 ...
 */
goog.inherits = function(childCtor: Function, parentCtor: Function) {
  class tempCtor {}
   ...
   * @param methodName The method name to call. Calling
   ...
   */
  childCtor.base = function(
      me: Object, methodName: string, ...var_args: any[]): any {
 ...
 */
goog.base = function(
    me: Object, opt_methodName?: any, ...var_args: any[]): any {
  ...
  if (caller.superClass_) {
    // Copying using loop to avoid deop due to passing arguments object to
    // function. This is faster in many JS engines as of late 2014.
    let ctorArgs = new Array(arguments.length - 1);
  ...
  for (let ctor = me.constructor; ctor;
