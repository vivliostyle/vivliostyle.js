...
(() => {
  ...
  const actionsSelector = actionsSelector;
  ...
  const actionsSelectorInFunc = actionsSelectorInFunc;
  ...
  const actionsSelectorCont = actionsSelectorCont;
  ...
  const actionsPropVal = actionsPropVal;
  ...
  const actionsExprVal = actionsExprVal;
  ...
  const actionsExprOp = actionsExprOp;
  ...
  const actionsError = actionsError;
  ...
  const actionsErrorDecl = actionsErrorDecl;
  ...
  const actionsErrorSelector = actionsErrorSelector;
