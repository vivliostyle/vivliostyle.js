...
export class PageFloat implements pagefloat.PageFloat {
 ...
 *     after this fragment
 */
export class PageFloatFragment implements pagefloat.PageFloatFragment {
  constructor(
      public readonly floatReference: FloatReference,
...
export class PageFloatContinuation implements pagefloat.PageFloatContinuation {
  constructor(
 ...
 *     example page floats)
 */
export class PageFloatLayoutContext implements pagefloat.PageFloatLayoutContext {
  ...
  addLayoutConstraint(
      layoutConstraint: layout.LayoutConstraint, floatReference: FloatReference) {
    if (floatReference === this.floatReference) {
...
export interface PageFloatLayoutStrategy extends pagefloat.PageFloatLayoutStrategy {}
...
export function registerPageFloatPlugin() {
