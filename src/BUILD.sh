...
java -jar ../../tools/closure/compiler.jar --compilation_level ADVANCED_OPTIMIZATIONS --warning_level VERBOSE license.js closure/goog/base.js adapt/*.js vivliostyle/*.js
