 ...
 * @return void
 */
adapt.cssstyler.FlowListener.prototype.encounteredFlowChunk = (flowChunk, flow) => {};
 ...
 */
adapt.cssstyler.AbstractStyler.prototype.getStyle = (element, deep) => {};

/**
 * @param {Element} element
 * @param {!Object.<string,adapt.css.Val>} styles
 */
adapt.cssstyler.AbstractStyler.prototype.processContent = (element, styles) => {};
...
adapt.cssstyler.BoxStack.prototype.isCurrentBoxDisplayed = function() {
    return this.stack.every(box => box.displayValue() !== adapt.css.ident.none);
};
 ...
 * @override
 */
adapt.cssstyler.Styler.prototype.processContent = (element, styles) => {};
