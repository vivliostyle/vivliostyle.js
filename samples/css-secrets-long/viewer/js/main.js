 ...
 *
 * Vivliostyle core 2016.7.1-pre.8fa981337efc045c24419a456cdba9cd5cafeb19
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
e}else if(null!=f&&null==c)return 0!==f;return!1}function uc(a){this.b=a;this.f="_"+ec++}n=uc.prototype;n.toString=function(){var a=new Ka;this.oa(a,0);return a.toString()};n.oa=function(){throw Error("F_ABSTRACT");};n.Ta=function(){throw Error("F_ABSTRACT");};n.Ga=function(){return this};n.Bb=function(a){return a===this};function vc(a,b,c,d){var e=d[a.f];if(null!=e)return e===$b?!1:e;d[a.f]=$b;b=a.Bb(b,c,d);return d[a.f]=b}
n.evaluate=function(a){var b;b=(b=a.w[this.b.j])?b[this.f]:void 0;if("undefined"!=typeof b)return b;b=this.Ta(a);var c=this.f,d=this.b,e=a.w[d.j];e||(e={},a.w[d.j]=e);return e[c]=b};n.zd=function(){return!1};function wc(a,b){uc.call(this,a);this.d=b}t(wc,uc);n=wc.prototype;n.ud=function(){throw Error("F_ABSTRACT");};n.xd=function(){throw Error("F_ABSTRACT");};n.Ta=function(a){a=this.d.evaluate(a);return this.xd(a)};n.Bb=function(a,b,c){return a===this||vc(this.d,a,b,c)};
n.oa=function(a,b){10<b&&a.append("(");a.append(this.ud());this.d.oa(a,10);10<b&&a.append(")")};n.Ga=function(a,b){var c=this.d.Ga(a,b);return c===this.d?this:new this.constructor(this.b,c)};function B(a,b,c){uc.call(this,a);this.d=b;this.e=c}t(B,uc);n=B.prototype;n.qc=function(){throw Error("F_ABSTRACT");};n.Da=function(){throw Error("F_ABSTRACT");};n.$a=function(){throw Error("F_ABSTRACT");};n.Ta=function(a){var b=this.d.evaluate(a);a=this.e.evaluate(a);return this.$a(b,a)};
...
Dc.prototype.Ta=function(a){return this.d.evaluate(a)&&this.e.evaluate(a)};function Ec(a,b,c){B.call(this,a,b,c)}t(Ec,Dc);Ec.prototype.Da=function(){return" and "};function Fc(a,b,c){B.call(this,a,b,c)}t(Fc,xc);Fc.prototype.Da=function(){return"||"};Fc.prototype.Ta=function(a){return this.d.evaluate(a)||this.e.evaluate(a)};function Gc(a,b,c){B.call(this,a,b,c)}t(Gc,Fc);Gc.prototype.Da=function(){return", "};function Hc(a,b,c){B.call(this,a,b,c)}t(Hc,yc);Hc.prototype.Da=function(){return"<"};
...
l=k}f.b[l]=g}if(!c.f){var l=c,m=l.d;l.d=null;m&&m.b==l&&(m.b=null,k=Te,Te=m,N(m.top,l.e),Te=k)}b=a.e.currentTime();if(b>=a.h)break}}catch(p){u.error(p)}a.g=!1;a.d.length()&&ef(a)},b)}}bf.prototype.Va=function(a,b){var c=this.e.currentTime();a.Q=this.Q++;a.b=c+(b||0);a:{for(var c=this.d,d=c.b.length;1<d;){var e=Math.floor(d/2),f=c.b[e];if(0<ff(f,a)){c.b[d]=a;break a}c.b[d]=f;d=e}c.b[1]=a}ef(this)};
function af(a,b,c){var d=new gf(a,c||"");d.top=new Ve(d,null,"bootstrap");d.top.b=We;d.top.then(function(){function a(){d.h=!1;for(var b=0;b<d.g.length;b++){var c=d.g[b];try{c()}catch(e){u.error(e)}}}try{b().then(function(b){d.f=b;a()})}catch(c){Ze(d,c),a()}});c=Te;Te=d;a.Va(hf(d.top,"bootstrap"));Te=c;return d}function jf(a){this.d=a;this.Q=this.b=0;this.e=null;this.f=!1}function ff(a,b){return b.b-a.b||b.Q-a.Q}jf.prototype.Va=function(a,b){this.e=a;this.d.d.Va(this,b)};
function gf(a,b){this.d=a;this.name=b;this.g=[];this.e=null;this.h=!0;this.b=this.top=this.j=this.f=null}function kf(a,b){a.g.push(b)}gf.prototype.join=function(){var a=K("Task.join");if(this.h){var b=hf(a,this),c=this;kf(this,function(){b.Va(c.f)})}else N(a,this.f);return M(a)};
...
function nf(){var a=K("Frame.timeSlice"),b=a.d.d;b.e.currentTime()>=b.h?(u.debug("-- time slice --"),hf(a).Va(!0)):N(a,!0);return M(a)}function of(a){var b=K("Frame.sleep");hf(b).Va(!0,a);return M(b)}function pf(a){function b(d){try{for(;d;){var e=a();if(e.Ca()){e.then(b);return}e.then(function(a){d=a})}N(c,!0)}catch(f){Ze(c.d,f,c)}}var c=K("Frame.loop");b(!0);return M(c)}
...
k);continue}m=k.text;A(h);k=x(h)}else p="";switch(k.type){case 39:case 45:case 44:case 43:case 42:case 46:case 50:r=k.type;A(h);k=x(h);break;case 15:g.rc(p,m,0,null);a.b=f?Mf:Q;A(h);continue;default:a.b=Tf;g.error("E_CSS_ATTR_OP_EXPECTED",k);continue}switch(k.type){case 1:case 2:g.rc(p,m,r,k.text);A(h);k=x(h);break;default:a.b=Tf;g.error("E_CSS_ATTR_VAL_EXPECTED",k);continue}if(15!=k.type){a.b=Tf;g.error("E_CSS_ATTR",k);continue}a.b=f?Mf:Q;A(h);continue;case 11:g.Qc();a.b=Nf;A(h);continue;case 12:g.Pc();
...
function wg(a,b){var c=null,d=null;"img"==a.localName&&(c=a.getAttribute("width"),d=a.getAttribute("height"));var e=new yf(function(){function e(b){l||(l=!0,"img"==a.localName&&(c||a.removeAttribute("width"),d||a.removeAttribute("height")),h.Va(b?b.type:"timeout"))}var g=K("loadImage"),h=hf(g,a),l=!1;a.addEventListener("load",e,!1);a.addEventListener("error",e,!1);a.addEventListener("abort",e,!1);"http://www.w3.org/2000/svg"==a.namespaceURI?(a.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",
...
function Di(a){this.element=a;this.F=this.D=this.height=this.width=this.u=this.k=this.w=this.j=this.Aa=this.Z=this.Ja=this.O=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.xb=this.G=null;this.na=this.yb=this.Ra=this.Hb=this.d=0;this.b=!1}function Ei(a){return a.marginTop+a.Z+a.k}function Fi(a){return a.marginBottom+a.Aa+a.u}function Gi(a){return a.marginLeft+a.O+a.j}function Hi(a){return a.marginRight+a.Ja+a.w}
function Ji(a,b){a.element=b.element;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.O=b.O;a.Ja=b.Ja;a.Z=b.Z;a.Aa=b.Aa;a.j=b.j;a.w=b.w;a.k=b.k;a.u=b.u;a.width=b.width;a.height=b.height;a.D=b.D;a.F=b.F;a.xb=b.xb;a.G=b.G;a.d=b.d;a.Hb=b.Hb;a.Ra=b.Ra;a.b=b.b}function Ki(a,b,c){a.top=b;a.height=c;v(a.element,"top",b+"px");v(a.element,"height",c+"px")}
...
function Tj(a,b){Qj.call(this,a,b)}t(Tj,Qj);Tj.prototype.apply=function(a){Rj(this,a.Ra[a.e][a.d])&&this.b.apply(a)};Tj.prototype.d=function(){return 5};function Uj(a,b){Qj.call(this,a,b)}t(Uj,Qj);Uj.prototype.apply=function(a){var b=a.G;null===b&&(b=a.G=a.b.parentNode.childElementCount-a.Aa+1);Rj(this,b)&&this.b.apply(a)};Uj.prototype.d=function(){return 4};function Vj(a,b){Qj.call(this,a,b)}t(Vj,Qj);
...
function Gk(a,b,c,d){this.k=a;this.h=b;this.Hb=c;this.Pa=d;this.g=[[],[]];this.j={};this.w=this.u=this.b=null;this.na=this.Z=this.N=this.e=this.d="";this.O=this.F=null;this.ja=this.Ja=!0;this.f={};this.A=[{}];this.D=[new ld("\u201c"),new ld("\u201d"),new ld("\u2018"),new ld("\u2019")];this.l=0;this.lang="";this.yb=[0];this.Aa=0;this.ia=[{}];this.Ra=this.ia[0];this.G=null;this.wb=[this.G];this.xb=[{}];this.Qa=this.ia[0];this.ib=[]}function ek(a,b){a.j[b]=(a.j[b]||0)+1}
...
"lang"))||"http://www.w3.org/1999/xhtml"!=a.e||(d=b.getAttribute("lang"));d&&(a.g[a.g.length-1].push(new kk(a.lang)),a.lang=d.toLowerCase());var d=a.ja,e=a.yb;a.Aa=++e[e.length-1];e.push(0);var e=a.ia,f=a.Ra=e[e.length-1],g=f[a.e];g||(g=f[a.e]={});g[a.d]=(g[a.d]||0)+1;e.push({});e=a.wb;null!==e[e.length-1]?a.G=--e[e.length-1]:a.G=null;e.push(null);e=a.xb;(f=a.Qa=e[e.length-1])&&f[a.e]&&f[a.e][a.d]--;e.push({});Kk(a);Qk(a,b);e=c.quotes;c=null;e&&(e=e.evaluate(a.h))&&(c=new lk(a.D),e===J?a.D=[new ld(""),
...
"height",w+"px");v(q,p,f+"px "+h.toString()+(l?" "+l.toString():""));b.element.insertBefore(q,b.element.firstChild)}}for(d=0;d<xm.length;d++)mm(this,a,b,xm[d],g);for(d=0;d<zm.length;d++)e=b,g=zm[d],f=c.h,(h=lm(this,a,g))&&f.push(new Vh(e.element,g,h))};
...
function Sm(a,b,c,d){Di.call(this,a);this.qd=a.lastChild;this.f=b;this.g=c;this.Qa=d;this.ae=a.ownerDocument;this.Lc=!1;this.ja=this.Sa=this.sa=this.ia=this.N=0;this.ib=this.wb=this.l=this.Pa=null;this.rd=!1;this.h=this.e=this.A=null;this.Id=!0;this.Mc=this.Oc=this.Nc=0}t(Sm,Di);Sm.prototype.clone=function(){var a=new Sm(this.element,this.f,this.g,this.Qa);Ji(a,this);a.qd=this.qd;a.Lc=this.Lc;a.l=this.l?this.l.clone():null;a.wb=this.wb.concat();return a};
...
function pn(a,b,c,d){if(a.e&&a.e[a.e.length-1].b)return on(a,b,c),L(!0);d+=40*(a.b?-1:1);var e=a.l,f=!e;if(f){var g=a.element.ownerDocument.createElement("div");v(g,"position","absolute");var h=a.f.clone(),e=new Sm(g,h,a.g,a.Qa);a.l=e;e.b=qn(a.f,a.b,g);e.Lc=!0;a.b?(e.left=0,v(e.element,"width","2em")):(e.top=a.Sa,v(e.element,"height","2em"))}a.element.appendChild(e.element);nn(a,e.element,e);g=(a.b?-1:1)*(d-a.sa);a.b?e.height=a.Pa.S-a.Pa.W-Ei(e)-Fi(e):e.width=a.Pa.V-a.Pa.ca-Gi(e)-Hi(e);d=(a.b?-1:
1)*(a.Sa-d)-(a.b?Gi(e)-Hi(e):Ei(e)+Fi(e));if(f&&18>d)return a.element.removeChild(e.element),a.l=null,on(a,b,c),L(!0);if(!a.b&&e.top<g)return a.element.removeChild(e.element),on(a,b,c),L(!0);var l=K("layoutFootnoteInner");a.b?Li(e,0,d):Ki(e,g,d);e.D=a.D+a.left+Gi(a);e.F=a.F+a.top+Ei(a);e.G=a.G;var k=new wi(c);f?(rn(e),d=L(!0)):0==e.G.length?(sn(e),d=L(!0)):d=tn(e);d.then(function(){un(e,k).then(function(d){if(f&&d)a.element.removeChild(e.element),on(a,b,c),a.l=null,N(l,!0);else{a.b?(a.ja=a.Sa+(e.d+
Gi(e)+Hi(e)),Li(e,0,e.d)):(a.ja=a.Sa-(e.d+Ei(e)+Fi(e)),Ki(e,a.ja-a.sa,e.d));var g;!a.b&&0<e.G.length?g=tn(e):g=L(d);g.then(function(d){d=new Qm(b,c,d?d.Oa:null);a.e?a.e.push(d):a.e=[d];N(l,!0)})}})});return M(l)}
...
else{e=Ri(e,a.b,g);for(var r=a.N,w=a.ia,p=b.parent;p&&p.e;)p=p.parent;if(p){var q=p.B.ownerDocument.createElement("div");q.style.left="0px";q.style.top="0px";a.b?(q.style.bottom="0px",q.style.width="1px"):(q.style.right="0px",q.style.height="1px");p.B.appendChild(q);var y=ci(a.g,q),r=Math.max(a.b?y.top:y.left,r),w=Math.min(a.b?y.bottom:y.right,w);p.B.removeChild(q);q=a.b?m.S-m.W:m.V-m.ca;"left"==e?w=Math.max(w,r+q):r=Math.min(r,w-q);p.B.appendChild(b.B)}q=new re(r,(a.b?-1:1)*a.sa,w,(a.b?-1:1)*a.Sa);
r=m;a.b&&(r=Ie(m));w=a.b?-1:1;r.W<a.Mc*w&&(y=r.S-r.W,r.W=a.Mc*w,r.S=r.W+y);Ne(q,a.ib,r,e);a.b&&(m=new re(-r.S,r.ca,-r.W,r.V));q=mn(a,d);v(d,"width",m.V-m.ca-q.left-q.right+"px");v(d,"height",m.S-m.W-q.top-q.bottom+"px");v(d,"position","absolute");v(d,"display",b.display);w=null;p&&(p.F?w=p:w=ui(p));w?(q=w.B.ownerDocument.createElement("div"),q.style.position="absolute",w.b?q.style.right="0":q.style.left="0",q.style.top="0",w.B.appendChild(q),p=ci(a.g,q),w.B.removeChild(q)):p={left:a.b?a.Sa:a.N,right:a.b?
a.sa:a.ia,top:a.b?a.N:a.sa};(w?w.b:a.b)?v(d,"right",p.right-m.V+a.w+"px"):v(d,"left",m.ca-p.left+a.j+"px");v(d,"top",m.W-p.top+a.k+"px");b.u&&(b.u.parentNode.removeChild(b.u),b.u=null);p=a.b?m.ca:m.S;m=a.b?m.V:m.W;Tm(a,p)&&0!=a.A.length?(b=b.modify(),b.d=!0,N(c,b)):(gn(a),q=new re(a.b?a.Sa:a.N,a.b?a.N:a.sa,a.b?a.sa:a.ia,a.b?a.ia:a.Sa),a.b&&(q=Ie(q)),Oe(q,a.ib,r,e),hn(a),"left"==e?a.Nc=p:a.Oc=p,a.Mc=m,yn(a,p),N(c,k))}});return M(c)}
...
function sn(a){var b=a.element.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.k+"px";b.style.right=a.w+"px";b.style.bottom=a.u+"px";b.style.left=a.j+"px";a.element.appendChild(b);var c=ci(a.g,b);a.element.removeChild(b);var b=a.D+a.left+Gi(a),d=a.F+a.top+Ei(a);a.Pa=new re(b,d,b+a.width,d+a.height);a.N=c?a.b?c.top:c.left:0;a.ia=c?a.b?c.bottom:c.right:0;a.sa=c?a.b?c.right:c.top:0;a.Sa=c?a.b?c.left:c.bottom:0;a.Nc=a.sa;a.Oc=a.sa;a.Mc=a.sa;a.ja=a.Sa;c=a.Pa;b=a.D+a.left+Gi(a);
d=a.F+a.top+Ei(a);if(a.xb){for(var e=a.xb,f=[],g=0;g<e.b.length;g++){var h=e.b[g];f.push(new se(h.x+b,h.y+d))}b=new xe(f)}else b=Ae(b,d,b+a.width,d+a.height);a.ib=Ke(c,[b],a.G,a.Ra,a.b);hn(a);a.e=null}function rn(a){a.wb=[];v(a.element,"width",a.width+"px");v(a.element,"height",a.height+"px");sn(a);a.d=0;a.rd=!1;a.h=null}function yn(a,b){a.d=Math.max((a.b?-1:1)*(b-a.sa),a.d)}
...
function Xo(a,b){var c=a.style,d=a.d.d,e=b.start,f=b.end,g=b.da,h=a.d.l[g].la(d,null),l=W(d,c[g],h),k=W(d,c["margin-"+e],h),m=W(d,c["margin-"+f],h),p=Yl(d,c["padding-"+e],h),r=Yl(d,c["padding-"+f],h),w=$l(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),q=$l(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),y=D(d,h,C(d,C(d,w,p),C(d,q,r)));l?(y=D(d,y,l),k||m?k?m=D(d,y,k):k=D(d,y,m):m=k=$c(d,y,new gc(d,.5))):(k||(k=d.b),m||(m=d.b),l=D(d,y,C(d,k,m)));c[e]=new I(k);c[f]=new I(m);c["margin-"+e]=
...
function Yo(a,b,c){function d(a){if(y)return y;y={da:q?q.evaluate(a):null,Ma:l?l.evaluate(a):null,Na:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[r,m,p,w].forEach(function(b){b&&(c+=b.evaluate(a))});(null===y.Ma||null===y.Na)&&c+y.da+y.Ma+y.Na>b&&(null===y.Ma&&(y.Ma=0),null===y.Na&&(y.Qe=0));null!==y.da&&null!==y.Ma&&null!==y.Na&&(y.Na=null);null===y.da&&null!==y.Ma&&null!==y.Na?y.da=b-c-y.Ma-y.Na:null!==y.da&&null===y.Ma&&null!==y.Na?y.Ma=b-c-y.da-y.Na:null!==y.da&&null!==y.Ma&&null===y.Na?y.Na=
b-c-y.da-y.Ma:null===y.da?(y.Ma=y.Na=0,y.da=b-c):y.Ma=y.Na=(b-c-y.da)/2;return y}var e=a.style;a=a.d.d;var f=b.$c,g=b.dd;b=b.da;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],l=Zl(a,e["margin-"+f],h),k=Zl(a,e["margin-"+g],h),m=Yl(a,e["padding-"+f],h),p=Yl(a,e["padding-"+g],h),r=$l(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),w=$l(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),q=W(a,e[b],h),y=null;e[b]=new I(new jc(a,function(){var a=d(this).da;return null===a?0:a},b));e["margin-"+
...
c.clone();h=a;l=h.b.page;k=void 0;for(k in h.b.b)for(m=h.b.b[k],p=m.b.length-1;0<=p;p--){var r=m.b[p];0>r.b.Wa&&r.b.d<h.l&&(r.b.Wa=l)}pc(a,a.style.b);h=lm(f,a,"enabled");if(!h||h===ke){c=a;u.debug("Location - page",c.b.page);u.debug("  current:",d);u.debug("  lookup:",c.l);d=void 0;for(d in c.b.b)for(e=c.b.b[d],g=0;g<e.b.length;g++)u.debug("  Chunk",d+":",e.b[g].b.d);d=a.N;e=f;f=b;c=e.d;0===Object.keys(f).length?(c.d.e=c,f=e):(e=c,g=ap(d,f),e=e.g+"^"+g,g=d.g[e],g||("background-host"===c.sb?(c=d,f=
...
K("layoutContainer.inner"),X=l.toString(),ja=Y(c,a,"column-count"),Ma=Y(c,a,"column-gap"),ea=1<ja?Y(c,a,"column-width"):q.width,l=km(c,a),E=0,w=lm(c,a,"shape-inside"),S=qg(w,0,0,q.width,q.height,a),cm=new wp(X,a,a.viewport,a.d,l,a.X,a.h,a.style.u,a,b,a.Ja,a.Qa,h,a.Pa),dm=new Rn(a.f,a.b.page-1),Ii=0,fa=null;qf(function(b){for(;Ii<ja;){var c=Ii++;if(1<ja){var d=a.viewport.b.createElement("div");v(d,"position","absolute");r.appendChild(d);fa=new Sm(d,cm,a.e,dm);fa.b=q.b;fa.Ra=q.Ra;fa.Hb=q.Hb;q.b?(v(d,
"margin-left",q.j+"px"),v(d,"margin-right",q.w+"px"),c=c*(ea+Ma)+q.k,Li(fa,0,q.width),Ki(fa,c,ea)):(v(d,"margin-top",q.k+"px"),v(d,"margin-bottom",q.u+"px"),c=c*(ea+Ma)+q.j,Ki(fa,0,q.height),Li(fa,c,ea));fa.D=e+q.j;fa.F=f+q.k}else fa=new Sm(r,cm,a.e,dm),Ji(fa,q),q=fa;fa.G=p?[]:g;fa.xb=S;if(0<=fa.width){var k=K("inner");$p(a,fa,X).then(function(){fa.h&&"column"!=fa.h&&(Ii=ja,"region"!=fa.h&&(a.G[X]=!0));N(k,!0)});c=M(k)}else c=L(!0);if(c.Ca()){c.then(function(){0<h.b.length?P(b):(E=Math.max(E,fa.d),
sf(b))});return}0<h.b.length||(E=Math.max(E,fa.d))}P(b)}).then(function(){q.d=E;c.vc(a,q,b,fa,ja,a.e,a.h);N(O,!0)});l=M(O)}else(l=lm(c,a,"content"))&&Ni(l)?(w=a.viewport.b.createElement("span"),l.U(new Mi(w,a)),r.appendChild(w),Am(c,a,q,a.h)):c.na&&(d.removeChild(r),y=!0),y||c.vc(a,q,b,null,1,a.e,a.h),l=L(!0);l.then(function(){if(!c.f||0<Math.floor(q.d)){if(!y&&!m){var l=q.D+q.left,p=q.F+q.top,w=Gi(q)+q.width+Hi(q),E=Ei(q)+q.height+Fi(q),X=lm(c,a,"shape-outside"),l=qg(X,l,p,w,E,a);g.push(l)}}else if(0==
...
null)});return M(g)}
function Sq(a,b,c){var d=b.Ua.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.style.position="absolute";e.style.top="0";e.style.left="0";ma||(e.style.visibility="hidden");d.g.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);var g=new Yh(e,f);g.H=b.item.H;g.position=c;g.offset=Yp(b.Ua,c);0===g.offset&&(b=a.b.j.nd("",b.item.src),f.setAttribute("id",b),ai(g,f,b));d!==a.viewport&&(a=ac(a.viewport.width,
...
function Tq(a,b){if(b>=a.b.b.length)return L(null);var c=a.Eb[b];if(c)return L(c);var d=a.b.b[b],e=a.b.e,f=K("getPageViewItem");e.load(d.src).then(function(g){0==d.b&&1==a.b.b.length&&(d.b=Math.ceil(Bh(g)/2700),a.b.u=d.b);var h=e.d[g.url],l=a.bd(g),k=a.viewport,m=Up(h,k.width,k.height,k.fontSize);if(m.width!=k.width||m.height!=k.height||m.fontSize!=k.fontSize)k=new Pp(k.f,m.fontSize,k.root,m.width,m.height);m=a.Eb[b-1];null!==d.Wa?m=d.Wa-1:(m=m?m.Ua.ja+m.ab.length:0,null!==d.Db&&(m+=d.Db));bo(a.d,
m);var p=new Vp(h,g,a.b.lang,k,a.f,a.g,l,a.b.w,m,a.b.j,a.d);p.T=a.T;Wp(p).then(function(){c={item:d,X:g,Ua:p,Fa:[null],ab:[],complete:!1};a.Eb[b]=c;N(f,c)})});return M(f)}function dr(a){return a.Eb.some(function(a){return a&&0<a.ab.length})}
...
function fr(a,b,c,d){var e=this;this.h=a;this.Jc=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);ma&&b.setAttribute("data-vivliostyle-debug",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Ra=c;this.Qa=d;a=a.document;this.Ja=new rh(a.head,b);this.w="loading";this.O=[];this.g=null;this.k=this.d=!1;this.e=this.j=this.f=this.A=null;this.fontSize=16;this.zoom=1;this.G=!1;this.ia="autoSpread";this.na=!1;this.kd=!0;this.T=Xb();this.N=function(){};this.u=function(){};this.ja=
function(){e.d=!0;e.N()};this.fd=this.fd.bind(this);this.D=function(){};this.F=a.getElementById("vivliostyle-page-rules");this.Z=!1;this.l=null;this.Aa={loadEPUB:this.Zd,loadXML:this.$d,configure:this.vd,moveTo:this.Pa,toc:this.Ac};gr(this)}function gr(a){va(1,function(a){hr(this,{t:"debug",content:a})}.bind(a));va(2,function(a){hr(this,{t:"info",content:a})}.bind(a));va(3,function(a){hr(this,{t:"warn",content:a})}.bind(a));va(4,function(a){hr(this,{t:"error",content:a})}.bind(a))}
function hr(a,b){b.i=a.Ra;a.Qa(b)}function ir(a,b){a.w!==b&&(a.w=b,a.Jc.setAttribute("data-vivliostyle-viewer-status",b),hr(a,{t:"readystatechange"}))}n=fr.prototype;
...
function kr(a){if(a.l){var b=a.l;Ze(b,new Ar||Error("E_TASK_INTERRUPT"));if(b!==Te&&b.b){b.b.f=!0;var c=new jf(b);b.j="interrupt";b.b=c;b.d.Va(c)}}a.l=null}
