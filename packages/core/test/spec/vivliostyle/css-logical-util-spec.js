...
import * as vivliostyle_logical from "../../../src/vivliostyle/css-logical-util";

describe("css-logical-util", function () {
  "use strict";
  ...
  describe("toPhysical", function () {
    it("converts logical properties to physical properties (horizontal-tb, ltr)", function () {
      ...
      expect(l.toPhysical("border-inline-start-width", "horizontal-tb")).toBe(
        "border-left-width",
      );
      expect(l.toPhysical("border-inline-end-width", "horizontal-tb")).toBe(
        "border-right-width",
      );
      expect(l.toPhysical("border-block-start-width", "horizontal-tb")).toBe(
        "border-top-width",
      );
      expect(l.toPhysical("border-block-end-width", "horizontal-tb")).toBe(
        "border-bottom-width",
      );
    ...
    it("converts logical properties to physical properties (horizontal-tb, rtl)", function () {
      expect(l.toPhysical("inline-start", "horizontal-tb", "rtl")).toBe(
        "right",
      );
      ...
      expect(
        l.toPhysical("border-inline-start-width", "horizontal-tb", "rtl"),
      ).toBe("border-right-width");
      expect(
        l.toPhysical("border-inline-end-width", "horizontal-tb", "rtl"),
      ).toBe("border-left-width");
      expect(
        l.toPhysical("border-block-start-width", "horizontal-tb", "rtl"),
      ).toBe("border-top-width");
      expect(
        l.toPhysical("border-block-end-width", "horizontal-tb", "rtl"),
      ).toBe("border-bottom-width");
    });
    ...
    it("converts logical properties to physical properties (vertical-rl, ltr)", function () {
      ...
      expect(l.toPhysical("border-inline-start-width", "vertical-rl")).toBe(
        "border-top-width",
      );
      expect(l.toPhysical("border-inline-end-width", "vertical-rl")).toBe(
        "border-bottom-width",
      );
      expect(l.toPhysical("border-block-start-width", "vertical-rl")).toBe(
        "border-right-width",
      );
      expect(l.toPhysical("border-block-end-width", "vertical-rl")).toBe(
        "border-left-width",
      );
    ...
    it("converts logical properties to physical properties (vertical-rl, rtl)", function () {
      ...
      expect(
        l.toPhysical("border-inline-start-width", "vertical-rl", "rtl"),
      ).toBe("border-bottom-width");
      expect(
        l.toPhysical("border-inline-end-width", "vertical-rl", "rtl"),
      ).toBe("border-top-width");
      expect(
        l.toPhysical("border-block-start-width", "vertical-rl", "rtl"),
      ).toBe("border-right-width");
      expect(l.toPhysical("border-block-end-width", "vertical-rl", "rtl")).toBe(
        "border-left-width",
      );
    });
    ...
    it("converts logical properties to physical properties (vertical-lr, ltr)", function () {
      ...
      expect(l.toPhysical("border-inline-start-width", "vertical-lr")).toBe(
        "border-top-width",
      );
      expect(l.toPhysical("border-inline-end-width", "vertical-lr")).toBe(
        "border-bottom-width",
      );
      expect(l.toPhysical("border-block-start-width", "vertical-lr")).toBe(
        "border-left-width",
      );
      expect(l.toPhysical("border-block-end-width", "vertical-lr")).toBe(
        "border-right-width",
      );
    ...
    it("converts logical properties to physical properties (vertical-lr, rtl)", function () {
      ...
      expect(
        l.toPhysical("border-inline-start-width", "vertical-lr", "rtl"),
      ).toBe("border-bottom-width");
      expect(
        l.toPhysical("border-inline-end-width", "vertical-lr", "rtl"),
      ).toBe("border-top-width");
      expect(
        l.toPhysical("border-block-start-width", "vertical-lr", "rtl"),
      ).toBe("border-left-width");
      expect(l.toPhysical("border-block-end-width", "vertical-lr", "rtl")).toBe(
        "border-right-width",
      );
    });
  ...
  describe("toLogical", function () {
    it("converts physical properties to logical properties (horizontal-tb, ltr)", function () {
      ...
      expect(l.toLogical("border-left-width", "horizontal-tb")).toBe(
        "border-inline-start-width",
      );
      expect(l.toLogical("border-right-width", "horizontal-tb")).toBe(
        "border-inline-end-width",
      );
      expect(l.toLogical("border-top-width", "horizontal-tb")).toBe(
        "border-block-start-width",
      );
      expect(l.toLogical("border-bottom-width", "horizontal-tb")).toBe(
    ...
    it("converts physical properties to logical properties (horizontal-tb, rtl)", function () {
      ...
      expect(l.toLogical("border-left-width", "horizontal-tb", "rtl")).toBe(
        "border-inline-end-width",
      );
      expect(l.toLogical("border-right-width", "horizontal-tb", "rtl")).toBe(
        "border-inline-start-width",
      );
      expect(l.toLogical("border-top-width", "horizontal-tb", "rtl")).toBe(
        "border-block-start-width",
      );
      expect(l.toLogical("border-bottom-width", "horizontal-tb", "rtl")).toBe(
        "border-block-end-width",
      );
    });
    ...
    it("converts physical properties to logical properties (vertical-rl, ltr)", function () {
      ...
      expect(l.toLogical("border-left-width", "vertical-rl")).toBe(
        "border-block-end-width",
      );
      expect(l.toLogical("border-right-width", "vertical-rl")).toBe(
        "border-block-start-width",
      );
      expect(l.toLogical("border-top-width", "vertical-rl")).toBe(
        "border-inline-start-width",
      );
      expect(l.toLogical("border-bottom-width", "vertical-rl")).toBe(
        "border-inline-end-width",
      );
    ...
    it("converts physical properties to logical properties (vertical-rl, rtl)", function () {
      ...
      expect(l.toLogical("border-left-width", "vertical-rl", "rtl")).toBe(
        "border-block-end-width",
      );
      expect(l.toLogical("border-right-width", "vertical-rl", "rtl")).toBe(
        "border-block-start-width",
      );
      expect(l.toLogical("border-top-width", "vertical-rl", "rtl")).toBe(
        "border-inline-end-width",
      );
      expect(l.toLogical("border-bottom-width", "vertical-rl", "rtl")).toBe(
        "border-inline-start-width",
      );
    });
    ...
    it("converts logical properties to physical properties (vertical-lr, ltr)", function () {
      ...
      expect(l.toLogical("border-left-width", "vertical-lr")).toBe(
        "border-block-start-width",
      );
      expect(l.toLogical("border-right-width", "vertical-lr")).toBe(
        "border-block-end-width",
      );
      expect(l.toLogical("border-top-width", "vertical-lr")).toBe(
        "border-inline-start-width",
      );
      expect(l.toLogical("border-bottom-width", "vertical-lr")).toBe(
        "border-inline-end-width",
      );
    ...
    it("converts logical properties to physical properties (vertical-lr, rtl)", function () {
      ...
      expect(l.toLogical("border-left-width", "vertical-lr", "rtl")).toBe(
        "border-block-start-width",
      );
      expect(l.toLogical("border-right-width", "vertical-lr", "rtl")).toBe(
        "border-block-end-width",
      );
      expect(l.toLogical("border-top-width", "vertical-lr", "rtl")).toBe(
        "border-inline-end-width",
      );
      expect(l.toLogical("border-bottom-width", "vertical-lr", "rtl")).toBe(
        "border-inline-start-width",
      );
    });
