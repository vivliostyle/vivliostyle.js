...
d(C);break;case "fit-content width":c=I?d(C):h();break;case "fit-content height":c=I?h():d(C)}N[a]=parseFloat(c);u(b,"position",n);u(b,"display",l)});u(b,"width",p);u(b,"height",r);q.insertBefore(b,y);q.removeChild(y);return N};function mm(a){var b=a["writing-mode"],b=b&&b.value;a=(a=a.direction)&&a.value;return b===Id||b!==Jd&&a!==Ed?"ltr":"rtl"}
...
function Im(a,b,c){function d(a){if(x)return x;x={W:y?y.evaluate(a):null,za:k?k.evaluate(a):null,Aa:l?l.evaluate(a):null};var b=h.evaluate(a),c=0;[r,n,p,q].forEach(function(b){b&&(c+=b.evaluate(a))});(null===x.za||null===x.Aa)&&c+x.W+x.za+x.Aa>b&&(null===x.za&&(x.za=0),null===x.Aa&&(x.Jd=0));null!==x.W&&null!==x.za&&null!==x.Aa&&(x.Aa=null);null===x.W&&null!==x.za&&null!==x.Aa?x.W=b-c-x.za-x.Aa:null!==x.W&&null===x.za&&null!==x.Aa?x.za=b-c-x.W-x.Aa:null!==x.W&&null!==x.za&&null===x.Aa?x.Aa=b-c-x.W-
...
b=qo(a);d.u();return!0}};window.adapt_embedded&&(window.adapt_initEmbed=function(a,b,c){(new bo(window,document.body,b,function(b){var c=JSON.stringify(b);(new Ze(function(){return Te(a,!1,"POST",c)})).start()})).Tc(c);delete window.adapt_initEmbed});ba("adapt.viewer.Viewer",bo,void 0);ba("adapt.viewer.Viewer.prototype.initEmbed",bo.prototype.Tc,void 0);var ro=16,so="ltr";function to(a){window.adapt_command(a)}function uo(){to({a:"moveTo",where:"ltr"===so?"previous":"next"})}function vo(){to({a:"moveTo",where:"ltr"===so?"next":"previous"})}
...
g.textContent="@page { size: "+n+"; margin: 0; }",document.head.appendChild(g));(new bo(window,l,"main",xo)).Tc(a)},"undefined"!==typeof enclosingObject&&enclosingObject?enclosingObject:window);
