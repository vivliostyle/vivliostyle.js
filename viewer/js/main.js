 ...
 *
 * Vivliostyle core 2016.10.1-pre.20170111141448
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
e}else if(null!=f&&!c)return!!f;return!1}function Bb(a){this.b=a;this.h="_"+lb++}n=Bb.prototype;n.toString=function(){var a=new ya;this.ua(a,0);return a.toString()};n.ua=function(){throw Error("F_ABSTRACT");};n.ab=function(){throw Error("F_ABSTRACT");};n.Qa=function(){return this};n.Qb=function(a){return a===this};function Cb(a,b,c,d){var e=d[a.h];if(null!=e)return e===gb?!1:e;d[a.h]=gb;b=a.Qb(b,c,d);return d[a.h]=b}
...
n.ua=function(a,b){10<b&&a.append("(");a.append(this.Qd());this.f.ua(a,10);10<b&&a.append(")")};n.Qa=function(a,b){var c=this.f.Qa(a,b);return c===this.f?this:new this.constructor(this.b,c)};function Fb(a,b,c){Bb.call(this,a);this.f=b;this.g=c}u(Fb,Bb);n=Fb.prototype;n.Jc=function(){throw Error("F_ABSTRACT");};n.Ma=function(){throw Error("F_ABSTRACT");};n.hb=function(){throw Error("F_ABSTRACT");};n.ab=function(a){var b=this.f.evaluate(a);a=this.g.evaluate(a);return this.hb(b,a)};
n.Qb=function(a,b,c){return a===this||Cb(this.f,a,b,c)||Cb(this.g,a,b,c)};n.ua=function(a,b){var c=this.Jc();c<=b&&a.append("(");this.f.ua(a,c);a.append(this.Ma());this.g.ua(a,c);c<=b&&a.append(")")};n.Qa=function(a,b){var c=this.f.Qa(a,b),d=this.g.Qa(a,b);return c===this.f&&d===this.g?this:new this.constructor(this.b,c,d)};function Gb(a,b,c){Fb.call(this,a,b,c)}u(Gb,Fb);Gb.prototype.Jc=function(){return 1};function Hb(a,b,c){Fb.call(this,a,b,c)}u(Hb,Fb);Hb.prototype.Jc=function(){return 2};
...
function Md(a,b,c){var d=b.frameTrace;if(!d){for(var d=b.stack?b.stack+"\n\t---- async ---\n":"",e=a.top;e;e=e.parent)d+="\t",d+=e.name,d+="\n";b.frameTrace=d}if(c){for(d=a.top;d&&d!=c;)d=d.parent;d==c&&(a.top=d)}for(a.g=b;a.top&&!a.top.j;)a.top=a.top.parent;a.top?(b=a.g,a.g=null,a.top.j(a.top,b)):a.g&&v.error(a.g,"Unhandled exception in task",a.name)}function Kd(a){this.value=a}n=Kd.prototype;n.then=function(a){a(this.value)};n.sa=function(a){return a(this.value)};n.Ld=function(a){return new Kd(a)};
n.Da=function(a){M(a,this.value)};n.va=function(){return!1};n.get=function(){return this.value};function Yd(a){this.b=a}n=Yd.prototype;n.then=function(a){this.b.then(a)};n.sa=function(a){if(this.va()){var b=new Id(this.b.f,this.b.parent,"AsyncResult.thenAsync");b.b=Jd;this.b.parent=b;this.b.then(function(c){a(c).then(function(a){M(b,a)})});return K(b)}return a(this.b.g)};n.Ld=function(a){return this.va()?this.sa(function(){return new Kd(a)}):new Kd(a)};
n.Da=function(a){this.va()?this.then(function(b){M(a,b)}):M(a,this.b.g)};n.va=function(){return this.b.b==Jd};n.get=function(){if(this.va())throw Error("Result is pending");return this.b.g};function Id(a,b,c){this.f=a;this.parent=b;this.name=c;this.g=null;this.b=0;this.j=this.h=null}function Zd(a){if(!Gd)throw Error("F_TASK_NO_CONTEXT");if(a!==Gd.top)throw Error("F_TASK_NOT_TOP_FRAME");}function K(a){return new Yd(a)}
...
function $d(){var a=I("Frame.timeSlice"),b=a.f.f;b.g.currentTime()>=b.l?(v.debug("-- time slice --"),Vd(a).Za(!0)):M(a,!0);return K(a)}function ae(a){var b=I("Frame.sleep");Vd(b).Za(!0,a);return K(b)}function be(a){function b(d){try{for(;d;){var e=a();if(e.va()){e.then(b);return}e.then(function(a){d=a})}M(c,!0)}catch(f){Md(c.f,f,c)}}var c=I("Frame.loop");b(!0);return K(c)}
function ce(a){var b=Gd;if(!b)throw Error("E_TASK_NO_CONTEXT");return be(function(){var c;do c=new de(b,b.top),b.top=c,c.b=Jd,a(c),c=K(c);while(!c.va()&&c.get());return c})}function Vd(a,b){Zd(a);if(a.f.b)throw Error("E_TASK_ALREADY_SUSPENDED");var c=new Wd(a.f);a.f.b=c;Gd=null;a.f.u=b||null;return c}function de(a,b){Id.call(this,a,b,"loop")}u(de,Id);function ee(a){M(a,!0)}function N(a){M(a,!1)};function fe(a,b){this.fetch=a;this.name=b;this.f=!1;this.b=this.h=null;this.g=[]}fe.prototype.start=function(){if(!this.b){var a=this;this.b=Od(Gd.f,function(){var b=I("Fetcher.run");a.fetch().then(function(c){var d=a.g;a.f=!0;a.h=c;a.b=null;a.g=[];if(d)for(var e=0;e<d.length;e++)try{d[e](c)}catch(f){v.error(f,"Error:")}M(b,c)});return K(b)},this.name)}};function ge(a,b){a.f?b(a.h):a.g.push(b)}fe.prototype.get=function(){if(this.f)return J(this.h);this.start();return this.b.join()};
...
n.yb=function(){};n.od=function(){};n.kd=function(){};n.sd=function(){};n.cc=function(){};n.rb=function(){};n.$c=function(){};n.Bc=function(){};n.dd=function(){};n.Yc=function(){};n.cd=function(){};n.ec=function(){};n.Kd=function(){};n.Vb=function(){};n.Zc=function(){};n.bd=function(){};n.ad=function(){};n.Ec=function(){};n.Dc=function(){};n.xa=function(){};n.pb=function(){};n.zb=function(){};n.Cc=function(){};n.Nc=function(){};
...
function Ff(a,b,c,d,e){var f=I("parseStylesheet"),g=new uf(hf,a,b,c),h=null;e&&(h=Gf(new Pe(e,b),b,c));if(h=Bf(g,d,h&&h.oa()))b.Vb(h),b.xa();be(function(){for(;!Df(g,100,!1,!1,!1,!1);){if(g.H){var a=ka(g.M,c);g.A&&(b.Vb(g.A),b.xa());var d=I("parseStylesheet.import");Hf(a,b,null,null).then(function(){g.A&&b.zb();g.H=!1;g.M=null;g.A=null;M(d,!0)});return K(d)}a=$d();if(a.va)return a}return J(!1)}).then(function(){h&&b.zb();M(f,!0)});return K(f)}
...
function Hi(a,b,c,d){this.A=a;this.l=b;this.Xb=c;this.lb=d;this.h=[[],[]];this.u={};this.G=this.F=this.b=null;this.ta=this.ha=this.V=this.j=this.f="";this.W=this.M=null;this.ra=this.Ta=!0;this.g={};this.H=[{}];this.J=[new vc("\u201c"),new vc("\u201d"),new vc("\u2018"),new vc("\u2019")];this.C=0;this.lang="";this.Nb=[0];this.Ja=0;this.pa=[{}];this.nb=this.pa[0];this.R=null;this.Lb=[this.R];this.Mb=[{}];this.mb=this.pa[0];this.tb=[]}function fi(a,b){a.u[b]=(a.u[b]||0)+1}
function Ii(a,b,c){(b=b[c])&&b.apply(a)}var Ji=[];function Ki(a,b,c,d){a.b=null;a.F=d;a.j="";a.f="";a.V="";a.ha="";a.G=b;a.ta="";a.M=Ji;a.W=c;Li(a)}function Mi(a,b,c){a.g[b]?a.g[b].push(c):a.g[b]=[c];c=a.H[a.H.length-1];c||(c={},a.H[a.H.length-1]=c);c[b]=!0}
...
function Li(a){var b;for(b=0;b<a.G.length;b++)Ii(a,a.A.Aa,a.G[b]);for(b=0;b<a.M.length;b++)Ii(a,a.A.f,a.M[b]);Ii(a,a.A.g,a.V);Ii(a,a.A.Fc,a.f);""!=a.f&&Ii(a,a.A.Fc,"*");Ii(a,a.A.h,a.ta);null!==a.W&&(Ii(a,a.A.wc,a.W),Ii(a,a.A.wc,"*"));a.b=null;a.h.push([]);for(var c=1;-1<=c;--c){var d=a.h[a.h.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.Ta=!0;a.ra=!1}
...
d?e=new Nh(a,b):(v.b("Unsupported :: attr selector op:",d),e=new bi(""));break;default:v.b("Unsupported attr selector:",c),e=new bi("")}this.b.push(e)};var Yi=0;n=Vi.prototype;n.yb=function(){var a="d"+Yi++;Wi(this,new Ch(new ei(a)));this.b=[new bi(a)]};n.od=function(){var a="c"+Yi++;Wi(this,new Ch(new gi(a)));this.b=[new bi(a)]};n.kd=function(){var a="a"+Yi++;Wi(this,new Ch(new hi(a)));this.b=[new bi(a)]};n.sd=function(){var a="f"+Yi++;Wi(this,new Ch(new ii(a)));this.b=[new bi(a)]};
n.cc=function(){$i(this);this.h=null;this.A=!1;this.X=0;this.b=[]};n.rb=function(){var a;0!=this.l?(gf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.l=1,this.Va={},this.h=null,this.X=0,this.A=!1,this.b=[])};n.error=function(a,b){ef.prototype.error.call(this,a,b);1==this.l&&(this.l=0)};n.fc=function(a){ef.prototype.fc.call(this,a);this.l=0};n.xa=function(){$i(this);ef.prototype.xa.call(this);1==this.l&&(this.l=0)};n.zb=function(){ef.prototype.zb.call(this)};
...
function Uj(a){this.f=a;this.b=[];this.K=null}function Vj(a,b,c,d,e,f,g,h,l){this.b=a;this.element=b;this.f=c;this.Ra=d;this.l=e;this.h=f;this.$e=g;this.j=h;this.cb=-1;this.g=l}function Wj(a,b){return a.h?!b.h||a.Ra>b.Ra?!0:a.j:!1}function Xj(a,b){return a.top-b.top}function Yj(a,b){return b.right-a.right}
function Zj(a,b){if(a===b)return!0;if(!a||!b||a.ea!==b.ea||a.L!==b.L||a.ka.length!==b.ka.length)return!1;for(var c=0;c<a.ka.length;c++){var d=a[c],e=b[c];if(!(d===e||d&&e&&d.node===e.node&&d.Sa===e.Sa&&d.ma===e.ma&&d.ya===e.ya&&d.wa===e.wa))return!1}return!0}function ak(a){return{ka:[{node:a.U,Sa:bk,ma:a.ma,ya:null,wa:null}],ea:0,L:!1,Ia:a.Ia}}function ck(a,b){var c=new dk(a.node,b,0);c.Sa=a.Sa;c.ma=a.ma;c.ya=a.ya;c.wa=a.wa?ck(a.wa,ek(b)):null;c.K=a.K;return c}var bk=0;
...
function dk(a,b,c){this.U=a;this.parent=b;this.na=c;this.ea=0;this.L=!1;this.Sa=bk;this.ma=b?b.ma:null;this.wa=this.ya=null;this.W=!1;this.Ba=!0;this.b=!1;this.l=b?b.l:0;this.A=this.h=this.ha=this.display=null;this.H="baseline";this.M="top";this.md=this.R=0;this.G=!1;this.Kb=b?b.Kb:0;this.j=b?b.j:null;this.u=b?b.u:!1;this.J=this.sc=!1;this.C=this.D=this.F=this.g=null;this.ob=b?b.ob:{};this.w=b?b.w:!1;this.V=b?b.V:"ltr";this.f=b?b.f:null;this.Ia=this.lang=null;this.K=b?b.K:null}
function hk(a){a.Ba=!0;a.l=a.parent?a.parent.l:0;a.D=null;a.C=null;a.ea=0;a.L=!1;a.display=null;a.h=null;a.A=null;a.H="baseline";a.G=!1;a.Kb=a.parent?a.parent.Kb:0;a.j=a.parent?a.parent.j:null;a.u=a.parent?a.parent.u:!1;a.g=null;a.F=null;a.ya=null;a.sc=!1;a.J=!1;a.w=a.parent?a.parent.w:!1;a.ya=null;a.Ia=null;a.K=a.parent?a.parent.K:null}
function ik(a){var b=new dk(a.U,a.parent,a.na);b.ea=a.ea;b.L=a.L;b.ya=a.ya;b.Sa=a.Sa;b.ma=a.ma;b.wa=a.wa;b.Ba=a.Ba;b.l=a.l;b.display=a.display;b.h=a.h;b.A=a.A;b.H=a.H;b.M=a.M;b.R=a.R;b.md=a.md;b.sc=a.sc;b.J=a.J;b.G=a.G;b.Kb=a.Kb;b.j=a.j;b.u=a.u;b.g=a.g;b.F=a.F;b.D=a.D;b.C=a.C;b.f=a.f;b.w=a.w;b.b=a.b;b.Ia=a.Ia;b.K=a.K;return b}dk.prototype.modify=function(){return this.W?ik(this):this};function ek(a){var b=a;do{if(b.W)break;b.W=!0;b=b.parent}while(b);return a}
dk.prototype.clone=function(){for(var a=ik(this),b=a,c;c=b.parent;)c=ik(c),b=b.parent=c;return a};function jk(a){return{node:a.U,Sa:a.Sa,ma:a.ma,ya:a.ya,wa:a.wa?jk(a.wa):null,K:a.K}}function kk(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(jk(b)),b=b.parent;while(b);b=a.Ia?lk(a.Ia,a.ea,-1):a.ea;return{ka:c,ea:b,L:a.L,Ia:a.Ia}}function mk(a){for(a=a.parent;a;){if(a.sc)return!0;a=a.parent}return!1}function nk(a){for(a=a.parent;a;){if(a.J)return a;a=a.parent}return null}
...
function wk(a){this.element=a;this.R=this.M=this.height=this.width=this.H=this.A=this.J=this.u=this.Ja=this.pa=this.Ta=this.ha=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.Mb=this.V=null;this.ta=this.Nb=this.nb=this.Xb=this.g=0;this.w=!1}function xk(a){return a.marginTop+a.pa+a.A}function yk(a){return a.marginBottom+a.Ja+a.H}function zk(a){return a.marginLeft+a.ha+a.u}function Ak(a){return a.marginRight+a.Ta+a.J}
...
function $k(a,b,c,d,e,f,g,h){this.da=a;this.root=a.root;this.Ja=c;this.h=d;this.u=f;this.f=this.root;this.M={};this.R={};this.C={};this.G=[];this.A=this.J=this.H=null;this.V=new Hi(b,d,g,h);this.g=new Hk;this.Pa=!0;this.ha=[];this.ta=e;this.ra=this.pa=!1;this.b=a=oj(a,this.root);this.W={};this.j=new Wk(d);Jk(this.g,a);d=al(this,this.root);Qi(this.V,this.root,d);bl(this,d,!1);this.F=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.F=
...
g.parentNode!=a.root||(bl(a,f,!0),a.F=!0);if(h=f["flow-into"]){var h=h.evaluate(e,"flow-into").toString(),l=il(a,h,f,g,a.b);a.Pa=!!a.ta[h];g=a.j.push(f,a.b,g===a.root,l)}else g=a.j.push(f,a.b,g===a.root);h=Zk(a.j,g);ll(a,g.g,h,g.b);g.h&&(l=Sk(g.h,"after"),ll(a,l,g.h.Na?h:g.offset,g.b));a.Pa&&Uk(g)===F&&(a.Pa=!1);if(oj(a.da,a.f)!=a.b)throw Error("Inconsistent offset");a.R["e"+a.b]=f;a.b++;a.Pa?Jk(a.g,a.b):Kk(a.g,a.b);if(b<a.b&&(0>d&&(d=Lk(a.g,b),d+=c),d<=Ik(a.g)))return Mk(a.g,d)}}}
...
Pl.prototype.Xd=function(a){var b=this,c=I("openAllViews"),d=a.ka;Ql(b.b,b.element,b.hd);var e=d.length-1,f=null;be(function(){for(;0<=e;){f=ck(d[e],f);e!==d.length-1||f.K||(f.K=b.Ud);if(!e){var c=f,h;h=a;h=h.Ia?lk(h.Ia,h.ea,1):h.ea;c.ea=h;f.L=a.L;f.Ia=a.Ia;if(f.L)break}c=Rl(b.b,f,!e&&!f.ea);e--;if(c.va())return c}return J(!1)}).then(function(){M(c,f)});return K(c)};var Sl=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
...
function Gm(a,b){if(!a.h)return J(!0);for(var c=!1,d=a.h.length-1;0<=d;--d){var e=a.h[d];if(e.na<=b)break;a.h.pop();e.b!==e.f&&(c=!0)}if(!c)return J(!0);var f=I("clearFootnotes"),g=a.g+a.za,h=a.h;a.C=null;a.h=null;var l=0;be(function(){for(;l<h.length;){var b=h[l++],b=jm(a,b.na,b.f,g);if(b.va())return b}return J(!1)}).then(function(){M(f,!0)});return K(f)}
...
function Nm(a,b,c,d){var e;if(!(e=!b))a:{for(e=b.D;e;){if(e.parentNode===e.ownerDocument){e=!1;break a}e=e.parentNode}e=!0}if(e)return!1;e=Cl(b,a.f,0,a.w);var f=b.L?b.parent&&b.parent.K:b.K;f&&(f=f.Zb())&&(e+=(a.w?-1:1)*Kl(f));f=Ll(a,e);c&&(e+=Cm(a,c));wm(a,e);c=ek(b);b=El(b.K).g(c,d,f,a.g);a.F.push(b);return f}
...
function Pm(a,b,c){function d(){b=m[0]||b;b.D.parentNode.removeChild(b.D);f.l=l}var e=b.L?b.parent&&b.parent.K:b.K;if(e&&!(e instanceof Ol))return J(b);var f=a,g=I("skipEdges"),h=c&&b&&b.L,l=null,k=null,m=[],p=[],q=!1;ce(function(a){for(;b;){do if(b.D){if(b.Ba&&1!=b.D.nodeType){if(Tj(b.D,b.Kb))break;if(!b.L){!c&&Tk[l]?d():Nm(f,k,null,l)?(b=(f.j?k||b:b).modify(),b.b=!0):(b=b.modify(),b.g=l);N(a);return}}if(!b.L&&(b.A&&Om(f,b),!(b.K instanceof Ol)||b.h||b.G)){m.push(ek(b));l=Rk(l,b.g);if(!c&&Tk[l])d();
...
l)&&(b=(f.j?k||b:b).modify(),b.b=!0);N(a);return}!e||Mm(e.paddingTop)&&Mm(e.borderTopWidth)||(h=!1,p=[]);q=!0}}}while(0);e=Wl(f.b,b,h);if(e.va()){e.then(function(c){b=c;ee(a)});return}b=e.get()}Nm(f,k,p,l)?k&&f.j&&(b=k.modify(),b.b=!0):Tk[l]&&(f.l=l);N(a)}).then(function(){M(g,b)});return K(g)}
function Lm(a,b){var c=ek(b),d=I("skipEdges"),e=null,f=!1;ce(function(d){for(;b;){do if(b.D){if(b.Ba&&1!=b.D.nodeType){if(Tj(b.D,b.Kb))break;if(!b.L){Tk[e]&&(a.l=e);N(d);return}}if(!b.L&&(b.h||b.G)){e=Rk(e,b.g);Tk[e]&&(a.l=e);N(d);return}if(1==b.D.nodeType){var g=b.D.style;if(b.L){if(f){if(Tk[e]){a.l=e;N(d);return}e=null}f=!1;e=Rk(e,b.F)}else{e=Rk(e,b.g);if(Bl[b.D.localName]){Tk[e]&&(a.l=e);N(d);return}if(g&&(!Mm(g.paddingTop)||!Mm(g.borderTopWidth))){N(d);return}}f=!0}}while(0);g=Wl(a.b,b);if(g.va()){g.then(function(a){b=
a;ee(d)});return}b=g.get()}c=null;N(d)}).then(function(){M(d,c)});return K(d)}function Yl(a,b){return"footnote"==b.h?pm(a,b):rm(a,b)}function Qm(a,b,c){var d=I("layoutNext");Pm(a,b,c).then(function(c){b=c;!b||a.l||a.j&&b&&b.b?M(d,b):El(b.K).f(b,a).Da(d)});return K(d)}function Rm(a,b){do{var c=a.D.parentNode;if(!c)break;var d=c,e=a.D;if(d)for(var f;(f=d.lastChild)!=e;)d.removeChild(f);b&&(c.removeChild(a.D),b=!1);a=a.parent}while(a)}
...
function Sm(a,b){var c=b.b;if(!c)return J(!0);var d=I("layoutOverflownFootnotes"),e=0;be(function(){for(;e<c.length;){var b=c[e++],b=jm(a,0,b,a.za);if(b.va())return b}return J(!1)}).then(function(){M(d,!0)});return K(d)}
...
function En(a,b){this.f=a;this.b=b;this.J={};this.style={};this.A=this.C=null;this.u=[];this.M=this.R=this.g=this.h=!1;this.G=this.H=0;this.F=null;this.pa={};this.ha={};this.ta=this.w=!1;a&&a.u.push(this)}function Fn(a){a.H=0;a.G=0}function Gn(a,b,c){b=tn(a,b);c=tn(a,c);if(!b||!c)throw Error("E_INTERNAL");return y(a.b.f,b,c)}
...
function Qn(a,b,c){var d=Z(a,b,"snap-height"),e=Z(a,b,"top"),f=Z(a,b,"margin-top"),g=Z(a,b,"padding-top");b=Z(a,b,"border-top-width");c.top=e;c.marginTop=f;c.pa=b;c.nb=d;!a.w&&0<d&&(a=e+xk(c),a-=Math.floor(a/d)*d,0<a&&(c.ta=d-a,g+=c.ta));c.A=g;w(c.element,"top",e+"px");w(c.element,"margin-top",f+"px");w(c.element,"padding-top",g+"px");w(c.element,"border-top-width",b+"px")}
function Rn(a,b,c){var d=Z(a,b,"margin-bottom"),e=Z(a,b,"padding-bottom"),f=Z(a,b,"border-bottom-width");a=Z(a,b,"height")-c.ta;w(c.element,"height",a+"px");w(c.element,"margin-bottom",d+"px");w(c.element,"padding-bottom",e+"px");w(c.element,"border-bottom-width",f+"px");c.height=a-c.ta;c.marginBottom=d;c.Ja=f;c.H=e}function Sn(a,b,c){a.w?(Qn(a,b,c),Rn(a,b,c)):(Pn(a,b,c),On(a,b,c))}
function Tn(a,b,c){w(c.element,"border-top-width","0px");var d=Z(a,b,"max-height");a.R?Ck(c,0,d):(Qn(a,b,c),d-=c.ta,c.height=d,w(c.element,"height",d+"px"))}function Un(a,b,c){w(c.element,"border-left-width","0px");var d=Z(a,b,"max-width");a.M?Dk(c,0,d):(Pn(a,b,c),d-=c.Nb,c.width=d,a=Z(a,b,"right"),w(c.element,"right",a+"px"),w(c.element,"width",d+"px"))}
...
En.prototype.Pc=function(a,b,c,d,e,f,g){this.w?this.H=b.g+b.Nb:this.G=b.g+b.ta;var h=(this.w||!d)&&this.g,l=(!this.w||!d)&&this.h;if(l||h)l&&w(b.element,"width","auto"),h&&w(b.element,"height","auto"),d=Rj(f,d?d.element:b.element),l&&(this.H=Math.ceil(d.right-d.left-b.u-b.ha-b.J-b.Ta),this.w&&(this.H+=b.Nb)),h&&(this.G=d.bottom-d.top-b.A-b.pa-b.H-b.Ja,this.w||(this.G+=b.ta));(this.w?this.g:this.h)&&Sn(this,a,b);if(this.w?this.h:this.g){if(this.w?this.M:this.R)this.w?Pn(this,a,b):Qn(this,a,b);this.w?
...
function Oo(a,b,c,d,e,f){for(var g=Ed.RESOLVE_FORMATTING_CONTEXT||[],h=0;h<g.length;h++){var l=g[h](a,b,c,d,e,f);if(l){a.K=l;break}}}
...
function Wo(a){if(a.B.Ia)return J(!0);var b,c=b=a.U.textContent,d=I("preprocessTextContent"),e=Ed.PREPROCESS_TEXT_CONTENT||[],f=0;be(function(){return f>=e.length?J(!1):e[f++](a.B,c).sa(function(a){c=a;return J(!0)})}).then(function(){a.B.Ia=Yo(b,c,0);M(d,!0)});return K(d)}
...
function $o(a){if(null==a.ma||"content"!=a.U.localName||"http://www.pyroxy.com/ns/shadow"!=a.U.namespaceURI)return a;var b=a.na,c=a.ma,d=a.parent,e,f;c.ie?(f=c.ie,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.Gd,e=c.ia.firstChild,c=2);var g=a.U.nextSibling;g?(a.U=g,hk(a)):a.wa?a=a.wa:e?a=null:(a=a.parent.modify(),a.L=!0);if(e)return b=new dk(e,d,b),b.ma=f,b.Sa=c,b.wa=a,b;a.na=b;return a}
function ap(a){var b=a.na+1;if(a.L){if(!a.parent)return null;if(3!=a.Sa){var c=a.U.nextSibling;if(c)return a=a.modify(),a.na=b,a.U=c,hk(a),$o(a)}if(a.wa)return a=a.wa.modify(),a.na=b,a;a=a.parent.modify()}else{if(a.ya&&(c=a.ya.root,2==a.ya.type&&(c=c.firstChild),c))return b=new dk(c,a,b),b.ma=a.ya,b.Sa=a.ya.type,$o(b);if(c=a.U.firstChild)return $o(new dk(c,a,b));1!=a.U.nodeType&&(c=Xo(a.Ia),b+=c.length-1-a.ea);a=a.modify()}a.na=b;a.L=!0;return a}
...
function Ul(a,b,c){var d=I("peelOff"),e=b.f,f=b.ea,g=b.L;if(0<c)b.D.textContent=b.D.textContent.substr(0,c),f+=c;else if(!g&&b.D&&!f){var h=b.D.parentNode;h&&h.removeChild(b.D)}for(var l=b.na+c,k=[];b.f===e;)k.push(b),b=b.parent;var m=k.pop(),p=m.wa;be(function(){for(;0<k.length;){m=k.pop();b=new dk(m.U,b,l);k.length||(b.ea=f,b.L=g);b.Sa=m.Sa;b.ma=m.ma;b.ya=m.ya;b.wa=m.wa?m.wa:p;p=null;var c=Rl(a,b,!1);if(c.va())return c}return J(!1)}).then(function(){M(d,b)});return K(d)}
...
function aq(a){var b;a.g||a.C.length?b=[a.g].concat(a.C.sort()):b=null;a.G.push({ee:b,X:a.X});a.g="";a.C=[]}n.cc=function(){aq(this);Vi.prototype.cc.call(this)};n.xa=function(){aq(this);Vi.prototype.xa.call(this)};
...
function hq(a,b,c,d,e,f,g,h,l,k,m){vb.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.da=b;this.lang=b.lang||c;this.viewport=d;this.l={body:!0};this.g=e;this.A=this.b=this.H=this.f=this.F=null;this.C=0;this.nb=f;this.h=new sl(this.style.C);this.pa={};this.V=null;this.j=m;this.R={};this.ha=null;this.Ta=g;this.mb=h;this.ra=l;this.lb=k;for(var p in a.h)(b=a.h[p]["flow-consume"])&&(b.evaluate(this,"flow-consume")==Ec?this.l[p]=!0:delete this.l[p]);this.ta={}}u(hq,vb);
...
op(np(f[a]),this);this.ta[a]={width:b.Eb+2*b.rd,height:b.Db+2*b.rd}},a);return K(b)}function kl(a,b,c){if(a=a.b)a.f[b.b]||(a.f[b.b]=c),c=a.b[b.b],c||(c=new sk,a.b[b.b]=c),c.b.push(new rk(new pk({ka:[{node:b.element,Sa:bk,ma:null,ya:null,wa:null}],ea:0,L:!1,Ia:null}),b))}function jq(a,b){for(var c=Number.POSITIVE_INFINITY,d=0;d<b.b.length;d++){for(var e=b.b[d].f.Pa,f=e.ka[0].node,g=e.ea,h=e.L,l=0;f.ownerDocument!=a.da.b;)l++,f=e.ka[l].node,h=!1,g=0;e=pj(a.da,f,g,h);e<c&&(c=e)}return c}
...
r.u+"px"),w(d,"margin-right",r.J+"px"),c=c*(Ya+W)+r.A,Dk(P,0,r.width),Ck(P,c,Ya)):(w(d,"margin-top",r.A+"px"),w(d,"margin-bottom",r.H+"px"),c=c*(Ya+W)+r.u,Ck(P,0,r.height),Dk(P,c,Ya));P.M=e+r.u;P.R=f+r.A}else P=new Pl(q,va,a.g,L),Bk(P,r),r=P;P.V=p?[]:g;P.Mb=lc;if(0<=P.width){var k=I("inner");nq(a,P,H).then(function(){P.l&&"column"!=P.l&&(Eb=G,"region"!=P.l&&(a.R[H]=!0));M(k,!0)});c=K(k)}else c=J(!0);if(c.va()){c.then(function(){0<h.b.length?N(b):(pb=Math.max(pb,P.g),ee(b))});return}0<h.b.length||
(pb=Math.max(pb,P.g))}N(b)}).then(function(){r.g=pb;c.Pc(a,r,b,P,G,a.g,a.h);M(A,!0)});l=K(A)}else{if((l=Mn(c,a,"content"))&&Fk(l)){x="span";l.url&&(x="img");var Zi=a.viewport.b.createElement(x);l.aa(new Ek(Zi,a,l));q.appendChild(Zi);"img"==x&&ao(c,a,Zi,a.h);$n(c,a,r,a.h)}else c.ta&&(d.removeChild(q),t=!0);t||c.Pc(a,r,b,null,1,a.g,a.h);l=J(!0)}l.then(function(){if(!c.g||0<Math.floor(r.g)){if(!t&&!m){var l=r.M+r.left,p=r.R+r.top,x=zk(r)+r.width+Ak(r),A=xk(r)+r.height+yk(r),H=Mn(c,a,"shape-outside"),
l=ng(H,l,p,x,A,a);g.push(l)}}else if(!c.u.length){d.removeChild(q);M(k,!0);return}var G=c.u.length-1;be(function(){for(;0<=G;){var d=c.u[G--],d=oq(a,b,d,q,e,f,g,h);if(d.va())return d}return J(!1)}).then(function(){M(k,!0)})});return K(k)}
...
n.Bc=function(a){var b=this.g.C;if(a){var c=uh(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}cf(this.g,new cj(this.f,this.ia,null,b,this.g.h))};n.cd=function(){this.C=!0;this.rb()};n.ec=function(){var a=new $p(this.g.u,this.g,this,this.u,this.g.F);cf(this.g,a);a.ec()};n.xa=function(){Vi.prototype.xa.call(this);if(this.C){this.C=!1;var a="R"+this.g.M++,b=C(a),c;this.T?c=new ph(b,0,this.T):c=new U(b,0);vh(this.Va,"region-id").push(c);this.zb();a=new rq(this.g,this.T,this,a);cf(this.g,a);a.xa()}};
...
Gq.prototype.load=function(a){var b=ha(a);if(a=this.C[b])return a.va()?a:J(a.get());var c=I("EPUBDocStore.load");a=Gq.Je.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?M(c,a):v.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return K(c)};function Nq(){this.id=null;this.src="";this.h=this.f=null;this.N=-1;this.l=0;this.u=null;this.b=this.g=0;this.Tb=this.cb=null;this.j=Ja}
...
function pr(a,b,c){b="left"===b.l;a="ltr"===a.Bb(c);return!b&&a||b&&!a}function qr(a,b,c){var d=I("getCurrentSpread"),e=gr(a,b);if(!e)return J({left:null,right:null});var f="left"===e.l;(pr(a,e,b)?a.Hd(b):a.nextPage(b,c)).then(function(a){a=a&&a.page;f?M(d,{left:e,right:a}):M(d,{left:a,right:e})});return K(d)}n.We=function(a,b){var c=gr(this,a);if(!c)return J(null);var c=pr(this,c,a),d=this.nextPage(a,!!b);if(c)return d;var e=this;return d.sa(function(a){return a?e.nextPage(a.position,!!b):J(null)})};
n.Ze=function(a){var b=gr(this,a);if(!b)return J(null);b=pr(this,b,a);a=this.Hd(a);if(b){var c=this;return a.sa(function(a){return a?c.Hd(a.position):J(null)})}return a};function rr(a,b){var c=I("navigateToEPage");cr(a.b,b).then(function(b){b?mr(a,b).Da(c):M(c,null)});return K(c)}function sr(a,b){var c=I("navigateToCFI");br(a.b,b).then(function(b){b?mr(a,b).Da(c):M(c,null)});return K(c)}
...
function(){e.La=!0;e.J()};this.Fd=this.Fd.bind(this);this.G=function(){};this.H=a.getElementById("vivliostyle-page-rules");this.R=!1;this.l=null;this.pa={loadEPUB:this.Me,loadXML:this.Ne,configure:this.Sd,moveTo:this.ta,toc:this.Xc};yr(this)}function yr(a){ga(1,function(a){zr(this,{t:"debug",content:a})}.bind(a));ga(2,function(a){zr(this,{t:"info",content:a})}.bind(a));ga(3,function(a){zr(this,{t:"warn",content:a})}.bind(a));ga(4,function(a){zr(this,{t:"error",content:a})}.bind(a))}
...
function Cr(a,b){Dr(a);var c;b?c=br(a.h,b).sa(function(b){a.f=b;return J(!0)}):c=J(!0);return c.sa(function(){Br.b("beforeRender");return Er(a)})}function Fr(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*tb.ex*a.fontSize/tb.em;if(d=tb[d])return c*d}return c}
...
function Hr(a,b,c){a.Cb=!1;Jr(a);if(a.$.kb)return qr(a.b,a.f,c).sa(function(c){Kr(a);a.j=c;c.left&&(Lr(a,c.left),c.right||c.left.S.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Lr(a,c.right),c.left||c.right.S.setAttribute("data-vivliostyle-unpaired-page",!0));c=Sr(a,c);a.viewport.zoom(c.width,c.height,a.F?Tr(a,c):a.zoom);a.g=b;return J(null)});Mr(a,b);a.viewport.zoom(b.f.width,b.f.height,a.F?Tr(a,b.f):a.zoom);a.g=b;return J(null)}
...
function is(a,b){var c=a.b,d=c.ve(b),e=I("LayoutIterator");ce(function(a){for(var b;d.B;){b=d.B.D?1!==d.B.D.nodeType?Tj(d.B.D,d.B.Kb)?void 0:d.B.L?void 0:c.He(d):d.B.Ba?void 0:d.B.L?c.mc(d):c.he(d):void 0;b=(b&&b.va()?b:J(!0)).sa(function(){return d.xb?J(null):Wl(this.f,d.B,d.Kc)}.bind(this));if(b.va()){b.then(function(b){d.xb?N(a):(d.B=b,ee(a))});return}if(d.xb){N(a);return}d.B=b.get()}N(a)}.bind(a)).then(function(){M(e,d.B)});return K(e)}function js(a){this.Sc=a}u(js,gs);n=js.prototype;n.Ie=function(){};
n.pe=function(){};n.ve=function(a){return{B:a,Kc:!!this.Sc&&a.L,xb:!1,Sc:this.Sc,oc:null,Cd:!1,Ae:[],ze:null}};n.He=function(a){a.Cd=!1};n.he=function(a){a.Ae.push(ek(a.B));a.oc=Rk(a.oc,a.B.g);a.Cd=!0;return this.Ie(a)};n.mc=function(a){var b;a.Cd?(b=(b=void 0,J(!0)),b=b.sa(function(){a.xb||(a.Ae=[],a.Sc=!1,a.Kc=!1,a.oc=null);return J(!0)})):b=(b=this.pe(a))&&b.va()?b:J(!0);return b.sa(function(){a.xb||(a.Cd=!1,a.ze=ek(a.B),a.oc=Rk(a.oc,a.B.F));return J(!0)})};
function ks(a,b,c){this.ge=[];this.b=Object.create(a);this.b.element=b;this.b.b=a.b.clone();this.b.j=!1;this.b.Ud=c.K;a=Hm(this.b,c);this.b.G-=a;var d=this;this.b.Xd=function(a){return Pl.prototype.Xd.call(this,a).sa(function(a){var b=ek(a);d.ge.push(b);return J(a)})}}ks.prototype.Ab=function(a){var b=this.b.Ab();if(a){a=b.Mc?b.Mc.b():Number.MAX_VALUE;var c=this.ge[0],c=new Jl(ek(c),null,c.b,0),d=c.f(this.b,a);if(d&&c.b()<a)return{Mc:c,B:d}}return b};
...
var vs={now:Date.now},Br,ws=Br=new us(window&&window.performance||vs);ss.call(ws,"load_vivliostyle","start",void 0);ba("vivliostyle.profile.profiler",ws);us.prototype.printTimings=us.prototype.l;us.prototype.disable=us.prototype.u;us.prototype.enable=us.prototype.A;function xs(a,b,c){var d=a.B,e=d.display,f=d.parent?d.parent.display:null;return"table-row"===e&&!ys(f)&&"table"!==f&&"inline-table"!==f||"table-cell"===e&&"table-row"!==f&&!ys(f)&&"table"!==f&&"inline-table"!==f||d.K instanceof zs&&d.K!==b?Zl(c,d).sa(function(b){a.B=b;return J(!0)}):null}function ys(a){return"table-row-group"===a||"table-header-group"===a||"table-footer-group"===a}function As(a,b){this.rowIndex=a;this.U=b;this.b=[]}
function Bs(a){return Math.min.apply(null,a.b.map(function(a){return a.height}))}function Cs(a,b,c){this.rowIndex=a;this.h=b;this.g=c;this.b=c.colSpan||1;this.rowSpan=c.rowSpan||1;this.height=0;this.f=null}function Ds(a,b,c){this.rowIndex=a;this.b=b;this.qc=c}function Es(a,b,c){this.g=a;this.b=c;this.Uc=new ks(a,b,c);this.f=!1}Es.prototype.Ab=function(){return this.Uc.Ab(!0)};function Fs(a,b){this.D=a;this.b=b}function Gs(a,b,c,d){Jl.call(this,a,b,c,d);this.K=a.K;this.rowIndex=this.j=null}u(Gs,Jl);
Gs.prototype.f=function(a,b){var c=Jl.prototype.f.call(this,a,b);return b<this.b()?null:Hs(this).every(function(a){return!!a.B})?c:null};Gs.prototype.b=function(){var a=Jl.prototype.b.call(this);Hs(this).forEach(function(b){a+=b.Mc.b()});return a};function Hs(a){a.j||(a.j=Is(a).map(function(a){return a.Ab()}));return a.j}function Is(a){return Js(a.K,null!=a.rowIndex?a.rowIndex:a.rowIndex=Ks(a.K,a.position.U)).map(a.K.Zd,a.K)}function Ls(a,b,c){this.rowIndex=a;this.j=b;this.K=c;this.h=null}u(Ls,Fl);
Ls.prototype.f=function(a,b){if(b<this.b())return null;var c=Ms(this),d=Ns(this);return d.every(function(a){return!!a.B})&&d.some(function(a,b){var d=a.B,e=c[b].Uc.ge[0];return!(e.D===d.D&&e.L===d.L&&e.ea===d.ea)})?this.j:null};Ls.prototype.b=function(){var a=this.K,b=0;Os(a,a.f[this.rowIndex])||(b+=10);Ns(this).forEach(function(a){b+=a.Mc.b()});return b};function Ns(a){a.h||(a.h=Ms(a).map(function(a){return a.Ab()}));return a.h}Ls.prototype.g=function(){return Gl(this.j)};
function Ms(a){return Ps(a.K,a.rowIndex).map(a.K.Zd,a.K)}function zs(a,b){this.parent=a;this.j=b;this.w=this.G=!1;this.u=-1;this.J=0;this.C=[];this.F=this.l=null;this.M=0;this.f=[];this.H=[];this.h=[];this.A=null;this.b=[];this.g=null}n=zs.prototype;n.le=function(){return"Table formatting context (vivliostyle.table.TableFormattingContext)"};
n.xe=function(a,b){if(!b)return b;switch(a.display){case "table-row":return!this.b.length;case "table-cell":return!this.b.some(function(b){return b.Rd.ka[0].node===a.U});default:return b}};n.me=function(){return this.parent};function Qs(a,b){do if(b.U===a.j)return b.D;while(b=b.parent);return null}function Rs(a,b){var c=a.H[b];c||(c=a.H[b]=[]);return c}function Ks(a,b){return a.f.findIndex(function(a){return b===a.U})}function Ss(a,b,c,d){var e=a.h[b];e||(e=a.h[b]=[]);e[c]=d}
function Ps(a,b){return Rs(a,b).reduce(function(a,b){return b.qc!==a[a.length-1]?a.concat(b.qc):a},[])}function Js(a,b){return Ps(a,b).filter(function(a){return a.rowIndex+a.rowSpan-1>b})}n.Zd=function(a){return this.h[a.rowIndex][a.h]};function Os(a,b){return Bs(b)>a.J/2}function Ts(a){0>a.u&&(a.u=Math.max.apply(null,a.f.map(function(a){return a.b.reduce(function(a,b){return a+b.b},0)})));return a.u}
function Us(a,b){a.f.forEach(function(a){a.b.forEach(function(a){var c=Rj(b,a.g);a.g=null;a.height=this.w?c.width:c.height},this)},a)}n.Zb=function(){return this.g};function Vs(a,b){this.K=a;this.h=b;this.rowIndex=-1;this.f=0;this.g=!1}u(Vs,gs);
Vs.prototype.he=function(a){var b=this.K,c=xs(a,b,this.h);if(c)return c;a=a.B;switch(a.display){case "table":b.M=a.R;break;case "table-caption":b.C.push(new Fs(a.D,a.M));break;case "table-header-group":this.b=!0;b=b.g;b.f||(b.f=a.D);break;case "table-footer-group":this.b=!0;b=b.g;b.b||(b.b=a.D);break;case "table-row":this.b||(this.g=!0,this.rowIndex++,this.f=0,b.f[this.rowIndex]=new As(this.rowIndex,a.U))}return J(!0)};
Vs.prototype.mc=function(a){var b=this.K,c=a.B,d=c.display,e=this.h.f;if(c.U===b.j)c=em(e,Qs(b,c)),b.J=parseFloat(c[b.w?"height":"width"]),a.xb=!0;else switch(d){case "table-header-group":case "table-footer-group":this.b=!1;break;case "table-row":this.b||(b.A=c.D,this.g=!1);break;case "table-cell":if(!this.b){this.g||(this.rowIndex++,this.f=0,this.g=!0);a=this.rowIndex;c=new Cs(this.rowIndex,this.f,c.D);d=b.f[a];d||(b.f[a]=new As(a,null),d=b.f[a]);d.b.push(c);for(var d=a+c.rowSpan,e=Rs(b,a),f=0;e[f];)f++;
for(;a<d;a++)for(var e=Rs(b,a),g=f;g<f+c.b;g++){var h=e[g]=new Ds(a,g,c);c.f||(c.f=h)}this.f++}}};function Ws(a,b){this.Sc=!0;this.K=a;this.f=b;this.l=!1;this.b=-1;this.g=0;this.u=b.j;b.j=!1}u(Ws,js);var Xs={"table-caption":!0,"table-column-group":!0,"table-column":!0,"table-header-group":!0,"table-footer-group":!0};function Ys(a,b){for(var c=a.K.F,d=0,e=0;e<b.b;e++)d+=c[b.f.b+e];return d+=a.K.M*(b.b-1)}
function Zs(a,b,c,d){var e=b.rowIndex,f=b.h,g=c.D,h=c.H;1<b.b&&(w(g,"box-sizing","border-box"),w(g,a.K.w?"height":"width",Ys(a,b)+"px"));b=g.ownerDocument.createElement("div");g.appendChild(b);c=new Es(a.f,b,c);Ss(a.K,e,f,c);1===d.Pa.ka.length&&d.Pa.L&&(c.f=!0);return om(c.Uc.b,d,!0).sa(function(){"baseline"!==h&&"top"!==h&&w(g,"vertical-align","top");return J(!0)})}function $s(a,b){var c=a.K.b[0];return c?c.qc.f.b===b:!1}
function at(a){var b=a.K.b;if(!b.length)return[];var c=[],d=0;do{var e=b[d],f=e.qc.rowIndex;if(f<a.b){var g=c[f];g||(g=c[f]=[]);g.push(e);b.splice(d,1)}else d++}while(d<b.length);return c}
function bt(a,b){var c=a.K,d=at(a),e=d.reduce(function(a){return a+1},0);if(0===e)return J(!0);var f=a.f.b,g=b.B;g.D.parentNode.removeChild(g.D);var h=I("layoutRowSpanningCellsFromPreviousFragment"),l=J(!0),k=0,m=[];d.forEach(function(a){l=l.sa(function(){var b=ck(a[0].Rd.ka[1],g.parent);return Rl(f,b,!1).sa(function(){function d(a){for(;h<a;){if(!(0<=m.indexOf(h))){var c=b.D.ownerDocument.createElement("td");w(c,"padding","0");b.D.appendChild(c)}h++}}var g=J(!0),h=0;a.forEach(function(a){g=g.sa(function(){var c=
a.qc;d(c.f.b);var g=a.Rd,l=ck(g.ka[0],b);l.ea=g.ea;l.L=g.L;return Rl(f,l,!1).sa(function(){for(var b=a.oe,d=0;d<c.b;d++)m.push(h+d);h+=c.b;return Zs(this,c,l,b).sa(function(){l.D.rowSpan=c.rowIndex+c.rowSpan-this.b+e-k;return J(!0)}.bind(this))}.bind(this))}.bind(this))},this);return g.sa(function(){d(Ts(c));k++;return J(!0)})}.bind(this))}.bind(this))},a);l.then(function(){Rl(f,g,!0,b.Kc).then(function(){M(h,!0)})});return K(h)}
function ct(a,b){if(a.j||a.h)return J(!0);var c=b.B,d=a.K;0>a.b?a.b=Ks(d,c.U):a.b++;a.g=0;a.l=!0;return bt(a,b).sa(function(){Nm(this.f,b.ze,null,b.oc)&&!Js(d,this.b-1).length&&(this.f.j=this.u,c.b=!0,b.xb=!0);return J(!0)}.bind(a))}
function dt(a,b){if(a.j||a.h)return J(!0);var c=b.B;a.l||(0>a.b?a.b=0:a.b++,a.g=0,a.l=!0);var d=a.K.f[a.b].b[a.g],e=ek(c).modify();e.L=!0;b.B=e;var f=I("startTableCell");$s(a,d.f.b)?(e=a.K.b.shift(),e=J(e.oe)):e=Wl(a.f.b,c,b.Kc).sa(function(a){a.D&&c.D.removeChild(a.D);return J(new pk(ak(a)))});e.then(function(a){Zs(this,d,c,a).then(function(){this.mc(b);this.g++;M(f,!0)}.bind(this))}.bind(a));return K(f)}
Ws.prototype.Ie=function(a){var b=xs(a,this.K,this.f);if(b)return b;b=a.B.display;return"table-header-group"===b?(this.j=!0,J(!0)):"table-footer-group"===b?(this.h=!0,J(!0)):"table-row"===b?ct(this,a):"table-cell"===b?dt(this,a):J(!0)};Ws.prototype.pe=function(a){a=a.B;"table-row"===a.display&&(this.l=!1,this.j||this.h||(a=ek(a).modify(),a.L=!1,this.f.F.push(new Ls(this.b,a,this.K))));return J(!0)};
Ws.prototype.mc=function(a){var b=a.B,c=b.display;"table-header-group"===c?this.j=!1:"table-footer-group"===c&&(this.h=!1);if(c&&Xs[c])b.D.parentNode.removeChild(b.D);else if(b.U===this.K.j)this.f.j=this.u,a.xb=!0;else return js.prototype.mc.call(this,a);return J(!0)};function et(){}
function ft(a,b,c,d){for(var e=a.ownerDocument,f=e.createElement("tr"),g=[],h=0;h<b;h++){var l=e.createElement("td");f.appendChild(l);g.push(l)}a.parentNode.insertBefore(f,a.nextSibling);b=g.map(function(a){a=Rj(d,a);return c?a.height:a.width});a.parentNode.removeChild(f);return b}function gt(a){var b=[];for(a=a.firstElementChild;a;)"colgroup"===a.localName&&b.push(a),a=a.nextElementSibling;return b}
function ht(a){var b=[];a.forEach(function(a){var c=a.span;a.removeAttribute("span");for(var e=a.firstElementChild;e;){if("col"===e.localName){var f=e.span;e.removeAttribute("span");for(c-=f;1<f--;){var g=e.cloneNode(!0);a.insertBefore(g,e);b.push(g)}b.push(e)}e=e.nextElementSibling}for(;0<c--;)e=a.ownerDocument.createElement("col"),a.appendChild(e),b.push(e)});return b}
function it(a,b,c,d){if(a.length<c){var e=d.ownerDocument.createElement("colgroup");b.push(e);for(b=a.length;b<c;b++){var f=d.ownerDocument.createElement("col");e.appendChild(f);a.push(f)}}}function jt(a,b,c){var d=a.w,e=a.A;if(e){a.A=null;var f=e.ownerDocument.createDocumentFragment(),g=Ts(a);if(0<g){var h=a.F=ft(e,g,d,c.f);c=gt(b);e=ht(c);it(e,c,g,b);e.forEach(function(a,b){w(a,d?"height":"width",h[b]+"px")});c.forEach(function(a){f.appendChild(a.cloneNode(!0))})}a.l=f}}
function kt(a,b,c){var d=b.K;d.w=b.w;d.g=new ls(d.w);var e=I("TableLayoutProcessor.doInitialLayout");is(new hs(new Vs(b.K,c),c.b),b).then(function(a){var b=a.D,f=Rj(c.f,b);Ll(c,c.w?f.left:f.bottom)?(jt(d,b,c),Us(d,c.f),a=d.g,b=c.f,a.f&&(a.F=ms(a,a.f,b)),a.b&&(a.C=ms(a,a.b,b)),M(e,null)):M(e,a)}.bind(a));return K(e)}function lt(a,b,c){var d=a.C;d.forEach(function(a,f){a&&(b.insertBefore(a.D,c),"top"===a.b&&(d[f]=null))})}
function mt(a,b){if(a.l&&b){var c=gt(b);c&&c.forEach(function(a){b.removeChild(a)})}}et.prototype.f=function(a,b){var c=a.K,d=I("TableLayoutProcessor.layout"),e=nt(a,c),f=ek(a),g=[].concat(c.b),h=[].concat(b.F);e.g(this,a,b).then(function(l){var k=e.f(l,c,b);e.b(l,c,k);if(k)M(d,l);else{for(l=f.D||f.parent.D;k=l.lastChild;)l.removeChild(k);for(;k=l.nextSibling;)k.parentNode.removeChild(k);mt(c,Qs(c,f));b.F=h;c.h=[];c.b=g;this.f(a,b).Da(d)}}.bind(this));return K(d)};
et.prototype.g=function(a,b,c,d){return new Gs(a,b,c,d)};
et.prototype.b=function(a,b){var c=b.K,d=c.g;d.j||b.U===c.j&&b.L||ps(d);if("table-row"===b.display){var e=Ks(c,b.U);c.b=[];var f;f=b.L?Js(c,e):Ps(c,e);if(f.length){var g=I("TableLayoutProcessor.finishBreak"),h=0;ce(function(a){if(h===f.length)N(a);else{var b=f[h++],d=c.Zd(b),g=d.Ab().B,l=d.b,x=kk(l),r=new pk(kk(g));c.b.push({Rd:x,oe:r,qc:b});var t=l.D;Vm(d.b);e<b.rowIndex+b.rowSpan-1&&(t.rowSpan=e-b.rowIndex+1);d.f?ee(a):Bm(d.Uc.b,g,!1,!0).then(function(){var b=l.H;"baseline"!==b&&"top"!==b&&w(t,
"vertical-align",b);if(b=c.Zb()){var e=c.w,f=d.g,g=d.Uc.b.element,h=d.b.D,k=Rj(f.f,h),h=fm(f,h);e?w(g,"max-width",k.right-f.G-Kl(b)-h.right+"px"):w(g,"max-height",f.G-Kl(b)-k.top-h.top+"px");w(g,"overflow","hidden")}ee(a)})}}).then(function(){d&&ns(d);c.h=[];Rm(b,!1);Vm(b);M(g,!0)});return K(g)}}d&&ns(d);c.h=[];return null};function nt(a,b){if(b.G){var c=b.Zb();a.U===b.j&&!a.L&&c&&(c.h=!1,c.l=!1);return new ot}return new pt}function pt(){}pt.prototype.g=function(a,b,c){return kt(a,b,c)};
pt.prototype.f=function(a){return!!a};pt.prototype.b=function(a,b){b.G=!0};function ot(){}ot.prototype.g=function(a,b,c){a=b.K;var d=a.g,e=Qs(a,b),f=e.firstChild;lt(a,e,f);a.l&&e.insertBefore(a.l.cloneNode(!0),f);if(d.f&&!d.h){var g=d.f.cloneNode(!0);d.A.push(g);e.insertBefore(g,f)}d.b&&!d.g&&(g=d.b.cloneNode(!0),d.u.push(g),e.insertBefore(g,f));a=new Ws(a,c);c=new hs(a,c.b);a=I("TableFormattingContext.doLayout");is(c,b).Da(a);return K(a)};
ot.prototype.f=function(a,b,c){var d=b.Zb();if(!d)return!0;c=c.Ab();return a.U===b.j&&a.L&&d.g?(d.g=!1,d.j=!1):!d.g&&d.j&&d.b||!d.h&&d.l&&d.f?!!c.B&&!c.B.b:!0};ot.prototype.b=function(a,b,c){(a=b.Zb())&&!c&&(os(a),ps(a),!a.g&&a.j&&a.b?a.g=!0:!a.h&&a.l&&a.f&&(a.h=!0))};var qt=new et;Fd("RESOLVE_FORMATTING_CONTEXT",function(a,b,c){return b?c===od?(b=a.parent,new zs(b?b.K:null,a.U)):null:null});Fd("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof zs?qt:null});Array.from||(Array.from=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e],e):a[e];return c});
...
Object.assign||(Object.assign=function(a,b){if(!b)return a;Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function rt(a){function b(a){return"number"===typeof a?a:null}function c(a){return"string"===typeof a?{url:a,cb:null,Tb:null}:{url:a.url,cb:b(a.startPage),Tb:b(a.skipPagesBefore)}}return Array.isArray(a)?a.map(c):a?[c(a)]:null}function st(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}
function tt(a,b){hj=a.debug;this.g=!1;this.h=a;this.Ob=new xr(a.window||window,a.viewportElement,"main",this.Oe.bind(this));this.f={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,pageViewMode:"autoSpread",zoom:1,fitToScreen:!1};b&&this.Ge(b);this.b=new Na;Object.defineProperty(this,"readyState",{get:function(){return this.Ob.A}})}n=tt.prototype;n.Ge=function(a){var b=Object.assign({a:"configure"},st(a));this.Ob.u(b);Object.assign(this.f,a)};
n.Oe=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});Oa(this.b,b)};n.cf=function(a,b){this.b.addEventListener(a,b,!1)};n.ff=function(a,b){this.b.removeEventListener(a,b,!1)};n.Se=function(a,b,c){a||Oa(this.b,{type:"error",content:"No URL specified"});ut(this,a,null,b,c)};n.df=function(a,b,c){a||Oa(this.b,{type:"error",content:"No URL specified"});ut(this,null,a,b,c)};
function ut(a,b,c,d,e){function f(a){if(a)return a.map(function(a){return{url:a.url||null,text:a.text||null}})}d=d||{};var g=f(d.authorStyleSheet),h=f(d.userStyleSheet);e&&Object.assign(a.f,e);b=Object.assign({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.h.userAgentRootURL,url:rt(b)||c,document:d.documentObject,fragment:d.fragment,authorStyleSheet:g,userStyleSheet:h},st(a.f));a.g?a.Ob.u(b):(a.g=!0,Yr(a.Ob,b))}n.Bb=function(){return this.Ob.Bb()};
n.Ue=function(a){a:switch(a){case "left":a="ltr"===this.Bb()?"previous":"next";break a;case "right":a="ltr"===this.Bb()?"next":"previous"}this.Ob.u({a:"moveTo",where:a})};n.Te=function(a){this.Ob.u({a:"moveTo",url:a})};n.ef=function(a){a:{var b=this.Ob;if(!b.g)throw Error("no page exists.");switch(a){case "fit inside viewport":a=Tr(b,b.$.kb?Sr(b,b.j):b.g.f);break a;default:throw Error("unknown zoom type: "+a);}}return a};ba("vivliostyle.viewer.Viewer",tt);tt.prototype.setOptions=tt.prototype.Ge;
tt.prototype.addListener=tt.prototype.cf;tt.prototype.removeListener=tt.prototype.ff;tt.prototype.loadDocument=tt.prototype.Se;tt.prototype.loadEPUB=tt.prototype.df;tt.prototype.getCurrentPageProgression=tt.prototype.Bb;tt.prototype.navigateToPage=tt.prototype.Ue;tt.prototype.navigateToInternalUrl=tt.prototype.Te;tt.prototype.queryZoomFactor=tt.prototype.ef;ba("vivliostyle.viewer.ZoomType",Ur);Ur.FIT_INSIDE_VIEWPORT="fit inside viewport";ba("vivliostyle.viewer.PageViewMode",wr);wr.SINGLE_PAGE="singlePage";
wr.SPREAD="spread";wr.AUTO_SPREAD="autoSpread";ss.call(Br,"load_vivliostyle","end",void 0);var vt=16,wt="ltr";function xt(a){window.adapt_command(a)}function yt(){xt({a:"moveTo",where:"ltr"===wt?"previous":"next"})}function zt(){xt({a:"moveTo",where:"ltr"===wt?"next":"previous"})}
function At(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)xt({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)xt({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)xt({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)xt({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)zt(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)yt(),a.preventDefault();else if("0"===b||"U+0030"===c)xt({a:"configure",fontSize:Math.round(vt)}),a.preventDefault();else if("t"===b||"U+0054"===c)xt({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)vt*=1.2,xt({a:"configure",fontSize:Math.round(vt)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)vt/=1.2,xt({a:"configure",
fontSize:Math.round(vt)}),a.preventDefault()}
function Bt(a){switch(a.t){case "loaded":a=a.viewer;var b=wt=a.Bb();a.fd.setAttribute("data-vivliostyle-page-progression",b);a.fd.setAttribute("data-vivliostyle-spread-view",a.$.kb);window.addEventListener("keydown",At,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",yt,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",zt,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(na(location.href,Ca(a||"")));break;case "hyperlink":a.internal&&xt({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+m+"; margin: 0; }",document.head.appendChild(g));Yr(new xr(window,k,"main",Bt),a)});
