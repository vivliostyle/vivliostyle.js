...
ab.prototype.e=function(a){a.append("/");a.append(this.b.toString());if(this.id||this.Sa)a.append("["),this.id&&a.append(this.id),this.Sa&&(a.append(";s="),a.append(this.Sa)),a.append("]")};
...
bb.prototype.f=function(a){if(0<this.offset&&!a.K){for(var b=this.offset,c=a.ea;;){var d=c.nodeType;if(1==d)break;var e=c.nextSibling;if(3<=d&&5>=d){d=c.textContent.length;if(b<=d)break;if(!e){b=d;break}b-=d}if(!e){b=0;break}c=e}a.ea=c;a.offset=b}a.Sa=this.Sa;return!0};
bb.prototype.e=function(a){a.append(":");a.append(this.offset.toString());if(this.d||this.b||this.Sa){a.append("[");if(this.d||this.b)this.d&&a.append(this.d.replace(/[\[\]\(\),=;^]/g,Wa)),a.append(","),this.b&&a.append(this.b.replace(/[\[\]\(\),=;^]/g,Wa));this.Sa&&(a.append(";s="),a.append(this.Sa));a.append("]")}};function cb(){this.ia=null}
...
if(!c)throw Error("E_CFI_NUMBER_EXPECTED");e+=c[0].length;g=parseInt(c[1],10);(k=c[4])&&(k=Ya(k));var h=c[7];h&&(h=Ya(h));c=Za(c[10]);f.push(new bb(g,k,h,ia(c.s)));break;case "!":e++;f.push(new $a);break;case "~":case "@":case "":a.ia=f;return;default:throw Error("E_CFI_PARSE_ERROR");}}function eb(a,b){for(var c={ea:b.documentElement,offset:0,K:!1,Sa:null,Jb:null},d=0;d<a.ia.length;d++)if(!a.ia[d].f(c)){++d<a.ia.length&&(c.Jb=new cb,c.Jb.ia=a.ia.slice(d));break}return c}
...
xc.prototype.Qa=function(a,b){return a<b};function yc(a,b,c){C.call(this,a,b,c)}t(yc,oc);yc.prototype.Aa=function(){return"<="};yc.prototype.Qa=function(a,b){return a<=b};function zc(a,b,c){C.call(this,a,b,c)}t(zc,oc);zc.prototype.Aa=function(){return">"};zc.prototype.Qa=function(a,b){return a>b};function Ac(a,b,c){C.call(this,a,b,c)}t(Ac,oc);Ac.prototype.Aa=function(){return">="};Ac.prototype.Qa=function(a,b){return a>=b};function Bc(a,b,c){C.call(this,a,b,c)}t(Bc,oc);Bc.prototype.Aa=function(){return"=="};
Bc.prototype.Qa=function(a,b){return a==b};function Cc(a,b,c){C.call(this,a,b,c)}t(Cc,oc);Cc.prototype.Aa=function(){return"!="};Cc.prototype.Qa=function(a,b){return a!=b};function Dc(a,b,c){C.call(this,a,b,c)}t(Dc,pc);Dc.prototype.Aa=function(){return"+"};Dc.prototype.Qa=function(a,b){return a+b};function Ec(a,b,c){C.call(this,a,b,c)}t(Ec,pc);Ec.prototype.Aa=function(){return" - "};Ec.prototype.Qa=function(a,b){return a-b};function Fc(a,b,c){C.call(this,a,b,c)}t(Fc,qc);Fc.prototype.Aa=function(){return"*"};
Fc.prototype.Qa=function(a,b){return a*b};function Gc(a,b,c){C.call(this,a,b,c)}t(Gc,qc);Gc.prototype.Aa=function(){return"/"};Gc.prototype.Qa=function(a,b){return a/b};function Hc(a,b,c){C.call(this,a,b,c)}t(Hc,qc);Hc.prototype.Aa=function(){return"%"};Hc.prototype.Qa=function(a,b){return a%b};function Ic(a,b,c){B.call(this,a);this.C=b;this.ja=c}t(Ic,B);Ic.prototype.ka=function(a){a.append(this.C.toString());a.append(Ca(this.ja))};Ic.prototype.Ha=function(a){return this.C*hc(a,this.ja,!1)};
...
function $e(){var a=L("Frame.timeSlice"),b=a.d.d;b.e.currentTime()>=b.h?(w("-- time slice --"),Ve(a).Va(!0)):O(a,!0);return N(a)}function af(a){function b(d){try{for(;d;){var e=a();if(e.za()){e.then(b);return}e.then(function(a){d=a})}O(c,!0)}catch(f){Le(c.d,f,c)}}var c=L("Frame.loop");b(!0);return N(c)}function bf(a){var b=Fe;if(!b)throw Error("E_TASK_NO_CONTEXT");return af(function(){var c;do c=new cf(b,b.top),b.top=c,c.b=Ie,a(c),c=N(c);while(!c.za()&&c.Wb());return c})}
...
$f.prototype.zb=function(a){this.d&&0==a.C&&this.b.push(new J(0,"px"));return null};$f.prototype.Xa=function(a){this.ib(a.values);return null};$f.prototype.ob=function(a){this.d||(this.d=!0,this.ib(a.values),this.d=!1,this.name=a.name.toLowerCase());return null};
...
function fg(a,b){var c=null,d=null;"img"==a.localName&&(c=a.getAttribute("width"),d=a.getAttribute("height"));var e=new lf(function(){function e(b){"img"==a.localName&&(c||a.removeAttribute("width"),d||a.removeAttribute("height"));k.Va(b?b.type:"timeout")}var g=L("loadImage"),k=Ve(g,a);a.addEventListener("load",e,!1);a.addEventListener("error",e,!1);a.addEventListener("abort",e,!1);"http://www.w3.org/2000/svg"==a.namespaceURI?(a.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",b),setTimeout(e,
...
m.Pb=function(a){return this.b&128?a:null};m.Xa=function(){return null};m.nb=function(){return null};m.ob=function(){return null};m.xb=function(){return null};var lg=new ng(0,T,T);
...
Di(h,f,c);w("Starting to load font: "+f);var v=!1;af(function(){var a=l.getBoundingClientRect(),b=a.bottom-a.top;if(q!=a.right-a.left||r!=b)return v=!0,M(!1);(new Date).valueOf()>n?a=M(!1):(a=L("Frame.sleep"),Ve(a).Va(!0,10),a=N(a));return a}).then(function(){v?w("Loaded font: "+f):w("Failed to load font: "+f);a.b.removeChild(l);O(e,h)});return N(e)}
...
18>d)return a.d.removeChild(e.d),a.l=null,Vk(a,b,c),M(!0);if(!a.b&&e.top<g)return a.d.removeChild(e.d),Vk(a,b,c),M(!0);var h=L("layoutFootnoteInner");a.b?Uj(e,0,d):Tj(e,g,d);e.A=a.A+a.left+Qj(a);e.B=a.B+a.top+Oj(a);e.I=a.I;var l=new Jj(c);f?(Yk(e),f=M(!0)):0==e.I.length?(Zk(e),f=M(!0)):f=$k(e);f.then(function(){al(e,l).then(function(d){a.b?(a.na=a.jb+(e.e+Qj(e)+Rj(e)),Uj(e,0,e.e)):(a.na=a.jb-(e.e+Oj(e)+Pj(e)),Tj(e,a.na-a.Pa,e.e));var f;!a.b&&0<e.I.length?f=$k(e):f=M(d);f.then(function(d){d=new vk(b,
c,d?d.Ra:null);a.g?a.g.push(d):a.g=[d];O(h,!0)})})});return N(h)}
function bl(a,b){var c=L("layoutFootnote"),d=b.b;d.setAttribute("style","");u(d,"display","inline-block");d.textContent="M";var e=d.getBoundingClientRect(),f=a.b?e.left:e.bottom;d.textContent="";cl(a.h,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d={ia:[{ea:b.X,La:0,ca:b.ca,va:null,oa:null}],ba:0,K:!1};e=b.da;b=b.modify();b.K=!0;Wk(a,e,d,f).then(function(){a.l&&a.l.d.parentNode&&a.d.removeChild(a.l.d);zk(a,f)&&0!=a.u.length&&(b.e=!0);O(c,b)});return N(c)}
...
1)*a.f.P);q=n;a.b&&(q=ue(n));ze(p,a.Ya,q,e);a.b&&(n=new ce(-q.P,q.W,-q.T,q.U));u(d,"left",n.W-a.f.W+a.j+"px");u(d,"top",n.T-a.f.T+a.k+"px");n=a.b?n.W:n.P;zk(a,n)&&0!=a.u.length?(b=b.modify(),b.e=!0,O(c,b)):(Mk(a),p=a.b?ue(a.f):a.f,Ae(p,a.Ya,q,e),Nk(a),"left"==e?a.qc=n:a.rc=n,il(a,n),O(c,l))}});return N(c)}
...
"1"))}}function kl(a,b,c,d){var e=L("processLineStyling");wk(d);var f=d.concat([]);d.splice(0,d.length);var g=0,k=b.f;0==k.count&&(k=k.Fd);bf(function(d){if(k){var e=ll(a,f),n=k.count-g;if(e.length<=n)Q(d);else{var p=ml(a,f,e[n-1]);nl(a,p,!1,!1).then(function(){g+=n;Gk(a.h,p,0).then(function(e){b=e;jl(b,!1);k=b.f;f=[];Hk(a,b,f).then(function(b){c=b;0<a.h.g.b.length?Q(d):df(d)})})})}}else Q(d)}).then(function(){Array.prototype.push.apply(d,f);wk(d);O(e,c)});return N(e)}
...
function pl(a,b){var c=L("layoutBreakableBlock"),d=[];Hk(a,b,d).then(function(e){if(0<a.h.g.b.length)O(c,e);else{var f=d.length-1;if(0>f)O(c,e);else{var f=Ok(a,e,d,f,d[f].da),g=zk(a,f);null==e&&(f+=ol(a,d));il(a,f);var k;b.f?k=kl(a,b,e,d):k=M(e);k.then(function(b){0<d.length&&(a.u.push(new sk(d,d[0].h)),g&&(2!=d.length&&0<a.u.length||d[0].X!=d[1].X||!pk[d[0].X.localName])&&b&&(b=b.modify(),b.e=!0));O(c,b)})}}});return N(c)}
...
function ql(a,b){if(!a.g)return M(!0);for(var c=!1,d=a.g.length-1;0<=d;--d){var e=a.g[d];if(e.da<=b)break;a.g.pop();e.b!==e.d&&(c=!0)}if(!c)return M(!0);var f=L("clearFootnotes"),g=a.e+a.Pa,k=a.g;a.l=null;a.g=null;var h=0;af(function(){for(;h<k.length;){var b=k[h++],b=Wk(a,b.da,b.d,g);if(b.za())return b}return M(!1)}).then(function(){O(f,!0)});return N(f)}
function tk(a,b,c){var d=b.e,e;if(c)e=c=1;else{for(e=d[0];e.parent&&e.d;)e=e.parent;c=Math.max((e.l.widows||1)-0,1);e=Math.max((e.l.orphans||1)-0,1)}var f=ll(a,d),g=a.na,d=Ja(f.length,function(b){return a.b?f[b]<g:f[b]>g}),d=Math.min(f.length-c,d);if(d<e)return null;g=f[d-1];if(b=ml(a,b.e,g))a.e=(a.b?-1:1)*(g-a.Pa);return b}
...
function rl(a,b,c){var d=L("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,k=a.u.length-1;0<=k&&!e;--k){var e=a.u[k].d(a,f),h=a.u[k].b();h>f&&(g=Math.min(g,h))}while(g>f&&!e);var l=!1;if(!e){w("Could not find any page breaks?!!");if(a.hd)return sl(a,b).then(function(b){b?(b=b.modify(),b.e=!1,nl(a,b,l,!0).then(function(){O(d,b)})):O(d,b)}),N(d);e=c;l=!0}nl(a,e,l,!0).then(function(){O(d,e)});return N(d)}
...
Q(c);return}g=[f];f=e=null}}else{if((e=ok(b.u,e))&&"avoid"!=e&&"auto"!=e){Q(c);a.M=e;return}if(pk[b.b.localName]){ul(a,f,null,!0,e)&&(b=(f||b).modify(),b.e=!0);Q(c);return}if(d&&(!tl(d.paddingTop)||!tl(d.borderTopWidth))){if(ul(a,f,null,!0,e)){b=(f||b).modify();b.e=!0;Q(c);return}f=e=null;g=[]}}}}while(0);d=Ik(a.h,b);if(d.za()){d.then(function(a){b=a;df(c)});return}b=d.Wb()}0!=a.u.length&&ul(a,f,g,!1,e)&&f&&(b=f.modify(),b.e=!0);Q(c)}).then(function(){O(d,b)});return N(d)}
function sl(a,b){var c=b,d=L("skipEdges"),e=null;bf(function(d){for(;b;){do if(b.b){if(b.d&&1!=b.b.nodeType){if(wj(b.b,b.A))break;if(!b.K){Q(d);return}}if(!b.K&&b.j){Q(d);return}if(1==b.b.nodeType){var g=b.b.style;if(b.K)e=ok(b.B,e);else{if((e=ok(b.u,e))&&"avoid"!=e&&"auto"!=e){Q(d);a.M=e;return}if(pk[b.b.localName]){Q(d);return}if(g&&(!tl(g.paddingTop)||!tl(g.borderTopWidth))){Q(d);return}}}}while(0);g=Ik(a.h,b);if(g.za()){g.then(function(a){b=a;df(d)});return}b=g.Wb()}c=null;Q(d)}).then(function(){O(d,
c)});return N(d)}function Jk(a,b){return"footnote"==b.j?bl(a,b):dl(a,b)}function xl(a,b,c){var d=L("layoutNext");wl(a,b,c).then(function(c){b=c;if(!b||a.M||b.e)O(d,b);else if(b.j)Jk(a,b).pa(d);else{a:{if(!b.K)switch(b.X.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!0}c?pl(a,b).pa(d):Kk(a,b).pa(d)}});return N(d)}
...
me(b,d,b+a.width,d+a.height);a.Ya=we(c,[b],a.I,a.Ga,a.b);Nk(a);a.g=null}function Yk(a){a.Rb=[];u(a.d,"width",a.width+"px");u(a.d,"height",a.height+"px");Zk(a);a.e=0;a.Sc=!1;a.M=null}function il(a,b){a.e=Math.max((a.b?-1:1)*(b-a.Pa),a.e)}function yl(a,b){var c=b.b;if(!c)return M(!0);var d=L("layoutOverflownFootnotes"),e=0;af(function(){for(;e<c.length;){var b=c[e++],b=Wk(a,0,b,a.Pa);if(b.za())return b}return M(!1)}).then(function(){O(d,!0)});return N(d)}
function al(a,b){a.Rb.push(b);if(a.Sc)return M(b);var c=L("layout");yl(a,b).then(function(){Bk(a,b.Ra).then(function(b){var e=b,f=!0;a.u=[];bf(function(c){for(;b;){var k=!0;xl(a,b,f).then(function(h){f=!1;b=h;0<a.h.g.b.length?Q(c):a.M?Q(c):b&&b.e?rl(a,b,e).then(function(a){b=a;Q(c)}):k?k=!1:df(c)});if(k){k=!1;return}}Q(c)}).then(function(){var e=a.l;e&&(a.d.appendChild(e.d),a.b?a.e=this.Pa-this.jb:a.e=e.top+Oj(e)+e.e+Pj(e));if(b)if(0<a.h.g.b.length)O(c,null);else{a.Sc=!0;e=new Jj(Ij(b));if(a.g){for(var f=
[],h=0;h<a.g.length;h++){var l=a.g[h].b;l&&f.push(l)}e.b=f.length?f:null}O(c,e)}else O(c,null)})})});return N(c)}function $k(a){for(var b=a.Rb;a.d.lastChild!=a.Rc;)a.d.removeChild(a.d.lastChild);Mk(a);Yk(a);var c=L("redoLayout"),d=0,e=null;bf(function(c){if(d<b.length){var g=b[d++];al(a,g).then(function(a){a?(e=a,Q(c)):df(c)})}else Q(c)}).then(function(){O(c,e)});return N(c)};var zl=1;function Al(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.h=0;this.d=a;this.name=b;this.eb=c;this.ya=d;this.parent=e;this.g="p"+zl++;e&&(this.h=e.children.length,e.children.push(this))}Al.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Al.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Bl(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
...
function Zl(a,b,c){var d=Y(a,b,"left"),e=Y(a,b,"margin-left"),f=Y(a,b,"padding-left"),g=Y(a,b,"border-left-width");a=Y(a,b,"width");Uj(c,d,a);u(c.d,"margin-left",e+"px");u(c.d,"padding-left",f+"px");u(c.d,"border-left-width",g+"px");c.marginLeft=e;c.aa=g;c.j=f}
function $l(a,b,c){var d=Y(a,b,"right"),e=Y(a,b,"snap-height"),f=Y(a,b,"margin-right"),g=Y(a,b,"padding-right");b=Y(a,b,"border-right-width");u(c.d,"margin-right",f+"px");u(c.d,"padding-right",g+"px");u(c.d,"border-right-width",b+"px");c.marginRight=f;c.Fa=b;a.b&&0<e&&(a=d+Rj(c),a=a-Math.floor(a/e)*e,0<a&&(c.Tb=e-a,g+=c.Tb));c.D=g;c.Ub=e}
...
function dm(a,b,c){u(c.d,"border-top-width","0px");var d=Y(a,b,"max-height");a.I?Tj(c,0,d):(am(a,b,c),d-=c.qa,c.height=d,u(c.d,"height",d+"px"))}function em(a,b,c){u(c.d,"border-left-width","0px");var d=Y(a,b,"max-width");a.D?Uj(c,0,d):($l(a,b,c),d-=c.Tb,c.width=d,a=Y(a,b,"right"),u(c.d,"right",a+"px"),u(c.d,"width",d+"px"))}
...
Bm.prototype.g=function(a){var b=a.getAttribute("class")||"";this.b&&b&&b.match(/after$/)&&(this.style=this.b.g(this.f,!0),this.b=null);var c=this.style._pseudos[b]||{};if(!this.e[b]){this.e[b]=!0;var d=c.content;d&&(d=d.evaluate(this.d),Wj(d)&&d.S(new Vj(a,this.d)))}if(b.match(/^first-/)&&!c["x-first-pseudo"]){a=1;var e;"first-letter"==b?a=0:null!=(e=b.match(/^first-([0-9]+)-lines$/))&&(a=e[1]-0);c["x-first-pseudo"]=new U(new ed(a),0)}return c};
...
function Dm(a,b,c,d,e,f){var g=L("createRefShadow");a.$.j.load(b).then(function(k){if(k){var h=Ri(k,b);if(h){var l=a.I,n=l.D[k.url];n||(n=l.style.h.b[k.url],n=new ek(k,n.d,n.g,new fc(0,l.u(),l.l(),l.g),l.e,n.j,l.j),l.D[k.url]=n);f=new Bj(d,h,k,e,f,c,n)}}O(g,f)});return N(g)}
...
function Ik(a,b){b=Nm(b);if(!b||b.K)return M(b);var c=L("nextInTree");Dk(a,b,!0).then(function(a){b.b&&a||(b=b.modify(),b.K=!0,b.b||(b.d=!0));O(c,b)});return N(c)}function Om(a,b){if(b instanceof Wc)for(var c=b.values,d=0;d<c.length;d++)Om(a,c[d]);else b instanceof gd&&(c=b.url,a.e.e.push(fg(new Image,c)))}
...
function gn(a,b,c){Gl.call(this,a,null,"vivliostyle-page-rule-master",[],b,null,0);a=cn(c);new hn(this.d,this,c,a);this.u={};jn(this,c);this.b.position=new U(Jd,0);this.b.width=new U(a.width,0);this.b.height=new U(a.height,0);for(var d in c)dn[d]||"background-clip"===d||(this.b[d]=c[d])}t(gn,Gl);function jn(a,b){var c=b._marginBoxes;c&&fn.forEach(function(d){c[d]&&(a.u[d]=new kn(a.d,a,d,b))})}gn.prototype.f=function(a){return new ln(a,this)};
function hn(a,b,c,d){Kl.call(this,a,null,null,[],b);this.w=d;this.b["z-index"]=new U(new ed(0),0);this.b["flow-from"]=new U(H("body"),0);this.b.position=new U(jd,0);this.b.overflow=new U(Ud,0);for(var e in dn)dn.hasOwnProperty(e)&&(this.b[e]=c[e])}t(hn,Kl);hn.prototype.f=function(a){return new mn(a,this)};
...
function pn(a,b,c,d,e){this.L=a;this.l=e;this.g=c;this.k=!X(d,b[c?"width":"height"],new Ic(d,0,"px"));this.h=null}pn.prototype.b=function(){return this.k};function qn(a){a.h||(a.h=Zm(a.l,a.L.d,a.g?["max-content width","min-content width"]:["max-content height","min-content height"]));return a.h}pn.prototype.e=function(){var a=qn(this);return this.g?Qj(this.L)+a["max-content width"]+Rj(this.L):Oj(this.L)+a["max-content height"]+Pj(this.L)};
...
function on(a,b,c,d,e,f){var g=a.d.d,k={},h={},l={},n;for(n in b){var p=en[n];if(p){var q=b[n],r=a.qa[n],v=new pn(q,r.style,c,g,f);k[p.ha]=q;h[p.ha]=r;l[p.ha]=v}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.Y.evaluate(e);var y=tn(l,b),I=!1,W={};Object.keys(k).forEach(function(a){var b=X(g,h[a].style[c?"max-width":"max-height"],d.Y);b&&(b=b.evaluate(e),y[a]>b&&(b=l[a]=new sn(k[a],h[a].style,c,g,f,b),W[a]=b.d(),I=!0))});I&&(y=tn(l,b),I=!1,["start","center","end"].forEach(function(a){y[a]=W[a]||y[a]}));
var P={};Object.keys(k).forEach(function(a){var b=X(g,h[a].style[c?"min-width":"min-height"],d.Y);b&&(b=b.evaluate(e),y[a]<b&&(b=l[a]=new sn(k[a],h[a].style,c,g,f,b),P[a]=b.d(),I=!0))});I&&(y=tn(l,b),["start","center","end"].forEach(function(a){y[a]=P[a]||y[a]}));var E=a+b,Ea=a+(a+b);["start","center","end"].forEach(function(a){var b=y[a];if(b){var d=k[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(Ea-b)/2;break;case "end":e=E-b}c?Uj(d,e,b-Qj(d)-Rj(d)):Tj(d,e,b-Oj(d)-Pj(d))}})}
...
d["padding-bottom"]=new K(c.marginBottom)};mn.prototype.Cc=function(){var a=vn(this,{start:"left",end:"right",Y:"width"});this.rb=a.kd;this.marginLeft=a.rd;this.marginRight=a.qd};mn.prototype.Dc=function(){var a=vn(this,{start:"top",end:"bottom",Y:"height"});this.qb=a.kd;this.marginTop=a.rd;this.marginBottom=a.qd};
function vn(a,b){var c=a.style,d=a.d.d,e=b.start,f=b.end,g=b.Y,k=a.d.w[g].fa(d,null),h=X(d,c[g],k),l=X(d,c["margin-"+e],k),n=X(d,c["margin-"+f],k),p=Ml(d,c["padding-"+e],k),q=Ml(d,c["padding-"+f],k),r=Ol(d,c["border-"+e+"-width"],c["border-"+e+"-style"],k),v=Ol(d,c["border-"+f+"-width"],c["border-"+f+"-style"],k),y=F(d,k,D(d,D(d,r,p),D(d,v,q)));h?(y=F(d,y,h),l||n?l?n=F(d,y,l):l=F(d,y,n):n=l=Qc(d,y,new $b(d,.5))):(l||(l=d.b),n||(n=d.b),h=F(d,y,D(d,l,n)));c[e]=new K(l);c[f]=new K(n);c["margin-"+e]=
$d;c["margin-"+f]=$d;c["padding-"+e]=new K(p);c["padding-"+f]=new K(q);c["border-"+e+"-width"]=new K(r);c["border-"+f+"-width"]=new K(v);c[g]=new K(h);c["max-"+g]=new K(h);return{kd:F(d,k,D(d,l,n)),rd:l,qd:n}}mn.prototype.tb=function(a,b,c){Ll.prototype.tb.call(this,a,b,c);c.u=b.d};function nn(a,b){Ll.call(this,a,b);var c=b.l;this.j=en[c];a.qa[c]=this;this.wa=!0}t(nn,Ll);m=nn.prototype;
...
function(){var a=d(this).Ca;return null===a?0:a},"margin-"+f));e["margin-"+g]=new K(new bc(a,function(){var a=d(this).Da;return null===a?0:a},"margin-"+g));"left"===f?e.left=new K(D(a,c.marginLeft,c.rb)):"top"===f&&(e.top=new K(D(a,c.marginTop,c.qb)))}m.Cc=function(){var a=this.e.j;this.j.sa?wn(this,{Ec:"right",Jc:"left",Y:"width"},a):this.j.ta?wn(this,{Ec:"left",Jc:"right",Y:"width"},a):this.ha({start:"left",end:"right",Y:"width"},a)};
...
function zn(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof U?e.value+"":zn(a,e);c.push(d+f+(e.Ea||""))}return c.sort().join("^")}function An(a){this.b=null;this.f=a}t(An,V);An.prototype.apply=function(a){a.I===this.f&&this.b.apply(a)};An.prototype.d=function(){return 3};An.prototype.e=function(a){this.b&&sh(a.Gb,this.f,this.b);return!0};function Bn(a){this.b=null;this.f=a}t(Bn,V);
Bn.prototype.apply=function(a){1===(new Jc(this.f,"page-number")).evaluate(a.d)&&this.b.apply(a)};Bn.prototype.d=function(){return 2};function Cn(a){this.b=null;this.f=a}t(Cn,V);Cn.prototype.apply=function(a){(new Jc(this.f,"left-page")).evaluate(a.d)&&this.b.apply(a)};Cn.prototype.d=function(){return 1};function Dn(a){this.b=null;this.f=a}t(Dn,V);Dn.prototype.apply=function(a){(new Jc(this.f,"right-page")).evaluate(a.d)&&this.b.apply(a)};Dn.prototype.d=function(){return 1};
function En(a){this.b=null;this.f=a}t(En,V);En.prototype.apply=function(a){(new Jc(this.f,"recto-page")).evaluate(a.d)&&this.b.apply(a)};En.prototype.d=function(){return 1};function Fn(a){this.b=null;this.f=a}t(Fn,V);Fn.prototype.apply=function(a){(new Jc(this.f,"verso-page")).evaluate(a.d)&&this.b.apply(a)};Fn.prototype.d=function(){return 1};function Gn(a,b){qh.call(this,a,b,null,null)}t(Gn,qh);
...
function Sn(a,b,c){var d=a.b.b[c];if(!d)return M(!0);Yk(b);a.e[c]&&0<b.Ya.length&&(b.hd=!1);var e=L("layoutColumn"),f=[];bf(function(c){for(;0<d.b.length;){var e=0,h=d.b[e];if(h.b.b>a.h)break;for(var l=1;l<d.b.length;l++){var n=d.b[l];if(n.b.b>a.h)break;yj(n.b,h.b)&&(h=n,e=l)}var p=h.b,q=!0;al(b,h.d).then(function(a){h.b.Hd&&(null===a||p.d)&&f.push(h);p.d?(d.b.splice(e,1),Q(c)):a?(h.d=a,Q(c)):(d.b.splice(e,1),q?q=!1:df(c))});if(q){q=!1;return}}Q(c)}).then(function(){0<f.length&&(d.b=f.concat(d.b));
O(e,!0)});return N(e)}
...
I=h.toString(),W=Y(c,a,"column-count"),P=Y(c,a,"column-gap"),E=1<W?Y(c,a,"column-width"):v.width,h=Wl(c,a),Ea=0,r=Xl(c,a,"shape-inside"),mb=ag(r,0,0,v.width,v.height,a),Pk=new Cm(I,a,a.viewport,a.d,h,a.$,a.na,a.style.u,a,b,a.Fa,a.Ga,k),xh=0,Z=null;bf(function(b){for(;xh<W;){var c=xh++;if(1<W){var d=a.viewport.b.createElement("div");u(d,"position","absolute");q.appendChild(d);Z=new xk(d,Pk,a.f);Z.b=v.b;Z.Ga=v.Ga;Z.Ub=v.Ub;v.b?(u(d,"margin-left",v.j+"px"),u(d,"margin-right",v.D+"px"),c=c*(E+P)+v.k,
Uj(Z,0,v.width),Tj(Z,c,E)):(u(d,"margin-top",v.k+"px"),u(d,"margin-bottom",v.w+"px"),c=c*(E+P)+v.j,Tj(Z,0,v.height),Uj(Z,c,E));Z.A=e+v.j;Z.B=f+v.k}else Z=new xk(q,Pk,a.f),Sj(Z,v),v=Z;Z.I=p?[]:g;Z.Sb=mb;if(0<=Z.width){var h=L("inner");Sn(a,Z,I).then(function(){Z.M&&"column"!=Z.M&&(xh=W,"region"!=Z.M&&(a.I[I]=!0));O(h,!0)});c=N(h)}else c=M(!0);if(c.za()){c.then(function(){0<k.b.length?Q(b):(Ea=Math.max(Ea,Z.e),df(b))});return}0<k.b.length||(Ea=Math.max(Ea,Z.e))}Q(b)}).then(function(){v.e=Ea;c.Zb(a,
v,b,Z,W,a.f);O(y,!0)});h=N(y)}else{h=Xl(c,a,"content");r=!1;if(h&&Wj(h)){var Qk=a.viewport.b.createElement("span");h.S(new Vj(Qk,a));q.appendChild(Qk);jm(c,a,v)}else c.wa&&(d.removeChild(q),r=!0);r||c.Zb(a,v,b,null,1,a.f);h=M(!0)}h.then(function(){if(!c.f||0<Math.floor(v.e)){if(!n){var h=v.A+v.left,p=v.B+v.top,r=Qj(v)+v.width+Rj(v),y=Oj(v)+v.height+Pj(v),E=Xl(c,a,"shape-outside"),h=ag(E,h,p,r,y,a);Ta(a.viewport.root)&&g.push(ke(h,0,-1.25*hc(a,"em",!1)));g.push(h)}}else if(0==c.children.length){d.removeChild(q);
O(l,!0);return}var I=c.children.length-1;af(function(){for(;0<=I;){var d=c.children[I--],d=Tn(a,b,d,q,e,f,g,k);if(d.za())return d}return M(!1)}).then(function(){O(l,!0)})});return N(l)}
function Un(a,b,c){a.I={};c?(a.b=c.clone(),hk(a.d,c.e)):(a.b=new Mj,hk(a.d,-1));a.lang&&b.L.setAttribute("lang",a.lang);c=a.b;c.d++;gc(a,a.style.b);var d=yn(a.M);Vn(a,d);var e=Rn(a,d);if(!e)return M(null);e.d.b.width.value===Yd&&tj(b);e.d.b.height.value===Zd&&uj(b);Ln(a.j,d,a);var d=Xl(e,a,"writing-mode")||wd,f=Xl(e,a,"direction")||Ed,g=new sm(b.w.bind(b),d,f),k=c.clone(),h=[],l=L("layoutNextPage");bf(function(d){Tn(a,b,e,b.L,0,0,h.concat(),g).then(function(){if(0<g.b.length){h=h.concat(um(g));g.b.splice(0,
...
m.ma=function(){pi.prototype.ma.call(this);if(this.A){this.A=!1;var a="R"+this.f.B++,b=H(a),c;this.J?c=new dh(b,0,this.J):c=new U(b,0);jh(this.k,"region-id").push(c);this.Ta();a=new Wn(this.f,this.J,this,a);sf(this.f,a);a.ma()}};
function Xn(a){var b=a.getAttribute("content");if(!b)return"";a={};for(var c;null!=(c=b.match(/^,?\s*([-A-Za-z_.][-A-Za-z_0-9.]*)\s*=\s*([-+A-Za-z_0-9.]*)\s*/));)b=b.substr(c[0].length),a[c[1]]=c[2];b=a.width-0;a=a.height-0;return b&&a?"@-epubx-viewport{width:"+b+"px;height:"+a+"px;}":""}function Yn(a){rf.call(this);this.f=a;this.g=new Zb(null);this.j=new Zb(this.g);this.u=new Dl(this.g);this.A=new Wn(this,null,null,null);this.B=0;this.k=[];this.l={};this.h={};this.w=[];this.b=this.A}t(Yn,rf);
Yn.prototype.Q=function(a){w("CSS parser: "+a)};function Zn(a,b){return $n(b,a)}function ao(a){hf.call(this,Zn,"document");this.D=a;this.A={};this.h={};this.b={};this.B={};this.f=null;this.j=[]}t(ao,hf);function bo(a){var b=ea("user-agent.xml",da),c=L("OPSDocStore.init");jf(Sg).then(function(d){a.f=d;jf(vi).then(function(){a.load(b).then(function(){O(c,!0)})})});return N(c)}function co(a,b){a.j.push({url:b.url,text:b.text,Ua:"User",ya:null,media:null})}
function $n(a,b){var c=L("OPSDocStore.load"),d=b.url;Vi(b,a).then(function(b){for(var f=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),k=0;k<g.length;k++){var h=g[k],l=h.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),n=h.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=h.getAttribute("action"),h=h.getAttribute("ref");l&&n&&p&&h&&f.push({Ed:l,event:n,action:p,Jb:h})}a.B[d]=f;var q=[],f=ea("user-agent-page.css",da);q.push({url:f,text:null,Ua:"UA",
ya:null,media:null});for(k=0;k<a.j.length;k++)q.push(a.j[k]);if(f=b.h)for(f=f.firstChild;f;f=f.nextSibling)if(1==f.nodeType)if(g=f,k=g.namespaceURI,l=g.localName,"http://www.w3.org/1999/xhtml"==k)if("style"==l)q.push({url:d,text:g.textContent,Ua:"Author",ya:null,media:null});else if("link"==l){if(n=g.getAttribute("rel"),k=g.getAttribute("class"),l=g.getAttribute("media"),"stylesheet"==n||"alternate stylesheet"==n&&k)g=g.getAttribute("href"),g=ea(g,d),q.push({url:g,text:null,ya:k,media:l,Ua:"Author"})}else"meta"==
...
for(var r="",k=0;k<q.length;k++)r+=q[k].url,r+="^",q[k].text&&(r+=q[k].text),r+="^";var v=a.A[r];v?(a.b[d]=v,O(c,b)):(f=a.h[r],f||(f=new lf(function(){var b=L("fetchStylesheet"),c=0,d=new Yn(a.f);af(function(){if(c<q.length){var a=q[c++];d.wb(a.Ua);var b;if(null!==a.text){b=a.url;var e=a.ya,f=a.media,a=new Ob(a.text);b=Rf(a,d,b,e,f)}else b=Tf(a.url,d,a.ya,a.media);return b}return M(!1)}).then(function(){v=new Mn(a,d.g,d.j,d.A.h,d.u,d.k,d.l,d.h,d.w);a.A[r]=v;delete a.h[r];O(b,v)});return N(b)},"FetchStylesheet "+
d),a.h[r]=f,f.start()),jf(f).then(function(f){a.b[d]=f;O(c,b)}))});return N(c)};function eo(a,b,c,d,e,f,g,k){this.d=a;this.url=b;this.lang=c;this.e=d;this.g=e;this.R=Rb(f);this.h=g;this.f=k;this.Ia=this.b=null}function fo(a,b,c){if(0!=c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=za(d,"height","auto")&&(u(d,"height","auto"),fo(a,d,c));"absolute"==za(d,"position","static")&&(u(d,"position","relative"),fo(a,d,c))}}
...
eo.prototype.cc=function(a,b,c,d,e){if(this.b)return M(this.b);var f=this,g=L("showTOC"),k=new sj(a);this.b=k;this.d.load(this.url).then(function(d){var l=f.d.b[d.url],n=Nn(l,c,1E5,e);b=new Qm(b.f,n.fontSize,b.root,n.width,n.height);var p=new On(l,d,f.lang,b,f.e,f.g,f.Gc(d),f.f,0);f.Ia=p;p.R=f.R;Pn(p).then(function(){Un(p,k,null).then(function(){fo(f,a,2);O(g,k)})})});return N(g)};
...
function jo(a,b,c){var d=L("loadEPUBDoc");c&&a.u.Yb(b+"?r=list");a.d.Yb(b+"META-INF/encryption.xml");a.d.load(b+"META-INF/container.xml").then(function(e){e=fj(Ki(Ki(Ki(new Li([e.b]),"container"),"rootfiles"),"rootfile"),"full-path");for(var f=0;f<e.length;f++){var g=e[f];if(g){ko(a,b,g,c).pa(d);return}}O(d,null)});return N(d)}
function ko(a,b,c,d){var e=b+c,f=a.w[e];if(f)return M(f);var g=L("loadOPF");a.d.load(e).then(function(c){a.d.load(b+"META-INF/encryption.xml").then(function(h){(d?a.u.load(b+"?r=list"):M(null)).then(function(d){f=new lo(a,b);mo(f,c,h,d,b+"?r=manifest").then(function(){a.w[e]=f;a.M[b]=f;O(g,f)})})})});return N(g)}ho.prototype.load=function(a){a=ca(a);var b=this.l[a];return b?b.za()?b:M(b.Wb()):ho.Id.load.call(this,a)};
function no(){this.id=null;this.src="";this.g=this.d=null;this.F=-1;this.h=0;this.j=null;this.b=this.e=0;this.f=Ma}function oo(a){return a.id}function po(a){var b=De(a);return function(a){var d=L("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));gf(e).then(function(a){a=new DataView(a);for(var c=0;c<a.byteLength;c++){var e=a.getUint8(c),e=e^b[c%20];a.setUint8(c,e)}O(d,ff([a,f]))});return N(d)}}
...
a.namespaceURI)return{name:qo.dcterms+a.localName,N:k++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Mc:null,scheme:null};return null});var h=Na(g,function(a){return a.Mc});g=d(Na(g,function(a){return a.Mc?null:a.name}));var l=null;g[ro]&&(l=g[ro][0].v);c(g);return g}function vo(){var a=window.MathJax;return a?a.Hub:null}var wo={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
...
function zo(a,b,c){var d=new no;d.F=0;d.id="item1";d.src=b;a.d={item1:d};a.g={};a.g[b]=d;a.h=[d];a.b=a.h;c?(a=a.e,d=L("EPUBDocStore.load"),b=ca(b),(a.l[b]=$n(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,bc:null})).pa(d),c=N(d)):c=M(null);return c}function Ao(a,b,c){var d=a.b[b],e=L("getCFI");a.e.load(d.src).then(function(a){var b=Pi(a,c),k=null;b&&(a=Ni(a,b,0,!1),k=new cb,gb(k,b,c-a),d.g&&gb(k,d.g,0),k=k.toString());O(e,k)});return N(e)}
...
function Co(a,b){return Ke("resolveEPage",function(c){if(0>=b)O(c,{F:0,la:0,O:-1});else{var d=Ja(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.e.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=Oi(a),g=Math.round(a*b/e.b),g==a&&g--);O(c,{F:d,la:g,O:-1})})}},function(a){w("Error resolving epage: "+b);O(a,null)})}
function Do(a,b){var c=a.b[b.F];if(0>=b.la)return M(c.e);var d=L("getEPage");a.e.load(c.src).then(function(a){a=Oi(a);var f=Math.min(a,b.la);O(d,c.e+f*c.b/a)});return N(d)}function Eo(a,b,c,d){this.b=a;this.viewport=b;this.f=c;this.ub=[];this.la=this.O=this.F=0;this.R=Rb(d);this.e=new Pm(b.f)}function Fo(a){var b=a.ub[a.F];return b?b.Za[a.O]:null}m=Eo.prototype;m.cb=function(){if(this.b.A)return this.b.A;var a=this.ub[this.F];return a?a.Ia.ga:null};
function Go(a){var b=L("renderPage");Ho(a).then(function(c){if(c){var d=-1;if(0>a.O){var d=a.la,e=Ja(c.Ja.length,function(a){return Qn(c.Ia,c.Ja[a])>d});a.O=e==c.Ja.length?Number.POSITIVE_INFINITY:e-1}var f=c.Za[a.O];f?(a.la=f.offset,O(b,f)):bf(function(b){if(a.O<c.Ja.length)Q(b);else if(c.complete)a.O=c.Ja.length-1,Q(b);else{var e=c.Ja[c.Ja.length-1],h=Io(a,c,e);Un(c.Ia,h,e).then(function(l){h.L.style.display="none";h.L.style.visibility="visible";h.L.setAttribute("data-vivliostyle-page-side",h.f);
(e=l)?(c.Za[e.d-1]=h,c.Ja.push(e),0<=d&&Qn(c.Ia,e)>d?(f=h,a.O=c.Ja.length-2,Q(b)):(h.j=0==c.item.F&&0==e.d-1,df(b))):(c.Za.push(h),f=h,a.O=c.Ja.length-1,0>d&&(a.la=h.offset),c.complete=!0,h.j=0==c.item.F&&0==a.O,h.k=c.item.F==a.b.b.length-1,Q(b))})}}).then(function(){if(f=f||c.Za[a.O])O(b,f);else{var e=c.Ja[a.O];0>d&&(a.la=Qn(c.Ia,e));var k=Io(a,c,e);Un(c.Ia,k,e).then(function(d){k.L.style.display="none";k.L.style.visibility="visible";k.L.setAttribute("data-vivliostyle-page-side",k.f);(e=d)?(c.Za[e.d-
1]=k,c.Ja[a.O+1]=e):(c.Za.push(k),c.complete=!0,k.k=c.item.F==a.b.b.length-1);k.j=0==c.item.F&&0==a.O;O(b,k)})}})}else O(b,null)});return N(b)}m.Nc=function(){return Jo(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};function Jo(a,b,c){var d=L("renderAllPages"),e=a.F,f=a.O;a.F=0;bf(function(d){a.O=a.F==b?c:Number.POSITIVE_INFINITY;Go(a).then(function(){++a.F>b?Q(d):df(d)})}).then(function(){a.F=e;a.O=f;Go(a).pa(d)});return N(d)}m.xd=function(){this.O=this.F=0;return Go(this)};
m.yd=function(){this.F=this.b.b.length-1;this.O=Number.POSITIVE_INFINITY;return Go(this)};m.nextPage=function(){var a=this,b=L("nextPage");Ho(a).then(function(c){if(c){if(c.complete&&a.O==c.Ja.length-1){if(a.F>=a.b.b.length-1){O(b,null);return}a.F++;a.O=0}else a.O++;Go(a).pa(b)}else O(b,null)});return N(b)};m.Lc=function(){if(0==this.O){if(0==this.F)return M(null);this.F--;this.O=Number.POSITIVE_INFINITY}else this.O--;return Go(this)};
function Ko(a,b){var c="left"===b.f,d="ltr"===a.cb();return!c&&d||c&&!d}function Lo(a){var b=L("getCurrentSpread"),c=Fo(a);if(!c)return M({left:null,right:null});var d=a.F,e=a.O,f="left"===c.f;(Ko(a,c)?a.Lc():a.nextPage()).then(function(g){a.F=d;a.O=e;Go(a).then(function(){f?O(b,{left:c,right:g}):O(b,{left:g,right:c})})});return N(b)}m.Dd=function(){var a=Fo(this);if(!a)return M(null);var a=Ko(this,a),b=this.nextPage();if(a)return b;var c=this;return b.kc(function(){return c.nextPage()})};
m.Gd=function(){var a=Fo(this);if(!a)return M(null);var a=Ko(this,a),b=this.Lc();if(a){var c=this;return b.kc(function(){return c.Lc()})}return b};function Mo(a,b){var c=L("navigateToEPage");Co(a.b,b).then(function(b){b&&(a.F=b.F,a.O=b.O,a.la=b.la);Go(a).pa(c)});return N(c)}function No(a,b){var c=L("navigateToCFI");Bo(a.b,b).then(function(b){b&&(a.F=b.F,a.O=b.O,a.la=b.la);Go(a).pa(c)});return N(c)}
function Oo(a,b){w("Navigate to "+b);var c=xo(a.b,ca(b));if(null==c&&(a.b.f&&b.match(/^#epubcfi\(/)&&(c=xo(a.b,a.b.f.url)),null==c))return M(null);var d=a.b.g[c];if(!d)return a.b.f&&c==xo(a.b,a.b.f.url)&&(c=b.indexOf("#"),0<=c)?No(a,b.substr(c+1)):M(null);d.F!=a.F&&(a.F=d.F,a.O=0);var e=L("navigateTo");Ho(a).then(function(c){var d=Ri(c.$,b);d&&(a.la=Mi(c.$,d),a.O=-1);Go(a).pa(e)});return N(e)}
...
function Po(a,b){var c=vo();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=L("navigateToEPage"),f=Ve(c);d.Push(function(){f.Va(e)});return N(c)}return M(null)}
...
function Ho(a){if(a.F>=a.b.b.length)return M(null);var b=a.ub[a.F];if(b)return M(b);var c=a.b.b[a.F],d=a.b.e,e=L("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(Oi(f)/2700),a.b.u=c.b);var g=d.b[f.url],k=a.Gc(f),h=a.viewport,l=Nn(g,h.width,h.height,h.fontSize);if(l.width!=h.width||l.height!=h.height||l.fontSize!=h.fontSize)h=new Qm(h.f,l.fontSize,h.root,l.width,l.height);var l=a.ub[a.F-1],n=new On(g,f,a.b.lang,h,a.e,a.f,k,a.b.w,l?l.Ia.wa+l.Za.length:0);l&&
Kn(n.j,l.Ia.j);n.R=a.R;Pn(n).then(function(){b={item:c,$:f,Ia:n,Ja:[null],Za:[],complete:!1};a.ub[a.F]=b;O(e,b)})});return N(e)}function Qo(a){return{F:a.F,O:a.O,la:a.la}}function Ro(a,b){b?(a.F=b.F,a.O=-1,a.la=b.la):(a.F=0,a.O=0,a.la=0);return Jo(a,a.F,a.O)}
m.cc=function(){var a=this.b,b=a.B||a.M;if(!b)return M(null);var c=L("showTOC");this.d||(this.d=new eo(a.e,b.src,a.lang,this.e,this.f,this.R,this,a.w));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";e.style.border=
...
So.prototype.na=function(a){Xm.b("loadEPUB");Xm.b("loadFirstPage");this.ab.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet;this.viewport=null;var f=L("loadEPUB"),g=this;g.A(a).then(function(){var a=new ho;if(e)for(var h=0;h<e.length;h++)co(a,e[h]);bo(a).then(function(){var e=ea(b,g.h.location.href);g.w=e;jo(a,e,d).then(function(a){g.g=a;Bo(g.g,c).then(function(a){g.f=a;Uo(g).then(function(){g.ab.setAttribute("data-vivliostyle-viewer-status",
"complete");Xm.d("loadEPUB");To(g,{t:"loaded",metadata:g.g.l});O(f,!0)})})})})});return N(f)};
So.prototype.qa=function(a){Xm.b("loadXML");Xm.b("loadFirstPage");this.ab.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.document,d=a.fragment,e=a.userStyleSheet;this.viewport=null;var f=L("loadXML"),g=this;g.A(a).then(function(){var a=new ho;if(e)for(var h=0;h<e.length;h++)co(a,e[h]);bo(a).then(function(){var e=ea(b,g.h.location.href);g.w=e;g.g=new lo(a,"");zo(g.g,e,c).then(function(){Bo(g.g,d).then(function(a){g.f=a;Uo(g).then(function(){g.ab.setAttribute("data-vivliostyle-viewer-status",
"complete");Xm.d("loadXML");To(g,{t:"loaded"});O(f,!0)})})})})});return N(f)};function Vo(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*ec.ex*a.fontSize/ec.em;if(d=ec[d])return c*d}return c}
...
typeof a.fontFamily&&(this.R.fontFamily=a.fontFamily,this.d=!0);"boolean"==typeof a.load&&(this.M=a.load);"boolean"==typeof a.renderAllPages&&(this.Nc=a.renderAllPages);"string"==typeof a.userAgentRootURL&&(da=a.userAgentRootURL);"boolean"==typeof a.spreadView&&a.spreadView!==this.R.Wa&&(this.viewport=null,this.R.Wa=a.spreadView,this.d=!0);"number"==typeof a.pageBorder&&a.pageBorder!==this.R.Fb&&(this.viewport=null,this.R.Fb=a.pageBorder,this.d=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=
a.zoom,this.D=!0);return M(!0)};function Wo(a){var b=[];a.e&&(b.push(a.e),a.e=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(u(a.L,"display","none"),a.removeEventListener("hyperlink",this.u,!1))},a)}function Xo(a,b){b.addEventListener("hyperlink",a.u,!1);u(b.L,"visibility","visible");u(b.L,"display","block")}function Yo(a,b){Wo(a);a.e=b;Xo(a,b)}
function Zo(a){var b=L("reportPosition");a.f||(a.f=Qo(a.b));Ao(a.g,a.f.F,a.f.la).then(function(c){var d=a.e;(a.M&&0<d.e.length?eg(d.e):M(!0)).then(function(){$o(a,d,c).pa(b)})});return N(b)}function ap(a){var b=a.ab;if(a.l){var c=a.l;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new Qm(a.h,a.fontSize,b,c.width,c.height)}return new Qm(a.h,a.fontSize,b)}
...
function dp(a,b){a.D=!1;if(a.R.Wa)return Lo(a.b).kc(function(c){Wo(a);a.j=c;c.left&&(Xo(a,c.left),c.right||c.left.L.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Xo(a,c.right),c.left||c.right.L.setAttribute("data-vivliostyle-unpaired-page",!0));c=ep(a,c);a.viewport.zoom(c.width,c.height,a.zoom);a.e=b;return M(null)});Yo(a,b);a.viewport.zoom(b.b.width,b.b.height,a.zoom);a.e=b;return M(null)}
...
function Uo(a){a.d=!1;if(bp(a))return M(!0);"complete"===a.ab.getAttribute("data-vivliostyle-viewer-status")&&a.ab.setAttribute("data-vivliostyle-viewer-status","resizing");To(a,{t:"resizestart"});var b=L("resize");a.b&&!a.f&&(a.f=Qo(a.b));cp(a);Ro(a.b,a.f).then(function(c){dp(a,c).then(function(){Zo(a).then(function(c){Xm.d("loadFirstPage");(a.Nc?a.b.Nc():M(null)).then(function(){a.ab.setAttribute("data-vivliostyle-viewer-status","complete");To(a,{t:"resizeend"});O(b,c)})})})});return N(b)}
function $o(a,b,c){var d=L("sendLocationNotification"),e={t:"nav",first:b.j,last:b.k};Do(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.u;c&&(e.cfi=c);To(a,e);O(d,!0)});return N(d)}So.prototype.cb=function(){return this.b?this.b.cb():null};
So.prototype.wa=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.R.Wa?this.b.Dd:this.b.nextPage;break;case "previous":a=this.R.Wa?this.b.Gd:this.b.Lc;break;case "last":a=this.b.yd;break;case "first":a=this.b.xd;break;default:return M(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return Mo(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return Oo(b.b,d)}}else return M(!0);var e=L("nextPage");a.call(b.b).then(function(a){a?(b.f=
null,dp(b,a).then(function(){Zo(b).pa(e)})):O(e,!0)});return N(e)};So.prototype.cc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.bd();if(c){if("show"==a)return M(!0)}else if("hide"==a)return M(!0);if(c)return this.b.$b(),M(!0);var d=this,e=L("showTOC");this.b.cc(b).then(function(a){if(a){if(b){var c=function(){d.b.$b()};a.addEventListener("hyperlink",c,!1);a.L.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.u,!1)}O(e,!0)});return N(e)};
function gp(a,b){var c=b.a||"";return Ke("runCommand",function(d){var e=a.aa[c];e?e.call(a,b).then(function(){To(a,{t:"done",a:c});O(d,!0)}):(To(a,{t:"error",content:"No such action",a:c}),O(d,!0))},function(b,e){To(a,{t:"error",content:e.toString(),a:c});O(b,!0)})}function hp(a){return"string"==typeof a?JSON.parse(a):a}
function ip(a,b){var c=hp(b),d=null;Me(function(){var b=L("commandLoop"),f=Fe.d;a.u=function(b){var c={t:"hyperlink",href:b.href,internal:b.href.substr(0,a.w.length)==a.w};Ne(f,function(){To(a,c);return M(!0)})};bf(function(b){if(a.d)Uo(a).then(function(){df(b)});else if(a.D)a.e&&dp(a,a.e).then(function(){df(b)});else if(c){var e=c;c=null;gp(a,e).then(function(){df(b)})}else e=L("waitForCommand"),d=Ve(e,self),N(e).then(function(){df(b)})}).pa(b);return N(b)});a.B=function(){var a=d;a&&(d=null,a.Va())};
a.k=function(b){if(c)return!1;c=hp(b);a.B();return!0};a.h.adapt_command=a.k};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Cb||(Object.Cb=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function jp(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}function kp(a,b){this.f=a;this.b=new So(a.window||window,a.viewportElement,"main",this.wd.bind(this));this.e={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,spreadView:!1,zoom:1};b&&this.sd(b);this.d=new Qa}m=kp.prototype;
m.sd=function(a){var b=Object.Cb({a:"configure"},jp(a));this.b.k(b);Object.Cb(this.e,a)};m.wd=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});Ra(this.d,b)};m.Jd=function(a,b){this.d.addEventListener(a,b,!1)};m.Md=function(a,b){this.d.removeEventListener(a,b,!1)};m.zd=function(a,b,c){a||Ra(this.d,{type:"error",content:"No URL specified"});lp(this,a,null,b,c)};m.Kd=function(a,b,c){a||Ra(this.d,{type:"error",content:"No URL specified"});lp(this,null,a,b,c)};
...
ba("vivliostyle.viewer.Viewer",kp);kp.prototype.setOptions=kp.prototype.sd;kp.prototype.addListener=kp.prototype.Jd;kp.prototype.removeListener=kp.prototype.Md;kp.prototype.loadDocument=kp.prototype.zd;kp.prototype.loadEPUB=kp.prototype.Kd;kp.prototype.getCurrentPageProgression=kp.prototype.cb;kp.prototype.navigateToPage=kp.prototype.Bd;kp.prototype.navigateToInternalUrl=kp.prototype.Ad;kp.prototype.queryZoomFactor=kp.prototype.Ld;ba("vivliostyle.viewer.ZoomType",fp);fp.FIT_INSIDE_VIEWPORT="fit inside viewport";
...
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "error":w("Error: "+a.content);break;case "nav":(a=a.cfi)&&location.replace(ha(location.href,Fa(a||"")));break;case "hyperlink":a.internal&&op({a:"moveTo",url:a.href})}}
