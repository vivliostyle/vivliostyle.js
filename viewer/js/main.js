 ...
 *
 * Vivliostyle core 2019.1.100-pre.20190224185306
 */
(function(factory) {
...
function au(a,b,c){b.readingProgression&&(a.J=b.readingProgression);void 0===a.f&&(a.f={});var d=c&&c.title||b.name||b.metadata&&b.metadata.title;d&&(a.f[ju]=[{v:d}]);var e=qu(a,a.G);!b.readingOrder&&c&&null!==e&&(b.readingOrder=[encodeURI(e)],Array.from(c.querySelectorAll("[role=doc-toc] a[href],[role=directory] a[href],nav a[href],.toc a[href],#toc a[href]")).forEach(function(c){c=qu(a,ya(c.href));null!==c&&(c=encodeURI(c),-1==b.readingOrder.indexOf(c)&&b.readingOrder.push(c))}));var f=[],g=0,h=
-1;[b.readingOrder,b.resources].forEach(function(b){b instanceof Array&&b.forEach(function(b){var c="string"===typeof b?b:b.url||b.href,d="string"===typeof b?"":b.oh||b.href&&b.type||"";if("text/html"===d||"application/xhtml+xml"===d||/(^|\/)([^/]+\.(x?html|htm|xht)|[^/.]*)([#?]|$)/.test(c))c={url:Ba(Ea(c),a.G),index:g++,wb:null,nc:null},"contents"===b.rel&&-1===h&&(h=c.index),f.push(c)})});var l=L("initWithWebPubManifest");uu(a,f).then(function(){-1!==h&&(a.Yb=a.u[h]);a.Yb||(a.Yb=a.C[e]);O(l,!0)});
