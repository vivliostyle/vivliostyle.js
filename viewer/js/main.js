 ...
 *
 * Vivliostyle core 2016.4.1-pre.20160614042445
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function sp(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof V?e.value+"":sp(a,e);c.push(d+f+(e.Ga||""))}return c.sort().join("^")}function tp(a,b,c){c=c.clone({sb:"vivliostyle-page-rule-master"});var d=c.b,e=b.size;if(e){var f=Po(b),e=e.Ga;d.width=kj(a.d,d.width,new V(f.width,e));d.height=kj(a.d,d.height,new V(f.height,e))}["counter-reset","counter-increment"].forEach(function(a){d[a]&&(b[a]=d[a])});c=c.f(a.f);c.h(a.b,a.e);vm(c,a.d);return c}
function up(a){this.b=null;this.f=a}t(up,W);up.prototype.apply=function(a){a.S===this.f&&this.b.apply(a)};up.prototype.d=function(){return 3};up.prototype.e=function(a){this.b&&zj(a.Yb,this.f,this.b);return!0};function vp(a){this.b=null;this.f=a}t(vp,W);vp.prototype.apply=function(a){1===(new Rc(this.f,"page-number")).evaluate(a.g)&&this.b.apply(a)};vp.prototype.d=function(){return 2};function wp(a){this.b=null;this.f=a}t(wp,W);
wp.prototype.apply=function(a){(new Rc(this.f,"left-page")).evaluate(a.g)&&this.b.apply(a)};wp.prototype.d=function(){return 1};function xp(a){this.b=null;this.f=a}t(xp,W);xp.prototype.apply=function(a){(new Rc(this.f,"right-page")).evaluate(a.g)&&this.b.apply(a)};xp.prototype.d=function(){return 1};function yp(a){this.b=null;this.f=a}t(yp,W);yp.prototype.apply=function(a){(new Rc(this.f,"recto-page")).evaluate(a.g)&&this.b.apply(a)};yp.prototype.d=function(){return 1};
function zp(a){this.b=null;this.f=a}t(zp,W);zp.prototype.apply=function(a){(new Rc(this.f,"verso-page")).evaluate(a.g)&&this.b.apply(a)};zp.prototype.d=function(){return 1};function Ap(a,b){xj.call(this,a,b,null,null)}t(Ap,xj);Ap.prototype.apply=function(a){var b=a.g,c=a.u,d=this.style;a=this.P;qj(b,c,d,a,null,null);if(d=d._marginBoxes){var c=oj(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);qj(b,f,d[e],a,null,null)}}};
function Bp(a,b,c,d,e){Qk.call(this,a,b,null,c,null,d,!1);this.I=e;this.B=[];this.e="";this.u=[]}t(Bp,Qk);n=Bp.prototype;n.Mb=function(){this.eb()};n.hb=function(a,b){if(this.e=b)this.b.push(new up(b)),this.P+=65536};
n.Zb=function(a,b){b&&If(this,"E_INVALID_PAGE_SELECTOR :"+a+"("+b.join("")+")");this.u.push(":"+a);switch(a.toLowerCase()){case "first":this.b.push(new vp(this.d));this.P+=256;break;case "left":this.b.push(new wp(this.d));this.P+=1;break;case "right":this.b.push(new xp(this.d));this.P+=1;break;case "recto":this.b.push(new yp(this.d));this.P+=1;break;case "verso":this.b.push(new zp(this.d));this.P+=1;break;default:If(this,"E_INVALID_PAGE_SELECTOR :"+a)}};
function Cp(a){var b;a.e||a.u.length?b=[a.e].concat(a.u.sort()):b=null;a.B.push({Ad:b,P:a.P});a.e="";a.u=[]}n.Jb=function(){Cp(this);Qk.prototype.Jb.call(this)};n.ra=function(){Cp(this);Qk.prototype.ra.call(this)};
...
this)}}};n.Jd=function(a){zj(this.g.Yb,"*",a)};n.Ld=function(a){return new Ap(this.h,a)};n.jd=function(a){var b=oj(this.h,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);Ef(this.$,new Dp(this.d,this.$,this.k,c))};function Dp(a,b,c,d){Ff.call(this,a,b,!1);this.e=c;this.b=d}t(Dp,Gf);Dp.prototype.bb=function(a,b,c){fh(this.e,a,b,c,this)};Dp.prototype.Wb=function(a,b){Hf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Dp.prototype.Hc=function(a,b){Hf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
Dp.prototype.cb=function(a,b,c){nj(this.b,a,new V(b,c?Bf(this):Cf(this)))};var Ep=new xf(function(){var a=L("uaStylesheetBase");vf(gh).then(function(b){var c=va("user-agent-base.css",ua);b=new Qk(null,null,null,null,null,b,!0);b.Nb("UA");Pk=b.g;gg(c,b,null,null).ua(a)});return O(a)},"uaStylesheetBaseFetcher");
function Fp(a,b,c,d,e,f,g,h,l,k){this.h=a;this.d=b;this.b=c;this.e=d;this.B=e;this.g=f;this.l=a.H;this.u=g;this.f=h;this.k=l;this.w=k;this.j=a.f;kc(this.b,function(a){var b=this.b,c;c=(c=b.b[a])?(c=c.b[0])?c.b:null:null;var d;d=b.b[a];if(d=Gp(this,d?d.d:"any"))d=(a=b.b[a])?0<a.b.length&&a.b[0].b.d<=this.l:!1;return d&&!!c&&!Hp(this,c)});jc(this.b,new ic(this.b,function(){return this.ma+this.b.page},"page-number"))}
...
function Np(a,b){var c=a.b,d=Mp(a,c);if(d==Number.POSITIVE_INFINITY)return null;for(var e=a.u.children,f,g=0;g<e.length;g++)if(f=e[g],"vivliostyle-page-rule-master"!==f.d.sb){var h=1,l=hm(f,a,"utilization");l&&l.xd()&&(h=l.C);var l=pc(a,"em",!1),k=a.pb()*a.ob();a.l=El(a.d,d,Math.ceil(h*k/(l*l)));h=a;l=c;k=void 0;for(k in l.b){var m=l.b[k];if(m&&0<m.b.length){var p=m.b[0].b;if(Lp(h,m)===p.d){a:switch(p=m.d,p){case "left":case "right":case "recto":case "verso":break a;default:p=null}m.d=on(ml(p,m.b[0].b.e))}}}a.k=
c.clone();h=a;l=h.b.page;k=void 0;for(k in h.b.b)for(m=h.b.b[k],p=m.b.length-1;0<=p;p--){var r=m.b[p];0>r.b.g&&r.b.d<h.l&&(r.b.g=l)}oc(a,a.style.b);h=hm(f,a,"enabled");if(!h||h===ie){c=a;u.debug("Location - page",c.b.page);u.debug("  current:",d);u.debug("  lookup:",c.l);d=void 0;for(d in c.b.b)for(e=c.b.b[d],g=0;g<e.b.length;g++)u.debug("  Chunk",d+":",e.b[g].b.d);d=a.O;e=f;f=b;c=e.d;0===Object.keys(f).length?(c.d.e=c,f=e):(e=c,g=sp(d,f),e=e.g+"^"+g,g=d.g[e],g||("background-host"===c.sb?(c=d,f=(new ap(c.h,
...
function Op(a,b,c){var d=a.b.b[c];if(!d||!Gp(a,d.d))return N(!0);d.d="any";Pn(b);a.g[c]&&0<b.gb.length&&(b.Gd=!1);var e=L("layoutColumn"),f=[],g=[],h=!0;of(function(c){for(;0<d.b.length-g.length;){for(var e=0;0<=g.indexOf(e);)e++;var m=d.b[e];if(m.b.d>a.l||Hp(a,m.b))break;for(var p=e+1;p<d.b.length;p++)if(!(0<=g.indexOf(p))){var r=d.b[p];if(r.b.d>a.l||Hp(a,r.b))break;fi(r.b,m.b)&&(m=r,e=p)}var v=m.b,q=!0;Sn(b,m.d,h).then(function(a){h=!1;m.b.ge&&(null===a||v.f)&&f.push(e);v.f?(g.push(e),Q(c)):(a?
...
"margin-right",q.w+"px"),c=c*(Ea+oa)+q.k,Ii(ba,0,q.width),Hi(ba,c,Ea)):(x(d,"margin-top",q.k+"px"),x(d,"margin-bottom",q.u+"px"),c=c*(Ea+oa)+q.j,Hi(ba,0,q.height),Ii(ba,c,Ea));ba.D=e+q.j;ba.H=f+q.k}else ba=new wn(r,F,a.e,Ga),Gi(ba,q),q=ba;ba.I=p?[]:g;ba.xb=U;if(0<=ba.width){var k=L("inner");Op(a,ba,M).then(function(){ba.h&&"column"!=ba.h&&(ai=da,"region"!=ba.h&&(a.I[M]=!0));P(k,!0)});c=O(k)}else c=N(!0);if(c.Ca()){c.then(function(){0<h.b.length?Q(b):(Ta=Math.max(Ta,ba.e),qf(b))});return}0<h.b.length||
...
0,-1.25*pc(a,"em",!1)));g.push(l)}}else if(0==c.children.length){d.removeChild(r);P(k,!0);return}var M=c.children.length-1;nf(function(){for(;0<=M;){var d=c.children[M--],d=Pp(a,b,d,r,e,f,g,h);if(d.Ca())return d}return N(!1)}).then(function(){P(k,!0)})});return O(k)}
function Qp(a,b,c){a.I={};c?(a.b=c.clone(),xl(a.d,c.d)):(a.b=new zi,xl(a.d,-1));a.lang&&b.d.setAttribute("lang",a.lang);c=a.b;c.page++;oc(a,a.style.b);a.k=c.clone();var d=rp(a.O),e=Np(a,d);if(!e)return N(null);e.d.b.width.value===ke&&Xh(b);e.d.b.height.value===le&&Yh(b);a.f.g=b;vo(a.f,d,a);var f=Qo(Po(d),a);Rp(a,f,b);Xo(d,f,b,a);var g=f.kb+f.zb,d=hm(e,a,"writing-mode")||Hd,f=hm(e,a,"direction")||Qd,h=new Qi(b.B.bind(b),d,f),l=[],k=L("layoutNextPage");of(function(d){Pp(a,b,e,b.d,g,g,l.concat(),h).then(function(){if(0<
...
c)});return O(k)}function Rp(a,b,c){a.H=b.pb;a.D=b.ob;c.N.style.width=b.pb+2*b.Rc+"px";c.N.style.height=b.ob+2*b.Rc+"px";c.d.style.left=b.kb+"px";c.d.style.right=b.kb+"px";c.d.style.top=b.kb+"px";c.d.style.bottom=b.kb+"px";c.d.style.padding=b.zb+"px"}function Sp(a,b,c,d){Qk.call(this,a.g,a,b,c,d,a.f,!c);this.e=a;this.u=!1}t(Sp,Qk);n=Sp.prototype;n.Cc=function(){};n.Bc=function(a,b,c){a=new Ql(this.e.j,a,b,c,this.e.w,this.M,Cf(this.$));Ef(this.e,new Bm(a.d,this.e,a,this.k))};
n.Cb=function(a){a=a.d;null!=this.M&&(a=Xc(this.d,this.M,a));Ef(this.e,new Sp(this.e,a,this,this.w))};n.yc=function(){Ef(this.e,new Wk(this.d,this.$))};n.Ac=function(){var a={};this.e.k.push({Bb:a,M:this.M});Ef(this.e,new Xk(this.d,this.$,null,a,this.e.f))};n.zc=function(a){var b=this.e.h[a];b||(b={},this.e.h[a]=b);Ef(this.e,new Xk(this.d,this.$,null,b,this.e.f))};n.Ec=function(){var a={};this.e.B.push(a);Ef(this.e,new Xk(this.d,this.$,this.M,a,this.e.f))};
n.cc=function(a){var b=this.e.l;if(a){var c=oj(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Ef(this.e,new Xk(this.d,this.$,null,b,this.e.f))};n.Dc=function(){this.u=!0;this.eb()};n.Mb=function(){var a=new Bp(this.e.j,this.e,this,this.k,this.e.u);Ef(this.e,a);a.Mb()};n.ra=function(){Qk.prototype.ra.call(this);if(this.u){this.u=!1;var a="R"+this.e.H++,b=I(a),c;this.M?c=new jj(b,0,this.M):c=new V(b,0);pj(this.h,"region-id").push(c);this.mb();a=new Sp(this.e,this.M,this,a);Ef(this.e,a);a.ra()}};
function Tp(a){var b=a.getAttribute("content");if(!b)return"";a={};for(var c;null!=(c=b.match(/^,?\s*([-A-Za-z_.][-A-Za-z_0-9.]*)\s*=\s*([-+A-Za-z_0-9.]*)\s*/));)b=b.substr(c[0].length),a[c[1]]=c[2];b=a.width-0;a=a.height-0;return b&&a?"@-epubx-viewport{width:"+b+"px;height:"+a+"px;}":""}function Up(a){Df.call(this);this.f=a;this.g=new gc(null);this.j=new gc(this.g);this.w=new Nl(this.g);this.D=new Sp(this,null,null,null);this.H=0;this.k=[];this.l={};this.h={};this.B=[];this.u={};this.b=this.D}
t(Up,Df);Up.prototype.error=function(a){u.b("CSS parser:",a)};function Vp(a,b){return Wp(b,a)}function Xp(a){uf.call(this,Vp,"document");this.H=a;this.B={};this.h={};this.b={};this.D={};this.f=null;this.j=[]}t(Xp,uf);function Yp(a){var b=va("user-agent.xml",ua),c=L("OPSDocStore.init");vf(gh).then(function(d){a.f=d;vf(Ep).then(function(){a.load(b).then(function(){P(c,!0)})})});return O(c)}function Zp(a,b){a.j.push({url:b.url,text:b.text,ab:"User",Ba:null,media:null})}
function Wp(a,b){var c=L("OPSDocStore.load"),d=b.url;Gh(b,a).then(function(b){if(b){for(var f=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),h=0;h<g.length;h++){var l=g[h],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=l.getAttribute("action"),l=l.getAttribute("ref");k&&m&&p&&l&&f.push({de:k,event:m,action:p,ac:l})}a.D[d]=f;var r=[],f=va("user-agent-page.css",ua);r.push({url:f,text:null,
...
for(var v="",h=0;h<r.length;h++)v+=r[h].url,v+="^",r[h].text&&(v+=r[h].text),v+="^";var q=a.B[v];q?(a.b[d]=q,P(c,b)):(f=a.h[v],f||(f=new xf(function(){var b=L("fetchStylesheet"),c=0,d=new Up(a.f);nf(function(){if(c<r.length){var a=r[c++];d.Nb(a.ab);return null!==a.text?hg(a.text,d,a.url,a.Ba,a.media).kd(!0):gg(a.url,d,a.Ba,a.media)}return N(!1)}).then(function(){q=new Fp(a,d.g,d.j,d.D.g,d.w,d.k,d.l,d.h,d.B,d.u);a.B[v]=q;delete a.h[v];P(b,q)});return O(b)},"FetchStylesheet "+d),a.h[v]=f,f.start()),
vf(f).then(function(f){a.b[d]=f;P(c,b)}))}else P(c,null)});return O(c)};function $p(a,b,c,d,e,f,g,h,l,k){this.b=a;this.url=b;this.lang=c;this.d=d;this.h=e;this.T=Zb(f);this.j=g;this.g=h;this.f=l;this.e=k;this.Ja=this.page=null}function aq(a,b,c){if(0!=c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=Ia(d,"height","auto")&&(x(d,"height","auto"),aq(a,d,c));"absolute"==Ia(d,"position","static")&&(x(d,"position","relative"),aq(a,d,c))}}
...
$p.prototype.$c=function(a){var b=this.j.$c(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",x(e,"cursor","pointer"),e.addEventListener("click",bq,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
$p.prototype.xc=function(a,b,c,d,e){if(this.page)return N(this.page);var f=this,g=L("showTOC"),h=new Wh(a,a);this.page=h;this.b.load(this.url).then(function(d){var k=f.b.b[d.url],m=Ip(k,c,1E5,e);b=new mn(b.f,m.fontSize,b.root,m.width,m.height);var p=new Jp(k,d,f.lang,b,f.d,f.h,f.$c(d),f.g,0,f.f,f.e);f.Ja=p;p.T=f.T;Kp(p).then(function(){Qp(p,h,null).then(function(){aq(f,a,2);P(g,h)})})});return O(g)};
$p.prototype.tc=function(){if(this.page){var a=this.page;this.Ja=this.page=null;x(a.N,"visibility","none");var b=a.N.parentNode;b&&b.removeChild(a.N)}};$p.prototype.yd=function(){return!!this.page};function cq(){Xp.call(this,dq(this));this.d=new uf(Gh,"document");this.u=new uf(yf,"text");this.w={};this.O={};this.k={};this.l={}}t(cq,Xp);function dq(a){return function(b){return a.k[b]}}
function eq(a,b,c){var d=L("loadEPUBDoc");"/"!==b.substring(b.length-1)&&(b+="/");c&&a.u.qc(b+"?r=list");a.d.qc(b+"META-INF/encryption.xml");var e=b+"META-INF/container.xml";a.d.load(e,!0,"Failed to fetch EPUB container.xml from "+e).then(function(f){if(f){f=Qh(vh(vh(vh(new wh([f.b]),"container"),"rootfiles"),"rootfile"),"full-path");for(var g=0;g<f.length;g++){var h=f[g];if(h){fq(a,b,h,c).ua(d);return}}P(d,null)}else u.error("Received an empty response for EPUB container.xml "+e+". This may be caused by the server not allowing cross origin requests.")});
return O(d)}function fq(a,b,c,d){var e=b+c,f=a.w[e];if(f)return N(f);var g=L("loadOPF");a.d.load(e,void 0,void 0).then(function(c){c?a.d.load(b+"META-INF/encryption.xml",void 0,void 0).then(function(l){(d?a.u.load(b+"?r=list"):N(null)).then(function(d){f=new gq(a,b);hq(f,c,l,d,b+"?r=manifest").then(function(){a.w[e]=f;a.O[b]=f;P(g,f)})})}):u.error("Received an empty response for EPUB OPF "+e+". This may be caused by the server not allowing cross origin requests.")});return O(g)}
function iq(a,b,c){var d=L("EPUBDocStore.load");b=ta(b);(a.l[b]=Wp(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,wc:null})).ua(d);return O(d)}
cq.prototype.load=function(a){var b=ta(a);if(a=this.l[b])return a.Ca()?a:N(a.mc());var c=L("EPUBDocStore.load");a=cq.Pd.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?P(c,a):u.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return O(c)};function jq(){this.id=null;this.src="";this.f=this.d=null;this.F=-1;this.h=0;this.j=null;this.b=this.e=0;this.g=Va}function kq(a){return a.id}
function lq(a){var b=Qe(a);return function(a){var d=L("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));tf(e).then(function(a){a=new DataView(a);for(var c=0;c<a.byteLength;c++){var e=a.getUint8(c),e=e^b[c%20];a.setUint8(c,e)}P(d,sf([a,f]))});return O(d)}}
...
function qq(a,b){function c(a){for(var b in a){var d=a[b];d.sort(pq(b,k));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return Ya(a,function(a){return Xa(a,function(a){var b={v:a.value,o:a.Q};a.Ge&&(b.s=a.scheme);if(a.id||a.lang){var c=l[a.id];if(c||a.lang)a.lang&&(a={name:nq,value:a.lang,lang:null,id:null,gd:a.id,scheme:null,Q:a.Q},c?c.push(a):c=[a]),c=Wa(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in mq)f[g]=mq[g];for(;null!=(g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/));)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=mq;var h=1;g=Oh(Ph(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),Q:h++,gd:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:mq.dcterms+a.localName,Q:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),gd:null,scheme:null};return null});var l=Wa(g,function(a){return a.gd});g=d(Wa(g,function(a){return a.gd?null:a.name}));var k=null;g[nq]&&(k=g[nq][0].v);c(g);return g}function rq(){var a=window.MathJax;return a?a.Hub:null}var sq={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function gq(a,b){this.f=a;this.h=this.d=this.b=this.g=this.e=null;this.l=b;this.k=null;this.I={};this.lang=null;this.w=0;this.u={};this.O=this.H=this.S=null;this.B={};this.D=null;this.j=tq(this);rq()&&($i["http://www.w3.org/1998/Math/MathML"]=!0)}
function tq(a){function b(){}b.prototype.Gc=function(a,b){return encodeURIComponent(b+(a?"#"+a:""))};b.prototype.b=function(b,d){var e=b.match(/^([^#]*)#?(.*)$/);if(e){var f=e[1]||d,e=e[2];if(f&&a.g.some(function(a){return a.src===f}))return"#"+this.Gc(e,f)}return b};b.prototype.he=function(a){"#"===a.charAt(0)&&(a=a.substring(1));return(a=decodeURIComponent(a).match(/^([^#]*)#?(.*)$/))?[a[1],a[2]]:[]};return new b}
function uq(a,b){return a.l?b.substr(0,a.l.length)==a.l?decodeURI(b.substr(a.l.length)):null:b}
function hq(a,b,c,d,e){a.e=b;var f=vh(new wh([b.b]),"package"),g=Qh(f,"unique-identifier")[0];g&&(g=Ch(b,b.url+"#"+g))&&(a.k=g.textContent.replace(/[ \n\r\t]/g,""));var h={};a.g=Xa(Mh(vh(vh(f,"manifest"),"item")),function(c){var d=new jq,e=b.url;d.id=c.getAttribute("id");d.src=va(c.getAttribute("href"),e);d.d=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.g=f}(c=c.getAttribute("fallback"))&&!sq[d.d]&&(h[d.src]=c);!a.H&&
d.g.nav&&(a.H=d);!a.O&&d.g["cover-image"]&&(a.O=d);return d});a.d=Ua(a.g,kq);a.h=Ua(a.g,function(b){return uq(a,b.src)});for(var l in h)for(g=l;;){g=a.d[h[g]];if(!g)break;if(sq[g.d]){a.B[l]=g.src;break}g=g.src}a.b=Xa(Mh(vh(vh(f,"spine"),"itemref")),function(b,c){var d=b.getAttribute("idref");if(d=a.d[d])d.f=b,d.F=c;return d});if(l=Qh(vh(f,"spine"),"toc")[0])a.S=a.d[l];if(l=Qh(vh(f,"spine"),"page-progression-direction")[0]){a:switch(l){case "ltr":l="ltr";break a;case "rtl":l="rtl";break a;default:throw Error("unknown PageProgression: "+
l);}a.D=l}var g=c?Qh(vh(vh(Lh(vh(vh(new wh([c.b]),"encryption"),"EncryptedData"),Kh()),"CipherData"),"CipherReference"),"URI"):[],k=Mh(vh(vh(f,"bindings"),"mediaType"));for(c=0;c<k.length;c++){var m=k[c].getAttribute("handler");(l=k[c].getAttribute("media-type"))&&m&&a.d[m]&&(a.I[l]=a.d[m].src)}a.u=qq(vh(f,"metadata"),Qh(f,"prefix")[0]);a.u[nq]&&(a.lang=a.u[nq][0].v);if(!d){if(0<g.length&&a.k)for(d=lq(a.k),c=0;c<g.length;c++)a.f.k[a.l+g[c]]=d;return N(!0)}f=new Ja;k={};if(0<g.length&&a.k)for(l="1040:"+
Re(a.k),c=0;c<g.length;c++)k[g[c]]=l;for(c=0;c<d.length;c++){var p=d[c];if(m=p.n){var r=decodeURI(m),g=a.h[r];l=null;g&&(g.j=0!=p.m,g.h=p.c,g.d&&(l=g.d.replace(/\s+/g,"")));g=k[r];if(l||g)f.append(m),f.append(" "),f.append(l||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}vq(a);return rf(e,"","POST",f.toString(),"text/plain")}function vq(a){for(var b=0,c=0;c<a.b.length;c++){var d=a.b[c],e=Math.ceil(d.h/1024);d.e=b;d.b=e;b+=e}a.w=b}
function wq(a,b,c){a.d={};a.h={};a.g=[];a.b=a.g;var d=a.e=new uh(null,"",(new DOMParser).parseFromString("<spine></spine>","text/xml"));b.forEach(function(a,b){var c=new jq;c.F=b;c.id="item"+(b+1);c.src=a;var h=d.b.createElement("itemref");h.setAttribute("idref",c.id);d.root.appendChild(h);c.f=h;this.d[c.id]=c;this.h[a]=c;this.g.push(c)},a);return c?iq(a.f,b[0],c):N(null)}
function xq(a,b,c){var d=a.b[b],e=L("getCFI");a.f.load(d.src).then(function(a){var b=Ah(a,c),h=null;b&&(a=yh(a,b,0,!1),h=new lb,ob(h,b,c-a),d.f&&ob(h,d.f,0),h=h.toString());P(e,h)});return O(e)}
function yq(a,b){return Xe("resolveFragment",function(c){if(b){var d=new lb;mb(d,b);var e;if(a.e){var f=nb(d,a.e.b);if(1!=f.fa.nodeType||f.J||!f.ac){P(c,null);return}var g=f.fa,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.d[h]){P(c,null);return}e=a.d[h];d=f.ac}else e=a.b[0];a.f.load(e.src).then(function(a){var b=nb(d,a.b);a=yh(a,b.fa,b.offset,b.J);P(c,{F:e.F,na:a,G:-1})})}else P(c,null)},function(a,d){u.b(d,"Cannot resolve fragment:",b);P(a,null)})}
function zq(a,b){return Xe("resolveEPage",function(c){if(0>=b)P(c,{F:0,na:0,G:-1});else{var d=Ra(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.f.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=zh(a),g=Math.round(a*b/e.b),g==a&&g--);P(c,{F:d,na:g,G:-1})})}},function(a,d){u.b(d,"Cannot resolve epage:",b);P(a,null)})}
function Aq(a,b){var c=a.b[b.F];if(0>=b.na)return N(c.e);var d=L("getEPage");a.f.load(c.src).then(function(a){a=zh(a);var f=Math.min(a,b.na);P(d,c.e+f*c.b/a)});return O(d)}function Bq(a,b,c,d,e){this.b=a;this.viewport=b;this.g=c;this.h=e;this.Lb=[];this.na=this.G=this.F=0;this.T=Zb(d);this.f=new jn(b.f);this.d=new uo(a.j)}function Cq(a){var b=a.Lb[a.F];return b?b.qb[a.G]:null}n=Bq.prototype;n.nb=function(){if(this.b.D)return this.b.D;var a=this.Lb[this.F];return a?a.Ja.ba:null};
...
function Eq(a,b,c){var d=L("renderSinglePage"),e=Fq(a,b,c);Qp(b.Ja,e,c).then(function(f){var g=(c=f)?c.page-1:b.Ka.length-1;Dq(a,b,e,g);xo(a.d,a.F,g);var h=a.F,l=a.G,k=a.na;f=null;if(c){var m=b.Ka[c.page];b.Ka[c.page]=c;m&&b.qb[c.page]&&!Ai(c,m)&&(a.G=c.page,f=Eq(a,b,c))}f||(f=N(!0));f.then(function(){var b=yo(a.d,e),f=0;of(function(c){f++;if(f>b.length)Q(c);else{var d=b[f-1];d.vc=d.vc.filter(function(a){return!a.bc});0===d.vc.length?qf(c):(a.F=d.F,a.G=d.G,Gq(a).then(function(b){b?(wo(a.d,d.cd),zo(a.d,
d.vc),Eq(a,b,b.Ka[a.G]).then(function(){var b=a.d;b.b=b.u.pop();b=a.d;b.d=b.B.pop();qf(c)})):qf(c)}))}}).then(function(){a.F=h;a.G=l;a.na=k;P(d,{page:e,position:c,G:g})})})});return O(d)}
function Hq(a){var b=L("renderPage");Gq(a).then(function(c){if(c){var d=-1;if(0>a.G){var d=a.na,e=Ra(c.Ka.length,function(a){return Mp(c.Ja,c.Ka[a])>d});a.G=e==c.Ka.length?Number.POSITIVE_INFINITY:e-1}var f=c.qb[a.G];f?(a.na=f.offset,P(b,f)):of(function(b){if(a.G<c.Ka.length)Q(b);else if(c.complete)a.G=c.Ka.length-1,Q(b);else{var e=c.Ka[c.Ka.length-1];Eq(a,c,e).then(function(l){var k=l.page;e=l.position;l=l.G;e?0<=d&&Mp(c.Ja,e)>d?(f=k,a.G=c.Ka.length-2,Q(b)):qf(b):(f=k,a.G=l,0>d&&(a.na=k.offset),
c.complete=!0,k.k=c.item.F==a.b.b.length-1,Q(b))})}}).then(function(){f=f||c.qb[a.G];var e=c.Ka[a.G];0>d&&(a.na=Mp(c.Ja,e));f?P(b,f):Eq(a,c,e).then(function(d){var f=d.page;e=d.position;e||(c.complete=!0,f.k=c.item.F==a.b.b.length-1);P(b,f)})})}else P(b,null)});return O(b)}n.hd=function(){return Iq(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};
function Iq(a,b,c){var d=L("renderAllPages"),e=a.F,f=a.G;a.F=0;of(function(d){a.G=a.F==b?c:Number.POSITIVE_INFINITY;Hq(a).then(function(){++a.F>b?Q(d):qf(d)})}).then(function(){a.F=e;a.G=f;Hq(a).ua(d)});return O(d)}n.Wd=function(){this.G=this.F=0;return Hq(this)};n.Xd=function(){this.F=this.b.b.length-1;this.G=Number.POSITIVE_INFINITY;return Hq(this)};
n.nextPage=function(){var a=this,b=L("nextPage");Gq(a).then(function(c){if(c){if(c.complete&&a.G==c.Ka.length-1){if(a.F>=a.b.b.length-1){P(b,null);return}a.F++;a.G=0}else a.G++;Hq(a).ua(b)}else P(b,null)});return O(b)};n.fd=function(){if(0==this.G){if(0==this.F)return N(null);this.F--;this.G=Number.POSITIVE_INFINITY}else this.G--;return Hq(this)};function Jq(a,b){var c="left"===b.j,d="ltr"===a.nb();return!c&&d||c&&!d}
function Kq(a){var b=L("getCurrentSpread"),c=Cq(a);if(!c)return N({left:null,right:null});var d=a.F,e=a.G,f="left"===c.j;(Jq(a,c)?a.fd():a.nextPage()).then(function(g){a.F=d;a.G=e;Hq(a).then(function(){f?P(b,{left:c,right:g}):P(b,{left:g,right:c})})});return O(b)}n.ce=function(){var a=Cq(this);if(!a)return N(null);var a=Jq(this,a),b=this.nextPage();if(a)return b;var c=this;return b.Fc(function(){return c.nextPage()})};
n.fe=function(){var a=Cq(this);if(!a)return N(null);var a=Jq(this,a),b=this.fd();if(a){var c=this;return b.Fc(function(){return c.fd()})}return b};function Lq(a,b){var c=L("navigateToEPage");zq(a.b,b).then(function(b){b&&(a.F=b.F,a.G=b.G,a.na=b.na);Hq(a).ua(c)});return O(c)}function Mq(a,b){var c=L("navigateToCFI");yq(a.b,b).then(function(b){b&&(a.F=b.F,a.G=b.G,a.na=b.na);Hq(a).ua(c)});return O(c)}
function Nq(a,b){u.debug("Navigate to",b);var c=uq(a.b,ta(b));if(!c){if(a.b.e&&b.match(/^#epubcfi\(/))c=uq(a.b,a.b.e.url);else if("#"===b.charAt(0)){var d=a.b.j.he(b);a.b.e?c=uq(a.b,d[0]):c=d[0];b=c+(d[1]?"#"+d[1]:"")}if(null==c)return N(null)}d=a.b.h[c];if(!d)return a.b.e&&c==uq(a.b,a.b.e.url)&&(c=b.indexOf("#"),0<=c)?Mq(a,b.substr(c+1)):N(null);d.F!=a.F&&(a.F=d.F,a.G=0);var e=L("navigateTo");Gq(a).then(function(c){var d=Ch(c.X,b);d&&(a.na=xh(c.X,d),a.G=-1);Hq(a).ua(e)});return O(e)}
function Fq(a,b,c){var d=b.Ja.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.style.position="absolute";e.style.top="0";e.style.left="0";ka||(e.style.visibility="hidden");d.root.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);var g=new Wh(e,f);g.F=b.item.F;g.position=c;g.offset=Mp(b.Ja,c);0===g.offset&&f.setAttribute("id",a.b.j.Gc("",b.item.src));d!==a.viewport&&(a=bc(a.viewport.width,a.viewport.height,
d.width,d.height),a=ig(null,new Vb(a,null)),g.h.push(new Th(e,"transform",a)));return g}function Oq(a,b){var c=rq();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=L("navigateToEPage"),f=gf(c);d.Push(function(){f.Va(e)});return O(c)}return N(null)}
n.$c=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=va(f,a.url),g=c.getAttribute("media-type");if(!g){var h=uq(b.b,f);h&&(h=b.b.h[h])&&(g=h.d)}if(g&&(h=b.b.I[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Na(f),l=Na(g),g=new Ja;g.append(h);g.append("?src=");g.append(f);g.append("&type=");g.append(l);for(h=c.firstChild;h;h=h.nextSibling)1==h.nodeType&&
...
c.namespaceURI)e=Oq(c,d);else if("http://example.com/sse"==c.namespaceURI){e=d?d.ownerDocument:b.viewport.b;g=c.localName;switch(g){case "t":case "tab":case "ec":case "nt":case "fraction":case "comment":case "mark":g="span";break;case "ruby":case "rp":case "rt":break;default:g="div"}e=e.createElement(g);e.setAttribute("data-adapt-process-children","true");e=N(e)}else e=c.dataset&&"true"==c.dataset.mathTypeset?Oq(c,d):N(null);return e}};
function Gq(a){if(a.F>=a.b.b.length)return N(null);var b=a.Lb[a.F];if(b)return N(b);var c=a.b.b[a.F],d=a.b.f,e=L("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(zh(f)/2700),a.b.w=c.b);var g=d.b[f.url],h=a.$c(f),l=a.viewport,k=Ip(g,l.width,l.height,l.fontSize);if(k.width!=l.width||k.height!=l.height||k.fontSize!=l.fontSize)l=new mn(l.f,k.fontSize,l.root,k.width,k.height);var k=a.Lb[a.F-1],m=new Jp(g,f,a.b.lang,l,a.f,a.g,h,a.b.B,k?k.Ja.ma+k.qb.length:0,a.b.j,
a.d);m.T=a.T;Kp(m).then(function(){b={item:c,X:f,Ja:m,Ka:[null],qb:[],complete:!1};a.Lb[a.F]=b;P(e,b)})});return O(e)}function Pq(a){return{F:a.F,G:a.G,na:a.na}}function Qq(a,b){b?(a.F=b.F,a.G=-1,a.na=b.na):(a.F=0,a.G=0,a.na=0);return Iq(a,a.F,a.G)}
n.xc=function(){var a=this.b,b=a.H||a.S;if(!b)return N(null);var c=L("showTOC");this.e||(this.e=new $p(a.f,b.src,a.lang,this.f,this.g,this.T,this,a.B,a.j,this.d));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background=
...
this.I=!1;this.ba={loadEPUB:this.Sd,loadXML:this.Td,configure:this.rd,moveTo:this.ma,toc:this.xc};Sq(this)}function Sq(a){sa(1,function(a){Tq(this,{t:"debug",content:a})}.bind(a));sa(2,function(a){Tq(this,{t:"info",content:a})}.bind(a));sa(3,function(a){Tq(this,{t:"warn",content:a})}.bind(a));sa(4,function(a){Tq(this,{t:"error",content:a})}.bind(a))}function Tq(a,b){b.i=a.za;a.oa(b)}n=Rq.prototype;
n.Sd=function(a){Go.b("loadEPUB");Go.b("loadFirstPage");this.ib.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet;this.viewport=null;var f=L("loadEPUB"),g=this;g.rd(a).then(function(){var a=new cq;if(e)for(var l=0;l<e.length;l++)Zp(a,e[l]);Yp(a).then(function(){var e=va(b,g.h.location.href);g.H=[e];eq(a,e,d).then(function(a){g.g=a;yq(g.g,c).then(function(a){g.f=a;Uq(g).then(function(){g.ib.setAttribute("data-vivliostyle-viewer-status",
"complete");Go.d("loadEPUB");Tq(g,{t:"loaded",metadata:g.g.u});P(f,!0)})})})})});return O(f)};
n.Td=function(a){Go.b("loadXML");Go.b("loadFirstPage");this.ib.setAttribute("data-vivliostyle-viewer-status","loading");var b;"string"===typeof a.url?b=[a.url]:b=a.url;var c=a.document,d=a.fragment,e=a.userStyleSheet;this.viewport=null;var f=L("loadXML"),g=this;g.rd(a).then(function(){var a=new cq;if(e)for(var l=0;l<e.length;l++)Zp(a,e[l]);Yp(a).then(function(){var e=b.map(function(a){return va(a,g.h.location.href)});g.H=e;g.g=new gq(a,"");wq(g.g,e,c).then(function(){yq(g.g,d).then(function(a){g.f=
a;Uq(g).then(function(){g.ib.setAttribute("data-vivliostyle-viewer-status","complete");Go.d("loadXML");Tq(g,{t:"loaded"});P(f,!0)})})})})});return O(f)};function Vq(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*lc.ex*a.fontSize/lc.em;if(d=lc[d])return c*d}return c}
...
a.zoom,this.D=!0);return N(!0)};n.dd=function(a){var b=this.e;b===a.target&&(b=a.be);Wq(this,b)};function Xq(a){var b=[];a.e&&(b.push(a.e),a.e=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(x(a.N,"display","none"),a.removeEventListener("hyperlink",this.u,!1),a.removeEventListener("replaced",this.dd,!1))},a)}function Yq(a,b){b.addEventListener("hyperlink",a.u,!1);b.addEventListener("replaced",a.dd,!1);x(b.N,"visibility","visible");x(b.N,"display","block")}
function Zq(a,b){Xq(a);a.e=b;Yq(a,b)}function $q(a){var b=L("reportPosition");a.f||(a.f=Pq(a.b));xq(a.g,a.f.F,a.f.na).then(function(c){var d=a.e;(a.S&&0<d.g.length?tg(d.g):N(!0)).then(function(){ar(a,d,c).ua(b)})});return O(b)}
...
function dr(a){if(a.b){a.b.tc();for(var b=a.b.Lb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.qb,e;e=d.shift();)e=e.N,e.parentNode.removeChild(e)}}a.w&&(a.w.textContent="",a.I=!1);a.viewport=br(a);b=a.viewport;x(b.e,"width","");x(b.e,"height","");x(b.d,"width","");x(b.d,"height","");x(b.d,"transform","");a.b=new Bq(a.g,a.viewport,a.ka,a.T,a.ie.bind(a))}
function Wq(a,b){a.D=!1;if(a.T.Xa)return Kq(a.b).Fc(function(c){Xq(a);a.j=c;c.left&&(Yq(a,c.left),c.right||c.left.N.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Yq(a,c.right),c.left||c.right.N.setAttribute("data-vivliostyle-unpaired-page",!0));c=er(a,c);a.viewport.zoom(c.width,c.height,a.zoom);a.e=b;return N(null)});Zq(a,b);a.viewport.zoom(b.e.width,b.e.height,a.zoom);a.e=b;return N(null)}
...
function Uq(a){a.d=!1;if(cr(a))return N(!0);"complete"===a.ib.getAttribute("data-vivliostyle-viewer-status")&&a.ib.setAttribute("data-vivliostyle-viewer-status","resizing");Tq(a,{t:"resizestart"});var b=L("resize");a.b&&!a.f&&(a.f=Pq(a.b));dr(a);Qq(a.b,a.f).then(function(c){Wq(a,c).then(function(){$q(a).then(function(c){Go.d("loadFirstPage");(a.hd?a.b.hd():N(null)).then(function(){a.ib.setAttribute("data-vivliostyle-viewer-status","complete");Tq(a,{t:"resizeend"});P(b,c)})})})});return O(b)}
function ar(a,b,c){var d=L("sendLocationNotification"),e={t:"nav",first:b.l,last:b.k};Aq(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.w;c&&(e.cfi=c);Tq(a,e);P(d,!0)});return O(d)}Rq.prototype.nb=function(){return this.b?this.b.nb():null};
Rq.prototype.ma=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.T.Xa?this.b.ce:this.b.nextPage;break;case "previous":a=this.T.Xa?this.b.fe:this.b.fd;break;case "last":a=this.b.Xd;break;case "first":a=this.b.Wd;break;default:return N(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return Lq(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return Nq(b.b,d)}}else return N(!0);var e=L("nextPage");a.call(b.b).then(function(a){a?(b.f=
null,Wq(b,a).then(function(){$q(b).ua(e)})):P(e,!0)});return O(e)};Rq.prototype.xc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.yd();if(c){if("show"==a)return N(!0)}else if("hide"==a)return N(!0);if(c)return this.b.tc(),N(!0);var d=this,e=L("showTOC");this.b.xc(b).then(function(a){if(a){if(b){var c=function(){d.b.tc()};a.addEventListener("hyperlink",c,!1);a.N.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.u,!1)}P(e,!0)});return O(e)};
function gr(a,b){var c=b.a||"";return Xe("runCommand",function(d){var e=a.ba[c];e?e.call(a,b).then(function(){Tq(a,{t:"done",a:c});P(d,!0)}):(u.error("No such action:",c),P(d,!0))},function(a,b){u.error(b,"Error during action:",c);P(a,!0)})}function hr(a){return"string"==typeof a?JSON.parse(a):a}
function ir(a,b){var c=hr(b),d=null;Ze(function(){var b=L("commandLoop"),f=Se.d;a.u=function(b){var c="#"===b.href.charAt(0)||a.H.some(function(a){return b.href.substr(0,a.length)==a}),d={t:"hyperlink",href:b.href,internal:c};$e(f,function(){Tq(a,d);return N(!0)})};of(function(b){if(a.d)Uq(a).then(function(){qf(b)});else if(a.D)a.e&&Wq(a,a.e).then(function(){qf(b)});else if(c){var e=c;c=null;gr(a,e).then(function(){qf(b)})}else e=L("waitForCommand"),d=gf(e,self),O(e).then(function(){qf(b)})}).ua(b);
return O(b)});a.B=function(){var a=d;a&&(d=null,a.Va())};a.k=function(b){if(c)return!1;c=hr(b);a.B();return!0};a.h.adapt_command=a.k};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Ub||(Object.Ub=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function jr(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}function kr(a,b){ka=a.debug;this.f=a;this.b=new Rq(a.window||window,a.viewportElement,"main",this.Vd.bind(this));this.e={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,spreadView:!1,zoom:1};b&&this.Od(b);this.d=new Za}n=kr.prototype;
n.Od=function(a){var b=Object.Ub({a:"configure"},jr(a));this.b.k(b);Object.Ub(this.e,a)};n.Vd=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});$a(this.d,b)};n.je=function(a,b){this.d.addEventListener(a,b,!1)};n.me=function(a,b){this.d.removeEventListener(a,b,!1)};n.Yd=function(a,b,c){a||$a(this.d,{type:"error",content:"No URL specified"});lr(this,a,null,b,c)};n.ke=function(a,b,c){a||$a(this.d,{type:"error",content:"No URL specified"});lr(this,null,a,b,c)};
...
ca("vivliostyle.viewer.Viewer",kr);kr.prototype.setOptions=kr.prototype.Od;kr.prototype.addListener=kr.prototype.je;kr.prototype.removeListener=kr.prototype.me;kr.prototype.loadDocument=kr.prototype.Yd;kr.prototype.loadEPUB=kr.prototype.ke;kr.prototype.getCurrentPageProgression=kr.prototype.nb;kr.prototype.navigateToPage=kr.prototype.$d;kr.prototype.navigateToInternalUrl=kr.prototype.Zd;kr.prototype.queryZoomFactor=kr.prototype.le;ca("vivliostyle.viewer.ZoomType",fr);fr.FIT_INSIDE_VIEWPORT="fit inside viewport";
...
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(ya(location.href,Na(a||"")));break;case "hyperlink":a.internal&&or({a:"moveTo",url:a.href})}}
