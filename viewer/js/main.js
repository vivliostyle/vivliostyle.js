 ...
 *
 * Vivliostyle core 2016.10.1-pre.20170202150155
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
eb.prototype.g=function(a){a.append(":");a.append(this.offset.toString());if(this.f||this.b||this.nb){a.append("[");if(this.f||this.b)this.f&&a.append(this.f.replace(/[\[\]\(\),=;^]/g,Za)),a.append(","),this.b&&a.append(this.b.replace(/[\[\]\(\),=;^]/g,Za));this.nb&&(a.append(";s="),a.append(this.nb));a.append("]")}};function fb(){this.la=null}
...
if(!c)throw Error("E_CFI_NUMBER_EXPECTED");e+=c[0].length;g=parseInt(c[1],10);(h=c[4])&&(h=ab(h));var l=c[7];l&&(l=ab(l));c=bb(c[10]);f.push(new eb(g,h,l,sa(c.s)));break;case "!":e++;f.push(new cb);break;case "~":case "@":case "":a.la=f;return;default:throw Error("E_CFI_PARSE_ERROR");}}function hb(a,b){for(var c={node:b.documentElement,offset:0,M:!1,nb:null,Fc:null},d=0;d<a.la.length;d++)if(!a.la[d].h(c)){++d<a.la.length&&(c.Fc=new fb,c.Fc.la=a.la.slice(d));break}return c}
...
d=!1}f.reverse();a.la?(f.push(new cb),a.la=f.concat(a.la)):a.la=f}fb.prototype.toString=function(){if(!this.la)return"";var a=new Da;a.append("epubcfi(");for(var b=0;b<this.la.length;b++)this.la[b].g(a);a.append(")");return a.toString()};function jb(){return{fontFamily:"serif",lineHeight:1.25,margin:8,Ad:!0,vd:25,zd:!1,Gd:!1,ob:!1,ic:1,ae:{print:!0}}}function kb(a){return{fontFamily:a.fontFamily,lineHeight:a.lineHeight,margin:a.margin,Ad:a.Ad,vd:a.vd,zd:a.zd,Gd:a.Gd,ob:a.ob,ic:a.ic,ae:Object.assign({},a.ae)}}var lb=jb(),mb={};function nb(a,b,c,d){a=Math.min((a-0)/c,(b-0)/d);return"matrix("+a+",0,0,"+a+",0,0)"}function ob(a){return'"'+Ga(a+"")+'"'}function pb(a){return Fa(a+"")}function qb(a,b){return a?Fa(a)+"."+Fa(b):Fa(b)}
var rb=0;
...
Ac.prototype.ra=function(a){return new tb(a,this.lc)};Ac.prototype.Ma=function(a,b){b?(a.append('"'),a.append(Ga(this.lc)),a.append('"')):a.append(this.lc)};Ac.prototype.ba=function(a){return a.Nc(this)};function Bc(a){this.name=a;if(oc[a])throw Error("E_INVALID_CALL");oc[a]=this}t(Bc,uc);Bc.prototype.ra=function(a){return new tb(a,this.name)};Bc.prototype.Ma=function(a,b){b?a.append(Fa(this.name)):a.append(this.name)};Bc.prototype.ba=function(a){return a.Ob(this)};Bc.prototype.Ie=function(){return!0};
...
function Rd(a,b,c){var d=b.frameTrace;if(!d){for(var d=b.stack?b.stack+"\n\t---- async ---\n":"",e=a.top;e;e=e.parent)d+="\t",d+=e.name,d+="\n";b.frameTrace=d}if(c){for(d=a.top;d&&d!=c;)d=d.parent;d==c&&(a.top=d)}for(a.g=b;a.top&&!a.top.j;)a.top=a.top.parent;a.top?(b=a.g,a.g=null,a.top.j(a.top,b)):a.g&&u.error(a.g,"Unhandled exception in task",a.name)}function Pd(a){this.value=a}p=Pd.prototype;p.then=function(a){a(this.value)};p.na=function(a){return a(this.value)};p.md=function(a){return new Pd(a)};
p.Fa=function(a){O(a,this.value)};p.za=function(){return!1};p.get=function(){return this.value};function ce(a){this.b=a}p=ce.prototype;p.then=function(a){this.b.then(a)};p.na=function(a){if(this.za()){var b=new Nd(this.b.f,this.b.parent,"AsyncResult.thenAsync");b.b=Od;this.b.parent=b;this.b.then(function(c){a(c).then(function(a){O(b,a)})});return M(b)}return a(this.b.g)};p.md=function(a){return this.za()?this.na(function(){return new Pd(a)}):new Pd(a)};
...
function bf(a){a=a.responseText;return L(a?JSON.parse(a):null)};function cf(a){var b=parseInt(a,16);if(isNaN(b))throw Error("E_CSS_COLOR");if(6==a.length)return new Ec(b);if(3==a.length)return new Ec(b&15|(b&15)<<4|(b&240)<<4|(b&240)<<8|(b&3840)<<8|(b&3840)<<12);throw Error("E_CSS_COLOR");}function df(a){this.f=a;this.Xa="Author"}p=df.prototype;p.yc=function(){return null};p.ha=function(){return this.f};p.error=function(){};p.kc=function(a){this.Xa=a};p.yb=function(){};p.ud=function(){};p.Dc=function(){};p.Ec=function(){};p.Bd=function(){};p.Sc=function(){};
p.Db=function(){};p.sd=function(){};p.qd=function(){};p.xd=function(){};p.hc=function(){};p.tb=function(){};p.gd=function(){};p.Hc=function(){};p.ld=function(){};p.ed=function(){};p.kd=function(){};p.jc=function(){};p.Pd=function(){};p.Zb=function(){};p.fd=function(){};p.jd=function(){};p.hd=function(){};p.Kc=function(){};p.Jc=function(){};p.wa=function(){};p.rb=function(){};p.Eb=function(){};p.Ic=function(){};p.Uc=function(){};
function ef(a){switch(a.Xa){case "UA":return 0;case "User":return 100663296;default:return 83886080}}function ff(a){switch(a.Xa){case "UA":return 0;case "User":return 16777216;default:return 33554432}}function gf(){df.call(this,null);this.g=[];this.b=null}t(gf,df);function hf(a,b){a.g.push(a.b);a.b=b}p=gf.prototype;p.yc=function(){return null};p.ha=function(){return this.b.ha()};p.error=function(a,b){this.b.error(a,b)};
p.kc=function(a){df.prototype.kc.call(this,a);0<this.g.length&&(this.b=this.g[0],this.g=[]);this.b.kc(a)};p.yb=function(a,b){this.b.yb(a,b)};p.ud=function(a){this.b.ud(a)};p.Dc=function(a,b){this.b.Dc(a,b)};p.Ec=function(a,b){this.b.Ec(a,b)};p.Bd=function(a){this.b.Bd(a)};p.Sc=function(a,b,c,d){this.b.Sc(a,b,c,d)};p.Db=function(){this.b.Db()};p.sd=function(){this.b.sd()};p.qd=function(){this.b.qd()};p.xd=function(){this.b.xd()};p.hc=function(){this.b.hc()};p.tb=function(){this.b.tb()};p.gd=function(){this.b.gd()};
p.Hc=function(a){this.b.Hc(a)};p.ld=function(){this.b.ld()};p.ed=function(){this.b.ed()};p.kd=function(){this.b.kd()};p.jc=function(){this.b.jc()};p.Pd=function(a){this.b.Pd(a)};p.Zb=function(a){this.b.Zb(a)};p.fd=function(a){this.b.fd(a)};p.jd=function(){this.b.jd()};p.hd=function(a,b,c){this.b.hd(a,b,c)};p.Kc=function(a,b,c){this.b.Kc(a,b,c)};p.Jc=function(a,b,c){this.b.Jc(a,b,c)};p.wa=function(){this.b.wa()};p.rb=function(a,b,c){this.b.rb(a,b,c)};p.Eb=function(){this.b.Eb()};p.Ic=function(a){this.b.Ic(a)};
p.Uc=function(){this.b.Uc()};function jf(a,b,c){df.call(this,a);this.J=c;this.H=0;if(this.ja=b)this.Xa=b.Xa}t(jf,df);jf.prototype.yc=function(){return this.ja.yc()};jf.prototype.error=function(a){u.b(a)};jf.prototype.wa=function(){this.H++};jf.prototype.Eb=function(){if(!--this.H&&!this.J){var a=this.ja;a.b=a.g.pop()}};function kf(a,b,c){jf.call(this,a,b,c)}t(kf,jf);function lf(a,b){a.error(b,a.yc())}function mf(a,b){lf(a,b);hf(a.ja,new jf(a.f,a.ja,!1))}p=kf.prototype;p.tb=function(){mf(this,"E_CSS_UNEXPECTED_SELECTOR")};
p.gd=function(){mf(this,"E_CSS_UNEXPECTED_FONT_FACE")};p.Hc=function(){mf(this,"E_CSS_UNEXPECTED_FOOTNOTE")};p.ld=function(){mf(this,"E_CSS_UNEXPECTED_VIEWPORT")};p.ed=function(){mf(this,"E_CSS_UNEXPECTED_DEFINE")};p.kd=function(){mf(this,"E_CSS_UNEXPECTED_REGION")};p.jc=function(){mf(this,"E_CSS_UNEXPECTED_PAGE")};p.Zb=function(){mf(this,"E_CSS_UNEXPECTED_WHEN")};p.fd=function(){mf(this,"E_CSS_UNEXPECTED_FLOW")};p.jd=function(){mf(this,"E_CSS_UNEXPECTED_PAGE_TEMPLATE")};p.hd=function(){mf(this,"E_CSS_UNEXPECTED_PAGE_MASTER")};
p.Kc=function(){mf(this,"E_CSS_UNEXPECTED_PARTITION")};p.Jc=function(){mf(this,"E_CSS_UNEXPECTED_PARTITION_GROUP")};p.Ic=function(){mf(this,"E_CSS_UNEXPECTED_SELECTOR_FUNC")};p.Uc=function(){mf(this,"E_CSS_UNEXPECTED_END_SELECTOR_FUNC")};p.rb=function(){this.error("E_CSS_UNEXPECTED_PROPERTY",this.yc())};var nf=[],of=[],T=[],pf=[],qf=[],rf=[],sf=[],tf=[],uf=[],vf=[],wf=[],xf=[],yf=[];nf[1]=28;nf[36]=29;nf[7]=29;nf[9]=29;nf[14]=29;nf[18]=29;nf[20]=30;nf[13]=27;nf[0]=200;of[1]=46;of[0]=200;rf[1]=2;
...
k);continue}g.Db();case 4:if(34==Ve(h,1).type)switch(S(h),S(h),k=R(h),k.type){case 1:g.yb(null,k.text);a.b=f?pf:T;S(h);break;case 36:g.yb(null,null);a.b=f?pf:T;S(h);break;default:a.b=vf,g.error("E_CSS_NAMESPACE",k)}else g.yb(a.J,null),a.b=f?pf:T,S(h);continue;case 5:k.b&&g.Db();case 6:g.Bd(k.text);a.b=f?pf:T;S(h);continue;case 7:k.b&&g.Db();case 8:g.ud(k.text);a.b=f?pf:T;S(h);continue;case 55:k.b&&g.Db();case 14:S(h);k=R(h);b:switch(k.type){case 1:g.Dc(k.text,null);S(h);a.b=f?pf:T;continue;case 6:m=
k.text;S(h);switch(m){case "not":a.b=rf;g.Ic("not");If(a,Number.POSITIVE_INFINITY,!1,!1,!1,!0)?a.b=T:a.b=xf;break a;case "lang":case "href-epub-type":if(k=R(h),1===k.type){n=[k.text];S(h);break}else break b;case "nth-child":case "nth-of-type":case "nth-last-child":case "nth-last-of-type":if(n=Ff(a))break;else break b;default:n=Ef(a)}k=R(h);if(11==k.type){g.Dc(m,n);S(h);a.b=f?pf:T;continue}}g.error("E_CSS_PSEUDOCLASS_SYNTAX",k);a.b=vf;continue;case 42:S(h);k=R(h);switch(k.type){case 1:g.Ec(k.text,
null);a.b=f?pf:T;S(h);continue;case 6:if(m=k.text,S(h),n=Ef(a),k=R(h),11==k.type){g.Ec(m,n);a.b=f?pf:T;S(h);continue}}g.error("E_CSS_PSEUDOELEM_SYNTAX",k);a.b=vf;continue;case 9:k.b&&g.Db();case 10:S(h);k=R(h);if(1==k.type)m=k.text,S(h);else if(36==k.type)m=null,S(h);else if(34==k.type)m="";else{a.b=xf;g.error("E_CSS_ATTR",k);S(h);continue}k=R(h);if(34==k.type){n=m?a.V[m]:m;if(null==n){a.b=xf;g.error("E_CSS_UNDECLARED_PREFIX",k);S(h);continue}S(h);k=R(h);if(1!=k.type){a.b=xf;g.error("E_CSS_ATTR_NAME_EXPECTED",
...
function dg(a,b,c){c=b+c;for(var d=Array(c),e=Array(c),f=0;f<=c;f++)d[f]=0,e[f]=0;for(var g=[],h=!1,l=a.length,k=0;k<l;k++){var m=a[k];d[m.b]+=m.h;e[m.b]+=m.g;for(var n=!1,f=0;f<b;f++)if(d[f]&&!e[f]){n=!0;break}if(n)for(f=b;f<=c;f++)if(d[f]||e[f]){n=!1;break}h!=n&&(g.push(m.f),h=n)}return g}function eg(a,b){return b?Math.ceil(a/b)*b:a}function fg(a,b){return b?Math.floor(a/b)*b:a}function gg(a){return new Sf(a.b,-a.f)}function hg(a){return new Rf(a.S,-a.T,a.N,-a.U)}
function ig(a){return new Rf(-a.N,a.U,-a.S,a.T)}function jg(a){return new Xf(Ra(a.b,gg))}
function kg(a,b,c,d,e){e&&(a=hg(a),b=Ra(b,jg),c=Ra(c,jg));e=b.length;var f=c?c.length:0,g=[],h=[],l,k,m;for(l=0;l<e;l++)Yf(b[l],h,l);for(l=0;l<f;l++)Yf(c[l],h,l+e);b=h.length;h.sort(Wf);for(c=0;h[c].g>=e;)c++;c=h[c].b.b;c>a.S&&g.push(new Vf(a.S,c,a.T,a.T));l=0;for(var n=[];l<b&&(m=h[l]).b.b<c;)m.f.b>c&&n.push(m),l++;for(;l<b||0<n.length;){var r=a.N,q=Math.min(eg(Math.ceil(c+8),d),a.N);for(k=0;k<n.length&&r>q;k++)m=n[k],m.b.f==m.f.f?m.f.b<r&&(r=Math.max(fg(m.f.b,d),q)):m.b.f!=m.f.f&&(r=q);r>a.N&&(r=
...
n.length-1;0<=k;k--)n[k].f.b<=r&&n.splice(k,1)}lg(a,g);return g}function lg(a,b){for(var c=b.length-1,d=new Vf(a.N,a.N,a.U,a.T);0<=c;){var e=d,d=b[c];d.U==e.U&&d.T==e.T&&(e.S=d.S,b.splice(c,1),d=e);c--}}function mg(a,b){for(var c=0,d=a.length;c<d;){var e=Math.floor((c+d)/2);b>=a[e].N?c=e+1:d=e}return c}
function ng(a,b){if(!a.length)return b;for(var c=b.S,d,e=0;e<a.length&&!(d=a[e],d.N>b.S&&d.U-.1<=b.U&&d.T+.1>=b.T);e++)c=Math.max(c,d.N);for(var f=c;e<a.length&&!(d=a[e],d.S>=b.N||d.U-.1>b.U||d.T+.1<b.T);e++)f=d.N;f=e===a.length?b.N:Math.min(f,b.N);return f<=c?null:new Rf(b.U,c,b.T,f)}
function og(a,b){if(!a.length)return b;for(var c=b.N,d,e=a.length-1;0<=e&&!(d=a[e],e===a.length-1&&d.N<b.N)&&!(d.S<b.N&&d.U-.1<=b.U&&d.T+.1>=b.T);e--)c=Math.min(c,d.S);for(var f=Math.min(c,d.N);0<=e&&!(d=a[e],d.N<=b.S||d.U-.1>b.U||d.T+.1<b.T);e--)f=d.S;f=Math.max(f,b.S);return c<=f?null:new Rf(b.U,f,b.T,c)};function pg(){this.b={}}t(pg,pc);pg.prototype.Ob=function(a){this.b[a.name]=!0;return a};pg.prototype.ub=function(a){this.Pb(a.values);return a};function qg(a){this.value=a}t(qg,pc);qg.prototype.nc=function(a){this.value=a.I;return a};function rg(a,b){if(a){var c=new qg(b);try{return a.ba(c),c.value}catch(d){u.b(d,"toInt: ")}}return b}function sg(){this.f=!1;this.b=[];this.name=null}t(sg,pc);sg.prototype.qc=function(a){this.f&&this.b.push(a);return null};
...
function eh(a,b){for(;;){var c=dh(a,b,1);if(!c)break;for(var d=[],e=[],f="",g,h=!0,l=function(){if(!d.length)throw Error("No values");var a;if(1==d.length)a=d[0];else{var b=f,c=d;a=new zg;if("||"==b){for(b=0;b<c.length;b++){var e=new zg,g=e;if(g.b.length)throw Error("invalid call");var h=new xg(Bg);h.f=2*b+1;g.b.push(h);var h=new yg(0,!0),k=new yg(0,!1);g.g.push(g.f.length);g.f.push(k);g.match.push(g.f.length);g.f.push(h);Eg(e,c[b],1);Ag(e,e.match,!1,b);Eg(a,e,b?4:1)}c=new zg;if(c.b.length)throw Error("invalid call");
...
d.push(n.clone())}else n={},n[g.text.toLowerCase()]=C(g.text),d.push($g(new Dg(0,n,U)));h=!1;break;case 5:n={};n[""+g.I]=new Dc(g.I);d.push($g(new Dg(0,n,U)));h=!1;break;case 34:k("|");break;case 25:k("||");break;case 14:h||k(" ");e.push({pe:d,je:f,tc:"["});f="";d=[];h=!0;break;case 6:h||k(" ");e.push({pe:d,je:f,tc:"(",gc:g.text});f="";d=[];h=!0;break;case 15:g=l();n=e.pop();if("["!=n.tc)throw Error("']' unexpected");d=n.pe;d.push(g);f=n.je;h=!1;break;case 11:g=l();n=e.pop();if("("!=n.tc)throw Error("')' unexpected");
...
if(5!=g.type)throw Error("<int> expected");r=g.I;S(b);g=R(b)}if(13!=g.type)throw Error("'}' expected");d.push(Zg(d.pop(),n,r));break;case 17:m=l();if(0<e.length)throw Error("unclosed '"+e.pop().tc+"'");break;default:throw Error("unexpected token");}S(b);ch(c)?a.b[c]=m:a.g[c]=1!=m.b.length||m.b[0].f?new Ig(m):m.b[0].b}}
...
function gh(a,b,c,d,e){var f="",g=b;b=b.toLowerCase();var h=b.match(/^-([a-z]+)-([-a-z0-9]+)$/);h&&(f=h[1],b=h[2]);if((h=a.A[b])&&h[f])if(f=a.g[b])(a=c===bd||c.ee()?c:c.ba(f))?e.sb(b,a,d):e.zc(g,c);else if(b=a.h[b].clone(),c===bd)for(c=0;c<b.b.length;c++)e.sb(b.b[c],bd,d);else{c.ba(b);if(b.error)d=!1;else{for(a=0;a<b.b.length;a++)f=b.b[a],e.sb(f,b.values[f]||b.f.l[f],d);d=!0}d||e.zc(g,c)}else e.nd(g,c)}
...
yi={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},zi={Of:!1,wc:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",$c:"\u5341\u767e\u5343",ff:"\u8ca0"};
function Ai(a){if(9999<a||-9999>a)return""+a;if(!a)return zi.wc.charAt(0);var b=new Da;0>a&&(b.append(zi.ff),a=-a);if(10>a)b.append(zi.wc.charAt(a));else if(zi.Pf&&19>=a)b.append(zi.$c.charAt(0)),a&&b.append(zi.$c.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(zi.wc.charAt(c)),b.append(zi.$c.charAt(2)));if(c=Math.floor(a/100)%10)b.append(zi.wc.charAt(c)),b.append(zi.$c.charAt(1));if(c=Math.floor(a/10)%10)b.append(zi.wc.charAt(c)),b.append(zi.$c.charAt(0));(a%=10)&&b.append(zi.wc.charAt(a))}return b.toString()}
...
function Mi(){this.j=0;this.b={};this.Lc={};this.h={};this.f={};this.Ca={};this.g={};this.Cc={};this.order=0}Mi.prototype.clone=function(){var a=new Mi;a.j=this.j;for(var b in this.b)a.b[b]=this.b[b];Li(this.Lc,a.Lc);Li(this.h,a.h);Li(this.f,a.f);Li(this.Ca,a.Ca);Li(this.g,a.g);Li(this.Cc,a.Cc);a.order=this.order;return a};function Lh(a,b,c){var d=a[b];d&&(c=d.l(c));a[b]=c}Mi.prototype.ie=function(){return this.order+=Ki};
function Ni(a,b,c,d){this.A=a;this.l=b;this.Pc=c;this.pb=d;this.h=[[],[]];this.w={};this.G=this.F=this.b=null;this.xa=this.ga=this.X=this.j=this.f="";this.Y=this.O=null;this.ta=this.Va=!0;this.g={};this.H=[{}];this.J=[new Ac("\u201c"),new Ac("\u201d"),new Ac("\u2018"),new Ac("\u2019")];this.C=0;this.lang="";this.bc=[0];this.La=0;this.ma=[{}];this.wb=this.ma[0];this.V=null;this.Ab=[this.V];this.ac=[{}];this.vb=this.ma[0];this.xb=[]}function li(a,b){a.w[b]=(a.w[b]||0)+1}
...
a.lang=d.toLowerCase();var d=a.ta,e=a.bc;a.La=++e[e.length-1];e.push(0);var e=a.ma,f=a.wb=e[e.length-1],g=f[a.j];g||(g=f[a.j]={});g[a.f]=(g[a.f]||0)+1;e.push({});e=a.Ab;null!==e[e.length-1]?a.V=--e[e.length-1]:a.V=null;e.push(null);e=a.ac;(f=a.vb=e[e.length-1])&&f[a.j]&&f[a.j][a.f]--;e.push({});Ri(a);Xi(a,b);e=c.quotes;c=null;e&&(e=e.evaluate(a.l))&&(c=new si(a.J),e===F?a.J=[new Ac(""),new Ac("")]:e instanceof rc&&(a.J=e.values));Ti(a,a.F);e=a.X||a.ga||b.getAttribute("name")||"";if(d||e){var h={};
Object.keys(a.g).forEach(function(a){h[a]=Array.from(this.g[a])},a);Yi(a.Pc,e,h)}if(d=a.F._pseudos)for(e=!0,f=0;f<Vi.length;f++)(g=Vi[f])||(e=!1),(g=d[g])&&(e?qi(a,g,b):a.h[a.h.length-2].push(new pi(g,b)));c&&a.h[a.h.length-2].push(c)}function Zi(a,b){for(var c in b)yh(c)&&(b[c]=b[c].Vc(a))}function Xi(a,b){var c=new ti(b),d=a.F,e=d._pseudos,f;for(f in e)Zi(c,e[f]);Zi(c,d)}
function Ri(a){var b;for(b=0;b<a.G.length;b++)Oi(a,a.A.Ca,a.G[b]);for(b=0;b<a.O.length;b++)Oi(a,a.A.f,a.O[b]);Oi(a,a.A.g,a.X);Oi(a,a.A.Lc,a.f);""!=a.f&&Oi(a,a.A.Lc,"*");Oi(a,a.A.h,a.xa);null!==a.Y&&(Oi(a,a.A.Cc,a.Y),Oi(a,a.A.Cc,"*"));a.b=null;a.h.push([]);for(var c=1;-1<=c;--c){var d=a.h[a.h.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.Va=!0;a.ta=!1}
Ni.prototype.pop=function(){for(var a=1;-1<=a;--a)for(var b=this.h[this.h.length-a-2],c=0;c<b.length;)b[c].pop(this,a)?b.splice(c,1):c++;this.h.pop();this.Va=!1};var $i=null;function aj(a,b,c,d,e,f,g){jf.call(this,a,b,g);this.b=null;this.Z=0;this.h=this.Sa=null;this.A=!1;this.W=c;this.j=d?d.j:$i?$i.clone():new Mi;this.F=e;this.w=f;this.l=0}t(aj,kf);aj.prototype.Ge=function(a){Lh(this.j.Lc,"*",a)};function bj(a,b){var c=Dh(a.b,b);c!==b&&c.g(a.j)||a.Ge(c)}
...
break;case "last-child":this.b.push(new bi(0,1));break;case "first-of-type":this.b.push(new ai(0,1));break;case "last-of-type":this.b.push(new ci(0,1));break;case "only-child":this.b.push(new Wh);this.b.push(new bi(0,1));break;case "only-of-type":this.b.push(new ai(0,1));this.b.push(new ci(0,1));break;case "empty":this.b.push(new di);break;case "before":case "after":case "first-line":case "first-letter":this.Ec(a,b);return;default:u.b("unknown pseudo-class selector: "+a),this.b.push(new hi(""))}this.Z+=
256}};
aj.prototype.Ec=function(a,b){switch(a){case "before":case "after":case "first-line":case "first-letter":case "footnote-call":case "footnote-marker":case "inner":this.h?(u.b("Double pseudoelement ::"+this.h+"::"+a),this.b.push(new hi(""))):this.h=a;break;case "first-n-lines":if(b&&1==b.length&&"number"==typeof b[0]){var c=Math.round(b[0]);if(0<c&&c==b[0]){this.h?(u.b("Double pseudoelement ::"+this.h+"::"+a),this.b.push(new hi(""))):this.h="first-"+c+"-lines";break}}default:u.b("Unrecognized pseudoelement: ::"+a),
...
function ej(a){if(a.b){var b=a.Z+a.j.ie();bj(a,a.Le(b));a.b=null;a.h=null;a.A=!1;a.Z=0}}p.Le=function(a){var b=this.F;this.A&&(b=b?"xxx-bogus-xxx":"footnote");return new Jh(this.Sa,a,this.h,b)};p.rb=function(a,b,c){gh(this.w,a,b,c,this)};p.zc=function(a,b){lf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};p.nd=function(a,b){lf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
p.sb=function(a,b,c){"display"!=a||b!==md&&b!==ld||(this.sb("flow-options",new rc([Wc,rd]),c),this.sb("flow-into",b,c),b=Mc);(Jd.SIMPLE_PROPERTY||[]).forEach(function(d){d=d({name:a,value:b,important:c});a=d.name;b=d.value;c=d.important});var d=c?ef(this):ff(this);zh(this.Sa,a,this.W?new vh(b,d,this.W):new V(b,d))};p.Ic=function(a){switch(a){case "not":a=new fj(this),a.tb(),hf(this.ja,a)}};function fj(a){aj.call(this,a.f,a.ja,a.W,a,a.F,a.w,!1);this.parent=a;this.g=a.b}t(fj,aj);p=fj.prototype;
p.Ic=function(a){"not"==a&&mf(this,"E_CSS_UNEXPECTED_NOT")};p.wa=function(){mf(this,"E_CSS_UNEXPECTED_RULE_BODY")};p.hc=function(){mf(this,"E_CSS_UNEXPECTED_NEXT_SELECTOR")};p.Uc=function(){this.b&&0<this.b.length&&this.g.push(new ji(this.b));this.parent.Z+=this.Z;var a=this.ja;a.b=a.g.pop()};p.error=function(a,b){aj.prototype.error.call(this,a,b);var c=this.ja;c.b=c.g.pop()};function gj(a,b){jf.call(this,a,b,!1)}t(gj,kf);
gj.prototype.rb=function(a,b){if(this.f.values[a])this.error("E_CSS_NAME_REDEFINED "+a,this.yc());else{var c=a.match(/height|^(top|bottom)$/)?"vh":"vw",c=new ec(this.f,100,c),c=b.ra(this.f,c);this.f.values[a]=c}};function hj(a,b,c,d,e){jf.call(this,a,b,!1);this.Sa=d;this.W=c;this.b=e}t(hj,kf);hj.prototype.rb=function(a,b,c){c?u.b("E_IMPORTANT_NOT_ALLOWED"):gh(this.b,a,b,c,this)};hj.prototype.zc=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};
hj.prototype.nd=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};hj.prototype.sb=function(a,b,c){c=c?ef(this):ff(this);c+=this.order;this.order+=Ki;zh(this.Sa,a,this.W?new vh(b,c,this.W):new V(b,c))};function ij(a,b){Jf.call(this,a);this.Sa={};this.b=b;this.order=0}t(ij,Jf);ij.prototype.rb=function(a,b,c){gh(this.b,a,b,c,this)};ij.prototype.zc=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};ij.prototype.nd=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};
...
function Wj(a,b,c){Object.keys(a.b).forEach(function(a){for(var b=this.b[a],c=0;c<b.length;)this.K.contains(b[c])?c++:b.splice(c,1);b.length||delete this.b[a]},a);for(var d=a.w,e=0;e<d.length;e++){var f=d[e];v(f.target,f.name,f.value.toString())}e=Xj(c,a.K);a.f.width=e.width;a.f.height=e.height;for(e=0;e<b.length;e++)if(c=b[e],f=a.b[c.Fc],d=a.b[c.hf],f&&d&&(f=Rj(f,c.action)))for(var g=0;g<d.length;g++)d[g].addEventListener(c.event,f,!1)}
...
function fk(a,b){if(a===b)return!0;if(!a||!b||a.ia!==b.ia||a.M!==b.M||a.la.length!==b.la.length)return!1;for(var c=0;c<a.la.length;c++){var d=a[c],e=b[c];if(!(d===e||d&&e&&d.node===e.node&&d.Ua===e.Ua&&d.qa===e.qa&&d.Aa===e.Aa&&d.va===e.va))return!1}return!0}function gk(a){return{la:[{node:a.R,Ua:hk,qa:a.qa,Aa:null,va:null}],ia:0,M:!1,Ka:a.Ka}}function ik(a,b){var c=new jk(a.node,b,0);c.Ua=a.Ua;c.qa=a.qa;c.Aa=a.Aa;c.va=a.va?ik(a.va,kk(b)):null;c.L=a.L;return c}var hk=0;
...
function jk(a,b,c){this.R=a;this.parent=b;this.oa=c;this.ia=0;this.M=!1;this.Ua=hk;this.qa=b?b.qa:null;this.va=this.Aa=null;this.ga=!1;this.Da=!0;this.b=!1;this.l=b?b.l:0;this.display=null;this.H=nk;this.V=this.A=this.j=null;this.O="baseline";this.X="top";this.rd=this.Y=0;this.G=!1;this.Qb=b?b.Qb:0;this.h=b?b.h:null;this.w=b?b.w:!1;this.J=this.xc=!1;this.C=this.D=this.F=this.g=null;this.qb=b?b.qb:{};this.u=b?b.u:!1;this.ma=b?b.ma:"ltr";this.f=b?b.f:null;this.Ka=this.lang=null;this.L=b?b.L:null}
function ok(a){a.Da=!0;a.l=a.parent?a.parent.l:0;a.D=null;a.C=null;a.ia=0;a.M=!1;a.display=null;a.H=nk;a.j=null;a.A=null;a.V=null;a.O="baseline";a.G=!1;a.Qb=a.parent?a.parent.Qb:0;a.h=a.parent?a.parent.h:null;a.w=a.parent?a.parent.w:!1;a.g=null;a.F=null;a.Aa=null;a.xc=!1;a.J=!1;a.u=a.parent?a.parent.u:!1;a.Aa=null;a.Ka=null;a.L=a.parent?a.parent.L:null}
function pk(a){var b=new jk(a.R,a.parent,a.oa);b.ia=a.ia;b.M=a.M;b.Aa=a.Aa;b.Ua=a.Ua;b.qa=a.qa;b.va=a.va;b.Da=a.Da;b.l=a.l;b.display=a.display;b.H=a.H;b.j=a.j;b.A=a.A;b.V=a.V;b.O=a.O;b.X=a.X;b.Y=a.Y;b.rd=a.rd;b.xc=a.xc;b.J=a.J;b.G=a.G;b.Qb=a.Qb;b.h=a.h;b.w=a.w;b.g=a.g;b.F=a.F;b.D=a.D;b.C=a.C;b.f=a.f;b.u=a.u;b.b=a.b;b.Ka=a.Ka;b.L=a.L;return b}jk.prototype.modify=function(){return this.ga?pk(this):this};function kk(a){var b=a;do{if(b.ga)break;b.ga=!0;b=b.parent}while(b);return a}
jk.prototype.clone=function(){for(var a=pk(this),b=a,c;c=b.parent;)c=pk(c),b=b.parent=c;return a};function qk(a){return{node:a.R,Ua:a.Ua,qa:a.qa,Aa:a.Aa,va:a.va?qk(a.va):null,L:a.L}}function rk(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(qk(b)),b=b.parent;while(b);b=a.Ka?sk(a.Ka,a.ia,-1):a.ia;return{la:c,ia:b,M:a.M,Ka:a.Ka}}function tk(a){for(a=a.parent;a;){if(a.xc)return!0;a=a.parent}return!1}function uk(a,b){for(var c=a;c;)c.Da||b(c),c=c.parent}
...
function jl(a,b,c,d,e,f,g,h){this.ea=a;this.root=a.root;this.La=c;this.h=d;this.w=f;this.f=this.root;this.O={};this.V={};this.C={};this.G=[];this.A=this.J=this.H=null;this.X=new Ni(b,d,g,h);this.g=new Rk;this.Ba=!0;this.ga=[];this.xa=e;this.ta=this.ma=!1;this.b=a=tj(a,this.root);this.Y={};this.j=new fl(d);Tk(this.g,a);d=kl(this,this.root);Wi(this.X,this.root,d);ll(this,d,!1);this.F=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.F=
...
function ll(a,b,c){c||["writing-mode","direction"].forEach(function(a){b[a]&&(this.O[a]=b[a])},a);if(!a.ma){var d=nl(a,b,a.w.j,"background-color")?b["background-color"].evaluate(a.h):null,e=nl(a,b,a.w.j,"background-image")?b["background-image"].evaluate(a.h):null;if(d&&d!==bd||e&&e!==bd)ol(a,b,a.w.j),a.ma=!0}if(!a.ta)for(d=0;d<pl.length;d++)if(nl(a,b,a.w.w,pl[d])){ol(a,b,a.w.w);a.ta=!0;break}if(!c&&(c=b["font-size"])){d=c.evaluate(a.h);c=d.I;switch(d.fa){case "em":case "rem":c*=a.h.w;break;case "ex":case "rex":c*=
...
function rl(a,b,c){var d=-1;if(b<=a.b&&(d=Vk(a.g,b),d+=c,d<Sk(a.g)))return Wk(a.g,d);if(!a.f)return Number.POSITIVE_INFINITY;for(var e=a.h;;){var f=a.f.firstChild;if(!f)for(;;){if(1==a.f.nodeType){var f=a.X,g=a.f;if(f.xb.pop()!==g)throw Error("Invalid call to popElement");f.bc.pop();f.ma.pop();f.Ab.pop();f.ac.pop();f.pop();Ui(f);a.Ba=a.ga.pop();g=a.j.pop(a.b);f=null;g.f&&(f=bl(g.f,"before"),vl(a,f,g.f.Pa?il(a.j,g):g.f.offset,g.b),f=bl(g.f,"after"));f=al(f,bl(g,"after"));vl(a,f,a.b,g.b)}if(f=a.f.nextSibling)break;
...
function jm(a){a.K&&(a.j.forEach(function(a){a.K&&a.K.element===this.K.element&&a.b.forEach(function(a){(a=a.Sb.element)&&a.parentNode&&a.parentNode.removeChild(a)})},a),Lk(a.K));a.j.splice(0);Object.keys(a.w).forEach(function(a){delete this.w[a]},a);a.Ac=!0}function wm(a){return a.Ac||!!a.parent&&wm(a.parent)}function xm(a,b){return Ll(b,a.G.toString(),a.F.toString()||null,Pl)}
...
function en(a,b,c){var d=I("buildViewToNextBlockEdge");he(function(d){b.D&&!fn(b)&&c.push(kk(b));cn(a,b).then(function(e){e!==b&&(b=e,fn(b)||c.push(kk(b)));gn(a.h,b).then(function(c){if(b=c){if(!hn(a.Va,b)&&(b=b.modify(),b.b=!0,a.l)){Q(d);return}Ym(a,b)&&!a.u?jn(a,b).then(function(c){b=c;!b||a.l&&b&&b.b?Q(d):P(d)}):b.Da?P(d):Q(d)}else Q(d)})})}).then(function(){O(d,b)});return M(d)}
function kn(a,b){if(!b.D)return L(b);var c=b.R,d=I("buildDeepElementView");he(function(d){cn(a,b).then(function(e){if(e!==b){for(var f=e;f&&f.R!=c;)f=f.parent;if(!f){b=e;Q(d);return}}gn(a.h,e).then(function(e){(b=e)&&b.R!=c?hn(a.Va,b)?P(d):(b=b.modify(),b.b=!0,a.l?Q(d):P(d)):Q(d)})})}).then(function(){O(d,b)});return M(d)}
...
function un(a,b,c,d){if(a.g&&a.g[a.g.length-1].b)return tn(a,b,c),L(!0);var e=new Rf(a.V,a.ya,a.X,a.kb),f=ng(a.J,e);f&&(d=Math.max(d,f.S*Hk(a)));d+=40*Hk(a);var g=a.O,h=!g;if(h){f=a.element.ownerDocument.createElement("div");v(f,"position","absolute");var l=a.h.clone(),k=new Zl(a.f,"column",null,a.f.h,c.la[0].node,null,null),g=new Xm(f,l,a.b,a.Va,k);cm(k,g);a.O=g;g.u=vn(a.h,a.u,f);g.ve=!0;a.u?(g.left=0,v(g.element,"width","2em")):(g.top=a.kb,v(g.element,"height","2em"))}a.element.appendChild(g.element);
sn(a,g.element,g);f=Hk(a)*(d-a.ya);a.u?g.height=a.ta.N-a.ta.S-Dk(g)-Ek(g):g.width=a.ta.T-a.ta.U-Fk(g)-Gk(g);var m=(e=og(a.J,e))?e.N:a.kb;d=Hk(a)*(m-d)-(a.u?Fk(g)-Gk(g):Dk(g)+Ek(g));if(h&&18>d)return a.element.removeChild(g.element),a.O=null,tn(a,b,c),L(!0);if(!a.u&&g.top<f)return a.element.removeChild(g.element),tn(a,b,c),L(!0);var n=I("layoutFootnoteInner");a.u?Kk(g,0,d):Jk(g,f,d);g.$a=a.$a+a.left+Fk(a);g.ab=a.ab+a.top+Dk(a);g.Fb=a.Fb;var r=new vk(c);h?(wn(g),d=L(!0)):Zm(g).length?d=xn(g):(yn(g),
d=L(!0));d.then(function(){zn(g,r).then(function(d){if(h&&d)a.element.removeChild(g.element),tn(a,b,c),a.O=null,O(n,!0);else{a.u?(a.F=m+(g.pa+Fk(g)+Gk(g)),Kk(g,0,g.pa)):(a.F=m-(g.pa+Dk(g)+Ek(g)),Jk(g,a.F-a.ya,g.pa));var e;!a.u&&0<Zm(g).length?e=xn(g):e=L(d);e.then(function(d){d=new Um(b,c,d?d.Ba:null);a.g?a.g.push(d):a.g=[d];O(n,!0)})}})});return M(n)}
function An(a,b){var c=I("layoutFootnote"),d=b.D;d.setAttribute("style","");v(d,"display","inline-block");d.textContent="M";var e=Xj(a.b,d),f=a.u?e.left:e.bottom;d.textContent="";Bn(a.h,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d=gk(b);e=b.oa;b=b.modify();b.M=!0;un(a,e,d,f).then(function(){a.O&&a.O.element.parentNode&&a.element.removeChild(a.O.element);Tm(a,f)&&a.C.length&&(b.b=!0);O(c,b)});return M(c)}
...
k.D.appendChild(m);var n=Xj(a.b,m),h=Math.max(a.u?n.top:n.left,h),l=Math.min(a.u?n.bottom:n.right,l);k.D.removeChild(m);m=a.u?g.N-g.S:g.T-g.U;"left"==e?l=Math.max(l,h+m):h=Math.min(h,l-m);k.D.appendChild(b.D)}m=new Rf(h,Hk(a)*a.ya,l,Hk(a)*a.kb);h=g;a.u&&(h=hg(g));l=Hk(a);h.S<a.Ab*l&&(n=h.N-h.S,h.S=a.Ab*l,h.N=h.S+n);a:for(var l=a.J,n=h,r=n.S,q=n.T-n.U,z=n.N-n.S,y=mg(l,r);;){var A=r+z;if(A>m.N)break a;for(var H=m.U,G=m.T,J=y;J<l.length&&l[J].S<A;J++){var K=l[J];K.U>H&&(H=K.U);K.T<G&&(G=K.T)}if(H+q<=
G||y>=l.length){"left"==e?(n.U=H,n.T=H+q):(n.U=G-q,n.T=G);n.N+=r-n.S;n.S=r;break a}r=l[y].N;y++}a.u&&(g=ig(h));a:{m=qn(a.b,d);l=new Tf;if(m){if("border-box"==m.boxSizing){m=pn(a,d);break a}l.left=X(m.marginLeft)+X(m.borderLeftWidth)+X(m.paddingLeft);l.top=X(m.marginTop)+X(m.borderTopWidth)+X(m.paddingTop);l.right=X(m.marginRight)+X(m.borderRightWidth)+X(m.paddingRight);l.bottom=X(m.marginBottom)+X(m.borderBottomWidth)+X(m.paddingBottom)}m=l}v(d,"width",g.T-g.U-m.left-m.right+"px");v(d,"height",g.N-
g.S-m.top-m.bottom+"px");v(d,"position","absolute");v(d,"display",b.display);l=null;if(k)if(k.J)l=k;else a:{for(k=k.parent;k;){if(k.J){l=k;break a}k=k.parent}l=null}l?(m=l.D.ownerDocument.createElement("div"),m.style.position="absolute",l.u?m.style.right="0":m.style.left="0",m.style.top="0",l.D.appendChild(m),k=Xj(a.b,m),l.D.removeChild(m)):k={left:a.u?a.kb:a.V,right:a.u?a.ya:a.X,top:a.u?a.V:a.ya};(l?l.u:a.u)?v(d,"right",k.right-g.T+a.H+"px"):v(d,"left",g.U-k.left+a.w+"px");v(d,"top",g.S-k.top+a.A+
"px");b.C&&(b.C.parentNode.removeChild(b.C),b.C=null);k=a.u?g.U:g.N;g=a.u?g.T:g.S;if(Tm(a,k)&&a.C.length)b=b.modify(),b.b=!0,O(c,b);else{mn(a);m=new Rf(a.u?a.kb:a.V,a.u?a.V:a.ya,a.u?a.ya:a.X,a.u?a.X:a.kb);a.u&&(m=hg(m));l=a.J;for(h=[new Vf(h.S,h.N,h.U,h.T)];0<h.length&&h[0].N<=m.S;)h.shift();if(h.length){h[0].S<m.S&&(h[0].S=m.S);n=l.length?l[l.length-1].N:m.S;n<m.N&&l.push(new Vf(n,m.N,m.U,m.T));r=mg(l,h[0].S);for(q=0;q<h.length;q++){z=h[q];if(r==l.length)break;l[r].S<z.S&&(n=l[r],r++,l.splice(r,
0,new Vf(z.S,n.N,n.U,n.T)),n.N=z.S);for(;r<l.length&&(n=l[r++],n.N>z.N&&(l.splice(r,0,new Vf(z.N,n.N,n.U,n.T)),n.N=z.N),z.U!=z.T&&("left"==e?n.U=Math.min(z.T,m.T):n.T=Math.max(z.U,m.U)),n.N!=z.N););}lg(m,l)}nn(a);"left"==e?a.ac=k:a.bc=k;a.Ab=g;En(a,k);O(c,f)}});return M(c)}
function Fn(a,b){var c=a.element.ownerDocument.createElement("div");v(c,"position","absolute");var d=em(a.f,b.b),e=new Zl(d,"column",null,a.f.h,b.R,null,null),d=bm(d),c=new Gn(b,c,a.h.clone(),a.b,a.Va,e,d);cm(e,c);var f=a.f,e=bm(f,b.b),g=Mk(e),d=c.element;e.element.parentNode.appendChild(d);Ik(c,e);c.element=d;c.xe=!0;c.width=g.T-g.U;c.height=g.N-g.S;c.marginLeft=c.marginRight=c.marginTop=c.marginBottom=0;c.borderLeft=c.ga=c.borderTop=c.Y=0;c.w=c.H=c.A=c.G=0;Kk(c,g.U-e.$a,c.width);Jk(c,g.S-e.ab,c.height);
c.Fb=(e.Fb||[]).concat();c.Ud=!mm(f);c.xa=null;wn(c);(f=Em(f,c,b,!0,!mm(f)))?(mn(c),wn(c)):e.element.parentNode.removeChild(d);return f?c:null}
...
function Dn(a,b){var c=a.f,d=b.H,e=b.R,f=b.j,g=c.ce(e);return(g?L(g):Kn(a,d,b.V,b).na(function(a){d=a;g=new Sl(e,d,f);c.Xd(g);return L(g)})).na(function(d){var e=gk(b),f=Jn(b);return lm(c,d)?(nm(c,d,f.D),L(f)):gm(c,d)||sm(c,d)?(qm(c,d,e),nm(c,d,f.D),L(f)):Hn(a,e,d).na(function(a){if(a)return L(null);nm(c,d,f.D);return L(f)})})}
...
function Tn(a,b){var c=I("layoutBreakableBlock"),d=[];en(a,b,d).then(function(e){var f=d.length-1;if(0>f)O(c,e);else{var f=on(a,e,d,f,d[f].oa),g=Tm(a,f);e||(f+=Sn(a,d));En(a,f);var h;b.f?h=On(a,b,e,d):h=L(e);h.then(function(b){0<d.length&&(a.C.push(new Pm(d,d[0].l)),g&&(2!=d.length&&0<a.C.length||d[0].R!=d[1].R||!Jm[d[0].R.localName])&&b&&(b=b.modify(),b.b=!0));O(c,b)})}});return M(c)}
function Qn(a,b,c){Vm(b);for(var d=0,e=b[0].oa,f=d,g=b.length-1,h=b[g].oa,l;e<h;){l=e+Math.ceil((h-e)/2);for(var f=d,k=g;f<k;){var m=f+Math.ceil((k-f)/2);b[m].oa>l?k=m-1:f=m}k=on(a,null,b,f,l);if(a.u?k<c:k>c){for(h=l-1;b[f].oa==l;)f--;g=f}else En(a,k),e=l,d=f}a=b[f];b=a.D;1!=b.nodeType?(Un(a),a.M?a.ia=b.length:(c=e-a.oa,e=b.data,173==e.charCodeAt(c)?(b.replaceData(c,e.length-c,a.w?"":a.h||a.parent&&a.parent.h||"-"),e=c+1):(d=e.charAt(c),c++,f=e.charAt(c),b.replaceData(c,e.length-c,!a.w&&Ia(d)&&Ia(f)?
...
function Wn(a,b){if(!a.g)return L(!0);for(var c=!1,d=a.g.length-1;0<=d;--d){var e=a.g[d];if(e.oa<=b)break;a.g.pop();e.b!==e.f&&(c=!0)}if(!c)return L(!0);var f=I("clearFootnotes"),g=a.pa+a.ya,h=a.g;a.O=null;a.g=null;var l=0;ge(function(){for(;l<h.length;){var b=h[l++],b=un(a,b.oa,b.f,g);if(b.za())return b}return L(!1)}).then(function(){O(f,!0)});return M(f)}
...
function Zn(a,b,c){var d=I("findAcceptableBreak"),e=a.Gb().B,f=!1;if(!e){u.b("Could not find any page breaks?!!");if(a.Ud)return $n(a,b).then(function(b){b?(b=b.modify(),b.b=!1,Rn(a,b,f,!0).then(function(){O(d,b)})):O(d,b)}),M(d);e=c;f=!0}Rn(a,e,f,!0).then(function(){O(d,e)});return M(d)}function ao(a){a=a.toString();return""==a||"auto"==a||!!a.match(/^0+(.0*)?[^0-9]/)}
function bo(a,b,c,d){var e;if(!(e=!b))a:{for(e=b.D;e;){if(e.parentNode===e.ownerDocument){e=!1;break a}e=e.parentNode}e=!0}if(e)return!1;e=Km(b,a.b,0,a.u);var f=b.M?b.parent&&b.parent.L:b.L;f&&(f=f.dc())&&(e+=(a.u?-1:1)*Sm(f));f=Tm(a,e);c&&(e+=Sn(a,c));En(a,e);c=kk(b);b=Mm(b.L).g(c,d,f,a.pa);a.C.push(b);return f}
function co(a,b){if(b.D.parentNode){var c=pn(a,b.D),d=b.D.ownerDocument.createElement("div");a.u?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.D.parentNode.insertBefore(d,b.D);var e=Xj(a.b,d),e=a.u?e.right:e.top,f=Hk(a),g;switch(b.A){case "left":g=a.ac;break;case "right":g=a.bc;break;default:g=f*Math.max(a.bc*f,a.ac*f)}e*f>=g*f?b.D.parentNode.removeChild(d):(e=Math.max(1,(g-e)*f),a.u?d.style.width=
...
function eo(a,b,c,d){function e(){return!!d||!c&&!!cl[m]}function f(){b=r[0]||b;b.D.parentNode.removeChild(b.D);h.j=m}var g=b.M?b.parent&&b.parent.L:b.L;if(g&&!(g instanceof Wm))return L(b);var h=a,l=I("skipEdges"),k=!d&&c&&b&&b.M,m=d,n=null,r=[],q=[],z=!1;he(function(a){for(;b;){do if(b.D){if(b.Da&&1!=b.D.nodeType){if(Zj(b.D,b.Qb))break;if(!b.M){e()?f():bo(h,n,null,m)?(b=(h.l?n||b:b).modify(),b.b=!0):(b=b.modify(),b.g=m);Q(a);return}}if(!b.M&&(b.A&&co(h,b),!(b.L instanceof Wm)||Ym(h,b)||b.G)){r.push(kk(b));
m=al(m,b.g);if(e())f();else if(bo(h,n,null,m)||!hn(h.Va,b))b=(h.l?n||b:b).modify(),b.b=!0;Q(a);return}if(1==b.D.nodeType){var d=b.D.style;if(b.M){if(z){if(e()){f();Q(a);return}r=[];k=c=!1;m=null}z=!1;n=kk(b);q.push(n);m=al(m,b.F);if(d&&(!ao(d.paddingBottom)||!ao(d.borderBottomWidth))){if(bo(h,n,null,m)&&(b=(h.l?n||b:b).modify(),b.b=!0,h.l)){Q(a);return}q=[n];n=null}}else{r.push(kk(b));m=al(m,b.g);if(!hn(h.Va,b)&&(bo(h,n,null,m),b=b.modify(),b.b=!0,h.l)){Q(a);return}if(Jm[b.D.localName]){e()?f():bo(h,
n,null,m)&&(b=(h.l?n||b:b).modify(),b.b=!0);Q(a);return}!d||ao(d.paddingTop)&&ao(d.borderTopWidth)||(k=!1,q=[]);z=!0}}}while(0);d=gn(h.h,b,k);if(d.za()){d.then(function(c){b=c;P(a)});return}b=d.get()}bo(h,n,q,m)?n&&h.l&&(b=n.modify(),b.b=!0):cl[m]&&(h.j=m);Q(a)}).then(function(){n&&(h.La=rk(n));O(l,b)});return M(l)}
...
function yn(a){var b=a.element.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.A+"px";b.style.right=a.H+"px";b.style.bottom=a.G+"px";b.style.left=a.w+"px";a.element.appendChild(b);var c=Xj(a.b,b);a.element.removeChild(b);var b=a.$a+a.left+Fk(a),d=a.ab+a.top+Dk(a);a.ta=new Rf(b,d,b+a.width,d+a.height);a.V=c?a.u?c.top:c.left:0;a.X=c?a.u?c.bottom:c.right:0;a.ya=c?a.u?c.right:c.top:0;a.kb=c?a.u?c.left:c.bottom:0;a.ac=a.ya;a.bc=a.ya;a.Ab=a.ya;a.F=a.kb;var c=a.ta,e,b=a.$a+a.left+
Fk(a),d=a.ab+a.top+Dk(a);e=new Rf(b,d,b+a.width,d+a.height);if(a.xa){b=a.xa;d=e.U;e=e.S;for(var f=[],g=0;g<b.b.length;g++){var h=b.b[g];f.push(new Sf(h.f+d,h.b+e))}b=new Xf(f)}else b=$f(e.U,e.S,e.T,e.N);a.J=kg(c,[b],Zm(a),a.pb,a.u);nn(a);a.g=null}function wn(a){a.Pc=[];v(a.element,"width",a.width+"px");v(a.element,"height",a.height+"px");yn(a);a.pa=0;a.Yd=!1;a.j=null;a.La=null}function En(a,b){a.pa=Math.max(Hk(a)*(b-a.ya),a.pa)}
...
function to(a,b){var c=a.f[b],d=a.h[b];d||(d=a.h[b]=[]);for(var e=!1,f=0;f<a.g.length;){var g=a.g[f];g.$b===b?(g.Gc=!0,a.g.splice(f,1),c&&(e=c.indexOf(g),0<=e&&c.splice(e,1)),d.push(g),e=!0):f++}e||uo(a,b,!0)}function uo(a,b,c){a.w.some(function(a){return a.$b===b})||a.w.push(new po(b,c))}
function zo(a,b,c){var d=Object.keys(a.j.b);if(0<d.length){var e=oo(a.b);d.forEach(function(a){this.A[a]=e;var d=this.C[a];if(d&&d.$<c&&(d=this.h[a])){var f=this.f[a];f||(f=this.f[a]=[]);for(var g;g=d.shift();)g.Gc=!1,f.push(g)}this.C[a]={P:b,$:c}},a)}for(var d=a.G,f;f=a.w.shift();){f.Jd=d;f.P=b;f.$=c;var g;f.Gc?(g=a.h[f.$b])||(g=a.h[f.$b]=[]):(g=a.f[f.$b])||(g=a.f[f.$b]=[]);g.every(function(a){return!(f===a||a&&f.$b===a.$b&&f.Gc===a.Gc&&f.P===a.P&&f.$===a.$)})&&g.push(f)}a.j=null}
...
function Ho(a,b){this.g=b;var c=this;sb.call(this,a,function(a,b){var d=a.match(/^([^.]+)\.([^.]+)$/);if(d){var e=c.g.w[d[1]];if(e&&(e=this.ma[e])){if(b){var d=d[2],h=e.ga[d];if(h)e=h;else{switch(d){case "columns":var h=e.b.f,l=new kc(h,0),k=Io(e,"column-count"),m=Io(e,"column-width"),n=Io(e,"column-gap"),h=x(h,mc(h,new hc(h,"min",[l,k]),w(h,m,n)),n)}h&&(e.ga[d]=h);e=h}}else e=Io(e,d[2]);return e}}return null})}t(Ho,sb);
...
Vo(a,"padding-top-edge","padding-top");break;case "right-edge":c=Vo(a,"left-edge","width");break;case "bottom-edge":c=Vo(a,"top-edge","height")}if(!c){if("extent"==b)d=a.u?"width":"height";else if("measure"==b)d=a.u?"height":"width";else{var e=a.u?th:uh,d=b,f;for(f in e)d=d.replace(f,e[f])}d!=b&&(c=Io(a,d))}c&&(a.ma[b]=c);return c}
...
To.prototype.Wc=function(a,b,c,d,e,f,g){this.u?this.H=b.pa+b.wb:this.G=b.pa+b.ma;var h=(this.u||!d)&&this.g,l=(!this.u||!d)&&this.h;if(l||h)l&&v(b.element,"width","auto"),h&&v(b.element,"height","auto"),d=Xj(f,d?d.element:b.element),l&&(this.H=Math.ceil(d.right-d.left-b.w-b.borderLeft-b.H-b.ga),this.u&&(this.H+=b.wb)),h&&(this.G=d.bottom-d.top-b.A-b.borderTop-b.G-b.Y,this.u||(this.G+=b.ma));(this.u?this.g:this.h)&&gp(this,a,b);if(this.u?this.h:this.g){if(this.u?this.O:this.V)this.u?dp(this,a,b):ep(this,
...
function Jp(a,b,c,d,e,f,g,h,l,k,m,n,r){this.C=a;this.b=b;this.viewport=c;this.w=c.b;this.j=d;this.G=e;this.ea=f;this.F=g;this.l=h;this.H=l;this.page=k;this.f=m;this.A=n;this.g=r;this.J=this.B=null;this.h=!1;this.R=null;this.ia=0;this.D=null}Jp.prototype.clone=function(){return new Jp(this.C,this.b,this.viewport,this.j,this.G,this.ea,this.F,this.l,this.H,this.page,this.f,this.A,this.g)};
...
function Mp(a,b,c,d){var e=a.b;c=kj(c,e,a.G,a.h);b=jj(c,e,b);lj(c,d,b,function(b,c){var d=c.evaluate(e,b);"font-family"==b&&(d=Dl(a.F,d));return d});var f=el(d.display||cd,d.position,d["float"],a.R===a.ea.root);["display","position","float"].forEach(function(a){f[a]&&(d[a]=f[a])});return b}
function Np(a,b){for(var c=a.B.R,d=[],e=null,f=a.B.qa,g=-1;c&&1==c.nodeType;){var h=f&&f.root==c;if(!h||2==f.type){var l=(f?f.b:a.j).l(c,!1);d.push(l);e=e||Ba(c)}h?(c=f.ja,f=f.Ld):(c=c.parentNode,g++)}c=Cb(a.b,"em",!g);c={"font-size":new V(new D(c,"px"),0)};f=new Eh(c,a.b);for(g=d.length-1;0<=g;--g){var h=d[g],l=[],k;for(k in h)ih[k]&&l.push(k);l.sort(Hd);for(var m=0;m<l.length;m++){var n=l[m];f.f=n;var r=h[n];r.value!==bd&&(c[n]=r.Vc(f))}}for(var q in b)ih[q]||(c[q]=b[q]);return{lang:e,Sa:c}}
var Op={a:"a",sub:"sub",sup:"sup",table:"table",tr:"tr",td:"td",th:"th",code:"code",body:"div",p:"p",v:"p",date:"p",emphasis:"em",strong:"strong",style:"span",strikethrough:"del"};function Pp(a,b){b=oa(b,a.ea.url);return a.A[b]||b}function Qp(a){a.B.lang=Ba(a.B.R)||a.B.parent&&a.B.parent.lang||a.B.lang}
...
function Tp(a,b,c){var d=!0,e=I("createElementView"),f=a.R,g=a.B.qa?a.B.qa.b:a.j,h=g.l(f,!1),l={};if(!a.B.parent){var k=Np(a,h),h=k.Sa;a.B.lang=k.lang}var m=h["float-reference"]&&Ql(h["float-reference"].value.toString());a.B.parent&&m&&Rl(m)&&(k=Np(a,h),h=k.Sa,a.B.lang=k.lang);a.B.u=Mp(a,a.B.u,h,l);Rp(a,l);Qp(a);l.direction&&(a.B.ma=l.direction.toString());if((k=l["flow-into"])&&k.toString()!=a.C)return O(e,!1),M(e);var n=l.display;if(n===F)return O(e,!1),M(e);var r=!a.B.parent;a.B.G=n===Zc;Lp(a,
f,r,h,l,g,a.b,a.B.qa).then(function(g){a.B.Aa=g;g=l.position;var k=l["float"],q=l.clear,A=a.B.u?zd:ad,H=a.B.parent?a.B.parent.u?zd:ad:A,G="true"===f.getAttribute("data-vivliostyle-flow-root");a.B.xc=yp(n,g,k,l.overflow,A,H,G);a.B.J=g===od||g===Ic||g===Yc;tk(a.B)&&(q=null,k===$c||m&&Rl(m)||(k=null));A=k===hd||k===pd||k===wd||k===Qc||k===fd||k===ed||k===Oc||k===Nc||k===$c;k&&(delete l["float"],k===$c&&(a.h?(A=!1,l.display=Mc):l.display=cd));q&&(q===bd&&a.B.parent&&a.B.parent.A&&(q=C(a.B.parent.A)),
...
0;y<z;y++){var A=r[y],H=A.namespaceURI,G=A.localName,A=A.nodeValue;if(H)if("http://www.w3.org/2000/xmlns/"==H)continue;else"http://www.w3.org/1999/xlink"==H&&"href"==G&&(A=Pp(a,A));else{if(G.match(/^on/))continue;if("style"==G)continue;if(("id"==G||"name"==G)&&b){A=a.g.Qd(A,a.ea.url);g.setAttribute(G,A);Vj(a.page,g,A);continue}"src"==G||"href"==G||"poster"==G?(A=Pp(a,A),"href"===G&&(A=a.g.Mc(A,a.ea.url))):"srcset"==G&&(A=A.split(",").map(function(b){return Pp(a,b.trim())}).join(","));if("poster"===
...
function $p(a){if(a.B.Ka)return L(!0);var b,c=b=a.R.textContent,d=I("preprocessTextContent"),e=Jd.PREPROCESS_TEXT_CONTENT||[],f=0;ge(function(){return f>=e.length?L(!1):e[f++](a.B,c).na(function(a){c=a;return L(!0)})}).then(function(){a.B.Ka=bq(b,c,0);O(d,!0)});return M(d)}
function cq(a,b,c){var d=I("createNodeView"),e=!0;1==a.R.nodeType?b=Tp(a,b,c):8==a.R.nodeType?(a.D=null,b=L(!0)):b=Zp(a);b.then(function(b){e=b;(a.B.D=a.D)&&(b=a.B.parent?a.B.parent.D:a.J)&&b.appendChild(a.D);O(d,e)});return M(d)}function an(a,b,c,d){(a.B=b)?(a.R=b.R,a.ia=b.ia):(a.R=null,a.ia=-1);a.D=null;return a.B?cq(a,c,!!d):L(!0)}
function dq(a){if(null==a.qa||"content"!=a.R.localName||"http://www.pyroxy.com/ns/shadow"!=a.R.namespaceURI)return a;var b=a.oa,c=a.qa,d=a.parent,e,f;c.oe?(f=c.oe,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.Ld,e=c.ja.firstChild,c=2);var g=a.R.nextSibling;g?(a.R=g,ok(a)):a.va?a=a.va:e?a=null:(a=a.parent.modify(),a.M=!0);if(e)return b=new jk(e,d,b),b.qa=f,b.Ua=c,b.va=a,b;a.oa=b;return a}
function eq(a){var b=a.oa+1;if(a.M){if(!a.parent)return null;if(3!=a.Ua){var c=a.R.nextSibling;if(c)return a=a.modify(),a.oa=b,a.R=c,ok(a),dq(a)}if(a.va)return a=a.va.modify(),a.oa=b,a;a=a.parent.modify()}else{if(a.Aa&&(c=a.Aa.root,2==a.Aa.type&&(c=c.firstChild),c))return b=new jk(c,a,b),b.qa=a.Aa,b.Ua=a.Aa.type,dq(b);if(c=a.R.firstChild)return dq(new jk(c,a,b));1!=a.R.nodeType&&(c=aq(a.Ka),b+=c.length-1-a.ia);a=a.modify()}a.oa=b;a.M=!0;return a}
...
Gq.prototype.Dd=function(){var a=this.style;a.top=Fd;a["margin-top"]=Fd;a["border-top-width"]=Fd;a["padding-top"]=Fd;a["padding-bottom"]=Fd;a["border-bottom-width"]=Fd;a["margin-bottom"]=Fd;a.bottom=Fd};Gq.prototype.Y=function(a,b,c){b=b.H;var d={start:this.l.marginLeft,end:this.l.marginRight,ka:this.l.fc},e={start:this.l.marginTop,end:this.l.marginBottom,ka:this.l.ec};Jq(this,b.top,!0,d,a,c);Jq(this,b.bottom,!0,d,a,c);Jq(this,b.left,!1,e,a,c);Jq(this,b.right,!1,e,a,c)};
...
function Jq(a,b,c,d,e,f){var g=a.b.f,h={},l={},k={},m;for(m in b){var n=Aq[m];if(n){var r=b[m],q=a.ta[m],z=new Kq(r,q.style,c,g,f);h[n.sa]=r;l[n.sa]=q;k[n.sa]=z}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.ka.evaluate(e);var y=Oq(k,b),A=!1,H={};Object.keys(h).forEach(function(a){var b=Y(g,l[a].style[c?"max-width":"max-height"],d.ka);b&&(b=b.evaluate(e),y[a]>b&&(b=k[a]=new Nq(h[a],l[a].style,c,g,f,b),H[a]=b.f(),A=!0))});A&&(y=Oq(k,b),A=!1,["start","center","end"].forEach(function(a){y[a]=H[a]||y[a]}));
var G={};Object.keys(h).forEach(function(a){var b=Y(g,l[a].style[c?"min-width":"min-height"],d.ka);b&&(b=b.evaluate(e),y[a]<b&&(b=k[a]=new Nq(h[a],l[a].style,c,g,f,b),G[a]=b.f(),A=!0))});A&&(y=Oq(k,b),["start","center","end"].forEach(function(a){y[a]=G[a]||y[a]}));var J=a+b,K=a+(a+b);["start","center","end"].forEach(function(a){var b=y[a];if(b){var d=h[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(K-b)/2;break;case "end":e=J-b}c?Kk(d,e,b-Fk(d)-Gk(d)):Jk(d,e,b-Dk(d)-Ek(d))}})}
function Oq(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=Pq(d,g.length?new Mq(g):null,b);g.ib&&(f.center=g.ib);d=g.ib||d.f();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=Pq(c,e,b),c.ib&&(f.start=c.ib),c.Oc&&(f.end=c.Oc);return f}
function Pq(a,b,c){var d={ib:null,Oc:null};if(a&&b)if(a.b()&&b.b()){var e=a.g(),f=b.g();0<e&&0<f?(f=e+f,f<c?d.ib=c*e/f:(a=a.h(),b=b.h(),b=a+b,b<c?d.ib=a+(c-b)*(e-a)/(f-b):0<b&&(d.ib=c*a/b)),0<d.ib&&(d.Oc=c-d.ib)):0<e?d.ib=c:0<f&&(d.Oc=c)}else a.b()?d.ib=Math.max(c-b.f(),0):b.b()&&(d.Oc=Math.max(c-a.f(),0));else a?a.b()&&(d.ib=c):b&&b.b()&&(d.Oc=c);return d}Gq.prototype.Lb=function(a,b,c,d,e){Gq.Te.Lb.call(this,a,b,c,d,e);b.element.setAttribute("data-vivliostyle-page-box",!0)};
...
d["padding-bottom"]=new E(c.marginBottom)};Hq.prototype.Cd=function(){var a=Qq(this,{start:"left",end:"right",ka:"width"});this.fc=a.te;this.marginLeft=a.Ne;this.marginRight=a.Me};Hq.prototype.Dd=function(){var a=Qq(this,{start:"top",end:"bottom",ka:"height"});this.ec=a.te;this.marginTop=a.Ne;this.marginBottom=a.Me};
function Qq(a,b){var c=a.style,d=a.b.f,e=b.start,f=b.end,g=b.ka,h=a.b.F[g].ra(d,null),l=Y(d,c[g],h),k=Y(d,c["margin-"+e],h),m=Y(d,c["margin-"+f],h),n=Po(d,c["padding-"+e],h),r=Po(d,c["padding-"+f],h),q=Ro(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),z=Ro(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),y=x(d,h,w(d,w(d,q,n),w(d,z,r)));l?(y=x(d,y,l),k||m?k?m=x(d,y,k):k=x(d,y,m):m=k=mc(d,y,new tb(d,.5))):(k||(k=d.b),m||(m=d.b),l=x(d,y,w(d,k,m)));c[e]=new E(k);c[f]=new E(m);c["margin-"+e]=
...
p.sa=function(a,b){var c=this.style,d=this.b.f,e=a.start,f=a.end,g="left"===e,h=g?b.fc:b.ec,l=Y(d,c[a.ka],h),g=g?b.marginLeft:b.marginTop;if("start"===this.l.sa)c[e]=new E(g);else if(l){var k=Po(d,c["margin-"+e],h),m=Po(d,c["margin-"+f],h),n=Po(d,c["padding-"+e],h),r=Po(d,c["padding-"+f],h),q=Ro(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),f=Ro(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),l=w(d,l,w(d,w(d,n,r),w(d,w(d,q,f),w(d,k,m))));switch(this.l.sa){case "center":c[e]=new E(w(d,
g,nc(d,x(d,h,l),new tb(d,2))));break;case "end":c[e]=new E(x(d,w(d,g,h),l))}}};
function Rq(a,b,c){function d(a){if(y)return y;y={ka:z?z.evaluate(a):null,Ya:l?l.evaluate(a):null,Za:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[r,m,n,q].forEach(function(b){b&&(c+=b.evaluate(a))});(null===y.Ya||null===y.Za)&&c+y.ka+y.Ya+y.Za>b&&(null===y.Ya&&(y.Ya=0),null===y.Za&&(y.Qf=0));null!==y.ka&&null!==y.Ya&&null!==y.Za&&(y.Za=null);null===y.ka&&null!==y.Ya&&null!==y.Za?y.ka=b-c-y.Ya-y.Za:null!==y.ka&&null===y.Ya&&null!==y.Za?y.Ya=b-c-y.ka-y.Za:null!==y.ka&&null!==y.Ya&&null===y.Za?y.Za=
b-c-y.ka-y.Ya:null===y.ka?(y.Ya=y.Za=0,y.ka=b-c):y.Ya=y.Za=(b-c-y.ka)/2;return y}var e=a.style;a=a.b.f;var f=b.Ed,g=b.Id;b=b.ka;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],l=Qo(a,e["margin-"+f],h),k=Qo(a,e["margin-"+g],h),m=Po(a,e["padding-"+f],h),n=Po(a,e["padding-"+g],h),r=Ro(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),q=Ro(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),z=Y(a,e[b],h),y=null;e[b]=new E(new vb(a,function(){var a=d(this).ka;return null===a?0:a},b));e["margin-"+
f]=new E(new vb(a,function(){var a=d(this).Ya;return null===a?0:a},"margin-"+f));e["margin-"+g]=new E(new vb(a,function(){var a=d(this).Za;return null===a?0:a},"margin-"+g));"left"===f?e.left=new E(w(a,c.marginLeft,c.fc)):"top"===f&&(e.top=new E(w(a,c.marginTop,c.ec)))}p.Cd=function(){var a=this.f.l;this.l.Ha?Rq(this,{Ed:"right",Id:"left",ka:"width"},a):this.l.Ia?Rq(this,{Ed:"left",Id:"right",ka:"width"},a):this.sa({start:"left",end:"right",ka:"width"},a)};
p.Dd=function(){var a=this.f.l;this.l.Ja?Rq(this,{Ed:"bottom",Id:"top",ka:"height"},a):this.l.Ga?Rq(this,{Ed:"top",Id:"bottom",ka:"height"},a):this.sa({start:"top",end:"bottom",ka:"height"},a)};p.Wc=function(a,b,c,d,e,f,g){Oo.prototype.Wc.call(this,a,b,c,d,e,f,g);a=c.H;c=this.b.A;d=this.l;d.Ha||d.Ia?d.Ja||d.Ga||(d.Ha?a.left[c]=b:d.Ia&&(a.right[c]=b)):d.Ja?a.top[c]=b:d.Ga&&(a.bottom[c]=b)};
...
function kr(a,b,c,d,e,f,g,h,l,k,m){Ab.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.ea=b;this.lang=b.lang||c;this.viewport=d;this.l={body:!0};this.g=e;this.A=this.b=this.H=this.f=this.F=null;this.C=0;this.wb=f;this.h=new Cl(this.style.C);this.ma={};this.X=null;this.j=m;this.xb=new Zl(null,null,null,null,null,null,null);this.V={};this.ga=null;this.Va=g;this.vb=h;this.ta=l;this.pb=k;for(var n in a.h)(b=a.h[n]["flow-consume"])&&(b.evaluate(this,"flow-consume")==Jc?this.l[n]=!0:delete this.l[n]);
this.xa={}}t(kr,Ab);
...
rq(qq(f[a]),this);this.xa[a]={width:b.Kb+2*b.wd,height:b.Jb+2*b.wd}},a);return M(b)}function ul(a,b,c){if(a=a.b)a.f[b.b]||(a.f[b.b]=c),c=a.b[b.b],c||(c=new yk,a.b[b.b]=c),c.b.push(new xk(new vk({la:[{node:b.element,Ua:hk,qa:null,Aa:null,va:null}],ia:0,M:!1,Ka:null}),b))}function mr(a,b){for(var c=Number.POSITIVE_INFINITY,d=0;d<b.b.length;d++){for(var e=b.b[d].f.Ba,f=e.la[0].node,g=e.ia,h=e.M,l=0;f.ownerDocument!=a.ea.b;)l++,f=e.la[l].node,h=!1,g=0;e=uj(a.ea,f,g,h);e<c&&(c=e)}return c}
...
K);0<=K.width?rr(a,K,h).then(function(){wm(H)||um(H);wm(K.f)&&!wm(l)?(K.f.Ac=!1,a.b=G.clone(),K.element!==A&&A.removeChild(K.element),P(b)):Q(b)}):(um(H),Q(b))}).then(function(){O(J,K)});return M(J)}function tr(a,b,c,d,e){var f=ap(c,a,"writing-mode")||null;a=ap(c,a,"direction")||null;return new Zl(b,"region",d,e,null,f,a)}
...
J||wm(G)||um(G),wm(G)?(yc=0,a.b=z.clone(),G.Ac=!1,P(b)):(zc=c,zc.j&&"column"!=zc.j&&(yc=J,"region"!=zc.j&&(a.V[H]=!0)),Ca=Math.max(Ca,zc.pa),yc<J?P(b):Q(b)))})}).then(function(){if(!wm(h)){zc.element===n&&(q=zc);q.pa=Ca;c.Wc(a,q,b,zc,J,a.g,a.h);var d=a.b.b[H];d&&"region"===d.f&&(d.f=null)}O(A,!0)});l=M(A)}else{if((l=ap(c,a,"content"))&&Pk(l)){r="span";l.url&&(r="img");var Kj=a.viewport.b.createElement(r);l.ba(new Ok(Kj,a,l));n.appendChild(Kj);"img"==r&&pp(c,a,Kj,a.h);op(c,a,q,a.h)}else c.xa&&(d.removeChild(n),
y=!0);y||c.Wc(a,q,b,null,1,a.g,a.h);l=L(!0)}l.then(function(){if(wm(h))O(k,!0);else{if(!c.g||0<Math.floor(q.pa)){if(!y&&!m){var l=ap(c,a,"shape-outside"),l=q.yd(l,a);g.push(l)}}else if(!c.w.length){d.removeChild(n);O(k,!0);return}var r=c.w.length-1;ge(function(){for(;0<=r;){var d=c.w[r--],d=ur(a,b,d,n,e,f,g,h);if(d.za())return d.na(function(){return L(!wm(h))});if(wm(h))break}return L(!1)}).then(function(){O(k,!0)})}});return M(k)}
...
um(h);wm(h)?(a.b=a.A.clone(),h.Ac=!1,P(c)):Q(c)})}).then(function(){e.Y(a,b,a.g);var d=new fc(e.b.f,"left-page");b.l=d.evaluate(a)?"left":"right";vr(a);c=a.b;Object.keys(c.b).forEach(function(b){b=c.b[b];var d=b.f;!d||"page"!==d&&hr(a,d)||(b.f=null)});a.b=a.A=null;c.g=a.f.b;Wj(b,a.style.l.J[a.ea.url],a.g);wr(a,c)&&(c=null);O(l,c)});return M(l)}
...
function Dr(a,b){var c=I("OPSDocStore.load"),d=b.url;Cj(b,a).then(function(b){if(b){for(var e=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),h=0;h<g.length;h++){var l=g[h],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),n=l.getAttribute("action"),l=l.getAttribute("ref");k&&m&&n&&l&&e.push({hf:k,event:m,action:n,Fc:l})}a.J[d]=e;var r=[];r.push({url:oa("user-agent-page.css",na),text:null,Xa:"UA",
...
function js(a,b){return Qd("resolveFragment",function(c){if(b){var d=new fb;gb(d,b);var e;if(a.g){var f=hb(d,a.g.b);if(1!=f.node.nodeType||f.M||!f.Fc){O(c,null);return}var g=f.node,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.f[h]){O(c,null);return}e=a.f[h];d=f.Fc}else e=a.b[0];a.h.load(e.src).then(function(a){var b=hb(d,a.b);a=uj(a,b.node,b.offset,b.M);O(c,{P:e.P,Ea:a,$:-1})})}else O(c,null)},function(a,d){u.b(d,"Cannot resolve fragment:",b);O(a,null)})}
...
function qs(a,b,c){var d=I("renderSinglePage"),e=rs(a,b,c);xr(b.fb,e,c).then(function(f){var g=(c=f)?c.page-1:b.Qa.length-1;ps(a,b,e,g);zo(a.f,e.P,g);f=null;if(c){var h=b.Qa[c.page];b.Qa[c.page]=c;h&&b.mb[c.page]&&(Bk(c,h)||(f=qs(a,b,c)))}f||(f=L(!0));f.then(function(){var b=Ao(a.f,e),f=0;he(function(c){f++;if(f>b.length)Q(c);else{var d=b[f-1];d.bd=d.bd.filter(function(a){return!a.Gc});d.bd.length?ss(a,d.P).then(function(b){b?(yo(a.f,d.Jd),Bo(a.f,d.bd),qs(a,b,b.Qa[d.$]).then(function(b){var d=a.f;
d.b=d.F.pop();d=a.f;d.g=d.H.pop();d=b.Bc.position;d.P===e.P&&d.$===g&&(e=b.Bc.page);P(c)})):P(c)}):P(c)}}).then(function(){O(d,{Bc:ms(e,g),Pe:c})})})});return M(d)}function ts(a,b){var c=a.$,d=-1;0>c&&(d=a.Ea,c=La(b.Qa.length,function(a){return nr(b.fb,b.Qa[a],!0)>d}),c=c===b.Qa.length?b.complete?b.Qa.length-1:Number.POSITIVE_INFINITY:c-1);return{P:a.P,$:c,Ea:d}}
...
function vs(a,b){var c=I("renderPage");ss(a,b.P).then(function(d){if(d){var e=ts(b,d),f=e.$,g=e.Ea,h=d.mb[f];h?O(c,ms(h,f)):he(function(b){if(f<d.Qa.length)Q(b);else if(d.complete)f=d.Qa.length-1,Q(b);else{var c=d.Qa[d.Qa.length-1];qs(a,d,c).then(function(e){var k=e.Bc.page;(c=e.Pe)?0<=g&&nr(d.fb,c)>g?(h=k,f=d.Qa.length-2,Q(b)):P(b):(h=k,f=e.Bc.position.$,d.complete=!0,k.A=d.item.P===a.b.b.length-1,Q(b))})}}).then(function(){h=h||d.mb[f];var b=d.Qa[f];h?O(c,ms(h,f)):qs(a,d,b).then(function(b){b.Pe||
(d.complete=!0,b.Bc.page.A=d.item.P===a.b.b.length-1);O(c,b.Bc)})})}else O(c,null)});return M(c)}p.Od=function(){return ws(this,{P:this.b.b.length-1,$:Number.POSITIVE_INFINITY,Ea:-1})};function ws(a,b){var c=I("renderAllPages");b||(b={P:0,$:0,Ea:0});var d=b.P,e=b.$,f=0,g;he(function(c){vs(a,{P:f,$:f===d?e:Number.POSITIVE_INFINITY,Ea:f===d?b.Ea:-1}).then(function(a){g=a;++f>d?Q(c):P(c)})}).then(function(){O(c,g)});return M(c)}p.Ze=function(){return us(this,{P:0,$:0,Ea:-1})};
...
function xs(a,b,c){b="left"===b.l;a="ltr"===a.Hb(c);return!b&&a||b&&!a}function ys(a,b,c){var d=I("getCurrentSpread"),e=os(a,b);if(!e)return L({left:null,right:null});var f="left"===e.l;(xs(a,e,b)?a.Md(b):a.nextPage(b,c)).then(function(a){a=a&&a.page;f?O(d,{left:e,right:a}):O(d,{left:a,right:e})});return M(d)}p.gf=function(a,b){var c=os(this,a);if(!c)return L(null);var c=xs(this,c,a),d=this.nextPage(a,!!b);if(c)return d;var e=this;return d.na(function(a){return a?e.nextPage(a.position,!!b):L(null)})};
p.kf=function(a){var b=os(this,a);if(!b)return L(null);b=xs(this,b,a);a=this.Md(a);if(b){var c=this;return a.na(function(a){return a?c.Md(a.position):L(null)})}return a};function zs(a,b){var c=I("navigateToEPage");ks(a.b,b).then(function(b){b?us(a,b).Fa(c):O(c,null)});return M(c)}function As(a,b){var c=I("navigateToCFI");js(a.b,b).then(function(b){b?us(a,b).Fa(c):O(c,null)});return M(c)}
...
function(){e.Na=!0;e.J()};this.Kd=this.Kd.bind(this);this.G=function(){};this.H=a.getElementById("vivliostyle-page-rules");this.V=!1;this.l=null;this.ma={loadEPUB:this.We,loadXML:this.Xe,configure:this.$d,moveTo:this.xa,toc:this.dd};Gs(this)}function Gs(a){ka(1,function(a){Hs(this,{t:"debug",content:a})}.bind(a));ka(2,function(a){Hs(this,{t:"info",content:a})}.bind(a));ka(3,function(a){Hs(this,{t:"warn",content:a})}.bind(a));ka(4,function(a){Hs(this,{t:"error",content:a})}.bind(a))}
...
function Ks(a,b){Ls(a);var c;b?c=js(a.h,b).na(function(b){a.f=b;return L(!0)}):c=L(!0);return c.na(function(){Js.b("beforeRender");return Ms(a)})}function Ns(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*yb.ex*a.fontSize/yb.em;if(d=yb[d])return c*d}return c}
...
function Ps(a,b,c){a.Ib=!1;Rs(a);if(a.aa.ob)return ys(a.b,a.f,c).na(function(c){Ss(a);a.j=c;c.left&&(Ts(a,c.left),c.right||c.left.K.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Ts(a,c.right),c.left||c.right.K.setAttribute("data-vivliostyle-unpaired-page",!0));c=$s(a,c);a.viewport.zoom(c.width,c.height,a.F?at(a,c):a.zoom);a.g=b;return L(null)});Us(a,b);a.viewport.zoom(b.f.width,b.f.height,a.F?at(a,b.f):a.zoom);a.g=b;return L(null)}
...
function dt(a,b){var c=b.a||"";return Qd("runCommand",function(d){var e=a.ma[c];e?e.call(a,b).then(function(){Hs(a,{t:"done",a:c});O(d,!0)}):(u.error("No such action:",c),O(d,!0))},function(a,b){u.error(b,"Error during action:",c);O(a,!0)})}function et(a){return"string"==typeof a?JSON.parse(a):a}
...
e[1]],[0,e[1]]),e=f[1].slice(e[1].length),0<e.length&&d.splice(c+2,0,[f[0],e]),nt(d,c,3)):a}function nt(a,b,c){for(c=b+c-1;0<=c&&c>=b-1;c--)if(c+1<a.length){var d=a[c],e=a[c+1];d[0]===e[1]&&a.splice(c,2,[d[0],d[1]+e[1]])}return a};function aq(a){return a.reduce(function(a,c){return c[0]===bq.b?a:a+c[1]},"")}function sk(a,b,c){var d=0,e=0;a.some(function(a){for(var f=0;f<a[1].length;f++){switch(a[0]*c){case bq.f:d++;break;case bq.b:d--;e++;break;case bq.g:e++}if(e>b)return!0}return!1});return Math.max(Math.min(b,e-1)+d,0)};function ot(){}ot.prototype.Fe=function(a){return{B:a,Rc:!1,Cb:!1}};ot.prototype.Re=function(){};ot.prototype.ne=function(){};ot.prototype.sc=function(){};function pt(a,b){this.b=a;this.f=b}
function qt(a,b){var c=a.b,d=c.Fe(b),e=I("LayoutIterator");he(function(a){for(var b;d.B;){b=d.B.D?1!==d.B.D.nodeType?Zj(d.B.D,d.B.Qb)?void 0:d.B.M?void 0:c.Re(d):d.B.Da?void 0:d.B.M?c.sc(d):c.ne(d):void 0;b=(b&&b.za()?b:L(!0)).na(function(){return d.Cb?L(null):gn(this.f,d.B,d.Rc)}.bind(this));if(b.za()){b.then(function(b){d.Cb?Q(a):(d.B=b,P(a))});return}if(d.Cb){Q(a);return}d.B=b.get()}Q(a)}.bind(a)).then(function(){O(e,d.B)});return M(e)}function rt(a){this.Zc=a}t(rt,ot);p=rt.prototype;p.Se=function(){};
p.ye=function(){};p.Fe=function(a){return{B:a,Rc:!!this.Zc&&a.M,Cb:!1,Zc:this.Zc,uc:null,Hd:!1,Ke:[],Je:null}};p.Re=function(a){a.Hd=!1};p.ne=function(a){a.Ke.push(kk(a.B));a.uc=al(a.uc,a.B.g);a.Hd=!0;return this.Se(a)};p.sc=function(a){var b;a.Hd?(b=(b=void 0,L(!0)),b=b.na(function(){a.Cb||(a.Ke=[],a.Zc=!1,a.Rc=!1,a.uc=null);return L(!0)})):b=(b=this.ye(a))&&b.za()?b:L(!0);return b.na(function(){a.Cb||(a.Hd=!1,a.Je=kk(a.B),a.uc=al(a.uc,a.B.F));return L(!0)})};
function st(a,b,c){this.me=[];this.b=Object.create(a);this.b.element=b;this.b.h=a.h.clone();this.b.l=!1;this.b.Td=c.L;a=Xn(this.b,c);this.b.F-=a;var d=this;this.b.vb=function(a){return Xm.prototype.vb.call(this,a).na(function(a){var b=kk(a);d.me.push(b);return L(a)})}}st.prototype.Gb=function(a){var b=this.b.Gb();if(a){a=b.Tc?b.Tc.b():Number.MAX_VALUE;var c=this.me[0],c=new Rm(kk(c),null,c.b,0),d=c.f(this.b,a);if(d&&c.b()<a)return{Tc:c,B:d}}return b};
...
bu.prototype.sc=function(a){var b=this.L,c=a.B,d=c.display,e=this.h.b;if(c.R===b.j)c=qn(e,Yt(b,c)),b.J=parseFloat(c[b.u?"height":"width"]),a.Cb=!0;else switch(d){case "table-header-group":case "table-footer-group":this.b=!1;break;case "table-row":this.b||(b.A=c.D,this.g=!1);break;case "table-cell":if(!this.b){this.g||(this.rowIndex++,this.f=0,this.g=!0);a=this.rowIndex;c=new Kt(this.rowIndex,this.f,c.D);d=b.f[a];d||(b.f[a]=new It(a,null),d=b.f[a]);d.b.push(c);for(var d=a+c.rowSpan,e=Zt(b,a),f=0;e[f];)f++;
...
function eu(a,b,c,d){var e=b.rowIndex,f=b.h,g=c.D;if(1<b.b){v(g,"box-sizing","border-box");for(var h=a.L.F,l=0,k=0;k<b.b;k++)l+=h[b.f.b+k];l+=a.L.O*(b.b-1);v(g,a.L.u?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new Mt(a.f,b,c);a=a.L;(g=a.h[e])||(g=a.h[e]=[]);g[f]=c;1===d.Ba.la.length&&d.Ba.M&&(c.f=!0);return zn(c.ad.b,d,!0).md(!0)}function fu(a,b){var c=a.L.b[0];return c?c.vc.f.b===b:!1}
function gu(a){var b=a.L.b;if(!b.length)return[];var c=[],d=0;do{var e=b[d],f=e.vc.rowIndex;if(f<a.b){var g=c[f];g||(g=c[f]=[]);g.push(e);b.splice(d,1)}else d++}while(d<b.length);return c}
function hu(a,b){var c=a.L,d=gu(a),e=d.reduce(function(a){return a+1},0);if(0===e)return L(!0);var f=a.f.h,g=b.B;g.D.parentNode.removeChild(g.D);var h=I("layoutRowSpanningCellsFromPreviousFragment"),l=L(!0),k=0,m=[];d.forEach(function(a){l=l.na(function(){var b=ik(a[0].Zd.la[1],g.parent);return an(f,b,!1).na(function(){function d(a){for(;h<a;){if(!(0<=m.indexOf(h))){var c=b.D.ownerDocument.createElement("td");v(c,"padding","0");b.D.appendChild(c)}h++}}var g=L(!0),h=0;a.forEach(function(a){g=g.na(function(){var c=
a.vc;d(c.f.b);var g=a.Zd,l=ik(g.la[0],b);l.ia=g.ia;l.M=g.M;return an(f,l,!1).na(function(){for(var b=a.ue,d=0;d<c.b;d++)m.push(h+d);h+=c.b;return eu(this,c,l,b).na(function(){l.D.rowSpan=c.rowIndex+c.rowSpan-this.b+e-k;return L(!0)}.bind(this))}.bind(this))}.bind(this))},this);return g.na(function(){d($t(c));k++;return L(!0)})}.bind(this))}.bind(this))},a);l.then(function(){an(f,g,!0,b.Rc).then(function(){O(h,!0)})});return M(h)}
function iu(a,b){if(a.j||a.h)return L(!0);var c=b.B,d=a.L;0>a.b?a.b=St(d,c.R):a.b++;a.g=0;a.l=!0;return hu(a,b).na(function(){bo(this.f,b.Je,null,b.uc)&&!Rt(d,this.b-1).length&&(this.f.l=this.w,c.b=!0,b.Cb=!0);return L(!0)}.bind(a))}
function ju(a,b){if(a.j||a.h)return L(!0);var c=b.B;a.l||(0>a.b?a.b=0:a.b++,a.g=0,a.l=!0);var d=a.L.f[a.b].b[a.g],e=kk(c).modify();e.M=!0;b.B=e;var f=I("startTableCell");fu(a,d.f.b)?(e=a.L.b.shift(),e=L(e.ue)):e=gn(a.f.h,c,b.Rc).na(function(a){a.D&&c.D.removeChild(a.D);return L(new vk(gk(a)))});e.then(function(a){eu(this,d,c,a).then(function(){this.sc(b);this.g++;O(f,!0)}.bind(this))}.bind(a));return M(f)}
...
cu.prototype.sc=function(a){var b=a.B,c=b.display;"table-header-group"===c?this.j=!1:"table-footer-group"===c&&(this.h=!1);if(c&&du[c])b.D.parentNode.removeChild(b.D);else if(b.R===this.L.j)this.f.l=this.w,a.Cb=!0;else return rt.prototype.sc.call(this,a);return L(!0)};function ku(){}
...
ku.prototype.b=function(a,b){var c=b.L,d=c.g;d.j||b.R===c.j&&b.M||xt(d);if("table-row"===b.display){var e=St(c,b.R);c.b=[];var f;f=b.M?Rt(c,e):Xt(c,e);if(f.length){var g=I("TableLayoutProcessor.finishBreak"),h=0;he(function(a){if(h===f.length)Q(a);else{var b=f[h++],d=c.de(b),g=d.Gb().B,l=d.b,q=rk(l),z=new vk(rk(g));c.b.push({Zd:q,ue:z,vc:b});l=l.D;jo(d.b);e<b.rowIndex+b.rowSpan-1&&(l.rowSpan=e-b.rowIndex+1);d.f?P(a):Rn(d.ad.b,g,!1,!0).then(function(){var b=c.dc();if(b){var e=c.u,f=d.g,g=d.ad.b.element,
h=d.b.D,k=Xj(f.b,h),h=rn(f,h);e?v(g,"max-width",k.right-f.F-Sm(b)-h.right+"px"):v(g,"max-height",f.F-Sm(b)-k.top-h.top+"px");v(g,"overflow","hidden")}P(a)})}}).then(function(){d&&vt(d);c.h=[];go(b,!1);jo(b);O(g,!0)});return M(g)}}d&&vt(d);c.h=[];return null};function tu(a,b){if(b.G){var c=b.dc();a.R===b.j&&!a.M&&c&&(c.h=!1,c.l=!1);return new uu}return new vu}function vu(){}vu.prototype.g=function(a,b,c){return qu(a,b,c)};vu.prototype.f=function(a){return!!a};vu.prototype.b=function(a,b){b.G=!0};
...
uu.prototype.f=function(a,b,c){var d=b.dc();if(!d)return!0;c=c.Gb();return a.R===b.j&&a.M&&d.g?(d.g=!1,d.j=!1):!d.g&&d.j&&d.b||!d.h&&d.l&&d.f?!!c.B&&!c.B.b:!0};uu.prototype.b=function(a,b,c){(a=b.dc())&&!c&&(wt(a),xt(a),!a.g&&a.j&&a.b?a.g=!0:!a.h&&a.l&&a.f&&(a.h=!0))};var wu=new ku;Kd("RESOLVE_FORMATTING_CONTEXT",function(a,b,c){return b?c===td?(b=a.parent,new Ht(b?b.L:null,a.R)):null:null});Kd("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof Ht?wu:null});Array.from||(Array.from=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e],e):a[e];return c});
