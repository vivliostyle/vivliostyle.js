 ...
 *
 * Vivliostyle core 2016.2.0-pre.20160407061545
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
c.namespaceURI)e=Qp(c,d);else if("http://example.com/sse"==c.namespaceURI){e=d?d.ownerDocument:b.viewport.b;g=c.localName;switch(g){case "t":case "tab":case "ec":case "nt":case "fraction":case "comment":case "mark":g="span";break;case "ruby":case "rp":case "rt":break;default:g="div"}e=e.createElement(g);e.setAttribute("data-adapt-process-children","true");e=M(e)}else e=c.dataset&&"true"==c.dataset.mathTypeset?Qp(c,d):M(null);return e}};
...
function gq(a,b){var c=0,d=0;b.left&&(c+=b.left.d.width,d=b.left.d.height);b.right&&(c+=b.right.d.width,d=Math.max(d,b.right.d.height));b.left&&b.right&&(c+=2*a.S.Gb);return{width:c,height:d}}var hq={ce:"fit inside viewport"};
...
Tp.prototype.Ka=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.S.Wa?this.b.Pd:this.b.nextPage;break;case "previous":a=this.S.Wa?this.b.Sd:this.b.Vc;break;case "last":a=this.b.Kd;break;case "first":a=this.b.Jd;break;default:return M(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return Np(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return Pp(b.b,d)}}else return M(!0);var e=L("nextPage");a.call(b.b).then(function(a){a?(b.f=
