 ...
 *
 * Vivliostyle core 2016.2.0-pre.20160407053212
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function(){return this.kb()});qc(this,"pref-font-family",function(){return this.S.fontFamily});qc(this,"pref-night-mode",function(){return this.S.Sc});qc(this,"pref-hyphenate",function(){return this.S.Lc});qc(this,"pref-margin",function(){return this.S.margin});qc(this,"pref-line-height",function(){return this.S.lineHeight});qc(this,"pref-column-width",function(){return this.S.Gc*this.fontSize});qc(this,"pref-horizontal",function(){return this.S.Kc});qc(this,"pref-spread-view",function(){return this.S.Wa})}}
...
function Je(a,b,c){c=b+c;for(var d=Array(c),e=Array(c),f=0;f<=c;f++)d[f]=0,e[f]=0;for(var g=[],h=!1,l=a.length,k=0;k<l;k++){var m=a[k];d[m.b]+=m.e;e[m.b]+=m.d;for(var p=!1,f=0;f<b;f++)if(d[f]&&!e[f]){p=!0;break}if(p)for(f=b;f<=c;f++)if(d[f]||e[f]){p=!1;break}h!=p&&(g.push(m.x),h=p)}return g}function Ke(a,b){return b?Math.ceil(a/b)*b:a}function Le(a,b){return b?Math.floor(a/b)*b:a}function Me(a){return new we(a.y,-a.x)}function Ne(a){return new ve(a.V,-a.U,a.Q,-a.X)}
function Oe(a){return new Be(db(a.b,Me))}
function Pe(a,b,c,d,e){e&&(a=Ne(a),b=db(b,Oe),c=db(c,Oe));e=b.length;var f=c?c.length:0,g=[],h=[],l,k,m;for(l=0;l<e;l++)Ce(b[l],h,l);for(l=0;l<f;l++)Ce(c[l],h,l+e);b=h.length;h.sort(Ae);for(c=0;h[c].e>=e;)c++;c=h[c].b.y;c>a.V&&g.push(new ze(a.V,c,a.U,a.U));l=0;for(var p=[];l<b&&(m=h[l]).b.y<c;)m.d.y>c&&p.push(m),l++;for(;l<b||0<p.length;){var q=a.Q,v=Ke(Math.ceil(c+8),d);for(k=0;k<p.length&&q>v;k++)m=p[k],m.b.x==m.d.x?m.d.y<q&&(q=Math.max(Le(m.d.y,d),v)):m.b.x!=m.d.x&&(q=v);q>a.Q&&(q=a.Q);for(;l<
...
1;0<=k;k--)p[k].d.y<=q&&p.splice(k,1)}Qe(a,g);return g}function Qe(a,b){for(var c=b.length-1,d=new ze(a.Q,a.Q,a.X,a.U);0<=c;){var e=d,d=b[c];d.X==e.X&&d.U==e.U&&(e.V=d.V,b.splice(c,1),d=e);c--}}function Re(a,b){for(var c=0,d=a.length;c<d;){var e=Math.floor((c+d)/2);b>=a[e].Q?c=e+1:d=e}return c}
function Se(a,b,c,d){for(var e=c.V,f=c.U-c.X,g=c.Q-c.V,h=Re(b,e);;){var l=e+g;if(l>a.Q)break;for(var k=a.X,m=a.U,p=h;p<b.length&&b[p].V<l;p++){var q=b[p];q.X>k&&(k=q.X);q.U<m&&(m=q.U)}if(k+f<=m||h>=b.length){"left"==d?(c.X=k,c.U=k+f):(c.X=m-f,c.U=m);c.Q+=e-c.V;c.V=e;break}e=b[h].Q;h++}}
function Te(a,b,c,d){for(var e=null,e=[new ze(c.V,c.Q,c.X,c.U)];0<e.length&&e[0].Q<=a.V;)e.shift();if(0!=e.length){e[0].V<a.V&&(e[0].V=a.V);c=0==b.length?a.V:b[b.length-1].Q;c<a.Q&&b.push(new ze(c,a.Q,a.X,a.U));for(var f=Re(b,e[0].V),g=0;g<e.length;g++){var h=e[g];if(f==b.length)break;b[f].V<h.V&&(c=b[f],f++,b.splice(f,0,new ze(h.V,c.Q,c.X,c.U)),c.Q=h.V);for(;f<b.length&&(c=b[f++],c.Q>h.Q&&(b.splice(f,0,new ze(h.Q,c.Q,c.X,c.U)),c.Q=h.Q),h.X!=h.U&&("left"==d?c.X=h.U:c.U=h.X),c.Q!=h.Q););}Qe(a,b)}}
...
function gf(a){this.e=a;this.f=1;this.slice=25;this.h=0;this.d=new Aa;this.b=this.j=null;this.g=!1;this.P=0;Ze||(Ze=this)}
...
l=k}f.b[l]=g}var l=c,m=l.d;l.d=null;m&&m.e==l&&(m.e=null,k=Ye,Ye=m,O(m.top,l.e),Ye=k);b=a.e.currentTime();if(b>=a.h)break}}catch(p){u.error(p)}a.g=!1;a.d.length()&&kf(a)},b)}}gf.prototype.Ua=function(a,b){var c=this.e.currentTime();a.P=this.P++;a.b=c+(b||0);a:{for(var c=this.d,d=c.b.length;1<d;){var e=Math.floor(d/2),f=c.b[e];if(0<lf(f,a)){c.b[d]=a;break a}c.b[d]=f;d=e}c.b[1]=a}kf(this)};
function ff(a,b,c){var d=new mf(a,c||"");d.top=new $e(d,null,"bootstrap");d.top.b=af;d.top.then(function(){function a(){d.h=!1;for(var b=0;b<d.g.length;b++){var c=d.g[b];try{c()}catch(e){u.error(e)}}}try{b().then(function(b){d.f=b;a()})}catch(c){df(d,c),a()}});c=Ye;Ye=d;a.Ua(nf(d.top,"bootstrap"));Ye=c;return d}function of(a){this.d=a;this.P=this.b=0;this.e=null}function lf(a,b){return b.b-a.b||b.P-a.P}of.prototype.Ua=function(a,b){this.e=a;this.d.d.Ua(this,b)};
...
300)):a.src=b;return N(g)},"loadElement "+b);e.start();return e};function Bg(a){this.e=this.f=null;this.d=0;this.b=a}function Cg(a,b){this.b=-1;this.d=a;this.e=b}function Dg(){this.b=[];this.d=[];this.match=[];this.e=[];this.error=[];this.f=!0}function Eg(a,b,c){for(var d=0;d<b.length;d++)a.d[b[d]].b=c;b.splice(0,b.length)}
Dg.prototype.clone=function(){for(var a=new Dg,b=0;b<this.b.length;b++){var c=this.b[b],d=new Bg(c.b);d.d=c.d;a.b.push(d)}for(b=0;b<this.d.length;b++)c=this.d[b],d=new Cg(c.d,c.e),d.b=c.b,a.d.push(d);a.match.push.apply(a.match,this.match);a.e.push.apply(a.e,this.e);a.error.push.apply(a.error,this.error);return a};
function Fg(a,b,c,d){var e=a.b.length,f=new Bg(Gg);f.d=0<=d?c?2*d+1:2*d+2:c?-1:-2;a.b.push(f);Eg(a,b,e);c=new Cg(e,!0);e=new Cg(e,!1);b.push(a.d.length);a.d.push(e);b.push(a.d.length);a.d.push(c)}function Hg(a){return 1==a.b.length&&0==a.b[0].d&&a.b[0].b instanceof Ig}
function Jg(a,b,c){if(0!=b.b.length){var d=a.b.length;if(4==c&&1==d&&Hg(b)&&Hg(a)){c=a.b[0].b;b=b.b[0].b;var d={},e={},f;for(f in c.d)d[f]=c.d[f];for(f in b.d)d[f]=b.d[f];for(var g in c.e)e[g]=c.e[g];for(g in b.e)e[g]=b.e[g];a.b[0].b=new Ig(c.b|b.b,d,e)}else{for(f=0;f<b.b.length;f++)a.b.push(b.b[f]);4==c?(a.f=!0,Eg(a,a.e,d)):Eg(a,a.match,d);g=a.d.length;for(f=0;f<b.d.length;f++)e=b.d[f],e.d+=d,0<=e.b&&(e.b+=d),a.d.push(e);for(f=0;f<b.match.length;f++)a.match.push(b.match[f]+g);3==c&&Eg(a,a.match,
...
function Lg(a){this.b=new Bg(null);var b=this.e=new Bg(null),c=a.b.length;a.b.push(this.b);a.b.push(b);Eg(a,a.match,c);Eg(a,a.e,c+1);Eg(a,a.error,c+1);for(b=0;b<a.d.length;b++){var d=a.d[b];d.e?a.b[d.d].f=a.b[d.b]:a.b[d.d].e=a.b[d.b]}for(b=0;b<c;b++)if(null==a.b[b].e||null==a.b[b].f)throw Error("Invalid validator state");this.d=a.b[0]}t(Lg,Kg);
function Mg(a,b,c,d){for(var e=c?[]:b,f=a.d,g=d,h=null,l=null;f!==a.b&&f!==a.e;)if(g>=b.length)f=f.e;else{var k=b[g],m=k;if(0!=f.d)m=!0,-1==f.d?(h?h.push(l):h=[l],l=[]):-2==f.d?0<h.length?l=h.pop():l=null:0<f.d&&0==f.d%2?l[Math.floor((f.d-1)/2)]="taken":m=null==l[Math.floor((f.d-1)/2)],f=m?f.f:f.e;else{if(0==g&&!c&&f.b instanceof Ng&&a instanceof Ng){if(m=(new ld(b)).T(f.b)){g=b.length;f=f.f;continue}}else if(0==g&&!c&&f.b instanceof Og&&a instanceof Ng){if(m=(new md(b)).T(f.b)){g=b.length;f=f.f;
continue}}else m=k.T(f.b);if(m){if(m!==k&&b===e)for(e=[],k=0;k<g;k++)e[k]=b[k];b!==e&&(e[g-d]=m);g++;f=f.f}else f=f.e}}return f===a.b&&(c?0<e.length:g==b.length)?e:null}n=Lg.prototype;n.Ra=function(a){for(var b=null,c=this.d;c!==this.b&&c!==this.e;)a?0!=c.d?c=c.f:(b=a.T(c.b))?(a=null,c=c.f):c=c.e:c=c.e;return c===this.b?b:null};n.$c=function(a){return this.Ra(a)};n.ad=function(a){return this.Ra(a)};n.cc=function(a){return this.Ra(a)};n.pb=function(a){return this.Ra(a)};n.Nb=function(a){return this.Ra(a)};
...
Ng.prototype.ob=function(a){for(var b=this.d,c=!1;b;){if(b.b instanceof Og){c=!0;break}b=b.e}return c?(b=Mg(this,a.values,!1,0),b===a.values?a:b?new md(b):null):null};Ng.prototype.f=function(a,b){return Mg(this,a,!0,b)};function Og(a){Lg.call(this,a)}t(Og,Lg);Og.prototype.ab=function(a){return this.Ra(a)};Og.prototype.ob=function(a){var b=Mg(this,a.values,!1,0);return b===a.values?a:b?new md(b):null};Og.prototype.f=function(a,b){for(var c=this.d,d;c!==this.e;){if(d=c.b.f(a,b))return d;c=c.e}return null};
function Pg(a,b){Lg.call(this,b);this.name=a}t(Pg,Lg);Pg.prototype.Ra=function(){return null};Pg.prototype.yb=function(a){if(a.name.toLowerCase()!=this.name)return null;var b=Mg(this,a.values,!1,0);return b===a.values?a:b?new nd(a.name,b):null};function Qg(){}Qg.prototype.b=function(a,b){return b};Qg.prototype.e=function(){};function Rg(a,b){this.name=b;this.f=a.e[this.name]}t(Rg,Qg);
Rg.prototype.b=function(a,b,c){if(c.values[this.name])return b;if(a=this.f.f(a,b)){var d=a.length;this.e(1<d?new ld(a):a[0],c);return b+d}return b};Rg.prototype.e=function(a,b){b.values[this.name]=a};function Sg(a,b){Rg.call(this,a,b[0]);this.d=b}t(Sg,Rg);Sg.prototype.e=function(a,b){for(var c=0;c<this.d.length;c++)b.values[this.d[c]]=a};function Tg(a,b){this.d=a;this.od=b}t(Tg,Qg);
Tg.prototype.b=function(a,b,c){var d=b;if(this.od)if(a[b]==rd){if(++b==a.length)return d}else return d;var e=this.d[0].b(a,b,c);if(e==b)return d;b=e;for(d=1;d<this.d.length&&b<a.length;d++){e=this.d[d].b(a,b,c);if(e==b)break;b=e}return b};function Ug(){this.b=this.Oa=null;this.error=!1;this.values={};this.d=null}n=Ug.prototype;n.clone=function(){var a=new this.constructor;a.Oa=this.Oa;a.b=this.b;a.d=this.d;return a};n.dd=function(a,b){this.Oa=a;this.b=b};n.Ab=function(){this.error=!0;return 0};
function Vg(a,b){a.Ab([b]);return null}n.$c=function(a){return Vg(this,a)};n.cc=function(a){return Vg(this,a)};n.pb=function(a){return Vg(this,a)};n.Nb=function(a){return Vg(this,a)};n.Mb=function(a){return Vg(this,a)};n.Lb=function(a){return Vg(this,a)};n.zc=function(a){return Vg(this,a)};n.dc=function(a){return Vg(this,a)};n.ab=function(a){this.Ab(a.values);return null};n.ob=function(){this.error=!0;return null};n.yb=function(a){return Vg(this,a)};n.Kb=function(){this.error=!0;return null};
function Wg(){Ug.call(this)}t(Wg,Ug);Wg.prototype.Ab=function(a){for(var b=0,c=0;b<a.length;){var d=this.Oa[c].b(a,b,this);if(d>b)b=d,c=0;else if(++c==this.Oa.length){this.error=!0;break}}return b};function Xg(){Ug.call(this)}t(Xg,Ug);Xg.prototype.Ab=function(a){if(a.length>this.Oa.length||0==a.length)return this.error=!0,0;for(var b=0;b<this.Oa.length;b++){for(var c=b;c>=a.length;)c=1==c?0:c-2;if(this.Oa[b].b(a,c,this)!=c+1)return this.error=!0,0}return a.length};function Yg(){Ug.call(this)}
t(Yg,Ug);Yg.prototype.Ab=function(a){for(var b=a.length,c=0;c<a.length;c++)if(a[c]===rd){b=c;break}if(b>this.Oa.length||0==a.length)return this.error=!0,0;for(c=0;c<this.Oa.length;c++){for(var d=c;d>=b;)d=1==d?0:d-2;var e;if(b+1<a.length)for(e=b+c+1;e>=a.length;)e-=e==b+2?1:2;else e=d;if(2!=this.Oa[c].b([a[d],a[e]],0,this))return this.error=!0,0}return a.length};function Zg(){Ug.call(this)}t(Zg,Wg);
...
function bh(){this.e={};this.k={};this.h={};this.b={};this.d={};this.f={};this.j=[];this.g=[]}function ch(a,b){var c;if(3==b.type)c=new I(b.B,b.text);else if(7==b.type)c=Ff(b.text);else if(1==b.type)c=H(b.text);else throw Error("unexpected replacement");if(Hg(a)){var d=a.b[0].b.d,e;for(e in d)d[e]=c;return a}throw Error("unexpected replacement");}
...
if(5!=g.type)throw Error("<int> expected");q=g.B;A(b);g=x(b)}if(13!=g.type)throw Error("'}' expected");d.push(dh(d.pop(),p,q));break;case 17:m=l();if(0<e.length)throw Error("unclosed '"+e.pop().Ob+"'");break;default:throw Error("unexpected token");}A(b);hh(c)?a.b[c]=m:a.e[c]=1!=m.b.length||0!=m.b[0].d?new Ng(m):m.b[0].b}}
...
function ci(a,b){this.e={};this.M=a;this.b=b;this.w=null;this.h=[];var c=this;this.D=function(a){var b=a.currentTarget,f=b.getAttribute("href")||b.getAttributeNS("http://www.w3.org/1999/xlink","href");f&&(a.preventDefault(),gb(c,{type:"hyperlink",target:null,currentTarget:null,me:b,href:f}))};this.j={};this.d={width:0,height:0};this.l=this.k=!1;this.G=0;this.position=null;this.offset=-1;this.g=null;this.f=[];this.u={top:{},bottom:{},left:{},right:{}}}t(ci,fb);
...
dk={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},ek={oe:!1,Pb:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",mc:"\u5341\u767e\u5343",Pd:"\u8ca0"};
function fk(a){if(9999<a||-9999>a)return""+a;if(0==a)return ek.Pb.charAt(0);var b=new Ra;0>a&&(b.append(ek.Pd),a=-a);if(10>a)b.append(ek.Pb.charAt(a));else if(ek.pe&&19>=a)b.append(ek.mc.charAt(0)),0!=a&&b.append(ek.mc.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(ek.Pb.charAt(c)),b.append(ek.mc.charAt(2)));if(c=Math.floor(a/100)%10)b.append(ek.Pb.charAt(c)),b.append(ek.mc.charAt(1));if(c=Math.floor(a/10)%10)b.append(ek.Pb.charAt(c)),b.append(ek.mc.charAt(0));(a%=10)&&b.append(ek.Pb.charAt(a))}return b.toString()}
...
function nk(){this.g=0;this.b={};this.bc={};this.f={};this.d={};this.za={};this.e={};this.Ub={};this.P=0}nk.prototype.clone=function(){var a=new nk;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b];mk(this.bc,a.bc);mk(this.f,a.f);mk(this.d,a.d);mk(this.za,a.za);mk(this.e,a.e);mk(this.Ub,a.Ub);a.P=this.P;return a};function sj(a,b,c){var d=a[b];d&&(c=d.h(c));a[b]=c}
...
ok.prototype.pop=function(){for(var a=1;-1<=a;--a)for(var b=this.f[this.f.length-a-2],c=0;c<b.length;)b[c].pop(this,a)?b.splice(c,1):c++;this.f.pop();this.Fa=!1};var yk=null;function zk(a,b,c,d,e,f,g){Lf.call(this,a,b,g);this.b=null;this.O=0;this.f=this.h=null;this.l=!1;this.K=c;this.g=d?d.g:yk?yk.clone():new nk;this.w=e;this.k=f;this.j=0}t(zk,Mf);zk.prototype.yd=function(a){sj(this.g.bc,"*",a)};function Ak(a,b){var c=kj(a.b,b);c!==b&&c.e(a.g)||a.yd(c)}
zk.prototype.fb=function(a,b){if(b||a)this.O+=1,b&&a?this.b.push(new vj(a,b.toLowerCase())):b?this.b.push(new uj(b.toLowerCase())):this.b.push(new xj(a))};zk.prototype.Fc=function(a){this.f?(u.b("::"+this.f,"followed by ."+a),this.b.push(new V(""))):(this.O+=256,this.b.push(new rj(a)))};var Bk={"nth-child":Hj,"nth-of-type":Ij,"nth-last-child":Jj,"nth-last-of-type":Kj};
...
this.b.push(new V(""))}this.O+=1};zk.prototype.Mc=function(a){this.O+=65536;this.b.push(new tj(a))};
...
n.Fb=function(){Dk(this);this.f=null;this.l=!1;this.O=0;this.b=[]};n.$a=function(){var a;0!=this.j?(Of(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.j=1,this.h={},this.f=null,this.O=0,this.l=!1,this.b=[])};n.error=function(a,b){Mf.prototype.error.call(this,a,b);1==this.j&&(this.j=0)};n.Jb=function(a){Mf.prototype.Jb.call(this,a);this.j=0};n.ma=function(){Dk(this);Mf.prototype.ma.call(this);1==this.j&&(this.j=0)};n.ib=function(){Mf.prototype.ib.call(this)};
function Dk(a){if(a.b){var b=a.O,c;c=a.g;c=c.P+=lk;Ak(a,a.Ad(b+c));a.b=null;a.f=null;a.l=!1;a.O=0}}n.Ad=function(a){var b=this.w;this.l&&(b=b?"xxx-bogus-xxx":"footnote");return new qj(this.h,a,this.f,b)};n.Ya=function(a,b,c){lh(this.k,a,b,c,this)};n.Sb=function(a,b){Nf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};n.yc=function(a,b){Nf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
n.Za=function(a,b,c){"display"!=a||b!==be&&b!==ae||(this.Za("flow-options",new ld([Ld,ge]),c),this.Za("flow-into",b,c),b=Ed);(Qi.SIMPLE_PROPERTY||[]).forEach(function(d){d=d({name:a,value:b,important:c});a=d.name;b=d.value;c=d.important});var d=c?Hf(this):If(this);gj(this.h,a,this.K?new cj(b,d,this.K):new T(b,d))};n.Zb=function(a){switch(a){case "not":a=new Ek(this),a.$a(),Kf(this.Y,a)}};function Ek(a){zk.call(this,a.d,a.Y,a.K,a,a.w,a.k,!1);this.parent=a;this.e=a.b}t(Ek,zk);n=Ek.prototype;
n.Zb=function(a){"not"==a&&Of(this,"E_CSS_UNEXPECTED_NOT")};n.ma=function(){Of(this,"E_CSS_UNEXPECTED_RULE_BODY")};n.Fb=function(){Of(this,"E_CSS_UNEXPECTED_NEXT_SELECTOR")};n.ic=function(){this.b&&0<this.b.length&&this.e.push(new Qj(this.b));this.parent.O+=this.O;var a=this.Y;a.b=a.e.pop()};n.error=function(a,b){zk.prototype.error.call(this,a,b);var c=this.Y;c.b=c.e.pop()};function Fk(a,b){Lf.call(this,a,b,!1)}t(Fk,Mf);
...
Gk.prototype.yc=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};Gk.prototype.Za=function(a,b,c){c=c?Hf(this):If(this);c+=this.P;this.P+=lk;gj(this.b,a,this.K?new cj(b,c,this.K):new T(b,c))};function Hk(a,b){jg.call(this,a);this.b={};this.e=b;this.P=0}t(Hk,jg);Hk.prototype.Ya=function(a,b,c){lh(this.e,a,b,c,this)};Hk.prototype.Sb=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};Hk.prototype.yc=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};
Hk.prototype.Za=function(a,b,c){c=(c?67108864:50331648)+this.P;this.P+=lk;gj(this.b,a,new T(b,c))};function Ik(a,b,c){return(a=a["writing-mode"])&&(b=a.evaluate(b,"writing-mode"))&&b!==Rd?b===me:c}function Jk(a,b,c,d){var e={},f;for(f in a)fj(f)&&(e[f]=a[f]);a=a._regions;if((c||d)&&a)for(d&&(d=["footnote"],c=c?c.concat(d):d),d=0;d<c.length;d++){f=a[c[d]];for(var g in f)fj(g)&&(e[g]=dj(b,e[g],f[g]))}return e}
...
function nl(a,b,c,d,e,f,g){a=a instanceof ll?a:new ll(a,this);hl.call(this,a,b,c,d,e);this.e=this;this.K=f;this.O=g;this.b.width=new T(qe,0);this.b.height=new T(re,0);this.b["wrap-flow"]=new T(Dd,0);this.b.position=new T(de,0);this.b.overflow=new T(ne,0);this.j={}}t(nl,hl);nl.prototype.f=function(a){return new ol(a,this)};nl.prototype.clone=function(a){a=new nl(this.d,this.name,a.nb||this.nb,this.za,this.parent,this.K,this.O);il(this,a);jl(this,a);return a};
...
X?(X="http://www.w3.org/1999/xhtml",F=a.b.b?"span":"div"):J=!!a.g;y?b?F="li":(F="div",m=Ed,l.display=m):"body"==F||"li"==F?F="div":"q"==F?F="span":"a"==F&&(g=l["hyperlink-processing"])&&"normal"!=g.toString()&&(F="span");l.behavior&&"none"!=l.behavior.toString()&&a.g&&(J=!0);f.dataset&&"true"==f.dataset.Md&&(J=!0);var va;J?va=a.g(f,a.b.parent?a.b.parent.C:null,l):va=M(null);va.then(function(g){g?J&&(d="true"==g.getAttribute("data-adapt-process-children")):g=a.createElement(X,F);"a"==F&&g.addEventListener("click",
a.e.D,!1);W&&(sm(a,a.b,"inner",W),g.appendChild(W));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&em(g);if("http://www.gribuser.ru/xml/fictionbook/2.0"!=f.namespaceURI||"td"==F){for(var h=f.attributes,k=h.length,m=null,p=0;p<k;p++){var q=h[p],r=q.namespaceURI,v=q.localName,q=q.nodeValue;if(r)if("http://www.w3.org/2000/xmlns/"==r)continue;else"http://www.w3.org/1999/xlink"==r&&"href"==v&&(q=qm(a,q));else{if(v.match(/^on/))continue;if("style"==v)continue;if("id"==v){fi(a.e,
g,q);continue}"src"==v||"href"==v||"poster"==v?q=qm(a,q):"srcset"==v&&(q=q.split(",").map(function(b){return qm(a,b.trim())}).join(","))}if(r){var va=dm[r];va&&(v=va+":"+v)}"src"!=v||r||"img"!=F||"http://www.w3.org/1999/xhtml"!=X?"href"==v&&"image"==F&&"http://www.w3.org/2000/svg"==X&&"http://www.w3.org/1999/xlink"==r?a.e.f.push(Ag(g,q)):r?g.setAttributeNS(r,v,q):g.setAttribute(v,q):m=q}m&&(h=Ag(g,m),k=l.width,m=l.height,k&&k!==Dd&&m&&m!==Dd?a.e.f.push(h):pa.push(h))}delete l.content;(h=l["list-style-image"])&&
h instanceof xd&&(h=h.url,pa.push(Ag(new Image,h)));tm(a,g,l);h=l.widows;k=l.orphans;if(h||k){if(a.b.parent){a.b.l={};for(var bc in a.b.parent.l)a.b.l[bc]=a.b.parent.l[bc]}h instanceof vd&&(a.b.l.widows=h.B);k instanceof vd&&(a.b.l.orphans=k.B)}if(!a.b.b&&(bc=null,b?c&&(bc=a.b.f?cm:bm):bc=a.b.f?am:$l,bc))for(var el in bc)w(g,el,bc[el]);y&&g.setAttribute("value",l["ua-list-item-count"].stringValue());a.C=g;pa.length?zg(pa).then(function(){O(e,d)}):sf().then(function(){O(e,d)})})});return N(e)}
...
function Qm(a,b){var c=(a.b?a.cb:a.La)-a.h.X,d=(a.b?a.La:a.Ga)-a.h.V;return new ve(b.X-c,b.V-d,b.U-c,b.Q-d)}function Rm(a,b){return a.b?b<a.oa:b>a.oa}function Sm(a,b,c){var d=new ni(b.ha,c,0);d.Na=b.Na;d.da=b.da;d.xa=b.xa;d.qa=b.qa?Sm(a,b.qa,qi(c)):null;return d}
...
function $m(a){for(var b=a.d.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.d.removeChild(b);else break}b=c}}function an(a){for(var b=a.d.firstChild,c=a.Qa,d=a.b?a.h.V:a.h.X,e=a.b?a.h.Q:a.h.U,f=0;f<c.length;f++){var g=c[f],h=g.Q-g.V;g.left=Zm(a,b,"left",g.X-d,h);g.right=Zm(a,b,"right",e-g.U,h)}}
...
new ve(p,(a.b?-1:1)*a.Ga,q,(a.b?-1:1)*a.cb);q=m;a.b&&(q=Ne(m));Se(p,a.Qa,q,e);a.b&&(m=new ve(-q.Q,q.X,-q.V,q.U));w(d,"left",m.X-(a.b?a.cb:a.La)+a.j+"px");w(d,"top",m.V-(a.b?a.La:a.Ga)+a.k+"px");m=a.b?m.X:m.Q;Rm(a,m)&&0!=a.A.length?(b=b.modify(),b.e=!0,O(c,b)):($m(a),p=a.b?Ne(a.h):a.h,a.b?q=Ne(Qm(a,new ve(-q.Q,q.X,-q.V,q.U))):q=Qm(a,q),Te(p,a.Qa,q,e),an(a),"left"==e?a.Bc=m:a.Cc=m,on(a,m),O(c,k))}});return N(c)}
...
"pt")));return b}function Vn(a,b){var c={},d=a.Bb.B*yc(b,a.Bb.fa,!1),e=a.ub.B*yc(b,a.ub.fa,!1),f=d+e,g=a.width;c.lb=g===qe?(b.S.Wa?Math.floor(b.sa/2)-b.S.Gb:b.sa)-2*f:g.B*yc(b,g.fa,!1);g=a.height;c.kb=g===re?b.Qa-2*f:g.B*yc(b,g.fa,!1);c.Bb=d;c.ub=e;c.Hc=f;return c}function Wn(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
function Xn(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg",c||"polyline");a.setAttribute("stroke","black");a.setAttribute("stroke-width",b);a.setAttribute("fill","none");return a}var Yn={ke:"top left",le:"top right",be:"bottom left",ce:"bottom right"};
...
k.appendChild(l);a=Xn(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));k.appendChild(a);b.split(" ").forEach(function(a){k.style[a]=f+"px"});return k}var $n={je:"top",ae:"bottom",Fd:"left",Gd:"right"};
...
ta:!0,ua:!1,va:!1,ja:"center"},"bottom-left":{P:12,wa:!1,ta:!0,ua:!1,va:!1,ja:"start"},"bottom-left-corner":{P:13,wa:!1,ta:!0,ua:!0,va:!1,ja:null},"left-bottom":{P:14,wa:!1,ta:!1,ua:!0,va:!1,ja:"end"},"left-middle":{P:15,wa:!1,ta:!1,ua:!0,va:!1,ja:"center"},"left-top":{P:16,wa:!1,ta:!1,ua:!0,va:!1,ja:"start"}},fo=Object.keys(eo).sort(function(a,b){return eo[a].P-eo[b].P});
...
function vo(a,b,c){function d(a){if(y)return y;y={aa:r?r.evaluate(a):null,Ia:l?l.evaluate(a):null,Ja:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[q,m,p,v].forEach(function(b){b&&(c+=b.evaluate(a))});(null===y.Ia||null===y.Ja)&&c+y.aa+y.Ia+y.Ja>b&&(null===y.Ia&&(y.Ia=0),null===y.Ja&&(y.qe=0));null!==y.aa&&null!==y.Ia&&null!==y.Ja&&(y.Ja=null);null===y.aa&&null!==y.Ia&&null!==y.Ja?y.aa=b-c-y.Ia-y.Ja:null!==y.aa&&null===y.Ia&&null!==y.Ja?y.Ia=b-c-y.aa-y.Ja:null!==y.aa&&null!==y.Ia&&null===y.Ja?y.Ja=
...
Fo.prototype.apply=function(a){var b=a.g,c=a.w,d=this.style;a=this.O;jj(b,c,d,a,null,null);if(d=d._marginBoxes){var c=hj(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);jj(b,f,d[e],a,null,null)}}};function Go(a,b,c,d,e){zk.call(this,a,b,null,c,null,d,!1);this.H=e;this.A=[];this.e="";this.u=[]}t(Go,zk);n=Go.prototype;n.Ib=function(){this.$a()};n.fb=function(a,b){if(this.e=b)this.b.push(new zo(b)),this.O+=65536};
n.Vb=function(a,b){b&&Of(this,"E_INVALID_PAGE_SELECTOR :"+a+"("+b.join("")+")");this.u.push(":"+a);switch(a.toLowerCase()){case "first":this.b.push(new Ao(this.d));this.O+=256;break;case "left":this.b.push(new Bo(this.d));this.O+=1;break;case "right":this.b.push(new Co(this.d));this.O+=1;break;case "recto":this.b.push(new Do(this.d));this.O+=1;break;case "verso":this.b.push(new Eo(this.d));this.O+=1;break;default:Of(this,"E_INVALID_PAGE_SELECTOR :"+a)}};
function Ho(a){var b;a.e||a.u.length?b=[a.e].concat(a.u.sort()):b=null;a.A.push({nd:b,O:a.O});a.e="";a.u=[]}n.Fb=function(){Ho(this);zk.prototype.Fb.call(this)};n.ma=function(){Ho(this);zk.prototype.ma.call(this)};
n.Za=function(a,b,c){if("bleed"!==a&&"marks"!==a||this.A.some(function(a){return null===a.nd})){zk.prototype.Za.call(this,a,b,c);var d=this.h[a],e=this.H;if("bleed"===a||"marks"===a)e[""]||(e[""]={}),Object.keys(e).forEach(function(b){gj(e[b],a,d)});else if("size"===a){var f=e[""];this.A.forEach(function(b){var c=new T(d.value,d.Ea+b.O);b=b.nd?b.nd.join(""):"";var l=e[b];l?(c=(b=l[a])?dj(null,c,b):c,gj(l,a,c)):(l=e[b]={},gj(l,a,c),f&&["bleed","marks"].forEach(function(a){f[a]&&gj(l,a,f[a])},this))},
...
function To(a,b,c){var d=a.b.b[c];if(!d)return M(!0);hn(b);a.e[c]&&0<b.Qa.length&&(b.sd=!1);var e=L("layoutColumn"),f=[],g=[];uf(function(c){for(;0<d.b.length-g.length;){for(var e=0;0<=g.indexOf(e);)e++;var k=d.b[e];if(k.b.b>a.j)break;for(var m=1;m<d.b.length;m++)if(!(0<=g.indexOf(m))){var p=d.b[m];if(p.b.b>a.j)break;ii(p.b,k.b)&&(k=p,e=m)}var q=k.b,v=!0;ln(b,k.d).then(function(a){k.b.Ud&&(null===a||q.d)&&f.push(e);q.d?(g.push(e),P(c)):a?(k.d=a,P(c)):(g.push(e),v?v=!1:wf(c))});if(v){v=!1;return}}P(c)}).then(function(){d.b=
...
h.name,h.value.toString());for(d=0;d<f.length;d++)if(g=f[d],l=b.j[g.Xb],h=b.j[g.Rd],l&&h&&(l=bi(l,g.action)))for(var y=0;y<h.length;y++)h[y].addEventListener(g.event,l,!1);var J;a:{for(J in a.e)if((f=c.b[J])&&0<f.b.length){J=!1;break a}J=!0}J&&(c=null);O(k,c)});return N(k)}
...
function ap(a,b){var c=L("OPSDocStore.load"),d=b.url;Nh(b,a).then(function(b){if(b){for(var f=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),h=0;h<g.length;h++){var l=g[h],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=l.getAttribute("action"),l=l.getAttribute("ref");k&&m&&p&&l&&f.push({Rd:k,event:m,action:p,Xb:l})}a.D[d]=f;var q=[],f=ua("user-agent-page.css",ta);q.push({url:f,text:null,
...
ep.prototype.oc=function(a,b,c,d,e){if(this.b)return M(this.b);var f=this,g=L("showTOC"),h=new ci(a,a);this.b=h;this.d.load(this.url).then(function(d){var k=f.d.b[d.url],m=Oo(k,c,1E5,e);b=new Em(b.f,m.fontSize,b.root,m.width,m.height);var p=new Po(k,d,f.lang,b,f.e,f.g,f.Rc(d),f.f,0);f.Da=p;p.S=f.S;Qo(p).then(function(){Vo(p,h,null).then(function(){fp(f,a,2);O(g,h)})})});return N(g)};
...
function vp(a,b){function c(a){for(var b in a){var d=a[b];d.sort(up(b,k));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return eb(a,function(a){return db(a,function(a){var b={v:a.value,o:a.P};a.re&&(b.s=a.scheme);if(a.id||a.lang){var c=l[a.id];if(c||a.lang)a.lang&&(a={name:sp,value:a.lang,lang:null,id:null,Wc:a.id,scheme:null,P:a.P},c?c.push(a):c=[a]),c=cb(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
...
a.namespaceURI)return{name:rp.dcterms+a.localName,P:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Wc:null,scheme:null};return null});var l=cb(g,function(a){return a.Wc});g=d(cb(g,function(a){return a.Wc?null:a.name}));var k=null;g[sp]&&(k=g[sp][0].v);c(g);return g}function wp(){var a=window.MathJax;return a?a.Hub:null}var xp={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
...
function Cp(a,b){return cf("resolveFragment",function(c){if(b){var d=new sb;tb(d,b);var e;if(a.f){var f=ub(d,a.f.b);if(1!=f.ha.nodeType||f.L||!f.Xb){O(c,null);return}var g=f.ha,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.d[h]){O(c,null);return}e=a.d[h];d=f.Xb}else e=a.b[0];a.e.load(e.src).then(function(a){var b=ub(d,a.b);a=Eh(a,b.ha,b.offset,b.L);O(c,{G:e.G,na:a,R:-1})})}else O(c,null)},function(a,d){u.b(d,"Cannot resolve fragment:",b);O(a,null)})}
function Dp(a,b){return cf("resolveEPage",function(c){if(0>=b)O(c,{G:0,na:0,R:-1});else{var d=Za(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.e.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=Fh(a),g=Math.round(a*b/e.b),g==a&&g--);O(c,{G:d,na:g,R:-1})})}},function(a,d){u.b(d,"Cannot resolve epage:",b);O(a,null)})}
function Ep(a,b){var c=a.b[b.G];if(0>=b.na)return M(c.e);var d=L("getEPage");a.e.load(c.src).then(function(a){a=Fh(a);var f=Math.min(a,b.na);O(d,c.e+f*c.b/a)});return N(d)}function Fp(a,b,c,d,e){this.b=a;this.viewport=b;this.f=c;this.g=e;this.Hb=[];this.na=this.R=this.G=0;this.S=gc(d);this.e=new Cm(b.f)}function Gp(a){var b=a.Hb[a.G];return b?b.eb[a.R]:null}n=Fp.prototype;n.jb=function(){if(this.b.A)return this.b.A;var a=this.Hb[this.G];return a?a.Da.ea:null};
function Hp(a){var b=L("renderPage");Ip(a).then(function(c){if(c){var d=-1;if(0>a.R){var d=a.na,e=Za(c.Ha.length,function(a){return Ro(c.Da,c.Ha[a])>d});a.R=e==c.Ha.length?Number.POSITIVE_INFINITY:e-1}var f=c.eb[a.R];f?(a.na=f.offset,O(b,f)):uf(function(b){if(a.R<c.Ha.length)P(b);else if(c.complete)a.R=c.Ha.length-1,P(b);else{var e=c.Ha[c.Ha.length-1],l=Jp(a,c,e);Vo(c.Da,l,e).then(function(k){l.M.style.display="none";l.M.style.visibility="visible";l.M.setAttribute("data-vivliostyle-page-side",l.g);
k=(e=k)?e.d-1:c.Ha.length-1;a.g(c.Da.N,c.item.G,k);e?(c.eb[k]=l,c.Ha.push(e),0<=d&&Ro(c.Da,e)>d?(f=l,a.R=c.Ha.length-2,P(b)):(l.k=0==c.item.G&&0==k,wf(b))):(c.eb.push(l),f=l,a.R=k,0>d&&(a.na=l.offset),c.complete=!0,l.k=0==c.item.G&&0==k,l.l=c.item.G==a.b.b.length-1,P(b))})}}).then(function(){f=f||c.eb[a.R];var e=c.Ha[a.R];0>d&&(a.na=Ro(c.Da,e));if(f)O(b,f);else{var h=Jp(a,c,e);Vo(c.Da,h,e).then(function(d){h.M.style.display="none";h.M.style.visibility="visible";h.M.setAttribute("data-vivliostyle-page-side",
h.g);d=(e=d)?e.d-1:c.Ha.length-1;a.g(c.Da.N,c.item.G,d);e?(c.eb[d]=h,c.Ha[a.R+1]=e):(c.eb.push(h),c.complete=!0,h.l=c.item.G==a.b.b.length-1);h.k=0==c.item.G&&0==d;O(b,h)})}})}else O(b,null)});return N(b)}n.Xc=function(){return Kp(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};function Kp(a,b,c){var d=L("renderAllPages"),e=a.G,f=a.R;a.G=0;uf(function(d){a.R=a.G==b?c:Number.POSITIVE_INFINITY;Hp(a).then(function(){++a.G>b?P(d):wf(d)})}).then(function(){a.G=e;a.R=f;Hp(a).ra(d)});return N(d)}
n.Jd=function(){this.R=this.G=0;return Hp(this)};n.Kd=function(){this.G=this.b.b.length-1;this.R=Number.POSITIVE_INFINITY;return Hp(this)};n.nextPage=function(){var a=this,b=L("nextPage");Ip(a).then(function(c){if(c){if(c.complete&&a.R==c.Ha.length-1){if(a.G>=a.b.b.length-1){O(b,null);return}a.G++;a.R=0}else a.R++;Hp(a).ra(b)}else O(b,null)});return N(b)};n.Vc=function(){if(0==this.R){if(0==this.G)return M(null);this.G--;this.R=Number.POSITIVE_INFINITY}else this.R--;return Hp(this)};
function Lp(a,b){var c="left"===b.g,d="ltr"===a.jb();return!c&&d||c&&!d}function Mp(a){var b=L("getCurrentSpread"),c=Gp(a);if(!c)return M({left:null,right:null});var d=a.G,e=a.R,f="left"===c.g;(Lp(a,c)?a.Vc():a.nextPage()).then(function(g){a.G=d;a.R=e;Hp(a).then(function(){f?O(b,{left:c,right:g}):O(b,{left:g,right:c})})});return N(b)}n.Qd=function(){var a=Gp(this);if(!a)return M(null);var a=Lp(this,a),b=this.nextPage();if(a)return b;var c=this;return b.xc(function(){return c.nextPage()})};
n.Td=function(){var a=Gp(this);if(!a)return M(null);var a=Lp(this,a),b=this.Vc();if(a){var c=this;return b.xc(function(){return c.Vc()})}return b};function Np(a,b){var c=L("navigateToEPage");Dp(a.b,b).then(function(b){b&&(a.G=b.G,a.R=b.R,a.na=b.na);Hp(a).ra(c)});return N(c)}function Op(a,b){var c=L("navigateToCFI");Cp(a.b,b).then(function(b){b&&(a.G=b.G,a.R=b.R,a.na=b.na);Hp(a).ra(c)});return N(c)}
function Pp(a,b){u.debug("Navigate to",b);var c=yp(a.b,sa(b));if(null==c&&(a.b.f&&b.match(/^#epubcfi\(/)&&(c=yp(a.b,a.b.f.url)),null==c))return M(null);var d=a.b.h[c];if(!d)return a.b.f&&c==yp(a.b,a.b.f.url)&&(c=b.indexOf("#"),0<=c)?Op(a,b.substr(c+1)):M(null);d.G!=a.G&&(a.G=d.G,a.R=0);var e=L("navigateTo");Ip(a).then(function(c){var d=Ih(c.ba,b);d&&(a.na=Dh(c.ba,d),a.R=-1);Hp(a).ra(e)});return N(e)}
...
c.namespaceURI)e=Qp(c,d);else if("http://example.com/sse"==c.namespaceURI){e=d?d.ownerDocument:b.viewport.b;g=c.localName;switch(g){case "t":case "tab":case "ec":case "nt":case "fraction":case "comment":case "mark":g="span";break;case "ruby":case "rp":case "rt":break;default:g="div"}e=e.createElement(g);e.setAttribute("data-adapt-process-children","true");e=M(e)}else e=c.dataset&&"true"==c.dataset.Md?Qp(c,d):M(null);return e}};
...
Ko(m.k,k.Da.k);m.S=a.S;Qo(m).then(function(){b={item:c,ba:f,Da:m,Ha:[null],eb:[],complete:!1};a.Hb[a.G]=b;O(e,b)})});return N(e)}function Rp(a){return{G:a.G,R:a.R,na:a.na}}function Sp(a,b){b?(a.G=b.G,a.R=-1,a.na=b.na):(a.G=0,a.R=0,a.na=0);return Kp(a,a.G,a.R)}
n.oc=function(){var a=this.b,b=a.D||a.N;if(!b)return M(null);var c=L("showTOC");this.d||(this.d=new ep(a.e,b.src,a.lang,this.e,this.f,this.S,this,a.w));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";e.style.border=
"1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.d.oc(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";O(c,a)});return N(c)};n.lc=function(){this.d&&this.d.lc()};n.ld=function(){return this.d&&this.d.ld()};function Tp(a,b,c,d){var e=this;this.h=a;this.gb=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Qa=c;this.La=d;a=a.document;this.pa=new vh(a.head,b);this.H=[];this.g=null;this.F=this.d=!1;this.f=this.j=this.e=this.l=null;this.fontSize=16;this.zoom=1;this.ea=!1;this.Xc=!0;this.S=fc();this.D=function(){};this.k=function(){};this.$=function(){e.d=!0;e.D()};this.u=function(){};this.w=a.getElementById("vivliostyle-page-rules");this.N=
...
function eq(a){if(a.b){a.b.lc();for(var b=a.b.Hb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.eb,e;e=d.shift();)e=e.M,e.parentNode.removeChild(e)}}a.w&&(a.w.textContent="",a.N=!1);a.viewport=cq(a);b=a.viewport;w(b.e,"width","");w(b.e,"height","");w(b.d,"width","");w(b.d,"height","");w(b.d,"transform","");a.b=new Fp(a.g,a.viewport,a.pa,a.S,a.bb.bind(a))}
function fq(a,b){a.F=!1;if(a.S.Wa)return Mp(a.b).xc(function(c){Yp(a);a.j=c;c.left&&(Zp(a,c.left),c.right||c.left.M.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Zp(a,c.right),c.left||c.right.M.setAttribute("data-vivliostyle-unpaired-page",!0));c=gq(a,c);a.viewport.zoom(c.width,c.height,a.zoom);a.e=b;return M(null)});$p(a,b);a.viewport.zoom(b.d.width,b.d.height,a.zoom);a.e=b;return M(null)}
function gq(a,b){var c=0,d=0;b.left&&(c+=b.left.d.width,d=b.left.d.height);b.right&&(c+=b.right.d.width,d=Math.max(d,b.right.d.height));b.left&&b.right&&(c+=2*a.S.Gb);return{width:c,height:d}}var hq={de:"fit inside viewport"};
...
Tp.prototype.Ka=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.S.Wa?this.b.Qd:this.b.nextPage;break;case "previous":a=this.S.Wa?this.b.Td:this.b.Vc;break;case "last":a=this.b.Kd;break;case "first":a=this.b.Jd;break;default:return M(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return Np(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return Pp(b.b,d)}}else return M(!0);var e=L("nextPage");a.call(b.b).then(function(a){a?(b.f=
...
n.Dd=function(a){var b=Object.Qb({a:"configure"},lq(a));this.b.k(b);Object.Qb(this.e,a)};n.Id=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});gb(this.d,b)};n.Vd=function(a,b){this.d.addEventListener(a,b,!1)};n.Yd=function(a,b){this.d.removeEventListener(a,b,!1)};n.Ld=function(a,b,c){a||gb(this.d,{type:"error",content:"No URL specified"});nq(this,a,null,b,c)};n.Wd=function(a,b,c){a||gb(this.d,{type:"error",content:"No URL specified"});nq(this,null,a,b,c)};
...
n.Od=function(a){a:switch(a){case "left":a="ltr"===this.jb()?"previous":"next";break a;case "right":a="ltr"===this.jb()?"next":"previous";break a}this.b.k({a:"moveTo",where:a})};n.Nd=function(a){this.b.k({a:"moveTo",url:a})};n.Xd=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.S.Wa?gq(b,b.j):b.e.d;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ca("vivliostyle.viewer.Viewer",mq);mq.prototype.setOptions=mq.prototype.Dd;mq.prototype.addListener=mq.prototype.Vd;mq.prototype.removeListener=mq.prototype.Yd;mq.prototype.loadDocument=mq.prototype.Ld;mq.prototype.loadEPUB=mq.prototype.Wd;mq.prototype.getCurrentPageProgression=mq.prototype.jb;mq.prototype.navigateToPage=mq.prototype.Od;mq.prototype.navigateToInternalUrl=mq.prototype.Nd;mq.prototype.queryZoomFactor=mq.prototype.Xd;ca("vivliostyle.viewer.ZoomType",hq);hq.FIT_INSIDE_VIEWPORT="fit inside viewport";
...
function uq(a){switch(a.t){case "loaded":a=a.viewer;var b=pq=a.jb();a.gb.setAttribute("data-vivliostyle-page-progression",b);a.gb.setAttribute("data-vivliostyle-spread-view",a.S.Wa);window.addEventListener("keydown",tq,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",rq,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",sq,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
