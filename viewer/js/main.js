...
function Sk(a,b,c,d,e){var f;if(b&&b.K&&!b.d&&(f=rk(b,0,a.b),!isNaN(f)))return f;b=c[d];for(e-=b.da;;){f=rk(b,e,a.b);if(!isNaN(f))return f;if(0<e)e--;else{d--;if(0>d)return a.Qa;b=c[d];1!=b.b.nodeType&&(e=b.b.textContent.length)}}}function Tk(a){return"number"==typeof a?a:(a=a.match(/^(-?[0-9]*(\.[0-9]*)?)px$/))?parseFloat(a[0]):0}
function Uk(a,b){var c=a.mc.b.getComputedStyle(b,null),d=new ee;c&&(d.left=Tk(c.marginLeft),d.top=Tk(c.marginTop),d.right=Tk(c.marginRight),d.bottom=Tk(c.marginBottom));return d}
function Vk(a,b,c){if(a=a.mc.b.getComputedStyle(b,null))c.marginLeft=Tk(a.marginLeft),c.aa=Tk(a.borderLeftWidth),c.j=Tk(a.paddingLeft),c.marginTop=Tk(a.marginTop),c.ga=Tk(a.borderTopWidth),c.k=Tk(a.paddingTop),c.marginRight=Tk(a.marginRight),c.Fa=Tk(a.borderRightWidth),c.I=Tk(a.paddingRight),c.marginBottom=Tk(a.marginBottom),c.wa=Tk(a.borderBottomWidth),c.w=Tk(a.paddingBottom)}function Wk(a,b,c){b=new wk(b,c,c);a.g?a.g.push(b):a.g=[b]}
function Xk(a,b,c,d){if(a.g&&a.g[a.g.length-1].b)return Wk(a,b,c),M(!0);d+=40*(a.b?-1:1);var e=a.l,f=!e;if(f){var g=a.d.ownerDocument.createElement("div");u(g,"position","absolute");var k=a.h.clone(),e=new yk(g,k,a.mc);a.l=e;e.b=Yk(a.h,a.b,g);e.nc=!0;a.b?(e.left=0,u(e.d,"width","2em")):(e.top=a.jb,u(e.d,"height","2em"))}a.d.appendChild(e.d);Vk(a,e.d,e);g=(a.b?-1:1)*(d-a.Qa);a.b?e.height=a.f.P-a.f.T-Pj(e)-Qj(e):e.width=a.f.U-a.f.W-Rj(e)-Sj(e);d=(a.b?-1:1)*(a.jb-d)-(a.b?Rj(e)-Sj(e):Pj(e)+Qj(e));if(f&&
18>d)return a.d.removeChild(e.d),a.l=null,Wk(a,b,c),M(!0);if(!a.b&&e.top<g)return a.d.removeChild(e.d),Wk(a,b,c),M(!0);var h=L("layoutFootnoteInner");a.b?Vj(e,0,d):Uj(e,g,d);e.B=a.B+a.left+Rj(a);e.D=a.D+a.top+Pj(a);e.A=a.A;var l=new Kj(c);f?(Zk(e),f=M(!0)):0==e.A.length?($k(e),f=M(!0)):f=al(e);f.then(function(){bl(e,l).then(function(d){a.b?(a.na=a.jb+(e.e+Rj(e)+Sj(e)),Vj(e,0,e.e)):(a.na=a.jb-(e.e+Pj(e)+Qj(e)),Uj(e,a.na-a.Qa,e.e));var f;!a.b&&0<e.A.length?f=al(e):f=M(d);f.then(function(d){d=new wk(b,
...
1)*a.f.P);q=n;a.b&&(q=ue(n));ze(p,a.oc,q,e);a.b&&(n=new ce(-q.P,q.W,-q.T,q.U));u(d,"left",n.W-a.f.W+a.j+"px");u(d,"top",n.T-a.f.T+a.k+"px");n=a.b?n.W:n.P;Ak(a,n)&&0!=a.u.length?(b=b.modify(),b.e=!0,O(c,b)):(Nk(a),p=a.b?ue(a.f):a.f,Ae(p,a.oc,q,e),Ok(a),"left"==e?a.qc=n:a.rc=n,jl(a,n),O(c,l))}});return N(c)}
...
function sl(a,b,c){var d=L("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,k=a.u.length-1;0<=k&&!e;--k){var e=a.u[k].d(a,f),h=a.u[k].b();h>f&&(g=Math.min(g,h))}while(g>f&&!e);var l=!1;if(!e){w("Could not find any page breaks?!!");if(a.gd)return tl(a,b).then(function(b){b?(b=b.modify(),b.e=!1,ol(a,b,l,!0).then(function(){O(d,b)})):O(d,b)}),N(d);e=c;l=!0}ol(a,e,l,!0).then(function(){O(d,e)});return N(d)}
...
me(b,d,b+a.width,d+a.height);a.oc=we(c,[b],a.A,a.Ga,a.b);Ok(a);a.g=null}function Zk(a){a.Oa=[];u(a.d,"width",a.width+"px");u(a.d,"height",a.height+"px");$k(a);a.e=0;a.Sc=!1;a.M=null}function jl(a,b){a.e=Math.max((a.b?-1:1)*(b-a.Qa),a.e)}function zl(a,b){var c=b.b;if(!c)return M(!0);var d=L("layoutOverflownFootnotes"),e=0;af(function(){for(;e<c.length;){var b=c[e++],b=Xk(a,0,b,a.Qa);if(b.za())return b}return M(!1)}).then(function(){O(d,!0)});return N(d)}
function bl(a,b){a.Oa.push(b);if(a.Sc)return M(b);var c=L("layout");zl(a,b).then(function(){Ck(a,b.Sa).then(function(b){var e=b,f=!0;a.u=[];bf(function(c){for(;b;){var k=!0;yl(a,b,f).then(function(h){f=!1;b=h;0<a.h.g.b.length?Q(c):a.M?Q(c):b&&b.e?sl(a,b,e).then(function(a){b=a;Q(c)}):k?k=!1:df(c)});if(k){k=!1;return}}Q(c)}).then(function(){var e=a.l;e&&(a.d.appendChild(e.d),a.b?a.e=this.Qa-this.jb:a.e=e.top+Pj(e)+e.e+Qj(e));if(b)if(0<a.h.g.b.length)O(c,null);else{a.Sc=!0;e=new Kj(Jj(b));if(a.g){for(var f=
[],h=0;h<a.g.length;h++){var l=a.g[h].b;l&&f.push(l)}e.b=f.length?f:null}O(c,e)}else O(c,null)})})});return N(c)}function al(a){for(var b=a.Oa;a.d.lastChild!=a.Rc;)a.d.removeChild(a.d.lastChild);Nk(a);Zk(a);var c=L("redoLayout"),d=0,e=null;bf(function(c){if(d<b.length){var g=b[d++];bl(a,g).then(function(a){a?(e=a,Q(c)):df(c)})}else Q(c)}).then(function(){O(c,e)});return N(c)};var Al=1;function Bl(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.h=0;this.d=a;this.name=b;this.eb=c;this.ya=d;this.parent=e;this.g="p"+Al++;e&&(this.h=e.children.length,e.children.push(this))}Bl.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Bl.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Cl(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
...
function am(a,b,c){var d=Y(a,b,"right"),e=Y(a,b,"snap-height"),f=Y(a,b,"margin-right"),g=Y(a,b,"padding-right");b=Y(a,b,"border-right-width");u(c.d,"margin-right",f+"px");u(c.d,"padding-right",g+"px");u(c.d,"border-right-width",b+"px");c.marginRight=f;c.Fa=b;a.b&&0<e&&(a=d+Sj(c),a=a-Math.floor(a/e)*e,0<a&&(c.Sb=e-a,g+=c.Sb));c.I=g;c.Tb=e}
...
function em(a,b,c){u(c.d,"border-top-width","0px");var d=Y(a,b,"max-height");a.I?Uj(c,0,d):(bm(a,b,c),d-=c.qa,c.height=d,u(c.d,"height",d+"px"))}function fm(a,b,c){u(c.d,"border-left-width","0px");var d=Y(a,b,"max-width");a.D?Vj(c,0,d):(am(a,b,c),d-=c.Sb,c.width=d,a=Y(a,b,"right"),u(c.d,"right",a+"px"),u(c.d,"width",d+"px"))}
...
height:new J(17,"in")}},dn={width:Yd,height:Zd};function en(a){if((a=a.size)&&a.value!==ld){var b=a.value;b.od()?(a=b.values[0],b=b.values[1]):(a=b,b=null);return a.Fc()?{width:a,height:b||a}:(a=cn[a.name.toLowerCase()])?b&&b===Bd?{width:a.height,height:a.width}:{width:a.width,height:a.height}:dn}return dn}
...
d["padding-bottom"]=new K(c.marginBottom)};on.prototype.Cc=function(){var a=xn(this,{start:"left",end:"right",Y:"width"});this.rb=a.jd;this.marginLeft=a.rd;this.marginRight=a.qd};on.prototype.Dc=function(){var a=xn(this,{start:"top",end:"bottom",Y:"height"});this.qb=a.jd;this.marginTop=a.rd;this.marginBottom=a.qd};
...
$d;c["margin-"+f]=$d;c["padding-"+e]=new K(p);c["padding-"+f]=new K(q);c["border-"+e+"-width"]=new K(r);c["border-"+f+"-width"]=new K(v);c[g]=new K(h);c["max-"+g]=new K(h);return{jd:F(d,k,D(d,l,n)),rd:l,qd:n}}on.prototype.tb=function(a,b,c){Ml.prototype.tb.call(this,a,b,c);c.u=b.d};function pn(a,b){Ml.call(this,a,b);var c=b.l;this.j=gn[c];a.qa[c]=this;this.wa=!0}t(pn,Ml);m=pn.prototype;
...
m.Dc=function(){var a=this.e.j;this.j.ua?yn(this,{Ec:"bottom",Jc:"top",Y:"height"},a):this.j.ra?yn(this,{Ec:"top",Jc:"bottom",Y:"height"},a):this.ha({start:"top",end:"bottom",Y:"height"},a)};m.Yb=function(a,b,c,d,e,f){Ml.prototype.Yb.call(this,a,b,c,d,e,f);a=c.l;c=this.d.l;d=this.j;d.sa||d.ta?d.ua||d.ra||(d.sa?a.left[c]=b:d.ta&&(a.right[c]=b)):d.ua?a.top[c]=b:d.ra&&(a.bottom[c]=b)};
...
function Un(a,b,c){var d=a.b.b[c];if(!d)return M(!0);a.e[c]&&0<b.A.length&&(b.gd=!1);Zk(b);var e=L("layoutColumn"),f=[];bf(function(c){for(;0<d.b.length;){var e=0,h=d.b[e];if(h.b.b>a.h)break;for(var l=1;l<d.b.length;l++){var n=d.b[l];if(n.b.b>a.h)break;zj(n.b,h.b)&&(h=n,e=l)}var p=h.b,q=!0;bl(b,h.d).then(function(a){h.b.Hd&&(null===a||p.d)&&f.push(h);p.d?(d.b.splice(e,1),Q(c)):a?(h.d=a,Q(c)):(d.b.splice(e,1),q?q=!1:df(c))});if(q){q=!1;return}}Q(c)}).then(function(){0<f.length&&(d.b=f.concat(d.b));
O(e,!0)});return N(e)}
function Vn(a,b,c,d,e,f,g,k){var h=Yl(c,a,"enabled");if(h&&h!==Vd)return M(!0);var l=L("layoutContainer"),n=Yl(c,a,"wrap-flow")===ld,p=c.b?c.g&&c.D:c.f&&c.I,h=Yl(c,a,"flow-from"),q=a.viewport.b.createElement("div"),r=Yl(c,a,"position");u(q,"position",r?r.name:"absolute");d.insertBefore(q,d.firstChild);var v=new Oj(q);v.b=c.b;c.tb(a,v,b);v.B=e;v.D=f;e+=v.left+v.marginLeft+v.aa;f+=v.top+v.marginTop+v.ga;if(h&&h.nd())if(a.I[h.toString()])c.Yb(a,v,b,null,1,a.f),h=M(!0);else{var y=L("layoutContainer.inner"),
I=h.toString(),W=Y(c,a,"column-count"),P=Y(c,a,"column-gap"),E=1<W?Y(c,a,"column-width"):v.width,h=Xl(c,a),Ea=0,r=Yl(c,a,"shape-inside"),mb=ag(r,0,0,v.width,v.height,a),Pk=new Dm(I,a,a.viewport,a.d,h,a.$,a.na,a.style.u,a,b,a.Fa,a.Ga,k),yh=0,Z=null;bf(function(b){for(;yh<W;){var c=yh++;if(1<W){var d=a.viewport.b.createElement("div");u(d,"position","absolute");q.appendChild(d);Z=new yk(d,Pk,a.f);Z.b=v.b;Z.Ga=v.Ga;Z.Tb=v.Tb;v.b?(u(d,"margin-left",v.j+"px"),u(d,"margin-right",v.I+"px"),c=c*(E+P)+v.k,
Vj(Z,0,v.width),Uj(Z,c,E)):(u(d,"margin-top",v.k+"px"),u(d,"margin-bottom",v.w+"px"),c=c*(E+P)+v.j,Uj(Z,0,v.height),Vj(Z,c,E));Z.B=e+v.j;Z.D=f+v.k}else Z=new yk(q,Pk,a.f),Tj(Z,v),v=Z;Z.A=p?[]:g;Z.Rb=mb;if(0<=Z.width){var h=L("inner");Un(a,Z,I).then(function(){Z.M&&"column"!=Z.M&&(yh=W,"region"!=Z.M&&(a.I[I]=!0));O(h,!0)});c=N(h)}else c=M(!0);if(c.za()){c.then(function(){0<k.b.length?Q(b):(Ea=Math.max(Ea,Z.e),df(b))});return}0<k.b.length||(Ea=Math.max(Ea,Z.e))}Q(b)}).then(function(){v.e=Ea;c.Yb(a,
v,b,Z,W,a.f);O(y,!0)});h=N(y)}else{h=Yl(c,a,"content");r=!1;if(h&&Xj(h)){var Qk=a.viewport.b.createElement("span");h.S(new Wj(Qk,a));q.appendChild(Qk);km(c,a,v)}else c.wa&&(d.removeChild(q),r=!0);r||c.Yb(a,v,b,null,1,a.f);h=M(!0)}h.then(function(){if(!c.f||0<Math.floor(v.e)){if(!n){var h=v.B+v.left,p=v.D+v.top,r=Rj(v)+v.width+Sj(v),y=Pj(v)+v.height+Qj(v),E=Yl(c,a,"shape-outside"),h=ag(E,h,p,r,y,a);Ta(a.viewport.root)&&g.push(ke(h,0,-1.25*hc(a,"em",!1)));g.push(h)}}else if(0==c.children.length){d.removeChild(q);
...
function Bo(a,b,c){var d=new po;d.F=0;d.id="item1";d.src=b;a.d={item1:d};a.g={};a.g[b]=d;a.h=[d];a.b=a.h;c?(a=a.e,d=L("EPUBDocStore.load"),b=ca(b),(a.l[b]=bo(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,ac:null})).pa(d),c=N(d)):c=M(null);return c}function Co(a,b,c){var d=a.b[b],e=L("getCFI");a.e.load(d.src).then(function(a){var b=Pi(a,c),k=null;b&&(a=Ni(a,b,0,!1),k=new cb,gb(k,b,c-a),d.g&&gb(k,d.g,0),k=k.toString());O(e,k)});return N(e)}
...
m.Gd=function(){var a=Ho(this);if(!a)return M(null);var a=Mo(this,a),b=this.Lc();if(a){var c=this;return b.jc(function(){return c.Lc()})}return b};function Oo(a,b){var c=L("navigateToEPage");Eo(a.b,b).then(function(b){b&&(a.F=b.F,a.O=b.O,a.la=b.la);Io(a).pa(c)});return N(c)}function Po(a,b){var c=L("navigateToCFI");Do(a.b,b).then(function(b){b&&(a.F=b.F,a.O=b.O,a.la=b.la);Io(a).pa(c)});return N(c)}
...
m.bc=function(){var a=this.b,b=a.B||a.M;if(!b)return M(null);var c=L("showTOC");this.d||(this.d=new go(a.e,b.src,a.lang,this.e,this.f,this.R,this,a.w));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";e.style.border=
...
moveTo:this.Fa,toc:this.bc}}function Vo(a,b){b.i=a.Oa;a.Ga(b)}
...
function ep(a){if(a.b){a.b.Zb();for(var b=a.b.ub,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.Za,e;e=d.shift();)e=e.L,e.parentNode.removeChild(e)}}a.viewport=cp(a);b=a.viewport.e;u(b,"width","");u(b,"height","");a.b=new Go(a.g,a.viewport,a.na,a.R)}
function fp(a,b){a.I=!1;if(a.R.Xa)return No(a.b).jc(function(c){Yo(a);a.k=c;c.left&&(Zo(a,c.left),c.right||c.left.L.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Zo(a,c.right),c.left||c.right.L.setAttribute("data-vivliostyle-unpaired-page",!0));var d=gp(a,c);Sm(a.viewport,d.width*a.h,d.height*a.h);c.left&&wj(c.left,a.h);c.right&&wj(c.right,a.h);a.e=b;return M(null)});$o(a,b);hp(a,b);a.e=b;return M(null)}function hp(a,b){Sm(a.viewport,b.b.width*a.h,b.b.height*a.h);wj(b,a.h)}
...
null,fp(b,a).then(function(){ap(b).pa(e)})):O(e,!0)});return N(e)};Uo.prototype.bc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.ad();if(c){if("show"==a)return M(!0)}else if("hide"==a)return M(!0);if(c)return this.b.Zb(),M(!0);var d=this,e=L("showTOC");this.b.bc(b).then(function(a){if(a){if(b){var c=function(){d.b.Zb()};a.addEventListener("hyperlink",c,!1);a.L.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.w,!1)}O(e,!0)});return N(e)};
