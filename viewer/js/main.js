...
m.ka=function(a,b){10<b&&a.append("(");a.append(this.Vc());this.d.ka(a,10);10<b&&a.append(")")};m.Ba=function(a,b){var c=this.d.Ba(a,b);return c===this.d?this:new this.constructor(this.b,c)};function C(a,b,c){B.call(this,a);this.d=b;this.e=c}t(C,B);m=C.prototype;m.Ub=function(){throw Error("F_ABSTRACT");};m.Aa=function(){throw Error("F_ABSTRACT");};m.Ra=function(){throw Error("F_ABSTRACT");};m.Ha=function(a){var b=this.d.evaluate(a);a=this.e.evaluate(a);return this.Ra(b,a)};
m.kb=function(a,b,c){return a===this||lc(this.d,a,b,c)||lc(this.e,a,b,c)};m.ka=function(a,b){var c=this.Ub();c<=b&&a.append("(");this.d.ka(a,c);a.append(this.Aa());this.e.ka(a,c);c<=b&&a.append(")")};m.Ba=function(a,b){var c=this.d.Ba(a,b),d=this.e.Ba(a,b);return c===this.d&&d===this.e?this:new this.constructor(this.b,c,d)};function nc(a,b,c){C.call(this,a,b,c)}t(nc,C);nc.prototype.Ub=function(){return 1};function oc(a,b,c){C.call(this,a,b,c)}t(oc,C);oc.prototype.Ub=function(){return 2};
function pc(a,b,c){C.call(this,a,b,c)}t(pc,C);pc.prototype.Ub=function(){return 3};function qc(a,b,c){C.call(this,a,b,c)}t(qc,C);qc.prototype.Ub=function(){return 4};function rc(a,b){mc.call(this,a,b)}t(rc,mc);rc.prototype.Vc=function(){return"!"};rc.prototype.Xc=function(a){return!a};function sc(a,b){mc.call(this,a,b)}t(sc,mc);sc.prototype.Vc=function(){return"-"};sc.prototype.Xc=function(a){return-a};function tc(a,b,c){C.call(this,a,b,c)}t(tc,nc);tc.prototype.Aa=function(){return"&&"};
...
m.lc=function(){throw Error("E_CSS_COLOR_NOT_ALLOWED");};m.Pb=function(){throw Error("E_CSS_URL_NOT_ALLOWED");};m.Ya=function(){throw Error("E_CSS_LIST_NOT_ALLOWED");};m.nb=function(){throw Error("E_CSS_COMMA_NOT_ALLOWED");};m.ob=function(){throw Error("E_CSS_FUNC_NOT_ALLOWED");};m.xb=function(){throw Error("E_CSS_EXPR_NOT_ALLOWED");};function Uc(){}t(Uc,Tc);m=Uc.prototype;
m.ib=function(a){for(var b=null,c=0;c<a.length;c++){var d=a[c],e=d.S(this);if(b)b[c]=e;else if(d!==e){b=Array(a.length);for(d=0;d<c;d++)b[d]=a[d];b[c]=e}}return b||a};m.Ob=function(a){return a};m.hb=function(a){return a};m.Qc=function(a){return a};m.Ab=function(a){return a};m.zb=function(a){return a};m.yb=function(a){return a};m.lc=function(a){return a};m.Pb=function(a){return a};m.Ya=function(a){var b=this.ib(a.values);return b===a.values?a:new Vc(b)};
...
m.nd=function(){return!1};m.od=function(){return!1};function Zc(){if(G)throw Error("E_INVALID_CALL");}t(Zc,Yc);Zc.prototype.fa=function(a){return new $b(a,"")};Zc.prototype.xa=function(){};Zc.prototype.S=function(a){return a.Pc(this)};var G=new Zc;function $c(){if(ad)throw Error("E_INVALID_CALL");}t($c,Yc);$c.prototype.fa=function(a){return new $b(a,"/")};$c.prototype.xa=function(a){a.append("/")};$c.prototype.S=function(a){return a.Qc(this)};var ad=new $c;function bd(a){this.b=a}t(bd,Yc);
bd.prototype.fa=function(a){return new $b(a,this.b)};bd.prototype.xa=function(a,b){b?(a.append('"'),a.append(Da(this.b)),a.append('"')):a.append(this.b)};bd.prototype.S=function(a){return a.Ob(this)};function cd(a){this.name=a;if(Sc[a])throw Error("E_INVALID_CALL");Sc[a]=this}t(cd,Yc);cd.prototype.fa=function(a){return new $b(a,this.name)};cd.prototype.xa=function(a,b){b?a.append(Ca(this.name)):a.append(this.name)};cd.prototype.S=function(a){return a.hb(this)};cd.prototype.nd=function(){return!0};
...
function Le(a,b,c){var d=b.frameTrace;if(!d){for(var d=b.stack?b.stack+"\n\t---- async ---\n":"",e=a.top;e;e=e.parent)d+="\t",d+=e.name,d+="\n";b.frameTrace=d}if(c){for(d=a.top;d&&d!=c;)d=d.parent;d==c&&(a.top=d)}for(a.b=b;a.top&&!a.top.g;)a.top=a.top.parent;a.top?(b=a.b,a.b=null,a.top.g(a.top,b)):a.b&&Qe("Unhandled exception in task "+a.name,a.b)}function Je(a){this.value=a}m=Je.prototype;m.then=function(a){a(this.value)};m.jc=function(a){return a(this.value)};m.ed=function(a){return new Je(a)};
m.pa=function(a){O(a,this.value)};m.za=function(){return!1};m.Vb=function(){return this.value};function Ye(a){this.b=a}m=Ye.prototype;m.then=function(a){this.b.then(a)};m.jc=function(a){if(this.za()){var b=new He(this.b.d,this.b.parent,"AsyncResult.thenAsync");b.b=Ie;this.b.parent=b;this.b.then(function(c){a(c).then(function(a){O(b,a)})});return N(b)}return a(this.b.e)};m.ed=function(a){return this.za()?this.jc(function(){return new Je(a)}):new Je(a)};
m.pa=function(a){this.za()?this.then(function(b){O(a,b)}):O(a,this.b.e)};m.za=function(){return this.b.b==Ie};m.Vb=function(){if(this.za())throw Error("Result is pending");return this.b.e};function He(a,b,c){this.d=a;this.parent=b;this.name=c;this.e=null;this.b=0;this.g=this.f=null}function Ze(a){if(!Fe)throw Error("F_TASK_NO_CONTEXT");if(a!==Fe.top)throw Error("F_TASK_NOT_TOP_FRAME");}function N(a){return new Ye(a)}
...
function $e(){var a=L("Frame.timeSlice"),b=a.d.d;b.e.currentTime()>=b.h?(w("-- time slice --"),Ve(a).Wa(!0)):O(a,!0);return N(a)}function af(a){function b(d){try{for(;d;){var e=a();if(e.za()){e.then(b);return}e.then(function(a){d=a})}O(c,!0)}catch(f){Le(c.d,f,c)}}var c=L("Frame.loop");b(!0);return N(c)}function bf(a){var b=Fe;if(!b)throw Error("E_TASK_NO_CONTEXT");return af(function(){var c;do c=new cf(b,b.top),b.top=c,c.b=Ie,a(c),c=N(c);while(!c.za()&&c.Vb());return c})}
function Ve(a,b){Ze(a);if(a.d.e)throw Error("E_TASK_ALREADY_SUSPENDED");var c=new We(a.d);a.d.e=c;Fe=null;a.d.j=b||null;return c}function cf(a,b){He.call(this,a,b,"loop")}t(cf,He);function df(a){O(a,!0)}function Q(a){O(a,!1)};function ef(a,b,c,d,e){var f=L("ajax"),g=new XMLHttpRequest,k=Ve(f,g),h={status:0,url:a,contentType:null,responseText:null,responseXML:null,ac:null};g.open(c||"GET",a,!0);b&&(g.responseType=b);g.onreadystatechange=function(){if(4===g.readyState){h.status=g.status;if(200==h.status||0==h.status)if(b&&"document"!==b||!g.responseXML){var c=g.response;b&&"text"!==b||"string"!=typeof c?c?"string"==typeof c?h.ac=ff([c]):h.ac=c:w("Unexpected empty success response for "+a):h.responseText=c;if(c=g.getResponseHeader("Content-Type"))h.contentType=
...
function gf(a){var b=L("readBlob"),c=new FileReader,d=Ve(b,c);c.addEventListener("load",function(){d.Wa(c.result)},!1);c.readAsArrayBuffer(a);return N(b)}function hf(a,b){this.I=a;this.type=b;this.g={};this.e={}}hf.prototype.load=function(a){a=ca(a);var b=this.g[a];return"undefined"!=typeof b?M(b):jf(this.Xb(a))};function kf(a,b){var c=L("fetch");ef(b,a.type).then(function(d){a.I(d,a).then(function(d){delete a.e[b];a.g[b]=d;O(c,d)})});return N(c)}
hf.prototype.Xb=function(a){a=ca(a);if(this.g[a])return null;var b=this.e[a];if(!b){var c=this,b=new lf(function(){return kf(c,a)},"Fetch "+a);c.e[a]=b;b.start()}return b};function mf(a){a=a.responseText;return M(a?JSON.parse(a):null)};function nf(a){var b=parseInt(a,16);if(isNaN(b))throw Error("E_CSS_COLOR");if(6==a.length)return new fd(b);if(3==a.length)return new fd(b&15|(b&15)<<4|(b&240)<<4|(b&240)<<8|(b&3840)<<8|(b&3840)<<12);throw Error("E_CSS_COLOR");}function of(a){this.e=a;this.Va="Author"}m=of.prototype;m.Db=function(){return null};m.V=function(){return this.e};m.Q=function(){};m.wb=function(a){this.Va=a};m.$a=function(){};m.vc=function(){};m.Hb=function(){};m.Ib=function(){};m.Bc=function(){};m.Wb=function(){};m.bb=function(){};
m.uc=function(){};m.sc=function(){};m.yc=function(){};m.Hc=function(){};m.gb=function(){};m.ec=function(){};m.Kb=function(){};m.ic=function(){};m.cc=function(){};m.hc=function(){};m.vb=function(){};m.Oc=function(){};m.mb=function(){};m.dc=function(){};m.gc=function(){};m.fc=function(){};m.Mb=function(){};m.Lb=function(){};m.ma=function(){};m.Ka=function(){};m.Ua=function(){};function pf(a){switch(a.Va){case "UA":return 0;case "User":return 100663296;default:return 83886080}}
...
m.Hb=function(a,b){this.b.Hb(a,b)};m.Ib=function(a,b){this.b.Ib(a,b)};m.Bc=function(a){this.b.Bc(a)};m.Wb=function(a,b,c,d){this.b.Wb(a,b,c,d)};m.bb=function(){this.b.bb()};m.uc=function(){this.b.uc()};m.sc=function(){this.b.sc()};m.yc=function(){this.b.yc()};m.Hc=function(){this.b.Hc()};m.gb=function(){this.b.gb()};m.ec=function(){this.b.ec()};m.Kb=function(a){this.b.Kb(a)};m.ic=function(){this.b.ic()};m.cc=function(){this.b.cc()};m.hc=function(){this.b.hc()};m.vb=function(){this.b.vb()};m.Oc=function(a){this.b.Oc(a)};
m.mb=function(a){this.b.mb(a)};m.dc=function(a){this.b.dc(a)};m.gc=function(){this.b.gc()};m.fc=function(a,b,c){this.b.fc(a,b,c)};m.Mb=function(a,b,c){this.b.Mb(a,b,c)};m.Lb=function(a,b,c){this.b.Lb(a,b,c)};m.ma=function(){this.b.ma()};m.Ka=function(a,b,c){this.b.Ka(a,b,c)};m.Ua=function(){this.b.Ua()};function tf(a,b,c){of.call(this,a);this.I=c;this.D=0;this.Z=b}t(tf,of);tf.prototype.Db=function(){return this.Z.Db()};tf.prototype.Q=function(a){w(a)};tf.prototype.ma=function(){this.D++};
tf.prototype.Ua=function(){if(0==--this.D&&!this.I){var a=this.Z;a.b=a.d.pop()}};function uf(a,b,c){tf.call(this,a,b,c)}t(uf,tf);function vf(a,b){a.Q(b,a.Db())}function wf(a,b){vf(a,b);sf(a.Z,new tf(a.e,a.Z,!1))}m=uf.prototype;m.gb=function(){wf(this,"E_CSS_UNEXPECTED_SELECTOR")};m.ec=function(){wf(this,"E_CSS_UNEXPECTED_FONT_FACE")};m.Kb=function(){wf(this,"E_CSS_UNEXPECTED_FOOTNOTE")};m.ic=function(){wf(this,"E_CSS_UNEXPECTED_VIEWPORT")};m.cc=function(){wf(this,"E_CSS_UNEXPECTED_DEFINE")};
m.hc=function(){wf(this,"E_CSS_UNEXPECTED_REGION")};m.vb=function(){wf(this,"E_CSS_UNEXPECTED_PAGE")};m.mb=function(){wf(this,"E_CSS_UNEXPECTED_WHEN")};m.dc=function(){wf(this,"E_CSS_UNEXPECTED_FLOW")};m.gc=function(){wf(this,"E_CSS_UNEXPECTED_PAGE_TEMPLATE")};m.fc=function(){wf(this,"E_CSS_UNEXPECTED_PAGE_MASTER")};m.Mb=function(){wf(this,"E_CSS_UNEXPECTED_PARTITION")};m.Lb=function(){wf(this,"E_CSS_UNEXPECTED_PARTITION_GROUP")};m.Ka=function(){this.Q("E_CSS_UNEXPECTED_PROPERTY",this.Db())};
...
h=x(g);if(1!=h.type){a.b=Ff;f.Q("E_CSS_ATTR_NAME_EXPECTED",h);continue}l=h.text;A(g);h=x(g)}else n="";switch(h.type){case 39:case 45:case 44:case 46:case 50:p=h.type;A(g);h=x(g);break;case 15:f.Wb(n,l,0,null);a.b=R;A(g);continue;default:a.b=Ff;f.Q("E_CSS_ATTR_OP_EXPECTED",h);continue}switch(h.type){case 1:case 2:f.Wb(n,l,p,h.text);A(g);h=x(g);break;default:a.b=Ff;f.Q("E_CSS_ATTR_VAL_EXPECTED",h);continue}if(15!=h.type){a.b=Ff;f.Q("E_CSS_ATTR",h);continue}a.b=R;A(g);continue;case 11:f.uc();a.b=zf;
...
function cg(a,b){var c=new bg(b);try{a.S(c)}catch(d){w("toCounters: "+d)}return c.b};function lf(a,b){this.Xb=a;this.name=b;this.d=!1;this.e=this.b=this.f=null}lf.prototype.start=function(){if(!this.b){var a=this;this.b=Ne(Fe.d,function(){var b=L("Fetcher.run");a.Xb().then(function(c){var d=a.e;a.d=!0;a.f=c;a.b=null;a.e=null;if(d)for(var e=0;e<d.length;e++)try{d[e](c)}catch(f){w("Error: "+f)}O(b,c)});return N(b)},this.name)}};function dg(a,b){a.d?b(a.f):a.e.push(b)}function jf(a){if(a.d)return M(a.f);a.start();return a.b.join()}
function eg(a){if(0==a.length)return M(!0);if(1==a.length)return jf(a[0]).ed(!0);var b=L("waitForFetches"),c=0;af(function(){for(;c<a.length;){var b=a[c++];if(!b.d)return jf(b).ed(!0)}return M(!1)}).then(function(){O(b,!0)});return N(b)}
...
var bh=ah({before:"right",after:"left",start:"top",end:"bottom"}),ch=ah({before:"top",after:"bottom",start:"left",end:"right"});function U(a,b){this.value=a;this.Ea=b}m=U.prototype;m.kd=function(){return this};m.xc=function(a){a=this.value.S(a);return a===this.value?this:new U(a,this.Ea)};m.ld=function(a){return 0==a?this:new U(this.value,this.Ea+a)};m.evaluate=function(a,b){return Wf(a,this.value,b)};m.hd=function(){return!0};function dh(a,b,c){U.call(this,a,b);this.J=c}t(dh,U);
dh.prototype.kd=function(){return new U(this.value,this.Ea)};dh.prototype.xc=function(a){a=this.value.S(a);return a===this.value?this:new dh(a,this.Ea,this.J)};dh.prototype.ld=function(a){return 0==a?this:new dh(this.value,this.Ea+a,this.J)};dh.prototype.hd=function(a){return!!this.J.evaluate(a)};function eh(a,b,c){return(null==b||c.Ea>b.Ea)&&c.hd(a)?c.kd():b}var fh={"region-id":!0};function gh(a){return"_"!=a.charAt(0)&&!fh[a]}function hh(a,b,c){c?a[b]=c:delete a[b]}
function ih(a,b){var c=a[b];c||(c={},a[b]=c);return c}function jh(a,b){var c=a[b];c||(c=[],a[b]=c);return c}function kh(a,b,c,d,e,f){if(e){var g=ih(b,"_pseudos");b=g[e];b||(b={},g[e]=b)}f&&(e=ih(b,"_regions"),b=e[f],b||(b={},e[f]=b));for(var k in c)"_"!=k.charAt(0)&&(fh[k]?(f=c[k],e=jh(b,k),Array.prototype.push.apply(e,f)):hh(b,k,eh(a,b[k],c[k].ld(d))))}function lh(a,b){this.e=a;this.d=b;this.b=""}t(lh,Uc);
...
Uh={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},Vh={Zd:!1,Bb:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",$b:"\u5341\u767e\u5343",Cd:"\u8ca0"};
function Wh(a){if(9999<a||-9999>a)return""+a;if(0==a)return Vh.Bb.charAt(0);var b=new Aa;0>a&&(b.append(Vh.Cd),a=-a);if(10>a)b.append(Vh.Bb.charAt(a));else if(Vh.$d&&19>=a)b.append(Vh.$b.charAt(0)),0!=a&&b.append(Vh.$b.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(Vh.Bb.charAt(c)),b.append(Vh.$b.charAt(2)));if(c=Math.floor(a/100)%10)b.append(Vh.Bb.charAt(c)),b.append(Vh.$b.charAt(1));if(c=Math.floor(a/10)%10)b.append(Vh.Bb.charAt(c)),b.append(Vh.$b.charAt(0));(a%=10)&&b.append(Vh.Bb.charAt(a))}return b.toString()}
...
Nj.prototype.clone=function(){var a=new Nj;a.d=this.d;a.f=this.f;a.e=this.e;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b].clone();return a};function Oj(a){this.d=a;this.D=this.B=this.height=this.width=this.w=this.k=this.I=this.j=this.wa=this.ga=this.Fa=this.aa=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.Rb=this.A=null;this.qa=this.Sb=this.Ga=this.Tb=this.e=0;this.b=!1}function Pj(a){return a.marginTop+a.ga+a.k}
function Qj(a){return a.marginBottom+a.wa+a.w}function Rj(a){return a.marginLeft+a.aa+a.j}function Sj(a){return a.marginRight+a.Fa+a.I}function Tj(a,b){a.d=b.d;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.aa=b.aa;a.Fa=b.Fa;a.ga=b.ga;a.wa=b.wa;a.j=b.j;a.I=b.I;a.k=b.k;a.w=b.w;a.width=b.width;a.height=b.height;a.B=b.B;a.D=b.D;a.Rb=b.Rb;a.A=b.A;a.e=b.e;a.Tb=b.Tb;a.Ga=b.Ga;a.b=b.b}
...
function yk(a,b,c){Oj.call(this,a);this.Rc=a.lastChild;this.h=b;this.mc=c;this.vd=a.ownerDocument;this.nc=!1;this.na=this.jb=this.Qa=this.Tc=0;this.oc=this.Oa=this.l=this.f=null;this.Sc=!1;this.M=this.g=this.u=null;this.gd=!0;this.rc=this.qc=0}t(yk,Oj);yk.prototype.clone=function(){var a=new yk(this.d,this.h,this.mc);Tj(a,this);a.Rc=this.Rc;a.nc=this.nc;a.l=this.l?this.l.clone():null;a.Oa=this.Oa.concat();return a};
...
function Nk(a){for(var b=a.d.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.d.removeChild(b);else break}b=c}}function Ok(a){for(var b=a.d.firstChild,c=a.oc,d=a.b?a.f.T:a.f.W,e=a.b?a.f.P:a.f.U,f=0;f<c.length;f++){var g=c[f],k=g.P-g.T;g.left=Mk(a,b,"left",g.W-d,k);g.right=Mk(a,b,"right",e-g.U,k)}}
function Rk(a,b,c,d,e){var f;if(b&&b.K&&!b.d&&(f=rk(b,0,a.b),!isNaN(f)))return f;b=c[d];for(e-=b.da;;){f=rk(b,e,a.b);if(!isNaN(f))return f;if(0<e)e--;else{d--;if(0>d)return a.Qa;b=c[d];1!=b.b.nodeType&&(e=b.b.textContent.length)}}}function Sk(a){return"number"==typeof a?a:(a=a.match(/^(-?[0-9]*(\.[0-9]*)?)px$/))?parseFloat(a[0]):0}
function Tk(a,b){var c=a.mc.b.getComputedStyle(b,null),d=new ee;c&&(d.left=Sk(c.marginLeft),d.top=Sk(c.marginTop),d.right=Sk(c.marginRight),d.bottom=Sk(c.marginBottom));return d}
function Uk(a,b,c){if(a=a.mc.b.getComputedStyle(b,null))c.marginLeft=Sk(a.marginLeft),c.aa=Sk(a.borderLeftWidth),c.j=Sk(a.paddingLeft),c.marginTop=Sk(a.marginTop),c.ga=Sk(a.borderTopWidth),c.k=Sk(a.paddingTop),c.marginRight=Sk(a.marginRight),c.Fa=Sk(a.borderRightWidth),c.I=Sk(a.paddingRight),c.marginBottom=Sk(a.marginBottom),c.wa=Sk(a.borderBottomWidth),c.w=Sk(a.paddingBottom)}function Vk(a,b,c){b=new wk(b,c,c);a.g?a.g.push(b):a.g=[b]}
function Wk(a,b,c,d){if(a.g&&a.g[a.g.length-1].b)return Vk(a,b,c),M(!0);d+=40*(a.b?-1:1);var e=a.l,f=!e;if(f){var g=a.d.ownerDocument.createElement("div");u(g,"position","absolute");var k=a.h.clone(),e=new yk(g,k,a.mc);a.l=e;e.b=Xk(a.h,a.b,g);e.nc=!0;a.b?(e.left=0,u(e.d,"width","2em")):(e.top=a.jb,u(e.d,"height","2em"))}a.d.appendChild(e.d);Uk(a,e.d,e);g=(a.b?-1:1)*(d-a.Qa);a.b?e.height=a.f.P-a.f.T-Pj(e)-Qj(e):e.width=a.f.U-a.f.W-Rj(e)-Sj(e);d=(a.b?-1:1)*(a.jb-d)-(a.b?Rj(e)-Sj(e):Pj(e)+Qj(e));if(f&&
18>d)return a.d.removeChild(e.d),a.l=null,Vk(a,b,c),M(!0);if(!a.b&&e.top<g)return a.d.removeChild(e.d),Vk(a,b,c),M(!0);var h=L("layoutFootnoteInner");a.b?Vj(e,0,d):Uj(e,g,d);e.B=a.B+a.left+Rj(a);e.D=a.D+a.top+Pj(a);e.A=a.A;var l=new Kj(c);f?(Yk(e),f=M(!0)):0==e.A.length?(Zk(e),f=M(!0)):f=$k(e);f.then(function(){al(e,l).then(function(d){a.b?(a.na=a.jb+(e.e+Rj(e)+Sj(e)),Vj(e,0,e.e)):(a.na=a.jb-(e.e+Pj(e)+Qj(e)),Uj(e,a.na-a.Qa,e.e));var f;!a.b&&0<e.A.length?f=$k(e):f=M(d);f.then(function(d){d=new wk(b,
c,d?d.Sa:null);a.g?a.g.push(d):a.g=[d];O(h,!0)})})});return N(h)}
function bl(a,b){var c=L("layoutFootnote"),d=b.b;d.setAttribute("style","");u(d,"display","inline-block");d.textContent="M";var e=d.getBoundingClientRect(),f=a.b?e.left:e.bottom;d.textContent="";cl(a.h,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d={ia:[{ea:b.X,La:0,ca:b.ca,va:null,oa:null}],ba:0,K:!1};e=b.da;b=b.modify();b.K=!0;Wk(a,e,d,f).then(function(){a.l&&a.l.d.parentNode&&a.d.removeChild(a.l.d);Ak(a,f)&&0!=a.u.length&&(b.e=!0);O(c,b)});return N(c)}
function dl(a,b){var c=L("layoutFloat"),d=b.b,e=b.j,f=b.M,g=b.parent?b.parent.D:"ltr",k=a.h.g,h=b.b.parentNode;"page"===f?el(k,d,e):(u(d,"float","none"),u(d,"position","absolute"),u(d,"left","auto"),u(d,"right","auto"),u(d,"top","auto"));Lk(a,b).then(function(l){var n=zk(a,d),p=Tk(a,d),n=new ce(n.left-p.left,n.top-p.top,n.right+p.right,n.bottom+p.bottom);if("page"===f)fl(k,b,a.h)?(n=h.ownerDocument.createElement("span"),u(n,"width","0"),u(n,"height","0"),h.appendChild(n),l.b=n,O(c,l)):gl(k,b,n).then(function(){O(c,
...
1)*a.f.P);q=n;a.b&&(q=ue(n));ze(p,a.oc,q,e);a.b&&(n=new ce(-q.P,q.W,-q.T,q.U));u(d,"left",n.W-a.f.W+a.j+"px");u(d,"top",n.T-a.f.T+a.k+"px");n=a.b?n.W:n.P;Ak(a,n)&&0!=a.u.length?(b=b.modify(),b.e=!0,O(c,b)):(Nk(a),p=a.b?ue(a.f):a.f,Ae(p,a.oc,q,e),Ok(a),"left"==e?a.qc=n:a.rc=n,il(a,n),O(c,l))}});return N(c)}
...
"1"))}}function kl(a,b,c,d){var e=L("processLineStyling");xk(d);var f=d.concat([]);d.splice(0,d.length);var g=0,k=b.f;0==k.count&&(k=k.Fd);bf(function(d){if(k){var e=ll(a,f),n=k.count-g;if(e.length<=n)Q(d);else{var p=ml(a,f,e[n-1]);nl(a,p,!1,!1).then(function(){g+=n;Hk(a.h,p,0).then(function(e){b=e;jl(b,!1);k=b.f;f=[];Ik(a,b,f).then(function(b){c=b;0<a.h.g.b.length?Q(d):df(d)})})})}}else Q(d)}).then(function(){Array.prototype.push.apply(d,f);xk(d);O(e,c)});return N(e)}
...
function ql(a,b){if(!a.g)return M(!0);for(var c=!1,d=a.g.length-1;0<=d;--d){var e=a.g[d];if(e.da<=b)break;a.g.pop();e.b!==e.d&&(c=!0)}if(!c)return M(!0);var f=L("clearFootnotes"),g=a.e+a.Qa,k=a.g;a.l=null;a.g=null;var h=0;af(function(){for(;h<k.length;){var b=k[h++],b=Wk(a,b.da,b.d,g);if(b.za())return b}return M(!1)}).then(function(){O(f,!0)});return N(f)}
function uk(a,b,c){var d=b.e,e;if(c)e=c=1;else{for(e=d[0];e.parent&&e.d;)e=e.parent;c=Math.max((e.l.widows||1)-0,1);e=Math.max((e.l.orphans||1)-0,1)}var f=ll(a,d),g=a.na,d=Ja(f.length,function(b){return a.b?f[b]<g:f[b]>g}),d=Math.min(f.length-c,d);if(d<e)return null;g=f[d-1];if(b=ml(a,b.e,g))a.e=(a.b?-1:1)*(g-a.Qa);return b}
...
function rl(a,b,c){var d=L("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,k=a.u.length-1;0<=k&&!e;--k){var e=a.u[k].d(a,f),h=a.u[k].b();h>f&&(g=Math.min(g,h))}while(g>f&&!e);var l=!1;if(!e){w("Could not find any page breaks?!!");if(a.gd)return sl(a,b).then(function(b){b?(b=b.modify(),b.e=!1,nl(a,b,l,!0).then(function(){O(d,b)})):O(d,b)}),N(d);e=c;l=!0}nl(a,e,l,!0).then(function(){O(d,e)});return N(d)}
...
Q(c);return}g=[f];f=e=null}}else{if((e=pk(b.u,e))&&"avoid"!=e&&"auto"!=e){Q(c);a.M=e;return}if(qk[b.b.localName]){ul(a,f,null,!0,e)&&(b=(f||b).modify(),b.e=!0);Q(c);return}if(d&&(!tl(d.paddingTop)||!tl(d.borderTopWidth))){if(ul(a,f,null,!0,e)){b=(f||b).modify();b.e=!0;Q(c);return}f=e=null;g=[]}}}}while(0);d=Jk(a.h,b);if(d.za()){d.then(function(a){b=a;df(c)});return}b=d.Vb()}0!=a.u.length&&ul(a,f,g,!1,e)&&f&&(b=f.modify(),b.e=!0);Q(c)}).then(function(){O(d,b)});return N(d)}
function sl(a,b){var c=b,d=L("skipEdges"),e=null;bf(function(d){for(;b;){do if(b.b){if(b.d&&1!=b.b.nodeType){if(xj(b.b,b.A))break;if(!b.K){Q(d);return}}if(!b.K&&b.j){Q(d);return}if(1==b.b.nodeType){var g=b.b.style;if(b.K)e=pk(b.B,e);else{if((e=pk(b.u,e))&&"avoid"!=e&&"auto"!=e){Q(d);a.M=e;return}if(qk[b.b.localName]){Q(d);return}if(g&&(!tl(g.paddingTop)||!tl(g.borderTopWidth))){Q(d);return}}}}while(0);g=Jk(a.h,b);if(g.za()){g.then(function(a){b=a;df(d)});return}b=g.Vb()}c=null;Q(d)}).then(function(){O(d,
c)});return N(d)}function Kk(a,b){return"footnote"==b.j?bl(a,b):dl(a,b)}function xl(a,b,c){var d=L("layoutNext");wl(a,b,c).then(function(c){b=c;if(!b||a.M||b.e)O(d,b);else if(b.j)Kk(a,b).pa(d);else{a:{if(!b.K)switch(b.X.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!0}c?pl(a,b).pa(d):Lk(a,b).pa(d)}});return N(d)}
function Zk(a){var b=a.d.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.k+"px";b.style.right=a.I+"px";b.style.bottom=a.w+"px";b.style.left=a.j+"px";a.d.appendChild(b);var c=b.getBoundingClientRect();a.d.removeChild(b);var b=a.B+a.left+Rj(a),d=a.D+a.top+Pj(a);a.f=new ce(b,d,b+a.width,d+a.height);a.Tc=c?a.b?c.top:c.left:0;a.Qa=c?a.b?c.right:c.top:0;a.jb=c?a.b?c.left:c.bottom:0;a.qc=a.Qa;a.rc=a.Qa;a.na=a.jb;c=a.f;b=a.B+a.left+Rj(a);d=a.D+a.top+Pj(a);b=a.Rb?ke(a.Rb,b,d):
me(b,d,b+a.width,d+a.height);a.oc=we(c,[b],a.A,a.Ga,a.b);Ok(a);a.g=null}function Yk(a){a.Oa=[];u(a.d,"width",a.width+"px");u(a.d,"height",a.height+"px");Zk(a);a.e=0;a.Sc=!1;a.M=null}function il(a,b){a.e=Math.max((a.b?-1:1)*(b-a.Qa),a.e)}function yl(a,b){var c=b.b;if(!c)return M(!0);var d=L("layoutOverflownFootnotes"),e=0;af(function(){for(;e<c.length;){var b=c[e++],b=Wk(a,0,b,a.Qa);if(b.za())return b}return M(!1)}).then(function(){O(d,!0)});return N(d)}
function al(a,b){a.Oa.push(b);if(a.Sc)return M(b);var c=L("layout");yl(a,b).then(function(){Ck(a,b.Sa).then(function(b){var e=b,f=!0;a.u=[];bf(function(c){for(;b;){var k=!0;xl(a,b,f).then(function(h){f=!1;b=h;0<a.h.g.b.length?Q(c):a.M?Q(c):b&&b.e?rl(a,b,e).then(function(a){b=a;Q(c)}):k?k=!1:df(c)});if(k){k=!1;return}}Q(c)}).then(function(){var e=a.l;e&&(a.d.appendChild(e.d),a.b?a.e=this.Qa-this.jb:a.e=e.top+Pj(e)+e.e+Qj(e));if(b)if(0<a.h.g.b.length)O(c,null);else{a.Sc=!0;e=new Kj(Jj(b));if(a.g){for(var f=
[],h=0;h<a.g.length;h++){var l=a.g[h].b;l&&f.push(l)}e.b=f.length?f:null}O(c,e)}else O(c,null)})})});return N(c)}function $k(a){for(var b=a.Oa;a.d.lastChild!=a.Rc;)a.d.removeChild(a.d.lastChild);Nk(a);Yk(a);var c=L("redoLayout"),d=0,e=null;bf(function(c){if(d<b.length){var g=b[d++];al(a,g).then(function(a){a?(e=a,Q(c)):df(c)})}else Q(c)}).then(function(){O(c,e)});return N(c)};var zl=1;function Al(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.h=0;this.d=a;this.name=b;this.eb=c;this.ya=d;this.parent=e;this.g="p"+zl++;e&&(this.h=e.children.length,e.children.push(this))}Al.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Al.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Bl(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
...
function Gl(a,b,c,d,e,f,g){a=a instanceof El?a:new El(a,this);Al.call(this,a,b,c,d,e);this.e=this;this.J=f;this.j=g;this.b.width=new U(Yd,0);this.b.height=new U(Zd,0);this.b["wrap-flow"]=new U(ld,0);this.b.position=new U(Jd,0);this.b.overflow=new U(vd,0);this.k={}}t(Gl,Al);Gl.prototype.f=function(a){return new Hl(a,this)};Gl.prototype.clone=function(a){a=new Gl(this.d,this.name,a.eb||this.eb,this.ya,this.parent,this.J,this.j);Bl(this,a);Cl(this,a);return a};
function Il(a,b,c,d,e){Al.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.k[b]=this.g);this.b["wrap-flow"]=new U(ld,0)}t(Il,Al);Il.prototype.f=function(a){return new Jl(a,this)};Il.prototype.clone=function(a){a=new Il(a.parent.d,this.name,this.eb,this.ya,a.parent);Bl(this,a);Cl(this,a);return a};function Kl(a,b,c,d,e){Al.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.k[b]=this.g)}t(Kl,Al);Kl.prototype.f=function(a){return new Ll(a,this)};
Kl.prototype.clone=function(a){a=new Kl(a.parent.d,this.name,this.eb,this.ya,a.parent);Bl(this,a);Cl(this,a);return a};function X(a,b,c){return b&&b!==ld?b.fa(a,c):null}function Ml(a,b,c){return b&&b!==ld?b.fa(a,c):a.b}function Nl(a,b,c){return b?b===ld?null:b.fa(a,c):a.b}function Ol(a,b,c,d){return b&&c!==Fd?b.fa(a,d):a.b}function Pl(a,b,c){return b?b===Vd?a.g:b===td?a.f:b.fa(a,a.b):c}
function Ql(a,b){this.e=a;this.d=b;this.B={};this.style={};this.k=this.l=null;this.children=[];this.D=this.I=this.f=this.g=!1;this.w=this.A=0;this.u=null;this.na={};this.ga={};this.wa=this.b=!1;a&&a.children.push(this)}function Rl(a,b,c){b=Fl(a,b);c=Fl(a,c);if(!b||!c)throw Error("E_INTERNAL");return D(a.d.d,b,c)}
...
function Vl(a,b){b.qa[a.d.g]=a;var c=a.d.d,d=a.style,e=a.e?Wl(a.e,b):null,e=xi(a.B,b,e,!1);a.b=wi(e,b,a.e?a.e.b:!1);yi(e,d,a.b,function(a,b){return b.value});a.l=new bc(c,function(){return a.A},"autoWidth");a.k=new bc(c,function(){return a.w},"autoHeight");a.Cc();a.Dc();Tl(a);Sl(a)}function Xl(a,b,c){(a=a.style[c])&&(a=Wf(b,a,c));return a}function Y(a,b,c){(a=a.style[c])&&(a=Wf(b,a,c));return id(a,b)}
...
function $l(a,b,c){var d=Y(a,b,"right"),e=Y(a,b,"snap-height"),f=Y(a,b,"margin-right"),g=Y(a,b,"padding-right");b=Y(a,b,"border-right-width");u(c.d,"margin-right",f+"px");u(c.d,"padding-right",g+"px");u(c.d,"border-right-width",b+"px");c.marginRight=f;c.Fa=b;a.b&&0<e&&(a=d+Sj(c),a=a-Math.floor(a/e)*e,0<a&&(c.Sb=e-a,g+=c.Sb));c.I=g;c.Tb=e}
...
function bm(a,b,c){var d=Y(a,b,"margin-bottom"),e=Y(a,b,"padding-bottom"),f=Y(a,b,"border-bottom-width");a=Y(a,b,"height")-c.qa;u(c.d,"height",a+"px");u(c.d,"margin-bottom",d+"px");u(c.d,"padding-bottom",e+"px");u(c.d,"border-bottom-width",f+"px");c.height=a-c.qa;c.marginBottom=d;c.wa=f;c.w=e}function cm(a,b,c){a.b?(am(a,b,c),bm(a,b,c)):($l(a,b,c),Zl(a,b,c))}
function dm(a,b,c){u(c.d,"border-top-width","0px");var d=Y(a,b,"max-height");a.I?Uj(c,0,d):(am(a,b,c),d-=c.qa,c.height=d,u(c.d,"height",d+"px"))}function em(a,b,c){u(c.d,"border-left-width","0px");var d=Y(a,b,"max-width");a.D?Vj(c,0,d):($l(a,b,c),d-=c.Sb,c.width=d,a=Y(a,b,"right"),u(c.d,"right",a+"px"),u(c.d,"width",d+"px"))}
...
Ql.prototype.Yb=function(a,b,c,d,e){this.b?this.A=b.e+b.Sb:this.w=b.e+b.qa;var f=(this.b||!d)&&this.f,g=(!this.b||!d)&&this.g,k=null;if(g||f)g&&u(b.d,"width","auto"),f&&u(b.d,"height","auto"),k=(d?d.d:b.d).getBoundingClientRect(),g&&(this.A=Math.ceil(k.right-k.left-b.j-b.aa-b.I-b.Fa),this.b&&(this.A+=b.Sb)),f&&(this.w=k.bottom-k.top-b.k-b.ga-b.w-b.wa,this.b||(this.w+=b.qa));(this.b?this.f:this.g)&&cm(this,a,b);if(this.b?this.g:this.f){if(this.b?this.D:this.I)this.b?$l(this,a,b):am(this,a,b);this.b?
...
function Dm(a,b,c,d,e,f){var g=L("createRefShadow");a.$.j.load(b).then(function(k){if(k){var h=Ri(k,b);if(h){var l=a.I,n=l.D[k.url];n||(n=l.style.h.b[k.url],n=new fk(k,n.d,n.g,new fc(0,l.u(),l.l(),l.g),l.e,n.j,l.j),l.D[k.url]=n);f=new Cj(d,h,k,e,f,c,n)}}O(g,f)});return N(g)}
function Em(a,b,c,d,e,f,g,k){var h=L("createShadows"),l=e.template,n;l instanceof gd?n=Dm(a,l.url,2,b,k,null):n=M(null);n.then(function(l){var n=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var r=b.getAttribute("href"),v=null;r?v=k?k.$:a.$:k&&(r="http://www.w3.org/1999/xhtml"==k.Z.namespaceURI?k.Z.getAttribute("href"):k.Z.getAttributeNS("http://www.w3.org/1999/xlink","href"),v=k.Kc?k.Kc.$:a.$);r&&(r=ea(r,v.url),n=Dm(a,r,3,b,k,l))}null==n&&(n=M(l));n.then(function(l){var n;
...
function Nm(a){var b=a.da+1;if(a.K){if(!a.parent)return null;if(3!=a.La){var c=a.X.nextSibling;if(c)return a=a.modify(),a.da=b,a.X=c,Fj(a),Mm(a)}if(a.oa)return a=a.oa.modify(),a.da=b,a;a=a.parent.modify()}else{if(a.va&&(c=a.va.root,2==a.va.type&&(c=c.firstChild),c))return b=new Ej(c,a,b),b.ca=a.va,b.La=a.va.type,Mm(b);if(c=a.X.firstChild)return Mm(new Ej(c,a,b));1!=a.X.nodeType&&(b+=a.X.textContent.length-1-a.ba);a=a.modify()}a.da=b;a.K=!0;return a}
function Jk(a,b){b=Nm(b);if(!b||b.K)return M(b);var c=L("nextInTree");Ek(a,b,!0).then(function(a){b.b&&a||(b=b.modify(),b.K=!0,b.b||(b.d=!0));O(c,b)});return N(c)}function Om(a,b){if(b instanceof Wc)for(var c=b.values,d=0;d<c.length;d++)Om(a,c[d]);else b instanceof gd&&(c=b.url,a.e.e.push(fg(new Image,c)))}
function Km(a,b,c){var d=c["background-image"];d&&Om(a,d);for(var e in c)d=c[e],!oj[e]||"position"==e&&d!==Jd?(d.Fc()&&"rem"===d.ja&&(d=new J(id(d,a.d),"px")),u(b,e,d.toString())):a.e.g.push(new pj(b,e,d))}function cl(a,b,c,d){if(!b.K){var e=(b.ca?b.ca.b:a.k).g(a.X,!1);if(e=e._pseudos)e=e[c],c={},b.g=Fm(a,b.g,e,c),b=c.content,Xj(b)&&(b.S(new Wj(d,a.d)),delete c.content),Km(a,d,c)}}
...
function dn(a){if((a=a.size)&&a.value!==ld){var b=a.value;b.od()?(a=b.values[0],b=b.values[1]):(a=b,b=null);return a.Fc()?{width:a,height:b||a}:(a=bn[a.name.toLowerCase()])?b&&b===Bd?{width:a.height,height:a.width}:{width:a.width,height:a.height}:cn}return cn}
...
ra:!0,sa:!1,ta:!1,ha:"center"},"bottom-left":{N:12,ua:!1,ra:!0,sa:!1,ta:!1,ha:"start"},"bottom-left-corner":{N:13,ua:!1,ra:!0,sa:!0,ta:!1,ha:null},"left-bottom":{N:14,ua:!1,ra:!1,sa:!0,ta:!1,ha:"end"},"left-middle":{N:15,ua:!1,ra:!1,sa:!0,ta:!1,ha:"center"},"left-top":{N:16,ua:!1,ra:!1,sa:!0,ta:!1,ha:"start"}},gn=Object.keys(fn).sort(function(a,b){return fn[a].N-fn[b].N});
...
function ln(a,b,c,d){Kl.call(this,a,null,null,[],b);this.l=c;a=d._marginBoxes[this.l];for(var e in d)if(b=d[e],c=a[e],Tg[e]||c&&c.value===xd)this.b[e]=b;for(e in a)Object.prototype.hasOwnProperty.call(a,e)&&(b=a[e])&&b.value!==xd&&(this.b[e]=b)}t(ln,Kl);ln.prototype.f=function(a){return new on(a,this)};function mn(a,b){Hl.call(this,a,b);this.j=null;this.qa={}}t(mn,Hl);
mn.prototype.h=function(a,b){var c=this.B,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}Hl.prototype.h.call(this,a,b)};mn.prototype.Cc=function(){var a=this.style;a.left=$d;a["margin-left"]=$d;a["border-left-width"]=$d;a["padding-left"]=$d;a["padding-right"]=$d;a["border-right-width"]=$d;a["margin-right"]=$d;a.right=$d};
mn.prototype.Dc=function(){var a=this.style;a.top=$d;a["margin-top"]=$d;a["border-top-width"]=$d;a["padding-top"]=$d;a["padding-bottom"]=$d;a["border-bottom-width"]=$d;a["margin-bottom"]=$d;a.bottom=$d};mn.prototype.aa=function(a,b,c){b=b.l;var d={start:this.j.marginLeft,end:this.j.marginRight,Y:this.j.rb},e={start:this.j.marginTop,end:this.j.marginBottom,Y:this.j.qb};pn(this,b.top,!0,d,a,c);pn(this,b.bottom,!0,d,a,c);pn(this,b.left,!1,e,a,c);pn(this,b.right,!1,e,a,c)};
...
function pn(a,b,c,d,e,f){var g=a.d.d,k={},h={},l={},n;for(n in b){var p=fn[n];if(p){var q=b[n],r=a.qa[n],v=new qn(q,r.style,c,g,f);k[p.ha]=q;h[p.ha]=r;l[p.ha]=v}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.Y.evaluate(e);var y=un(l,b),I=!1,W={};Object.keys(k).forEach(function(a){var b=X(g,h[a].style[c?"max-width":"max-height"],d.Y);b&&(b=b.evaluate(e),y[a]>b&&(b=l[a]=new tn(k[a],h[a].style,c,g,f,b),W[a]=b.d(),I=!0))});I&&(y=un(l,b),I=!1,["start","center","end"].forEach(function(a){y[a]=W[a]||y[a]}));
...
function un(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=vn(d,g.length?new sn(g):null,b);g.Na&&(f.center=g.Na);d=g.Na||d.d();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=vn(c,e,b),c.Na&&(f.start=c.Na),c.Qb&&(f.end=c.Qb);return f}
function vn(a,b,c){var d={Na:null,Qb:null};if(a&&b)if(a.b()&&b.b()){var e=a.e(),f=b.e();0<e&&0<f?(f=e+f,f<c?d.Na=c*e/f:(a=a.f(),b=b.f(),b=a+b,b<c?d.Na=a+(c-b)*(e-a)/(f-b):0<b&&(d.Na=c*a/b)),0<d.Na&&(d.Qb=c-d.Na)):0<e?d.Na=c:0<f&&(d.Qb=c)}else a.b()?d.Na=Math.max(c-b.d(),0):b.b()&&(d.Qb=Math.max(c-a.d(),0));else a?a.b()&&(d.Na=c):b&&b.b()&&(d.Qb=c);return d}function nn(a,b){Ll.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.qb=this.rb=null}t(nn,Ll);
...
d["padding-bottom"]=new K(c.marginBottom)};nn.prototype.Cc=function(){var a=wn(this,{start:"left",end:"right",Y:"width"});this.rb=a.jd;this.marginLeft=a.rd;this.marginRight=a.qd};nn.prototype.Dc=function(){var a=wn(this,{start:"top",end:"bottom",Y:"height"});this.qb=a.jd;this.marginTop=a.rd;this.marginBottom=a.qd};
...
$d;c["margin-"+f]=$d;c["padding-"+e]=new K(p);c["padding-"+f]=new K(q);c["border-"+e+"-width"]=new K(r);c["border-"+f+"-width"]=new K(v);c[g]=new K(h);c["max-"+g]=new K(h);return{jd:F(d,k,D(d,l,n)),rd:l,qd:n}}nn.prototype.tb=function(a,b,c){Ll.prototype.tb.call(this,a,b,c);c.u=b.d};function on(a,b){Ll.call(this,a,b);var c=b.l;this.j=fn[c];a.qa[c]=this;this.wa=!0}t(on,Ll);m=on.prototype;
m.tb=function(a,b,c){var d=b.d;u(d,"display","flex");var e=Xl(this,a,"vertical-align"),f=null;e===H("middle")?f="center":e===H("top")?f="flex-start":e===H("bottom")&&(f="flex-end");f&&(u(d,"flex-flow",this.b?"row":"column"),u(d,"justify-content",f));Ll.prototype.tb.call(this,a,b,c)};
...
function xn(a,b,c){function d(a){if(y)return y;y={Y:v?v.evaluate(a):null,Ca:h?h.evaluate(a):null,Da:l?l.evaluate(a):null};var b=k.evaluate(a),c=0;[q,n,p,r].forEach(function(b){b&&(c+=b.evaluate(a))});(null===y.Ca||null===y.Da)&&c+y.Y+y.Ca+y.Da>b&&(null===y.Ca&&(y.Ca=0),null===y.Da&&(y.ae=0));null!==y.Y&&null!==y.Ca&&null!==y.Da&&(y.Da=null);null===y.Y&&null!==y.Ca&&null!==y.Da?y.Y=b-c-y.Ca-y.Da:null!==y.Y&&null===y.Ca&&null!==y.Da?y.Ca=b-c-y.Y-y.Da:null!==y.Y&&null!==y.Ca&&null===y.Da?y.Da=b-c-y.Y-
y.Ca:null===y.Y?(y.Ca=y.Da=0,y.Y=b-c):y.Ca=y.Da=(b-c-y.Y)/2;return y}var e=a.style;a=a.d.d;var f=b.Ec,g=b.Jc;b=b.Y;var k=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],h=Nl(a,e["margin-"+f],k),l=Nl(a,e["margin-"+g],k),n=Ml(a,e["padding-"+f],k),p=Ml(a,e["padding-"+g],k),q=Ol(a,e["border-"+f+"-width"],e["border-"+f+"-style"],k),r=Ol(a,e["border-"+g+"-width"],e["border-"+g+"-style"],k),v=X(a,e[b],k),y=null;e[b]=new K(new bc(a,function(){var a=d(this).Y;return null===a?0:a},b));e["margin-"+f]=new K(new bc(a,
function(){var a=d(this).Ca;return null===a?0:a},"margin-"+f));e["margin-"+g]=new K(new bc(a,function(){var a=d(this).Da;return null===a?0:a},"margin-"+g));"left"===f?e.left=new K(D(a,c.marginLeft,c.rb)):"top"===f&&(e.top=new K(D(a,c.marginTop,c.qb)))}m.Cc=function(){var a=this.e.j;this.j.sa?xn(this,{Ec:"right",Jc:"left",Y:"width"},a):this.j.ta?xn(this,{Ec:"left",Jc:"right",Y:"width"},a):this.ha({start:"left",end:"right",Y:"width"},a)};
m.Dc=function(){var a=this.e.j;this.j.ua?xn(this,{Ec:"bottom",Jc:"top",Y:"height"},a):this.j.ra?xn(this,{Ec:"top",Jc:"bottom",Y:"height"},a):this.ha({start:"top",end:"bottom",Y:"height"},a)};m.Yb=function(a,b,c,d,e,f){Ll.prototype.Yb.call(this,a,b,c,d,e,f);a=c.l;c=this.d.l;d=this.j;d.sa||d.ta?d.ua||d.ra||(d.sa?a.left[c]=b:d.ta&&(a.right[c]=b)):d.ua?a.top[c]=b:d.ra&&(a.bottom[c]=b)};
...
function An(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof U?e.value+"":An(a,e);c.push(d+f+(e.Ea||""))}return c.sort().join("^")}function Bn(a){this.b=null;this.f=a}t(Bn,V);Bn.prototype.apply=function(a){a.I===this.f&&this.b.apply(a)};Bn.prototype.d=function(){return 3};Bn.prototype.e=function(a){this.b&&sh(a.Gb,this.f,this.b);return!0};function Cn(a){this.b=null;this.f=a}t(Cn,V);
...
Hn.prototype.apply=function(a){var b=a.d,c=a.w,d=this.style,e=this.b;kh(b,c,d,e,null,null);if(d=d._marginBoxes){var c=ih(c,"_marginBoxes"),f;for(f in d)if(d.hasOwnProperty(f)){var g=c[f];g||(g={},c[f]=g);kh(b,g,d[f],e,null,null);g.content&&(g.content=g.content.xc(new Rh(a,null)))}}};function In(a,b,c,d){pi.call(this,a,b,null,c,null,d,!1);this.f=""}t(In,pi);m=In.prototype;m.vb=function(){this.f+="@page ";this.gb()};m.$a=function(a,b){this.f+=b;b&&(this.b.push(new Bn(b)),this.d+=65536)};
...
m.Ua=function(){this.f+="}";document.getElementById("vivliostyle-page-rules").textContent+=this.f;pi.prototype.Ua.call(this)};m.Ka=function(a,b,c){"size"===a&&(this.f+="size: "+b.toString()+(c?"!important":"")+";");pi.prototype.Ka.call(this,a,b,c)};m.md=function(a){sh(this.h.Gb,"*",a)};m.pd=function(a){return new Hn(this.k,a)};m.Oc=function(a){var b=ih(this.k,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);sf(this.Z,new Jn(this.e,this.Z,this.u,c))};
function Jn(a,b,c,d){tf.call(this,a,b,!1);this.d=c;this.b=d}t(Jn,uf);Jn.prototype.Ka=function(a,b,c){Rg(this.d,a,b,c,this)};Jn.prototype.Eb=function(a,b){vf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Jn.prototype.kc=function(a,b){vf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};Jn.prototype.fb=function(a,b,c){hh(this.b,a,new U(b,c?pf(this):qf(this)))};function Kn(a){this.d=a;this.b={};this.b.page=[0]}
...
function Pn(a,b,c,d,e,f,g,k,h){fc.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.$=b;this.lang=b.lang||c;this.viewport=d;this.e={body:!0};this.f=e;this.b=this.D=this.d=this.k=null;this.h=0;this.Oa=f;this.na=new Ei(this.style.l);this.qa={};this.M=null;this.j=new Kn(a.b);this.I={};this.ga=null;this.Fa=g;this.Ga=k;this.wa=h;for(var l in a.e)(b=a.e[l]["flow-consume"])&&(b.evaluate(this,"flow-consume")==kd?this.e[l]=!0:delete this.e[l])}t(Pn,fc);
function Qn(a){var b=L("StyleInstance.init");a.d=new fk(a.$,a.style.d,a.style.g,a,a.e,a.style.j,a.j);var c=a.d;c.k=a;for(var d=0;d<c.B.length;d++)nk(c.k,c.B[d]);a.D={};c=a.D[a.$.url]=a.d;for(d=0;!c.j&&(d+=5E3,ok(c,d,0)!=Number.POSITIVE_INFINITY););c=c.u;a.ga=an(c);a.k=new lm(a.style.w);d=new ei(a.style.d,a,a.j);a.k.h(d,c);km(a.k,a);a.M=new yn(d,a.style.b,a.k,a,c);c=[];for(d=0;d<a.style.f.length;d++){var e=a.style.f[d];if(!e.J||e.J.evaluate(a)){var f=e.lb,g=a,e={},k=void 0;for(k in f)e[k]=f[k].evaluate(g,
...
function Sn(a,b){var c=Rn(a,a.b);if(c==Number.POSITIVE_INFINITY)return null;for(var d=a.k.children,e,f=0;f<d.length;f++)if(e=d[f],"vivliostyle-page-rule-master"!==e.d.eb){var g=1,k=Xl(e,a,"utilization");k&&k.$c()&&(g=k.C);k=hc(a,"em",!1);a.h=ok(a.d,c,Math.ceil(g*a.u()*a.l()/(k*k)));var g=a,k=g.b.d,h=void 0;for(h in g.b.b)for(var l=g.b.b[h],n=l.b.length-1;0<=n;n--){var p=l.b[n];0>p.b.e&&p.b.b<g.h&&(p.b.e=k)}gc(a,a.style.b);g=Xl(e,a,"enabled");if(!g||g===Vd){d=a;w("Location - page "+d.b.d);w("  currnt: "+
c);w("  lookup: "+d.h);c=void 0;for(c in d.b.b)for(f=d.b.b[c],g=0;g<f.b.length;g++)w("  Chunk "+c+": "+f.b[g].b.b);c=a.M;f=b;g=e.d;if(0===Object.keys(f).length)g.d.e=g;else{e=g;d=An(c,f);e=e.g+"^"+d;d=c.g[e];if(!d){if("background-host"===g.eb)d=c,f=(new hn(d.h,d.f.d,f)).f(d.f),f.h(d.b,d.e),km(f,d.d),d=f;else{d=c;k=f;f=g.clone({eb:"vivliostyle-page-rule-master"});if(g=k.size)k=dn(k),g=g.Ea,f.b.width=eh(d.d,f.b.width,new U(k.width,g)),f.b.height=eh(d.d,f.b.height,new U(k.height,g));f=f.f(d.f);f.h(d.b,
d.e);km(f,d.d);d=f}c.g[e]=d}e=d.d;e.d.e=e;e=d}return e}}throw Error("No enabled page masters");}
function Tn(a,b,c){var d=a.b.b[c];if(!d)return M(!0);a.e[c]&&0<b.A.length&&(b.gd=!1);Yk(b);var e=L("layoutColumn"),f=[];bf(function(c){for(;0<d.b.length;){var e=0,h=d.b[e];if(h.b.b>a.h)break;for(var l=1;l<d.b.length;l++){var n=d.b[l];if(n.b.b>a.h)break;zj(n.b,h.b)&&(h=n,e=l)}var p=h.b,q=!0;al(b,h.d).then(function(a){h.b.Hd&&(null===a||p.d)&&f.push(h);p.d?(d.b.splice(e,1),Q(c)):a?(h.d=a,Q(c)):(d.b.splice(e,1),q?q=!1:df(c))});if(q){q=!1;return}}Q(c)}).then(function(){0<f.length&&(d.b=f.concat(d.b));
O(e,!0)});return N(e)}
function Un(a,b,c,d,e,f,g,k){var h=Xl(c,a,"enabled");if(h&&h!==Vd)return M(!0);var l=L("layoutContainer"),n=Xl(c,a,"wrap-flow")===ld,p=c.b?c.g&&c.D:c.f&&c.I,h=Xl(c,a,"flow-from"),q=a.viewport.b.createElement("div"),r=Xl(c,a,"position");u(q,"position",r?r.name:"absolute");d.insertBefore(q,d.firstChild);var v=new Oj(q);v.b=c.b;c.tb(a,v,b);v.B=e;v.D=f;e+=v.left+v.marginLeft+v.aa;f+=v.top+v.marginTop+v.ga;if(h&&h.nd())if(a.I[h.toString()])c.Yb(a,v,b,null,1,a.f),h=M(!0);else{var y=L("layoutContainer.inner"),
I=h.toString(),W=Y(c,a,"column-count"),P=Y(c,a,"column-gap"),E=1<W?Y(c,a,"column-width"):v.width,h=Wl(c,a),Ea=0,r=Xl(c,a,"shape-inside"),mb=ag(r,0,0,v.width,v.height,a),Pk=new Cm(I,a,a.viewport,a.d,h,a.$,a.na,a.style.u,a,b,a.Fa,a.Ga,k),yh=0,Z=null;bf(function(b){for(;yh<W;){var c=yh++;if(1<W){var d=a.viewport.b.createElement("div");u(d,"position","absolute");q.appendChild(d);Z=new yk(d,Pk,a.f);Z.b=v.b;Z.Ga=v.Ga;Z.Tb=v.Tb;v.b?(u(d,"margin-left",v.j+"px"),u(d,"margin-right",v.I+"px"),c=c*(E+P)+v.k,
Vj(Z,0,v.width),Uj(Z,c,E)):(u(d,"margin-top",v.k+"px"),u(d,"margin-bottom",v.w+"px"),c=c*(E+P)+v.j,Uj(Z,0,v.height),Vj(Z,c,E));Z.B=e+v.j;Z.D=f+v.k}else Z=new yk(q,Pk,a.f),Tj(Z,v),v=Z;Z.A=p?[]:g;Z.Rb=mb;if(0<=Z.width){var h=L("inner");Tn(a,Z,I).then(function(){Z.M&&"column"!=Z.M&&(yh=W,"region"!=Z.M&&(a.I[I]=!0));O(h,!0)});c=N(h)}else c=M(!0);if(c.za()){c.then(function(){0<k.b.length?Q(b):(Ea=Math.max(Ea,Z.e),df(b))});return}0<k.b.length||(Ea=Math.max(Ea,Z.e))}Q(b)}).then(function(){v.e=Ea;c.Yb(a,
v,b,Z,W,a.f);O(y,!0)});h=N(y)}else h=Xl(c,a,"content"),r=!1,h&&Xj(h)?(h.S(new Wj(q,a)),jm(c,a,v)):c.wa&&(d.removeChild(q),r=!0),r||c.Yb(a,v,b,null,1,a.f),h=M(!0);h.then(function(){if(!c.f||0<Math.floor(v.e)){if(!n){var h=v.B+v.left,p=v.D+v.top,r=Rj(v)+v.width+Sj(v),y=Pj(v)+v.height+Qj(v),E=Xl(c,a,"shape-outside"),h=ag(E,h,p,r,y,a);Ta(a.viewport.root)&&g.push(ke(h,0,-1.25*hc(a,"em",!1)));g.push(h)}}else if(0==c.children.length){d.removeChild(q);O(l,!0);return}var I=c.children.length-1;af(function(){for(;0<=
I;){var d=c.children[I--],d=Un(a,b,d,q,e,f,g,k);if(d.za())return d}return M(!1)}).then(function(){O(l,!0)})});return N(l)}
function Vn(a,b,c){a.I={};c?(a.b=c.clone(),ik(a.d,c.e)):(a.b=new Nj,ik(a.d,-1));a.lang&&b.L.setAttribute("lang",a.lang);c=a.b;c.d++;gc(a,a.style.b);var d=zn(a.M);Wn(a,d);var e=Sn(a,d);if(!e)return M(null);e.d.b.width.value===Yd&&tj(b);e.d.b.height.value===Zd&&uj(b);Mn(a.j,d,a);var d=Xl(e,a,"writing-mode")||wd,f=Xl(e,a,"direction")||Ed,g=new sm(b.w.bind(b),d,f),k=c.clone(),h=[],l=L("layoutNextPage");bf(function(d){Un(a,b,e,b.L,0,0,h.concat(),g).then(function(){if(0<g.b.length){h=h.concat(um(g));g.b.splice(0,
...
h.value.toString());for(d=0;d<f.length;d++)if(g=f[d],k=b.h[g.Jb],h=b.h[g.Ed],k&&h&&(k=rj(k,g.action)))for(var y=0;y<h.length;y++)h[y].addEventListener(g.event,k,!1);var I;a:{for(I in a.e)if((f=c.b[I])&&0<f.b.length){I=!1;break a}I=!0}I&&(c=null);O(l,c)});return N(l)}function Wn(a,b){var c=dn(b),d=c.width;d===Yd?a.A=null:a.A=d.C*hc(a,d.ja,!1);c=c.height;c===Zd?a.w=null:a.w=c.C*hc(a,c.ja,!1)}function Xn(a,b,c,d){pi.call(this,a.g,a,b,c,d,a.f,!c);this.f=a;this.A=!1}t(Xn,pi);m=Xn.prototype;m.gc=function(){};
m.fc=function(a,b,c){a=new Gl(this.f.j,a,b,c,this.f.u,this.J,qf(this.Z));sf(this.f,new qm(a.d,this.f,a,this.u))};m.mb=function(a){a=a.d;null!=this.J&&(a=Pc(this.e,this.J,a));sf(this.f,new Xn(this.f,a,this,this.B))};m.cc=function(){sf(this.f,new si(this.e,this.Z))};m.ec=function(){var a={};this.f.k.push({lb:a,J:this.J});sf(this.f,new ti(this.e,this.Z,null,a,this.f.f))};m.dc=function(a){var b=this.f.h[a];b||(b={},this.f.h[a]=b);sf(this.f,new ti(this.e,this.Z,null,b,this.f.f))};
m.ic=function(){var a={};this.f.w.push(a);sf(this.f,new ti(this.e,this.Z,this.J,a,this.f.f))};m.Kb=function(a){var b=this.f.l;if(a){var c=ih(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}sf(this.f,new ti(this.e,this.Z,null,b,this.f.f))};m.hc=function(){this.A=!0;this.gb()};m.vb=function(){var a=new In(this.f.j,this.f,this,this.u);sf(this.f,a);a.vb()};
m.ma=function(){pi.prototype.ma.call(this);if(this.A){this.A=!1;var a="R"+this.f.B++,b=H(a),c;this.J?c=new dh(b,0,this.J):c=new U(b,0);jh(this.k,"region-id").push(c);this.Ua();a=new Xn(this.f,this.J,this,a);sf(this.f,a);a.ma()}};
...
Zn.prototype.Q=function(a){w("CSS parser: "+a)};function $n(a,b){return ao(b,a)}function bo(a){hf.call(this,$n,"document");this.D=a;this.A={};this.h={};this.b={};this.B={};this.f=null;this.j=[]}t(bo,hf);function co(a){var b=ea("user-agent.xml",da),c=L("OPSDocStore.init");jf(Sg).then(function(d){a.f=d;jf(vi).then(function(){a.load(b).then(function(){O(c,!0)})})});return N(c)}function eo(a,b){a.j.push({url:b.url,text:b.text,Va:"User",ya:null,media:null})}
...
fo.prototype.Gc=function(a){var b=this.h.Gc(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",u(e,"cursor","pointer"),e.addEventListener("click",ho,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
a.namespaceURI)return{name:ro.dcterms+a.localName,N:k++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Mc:null,scheme:null};return null});var h=Na(g,function(a){return a.Mc});g=d(Na(g,function(a){return a.Mc?null:a.name}));var l=null;g[so]&&(l=g[so][0].v);c(g);return g}function wo(){var a=window.MathJax;return a?a.Hub:null}var xo={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
...
function Ao(a,b,c){var d=new oo;d.F=0;d.id="item1";d.src=b;a.d={item1:d};a.g={};a.g[b]=d;a.h=[d];a.b=a.h;c?(a=a.e,d=L("EPUBDocStore.load"),b=ca(b),(a.l[b]=ao(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,ac:null})).pa(d),c=N(d)):c=M(null);return c}function Bo(a,b,c){var d=a.b[b],e=L("getCFI");a.e.load(d.src).then(function(a){var b=Pi(a,c),k=null;b&&(a=Ni(a,b,0,!1),k=new cb,gb(k,b,c-a),d.g&&gb(k,d.g,0),k=k.toString());O(e,k)});return N(e)}
...
function Do(a,b){return Ke("resolveEPage",function(c){if(0>=b)O(c,{F:0,la:0,O:-1});else{var d=Ja(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.e.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=Oi(a),g=Math.round(a*b/e.b),g==a&&g--);O(c,{F:d,la:g,O:-1})})}},function(a){w("Error resolving epage: "+b);O(a,null)})}
function Eo(a,b){var c=a.b[b.F];if(0>=b.la)return M(c.e);var d=L("getEPage");a.e.load(c.src).then(function(a){a=Oi(a);var f=Math.min(a,b.la);O(d,c.e+f*c.b/a)});return N(d)}function Fo(a,b,c,d){this.b=a;this.viewport=b;this.f=c;this.ub=[];this.la=this.O=this.F=0;this.R=Rb(d);this.e=new Pm(b.d)}function Go(a){var b=a.ub[a.F];return b?b.Za[a.O]:null}m=Fo.prototype;m.cb=function(){if(this.b.A)return this.b.A;var a=this.ub[this.F];return a?a.Ia.ga:null};
function Ho(a){var b=L("renderPage");Io(a).then(function(c){if(c){var d=-1;if(0>a.O){var d=a.la,e=Ja(c.Ja.length,function(a){return Rn(c.Ia,c.Ja[a])>d});a.O=e==c.Ja.length?Number.POSITIVE_INFINITY:e-1}var f=c.Za[a.O];f?(a.la=f.offset,O(b,f)):bf(function(b){if(a.O<c.Ja.length)Q(b);else if(c.complete)a.O=c.Ja.length-1,Q(b);else{var e=c.Ja[c.Ja.length-1],h=Jo(a,c,e);Vn(c.Ia,h,e).then(function(l){h.L.style.display="none";h.L.style.visibility="visible";h.L.setAttribute("data-vivliostyle-page-side",h.f);
(e=l)?(c.Za[e.d-1]=h,c.Ja.push(e),0<=d&&Rn(c.Ia,e)>d?(f=h,a.O=c.Ja.length-2,Q(b)):(h.j=0==c.item.F&&0==e.d-1,df(b))):(c.Za.push(h),f=h,a.O=c.Ja.length-1,0>d&&(a.la=h.offset),c.complete=!0,h.j=0==c.item.F&&0==a.O,h.k=c.item.F==a.b.b.length-1,Q(b))})}}).then(function(){if(f=f||c.Za[a.O])O(b,f);else{var e=c.Ja[a.O];0>d&&(a.la=Rn(c.Ia,e));var k=Jo(a,c,e);Vn(c.Ia,k,e).then(function(d){k.L.style.display="none";k.L.style.visibility="visible";k.L.setAttribute("data-vivliostyle-page-side",k.f);(e=d)?(c.Za[e.d-
1]=k,c.Ja[a.O+1]=e):(c.Za.push(k),c.complete=!0,k.k=c.item.F==a.b.b.length-1);k.j=0==c.item.F&&0==a.O;O(b,k)})}})}else O(b,null)});return N(b)}m.Nc=function(){return Ko(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};function Ko(a,b,c){var d=L("renderAllPages"),e=a.F,f=a.O;a.F=0;bf(function(d){a.O=a.F==b?c:Number.POSITIVE_INFINITY;Ho(a).then(function(){++a.F>b?Q(d):df(d)})}).then(function(){a.F=e;a.O=f;Ho(a).pa(d)});return N(d)}m.xd=function(){this.O=this.F=0;return Ho(this)};
m.yd=function(){this.F=this.b.b.length-1;this.O=Number.POSITIVE_INFINITY;return Ho(this)};m.nextPage=function(){var a=this,b=L("nextPage");Io(a).then(function(c){if(c){if(c.complete&&a.O==c.Ja.length-1){if(a.F>=a.b.b.length-1){O(b,null);return}a.F++;a.O=0}else a.O++;Ho(a).pa(b)}else O(b,null)});return N(b)};m.Lc=function(){if(0==this.O){if(0==this.F)return M(null);this.F--;this.O=Number.POSITIVE_INFINITY}else this.O--;return Ho(this)};
function Lo(a,b){var c="left"===b.f,d="ltr"===a.cb();return!c&&d||c&&!d}function Mo(a){var b=L("getCurrentSpread"),c=Go(a);if(!c)return M({left:null,right:null});var d=a.F,e=a.O,f="left"===c.f;(Lo(a,c)?a.Lc():a.nextPage()).then(function(g){a.F=d;a.O=e;Ho(a).then(function(){f?O(b,{left:c,right:g}):O(b,{left:g,right:c})})});return N(b)}m.Dd=function(){var a=Go(this);if(!a)return M(null);var a=Lo(this,a),b=this.nextPage();if(a)return b;var c=this;return b.jc(function(){return c.nextPage()})};
m.Gd=function(){var a=Go(this);if(!a)return M(null);var a=Lo(this,a),b=this.Lc();if(a){var c=this;return b.jc(function(){return c.Lc()})}return b};function No(a,b){var c=L("navigateToEPage");Do(a.b,b).then(function(b){b&&(a.F=b.F,a.O=b.O,a.la=b.la);Ho(a).pa(c)});return N(c)}function Oo(a,b){var c=L("navigateToCFI");Co(a.b,b).then(function(b){b&&(a.F=b.F,a.O=b.O,a.la=b.la);Ho(a).pa(c)});return N(c)}
function Po(a,b){w("Navigate to "+b);var c=yo(a.b,ca(b));if(null==c&&(a.b.f&&b.match(/^#epubcfi\(/)&&(c=yo(a.b,a.b.f.url)),null==c))return M(null);var d=a.b.g[c];if(!d)return a.b.f&&c==yo(a.b,a.b.f.url)&&(c=b.indexOf("#"),0<=c)?Oo(a,b.substr(c+1)):M(null);d.F!=a.F&&(a.F=d.F,a.O=0);var e=L("navigateTo");Io(a).then(function(c){var d=Ri(c.$,b);d&&(a.la=Mi(c.$,d),a.O=-1);Ho(a).pa(e)});return N(e)}
function Jo(a,b,c){var d=b.Ia.viewport,e=d.b.createElement("div");d.e.appendChild(e);e.style.position="relative";e.style.visibility="hidden";e.style.left="0px";e.style.top="0px";var f=new sj(e);f.F=b.item.F;f.position=c;f.offset=Rn(b.Ia,c);d!==a.viewport&&(a=Ub(a.viewport.width,a.viewport.height,d.width,d.height),a=Uf(null,new Ob(a)),f.g.push(new pj(e,"transform",a)));return f}
function Qo(a,b){var c=wo();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=L("navigateToEPage"),f=Ve(c);d.Push(function(){f.Wa(e)});return N(c)}return M(null)}
...
function Io(a){if(a.F>=a.b.b.length)return M(null);var b=a.ub[a.F];if(b)return M(b);var c=a.b.b[a.F],d=a.b.e,e=L("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(Oi(f)/2700),a.b.u=c.b);var g=d.b[f.url],k=a.Gc(f),h=a.viewport,l=On(g,h.width,h.height,h.fontSize);if(l.width!=h.width||l.height!=h.height||l.fontSize!=h.fontSize)h=new Qm(h.d,l.fontSize,h.root,l.width,l.height);var l=a.ub[a.F-1],n=new Pn(g,f,a.b.lang,h,a.e,a.f,k,a.b.w,l?l.Ia.wa+l.Za.length:0);l&&
Ln(n.j,l.Ia.j);n.R=a.R;Qn(n).then(function(){b={item:c,$:f,Ia:n,Ja:[null],Za:[],complete:!1};a.ub[a.F]=b;O(e,b)})});return N(e)}function Ro(a){return{F:a.F,O:a.O,la:a.la}}function So(a,b){b?(a.F=b.F,a.O=-1,a.la=b.la):(a.F=0,a.O=0,a.la=0);return Ko(a,a.F,a.O)}
m.bc=function(){var a=this.b,b=a.B||a.M;if(!b)return M(null);var c=L("showTOC");this.d||(this.d=new fo(a.e,b.src,a.lang,this.e,this.f,this.R,this,a.w));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";e.style.border=
"1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.d.bc(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";O(c,a)});return N(c)};m.Zb=function(){this.d&&this.d.Zb()};m.ad=function(){return this.d&&this.d.ad()};function To(a,b,c,d){var e=this;this.j=a;this.ab=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Oa=c;this.Ga=d;this.na=new Fi(a.document.head,b);this.A="";this.g=null;this.I=this.d=!1;this.f=this.k=this.e=this.u=null;this.fontSize=16;this.h=1;this.aa=!1;this.Nc=!0;this.R=Qb();this.D=function(){};this.l=function(){};this.M=function(){e.d=!0;e.D()};this.w=function(){};this.ga={loadEPUB:this.qa,loadXML:this.wa,configure:this.B,
moveTo:this.Fa,toc:this.bc}}function Uo(a,b){b.i=a.Oa;a.Ga(b)}
To.prototype.qa=function(a){Ym.b("loadEPUB");Ym.b("loadFirstPage");this.ab.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet;this.viewport=null;var f=L("loadEPUB"),g=this;g.B(a).then(function(){var a=new io;if(e)for(var h=0;h<e.length;h++)eo(a,e[h]);co(a).then(function(){var e=ea(b,g.j.location.href);g.A=e;ko(a,e,d).then(function(a){g.g=a;Co(g.g,c).then(function(a){g.f=a;Vo(g).then(function(){g.ab.setAttribute("data-vivliostyle-viewer-status",
"complete");Ym.d("loadEPUB");Uo(g,{t:"loaded",metadata:g.g.l});O(f,!0)})})})})});return N(f)};
To.prototype.wa=function(a){Ym.b("loadXML");Ym.b("loadFirstPage");this.ab.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.document,d=a.fragment,e=a.userStyleSheet;this.viewport=null;var f=L("loadXML"),g=this;g.B(a).then(function(){var a=new io;if(e)for(var h=0;h<e.length;h++)eo(a,e[h]);co(a).then(function(){var e=ea(b,g.j.location.href);g.A=e;g.g=new mo(a,"");Ao(g.g,e,c).then(function(){Co(g.g,d).then(function(a){g.f=a;Vo(g).then(function(){g.ab.setAttribute("data-vivliostyle-viewer-status",
...
function $o(a){var b=L("reportPosition");a.f||(a.f=Ro(a.b));Bo(a.g,a.f.F,a.f.la).then(function(c){var d=a.e;(a.aa&&0<d.e.length?eg(d.e):M(!0)).then(function(){ap(a,d,c).pa(b)})});return N(b)}function bp(a){var b=a.ab;if(a.u){var c=a.u;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new Qm(a.j,a.fontSize,b,c.width,c.height)}return new Qm(a.j,a.fontSize,b)}
function cp(a){if(a.u||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=bp(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.ub;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.Za,d=0;d<c.length;d++){var e=c[d];if(e.D&&e.B){a=!0;break a}}}a=!1}b=!a}return b}
function dp(a){if(a.b){a.b.Zb();for(var b=a.b.ub,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.Za,e;e=d.shift();)e=e.L,e.parentNode.removeChild(e)}}a.viewport=bp(a);b=a.viewport.e;u(b,"width","");u(b,"height","");a.b=new Fo(a.g,a.viewport,a.na,a.R)}
function ep(a,b){a.I=!1;if(a.R.Xa)return Mo(a.b).jc(function(c){Xo(a);a.k=c;c.left&&(Yo(a,c.left),c.right||c.left.L.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Yo(a,c.right),c.left||c.right.L.setAttribute("data-vivliostyle-unpaired-page",!0));var d=fp(a,c);Rm(a.viewport,d.width*a.h,d.height*a.h);c.left&&wj(c.left,a.h);c.right&&wj(c.right,a.h);a.e=b;return M(null)});Zo(a,b);gp(a,b);a.e=b;return M(null)}function gp(a,b){Rm(a.viewport,b.b.width*a.h,b.b.height*a.h);wj(b,a.h)}
function fp(a,b){var c=0,d=0;b.left&&(c+=b.left.b.width,d=b.left.b.height);b.right&&(c+=b.right.b.width,d=Math.max(d,b.right.b.height));b.left&&b.right&&(c+=2*a.R.Fb);return{width:c,height:d}}var hp={Pd:"fit inside viewport"};
function Vo(a){a.d=!1;if(cp(a))return M(!0);"complete"===a.ab.getAttribute("data-vivliostyle-viewer-status")&&a.ab.setAttribute("data-vivliostyle-viewer-status","resizing");Uo(a,{t:"resizestart"});var b=L("resize");a.b&&!a.f&&(a.f=Ro(a.b));dp(a);So(a.b,a.f).then(function(c){ep(a,c).then(function(){$o(a).then(function(c){Ym.d("loadFirstPage");(a.Nc?a.b.Nc():M(null)).then(function(){a.ab.setAttribute("data-vivliostyle-viewer-status","complete");Uo(a,{t:"resizeend"});O(b,c)})})})});return N(b)}
function ap(a,b,c){var d=L("sendLocationNotification"),e={t:"nav",first:b.j,last:b.k};Eo(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.u;c&&(e.cfi=c);Uo(a,e);O(d,!0)});return N(d)}To.prototype.cb=function(){return this.b?this.b.cb():null};
To.prototype.Fa=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.R.Xa?this.b.Dd:this.b.nextPage;break;case "previous":a=this.R.Xa?this.b.Gd:this.b.Lc;break;case "last":a=this.b.yd;break;case "first":a=this.b.xd;break;default:return M(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return No(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return Po(b.b,d)}}else return M(!0);var e=L("nextPage");a.call(b.b).then(function(a){a?(b.f=
null,ep(b,a).then(function(){$o(b).pa(e)})):O(e,!0)});return N(e)};To.prototype.bc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.ad();if(c){if("show"==a)return M(!0)}else if("hide"==a)return M(!0);if(c)return this.b.Zb(),M(!0);var d=this,e=L("showTOC");this.b.bc(b).then(function(a){if(a){if(b){var c=function(){d.b.Zb()};a.addEventListener("hyperlink",c,!1);a.L.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.w,!1)}O(e,!0)});return N(e)};
...
function kp(a,b){var c=jp(b),d=null;Me(function(){var b=L("commandLoop"),f=Fe.d;a.w=function(b){var c={t:"hyperlink",href:b.href,internal:b.href.substr(0,a.A.length)==a.A};Ne(f,function(){Uo(a,c);return M(!0)})};bf(function(b){if(a.d)Vo(a).then(function(){df(b)});else if(a.I)a.e&&ep(a,a.e).then(function(){df(b)});else if(c){var e=c;c=null;ip(a,e).then(function(){df(b)})}else e=L("waitForCommand"),d=Ve(e,self),N(e).then(function(){df(b)})}).pa(b);return N(b)});a.D=function(){var a=d;a&&(d=null,a.Wa())};
a.l=function(b){if(c)return!1;c=jp(b);a.D();return!0};a.j.adapt_command=a.l};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Cb||(Object.Cb=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function lp(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}function mp(a,b){this.f=a;this.b=new To(a.window||window,a.viewportElement,"main",this.wd.bind(this));this.e={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,spreadView:!1,zoom:1};b&&this.sd(b);this.d=new Qa}m=mp.prototype;
m.sd=function(a){var b=Object.Cb({a:"configure"},lp(a));this.b.l(b);Object.Cb(this.e,a)};m.wd=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});Ra(this.d,b)};m.Jd=function(a,b){this.d.addEventListener(a,b,!1)};m.Md=function(a,b){this.d.removeEventListener(a,b,!1)};m.zd=function(a,b,c){a||Ra(this.d,{type:"error",content:"No URL specified"});np(this,a,null,b,c)};m.Kd=function(a,b,c){a||Ra(this.d,{type:"error",content:"No URL specified"});np(this,null,a,b,c)};
function np(a,b,c,d,e){d=d||{};var f,g=d.userStyleSheet;g&&(f=g.map(function(a){return{url:a.url||null,text:a.text||null}}));e&&Object.Cb(a.e,e);b=Object.Cb({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.f.userAgentRootURL,url:b||c,document:d.documentObject,fragment:d.fragment,userStyleSheet:f},lp(a.e));kp(a.b,b)}m.cb=function(){return this.b.cb()};
m.Bd=function(a){a:switch(a){case "left":a="ltr"===this.cb()?"previous":"next";break a;case "right":a="ltr"===this.cb()?"next":"previous";break a}this.b.l({a:"moveTo",where:a})};m.Ad=function(a){this.b.l({a:"moveTo",url:a})};m.Ld=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.R.Xa?fp(b,b.k):b.e.b;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ba("vivliostyle.viewer.Viewer",mp);mp.prototype.setOptions=mp.prototype.sd;mp.prototype.addListener=mp.prototype.Jd;mp.prototype.removeListener=mp.prototype.Md;mp.prototype.loadDocument=mp.prototype.zd;mp.prototype.loadEPUB=mp.prototype.Kd;mp.prototype.getCurrentPageProgression=mp.prototype.cb;mp.prototype.navigateToPage=mp.prototype.Bd;mp.prototype.navigateToInternalUrl=mp.prototype.Ad;mp.prototype.queryZoomFactor=mp.prototype.Ld;ba("vivliostyle.viewer.ZoomType",hp);hp.FIT_INSIDE_VIEWPORT="fit inside viewport";
...
function up(a){switch(a.t){case "loaded":a=a.viewer;var b=pp=a.cb();a.ab.setAttribute("data-vivliostyle-page-progression",b);a.ab.setAttribute("data-vivliostyle-spread-view",a.R.Xa);window.addEventListener("keydown",tp,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",rp,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",sp,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
