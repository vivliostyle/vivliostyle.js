 ...
 *
 * Vivliostyle core 2016.2.0-pre.20160222162811
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function Me(a,b,c,d,e){e&&(a=Ke(a),b=bb(b,Le),c=bb(c,Le));e=b.length;var f=c?c.length:0,g=[],k=[],h,l,n;for(h=0;h<e;h++)ze(b[h],k,h);for(h=0;h<f;h++)ze(c[h],k,h+e);b=k.length;k.sort(xe);for(c=0;k[c].e>=e;)c++;c=k[c].b.y;c>a.U&&g.push(new we(a.U,c,a.T,a.T));h=0;for(var p=[];h<b&&(n=k[h]).b.y<c;)n.d.y>c&&p.push(n),h++;for(;h<b||0<p.length;){var q=a.O,r=He(Math.ceil(c+8),d);for(l=0;l<p.length&&q>r;l++)n=p[l],n.b.x==n.d.x?n.d.y<q&&(q=Math.max(Ie(n.d.y,d),r)):n.b.x!=n.d.x&&(q=r);q>a.O&&(q=a.O);for(;h<
b&&(n=k[h]).b.y<q;)if(n.d.y<c)h++;else if(n.b.y<r){if(n.b.y!=n.d.y||n.b.y!=c)p.push(n),q=r;h++}else{l=Ie(n.b.y,d);l<q&&(q=l);break}r=[];for(l=0;l<p.length;l++)Fe(r,p[l],c,q);r.sort(function(a,b){return a.x-b.x||a.d-b.d});r=Ge(r,e,f);if(0==r.length)g.push(new we(c,q,a.T,a.T));else{var v=0,y=a.W;for(l=0;l<r.length;l+=2){var J=Math.max(a.W,r[l]),X=Math.min(a.T,r[l+1])-J;X>v&&(v=X,y=J)}0==v?g.push(new we(c,q,a.T,a.T)):g.push(new we(c,q,Math.max(y,a.W),Math.min(y+v,a.T)))}if(q==a.O)break;c=q;for(l=p.length-
1;0<=l;l--)p[l].d.y<=q&&p.splice(l,1)}Ne(a,g);return g}function Ne(a,b){for(var c=b.length-1,d=new we(a.O,a.O,a.W,a.T);0<=c;){var e=d,d=b[c];d.W==e.W&&d.T==e.T&&(e.U=d.U,b.splice(c,1),d=e);c--}}function Oe(a,b){for(var c=0,d=a.length;c<d;){var e=Math.floor((c+d)/2);b>=a[e].O?c=e+1:d=e}return c}
function Pe(a,b,c,d){for(var e=c.U,f=c.T-c.W,g=c.O-c.U,k=Oe(b,e);;){var h=e+g;if(h>a.O)break;for(var l=a.W,n=a.T,p=k;p<b.length&&b[p].U<h;p++){var q=b[p];q.W>l&&(l=q.W);q.T<n&&(n=q.T)}if(l+f<=n||k>=b.length){"left"==d?(c.W=l,c.T=l+f):(c.W=n-f,c.T=n);c.O+=e-c.U;c.U=e;break}e=b[k].O;k++}}
...
Uf;f.error("E_CSS_ATTR",h);continue}a.b=R;A(g);continue;case 11:f.Bc();a.b=Of;A(g);continue;case 12:f.zc();a.b=Of;A(g);continue;case 56:f.Gc();a.b=Of;A(g);continue;case 13:a.Y?(a.e.push("-epubx-region"),a.Y=!1):a.L?(a.e.push("page"),a.L=!1):a.e.push("[selector]");f.ma();a.b=Mf;A(g);continue;case 41:f.Nb();a.b=Pf;A(g);continue;case 15:k.push(H(h.text));A(g);continue;case 16:try{k.push(Cf(h.text))}catch(q){f.error("E_CSS_COLOR",h),a.b=Sf}A(g);continue;case 17:k.push(new rd(h.C));A(g);continue;case 18:k.push(new sd(h.C));
...
d=p.nd;d.push(ah(p.zb,g));f=p.jd;k=!1;break;case 18:if(k)throw Error("':' unexpected");A(b);d.push(Yg(d.pop(),x(b)));break;case 22:if(k)throw Error("'?' unexpected");d.push(Zg(d.pop(),0,1));break;case 36:if(k)throw Error("'*' unexpected");d.push(Zg(d.pop(),0,Number.POSITIVE_INFINITY));break;case 23:if(k)throw Error("'+' unexpected");d.push(Zg(d.pop(),1,Number.POSITIVE_INFINITY));break;case 12:A(b);g=x(b);if(5!=g.type)throw Error("<int> expected");var q=p=g.C;A(b);g=x(b);if(16==g.type){A(b);g=x(b);
if(5!=g.type)throw Error("<int> expected");q=g.C;A(b);g=x(b)}if(13!=g.type)throw Error("'}' expected");d.push(Zg(d.pop(),p,q));break;case 17:n=h();if(0<e.length)throw Error("unclosed '"+e.pop().Ac+"'");break;default:throw Error("unexpected token");}A(b);ch(c)?a.b[c]=n:a.e[c]=1!=n.b.length||0!=n.b[0].b?new Jg(n):n.b[0].d}}
...
function Rh(a){return Ph(a,function(a,c){for(var d=a.firstChild;d;d=d.nextSibling)1==d.nodeType&&c(d)})}function Sh(a,b){return Qh(a,function(a){return 1==a.nodeType?a.getAttribute(b):null})}yh.prototype.textContent=function(){return this.forEach(function(a){return a.textContent})};var Th={transform:!0,"transform-origin":!0,position:!0};function Uh(a,b,c){this.target=a;this.name=b;this.value=c}var Vh={show:function(a){a.style.visibility="visible"},hide:function(a){a.style.visibility="hidden"},play:function(a){a.currentTime=0;a.play()},pause:function(a){a.pause()},resume:function(a){a.play()},mute:function(a){a.muted=!0},unmute:function(a){a.muted=!1}};function Wh(a,b){var c=Vh[b];return c?function(){for(var b=0;b<a.length;b++)try{c(a[b])}catch(e){}}:null}
function Xh(a,b){this.e={};this.M=a;this.b=b;this.w=null;this.h=[];var c=this;this.B=function(a){var b=a.currentTarget,f=b.getAttribute("href")||b.getAttributeNS("http://www.w3.org/1999/xlink","href");f&&(a.preventDefault(),eb(c,{type:"hyperlink",target:null,currentTarget:null,je:b,href:f}))};this.j={};this.d={width:0,height:0};this.l=this.k=!1;this.F=0;this.position=null;this.offset=-1;this.g=null;this.f=[];this.u={top:{},bottom:{},left:{},right:{}}}t(Xh,db);
function Yh(a){a.G=!0;a.M.setAttribute("data-vivliostyle-auto-page-width",!0)}function Zh(a){a.D=!0;a.M.setAttribute("data-vivliostyle-auto-page-height",!0)}function $h(a,b,c){var d=a.j[c];d?d.push(b):a.j[c]=[b]}Xh.prototype.zoom=function(a){w(this.M,"transform","scale("+a+")")};Xh.prototype.A=function(){return this.w||this.M};
function ai(a,b){if(1==a.nodeType)return!1;var c=a.textContent;switch(b){case 0:return!!c.match(/^\s*$/);case 1:return!!c.match(/^[ \t\f]*$/);case 2:return 0==c.length}throw Error("Unexpected whitespace: "+b);}function bi(a,b,c,d,e,f,g,k){this.f=a;this.g=b;this.b=c;this.Da=d;this.j=e;this.d=f;this.Rd=g;this.h=k;this.e=-1}function ci(a,b){return a.d?!b.d||a.Da>b.Da?!0:a.h:!1}function di(a,b){return a.top-b.top}function ei(a,b){return b.right-a.right}
function fi(a,b,c,d,e,f,g){this.$=a;this.Rc=d;this.md=null;this.root=b;this.aa=c;this.type=f;e&&(e.md=this);this.b=g}function gi(a,b){this.Pd=a;this.count=b}function hi(a,b,c){this.X=a;this.parent=b;this.fa=c;this.ba=0;this.K=!1;this.Ma=0;this.ca=b?b.ca:null;this.pa=this.va=null;this.G=!1;this.d=!0;this.e=!1;this.h=b?b.h:0;this.w=this.j=this.L=null;this.A=b?b.A:0;this.k=b?b.k:!1;this.b=this.B=this.u=null;this.l=b?b.l:{};this.g=b?b.g:!1;this.D=b?b.D:"ltr";this.f=b?b.f:null}
function ii(a){a.d=!0;a.h=a.parent?a.parent.h:0;a.b=null;a.ba=0;a.K=!1;a.j=null;a.w=null;a.u=null;a.B=null;a.va=null;a.k=a.parent?a.parent.k:!1;a.g=a.parent?a.parent.g:!1;a.va=null}function ji(a){var b=new hi(a.X,a.parent,a.fa);b.ba=a.ba;b.K=a.K;b.va=a.va;b.Ma=a.Ma;b.ca=a.ca;b.pa=a.pa;b.d=a.d;b.h=a.h;b.j=a.j;b.w=a.w;b.k=a.k;b.A=a.A;b.u=a.u;b.B=a.B;b.b=a.b;b.f=a.f;b.g=a.g;b.e=a.e;return b}hi.prototype.modify=function(){return this.G?ji(this):this};
function ki(a){var b=a;do{if(b.G)break;b.G=!0;b=b.parent}while(b);return a}hi.prototype.clone=function(){for(var a=ji(this),b=a,c;null!=(c=b.parent);)c=ji(c),b=b.parent=c;return a};function li(a){return{ga:a.X,Ma:a.Ma,ca:a.ca,va:a.va,pa:a.pa?li(a.pa):null}}function mi(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(li(b)),b=b.parent;while(b);return{ja:c,ba:a.ba,K:a.K}}function ni(a){this.Ra=a;this.b=this.d=null}
ni.prototype.clone=function(){var a=new ni(this.Ra);if(this.d){a.d=[];for(var b=0;b<this.d.length;++b)a.d[b]=this.d[b]}if(this.b)for(a.b=[],b=0;b<this.b.length;++b)a.b[b]=this.b[b];return a};function oi(a,b){this.d=a;this.b=b}oi.prototype.clone=function(){return new oi(this.d.clone(),this.b)};function pi(){this.b=[]}pi.prototype.clone=function(){for(var a=new pi,b=this.b,c=a.b,d=0;d<b.length;d++)c[d]=b[d].clone();return a};function qi(){this.d=0;this.b={};this.e=0}
qi.prototype.clone=function(){var a=new qi;a.d=this.d;a.f=this.f;a.e=this.e;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b].clone();return a};function ri(a){this.d=a;this.B=this.A=this.height=this.width=this.w=this.k=this.D=this.j=this.wa=this.ea=this.Ia=this.Y=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.Zb=this.G=null;this.oa=this.$b=this.Ja=this.ac=this.e=0;this.b=!1}function si(a){return a.marginTop+a.ea+a.k}
function ti(a){return a.marginBottom+a.wa+a.w}function ui(a){return a.marginLeft+a.Y+a.j}function vi(a){return a.marginRight+a.Ia+a.D}function wi(a,b){a.d=b.d;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.Y=b.Y;a.Ia=b.Ia;a.ea=b.ea;a.wa=b.wa;a.j=b.j;a.D=b.D;a.k=b.k;a.w=b.w;a.width=b.width;a.height=b.height;a.A=b.A;a.B=b.B;a.Zb=b.Zb;a.G=b.G;a.e=b.e;a.ac=b.ac;a.Ja=b.Ja;a.b=b.b}
function xi(a,b,c){a.top=b;a.height=c;w(a.d,"top",b+"px");w(a.d,"height",c+"px")}function yi(a,b,c){a.left=b;a.width=c;w(a.d,"left",b+"px");w(a.d,"width",c+"px")}function zi(a,b){this.b=a;this.d=b}t(zi,gd);zi.prototype.Wb=function(a){this.b.appendChild(this.b.ownerDocument.createTextNode(a.b));return null};zi.prototype.Xb=function(a){var b=this.b.ownerDocument.createElementNS("http://www.w3.org/1999/xhtml","img");b.setAttribute("src",a.url);this.b.appendChild(b);return null};
zi.prototype.Ya=function(a){this.nb(a.values);return null};zi.prototype.Eb=function(a){a=a.ha().evaluate(this.d);"string"===typeof a&&this.b.appendChild(this.b.ownerDocument.createTextNode(a));return null};function Ai(a){return null!=a&&a!==Wd&&a!==Vd&&a!==Nd};function Bi(a,b,c){b=b?"vertical-rl":"horizontal-tb";if("top"===a||"bottom"===a)a=ca(a,b,c||null,ga);"block-start"===a&&(a="inline-start");"block-end"===a&&(a="inline-end");if("inline-start"===a||"inline-end"===a){c=ca(a,b,c||null,fa);a:{var d=ha[b];if(!d)throw Error("unknown writing-mode: "+b);for(b=0;b<d.length;b++)if(d[b].J===c){b=d[b].I;break a}b=c}"line-left"===b?a="left":"line-right"===b&&(a="right")}"left"!==a&&"right"!==a&&(u.b("Invalid float value: "+a+". Fallback to left."),a="left");return a}
function Ci(a,b){this.d=ki(a);this.b=b}function Di(a,b,c){this.e=a;this.g=b;this.f=c;this.d=[];this.b=[]}
function Ei(a,b,c){b.parentNode&&b.parentNode.removeChild(b);w(b,"float","none");w(b,"position","absolute");var d=a.g.toString(),e=a.f.toString(),f=ca(c,d,e||null,fa),g=ca(c,d,e||null,ga);w(b,f,"0");switch(g){case "inline-start":case "inline-end":d=ca("block-start",d,e||null,fa);w(b,d,"0");break;case "block-start":case "block-end":c=ca("inline-start",d,e||null,fa);w(b,c,"0");d=ca("max-inline-size",d,e||null,fa);Oa(b,d)||w(b,d,"100%");break;default:throw Error("unknown float direction: "+c);}a.e().appendChild(b)}
function Fi(a,b,c){b=mi(b);for(var d=0;d<a.d.length;d++){var e=a.d[d];if(Gi(c,b,mi(e.d)))return e}return null}function Hi(a,b,c){var d=L("tryToAddFloat");b=new Ci(b,c);a.d.push(b);a.b.push(b);O(d,b);return N(d)}function Ii(a){return a.b.map(function(a){a=a.b;return new ye([new te(a.W,a.U),new te(a.T,a.U),new te(a.T,a.O),new te(a.W,a.O)])})};var Ji={SIMPLE_PROPERTY:"SIMPLE_PROPERTY"},Ki={};function Li(a,b){if(Ji[a]){var c=Ki[a];c||(c=Ki[a]=[]);c.push(b)}else u.b(Error("Skipping unknown plugin hook '"+a+"'."))}ba("vivliostyle.plugin.registerHook",Li);ba("vivliostyle.plugin.removeHook",function(a,b){if(Ji[a]){var c=Ki[a];if(c){var d=c.indexOf(b);0<=d&&c.splice(d,1)}}else u.b(Error("Ignoring unknown plugin hook '"+a+"'."))});for(var Mi={azimuth:!0,"border-collapse":!0,"border-spacing":!0,"caption-side":!0,color:!0,cursor:!0,direction:!0,elevation:!0,"empty-cells":!0,"font-kerning":!0,"font-size":!0,"font-family":!0,"font-style":!0,"font-variant":!0,"font-weight":!0,"letter-spacing":!0,"line-break":!0,"line-height":!0,"list-style-image":!0,"list-style-position":!0,"list-style-type":!0,orphans:!0,"overflow-wrap":!0,"pitch-range":!0,quotes:!0,richness:!0,"ruby-align":!0,"ruby-position":!0,"speak-header":!0,"speak-numeral":!0,
"speak-punctuation":!0,"speech-rate":!0,stress:!0,"tab-size":!0,"text-align":!0,"text-align-last":!0,"text-decoration-skip":!0,"text-emphasis-color":!0,"text-emphasis-position":!0,"text-emphasis-style":!0,"text-combine-upright":!0,"text-indent":!0,"text-justify":!0,"text-size-adjust":!0,"text-transform":!0,"text-underline-position":!0,visibility:!0,"voice-family":!0,volume:!0,"white-space":!0,widows:!0,"word-break":!0,"word-spacing":!0,"word-wrap":!0,"writing-mode":!0},Ni={"http://www.idpf.org/2007/ops":!0,
"http://www.w3.org/1999/xhtml":!0,"http://www.w3.org/2000/svg":!0},Oi="margin-% padding-% border-%-width border-%-style border-%-color %".split(" "),Pi=["left","right","top","bottom"],Qi={width:!0,height:!0},Ri=0;Ri<Oi.length;Ri++)for(var Si=0;Si<Pi.length;Si++){var Ti=Oi[Ri].replace("%",Pi[Si]);Qi[Ti]=!0}function Ui(a){for(var b={},c=0;c<Oi.length;c++)for(var d in a){var e=Oi[c].replace("%",d),f=Oi[c].replace("%",a[d]);b[e]=f;b[f]=e}return b}
var Vi=Ui({before:"right",after:"left",start:"top",end:"bottom"}),Wi=Ui({before:"top",after:"bottom",start:"left",end:"right"});function U(a,b){this.value=a;this.Da=b}m=U.prototype;m.sd=function(){return this};m.Fc=function(a){a=this.value.S(a);return a===this.value?this:new U(a,this.Da)};m.ud=function(a){return 0==a?this:new U(this.value,this.Da+a)};m.evaluate=function(a,b){return lg(a,this.value,b)};m.qd=function(){return!0};function Xi(a,b,c){U.call(this,a,b);this.H=c}t(Xi,U);
Xi.prototype.sd=function(){return new U(this.value,this.Da)};Xi.prototype.Fc=function(a){a=this.value.S(a);return a===this.value?this:new Xi(a,this.Da,this.H)};Xi.prototype.ud=function(a){return 0==a?this:new Xi(this.value,this.Da+a,this.H)};Xi.prototype.qd=function(a){return!!this.H.evaluate(a)};function Yi(a,b,c){return(null==b||c.Da>b.Da)&&c.qd(a)?c.sd():b}var Zi={"region-id":!0};function $i(a){return"_"!=a.charAt(0)&&!Zi[a]}function aj(a,b,c){c?a[b]=c:delete a[b]}
function bj(a,b){var c=a[b];c||(c={},a[b]=c);return c}function cj(a,b){var c=a[b];c||(c=[],a[b]=c);return c}function dj(a,b,c,d,e,f){if(e){var g=bj(b,"_pseudos");b=g[e];b||(b={},g[e]=b)}f&&(e=bj(b,"_regions"),b=e[f],b||(b={},e[f]=b));for(var k in c)"_"!=k.charAt(0)&&(Zi[k]?(f=c[k],e=cj(b,k),Array.prototype.push.apply(e,f)):aj(b,k,Yi(a,b[k],c[k].ud(d))))}function ej(a,b){this.e=a;this.d=b;this.b=""}t(ej,hd);
function fj(a){a=a.e["font-size"].value;var b;a:switch(a.da.toLowerCase()){case "px":case "in":case "pt":case "pc":case "cm":case "mm":case "q":b=!0;break a;default:b=!1}if(!b)throw Error("Unexpected state");return a.C*rc[a.da]}
ej.prototype.Hb=function(a){if("em"==a.da||"ex"==a.da){var b=vc(this.d,a.da,!1)/vc(this.d,"em",!1);return new I(a.C*b*fj(this),"px")}if("%"==a.da){if("font-size"===this.b)return new I(a.C/100*fj(this),"px");b=this.b.match(/height|^(top|bottom)$/)?"vh":"vw";return new I(a.C,b)}return a};ej.prototype.Eb=function(a){return"font-size"==this.b?lg(this.d,a,this.b).S(this):a};function gj(){}gj.prototype.apply=function(){};gj.prototype.g=function(a){return new hj([this,a])};gj.prototype.clone=function(){return this};
function ij(a){this.b=a}t(ij,gj);ij.prototype.apply=function(a){a.b[a.b.length-1].push(this.b.b())};function hj(a){this.b=a}t(hj,gj);hj.prototype.apply=function(a){for(var b=0;b<this.b.length;b++)this.b[b].apply(a)};hj.prototype.g=function(a){this.b.push(a);return this};hj.prototype.clone=function(){return new hj([].concat(this.b))};function jj(a,b,c,d){this.style=a;this.R=b;this.b=c;this.d=d}t(jj,gj);jj.prototype.apply=function(a){dj(a.d,a.w,this.style,this.R,this.b,this.d)};
function V(){this.b=null}t(V,gj);V.prototype.apply=function(a){this.b.apply(a)};V.prototype.d=function(){return 0};V.prototype.e=function(){return!1};function kj(a){this.b=null;this.f=a}t(kj,V);kj.prototype.apply=function(a){0<=a.u.indexOf(this.f)&&this.b.apply(a)};kj.prototype.d=function(){return 10};kj.prototype.e=function(a){this.b&&lj(a.ya,this.f,this.b);return!0};function mj(a){this.b=null;this.id=a}t(mj,V);mj.prototype.apply=function(a){a.L!=this.id&&a.na!=this.id||this.b.apply(a)};
mj.prototype.d=function(){return 11};mj.prototype.e=function(a){this.b&&lj(a.e,this.id,this.b);return!0};function nj(a){this.b=null;this.localName=a}t(nj,V);nj.prototype.apply=function(a){a.f==this.localName&&this.b.apply(a)};nj.prototype.d=function(){return 8};nj.prototype.e=function(a){this.b&&lj(a.Vb,this.localName,this.b);return!0};function oj(a,b){this.b=null;this.f=a;this.localName=b}t(oj,V);oj.prototype.apply=function(a){a.f==this.localName&&a.k==this.f&&this.b.apply(a)};oj.prototype.d=function(){return 8};
oj.prototype.e=function(a){if(this.b){var b=a.b[this.f];b||(b="ns"+a.g++ +":",a.b[this.f]=b);lj(a.f,b+this.localName,this.b)}return!0};function pj(a){this.b=null;this.f=a}t(pj,V);pj.prototype.apply=function(a){var b=a.e;if(b&&"a"==a.f){var c=b.getAttribute("href");c&&c.match(/^#/)&&(b=b.ownerDocument.getElementById(c.substring(1)))&&(b=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))&&b.match(this.f)&&this.b.apply(a)}};function qj(a){this.b=null;this.f=a}t(qj,V);
qj.prototype.apply=function(a){a.k==this.f&&this.b.apply(a)};function rj(a,b){this.b=null;this.f=a;this.name=b}t(rj,V);rj.prototype.apply=function(a){a.e&&a.e.hasAttributeNS(this.f,this.name)&&this.b.apply(a)};function sj(a,b,c){this.b=null;this.f=a;this.name=b;this.value=c}t(sj,V);sj.prototype.apply=function(a){a.e&&a.e.getAttributeNS(this.f,this.name)==this.value&&this.b.apply(a)};sj.prototype.d=function(){return"type"==this.name&&"http://www.idpf.org/2007/ops"==this.f?9:0};
sj.prototype.e=function(a){return"type"==this.name&&"http://www.idpf.org/2007/ops"==this.f?(this.b&&lj(a.d,this.value,this.b),!0):!1};function tj(a,b){this.b=null;this.f=a;this.name=b}t(tj,V);tj.prototype.apply=function(a){if(a.e){var b=a.e.getAttributeNS(this.f,this.name);b&&Ni[b]&&this.b.apply(a)}};tj.prototype.d=function(){return 0};tj.prototype.e=function(){return!1};function uj(a,b,c){this.b=null;this.h=a;this.name=b;this.f=c}t(uj,V);
uj.prototype.apply=function(a){if(a.e){var b=a.e.getAttributeNS(this.h,this.name);b&&b.match(this.f)&&this.b.apply(a)}};function vj(a){this.b=null;this.f=a}t(vj,V);vj.prototype.apply=function(a){a.lang.match(this.f)&&this.b.apply(a)};function wj(){this.b=null}t(wj,V);wj.prototype.apply=function(a){a.oa&&this.b.apply(a)};wj.prototype.d=function(){return 6};function xj(){this.b=null}t(xj,V);xj.prototype.apply=function(a){a.Ia&&this.b.apply(a)};xj.prototype.d=function(){return 12};
function yj(a){this.b=null;this.f=a}t(yj,V);yj.prototype.apply=function(a){a.ea===this.f&&this.b.apply(a)};yj.prototype.d=function(){return 5};function zj(a){this.b=null;this.H=a}t(zj,V);zj.prototype.apply=function(a){var b=a.ea;"even"===this.H?0===b%2&&this.b.apply(a):"odd"===this.H&&1===b%2&&this.b.apply(a)};zj.prototype.d=function(){return 5};function Aj(a){this.b=null;this.H=a}t(Aj,V);Aj.prototype.apply=function(a){a.h[this.H]&&this.b.apply(a)};Aj.prototype.d=function(){return 5};
function Bj(a){this.H=a}Bj.prototype.b=function(){return this};Bj.prototype.push=function(a,b){0==b&&Cj(a,this.H);return!1};Bj.prototype.pop=function(a,b){return 0==b?(a.h[this.H]--,!0):!1};function Dj(a){this.H=a}Dj.prototype.b=function(){return this};Dj.prototype.push=function(a,b){0==b?Cj(a,this.H):1==b&&a.h[this.H]--;return!1};Dj.prototype.pop=function(a,b){if(0==b)return a.h[this.H]--,!0;1==b&&Cj(a,this.H);return!1};function Ej(a){this.H=a;this.d=!1}Ej.prototype.b=function(){return new Ej(this.H)};
Ej.prototype.push=function(a){return this.d?(a.h[this.H]--,!0):!1};Ej.prototype.pop=function(a,b){if(this.d)return a.h[this.H]--,!0;0==b&&(this.d=!0,Cj(a,this.H));return!1};function Fj(a){this.H=a;this.d=!1}Fj.prototype.b=function(){return new Fj(this.H)};Fj.prototype.push=function(a,b){this.d&&(-1==b?Cj(a,this.H):0==b&&a.h[this.H]--);return!1};Fj.prototype.pop=function(a,b){if(this.d){if(-1==b)return a.h[this.H]--,!0;0==b&&Cj(a,this.H)}else 0==b&&(this.d=!0,Cj(a,this.H));return!1};
function Gj(a,b){this.e=a;this.d=b}Gj.prototype.b=function(){return this};Gj.prototype.push=function(){return!1};Gj.prototype.pop=function(a,b){return 0==b?(Hj(a,this.e,this.d),!0):!1};function Ij(a){this.lang=a}Ij.prototype.b=function(){return this};Ij.prototype.push=function(){return!1};Ij.prototype.pop=function(a,b){return 0==b?(a.lang=this.lang,!0):!1};function Jj(a){this.d=a}Jj.prototype.b=function(){return this};Jj.prototype.push=function(){return!1};
Jj.prototype.pop=function(a,b){return 0==b?(a.B=this.d,!0):!1};function Kj(a,b){this.b=a;this.d=b}t(Kj,hd);Kj.prototype.mb=function(a){var b=this.b,c=b.B,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.l)];b.l++;break;case "close-quote":return 0<b.l&&b.l--,c[2*Math.min(d,b.l)+1];case "no-open-quote":return b.l++,new pd("");case "no-close-quote":return 0<b.l&&b.l--,new pd("")}return a};
var Lj={roman:[4999,1E3,"M",900,"CM",500,"D",400,"CD",100,"C",90,"XC",50,"L",40,"XL",10,"X",9,"IX",5,"V",4,"IV",1,"I"],armenian:[9999,9E3,"\u0584",8E3,"\u0583",7E3,"\u0582",6E3,"\u0581",5E3,"\u0580",4E3,"\u057f",3E3,"\u057e",2E3,"\u057d",1E3,"\u057c",900,"\u057b",800,"\u057a",700,"\u0579",600,"\u0578",500,"\u0577",400,"\u0576",300,"\u0575",200,"\u0574",100,"\u0573",90,"\u0572",80,"\u0571",70,"\u0570",60,"\u056f",50,"\u056e",40,"\u056d",30,"\u056c",20,"\u056b",10,"\u056a",9,"\u0569",8,"\u0568",7,"\u0567",
...
3,"\u10d2",2,"\u10d1",1,"\u10d0"],hebrew:[999,400,"\u05ea",300,"\u05e9",200,"\u05e8",100,"\u05e7",90,"\u05e6",80,"\u05e4",70,"\u05e2",60,"\u05e1",50,"\u05e0",40,"\u05de",30,"\u05dc",20,"\u05db",19,"\u05d9\u05d8",18,"\u05d9\u05d7",17,"\u05d9\u05d6",16,"\u05d8\u05d6",15,"\u05d8\u05d5",10,"\u05d9",9,"\u05d8",8,"\u05d7",7,"\u05d6",6,"\u05d5",5,"\u05d4",4,"\u05d3",3,"\u05d2",2,"\u05d1",1,"\u05d0"]},Mj={latin:"a-z",alpha:"a-z",greek:"\u03b1-\u03c1\u03c3-\u03c9",russian:"\u0430-\u0438\u043a-\u0449\u044d-\u044f"},
Nj={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},Oj={le:!1,Ib:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",hc:"\u5341\u767e\u5343",Md:"\u8ca0"};
function Pj(a){if(9999<a||-9999>a)return""+a;if(0==a)return Oj.Ib.charAt(0);var b=new Pa;0>a&&(b.append(Oj.Md),a=-a);if(10>a)b.append(Oj.Ib.charAt(a));else if(Oj.me&&19>=a)b.append(Oj.hc.charAt(0)),0!=a&&b.append(Oj.hc.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(Oj.Ib.charAt(c)),b.append(Oj.hc.charAt(2)));if(c=Math.floor(a/100)%10)b.append(Oj.Ib.charAt(c)),b.append(Oj.hc.charAt(1));if(c=Math.floor(a/10)%10)b.append(Oj.Ib.charAt(c)),b.append(Oj.hc.charAt(0));(a%=10)&&b.append(Oj.Ib.charAt(a))}return b.toString()}
function Qj(a,b){var c=!1,d=!1,e;null!=(e=b.match(/^upper-(.*)/))?(c=!0,b=e[1]):null!=(e=b.match(/^lower-(.*)/))&&(d=!0,b=e[1]);e="";if(Lj[b])a:{e=Lj[b];var f=a;if(f>e[0]||0>=f||f!=Math.round(f))e="";else{for(var g="",k=1;k<e.length;k+=2){var h=e[k],l=Math.floor(f/h);if(20<l){e="";break a}for(f-=l*h;0<l;)g+=e[k+1],l--}e=g}}else if(Mj[b])if(e=a,0>=e||e!=Math.round(e))e="";else{g=Mj[b];f=[];for(k=0;k<g.length;)if("-"==g.substr(k+1,1))for(l=g.charCodeAt(k),h=g.charCodeAt(k+2),k+=3;l<=h;l++)f.push(String.fromCharCode(l));
else f.push(g.substr(k++,1));g="";do e--,k=e%f.length,g=f[k]+g,e=(e-k)/f.length;while(0<e);e=g}else null!=Nj[b]?e=Nj[b]:"decimal-leading-zero"==b?(e=a+"",1==e.length&&(e="0"+e)):"cjk-ideographic"==b||"trad-chinese-informal"==b?e=Pj(a):e=a+"";return c?e.toUpperCase():d?e.toLowerCase():e}
function Rj(a,b){var c=b[0].toString(),d=1<b.length?b[1].stringValue():"decimal",e=a.b.g[c];if(e&&e.length)return new pd(Qj(e&&e.length&&e[e.length-1]||0,d));c=new K(Sj(a.b.Ja,c,function(a){return Qj(a||0,d)}));return new id([c])}
function Tj(a,b){var c=b[0].toString(),d=b[1].stringValue(),e=2<b.length?b[2].stringValue():"decimal",f=a.b.g[c],g=new Pa;if(f&&f.length)for(var k=0;k<f.length;k++)0<k&&g.append(d),g.append(Qj(f[k],e));c=new K(Uj(a.b.Ja,c,function(a){var b=[];if(a.length)for(var c=0;c<a.length;c++)b.push(Qj(a[c],e));a=g.toString();a.length&&b.push(a);return b.length?b.join(d):Qj(0,e)}));return new id([c])}
Kj.prototype.tb=function(a){switch(a.name){case "attr":if(1==a.values.length)return new pd(this.d&&this.d.getAttribute(a.values[0].stringValue())||"");break;case "counter":if(2>=a.values.length)return Rj(this,a.values);break;case "counters":if(3>=a.values.length)return Tj(this,a.values)}u.b("E_CSS_CONTENT_PROP:",a.toString());return new pd("")};var Vj=1/1048576;function Wj(a,b){for(var c in a)b[c]=a[c].clone()}
function Xj(){this.g=0;this.b={};this.Vb={};this.f={};this.d={};this.ya={};this.e={};this.Ob={};this.N=0}Xj.prototype.clone=function(){var a=new Xj;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b];Wj(this.Vb,a.Vb);Wj(this.f,a.f);Wj(this.d,a.d);Wj(this.ya,a.ya);Wj(this.e,a.e);Wj(this.Ob,a.Ob);a.N=this.N;return a};function lj(a,b,c){var d=a[b];d&&(c=d.g(c));a[b]=c}
function Yj(a,b,c){this.j=a;this.d=b;this.Ja=c;this.b=[[],[]];this.h={};this.u=this.w=this.e=null;this.Y=this.na=this.L=this.k=this.f="";this.G=this.D=null;this.Ia=this.oa=!0;this.g={};this.A=[{}];this.B=[new pd("\u201c"),new pd("\u201d"),new pd("\u2018"),new pd("\u2019")];this.l=0;this.lang="";this.Ka=[0];this.ea=0;this.wa=[]}function Cj(a,b){a.h[b]=(a.h[b]||0)+1}function Zj(a,b,c){(b=b[c])&&b.apply(a)}var ak=[];
function bk(a,b,c,d){a.e=null;a.w=d;a.k="";a.f="";a.L="";a.na="";a.u=b;a.Y="";a.D=ak;a.G=c;ck(a)}function dk(a,b,c){a.g[b]?a.g[b].push(c):a.g[b]=[c];c=a.A[a.A.length-1];c||(c={},a.A[a.A.length-1]=c);c[b]=!0}
function ek(a,b){var c=Od,d=b.display;d&&(c=d.evaluate(a.d));var e=null,d=null,f=b["counter-reset"];f&&(f=f.evaluate(a.d))&&(e=sg(f,!0));(f=b["counter-increment"])&&(f=f.evaluate(a.d))&&(d=sg(f,!1));"ol"!=a.f&&"ul"!=a.f||"http://www.w3.org/1999/xhtml"!=a.k||(e||(e={}),e["ua-list-item"]=0);c===Td&&(d||(d={}),d["ua-list-item"]=1);if(e)for(var g in e)dk(a,g,e[g]);if(d)for(var k in d)a.g[k]||dk(a,k,0),g=a.g[k],g[g.length-1]+=d[k];c===Td&&(c=a.g["ua-list-item"],b["ua-list-item-count"]=new U(new rd(c[c.length-
1]),0));a.A.push(null)}function fk(a){var b=a.A.pop();if(b)for(var c in b)(b=a.g[c])&&(1==b.length?delete a.g[c]:b.pop())}function Hj(a,b,c){ek(a,b);b.content&&(b.content=b.content.Fc(new Kj(a,c)));fk(a)}var gk="before transclusion-before footnote-call footnote-marker inner first-letter first-line  transclusion-after after".split(" ");
function hk(a,b,c){a.wa.push(b);a.G=null;a.e=b;a.w=c;a.k=b.namespaceURI;a.f=b.localName;var d=a.j.b[a.k];a.Y=d?d+a.f:"";a.L=b.getAttribute("id");a.na=b.getAttributeNS("http://www.w3.org/XML/1998/namespace","id");(d=b.getAttribute("class"))?a.u=d.split(/\s+/):a.u=ak;(d=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))?a.D=d.split(/\s+/):a.D=ak;"style"==a.f&&"http://www.gribuser.ru/xml/fictionbook/2.0"==a.k&&(a.u=[b.getAttribute("name")||""]);(d=b.getAttributeNS("http://www.w3.org/XML/1998/namespace",
"lang"))||"http://www.w3.org/1999/xhtml"!=a.k||(d=b.getAttribute("lang"));d&&(a.b[a.b.length-1].push(new Ij(a.lang)),a.lang=d.toLowerCase());d=a.Ka;a.ea=++d[d.length-1];d.push([0]);ck(a);d=c.quotes;c=null;d&&(d=d.evaluate(a.d))&&(c=new Jj(a.B),d===Vd?a.B=[new pd(""),new pd("")]:d instanceof id&&(a.B=d.values));ek(a,a.w);if(d=a.w._pseudos)for(var e=!0,f=0;f<gk.length;f++){var g=gk[f];g||(e=!1);(g=d[g])&&(e?Hj(a,g,b):a.b[a.b.length-2].push(new Gj(g,b)))}c&&a.b[a.b.length-2].push(c)}
function ck(a){var b;for(b=0;b<a.u.length;b++)Zj(a,a.j.ya,a.u[b]);for(b=0;b<a.D.length;b++)Zj(a,a.j.d,a.D[b]);Zj(a,a.j.e,a.L);Zj(a,a.j.Vb,a.f);""!=a.f&&Zj(a,a.j.Vb,"*");Zj(a,a.j.f,a.Y);null!==a.G&&(Zj(a,a.j.Ob,a.G),Zj(a,a.j.Ob,"*"));a.e=null;a.b.push([]);for(var c=1;-1<=c;--c){var d=a.b[a.b.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.oa=!0;a.Ia=!1}
Yj.prototype.pop=function(){for(var a=1;-1<=a;--a)for(var b=this.b[this.b.length-a-2],c=0;c<b.length;)b[c].pop(this,a)?b.splice(c,1):c++;this.b.pop();this.oa=!1};var ik=null;function jk(a,b,c,d,e,f,g){If.call(this,a,b,g);this.b=null;this.R=0;this.h=null;this.u=0;this.f=null;this.k=!1;this.H=c;this.g=d?d.g:ik?ik.clone():new Xj;this.B=e;this.l=f;this.j=0}t(jk,Jf);m=jk.prototype;m.vd=function(a){lj(this.g.Vb,"*",a)};
function kk(a,b){var c=a.b;if(0<c.length){c.sort(function(a,b){return b.d()-a.d()});for(var d=null,e=c.length-1;0<=e;e--)d=c[e],d.b=b,b=d;if(d.e(a.g))return}a.vd(b)}m.ab=function(a,b){if(b||a)this.R+=1,b&&a?this.b.push(new oj(a,b.toLowerCase())):b?this.b.push(new nj(b.toLowerCase())):this.b.push(new qj(a))};m.Cc=function(a){this.f?(u.b("::"+this.f,"followed by ."+a),this.b.push(new Aj(""))):(this.R+=256,this.b.push(new kj(a)))};
m.Pb=function(a,b){if(this.f)u.b("::"+this.f,"followed by :"+a),this.b.push(new Aj(""));else{switch(a.toLowerCase()){case "first-child":this.b.push(new wj);break;case "root":this.b.push(new xj);break;case "link":this.b.push(new nj("a"));this.b.push(new rj("","href"));break;case "-adapt-href-epub-type":case "href-epub-type":if(b&&1==b.length&&"string"==typeof b[0]){var c=new RegExp("(^|s)"+ua(b[0])+"($|s)");this.b.push(new pj(c))}else this.b.push(new Aj(""));break;case "-adapt-footnote-content":case "footnote-content":this.k=
!0;break;case "visited":case "active":case "hover":case "focus":this.b.push(new Aj(""));break;case "lang":b&&1==b.length&&"string"==typeof b[0]?this.b.push(new vj(new RegExp("^"+ua(b[0].toLowerCase())+"($|-)"))):this.b.push(new Aj(""));break;case "nth-child":b&&1==b.length?"number"==typeof b[0]?this.b.push(new yj(b[0])):"even"!==b[0]&&"odd"!==b[0]||this.b.push(new zj(b[0])):this.b.push(new Aj(""));break;case "before":case "after":case "first-line":case "first-letter":this.Qb(a,b);return;default:u.b("unknown pseudo-class selector: "+
a),this.b.push(new Aj(""))}this.R+=256}};
m.Qb=function(a,b){switch(a){case "before":case "after":case "first-line":case "first-letter":case "footnote-call":case "footnote-marker":case "inner":this.f?(u.b("Double pseudoelement ::"+this.f+"::"+a),this.b.push(new Aj(""))):this.f=a;break;case "first-n-lines":if(b&&1==b.length&&"number"==typeof b[0]){var c=Math.round(b[0]);if(0<c&&c==b[0]){this.f?(u.b("Double pseudoelement ::"+this.f+"::"+a),this.b.push(new Aj(""))):this.f="first-"+c+"-lines";break}}default:u.b("Unrecognized pseudoelement: ::"+a),
this.b.push(new Aj(""))}this.R+=1};m.Jc=function(a){this.R+=65536;this.b.push(new mj(a))};
m.dc=function(a,b,c,d){this.R+=256;b=b.toLowerCase();d=d||"";switch(c){case 0:this.b.push(new rj(a,b));break;case 39:this.b.push(new sj(a,b,d));break;case 45:this.b.push(new uj(a,b,new RegExp("(^|\\s)"+ua(d)+"($|\\s)")));break;case 44:this.b.push(new uj(a,b,new RegExp("^"+ua(d)+"($|-)")));break;case 50:"supported"==d?this.b.push(new tj(a,b)):u.b("Unsupported :: attr selector op:",d);break;default:u.b("Unsupported attr selector:",c)}};
m.eb=function(){var a="d"+this.u++;kk(this,new ij(new Bj(a)));this.b=[new Aj(a)]};m.Bc=function(){var a="c"+this.u++;kk(this,new ij(new Dj(a)));this.b=[new Aj(a)]};m.zc=function(){var a="a"+this.u++;kk(this,new ij(new Ej(a)));this.b=[new Aj(a)]};m.Gc=function(){var a="f"+this.u++;kk(this,new ij(new Fj(a)));this.b=[new Aj(a)]};m.Nb=function(){lk(this);this.f=null;this.k=!1;this.R=0;this.b=[]};
m.lb=function(){var a;0!=this.j?(Lf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.j=1,this.h={},this.f=null,this.R=0,this.k=!1,this.b=[])};m.error=function(a,b){Jf.prototype.error.call(this,a,b);1==this.j&&(this.j=0)};m.Db=function(a){Jf.prototype.Db.call(this,a);this.j=0};m.ma=function(){lk(this);Jf.prototype.ma.call(this);1==this.j&&(this.j=0)};m.fb=function(){Jf.prototype.fb.call(this)};function lk(a){if(a.b){var b=a.R,c;c=a.g;c=c.N+=Vj;kk(a,a.xd(b+c));a.b=null;a.f=null;a.k=!1;a.R=0}}
m.xd=function(a){var b=this.B;this.k&&(b=b?"xxx-bogus-xxx":"footnote");return new jj(this.h,a,this.f,b)};m.Wa=function(a,b,c){gh(this.l,a,b,c,this)};m.Lb=function(a,b){Kf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};m.tc=function(a,b){Kf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
m.Xa=function(a,b,c){"display"!=a||b!==Yd&&b!==Xd||(this.Xa("flow-options",new id([Id,de]),c),this.Xa("flow-into",b,c),b=Bd);(Ki.SIMPLE_PROPERTY||[]).forEach(function(d){d=d({name:a,value:b,important:c});a=d.name;b=d.value;c=d.important});var d=c?Ef(this):Ff(this);aj(this.h,a,this.H?new Xi(b,d,this.H):new U(b,d))};function mk(a,b){If.call(this,a,b,!1)}t(mk,Jf);
mk.prototype.Wa=function(a,b){if(this.d.values[a])this.error("E_CSS_NAME_REDEFINED "+a,this.Kb());else{var c=a.match(/height|^(top|bottom)$/)?"vh":"vw",c=new Wc(this.d,100,c),c=b.ha(this.d,c);this.d.values[a]=c}};function nk(a,b,c,d,e){If.call(this,a,b,!1);this.b=d;this.H=c;this.e=e}t(nk,Jf);nk.prototype.Wa=function(a,b,c){c?u.b("E_IMPORTANT_NOT_ALLOWED"):gh(this.e,a,b,c,this)};nk.prototype.Lb=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};
nk.prototype.tc=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};nk.prototype.Xa=function(a,b,c){c=c?Ef(this):Ff(this);c+=this.N;this.N+=Vj;aj(this.b,a,this.H?new Xi(b,c,this.H):new U(b,c))};function ok(a,b){eg.call(this,a);this.b={};this.e=b;this.N=0}t(ok,eg);ok.prototype.Wa=function(a,b,c){gh(this.e,a,b,c,this)};ok.prototype.Lb=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};ok.prototype.tc=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};
ok.prototype.Xa=function(a,b,c){c=(c?67108864:50331648)+this.N;this.N+=Vj;aj(this.b,a,new U(b,c))};var pk=new Af(function(){var a=L("uaStylesheetBase");yf(hh).then(function(b){var c=sa("user-agent-base.css",ra);b=new jk(null,null,null,null,null,b,!0);b.Db("UA");ik=b.g;hg(c,b,null,null).qa(a)});return N(a)},"uaStylesheetBaseFetcher");function qk(a,b,c){return(a=a["writing-mode"])&&(b=a.evaluate(b,"writing-mode"))&&b!==Nd?b===je:c}
function rk(a,b,c,d){var e={},f;for(f in a)$i(f)&&(e[f]=a[f]);a=a._regions;if((c||d)&&a)for(d&&(d=["footnote"],c=c?c.concat(d):d),d=0;d<c.length;d++){f=a[c[d]];for(var g in f)$i(g)&&(e[g]=Yi(b,e[g],f[g]))}return e}function sk(a,b,c,d){c=c?Vi:Wi;for(var e in a)if(a.hasOwnProperty(e)){var f=a[e];if(f){var g=c[e];if(g){var k=a[g];if(k&&k.Da>f.Da)continue;g=Qi[g]?g:e}else g=e;b[g]=d(e,f)}}};function tk(a,b,c){this.e=a;this.d=b;this.b=c}function uk(){this.map=[]}function vk(a){return 0==a.map.length?0:a.map[a.map.length-1].b}function wk(a,b){if(0==a.map.length)a.map.push(new tk(b,b,b));else{var c=a.map[a.map.length-1],d=c.b+b-c.d;c.d==c.e?(c.d=b,c.e=b,c.b=d):a.map.push(new tk(b,b,d))}}function xk(a,b){0==a.map.length?a.map.push(new tk(b,0,0)):a.map[a.map.length-1].d=b}function yk(a,b){var c=Xa(a.map.length,function(c){return b<=a.map[c].d}),c=a.map[c];return c.b-Math.max(0,c.e-b)}
function zk(a,b){var c=Xa(a.map.length,function(c){return b<=a.map[c].b}),c=a.map[c];return c.e-(c.b-b)}
function Ak(a,b,c,d,e,f,g){this.aa=a;this.root=a.root;this.ea=c;this.f=d;this.h=f;this.d=this.root;this.u={};this.w={};this.B=[];this.l=this.k=null;this.A=new Yj(b,d,g);this.e=new uk;this.Ra=!0;this.D=[];this.Y=e;this.L=this.G=!1;this.b=a=zh(a,this.root);wk(this.e,a);b=Bk(this,this.root);hk(this.A,this.root,b);Ck(this,b,!1);this.j=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.j=!1}this.D.push(!0);this.w={};this.w["e"+a]=
b;this.b++;Dk(this,-1)}function Ek(a,b,c,d){return(b=b[d])&&b.evaluate(a.f)!==c[d]}function Fk(a,b,c){for(var d in c){var e=b[d];e?(a.u[d]=e,delete b[d]):(e=c[d])&&(a.u[d]=new U(e,33554432))}}var Gk=["column-count","column-width"];
function Ck(a,b,c){c||["writing-mode","direction"].forEach(function(a){b[a]&&(this.u[a]=b[a])},a);if(!a.G){c=Ek(a,b,a.h.g,"background-color")?b["background-color"].evaluate(a.f):null;var d=Ek(a,b,a.h.g,"background-image")?b["background-image"].evaluate(a.f):null;if(c&&c!==Nd||d&&d!==Nd)Fk(a,b,a.h.g),a.G=!0}if(!a.L)for(c=0;c<Gk.length;c++)if(Ek(a,b,a.h.j,Gk[c])){Fk(a,b,a.h.j);a.L=!0;break}if(c=b["font-size"]){d=c.evaluate(a.f);c=d.C;switch(d.da){case "em":case "rem":c*=a.f.h;break;case "ex":case "rex":c*=
a.f.h*rc.ex/rc.em;break;case "%":c*=a.f.h/100;break;default:(d=rc[d.da])&&(c*=d)}a.f.Y=c}}function Hk(a){for(var b=0;!a.j&&(b+=5E3,Ik(a,b,0)!=Number.POSITIVE_INFINITY););return a.u}function Bk(a,b){if(b.style instanceof CSSStyleDeclaration){var c=b.getAttribute("style");if(c){var d=a.aa.url,e=new ok(a.ea,a.h),c=new ac(c,e);try{dg(new Wf(Nf,c,e,d),Number.POSITIVE_INFINITY,!1,!0,!1)}catch(f){u.b(f,"Style attribute parse error:")}return e.b}}return{}}
function Dk(a,b){if(!(b>=a.b)){var c=a.f,d=zh(a.aa,a.root);if(b<d){var e=a.g(a.root,!1),f=e["flow-into"],f=f?f.evaluate(c,"flow-into").toString():"body";Jk(a,f,e,a.root,d)}d=Ch(a.aa,b);e=Ah(a.aa,d,0,!1);if(!(e>=a.b))for(;;){if(1!=d.nodeType)e+=d.textContent.length;else{var g=d;if(e!=zh(a.aa,g))throw Error("Inconsistent offset");var k=a.g(g,!1);if(f=k["flow-into"])f=f.evaluate(c,"flow-into").toString(),Jk(a,f,k,g,e);e++}if(e>=a.b)break;f=d.firstChild;if(null==f)for(;!(f=d.nextSibling);)if(d=d.parentNode,
d===a.root)return;d=f}}}function Kk(a,b){a.k=b;for(var c=0;c<a.B.length;c++)Lk(a.k,a.B[c])}
function Jk(a,b,c,d,e){var f=0,g=Number.POSITIVE_INFINITY,k=!1,h=!1,l=!1,n=c["flow-options"];if(n){var p;a:{if(k=n.evaluate(a.f,"flow-options")){h=new mg;try{k.S(h);p=h.b;break a}catch(q){u.b(q,"toSet:")}}p={}}k=!!p.exclusive;h=!!p["static"];l=!!p.last}(p=c["flow-linger"])&&(g=og(p.evaluate(a.f,"flow-linger"),Number.POSITIVE_INFINITY));(c=c["flow-priority"])&&(f=og(c.evaluate(a.f,"flow-priority"),0));d=new bi(b,d,e,f,g,k,h,l);a.B.push(d);a.l==b&&(a.l=null);a.k&&Lk(a.k,d)}
function Ik(a,b,c){var d=-1;if(b<=a.b&&(d=yk(a.e,b),d+=c,d<vk(a.e)))return zk(a.e,d);if(null==a.d)return Number.POSITIVE_INFINITY;for(var e=a.f;;){var f=a.d.firstChild;if(null==f)for(;;){if(1==a.d.nodeType){var f=a.A,g=a.d;if(f.wa.pop()!==g)throw Error("Invalid call to popElement");f.Ka.pop();f.pop();fk(f);a.Ra=a.D.pop()}if(f=a.d.nextSibling)break;a.d=a.d.parentNode;if(a.d===a.root)return a.d=null,b<a.b&&(0>d&&(d=yk(a.e,b),d+=c),d<=vk(a.e))?zk(a.e,d):Number.POSITIVE_INFINITY}a.d=f;if(1!=a.d.nodeType)a.b+=
a.d.textContent.length,a.Ra?wk(a.e,a.b):xk(a.e,a.b);else{g=a.d;f=Bk(a,g);a.D.push(a.Ra);hk(a.A,g,f);a.j||"body"!=g.localName||g.parentNode!=a.root||(Ck(a,f,!0),a.j=!0);var k=f["flow-into"];k&&(k=k.evaluate(e,"flow-into").toString(),Jk(a,k,f,g,a.b),a.Ra=!!a.Y[k]);a.Ra&&(g=f.display)&&g.evaluate(e,"display")===Vd&&(a.Ra=!1);if(zh(a.aa,a.d)!=a.b)throw Error("Inconsistent offset");a.w["e"+a.b]=f;a.b++;a.Ra?wk(a.e,a.b):xk(a.e,a.b);if(b<a.b&&(0>d&&(d=yk(a.e,b),d+=c),d<=vk(a.e)))return zk(a.e,d)}}}
Ak.prototype.g=function(a,b){var c=zh(this.aa,a),d="e"+c;b&&(c=Ah(this.aa,a,0,!0));this.b<=c&&Ik(this,c,0);return this.w[d]};var Mk=1;function Qk(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.h=0;this.d=a;this.name=b;this.kb=c;this.ya=d;this.parent=e;this.g="p"+Mk++;e&&(this.h=e.children.length,e.children.push(this))}Qk.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Qk.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Rk(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
function Sk(a,b){for(var c=0;c<a.children.length;c++)a.children[c].clone({parent:b})}function Tk(a){Qk.call(this,a,null,null,[],null);this.b.width=new U(ne,0);this.b.height=new U(oe,0)}t(Tk,Qk);
function Uk(a,b){this.e=b;var c=this;lc.call(this,a,function(a,b){var f=a.match(/^([^.]+)\.([^.]+)$/);if(f){var g=c.e.j[f[1]];if(g&&(g=this.na[g])){if(b){var f=f[2],k=g.ea[f];if(k)g=k;else{switch(f){case "columns":var k=g.d.d,h=new bd(k,0),l=Vk(g,"column-count"),n=Vk(g,"column-width"),p=Vk(g,"column-gap"),k=E(k,dd(k,new Zc(k,"min",[h,l]),D(k,n,p)),p)}k&&(g.ea[f]=k);g=k}}else g=Vk(g,f[2]);return g}}return null})}t(Uk,lc);
function Wk(a,b,c,d,e,f,g){a=a instanceof Uk?a:new Uk(a,this);Qk.call(this,a,b,c,d,e);this.e=this;this.H=f;this.R=g;this.b.width=new U(ne,0);this.b.height=new U(oe,0);this.b["wrap-flow"]=new U(Ad,0);this.b.position=new U($d,0);this.b.overflow=new U(ke,0);this.j={}}t(Wk,Qk);Wk.prototype.f=function(a){return new Xk(a,this)};Wk.prototype.clone=function(a){a=new Wk(this.d,this.name,a.kb||this.kb,this.ya,this.parent,this.H,this.R);Rk(this,a);Sk(this,a);return a};
function Yk(a,b,c,d,e){Qk.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.j[b]=this.g);this.b["wrap-flow"]=new U(Ad,0)}t(Yk,Qk);Yk.prototype.f=function(a){return new Zk(a,this)};Yk.prototype.clone=function(a){a=new Yk(a.parent.d,this.name,this.kb,this.ya,a.parent);Rk(this,a);Sk(this,a);return a};function $k(a,b,c,d,e){Qk.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.j[b]=this.g)}t($k,Qk);$k.prototype.f=function(a){return new al(a,this)};
$k.prototype.clone=function(a){a=new $k(a.parent.d,this.name,this.kb,this.ya,a.parent);Rk(this,a);Sk(this,a);return a};function W(a,b,c){return b&&b!==Ad?b.ha(a,c):null}function bl(a,b,c){return b&&b!==Ad?b.ha(a,c):a.b}function cl(a,b,c){return b?b===Ad?null:b.ha(a,c):a.b}function dl(a,b,c,d){return b&&c!==Vd?b.ha(a,d):a.b}function el(a,b,c){return b?b===le?a.g:b===Jd?a.f:b.ha(a,a.b):c}
function fl(a,b){this.e=a;this.d=b;this.B={};this.style={};this.k=this.l=null;this.children=[];this.D=this.G=this.f=this.g=!1;this.w=this.A=0;this.u=null;this.na={};this.ea={};this.wa=this.b=!1;a&&a.children.push(this)}function gl(a,b,c){b=Vk(a,b);c=Vk(a,c);if(!b||!c)throw Error("E_INTERNAL");return D(a.d.d,b,c)}
function Vk(a,b){var c=a.na[b];if(c)return c;var d=a.style[b];d&&(c=d.ha(a.d.d,a.d.d.b));switch(b){case "margin-left-edge":c=Vk(a,"left");break;case "margin-top-edge":c=Vk(a,"top");break;case "margin-right-edge":c=gl(a,"border-right-edge","margin-right");break;case "margin-bottom-edge":c=gl(a,"border-bottom-edge","margin-bottom");break;case "border-left-edge":c=gl(a,"margin-left-edge","margin-left");break;case "border-top-edge":c=gl(a,"margin-top-edge","margin-top");break;case "border-right-edge":c=
gl(a,"padding-right-edge","border-right-width");break;case "border-bottom-edge":c=gl(a,"padding-bottom-edge","border-bottom-width");break;case "padding-left-edge":c=gl(a,"border-left-edge","border-left-width");break;case "padding-top-edge":c=gl(a,"border-top-edge","border-top-width");break;case "padding-right-edge":c=gl(a,"right-edge","padding-right");break;case "padding-bottom-edge":c=gl(a,"bottom-edge","padding-bottom");break;case "left-edge":c=gl(a,"padding-left-edge","padding-left");break;case "top-edge":c=
gl(a,"padding-top-edge","padding-top");break;case "right-edge":c=gl(a,"left-edge","width");break;case "bottom-edge":c=gl(a,"top-edge","height")}if(!c){if("extent"==b)d=a.b?"width":"height";else if("measure"==b)d=a.b?"height":"width";else{var e=a.b?Vi:Wi,d=b,f;for(f in e)d=d.replace(f,e[f])}d!=b&&(c=Vk(a,d))}c&&(a.na[b]=c);return c}
function hl(a){var b=a.d.d,c=a.style,d=el(b,c.enabled,b.g),e=W(b,c.page,b.b);if(e)var f=new Xc(b,"page-number"),d=cd(b,d,new Pc(b,e,f));(e=W(b,c["min-page-width"],b.b))&&(d=cd(b,d,new Oc(b,new Xc(b,"page-width"),e)));(e=W(b,c["min-page-height"],b.b))&&(d=cd(b,d,new Oc(b,new Xc(b,"page-height"),e)));d=a.L(d);c.enabled=new K(d)}fl.prototype.L=function(a){return a};
fl.prototype.Kc=function(){var a=this.d.d,b=this.style,c=this.e?this.e.style.width.ha(a,null):null,d=W(a,b.left,c),e=W(a,b["margin-left"],c),f=dl(a,b["border-left-width"],b["border-left-style"],c),g=bl(a,b["padding-left"],c),k=W(a,b.width,c),h=W(a,b["max-width"],c),l=bl(a,b["padding-right"],c),n=dl(a,b["border-right-width"],b["border-right-style"],c),p=W(a,b["margin-right"],c),q=W(a,b.right,c),r=D(a,f,g),v=D(a,f,l);d&&q&&k?(r=E(a,c,D(a,k,D(a,D(a,d,r),v))),e?p?q=E(a,r,p):p=E(a,r,D(a,q,e)):(r=E(a,r,
q),p?e=E(a,r,p):p=e=dd(a,r,new mc(a,.5)))):(e||(e=a.b),p||(p=a.b),d||q||k||(d=a.b),d||k?d||q?k||q||(k=this.l,this.g=!0):d=a.b:(k=this.l,this.g=!0),r=E(a,c,D(a,D(a,e,r),D(a,p,v))),this.g&&(h||(h=E(a,r,d?d:q)),this.b||!W(a,b["column-width"],null)&&!W(a,b["column-count"],null)||(k=h,this.g=!1)),d?k?q||(q=E(a,r,D(a,d,k))):k=E(a,r,D(a,d,q)):d=E(a,r,D(a,q,k)));a=bl(a,b["snap-width"]||(this.e?this.e.style["snap-width"]:null),c);b.left=new K(d);b["margin-left"]=new K(e);b["border-left-width"]=new K(f);b["padding-left"]=
...
fl.prototype.Lc=function(){var a=this.d.d,b=this.style,c=this.e?this.e.style.width.ha(a,null):null,d=this.e?this.e.style.height.ha(a,null):null,e=W(a,b.top,d),f=W(a,b["margin-top"],c),g=dl(a,b["border-top-width"],b["border-top-style"],c),k=bl(a,b["padding-top"],c),h=W(a,b.height,d),l=W(a,b["max-height"],d),n=bl(a,b["padding-bottom"],c),p=dl(a,b["border-bottom-width"],b["border-bottom-style"],c),q=W(a,b["margin-bottom"],c),r=W(a,b.bottom,d),v=D(a,g,k),y=D(a,p,n);e&&r&&h?(d=E(a,d,D(a,h,D(a,D(a,e,v),
y))),f?q?r=E(a,d,f):q=E(a,d,D(a,r,f)):(d=E(a,d,r),q?f=E(a,d,q):q=f=dd(a,d,new mc(a,.5)))):(f||(f=a.b),q||(q=a.b),e||r||h||(e=a.b),e||h?e||r?h||r||(h=this.k,this.f=!0):e=a.b:(h=this.k,this.f=!0),d=E(a,d,D(a,D(a,f,v),D(a,q,y))),this.f&&(l||(l=E(a,d,e?e:r)),this.b&&(W(a,b["column-width"],null)||W(a,b["column-count"],null))&&(h=l,this.f=!1)),e?h?r||(r=E(a,d,D(a,e,h))):h=E(a,d,D(a,r,e)):e=E(a,d,D(a,r,h)));a=bl(a,b["snap-height"]||(this.e?this.e.style["snap-height"]:null),c);b.top=new K(e);b["margin-top"]=
...
function il(a){var b=a.d.d,c=a.style;a=W(b,c[a.b?"height":"width"],null);var d=W(b,c["column-width"],a),e=W(b,c["column-count"],null),f;(f=(f=c["column-gap"])&&f!==Wd?f.ha(b,null):null)||(f=new Wc(b,1,"em"));d&&!e&&(e=new Zc(b,"floor",[ed(b,D(b,a,f),D(b,d,f))]),e=new Zc(b,"max",[b.d,e]));e||(e=b.d);d=E(b,ed(b,D(b,a,f),e),f);c["column-width"]=new K(d);c["column-count"]=new K(e);c["column-gap"]=new K(f)}function jl(a,b,c,d){a=a.style[b].ha(a.d.d,null);return zc(a,c,d,{})}
function kl(a,b){b.na[a.d.g]=a;var c=a.d.d,d=a.style,e=a.e?ll(a.e,b):null,e=rk(a.B,b,e,!1);a.b=qk(e,b,a.e?a.e.b:!1);sk(e,d,a.b,function(a,b){return b.value});a.l=new oc(c,function(){return a.A},"autoWidth");a.k=new oc(c,function(){return a.w},"autoHeight");a.Kc();a.Lc();il(a);hl(a)}function ml(a,b,c){(a=a.style[c])&&(a=lg(b,a,c));return a}function Y(a,b,c){(a=a.style[c])&&(a=lg(b,a,c));return wd(a,b)}
function ll(a,b){var c;a:{if(c=a.B["region-id"]){for(var d=[],e=0;e<c.length;e++){var f=c[e].evaluate(b,"");f&&f!==G&&d.push(f)}if(d.length){c=d;break a}}c=null}if(c){d=[];for(e=0;e<c.length;e++)d[e]=c[e].toString();return d}return null}function nl(a,b,c,d,e){if(a=ml(a,b,d))a.Mb()&&sc(a.da)&&(a=new I(wd(a,b),"px")),"font-family"===d&&(a=ph(e,a)),w(c.d,d,a.toString())}
function ol(a,b,c){var d=Y(a,b,"left"),e=Y(a,b,"margin-left"),f=Y(a,b,"padding-left"),g=Y(a,b,"border-left-width");a=Y(a,b,"width");yi(c,d,a);w(c.d,"margin-left",e+"px");w(c.d,"padding-left",f+"px");w(c.d,"border-left-width",g+"px");c.marginLeft=e;c.Y=g;c.j=f}
function pl(a,b,c){var d=Y(a,b,"right"),e=Y(a,b,"snap-height"),f=Y(a,b,"margin-right"),g=Y(a,b,"padding-right");b=Y(a,b,"border-right-width");w(c.d,"margin-right",f+"px");w(c.d,"padding-right",g+"px");w(c.d,"border-right-width",b+"px");c.marginRight=f;c.Ia=b;a.b&&0<e&&(a=d+vi(c),a=a-Math.floor(a/e)*e,0<a&&(c.$b=e-a,g+=c.$b));c.D=g;c.ac=e}
function ql(a,b,c){var d=Y(a,b,"snap-height"),e=Y(a,b,"top"),f=Y(a,b,"margin-top"),g=Y(a,b,"padding-top");b=Y(a,b,"border-top-width");c.top=e;c.marginTop=f;c.ea=b;c.Ja=d;!a.b&&0<d&&(a=e+si(c),a=a-Math.floor(a/d)*d,0<a&&(c.oa=d-a,g+=c.oa));c.k=g;w(c.d,"top",e+"px");w(c.d,"margin-top",f+"px");w(c.d,"padding-top",g+"px");w(c.d,"border-top-width",b+"px")}
function rl(a,b,c){var d=Y(a,b,"margin-bottom"),e=Y(a,b,"padding-bottom"),f=Y(a,b,"border-bottom-width");a=Y(a,b,"height")-c.oa;w(c.d,"height",a+"px");w(c.d,"margin-bottom",d+"px");w(c.d,"padding-bottom",e+"px");w(c.d,"border-bottom-width",f+"px");c.height=a-c.oa;c.marginBottom=d;c.wa=f;c.w=e}function sl(a,b,c){a.b?(ql(a,b,c),rl(a,b,c)):(pl(a,b,c),ol(a,b,c))}
function tl(a,b,c){w(c.d,"border-top-width","0px");var d=Y(a,b,"max-height");a.G?xi(c,0,d):(ql(a,b,c),d-=c.oa,c.height=d,w(c.d,"height",d+"px"))}function ul(a,b,c){w(c.d,"border-left-width","0px");var d=Y(a,b,"max-width");a.D?yi(c,0,d):(pl(a,b,c),d-=c.$b,c.width=d,a=Y(a,b,"right"),w(c.d,"right",a+"px"),w(c.d,"width",d+"px"))}
var vl="border-left-style border-right-style border-top-style border-bottom-style border-left-color border-right-color border-top-color border-bottom-color outline-style outline-color outline-width overflow visibility".split(" "),wl="border-top-left-radius border-top-right-radius border-bottom-right-radius border-bottom-left-radius border-image-source border-image-slice border-image-width border-image-outset border-image-repeat background-attachment background-color background-image background-repeat background-position background-clip background-origin background-size opacity z-index".split(" "),
xl="color font-family font-size font-style font-weight font-variant line-height letter-spacing text-align text-decoration text-indent text-transform white-space word-spacing".split(" "),yl=["transform","transform-origin"];
fl.prototype.jb=function(a,b,c,d){this.e&&this.b==this.e.b||w(b.d,"writing-mode",this.b?"vertical-rl":"horizontal-tb");(this.b?this.g:this.f)?this.b?ul(this,a,b):tl(this,a,b):(this.b?pl(this,a,b):ql(this,a,b),this.b?ol(this,a,b):rl(this,a,b));(this.b?this.f:this.g)?this.b?tl(this,a,b):ul(this,a,b):sl(this,a,b);for(c=0;c<vl.length;c++)nl(this,a,b,vl[c],d)};function zl(a,b,c,d){for(var e=0;e<xl.length;e++)nl(a,b,c,xl[e],d)}
fl.prototype.fc=function(a,b,c,d,e,f,g){this.b?this.A=b.e+b.$b:this.w=b.e+b.oa;f=(this.b||!d)&&this.f;var k=(!this.b||!d)&&this.g,h=null;if(k||f)k&&w(b.d,"width","auto"),f&&w(b.d,"height","auto"),h=(d?d.d:b.d).getBoundingClientRect(),k&&(this.A=Math.ceil(h.right-h.left-b.j-b.Y-b.D-b.Ia),this.b&&(this.A+=b.$b)),f&&(this.w=h.bottom-h.top-b.k-b.ea-b.w-b.wa,this.b||(this.w+=b.oa));(this.b?this.f:this.g)&&sl(this,a,b);if(this.b?this.g:this.f){if(this.b?this.D:this.G)this.b?pl(this,a,b):ql(this,a,b);this.b?
ol(this,a,b):rl(this,a,b)}if(1<e&&(f=Y(this,a,"column-rule-width"),k=ml(this,a,"column-rule-style"),h=ml(this,a,"column-rule-color"),0<f&&k&&k!=Vd&&h!=he)){var l=Y(this,a,"column-gap"),n=this.b?b.height:b.width,p=this.b?"border-top":"border-left";for(d=1;d<e;d++){var q=(n+l)*d/e-l/2+b.j-f/2,r=b.height+b.k+b.w,v=b.d.ownerDocument.createElement("div");w(v,"position","absolute");w(v,this.b?"left":"top","0px");w(v,this.b?"top":"left",q+"px");w(v,this.b?"height":"width","0px");w(v,this.b?"width":"height",
r+"px");w(v,p,f+"px "+k.toString()+(h?" "+h.toString():""));b.d.insertBefore(v,b.d.firstChild)}}for(d=0;d<wl.length;d++)nl(this,a,b,wl[d],g);for(d=0;d<yl.length;d++)e=b,g=yl[d],f=c.h,(k=ml(this,a,g))&&f.push(new Uh(e.d,g,k))};
fl.prototype.h=function(a,b){var c=this.B,d=this.d.b,e;for(e in d)$i(e)&&aj(c,e,d[e]);if("background-host"==this.d.kb)for(e in b)if(e.match(/^background-/)||"writing-mode"==e)c[e]=b[e];if("layout-host"==this.d.kb)for(e in b)e.match(/^background-/)||"writing-mode"==e||(c[e]=b[e]);bk(a,this.d.ya,null,c);c.content&&(c.content=c.content.Fc(new Kj(a,null)));kl(this,a.d);for(c=0;c<this.d.children.length;c++)this.d.children[c].f(this).h(a,b);a.pop()};
function Al(a,b){a.g&&(a.D=jl(a,"right",a.l,b)||jl(a,"margin-right",a.l,b)||jl(a,"border-right-width",a.l,b)||jl(a,"padding-right",a.l,b));a.f&&(a.G=jl(a,"top",a.k,b)||jl(a,"margin-top",a.k,b)||jl(a,"border-top-width",a.k,b)||jl(a,"padding-top",a.k,b));for(var c=0;c<a.children.length;c++)Al(a.children[c],b)}function Bl(a){fl.call(this,null,a)}t(Bl,fl);Bl.prototype.h=function(a,b){fl.prototype.h.call(this,a,b);this.children.sort(function(a,b){return b.d.R-a.d.R||a.d.h-b.d.h})};
function Xk(a,b){fl.call(this,a,b);this.u=this}t(Xk,fl);Xk.prototype.L=function(a){var b=this.d.e;b.H&&(a=cd(b.d,a,b.H));return a};Xk.prototype.Y=function(){};function Zk(a,b){fl.call(this,a,b);this.u=a.u}t(Zk,fl);function al(a,b){fl.call(this,a,b);this.u=a.u}t(al,fl);function Cl(a,b,c,d){var e=null;c instanceof qd&&(e=[c]);c instanceof jd&&(e=c.values);if(e)for(a=a.d.d,c=0;c<e.length;c++)if(e[c]instanceof qd){var f=jc(e[c].name,"enabled"),f=new Xc(a,f);d&&(f=new Fc(a,f));b=cd(a,b,f)}return b}
al.prototype.L=function(a){var b=this.d.d,c=this.style,d=el(b,c.required,b.f)!==b.f;if(d||this.f){var e;e=(e=c["flow-from"])?e.ha(b,b.b):new mc(b,"body");e=new Zc(b,"has-content",[e]);a=cd(b,a,e)}a=Cl(this,a,c["required-partitions"],!1);a=Cl(this,a,c["conflicting-partitions"],!0);d&&(c=(c=this.u.style.enabled)?c.ha(b,null):b.g,c=cd(b,c,a),this.u.style.enabled=new K(c));return a};al.prototype.jb=function(a,b,c,d){w(b.d,"overflow","hidden");fl.prototype.jb.call(this,a,b,c,d)};
function Dl(a,b,c,d){If.call(this,a,b,!1);this.target=c;this.b=d}t(Dl,Jf);Dl.prototype.Wa=function(a,b,c){gh(this.b,a,b,c,this)};Dl.prototype.tc=function(a,b){Kf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};Dl.prototype.Lb=function(a,b){Kf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Dl.prototype.Xa=function(a,b,c){this.target.b[a]=new U(b,c?50331648:67108864)};function El(a,b,c,d){Dl.call(this,a,b,c,d)}t(El,Dl);
function Fl(a,b,c,d){Dl.call(this,a,b,c,d);c.b.width=new U(me,0);c.b.height=new U(me,0)}t(Fl,Dl);Fl.prototype.Ub=function(a,b,c){a=new $k(this.d,a,b,c,this.target);Hf(this.$,new El(this.d,this.$,a,this.b))};Fl.prototype.Tb=function(a,b,c){a=new Yk(this.d,a,b,c,this.target);a=new Fl(this.d,this.$,a,this.b);Hf(this.$,a)};function Gl(a,b,c,d){Dl.call(this,a,b,c,d)}t(Gl,Dl);Gl.prototype.Ub=function(a,b,c){a=new $k(this.d,a,b,c,this.target);Hf(this.$,new El(this.d,this.$,a,this.b))};
Gl.prototype.Tb=function(a,b,c){a=new Yk(this.d,a,b,c,this.target);a=new Fl(this.d,this.$,a,this.b);Hf(this.$,a)};var Hl={"text-indent":"0px","margin-top":"0px","padding-top":"0px","border-top-width":"0px","border-top-style":"none","border-top-color":"transparent"},Il={"text-indent":"0px","margin-right":"0px","padding-right":"0px","border-right-width":"0px","border-right-style":"none","border-right-color":"transparent"},Jl={};
function Kl(a){a.addEventListener("load",function(){a.contentWindow.navigator.epubReadingSystem={name:"adapt",version:"0.1",layoutStyle:"paginated",hasFeature:function(a){switch(a){case "mouse-events":return!0}return!1}}},!1)}var Ll=(new DOMParser).parseFromString('<root xmlns="http://www.pyroxy.com/ns/shadow"/>',"text/xml"),Ml="footnote-marker first-5-lines first-4-lines first-3-lines first-2-lines first-line first-letter before  after".split(" ");
function Nl(a){return a.getAttribute("data-adapt-pseudo")||""}function Ol(a,b,c,d){this.style=b;this.f=a;this.b=c;this.d=d;this.e={}}
Ol.prototype.g=function(a){var b=Nl(a);this.b&&b&&b.match(/after$/)&&(this.style=this.b.g(this.f,!0),this.b=null);var c=this.style._pseudos[b]||{};if(!this.e[b]){this.e[b]=!0;var d=c.content;d&&(d=d.evaluate(this.d),Ai(d)&&d.S(new zi(a,this.d)))}if(b.match(/^first-/)&&!c["x-first-pseudo"]){a=1;var e;"first-letter"==b?a=0:null!=(e=b.match(/^first-([0-9]+)-lines$/))&&(a=e[1]-0);c["x-first-pseudo"]=new U(new sd(a),0)}return c};
function Pl(a,b,c,d,e,f,g,k,h,l,n,p,q){this.A=a;this.d=b;this.viewport=c;this.u=c.b;this.k=d;this.D=e;this.aa=f;this.B=g;this.l=k;this.G=h;this.e=l;this.h=n;this.w=p;this.g=q;this.L=this.b=null;this.j=!1;this.X=null;this.ba=0;this.f=null}Pl.prototype.clone=function(){return new Pl(this.A,this.d,this.viewport,this.k,this.D,this.aa,this.B,this.l,this.G,this.e,this.h,this.w,this.g)};
function Ql(a,b,c,d,e,f){var g=L("createRefShadow");a.aa.j.load(b).then(function(k){if(k){var h=Eh(k,b);if(h){var l=a.G,n=l.w[k.url];if(!n){var n=l.style.h.b[k.url],p=new tc(0,l.ib(),l.hb(),l.h),n=new Ak(k,n.d,n.g,p,l.e,n.j,l.k);l.w[k.url]=n}f=new fi(d,h,k,e,f,c,n)}}O(g,f)});return N(g)}
function Rl(a,b,c,d,e,f,g,k){var h=L("createShadows"),l=e.template,n;l instanceof ud?n=Ql(a,l.url,2,b,k,null):n=M(null);n.then(function(l){var n=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var r=b.getAttribute("href"),v=null;r?v=k?k.aa:a.aa:k&&(r="http://www.w3.org/1999/xhtml"==k.$.namespaceURI?k.$.getAttribute("href"):k.$.getAttributeNS("http://www.w3.org/1999/xlink","href"),v=k.Rc?k.Rc.aa:a.aa);r&&(r=sa(r,v.url),n=Ql(a,r,3,b,k,l))}null==n&&(n=M(l));n.then(function(l){var n;
if(n=d._pseudos){for(var q=Ll.createElementNS("http://www.pyroxy.com/ns/shadow","root"),p=q,r=0;r<Ml.length;r++){var v=Ml[r],pb;if(v){if(!n[v])continue;if(!("footnote-marker"!=v||c&&a.j))continue;if(v.match(/^first-/)&&(pb=e.display,!pb||pb===Od))continue;pb=Ll.createElementNS("http://www.w3.org/1999/xhtml","span");pb.setAttribute("data-adapt-pseudo",v)}else pb=Ll.createElementNS("http://www.pyroxy.com/ns/shadow","content");p.appendChild(pb);v.match(/^first-/)&&(p=pb)}l=new fi(b,q,null,k,l,2,new Ol(b,
d,f,g))}O(h,l)})});return N(h)}function Sl(a,b,c){a.L=b;a.j=c}function Tl(a,b,c,d){var e=a.d;c=rk(c,e,a.D,a.j);b=qk(c,e,b);sk(c,d,b,function(b,c){var d=c.evaluate(e,b);"font-family"==b&&(d=ph(a.B,d));return d});return b}
function Ul(a,b){for(var c=a.b.X,d=[],e=a.b.ca,f=-1;c&&1==c.nodeType;){var g=e&&e.root==c;if(!g||2==e.type){var k=(e?e.b:a.k).g(c,!1);d.push(k)}g?(c=e.$,e=e.Rc):(c=c.parentNode,f++)}c=vc(a.d,"em",0===f);c={"font-size":new U(new I(c,"px"),0)};e=new ej(c,a.d);for(f=d.length-1;0<=f;--f){var g=d[f],k=[],h;for(h in g)Mi[h]&&k.push(h);k.sort(re);for(var l=0;l<k.length;l++){var n=k[l];e.b=n;c[n]=g[n].Fc(e)}}for(var p in b)Mi[p]||(c[p]=b[p]);return c}
var Vl={a:"a",sub:"sub",sup:"sup",table:"table",tr:"tr",td:"td",th:"th",code:"code",body:"div",p:"p",v:"p",date:"p",emphasis:"em",strong:"strong",style:"span",strikethrough:"del"};function Wl(a,b){b=sa(b,a.aa.url);return a.w[b]||b}
function Xl(a,b){var c=!0,d=L("createElementView"),e=a.X,f=a.b.ca?a.b.ca.b:a.k,g=f.g(e,!1),k={};a.b.parent||(g=Ul(a,g));a.b.g=Tl(a,a.b.g,g,k);k.direction&&(a.b.D=k.direction.toString());var h=k["flow-into"];if(h&&h.toString()!=a.A)return O(d,!1),N(d);var l=k.display;if(l===Vd)return O(d,!1),N(d);Rl(a,e,null==a.b.parent,g,k,f,a.d,a.b.ca).then(function(f){a.b.va=f;var g=a.b.parent&&a.b.parent.k;f=k["float-reference"];var h=k["float"],r=k.clear;if(k.position===xd||k.position===$d)a.b.k=!0,h=null;g&&
(r=null,h!==Kd&&(h=null));g=h===Sd||h===ae||h===ge||h===Fd||h===Qd||h===Pd||h===Dd||h===Cd||h===Kd;h&&(delete k["float"],h===Kd&&(a.j?(g=!1,k.display=Bd):k.display=Od),a.b.k=!0);r&&(r===Nd&&a.b.parent&&a.b.parent.w&&(r=H(a.b.parent.w)),r===Sd||r===ae||r===Ed)&&(delete k.clear,k.display&&k.display!=Od&&(a.b.w=r.toString()));k.overflow===Ld&&(a.b.k=!0);var v=l===Td&&k["ua-list-item-count"];g||k["break-inside"]&&k["break-inside"]!==Ad?a.b.h++:l===fe&&(a.b.h+=10);a.b.d=!g&&!l||l===Od;a.b.j=g?h.toString():
null;a.b.L=f?f.toString():null;if(!a.b.d){if(f=k["break-after"])a.b.B=f.toString();if(f=k["break-before"])a.b.u=f.toString()}if(f=k["x-first-pseudo"])a.b.f=new gi(a.b.parent?a.b.parent.f:null,f.C);if(f=k["white-space"])switch(f.toString()){case "normal":case "nowrap":a.b.A=0;break;case "pre-line":a.b.A=1;break;case "pre":case "pre-wrap":a.b.A=2}var y=!1,J=null,X=[],P=e.namespaceURI,F=e.localName;if("http://www.w3.org/1999/xhtml"==P)"html"==F||"body"==F||"script"==F||"link"==F||"meta"==F?F="div":"vide_"==
...
Vl[F];F||(F=a.b.d?"span":"div")}else if("http://www.daisy.org/z3986/2005/ncx/"==P)if(P="http://www.w3.org/1999/xhtml","ncx"==F||"navPoint"==F)F="div";else if("navLabel"==F){if(F="span",h=e.parentNode){f=null;for(h=h.firstChild;h;h=h.nextSibling)if(1==h.nodeType&&(r=h,"http://www.daisy.org/z3986/2005/ncx/"==r.namespaceURI&&"content"==r.localName)){f=r.getAttribute("src");break}f&&(F="a",e=e.ownerDocument.createElementNS(P,"a"),e.setAttribute("href",f))}}else F="span";else"http://www.pyroxy.com/ns/shadow"==
P?(P="http://www.w3.org/1999/xhtml",F=a.b.d?"span":"div"):y=!!a.h;v?b?F="li":(F="div",l=Bd,k.display=l):"body"==F||"li"==F?F="div":"q"==F?F="span":"a"==F&&(f=k["hyperlink-processing"])&&"normal"!=f.toString()&&(F="span");k.behavior&&"none"!=k.behavior.toString()&&a.h&&(y=!0);var Ea;y?Ea=a.h(e,a.b.parent?a.b.parent.b:null,k):Ea=M(null);Ea.then(function(f){f?y&&(c="true"==f.getAttribute("data-adapt-process-children")):f=a.createElement(P,F);"a"==F&&f.addEventListener("click",a.e.B,!1);J&&(Yl(a,a.b,
"inner",J),f.appendChild(J));"iframe"==f.localName&&"http://www.w3.org/1999/xhtml"==f.namespaceURI&&Kl(f);if("http://www.gribuser.ru/xml/fictionbook/2.0"!=e.namespaceURI||"td"==F){for(var g=e.attributes,h=g.length,l=null,n=0;n<h;n++){var p=g[n],q=p.namespaceURI,r=p.localName,p=p.nodeValue;if(q)if("http://www.w3.org/2000/xmlns/"==q)continue;else"http://www.w3.org/1999/xlink"==q&&"href"==r&&(p=Wl(a,p));else{if(r.match(/^on/))continue;if("style"==r)continue;if("id"==r){$h(a.e,f,p);continue}"src"==r||
"href"==r||"poster"==r?p=Wl(a,p):"srcset"==r&&(p=p.split(",").map(function(b){return Wl(a,b.trim())}).join(","))}if(q){var Ea=Jl[q];Ea&&(r=Ea+":"+r)}"src"!=r||q||"img"!=F||"http://www.w3.org/1999/xhtml"!=P?"href"==r&&"image"==F&&"http://www.w3.org/2000/svg"==P&&"http://www.w3.org/1999/xlink"==q?a.e.f.push(vg(f,p)):q?f.setAttributeNS(q,r,p):f.setAttribute(r,p):l=p}l&&(g=vg(f,l),h=k.width,l=k.height,h&&h!==Ad&&l&&l!==Ad?a.e.f.push(g):X.push(g))}delete k.content;(g=k["list-style-image"])&&g instanceof
ud&&(g=g.url,X.push(vg(new Image,g)));Zl(a,f,k);g=k.widows;h=k.orphans;if(g||h){if(a.b.parent){a.b.l={};for(var be in a.b.parent.l)a.b.l[be]=a.b.parent.l[be]}g instanceof sd&&(a.b.l.widows=g.C);h instanceof sd&&(a.b.l.orphans=h.C)}if(!b&&!a.b.d){be=a.b.g?Il:Hl;for(var Pk in be)w(f,Pk,be[Pk])}v&&f.setAttribute("value",k["ua-list-item-count"].stringValue());a.f=f;X.length?ug(X).then(function(){O(d,c)}):pf().then(function(){O(d,c)})})});return N(d)}
function $l(a,b){var c=L("createNodeView"),d,e=!0;1==a.X.nodeType?d=Xl(a,b):(8==a.X.nodeType?a.f=null:a.f=document.createTextNode(a.X.textContent.substr(a.ba||0)),d=M(!0));d.then(function(b){e=b;(a.b.b=a.f)&&(b=a.b.parent?a.b.parent.b:a.L)&&b.appendChild(a.f);O(c,e)});return N(c)}function am(a,b,c){(a.b=b)?(a.X=b.X,a.ba=b.ba):(a.X=null,a.ba=-1);a.f=null;return a.b?$l(a,c):M(!0)}
function bm(a){if(null==a.ca||"content"!=a.X.localName||"http://www.pyroxy.com/ns/shadow"!=a.X.namespaceURI)return a;var b=a.fa,c=a.ca,d=a.parent,e,f;c.md?(f=c.md,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.Rc,e=c.$.firstChild,c=2);var g=a.X.nextSibling;g?(a.X=g,ii(a)):a.pa?a=a.pa:e?a=null:(a=a.parent.modify(),a.K=!0);if(e)return b=new hi(e,d,b),b.ca=f,b.Ma=c,b.pa=a,b;a.fa=b;return a}
function cm(a){var b=a.fa+1;if(a.K){if(!a.parent)return null;if(3!=a.Ma){var c=a.X.nextSibling;if(c)return a=a.modify(),a.fa=b,a.X=c,ii(a),bm(a)}if(a.pa)return a=a.pa.modify(),a.fa=b,a;a=a.parent.modify()}else{if(a.va&&(c=a.va.root,2==a.va.type&&(c=c.firstChild),c))return b=new hi(c,a,b),b.ca=a.va,b.Ma=a.va.type,bm(b);if(c=a.X.firstChild)return bm(new hi(c,a,b));1!=a.X.nodeType&&(b+=a.X.textContent.length-1-a.ba);a=a.modify()}a.fa=b;a.K=!0;return a}
function dm(a,b){b=cm(b);if(!b||b.K)return M(b);var c=L("nextInTree");am(a,b,!0).then(function(a){b.b&&a||(b=b.modify(),b.K=!0,b.b||(b.d=!0));O(c,b)});return N(c)}function em(a,b){if(b instanceof jd)for(var c=b.values,d=0;d<c.length;d++)em(a,c[d]);else b instanceof ud&&(c=b.url,a.e.f.push(vg(new Image,c)))}
function Zl(a,b,c){var d=c["background-image"];d&&em(a,d);for(var e in c)d=c[e],!Th[e]||"position"==e&&d!==$d?(d.Mb()&&sc(d.da)&&(d=new I(wd(d,a.d),"px")),w(b,e,d.toString())):a.e.h.push(new Uh(b,e,d))}function Yl(a,b,c,d){if(!b.K){var e=(b.ca?b.ca.b:a.k).g(a.X,!1);if(e=e._pseudos)if(e=e[c])c={},b.g=Tl(a,b.g,e,c),b=c.content,Ai(b)&&(b.S(new zi(d,a.d)),delete c.content),Zl(a,d,c)}}
function fm(a,b,c){var d=L("peelOff"),e=b.f,f=b.ba,g=b.K;if(0<c)b.b.textContent=b.b.textContent.substr(0,c),f+=c;else if(!g&&b.b&&0==f){var k=b.b.parentNode;k&&k.removeChild(b.b)}for(var h=b.fa+c,l=[];b.f===e;)l.push(b),b=b.parent;var n=l.pop(),p=n.pa;qf(function(){for(;0<l.length;){n=l.pop();b=new hi(n.X,b,h);0==l.length&&(b.ba=f,b.K=g);b.Ma=n.Ma;b.ca=n.ca;b.va=n.va;b.pa=n.pa?n.pa:p;p=null;var c=am(a,b,!1);if(c.za())return c}return M(!1)}).then(function(){O(d,b)});return N(d)}
Pl.prototype.createElement=function(a,b){return"http://www.w3.org/1999/xhtml"==a?this.u.createElement(b):this.u.createElementNS(a,b)};function gm(a,b,c){var d={},e=a.l._pseudos;b=Tl(a,b,a.l,d);if(e&&e.before){var f={},g=a.createElement("http://www.w3.org/1999/xhtml","span");g.setAttribute("data-adapt-pseudo","before");c.appendChild(g);Tl(a,b,e.before,f);delete f.content;Zl(a,g,f)}delete d.content;Zl(a,c,d);return b}
function Gi(a,b,c){return b.ba===c.ba&&b.K==c.K&&b.ja.length===c.ja.length&&b.ja.every(function(a,b){var f;f=c.ja[b];if(a.ca)if(f.ca){var g=1===a.ga.nodeType?a.ga:a.ga.parentElement,k=1===f.ga.nodeType?f.ga:f.ga.parentElement;f=a.ca.$===f.ca.$&&Nl(g)===Nl(k)}else f=!1;else f=a.ga===f.ga;return f}.bind(a))}function hm(a){this.b=a}function im(a){return a.getClientRects()}
function jm(a,b,c,d,e){this.f=a;this.fontSize=b;this.b=a.document;this.root=c||this.b.body;b=this.root.firstElementChild;b||(b=this.b.createElement("div"),b.setAttribute("data-vivliostyle-outer-zoom-box",!0),this.root.appendChild(b));c=b.firstElementChild;c||(c=this.b.createElement("div"),c.setAttribute("data-vivliostyle-spread-container",!0),b.appendChild(c));this.e=b;this.d=c;b=(new hm(a)).b.getComputedStyle(this.root,null);this.width=d||parseFloat(b.width)||a.innerWidth;this.height=e||parseFloat(b.height)||
a.innerHeight}jm.prototype.zoom=function(a,b,c){w(this.e,"width",a*c+"px");w(this.e,"height",b*c+"px");w(this.d,"width",a+"px");w(this.d,"height",b+"px");w(this.d,"transform","scale("+c+")")};Li("SIMPLE_PROPERTY",function(a){var b=a.name,c=a.value;switch(b){case "page-break-before":case "page-break-after":case "page-break-inside":return{name:b.replace(/^page-/,""),value:c===zd?Zd:c,important:a.important};default:return a}});var km={page:!0,left:!0,right:!0,recto:!0,verso:!0,column:!0,region:!0},lm={avoid:!0,"avoid-page":!0,"avoid-column":!0,"avoid-region":!0};function mm(a,b){return a?b?km[b]?b:km[a]?a:lm[b]?b:lm[a]?a:b:a:b};var nm={img:!0,svg:!0,audio:!0,video:!0};
function om(a,b,c){var d=a.b;if(!d)return NaN;if(1==d.nodeType){if(a.K){var e=d.getBoundingClientRect();if(e.right>=e.left&&e.bottom>=e.top)return c?e.left:e.bottom}return NaN}var e=NaN,f=d.ownerDocument.createRange(),g=d.textContent.length;if(!g)return NaN;a.K&&(b+=g);b>=g&&(b=g-1);f.setStart(d,b);f.setEnd(d,b+1);a=im(f);if(b=c){b=document.body;if(null==hb){var k=b.ownerDocument,f=k.createElement("div");f.style.position="absolute";f.style.top="0px";f.style.left="0px";f.style.width="100px";f.style.height=
"100px";f.style.overflow="hidden";f.style.lineHeight="16px";f.style.fontSize="16px";w(f,"writing-mode","vertical-rl");b.appendChild(f);g=k.createTextNode("a a a a a a a a a a a a a a a a");f.appendChild(g);k=k.createRange();k.setStart(g,0);k.setEnd(g,1);hb=50>k.getBoundingClientRect().left;b.removeChild(f)}b=hb}if(b){b=d.ownerDocument.createRange();b.setStart(d,0);b.setEnd(d,d.textContent.length);d=im(b);b=[];for(f=0;f<a.length;f++){g=a[f];for(k=0;k<d.length;k++){var h=d[k];if(g.top>=h.top&&g.bottom<=
h.bottom&&1>Math.abs(g.right-h.right)){b.push({top:g.top,left:h.left,bottom:h.bottom,right:h.right});break}}k==d.length&&(u.b("Could not fix character box"),b.push(g))}a=b}for(b=d=0;b<a.length;b++)f=a[b],g=c?f.bottom-f.top:f.right-f.left,f.right>f.left&&f.bottom>f.top&&(isNaN(e)||g>d)&&(e=c?f.left:f.bottom,d=g);return e}function pm(a,b){this.e=a;this.f=b}pm.prototype.d=function(a,b){return b<this.f?null:qm(a,this,0<b)};pm.prototype.b=function(){return this.f};
function rm(a,b,c,d){this.position=a;this.f=b;this.g=c;this.e=d}rm.prototype.d=function(a,b){var c;b<this.b()?c=null:(a.e=this.e,c=this.position);return c};rm.prototype.b=function(){return(lm[this.f]?1:0)+(this.g?3:0)+(this.position.parent?this.position.parent.h:0)};function sm(a,b,c){this.fa=a;this.d=b;this.b=c}
function tm(a){for(var b=1;b<a.length;b++){var c=a[b-1],d=a[b];c===d?u.b("validateCheckPoints: duplicate entry"):c.fa>=d.fa?u.b("validateCheckPoints: incorrect boxOffset"):c.X==d.X&&(d.K?c.K&&u.b("validateCheckPoints: duplicate after points"):c.K?u.b("validateCheckPoints: inconsistent after point"):d.fa-c.fa!=d.ba-c.ba&&u.b("validateCheckPoints: boxOffset inconsistent with offsetInNode"))}}
function um(a,b,c){ri.call(this,a);this.Zc=a.lastChild;this.g=b;this.vc=c;this.Fd=a.ownerDocument;this.wc=!1;this.na=this.Za=this.Ea=this.od=this.Ka=0;this.cb=this.ub=this.l=this.h=null;this.$c=!1;this.L=this.f=this.u=null;this.pd=!0;this.yc=this.xc=0}t(um,ri);um.prototype.clone=function(){var a=new um(this.d,this.g,this.vc);wi(a,this);a.Zc=this.Zc;a.wc=this.wc;a.l=this.l?this.l.clone():null;a.ub=this.ub.concat();return a};
function vm(a,b){var c=(a.b?a.Za:a.Ka)-a.h.W,d=(a.b?a.Ka:a.Ea)-a.h.U;return new se(b.W-c,b.U-d,b.T-c,b.O-d)}function wm(a,b){return a.b?b<a.na:b>a.na}function xm(a,b,c){var d=new hi(b.ga,c,0);d.Ma=b.Ma;d.ca=b.ca;d.va=b.va;d.pa=b.pa?xm(a,b.pa,ki(c)):null;return d}
function ym(a,b){var c=L("openAllViews"),d=b.ja;Sl(a.g,a.d,a.wc);var e=d.length-1,f=null;qf(function(){for(;0<=e;){f=xm(a,d[e],f);if(0==e&&(f.ba=b.ba,f.K=b.K,f.K))break;var c=am(a.g,f,0==e&&0==f.ba);e--;if(c.za())return c}return M(!1)}).then(function(){O(c,f)});return N(c)}var zm=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
function Am(a,b){if(b.f&&b.d&&!b.K&&0==b.f.count&&1!=b.b.nodeType){var c=b.b.textContent.match(zm);return fm(a.g,b,c[0].length)}return M(b)}function Bm(a,b,c){var d=L("buildViewToNextBlockEdge");rf(function(d){b.b&&c.push(ki(b));Am(a,b).then(function(f){f!==b&&(b=f,c.push(ki(b)));dm(a.g,b).then(function(c){(b=c)?b.j&&!a.b?Cm(a,b).then(function(c){b=c;!b||b.e||0<a.g.g.b.length?Q(d):tf(d)}):b.d?tf(d):Q(d):Q(d)})})}).then(function(){O(d,b)});return N(d)}
function Dm(a,b){if(!b.b)return M(b);var c=b.X,d=L("buildDeepElementView");rf(function(d){Am(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.X!=c;)g=g.parent;if(null==g){b=f;Q(d);return}}dm(a.g,f).then(function(a){(b=a)&&b.X!=c?tf(d):Q(d)})})}).then(function(){O(d,b)});return N(d)}function Em(a,b,c,d,e){var f=a.Fd.createElement("div");a.b?(w(f,"height",d+"px"),w(f,"width",e+"px")):(w(f,"width",d+"px"),w(f,"height",e+"px"));w(f,"float",c);w(f,"clear",c);a.d.insertBefore(f,b);return f}
function Fm(a){for(var b=a.d.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.d.removeChild(b);else break}b=c}}function Gm(a){for(var b=a.d.firstChild,c=a.cb,d=a.b?a.h.U:a.h.W,e=a.b?a.h.O:a.h.T,f=0;f<c.length;f++){var g=c[f],k=g.O-g.U;g.left=Em(a,b,"left",g.W-d,k);g.right=Em(a,b,"right",e-g.T,k)}}
function Hm(a,b,c,d,e){var f;if(b&&b.K&&!b.d&&(f=om(b,0,a.b),!isNaN(f)))return f;b=c[d];for(e-=b.fa;;){f=om(b,e,a.b);if(!isNaN(f))return f;if(0<e)e--;else{d--;if(0>d)return a.Ea;b=c[d];1!=b.b.nodeType&&(e=b.b.textContent.length)}}}function Im(a){return"number"==typeof a?a:(a=a.match(/^(-?[0-9]*(\.[0-9]*)?)px$/))?parseFloat(a[0]):0}
function Jm(a,b){var c=a.vc.b.getComputedStyle(b,null),d=new ue;c&&(d.left=Im(c.marginLeft),d.top=Im(c.marginTop),d.right=Im(c.marginRight),d.bottom=Im(c.marginBottom));return d}
function Km(a,b,c){if(a=a.vc.b.getComputedStyle(b,null))c.marginLeft=Im(a.marginLeft),c.Y=Im(a.borderLeftWidth),c.j=Im(a.paddingLeft),c.marginTop=Im(a.marginTop),c.ea=Im(a.borderTopWidth),c.k=Im(a.paddingTop),c.marginRight=Im(a.marginRight),c.Ia=Im(a.borderRightWidth),c.D=Im(a.paddingRight),c.marginBottom=Im(a.marginBottom),c.wa=Im(a.borderBottomWidth),c.w=Im(a.paddingBottom)}function Lm(a,b,c){b=new sm(b,c,c);a.f?a.f.push(b):a.f=[b]}
function Mm(a,b,c,d){if(a.f&&a.f[a.f.length-1].b)return Lm(a,b,c),M(!0);d+=40*(a.b?-1:1);var e=a.l,f=!e;if(f){var g=a.d.ownerDocument.createElement("div");w(g,"position","absolute");var k=a.g.clone(),e=new um(g,k,a.vc);a.l=e;e.b=gm(a.g,a.b,g);e.wc=!0;a.b?(e.left=0,w(e.d,"width","2em")):(e.top=a.Za,w(e.d,"height","2em"))}a.d.appendChild(e.d);Km(a,e.d,e);g=(a.b?-1:1)*(d-a.Ea);a.b?e.height=a.h.O-a.h.U-si(e)-ti(e):e.width=a.h.T-a.h.W-ui(e)-vi(e);d=(a.b?-1:1)*(a.Za-d)-(a.b?ui(e)-vi(e):si(e)+ti(e));if(f&&
18>d)return a.d.removeChild(e.d),a.l=null,Lm(a,b,c),M(!0);if(!a.b&&e.top<g)return a.d.removeChild(e.d),Lm(a,b,c),M(!0);var h=L("layoutFootnoteInner");a.b?yi(e,0,d):xi(e,g,d);e.A=a.A+a.left+ui(a);e.B=a.B+a.top+si(a);e.G=a.G;var l=new ni(c);f?(Nm(e),f=M(!0)):0==e.G.length?(Om(e),f=M(!0)):f=Pm(e);f.then(function(){Qm(e,l).then(function(d){a.b?(a.na=a.Za+(e.e+ui(e)+vi(e)),yi(e,0,e.e)):(a.na=a.Za-(e.e+si(e)+ti(e)),xi(e,a.na-a.Ea,e.e));var f;!a.b&&0<e.G.length?f=Pm(e):f=M(d);f.then(function(d){d=new sm(b,
c,d?d.Ra:null);a.f?a.f.push(d):a.f=[d];O(h,!0)})})});return N(h)}
function Rm(a,b){var c=L("layoutFootnote"),d=b.b;d.setAttribute("style","");w(d,"display","inline-block");d.textContent="M";var e=d.getBoundingClientRect(),f=a.b?e.left:e.bottom;d.textContent="";Yl(a.g,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d={ja:[{ga:b.X,Ma:0,ca:b.ca,va:null,pa:null}],ba:0,K:!1};e=b.fa;b=b.modify();b.K=!0;Mm(a,e,d,f).then(function(){a.l&&a.l.d.parentNode&&a.d.removeChild(a.l.d);wm(a,f)&&0!=a.u.length&&(b.e=!0);O(c,b)});return N(c)}
function Sm(a,b){var c=L("layoutFloat"),d=b.b,e=b.j,f=b.L,g=b.parent?b.parent.D:"ltr",k=a.g.g,h=b.b.parentNode;"page"===f?Ei(k,d,e):(w(d,"float","none"),w(d,"position","absolute"),w(d,"left","auto"),w(d,"right","auto"),w(d,"top","auto"));Dm(a,b).then(function(l){var n=d.getBoundingClientRect(),p=Jm(a,d),n=new se(n.left-p.left,n.top-p.top,n.right+p.right,n.bottom+p.bottom);if("page"===f)Fi(k,b,a.g)?(n=h.ownerDocument.createElement("span"),w(n,"width","0"),w(n,"height","0"),h.appendChild(n),l.b=n,O(c,
l)):Hi(k,b,vm(a,n)).then(function(){O(c,null)});else{e=Bi(e,a.b,g);for(var p=a.Ka,q=a.od,r=b.parent;r&&r.d;)r=r.parent;if(r){var v=r.b.ownerDocument.createElement("div");v.style.left="0px";v.style.top="0px";a.b?(v.style.bottom="0px",v.style.width="1px"):(v.style.right="0px",v.style.height="1px");r.b.appendChild(v);var y=v.getBoundingClientRect(),p=Math.max(a.b?y.top:y.left,p),q=Math.min(a.b?y.bottom:y.right,q);r.b.removeChild(v);r=a.b?n.O-n.U:n.T-n.W;"left"==e?q=Math.max(q,p+r):p=Math.min(p,q-r)}p=
new se(p,(a.b?-1:1)*a.Ea,q,(a.b?-1:1)*a.Za);q=n;a.b&&(q=Ke(n));Pe(p,a.cb,q,e);a.b&&(n=new se(-q.O,q.W,-q.U,q.T));w(d,"left",n.W-(a.b?a.Za:a.Ka)+a.j+"px");w(d,"top",n.U-(a.b?a.Ka:a.Ea)+a.k+"px");n=a.b?n.W:n.O;wm(a,n)&&0!=a.u.length?(b=b.modify(),b.e=!0,O(c,b)):(Fm(a),p=a.b?Ke(a.h):a.h,a.b?q=Ke(vm(a,new se(-q.O,q.W,-q.U,q.T))):q=vm(a,q),Qe(p,a.cb,q,e),Gm(a),"left"==e?a.xc=n:a.yc=n,Tm(a,n),O(c,l))}});return N(c)}
function Um(a,b){for(var c=a.b,d="";c&&b&&!d&&(1!=c.nodeType||(d=c.style.textAlign,b));c=c.parentNode);if(!b||"justify"==d){var c=a.b,e=c.ownerDocument,d=e.createElement("span");d.style.visibility="hidden";d.textContent=" ########################";d.setAttribute("data-adapt-spec","1");var f=b&&(a.K||1!=c.nodeType)?c.nextSibling:c;if(c=c.parentNode)c.insertBefore(d,f),b||(e=e.createElement("div"),c.insertBefore(e,f),d.style.lineHeight="80px",e.style.marginTop="-80px",e.style.height="0px",e.setAttribute("data-adapt-spec",
"1"))}}function Vm(a,b,c,d){var e=L("processLineStyling");tm(d);var f=d.concat([]);d.splice(0,d.length);var g=0,k=b.f;0==k.count&&(k=k.Pd);rf(function(d){if(k){var e=Wm(a,f),n=k.count-g;if(e.length<=n)Q(d);else{var p=Xm(a,f,e[n-1]);Ym(a,p,!1,!1).then(function(){g+=n;fm(a.g,p,0).then(function(e){b=e;Um(b,!1);k=b.f;f=[];Bm(a,b,f).then(function(b){c=b;0<a.g.g.b.length?Q(d):tf(d)})})})}}else Q(d)}).then(function(){Array.prototype.push.apply(d,f);tm(d);O(e,c)});return N(e)}
function Zm(a,b){for(var c=0,d=0,e=b.length-1;0<=e;e--){var f=b[e];if(!f.K||!f.b||1!=f.b.nodeType)break;f=Jm(a,f.b);f=a.b?-f.left:f.bottom;0<f?c=Math.max(c,f):d=Math.min(d,f)}return c-d}
function $m(a,b){var c=L("layoutBreakableBlock"),d=[];Bm(a,b,d).then(function(e){if(0<a.g.g.b.length)O(c,e);else{var f=d.length-1;if(0>f)O(c,e);else{var f=Hm(a,e,d,f,d[f].fa),g=wm(a,f);null==e&&(f+=Zm(a,d));Tm(a,f);var k;b.f?k=Vm(a,b,e,d):k=M(e);k.then(function(b){0<d.length&&(a.u.push(new pm(d,d[0].h)),g&&(2!=d.length&&0<a.u.length||d[0].X!=d[1].X||!nm[d[0].X.localName])&&b&&(b=b.modify(),b.e=!0));O(c,b)})}}});return N(c)}
function Xm(a,b,c){tm(b);for(var d=0,e=b[0].fa,f=d,g=b.length-1,k=b[g].fa,h;e<k;){h=e+Math.ceil((k-e)/2);for(var f=d,l=g;f<l;){var n=f+Math.ceil((l-f)/2);b[n].fa>h?l=n-1:f=n}l=Hm(a,null,b,f,h);if(a.b?l<c:l>c){for(k=h-1;b[f].fa==h;)f--;g=f}else Tm(a,l),e=h,d=f}a=b[f];b=a.b;1!=b.nodeType&&(a.K?a.ba=b.length:(e-=a.fa,c=b.data,173==c.charCodeAt(e)?(b.replaceData(e,c.length-e,"-"),e++):(d=c.charAt(e),e++,f=c.charAt(e),b.replaceData(e,c.length-e,Ua(d)&&Ua(f)?"-":"")),0<e&&(a=a.modify(),a.ba+=e,a.u=null)));
return a}
function Wm(a,b){for(var c=[],d=b[0].b,e=b[b.length-1].b,f=[],g=d.ownerDocument.createRange(),k=!1,h=null,l=!1,n=!0;n;){var p=!0;do{var q=null;d==e&&(n=!1);1!=d.nodeType?(l||(g.setStartBefore(d),l=!0),h=d):k?k=!1:d.getAttribute("data-adapt-spec")?p=!l:q=d.firstChild;q||(q=d.nextSibling,q||(k=!0,q=d.parentNode));d=q}while(p&&n);if(l){g.setEndAfter(h);l=im(g);for(p=0;p<l.length;p++)f.push(l[p]);l=!1}}f.sort(a.b?ei:di);h=d=k=g=e=0;for(n=a.b?-1:1;;){if(h<f.length&&(l=f[h],p=1,0<d&&(p=Math.max(a.b?l.right-
...
function an(a,b){if(!a.f)return M(!0);for(var c=!1,d=a.f.length-1;0<=d;--d){var e=a.f[d];if(e.fa<=b)break;a.f.pop();e.b!==e.d&&(c=!0)}if(!c)return M(!0);var f=L("clearFootnotes"),g=a.e+a.Ea,k=a.f;a.l=null;a.f=null;var h=0;qf(function(){for(;h<k.length;){var b=k[h++],b=Mm(a,b.fa,b.d,g);if(b.za())return b}return M(!1)}).then(function(){O(f,!0)});return N(f)}
function qm(a,b,c){var d=b.e,e;if(c)e=c=1;else{for(e=d[0];e.parent&&e.d;)e=e.parent;c=Math.max((e.l.widows||2)-0,1);e=Math.max((e.l.orphans||2)-0,1)}var f=Wm(a,d),g=a.na,d=Xa(f.length,function(b){return a.b?f[b]<g:f[b]>g}),d=Math.min(f.length-c,d);if(d<e)return null;g=f[d-1];if(b=Xm(a,b.e,g))a.e=(a.b?-1:1)*(g-a.Ea);return b}
function Ym(a,b,c,d){var e=b;c=c||null!=b.b&&1==b.b.nodeType&&!b.K;do{var f=e.b.parentNode;if(!f)break;var g=f,k=e.b;if(g)for(var h=void 0;(h=g.lastChild)!=k;)g.removeChild(h);c&&(f.removeChild(e.b),c=!1);e=e.parent}while(e);d&&Um(b,!0);return an(a,b.fa)}
function bn(a,b,c){var d=L("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,k=a.u.length-1;0<=k&&!e;--k){var e=a.u[k].d(a,f),h=a.u[k].b();h>f&&(g=Math.min(g,h))}while(g>f&&!e);var l=!1;if(!e){u.b("Could not find any page breaks?!!");if(a.pd)return cn(a,b).then(function(b){b?(b=b.modify(),b.e=!1,Ym(a,b,l,!0).then(function(){O(d,b)})):O(d,b)}),N(d);e=c;l=!0}Ym(a,e,l,!0).then(function(){O(d,e)});return N(d)}
function dn(a){a=a.toString();return""==a||"auto"==a||!!a.match(/^0+(.0*)?[^0-9]/)}function en(a,b,c,d,e){if(!b)return!1;var f=om(b,0,a.b),g=wm(a,f);c&&(f+=Zm(a,c));Tm(a,f);if(d||!g)b=new rm(ki(b),e,g,a.e),a.u.push(b);return g}
function fn(a,b){if(b.b.parentNode){var c=Jm(a,b.b),d=b.b.ownerDocument.createElement("div");a.b?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.b.parentNode.insertBefore(d,b.b);var e=d.getBoundingClientRect(),e=a.b?e.right:e.top,f=a.b?-1:1,g;switch(b.w){case "left":g=a.xc;break;case "right":g=a.yc;break;default:g=f*Math.max(a.yc*f,a.xc*f)}e*f>=g*f?b.b.parentNode.removeChild(d):(e=Math.max(1,(g-e)*
...
function gn(a,b,c){var d=L("skipEdges"),e=null,f=null,g=[];rf(function(d){for(;b;){do if(b.b){if(b.d&&1!=b.b.nodeType){if(ai(b.b,b.A))break;if(!b.K){en(a,f,null,!0,e)?(b=(f||b).modify(),b.e=!0):(b=b.modify(),b.u=e);Q(d);return}}if(!b.K&&(b.w&&fn(a,b),b.j)){en(a,f,null,!0,e)&&(b=(f||b).modify(),b.e=!0);Q(d);return}if(1==b.b.nodeType){var h=b.b.style;if(b.K){if(f=ki(b),g.push(f),e=mm(e,b.B),h&&(!dn(h.paddingBottom)||!dn(h.borderBottomWidth))){if(en(a,f,null,!0,e)){b=(f||b).modify();b.e=!0;Q(d);return}g=
[f];f=e=null}}else{e=mm(e,b.u);if(!c&&km[e]){Q(d);a.L=e;return}if(nm[b.b.localName]){en(a,f,null,!0,e)&&(b=(f||b).modify(),b.e=!0);Q(d);return}if(h&&(!dn(h.paddingTop)||!dn(h.borderTopWidth))){if(en(a,f,null,!0,e)){b=(f||b).modify();b.e=!0;Q(d);return}f=e=null;g=[]}}}}while(0);h=dm(a.g,b);if(h.za()){h.then(function(a){b=a;tf(d)});return}b=h.cc()}0!=a.u.length&&en(a,f,g,!1,e)&&f&&(b=f.modify(),b.e=!0);Q(d)}).then(function(){O(d,b)});return N(d)}
function cn(a,b){var c=b,d=L("skipEdges"),e=null;rf(function(d){for(;b;){do if(b.b){if(b.d&&1!=b.b.nodeType){if(ai(b.b,b.A))break;if(!b.K){Q(d);return}}if(!b.K&&b.j){Q(d);return}if(1==b.b.nodeType){var g=b.b.style;if(b.K)e=mm(e,b.B);else{e=mm(e,b.u);if(km[e]){Q(d);a.L=e;return}if(nm[b.b.localName]){Q(d);return}if(g&&(!dn(g.paddingTop)||!dn(g.borderTopWidth))){Q(d);return}}}}while(0);g=dm(a.g,b);if(g.za()){g.then(function(a){b=a;tf(d)});return}b=g.cc()}c=null;Q(d)}).then(function(){O(d,c)});return N(d)}
function Cm(a,b){return"footnote"==b.j?Rm(a,b):Sm(a,b)}function hn(a,b,c){var d=L("layoutNext");gn(a,b,c).then(function(c){b=c;if(!b||a.L||b.e)O(d,b);else if(b.j)Cm(a,b).qa(d);else{a:{if(!b.K)switch(b.X.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!0}c?$m(a,b).qa(d):Dm(a,b).qa(d)}});return N(d)}
function Om(a){var b=a.d.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.k+"px";b.style.right=a.D+"px";b.style.bottom=a.w+"px";b.style.left=a.j+"px";a.d.appendChild(b);var c=b.getBoundingClientRect();a.d.removeChild(b);var b=a.A+a.left+ui(a),d=a.B+a.top+si(a);a.h=new se(b,d,b+a.width,d+a.height);a.Ka=c?a.b?c.top:c.left:0;a.od=c?a.b?c.bottom:c.right:0;a.Ea=c?a.b?c.right:c.top:0;a.Za=c?a.b?c.left:c.bottom:0;a.xc=a.Ea;a.yc=a.Ea;a.na=a.Za;c=a.h;b=a.A+a.left+ui(a);d=a.B+a.top+
si(a);b=a.Zb?Ae(a.Zb,b,d):Ce(b,d,b+a.width,d+a.height);a.cb=Me(c,[b],a.G,a.Ja,a.b);Gm(a);a.f=null}function Nm(a){a.ub=[];w(a.d,"width",a.width+"px");w(a.d,"height",a.height+"px");Om(a);a.e=0;a.$c=!1;a.L=null}function Tm(a,b){a.e=Math.max((a.b?-1:1)*(b-a.Ea),a.e)}function jn(a,b){var c=b.b;if(!c)return M(!0);var d=L("layoutOverflownFootnotes"),e=0;qf(function(){for(;e<c.length;){var b=c[e++],b=Mm(a,0,b,a.Ea);if(b.za())return b}return M(!1)}).then(function(){O(d,!0)});return N(d)}
function Qm(a,b){a.ub.push(b);if(a.$c)return M(b);var c=L("layout");jn(a,b).then(function(){ym(a,b.Ra).then(function(b){var e=b,f=!0;a.u=[];rf(function(c){for(;b;){var k=!0;hn(a,b,f).then(function(h){f=!1;b=h;0<a.g.g.b.length?Q(c):a.L?Q(c):b&&b.e?bn(a,b,e).then(function(a){b=a;Q(c)}):k?k=!1:tf(c)});if(k){k=!1;return}}Q(c)}).then(function(){var e=a.l;e&&(a.d.appendChild(e.d),a.b?a.e=this.Ea-this.Za:a.e=e.top+si(e)+e.e+ti(e));if(b)if(0<a.g.g.b.length)O(c,null);else{a.$c=!0;e=new ni(mi(b));if(a.f){for(var f=
[],h=0;h<a.f.length;h++){var l=a.f[h].b;l&&f.push(l)}e.b=f.length?f:null}O(c,e)}else O(c,null)})})});return N(c)}function Pm(a){for(var b=a.ub,c=a.d.lastChild;c!=a.Zc;){var d=c.previousSibling;a.d===c.parentNode&&Nl(c)||a.d.removeChild(c);c=d}Fm(a);Nm(a);var e=L("redoLayout"),f=0,g=null;rf(function(c){if(f<b.length){var d=b[f++];Qm(a,d).then(function(a){a?(g=a,Q(c)):tf(c)})}else Q(c)}).then(function(){O(e,g)});return N(e)};function kn(a,b){this.e(a,"end",b)}function ln(a,b){this.e(a,"start",b)}function mn(a,b,c){c||(c=this.g.now());var d=this.f[a];d||(d=this.f[a]=[]);var e;for(a=d.length-1;0<=a&&(!(e=d[a])||e[b]);a--)e=null;e||(e={},d.push(e));e[b]=c}function nn(){}function on(a){this.g=a;this.f={};this.registerEndTiming=this.d=this.registerStartTiming=this.b=this.e=nn}
on.prototype.h=function(){var a=this.f,b="";Object.keys(a).forEach(function(c){for(var d=a[c],e=d.length,f=0;f<e;f++){var g=d[f];b+=c;1<e&&(b+="("+f+")");b+=" => start: "+g.start+", end: "+g.end+", duration: "+(g.end-g.start)+"\n"}});u.e(b)};on.prototype.j=function(){this.registerEndTiming=this.d=this.registerStartTiming=this.b=this.e=nn};on.prototype.k=function(){this.e=mn;this.registerStartTiming=this.b=ln;this.registerEndTiming=this.d=kn};
var pn={now:Date.now},qn,rn=qn=new on(window&&window.performance||pn);mn.call(rn,"load_vivliostyle","start",void 0);ba("vivliostyle.profile.profiler",rn);on.prototype.printTimings=on.prototype.h;on.prototype.disable=on.prototype.j;on.prototype.enable=on.prototype.k;function sn(a,b,c){function d(c){return a.b.getComputedStyle(b,null).getPropertyValue(c)}function e(){w(b,"display","block");w(b,"position","static");return d(X)}function f(){w(b,"display","inline-block");w(v,X,"99999999px");var a=d(X);w(v,X,"");return a}function g(){w(b,"display","inline-block");w(v,X,"0");var a=d(X);w(v,X,"");return a}function k(){var a=e(),b=g(),c=parseFloat(a);if(c<=parseFloat(b))return b;b=f();return c<=parseFloat(b)?a:b}function h(){throw Error("Getting fill-available block size is not implemented");
...
d(P);break;case "fit-content width":c=J?d(P):k();break;case "fit-content height":c=J?k():d(P)}F[a]=parseFloat(c);w(b,"position",n);w(b,"display",l)});w(b,"width",p);w(b,"height",q);r.insertBefore(b,v);r.removeChild(v);return F};function tn(a){var b=a["writing-mode"],b=b&&b.value;a=(a=a.direction)&&a.value;return b===ie||b!==je&&a!==ee?"ltr":"rtl"}
var un={a5:{width:new I(148,"mm"),height:new I(210,"mm")},a4:{width:new I(210,"mm"),height:new I(297,"mm")},a3:{width:new I(297,"mm"),height:new I(420,"mm")},b5:{width:new I(176,"mm"),height:new I(250,"mm")},b4:{width:new I(250,"mm"),height:new I(353,"mm")},"jis-b5":{width:new I(182,"mm"),height:new I(257,"mm")},"jis-b4":{width:new I(257,"mm"),height:new I(364,"mm")},letter:{width:new I(8.5,"in"),height:new I(11,"in")},legal:{width:new I(8.5,"in"),height:new I(14,"in")},ledger:{width:new I(11,"in"),
height:new I(17,"in")}},vn=new I(.24,"pt"),wn=new I(3,"mm"),xn=new I(10,"mm"),yn=new I(13,"mm");
function zn(a){var b={width:ne,height:oe,wb:pe,ob:pe},c=a.size;if(c&&c.value!==Ad){var d=c.value;d.Nc()?(c=d.values[0],d=d.values[1]):(c=d,d=null);if(c.Mb())b.width=c,b.height=d||c;else if(c=un[c.name.toLowerCase()])d&&d===Rd?(b.width=c.height,b.height=c.width):(b.width=c.width,b.height=c.height)}(c=a.marks)&&c.value!==Vd&&(b.ob=yn);a=a.bleed;a&&a.value!==Ad?a.value&&a.value.Mb()&&(b.wb=a.value):c&&(a=!1,c.value.Nc()?a=c.value.values.some(function(a){return a===Gd}):a=c.value===Gd,a&&(b.wb=new I(6,
"pt")));return b}function An(a,b){var c={},d=a.wb.C*vc(b,a.wb.da,!1),e=a.ob.C*vc(b,a.ob.da,!1),f=d+e,g=a.width;c.ib=g===ne?(b.Q.Ua?Math.floor(b.wa/2)-b.Q.Ab:b.wa)-2*f:g.C*vc(b,g.da,!1);g=a.height;c.hb=g===oe?b.cb-2*f:g.C*vc(b,g.da,!1);c.wb=d;c.ob=e;c.Ec=f;return c}function Bn(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
function Cn(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg",c||"polyline");a.setAttribute("stroke","black");a.setAttribute("stroke-width",b);a.setAttribute("fill","none");return a}var Dn={he:"top left",ie:"top right",Zd:"bottom left",$d:"bottom right"};
function En(a,b,c,d,e,f){var g=d;g<=e+2*rc.mm&&(g=e+d/2);var k=Math.max(d,g),h=e+k+c/2,l=Bn(a,h,h),g=[[0,e+d],[d,e+d],[d,e+d-g]];d=g.map(function(a){return[a[1],a[0]]});if("top right"===b||"bottom right"===b)g=g.map(function(a){return[e+k-a[0],a[1]]}),d=d.map(function(a){return[e+k-a[0],a[1]]});if("bottom left"===b||"bottom right"===b)g=g.map(function(a){return[a[0],e+k-a[1]]}),d=d.map(function(a){return[a[0],e+k-a[1]]});h=Cn(a,c);h.setAttribute("points",g.map(function(a){return a.join(",")}).join(" "));
l.appendChild(h);a=Cn(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));l.appendChild(a);b.split(" ").forEach(function(a){l.style[a]=f+"px"});return l}var Fn={ge:"top",Yd:"bottom",Dd:"left",Ed:"right"};
function Gn(a,b,c,d,e){var f=2*d,g;"top"===b||"bottom"===b?(g=f,f=d):g=d;var k=Bn(a,g,f),h=Cn(a,c);h.setAttribute("points","0,"+f/2+" "+g+","+f/2);k.appendChild(h);h=Cn(a,c);h.setAttribute("points",g/2+",0 "+g/2+","+f);k.appendChild(h);a=Cn(a,c,"circle");a.setAttribute("cx",g/2);a.setAttribute("cy",f/2);a.setAttribute("r",d/4);k.appendChild(a);var l;switch(b){case "top":l="bottom";break;case "bottom":l="top";break;case "left":l="right";break;case "right":l="left"}Object.keys(Fn).forEach(function(a){a=
Fn[a];a===b?k.style[a]=e+"px":a!==l&&(k.style[a]="0",k.style["margin-"+a]="auto")});return k}function Hn(a,b,c,d){var e=!1,f=!1;if(a=a.marks)a=a.value,a.Nc()?a.values.forEach(function(a){a===Gd?e=!0:a===Hd&&(f=!0)}):a===Gd?e=!0:a===Hd&&(f=!0);if(e||f){var g=c.M,k=g.ownerDocument,h=b.wb,l=wd(vn,d),n=wd(wn,d),p=wd(xn,d);e&&Object.keys(Dn).forEach(function(a){a=En(k,Dn[a],l,p,h,n);g.appendChild(a)});f&&Object.keys(Fn).forEach(function(a){a=Gn(k,Fn[a],l,p,n);g.appendChild(a)})}}
var In=function(){var a={width:!0,height:!0,"block-size":!0,"inline-size":!0,margin:!0,padding:!0,border:!0,outline:!0,"outline-width":!0,"outline-style":!0,"outline-color":!0};"left right top bottom before after start end block-start block-end inline-start inline-end".split(" ").forEach(function(b){a["margin-"+b]=!0;a["padding-"+b]=!0;a["border-"+b+"-width"]=!0;a["border-"+b+"-style"]=!0;a["border-"+b+"-color"]=!0});return a}(),Jn={"top-left-corner":{N:1,ua:!0,ra:!1,sa:!0,ta:!0,ia:null},"top-left":{N:2,
...
ra:!0,sa:!1,ta:!1,ia:"center"},"bottom-left":{N:12,ua:!1,ra:!0,sa:!1,ta:!1,ia:"start"},"bottom-left-corner":{N:13,ua:!1,ra:!0,sa:!0,ta:!1,ia:null},"left-bottom":{N:14,ua:!1,ra:!1,sa:!0,ta:!1,ia:"end"},"left-middle":{N:15,ua:!1,ra:!1,sa:!0,ta:!1,ia:"center"},"left-top":{N:16,ua:!1,ra:!1,sa:!0,ta:!1,ia:"start"}},Kn=Object.keys(Jn).sort(function(a,b){return Jn[a].N-Jn[b].N});
function Ln(a,b,c){Wk.call(this,a,null,"vivliostyle-page-rule-master",[],b,null,0);a=zn(c);new Mn(this.d,this,c,a);this.l={};Nn(this,c);this.b.position=new U($d,0);this.b.width=new U(a.width,0);this.b.height=new U(a.height,0);for(var d in c)In[d]||"background-clip"===d||(this.b[d]=c[d])}t(Ln,Wk);function Nn(a,b){var c=b._marginBoxes;c&&Kn.forEach(function(d){c[d]&&(a.l[d]=new On(a.d,a,d,b))})}Ln.prototype.f=function(a){return new Pn(a,this)};
function Mn(a,b,c,d){$k.call(this,a,null,null,[],b);this.u=d;this.b["z-index"]=new U(new sd(0),0);this.b["flow-from"]=new U(H("body"),0);this.b.position=new U(xd,0);this.b.overflow=new U(ke,0);for(var e in In)In.hasOwnProperty(e)&&(this.b[e]=c[e])}t(Mn,$k);Mn.prototype.f=function(a){return new Qn(a,this)};
function On(a,b,c,d){$k.call(this,a,null,null,[],b);this.k=c;a=d._marginBoxes[this.k];for(var e in d)if(b=d[e],c=a[e],Mi[e]||c&&c.value===Nd)this.b[e]=b;for(e in a)Object.prototype.hasOwnProperty.call(a,e)&&(b=a[e])&&b.value!==Nd&&(this.b[e]=b)}t(On,$k);On.prototype.f=function(a){return new Rn(a,this)};function Pn(a,b){Xk.call(this,a,b);this.j=null;this.oa={}}t(Pn,Xk);
Pn.prototype.h=function(a,b){var c=this.B,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}Xk.prototype.h.call(this,a,b)};Pn.prototype.Kc=function(){var a=this.style;a.left=pe;a["margin-left"]=pe;a["border-left-width"]=pe;a["padding-left"]=pe;a["padding-right"]=pe;a["border-right-width"]=pe;a["margin-right"]=pe;a.right=pe};
Pn.prototype.Lc=function(){var a=this.style;a.top=pe;a["margin-top"]=pe;a["border-top-width"]=pe;a["padding-top"]=pe;a["padding-bottom"]=pe;a["border-bottom-width"]=pe;a["margin-bottom"]=pe;a.bottom=pe};Pn.prototype.Y=function(a,b,c){b=b.u;var d={start:this.j.marginLeft,end:this.j.marginRight,Z:this.j.yb},e={start:this.j.marginTop,end:this.j.marginBottom,Z:this.j.xb};Sn(this,b.top,!0,d,a,c);Sn(this,b.bottom,!0,d,a,c);Sn(this,b.left,!1,e,a,c);Sn(this,b.right,!1,e,a,c)};
function Tn(a,b,c,d,e){this.M=a;this.l=e;this.g=c;this.k=!W(d,b[c?"width":"height"],new Wc(d,0,"px"));this.h=null}Tn.prototype.b=function(){return this.k};function Un(a){a.h||(a.h=sn(a.l,a.M.d,a.g?["max-content width","min-content width"]:["max-content height","min-content height"]));return a.h}Tn.prototype.e=function(){var a=Un(this);return this.g?ui(this.M)+a["max-content width"]+vi(this.M):si(this.M)+a["max-content height"]+ti(this.M)};
Tn.prototype.f=function(){var a=Un(this);return this.g?ui(this.M)+a["min-content width"]+vi(this.M):si(this.M)+a["min-content height"]+ti(this.M)};Tn.prototype.d=function(){return this.g?ui(this.M)+this.M.width+vi(this.M):si(this.M)+this.M.height+ti(this.M)};function Vn(a){this.g=a}Vn.prototype.b=function(){return this.g.some(function(a){return a.b()})};Vn.prototype.e=function(){var a=this.g.map(function(a){return a.e()});return Math.max.apply(null,a)*a.length};
Vn.prototype.f=function(){var a=this.g.map(function(a){return a.f()});return Math.max.apply(null,a)*a.length};Vn.prototype.d=function(){var a=this.g.map(function(a){return a.d()});return Math.max.apply(null,a)*a.length};function Wn(a,b,c,d,e,f){Tn.call(this,a,b,c,d,e);this.j=f}t(Wn,Tn);Wn.prototype.b=function(){return!1};Wn.prototype.e=function(){return this.d()};Wn.prototype.f=function(){return this.d()};Wn.prototype.d=function(){return this.g?ui(this.M)+this.j+vi(this.M):si(this.M)+this.j+ti(this.M)};
function Sn(a,b,c,d,e,f){var g=a.d.d,k={},h={},l={},n;for(n in b){var p=Jn[n];if(p){var q=b[n],r=a.oa[n],v=new Tn(q,r.style,c,g,f);k[p.ia]=q;h[p.ia]=r;l[p.ia]=v}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.Z.evaluate(e);var y=Xn(l,b),J=!1,X={};Object.keys(k).forEach(function(a){var b=W(g,h[a].style[c?"max-width":"max-height"],d.Z);b&&(b=b.evaluate(e),y[a]>b&&(b=l[a]=new Wn(k[a],h[a].style,c,g,f,b),X[a]=b.d(),J=!0))});J&&(y=Xn(l,b),J=!1,["start","center","end"].forEach(function(a){y[a]=X[a]||y[a]}));
var P={};Object.keys(k).forEach(function(a){var b=W(g,h[a].style[c?"min-width":"min-height"],d.Z);b&&(b=b.evaluate(e),y[a]<b&&(b=l[a]=new Wn(k[a],h[a].style,c,g,f,b),P[a]=b.d(),J=!0))});J&&(y=Xn(l,b),["start","center","end"].forEach(function(a){y[a]=P[a]||y[a]}));var F=a+b,Ea=a+(a+b);["start","center","end"].forEach(function(a){var b=y[a];if(b){var d=k[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(Ea-b)/2;break;case "end":e=F-b}c?yi(d,e,b-ui(d)-vi(d)):xi(d,e,b-si(d)-ti(d))}})}
function Xn(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=Yn(d,g.length?new Vn(g):null,b);g.Oa&&(f.center=g.Oa);d=g.Oa||d.d();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=Yn(c,e,b),c.Oa&&(f.start=c.Oa),c.Yb&&(f.end=c.Yb);return f}
function Yn(a,b,c){var d={Oa:null,Yb:null};if(a&&b)if(a.b()&&b.b()){var e=a.e(),f=b.e();0<e&&0<f?(f=e+f,f<c?d.Oa=c*e/f:(a=a.f(),b=b.f(),b=a+b,b<c?d.Oa=a+(c-b)*(e-a)/(f-b):0<b&&(d.Oa=c*a/b)),0<d.Oa&&(d.Yb=c-d.Oa)):0<e?d.Oa=c:0<f&&(d.Yb=c)}else a.b()?d.Oa=Math.max(c-b.d(),0):b.b()&&(d.Yb=Math.max(c-a.d(),0));else a?a.b()&&(d.Oa=c):b&&b.b()&&(d.Yb=c);return d}Pn.prototype.jb=function(a,b,c,d){Pn.Bd.jb.call(this,a,b,c,d);b.d.setAttribute("data-vivliostyle-page-box",!0)};
function Qn(a,b){al.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.xb=this.yb=null}t(Qn,al);
Qn.prototype.h=function(a,b){var c=this.B,d;for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(d.match(/^column.*$/)||d.match(/^background-/))&&(c[d]=b[d]);al.prototype.h.call(this,a,b);d=this.e;c={yb:this.yb,xb:this.xb,marginTop:this.marginTop,marginRight:this.marginRight,marginBottom:this.marginBottom,marginLeft:this.marginLeft};d.j=c;d=d.style;d.width=new K(c.yb);d.height=new K(c.xb);d["padding-left"]=new K(c.marginLeft);d["padding-right"]=new K(c.marginRight);d["padding-top"]=new K(c.marginTop);
d["padding-bottom"]=new K(c.marginBottom)};Qn.prototype.Kc=function(){var a=Zn(this,{start:"left",end:"right",Z:"width"});this.yb=a.rd;this.marginLeft=a.zd;this.marginRight=a.yd};Qn.prototype.Lc=function(){var a=Zn(this,{start:"top",end:"bottom",Z:"height"});this.xb=a.rd;this.marginTop=a.zd;this.marginBottom=a.yd};
function Zn(a,b){var c=a.style,d=a.d.d,e=b.start,f=b.end,g=b.Z,k=a.d.u[g].ha(d,null),h=W(d,c[g],k),l=W(d,c["margin-"+e],k),n=W(d,c["margin-"+f],k),p=bl(d,c["padding-"+e],k),q=bl(d,c["padding-"+f],k),r=dl(d,c["border-"+e+"-width"],c["border-"+e+"-style"],k),v=dl(d,c["border-"+f+"-width"],c["border-"+f+"-style"],k),y=E(d,k,D(d,D(d,r,p),D(d,v,q)));h?(y=E(d,y,h),l||n?l?n=E(d,y,l):l=E(d,y,n):n=l=dd(d,y,new mc(d,.5))):(l||(l=d.b),n||(n=d.b),h=E(d,y,D(d,l,n)));c[e]=new K(l);c[f]=new K(n);c["margin-"+e]=
pe;c["margin-"+f]=pe;c["padding-"+e]=new K(p);c["padding-"+f]=new K(q);c["border-"+e+"-width"]=new K(r);c["border-"+f+"-width"]=new K(v);c[g]=new K(h);c["max-"+g]=new K(h);return{rd:E(d,k,D(d,l,n)),zd:l,yd:n}}Qn.prototype.jb=function(a,b,c,d){al.prototype.jb.call(this,a,b,c,d);c.w=b.d};function Rn(a,b){al.call(this,a,b);var c=b.k;this.j=Jn[c];a.oa[c]=this;this.wa=!0}t(Rn,al);m=Rn.prototype;
m.jb=function(a,b,c,d){var e=b.d;w(e,"display","flex");var f=ml(this,a,"vertical-align"),g=null;f===H("middle")?g="center":f===H("top")?g="flex-start":f===H("bottom")&&(g="flex-end");g&&(w(e,"flex-flow",this.b?"row":"column"),w(e,"justify-content",g));al.prototype.jb.call(this,a,b,c,d)};
m.ia=function(a,b){var c=this.style,d=this.d.d,e=a.start,f=a.end,g="left"===e,k=g?b.yb:b.xb,h=W(d,c[a.Z],k),g=g?b.marginLeft:b.marginTop;if("start"===this.j.ia)c[e]=new K(g);else if(h){var l=bl(d,c["margin-"+e],k),n=bl(d,c["margin-"+f],k),p=bl(d,c["padding-"+e],k),q=bl(d,c["padding-"+f],k),r=dl(d,c["border-"+e+"-width"],c["border-"+e+"-style"],k),f=dl(d,c["border-"+f+"-width"],c["border-"+f+"-style"],k),h=D(d,h,D(d,D(d,p,q),D(d,D(d,r,f),D(d,l,n))));switch(this.j.ia){case "center":c[e]=new K(D(d,g,
ed(d,E(d,k,h),new mc(d,2))));break;case "end":c[e]=new K(E(d,D(d,g,k),h))}}};
function $n(a,b,c){function d(a){if(y)return y;y={Z:v?v.evaluate(a):null,Ga:h?h.evaluate(a):null,Ha:l?l.evaluate(a):null};var b=k.evaluate(a),c=0;[q,n,p,r].forEach(function(b){b&&(c+=b.evaluate(a))});(null===y.Ga||null===y.Ha)&&c+y.Z+y.Ga+y.Ha>b&&(null===y.Ga&&(y.Ga=0),null===y.Ha&&(y.ne=0));null!==y.Z&&null!==y.Ga&&null!==y.Ha&&(y.Ha=null);null===y.Z&&null!==y.Ga&&null!==y.Ha?y.Z=b-c-y.Ga-y.Ha:null!==y.Z&&null===y.Ga&&null!==y.Ha?y.Ga=b-c-y.Z-y.Ha:null!==y.Z&&null!==y.Ga&&null===y.Ha?y.Ha=b-c-y.Z-
y.Ga:null===y.Z?(y.Ga=y.Ha=0,y.Z=b-c):y.Ga=y.Ha=(b-c-y.Z)/2;return y}var e=a.style;a=a.d.d;var f=b.Mc,g=b.Qc;b=b.Z;var k=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],h=cl(a,e["margin-"+f],k),l=cl(a,e["margin-"+g],k),n=bl(a,e["padding-"+f],k),p=bl(a,e["padding-"+g],k),q=dl(a,e["border-"+f+"-width"],e["border-"+f+"-style"],k),r=dl(a,e["border-"+g+"-width"],e["border-"+g+"-style"],k),v=W(a,e[b],k),y=null;e[b]=new K(new oc(a,function(){var a=d(this).Z;return null===a?0:a},b));e["margin-"+f]=new K(new oc(a,
function(){var a=d(this).Ga;return null===a?0:a},"margin-"+f));e["margin-"+g]=new K(new oc(a,function(){var a=d(this).Ha;return null===a?0:a},"margin-"+g));"left"===f?e.left=new K(D(a,c.marginLeft,c.yb)):"top"===f&&(e.top=new K(D(a,c.marginTop,c.xb)))}m.Kc=function(){var a=this.e.j;this.j.sa?$n(this,{Mc:"right",Qc:"left",Z:"width"},a):this.j.ta?$n(this,{Mc:"left",Qc:"right",Z:"width"},a):this.ia({start:"left",end:"right",Z:"width"},a)};
m.Lc=function(){var a=this.e.j;this.j.ua?$n(this,{Mc:"bottom",Qc:"top",Z:"height"},a):this.j.ra?$n(this,{Mc:"top",Qc:"bottom",Z:"height"},a):this.ia({start:"top",end:"bottom",Z:"height"},a)};m.fc=function(a,b,c,d,e,f,g){al.prototype.fc.call(this,a,b,c,d,e,f,g);a=c.u;c=this.d.k;d=this.j;d.sa||d.ta?d.ua||d.ra||(d.sa?a.left[c]=b:d.ta&&(a.right[c]=b)):d.ua?a.top[c]=b:d.ra&&(a.bottom[c]=b)};
function ao(a,b,c,d,e){this.b=a;this.h=b;this.f=c;this.d=d;this.e=e;this.g={};a=this.h;b=new Xc(a,"page-number");b=new Pc(a,new Vc(a,b,new mc(a,2)),a.b);c=new Fc(a,b);a.values["recto-page"]=c;a.values["verso-page"]=b;"ltr"===tn(this.e)?(a.values["left-page"]=b,b=new Fc(a,b),a.values["right-page"]=b):(c=new Fc(a,b),a.values["left-page"]=c,a.values["right-page"]=b)}function bo(a){var b={};bk(a.b,[],"",b);a.b.pop();return b}
function co(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof U?e.value+"":co(a,e);c.push(d+f+(e.Da||""))}return c.sort().join("^")}function eo(a){this.b=null;this.f=a}t(eo,V);eo.prototype.apply=function(a){a.G===this.f&&this.b.apply(a)};eo.prototype.d=function(){return 3};eo.prototype.e=function(a){this.b&&lj(a.Ob,this.f,this.b);return!0};function fo(a){this.b=null;this.f=a}t(fo,V);
fo.prototype.apply=function(a){1===(new Xc(this.f,"page-number")).evaluate(a.d)&&this.b.apply(a)};fo.prototype.d=function(){return 2};function go(a){this.b=null;this.f=a}t(go,V);go.prototype.apply=function(a){(new Xc(this.f,"left-page")).evaluate(a.d)&&this.b.apply(a)};go.prototype.d=function(){return 1};function ho(a){this.b=null;this.f=a}t(ho,V);ho.prototype.apply=function(a){(new Xc(this.f,"right-page")).evaluate(a.d)&&this.b.apply(a)};ho.prototype.d=function(){return 1};
function io(a){this.b=null;this.f=a}t(io,V);io.prototype.apply=function(a){(new Xc(this.f,"recto-page")).evaluate(a.d)&&this.b.apply(a)};io.prototype.d=function(){return 1};function jo(a){this.b=null;this.f=a}t(jo,V);jo.prototype.apply=function(a){(new Xc(this.f,"verso-page")).evaluate(a.d)&&this.b.apply(a)};jo.prototype.d=function(){return 1};function ko(a,b){jj.call(this,a,b,null,null)}t(ko,jj);
ko.prototype.apply=function(a){var b=a.d,c=a.w,d=this.style;a=this.R;dj(b,c,d,a,null,null);if(d=d._marginBoxes){var c=bj(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);dj(b,f,d[e],a,null,null)}}};function lo(a,b,c,d,e){jk.call(this,a,b,null,c,null,d,!1);this.L=e;this.A=[];this.e="";this.w=[]}t(lo,jk);m=lo.prototype;m.Cb=function(){this.lb()};m.ab=function(a,b){if(this.e=b)this.b.push(new eo(b)),this.R+=65536};
m.Pb=function(a,b){b&&Lf(this,"E_INVALID_PAGE_SELECTOR :"+a+"("+b.join("")+")");this.w.push(":"+a);switch(a.toLowerCase()){case "first":this.b.push(new fo(this.d));this.R+=256;break;case "left":this.b.push(new go(this.d));this.R+=1;break;case "right":this.b.push(new ho(this.d));this.R+=1;break;case "recto":this.b.push(new io(this.d));this.R+=1;break;case "verso":this.b.push(new jo(this.d));this.R+=1;break;default:Lf(this,"E_INVALID_PAGE_SELECTOR :"+a)}};
function mo(a){var b;a.e||a.w.length?b=[a.e].concat(a.w.sort()):b=null;a.A.push({kd:b,R:a.R});a.e="";a.w=[]}m.Nb=function(){mo(this);jk.prototype.Nb.call(this)};m.ma=function(){mo(this);jk.prototype.ma.call(this)};
m.Xa=function(a,b,c){if("bleed"!==a&&"marks"!==a||this.A.some(function(a){return null===a.kd})){jk.prototype.Xa.call(this,a,b,c);var d=this.h[a],e=this.L;if("bleed"===a||"marks"===a)e[""]||(e[""]={}),Object.keys(e).forEach(function(b){aj(e[b],a,d)});else if("size"===a){var f=e[""];this.A.forEach(function(b){var c=new U(d.value,d.Da+b.R);b=b.kd?b.kd.join(""):"";var h=e[b];h?(c=(b=h[a])?Yi(null,c,b):c,aj(h,a,c)):(h=e[b]={},aj(h,a,c),f&&["bleed","marks"].forEach(function(a){f[a]&&aj(h,a,f[a])},this))},
this)}}};m.vd=function(a){lj(this.g.Ob,"*",a)};m.xd=function(a){return new ko(this.h,a)};m.Vc=function(a){var b=bj(this.h,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);Hf(this.$,new no(this.d,this.$,this.l,c))};function no(a,b,c,d){If.call(this,a,b,!1);this.e=c;this.b=d}t(no,Jf);no.prototype.Wa=function(a,b,c){gh(this.e,a,b,c,this)};no.prototype.Lb=function(a,b){Kf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};no.prototype.tc=function(a,b){Kf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
no.prototype.Xa=function(a,b,c){aj(this.b,a,new U(b,c?Ef(this):Ff(this)))};function oo(a){this.d=a;this.b={};this.b.page=[0]}function po(a,b){Object.keys(b.b).forEach(function(a){this.b[a]=Array.b(b.b[a])},a)}function Sj(a,b,c){return new oc(a.d,function(){var d=a.b[b];return c(d&&d.length?d[d.length-1]:null)},"page-counter-"+b)}function Uj(a,b,c){return new oc(a.d,function(){return c(a.b[b]||[])},"page-counters-"+b)}
function qo(a,b,c){var d,e=b["counter-reset"];e&&(e=e.evaluate(c))&&(d=sg(e,!0));if(d)for(var f in d){var e=a,g=f,k=d[f];e.b[g]?e.b[g].push(k):e.b[g]=[k]}var h;(b=b["counter-increment"])&&(c=b.evaluate(c))&&(h=sg(c,!1));h?"page"in h||(h.page=1):h={page:1};for(var l in h)a.b[l]||(c=a,b=l,c.b[b]?c.b[b].push(0):c.b[b]=[0]),c=a.b[l],c[c.length-1]+=h[l]};function ro(a,b,c,d,e,f,g,k,h,l){this.h=a;this.g=b;this.b=c;this.d=d;this.A=e;this.f=f;this.l=a.D;this.u=g;this.e=k;this.k=h;this.w=l;this.j=a.f;qc(this.b,function(a){return(a=this.b.b[a])?0<a.b.length&&a.b[0].b.b<=this.j:!1});pc(this.b,new oc(this.b,function(){return this.oa+this.b.d},"page-number"))}
function so(a,b,c,d){if(a.k.length){var e=new tc(0,b,c,d);a=a.k;for(var f={},g=0;g<a.length;g++)dj(e,f,a[g],0,null,null);g=f.width;a=f.height;var f=f["text-zoom"],k=1;if(g&&a||f){var h=rc.em;(f?f.evaluate(e,"text-zoom"):null)===ce&&(k=h/d,d=h,b*=k,c*=k);if(g&&a&&(g=wd(g.evaluate(e,"width"),e),e=wd(a.evaluate(e,"height"),e),0<g&&0<e))return{width:g,height:e,fontSize:d}}}return{width:b,height:c,fontSize:d}}
function to(a,b,c,d,e,f,g,k,h){tc.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.aa=b;this.lang=b.lang||c;this.viewport=d;this.e={body:!0};this.g=e;this.b=this.w=this.d=this.l=null;this.j=0;this.Ka=f;this.f=new oh(this.style.l);this.na={};this.G=null;this.k=new oo(a.b);this.D={};this.ea=null;this.Ia=g;this.Ja=k;this.oa=h;for(var l in a.e)(b=a.e[l]["flow-consume"])&&(b.evaluate(this,"flow-consume")==yd?this.e[l]=!0:delete this.e[l]);this.L={}}t(to,tc);
function uo(a){var b=L("StyleInstance.init");a.d=new Ak(a.aa,a.style.d,a.style.g,a,a.e,a.style.j,a.k);Kk(a.d,a);a.w={};a.w[a.aa.url]=a.d;var c=Hk(a.d);a.ea=tn(c);a.l=new Bl(a.style.A);var d=new Yj(a.style.d,a,a.k);a.l.h(d,c);Al(a.l,a);a.G=new ao(d,a.style.b,a.l,a,c);c=[];for(d=0;d<a.style.f.length;d++){var e=a.style.f[d];if(!e.H||e.H.evaluate(a))e=lh(e.qb,a),e=new mh(e),c.push(e)}uh(a.Ka,c,a.f).qa(b);var f=a.style.w;Object.keys(f).forEach(function(a){var b=An(zn(f[a]),this);this.L[a]={width:b.ib+
2*b.Ec,height:b.hb+2*b.Ec}},a);return N(b)}function Lk(a,b){var c=a.b;if(c){var d=c.b[b.f];d||(d=new pi,c.b[b.f]=d);d.b.push(new oi(new ni({ja:[{ga:b.g,Ma:0,ca:null,va:null,pa:null}],ba:0,K:!1}),b))}}
function vo(a,b){if(!b)return 0;var c=Number.POSITIVE_INFINITY,d;for(d in a.e){var e=b.b[d];if((!e||0==e.b.length)&&a.b){var f=a.d;f.l=d;for(e=0;null!=f.l&&(e+=5E3,Ik(f,e,0)!=Number.POSITIVE_INFINITY););e=a.b.b[d];b!=a.b&&e&&(e=e.clone(),b.b[d]=e)}if(e){for(var f=a,g=Number.POSITIVE_INFINITY,k=0;k<e.b.length;k++){for(var h=e.b[k].d.Ra,l=h.ja[0].ga,n=h.ba,p=h.K,q=0;l.ownerDocument!=f.aa.b;)q++,l=h.ja[q].ga,p=!1,n=0;h=Ah(f.aa,l,n,p);h<g&&(g=h)}f=g;f<c&&(c=f)}}return c}
function wo(a,b){var c=vo(a,a.b);if(c==Number.POSITIVE_INFINITY)return null;for(var d=a.l.children,e,f=0;f<d.length;f++)if(e=d[f],"vivliostyle-page-rule-master"!==e.d.kb){var g=1,k=ml(e,a,"utilization");k&&k.gd()&&(g=k.C);var k=vc(a,"em",!1),h=a.ib()*a.hb();a.j=Ik(a.d,c,Math.ceil(g*h/(k*k)));g=a;k=g.b.d;h=void 0;for(h in g.b.b)for(var l=g.b.b[h],n=l.b.length-1;0<=n;n--){var p=l.b[n];0>p.b.e&&p.b.b<g.j&&(p.b.e=k)}uc(a,a.style.b);g=ml(e,a,"enabled");if(!g||g===le){d=a;u.debug("Location - page",d.b.d);
u.debug("  current:",c);u.debug("  lookup:",d.j);c=void 0;for(c in d.b.b)for(f=d.b.b[c],g=0;g<f.b.length;g++)u.debug("  Chunk",c+":",f.b[g].b.b);c=a.G;f=b;g=e.d;if(0===Object.keys(f).length)g.d.e=g;else{e=g;d=co(c,f);e=e.g+"^"+d;d=c.g[e];if(!d){if("background-host"===g.kb)d=c,f=(new Ln(d.h,d.f.d,f)).f(d.f),f.h(d.b,d.e),Al(f,d.d),d=f;else{d=c;k=f;f=g.clone({kb:"vivliostyle-page-rule-master"});if(g=k.size)k=zn(k),g=g.Da,f.b.width=Yi(d.d,f.b.width,new U(k.width,g)),f.b.height=Yi(d.d,f.b.height,new U(k.height,
g));f=f.f(d.f);f.h(d.b,d.e);Al(f,d.d);d=f}c.g[e]=d}e=d.d;e.d.e=e;e=d}return e}}throw Error("No enabled page masters");}
function xo(a,b,c){var d=a.b.b[c];if(!d)return M(!0);Nm(b);a.e[c]&&0<b.cb.length&&(b.pd=!1);var e=L("layoutColumn"),f=[];rf(function(c){for(;0<d.b.length;){var e=0,h=d.b[e];if(h.b.b>a.j)break;for(var l=1;l<d.b.length;l++){var n=d.b[l];if(n.b.b>a.j)break;ci(n.b,h.b)&&(h=n,e=l)}var p=h.b,q=!0;Qm(b,h.d).then(function(a){h.b.Rd&&(null===a||p.d)&&f.push(h);p.d?(d.b.splice(e,1),Q(c)):a?(h.d=a,Q(c)):(d.b.splice(e,1),q?q=!1:tf(c))});if(q){q=!1;return}}Q(c)}).then(function(){0<f.length&&(d.b=f.concat(d.b));
O(e,!0)});return N(e)}
function yo(a,b,c,d,e,f,g,k){var h=ml(c,a,"enabled");if(h&&h!==le)return M(!0);var l=L("layoutContainer"),n=ml(c,a,"wrap-flow")===Ad,p=c.b?c.g&&c.D:c.f&&c.G,h=ml(c,a,"flow-from"),q=a.viewport.b.createElement("div"),r=ml(c,a,"position");w(q,"position",r?r.name:"absolute");d.insertBefore(q,d.firstChild);var v=new ri(q);v.b=c.b;c.jb(a,v,b,a.f);v.A=e;v.B=f;e+=v.left+v.marginLeft+v.Y;f+=v.top+v.marginTop+v.ea;if(h&&h.wd())if(a.D[h.toString()])c.fc(a,v,b,null,1,a.g,a.f),h=M(!0);else{var y=L("layoutContainer.inner"),
J=h.toString(),X=Y(c,a,"column-count"),P=Y(c,a,"column-gap"),F=1<X?Y(c,a,"column-width"):v.width,h=ll(c,a),Ea=0,r=ml(c,a,"shape-inside"),pb=qg(r,0,0,v.width,v.height,a),Nk=new Pl(J,a,a.viewport,a.d,h,a.aa,a.f,a.style.u,a,b,a.Ia,a.Ja,k),xh=0,Z=null;rf(function(b){for(;xh<X;){var c=xh++;if(1<X){var d=a.viewport.b.createElement("div");w(d,"position","absolute");q.appendChild(d);Z=new um(d,Nk,a.g);Z.b=v.b;Z.Ja=v.Ja;Z.ac=v.ac;v.b?(w(d,"margin-left",v.j+"px"),w(d,"margin-right",v.D+"px"),c=c*(F+P)+v.k,
yi(Z,0,v.width),xi(Z,c,F)):(w(d,"margin-top",v.k+"px"),w(d,"margin-bottom",v.w+"px"),c=c*(F+P)+v.j,xi(Z,0,v.height),yi(Z,c,F));Z.A=e+v.j;Z.B=f+v.k}else Z=new um(q,Nk,a.g),wi(Z,v),v=Z;Z.G=p?[]:g;Z.Zb=pb;if(0<=Z.width){var h=L("inner");xo(a,Z,J).then(function(){Z.L&&"column"!=Z.L&&(xh=X,"region"!=Z.L&&(a.D[J]=!0));O(h,!0)});c=N(h)}else c=M(!0);if(c.za()){c.then(function(){0<k.b.length?Q(b):(Ea=Math.max(Ea,Z.e),tf(b))});return}0<k.b.length||(Ea=Math.max(Ea,Z.e))}Q(b)}).then(function(){v.e=Ea;c.fc(a,
v,b,Z,X,a.g,a.f);O(y,!0)});h=N(y)}else{h=ml(c,a,"content");r=!1;if(h&&Ai(h)){var Ok=a.viewport.b.createElement("span");h.S(new zi(Ok,a));q.appendChild(Ok);zl(c,a,v,a.f)}else c.wa&&(d.removeChild(q),r=!0);r||c.fc(a,v,b,null,1,a.g,a.f);h=M(!0)}h.then(function(){if(!c.f||0<Math.floor(v.e)){if(!n){var h=v.A+v.left,p=v.B+v.top,r=ui(v)+v.width+vi(v),y=si(v)+v.height+ti(v),F=ml(c,a,"shape-outside"),h=qg(F,h,p,r,y,a);gb(a.viewport.root)&&g.push(Ae(h,0,-1.25*vc(a,"em",!1)));g.push(h)}}else if(0==c.children.length){d.removeChild(q);
O(l,!0);return}var J=c.children.length-1;qf(function(){for(;0<=J;){var d=c.children[J--],d=yo(a,b,d,q,e,f,g,k);if(d.za())return d}return M(!1)}).then(function(){O(l,!0)})});return N(l)}
function zo(a,b,c){a.D={};c?(a.b=c.clone(),Dk(a.d,c.e)):(a.b=new qi,Dk(a.d,-1));a.lang&&b.b.setAttribute("lang",a.lang);c=a.b;c.d++;uc(a,a.style.b);var d=bo(a.G),e=wo(a,d);if(!e)return M(null);e.d.b.width.value===ne&&Yh(b);e.d.b.height.value===oe&&Zh(b);qo(a.k,d,a);var f=An(zn(d),a);Ao(a,f,b);Hn(d,f,b,a);var d=ml(e,a,"writing-mode")||Md,f=ml(e,a,"direction")||Ud,g=new Di(b.A.bind(b),d,f),k=c.clone(),h=[],l=L("layoutNextPage");rf(function(d){yo(a,b,e,b.b,0,0,h.concat(),g).then(function(){if(0<g.b.length){h=
h.concat(Ii(g));g.b.splice(0,g.b.length);c=a.b=k.clone();for(var e;e=b.b.lastChild;)b.b.removeChild(e);tf(d)}else Q(d)})}).then(function(){e.Y(a,b,a.g);var d=new Xc(e.d.d,"left-page");b.g=d.evaluate(a)?"left":"right";var d=a.b.d,f;for(f in a.b.b)for(var g=a.b.b[f],h=g.b.length-1;0<=h;h--){var k=g.b[h];0<=k.b.e&&k.b.e+k.b.j-1<=d&&g.b.splice(h,1)}a.b=null;c.e=a.d.b;f=a.style.h.B[a.aa.url];d=b.M.getBoundingClientRect();b.d.width=d.width;b.d.height=d.height;g=b.h;for(d=0;d<g.length;d++)h=g[d],w(h.target,
h.name,h.value.toString());for(d=0;d<f.length;d++)if(g=f[d],k=b.j[g.Rb],h=b.j[g.Od],k&&h&&(k=Wh(k,g.action)))for(var y=0;y<h.length;y++)h[y].addEventListener(g.event,k,!1);var J;a:{for(J in a.e)if((f=c.b[J])&&0<f.b.length){J=!1;break a}J=!0}J&&(c=null);O(l,c)});return N(l)}
function Ao(a,b,c){a.B=b.ib;a.A=b.hb;c.M.style.width=b.ib+2*b.Ec+"px";c.M.style.height=b.hb+2*b.Ec+"px";c.b.style.left=b.ob+"px";c.b.style.right=b.ob+"px";c.b.style.top=b.ob+"px";c.b.style.bottom=b.ob+"px";c.b.style.padding=b.wb+"px"}function Bo(a,b,c,d){jk.call(this,a.g,a,b,c,d,a.f,!c);this.e=a;this.w=!1}t(Bo,jk);m=Bo.prototype;m.oc=function(){};m.nc=function(a,b,c){a=new Wk(this.e.j,a,b,c,this.e.w,this.H,Ff(this.$));Hf(this.e,new Gl(a.d,this.e,a,this.l))};
m.rb=function(a){a=a.d;null!=this.H&&(a=cd(this.d,this.H,a));Hf(this.e,new Bo(this.e,a,this,this.B))};m.kc=function(){Hf(this.e,new mk(this.d,this.$))};m.mc=function(){var a={};this.e.k.push({qb:a,H:this.H});Hf(this.e,new nk(this.d,this.$,null,a,this.e.f))};m.lc=function(a){var b=this.e.h[a];b||(b={},this.e.h[a]=b);Hf(this.e,new nk(this.d,this.$,null,b,this.e.f))};m.rc=function(){var a={};this.e.A.push(a);Hf(this.e,new nk(this.d,this.$,this.H,a,this.e.f))};
m.Sb=function(a){var b=this.e.l;if(a){var c=bj(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Hf(this.e,new nk(this.d,this.$,null,b,this.e.f))};m.qc=function(){this.w=!0;this.lb()};m.Cb=function(){var a=new lo(this.e.j,this.e,this,this.l,this.e.u);Hf(this.e,a);a.Cb()};m.ma=function(){jk.prototype.ma.call(this);if(this.w){this.w=!1;var a="R"+this.e.D++,b=H(a),c;this.H?c=new Xi(b,0,this.H):c=new U(b,0);cj(this.h,"region-id").push(c);this.fb();a=new Bo(this.e,this.H,this,a);Hf(this.e,a);a.ma()}};
function Co(a){var b=a.getAttribute("content");if(!b)return"";a={};for(var c;null!=(c=b.match(/^,?\s*([-A-Za-z_.][-A-Za-z_0-9.]*)\s*=\s*([-+A-Za-z_0-9.]*)\s*/));)b=b.substr(c[0].length),a[c[1]]=c[2];b=a.width-0;a=a.height-0;return b&&a?"@-epubx-viewport{width:"+b+"px;height:"+a+"px;}":""}function Do(a){Gf.call(this);this.f=a;this.g=new lc(null);this.j=new lc(this.g);this.w=new Tk(this.g);this.B=new Bo(this,null,null,null);this.D=0;this.k=[];this.l={};this.h={};this.A=[];this.u={};this.b=this.B}
t(Do,Gf);Do.prototype.error=function(a){u.b("CSS parser:",a)};function Eo(a,b){return Fo(b,a)}function Go(a){xf.call(this,Eo,"document");this.D=a;this.A={};this.h={};this.b={};this.B={};this.f=null;this.j=[]}t(Go,xf);function Ho(a){var b=sa("user-agent.xml",ra),c=L("OPSDocStore.init");yf(hh).then(function(d){a.f=d;yf(pk).then(function(){a.load(b).then(function(){O(c,!0)})})});return N(c)}function Io(a,b){a.j.push({url:b.url,text:b.text,Va:"User",ya:null,media:null})}
function Fo(a,b){var c=L("OPSDocStore.load"),d=b.url;Ih(b,a).then(function(b){if(b){for(var f=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),k=0;k<g.length;k++){var h=g[k],l=h.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),n=h.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=h.getAttribute("action"),h=h.getAttribute("ref");l&&n&&p&&h&&f.push({Od:l,event:n,action:p,Rb:h})}a.B[d]=f;var q=[],f=sa("user-agent-page.css",ra);q.push({url:f,text:null,
Va:"UA",ya:null,media:null});for(k=0;k<a.j.length;k++)q.push(a.j[k]);if(f=b.h)for(f=f.firstChild;f;f=f.nextSibling)if(1==f.nodeType)if(g=f,k=g.namespaceURI,l=g.localName,"http://www.w3.org/1999/xhtml"==k)if("style"==l)q.push({url:d,text:g.textContent,Va:"Author",ya:null,media:null});else if("link"==l){if(n=g.getAttribute("rel"),k=g.getAttribute("class"),l=g.getAttribute("media"),"stylesheet"==n||"alternate stylesheet"==n&&k)g=g.getAttribute("href"),g=sa(g,d),q.push({url:g,text:null,ya:k,media:l,Va:"Author"})}else"meta"==
l&&"viewport"==g.getAttribute("name")&&q.push({url:d,text:Co(g),Va:"Author",H:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==k?"stylesheet"==l&&"text/css"==g.getAttribute("type")&&q.push({url:d,text:g.textContent,Va:"Author",ya:null,media:null}):"http://example.com/sse"==k&&"property"===l&&(k=g.getElementsByTagName("name")[0])&&"stylesheet"===k.textContent&&(g=g.getElementsByTagName("value")[0])&&(g=sa(g.textContent,d),q.push({url:g,text:null,ya:null,media:null,Va:"Author"}));
for(var r="",k=0;k<q.length;k++)r+=q[k].url,r+="^",q[k].text&&(r+=q[k].text),r+="^";var v=a.A[r];v?(a.b[d]=v,O(c,b)):(f=a.h[r],f||(f=new Af(function(){var b=L("fetchStylesheet"),c=0,d=new Do(a.f);qf(function(){if(c<q.length){var a=q[c++];d.Db(a.Va);return null!==a.text?ig(a.text,d,a.url,a.ya,a.media).Wc(!0):hg(a.url,d,a.ya,a.media)}return M(!1)}).then(function(){v=new ro(a,d.g,d.j,d.B.g,d.w,d.k,d.l,d.h,d.A,d.u);a.A[r]=v;delete a.h[r];O(b,v)});return N(b)},"FetchStylesheet "+d),a.h[r]=f,f.start()),
yf(f).then(function(f){a.b[d]=f;O(c,b)}))}else O(c,null)});return N(c)};function Jo(a,b,c,d,e,f,g,k){this.d=a;this.url=b;this.lang=c;this.e=d;this.g=e;this.Q=dc(f);this.h=g;this.f=k;this.Ca=this.b=null}function Ko(a,b,c){if(0!=c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=Oa(d,"height","auto")&&(w(d,"height","auto"),Ko(a,d,c));"absolute"==Oa(d,"position","static")&&(w(d,"position","relative"),Ko(a,d,c))}}
function Lo(a){var b=a.target,c="\u25b8"==b.textContent;b.textContent=c?"\u25be":"\u25b8";for(b=b.parentNode.firstChild;b;)if(1!=b.nodeType)b=b.nextSibling;else{var d=b;"toc-container"==d.getAttribute("data-adapt-class")?b=d.firstChild:("toc-node"==d.getAttribute("data-adapt-class")&&(d.style.height=c?"auto":"0px"),b=b.nextSibling)}a.stopPropagation()}
Jo.prototype.Oc=function(a){var b=this.h.Oc(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",w(e,"cursor","pointer"),e.addEventListener("click",Lo,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
Jo.prototype.jc=function(a,b,c,d,e){if(this.b)return M(this.b);var f=this,g=L("showTOC"),k=new Xh(a,a);this.b=k;this.d.load(this.url).then(function(d){var l=f.d.b[d.url],n=so(l,c,1E5,e);b=new jm(b.f,n.fontSize,b.root,n.width,n.height);var p=new to(l,d,f.lang,b,f.e,f.g,f.Oc(d),f.f,0);f.Ca=p;p.Q=f.Q;uo(p).then(function(){zo(p,k,null).then(function(){Ko(f,a,2);O(g,k)})})});return N(g)};
Jo.prototype.gc=function(){if(this.b){var a=this.b;this.Ca=this.b=null;w(a.M,"visibility","none");var b=a.M.parentNode;b&&b.removeChild(a.M)}};Jo.prototype.hd=function(){return!!this.b};function Mo(){Go.call(this,No(this));this.d=new xf(Ih,"document");this.u=new xf(Bf,"text");this.w={};this.L={};this.k={};this.l={}}t(Mo,Go);function No(a){return function(b){return a.k[b]}}
function Oo(a,b,c){var d=L("loadEPUBDoc");"/"!==b.substring(b.length-1)&&(b+="/");c&&a.u.ec(b+"?r=list");a.d.ec(b+"META-INF/encryption.xml");var e=b+"META-INF/container.xml";a.d.load(e,!0,"Failed to fetch EPUB container.xml from "+e).then(function(f){if(f){f=Sh(wh(wh(wh(new yh([f.b]),"container"),"rootfiles"),"rootfile"),"full-path");for(var g=0;g<f.length;g++){var k=f[g];if(k){Po(a,b,k,c).qa(d);return}}O(d,null)}else u.error("Received an empty response for EPUB container.xml "+e+". This may be caused by the server not allowing cross origin requests.")});
return N(d)}function Po(a,b,c,d){var e=b+c,f=a.w[e];if(f)return M(f);var g=L("loadOPF");a.d.load(e,void 0,void 0).then(function(c){c?a.d.load(b+"META-INF/encryption.xml",void 0,void 0).then(function(h){(d?a.u.load(b+"?r=list"):M(null)).then(function(d){f=new Qo(a,b);Ro(f,c,h,d,b+"?r=manifest").then(function(){a.w[e]=f;a.L[b]=f;O(g,f)})})}):u.error("Received an empty response for EPUB OPF "+e+". This may be caused by the server not allowing cross origin requests.")});return N(g)}
Mo.prototype.load=function(a){var b=qa(a);if(a=this.l[b])return a.za()?a:M(a.cc());var c=L("EPUBDocStore.load");a=Mo.Bd.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?O(c,a):u.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return N(c)};function So(){this.id=null;this.src="";this.g=this.d=null;this.F=-1;this.h=0;this.j=null;this.b=this.e=0;this.f=$a}function To(a){return a.id}
function Uo(a){var b=Te(a);return function(a){var d=L("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));wf(e).then(function(a){a=new DataView(a);for(var c=0;c<a.byteLength;c++){var e=a.getUint8(c),e=e^b[c%20];a.setUint8(c,e)}O(d,vf([a,f]))});return N(d)}}
var Vo={dcterms:"http://purl.org/dc/terms/",marc:"http://id.loc.gov/vocabulary/",media:"http://www.idpf.org/epub/vocab/overlays/#",onix:"http://www.editeur.org/ONIX/book/codelists/current.html#",xsd:"http://www.w3.org/2001/XMLSchema#"},Wo=Vo.dcterms+"language",Xo=Vo.dcterms+"title";
function Yo(a,b){var c={};return function(d,e){var f,g,k=d.r||c,h=e.r||c;if(a==Xo&&(f="main"==k["http://idpf.org/epub/vocab/package/#title-type"],g="main"==h["http://idpf.org/epub/vocab/package/#title-type"],f!=g))return f?-1:1;f=parseInt(k["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(f)&&(f=Number.MAX_VALUE);g=parseInt(h["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(g)&&(g=Number.MAX_VALUE);return f!=g?f-g:a!=Wo&&b&&(f=(k[Wo]||k["http://idpf.org/epub/vocab/package/#alternate-script"])==
b,g=(h[Wo]||h["http://idpf.org/epub/vocab/package/#alternate-script"])==b,f!=g)?f?-1:1:d.o-e.o}}
function Zo(a,b){function c(a){for(var b in a){var d=a[b];d.sort(Yo(b,l));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return cb(a,function(a){return bb(a,function(a){var b={v:a.value,o:a.N};a.oe&&(b.s=a.scheme);if(a.id||a.lang){var c=h[a.id];if(c||a.lang)a.lang&&(a={name:Wo,value:a.lang,lang:null,id:null,Tc:a.id,scheme:null,N:a.N},c?c.push(a):c=[a]),c=ab(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in Vo)f[g]=Vo[g];for(;null!=(g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/));)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=Vo;var k=1;g=Qh(Rh(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),N:k++,Tc:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:Vo.dcterms+a.localName,N:k++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Tc:null,scheme:null};return null});var h=ab(g,function(a){return a.Tc});g=d(ab(g,function(a){return a.Tc?null:a.name}));var l=null;g[Wo]&&(l=g[Wo][0].v);c(g);return g}function $o(){var a=window.MathJax;return a?a.Hub:null}var ap={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function Qo(a,b){this.e=a;this.g=this.d=this.b=this.h=this.f=null;this.k=b;this.j=null;this.D={};this.lang=null;this.u=0;this.l={};this.G=this.B=this.L=null;this.w={};this.A=null;$o()&&(Ni["http://www.w3.org/1998/Math/MathML"]=!0)}function bp(a,b){return a.k?b.substr(0,a.k.length)==a.k?decodeURI(b.substr(a.k.length)):null:b}
function Ro(a,b,c,d,e){a.f=b;var f=wh(new yh([b.b]),"package"),g=Sh(f,"unique-identifier")[0];g&&(g=Eh(b,b.url+"#"+g))&&(a.j=g.textContent.replace(/[ \n\r\t]/g,""));var k={};a.h=bb(Oh(wh(wh(f,"manifest"),"item")),function(c){var d=new So,e=b.url;d.id=c.getAttribute("id");d.src=sa(c.getAttribute("href"),e);d.d=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.f=f}(c=c.getAttribute("fallback"))&&!ap[d.d]&&(k[d.src]=c);!a.B&&
d.f.nav&&(a.B=d);!a.G&&d.f["cover-image"]&&(a.G=d);return d});a.d=Za(a.h,To);a.g=Za(a.h,function(b){return bp(a,b.src)});for(var h in k)for(g=h;;){g=a.d[k[g]];if(!g)break;if(ap[g.d]){a.w[h]=g.src;break}g=g.src}a.b=bb(Oh(wh(wh(f,"spine"),"itemref")),function(b,c){var d=b.getAttribute("idref");if(d=a.d[d])d.g=b,d.F=c;return d});if(h=Sh(wh(f,"spine"),"toc")[0])a.L=a.d[h];if(h=Sh(wh(f,"spine"),"page-progression-direction")[0]){a:switch(h){case "ltr":h="ltr";break a;case "rtl":h="rtl";break a;default:throw Error("unknown PageProgression: "+
h);}a.A=h}var g=c?Sh(wh(wh(Nh(wh(wh(new yh([c.b]),"encryption"),"EncryptedData"),Mh()),"CipherData"),"CipherReference"),"URI"):[],l=Oh(wh(wh(f,"bindings"),"mediaType"));for(c=0;c<l.length;c++){var n=l[c].getAttribute("handler");(h=l[c].getAttribute("media-type"))&&n&&a.d[n]&&(a.D[h]=a.d[n].src)}a.l=Zo(wh(f,"metadata"),Sh(f,"prefix")[0]);a.l[Wo]&&(a.lang=a.l[Wo][0].v);if(!d){if(0<g.length&&a.j)for(d=Uo(a.j),c=0;c<g.length;c++)a.e.k[a.k+g[c]]=d;return M(!0)}f=new Pa;l={};if(0<g.length&&a.j)for(h="1040:"+
Ue(a.j),c=0;c<g.length;c++)l[g[c]]=h;for(c=0;c<d.length;c++){var p=d[c];if(n=p.n){var q=decodeURI(n),g=a.g[q];h=null;g&&(g.j=0!=p.m,g.h=p.c,g.d&&(h=g.d.replace(/\s+/g,"")));g=l[q];if(h||g)f.append(n),f.append(" "),f.append(h||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}cp(a);return uf(e,"","POST",f.toString(),"text/plain")}function cp(a){for(var b=0,c=0;c<a.b.length;c++){var d=a.b[c],e=Math.ceil(d.h/1024);d.e=b;d.b=e;b+=e}a.u=b}
function dp(a,b,c){var d=new So;d.F=0;d.id="item1";d.src=b;a.d={item1:d};a.g={};a.g[b]=d;a.h=[d];a.b=a.h;c?(a=a.e,d=L("EPUBDocStore.load"),b=qa(b),(a.l[b]=Fo(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,ic:null})).qa(d),c=N(d)):c=M(null);return c}function ep(a,b,c){var d=a.b[b],e=L("getCFI");a.e.load(d.src).then(function(a){var b=Ch(a,c),k=null;b&&(a=Ah(a,b,0,!1),k=new rb,ub(k,b,c-a),d.g&&ub(k,d.g,0),k=k.toString());O(e,k)});return N(e)}
function fp(a,b){return $e("resolveFragment",function(c){if(b){var d=new rb;sb(d,b);var e;if(a.f){var f=tb(d,a.f.b);if(1!=f.ga.nodeType||f.K||!f.Rb){O(c,null);return}var g=f.ga,k=g.getAttribute("idref");if("itemref"!=g.localName||!k||!a.d[k]){O(c,null);return}e=a.d[k];d=f.Rb}else e=a.b[0];a.e.load(e.src).then(function(a){var b=tb(d,a.b);a=Ah(a,b.ga,b.offset,b.K);O(c,{F:e.F,la:a,P:-1})})}else O(c,null)},function(a,d){u.b(d,"Cannot resolve fragment:",b);O(a,null)})}
function gp(a,b){return $e("resolveEPage",function(c){if(0>=b)O(c,{F:0,la:0,P:-1});else{var d=Xa(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.e.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=Bh(a),g=Math.round(a*b/e.b),g==a&&g--);O(c,{F:d,la:g,P:-1})})}},function(a,d){u.b(d,"Cannot resolve epage:",b);O(a,null)})}
function hp(a,b){var c=a.b[b.F];if(0>=b.la)return M(c.e);var d=L("getEPage");a.e.load(c.src).then(function(a){a=Bh(a);var f=Math.min(a,b.la);O(d,c.e+f*c.b/a)});return N(d)}function ip(a,b,c,d,e){this.b=a;this.viewport=b;this.f=c;this.g=e;this.Bb=[];this.la=this.P=this.F=0;this.Q=dc(d);this.e=new hm(b.f)}function jp(a){var b=a.Bb[a.F];return b?b.$a[a.P]:null}m=ip.prototype;m.gb=function(){if(this.b.A)return this.b.A;var a=this.Bb[this.F];return a?a.Ca.ea:null};
function kp(a){var b=L("renderPage");lp(a).then(function(c){if(c){var d=-1;if(0>a.P){var d=a.la,e=Xa(c.Fa.length,function(a){return vo(c.Ca,c.Fa[a])>d});a.P=e==c.Fa.length?Number.POSITIVE_INFINITY:e-1}var f=c.$a[a.P];f?(a.la=f.offset,O(b,f)):rf(function(b){if(a.P<c.Fa.length)Q(b);else if(c.complete)a.P=c.Fa.length-1,Q(b);else{var e=c.Fa[c.Fa.length-1],h=mp(a,c,e);zo(c.Ca,h,e).then(function(l){h.M.style.display="none";h.M.style.visibility="visible";h.M.setAttribute("data-vivliostyle-page-side",h.g);
l=(e=l)?e.d-1:c.Fa.length-1;a.g(c.Ca.L,c.item.F,l);e?(c.$a[l]=h,c.Fa.push(e),0<=d&&vo(c.Ca,e)>d?(f=h,a.P=c.Fa.length-2,Q(b)):(h.k=0==c.item.F&&0==l,tf(b))):(c.$a.push(h),f=h,a.P=l,0>d&&(a.la=h.offset),c.complete=!0,h.k=0==c.item.F&&0==l,h.l=c.item.F==a.b.b.length-1,Q(b))})}}).then(function(){if(f=f||c.$a[a.P])O(b,f);else{var e=c.Fa[a.P];0>d&&(a.la=vo(c.Ca,e));var k=mp(a,c,e);zo(c.Ca,k,e).then(function(d){k.M.style.display="none";k.M.style.visibility="visible";k.M.setAttribute("data-vivliostyle-page-side",
k.g);d=(e=d)?e.d-1:c.Fa.length-1;a.g(c.Ca.L,c.item.F,d);e?(c.$a[d]=k,c.Fa[a.P+1]=e):(c.$a.push(k),c.complete=!0,k.l=c.item.F==a.b.b.length-1);k.k=0==c.item.F&&0==d;O(b,k)})}})}else O(b,null)});return N(b)}m.Uc=function(){return np(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};function np(a,b,c){var d=L("renderAllPages"),e=a.F,f=a.P;a.F=0;rf(function(d){a.P=a.F==b?c:Number.POSITIVE_INFINITY;kp(a).then(function(){++a.F>b?Q(d):tf(d)})}).then(function(){a.F=e;a.P=f;kp(a).qa(d)});return N(d)}
m.Hd=function(){this.P=this.F=0;return kp(this)};m.Id=function(){this.F=this.b.b.length-1;this.P=Number.POSITIVE_INFINITY;return kp(this)};m.nextPage=function(){var a=this,b=L("nextPage");lp(a).then(function(c){if(c){if(c.complete&&a.P==c.Fa.length-1){if(a.F>=a.b.b.length-1){O(b,null);return}a.F++;a.P=0}else a.P++;kp(a).qa(b)}else O(b,null)});return N(b)};m.Sc=function(){if(0==this.P){if(0==this.F)return M(null);this.F--;this.P=Number.POSITIVE_INFINITY}else this.P--;return kp(this)};
function op(a,b){var c="left"===b.g,d="ltr"===a.gb();return!c&&d||c&&!d}function pp(a){var b=L("getCurrentSpread"),c=jp(a);if(!c)return M({left:null,right:null});var d=a.F,e=a.P,f="left"===c.g;(op(a,c)?a.Sc():a.nextPage()).then(function(g){a.F=d;a.P=e;kp(a).then(function(){f?O(b,{left:c,right:g}):O(b,{left:g,right:c})})});return N(b)}m.Nd=function(){var a=jp(this);if(!a)return M(null);var a=op(this,a),b=this.nextPage();if(a)return b;var c=this;return b.sc(function(){return c.nextPage()})};
m.Qd=function(){var a=jp(this);if(!a)return M(null);var a=op(this,a),b=this.Sc();if(a){var c=this;return b.sc(function(){return c.Sc()})}return b};function qp(a,b){var c=L("navigateToEPage");gp(a.b,b).then(function(b){b&&(a.F=b.F,a.P=b.P,a.la=b.la);kp(a).qa(c)});return N(c)}function rp(a,b){var c=L("navigateToCFI");fp(a.b,b).then(function(b){b&&(a.F=b.F,a.P=b.P,a.la=b.la);kp(a).qa(c)});return N(c)}
function sp(a,b){u.debug("Navigate to",b);var c=bp(a.b,qa(b));if(null==c&&(a.b.f&&b.match(/^#epubcfi\(/)&&(c=bp(a.b,a.b.f.url)),null==c))return M(null);var d=a.b.g[c];if(!d)return a.b.f&&c==bp(a.b,a.b.f.url)&&(c=b.indexOf("#"),0<=c)?rp(a,b.substr(c+1)):M(null);d.F!=a.F&&(a.F=d.F,a.P=0);var e=L("navigateTo");lp(a).then(function(c){var d=Eh(c.aa,b);d&&(a.la=zh(c.aa,d),a.P=-1);kp(a).qa(e)});return N(e)}
function mp(a,b,c){var d=b.Ca.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);ia||(e.style.visibility="hidden");d.d.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);f=new Xh(e,f);f.F=b.item.F;f.position=c;f.offset=vo(b.Ca,c);d!==a.viewport&&(a=gc(a.viewport.width,a.viewport.height,d.width,d.height),a=jg(null,new ac(a,null)),f.h.push(new Uh(e,"transform",a)));return f}
function tp(a,b){var c=$o();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=L("navigateToEPage"),f=kf(c);d.Push(function(){f.Sa(e)});return N(c)}return M(null)}
m.Oc=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=sa(f,a.url),g=c.getAttribute("media-type");if(!g){var k=bp(b.b,f);k&&(k=b.b.g[k])&&(g=k.d)}if(g&&(k=b.b.D[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Ta(f),h=Ta(g),g=new Pa;g.append(k);g.append("?src=");g.append(f);g.append("&type=");g.append(h);for(k=c.firstChild;k;k=k.nextSibling)1==k.nodeType&&
...
c.namespaceURI)e=tp(c,d);else if("http://example.com/sse"==c.namespaceURI){e=d?d.ownerDocument:b.viewport.b;g=c.localName;switch(g){case "t":case "tab":case "ec":case "nt":case "fraction":case "comment":case "mark":g="span";break;case "ruby":case "rp":case "rt":break;default:g="div"}e=e.createElement(g);e.setAttribute("data-adapt-process-children","true");e=M(e)}else e=M(null);return e}};
function lp(a){if(a.F>=a.b.b.length)return M(null);var b=a.Bb[a.F];if(b)return M(b);var c=a.b.b[a.F],d=a.b.e,e=L("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(Bh(f)/2700),a.b.u=c.b);var g=d.b[f.url],k=a.Oc(f),h=a.viewport,l=so(g,h.width,h.height,h.fontSize);if(l.width!=h.width||l.height!=h.height||l.fontSize!=h.fontSize)h=new jm(h.f,l.fontSize,h.root,l.width,l.height);var l=a.Bb[a.F-1],n=new to(g,f,a.b.lang,h,a.e,a.f,k,a.b.w,l?l.Ca.oa+l.$a.length:0);l&&
po(n.k,l.Ca.k);n.Q=a.Q;uo(n).then(function(){b={item:c,aa:f,Ca:n,Fa:[null],$a:[],complete:!1};a.Bb[a.F]=b;O(e,b)})});return N(e)}function up(a){return{F:a.F,P:a.P,la:a.la}}function vp(a,b){b?(a.F=b.F,a.P=-1,a.la=b.la):(a.F=0,a.P=0,a.la=0);return np(a,a.F,a.P)}
m.jc=function(){var a=this.b,b=a.B||a.L;if(!b)return M(null);var c=L("showTOC");this.d||(this.d=new Jo(a.e,b.src,a.lang,this.e,this.f,this.Q,this,a.w));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";e.style.border=
"1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.d.jc(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";O(c,a)});return N(c)};m.gc=function(){this.d&&this.d.gc()};m.hd=function(){return this.d&&this.d.hd()};function wp(a,b,c,d){var e=this;this.h=a;this.bb=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.cb=c;this.Ka=d;a=a.document;this.oa=new qh(a.head,b);this.w="";this.g=null;this.G=this.d=!1;this.f=this.j=this.e=this.l=null;this.fontSize=16;this.zoom=1;this.ea=!1;this.Uc=!0;this.Q=cc();this.D=function(){};this.k=function(){};this.Y=function(){e.d=!0;e.D()};this.u=function(){};this.A=a.getElementById("vivliostyle-page-rules");this.L=
!1;this.na={loadEPUB:this.wa,loadXML:this.Ia,configure:this.B,moveTo:this.Ja,toc:this.jc};xp(this)}function xp(a){pa(1,function(a){yp(this,{t:"debug",content:a})}.bind(a));pa(2,function(a){yp(this,{t:"info",content:a})}.bind(a));pa(3,function(a){yp(this,{t:"warn",content:a})}.bind(a));pa(4,function(a){yp(this,{t:"error",content:a})}.bind(a))}function yp(a,b){b.i=a.cb;a.Ka(b)}
wp.prototype.wa=function(a){qn.b("loadEPUB");qn.b("loadFirstPage");this.bb.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet;this.viewport=null;var f=L("loadEPUB"),g=this;g.B(a).then(function(){var a=new Mo;if(e)for(var h=0;h<e.length;h++)Io(a,e[h]);Ho(a).then(function(){var e=sa(b,g.h.location.href);g.w=e;Oo(a,e,d).then(function(a){g.g=a;fp(g.g,c).then(function(a){g.f=a;zp(g).then(function(){g.bb.setAttribute("data-vivliostyle-viewer-status",
"complete");qn.d("loadEPUB");yp(g,{t:"loaded",metadata:g.g.l});O(f,!0)})})})})});return N(f)};
wp.prototype.Ia=function(a){qn.b("loadXML");qn.b("loadFirstPage");this.bb.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.document,d=a.fragment,e=a.userStyleSheet;this.viewport=null;var f=L("loadXML"),g=this;g.B(a).then(function(){var a=new Mo;if(e)for(var h=0;h<e.length;h++)Io(a,e[h]);Ho(a).then(function(){var e=sa(b,g.h.location.href);g.w=e;g.g=new Qo(a,"");dp(g.g,e,c).then(function(){fp(g.g,d).then(function(a){g.f=a;zp(g).then(function(){g.bb.setAttribute("data-vivliostyle-viewer-status",
"complete");qn.d("loadXML");yp(g,{t:"loaded"});O(f,!0)})})})})});return N(f)};function Ap(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*rc.ex*a.fontSize/rc.em;if(d=rc[d])return c*d}return c}
wp.prototype.B=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.l=null,this.h.addEventListener("resize",this.Y,!1),this.d=!0):this.h.removeEventListener("resize",this.Y,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.d=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:Ap(this,b["margin-left"])||0,marginRight:Ap(this,b["margin-right"])||0,marginTop:Ap(this,b["margin-top"])||0,marginBottom:Ap(this,b["margin-bottom"])||
0,width:Ap(this,b.width)||0,height:Ap(this,b.height)||0},200<=b.width||200<=b.height)&&(this.h.removeEventListener("resize",this.Y,!1),this.l=b,this.d=!0);"boolean"==typeof a.hyphenate&&(this.Q.Ic=a.hyphenate,this.d=!0);"boolean"==typeof a.horizontal&&(this.Q.Hc=a.horizontal,this.d=!0);"boolean"==typeof a.nightMode&&(this.Q.Pc=a.nightMode,this.d=!0);"number"==typeof a.lineHeight&&(this.Q.lineHeight=a.lineHeight,this.d=!0);"number"==typeof a.columnWidth&&(this.Q.Dc=a.columnWidth,this.d=!0);"string"==
...
a.zoom,this.G=!0);return M(!0)};function Bp(a){var b=[];a.e&&(b.push(a.e),a.e=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(w(a.M,"display","none"),a.removeEventListener("hyperlink",this.u,!1))},a)}function Cp(a,b){b.addEventListener("hyperlink",a.u,!1);w(b.M,"visibility","visible");w(b.M,"display","block")}function Dp(a,b){Bp(a);a.e=b;Cp(a,b)}
function Ep(a){var b=L("reportPosition");a.f||(a.f=up(a.b));ep(a.g,a.f.F,a.f.la).then(function(c){var d=a.e;(a.ea&&0<d.f.length?ug(d.f):M(!0)).then(function(){Fp(a,d,c).qa(b)})});return N(b)}function Gp(a){var b=a.bb;if(a.l){var c=a.l;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new jm(a.h,a.fontSize,b,c.width,c.height)}return new jm(a.h,a.fontSize,b)}
function Hp(a){if(a.l||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=Gp(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.Bb;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.$a,d=0;d<c.length;d++){var e=c[d];if(e.G&&e.D){a=!0;break a}}}a=!1}b=!a}return b}
wp.prototype.ub=function(a,b,c){if(!this.L&&this.A&&0===b&&0===c){var d="";Object.keys(a).forEach(function(b){d+="@page "+b+"{size:";b=a[b];d+=b.width+"px "+b.height+"px;}"});this.A.textContent=d;this.L=!0}};
function Ip(a){if(a.b){a.b.gc();for(var b=a.b.Bb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.$a,e;e=d.shift();)e=e.M,e.parentNode.removeChild(e)}}a.A&&(a.A.textContent="",a.L=!1);a.viewport=Gp(a);b=a.viewport;w(b.e,"width","");w(b.e,"height","");w(b.d,"width","");w(b.d,"height","");w(b.d,"transform","");a.b=new ip(a.g,a.viewport,a.oa,a.Q,a.ub.bind(a))}
function Jp(a,b){a.G=!1;if(a.Q.Ua)return pp(a.b).sc(function(c){Bp(a);a.j=c;c.left&&(Cp(a,c.left),c.right||c.left.M.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Cp(a,c.right),c.left||c.right.M.setAttribute("data-vivliostyle-unpaired-page",!0));c=Kp(a,c);a.viewport.zoom(c.width,c.height,a.zoom);a.e=b;return M(null)});Dp(a,b);a.viewport.zoom(b.d.width,b.d.height,a.zoom);a.e=b;return M(null)}
function Kp(a,b){var c=0,d=0;b.left&&(c+=b.left.d.width,d=b.left.d.height);b.right&&(c+=b.right.d.width,d=Math.max(d,b.right.d.height));b.left&&b.right&&(c+=2*a.Q.Ab);return{width:c,height:d}}var Lp={ae:"fit inside viewport"};
function zp(a){a.d=!1;if(Hp(a))return M(!0);"complete"===a.bb.getAttribute("data-vivliostyle-viewer-status")&&a.bb.setAttribute("data-vivliostyle-viewer-status","resizing");yp(a,{t:"resizestart"});var b=L("resize");a.b&&!a.f&&(a.f=up(a.b));Ip(a);vp(a.b,a.f).then(function(c){Jp(a,c).then(function(){Ep(a).then(function(c){qn.d("loadFirstPage");(a.Uc?a.b.Uc():M(null)).then(function(){a.bb.setAttribute("data-vivliostyle-viewer-status","complete");yp(a,{t:"resizeend"});O(b,c)})})})});return N(b)}
function Fp(a,b,c){var d=L("sendLocationNotification"),e={t:"nav",first:b.k,last:b.l};hp(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.u;c&&(e.cfi=c);yp(a,e);O(d,!0)});return N(d)}wp.prototype.gb=function(){return this.b?this.b.gb():null};
wp.prototype.Ja=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.Q.Ua?this.b.Nd:this.b.nextPage;break;case "previous":a=this.Q.Ua?this.b.Qd:this.b.Sc;break;case "last":a=this.b.Id;break;case "first":a=this.b.Hd;break;default:return M(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return qp(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return sp(b.b,d)}}else return M(!0);var e=L("nextPage");a.call(b.b).then(function(a){a?(b.f=
null,Jp(b,a).then(function(){Ep(b).qa(e)})):O(e,!0)});return N(e)};wp.prototype.jc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.hd();if(c){if("show"==a)return M(!0)}else if("hide"==a)return M(!0);if(c)return this.b.gc(),M(!0);var d=this,e=L("showTOC");this.b.jc(b).then(function(a){if(a){if(b){var c=function(){d.b.gc()};a.addEventListener("hyperlink",c,!1);a.M.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.u,!1)}O(e,!0)});return N(e)};
function Mp(a,b){var c=b.a||"";return $e("runCommand",function(d){var e=a.na[c];e?e.call(a,b).then(function(){yp(a,{t:"done",a:c});O(d,!0)}):(u.error("No such action:",c),O(d,!0))},function(a,b){u.error(b,"Error during action:",c);O(a,!0)})}function Np(a){return"string"==typeof a?JSON.parse(a):a}
function Op(a,b){var c=Np(b),d=null;bf(function(){var b=L("commandLoop"),f=Ve.d;a.u=function(b){var c={t:"hyperlink",href:b.href,internal:b.href.substr(0,a.w.length)==a.w};cf(f,function(){yp(a,c);return M(!0)})};rf(function(b){if(a.d)zp(a).then(function(){tf(b)});else if(a.G)a.e&&Jp(a,a.e).then(function(){tf(b)});else if(c){var e=c;c=null;Mp(a,e).then(function(){tf(b)})}else e=L("waitForCommand"),d=kf(e,self),N(e).then(function(){tf(b)})}).qa(b);return N(b)});a.D=function(){var a=d;a&&(d=null,a.Sa())};
a.k=function(b){if(c)return!1;c=Np(b);a.D();return!0};a.h.adapt_command=a.k};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Jb||(Object.Jb=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function Pp(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}function Qp(a,b){ia=a.debug;this.f=a;this.b=new wp(a.window||window,a.viewportElement,"main",this.Gd.bind(this));this.e={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,spreadView:!1,zoom:1};b&&this.Ad(b);this.d=new db}m=Qp.prototype;
m.Ad=function(a){var b=Object.Jb({a:"configure"},Pp(a));this.b.k(b);Object.Jb(this.e,a)};m.Gd=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});eb(this.d,b)};m.Sd=function(a,b){this.d.addEventListener(a,b,!1)};m.Vd=function(a,b){this.d.removeEventListener(a,b,!1)};m.Jd=function(a,b,c){a||eb(this.d,{type:"error",content:"No URL specified"});Rp(this,a,null,b,c)};m.Td=function(a,b,c){a||eb(this.d,{type:"error",content:"No URL specified"});Rp(this,null,a,b,c)};
function Rp(a,b,c,d,e){d=d||{};var f,g=d.userStyleSheet;g&&(f=g.map(function(a){return{url:a.url||null,text:a.text||null}}));e&&Object.Jb(a.e,e);b=Object.Jb({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.f.userAgentRootURL,url:b||c,document:d.documentObject,fragment:d.fragment,userStyleSheet:f},Pp(a.e));Op(a.b,b)}m.gb=function(){return this.b.gb()};
m.Ld=function(a){a:switch(a){case "left":a="ltr"===this.gb()?"previous":"next";break a;case "right":a="ltr"===this.gb()?"next":"previous";break a}this.b.k({a:"moveTo",where:a})};m.Kd=function(a){this.b.k({a:"moveTo",url:a})};m.Ud=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.Q.Ua?Kp(b,b.j):b.e.d;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ba("vivliostyle.viewer.Viewer",Qp);Qp.prototype.setOptions=Qp.prototype.Ad;Qp.prototype.addListener=Qp.prototype.Sd;Qp.prototype.removeListener=Qp.prototype.Vd;Qp.prototype.loadDocument=Qp.prototype.Jd;Qp.prototype.loadEPUB=Qp.prototype.Td;Qp.prototype.getCurrentPageProgression=Qp.prototype.gb;Qp.prototype.navigateToPage=Qp.prototype.Ld;Qp.prototype.navigateToInternalUrl=Qp.prototype.Kd;Qp.prototype.queryZoomFactor=Qp.prototype.Ud;ba("vivliostyle.viewer.ZoomType",Lp);Lp.FIT_INSIDE_VIEWPORT="fit inside viewport";
mn.call(qn,"load_vivliostyle","end",void 0);var Sp=16,Tp="ltr";function Up(a){window.adapt_command(a)}function Vp(){Up({a:"moveTo",where:"ltr"===Tp?"previous":"next"})}function Wp(){Up({a:"moveTo",where:"ltr"===Tp?"next":"previous"})}
function Xp(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)Up({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)Up({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)Up({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)Up({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)Wp(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)Vp(),a.preventDefault();else if("0"===b||"U+0030"===c)Up({a:"configure",fontSize:Math.round(Sp)}),a.preventDefault();else if("t"===b||"U+0054"===c)Up({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)Sp*=1.2,Up({a:"configure",fontSize:Math.round(Sp)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)Sp/=1.2,Up({a:"configure",
fontSize:Math.round(Sp)}),a.preventDefault()}
function Yp(a){switch(a.t){case "loaded":a=a.viewer;var b=Tp=a.gb();a.bb.setAttribute("data-vivliostyle-page-progression",b);a.bb.setAttribute("data-vivliostyle-spread-view",a.Q.Ua);window.addEventListener("keydown",Xp,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Vp,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Wp,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(va(location.href,Ta(a||"")));break;case "hyperlink":a.internal&&Up({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+n+"; margin: 0; }",document.head.appendChild(g));Op(new wp(window,l,"main",Yp),a)});
