 ...
 *
 * Vivliostyle core 2016.7.1-pre.20160802010716
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
n.Ic=function(){throw Error("E_CSS_COLOR_NOT_ALLOWED");};n.lc=function(){throw Error("E_CSS_URL_NOT_ALLOWED");};n.gb=function(){throw Error("E_CSS_LIST_NOT_ALLOWED");};n.ub=function(){throw Error("E_CSS_COMMA_NOT_ALLOWED");};n.kb=function(){throw Error("E_CSS_FUNC_NOT_ALLOWED");};n.Qb=function(){throw Error("E_CSS_EXPR_NOT_ALLOWED");};function bd(){}t(bd,ad);n=bd.prototype;
...
function H(a){var b=$c[a];b||(b=new kd(a));return b}function I(a,b){this.C=a;this.aa=b.toLowerCase()}t(I,fd);I.prototype.ja=function(a,b){return 0==this.C?a.b:b&&"%"==this.aa?100==this.C?b:new Nc(a,b,new B(a,this.C/100)):new Qc(a,this.C,this.aa)};I.prototype.Aa=function(a){a.append(this.C.toString());a.append(this.aa)};I.prototype.U=function(a){return a.Tb(this)};I.prototype.$b=function(){return!0};function ld(a){this.C=a}t(ld,fd);
...
function Ce(a,b,c){c=b+c;for(var d=Array(c),e=Array(c),f=0;f<=c;f++)d[f]=0,e[f]=0;for(var g=[],h=!1,l=a.length,k=0;k<l;k++){var m=a[k];d[m.b]+=m.e;e[m.b]+=m.d;for(var p=!1,f=0;f<b;f++)if(d[f]&&!e[f]){p=!0;break}if(p)for(f=b;f<=c;f++)if(d[f]||e[f]){p=!1;break}h!=p&&(g.push(m.x),h=p)}return g}function De(a,b){return b?Math.ceil(a/b)*b:a}function Ee(a,b){return b?Math.floor(a/b)*b:a}function Fe(a){return new qe(a.y,-a.x)}function Ge(a){return new pe(a.W,-a.V,a.R,-a.ba)}
function He(a){return new ve(Wa(a.b,Fe))}
function Ie(a,b,c,d,e){e&&(a=Ge(a),b=Wa(b,He),c=Wa(c,He));e=b.length;var f=c?c.length:0,g=[],h=[],l,k,m;for(l=0;l<e;l++)we(b[l],h,l);for(l=0;l<f;l++)we(c[l],h,l+e);b=h.length;h.sort(ue);for(c=0;h[c].e>=e;)c++;c=h[c].b.y;c>a.W&&g.push(new te(a.W,c,a.V,a.V));l=0;for(var p=[];l<b&&(m=h[l]).b.y<c;)m.d.y>c&&p.push(m),l++;for(;l<b||0<p.length;){var r=a.R,w=De(Math.ceil(c+8),d);for(k=0;k<p.length&&r>w;k++)m=p[k],m.b.x==m.d.x?m.d.y<r&&(r=Math.max(Ee(m.d.y,d),w)):m.b.x!=m.d.x&&(r=w);r>a.R&&(r=a.R);for(;l<
b&&(m=h[l]).b.y<r;)if(m.d.y<c)l++;else if(m.b.y<w){if(m.b.y!=m.d.y||m.b.y!=c)p.push(m),r=w;l++}else{k=Ee(m.b.y,d);k<r&&(r=k);break}w=[];for(k=0;k<p.length;k++)Be(w,p[k],c,r);w.sort(function(a,b){return a.x-b.x||a.d-b.d});w=Ce(w,e,f);if(0==w.length)g.push(new te(c,r,a.V,a.V));else{var q=0,x=a.ba;for(k=0;k<w.length;k+=2){var S=Math.max(a.ba,w[k]),W=Math.min(a.V,w[k+1])-S;W>q&&(q=W,x=S)}0==q?g.push(new te(c,r,a.V,a.V)):g.push(new te(c,r,Math.max(x,a.ba),Math.min(x+q,a.V)))}if(r==a.R)break;c=r;for(k=
p.length-1;0<=k;k--)p[k].d.y<=r&&p.splice(k,1)}Je(a,g);return g}function Je(a,b){for(var c=b.length-1,d=new te(a.R,a.R,a.ba,a.V);0<=c;){var e=d,d=b[c];d.ba==e.ba&&d.V==e.V&&(e.W=d.W,b.splice(c,1),d=e);c--}}function Ke(a,b){for(var c=0,d=a.length;c<d;){var e=Math.floor((c+d)/2);b>=a[e].R?c=e+1:d=e}return c}
function Le(a,b,c,d){for(var e=c.W,f=c.V-c.ba,g=c.R-c.W,h=Ke(b,e);;){var l=e+g;if(l>a.R)break;for(var k=a.ba,m=a.V,p=h;p<b.length&&b[p].W<l;p++){var r=b[p];r.ba>k&&(k=r.ba);r.V<m&&(m=r.V)}if(k+f<=m||h>=b.length){"left"==d?(c.ba=k,c.V=k+f):(c.ba=m-f,c.V=m);c.R+=e-c.W;c.W=e;break}e=b[h].R;h++}}
function Me(a,b,c,d){for(var e=null,e=[new te(c.W,c.R,c.ba,c.V)];0<e.length&&e[0].R<=a.W;)e.shift();if(0!=e.length){e[0].W<a.W&&(e[0].W=a.W);c=0==b.length?a.W:b[b.length-1].R;c<a.R&&b.push(new te(c,a.R,a.ba,a.V));for(var f=Ke(b,e[0].W),g=0;g<e.length;g++){var h=e[g];if(f==b.length)break;b[f].W<h.W&&(c=b[f],f++,b.splice(f,0,new te(h.W,c.R,c.ba,c.V)),c.R=h.W);for(;f<b.length&&(c=b[f++],c.R>h.R&&(b.splice(f,0,new te(h.R,c.R,c.ba,c.V)),c.R=h.R),h.ba!=h.V&&("left"==d?c.ba=Math.min(h.V,a.V):c.V=Math.max(h.ba,
a.ba)),c.R!=h.R););}Je(a,b)}};function Ne(a){return String.fromCharCode(a>>>24&255,a>>>16&255,a>>>8&255,a&255)}
...
a.b=Nf;l.splice(0,l.length);continue;case 29:a.b=Mf;g.fb();continue;case 1:if(!k.b){a.b=Rf;g.error("E_CSS_SPACE_EXPECTED",k);continue}g.mb();case 2:if(34==z(h,1).type)if(A(h),A(h),p=a.I[k.text],null!=p)switch(k=y(h),k.type){case 1:g.ib(p,k.text);a.b=f?Kf:Q;A(h);break;case 36:g.ib(p,null);a.b=f?Kf:Q;A(h);break;default:a.b=Pf,g.error("E_CSS_NAMESPACE",k)}else a.b=Pf,g.error("E_CSS_UNDECLARED_PREFIX",k);else g.ib(a.D,k.text),a.b=f?Kf:Q,A(h);continue;case 3:if(!k.b){a.b=Rf;g.error("E_CSS_SPACE_EXPECTED",
...
a.b=Lf;A(h);continue;case 56:g.Sc();a.b=Lf;A(h);continue;case 13:a.S?(a.f.push("-epubx-region"),a.S=!1):a.O?(a.f.push("page"),a.O=!1):a.f.push("[selector]");g.qa();a.b=If;A(h);continue;case 41:g.Lb();a.b=Mf;A(h);continue;case 15:l.push(H(k.text));A(h);continue;case 16:try{l.push(yf(k.text))}catch(w){g.error("E_CSS_COLOR",k),a.b=Pf}A(h);continue;case 17:l.push(new ld(k.C));A(h);continue;case 18:l.push(new md(k.C));A(h);continue;case 19:l.push(new I(k.C,k.text));A(h);continue;case 20:l.push(new jd(k.text));
A(h);continue;case 21:l.push(new od(va(k.text,a.ca)));A(h);continue;case 22:Vf(a,",",k);l.push(",");A(h);continue;case 23:l.push(id);A(h);continue;case 24:m=k.text.toLowerCase();"-epubx-expr"==m?(a.b=Of,a.g=0,l.push("{")):(l.push(m),l.push("("));A(h);continue;case 25:Vf(a,")",k);A(h);continue;case 47:A(h);k=y(h);m=z(h,1);if(1==k.type&&"important"==k.text.toLowerCase()&&(17==m.type||0==m.type||13==m.type)){A(h);a.l=!0;continue}Wf(a,"E_CSS_SYNTAX",k);continue;case 54:m=z(h,1);switch(m.type){case 4:case 3:case 5:if(!m.b){A(h);
...
function og(a,b,c,d,e,f){if(a){var g=new ng;try{a.U(g);var h;a:{if(0<g.b.length){a=[];for(var l=0;l<g.b.length;l++){var k=g.b[l];if("%"==k.aa){var m=0==l%2?d:e;3==l&&"circle"==g.name&&(m=Math.sqrt((d*d+e*e)/2));a.push(k.C*m/100)}else a.push(k.C*oc(f,k.aa,!1))}switch(g.name){case "polygon":if(0==a.length%2){f=[];for(g=0;g<a.length;g+=2)f.push({x:b+a[g],y:c+a[g+1]});h=new ve(f);break a}break;case "rectangle":if(4==a.length){h=ye(b+a[0],c+a[1],b+a[0]+a[2],c+a[1]+a[3]);break a}break;case "ellipse":if(4==
...
n.Ic=function(a){return this.b&64?a:null};n.lc=function(a){return this.b&128?a:null};n.gb=function(){return null};n.ub=function(){return null};n.kb=function(){return null};n.Qb=function(){return null};var zg=new Bg(0,T,T);
...
n.Sb=function(a){return this.Ua(a)};n.Rb=function(a){return this.Ua(a)};n.Ic=function(a){return this.Ua(a)};n.lc=function(a){return this.Ua(a)};n.gb=function(){return null};n.ub=function(){return null};n.kb=function(a){return this.Ua(a)};n.Qb=function(){return null};function Gg(a){Eg.call(this,a)}t(Gg,Eg);Gg.prototype.gb=function(a){var b=Fg(this,a.values,!1,0);return b===a.values?a:b?new cd(b):null};
...
c[0]}for(;;){var l=bh(d,f,3);if(!l)break;var k=z(f,1),m;1==k.type&&Ug[k.text]?(m=new Ug[k.text],A(f)):m=new Pg;m.d=d;g=!1;h=[];c=!1;for(var p=[],r=[];!g;)switch(A(f),k=y(f),k.type){case 1:if(d.e[k.text])h.push(new Kg(m.d,k.text)),r.push(k.text);else if(d.f[k.text]instanceof Qg){var w=d.f[k.text];h.push(new Lg(w.d,w.b));r.push.apply(r,w.b)}else throw Error("'"+k.text+"' is neither a simple property nor an inset shorthand");break;case 19:if(0<h.length||c)throw Error("unexpected slash");c=!0;break;case 14:p.push({Cd:c,
...
function Zh(a,b){Object.keys(a.b).forEach(function(a){for(var b=this.b[a],c=0;c<b.length;)this.N.contains(b[c])?c++:b.splice(c,1);0===b.length&&delete this.b[a]},a);var c=a.N.getBoundingClientRect();a.e.width=c.width;a.e.height=c.height;for(var d=a.h,c=0;c<d.length;c++){var e=d[c];v(e.target,e.name,e.value.toString())}for(c=0;c<b.length;c++){var d=b[c],f=a.b[d.dc],e=a.b[d.ge];if(f&&e&&(f=Uh(f,d.action)))for(var g=0;g<e.length;g++)e[g].addEventListener(d.event,f,!1)}}
Vh.prototype.zoom=function(a){v(this.N,"transform","scale("+a+")")};Vh.prototype.B=function(){return this.w||this.N};function $h(a){switch(a){case "normal":case "nowrap":return 0;case "pre-line":return 1;case "pre":case "pre-wrap":return 2;default:return null}}function ai(a,b){if(1==a.nodeType)return!1;var c=a.textContent;switch(b){case 0:return!!c.match(/^\s*$/);case 1:return!!c.match(/^[ \t\f]*$/);case 2:return 0==c.length}throw Error("Unexpected whitespace: "+b);}
function bi(a){this.d=a;this.b=[]}function ci(a,b,c,d,e,f,g,h,l){this.b=a;this.element=b;this.d=c;this.Ga=d;this.h=e;this.f=f;this.je=g;this.g=h;this.Qa=-1;this.e=l}function ei(a,b){return a.f?!b.f||a.Ga>b.Ga?!0:a.g:!1}function fi(a,b){return a.top-b.top}function gi(a,b){return b.right-a.right}
...
function li(a){a.e=!0;a.j=a.parent?a.parent.j:0;a.A=null;a.u=null;a.ea=0;a.J=!1;a.display=null;a.k=null;a.l=null;a.B=!1;a.w=a.parent?a.parent.w:0;a.h=null;a.D=null;a.sa=null;a.I=!1;a.H=!1;a.b=a.parent?a.parent.b:!1;a.sa=null}function mi(a){var b=new ki(a.Y,a.parent,a.ia);b.ea=a.ea;b.J=a.J;b.sa=a.sa;b.Ha=a.Ha;b.fa=a.fa;b.pa=a.pa;b.e=a.e;b.j=a.j;b.display=a.display;b.k=a.k;b.l=a.l;b.I=a.I;b.H=a.H;b.B=a.B;b.w=a.w;b.h=a.h;b.D=a.D;b.A=a.A;b.u=a.u;b.f=a.f;b.b=a.b;b.d=a.d;return b}
ki.prototype.modify=function(){return this.S?mi(this):this};function ni(a){var b=a;do{if(b.S)break;b.S=!0;b=b.parent}while(b);return a}ki.prototype.clone=function(){for(var a=mi(this),b=a,c;null!=(c=b.parent);)c=mi(c),b=b.parent=c;return a};function oi(a){return{ga:a.Y,Ha:a.Ha,fa:a.fa,sa:a.sa,pa:a.pa?oi(a.pa):null}}function pi(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(oi(b)),b=b.parent;while(b);return{ha:c,ea:a.ea,J:a.J}}
...
function Mj(a,b){this.b=null;this.f=a;this.Vb=b}t(Mj,V);function Nj(a,b){var c=a.f;b-=a.Vb;return 0===c?0===b:0===b%c&&0<=b/c}function Oj(a,b){Mj.call(this,a,b)}t(Oj,Mj);Oj.prototype.apply=function(a){Nj(this,a.za)&&this.b.apply(a)};Oj.prototype.d=function(){return 5};function Pj(a,b){Mj.call(this,a,b)}t(Pj,Mj);Pj.prototype.apply=function(a){Nj(this,a.ab[a.e][a.d])&&this.b.apply(a)};Pj.prototype.d=function(){return 5};function Qj(a,b){Mj.call(this,a,b)}t(Qj,Mj);
...
nk={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},ok={Ge:!1,Wb:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",vc:"\u5341\u767e\u5343",ee:"\u8ca0"};
function pk(a){if(9999<a||-9999>a)return""+a;if(0==a)return ok.Wb.charAt(0);var b=new Ia;0>a&&(b.append(ok.ee),a=-a);if(10>a)b.append(ok.Wb.charAt(a));else if(ok.He&&19>=a)b.append(ok.vc.charAt(0)),0!=a&&b.append(ok.vc.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(ok.Wb.charAt(c)),b.append(ok.vc.charAt(2)));if(c=Math.floor(a/100)%10)b.append(ok.Wb.charAt(c)),b.append(ok.vc.charAt(1));if(c=Math.floor(a/10)%10)b.append(ok.Wb.charAt(c)),b.append(ok.vc.charAt(0));(a%=10)&&b.append(ok.Wb.charAt(a))}return b.toString()}
...
function Ck(a,b,c,d){this.k=a;this.h=b;this.Gb=c;this.Za=d;this.g=[[],[]];this.j={};this.w=this.u=this.b=null;this.ra=this.ca=this.O=this.e=this.d="";this.S=this.H=null;this.ma=this.Ta=!0;this.f={};this.B=[{}];this.D=[new jd("\u201c"),new jd("\u201d"),new jd("\u2018"),new jd("\u2019")];this.l=0;this.lang="";this.zb=[0];this.za=0;this.ka=[{}];this.ab=this.ka[0];this.I=null;this.xb=[this.I];this.yb=[{}];this.$a=this.ka[0];this.hb=[]}function ak(a,b){a.j[b]=(a.j[b]||0)+1}
function Dk(a,b,c){(b=b[c])&&b.apply(a)}var Ek=[];function Fk(a,b,c,d){a.b=null;a.u=d;a.e="";a.d="";a.O="";a.ca="";a.w=b;a.ra="";a.H=Ek;a.S=c;Gk(a)}function Hk(a,b,c){a.f[b]?a.f[b].push(c):a.f[b]=[c];c=a.B[a.B.length-1];c||(c={},a.B[a.B.length-1]=c);c[b]=!0}
...
function ul(a,b,c,d,e,f,g,h){this.Z=a;this.root=a.root;this.za=c;this.f=d;this.j=f;this.d=this.root;this.H={};this.I={};this.l={};this.w=[];this.k=this.D=this.B=null;this.O=new Ck(b,d,g,h);this.e=new cl;this.Na=!0;this.ca=[];this.ra=e;this.ma=this.ka=!1;this.b=a=wh(a,this.root);this.S={};this.g=new ql(d);el(this.e,a);d=vl(this,this.root);Lk(this.O,this.root,d);wl(this,d,!1);this.u=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.u=
!1}this.ca.push(!0);this.I={};this.I["e"+a]=d;this.b++;xl(this,-1)}function yl(a,b,c,d){return(b=b[d])&&b.evaluate(a.f)!==c[d]}function zl(a,b,c){for(var d in c){var e=b[d];e?(a.H[d]=e,delete b[d]):(e=c[d])&&(a.H[d]=new U(e,33554432))}}var Bl=["column-count","column-width"];
...
function Hl(a,b,c,d,e){var f=0,g=Number.POSITIVE_INFINITY,h=!1,l=!1,k=!1,m=c["flow-options"];if(m){var p;a:{if(h=m.evaluate(a.f,"flow-options")){l=new kg;try{h.U(l);p=l.b;break a}catch(r){u.b(r,"toSet:")}}p={}}h=!!p.exclusive;l=!!p["static"];k=!!p.last}(p=c["flow-linger"])&&(g=mg(p.evaluate(a.f,"flow-linger"),Number.POSITIVE_INFINITY));(c=c["flow-priority"])&&(f=mg(c.evaluate(a.f,"flow-priority"),0));c=a.S[e]||null;p=a.l[b];p||(p=rl(a.g),p=a.l[b]=new bi(p?p.g.b:null));d=new ci(b,d,e,f,g,h,l,k,c);
...
function Gl(a,b,c){var d=-1;if(b<=a.b&&(d=gl(a.e,b),d+=c,d<dl(a.e)))return hl(a.e,d);if(null==a.d)return Number.POSITIVE_INFINITY;for(var e=a.f;;){var f=a.d.firstChild;if(null==f)for(;;){if(1==a.d.nodeType){var f=a.O,g=a.d;if(f.hb.pop()!==g)throw Error("Invalid call to popElement");f.zb.pop();f.ka.pop();f.xb.pop();f.yb.pop();f.pop();Jk(f);a.Na=a.ca.pop();g=a.g.pop(a.b);f=null;g.d&&(f=nl(g.d,"before"),Kl(a,f,g.d.Ea?tl(a.g,g):g.d.offset,g.b),f=nl(g.d,"after"));f=ml(f,nl(g,"after"));Kl(a,f,a.b,g.b)}if(f=
a.d.nextSibling)break;a.d=a.d.parentNode;if(a.d===a.root)return a.d=null,b<a.b&&(0>d&&(d=gl(a.e,b),d+=c),d<=dl(a.e))?hl(a.e,d):Number.POSITIVE_INFINITY}a.d=f;if(1!=a.d.nodeType){a.b+=a.d.textContent.length;var f=a.g,g=a.d,h=rl(f);(f.Ea||f.Ia)&&jl(h)&&(h=ll(h,"white-space",Sd).toString(),ai(g,$h(h))||(f.Ea=!1,f.Ia=!1));a.Na?el(a.e,a.b):fl(a.e,a.b)}else{g=a.d;f=vl(a,g);a.ca.push(a.Na);Lk(a.O,g,f);(h=g.getAttribute("id")||g.getAttributeNS("http://www.w3.org/XML/1998/namespace","id"))&&h===a.k&&(a.k=
...
function Ql(a,b){this.e=b;var c=this;ec.call(this,a,function(a,b){var f=a.match(/^([^.]+)\.([^.]+)$/);if(f){var g=c.e.h[f[1]];if(g&&(g=this.ka[g])){if(b){var f=f[2],h=g.ca[f];if(h)g=h;else{switch(f){case "columns":var h=g.d.d,l=new Wc(h,0),k=Rl(g,"column-count"),m=Rl(g,"column-width"),p=Rl(g,"column-gap"),h=F(h,Yc(h,new Tc(h,"min",[l,k]),D(h,m,p)),p)}h&&(g.ca[f]=h);g=h}}else g=Rl(g,f[2]);return g}}return null})}t(Ql,ec);
...
function bm(a,b){this.e=a;this.d=b;this.D={};this.style={};this.k=this.l=null;this.children=[];this.H=this.I=this.f=this.g=!1;this.w=this.B=0;this.u=null;this.ka={};this.ca={};this.ra=this.b=!1;a&&a.children.push(this)}function cm(a){a.B=0;a.w=0}function dm(a,b,c){b=Rl(a,b);c=Rl(a,c);if(!b||!c)throw Error("E_INTERNAL");return D(a.d.d,b,c)}
...
bm.prototype.Wc=function(){var a=this.d.d,b=this.style,c=this.e?this.e.style.width.ja(a,null):null,d=X(a,b.left,c),e=X(a,b["margin-left"],c),f=$l(a,b["border-left-width"],b["border-left-style"],c),g=Yl(a,b["padding-left"],c),h=X(a,b.width,c),l=X(a,b["max-width"],c),k=Yl(a,b["padding-right"],c),m=$l(a,b["border-right-width"],b["border-right-style"],c),p=X(a,b["margin-right"],c),r=X(a,b.right,c),w=D(a,f,g),q=D(a,f,k);d&&r&&h?(w=F(a,c,D(a,h,D(a,D(a,d,w),q))),e?p?r=F(a,w,p):p=F(a,w,D(a,r,e)):(w=F(a,w,
r),p?e=F(a,w,p):p=e=Yc(a,w,new B(a,.5)))):(e||(e=a.b),p||(p=a.b),d||r||h||(d=a.b),d||h?d||r?h||r||(h=this.l,this.g=!0):d=a.b:(h=this.l,this.g=!0),w=F(a,c,D(a,D(a,e,w),D(a,p,q))),this.g&&(l||(l=F(a,w,d?d:r)),this.b||!X(a,b["column-width"],null)&&!X(a,b["column-count"],null)||(h=l,this.g=!1)),d?h?r||(r=F(a,w,D(a,d,h))):h=F(a,w,D(a,d,r)):d=F(a,w,D(a,r,h)));a=Yl(a,b["snap-width"]||(this.e?this.e.style["snap-width"]:null),c);b.left=new K(d);b["margin-left"]=new K(e);b["border-left-width"]=new K(f);b["padding-left"]=
...
bm.prototype.Xc=function(){var a=this.d.d,b=this.style,c=this.e?this.e.style.width.ja(a,null):null,d=this.e?this.e.style.height.ja(a,null):null,e=X(a,b.top,d),f=X(a,b["margin-top"],c),g=$l(a,b["border-top-width"],b["border-top-style"],c),h=Yl(a,b["padding-top"],c),l=X(a,b.height,d),k=X(a,b["max-height"],d),m=Yl(a,b["padding-bottom"],c),p=$l(a,b["border-bottom-width"],b["border-bottom-style"],c),r=X(a,b["margin-bottom"],c),w=X(a,b.bottom,d),q=D(a,g,h),x=D(a,p,m);e&&w&&l?(d=F(a,d,D(a,l,D(a,D(a,e,q),
x))),f?r?w=F(a,d,f):r=F(a,d,D(a,w,f)):(d=F(a,d,w),r?f=F(a,d,r):r=f=Yc(a,d,new B(a,.5)))):(f||(f=a.b),r||(r=a.b),e||w||l||(e=a.b),e||l?e||w?l||w||(l=this.k,this.f=!0):e=a.b:(l=this.k,this.f=!0),d=F(a,d,D(a,D(a,f,q),D(a,r,x))),this.f&&(k||(k=F(a,d,e?e:w)),this.b&&(X(a,b["column-width"],null)||X(a,b["column-count"],null))&&(l=k,this.f=!1)),e?l?w||(w=F(a,d,D(a,e,l))):l=F(a,d,D(a,w,e)):e=F(a,d,D(a,w,l)));a=Yl(a,b["snap-height"]||(this.e?this.e.style["snap-height"]:null),c);b.top=new K(e);b["margin-top"]=
new K(f);b["border-top-width"]=new K(g);b["padding-top"]=new K(h);b.height=new K(l);b["max-height"]=new K(k?k:l);b["padding-bottom"]=new K(m);b["border-bottom-width"]=new K(p);b["margin-bottom"]=new K(r);b.bottom=new K(w);b["snap-height"]=new K(a)};
...
function im(a,b){var c;a:{if(c=a.D["region-id"]){for(var d=[],e=0;e<c.length;e++){var f=c[e].evaluate(b,"");f&&f!==G&&d.push(f)}if(d.length){c=d;break a}}c=null}if(c){d=[];for(e=0;e<c.length;e++)d[e]=c[e].toString();return d}return null}function km(a,b,c,d,e){if(a=jm(a,b,d))a.$b()&&lc(a.aa)&&(a=new I(qd(a,b),"px")),"font-family"===d&&(a=nh(e,a)),v(c.element,d,a.toString())}
function lm(a,b,c){var d=Y(a,b,"left"),e=Y(a,b,"margin-left"),f=Y(a,b,"padding-left"),g=Y(a,b,"border-left-width");a=Y(a,b,"width");Hi(c,d,a);v(c.element,"margin-left",e+"px");v(c.element,"padding-left",f+"px");v(c.element,"border-left-width",g+"px");c.marginLeft=e;c.O=g;c.h=f}
...
function qm(a,b,c){v(c.element,"border-top-width","0px");var d=Y(a,b,"max-height");a.I?Gi(c,0,d):(nm(a,b,c),d-=c.ma,c.height=d,v(c.element,"height",d+"px"))}function rm(a,b,c){v(c.element,"border-left-width","0px");var d=Y(a,b,"max-width");a.H?Hi(c,0,d):(mm(a,b,c),d-=c.zb,c.width=d,a=Y(a,b,"right"),v(c.element,"right",a+"px"),v(c.element,"width",d+"px"))}
...
bm.prototype.tc=function(a,b,c,d,e,f,g){this.b?this.B=b.d+b.zb:this.w=b.d+b.ma;f=(this.b||!d)&&this.f;var h=(!this.b||!d)&&this.g,l=null;if(h||f)h&&v(b.element,"width","auto"),f&&v(b.element,"height","auto"),l=(d?d.element:b.element).getBoundingClientRect(),h&&(this.B=Math.ceil(l.right-l.left-b.h-b.O-b.u-b.Ta),this.b&&(this.B+=b.zb)),f&&(this.w=l.bottom-l.top-b.j-b.S-b.l-b.za,this.b||(this.w+=b.ma));(this.b?this.f:this.g)&&pm(this,a,b);if(this.b?this.g:this.f){if(this.b?this.H:this.I)this.b?mm(this,
a,b):nm(this,a,b);this.b?lm(this,a,b):om(this,a,b)}if(1<e&&(f=Y(this,a,"column-rule-width"),h=jm(this,a,"column-rule-style"),l=jm(this,a,"column-rule-color"),0<f&&h&&h!=Rd&&l!=ee)){var k=Y(this,a,"column-gap"),m=this.b?b.height:b.width,p=this.b?"border-top":"border-left";for(d=1;d<e;d++){var r=(m+k)*d/e-k/2+b.h-f/2,w=b.height+b.j+b.l,q=b.element.ownerDocument.createElement("div");v(q,"position","absolute");v(q,this.b?"left":"top","0px");v(q,this.b?"top":"left",r+"px");v(q,this.b?"height":"width",
"0px");v(q,this.b?"width":"height",w+"px");v(q,p,f+"px "+h.toString()+(l?" "+l.toString():""));b.element.insertBefore(q,b.element.firstChild)}}for(d=0;d<tm.length;d++)km(this,a,b,tm[d],g);for(d=0;d<vm.length;d++)e=b,g=vm[d],f=c.h,(h=jm(this,a,g))&&f.push(new Sh(e.element,g,h))};
...
function Om(a,b,c,d,e,f,g,h,l,k,m,p,r,w){this.w=a;this.d=b;this.viewport=c;this.l=c.b;this.h=d;this.D=e;this.Z=f;this.B=g;this.k=h;this.H=l;this.page=k;this.f=m;this.u=p;this.e=r;this.j=w;this.I=this.b=null;this.g=!1;this.Y=null;this.ea=0;this.A=null}Om.prototype.clone=function(){return new Om(this.w,this.d,this.viewport,this.h,this.D,this.Z,this.B,this.k,this.H,this.page,this.f,this.u,this.e,this.j)};
...
function Sm(a,b,c,d,e,f,g,h){var l=L("createShadows"),k=e.template,m;k instanceof od?m=Pm(a,k.url,2,b,h,null):m=M(null);m.then(function(k){var m=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var w=b.getAttribute("href"),q=null;w?q=h?h.Z:a.Z:h&&(w="http://www.w3.org/1999/xhtml"==h.$.namespaceURI?h.$.getAttribute("href"):h.$.getAttributeNS("http://www.w3.org/1999/xlink","href"),q=h.ed?h.ed.Z:a.Z);w&&(w=va(w,q.url),m=Pm(a,w,3,b,h,k))}null==m&&(m=M(k));m.then(function(k){var m;
if(m=d._pseudos){for(var p=[],r=Km.createElementNS("http://www.pyroxy.com/ns/shadow","root"),q=r,w=0;w<Lm.length;w++){var E=Lm[w],J;if(E){if(!m[E])continue;if(!("footnote-marker"!=E||c&&a.g))continue;if(E.match(/^first-/)&&(J=e.display,!J||J===Jd))continue;if("before"===E||"after"===E)if(J=m[E].content,!J||J===Sd||J===Rd)continue;p.push(E);J=Km.createElementNS("http://www.w3.org/1999/xhtml","span");J.setAttribute("data-adapt-pseudo",E)}else J=Km.createElementNS("http://www.pyroxy.com/ns/shadow","content");
...
function Ym(a,b){var c=Zi.filter(function(a){return b[a]});if(c.length){var d=a.b.g;if(a.b.parent){var d=a.b.g={},e;for(e in a.b.parent.g)d[e]=a.b.parent.g[e]}c.forEach(function(a){var c=b[a];if(c){if(c instanceof md)d[a]=c.C;else if(c instanceof kd)d[a]=c.name;else if(c instanceof I)switch(c.aa){case "dpi":case "dpcm":case "dppx":d[a]=c.C*kc[c.aa]}delete b[a]}})}}
function Zm(a,b,c){var d=!0,e=L("createElementView"),f=a.Y,g=a.b.fa?a.b.fa.b:a.h,h=g.h(f,!1),l={};a.b.parent||(h=Vm(a,h));a.b.b=Um(a,a.b.b,h,l);Ym(a,l);l.direction&&(a.b.O=l.direction.toString());var k=l["flow-into"];if(k&&k.toString()!=a.w)return O(e,!1),N(e);var m=l.display;if(m===Rd)return O(e,!1),N(e);k=null==a.b.parent;a.b.B=m===Fd;Sm(a,f,k,h,l,g,a.d,a.b.fa).then(function(g){a.b.sa=g;var h=l.position;g=l["float-reference"];var k=l["float"],q=l.clear,x=a.b.b?ge:Hd;a.b.I=Mi(m,h,k,l.overflow,x,
...
!h&&!m||m===Jd;a.b.display=m?m.toString():"inline";a.b.k=h?k.toString():null;a.b.ca=g?g.toString():null;if(!a.b.e){if(g=l["break-after"])a.b.D=g.toString();if(g=l["break-before"])a.b.h=g.toString()}if(g=l["x-first-pseudo"])a.b.f=new ji(a.b.parent?a.b.parent.f:null,g.C);if(g=l["white-space"])g=$h(g.toString()),null!==g&&(a.b.w=g);var W=!1,ga=null,Ja=[],la=f.namespaceURI,E=f.localName;if("http://www.w3.org/1999/xhtml"==la)"html"==E||"body"==E||"script"==E||"link"==E||"meta"==E?E="div":"vide_"==E?E=
"video":"audi_"==E?E="audio":"object"==E&&(W=!!a.f);else if("http://www.idpf.org/2007/ops"==la)E="span",la="http://www.w3.org/1999/xhtml";else if("http://www.gribuser.ru/xml/fictionbook/2.0"==la){la="http://www.w3.org/1999/xhtml";if("image"==E){if(E="div",(g=f.getAttributeNS("http://www.w3.org/1999/xlink","href"))&&"#"==g.charAt(0)&&(g=Bh(a.Z,g)))ga=a.createElement(la,"img"),g="data:"+(g.getAttribute("content-type")||"image/jpeg")+";base64,"+g.textContent.replace(/[ \t\n\t]/g,""),Ja.push(tg(ga,g))}else E=
Wm[E];E||(E=a.b.e?"span":"div")}else if("http://www.daisy.org/z3986/2005/ncx/"==la)if(la="http://www.w3.org/1999/xhtml","ncx"==E||"navPoint"==E)E="div";else if("navLabel"==E){if(E="span",k=f.parentNode){g=null;for(k=k.firstChild;k;k=k.nextSibling)if(1==k.nodeType&&(q=k,"http://www.daisy.org/z3986/2005/ncx/"==q.namespaceURI&&"content"==q.localName)){g=q.getAttribute("src");break}g&&(E="a",f=f.ownerDocument.createElementNS(la,"a"),f.setAttribute("href",g))}}else E="span";else"http://www.pyroxy.com/ns/shadow"==
la?(la="http://www.w3.org/1999/xhtml",E=a.b.e?"span":"div"):W=!!a.f;S?b?E="li":(E="div",m=vd,l.display=m):"body"==E||"li"==E?E="div":"q"==E?E="span":"a"==E&&(g=l["hyperlink-processing"])&&"normal"!=g.toString()&&(E="span");l.behavior&&"none"!=l.behavior.toString()&&a.f&&(W=!0);f.dataset&&"true"==f.dataset.mathTypeset&&(W=!0);var J;W?J=a.f(f,a.b.parent?a.b.parent.A:null,l):J=M(null);J.then(function(g){g?W&&(d="true"==g.getAttribute("data-adapt-process-children")):g=a.createElement(la,E);"a"==E&&g.addEventListener("click",
a.page.D,!1);ga&&($m(a,a.b,"inner",ga),g.appendChild(ga));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&Jm(g);var h=a.b.g["image-resolution"],k=[],m=l.width,p=l.height,r=f.getAttribute("width"),q=f.getAttribute("height"),m=m===ud||!m&&!r,p=p===ud||!p&&!q;if("http://www.gribuser.ru/xml/fictionbook/2.0"!=f.namespaceURI||"td"==E){for(var r=f.attributes,w=r.length,q=null,x=0;x<w;x++){var J=r[x],Mb=J.namespaceURI,ya=J.localName,J=J.nodeValue;if(Mb)if("http://www.w3.org/2000/xmlns/"==
Mb)continue;else"http://www.w3.org/1999/xlink"==Mb&&"href"==ya&&(J=Xm(a,J));else{if(ya.match(/^on/))continue;if("style"==ya)continue;if(("id"==ya||"name"==ya)&&b){J=a.j.ld(J,a.Z.url);g.setAttribute(ya,J);Yh(a.page,g,J);continue}"src"==ya||"href"==ya||"poster"==ya?(J=Xm(a,J),"href"===ya&&(J=a.j.b(J,a.Z.url))):"srcset"==ya&&(J=J.split(",").map(function(b){return Xm(a,b.trim())}).join(","));if("poster"===ya&&"video"===E&&"http://www.w3.org/1999/xhtml"===la&&m&&p){var hc=new Image,Dl=tg(hc,J);Ja.push(Dl);
k.push({Kd:hc,element:g,Id:Dl})}}Mb&&(hc=Im[Mb])&&(ya=hc+":"+ya);"src"!=ya||Mb||"img"!=E&&"input"!=E||"http://www.w3.org/1999/xhtml"!=la?"href"==ya&&"image"==E&&"http://www.w3.org/2000/svg"==la&&"http://www.w3.org/1999/xlink"==Mb?a.page.g.push(tg(g,J)):Mb?g.setAttributeNS(Mb,ya,J):g.setAttribute(ya,J):q=J}q&&(hc="input"===E?new Image:g,r=tg(hc,q),hc!==g&&(g.src=q),m||p?(m&&p&&h&&1!==h&&k.push({Kd:hc,element:g,Id:r}),Ja.push(r)):a.page.g.push(r))}delete l.content;(m=l["list-style-image"])&&m instanceof
od&&(m=m.url,Ja.push(tg(new Image,m)));an(a,g,l);if(!a.b.e&&(m=null,b?c&&(m=a.b.b?Hm:Gm):m="clone"!==a.b.g["box-decoration-break"]?a.b.b?Fm:Em:a.b.b?Hm:Gm,m))for(var El in m)v(g,El,m[El]);S&&g.setAttribute("value",l["ua-list-item-count"].stringValue());a.A=g;Ja.length?sg(Ja).then(function(){0<h&&bn(a,k,h,l,a.b.b);O(e,d)}):lf().then(function(){O(e,d)})})});return N(e)}
function bn(a,b,c,d,e){b.forEach(function(b){if("load"===uf(b.Id).Ub()){var g=b.Kd,h=g.width/c,g=g.height/c;b=b.element;if(0<h&&0<g)if(1<c){var l=d["max-width"]||Rd,k=d["max-height"]||Rd;l===Rd&&k===Rd?v(b,"max-width",h+"px"):l!==Rd&&k===Rd?v(b,"width",h+"px"):l===Rd&&k!==Rd?v(b,"height",g+"px"):"%"!==l.aa?v(b,"max-width",Math.min(h,qd(l,a.d))+"px"):"%"!==k.aa?v(b,"max-height",Math.min(g,qd(k,a.d))+"px"):e?v(b,"height",g+"px"):v(b,"width",h+"px")}else 1>c&&(l=d["min-width"]||me,k=d["min-height"]||
me,0===l.C&&0===k.C?v(b,"min-width",h+"px"):0!==l.C&&0===k.C?v(b,"width",h+"px"):0===l.C&&0!==k.C?v(b,"height",g+"px"):"%"!==l.aa?v(b,"min-width",Math.max(h,qd(l,a.d))+"px"):"%"!==k.aa?v(b,"min-height",Math.max(g,qd(k,a.d))+"px"):e?v(b,"height",g+"px"):v(b,"width",h+"px"))}})}
function cn(a,b,c){var d=L("createNodeView"),e=!0;1==a.Y.nodeType?b=Zm(a,b,c):(8==a.Y.nodeType?a.A=null:a.A=document.createTextNode(a.Y.textContent.substr(a.ea||0)),b=M(!0));b.then(function(b){e=b;(a.b.A=a.A)&&(b=a.b.parent?a.b.parent.A:a.I)&&b.appendChild(a.A);O(d,e)});return N(d)}function dn(a,b,c,d){(a.b=b)?(a.Y=b.Y,a.ea=b.ea):(a.Y=null,a.ea=-1);a.A=null;return a.b?cn(a,c,!!d):M(!0)}
function en(a){if(null==a.fa||"content"!=a.Y.localName||"http://www.pyroxy.com/ns/shadow"!=a.Y.namespaceURI)return a;var b=a.ia,c=a.fa,d=a.parent,e,f;c.Dd?(f=c.Dd,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.ed,e=c.$.firstChild,c=2);var g=a.Y.nextSibling;g?(a.Y=g,li(a)):a.pa?a=a.pa:e?a=null:(a=a.parent.modify(),a.J=!0);if(e)return b=new ki(e,d,b),b.fa=f,b.Ha=c,b.pa=a,b;a.ia=b;return a}
function fn(a){var b=a.ia+1;if(a.J){if(!a.parent)return null;if(3!=a.Ha){var c=a.Y.nextSibling;if(c)return a=a.modify(),a.ia=b,a.Y=c,li(a),en(a)}if(a.pa)return a=a.pa.modify(),a.ia=b,a;a=a.parent.modify()}else{if(a.sa&&(c=a.sa.root,2==a.sa.type&&(c=c.firstChild),c))return b=new ki(c,a,b),b.fa=a.sa,b.Ha=a.sa.type,en(b);if(c=a.Y.firstChild)return en(new ki(c,a,b));1!=a.Y.nodeType&&(b+=a.Y.textContent.length-1-a.ea);a=a.modify()}a.ia=b;a.J=!0;return a}
...
function an(a,b,c){var d=c["background-image"];d&&hn(a,d);var d=c.position===Wd,e;for(e in c)if(!jn[e]){var f=c[e];Qh[e]||d&&Rh[e]?a.page.h.push(new Sh(b,e,f)):(f.$b()&&lc(f.aa)&&(f=new I(qd(f,a.d),"px")),v(b,e,f.toString()))}}function $m(a,b,c,d){if(!b.J){var e=(b.fa?b.fa.b:a.h).h(a.Y,!1);if(e=e._pseudos)if(e=e[c])c={},b.b=Um(a,b.b,e,c),b=c.content,Ji(b)&&(b.U(new Ii(d,a.d)),delete c.content),an(a,d,c)}}
function kn(a,b,c){var d=L("peelOff"),e=b.f,f=b.ea,g=b.J;if(0<c)b.A.textContent=b.A.textContent.substr(0,c),f+=c;else if(!g&&b.A&&0==f){var h=b.A.parentNode;h&&h.removeChild(b.A)}for(var l=b.ia+c,k=[];b.f===e;)k.push(b),b=b.parent;var m=k.pop(),p=m.pa;mf(function(){for(;0<k.length;){m=k.pop();b=new ki(m.Y,b,l);0==k.length&&(b.ea=f,b.J=g);b.Ha=m.Ha;b.fa=m.fa;b.sa=m.sa;b.pa=m.pa?m.pa:p;p=null;var c=dn(a,b,!1);if(c.Ca())return c}return M(!1)}).then(function(){O(d,b)});return N(d)}
...
function mn(a){si(a,function(a){var c=a.g["box-decoration-break"];c&&"slice"!==c||(c=a.A,a.b?(v(c,"padding-left","0"),v(c,"border-left","none"),v(c,"border-top-left-radius","0"),v(c,"border-bottom-left-radius","0")):(v(c,"padding-bottom","0"),v(c,"border-bottom","none"),v(c,"border-bottom-left-radius","0"),v(c,"border-bottom-right-radius","0")))})}
function Si(a,b,c){return b.ea===c.ea&&b.J==c.J&&b.ha.length===c.ha.length&&b.ha.every(function(a,b){var f;f=c.ha[b];if(a.fa)if(f.fa){var g=1===a.ga.nodeType?a.ga:a.ga.parentElement,h=1===f.ga.nodeType?f.ga:f.ga.parentElement;f=a.fa.$===f.fa.$&&Mm(g)===Mm(h)}else f=!1;else f=a.ga===f.ga;return f}.bind(a))}function nn(a){this.b=a}function on(a){return a.getClientRects()}function pn(a,b){return a.b.getComputedStyle(b,null)}
...
qn.prototype.zoom=function(a,b,c){v(this.e,"width",a*c+"px");v(this.e,"height",b*c+"px");v(this.d,"width",a+"px");v(this.d,"height",b+"px");v(this.d,"transform","scale("+c+")")};Xi("SIMPLE_PROPERTY",function(a){var b=a.name,c=a.value;switch(b){case "page-break-before":case "page-break-after":case "page-break-inside":return{name:b.replace(/^page-/,""),value:c===td?Vd:c,important:a.important};default:return a}});var ol={page:!0,left:!0,right:!0,recto:!0,verso:!0,column:!0,region:!0},rn={avoid:!0,"avoid-page":!0,"avoid-column":!0,"avoid-region":!0};
...
function An(a,b,c,d){Ai.call(this,a);this.od=a.lastChild;this.f=b;this.ra=c;this.$a=d;this.Yd=a.ownerDocument;this.Jc=!1;this.ka=this.Oa=this.ta=this.ca=this.I=0;this.hb=this.xb=this.k=this.Za=null;this.pd=!1;this.g=this.e=this.w=null;this.Gd=!0;this.Kc=this.Mc=this.Lc=0}t(An,Ai);An.prototype.clone=function(){var a=new An(this.element,this.f,this.ra,this.$a);Fi(a,this);a.od=this.od;a.Jc=this.Jc;a.k=this.k?this.k.clone():null;a.xb=this.xb.concat();return a};
function Bn(a,b){return a.b?b<a.ka:b>a.ka}function Cn(a,b,c){var d=new ki(b.ga,c,0);d.Ha=b.Ha;d.fa=b.fa;d.sa=b.sa;d.pa=b.pa?Cn(a,b.pa,ni(c)):null;return d}function Dn(a,b){var c=L("openAllViews"),d=b.ha;Tm(a.f,a.element,a.Jc);var e=d.length-1,f=null;mf(function(){for(;0<=e;){f=Cn(a,d[e],f);if(0==e&&(f.ea=b.ea,f.J=b.J,f.J))break;var c=dn(a.f,f,0==e&&0==f.ea);e--;if(c.Ca())return c}return M(!1)}).then(function(){O(c,f)});return N(c)}var En=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
...
function Jn(a,b){if(!b.A)return M(b);var c=b.Y,d=L("buildDeepElementView");nf(function(d){Fn(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.Y!=c;)g=g.parent;if(null==g){b=f;P(d);return}}gn(a.f,f).then(function(f){(b=f)&&b.Y!=c?Hn(a.$a,b)?pf(d):(b=b.modify(),b.d=!0,P(d)):P(d)})})}).then(function(){O(d,b)});return N(d)}
function Kn(a,b,c,d,e){var f=a.Yd.createElement("div");a.b?(v(f,"height",d+"px"),v(f,"width",e+"px")):(v(f,"width",d+"px"),v(f,"height",e+"px"));v(f,"float",c);v(f,"clear",c);a.element.insertBefore(f,b);return f}function Ln(a){for(var b=a.element.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.element.removeChild(b);else break}b=c}}
function Mn(a){for(var b=a.element.firstChild,c=a.hb,d=a.b?a.b?a.I:a.ta:a.b?a.Oa:a.I,e=a.b?a.b?a.ca:a.Oa:a.b?a.ta:a.ca,f=0;f<c.length;f++){var g=c[f],h=g.R-g.W;g.left=Kn(a,b,"left",g.ba-d,h);g.right=Kn(a,b,"right",e-g.V,h)}}function Nn(a,b,c,d,e){var f;if(b&&b.J&&!b.e&&(f=un(b,0,a.b),!isNaN(f)))return f;b=c[d];for(e-=b.ia;;){f=un(b,e,a.b);if(!isNaN(f))return f;if(0<e)e--;else{d--;if(0>d)return a.ta;b=c[d];1!=b.A.nodeType&&(e=b.A.textContent.length)}}}
...
function Sn(a,b,c,d){if(a.e&&a.e[a.e.length-1].b)return Rn(a,b,c),M(!0);d+=40*(a.b?-1:1);var e=a.k,f=!e;if(f){var g=a.element.ownerDocument.createElement("div");v(g,"position","absolute");var h=a.f.clone(),e=new An(g,h,a.ra,a.$a);a.k=e;e.b=ln(a.f,a.b,g);e.Jc=!0;a.b?(e.left=0,v(e.element,"width","2em")):(e.top=a.Oa,v(e.element,"height","2em"))}a.element.appendChild(e.element);Qn(a,e.element,e);g=(a.b?-1:1)*(d-a.ta);a.b?e.height=a.Za.R-a.Za.W-Bi(e)-Ci(e):e.width=a.Za.V-a.Za.ba-Di(e)-Ei(e);d=(a.b?-1:
...
function Xn(a,b){var c=L("layoutFootnote"),d=b.A;d.setAttribute("style","");v(d,"display","inline-block");d.textContent="M";var e=d.getBoundingClientRect(),f=a.b?e.left:e.bottom;d.textContent="";$m(a.f,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d={ha:[{ga:b.Y,Ha:0,fa:b.fa,sa:null,pa:null}],ea:0,J:!1};e=b.ia;b=b.modify();b.J=!0;Sn(a,e,d,f).then(function(){a.k&&a.k.element.parentNode&&a.element.removeChild(a.k.element);Bn(a,f)&&0!=a.w.length&&(b.d=!0);O(c,b)});return N(c)}
function Yn(a,b){var c=L("layoutFloat"),d=b.A,e=b.k,f=b.ca,g=b.parent?b.parent.O:"ltr",h=a.f.e,l=b.A.parentNode;"page"===f?Qi(h,d,e):(v(d,"float","none"),v(d,"display","inline-block"),v(d,"vertical-align","top"));Jn(a,b).then(function(k){var m=d.getBoundingClientRect(),p=On(a,d),m=new pe(m.left-p.left,m.top-p.top,m.right+p.right,m.bottom+p.bottom);if("page"===f)Ri(h,b,a.f)?(m=l.ownerDocument.createElement("span"),v(m,"width","0"),v(m,"height","0"),l.appendChild(m),k.A=m,O(c,k)):Ti(h,b,m).then(function(){O(c,
null)});else{e=Ni(e,a.b,g);for(var r=a.I,w=a.ca,p=b.parent;p&&p.e;)p=p.parent;if(p){var q=p.A.ownerDocument.createElement("div");q.style.left="0px";q.style.top="0px";a.b?(q.style.bottom="0px",q.style.width="1px"):(q.style.right="0px",q.style.height="1px");p.A.appendChild(q);var x=q.getBoundingClientRect(),r=Math.max(a.b?x.top:x.left,r),w=Math.min(a.b?x.bottom:x.right,w);p.A.removeChild(q);q=a.b?m.R-m.W:m.V-m.ba;"left"==e?w=Math.max(w,r+q):r=Math.min(r,w-q);p.A.appendChild(b.A)}q=new pe(r,(a.b?-1:
1)*a.ta,w,(a.b?-1:1)*a.Oa);r=m;a.b&&(r=Ge(m));w=a.b?-1:1;r.W<a.Kc*w&&(x=r.R-r.W,r.W=a.Kc*w,r.R=r.W+x);Le(q,a.hb,r,e);a.b&&(m=new pe(-r.R,r.ba,-r.W,r.V));q=Pn(a,d);v(d,"width",m.V-m.ba-q.left-q.right+"px");v(d,"height",m.R-m.W-q.top-q.bottom+"px");v(d,"position","absolute");v(d,"display",b.display);w=null;p&&(p.H?w=p:w=ri(p));w?(q=w.A.ownerDocument.createElement("div"),q.style.position="absolute",w.b?q.style.right="0":q.style.left="0",q.style.top="0",w.A.appendChild(q),p=q.getBoundingClientRect(),
w.A.removeChild(q)):p={left:a.b?a.Oa:a.I,right:a.b?a.ta:a.ca,top:a.b?a.I:a.ta};(w?w.b:a.b)?v(d,"right",p.right-m.V+a.u+"px"):v(d,"left",m.ba-p.left+a.h+"px");v(d,"top",m.W-p.top+a.j+"px");b.u&&(b.u.parentNode.removeChild(b.u),b.u=null);p=a.b?m.ba:m.R;m=a.b?m.V:m.W;Bn(a,p)&&0!=a.w.length?(b=b.modify(),b.d=!0,O(c,b)):(Ln(a),q=new pe(a.b?a.Oa:a.I,a.b?a.I:a.ta,a.b?a.ta:a.ca,a.b?a.ca:a.Oa),a.b&&(q=Ge(q)),Me(q,a.hb,r,e),Mn(a),"left"==e?a.Lc=p:a.Mc=p,a.Kc=m,Zn(a,p),O(c,k))}});return N(c)}
...
function no(a,b,c){function d(){b=k[0]||b;b.A.parentNode.removeChild(b.A);e.g=h}var e=a,f=L("skipEdges"),g=c&&b&&b.J,h=null,l=null,k=[],m=[],p=!1;nf(function(a){for(;b;){do if(b.A){if(b.e&&1!=b.A.nodeType){if(ai(b.A,b.w))break;if(!b.J){!c&&ol[h]?d():lo(e,l,null,!0,h)?(b=(l||b).modify(),b.d=!0):(b=b.modify(),b.h=h);P(a);return}}if(!b.J&&(b.l&&mo(e,b),b.k||b.B)){k.push(ni(b));h=ml(h,b.h);if(!c&&ol[h])d();else if(lo(e,l,null,!0,h)||!Hn(e.$a,b))b=(l||b).modify(),b.d=!0;P(a);return}if(1==b.A.nodeType){var f=
b.A.style;if(b.J){if(p){if(!c&&ol[h]){d();P(a);return}k=[];g=c=!1;h=null}p=!1;l=ni(b);m.push(l);h=ml(h,b.D);if(f&&(!ko(f.paddingBottom)||!ko(f.borderBottomWidth))){if(lo(e,l,null,!0,h)){b=(l||b).modify();b.d=!0;P(a);return}m=[l];l=null}}else{k.push(ni(b));h=ml(h,b.h);if(!Hn(e.$a,b)){lo(e,l,null,!1,h);b=b.modify();b.d=!0;P(a);return}if(tn[b.A.localName]){!c&&ol[h]?d():lo(e,l,null,!0,h)&&(b=(l||b).modify(),b.d=!0);P(a);return}!f||ko(f.paddingTop)&&ko(f.borderTopWidth)||(g=!1,m=[]);p=!0}}}while(0);f=
gn(e.f,b,g);if(f.Ca()){f.then(function(c){b=c;pf(a)});return}b=f.Ub()}lo(e,l,m,!1,h)?l&&(b=l.modify(),b.d=!0):ol[h]&&(e.g=h);P(a)}).then(function(){O(f,b)});return N(f)}
...
function Un(a){var b=a.element.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.j+"px";b.style.right=a.u+"px";b.style.bottom=a.l+"px";b.style.left=a.h+"px";a.element.appendChild(b);var c=b.getBoundingClientRect();a.element.removeChild(b);var b=a.B+a.left+Di(a),d=a.D+a.top+Bi(a);a.Za=new pe(b,d,b+a.width,d+a.height);a.I=c?a.b?c.top:c.left:0;a.ca=c?a.b?c.bottom:c.right:0;a.ta=c?a.b?c.right:c.top:0;a.Oa=c?a.b?c.left:c.bottom:0;a.Lc=a.ta;a.Mc=a.ta;a.Kc=a.ta;a.ka=a.Oa;c=a.Za;
b=a.B+a.left+Di(a);d=a.D+a.top+Bi(a);if(a.yb){for(var e=a.yb,f=[],g=0;g<e.b.length;g++){var h=e.b[g];f.push(new qe(h.x+b,h.y+d))}b=new ve(f)}else b=ye(b,d,b+a.width,d+a.height);a.hb=Ie(c,[b],a.H,a.ab,a.b);Mn(a);a.e=null}function Tn(a){a.xb=[];v(a.element,"width",a.width+"px");v(a.element,"height",a.height+"px");Un(a);a.d=0;a.pd=!1;a.g=null}function Zn(a,b){a.d=Math.max((a.b?-1:1)*(b-a.ta),a.d)}
...
function wo(a,b){var c=a.d[b],d=a.f[b];d||(d=a.f[b]=[]);for(var e=!1,f=0;f<a.e.length;){var g=a.e[f];g.Fb===b?(g.ec=!0,a.e.splice(f,1),c&&(e=c.indexOf(g),0<=e&&c.splice(e,1)),d.push(g),e=!0):f++}e||xo(a,b,!0)}function xo(a,b,c){a.j.some(function(a){return a.Fb===b})||a.j.push(new so(b,c))}
...
var Ko={now:Date.now},Lo,Mo=Lo=new Jo(window&&window.performance||Ko);Ho.call(Mo,"load_vivliostyle","start",void 0);ba("vivliostyle.profile.profiler",Mo);Jo.prototype.printTimings=Jo.prototype.h;Jo.prototype.disable=Jo.prototype.j;Jo.prototype.enable=Jo.prototype.k;function No(a,b,c){function d(c){return pn(a,b).getPropertyValue(c)}function e(){v(b,"display","block");v(b,"position","static");return d(W)}function f(){v(b,"display","inline-block");v(q,W,"99999999px");var a=d(W);v(q,W,"");return a}function g(){v(b,"display","inline-block");v(q,W,"0");var a=d(W);v(q,W,"");return a}function h(){var a=e(),b=g(),c=parseFloat(a);if(c<=parseFloat(b))return b;b=f();return c<=parseFloat(b)?a:b}function l(){throw Error("Getting fill-available block size is not implemented");
}var k=b.style.display,m=b.style.position,p=b.style.width,r=b.style.height,w=b.parentNode,q=b.ownerDocument.createElement("div");v(q,"position",m);w.insertBefore(q,b);q.appendChild(b);v(b,"width","auto");v(b,"height","auto");var x=Ga("writing-mode"),x=(x?d(x):null)||d("writing-mode"),S="vertical-rl"===x||"tb-rl"===x||"vertical-lr"===x||"tb-lr"===x,W=S?"height":"width",ga=S?"width":"height",Ja={};c.forEach(function(a){var c;switch(a){case "fill-available inline size":c=e();break;case "max-content inline size":c=
...
S?g():d(ga);break;case "fit-content width":c=S?d(ga):h();break;case "fit-content height":c=S?h():d(ga)}Ja[a]=parseFloat(c);v(b,"position",m);v(b,"display",k)});v(b,"width",p);v(b,"height",r);w.insertBefore(b,q);w.removeChild(q);return Ja};function Oo(a){var b=a["writing-mode"],b=b&&b.value;a=(a=a.direction)&&a.value;return b===fe||b!==ge&&a!==$d?"ltr":"rtl"}
...
"pt")));return b}function Vo(a,b){var c={},d=a.Ab.C*oc(b,a.Ab.aa,!1),e=a.lb.C*oc(b,a.lb.aa,!1),f=d+e,g=a.width;c.qb=g===ke?(b.T.Ya?Math.floor(b.za/2)-b.T.Mb:b.za)-2*f:g.C*oc(b,g.aa,!1);g=a.height;c.pb=g===le?b.hb-2*f:g.C*oc(b,g.aa,!1);c.Ab=d;c.lb=e;c.Rc=f;return c}function Wo(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
...
k.appendChild(l);a=Xo(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));k.appendChild(a);b.split(" ").forEach(function(a){k.style[a]=f+"px"});return k}var $o={Be:"top",se:"bottom",Ud:"left",Vd:"right"};
...
jp.prototype.Xc=function(){var a=this.style;a.top=me;a["margin-top"]=me;a["border-top-width"]=me;a["padding-top"]=me;a["padding-bottom"]=me;a["border-bottom-width"]=me;a["margin-bottom"]=me;a.bottom=me};jp.prototype.S=function(a,b,c){b=b.u;var d={start:this.j.marginLeft,end:this.j.marginRight,da:this.j.Jb},e={start:this.j.marginTop,end:this.j.marginBottom,da:this.j.Ib};mp(this,b.top,!0,d,a,c);mp(this,b.bottom,!0,d,a,c);mp(this,b.left,!1,e,a,c);mp(this,b.right,!1,e,a,c)};
...
function mp(a,b,c,d,e,f){var g=a.d.d,h={},l={},k={},m;for(m in b){var p=dp[m];if(p){var r=b[m],w=a.ma[m],q=new np(r,w.style,c,g,f);h[p.la]=r;l[p.la]=w;k[p.la]=q}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.da.evaluate(e);var x=rp(k,b),S=!1,W={};Object.keys(h).forEach(function(a){var b=X(g,l[a].style[c?"max-width":"max-height"],d.da);b&&(b=b.evaluate(e),x[a]>b&&(b=k[a]=new qp(h[a],l[a].style,c,g,f,b),W[a]=b.d(),S=!0))});S&&(x=rp(k,b),S=!1,["start","center","end"].forEach(function(a){x[a]=W[a]||x[a]}));
var ga={};Object.keys(h).forEach(function(a){var b=X(g,l[a].style[c?"min-width":"min-height"],d.da);b&&(b=b.evaluate(e),x[a]<b&&(b=k[a]=new qp(h[a],l[a].style,c,g,f,b),ga[a]=b.d(),S=!0))});S&&(x=rp(k,b),["start","center","end"].forEach(function(a){x[a]=ga[a]||x[a]}));var Ja=a+b,la=a+(a+b);["start","center","end"].forEach(function(a){var b=x[a];if(b){var d=h[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(la-b)/2;break;case "end":e=Ja-b}c?Hi(d,e,b-Di(d)-Ei(d)):Gi(d,e,b-Bi(d)-
...
d["padding-bottom"]=new K(c.marginBottom)};kp.prototype.Wc=function(){var a=tp(this,{start:"left",end:"right",da:"width"});this.Jb=a.Hd;this.marginLeft=a.Qd;this.marginRight=a.Pd};kp.prototype.Xc=function(){var a=tp(this,{start:"top",end:"bottom",da:"height"});this.Ib=a.Hd;this.marginTop=a.Qd;this.marginBottom=a.Pd};
function tp(a,b){var c=a.style,d=a.d.d,e=b.start,f=b.end,g=b.da,h=a.d.l[g].ja(d,null),l=X(d,c[g],h),k=X(d,c["margin-"+e],h),m=X(d,c["margin-"+f],h),p=Yl(d,c["padding-"+e],h),r=Yl(d,c["padding-"+f],h),w=$l(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),q=$l(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),x=F(d,h,D(d,D(d,w,p),D(d,q,r)));l?(x=F(d,x,l),k||m?k?m=F(d,x,k):k=F(d,x,m):m=k=Yc(d,x,new B(d,.5))):(k||(k=d.b),m||(m=d.b),l=F(d,x,D(d,k,m)));c[e]=new K(k);c[f]=new K(m);c["margin-"+e]=
me;c["margin-"+f]=me;c["padding-"+e]=new K(p);c["padding-"+f]=new K(r);c["border-"+e+"-width"]=new K(w);c["border-"+f+"-width"]=new K(q);c[g]=new K(l);c["max-"+g]=new K(l);return{Hd:F(d,h,D(d,k,m)),Qd:k,Pd:m}}kp.prototype.sb=function(a,b,c,d,e){Xl.prototype.sb.call(this,a,b,c,d,e);c.w=b.element};function lp(a,b){Xl.call(this,a,b);var c=b.j;this.j=dp[c];a.ma[c]=this;this.ra=!0}t(lp,Xl);n=lp.prototype;
n.sb=function(a,b,c,d,e){var f=b.element;v(f,"display","flex");var g=jm(this,a,"vertical-align"),h=null;g===H("middle")?h="center":g===H("top")?h="flex-start":g===H("bottom")&&(h="flex-end");h&&(v(f,"flex-flow",this.b?"row":"column"),v(f,"justify-content",h));Xl.prototype.sb.call(this,a,b,c,d,e)};
n.la=function(a,b){var c=this.style,d=this.d.d,e=a.start,f=a.end,g="left"===e,h=g?b.Jb:b.Ib,l=X(d,c[a.da],h),g=g?b.marginLeft:b.marginTop;if("start"===this.j.la)c[e]=new K(g);else if(l){var k=Yl(d,c["margin-"+e],h),m=Yl(d,c["margin-"+f],h),p=Yl(d,c["padding-"+e],h),r=Yl(d,c["padding-"+f],h),w=$l(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),f=$l(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),l=D(d,l,D(d,D(d,p,r),D(d,D(d,w,f),D(d,k,m))));switch(this.j.la){case "center":c[e]=new K(D(d,
g,Zc(d,F(d,h,l),new B(d,2))));break;case "end":c[e]=new K(F(d,D(d,g,h),l))}}};
function up(a,b,c){function d(a){if(x)return x;x={da:q?q.evaluate(a):null,La:l?l.evaluate(a):null,Ma:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[r,m,p,w].forEach(function(b){b&&(c+=b.evaluate(a))});(null===x.La||null===x.Ma)&&c+x.da+x.La+x.Ma>b&&(null===x.La&&(x.La=0),null===x.Ma&&(x.Ie=0));null!==x.da&&null!==x.La&&null!==x.Ma&&(x.Ma=null);null===x.da&&null!==x.La&&null!==x.Ma?x.da=b-c-x.La-x.Ma:null!==x.da&&null===x.La&&null!==x.Ma?x.La=b-c-x.da-x.Ma:null!==x.da&&null!==x.La&&null===x.Ma?x.Ma=
b-c-x.da-x.La:null===x.da?(x.La=x.Ma=0,x.da=b-c):x.La=x.Ma=(b-c-x.da)/2;return x}var e=a.style;a=a.d.d;var f=b.Yc,g=b.bd;b=b.da;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],l=Zl(a,e["margin-"+f],h),k=Zl(a,e["margin-"+g],h),m=Yl(a,e["padding-"+f],h),p=Yl(a,e["padding-"+g],h),r=$l(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),w=$l(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),q=X(a,e[b],h),x=null;e[b]=new K(new gc(a,function(){var a=d(this).da;return null===a?0:a},b));e["margin-"+
f]=new K(new gc(a,function(){var a=d(this).La;return null===a?0:a},"margin-"+f));e["margin-"+g]=new K(new gc(a,function(){var a=d(this).Ma;return null===a?0:a},"margin-"+g));"left"===f?e.left=new K(D(a,c.marginLeft,c.Jb)):"top"===f&&(e.top=new K(D(a,c.marginTop,c.Ib)))}n.Wc=function(){var a=this.e.j;this.j.wa?up(this,{Yc:"right",bd:"left",da:"width"},a):this.j.xa?up(this,{Yc:"left",bd:"right",da:"width"},a):this.la({start:"left",end:"right",da:"width"},a)};
n.Xc=function(){var a=this.e.j;this.j.ya?up(this,{Yc:"bottom",bd:"top",da:"height"},a):this.j.va?up(this,{Yc:"top",bd:"bottom",da:"height"},a):this.la({start:"top",end:"bottom",da:"height"},a)};n.tc=function(a,b,c,d,e,f,g){Xl.prototype.tc.call(this,a,b,c,d,e,f,g);a=c.u;c=this.d.j;d=this.j;d.wa||d.xa?d.ya||d.va||(d.wa?a.left[c]=b:d.xa&&(a.right[c]=b)):d.ya?a.top[c]=b:d.va&&(a.bottom[c]=b)};
...
function Gp(a,b,c,d,e){Qk.call(this,a,b,null,c,null,d,!1);this.I=e;this.B=[];this.e="";this.u=[]}t(Gp,Qk);n=Gp.prototype;n.Ob=function(){this.fb()};n.ib=function(a,b){if(this.e=b)this.b.push(new zp(b)),this.P+=65536};
...
Ip.prototype.eb=function(a,b,c){nj(this.b,a,new U(b,c?Af(this):Bf(this)))};var Jp=new wf(function(){var a=L("uaStylesheetBase");uf(fh).then(function(b){var c=va("user-agent-base.css",ua);b=new Qk(null,null,null,null,null,b,!0);b.Pb("UA");Pk=b.g;fg(c,b,null,null).ua(a)});return N(a)},"uaStylesheetBaseFetcher");
...
function Op(a,b,c,d,e,f,g,h,l,k,m){mc.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.Z=b;this.lang=b.lang||c;this.viewport=d;this.g={body:!0};this.e=e;this.k=this.b=this.B=this.d=this.u=null;this.l=0;this.ab=f;this.h=new mh(this.style.l);this.ka={};this.O=null;this.f=m;this.I={};this.ca=null;this.Ta=g;this.$a=h;this.ma=l;this.Za=k;for(var p in a.f)(b=a.f[p]["flow-consume"])&&(b.evaluate(this,"flow-consume")==sd?this.g[p]=!0:delete this.g[p]);this.ra={}}t(Op,mc);
function Pp(a){var b=L("StyleInstance.init"),c=new Qm(a.f,a.Z.url),d=new Rm(a.f,a.Z.url,a.style.d,a.style.b);a.d=new ul(a.Z,a.style.e,a.style.d,a,a.g,a.style.j,c,d);d.f=a.d;Il(a.d,a);a.B={};a.B[a.Z.url]=a.d;var e=Fl(a.d);a.ca=Oo(e);a.u=new ym(a.style.B);c=new Ck(a.style.e,a,c,d);a.u.h(c,e);xm(a.u,a);a.O=new vp(c,a.style.b,a.u,a,e);e=[];for(c=0;c<a.style.g.length;c++)if(d=a.style.g[c],!d.M||d.M.evaluate(a))d=jh(d.Cb,a),d=new kh(d),e.push(d);sh(a.ab,e,a.h).ua(b);var f=a.style.w;Object.keys(f).forEach(function(a){var b=
Vo(Uo(f[a]),this);this.ra[a]={width:b.qb+2*b.Rc,height:b.pb+2*b.Rc}},a);return N(b)}function Jl(a,b,c){if(a=a.b)a.e[b.b]||(a.e[b.b]=c),c=a.b[b.b],c||(c=new wi,a.b[b.b]=c),c.b.push(new vi(new ti({ha:[{ga:b.element,Ha:0,fa:null,sa:null,pa:null}],ea:0,J:!1}),b))}function Qp(a,b){for(var c=Number.POSITIVE_INFINITY,d=0;d<b.b.length;d++){for(var e=b.b[d].d.Na,f=e.ha[0].ga,g=e.ea,h=e.J,l=0;f.ownerDocument!=a.Z.b;)l++,f=e.ha[l].ga,h=!1,g=0;e=xh(a.Z,f,g,h);e<c&&(c=e)}return c}
...
function Tp(a,b,c){var d=a.b.b[c];if(!d||!Lp(a,d.d))return M(!0);d.d="any";Tn(b);a.g[c]&&0<b.hb.length&&(b.Gd=!1);var e=L("layoutColumn"),f=[],g=[],h=!0;nf(function(c){for(;0<d.b.length-g.length;){for(var e=0;0<=g.indexOf(e);)e++;var m=d.b[e];if(m.b.d>a.l||Mp(a,m.b))break;for(var p=e+1;p<d.b.length;p++)if(!(0<=g.indexOf(p))){var r=d.b[p];if(r.b.d>a.l||Mp(a,r.b))break;ei(r.b,m.b)&&(m=r,e=p)}var w=m.b,q=!0;Wn(b,m.d,h).then(function(a){h=!1;m.b.je&&(null===a||w.f)&&f.push(e);w.f?(g.push(e),P(c)):(a?
...
function Up(a,b,c,d,e,f,g,h){cm(c);var l=jm(c,a,"enabled");if(l&&l!==ie)return M(!0);var k=L("layoutContainer"),m=jm(c,a,"wrap-flow")===ud,p=c.b?c.g&&c.H:c.f&&c.I,l=jm(c,a,"flow-from"),r=a.viewport.b.createElement("div"),w=jm(c,a,"position");v(r,"position",w?w.name:"absolute");d.insertBefore(r,d.firstChild);var q=new Ai(r);q.b=c.b;c.sb(a,q,b,a.h,a.e);q.B=e;q.D=f;e+=q.left+q.marginLeft+q.O;f+=q.top+q.marginTop+q.S;var x=!1;if(l&&l.Nd())if(a.I[l.toString()])c.tc(a,q,b,null,1,a.e,a.h),l=M(!0);else{var S=
L("layoutContainer.inner"),W=l.toString(),ga=Y(c,a,"column-count"),Ja=Y(c,a,"column-gap"),la=1<ga?Y(c,a,"column-width"):q.width,l=im(c,a),E=0,w=jm(c,a,"shape-inside"),J=og(w,0,0,q.width,q.height,a),Al=new Om(W,a,a.viewport,a.d,l,a.Z,a.h,a.style.u,a,b,a.Ta,a.$a,h,a.Za),Cl=new qo(a.f,a.b.page-1),di=0,ca=null;nf(function(b){for(;di<ga;){var c=di++;if(1<ga){var d=a.viewport.b.createElement("div");v(d,"position","absolute");r.appendChild(d);ca=new An(d,Al,a.e,Cl);ca.b=q.b;ca.ab=q.ab;ca.Gb=q.Gb;q.b?(v(d,
"margin-left",q.h+"px"),v(d,"margin-right",q.u+"px"),c=c*(la+Ja)+q.j,Hi(ca,0,q.width),Gi(ca,c,la)):(v(d,"margin-top",q.j+"px"),v(d,"margin-bottom",q.l+"px"),c=c*(la+Ja)+q.h,Gi(ca,0,q.height),Hi(ca,c,la));ca.B=e+q.h;ca.D=f+q.j}else ca=new An(r,Al,a.e,Cl),Fi(ca,q),q=ca;ca.H=p?[]:g;ca.yb=J;if(0<=ca.width){var k=L("inner");Tp(a,ca,W).then(function(){ca.g&&"column"!=ca.g&&(di=ga,"region"!=ca.g&&(a.I[W]=!0));O(k,!0)});c=N(k)}else c=M(!0);if(c.Ca()){c.then(function(){0<h.b.length?P(b):(E=Math.max(E,ca.d),
pf(b))});return}0<h.b.length||(E=Math.max(E,ca.d))}P(b)}).then(function(){q.d=E;c.tc(a,q,b,ca,ga,a.e,a.h);O(S,!0)});l=N(S)}else(l=jm(c,a,"content"))&&Ji(l)?(w=a.viewport.b.createElement("span"),l.U(new Ii(w,a)),r.appendChild(w),wm(c,a,q,a.h)):c.ra&&(d.removeChild(r),x=!0),x||c.tc(a,q,b,null,1,a.e,a.h),l=M(!0);l.then(function(){if(!c.f||0<Math.floor(q.d)){if(!x&&!m){var l=q.B+q.left,p=q.D+q.top,w=Di(q)+q.width+Ei(q),E=Bi(q)+q.height+Ci(q),W=jm(c,a,"shape-outside"),l=og(W,l,p,w,E,a);g.push(l)}}else if(0==
...
n.fc=function(a){var b=this.e.l;if(a){var c=oj(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Df(this.e,new Xk(this.d,this.$,null,b,this.e.f))};n.Ec=function(){this.u=!0;this.fb()};n.Ob=function(){var a=new Gp(this.e.j,this.e,this,this.k,this.e.u);Df(this.e,a);a.Ob()};n.qa=function(){Qk.prototype.qa.call(this);if(this.u){this.u=!1;var a="R"+this.e.H++,b=H(a),c;this.M?c=new jj(b,0,this.M):c=new U(b,0);pj(this.h,"region-id").push(c);this.nb();a=new Xp(this.e,this.M,this,a);Df(this.e,a);a.qa()}};
...
t(Zp,Cf);Zp.prototype.error=function(a){u.b("CSS parser:",a)};function $p(a,b){return aq(b,a)}function bq(a){tf.call(this,$p,"document");this.H=a;this.B={};this.h={};this.b={};this.D={};this.f=null;this.j=[]}t(bq,tf);function cq(a){var b=va("user-agent.xml",ua),c=L("OPSDocStore.init");uf(fh).then(function(d){a.f=d;uf(Jp).then(function(){a.load(b).then(function(){O(c,!0)})})});return N(c)}function dq(a,b){a.j.push({url:b.url,text:b.text,bb:"User",Ba:null,media:null})}
...
for(var w="",h=0;h<r.length;h++)w+=r[h].url,w+="^",r[h].text&&(w+=r[h].text),w+="^";var q=a.B[w];q?(a.b[d]=q,O(c,b)):(f=a.h[w],f||(f=new wf(function(){var b=L("fetchStylesheet"),c=0,d=new Zp(a.f);mf(function(){if(c<r.length){var a=r[c++];d.Pb(a.bb);return null!==a.text?gg(a.text,d,a.url,a.Ba,a.media).kd(!0):fg(a.url,d,a.Ba,a.media)}return M(!1)}).then(function(){q=new Kp(a,d.g,d.j,d.D.g,d.w,d.k,d.l,d.h,d.B,d.u);a.B[w]=q;delete a.h[w];O(b,q)});return N(b)},"FetchStylesheet "+d),a.h[w]=f,f.start()),
uf(f).then(function(f){a.b[d]=f;O(c,b)}))}else O(c,null)});return N(c)};function eq(a,b,c,d,e,f,g,h,l,k){this.b=a;this.url=b;this.lang=c;this.d=d;this.h=e;this.T=Xb(f);this.j=g;this.g=h;this.f=l;this.e=k;this.Ja=this.page=null}function fq(a,b,c){if(0!=c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=Ha(d,"height","auto")&&(v(d,"height","auto"),fq(a,d,c));"absolute"==Ha(d,"position","static")&&(v(d,"position","relative"),fq(a,d,c))}}
...
eq.prototype.$c=function(a){var b=this.j.$c(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",v(e,"cursor","pointer"),e.addEventListener("click",gq,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
hq.prototype.load=function(a){var b=ta(a);if(a=this.l[b])return a.Ca()?a:M(a.Ub());var c=L("EPUBDocStore.load");a=hq.Td.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?O(c,a):u.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return N(c)};function oq(){this.id=null;this.src="";this.f=this.d=null;this.F=-1;this.h=0;this.j=null;this.b=this.e=0;this.Db=this.Qa=null;this.g=Ua}
...
d.wc),Jq(a,b,b.Ka[a.G]).then(function(){var b=a.d;b.b=b.u.pop();b=a.d;b.e=b.B.pop();pf(c)})):pf(c)}))}}).then(function(){a.F=h;a.G=l;a.na=k;O(d,{page:e,position:c,G:g})})})});return N(d)}
...
function Nq(a,b,c){var d=L("renderAllPages"),e=a.F,f=a.G;a.F=0;nf(function(d){a.G=a.F==b?c:Number.POSITIVE_INFINITY;Mq(a).then(function(){++a.F>b?P(d):pf(d)})}).then(function(){a.F=e;a.G=f;Mq(a).ua(d)});return N(d)}n.$d=function(){this.G=this.F=0;return Mq(this)};n.ae=function(){this.F=this.b.b.length-1;this.G=Number.POSITIVE_INFINITY;return Mq(this)};
...
function Kq(a,b,c){var d=b.Ja.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.style.position="absolute";e.style.top="0";e.style.left="0";ka||(e.style.visibility="hidden");d.root.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);var g=new Vh(e,f);g.F=b.item.F;g.position=c;g.offset=Rp(b.Ja,c);0===g.offset&&(b=a.b.j.ld("",b.item.src),f.setAttribute("id",b),Yh(g,f,b));d!==a.viewport&&(a=$b(a.viewport.width,
...
function cr(a,b){b.addEventListener("hyperlink",a.u,!1);b.addEventListener("replaced",a.dd,!1);v(b.N,"visibility","visible");v(b.N,"display","block")}function dr(a,b){br(a);a.e=b;cr(a,b)}function er(a){var b=L("reportPosition");a.f||(a.f=Uq(a.b));Cq(a.g,a.f.F,a.f.na).then(function(c){var d=a.e;(a.S&&0<d.g.length?sg(d.g):M(!0)).then(function(){fr(a,d,c).ua(b)})});return N(b)}
...
function lr(a,b){var c=b.a||"";return We("runCommand",function(d){var e=a.ca[c];e?e.call(a,b).then(function(){Yq(a,{t:"done",a:c});O(d,!0)}):(u.error("No such action:",c),O(d,!0))},function(a,b){u.error(b,"Error during action:",c);O(a,!0)})}function mr(a){return"string"==typeof a?JSON.parse(a):a}
function nr(a,b){var c=mr(b),d=null;Ye(function(){var b=L("commandLoop"),f=Re.d;a.u=function(b){var c="#"===b.href.charAt(0)||a.H.some(function(a){return b.href.substr(0,a.length)==a});if(c){b.preventDefault();var d={t:"hyperlink",href:b.href,internal:c};Ze(f,function(){Yq(a,d);return M(!0)})}};nf(function(b){if(a.d)Zq(a).then(function(){pf(b)});else if(a.D)a.e&&ar(a,a.e).then(function(){pf(b)});else if(c){var e=c;c=null;lr(a,e).then(function(){pf(b)})}else e=L("waitForCommand"),d=ff(e,self),N(e).then(function(){pf(b)})}).ua(b);
...
function qr(a,b){ka=a.debug;this.f=a;this.b=new Wq(a.window||window,a.viewportElement,"main",this.Zd.bind(this));this.e={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,spreadView:!1,zoom:1};b&&this.Sd(b);this.d=new Ya}n=qr.prototype;n.Sd=function(a){var b=Object.Xb({a:"configure"},pr(a));this.b.k(b);Object.Xb(this.e,a)};n.Zd=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});Za(this.d,b)};n.me=function(a,b){this.d.addEventListener(a,b,!1)};
n.pe=function(a,b){this.d.removeEventListener(a,b,!1)};n.be=function(a,b,c){a||Za(this.d,{type:"error",content:"No URL specified"});rr(this,a,null,b,c)};n.ne=function(a,b,c){a||Za(this.d,{type:"error",content:"No URL specified"});rr(this,null,a,b,c)};
...
ba("vivliostyle.viewer.Viewer",qr);qr.prototype.setOptions=qr.prototype.Sd;qr.prototype.addListener=qr.prototype.me;qr.prototype.removeListener=qr.prototype.pe;qr.prototype.loadDocument=qr.prototype.be;qr.prototype.loadEPUB=qr.prototype.ne;qr.prototype.getCurrentPageProgression=qr.prototype.ob;qr.prototype.navigateToPage=qr.prototype.de;qr.prototype.navigateToInternalUrl=qr.prototype.ce;qr.prototype.queryZoomFactor=qr.prototype.oe;ba("vivliostyle.viewer.ZoomType",kr);kr.FIT_INSIDE_VIEWPORT="fit inside viewport";
