...
var Navigation = (function () {
    function Navigation(viewerOptions, viewer, settingsPanel, navigationOptions) {
        ...
        this.isNavigateToPreviousDisabled = _knockout2["default"].pureComputed(function () {
            ...
            var spreadContainerElement = _this.viewer_.getSpreadContainerElement();
        ...
        this.pageNumber = _knockout2["default"].pureComputed({
            ...
            write: function write(pageNumber) {
                var nthPage = parseInt(pageNumber.replace(/[０-９]/g, function (s) {
                    return String.fromCharCode(s.charCodeAt(0) - 0xFEE0);
                })) || 0;
                var totalPages = this.viewer_.getTotalPages();
                if (nthPage < 1) {
                    nthPage = 1;
        ...
        this.totalPages = _knockout2["default"].pureComputed(function () {
            _this.viewer_.state.status();
            return _this.viewer_.getTotalPages();
        });
    ...
    _createClass(Viewer, [{
        ...
        value: function setupViewerEventHandler() {
            ...
            this.viewer_.addListener("readystatechange", function () {
                ...
                if (intervalID === 0 && readyState === _modelsVivliostyle2["default"].constants.ReadyState.INTERACTIVE) {
                    intervalID = setInterval(function () {
                        _this.state_.status.value(_modelsVivliostyle2["default"].constants.ReadyState.LOADING);
                        _this.state_.status.value(_modelsVivliostyle2["default"].constants.ReadyState.INTERACTIVE);
                    }, 200);
                } else {
        ...
        value: function afterNavigateToPage() {
            ...
            setTimeout(function () {
                ...
                pageNumberElem.value = _this2.getPageNumber();
            }, 1);
        }
    }, {
        key: "getSpreadContainerElement",
        value: function getSpreadContainerElement() {
            var viewportElement = document.getElementById("vivliostyle-viewer-viewport");
        ...
        value: function getTotalPages() {
            var spreadContainerElement = this.getSpreadContainerElement();
        ...
        value: function getPageNumber() {
            ...
            var children = spreadContainerElement.children;
            var pageNumber = 0;
        ...
        key: "navigateToNthPage",
        value: function navigateToNthPage(nthPage) {
            this.viewer_.navigateToNthPage(nthPage);
            this.afterNavigateToPage();
        }
    }, {
 ...
 *
 * Vivliostyle core 2018.12.101-pre.20190102162335
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
if(!c)throw Error("E_CFI_NUMBER_EXPECTED");e+=c[0].length;g=parseInt(c[1],10);(h=c[4])&&(h=mb(h));var l=c[7];l&&(l=mb(l));c=nb(c[10]);f.push(new rb(g,h,l,Ga(c.s)));break;case "!":e++;f.push(new ob);break;case "~":case "@":case "":a.oa=f;return;default:throw Error("E_CFI_PARSE_ERROR");}}function ub(a,b){for(var c={node:b.documentElement,offset:0,J:!1,Db:null,kd:null},d=0;d<a.oa.length;d++)if(!a.oa[d].h(c)){c.kd=new sb;c.kd.oa=a.oa.slice(d+1);break}return c}
...
d=!1}f.reverse();a.oa?(f.push(new ob),a.oa=f.concat(a.oa)):a.oa=f}sb.prototype.toString=function(){if(!this.oa)return"";var a=new Pa;a.append("epubcfi(");for(var b=0;b<this.oa.length;b++)this.oa[b].g(a);a.append(")");return a.toString()};function wb(){return{fontFamily:"serif",lineHeight:1.25,margin:8,re:!1,je:25,qe:!1,Ce:!1,tb:!1,wc:1,We:{print:!0},nc:void 0}}function xb(a){return{fontFamily:a.fontFamily,lineHeight:a.lineHeight,margin:a.margin,re:a.re,je:a.je,qe:a.qe,Ce:a.Ce,tb:a.tb,wc:a.wc,We:Object.assign({},a.We),nc:a.nc?Object.assign({},a.nc):void 0}}var yb=wb(),zb={};function Ab(a,b,c,d){a=Math.min((a-0)/c,(b-0)/d);return"matrix("+a+",0,0,"+a+",0,0)"}function Bb(a){return'"'+Sa(""+a)+'"'}function Cb(a){return Ra(""+a)}
...
e}else if(null!=f&&!c)return!!f;return!1}function Tb(a){this.b=a;this.g="_"+Eb++}n=Tb.prototype;n.toString=function(){var a=new Pa;this.Ea(a,0);return a.toString()};n.Ea=function(){throw Error("F_ABSTRACT");};n.sb=function(){throw Error("F_ABSTRACT");};n.jb=function(){return this};n.oc=function(a){return a===this};function Ub(a,b,c,d){var e=d[a.g];if(null!=e)return e===zb?!1:e;d[a.g]=zb;b=a.oc(b,c,d);return d[a.g]=b}
n.evaluate=function(a){var b;b=(b=a.H[this.b.u])?b[this.g]:void 0;if("undefined"!=typeof b)return b;b=this.sb(a);var c=this.g,d=this.b,e=a.H[d.u];e||(e={},a.H[d.u]=e);return e[c]=b};n.bf=function(){return!1};function Vb(a,b){Tb.call(this,a);this.f=b}v(Vb,Tb);n=Vb.prototype;n.Qe=function(){throw Error("F_ABSTRACT");};n.Xe=function(){throw Error("F_ABSTRACT");};n.sb=function(a){a=this.f.evaluate(a);return this.Xe(a)};n.oc=function(a,b,c){return a===this||Ub(this.f,a,b,c)};
n.Ea=function(a,b){10<b&&a.append("(");a.append(this.Qe());this.f.Ea(a,10);10<b&&a.append(")")};n.jb=function(a,b){var c=this.f.jb(a,b);return c===this.f?this:new this.constructor(this.b,c)};function Wb(a,b,c){Tb.call(this,a);this.f=b;this.h=c}v(Wb,Tb);n=Wb.prototype;n.vd=function(){throw Error("F_ABSTRACT");};n.cb=function(){throw Error("F_ABSTRACT");};n.Cb=function(){throw Error("F_ABSTRACT");};n.sb=function(a){var b=this.f.evaluate(a);a=this.h.evaluate(a);return this.Cb(b,a)};
n.oc=function(a,b,c){return a===this||Ub(this.f,a,b,c)||Ub(this.h,a,b,c)};n.Ea=function(a,b){var c=this.vd();c<=b&&a.append("(");this.f.Ea(a,c);a.append(this.cb());this.h.Ea(a,c);c<=b&&a.append(")")};n.jb=function(a,b){var c=this.f.jb(a,b),d=this.h.jb(a,b);return c===this.f&&d===this.h?this:new this.constructor(this.b,c,d)};function Xb(a,b,c){Wb.call(this,a,b,c)}v(Xb,Wb);Xb.prototype.vd=function(){return 1};function Yb(a,b,c){Wb.call(this,a,b,c)}v(Yb,Wb);Yb.prototype.vd=function(){return 2};
...
oc.prototype.Cb=function(a,b){return a*b};function pc(a,b,c){Wb.call(this,a,b,c)}v(pc,$b);pc.prototype.cb=function(){return"/"};pc.prototype.Cb=function(a,b){return a/b};function qc(a,b,c){Wb.call(this,a,b,c)}v(qc,$b);qc.prototype.cb=function(){return"%"};qc.prototype.Cb=function(a,b){return a%b};function rc(a,b,c){Tb.call(this,a);this.K=b;this.ka=c.toLowerCase()}v(rc,Tb);rc.prototype.Ea=function(a){a.append(this.K.toString());a.append(Ra(this.ka))};
rc.prototype.sb=function(a){return this.K*Pb(a,this.ka,!1)};function sc(a,b){Tb.call(this,a);this.f=b}v(sc,Tb);sc.prototype.Ea=function(a){a.append(this.f)};sc.prototype.sb=function(a){return Qb(a,this.b,this.f).evaluate(a)};sc.prototype.oc=function(a,b,c){return a===this||Ub(Qb(b,this.b,this.f),a,b,c)};function tc(a,b,c){Tb.call(this,a);this.f=b;this.name=c}v(tc,Tb);tc.prototype.Ea=function(a){this.f&&a.append("not ");a.append(Ra(this.name))};
tc.prototype.sb=function(a){var b=this.name;a="all"===b||!!a.Z.We[b];return this.f?!a:a};tc.prototype.oc=function(a,b,c){return a===this||Ub(this.value,a,b,c)};tc.prototype.bf=function(){return!0};function Ib(a,b,c){Tb.call(this,a);this.Jc=b;this.Pc=c}v(Ib,Tb);Ib.prototype.Ea=function(a){a.append(this.Pc)};Ib.prototype.sb=function(a){return this.Jc.call(a)};function uc(a,b,c){Tb.call(this,a);this.h=b;this.f=c}v(uc,Tb);
uc.prototype.Ea=function(a){a.append(this.h);var b=this.f;a.append("(");for(var c=0;c<b.length;c++)c&&a.append(","),b[c].Ea(a,0);a.append(")")};uc.prototype.sb=function(a){return Rb(a,this.b,this.h,this.f,!1).jb(a,this.f).evaluate(a)};uc.prototype.oc=function(a,b,c){if(a===this)return!0;for(var d=0;d<this.f.length;d++)if(Ub(this.f[d],a,b,c))return!0;return Ub(Rb(b,this.b,this.h,this.f,!0),a,b,c)};
...
vc.prototype.sb=function(a){return this.f.evaluate(a)?this.j.evaluate(a):this.h.evaluate(a)};vc.prototype.oc=function(a,b,c){return a===this||Ub(this.f,a,b,c)||Ub(this.j,a,b,c)||Ub(this.h,a,b,c)};vc.prototype.jb=function(a,b){var c=this.f.jb(a,b),d=this.j.jb(a,b),e=this.h.jb(a,b);return c===this.f&&d===this.j&&e===this.h?this:new vc(this.b,c,d,e)};function Gb(a,b){Tb.call(this,a);this.f=b}v(Gb,Tb);
...
wc.prototype.sb=function(a){return Sb(a,this.name.name,this.value)};wc.prototype.oc=function(a,b,c){return a===this||Ub(this.value,a,b,c)};wc.prototype.jb=function(a,b){var c=this.value.jb(a,b);return c===this.value?this:new wc(this.b,this.name,c)};function xc(a,b){Tb.call(this,a);this.index=b}v(xc,Tb);xc.prototype.Ea=function(a){a.append("$");a.append(this.index.toString())};xc.prototype.jb=function(a,b){var c=b[this.index];if(!c)throw Error("Parameter missing: "+this.index);return c};
function yc(a,b,c){return b===a.h||b===a.b||c==a.h||c==a.b?a.h:b===a.j||b===a.f?c:c===a.j||c===a.f?b:new cc(a,b,c)}function y(a,b,c){return b===a.b?c:c===a.b?b:new mc(a,b,c)}function B(a,b,c){return b===a.b?new bc(a,c):c===a.b?b:new nc(a,b,c)}function zc(a,b,c){return b===a.b||c===a.b?a.b:b===a.f?c:c===a.f?b:new oc(a,b,c)}function Ac(a,b,c){return b===a.b?a.b:c===a.f?b:new pc(a,b,c)};var Bc={};function Cc(){}n=Cc.prototype;n.kc=function(a){for(var b=0;b<a.length;b++)a[b].ca(this)};n.Ne=function(){throw Error("E_CSS_EMPTY_NOT_ALLOWED");};n.Oe=function(){throw Error("E_CSS_SLASH_NOT_ALLOWED");};n.rd=function(){throw Error("E_CSS_STR_NOT_ALLOWED");};n.jc=function(){throw Error("E_CSS_IDENT_NOT_ALLOWED");};n.Tc=function(){throw Error("E_CSS_NUMERIC_NOT_ALLOWED");};n.Sc=function(){throw Error("E_CSS_NUM_NOT_ALLOWED");};n.Rc=function(a){return this.Sc(a)};
n.be=function(){throw Error("E_CSS_COLOR_NOT_ALLOWED");};n.Uc=function(){throw Error("E_CSS_URL_NOT_ALLOWED");};n.Lb=function(){throw Error("E_CSS_LIST_NOT_ALLOWED");};n.ic=function(){throw Error("E_CSS_COMMA_NOT_ALLOWED");};n.Pb=function(){throw Error("E_CSS_FUNC_NOT_ALLOWED");};n.Qc=function(){throw Error("E_CSS_EXPR_NOT_ALLOWED");};function Dc(){}v(Dc,Cc);n=Dc.prototype;
n.kc=function(a){for(var b=null,c=0;c<a.length;c++){var d=a[c],e=d.ca(this);if(b)b[c]=e;else if(d!==e){b=Array(a.length);for(d=0;d<c;d++)b[d]=a[d];b[c]=e}}return b||a};n.rd=function(a){return a};n.jc=function(a){return a};n.Oe=function(a){return a};n.Tc=function(a){return a};n.Sc=function(a){return a};n.Rc=function(a){return a};n.be=function(a){return a};n.Uc=function(a){return a};n.Lb=function(a){var b=this.kc(a.values);return b===a.values?a:new Ec(b)};
n.ic=function(a){var b=this.kc(a.values);return b===a.values?a:new Fc(b)};n.Pb=function(a){var b=this.kc(a.values);return b===a.values?a:new Gc(a.name,b)};n.Qc=function(a){return a};function Hc(){}n=Hc.prototype;n.toString=function(){var a=new Pa;this.Ya(a,!0);return a.toString()};n.stringValue=function(){var a=new Pa;this.Ya(a,!1);return a.toString()};n.za=function(){throw Error("F_ABSTRACT");};n.Ya=function(a){a.append("[error]")};n.$e=function(){return!1};n.tc=function(){return!1};n.cf=function(){return!1};
n.Qf=function(){return!1};n.Md=function(){return!1};function Ic(){if(C)throw Error("E_INVALID_CALL");}v(Ic,Hc);Ic.prototype.za=function(a){return new Gb(a,"")};Ic.prototype.Ya=function(){};Ic.prototype.ca=function(a){return a.Ne(this)};var C=new Ic;function Jc(){if(Kc)throw Error("E_INVALID_CALL");}v(Jc,Hc);Jc.prototype.za=function(a){return new Gb(a,"/")};Jc.prototype.Ya=function(a){a.append("/")};Jc.prototype.ca=function(a){return a.Oe(this)};var Kc=new Jc;function Lc(a){this.Pc=a}v(Lc,Hc);
Lc.prototype.za=function(a){return new Gb(a,this.Pc)};Lc.prototype.Ya=function(a,b){b?(a.append('"'),a.append(Sa(this.Pc)),a.append('"')):a.append(this.Pc)};Lc.prototype.ca=function(a){return a.rd(this)};function Mc(a){this.name=a;if(Bc[a])throw Error("E_INVALID_CALL");Bc[a]=this}v(Mc,Hc);Mc.prototype.za=function(a){return new Gb(a,this.name)};Mc.prototype.Ya=function(a,b){b?a.append(Ra(this.name)):a.append(this.name)};Mc.prototype.ca=function(a){return a.jc(this)};Mc.prototype.Qf=function(){return!0};
function D(a){var b=Bc[a];b||(b=new Mc(a));return b}function F(a,b){this.K=a;this.ka=b.toLowerCase()}v(F,Hc);F.prototype.za=function(a,b){return this.K?b&&"%"==this.ka?100==this.K?b:new oc(a,b,new Gb(a,this.K/100)):new rc(a,this.K,this.ka):a.b};F.prototype.Ya=function(a){a.append(this.K.toString());a.append(this.ka)};F.prototype.ca=function(a){return a.Tc(this)};F.prototype.tc=function(){return!0};function Nc(a){this.K=a}v(Nc,Hc);
...
Fc.prototype.Ya=function(a,b){Rc(a,this.values,",",b)};Fc.prototype.ca=function(a){return a.ic(this)};function Gc(a,b){this.name=a;this.values=b}v(Gc,Hc);Gc.prototype.Ya=function(a,b){a.append(Ra(this.name));a.append("(");Rc(a,this.values,",",b);a.append(")")};Gc.prototype.ca=function(a){return a.Pb(this)};function G(a){this.Gc=a}v(G,Hc);G.prototype.za=function(){return this.Gc};G.prototype.Ya=function(a){a.append("-epubx-expr(");this.Gc.Ea(a,0);a.append(")")};G.prototype.ca=function(a){return a.Qc(this)};
G.prototype.$e=function(){return!0};function Sc(a,b){if(a){if(a.tc())return Pb(b,a.ka,!1)*a.K;if(a.cf())return a.K}return 0}var Tc=D("absolute"),Uc=D("all"),Vc=D("always"),Wc=D("auto");D("avoid");var Xc=D("balance"),Yc=D("balance-all"),Zc=D("block"),$c=D("block-end"),ad=D("block-start"),bd=D("both"),cd=D("bottom"),dd=D("border-box"),ed=D("break-all"),fd=D("break-word"),gd=D("crop"),hd=D("cross");D("column");
...
else{var c=g.response;b&&"text"!==b||"string"!=typeof c?c?"string"==typeof c?l.Rd=tf([c]):l.Rd=c:w.b("Unexpected empty success response for",a):l.responseText=c;if(c=g.getResponseHeader("Content-Type"))l.contentType=c.replace(/(.*);.*$/,"$1")}else l.responseXML=g.responseXML,l.contentType=g.responseXML.contentType;h.qb(l)}};try{d?(g.setRequestHeader("Content-Type",e||"text/plain; charset=UTF-8"),g.send(d)):(a.match(/file:\/\/.*(\.html$|\.htm$)/)&&g.overrideMimeType("text/html"),g.send(null))}catch(k){w.b(k,
...
function cg(a,b,c,d,e,f){var g=a.u,h=a.f,l=a.F,k,m,p,q;e&&(a.j=2,a.F.push("{"));a:for(;0<b;--b)switch(k=R(h),a.b[k.type]){case 28:if(18!=qf(h,1).type){bg(a)?(g.error("E_CSS_COLON_EXPECTED",qf(h,1)),a.b=Rf):(a.b=Mf,g.Kb());continue}m=qf(h,2);if(!(m.b||1!=m.type&&6!=m.type)){if(0<=h.b)throw Error("F_CSSTOK_BAD_CALL mark");h.b=h.f}a.g=k.text;a.D=!1;S(h);S(h);a.b=Nf;l.splice(0,l.length);continue;case 46:if(18!=qf(h,1).type){a.b=Rf;g.error("E_CSS_COLON_EXPECTED",qf(h,1));continue}a.g=k.text;a.D=!1;S(h);
S(h);a.b=Nf;l.splice(0,l.length);continue;case 29:a.b=Mf;g.Kb();continue;case 1:if(!k.b){a.b=Sf;g.error("E_CSS_SPACE_EXPECTED",k);continue}g.Wb();case 2:if(34==qf(h,1).type)if(S(h),S(h),p=a.N[k.text],null!=p)switch(k=R(h),k.type){case 1:g.Ob(p,k.text);a.b=f?Kf:T;S(h);break;case 36:g.Ob(p,null);a.b=f?Kf:T;S(h);break;default:a.b=Qf,g.error("E_CSS_NAMESPACE",k)}else a.b=Qf,g.error("E_CSS_UNDECLARED_PREFIX",k);else g.Ob(a.H,k.text),a.b=f?Kf:T,S(h);continue;case 3:if(!k.b){a.b=Sf;g.error("E_CSS_SPACE_EXPECTED",
k);continue}g.Wb();case 4:if(34==qf(h,1).type)switch(S(h),S(h),k=R(h),k.type){case 1:g.Ob(null,k.text);a.b=f?Kf:T;S(h);break;case 36:g.Ob(null,null);a.b=f?Kf:T;S(h);break;default:a.b=Qf,g.error("E_CSS_NAMESPACE",k)}else g.Ob(a.H,null),a.b=f?Kf:T,S(h);continue;case 5:k.b&&g.Wb();case 6:g.te(k.text);a.b=f?Kf:T;S(h);continue;case 7:k.b&&g.Wb();case 8:g.ie(k.text);a.b=f?Kf:T;S(h);continue;case 55:k.b&&g.Wb();case 14:S(h);k=R(h);b:switch(k.type){case 1:g.hd(k.text,null);S(h);a.b=f?Kf:T;continue;case 6:m=
...
function Ig(a,b){if(!a.length)return b;for(var c=b.O,d,e=a.length-1;0<=e&&!(d=a[e],e===a.length-1&&d.O<b.O)&&!(d.R<b.O&&d.U-.1<=b.U&&d.T+.1>=b.T);e--)c=Math.min(c,d.R);for(var f=Math.min(c,d.O);0<=e&&!(d=a[e],d.O<=b.R||d.U-.1>b.U||d.T+.1<b.T);e--)f=d.R;f=Math.max(f,b.R);return c<=f?null:new lg(b.U,f,b.T,c)};function Jg(){this.b={}}v(Jg,Cc);Jg.prototype.jc=function(a){this.b[a.name]=!0;return a};Jg.prototype.Lb=function(a){this.kc(a.values);return a};function Kg(a){this.value=a}v(Kg,Cc);Kg.prototype.Rc=function(a){this.value=a.K;return a};function Lg(a,b){if(a){var c=new Kg(b);try{return a.ca(c),c.value}catch(d){w.b(d,"toInt: ")}}return b}function Mg(){this.b=!1;this.f=[];this.name=null}v(Mg,Cc);Mg.prototype.Tc=function(a){this.b&&this.f.push(a);return null};
Mg.prototype.Sc=function(a){this.b&&!a.K&&this.f.push(new F(0,"px"));return null};Mg.prototype.Lb=function(a){this.kc(a.values);return null};Mg.prototype.Pb=function(a){this.b||(this.b=!0,this.kc(a.values),this.b=!1,this.name=a.name.toLowerCase());return null};
...
k.ca(f.bb);if(m){if(m!==k&&b===e)for(e=[],k=0;k<g;k++)e[k]=b[k];b!==e&&(e[g-d]=m);g++;f=f.g}else f=f.f}}return f===a.b&&(c?0<e.length:g==b.length)?e:null}n=ah.prototype;n.zb=function(a){for(var b=null,c=this.f;c!==this.b&&c!==this.g;)a?c.b?c=c.g:(b=a.ca(c.bb))?(a=null,c=c.g):c=c.f:c=c.f;return c===this.b?b:null};n.Ne=function(a){return this.zb(a)};n.Oe=function(a){return this.zb(a)};n.rd=function(a){return this.zb(a)};n.jc=function(a){return this.zb(a)};n.Tc=function(a){return this.zb(a)};n.Sc=function(a){return this.zb(a)};
n.Rc=function(a){return this.zb(a)};n.be=function(a){return this.zb(a)};n.Uc=function(a){return this.zb(a)};n.Lb=function(){return null};n.ic=function(){return null};n.Pb=function(a){return this.zb(a)};n.Qc=function(){return null};function ch(a){ah.call(this,a)}v(ch,ah);ch.prototype.Lb=function(a){var b=bh(this,a.values,!1,0);return b===a.values?a:b?new Ec(b):null};
ch.prototype.ic=function(a){for(var b=this.f,c=!1;b;){if(b.bb instanceof dh){c=!0;break}b=b.f}return c?(b=bh(this,a.values,!1,0),b===a.values?a:b?new Fc(b):null):null};ch.prototype.h=function(a,b){return bh(this,a,!0,b)};function dh(a){ah.call(this,a)}v(dh,ah);dh.prototype.Lb=function(a){return this.zb(a)};dh.prototype.ic=function(a){var b=bh(this,a.values,!1,0);return b===a.values?a:b?new Fc(b):null};dh.prototype.h=function(a,b){for(var c=this.f,d;c!==this.g;){if(d=c.bb.h(a,b))return d;c=c.f}return null};
function eh(a,b){ah.call(this,b);this.name=a}v(eh,ah);eh.prototype.zb=function(){return null};eh.prototype.Pb=function(a){if(a.name.toLowerCase()!=this.name)return null;var b=bh(this,a.values,!1,0);return b===a.values?a:b?new Gc(a.name,b):null};function fh(){}fh.prototype.b=function(a,b){return b};fh.prototype.f=function(){};function gh(a,b){this.name=b;this.bb=a.g[this.name]}v(gh,fh);
gh.prototype.b=function(a,b,c){if(c.values[this.name])return b;if(a=this.bb.h(a,b)){var d=a.length;this.f(1<d?new Ec(a):a[0],c);return b+d}return b};gh.prototype.f=function(a,b){b.values[this.name]=a};function hh(a,b){gh.call(this,a,b[0]);this.g=b}v(hh,gh);hh.prototype.f=function(a,b){for(var c=0;c<this.g.length;c++)b.values[this.g[c]]=a};function ih(a,b){this.W=a;this.nf=b}v(ih,fh);
ih.prototype.b=function(a,b,c){var d=b;if(this.nf)if(a[b]==Kc){if(++b==a.length)return d}else return d;var e=this.W[0].b(a,b,c);if(e==b)return d;b=e;for(d=1;d<this.W.length&&b<a.length;d++){e=this.W[d].b(a,b,c);if(e==b)break;b=e}return b};function jh(){this.f=this.vb=null;this.error=!1;this.values={};this.b=null}n=jh.prototype;n.clone=function(){var a=new this.constructor;a.vb=this.vb;a.f=this.f;a.b=this.b;return a};n.Pe=function(a,b){this.vb=a;this.f=b};n.Cc=function(){this.error=!0;return 0};
function kh(a,b){a.Cc([b]);return null}n.Ne=function(a){return kh(this,a)};n.rd=function(a){return kh(this,a)};n.jc=function(a){return kh(this,a)};n.Tc=function(a){return kh(this,a)};n.Sc=function(a){return kh(this,a)};n.Rc=function(a){return kh(this,a)};n.be=function(a){return kh(this,a)};n.Uc=function(a){return kh(this,a)};n.Lb=function(a){this.Cc(a.values);return null};n.ic=function(){this.error=!0;return null};n.Pb=function(a){return kh(this,a)};n.Qc=function(){this.error=!0;return null};
function lh(){jh.call(this)}v(lh,jh);lh.prototype.Cc=function(a){for(var b=0,c=0;b<a.length;){var d=this.vb[c].b(a,b,this);if(d>b)b=d,c=0;else if(++c==this.vb.length){this.error=!0;break}}return b};function mh(){jh.call(this)}v(mh,jh);mh.prototype.Cc=function(a){if(a.length>this.vb.length||!a.length)return this.error=!0,0;for(var b=0;b<this.vb.length;b++){for(var c=b;c>=a.length;)c=1==c?0:c-2;if(this.vb[b].b(a,c,this)!=c+1)return this.error=!0,0}return a.length};function nh(){jh.call(this)}v(nh,jh);
...
oh.prototype.ic=function(a){for(var b={},c=0;c<a.values.length;c++){this.values={};if(a.values[c]instanceof Fc)this.error=!0;else{a.values[c].ca(this);for(var d=this.values,e=t(this.f),f=e.next();!f.done;f=e.next()){var f=f.value,g=d[f]||this.b.l[f],h=b[f];h||(h=[],b[f]=h);h.push(g)}this.values["background-color"]&&c!=a.values.length-1&&(this.error=!0)}if(this.error)return null}this.values={};for(var l in b)this.values[l]="background-color"==l?b[l].pop():new Fc(b[l]);return null};
...
ph.prototype.ic=function(a){a.values[0].ca(this);if(this.error)return null;for(var b=[this.values["font-family"]],c=1;c<a.values.length;c++)b.push(a.values[c]);a=new Fc(b);a.ca(this.b.g["font-family"])?this.values["font-family"]=a:this.error=!0;return null};ph.prototype.jc=function(a){if(a=this.b.f[a.name])for(var b in a)this.values[b]=a[b];else this.error=!0;return null};var qh={SIMPLE:lh,INSETS:mh,INSETS_SLASH:nh,COMMA:oh,FONT:ph};
...
function zh(a,b){for(var c={};;){var d=yh(a,b,1);if(!d)break;c.qa=[];var e=[];c.$a="";var f=void 0;c.Za=!0;c.dg=a;for(var g=function(a){return function(){if(!a.qa.length)throw Error("No values");var b;if(1==a.qa.length)b=a.qa[0];else{var c=a.$a,d=a.qa;b=new Ug;if("||"==c){for(c=0;c<d.length;c++){var e=new Ug;if(e.W.length)throw Error("invalid call");var f=new Sg(Wg);f.b=2*c+1;e.W.push(f);var f=new Tg(0,!0),g=new Tg(0,!1);e.f.push(e.b.length);e.b.push(g);e.match.push(e.b.length);e.b.push(f);Zg(e,d[c],
...
}S(b);xh(d)?a.b[d]=l:a.g[d]=1!=l.W.length||l.W[0].b?new ch(l):l.W[0].bb;c={qa:c.qa,dg:c.dg,$a:c.$a,Za:c.Za}}}function Ah(a,b){for(var c={},d=t(b),e=d.next();!e.done;e=d.next())for(var e=e.value,f=a.h[e],e=t(f?f.f:[e]),f=e.next();!f.done;f=e.next()){var f=f.value,g=a.l[f];g?c[f]=g:w.b("Unknown property in makePropSet:",f)}return c}
...
{"block-size":"height","inline-size":"width"});function V(a,b){this.value=a;this.ab=b}n=V.prototype;n.Lf=function(){return this};n.Hd=function(a){a=this.value.ca(a);return a===this.value?this:new V(a,this.ab)};n.Nf=function(a){return a?new V(this.value,this.ab+a):this};n.evaluate=function(a,b){return kg(a,this.value,b)};n.uf=function(){return!0};function Th(a,b,c){V.call(this,a,b);this.ia=c}v(Th,V);Th.prototype.Lf=function(){return new V(this.value,this.ab)};
Th.prototype.Hd=function(a){a=this.value.ca(a);return a===this.value?this:new Th(a,this.ab,this.ia)};Th.prototype.Nf=function(a){return a?new Th(this.value,this.ab+a,this.ia):this};Th.prototype.uf=function(a){return!!this.ia.evaluate(a)};function Uh(a,b,c){return(!b||c.ab>b.ab)&&c.uf(a)?c.Lf():b}var Vh={"region-id":!0,"fragment-selector-id":!0};function Wh(a){return"_"!=a.charAt(0)&&!Vh[a]}function Xh(a,b,c){c?a[b]=c:delete a[b]}function Yh(a,b){var c=a[b];c||(c={},a[b]=c);return c}
function Zh(a){var b=a._viewConditionalStyles;b||(b=[],a._viewConditionalStyles=b);return b}function $h(a,b){var c=a[b];c||(c=[],a[b]=c);return c}function ai(a,b,c,d,e,f,g){[{id:e,hg:"_pseudos"},{id:f,hg:"_regions"}].forEach(function(a){if(a.id){var c=Yh(b,a.hg);b=c[a.id];b||(b={},c[a.id]=b)}});g&&(e=Zh(b),b={},e.push({Hg:b,xg:g}));for(var h in c)"_"!=h.charAt(0)&&(Vh[h]?(g=c[h],e=$h(b,h),Array.prototype.push.apply(e,g)):Xh(b,h,Uh(a,b[h],c[h].Nf(d))))}
...
Xi.prototype.Pb=function(a){if("attr"!==a.name)return Dc.prototype.Pb.call(this,a);var b="string",c;a.values[0]instanceof Ec?(2<=a.values[0].values.length&&(b=a.values[0].values[1].stringValue()),c=a.values[0].values[0].stringValue()):c=a.values[0].stringValue();a=1<a.values.length?Yi(a.values[1].stringValue(),b):Yi(null,b);return this.element&&this.element.hasAttribute(c)?Yi(this.element.getAttribute(c),b):a};function Zi(a,b,c){this.f=a;this.element=b;this.b=c}v(Zi,Dc);
Zi.prototype.jc=function(a){var b=this.f,c=b.I,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.D)];b.D++;break;case "close-quote":return 0<b.D&&b.D--,c[2*Math.min(d,b.D)+1];case "no-open-quote":return b.D++,new Lc("");case "no-close-quote":return 0<b.D&&b.D--,new Lc("")}return a};
...
Zi.prototype.Pb=function(a){switch(a.name){case "counter":if(2>=a.values.length)return ej(this,a.values);break;case "counters":if(3>=a.values.length)return gj(this,a.values);break;case "target-counter":if(3>=a.values.length)return ij(this,a.values);break;case "target-counters":if(4>=a.values.length)return kj(this,a.values)}w.b("E_CSS_CONTENT_PROP:",a.toString());return new Lc("")};var mj=1/1048576;function nj(a,b){for(var c in a)b[c]=a[c].clone()}
function oj(){this.j=0;this.b={};this.qd={};this.h={};this.f={};this.Na={};this.g={};this.fd={};this.order=0}oj.prototype.clone=function(){var a=new oj;a.j=this.j;for(var b in this.b)a.b[b]=this.b[b];nj(this.qd,a.qd);nj(this.h,a.h);nj(this.f,a.f);nj(this.Na,a.Na);nj(this.g,a.g);nj(this.fd,a.fd);a.order=this.order;return a};function li(a,b,c){var d=a[b];d&&(c=d.l(c));a[b]=c}oj.prototype.jf=function(){return this.order+=mj};
function pj(a,b,c,d){this.u=a;this.l=b;this.Dc=c;this.xb=d;this.h=[[],[]];this.ga={};this.G=this.F=this.va=this.b=null;this.Ca=this.ha=this.X=this.j=this.f="";this.Y=this.N=null;this.sa=this.rb=!0;this.g={};this.H=[{}];this.I=[new Lc("\u201c"),new Lc("\u201d"),new Lc("\u2018"),new Lc("\u2019")];this.D=0;this.lang="";this.Sb=[0];this.Pa=0;this.ra=[{}];this.Eb=this.ra[0];this.P=null;this.Rb=[this.P];this.Qb=[{}];this.yb=this.ra[0];this.B={};this.ib=[];this.Fb=[]}
...
a.lang=d.toLowerCase();d=a.sa;var e=a.Sb;a.Pa=++e[e.length-1];e.push(0);var e=a.ra,f=a.Eb=e[e.length-1],g=f[a.j];g||(g=f[a.j]={});g[a.f]=(g[a.f]||0)+1;e.push({});e=a.Rb;null!==e[e.length-1]?a.P=--e[e.length-1]:a.P=null;e.push(null);e=a.Qb;(f=a.yb=e[e.length-1])&&f[a.j]&&f[a.j][a.f]--;e.push({});wj(a);Cj(a,b);e=c.quotes;c=null;e&&(e=e.evaluate(a.l))&&(c=new Wi(a.I),e===J?a.I=[new Lc(""),new Lc("")]:e instanceof Ec&&(a.I=e.values));yj(a,a.F);e=a.X||a.ha||b.getAttribute("name")||"";if(d||e){var h={};
...
function wj(a){var b;for(b=0;b<a.G.length;b++)tj(a,a.u.Na,a.G[b]);for(b=0;b<a.N.length;b++)tj(a,a.u.f,a.N[b]);tj(a,a.u.g,a.X);tj(a,a.u.qd,a.f);""!=a.f&&tj(a,a.u.qd,"*");tj(a,a.u.h,a.Ca);null!==a.Y&&(tj(a,a.u.fd,a.Y),tj(a,a.u.fd,"*"));a.b=null;a.h.push([]);for(var c=1;-1<=c;--c){var d=a.h[a.h.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.rb=!0;a.sa=!1}
function Fj(a){for(var b=1;-1<=b;--b)for(var c=a.h[a.h.length-b-2],d=0;d<c.length;)c[d].f(a,b)?c.splice(d,1):d++;a.h.pop();a.rb=!1}var Gj=null;function Hj(a,b,c,d,e,f,g){Ef.call(this,a,b,g);this.b=null;this.$=0;this.h=this.kb=null;this.D=!1;this.ia=c;this.l=d?d.l:Gj?Gj.clone():new oj;this.G=e;this.B=f;this.u=0;this.j=null}v(Hj,Ff);Hj.prototype.Pf=function(a){li(this.l.qd,"*",a)};function Ij(a,b){var c=bi(a.b,b);c!==b&&c.g(a.l)||a.Pf(c)}
Hj.prototype.Ob=function(a,b){if(b||a)this.$+=1,b&&a?this.b.push(new oi(a,b.toLowerCase())):b?this.b.push(new ni(b.toLowerCase())):this.b.push(new qi(a))};Hj.prototype.ie=function(a){this.h?(w.b("::"+this.h,"followed by ."+a),this.b.push(new Ii(""))):(this.$+=256,this.b.push(new ki(a)))};var Jj={"nth-child":Ai,"nth-of-type":Bi,"nth-last-child":Ci,"nth-last-of-type":Di};
...
n.ne=function(){var a="f"+Kj++;Ij(this,new hi(new Si(a,this.j,null)));this.b=[new Ii(a)];this.j=null};n.Lc=function(){Lj(this);this.h=null;this.D=!1;this.$=0;this.b=[]};n.Kb=function(){var a;0!=this.u?(Hf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.u=1,this.kb={},this.h=null,this.$=0,this.D=!1,this.b=[])};n.error=function(a,b){Ff.prototype.error.call(this,a,b);1==this.u&&(this.u=0)};n.Oc=function(a){Ff.prototype.Oc.call(this,a);this.u=0};
n.Ha=function(){Lj(this);Ff.prototype.Ha.call(this);1==this.u&&(this.u=0)};n.Xb=function(){Ff.prototype.Xb.call(this)};function Lj(a){if(a.b){var b=a.$+a.l.jf();Ij(a,a.Sf(b));a.b=null;a.h=null;a.j=null;a.D=!1;a.$=0}}n.Sf=function(a){var b=this.G;this.D&&(b=b?"xxx-bogus-xxx":"footnote");return new ii(this.kb,a,this.h,b,this.j)};n.Ib=function(a,b,c){Bh(this.B,a,b,c,this)};n.bd=function(a,b){Gf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};
...
var kk={bh:"text/html",dh:"text/xml",Pg:"application/xml",Og:"application/xhtml_xml",Wg:"image/svg+xml"};function lk(a,b,c){c=c||new DOMParser;var d;try{d=c.parseFromString(a,b)}catch(e){}if(d){a=d.documentElement;if("parsererror"===a.localName)return null;for(a=a.firstChild;a;a=a.nextSibling)if("parsererror"===a.localName)return null}else return null;return d}
...
function Ck(a,b){this.h={};this.L=a;this.g=b;this.N=null;this.u=[];var c=this;this.I=function(a){var b=a.currentTarget,d=b.getAttribute("href")||b.getAttributeNS("http://www.w3.org/1999/xlink","href");d&&eb(c,{type:"hyperlink",target:null,currentTarget:null,hh:b,href:d,preventDefault:function(){a.preventDefault()}})};this.b={};this.f={width:0,height:0};this.B=this.G=!1;this.D=this.F=!0;this.S=0;this.position=null;this.offset=-1;this.l=null;this.j=[];this.H={top:{},bottom:{},left:{},right:{}}}
v(Ck,db);function Dk(a,b){(a.F=b)?a.L.setAttribute("data-vivliostyle-auto-page-width",!0):a.L.removeAttribute("data-vivliostyle-auto-page-width")}function Ek(a,b){(a.D=b)?a.L.setAttribute("data-vivliostyle-auto-page-height",!0):a.L.removeAttribute("data-vivliostyle-auto-page-height")}function Fk(a,b,c){var d=a.b[c];d?d.push(b):a.b[c]=[b]}
function Gk(a,b,c){Object.keys(a.b).forEach(function(a){for(var b=this.b[a],c=0;c<b.length;)this.L.contains(b[c])?c++:b.splice(c,1);b.length||delete this.b[a]},a);for(var d=a.u,e=0;e<d.length;e++){var f=d[e];x(f.target,f.name,f.value.toString())}e=Hk(c,a.L);a.f.width=e.width;a.f.height=e.height;for(e=0;e<b.length;e++)if(c=b[e],f=a.b[c.kd],d=a.b[c.Cg],f&&d&&(f=Bk(f,c.action)))for(var g=0;g<d.length;g++)d[g].addEventListener(c.event,f,!1)}
...
function Lk(a,b,c,d,e,f,g,h,l){this.b=a;this.element=b;this.f=c;this.ab=d;this.l=e;this.h=f;this.u=g;this.j=h;this.ub=-1;this.g=l}function Mk(a,b){return a.h?!b.h||a.ab>b.ab?!0:a.j:!1}function Nk(a,b){return a.top-b.top}function Ok(a,b){return b.right-a.right}function Pk(a,b){return a===b?!0:a&&b?a.node===b.node&&a.hb===b.hb&&Qk(a.ua,b.ua)&&Qk(a.Ga,b.Ga)&&Pk(a.Da,b.Da):!1}
function Rk(a,b){if(a===b)return!0;if(!a||!b||a.ma!==b.ma||a.J!==b.J||a.oa.length!==b.oa.length)return!1;for(var c=0;c<a.oa.length;c++)if(!Pk(a.oa[c],b.oa[c]))return!1;return!0}function Sk(a){return{oa:[{node:a.M,hb:Tk,ua:a.ua,Ga:null,Da:null,Ra:0}],ma:0,J:!1,Oa:a.Oa}}function Uk(a,b){var c=new Vk(a.node,b,0);c.hb=a.hb;c.ua=a.ua;c.Ga=a.Ga;c.Da=a.Da?Uk(a.Da,Wk(b)):null;c.C=a.C;c.Ra=a.Ra+1;return c}var Tk=0;
function Xk(a,b,c,d,e,f,g){this.na=a;this.gd=d;this.rf=null;this.root=b;this.ba=c;this.type=f;e&&(e.rf=this);this.b=g}function Qk(a,b){return a===b||!!a&&!!b&&(b?a.na===b.na&&a.ba===b.ba&&a.type===b.type&&Qk(a.gd,b.gd):!1)}function Yk(a,b){this.Dg=a;this.count=b}
function Vk(a,b,c){this.M=a;this.parent=b;this.Ia=c;this.ma=0;this.J=!1;this.hb=Tk;this.ua=b?b.ua:null;this.Da=this.Ga=null;this.Ca=!1;this.xa=!0;this.wa=!1;this.j=b?b.j:0;this.display=null;this.V=Zk;this.ga=this.N=this.l=this.Aa=null;this.Y="baseline";this.ha="top";this.sa=this.ra=0;this.H=!1;this.mc=b?b.mc:0;this.F=b?b.F:null;this.B=b?b.B:!1;this.P=this.$c=!1;this.D=this.A=this.G=this.g=null;this.h=b?b.h:{};this.b=b?b.b:!1;this.direction=b?b.direction:"ltr";this.f=b?b.f:null;this.Oa=this.lang=null;
this.C=b?b.C:null;this.u=null;this.va={};this.Ra=1;this.X=this.I=null}function $k(a){a.xa=!0;a.j=a.parent?a.parent.j:0;a.A=null;a.D=null;a.ma=0;a.J=!1;a.display=null;a.V=Zk;a.Aa=null;a.l=null;a.N=null;a.ga=null;a.Y="baseline";a.H=!1;a.mc=a.parent?a.parent.mc:0;a.F=a.parent?a.parent.F:null;a.B=a.parent?a.parent.B:!1;a.g=null;a.G=null;a.Ga=null;a.$c=!1;a.P=!1;a.b=a.parent?a.parent.b:!1;a.Ga=null;a.Oa=null;a.C=a.parent?a.parent.C:null;a.u=null;a.va={};a.Ra=1;a.I=null;a.X=null}
function al(a){var b=new Vk(a.M,a.parent,a.Ia);b.ma=a.ma;b.J=a.J;b.Ga=a.Ga;b.hb=a.hb;b.ua=a.ua;b.Da=a.Da;b.xa=a.xa;b.j=a.j;b.display=a.display;b.V=a.V;b.Aa=a.Aa;b.l=a.l;b.N=a.N;b.ga=a.ga;b.Y=a.Y;b.ha=a.ha;b.ra=a.ra;b.sa=a.sa;b.$c=a.$c;b.P=a.P;b.H=a.H;b.mc=a.mc;b.F=a.F;b.B=a.B;b.g=a.g;b.G=a.G;b.A=a.A;b.D=a.D;b.f=a.f;b.b=a.b;b.wa=a.wa;b.Oa=a.Oa;b.C=a.C;b.u=a.u;b.va=Object.create(a.va);b.Ra=a.Ra;b.I=a.I;b.X=a.X;return b}Vk.prototype.modify=function(){return this.Ca?al(this):this};
function Wk(a){var b=a;do{if(b.Ca)break;b.Ca=!0;b=b.parent}while(b);return a}Vk.prototype.clone=function(){for(var a=al(this),b=a,c;c=b.parent;)c=al(c),b=b.parent=c;return a};function bl(a){return{node:a.M,hb:a.hb,ua:a.ua,Ga:a.Ga,Da:a.Da?bl(a.Da):null,C:a.C,Ra:a.Ra}}function cl(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(bl(b)),b=b.parent;while(b);b=a.Oa?dl(a.Oa,a.ma,-1):a.ma;return{oa:c,ma:b,J:a.J,Oa:a.Oa}}function el(a){for(a=a.parent;a;){if(a.$c)return!0;a=a.parent}return!1}
function fl(a,b){for(var c=a;c;)c.xa||b(c),c=c.parent}function gl(a,b){return a.C===b&&!!a.parent&&a.parent.C===b}function hl(a){this.f=a;this.b=null}hl.prototype.clone=function(){var a=new hl(this.f);if(this.b){a.b=[];for(var b=0;b<this.b.length;++b)a.b[b]=this.b[b]}return a};function il(a,b){if(!b)return!1;if(a===b)return!0;if(!Rk(a.f,b.f))return!1;if(a.b){if(!b.b||a.b.length!==b.b.length)return!1;for(var c=0;c<a.b.length;c++)if(!Rk(a.b[c],b.b[c]))return!1}else if(b.b)return!1;return!0}
...
function ol(a){this.element=a;this.G=this.F=this.height=this.width=this.P=this.I=this.X=this.H=this.Ca=this.ga=this.Pa=this.Y=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.Rb=this.rb=null;this.yb=this.Gd=this.Sb=this.Jd=this.h=0;this.b=!1}function pl(a){return a.marginTop+a.ga+a.I}function ql(a){return a.marginBottom+a.Ca+a.P}function rl(a){return a.marginLeft+a.Y+a.H}function sl(a){return a.marginRight+a.Pa+a.X}function tl(a){return a.b?-1:1}
function ul(a,b){a.element=b.element;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.Y=b.Y;a.Pa=b.Pa;a.ga=b.ga;a.Ca=b.Ca;a.H=b.H;a.X=b.X;a.I=b.I;a.P=b.P;a.width=b.width;a.height=b.height;a.F=b.F;a.G=b.G;a.Rb=b.Rb;a.rb=b.rb;a.h=b.h;a.Jd=b.Jd;a.Sb=b.Sb;a.b=b.b}function vl(a,b,c){a.top=b;a.height=c;x(a.element,"top",b+"px");x(a.element,"height",c+"px")}
...
function Yl(a,b){if(!b.eb)return b.offset;var c=a.b.length-1,d=a.b[c];d===b&&(c--,d=a.b[c]);for(;0<=c;){if(d.b!==b.b)return b.offset;if(!d.eb||d.D)return d.offset;b=d;d=a.b[--c]}throw Error("No block start offset found!");}
function Zl(a,b,c,d,e,f,g,h){this.ba=a;this.root=a.root;this.ib=c;this.h=d;this.B=f;this.f=this.root;this.F={};this.X={};this.G={};this.I=[];this.D=this.P=this.N=null;this.Ca=g;this.Y=new pj(b,d,g,h);this.g=new Gl;this.u=!0;this.ha=[];this.Pa=e;this.va=this.sa=!1;this.b=a=ek(a,this.root);this.ga={};this.j=new Vl(d);Il(this.g,a);d=$l(this,this.root);Bj(this.Y,this.root,d,a);am(this,d,!1);this.H=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.H=
...
function gm(a,b,c){var d=-1;if(b<=a.b&&(d=Kl(a.g,b),d+=c,d<Hl(a.g)))return Ll(a.g,d);if(!a.f)return Number.POSITIVE_INFINITY;for(var e=a.h;;){var f=a.f.firstChild;if(!f)for(;;){if(1==a.f.nodeType){var f=a.Y,g=a.f;if(f.Fb.pop()!==g)throw Error("Invalid call to popElement");f.Sb.pop();f.ra.pop();f.Rb.pop();f.Qb.pop();Fj(f);zj(f);a.u=a.ha.pop();var f=a.j,h=a.b,l=g=f.b.pop(),k=f.eb,m=f.lb;if(Nl(l)){var p=l.style._pseudos;p&&p.after&&(h=new Ml(l.B,p.after,h,!1,l.pa,k,m,!0),k=Pl(h,"content"),El(k)&&(l.f=
...
function vm(a,b,c,d){var e=L("initFont"),f=b.src,g={},h;for(h in lm)g[h]=b.xc[h];d=um(a,b,d);g["font-family"]=D(d);var l=new pm(g),k=a.body.ownerDocument.createElement("span");k.textContent="M";var m=(new Date).valueOf()+1E3;b=a.b.ownerDocument.createElement("style");h=mm+nm++;b.textContent=qm(l,"",tf([h]));a.b.appendChild(b);a.body.appendChild(k);k.style.visibility="hidden";k.style.fontFamily=d;for(var p in lm)x(k,p,g[p].toString());var g=k.getBoundingClientRect(),q=g.right-g.left,r=g.bottom-g.top;
...
function Ql(a,b){if(a)if(b){var c=!!Sl[a],d=!!Sl[b];if(c&&d)switch(b){case "column":return a;case "region":return"column"===a?b:a;default:return b}else return d?b:c?a:ym[b]?b:ym[a]?a:b}else return a;else return b}function zm(a){switch(a){case "left":case "right":case "recto":case "verso":return a;default:return"any"}};function Am(){}n=Am.prototype;n.Of=function(a){return{w:a,xd:!1,Nb:!1}};n.qf=function(){};n.yf=function(){};n.fg=function(){};n.xf=function(){};n.sd=function(){};n.lc=function(){};function Bm(a,b){this.b=a;this.f=b}
function Cm(a,b){var c=a.b,d=c.Of(b),e=L("LayoutIterator");Ce(function(b){for(var e;d.w;){e=d.w.A?1!==d.w.A.nodeType?Jk(d.w.A,d.w.mc)?void 0:d.w.J?c.yf(d):c.qf(d):d.w.xa?d.w.J?c.xf(d):c.fg(d):d.w.J?c.lc(d):c.sd(d):void 0;e=(e&&e.Wa()?e:M(!0)).fa(function(){return d.Nb?M(null):Dm(a.f,d.w,d.xd)});if(e.Wa()){e.then(function(a){d.Nb?Q(b):(d.w=a,P(b))});return}if(d.Nb){Q(b);return}d.w=e.get()}Q(b)}).then(function(){O(e,d.w)});return e.result()}function Em(a){this.$b=a}v(Em,Am);n=Em.prototype;n.gg=function(){};
n.If=function(){};n.Of=function(a){return{w:a,xd:!!this.$b&&a.J,Nb:!1,$b:this.$b,Wc:null,De:!1,Rf:[],cd:null}};n.qf=function(a){a.De=!1};n.sd=function(a){a.Rf.push(Wk(a.w));a.Wc=Ql(a.Wc,a.w.g);a.De=!0;return this.gg(a)};n.lc=function(a){var b;a.De?(b=(b=void 0,M(!0)),b=b.fa(function(){a.Nb||(a.Rf=[],a.$b=!1,a.xd=!1,a.Wc=null);return M(!0)})):b=(b=this.If(a))&&b.Wa()?b:M(!0);return b.fa(function(){a.Nb||(a.De=!1,a.cd=Wk(a.w),a.Wc=Ql(a.Wc,a.w.G));return M(!0)})};
function Fm(a,b,c){this.pf=[];this.ya=Object.create(a);this.ya.element=b;this.ya.j=a.j.clone();this.ya.u=!1;this.ya.ff=c.C;this.ya.Ed=a;a=Gm(this.ya,c);this.ya.ha-=a;var d=this;this.ya.zd=function(a){return Hm.prototype.zd.call(this,a).fa(function(a){d.pf.push(Wk(a));return M(a)})}}function Im(a,b){return Jm(a.ya,b,!0)}Fm.prototype.Yb=function(a){var b=this.ya.Yb();if(a){a=Wk(this.pf[0]);var c=new Km(a,null,a.wa,0);c.f(this.ya,0);if(!b.w)return{Ab:c,w:a}}return b};
Fm.prototype.Ja=function(a,b,c){return this.ya.Ja(a,b,c)};function Lm(){this.u=this.h=null}function Mm(a,b,c){a.$f(b,c);return Nm(a,b,c)}function Nm(a,b,c){var d=L("vivliostyle.layoututil.AbstractLayoutRetryer.tryLayout");a.tf(b,c);var e=a.lf(b);e.b(b,c).then(function(a){var f=e.f(a,c);(f=e.g(a,this.f,c,f))?O(d,a):(this.Bd(this.f),this.ce(b,c),Nm(this,this.f,c).Ma(d))}.bind(a));return d.result()}Lm.prototype.$f=function(){};
Lm.prototype.Bd=function(a){a=a.A||a.parent.A;for(var b;b=a.lastChild;)a.removeChild(b);for(;b=a.nextSibling;)b.parentNode.removeChild(b)};Lm.prototype.tf=function(a,b){this.f=Wk(a);this.h=[].concat(b.N);this.D=[].concat(b.B);a.C&&(this.u=a.C.Te())};Lm.prototype.ce=function(a,b){b.N=this.h;b.B=this.D;a.C&&a.C.Se(this.u)};function Om(a,b,c,d){d=d[b];if(!d)throw Error("unknown writing-mode: "+b);b=d[c||"ltr"];if(!b)throw Error("unknown direction: "+c);c=t(b);for(b=c.next();!b.done;b=c.next())if(b=b.value,b=a.replace(b.h,b.b),b!==a)return b;return a}function Pm(a){var b=Qm,c={};Object.keys(b).forEach(function(d){var e=c[d]={},f=b[d];Object.keys(f).forEach(function(b){e[b]=f[b].map(function(b){return{h:new RegExp("(-?)"+(a?b.da:b.ea)+"(-?)"),b:"$1"+(a?b.ea:b.da)+"$2"}})})});return c}
...
Vm.prototype.Fa=function(){if(null===this.order)throw Error("The page float is not yet added");return this.order};function Wm(a){if(!a.id)throw Error("The page float is not yet added");return a.id}Vm.prototype.Ze=function(){return!1};function Xm(){this.b=[];this.f=0}Xm.prototype.jf=function(){return this.f++};
Xm.prototype.fe=function(a){if(0<=this.b.findIndex(function(b){return Rk(b.b,a.b)}))throw Error("A page float with the same source node is already registered");var b=a.order=this.jf();a.id="pf"+b;this.b.push(a)};Xm.prototype.Ye=function(a){var b=this.b.findIndex(function(b){return Rk(b.b,a)});return 0<=b?this.b[b]:null};function Ym(a,b,c,d,e){this.V=a;this.Aa=b;this.Hb=c;this.b=d;this.g=e}function Zm(a,b){return a.Hb.some(function(a){return a.ja===b})}
...
function hn(a,b){var c=Wm(b),d=b.V;d===a.V?a.B.includes(c)||(a.B.push(c),jn(b).jg(b,a)):hn(cn(a,d),b)}function kn(a,b){var c=Wm(b),d=b.V;return d===a.V?a.B.includes(c):kn(cn(a,d),b)}function ln(a,b,c){var d=b.V;d!==a.V?ln(cn(a,d),b,c):a.b.includes(b)||(a.b.push(b),a.b.sort(function(a,b){return a.Fa()-b.Fa()}));c||mn(a)}function nn(a,b,c){var d=b.V;d!==a.V?nn(cn(a,d),b,c):(b=a.b.indexOf(b),0<=b&&(b=a.b.splice(b,1)[0],(b=b.b&&b.b.element)&&b.parentNode&&b.parentNode.removeChild(b),c||mn(a)))}
...
function mn(a){a.Kc=!0;a.g||(a.L&&(a.children.forEach(function(a){Dn(this,a)&&a.b.forEach(function(a){(a=a.b.element)&&a.parentNode&&a.parentNode.removeChild(a)})},a),zl(a.L)),a.children.forEach(function(a){a.D.splice(0)}),a.children.splice(0),Object.keys(a.l).forEach(function(a){delete this.l[a]},a))}function En(a){a=a.children.splice(0);a.forEach(function(a){a.b.forEach(function(a){(a=a.b.element)&&a.parentNode&&a.parentNode.removeChild(a)})});return a}
...
l=b.top,m=b.left,p=b.bottom,E=b.right,K=b.Ic,I=b.Hc;switch(f){case "inline-start":g.b?l=Math.max(l,g.top+g.height):m=Math.max(m,g.left+g.width);break;case "block-start":g.b?(k&&g.left<E&&(K=e(k,g.Qb[0],h.T-h.U)),E=Math.min(E,g.left)):(k&&g.top+g.height>l&&(K=e(k,g.Qb[0],h.O-h.R)),l=Math.max(l,g.top+g.height));break;case "inline-end":g.b?p=Math.min(p,g.top):E=Math.min(E,g.left);break;case "block-end":g.b?(k&&g.left+g.width>m&&(I=e(k,g.Qb[0],h.T-h.U)),m=Math.max(m,g.left+g.width)):(k&&g.top<p&&(I=e(k,
g.Qb[0],h.O-h.R)),p=Math.min(p,g.top));break;default:throw Error("Unknown logical float side: "+f);}return{top:l,left:m,bottom:p,right:E,Ic:K,Hc:I}},l));l.left+=f;l.right+=f;l.top+=g;l.bottom+=g;return l}
...
c?["block-start","block-end"]:[c]:[d];var l=b.Fa();d.forEach(function(a){switch(a){case "block-start":case "inline-start":h[a]=!f(this,a);break;case "block-end":case "inline-end":h[a]=!g(this,a);break;default:throw Error("Unexpected side: "+a);}},a);return h}function Xn(a){return(a.parent?Xn(a.parent):[]).concat(a.D)}function Yn(a,b,c){c===a.V?a.D.push(b):Yn(cn(a,c),b,c)}
...
function bo(a){for(var b=ao.length-1;0<=b;b--){var c=ao[b];if(c.Af(a))return c}throw Error("No PageFloatLayoutStrategy found for "+a);}function jn(a){for(var b=ao.length-1;0<=b;b--){var c=ao[b];if(c.zf(a))return c}throw Error("No PageFloatLayoutStrategy found for "+a);}function co(){}n=co.prototype;n.Af=function(a){return Um(a.V)};n.zf=function(){return!0};n.Gf=function(a,b,c){var d=a.V,e=a.Aa,f=cl(a);return eo(c,d,a.ga,a).fa(function(c){d=c;c=new Vm(f,d,e,a.l,b.h,a.N);b.fe(c);return M(c)})};
n.Hf=function(a,b,c,d){return new Ym(a[0].ja.V,b,a,c,d)};n.sf=function(a,b){return on(b,a)};n.wf=function(){};n.jg=function(){};ao.push(new co);var fo={img:!0,svg:!0,audio:!0,video:!0};
...
function mo(a,b){this.h=a;this.Mc=b;this.j=!1;this.l=null}v(mo,ko);mo.prototype.f=function(a,b){if(b<this.b())return null;this.j||(this.l=no(a,this,0<b),this.j=!0);return this.l};mo.prototype.b=function(){return this.Mc};mo.prototype.g=function(){return this.j?this.l:this.h[this.h.length-1]};function Km(a,b,c,d){this.position=a;this.F=b;this.B=this.j=c;this.D=d;this.h=!1;this.qc=0}v(Km,ko);
Km.prototype.f=function(a,b){if(!this.h){var c=Gm(a,this.position);this.qc=go(this.position,a.f,0,a.b)+c;this.h=!0}var c=this.qc,d=lo(this.g(),oo(a));this.B=po(a,c+(a.b?-1:1)*d.Be);this.j=this.position.wa=po(a,c+(a.b?-1:1)*d.current);b<this.b()?c=null:(a.h=this.D+qo(a,this),c=this.position);return c};
...
function Io(a,b,c,d,e){var f=a.Ig.createElement("div");a.b?(e>=a.height&&(e-=.1),x(f,"height",d+"px"),x(f,"width",e+"px")):(d>=a.width&&(d-=.1),x(f,"width",d+"px"),x(f,"height",e+"px"));x(f,"float",c);x(f,"clear",c);a.element.insertBefore(f,b);return f}function Jo(a){for(var b=a.element.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.element.removeChild(b);else break}b=c}}
function Ko(a){for(var b=a.element.firstChild,c=a.b?a.b?a.va:a.D:a.b?a.ra:a.va,d=a.b?a.b?a.ib:a.ra:a.b?a.D:a.ib,e=t(a.Eb),f=e.next();!f.done;f=e.next()){var f=f.value,g=f.O-f.R;f.left=Io(a,b,"left",f.U-c,g);f.right=Io(a,b,"right",d-f.T,g)}}
function Lo(a,b,c,d,e){var f;if(b&&Mo(b.A))return NaN;if(b&&b.J&&!b.xa&&(f=go(b,a.f,0,a.b),!isNaN(f)))return f;b=c[d];for(e-=b.Ia;;){f=go(b,a.f,e,a.b);if(!isNaN(f))return f;if(0<e)e--;else{d--;if(0>d)return a.D;b=c[d];1!=b.A.nodeType&&(e=b.A.textContent.length)}}}function X(a){return"number"==typeof a?a:(a=a.match(/^(-?[0-9]*(\.[0-9]*)?)px$/))?parseFloat(a[0]):0}
...
m.top-m.bottom+"px");x(d,"position","absolute");x(d,"display",b.display);l=null;if(k)if(k.P)l=k;else a:{for(k=k.parent;k;){if(k.P){l=k;break a}k=k.parent}l=null}l?(m=l.A.ownerDocument.createElement("div"),m.style.position="absolute",l.b?m.style.right="0":m.style.left="0",m.style.top="0",l.A.appendChild(m),k=Hk(a.f,m),l.A.removeChild(m)):k={left:(a.b?a.ra:a.va)-a.H,right:(a.b?a.D:a.ib)+a.X,top:(a.b?a.va:a.D)-a.I};(l?l.b:a.b)?x(d,"right",k.right-g.T+"px"):x(d,"left",g.U-k.left+"px");x(d,"top",g.R-k.top+
"px");b.D&&(b.D.parentNode.removeChild(b.D),b.D=null);k=a.b?g.U:g.O;g=a.b?g.T:g.R;if(po(a,k)&&a.N.length)b=b.modify(),b.wa=!0,O(c,b);else{Jo(a);m=new lg(a.b?a.ra:a.va,a.b?a.va:a.D,a.b?a.D:a.ib,a.b?a.ib:a.ra);a.b&&(m=Cg(m));l=a.Eb;for(p=[new pg(h.R,h.O,h.U,h.T)];0<p.length&&p[0].O<=m.R;)p.shift();if(p.length){p[0].R<m.R&&(p[0].R=m.R);h=l.length?l[l.length-1].O:m.R;h<m.O&&l.push(new pg(h,m.O,m.U,m.T));h=Gg(l,p[0].R);p=t(p);for(q=p.next();!q.done;q=p.next()){r=q.value;if(h==l.length)break;l[h].R<r.R&&
...
function Ro(a,b,c,d,e,f){var g=a.element.ownerDocument.createElement("div");x(g,"position","absolute");var h=gn(a.l,b.V),l=new an(null,"column",null,a.l.h,b.b,null,null),h=dn(h),g=new So(c,g,a.j.clone(),a.f,a.Dc,l,h);en(l,g);var h=b.V,k=a.l;b=dn(k,h);l=g.element;b.element.parentNode.appendChild(l);g.bg=!0;g.F=b.F;g.G=b.G;g.b=b.b;g.marginLeft=g.marginRight=g.marginTop=g.marginBottom=0;g.Y=g.Pa=g.ga=g.Ca=0;g.H=g.X=g.I=g.P=0;g.rb=(b.rb||[]).concat();g.Fb=!pn(k);g.Rb=null;var m=Al(b);wl(g,m.U-b.F,m.T-
m.U);vl(g,m.R-b.G,m.O-m.R);e.wf(g,b,a);To(g);(a=!!On(k,g,h,c,d,!0,!pn(k),f))?(Jo(g),To(g)):b.element.parentNode.removeChild(l);return a?g:null}
function Uo(a,b,c,d,e,f,g,h){var l=a.l;b=(h?h.Hb:[]).concat(b);var k=b[0].ja,m=Wn(l,k,c,d),p=Ro(a,k,c,g,f,m),q={Kf:p,kf:null,hf:null};if(!p)return M(q);var r=L("layoutSinglePageFloatFragment"),z=!1,u=0;Ce(function(a){u>=b.length?Q(a):Jm(p,new hl(b[u].b),!0).then(function(b){q.hf=b;!b||e?(u++,P(a)):(z=!0,Q(a))})}).then(function(){if(!z){var a=On(l,p,k.V,c,g,!1,e,m);a?(a=f.Hf(b,a,p,!!q.hf),ln(l,a,!0),q.kf=a):z=!0}O(r,q)});return r.result()}
function Vo(a,b,c,d,e){function f(a,c){c?nn(g,c,!0):a&&a.element.parentNode.removeChild(a.element);In(g,h.V);vn(g,b)}var g=a.l,h=b.ja;Hn(g,h);var l=L("layoutPageFloatInner");Uo(a,[b],h.Aa,h.h,!pn(g),c,d,e).then(function(b){var c=b.Kf,d=b.kf,k=b.hf;d?Wo(a,h.V,[e]).then(function(a){a?(ln(g,d),Jn(g,h.V),k&&vn(g,new $m(h,k.f)),O(l,!0)):(f(c,d),O(l,!1))}):(f(c,d),O(l,!1))});return l.result()}
function Wo(a,b,c){var d=a.l,e=Kn(d,b),f=[],g=[],h=!1,l=L("layoutStashedPageFloats"),k=0;Ce(function(b){if(k>=e.length)Q(b);else{var d=e[k];if(c.includes(d))k++,P(b);else{var l=jn(d.Hb[0].ja);Uo(a,d.Hb,d.Aa,null,!1,l,null).then(function(a){var c=a.Kf;c&&f.push(c);(a=a.kf)?(g.push(a),k++,P(b)):(h=!0,Q(b))})}}}).then(function(){h?(g.forEach(function(a){nn(d,a,!0)}),f.forEach(function(a){(a=a.element)&&a.parentNode&&a.parentNode.removeChild(a)})):e.forEach(function(a){(a=a.b.element)&&a.parentNode&&
...
function $o(a,b){var c=a.l,d=bo(b),e=c.Ye(cl(b));return(e?M(e):d.Gf(b,c,a)).fa(function(e){var f=Sk(b),h=Xo(a,b),l=d.sf(e,c),f=new $m(e,f);if(l&&Zm(l,e))return rn(c,e,h.A),M(h);if(kn(c,e)||wn(c,e))return vn(c,f),rn(c,e,h.A),M(h);if(a.sa)return M(null);var k=go(h,a.f,0,a.b);return po(a,k)?M(h):Vo(a,f,d,k,l).fa(function(a){if(a)return M(null);rn(c,e,h.A);return M(h)})})}
...
function cp(a,b,c,d){var e=L("processLineStyling");so(d);var f=d.concat([]);d.splice(0,d.length);var g=0,h=b.f;0==h.count&&(h=h.Dg);Ce(function(d){if(h){var e=dp(a,f),l=h.count-g;if(e.length<=l)Q(d);else{var p=ep(a,f,e[l-1]);p?a.Ja(p,!1,!1).then(function(){g+=l;Ao(a.j,p,0).then(function(e){b=e;ap(a,b,!1);h=b.f;f=[];Bo(a,b,f).then(function(a){c=a;P(d)})})}):Q(d)}}else Q(d)}).then(function(){Array.prototype.push.apply(d,f);so(d);O(e,c)});return e.result()}
...
function gp(a,b){var c=L("layoutBreakableBlock"),d=[];Bo(a,b,d).then(function(e){var f=d.length-1;if(0>f)O(c,e);else{var f=Lo(a,e,d,f,d[f].Ia),g=!1;if(!e||!Mo(e.A)){var h=lo(e,oo(a)),g=po(a,f+(a.b?-1:1)*h.Be);po(a,f+(a.b?-1:1)*h.current)&&!a.sa&&(a.sa=e)}e||(f+=fp(a,d));Qo(a,f);var l;b.f?l=cp(a,b,e,d):l=M(e);l.then(function(b){Ho(a,b,d);0<d.length&&(a.N.push(new mo(d,d[0].j)),g&&(2!=d.length&&0<a.N.length||d[0].M!=d[1].M||!fo[d[0].M.localName])&&b&&(b=b.modify(),b.wa=!0));O(c,b)})}});return c.result()}
...
function no(a,b,c){for(var d=b.h,e=d[0];e.parent&&e.xa;)e=e.parent;var f;c?f=c=1:(c=Math.max((e.h.widows||2)-0,1),f=Math.max((e.h.orphans||2)-0,1));var e=Gm(a,e),g=dp(a,d),h=a.ha-e,e=tl(a),l=qo(a,b),h=h-e*l,k=kp(a,d);isNaN(k.qc)&&(k.qc=Infinity*e);var d=Xa(g.length,function(b){b=g[b];return a.b?b<h||b<=k.qc:b>h||b>=k.qc}),m=0>=d;m&&(d=Xa(g.length,function(b){return a.b?g[b]<h:g[b]>h}));d=Math.min(g.length-c,d);if(d<f)return null;h=g[d-1];if(b=m?k.Df:ep(a,b.h,h))c=lp(a,b),!isNaN(c)&&c<h&&(h=c),a.h=
e*(h-a.D)+l;return b}function lp(a,b){var c=b;do c=c.parent;while(c&&c.xa);return c?(c=Wk(c).modify(),c.J=!0,go(c,a.f,0,a.b)):NaN}function kp(a,b){var c=b.findIndex(function(a){return a.wa});if(0>c)return{qc:NaN,Df:null};var d=b[c];return{qc:Lo(a,null,b,c,d.Ia),Df:d}}Hm.prototype.Ja=function(a,b,c){var d=io(a.C).Ja(this,a,b,c);d||(d=mp.Ja(this,a,b,c));return d};
Hm.prototype.Yb=function(){var a=null,b=null,c,d=0;do{c=d;for(var d=Number.MAX_VALUE,e=this.N.length-1;0<=e&&!b;--e){var a=this.N[e],b=a.f(this,c),f=a.b();f>c&&(d=Math.min(d,f))}}while(d>c&&!b&&this.Fb);return{Ab:b?a:null,w:b}};
...
function xp(a,b,c,d){function e(){return!!d||!c&&!!Sl[m]}function f(){b=q[0]||b;b.A.parentNode.removeChild(b.A);h.g=m}var g=b.J?b.parent&&b.parent.C:b.C;if(g&&!up(g))return M(b);var h=a,l=L("skipEdges"),k=!d&&c&&b&&b.J,m=d,p=null,q=[],r=[],z=!1;Ce(function(a){for(;b;){var d=io(b.C);do if(b.A){if(b.xa&&1!=b.A.nodeType){if(Jk(b.A,b.mc))break;if(!b.J){e()?f():rp(h,p,null,!0,m)?(b=(h.u?p||b:b).modify(),b.wa=!0):(b=b.modify(),b.g=m);Q(a);return}}if(!b.J){if(d&&d.Ue(b))break;b.l&&tp(h,b)&&c&&!h.N.length&&
sp(h,Wk(b),m,!1);if(!up(b.C)||b.C instanceof wp||uo(h,b)||b.H){q.push(Wk(b));m=Ql(m,b.g);if(e())f();else if(rp(h,p,null,!0,m)||!h.Dc.b(b))b=(h.u?p||b:b).modify(),b.wa=!0;Q(a);return}}if(1==b.A.nodeType){var g=b.A.style;if(b.J){if(!(b.xa||d&&d.vf(b,h.u))){if(z){if(e()){f();Q(a);return}q=[];k=c=!1;m=null}z=!1;p=Wk(b);r.push(p);m=Ql(m,b.G);!g||pp(g.paddingBottom)&&pp(g.borderBottomWidth)||(r=[p])}}else{q.push(Wk(b));m=Ql(m,b.g);if(!h.Dc.b(b)&&(rp(h,p,null,!h.u,m),b=b.modify(),b.wa=!0,h.u)){Q(a);return}if(fo[b.A.localName]){e()?
...
function op(a,b){var c=Wk(b),d=L("skipEdges"),e=null,f=!1;Ce(function(d){for(;b;){do if(b.A){if(b.xa&&1!=b.A.nodeType){if(Jk(b.A,b.mc))break;if(!b.J){Sl[e]&&(a.g=e);Q(d);return}}if(!b.J&&(uo(a,b)||b.H)){e=Ql(e,b.g);Sl[e]&&(a.g=e);Q(d);return}if(1==b.A.nodeType){var g=b.A.style;if(b.J){if(f){if(Sl[e]){a.g=e;Q(d);return}e=null}f=!1;e=Ql(e,b.G)}else{e=Ql(e,b.g);if(fo[b.A.localName]){Sl[e]&&(a.g=e);Q(d);return}if(g&&(!pp(g.paddingTop)||!pp(g.borderTopWidth))){Q(d);return}}f=!0}}while(0);g=Dm(a.j,b);if(g.Wa()){g.then(function(a){b=
a;P(d)});return}b=g.get()}c=null;Q(d)}).then(function(){O(d,c)});return d.result()}function Eo(a,b){return Um(b.V)||"footnote"===b.Aa?$o(a,b):Po(a,b)}function yp(a,b,c,d){var e=L("layoutNext");xp(a,b,c,d||null).then(function(d){b=d;!b||a.g||a.u&&b&&b.wa?O(e,b):io(b.C).de(b,a,c).Ma(e)});return e.result()}function ip(a,b,c){if(b)for(var d=b.parent;b;b=d,d=d?d.parent:null)io((d||b).C).wd(a,d,b,c),c=!1}
function To(a){a.Zf=[];x(a.element,"width",a.width+"px");x(a.element,"height",a.height+"px");var b=a.element.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.I+"px";b.style.right=a.X+"px";b.style.bottom=a.P+"px";b.style.left=a.H+"px";a.element.appendChild(b);var c=Hk(a.f,b);a.element.removeChild(b);var b=a.F+a.left+rl(a),d=a.G+a.top+pl(a);a.Yf=new lg(b,d,b+a.width,d+a.height);a.va=c?a.b?c.top:c.left:0;a.ib=c?a.b?c.bottom:c.right:0;a.D=c?a.b?c.right:c.top:0;a.ra=c?a.b?c.left:
c.bottom:0;a.ye=a.D;a.ze=a.D;a.se=a.D;a.ha=a.ra;c=a.Yf;b=a.F+a.left+rl(a);d=a.G+a.top+pl(a);d=new lg(b,d,b+a.width,d+a.height);if(a.Rb){for(var b=d.U,d=d.R,e=[],f=t(a.Rb.b),g=f.next();!g.done;g=f.next())g=g.value,e.push(new mg(g.f+b,g.b+d));b=new rg(e)}else b=ug(d.U,d.R,d.T,d.O);b=[b];d=Sn(a.l);a.Eb=Eg(c,b,a.rb.concat(d),a.Sb,a.b);Ko(a);a.h=0;a.Dd=!1;a.g=null;a.xb=null}function sp(a,b,c,d){var e=Wk(b);b=io(b.C);var f=Gm(a,e);c=b.Ff(e,c,d,a.h+f);a.N.push(c)}
function Qo(a,b){isNaN(b)||(a.h=Math.max(tl(a)*(b-a.D),a.h))}
function Jm(a,b,c,d){a.Zf.push(b);b.f.J&&(a.xb=b.f);if(a.u&&a.Dd)return M(b);if(Zn(a.l,a))return b.f.J&&1===b.f.oa.length?M(null):M(b);var e=L("layout");a.zd(b.f).then(function(b){var f=null;if(b.A)f=Wk(b);else{var h=function(b){b.w.A&&(f=b.w,a.j.removeEventListener("nextInTree",h))};a.j.addEventListener("nextInTree",h)}var l=new zp(c,d);Mm(l,b,a).then(function(b){np(a,b,l.g.Od,f,l.b).then(function(b){var c=null;a.Ed?c=M(null):c=Cp(a,b);c.then(function(){if(Gn(a.l))O(e,null);else if(b){a.Dd=!0;var c=
...
function Dp(a,b,c,d){var e=L("doLayout"),f=null;a.N=[];a.sa=null;Ce(function(e){for(var g={};b;){g.La=!0;yp(a,b,c,d||null).then(function(g){return function(h){c=!1;d=null;a.sa&&a.u?(a.g=null,b=a.sa,b.wa=!0):b=h;Gn(a.l)?Q(e):a.g?Q(e):b&&a.u&&b&&b.wa?(f=b,h=a.Yb(),b=h.w,h.Ab&&h.Ab.u(a),Q(e)):g.La?g.La=!1:P(e)}}(g));if(g.La){g.La=!1;return}g={La:g.La}}a.h+=qo(a);Q(e)}).then(function(){O(e,{w:b,Od:f})});return e.result()}function Ep(a){var b=Un(a.l);0<b&&isFinite(b)&&(a.ef=tl(a)*(b-a.D-a.h))}
function Mo(a){for(;a;){if(a.parentNode===a.ownerDocument)return!1;a=a.parentNode}return!0}function zp(a,b){Lm.call(this);this.$b=a;this.B=b||null;this.l=null;this.b=0;this.j=!1;this.g={Od:null}}v(zp,Lm);n=zp.prototype;n.lf=function(){return new Fp(this.$b,this.B,this.g)};n.$f=function(a,b){b.B=[];b.Ed||(Gp=[])};n.Bd=function(a){for(Lm.prototype.Bd.call(this,a);a;){var b=a.A;b&&vo(b.parentNode,b);a=a.parent}};n.tf=function(a,b){Lm.prototype.tf.call(this,a,b);this.l=b.g;this.b=b.h;this.j=b.Dd};
...
function mq(a,b,c,d,e,f,g){a=a instanceof kq?a:new kq(a,this);gq.call(this,a,b,c,d,e);this.g=this;this.ia=f;this.$=g;this.b.width=new V(Xd,0);this.b.height=new V(Yd,0);this.b["wrap-flow"]=new V(Wc,0);this.b.position=new V(Ed,0);this.b.overflow=new V(Ud,0);this.b.top=new V(new F(-1,"px"),0);this.l={}}v(mq,gq);mq.prototype.h=function(a){return new nq(a,this)};mq.prototype.clone=function(a){a=new mq(this.f,this.name,a.fc||this.fc,this.Na,this.parent,this.ia,this.$);hq(this,a);iq(this,a);return a};
function oq(a,b,c,d,e){gq.call(this,a,b,c,d,e);this.g=e.g;b&&(this.g.l[b]=this.j);this.b["wrap-flow"]=new V(Wc,0)}v(oq,gq);oq.prototype.h=function(a){return new pq(a,this)};oq.prototype.clone=function(a){a=new oq(a.parent.f,this.name,this.fc,this.Na,a.parent);hq(this,a);iq(this,a);return a};function qq(a,b,c,d,e){gq.call(this,a,b,c,d,e);this.g=e.g;b&&(this.g.l[b]=this.j)}v(qq,gq);qq.prototype.h=function(a){return new rq(a,this)};
qq.prototype.clone=function(a){a=new qq(a.parent.f,this.name,this.fc,this.Na,a.parent);hq(this,a);iq(this,a);return a};function Y(a,b,c){return b&&b!==Wc?b.za(a,c):null}function sq(a,b,c){return b&&b!==Wc?b.za(a,c):a.b}function tq(a,b,c){return b?b===Wc?null:b.za(a,c):a.b}function uq(a,b,c,d){return b&&c!==J?b.za(a,d):a.b}function vq(a,b,c){return b?b===Vd?a.j:b===jd?a.h:b.za(a,a.b):c}
function wq(a,b){this.g=a;this.f=b;this.I={};this.style={};this.B=this.D=null;this.children=[];this.N=this.P=this.h=this.j=!1;this.G=this.H=0;this.F=null;this.ra={};this.ha={};this.va=this.Y=this.b=!1;a&&a.children.push(this)}function xq(a){a.H=0;a.G=0}function yq(a,b,c){b=lq(a,b);c=lq(a,c);if(!b||!c)throw Error("E_INTERNAL");return y(a.f.f,b,c)}
...
function Iq(a,b,c){var d=Z(a,b,"snap-height"),e=Z(a,b,"top"),f=Z(a,b,"margin-top"),g=Z(a,b,"padding-top");b=Z(a,b,"border-top-width");c.top=e;c.marginTop=f;c.ga=b;c.Sb=d;!a.b&&0<d&&(a=e+pl(c),a-=Math.floor(a/d)*d,0<a&&(c.yb=d-a,g+=c.yb));c.I=g;x(c.element,"top",e+"px");x(c.element,"margin-top",f+"px");x(c.element,"padding-top",g+"px");x(c.element,"border-top-width",b+"px")}
...
wq.prototype.l=function(a,b){var c=this.I,d=this.f.b,e;for(e in d)Wh(e)&&Xh(c,e,d[e]);if("background-host"==this.f.fc)for(e in b)if(e.match(/^background-/)||"writing-mode"==e)c[e]=b[e];if("layout-host"==this.f.fc)for(e in b)e.match(/^background-/)||"writing-mode"==e||(c[e]=b[e]);vj(a,this.f.Na,null,c);c.content&&(c.content=c.content.Hd(new Zi(a,null,a.xb)));Cq(this,a.l);c=t(this.f.children);for(d=c.next();!d.done;d=c.next())d.value.h(this).l(a,b);Fj(a)};
function Uq(a,b){a.j&&(a.N=Bq(a,"right",a.D,b)||Bq(a,"margin-right",a.D,b)||Bq(a,"border-right-width",a.D,b)||Bq(a,"padding-right",a.D,b));a.h&&(a.P=Bq(a,"top",a.B,b)||Bq(a,"margin-top",a.B,b)||Bq(a,"border-top-width",a.B,b)||Bq(a,"padding-top",a.B,b));for(var c=t(a.children),d=c.next();!d.done;d=c.next())Uq(d.value,b)}function Vq(a){wq.call(this,null,a)}v(Vq,wq);Vq.prototype.l=function(a,b){wq.prototype.l.call(this,a,b);this.children.sort(function(a,b){return b.f.$-a.f.$||a.f.index-b.f.index})};
...
nr.prototype.ra=function(a,b){var c=a.getAttribute("data-adapt-pseudo")||"";this.f[c]||(this.f[c]=!0,(c=b.content)&&El(c)&&c.ca(new Dl(a,this.g,c,this.h)))};function or(a,b,c,d,e,f,g,h,l,k,m,p,q){this.h={};this.H=a;this.b=b;this.viewport=c;this.F=c.b;this.l=d;this.B=cq(d.Ca.b);this.u=e;this.ba=f;this.I=g;this.D=h;this.N=l;this.page=k;this.g=m;this.G=p;this.j=q;this.P=this.w=null;this.f=!1;this.M=null;this.ma=0;this.A=null}v(or,db);
or.prototype.clone=function(){return new or(this.H,this.b,this.viewport,this.l,this.u,this.ba,this.I,this.D,this.N,this.page,this.g,this.G,this.j)};function pr(a,b,c,d){a=a._pseudos;if(!a)return null;var e={},f={},g;for(g in a)f.Xc=e[g]={},Vj(f.Xc,a[g],d),Tj(f.Xc,d,a[g]),Uj(a[g],b,c,function(a){return function(b,c){Vj(a.Xc,c,d);qr(c,function(b){Vj(a.Xc,b,d)})}}(f)),f={Xc:f.Xc};return e}
...
function sr(a,b,c,d,e,f,g,h){var l=L("createShadows"),k=e.template,m;k instanceof Qc?m=rr(a,k.url,2,b,h,null):m=M(null);m.then(function(k){var m=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var p=b.getAttribute("href"),z=null;p?z=h?h.ba:a.ba:h&&(p="http://www.w3.org/1999/xhtml"==h.na.namespaceURI?h.na.getAttribute("href"):h.na.getAttributeNS("http://www.w3.org/1999/xlink","href"),z=h.gd?h.gd.ba:a.ba);p&&(p=Aa(p,z.url),m=rr(a,p,3,b,h,k))}m||(m=M(k));var u=null;
...
"span");mr(A,z)}else A=kr.createElementNS("http://www.pyroxy.com/ns/shadow","content");r.appendChild(A);z.match(/^first-/)&&(r=A)}k=p.length?new Xk(b,q,null,h,k,2,new nr(b,d,f,g,a.B)):k}O(l,k)})});return l.result()}function wo(a,b,c){a.P=b;a.f=c}
function tr(a,b,c,d,e){var f=a.b;d=Sj(d,f,a.u,a.f);b=Qj(d,f,b);c=Rj(d,f,c);Wj(d,e,b,c,function(b,c){var d=c.evaluate(f,b);"font-family"==b&&(d=sm(a.I,d));return d});var g=Ul(e.display||rd,e.position,e["float"],a.M===a.ba.root);["display","position","float"].forEach(function(a){g[a]&&(e[a]=g[a])});return b}
function ur(a,b){for(var c=a.w.M,d=[],e=null,f=a.w.ua,g=-1;c&&1==c.nodeType;){var h=f&&f.root==c;if(!h||2==f.type){var l=(f?f.b:a.l).l(c,!1);d.push(l);e=e||Oa(c)}h?(c=f.na,f=f.gd):(c=c.parentNode,g++)}c=Pb(a.b,"em",!g);c={"font-size":new V(new F(c,"px"),0)};f=new ci(c,a.b);for(g=d.length-1;0<=g;--g){var h=d[g],l=[],k;for(k in h)Dh[k]&&l.push(k);l.sort(ae);for(var l=t(l),m=l.next();!m.done;m=l.next()){m=m.value;f.b=m;var p=h[m];p.value!==qd&&(c[m]=p.Hd(f))}}for(var q in b)Dh[q]||(c[q]=b[q]);return{lang:e,
kb:c}}var vr={a:"a",sub:"sub",sup:"sup",table:"table",tr:"tr",td:"td",th:"th",code:"code",body:"div",p:"p",v:"p",date:"p",emphasis:"em",strong:"strong",style:"span",strikethrough:"del"};function wr(a,b){b=Aa(b,a.ba.url);return a.G[b]||b}function xr(a){a.w.lang=Oa(a.w.M)||a.w.parent&&a.w.parent.lang||a.w.lang}
function yr(a,b){var c=Fh().filter(function(a){return b[a]});if(c.length){var d=a.w.h;if(a.w.parent){var d=a.w.h={},e;for(e in a.w.parent.h)d[e]=a.w.parent.h[e]}c.forEach(function(a){var c=b[a];if(c){if(c instanceof Oc)d[a]=c.K;else if(c instanceof Mc)d[a]=c.name;else if(c instanceof F)switch(c.ka){case "dpi":case "dpcm":case "dppx":d[a]=c.K*Lb[c.ka]}else d[a]=c;delete b[a]}})}}
function zr(a,b,c,d,e,f){for(var g=ee("RESOLVE_FORMATTING_CONTEXT"),h=0;h<g.length;h++){var l=g[h](a,b,c,d,e,f);if(l){a.C=l;break}}}
function Ar(a,b,c){var d=!0,e=L("createElementView"),f=a.M,g=a.w.ua?a.w.ua.b:a.l,h=g.l(f,!1);if(!a.w.ua){var l=ek(a.ba,f);Br(l,a.w.Ra,0)}var k={};a.w.parent||(l=ur(a,h),h=l.kb,a.w.lang=l.lang);var m=h["float-reference"]&&Tm(h["float-reference"].value.toString());a.w.parent&&m&&Um(m)&&(l=ur(a,h),h=l.kb,a.w.lang=l.lang);a.w.b=tr(a,a.w.b,"rtl"===a.w.direction,h,k);g.ra(f,k);yr(a,k);xr(a);k.direction&&(a.w.direction=k.direction.toString());if((l=k["flow-into"])&&l.toString()!=a.H)return O(e,!1),e.result();
var p=k.display;if(p===J)return O(e,!1),e.result();var q=!a.w.parent;a.w.H=p===ld;sr(a,f,q,h,k,g,a.b,a.w.ua).then(function(l){a.w.Ga=l;l=k.position;var r=k["float"],u=k.clear,A=a.w.b?Td:pd,H=a.w.parent?a.w.parent.b?Td:pd:A,E="true"===f.getAttribute("data-vivliostyle-flow-root");a.w.$c=cr(p,l,r,k.overflow,A,H,E);a.w.P=l===Ed||l===Tc||l===kd;!el(a.w)||r===md||m&&Um(m)||(u=r=null);A=r===wd||r===Fd||r===Qd||r===cd||r===ud||r===td||r===ad||r===$c||r===Id||r===md;r&&(delete k["float"],r===md&&(a.f?(A=!1,
...
p?p.toString():"inline";a.w.Aa=A?r.toString():null;a.w.V=m||Zk;a.w.N=k["float-min-wrap-block"]||null;a.w.ga=k["column-span"];if(!a.w.xa){if(u=k["break-after"])a.w.G=u.toString();if(u=k["break-before"])a.w.g=u.toString()}a.w.Y=k["vertical-align"]&&k["vertical-align"].toString()||"baseline";a.w.ha=k["caption-side"]&&k["caption-side"].toString()||"top";u=k["border-collapse"];if(!u||u===D("separate"))if(A=k["border-spacing"])A.Md()?(u=A.values[0],A=A.values[1]):u=A,u.tc()&&(a.w.ra=Sc(u,a.b)),A.tc()&&
(a.w.sa=Sc(A,a.b));a.w.X=k["footnote-policy"];if(u=k["x-first-pseudo"])a.w.f=new Yk(a.w.parent?a.w.parent.f:null,u.K);a.w.xa||Cr(a,f,h,g,a.b);if(u=k["white-space"])u=Ik(u.toString()),null!==u&&(a.w.mc=u);(u=k["hyphenate-character"])&&u!==Wc&&(a.w.F=u.Pc);u=k["overflow-wrap"]||["word-wrap"];a.w.B=k["word-break"]===ed||u===fd;zr(a.w,b,p,l,r,q);a.w.parent&&a.w.parent.C&&(b=a.w.parent.C.af(a.w,b));a.w.xa||(a.w.u=Dr(k),Er(a,f,g));var I=!1,ka=null,Ca=[],Da=f.namespaceURI,N=f.localName;if("http://www.w3.org/1999/xhtml"==
...
(I=!0);var qb;I?qb=a.g(f,a.w.parent?a.w.parent.A:null,k):qb=M(null);qb.then(function(g){g?I&&(d="true"==g.getAttribute("data-adapt-process-children")):g=Fr(a,Da,N);"a"==N&&g.addEventListener("click",a.page.I,!1);ka&&(Yo(a,a.w,"inner",ka),g.appendChild(ka));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&jr(g);var h=a.w.h["image-resolution"],l=[],m=k.width,p=k.height,q=f.getAttribute("width"),r=f.getAttribute("height"),m=m===Wc||!m&&!q,p=p===Wc||!p&&!r;if("http://www.gribuser.ru/xml/fictionbook/2.0"!=
f.namespaceURI||"td"==N){for(var q=f.attributes,u=q.length,r=null,z=0;z<u;z++){var A=q[z],H=A.namespaceURI,E=A.localName,A=A.nodeValue;if(H)if("http://www.w3.org/2000/xmlns/"==H)continue;else"http://www.w3.org/1999/xlink"==H&&"href"==E&&(A=wr(a,A));else{if(E.match(/^on/))continue;if("style"==E)continue;if(("id"==E||"name"==E)&&b){A=a.j.Me(A,a.ba.url);g.setAttribute(E,A);Fk(a.page,g,A);continue}"src"==E||"href"==E||"poster"==E?(A=wr(a,A),"href"===E&&(A=a.j.hc(A,a.ba.url))):"srcset"==E&&(A=A.split(",").map(function(b){return wr(a,
b.trim())}).join(","));if("poster"===E&&"video"===N&&"http://www.w3.org/1999/xhtml"===Da&&m&&p){var qb=new Image,Ap=He(qb,A);Ca.push(Ap);l.push({Mf:qb,element:g,Jf:Ap})}}"http://www.w3.org/2000/svg"==Da&&/^[A-Z\-]+$/.test(E)&&(E=E.toLowerCase());Gr.includes(E.toLowerCase())&&(A=dr(A,a.ba.url,a.j));H&&(qb=ir[H])&&(E=qb+":"+E);"src"!=E||H||"img"!=N&&"input"!=N||"http://www.w3.org/1999/xhtml"!=Da?"href"==E&&"image"==N&&"http://www.w3.org/2000/svg"==Da&&"http://www.w3.org/1999/xlink"==H?a.page.j.push(He(g,
A)):H?g.setAttributeNS(H,E,A):g.setAttribute(E,A):r=A}r&&(qb="input"===N?new Image:g,q=He(qb,r),qb!==g&&(g.src=r),m||p?(m&&p&&h&&1!==h&&l.push({Mf:qb,element:g,Jf:q}),Ca.push(q)):a.page.j.push(q))}delete k.content;(m=k["list-style-image"])&&m instanceof Qc&&(m=m.url,Ca.push(He(new Image,m)));Hr(a,k);Ir(a,g,k);if(!a.w.xa&&(m=null,b?c&&(m=a.w.b?hr:gr):m="clone"!==a.w.h["box-decoration-break"]?a.w.b?fr:er:a.w.b?hr:gr,m))for(var Bp in m)x(g,Bp,m[Bp]);K&&g.setAttribute("value",k["ua-list-item-count"].stringValue());
a.A=g;Ca.length?Ge(Ca).then(function(){0<h&&Jr(a,l,h,k,a.w.b);O(e,d)}):ze().then(function(){O(e,d)})})});return e.result()}function Cr(a,b,c,d,e){var f=pr(c,a.u,a.f,e);f&&f["after-if-continues"]&&f["after-if-continues"].content&&(a.w.I=new Kr(b,new nr(b,c,d,e,a.B)))}var Gr="color-profile clip-path cursor filter marker marker-start marker-end marker-mid fill stroke mask".split(" ");
function Jr(a,b,c,d,e){b.forEach(function(b){if("load"===b.Jf.get().get()){var f=b.Mf,h=f.width/c,f=f.height/c;b=b.element;if(0<h&&0<f)if(d["box-sizing"]===dd&&(d["border-left-style"]!==J&&(h+=Sc(d["border-left-width"],a.b)),d["border-right-style"]!==J&&(h+=Sc(d["border-right-width"],a.b)),d["border-top-style"]!==J&&(f+=Sc(d["border-top-width"],a.b)),d["border-bottom-style"]!==J&&(f+=Sc(d["border-bottom-width"],a.b))),1<c){var l=d["max-width"]||J,k=d["max-height"]||J;l===J&&k===J?x(b,"max-width",
...
function Dr(a){var b=a["repeat-on-break"];return b!==J&&(b===Wc&&(b=a.display===Pd?od:a.display===Od?nd:J),b&&b!==J)?b.toString():null}function Mr(a){var b=L("createTextNodeView");Nr(a).then(function(){var c=a.ma||0,c=Or(a.w.Oa).substr(c);a.A=document.createTextNode(c);O(b,!0)});return b.result()}
function Nr(a){if(a.w.Oa)return M(!0);var b,c=b=a.M.textContent,d=L("preprocessTextContent"),e=ee("PREPROCESS_TEXT_CONTENT"),f=0;Be(function(){return f>=e.length?M(!1):e[f++](a.w,c).fa(function(a){c=a;return M(!0)})}).then(function(){a.w.Oa=Pr(b,c,0);O(d,!0)});return d.result()}
function Qr(a,b,c){var d=L("createNodeView"),e=!0;1==a.M.nodeType?b=Ar(a,b,c):8==a.M.nodeType?(a.A=null,b=M(!0)):b=Mr(a);b.then(function(b){e=b;(a.w.A=a.A)&&(b=a.w.parent?a.w.parent.A:a.P)&&b.appendChild(a.A);O(d,e)});return d.result()}function xo(a,b,c,d){(a.w=b)?(a.M=b.M,a.ma=b.ma):(a.M=null,a.ma=-1);a.A=null;return a.w?Qr(a,c,!!d):M(!0)}
...
function Sr(a){var b=a.Ia+1;if(a.J){if(!a.parent)return null;if(3!=a.hb){var c=a.M.nextSibling;if(c)return a=a.modify(),a.Ia=b,a.M=c,$k(a),Rr(a)}if(a.Da)return a=a.Da.modify(),a.Ia=b,a;a=a.parent.modify()}else{if(a.Ga&&(c=a.Ga.root,2==a.Ga.type&&(c=c.firstChild),c))return b=new Vk(c,a,b),b.ua=a.Ga,b.hb=a.Ga.type,Rr(b);if(c=a.M.firstChild)return Rr(new Vk(c,a,b));1!=a.M.nodeType&&(c=Or(a.Oa),b+=c.length-1-a.ma);a=a.modify()}a.Ia=b;a.J=!0;return a}
function Dm(a,b,c){b=Sr(b);if(!b||b.J)return M(b);var d=L("nextInTree");xo(a,b,!0,c).then(function(c){b.A&&c||(b=b.modify(),b.J=!0,b.A||(b.xa=!0));eb(a,{type:"nextInTree",w:b});O(d,b)});return d.result()}function Tr(a,b){if(b instanceof Fc)for(var c=b.values,d=0;d<c.length;d++)Tr(a,c[d]);else b instanceof Qc&&(c=b.url,a.page.j.push(He(new Image,c)))}
var Ur={"box-decoration-break":!0,"float-min-wrap-block":!0,"float-reference":!0,"flow-into":!0,"flow-linger":!0,"flow-options":!0,"flow-priority":!0,"footnote-policy":!0,page:!0};function Ir(a,b,c){var d=c["background-image"];d&&Tr(a,d);var d=c.position===Ed,e;for(e in c)if(!Ur[e]){var f=c[e],f=f.ca(new Rg(a.ba.url,a.j));f.tc()&&Mb(f.ka)&&(f=new F(Sc(f,a.b),"px"));xk[e]||d&&yk[e]?a.page.u.push(new zk(b,e,f)):x(b,e,f.toString())}}
function Yo(a,b,c,d){if(!b.J){var e=(b.ua?b.ua.b:a.l).l(a.M,!1);if(e=e._pseudos)if(e=e[c])c={},b.b=tr(a,b.b,"rtl"===b.direction,e,c),b=c.content,El(b)&&(b.ca(new Dl(d,a.b,b,a.B)),delete c.content),Ir(a,d,c)}}
...
function es(a){var b={width:Xd,height:Yd,Tb:Zd,Ub:Zd},c=a.size;if(c&&c.value!==Wc){var d=c.value;d.Md()?(c=d.values[0],d=d.values[1]):(c=d,d=null);if(c.tc())b.width=c,b.height=d||c;else if(c=$r[c.name.toLowerCase()])d&&d===vd?(b.width=c.height,b.height=c.width):(b.width=c.width,b.height=c.height)}(c=a.marks)&&c.value!==J&&(b.Ub=ds);a=a.bleed;a&&a.value!==Wc?a.value&&a.value.tc()&&(b.Tb=a.value):c&&(a=!1,c.value.Md()?a=c.value.values.some(function(a){return a===gd}):a=c.value===gd,a&&(b.Tb=new F(6,
"pt")));return b}function fs(a,b){var c={},d=a.Tb.K*Pb(b,a.Tb.ka,!1),e=a.Ub.K*Pb(b,a.Ub.ka,!1),f=d+e,g=a.width;c.cc=g===Xd?b.Z.nc?b.Z.nc.width*Pb(b,"px",!1):(b.Z.tb?Math.floor(b.Pa/2)-b.Z.wc:b.Pa)-2*f:g.K*Pb(b,g.ka,!1);g=a.height;c.bc=g===Yd?b.Z.nc?b.Z.nc.height*Pb(b,"px",!1):b.Fb-2*f:g.K*Pb(b,g.ka,!1);c.Tb=d;c.Ub=e;c.ke=f;return c}function gs(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
function hs(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg",c||"polyline");a.setAttribute("stroke","black");a.setAttribute("stroke-width",b);a.setAttribute("fill","none");return a}var is={fh:"top left",gh:"top right",Sg:"bottom left",Tg:"bottom right"};
...
k.appendChild(l);a=hs(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));k.appendChild(a);b.split(" ").forEach(function(a){k.style[a]=f+"px"});return k}var ks={eh:"top",Rg:"bottom",kg:"left",lg:"right"};
...
ks[a];a===b?h.style[a]=e+"px":a!==k&&(h.style[a]="0",h.style["margin-"+a]="auto")});return h}function ms(a,b,c,d){var e=!1,f=!1;if(a=a.marks)a=a.value,a.Md()?a.values.forEach(function(a){a===gd?e=!0:a===hd&&(f=!0)}):a===gd?e=!0:a===hd&&(f=!0);if(e||f){var g=c.L,h=g.ownerDocument,l=b.Tb,k=Sc(as,d),m=Sc(bs,d),p=Sc(cs,d);e&&Object.keys(is).forEach(function(a){a=js(h,is[a],k,p,l,m);g.appendChild(a)});f&&Object.keys(ks).forEach(function(a){a=ls(h,ks[a],k,p,m);g.appendChild(a)})}}
...
function rs(a,b,c,d){qq.call(this,a,null,null,[],b);this.D=d;this.b["z-index"]=new V(new Oc(0),0);this.b["flow-from"]=new V(D("body"),0);this.b.position=new V(Tc,0);this.b.overflow=new V(Ud,0);for(var e in ns)ns.hasOwnProperty(e)&&(this.b[e]=c[e])}v(rs,qq);rs.prototype.h=function(a){return new vs(a,this)};
...
us.prototype.l=function(a,b){var c=this.I,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}nq.prototype.l.call(this,a,b)};us.prototype.ue=function(){var a=this.style;a.left=Zd;a["margin-left"]=Zd;a["border-left-width"]=Zd;a["padding-left"]=Zd;a["padding-right"]=Zd;a["border-right-width"]=Zd;a["margin-right"]=Zd;a.right=Zd};
us.prototype.ve=function(){var a=this.style;a.top=new F(-1,"px");a["margin-top"]=Zd;a["border-top-width"]=Zd;a["padding-top"]=Zd;a["padding-bottom"]=Zd;a["border-bottom-width"]=Zd;a["margin-bottom"]=Zd;a.bottom=Zd};us.prototype.ga=function(a,b,c){b=b.H;var d={start:this.u.marginLeft,end:this.u.marginRight,ta:this.u.Fc},e={start:this.u.marginTop,end:this.u.marginBottom,ta:this.u.Ec};xs(this,b.top,!0,d,a,c);xs(this,b.bottom,!0,d,a,c);xs(this,b.left,!1,e,a,c);xs(this,b.right,!1,e,a,c)};
function ys(a,b,c,d,e){this.L=a;this.B=e;this.j=c;this.u=!Y(d,b[c?"width":"height"],new rc(d,0,"px"));this.size=null}ys.prototype.b=function(){return this.u};function zs(a){a.size||(a.size=Pn(a.B,a.L.element,a.j?["max-content width","min-content width"]:["max-content height","min-content height"]));return a.size}ys.prototype.g=function(){var a=zs(this);return this.j?rl(this.L)+a["max-content width"]+sl(this.L):pl(this.L)+a["max-content height"]+ql(this.L)};
ys.prototype.h=function(){var a=zs(this);return this.j?rl(this.L)+a["min-content width"]+sl(this.L):pl(this.L)+a["min-content height"]+ql(this.L)};ys.prototype.f=function(){return this.j?rl(this.L)+this.L.width+sl(this.L):pl(this.L)+this.L.height+ql(this.L)};function As(a){this.j=a}As.prototype.b=function(){return this.j.some(function(a){return a.b()})};As.prototype.g=function(){var a=this.j.map(function(a){return a.g()});return Math.max.apply(null,a)*a.length};
As.prototype.h=function(){var a=this.j.map(function(a){return a.h()});return Math.max.apply(null,a)*a.length};As.prototype.f=function(){var a=this.j.map(function(a){return a.f()});return Math.max.apply(null,a)*a.length};function Bs(a,b,c,d,e,f){ys.call(this,a,b,c,d,e);this.l=f}v(Bs,ys);Bs.prototype.b=function(){return!1};Bs.prototype.g=function(){return this.f()};Bs.prototype.h=function(){return this.f()};Bs.prototype.f=function(){return this.j?rl(this.L)+this.l+sl(this.L):pl(this.L)+this.l+ql(this.L)};
...
function Cs(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=Ds(d,g.length?new As(g):null,b);g.wb&&(f.center=g.wb);d=g.wb||d.f();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=Ds(c,e,b),c.wb&&(f.start=c.wb),c.ud&&(f.end=c.ud);return f}
function Ds(a,b,c){var d={wb:null,ud:null};if(a&&b)if(a.b()&&b.b()){var e=a.g(),f=b.g();0<e&&0<f?(f=e+f,f<c?d.wb=c*e/f:(a=a.h(),b=b.h(),b=a+b,b<c?d.wb=a+(c-b)*(e-a)/(f-b):0<b&&(d.wb=c*a/b)),0<d.wb&&(d.ud=c-d.wb)):0<e?d.wb=c:0<f&&(d.ud=c)}else a.b()?d.wb=Math.max(c-b.f(),0):b.b()&&(d.ud=Math.max(c-a.f(),0));else a?a.b()&&(d.wb=c):b&&b.b()&&(d.ud=c);return d}us.prototype.dc=function(a,b,c,d,e){us.ig.dc.call(this,a,b,c,d,e);b.element.setAttribute("data-vivliostyle-page-box",!0)};
function vs(a,b){rq.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.Ec=this.Fc=null}v(vs,rq);
vs.prototype.l=function(a,b){var c=this.I,d;for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(d.match(/^column.*$/)||d.match(/^background-/))&&(c[d]=b[d]);rq.prototype.l.call(this,a,b);d=this.g;c={Fc:this.Fc,Ec:this.Ec,marginTop:this.marginTop,marginRight:this.marginRight,marginBottom:this.marginBottom,marginLeft:this.marginLeft};d.u=c;d=d.style;d.width=new G(c.Fc);d.height=new G(c.Ec);d["padding-left"]=new G(c.marginLeft);d["padding-right"]=new G(c.marginRight);d["padding-top"]=new G(c.marginTop);
d["padding-bottom"]=new G(c.marginBottom)};vs.prototype.ue=function(){var a=Es(this,{start:"left",end:"right",ta:"width"});this.Fc=a.Bf;this.marginLeft=a.Uf;this.marginRight=a.Tf};vs.prototype.ve=function(){var a=Es(this,{start:"top",end:"bottom",ta:"height"});this.Ec=a.Bf;this.marginTop=a.Uf;this.marginBottom=a.Tf};
function Es(a,b){var c=a.style,d=a.f.f,e=b.start,f=b.end,g=b.ta,h=a.f.D[g].za(d,null),l=Y(d,c[g],h),k=Y(d,c["margin-"+e],h),m=Y(d,c["margin-"+f],h),p=sq(d,c["padding-"+e],h),q=sq(d,c["padding-"+f],h),r=uq(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),z=uq(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),u=B(d,h,y(d,y(d,r,p),y(d,z,q)));l?(u=B(d,u,l),k||m?k?m=B(d,u,k):k=B(d,u,m):m=k=zc(d,u,new Gb(d,.5))):(k||(k=d.b),m||(m=d.b),l=B(d,u,y(d,k,m)));c[e]=new G(k);c[f]=new G(m);c["margin-"+e]=
Zd;c["margin-"+f]=Zd;c["padding-"+e]=new G(p);c["padding-"+f]=new G(q);c["border-"+e+"-width"]=new G(r);c["border-"+f+"-width"]=new G(z);c[g]=new G(l);c["max-"+g]=new G(l);return{Bf:B(d,h,y(d,k,m)),Uf:k,Tf:m}}vs.prototype.dc=function(a,b,c,d,e){rq.prototype.dc.call(this,a,b,c,d,e);c.N=b.element};function ws(a,b){rq.call(this,a,b);var c=b.u;this.u=os[c];a.sa[c]=this;this.va=!0}v(ws,rq);n=ws.prototype;
...
function Fs(a,b,c){function d(a){if(u)return u;u={ta:z?z.evaluate(a):null,nb:l?l.evaluate(a):null,ob:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[q,m,p,r].forEach(function(b){b&&(c+=b.evaluate(a))});(null===u.nb||null===u.ob)&&c+u.ta+u.nb+u.ob>b&&(null===u.nb&&(u.nb=0),null===u.ob&&(u.lh=0));null!==u.ta&&null!==u.nb&&null!==u.ob&&(u.ob=null);null===u.ta&&null!==u.nb&&null!==u.ob?u.ta=b-c-u.nb-u.ob:null!==u.ta&&null===u.nb&&null!==u.ob?u.nb=b-c-u.ta-u.ob:null!==u.ta&&null!==u.nb&&null===u.ob?u.ob=
...
f]=new G(new Ib(a,function(){var a=d(this).nb;return null===a?0:a},"margin-"+f));e["margin-"+g]=new G(new Ib(a,function(){var a=d(this).ob;return null===a?0:a},"margin-"+g));"left"===f?e.left=new G(y(a,c.marginLeft,c.Fc)):"top"===f&&(e.top=new G(y(a,c.marginTop,c.Ec)))}n.ue=function(){var a=this.g.u;this.u.Ta?Fs(this,{xe:"right",Ee:"left",ta:"width"},a):this.u.Ua?Fs(this,{xe:"left",Ee:"right",ta:"width"},a):this.Ba({start:"left",end:"right",ta:"width"},a)};
n.ve=function(){var a=this.g.u;this.u.Va?Fs(this,{xe:"bottom",Ee:"top",ta:"height"},a):this.u.Sa?Fs(this,{xe:"top",Ee:"bottom",ta:"height"},a):this.Ba({start:"top",end:"bottom",ta:"height"},a)};n.Id=function(a,b,c,d,e,f,g){rq.prototype.Id.call(this,a,b,c,d,e,f,g);a=c.H;c=this.f.u;d=this.u;d.Ta||d.Ua?d.Va||d.Sa||(d.Ta?a.left[c]=b:d.Ua&&(a.right[c]=b)):d.Va?a.top[c]=b:d.Sa&&(a.bottom[c]=b)};
...
function Is(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof V?""+e.value:Is(a,e);c.push(d+f+(e.ab||""))}return c.sort().join("^")}function Js(a,b,c){c=c.clone({fc:"vivliostyle-page-rule-master"});var d=c.b,e=b.size;if(e){var f=es(b),e=e.ab;d.width=Uh(a.b,d.width,new V(f.width,e));d.height=Uh(a.b,d.height,new V(f.height,e))}["counter-reset","counter-increment"].forEach(function(a){d[a]&&(b[a]=d[a])});c=c.h(a.h);c.l(a.f,a.g);Uq(c,a.b);return c}
function Ks(a){this.b=null;this.h=a}v(Ks,W);Ks.prototype.apply=function(a){a.Y===this.h&&this.b.apply(a)};Ks.prototype.f=function(){return 3};Ks.prototype.g=function(a){this.b&&li(a.fd,this.h,this.b);return!0};function Ls(a){this.b=null;this.h=a}v(Ls,W);Ls.prototype.apply=function(a){1===(new sc(this.h,"page-number")).evaluate(a.l)&&this.b.apply(a)};Ls.prototype.f=function(){return 2};function Ms(a){this.b=null;this.h=a}v(Ms,W);
...
function Ps(a){this.b=null;this.h=a}v(Ps,W);Ps.prototype.apply=function(a){(new sc(this.h,"verso-page")).evaluate(a.l)&&this.b.apply(a)};Ps.prototype.f=function(){return 1};function Qs(a,b){ii.call(this,a,b,null,null,null)}v(Qs,ii);Qs.prototype.apply=function(a){var b=a.l,c=a.F,d=this.style;a=this.$;ai(b,c,d,a,null,null,null);if(d=d._marginBoxes){var c=Yh(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);ai(b,f,d[e],a,null,null,null)}}};
function Rs(a,b,c,d,e){Hj.call(this,a,b,null,c,null,d,!1);this.P=e;this.H=[];this.g="";this.F=[]}v(Rs,Hj);n=Rs.prototype;n.Nc=function(){this.Kb()};n.Ob=function(a,b){if(this.g=b)this.b.push(new Ks(b)),this.$+=65536};
n.hd=function(a,b){b&&Hf(this,"E_INVALID_PAGE_SELECTOR :"+a+"("+b.join("")+")");this.F.push(":"+a);switch(a.toLowerCase()){case "first":this.b.push(new Ls(this.f));this.$+=256;break;case "left":this.b.push(new Ms(this.f));this.$+=1;break;case "right":this.b.push(new Ns(this.f));this.$+=1;break;case "recto":this.b.push(new Os(this.f));this.$+=1;break;case "verso":this.b.push(new Ps(this.f));this.$+=1;break;default:Hf(this,"E_INVALID_PAGE_SELECTOR :"+a)}};
function Ss(a){var b;a.g||a.F.length?b=[a.g].concat(a.F.sort()):b=null;a.H.push({mf:b,$:a.$});a.g="";a.F=[]}n.Lc=function(){Ss(this);Hj.prototype.Lc.call(this)};n.Ha=function(){Ss(this);Hj.prototype.Ha.call(this)};
n.Jb=function(a,b,c){if("bleed"!==a&&"marks"!==a||this.H.some(function(a){return!a.mf})){Hj.prototype.Jb.call(this,a,b,c);var d=this.kb[a],e=this.P;if("bleed"===a||"marks"===a)e[""]||(e[""]={}),Object.keys(e).forEach(function(b){Xh(e[b],a,d)});else if("size"===a){var f=e[""];this.H.forEach(function(b){var c=new V(d.value,d.ab+b.$);b=b.mf?b.mf.join(""):"";var g=e[b];g?(c=(b=g[a])?Uh(null,c,b):c,Xh(g,a,c)):(g=e[b]={},Xh(g,a,c),f&&["bleed","marks"].forEach(function(a){f[a]&&Xh(g,a,f[a])},this))},this)}}};
n.Pf=function(a){li(this.l.fd,"*",a)};n.Sf=function(a){return new Qs(this.kb,a)};n.Le=function(a){var b=Yh(this.kb,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);Df(this.na,new Ts(this.f,this.na,this.B,c))};function Ts(a,b,c,d){Ef.call(this,a,b,!1);this.g=c;this.b=d}v(Ts,Ff);Ts.prototype.Ib=function(a,b,c){Bh(this.g,a,b,c,this)};Ts.prototype.bd=function(a,b){Gf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Ts.prototype.$d=function(a,b){Gf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
Ts.prototype.Jb=function(a,b,c){Xh(this.b,a,new V(b,c?Af(this):Bf(this)))};function Us(a){if(1>=a.length)return!1;var b=a[a.length-1].h;return a.slice(0,a.length-1).every(function(a){return b>a.h})}function Vs(a,b){a.b?a.width=b:a.height=b}function Ws(a){return a.b?a.width:a.height}function Xs(a,b){this.dd=a;this.Mc=b}function Ys(a,b,c){this.b=a;this.F=b;this.B=c;this.f=Ws(a)}
function Zs(a,b){var c=L("ColumnBalancer#balanceColumns");a.u(b);$s(a,b);zl(a.b);var d=[at(a,b)];Ce(function(b){a.l(d)?(a.D(d),a.F().then(function(c){$s(a,c);zl(a.b);c?(d.push(at(a,c)),P(b)):Q(b)})):Q(b)}).then(function(){var b=d.reduce(function(a,b){return b.Mc<a.Mc?b:a},d[0]);bt(a,b.dd);Vs(a.b,a.f);O(c,b.dd)});return c.result()}function at(a,b){var c=a.j(b);return new Xs(b,c)}Ys.prototype.u=function(){};function $s(a,b){var c=En(a.B);b&&(b.pg=c)}
function bt(a,b){var c=a.b.element;b.Bb.forEach(function(a){c.appendChild(a.element)});Fn(a.B,b.pg)}function ct(a){var b=a[a.length-1];if(!b.Mc||(a=a[a.length-2])&&b.Mc>=a.Mc)return!1;a=b.dd.Bb;b=Math.max.apply(null,a.map(function(a){return a.h}));a=Math.max.apply(null,a.map(function(a){return $n(a.l)}));return b>a+1}function dt(a,b){var c=Math.max.apply(null,a[a.length-1].dd.Bb.map(function(a){return isNaN(a.ef)?a.h:a.h-a.ef+1}))-1;c<Ws(b)?Vs(b,c):Vs(b,Ws(b)-1)}
...
et.prototype.l=function(a){if(1===a.length)return!0;if(this.g)return ct(a);a=a[a.length-1];return ft(this,a.dd.position)&&!Us(a.dd.Bb)?this.g=!0:Ws(this.b)<this.f};et.prototype.D=function(a){this.g?dt(a,this.b):Vs(this.b,Math.min(this.f,Ws(this.b)+.1*this.f))};function gt(a,b,c){Ys.call(this,c,a,b)}v(gt,Ys);gt.prototype.j=function(a){if(a.Bb.every(function(a){return!a.h}))return Infinity;a=a.Bb.filter(function(a){return!a.g}).map(function(a){return a.h});return ht(a)};gt.prototype.l=function(a){return ct(a)};
gt.prototype.D=function(a){dt(a,this.b)};function it(a,b,c,d,e,f,g){if(b===Wc)return null;f=f[f.length-1];f=!(!f||!f.g);return!g.b.length||f?new et(c,d,e,a):b===Yc?new gt(c,d,e):null};var jt=new Ee(function(){var a=L("uaStylesheetBase");Ch.get().then(function(b){var c=Aa("user-agent-base.css",za);b=new Hj(null,null,null,null,null,b,!0);b.Oc("UA");Gj=b.l;gg(c,b,null,null).Ma(a)});return a.result()},"uaStylesheetBaseFetcher");
function kt(a,b,c,d,e,f,g,h,l,k){this.j=a;this.f=b;this.b=c;this.g=d;this.H=e;this.D=f;this.B=a.P;this.F=g;this.h=h;this.u=l;this.G=k;this.l=a.l;Kb(this.b,function(a){var b=this.b,c;c=(c=b.b[a])?(c=c.b[0])?c.pa:null:null;var d;d=b.b[a];if(d=lt(this,d?d.g:"any"))d=(a=b.b[a])?0<a.b.length&&a.b[0].pa.f<=this.D:!1;return d&&!!c&&!mt(this,c)});Jb(this.b,new Ib(this.b,function(){return this.ga+this.b.page},"page-number"))}
function nt(a,b,c,d,e){if(a.u.length){var f=new Nb(0,b,c,d);a=a.u;for(var g={},h=0;h<a.length;h++)ai(f,g,a[h],0,null,null,null);h=g.width;a=g.height;var l=g["text-zoom"];if(h&&a||l)if(g=Lb.em,(l?l.evaluate(f,"text-zoom"):null)===Hd&&(l=g/d,d=g,b*=l,c*=l),h&&a&&(h=Sc(h.evaluate(f,"width"),f),f=Sc(a.evaluate(f,"height"),f),0<h&&0<f))return{width:e&&e.tb?2*(h+e.wc):h,height:f,fontSize:d}}return{width:b,height:c,fontSize:d}}
function ot(a,b,c,d,e,f,g,h,l,k,m,p){Nb.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.ba=b;this.lang=b.lang||c;this.viewport=d;this.l={body:!0};this.g=e;this.B=this.b=this.I=this.f=this.F=null;this.D=0;this.yb=f;this.j=new rm(this.style.B);this.va={};this.Y=null;this.h=m;this.Eb=new an(null,null,null,null,null,null,null);this.X={};this.G=p||null;this.ib=g;this.xb=h;this.ga=l;this.rb=k;for(var q in a.h)(b=a.h[q]["flow-consume"])&&(b.evaluate(this,"flow-consume")==Uc?this.l[q]=!0:delete this.l[q]);
this.Ca={};this.ra=this.ha=0}v(ot,Nb);
function pt(a){var b=L("StyleInstance.init"),c=new Op(a.h,a.ba.url),d=new Pp(a.h,a.ba.url,a.style.f,a.style.b);a.f=new Zl(a.ba,a.style.g,a.style.f,a,a.l,a.style.l,c,d);d.h=a.f;im(a.f,a);a.I={};a.I[a.ba.url]=a.f;var e=fm(a.f);a.G||(a.G=Zr(e));a.F=new Vq(a.style.H);c=new pj(a.style.g,a,c,d);a.F.l(c,e);Uq(a.F,a);a.Y=new Gs(c,a.style.b,a.F,a,e);e=[];c=t(a.style.D);for(d=c.next();!d.done;d=c.next())if(d=d.value,!d.ia||d.ia.evaluate(a))d=om(d.xc,a),d=new pm(d),e.push(d);xm(a.yb,e,a.j).Ma(b);var f=a.style.G;
Object.keys(f).forEach(function(a){var b=fs(es(f[a]),this);this.Ca[a]={width:b.cc+2*b.ke,height:b.bc+2*b.ke}},a);return b.result()}function jm(a,b,c){if(a=a.b)a.f[b.b]||(a.f[b.b]=c),c=a.b[b.b],c||(c=new kl,a.b[b.b]=c),c.b.push(new jl(new hl({oa:[{node:b.element,hb:Tk,ua:null,Ga:null,Da:null,Ra:0}],ma:0,J:!1,Oa:null}),b))}
function qt(a,b){for(var c=Number.POSITIVE_INFINITY,d=0;d<b.b.length;d++){for(var e=b.b[d].b.f,f=e.oa[0].node,g=e.ma,h=e.J,l=0;f.ownerDocument!=a.ba.b;)l++,f=e.oa[l].node,h=!1,g=0;e=fk(a.ba,f,g,h);e<c&&(c=e)}return c}
function rt(a,b,c){if(!b)return 0;var d=Number.POSITIVE_INFINITY,e;for(e in a.l){var f=b.b[e];if(!(c||f&&f.b.length)&&a.b){f=a.f;f.P=e;for(var g=0;null!=f.P&&(g+=5E3,gm(f,g,0)!=Number.POSITIVE_INFINITY););f=a.b.b[e];b!=a.b&&f&&(f=f.clone(),b.b[e]=f)}f&&(f=qt(a,f),f<d&&(d=f))}return d}function lt(a,b){switch(b){case "left":case "right":case "recto":case "verso":return(new sc(a.style.b,b+"-page")).evaluate(a);default:return!0}}
function st(a,b){var c=a.b,d=rt(a,c);if(d==Number.POSITIVE_INFINITY)return null;for(var e=a.F.children,f,g=0;g<e.length;g++)if(f=e[g],"vivliostyle-page-rule-master"!==f.f.fc){var h=1,l=Eq(f,a,"utilization");l&&l.cf()&&(h=l.K);var l=Pb(a,"em",!1),k=a.cc()*a.bc();a.D=gm(a.f,d,Math.ceil(h*k/(l*l)));h=a;l=void 0;for(l in c.b)if((k=c.b[l])&&0<k.b.length){var m=k.b[0].pa;if(qt(h,k)===m.f){a:switch(m=k.g,m){case "left":case "right":case "recto":case "verso":break a;default:m=null}k.g=zm(Ql(m,k.b[0].pa.g))}}a.B=
c.clone();h=a;l=h.b.page;k=void 0;for(k in h.b.b)for(var m=h.b.b[k],p=m.b.length-1;0<=p;p--){var q=m.b[p];0>q.pa.ub&&q.pa.f<h.D&&(q.pa.ub=l)}Ob(a,a.style.b);h=Eq(f,a,"enabled");if(!h||h===Vd){c=a;w.debug("Location - page",c.b.page);w.debug("  current:",d);w.debug("  lookup:",c.D);d=void 0;for(d in c.b.b)for(e=t(c.b.b[d].b),g=e.next();!g.done;g=e.next())w.debug("  Chunk",d+":",g.value.pa.f);d=a.Y;e=f;f=b;c=e.f;Object.keys(f).length?(e=c,g=Is(d,f),e=e.j+"^"+g,g=d.j[e],g||("background-host"===c.fc?(c=
d,f=(new qs(c.l,c.h.f,f)).h(c.h),f.l(c.f,c.g),Uq(f,c.b),g=f):g=Js(d,f,c),d.j[e]=g),f=g.f,f.f.g=f,f=g):(c.f.g=c,f=e);return f}}throw Error("No enabled page masters");}function mt(a,b){var c=a.B.f,d=c[b.b].f;if(d){var e=b.f,f=c[d].b;if(!f.length||e<f[0])return!1;var c=Xa(f.length,function(a){return f[a]>e})-1,c=f[c],d=a.B.b[d],g=qt(a,d);return c<g?!1:g<c?!0:!lt(a,d.g)}return!1}function tt(a,b,c){a=a.b.f[c];a.C||(a.C=new to(null));b.ff=a.C}
function ut(a){var b=a.l,c=un(b),d=L("layoutDeferredPageFloats"),e=!1,f=0;Ce(function(d){if(f===c.length)Q(d);else{var g=c[f++],l=g.ja,k=jn(l),m=k.sf(l,b);m&&Zm(m,l)?P(d):kn(b,l)||wn(b,l)?(vn(b,g),Q(d)):Vo(a,g,k,null,m).then(function(a){a?(a=Gn(b.parent))?Q(d):(Gn(b)&&!a&&(e=!0,b.Kc=!1),P(d)):Q(d)})}}).then(function(){e&&mn(b);O(d,!0)});return d.result()}
function vt(a,b,c){var d=a.b.b[c];if(!d||!lt(a,d.g))return M(!0);d.g="any";tt(a,b,c);To(b);a.l[c]&&0<b.Eb.length&&(b.Fb=!1);var e=L("layoutColumn");ut(b).then(function(){if(Gn(b.l))O(e,!0);else{var f=[],g=[],h=!0;Ce(function(e){if(!qn(b.l,c))for(var k={};0<d.b.length-g.length;){for(k.index=0;g.includes(k.index);)k.index++;k.selected=d.b[k.index];if(k.selected.pa.f>a.D||mt(a,k.selected.pa))break;for(var l=k.index+1;l<d.b.length;l++)if(!g.includes(l)){var p=d.b[l];if(p.pa.f>a.D||mt(a,p.pa))break;Mk(p.pa,
k.selected.pa)&&(k.selected=p,k.index=l)}k.pa=k.selected.pa;k.La=!0;Jm(b,k.selected.b,h,d.f).then(function(a){return function(c){if(Gn(b.l))Q(e);else if(h=!1,a.selected.pa.u&&(null===c||a.pa.h)&&f.push(a.index),a.pa.h)g.push(a.index),Q(e);else{var k=!!c||!!b.g,l;0<xn(b.l).length&&b.xb?c?(l=c.clone(),l.f=b.xb):l=new hl(b.xb):l=null;if(b.g&&l)a.selected.b=l,d.f=b.g,b.g=null;else{g.push(a.index);if(c||l)a.selected.b=c||l,f.push(a.index);b.g&&(d.g=zm(b.g))}k?Q(e):(b.Fb=!1,a.La?a.La=!1:P(e))}}}(k));if(k.La){k.La=
!1;return}k={selected:k.selected,pa:k.pa,index:k.index,La:k.La}}Q(e)}).then(function(){if(!Gn(b.l)){d.b=d.b.filter(function(a,b){return f.includes(b)||!g.includes(b)});"column"===d.f&&(d.f=null);Ep(b);var a=Tn(b.l);Qo(b,a)}O(e,!0)})}});return e.result()}
function wt(a,b,c,d,e,f,g,h,l,k,m,p,q,r,z){var u=b.b?b.j&&b.N:b.h&&b.P,A=f.element,H=new an(l,"column",null,h,null,null,null),E=a.b.clone(),K=L("createAndLayoutColumn"),I;Ce(function(b){var K=new jo([new eq(a.h,a.b.page-1)].concat(Xn(H)));if(1<k){var ka=a.viewport.b.createElement("div");x(ka,"position","absolute");A.appendChild(ka);I=new Hm(ka,r,a.g,K,H);I.Fb=z;I.b=f.b;I.Sb=f.Sb;I.Jd=f.Jd;f.b?(K=g*(p+m)+f.I,wl(I,f.H,f.width),vl(I,K,p)):(K=g*(p+m)+f.H,vl(I,f.I,f.height),wl(I,K,p));I.F=c;I.G=d}else I=
new Hm(A,r,a.g,K,H),ul(I,f);I.rb=u?[]:e.concat();I.Rb=q;en(H,I);0<=I.width?vt(a,I,h).then(function(){Gn(H)||Cn(H);Gn(I.l)&&!Gn(l)?(I.l.Kc=!1,a.b=E.clone(),I.element!==A&&A.removeChild(I.element),P(b)):Q(b)}):(Cn(H),Q(b))}).then(function(){O(K,I)});return K.result()}function xt(a,b,c,d,e){var f=Eq(c,a,"writing-mode")||null;a=Eq(c,a,"direction")||null;return new an(b,"region",d,e,null,f,a)}
function yt(a,b,c,d,e,f,g,h,l,k){function m(){p.b=q.clone();return zt(p,b,c,d,e,f,g,r,h,l,k,z).fa(function(a){return a?M({Bb:a,position:p.b}):M(null)})}var p=a,q=p.b.clone(),r=xt(p,g,c,h,l),z=!0;return m().fa(function(a){if(!a)return M(null);if(1>=k)return M(a.Bb);var b=Eq(c,p,"column-fill")||Xc,b=it(k,b,m,r,h,a.Bb,p.b.b[l]);if(!b)return M(a.Bb);z=!1;g.g=!0;r.g=!0;return Zs(b,a).fa(function(a){g.g=!1;g.Kc=!1;r.g=!1;p.b=a.position;return M(a.Bb)})})}
function zt(a,b,c,d,e,f,g,h,l,k,m,p){var q=L("layoutFlowColumns"),r=a.b.clone(),z=Z(c,a,"column-gap"),u=1<m?Z(c,a,"column-width"):l.width,A=Dq(c,a),H=Eq(c,a,"shape-inside"),E=Og(H,0,0,l.width,l.height,a),K=new or(k,a,a.viewport,a.f,A,a.ba,a.j,a.style.F,a,b,a.ib,a.xb,a.rb),I=0,ka=null,Ca=[];Ce(function(b){wt(a,c,d,e,f,l,I++,k,h,m,z,u,E,K,p).then(function(c){Gn(g)?(Ca=null,Q(b)):((c.g&&"column"!==c.g||I===m)&&!Gn(h)&&Cn(h),Gn(h)?(I=0,a.b=r.clone(),h.Kc=!1,h.g?(Ca=null,Q(b)):P(b)):(ka=c,Ca[I-1]=ka,ka.g&&
"column"!=ka.g&&(I=m,"region"!=ka.g&&(a.X[k]=!0)),I<m?P(b):Q(b)))})}).then(function(){O(q,Ca)});return q.result()}
function At(a,b,c,d,e,f,g,h){xq(c);var l=Eq(c,a,"enabled");if(l&&l!==Vd)return M(!0);var k=L("layoutContainer"),m=Eq(c,a,"wrap-flow")===Wc,l=Eq(c,a,"flow-from"),p=a.viewport.b.createElement("div"),q=Eq(c,a,"position");x(p,"position",q?q.name:"absolute");d.insertBefore(p,d.firstChild);var r=new ol(p);r.b=c.b;r.rb=g;c.dc(a,r,b,a.j,a.g);r.F=e;r.G=f;e+=r.left+r.marginLeft+r.Y;f+=r.top+r.marginTop+r.ga;(c instanceof vs||c instanceof nq&&!(c instanceof us))&&en(h,r);var z=!1;if(l&&l.Qf())if(a.X[l.toString()])Gn(h)||
c.Id(a,r,b,null,1,a.g,a.j),l=M(!0);else{var u=L("layoutContainer.inner"),A=l.toString(),H=Z(c,a,"column-count");yt(a,b,c,e,f,g,h,r,A,H).then(function(d){if(!Gn(h)){var e=d[0];e.element===p&&(r=e);r.h=Math.max.apply(null,d.map(function(a){return a.h}));c.Id(a,r,b,e,H,a.g,a.j);(d=a.b.b[A])&&"region"===d.f&&(d.f=null)}O(u,!0)});l=u.result()}else{if((l=Eq(c,a,"content"))&&El(l)){q="span";l.url&&(q="img");var E=a.viewport.b.createElement(q);l.ca(new Dl(E,a,l,cq(a.h)));p.appendChild(E);"img"==q&&Tq(c,a,
E,a.j);Sq(c,a,r,a.j)}else c.va&&(d.removeChild(p),z=!0);z||c.Id(a,r,b,null,1,a.g,a.j);l=M(!0)}l.then(function(){if(Gn(h))O(k,!0);else{if(!c.h||0<Math.floor(r.h)){if(!z&&!m){var l=Eq(c,a,"shape-outside"),l=Bl(r,l,a);g.push(l)}}else if(!c.children.length){d.removeChild(p);O(k,!0);return}var q=c.children.length-1;Be(function(){for(;0<=q;){var d=c.children[q--],d=At(a,b,d,p,e,f,g,h);if(d.Wa())return d.fa(function(){return M(!Gn(h))});if(Gn(h))break}return M(!1)}).then(function(){O(k,!0)})}});return k.result()}
function Bt(a){var b=a.b.page,c;for(c in a.b.b)for(var d=a.b.b[c],e=d.b.length-1;0<=e;e--){var f=d.b[e];0<=f.pa.ub&&f.pa.ub+f.pa.l-1<=b&&d.b.splice(e,1)}}function Ct(a,b){for(var c in a.l){var d=b.b[c];if(d&&0<d.b.length)return!1}return!0}
function Dt(a,b,c){a.X={};c?(a.b=c.clone(),bm(a.f,c.g)):(a.b=new ml,bm(a.f,-1));a.lang&&b.g.setAttribute("lang",a.lang);c=a.b;c.page++;Ob(a,a.style.b);a.B=c.clone();var d=Hs(a.Y),e=st(a,d);if(!e)return M(null);Dk(b,e.f.b.width.value===Xd);Ek(b,e.f.b.height.value===Yd);a.h.j=b;Yp(a.h,d,a);var f=fs(es(d),a);Et(a,f,b);ms(d,f,b,a);var g=f.Ub+f.Tb,d=Eq(e,a,"writing-mode")||pd,f=Eq(e,a,"direction")||zd,h=new an(a.Eb,"page",null,null,null,d,f),l=L("layoutNextPage");Ce(function(c){At(a,b,e,b.g,g,g+1,[],h).then(function(){Gn(h)||
Cn(h);Gn(h)?(a.b=a.B.clone(),h.Kc=!1,P(c)):Q(c)})}).then(function(){e.ga(a,b,a.g);var d=new sc(e.f.f,"left-page");b.l=d.evaluate(a)?"left":"right";Bt(a);c=a.b;Object.keys(c.b).forEach(function(b){b=c.b[b];var d=b.f;!d||"page"!==d&&lt(a,d)||(b.f=null)});a.b=a.B=null;c.g=a.f.b;Gk(b,a.style.j.N[a.ba.url],a.g);Ct(a,c)&&(c=null);O(l,c)});return l.result()}
function Et(a,b,c){a.P=b.cc;a.N=b.bc;a.ra=b.cc+2*b.ke;a.ha=b.bc+2*b.ke;c.L.style.width=a.ra+"px";c.L.style.height=a.ha+"px";c.g.style.left=b.Ub+"px";c.g.style.right=b.Ub+"px";c.g.style.top=b.Ub+"px";c.g.style.bottom=b.Ub+"px";c.g.style.padding=b.Tb+"px";c.g.style.paddingTop=b.Tb+1+"px"}function Ft(a,b,c,d){Hj.call(this,a.j,a,b,c,d,a.h,!c);this.g=a;this.F=!1}v(Ft,Hj);n=Ft.prototype;n.Xd=function(){};
n.Wd=function(a,b,c){a=new mq(this.g.u,a,b,c,this.g.G,this.ia,Bf(this.na));Df(this.g,new $q(a.f,this.g,a,this.B))};n.zc=function(a){a=a.Gc;this.ia&&(a=yc(this.f,this.ia,a));Df(this.g,new Ft(this.g,a,this,this.G))};n.Td=function(){Df(this.g,new Nj(this.f,this.na))};n.Vd=function(){var a={};this.g.B.push({xc:a,ia:this.ia});Df(this.g,new Oj(this.f,this.na,null,a,this.g.h))};n.Ud=function(a){var b=this.g.l[a];b||(b={},this.g.l[a]=b);Df(this.g,new Oj(this.f,this.na,null,b,this.g.h))};
n.Zd=function(){var a={};this.g.H.push(a);Df(this.g,new Oj(this.f,this.na,this.ia,a,this.g.h))};n.md=function(a){var b=this.g.D;if(a){var c=Yh(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Df(this.g,new Oj(this.f,this.na,null,b,this.g.h))};n.Yd=function(){this.F=!0;this.Kb()};n.Nc=function(){var a=new Rs(this.g.u,this.g,this,this.B,this.g.F);Df(this.g,a);a.Nc()};
n.Ha=function(){Hj.prototype.Ha.call(this);if(this.F){this.F=!1;var a="R"+this.g.N++,b=D(a),c;this.ia?c=new Th(b,0,this.ia):c=new V(b,0);$h(this.kb,"region-id").push(c);this.Xb();a=new Ft(this.g,this.ia,this,a);Df(this.g,a);a.Ha()}};
function Gt(a){var b=a.getAttribute("content");if(!b)return"";a={};for(var c;c=b.match(/^,?\s*([-A-Za-z_.][-A-Za-z_0-9.]*)\s*=\s*([-+A-Za-z_0-9.]*)\s*/);)b=b.substr(c[0].length),a[c[1]]=c[2];b=a.width-0;a=a.height-0;return b&&a?"@-epubx-viewport{width:"+b+"px;height:"+a+"px;}":""}function Ht(a){Cf.call(this);this.h=a;this.j=new Fb(null);this.u=new Fb(this.j);this.G=new jq(this.j);this.I=new Ft(this,null,null,null);this.N=0;this.B=[];this.D={};this.l={};this.H=[];this.F={};this.b=this.I}v(Ht,Cf);
Ht.prototype.error=function(a){w.b("CSS parser:",a)};function It(a,b){return Jt(b,a)}function Kt(a){vf.call(this,It,"document");this.P=a;this.H={};this.u={};this.f={};this.N={};this.l=null;this.b=[];this.I=!1}v(Kt,vf);function Lt(a,b,c){Mt(a,b,c);var d=Aa("user-agent.xml",za),e=L("OPSDocStore.init");Ch.get().then(function(b){a.l=b;jt.get().then(function(){a.load(d).then(function(){a.I=!0;O(e,!0)})})});return e.result()}function Mt(a,b,c){a.b.splice(0);b&&b.forEach(a.X,a);c&&c.forEach(a.Y,a)}
Kt.prototype.X=function(a){var b=a.url;b&&(b=Aa(b,ya));this.b.push({url:b,text:a.text,mb:"Author",Na:null,media:null})};Kt.prototype.Y=function(a){var b=a.url;b&&(b=Aa(b,ya));this.b.push({url:b,text:a.text,mb:"User",Na:null,media:null})};
function Jt(a,b){var c=L("OPSDocStore.load"),d=b.url;nk(b,a).then(function(b){if(b){if(a.I)for(var e=ee("PREPROCESS_SINGLE_DOCUMENT"),g=0;g<e.length;g++)try{e[g](b.b)}catch(u){w.b("Error during single document preprocessing:",u)}for(var e=[],h=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),g=0;g<h.length;g++){var l=h[g],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=l.getAttribute("action"),
l=l.getAttribute("ref");k&&m&&p&&l&&e.push({Cg:k,event:m,action:p,kd:l})}a.N[d]=e;var q=[];q.push({url:Aa("user-agent-page.css",za),text:null,mb:"UA",Na:null,media:null});if(g=b.l)for(g=g.firstChild;g;g=g.nextSibling)if(1==g.nodeType)if(e=g,h=e.namespaceURI,k=e.localName,"http://www.w3.org/1999/xhtml"==h)if("style"==k)q.push({url:d,text:e.textContent,mb:"Author",Na:null,media:null});else if("link"==k){if(m=e.getAttribute("rel"),h=e.getAttribute("class"),k=e.getAttribute("media"),"stylesheet"==m||
"alternate stylesheet"==m&&h)m=e.getAttribute("href"),m=Aa(m,d),e=e.getAttribute("title"),q.push({url:m,text:null,Na:e?h:null,media:k,mb:"Author"})}else"meta"==k&&"viewport"==e.getAttribute("name")&&q.push({url:d,text:Gt(e),mb:"Author",Na:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==h?"stylesheet"==k&&"text/css"==e.getAttribute("type")&&q.push({url:d,text:e.textContent,mb:"Author",Na:null,media:null}):"http://example.com/sse"==h&&"property"===k&&(h=e.getElementsByTagName("name")[0])&&
"stylesheet"===h.textContent&&(e=e.getElementsByTagName("value")[0])&&(m=Aa(e.textContent,d),q.push({url:m,text:null,Na:null,media:null,mb:"Author"}));for(g=0;g<a.b.length;g++)q.push(a.b[g]);for(var r="",g=0;g<q.length;g++)r+=q[g].url,r+="^",q[g].text&&(r+=q[g].text),r+="^";var z=a.H[r];z?(a.f[d]=z,O(c,b)):(g=a.u[r],g||(g=new Ee(function(){var b=L("fetchStylesheet"),c=0,d=new Ht(a.l);Be(function(){if(c<q.length){var a=q[c++];d.Oc(a.mb);return null!==a.text?hg(a.text,d,a.url,a.Na,a.media).Bc(!0):gg(a.url,
d,a.Na,a.media)}return M(!1)}).then(function(){z=new kt(a,d.j,d.u,d.I.l,d.G,d.B,d.D,d.l,d.H,d.F);a.H[r]=z;delete a.u[r];O(b,z)});return b.result()},"FetchStylesheet "+d),a.u[r]=g,g.start()),g.get().then(function(e){a.f[d]=e;O(c,b)}))}else O(c,null)});return c.result()};function Nt(a){return String.fromCharCode(a>>>24&255,a>>>16&255,a>>>8&255,a&255)}
...
Rt.prototype.Sd=function(a,b,c,d,e){if(this.page)return M(this.page);var f=this,g=L("showTOC"),h=new Ck(a,a);this.page=h;this.b.load(this.url).then(function(d){var k=f.b.f[d.url],l=nt(k,c,1E5,e);b=new Xr(b.window,l.fontSize,b.root,l.width,l.height);var p=new ot(k,d,f.lang,b,f.f,f.l,f.Ae(d),f.j,0,f.h,f.g);f.fb=p;p.Z=f.Z;pt(p).then(function(){Dt(p,h,null).then(function(){St(f,a,2);O(g,h)})})});return g.result()};
Rt.prototype.Ld=function(){if(this.page){var a=this.page;this.fb=this.page=null;x(a.L,"visibility","none");var b=a.L.parentNode;b&&b.removeChild(a.L)}};Rt.prototype.df=function(){return!!this.page};function Ut(){Kt.call(this,Vt(this));this.g=new vf(nk,"document");this.F=new vf(xf,"text");this.G={};this.ha={};this.B={};this.D={}}v(Ut,Kt);function Vt(a){return function(b){return a.B[b]}}
function Wt(a,b,c){var d=L("loadEPUBDoc");"/"!==b.substring(b.length-1)&&(b+="/");c&&a.F.fetch(b+"?r=list");a.g.fetch(b+"META-INF/encryption.xml");var e=b+"META-INF/container.xml";a.g.load(e,!0,"Failed to fetch EPUB container.xml from "+e).then(function(f){if(f){f=wk(ck(ck(ck(new dk([f.b]),"container"),"rootfiles"),"rootfile"),"full-path");f=t(f);for(var g=f.next();!g.done;g=f.next())if(g=g.value){Xt(a,b,g,c).Ma(d);return}O(d,null)}else w.error("Received an empty response for EPUB container.xml "+
...
function $t(a,b,c){var d=L("EPUBDocStore.load");b=xa(b);(a.D[b]=Jt(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,Rd:null})).Ma(d);return d.result()}
Ut.prototype.load=function(a){var b=xa(a);if(a=this.D[b])return a.Wa()?a:M(a.get());var c=L("EPUBDocStore.load");a=Ut.ig.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?O(c,a):w.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return c.result()};function au(){this.id=null;this.src="";this.h=this.f=null;this.S=-1;this.l=0;this.u=null;this.b=this.g=0;this.yc=this.ub=null;this.j=$a}
...
var du={dcterms:"http://purl.org/dc/terms/",marc:"http://id.loc.gov/vocabulary/",media:"http://www.idpf.org/epub/vocab/overlays/#",onix:"http://www.editeur.org/ONIX/book/codelists/current.html#",xsd:"http://www.w3.org/2001/XMLSchema#"},eu=du.dcterms+"language",fu=du.dcterms+"title";
function gu(a,b){var c={};return function(d,e){var f,g,h=d.r||c,l=e.r||c;if(a==fu&&(f="main"==h["http://idpf.org/epub/vocab/package/#title-type"],g="main"==l["http://idpf.org/epub/vocab/package/#title-type"],f!=g))return f?-1:1;f=parseInt(h["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(f)&&(f=Number.MAX_VALUE);g=parseInt(l["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(g)&&(g=Number.MAX_VALUE);return f!=g?f-g:a!=eu&&b&&(f=(h[eu]||h["http://idpf.org/epub/vocab/package/#alternate-script"])==
b,g=(l[eu]||l["http://idpf.org/epub/vocab/package/#alternate-script"])==b,f!=g)?f?-1:1:d.o-e.o}}
function hu(a,b){function c(a){for(var b in a){var d=a[b];d.sort(gu(b,k));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return cb(a,function(a){return bb(a,function(a){var b={v:a.value,o:a.order};a.mh&&(b.s=a.scheme);if(a.id||a.lang){var c=l[a.id];if(c||a.lang)a.lang&&(a={name:eu,value:a.lang,lang:null,id:null,Je:a.id,scheme:null,order:a.order},c?c.push(a):c=[a]),c=ab(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=
a[1]?f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in du)f[g]=du[g];for(;g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/);)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=du;var h=1;g=uk(vk(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),order:h++,Je:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:du.dcterms+a.localName,order:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Je:null,scheme:null};return null});var l=ab(g,function(a){return a.Je});g=d(ab(g,function(a){return a.Je?null:a.name}));var k=null;g[eu]&&(k=g[eu][0].v);c(g);return g}function iu(){var a=window.MathJax;return a?a.Hub:null}var ju={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function Yt(a,b){this.h=a;this.l=this.f=this.b=this.j=this.g=null;this.D=b;this.B=null;this.P={};this.lang=null;this.G=0;this.I={};this.X=this.N=this.Y=null;this.H={};this.F=null;this.u=ku(this);iu()&&(Gh["http://www.w3.org/1998/Math/MathML"]=!0)}
function ku(a){function b(){}b.prototype.Me=function(a,b){return"viv-id-"+Ea(b+(a?"#"+a:""),":")};b.prototype.hc=function(b,d){var c=b.match(/^([^#]*)#?(.*)$/);if(c){var f=c[1]||d,c=c[2];if(f&&a.j.some(function(a){return a.src===f}))return"#"+this.Me(c,f)}return b};b.prototype.Fg=function(a){"#"===a.charAt(0)&&(a=a.substring(1));a.indexOf("viv-id-")||(a=a.substring(7));return(a=Va(a).match(/^([^#]*)#?(.*)$/))?[a[1],a[2]]:[]};return new b}
function lu(a,b){return a.D?b.substr(0,a.D.length)==a.D?decodeURI(b.substr(a.D.length)):null:b}
function Zt(a,b,c,d,e){a.g=b;var f=ck(new dk([b.b]),"package"),g=wk(f,"unique-identifier")[0];g&&(g=jk(b,b.url+"#"+g))&&(a.B=g.textContent.replace(/[ \n\r\t]/g,""));var h={};a.j=bb(ck(ck(f,"manifest"),"item").W,function(c){var d=new au,e=b.url;d.id=c.getAttribute("id");d.src=Aa(c.getAttribute("href"),e);d.f=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.j=f}(c=c.getAttribute("fallback"))&&!ju[d.f]&&(h[d.src]=c);!a.N&&d.j.nav&&
(a.N=d);!a.X&&d.j["cover-image"]&&(a.X=d);return d});a.f=Za(a.j,bu);a.l=Za(a.j,function(b){return lu(a,b.src)});for(var l in h)for(g=l;;){g=a.f[h[g]];if(!g)break;if(ju[g.f]){a.H[l]=g.src;break}g=g.src}a.b=bb(ck(ck(f,"spine"),"itemref").W,function(b,c){var d=b.getAttribute("idref");if(d=a.f[d])d.h=b,d.S=c;return d});if(l=wk(ck(f,"spine"),"toc")[0])a.Y=a.f[l];if(l=wk(ck(f,"spine"),"page-progression-direction")[0]){a:switch(l){case "ltr":l="ltr";break a;case "rtl":l="rtl";break a;default:throw Error("unknown PageProgression: "+
l);}a.F=l}var g=c?wk(ck(ck(sk(ck(ck(new dk([c.b]),"encryption"),"EncryptedData"),rk()),"CipherData"),"CipherReference"),"URI"):[],k=ck(ck(f,"bindings"),"mediaType").W;for(c=0;c<k.length;c++){var m=k[c].getAttribute("handler");(l=k[c].getAttribute("media-type"))&&m&&a.f[m]&&(a.P[l]=a.f[m].src)}a.I=hu(ck(f,"metadata"),wk(f,"prefix")[0]);a.I[eu]&&(a.lang=a.I[eu][0].v);if(!d){if(0<g.length&&a.B)for(d=cu(a.B),c=0;c<g.length;c++)a.h.B[a.D+g[c]]=d;return M(!0)}f=new Pa;k={};if(0<g.length&&a.B)for(l="1040:"+
Qt(a.B),c=0;c<g.length;c++)k[g[c]]=l;for(c=0;c<d.length;c++){var p=d[c];if(m=p.n){var q=decodeURI(m),g=a.l[q];l=null;g&&(g.u=0!=p.m,g.l=p.c,g.f&&(l=g.f.replace(/\s+/g,"")));g=k[q];if(l||g)f.append(m),f.append(" "),f.append(l||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}mu(a);return sf(e,"","POST",f.toString(),"text/plain")}function mu(a){for(var b=0,c=t(a.b),d=c.next();!d.done;d=c.next()){var d=d.value,e=Math.ceil(d.l/1024);d.g=b;d.b=e;b+=e}a.G=b}
function nu(a,b,c){a.f={};a.l={};a.j=[];a.b=a.j;var d=a.g=new bk(null,"",(new DOMParser).parseFromString("<spine></spine>","text/xml"));b.forEach(function(a){var b=new au;b.S=a.index;b.id="item"+(a.index+1);b.src=a.url;b.ub=a.ub;b.yc=a.yc;var c=d.b.createElement("itemref");c.setAttribute("idref",b.id);d.root.appendChild(c);b.h=c;this.f[b.id]=b;this.l[a.url]=b;this.j.push(b)},a);return c?$t(a.h,b[0].url,c):M(null)}
function ou(a,b,c){var d=a.b[b],e=L("getCFI");a.h.load(d.src).then(function(a){var b=hk(a,c),f=null;b&&(a=fk(a,b,0,!1),f=new sb,vb(f,b,c-a),d.h&&vb(f,d.h,0),f=f.toString());O(e,f)});return e.result()}
function pu(a,b){return ke("resolveFragment",function(c){if(b){var d=new sb;tb(d,b);var e;if(a.g){var f=ub(d,a.g.b);if(1!=f.node.nodeType||f.J||!f.kd){O(c,null);return}var g=f.node,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.f[h]){O(c,null);return}e=a.f[h];d=f.kd}else e=a.b[0];a.h.load(e.src).then(function(a){var b=ub(d,a.b);a=fk(a,b.node,b.offset,b.J);O(c,{S:e.S,Ka:a,aa:-1})})}else O(c,null)},function(a,d){w.b(d,"Cannot resolve fragment:",b);O(a,null)})}
function qu(a,b){return ke("resolveEPage",function(c){if(0>=b)O(c,{S:0,Ka:0,aa:-1});else{var d=Xa(a.b.length,function(c){c=a.b[c];return c.g+c.b>b}),e=a.b[d];a.h.load(e.src).then(function(a){b-=e.g;b>e.b&&(b=e.b);var f=0;0<b&&(a=gk(a),f=Math.round(a*b/e.b),f==a&&f--);O(c,{S:d,Ka:f,aa:-1})})}},function(a,d){w.b(d,"Cannot resolve epage:",b);O(a,null)})}
function ru(a,b){var c=a.b[b.S];if(0>=b.Ka)return M(c.g);var d=L("getEPage");a.h.load(c.src).then(function(a){a=gk(a);O(d,c.g+Math.min(a,b.Ka)*c.b/a)});return d.result()}function su(a,b){return{page:a,position:{S:a.S,aa:b,Ka:a.offset}}}function tu(a,b,c,d,e){this.b=a;this.viewport=b;this.j=c;this.u=e;this.gc=[];this.l=[];this.Z=xb(d);this.h=new Vr(b);this.f=new Wp(a.u)}function uu(a,b){var c=a.gc[b.S];return c?c.pb[b.aa]:null}n=tu.prototype;
n.Zb=function(a){return this.b.F?this.b.F:(a=this.gc[a?a.S:0])?a.fb.G:null};
function vu(a,b,c,d){c.L.style.display="none";c.L.style.visibility="visible";c.L.style.position="";c.L.style.top="";c.L.style.left="";c.L.setAttribute("data-vivliostyle-page-side",c.l);var e=b.pb[d];c.G=!b.item.S&&!d;b.pb[d]=c;e?(b.fb.viewport.f.replaceChild(c.L,e.L),eb(e,{type:"replaced",target:null,currentTarget:null,Wf:c})):b.fb.viewport.f.appendChild(c.L);a.u({width:b.fb.ra,height:b.fb.ha},b.fb.Ca,b.item.S,b.fb.ga+d)}
function wu(a,b,c){var d=L("renderSinglePage"),e=xu(a,b,c);Dt(b.fb,e,c).then(function(f){var g=(c=f)?c.page-1:b.gb.length-1;vu(a,b,e,g);$p(a.f,e.S,g);f=null;if(c){var h=b.gb[c.page];b.gb[c.page]=c;h&&b.pb[c.page]&&(nl(c,h)||(f=wu(a,b,c)))}f||(f=M(!0));f.then(function(){var f=aq(a.f,e),h=0;Ce(function(b){h++;if(h>f.length)Q(b);else{var c=f[h-1];c.Qd=c.Qd.filter(function(a){return!a.ld});c.Qd.length?yu(a,c.S).then(function(d){d?(Zp(a.f,c.Fe),bq(a.f,c.Qd),wu(a,d,d.gb[c.aa]).then(function(c){var d=a.f;
d.b=d.F.pop();d=a.f;d.g=d.H.pop();d=c.Pd.position;d.S===e.S&&d.aa===g&&(e=c.Pd.page);P(b)})):P(b)}):P(b)}}).then(function(){e.B=!c&&b.item.S===a.b.b.length-1;e.B&&dq(a.f,a.viewport);O(d,{Pd:su(e,g),Xf:c})})})});return d.result()}function zu(a,b){var c=a.aa,d=-1;0>c&&(d=a.Ka,c=Xa(b.gb.length,function(a){return rt(b.fb,b.gb[a],!0)>d}),c=c===b.gb.length?b.complete?b.gb.length-1:Number.POSITIVE_INFINITY:c-1);return{S:a.S,aa:c,Ka:d}}
function Au(a,b,c){var d=L("findPage");yu(a,b.S).then(function(e){if(e){var f=null,g;Ce(function(d){var h=zu(b,e);g=h.aa;(f=e.pb[g])?Q(d):e.complete?(g=e.gb.length-1,f=e.pb[g],Q(d)):c?Bu(a,h).then(function(a){a&&(f=a.page);Q(d)}):Ae(100).then(function(){P(d)})}).then(function(){O(d,su(f,g))})}else O(d,null)});return d.result()}
function Bu(a,b){var c=L("renderPage");yu(a,b.S).then(function(d){if(d){var e=zu(b,d),f=e.aa,g=e.Ka,h=d.pb[f];h?O(c,su(h,f)):Ce(function(b){if(f<d.gb.length)Q(b);else if(d.complete)f=d.gb.length-1,Q(b);else{var c=d.gb[d.gb.length-1];wu(a,d,c).then(function(a){var e=a.Pd.page;(c=a.Xf)?0<=g&&rt(d.fb,c)>g?(h=e,f=d.gb.length-2,Q(b)):P(b):(h=e,f=a.Pd.position.aa,d.complete=!0,Q(b))})}}).then(function(){h=h||d.pb[f];var b=d.gb[f];h?O(c,su(h,f)):wu(a,d,b).then(function(a){a.Xf||(d.complete=!0);O(c,a.Pd)})})}else O(c,
null)});return c.result()}n.Ke=function(){return Cu(this,{S:this.b.b.length-1,aa:Number.POSITIVE_INFINITY,Ka:-1})};function Cu(a,b){var c=L("renderAllPages");b||(b={S:0,aa:0,Ka:0});var d=b.S,e=b.aa,f=0,g;Ce(function(c){Bu(a,{S:f,aa:f===d?e:Number.POSITIVE_INFINITY,Ka:f===d?b.Ka:-1}).then(function(a){g=a;++f>d?Q(c):P(c)})}).then(function(){O(c,g)});return c.result()}n.sg=function(){return Au(this,{S:0,aa:0,Ka:-1})};n.vg=function(){return Au(this,{S:this.b.b.length-1,aa:Number.POSITIVE_INFINITY,Ka:-1})};
n.nextPage=function(a,b){var c=this,d=a.S,e=a.aa,f=L("nextPage");yu(c,d).then(function(a){if(a){if(a.complete&&e==a.gb.length-1){if(d>=c.b.b.length-1){O(f,null);return}d++;e=0}else e++;Au(c,{S:d,aa:e,Ka:-1},b).Ma(f)}else O(f,null)});return f.result()};n.Ie=function(a){var b=a.S;if(a=a.aa)a--;else{if(!b)return M(null);b--;a=Number.POSITIVE_INFINITY}return Au(this,{S:b,aa:a,Ka:-1})};function Du(a,b,c){b="left"===b.l;a="ltr"===a.Zb(c);return!b&&a||b&&!a}
function Eu(a,b,c){var d=L("getCurrentSpread"),e=uu(a,b);if(!e)return M({left:null,right:null});var f="left"===e.l;(Du(a,e,b)?a.Ie(b):a.nextPage(b,c)).then(function(a){a=a&&a.page;f?O(d,{left:e,right:a}):O(d,{left:a,right:e})});return d.result()}n.Bg=function(a,b){var c=uu(this,a);if(!c)return M(null);var c=Du(this,c,a),d=this.nextPage(a,!!b);if(c)return d;var e=this;return d.fa(function(a){return a?e.nextPage(a.position,!!b):M(null)})};
n.Eg=function(a){var b=uu(this,a);if(!b)return M(null);b=Du(this,b,a);a=this.Ie(a);if(b){var c=this;return a.fa(function(a){return a?c.Ie(a.position):M(null)})}return a};n.gf=function(a){if(1>a)return M(null);for(var b=0,c=-1,d=0,e=t(this.gc),f=e.next();!f.done;f=e.next()){var f=f.value,g=a-b-1;if(g<f.pb.length){c=g;break}b+=f.pb.length;d++}return-1===c?M(null):Au(this,{S:d,aa:c,Ka:-1})};
function Fu(a,b){var c=L("navigateToEPage");qu(a.b,b).then(function(b){b?Au(a,b).Ma(c):O(c,null)});return c.result()}function Gu(a,b){var c=L("navigateToCFI");pu(a.b,b).then(function(b){b?Au(a,b).Ma(c):O(c,null)});return c.result()}
function Hu(a,b,c){w.debug("Navigate to",b);var d=lu(a.b,xa(b));if(!d){if(a.b.g&&b.match(/^#epubcfi\(/))d=lu(a.b,a.b.g.url);else if("#"===b.charAt(0)){var e=a.b.u.Fg(b);a.b.g?d=lu(a.b,e[0]):d=e[0];b=e[0]+(e[1]?"#"+e[1]:"")}if(null==d)return M(null)}var f=a.b.l[d];if(!f)return a.b.g&&d==lu(a.b,a.b.g.url)&&(d=b.indexOf("#"),0<=d)?Gu(a,b.substr(d+1)):M(null);var g=L("navigateTo");yu(a,f.S).then(function(d){var e=jk(d.ba,b);e?Au(a,{S:f.S,aa:-1,Ka:ek(d.ba,e)}).Ma(g):c.S!==f.S?Au(a,{S:f.S,aa:0,Ka:-1}).Ma(g):
O(g,null)});return g.result()}
function xu(a,b,c){var d=b.fb.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.style.position="absolute";e.style.top="0";e.style.left="0";Xj||(e.style.visibility="hidden");d.h.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);var g=new Ck(e,f);g.S=b.item.S;g.position=c;g.offset=rt(b.fb,c);g.offset||(b=a.b.u.Me("",b.item.src),f.setAttribute("id",b),Fk(g,f,b));d!==a.viewport&&(a=ig(null,new of(Ab(a.viewport.width,
a.viewport.height,d.width,d.height),null)),g.u.push(new zk(e,"transform",a)));return g}function Iu(a,b,c,d){var e=iu();if(e){var f=d.ownerDocument,g=f.createElement("span");d.appendChild(g);c=f.importNode(c,!0);Ju(a,c,b);g.appendChild(c);a=e.queue;a.Push(["Typeset",e,g]);var e=L("makeMathJaxView"),h=ue(e);a.Push(function(){h.qb(g)});return e.result()}return M(null)}
function Ju(a,b,c){if(b){if(1===b.nodeType&&"mglyph"===b.tagName)for(var d=t(b.attributes),e=d.next();!e.done;e=d.next())if(e=e.value,"src"===e.name){var f=Aa(e.nodeValue,c.url);e.namespaceURI?b.setAttributeNS(e.namespaceURI,e.name,f):b.setAttribute(e.name,f)}b.firstChild&&Ju(a,b.firstChild,c);b.nextSibling&&Ju(a,b.nextSibling,c)}}
n.Ae=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=Aa(f,a.url),g=c.getAttribute("media-type");if(!g){var h=lu(b.b,f);h&&(h=b.b.l[h])&&(g=h.f)}if(g&&(h=b.b.P[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Ta(f),l=Ta(g),g=new Pa;g.append(h);g.append("?src=");g.append(f);g.append("&type=");g.append(l);for(h=c.firstChild;h;h=h.nextSibling)1==h.nodeType&&
...
c.namespaceURI)e=Iu(b,a,c,d);else if("http://example.com/sse"==c.namespaceURI){e=d?d.ownerDocument:b.viewport.b;g=c.localName;switch(g){case "t":case "tab":case "ec":case "nt":case "fraction":case "comment":case "mark":g="span";break;case "ruby":case "rp":case "rt":break;default:g="div"}e=e.createElement(g);e.setAttribute("data-adapt-process-children","true");e=M(e)}else e=c.dataset&&"true"==c.dataset.mathTypeset?Iu(b,a,c,d):M(null);return e}};
function yu(a,b){if(b>=a.b.b.length)return M(null);var c=a.gc[b];if(c)return M(c);var d=L("getPageViewItem"),e=a.l[b];if(e){var f=ue(d);e.push(f);return d.result()}var e=a.l[b]=[],g=a.b.b[b],h=a.b.h;h.load(g.src).then(function(f){g.b||1!=a.b.b.length||(g.b=Math.ceil(gk(f)/2700),a.b.G=g.b);var k=h.f[f.url],l=a.Ae(f),p=a.viewport,q=nt(k,p.width,p.height,p.fontSize,a.Z);if(q.width!=p.width||q.height!=p.height||q.fontSize!=p.fontSize)p=new Xr(p.window,q.fontSize,p.root,q.width,q.height);q=a.gc[b-1];null!==
g.ub?q=g.ub-1:(q=q?q.fb.ga+q.pb.length:0,null!==g.yc&&(q+=g.yc));Xp(a.f,q);var r=new ot(k,f,a.b.lang,p,a.h,a.j,l,a.b.H,q,a.b.u,a.f,a.b.F);r.Z=a.Z;pt(r).then(function(){c={item:g,ba:f,fb:r,gb:[null],pb:[],complete:!1};a.gc[b]=c;O(d,c);e.forEach(function(a){a.qb(c)})})});return d.result()}function Ku(a){for(var b=t(a.gc),c=b.next();!c.done;c=b.next())(c=c.value)&&c.pb.splice(0);for(a=a.viewport.root;a.lastChild;)a.removeChild(a.lastChild)}
function Lu(a){return a.gc.some(function(a){return a&&0<a.pb.length})}
n.Sd=function(){var a=this.b,b=a.N||a.Y;if(!b)return M(null);var c=L("showTOC");this.g||(this.g=new Rt(a.h,b.src,a.lang,this.h,this.j,this.Z,this,a.H,a.u,this.f));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background=
"#EEE";e.style.border="1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.g.Sd(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";O(c,a)});return c.result()};n.Ld=function(){this.g&&this.g.Ld()};n.df=function(){return this.g&&this.g.df()};var Mu={$g:"singlePage",ah:"spread",Qg:"autoSpread"};
function Nu(a,b,c,d){var e=this;this.window=a;this.ae=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);Xj&&b.setAttribute("data-vivliostyle-debug",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Pa=c;this.Ca=d;a=a.document;this.sa=new tm(a.head,b);this.B="loading";this.N=[];this.h=null;this.ac=this.Xa=!1;this.f=this.j=this.g=this.D=null;this.fontSize=16;this.zoom=1;this.F=!1;this.X="singlePage";this.ha=!1;this.Ke=!0;this.Z=wb();this.ga=[];this.I=function(){};this.l=function(){};
this.Y=function(){e.Xa=!0;e.I()};this.Ge=this.Ge.bind(this);this.G=function(){};this.H=a.getElementById("vivliostyle-page-rules");this.P=!1;this.u=null;this.ra={loadEPUB:this.mg,loadXML:this.ng,configure:this.Ve,moveTo:this.va,toc:this.Sd};Ou(this)}function Ou(a){wa(1,function(b){Pu(a,{t:"debug",content:b})});wa(2,function(b){Pu(a,{t:"info",content:b})});wa(3,function(b){Pu(a,{t:"warn",content:b})});wa(4,function(b){Pu(a,{t:"error",content:b})})}function Pu(a,b){b.i=a.Pa;a.Ca(b)}
function Qu(a,b){a.B!==b&&(a.B=b,a.ae.setAttribute("data-vivliostyle-viewer-status",b),Pu(a,{t:"readystatechange"}))}n=Nu.prototype;n.mg=function(a){Ru.f("beforeRender");Qu(this,"loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=L("loadEPUB"),h=this;h.Ve(a).then(function(){var a=new Ut;Lt(a,e,f).then(function(){var e=Aa(b,h.window.location.href);h.N=[e];Wt(a,e,d).then(function(a){h.h=a;Su(h,c).then(function(){O(g,!0)})})})});return g.result()};
n.ng=function(a){Ru.f("beforeRender");Qu(this,"loading");var b=a.url,c=a.document,d=a.fragment,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=L("loadXML"),h=this;h.Ve(a).then(function(){var a=new Ut;Lt(a,e,f).then(function(){var e=b.map(function(a,b){return{url:Aa(a.url,h.window.location.href),index:b,ub:a.ub,yc:a.yc}});h.N=e.map(function(a){return a.url});h.h=new Yt(a,"");nu(h.h,e,c).then(function(){Su(h,d).then(function(){O(g,!0)})})})});return g.result()};
function Su(a,b){Tu(a);var c;b?c=pu(a.h,b).fa(function(b){a.f=b;return M(!0)}):c=M(!0);return c.fa(function(){Ru.b("beforeRender");return Uu(a)})}function Vu(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d)return c*Lb.ex*a.fontSize/Lb.em;if(d=Lb[d])return c*d}return c}
n.Ve=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.D=null,this.window.addEventListener("resize",this.Y,!1),this.Xa=!0):this.window.removeEventListener("resize",this.Y,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.Xa=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:Vu(this,b["margin-left"])||0,marginRight:Vu(this,b["margin-right"])||0,marginTop:Vu(this,b["margin-top"])||0,marginBottom:Vu(this,b["margin-bottom"])||
0,width:Vu(this,b.width)||0,height:Vu(this,b.height)||0},200<=b.width||200<=b.height)&&(this.window.removeEventListener("resize",this.Y,!1),this.D=b,this.Xa=!0);"boolean"==typeof a.hyphenate&&(this.Z.re=a.hyphenate,this.Xa=!0);"boolean"==typeof a.horizontal&&(this.Z.qe=a.horizontal,this.Xa=!0);"boolean"==typeof a.nightMode&&(this.Z.Ce=a.nightMode,this.Xa=!0);"number"==typeof a.lineHeight&&(this.Z.lineHeight=a.lineHeight,this.Xa=!0);"number"==typeof a.columnWidth&&(this.Z.je=a.columnWidth,this.Xa=
!0);"string"==typeof a.fontFamily&&(this.Z.fontFamily=a.fontFamily,this.Xa=!0);"boolean"==typeof a.load&&(this.ha=a.load);"boolean"==typeof a.renderAllPages&&(this.Ke=a.renderAllPages);"string"==typeof a.userAgentRootURL&&(ya=a.userAgentRootURL.replace(/resources\/?$/,""),za=a.userAgentRootURL);"string"==typeof a.rootURL&&(ya=a.rootURL,za=ya+"resources/");"string"==typeof a.pageViewMode&&a.pageViewMode!==this.X&&(this.X=a.pageViewMode,this.Xa=!0);"number"==typeof a.pageBorder&&a.pageBorder!==this.Z.wc&&
(this.viewport=null,this.Z.wc=a.pageBorder,this.Xa=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=a.zoom,this.ac=!0);"boolean"==typeof a.fitToScreen&&a.fitToScreen!==this.F&&(this.F=a.fitToScreen,this.ac=!0);"object"==typeof a.defaultPaperSize&&"number"==typeof a.defaultPaperSize.width&&"number"==typeof a.defaultPaperSize.height&&(this.viewport=null,this.Z.nc=a.defaultPaperSize,this.Xa=!0);Wu(this,a);return M(!0)};
function Wu(a,b){ee("CONFIGURATION").forEach(function(c){c=c(b);a.Xa=c.Xa||a.Xa;a.ac=c.ac||a.ac})}n.Ge=function(a){var b=this.g,c=this.j,d=a.target;c?c.left!==d&&c.right!==d||Xu(this,a.Wf):b===a.target&&Xu(this,a.Wf)};function Yu(a,b){var c=[];a.g&&c.push(a.g);a.j&&(c.push(a.j.left),c.push(a.j.right));c.forEach(function(a){a&&b(a)})}function Zu(a){Yu(a,function(b){b.removeEventListener("hyperlink",a.G,!1);b.removeEventListener("replaced",a.Ge,!1)})}
function $u(a){Zu(a);Yu(a,function(a){x(a.L,"display","none")});a.g=null;a.j=null}function av(a,b){b.addEventListener("hyperlink",a.G,!1);b.addEventListener("replaced",a.Ge,!1);x(b.L,"visibility","visible");x(b.L,"display","block")}function bv(a,b){$u(a);a.g=b;av(a,b)}function cv(a){var b=L("reportPosition");ou(a.h,a.f.S,a.f.Ka).then(function(c){var d=a.g;(a.ha&&0<d.j.length?Ge(d.j):M(!0)).then(function(){dv(a,d,c).Ma(b)})});return b.result()}
function ev(a){var b=a.ae;if(a.D){var c=a.D;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new Xr(a.window,a.fontSize,b,c.width,c.height)}return new Xr(a.window,a.fontSize,b)}
function fv(a){var b=ev(a),c;a:switch(a.X){case "singlePage":c=!1;break a;case "spread":c=!0;break a;default:c=1.45<=b.width/b.height&&800<b.width}var d=a.Z.tb!==c;a.Z.tb=c;a.ae.setAttribute("data-vivliostyle-spread-view",c);if(a.D||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;if(!d&&b.width==a.viewport.width&&b.height==a.viewport.height||!d&&b.width==a.viewport.width&&b.height!=a.viewport.height&&/Android|iPhone|iPad|iPod/.test(navigator.userAgent))return!0;if(c=a.b&&Lu(a.b)){a:{c=t(a.b.gc);
for(d=c.next();!d.done;d=c.next())if(d=d.value)for(var d=t(d.pb),e=d.next();!e.done;e=d.next())if(e=e.value,e.F&&e.D){c=!0;break a}c=!1}c=!c}return c?(a.viewport.width=b.width,a.viewport.height=b.height,a.ac=!0):!1}n.Gg=function(a,b,c,d){this.ga[d]=a;gv(this,b)};function gv(a,b){if(!a.P&&a.H){var c="";Object.keys(b).forEach(function(a){c+="@page "+a+"{margin:0;size:";a=b[a];c+=a.width+"px "+a.height+"px;}"});a.H.textContent=c;a.P=!0}}function hv(a){a.H&&(a.H.textContent="",a.P=!1)}
function Xu(a,b,c){a.ac=!1;Zu(a);if(a.Z.tb)return Eu(a.b,a.f,c).fa(function(c){$u(a);a.j=c;c.left&&(av(a,c.left),c.right||c.left.L.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(av(a,c.right),c.left||c.right.L.setAttribute("data-vivliostyle-unpaired-page",!0));c=iv(a,c);a.viewport.zoom(c.width,c.height,a.F?jv(a,c):a.zoom);a.g=b;return M(null)});bv(a,b);a.viewport.zoom(b.f.width,b.f.height,a.F?jv(a,b.f):a.zoom);a.g=b;return M(null)}
function iv(a,b){var c=0,d=0;b.left&&(c+=b.left.f.width,d=b.left.f.height);b.right&&(c+=b.right.f.width,d=Math.max(d,b.right.f.height));b.left&&b.right&&(c+=2*a.Z.wc);return{width:c,height:d}}var kv={Vg:"fit inside viewport"};function jv(a,b){return Math.min(a.viewport.width/b.width,a.viewport.height/b.height)}function lv(){this.name="RenderingCanceledError";this.message="Page rendering has been canceled";this.stack=Error().stack}v(lv,Error);
function Tu(a){if(a.u){var b=a.u;le(b,new lv);if(b!==fe&&b.b){b.b.g=!0;var c=new ve(b);b.l="interrupt";b.b=c;b.f.qb(c)}}a.u=null}
function Uu(a){a.Xa=!1;a.ac=!1;if(fv(a))return M(!0);Qu(a,"loading");Tu(a);var b=ne(fe.f,function(){return ke("resize",function(c){a.u=b;Ru.f("render (resize)");a.b&&(a.b.Ld(),Ku(a.b));hv(a);a.viewport=ev(a);Yr(a.viewport);a.b=new tu(a.h,a.viewport,a.sa,a.Z,a.Gg.bind(a));a.f&&(a.f.aa=-1);Cu(a.b,a.f).then(function(d){a.f=d.position;Xu(a,d.page,!0).then(function(){cv(a).then(function(d){Qu(a,"interactive");(a.Ke?a.b.Ke():M(null)).then(function(){a.u===b&&(a.u=null);Ru.b("render (resize)");Qu(a,"complete");
Pu(a,{t:"loaded"});O(c,d)})})})})},function(a,b){if(b instanceof lv)Ru.b("render (resize)"),w.debug(b.message);else throw b;})});return M(!0)}function dv(a,b,c){var d=L("sendLocationNotification"),e={t:"nav",first:b.G,last:b.B};ru(a.h,a.f).then(function(b){e.epage=b;e.epageCount=a.h.G;c&&(e.cfi=c);Pu(a,e);O(d,!0)});return d.result()}Nu.prototype.Zb=function(){return this.b?this.b.Zb(this.f):null};
Nu.prototype.va=function(a){var b=this;"complete"!==this.B&&Qu(this,"loading");if("string"==typeof a.where){switch(a.where){case "next":a=this.Z.tb?this.b.Bg:this.b.nextPage;break;case "previous":a=this.Z.tb?this.b.Eg:this.b.Ie;break;case "last":a=this.b.vg;break;case "first":a=this.b.sg;break;default:return M(!0)}if(a){var c=a;a=function(){return c.call(b.b,b.f)}}}else if("number"==typeof a.nthPage){var d=a.nthPage;a=function(){return b.b.gf(d,b.f)}}else if("number"==typeof a.epage){var e=a.epage;
a=function(){return Fu(b.b,e)}}else if("string"==typeof a.url){var f=a.url;a=function(){return Hu(b.b,f,b.f)}}else return M(!0);var g=L("moveTo");a.call(b.b).then(function(a){var c;if(a){b.f=a.position;var d=L("moveTo.showCurrent");c=d.result();Xu(b,a.page).then(function(){cv(b).Ma(d)})}else c=M(!0);c.then(function(a){"loading"===b.B&&Qu(b,"interactive");O(g,a)})});return g.result()};
Nu.prototype.Sd=function(a){var b=!!a.autohide;a=a.v;var c=this.b.df();if(c){if("show"==a)return M(!0)}else if("hide"==a)return M(!0);if(c)return this.b.Ld(),M(!0);var d=this,e=L("showTOC");this.b.Sd(b).then(function(a){if(a){if(b){var c=function(){d.b.Ld()};a.addEventListener("hyperlink",c,!1);a.L.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.G,!1)}O(e,!0)});return e.result()};
function mv(a,b){var c=b.a||"";return ke("runCommand",function(d){var e=a.ra[c];e?e.call(a,b).then(function(){Pu(a,{t:"done",a:c});O(d,!0)}):(w.error("No such action:",c),O(d,!0))},function(a,b){w.error(b,"Error during action:",c);O(a,!0)})}function nv(a){return"string"==typeof a?JSON.parse(a):a}
function ov(a,b){var c=nv(b),d=null;me(function(){var b=L("commandLoop"),f=fe.f;a.G=function(b){var c="#"===b.href.charAt(0)||a.N.some(function(a){return b.href.substr(0,a.length)==a});if(c){b.preventDefault();var d={t:"hyperlink",href:b.href,internal:c};ne(f,function(){Pu(a,d);return M(!0)})}};Ce(function(b){if(a.Xa)Uu(a).then(function(){P(b)});else if(a.ac)a.g&&Xu(a,a.g).then(function(){P(b)});else if(c){var e=c;c=null;mv(a,e).then(function(){P(b)})}else e=L("waitForCommand"),d=ue(e,self),e.result().then(function(){P(b)})}).Ma(b);
return b.result()});a.I=function(){var a=d;a&&(d=null,a.qb())};a.l=function(b){if(c)return!1;c=nv(b);a.I();return!0};a.window.adapt_command=a.l};function Pr(a,b,c){if(a==b)return a?[[0,a]]:[];if(0>c||a.length<c)c=null;var d=pv(a,b),e=a.substring(0,d);a=a.substring(d);b=b.substring(d);var d=qv(a,b),f=a.substring(a.length-d);a=a.substring(0,a.length-d);b=b.substring(0,b.length-d);a=rv(a,b);e&&a.unshift([0,e]);f&&a.push([0,f]);sv(a);null!=c&&(a=tv(a,c));return a=uv(a)}
function rv(a,b){var c;if(!a)return[[1,b]];if(!b)return[[-1,a]];c=a.length>b.length?a:b;var d=a.length>b.length?b:a,e=c.indexOf(d);if(-1!=e)return c=[[1,c.substring(0,e)],[0,d],[1,c.substring(e+d.length)]],a.length>b.length&&(c[0][0]=c[2][0]=-1),c;if(1==d.length)return[[-1,a],[1,b]];var f=vv(a,b);if(f)return d=f[1],e=f[3],c=f[4],f=Pr(f[0],f[2]),d=Pr(d,e),f.concat([[0,c]],d);a:{c=a.length;for(var d=b.length,e=Math.ceil((c+d)/2),f=2*e,g=Array(f),h=Array(f),l=0;l<f;l++)g[l]=-1,h[l]=-1;g[e+1]=0;h[e+1]=
0;for(var l=c-d,k=!!(l%2),m=0,p=0,q=0,r=0,z=0;z<e;z++){for(var u=-z+m;u<=z-p;u+=2){var A=e+u,H;H=u==-z||u!=z&&g[A-1]<g[A+1]?g[A+1]:g[A-1]+1;for(var E=H-u;H<c&&E<d&&a.charAt(H)==b.charAt(E);)H++,E++;g[A]=H;if(H>c)p+=2;else if(E>d)m+=2;else if(k&&(A=e+l-u,0<=A&&A<f&&-1!=h[A])){var K=c-h[A];if(H>=K){c=wv(a,b,H,E);break a}}}for(u=-z+q;u<=z-r;u+=2){A=e+u;K=u==-z||u!=z&&h[A-1]<h[A+1]?h[A+1]:h[A-1]+1;for(H=K-u;K<c&&H<d&&a.charAt(c-K-1)==b.charAt(d-H-1);)K++,H++;h[A]=K;if(K>c)r+=2;else if(H>d)q+=2;else if(!k&&
(A=e+l-u,0<=A&&A<f&&-1!=g[A]&&(H=g[A],E=e+H-A,K=c-K,H>=K))){c=wv(a,b,H,E);break a}}}c=[[-1,a],[1,b]]}return c}function wv(a,b,c,d){var e=a.substring(c),f=b.substring(d);a=Pr(a.substring(0,c),b.substring(0,d));e=Pr(e,f);return a.concat(e)}function pv(a,b){if(!a||!b||a.charAt(0)!=b.charAt(0))return 0;for(var c=0,d=Math.min(a.length,b.length),e=d,f=0;c<e;)a.substring(f,e)==b.substring(f,e)?f=c=e:d=e,e=Math.floor((d-c)/2+c);return e}
function qv(a,b){if(!a||!b||a.charAt(a.length-1)!=b.charAt(b.length-1))return 0;for(var c=0,d=Math.min(a.length,b.length),e=d,f=0;c<e;)a.substring(a.length-e,a.length-f)==b.substring(b.length-e,b.length-f)?f=c=e:d=e,e=Math.floor((d-c)/2+c);return e}
function vv(a,b){function c(a,b,c){for(var d=a.substring(c,c+Math.floor(a.length/4)),e=-1,f="",g,h,k,l;-1!=(e=b.indexOf(d,e+1));){var m=pv(a.substring(c),b.substring(e)),K=qv(a.substring(0,c),b.substring(0,e));f.length<K+m&&(f=b.substring(e-K,e)+b.substring(e,e+m),g=a.substring(0,c-K),h=a.substring(c+m),k=b.substring(0,e-K),l=b.substring(e+m))}return 2*f.length>=a.length?[g,h,k,l,f]:null}var d=a.length>b.length?a:b,e=a.length>b.length?b:a;if(4>d.length||2*e.length<d.length)return null;var f=c(d,e,
...
function sv(a){a.push([0,""]);for(var b=0,c=0,d=0,e="",f="",g;b<a.length;)switch(a[b][0]){case 1:d++;f+=a[b][1];b++;break;case -1:c++;e+=a[b][1];b++;break;case 0:if(1<c+d){if(c&&d){if(g=pv(f,e))0<b-c-d&&0==a[b-c-d-1][0]?a[b-c-d-1][1]+=f.substring(0,g):(a.splice(0,0,[0,f.substring(0,g)]),b++),f=f.substring(g),e=e.substring(g);if(g=qv(f,e))a[b][1]=f.substring(f.length-g)+a[b][1],f=f.substring(0,f.length-g),e=e.substring(0,e.length-g)}c?d?a.splice(b-c-d,c+d,[-1,e],[1,f]):a.splice(b-c,c+d,[-1,e]):a.splice(b-
...
a[b+1][1],a.splice(b+1,1),c=!0)),b++;c&&sv(a)}Pr.f=1;Pr.b=-1;Pr.g=0;
function tv(a,b){var c;a:{var d=a;if(0===b)c=[0,d];else{var e=0;for(c=0;c<d.length;c++){var f=d[c];if(-1===f[0]||0===f[0]){var g=e+f[1].length;if(b===g){c=[c+1,d];break a}if(b<g){d=d.slice();g=b-e;e=[f[0],f[1].slice(0,g)];f=[f[0],f[1].slice(g)];d.splice(c,1,e,f);c=[c+1,d];break a}e=g}}throw Error("cursor_pos is out of bounds!");}}d=c[1];c=c[0];e=d[c];f=d[c+1];return null==e||0!==e[0]?a:null!=f&&e[1]+f[1]===f[1]+e[1]?(d.splice(c,2,f,e),xv(d,c,2)):null!=f&&0===f[1].indexOf(e[1])?(d.splice(c,2,[f[0],
e[1]],[0,e[1]]),e=f[1].slice(e[1].length),0<e.length&&d.splice(c+2,0,[f[0],e]),xv(d,c,3)):a}
function uv(a){function b(a){return 55296<=a.charCodeAt(a.length-1)&&56319>=a.charCodeAt(a.length-1)}function c(a){return 56320<=a.charCodeAt(0)&&57343>=a.charCodeAt(0)}for(var d=!1,e=2;e<a.length;e+=1)0===a[e-2][0]&&b(a[e-2][1])&&-1===a[e-1][0]&&c(a[e-1][1])&&1===a[e][0]&&c(a[e][1])&&(d=!0,a[e-1][1]=a[e-2][1].slice(-1)+a[e-1][1],a[e][1]=a[e-2][1].slice(-1)+a[e][1],a[e-2][1]=a[e-2][1].slice(0,-1));if(!d)return a;d=[];for(e=0;e<a.length;e+=1)0<a[e][1].length&&d.push(a[e]);return d}
function xv(a,b,c){for(c=b+c-1;0<=c&&c>=b-1;c--)if(c+1<a.length){var d=a[c],e=a[c+1];d[0]===e[1]&&a.splice(c,2,[d[0],d[1]+e[1]])}return a};function Or(a){return a.reduce(function(a,c){return c[0]===Pr.b?a:a+c[1]},"")}function dl(a,b,c){var d=0,e=0;a.some(function(a){for(var f=0;f<a[1].length;f++){switch(a[0]*c){case Pr.f:d++;break;case Pr.b:d--;e++;break;case Pr.g:e++}if(e>b)return!0}return!1});return Math.max(Math.min(b,e-1)+d,0)};function yv(a,b,c,d,e){Vm.call(this,a,b,"block-end",null,c,e);this.g=d}v(yv,Vm);yv.prototype.Ze=function(a){return!(a instanceof yv)};function zv(a,b,c,d){Ym.call(this,a,"block-end",b,c,d)}v(zv,Ym);zv.prototype.Fa=function(){return Infinity};zv.prototype.f=function(a){return a instanceof yv?!0:this.Fa()<a.Fa()};function Av(a){this.f=a}Av.prototype.b=function(a){a=cl(a);return!Rk(a,this.f.b)};function Bv(){}n=Bv.prototype;n.Af=function(a){return"footnote"===a.Aa};
n.zf=function(a){return a instanceof yv};n.Gf=function(a,b){var c="region",d=gn(b,c);Dn(gn(b,"page"),d)&&(c="page");d=cl(a);c=new yv(d,c,b.h,a.X,a.N);b.fe(c);return M(c)};n.Hf=function(a,b,c,d){return new zv(a[0].ja.V,a,c,d)};n.sf=function(a,b){return gn(b,a.V).b.filter(function(a){return a instanceof zv})[0]||null};
n.wf=function(a,b,c){a.Vf=!0;a.pe=!1;var d=a.element,e=c.j;b=b.b;var f=c.j.w&&"rtl"===c.j.w.direction,g={},h=e.D._pseudos;b=tr(e,b,f,e.D,g);if(h&&h.before){var l={},k=Fr(e,"http://www.w3.org/1999/xhtml","span");mr(k,"before");d.appendChild(k);tr(e,b,f,h.before,l);delete l.content;Ir(e,k,l)}delete g.content;Ir(e,d,g);a.b=b;Kp(a,d);if(e=Nn(c.f,d))a.marginLeft=X(e.marginLeft),a.Y=X(e.borderLeftWidth),a.H=X(e.paddingLeft),a.marginTop=X(e.marginTop),a.ga=X(e.borderTopWidth),a.I=X(e.paddingTop),a.marginRight=
X(e.marginRight),a.Pa=X(e.borderRightWidth),a.X=X(e.paddingRight),a.marginBottom=X(e.marginBottom),a.Ca=X(e.borderBottomWidth),a.P=X(e.paddingBottom);if(c=Nn(c.f,d))a.width=X(c.width),a.height=X(c.height)};n.jg=function(a,b){switch(a.g){case xd:Yn(b,new Av(a),a.V)}};ao.push(new Bv);function Cv(a){return a.reduce(function(a,c){return a+c},0)/a.length}function ht(a){var b=Cv(a);return Cv(a.map(function(a){a-=b;return a*a}))};function Dv(a,b){this.g(a,"end",b)}function Ev(a,b){this.g(a,"start",b)}function Fv(a,b,c){c||(c=this.j.now());var d=this.h[a];d||(d=this.h[a]=[]);var e;for(a=d.length-1;0<=a&&(!(e=d[a])||e[b]);a--)e=null;e||(e={},d.push(e));e[b]=c}function Gv(){}function Hv(a){this.j=a;this.h={};this.registerEndTiming=this.b=this.registerStartTiming=this.f=this.g=Gv}
Hv.prototype.l=function(){var a=this.h,b="";Object.keys(a).forEach(function(c){for(var d=a[c],e=d.length,f=0;f<e;f++){var g=d[f];b+=c;1<e&&(b+="("+f+")");b+=" => start: "+g.start+", end: "+g.end+", duration: "+(g.end-g.start)+"\n"}});w.g(b)};Hv.prototype.u=function(){this.registerEndTiming=this.b=this.registerStartTiming=this.f=this.g=Gv};Hv.prototype.B=function(){this.g=Fv;this.registerStartTiming=this.f=Ev;this.registerEndTiming=this.b=Dv};
var Iv={now:Date.now},Ru,Jv=Ru=new Hv(window&&window.performance||Iv);Fv.call(Jv,"load_vivliostyle","start",void 0);na("vivliostyle.profile.profiler",Jv);Hv.prototype.printTimings=Hv.prototype.l;Hv.prototype.disable=Hv.prototype.u;Hv.prototype.enable=Hv.prototype.B;function ro(a){return(a=a.C)&&a instanceof wp?a:null}function Kv(a,b,c){var d=a.b;return d&&!d.uc&&(a=Lv(a,b),a.A)?!d.rc||d.uc?M(!0):Mv(d,d.rc,a,null,c):M(!0)}function Nv(a,b,c){var d=a.b;return d&&(a=Lv(a,b),a.A)?!d.sc||d.vc?M(!0):Mv(d,d.sc,a,a.A.firstChild,c):M(!0)}function Ov(a,b){a&&Pv(a.J?a.parent:a,function(a,d){a instanceof vp||b.B.push(new Qv(d))})}function Pv(a,b){for(var c=a;c;c=c.parent){var d=c.C;d&&d instanceof wp&&!gl(c,d)&&b(d,c)}}
function wp(a,b){this.parent=a;this.j=b;this.b=null}wp.prototype.Re=function(){return"Repetitive elements owner formatting context (vivliostyle.repetitiveelements.RepetitiveElementsOwnerFormattingContext)"};wp.prototype.af=function(a,b){return b};function Rv(a,b){var c=Lv(a,b);return c?c.A:null}function Lv(a,b){do if(!gl(b,a)&&b.M===a.j)return b;while(b=b.parent);return null}
function Lr(a,b){a.b||Gp.some(function(b){return b.root===a.j?(a.b=b.elements,!0):!1})||(a.b=new Sv(b,a.j),Gp.push({root:a.j,elements:a.b}))}wp.prototype.Te=function(){};wp.prototype.Se=function(){};var Gp=[];function Sv(a,b){this.N=a;this.rc=this.sc=this.u=this.D=this.l=this.B=null;this.G=this.H=0;this.uc=this.vc=!1;this.Zc=this.le=!0;this.j=!1;this.Y=b;this.I=this.g=null;this.P=[];this.X=[]}function Tv(a,b){a.sc||(a.sc=Sk(b),a.B=b.M,a.D=b.A)}function Uv(a,b){a.rc||(a.rc=Sk(b),a.l=b.M,a.u=b.A)}
function Mv(a,b,c,d,e){var f=c.A,g=c.A.ownerDocument.createElement("div");f.appendChild(g);var h=new Fm(e,g,c),l=h.ya.g;h.ya.g=null;a.h=!0;return Im(h,new hl(b)).fa(function(){a.h=!1;f.removeChild(g);if(f)for(;g.firstChild;){var b=g.firstChild;g.removeChild(b);b.setAttribute("data-adapt-spec","1");d?f.insertBefore(b,d):f.appendChild(b)}h.ya.g=l;return M(!0)})}Sv.prototype.b=function(a){var b=0;if(a&&!this.f(a))return b;if(!this.uc||a&&Vv(this,a))b+=this.G;this.vc||(b+=this.H);return b};
Sv.prototype.F=function(a){var b=0;if(a&&!this.f(a))return b;a&&Vv(this,a)&&(b+=this.G);this.Zc||(b+=this.H);return b};function Vv(a,b){return Wv(b,a.X,function(){return Xv(a.I,b,!1)})}Sv.prototype.f=function(a){var b=this;return Wv(a,this.P,function(){return Xv(b.Y,a,!0)})};function Wv(a,b,c){var d=b.filter(function(b){return b.w.M===a.M&&b.w.J===a.J});if(0<d.length)return d[0].result;c=c(a);b.push({w:a,result:c});return c}
function Xv(a,b,c){for(var d=[];a;a=a.parentNode){if(b.M===a)return b.J;d.push(a)}for(a=b.M;a;a=a.parentNode){var e=d.indexOf(a);if(0<=e)return c?!e:!1;for(e=a;e;e=e.previousElementSibling)if(d.includes(e))return!0}return b.J}function Yv(a){return!a.uc&&a.le&&a.rc||!a.vc&&a.Zc&&a.sc?!0:!1}function Zv(a){this.C=a}Zv.prototype.b=function(){};Zv.prototype.f=function(a){return!!a};
Zv.prototype.g=function(a,b,c,d){(a=this.C.b)&&!a.j&&(a.D&&(a.H=Lp(a.D,c,a.N),a.D=null),a.u&&(a.G=Lp(a.u,c,a.N),a.u=null),a.j=!0);return d};function $v(a){this.C=a}$v.prototype.b=function(){};$v.prototype.f=function(){return!0};$v.prototype.g=function(a,b,c,d){return d};function aw(a){this.C=a}v(aw,Zv);aw.prototype.b=function(a,b){Zv.prototype.b.call(this,a,b);var c=L("BlockLayoutProcessor.doInitialLayout");Cm(new Bm(new bw(a.C),b.j),a).Ma(c);return c.result()};aw.prototype.f=function(){return!1};
function cw(a){this.C=a}v(cw,$v);cw.prototype.b=function(a,b){gl(a,this.C)||a.J||b.B.unshift(new Qv(a));return dw(a,b)};function Qv(a){this.w=Lv(a.C,a)}n=Qv.prototype;n.ee=function(a,b){var c=this.w.C.b;return c&&!Mo(this.w.A)&&Yv(c)?b&&!a||a&&a.wa?!1:!0:!0};n.ed=function(){var a=this.w.C.b;return a&&Yv(a)?(!a.uc&&a.le&&a.rc?a.uc=!0:!a.vc&&a.Zc&&a.sc&&(a.vc=!0),!0):!1};n.Vc=function(a,b,c,d){(c=this.w.C.b)&&a&&d.u&&(!b||Vv(c,b))&&(c.uc=!1,c.le=!1)};
n.Ja=function(a,b){var c=this.w.C,d=this.w.C.b;if(!d)return M(!0);var e=this.w;return Nv(c,e,b).fa(function(){return Kv(c,e,b).fa(function(){d.vc=d.uc=!1;d.le=!0;d.Zc=!0;return M(!0)})})};n.me=function(a){return a instanceof Qv?this.w.C===a.w.C:!1};n.oe=function(){return 10};function ew(a){Lm.call(this);this.C=a}v(ew,Lm);ew.prototype.lf=function(a){var b=this.C.b;return gl(a,this.C)||b.j?(gl(a,this.C)||a.J||!b||(b.vc=!1,b.Zc=!1),new cw(this.C)):new aw(this.C)};function bw(a){this.C=a}v(bw,Em);
bw.prototype.sd=function(a){var b=this.C,c=a.w,d=b.b;if(c.parent&&b.j===c.parent.M){switch(c.u){case "header":if(d.sc)c.u="none";else return Tv(d,c),M(!0);break;case "footer":if(d.rc)c.u="none";else return Uv(d,c),M(!0)}d.g||(d.g=c.M)}return Em.prototype.sd.call(this,a)};bw.prototype.lc=function(a){var b=this.C,c=a.w;c.M===b.j&&(b.b.I=a.cd&&a.cd.M,a.Nb=!0);return"header"===c.u||"footer"===c.u?M(!0):Em.prototype.lc.call(this,a)};function fw(){}v(fw,Ip);
fw.prototype.de=function(a,b,c){if(uo(b,a))return Eo(b,a);var d=a.C;return Rv(d,a)?(c&&Ov(a.parent,b),gl(a,d)?Ip.prototype.de.call(this,a,b,c):Mm(new ew(d),a,b)):Go(b,a)};fw.prototype.Ue=function(a){var b=ro(a).b;if(!b)return!1;b.h||b.B!==a.M&&b.l!==a.M||a.A.parentNode.removeChild(a.A);return!1};
function dw(a,b){var c=a.C,d=L("doLayout"),e=Dm(b.j,a,!1);Fo(e,b).then(function(a){var e=a;Ce(function(a){for(var d={};e;){d.La=!0;yp(b,e,!1).then(function(d){return function(f){e=f;Gn(b.l)?Q(a):b.g?Q(a):e&&b.u&&e&&e.wa?Q(a):e&&e.J&&e.M==c.j?Q(a):d.La?d.La=!1:P(a)}}(d));if(d.La){d.La=!1;return}d={La:d.La}}Q(a)}).then(function(){O(d,e)})});return d.result()}fw.prototype.Ja=function(a,b,c,d){return Ip.prototype.Ja.call(this,a,b,c,d)};fw.prototype.wd=function(a,b,c,d){Ip.prototype.wd(a,b,c,d)};
function oo(a){for(var b=[],c=a;c;c=c.Ed)c.B.forEach(function(c){if(c instanceof Qv){var d=c.w.C.b;b.push(d)}c instanceof gw&&(d=new hw(c.w,c.f),b.push(d));c instanceof iw&&jw(c,a).forEach(function(a){b.push(a)})});return b}var kw=new fw;de("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof wp&&!(a instanceof vp)?kw:null});function lw(a,b){if(!a||!a.I||a.J||uo(b,a))return M(a);var c=a.I;return mw(c,b,a).fa(function(d){var e=a.A;e.appendChild(d);var f=Lp(d,b,a.b);e.removeChild(d);b.B.push(new gw(a,c,f));return M(a)})}function nw(a,b,c){this.b=a;this.f=b;this.Gb=c}nw.prototype.matches=function(){var a=ow[this.b];return!!a&&null!=a.Ra&&zi(a.Ra,this.f,this.Gb)};function rj(a){this.b=a}rj.prototype.matches=function(){return this.b.some(function(a){return a.matches()})};function sj(a){this.b=a}sj.prototype.matches=function(){return this.b.every(function(a){return a.matches()})};
function qj(a,b){var c=b.split("_");if("NFS"==c[0])return new nw(a,parseInt(c[1],10),parseInt(c[2],10));ra("unknown view condition. condition="+b);return null}function Tj(a,b,c){qr(c,function(c){Vj(a,c,b)})}function qr(a,b){var c=a._viewConditionalStyles;c&&c.forEach(function(a){a.xg.matches()&&b(a.Hg)})}function Br(a,b,c){var d=ow;if(!d[a]||d[a].ab<=c)d[a]={Ra:b,ab:c}}var ow={};function Kr(a,b){this.b=b;this.M=a}
function mw(a,b,c){var d=c.A.ownerDocument.createElement("div"),e=new Fm(b,d,c),f=e.ya.g;e.ya.g=null;return Im(e,pw(a)).fa(function(){a.b.f["after-if-continues"]=!1;e.ya.g=f;var b=d.firstChild;x(b,"display","block");return M(b)})}function pw(a){var b=kr.createElementNS("http://www.w3.org/1999/xhtml","div");mr(b,"after-if-continues");a=new Xk(a.M,b,null,null,null,3,a.b);return new hl({oa:[{node:b,hb:a.type,ua:a,Ga:null,Da:null}],ma:0,J:!1,Oa:null})}function gw(a,b,c){this.w=a;this.b=b;this.f=c}n=gw.prototype;
n.ee=function(a,b){return b&&!a||a&&a.wa?!1:!0};n.ed=function(){return!1};n.Vc=function(){};n.Ja=function(a,b){var c=this;return(new hw(this.w,this.f)).f(a)?mw(this.b,b,this.w).fa(function(a){c.w.A.appendChild(a);return M(!0)}):M(!0)};n.me=function(a){return a instanceof gw?this.b==a.b:!1};n.oe=function(){return 9};function hw(a,b){this.w=a;this.g=b}hw.prototype.b=function(a){return this.f(a)?this.g:0};hw.prototype.F=function(a){return this.b(a)};
hw.prototype.f=function(a){if(!a)return!1;var b=a.ua?a.ua.na:a.M;if(b===this.w.M)return!!a.J;for(a=b.parentNode;a;a=a.parentNode)if(a===this.w.M)return!0;return!1};function Fo(a,b){return a.fa(function(a){return lw(a,b)})}function Hp(a,b){var c=L("vivliostyle.selectors.processAfterIfContinuesOfAncestors"),d=a;Be(function(){if(d){var a=lw(d,b);d=d.parent;return a.Bc(!0)}return M(!1)}).then(function(){O(c,!0)});return c.result()};function qw(a){var b=rw.findIndex(function(b){return b.root===a});0<=b&&rw.splice(b,1)}function sw(a){var b=rw.findIndex(function(b){return b.root===a});return(b=rw[b])?b.Jg:null}
function tw(a,b,c){var d=a.w,e=d.display,f=d.parent?d.parent.display:null,g=!1;if("inline-table"===f&&!(d.C instanceof vp))for(var h=d.parent;h;h=h.parent)if(h.C instanceof vp){g=h.C===b;break}return g||"table-row"===e&&!uw(f)&&"table"!==f&&"inline-table"!==f||"table-cell"===e&&"table-row"!==f&&!uw(f)&&"table"!==f&&"inline-table"!==f||d.C instanceof vp&&d.C!==b?Go(c,d).fa(function(b){a.w=b;return M(!0)}):null}
function uw(a){return"table-row-group"===a||"table-header-group"===a||"table-footer-group"===a}function vw(a,b){this.rowIndex=a;this.M=b;this.b=[]}function ww(a){return Math.min.apply(null,a.b.map(function(a){return a.height}))}function xw(a,b,c){this.rowIndex=a;this.Qa=b;this.g=c;this.f=c.colSpan||1;this.rowSpan=c.rowSpan||1;this.height=0;this.b=null}function yw(a,b,c){this.rowIndex=a;this.Qa=b;this.Vb=c}function zw(a,b,c){this.g=a;this.b=c;this.ec=new Fm(a,b,c);this.f=!1}
zw.prototype.Yb=function(){var a=this.b.A,b=this.b.Y;"middle"!==b&&"bottom"!==b||x(a,"vertical-align","top");var c=this.ec.Yb(!0);x(a,"vertical-align",b);return c};function Aw(a,b){this.A=a;this.b=b}function Bw(a,b,c,d){Km.call(this,a,b,c,d);this.C=a.C;this.rowIndex=this.l=null}v(Bw,Km);Bw.prototype.f=function(a,b){var c=Km.prototype.f.call(this,a,b);return b<this.b()?null:Cw(this).every(function(a){return!!a.w})?c:null};
Bw.prototype.b=function(){var a=Km.prototype.b.call(this);Cw(this).forEach(function(b){a+=b.Ab.b()});return a};function Cw(a){a.l||(a.l=Dw(a).map(function(a){return a.Yb()}));return a.l}function Dw(a){return Ew(a.C,null!=a.rowIndex?a.rowIndex:a.rowIndex=Fw(a.C,a.position.M)).map(a.C.Kd,a.C)}function Gw(a,b,c){this.rowIndex=a;this.j=b;this.C=c;this.h=null}v(Gw,ko);
Gw.prototype.f=function(a,b){if(b<this.b())return null;var c=Hw(this),d=Iw(this),e=d.every(function(a){return!!a.w})&&d.some(function(a,b){var d=c[b].ec,e=a.w,f=d.pf[0];return!(f.A===e.A&&f.J===e.J&&f.ma===e.ma)&&!Rk(cl(e),d.ya.xb)});this.j.wa=d.some(function(a){return a.w&&a.w.wa});return e?this.j:null};Gw.prototype.b=function(){var a=this.C,b=0;ww(a.g[this.rowIndex])>a.N/2||(b+=10);Iw(this).forEach(function(a){b+=a.Ab.b()});return b};
function Iw(a){a.h||(a.h=Hw(a).map(function(a){return a.Yb()}));return a.h}function Hw(a){return Jw(a.C,a.rowIndex).map(a.C.Kd,a.C)}function vp(a,b){wp.call(this,a,b);this.F=b;this.u=!1;this.G=-1;this.N=0;this.H=[];this.I=this.B=null;this.P=0;this.g=[];this.l=[];this.f=[];this.D=null;this.h=[];this.b=null}v(vp,wp);n=vp.prototype;n.Re=function(){return"Table formatting context (vivliostyle.table.TableFormattingContext)"};
n.af=function(a,b){if(!b)return b;switch(a.display){case "table-row":return!this.h.length;case "table-cell":return!this.h.some(function(b){return b.Ad.oa[0].node===a.M});default:return b}};function Kw(a,b){var c=a.l[b];c||(c=a.l[b]=[]);return c}function Fw(a,b){return a.g.findIndex(function(a){return b===a.M})}function Jw(a,b){return Kw(a,b).reduce(function(a,b){return b.Vb!==a[a.length-1]?a.concat(b.Vb):a},[])}function Ew(a,b){return Jw(a,b).filter(function(a){return a.rowIndex+a.rowSpan-1>b})}
n.Kd=function(a){return this.f[a.rowIndex]&&this.f[a.rowIndex][a.Qa]};function Lw(a){0>a.G&&(a.G=Math.max.apply(null,a.g.map(function(a){return a.b.reduce(function(a,b){return a+b.f},0)})));return a.G}function Mw(a,b){a.g.forEach(function(a){a.b.forEach(function(a){var c=Hk(b,a.g);a.g=null;a.height=this.u?c.width:c.height},this)},a)}
function Nw(a,b){if(!b)return null;var c=null,d=0;a:for(;d<a.f.length;d++)if(a.f[d])for(var e=0;e<a.f[d].length;e++)if(a.f[d][e]&&b===a.f[d][e].ec.ya){c=a.g[d].b[e];break a}if(!c)return null;for(;d<a.l.length;d++)for(;e<a.l[d].length;e++){var f=a.l[d][e];if(f.Vb===c)return{rowIndex:f.rowIndex,Qa:f.Qa}}return null}function Ow(a,b){var c=[];return a.l.reduce(function(d,e,f){if(f>=b.rowIndex)return d;e=a.Kd(e[b.Qa].Vb);if(!e||c.includes(e))return d;Pw(e.ec.ya,d);c.push(e);return d},[])}
function Qw(a){var b=[];a.g.forEach(function(c){c.b.forEach(function(c,e){b[e]||(b[e]={Ef:[],elements:[]});var d=b[e],g=a.Kd(c);g&&!d.Ef.includes(g)&&(Pw(g.ec.ya,d.elements),d.Ef.push(g))})});return[new Rw(b.map(function(a){return a.elements}))]}function Pw(a,b){a.B.forEach(function(a){a instanceof Qv&&b.push(a.w.C.b);a instanceof iw&&jw(a,null).forEach(function(a){b.push(a)})})}n.Te=function(){return[].concat(this.h)};n.Se=function(a){this.h=a};function Rw(a){this.f=a}
Rw.prototype.b=function(a){return Sw(this,a,function(a){return a.current})};Rw.prototype.F=function(a){return Sw(this,a,function(a){return a.Be})};function Sw(a,b,c){var d=0;a.f.forEach(function(a){a=lo(b,a);d=Math.max(d,c(a))});return d}function Tw(a,b){this.C=a;this.h=b;this.rowIndex=-1;this.Qa=0;this.g=!1;this.f=[]}v(Tw,Em);n=Tw.prototype;
n.sd=function(a){var b=this.C,c=tw(a,b,this.h);if(c)return c;Uw(this,a);var c=a.w,d=b.b;switch(c.display){case "table":b.P=c.ra;break;case "table-caption":b.H.push(new Aw(c.A,c.ha));break;case "table-header-group":return d.sc||(this.b=!0,Tv(d,c)),M(!0);case "table-footer-group":return d.rc||(this.b=!0,Uv(d,c)),M(!0);case "table-row":this.b||(this.g=!0,this.rowIndex++,this.Qa=0,b.g[this.rowIndex]=new vw(this.rowIndex,c.M),d.g||(d.g=c.M))}return Em.prototype.sd.call(this,a)};
n.lc=function(a){var b=this.C,c=a.w,d=c.display,e=this.h.f;Uw(this,a);if(c.M===b.F)d=Nn(e,Rv(b,c)),b.N=parseFloat(d[b.u?"height":"width"]),b.b.I=a.cd&&a.cd.M,a.Nb=!0;else switch(d){case "table-header-group":case "table-footer-group":if(this.b)return this.b=!1,M(!0);break;case "table-row":this.b||(b.D=c.A,this.g=!1);break;case "table-cell":if(!this.b){this.g||(this.rowIndex++,this.Qa=0,this.g=!0);d=this.rowIndex;c=new xw(this.rowIndex,this.Qa,c.A);e=b.g[d];e||(b.g[d]=new vw(d,null),e=b.g[d]);e.b.push(c);
for(var e=d+c.rowSpan,f=Kw(b,d),g=0;f[g];)g++;for(;d<e;d++)for(var f=Kw(b,d),h=g;h<g+c.f;h++){var l=f[h]=new yw(d,h,c);c.b||(c.b=l)}this.Qa++}}return Em.prototype.lc.call(this,a)};n.qf=function(a){Vw(this,a)};n.yf=function(a){Vw(this,a)};n.fg=function(a){Vw(this,a)};n.xf=function(a){Vw(this,a)};function Vw(a,b){var c=b.w;c&&c.A&&!Co(c)&&a.f.push(c.clone())}function Uw(a,b){0<a.f.length&&Ho(a.h,b.w,a.f);a.f=[]}
function Ww(a,b){this.$b=!0;this.C=a;this.f=b;this.l=!1;this.b=-1;this.g=0;this.u=b.u;b.u=!1}v(Ww,Em);var Xw={"table-caption":!0,"table-column-group":!0,"table-column":!0};
function Yw(a,b,c,d){var e=b.rowIndex,f=b.Qa,g=c.A;if(1<b.f){x(g,"box-sizing","border-box");for(var h=a.C.I,l=0,k=0;k<b.f;k++)l+=h[b.b.Qa+k];l+=a.C.P*(b.f-1);x(g,a.C.u?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new zw(a.f,b,c);a=a.C;(g=a.f[e])||(g=a.f[e]=[]);g[f]=c;1===d.f.oa.length&&d.f.J&&(c.f=!0);return Im(c.ec,d).Bc(!0)}function Zw(a,b){var c=a.C.h[0];return c?c.Vb.b.Qa===b:!1}
function $w(a){var b=a.C.h;if(!b.length)return[];var c=[],d=0;do{var e=b[d],f=e.Vb.rowIndex;if(f<a.b){var g=c[f];g||(g=c[f]=[]);g.push(e);b.splice(d,1)}else d++}while(d<b.length);return c}
function ax(a,b){var c=a.C,d=$w(a),e=d.reduce(function(a){return a+1},0);if(0===e)return M(!0);var f=a.f.j,g=b.w;g.A.parentNode.removeChild(g.A);var h=L("layoutRowSpanningCellsFromPreviousFragment"),l=M(!0),k=0,m=[];d.forEach(function(a){var b=this;l=l.fa(function(){var d=Uk(a[0].Ad.oa[1],g.parent);return xo(f,d,!1).fa(function(){function g(a){for(;l<a;){if(!m.includes(l)){var b=d.A.ownerDocument.createElement("td");x(b,"padding","0");d.A.appendChild(b)}l++}}var h=M(!0),l=0;a.forEach(function(a){var b=
this;h=h.fa(function(){var c=a.Vb;g(c.b.Qa);var h=a.Ad,p=Uk(h.oa[0],d);p.ma=h.ma;p.J=h.J;p.Ra=h.oa[0].Ra+1;return xo(f,p,!1).fa(function(){for(var d=a.Cf,f=0;f<c.f;f++)m.push(l+f);l+=c.f;return Yw(b,c,p,d).fa(function(){p.A.rowSpan=c.rowIndex+c.rowSpan-b.b+e-k;return M(!0)})})})},b);return h.fa(function(){g(Lw(c));k++;return M(!0)})})})},a);l.then(function(){xo(f,g,!0,b.xd).then(function(){O(h,!0)})});return h.result()}
function bx(a,b){if(a.j||a.h)return M(!0);var c=b.w,d=a.C;0>a.b?a.b=Fw(d,c.M):a.b++;a.g=0;a.l=!0;return ax(a,b).fa(function(){cx(a);rp(a.f,b.cd,null,!0,b.Wc)&&!Ew(d,a.b-1).length&&(a.f.u=a.u,c.wa=!0,b.Nb=!0);return M(!0)})}function cx(a){a.C.g[a.b].b.forEach(function(b){var c=a.C.h[b.Qa];c&&c.Vb.b.Qa==b.b.Qa&&(b=c.Ad.oa[0],c=ek(a.f.j.ba,b.node),Br(c,b.Ra+1,1))})}
function dx(a,b){if(a.j||a.h)return M(!0);var c=b.w;a.l||(0>a.b?a.b=0:a.b++,a.g=0,a.l=!0);var d=a.C.g[a.b].b[a.g],e=Wk(c).modify();e.J=!0;b.w=e;var f=L("startTableCell");Zw(a,d.b.Qa)?(e=a.C.h.shift(),c.Ra=e.Ad.oa[0].Ra+1,e=M(e.Cf)):e=Do(a.f,c,b.xd).fa(function(a){a.A&&c.A.removeChild(a.A);return M(new hl(Sk(a)))});e.then(function(e){Yw(a,d,c,e).then(function(){a.lc(b);a.g++;O(f,!0)})});return f.result()}
Ww.prototype.gg=function(a){var b=tw(a,this.C,this.f);if(b)return b;var b=a.w,c=this.C.b,d=b.display;return"table-header-group"===d&&c&&c.B===b.M?(this.j=!0,M(!0)):"table-footer-group"===d&&c&&c.l===b.M?(this.h=!0,M(!0)):"table-row"===d?bx(this,a):"table-cell"===d?dx(this,a):M(!0)};Ww.prototype.If=function(a){a=a.w;"table-row"===a.display&&(this.l=!1,this.j||this.h||(a=Wk(a).modify(),a.J=!1,this.f.N.push(new Gw(this.b,a,this.C))));return M(!0)};
Ww.prototype.lc=function(a){var b=a.w,c=this.C.b,d=b.display;"table-header-group"===d?c&&!c.h&&c.B===b.M?(this.j=!1,b.A.parentNode.removeChild(b.A)):x(b.A,"display","table-row-group"):"table-footer-group"===d&&(c&&!c.h&&c.l===b.M?(this.h=!1,b.A.parentNode.removeChild(b.A)):x(b.A,"display","table-row-group"));if(d&&Xw[d])b.A.parentNode.removeChild(b.A);else if(b.M===this.C.F)b.wa=qp(this.f,b,null),this.f.u=this.u,a.Nb=!0;else return Em.prototype.lc.call(this,a);return M(!0)};var rw=[];
function ex(){}function fx(a,b,c,d){for(var e=a.ownerDocument,f=e.createElement("tr"),g=[],h=0;h<b;h++){var l=e.createElement("td");f.appendChild(l);g.push(l)}a.parentNode.insertBefore(f,a.nextSibling);b=g.map(function(a){a=Hk(d,a);return c?a.height:a.width});a.parentNode.removeChild(f);return b}function gx(a){var b=[];for(a=a.firstElementChild;a;)"colgroup"===a.localName&&b.push(a),a=a.nextElementSibling;return b}
function hx(a){var b=[];a.forEach(function(a){var c=a.span;a.removeAttribute("span");for(var e=a.firstElementChild;e;){if("col"===e.localName){var f=e.span;e.removeAttribute("span");for(c-=f;1<f--;){var g=e.cloneNode(!0);a.insertBefore(g,e);b.push(g)}b.push(e)}e=e.nextElementSibling}for(;0<c--;)e=a.ownerDocument.createElement("col"),a.appendChild(e),b.push(e)});return b}
function ix(a,b,c,d){if(a.length<c){var e=d.ownerDocument.createElement("colgroup");b.push(e);for(b=a.length;b<c;b++){var f=d.ownerDocument.createElement("col");e.appendChild(f);a.push(f)}}}function jx(a,b,c){var d=a.u,e=a.D;if(e){a.D=null;var f=e.ownerDocument.createDocumentFragment(),g=Lw(a);if(0<g){var h=a.I=fx(e,g,d,c.f);c=gx(b);e=hx(c);ix(e,c,g,b);e.forEach(function(a,b){x(a,d?"height":"width",h[b]+"px")});c.forEach(function(a){f.appendChild(a.cloneNode(!0))})}a.B=f}}
function kx(a,b,c){var d=b.C;d.u=b.b;Lr(d,b.b);var e=sw(b.M);qw(b.M);var f=L("TableLayoutProcessor.doInitialLayout"),g=Wk(b);Cm(new Bm(new Tw(b.C,c),c.j),b).then(function(a){var h=a.A,k=Hk(c.f,h),k=c.b?k.left:k.bottom,k=k+(c.b?-1:1)*lo(b,oo(c)).current;po(c,k)||e&&e.og?(jx(d,h,c),Mw(d,c.f),O(f,null)):(c.N.push(new lx(g)),O(f,a))}.bind(a));return f.result()}function mx(a,b,c){var d=a.H;d.forEach(function(a,f){a&&(b.insertBefore(a.A,c),"top"===a.b&&(d[f]=null))})}
function nx(a,b){if(a.B&&b){var c=gx(b);c&&c.forEach(function(a){b.removeChild(a)})}}function ox(a,b){var c=a.C,d=Rv(c,a),e=d.firstChild;mx(c,d,e);c.B&&!gx(d).length&&d.insertBefore(c.B.cloneNode(!0),e);c=new Ww(c,b);c=new Bm(c,b.j);d=L("TableFormattingContext.doLayout");Cm(c,a).Ma(d);return d.result()}n=ex.prototype;n.de=function(a,b,c){var d=a.C;return Rv(d,a)?(c&&Ov(a.parent,b),Mm(new px(d,this),a,b)):Go(b,a)};n.Ff=function(a,b,c,d){return new Bw(a,b,c,d)};n.Ue=function(){return!1};n.vf=function(){return!1};
n.Ja=function(a,b,c,d){var e=b.C;if("table-row"===b.display){var f=Fw(e,b.M);e.h=[];var g;g=b.J?Ew(e,f):Jw(e,f);if(g.length){var h=L("TableLayoutProcessor.finishBreak"),l=0;Ce(function(a){if(l===g.length)Q(a);else{var b=g[l++],c=e.Kd(b),d=c.Yb().w,h=c.b,k=cl(h),u=new hl(cl(d));e.h.push({Ad:k,Cf:u,Vb:b});h=h.A;Jp(c.b);f<b.rowIndex+b.rowSpan-1&&(h.rowSpan=f-b.rowIndex+1);c.f?P(a):c.ec.Ja(d,!1,!0).then(function(){var b=e.b;if(b){var f=e.u,g=c.g,h=c.ec.ya.element,k=c.b.A,l=Hk(g.f,k),k=Oo(g,k);f?(b=l.right-
g.ha-b.b(d)-k.right,x(h,"max-width",b+"px")):(b=g.ha-b.b(d)-l.top-k.top,x(h,"max-height",b+"px"));x(h,"overflow","hidden")}P(a)})}}).then(function(){ip(a,b,!1);Jp(b);e.f=[];O(h,!0)});return h.result()}}e.f=[];return mp.Ja(a,b,c,d)};n.wd=function(a,b,c,d){Ip.prototype.wd(a,b,c,d)};function px(a,b){Lm.call(this);this.g=b;this.b=a}v(px,Lm);px.prototype.lf=function(a){var b=this.b.b;return b&&b.j?(a.M===this.b.F&&!a.J&&b&&(b.vc=!1,b.Zc=!1),new qx(this.b)):new rx(this.b,this.g)};
px.prototype.Bd=function(a){Lm.prototype.Bd.call(this,a);nx(this.b,Rv(this.b,a))};px.prototype.ce=function(a,b){Lm.prototype.ce.call(this,a,b);this.b.f=[]};function rx(a,b){this.C=a;this.h=b}v(rx,Zv);rx.prototype.b=function(a,b){Zv.prototype.b.call(this,a,b);return kx(this.h,a,b)};function lx(a){Km.call(this,a,null,a.wa,0)}v(lx,Km);lx.prototype.b=function(){if(!this.h)throw Error("EdgeBreakPosition.prototype.updateEdge not called");return(this.j?3:0)+(this.position.parent?this.position.parent.j:0)};
lx.prototype.u=function(a){a.B.push(new sx(this.position.M))};function sx(a){this.b=a}n=sx.prototype;n.ee=function(){return!1};n.ed=function(){return!0};n.Vc=function(a,b){rw.push({root:b.M,Jg:{og:!0}})};n.Ja=function(){return M(!0)};n.me=function(a){return a instanceof sx&&a.b===this.b};n.oe=function(){return 0};function qx(a){this.C=a}v(qx,$v);qx.prototype.b=function(a,b){var c=this.C.b;if(c&&!Vv(c,a)){var d=new iw(a);b.B.some(function(a){return d.me(a)})||b.B.unshift(d)}return ox(a,b)};
function iw(a){Qv.call(this,a);this.b=[]}v(iw,Qv);n=iw.prototype;n.ee=function(a,b,c){var d=this.w.C.b;return!d||c.Ed||Mo(this.w.A)||!Yv(d)?!0:b&&!a||a&&a.wa?!1:!0};n.ed=function(a){return tx(a,this.w.C).some(function(b){return b.Cd.some(function(b){return b.ed(a)})})?!0:Qv.prototype.ed.call(this,a)};n.Vc=function(a,b,c,d){var e=this.w.C;this.b=tx(b,e);this.b.forEach(function(b){b.Cd.forEach(function(e){e.Vc(a,b.Ab,c,d)})});a||(nx(e,Rv(e,this.w)),ux(c));Qv.prototype.Vc.call(this,a,b,c,d)};
n.Ja=function(a,b){var c=this,d=L("finishBreak"),e=this.b.reduce(function(a,b){return a.concat(b.Cd.map(function(a){return{qg:a,Ab:b.Ab}}))},[]),f=0;Be(function(){if(f<e.length){var a=e[f++];return a.qg.Ja(a.Ab,b).Bc(!0)}return M(!1)}).then(function(){O(d,!0)});return d.result().fa(function(){return Qv.prototype.Ja.call(c,a,b)})};function ux(a){if(a&&"table-row"===a.display&&a.A)for(;a.A.previousElementSibling;){var b=a.A.previousElementSibling;b.parentNode&&b.parentNode.removeChild(b)}}
function tx(a,b){return vx(a,b).map(function(a){return{Cd:a.tg.ec.ya.B,Ab:a.Ab}})}function vx(a,b){var c=Number.MAX_VALUE;a&&"table-row"===a.display&&(c=Fw(b,a.M)+1);for(var c=Math.min(b.f.length,c),d=[],e=0;e<c;e++)b.f[e]&&b.f[e].forEach(function(a){a&&d.push({tg:a,Ab:a.Yb().w})});return d}function jw(a,b){var c=a.w.C,d=Nw(c,b);return d?Ow(c,d):Qw(c)}n.me=function(a){return a instanceof iw?this.w.C===a.w.C:!1};var wx=new ex;
de("RESOLVE_FORMATTING_CONTEXT",function(a,b,c){return b?c===Ld?(b=a.parent,new vp(b?b.C:null,a.M)):null:null});de("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof vp?wx:null});Array.from||(Array.from=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e],e):a[e];return c});
...
Object.assign||(Object.assign=function(a,b){if(!b)return a;Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function xx(a){function b(a){return"number"===typeof a?a:null}function c(a){return"string"===typeof a?{url:a,ub:null,yc:null}:{url:a.url,ub:b(a.startPage),yc:b(a.skipPagesBefore)}}return Array.isArray(a)?a.map(c):a?[c(a)]:null}function yx(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}
function zx(a,b){Xj=a.debug;this.g=!1;this.h=a;this.Mb=new Nu(a.window||window,a.viewportElement,"main",this.rg.bind(this));this.f={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,pageViewMode:"autoSpread",zoom:1,fitToScreen:!1,defaultPaperSize:void 0};b&&this.eg(b);this.b=new db;Object.defineProperty(this,"readyState",{get:function(){return this.Mb.B}})}n=zx.prototype;n.eg=function(a){var b=Object.assign({a:"configure"},yx(a));this.Mb.l(b);Object.assign(this.f,a)};
n.rg=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});eb(this.b,b)};n.Kg=function(a,b){this.b.addEventListener(a,b,!1)};n.Ng=function(a,b){this.b.removeEventListener(a,b,!1)};n.wg=function(a,b,c){a||eb(this.b,{type:"error",content:"No URL specified"});Ax(this,a,null,b,c)};n.Lg=function(a,b,c){a||eb(this.b,{type:"error",content:"No URL specified"});Ax(this,null,a,b,c)};
function Ax(a,b,c,d,e){function f(a){if(a)return a.map(function(a){return{url:a.url||null,text:a.text||null}})}d=d||{};var g=f(d.authorStyleSheet),h=f(d.userStyleSheet);e&&Object.assign(a.f,e);b=Object.assign({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.h.userAgentRootURL,url:xx(b)||c,document:d.documentObject,fragment:d.fragment,authorStyleSheet:g,userStyleSheet:h},yx(a.f));a.g?a.Mb.l(b):(a.g=!0,ov(a.Mb,b))}n.Zb=function(){return this.Mb.Zb()};
n.zg=function(a){a:switch(a){case "left":a="ltr"===this.Zb()?"previous":"next";break a;case "right":a="ltr"===this.Zb()?"next":"previous"}this.Mb.l({a:"moveTo",where:a})};n.gf=function(a){this.Mb.l({a:"moveTo",nthPage:a})};n.yg=function(a){this.Mb.l({a:"moveTo",url:a})};n.Mg=function(a){a:{var b=this.Mb;if(!b.g)throw Error("no page exists.");switch(a){case "fit inside viewport":a=jv(b,b.Z.tb?iv(b,b.j):b.g.f);break a;default:throw Error("unknown zoom type: "+a);}}return a};n.ug=function(){return this.Mb.ga};
na("vivliostyle.viewer.Viewer",zx);zx.prototype.setOptions=zx.prototype.eg;zx.prototype.addListener=zx.prototype.Kg;zx.prototype.removeListener=zx.prototype.Ng;zx.prototype.loadDocument=zx.prototype.wg;zx.prototype.loadEPUB=zx.prototype.Lg;zx.prototype.getCurrentPageProgression=zx.prototype.Zb;zx.prototype.navigateToPage=zx.prototype.zg;zx.prototype.navigateToNthPage=zx.prototype.gf;zx.prototype.navigateToInternalUrl=zx.prototype.yg;zx.prototype.queryZoomFactor=zx.prototype.Mg;
zx.prototype.getPageSizes=zx.prototype.ug;na("vivliostyle.viewer.ZoomType",kv);kv.FIT_INSIDE_VIEWPORT="fit inside viewport";na("vivliostyle.viewer.PageViewMode",Mu);Mu.SINGLE_PAGE="singlePage";Mu.SPREAD="spread";Mu.AUTO_SPREAD="autoSpread";Fv.call(Ru,"load_vivliostyle","end",void 0);var Bx=16,Cx="ltr";function Dx(a){window.adapt_command(a)}function Ex(){Dx({a:"moveTo",where:"ltr"===Cx?"previous":"next"})}function Fx(){Dx({a:"moveTo",where:"ltr"===Cx?"next":"previous"})}
function Gx(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)Dx({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)Dx({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)Dx({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)Dx({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)Fx(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)Ex(),a.preventDefault();else if("0"===b||"U+0030"===c)Dx({a:"configure",fontSize:Math.round(Bx)}),a.preventDefault();else if("t"===b||"U+0054"===c)Dx({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)Bx*=1.2,Dx({a:"configure",fontSize:Math.round(Bx)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)Bx/=1.2,Dx({a:"configure",
fontSize:Math.round(Bx)}),a.preventDefault()}
function Hx(a){switch(a.t){case "loaded":a=a.viewer;var b=Cx=a.Zb();a.ae.setAttribute("data-vivliostyle-page-progression",b);a.ae.setAttribute("data-vivliostyle-spread-view",a.Z.tb);window.addEventListener("keydown",Gx,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Ex,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Fx,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(Fa(location.href,Ta(a||"")));break;case "hyperlink":a.internal&&Dx({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+m+"; margin: 0; }",document.head.appendChild(g));ov(new Nu(window,k,"main",Hx),a)});
