 ...
 *
 * Vivliostyle core 2016.10.1-pre.20161025141750
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
ib.prototype.e=function(a){a.append("/");a.append(this.index.toString());if(this.id||this.bb)a.append("["),this.id&&a.append(this.id),this.bb&&(a.append(";s="),a.append(this.bb)),a.append("]")};
ib.prototype.f=function(a){if(1!=a.ga.nodeType)throw Error("E_CFI_NOT_ELEMENT");var b=a.ga,c=b.children,d=c.length,e=Math.floor(this.index/2)-1;0>e||0==d?(c=b.firstChild,a.ga=c||b):(c=c[Math.min(e,d-1)],this.index&1&&((b=c.nextSibling)&&1!=b.nodeType?c=b:a.I=!0),a.ga=c);if(this.id&&(a.I||this.id!=cb(a.ga)))throw Error("E_CFI_ID_MISMATCH");a.bb=this.bb;return!0};function jb(a,b,c,d){this.offset=a;this.d=b;this.b=c;this.bb=d}
jb.prototype.f=function(a){if(0<this.offset&&!a.I){for(var b=this.offset,c=a.ga;;){var d=c.nodeType;if(1==d)break;var e=c.nextSibling;if(3<=d&&5>=d){d=c.textContent.length;if(b<=d)break;if(!e){b=d;break}b-=d}if(!e){b=0;break}c=e}a.ga=c;a.offset=b}a.bb=this.bb;return!0};
jb.prototype.e=function(a){a.append(":");a.append(this.offset.toString());if(this.d||this.b||this.bb){a.append("[");if(this.d||this.b)this.d&&a.append(this.d.replace(/[\[\]\(\),=;^]/g,db)),a.append(","),this.b&&a.append(this.b.replace(/[\[\]\(\),=;^]/g,db));this.bb&&(a.append(";s="),a.append(this.bb));a.append("]")}};function kb(){this.ha=null}
...
if(!c)throw Error("E_CFI_NUMBER_EXPECTED");e+=c[0].length;g=parseInt(c[1],10);(h=c[4])&&(h=fb(h));var l=c[7];l&&(l=fb(l));c=gb(c[10]);f.push(new jb(g,h,l,Ca(c.s)));break;case "!":e++;f.push(new hb);break;case "~":case "@":case "":a.ha=f;return;default:throw Error("E_CFI_PARSE_ERROR");}}function mb(a,b){for(var c={ga:b.documentElement,offset:0,I:!1,bb:null,fc:null},d=0;d<a.ha.length;d++)if(!a.ha[d].f(c)){++d<a.ha.length&&(c.fc=new kb,c.fc.ha=a.ha.slice(d));break}return c}
...
function Vb(a){var b=a.f,c=0<=a.b?a.b:a.d,d=a.e;b>=c?c+=d:c--;if(c==b){if(0>a.b)throw Error("F_CSSTOK_INTERNAL");for(var b=2*(a.e+1)-1,c=Array(b+1),d=a.b,e=0;d!=a.f;)c[e]=a.g[d],d==a.d&&(a.d=e),d=d+1&a.e,e++;a.b=0;a.f=e;a.e=b;for(a.g=c;e<=b;)c[e++]=new qb;b=a.f;c=d=a.e}for(var e=sb,f=a.j,g=a.position,h=a.g,l=0,k=0,m="",p=0,q=!1,w=h[b],r=-9;;){var y=f.charCodeAt(g);switch(e[y]||e[65]){case 72:l=51;m=isNaN(y)?"E_CSS_UNEXPECTED_EOF":"E_CSS_UNEXPECTED_CHAR";g++;break;case 1:g++;q=!0;continue;case 2:k=
...
function(){return this.pb()});hc(this,"pref-font-family",function(){return this.T.fontFamily});hc(this,"pref-night-mode",function(){return this.T.cd});hc(this,"pref-hyphenate",function(){return this.T.Wc});hc(this,"pref-margin",function(){return this.T.margin});hc(this,"pref-line-height",function(){return this.T.lineHeight});hc(this,"pref-column-width",function(){return this.T.Sc*this.fontSize});hc(this,"pref-horizontal",function(){return this.T.Vc});hc(this,"pref-spread-view",function(){return this.T.cb})}}
...
e}else if(null!=f&&null==c)return 0!==f;return!1}function uc(a){this.b=a;this.f="_"+ec++}n=uc.prototype;n.toString=function(){var a=new Ka;this.oa(a,0);return a.toString()};n.oa=function(){throw Error("F_ABSTRACT");};n.Ua=function(){throw Error("F_ABSTRACT");};n.Ga=function(){return this};n.Bb=function(a){return a===this};function vc(a,b,c,d){var e=d[a.f];if(null!=e)return e===$b?!1:e;d[a.f]=$b;b=a.Bb(b,c,d);return d[a.f]=b}
n.evaluate=function(a){var b;b=(b=a.w[this.b.j])?b[this.f]:void 0;if("undefined"!=typeof b)return b;b=this.Ua(a);var c=this.f,d=this.b,e=a.w[d.j];e||(e={},a.w[d.j]=e);return e[c]=b};n.zd=function(){return!1};function wc(a,b){uc.call(this,a);this.d=b}t(wc,uc);n=wc.prototype;n.ud=function(){throw Error("F_ABSTRACT");};n.xd=function(){throw Error("F_ABSTRACT");};n.Ua=function(a){a=this.d.evaluate(a);return this.xd(a)};n.Bb=function(a,b,c){return a===this||vc(this.d,a,b,c)};
n.oa=function(a,b){10<b&&a.append("(");a.append(this.ud());this.d.oa(a,10);10<b&&a.append(")")};n.Ga=function(a,b){var c=this.d.Ga(a,b);return c===this.d?this:new this.constructor(this.b,c)};function B(a,b,c){uc.call(this,a);this.d=b;this.e=c}t(B,uc);n=B.prototype;n.qc=function(){throw Error("F_ABSTRACT");};n.Da=function(){throw Error("F_ABSTRACT");};n.$a=function(){throw Error("F_ABSTRACT");};n.Ua=function(a){var b=this.d.evaluate(a);a=this.e.evaluate(a);return this.$a(b,a)};
...
Dc.prototype.Ua=function(a){return this.d.evaluate(a)&&this.e.evaluate(a)};function Ec(a,b,c){B.call(this,a,b,c)}t(Ec,Dc);Ec.prototype.Da=function(){return" and "};function Fc(a,b,c){B.call(this,a,b,c)}t(Fc,xc);Fc.prototype.Da=function(){return"||"};Fc.prototype.Ua=function(a){return this.d.evaluate(a)||this.e.evaluate(a)};function Gc(a,b,c){B.call(this,a,b,c)}t(Gc,Fc);Gc.prototype.Da=function(){return", "};function Hc(a,b,c){B.call(this,a,b,c)}t(Hc,yc);Hc.prototype.Da=function(){return"<"};
Hc.prototype.$a=function(a,b){return a<b};function Ic(a,b,c){B.call(this,a,b,c)}t(Ic,yc);Ic.prototype.Da=function(){return"<="};Ic.prototype.$a=function(a,b){return a<=b};function Jc(a,b,c){B.call(this,a,b,c)}t(Jc,yc);Jc.prototype.Da=function(){return">"};Jc.prototype.$a=function(a,b){return a>b};function Kc(a,b,c){B.call(this,a,b,c)}t(Kc,yc);Kc.prototype.Da=function(){return">="};Kc.prototype.$a=function(a,b){return a>=b};function Lc(a,b,c){B.call(this,a,b,c)}t(Lc,yc);Lc.prototype.Da=function(){return"=="};
Lc.prototype.$a=function(a,b){return a==b};function Mc(a,b,c){B.call(this,a,b,c)}t(Mc,yc);Mc.prototype.Da=function(){return"!="};Mc.prototype.$a=function(a,b){return a!=b};function Nc(a,b,c){B.call(this,a,b,c)}t(Nc,zc);Nc.prototype.Da=function(){return"+"};Nc.prototype.$a=function(a,b){return a+b};function Oc(a,b,c){B.call(this,a,b,c)}t(Oc,zc);Oc.prototype.Da=function(){return" - "};Oc.prototype.$a=function(a,b){return a-b};function Pc(a,b,c){B.call(this,a,b,c)}t(Pc,Ac);Pc.prototype.Da=function(){return"*"};
Pc.prototype.$a=function(a,b){return a*b};function Qc(a,b,c){B.call(this,a,b,c)}t(Qc,Ac);Qc.prototype.Da=function(){return"/"};Qc.prototype.$a=function(a,b){return a/b};function Rc(a,b,c){B.call(this,a,b,c)}t(Rc,Ac);Rc.prototype.Da=function(){return"%"};Rc.prototype.$a=function(a,b){return a%b};function Sc(a,b,c){uc.call(this,a);this.C=b;this.Y=c.toLowerCase()}t(Sc,uc);Sc.prototype.oa=function(a){a.append(this.C.toString());a.append(Na(this.Y))};
Sc.prototype.Ua=function(a){return this.C*qc(a,this.Y,!1)};function Tc(a,b){uc.call(this,a);this.d=b}t(Tc,uc);Tc.prototype.oa=function(a){a.append(this.d)};Tc.prototype.Ua=function(a){return rc(a,this.b,this.d).evaluate(a)};Tc.prototype.Bb=function(a,b,c){return a===this||vc(rc(b,this.b,this.d),a,b,c)};function Uc(a,b,c){uc.call(this,a);this.d=b;this.name=c}t(Uc,uc);Uc.prototype.oa=function(a){this.d&&a.append("not ");a.append(Na(this.name))};
Uc.prototype.Ua=function(a){var b=this.name;a="all"===b||!!a.T.wd[b];return this.d?!a:a};Uc.prototype.Bb=function(a,b,c){return a===this||vc(this.value,a,b,c)};Uc.prototype.zd=function(){return!0};function jc(a,b,c){uc.call(this,a);this.Lb=b;this.d=c}t(jc,uc);jc.prototype.oa=function(a){a.append(this.d)};jc.prototype.Ua=function(a){return this.Lb.call(a)};function Vc(a,b,c){uc.call(this,a);this.e=b;this.d=c}t(Vc,uc);
Vc.prototype.oa=function(a){a.append(this.e);var b=this.d;a.append("(");for(var c=0;c<b.length;c++)c&&a.append(","),b[c].oa(a,0);a.append(")")};Vc.prototype.Ua=function(a){return sc(a,this.b,this.e,this.d,!1).Ga(a,this.d).evaluate(a)};Vc.prototype.Bb=function(a,b,c){if(a===this)return!0;for(var d=0;d<this.d.length;d++)if(vc(this.d[d],a,b,c))return!0;return vc(sc(b,this.b,this.e,this.d,!0),a,b,c)};
...
n.Kc=function(){throw Error("E_CSS_COLOR_NOT_ALLOWED");};n.Vb=function(){throw Error("E_CSS_URL_NOT_ALLOWED");};n.hb=function(){throw Error("E_CSS_LIST_NOT_ALLOWED");};n.tb=function(){throw Error("E_CSS_COMMA_NOT_ALLOWED");};n.kb=function(){throw Error("E_CSS_FUNC_NOT_ALLOWED");};n.Rb=function(){throw Error("E_CSS_EXPR_NOT_ALLOWED");};function dd(){}t(dd,cd);n=dd.prototype;
n.vb=function(a){for(var b=null,c=0;c<a.length;c++){var d=a[c],e=d.U(this);if(b)b[c]=e;else if(d!==e){b=Array(a.length);for(d=0;d<c;d++)b[d]=a[d];b[c]=e}}return b||a};n.nc=function(a){return a};n.ub=function(a){return a};n.pd=function(a){return a};n.Ub=function(a){return a};n.Tb=function(a){return a};n.Sb=function(a){return a};n.Kc=function(a){return a};n.Vb=function(a){return a};n.hb=function(a){var b=this.vb(a.values);return b===a.values?a:new ed(b)};
n.tb=function(a){var b=this.vb(a.values);return b===a.values?a:new fd(b)};n.kb=function(a){var b=this.vb(a.values);return b===a.values?a:new gd(a.name,b)};n.Rb=function(a){return a};function hd(){}n=hd.prototype;n.toString=function(){var a=new Ka;this.Ba(a,!0);return a.toString()};n.stringValue=function(){var a=new Ka;this.Ba(a,!1);return a.toString()};n.la=function(){throw Error("F_ABSTRACT");};n.Ba=function(a){a.append("[error]")};n.yd=function(){return!1};n.ac=function(){return!1};n.Ad=function(){return!1};
n.Pd=function(){return!1};n.ad=function(){return!1};function id(){if(F)throw Error("E_INVALID_CALL");}t(id,hd);id.prototype.la=function(a){return new gc(a,"")};id.prototype.Ba=function(){};id.prototype.U=function(a){return a.od(this)};var F=new id;function jd(){if(kd)throw Error("E_INVALID_CALL");}t(jd,hd);jd.prototype.la=function(a){return new gc(a,"/")};jd.prototype.Ba=function(a){a.append("/")};jd.prototype.U=function(a){return a.pd(this)};var kd=new jd;function ld(a){this.b=a}t(ld,hd);
ld.prototype.la=function(a){return new gc(a,this.b)};ld.prototype.Ba=function(a,b){b?(a.append('"'),a.append(Oa(this.b)),a.append('"')):a.append(this.b)};ld.prototype.U=function(a){return a.nc(this)};function md(a){this.name=a;if(bd[a])throw Error("E_INVALID_CALL");bd[a]=this}t(md,hd);md.prototype.la=function(a){return new gc(a,this.name)};md.prototype.Ba=function(a,b){b?a.append(Na(this.name)):a.append(this.name)};md.prototype.U=function(a){return a.ub(this)};md.prototype.Pd=function(){return!0};
function G(a){var b=bd[a];b||(b=new md(a));return b}function H(a,b){this.C=a;this.Y=b.toLowerCase()}t(H,hd);H.prototype.la=function(a,b){return 0==this.C?a.b:b&&"%"==this.Y?100==this.C?b:new Pc(a,b,new gc(a,this.C/100)):new Sc(a,this.C,this.Y)};H.prototype.Ba=function(a){a.append(this.C.toString());a.append(this.Y)};H.prototype.U=function(a){return a.Ub(this)};H.prototype.ac=function(){return!0};function nd(a){this.C=a}t(nd,hd);
nd.prototype.la=function(a){return 0==this.C?a.b:1==this.C?a.d:new gc(a,this.C)};nd.prototype.Ba=function(a){a.append(this.C.toString())};nd.prototype.U=function(a){return a.Tb(this)};nd.prototype.Ad=function(){return!0};function od(a){this.C=a}t(od,nd);od.prototype.U=function(a){return a.Sb(this)};function pd(a){this.b=a}t(pd,hd);pd.prototype.Ba=function(a){a.append("#");var b=this.b.toString(16);a.append("000000".substr(b.length));a.append(b)};pd.prototype.U=function(a){return a.Kc(this)};
function qd(a){this.url=a}t(qd,hd);qd.prototype.Ba=function(a){a.append('url("');a.append(Oa(this.url));a.append('")')};qd.prototype.U=function(a){return a.Vb(this)};function rd(a,b,c,d){var e=b.length;b[0].Ba(a,d);for(var f=1;f<e;f++)a.append(c),b[f].Ba(a,d)}function ed(a){this.values=a}t(ed,hd);ed.prototype.Ba=function(a,b){rd(a,this.values," ",b)};ed.prototype.U=function(a){return a.hb(this)};ed.prototype.ad=function(){return!0};function fd(a){this.values=a}t(fd,hd);
fd.prototype.Ba=function(a,b){rd(a,this.values,",",b)};fd.prototype.U=function(a){return a.tb(this)};function gd(a,b){this.name=a;this.values=b}t(gd,hd);gd.prototype.Ba=function(a,b){a.append(Na(this.name));a.append("(");rd(a,this.values,",",b);a.append(")")};gd.prototype.U=function(a){return a.kb(this)};function I(a){this.d=a}t(I,hd);I.prototype.la=function(){return this.d};I.prototype.Ba=function(a){a.append("-epubx-expr(");this.d.oa(a,0);a.append(")")};I.prototype.U=function(a){return a.Rb(this)};
...
function Ke(a,b,c,d,e){e&&(a=Ie(a),b=Ya(b,Je),c=Ya(c,Je));e=b.length;var f=c?c.length:0,g=[],h=[],l,k,m;for(l=0;l<e;l++)ye(b[l],h,l);for(l=0;l<f;l++)ye(c[l],h,l+e);b=h.length;h.sort(we);for(c=0;h[c].e>=e;)c++;c=h[c].b.y;c>a.W&&g.push(new ve(a.W,c,a.V,a.V));l=0;for(var p=[];l<b&&(m=h[l]).b.y<c;)m.d.y>c&&p.push(m),l++;for(;l<b||0<p.length;){var q=a.S,w=Fe(Math.ceil(c+8),d);for(k=0;k<p.length&&q>w;k++)m=p[k],m.b.x==m.d.x?m.d.y<q&&(q=Math.max(Ge(m.d.y,d),w)):m.b.x!=m.d.x&&(q=w);q>a.S&&(q=a.S);for(;l<
b&&(m=h[l]).b.y<q;)if(m.d.y<c)l++;else if(m.b.y<w){if(m.b.y!=m.d.y||m.b.y!=c)p.push(m),q=w;l++}else{k=Ge(m.b.y,d);k<q&&(q=k);break}w=[];for(k=0;k<p.length;k++)De(w,p[k],c,q);w.sort(function(a,b){return a.x-b.x||a.d-b.d});w=Ee(w,e,f);if(0==w.length)g.push(new ve(c,q,a.V,a.V));else{var r=0,y=a.ca;for(k=0;k<w.length;k+=2){var O=Math.max(a.ca,w[k]),X=Math.min(a.V,w[k+1])-O;X>r&&(r=X,y=O)}0==r?g.push(new ve(c,q,a.V,a.V)):g.push(new ve(c,q,Math.max(y,a.ca),Math.min(y+r,a.V)))}if(q==a.S)break;c=q;for(k=
p.length-1;0<=k;k--)p[k].d.y<=q&&p.splice(k,1)}Le(a,g);return g}function Le(a,b){for(var c=b.length-1,d=new ve(a.S,a.S,a.ca,a.V);0<=c;){var e=d,d=b[c];d.ca==e.ca&&d.V==e.V&&(e.W=d.W,b.splice(c,1),d=e);c--}}function Me(a,b){for(var c=0,d=a.length;c<d;){var e=Math.floor((c+d)/2);b>=a[e].S?c=e+1:d=e}return c}
function Ne(a,b,c,d){for(var e=c.W,f=c.V-c.ca,g=c.S-c.W,h=Me(b,e);;){var l=e+g;if(l>a.S)break;for(var k=a.ca,m=a.V,p=h;p<b.length&&b[p].W<l;p++){var q=b[p];q.ca>k&&(k=q.ca);q.V<m&&(m=q.V)}if(k+f<=m||h>=b.length){"left"==d?(c.ca=k,c.V=k+f):(c.ca=m-f,c.V=m);c.S+=e-c.W;c.W=e;break}e=b[h].S;h++}}
...
l=k}f.b[l]=g}if(!c.f){var l=c,m=l.d;l.d=null;m&&m.b==l&&(m.b=null,k=Te,Te=m,N(m.top,l.e),Te=k)}b=a.e.currentTime();if(b>=a.h)break}}catch(p){u.error(p)}a.g=!1;a.d.length()&&ef(a)},b)}}bf.prototype.Pa=function(a,b){var c=this.e.currentTime();a.Q=this.Q++;a.b=c+(b||0);a:{for(var c=this.d,d=c.b.length;1<d;){var e=Math.floor(d/2),f=c.b[e];if(0<ff(f,a)){c.b[d]=a;break a}c.b[d]=f;d=e}c.b[1]=a}ef(this)};
function af(a,b,c){var d=new gf(a,c||"");d.top=new Ve(d,null,"bootstrap");d.top.b=We;d.top.then(function(){function a(){d.h=!1;for(var b=0;b<d.g.length;b++){var c=d.g[b];try{c()}catch(e){u.error(e)}}}try{b().then(function(b){d.f=b;a()})}catch(c){Ze(d,c),a()}});c=Te;Te=d;a.Pa(hf(d.top,"bootstrap"));Te=c;return d}function jf(a){this.d=a;this.Q=this.b=0;this.e=null;this.f=!1}function ff(a,b){return b.b-a.b||b.Q-a.Q}jf.prototype.Pa=function(a,b){this.e=a;this.d.d.Pa(this,b)};
function gf(a,b){this.d=a;this.name=b;this.g=[];this.e=null;this.h=!0;this.b=this.top=this.j=this.f=null}function kf(a,b){a.g.push(b)}gf.prototype.join=function(){var a=K("Task.join");if(this.h){var b=hf(a,this),c=this;kf(this,function(){b.Pa(c.f)})}else N(a,this.f);return M(a)};
function Ze(a,b,c){var d=b.frameTrace;if(!d){for(var d=b.stack?b.stack+"\n\t---- async ---\n":"",e=a.top;e;e=e.parent)d+="\t",d+=e.name,d+="\n";b.frameTrace=d}if(c){for(d=a.top;d&&d!=c;)d=d.parent;d==c&&(a.top=d)}for(a.e=b;a.top&&!a.top.g;)a.top=a.top.parent;a.top?(b=a.e,a.e=null,a.top.g(a.top,b)):a.e&&u.error(a.e,"Unhandled exception in task",a.name)}function Xe(a){this.value=a}n=Xe.prototype;n.then=function(a){a(this.value)};n.Qb=function(a){return a(this.value)};n.md=function(a){return new Xe(a)};
n.ua=function(a){N(a,this.value)};n.Ca=function(){return!1};n.get=function(){return this.value};function lf(a){this.b=a}n=lf.prototype;n.then=function(a){this.b.then(a)};n.Qb=function(a){if(this.Ca()){var b=new Ve(this.b.d,this.b.parent,"AsyncResult.thenAsync");b.b=We;this.b.parent=b;this.b.then(function(c){a(c).then(function(a){N(b,a)})});return M(b)}return a(this.b.e)};n.md=function(a){return this.Ca()?this.Qb(function(){return new Xe(a)}):new Xe(a)};
...
function nf(){var a=K("Frame.timeSlice"),b=a.d.d;b.e.currentTime()>=b.h?(u.debug("-- time slice --"),hf(a).Pa(!0)):N(a,!0);return M(a)}function of(a){var b=K("Frame.sleep");hf(b).Pa(!0,a);return M(b)}function pf(a){function b(d){try{for(;d;){var e=a();if(e.Ca()){e.then(b);return}e.then(function(a){d=a})}N(c,!0)}catch(f){Ze(c.d,f,c)}}var c=K("Frame.loop");b(!0);return M(c)}
...
c.replace(/(.*);.*$/,"$1")}else l.responseXML=g.responseXML,l.contentType=g.responseXML.contentType;h.Pa(l)}};try{d?(g.setRequestHeader("Content-Type",e||"text/plain; charset=UTF-8"),g.send(d)):g.send(null)}catch(k){u.b(k,"Error fetching "+a),h.Pa(l)}return M(f)}function uf(a){var b=window.WebKitBlobBuilder||window.MSBlobBuilder;if(b){for(var b=new b,c=0;c<a.length;c++)b.append(a[c]);return b.getBlob("application/octet-stream")}return new Blob(a,{type:"application/octet-stream"})}
function vf(a){var b=K("readBlob"),c=new FileReader,d=hf(b,c);c.addEventListener("load",function(){d.Pa(c.result)},!1);c.readAsArrayBuffer(a);return M(b)}function wf(a,b){this.O=a;this.type=b;this.f={};this.g={}}wf.prototype.load=function(a,b,c){a=wa(a);var d=this.f[a];return"undefined"!=typeof d?L(d):this.tc(a,b,c).get()};
...
function zf(a){a=a.responseText;return L(a?JSON.parse(a):null)};function Af(a){var b=parseInt(a,16);if(isNaN(b))throw Error("E_CSS_COLOR");if(6==a.length)return new pd(b);if(3==a.length)return new pd(b&15|(b&15)<<4|(b&240)<<4|(b&240)<<8|(b&3840)<<8|(b&3840)<<12);throw Error("E_CSS_COLOR");}function Bf(a){this.d=a;this.La="Author"}n=Bf.prototype;n.Zb=function(){return null};n.$=function(){return this.d};n.error=function(){};n.Pb=function(a){this.La=a};n.jb=function(){};n.Rc=function(){};n.dc=function(){};n.ec=function(){};n.Xc=function(){};n.rc=function(){};
n.mb=function(){};n.Qc=function(){};n.Pc=function(){};n.Uc=function(){};n.Mb=function(){};n.gb=function(){};n.Dc=function(){};n.hc=function(){};n.Hc=function(){};n.Bc=function(){};n.Gc=function(){};n.Ob=function(){};n.ld=function(){};n.Fb=function(){};n.Cc=function(){};n.Fc=function(){};n.Ec=function(){};n.kc=function(){};n.jc=function(){};n.qa=function(){};n.eb=function(){};n.nb=function(){};n.ic=function(){};n.sc=function(){};
...
function dg(a,b,c,d,e,f){var g=a.j,h=a.d,l=a.u,k,m,p,q;e&&(a.g=2,a.u.push("{"));a:for(;0<b;--b)switch(k=x(h),a.b[k.type]){case 28:if(18!=z(h,1).type){cg(a)?(g.error("E_CSS_COLON_EXPECTED",z(h,1)),a.b=Sf):(a.b=Of,g.gb());continue}m=z(h,2);if(!(m.b||1!=m.type&&6!=m.type)){if(0<=h.b)throw Error("F_CSSTOK_BAD_CALL mark");h.b=h.d}a.e=k.text;a.l=!1;A(h);A(h);a.b=Pf;l.splice(0,l.length);continue;case 46:if(18!=z(h,1).type){a.b=Sf;g.error("E_CSS_COLON_EXPECTED",z(h,1));continue}a.e=k.text;a.l=!1;A(h);A(h);
...
k);continue}g.mb();case 4:if(34==z(h,1).type)switch(A(h),A(h),k=x(h),k.type){case 1:g.jb(null,k.text);a.b=f?Mf:Q;A(h);break;case 36:g.jb(null,null);a.b=f?Mf:Q;A(h);break;default:a.b=Rf,g.error("E_CSS_NAMESPACE",k)}else g.jb(a.D,null),a.b=f?Mf:Q,A(h);continue;case 5:k.b&&g.mb();case 6:g.Xc(k.text);a.b=f?Mf:Q;A(h);continue;case 7:k.b&&g.mb();case 8:g.Rc(k.text);a.b=f?Mf:Q;A(h);continue;case 55:k.b&&g.mb();case 14:A(h);k=x(h);b:switch(k.type){case 1:g.dc(k.text,null);A(h);a.b=f?Mf:Q;continue;case 6:m=
...
k);continue}m=k.text;A(h);k=x(h)}else p="";switch(k.type){case 39:case 45:case 44:case 43:case 42:case 46:case 50:q=k.type;A(h);k=x(h);break;case 15:g.rc(p,m,0,null);a.b=f?Mf:Q;A(h);continue;default:a.b=Tf;g.error("E_CSS_ATTR_OP_EXPECTED",k);continue}switch(k.type){case 1:case 2:g.rc(p,m,q,k.text);A(h);k=x(h);break;default:a.b=Tf;g.error("E_CSS_ATTR_VAL_EXPECTED",k);continue}if(15!=k.type){a.b=Tf;g.error("E_CSS_ATTR",k);continue}a.b=f?Mf:Q;A(h);continue;case 11:g.Qc();a.b=Nf;A(h);continue;case 12:g.Pc();
a.b=Nf;A(h);continue;case 56:g.Uc();a.b=Nf;A(h);continue;case 13:a.O?(a.f.push("-epubx-region"),a.O=!1):a.N?(a.f.push("page"),a.N=!1):a.f.push("[selector]");g.qa();a.b=Kf;A(h);continue;case 41:g.Mb();a.b=Of;A(h);continue;case 15:l.push(G(k.text));A(h);continue;case 16:try{l.push(Af(k.text))}catch(w){g.error("E_CSS_COLOR",k),a.b=Rf}A(h);continue;case 17:l.push(new nd(k.C));A(h);continue;case 18:l.push(new od(k.C));A(h);continue;case 19:l.push(new H(k.C,k.text));A(h);continue;case 20:l.push(new ld(k.text));
...
function vg(a){if(0==a.length)return L(!0);if(1==a.length)return a[0].get().md(!0);var b=K("waitForFetches"),c=0;pf(function(){for(;c<a.length;){var b=a[c++];if(!b.d)return b.get().md(!0)}return L(!1)}).then(function(){N(b,!0)});return M(b)}
function wg(a,b){var c=null,d=null;"img"==a.localName&&(c=a.getAttribute("width"),d=a.getAttribute("height"));var e=new yf(function(){function e(b){l||(l=!0,"img"==a.localName&&(c||a.removeAttribute("width"),d||a.removeAttribute("height")),h.Pa(b?b.type:"timeout"))}var g=K("loadImage"),h=hf(g,a),l=!1;a.addEventListener("load",e,!1);a.addEventListener("error",e,!1);a.addEventListener("abort",e,!1);"http://www.w3.org/2000/svg"==a.namespaceURI?(a.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",
...
n.Kc=function(a){return this.b&64?a:null};n.Vb=function(a){return this.b&128?a:null};n.hb=function(){return null};n.tb=function(){return null};n.kb=function(){return null};n.Rb=function(){return null};var Cg=new Eg(0,T,T);
...
continue}}else m=k.U(f.b);if(m){if(m!==k&&b===e)for(e=[],k=0;k<g;k++)e[k]=b[k];b!==e&&(e[g-d]=m);g++;f=f.f}else f=f.e}}return f===a.b&&(c?0<e.length:g==b.length)?e:null}n=Hg.prototype;n.Za=function(a){for(var b=null,c=this.d;c!==this.b&&c!==this.e;)a?0!=c.d?c=c.f:(b=a.U(c.b))?(a=null,c=c.f):c=c.e:c=c.e;return c===this.b?b:null};n.od=function(a){return this.Za(a)};n.pd=function(a){return this.Za(a)};n.nc=function(a){return this.Za(a)};n.ub=function(a){return this.Za(a)};n.Ub=function(a){return this.Za(a)};
n.Tb=function(a){return this.Za(a)};n.Sb=function(a){return this.Za(a)};n.Kc=function(a){return this.Za(a)};n.Vb=function(a){return this.Za(a)};n.hb=function(){return null};n.tb=function(){return null};n.kb=function(a){return this.Za(a)};n.Rb=function(){return null};function Jg(a){Hg.call(this,a)}t(Jg,Hg);Jg.prototype.hb=function(a){var b=Ig(this,a.values,!1,0);return b===a.values?a:b?new ed(b):null};
Jg.prototype.tb=function(a){for(var b=this.d,c=!1;b;){if(b.b instanceof Kg){c=!0;break}b=b.e}return c?(b=Ig(this,a.values,!1,0),b===a.values?a:b?new fd(b):null):null};Jg.prototype.f=function(a,b){return Ig(this,a,!0,b)};function Kg(a){Hg.call(this,a)}t(Kg,Hg);Kg.prototype.hb=function(a){return this.Za(a)};Kg.prototype.tb=function(a){var b=Ig(this,a.values,!1,0);return b===a.values?a:b?new fd(b):null};Kg.prototype.f=function(a,b){for(var c=this.d,d;c!==this.e;){if(d=c.b.f(a,b))return d;c=c.e}return null};
function Lg(a,b){Hg.call(this,b);this.name=a}t(Lg,Hg);Lg.prototype.Za=function(){return null};Lg.prototype.kb=function(a){if(a.name.toLowerCase()!=this.name)return null;var b=Ig(this,a.values,!1,0);return b===a.values?a:b?new gd(a.name,b):null};function Mg(){}Mg.prototype.b=function(a,b){return b};Mg.prototype.e=function(){};function Ng(a,b){this.name=b;this.f=a.e[this.name]}t(Ng,Mg);
...
Pg.prototype.b=function(a,b,c){var d=b;if(this.Ed)if(a[b]==kd){if(++b==a.length)return d}else return d;var e=this.d[0].b(a,b,c);if(e==b)return d;b=e;for(d=1;d<this.d.length&&b<a.length;d++){e=this.d[d].b(a,b,c);if(e==b)break;b=e}return b};function Qg(){this.b=this.Xa=null;this.error=!1;this.values={};this.d=null}n=Qg.prototype;n.clone=function(){var a=new this.constructor;a.Xa=this.Xa;a.b=this.b;a.d=this.d;return a};n.sd=function(a,b){this.Xa=a;this.b=b};n.Ib=function(){this.error=!0;return 0};
function Rg(a,b){a.Ib([b]);return null}n.od=function(a){return Rg(this,a)};n.nc=function(a){return Rg(this,a)};n.ub=function(a){return Rg(this,a)};n.Ub=function(a){return Rg(this,a)};n.Tb=function(a){return Rg(this,a)};n.Sb=function(a){return Rg(this,a)};n.Kc=function(a){return Rg(this,a)};n.Vb=function(a){return Rg(this,a)};n.hb=function(a){this.Ib(a.values);return null};n.tb=function(){this.error=!0;return null};n.kb=function(a){return Rg(this,a)};n.Rb=function(){this.error=!0;return null};
function Sg(){Qg.call(this)}t(Sg,Qg);Sg.prototype.Ib=function(a){for(var b=0,c=0;b<a.length;){var d=this.Xa[c].b(a,b,this);if(d>b)b=d,c=0;else if(++c==this.Xa.length){this.error=!0;break}}return b};function Tg(){Qg.call(this)}t(Tg,Qg);Tg.prototype.Ib=function(a){if(a.length>this.Xa.length||0==a.length)return this.error=!0,0;for(var b=0;b<this.Xa.length;b++){for(var c=b;c>=a.length;)c=1==c?0:c-2;if(this.Xa[b].b(a,c,this)!=c+1)return this.error=!0,0}return a.length};function Ug(){Qg.call(this)}
t(Ug,Qg);Ug.prototype.Ib=function(a){for(var b=a.length,c=0;c<a.length;c++)if(a[c]===kd){b=c;break}if(b>this.Xa.length||0==a.length)return this.error=!0,0;for(c=0;c<this.Xa.length;c++){for(var d=c;d>=b;)d=1==d?0:d-2;var e;if(b+1<a.length)for(e=b+c+1;e>=a.length;)e-=e==b+2?1:2;else e=d;if(2!=this.Xa[c].b([a[d],a[e]],0,this))return this.error=!0,0}return a.length};function Vg(){Qg.call(this)}t(Vg,Sg);
...
d=p.Gd;d.push(bh(p.Lb,g));f=p.Cd;h=!1;break;case 18:if(h)throw Error("':' unexpected");A(b);d.push(Zg(d.pop(),x(b)));break;case 22:if(h)throw Error("'?' unexpected");d.push($g(d.pop(),0,1));break;case 36:if(h)throw Error("'*' unexpected");d.push($g(d.pop(),0,Number.POSITIVE_INFINITY));break;case 23:if(h)throw Error("'+' unexpected");d.push($g(d.pop(),1,Number.POSITIVE_INFINITY));break;case 12:A(b);g=x(b);if(5!=g.type)throw Error("<int> expected");var q=p=g.C;A(b);g=x(b);if(16==g.type){A(b);g=x(b);
if(5!=g.type)throw Error("<int> expected");q=g.C;A(b);g=x(b)}if(13!=g.type)throw Error("'}' expected");d.push($g(d.pop(),p,q));break;case 17:m=l();if(0<e.length)throw Error("unclosed '"+e.pop().Wb+"'");break;default:throw Error("unexpected token");}A(b);dh(c)?a.b[c]=m:a.e[c]=1!=m.b.length||0!=m.b[0].d?new Jg(m):m.b[0].b}}
...
function th(a,b,c,d){var e=K("initFont"),f=b.src,g={},h;for(h in jh)g[h]=b.Cb[h];d=sh(a,b,d);g["font-family"]=G(d);var l=new nh(g),k=a.b.ownerDocument.createElement("span");k.textContent="M";var m=(new Date).valueOf()+1E3;b=a.d.ownerDocument.createElement("style");h=kh+lh++;b.textContent=oh(l,"",uf([h]));a.d.appendChild(b);a.b.appendChild(k);k.style.visibility="hidden";k.style.fontFamily=d;for(var p in jh)v(k,p,g[p].toString());var g=k.getBoundingClientRect(),q=g.right-g.left,w=g.bottom-g.top;b.textContent=
oh(l,f,c);u.e("Starting to load font:",f);var r=!1;pf(function(){var a=k.getBoundingClientRect(),b=a.bottom-a.top;return q!=a.right-a.left||w!=b?(r=!0,L(!1)):(new Date).valueOf()>m?L(!1):of(10)}).then(function(){r?u.e("Loaded font:",f):u.b("Failed to load font:",f);a.b.removeChild(k);N(e,l)});return M(e)}
...
function Di(a){this.element=a;this.F=this.D=this.height=this.width=this.u=this.k=this.w=this.j=this.Aa=this.Z=this.Ja=this.O=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.xb=this.G=null;this.na=this.yb=this.Sa=this.Hb=this.d=0;this.b=!1}function Ei(a){return a.marginTop+a.Z+a.k}function Fi(a){return a.marginBottom+a.Aa+a.u}function Gi(a){return a.marginLeft+a.O+a.j}function Hi(a){return a.marginRight+a.Ja+a.w}
function Ji(a,b){a.element=b.element;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.O=b.O;a.Ja=b.Ja;a.Z=b.Z;a.Aa=b.Aa;a.j=b.j;a.w=b.w;a.k=b.k;a.u=b.u;a.width=b.width;a.height=b.height;a.D=b.D;a.F=b.F;a.xb=b.xb;a.G=b.G;a.d=b.d;a.Hb=b.Hb;a.Sa=b.Sa;a.b=b.b}function Ki(a,b,c){a.top=b;a.height=c;v(a.element,"top",b+"px");v(a.element,"height",c+"px")}
...
function Oj(){this.b=null}t(Oj,V);Oj.prototype.apply=function(a){a.Ja&&this.b.apply(a)};Oj.prototype.d=function(){return 6};function Pj(){this.b=null}t(Pj,V);Pj.prototype.apply=function(a){a.ja&&this.b.apply(a)};Pj.prototype.d=function(){return 12};function Qj(a,b){this.b=null;this.f=a;this.Wb=b}t(Qj,V);function Rj(a,b){var c=a.f;b-=a.Wb;return 0===c?0===b:0===b%c&&0<=b/c}function Sj(a,b){Qj.call(this,a,b)}t(Sj,Qj);Sj.prototype.apply=function(a){Rj(this,a.Aa)&&this.b.apply(a)};Sj.prototype.d=function(){return 5};
function Tj(a,b){Qj.call(this,a,b)}t(Tj,Qj);Tj.prototype.apply=function(a){Rj(this,a.Sa[a.e][a.d])&&this.b.apply(a)};Tj.prototype.d=function(){return 5};function Uj(a,b){Qj.call(this,a,b)}t(Uj,Qj);Uj.prototype.apply=function(a){var b=a.G;null===b&&(b=a.G=a.b.parentNode.childElementCount-a.Aa+1);Rj(this,b)&&this.b.apply(a)};Uj.prototype.d=function(){return 4};function Vj(a,b){Qj.call(this,a,b)}t(Vj,Qj);
Vj.prototype.apply=function(a){var b=a.Ra;if(!b[a.e]){var c=a.b;do{var d=c.namespaceURI,e=c.localName,f=b[d];f||(f=b[d]={});f[e]=(f[e]||0)+1}while(c=c.nextElementSibling)}Rj(this,b[a.e][a.d])&&this.b.apply(a)};Vj.prototype.d=function(){return 4};function Wj(){this.b=null}t(Wj,V);Wj.prototype.apply=function(a){for(var b=a.b.firstChild;b;){switch(b.nodeType){case Node.ELEMENT_NODE:return;case Node.TEXT_NODE:if(0<b.length)return}b=b.nextSibling}this.b.apply(a)};Wj.prototype.d=function(){return 4};
...
function Gk(a,b,c,d){this.k=a;this.h=b;this.Hb=c;this.Qa=d;this.g=[[],[]];this.j={};this.w=this.u=this.b=null;this.na=this.Z=this.N=this.e=this.d="";this.O=this.F=null;this.ja=this.Ja=!0;this.f={};this.A=[{}];this.D=[new ld("\u201c"),new ld("\u201d"),new ld("\u2018"),new ld("\u2019")];this.l=0;this.lang="";this.yb=[0];this.Aa=0;this.ia=[{}];this.Sa=this.ia[0];this.G=null;this.wb=[this.G];this.xb=[{}];this.Ra=this.ia[0];this.ib=[]}function ek(a,b){a.j[b]=(a.j[b]||0)+1}
...
"lang"))||"http://www.w3.org/1999/xhtml"!=a.e||(d=b.getAttribute("lang"));d&&(a.g[a.g.length-1].push(new kk(a.lang)),a.lang=d.toLowerCase());var d=a.ja,e=a.yb;a.Aa=++e[e.length-1];e.push(0);var e=a.ia,f=a.Sa=e[e.length-1],g=f[a.e];g||(g=f[a.e]={});g[a.d]=(g[a.d]||0)+1;e.push({});e=a.wb;null!==e[e.length-1]?a.G=--e[e.length-1]:a.G=null;e.push(null);e=a.xb;(f=a.Ra=e[e.length-1])&&f[a.e]&&f[a.e][a.d]--;e.push({});Kk(a);Qk(a,b);e=c.quotes;c=null;e&&(e=e.evaluate(a.h))&&(c=new lk(a.D),e===J?a.D=[new ld(""),
...
this.b.push(new ak(""))}this.P+=1};Uk.prototype.Xc=function(a){this.P+=65536;this.b.push(new Ej(a))};
...
d?e=new Lj(a,b):(u.b("Unsupported :: attr selector op:",d),e=new ak(""));break;default:u.b("Unsupported attr selector:",c),e=new ak("")}this.b.push(e)};var Xk=0;n=Uk.prototype;n.mb=function(){var a="d"+Xk++;Vk(this,new Aj(new dk(a)));this.b=[new ak(a)]};n.Qc=function(){var a="c"+Xk++;Vk(this,new Aj(new fk(a)));this.b=[new ak(a)]};n.Pc=function(){var a="a"+Xk++;Vk(this,new Aj(new gk(a)));this.b=[new ak(a)]};n.Uc=function(){var a="f"+Xk++;Vk(this,new Aj(new hk(a)));this.b=[new ak(a)]};
...
function yl(a,b,c,d,e,f,g,h){this.X=a;this.root=a.root;this.Aa=c;this.f=d;this.j=f;this.d=this.root;this.F={};this.G={};this.l={};this.w=[];this.k=this.D=this.A=null;this.N=new Gk(b,d,g,h);this.e=new gl;this.Oa=!0;this.Z=[];this.na=e;this.ja=this.ia=!1;this.b=a=zh(a,this.root);this.O={};this.g=new ul(d);il(this.e,a);d=zl(this,this.root);Pk(this.N,this.root,d);Al(this,d,!1);this.u=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.u=
...
function Hl(a,b,c,d,e){var f=0,g=Number.POSITIVE_INFINITY,h=!1,l=!1,k=!1,m=c["flow-options"];if(m){var p;a:{if(h=m.evaluate(a.f,"flow-options")){l=new mg;try{h.U(l);p=l.b;break a}catch(q){u.b(q,"toSet:")}}p={}}h=!!p.exclusive;l=!!p["static"];k=!!p.last}(p=c["flow-linger"])&&(g=og(p.evaluate(a.f,"flow-linger"),Number.POSITIVE_INFINITY));(c=c["flow-priority"])&&(f=og(c.evaluate(a.f,"flow-priority"),0));c=a.O[e]||null;p=a.l[b];p||(p=vl(a.g),p=a.l[b]=new fi(p?p.g.b:null));d=new gi(b,d,e,f,g,h,l,k,c);
...
Wl.prototype.clone=function(a){a=new Wl(a.parent.d,this.name,this.sb,this.va,a.parent);Nl(this,a);Ol(this,a);return a};function W(a,b,c){return b&&b!==wd?b.la(a,c):null}function Yl(a,b,c){return b&&b!==wd?b.la(a,c):a.b}function Zl(a,b,c){return b?b===wd?null:b.la(a,c):a.b}function $l(a,b,c,d){return b&&c!==J?b.la(a,d):a.b}function am(a,b,c){return b?b===ke?a.g:b===Gd?a.f:b.la(a,a.b):c}
...
function Rl(a,b){var c=a.ia[b];if(c)return c;var d=a.style[b];d&&(c=d.la(a.d.d,a.d.d.b));switch(b){case "margin-left-edge":c=Rl(a,"left");break;case "margin-top-edge":c=Rl(a,"top");break;case "margin-right-edge":c=fm(a,"border-right-edge","margin-right");break;case "margin-bottom-edge":c=fm(a,"border-bottom-edge","margin-bottom");break;case "border-left-edge":c=fm(a,"margin-left-edge","margin-left");break;case "border-top-edge":c=fm(a,"margin-top-edge","margin-top");break;case "border-right-edge":c=
...
function gm(a){var b=a.d.d,c=a.style,d=am(b,c.enabled,b.g),e=W(b,c.page,b.b);if(e)var f=new Tc(b,"page-number"),d=Zc(b,d,new Lc(b,e,f));(e=W(b,c["min-page-width"],b.b))&&(d=Zc(b,d,new Kc(b,new Tc(b,"page-width"),e)));(e=W(b,c["min-page-height"],b.b))&&(d=Zc(b,d,new Kc(b,new Tc(b,"page-height"),e)));d=a.N(d);c.enabled=new I(d)}bm.prototype.N=function(a){return a};
bm.prototype.Yc=function(){var a=this.d.d,b=this.style,c=this.e?this.e.style.width.la(a,null):null,d=W(a,b.left,c),e=W(a,b["margin-left"],c),f=$l(a,b["border-left-width"],b["border-left-style"],c),g=Yl(a,b["padding-left"],c),h=W(a,b.width,c),l=W(a,b["max-width"],c),k=Yl(a,b["padding-right"],c),m=$l(a,b["border-right-width"],b["border-right-style"],c),p=W(a,b["margin-right"],c),q=W(a,b.right,c),w=C(a,f,g),r=C(a,f,k);d&&q&&h?(w=D(a,c,C(a,h,C(a,C(a,d,w),r))),e?p?q=D(a,w,p):p=D(a,w,C(a,q,e)):(w=D(a,w,
q),p?e=D(a,w,p):p=e=$c(a,w,new gc(a,.5)))):(e||(e=a.b),p||(p=a.b),d||q||h||(d=a.b),d||h?d||q?h||q||(h=this.l,this.g=!0):d=a.b:(h=this.l,this.g=!0),w=D(a,c,C(a,C(a,e,w),C(a,p,r))),this.g&&(l||(l=D(a,w,d?d:q)),this.b||!W(a,b["column-width"],null)&&!W(a,b["column-count"],null)||(h=l,this.g=!1)),d?h?q||(q=D(a,w,C(a,d,h))):h=D(a,w,C(a,d,q)):d=D(a,w,C(a,q,h)));a=Yl(a,b["snap-width"]||(this.e?this.e.style["snap-width"]:null),c);b.left=new I(d);b["margin-left"]=new I(e);b["border-left-width"]=new I(f);b["padding-left"]=
new I(g);b.width=new I(h);b["max-width"]=new I(l?l:h);b["padding-right"]=new I(k);b["border-right-width"]=new I(m);b["margin-right"]=new I(p);b.right=new I(q);b["snap-width"]=new I(a)};
bm.prototype.Zc=function(){var a=this.d.d,b=this.style,c=this.e?this.e.style.width.la(a,null):null,d=this.e?this.e.style.height.la(a,null):null,e=W(a,b.top,d),f=W(a,b["margin-top"],c),g=$l(a,b["border-top-width"],b["border-top-style"],c),h=Yl(a,b["padding-top"],c),l=W(a,b.height,d),k=W(a,b["max-height"],d),m=Yl(a,b["padding-bottom"],c),p=$l(a,b["border-bottom-width"],b["border-bottom-style"],c),q=W(a,b["margin-bottom"],c),w=W(a,b.bottom,d),r=C(a,g,h),y=C(a,p,m);e&&w&&l?(d=D(a,d,C(a,l,C(a,C(a,e,r),
y))),f?q?w=D(a,d,f):q=D(a,d,C(a,w,f)):(d=D(a,d,w),q?f=D(a,d,q):q=f=$c(a,d,new gc(a,.5)))):(f||(f=a.b),q||(q=a.b),e||w||l||(e=a.b),e||l?e||w?l||w||(l=this.k,this.f=!0):e=a.b:(l=this.k,this.f=!0),d=D(a,d,C(a,C(a,f,r),C(a,q,y))),this.f&&(k||(k=D(a,d,e?e:w)),this.b&&(W(a,b["column-width"],null)||W(a,b["column-count"],null))&&(l=k,this.f=!1)),e?l?w||(w=D(a,d,C(a,e,l))):l=D(a,d,C(a,w,e)):e=D(a,d,C(a,w,l)));a=Yl(a,b["snap-height"]||(this.e?this.e.style["snap-height"]:null),c);b.top=new I(e);b["margin-top"]=
new I(f);b["border-top-width"]=new I(g);b["padding-top"]=new I(h);b.height=new I(l);b["max-height"]=new I(k?k:l);b["padding-bottom"]=new I(m);b["border-bottom-width"]=new I(p);b["margin-bottom"]=new I(q);b.bottom=new I(w);b["snap-height"]=new I(a)};
function hm(a){var b=a.d.d,c=a.style;a=W(b,c[a.b?"height":"width"],null);var d=W(b,c["column-width"],a),e=W(b,c["column-count"],null),f;(f=(f=c["column-gap"])&&f!==Ud?f.la(b,null):null)||(f=new Sc(b,1,"em"));d&&!e&&(e=new Vc(b,"floor",[ad(b,C(b,a,f),C(b,d,f))]),e=new Vc(b,"max",[b.d,e]));e||(e=b.d);d=D(b,ad(b,C(b,a,f),e),f);c["column-width"]=new I(d);c["column-count"]=new I(e);c["column-gap"]=new I(f)}function im(a,b,c,d){a=a.style[b].la(a.d.d,null);return vc(a,c,d,{})}
function jm(a,b){b.ia[a.d.g]=a;var c=a.d.d,d=a.style,e=a.e?km(a.e,b):null,e=dl(a.D,b,e,!1);a.b=cl(e,b,a.e?a.e.b:!1);el(e,d,a.b,function(a,b){return b.value});a.l=new jc(c,function(){return a.A},"autoWidth");a.k=new jc(c,function(){return a.w},"autoHeight");a.Yc();a.Zc();hm(a);gm(a)}function lm(a,b,c){(a=a.style[c])&&(a=lg(b,a,c));return a}function Y(a,b,c){(a=a.style[c])&&(a=lg(b,a,c));return sd(a,b)}
...
bm.prototype.rb=function(a,b,c,d){this.e&&this.b==this.e.b||v(b.element,"writing-mode",this.b?"vertical-rl":"horizontal-tb");(this.b?this.g:this.f)?this.b?vm(this,a,b):um(this,a,b):(this.b?qm(this,a,b):rm(this,a,b),this.b?pm(this,a,b):sm(this,a,b));(this.b?this.f:this.g)?this.b?um(this,a,b):vm(this,a,b):tm(this,a,b);for(c=0;c<wm.length;c++)mm(this,a,b,wm[c],d)};function Am(a,b,c,d){for(var e=0;e<ym.length;e++)mm(a,b,c,ym[e],d)}
bm.prototype.vc=function(a,b,c,d,e,f,g){this.b?this.A=b.d+b.yb:this.w=b.d+b.na;var h=(this.b||!d)&&this.f,l=(!this.b||!d)&&this.g,k=null;if(l||h)l&&v(b.element,"width","auto"),h&&v(b.element,"height","auto"),k=ci(f,d?d.element:b.element),l&&(this.A=Math.ceil(k.right-k.left-b.j-b.O-b.w-b.Ja),this.b&&(this.A+=b.yb)),h&&(this.w=k.bottom-k.top-b.k-b.Z-b.u-b.Aa,this.b||(this.w+=b.na));(this.b?this.f:this.g)&&tm(this,a,b);if(this.b?this.g:this.f){if(this.b?this.F:this.G)this.b?qm(this,a,b):rm(this,a,b);
this.b?pm(this,a,b):sm(this,a,b)}if(1<e&&(f=Y(this,a,"column-rule-width"),h=lm(this,a,"column-rule-style"),l=lm(this,a,"column-rule-color"),0<f&&h&&h!=J&&l!=ge)){var k=Y(this,a,"column-gap"),m=this.b?b.height:b.width,p=this.b?"border-top":"border-left";for(d=1;d<e;d++){var q=(m+k)*d/e-k/2+b.j-f/2,w=b.height+b.k+b.u,r=b.element.ownerDocument.createElement("div");v(r,"position","absolute");v(r,this.b?"left":"top","0px");v(r,this.b?"top":"left",q+"px");v(r,this.b?"height":"width","0px");v(r,this.b?"width":
"height",w+"px");v(r,p,f+"px "+h.toString()+(l?" "+l.toString():""));b.element.insertBefore(r,b.element.firstChild)}}for(d=0;d<xm.length;d++)mm(this,a,b,xm[d],g);for(d=0;d<zm.length;d++)e=b,g=zm[d],f=c.h,(h=lm(this,a,g))&&f.push(new Vh(e.element,g,h))};
bm.prototype.h=function(a,b){var c=this.D,d=this.d.b,e;for(e in d)qj(e)&&rj(c,e,d[e]);if("background-host"==this.d.sb)for(e in b)if(e.match(/^background-/)||"writing-mode"==e)c[e]=b[e];if("layout-host"==this.d.sb)for(e in b)e.match(/^background-/)||"writing-mode"==e||(c[e]=b[e]);Jk(a,this.d.va,null,c);c.content&&(c.content=c.content.uc(new ok(a,null,a.Qa)));jm(this,a.h);for(c=0;c<this.d.children.length;c++)this.d.children[c].f(this).h(a,b);a.pop()};
function Bm(a,b){a.g&&(a.F=im(a,"right",a.l,b)||im(a,"margin-right",a.l,b)||im(a,"border-right-width",a.l,b)||im(a,"padding-right",a.l,b));a.f&&(a.G=im(a,"top",a.k,b)||im(a,"margin-top",a.k,b)||im(a,"border-top-width",a.k,b)||im(a,"padding-top",a.k,b));for(var c=0;c<a.children.length;c++)Bm(a.children[c],b)}function Cm(a){bm.call(this,null,a)}t(Cm,bm);Cm.prototype.h=function(a,b){bm.prototype.h.call(this,a,b);this.children.sort(function(a,b){return b.d.P-a.d.P||a.d.index-b.d.index})};
function Tl(a,b){bm.call(this,a,b);this.u=this}t(Tl,bm);Tl.prototype.N=function(a){var b=this.d.e;b.M&&(a=Zc(b.d,a,b.M));return a};Tl.prototype.O=function(){};function Vl(a,b){bm.call(this,a,b);this.u=a.u}t(Vl,bm);function Xl(a,b){bm.call(this,a,b);this.u=a.u}t(Xl,bm);function Dm(a,b,c,d){var e=null;c instanceof md&&(e=[c]);c instanceof fd&&(e=c.values);if(e)for(a=a.d.d,c=0;c<e.length;c++)if(e[c]instanceof md){var f=dc(e[c].name,"enabled"),f=new Tc(a,f);d&&(f=new Bc(a,f));b=Zc(a,b,f)}return b}
Xl.prototype.N=function(a){var b=this.d.d,c=this.style,d=am(b,c.required,b.f)!==b.f;if(d||this.f){var e;e=(e=c["flow-from"])?e.la(b,b.b):new gc(b,"body");e=new Vc(b,"has-content",[e]);a=Zc(b,a,e)}a=Dm(this,a,c["required-partitions"],!1);a=Dm(this,a,c["conflicting-partitions"],!0);d&&(c=(c=this.u.style.enabled)?c.la(b,null):b.g,c=Zc(b,c,a),this.u.style.enabled=new I(c));return a};Xl.prototype.rb=function(a,b,c,d,e){v(b.element,"overflow","hidden");bm.prototype.rb.call(this,a,b,c,d,e)};
...
function Pm(a,b,c,d){this.position=a;this.f=b;this.g=c;this.e=d}Pm.prototype.d=function(a,b){var c;b<this.b()?c=null:(a.d=this.e,c=this.position);return c};Pm.prototype.b=function(){return(Im[this.f]?1:0)+(this.g?3:0)+(this.position.parent?this.position.parent.j:0)};function Qm(a,b,c){this.ka=a;this.d=b;this.b=c}
function Rm(a){for(var b=1;b<a.length;b++){var c=a[b-1],d=a[b];c===d?u.b("validateCheckPoints: duplicate entry"):c.ka>=d.ka?u.b("validateCheckPoints: incorrect boxOffset"):c.aa==d.aa&&(d.I?c.I&&u.b("validateCheckPoints: duplicate after points"):c.I?u.b("validateCheckPoints: inconsistent after point"):d.ka-c.ka!=d.ea-c.ea&&u.b("validateCheckPoints: boxOffset inconsistent with offsetInNode"))}}
function Sm(a,b,c,d){Di.call(this,a);this.qd=a.lastChild;this.f=b;this.g=c;this.Ra=d;this.ae=a.ownerDocument;this.Lc=!1;this.ja=this.Ta=this.sa=this.ia=this.N=0;this.ib=this.wb=this.l=this.Qa=null;this.rd=!1;this.h=this.e=this.A=null;this.Id=!0;this.Mc=this.Oc=this.Nc=0}t(Sm,Di);Sm.prototype.clone=function(){var a=new Sm(this.element,this.f,this.g,this.Ra);Ji(a,this);a.qd=this.qd;a.Lc=this.Lc;a.l=this.l?this.l.clone():null;a.wb=this.wb.concat();return a};
function Tm(a,b){return a.b?b<a.ja:b>a.ja}function Um(a,b,c){var d=new ni(b.ga,c,0);d.Ia=b.Ia;d.fa=b.fa;d.ra=b.ra;d.pa=b.pa?Um(a,b.pa,qi(c)):null;return d}function Vm(a,b){var c=K("openAllViews"),d=b.ha;Wm(a.f,a.element,a.Lc);var e=d.length-1,f=null;pf(function(){for(;0<=e;){f=Um(a,d[e],f);if(0==e&&(f.ea=b.ea,f.I=b.I,f.I))break;var c=Xm(a.f,f,0==e&&0==f.ea);e--;if(c.Ca())return c}return L(!1)}).then(function(){N(c,f)});return M(c)}var Ym=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
function Zm(a,b){if(b.f&&b.e&&!b.I&&0==b.f.count&&1!=b.B.nodeType){var c=b.B.textContent.match(Ym);return $m(a.f,b,c[0].length)}return L(b)}function an(a,b,c){var d=K("buildViewToNextBlockEdge");qf(function(d){b.B&&c.push(qi(b));Zm(a,b).then(function(f){f!==b&&(b=f,c.push(qi(b)));bn(a.f,b).then(function(c){(b=c)?cn(a.Ra,b)?b.k&&!a.b?dn(a,b).then(function(c){b=c;!b||b.d||0<a.f.e.b.length?P(d):sf(d)}):b.e?sf(d):P(d):(b=b.modify(),b.d=!0,P(d)):P(d)})})}).then(function(){N(d,b)});return M(d)}
function en(a,b){if(!b.B)return L(b);var c=b.aa,d=K("buildDeepElementView");qf(function(d){Zm(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.aa!=c;)g=g.parent;if(null==g){b=f;P(d);return}}bn(a.f,f).then(function(f){(b=f)&&b.aa!=c?cn(a.Ra,b)?sf(d):(b=b.modify(),b.d=!0,P(d)):P(d)})})}).then(function(){N(d,b)});return M(d)}
...
function pn(a,b,c,d){if(a.e&&a.e[a.e.length-1].b)return on(a,b,c),L(!0);d+=40*(a.b?-1:1);var e=a.l,f=!e;if(f){var g=a.element.ownerDocument.createElement("div");v(g,"position","absolute");var h=a.f.clone(),e=new Sm(g,h,a.g,a.Ra);a.l=e;e.b=qn(a.f,a.b,g);e.Lc=!0;a.b?(e.left=0,v(e.element,"width","2em")):(e.top=a.Ta,v(e.element,"height","2em"))}a.element.appendChild(e.element);nn(a,e.element,e);g=(a.b?-1:1)*(d-a.sa);a.b?e.height=a.Qa.S-a.Qa.W-Ei(e)-Fi(e):e.width=a.Qa.V-a.Qa.ca-Gi(e)-Hi(e);d=(a.b?-1:
1)*(a.Ta-d)-(a.b?Gi(e)-Hi(e):Ei(e)+Fi(e));if(f&&18>d)return a.element.removeChild(e.element),a.l=null,on(a,b,c),L(!0);if(!a.b&&e.top<g)return a.element.removeChild(e.element),on(a,b,c),L(!0);var l=K("layoutFootnoteInner");a.b?Li(e,0,d):Ki(e,g,d);e.D=a.D+a.left+Gi(a);e.F=a.F+a.top+Ei(a);e.G=a.G;var k=new wi(c);f?(rn(e),d=L(!0)):0==e.G.length?(sn(e),d=L(!0)):d=tn(e);d.then(function(){un(e,k).then(function(d){if(f&&d)a.element.removeChild(e.element),on(a,b,c),a.l=null,N(l,!0);else{a.b?(a.ja=a.Ta+(e.d+
Gi(e)+Hi(e)),Li(e,0,e.d)):(a.ja=a.Ta-(e.d+Ei(e)+Fi(e)),Ki(e,a.ja-a.sa,e.d));var g;!a.b&&0<e.G.length?g=tn(e):g=L(d);g.then(function(d){d=new Qm(b,c,d?d.Oa:null);a.e?a.e.push(d):a.e=[d];N(l,!0)})}})});return M(l)}
function vn(a,b){var c=K("layoutFootnote"),d=b.B;d.setAttribute("style","");v(d,"display","inline-block");d.textContent="M";var e=ci(a.g,d),f=a.b?e.left:e.bottom;d.textContent="";wn(a.f,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d={ha:[{ga:b.aa,Ia:0,fa:b.fa,ra:null,pa:null}],ea:0,I:!1};e=b.ka;b=b.modify();b.I=!0;pn(a,e,d,f).then(function(){a.l&&a.l.element.parentNode&&a.element.removeChild(a.l.element);Tm(a,f)&&0!=a.A.length&&(b.d=!0);N(c,b)});return M(c)}
...
else{e=Ri(e,a.b,g);for(var q=a.N,w=a.ia,p=b.parent;p&&p.e;)p=p.parent;if(p){var r=p.B.ownerDocument.createElement("div");r.style.left="0px";r.style.top="0px";a.b?(r.style.bottom="0px",r.style.width="1px"):(r.style.right="0px",r.style.height="1px");p.B.appendChild(r);var y=ci(a.g,r),q=Math.max(a.b?y.top:y.left,q),w=Math.min(a.b?y.bottom:y.right,w);p.B.removeChild(r);r=a.b?m.S-m.W:m.V-m.ca;"left"==e?w=Math.max(w,q+r):q=Math.min(q,w-r);p.B.appendChild(b.B)}r=new re(q,(a.b?-1:1)*a.sa,w,(a.b?-1:1)*a.Ta);
q=m;a.b&&(q=Ie(m));w=a.b?-1:1;q.W<a.Mc*w&&(y=q.S-q.W,q.W=a.Mc*w,q.S=q.W+y);Ne(r,a.ib,q,e);a.b&&(m=new re(-q.S,q.ca,-q.W,q.V));r=mn(a,d);v(d,"width",m.V-m.ca-r.left-r.right+"px");v(d,"height",m.S-m.W-r.top-r.bottom+"px");v(d,"position","absolute");v(d,"display",b.display);w=null;p&&(p.F?w=p:w=ui(p));w?(r=w.B.ownerDocument.createElement("div"),r.style.position="absolute",w.b?r.style.right="0":r.style.left="0",r.style.top="0",w.B.appendChild(r),p=ci(a.g,r),w.B.removeChild(r)):p={left:a.b?a.Ta:a.N,right:a.b?
a.sa:a.ia,top:a.b?a.N:a.sa};(w?w.b:a.b)?v(d,"right",p.right-m.V+a.w+"px"):v(d,"left",m.ca-p.left+a.j+"px");v(d,"top",m.W-p.top+a.k+"px");b.u&&(b.u.parentNode.removeChild(b.u),b.u=null);p=a.b?m.ca:m.S;m=a.b?m.V:m.W;Tm(a,p)&&0!=a.A.length?(b=b.modify(),b.d=!0,N(c,b)):(gn(a),r=new re(a.b?a.Ta:a.N,a.b?a.N:a.sa,a.b?a.sa:a.ia,a.b?a.ia:a.Ta),a.b&&(r=Ie(r)),Oe(r,a.ib,q,e),hn(a),"left"==e?a.Nc=p:a.Oc=p,a.Mc=m,yn(a,p),N(c,k))}});return M(c)}
...
function Nn(a,b,c){function d(){b=k[0]||b;b.B.parentNode.removeChild(b.B);e.h=h}var e=a,f=K("skipEdges"),g=c&&b&&b.I,h=null,l=null,k=[],m=[],p=!1;qf(function(a){for(;b;){do if(b.B){if(b.e&&1!=b.B.nodeType){if(ei(b.B,b.w))break;if(!b.I){!c&&sl[h]?d():Ln(e,l,null,!0,h)?(b=(l||b).modify(),b.d=!0):(b=b.modify(),b.h=h);P(a);return}}if(!b.I&&(b.l&&Mn(e,b),b.k||b.A)){k.push(qi(b));h=ql(h,b.h);if(!c&&sl[h])d();else if(Ln(e,l,null,!0,h)||!cn(e.Ra,b))b=(l||b).modify(),b.d=!0;P(a);return}if(1==b.B.nodeType){var f=
b.B.style;if(b.I){if(p){if(!c&&sl[h]){d();P(a);return}k=[];g=c=!1;h=null}p=!1;l=qi(b);m.push(l);h=ql(h,b.D);if(f&&(!Kn(f.paddingBottom)||!Kn(f.borderBottomWidth))){if(Ln(e,l,null,!0,h)){b=(l||b).modify();b.d=!0;P(a);return}m=[l];l=null}}else{k.push(qi(b));h=ql(h,b.h);if(!cn(e.Ra,b)){Ln(e,l,null,!1,h);b=b.modify();b.d=!0;P(a);return}if(Km[b.B.localName]){!c&&sl[h]?d():Ln(e,l,null,!0,h)&&(b=(l||b).modify(),b.d=!0);P(a);return}!f||Kn(f.paddingTop)&&Kn(f.borderTopWidth)||(g=!1,m=[]);p=!0}}}while(0);f=
...
function sn(a){var b=a.element.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.k+"px";b.style.right=a.w+"px";b.style.bottom=a.u+"px";b.style.left=a.j+"px";a.element.appendChild(b);var c=ci(a.g,b);a.element.removeChild(b);var b=a.D+a.left+Gi(a),d=a.F+a.top+Ei(a);a.Qa=new re(b,d,b+a.width,d+a.height);a.N=c?a.b?c.top:c.left:0;a.ia=c?a.b?c.bottom:c.right:0;a.sa=c?a.b?c.right:c.top:0;a.Ta=c?a.b?c.left:c.bottom:0;a.Nc=a.sa;a.Oc=a.sa;a.Mc=a.sa;a.ja=a.Ta;c=a.Qa;b=a.D+a.left+Gi(a);
d=a.F+a.top+Ei(a);if(a.xb){for(var e=a.xb,f=[],g=0;g<e.b.length;g++){var h=e.b[g];f.push(new se(h.x+b,h.y+d))}b=new xe(f)}else b=Ae(b,d,b+a.width,d+a.height);a.ib=Ke(c,[b],a.G,a.Sa,a.b);hn(a);a.e=null}function rn(a){a.wb=[];v(a.element,"width",a.width+"px");v(a.element,"height",a.height+"px");sn(a);a.d=0;a.rd=!1;a.h=null}function yn(a,b){a.d=Math.max((a.b?-1:1)*(b-a.sa),a.d)}
...
var no={now:Date.now},oo,po=oo=new mo(window&&window.performance||no);ko.call(po,"load_vivliostyle","start",void 0);ba("vivliostyle.profile.profiler",po);mo.prototype.printTimings=mo.prototype.h;mo.prototype.disable=mo.prototype.j;mo.prototype.enable=mo.prototype.k;function qo(a,b,c){function d(c){return ln(a,b).getPropertyValue(c)}function e(){v(b,"display","block");v(b,"position","static");return d(X)}function f(){v(b,"display","inline-block");v(r,X,"99999999px");var a=d(X);v(r,X,"");return a}function g(){v(b,"display","inline-block");v(r,X,"0");var a=d(X);v(r,X,"");return a}function h(){var a=e(),b=g(),c=parseFloat(a);if(c<=parseFloat(b))return b;b=f();return c<=parseFloat(b)?a:b}function l(){throw Error("Getting fill-available block size is not implemented");
}var k=b.style.display,m=b.style.position,p=b.style.width,q=b.style.height,w=b.parentNode,r=b.ownerDocument.createElement("div");v(r,"position",m);w.insertBefore(r,b);r.appendChild(b);v(b,"width","auto");v(b,"height","auto");var y=Ia("writing-mode"),y=(y?d(y[0]):null)||d("writing-mode"),O="vertical-rl"===y||"tb-rl"===y||"vertical-lr"===y||"tb-lr"===y,X=O?"height":"width",ja=O?"width":"height",Ma={};c.forEach(function(a){var c;switch(a){case "fill-available inline size":c=e();break;case "max-content inline size":c=
...
function xo(a){var b={width:me,height:ne,Ab:oe,lb:oe},c=a.size;if(c&&c.value!==wd){var d=c.value;d.ad()?(c=d.values[0],d=d.values[1]):(c=d,d=null);if(c.ac())b.width=c,b.height=d||c;else if(c=so[c.name.toLowerCase()])d&&d===Qd?(b.width=c.height,b.height=c.width):(b.width=c.width,b.height=c.height)}(c=a.marks)&&c.value!==J&&(b.lb=wo);a=a.bleed;a&&a.value!==wd?a.value&&a.value.ac()&&(b.Ab=a.value):c&&(a=!1,c.value.ad()?a=c.value.values.some(function(a){return a===Dd}):a=c.value===Dd,a&&(b.Ab=new H(6,
"pt")));return b}function yo(a,b){var c={},d=a.Ab.C*qc(b,a.Ab.Y,!1),e=a.lb.C*qc(b,a.lb.Y,!1),f=d+e,g=a.width;c.qb=g===me?(b.T.cb?Math.floor(b.Aa/2)-b.T.Nb:b.Aa)-2*f:g.C*qc(b,g.Y,!1);g=a.height;c.pb=g===ne?b.ib-2*f:g.C*qc(b,g.Y,!1);c.Ab=d;c.lb=e;c.Tc=f;return c}function zo(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
function Ao(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg",c||"polyline");a.setAttribute("stroke","black");a.setAttribute("stroke-width",b);a.setAttribute("fill","none");return a}var Bo={Ke:"top left",Le:"top right",xe:"bottom left",ye:"bottom right"};
...
k.appendChild(l);a=Ao(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));k.appendChild(a);b.split(" ").forEach(function(a){k.style[a]=f+"px"});return k}var Do={Je:"top",we:"bottom",Xd:"left",Yd:"right"};
...
Do[a];a===b?h.style[a]=e+"px":a!==k&&(h.style[a]="0",h.style["margin-"+a]="auto")});return h}function Fo(a,b,c,d){var e=!1,f=!1;if(a=a.marks)a=a.value,a.ad()?a.values.forEach(function(a){a===Dd?e=!0:a===Ed&&(f=!0)}):a===Dd?e=!0:a===Ed&&(f=!0);if(e||f){var g=c.L,h=g.ownerDocument,l=b.Ab,k=sd(to,d),m=sd(uo,d),p=sd(vo,d);e&&Object.keys(Bo).forEach(function(a){a=Co(h,Bo[a],k,p,l,m);g.appendChild(a)});f&&Object.keys(Do).forEach(function(a){a=Eo(h,Do[a],k,p,m);g.appendChild(a)})}}
...
d["padding-bottom"]=new I(c.marginBottom)};Oo.prototype.Yc=function(){var a=Xo(this,{start:"left",end:"right",da:"width"});this.Kb=a.Jd;this.marginLeft=a.Sd;this.marginRight=a.Rd};Oo.prototype.Zc=function(){var a=Xo(this,{start:"top",end:"bottom",da:"height"});this.Jb=a.Jd;this.marginTop=a.Sd;this.marginBottom=a.Rd};
function Xo(a,b){var c=a.style,d=a.d.d,e=b.start,f=b.end,g=b.da,h=a.d.l[g].la(d,null),l=W(d,c[g],h),k=W(d,c["margin-"+e],h),m=W(d,c["margin-"+f],h),p=Yl(d,c["padding-"+e],h),q=Yl(d,c["padding-"+f],h),w=$l(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),r=$l(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),y=D(d,h,C(d,C(d,w,p),C(d,r,q)));l?(y=D(d,y,l),k||m?k?m=D(d,y,k):k=D(d,y,m):m=k=$c(d,y,new gc(d,.5))):(k||(k=d.b),m||(m=d.b),l=D(d,y,C(d,k,m)));c[e]=new I(k);c[f]=new I(m);c["margin-"+e]=
oe;c["margin-"+f]=oe;c["padding-"+e]=new I(p);c["padding-"+f]=new I(q);c["border-"+e+"-width"]=new I(w);c["border-"+f+"-width"]=new I(r);c[g]=new I(l);c["max-"+g]=new I(l);return{Jd:D(d,h,C(d,k,m)),Sd:k,Rd:m}}Oo.prototype.rb=function(a,b,c,d,e){Xl.prototype.rb.call(this,a,b,c,d,e);c.D=b.element};function Po(a,b){Xl.call(this,a,b);var c=b.j;this.j=Ho[c];a.ja[c]=this;this.na=!0}t(Po,Xl);n=Po.prototype;
...
n.ma=function(a,b){var c=this.style,d=this.d.d,e=a.start,f=a.end,g="left"===e,h=g?b.Kb:b.Jb,l=W(d,c[a.da],h),g=g?b.marginLeft:b.marginTop;if("start"===this.j.ma)c[e]=new I(g);else if(l){var k=Yl(d,c["margin-"+e],h),m=Yl(d,c["margin-"+f],h),p=Yl(d,c["padding-"+e],h),q=Yl(d,c["padding-"+f],h),w=$l(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),f=$l(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),l=C(d,l,C(d,C(d,p,q),C(d,C(d,w,f),C(d,k,m))));switch(this.j.ma){case "center":c[e]=new I(C(d,
g,ad(d,D(d,h,l),new gc(d,2))));break;case "end":c[e]=new I(D(d,C(d,g,h),l))}}};
function Yo(a,b,c){function d(a){if(y)return y;y={da:r?r.evaluate(a):null,Ma:l?l.evaluate(a):null,Na:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[q,m,p,w].forEach(function(b){b&&(c+=b.evaluate(a))});(null===y.Ma||null===y.Na)&&c+y.da+y.Ma+y.Na>b&&(null===y.Ma&&(y.Ma=0),null===y.Na&&(y.Qe=0));null!==y.da&&null!==y.Ma&&null!==y.Na&&(y.Na=null);null===y.da&&null!==y.Ma&&null!==y.Na?y.da=b-c-y.Ma-y.Na:null!==y.da&&null===y.Ma&&null!==y.Na?y.Ma=b-c-y.da-y.Na:null!==y.da&&null!==y.Ma&&null===y.Na?y.Na=
b-c-y.da-y.Ma:null===y.da?(y.Ma=y.Na=0,y.da=b-c):y.Ma=y.Na=(b-c-y.da)/2;return y}var e=a.style;a=a.d.d;var f=b.$c,g=b.dd;b=b.da;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],l=Zl(a,e["margin-"+f],h),k=Zl(a,e["margin-"+g],h),m=Yl(a,e["padding-"+f],h),p=Yl(a,e["padding-"+g],h),q=$l(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),w=$l(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),r=W(a,e[b],h),y=null;e[b]=new I(new jc(a,function(){var a=d(this).da;return null===a?0:a},b));e["margin-"+
f]=new I(new jc(a,function(){var a=d(this).Ma;return null===a?0:a},"margin-"+f));e["margin-"+g]=new I(new jc(a,function(){var a=d(this).Na;return null===a?0:a},"margin-"+g));"left"===f?e.left=new I(C(a,c.marginLeft,c.Kb)):"top"===f&&(e.top=new I(C(a,c.marginTop,c.Jb)))}n.Yc=function(){var a=this.e.j;this.j.xa?Yo(this,{$c:"right",dd:"left",da:"width"},a):this.j.ya?Yo(this,{$c:"left",dd:"right",da:"width"},a):this.ma({start:"left",end:"right",da:"width"},a)};
n.Zc=function(){var a=this.e.j;this.j.za?Yo(this,{$c:"bottom",dd:"top",da:"height"},a):this.j.wa?Yo(this,{$c:"top",dd:"bottom",da:"height"},a):this.ma({start:"top",end:"bottom",da:"height"},a)};n.vc=function(a,b,c,d,e,f,g){Xl.prototype.vc.call(this,a,b,c,d,e,f,g);a=c.A;c=this.d.j;d=this.j;d.xa||d.ya?d.za||d.wa||(d.xa?a.left[c]=b:d.ya&&(a.right[c]=b)):d.za?a.top[c]=b:d.wa&&(a.bottom[c]=b)};
...
function wp(a,b,c,d,e,f,g,h,l,k,m,p,q,w){this.w=a;this.d=b;this.viewport=c;this.l=c.b;this.j=d;this.D=e;this.X=f;this.A=g;this.k=h;this.F=l;this.page=k;this.f=m;this.u=p;this.e=q;this.g=w;this.G=this.b=null;this.h=!1;this.aa=null;this.ea=0;this.B=null}wp.prototype.clone=function(){return new wp(this.w,this.d,this.viewport,this.j,this.D,this.X,this.A,this.k,this.F,this.page,this.f,this.u,this.e,this.g)};
...
function yp(a,b,c,d,e,f,g,h){var l=K("createShadows"),k=e.template,m;k instanceof qd?m=xp(a,k.url,2,b,h,null):m=L(null);m.then(function(k){var m=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var w=b.getAttribute("href"),r=null;w?r=h?h.X:a.X:h&&(w="http://www.w3.org/1999/xhtml"==h.ba.namespaceURI?h.ba.getAttribute("href"):h.ba.getAttributeNS("http://www.w3.org/1999/xlink","href"),r=h.gd?h.gd.X:a.X);w&&(w=ya(w,r.url),m=xp(a,w,3,b,h,k))}null==m&&(m=L(k));m.then(function(k){var m;
if(m=d._pseudos){for(var p=[],q=tp.createElementNS("http://www.pyroxy.com/ns/shadow","root"),r=q,w=0;w<up.length;w++){var E=up[w],S;if(E){if(!m[E])continue;if(!("footnote-marker"!=E||c&&a.h))continue;if(E.match(/^first-/)&&(S=e.display,!S||S===Md))continue;if("before"===E||"after"===E)if(S=m[E].content,!S||S===Ud||S===J)continue;p.push(E);S=tp.createElementNS("http://www.w3.org/1999/xhtml","span");S.setAttribute("data-adapt-pseudo",E)}else S=tp.createElementNS("http://www.pyroxy.com/ns/shadow","content");
r.appendChild(S);E.match(/^first-/)&&(r=S)}k=p.length?new li(b,q,null,h,k,2,new vp(b,d,f,g)):k}N(l,k)})});return M(l)}function Wm(a,b,c){a.G=b;a.h=c}function zp(a,b,c,d){var e=a.d;c=dl(c,e,a.D,a.h);b=cl(c,e,b);el(c,d,b,function(b,c){var d=c.evaluate(e,b);"font-family"==b&&(d=qh(a.A,d));return d});var f=Pi(d.display||Md,d.position,d["float"],a.aa===a.X.root);["display","position","float"].forEach(function(a){f[a]&&(d[a]=f[a])});return b}
function Ap(a,b){for(var c=a.b.aa,d=[],e=a.b.fa,f=-1;c&&1==c.nodeType;){var g=e&&e.root==c;if(!g||2==e.type){var h=(e?e.b:a.j).h(c,!1);d.push(h)}g?(c=e.ba,e=e.gd):(c=c.parentNode,f++)}c=qc(a.d,"em",0===f);c={"font-size":new U(new H(c,"px"),0)};e=new wj(c,a.d);for(f=d.length-1;0<=f;--f){var g=d[f],h=[],l;for(l in g)bj[l]&&h.push(l);h.sort(qe);for(var k=0;k<h.length;k++){var m=h[k];e.d=m;var p=g[m];p.value!==Ld&&(c[m]=p.uc(e))}}for(var q in b)bj[q]||(c[q]=b[q]);return c}
...
function Ep(a,b,c){var d=!0,e=K("createElementView"),f=a.aa,g=a.b.fa?a.b.fa.b:a.j,h=g.h(f,!1),l={};a.b.parent||(h=Ap(a,h));a.b.b=zp(a,a.b.b,h,l);Dp(a,l);l.direction&&(a.b.N=l.direction.toString());var k=l["flow-into"];if(k&&k.toString()!=a.w)return N(e,!1),M(e);var m=l.display;if(m===J)return N(e,!1),M(e);k=null==a.b.parent;a.b.A=m===Id;yp(a,f,k,h,l,g,a.d,a.b.fa).then(function(g){a.b.ra=g;var h=l.position;g=l["float-reference"];var k=l["float"],r=l.clear,y=a.b.b?ie:Kd;a.b.G=Qi(m,h,k,l.overflow,y,
a.b.parent?a.b.parent.b?ie:Kd:y);a.b.F=h===Yd||h===td||h===Hd;ti(a.b)&&(r=null,k!==Jd&&(k=null));h=k===Rd||k===Zd||k===fe||k===Bd||k===Pd||k===Od||k===zd||k===yd||k===Jd;k&&(delete l["float"],k===Jd&&(a.h?(h=!1,l.display=xd):l.display=Md));r&&(r===Ld&&a.b.parent&&a.b.parent.l&&(r=G(a.b.parent.l)),r===Rd||r===Zd||r===Ad)&&(delete l.clear,l.display&&l.display!=Md&&(a.b.l=r.toString()));var O=m===Sd&&l["ua-list-item-count"];h||l["break-inside"]&&l["break-inside"]!==wd?a.b.j++:m===ee&&(a.b.j+=10);a.b.e=
...
Bp[E];E||(E=a.b.e?"span":"div")}else if("http://www.daisy.org/z3986/2005/ncx/"==ea)if(ea="http://www.w3.org/1999/xhtml","ncx"==E||"navPoint"==E)E="div";else if("navLabel"==E){if(E="span",k=f.parentNode){g=null;for(k=k.firstChild;k;k=k.nextSibling)if(1==k.nodeType&&(r=k,"http://www.daisy.org/z3986/2005/ncx/"==r.namespaceURI&&"content"==r.localName)){g=r.getAttribute("src");break}g&&(E="a",f=f.ownerDocument.createElementNS(ea,"a"),f.setAttribute("href",g))}}else E="span";else"http://www.pyroxy.com/ns/shadow"==
...
S)continue;else"http://www.w3.org/1999/xlink"==S&&"href"==oa&&(ga=Cp(a,ga));else{if(oa.match(/^on/))continue;if("style"==oa)continue;if(("id"==oa||"name"==oa)&&b){ga=a.g.nd(ga,a.X.url);g.setAttribute(oa,ga);ai(a.page,g,ga);continue}"src"==oa||"href"==oa||"poster"==oa?(ga=Cp(a,ga),"href"===oa&&(ga=a.g.mc(ga,a.X.url))):"srcset"==oa&&(ga=ga.split(",").map(function(b){return Cp(a,b.trim())}).join(","));if("poster"===oa&&"video"===E&&"http://www.w3.org/1999/xhtml"===ea&&m&&p){var ic=new Image,nm=wg(ic,
ga);Ma.push(nm);k.push({Md:ic,element:g,Kd:nm})}}"http://www.w3.org/2000/svg"==ea&&/^[A-Z\-]+$/.test(oa)&&(oa=oa.toLowerCase());-1!=Fp.indexOf(oa.toLowerCase())&&(ga=mp(ga,a.X.url,a.g));S&&(ic=rp[S])&&(oa=ic+":"+oa);"src"!=oa||S||"img"!=E&&"input"!=E||"http://www.w3.org/1999/xhtml"!=ea?"href"==oa&&"image"==E&&"http://www.w3.org/2000/svg"==ea&&"http://www.w3.org/1999/xlink"==S?a.page.g.push(wg(g,ga)):S?g.setAttributeNS(S,oa,ga):g.setAttribute(oa,ga):r=ga}r&&(ic="input"===E?new Image:g,q=wg(ic,r),ic!==
g&&(g.src=r),m||p?(m&&p&&h&&1!==h&&k.push({Md:ic,element:g,Kd:q}),Ma.push(q)):a.page.g.push(q))}delete l.content;(m=l["list-style-image"])&&m instanceof qd&&(m=m.url,Ma.push(wg(new Image,m)));Gp(a,g,l);if(!a.b.e&&(m=null,b?c&&(m=a.b.b?qp:pp):m="clone"!==a.b.g["box-decoration-break"]?a.b.b?op:np:a.b.b?qp:pp,m))for(var om in m)v(g,om,m[om]);O&&g.setAttribute("value",l["ua-list-item-count"].stringValue());a.B=g;Ma.length?vg(Ma).then(function(){0<h&&Hp(a,k,h,l,a.b.b);N(e,d)}):nf().then(function(){N(e,
...
function Jp(a){if(null==a.fa||"content"!=a.aa.localName||"http://www.pyroxy.com/ns/shadow"!=a.aa.namespaceURI)return a;var b=a.ka,c=a.fa,d=a.parent,e,f;c.Fd?(f=c.Fd,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.gd,e=c.ba.firstChild,c=2);var g=a.aa.nextSibling;g?(a.aa=g,oi(a)):a.pa?a=a.pa:e?a=null:(a=a.parent.modify(),a.I=!0);if(e)return b=new ni(e,d,b),b.fa=f,b.Ia=c,b.pa=a,b;a.ka=b;return a}
function Kp(a){var b=a.ka+1;if(a.I){if(!a.parent)return null;if(3!=a.Ia){var c=a.aa.nextSibling;if(c)return a=a.modify(),a.ka=b,a.aa=c,oi(a),Jp(a)}if(a.pa)return a=a.pa.modify(),a.ka=b,a;a=a.parent.modify()}else{if(a.ra&&(c=a.ra.root,2==a.ra.type&&(c=c.firstChild),c))return b=new ni(c,a,b),b.fa=a.ra,b.Ia=a.ra.type,Jp(b);if(c=a.aa.firstChild)return Jp(new ni(c,a,b));1!=a.aa.nodeType&&(b+=a.aa.textContent.length-1-a.ea);a=a.modify()}a.ka=b;a.I=!0;return a}
...
function Vp(a,b,c,d,e,f,g,h,l,k,m){oc.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.X=b;this.lang=b.lang||c;this.viewport=d;this.g={body:!0};this.e=e;this.k=this.b=this.A=this.d=this.u=null;this.l=0;this.Sa=f;this.h=new ph(this.style.l);this.ia={};this.N=null;this.f=m;this.G={};this.Z=null;this.Ja=g;this.Ra=h;this.ja=l;this.Qa=k;for(var p in a.f)(b=a.f[p]["flow-consume"])&&(b.evaluate(this,"flow-consume")==ud?this.g[p]=!0:delete this.g[p]);this.na={}}t(Vp,oc);
function Wp(a){var b=K("StyleInstance.init"),c=new Tn(a.f,a.X.url),d=new Sn(a.f,a.X.url,a.style.d,a.style.b);a.d=new yl(a.X,a.style.e,a.style.d,a,a.g,a.style.j,c,d);d.f=a.d;Il(a.d,a);a.A={};a.A[a.X.url]=a.d;var e=Fl(a.d);a.Z=ro(e);a.u=new Cm(a.style.A);c=new Gk(a.style.e,a,c,d);a.u.h(c,e);Bm(a.u,a);a.N=new Zo(c,a.style.b,a.u,a,e);e=[];for(c=0;c<a.style.g.length;c++)if(d=a.style.g[c],!d.M||d.M.evaluate(a))d=mh(d.Cb,a),d=new nh(d),e.push(d);vh(a.Sa,e,a.h).ua(b);var f=a.style.w;Object.keys(f).forEach(function(a){var b=
yo(xo(f[a]),this);this.na[a]={width:b.qb+2*b.Tc,height:b.pb+2*b.Tc}},a);return M(b)}function Jl(a,b,c){if(a=a.b)a.e[b.b]||(a.e[b.b]=c),c=a.b[b.b],c||(c=new zi,a.b[b.b]=c),c.b.push(new yi(new wi({ha:[{ga:b.element,Ia:0,fa:null,ra:null,pa:null}],ea:0,I:!1}),b))}function Xp(a,b){for(var c=Number.POSITIVE_INFINITY,d=0;d<b.b.length;d++){for(var e=b.b[d].d.Oa,f=e.ha[0].ga,g=e.ea,h=e.I,l=0;f.ownerDocument!=a.X.b;)l++,f=e.ha[l].ga,h=!1,g=0;e=Ah(a.X,f,g,h);e<c&&(c=e)}return c}
...
c.clone();h=a;l=h.b.page;k=void 0;for(k in h.b.b)for(m=h.b.b[k],p=m.b.length-1;0<=p;p--){var q=m.b[p];0>q.b.Wa&&q.b.d<h.l&&(q.b.Wa=l)}pc(a,a.style.b);h=lm(f,a,"enabled");if(!h||h===ke){c=a;u.debug("Location - page",c.b.page);u.debug("  current:",d);u.debug("  lookup:",c.l);d=void 0;for(d in c.b.b)for(e=c.b.b[d],g=0;g<e.b.length;g++)u.debug("  Chunk",d+":",e.b[g].b.d);d=a.N;e=f;f=b;c=e.d;0===Object.keys(f).length?(c.d.e=c,f=e):(e=c,g=ap(d,f),e=e.g+"^"+g,g=d.g[e],g||("background-host"===c.sb?(c=d,f=
...
function $p(a,b,c){var d=a.b.b[c];if(!d||!Sp(a,d.d))return L(!0);d.d="any";rn(b);a.g[c]&&0<b.ib.length&&(b.Id=!1);var e=K("layoutColumn"),f=[],g=[],h=!0;qf(function(c){for(;0<d.b.length-g.length;){for(var e=0;0<=g.indexOf(e);)e++;var m=d.b[e];if(m.b.d>a.l||Tp(a,m.b))break;for(var p=e+1;p<d.b.length;p++)if(!(0<=g.indexOf(p))){var q=d.b[p];if(q.b.d>a.l||Tp(a,q.b))break;hi(q.b,m.b)&&(m=q,e=p)}var w=m.b,r=!0;un(b,m.d,h).then(function(a){h=!1;m.b.me&&(null===a||w.f)&&f.push(e);w.f?(g.push(e),P(c)):(a?
m.d=a:g.push(e),b.h&&(d.d=Jm(b.h)),a||b.h?P(c):r?r=!1:sf(c))});if(r){r=!1;return}}P(c)}).then(function(){d.b=d.b.filter(function(a,b){return 0<=f.indexOf(b)||0>g.indexOf(b)});N(e,!0)});return M(e)}
function aq(a,b,c,d,e,f,g,h){em(c);var l=lm(c,a,"enabled");if(l&&l!==ke)return L(!0);var k=K("layoutContainer"),m=lm(c,a,"wrap-flow")===wd,p=c.b?c.g&&c.F:c.f&&c.G,l=lm(c,a,"flow-from"),q=a.viewport.b.createElement("div"),w=lm(c,a,"position");v(q,"position",w?w.name:"absolute");d.insertBefore(q,d.firstChild);var r=new Di(q);r.b=c.b;c.rb(a,r,b,a.h,a.e);r.D=e;r.F=f;e+=r.left+r.marginLeft+r.O;f+=r.top+r.marginTop+r.Z;var y=!1;if(l&&l.Pd())if(a.G[l.toString()])c.vc(a,r,b,null,1,a.e,a.h),l=L(!0);else{var O=
K("layoutContainer.inner"),X=l.toString(),ja=Y(c,a,"column-count"),Ma=Y(c,a,"column-gap"),ea=1<ja?Y(c,a,"column-width"):r.width,l=km(c,a),E=0,w=lm(c,a,"shape-inside"),S=qg(w,0,0,r.width,r.height,a),cm=new wp(X,a,a.viewport,a.d,l,a.X,a.h,a.style.u,a,b,a.Ja,a.Ra,h,a.Qa),dm=new Rn(a.f,a.b.page-1),Ii=0,fa=null;qf(function(b){for(;Ii<ja;){var c=Ii++;if(1<ja){var d=a.viewport.b.createElement("div");v(d,"position","absolute");q.appendChild(d);fa=new Sm(d,cm,a.e,dm);fa.b=r.b;fa.Sa=r.Sa;fa.Hb=r.Hb;r.b?(v(d,
"margin-left",r.j+"px"),v(d,"margin-right",r.w+"px"),c=c*(ea+Ma)+r.k,Li(fa,0,r.width),Ki(fa,c,ea)):(v(d,"margin-top",r.k+"px"),v(d,"margin-bottom",r.u+"px"),c=c*(ea+Ma)+r.j,Ki(fa,0,r.height),Li(fa,c,ea));fa.D=e+r.j;fa.F=f+r.k}else fa=new Sm(q,cm,a.e,dm),Ji(fa,r),r=fa;fa.G=p?[]:g;fa.xb=S;if(0<=fa.width){var k=K("inner");$p(a,fa,X).then(function(){fa.h&&"column"!=fa.h&&(Ii=ja,"region"!=fa.h&&(a.G[X]=!0));N(k,!0)});c=M(k)}else c=L(!0);if(c.Ca()){c.then(function(){0<h.b.length?P(b):(E=Math.max(E,fa.d),
sf(b))});return}0<h.b.length||(E=Math.max(E,fa.d))}P(b)}).then(function(){r.d=E;c.vc(a,r,b,fa,ja,a.e,a.h);N(O,!0)});l=M(O)}else(l=lm(c,a,"content"))&&Ni(l)?(w=a.viewport.b.createElement("span"),l.U(new Mi(w,a)),q.appendChild(w),Am(c,a,r,a.h)):c.na&&(d.removeChild(q),y=!0),y||c.vc(a,r,b,null,1,a.e,a.h),l=L(!0);l.then(function(){if(!c.f||0<Math.floor(r.d)){if(!y&&!m){var l=r.D+r.left,p=r.F+r.top,w=Gi(r)+r.width+Hi(r),E=Ei(r)+r.height+Fi(r),X=lm(c,a,"shape-outside"),l=qg(X,l,p,w,E,a);g.push(l)}}else if(0==
c.children.length){d.removeChild(q);N(k,!0);return}var O=c.children.length-1;pf(function(){for(;0<=O;){var d=c.children[O--],d=aq(a,b,d,q,e,f,g,h);if(d.Ca())return d}return L(!1)}).then(function(){N(k,!0)})});return M(k)}
...
t(fq,Ef);fq.prototype.error=function(a){u.b("CSS parser:",a)};function gq(a,b){return hq(b,a)}function iq(a){wf.call(this,gq,"document");this.F=a;this.A={};this.j={};this.d={};this.D={};this.h=null;this.b=[]}t(iq,wf);function jq(a,b,c){kq(a,b,c);var d=ya("user-agent.xml",xa),e=K("OPSDocStore.init");ih.get().then(function(b){a.h=b;Qp.get().then(function(){a.load(d).then(function(){N(e,!0)})})});return M(e)}function kq(a,b,c){a.b.splice(0);b&&b.forEach(a.G,a);c&&c.forEach(a.N,a)}
...
function hq(a,b){var c=K("OPSDocStore.load"),d=b.url;Ih(b,a).then(function(b){if(b){for(var f=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),h=0;h<g.length;h++){var l=g[h],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=l.getAttribute("action"),l=l.getAttribute("ref");k&&m&&p&&l&&f.push({je:k,event:m,action:p,fc:l})}a.D[d]=f;var q=[],f=ya("user-agent-page.css",xa);q.push({url:f,text:null,
La:"UA",va:null,media:null});if(f=b.h)for(f=f.firstChild;f;f=f.nextSibling)if(1==f.nodeType)if(g=f,h=g.namespaceURI,k=g.localName,"http://www.w3.org/1999/xhtml"==h)if("style"==k)q.push({url:d,text:g.textContent,La:"Author",va:null,media:null});else if("link"==k){if(m=g.getAttribute("rel"),h=g.getAttribute("class"),k=g.getAttribute("media"),"stylesheet"==m||"alternate stylesheet"==m&&h)g=g.getAttribute("href"),g=ya(g,d),q.push({url:g,text:null,va:h,media:k,La:"Author"})}else"meta"==k&&"viewport"==
g.getAttribute("name")&&q.push({url:d,text:eq(g),La:"Author",M:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==h?"stylesheet"==k&&"text/css"==g.getAttribute("type")&&q.push({url:d,text:g.textContent,La:"Author",va:null,media:null}):"http://example.com/sse"==h&&"property"===k&&(h=g.getElementsByTagName("name")[0])&&"stylesheet"===h.textContent&&(g=g.getElementsByTagName("value")[0])&&(g=ya(g.textContent,d),q.push({url:g,text:null,va:null,media:null,La:"Author"}));for(h=0;h<a.b.length;h++)q.push(a.b[h]);
for(var w="",h=0;h<q.length;h++)w+=q[h].url,w+="^",q[h].text&&(w+=q[h].text),w+="^";var r=a.A[w];r?(a.d[d]=r,N(c,b)):(f=a.j[w],f||(f=new yf(function(){var b=K("fetchStylesheet"),c=0,d=new fq(a.h);pf(function(){if(c<q.length){var a=q[c++];d.Pb(a.La);return null!==a.text?ig(a.text,d,a.url,a.va,a.media).md(!0):hg(a.url,d,a.va,a.media)}return L(!1)}).then(function(){r=new Rp(a,d.g,d.j,d.D.g,d.w,d.k,d.l,d.h,d.A,d.u);a.A[w]=r;delete a.j[w];N(b,r)});return M(b)},"FetchStylesheet "+d),a.j[w]=f,f.start()),
f.get().then(function(f){a.d[d]=f;N(c,b)}))}else N(c,null)});return M(c)};function lq(a,b,c,d,e,f,g,h,l,k){this.b=a;this.url=b;this.lang=c;this.d=d;this.h=e;this.T=Yb(f);this.j=g;this.g=h;this.f=l;this.e=k;this.Va=this.page=null}function mq(a,b,c){if(0!=c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=Ja(d,"height","auto")&&(v(d,"height","auto"),mq(a,d,c));"absolute"==Ja(d,"position","static")&&(v(d,"position","relative"),mq(a,d,c))}}
...
lq.prototype.bd=function(a){var b=this.j.bd(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",v(e,"cursor","pointer"),e.addEventListener("click",nq,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
function Cq(a,b){function c(a){for(var b in a){var d=a[b];d.sort(Bq(b,k));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return Za(a,function(a){return Ya(a,function(a){var b={v:a.value,o:a.Q};a.Re&&(b.s=a.scheme);if(a.id||a.lang){var c=l[a.id];if(c||a.lang)a.lang&&(a={name:zq,value:a.lang,lang:null,id:null,jd:a.id,scheme:null,Q:a.Q},c?c.push(a):c=[a]),c=Xa(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in yq)f[g]=yq[g];for(;null!=(g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/));)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=yq;var h=1;g=Qh(Rh(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),Q:h++,jd:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:yq.dcterms+a.localName,Q:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),jd:null,scheme:null};return null});var l=Xa(g,function(a){return a.jd});g=d(Xa(g,function(a){return a.jd?null:a.name}));var k=null;g[zq]&&(k=g[zq][0].v);c(g);return g}function Dq(){var a=window.MathJax;return a?a.Hub:null}var Eq={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function sq(a,b){this.f=a;this.h=this.d=this.b=this.g=this.e=null;this.l=b;this.k=null;this.G={};this.lang=null;this.u=0;this.D={};this.N=this.F=this.O=null;this.w={};this.A=null;this.j=Fq(this);Dq()&&(dj["http://www.w3.org/1998/Math/MathML"]=!0)}
function Fq(a){function b(){}b.prototype.nd=function(a,b){return"viv-id-"+Aa(b+(a?"#"+a:""),":")};b.prototype.mc=function(b,d){var e=b.match(/^([^#]*)#?(.*)$/);if(e){var f=e[1]||d,e=e[2];if(f&&a.g.some(function(a){return a.src===f}))return"#"+this.nd(e,f)}return b};b.prototype.ne=function(a){"#"===a.charAt(0)&&(a=a.substring(1));0===a.indexOf("viv-id-")&&(a=a.substring(7));return(a=Ra(a).match(/^([^#]*)#?(.*)$/))?[a[1],a[2]]:[]};return new b}
function Gq(a,b){return a.l?b.substr(0,a.l.length)==a.l?decodeURI(b.substr(a.l.length)):null:b}
function tq(a,b,c,d,e){a.e=b;var f=xh(new yh([b.b]),"package"),g=Sh(f,"unique-identifier")[0];g&&(g=Eh(b,b.url+"#"+g))&&(a.k=g.textContent.replace(/[ \n\r\t]/g,""));var h={};a.g=Ya(Oh(xh(xh(f,"manifest"),"item")),function(c){var d=new vq,e=b.url;d.id=c.getAttribute("id");d.src=ya(c.getAttribute("href"),e);d.d=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.g=f}(c=c.getAttribute("fallback"))&&!Eq[d.d]&&(h[d.src]=c);!a.F&&
...
l);}a.A=l}var g=c?Sh(xh(xh(Nh(xh(xh(new yh([c.b]),"encryption"),"EncryptedData"),Mh()),"CipherData"),"CipherReference"),"URI"):[],k=Oh(xh(xh(f,"bindings"),"mediaType"));for(c=0;c<k.length;c++){var m=k[c].getAttribute("handler");(l=k[c].getAttribute("media-type"))&&m&&a.d[m]&&(a.G[l]=a.d[m].src)}a.D=Cq(xh(f,"metadata"),Sh(f,"prefix")[0]);a.D[zq]&&(a.lang=a.D[zq][0].v);if(!d){if(0<g.length&&a.k)for(d=xq(a.k),c=0;c<g.length;c++)a.f.k[a.l+g[c]]=d;return L(!0)}f=new Ka;k={};if(0<g.length&&a.k)for(l="1040:"+
Se(a.k),c=0;c<g.length;c++)k[g[c]]=l;for(c=0;c<d.length;c++){var p=d[c];if(m=p.n){var q=decodeURI(m),g=a.h[q];l=null;g&&(g.j=0!=p.m,g.h=p.c,g.d&&(l=g.d.replace(/\s+/g,"")));g=k[q];if(l||g)f.append(m),f.append(" "),f.append(l||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}Hq(a);return tf(e,"","POST",f.toString(),"text/plain")}function Hq(a){for(var b=0,c=0;c<a.b.length;c++){var d=a.b[c],e=Math.ceil(d.h/1024);d.e=b;d.b=e;b+=e}a.u=b}
function Iq(a,b,c){a.d={};a.h={};a.g=[];a.b=a.g;var d=a.e=new wh(null,"",(new DOMParser).parseFromString("<spine></spine>","text/xml"));b.forEach(function(a){var b=new vq;b.H=a.index;b.id="item"+(a.index+1);b.src=a.url;b.Wa=a.Wa;b.Db=a.Db;var c=d.b.createElement("itemref");c.setAttribute("idref",b.id);d.root.appendChild(c);b.f=c;this.d[b.id]=b;this.h[a.url]=b;this.g.push(b)},a);return c?uq(a.f,b[0].url,c):L(null)}
function Jq(a,b,c){var d=a.b[b],e=K("getCFI");a.f.load(d.src).then(function(a){var b=Ch(a,c),h=null;b&&(a=Ah(a,b,0,!1),h=new kb,nb(h,b,c-a),d.f&&nb(h,d.f,0),h=h.toString());N(e,h)});return M(e)}
function Kq(a,b){return Ye("resolveFragment",function(c){if(b){var d=new kb;lb(d,b);var e;if(a.e){var f=mb(d,a.e.b);if(1!=f.ga.nodeType||f.I||!f.fc){N(c,null);return}var g=f.ga,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.d[h]){N(c,null);return}e=a.d[h];d=f.fc}else e=a.b[0];a.f.load(e.src).then(function(a){var b=mb(d,a.b);a=Ah(a,b.ga,b.offset,b.I);N(c,{H:e.H,ta:a,R:-1})})}else N(c,null)},function(a,d){u.b(d,"Cannot resolve fragment:",b);N(a,null)})}
function Lq(a,b){return Ye("resolveEPage",function(c){if(0>=b)N(c,{H:0,ta:0,R:-1});else{var d=Ta(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.f.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=Bh(a),g=Math.round(a*b/e.b),g==a&&g--);N(c,{H:d,ta:g,R:-1})})}},function(a,d){u.b(d,"Cannot resolve epage:",b);N(a,null)})}
function Mq(a,b){var c=a.b[b.H];if(0>=b.ta)return L(c.e);var d=K("getEPage");a.f.load(c.src).then(function(a){a=Bh(a);var f=Math.min(a,b.ta);N(d,c.e+f*c.b/a)});return M(d)}function Nq(a,b){return{page:a,position:{H:a.H,R:b,ta:a.offset}}}function Oq(a,b,c,d,e){this.b=a;this.viewport=b;this.g=c;this.j=e;this.Eb=[];this.h=[];this.T=Yb(d);this.f=new Np(b);this.d=new ao(a.j)}function Pq(a,b){var c=a.Eb[b.H];return c?c.ab[b.R]:null}n=Oq.prototype;
n.ob=function(a){return this.b.A?this.b.A:(a=this.Eb[a?a.H:0])?a.Va.Z:null};function Qq(a,b,c,d){c.L.style.display="none";c.L.style.visibility="visible";c.L.style.position="";c.L.style.top="";c.L.style.left="";c.L.setAttribute("data-vivliostyle-page-side",c.j);var e=b.ab[d];c.w=0==b.item.H&&0==d;b.ab[d]=c;e?(b.Va.viewport.d.replaceChild(c.L,e.L),ab(e,{type:"replaced",target:null,currentTarget:null,Td:c})):b.Va.viewport.d.appendChild(c.L);a.j(b.Va.na,b.item.H,d)}
function Rq(a,b,c){var d=K("renderSinglePage"),e=Sq(a,b,c);bq(b.Va,e,c).then(function(f){var g=(c=f)?c.page-1:b.Fa.length-1;Qq(a,b,e,g);fo(a.d,e.H,g);f=null;if(c){var h=b.Fa[c.page];b.Fa[c.page]=c;h&&b.ab[c.page]&&(Ci(c,h)||(f=Rq(a,b,c)))}f||(f=L(!0));f.then(function(){var b=go(a.d,e),f=0;qf(function(c){f++;if(f>b.length)P(c);else{var d=b[f-1];d.yc=d.yc.filter(function(a){return!a.gc});0===d.yc.length?sf(c):Tq(a,d.H).then(function(b){b?(eo(a.d,d.ed),ho(a.d,d.yc),Rq(a,b,b.Fa[d.R]).then(function(b){var d=
a.d;d.b=d.u.pop();d=a.d;d.e=d.A.pop();d=b.bc.position;d.H===e.H&&d.R===g&&(e=b.bc.page);sf(c)})):sf(c)})}}).then(function(){N(d,{bc:Nq(e,g),Ud:c})})})});return M(d)}function Uq(a,b){var c=a.R,d=-1;0>c&&(d=a.ta,c=Ta(b.Fa.length,function(a){return Yp(b.Va,b.Fa[a],!0)>d}),c=c===b.Fa.length?b.complete?b.Fa.length-1:Number.POSITIVE_INFINITY:c-1);return{H:a.H,R:c,ta:d}}
function Vq(a,b,c){var d=K("findPage");Tq(a,b.H).then(function(e){if(e){var f=null,g;qf(function(d){var l=Uq(b,e);g=l.R;(f=e.ab[g])?P(d):e.complete?(g=e.Fa.length-1,f=e.ab[g],P(d)):c?Wq(a,l).then(function(a){a&&(f=a.page);P(d)}):of(100).then(function(){sf(d)})}).then(function(){N(d,Nq(f,g))})}else N(d,null)});return M(d)}
function Wq(a,b){var c=K("renderPage");Tq(a,b.H).then(function(d){if(d){var e=Uq(b,d),f=e.R,g=e.ta,h=d.ab[f];h?N(c,Nq(h,f)):qf(function(b){if(f<d.Fa.length)P(b);else if(d.complete)f=d.Fa.length-1,P(b);else{var c=d.Fa[d.Fa.length-1];Rq(a,d,c).then(function(e){var p=e.bc.page;(c=e.Ud)?0<=g&&Yp(d.Va,c)>g?(h=p,f=d.Fa.length-2,P(b)):sf(b):(h=p,f=e.bc.position.R,d.complete=!0,p.k=d.item.H===a.b.b.length-1,P(b))})}}).then(function(){h=h||d.ab[f];var b=d.Fa[f];h?N(c,Nq(h,f)):Rq(a,d,b).then(function(b){b.Ud||
(d.complete=!0,b.bc.page.k=d.item.H===a.b.b.length-1);N(c,b.bc)})})}else N(c,null)});return M(c)}n.kd=function(){return Xq(this,{H:this.b.b.length-1,R:Number.POSITIVE_INFINITY,ta:-1})};function Xq(a,b){var c=K("renderAllPages");b||(b={H:0,R:0,ta:0});var d=b.H,e=b.R,f=0,g;qf(function(c){Wq(a,{H:f,R:f===d?e:Number.POSITIVE_INFINITY,ta:f===d?b.ta:-1}).then(function(a){g=a;++f>d?P(c):sf(c)})}).then(function(){N(c,g)});return M(c)}n.ce=function(){return Vq(this,{H:0,R:0,ta:-1})};
n.de=function(){return Vq(this,{H:this.b.b.length-1,R:Number.POSITIVE_INFINITY,ta:-1})};n.nextPage=function(a,b){var c=this,d=a.H,e=a.R,f=K("nextPage");Tq(c,d).then(function(a){if(a){if(a.complete&&e==a.Fa.length-1){if(d>=c.b.b.length-1){N(f,null);return}d++;e=0}else e++;Vq(c,{H:d,R:e,ta:-1},b).ua(f)}else N(f,null)});return M(f)};n.hd=function(a){var b=a.H;a=a.R;if(0==a){if(0==b)return L(null);b--;a=Number.POSITIVE_INFINITY}else a--;return Vq(this,{H:b,R:a,ta:-1})};
function Yq(a,b,c){b="left"===b.j;a="ltr"===a.ob(c);return!b&&a||b&&!a}function Zq(a,b,c){var d=K("getCurrentSpread"),e=Pq(a,b);if(!e)return L({left:null,right:null});var f="left"===e.j;(Yq(a,e,b)?a.hd(b):a.nextPage(b,c)).then(function(a){a=a&&a.page;f?N(d,{left:e,right:a}):N(d,{left:a,right:e})});return M(d)}n.ie=function(a,b){var c=Pq(this,a);if(!c)return L(null);var c=Yq(this,c,a),d=this.nextPage(a,!!b);if(c)return d;var e=this;return d.Qb(function(a){return a?e.nextPage(a.position,!!b):L(null)})};
n.le=function(a){var b=Pq(this,a);if(!b)return L(null);b=Yq(this,b,a);a=this.hd(a);if(b){var c=this;return a.Qb(function(a){return a?c.hd(a.position):L(null)})}return a};function $q(a,b){var c=K("navigateToEPage");Lq(a.b,b).then(function(b){b?Vq(a,b).ua(c):N(c,null)});return M(c)}function ar(a,b){var c=K("navigateToCFI");Kq(a.b,b).then(function(b){b?Vq(a,b).ua(c):N(c,null)});return M(c)}
function br(a,b,c){u.debug("Navigate to",b);var d=Gq(a.b,wa(b));if(!d){if(a.b.e&&b.match(/^#epubcfi\(/))d=Gq(a.b,a.b.e.url);else if("#"===b.charAt(0)){var e=a.b.j.ne(b);a.b.e?d=Gq(a.b,e[0]):d=e[0];b=d+(e[1]?"#"+e[1]:"")}if(null==d)return L(null)}var f=a.b.h[d];if(!f)return a.b.e&&d==Gq(a.b,a.b.e.url)&&(d=b.indexOf("#"),0<=d)?ar(a,b.substr(d+1)):L(null);var g=K("navigateTo");Tq(a,f.H).then(function(d){var e=Eh(d.X,b);e?Vq(a,{H:f.H,R:-1,ta:zh(d.X,e)}).ua(g):c.H!==f.H?Vq(a,{H:f.H,R:0,ta:-1}).ua(g):N(g,
null)});return M(g)}
function Sq(a,b,c){var d=b.Va.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.style.position="absolute";e.style.top="0";e.style.left="0";ma||(e.style.visibility="hidden");d.g.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);var g=new Yh(e,f);g.H=b.item.H;g.position=c;g.offset=Yp(b.Va,c);0===g.offset&&(b=a.b.j.nd("",b.item.src),f.setAttribute("id",b),ai(g,f,b));d!==a.viewport&&(a=ac(a.viewport.width,
a.viewport.height,d.width,d.height),a=jg(null,new Ub(a,null)),g.h.push(new Vh(e,"transform",a)));return g}function cr(a,b){var c=Dq();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=K("makeMathJaxView"),f=hf(c);d.Push(function(){f.Pa(e)});return M(c)}return L(null)}
...
function Tq(a,b){if(b>=a.b.b.length)return L(null);var c=a.Eb[b];if(c)return L(c);var d=K("getPageViewItem"),e=a.h[b];if(e){var f=hf(d);e.push(f);return M(d)}var e=a.h[b]=[],g=a.b.b[b],h=a.b.f;h.load(g.src).then(function(f){0==g.b&&1==a.b.b.length&&(g.b=Math.ceil(Bh(f)/2700),a.b.u=g.b);var k=h.d[f.url],m=a.bd(f),p=a.viewport,q=Up(k,p.width,p.height,p.fontSize);if(q.width!=p.width||q.height!=p.height||q.fontSize!=p.fontSize)p=new Pp(p.f,q.fontSize,p.root,q.width,q.height);q=a.Eb[b-1];null!==g.Wa?q=
g.Wa-1:(q=q?q.Va.ja+q.ab.length:0,null!==g.Db&&(q+=g.Db));bo(a.d,q);var w=new Vp(k,f,a.b.lang,p,a.f,a.g,m,a.b.w,q,a.b.j,a.d);w.T=a.T;Wp(w).then(function(){c={item:g,X:f,Va:w,Fa:[null],ab:[],complete:!1};a.Eb[b]=c;N(d,c);e.forEach(function(a){a.Pa(c)})})});return M(d)}function dr(a){return a.Eb.some(function(a){return a&&0<a.ab.length})}
n.Ac=function(){var a=this.b,b=a.F||a.O;if(!b)return L(null);var c=K("showTOC");this.e||(this.e=new lq(a.f,b.src,a.lang,this.f,this.g,this.T,this,a.w,a.j,this.d));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background=
"#EEE";e.style.border="1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.e.Ac(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";N(c,a)});return M(c)};n.wc=function(){this.e&&this.e.wc()};n.Bd=function(){return this.e&&this.e.Bd()};var er={Fe:"singlePage",Ge:"spread",ve:"autoSpread"};
function fr(a,b,c,d){var e=this;this.h=a;this.Jc=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);ma&&b.setAttribute("data-vivliostyle-debug",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Sa=c;this.Ra=d;a=a.document;this.Ja=new rh(a.head,b);this.w="loading";this.O=[];this.g=null;this.k=this.d=!1;this.e=this.j=this.f=this.A=null;this.fontSize=16;this.zoom=1;this.G=!1;this.ia="autoSpread";this.na=!1;this.kd=!0;this.T=Xb();this.N=function(){};this.u=function(){};this.ja=
function(){e.d=!0;e.N()};this.fd=this.fd.bind(this);this.D=function(){};this.F=a.getElementById("vivliostyle-page-rules");this.Z=!1;this.l=null;this.Aa={loadEPUB:this.Zd,loadXML:this.$d,configure:this.vd,moveTo:this.Qa,toc:this.Ac};gr(this)}function gr(a){va(1,function(a){hr(this,{t:"debug",content:a})}.bind(a));va(2,function(a){hr(this,{t:"info",content:a})}.bind(a));va(3,function(a){hr(this,{t:"warn",content:a})}.bind(a));va(4,function(a){hr(this,{t:"error",content:a})}.bind(a))}
function hr(a,b){b.i=a.Sa;a.Ra(b)}function ir(a,b){a.w!==b&&(a.w=b,a.Jc.setAttribute("data-vivliostyle-viewer-status",b),hr(a,{t:"readystatechange"}))}n=fr.prototype;
n.Zd=function(a){oo.d("beforeRender");ir(this,"loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=K("loadEPUB"),h=this;h.vd(a).then(function(){var a=new oq;jq(a,e,f).then(function(){var e=ya(b,h.h.location.href);h.O=[e];qq(a,e,d).then(function(a){h.g=a;jr(h,c).then(function(){N(g,!0)})})})});return M(g)};
n.$d=function(a){oo.d("beforeRender");ir(this,"loading");var b=a.url,c=a.document,d=a.fragment,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=K("loadXML"),h=this;h.vd(a).then(function(){var a=new oq;jq(a,e,f).then(function(){var e=b.map(function(a,b){return{url:ya(a.url,h.h.location.href),index:b,Wa:a.Wa,Db:a.Db}});h.O=e.map(function(a){return a.url});h.g=new sq(a,"");Iq(h.g,e,c).then(function(){jr(h,d).then(function(){N(g,!0)})})})});return M(g)};
function jr(a,b){kr(a);var c;b?c=Kq(a.g,b).Qb(function(b){a.e=b;return L(!0)}):c=L(!0);return c.Qb(function(){oo.b("beforeRender");return lr(a)})}function mr(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*mc.ex*a.fontSize/mc.em;if(d=mc[d])return c*d}return c}
n.vd=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.A=null,this.h.addEventListener("resize",this.ja,!1),this.d=!0):this.h.removeEventListener("resize",this.ja,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.d=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:mr(this,b["margin-left"])||0,marginRight:mr(this,b["margin-right"])||0,marginTop:mr(this,b["margin-top"])||0,marginBottom:mr(this,b["margin-bottom"])||
0,width:mr(this,b.width)||0,height:mr(this,b.height)||0},200<=b.width||200<=b.height)&&(this.h.removeEventListener("resize",this.ja,!1),this.A=b,this.d=!0);"boolean"==typeof a.hyphenate&&(this.T.Wc=a.hyphenate,this.d=!0);"boolean"==typeof a.horizontal&&(this.T.Vc=a.horizontal,this.d=!0);"boolean"==typeof a.nightMode&&(this.T.cd=a.nightMode,this.d=!0);"number"==typeof a.lineHeight&&(this.T.lineHeight=a.lineHeight,this.d=!0);"number"==typeof a.columnWidth&&(this.T.Sc=a.columnWidth,this.d=!0);"string"==
typeof a.fontFamily&&(this.T.fontFamily=a.fontFamily,this.d=!0);"boolean"==typeof a.load&&(this.na=a.load);"boolean"==typeof a.renderAllPages&&(this.kd=a.renderAllPages);"string"==typeof a.userAgentRootURL&&(xa=a.userAgentRootURL);"string"==typeof a.pageViewMode&&a.pageViewMode!==this.ia&&(this.ia=a.pageViewMode,this.d=!0);"number"==typeof a.pageBorder&&a.pageBorder!==this.T.Nb&&(this.viewport=null,this.T.Nb=a.pageBorder,this.d=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=a.zoom,this.k=
!0);"boolean"==typeof a.fitToScreen&&a.fitToScreen!==this.G&&(this.G=a.fitToScreen,this.k=!0);return L(!0)};n.fd=function(a){var b=this.f,c=this.j,d=a.target;c?c.left!==d&&c.right!==d||nr(this,a.Td):b===a.target&&nr(this,a.Td)};function or(a,b){var c=[];a.f&&c.push(a.f);a.j&&(c.push(a.j.left),c.push(a.j.right));c.forEach(function(a){a&&b(a)})}function pr(a){or(a,function(a){a.removeEventListener("hyperlink",this.D,!1);a.removeEventListener("replaced",this.fd,!1)}.bind(a))}
function qr(a){pr(a);or(a,function(a){v(a.L,"display","none")});a.f=null;a.j=null}function rr(a,b){b.addEventListener("hyperlink",a.D,!1);b.addEventListener("replaced",a.fd,!1);v(b.L,"visibility","visible");v(b.L,"display","block")}function sr(a,b){qr(a);a.f=b;rr(a,b)}function tr(a){var b=K("reportPosition");Jq(a.g,a.e.H,a.e.ta).then(function(c){var d=a.f;(a.na&&0<d.g.length?vg(d.g):L(!0)).then(function(){ur(a,d,c).ua(b)})});return M(b)}
function vr(a){var b=a.Jc;if(a.A){var c=a.A;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new Pp(a.h,a.fontSize,b,c.width,c.height)}return new Pp(a.h,a.fontSize,b)}
function wr(a){var b=vr(a),c;a:switch(a.ia){case "singlePage":c=!1;break a;case "spread":c=!0;break a;default:c=1.45<=b.width/b.height&&800<b.width}var d=a.T.cb!==c;a.T.cb=c;a.Jc.setAttribute("data-vivliostyle-spread-view",c);if(a.A||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;if(!d&&b.width==a.viewport.width&&b.height==a.viewport.height)return!0;if(d=a.b&&dr(a.b)){a:{d=a.b.Eb;for(c=0;c<d.length;c++){var e=d[c];if(e)for(var e=e.ab,f=0;f<e.length;f++){var g=e[f];if(g.u&&g.l){d=!0;break a}}}d=
!1}d=!d}return d?(a.viewport.width=b.width,a.viewport.height=b.height,a.k=!0):!1}n.oe=function(a,b,c){if(!this.Z&&this.F&&0===b&&0===c){var d="";Object.keys(a).forEach(function(b){d+="@page "+b+"{size:";b=a[b];d+=b.width+"px "+b.height+"px;}"});this.F.textContent=d;this.Z=!0}};
function xr(a){if(a.b){a.b.wc();for(var b=a.b,c=b.Eb,d=0;d<c.length;d++){var e=c[d];e&&e.ab.splice(0)}for(b=b.viewport.root;b.lastChild;)b.removeChild(b.lastChild)}a.F&&(a.F.textContent="",a.Z=!1);a.viewport=vr(a);b=a.viewport;v(b.e,"width","");v(b.e,"height","");v(b.d,"width","");v(b.d,"height","");v(b.d,"transform","");a.b=new Oq(a.g,a.viewport,a.Ja,a.T,a.oe.bind(a))}
function nr(a,b,c){a.k=!1;pr(a);if(a.T.cb)return Zq(a.b,a.e,c).Qb(function(c){qr(a);a.j=c;c.left&&(rr(a,c.left),c.right||c.left.L.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(rr(a,c.right),c.left||c.right.L.setAttribute("data-vivliostyle-unpaired-page",!0));c=yr(a,c);a.viewport.zoom(c.width,c.height,zr(a,c));a.f=b;return L(null)});sr(a,b);Ar(a,b);a.f=b;return L(null)}function Ar(a,b){var c=zr(a,b.d);a.viewport.zoom(b.d.width,b.d.height,c)}
function zr(a,b){return a.G?Math.min(a.viewport.width/b.width,a.viewport.height/b.height):a.zoom}function yr(a,b){var c=0,d=0;b.left&&(c+=b.left.d.width,d=b.left.d.height);b.right&&(c+=b.right.d.width,d=Math.max(d,b.right.d.height));b.left&&b.right&&(c+=2*a.T.Nb);return{width:c,height:d}}var Br={Ae:"fit inside viewport"};function Cr(){this.name="RenderingCanceledError";this.message="Page rendering has been canceled";this.stack=Error().stack}t(Cr,Error);
function kr(a){if(a.l){var b=a.l;Ze(b,new Cr||Error("E_TASK_INTERRUPT"));if(b!==Te&&b.b){b.b.f=!0;var c=new jf(b);b.j="interrupt";b.b=c;b.d.Pa(c)}}a.l=null}
function lr(a){a.d=!1;a.k=!1;if(wr(a))return L(!0);ir(a,"loading");kr(a);var b=af(Te.d,function(){return Ye("resize",function(c){a.l=b;oo.d("render (resize)");xr(a);a.e&&(a.e.R=-1);Xq(a.b,a.e).then(function(d){a.e=d.position;nr(a,d.page,!0).then(function(){tr(a).then(function(d){ir(a,"interactive");(a.kd?a.b.kd():L(null)).then(function(){a.l===b&&(a.l=null);oo.b("render (resize)");ir(a,"complete");hr(a,{t:"loaded"});N(c,d)})})})})},function(a,b){if(b instanceof Cr)oo.b("render (resize)"),u.debug(b.message);
else throw b;})});return L(!0)}function ur(a,b,c){var d=K("sendLocationNotification"),e={t:"nav",first:b.w,last:b.k};Mq(a.g,a.e).then(function(b){e.epage=b;e.epageCount=a.g.u;c&&(e.cfi=c);hr(a,e);N(d,!0)});return M(d)}fr.prototype.ob=function(){return this.b?this.b.ob(this.e):null};
fr.prototype.Qa=function(a){var b=this;"complete"!==this.w&&ir(this,"loading");if("string"==typeof a.where){switch(a.where){case "next":a=this.T.cb?this.b.ie:this.b.nextPage;break;case "previous":a=this.T.cb?this.b.le:this.b.hd;break;case "last":a=this.b.de;break;case "first":a=this.b.ce;break;default:return L(!0)}if(a){var c=a;a=function(){return c.call(b.b,b.e)}}}else if("number"==typeof a.epage){var d=a.epage;a=function(){return $q(b.b,d)}}else if("string"==typeof a.url){var e=a.url;a=function(){return br(b.b,
e,b.e)}}else return L(!0);var f=K("moveTo");a.call(b.b).then(function(a){var c;if(a){b.e=a.position;var d=K("moveTo.showCurrent");c=M(d);nr(b,a.page).then(function(){tr(b).ua(d)})}else c=L(!0);c.then(function(a){"loading"===b.w&&ir(b,"interactive");N(f,a)})});return M(f)};
fr.prototype.Ac=function(a){var b=!!a.autohide;a=a.v;var c=this.b.Bd();if(c){if("show"==a)return L(!0)}else if("hide"==a)return L(!0);if(c)return this.b.wc(),L(!0);var d=this,e=K("showTOC");this.b.Ac(b).then(function(a){if(a){if(b){var c=function(){d.b.wc()};a.addEventListener("hyperlink",c,!1);a.L.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.D,!1)}N(e,!0)});return M(e)};
function Dr(a,b){var c=b.a||"";return Ye("runCommand",function(d){var e=a.Aa[c];e?e.call(a,b).then(function(){hr(a,{t:"done",a:c});N(d,!0)}):(u.error("No such action:",c),N(d,!0))},function(a,b){u.error(b,"Error during action:",c);N(a,!0)})}function Er(a){return"string"==typeof a?JSON.parse(a):a}
function Fr(a,b){var c=Er(b),d=null;$e(function(){var b=K("commandLoop"),f=Te.d;a.D=function(b){var c="#"===b.href.charAt(0)||a.O.some(function(a){return b.href.substr(0,a.length)==a});if(c){b.preventDefault();var d={t:"hyperlink",href:b.href,internal:c};af(f,function(){hr(a,d);return L(!0)})}};qf(function(b){if(a.d)lr(a).then(function(){sf(b)});else if(a.k)a.f&&nr(a,a.f).then(function(){sf(b)});else if(c){var e=c;c=null;Dr(a,e).then(function(){sf(b)})}else e=K("waitForCommand"),d=hf(e,self),M(e).then(function(){sf(b)})}).ua(b);
return M(b)});a.N=function(){var a=d;a&&(d=null,a.Pa())};a.u=function(b){if(c)return!1;c=Er(b);a.N();return!0};a.h.adapt_command=a.u};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Yb||(Object.Yb=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function Gr(a){function b(a){return"number"===typeof a?a:null}function c(a){return"string"===typeof a?{url:a,Wa:null,Db:null}:{url:a.url,Wa:b(a.startPage),Db:b(a.skipPagesBefore)}}return Array.isArray(a)?a.map(c):a?[c(a)]:null}function Hr(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}
function Ir(a,b){ma=a.debug;this.e=!1;this.f=a;this.zb=new fr(a.window||window,a.viewportElement,"main",this.be.bind(this));this.d={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,pageViewMode:"autoSpread",zoom:1,fitToScreen:!1};b&&this.Vd(b);this.b=new $a;Object.defineProperty(this,"readyState",{get:function(){return this.zb.w}})}n=Ir.prototype;n.Vd=function(a){var b=Object.Yb({a:"configure"},Hr(a));this.zb.u(b);Object.Yb(this.d,a)};
n.be=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});ab(this.b,b)};n.pe=function(a,b){this.b.addEventListener(a,b,!1)};n.se=function(a,b){this.b.removeEventListener(a,b,!1)};n.ee=function(a,b,c){a||ab(this.b,{type:"error",content:"No URL specified"});Jr(this,a,null,b,c)};n.qe=function(a,b,c){a||ab(this.b,{type:"error",content:"No URL specified"});Jr(this,null,a,b,c)};
function Jr(a,b,c,d,e){function f(a){if(a)return a.map(function(a){return{url:a.url||null,text:a.text||null}})}d=d||{};var g=f(d.authorStyleSheet),h=f(d.userStyleSheet);e&&Object.Yb(a.d,e);b=Object.Yb({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.f.userAgentRootURL,url:Gr(b)||c,document:d.documentObject,fragment:d.fragment,authorStyleSheet:g,userStyleSheet:h},Hr(a.d));a.e?a.zb.u(b):(a.e=!0,Fr(a.zb,b))}n.ob=function(){return this.zb.ob()};
n.ge=function(a){a:switch(a){case "left":a="ltr"===this.ob()?"previous":"next";break a;case "right":a="ltr"===this.ob()?"next":"previous";break a}this.zb.u({a:"moveTo",where:a})};n.fe=function(a){this.zb.u({a:"moveTo",url:a})};n.re=function(a){var b;a:{b=this.zb;if(!b.f)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.T.cb?yr(b,b.j):b.f.d;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ba("vivliostyle.viewer.Viewer",Ir);Ir.prototype.setOptions=Ir.prototype.Vd;Ir.prototype.addListener=Ir.prototype.pe;Ir.prototype.removeListener=Ir.prototype.se;Ir.prototype.loadDocument=Ir.prototype.ee;Ir.prototype.loadEPUB=Ir.prototype.qe;Ir.prototype.getCurrentPageProgression=Ir.prototype.ob;Ir.prototype.navigateToPage=Ir.prototype.ge;Ir.prototype.navigateToInternalUrl=Ir.prototype.fe;Ir.prototype.queryZoomFactor=Ir.prototype.re;ba("vivliostyle.viewer.ZoomType",Br);Br.FIT_INSIDE_VIEWPORT="fit inside viewport";
ba("vivliostyle.viewer.PageViewMode",er);er.SINGLE_PAGE="singlePage";er.SPREAD="spread";er.AUTO_SPREAD="autoSpread";ko.call(oo,"load_vivliostyle","end",void 0);var Kr=16,Lr="ltr";function Mr(a){window.adapt_command(a)}function Nr(){Mr({a:"moveTo",where:"ltr"===Lr?"previous":"next"})}function Or(){Mr({a:"moveTo",where:"ltr"===Lr?"next":"previous"})}
function Pr(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)Mr({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)Mr({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)Mr({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)Mr({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)Or(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)Nr(),a.preventDefault();else if("0"===b||"U+0030"===c)Mr({a:"configure",fontSize:Math.round(Kr)}),a.preventDefault();else if("t"===b||"U+0054"===c)Mr({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)Kr*=1.2,Mr({a:"configure",fontSize:Math.round(Kr)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)Kr/=1.2,Mr({a:"configure",
fontSize:Math.round(Kr)}),a.preventDefault()}
function Qr(a){switch(a.t){case "loaded":a=a.viewer;var b=Lr=a.ob();a.Jc.setAttribute("data-vivliostyle-page-progression",b);a.Jc.setAttribute("data-vivliostyle-spread-view",a.T.cb);window.addEventListener("keydown",Pr,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Nr,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Or,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(Ba(location.href,Pa(a||"")));break;case "hyperlink":a.internal&&Mr({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+m+"; margin: 0; }",document.head.appendChild(g));Fr(new fr(window,k,"main",Qr),a)});
