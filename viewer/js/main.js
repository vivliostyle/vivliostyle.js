 ...
 *
 * Vivliostyle core 2016.7.1-pre.20161025032400
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
n.Zd=function(a){oo.d("beforeRender");ir(this,"loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=K("loadEPUB"),h=this;h.vd(a).then(function(){var a=new oq;jq(a).then(function(){var k=ya(b,h.h.location.href);h.O=[k];qq(a,k,d).then(function(a){h.g=a;jr(h,e,f,c).then(function(){N(g,!0)})})})});return M(g)};
n.$d=function(a){oo.d("beforeRender");ir(this,"loading");var b=a.url,c=a.document,d=a.fragment,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=K("loadXML"),h=this;h.vd(a).then(function(){var a=new oq;jq(a).then(function(){var k=b.map(function(a,b){return{url:ya(a.url,h.h.location.href),index:b,Wa:a.Wa,Db:a.Db}});h.O=k.map(function(a){return a.url});h.g=new sq(a,"");Iq(h.g,k,c).then(function(){jr(h,e,f,d).then(function(){N(g,!0)})})})});return M(g)};
function jr(a,b,c,d){kr(a);kq(a.g.e,b,c);var e;d?e=Kq(a.g,d).Qb(function(b){a.e=b;return L(!0)}):e=L(!0);return e.Qb(function(){oo.b("beforeRender");return lr(a)})}function mr(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*mc.ex*a.fontSize/mc.em;if(d=mc[d])return c*d}return c}
