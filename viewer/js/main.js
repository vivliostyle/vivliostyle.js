 ...
 *
 * Vivliostyle core 2016.4.1-pre.20160530065427
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
n.Cd=function(){return!1};n.Uc=function(){return!1};function gd(){if(G)throw Error("E_INVALID_CALL");}u(gd,fd);gd.prototype.ia=function(a){return new gc(a,"")};gd.prototype.za=function(){};gd.prototype.U=function(a){return a.dd(this)};var G=new gd;function hd(){if(id)throw Error("E_INVALID_CALL");}u(hd,fd);hd.prototype.ia=function(a){return new gc(a,"/")};hd.prototype.za=function(a){a.append("/")};hd.prototype.U=function(a){return a.ed(this)};var id=new hd;function jd(a){this.b=a}u(jd,fd);
jd.prototype.ia=function(a){return new gc(a,this.b)};jd.prototype.za=function(a,b){b?(a.append('"'),a.append(La(this.b)),a.append('"')):a.append(this.b)};jd.prototype.U=function(a){return a.ec(this)};function kd(a){this.name=a;if($c[a])throw Error("E_INVALID_CALL");$c[a]=this}u(kd,fd);kd.prototype.ia=function(a){return new gc(a,this.name)};kd.prototype.za=function(a,b){b?a.append(Ka(this.name)):a.append(this.name)};kd.prototype.U=function(a){return a.tb(this)};kd.prototype.Cd=function(){return!0};
...
var Dh={ke:"text/html",le:"text/xml",ce:"application/xml",be:"application/xhtml_xml",he:"image/svg+xml"};function Eh(a,b,c){c=c||new DOMParser;var d;try{d=c.parseFromString(a,b)}catch(e){}if(d){a=d.documentElement;if("parsererror"===a.localName)return null;for(a=a.firstChild;a;a=a.nextSibling)if("parsererror"===a.localName)return null}else return null;return d}
...
function Xh(a,b){this.e={};this.I=a;this.b=b;this.w=null;this.h=[];var c=this;this.D=function(a){var b=a.currentTarget,f=b.getAttribute("href")||b.getAttributeNS("http://www.w3.org/1999/xlink","href");f&&(a.preventDefault(),Ya(c,{type:"hyperlink",target:null,currentTarget:null,pe:b,href:f}))};this.j={};this.d={width:0,height:0};this.l=this.k=!1;this.H=0;this.position=null;this.offset=-1;this.g=null;this.f=[];this.u={top:{},bottom:{},left:{},right:{}}}u(Xh,Xa);
...
function hi(a,b,c,d,e,f,g){this.Z=a;this.Yc=d;this.ud=null;this.root=b;this.aa=c;this.type=f;e&&(e.ud=this);this.b=g}function ii(a,b){this.Ud=a;this.count=b}
...
hk={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},ik={re:!1,Rb:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",rc:"\u5341\u767e\u5343",Rd:"\u8ca0"};
function jk(a){if(9999<a||-9999>a)return""+a;if(0==a)return ik.Rb.charAt(0);var b=new Ia;0>a&&(b.append(ik.Rd),a=-a);if(10>a)b.append(ik.Rb.charAt(a));else if(ik.se&&19>=a)b.append(ik.rc.charAt(0)),0!=a&&b.append(ik.rc.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(ik.Rb.charAt(c)),b.append(ik.rc.charAt(2)));if(c=Math.floor(a/100)%10)b.append(ik.Rb.charAt(c)),b.append(ik.rc.charAt(1));if(c=Math.floor(a/10)%10)b.append(ik.Rb.charAt(c)),b.append(ik.rc.charAt(0));(a%=10)&&b.append(ik.Rb.charAt(a))}return b.toString()}
...
function Bm(a,b,c,d,e,f,g,h,l,k,m,p,r,t){this.B=a;this.d=b;this.viewport=c;this.u=c.b;this.j=d;this.F=e;this.aa=f;this.D=g;this.l=h;this.G=l;this.e=k;this.g=m;this.w=p;this.f=r;this.k=t;this.N=this.b=null;this.h=!1;this.Y=null;this.da=0;this.A=null}Bm.prototype.clone=function(){return new Bm(this.B,this.d,this.viewport,this.j,this.F,this.aa,this.D,this.l,this.G,this.e,this.g,this.w,this.f,this.k)};
function Cm(a,b,c,d,e,f){var g=K("createRefShadow");a.aa.j.load(b).then(function(h){if(h){var l=Ch(h,b);if(l){var k=a.G,m=k.B[h.url];if(!m){var m=k.style.h.b[h.url],p=new nc(0,k.pb(),k.ob(),k.h),m=new il(h,m.d,m.g,p,k.f,m.j,k.l);k.B[h.url]=m}f=new hi(d,l,h,e,f,c,m)}}O(g,f)});return N(g)}
function Dm(a,b,c,d,e,f,g,h){var l=K("createShadows"),k=e.template,m;k instanceof od?m=Cm(a,k.url,2,b,h,null):m=M(null);m.then(function(k){var m=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var t=b.getAttribute("href"),q=null;t?q=h?h.aa:a.aa:h&&(t="http://www.w3.org/1999/xhtml"==h.Z.namespaceURI?h.Z.getAttribute("href"):h.Z.getAttributeNS("http://www.w3.org/1999/xlink","href"),q=h.Yc?h.Yc.aa:a.aa);t&&(t=va(t,q.url),m=Cm(a,t,3,b,h,k))}null==m&&(m=M(k));m.then(function(k){var m=
...
var Hm={a:"a",sub:"sub",sup:"sup",table:"table",tr:"tr",td:"td",th:"th",code:"code",body:"div",p:"p",v:"p",date:"p",emphasis:"em",strong:"strong",style:"span",strikethrough:"del"};function Im(a,b){b=va(b,a.aa.url);return a.w[b]||b}
function Jm(a,b,c){var d=!0,e=K("createElementView"),f=a.Y,g=a.b.ea?a.b.ea.b:a.j,h=g.h(f,!1),l={};a.b.parent||(h=Gm(a,h));a.b.f=Fm(a,a.b.f,h,l);l.direction&&(a.b.N=l.direction.toString());var k=l["flow-into"];if(k&&k.toString()!=a.B)return O(e,!1),N(e);var m=l.display;if(m===Rd)return O(e,!1),N(e);a.b.B=m===Fd;Dm(a,f,null==a.b.parent,h,l,g,a.d,a.b.ea).then(function(g){a.b.ya=g;var h=l.position;g=l["float-reference"];var k=l["float"],q=l.clear;a.b.G=Hi(m,h,k,l.overflow);a.b.F=h===Wd||h===rd||h===Ed;
...
function rn(a){for(var b=a.d.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.d.removeChild(b);else break}b=c}}function sn(a){for(var b=a.d.firstChild,c=a.gb,d=a.b?a.b?a.N:a.ra:a.b?a.Pa:a.N,e=a.b?a.b?a.la:a.Pa:a.b?a.ra:a.la,f=0;f<c.length;f++){var g=c[f],h=g.Q-g.W;g.left=qn(a,b,"left",g.$-d,h);g.right=qn(a,b,"right",e-g.V,h)}}
...
function En(a,b){var c=K("layoutFloat"),d=b.A,e=b.j,f=b.ba,g=b.parent?b.parent.N:"ltr",h=a.g.f,l=b.A.parentNode;"page"===f?Li(h,d,e):(w(d,"float","none"),w(d,"display","inline-block"),w(d,"vertical-align","top"));pn(a,b).then(function(k){var m=d.getBoundingClientRect(),p=un(a,d),m=new pe(m.left-p.left,m.top-p.top,m.right+p.right,m.bottom+p.bottom);if("page"===f)Mi(h,b,a.g)?(m=l.ownerDocument.createElement("span"),w(m,"width","0"),w(m,"height","0"),l.appendChild(m),k.A=m,O(c,k)):Oi(h,b,m).then(function(){O(c,
...
a.ra,t,(a.b?-1:1)*a.Pa);r=m;a.b&&(r=He(m));t=a.b?-1:1;r.W<a.Fc*t&&(y=r.Q-r.W,r.W=a.Fc*t,r.Q=r.W+y);Me(q,a.gb,r,e);a.b&&(m=new pe(-r.Q,r.$,-r.W,r.V));q=vn(a,d);w(d,"width",m.V-m.$-q.left-q.right+"px");w(d,"height",m.Q-m.W-q.top-q.bottom+"px");w(d,"position","absolute");w(d,"display",b.display);t=null;p&&(p.F?t=p:t=qi(p));t?(q=t.A.ownerDocument.createElement("div"),q.style.position="absolute",t.f?q.style.right="0":q.style.left="0",q.style.top="0",t.A.appendChild(q),p=q.getBoundingClientRect(),t.A.removeChild(q)):
p={left:a.b?a.Pa:a.N,right:a.b?a.ra:a.la,top:a.b?a.N:a.ra};(t?t.f:a.b)?w(d,"right",p.right-m.V+a.w+"px"):w(d,"left",m.$-p.left+a.j+"px");w(d,"top",m.W-p.top+a.k+"px");b.u&&(b.u.parentNode.removeChild(b.u),b.u=null);p=a.b?m.$:m.Q;m=a.b?m.V:m.W;hn(a,p)&&0!=a.B.length?(b=b.modify(),b.e=!0,O(c,b)):(rn(a),q=new pe(a.b?a.Pa:a.N,a.b?a.N:a.ra,a.b?a.ra:a.la,a.b?a.la:a.Pa),a.b&&(q=He(q)),Ne(q,a.gb,r,e),sn(a),"left"==e?a.Gc=p:a.Hc=p,a.Fc=m,Fn(a,p),O(c,k))}});return N(c)}
...
"pt")));return b}function mo(a,b){var c={},d=a.Db.C*pc(b,a.Db.fa,!1),e=a.yb.C*pc(b,a.yb.fa,!1),f=d+e,g=a.width;c.pb=g===ke?(b.T.$a?Math.floor(b.Fa/2)-b.T.Ib:b.Fa)-2*f:g.C*pc(b,g.fa,!1);g=a.height;c.ob=g===le?b.gb-2*f:g.C*pc(b,g.fa,!1);c.Db=d;c.yb=e;c.Mc=f;return c}function no(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
function oo(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg",c||"polyline");a.setAttribute("stroke","black");a.setAttribute("stroke-width",b);a.setAttribute("fill","none");return a}var po={ne:"top left",oe:"top right",ee:"bottom left",fe:"bottom right"};
...
k.appendChild(l);a=oo(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));k.appendChild(a);b.split(" ").forEach(function(a){k.style[a]=f+"px"});return k}var ro={me:"top",de:"bottom",Id:"left",Jd:"right"};
...
me;c["margin-"+f]=me;c["padding-"+e]=new J(p);c["padding-"+f]=new J(r);c["border-"+e+"-width"]=new J(t);c["border-"+f+"-width"]=new J(q);c[g]=new J(l);c["max-"+g]=new J(l);return{yd:E(d,h,D(d,k,m)),Fd:k,Ed:m}}Co.prototype.qb=function(a,b,c,d,e){Jl.prototype.qb.call(this,a,b,c,d,e);c.w=b.d};function Do(a,b){Jl.call(this,a,b);var c=b.k;this.j=vo[c];a.ma[c]=this;this.na=!0}u(Do,Jl);n=Do.prototype;
...
function Mo(a,b,c){function d(a){if(y)return y;y={ca:q?q.evaluate(a):null,Ka:l?l.evaluate(a):null,La:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[r,m,p,t].forEach(function(b){b&&(c+=b.evaluate(a))});(null===y.Ka||null===y.La)&&c+y.ca+y.Ka+y.La>b&&(null===y.Ka&&(y.Ka=0),null===y.La&&(y.te=0));null!==y.ca&&null!==y.Ka&&null!==y.La&&(y.La=null);null===y.ca&&null!==y.Ka&&null!==y.La?y.ca=b-c-y.Ka-y.La:null!==y.ca&&null===y.Ka&&null!==y.La?y.Ka=b-c-y.ca-y.La:null!==y.ca&&null!==y.Ka&&null===y.La?y.La=
...
function hp(a,b,c,d,e,f,g,h,l,k){nc.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.aa=b;this.lang=b.lang||c;this.viewport=d;this.f={body:!0};this.e=e;this.j=this.b=this.B=this.d=this.u=null;this.k=0;this.Ua=f;this.g=new nh(this.style.l);this.ma={};this.N=null;this.l=new $o(a.b);this.G={};this.la=null;this.Ma=g;this.Oa=h;this.na=l;this.Na=k;for(var m in a.e)(b=a.e[m]["flow-consume"])&&(b.evaluate(this,"flow-consume")==sd?this.f[m]=!0:delete this.f[m]);this.R={}}u(hp,nc);
function ip(a){var b=K("StyleInstance.init");a.d=new il(a.aa,a.style.d,a.style.g,a,a.f,a.style.j,a.l);ul(a.d,a);a.B={};a.B[a.aa.url]=a.d;var c=rl(a.d);a.la=fo(c);a.u=new lm(a.style.B);var d=new sk(a.style.d,a,a.l);a.u.h(d,c);km(a.u,a);a.N=new No(d,a.style.b,a.u,a,c);c=[];for(d=0;d<a.style.f.length;d++){var e=a.style.f[d];if(!e.L||e.L.evaluate(a))e=kh(e.Ab,a),e=new lh(e),c.push(e)}th(a.Ua,c,a.g).ta(b);var f=a.style.w;Object.keys(f).forEach(function(a){var b=mo(lo(f[a]),this);this.R[a]={width:b.pb+
...
function lp(a,b){var c=a.b,d=kp(a,c);if(d==Number.POSITIVE_INFINITY)return null;for(var e=a.u.children,f,g=0;g<e.length;g++)if(f=e[g],"vivliostyle-page-rule-master"!==f.d.rb){var h=1,l=Wl(f,a,"utilization");l&&l.od()&&(h=l.C);var l=pc(a,"em",!1),k=a.pb()*a.ob();a.k=sl(a.d,d,Math.ceil(h*k/(l*l)));h=a;l=c;k=void 0;for(k in l.b){var m=l.b[k];if(m&&0<m.b.length){var p=m.b[0].b;if(jp(h,m)===p.d){a:switch(p=m.d,p){case "left":case "right":case "recto":case "verso":break a;default:p=null}m.d=Zm(al(p,m.b[0].b.e))}}}a.j=
...
function np(a,b,c,d,e,f,g,h){Pl(c);var l=Wl(c,a,"enabled");if(l&&l!==ie)return M(!0);var k=K("layoutContainer"),m=Wl(c,a,"wrap-flow")===ud,p=c.b?c.g&&c.F:c.f&&c.G,l=Wl(c,a,"flow-from"),r=a.viewport.b.createElement("div"),t=Wl(c,a,"position");w(r,"position",t?t.name:"absolute");d.insertBefore(r,d.firstChild);var q=new vi(r);q.b=c.b;c.qb(a,q,b,a.g,a.e);q.D=e;q.F=f;e+=q.left+q.marginLeft+q.R;f+=q.top+q.marginTop+q.ba;if(l&&l.Cd())if(a.G[l.toString()])c.oc(a,q,b,null,1,a.e,a.g),l=M(!0);else{var y=K("layoutContainer.inner"),
L=l.toString(),Q=X(c,a,"column-count"),qa=X(c,a,"column-gap"),Y=1<Q?X(c,a,"column-width"):q.width,l=Vl(c,a),F=0,t=Wl(c,a,"shape-inside"),sa=pg(t,0,0,q.width,q.height,a),Fa=new Bm(L,a,a.viewport,a.d,l,a.aa,a.g,a.style.u,a,b,a.Ma,a.Oa,h,a.Na),Sh=0,ba=null;of(function(b){for(;Sh<Q;){var c=Sh++;if(1<Q){var d=a.viewport.b.createElement("div");w(d,"position","absolute");r.appendChild(d);ba=new gn(d,Fa,a.e);ba.b=q.b;ba.Oa=q.Oa;ba.hc=q.hc;q.b?(w(d,"margin-left",q.j+"px"),w(d,"margin-right",q.w+"px"),c=c*
(Y+qa)+q.k,Ci(ba,0,q.width),Bi(ba,c,Y)):(w(d,"margin-top",q.k+"px"),w(d,"margin-bottom",q.u+"px"),c=c*(Y+qa)+q.j,Bi(ba,0,q.height),Ci(ba,c,Y));ba.D=e+q.j;ba.F=f+q.k}else ba=new gn(r,Fa,a.e),Ai(ba,q),q=ba;ba.G=p?[]:g;ba.wb=sa;if(0<=ba.width){var k=K("inner");mp(a,ba,L).then(function(){ba.h&&"column"!=ba.h&&(Sh=Q,"region"!=ba.h&&(a.G[L]=!0));O(k,!0)});c=N(k)}else c=M(!0);if(c.Ca()){c.then(function(){0<h.b.length?P(b):(F=Math.max(F,ba.e),qf(b))});return}0<h.b.length||(F=Math.max(F,ba.e))}P(b)}).then(function(){q.e=
F;c.oc(a,q,b,ba,Q,a.e,a.g);O(y,!0)});l=N(y)}else{l=Wl(c,a,"content");t=!1;if(l&&Ei(l)){var ol=a.viewport.b.createElement("span");l.U(new Di(ol,a));r.appendChild(ol);jm(c,a,q,a.g)}else c.na&&(d.removeChild(r),t=!0);t||c.oc(a,q,b,null,1,a.e,a.g);l=M(!0)}l.then(function(){if(!c.f||0<Math.floor(q.e)){if(!m){var l=q.D+q.left,p=q.F+q.top,t=yi(q)+q.width+zi(q),y=wi(q)+q.height+xi(q),F=Wl(c,a,"shape-outside"),l=pg(F,l,p,t,y,a);$a(a.viewport.root)&&g.push(xe(l,0,-1.25*pc(a,"em",!1)));g.push(l)}}else if(0==
...
n.$b=function(a){var b=this.e.l;if(a){var c=ij(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Ef(this.e,new Lk(this.d,this.Z,null,b,this.e.f))};n.zc=function(){this.u=!0;this.eb()};n.Kb=function(){var a=new Xo(this.e.j,this.e,this,this.k,this.e.u);Ef(this.e,a);a.Kb()};n.pa=function(){Ek.prototype.pa.call(this);if(this.u){this.u=!1;var a="R"+this.e.F++,b=H(a),c;this.L?c=new dj(b,0,this.L):c=new U(b,0);jj(this.h,"region-id").push(c);this.mb();a=new qp(this.e,this.L,this,a);Ef(this.e,a);a.pa()}};
...
yp.prototype.Vc=function(a){var b=this.j.Vc(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",w(e,"cursor","pointer"),e.addEventListener("click",Ap,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
yp.prototype.tc=function(a,b,c,d,e){if(this.b)return M(this.b);var f=this,g=K("showTOC"),h=new Xh(a,a);this.b=h;this.d.load(this.url).then(function(d){var k=f.d.b[d.url],m=gp(k,c,1E5,e);b=new Xm(b.f,m.fontSize,b.root,m.width,m.height);var p=new hp(k,d,f.lang,b,f.e,f.h,f.Vc(d),f.g,0,f.f);f.Ba=p;p.T=f.T;ip(p).then(function(){op(p,h,null).then(function(){zp(f,a,2);O(g,h)})})});return N(g)};
...
function Fp(a,b){this.f=a;this.h=this.d=this.b=this.g=this.e=null;this.k=b;this.j=null;this.G={};this.lang=null;this.w=0;this.l={};this.N=this.F=this.R=null;this.B={};this.D=null;this.u=Sp(this);Qp()&&(Ui["http://www.w3.org/1998/Math/MathML"]=!0)}
function Sp(a){function b(){}b.prototype.b=function(a,b){return encodeURIComponent(b+(a?"#"+a:""))};b.prototype.d=function(b,d){var e=b.match(/^([^#]*)#?(.*)$/);if(e){var f=e[1]||d,e=e[2];if(f&&a.g.some(function(a){return a.src===f}))return"#"+this.b(e,f)}return b};b.prototype.Xd=function(a){"#"===a.charAt(0)&&(a=a.substring(1));return(a=decodeURIComponent(a).match(/^([^#]*)#?(.*)$/))?[a[1],a[2]]:[]};return new b}
function Tp(a,b){return a.k?b.substr(0,a.k.length)==a.k?decodeURI(b.substr(a.k.length)):null:b}
function Gp(a,b,c,d,e){a.e=b;var f=vh(new wh([b.b]),"package"),g=Qh(f,"unique-identifier")[0];g&&(g=Ch(b,b.url+"#"+g))&&(a.j=g.textContent.replace(/[ \n\r\t]/g,""));var h={};a.g=Va(Mh(vh(vh(f,"manifest"),"item")),function(c){var d=new Ip,e=b.url;d.id=c.getAttribute("id");d.src=va(c.getAttribute("href"),e);d.d=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.g=f}(c=c.getAttribute("fallback"))&&!Rp[d.d]&&(h[d.src]=c);!a.F&&
d.g.nav&&(a.F=d);!a.N&&d.g["cover-image"]&&(a.N=d);return d});a.d=Sa(a.g,Jp);a.h=Sa(a.g,function(b){return Tp(a,b.src)});for(var l in h)for(g=l;;){g=a.d[h[g]];if(!g)break;if(Rp[g.d]){a.B[l]=g.src;break}g=g.src}a.b=Va(Mh(vh(vh(f,"spine"),"itemref")),function(b,c){var d=b.getAttribute("idref");if(d=a.d[d])d.f=b,d.H=c;return d});if(l=Qh(vh(f,"spine"),"toc")[0])a.R=a.d[l];if(l=Qh(vh(f,"spine"),"page-progression-direction")[0]){a:switch(l){case "ltr":l="ltr";break a;case "rtl":l="rtl";break a;default:throw Error("unknown PageProgression: "+
l);}a.D=l}var g=c?Qh(vh(vh(Lh(vh(vh(new wh([c.b]),"encryption"),"EncryptedData"),Kh()),"CipherData"),"CipherReference"),"URI"):[],k=Mh(vh(vh(f,"bindings"),"mediaType"));for(c=0;c<k.length;c++){var m=k[c].getAttribute("handler");(l=k[c].getAttribute("media-type"))&&m&&a.d[m]&&(a.G[l]=a.d[m].src)}a.l=Pp(vh(f,"metadata"),Qh(f,"prefix")[0]);a.l[Mp]&&(a.lang=a.l[Mp][0].v);if(!d){if(0<g.length&&a.j)for(d=Kp(a.j),c=0;c<g.length;c++)a.f.k[a.k+g[c]]=d;return M(!0)}f=new Ia;k={};if(0<g.length&&a.j)for(l="1040:"+
Re(a.j),c=0;c<g.length;c++)k[g[c]]=l;for(c=0;c<d.length;c++){var p=d[c];if(m=p.n){var r=decodeURI(m),g=a.h[r];l=null;g&&(g.j=0!=p.m,g.h=p.c,g.d&&(l=g.d.replace(/\s+/g,"")));g=k[r];if(l||g)f.append(m),f.append(" "),f.append(l||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}Up(a);return rf(e,"","POST",f.toString(),"text/plain")}function Up(a){for(var b=0,c=0;c<a.b.length;c++){var d=a.b[c],e=Math.ceil(d.h/1024);d.e=b;d.b=e;b+=e}a.w=b}
function Vp(a,b,c){a.d={};a.h={};a.g=[];a.b=a.g;var d=a.e=new uh(null,"",(new DOMParser).parseFromString("<spine></spine>","text/xml"));b.forEach(function(a,b){var c=new Ip;c.H=b;c.id="item"+(b+1);c.src=a;var h=d.b.createElement("itemref");h.setAttribute("idref",c.id);d.root.appendChild(h);c.f=h;this.d[c.id]=c;this.h[a]=c;this.g.push(c)},a);return c?Hp(a.f,b[0],c):M(null)}
function Wp(a,b,c){var d=a.b[b],e=K("getCFI");a.f.load(d.src).then(function(a){var b=Ah(a,c),h=null;b&&(a=yh(a,b,0,!1),h=new jb,mb(h,b,c-a),d.f&&mb(h,d.f,0),h=h.toString());O(e,h)});return N(e)}
function Xp(a,b){return Xe("resolveFragment",function(c){if(b){var d=new jb;kb(d,b);var e;if(a.e){var f=lb(d,a.e.b);if(1!=f.ha.nodeType||f.M||!f.Zb){O(c,null);return}var g=f.ha,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.d[h]){O(c,null);return}e=a.d[h];d=f.Zb}else e=a.b[0];a.f.load(e.src).then(function(a){var b=lb(d,a.b);a=yh(a,b.ha,b.offset,b.M);O(c,{H:e.H,qa:a,S:-1})})}else O(c,null)},function(a,d){v.b(d,"Cannot resolve fragment:",b);O(a,null)})}
function Yp(a,b){return Xe("resolveEPage",function(c){if(0>=b)O(c,{H:0,qa:0,S:-1});else{var d=Qa(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.f.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=zh(a),g=Math.round(a*b/e.b),g==a&&g--);O(c,{H:d,qa:g,S:-1})})}},function(a,d){v.b(d,"Cannot resolve epage:",b);O(a,null)})}
function Zp(a,b){var c=a.b[b.H];if(0>=b.qa)return M(c.e);var d=K("getEPage");a.f.load(c.src).then(function(a){a=zh(a);var f=Math.min(a,b.qa);O(d,c.e+f*c.b/a)});return N(d)}function $p(a,b,c,d,e){this.b=a;this.viewport=b;this.f=c;this.g=e;this.Jb=[];this.qa=this.S=this.H=0;this.T=Xb(d);this.e=new Vm(b.f)}function aq(a){var b=a.Jb[a.H];return b?b.hb[a.S]:null}n=$p.prototype;n.nb=function(){if(this.b.D)return this.b.D;var a=this.Jb[this.H];return a?a.Ba.la:null};
function bq(a){var b=K("renderPage");cq(a).then(function(c){if(c){var d=-1;if(0>a.S){var d=a.qa,e=Qa(c.Ja.length,function(a){return kp(c.Ba,c.Ja[a])>d});a.S=e==c.Ja.length?Number.POSITIVE_INFINITY:e-1}var f=c.hb[a.S];f?(a.qa=f.offset,O(b,f)):of(function(b){if(a.S<c.Ja.length)P(b);else if(c.complete)a.S=c.Ja.length-1,P(b);else{var e=c.Ja[c.Ja.length-1],l=dq(a,c,e);op(c.Ba,l,e).then(function(k){l.I.style.display="none";l.I.style.visibility="visible";l.I.style.position="";l.I.style.top="";l.I.style.left=
"";l.I.setAttribute("data-vivliostyle-page-side",l.g);c.Ba.viewport.d.appendChild(l.I);k=(e=k)?e.d-1:c.Ja.length-1;a.g(c.Ba.R,c.item.H,k);e?(c.hb[k]=l,c.Ja.push(e),0<=d&&kp(c.Ba,e)>d?(f=l,a.S=c.Ja.length-2,P(b)):(l.k=0==c.item.H&&0==k,qf(b))):(c.hb.push(l),f=l,a.S=k,0>d&&(a.qa=l.offset),c.complete=!0,l.k=0==c.item.H&&0==k,l.l=c.item.H==a.b.b.length-1,P(b))})}}).then(function(){f=f||c.hb[a.S];var e=c.Ja[a.S];0>d&&(a.qa=kp(c.Ba,e));if(f)O(b,f);else{var h=dq(a,c,e);op(c.Ba,h,e).then(function(d){h.I.style.display=
"none";h.I.style.visibility="visible";h.I.style.position="";h.I.style.top="";h.I.style.left="";h.I.setAttribute("data-vivliostyle-page-side",h.g);c.Ba.viewport.d.appendChild(h.I);d=(e=d)?e.d-1:c.Ja.length-1;a.g(c.Ba.R,c.item.H,d);e?(c.hb[d]=h,c.Ja[a.S+1]=e):(c.hb.push(h),c.complete=!0,h.l=c.item.H==a.b.b.length-1);h.k=0==c.item.H&&0==d;O(b,h)})}})}else O(b,null)});return N(b)}n.ad=function(){return eq(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};
function eq(a,b,c){var d=K("renderAllPages"),e=a.H,f=a.S;a.H=0;of(function(d){a.S=a.H==b?c:Number.POSITIVE_INFINITY;bq(a).then(function(){++a.H>b?P(d):qf(d)})}).then(function(){a.H=e;a.S=f;bq(a).ta(d)});return N(d)}n.Md=function(){this.S=this.H=0;return bq(this)};n.Nd=function(){this.H=this.b.b.length-1;this.S=Number.POSITIVE_INFINITY;return bq(this)};
n.nextPage=function(){var a=this,b=K("nextPage");cq(a).then(function(c){if(c){if(c.complete&&a.S==c.Ja.length-1){if(a.H>=a.b.b.length-1){O(b,null);return}a.H++;a.S=0}else a.S++;bq(a).ta(b)}else O(b,null)});return N(b)};n.Zc=function(){if(0==this.S){if(0==this.H)return M(null);this.H--;this.S=Number.POSITIVE_INFINITY}else this.S--;return bq(this)};function fq(a,b){var c="left"===b.g,d="ltr"===a.nb();return!c&&d||c&&!d}
function gq(a){var b=K("getCurrentSpread"),c=aq(a);if(!c)return M({left:null,right:null});var d=a.H,e=a.S,f="left"===c.g;(fq(a,c)?a.Zc():a.nextPage()).then(function(g){a.H=d;a.S=e;bq(a).then(function(){f?O(b,{left:c,right:g}):O(b,{left:g,right:c})})});return N(b)}n.Sd=function(){var a=aq(this);if(!a)return M(null);var a=fq(this,a),b=this.nextPage();if(a)return b;var c=this;return b.Bc(function(){return c.nextPage()})};
n.Vd=function(){var a=aq(this);if(!a)return M(null);var a=fq(this,a),b=this.Zc();if(a){var c=this;return b.Bc(function(){return c.Zc()})}return b};function hq(a,b){var c=K("navigateToEPage");Yp(a.b,b).then(function(b){b&&(a.H=b.H,a.S=b.S,a.qa=b.qa);bq(a).ta(c)});return N(c)}function iq(a,b){var c=K("navigateToCFI");Xp(a.b,b).then(function(b){b&&(a.H=b.H,a.S=b.S,a.qa=b.qa);bq(a).ta(c)});return N(c)}
function jq(a,b){v.debug("Navigate to",b);var c=Tp(a.b,ta(b));if(!c){if(a.b.e&&b.match(/^#epubcfi\(/))c=Tp(a.b,a.b.e.url);else if("#"===b.charAt(0)){var d=a.b.u.Xd(b);a.b.e?c=Tp(a.b,d[0]):c=d[0];b=c+(d[1]?"#"+d[1]:"")}if(null==c)return M(null)}d=a.b.h[c];if(!d)return a.b.e&&c==Tp(a.b,a.b.e.url)&&(c=b.indexOf("#"),0<=c)?iq(a,b.substr(c+1)):M(null);d.H!=a.H&&(a.H=d.H,a.S=0);var e=K("navigateTo");cq(a).then(function(c){var d=Ch(c.aa,b);d&&(a.qa=xh(c.aa,d),a.S=-1);bq(a).ta(e)});return N(e)}
function dq(a,b,c){var d=b.Ba.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.style.position="absolute";e.style.top="0";e.style.left="0";ja||(e.style.visibility="hidden");d.root.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);f=new Xh(e,f);f.H=b.item.H;f.position=c;f.offset=kp(b.Ba,c);d!==a.viewport&&(a=$b(a.viewport.width,a.viewport.height,d.width,d.height),a=ig(null,new Tb(a,null)),f.h.push(new Uh(e,
"transform",a)));return f}function kq(a,b){var c=Qp();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=K("navigateToEPage"),f=gf(c);d.Push(function(){f.Ya(e)});return N(c)}return M(null)}
n.Vc=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=va(f,a.url),g=c.getAttribute("media-type");if(!g){var h=Tp(b.b,f);h&&(h=b.b.h[h])&&(g=h.d)}if(g&&(h=b.b.G[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Ma(f),l=Ma(g),g=new Ia;g.append(h);g.append("?src=");g.append(f);g.append("&type=");g.append(l);for(h=c.firstChild;h;h=h.nextSibling)1==h.nodeType&&
...
c.namespaceURI)e=kq(c,d);else if("http://example.com/sse"==c.namespaceURI){e=d?d.ownerDocument:b.viewport.b;g=c.localName;switch(g){case "t":case "tab":case "ec":case "nt":case "fraction":case "comment":case "mark":g="span";break;case "ruby":case "rp":case "rt":break;default:g="div"}e=e.createElement(g);e.setAttribute("data-adapt-process-children","true");e=M(e)}else e=c.dataset&&"true"==c.dataset.mathTypeset?kq(c,d):M(null);return e}};
function cq(a){if(a.H>=a.b.b.length)return M(null);var b=a.Jb[a.H];if(b)return M(b);var c=a.b.b[a.H],d=a.b.f,e=K("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(zh(f)/2700),a.b.w=c.b);var g=d.b[f.url],h=a.Vc(f),l=a.viewport,k=gp(g,l.width,l.height,l.fontSize);if(k.width!=l.width||k.height!=l.height||k.fontSize!=l.fontSize)l=new Xm(l.f,k.fontSize,l.root,k.width,k.height);var k=a.Jb[a.H-1],m=new hp(g,f,a.b.lang,l,a.e,a.f,h,a.b.B,k?k.Ba.na+k.hb.length:0,a.b.u);
k&&ap(m.l,k.Ba.l);m.T=a.T;ip(m).then(function(){b={item:c,aa:f,Ba:m,Ja:[null],hb:[],complete:!1};a.Jb[a.H]=b;O(e,b)})});return N(e)}function lq(a){return{H:a.H,S:a.S,qa:a.qa}}function mq(a,b){b?(a.H=b.H,a.S=-1,a.qa=b.qa):(a.H=0,a.S=0,a.qa=0);return eq(a,a.H,a.S)}
n.tc=function(){var a=this.b,b=a.F||a.R;if(!b)return M(null);var c=K("showTOC");this.d||(this.d=new yp(a.f,b.src,a.lang,this.e,this.f,this.T,this,a.B,a.u));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";
e.style.border="1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.d.tc(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";O(c,a)});return N(c)};n.qc=function(){this.d&&this.d.qc()};n.pd=function(){return this.d&&this.d.pd()};function nq(a,b,c,d){var e=this;this.h=a;this.jb=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Oa=c;this.Na=d;a=a.document;this.ma=new ph(a.head,b);this.G=[];this.g=null;this.F=this.d=!1;this.f=this.j=this.e=this.l=null;this.fontSize=16;this.zoom=1;this.ba=!1;this.ad=!0;this.T=Wb();this.D=function(){};this.k=function(){};this.R=function(){e.d=!0;e.D()};this.u=function(){};this.w=a.getElementById("vivliostyle-page-rules");this.N=
!1;this.la={loadEPUB:this.na,loadXML:this.Fa,configure:this.B,moveTo:this.Ma,toc:this.tc};oq(this)}function oq(a){ra(1,function(a){pq(this,{t:"debug",content:a})}.bind(a));ra(2,function(a){pq(this,{t:"info",content:a})}.bind(a));ra(3,function(a){pq(this,{t:"warn",content:a})}.bind(a));ra(4,function(a){pq(this,{t:"error",content:a})}.bind(a))}function pq(a,b){b.i=a.Oa;a.Na(b)}
nq.prototype.na=function(a){bo.b("loadEPUB");bo.b("loadFirstPage");this.jb.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet;this.viewport=null;var f=K("loadEPUB"),g=this;g.B(a).then(function(){var a=new Bp;if(e)for(var l=0;l<e.length;l++)xp(a,e[l]);wp(a).then(function(){var e=va(b,g.h.location.href);g.G=[e];Dp(a,e,d).then(function(a){g.g=a;Xp(g.g,c).then(function(a){g.f=a;qq(g).then(function(){g.jb.setAttribute("data-vivliostyle-viewer-status",
"complete");bo.d("loadEPUB");pq(g,{t:"loaded",metadata:g.g.l});O(f,!0)})})})})});return N(f)};
nq.prototype.Fa=function(a){bo.b("loadXML");bo.b("loadFirstPage");this.jb.setAttribute("data-vivliostyle-viewer-status","loading");var b;"string"===typeof a.url?b=[a.url]:b=a.url;var c=a.document,d=a.fragment,e=a.userStyleSheet;this.viewport=null;var f=K("loadXML"),g=this;g.B(a).then(function(){var a=new Bp;if(e)for(var l=0;l<e.length;l++)xp(a,e[l]);wp(a).then(function(){var e=b.map(function(a){return va(a,g.h.location.href)});g.G=e;g.g=new Fp(a,"");Vp(g.g,e,c).then(function(){Xp(g.g,d).then(function(a){g.f=
a;qq(g).then(function(){g.jb.setAttribute("data-vivliostyle-viewer-status","complete");bo.d("loadXML");pq(g,{t:"loaded"});O(f,!0)})})})})});return N(f)};function rq(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*lc.ex*a.fontSize/lc.em;if(d=lc[d])return c*d}return c}
nq.prototype.B=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.l=null,this.h.addEventListener("resize",this.R,!1),this.d=!0):this.h.removeEventListener("resize",this.R,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.d=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:rq(this,b["margin-left"])||0,marginRight:rq(this,b["margin-right"])||0,marginTop:rq(this,b["margin-top"])||0,marginBottom:rq(this,b["margin-bottom"])||
0,width:rq(this,b.width)||0,height:rq(this,b.height)||0},200<=b.width||200<=b.height)&&(this.h.removeEventListener("resize",this.R,!1),this.l=b,this.d=!0);"boolean"==typeof a.hyphenate&&(this.T.Pc=a.hyphenate,this.d=!0);"boolean"==typeof a.horizontal&&(this.T.Oc=a.horizontal,this.d=!0);"boolean"==typeof a.nightMode&&(this.T.Wc=a.nightMode,this.d=!0);"number"==typeof a.lineHeight&&(this.T.lineHeight=a.lineHeight,this.d=!0);"number"==typeof a.columnWidth&&(this.T.Lc=a.columnWidth,this.d=!0);"string"==
...
a.zoom,this.F=!0);return M(!0)};function sq(a){var b=[];a.e&&(b.push(a.e),a.e=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(w(a.I,"display","none"),a.removeEventListener("hyperlink",this.u,!1))},a)}function tq(a,b){b.addEventListener("hyperlink",a.u,!1);w(b.I,"visibility","visible");w(b.I,"display","block")}function uq(a,b){sq(a);a.e=b;tq(a,b)}
function vq(a){var b=K("reportPosition");a.f||(a.f=lq(a.b));Wp(a.g,a.f.H,a.f.qa).then(function(c){var d=a.e;(a.ba&&0<d.f.length?tg(d.f):M(!0)).then(function(){wq(a,d,c).ta(b)})});return N(b)}function xq(a){var b=a.jb;if(a.l){var c=a.l;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new Xm(a.h,a.fontSize,b,c.width,c.height)}return new Xm(a.h,a.fontSize,b)}
function yq(a){if(a.l||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=xq(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.Jb;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.hb,d=0;d<c.length;d++){var e=c[d];if(e.G&&e.F){a=!0;break a}}}a=!1}b=!a}return b}
nq.prototype.Ua=function(a,b,c){if(!this.N&&this.w&&0===b&&0===c){var d="";Object.keys(a).forEach(function(b){d+="@page "+b+"{size:";b=a[b];d+=b.width+"px "+b.height+"px;}"});this.w.textContent=d;this.N=!0}};
function zq(a){if(a.b){a.b.qc();for(var b=a.b.Jb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.hb,e;e=d.shift();)e=e.I,e.parentNode.removeChild(e)}}a.w&&(a.w.textContent="",a.N=!1);a.viewport=xq(a);b=a.viewport;w(b.e,"width","");w(b.e,"height","");w(b.d,"width","");w(b.d,"height","");w(b.d,"transform","");a.b=new $p(a.g,a.viewport,a.ma,a.T,a.Ua.bind(a))}
function Aq(a,b){a.F=!1;if(a.T.$a)return gq(a.b).Bc(function(c){sq(a);a.j=c;c.left&&(tq(a,c.left),c.right||c.left.I.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(tq(a,c.right),c.left||c.right.I.setAttribute("data-vivliostyle-unpaired-page",!0));c=Bq(a,c);a.viewport.zoom(c.width,c.height,a.zoom);a.e=b;return M(null)});uq(a,b);a.viewport.zoom(b.d.width,b.d.height,a.zoom);a.e=b;return M(null)}
function Bq(a,b){var c=0,d=0;b.left&&(c+=b.left.d.width,d=b.left.d.height);b.right&&(c+=b.right.d.width,d=Math.max(d,b.right.d.height));b.left&&b.right&&(c+=2*a.T.Ib);return{width:c,height:d}}var Cq={ge:"fit inside viewport"};
function qq(a){a.d=!1;if(yq(a))return M(!0);"complete"===a.jb.getAttribute("data-vivliostyle-viewer-status")&&a.jb.setAttribute("data-vivliostyle-viewer-status","resizing");pq(a,{t:"resizestart"});var b=K("resize");a.b&&!a.f&&(a.f=lq(a.b));zq(a);mq(a.b,a.f).then(function(c){Aq(a,c).then(function(){vq(a).then(function(c){bo.d("loadFirstPage");(a.ad?a.b.ad():M(null)).then(function(){a.jb.setAttribute("data-vivliostyle-viewer-status","complete");pq(a,{t:"resizeend"});O(b,c)})})})});return N(b)}
function wq(a,b,c){var d=K("sendLocationNotification"),e={t:"nav",first:b.k,last:b.l};Zp(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.w;c&&(e.cfi=c);pq(a,e);O(d,!0)});return N(d)}nq.prototype.nb=function(){return this.b?this.b.nb():null};
nq.prototype.Ma=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.T.$a?this.b.Sd:this.b.nextPage;break;case "previous":a=this.T.$a?this.b.Vd:this.b.Zc;break;case "last":a=this.b.Nd;break;case "first":a=this.b.Md;break;default:return M(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return hq(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return jq(b.b,d)}}else return M(!0);var e=K("nextPage");a.call(b.b).then(function(a){a?(b.f=
null,Aq(b,a).then(function(){vq(b).ta(e)})):O(e,!0)});return N(e)};nq.prototype.tc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.pd();if(c){if("show"==a)return M(!0)}else if("hide"==a)return M(!0);if(c)return this.b.qc(),M(!0);var d=this,e=K("showTOC");this.b.tc(b).then(function(a){if(a){if(b){var c=function(){d.b.qc()};a.addEventListener("hyperlink",c,!1);a.I.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.u,!1)}O(e,!0)});return N(e)};
function Dq(a,b){var c=b.a||"";return Xe("runCommand",function(d){var e=a.la[c];e?e.call(a,b).then(function(){pq(a,{t:"done",a:c});O(d,!0)}):(v.error("No such action:",c),O(d,!0))},function(a,b){v.error(b,"Error during action:",c);O(a,!0)})}function Eq(a){return"string"==typeof a?JSON.parse(a):a}
function Fq(a,b){var c=Eq(b),d=null;Ze(function(){var b=K("commandLoop"),f=Se.d;a.u=function(b){var c="#"===b.href.charAt(0)||a.G.some(function(a){return b.href.substr(0,a.length)==a}),d={t:"hyperlink",href:b.href,internal:c};$e(f,function(){pq(a,d);return M(!0)})};of(function(b){if(a.d)qq(a).then(function(){qf(b)});else if(a.F)a.e&&Aq(a,a.e).then(function(){qf(b)});else if(c){var e=c;c=null;Dq(a,e).then(function(){qf(b)})}else e=K("waitForCommand"),d=gf(e,self),N(e).then(function(){qf(b)})}).ta(b);
return N(b)});a.D=function(){var a=d;a&&(d=null,a.Ya())};a.k=function(b){if(c)return!1;c=Eq(b);a.D();return!0};a.h.adapt_command=a.k};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Sb||(Object.Sb=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function Gq(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}function Hq(a,b){ja=a.debug;this.f=a;this.b=new nq(a.window||window,a.viewportElement,"main",this.Ld.bind(this));this.e={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,spreadView:!1,zoom:1};b&&this.Gd(b);this.d=new Xa}n=Hq.prototype;
n.Gd=function(a){var b=Object.Sb({a:"configure"},Gq(a));this.b.k(b);Object.Sb(this.e,a)};n.Ld=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});Ya(this.d,b)};n.Yd=function(a,b){this.d.addEventListener(a,b,!1)};n.ae=function(a,b){this.d.removeEventListener(a,b,!1)};n.Od=function(a,b,c){a||Ya(this.d,{type:"error",content:"No URL specified"});Iq(this,a,null,b,c)};n.Zd=function(a,b,c){a||Ya(this.d,{type:"error",content:"No URL specified"});Iq(this,null,a,b,c)};
function Iq(a,b,c,d,e){d=d||{};var f,g=d.userStyleSheet;g&&(f=g.map(function(a){return{url:a.url||null,text:a.text||null}}));e&&Object.Sb(a.e,e);b=Object.Sb({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.f.userAgentRootURL,url:b||c,document:d.documentObject,fragment:d.fragment,userStyleSheet:f},Gq(a.e));Fq(a.b,b)}n.nb=function(){return this.b.nb()};
n.Qd=function(a){a:switch(a){case "left":a="ltr"===this.nb()?"previous":"next";break a;case "right":a="ltr"===this.nb()?"next":"previous";break a}this.b.k({a:"moveTo",where:a})};n.Pd=function(a){this.b.k({a:"moveTo",url:a})};n.$d=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.T.$a?Bq(b,b.j):b.e.d;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ca("vivliostyle.viewer.Viewer",Hq);Hq.prototype.setOptions=Hq.prototype.Gd;Hq.prototype.addListener=Hq.prototype.Yd;Hq.prototype.removeListener=Hq.prototype.ae;Hq.prototype.loadDocument=Hq.prototype.Od;Hq.prototype.loadEPUB=Hq.prototype.Zd;Hq.prototype.getCurrentPageProgression=Hq.prototype.nb;Hq.prototype.navigateToPage=Hq.prototype.Qd;Hq.prototype.navigateToInternalUrl=Hq.prototype.Pd;Hq.prototype.queryZoomFactor=Hq.prototype.$d;ca("vivliostyle.viewer.ZoomType",Cq);Cq.FIT_INSIDE_VIEWPORT="fit inside viewport";
Yn.call(bo,"load_vivliostyle","end",void 0);var Jq=16,Kq="ltr";function Lq(a){window.adapt_command(a)}function Mq(){Lq({a:"moveTo",where:"ltr"===Kq?"previous":"next"})}function Nq(){Lq({a:"moveTo",where:"ltr"===Kq?"next":"previous"})}
...
function Pq(a){switch(a.t){case "loaded":a=a.viewer;var b=Kq=a.nb();a.jb.setAttribute("data-vivliostyle-page-progression",b);a.jb.setAttribute("data-vivliostyle-spread-view",a.T.$a);window.addEventListener("keydown",Oq,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Mq,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Nq,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
...
g.textContent="@page { size: "+m+"; margin: 0; }",document.head.appendChild(g));Fq(new nq(window,k,"main",Pq),a)});
