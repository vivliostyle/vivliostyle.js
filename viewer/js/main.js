 ...
 *
 * Vivliostyle core 2019.1.103-pre.20190309063339
 */
(function(factory) {
...
function cu(a,b){var c=L("loadWebPub");a.load(b).then(function(d){if(d){var e=d.b,f=new au(a,b);e.body&&e.body.setAttribute("data-vivliostyle-primary-entry",!0);var g=e.querySelector("link[rel='publication'],link[rel='manifest'][type='application/webpub+json']");if(g){var h=g.getAttribute("href");/^#/.test(h)?(g=JSON.parse(e.getElementById(h.substr(1)).textContent),bu(f,g,e).then(function(){O(c,f)})):Yt(a,g.href||g.getAttribute("href")).then(function(a){bu(f,a,e).then(function(){O(c,f)})})}else bu(f,
...
function bu(a,b,c){b.readingProgression&&(a.J=b.readingProgression);void 0===a.f&&(a.f={});var d=c&&c.title||b.name||b.metadata&&b.metadata.title;d&&(a.f[ku]=[{v:d}]);var e=ru(a,a.G);!b.readingOrder&&c&&null!==e&&(b.readingOrder=[encodeURI(e)],Array.from(c.querySelectorAll("[role=doc-toc] a[href],[role=directory] a[href],nav li a[href],.toc a[href],#toc a[href]")).forEach(function(c){c=ya(c.href||c.getAttribute("href"));var d=ru(a,c);c=null!==d?encodeURI(d):c;-1==b.readingOrder.indexOf(c)&&b.readingOrder.push(c)}));
