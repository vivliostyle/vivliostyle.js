 ...
 *
 * Vivliostyle core 2016.2.0-pre.20160408010331
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
J=l.toString(),W=Z(c,a,"column-count"),pa=Z(c,a,"column-gap"),X=1<W?Z(c,a,"column-width"):r.width,l=ul(c,a),F=0,v=vl(c,a,"shape-inside"),ra=mg(v,0,0,r.width,r.height,a),Fa=new $l(J,a,a.viewport,a.d,l,a.ba,a.f,a.style.u,a,b,a.Fa,a.Ka,h),Ah=0,aa=null;lf(function(b){for(;Ah<W;){var c=Ah++;if(1<W){var d=a.viewport.b.createElement("div");w(d,"position","absolute");q.appendChild(d);aa=new Gm(d,Fa,a.g);aa.b=r.b;aa.Ka=r.Ka;aa.tb=r.tb;r.b?(w(d,"margin-left",r.j+"px"),w(d,"margin-right",r.H+"px"),c=c*(X+pa)+
r.k,vi(aa,0,r.width),ui(aa,c,X)):(w(d,"margin-top",r.k+"px"),w(d,"margin-bottom",r.w+"px"),c=c*(X+pa)+r.j,ui(aa,0,r.height),vi(aa,c,X));aa.D=e+r.j;aa.F=f+r.k}else aa=new Gm(q,Fa,a.g),ti(aa,r),r=aa;aa.N=p?[]:g;aa.rb=ra;if(0<=aa.width){var k=L("inner");Ko(a,aa,J).then(function(){aa.u&&"column"!=aa.u&&(Ah=W,"region"!=aa.u&&(a.F[J]=!0));O(k,!0)});c=N(k)}else c=M(!0);if(c.Aa()){c.then(function(){0<h.b.length?P(b):(F=Math.max(F,aa.e),nf(b))});return}0<h.b.length||(F=Math.max(F,aa.e))}P(b)}).then(function(){r.e=
