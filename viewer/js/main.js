...
function Ah(a,b){var c=a.responseXML;if(!c){var d=new DOMParser,e=a.responseText;if(e){var f=zh(a);(c=yh(e,f||"application/xml",d))&&!f&&(f=c.documentElement,"html"!==f.localName.toLowerCase()||f.namespaceURI?"svg"===f.localName.toLowerCase()&&"image/svg+xml"!==c.contentType&&(c=yh(e,"image/svg+xml",d)):c=yh(e,"text/html",d));c||(c=yh(e,"text/html",d))}}c=c?new nh(b,a.url,c):null;return N(c)}function Bh(a){this.rb=a}
function Ch(){var a=Dh;return new Bh(function(b){return a.rb(b)&&1==b.nodeType&&"http://www.idpf.org/2008/embedding"==b.getAttribute("Algorithm")})}function Eh(){var a=Ch(),b=Dh;return new Bh(function(c){if(!b.rb(c))return!1;c=new ph([c]);c=oh(c,"EncryptionMethod");a&&(c=Fh(c,a));return 0<c.b.length})}var Dh=new Bh(function(){return!0});function ph(a){this.b=a}function Gh(a){return a.b}function Fh(a,b){for(var c=[],d=0;d<a.b.length;d++){var e=a.b[d];b.rb(e)&&c.push(e)}return new ph(c)}
...
Cj.prototype.gb=function(a){var b=this.b,c=b.B,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.l)];b.l++;break;case "close-quote":return 0<b.l&&b.l--,c[2*Math.min(d,b.l)+1];case "no-open-quote":return b.l++,new nd("");case "no-close-quote":return 0<b.l&&b.l--,new nd("")}return a};
...
Fj={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},Gj={Yd:!1,Ab:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",$b:"\u5341\u767e\u5343",Bd:"\u8ca0"};
function Hj(a){if(9999<a||-9999>a)return""+a;if(0==a)return Gj.Ab.charAt(0);var b=new Pa;0>a&&(b.append(Gj.Bd),a=-a);if(10>a)b.append(Gj.Ab.charAt(a));else if(Gj.Zd&&19>=a)b.append(Gj.$b.charAt(0)),0!=a&&b.append(Gj.$b.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(Gj.Ab.charAt(c)),b.append(Gj.$b.charAt(2)));if(c=Math.floor(a/100)%10)b.append(Gj.Ab.charAt(c)),b.append(Gj.$b.charAt(1));if(c=Math.floor(a/10)%10)b.append(Gj.Ab.charAt(c)),b.append(Gj.$b.charAt(0));(a%=10)&&b.append(Gj.Ab.charAt(a))}return b.toString()}
...
Cj.prototype.nb=function(a){switch(a.name){case "attr":if(1==a.values.length)return new nd(this.d&&this.d.getAttribute(a.values[0].stringValue())||"");break;case "counter":if(2>=a.values.length)return Jj(this,a.values);break;case "counters":if(3>=a.values.length)return Lj(this,a.values)}u.b("E_CSS_CONTENT_PROP:",a.toString());return new nd("")};var Nj=1/1048576;function Oj(a,b){for(var c in a)b[c]=a[c].clone()}
...
m.tc=function(){var a="c"+this.w++;ck(this,new bj(new vj(a)));this.b=[new sj(a)]};m.rc=function(){var a="a"+this.w++;ck(this,new bj(new wj(a)));this.b=[new sj(a)]};m.xc=function(){var a="f"+this.w++;ck(this,new bj(new xj(a)));this.b=[new sj(a)]};m.Gc=function(){dk(this);this.g=null;this.l=!1;this.d=0;this.b=[]};m.fb=function(){var a;0!=this.j?(Hf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.j=1,this.k={},this.g=null,this.d=0,this.l=!1,this.b=[])};
...
fk.prototype.kc=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};fk.prototype.eb=function(a,b,c){c=c?Af(this):Bf(this);c+=this.N;this.N+=Nj;Ui(this.b,a,this.J?new Qi(b,c,this.J):new V(b,c))};function gk(a,b){ag.call(this,a);this.b={};this.d=b;this.N=0}t(gk,ag);gk.prototype.Ja=function(a,b,c){bh(this.d,a,b,c,this)};gk.prototype.Db=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};gk.prototype.kc=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};
gk.prototype.eb=function(a,b,c){c=(c?67108864:50331648)+this.N;this.N+=Nj;Ui(this.b,a,new V(b,c))};var hk=new wf(function(){var a=M("uaStylesheetBase");uf(ch).then(function(b){var c=sa("user-agent-base.css",ra);b=new bk(null,null,null,null,null,b,!0);b.vb("UA");ak=b.h;dg(c,b,null,null).oa(a)});return O(a)},"uaStylesheetBaseFetcher");function ik(a,b,c){return(a=a["writing-mode"])&&(b=a.evaluate(b,"writing-mode"))&&b!==Jd?b===fe:c}
...
sk.prototype.g=function(a,b){var c=qh(this.Z,a),d="e"+c;b&&(c=rh(this.Z,a,0,!0));this.b<=c&&Bk(this,c,0);return this.w[d]};var Ck=1;function Dk(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.h=0;this.d=a;this.name=b;this.cb=c;this.xa=d;this.parent=e;this.g="p"+Ck++;e&&(this.h=e.children.length,e.children.push(this))}Dk.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Dk.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Ek(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
...
function Mk(a,b,c,d,e,f,g){a=a instanceof Kk?a:new Kk(a,this);Dk.call(this,a,b,c,d,e);this.e=this;this.J=f;this.j=g;this.b.width=new V(je,0);this.b.height=new V(ke,0);this.b["wrap-flow"]=new V(yd,0);this.b.position=new V(Wd,0);this.b.overflow=new V(Hd,0);this.k={}}t(Mk,Dk);Mk.prototype.f=function(a){return new Nk(a,this)};Mk.prototype.clone=function(a){a=new Mk(this.d,this.name,a.cb||this.cb,this.xa,this.parent,this.J,this.j);Ek(this,a);Ik(this,a);return a};
function Ok(a,b,c,d,e){Dk.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.k[b]=this.g);this.b["wrap-flow"]=new V(yd,0)}t(Ok,Dk);Ok.prototype.f=function(a){return new Pk(a,this)};Ok.prototype.clone=function(a){a=new Ok(a.parent.d,this.name,this.cb,this.xa,a.parent);Ek(this,a);Ik(this,a);return a};function Qk(a,b,c,d,e){Dk.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.k[b]=this.g)}t(Qk,Dk);Qk.prototype.f=function(a){return new Rk(a,this)};
Qk.prototype.clone=function(a){a=new Qk(a.parent.d,this.name,this.cb,this.xa,a.parent);Ek(this,a);Ik(this,a);return a};function Y(a,b,c){return b&&b!==yd?b.ea(a,c):null}function Sk(a,b,c){return b&&b!==yd?b.ea(a,c):a.b}function Tk(a,b,c){return b?b===yd?null:b.ea(a,c):a.b}function Uk(a,b,c,d){return b&&c!==Rd?b.ea(a,d):a.b}function Vk(a,b,c){return b?b===he?a.g:b===Fd?a.f:b.ea(a,a.b):c}
...
function fl(a,b,c){var d=Z(a,b,"right"),e=Z(a,b,"snap-height"),f=Z(a,b,"margin-right"),g=Z(a,b,"padding-right");b=Z(a,b,"border-right-width");w(c.d,"margin-right",f+"px");w(c.d,"padding-right",g+"px");w(c.d,"border-right-width",b+"px");c.marginRight=f;c.Ea=b;a.b&&0<e&&(a=d+oi(c),a=a-Math.floor(a/e)*e,0<a&&(c.Sb=e-a,g+=c.Sb));c.D=g;c.Tb=e}
...
function jl(a,b,c){w(c.d,"border-top-width","0px");var d=Z(a,b,"max-height");a.I?qi(c,0,d):(gl(a,b,c),d-=c.pa,c.height=d,w(c.d,"height",d+"px"))}function kl(a,b,c){w(c.d,"border-left-width","0px");var d=Z(a,b,"max-width");a.D?ri(c,0,d):(fl(a,b,c),d-=c.Sb,c.width=d,a=Z(a,b,"right"),w(c.d,"right",a+"px"),w(c.d,"width",d+"px"))}
...
el(this,a,b):hl(this,a,b)}if(1<e&&(f=Z(this,a,"column-rule-width"),g=cl(this,a,"column-rule-style"),k=cl(this,a,"column-rule-color"),0<f&&g&&g!=Rd&&k!=de)){var h=Z(this,a,"column-gap"),l=this.b?b.height:b.width,n=this.b?"border-top":"border-left";for(d=1;d<e;d++){var p=(l+h)*d/e-h/2+b.j-f/2,r=b.height+b.k+b.w,q=b.d.ownerDocument.createElement("div");w(q,"position","absolute");w(q,this.b?"left":"top","0px");w(q,this.b?"top":"left",p+"px");w(q,this.b?"height":"width","0px");w(q,this.b?"width":"height",
r+"px");w(q,n,f+"px "+g.toString()+(k?" "+k.toString():""));b.d.insertBefore(q,b.d.firstChild)}}for(d=0;d<ml.length;d++)dl(this,a,b,ml[d]);for(d=0;d<ol.length;d++)e=b,f=ol[d],g=c.g,(k=cl(this,a,f))&&g.push(new Nh(e.d,f,k))};
...
function km(a,b,c){ki.call(this,a);this.Qc=a.lastChild;this.h=b;this.mc=c;this.ud=a.ownerDocument;this.nc=!1;this.ma=this.ib=this.Oa=this.Sc=0;this.Xa=this.Qb=this.l=this.f=null;this.Rc=!1;this.M=this.g=this.u=null;this.gd=!0;this.qc=this.oc=0}t(km,ki);km.prototype.clone=function(){var a=new km(this.d,this.h,this.mc);pi(a,this);a.Qc=this.Qc;a.nc=this.nc;a.l=this.l?this.l.clone():null;a.Qb=this.Qb.concat();return a};
function lm(a,b){var c=b.getBoundingClientRect(),d=(a.b?a.ib:a.Sc)-a.f.V,e=(a.b?a.Sc:a.Oa)-a.f.S;return{left:c.left-d,top:c.top-e,right:c.right-d,bottom:c.bottom-e}}function mm(a,b){return a.b?b<a.ma:b>a.ma}function nm(a,b,c){var d=new ai(b.da,c,0);d.Ka=b.Ka;d.ba=b.ba;d.ua=b.ua;d.na=b.na?nm(a,b.na,di(c)):null;return d}
function om(a,b){var c=M("openAllViews"),d=b.ha;Il(a.h,a.d,a.nc);var e=d.length-1,f=null;mf(function(){for(;0<=e;){f=nm(a,d[e],f);if(0==e&&(f.aa=b.aa,f.K=b.K,f.K))break;var c=Rl(a.h,f,0==e&&0==f.aa);e--;if(c.ya())return c}return N(!1)}).then(function(){Q(c,f)});return O(c)}var pm=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
function qm(a,b){if(b.f&&b.d&&!b.K&&0==b.f.count&&1!=b.b.nodeType){var c=b.b.textContent.match(pm);return Wl(a.h,b,c[0].length)}return N(b)}function rm(a,b,c){var d=M("buildViewToNextBlockEdge");nf(function(d){b.b&&c.push(di(b));qm(a,b).then(function(f){f!==b&&(b=f,c.push(di(b)));Ul(a.h,b).then(function(c){(b=c)?b.j&&!a.b?sm(a,b).then(function(c){b=c;!b||b.e||0<a.h.g.b.length?R(d):pf(d)}):b.d?pf(d):R(d):R(d)})})}).then(function(){Q(d,b)});return O(d)}
...
function vm(a){for(var b=a.d.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.d.removeChild(b);else break}b=c}}function wm(a){for(var b=a.d.firstChild,c=a.Xa,d=a.b?a.f.S:a.f.V,e=a.b?a.f.P:a.f.T,f=0;f<c.length;f++){var g=c[f],k=g.P-g.S;g.left=um(a,b,"left",g.V-d,k);g.right=um(a,b,"right",e-g.T,k)}}
function xm(a,b,c,d,e){var f;if(b&&b.K&&!b.d&&(f=em(b,0,a.b),!isNaN(f)))return f;b=c[d];for(e-=b.ca;;){f=em(b,e,a.b);if(!isNaN(f))return f;if(0<e)e--;else{d--;if(0>d)return a.Oa;b=c[d];1!=b.b.nodeType&&(e=b.b.textContent.length)}}}function ym(a){return"number"==typeof a?a:(a=a.match(/^(-?[0-9]*(\.[0-9]*)?)px$/))?parseFloat(a[0]):0}
...
function Cm(a,b,c,d){if(a.g&&a.g[a.g.length-1].b)return Bm(a,b,c),N(!0);d+=40*(a.b?-1:1);var e=a.l,f=!e;if(f){var g=a.d.ownerDocument.createElement("div");w(g,"position","absolute");var k=a.h.clone(),e=new km(g,k,a.mc);a.l=e;e.b=Xl(a.h,a.b,g);e.nc=!0;a.b?(e.left=0,w(e.d,"width","2em")):(e.top=a.ib,w(e.d,"height","2em"))}a.d.appendChild(e.d);Am(a,e.d,e);g=(a.b?-1:1)*(d-a.Oa);a.b?e.height=a.f.P-a.f.S-li(e)-mi(e):e.width=a.f.T-a.f.V-ni(e)-oi(e);d=(a.b?-1:1)*(a.ib-d)-(a.b?ni(e)-oi(e):li(e)+mi(e));if(f&&
18>d)return a.d.removeChild(e.d),a.l=null,Bm(a,b,c),N(!0);if(!a.b&&e.top<g)return a.d.removeChild(e.d),Bm(a,b,c),N(!0);var h=M("layoutFootnoteInner");a.b?ri(e,0,d):qi(e,g,d);e.A=a.A+a.left+ni(a);e.B=a.B+a.top+li(a);e.I=a.I;var l=new gi(c);f?(Dm(e),f=N(!0)):0==e.I.length?(Em(e),f=N(!0)):f=Fm(e);f.then(function(){Gm(e,l).then(function(d){a.b?(a.ma=a.ib+(e.e+ni(e)+oi(e)),ri(e,0,e.e)):(a.ma=a.ib-(e.e+li(e)+mi(e)),qi(e,a.ma-a.Oa,e.e));var f;!a.b&&0<e.I.length?f=Fm(e):f=N(d);f.then(function(d){d=new im(b,
c,d?d.Qa:null);a.g?a.g.push(d):a.g=[d];Q(h,!0)})})});return O(h)}
function Hm(a,b){var c=M("layoutFootnote"),d=b.b;d.setAttribute("style","");w(d,"display","inline-block");d.textContent="M";var e=d.getBoundingClientRect(),f=a.b?e.left:e.bottom;d.textContent="";Ol(a.h,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d={ha:[{da:b.W,Ka:0,ba:b.ba,ua:null,na:null}],aa:0,K:!1};e=b.ca;b=b.modify();b.K=!0;Cm(a,e,d,f).then(function(){a.l&&a.l.d.parentNode&&a.d.removeChild(a.l.d);mm(a,f)&&0!=a.u.length&&(b.e=!0);Q(c,b)});return O(c)}
...
null)});else{e=ui(e,a.b,g);for(var p=a.b?a.f.S:a.f.V,r=a.b?a.f.P:a.f.T,q=b.parent;q&&q.d;)q=q.parent;if(q){var v=q.b.ownerDocument.createElement("div");v.style.left="0px";v.style.top="0px";a.b?(v.style.bottom="0px",v.style.width="1px"):(v.style.right="0px",v.style.height="1px");q.b.appendChild(v);var y=lm(a,v),p=Math.max(a.b?y.top:y.left,p),r=Math.min(a.b?y.bottom:y.right,r);q.b.removeChild(v);q=a.b?n.P-n.S:n.T-n.V;"left"==e?r=Math.max(r,p+q):p=Math.min(p,r-q)}p=new oe(p,(a.b?-1:1)*a.f.S,r,(a.b?-1:
1)*a.f.P);r=n;a.b&&(r=Ge(n));Le(p,a.Xa,r,e);a.b&&(n=new oe(-r.P,r.V,-r.S,r.T));w(d,"left",n.V-a.f.V+a.j+"px");w(d,"top",n.S-a.f.S+a.k+"px");n=a.b?n.V:n.P;mm(a,n)&&0!=a.u.length?(b=b.modify(),b.e=!0,Q(c,b)):(vm(a),p=a.b?Ge(a.f):a.f,Me(p,a.Xa,r,e),wm(a),"left"==e?a.oc=n:a.qc=n,Jm(a,n),Q(c,l))}});return O(c)}
...
"1"))}}function Lm(a,b,c,d){var e=M("processLineStyling");jm(d);var f=d.concat([]);d.splice(0,d.length);var g=0,k=b.f;0==k.count&&(k=k.Ed);nf(function(d){if(k){var e=Mm(a,f),n=k.count-g;if(e.length<=n)R(d);else{var p=Nm(a,f,e[n-1]);Om(a,p,!1,!1).then(function(){g+=n;Wl(a.h,p,0).then(function(e){b=e;Km(b,!1);k=b.f;f=[];rm(a,b,f).then(function(b){c=b;0<a.h.g.b.length?R(d):pf(d)})})})}}else R(d)}).then(function(){Array.prototype.push.apply(d,f);jm(d);Q(e,c)});return O(e)}
...
function gm(a,b,c){var d=b.e,e;if(c)e=c=1;else{for(e=d[0];e.parent&&e.d;)e=e.parent;c=Math.max((e.l.widows||2)-0,1);e=Math.max((e.l.orphans||2)-0,1)}var f=Mm(a,d),g=a.ma,d=Xa(f.length,function(b){return a.b?f[b]<g:f[b]>g}),d=Math.min(f.length-c,d);if(d<e)return null;g=f[d-1];if(b=Nm(a,b.e,g))a.e=(a.b?-1:1)*(g-a.Oa);return b}
...
un.prototype.Cc=function(){var a=this.style;a.top=le;a["margin-top"]=le;a["border-top-width"]=le;a["padding-top"]=le;a["padding-bottom"]=le;a["border-bottom-width"]=le;a["margin-bottom"]=le;a.bottom=le};un.prototype.$=function(a,b,c){b=b.l;var d={start:this.j.marginLeft,end:this.j.marginRight,X:this.j.qb},e={start:this.j.marginTop,end:this.j.marginBottom,X:this.j.pb};xn(this,b.top,!0,d,a,c);xn(this,b.bottom,!0,d,a,c);xn(this,b.left,!1,e,a,c);xn(this,b.right,!1,e,a,c)};
...
function Dn(a,b,c){var d={Ma:null,Pb:null};if(a&&b)if(a.b()&&b.b()){var e=a.e(),f=b.e();0<e&&0<f?(f=e+f,f<c?d.Ma=c*e/f:(a=a.f(),b=b.f(),b=a+b,b<c?d.Ma=a+(c-b)*(e-a)/(f-b):0<b&&(d.Ma=c*a/b)),0<d.Ma&&(d.Pb=c-d.Ma)):0<e?d.Ma=c:0<f&&(d.Pb=c)}else a.b()?d.Ma=Math.max(c-b.d(),0):b.b()&&(d.Pb=Math.max(c-a.d(),0));else a?a.b()&&(d.Ma=c):b&&b.b()&&(d.Pb=c);return d}function vn(a,b){Rk.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.pb=this.qb=null}t(vn,Rk);
vn.prototype.h=function(a,b){var c=this.B,d;for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(d.match(/^column.*$/)||d.match(/^background-/))&&(c[d]=b[d]);Rk.prototype.h.call(this,a,b);d=this.e;c={qb:this.qb,pb:this.pb,marginTop:this.marginTop,marginRight:this.marginRight,marginBottom:this.marginBottom,marginLeft:this.marginLeft};d.j=c;d=d.style;d.width=new L(c.qb);d.height=new L(c.pb);d["padding-left"]=new L(c.marginLeft);d["padding-right"]=new L(c.marginRight);d["padding-top"]=new L(c.marginTop);
var e=c.marginBottom.b;d["padding-bottom"]=new L(G(e,c.marginBottom,new B(e,.75)))};vn.prototype.Bc=function(){var a=En(this,{start:"left",end:"right",X:"width"});this.qb=a.jd;this.marginLeft=a.qd;this.marginRight=a.pd};vn.prototype.Cc=function(){var a=En(this,{start:"top",end:"bottom",X:"height"});this.pb=a.jd;this.marginTop=a.qd;this.marginBottom=a.pd};
...
c["margin-"+f]=le;c["padding-"+e]=new L(p);c["padding-"+f]=new L(r);c["border-"+e+"-width"]=new L(q);c["border-"+f+"-width"]=new L(v);c[g]=new L(h);c["max-"+g]=new L(h);return{jd:G(d,k,E(d,l,n)),qd:l,pd:n}}vn.prototype.sb=function(a,b,c){Rk.prototype.sb.call(this,a,b,c);c.u=b.d};function wn(a,b){Rk.call(this,a,b);var c=b.l;this.j=on[c];a.pa[c]=this;this.va=!0}t(wn,Rk);m=wn.prototype;
m.sb=function(a,b,c){var d=b.d;w(d,"display","flex");var e=cl(this,a,"vertical-align"),f=null;e===J("middle")?f="center":e===J("top")?f="flex-start":e===J("bottom")&&(f="flex-end");f&&(w(d,"flex-flow",this.b?"row":"column"),w(d,"justify-content",f));Rk.prototype.sb.call(this,a,b,c)};
...
y.Ba:null===y.X?(y.Ba=y.Ca=0,y.X=b-c):y.Ba=y.Ca=(b-c-y.X)/2;return y}var e=a.style;a=a.d.d;var f=b.Dc,g=b.Ic;b=b.X;var k=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],h=Tk(a,e["margin-"+f],k),l=Tk(a,e["margin-"+g],k),n=Sk(a,e["padding-"+f],k),p=Sk(a,e["padding-"+g],k),r=Uk(a,e["border-"+f+"-width"],e["border-"+f+"-style"],k),q=Uk(a,e["border-"+g+"-width"],e["border-"+g+"-style"],k),v=Y(a,e[b],k),y=null;e[b]=new L(new nc(a,function(){var a=d(this).X;return null===a?0:a},b));e["margin-"+f]=new L(new nc(a,
function(){var a=d(this).Ba;return null===a?0:a},"margin-"+f));e["margin-"+g]=new L(new nc(a,function(){var a=d(this).Ca;return null===a?0:a},"margin-"+g));"left"===f?e.left=new L(E(a,c.marginLeft,c.qb)):"top"===f&&(e.top=new L(E(a,c.marginTop,c.pb)))}m.Bc=function(){var a=this.e.j;this.j.ra?Fn(this,{Dc:"right",Ic:"left",X:"width"},a):this.j.sa?Fn(this,{Dc:"left",Ic:"right",X:"width"},a):this.ga({start:"left",end:"right",X:"width"},a)};
...
function $n(a,b){var c=Zn(a,a.b);if(c==Number.POSITIVE_INFINITY)return null;for(var d=a.k.children,e,f=0;f<d.length;f++)if(e=d[f],"vivliostyle-page-rule-master"!==e.d.cb){var g=1,k=cl(e,a,"utilization");k&&k.Zc()&&(g=k.C);k=tc(a,"em",!1);a.h=Bk(a.d,c,Math.ceil(g*a.u()*a.l()/(k*k)));var g=a,k=g.b.d,h=void 0;for(h in g.b.b)for(var l=g.b.b[h],n=l.b.length-1;0<=n;n--){var p=l.b[n];0>p.b.e&&p.b.b<g.h&&(p.b.e=k)}sc(a,a.style.b);g=cl(e,a,"enabled");if(!g||g===he){d=a;u.d("Location - page",d.b.d);u.d("  current:",
c);u.d("  lookup:",d.h);c=void 0;for(c in d.b.b)for(f=d.b.b[c],g=0;g<f.b.length;g++)u.d("  Chunk",c+":",f.b[g].b.b);c=a.M;f=b;g=e.d;if(0===Object.keys(f).length)g.d.e=g;else{e=g;d=In(c,f);e=e.g+"^"+d;d=c.g[e];if(!d){if("background-host"===g.cb)d=c,f=(new qn(d.h,d.f.d,f)).f(d.f),f.h(d.b,d.e),ql(f,d.d),d=f;else{d=c;k=f;f=g.clone({cb:"vivliostyle-page-rule-master"});if(g=k.size)k=mn(k),g=g.Da,f.b.width=Ri(d.d,f.b.width,new V(k.width,g)),f.b.height=Ri(d.d,f.b.height,new V(k.height,g));f=f.f(d.f);f.h(d.b,
d.e);ql(f,d.d);d=f}c.g[e]=d}e=d.d;e.d.e=e;e=d}return e}}throw Error("No enabled page masters");}
function ao(a,b,c){var d=a.b.b[c];if(!d)return N(!0);Dm(b);a.e[c]&&0<b.Xa.length&&(b.gd=!1);var e=M("layoutColumn"),f=[];nf(function(c){for(;0<d.b.length;){var e=0,h=d.b[e];if(h.b.b>a.h)break;for(var l=1;l<d.b.length;l++){var n=d.b[l];if(n.b.b>a.h)break;Wh(n.b,h.b)&&(h=n,e=l)}var p=h.b,r=!0;Gm(b,h.d).then(function(a){h.b.Gd&&(null===a||p.d)&&f.push(h);p.d?(d.b.splice(e,1),R(c)):a?(h.d=a,R(c)):(d.b.splice(e,1),r?r=!1:pf(c))});if(r){r=!1;return}}R(c)}).then(function(){0<f.length&&(d.b=f.concat(d.b));
Q(e,!0)});return O(e)}
function bo(a,b,c,d,e,f,g,k){var h=cl(c,a,"enabled");if(h&&h!==he)return N(!0);var l=M("layoutContainer"),n=cl(c,a,"wrap-flow")===yd,p=c.b?c.g&&c.D:c.f&&c.I,h=cl(c,a,"flow-from"),r=a.viewport.b.createElement("div"),q=cl(c,a,"position");w(r,"position",q?q.name:"absolute");d.insertBefore(r,d.firstChild);var v=new ki(r);v.b=c.b;c.sb(a,v,b);v.A=e;v.B=f;e+=v.left+v.marginLeft+v.$;f+=v.top+v.marginTop+v.fa;if(h&&h.nd())if(a.I[h.toString()])c.Yb(a,v,b,null,1,a.f),h=N(!0);else{var y=M("layoutContainer.inner"),
I=h.toString(),W=Z(c,a,"column-count"),P=Z(c,a,"column-gap"),F=1<W?Z(c,a,"column-width"):v.width,h=bl(c,a),Ea=0,q=cl(c,a,"shape-inside"),ob=lg(q,0,0,v.width,v.height,a),Fk=new Fl(I,a,a.viewport,a.d,h,a.Z,a.ma,a.style.u,a,b,a.Ea,a.Fa,k),sh=0,aa=null;nf(function(b){for(;sh<W;){var c=sh++;if(1<W){var d=a.viewport.b.createElement("div");w(d,"position","absolute");r.appendChild(d);aa=new km(d,Fk,a.f);aa.b=v.b;aa.Fa=v.Fa;aa.Tb=v.Tb;v.b?(w(d,"margin-left",v.j+"px"),w(d,"margin-right",v.D+"px"),c=c*(F+P)+
...
m.fc=function(a,b,c){a=new Mk(this.f.j,a,b,c,this.f.u,this.J,Bf(this.Y));Df(this.f,new wl(a.d,this.f,a,this.u))};m.lb=function(a){a=a.d;null!=this.J&&(a=ad(this.e,this.J,a));Df(this.f,new fo(this.f,a,this,this.B))};m.cc=function(){Df(this.f,new ek(this.e,this.Y))};m.ec=function(){var a={};this.f.k.push({kb:a,J:this.J});Df(this.f,new fk(this.e,this.Y,null,a,this.f.f))};m.dc=function(a){var b=this.f.h[a];b||(b={},this.f.h[a]=b);Df(this.f,new fk(this.e,this.Y,null,b,this.f.f))};
m.ic=function(){var a={};this.f.w.push(a);Df(this.f,new fk(this.e,this.Y,this.J,a,this.f.f))};m.Jb=function(a){var b=this.f.l;if(a){var c=Vi(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Df(this.f,new fk(this.e,this.Y,null,b,this.f.f))};m.hc=function(){this.A=!0;this.fb()};m.ub=function(){var a=new Qn(this.f.j,this.f,this,this.u);Df(this.f,a);a.ub()};
...
function jo(a,b){var c=M("OPSDocStore.load"),d=b.url;Ah(b,a).then(function(b){if(b){for(var f=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),k=0;k<g.length;k++){var h=g[k],l=h.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),n=h.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=h.getAttribute("action"),h=h.getAttribute("ref");l&&n&&p&&h&&f.push({Dd:l,event:n,action:p,Ib:h})}a.B[d]=f;var r=[],f=sa("user-agent-page.css",ra);r.push({url:f,text:null,
...
qo.prototype.load=function(a){var b=qa(a);if(a=this.l[b])return a.ya()?a:N(a.Vb());var c=M("EPUBDocStore.load");a=qo.Hd.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?Q(c,a):u.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return O(c)};function wo(){this.id=null;this.src="";this.g=this.d=null;this.F=-1;this.h=0;this.j=null;this.b=this.e=0;this.f=$a}function xo(a){return a.id}
...
ap.prototype.va=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.Q.Va?this.b.Cd:this.b.nextPage;break;case "previous":a=this.Q.Va?this.b.Fd:this.b.Kc;break;case "last":a=this.b.xd;break;case "first":a=this.b.wd;break;default:return N(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return Vo(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return Xo(b.b,d)}}else return N(!0);var e=M("nextPage");a.call(b.b).then(function(a){a?(b.f=
...
ca("vivliostyle.viewer.Viewer",up);up.prototype.setOptions=up.prototype.rd;up.prototype.addListener=up.prototype.Id;up.prototype.removeListener=up.prototype.Ld;up.prototype.loadDocument=up.prototype.yd;up.prototype.loadEPUB=up.prototype.Jd;up.prototype.getCurrentPageProgression=up.prototype.bb;up.prototype.navigateToPage=up.prototype.Ad;up.prototype.navigateToInternalUrl=up.prototype.zd;up.prototype.queryZoomFactor=up.prototype.Kd;ca("vivliostyle.viewer.ZoomType",pp);pp.FIT_INSIDE_VIEWPORT="fit inside viewport";
