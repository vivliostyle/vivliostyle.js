 ...
 *
 * Vivliostyle core 2016.7.1-pre.20161024091231
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
!0);"boolean"==typeof a.fitToScreen&&a.fitToScreen!==this.G&&(this.G=a.fitToScreen,this.k=!0);return L(!0)};n.fd=function(a){var b=this.f,c=this.j,d=a.target;c?c.left!==d&&c.right!==d||nr(this,a.Td):b===a.target&&nr(this,a.Td)};function or(a){var b=[];a.f&&(b.push(a.f),a.f=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(v(a.L,"display","none"),a.removeEventListener("hyperlink",this.D,!1),a.removeEventListener("replaced",this.fd,!1))},a)}
function pr(a,b){b.addEventListener("hyperlink",a.D,!1);b.addEventListener("replaced",a.fd,!1);v(b.L,"visibility","visible");v(b.L,"display","block")}function qr(a,b){or(a);a.f=b;pr(a,b)}function rr(a){var b=K("reportPosition");Jq(a.g,a.e.H,a.e.ta).then(function(c){var d=a.f;(a.na&&0<d.g.length?vg(d.g):L(!0)).then(function(){sr(a,d,c).ua(b)})});return M(b)}
function tr(a){var b=a.Jc;if(a.A){var c=a.A;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new Pp(a.h,a.fontSize,b,c.width,c.height)}return new Pp(a.h,a.fontSize,b)}
function ur(a){var b=tr(a),c;a:switch(a.ia){case "singlePage":c=!1;break a;case "spread":c=!0;break a;default:c=1.45<=b.width/b.height&&800<b.width}var d=a.T.cb!==c;a.T.cb=c;a.Jc.setAttribute("data-vivliostyle-spread-view",c);if(a.A||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;if(!d&&b.width==a.viewport.width&&b.height==a.viewport.height)return!0;if(d=a.b&&dr(a.b)){a:{d=a.b.Eb;for(c=0;c<d.length;c++){var e=d[c];if(e)for(var e=e.ab,f=0;f<e.length;f++){var g=e[f];if(g.u&&g.l){d=!0;break a}}}d=
...
function vr(a){if(a.b){a.b.wc();for(var b=a.b,c=b.Eb,d=0;d<c.length;d++){var e=c[d];e&&e.ab.splice(0)}for(b=b.viewport.root;b.lastChild;)b.removeChild(b.lastChild)}a.F&&(a.F.textContent="",a.Z=!1);a.viewport=tr(a);b=a.viewport;v(b.e,"width","");v(b.e,"height","");v(b.d,"width","");v(b.d,"height","");v(b.d,"transform","");a.b=new Oq(a.g,a.viewport,a.Ja,a.T,a.oe.bind(a))}
function nr(a,b,c){a.k=!1;if(a.T.cb)return Zq(a.b,a.e,c).Qb(function(c){or(a);a.j=c;c.left&&(pr(a,c.left),c.right||c.left.L.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(pr(a,c.right),c.left||c.right.L.setAttribute("data-vivliostyle-unpaired-page",!0));c=wr(a,c);a.viewport.zoom(c.width,c.height,xr(a,c));a.f=b;return L(null)});qr(a,b);yr(a,b);a.f=b;return L(null)}function yr(a,b){var c=xr(a,b.d);a.viewport.zoom(b.d.width,b.d.height,c)}
function xr(a,b){return a.G?Math.min(a.viewport.width/b.width,a.viewport.height/b.height):a.zoom}function wr(a,b){var c=0,d=0;b.left&&(c+=b.left.d.width,d=b.left.d.height);b.right&&(c+=b.right.d.width,d=Math.max(d,b.right.d.height));b.left&&b.right&&(c+=2*a.T.Nb);return{width:c,height:d}}var zr={Ae:"fit inside viewport"};function Ar(){this.name="RenderingCanceledError";this.message="Page rendering has been canceled";this.stack=Error().stack}t(Ar,Error);
...
function lr(a){a.d=!1;a.k=!1;if(ur(a))return L(!0);ir(a,"loading");kr(a);var b=af(Te.d,function(){return Ye("resize",function(c){a.l=b;oo.d("render (resize)");vr(a);a.e&&(a.e.R=-1);Xq(a.b,a.e).then(function(d){a.e=d.position;nr(a,d.page,!0).then(function(){rr(a).then(function(d){ir(a,"interactive");(a.kd?a.b.kd():L(null)).then(function(){a.l===b&&(a.l=null);oo.b("render (resize)");ir(a,"complete");hr(a,{t:"loaded"});N(c,d)})})})})},function(a,b){if(b instanceof Ar)oo.b("render (resize)"),u.debug(b.message);
else throw b;})});return L(!0)}function sr(a,b,c){var d=K("sendLocationNotification"),e={t:"nav",first:b.w,last:b.k};Mq(a.g,a.e).then(function(b){e.epage=b;e.epageCount=a.g.u;c&&(e.cfi=c);hr(a,e);N(d,!0)});return M(d)}fr.prototype.ob=function(){return this.b?this.b.ob(this.e):null};
...
e,b.e)}}else return L(!0);var f=K("moveTo");a.call(b.b).then(function(a){var c;if(a){b.e=a.position;var d=K("moveTo.showCurrent");c=M(d);nr(b,a.page).then(function(){rr(b).ua(d)})}else c=L(!0);c.then(function(a){"loading"===b.w&&ir(b,"interactive");N(f,a)})});return M(f)};
