 ...
 *
 * Vivliostyle core 2016.2.0-pre.20160318115333
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function hi(a,b,c,d,e,f,g){this.aa=a;this.Sc=d;this.nd=null;this.root=b;this.ba=c;this.type=f;e&&(e.nd=this);this.b=g}function ii(a,b){this.Qd=a;this.count=b}function ji(a,b,c){this.Y=a;this.parent=b;this.ga=c;this.ca=0;this.L=!1;this.Na=0;this.da=b?b.da:null;this.qa=this.wa=null;this.H=!1;this.b=!0;this.d=!1;this.g=b?b.g:0;this.u=this.h=this.N=null;this.C=!1;this.w=b?b.w:0;this.k=b?b.k:!1;this.A=this.B=this.j=null;this.l=b?b.l:{};this.f=b?b.f:!1;this.F=b?b.F:"ltr";this.e=b?b.e:null}
function ki(a){a.b=!0;a.g=a.parent?a.parent.g:0;a.A=null;a.ca=0;a.L=!1;a.h=null;a.u=null;a.C=!1;a.j=null;a.B=null;a.wa=null;a.k=a.parent?a.parent.k:!1;a.f=a.parent?a.parent.f:!1;a.wa=null}function li(a){var b=new ji(a.Y,a.parent,a.ga);b.ca=a.ca;b.L=a.L;b.wa=a.wa;b.Na=a.Na;b.da=a.da;b.qa=a.qa;b.b=a.b;b.g=a.g;b.h=a.h;b.u=a.u;b.k=a.k;b.C=a.C;b.w=a.w;b.j=a.j;b.B=a.B;b.A=a.A;b.e=a.e;b.f=a.f;b.d=a.d;return b}ji.prototype.modify=function(){return this.H?li(this):this};
function mi(a){var b=a;do{if(b.H)break;b.H=!0;b=b.parent}while(b);return a}ji.prototype.clone=function(){for(var a=li(this),b=a,c;null!=(c=b.parent);)c=li(c),b=b.parent=c;return a};function ni(a){return{ha:a.Y,Na:a.Na,da:a.da,wa:a.wa,qa:a.qa?ni(a.qa):null}}function oi(a){var b=a,c=[];do b.e&&b.parent&&b.parent.e!==b.e||c.push(ni(b)),b=b.parent;while(b);return{ka:c,ca:a.ca,L:a.L}}function pi(a){this.Sa=a;this.b=this.d=null}
...
si.prototype.clone=function(){var a=new si;a.d=this.d;a.f=this.f;a.e=this.e;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b].clone();return a};function ti(a){this.d=a;this.C=this.B=this.height=this.width=this.u=this.k=this.F=this.j=this.xa=this.fa=this.Ja=this.Z=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.$b=this.H=null;this.pa=this.ac=this.Ka=this.bc=this.e=0;this.b=!1}function ui(a){return a.marginTop+a.fa+a.k}
function vi(a){return a.marginBottom+a.xa+a.u}function wi(a){return a.marginLeft+a.Z+a.j}function xi(a){return a.marginRight+a.Ja+a.F}function yi(a,b){a.d=b.d;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.Z=b.Z;a.Ja=b.Ja;a.fa=b.fa;a.xa=b.xa;a.j=b.j;a.F=b.F;a.k=b.k;a.u=b.u;a.width=b.width;a.height=b.height;a.B=b.B;a.C=b.C;a.$b=b.$b;a.H=b.H;a.e=b.e;a.bc=b.bc;a.Ka=b.Ka;a.b=b.b}
...
function sl(a,b,c){var d=Y(a,b,"right"),e=Y(a,b,"snap-height"),f=Y(a,b,"margin-right"),g=Y(a,b,"padding-right");b=Y(a,b,"border-right-width");w(c.d,"margin-right",f+"px");w(c.d,"padding-right",g+"px");w(c.d,"border-right-width",b+"px");c.marginRight=f;c.Ja=b;a.b&&0<e&&(a=d+xi(c),a=a-Math.floor(a/e)*e,0<a&&(c.ac=e-a,g+=c.ac));c.F=g;c.bc=e}
...
il.prototype.gc=function(a,b,c,d,e,f,g){this.b?this.B=b.e+b.ac:this.w=b.e+b.pa;f=(this.b||!d)&&this.f;var k=(!this.b||!d)&&this.g,h=null;if(k||f)k&&w(b.d,"width","auto"),f&&w(b.d,"height","auto"),h=(d?d.d:b.d).getBoundingClientRect(),k&&(this.B=Math.ceil(h.right-h.left-b.j-b.Z-b.F-b.Ja),this.b&&(this.B+=b.ac)),f&&(this.w=h.bottom-h.top-b.k-b.fa-b.u-b.xa,this.b||(this.w+=b.pa));(this.b?this.f:this.g)&&vl(this,a,b);if(this.b?this.g:this.f){if(this.b?this.F:this.H)this.b?sl(this,a,b):tl(this,a,b);this.b?
...
vd&&(k=k.url,la.push(wg(new Image,k)));dm(a,g,h);k=h.widows;l=h.orphans;if(k||l){if(a.b.parent){a.b.l={};for(var Xb in a.b.parent.l)a.b.l[Xb]=a.b.parent.l[Xb]}k instanceof td&&(a.b.l.widows=k.D);l instanceof td&&(a.b.l.orphans=l.D)}if(!a.b.b&&(Xb=null,b?c&&(Xb=a.b.f?Nl:Ml):Xb=a.b.f?Ll:Kl,Xb))for(var Rk in Xb)w(g,Rk,Xb[Rk]);y&&g.setAttribute("value",h["ua-list-item-count"].stringValue());a.A=g;la.length?vg(la).then(function(){O(e,d)}):qf().then(function(){O(e,d)})})});return N(e)}
...
function km(a,b,c){var d=L("peelOff"),e=b.e,f=b.ca,g=b.L;if(0<c)b.A.textContent=b.A.textContent.substr(0,c),f+=c;else if(!g&&b.A&&0==f){var k=b.A.parentNode;k&&k.removeChild(b.A)}for(var h=b.ga+c,l=[];b.e===e;)l.push(b),b=b.parent;var m=l.pop(),p=m.qa;rf(function(){for(;0<l.length;){m=l.pop();b=new ji(m.Y,b,h);0==l.length&&(b.ca=f,b.L=g);b.Na=m.Na;b.da=m.da;b.wa=m.wa;b.qa=m.qa?m.qa:p;p=null;var c=fm(a,b,!1);if(c.Aa())return c}return M(!1)}).then(function(){O(d,b)});return N(d)}
...
function wm(a,b,c,d){this.position=a;this.f=b;this.g=c;this.e=d}wm.prototype.d=function(a,b){var c;b<this.b()?c=null:(a.e=this.e,c=this.position);return c};wm.prototype.b=function(){return(qm[this.f]?1:0)+(this.g?3:0)+(this.position.parent?this.position.parent.g:0)};function xm(a,b,c){this.ga=a;this.d=b;this.b=c}
...
function Fm(a,b){if(b.e&&b.b&&!b.L&&0==b.e.count&&1!=b.A.nodeType){var c=b.A.textContent.match(Em);return km(a.g,b,c[0].length)}return M(b)}function Gm(a,b,c){var d=L("buildViewToNextBlockEdge");sf(function(d){b.A&&c.push(mi(b));Fm(a,b).then(function(f){f!==b&&(b=f,c.push(mi(b)));im(a.g,b).then(function(c){(b=c)?b.h&&!a.b?Hm(a,b).then(function(c){b=c;!b||b.d||0<a.g.f.b.length?P(d):uf(d)}):b.b?uf(d):P(d):P(d)})})}).then(function(){O(d,b)});return N(d)}
...
18>d)return a.d.removeChild(e.d),a.l=null,Qm(a,b,c),M(!0);if(!a.b&&e.top<g)return a.d.removeChild(e.d),Qm(a,b,c),M(!0);var h=L("layoutFootnoteInner");a.b?Ai(e,0,d):zi(e,g,d);e.B=a.B+a.left+wi(a);e.C=a.C+a.top+ui(a);e.H=a.H;var l=new pi(c);f?(Sm(e),f=M(!0)):0==e.H.length?(Tm(e),f=M(!0)):f=Um(e);f.then(function(){Vm(e,l).then(function(d){a.b?(a.oa=a.$a+(e.e+wi(e)+xi(e)),Ai(e,0,e.e)):(a.oa=a.$a-(e.e+ui(e)+vi(e)),zi(e,a.oa-a.Fa,e.e));var f;!a.b&&0<e.H.length?f=Um(e):f=M(d);f.then(function(d){d=new xm(b,
c,d?d.Sa:null);a.f?a.f.push(d):a.f=[d];O(h,!0)})})});return N(h)}
function Wm(a,b){var c=L("layoutFootnote"),d=b.A;d.setAttribute("style","");w(d,"display","inline-block");d.textContent="M";var e=d.getBoundingClientRect(),f=a.b?e.left:e.bottom;d.textContent="";cm(a.g,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d={ka:[{ha:b.Y,Na:0,da:b.da,wa:null,qa:null}],ca:0,L:!1};e=b.ga;b=b.modify();b.L=!0;Rm(a,e,d,f).then(function(){a.l&&a.l.d.parentNode&&a.d.removeChild(a.l.d);Bm(a,f)&&0!=a.w.length&&(b.d=!0);O(c,b)});return N(c)}
function Xm(a,b){var c=L("layoutFloat"),d=b.A,e=b.h,f=b.N,g=b.parent?b.parent.F:"ltr",k=a.g.f,h=b.A.parentNode;"page"===f?Gi(k,d,e):(w(d,"float","none"),w(d,"position","absolute"),w(d,"left","auto"),w(d,"right","auto"),w(d,"top","auto"));Im(a,b).then(function(l){var m=d.getBoundingClientRect(),p=Om(a,d),m=new te(m.left-p.left,m.top-p.top,m.right+p.right,m.bottom+p.bottom);if("page"===f)Hi(k,b,a.g)?(m=h.ownerDocument.createElement("span"),w(m,"width","0"),w(m,"height","0"),h.appendChild(m),l.A=m,O(c,
...
new te(p,(a.b?-1:1)*a.Fa,q,(a.b?-1:1)*a.$a);q=m;a.b&&(q=Le(m));Qe(p,a.eb,q,e);a.b&&(m=new te(-q.P,q.X,-q.V,q.U));w(d,"left",m.X-(a.b?a.$a:a.La)+a.j+"px");w(d,"top",m.V-(a.b?a.La:a.Fa)+a.k+"px");m=a.b?m.X:m.P;Bm(a,m)&&0!=a.w.length?(b=b.modify(),b.d=!0,O(c,b)):(Km(a),p=a.b?Le(a.h):a.h,a.b?q=Le(Am(a,new te(-q.P,q.X,-q.V,q.U))):q=Am(a,q),Re(p,a.eb,q,e),Lm(a),"left"==e?a.yc=m:a.zc=m,Ym(a,m),O(c,l))}});return N(c)}
...
"1"))}}function $m(a,b,c,d){var e=L("processLineStyling");ym(d);var f=d.concat([]);d.splice(0,d.length);var g=0,k=b.e;0==k.count&&(k=k.Qd);sf(function(d){if(k){var e=an(a,f),m=k.count-g;if(e.length<=m)P(d);else{var p=bn(a,f,e[m-1]);cn(a,p,!1,!1).then(function(){g+=m;km(a.g,p,0).then(function(e){b=e;Zm(b,!1);k=b.e;f=[];Gm(a,b,f).then(function(b){c=b;0<a.g.f.b.length?P(d):uf(d)})})})}}else P(d)}).then(function(){Array.prototype.push.apply(d,f);ym(d);O(e,c)});return N(e)}
...
function gn(a,b,c){var d=L("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,k=a.w.length-1;0<=k&&!e;--k){var e=a.w[k].d(a,f),h=a.w[k].b();h>f&&(g=Math.min(g,h))}while(g>f&&!e);var l=!1;if(!e){v.b("Could not find any page breaks?!!");if(a.qd)return hn(a,b).then(function(b){b?(b=b.modify(),b.d=!1,cn(a,b,l,!0).then(function(){O(d,b)})):O(d,b)}),N(d);e=c;l=!0}cn(a,e,l,!0).then(function(){O(d,e)});return N(d)}
...
function mn(a,b,c){function d(){b=l[0]||b;b.A.parentNode.removeChild(b.A);e.N=k}var e=a,f=L("skipEdges"),g=c&&b&&b.L,k=null,h=null,l=[],m=[],p=!1;sf(function(a){for(;b;){do if(b.A){if(b.b&&1!=b.A.nodeType){if(ci(b.A,b.w))break;if(!b.L){!c&&pm[k]?d():kn(e,h,null,!0,k)?(b=(h||b).modify(),b.d=!0):(b=b.modify(),b.j=k);P(a);return}}if(!b.L&&(b.u&&ln(e,b),b.h||b.C)){l.push(mi(b));k=rm(k,b.j);!c&&pm[k]?d():kn(e,h,null,!0,k)&&(b=(h||b).modify(),b.d=!0);P(a);return}if(1==b.A.nodeType){var f=b.A.style;if(b.L){if(p){if(!c&&
pm[k]){d();P(a);return}l=[];g=c=!1}p=!1;h=mi(b);m.push(h);k=rm(k,b.B);if(f&&(!jn(f.paddingBottom)||!jn(f.borderBottomWidth))){if(kn(e,h,null,!0,k)){b=(h||b).modify();b.d=!0;P(a);return}m=[h];h=null}}else{l.push(mi(b));k=rm(k,b.j);if(sm[b.A.localName]){!c&&pm[k]?d():kn(e,h,null,!0,k)&&(b=(h||b).modify(),b.d=!0);P(a);return}if(f&&(!jn(f.paddingTop)||!jn(f.borderTopWidth))){g=!1;if(kn(e,h,null,!0,k)){b=(h||b).modify();b.d=!0;P(a);return}h=null;m=[]}p=!0}}}while(0);f=im(e.g,b,g);if(f.Aa()){f.then(function(c){b=
c;uf(a)});return}b=f.dc()}kn(e,h,m,!1,k)&&h&&(b=h.modify(),b.d=!0);P(a)}).then(function(){O(f,b)});return N(f)}
function hn(a,b){var c=b,d=L("skipEdges"),e=null;sf(function(d){for(;b;){do if(b.A){if(b.b&&1!=b.A.nodeType){if(ci(b.A,b.w))break;if(!b.L){P(d);return}}if(!b.L&&b.h){P(d);return}if(1==b.A.nodeType){var g=b.A.style;if(b.L)e=rm(e,b.B);else{e=rm(e,b.j);if(pm[e]){P(d);a.N=e;return}if(sm[b.A.localName]){P(d);return}if(g&&(!jn(g.paddingTop)||!jn(g.borderTopWidth))){P(d);return}}}}while(0);g=im(a.g,b);if(g.Aa()){g.then(function(a){b=a;uf(d)});return}b=g.dc()}c=null;P(d)}).then(function(){O(d,c)});return N(d)}
function Hm(a,b){return"footnote"==b.h?Wm(a,b):Xm(a,b)}function nn(a,b,c){var d=L("layoutNext");mn(a,b,c).then(function(c){b=c;if(!b||a.N||b.d)O(d,b);else if(b.h)Hm(a,b).ra(d);else{a:if(b.L)c=!0;else{switch(b.Y.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!b.C}c?en(a,b).ra(d):Im(a,b).ra(d)}});return N(d)}
function Tm(a){var b=a.d.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.k+"px";b.style.right=a.F+"px";b.style.bottom=a.u+"px";b.style.left=a.j+"px";a.d.appendChild(b);var c=b.getBoundingClientRect();a.d.removeChild(b);var b=a.B+a.left+wi(a),d=a.C+a.top+ui(a);a.h=new te(b,d,b+a.width,d+a.height);a.La=c?a.b?c.top:c.left:0;a.pd=c?a.b?c.bottom:c.right:0;a.Fa=c?a.b?c.right:c.top:0;a.$a=c?a.b?c.left:c.bottom:0;a.yc=a.Fa;a.zc=a.Fa;a.oa=a.$a;c=a.h;b=a.B+a.left+wi(a);d=a.C+a.top+
ui(a);b=a.$b?Be(a.$b,b,d):De(b,d,b+a.width,d+a.height);a.eb=Ne(c,[b],a.H,a.Ka,a.b);Lm(a);a.f=null}function Sm(a){a.vb=[];w(a.d,"width",a.width+"px");w(a.d,"height",a.height+"px");Tm(a);a.e=0;a.ad=!1;a.N=null}function Ym(a,b){a.e=Math.max((a.b?-1:1)*(b-a.Fa),a.e)}function on(a,b){var c=b.b;if(!c)return M(!0);var d=L("layoutOverflownFootnotes"),e=0;rf(function(){for(;e<c.length;){var b=c[e++],b=Rm(a,0,b,a.Fa);if(b.Aa())return b}return M(!1)}).then(function(){O(d,!0)});return N(d)}
function Vm(a,b){a.vb.push(b);if(a.ad)return M(b);var c=L("layout");on(a,b).then(function(){Dm(a,b.Sa).then(function(b){var e=b,f=!0;a.w=[];sf(function(c){for(;b;){var k=!0;nn(a,b,f).then(function(h){f=!1;b=h;0<a.g.f.b.length?P(c):a.N?P(c):b&&b.d?gn(a,b,e).then(function(a){b=a;P(c)}):k?k=!1:uf(c)});if(k){k=!1;return}}P(c)}).then(function(){var e=a.l;e&&(a.d.appendChild(e.d),a.b?a.e=this.Fa-this.$a:a.e=e.top+ui(e)+e.e+vi(e));if(b)if(0<a.g.f.b.length)O(c,null);else{a.ad=!0;e=new pi(oi(b));if(a.f){for(var f=
...
function Do(a,b,c,d,e,f,g,k){var h=pl(c,a,"enabled");if(h&&h!==me)return M(!0);var l=L("layoutContainer"),m=pl(c,a,"wrap-flow")===Bd,p=c.b?c.g&&c.F:c.f&&c.H,h=pl(c,a,"flow-from"),q=a.viewport.b.createElement("div"),t=pl(c,a,"position");w(q,"position",t?t.name:"absolute");d.insertBefore(q,d.firstChild);var r=new ti(q);r.b=c.b;c.kb(a,r,b,a.f);r.B=e;r.C=f;e+=r.left+r.marginLeft+r.Z;f+=r.top+r.marginTop+r.fa;if(h&&h.xd())if(a.F[h.toString()])c.gc(a,r,b,null,1,a.g,a.f),h=M(!0);else{var y=L("layoutContainer.inner"),
J=h.toString(),W=Y(c,a,"column-count"),la=Y(c,a,"column-gap"),X=1<W?Y(c,a,"column-width"):r.width,h=ol(c,a),F=0,t=pl(c,a,"shape-inside"),sa=rg(t,0,0,r.width,r.height,a),Ok=new Ul(J,a,a.viewport,a.d,h,a.ba,a.f,a.style.u,a,b,a.Ja,a.Ka,k),yh=0,Z=null;sf(function(b){for(;yh<W;){var c=yh++;if(1<W){var d=a.viewport.b.createElement("div");w(d,"position","absolute");q.appendChild(d);Z=new zm(d,Ok,a.g);Z.b=r.b;Z.Ka=r.Ka;Z.bc=r.bc;r.b?(w(d,"margin-left",r.j+"px"),w(d,"margin-right",r.F+"px"),c=c*(X+la)+r.k,
Ai(Z,0,r.width),zi(Z,c,X)):(w(d,"margin-top",r.k+"px"),w(d,"margin-bottom",r.u+"px"),c=c*(X+la)+r.j,zi(Z,0,r.height),Ai(Z,c,X));Z.B=e+r.j;Z.C=f+r.k}else Z=new zm(q,Ok,a.g),yi(Z,r),r=Z;Z.H=p?[]:g;Z.$b=sa;if(0<=Z.width){var h=L("inner");Co(a,Z,J).then(function(){Z.N&&"column"!=Z.N&&(yh=W,"region"!=Z.N&&(a.F[J]=!0));O(h,!0)});c=N(h)}else c=M(!0);if(c.Aa()){c.then(function(){0<k.b.length?P(b):(F=Math.max(F,Z.e),uf(b))});return}0<k.b.length||(F=Math.max(F,Z.e))}P(b)}).then(function(){r.e=F;c.gc(a,r,b,
Z,W,a.g,a.f);O(y,!0)});h=N(y)}else{h=pl(c,a,"content");t=!1;if(h&&Ci(h)){var Qk=a.viewport.b.createElement("span");h.T(new Bi(Qk,a));q.appendChild(Qk);Cl(c,a,r,a.f)}else c.xa&&(d.removeChild(q),t=!0);t||c.gc(a,r,b,null,1,a.g,a.f);h=M(!0)}h.then(function(){if(!c.f||0<Math.floor(r.e)){if(!m){var h=r.B+r.left,p=r.C+r.top,t=wi(r)+r.width+xi(r),y=ui(r)+r.height+vi(r),F=pl(c,a,"shape-outside"),h=rg(F,h,p,t,y,a);hb(a.viewport.root)&&g.push(Be(h,0,-1.25*wc(a,"em",!1)));g.push(h)}}else if(0==c.children.length){d.removeChild(q);
