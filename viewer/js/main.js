 ...
 *
 * Vivliostyle core 2019.1.103-pre.20190307025044
 */
(function(factory) {
...
ja("Array.prototype.findIndex",function(a){return a?a:function(a,c){var b;a:{b=this;b instanceof String&&(b=String(b));for(var e=b.length,f=0;f<e;f++)if(a.call(c,b[f],f,b)){b=f;break a}b=-1}return b}});var na=this;function oa(a,b){var c="undefined"!==typeof enclosingObject&&enclosingObject?enclosingObject:window,d=a.split("."),c=c||na;d[0]in c||!c.execScript||c.execScript("var "+d[0]);for(var e;d.length&&(e=d.shift());)d.length||void 0===b?c[e]?c=c[e]:c=c[e]={}:c[e]=b}
...
11,k)&&(a.g||3==a.j?$f(a,"E_CSS_UNEXPECTED_BRC",k):(1==a.j?g.Fc(l.pop()):(k=l.pop(),g.Fc(k)),a.h.push("media"),g.La(),a.b=Lf));S(h);continue;case 49:if(ag(a,11,k))if(a.g||3!=a.j)$f(a,"E_CSS_UNEXPECTED_SEMICOL",k);else return a.B=l.pop(),a.G=!0,a.b=Lf,S(h),!1;S(h);continue;case 40:l.push(k.type);S(h);continue;case 27:a.b=Lf;S(h);g.dc();a.h.length&&a.h.pop();continue;case 30:m=k.text.toLowerCase();switch(m){case "import":S(h);k=R(h);if(2==k.type||8==k.type){a.J=k.text;S(h);k=R(h);if(17==k.type||0==
...
function hg(a,b,c,d,e){var f=L("parseStylesheet"),g=new Xf(Lf,a,b,c),h=null;e&&(h=ig(new rf(e,b),b,c));if(h=dg(g,d,h&&h.Aa()))b.Fc(h),b.La();Ee(function(){for(var a={};!fg(g,100,!1,!1,!1,!1);){if(g.G){var d=Ba(g.J,c);g.B&&(b.Fc(g.B),b.La());a.Ce=L("parseStylesheet.import");jg(d,b,null,null).then(function(a){return function(){g.B&&b.dc();g.G=!1;g.J=null;g.B=null;O(a.Ce,!0)}}(a));return a.Ce.result()}d=Ce();if(d.Xa)return d;a={Ce:a.Ce}}return M(!1)}).then(function(){h&&b.dc();O(f,!0)});return f.result()}
...
function Bh(a,b,c){var d=R(b);if(0==d.type)return null;var e={"":!0};if(14==d.type){do{S(b);d=R(b);if(1!=d.type)throw Error("Prefix name expected");e[d.text]=!0;S(b);d=R(b)}while(16==d.type);if(15!=d.type)throw Error("']' expected");S(b);d=R(b)}if(1!=d.type)throw Error("Property name expected");if(2==c?"SHORTHANDS"==d.text:"DEFAULTS"==d.text)return S(b),null;d=d.text;S(b);if(2!=c){if(39!=R(b).type)throw Error("'=' expected");Ah(d)||(a.B[d]=e)}else if(18!=R(b).type)throw Error("':' expected");return d}
...
function sj(a,b,c,d){this.u=a;this.l=b;this.Zb=c;this.xb=d;this.h=[[],[]];this.ca={};this.G=this.F=this.ua=this.b=null;this.Ba=this.la=this.Y=this.j=this.f="";this.Z=this.N=null;this.ta=this.ob=!0;this.g={};this.H=[{}];this.J=[new Oc("\u201c"),new Oc("\u201d"),new Oc("\u2018"),new Oc("\u2019")];this.D=0;this.lang="";this.Mb=[0];this.Za=0;this.sa=[{}];this.Cb=this.sa[0];this.S=null;this.Lb=[this.S];this.Jb=[{}];this.yb=this.sa[0];this.B={};this.fb=[];this.Kb=[]}
function Ri(a,b,c){a.ca[b]--;a.B[b]&&(a.B[b]=a.B[b].filter(function(a){return a!==c}),a.B[b].length||delete a.B[b])}function mi(a,b){var c=null;b&&(c=tj(a.ua,b));var d=a.fb.map(function(b){return(b=a.B[b])&&0<b.length?1===b.length?b[0]:new uj([].concat(b)):null}).filter(function(a){return a});return 0>=d.length?c:c?new vj([c].concat(d)):1===d.length?d[0]:new vj(d)}function wj(a,b,c){(b=b[c])&&b.apply(a)}var xj=[];
...
function Ij(a){for(var b=1;-1<=b;--b)for(var c=a.h[a.h.length-b-2],d=0;d<c.length;)c[d].f(a,b)?c.splice(d,1):d++;a.h.pop();a.ob=!1}var Jj=null;function Kj(a,b,c,d,e,f,g){Hf.call(this,a,b,g);this.b=null;this.ba=0;this.h=this.mb=null;this.D=!1;this.ia=c;this.l=d?d.l:Jj?Jj.clone():new rj;this.G=e;this.B=f;this.u=0;this.j=null}v(Kj,If);Kj.prototype.Uf=function(a){oi(this.l.Ad,"*",a)};function Lj(a,b){var c=ei(a.b,b);c!==b&&c.g(a.l)||a.Uf(c)}
...
function Pj(a){Kj.call(this,a.f,a.oa,a.ia,a,a.G,a.B,!1);this.parent=a;this.g=a.b}v(Pj,Kj);n=Pj.prototype;n.xd=function(a){"not"==a&&Kf(this,"E_CSS_UNEXPECTED_NOT")};n.La=function(){Kf(this,"E_CSS_UNEXPECTED_RULE_BODY")};n.Sc=function(){Kf(this,"E_CSS_UNEXPECTED_NEXT_SELECTOR")};n.Nd=function(){this.b&&0<this.b.length&&this.g.push(new Ni(this.b));this.parent.ba+=this.ba;var a=this.oa;a.b=a.g.pop()};n.error=function(a,b){Kj.prototype.error.call(this,a,b);var c=this.oa;c.b=c.g.pop()};
...
function Fk(a,b){this.Pb={};this.I=a;this.h=b;this.D=null;this.l=[];var c=this;this.J=function(a){var b=a.currentTarget,d=b.getAttribute("href")||b.getAttributeNS("http://www.w3.org/1999/xlink","href");d&&gb(c,{type:"hyperlink",target:null,currentTarget:null,mh:b,href:d,preventDefault:function(){a.preventDefault()}})};this.f={};this.g={width:0,height:0};this.B=this.u=!1;this.F=this.G=!0;this.P=0;this.position=null;this.offset=-1;this.b=null;this.j=[];this.H={top:{},bottom:{},left:{},right:{}}}
...
function Sl(a,b,c){if(!(b in a.u)){var d=a.style[b];a.u[b]=d?d.evaluate(a.B,b):c||null}return a.u[b]}function Wl(a){return Sl(a,"display",ud)}function Rl(a){if(null===a.l){var b=Wl(a),c=Sl(a,"position"),d=Sl(a,"float");a.l=Xl(b,c,d,a.D).display===bd}return a.l}function Ql(a){null===a.j&&(a.j=a.F&&Wl(a)!==J);return a.j}function Ul(a,b){var c=null;if(Rl(a)){var d=Sl(a,"break-"+b);d&&(c=d.toString())}return c}function Yl(a){this.g=a;this.b=[];this.pb=this.ib=!0;this.f=[]}
...
function bm(a,b,c,d,e,f,g,h){this.da=a;this.root=a.root;this.fb=c;this.h=d;this.B=f;this.f=this.root;this.F={};this.Y={};this.G={};this.J=[];this.D=this.S=this.N=null;this.Ba=g;this.Z=new sj(b,d,g,h);this.g=new Jl;this.u=!0;this.la=[];this.Za=e;this.ua=this.ta=!1;this.b=a=hk(a,this.root);this.ca={};this.j=new Yl(d);Ll(this.g,a);d=cm(this,this.root);Ej(this.Z,this.root,d,a);dm(this,d,!1);this.H=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.H=
...
function dm(a,b,c){["writing-mode","direction"].forEach(function(d){!b[d]||c&&a.F[d]||(a.F[d]=b[d])});if(!a.ta){var d=fm(a,b,a.B.j,"background-color")?b["background-color"].evaluate(a.h):null,e=fm(a,b,a.B.j,"background-image")?b["background-image"].evaluate(a.h):null;if(d&&d!==td||e&&e!==td)gm(a,b,a.B.j),a.ta=!0}if(!a.ua)for(d=0;d<hm.length;d++)if(fm(a,b,a.B.u,hm[d])){gm(a,b,a.B.u);a.ua=!0;break}if(!c&&(d=b["font-size"])){e=d.evaluate(a.h);d=e.L;switch(e.ka){case "em":case "rem":d*=a.h.u;break;case "ex":d*=
a.h.u*Ob.ex/Ob.em;break;case "%":d*=a.h.u/100;break;default:(e=Ob[e.ka])&&(d*=e)}a.h.Za=d}}function im(a){for(var b=0;!a.H&&(b+=5E3,jm(a,b,0)!=Number.POSITIVE_INFINITY););return a.F}function cm(a,b){if(b.style instanceof CSSStyleDeclaration){var c=b.getAttribute("style");if(c){var d=a.da.url,e=new Sj(a.fb,a.B),c=new rf(c,e);try{fg(new Xf(Mf,c,e,d),Number.POSITIVE_INFINITY,!1,!0,!1,!1)}catch(f){w.b(f,"Style attribute parse error:")}return e.mb}}return{}}
...
function po(a,b){this.h=a;this.Tc=b;this.j=!1;this.l=null}v(po,no);po.prototype.f=function(a,b){if(b<this.b())return null;this.j||(this.l=qo(a,this,0<b),this.j=!0);return this.l};po.prototype.b=function(){return this.Tc};po.prototype.g=function(){return this.j?this.l:this.h[this.h.length-1]};function Nm(a,b,c,d){this.position=a;this.F=b;this.B=this.j=c;this.D=d;this.h=!1;this.xc=0}v(Nm,no);
Nm.prototype.f=function(a,b){if(!this.h){var c=Jm(a,this.position);this.xc=jo(this.position,a.f,0,a.b)+c;this.h=!0}var c=this.xc,d=oo(this.g(),ro(a));this.B=so(a,c+(a.b?-1:1)*d.He);this.j=this.position.xa=so(a,c+(a.b?-1:1)*d.current);b<this.b()?c=null:(a.h=this.D+to(a,this),c=this.position);return c};
Nm.prototype.b=function(){if(!this.h)throw Error("EdgeBreakPosition.prototype.updateEdge not called");var a;if((a=this.g())&&a.parent){var b=uo(a.parent);a=b?(b=b.b)?a&&b.g===a.M:!1:!1}else a=!1;a=a&&!this.B;return(Bm[this.F]?1:0)+(this.j&&!a?3:0)+(this.position.parent?this.position.parent.j:0)};Nm.prototype.g=function(){return this.position};
...
function Co(a,b){if(b.f&&b.ya&&!b.K&&!b.f.count&&1!=b.A.nodeType){var c=b.A.textContent.match(Bo);return Do(a.j,b,c[0].length)}return M(b)}
function Eo(a,b,c){var d=!1,e=L("buildViewToNextBlockEdge");Fe(function(e){b.A&&!Fo(b)&&c.push(Zk(b));Co(a,b).then(function(f){f!==b&&(b=f,Fo(b)||c.push(Zk(b)));Go(a,b).then(function(c){if(b=c){if(d||!a.Zb.b(b))d=!0,b=b.modify(),b.xa=!0;xo(a,b)&&!a.b?Ho(a,b).then(function(c){b=c;Jn(a.l)&&(b=null);b?P(e):Q(e)}):b.ya?P(e):Q(e)}else Q(e)})})}).then(function(){O(e,b)});return e.result()}function Go(a,b,c){b=Gm(a.j,b,c);return Io(b,a)}
function Jo(a,b){if(!b.A)return M(b);var c=[],d=b.M,e=L("buildDeepElementView");Fe(function(e){b.A&&b.ya&&!Fo(b)?c.push(Zk(b)):(0<c.length&&Ko(a,b,c),c=[]);Co(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.M!=d;)g=g.parent;if(!g){b=f;Q(e);return}Fo(f)||c.push(Zk(f))}Go(a,f).then(function(c){(b=c)&&b.M!=d?a.Zb.b(b)?P(e):(b=b.modify(),b.xa=!0,a.u?Q(e):P(e)):Q(e)})})}).then(function(){0<c.length&&Ko(a,b,c);O(e,b)});return e.result()}
...
function So(a,b){var c=L("layoutFloat"),d=b.A,e=b.Ca;x(d,"float","none");x(d,"display","inline-block");x(d,"vertical-align","top");Jo(a,b).then(function(f){for(var g=Kk(a.f,d),h=Qo(a,d),g=new og(g.left-h.left,g.top-h.top,g.right+h.right,g.bottom+h.bottom),h=a.ua,l=a.fb,k=b.parent;k&&k.ya;)k=k.parent;if(k){var m=k.A.ownerDocument.createElement("div");m.style.left="0px";m.style.top="0px";a.b?(m.style.bottom="0px",m.style.width="1px"):(m.style.right="0px",m.style.height="1px");k.A.appendChild(m);var p=
Kk(a.f,m),h=Math.max(a.b?p.top:p.left,h),l=Math.min(a.b?p.bottom:p.right,l);k.A.removeChild(m);m=a.b?g.R-g.T:g.U-g.V;"left"==e?l=Math.max(l,h+m):h=Math.min(h,l-m);k.A.appendChild(b.A)}m=new og(h,wl(a)*a.D,l,wl(a)*a.sa);h=g;a.b&&(h=Fg(g));l=wl(a);h.T<a.ye*l&&(p=h.R-h.T,h.T=a.ye*l,h.R=h.T+p);a:for(var l=a.Cb,p=h,q=p.T,r=p.U-p.V,z=p.R-p.T,u=Jg(l,q);;){var A=q+z;if(A>m.R)break a;for(var D=m.V,I=m.U,K=u;K<l.length&&l[K].T<A;K++){var H=l[K];H.V>D&&(D=H.V);H.U<I&&(I=H.U)}if(D+r<=I||u>=l.length){"left"==
...
m.top-m.bottom+"px");x(d,"position","absolute");x(d,"display",b.display);l=null;if(k)if(k.S)l=k;else a:{for(k=k.parent;k;){if(k.S){l=k;break a}k=k.parent}l=null}l?(m=l.A.ownerDocument.createElement("div"),m.style.position="absolute",l.b?m.style.right="0":m.style.left="0",m.style.top="0",l.A.appendChild(m),k=Kk(a.f,m),l.A.removeChild(m)):k={left:(a.b?a.sa:a.ua)-a.H,right:(a.b?a.D:a.fb)+a.Y,top:(a.b?a.ua:a.D)-a.J};(l?l.b:a.b)?x(d,"right",k.right-g.U+"px"):x(d,"left",g.V-k.left+"px");x(d,"top",g.T-k.top+
...
a.parentNode.removeChild(a)});O(l,!h)});return l.result()}function $o(a,b){var c=b.A.parentNode,d=c.ownerDocument.createElement("span");d.setAttribute("data-adapt-spec","1");"footnote"===b.Ca&&ap(a.j,b,"footnote-call",d);c.appendChild(d);c.removeChild(b.A);c=b.modify();c.K=!0;c.A=d;return c}
function ho(a,b,c,d){var e=L("resolveFloatReferenceFromColumnSpan"),f=a.l,g=kn(f,"region");gn(f).width<gn(g).width&&"column"===b?c===Zc?Jo(a,Zk(d)).then(function(c){var d=c.A;c=Sn(a.f,d,[bp])[bp];d=Qo(a,d);c=a.b?c+(d.top+d.bottom):c+(d.left+d.right);c>a.width?O(e,"region"):O(e,b)}):c===Xc?O(e,"region"):O(e,b):O(e,b);return e.result()}
function cp(a,b){var c=a.l,d=fo(b),e=c.cf(fl(b));return(e?M(e):d.Lf(b,c,a)).ea(function(e){var f=Vk(b),h=$o(a,b),l=d.xf(e,c),f=new cn(e,f);if(l&&bn(l,e))return un(c,e,h.A),M(h);if(nn(c,e)||zn(c,e))return yn(c,f),un(c,e,h.A),M(h);if(a.ta)return M(null);var k=jo(h,a.f,0,a.b);return so(a,k)?M(h):Yo(a,f,d,k,l).ea(function(a){if(a)return M(null);un(c,e,h.A);return M(h)})})}
...
function ip(a,b){for(var c=0,d=0,e=b.length-1;0<=e;e--){var f=b[e];if(!f.K||!f.A||1!=f.A.nodeType)break;f=Qo(a,f.A);f=a.b?-f.left:f.bottom;0<f?c=Math.max(c,f):d=Math.min(d,f)}return c-d}
function jp(a,b){var c=L("layoutBreakableBlock"),d=[];Eo(a,b,d).then(function(e){var f=d.length-1;if(0>f)O(c,e);else{var f=Oo(a,e,d,f,d[f].Ma),g=!1;if(!e||!Po(e.A)){var h=oo(e,ro(a)),g=so(a,f+(a.b?-1:1)*h.He);so(a,f+(a.b?-1:1)*h.current)&&!a.ta&&(a.ta=e)}e||(f+=ip(a,d));To(a,f);var l;b.f?l=fp(a,b,e,d):l=M(e);l.then(function(b){Ko(a,b,d);0<d.length&&(a.N.push(new po(d,d[0].j)),g&&(2!=d.length&&0<a.N.length||d[0].M!=d[1].M||!io[d[0].M.localName])&&b&&(b=b.modify(),b.xa=!0));O(c,b)})}});return c.result()}
function Ko(a,b,c){he("POST_LAYOUT_BLOCK").forEach(function(d){d(b,c,a)})}
function hp(a,b,c){vo(b);var d=a.b?c-1:c+1,e=0,f=b[0].Ma;c=e;for(var g=b.length-1,h=b[g].Ma,l;f<h;){l=f+Math.ceil((h-f)/2);c=e;for(var k=g;c<k;){var m=c+Math.ceil((k-c)/2);b[m].Ma>l?k=m-1:c=m}k=Oo(a,null,b,c,l);if(a.b?k<=d:k>=d){for(h=l-1;b[c].Ma==l;)c--;g=c}else To(a,k),f=l,e=c}d=f;b=b[c];c=b.A;1!=c.nodeType&&(kp(b),b.K?b.na=c.length:(e=d-b.Ma,d=c.data,173==d.charCodeAt(e)?(c.replaceData(e,d.length-e,b.B?"":ep(b)),c=e+1):(f=d.charAt(e),e++,g=d.charAt(e),c.replaceData(e,d.length-e,!b.B&&Wa(f)&&Wa(g)?
ep(b):""),c=e),e=c,0<e&&(c=e,b=b.modify(),b.na+=c,b.g=null)));lp(a,b,!1);return b}function kp(a){he("RESOLVE_TEXT_NODE_BREAKER").reduce(function(b,c){return c(a)||b},mp)}var mp=new function(){};function ep(a){return a.F||a.parent&&a.parent.F||"-"}function Fo(a){return a?(a=a.A)&&1===a.nodeType?!!a.getAttribute("data-adapt-spec"):!1:!1}
...
h-1)){h=a.b?k.bottom:k.right;a.b?(e=d?Math.max(e,k.right):k.right,g=d?Math.min(g,k.left):k.left):(e=d?Math.min(e,k.top):k.top,g=d?Math.max(g,k.bottom):k.bottom);d++;l++;continue}0<d&&(c.push(g),d=0);if(l>=f.length)break}c.sort($a);a.b&&c.reverse();return c}function Jm(a,b){var c=0;il(b,function(b){if("clone"===b.h["box-decoration-break"]){var d=Ro(a,b.A);c+=b.b?-d.left:d.bottom;"table"===b.display&&(c+=b.ta)}});return c}function to(a,b){return(b?oo(b.g(),ro(a)):oo(null,ro(a))).current}
...
function tp(a,b,c){if(!b||Po(b.A))return!1;var d=jo(b,a.f,0,a.b),e=oo(b,ro(a)),f=so(a,d+(a.b?-1:1)*e.He);so(a,d+(a.b?-1:1)*e.current)&&!a.ta?a.ta=b:c&&(b=d+ip(a,c),e=a.la-wl(a)*e.current,d=a.b?Math.min(d,Math.max(b,e)):Math.max(d,Math.min(b,e)));To(a,d);return f}function up(a,b,c,d,e){if(!b||Po(b.A))return!1;c=tp(a,b,c);!d&&c||vp(a,b,e,c);return c}
function wp(a,b){if(!b.A.parentNode)return!1;var c=Qo(a,b.A),d=b.A.ownerDocument.createElement("div");a.b?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.A.parentNode.insertBefore(d,b.A);var e=Kk(a.f,d),e=a.b?e.right:e.top,f=wl(a),g=b.l,h=Infinity*-wl(a);"all"===g&&(h=Yn(a.l,a));switch(g){case "left":h=f*Math.max(h*f,a.Ee*f);break;case "right":h=f*Math.max(h*f,a.Fe*f);break;default:h=f*Math.max(h*
f,Math.max(a.Fe*f,a.Ee*f))}if(e*f>=h*f)return b.A.parentNode.removeChild(d),!1;e=Math.max(1,(h-e)*f);a.b?d.style.width=e+"px":d.style.height=e+"px";e=Kk(a.f,d);e=a.b?e.left:e.bottom;a.b?(h=e+c.right-h,0<h==0<=c.right&&(h+=c.right),d.style.marginLeft=h+"px"):(h-=e+c.top,0<h==0<=c.top&&(h+=c.top),d.style.marginBottom=h+"px");b.D=d;return!0}function xp(a){return a instanceof wo?!0:a instanceof yp?!1:a instanceof zp?!0:!1}
function Ap(a,b,c,d){function e(){return!!d||!c&&!!Vl[m]}function f(){b=q[0]||b;b.A.parentNode.removeChild(b.A);h.g=m}var g=b.K?b.parent&&b.parent.C:b.C;if(g&&!xp(g))return M(b);var h=a,l=L("skipEdges"),k=!d&&c&&b&&b.K,m=d,p=null,q=[],r=[],z=!1;Fe(function(a){for(;b;){var d=lo(b.C);do if(b.A){if(b.ya&&1!=b.A.nodeType){if(Mk(b.A,b.uc))break;if(!b.K){e()?f():up(h,p,null,!0,m)?(b=(h.u?p||b:b).modify(),b.xa=!0):(b=b.modify(),b.g=m);Q(a);return}}if(!b.K){if(d&&d.Ze(b))break;b.l&&wp(h,b)&&c&&!h.N.length&&
vp(h,Zk(b),m,!1);if(!xp(b.C)||b.C instanceof zp||xo(h,b)||b.H){q.push(Zk(b));m=Tl(m,b.g);if(e())f();else if(up(h,p,null,!0,m)||!h.Zb.b(b))b=(h.u?p||b:b).modify(),b.xa=!0;Q(a);return}}if(1==b.A.nodeType){var g=b.A.style;if(b.K){if(!(b.ya||d&&d.Af(b,h.u))){if(z){if(e()){f();Q(a);return}q=[];k=c=!1;m=null}z=!1;p=Zk(b);r.push(p);m=Tl(m,b.G);!g||sp(g.paddingBottom)&&sp(g.borderBottomWidth)||(r=[p])}}else{q.push(Zk(b));m=Tl(m,b.g);if(!h.Zb.b(b)&&(up(h,p,null,!h.u,m),b=b.modify(),b.xa=!0,h.u)){Q(a);return}if(io[b.A.localName]){e()?
...
function rp(a,b){var c=Zk(b),d=L("skipEdges"),e=null,f=!1;Fe(function(d){for(;b;){do if(b.A){if(b.ya&&1!=b.A.nodeType){if(Mk(b.A,b.uc))break;if(!b.K){Vl[e]&&(a.g=e);Q(d);return}}if(!b.K&&(xo(a,b)||b.H)){e=Tl(e,b.g);Vl[e]&&(a.g=e);Q(d);return}if(1==b.A.nodeType){var g=b.A.style;if(b.K){if(f){if(Vl[e]){a.g=e;Q(d);return}e=null}f=!1;e=Tl(e,b.G)}else{e=Tl(e,b.g);if(io[b.A.localName]){Vl[e]&&(a.g=e);Q(d);return}if(g&&(!sp(g.paddingTop)||!sp(g.borderTopWidth))){Q(d);return}}f=!0}}while(0);g=Gm(a.j,b);if(g.Xa()){g.then(function(a){b=
...
function Fq(a,b){b.ob[a.f.j]=a;var c=a.f.f,d=a.style,e=a.g?Gq(a.g,b):null,e=Vj(a.J,b,e,!1);a.b=Tj(e,b,a.g?a.g.b:!1);a.Z=Uj(e,b,a.g?a.g.Z:!1);Zj(e,d,a.b,a.Z,function(a,b){return b.value});a.D=new Kb(c,function(){return a.H},"autoWidth");a.B=new Kb(c,function(){return a.G},"autoHeight");a.Ae();a.Be();Dq(a);Cq(a)}function Hq(a,b,c){(a=a.style[c])&&(a=ng(b,a,c));return a}function Z(a,b,c){(a=a.style[c])&&(a=ng(b,a,c));return Vc(a,b)}
...
function Xq(a,b){a.j&&(a.N=Eq(a,"right",a.D,b)||Eq(a,"margin-right",a.D,b)||Eq(a,"border-right-width",a.D,b)||Eq(a,"padding-right",a.D,b));a.h&&(a.S=Eq(a,"top",a.B,b)||Eq(a,"margin-top",a.B,b)||Eq(a,"border-top-width",a.B,b)||Eq(a,"padding-top",a.B,b));for(var c=t(a.children),d=c.next();!d.done;d=c.next())Xq(d.value,b)}function Yq(a){zq.call(this,null,a)}v(Yq,zq);Yq.prototype.l=function(a,b){zq.prototype.l.call(this,a,b);this.children.sort(function(a,b){return b.f.ba-a.f.ba||a.f.index-b.f.index})};
...
function ur(a,b,c,d,e,f){var g=L("createRefShadow");a.da.u.load(b).then(function(h){if(h){var l=mk(h,b);if(l){var k=a.J,m=k.N[h.url];if(!m){var m=k.style.j.g[h.url],p=new Qb(0,k.jc(),k.ic(),k.u),m=new bm(h,m.g,m.f,p,k.l,m.l,new Rp(k.h,h.url),new Sp(k.h,h.url,m.f,m.b));k.N[h.url]=m}f=new $k(d,l,h,e,f,c,m)}}O(g,f)});return g.result()}
...
(H=!0);var sb;H?sb=a.g(f,a.w.parent?a.w.parent.A:null,k):sb=M(null);sb.then(function(g){g?H&&(d="true"==g.getAttribute("data-adapt-process-children")):g=Ir(a,Da,N);"a"==N&&g.addEventListener("click",a.page.J,!1);ma&&(ap(a,a.w,"inner",ma),g.appendChild(ma));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&mr(g);var h=a.w.h["image-resolution"],l=[],m=k.width,p=k.height,q=f.getAttribute("width"),r=f.getAttribute("height"),m=m===Zc||!m&&!q,p=p===Zc||!p&&!r;if("http://www.gribuser.ru/xml/fictionbook/2.0"!=
...
b.trim())}).join(","));if("poster"===D&&"video"===N&&"http://www.w3.org/1999/xhtml"===Da&&m&&p){var sb=new Image,Kp=Ke(sb,A);Ca.push(Kp);l.push({Rf:sb,element:g,Of:Kp})}}"http://www.w3.org/2000/svg"==Da&&/^[A-Z\-]+$/.test(D)&&(D=D.toLowerCase());Jr.includes(D.toLowerCase())&&(A=gr(A,a.da.url,a.h));I&&(sb=lr[I])&&(D=sb+":"+D);"src"!=D||I||"img"!=N&&"input"!=N||"http://www.w3.org/1999/xhtml"!=Da?"href"==D&&"image"==N&&"http://www.w3.org/2000/svg"==Da&&"http://www.w3.org/1999/xlink"==I?a.page.j.push(Ke(g,
...
function Gm(a,b,c){b=Vr(b);if(!b||b.K)return M(b);var d=L("nextInTree");Ao(a,b,!0,c).then(function(c){b.A&&c||(b=b.modify(),b.K=!0,b.A||(b.ya=!0));gb(a,{type:"nextInTree",w:b});O(d,b)});return d.result()}function Wr(a,b){if(b instanceof Ic)for(var c=b.values,d=0;d<c.length;d++)Wr(a,c[d]);else b instanceof Tc&&(c=b.url,a.page.j.push(Ke(new Image,c)))}
...
function Do(a,b,c){var d=L("peelOff"),e=b.f,f=b.na,g=b.K;if(0<c)b.A.textContent=b.A.textContent.substr(0,c),f+=c;else if(!g&&b.A&&!f){var h=b.A.parentNode;h&&h.removeChild(b.A)}for(var l=b.Ma+c,k=[];b.f===e;)k.push(b),b=b.parent;var m=k.pop(),p=m.Ga;Ee(function(){for(;0<k.length;){m=k.pop();b=new Yk(m.M,b,l);k.length||(b.na=f,b.K=g);b.kb=m.kb;b.wa=m.wa;b.Ja=m.Ja;b.Ga=m.Ga?m.Ga:p;p=null;var c=Ao(a,b,!1);if(c.Xa())return c}return M(!1)}).then(function(){O(d,b)});return d.result()}
function Ir(a,b,c){return"http://www.w3.org/1999/xhtml"==b?a.D.createElement(c):a.D.createElementNS(b,c)}function Mp(a){a&&il(a,function(a){var b=a.h["box-decoration-break"];b&&"slice"!==b||(b=a.A,a.b?(x(b,"padding-left","0"),x(b,"border-left","none"),x(b,"border-top-left-radius","0"),x(b,"border-bottom-left-radius","0")):(x(b,"padding-bottom","0"),x(b,"border-bottom","none"),x(b,"border-bottom-left-radius","0"),x(b,"border-bottom-right-radius","0")))})}
...
function ss(a,b,c){pq.call(this,a,null,"vivliostyle-page-rule-master",[],b,null,0);a=gs(c);new ts(this.f,this,c,a);this.B={};us(this,c);this.b.position=new V(Hd,0);this.b.width=new V(a.width,0);this.b.height=new V(a.height,0);for(var d in c)ps[d]||"background-clip"===d||(this.b[d]=c[d])}v(ss,pq);function us(a,b){var c=b._marginBoxes;c&&rs.forEach(function(d){c[d]&&(a.B[d]=new vs(a.f,a,d,b))})}ss.prototype.h=function(a){return new ws(a,this)};
...
function As(a,b,c,d,e){this.I=a;this.B=e;this.j=c;this.u=!Y(d,b[c?"width":"height"],new uc(d,0,"px"));this.size=null}As.prototype.b=function(){return this.u};function Bs(a){a.size||(a.size=Sn(a.B,a.I.element,a.j?["max-content width","min-content width"]:["max-content height","min-content height"]));return a.size}As.prototype.g=function(){var a=Bs(this);return this.j?ul(this.I)+a["max-content width"]+vl(this.I):sl(this.I)+a["max-content height"]+tl(this.I)};
...
function Ft(a,b,c){var d=b.I===b.h;a.la={};c?(a.b=c.clone(),em(a.f,c.g)):(a.b=new pl,em(a.f,-1));a.lang&&b.h.setAttribute("lang",a.lang);c=a.b;c.page++;Rb(a,a.style.b);a.B=c.clone();var e=d?{}:Js(a.sa),f=ut(a,e);if(!f)return M(null);var g=0;if(!d){Gk(b,f.f.b.width.value===$d);Hk(b,f.f.b.height.value===ae);a.h.j=b;aq(a.h,e,a);var h=hs(gs(e),a);Gt(a,h,b);os(e,h,b,a);g=h.ac+h.$b}e=!d&&Hq(f,a,"writing-mode")||sd;a.G=e!=sd;var h=Hq(f,a,"direction")||Cd,l=new dn(a.Zb,"page",null,null,null,e,h),k=L("layoutNextPage");
Fe(function(c){Ct(a,b,f,b.h,g,g+1,[],l).then(function(){Jn(l)||Fn(l);Jn(l)?(a.b=a.B.clone(),l.Qc=!1,P(c)):Q(c)})}).then(function(){f.ca(a,b,a.g);if(!d){var e=new vc(f.f.f,"left-page");b.b=e.evaluate(a)?"left":"right";Dt(a);c=a.b;Object.keys(c.b).forEach(function(b){b=c.b[b];var d=b.f;!d||"page"!==d&&nt(a,d)||(b.f=null)})}a.b=a.B=null;c.g=a.f.b;Jk(b,a.style.j.J[a.da.url],a.g);Et(a,c)&&(c=null);O(k,c)});return k.result()}
...
n.be=function(a,b,c){a=new pq(this.g.u,a,b,c,this.g.G,this.ia,Ef(this.oa));Gf(this.g,new cr(a.f,this.g,a,this.B))};n.Fc=function(a){a=a.Mc;this.ia&&(a=Bc(this.f,this.ia,a));Gf(this.g,new Ht(this.g,a,this,this.G))};n.Zd=function(){Gf(this.g,new Qj(this.f,this.oa))};n.ae=function(){var a={};this.g.B.push({Ec:a,ia:this.ia});Gf(this.g,new Rj(this.f,this.oa,null,a,this.g.h))};n.$d=function(a){var b=this.g.l[a];b||(b={},this.g.l[a]=b);Gf(this.g,new Rj(this.f,this.oa,null,b,this.g.h))};
n.ee=function(){var a={};this.g.H.push(a);Gf(this.g,new Rj(this.f,this.oa,this.ia,a,this.g.h))};n.wd=function(a){var b=this.g.D;if(a){var c=ai(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Gf(this.g,new Rj(this.f,this.oa,null,b,this.g.h))};n.de=function(){this.F=!0;this.Tb()};n.Vc=function(){var a=new Ts(this.g.u,this.g,this,this.B,this.g.F);Gf(this.g,a);a.Vc()};
...
Jt.prototype.error=function(a){w.b("CSS parser:",a)};function Kt(a,b){return Lt(b,a)}function Mt(a){yf.call(this,Kt,"document");this.N=a;this.G={};this.u={};this.g={};this.J={};this.j=null;this.b=[];this.H=!1}v(Mt,yf);function Nt(a,b,c){Ot(a,b,c);var d=Ba("user-agent.xml",Aa),e=L("OPSDocStore.init");Fh.get().then(function(b){a.j=b;lt.get().then(function(){a.load(d).then(function(){a.H=!0;O(e,!0)})})});return e.result()}function Ot(a,b,c){a.b.splice(0);b&&b.forEach(a.S,a);c&&c.forEach(a.Y,a)}
Mt.prototype.S=function(a){var b=a.url;b&&(b=Ba(Ea(b),za));this.b.push({url:b,text:a.text,qb:"Author",Pa:null,media:null})};Mt.prototype.Y=function(a){var b=a.url;b&&(b=Ba(Ea(b),za));this.b.push({url:b,text:a.text,qb:"User",Pa:null,media:null})};
function Lt(a,b){var c=L("OPSDocStore.load"),d=b.url,e=d.endsWith("?viv-toc-box");qk(b,a).then(function(b){if(b){if(a.H)for(var f=he("PREPROCESS_SINGLE_DOCUMENT"),h=0;h<f.length;h++)try{f[h](b.b)}catch(A){w.b("Error during single document preprocessing:",A)}for(var f=[],l=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),h=0;h<l.length;h++){var k=l[h],m=k.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),p=k.getAttributeNS("http://www.w3.org/2001/xml-events","event"),
q=k.getAttribute("action"),k=k.getAttribute("ref");m&&p&&q&&k&&f.push({Hg:m,event:p,action:q,sd:k})}a.J[d]=f;var r=[];r.push({url:Ba("user-agent-page.css",Aa),text:null,qb:"UA",Pa:null,media:null});h=b.l;if(!e&&h)for(h=h.firstChild;h;h=h.nextSibling)if(1==h.nodeType)if(f=h,l=f.namespaceURI,m=f.localName,"http://www.w3.org/1999/xhtml"==l)if("style"==m)l=f.getAttribute("class"),m=f.getAttribute("media"),p=f.getAttribute("title"),r.push({url:d,text:f.textContent,qb:"Author",Pa:p?l:null,media:m});else if("link"==
...
Pa:null,media:null}):"http://example.com/sse"==l&&"property"===m&&(l=f.getElementsByTagName("name")[0])&&"stylesheet"===l.textContent&&(f=f.getElementsByTagName("value")[0])&&(p=Ba(f.textContent,d),r.push({url:p,text:null,Pa:null,media:null,qb:"Author"}));if(!e)for(h=0;h<a.b.length;h++)r.push(a.b[h]);for(var z="",h=0;h<r.length;h++)z+=r[h].url,z+="^",r[h].text&&(z+=r[h].text),z+="^";var u=a.G[z];u?(a.g[d]=u,O(c,b)):(h=a.u[z],h||(h=new He(function(){var b=L("fetchStylesheet"),c=0,d=new Jt(a.j);Ee(function(){if(c<
r.length){var a=r[c++];d.Wc(a.qb);return null!==a.text?kg(a.text,d,a.url,a.Pa,a.media).Hc(!0):jg(a.url,d,a.Pa,a.media)}return M(!1)}).then(function(){u=new mt(a,d.j,d.u,d.J.l,d.G,d.B,d.D,d.l,d.H,d.F);a.G[z]=u;delete a.u[z];O(b,u)});return b.result()},"FetchStylesheet "+d),a.u[z]=h,h.start()),h.get().then(function(e){a.g[d]=e;O(c,b)}))}else O(c,null)});return c.result()};function Pt(a){return String.fromCharCode(a>>>24&255,a>>>16&255,a>>>8&255,a&255)}
...
Tt.prototype.Uc=function(a,b,c,d,e){var f=this;if(this.page)return M(this.page);var g=this,h=L("showTOC"),l=new Fk(a,a);this.page=l;this.b.load(this.url+"?viv-toc-box").then(function(d){var k=f.b.f[f.url];k&&k.body&&k.body.getAttribute("data-vivliostyle-primary-entry")&&d.body.setAttribute("data-vivliostyle-primary-entry",!0);var k=g.b.g[d.url],p=pt(k,c,1E5,e);b=new $r(b.window,p.fontSize,b.root,p.width,p.height);var q=new qt(k,d,g.lang,b,g.f,g.l,g.Ge(d),g.j,0,g.h,g.g);g.nb=q;q.$=g.$;rt(q).then(function(){Ft(q,
l,null).then(function(){Array.from(l.I.querySelectorAll("[data-vivliostyle-toc-box]>*>*>*>*>*[style*='display: none']")).forEach(function(a){a.setAttribute("aria-hidden","true");a.setAttribute("hidden","hidden")});Ut(g,a,2);O(h,l)})})});return h.result()};Tt.prototype.Td=function(){this.page&&(this.page.I.style.visibility="hidden",this.page.I.setAttribute("aria-hidden","true"))};Tt.prototype.Rc=function(){return!!this.page&&"visible"===this.page.I.style.visibility};function Wt(){Mt.call(this,Xt(this));this.l=new yf(qk,"document");this.Z=new yf(Af,"text");this.F={};this.la={};this.B={};this.D={}}v(Wt,Mt);function Xt(a){return function(b){return a.B[b]}}function Yt(a,b,c){return a.Z.load(b,c,void 0)}
function Zt(a,b,c){var d=L("loadPUBDoc"),e=b;e.endsWith("/")||(e+="/");a.l.load(e+"META-INF/container.xml",void 0,void 0).then(function(f){if(f){f=zk(fk(fk(fk(new gk([f.b]),"container"),"rootfiles"),"rootfile"),"full-path");f=t(f);for(var g=f.next();!g.done;g=f.next())if(g=g.value){$t(a,e,g,c).Ea(d);return}}vf(b,null,"HEAD").then(function(e){if(400<=e.status)w.error("Failed to fetch a source document from "+b+" ("+e.status+(e.statusText?" "+e.statusText:"")+")"),O(d,null);else if(e.status||e.responseXML||
e.responseText||e.vd||e.contentType||!/\/[^/.]+(?:[#?]|$)/.test(b)||(b=b.replace(/([#?]|$)/,"/$1")),"application/oebps-package+xml"==e.contentType||/\.opf(?:[#?]|$)/.test(b)){var f=t(b.match(/^((?:.*\/)?)([^/]*)$/));f.next();e=f.next().value;f=f.next().value;$t(a,e,f,c).Ea(d)}else"application/ld+json"==e.contentType||"application/webpub+json"==e.contentType||"application/audiobook+json"==e.contentType||"application/json"==e.contentType||/\.json(?:ld)?(?:[#?]|$)/.test(b)?Yt(a,b,!0).then(function(c){if(c){var e=
new au(a,b);bu(e,c).then(function(){O(d,e)})}else w.error("Received an empty response for "+b+". This may be caused by the server not allowing cross-origin resource sharing (CORS)."),O(d,null)}):cu(a,b).Ea(d)})});return d.result()}
function $t(a,b,c,d){var e=b+c,f=a.F[e];if(f)return M(f);var g=L("loadOPF");a.l.load(e,!0,"Failed to fetch EPUB OPF "+e).then(function(c){c?a.l.load(b+"META-INF/encryption.xml",void 0,void 0).then(function(h){(d?Yt(a,b+"?r=list"):M(null)).then(function(d){f=new au(a,b);du(f,c,h,d,b+"?r=manifest").then(function(){a.F[e]=f;a.la[b]=f;O(g,f)})})}):w.error("Received an empty response for EPUB OPF "+e+". This may be caused by the server not allowing cross-origin resource sharing (CORS).")});return g.result()}
function cu(a,b){var c=L("loadWebPub");a.load(b).then(function(d){if(d){var e=d.b,f=new au(a,b);e.body&&e.body.setAttribute("data-vivliostyle-primary-entry",!0);var g=e.querySelector("link[rel='publication'],link[rel='manifest'][type='application/webpub+json']");if(g){var h=g.getAttribute("href");/^#/.test(h)?(g=JSON.parse(e.getElementById(h.substr(1)).textContent),bu(f,g,e).then(function(){O(c,f)})):Yt(a,g.getAttribute("href")).then(function(a){bu(f,a,e).then(function(){O(c,f)})})}else bu(f,{},e).then(function(){f.Yb&&
f.Yb.src===d.url&&!e.querySelector("[role=doc-toc], [role=directory], nav, .toc, #toc")&&(f.Yb=null);O(c,f)})}else w.error("Received an empty response for "+b+". This may be caused by the server not allowing cross-origin resource sharing (CORS).")});return c.result()}function eu(a,b,c){var d=L("EPUBDocStore.load");b=ya(b);(a.D[b]=Lt(a,{status:200,statusText:"",url:b,contentType:c.contentType,responseText:null,responseXML:c,vd:null})).Ea(d);return d.result()}
...
return c.result()};function fu(){this.id=null;this.src="";this.j=this.h=this.g=null;this.P=-1;this.u=0;this.B=null;this.f=this.b=0;this.nc=this.wb=null;this.l=bb}function gu(a){return a.id}
function hu(a){var b=Rt(a);return function(a){var c=L("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));xf(e).then(function(a){a=new DataView(a);for(var d=0;d<a.byteLength;d++){var e=a.getUint8(d),e=e^b[d%20];a.setUint8(d,e)}O(c,wf([a,f]))});return c.result()}}
var iu={dcterms:"http://purl.org/dc/terms/",marc:"http://id.loc.gov/vocabulary/",media:"http://www.idpf.org/epub/vocab/overlays/#",rendition:"http://www.idpf.org/vocab/rendition/#",onix:"http://www.editeur.org/ONIX/book/codelists/current.html#",xsd:"http://www.w3.org/2001/XMLSchema#"},ju=iu.dcterms+"language",ku=iu.dcterms+"title",lu=iu.rendition+"layout";
function mu(a,b){var c={};return function(d,e){var f,g,h=d.r||c,l=e.r||c;if(a==ku&&(f="main"==h["http://idpf.org/epub/vocab/package/#title-type"],g="main"==l["http://idpf.org/epub/vocab/package/#title-type"],f!=g))return f?-1:1;f=parseInt(h["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(f)&&(f=Number.MAX_VALUE);g=parseInt(l["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(g)&&(g=Number.MAX_VALUE);return f!=g?f-g:a!=ju&&b&&(f=(h[ju]||h["http://idpf.org/epub/vocab/package/#alternate-script"])==
b,g=(l[ju]||l["http://idpf.org/epub/vocab/package/#alternate-script"])==b,f!=g)?f?-1:1:d.o-e.o}}
function nu(a,b){function c(a){for(var b in a){var d=a[b];d.sort(mu(b,k));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return eb(a,function(a){return db(a,function(a){var b={v:a.value,o:a.order};a.sh&&(b.s=a.scheme);if(a.id||a.lang){var c=l[a.id];if(c||a.lang)a.lang&&(a={name:ju,value:a.lang,lang:null,id:null,Pe:a.id,scheme:null,order:a.order},c?c.push(a):c=[a]),c=cb(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=
a[2]?f[a[2]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in iu)f[g]=iu[g];for(;g=b.match(/^\s*([A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/);)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=iu;var h=1;g=xk(yk(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),order:h++,Pe:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:iu.dcterms+a.localName,order:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Pe:null,scheme:null};return null});var l=cb(g,function(a){return a.Pe});g=d(cb(g,function(a){return a.Pe?null:a.name}));var k=null;g[ju]&&(k=g[ju][0].v);c(g);return g}function ou(){var a=window.MathJax;return a?a.Hub:null}var pu={"application/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function au(a,b){this.h=a;this.D=this.g=this.b=this.u=this.j=null;this.G=b;this.N=null;this.Z={};this.lang=null;this.l=0;this.F=!1;this.S=!0;this.B=null;this.f={};this.ca=this.Yb=this.lf=null;this.Y={};this.J=null;this.H=qu(this);ou()&&(Jh["http://www.w3.org/1998/Math/MathML"]=!0)}
function qu(a){function b(){}b.prototype.Re=function(a,b){return"viv-id-"+Ga(b+(a?"#"+a:""),":")};b.prototype.oc=function(b,d){var c=b.match(/^([^#]*)#?(.*)$/);if(c){var f=c[1]||d,c=c[2];if(f&&a.u.some(function(a){return a.src===f}))return"#"+this.Re(c,f)}return b};b.prototype.Kg=function(a){"#"===a.charAt(0)&&(a=a.substring(1));a.indexOf("viv-id-")||(a=a.substring(7));return(a=Xa(a).match(/^([^#]*)#?(.*)$/))?[a[1],a[2]]:[]};return new b}
function ru(a,b){if(b.startsWith("data:"))return b===a.G?"":b;if(a.G){var c=Ba("",a.G);if(b===c||b+"/"===c)return"";"/"!=c.charAt(c.length-1)&&(c+="/");return b.substr(0,c.length)==c?decodeURI(b.substr(c.length)):null}return b}
function du(a,b,c,d,e){a.j=b;var f=fk(new gk([b.b]),"package"),g=zk(f,"unique-identifier")[0];g&&(g=mk(b,b.url+"#"+g))&&(a.N=g.textContent.replace(/[ \n\r\t]/g,""));var h={};a.u=db(fk(fk(f,"manifest"),"item").X,function(c){var d=new fu,e=b.url;d.id=c.getAttribute("id");d.src=Ba(c.getAttribute("href"),e);d.g=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.l=f}(c=c.getAttribute("fallback"))&&!pu[d.g]&&(h[d.src]=c);!a.Yb&&
d.l.nav&&(a.Yb=d);!a.ca&&d.l["cover-image"]&&(a.ca=d);return d});a.g=ab(a.u,gu);a.D=ab(a.u,function(b){return ru(a,b.src)});for(var l in h)for(g=l;;){g=a.g[h[g]];if(!g)break;if(pu[g.g]){a.Y[l]=g.src;break}g=g.src}a.b=db(fk(fk(f,"spine"),"itemref").X,function(b,c){var d=b.getAttribute("idref");if(d=a.g[d])d.j=b,d.P=c;return d});if(l=zk(fk(f,"spine"),"toc")[0])a.lf=a.g[l];if(l=zk(fk(f,"spine"),"page-progression-direction")[0]){a:switch(l){case "ltr":l="ltr";break a;case "rtl":l="rtl";break a;default:throw Error("unknown PageProgression: "+
l);}a.J=l}var g=c?zk(fk(fk(vk(fk(fk(new gk([c.b]),"encryption"),"EncryptedData"),uk()),"CipherData"),"CipherReference"),"URI"):[],k=fk(fk(f,"bindings"),"mediaType").X;for(c=0;c<k.length;c++){var m=k[c].getAttribute("handler");(l=k[c].getAttribute("media-type"))&&m&&a.g[m]&&(a.Z[l]=a.g[m].src)}a.f=nu(fk(f,"metadata"),zk(f,"prefix")[0]);a.f[ju]&&(a.lang=a.f[ju][0].v);a.f[lu]&&(a.F="pre-paginated"===a.f[lu][0].v);if(!d){if(0<g.length&&a.N)for(d=hu(a.N),c=0;c<g.length;c++)a.h.B[a.G+g[c]]=d;a.F&&su(a);
return M(!0)}f=new Ra;k={};if(0<g.length&&a.N)for(l="1040:"+St(a.N),c=0;c<g.length;c++)k[g[c]]=l;for(c=0;c<d.length;c++){var p=d[c];if(m=p.n){var q=decodeURI(m),g=a.D[q];l=null;g&&(g.B=0!=p.m,g.u=p.c,g.g&&(l=g.g.replace(/\s+/g,"")));g=k[q];if(l||g)f.append(m),f.append(" "),f.append(l||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}su(a);return vf(e,"","POST",f.toString(),"text/plain")}
function su(a){for(var b=0,c=t(a.b),d=c.next();!d.done;d=c.next()){var d=d.value,e=a.F?1:Math.ceil(d.u/1024);d.b=b;d.f=e;b+=e}a.l=b;a.B&&a.B(a.l)}function tu(a,b){a.S=b||a.F}
function uu(a,b){a.B=b;if(a.S)return a.F&&!a.l&&su(a),M(!0);var c=0,d=0,e=L("countEPages");Fe(function(b){if(d===a.b.length)Q(b);else{var e=a.b[d++];e.b=c;a.h.load(e.src).then(function(d){var f=1800,g=d.lang||a.lang;g&&g.match(/^(ja|ko|zh)/)&&(f/=3);e.f=Math.ceil(jk(d)/f);c+=e.f;a.l=c;a.B&&a.B(a.l);P(b)})}}).Ea(e);return e.result()}
function vu(a,b,c){a.g={};a.D={};a.u=[];a.b=a.u;var d=a.j=new ek(null,"",(new DOMParser).parseFromString("<spine></spine>","text/xml"));b.forEach(function(a){var b=new fu;b.P=a.index;b.id="item"+(a.index+1);b.src=a.url;b.wb=a.wb;b.nc=a.nc;var c=d.b.createElement("itemref");c.setAttribute("idref",b.id);d.root.appendChild(c);b.j=c;this.g[b.id]=b;c=ru(this,a.url);null==c&&(c=a.url);this.D[c]=b;this.u.push(b)},a);return c?eu(a.h,b[0].url,c):M(null)}
function bu(a,b,c){b.readingProgression&&(a.J=b.readingProgression);void 0===a.f&&(a.f={});var d=c&&c.title||b.name||b.metadata&&b.metadata.title;d&&(a.f[ku]=[{v:d}]);var e=ru(a,a.G);!b.readingOrder&&c&&null!==e&&(b.readingOrder=[encodeURI(e)],Array.from(c.querySelectorAll("[role=doc-toc] a[href],[role=directory] a[href],nav li a[href],.toc a[href],#toc a[href]")).forEach(function(c){c=ya(c.getAttribute("href"));var d=ru(a,c);c=null!==d?encodeURI(d):c;-1==b.readingOrder.indexOf(c)&&b.readingOrder.push(c)}));
var f=[],g=0,h=-1;[b.readingOrder,b.resources].forEach(function(c){c instanceof Array&&c.forEach(function(c){var d=b.readingOrder.includes(c),e="string"===typeof c?c:c.url||c.href,k="string"===typeof c?"":c.oh||c.href&&c.type||"";if(d||"text/html"===k||"application/xhtml+xml"===k||/(^|\/)([^/]+\.(x?html|htm|xht)|[^/.]*)([#?]|$)/.test(e))d={url:Ba(Ea(e),a.G),index:g++,wb:null,nc:null},"contents"===c.rel&&-1===h&&(h=d.index),f.push(d)})});var l=L("initWithWebPubManifest");vu(a,f).then(function(){-1!==
h&&(a.Yb=a.u[h]);a.Yb||(a.Yb=a.D[e]);O(l,!0)});return l.result()}function wu(a,b,c){var d=a.b[b],e=L("getCFI");a.h.load(d.src).then(function(a){var b=kk(a,c),f=null;b&&(a=ik(a,b,0,!1),f=new ub,xb(f,b,c-a),d.j&&xb(f,d.j,0),f=f.toString());O(e,f)});return e.result()}
...
d){w.b(d,"Cannot resolve epage:",b);O(a,null)})}function zu(a,b){var c=a.b[b.P];if(a.S)return M(c.b+b.aa);if(0>=b.Fa)return M(c.b);var d=L("getEPage");a.h.load(c.src).then(function(a){a=jk(a);O(d,c.b+Math.min(a,b.Fa)*c.f/a)});return d.result()}function Au(a,b){return{page:a,position:{P:a.P,aa:b,Fa:a.offset}}}function Bu(a,b,c,d,e){this.O=a;this.viewport=b;this.j=c;this.l=e;this.Ib=[];this.g=[];this.$=zb(d);this.h=new Yr(b);this.f=new Zp(a.H);this.wf=!1}
function Cu(a,b){var c=a.Ib[b.P];return c?c.Ka[b.aa]:null}n=Bu.prototype;n.fc=function(a){return this.O.J?this.O.J:(a=this.Ib[a?a.P:0])?a.nb.H:null};
function Du(a,b,c,d){c.I.style.display="none";c.I.style.visibility="visible";c.I.style.position="";c.I.style.top="";c.I.style.left="";c.I.setAttribute("data-vivliostyle-page-side",c.b);var e=b.Ka[d];c.u=!b.item.P&&!d;b.Ka[d]=c;if(a.O.S){if(!d&&0<b.item.P){var f=a.O.b[b.item.P-1];b.item.b=f.b+f.f}b.item.f=b.Ka.length;a.O.l=a.O.b.reduce(function(a,b){return a+b.f},0);a.O.B&&a.O.B(a.O.l)}if(e)b.nb.viewport.f.replaceChild(c.I,e.I),gb(e,{type:"replaced",target:null,currentTarget:null,ag:c});else{e=null;
...
function Eu(a,b,c){var d=L("renderSinglePage"),e=Fu(a,b,c);Ft(b.nb,e,c).then(function(f){var g=(c=f)?c.page-1:b.jb.length-1;Du(a,b,e,g);cq(a.f,e.P,g);f=null;if(c){var h=b.jb[c.page];b.jb[c.page]=c;h&&b.Ka[c.page]&&(ql(c,h)||(f=Eu(a,b,c)))}f||(f=M(!0));f.then(function(){var f=dq(a.f,e),h=0;Fe(function(b){h++;if(h>f.length)Q(b);else{var c=f[h-1];c.Yd=c.Yd.filter(function(a){return!a.ud});c.Yd.length?Gu(a,c.P).then(function(d){d?(bq(a.f,c.Le),eq(a.f,c.Yd),Eu(a,d,d.jb[c.aa]).then(function(c){var d=a.f;
d.b=d.F.pop();d=a.f;d.g=d.H.pop();d=c.Xd.position;d.P===e.P&&d.aa===g&&(e=c.Xd.page);P(b)})):P(b)}):P(b)}}).then(function(){e.I.parentElement||(e=b.Ka[g]);e.B=!c&&b.item.P===a.O.b.length-1;e.B&&gq(a.f,a.viewport);O(d,{Xd:Au(e,g),bg:c})})})});return d.result()}
function Hu(a,b){var c=a.aa,d=-1;0>c?(d=a.Fa,c=Za(b.jb.length,function(a){return tt(b.nb,b.jb[a],!0)>d}),c=c===b.jb.length?b.complete?b.jb.length-1:Number.POSITIVE_INFINITY:c-1):c===Number.POSITIVE_INFINITY&&-1!==a.Fa&&(d=a.Fa);return{P:a.P,aa:c,Fa:d}}
function Iu(a,b,c){var d=L("findPage");Gu(a,b.P).then(function(e){if(e){var f=null,g;Fe(function(d){var h=Hu(b,e);g=h.aa;(f=e.Ka[g])?Q(d):e.complete?(g=e.jb.length-1,f=e.Ka[g],Q(d)):c?Ju(a,h).then(function(a){a&&(f=a.page,g=a.position.aa);Q(d)}):De(100).then(function(){P(d)})}).then(function(){O(d,Au(f,g))})}else O(d,null)});return d.result()}
function Ju(a,b){var c=L("renderPage");Gu(a,b.P).then(function(d){if(d){var e=Hu(b,d),f=e.aa,g=e.Fa,h=d.Ka[f];h?O(c,Au(h,f)):Fe(function(b){if(f<d.jb.length)Q(b);else if(d.complete)f=d.jb.length-1,Q(b);else{var c=d.jb[d.jb.length-1];Eu(a,d,c).then(function(a){var e=a.Xd.page;(c=a.bg)?0<=g&&tt(d.nb,c)>g?(h=e,f=d.jb.length-2,Q(b)):P(b):(h=e,f=a.Xd.position.aa,d.complete=!0,Q(b))})}}).then(function(){h=h||d.Ka[f];var b=d.jb[f];h?O(c,Au(h,f)):Eu(a,d,b).then(function(a){a.bg||(d.complete=!0);O(c,a.Xd)})})}else O(c,
null)});return c.result()}n.Rb=function(){return Ku(this,{P:this.O.b.length-1,aa:Number.POSITIVE_INFINITY,Fa:-1},!1)};function Ku(a,b,c){var d=L("renderPagesUpto");b||(b={P:0,aa:0,Fa:0});var e=b.P,f=b.aa,g=0;c&&(g=e);var h;Fe(function(c){Ju(a,{P:g,aa:g===e?f:Number.POSITIVE_INFINITY,Fa:g===e?b.Fa:-1}).then(function(a){h=a;++g>e?Q(c):P(c)})}).then(function(){O(d,h)});return d.result()}n.xg=function(a,b){return Iu(this,{P:0,aa:0,Fa:-1},b)};
n.Ag=function(a,b){return Iu(this,{P:this.O.b.length-1,aa:Number.POSITIVE_INFINITY,Fa:-1},b)};n.nextPage=function(a,b){var c=this,d=this,e=a.P,f=a.aa,g=L("nextPage");Gu(d,e).then(function(a){if(a){if(a.complete&&f==a.jb.length-1){if(e>=d.O.b.length-1){O(g,null);return}e++;f=0;var h=c.Ib[e],k=h&&h.Ka[0];a=a.Ka[a.Ka.length-1];k&&a&&k.b==a.b&&(h.Ka.forEach(function(a){a.I&&a.I.remove()}),c.Ib[e]=null,c.g[e]=null)}else f++;Iu(d,{P:e,aa:f,Fa:-1},b).Ea(g)}else O(g,null)});return g.result()};
n.Oe=function(a,b){var c=a.P,d=a.aa;if(d)d--;else{if(!c)return M(null);c--;d=Number.POSITIVE_INFINITY}return Iu(this,{P:c,aa:d,Fa:-1},b)};function Lu(a,b,c){b="left"===b.b;a="ltr"===a.fc(c);return!b&&a||b&&!a}function Mu(a,b,c){var d=L("getCurrentSpread"),e=Cu(a,b);if(!e)return M({left:null,right:null});var f="left"===e.b;(Lu(a,e,b)?a.Oe(b,c):a.nextPage(b,c)).then(function(c){var e=Cu(a,b);(c=c&&c.page)&&c.b===e.b&&(c=null);f?O(d,{left:e,right:c}):O(d,{left:c,right:e})});return d.result()}
n.Gg=function(a,b){var c=Cu(this,a);if(!c)return M(null);var d=Lu(this,c,a),e=this.nextPage(a,b);if(d)return e;var f=this;return e.ea(function(a){if(a){if(a.page.b===c.b)return e;var d=f.nextPage(a.position,b);return d.ea(function(a){return a?d:e})}return M(null)})};n.Jg=function(a,b){var c=Cu(this,a);if(!c)return M(null);var d=Lu(this,c,a),e=this.Oe(a,b),f=c.I.previousElementSibling;if(d){var g=this;return e.ea(function(a){return a?a.page.b===c.b||a.page.I!==f?e:g.Oe(a.position,b):M(null)})}return e};
function Nu(a,b,c){var d=L("navigateToEPage");yu(a.O,b).then(function(b){b?Iu(a,b,c).Ea(d):O(d,null)});return d.result()}function Ou(a,b,c){var d=L("navigateToCFI");xu(a.O,b).then(function(b){b?Iu(a,b,c).Ea(d):O(d,null)});return d.result()}
function Pu(a,b,c,d){w.debug("Navigate to",b);var e=ru(a.O,ya(b));if(!e){if(a.O.j&&b.match(/^#epubcfi\(/))e=ru(a.O,a.O.j.url);else if("#"===b.charAt(0)){var f=a.O.H.Kg(b);a.O.j?(e=ru(a.O,f[0]),null==e&&(e=f[0])):e=f[0];b=f[0]+(f[1]?"#"+f[1]:"")}if(null==e)return M(null)}var g=a.O.D[e];if(!g)return a.O.j&&e==ru(a.O,a.O.j.url)&&(e=b.indexOf("#"),0<=e)?Ou(a,b.substr(e+1),d):M(null);var h=L("navigateTo");Gu(a,g.P).then(function(e){if(e){var f=mk(e.da,b);f?Iu(a,{P:g.P,aa:-1,Fa:hk(e.da,f)},d).Ea(h):c.P!==
g.P?Iu(a,{P:g.P,aa:0,Fa:-1},d).Ea(h):O(h,null)}else O(h,null)});return h.result()}
function Fu(a,b,c){var d=b.nb.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.setAttribute("role","region");e.style.position="absolute";e.style.top="0";e.style.left="0";ak||(e.style.visibility="hidden",e.setAttribute("aria-hidden","true"));d.h.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);var g=new Fk(e,f);g.P=b.item.P;g.position=c;g.offset=tt(b.nb,c);g.offset||(b=a.O.H.Re("",b.item.src),f.setAttribute("id",
b),Ik(g,f,b));d!==a.viewport&&(a=lg(null,new rf(Cb(a.viewport.width,a.viewport.height,d.width,d.height),null)),g.l.push(new Ck(e,"transform",a)));return g}function Qu(a,b,c,d){var e=ou();if(e){var f=d.ownerDocument,g=f.createElement("span");d.appendChild(g);c=f.importNode(c,!0);Ru(a,c,b);g.appendChild(c);a=e.queue;a.Push(["Typeset",e,g]);var e=L("makeMathJaxView"),h=xe(e);a.Push(function(){h.tb(g)});return e.result()}return M(null)}
function Ru(a,b,c){if(b){if(1===b.nodeType&&"mglyph"===b.tagName)for(var d=t(b.attributes),e=d.next();!e.done;e=d.next())if(e=e.value,"src"===e.name){var f=Ba(e.nodeValue,c.url);e.namespaceURI?b.setAttributeNS(e.namespaceURI,e.name,f):b.setAttribute(e.name,f)}b.firstChild&&Ru(a,b.firstChild,c);b.nextSibling&&Ru(a,b.nextSibling,c)}}
n.Ge=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=Ba(f,a.url),g=c.getAttribute("media-type");if(!g){var h=ru(b.O,f);h&&(h=b.O.D[h])&&(g=h.g)}if(g&&(h=b.O.Z[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Va(f),l=Va(g),g=new Ra;g.append(h);g.append("?src=");g.append(f);g.append("&type=");g.append(l);for(h=c.firstChild;h;h=h.nextSibling)1==h.nodeType&&
...
c.namespaceURI)e=Qu(b,a,c,d);else if("http://example.com/sse"==c.namespaceURI){e=d?d.ownerDocument:b.viewport.b;g=c.localName;switch(g){case "t":case "tab":case "ec":case "nt":case "fraction":case "comment":case "mark":g="span";break;case "ruby":case "rp":case "rt":break;default:g="div"}e=e.createElement(g);e.setAttribute("data-adapt-process-children","true");e=M(e)}else e=c.dataset&&"true"==c.dataset.mathTypeset?Qu(b,a,c,d):M(null);return e}};
function Gu(a,b){if(-1===b||b>=a.O.b.length)return M(null);var c=a.Ib[b];if(c)return M(c);var d=L("getPageViewItem"),e=a.g[b];if(e){var f=xe(d);e.push(f);return d.result()}var e=a.g[b]=[],g=a.O.b[b],h=a.O.h;h.load(g.src).then(function(f){g.h=f.b.title;var k=h.g[f.url],l=a.Ge(f),p=a.viewport,q=pt(k,p.width,p.height,p.fontSize,a.$);if(q.width!=p.width||q.height!=p.height||q.fontSize!=p.fontSize)p=new $r(p.window,q.fontSize,p.root,q.width,q.height);q=a.Ib[b-1];null!==g.wb?q=g.wb-1:(!(0<b)||q&&q.complete?
q=q?q.nb.ta+q.Ka.length:0:(q=g.b||b,a.O.F||q%2||q++),null!==g.nc&&(q+=g.nc));$p(a.f,q);var r=new qt(k,f,a.O.lang,p,a.h,a.j,l,a.O.Y,q,a.O.H,a.f,a.O.J);r.$=a.$;k=a.O.f&&a.O.f[ku];r.yb=k&&k[0]&&k[0].v||"";r.fb=g.h||"";rt(r).then(function(){c={item:g,da:f,nb:r,jb:[null],Ka:[],complete:!1};a.Ib[b]=c;O(d,c);e.forEach(function(a){a.tb(c)})})});return d.result()}function Su(a){return a.Ib.some(function(a){return a&&0<a.Ka.length})}
...
c+"px";e.setAttribute("data-vivliostyle-toc-box","true");e.setAttribute("role","navigation");this.b.Uc(e,a,b,c,this.viewport.fontSize).then(function(a){e.style.visibility="visible";e.setAttribute("aria-hidden","false");O(d,a)});return d.result()};n.Td=function(){this.b&&this.b.Td()};n.Rc=function(){return!!this.b&&this.b.Rc()};var Tu={fh:"singlePage",gh:"spread",Vg:"autoSpread"};
function Uu(a,b,c,d){var e=this;this.window=a;this.ge=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);ak&&b.setAttribute("data-vivliostyle-debug",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Ba=c;this.ua=d;a=a.document;this.sa=new wm(a.head,b);this.u="loading";this.J=[];this.O=null;this.hc=this.Ya=!1;this.f=this.j=this.g=this.B=null;this.fontSize=16;this.zoom=1;this.D=!1;this.S="singlePage";this.ca=!1;this.Rb=!0;this.$=yb();this.Z=[];this.H=function(){};this.h=function(){};
this.Y=function(){e.Ya=!0;e.H()};this.Me=this.Me.bind(this);this.F=function(){};this.G=a.getElementById("vivliostyle-page-rules");this.N=!1;this.l=null;this.la={loadPublication:this.rg,loadXML:this.sg,configure:this.$e,moveTo:this.ta,toc:this.Uc};Vu(this)}function Vu(a){xa(1,function(b){Wu(a,{t:"debug",content:b})});xa(2,function(b){Wu(a,{t:"info",content:b})});xa(3,function(b){Wu(a,{t:"warn",content:b})});xa(4,function(b){Wu(a,{t:"error",content:b})})}function Wu(a,b){b.i=a.Ba;a.ua(b)}
function Xu(a,b){a.u!==b&&(a.u=b,a.ge.setAttribute("data-vivliostyle-viewer-status",b),Wu(a,{t:"readystatechange"}))}n=Uu.prototype;
n.rg=function(a){Yu.f("beforeRender");Xu(this,"loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=L("loadPublication"),h=this;h.$e(a).then(function(){var a=new Wt;Nt(a,e,f).then(function(){var e=Ba(Ea(b),h.window.location.href);h.J=[e];Zt(a,e,d).then(function(a){a?(h.O=a,Zu(h,c).then(function(){O(g,!0)})):O(g,!1)})})});return g.result()};
n.sg=function(a){Yu.f("beforeRender");Xu(this,"loading");var b=a.url,c=a.document,d=a.fragment,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=L("loadXML"),h=this;h.$e(a).then(function(){var a=new Wt;Nt(a,e,f).then(function(){var e=b.map(function(a,b){return{url:Ba(Ea(a.url),h.window.location.href),index:b,wb:a.wb,nc:a.nc}});h.J=e.map(function(a){return a.url});h.O=new au(a,"");vu(h.O,e,c).then(function(){Zu(h,d).then(function(){O(g,!0)})})})});return g.result()};
function Zu(a,b){$u(a);var c;b?c=xu(a.O,b).ea(function(b){a.f=b;return M(!0)}):c=M(!0);return c.ea(function(){Yu.b("beforeRender");return av(a)})}function bv(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d)return c*Ob.ex*a.fontSize/Ob.em;if(d=Ob[d])return c*d}return c}
n.$e=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.B=null,this.window.addEventListener("resize",this.Y,!1),this.Ya=!0):this.window.removeEventListener("resize",this.Y,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.Ya=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:bv(this,b["margin-left"])||0,marginRight:bv(this,b["margin-right"])||0,marginTop:bv(this,b["margin-top"])||0,marginBottom:bv(this,b["margin-bottom"])||
0,width:bv(this,b.width)||0,height:bv(this,b.height)||0},200<=b.width||200<=b.height)&&(this.window.removeEventListener("resize",this.Y,!1),this.B=b,this.Ya=!0);"boolean"==typeof a.hyphenate&&(this.$.xe=a.hyphenate,this.Ya=!0);"boolean"==typeof a.horizontal&&(this.$.we=a.horizontal,this.Ya=!0);"boolean"==typeof a.nightMode&&(this.$.Ie=a.nightMode,this.Ya=!0);"number"==typeof a.lineHeight&&(this.$.lineHeight=a.lineHeight,this.Ya=!0);"number"==typeof a.columnWidth&&(this.$.pe=a.columnWidth,this.Ya=
...
(this.viewport=null,this.$.Dc=a.pageBorder,this.Ya=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=a.zoom,this.hc=!0);"boolean"==typeof a.fitToScreen&&a.fitToScreen!==this.D&&(this.D=a.fitToScreen,this.hc=!0);"object"==typeof a.defaultPaperSize&&"number"==typeof a.defaultPaperSize.width&&"number"==typeof a.defaultPaperSize.height&&(this.viewport=null,this.$.vc=a.defaultPaperSize,this.Ya=!0);cv(this,a);return M(!0)};
function cv(a,b){he("CONFIGURATION").forEach(function(c){c=c(b);a.Ya=c.Ya||a.Ya;a.hc=c.hc||a.hc})}n.Me=function(a){var b=this.g,c=this.j,d=a.target;c?c.left!==d&&c.right!==d||dv(this,a.ag):b===a.target&&dv(this,a.ag)};function ev(a,b){var c=[];a.g&&c.push(a.g);a.j&&(c.push(a.j.left),c.push(a.j.right));c.forEach(function(a){a&&b(a)})}function fv(a){ev(a,function(b){b.removeEventListener("hyperlink",a.F,!1);b.removeEventListener("replaced",a.Me,!1)})}
function gv(a){fv(a);ev(a,function(a){x(a.I,"display","none");a.I.setAttribute("aria-hidden","true")});a.g=null;a.j=null}function hv(a,b){b.addEventListener("hyperlink",a.F,!1);b.addEventListener("replaced",a.Me,!1);x(b.I,"visibility","visible");x(b.I,"display","block");b.I.setAttribute("aria-hidden","false")}function iv(a,b){gv(a);a.g=b;hv(a,b)}
function jv(a){var b=L("reportPosition");wu(a.O,a.f.P,a.f.Fa).then(function(c){var d=a.g;(a.ca&&0<d.j.length?Je(d.j):M(!0)).then(function(){kv(a,d,c).Ea(b)})});return b.result()}function lv(a){var b=a.ge;if(a.B){var c=a.B;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new $r(a.window,a.fontSize,b,c.width,c.height)}return new $r(a.window,a.fontSize,b)}
function mv(a){var b=lv(a),c;a:switch(a.S){case "singlePage":c=!1;break a;case "spread":c=!0;break a;default:c=1.45<=b.width/b.height&&800<b.width}var d=a.$.ub!==c;a.$.ub=c;a.ge.setAttribute("data-vivliostyle-spread-view",c);if(a.B||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;if(!d&&b.width==a.viewport.width&&b.height==a.viewport.height||!d&&b.width==a.viewport.width&&b.height!=a.viewport.height&&/Android|iPhone|iPad|iPod/.test(navigator.userAgent))return!0;if(c=a.b&&Su(a.b)){a:{c=t(a.b.Ib);
for(d=c.next();!d.done;d=c.next())if(d=d.value)for(var d=t(d.Ka),e=d.next();!e.done;e=d.next())if(e=e.value,e.G&&e.F){c=!0;break a}c=!1}c=!c}return c?(a.viewport.width=b.width,a.viewport.height=b.height,a.hc=!0):!1}n.Lg=function(a,b,c,d){this.Z[d]=a;nv(this,b)};function nv(a,b){if(!a.N&&a.G){var c="";Object.keys(b).forEach(function(a){c+="@page "+a+"{margin:0;size:";a=b[a];c+=a.width+"px "+a.height+"px;}"});a.G.textContent=c;a.N=!0}}
function ov(a){var b=!1,c=!1;if(a.b){b=a.b.Rc();c=a.b.wf;a.b.Td();for(var d=a.b,e=t(d.Ib),f=e.next();!f.done;f=e.next())(f=f.value)&&f.Ka.splice(0);for(d=d.viewport.root;d.lastChild;)d.removeChild(d.lastChild)}a.G&&(a.G.textContent="",a.N=!1);a.viewport=lv(a);d=a.viewport;x(d.g,"width","");x(d.g,"height","");x(d.f,"width","");x(d.f,"height","");x(d.f,"transform","");a.b=new Bu(a.O,a.viewport,a.sa,a.$,a.Lg.bind(a));b&&a.h({a:"toc",v:"show",autohide:c})}
function dv(a,b,c){a.hc=!1;fv(a);if(a.$.ub)return Mu(a.b,a.f,c).ea(function(c){gv(a);a.j=c;c.left&&(hv(a,c.left),c.right?c.left.I.removeAttribute("data-vivliostyle-unpaired-page"):c.left.I.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(hv(a,c.right),c.left?c.right.I.removeAttribute("data-vivliostyle-unpaired-page"):c.right.I.setAttribute("data-vivliostyle-unpaired-page",!0));c=pv(a,c);a.viewport.zoom(c.width,c.height,a.D?qv(a,c):a.zoom);a.g=b;return M(null)});iv(a,b);a.viewport.zoom(b.g.width,
b.g.height,a.D?qv(a,b.g):a.zoom);a.g=b;return M(null)}function pv(a,b){var c=0,d=0;b.left&&(c+=b.left.g.width,d=b.left.g.height);b.right&&(c+=b.right.g.width,d=Math.max(d,b.right.g.height));b.left&&b.right&&(c+=2*a.$.Dc);return{width:c,height:d}}var rv={$g:"fit inside viewport"};function qv(a,b){return Math.min(a.viewport.width/b.width,a.viewport.height/b.height)}function sv(){this.name="RenderingCanceledError";this.message="Page rendering has been canceled";this.stack=Error().stack}v(sv,Error);
function $u(a){if(a.l){var b=a.l;oe(b,new sv);if(b!==ie&&b.b){b.b.g=!0;var c=new ye(b);b.l="interrupt";b.b=c;b.f.tb(c)}}a.l=null}
function av(a){a.Ya=!1;a.hc=!1;if(mv(a))return M(!0);Xu(a,"loading");$u(a);var b=qe(ie.f,function(){return ne("resize",function(c){a.O?(a.l=b,Yu.f("render (resize)"),ov(a),a.f&&(a.f.aa=-1),tu(a.O,a.Rb),Ku(a.b,a.f,!a.Rb).then(function(d){d?(a.f=d.position,dv(a,d.page,!0).then(function(){Xu(a,"interactive");uu(a.O,function(b){b={t:"nav",epageCount:b,first:a.g.u,last:a.g.B,metadata:a.O.f,docTitle:a.O.b[a.f.P].h};if(a.g.u||!a.f.aa&&a.O.b[a.f.P].b)b.epage=a.O.b[a.f.P].b;Wu(a,b)}).then(function(){jv(a).then(function(d){(a.Rb?
a.b.Rb():M(null)).then(function(){a.l===b&&(a.l=null);Yu.b("render (resize)");a.Rb&&Xu(a,"complete");Wu(a,{t:"loaded"});O(c,d)})})})})):O(c,!1)})):O(c,!1)},function(a,b){if(b instanceof sv)Yu.b("render (resize)"),w.debug(b.message);else throw b;})});return M(!0)}function kv(a,b,c){var d=L("sendLocationNotification"),e={t:"nav",first:b.u,last:b.B,metadata:a.O.f,docTitle:a.O.b[b.P].h};zu(a.O,a.f).then(function(b){e.epage=b;e.epageCount=a.O.l;c&&(e.cfi=c);Wu(a,e);O(d,!0)});return d.result()}
Uu.prototype.fc=function(){return this.b?this.b.fc(this.f):null};
Uu.prototype.ta=function(a){var b=this;"complete"!==this.u&&"next"!==a.where&&Xu(this,"loading");if("string"==typeof a.where){switch(a.where){case "next":a=this.$.ub?this.b.Gg:this.b.nextPage;break;case "previous":a=this.$.ub?this.b.Jg:this.b.Oe;break;case "last":a=this.b.Ag;break;case "first":a=this.b.xg;break;default:return M(!0)}if(a){var c=a;a=function(){return c.call(b.b,b.f,!b.Rb)}}}else if("number"==typeof a.epage){var d=a.epage;a=function(){return Nu(b.b,d,!b.Rb)}}else if("string"==typeof a.url){var e=
a.url;a=function(){return Pu(b.b,e,b.f,!b.Rb)}}else return M(!0);var f=L("moveTo");a.call(b.b).then(function(a){var c;if(a){b.f=a.position;var d=L("moveTo.showCurrent");c=d.result();dv(b,a.page,!b.Rb).then(function(){jv(b).Ea(d)})}else c=M(!0);c.then(function(a){"loading"===b.u&&Xu(b,"interactive");O(f,a)})});return f.result()};
Uu.prototype.Uc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.Rc(),d=b!=this.b.wf&&"hide"!=a;if(c){if("show"==a&&!d)return M(!0)}else if("hide"==a)return M(!0);if(c&&"show"!=a)return this.b.Td(),M(!0);var e=this,f=L("showTOC");this.b.Uc(b).then(function(a){a&&(d&&(a.Pb={}),b&&a.addEventListener("hyperlink",function(){e.b.Td()},!1),a.addEventListener("hyperlink",e.F,!1));O(f,!0)});return f.result()};
function tv(a,b){var c=b.a||"";return ne("runCommand",function(d){var e=a.la[c];e?e.call(a,b).then(function(){Wu(a,{t:"done",a:c});O(d,!0)}):(w.error("No such action:",c),O(d,!0))},function(a,b){w.error(b,"Error during action:",c);O(a,!0)})}function uv(a){return"string"==typeof a?JSON.parse(a):a}
function vv(a,b){var c=uv(b),d=null;pe(function(){var b=L("commandLoop"),f=ie.f;a.F=function(b){var c="#"===b.href.charAt(0)||a.J.some(function(a){return b.href.substr(0,a.length)==a});if(c){b.preventDefault();var d={t:"hyperlink",href:b.href,internal:c};qe(f,function(){Wu(a,d);return M(!0)})}};Fe(function(b){if(a.Ya)av(a).then(function(){P(b)});else if(a.hc)a.g&&dv(a,a.g).then(function(){P(b)});else if(c){var e=c;c=null;tv(a,e).then(function(){P(b)})}else e=L("waitForCommand"),d=xe(e,self),e.result().then(function(){P(b)})}).Ea(b);
return b.result()});a.H=function(){var a=d;a&&(d=null,a.tb())};a.h=function(b){if(c)return!1;c=uv(b);a.H();return!0};a.window.adapt_command=a.h};function Sr(a,b,c){if(a==b)return a?[[0,a]]:[];if(0>c||a.length<c)c=null;var d=wv(a,b),e=a.substring(0,d);a=a.substring(d);b=b.substring(d);var d=xv(a,b),f=a.substring(a.length-d);a=a.substring(0,a.length-d);b=b.substring(0,b.length-d);a=yv(a,b);e&&a.unshift([0,e]);f&&a.push([0,f]);zv(a);null!=c&&(a=Av(a,c));return a=Bv(a)}
function yv(a,b){var c;if(!a)return[[1,b]];if(!b)return[[-1,a]];c=a.length>b.length?a:b;var d=a.length>b.length?b:a,e=c.indexOf(d);if(-1!=e)return c=[[1,c.substring(0,e)],[0,d],[1,c.substring(e+d.length)]],a.length>b.length&&(c[0][0]=c[2][0]=-1),c;if(1==d.length)return[[-1,a],[1,b]];var f=Cv(a,b);if(f)return d=f[1],e=f[3],c=f[4],f=Sr(f[0],f[2]),d=Sr(d,e),f.concat([[0,c]],d);a:{c=a.length;for(var d=b.length,e=Math.ceil((c+d)/2),f=2*e,g=Array(f),h=Array(f),l=0;l<f;l++)g[l]=-1,h[l]=-1;g[e+1]=0;h[e+1]=
0;for(var l=c-d,k=!!(l%2),m=0,p=0,q=0,r=0,z=0;z<e;z++){for(var u=-z+m;u<=z-p;u+=2){var A=e+u,D;D=u==-z||u!=z&&g[A-1]<g[A+1]?g[A+1]:g[A-1]+1;for(var I=D-u;D<c&&I<d&&a.charAt(D)==b.charAt(I);)D++,I++;g[A]=D;if(D>c)p+=2;else if(I>d)m+=2;else if(k&&(A=e+l-u,0<=A&&A<f&&-1!=h[A])){var K=c-h[A];if(D>=K){c=Dv(a,b,D,I);break a}}}for(u=-z+q;u<=z-r;u+=2){A=e+u;K=u==-z||u!=z&&h[A-1]<h[A+1]?h[A+1]:h[A-1]+1;for(D=K-u;K<c&&D<d&&a.charAt(c-K-1)==b.charAt(d-D-1);)K++,D++;h[A]=K;if(K>c)r+=2;else if(D>d)q+=2;else if(!k&&
(A=e+l-u,0<=A&&A<f&&-1!=g[A]&&(D=g[A],I=e+D-A,K=c-K,D>=K))){c=Dv(a,b,D,I);break a}}}c=[[-1,a],[1,b]]}return c}function Dv(a,b,c,d){var e=a.substring(c),f=b.substring(d);a=Sr(a.substring(0,c),b.substring(0,d));e=Sr(e,f);return a.concat(e)}function wv(a,b){if(!a||!b||a.charAt(0)!=b.charAt(0))return 0;for(var c=0,d=Math.min(a.length,b.length),e=d,f=0;c<e;)a.substring(f,e)==b.substring(f,e)?f=c=e:d=e,e=Math.floor((d-c)/2+c);return e}
function xv(a,b){if(!a||!b||a.charAt(a.length-1)!=b.charAt(b.length-1))return 0;for(var c=0,d=Math.min(a.length,b.length),e=d,f=0;c<e;)a.substring(a.length-e,a.length-f)==b.substring(b.length-e,b.length-f)?f=c=e:d=e,e=Math.floor((d-c)/2+c);return e}
function Cv(a,b){function c(a,b,c){for(var d=a.substring(c,c+Math.floor(a.length/4)),e=-1,f="",g,h,k,l;-1!=(e=b.indexOf(d,e+1));){var m=wv(a.substring(c),b.substring(e)),K=xv(a.substring(0,c),b.substring(0,e));f.length<K+m&&(f=b.substring(e-K,e)+b.substring(e,e+m),g=a.substring(0,c-K),h=a.substring(c+m),k=b.substring(0,e-K),l=b.substring(e+m))}return 2*f.length>=a.length?[g,h,k,l,f]:null}var d=a.length>b.length?a:b,e=a.length>b.length?b:a;if(4>d.length||2*e.length<d.length)return null;var f=c(d,e,
...
function zv(a){a.push([0,""]);for(var b=0,c=0,d=0,e="",f="",g;b<a.length;)switch(a[b][0]){case 1:d++;f+=a[b][1];b++;break;case -1:c++;e+=a[b][1];b++;break;case 0:if(1<c+d){if(c&&d){if(g=wv(f,e))0<b-c-d&&0==a[b-c-d-1][0]?a[b-c-d-1][1]+=f.substring(0,g):(a.splice(0,0,[0,f.substring(0,g)]),b++),f=f.substring(g),e=e.substring(g);if(g=xv(f,e))a[b][1]=f.substring(f.length-g)+a[b][1],f=f.substring(0,f.length-g),e=e.substring(0,e.length-g)}c?d?a.splice(b-c-d,c+d,[-1,e],[1,f]):a.splice(b-c,c+d,[-1,e]):a.splice(b-
...
a[b+1][1],a.splice(b+1,1),c=!0)),b++;c&&zv(a)}Sr.f=1;Sr.b=-1;Sr.g=0;
function Av(a,b){var c;a:{var d=a;if(0===b)c=[0,d];else{var e=0;for(c=0;c<d.length;c++){var f=d[c];if(-1===f[0]||0===f[0]){var g=e+f[1].length;if(b===g){c=[c+1,d];break a}if(b<g){d=d.slice();g=b-e;e=[f[0],f[1].slice(0,g)];f=[f[0],f[1].slice(g)];d.splice(c,1,e,f);c=[c+1,d];break a}e=g}}throw Error("cursor_pos is out of bounds!");}}d=c[1];c=c[0];e=d[c];f=d[c+1];return null==e||0!==e[0]?a:null!=f&&e[1]+f[1]===f[1]+e[1]?(d.splice(c,2,f,e),Ev(d,c,2)):null!=f&&0===f[1].indexOf(e[1])?(d.splice(c,2,[f[0],
e[1]],[0,e[1]]),e=f[1].slice(e[1].length),0<e.length&&d.splice(c+2,0,[f[0],e]),Ev(d,c,3)):a}
function Bv(a){function b(a){return 55296<=a.charCodeAt(a.length-1)&&56319>=a.charCodeAt(a.length-1)}function c(a){return 56320<=a.charCodeAt(0)&&57343>=a.charCodeAt(0)}for(var d=!1,e=2;e<a.length;e+=1)0===a[e-2][0]&&b(a[e-2][1])&&-1===a[e-1][0]&&c(a[e-1][1])&&1===a[e][0]&&c(a[e][1])&&(d=!0,a[e-1][1]=a[e-2][1].slice(-1)+a[e-1][1],a[e][1]=a[e-2][1].slice(-1)+a[e][1],a[e-2][1]=a[e-2][1].slice(0,-1));if(!d)return a;d=[];for(e=0;e<a.length;e+=1)0<a[e][1].length&&d.push(a[e]);return d}
function Ev(a,b,c){for(c=b+c-1;0<=c&&c>=b-1;c--)if(c+1<a.length){var d=a[c],e=a[c+1];d[0]===e[1]&&a.splice(c,2,[d[0],d[1]+e[1]])}return a};function Rr(a){return a.reduce(function(a,c){return c[0]===Sr.b?a:a+c[1]},"")}function gl(a,b,c){var d=0,e=0;a.some(function(a){for(var f=0;f<a[1].length;f++){switch(a[0]*c){case Sr.f:d++;break;case Sr.b:d--;e++;break;case Sr.g:e++}if(e>b)return!0}return!1});return Math.max(Math.min(b,e-1)+d,0)};function Fv(a,b,c,d,e){Ym.call(this,a,b,"block-end",null,c,e);this.g=d}v(Fv,Ym);Fv.prototype.df=function(a){return!(a instanceof Fv)};function Gv(a,b,c,d){an.call(this,a,"block-end",b,c,d)}v(Gv,an);Gv.prototype.Ia=function(){return Infinity};Gv.prototype.f=function(a){return a instanceof Fv?!0:this.Ia()<a.Ia()};function Hv(a){this.f=a}Hv.prototype.b=function(a){a=fl(a);return!Uk(a,this.f.b)};function Iv(){}n=Iv.prototype;n.Ff=function(a){return"footnote"===a.Ca};
n.Ef=function(a){return a instanceof Fv};n.Lf=function(a,b){var c="region",d=kn(b,c);Gn(kn(b,"page"),d)&&(c="page");d=fl(a);c=new Fv(d,c,b.h,a.Y,a.N);b.le(c);return M(c)};n.Mf=function(a,b,c,d){return new Gv(a[0].ja.W,a,c,d)};n.xf=function(a,b){return kn(b,a.W).b.filter(function(a){return a instanceof Gv})[0]||null};
n.Bf=function(a,b,c){a.$f=!0;a.ve=!1;var d=a.element,e=c.j;b=b.b;var f=c.j.w&&"rtl"===c.j.w.direction,g={},h=e.B._pseudos;b=wr(e,b,f,e.B,g);if(h&&h.before){var l={},k=Ir(e,"http://www.w3.org/1999/xhtml","span");pr(k,"before");d.appendChild(k);wr(e,b,f,h.before,l);delete l.content;Lr(e,k,l)}delete g.content;Lr(e,d,g);a.b=b;Np(a,d);if(e=Qn(c.f,d))a.marginLeft=X(e.marginLeft),a.Z=X(e.borderLeftWidth),a.H=X(e.paddingLeft),a.marginTop=X(e.marginTop),a.ca=X(e.borderTopWidth),a.J=X(e.paddingTop),a.marginRight=
X(e.marginRight),a.Za=X(e.borderRightWidth),a.Y=X(e.paddingRight),a.marginBottom=X(e.marginBottom),a.Ba=X(e.borderBottomWidth),a.S=X(e.paddingBottom);if(c=Qn(c.f,d))a.width=X(c.width),a.height=X(c.height)};n.og=function(a,b){switch(a.g){case Ad:ao(b,new Hv(a),a.W)}};eo.push(new Iv);function Jv(a){return a.reduce(function(a,c){return a+c},0)/a.length}function jt(a){var b=Jv(a);return Jv(a.map(function(a){a-=b;return a*a}))};function Kv(a,b){this.g(a,"end",b)}function Lv(a,b){this.g(a,"start",b)}function Mv(a,b,c){c||(c=this.j.now());var d=this.h[a];d||(d=this.h[a]=[]);var e;for(a=d.length-1;0<=a&&(!(e=d[a])||e[b]);a--)e=null;e||(e={},d.push(e));e[b]=c}function Nv(){}function Ov(a){this.j=a;this.h={};this.registerEndTiming=this.b=this.registerStartTiming=this.f=this.g=Nv}
Ov.prototype.l=function(){var a=this.h,b="";Object.keys(a).forEach(function(c){for(var d=a[c],e=d.length,f=0;f<e;f++){var g=d[f];b+=c;1<e&&(b+="("+f+")");b+=" => start: "+g.start+", end: "+g.end+", duration: "+(g.end-g.start)+"\n"}});w.g(b)};Ov.prototype.u=function(){this.registerEndTiming=this.b=this.registerStartTiming=this.f=this.g=Nv};Ov.prototype.B=function(){this.g=Mv;this.registerStartTiming=this.f=Lv;this.registerEndTiming=this.b=Kv};
var Pv={now:Date.now},Yu,Qv=Yu=new Ov(window&&window.performance||Pv);Mv.call(Qv,"load_vivliostyle","start",void 0);oa("vivliostyle.profile.profiler",Qv);Ov.prototype.printTimings=Ov.prototype.l;Ov.prototype.disable=Ov.prototype.u;Ov.prototype.enable=Ov.prototype.B;function uo(a){return(a=a.C)&&a instanceof zp?a:null}function Rv(a,b,c){var d=a.b;return d&&!d.Bc&&(a=Sv(a,b),a.A)?!d.yc||d.Bc?M(!0):Tv(d,d.yc,a,null,c):M(!0)}function Uv(a,b,c){var d=a.b;return d&&(a=Sv(a,b),a.A)?!d.zc||d.Cc?M(!0):Tv(d,d.zc,a,a.A.firstChild,c):M(!0)}function Vv(a,b){a&&Wv(a.K?a.parent:a,function(a,d){a instanceof yp||b.B.push(new Xv(d))})}function Wv(a,b){for(var c=a;c;c=c.parent){var d=c.C;d&&d instanceof zp&&!jl(c,d)&&b(d,c)}}
function zp(a,b){this.parent=a;this.j=b;this.b=null}zp.prototype.We=function(){return"Repetitive elements owner formatting context (vivliostyle.repetitiveelements.RepetitiveElementsOwnerFormattingContext)"};zp.prototype.ff=function(a,b){return b};function Yv(a,b){var c=Sv(a,b);return c?c.A:null}function Sv(a,b){do if(!jl(b,a)&&b.M===a.j)return b;while(b=b.parent);return null}
function Or(a,b){a.b||Hp.some(function(b){return b.root===a.j?(a.b=b.elements,!0):!1})||(a.b=new Zv(b,a.j),Hp.push({root:a.j,elements:a.b}))}zp.prototype.Ye=function(){};zp.prototype.Xe=function(){};var Hp=[];function Zv(a,b){this.N=a;this.yc=this.zc=this.u=this.D=this.l=this.B=null;this.G=this.H=0;this.Bc=this.Cc=!1;this.gd=this.re=!0;this.j=!1;this.Z=b;this.J=this.g=null;this.S=[];this.Y=[]}function $v(a,b){a.zc||(a.zc=Vk(b),a.B=b.M,a.D=b.A)}function aw(a,b){a.yc||(a.yc=Vk(b),a.l=b.M,a.u=b.A)}
function Tv(a,b,c,d,e){var f=c.A,g=c.A.ownerDocument.createElement("div");f.appendChild(g);var h=new Im(e,g,c),l=h.za.g;h.za.g=null;a.h=!0;return Lm(h,new kl(b)).ea(function(){a.h=!1;f.removeChild(g);if(f)for(;g.firstChild;){var b=g.firstChild;g.removeChild(b);b.setAttribute("data-adapt-spec","1");d?f.insertBefore(b,d):f.appendChild(b)}h.za.g=l;return M(!0)})}Zv.prototype.b=function(a){var b=0;if(a&&!this.f(a))return b;if(!this.Bc||a&&bw(this,a))b+=this.G;this.Cc||(b+=this.H);return b};
Zv.prototype.F=function(a){var b=0;if(a&&!this.f(a))return b;a&&bw(this,a)&&(b+=this.G);this.gd||(b+=this.H);return b};function bw(a,b){return cw(b,a.Y,function(){return dw(a.J,b,!1)})}Zv.prototype.f=function(a){var b=this;return cw(a,this.S,function(){return dw(b.Z,a,!0)})};function cw(a,b,c){var d=b.filter(function(b){return b.w.M===a.M&&b.w.K===a.K});if(0<d.length)return d[0].result;c=c(a);b.push({w:a,result:c});return c}
function dw(a,b,c){for(var d=[];a;a=a.parentNode){if(b.M===a)return b.K;d.push(a)}for(a=b.M;a;a=a.parentNode){var e=d.indexOf(a);if(0<=e)return c?!e:!1;for(e=a;e;e=e.previousElementSibling)if(d.includes(e))return!0}return b.K}function ew(a){return!a.Bc&&a.re&&a.yc||!a.Cc&&a.gd&&a.zc?!0:!1}function fw(a){this.C=a}fw.prototype.b=function(){};fw.prototype.f=function(a){return!!a};
fw.prototype.g=function(a,b,c,d){(a=this.C.b)&&!a.j&&(a.D&&(a.H=Op(a.D,c,a.N),a.D=null),a.u&&(a.G=Op(a.u,c,a.N),a.u=null),a.j=!0);return d};function gw(a){this.C=a}gw.prototype.b=function(){};gw.prototype.f=function(){return!0};gw.prototype.g=function(a,b,c,d){return d};function hw(a){this.C=a}v(hw,fw);hw.prototype.b=function(a,b){fw.prototype.b.call(this,a,b);var c=L("BlockLayoutProcessor.doInitialLayout");Fm(new Em(new iw(a.C),b.j),a).Ea(c);return c.result()};hw.prototype.f=function(){return!1};
function jw(a){this.C=a}v(jw,gw);jw.prototype.b=function(a,b){jl(a,this.C)||a.K||b.B.unshift(new Xv(a));return kw(a,b)};function Xv(a){this.w=Sv(a.C,a)}n=Xv.prototype;n.ke=function(a,b){var c=this.w.C.b;return c&&!Po(this.w.A)&&ew(c)?b&&!a||a&&a.xa?!1:!0:!0};n.nd=function(){var a=this.w.C.b;return a&&ew(a)?(!a.Bc&&a.re&&a.yc?a.Bc=!0:!a.Cc&&a.gd&&a.zc&&(a.Cc=!0),!0):!1};n.cd=function(a,b,c,d){(c=this.w.C.b)&&a&&d.u&&(!b||bw(c,b))&&(c.Bc=!1,c.re=!1)};
n.Na=function(a,b){var c=this.w.C,d=this.w.C.b;if(!d)return M(!0);var e=this.w;return Uv(c,e,b).ea(function(){return Rv(c,e,b).ea(function(){d.Cc=d.Bc=!1;d.re=!0;d.gd=!0;return M(!0)})})};n.se=function(a){return a instanceof Xv?this.w.C===a.w.C:!1};n.ue=function(){return 10};function lw(a){Om.call(this);this.C=a}v(lw,Om);lw.prototype.qf=function(a){var b=this.C.b;return jl(a,this.C)||b.j?(jl(a,this.C)||a.K||!b||(b.Cc=!1,b.gd=!1),new jw(this.C)):new hw(this.C)};function iw(a){this.C=a}v(iw,Hm);
iw.prototype.Cd=function(a){var b=this.C,c=a.w,d=b.b;if(c.parent&&b.j===c.parent.M){switch(c.u){case "header":if(d.zc)c.u="none";else return $v(d,c),M(!0);break;case "footer":if(d.yc)c.u="none";else return aw(d,c),M(!0)}d.g||(d.g=c.M)}return Hm.prototype.Cd.call(this,a)};iw.prototype.tc=function(a){var b=this.C,c=a.w;c.M===b.j&&(b.b.J=a.ld&&a.ld.M,a.Vb=!0);return"header"===c.u||"footer"===c.u?M(!0):Hm.prototype.tc.call(this,a)};function mw(){}v(mw,Jp);
mw.prototype.je=function(a,b,c){if(xo(b,a))return Ho(b,a);var d=a.C;return Yv(d,a)?(c&&Vv(a.parent,b),jl(a,d)?Jp.prototype.je.call(this,a,b,c):Pm(new lw(d),a,b)):Jo(b,a)};mw.prototype.Ze=function(a){var b=uo(a).b;if(!b)return!1;b.h||b.B!==a.M&&b.l!==a.M||a.A.parentNode.removeChild(a.A);return!1};
function kw(a,b){var c=a.C,d=L("doLayout"),e=Gm(b.j,a,!1);Io(e,b).then(function(a){var e=a;Fe(function(a){for(var d={};e;){d.Oa=!0;Bp(b,e,!1).then(function(d){return function(f){e=f;Jn(b.l)?Q(a):b.g?Q(a):e&&b.u&&e&&e.xa?Q(a):e&&e.K&&e.M==c.j?Q(a):d.Oa?d.Oa=!1:P(a)}}(d));if(d.Oa){d.Oa=!1;return}d={Oa:d.Oa}}Q(a)}).then(function(){O(d,e)})});return d.result()}mw.prototype.Na=function(a,b,c,d){return Jp.prototype.Na.call(this,a,b,c,d)};mw.prototype.Fd=function(a,b,c,d){Jp.prototype.Fd(a,b,c,d)};
function ro(a){for(var b=[],c=a;c;c=c.Md)c.B.forEach(function(c){if(c instanceof Xv){var d=c.w.C.b;b.push(d)}c instanceof nw&&(d=new ow(c.w,c.f),b.push(d));c instanceof pw&&qw(c,a).forEach(function(a){b.push(a)})});return b}var rw=new mw;ge("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof zp&&!(a instanceof yp)?rw:null});function sw(a,b){if(!a||!a.J||a.K||xo(b,a))return M(a);var c=a.J;return tw(c,b,a).ea(function(d){var e=a.A;e.appendChild(d);var f=Op(d,b,a.b);e.removeChild(d);b.B.push(new nw(a,c,f));return M(a)})}function uw(a,b,c){this.b=a;this.f=b;this.Nb=c}uw.prototype.matches=function(){var a=vw[this.b];return!!a&&null!=a.Sa&&Ci(a.Sa,this.f,this.Nb)};function uj(a){this.b=a}uj.prototype.matches=function(){return this.b.some(function(a){return a.matches()})};function vj(a){this.b=a}vj.prototype.matches=function(){return this.b.every(function(a){return a.matches()})};
function tj(a,b){var c=b.split("_");if("NFS"==c[0])return new uw(a,parseInt(c[1],10),parseInt(c[2],10));sa("unknown view condition. condition="+b);return null}function Wj(a,b,c){tr(c,function(c){Yj(a,c,b)})}function tr(a,b){var c=a._viewConditionalStyles;c&&c.forEach(function(a){a.Cg.matches()&&b(a.Mg)})}function Er(a,b,c){var d=vw;if(!d[a]||d[a].cb<=c)d[a]={Sa:b,cb:c}}var vw={};function Nr(a,b){this.b=b;this.M=a}
function tw(a,b,c){var d=c.A.ownerDocument.createElement("div"),e=new Im(b,d,c),f=e.za.g;e.za.g=null;return Lm(e,ww(a)).ea(function(){a.b.f["after-if-continues"]=!1;e.za.g=f;var b=d.firstChild;x(b,"display","block");return M(b)})}function ww(a){var b=nr.createElementNS("http://www.w3.org/1999/xhtml","div");pr(b,"after-if-continues");a=new $k(a.M,b,null,null,null,3,a.b);return new kl({pa:[{node:b,kb:a.type,wa:a,Ja:null,Ga:null}],na:0,K:!1,Qa:null})}function nw(a,b,c){this.w=a;this.b=b;this.f=c}n=nw.prototype;
n.ke=function(a,b){return b&&!a||a&&a.xa?!1:!0};n.nd=function(){return!1};n.cd=function(){};n.Na=function(a,b){var c=this;return(new ow(this.w,this.f)).f(a)?tw(this.b,b,this.w).ea(function(a){c.w.A.appendChild(a);return M(!0)}):M(!0)};n.se=function(a){return a instanceof nw?this.b==a.b:!1};n.ue=function(){return 9};function ow(a,b){this.w=a;this.g=b}ow.prototype.b=function(a){return this.f(a)?this.g:0};ow.prototype.F=function(a){return this.b(a)};
ow.prototype.f=function(a){if(!a)return!1;var b=a.wa?a.wa.oa:a.M;if(b===this.w.M)return!!a.K;for(a=b.parentNode;a;a=a.parentNode)if(a===this.w.M)return!0;return!1};function Io(a,b){return a.ea(function(a){return sw(a,b)})}function Ip(a,b){var c=L("vivliostyle.selectors.processAfterIfContinuesOfAncestors"),d=a;Ee(function(){if(d){var a=sw(d,b);d=d.parent;return a.Hc(!0)}return M(!1)}).then(function(){O(c,!0)});return c.result()};function xw(a){var b=yw.findIndex(function(b){return b.root===a});0<=b&&yw.splice(b,1)}function zw(a){var b=yw.findIndex(function(b){return b.root===a});return(b=yw[b])?b.Og:null}
function Aw(a,b,c){var d=a.w,e=d.display,f=d.parent?d.parent.display:null,g=!1;if("inline-table"===f&&!(d.C instanceof yp))for(var h=d.parent;h;h=h.parent)if(h.C instanceof yp){g=h.C===b;break}return g||"table-row"===e&&!Bw(f)&&"table"!==f&&"inline-table"!==f||"table-cell"===e&&"table-row"!==f&&!Bw(f)&&"table"!==f&&"inline-table"!==f||d.C instanceof yp&&d.C!==b?Jo(c,d).ea(function(b){a.w=b;return M(!0)}):null}
function Bw(a){return"table-row-group"===a||"table-header-group"===a||"table-footer-group"===a}function Cw(a,b){this.rowIndex=a;this.M=b;this.b=[]}function Dw(a){return Math.min.apply(null,a.b.map(function(a){return a.height}))}function Ew(a,b,c){this.rowIndex=a;this.Ra=b;this.g=c;this.f=c.colSpan||1;this.rowSpan=c.rowSpan||1;this.height=0;this.b=null}function Fw(a,b,c){this.rowIndex=a;this.Ra=b;this.bc=c}function Gw(a,b,c){this.g=a;this.b=c;this.lc=new Im(a,b,c);this.f=!1}
Gw.prototype.ec=function(){var a=this.b.A,b=this.b.Z;"middle"!==b&&"bottom"!==b||x(a,"vertical-align","top");var c=this.lc.ec(!0);x(a,"vertical-align",b);return c};function Hw(a,b){this.A=a;this.b=b}function Iw(a,b,c,d){Nm.call(this,a,b,c,d);this.C=a.C;this.rowIndex=this.l=null}v(Iw,Nm);Iw.prototype.f=function(a,b){var c=Nm.prototype.f.call(this,a,b);return b<this.b()?null:Jw(this).every(function(a){return!!a.w})?c:null};
Iw.prototype.b=function(){var a=Nm.prototype.b.call(this);Jw(this).forEach(function(b){a+=b.Eb.b()});return a};function Jw(a){a.l||(a.l=Kw(a).map(function(a){return a.ec()}));return a.l}function Kw(a){return Lw(a.C,null!=a.rowIndex?a.rowIndex:a.rowIndex=Mw(a.C,a.position.M)).map(a.C.Sd,a.C)}function Nw(a,b,c){this.rowIndex=a;this.j=b;this.C=c;this.h=null}v(Nw,no);
Nw.prototype.f=function(a,b){if(b<this.b())return null;var c=Ow(this),d=Pw(this),e=d.every(function(a){return!!a.w})&&d.some(function(a,b){var d=c[b].lc,e=a.w,f=d.tf[0];return!(f.A===e.A&&f.K===e.K&&f.na===e.na)&&!Uk(fl(e),d.za.xb)});this.j.xa=d.some(function(a){return a.w&&a.w.xa});return e?this.j:null};Nw.prototype.b=function(){var a=this.C,b=0;Dw(a.g[this.rowIndex])>a.N/2||(b+=10);Pw(this).forEach(function(a){b+=a.Eb.b()});return b};
function Pw(a){a.h||(a.h=Ow(a).map(function(a){return a.ec()}));return a.h}function Ow(a){return Qw(a.C,a.rowIndex).map(a.C.Sd,a.C)}function yp(a,b){zp.call(this,a,b);this.F=b;this.u=!1;this.G=-1;this.N=0;this.H=[];this.J=this.B=null;this.S=0;this.g=[];this.l=[];this.f=[];this.D=null;this.h=[];this.b=null}v(yp,zp);n=yp.prototype;n.We=function(){return"Table formatting context (vivliostyle.table.TableFormattingContext)"};
n.ff=function(a,b){if(!b)return b;switch(a.display){case "table-row":return!this.h.length;case "table-cell":return!this.h.some(function(b){return b.Id.pa[0].node===a.M});default:return b}};function Rw(a,b){var c=a.l[b];c||(c=a.l[b]=[]);return c}function Mw(a,b){return a.g.findIndex(function(a){return b===a.M})}function Qw(a,b){return Rw(a,b).reduce(function(a,b){return b.bc!==a[a.length-1]?a.concat(b.bc):a},[])}function Lw(a,b){return Qw(a,b).filter(function(a){return a.rowIndex+a.rowSpan-1>b})}
n.Sd=function(a){return this.f[a.rowIndex]&&this.f[a.rowIndex][a.Ra]};function Sw(a){0>a.G&&(a.G=Math.max.apply(null,a.g.map(function(a){return a.b.reduce(function(a,b){return a+b.f},0)})));return a.G}function Tw(a,b){a.g.forEach(function(a){a.b.forEach(function(a){var c=Kk(b,a.g);a.g=null;a.height=this.u?c.width:c.height},this)},a)}
function Uw(a,b){if(!b)return null;var c=null,d=0;a:for(;d<a.f.length;d++)if(a.f[d])for(var e=0;e<a.f[d].length;e++)if(a.f[d][e]&&b===a.f[d][e].lc.za){c=a.g[d].b[e];break a}if(!c)return null;for(;d<a.l.length;d++)for(;e<a.l[d].length;e++){var f=a.l[d][e];if(f.bc===c)return{rowIndex:f.rowIndex,Ra:f.Ra}}return null}function Vw(a,b){var c=[];return a.l.reduce(function(d,e,f){if(f>=b.rowIndex)return d;e=a.Sd(e[b.Ra].bc);if(!e||c.includes(e))return d;Ww(e.lc.za,d);c.push(e);return d},[])}
function Xw(a){var b=[];a.g.forEach(function(c){c.b.forEach(function(c,e){b[e]||(b[e]={Jf:[],elements:[]});var d=b[e],g=a.Sd(c);g&&!d.Jf.includes(g)&&(Ww(g.lc.za,d.elements),d.Jf.push(g))})});return[new Yw(b.map(function(a){return a.elements}))]}function Ww(a,b){a.B.forEach(function(a){a instanceof Xv&&b.push(a.w.C.b);a instanceof pw&&qw(a,null).forEach(function(a){b.push(a)})})}n.Ye=function(){return[].concat(this.h)};n.Xe=function(a){this.h=a};function Yw(a){this.f=a}
Yw.prototype.b=function(a){return Zw(this,a,function(a){return a.current})};Yw.prototype.F=function(a){return Zw(this,a,function(a){return a.He})};function Zw(a,b,c){var d=0;a.f.forEach(function(a){a=oo(b,a);d=Math.max(d,c(a))});return d}function $w(a,b){this.C=a;this.h=b;this.rowIndex=-1;this.Ra=0;this.g=!1;this.f=[]}v($w,Hm);n=$w.prototype;
n.Cd=function(a){var b=this.C,c=Aw(a,b,this.h);if(c)return c;ax(this,a);var c=a.w,d=b.b;switch(c.display){case "table":b.S=c.sa;break;case "table-caption":b.H.push(new Hw(c.A,c.la));break;case "table-header-group":return d.zc||(this.b=!0,$v(d,c)),M(!0);case "table-footer-group":return d.yc||(this.b=!0,aw(d,c)),M(!0);case "table-row":this.b||(this.g=!0,this.rowIndex++,this.Ra=0,b.g[this.rowIndex]=new Cw(this.rowIndex,c.M),d.g||(d.g=c.M))}return Hm.prototype.Cd.call(this,a)};
n.tc=function(a){var b=this.C,c=a.w,d=c.display,e=this.h.f;ax(this,a);if(c.M===b.F)d=Qn(e,Yv(b,c)),b.N=parseFloat(d[b.u?"height":"width"]),b.b.J=a.ld&&a.ld.M,a.Vb=!0;else switch(d){case "table-header-group":case "table-footer-group":if(this.b)return this.b=!1,M(!0);break;case "table-row":this.b||(b.D=c.A,this.g=!1);break;case "table-cell":if(!this.b){this.g||(this.rowIndex++,this.Ra=0,this.g=!0);d=this.rowIndex;c=new Ew(this.rowIndex,this.Ra,c.A);e=b.g[d];e||(b.g[d]=new Cw(d,null),e=b.g[d]);e.b.push(c);
for(var e=d+c.rowSpan,f=Rw(b,d),g=0;f[g];)g++;for(;d<e;d++)for(var f=Rw(b,d),h=g;h<g+c.f;h++){var l=f[h]=new Fw(d,h,c);c.b||(c.b=l)}this.Ra++}}return Hm.prototype.tc.call(this,a)};n.uf=function(a){bx(this,a)};n.Df=function(a){bx(this,a)};n.kg=function(a){bx(this,a)};n.Cf=function(a){bx(this,a)};function bx(a,b){var c=b.w;c&&c.A&&!Fo(c)&&a.f.push(c.clone())}function ax(a,b){0<a.f.length&&Ko(a.h,b.w,a.f);a.f=[]}
function cx(a,b){this.gc=!0;this.C=a;this.f=b;this.l=!1;this.b=-1;this.g=0;this.u=b.u;b.u=!1}v(cx,Hm);var dx={"table-caption":!0,"table-column-group":!0,"table-column":!0};
function ex(a,b,c,d){var e=b.rowIndex,f=b.Ra,g=c.A;if(1<b.f){x(g,"box-sizing","border-box");for(var h=a.C.J,l=0,k=0;k<b.f;k++)l+=h[b.b.Ra+k];l+=a.C.S*(b.f-1);x(g,a.C.u?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new Gw(a.f,b,c);a=a.C;(g=a.f[e])||(g=a.f[e]=[]);g[f]=c;1===d.f.pa.length&&d.f.K&&(c.f=!0);return Lm(c.lc,d).Hc(!0)}function fx(a,b){var c=a.C.h[0];return c?c.bc.b.Ra===b:!1}
function gx(a){var b=a.C.h;if(!b.length)return[];var c=[],d=0;do{var e=b[d],f=e.bc.rowIndex;if(f<a.b){var g=c[f];g||(g=c[f]=[]);g.push(e);b.splice(d,1)}else d++}while(d<b.length);return c}
function hx(a,b){var c=a.C,d=gx(a),e=d.reduce(function(a){return a+1},0);if(0===e)return M(!0);var f=a.f.j,g=b.w;g.A.parentNode.removeChild(g.A);var h=L("layoutRowSpanningCellsFromPreviousFragment"),l=M(!0),k=0,m=[];d.forEach(function(a){var b=this;l=l.ea(function(){var d=Xk(a[0].Id.pa[1],g.parent);return Ao(f,d,!1).ea(function(){function g(a){for(;l<a;){if(!m.includes(l)){var b=d.A.ownerDocument.createElement("td");x(b,"padding","0");d.A.appendChild(b)}l++}}var h=M(!0),l=0;a.forEach(function(a){var b=
this;h=h.ea(function(){var c=a.bc;g(c.b.Ra);var h=a.Id,p=Xk(h.pa[0],d);p.na=h.na;p.K=h.K;p.Sa=h.pa[0].Sa+1;return Ao(f,p,!1).ea(function(){for(var d=a.Hf,f=0;f<c.f;f++)m.push(l+f);l+=c.f;return ex(b,c,p,d).ea(function(){p.A.rowSpan=c.rowIndex+c.rowSpan-b.b+e-k;return M(!0)})})})},b);return h.ea(function(){g(Sw(c));k++;return M(!0)})})})},a);l.then(function(){Ao(f,g,!0,b.Gd).then(function(){O(h,!0)})});return h.result()}
function ix(a,b){if(a.j||a.h)return M(!0);var c=b.w,d=a.C;0>a.b?a.b=Mw(d,c.M):a.b++;a.g=0;a.l=!0;return hx(a,b).ea(function(){jx(a);up(a.f,b.ld,null,!0,b.dd)&&!Lw(d,a.b-1).length&&(a.f.u=a.u,c.xa=!0,b.Vb=!0);return M(!0)})}function jx(a){a.C.g[a.b].b.forEach(function(b){var c=a.C.h[b.Ra];c&&c.bc.b.Ra==b.b.Ra&&(b=c.Id.pa[0],c=hk(a.f.j.da,b.node),Er(c,b.Sa+1,1))})}
function kx(a,b){if(a.j||a.h)return M(!0);var c=b.w;a.l||(0>a.b?a.b=0:a.b++,a.g=0,a.l=!0);var d=a.C.g[a.b].b[a.g],e=Zk(c).modify();e.K=!0;b.w=e;var f=L("startTableCell");fx(a,d.b.Ra)?(e=a.C.h.shift(),c.Sa=e.Id.pa[0].Sa+1,e=M(e.Hf)):e=Go(a.f,c,b.Gd).ea(function(a){a.A&&c.A.removeChild(a.A);return M(new kl(Vk(a)))});e.then(function(e){ex(a,d,c,e).then(function(){a.tc(b);a.g++;O(f,!0)})});return f.result()}
cx.prototype.lg=function(a){var b=Aw(a,this.C,this.f);if(b)return b;var b=a.w,c=this.C.b,d=b.display;return"table-header-group"===d&&c&&c.B===b.M?(this.j=!0,M(!0)):"table-footer-group"===d&&c&&c.l===b.M?(this.h=!0,M(!0)):"table-row"===d?ix(this,a):"table-cell"===d?kx(this,a):M(!0)};cx.prototype.Nf=function(a){a=a.w;"table-row"===a.display&&(this.l=!1,this.j||this.h||(a=Zk(a).modify(),a.K=!1,this.f.N.push(new Nw(this.b,a,this.C))));return M(!0)};
cx.prototype.tc=function(a){var b=a.w,c=this.C.b,d=b.display;"table-header-group"===d?c&&!c.h&&c.B===b.M?(this.j=!1,b.A.parentNode.removeChild(b.A)):x(b.A,"display","table-row-group"):"table-footer-group"===d&&(c&&!c.h&&c.l===b.M?(this.h=!1,b.A.parentNode.removeChild(b.A)):x(b.A,"display","table-row-group"));if(d&&dx[d])b.A.parentNode.removeChild(b.A);else if(b.M===this.C.F)b.xa=tp(this.f,b,null),this.f.u=this.u,a.Vb=!0;else return Hm.prototype.tc.call(this,a);return M(!0)};var yw=[];
function lx(){}function mx(a,b,c,d){for(var e=a.ownerDocument,f=e.createElement("tr"),g=[],h=0;h<b;h++){var l=e.createElement("td");f.appendChild(l);g.push(l)}a.parentNode.insertBefore(f,a.nextSibling);b=g.map(function(a){a=Kk(d,a);return c?a.height:a.width});a.parentNode.removeChild(f);return b}function nx(a){var b=[];for(a=a.firstElementChild;a;)"colgroup"===a.localName&&b.push(a),a=a.nextElementSibling;return b}
function ox(a){var b=[];a.forEach(function(a){var c=a.span;a.removeAttribute("span");for(var e=a.firstElementChild;e;){if("col"===e.localName){var f=e.span;e.removeAttribute("span");for(c-=f;1<f--;){var g=e.cloneNode(!0);a.insertBefore(g,e);b.push(g)}b.push(e)}e=e.nextElementSibling}for(;0<c--;)e=a.ownerDocument.createElement("col"),a.appendChild(e),b.push(e)});return b}
function px(a,b,c,d){if(a.length<c){var e=d.ownerDocument.createElement("colgroup");b.push(e);for(b=a.length;b<c;b++){var f=d.ownerDocument.createElement("col");e.appendChild(f);a.push(f)}}}function qx(a,b,c){var d=a.u,e=a.D;if(e){a.D=null;var f=e.ownerDocument.createDocumentFragment(),g=Sw(a);if(0<g){var h=a.J=mx(e,g,d,c.f);c=nx(b);e=ox(c);px(e,c,g,b);e.forEach(function(a,b){x(a,d?"height":"width",h[b]+"px")});c.forEach(function(a){f.appendChild(a.cloneNode(!0))})}a.B=f}}
function rx(a,b,c){var d=b.C;d.u=b.b;Or(d,b.b);var e=zw(b.M);xw(b.M);var f=L("TableLayoutProcessor.doInitialLayout"),g=Zk(b);Fm(new Em(new $w(b.C,c),c.j),b).then(function(a){var h=a.A,k=Kk(c.f,h),k=c.b?k.left:k.bottom,k=k+(c.b?-1:1)*oo(b,ro(c)).current;so(c,k)||e&&e.tg?(qx(d,h,c),Tw(d,c.f),O(f,null)):(c.N.push(new sx(g)),O(f,a))}.bind(a));return f.result()}function tx(a,b,c){var d=a.H;d.forEach(function(a,f){a&&(b.insertBefore(a.A,c),"top"===a.b&&(d[f]=null))})}
function ux(a,b){if(a.B&&b){var c=nx(b);c&&c.forEach(function(a){b.removeChild(a)})}}function vx(a,b){var c=a.C,d=Yv(c,a),e=d.firstChild;tx(c,d,e);c.B&&!nx(d).length&&d.insertBefore(c.B.cloneNode(!0),e);c=new cx(c,b);c=new Em(c,b.j);d=L("TableFormattingContext.doLayout");Fm(c,a).Ea(d);return d.result()}n=lx.prototype;n.je=function(a,b,c){var d=a.C;return Yv(d,a)?(c&&Vv(a.parent,b),Pm(new wx(d,this),a,b)):Jo(b,a)};n.Kf=function(a,b,c,d){return new Iw(a,b,c,d)};n.Ze=function(){return!1};n.Af=function(){return!1};
n.Na=function(a,b,c,d){var e=b.C;if("table-row"===b.display){var f=Mw(e,b.M);e.h=[];var g;g=b.K?Lw(e,f):Qw(e,f);if(g.length){var h=L("TableLayoutProcessor.finishBreak"),l=0;Fe(function(a){if(l===g.length)Q(a);else{var b=g[l++],c=e.Sd(b),d=c.ec().w,h=c.b,k=fl(h),u=new kl(fl(d));e.h.push({Id:k,Hf:u,bc:b});h=h.A;Mp(c.b);f<b.rowIndex+b.rowSpan-1&&(h.rowSpan=f-b.rowIndex+1);c.f?P(a):c.lc.Na(d,!1,!0).then(function(){var b=e.b;if(b){var f=e.u,g=c.g,h=c.lc.za.element,k=c.b.A,l=Kk(g.f,k),k=Ro(g,k);f?(b=l.right-
g.la-b.b(d)-k.right,x(h,"max-width",b+"px")):(b=g.la-b.b(d)-l.top-k.top,x(h,"max-height",b+"px"));x(h,"overflow","hidden")}P(a)})}}).then(function(){lp(a,b,!1);Mp(b);e.f=[];O(h,!0)});return h.result()}}e.f=[];return pp.Na(a,b,c,d)};n.Fd=function(a,b,c,d){Jp.prototype.Fd(a,b,c,d)};function wx(a,b){Om.call(this);this.g=b;this.b=a}v(wx,Om);wx.prototype.qf=function(a){var b=this.b.b;return b&&b.j?(a.M===this.b.F&&!a.K&&b&&(b.Cc=!1,b.gd=!1),new xx(this.b)):new yx(this.b,this.g)};
wx.prototype.Jd=function(a){Om.prototype.Jd.call(this,a);ux(this.b,Yv(this.b,a))};wx.prototype.ie=function(a,b){Om.prototype.ie.call(this,a,b);this.b.f=[]};function yx(a,b){this.C=a;this.h=b}v(yx,fw);yx.prototype.b=function(a,b){fw.prototype.b.call(this,a,b);return rx(this.h,a,b)};function sx(a){Nm.call(this,a,null,a.xa,0)}v(sx,Nm);sx.prototype.b=function(){if(!this.h)throw Error("EdgeBreakPosition.prototype.updateEdge not called");return(this.j?3:0)+(this.position.parent?this.position.parent.j:0)};
sx.prototype.u=function(a){a.B.push(new zx(this.position.M))};function zx(a){this.b=a}n=zx.prototype;n.ke=function(){return!1};n.nd=function(){return!0};n.cd=function(a,b){yw.push({root:b.M,Og:{tg:!0}})};n.Na=function(){return M(!0)};n.se=function(a){return a instanceof zx&&a.b===this.b};n.ue=function(){return 0};function xx(a){this.C=a}v(xx,gw);xx.prototype.b=function(a,b){var c=this.C.b;if(c&&!bw(c,a)){var d=new pw(a);b.B.some(function(a){return d.se(a)})||b.B.unshift(d)}return vx(a,b)};
function pw(a){Xv.call(this,a);this.b=[]}v(pw,Xv);n=pw.prototype;n.ke=function(a,b,c){var d=this.w.C.b;return!d||c.Md||Po(this.w.A)||!ew(d)?!0:b&&!a||a&&a.xa?!1:!0};n.nd=function(a){return Ax(a,this.w.C).some(function(b){return b.Kd.some(function(b){return b.nd(a)})})?!0:Xv.prototype.nd.call(this,a)};n.cd=function(a,b,c,d){var e=this.w.C;this.b=Ax(b,e);this.b.forEach(function(b){b.Kd.forEach(function(e){e.cd(a,b.Eb,c,d)})});a||(ux(e,Yv(e,this.w)),Bx(c));Xv.prototype.cd.call(this,a,b,c,d)};
n.Na=function(a,b){var c=this,d=L("finishBreak"),e=this.b.reduce(function(a,b){return a.concat(b.Kd.map(function(a){return{vg:a,Eb:b.Eb}}))},[]),f=0;Ee(function(){if(f<e.length){var a=e[f++];return a.vg.Na(a.Eb,b).Hc(!0)}return M(!1)}).then(function(){O(d,!0)});return d.result().ea(function(){return Xv.prototype.Na.call(c,a,b)})};function Bx(a){if(a&&"table-row"===a.display&&a.A)for(;a.A.previousElementSibling;){var b=a.A.previousElementSibling;b.parentNode&&b.parentNode.removeChild(b)}}
function Ax(a,b){return Cx(a,b).map(function(a){return{Kd:a.yg.lc.za.B,Eb:a.Eb}})}function Cx(a,b){var c=Number.MAX_VALUE;a&&"table-row"===a.display&&(c=Mw(b,a.M)+1);for(var c=Math.min(b.f.length,c),d=[],e=0;e<c;e++)b.f[e]&&b.f[e].forEach(function(a){a&&d.push({yg:a,Eb:a.ec().w})});return d}function qw(a,b){var c=a.w.C,d=Uw(c,b);return d?Vw(c,d):Xw(c)}n.se=function(a){return a instanceof pw?this.w.C===a.w.C:!1};var Dx=new lx;
ge("RESOLVE_FORMATTING_CONTEXT",function(a,b,c){return b?c===Od?(b=a.parent,new yp(b?b.C:null,a.M)):null:null});ge("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof yp?Dx:null});Array.from||(Array.from=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e],e):a[e];return c});
...
Object.assign||(Object.assign=function(a,b){if(!b)return a;Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function Ex(a){function b(a){return"number"===typeof a?a:null}function c(a){return"string"===typeof a?{url:a,wb:null,nc:null}:{url:a.url,wb:b(a.startPage),nc:b(a.skipPagesBefore)}}return Array.isArray(a)?a.map(c):a?[c(a)]:null}function Fx(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}
function Gx(a,b){ak=a.debug;this.g=!1;this.h=a;this.gb=new Uu(a.window||window,a.viewportElement,"main",this.wg.bind(this));this.f={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,pageViewMode:"autoSpread",zoom:1,fitToScreen:!1,defaultPaperSize:void 0};b&&this.jg(b);this.b=new fb;Object.defineProperty(this,"readyState",{get:function(){return this.gb.u}})}n=Gx.prototype;n.jg=function(a){var b=Object.assign({a:"configure"},Fx(a));this.gb.h(b);Object.assign(this.f,a)};
n.wg=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});gb(this.b,b)};n.Pg=function(a,b){this.b.addEventListener(a,b,!1)};n.Sg=function(a,b){this.b.removeEventListener(a,b,!1)};n.Bg=function(a,b,c){a||gb(this.b,{type:"error",content:"No URL specified"});Hx(this,a,null,b,c)};n.Qg=function(a,b,c){a||gb(this.b,{type:"error",content:"No URL specified"});Hx(this,null,a,b,c)};
function Hx(a,b,c,d,e){function f(a){if(a)return a.map(function(a){return{url:a.url||null,text:a.text||null}})}d=d||{};var g=f(d.authorStyleSheet),h=f(d.userStyleSheet);e&&Object.assign(a.f,e);b=Object.assign({a:b?"loadXML":"loadPublication",userAgentRootURL:a.h.userAgentRootURL,url:Ex(b)||c,document:d.documentObject,fragment:d.fragment,authorStyleSheet:g,userStyleSheet:h},Fx(a.f));a.g?a.gb.h(b):(a.g=!0,vv(a.gb,b))}n.fc=function(){return this.gb.fc()};
...
n.Rg=function(a){a:{var b=this.gb;if(!b.g)throw Error("no page exists.");switch(a){case "fit inside viewport":a=qv(b,b.$.ub?pv(b,b.j):b.g.g);break a;default:throw Error("unknown zoom type: "+a);}}return a};n.zg=function(){return this.gb.Z};oa("vivliostyle.viewer.Viewer",Gx);Gx.prototype.setOptions=Gx.prototype.jg;Gx.prototype.addListener=Gx.prototype.Pg;Gx.prototype.removeListener=Gx.prototype.Sg;Gx.prototype.loadDocument=Gx.prototype.Bg;Gx.prototype.loadPublication=Gx.prototype.Qg;
Gx.prototype.getCurrentPageProgression=Gx.prototype.fc;Gx.prototype.navigateToPage=Gx.prototype.Eg;Gx.prototype.navigateToInternalUrl=Gx.prototype.Dg;Gx.prototype.isTOCVisible=Gx.prototype.Rc;Gx.prototype.showTOC=Gx.prototype.Uc;Gx.prototype.queryZoomFactor=Gx.prototype.Rg;Gx.prototype.getPageSizes=Gx.prototype.zg;oa("vivliostyle.viewer.ZoomType",rv);rv.FIT_INSIDE_VIEWPORT="fit inside viewport";oa("vivliostyle.viewer.PageViewMode",Tu);Tu.SINGLE_PAGE="singlePage";Tu.SPREAD="spread";
Tu.AUTO_SPREAD="autoSpread";Mv.call(Yu,"load_vivliostyle","end",void 0);var Ix=16,Jx="ltr";function Kx(a){window.adapt_command(a)}function Lx(){Kx({a:"moveTo",where:"ltr"===Jx?"previous":"next"})}function Mx(){Kx({a:"moveTo",where:"ltr"===Jx?"next":"previous"})}
function Nx(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)Kx({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)Kx({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)Kx({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)Kx({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)Mx(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)Lx(),a.preventDefault();else if("0"===b||"U+0030"===c)Kx({a:"configure",fontSize:Math.round(Ix)}),a.preventDefault();else if("t"===b||"U+0054"===c)Kx({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)Ix*=1.2,Kx({a:"configure",fontSize:Math.round(Ix)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)Ix/=1.2,Kx({a:"configure",
fontSize:Math.round(Ix)}),a.preventDefault()}
function Ox(a){switch(a.t){case "loaded":a=a.viewer;var b=Jx=a.fc();a.ge.setAttribute("data-vivliostyle-page-progression",b);a.ge.setAttribute("data-vivliostyle-spread-view",a.$.ub);window.addEventListener("keydown",Nx,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Lx,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Mx,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(Ha(location.href,Va(a||"")));break;case "hyperlink":a.internal&&Kx({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+m+"; margin: 0; }",document.head.appendChild(g));vv(new Uu(window,k,"main",Ox),a)});
