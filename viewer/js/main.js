 ...
 *
 * Vivliostyle core 2016.4.1-pre.20160530062125
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
if(f&&18>d)return a.d.removeChild(e.d),a.l=null,xn(a,b,c),M(!0);if(!a.b&&e.top<g)return a.d.removeChild(e.d),xn(a,b,c),M(!0);var l=K("layoutFootnoteInner");a.b?Ci(e,0,d):Bi(e,g,d);e.D=a.D+a.left+yi(a);e.F=a.F+a.top+wi(a);e.G=a.G;var k=new ri(c);f?(zn(e),d=M(!0)):0==e.G.length?(An(e),d=M(!0)):d=Bn(e);d.then(function(){Cn(e,k).then(function(d){if(f&&d)a.d.removeChild(e.d),xn(a,b,c),a.l=null,O(l,!0);else{a.b?(a.ma=a.Pa+(e.e+yi(e)+zi(e)),Ci(e,0,e.e)):(a.ma=a.Pa-(e.e+wi(e)+xi(e)),Bi(e,a.ma-a.ra,e.e));
var g;!a.b&&0<e.G.length?g=Bn(e):g=M(d);g.then(function(d){d=new en(b,c,d?d.Xa:null);a.f?a.f.push(d):a.f=[d];O(l,!0)})}})});return N(l)}
...
L=l.toString(),Q=X(c,a,"column-count"),qa=X(c,a,"column-gap"),Y=1<Q?X(c,a,"column-width"):q.width,l=Vl(c,a),F=0,t=Wl(c,a,"shape-inside"),sa=pg(t,0,0,q.width,q.height,a),Fa=new Bm(L,a,a.viewport,a.d,l,a.ba,a.g,a.style.u,a,b,a.Ma,a.Na,h),Sh=0,ba=null;of(function(b){for(;Sh<Q;){var c=Sh++;if(1<Q){var d=a.viewport.b.createElement("div");w(d,"position","absolute");r.appendChild(d);ba=new gn(d,Fa,a.e);ba.b=q.b;ba.Oa=q.Oa;ba.hc=q.hc;q.b?(w(d,"margin-left",q.j+"px"),w(d,"margin-right",q.w+"px"),c=c*(Y+qa)+
