 ...
 *
 * Vivliostyle core 2016.10.1-pre.20170221000510
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
if(!c)throw Error("E_CFI_NUMBER_EXPECTED");e+=c[0].length;g=parseInt(c[1],10);(h=c[4])&&(h=ab(h));var l=c[7];l&&(l=ab(l));c=bb(c[10]);f.push(new eb(g,h,l,sa(c.s)));break;case "!":e++;f.push(new cb);break;case "~":case "@":case "":a.la=f;return;default:throw Error("E_CFI_PARSE_ERROR");}}function hb(a,b){for(var c={node:b.documentElement,offset:0,M:!1,nb:null,Gc:null},d=0;d<a.la.length;d++)if(!a.la[d].h(c)){++d<a.la.length&&(c.Gc=new fb,c.Gc.la=a.la.slice(d));break}return c}
...
Wm.prototype.He=function(a,b){return b};Wm.prototype.se=function(){return this.parent};Wm.prototype.dc=function(){return null};function Xm(a,b,c,d,e){Ck.call(this,a);this.$e=a.lastChild;this.j=b;this.b=c;this.Va=d;this.af=a.ownerDocument;this.f=e;cm(e,this);this.Ud=null;this.ve=this.xe=!1;this.F=this.kb=this.ya=this.X=this.V=0;this.J=this.Td=this.O=this.ta=null;this.Yd=!1;this.l=this.g=this.C=null;this.ac=!0;this.Ab=this.sc=this.bc=0;this.h=!0;this.La=null}t(Xm,Ck);
function Ym(a,b){return!!b.j&&(!a.xe||!!b.parent)}function Tm(a,b){return a.u?b<a.F:b>a.F}function Zm(a){var b=Hm(a.f);return a.Fb.concat(b)}Xm.prototype.vb=function(a){var b=this,c=I("openAllViews"),d=a.la;$m(b.j,b.element,b.ve);var e=d.length-1,f=null;ge(function(){for(;0<=e;){f=ik(d[e],f);e!==d.length-1||f.L||(f.L=b.Ud);if(!e){var c=f,h;h=a;h=h.Ka?sk(h.Ka,h.ia,1):h.ia;c.ia=h;f.M=a.M;f.Ka=a.Ka;if(f.M)break}c=an(b.j,f,!e&&!f.ia);e--;if(c.za())return c}return L(!1)}).then(function(){O(c,f)});return M(c)};
var bn=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;function cn(a,b){if(b.f&&b.Da&&!b.M&&!b.f.count&&1!=b.D.nodeType){var c=b.D.textContent.match(bn);return dn(a.j,b,c[0].length)}return L(b)}
function en(a,b,c){var d=I("buildViewToNextBlockEdge");he(function(d){b.D&&!fn(b)&&c.push(kk(b));cn(a,b).then(function(e){e!==b&&(b=e,fn(b)||c.push(kk(b)));gn(a.j,b).then(function(c){if(b=c){if(!hn(a.Va,b)&&(b=b.modify(),b.b=!0,a.h)){Q(d);return}Ym(a,b)&&!a.u?jn(a,b).then(function(c){b=c;!b||a.h&&b&&b.b?Q(d):P(d)}):b.Da?P(d):Q(d)}else Q(d)})})}).then(function(){O(d,b)});return M(d)}
function kn(a,b){if(!b.D)return L(b);var c=b.S,d=I("buildDeepElementView");he(function(d){cn(a,b).then(function(e){if(e!==b){for(var f=e;f&&f.S!=c;)f=f.parent;if(!f){b=e;Q(d);return}}gn(a.j,e).then(function(e){(b=e)&&b.S!=c?hn(a.Va,b)?P(d):(b=b.modify(),b.b=!0,a.h?Q(d):P(d)):Q(d)})})}).then(function(){O(d,b)});return M(d)}
...
function un(a,b,c,d){if(a.g&&a.g[a.g.length-1].b)return tn(a,b,c),L(!0);var e=new Rf(a.V,a.ya,a.X,a.kb),f=ng(a.J,e);f&&(d=Math.max(d,f.R*Hk(a)));d+=40*Hk(a);var g=a.O,h=!g;if(h){f=a.element.ownerDocument.createElement("div");v(f,"position","absolute");var l=a.j.clone(),k=new Zl(a.f,"column",null,a.f.h,c.la[0].node,null,null),g=new Xm(f,l,a.b,a.Va,k);g.ac=!1;cm(k,g);a.O=g;g.u=vn(a.j,a.u,f);g.ve=!0;a.u?(g.left=0,v(g.element,"width","2em")):(g.top=a.kb,v(g.element,"height","2em"))}a.element.appendChild(g.element);
...
d=L(!0));d.then(function(){zn(g,r).then(function(d){if(h&&d)a.element.removeChild(g.element),tn(a,b,c),a.O=null,O(n,!0);else{a.u?(a.F=m+(g.na+Fk(g)+Gk(g)),Kk(g,0,g.na)):(a.F=m-(g.na+Dk(g)+Ek(g)),Jk(g,a.F-a.ya,g.na));var e;!a.u&&0<Zm(g).length?e=xn(g):e=L(d);e.then(function(d){d=new Um(b,c,d?d.Ba:null);a.g?a.g.push(d):a.g=[d];O(n,!0)})}})});return M(n)}
function An(a,b){var c=I("layoutFootnote"),d=b.D;d.setAttribute("style","");v(d,"display","inline-block");d.textContent="M";var e=Xj(a.b,d),f=a.u?e.left:e.bottom;d.textContent="";Bn(a.j,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d=gk(b);e=b.pa;b=b.modify();b.M=!0;un(a,e,d,f).then(function(){a.O&&a.O.element.parentNode&&a.element.removeChild(a.O.element);Tm(a,f)&&a.C.length&&(b.b=!0);O(c,b)});return M(c)}
...
function Fn(a,b){var c=a.element.ownerDocument.createElement("div");v(c,"position","absolute");var d=em(a.f,b.b),e=new Zl(d,"column",null,a.f.h,b.S,null,null),d=bm(d),c=new Gn(b,c,a.j.clone(),a.b,a.Va,e,d);cm(e,c);var f=a.f,e=bm(f,b.b),g=Mk(e),d=c.element;e.element.parentNode.appendChild(d);Ik(c,e);c.element=d;c.xe=!0;c.width=g.T-g.U;c.height=g.N-g.R;c.marginLeft=c.marginRight=c.marginTop=c.marginBottom=0;c.borderLeft=c.ga=c.borderTop=c.Y=0;c.w=c.H=c.A=c.G=0;Kk(c,g.U-e.$a,c.width);Jk(c,g.R-e.ab,c.height);
...
function Wn(a,b){if(!a.g)return L(!0);for(var c=!1,d=a.g.length-1;0<=d;--d){var e=a.g[d];if(e.pa<=b)break;a.g.pop();e.b!==e.f&&(c=!0)}if(!c)return L(!0);var f=I("clearFootnotes"),g=a.na+a.ya,h=a.g;a.O=null;a.g=null;var l=0;ge(function(){for(;l<h.length;){var b=h[l++],b=un(a,b.pa,b.f,g);if(b.za())return b}return L(!1)}).then(function(){O(f,!0)});return M(f)}
...
function Zn(a,b,c,d){var e=I("findAcceptableBreak"),f=a.Gb().B,g=!1;if(!f){u.b("Could not find any page breaks?!!");if(a.ac)return $n(a,b).then(function(b){b?(b=b.modify(),b.b=!1,Rn(a,b,g,!0).then(function(){O(e,b)})):O(e,b)}),M(e);f=c;g=!0;a.na=d}Rn(a,f,g,!0).then(function(){O(e,f)});return M(e)}function ao(a){a=a.toString();return""==a||"auto"==a||!!a.match(/^0+(.0*)?[^0-9]/)}
function bo(a,b,c,d,e){var f;if(!(f=!b))a:{for(f=b.D;f;){if(f.parentNode===f.ownerDocument){f=!1;break a}f=f.parentNode}f=!0}if(f)return!1;f=Km(b,a.b,0,a.u);var g=b.M?b.parent&&b.parent.L:b.L;g&&(g=g.dc())&&(f+=(a.u?-1:1)*Sm(g));g=Tm(a,f);c&&(f+=Sn(a,c));En(a,f);if((d=a.h?d:!0)||!g)c=kk(b),b=Mm(b.L).g(c,e,g,a.na),a.C.push(b);return g}
...
function eo(a,b,c,d){function e(){return!!d||!c&&!!cl[m]}function f(){b=r[0]||b;b.D.parentNode.removeChild(b.D);h.l=m}var g=b.M?b.parent&&b.parent.L:b.L;if(g&&!(g instanceof Wm))return L(b);var h=a,l=I("skipEdges"),k=!d&&c&&b&&b.M,m=d,n=null,r=[],q=[],z=!1;he(function(a){for(;b;){do if(b.D){if(b.Da&&1!=b.D.nodeType){if(Zj(b.D,b.Qb))break;if(!b.M){e()?f():bo(h,n,null,!0,m)?(b=(h.h?n||b:b).modify(),b.b=!0):(b=b.modify(),b.g=m);Q(a);return}}if(!b.M&&(b.A&&co(h,b),!(b.L instanceof Wm)||Ym(h,b)||b.G)){r.push(kk(b));
m=al(m,b.g);if(e())f();else if(bo(h,n,null,!0,m)||!hn(h.Va,b))b=(h.h?n||b:b).modify(),b.b=!0;Q(a);return}if(1==b.D.nodeType){var d=b.D.style;if(b.M){if(z){if(e()){f();Q(a);return}r=[];k=c=!1;m=null}z=!1;n=kk(b);q.push(n);m=al(m,b.F);if(d&&(!ao(d.paddingBottom)||!ao(d.borderBottomWidth))){if(bo(h,n,null,!0,m)&&(b=(h.h?n||b:b).modify(),b.b=!0,h.h)){Q(a);return}q=[n];n=null}}else{r.push(kk(b));m=al(m,b.g);if(!hn(h.Va,b)&&(bo(h,n,null,!1,m),b=b.modify(),b.b=!0,h.h)){Q(a);return}if(Jm[b.D.localName]){e()?
f():bo(h,n,null,!0,m)&&(b=(h.h?n||b:b).modify(),b.b=!0);Q(a);return}!d||ao(d.paddingTop)&&ao(d.borderTopWidth)||(k=!1,q=[]);z=!0}}}while(0);d=gn(h.j,b,k);if(d.za()){d.then(function(c){b=c;P(a)});return}b=d.get()}bo(h,n,q,!1,m)?n&&h.h&&(b=n.modify(),b.b=!0):cl[m]&&(h.l=m);Q(a)}).then(function(){n&&(h.La=rk(n));O(l,b)});return M(l)}
function $n(a,b){var c=kk(b),d=I("skipEdges"),e=null,f=!1;he(function(d){for(;b;){do if(b.D){if(b.Da&&1!=b.D.nodeType){if(Zj(b.D,b.Qb))break;if(!b.M){cl[e]&&(a.l=e);Q(d);return}}if(!b.M&&(Ym(a,b)||b.G)){e=al(e,b.g);cl[e]&&(a.l=e);Q(d);return}if(1==b.D.nodeType){var g=b.D.style;if(b.M){if(f){if(cl[e]){a.l=e;Q(d);return}e=null}f=!1;e=al(e,b.F)}else{e=al(e,b.g);if(Jm[b.D.localName]){cl[e]&&(a.l=e);Q(d);return}if(g&&(!ao(g.paddingTop)||!ao(g.borderTopWidth))){Q(d);return}}f=!0}}while(0);g=gn(a.j,b);if(g.za()){g.then(function(a){b=
a;P(d)});return}b=g.get()}c=null;Q(d)}).then(function(){O(d,c)});return M(d)}function jn(a,b){return"footnote"==b.j?An(a,b):Cn(a,b)}function fo(a,b,c,d){var e=I("layoutNext");eo(a,b,c,d).then(function(c){b=c;!b||a.l||a.h&&b&&b.b?O(e,b):Mm(b.L).f(b,a).Fa(e)});return M(e)}function go(a,b){do{var c=a.D.parentNode;if(!c)break;var d=c,e=a.D;if(d)for(var f;(f=d.lastChild)!=e;)d.removeChild(f);b&&(c.removeChild(a.D),b=!1);a=a.parent}while(a)}
...
Fk(a),d=a.ab+a.top+Dk(a);e=new Rf(b,d,b+a.width,d+a.height);if(a.xa){b=a.xa;d=e.U;e=e.R;for(var f=[],g=0;g<b.b.length;g++){var h=b.b[g];f.push(new Sf(h.f+d,h.b+e))}b=new Xf(f)}else b=$f(e.U,e.R,e.T,e.N);a.J=kg(c,[b],Zm(a),a.pb,a.u);nn(a);a.g=null}function wn(a){a.Td=[];v(a.element,"width",a.width+"px");v(a.element,"height",a.height+"px");yn(a);a.na=0;a.Yd=!1;a.l=null;a.La=null}function En(a,b){a.na=Math.max(Hk(a)*(b-a.ya),a.na)}
...
function zn(a,b,c,d){a.Td.push(b);b.Ba.M&&(a.La=b.Ba);if(a.h&&a.Yd)return L(b);var e=I("layout");ho(a,b).then(function(){a.vb(b.Ba).then(function(b){var f=b,h=a.na;a.C=[];he(function(e){for(;b;){var g=!0;fo(a,b,c,d||null).then(function(d){c=!1;b=d;wm(a.f)?Q(e):a.l?Q(e):b&&a.h&&b&&b.b?Zn(a,b,f,h).then(function(a){b=a;Q(e)}):g?g=!1:P(e)});if(g){g=!1;return}}Q(e)}).then(function(){if(wm(a.f))O(e,null);else{var c=a.O;c&&(a.element.appendChild(c.element),a.u?a.na=this.ya-this.kb:a.na=c.top+Dk(c)+c.na+
...
function Tp(a,b,c){var d=!0,e=I("createElementView"),f=a.S,g=a.B.qa?a.B.qa.b:a.j,h=g.l(f,!1),l={};if(!a.B.parent){var k=Np(a,h),h=k.Sa;a.B.lang=k.lang}var m=h["float-reference"]&&Ql(h["float-reference"].value.toString());a.B.parent&&m&&Rl(m)&&(k=Np(a,h),h=k.Sa,a.B.lang=k.lang);a.B.u=Mp(a,a.B.u,h,l);Rp(a,l);Qp(a);l.direction&&(a.B.ma=l.direction.toString());if((k=l["flow-into"])&&k.toString()!=a.C)return O(e,!1),M(e);var n=l.display;if(n===F)return O(e,!1),M(e);var r=!a.B.parent;a.B.G=n===Zc;Lp(a,
...
else if(h=!1,!l.b.lf||a&&!q.h||c.push(f),q.h)g.push(f),Q(e);else{var k=!!a||!!b.l,m;0<tm(b.f).length&&b.La?a?(m=a.clone(),m.Ba=b.La):m=new vk(b.La):m=null;if(b.l&&m)l.f=m,d.f=b.l,b.l=null;else{g.push(f);if(a||m)l.f=a||m,c.push(f);b.l&&(d.g=Kl(b.l))}k?Q(e):z?z=!1:P(e)}});if(z){z=!1;return}}Q(e)}).then(function(){if(!wm(b.f)){d.b=d.b.filter(function(a,b){return 0<=c.indexOf(b)||0>g.indexOf(b)});"column"===d.f&&(d.f=null);var a=Im(b.f);En(b,a)}O(e,!0)})}});return M(e)}
...
J||wm(G)||um(G),wm(G)?(yc=0,a.b=z.clone(),G.Bc=!1,P(b)):(zc=c,zc.l&&"column"!=zc.l&&(yc=J,"region"!=zc.l&&(a.V[H]=!0)),Ca=Math.max(Ca,zc.na),yc<J?P(b):Q(b)))})}).then(function(){if(!wm(h)){zc.element===n&&(q=zc);q.na=Ca;c.Wc(a,q,b,zc,J,a.g,a.h);var d=a.b.b[H];d&&"region"===d.f&&(d.f=null)}O(A,!0)});l=M(A)}else{if((l=ap(c,a,"content"))&&Pk(l)){r="span";l.url&&(r="img");var Kj=a.viewport.b.createElement(r);l.ba(new Ok(Kj,a,l));n.appendChild(Kj);"img"==r&&pp(c,a,Kj,a.h);op(c,a,q,a.h)}else c.xa&&(d.removeChild(n),
y=!0);y||c.Wc(a,q,b,null,1,a.g,a.h);l=L(!0)}l.then(function(){if(wm(h))O(k,!0);else{if(!c.g||0<Math.floor(q.na)){if(!y&&!m){var l=ap(c,a,"shape-outside"),l=q.yd(l,a);g.push(l)}}else if(!c.w.length){d.removeChild(n);O(k,!0);return}var r=c.w.length-1;ge(function(){for(;0<=r;){var d=c.w[r--],d=ur(a,b,d,n,e,f,g,h);if(d.za())return d.oa(function(){return L(!wm(h))});if(wm(h))break}return L(!1)}).then(function(){O(k,!0)})}});return M(k)}
...
function st(a,b,c){this.me=[];this.b=Object.create(a);this.b.element=b;this.b.j=a.j.clone();this.b.h=!1;this.b.Ud=c.L;a=Xn(this.b,c);this.b.F-=a;var d=this;this.b.vb=function(a){return Xm.prototype.vb.call(this,a).oa(function(a){var b=kk(a);d.me.push(b);return L(a)})}}st.prototype.Gb=function(a){var b=this.b.Gb();if(a){a=b.Tc?b.Tc.b():Number.MAX_VALUE;var c=this.me[0],c=new Rm(kk(c),null,c.b,0),d=c.f(this.b,a);if(d&&c.b()<a)return{Tc:c,B:d}}return b};
...
for(;a<d;a++)for(var e=Zt(b,a),g=f;g<f+c.b;g++){var h=e[g]=new Lt(a,g,c);c.f||(c.f=h)}this.f++}}};function cu(a,b){this.Zc=!0;this.L=a;this.f=b;this.l=!1;this.b=-1;this.g=0;this.w=b.h;b.h=!1}t(cu,rt);var du={"table-caption":!0,"table-column-group":!0,"table-column":!0,"table-header-group":!0,"table-footer-group":!0};
function eu(a,b,c,d){var e=b.rowIndex,f=b.h,g=c.D;if(1<b.b){v(g,"box-sizing","border-box");for(var h=a.L.F,l=0,k=0;k<b.b;k++)l+=h[b.f.b+k];l+=a.L.O*(b.b-1);v(g,a.L.u?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new Mt(a.f,b,c);a=a.L;(g=a.h[e])||(g=a.h[e]=[]);g[f]=c;1===d.Ba.la.length&&d.Ba.M&&(c.f=!0);return zn(c.ad.b,d,!0).md(!0)}function fu(a,b){var c=a.L.b[0];return c?c.wc.f.b===b:!1}
...
function hu(a,b){var c=a.L,d=gu(a),e=d.reduce(function(a){return a+1},0);if(0===e)return L(!0);var f=a.f.j,g=b.B;g.D.parentNode.removeChild(g.D);var h=I("layoutRowSpanningCellsFromPreviousFragment"),l=L(!0),k=0,m=[];d.forEach(function(a){l=l.oa(function(){var b=ik(a[0].Zd.la[1],g.parent);return an(f,b,!1).oa(function(){function d(a){for(;h<a;){if(!(0<=m.indexOf(h))){var c=b.D.ownerDocument.createElement("td");v(c,"padding","0");b.D.appendChild(c)}h++}}var g=L(!0),h=0;a.forEach(function(a){g=g.oa(function(){var c=
a.wc;d(c.f.b);var g=a.Zd,l=ik(g.la[0],b);l.ia=g.ia;l.M=g.M;return an(f,l,!1).oa(function(){for(var b=a.ue,d=0;d<c.b;d++)m.push(h+d);h+=c.b;return eu(this,c,l,b).oa(function(){l.D.rowSpan=c.rowIndex+c.rowSpan-this.b+e-k;return L(!0)}.bind(this))}.bind(this))}.bind(this))},this);return g.oa(function(){d($t(c));k++;return L(!0)})}.bind(this))}.bind(this))},a);l.then(function(){an(f,g,!0,b.Rc).then(function(){O(h,!0)})});return M(h)}
function iu(a,b){if(a.j||a.h)return L(!0);var c=b.B,d=a.L;0>a.b?a.b=St(d,c.S):a.b++;a.g=0;a.l=!0;return hu(a,b).oa(function(){bo(this.f,b.Je,null,!0,b.vc)&&!Rt(d,this.b-1).length&&(this.f.h=this.w,c.b=!0,b.Cb=!0);return L(!0)}.bind(a))}
function ju(a,b){if(a.j||a.h)return L(!0);var c=b.B;a.l||(0>a.b?a.b=0:a.b++,a.g=0,a.l=!0);var d=a.L.f[a.b].b[a.g],e=kk(c).modify();e.M=!0;b.B=e;var f=I("startTableCell");fu(a,d.f.b)?(e=a.L.b.shift(),e=L(e.ue)):e=gn(a.f.j,c,b.Rc).oa(function(a){a.D&&c.D.removeChild(a.D);return L(new vk(gk(a)))});e.then(function(a){eu(this,d,c,a).then(function(){this.tc(b);this.g++;O(f,!0)}.bind(this))}.bind(a));return M(f)}
...
cu.prototype.tc=function(a){var b=a.B,c=b.display;"table-header-group"===c?this.j=!1:"table-footer-group"===c&&(this.h=!1);if(c&&du[c])b.D.parentNode.removeChild(b.D);else if(b.S===this.L.j)this.f.h=this.w,a.Cb=!0;else return rt.prototype.tc.call(this,a);return L(!0)};function ku(){}
...
function qu(a,b,c){var d=b.L;d.u=b.u;d.g=new tt(d.u);var e=I("TableLayoutProcessor.doInitialLayout");qt(new pt(new bu(b.L,c),c.j),b).then(function(a){var b=a.D,f=Xj(c.b,b);Tm(c,c.u?f.left:f.bottom)?(pu(d,b,c),au(d,c.b),a=d.g,b=c.b,a.f&&(a.F=ut(a,a.f,b)),a.b&&(a.C=ut(a,a.b,b)),O(e,null)):O(e,a)}.bind(a));return M(e)}function ru(a,b,c){var d=a.C;d.forEach(function(a,f){a&&(b.insertBefore(a.D,c),"top"===a.b&&(d[f]=null))})}
...
function uu(){}uu.prototype.g=function(a,b,c){a=b.L;var d=a.g,e=Yt(a,b),f=e.firstChild;ru(a,e,f);a.l&&e.insertBefore(a.l.cloneNode(!0),f);if(d.f&&!d.h){var g=d.f.cloneNode(!0);d.A.push(g);e.insertBefore(g,f)}d.b&&!d.g&&(g=d.b.cloneNode(!0),d.w.push(g),e.insertBefore(g,f));a=new cu(a,c);c=new pt(a,c.j);a=I("TableFormattingContext.doLayout");qt(c,b).Fa(a);return M(a)};
