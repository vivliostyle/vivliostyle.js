 ...
 *
 * Vivliostyle core 2016.2.0-pre.20160128123945
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function Gh(){var a=Hh;return new Fh(function(b){return a.sb(b)&&1==b.nodeType&&"http://www.idpf.org/2008/embedding"==b.getAttribute("Algorithm")})}function Ih(){var a=Gh(),b=Hh;return new Fh(function(c){if(!b.sb(c))return!1;c=new uh([c]);c=th(c,"EncryptionMethod");a&&(c=Jh(c,a));return 0<c.b.length})}var Hh=new Fh(function(){return!0});function uh(a){this.b=a}function Kh(a){return a.b}function Jh(a,b){for(var c=[],d=0;d<a.b.length;d++){var e=a.b[d];b.sb(e)&&c.push(e)}return new uh(c)}
function Lh(a,b){function c(a){d.push(a)}for(var d=[],e=0;e<a.b.length;e++)b(a.b[e],c);return new uh(d)}function Mh(a,b){for(var c=[],d=0;d<a.b.length;d++)c.push(b(a.b[d]));return c}function Nh(a,b){for(var c=[],d=0;d<a.b.length;d++){var e=b(a.b[d]);null!=e&&c.push(e)}return c}function th(a,b){return Lh(a,function(a,d){for(var e=a.firstChild;e;e=e.nextSibling)e.localName==b&&d(e)})}function Oh(a){return Lh(a,function(a,c){for(var d=a.firstChild;d;d=d.nextSibling)1==d.nodeType&&c(d)})}
...
function ci(a,b,c,d,e,f,g){this.Y=a;this.Kc=d;this.ed=null;this.root=b;this.Z=c;this.type=f;e&&(e.ed=this);this.b=g}function di(a,b){this.Gd=a;this.count=b}function ei(a,b,c){this.W=a;this.parent=b;this.da=c;this.aa=0;this.K=!1;this.La=0;this.ba=b?b.ba:null;this.na=this.ua=null;this.I=!1;this.d=!0;this.e=!1;this.h=b?b.h:0;this.w=this.j=this.M=null;this.A=b?b.A:0;this.k=b?b.k:!1;this.b=this.B=this.u=null;this.l=b?b.l:{};this.g=b?b.g:!1;this.D=b?b.D:"ltr";this.f=b?b.f:null}
function fi(a){a.d=!0;a.h=a.parent?a.parent.h:0;a.b=null;a.aa=0;a.K=!1;a.j=null;a.w=null;a.u=null;a.B=null;a.ua=null;a.k=a.parent?a.parent.k:!1;a.g=a.parent?a.parent.g:!1;a.ua=null}function gi(a){var b=new ei(a.W,a.parent,a.da);b.aa=a.aa;b.K=a.K;b.ua=a.ua;b.La=a.La;b.ba=a.ba;b.na=a.na;b.d=a.d;b.h=a.h;b.j=a.j;b.w=a.w;b.k=a.k;b.A=a.A;b.u=a.u;b.B=a.B;b.b=a.b;b.f=a.f;b.g=a.g;b.e=a.e;return b}ei.prototype.modify=function(){return this.I?gi(this):this};
function hi(a){var b=a;do{if(b.I)break;b.I=!0;b=b.parent}while(b);return a}ei.prototype.clone=function(){for(var a=gi(this),b=a,c;null!=(c=b.parent);)c=gi(c),b=b.parent=c;return a};function ii(a){return{ea:a.W,La:a.La,ba:a.ba,ua:a.ua,na:a.na?ii(a.na):null}}function ji(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(ii(b)),b=b.parent;while(b);return{ha:c,aa:a.aa,K:a.K}}function ki(a){this.Qa=a;this.b=this.d=null}
...
ni.prototype.clone=function(){var a=new ni;a.d=this.d;a.f=this.f;a.e=this.e;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b].clone();return a};function oi(a){this.d=a;this.B=this.A=this.height=this.width=this.w=this.k=this.D=this.j=this.va=this.ca=this.Fa=this.$=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.Sb=this.I=null;this.pa=this.Tb=this.Ga=this.Ub=this.e=0;this.b=!1}function pi(a){return a.marginTop+a.ca+a.k}
...
function X(){this.b=null}t(X,dj);X.prototype.apply=function(a){this.b.apply(a)};X.prototype.d=function(){return 0};X.prototype.e=function(){return!1};function hj(a){this.b=null;this.f=a}t(hj,X);hj.prototype.apply=function(a){0<=a.u.indexOf(this.f)&&this.b.apply(a)};hj.prototype.d=function(){return 10};hj.prototype.e=function(a){this.b&&ij(a.xa,this.f,this.b);return!0};function jj(a){this.b=null;this.id=a}t(jj,X);jj.prototype.apply=function(a){a.M!=this.id&&a.ca!=this.id||this.b.apply(a)};
jj.prototype.d=function(){return 11};jj.prototype.e=function(a){this.b&&ij(a.e,this.id,this.b);return!0};function kj(a){this.b=null;this.localName=a}t(kj,X);kj.prototype.apply=function(a){a.f==this.localName&&this.b.apply(a)};kj.prototype.d=function(){return 8};kj.prototype.e=function(a){this.b&&ij(a.Mb,this.localName,this.b);return!0};function lj(a,b){this.b=null;this.f=a;this.localName=b}t(lj,X);lj.prototype.apply=function(a){a.f==this.localName&&a.k==this.f&&this.b.apply(a)};lj.prototype.d=function(){return 8};
lj.prototype.e=function(a){if(this.b){var b=a.b[this.f];b||(b="ns"+a.g++ +":",a.b[this.f]=b);ij(a.f,b+this.localName,this.b)}return!0};function mj(a){this.b=null;this.f=a}t(mj,X);mj.prototype.apply=function(a){var b=a.e;if(b&&"a"==a.f){var c=b.getAttribute("href");c&&c.match(/^#/)&&(b=b.ownerDocument.getElementById(c.substring(1)))&&(b=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))&&b.match(this.f)&&this.b.apply(a)}};function nj(a){this.b=null;this.f=a}t(nj,X);
nj.prototype.apply=function(a){a.k==this.f&&this.b.apply(a)};function oj(a,b){this.b=null;this.f=a;this.name=b}t(oj,X);oj.prototype.apply=function(a){a.e&&a.e.hasAttributeNS(this.f,this.name)&&this.b.apply(a)};function pj(a,b,c){this.b=null;this.f=a;this.name=b;this.value=c}t(pj,X);pj.prototype.apply=function(a){a.e&&a.e.getAttributeNS(this.f,this.name)==this.value&&this.b.apply(a)};pj.prototype.d=function(){return"type"==this.name&&"http://www.idpf.org/2007/ops"==this.f?9:0};
pj.prototype.e=function(a){return"type"==this.name&&"http://www.idpf.org/2007/ops"==this.f?(this.b&&ij(a.d,this.value,this.b),!0):!1};function qj(a,b){this.b=null;this.f=a;this.name=b}t(qj,X);qj.prototype.apply=function(a){if(a.e){var b=a.e.getAttributeNS(this.f,this.name);b&&Ki[b]&&this.b.apply(a)}};qj.prototype.d=function(){return 0};qj.prototype.e=function(){return!1};function rj(a,b,c){this.b=null;this.h=a;this.name=b;this.f=c}t(rj,X);
rj.prototype.apply=function(a){if(a.e){var b=a.e.getAttributeNS(this.h,this.name);b&&b.match(this.f)&&this.b.apply(a)}};function sj(a){this.b=null;this.f=a}t(sj,X);sj.prototype.apply=function(a){a.lang.match(this.f)&&this.b.apply(a)};function tj(){this.b=null}t(tj,X);tj.prototype.apply=function(a){a.ma&&this.b.apply(a)};tj.prototype.d=function(){return 6};function uj(){this.b=null}t(uj,X);uj.prototype.apply=function(a){a.Fa&&this.b.apply(a)};uj.prototype.d=function(){return 12};
function vj(a){this.b=null;this.f=a}t(vj,X);vj.prototype.apply=function(a){a.pa===this.f&&this.b.apply(a)};vj.prototype.d=function(){return 5};function wj(a){this.b=null;this.J=a}t(wj,X);wj.prototype.apply=function(a){a.h[this.J]&&this.b.apply(a)};wj.prototype.d=function(){return 5};function xj(a){this.J=a}xj.prototype.b=function(){return this};xj.prototype.push=function(a,b){0==b&&yj(a,this.J);return!1};xj.prototype.pop=function(a,b){return 0==b?(a.h[this.J]--,!0):!1};function zj(a){this.J=a}
zj.prototype.b=function(){return this};zj.prototype.push=function(a,b){0==b?yj(a,this.J):1==b&&a.h[this.J]--;return!1};zj.prototype.pop=function(a,b){if(0==b)return a.h[this.J]--,!0;1==b&&yj(a,this.J);return!1};function Aj(a){this.J=a;this.d=!1}Aj.prototype.b=function(){return new Aj(this.J)};Aj.prototype.push=function(a){return this.d?(a.h[this.J]--,!0):!1};Aj.prototype.pop=function(a,b){if(this.d)return a.h[this.J]--,!0;0==b&&(this.d=!0,yj(a,this.J));return!1};
function Bj(a){this.J=a;this.d=!1}Bj.prototype.b=function(){return new Bj(this.J)};Bj.prototype.push=function(a,b){this.d&&(-1==b?yj(a,this.J):0==b&&a.h[this.J]--);return!1};Bj.prototype.pop=function(a,b){if(this.d){if(-1==b)return a.h[this.J]--,!0;0==b&&yj(a,this.J)}else 0==b&&(this.d=!0,yj(a,this.J));return!1};function Cj(a,b){this.e=a;this.d=b}Cj.prototype.b=function(){return this};Cj.prototype.push=function(){return!1};Cj.prototype.pop=function(a,b){return 0==b?(Dj(a,this.e,this.d),!0):!1};
function Ej(a){this.lang=a}Ej.prototype.b=function(){return this};Ej.prototype.push=function(){return!1};Ej.prototype.pop=function(a,b){return 0==b?(a.lang=this.lang,!0):!1};function Fj(a){this.d=a}Fj.prototype.b=function(){return this};Fj.prototype.push=function(){return!1};Fj.prototype.pop=function(a,b){return 0==b?(a.B=this.d,!0):!1};function Gj(a,b){this.b=a;this.d=b}t(Gj,hd);
Gj.prototype.ib=function(a){var b=this.b,c=b.B,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.l)];b.l++;break;case "close-quote":return 0<b.l&&b.l--,c[2*Math.min(d,b.l)+1];case "no-open-quote":return b.l++,new pd("");case "no-close-quote":return 0<b.l&&b.l--,new pd("")}return a};
var Hj={roman:[4999,1E3,"M",900,"CM",500,"D",400,"CD",100,"C",90,"XC",50,"L",40,"XL",10,"X",9,"IX",5,"V",4,"IV",1,"I"],armenian:[9999,9E3,"\u0584",8E3,"\u0583",7E3,"\u0582",6E3,"\u0581",5E3,"\u0580",4E3,"\u057f",3E3,"\u057e",2E3,"\u057d",1E3,"\u057c",900,"\u057b",800,"\u057a",700,"\u0579",600,"\u0578",500,"\u0577",400,"\u0576",300,"\u0575",200,"\u0574",100,"\u0573",90,"\u0572",80,"\u0571",70,"\u0570",60,"\u056f",50,"\u056e",40,"\u056d",30,"\u056c",20,"\u056b",10,"\u056a",9,"\u0569",8,"\u0568",7,"\u0567",
...
3,"\u10d2",2,"\u10d1",1,"\u10d0"],hebrew:[999,400,"\u05ea",300,"\u05e9",200,"\u05e8",100,"\u05e7",90,"\u05e6",80,"\u05e4",70,"\u05e2",60,"\u05e1",50,"\u05e0",40,"\u05de",30,"\u05dc",20,"\u05db",19,"\u05d9\u05d8",18,"\u05d9\u05d7",17,"\u05d9\u05d6",16,"\u05d8\u05d6",15,"\u05d8\u05d5",10,"\u05d9",9,"\u05d8",8,"\u05d7",7,"\u05d6",6,"\u05d5",5,"\u05d4",4,"\u05d3",3,"\u05d2",2,"\u05d1",1,"\u05d0"]},Ij={latin:"a-z",alpha:"a-z",greek:"\u03b1-\u03c1\u03c3-\u03c9",russian:"\u0430-\u0438\u043a-\u0449\u044d-\u044f"},
Jj={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},Kj={Zd:!1,Ab:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",bc:"\u5341\u767e\u5343",Dd:"\u8ca0"};
function Lj(a){if(9999<a||-9999>a)return""+a;if(0==a)return Kj.Ab.charAt(0);var b=new Qa;0>a&&(b.append(Kj.Dd),a=-a);if(10>a)b.append(Kj.Ab.charAt(a));else if(Kj.$d&&19>=a)b.append(Kj.bc.charAt(0)),0!=a&&b.append(Kj.bc.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(Kj.Ab.charAt(c)),b.append(Kj.bc.charAt(2)));if(c=Math.floor(a/100)%10)b.append(Kj.Ab.charAt(c)),b.append(Kj.bc.charAt(1));if(c=Math.floor(a/10)%10)b.append(Kj.Ab.charAt(c)),b.append(Kj.bc.charAt(0));(a%=10)&&b.append(Kj.Ab.charAt(a))}return b.toString()}
function Mj(a,b){var c=!1,d=!1,e;null!=(e=b.match(/^upper-(.*)/))?(c=!0,b=e[1]):null!=(e=b.match(/^lower-(.*)/))&&(d=!0,b=e[1]);e="";if(Hj[b])a:{e=Hj[b];var f=a;if(f>e[0]||0>=f||f!=Math.round(f))e="";else{for(var g="",k=1;k<e.length;k+=2){var h=e[k],l=Math.floor(f/h);if(20<l){e="";break a}for(f-=l*h;0<l;)g+=e[k+1],l--}e=g}}else if(Ij[b])if(e=a,0>=e||e!=Math.round(e))e="";else{g=Ij[b];f=[];for(k=0;k<g.length;)if("-"==g.substr(k+1,1))for(l=g.charCodeAt(k),h=g.charCodeAt(k+2),k+=3;l<=h;l++)f.push(String.fromCharCode(l));
else f.push(g.substr(k++,1));g="";do e--,k=e%f.length,g=f[k]+g,e=(e-k)/f.length;while(0<e);e=g}else null!=Jj[b]?e=Jj[b]:"decimal-leading-zero"==b?(e=a+"",1==e.length&&(e="0"+e)):"cjk-ideographic"==b||"trad-chinese-informal"==b?e=Lj(a):e=a+"";return c?e.toUpperCase():d?e.toLowerCase():e}
function Nj(a,b){var c=b[0].toString(),d=1<b.length?b[1].stringValue():"decimal",e=a.b.g[c];if(e&&e.length)return new pd(Mj(e&&e.length&&e[e.length-1]||0,d));c=new L(Oj(a.b.Ga,c,function(a){return Mj(a||0,d)}));return new id([c])}
function Pj(a,b){var c=b[0].toString(),d=b[1].stringValue(),e=2<b.length?b[2].stringValue():"decimal",f=a.b.g[c],g=new Qa;if(f&&f.length)for(var k=0;k<f.length;k++)0<k&&g.append(d),g.append(Mj(f[k],e));c=new L(Qj(a.b.Ga,c,function(a){var b=[];if(a.length)for(var c=0;c<a.length;c++)b.push(Mj(a[c],e));a=g.toString();a.length&&b.push(a);return b.length?b.join(d):Mj(0,e)}));return new id([c])}
Gj.prototype.ob=function(a){switch(a.name){case "attr":if(1==a.values.length)return new pd(this.d&&this.d.getAttribute(a.values[0].stringValue())||"");break;case "counter":if(2>=a.values.length)return Nj(this,a.values);break;case "counters":if(3>=a.values.length)return Pj(this,a.values)}u.b("E_CSS_CONTENT_PROP:",a.toString());return new pd("")};var Rj=1/1048576;function Sj(a,b){for(var c in a)b[c]=a[c].clone()}
function Tj(){this.g=0;this.b={};this.Mb={};this.f={};this.d={};this.xa={};this.e={};this.Fb={};this.N=0}Tj.prototype.clone=function(){var a=new Tj;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b];Sj(this.Mb,a.Mb);Sj(this.f,a.f);Sj(this.d,a.d);Sj(this.xa,a.xa);Sj(this.e,a.e);Sj(this.Fb,a.Fb);a.N=this.N;return a};function ij(a,b,c){var d=a[b];d&&(c=d.g(c));a[b]=c}
function Uj(a,b,c){this.j=a;this.d=b;this.Ga=c;this.b=[[],[]];this.h={};this.u=this.w=this.e=null;this.$=this.ca=this.M=this.k=this.f="";this.I=this.D=null;this.Fa=this.ma=!0;this.g={};this.A=[{}];this.B=[new pd("\u201c"),new pd("\u201d"),new pd("\u2018"),new pd("\u2019")];this.l=0;this.lang="";this.Ta=[0];this.pa=0;this.va=[]}function yj(a,b){a.h[b]=(a.h[b]||0)+1}function Vj(a,b,c){(b=b[c])&&b.apply(a)}var Wj=[];
function Xj(a,b,c,d){a.e=null;a.w=d;a.k="";a.f="";a.M="";a.ca="";a.u=b;a.$="";a.D=Wj;a.I=c;Yj(a)}function Zj(a,b,c){a.g[b]?a.g[b].push(c):a.g[b]=[c];c=a.A[a.A.length-1];c||(c={},a.A[a.A.length-1]=c);c[b]=!0}
function ak(a,b){var c=Md,d=b.display;d&&(c=d.evaluate(a.d));var e=null,d=null,f=b["counter-reset"];f&&(f=f.evaluate(a.d))&&(e=qg(f,!0));(f=b["counter-increment"])&&(f=f.evaluate(a.d))&&(d=qg(f,!1));"ol"!=a.f&&"ul"!=a.f||"http://www.w3.org/1999/xhtml"!=a.k||(e||(e={}),e["ua-list-item"]=0);c===Rd&&(d||(d={}),d["ua-list-item"]=1);if(e)for(var g in e)Zj(a,g,e[g]);if(d)for(var k in d)a.g[k]||Zj(a,k,0),g=a.g[k],g[g.length-1]+=d[k];c===Rd&&(c=a.g["ua-list-item"],b["ua-list-item-count"]=new V(new rd(c[c.length-
1]),0));a.A.push(null)}function bk(a){var b=a.A.pop();if(b)for(var c in b)(b=a.g[c])&&(1==b.length?delete a.g[c]:b.pop())}function Dj(a,b,c){ak(a,b);b.content&&(b.content=b.content.yc(new Gj(a,c)));bk(a)}var ck="before transclusion-before footnote-call footnote-marker inner first-letter first-line  transclusion-after after".split(" ");
function dk(a,b,c){a.va.push(b);a.I=null;a.e=b;a.w=c;a.k=b.namespaceURI;a.f=b.localName;var d=a.j.b[a.k];a.$=d?d+a.f:"";a.M=b.getAttribute("id");a.ca=b.getAttributeNS("http://www.w3.org/XML/1998/namespace","id");(d=b.getAttribute("class"))?a.u=d.split(/\s+/):a.u=Wj;(d=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))?a.D=d.split(/\s+/):a.D=Wj;"style"==a.f&&"http://www.gribuser.ru/xml/fictionbook/2.0"==a.k&&(a.u=[b.getAttribute("name")||""]);(d=b.getAttributeNS("http://www.w3.org/XML/1998/namespace",
"lang"))||"http://www.w3.org/1999/xhtml"!=a.k||(d=b.getAttribute("lang"));d&&(a.b[a.b.length-1].push(new Ej(a.lang)),a.lang=d.toLowerCase());d=a.Ta;a.pa=++d[d.length-1];d.push([0]);Yj(a);d=c.quotes;c=null;d&&(d=d.evaluate(a.d))&&(c=new Fj(a.B),d===Td?a.B=[new pd(""),new pd("")]:d instanceof id&&(a.B=d.values));ak(a,a.w);if(d=a.w._pseudos)for(var e=!0,f=0;f<ck.length;f++){var g=ck[f];g||(e=!1);(g=d[g])&&(e?Dj(a,g,b):a.b[a.b.length-2].push(new Cj(g,b)))}c&&a.b[a.b.length-2].push(c)}
function Yj(a){var b;for(b=0;b<a.u.length;b++)Vj(a,a.j.xa,a.u[b]);for(b=0;b<a.D.length;b++)Vj(a,a.j.d,a.D[b]);Vj(a,a.j.e,a.M);Vj(a,a.j.Mb,a.f);""!=a.f&&Vj(a,a.j.Mb,"*");Vj(a,a.j.f,a.$);null!==a.I&&(Vj(a,a.j.Fb,a.I),Vj(a,a.j.Fb,"*"));a.e=null;a.b.push([]);for(var c=1;-1<=c;--c){var d=a.b[a.b.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.ma=!0;a.Fa=!1}
Uj.prototype.pop=function(){for(var a=1;-1<=a;--a)for(var b=this.b[this.b.length-a-2],c=0;c<b.length;)b[c].pop(this,a)?b.splice(c,1):c++;this.b.pop();this.ma=!1};var ek=null;function fk(a,b,c,d,e,f,g){Gf.call(this,a,b,g);this.b=null;this.d=0;this.k=null;this.w=0;this.g=null;this.l=!1;this.J=c;this.h=d?d.h:ek?ek.clone():new Tj;this.B=e;this.u=f;this.j=0}t(fk,Hf);m=fk.prototype;m.nd=function(a){ij(this.h.Mb,"*",a)};
function gk(a,b){var c=a.b;if(0<c.length){c.sort(function(a,b){return b.d()-a.d()});for(var d=null,e=c.length-1;0<=e;e--)d=c[e],d.b=b,b=d;if(d.e(a.h))return}a.nd(b)}m.$a=function(a,b){if(b||a)this.d+=1,b&&a?this.b.push(new lj(a,b.toLowerCase())):b?this.b.push(new kj(b.toLowerCase())):this.b.push(new nj(a))};m.wc=function(a){this.g?(u.b("::"+this.g,"followed by ."+a),this.b.push(new wj(""))):(this.d+=256,this.b.push(new hj(a)))};
m.Gb=function(a,b){if(this.g)u.b("::"+this.g,"followed by :"+a),this.b.push(new wj(""));else{switch(a.toLowerCase()){case "first-child":this.b.push(new tj);break;case "root":this.b.push(new uj);break;case "link":this.b.push(new kj("a"));this.b.push(new oj("","href"));break;case "-adapt-href-epub-type":case "href-epub-type":if(b&&1==b.length&&"string"==typeof b[0]){var c=new RegExp("(^|s)"+va(b[0])+"($|s)");this.b.push(new mj(c))}else this.b.push(new wj(""));break;case "-adapt-footnote-content":case "footnote-content":this.l=
!0;break;case "visited":case "active":case "hover":case "focus":this.b.push(new wj(""));break;case "lang":b&&1==b.length&&"string"==typeof b[0]?this.b.push(new sj(new RegExp("^"+va(b[0].toLowerCase())+"($|-)"))):this.b.push(new wj(""));break;case "nth-child":b&&1==b.length&&"number"==typeof b[0]?this.b.push(new vj(b[0])):this.b.push(new wj(""));break;case "before":case "after":case "first-line":case "first-letter":this.Hb(a,b);return;default:u.b("unknown pseudo-class selector: "+a),this.b.push(new wj(""))}this.d+=
256}};
m.Hb=function(a,b){switch(a){case "before":case "after":case "first-line":case "first-letter":case "footnote-call":case "footnote-marker":case "inner":this.g?(u.b("Double pseudoelement ::"+this.g+"::"+a),this.b.push(new wj(""))):this.g=a;break;case "first-n-lines":if(b&&1==b.length&&"number"==typeof b[0]){var c=Math.round(b[0]);if(0<c&&c==b[0]){this.g?(u.b("Double pseudoelement ::"+this.g+"::"+a),this.b.push(new wj(""))):this.g="first-"+c+"-lines";break}}default:u.b("Unrecognized pseudoelement: ::"+a),
this.b.push(new wj(""))}this.d+=1};m.Cc=function(a){this.d+=65536;this.b.push(new jj(a))};
...
m.bb=function(){var a="d"+this.w++;gk(this,new fj(new xj(a)));this.b=[new wj(a)]};m.vc=function(){var a="c"+this.w++;gk(this,new fj(new zj(a)));this.b=[new wj(a)]};m.tc=function(){var a="a"+this.w++;gk(this,new fj(new Aj(a)));this.b=[new wj(a)]};m.zc=function(){var a="f"+this.w++;gk(this,new fj(new Bj(a)));this.b=[new wj(a)]};m.Hc=function(){hk(this);this.g=null;this.l=!1;this.d=0;this.b=[]};
m.hb=function(){var a;0!=this.j?(Jf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.j=1,this.k={},this.g=null,this.d=0,this.l=!1,this.b=[])};m.error=function(a,b){Hf.prototype.error.call(this,a,b);1==this.j&&(this.j=0)};m.vb=function(a){Hf.prototype.vb.call(this,a);this.j=0};m.la=function(){hk(this);Hf.prototype.la.call(this);1==this.j&&(this.j=0)};m.Ua=function(){Hf.prototype.Ua.call(this)};function hk(a){if(a.b){var b=a.d,c;c=a.h;c=c.N+=Rj;gk(a,a.pd(b+c));a.b=null;a.g=null;a.l=!1;a.d=0}}
...
m.gb=function(a,b,c){"display"!=a||b!==Wd&&b!==Vd||(this.gb("flow-options",new id([Gd,be]),c),this.gb("flow-into",b,c),b=Bd);(Hi.SIMPLE_PROPERTY||[]).forEach(function(d){d=d({name:a,value:b,important:c});a=d.name;b=d.value;c=d.important});var d=c?Cf(this):Df(this);Yi(this.k,a,this.J?new Ui(b,d,this.J):new V(b,d))};function ik(a,b){Gf.call(this,a,b,!1)}t(ik,Hf);
ik.prototype.Ka=function(a,b){if(this.e.values[a])this.error("E_CSS_NAME_REDEFINED "+a,this.Cb());else{var c=a.match(/height|^(top|bottom)$/)?"vh":"vw",c=new Wc(this.e,100,c),c=b.fa(this.e,c);this.e.values[a]=c}};function jk(a,b,c,d,e){Gf.call(this,a,b,!1);this.b=d;this.J=c;this.d=e}t(jk,Hf);jk.prototype.Ka=function(a,b,c){c?u.b("E_IMPORTANT_NOT_ALLOWED"):eh(this.d,a,b,c,this)};jk.prototype.Db=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};
jk.prototype.mc=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};jk.prototype.gb=function(a,b,c){c=c?Cf(this):Df(this);c+=this.N;this.N+=Rj;Yi(this.b,a,this.J?new Ui(b,c,this.J):new V(b,c))};function kk(a,b){cg.call(this,a);this.b={};this.d=b;this.N=0}t(kk,cg);kk.prototype.Ka=function(a,b,c){eh(this.d,a,b,c,this)};kk.prototype.Db=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};kk.prototype.mc=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};
kk.prototype.gb=function(a,b,c){c=(c?67108864:50331648)+this.N;this.N+=Rj;Yi(this.b,a,new V(b,c))};var lk=new yf(function(){var a=M("uaStylesheetBase");wf(fh).then(function(b){var c=ta("user-agent-base.css",sa);b=new fk(null,null,null,null,null,b,!0);b.vb("UA");ek=b.h;fg(c,b,null,null).oa(a)});return O(a)},"uaStylesheetBaseFetcher");function mk(a,b,c){return(a=a["writing-mode"])&&(b=a.evaluate(b,"writing-mode"))&&b!==Ld?b===he:c}
function nk(a,b,c,d){var e={},f;for(f in a)Xi(f)&&(e[f]=a[f]);a=a._regions;if((c||d)&&a)for(d&&(d=["footnote"],c=c?c.concat(d):d),d=0;d<c.length;d++){f=a[c[d]];for(var g in f)Xi(g)&&(e[g]=Vi(b,e[g],f[g]))}return e}function ok(a,b,c,d){c=c?Si:Ti;for(var e in a)if(a.hasOwnProperty(e)){var f=a[e];if(f){var g=c[e];if(g){var k=a[g];if(k&&k.Ea>f.Ea)continue;g=Ni[g]?g:e}else g=e;b[g]=d(e,f)}}};function pk(a,b,c){this.e=a;this.d=b;this.b=c}function qk(){this.map=[]}function rk(a){return 0==a.map.length?0:a.map[a.map.length-1].b}function sk(a,b){if(0==a.map.length)a.map.push(new pk(b,b,b));else{var c=a.map[a.map.length-1],d=c.b+b-c.d;c.d==c.e?(c.d=b,c.e=b,c.b=d):a.map.push(new pk(b,b,d))}}function tk(a,b){0==a.map.length?a.map.push(new pk(b,0,0)):a.map[a.map.length-1].d=b}function uk(a,b){var c=Ya(a.map.length,function(c){return b<=a.map[c].d}),c=a.map[c];return c.b-Math.max(0,c.e-b)}
function vk(a,b){var c=Ya(a.map.length,function(c){return b<=a.map[c].b}),c=a.map[c];return c.e-(c.b-b)}
function wk(a,b,c,d,e,f,g){this.Z=a;this.root=a.root;this.ca=c;this.f=d;this.h=f;this.d=this.root;this.u={};this.w={};this.B=[];this.l=this.k=null;this.A=new Uj(b,d,g);this.e=new qk;this.Qa=!0;this.D=[];this.$=e;this.M=this.I=!1;this.b=a=vh(a,this.root);sk(this.e,a);b=xk(this,this.root);dk(this.A,this.root,b);yk(this,b,!1);this.j=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.j=!1}this.D.push(!0);this.w={};this.w["e"+a]=
b;this.b++;zk(this,-1)}function Ak(a,b,c,d){return(b=b[d])&&b.evaluate(a.f)!==c[d]}function Bk(a,b,c){for(var d in c){var e=b[d];e?(a.u[d]=e,delete b[d]):(e=c[d])&&(a.u[d]=new V(e,33554432))}}var Ck=["column-count","column-width"];
function yk(a,b,c){c||["writing-mode","direction"].forEach(function(a){b[a]&&(this.u[a]=b[a])},a);if(!a.I){c=Ak(a,b,a.h.g,"background-color")?b["background-color"].evaluate(a.f):null;var d=Ak(a,b,a.h.g,"background-image")?b["background-image"].evaluate(a.f):null;if(c&&c!==Ld||d&&d!==Ld)Bk(a,b,a.h.g),a.I=!0}if(!a.M)for(c=0;c<Ck.length;c++)if(Ak(a,b,a.h.j,Ck[c])){Bk(a,b,a.h.j);a.M=!0;break}if(c=b["font-size"]){d=c.evaluate(a.f);c=d.C;switch(d.ia){case "em":case "rem":c*=a.f.h;break;case "ex":case "rex":c*=
a.f.h*rc.ex/rc.em;break;case "%":c*=a.f.h/100;break;default:(d=rc[d.ia])&&(c*=d)}a.f.ca=c}}function xk(a,b){if(b.style instanceof CSSStyleDeclaration){var c=b.getAttribute("style");if(c){var d=a.Z.url,e=new kk(a.ca,a.h),c=new bc(c,e);try{bg(new Uf(Lf,c,e,d),Number.POSITIVE_INFINITY,!1,!0,!1)}catch(f){u.b(f,"Style attribute parse error:")}return e.b}}return{}}
function zk(a,b){if(!(b>=a.b)){var c=a.f,d=vh(a.Z,a.root);if(b<d){var e=a.g(a.root,!1),f=e["flow-into"],f=f?f.evaluate(c,"flow-into").toString():"body";Dk(a,f,e,a.root,d)}d=yh(a.Z,b);e=wh(a.Z,d,0,!1);if(!(e>=a.b))for(;;){if(1!=d.nodeType)e+=d.textContent.length;else{var g=d;if(e!=vh(a.Z,g))throw Error("Inconsistent offset");var k=a.g(g,!1);if(f=k["flow-into"])f=f.evaluate(c,"flow-into").toString(),Dk(a,f,k,g,e);e++}if(e>=a.b)break;f=d.firstChild;if(null==f)for(;!(f=d.nextSibling);)if(d=d.parentNode,
d===a.root)return;d=f}}}function Dk(a,b,c,d,e){var f=0,g=Number.POSITIVE_INFINITY,k=!1,h=!1,l=!1,n=c["flow-options"];if(n){var p;a:{if(k=n.evaluate(a.f,"flow-options")){h=new kg;try{k.R(h);p=h.b;break a}catch(q){u.b(q,"toSet:")}}p={}}k=!!p.exclusive;h=!!p["static"];l=!!p.last}(p=c["flow-linger"])&&(g=mg(p.evaluate(a.f,"flow-linger"),Number.POSITIVE_INFINITY));(c=c["flow-priority"])&&(f=mg(c.evaluate(a.f,"flow-priority"),0));d=new Zh(b,d,e,f,g,k,h,l);a.B.push(d);a.l==b&&(a.l=null);a.k&&Ek(a.k,d)}
function Fk(a,b,c){var d=-1;if(b<=a.b&&(d=uk(a.e,b),d+=c,d<rk(a.e)))return vk(a.e,d);if(null==a.d)return Number.POSITIVE_INFINITY;for(var e=a.f;;){var f=a.d.firstChild;if(null==f)for(;;){if(1==a.d.nodeType){var f=a.A,g=a.d;if(f.va.pop()!==g)throw Error("Invalid call to popElement");f.Ta.pop();f.pop();bk(f);a.Qa=a.D.pop()}if(f=a.d.nextSibling)break;a.d=a.d.parentNode;if(a.d===a.root)return a.d=null,b<a.b&&(0>d&&(d=uk(a.e,b),d+=c),d<=rk(a.e))?vk(a.e,d):Number.POSITIVE_INFINITY}a.d=f;if(1!=a.d.nodeType)a.b+=
a.d.textContent.length,a.Qa?sk(a.e,a.b):tk(a.e,a.b);else{g=a.d;f=xk(a,g);a.D.push(a.Qa);dk(a.A,g,f);a.j||"body"!=g.localName||g.parentNode!=a.root||(yk(a,f,!0),a.j=!0);var k=f["flow-into"];k&&(k=k.evaluate(e,"flow-into").toString(),Dk(a,k,f,g,a.b),a.Qa=!!a.$[k]);a.Qa&&(g=f.display)&&g.evaluate(e,"display")===Td&&(a.Qa=!1);if(vh(a.Z,a.d)!=a.b)throw Error("Inconsistent offset");a.w["e"+a.b]=f;a.b++;a.Qa?sk(a.e,a.b):tk(a.e,a.b);if(b<a.b&&(0>d&&(d=uk(a.e,b),d+=c),d<=rk(a.e)))return vk(a.e,d)}}}
wk.prototype.g=function(a,b){var c=vh(this.Z,a),d="e"+c;b&&(c=wh(this.Z,a,0,!0));this.b<=c&&Fk(this,c,0);return this.w[d]};var Gk=1;function Hk(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.h=0;this.d=a;this.name=b;this.fb=c;this.xa=d;this.parent=e;this.g="p"+Gk++;e&&(this.h=e.children.length,e.children.push(this))}Hk.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Hk.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Ik(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
function Mk(a,b){for(var c=0;c<a.children.length;c++)a.children[c].clone({parent:b})}function Nk(a){Hk.call(this,a,null,null,[],null);this.b.width=new V(le,0);this.b.height=new V(me,0)}t(Nk,Hk);
function Ok(a,b){this.e=b;var c=this;mc.call(this,a,function(a,b){var f=a.match(/^([^.]+)\.([^.]+)$/);if(f){var g=c.e.k[f[1]];if(g&&(g=this.pa[g])){if(b){var f=f[2],k=g.ca[f];if(k)g=k;else{switch(f){case "columns":var k=g.d.d,h=new bd(k,0),l=Pk(g,"column-count"),n=Pk(g,"column-width"),p=Pk(g,"column-gap"),k=G(k,dd(k,new Zc(k,"min",[h,l]),E(k,n,p)),p)}k&&(g.ca[f]=k);g=k}}else g=Pk(g,f[2]);return g}}return null})}t(Ok,mc);
function Qk(a,b,c,d,e,f,g){a=a instanceof Ok?a:new Ok(a,this);Hk.call(this,a,b,c,d,e);this.e=this;this.J=f;this.j=g;this.b.width=new V(le,0);this.b.height=new V(me,0);this.b["wrap-flow"]=new V(Ad,0);this.b.position=new V(Yd,0);this.b.overflow=new V(Jd,0);this.k={}}t(Qk,Hk);Qk.prototype.f=function(a){return new Rk(a,this)};Qk.prototype.clone=function(a){a=new Qk(this.d,this.name,a.fb||this.fb,this.xa,this.parent,this.J,this.j);Ik(this,a);Mk(this,a);return a};
function Sk(a,b,c,d,e){Hk.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.k[b]=this.g);this.b["wrap-flow"]=new V(Ad,0)}t(Sk,Hk);Sk.prototype.f=function(a){return new Tk(a,this)};Sk.prototype.clone=function(a){a=new Sk(a.parent.d,this.name,this.fb,this.xa,a.parent);Ik(this,a);Mk(this,a);return a};function Uk(a,b,c,d,e){Hk.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.k[b]=this.g)}t(Uk,Hk);Uk.prototype.f=function(a){return new Vk(a,this)};
Uk.prototype.clone=function(a){a=new Uk(a.parent.d,this.name,this.fb,this.xa,a.parent);Ik(this,a);Mk(this,a);return a};function Y(a,b,c){return b&&b!==Ad?b.fa(a,c):null}function Wk(a,b,c){return b&&b!==Ad?b.fa(a,c):a.b}function Xk(a,b,c){return b?b===Ad?null:b.fa(a,c):a.b}function Yk(a,b,c,d){return b&&c!==Td?b.fa(a,d):a.b}function Zk(a,b,c){return b?b===je?a.g:b===Hd?a.f:b.fa(a,a.b):c}
function $k(a,b){this.e=a;this.d=b;this.B={};this.style={};this.k=this.l=null;this.children=[];this.D=this.I=this.f=this.g=!1;this.w=this.A=0;this.u=null;this.ma={};this.ca={};this.va=this.b=!1;a&&a.children.push(this)}function al(a,b,c){b=Pk(a,b);c=Pk(a,c);if(!b||!c)throw Error("E_INTERNAL");return E(a.d.d,b,c)}
function Pk(a,b){var c=a.ma[b];if(c)return c;var d=a.style[b];d&&(c=d.fa(a.d.d,a.d.d.b));switch(b){case "margin-left-edge":c=Pk(a,"left");break;case "margin-top-edge":c=Pk(a,"top");break;case "margin-right-edge":c=al(a,"border-right-edge","margin-right");break;case "margin-bottom-edge":c=al(a,"border-bottom-edge","margin-bottom");break;case "border-left-edge":c=al(a,"margin-left-edge","margin-left");break;case "border-top-edge":c=al(a,"margin-top-edge","margin-top");break;case "border-right-edge":c=
al(a,"padding-right-edge","border-right-width");break;case "border-bottom-edge":c=al(a,"padding-bottom-edge","border-bottom-width");break;case "padding-left-edge":c=al(a,"border-left-edge","border-left-width");break;case "padding-top-edge":c=al(a,"border-top-edge","border-top-width");break;case "padding-right-edge":c=al(a,"right-edge","padding-right");break;case "padding-bottom-edge":c=al(a,"bottom-edge","padding-bottom");break;case "left-edge":c=al(a,"padding-left-edge","padding-left");break;case "top-edge":c=
al(a,"padding-top-edge","padding-top");break;case "right-edge":c=al(a,"left-edge","width");break;case "bottom-edge":c=al(a,"top-edge","height")}if(!c){if("extent"==b)d=a.b?"width":"height";else if("measure"==b)d=a.b?"height":"width";else{var e=a.b?Si:Ti,d=b,f;for(f in e)d=d.replace(f,e[f])}d!=b&&(c=Pk(a,d))}c&&(a.ma[b]=c);return c}
function bl(a){var b=a.d.d,c=a.style,d=Zk(b,c.enabled,b.g),e=Y(b,c.page,b.b);if(e)var f=new Xc(b,"page-number"),d=cd(b,d,new Pc(b,e,f));(e=Y(b,c["min-page-width"],b.b))&&(d=cd(b,d,new Oc(b,new Xc(b,"page-width"),e)));(e=Y(b,c["min-page-height"],b.b))&&(d=cd(b,d,new Oc(b,new Xc(b,"page-height"),e)));d=a.M(d);c.enabled=new L(d)}$k.prototype.M=function(a){return a};
$k.prototype.Dc=function(){var a=this.d.d,b=this.style,c=this.e?this.e.style.width.fa(a,null):null,d=Y(a,b.left,c),e=Y(a,b["margin-left"],c),f=Yk(a,b["border-left-width"],b["border-left-style"],c),g=Wk(a,b["padding-left"],c),k=Y(a,b.width,c),h=Y(a,b["max-width"],c),l=Wk(a,b["padding-right"],c),n=Yk(a,b["border-right-width"],b["border-right-style"],c),p=Y(a,b["margin-right"],c),q=Y(a,b.right,c),r=E(a,f,g),v=E(a,f,l);d&&q&&k?(r=G(a,c,E(a,k,E(a,E(a,d,r),v))),e?p?q=G(a,r,p):p=G(a,r,E(a,q,e)):(r=G(a,r,
q),p?e=G(a,r,p):p=e=dd(a,r,new B(a,.5)))):(e||(e=a.b),p||(p=a.b),d||q||k||(d=a.b),d||k?d||q?k||q||(k=this.l,this.g=!0):d=a.b:(k=this.l,this.g=!0),r=G(a,c,E(a,E(a,e,r),E(a,p,v))),this.g&&(h||(h=G(a,r,d?d:q)),this.b||!Y(a,b["column-width"],null)&&!Y(a,b["column-count"],null)||(k=h,this.g=!1)),d?k?q||(q=G(a,r,E(a,d,k))):k=G(a,r,E(a,d,q)):d=G(a,r,E(a,q,k)));a=Wk(a,b["snap-width"]||(this.e?this.e.style["snap-width"]:null),c);b.left=new L(d);b["margin-left"]=new L(e);b["border-left-width"]=new L(f);b["padding-left"]=
...
$k.prototype.Ec=function(){var a=this.d.d,b=this.style,c=this.e?this.e.style.width.fa(a,null):null,d=this.e?this.e.style.height.fa(a,null):null,e=Y(a,b.top,d),f=Y(a,b["margin-top"],c),g=Yk(a,b["border-top-width"],b["border-top-style"],c),k=Wk(a,b["padding-top"],c),h=Y(a,b.height,d),l=Y(a,b["max-height"],d),n=Wk(a,b["padding-bottom"],c),p=Yk(a,b["border-bottom-width"],b["border-bottom-style"],c),q=Y(a,b["margin-bottom"],c),r=Y(a,b.bottom,d),v=E(a,g,k),y=E(a,p,n);e&&r&&h?(d=G(a,d,E(a,h,E(a,E(a,e,v),
y))),f?q?r=G(a,d,f):q=G(a,d,E(a,r,f)):(d=G(a,d,r),q?f=G(a,d,q):q=f=dd(a,d,new B(a,.5)))):(f||(f=a.b),q||(q=a.b),e||r||h||(e=a.b),e||h?e||r?h||r||(h=this.k,this.f=!0):e=a.b:(h=this.k,this.f=!0),d=G(a,d,E(a,E(a,f,v),E(a,q,y))),this.f&&(l||(l=G(a,d,e?e:r)),this.b&&(Y(a,b["column-width"],null)||Y(a,b["column-count"],null))&&(h=l,this.f=!1)),e?h?r||(r=G(a,d,E(a,e,h))):h=G(a,d,E(a,r,e)):e=G(a,d,E(a,r,h)));a=Wk(a,b["snap-height"]||(this.e?this.e.style["snap-height"]:null),c);b.top=new L(e);b["margin-top"]=
...
function cl(a){var b=a.d.d,c=a.style;a=Y(b,c[a.b?"height":"width"],null);var d=Y(b,c["column-width"],a),e=Y(b,c["column-count"],null),f;(f=(f=c["column-gap"])&&f!==Ud?f.fa(b,null):null)||(f=new Wc(b,1,"em"));d&&!e&&(e=new Zc(b,"floor",[ed(b,E(b,a,f),E(b,d,f))]),e=new Zc(b,"max",[b.d,e]));e||(e=b.d);d=G(b,ed(b,E(b,a,f),e),f);c["column-width"]=new L(d);c["column-count"]=new L(e);c["column-gap"]=new L(f)}function dl(a,b,c,d){a=a.style[b].fa(a.d.d,null);return zc(a,c,d,{})}
function el(a,b){b.pa[a.d.g]=a;var c=a.d.d,d=a.style,e=a.e?fl(a.e,b):null,e=nk(a.B,b,e,!1);a.b=mk(e,b,a.e?a.e.b:!1);ok(e,d,a.b,function(a,b){return b.value});a.l=new oc(c,function(){return a.A},"autoWidth");a.k=new oc(c,function(){return a.w},"autoHeight");a.Dc();a.Ec();cl(a);bl(a)}function gl(a,b,c){(a=a.style[c])&&(a=jg(b,a,c));return a}function Z(a,b,c){(a=a.style[c])&&(a=jg(b,a,c));return wd(a,b)}
function fl(a,b){var c;a:{if(c=a.B["region-id"]){for(var d=[],e=0;e<c.length;e++){var f=c[e].evaluate(b,"");f&&f!==H&&d.push(f)}if(d.length){c=d;break a}}c=null}if(c){d=[];for(e=0;e<c.length;e++)d[e]=c[e].toString();return d}return null}function hl(a,b,c,d,e){if(a=gl(a,b,d))a.ac()&&sc(a.ia)&&(a=new K(wd(a,b),"px")),"font-family"===d&&(a=mh(e,a)),w(c.d,d,a.toString())}
function il(a,b,c){var d=Z(a,b,"left"),e=Z(a,b,"margin-left"),f=Z(a,b,"padding-left"),g=Z(a,b,"border-left-width");a=Z(a,b,"width");vi(c,d,a);w(c.d,"margin-left",e+"px");w(c.d,"padding-left",f+"px");w(c.d,"border-left-width",g+"px");c.marginLeft=e;c.$=g;c.j=f}
function jl(a,b,c){var d=Z(a,b,"right"),e=Z(a,b,"snap-height"),f=Z(a,b,"margin-right"),g=Z(a,b,"padding-right");b=Z(a,b,"border-right-width");w(c.d,"margin-right",f+"px");w(c.d,"padding-right",g+"px");w(c.d,"border-right-width",b+"px");c.marginRight=f;c.Fa=b;a.b&&0<e&&(a=d+si(c),a=a-Math.floor(a/e)*e,0<a&&(c.Tb=e-a,g+=c.Tb));c.D=g;c.Ub=e}
function kl(a,b,c){var d=Z(a,b,"snap-height"),e=Z(a,b,"top"),f=Z(a,b,"margin-top"),g=Z(a,b,"padding-top");b=Z(a,b,"border-top-width");c.top=e;c.marginTop=f;c.ca=b;c.Ga=d;!a.b&&0<d&&(a=e+pi(c),a=a-Math.floor(a/d)*d,0<a&&(c.pa=d-a,g+=c.pa));c.k=g;w(c.d,"top",e+"px");w(c.d,"margin-top",f+"px");w(c.d,"padding-top",g+"px");w(c.d,"border-top-width",b+"px")}
function ll(a,b,c){var d=Z(a,b,"margin-bottom"),e=Z(a,b,"padding-bottom"),f=Z(a,b,"border-bottom-width");a=Z(a,b,"height")-c.pa;w(c.d,"height",a+"px");w(c.d,"margin-bottom",d+"px");w(c.d,"padding-bottom",e+"px");w(c.d,"border-bottom-width",f+"px");c.height=a-c.pa;c.marginBottom=d;c.va=f;c.w=e}function ml(a,b,c){a.b?(kl(a,b,c),ll(a,b,c)):(jl(a,b,c),il(a,b,c))}
function nl(a,b,c){w(c.d,"border-top-width","0px");var d=Z(a,b,"max-height");a.I?ui(c,0,d):(kl(a,b,c),d-=c.pa,c.height=d,w(c.d,"height",d+"px"))}function ol(a,b,c){w(c.d,"border-left-width","0px");var d=Z(a,b,"max-width");a.D?vi(c,0,d):(jl(a,b,c),d-=c.Tb,c.width=d,a=Z(a,b,"right"),w(c.d,"right",a+"px"),w(c.d,"width",d+"px"))}
var pl="border-left-style border-right-style border-top-style border-bottom-style border-left-color border-right-color border-top-color border-bottom-color outline-style outline-color outline-width overflow visibility".split(" "),ql="border-top-left-radius border-top-right-radius border-bottom-right-radius border-bottom-left-radius border-image-source border-image-slice border-image-width border-image-outset border-image-repeat background-attachment background-color background-image background-repeat background-position background-clip background-origin background-size opacity z-index".split(" "),
rl="color font-family font-size font-style font-weight font-variant line-height letter-spacing text-align text-decoration text-indent text-transform white-space word-spacing".split(" "),sl=["transform","transform-origin"];
$k.prototype.eb=function(a,b,c,d){this.e&&this.b==this.e.b||w(b.d,"writing-mode",this.b?"vertical-rl":"horizontal-tb");(this.b?this.g:this.f)?this.b?ol(this,a,b):nl(this,a,b):(this.b?jl(this,a,b):kl(this,a,b),this.b?il(this,a,b):ll(this,a,b));(this.b?this.f:this.g)?this.b?nl(this,a,b):ol(this,a,b):ml(this,a,b);for(c=0;c<pl.length;c++)hl(this,a,b,pl[c],d)};function tl(a,b,c,d){for(var e=0;e<rl.length;e++)hl(a,b,c,rl[e],d)}
$k.prototype.Zb=function(a,b,c,d,e,f,g){this.b?this.A=b.e+b.Tb:this.w=b.e+b.pa;f=(this.b||!d)&&this.f;var k=(!this.b||!d)&&this.g,h=null;if(k||f)k&&w(b.d,"width","auto"),f&&w(b.d,"height","auto"),h=(d?d.d:b.d).getBoundingClientRect(),k&&(this.A=Math.ceil(h.right-h.left-b.j-b.$-b.D-b.Fa),this.b&&(this.A+=b.Tb)),f&&(this.w=h.bottom-h.top-b.k-b.ca-b.w-b.va,this.b||(this.w+=b.pa));(this.b?this.f:this.g)&&ml(this,a,b);if(this.b?this.g:this.f){if(this.b?this.D:this.I)this.b?jl(this,a,b):kl(this,a,b);this.b?
il(this,a,b):ll(this,a,b)}if(1<e&&(f=Z(this,a,"column-rule-width"),k=gl(this,a,"column-rule-style"),h=gl(this,a,"column-rule-color"),0<f&&k&&k!=Td&&h!=fe)){var l=Z(this,a,"column-gap"),n=this.b?b.height:b.width,p=this.b?"border-top":"border-left";for(d=1;d<e;d++){var q=(n+l)*d/e-l/2+b.j-f/2,r=b.height+b.k+b.w,v=b.d.ownerDocument.createElement("div");w(v,"position","absolute");w(v,this.b?"left":"top","0px");w(v,this.b?"top":"left",q+"px");w(v,this.b?"height":"width","0px");w(v,this.b?"width":"height",
r+"px");w(v,p,f+"px "+k.toString()+(h?" "+h.toString():""));b.d.insertBefore(v,b.d.firstChild)}}for(d=0;d<ql.length;d++)hl(this,a,b,ql[d],g);for(d=0;d<sl.length;d++)e=b,g=sl[d],f=c.g,(k=gl(this,a,g))&&f.push(new Rh(e.d,g,k))};
$k.prototype.h=function(a,b){var c=this.B,d=this.d.b,e;for(e in d)Xi(e)&&Yi(c,e,d[e]);if("background-host"==this.d.fb)for(e in b)if(e.match(/^background-/)||"writing-mode"==e)c[e]=b[e];if("layout-host"==this.d.fb)for(e in b)e.match(/^background-/)||"writing-mode"==e||(c[e]=b[e]);Xj(a,this.d.xa,null,c);c.content&&(c.content=c.content.yc(new Gj(a,null)));el(this,a.d);for(c=0;c<this.d.children.length;c++)this.d.children[c].f(this).h(a,b);a.pop()};
function ul(a,b){a.g&&(a.D=dl(a,"right",a.l,b)||dl(a,"margin-right",a.l,b)||dl(a,"border-right-width",a.l,b)||dl(a,"padding-right",a.l,b));a.f&&(a.I=dl(a,"top",a.k,b)||dl(a,"margin-top",a.k,b)||dl(a,"border-top-width",a.k,b)||dl(a,"padding-top",a.k,b));for(var c=0;c<a.children.length;c++)ul(a.children[c],b)}function vl(a){$k.call(this,null,a)}t(vl,$k);vl.prototype.h=function(a,b){$k.prototype.h.call(this,a,b);this.children.sort(function(a,b){return b.d.j-a.d.j||a.d.h-b.d.h})};
function Rk(a,b){$k.call(this,a,b);this.u=this}t(Rk,$k);Rk.prototype.M=function(a){var b=this.d.e;b.J&&(a=cd(b.d,a,b.J));return a};Rk.prototype.$=function(){};function Tk(a,b){$k.call(this,a,b);this.u=a.u}t(Tk,$k);function Vk(a,b){$k.call(this,a,b);this.u=a.u}t(Vk,$k);function wl(a,b,c,d){var e=null;c instanceof qd&&(e=[c]);c instanceof jd&&(e=c.values);if(e)for(a=a.d.d,c=0;c<e.length;c++)if(e[c]instanceof qd){var f=kc(e[c].name,"enabled"),f=new Xc(a,f);d&&(f=new Fc(a,f));b=cd(a,b,f)}return b}
Vk.prototype.M=function(a){var b=this.d.d,c=this.style,d=Zk(b,c.required,b.f)!==b.f;if(d||this.f){var e;e=(e=c["flow-from"])?e.fa(b,b.b):new B(b,"body");e=new Zc(b,"has-content",[e]);a=cd(b,a,e)}a=wl(this,a,c["required-partitions"],!1);a=wl(this,a,c["conflicting-partitions"],!0);d&&(c=(c=this.u.style.enabled)?c.fa(b,null):b.g,c=cd(b,c,a),this.u.style.enabled=new L(c));return a};Vk.prototype.eb=function(a,b,c,d){w(b.d,"overflow","hidden");$k.prototype.eb.call(this,a,b,c,d)};
function xl(a,b,c,d){Gf.call(this,a,b,!1);this.target=c;this.b=d}t(xl,Hf);xl.prototype.Ka=function(a,b,c){eh(this.b,a,b,c,this)};xl.prototype.mc=function(a,b){If(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};xl.prototype.Db=function(a,b){If(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};xl.prototype.gb=function(a,b,c){this.target.b[a]=new V(b,c?50331648:67108864)};function yl(a,b,c,d){xl.call(this,a,b,c,d)}t(yl,xl);
function zl(a,b,c,d){xl.call(this,a,b,c,d);c.b.width=new V(ke,0);c.b.height=new V(ke,0)}t(zl,xl);zl.prototype.Lb=function(a,b,c){a=new Uk(this.e,a,b,c,this.target);Ff(this.Y,new yl(this.e,this.Y,a,this.b))};zl.prototype.Kb=function(a,b,c){a=new Sk(this.e,a,b,c,this.target);a=new zl(this.e,this.Y,a,this.b);Ff(this.Y,a)};function Al(a,b,c,d){xl.call(this,a,b,c,d)}t(Al,xl);Al.prototype.Lb=function(a,b,c){a=new Uk(this.e,a,b,c,this.target);Ff(this.Y,new yl(this.e,this.Y,a,this.b))};
Al.prototype.Kb=function(a,b,c){a=new Sk(this.e,a,b,c,this.target);a=new zl(this.e,this.Y,a,this.b);Ff(this.Y,a)};var Bl={"text-indent":"0px","margin-top":"0px","padding-top":"0px","border-top-width":"0px","border-top-style":"none","border-top-color":"transparent"},Cl={"text-indent":"0px","margin-right":"0px","padding-right":"0px","border-right-width":"0px","border-right-style":"none","border-right-color":"transparent"},Dl={};
function El(a){a.addEventListener("load",function(){a.contentWindow.navigator.epubReadingSystem={name:"adapt",version:"0.1",layoutStyle:"paginated",hasFeature:function(a){switch(a){case "mouse-events":return!0}return!1}}},!1)}var Fl=(new DOMParser).parseFromString('<root xmlns="http://www.pyroxy.com/ns/shadow"/>',"text/xml"),Gl="footnote-marker first-5-lines first-4-lines first-3-lines first-2-lines first-line first-letter before  after".split(" ");
function Hl(a){return a.getAttribute("data-adapt-pseudo")||""}function Il(a,b,c,d){this.style=b;this.f=a;this.b=c;this.d=d;this.e={}}
Il.prototype.g=function(a){var b=Hl(a);this.b&&b&&b.match(/after$/)&&(this.style=this.b.g(this.f,!0),this.b=null);var c=this.style._pseudos[b]||{};if(!this.e[b]){this.e[b]=!0;var d=c.content;d&&(d=d.evaluate(this.d),xi(d)&&d.R(new wi(a,this.d)))}if(b.match(/^first-/)&&!c["x-first-pseudo"]){a=1;var e;"first-letter"==b?a=0:null!=(e=b.match(/^first-([0-9]+)-lines$/))&&(a=e[1]-0);c["x-first-pseudo"]=new V(new sd(a),0)}return c};
function Jl(a,b,c,d,e,f,g,k,h,l,n,p,q){this.A=a;this.d=b;this.viewport=c;this.u=c.b;this.k=d;this.D=e;this.Z=f;this.B=g;this.l=k;this.I=h;this.e=l;this.h=n;this.w=p;this.g=q;this.M=this.b=null;this.j=!1;this.W=null;this.aa=0;this.f=null}Jl.prototype.clone=function(){return new Jl(this.A,this.d,this.viewport,this.k,this.D,this.Z,this.B,this.l,this.I,this.e,this.h,this.w,this.g)};
function Kl(a,b,c,d,e,f){var g=M("createRefShadow");a.Z.j.load(b).then(function(k){if(k){var h=Ah(k,b);if(h){var l=a.I,n=l.I[k.url];n||(n=l.style.h.b[k.url],n=new wk(k,n.d,n.g,new tc(0,l.w(),l.u(),l.h),l.e,n.j,l.k),l.I[k.url]=n);f=new ci(d,h,k,e,f,c,n)}}Q(g,f)});return O(g)}
function Ll(a,b,c,d,e,f,g,k){var h=M("createShadows"),l=e.template,n;l instanceof ud?n=Kl(a,l.url,2,b,k,null):n=N(null);n.then(function(l){var n=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var r=b.getAttribute("href"),v=null;r?v=k?k.Z:a.Z:k&&(r="http://www.w3.org/1999/xhtml"==k.Y.namespaceURI?k.Y.getAttribute("href"):k.Y.getAttributeNS("http://www.w3.org/1999/xlink","href"),v=k.Kc?k.Kc.Z:a.Z);r&&(r=ta(r,v.url),n=Kl(a,r,3,b,k,l))}null==n&&(n=N(l));n.then(function(l){var n;
if(n=d._pseudos){for(var q=Fl.createElementNS("http://www.pyroxy.com/ns/shadow","root"),p=q,r=0;r<Gl.length;r++){var v=Gl[r],ob;if(v){if(!n[v])continue;if(!("footnote-marker"!=v||c&&a.j))continue;if(v.match(/^first-/)&&(ob=e.display,!ob||ob===Md))continue;ob=Fl.createElementNS("http://www.w3.org/1999/xhtml","span");ob.setAttribute("data-adapt-pseudo",v)}else ob=Fl.createElementNS("http://www.pyroxy.com/ns/shadow","content");p.appendChild(ob);v.match(/^first-/)&&(p=ob)}l=new ci(b,q,null,k,l,2,new Il(b,
d,f,g))}Q(h,l)})});return O(h)}function Ml(a,b,c){a.M=b;a.j=c}function Nl(a,b,c,d){var e=a.d;c=nk(c,e,a.D,a.j);b=mk(c,e,b);ok(c,d,b,function(b,c){var d=c.evaluate(e,b);"font-family"==b&&(d=mh(a.B,d));return d});return b}
function Ol(a,b){for(var c=a.b.W,d=[],e=a.b.ba,f=-1;c&&1==c.nodeType;){var g=e&&e.root==c;if(!g||2==e.type){var k=(e?e.b:a.k).g(c,!1);d.push(k)}g?(c=e.Y,e=e.Kc):(c=c.parentNode,f++)}c=vc(a.d,"em",0===f);c={"font-size":new V(new K(c,"px"),0)};e=new bj(c,a.d);for(f=d.length-1;0<=f;--f){var g=d[f],k=[],h;for(h in g)Ji[h]&&k.push(h);k.sort(pe);for(var l=0;l<k.length;l++){var n=k[l];e.b=n;c[n]=g[n].yc(e)}}for(var p in b)Ji[p]||(c[p]=b[p]);return c}
var Pl={a:"a",sub:"sub",sup:"sup",table:"table",tr:"tr",td:"td",th:"th",code:"code",body:"div",p:"p",v:"p",date:"p",emphasis:"em",strong:"strong",style:"span",strikethrough:"del"};function Ql(a,b){b=ta(b,a.Z.url);return a.w[b]||b}
function Rl(a,b){var c=!0,d=M("createElementView"),e=a.W,f=a.b.ba?a.b.ba.b:a.k,g=f.g(e,!1),k={};a.b.parent||(g=Ol(a,g));a.b.g=Nl(a,a.b.g,g,k);k.direction&&(a.b.D=k.direction.toString());var h=k["flow-into"];if(h&&h.toString()!=a.A)return Q(d,!1),O(d);var l=k.display;if(l===Td)return Q(d,!1),O(d);Ll(a,e,null==a.b.parent,g,k,f,a.d,a.b.ba).then(function(f){a.b.ua=f;var g=a.b.parent&&a.b.parent.k;f=k["float-reference"];var h=k["float"],r=k.clear;if(k.position===xd||k.position===Yd)a.b.k=!0,h=null;g&&
...
Pl[F];F||(F=a.b.d?"span":"div")}else if("http://www.daisy.org/z3986/2005/ncx/"==P)if(P="http://www.w3.org/1999/xhtml","ncx"==F||"navPoint"==F)F="div";else if("navLabel"==F){if(F="span",h=e.parentNode){f=null;for(h=h.firstChild;h;h=h.nextSibling)if(1==h.nodeType&&(r=h,"http://www.daisy.org/z3986/2005/ncx/"==r.namespaceURI&&"content"==r.localName)){f=r.getAttribute("src");break}f&&(F="a",e=e.ownerDocument.createElementNS(P,"a"),e.setAttribute("href",f))}}else F="span";else"http://www.pyroxy.com/ns/shadow"==
P?(P="http://www.w3.org/1999/xhtml",F=a.b.d?"span":"div"):y=!!a.h;v?b?F="li":(F="div",l=Bd,k.display=l):"body"==F||"li"==F?F="div":"q"==F?F="span":"a"==F&&(f=k["hyperlink-processing"])&&"normal"!=f.toString()&&(F="span");k.behavior&&"none"!=k.behavior.toString()&&a.h&&(y=!0);var Ea;y?Ea=a.h(e,a.b.parent?a.b.parent.b:null,k):Ea=N(null);Ea.then(function(f){f?y&&(c="true"==f.getAttribute("data-adapt-process-children")):f=a.createElement(P,F);"a"==F&&f.addEventListener("click",a.e.A,!1);J&&(Sl(a,a.b,
"inner",J),f.appendChild(J));"iframe"==f.localName&&"http://www.w3.org/1999/xhtml"==f.namespaceURI&&El(f);if("http://www.gribuser.ru/xml/fictionbook/2.0"!=e.namespaceURI||"td"==F){for(var g=e.attributes,h=g.length,l=null,n=0;n<h;n++){var p=g[n],q=p.namespaceURI,r=p.localName,p=p.nodeValue;if(q)if("http://www.w3.org/2000/xmlns/"==q)continue;else"http://www.w3.org/1999/xlink"==q&&"href"==r&&(p=Ql(a,p));else{if(r.match(/^on/))continue;if("style"==r)continue;if("id"==r){Xh(a.e,f,p);continue}"src"==r||
"href"==r||"poster"==r?p=Ql(a,p):"srcset"==r&&(p=p.split(",").map(function(b){return Ql(a,b.trim())}).join(","))}if(q){var Ea=Dl[q];Ea&&(r=Ea+":"+r)}"src"!=r||q||"img"!=F||"http://www.w3.org/1999/xhtml"!=P?"href"==r&&"image"==F&&"http://www.w3.org/2000/svg"==P&&"http://www.w3.org/1999/xlink"==q?a.e.e.push(tg(f,p)):q?f.setAttributeNS(q,r,p):f.setAttribute(r,p):l=p}l&&(g=tg(f,l),h=k.width,l=k.height,h&&h!==Ad&&l&&l!==Ad?a.e.e.push(g):W.push(g))}delete k.content;(g=k["list-style-image"])&&g instanceof
ud&&(g=g.url,W.push(tg(new Image,g)));Tl(a,f,k);g=k.widows;h=k.orphans;if(g||h){if(a.b.parent){a.b.l={};for(var ae in a.b.parent.l)a.b.l[ae]=a.b.parent.l[ae]}g instanceof sd&&(a.b.l.widows=g.C);h instanceof sd&&(a.b.l.orphans=h.C)}if(!b&&!a.b.d){ae=a.b.g?Cl:Bl;for(var Lk in ae)w(f,Lk,ae[Lk])}v&&f.setAttribute("value",k["ua-list-item-count"].stringValue());a.f=f;W.length?sg(W).then(function(){Q(d,c)}):nf().then(function(){Q(d,c)})})});return O(d)}
function Ul(a,b){var c=M("createNodeView"),d,e=!0;1==a.W.nodeType?d=Rl(a,b):(8==a.W.nodeType?a.f=null:a.f=document.createTextNode(a.W.textContent.substr(a.aa||0)),d=N(!0));d.then(function(b){e=b;(a.b.b=a.f)&&(b=a.b.parent?a.b.parent.b:a.M)&&b.appendChild(a.f);Q(c,e)});return O(c)}function Vl(a,b,c){(a.b=b)?(a.W=b.W,a.aa=b.aa):(a.W=null,a.aa=-1);a.f=null;return a.b?Ul(a,c):N(!0)}
function Wl(a){if(null==a.ba||"content"!=a.W.localName||"http://www.pyroxy.com/ns/shadow"!=a.W.namespaceURI)return a;var b=a.da,c=a.ba,d=a.parent,e,f;c.ed?(f=c.ed,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.Kc,e=c.Y.firstChild,c=2);var g=a.W.nextSibling;g?(a.W=g,fi(a)):a.na?a=a.na:e?a=null:(a=a.parent.modify(),a.K=!0);if(e)return b=new ei(e,d,b),b.ba=f,b.La=c,b.na=a,b;a.da=b;return a}
function Xl(a){var b=a.da+1;if(a.K){if(!a.parent)return null;if(3!=a.La){var c=a.W.nextSibling;if(c)return a=a.modify(),a.da=b,a.W=c,fi(a),Wl(a)}if(a.na)return a=a.na.modify(),a.da=b,a;a=a.parent.modify()}else{if(a.ua&&(c=a.ua.root,2==a.ua.type&&(c=c.firstChild),c))return b=new ei(c,a,b),b.ba=a.ua,b.La=a.ua.type,Wl(b);if(c=a.W.firstChild)return Wl(new ei(c,a,b));1!=a.W.nodeType&&(b+=a.W.textContent.length-1-a.aa);a=a.modify()}a.da=b;a.K=!0;return a}
function Yl(a,b){b=Xl(b);if(!b||b.K)return N(b);var c=M("nextInTree");Vl(a,b,!0).then(function(a){b.b&&a||(b=b.modify(),b.K=!0,b.b||(b.d=!0));Q(c,b)});return O(c)}function Zl(a,b){if(b instanceof jd)for(var c=b.values,d=0;d<c.length;d++)Zl(a,c[d]);else b instanceof ud&&(c=b.url,a.e.e.push(tg(new Image,c)))}
function Tl(a,b,c){var d=c["background-image"];d&&Zl(a,d);for(var e in c)d=c[e],!Qh[e]||"position"==e&&d!==Yd?(d.ac()&&sc(d.ia)&&(d=new K(wd(d,a.d),"px")),w(b,e,d.toString())):a.e.g.push(new Rh(b,e,d))}function Sl(a,b,c,d){if(!b.K){var e=(b.ba?b.ba.b:a.k).g(a.W,!1);if(e=e._pseudos)if(e=e[c])c={},b.g=Nl(a,b.g,e,c),b=c.content,xi(b)&&(b.R(new wi(d,a.d)),delete c.content),Tl(a,d,c)}}
function $l(a,b,c){var d=M("peelOff"),e=b.f,f=b.aa,g=b.K;if(0<c)b.b.textContent=b.b.textContent.substr(0,c),f+=c;else if(!g&&b.b&&0==f){var k=b.b.parentNode;k&&k.removeChild(b.b)}for(var h=b.da+c,l=[];b.f===e;)l.push(b),b=b.parent;var n=l.pop(),p=n.na;of(function(){for(;0<l.length;){n=l.pop();b=new ei(n.W,b,h);0==l.length&&(b.aa=f,b.K=g);b.La=n.La;b.ba=n.ba;b.ua=n.ua;b.na=n.na?n.na:p;p=null;var c=Vl(a,b,!1);if(c.ya())return c}return N(!1)}).then(function(){Q(d,b)});return O(d)}
Jl.prototype.createElement=function(a,b){return"http://www.w3.org/1999/xhtml"==a?this.u.createElement(b):this.u.createElementNS(a,b)};function am(a,b,c){var d={},e=a.l._pseudos;b=Nl(a,b,a.l,d);if(e&&e.before){var f={},g=a.createElement("http://www.w3.org/1999/xhtml","span");g.setAttribute("data-adapt-pseudo","before");c.appendChild(g);Nl(a,b,e.before,f);delete f.content;Tl(a,g,f)}delete d.content;Tl(a,c,d);return b}
function Di(a,b,c){return b.aa===c.aa&&b.K==c.K&&b.ha.length===c.ha.length&&b.ha.every(function(a,b){var f;f=c.ha[b];if(a.ba)if(f.ba){var g=1===a.ea.nodeType?a.ea:a.ea.parentElement,k=1===f.ea.nodeType?f.ea:f.ea.parentElement;f=a.ba.Y===f.ba.Y&&Hl(g)===Hl(k)}else f=!1;else f=a.ea===f.ea;return f}.bind(a))}function bm(a){this.b=a}function cm(a){return a.getClientRects()}
function dm(a,b,c,d,e){this.f=a;this.fontSize=b;this.b=a.document;this.root=c||this.b.body;b=this.root.firstElementChild;b||(b=this.b.createElement("div"),this.root.appendChild(b));c=b.firstElementChild;c||(c=this.b.createElement("div"),b.appendChild(c));this.e=b;this.d=c;b=(new bm(a)).b.getComputedStyle(this.root,null);this.width=d||parseFloat(b.width)||a.innerWidth;this.height=e||parseFloat(b.height)||a.innerHeight}
dm.prototype.zoom=function(a,b,c){w(this.e,"width",a*c+"px");w(this.e,"height",b*c+"px");w(this.d,"width",a+"px");w(this.d,"height",b+"px");w(this.d,"transform","scale("+c+")")};Ii("SIMPLE_PROPERTY",function(a){var b=a.name,c=a.value;switch(b){case "page-break-before":case "page-break-after":case "page-break-inside":return{name:b.replace(/^page-/,""),value:c===zd?Xd:c,important:a.important};default:return a}});var em={page:!0,left:!0,right:!0,recto:!0,verso:!0,column:!0,region:!0},fm={avoid:!0,"avoid-page":!0,"avoid-column":!0,"avoid-region":!0};function gm(a,b){return a?b?em[b]?b:em[a]?a:fm[b]?b:fm[a]?a:b:a:b};var hm={img:!0,svg:!0,audio:!0,video:!0};
function im(a,b,c){var d=a.b;if(!d)return NaN;if(1==d.nodeType){if(a.K){var e=d.getBoundingClientRect();if(e.right>=e.left&&e.bottom>=e.top)return c?e.left:e.bottom}return NaN}var e=NaN,f=d.ownerDocument.createRange(),g=d.textContent.length;if(!g)return NaN;a.K&&(b+=g);b>=g&&(b=g-1);f.setStart(d,b);f.setEnd(d,b+1);a=cm(f);if(b=c){b=document.body;if(null==ib){var k=b.ownerDocument,f=k.createElement("div");f.style.position="absolute";f.style.top="0px";f.style.left="0px";f.style.width="100px";f.style.height=
"100px";f.style.overflow="hidden";f.style.lineHeight="16px";f.style.fontSize="16px";w(f,"writing-mode","vertical-rl");b.appendChild(f);g=k.createTextNode("a a a a a a a a a a a a a a a a");f.appendChild(g);k=k.createRange();k.setStart(g,0);k.setEnd(g,1);ib=50>k.getBoundingClientRect().left;b.removeChild(f)}b=ib}if(b){b=d.ownerDocument.createRange();b.setStart(d,0);b.setEnd(d,d.textContent.length);d=cm(b);b=[];for(f=0;f<a.length;f++){g=a[f];for(k=0;k<d.length;k++){var h=d[k];if(g.top>=h.top&&g.bottom<=
h.bottom&&1>Math.abs(g.right-h.right)){b.push({top:g.top,left:h.left,bottom:h.bottom,right:h.right});break}}k==d.length&&(u.b("Could not fix character box"),b.push(g))}a=b}for(b=d=0;b<a.length;b++)f=a[b],g=c?f.bottom-f.top:f.right-f.left,f.right>f.left&&f.bottom>f.top&&(isNaN(e)||g>d)&&(e=c?f.left:f.bottom,d=g);return e}function jm(a,b){this.e=a;this.f=b}jm.prototype.d=function(a,b){return b<this.f?null:km(a,this,0<b)};jm.prototype.b=function(){return this.f};
function lm(a,b,c,d){this.position=a;this.f=b;this.g=c;this.e=d}lm.prototype.d=function(a,b){var c;b<this.b()?c=null:(a.e=this.e,c=this.position);return c};lm.prototype.b=function(){return(fm[this.f]?1:0)+(this.g?3:0)+(this.position.parent?this.position.parent.h:0)};function mm(a,b,c){this.da=a;this.d=b;this.b=c}
function nm(a){for(var b=1;b<a.length;b++){var c=a[b-1],d=a[b];c===d?u.b("validateCheckPoints: duplicate entry"):c.da>=d.da?u.b("validateCheckPoints: incorrect boxOffset"):c.W==d.W&&(d.K?c.K&&u.b("validateCheckPoints: duplicate after points"):c.K?u.b("validateCheckPoints: inconsistent after point"):d.da-c.da!=d.aa-c.aa&&u.b("validateCheckPoints: boxOffset inconsistent with offsetInNode"))}}
function om(a,b,c){oi.call(this,a);this.Sc=a.lastChild;this.g=b;this.oc=c;this.wd=a.ownerDocument;this.qc=!1;this.ma=this.Ya=this.Ba=this.gd=this.Ta=0;this.Qb=this.Rb=this.l=this.h=null;this.Tc=!1;this.M=this.f=this.u=null;this.hd=!0;this.sc=this.rc=0}t(om,oi);om.prototype.clone=function(){var a=new om(this.d,this.g,this.oc);ti(a,this);a.Sc=this.Sc;a.qc=this.qc;a.l=this.l?this.l.clone():null;a.Rb=this.Rb.concat();return a};
function pm(a,b){var c=(a.b?a.Ya:a.Ta)-a.h.V,d=(a.b?a.Ta:a.Ba)-a.h.T;return new qe(b.V-c,b.T-d,b.S-c,b.P-d)}function qm(a,b){return a.b?b<a.ma:b>a.ma}function rm(a,b,c){var d=new ei(b.ea,c,0);d.La=b.La;d.ba=b.ba;d.ua=b.ua;d.na=b.na?rm(a,b.na,hi(c)):null;return d}
function sm(a,b){var c=M("openAllViews"),d=b.ha;Ml(a.g,a.d,a.qc);var e=d.length-1,f=null;of(function(){for(;0<=e;){f=rm(a,d[e],f);if(0==e&&(f.aa=b.aa,f.K=b.K,f.K))break;var c=Vl(a.g,f,0==e&&0==f.aa);e--;if(c.ya())return c}return N(!1)}).then(function(){Q(c,f)});return O(c)}var tm=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
function um(a,b){if(b.f&&b.d&&!b.K&&0==b.f.count&&1!=b.b.nodeType){var c=b.b.textContent.match(tm);return $l(a.g,b,c[0].length)}return N(b)}function vm(a,b,c){var d=M("buildViewToNextBlockEdge");pf(function(d){b.b&&c.push(hi(b));um(a,b).then(function(f){f!==b&&(b=f,c.push(hi(b)));Yl(a.g,b).then(function(c){(b=c)?b.j&&!a.b?wm(a,b).then(function(c){b=c;!b||b.e||0<a.g.g.b.length?R(d):rf(d)}):b.d?rf(d):R(d):R(d)})})}).then(function(){Q(d,b)});return O(d)}
function xm(a,b){if(!b.b)return N(b);var c=b.W,d=M("buildDeepElementView");pf(function(d){um(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.W!=c;)g=g.parent;if(null==g){b=f;R(d);return}}Yl(a.g,f).then(function(a){(b=a)&&b.W!=c?rf(d):R(d)})})}).then(function(){Q(d,b)});return O(d)}function ym(a,b,c,d,e){var f=a.wd.createElement("div");a.b?(w(f,"height",d+"px"),w(f,"width",e+"px")):(w(f,"width",d+"px"),w(f,"height",e+"px"));w(f,"float",c);w(f,"clear",c);a.d.insertBefore(f,b);return f}
function zm(a){for(var b=a.d.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.d.removeChild(b);else break}b=c}}function Am(a){for(var b=a.d.firstChild,c=a.Qb,d=a.b?a.h.T:a.h.V,e=a.b?a.h.P:a.h.S,f=0;f<c.length;f++){var g=c[f],k=g.P-g.T;g.left=ym(a,b,"left",g.V-d,k);g.right=ym(a,b,"right",e-g.S,k)}}
function Bm(a,b,c,d,e){var f;if(b&&b.K&&!b.d&&(f=im(b,0,a.b),!isNaN(f)))return f;b=c[d];for(e-=b.da;;){f=im(b,e,a.b);if(!isNaN(f))return f;if(0<e)e--;else{d--;if(0>d)return a.Ba;b=c[d];1!=b.b.nodeType&&(e=b.b.textContent.length)}}}function Cm(a){return"number"==typeof a?a:(a=a.match(/^(-?[0-9]*(\.[0-9]*)?)px$/))?parseFloat(a[0]):0}
function Dm(a,b){var c=a.oc.b.getComputedStyle(b,null),d=new se;c&&(d.left=Cm(c.marginLeft),d.top=Cm(c.marginTop),d.right=Cm(c.marginRight),d.bottom=Cm(c.marginBottom));return d}
function Em(a,b,c){if(a=a.oc.b.getComputedStyle(b,null))c.marginLeft=Cm(a.marginLeft),c.$=Cm(a.borderLeftWidth),c.j=Cm(a.paddingLeft),c.marginTop=Cm(a.marginTop),c.ca=Cm(a.borderTopWidth),c.k=Cm(a.paddingTop),c.marginRight=Cm(a.marginRight),c.Fa=Cm(a.borderRightWidth),c.D=Cm(a.paddingRight),c.marginBottom=Cm(a.marginBottom),c.va=Cm(a.borderBottomWidth),c.w=Cm(a.paddingBottom)}function Fm(a,b,c){b=new mm(b,c,c);a.f?a.f.push(b):a.f=[b]}
function Gm(a,b,c,d){if(a.f&&a.f[a.f.length-1].b)return Fm(a,b,c),N(!0);d+=40*(a.b?-1:1);var e=a.l,f=!e;if(f){var g=a.d.ownerDocument.createElement("div");w(g,"position","absolute");var k=a.g.clone(),e=new om(g,k,a.oc);a.l=e;e.b=am(a.g,a.b,g);e.qc=!0;a.b?(e.left=0,w(e.d,"width","2em")):(e.top=a.Ya,w(e.d,"height","2em"))}a.d.appendChild(e.d);Em(a,e.d,e);g=(a.b?-1:1)*(d-a.Ba);a.b?e.height=a.h.P-a.h.T-pi(e)-qi(e):e.width=a.h.S-a.h.V-ri(e)-si(e);d=(a.b?-1:1)*(a.Ya-d)-(a.b?ri(e)-si(e):pi(e)+qi(e));if(f&&
18>d)return a.d.removeChild(e.d),a.l=null,Fm(a,b,c),N(!0);if(!a.b&&e.top<g)return a.d.removeChild(e.d),Fm(a,b,c),N(!0);var h=M("layoutFootnoteInner");a.b?vi(e,0,d):ui(e,g,d);e.A=a.A+a.left+ri(a);e.B=a.B+a.top+pi(a);e.I=a.I;var l=new ki(c);f?(Hm(e),f=N(!0)):0==e.I.length?(Im(e),f=N(!0)):f=Jm(e);f.then(function(){Km(e,l).then(function(d){a.b?(a.ma=a.Ya+(e.e+ri(e)+si(e)),vi(e,0,e.e)):(a.ma=a.Ya-(e.e+pi(e)+qi(e)),ui(e,a.ma-a.Ba,e.e));var f;!a.b&&0<e.I.length?f=Jm(e):f=N(d);f.then(function(d){d=new mm(b,
c,d?d.Qa:null);a.f?a.f.push(d):a.f=[d];Q(h,!0)})})});return O(h)}
function Lm(a,b){var c=M("layoutFootnote"),d=b.b;d.setAttribute("style","");w(d,"display","inline-block");d.textContent="M";var e=d.getBoundingClientRect(),f=a.b?e.left:e.bottom;d.textContent="";Sl(a.g,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d={ha:[{ea:b.W,La:0,ba:b.ba,ua:null,na:null}],aa:0,K:!1};e=b.da;b=b.modify();b.K=!0;Gm(a,e,d,f).then(function(){a.l&&a.l.d.parentNode&&a.d.removeChild(a.l.d);qm(a,f)&&0!=a.u.length&&(b.e=!0);Q(c,b)});return O(c)}
function Mm(a,b){var c=M("layoutFloat"),d=b.b,e=b.j,f=b.M,g=b.parent?b.parent.D:"ltr",k=a.g.g,h=b.b.parentNode;"page"===f?Bi(k,d,e):(w(d,"float","none"),w(d,"position","absolute"),w(d,"left","auto"),w(d,"right","auto"),w(d,"top","auto"));xm(a,b).then(function(l){var n=d.getBoundingClientRect(),p=Dm(a,d),n=new qe(n.left-p.left,n.top-p.top,n.right+p.right,n.bottom+p.bottom);if("page"===f)Ci(k,b,a.g)?(n=h.ownerDocument.createElement("span"),w(n,"width","0"),w(n,"height","0"),h.appendChild(n),l.b=n,Q(c,
l)):Ei(k,b,pm(a,n)).then(function(){Q(c,null)});else{e=yi(e,a.b,g);for(var p=a.Ta,q=a.gd,r=b.parent;r&&r.d;)r=r.parent;if(r){var v=r.b.ownerDocument.createElement("div");v.style.left="0px";v.style.top="0px";a.b?(v.style.bottom="0px",v.style.width="1px"):(v.style.right="0px",v.style.height="1px");r.b.appendChild(v);var y=v.getBoundingClientRect(),p=Math.max(a.b?y.top:y.left,p),q=Math.min(a.b?y.bottom:y.right,q);r.b.removeChild(v);r=a.b?n.P-n.T:n.S-n.V;"left"==e?q=Math.max(q,p+r):p=Math.min(p,q-r)}p=
new qe(p,(a.b?-1:1)*a.Ba,q,(a.b?-1:1)*a.Ya);q=n;a.b&&(q=Ie(n));Ne(p,a.Qb,q,e);a.b&&(n=new qe(-q.P,q.V,-q.T,q.S));w(d,"left",n.V-(a.b?a.Ya:a.Ta)+a.j+"px");w(d,"top",n.T-(a.b?a.Ta:a.Ba)+a.k+"px");n=a.b?n.V:n.P;qm(a,n)&&0!=a.u.length?(b=b.modify(),b.e=!0,Q(c,b)):(zm(a),p=a.b?Ie(a.h):a.h,a.b?q=Ie(pm(a,new qe(-q.P,q.V,-q.T,q.S))):q=pm(a,q),Oe(p,a.Qb,q,e),Am(a),"left"==e?a.rc=n:a.sc=n,Nm(a,n),Q(c,l))}});return O(c)}
function Om(a,b){for(var c=a.b,d="";c&&b&&!d&&(1!=c.nodeType||(d=c.style.textAlign,b));c=c.parentNode);if(!b||"justify"==d){var c=a.b,e=c.ownerDocument,d=e.createElement("span");d.style.visibility="hidden";d.textContent=" ########################";d.setAttribute("data-adapt-spec","1");var f=b&&(a.K||1!=c.nodeType)?c.nextSibling:c;if(c=c.parentNode)c.insertBefore(d,f),b||(e=e.createElement("div"),c.insertBefore(e,f),d.style.lineHeight="80px",e.style.marginTop="-80px",e.style.height="0px",e.setAttribute("data-adapt-spec",
"1"))}}function Pm(a,b,c,d){var e=M("processLineStyling");nm(d);var f=d.concat([]);d.splice(0,d.length);var g=0,k=b.f;0==k.count&&(k=k.Gd);pf(function(d){if(k){var e=Qm(a,f),n=k.count-g;if(e.length<=n)R(d);else{var p=Rm(a,f,e[n-1]);Sm(a,p,!1,!1).then(function(){g+=n;$l(a.g,p,0).then(function(e){b=e;Om(b,!1);k=b.f;f=[];vm(a,b,f).then(function(b){c=b;0<a.g.g.b.length?R(d):rf(d)})})})}}else R(d)}).then(function(){Array.prototype.push.apply(d,f);nm(d);Q(e,c)});return O(e)}
function Tm(a,b){for(var c=0,d=0,e=b.length-1;0<=e;e--){var f=b[e];if(!f.K||!f.b||1!=f.b.nodeType)break;f=Dm(a,f.b);f=a.b?-f.left:f.bottom;0<f?c=Math.max(c,f):d=Math.min(d,f)}return c-d}
function Um(a,b){var c=M("layoutBreakableBlock"),d=[];vm(a,b,d).then(function(e){if(0<a.g.g.b.length)Q(c,e);else{var f=d.length-1;if(0>f)Q(c,e);else{var f=Bm(a,e,d,f,d[f].da),g=qm(a,f);null==e&&(f+=Tm(a,d));Nm(a,f);var k;b.f?k=Pm(a,b,e,d):k=N(e);k.then(function(b){0<d.length&&(a.u.push(new jm(d,d[0].h)),g&&(2!=d.length&&0<a.u.length||d[0].W!=d[1].W||!hm[d[0].W.localName])&&b&&(b=b.modify(),b.e=!0));Q(c,b)})}}});return O(c)}
function Rm(a,b,c){nm(b);for(var d=0,e=b[0].da,f=d,g=b.length-1,k=b[g].da,h;e<k;){h=e+Math.ceil((k-e)/2);for(var f=d,l=g;f<l;){var n=f+Math.ceil((l-f)/2);b[n].da>h?l=n-1:f=n}l=Bm(a,null,b,f,h);if(a.b?l<c:l>c){for(k=h-1;b[f].da==h;)f--;g=f}else Nm(a,l),e=h,d=f}a=b[f];b=a.b;1!=b.nodeType&&(a.K?a.aa=b.length:(e-=a.da,c=b.data,173==c.charCodeAt(e)?(b.replaceData(e,c.length-e,"-"),e++):(d=c.charAt(e),e++,f=c.charAt(e),b.replaceData(e,c.length-e,Va(d)&&Va(f)?"-":"")),0<e&&(a=a.modify(),a.aa+=e,a.u=null)));
return a}
function Qm(a,b){for(var c=[],d=b[0].b,e=b[b.length-1].b,f=[],g=d.ownerDocument.createRange(),k=!1,h=null,l=!1,n=!0;n;){var p=!0;do{var q=null;d==e&&(n=!1);1!=d.nodeType?(l||(g.setStartBefore(d),l=!0),h=d):k?k=!1:d.getAttribute("data-adapt-spec")?p=!l:q=d.firstChild;q||(q=d.nextSibling,q||(k=!0,q=d.parentNode));d=q}while(p&&n);if(l){g.setEndAfter(h);l=cm(g);for(p=0;p<l.length;p++)f.push(l[p]);l=!1}}f.sort(a.b?bi:ai);h=d=k=g=e=0;for(n=a.b?-1:1;;){if(h<f.length&&(l=f[h],p=1,0<d&&(p=Math.max(a.b?l.right-
...
function Vm(a,b){if(!a.f)return N(!0);for(var c=!1,d=a.f.length-1;0<=d;--d){var e=a.f[d];if(e.da<=b)break;a.f.pop();e.b!==e.d&&(c=!0)}if(!c)return N(!0);var f=M("clearFootnotes"),g=a.e+a.Ba,k=a.f;a.l=null;a.f=null;var h=0;of(function(){for(;h<k.length;){var b=k[h++],b=Gm(a,b.da,b.d,g);if(b.ya())return b}return N(!1)}).then(function(){Q(f,!0)});return O(f)}
function km(a,b,c){var d=b.e,e;if(c)e=c=1;else{for(e=d[0];e.parent&&e.d;)e=e.parent;c=Math.max((e.l.widows||2)-0,1);e=Math.max((e.l.orphans||2)-0,1)}var f=Qm(a,d),g=a.ma,d=Ya(f.length,function(b){return a.b?f[b]<g:f[b]>g}),d=Math.min(f.length-c,d);if(d<e)return null;g=f[d-1];if(b=Rm(a,b.e,g))a.e=(a.b?-1:1)*(g-a.Ba);return b}
function Sm(a,b,c,d){var e=b;c=c||null!=b.b&&1==b.b.nodeType&&!b.K;do{var f=e.b.parentNode;if(!f)break;var g=f,k=e.b;if(g)for(var h=void 0;(h=g.lastChild)!=k;)g.removeChild(h);c&&(f.removeChild(e.b),c=!1);e=e.parent}while(e);d&&Om(b,!0);return Vm(a,b.da)}
function Wm(a,b,c){var d=M("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,k=a.u.length-1;0<=k&&!e;--k){var e=a.u[k].d(a,f),h=a.u[k].b();h>f&&(g=Math.min(g,h))}while(g>f&&!e);var l=!1;if(!e){u.b("Could not find any page breaks?!!");if(a.hd)return Xm(a,b).then(function(b){b?(b=b.modify(),b.e=!1,Sm(a,b,l,!0).then(function(){Q(d,b)})):Q(d,b)}),O(d);e=c;l=!0}Sm(a,e,l,!0).then(function(){Q(d,e)});return O(d)}
function Ym(a){a=a.toString();return""==a||"auto"==a||!!a.match(/^0+(.0*)?[^0-9]/)}function Zm(a,b,c,d,e){if(!b)return!1;var f=im(b,0,a.b),g=qm(a,f);c&&(f+=Tm(a,c));Nm(a,f);if(d||!g)b=new lm(hi(b),e,g,a.e),a.u.push(b);return g}
function $m(a,b){if(b.b.parentNode){var c=Dm(a,b.b),d=b.b.ownerDocument.createElement("div");a.b?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.b.parentNode.insertBefore(d,b.b);var e=d.getBoundingClientRect(),e=a.b?e.right:e.top,f=a.b?-1:1,g;switch(b.w){case "left":g=a.rc;break;case "right":g=a.sc;break;default:g=f*Math.max(a.sc*f,a.rc*f)}e*f>=g*f?b.b.parentNode.removeChild(d):(e=Math.max(1,(g-e)*
...
function an(a,b,c){var d=M("skipEdges"),e=null,f=null,g=[];pf(function(d){for(;b;){do if(b.b){if(b.d&&1!=b.b.nodeType){if(Yh(b.b,b.A))break;if(!b.K){Zm(a,f,null,!0,e)?(b=(f||b).modify(),b.e=!0):(b=b.modify(),b.u=e);R(d);return}}if(!b.K&&(b.w&&$m(a,b),b.j)){Zm(a,f,null,!0,e)&&(b=(f||b).modify(),b.e=!0);R(d);return}if(1==b.b.nodeType){var h=b.b.style;if(b.K){if(f=hi(b),g.push(f),e=gm(e,b.B),h&&(!Ym(h.paddingBottom)||!Ym(h.borderBottomWidth))){if(Zm(a,f,null,!0,e)){b=(f||b).modify();b.e=!0;R(d);return}g=
[f];f=e=null}}else{e=gm(e,b.u);if(!c&&em[e]){R(d);a.M=e;return}if(hm[b.b.localName]){Zm(a,f,null,!0,e)&&(b=(f||b).modify(),b.e=!0);R(d);return}if(h&&(!Ym(h.paddingTop)||!Ym(h.borderTopWidth))){if(Zm(a,f,null,!0,e)){b=(f||b).modify();b.e=!0;R(d);return}f=e=null;g=[]}}}}while(0);h=Yl(a.g,b);if(h.ya()){h.then(function(a){b=a;rf(d)});return}b=h.Wb()}0!=a.u.length&&Zm(a,f,g,!1,e)&&f&&(b=f.modify(),b.e=!0);R(d)}).then(function(){Q(d,b)});return O(d)}
function Xm(a,b){var c=b,d=M("skipEdges"),e=null;pf(function(d){for(;b;){do if(b.b){if(b.d&&1!=b.b.nodeType){if(Yh(b.b,b.A))break;if(!b.K){R(d);return}}if(!b.K&&b.j){R(d);return}if(1==b.b.nodeType){var g=b.b.style;if(b.K)e=gm(e,b.B);else{e=gm(e,b.u);if(em[e]){R(d);a.M=e;return}if(hm[b.b.localName]){R(d);return}if(g&&(!Ym(g.paddingTop)||!Ym(g.borderTopWidth))){R(d);return}}}}while(0);g=Yl(a.g,b);if(g.ya()){g.then(function(a){b=a;rf(d)});return}b=g.Wb()}c=null;R(d)}).then(function(){Q(d,c)});return O(d)}
function wm(a,b){return"footnote"==b.j?Lm(a,b):Mm(a,b)}function bn(a,b,c){var d=M("layoutNext");an(a,b,c).then(function(c){b=c;if(!b||a.M||b.e)Q(d,b);else if(b.j)wm(a,b).oa(d);else{a:{if(!b.K)switch(b.W.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!0}c?Um(a,b).oa(d):xm(a,b).oa(d)}});return O(d)}
function Im(a){var b=a.d.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.k+"px";b.style.right=a.D+"px";b.style.bottom=a.w+"px";b.style.left=a.j+"px";a.d.appendChild(b);var c=b.getBoundingClientRect();a.d.removeChild(b);var b=a.A+a.left+ri(a),d=a.B+a.top+pi(a);a.h=new qe(b,d,b+a.width,d+a.height);a.Ta=c?a.b?c.top:c.left:0;a.gd=c?a.b?c.bottom:c.right:0;a.Ba=c?a.b?c.right:c.top:0;a.Ya=c?a.b?c.left:c.bottom:0;a.rc=a.Ba;a.sc=a.Ba;a.ma=a.Ya;c=a.h;b=a.A+a.left+ri(a);d=a.B+a.top+
pi(a);b=a.Sb?ye(a.Sb,b,d):Ae(b,d,b+a.width,d+a.height);a.Qb=Ke(c,[b],a.I,a.Ga,a.b);Am(a);a.f=null}function Hm(a){a.Rb=[];w(a.d,"width",a.width+"px");w(a.d,"height",a.height+"px");Im(a);a.e=0;a.Tc=!1;a.M=null}function Nm(a,b){a.e=Math.max((a.b?-1:1)*(b-a.Ba),a.e)}function cn(a,b){var c=b.b;if(!c)return N(!0);var d=M("layoutOverflownFootnotes"),e=0;of(function(){for(;e<c.length;){var b=c[e++],b=Gm(a,0,b,a.Ba);if(b.ya())return b}return N(!1)}).then(function(){Q(d,!0)});return O(d)}
function Km(a,b){a.Rb.push(b);if(a.Tc)return N(b);var c=M("layout");cn(a,b).then(function(){sm(a,b.Qa).then(function(b){var e=b,f=!0;a.u=[];pf(function(c){for(;b;){var k=!0;bn(a,b,f).then(function(h){f=!1;b=h;0<a.g.g.b.length?R(c):a.M?R(c):b&&b.e?Wm(a,b,e).then(function(a){b=a;R(c)}):k?k=!1:rf(c)});if(k){k=!1;return}}R(c)}).then(function(){var e=a.l;e&&(a.d.appendChild(e.d),a.b?a.e=this.Ba-this.Ya:a.e=e.top+pi(e)+e.e+qi(e));if(b)if(0<a.g.g.b.length)Q(c,null);else{a.Tc=!0;e=new ki(ji(b));if(a.f){for(var f=
[],h=0;h<a.f.length;h++){var l=a.f[h].b;l&&f.push(l)}e.b=f.length?f:null}Q(c,e)}else Q(c,null)})})});return O(c)}function Jm(a){for(var b=a.Rb,c=a.d.lastChild;c!=a.Sc;){var d=c.previousSibling;a.d===c.parentNode&&Hl(c)||a.d.removeChild(c);c=d}zm(a);Hm(a);var e=M("redoLayout"),f=0,g=null;pf(function(c){if(f<b.length){var d=b[f++];Km(a,d).then(function(a){a?(g=a,R(c)):rf(c)})}else R(c)}).then(function(){Q(e,g)});return O(e)};function dn(a,b){this.e(a,"end",b)}function en(a,b){this.e(a,"start",b)}function fn(a,b,c){c||(c=this.g.now());var d=this.f[a];d||(d=this.f[a]=[]);var e;for(a=d.length-1;0<=a&&(!(e=d[a])||e[b]);a--)e=null;e||(e={},d.push(e));e[b]=c}function gn(){}function hn(a){this.g=a;this.f={};this.registerEndTiming=this.d=this.registerStartTiming=this.b=this.e=gn}
hn.prototype.h=function(){var a=this.f,b="";Object.keys(a).forEach(function(c){for(var d=a[c],e=d.length,f=0;f<e;f++){var g=d[f];b+=c;1<e&&(b+="("+f+")");b+=" => start: "+g.start+", end: "+g.end+", duration: "+(g.end-g.start)+"\n"}});u.e(b)};hn.prototype.j=function(){this.registerEndTiming=this.d=this.registerStartTiming=this.b=this.e=gn};hn.prototype.k=function(){this.e=fn;this.registerStartTiming=this.b=en;this.registerEndTiming=this.d=dn};
var jn={now:Date.now},kn,ln=kn=new hn(window&&window.performance||jn);fn.call(ln,"load_vivliostyle","start",void 0);ca("vivliostyle.profile.profiler",ln);hn.prototype.printTimings=hn.prototype.h;hn.prototype.disable=hn.prototype.j;hn.prototype.enable=hn.prototype.k;function mn(a,b,c){function d(c){return a.b.getComputedStyle(b,null).getPropertyValue(c)}function e(){w(b,"display","block");w(b,"position","static");return d(W)}function f(){w(b,"display","inline-block");w(v,W,"99999999px");var a=d(W);w(v,W,"");return a}function g(){w(b,"display","inline-block");w(v,W,"0");var a=d(W);w(v,W,"");return a}function k(){var a=e(),b=g(),c=parseFloat(a);if(c<=parseFloat(b))return b;b=f();return c<=parseFloat(b)?a:b}function h(){throw Error("Getting fill-available block size is not implemented");
...
d(P);break;case "fit-content width":c=J?d(P):k();break;case "fit-content height":c=J?k():d(P)}F[a]=parseFloat(c);w(b,"position",n);w(b,"display",l)});w(b,"width",p);w(b,"height",q);r.insertBefore(b,v);r.removeChild(v);return F};function nn(a){var b=a["writing-mode"],b=b&&b.value;a=(a=a.direction)&&a.value;return b===ge||b!==he&&a!==ce?"ltr":"rtl"}
var on={a5:{width:new K(148,"mm"),height:new K(210,"mm")},a4:{width:new K(210,"mm"),height:new K(297,"mm")},a3:{width:new K(297,"mm"),height:new K(420,"mm")},b5:{width:new K(176,"mm"),height:new K(250,"mm")},b4:{width:new K(250,"mm"),height:new K(353,"mm")},"jis-b5":{width:new K(182,"mm"),height:new K(257,"mm")},"jis-b4":{width:new K(257,"mm"),height:new K(364,"mm")},letter:{width:new K(8.5,"in"),height:new K(11,"in")},legal:{width:new K(8.5,"in"),height:new K(14,"in")},ledger:{width:new K(11,"in"),
height:new K(17,"in")}},pn={width:le,height:me};function qn(a){if((a=a.size)&&a.value!==Ad){var b=a.value;b.ad()?(a=b.values[0],b=b.values[1]):(a=b,b=null);return a.ac()?{width:a,height:b||a}:(a=on[a.name.toLowerCase()])?b&&b===Pd?{width:a.height,height:a.width}:{width:a.width,height:a.height}:pn}return pn}
var rn=function(){var a={width:!0,height:!0,"block-size":!0,"inline-size":!0,margin:!0,padding:!0,border:!0,outline:!0,"outline-width":!0,"outline-style":!0,"outline-color":!0};"left right top bottom before after start end block-start block-end inline-start inline-end".split(" ").forEach(function(b){a["margin-"+b]=!0;a["padding-"+b]=!0;a["border-"+b+"-width"]=!0;a["border-"+b+"-style"]=!0;a["border-"+b+"-color"]=!0});return a}(),sn={"top-left-corner":{N:1,ta:!0,qa:!1,ra:!0,sa:!0,ga:null},"top-left":{N:2,
...
qa:!0,ra:!1,sa:!1,ga:"center"},"bottom-left":{N:12,ta:!1,qa:!0,ra:!1,sa:!1,ga:"start"},"bottom-left-corner":{N:13,ta:!1,qa:!0,ra:!0,sa:!1,ga:null},"left-bottom":{N:14,ta:!1,qa:!1,ra:!0,sa:!1,ga:"end"},"left-middle":{N:15,ta:!1,qa:!1,ra:!0,sa:!1,ga:"center"},"left-top":{N:16,ta:!1,qa:!1,ra:!0,sa:!1,ga:"start"}},tn=Object.keys(sn).sort(function(a,b){return sn[a].N-sn[b].N});
function un(a,b,c){Qk.call(this,a,null,"vivliostyle-page-rule-master",[],b,null,0);a=qn(c);new vn(this.d,this,c,a);this.u={};wn(this,c);this.b.position=new V(Yd,0);this.b.width=new V(a.width,0);this.b.height=new V(a.height,0);for(var d in c)rn[d]||"background-clip"===d||(this.b[d]=c[d])}t(un,Qk);function wn(a,b){var c=b._marginBoxes;c&&tn.forEach(function(d){c[d]&&(a.u[d]=new xn(a.d,a,d,b))})}un.prototype.f=function(a){return new yn(a,this)};
function vn(a,b,c,d){Uk.call(this,a,null,null,[],b);this.w=d;this.b["z-index"]=new V(new sd(0),0);this.b["flow-from"]=new V(I("body"),0);this.b.position=new V(xd,0);this.b.overflow=new V(ie,0);for(var e in rn)rn.hasOwnProperty(e)&&(this.b[e]=c[e])}t(vn,Uk);vn.prototype.f=function(a){return new zn(a,this)};
function xn(a,b,c,d){Uk.call(this,a,null,null,[],b);this.l=c;a=d._marginBoxes[this.l];for(var e in d)if(b=d[e],c=a[e],Ji[e]||c&&c.value===Ld)this.b[e]=b;for(e in a)Object.prototype.hasOwnProperty.call(a,e)&&(b=a[e])&&b.value!==Ld&&(this.b[e]=b)}t(xn,Uk);xn.prototype.f=function(a){return new An(a,this)};function yn(a,b){Rk.call(this,a,b);this.j=null;this.pa={}}t(yn,Rk);
yn.prototype.h=function(a,b){var c=this.B,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}Rk.prototype.h.call(this,a,b)};yn.prototype.Dc=function(){var a=this.style;a.left=ne;a["margin-left"]=ne;a["border-left-width"]=ne;a["padding-left"]=ne;a["padding-right"]=ne;a["border-right-width"]=ne;a["margin-right"]=ne;a.right=ne};
yn.prototype.Ec=function(){var a=this.style;a.top=ne;a["margin-top"]=ne;a["border-top-width"]=ne;a["padding-top"]=ne;a["padding-bottom"]=ne;a["border-bottom-width"]=ne;a["margin-bottom"]=ne;a.bottom=ne};yn.prototype.$=function(a,b,c){b=b.l;var d={start:this.j.marginLeft,end:this.j.marginRight,X:this.j.rb},e={start:this.j.marginTop,end:this.j.marginBottom,X:this.j.qb};Bn(this,b.top,!0,d,a,c);Bn(this,b.bottom,!0,d,a,c);Bn(this,b.left,!1,e,a,c);Bn(this,b.right,!1,e,a,c)};
function Cn(a,b,c,d,e){this.L=a;this.l=e;this.g=c;this.k=!Y(d,b[c?"width":"height"],new Wc(d,0,"px"));this.h=null}Cn.prototype.b=function(){return this.k};function Dn(a){a.h||(a.h=mn(a.l,a.L.d,a.g?["max-content width","min-content width"]:["max-content height","min-content height"]));return a.h}Cn.prototype.e=function(){var a=Dn(this);return this.g?ri(this.L)+a["max-content width"]+si(this.L):pi(this.L)+a["max-content height"]+qi(this.L)};
Cn.prototype.f=function(){var a=Dn(this);return this.g?ri(this.L)+a["min-content width"]+si(this.L):pi(this.L)+a["min-content height"]+qi(this.L)};Cn.prototype.d=function(){return this.g?ri(this.L)+this.L.width+si(this.L):pi(this.L)+this.L.height+qi(this.L)};function En(a){this.g=a}En.prototype.b=function(){return this.g.some(function(a){return a.b()})};En.prototype.e=function(){var a=this.g.map(function(a){return a.e()});return Math.max.apply(null,a)*a.length};
En.prototype.f=function(){var a=this.g.map(function(a){return a.f()});return Math.max.apply(null,a)*a.length};En.prototype.d=function(){var a=this.g.map(function(a){return a.d()});return Math.max.apply(null,a)*a.length};function Fn(a,b,c,d,e,f){Cn.call(this,a,b,c,d,e);this.j=f}t(Fn,Cn);Fn.prototype.b=function(){return!1};Fn.prototype.e=function(){return this.d()};Fn.prototype.f=function(){return this.d()};Fn.prototype.d=function(){return this.g?ri(this.L)+this.j+si(this.L):pi(this.L)+this.j+qi(this.L)};
function Bn(a,b,c,d,e,f){var g=a.d.d,k={},h={},l={},n;for(n in b){var p=sn[n];if(p){var q=b[n],r=a.pa[n],v=new Cn(q,r.style,c,g,f);k[p.ga]=q;h[p.ga]=r;l[p.ga]=v}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.X.evaluate(e);var y=Gn(l,b),J=!1,W={};Object.keys(k).forEach(function(a){var b=Y(g,h[a].style[c?"max-width":"max-height"],d.X);b&&(b=b.evaluate(e),y[a]>b&&(b=l[a]=new Fn(k[a],h[a].style,c,g,f,b),W[a]=b.d(),J=!0))});J&&(y=Gn(l,b),J=!1,["start","center","end"].forEach(function(a){y[a]=W[a]||y[a]}));
var P={};Object.keys(k).forEach(function(a){var b=Y(g,h[a].style[c?"min-width":"min-height"],d.X);b&&(b=b.evaluate(e),y[a]<b&&(b=l[a]=new Fn(k[a],h[a].style,c,g,f,b),P[a]=b.d(),J=!0))});J&&(y=Gn(l,b),["start","center","end"].forEach(function(a){y[a]=P[a]||y[a]}));var F=a+b,Ea=a+(a+b);["start","center","end"].forEach(function(a){var b=y[a];if(b){var d=k[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(Ea-b)/2;break;case "end":e=F-b}c?vi(d,e,b-ri(d)-si(d)):ui(d,e,b-pi(d)-qi(d))}})}
function Gn(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=Hn(d,g.length?new En(g):null,b);g.Na&&(f.center=g.Na);d=g.Na||d.d();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=Hn(c,e,b),c.Na&&(f.start=c.Na),c.Pb&&(f.end=c.Pb);return f}
function Hn(a,b,c){var d={Na:null,Pb:null};if(a&&b)if(a.b()&&b.b()){var e=a.e(),f=b.e();0<e&&0<f?(f=e+f,f<c?d.Na=c*e/f:(a=a.f(),b=b.f(),b=a+b,b<c?d.Na=a+(c-b)*(e-a)/(f-b):0<b&&(d.Na=c*a/b)),0<d.Na&&(d.Pb=c-d.Na)):0<e?d.Na=c:0<f&&(d.Pb=c)}else a.b()?d.Na=Math.max(c-b.d(),0):b.b()&&(d.Pb=Math.max(c-a.d(),0));else a?a.b()&&(d.Na=c):b&&b.b()&&(d.Pb=c);return d}yn.prototype.eb=function(a,b,c,d){yn.ud.eb.call(this,a,b,c,d);b.d.setAttribute("data-vivliostyle-page-box",!0)};
function zn(a,b){Vk.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.qb=this.rb=null}t(zn,Vk);
zn.prototype.h=function(a,b){var c=this.B,d;for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(d.match(/^column.*$/)||d.match(/^background-/))&&(c[d]=b[d]);Vk.prototype.h.call(this,a,b);d=this.e;c={rb:this.rb,qb:this.qb,marginTop:this.marginTop,marginRight:this.marginRight,marginBottom:this.marginBottom,marginLeft:this.marginLeft};d.j=c;d=d.style;d.width=new L(c.rb);d.height=new L(c.qb);d["padding-left"]=new L(c.marginLeft);d["padding-right"]=new L(c.marginRight);d["padding-top"]=new L(c.marginTop);
d["padding-bottom"]=new L(c.marginBottom)};zn.prototype.Dc=function(){var a=In(this,{start:"left",end:"right",X:"width"});this.rb=a.kd;this.marginLeft=a.rd;this.marginRight=a.qd};zn.prototype.Ec=function(){var a=In(this,{start:"top",end:"bottom",X:"height"});this.qb=a.kd;this.marginTop=a.rd;this.marginBottom=a.qd};
function In(a,b){var c=a.style,d=a.d.d,e=b.start,f=b.end,g=b.X,k=a.d.w[g].fa(d,null),h=Y(d,c[g],k),l=Y(d,c["margin-"+e],k),n=Y(d,c["margin-"+f],k),p=Wk(d,c["padding-"+e],k),q=Wk(d,c["padding-"+f],k),r=Yk(d,c["border-"+e+"-width"],c["border-"+e+"-style"],k),v=Yk(d,c["border-"+f+"-width"],c["border-"+f+"-style"],k),y=G(d,k,E(d,E(d,r,p),E(d,v,q)));h?(y=G(d,y,h),l||n?l?n=G(d,y,l):l=G(d,y,n):n=l=dd(d,y,new B(d,.5))):(l||(l=d.b),n||(n=d.b),h=G(d,y,E(d,l,n)));c[e]=new L(l);c[f]=new L(n);c["margin-"+e]=ne;
c["margin-"+f]=ne;c["padding-"+e]=new L(p);c["padding-"+f]=new L(q);c["border-"+e+"-width"]=new L(r);c["border-"+f+"-width"]=new L(v);c[g]=new L(h);c["max-"+g]=new L(h);return{kd:G(d,k,E(d,l,n)),rd:l,qd:n}}zn.prototype.eb=function(a,b,c,d){Vk.prototype.eb.call(this,a,b,c,d);c.u=b.d};function An(a,b){Vk.call(this,a,b);var c=b.l;this.j=sn[c];a.pa[c]=this;this.va=!0}t(An,Vk);m=An.prototype;
m.eb=function(a,b,c,d){var e=b.d;w(e,"display","flex");var f=gl(this,a,"vertical-align"),g=null;f===I("middle")?g="center":f===I("top")?g="flex-start":f===I("bottom")&&(g="flex-end");g&&(w(e,"flex-flow",this.b?"row":"column"),w(e,"justify-content",g));Vk.prototype.eb.call(this,a,b,c,d)};
m.ga=function(a,b){var c=this.style,d=this.d.d,e=a.start,f=a.end,g="left"===e,k=g?b.rb:b.qb,h=Y(d,c[a.X],k),g=g?b.marginLeft:b.marginTop;if("start"===this.j.ga)c[e]=new L(g);else if(h){var l=Wk(d,c["margin-"+e],k),n=Wk(d,c["margin-"+f],k),p=Wk(d,c["padding-"+e],k),q=Wk(d,c["padding-"+f],k),r=Yk(d,c["border-"+e+"-width"],c["border-"+e+"-style"],k),f=Yk(d,c["border-"+f+"-width"],c["border-"+f+"-style"],k),h=E(d,h,E(d,E(d,p,q),E(d,E(d,r,f),E(d,l,n))));switch(this.j.ga){case "center":c[e]=new L(E(d,g,
ed(d,G(d,k,h),new B(d,2))));break;case "end":c[e]=new L(G(d,E(d,g,k),h))}}};
function Jn(a,b,c){function d(a){if(y)return y;y={X:v?v.evaluate(a):null,Ca:h?h.evaluate(a):null,Da:l?l.evaluate(a):null};var b=k.evaluate(a),c=0;[q,n,p,r].forEach(function(b){b&&(c+=b.evaluate(a))});(null===y.Ca||null===y.Da)&&c+y.X+y.Ca+y.Da>b&&(null===y.Ca&&(y.Ca=0),null===y.Da&&(y.ae=0));null!==y.X&&null!==y.Ca&&null!==y.Da&&(y.Da=null);null===y.X&&null!==y.Ca&&null!==y.Da?y.X=b-c-y.Ca-y.Da:null!==y.X&&null===y.Ca&&null!==y.Da?y.Ca=b-c-y.X-y.Da:null!==y.X&&null!==y.Ca&&null===y.Da?y.Da=b-c-y.X-
y.Ca:null===y.X?(y.Ca=y.Da=0,y.X=b-c):y.Ca=y.Da=(b-c-y.X)/2;return y}var e=a.style;a=a.d.d;var f=b.Fc,g=b.Jc;b=b.X;var k=G(a,c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],new B(a,2)),h=Xk(a,e["margin-"+f],k),l=Xk(a,e["margin-"+g],k),n=Wk(a,e["padding-"+f],k),p=Wk(a,e["padding-"+g],k),q=Yk(a,e["border-"+f+"-width"],e["border-"+f+"-style"],k),r=Yk(a,e["border-"+g+"-width"],e["border-"+g+"-style"],k),v=Y(a,e[b],k),y=null;e[b]=new L(new oc(a,function(){var a=d(this).X;return null===a?0:a},b));
e["margin-"+f]=new L(new oc(a,function(){var a=d(this).Ca;return null===a?0:a},"margin-"+f));e["margin-"+g]=new L(new oc(a,function(){var a=d(this).Da;return null===a?0:a},"margin-"+g));"left"===f?e.left=new L(E(a,c.marginLeft,c.rb)):"top"===f&&(e.top=new L(E(a,c.marginTop,c.qb)))}m.Dc=function(){var a=this.e.j;this.j.ra?Jn(this,{Fc:"right",Jc:"left",X:"width"},a):this.j.sa?Jn(this,{Fc:"left",Jc:"right",X:"width"},a):this.ga({start:"left",end:"right",X:"width"},a)};
m.Ec=function(){var a=this.e.j;this.j.ta?Jn(this,{Fc:"bottom",Jc:"top",X:"height"},a):this.j.qa?Jn(this,{Fc:"top",Jc:"bottom",X:"height"},a):this.ga({start:"top",end:"bottom",X:"height"},a)};m.Zb=function(a,b,c,d,e,f,g){Vk.prototype.Zb.call(this,a,b,c,d,e,f,g);a=c.l;c=this.d.l;d=this.j;d.ra||d.sa?d.ta||d.qa||(d.ra?a.left[c]=b:d.sa&&(a.right[c]=b)):d.ta?a.top[c]=b:d.qa&&(a.bottom[c]=b)};
function Kn(a,b,c,d,e){this.b=a;this.h=b;this.f=c;this.d=d;this.e=e;this.g={};a=this.h;b=new Xc(a,"page-number");b=new Pc(a,new Vc(a,b,new B(a,2)),a.b);c=new Fc(a,b);a.values["recto-page"]=c;a.values["verso-page"]=b;"ltr"===nn(this.e)?(a.values["left-page"]=b,b=new Fc(a,b),a.values["right-page"]=b):(c=new Fc(a,b),a.values["left-page"]=c,a.values["right-page"]=b)}function Ln(a){var b={};Xj(a.b,[],"",b);a.b.pop();return b}
function Mn(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof V?e.value+"":Mn(a,e);c.push(d+f+(e.Ea||""))}return c.sort().join("^")}function Nn(a){this.b=null;this.f=a}t(Nn,X);Nn.prototype.apply=function(a){a.I===this.f&&this.b.apply(a)};Nn.prototype.d=function(){return 3};Nn.prototype.e=function(a){this.b&&ij(a.Fb,this.f,this.b);return!0};function On(a){this.b=null;this.f=a}t(On,X);
On.prototype.apply=function(a){1===(new Xc(this.f,"page-number")).evaluate(a.d)&&this.b.apply(a)};On.prototype.d=function(){return 2};function Pn(a){this.b=null;this.f=a}t(Pn,X);Pn.prototype.apply=function(a){(new Xc(this.f,"left-page")).evaluate(a.d)&&this.b.apply(a)};Pn.prototype.d=function(){return 1};function Qn(a){this.b=null;this.f=a}t(Qn,X);Qn.prototype.apply=function(a){(new Xc(this.f,"right-page")).evaluate(a.d)&&this.b.apply(a)};Qn.prototype.d=function(){return 1};
function Rn(a){this.b=null;this.f=a}t(Rn,X);Rn.prototype.apply=function(a){(new Xc(this.f,"recto-page")).evaluate(a.d)&&this.b.apply(a)};Rn.prototype.d=function(){return 1};function Sn(a){this.b=null;this.f=a}t(Sn,X);Sn.prototype.apply=function(a){(new Xc(this.f,"verso-page")).evaluate(a.d)&&this.b.apply(a)};Sn.prototype.d=function(){return 1};function Tn(a,b){gj.call(this,a,b,null,null)}t(Tn,gj);
Tn.prototype.apply=function(a){var b=a.d,c=a.w,d=this.style;a=this.b;aj(b,c,d,a,null,null);if(d=d._marginBoxes){var c=Zi(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);aj(b,f,d[e],a,null,null)}}};function Un(a,b,c,d){fk.call(this,a,b,null,c,null,d,!1);this.f=""}t(Un,fk);m=Un.prototype;m.ub=function(){this.f+="@page ";this.hb()};m.$a=function(a,b){this.f+=b;b&&(this.b.push(new Nn(b)),this.d+=65536)};
m.Gb=function(a,b){b&&Jf(this,"E_INVALID_PAGE_SELECTOR :"+a+"("+b.join("")+")");this.f+=":"+a;switch(a.toLowerCase()){case "first":this.b.push(new On(this.e));this.d+=256;break;case "left":this.b.push(new Pn(this.e));this.d+=1;break;case "right":this.b.push(new Qn(this.e));this.d+=1;break;case "recto":this.b.push(new Rn(this.e));this.d+=1;break;case "verso":this.b.push(new Sn(this.e));this.d+=1;break;default:Jf(this,"E_INVALID_PAGE_SELECTOR :"+a)}};m.la=function(){this.f+="{";fk.prototype.la.call(this)};
m.Ua=function(){this.f+="}";document.getElementById("vivliostyle-page-rules").textContent+=this.f;fk.prototype.Ua.call(this)};
m.Ka=function(a,b,c){if("size"===a){var d=b.ad()&&b.values[1]===Pd,e=(d?b.values[0]:b).toString().toLowerCase(),f=on[e];f&&("a5"===e||"a4"===e||"a3"===e||"b5"===e||"b4"===e||"letter"===e||"legal"===e||"ledger"===e?d&&(e+=" landscape"):(e=f.width.stringValue(),f=f.height.stringValue(),e=d?f+" "+e:e+" "+f));this.f+="size: "+e+(c?" !important":"")+";"}fk.prototype.Ka.call(this,a,b,c)};m.nd=function(a){ij(this.h.Fb,"*",a)};m.pd=function(a){return new Tn(this.k,a)};
m.Oc=function(a){var b=Zi(this.k,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);Ff(this.Y,new Vn(this.e,this.Y,this.u,c))};function Vn(a,b,c,d){Gf.call(this,a,b,!1);this.d=c;this.b=d}t(Vn,Hf);Vn.prototype.Ka=function(a,b,c){eh(this.d,a,b,c,this)};Vn.prototype.Db=function(a,b){If(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Vn.prototype.mc=function(a,b){If(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};Vn.prototype.gb=function(a,b,c){Yi(this.b,a,new V(b,c?Cf(this):Df(this)))};
function Wn(a){this.d=a;this.b={};this.b.page=[0]}function Xn(a,b){Object.keys(b.b).forEach(function(a){this.b[a]=Array.b(b.b[a])},a)}function Oj(a,b,c){return new oc(a.d,function(){var d=a.b[b];return c(d&&d.length?d[d.length-1]:null)},"page-counter-"+b)}function Qj(a,b,c){return new oc(a.d,function(){return c(a.b[b]||[])},"page-counters-"+b)}
function Yn(a,b,c){var d,e=b["counter-reset"];e&&(e=e.evaluate(c))&&(d=qg(e,!0));if(d)for(var f in d){var e=a,g=f,k=d[f];e.b[g]?e.b[g].push(k):e.b[g]=[k]}var h;(b=b["counter-increment"])&&(c=b.evaluate(c))&&(h=qg(c,!1));h?"page"in h||(h.page=1):h={page:1};for(var l in h)a.b[l]||(c=a,b=l,c.b[b]?c.b[b].push(0):c.b[b]=[0]),c=a.b[l],c[c.length-1]+=h[l]};function Zn(a,b,c,d,e,f,g,k,h){this.h=a;this.g=b;this.b=c;this.d=d;this.w=e;this.f=f;this.l=a.D;this.u=g;this.e=k;this.k=h;this.j=a.f;qc(this.b,function(a){return(a=this.b.b[a])?0<a.b.length&&a.b[0].b.b<=this.j:!1});pc(this.b,new oc(this.b,function(){return this.va+this.b.d},"page-number"))}
...
function ao(a,b,c,d,e,f,g,k,h){tc.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.Z=b;this.lang=b.lang||c;this.viewport=d;this.e={body:!0};this.g=e;this.b=this.I=this.d=this.l=null;this.j=0;this.Ta=f;this.f=new lh(this.style.l);this.pa={};this.$=null;this.k=new Wn(a.b);this.M={};this.ma=null;this.Fa=g;this.Ga=k;this.va=h;for(var l in a.e)(b=a.e[l]["flow-consume"])&&(b.evaluate(this,"flow-consume")==yd?this.e[l]=!0:delete this.e[l])}t(ao,tc);
function bo(a){var b=M("StyleInstance.init");a.d=new wk(a.Z,a.style.d,a.style.g,a,a.e,a.style.j,a.k);var c=a.d;c.k=a;for(var d=0;d<c.B.length;d++)Ek(c.k,c.B[d]);a.I={};c=a.I[a.Z.url]=a.d;for(d=0;!c.j&&(d+=5E3,Fk(c,d,0)!=Number.POSITIVE_INFINITY););c=c.u;a.ma=nn(c);a.l=new vl(a.style.w);d=new Uj(a.style.d,a,a.k);a.l.h(d,c);ul(a.l,a);a.$=new Kn(d,a.style.b,a.l,a,c);c=[];for(d=0;d<a.style.f.length;d++){var e=a.style.f[d];if(!e.J||e.J.evaluate(a)){var f=e.lb,g=a,e={},k=void 0;for(k in f)e[k]=f[k].evaluate(g,
k);f=e;g=void 0;for(g in gh)f[g]||(f[g]=gh[g]);e=new jh(e);c.push(e)}}d=a.Ta;a=a.f;e=[];for(f=0;f<c.length;f++)g=c[f],g.src&&g.b?e.push(qh(d,g,a)):u.b("E_FONT_FACE_INVALID");sg(e).oa(b);return O(b)}function Ek(a,b){var c=a.b;if(c){var d=c.b[b.f];d||(d=new mi,c.b[b.f]=d);d.b.push(new li(new ki({ha:[{ea:b.g,La:0,ba:null,ua:null,na:null}],aa:0,K:!1}),b))}}
function co(a,b){if(!b)return 0;var c=Number.POSITIVE_INFINITY,d;for(d in a.e){var e=b.b[d];if((!e||0==e.b.length)&&a.b){var f=a.d;f.l=d;for(e=0;null!=f.l&&(e+=5E3,Fk(f,e,0)!=Number.POSITIVE_INFINITY););e=a.b.b[d];b!=a.b&&e&&(e=e.clone(),b.b[d]=e)}if(e){for(var f=a,g=Number.POSITIVE_INFINITY,k=0;k<e.b.length;k++){for(var h=e.b[k].d.Qa,l=h.ha[0].ea,n=h.aa,p=h.K,q=0;l.ownerDocument!=f.Z.b;)q++,l=h.ha[q].ea,p=!1,n=0;h=wh(f.Z,l,n,p);h<g&&(g=h)}f=g;f<c&&(c=f)}}return c}
function eo(a,b){var c=co(a,a.b);if(c==Number.POSITIVE_INFINITY)return null;for(var d=a.l.children,e,f=0;f<d.length;f++)if(e=d[f],"vivliostyle-page-rule-master"!==e.d.fb){var g=1,k=gl(e,a,"utilization");k&&k.$c()&&(g=k.C);k=vc(a,"em",!1);a.j=Fk(a.d,c,Math.ceil(g*a.w()*a.u()/(k*k)));var g=a,k=g.b.d,h=void 0;for(h in g.b.b)for(var l=g.b.b[h],n=l.b.length-1;0<=n;n--){var p=l.b[n];0>p.b.e&&p.b.b<g.j&&(p.b.e=k)}uc(a,a.style.b);g=gl(e,a,"enabled");if(!g||g===je){d=a;u.debug("Location - page",d.b.d);u.debug("  current:",
c);u.debug("  lookup:",d.j);c=void 0;for(c in d.b.b)for(f=d.b.b[c],g=0;g<f.b.length;g++)u.debug("  Chunk",c+":",f.b[g].b.b);c=a.$;f=b;g=e.d;if(0===Object.keys(f).length)g.d.e=g;else{e=g;d=Mn(c,f);e=e.g+"^"+d;d=c.g[e];if(!d){if("background-host"===g.fb)d=c,f=(new un(d.h,d.f.d,f)).f(d.f),f.h(d.b,d.e),ul(f,d.d),d=f;else{d=c;k=f;f=g.clone({fb:"vivliostyle-page-rule-master"});if(g=k.size)k=qn(k),g=g.Ea,f.b.width=Vi(d.d,f.b.width,new V(k.width,g)),f.b.height=Vi(d.d,f.b.height,new V(k.height,g));f=f.f(d.f);
f.h(d.b,d.e);ul(f,d.d);d=f}c.g[e]=d}e=d.d;e.d.e=e;e=d}return e}}throw Error("No enabled page masters");}
function fo(a,b,c){var d=a.b.b[c];if(!d)return N(!0);Hm(b);a.e[c]&&0<b.Qb.length&&(b.hd=!1);var e=M("layoutColumn"),f=[];pf(function(c){for(;0<d.b.length;){var e=0,h=d.b[e];if(h.b.b>a.j)break;for(var l=1;l<d.b.length;l++){var n=d.b[l];if(n.b.b>a.j)break;$h(n.b,h.b)&&(h=n,e=l)}var p=h.b,q=!0;Km(b,h.d).then(function(a){h.b.Id&&(null===a||p.d)&&f.push(h);p.d?(d.b.splice(e,1),R(c)):a?(h.d=a,R(c)):(d.b.splice(e,1),q?q=!1:rf(c))});if(q){q=!1;return}}R(c)}).then(function(){0<f.length&&(d.b=f.concat(d.b));
Q(e,!0)});return O(e)}
function go(a,b,c,d,e,f,g,k){var h=gl(c,a,"enabled");if(h&&h!==je)return N(!0);var l=M("layoutContainer"),n=gl(c,a,"wrap-flow")===Ad,p=c.b?c.g&&c.D:c.f&&c.I,h=gl(c,a,"flow-from"),q=a.viewport.b.createElement("div"),r=gl(c,a,"position");w(q,"position",r?r.name:"absolute");d.insertBefore(q,d.firstChild);var v=new oi(q);v.b=c.b;c.eb(a,v,b,a.f);v.A=e;v.B=f;e+=v.left+v.marginLeft+v.$;f+=v.top+v.marginTop+v.ca;if(h&&h.od())if(a.M[h.toString()])c.Zb(a,v,b,null,1,a.g,a.f),h=N(!0);else{var y=M("layoutContainer.inner"),
J=h.toString(),W=Z(c,a,"column-count"),P=Z(c,a,"column-gap"),F=1<W?Z(c,a,"column-width"):v.width,h=fl(c,a),Ea=0,r=gl(c,a,"shape-inside"),ob=og(r,0,0,v.width,v.height,a),Jk=new Jl(J,a,a.viewport,a.d,h,a.Z,a.f,a.style.u,a,b,a.Fa,a.Ga,k),sh=0,aa=null;pf(function(b){for(;sh<W;){var c=sh++;if(1<W){var d=a.viewport.b.createElement("div");w(d,"position","absolute");q.appendChild(d);aa=new om(d,Jk,a.g);aa.b=v.b;aa.Ga=v.Ga;aa.Ub=v.Ub;v.b?(w(d,"margin-left",v.j+"px"),w(d,"margin-right",v.D+"px"),c=c*(F+P)+
v.k,vi(aa,0,v.width),ui(aa,c,F)):(w(d,"margin-top",v.k+"px"),w(d,"margin-bottom",v.w+"px"),c=c*(F+P)+v.j,ui(aa,0,v.height),vi(aa,c,F));aa.A=e+v.j;aa.B=f+v.k}else aa=new om(q,Jk,a.g),ti(aa,v),v=aa;aa.I=p?[]:g;aa.Sb=ob;if(0<=aa.width){var h=M("inner");fo(a,aa,J).then(function(){aa.M&&"column"!=aa.M&&(sh=W,"region"!=aa.M&&(a.M[J]=!0));Q(h,!0)});c=O(h)}else c=N(!0);if(c.ya()){c.then(function(){0<k.b.length?R(b):(Ea=Math.max(Ea,aa.e),rf(b))});return}0<k.b.length||(Ea=Math.max(Ea,aa.e))}R(b)}).then(function(){v.e=
Ea;c.Zb(a,v,b,aa,W,a.g,a.f);Q(y,!0)});h=O(y)}else{h=gl(c,a,"content");r=!1;if(h&&xi(h)){var Kk=a.viewport.b.createElement("span");h.R(new wi(Kk,a));q.appendChild(Kk);tl(c,a,v,a.f)}else c.va&&(d.removeChild(q),r=!0);r||c.Zb(a,v,b,null,1,a.g,a.f);h=N(!0)}h.then(function(){if(!c.f||0<Math.floor(v.e)){if(!n){var h=v.A+v.left,p=v.B+v.top,r=ri(v)+v.width+si(v),y=pi(v)+v.height+qi(v),F=gl(c,a,"shape-outside"),h=og(F,h,p,r,y,a);hb(a.viewport.root)&&g.push(ye(h,0,-1.25*vc(a,"em",!1)));g.push(h)}}else if(0==
c.children.length){d.removeChild(q);Q(l,!0);return}var J=c.children.length-1;of(function(){for(;0<=J;){var d=c.children[J--],d=go(a,b,d,q,e,f,g,k);if(d.ya())return d}return N(!1)}).then(function(){Q(l,!0)})});return O(l)}
function ho(a,b,c){a.M={};c?(a.b=c.clone(),zk(a.d,c.e)):(a.b=new ni,zk(a.d,-1));a.lang&&b.L.setAttribute("lang",a.lang);c=a.b;c.d++;uc(a,a.style.b);var d=Ln(a.$);io(a,d);var e=eo(a,d);if(!e)return N(null);e.d.b.width.value===le&&Vh(b);e.d.b.height.value===me&&Wh(b);Yn(a.k,d,a);var d=gl(e,a,"writing-mode")||Kd,f=gl(e,a,"direction")||Sd,g=new Ai(b.w.bind(b),d,f),k=c.clone(),h=[],l=M("layoutNextPage");pf(function(d){go(a,b,e,b.L,0,0,h.concat(),g).then(function(){if(0<g.b.length){h=h.concat(Fi(g));g.b.splice(0,
...
for(d=0;d<f.length;d++)if(g=f[d],k=b.h[g.Ib],h=b.h[g.Fd],k&&h&&(k=Th(k,g.action)))for(var y=0;y<h.length;y++)h[y].addEventListener(g.event,k,!1);var J;a:{for(J in a.e)if((f=c.b[J])&&0<f.b.length){J=!1;break a}J=!0}J&&(c=null);Q(l,c)});return O(l)}function io(a,b){var c=qn(b),d=c.width;d===le?a.B=null:a.B=d.C*vc(a,d.ia,!1);c=c.height;c===me?a.A=null:a.A=c.C*vc(a,c.ia,!1)}function jo(a,b,c,d){fk.call(this,a.g,a,b,c,d,a.f,!c);this.f=a;this.A=!1}t(jo,fk);m=jo.prototype;m.ic=function(){};
m.hc=function(a,b,c){a=new Qk(this.f.j,a,b,c,this.f.u,this.J,Df(this.Y));Ff(this.f,new Al(a.d,this.f,a,this.u))};m.mb=function(a){a=a.d;null!=this.J&&(a=cd(this.e,this.J,a));Ff(this.f,new jo(this.f,a,this,this.B))};m.ec=function(){Ff(this.f,new ik(this.e,this.Y))};m.gc=function(){var a={};this.f.k.push({lb:a,J:this.J});Ff(this.f,new jk(this.e,this.Y,null,a,this.f.f))};m.fc=function(a){var b=this.f.h[a];b||(b={},this.f.h[a]=b);Ff(this.f,new jk(this.e,this.Y,null,b,this.f.f))};
m.kc=function(){var a={};this.f.w.push(a);Ff(this.f,new jk(this.e,this.Y,this.J,a,this.f.f))};m.Jb=function(a){var b=this.f.l;if(a){var c=Zi(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Ff(this.f,new jk(this.e,this.Y,null,b,this.f.f))};m.jc=function(){this.A=!0;this.hb()};m.ub=function(){var a=new Un(this.f.j,this.f,this,this.u);Ff(this.f,a);a.ub()};
m.la=function(){fk.prototype.la.call(this);if(this.A){this.A=!1;var a="R"+this.f.B++,b=I(a),c;this.J?c=new Ui(b,0,this.J):c=new V(b,0);$i(this.k,"region-id").push(c);this.Ua();a=new jo(this.f,this.J,this,a);Ff(this.f,a);a.la()}};
function ko(a){var b=a.getAttribute("content");if(!b)return"";a={};for(var c;null!=(c=b.match(/^,?\s*([-A-Za-z_.][-A-Za-z_0-9.]*)\s*=\s*([-+A-Za-z_0-9.]*)\s*/));)b=b.substr(c[0].length),a[c[1]]=c[2];b=a.width-0;a=a.height-0;return b&&a?"@-epubx-viewport{width:"+b+"px;height:"+a+"px;}":""}function lo(a){Ef.call(this);this.f=a;this.g=new mc(null);this.j=new mc(this.g);this.u=new Nk(this.g);this.A=new jo(this,null,null,null);this.B=0;this.k=[];this.l={};this.h={};this.w=[];this.b=this.A}t(lo,Ef);
lo.prototype.error=function(a){u.b("CSS parser:",a)};function mo(a,b){return no(b,a)}function oo(a){vf.call(this,mo,"document");this.D=a;this.A={};this.h={};this.b={};this.B={};this.f=null;this.j=[]}t(oo,vf);function po(a){var b=ta("user-agent.xml",sa),c=M("OPSDocStore.init");wf(fh).then(function(d){a.f=d;wf(lk).then(function(){a.load(b).then(function(){Q(c,!0)})})});return O(c)}function qo(a,b){a.j.push({url:b.url,text:b.text,Va:"User",xa:null,media:null})}
function no(a,b){var c=M("OPSDocStore.load"),d=b.url;Eh(b,a).then(function(b){if(b){for(var f=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),k=0;k<g.length;k++){var h=g[k],l=h.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),n=h.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=h.getAttribute("action"),h=h.getAttribute("ref");l&&n&&p&&h&&f.push({Fd:l,event:n,action:p,Ib:h})}a.B[d]=f;var q=[],f=ta("user-agent-page.css",sa);q.push({url:f,text:null,
...
l&&"viewport"==g.getAttribute("name")&&q.push({url:d,text:ko(g),Va:"Author",J:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==k?"stylesheet"==l&&"text/css"==g.getAttribute("type")&&q.push({url:d,text:g.textContent,Va:"Author",xa:null,media:null}):"http://example.com/sse"==k&&"property"===l&&(k=g.getElementsByTagName("name")[0])&&"stylesheet"===k.textContent&&(g=g.getElementsByTagName("value")[0])&&(g=ta(g.textContent,d),q.push({url:g,text:null,xa:null,media:null,Va:"Author"}));
for(var r="",k=0;k<q.length;k++)r+=q[k].url,r+="^",q[k].text&&(r+=q[k].text),r+="^";var v=a.A[r];v?(a.b[d]=v,Q(c,b)):(f=a.h[r],f||(f=new yf(function(){var b=M("fetchStylesheet"),c=0,d=new lo(a.f);of(function(){if(c<q.length){var a=q[c++];d.vb(a.Va);return null!==a.text?gg(a.text,d,a.url,a.xa,a.media).Pc(!0):fg(a.url,d,a.xa,a.media)}return N(!1)}).then(function(){v=new Zn(a,d.g,d.j,d.A.h,d.u,d.k,d.l,d.h,d.w);a.A[r]=v;delete a.h[r];Q(b,v)});return O(b)},"FetchStylesheet "+d),a.h[r]=f,f.start()),wf(f).then(function(f){a.b[d]=
f;Q(c,b)}))}else Q(c,null)});return O(c)};function ro(a,b,c,d,e,f,g,k){this.d=a;this.url=b;this.lang=c;this.e=d;this.g=e;this.Q=ec(f);this.h=g;this.f=k;this.Ia=this.b=null}function so(a,b,c){if(0!=c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=Pa(d,"height","auto")&&(w(d,"height","auto"),so(a,d,c));"absolute"==Pa(d,"position","static")&&(w(d,"position","relative"),so(a,d,c))}}
function to(a){var b=a.target,c="\u25b8"==b.textContent;b.textContent=c?"\u25be":"\u25b8";for(b=b.parentNode.firstChild;b;)if(1!=b.nodeType)b=b.nextSibling;else{var d=b;"toc-container"==d.getAttribute("data-adapt-class")?b=d.firstChild:("toc-node"==d.getAttribute("data-adapt-class")&&(d.style.height=c?"auto":"0px"),b=b.nextSibling)}a.stopPropagation()}
ro.prototype.Gc=function(a){var b=this.h.Gc(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",w(e,"cursor","pointer"),e.addEventListener("click",to,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
ro.prototype.dc=function(a,b,c,d,e){if(this.b)return N(this.b);var f=this,g=M("showTOC"),k=new Uh(a);this.b=k;this.d.load(this.url).then(function(d){var l=f.d.b[d.url],n=$n(l,c,1E5,e);b=new dm(b.f,n.fontSize,b.root,n.width,n.height);var p=new ao(l,d,f.lang,b,f.e,f.g,f.Gc(d),f.f,0);f.Ia=p;p.Q=f.Q;bo(p).then(function(){ho(p,k,null).then(function(){so(f,a,2);Q(g,k)})})});return O(g)};
ro.prototype.$b=function(){if(this.b){var a=this.b;this.Ia=this.b=null;w(a.L,"visibility","none");var b=a.L.parentNode;b&&b.removeChild(a.L)}};ro.prototype.bd=function(){return!!this.b};function uo(){oo.call(this,vo(this));this.d=new vf(Eh,"document");this.u=new vf(zf,"text");this.w={};this.M={};this.k={};this.l={}}t(uo,oo);function vo(a){return function(b){return a.k[b]}}
function wo(a,b,c){var d=M("loadEPUBDoc");"/"!==b.substring(b.length-1)&&(b+="/");c&&a.u.Yb(b+"?r=list");a.d.Yb(b+"META-INF/encryption.xml");var e=b+"META-INF/container.xml";a.d.load(e,!0,"Failed to fetch EPUB container.xml from "+e).then(function(f){if(f){f=Ph(th(th(th(new uh([f.b]),"container"),"rootfiles"),"rootfile"),"full-path");for(var g=0;g<f.length;g++){var k=f[g];if(k){xo(a,b,k,c).oa(d);return}}Q(d,null)}else u.error("Received an empty response for EPUB container.xml "+e+". This may be caused by the server not allowing cross origin requests.")});
return O(d)}function xo(a,b,c,d){var e=b+c,f=a.w[e];if(f)return N(f);var g=M("loadOPF");a.d.load(e,void 0,void 0).then(function(c){c?a.d.load(b+"META-INF/encryption.xml",void 0,void 0).then(function(h){(d?a.u.load(b+"?r=list"):N(null)).then(function(d){f=new yo(a,b);zo(f,c,h,d,b+"?r=manifest").then(function(){a.w[e]=f;a.M[b]=f;Q(g,f)})})}):u.error("Received an empty response for EPUB OPF "+e+". This may be caused by the server not allowing cross origin requests.")});return O(g)}
uo.prototype.load=function(a){var b=ra(a);if(a=this.l[b])return a.ya()?a:N(a.Wb());var c=M("EPUBDocStore.load");a=uo.ud.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?Q(c,a):u.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return O(c)};function Ao(){this.id=null;this.src="";this.g=this.d=null;this.F=-1;this.h=0;this.j=null;this.b=this.e=0;this.f=ab}function Bo(a){return a.id}
function Co(a){var b=Re(a);return function(a){var d=M("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));uf(e).then(function(a){a=new DataView(a);for(var c=0;c<a.byteLength;c++){var e=a.getUint8(c),e=e^b[c%20];a.setUint8(c,e)}Q(d,tf([a,f]))});return O(d)}}
var Do={dcterms:"http://purl.org/dc/terms/",marc:"http://id.loc.gov/vocabulary/",media:"http://www.idpf.org/epub/vocab/overlays/#",onix:"http://www.editeur.org/ONIX/book/codelists/current.html#",xsd:"http://www.w3.org/2001/XMLSchema#"},Eo=Do.dcterms+"language",Fo=Do.dcterms+"title";
function Go(a,b){var c={};return function(d,e){var f,g,k=d.r||c,h=e.r||c;if(a==Fo&&(f="main"==k["http://idpf.org/epub/vocab/package/#title-type"],g="main"==h["http://idpf.org/epub/vocab/package/#title-type"],f!=g))return f?-1:1;f=parseInt(k["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(f)&&(f=Number.MAX_VALUE);g=parseInt(h["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(g)&&(g=Number.MAX_VALUE);return f!=g?f-g:a!=Eo&&b&&(f=(k[Eo]||k["http://idpf.org/epub/vocab/package/#alternate-script"])==
b,g=(h[Eo]||h["http://idpf.org/epub/vocab/package/#alternate-script"])==b,f!=g)?f?-1:1:d.o-e.o}}
function Ho(a,b){function c(a){for(var b in a){var d=a[b];d.sort(Go(b,l));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return db(a,function(a){return cb(a,function(a){var b={v:a.value,o:a.N};a.be&&(b.s=a.scheme);if(a.id||a.lang){var c=h[a.id];if(c||a.lang)a.lang&&(a={name:Eo,value:a.lang,lang:null,id:null,Mc:a.id,scheme:null,N:a.N},c?c.push(a):c=[a]),c=bb(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in Do)f[g]=Do[g];for(;null!=(g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/));)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=Do;var k=1;g=Nh(Oh(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),N:k++,Mc:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:Do.dcterms+a.localName,N:k++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Mc:null,scheme:null};return null});var h=bb(g,function(a){return a.Mc});g=d(bb(g,function(a){return a.Mc?null:a.name}));var l=null;g[Eo]&&(l=g[Eo][0].v);c(g);return g}function Io(){var a=window.MathJax;return a?a.Hub:null}var Jo={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function yo(a,b){this.e=a;this.g=this.d=this.b=this.h=this.f=null;this.k=b;this.j=null;this.D={};this.lang=null;this.u=0;this.l={};this.I=this.B=this.M=null;this.w={};this.A=null;Io()&&(Ki["http://www.w3.org/1998/Math/MathML"]=!0)}function Ko(a,b){return a.k?b.substr(0,a.k.length)==a.k?decodeURI(b.substr(a.k.length)):null:b}
function zo(a,b,c,d,e){a.f=b;var f=th(new uh([b.b]),"package"),g=Ph(f,"unique-identifier")[0];g&&(g=Ah(b,b.url+"#"+g))&&(a.j=g.textContent.replace(/[ \n\r\t]/g,""));var k={};a.h=cb(Kh(th(th(f,"manifest"),"item")),function(c){var d=new Ao,e=b.url;d.id=c.getAttribute("id");d.src=ta(c.getAttribute("href"),e);d.d=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.f=f}(c=c.getAttribute("fallback"))&&!Jo[d.d]&&(k[d.src]=c);!a.B&&
d.f.nav&&(a.B=d);!a.I&&d.f["cover-image"]&&(a.I=d);return d});a.d=$a(a.h,Bo);a.g=$a(a.h,function(b){return Ko(a,b.src)});for(var h in k)for(g=h;;){g=a.d[k[g]];if(!g)break;if(Jo[g.d]){a.w[h]=g.src;break}g=g.src}a.b=cb(Kh(th(th(f,"spine"),"itemref")),function(b,c){var d=b.getAttribute("idref");if(d=a.d[d])d.g=b,d.F=c;return d});if(h=Ph(th(f,"spine"),"toc")[0])a.M=a.d[h];if(h=Ph(th(f,"spine"),"page-progression-direction")[0]){a:switch(h){case "ltr":h="ltr";break a;case "rtl":h="rtl";break a;default:throw Error("unknown PageProgression: "+
h);}a.A=h}var g=c?Ph(th(th(Jh(th(th(new uh([c.b]),"encryption"),"EncryptedData"),Ih()),"CipherData"),"CipherReference"),"URI"):[],l=Kh(th(th(f,"bindings"),"mediaType"));for(c=0;c<l.length;c++){var n=l[c].getAttribute("handler");(h=l[c].getAttribute("media-type"))&&n&&a.d[n]&&(a.D[h]=a.d[n].src)}a.l=Ho(th(f,"metadata"),Ph(f,"prefix")[0]);a.l[Eo]&&(a.lang=a.l[Eo][0].v);if(!d){if(0<g.length&&a.j)for(d=Co(a.j),c=0;c<g.length;c++)a.e.k[a.k+g[c]]=d;return N(!0)}f=new Qa;l={};if(0<g.length&&a.j)for(h="1040:"+
Se(a.j),c=0;c<g.length;c++)l[g[c]]=h;for(c=0;c<d.length;c++){var p=d[c];if(n=p.n){var q=decodeURI(n),g=a.g[q];h=null;g&&(g.j=0!=p.m,g.h=p.c,g.d&&(h=g.d.replace(/\s+/g,"")));g=l[q];if(h||g)f.append(n),f.append(" "),f.append(h||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}Lo(a);return sf(e,"","POST",f.toString(),"text/plain")}function Lo(a){for(var b=0,c=0;c<a.b.length;c++){var d=a.b[c],e=Math.ceil(d.h/1024);d.e=b;d.b=e;b+=e}a.u=b}
function Mo(a,b,c){var d=new Ao;d.F=0;d.id="item1";d.src=b;a.d={item1:d};a.g={};a.g[b]=d;a.h=[d];a.b=a.h;c?(a=a.e,d=M("EPUBDocStore.load"),b=ra(b),(a.l[b]=no(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,cc:null})).oa(d),c=O(d)):c=N(null);return c}function No(a,b,c){var d=a.b[b],e=M("getCFI");a.e.load(d.src).then(function(a){var b=yh(a,c),k=null;b&&(a=wh(a,b,0,!1),k=new sb,vb(k,b,c-a),d.g&&vb(k,d.g,0),k=k.toString());Q(e,k)});return O(e)}
function Oo(a,b){return Ye("resolveFragment",function(c){if(b){var d=new sb;tb(d,b);var e;if(a.f){var f=ub(d,a.f.b);if(1!=f.ea.nodeType||f.K||!f.Ib){Q(c,null);return}var g=f.ea,k=g.getAttribute("idref");if("itemref"!=g.localName||!k||!a.d[k]){Q(c,null);return}e=a.d[k];d=f.Ib}else e=a.b[0];a.e.load(e.src).then(function(a){var b=ub(d,a.b);a=wh(a,b.ea,b.offset,b.K);Q(c,{F:e.F,ka:a,O:-1})})}else Q(c,null)},function(a,d){u.b(d,"Cannot resolve fragment:",b);Q(a,null)})}
function Po(a,b){return Ye("resolveEPage",function(c){if(0>=b)Q(c,{F:0,ka:0,O:-1});else{var d=Ya(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.e.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=xh(a),g=Math.round(a*b/e.b),g==a&&g--);Q(c,{F:d,ka:g,O:-1})})}},function(a,d){u.b(d,"Cannot resolve epage:",b);Q(a,null)})}
function Qo(a,b){var c=a.b[b.F];if(0>=b.ka)return N(c.e);var d=M("getEPage");a.e.load(c.src).then(function(a){a=xh(a);var f=Math.min(a,b.ka);Q(d,c.e+f*c.b/a)});return O(d)}function Ro(a,b,c,d){this.b=a;this.viewport=b;this.f=c;this.tb=[];this.ka=this.O=this.F=0;this.Q=ec(d);this.e=new bm(b.f)}function So(a){var b=a.tb[a.F];return b?b.Za[a.O]:null}m=Ro.prototype;m.cb=function(){if(this.b.A)return this.b.A;var a=this.tb[this.F];return a?a.Ia.ma:null};
function To(a){var b=M("renderPage");Uo(a).then(function(c){if(c){var d=-1;if(0>a.O){var d=a.ka,e=Ya(c.Ja.length,function(a){return co(c.Ia,c.Ja[a])>d});a.O=e==c.Ja.length?Number.POSITIVE_INFINITY:e-1}var f=c.Za[a.O];f?(a.ka=f.offset,Q(b,f)):pf(function(b){if(a.O<c.Ja.length)R(b);else if(c.complete)a.O=c.Ja.length-1,R(b);else{var e=c.Ja[c.Ja.length-1],h=Vo(a,c,e);ho(c.Ia,h,e).then(function(l){h.L.style.display="none";h.L.style.visibility="visible";h.L.setAttribute("data-vivliostyle-page-side",h.f);
(e=l)?(c.Za[e.d-1]=h,c.Ja.push(e),0<=d&&co(c.Ia,e)>d?(f=h,a.O=c.Ja.length-2,R(b)):(h.j=0==c.item.F&&0==e.d-1,rf(b))):(c.Za.push(h),f=h,a.O=c.Ja.length-1,0>d&&(a.ka=h.offset),c.complete=!0,h.j=0==c.item.F&&0==a.O,h.k=c.item.F==a.b.b.length-1,R(b))})}}).then(function(){if(f=f||c.Za[a.O])Q(b,f);else{var e=c.Ja[a.O];0>d&&(a.ka=co(c.Ia,e));var k=Vo(a,c,e);ho(c.Ia,k,e).then(function(d){k.L.style.display="none";k.L.style.visibility="visible";k.L.setAttribute("data-vivliostyle-page-side",k.f);(e=d)?(c.Za[e.d-
1]=k,c.Ja[a.O+1]=e):(c.Za.push(k),c.complete=!0,k.k=c.item.F==a.b.b.length-1);k.j=0==c.item.F&&0==a.O;Q(b,k)})}})}else Q(b,null)});return O(b)}m.Nc=function(){return Wo(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};function Wo(a,b,c){var d=M("renderAllPages"),e=a.F,f=a.O;a.F=0;pf(function(d){a.O=a.F==b?c:Number.POSITIVE_INFINITY;To(a).then(function(){++a.F>b?R(d):rf(d)})}).then(function(){a.F=e;a.O=f;To(a).oa(d)});return O(d)}m.yd=function(){this.O=this.F=0;return To(this)};
m.zd=function(){this.F=this.b.b.length-1;this.O=Number.POSITIVE_INFINITY;return To(this)};m.nextPage=function(){var a=this,b=M("nextPage");Uo(a).then(function(c){if(c){if(c.complete&&a.O==c.Ja.length-1){if(a.F>=a.b.b.length-1){Q(b,null);return}a.F++;a.O=0}else a.O++;To(a).oa(b)}else Q(b,null)});return O(b)};m.Lc=function(){if(0==this.O){if(0==this.F)return N(null);this.F--;this.O=Number.POSITIVE_INFINITY}else this.O--;return To(this)};
function Xo(a,b){var c="left"===b.f,d="ltr"===a.cb();return!c&&d||c&&!d}function Yo(a){var b=M("getCurrentSpread"),c=So(a);if(!c)return N({left:null,right:null});var d=a.F,e=a.O,f="left"===c.f;(Xo(a,c)?a.Lc():a.nextPage()).then(function(g){a.F=d;a.O=e;To(a).then(function(){f?Q(b,{left:c,right:g}):Q(b,{left:g,right:c})})});return O(b)}m.Ed=function(){var a=So(this);if(!a)return N(null);var a=Xo(this,a),b=this.nextPage();if(a)return b;var c=this;return b.lc(function(){return c.nextPage()})};
m.Hd=function(){var a=So(this);if(!a)return N(null);var a=Xo(this,a),b=this.Lc();if(a){var c=this;return b.lc(function(){return c.Lc()})}return b};function Zo(a,b){var c=M("navigateToEPage");Po(a.b,b).then(function(b){b&&(a.F=b.F,a.O=b.O,a.ka=b.ka);To(a).oa(c)});return O(c)}function $o(a,b){var c=M("navigateToCFI");Oo(a.b,b).then(function(b){b&&(a.F=b.F,a.O=b.O,a.ka=b.ka);To(a).oa(c)});return O(c)}
function ap(a,b){u.debug("Navigate to",b);var c=Ko(a.b,ra(b));if(null==c&&(a.b.f&&b.match(/^#epubcfi\(/)&&(c=Ko(a.b,a.b.f.url)),null==c))return N(null);var d=a.b.g[c];if(!d)return a.b.f&&c==Ko(a.b,a.b.f.url)&&(c=b.indexOf("#"),0<=c)?$o(a,b.substr(c+1)):N(null);d.F!=a.F&&(a.F=d.F,a.O=0);var e=M("navigateTo");Uo(a).then(function(c){var d=Ah(c.Z,b);d&&(a.ka=vh(c.Z,d),a.O=-1);To(a).oa(e)});return O(e)}
function Vo(a,b,c){var d=b.Ia.viewport,e=d.b.createElement("div");d.d.appendChild(e);e.style.position="relative";ja||(e.style.visibility="hidden");e.style.left="0px";e.style.top="0px";var f=new Uh(e);f.F=b.item.F;f.position=c;f.offset=co(b.Ia,c);d!==a.viewport&&(a=hc(a.viewport.width,a.viewport.height,d.width,d.height),a=hg(null,new bc(a,null)),f.g.push(new Rh(e,"transform",a)));return f}
function bp(a,b){var c=Io();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=M("navigateToEPage"),f=hf(c);d.Push(function(){f.Ra(e)});return O(c)}return N(null)}
m.Gc=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=ta(f,a.url),g=c.getAttribute("media-type");if(!g){var k=Ko(b.b,f);k&&(k=b.b.g[k])&&(g=k.d)}if(g&&(k=b.b.D[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Ua(f),h=Ua(g),g=new Qa;g.append(k);g.append("?src=");g.append(f);g.append("&type=");g.append(h);for(k=c.firstChild;k;k=k.nextSibling)1==k.nodeType&&
...
c.namespaceURI)e=bp(c,d);else if("http://example.com/sse"==c.namespaceURI){e=d?d.ownerDocument:b.viewport.b;g=c.localName;switch(g){case "t":case "tab":case "ec":case "nt":case "fraction":case "comment":case "mark":g="span";break;case "ruby":case "rp":case "rt":break;default:g="div"}e=e.createElement(g);e.setAttribute("data-adapt-process-children","true");e=N(e)}else e=N(null);return e}};
function Uo(a){if(a.F>=a.b.b.length)return N(null);var b=a.tb[a.F];if(b)return N(b);var c=a.b.b[a.F],d=a.b.e,e=M("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(xh(f)/2700),a.b.u=c.b);var g=d.b[f.url],k=a.Gc(f),h=a.viewport,l=$n(g,h.width,h.height,h.fontSize);if(l.width!=h.width||l.height!=h.height||l.fontSize!=h.fontSize)h=new dm(h.f,l.fontSize,h.root,l.width,l.height);var l=a.tb[a.F-1],n=new ao(g,f,a.b.lang,h,a.e,a.f,k,a.b.w,l?l.Ia.va+l.Za.length:0);l&&
Xn(n.k,l.Ia.k);n.Q=a.Q;bo(n).then(function(){b={item:c,Z:f,Ia:n,Ja:[null],Za:[],complete:!1};a.tb[a.F]=b;Q(e,b)})});return O(e)}function cp(a){return{F:a.F,O:a.O,ka:a.ka}}function dp(a,b){b?(a.F=b.F,a.O=-1,a.ka=b.ka):(a.F=0,a.O=0,a.ka=0);return Wo(a,a.F,a.O)}
m.dc=function(){var a=this.b,b=a.B||a.M;if(!b)return N(null);var c=M("showTOC");this.d||(this.d=new ro(a.e,b.src,a.lang,this.e,this.f,this.Q,this,a.w));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";e.style.border=
"1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.d.dc(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";Q(c,a)});return O(c)};m.$b=function(){this.d&&this.d.$b()};m.bd=function(){return this.d&&this.d.bd()};function ep(a,b,c,d){var e=this;this.h=a;this.ab=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Ga=c;this.Fa=d;this.ca=new nh(a.document.head,b);this.w="";this.g=null;this.D=this.d=!1;this.f=this.j=this.e=this.l=null;this.fontSize=16;this.zoom=1;this.M=!1;this.Nc=!0;this.Q=dc();this.B=function(){};this.k=function(){};this.I=function(){e.d=!0;e.B()};this.u=function(){};this.$={loadEPUB:this.ma,loadXML:this.pa,configure:this.A,
moveTo:this.va,toc:this.dc};fp(this)}function fp(a){qa(1,function(a){gp(this,{t:"debug",content:a})}.bind(a));qa(2,function(a){gp(this,{t:"info",content:a})}.bind(a));qa(3,function(a){gp(this,{t:"warn",content:a})}.bind(a));qa(4,function(a){gp(this,{t:"error",content:a})}.bind(a))}function gp(a,b){b.i=a.Ga;a.Fa(b)}
ep.prototype.ma=function(a){kn.b("loadEPUB");kn.b("loadFirstPage");this.ab.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet;this.viewport=null;var f=M("loadEPUB"),g=this;g.A(a).then(function(){var a=new uo;if(e)for(var h=0;h<e.length;h++)qo(a,e[h]);po(a).then(function(){var e=ta(b,g.h.location.href);g.w=e;wo(a,e,d).then(function(a){g.g=a;Oo(g.g,c).then(function(a){g.f=a;hp(g).then(function(){g.ab.setAttribute("data-vivliostyle-viewer-status",
"complete");kn.d("loadEPUB");gp(g,{t:"loaded",metadata:g.g.l});Q(f,!0)})})})})});return O(f)};
ep.prototype.pa=function(a){kn.b("loadXML");kn.b("loadFirstPage");this.ab.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.document,d=a.fragment,e=a.userStyleSheet;this.viewport=null;var f=M("loadXML"),g=this;g.A(a).then(function(){var a=new uo;if(e)for(var h=0;h<e.length;h++)qo(a,e[h]);po(a).then(function(){var e=ta(b,g.h.location.href);g.w=e;g.g=new yo(a,"");Mo(g.g,e,c).then(function(){Oo(g.g,d).then(function(a){g.f=a;hp(g).then(function(){g.ab.setAttribute("data-vivliostyle-viewer-status",
"complete");kn.d("loadXML");gp(g,{t:"loaded"});Q(f,!0)})})})})});return O(f)};function ip(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*rc.ex*a.fontSize/rc.em;if(d=rc[d])return c*d}return c}
ep.prototype.A=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.l=null,this.h.addEventListener("resize",this.I,!1),this.d=!0):this.h.removeEventListener("resize",this.I,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.d=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:ip(this,b["margin-left"])||0,marginRight:ip(this,b["margin-right"])||0,marginTop:ip(this,b["margin-top"])||0,marginBottom:ip(this,b["margin-bottom"])||
0,width:ip(this,b.width)||0,height:ip(this,b.height)||0},200<=b.width||200<=b.height)&&(this.h.removeEventListener("resize",this.I,!1),this.l=b,this.d=!0);"boolean"==typeof a.hyphenate&&(this.Q.Bc=a.hyphenate,this.d=!0);"boolean"==typeof a.horizontal&&(this.Q.Ac=a.horizontal,this.d=!0);"boolean"==typeof a.nightMode&&(this.Q.Ic=a.nightMode,this.d=!0);"number"==typeof a.lineHeight&&(this.Q.lineHeight=a.lineHeight,this.d=!0);"number"==typeof a.columnWidth&&(this.Q.xc=a.columnWidth,this.d=!0);"string"==
...
a.zoom,this.D=!0);return N(!0)};function jp(a){var b=[];a.e&&(b.push(a.e),a.e=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(w(a.L,"display","none"),a.removeEventListener("hyperlink",this.u,!1))},a)}function kp(a,b){b.addEventListener("hyperlink",a.u,!1);w(b.L,"visibility","visible");w(b.L,"display","block")}function lp(a,b){jp(a);a.e=b;kp(a,b)}
function mp(a){var b=M("reportPosition");a.f||(a.f=cp(a.b));No(a.g,a.f.F,a.f.ka).then(function(c){var d=a.e;(a.M&&0<d.e.length?sg(d.e):N(!0)).then(function(){np(a,d,c).oa(b)})});return O(b)}function op(a){var b=a.ab;if(a.l){var c=a.l;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new dm(a.h,a.fontSize,b,c.width,c.height)}return new dm(a.h,a.fontSize,b)}
function pp(a){if(a.l||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=op(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.tb;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.Za,d=0;d<c.length;d++){var e=c[d];if(e.D&&e.B){a=!0;break a}}}a=!1}b=!a}return b}
function qp(a){if(a.b){a.b.$b();for(var b=a.b.tb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.Za,e;e=d.shift();)e=e.L,e.parentNode.removeChild(e)}}a.viewport=op(a);b=a.viewport;w(b.e,"width","");w(b.e,"height","");w(b.d,"width","");w(b.d,"height","");w(b.d,"transform","");a.b=new Ro(a.g,a.viewport,a.ca,a.Q)}
function rp(a,b){a.D=!1;if(a.Q.Wa)return Yo(a.b).lc(function(c){jp(a);a.j=c;c.left&&(kp(a,c.left),c.right||c.left.L.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(kp(a,c.right),c.left||c.right.L.setAttribute("data-vivliostyle-unpaired-page",!0));c=sp(a,c);a.viewport.zoom(c.width,c.height,a.zoom);a.e=b;return N(null)});lp(a,b);a.viewport.zoom(b.b.width,b.b.height,a.zoom);a.e=b;return N(null)}
function sp(a,b){var c=0,d=0;b.left&&(c+=b.left.b.width,d=b.left.b.height);b.right&&(c+=b.right.b.width,d=Math.max(d,b.right.b.height));b.left&&b.right&&(c+=2*a.Q.Eb);return{width:c,height:d}}var tp={Pd:"fit inside viewport"};
function hp(a){a.d=!1;if(pp(a))return N(!0);"complete"===a.ab.getAttribute("data-vivliostyle-viewer-status")&&a.ab.setAttribute("data-vivliostyle-viewer-status","resizing");gp(a,{t:"resizestart"});var b=M("resize");a.b&&!a.f&&(a.f=cp(a.b));qp(a);dp(a.b,a.f).then(function(c){rp(a,c).then(function(){mp(a).then(function(c){kn.d("loadFirstPage");(a.Nc?a.b.Nc():N(null)).then(function(){a.ab.setAttribute("data-vivliostyle-viewer-status","complete");gp(a,{t:"resizeend"});Q(b,c)})})})});return O(b)}
function np(a,b,c){var d=M("sendLocationNotification"),e={t:"nav",first:b.j,last:b.k};Qo(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.u;c&&(e.cfi=c);gp(a,e);Q(d,!0)});return O(d)}ep.prototype.cb=function(){return this.b?this.b.cb():null};
ep.prototype.va=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.Q.Wa?this.b.Ed:this.b.nextPage;break;case "previous":a=this.Q.Wa?this.b.Hd:this.b.Lc;break;case "last":a=this.b.zd;break;case "first":a=this.b.yd;break;default:return N(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return Zo(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return ap(b.b,d)}}else return N(!0);var e=M("nextPage");a.call(b.b).then(function(a){a?(b.f=
null,rp(b,a).then(function(){mp(b).oa(e)})):Q(e,!0)});return O(e)};ep.prototype.dc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.bd();if(c){if("show"==a)return N(!0)}else if("hide"==a)return N(!0);if(c)return this.b.$b(),N(!0);var d=this,e=M("showTOC");this.b.dc(b).then(function(a){if(a){if(b){var c=function(){d.b.$b()};a.addEventListener("hyperlink",c,!1);a.L.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.u,!1)}Q(e,!0)});return O(e)};
function up(a,b){var c=b.a||"";return Ye("runCommand",function(d){var e=a.$[c];e?e.call(a,b).then(function(){gp(a,{t:"done",a:c});Q(d,!0)}):(u.error("No such action:",c),Q(d,!0))},function(a,b){u.error(b,"Error during action:",c);Q(a,!0)})}function vp(a){return"string"==typeof a?JSON.parse(a):a}
function wp(a,b){var c=vp(b),d=null;$e(function(){var b=M("commandLoop"),f=Te.d;a.u=function(b){var c={t:"hyperlink",href:b.href,internal:b.href.substr(0,a.w.length)==a.w};af(f,function(){gp(a,c);return N(!0)})};pf(function(b){if(a.d)hp(a).then(function(){rf(b)});else if(a.D)a.e&&rp(a,a.e).then(function(){rf(b)});else if(c){var e=c;c=null;up(a,e).then(function(){rf(b)})}else e=M("waitForCommand"),d=hf(e,self),O(e).then(function(){rf(b)})}).oa(b);return O(b)});a.B=function(){var a=d;a&&(d=null,a.Ra())};
a.k=function(b){if(c)return!1;c=vp(b);a.B();return!0};a.h.adapt_command=a.k};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Bb||(Object.Bb=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function xp(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}function yp(a,b){ja=a.debug;this.f=a;this.b=new ep(a.window||window,a.viewportElement,"main",this.xd.bind(this));this.e={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,spreadView:!1,zoom:1};b&&this.sd(b);this.d=new eb}m=yp.prototype;
m.sd=function(a){var b=Object.Bb({a:"configure"},xp(a));this.b.k(b);Object.Bb(this.e,a)};m.xd=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});fb(this.d,b)};m.Jd=function(a,b){this.d.addEventListener(a,b,!1)};m.Md=function(a,b){this.d.removeEventListener(a,b,!1)};m.Ad=function(a,b,c){a||fb(this.d,{type:"error",content:"No URL specified"});zp(this,a,null,b,c)};m.Kd=function(a,b,c){a||fb(this.d,{type:"error",content:"No URL specified"});zp(this,null,a,b,c)};
function zp(a,b,c,d,e){d=d||{};var f,g=d.userStyleSheet;g&&(f=g.map(function(a){return{url:a.url||null,text:a.text||null}}));e&&Object.Bb(a.e,e);b=Object.Bb({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.f.userAgentRootURL,url:b||c,document:d.documentObject,fragment:d.fragment,userStyleSheet:f},xp(a.e));wp(a.b,b)}m.cb=function(){return this.b.cb()};
m.Cd=function(a){a:switch(a){case "left":a="ltr"===this.cb()?"previous":"next";break a;case "right":a="ltr"===this.cb()?"next":"previous";break a}this.b.k({a:"moveTo",where:a})};m.Bd=function(a){this.b.k({a:"moveTo",url:a})};m.Ld=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.Q.Wa?sp(b,b.j):b.e.b;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ca("vivliostyle.viewer.Viewer",yp);yp.prototype.setOptions=yp.prototype.sd;yp.prototype.addListener=yp.prototype.Jd;yp.prototype.removeListener=yp.prototype.Md;yp.prototype.loadDocument=yp.prototype.Ad;yp.prototype.loadEPUB=yp.prototype.Kd;yp.prototype.getCurrentPageProgression=yp.prototype.cb;yp.prototype.navigateToPage=yp.prototype.Cd;yp.prototype.navigateToInternalUrl=yp.prototype.Bd;yp.prototype.queryZoomFactor=yp.prototype.Ld;ca("vivliostyle.viewer.ZoomType",tp);tp.FIT_INSIDE_VIEWPORT="fit inside viewport";
fn.call(kn,"load_vivliostyle","end",void 0);var Ap=16,Bp="ltr";function Cp(a){window.adapt_command(a)}function Dp(){Cp({a:"moveTo",where:"ltr"===Bp?"previous":"next"})}function Ep(){Cp({a:"moveTo",where:"ltr"===Bp?"next":"previous"})}
function Fp(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)Cp({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)Cp({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)Cp({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)Cp({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)Ep(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)Dp(),a.preventDefault();else if("0"===b||"U+0030"===c)Cp({a:"configure",fontSize:Math.round(Ap)}),a.preventDefault();else if("t"===b||"U+0054"===c)Cp({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)Ap*=1.2,Cp({a:"configure",fontSize:Math.round(Ap)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)Ap/=1.2,Cp({a:"configure",
fontSize:Math.round(Ap)}),a.preventDefault()}
function Gp(a){switch(a.t){case "loaded":a=a.viewer;var b=Bp=a.cb();a.ab.setAttribute("data-vivliostyle-page-progression",b);a.ab.setAttribute("data-vivliostyle-spread-view",a.Q.Wa);window.addEventListener("keydown",Fp,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Dp,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Ep,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(wa(location.href,Ua(a||"")));break;case "hyperlink":a.internal&&Cp({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+n+"; margin: 0; }",document.head.appendChild(g));wp(new ep(window,l,"main",Gp),a)});
