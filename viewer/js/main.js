 ...
 *
 * Vivliostyle core 2016.4.1-pre.20160701045411
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
b&&(m=h[l]).b.y<r;)if(m.d.y<c)l++;else if(m.b.y<v){if(m.b.y!=m.d.y||m.b.y!=c)p.push(m),r=v;l++}else{k=Ee(m.b.y,d);k<r&&(r=k);break}v=[];for(k=0;k<p.length;k++)Be(v,p[k],c,r);v.sort(function(a,b){return a.x-b.x||a.d-b.d});v=Ce(v,e,f);if(0==v.length)g.push(new te(c,r,a.V,a.V));else{var q=0,x=a.aa;for(k=0;k<v.length;k+=2){var P=Math.max(a.aa,v[k]),W=Math.min(a.V,v[k+1])-P;W>q&&(q=W,x=P)}0==q?g.push(new te(c,r,a.V,a.V)):g.push(new te(c,r,Math.max(x,a.aa),Math.min(x+q,a.V)))}if(r==a.R)break;c=r;for(k=
...
function Xf(a,b,c){for(var d=a.u,e=a.j,f=d.pop(),g;;){var h=d.pop();if(11==b){for(g=[f];16==h;)g.unshift(d.pop()),h=d.pop();if("string"==typeof h){if("{"==h){for(;2<=g.length;)a=g.shift(),c=g.shift(),a=new Ec(e.X(),a,c),g.unshift(a);d.push(new J(g[0]));return!0}if("("==h){b=d.pop();f=d.pop();f=new Tc(e.X(),cc(f,b),g);b=0;continue}}if(10==h){f.xd()&&(f=new Vc(e.X(),f,null));b=0;continue}}else if("string"==typeof h){d.push(h);break}if(0>h)if(-31==h)f=new zc(e.X(),f);else if(-24==h)f=new Ac(e.X(),f);
...
function $f(a,b,c){a=a.j.X();if(!a)return null;c=c||a.g;if(b){b=b.split(/\s+/);for(var d=0;d<b.length;d++)switch(b[d]){case "vertical":c=Xc(a,c,new zc(a,new Rc(a,"pref-horizontal")));break;case "horizontal":c=Xc(a,c,new Rc(a,"pref-horizontal"));break;case "day":c=Xc(a,c,new zc(a,new Rc(a,"pref-night-mode")));break;case "night":c=Xc(a,c,new Rc(a,"pref-night-mode"));break;default:c=a.f}}return c===a.g?null:new J(c)}
...
a.b=Nf;l.splice(0,l.length);continue;case 29:a.b=Mf;g.eb();continue;case 1:if(!k.b){a.b=Rf;g.error("E_CSS_SPACE_EXPECTED",k);continue}g.mb();case 2:if(34==z(h,1).type)if(A(h),A(h),p=a.I[k.text],null!=p)switch(k=y(h),k.type){case 1:g.ib(p,k.text);a.b=f?Kf:R;A(h);break;case 36:g.ib(p,null);a.b=f?Kf:R;A(h);break;default:a.b=Pf,g.error("E_CSS_NAMESPACE",k)}else a.b=Pf,g.error("E_CSS_UNDECLARED_PREFIX",k);else g.ib(a.D,k.text),a.b=f?Kf:R,A(h);continue;case 3:if(!k.b){a.b=Rf;g.error("E_CSS_SPACE_EXPECTED",
k);continue}g.mb();case 4:if(34==z(h,1).type)switch(A(h),A(h),k=y(h),k.type){case 1:g.ib(null,k.text);a.b=f?Kf:R;A(h);break;case 36:g.ib(null,null);a.b=f?Kf:R;A(h);break;default:a.b=Pf,g.error("E_CSS_NAMESPACE",k)}else g.ib(a.D,null),a.b=f?Kf:R,A(h);continue;case 5:k.b&&g.mb();case 6:g.Vc(k.text);a.b=f?Kf:R;A(h);continue;case 7:k.b&&g.mb();case 8:g.Pc(k.text);a.b=f?Kf:R;A(h);continue;case 55:k.b&&g.mb();case 14:A(h);k=y(h);b:switch(k.type){case 1:g.bc(k.text,null);A(h);a.b=f?Kf:R;continue;case 6:m=
k.text;A(h);switch(m){case "not":a.b=Mf;g.gc("not");bg(a,Number.POSITIVE_INFINITY,!1,!1,!1,!0)?a.b=R:a.b=Rf;break a;case "lang":case "href-epub-type":if(k=y(h),1===k.type){p=[k.text];A(h);break}else break b;case "nth-child":case "nth-of-type":case "nth-last-child":case "nth-last-of-type":if(p=Zf(a))break;else break b;default:p=Yf(a)}k=y(h);if(11==k.type){g.bc(m,p);A(h);a.b=f?Kf:R;continue}}g.error("E_CSS_PSEUDOCLASS_SYNTAX",k);a.b=Pf;continue;case 42:A(h);k=y(h);switch(k.type){case 1:g.cc(k.text,
null);a.b=f?Kf:R;A(h);continue;case 6:if(m=k.text,A(h),p=Yf(a),k=y(h),11==k.type){g.cc(m,p);a.b=f?Kf:R;A(h);continue}}g.error("E_CSS_PSEUDOELEM_SYNTAX",k);a.b=Pf;continue;case 9:k.b&&g.mb();case 10:A(h);k=y(h);if(1==k.type)m=k.text,A(h);else if(36==k.type)m=null,A(h);else if(34==k.type)m="";else{a.b=Rf;g.error("E_CSS_ATTR",k);A(h);continue}k=y(h);if(34==k.type){p=m?a.I[m]:m;if(null==p){a.b=Rf;g.error("E_CSS_UNDECLARED_PREFIX",k);A(h);continue}A(h);k=y(h);if(1!=k.type){a.b=Rf;g.error("E_CSS_ATTR_NAME_EXPECTED",
k);continue}m=k.text;A(h);k=y(h)}else p="";switch(k.type){case 39:case 45:case 44:case 43:case 42:case 46:case 50:r=k.type;A(h);k=y(h);break;case 15:g.oc(p,m,0,null);a.b=f?Kf:R;A(h);continue;default:a.b=Rf;g.error("E_CSS_ATTR_OP_EXPECTED",k);continue}switch(k.type){case 1:case 2:g.oc(p,m,r,k.text);A(h);k=y(h);break;default:a.b=Rf;g.error("E_CSS_ATTR_VAL_EXPECTED",k);continue}if(15!=k.type){a.b=Rf;g.error("E_CSS_ATTR",k);continue}a.b=f?Kf:R;A(h);continue;case 11:g.Oc();a.b=Lf;A(h);continue;case 12:g.Nc();
...
continue}}a.b===Nf&&0<=h.b?(Vb(h),a.b=Mf,g.eb()):Wf(a,"E_CSS_UNEXPECTED_PLUS",k);continue;case 26:A(h);case 48:h.b=-1;(m=Vf(a,";",k))&&a.e&&g.bb(a.e,m,a.l);a.b=d?Jf:If;continue;case 44:A(h);h.b=-1;m=Vf(a,";",k);if(c)return a.w=m,!0;a.e&&m&&g.bb(a.e,m,a.l);if(d)return!0;Wf(a,"E_CSS_SYNTAX",k);continue;case 31:m=z(h,1);9==m.type?(10!=z(h,2).type||z(h,2).b?(l.push(new Rc(g.X(),cc(k.text,m.text))),a.b=S):(l.push(k.text,m.text,"("),A(h)),A(h)):(2==a.g||3==a.g?"not"==k.text.toLowerCase()?(A(h),l.push(new Sc(g.X(),
!0,m.text))):("only"==k.text.toLowerCase()&&(A(h),k=m),l.push(new Sc(g.X(),!1,k.text))):l.push(new Rc(g.X(),k.text)),a.b=S);A(h);continue;case 38:l.push(null,k.text,"(");A(h);continue;case 32:l.push(new B(g.X(),k.C));A(h);a.b=S;continue;case 33:m=k.text;"%"==m&&(m=a.e&&a.e.match(/height|^(top|bottom)$/)?"vh":"vw");l.push(new Qc(g.X(),k.C,m));A(h);a.b=S;continue;case 34:l.push(new B(g.X(),k.text));A(h);a.b=S;continue;case 35:A(h);k=y(h);5!=k.type||k.b?Wf(a,"E_CSS_SYNTAX",k):(l.push(new Wc(g.X(),k.C)),
...
function rk(a,b){var c=b[0].toString(),d=1<b.length?b[1].stringValue():"decimal",e=a.d.f[c];if(e&&e.length)return new jd(qk(e&&e.length&&e[e.length-1]||0,d));c=new J(sk(a.b,c,function(a){return qk(a||0,d)}));return new cd([c])}
function tk(a,b){var c=b[0].toString(),d=b[1].stringValue(),e=2<b.length?b[2].stringValue():"decimal",f=a.d.f[c],g=new Ia;if(f&&f.length)for(var h=0;h<f.length;h++)0<h&&g.append(d),g.append(qk(f[h],e));c=new J(uk(a.b,c,function(a){var b=[];if(a.length)for(var c=0;c<a.length;c++)b.push(qk(a[c],e));a=g.toString();a.length&&b.push(a);return b.length?b.join(d):qk(0,e)}));return new cd([c])}
function vk(a,b){var c=b[0],c=c instanceof od?c.url:c.stringValue(),d=b[1].toString(),e=2<b.length?b[2].stringValue():"decimal",c=new J(wk(a.b,c,d,function(a){return qk(a||0,e)}));return new cd([c])}function xk(a,b){var c=b[0],c=c instanceof od?c.url:c.stringValue(),d=b[1].toString(),e=b[2].stringValue(),f=3<b.length?b[3].stringValue():"decimal",c=new J(yk(a.b,c,d,function(a){a=a.map(function(a){return qk(a,f)});return a.length?a.join(e):qk(0,f)}));return new cd([c])}
...
if(m=d._pseudos){for(var p=[],r=Km.createElementNS("http://www.pyroxy.com/ns/shadow","root"),q=r,v=0;v<Lm.length;v++){var E=Lm[v],K;if(E){if(!m[E])continue;if(!("footnote-marker"!=E||c&&a.g))continue;if(E.match(/^first-/)&&(K=e.display,!K||K===Jd))continue;if("before"===E||"after"===E)if(K=m[E].content,!K||K===Sd||K===Rd)continue;p.push(E);K=Km.createElementNS("http://www.w3.org/1999/xhtml","span");K.setAttribute("data-adapt-pseudo",E)}else K=Km.createElementNS("http://www.pyroxy.com/ns/shadow","content");
q.appendChild(K);E.match(/^first-/)&&(q=K)}k=p.length?new ii(b,r,null,h,k,2,new Nm(b,d,f,g)):k}O(l,k)})});return N(l)}function Tm(a,b,c){a.I=b;a.g=c}function Um(a,b,c,d){var e=a.d;c=$k(c,e,a.D,a.g);b=Zk(c,e,b);al(c,d,b,function(b,c){var d=c.evaluate(e,b);"font-family"==b&&(d=nh(a.B,d));return d});var f=Li(d.display||Jd,d.position,d["float"],a.Y===a.Z.root);["display","position","float"].forEach(function(a){f[a]&&(d[a]=f[a])});return b}
...
a.b.parent?a.b.parent.b?ge:Hd:x);a.b.H=h===Wd||h===rd||h===Ed;qi(a.b)&&(q=null,k!==Gd&&(k=null));h=k===Od||k===Xd||k===de||k===zd||k===Md||k===Ld||k===xd||k===wd||k===Gd;k&&(delete l["float"],k===Gd&&(a.g?(h=!1,l.display=vd):l.display=Jd));q&&(q===Id&&a.b.parent&&a.b.parent.l&&(q=H(a.b.parent.l)),q===Od||q===Xd||q===yd)&&(delete l.clear,l.display&&l.display!=Jd&&(a.b.l=q.toString()));var P=m===Pd&&l["ua-list-item-count"];h||l["break-inside"]&&l["break-inside"]!==ud?a.b.j++:m===ce&&(a.b.j+=10);a.b.e=
...
ja?(ja="http://www.w3.org/1999/xhtml",E=a.b.e?"span":"div"):W=!!a.f;P?b?E="li":(E="div",m=vd,l.display=m):"body"==E||"li"==E?E="div":"q"==E?E="span":"a"==E&&(g=l["hyperlink-processing"])&&"normal"!=g.toString()&&(E="span");l.behavior&&"none"!=l.behavior.toString()&&a.f&&(W=!0);f.dataset&&"true"==f.dataset.mathTypeset&&(W=!0);var K;W?K=a.f(f,a.b.parent?a.b.parent.A:null,l):K=M(null);K.then(function(g){g?W&&(d="true"==g.getAttribute("data-adapt-process-children")):g=a.createElement(ja,E);"a"==E&&g.addEventListener("click",
a.page.D,!1);ea&&($m(a,a.b,"inner",ea),g.appendChild(ea));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&Jm(g);var h=a.b.g["image-resolution"],k=[],m=l.width,p=l.height,r=f.getAttribute("width"),q=f.getAttribute("height"),m=(!m||m===ud)&&!r,p=(!p||p===ud)&&!q;if("http://www.gribuser.ru/xml/fictionbook/2.0"!=f.namespaceURI||"td"==E){for(var r=f.attributes,v=r.length,q=null,x=0;x<v;x++){var K=r[x],Lb=K.namespaceURI,za=K.localName,K=K.nodeValue;if(Lb)if("http://www.w3.org/2000/xmlns/"==
Lb)continue;else"http://www.w3.org/1999/xlink"==Lb&&"href"==za&&(K=Xm(a,K));else{if(za.match(/^on/))continue;if("style"==za)continue;if(("id"==za||"name"==za)&&b){K=a.j.ld(K,a.Z.url);g.setAttribute(za,K);Yh(a.page,g,K);continue}"src"==za||"href"==za||"poster"==za?K=a.j.b(Xm(a,K),a.Z.url):"srcset"==za&&(K=K.split(",").map(function(b){return Xm(a,b.trim())}).join(","));if("poster"===za&&"video"===E&&"http://www.w3.org/1999/xhtml"===ja&&m&&p){var hc=new Image,Dl=tg(hc,K);Ja.push(Dl);k.push({Kd:hc,element:g,
Id:Dl})}}Lb&&(hc=Im[Lb])&&(za=hc+":"+za);"src"!=za||Lb||"img"!=E&&"input"!=E||"http://www.w3.org/1999/xhtml"!=ja?"href"==za&&"image"==E&&"http://www.w3.org/2000/svg"==ja&&"http://www.w3.org/1999/xlink"==Lb?a.page.g.push(tg(g,K)):Lb?g.setAttributeNS(Lb,za,K):g.setAttribute(za,K):q=K}q&&(hc="input"===E?new Image:g,r=tg(hc,q),hc!==g&&(g.src=q),m||p?(m&&p&&h&&k.push({Kd:hc,element:g,Id:r}),Ja.push(r)):a.page.g.push(r))}delete l.content;(m=l["list-style-image"])&&m instanceof od&&(m=m.url,Ja.push(tg(new Image,
m)));an(a,g,l);if(!a.b.e&&(m=null,b?c&&(m=a.b.b?Hm:Gm):m="clone"!==a.b.g["box-decoration-break"]?a.b.b?Fm:Em:a.b.b?Hm:Gm,m))for(var El in m)w(g,El,m[El]);P&&g.setAttribute("value",l["ua-list-item-count"].stringValue());a.A=g;Ja.length?sg(Ja).then(function(){0<h&&bn(k,h);O(e,d)}):lf().then(function(){O(e,d)})})});return N(e)}function bn(a,b){a.forEach(function(a){if("load"===uf(a.Id).Ub()){var d=a.Kd,e=d.width,d=d.height;a=a.element;0<e&&0<d&&(w(a,"width",e/b+"px"),w(a,"height",d/b+"px"))}})}
...
l.bottom&&1>Math.abs(g.right-l.right)){b.push({top:g.top,left:l.left,bottom:l.bottom,right:l.right});break}}h==d.length&&(u.b("Could not fix character box"),b.push(g))}a=b}for(b=d=0;b<a.length;b++)f=a[b],g=c?f.bottom-f.top:f.right-f.left,f.right>f.left&&f.bottom>f.top&&(isNaN(e)||g>d)&&(e=c?f.left:f.bottom,d=g);return e}function vn(a,b){this.e=a;this.f=b}vn.prototype.d=function(a,b){return b<this.f?null:wn(a,this,0<b)};vn.prototype.b=function(){return this.f};
...
function Fn(a,b){if(b.f&&b.e&&!b.J&&0==b.f.count&&1!=b.A.nodeType){var c=b.A.textContent.match(En);return kn(a.f,b,c[0].length)}return M(b)}function Gn(a,b,c){var d=L("buildViewToNextBlockEdge");nf(function(d){b.A&&c.push(ni(b));Fn(a,b).then(function(f){f!==b&&(b=f,c.push(ni(b)));gn(a.f,b).then(function(c){(b=c)?Hn(a.yb,b)?b.k&&!a.b?In(a,b).then(function(c){b=c;!b||b.d||0<a.f.e.b.length?Q(d):pf(d)}):b.e?pf(d):Q(d):(b=b.modify(),b.d=!0,Q(d)):Q(d)})})}).then(function(){O(d,b)});return N(d)}
function Jn(a,b){if(!b.A)return M(b);var c=b.Y,d=L("buildDeepElementView");nf(function(d){Fn(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.Y!=c;)g=g.parent;if(null==g){b=f;Q(d);return}}gn(a.f,f).then(function(f){(b=f)&&b.Y!=c?Hn(a.yb,b)?pf(d):(b=b.modify(),b.d=!0,Q(d)):Q(d)})})}).then(function(){O(d,b)});return N(d)}
...
"1"))}}function ao(a,b,c,d){var e=L("processLineStyling");zn(d);var f=d.concat([]);d.splice(0,d.length);var g=0,h=b.f;0==h.count&&(h=h.he);nf(function(d){if(h){var e=bo(a,f),m=h.count-g;if(e.length<=m)Q(d);else{var p=co(a,f,e[m-1]);eo(a,p,!1,!1).then(function(){g+=m;kn(a.f,p,0).then(function(e){b=e;$n(b,!1);h=b.f;f=[];Gn(a,b,f).then(function(b){c=b;0<a.f.e.b.length?Q(d):pf(d)})})})}}else Q(d)}).then(function(){Array.prototype.push.apply(d,f);zn(d);O(e,c)});return N(e)}
...
function no(a,b,c){function d(){b=k[0]||b;b.A.parentNode.removeChild(b.A);e.g=h}var e=a,f=L("skipEdges"),g=c&&b&&b.J,h=null,l=null,k=[],m=[],p=!1;nf(function(a){for(;b;){do if(b.A){if(!Hn(e.yb,b)){b=b.modify();b.d=!0;Q(a);return}if(b.e&&1!=b.A.nodeType){if(ai(b.A,b.w))break;if(!b.J){!c&&ol[h]?d():lo(e,l,null,!0,h)?(b=(l||b).modify(),b.d=!0):(b=b.modify(),b.h=h);Q(a);return}}if(!b.J&&(b.l&&mo(e,b),b.k||b.B)){k.push(ni(b));h=ml(h,b.h);!c&&ol[h]?d():lo(e,l,null,!0,h)&&(b=(l||b).modify(),b.d=!0);Q(a);
return}if(1==b.A.nodeType){var f=b.A.style;if(b.J){if(p){if(!c&&ol[h]){d();Q(a);return}k=[];g=c=!1;h=null}p=!1;l=ni(b);m.push(l);h=ml(h,b.D);if(f&&(!ko(f.paddingBottom)||!ko(f.borderBottomWidth))){if(lo(e,l,null,!0,h)){b=(l||b).modify();b.d=!0;Q(a);return}m=[l];l=null}}else{k.push(ni(b));h=ml(h,b.h);if(tn[b.A.localName]){!c&&ol[h]?d():lo(e,l,null,!0,h)&&(b=(l||b).modify(),b.d=!0);Q(a);return}!f||ko(f.paddingTop)&&ko(f.borderTopWidth)||(g=!1,m=[]);p=!0}}}while(0);f=gn(e.f,b,g);if(f.Ca()){f.then(function(c){b=
c;pf(a)});return}b=f.Ub()}lo(e,l,m,!1,h)?l&&(b=l.modify(),b.d=!0):ol[h]&&(e.g=h);Q(a)}).then(function(){O(f,b)});return N(f)}
function jo(a,b){var c=ni(b),d=L("skipEdges"),e=null,f=!1;nf(function(d){for(;b;){do if(b.A){if(b.e&&1!=b.A.nodeType){if(ai(b.A,b.w))break;if(!b.J){ol[e]&&(a.g=e);Q(d);return}}if(!b.J&&(b.k||b.B)){e=ml(e,b.h);ol[e]&&(a.g=e);Q(d);return}if(1==b.A.nodeType){var h=b.A.style;if(b.J){if(f){if(ol[e]){a.g=e;Q(d);return}e=null}f=!1;e=ml(e,b.D)}else{e=ml(e,b.h);if(tn[b.A.localName]){ol[e]&&(a.g=e);Q(d);return}if(h&&(!ko(h.paddingTop)||!ko(h.borderTopWidth))){Q(d);return}}f=!0}}while(0);h=gn(a.f,b);if(h.Ca()){h.then(function(a){b=
a;pf(d)});return}b=h.Ub()}c=null;Q(d)}).then(function(){O(d,c)});return N(d)}function In(a,b){return"footnote"==b.k?Xn(a,b):Yn(a,b)}function oo(a,b,c){var d=L("layoutNext");no(a,b,c).then(function(c){b=c;if(!b||a.g||b.d)O(d,b);else if(b.k)In(a,b).ua(d);else{a:if(b.J)c=!0;else{switch(b.Y.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!b.B}c?go(a,b).ua(d):Jn(a,b).ua(d)}});return N(d)}
...
}var k=b.style.display,m=b.style.position,p=b.style.width,r=b.style.height,v=b.parentNode,q=b.ownerDocument.createElement("div");w(q,"position",m);v.insertBefore(q,b);q.appendChild(b);w(b,"width","auto");w(b,"height","auto");var x=Ga("writing-mode"),x=(x?d(x):null)||d("writing-mode"),P="vertical-rl"===x||"tb-rl"===x||"vertical-lr"===x||"tb-lr"===x,W=P?"height":"width",ea=P?"width":"height",Ja={};c.forEach(function(a){var c;switch(a){case "fill-available inline size":c=e();break;case "max-content inline size":c=
f();break;case "min-content inline size":c=g();break;case "fit-content inline size":c=h();break;case "fill-available block size":c=l();break;case "max-content block size":case "min-content block size":case "fit-content block size":c=d(ea);break;case "fill-available width":c=P?l():e();break;case "fill-available height":c=P?e():l();break;case "max-content width":c=P?d(ea):f();break;case "max-content height":c=P?f():d(ea);break;case "min-content width":c=P?d(ea):g();break;case "min-content height":c=
P?g():d(ea);break;case "fit-content width":c=P?d(ea):h();break;case "fit-content height":c=P?h():d(ea)}Ja[a]=parseFloat(c);w(b,"position",m);w(b,"display",k)});w(b,"width",p);w(b,"height",r);v.insertBefore(b,q);v.removeChild(q);return Ja};function Oo(a){var b=a["writing-mode"],b=b&&b.value;a=(a=a.direction)&&a.value;return b===fe||b!==ge&&a!==$d?"ltr":"rtl"}
...
function mp(a,b,c,d,e,f){var g=a.d.d,h={},l={},k={},m;for(m in b){var p=dp[m];if(p){var r=b[m],v=a.ma[m],q=new np(r,v.style,c,g,f);h[p.la]=r;l[p.la]=v;k[p.la]=q}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.ca.evaluate(e);var x=rp(k,b),P=!1,W={};Object.keys(h).forEach(function(a){var b=X(g,l[a].style[c?"max-width":"max-height"],d.ca);b&&(b=b.evaluate(e),x[a]>b&&(b=k[a]=new qp(h[a],l[a].style,c,g,f,b),W[a]=b.d(),P=!0))});P&&(x=rp(k,b),P=!1,["start","center","end"].forEach(function(a){x[a]=W[a]||x[a]}));
var ea={};Object.keys(h).forEach(function(a){var b=X(g,l[a].style[c?"min-width":"min-height"],d.ca);b&&(b=b.evaluate(e),x[a]<b&&(b=k[a]=new qp(h[a],l[a].style,c,g,f,b),ea[a]=b.d(),P=!0))});P&&(x=rp(k,b),["start","center","end"].forEach(function(a){x[a]=ea[a]||x[a]}));var Ja=a+b,ja=a+(a+b);["start","center","end"].forEach(function(a){var b=x[a];if(b){var d=h[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(ja-b)/2;break;case "end":e=Ja-b}c?Hi(d,e,b-Di(d)-Ei(d)):Gi(d,e,b-Bi(d)-
...
d["padding-bottom"]=new J(c.marginBottom)};kp.prototype.Wc=function(){var a=tp(this,{start:"left",end:"right",ca:"width"});this.Jb=a.Hd;this.marginLeft=a.Qd;this.marginRight=a.Pd};kp.prototype.Xc=function(){var a=tp(this,{start:"top",end:"bottom",ca:"height"});this.Ib=a.Hd;this.marginTop=a.Qd;this.marginBottom=a.Pd};
...
me;c["margin-"+f]=me;c["padding-"+e]=new J(p);c["padding-"+f]=new J(r);c["border-"+e+"-width"]=new J(v);c["border-"+f+"-width"]=new J(q);c[g]=new J(l);c["max-"+g]=new J(l);return{Hd:F(d,h,D(d,k,m)),Qd:k,Pd:m}}kp.prototype.sb=function(a,b,c,d,e){Xl.prototype.sb.call(this,a,b,c,d,e);c.w=b.element};function lp(a,b){Xl.call(this,a,b);var c=b.j;this.j=dp[c];a.ma[c]=this;this.ra=!0}t(lp,Xl);n=lp.prototype;
...
n.la=function(a,b){var c=this.style,d=this.d.d,e=a.start,f=a.end,g="left"===e,h=g?b.Jb:b.Ib,l=X(d,c[a.ca],h),g=g?b.marginLeft:b.marginTop;if("start"===this.j.la)c[e]=new J(g);else if(l){var k=Yl(d,c["margin-"+e],h),m=Yl(d,c["margin-"+f],h),p=Yl(d,c["padding-"+e],h),r=Yl(d,c["padding-"+f],h),v=$l(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),f=$l(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),l=D(d,l,D(d,D(d,p,r),D(d,D(d,v,f),D(d,k,m))));switch(this.j.la){case "center":c[e]=new J(D(d,
g,Zc(d,F(d,h,l),new B(d,2))));break;case "end":c[e]=new J(F(d,D(d,g,h),l))}}};
...
b-c-x.ca-x.La:null===x.ca?(x.La=x.Ma=0,x.ca=b-c):x.La=x.Ma=(b-c-x.ca)/2;return x}var e=a.style;a=a.d.d;var f=b.Yc,g=b.bd;b=b.ca;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],l=Zl(a,e["margin-"+f],h),k=Zl(a,e["margin-"+g],h),m=Yl(a,e["padding-"+f],h),p=Yl(a,e["padding-"+g],h),r=$l(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),v=$l(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),q=X(a,e[b],h),x=null;e[b]=new J(new gc(a,function(){var a=d(this).ca;return null===a?0:a},b));e["margin-"+
f]=new J(new gc(a,function(){var a=d(this).La;return null===a?0:a},"margin-"+f));e["margin-"+g]=new J(new gc(a,function(){var a=d(this).Ma;return null===a?0:a},"margin-"+g));"left"===f?e.left=new J(D(a,c.marginLeft,c.Jb)):"top"===f&&(e.top=new J(D(a,c.marginTop,c.Ib)))}n.Wc=function(){var a=this.e.j;this.j.wa?up(this,{Yc:"right",bd:"left",ca:"width"},a):this.j.xa?up(this,{Yc:"left",bd:"right",ca:"width"},a):this.la({start:"left",end:"right",ca:"width"},a)};
...
function Tp(a,b,c){var d=a.b.b[c];if(!d||!Lp(a,d.d))return M(!0);d.d="any";Tn(b);a.g[c]&&0<b.gb.length&&(b.Gd=!1);var e=L("layoutColumn"),f=[],g=[],h=!0;nf(function(c){for(;0<d.b.length-g.length;){for(var e=0;0<=g.indexOf(e);)e++;var m=d.b[e];if(m.b.d>a.l||Mp(a,m.b))break;for(var p=e+1;p<d.b.length;p++)if(!(0<=g.indexOf(p))){var r=d.b[p];if(r.b.d>a.l||Mp(a,r.b))break;ei(r.b,m.b)&&(m=r,e=p)}var v=m.b,q=!0;Wn(b,m.d,h).then(function(a){h=!1;m.b.je&&(null===a||v.f)&&f.push(e);v.f?(g.push(e),Q(c)):(a?
m.d=a:g.push(e),b.g&&(d.d=sn(b.g)),a||b.g?Q(c):q?q=!1:pf(c))});if(q){q=!1;return}}Q(c)}).then(function(){d.b=d.b.filter(function(a,b){return 0<=f.indexOf(b)||0>g.indexOf(b)});O(e,!0)});return N(e)}
function Up(a,b,c,d,e,f,g,h){cm(c);var l=jm(c,a,"enabled");if(l&&l!==ie)return M(!0);var k=L("layoutContainer"),m=jm(c,a,"wrap-flow")===ud,p=c.b?c.g&&c.H:c.f&&c.I,l=jm(c,a,"flow-from"),r=a.viewport.b.createElement("div"),v=jm(c,a,"position");w(r,"position",v?v.name:"absolute");d.insertBefore(r,d.firstChild);var q=new Ai(r);q.b=c.b;c.sb(a,q,b,a.h,a.e);q.B=e;q.D=f;e+=q.left+q.marginLeft+q.O;f+=q.top+q.marginTop+q.S;var x=!1;if(l&&l.Nd())if(a.I[l.toString()])c.tc(a,q,b,null,1,a.e,a.h),l=M(!0);else{var P=
L("layoutContainer.inner"),W=l.toString(),ea=Y(c,a,"column-count"),Ja=Y(c,a,"column-gap"),ja=1<ea?Y(c,a,"column-width"):q.width,l=im(c,a),E=0,v=jm(c,a,"shape-inside"),K=og(v,0,0,q.width,q.height,a),Al=new Om(W,a,a.viewport,a.d,l,a.Z,a.h,a.style.u,a,b,a.Ta,a.$a,h,a.Za),Cl=new qo(a.f,a.b.page-1),ci=0,ca=null;nf(function(b){for(;ci<ea;){var c=ci++;if(1<ea){var d=a.viewport.b.createElement("div");w(d,"position","absolute");r.appendChild(d);ca=new An(d,Al,a.e,Cl);ca.b=q.b;ca.$a=q.$a;ca.Gb=q.Gb;q.b?(w(d,
"margin-left",q.h+"px"),w(d,"margin-right",q.u+"px"),c=c*(ja+Ja)+q.j,Hi(ca,0,q.width),Gi(ca,c,ja)):(w(d,"margin-top",q.j+"px"),w(d,"margin-bottom",q.l+"px"),c=c*(ja+Ja)+q.h,Gi(ca,0,q.height),Hi(ca,c,ja));ca.B=e+q.h;ca.D=f+q.j}else ca=new An(r,Al,a.e,Cl),Fi(ca,q),q=ca;ca.H=p?[]:g;ca.xb=K;if(0<=ca.width){var k=L("inner");Tp(a,ca,W).then(function(){ca.g&&"column"!=ca.g&&(ci=ea,"region"!=ca.g&&(a.I[W]=!0));O(k,!0)});c=N(k)}else c=M(!0);if(c.Ca()){c.then(function(){0<h.b.length?Q(b):(E=Math.max(E,ca.d),
pf(b))});return}0<h.b.length||(E=Math.max(E,ca.d))}Q(b)}).then(function(){q.d=E;c.tc(a,q,b,ca,ea,a.e,a.h);O(P,!0)});l=N(P)}else(l=jm(c,a,"content"))&&Ji(l)?(v=a.viewport.b.createElement("span"),l.U(new Ii(v,a)),r.appendChild(v),wm(c,a,q,a.h)):c.ra&&(d.removeChild(r),x=!0),x||c.tc(a,q,b,null,1,a.e,a.h),l=M(!0);l.then(function(){if(!c.f||0<Math.floor(q.d)){if(!x&&!m){var l=q.B+q.left,p=q.D+q.top,v=Di(q)+q.width+Ei(q),E=Bi(q)+q.height+Ci(q),W=jm(c,a,"shape-outside"),l=og(W,l,p,v,E,a);g.push(l)}}else if(0==
c.children.length){d.removeChild(r);O(k,!0);return}var P=c.children.length-1;mf(function(){for(;0<=P;){var d=c.children[P--],d=Up(a,b,d,r,e,f,g,h);if(d.Ca())return d}return M(!1)}).then(function(){O(k,!0)})});return N(k)}
...
h.b.length){l=l.concat(Ui(h));h.b.splice(0,h.b.length);c=a.b=a.k.clone();for(var e;e=b.d.lastChild;)b.d.removeChild(e);pf(d)}else Q(d)})}).then(function(){e.S(a,b,a.e);var d=new Rc(e.d.d,"left-page");b.j=d.evaluate(a)?"left":"right";var d=a.b.page,f;for(f in a.b.b)for(var g=a.b.b[f],h=g.b.length-1;0<=h;h--){var l=g.b[h];0<=l.b.Qa&&l.b.Qa+l.b.h-1<=d&&g.b.splice(h,1)}a.b=a.k=null;c.d=a.d.b;Zh(b,a.style.h.D[a.Z.url]);var x;a:{for(x in a.g)if((f=c.b[x])&&0<f.b.length){x=!1;break a}x=!0}x&&(c=null);O(k,
...
function Jq(a,b,c){var d=L("renderSinglePage"),e=Kq(a,b,c);Vp(b.Ja,e,c).then(function(f){var g=(c=f)?c.page-1:b.Ka.length-1;Iq(a,b,e,g);Co(a.d,a.F,g);var h=a.F,l=a.G,k=a.na;f=null;if(c){var m=b.Ka[c.page];b.Ka[c.page]=c;m&&b.rb[c.page]&&!zi(c,m)&&(a.G=c.page,f=Jq(a,b,c))}f||(f=M(!0));f.then(function(){var b=Do(a.d,e),f=0;nf(function(c){f++;if(f>b.length)Q(c);else{var d=b[f-1];d.wc=d.wc.filter(function(a){return!a.ec});0===d.wc.length?pf(c):(a.F=d.F,a.G=d.G,Lq(a).then(function(b){b?(Bo(a.d,d.cd),Eo(a.d,
...
function Mq(a){var b=L("renderPage");Lq(a).then(function(c){if(c){var d=-1;if(0>a.G){var d=a.na,e=Ra(c.Ka.length,function(a){return Rp(c.Ja,c.Ka[a])>d});a.G=e==c.Ka.length?Number.POSITIVE_INFINITY:e-1}var f=c.rb[a.G];f?(a.na=f.offset,O(b,f)):nf(function(b){if(a.G<c.Ka.length)Q(b);else if(c.complete)a.G=c.Ka.length-1,Q(b);else{var e=c.Ka[c.Ka.length-1];Jq(a,c,e).then(function(l){var k=l.page;e=l.position;l=l.G;e?0<=d&&Rp(c.Ja,e)>d?(f=k,a.G=c.Ka.length-2,Q(b)):pf(b):(f=k,a.G=l,0>d&&(a.na=k.offset),
...
function Nq(a,b,c){var d=L("renderAllPages"),e=a.F,f=a.G;a.F=0;nf(function(d){a.G=a.F==b?c:Number.POSITIVE_INFINITY;Mq(a).then(function(){++a.F>b?Q(d):pf(d)})}).then(function(){a.F=e;a.G=f;Mq(a).ua(d)});return N(d)}n.Zd=function(){this.G=this.F=0;return Mq(this)};n.$d=function(){this.F=this.b.b.length-1;this.G=Number.POSITIVE_INFINITY;return Mq(this)};
...
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(ya(location.href,Na(a||"")));break;case "hyperlink":a.internal&&ur({a:"moveTo",url:a.href})}}
