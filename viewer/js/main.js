 ...
 *
 * Vivliostyle core 2017.2.1-pre.20170303064518
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function Ud(a){this.g=a;this.h=1;this.slice=25;this.l=0;this.f=new ta;this.b=this.w=null;this.j=!1;this.order=0;Md||(Md=this)}
...
l=k}f.b[l]=g}if(!c.h){var l=c,m=l.f;l.f=null;m&&m.b==l&&(m.b=null,k=Ld,Ld=m,O(m.top,l.g),Ld=k)}b=a.g.currentTime();if(b>=a.l)break}}catch(n){u.error(n)}a.j=!1;a.f.length()&&Xd(a)},b)}}Ud.prototype.eb=function(a,b){var c=this.g.currentTime();a.order=this.order++;a.b=c+(b||0);a:{for(var c=this.f,d=c.b.length;1<d;){var e=Math.floor(d/2),f=c.b[e];if(0<Yd(f,a)){c.b[d]=a;break a}c.b[d]=f;d=e}c.b[1]=a}Xd(this)};
function Td(a,b,c){var d=new Zd(a,c||"");d.top=new Nd(d,null,"bootstrap");d.top.b=Od;d.top.then(function(){function a(){d.l=!1;for(var a=0;a<d.j.length;a++){var b=d.j[a];try{b()}catch(h){u.error(h)}}}try{b().then(function(b){d.h=b;a()})}catch(f){Rd(d,f),a()}});c=Ld;Ld=d;a.eb($d(d.top,"bootstrap"));Ld=c;return d}function ae(a){this.f=a;this.order=this.b=0;this.g=null;this.h=!1}function Yd(a,b){return b.b-a.b||b.order-a.order}ae.prototype.eb=function(a,b){this.g=a;this.f.f.eb(this,b)};
function Zd(a,b){this.f=a;this.name=b;this.j=[];this.g=null;this.l=!0;this.b=this.top=this.w=this.h=null}function be(a,b){a.j.push(b)}Zd.prototype.join=function(){var a=I("Task.join");if(this.l){var b=$d(a,this),c=this;be(this,function(){b.eb(c.h)})}else O(a,this.h);return M(a)};
function Rd(a,b,c){var d=b.frameTrace;if(!d){for(var d=b.stack?b.stack+"\n\t---- async ---\n":"",e=a.top;e;e=e.parent)d+="\t",d+=e.name,d+="\n";b.frameTrace=d}if(c){for(d=a.top;d&&d!=c;)d=d.parent;d==c&&(a.top=d)}for(a.g=b;a.top&&!a.top.j;)a.top=a.top.parent;a.top?(b=a.g,a.g=null,a.top.j(a.top,b)):a.g&&u.error(a.g,"Unhandled exception in task",a.name)}function Pd(a){this.value=a}p=Pd.prototype;p.then=function(a){a(this.value)};p.oa=function(a){return a(this.value)};p.nd=function(a){return new Pd(a)};
p.Fa=function(a){O(a,this.value)};p.za=function(){return!1};p.get=function(){return this.value};function ce(a){this.b=a}p=ce.prototype;p.then=function(a){this.b.then(a)};p.oa=function(a){if(this.za()){var b=new Nd(this.b.f,this.b.parent,"AsyncResult.thenAsync");b.b=Od;this.b.parent=b;this.b.then(function(c){a(c).then(function(a){O(b,a)})});return M(b)}return a(this.b.g)};p.nd=function(a){return this.za()?this.oa(function(){return new Pd(a)}):new Pd(a)};
...
function ee(){var a=I("Frame.timeSlice"),b=a.f.f;b.g.currentTime()>=b.l?(u.debug("-- time slice --"),$d(a).eb(!0)):O(a,!0);return M(a)}function fe(a){var b=I("Frame.sleep");$d(b).eb(!0,a);return M(b)}function ge(a){function b(d){try{for(;d;){var e=a();if(e.za()){e.then(b);return}e.then(function(a){d=a})}O(c,!0)}catch(f){Rd(c.f,f,c)}}var c=I("Frame.loop");b(!0);return M(c)}
...
function le(a){if(!a.length)return L(!0);if(1==a.length)return a[0].get().nd(!0);var b=I("waitForFetches"),c=0;ge(function(){for(;c<a.length;){var b=a[c++];if(!b.f)return b.get().nd(!0)}return L(!1)}).then(function(){O(b,!0)});return M(b)}
function me(a,b){var c=null,d=null;"img"==a.localName&&(c=a.getAttribute("width"),d=a.getAttribute("height"));var e=new je(function(){function e(b){l||(l=!0,"img"==a.localName&&(c||a.removeAttribute("width"),d||a.removeAttribute("height")),h.eb(b?b.type:"timeout"))}var g=I("loadImage"),h=$d(g,a),l=!1;a.addEventListener("load",e,!1);a.addEventListener("error",e,!1);a.addEventListener("abort",e,!1);"http://www.w3.org/2000/svg"==a.namespaceURI?(a.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",
...
break;case 73:if(9>g-z&&f.substring(z+1,g+1).match(/^[0-9a-fA-F]{0,6}[ \t]$/)){g++;continue}m=oe(f.substring(k,g));break;case 75:z=g++;continue;case 76:g++;e=ve;continue;default:e!==re?(l=51,m="E_CSS_UNEXPECTED_STATE"):(k=g,l=0)}q.type=l;q.b=r;q.I=n;q.text=m;q.position=k;b++;if(b>=c)break;e=re;r=!1;q=h[b&d]}a.position=g;a.h=b&d};function Xe(a,b,c,d,e){var f=I("ajax"),g=new XMLHttpRequest,h=$d(f,g),l={status:0,url:a,contentType:null,responseText:null,responseXML:null,dd:null};g.open(c||"GET",a,!0);b&&(g.responseType=b);g.onreadystatechange=function(){if(4===g.readyState){l.status=g.status;if(200==l.status||!l.status)if(b&&"document"!==b||!g.responseXML||"parsererror"==g.responseXML.documentElement.localName)if((!b||"document"===b)&&g.response instanceof HTMLDocument)l.responseXML=g.response,l.contentType=g.response.contentType;
else{var c=g.response;b&&"text"!==b||"string"!=typeof c?c?"string"==typeof c?l.dd=Ye([c]):l.dd=c:u.b("Unexpected empty success response for",a):l.responseText=c;if(c=g.getResponseHeader("Content-Type"))l.contentType=c.replace(/(.*);.*$/,"$1")}else l.responseXML=g.responseXML,l.contentType=g.responseXML.contentType;h.eb(l)}};try{d?(g.setRequestHeader("Content-Type",e||"text/plain; charset=UTF-8"),g.send(d)):g.send(null)}catch(k){u.b(k,"Error fetching "+a),h.eb(l)}return M(f)}
function Ye(a){var b=window.WebKitBlobBuilder||window.MSBlobBuilder;if(b){for(var b=new b,c=0;c<a.length;c++)b.append(a[c]);return b.getBlob("application/octet-stream")}return new Blob(a,{type:"application/octet-stream"})}function Ze(a){var b=I("readBlob"),c=new FileReader,d=$d(b,c);c.addEventListener("load",function(){d.eb(c.result)},!1);c.readAsArrayBuffer(a);return M(b)}function $e(a,b){this.Z=a;this.type=b;this.h={};this.j={}}
$e.prototype.load=function(a,b,c){a=la(a);var d=this.h[a];return"undefined"!=typeof d?L(d):this.fetch(a,b,c).get()};function af(a,b,c,d){var e=I("fetch");Xe(b,a.type).then(function(f){if(c&&400<=f.status)throw Error(d||"Failed to fetch required resource: "+b);a.Z(f,a).then(function(c){delete a.j[b];a.h[b]=c;O(e,c)})});return M(e)}$e.prototype.fetch=function(a,b,c){a=la(a);if(this.h[a])return null;var d=this.j[a];if(!d){var e=this,d=new je(function(){return af(e,a,b,c)},"Fetch "+a);e.j[a]=d;d.start()}return d};
$e.prototype.get=function(a){return this.h[la(a)]};function bf(a){a=a.responseText;return L(a?JSON.parse(a):null)};function cf(a){var b=parseInt(a,16);if(isNaN(b))throw Error("E_CSS_COLOR");if(6==a.length)return new Ec(b);if(3==a.length)return new Ec(b&15|(b&15)<<4|(b&240)<<4|(b&240)<<8|(b&3840)<<8|(b&3840)<<12);throw Error("E_CSS_COLOR");}function df(a){this.f=a;this.Za="Author"}p=df.prototype;p.Ac=function(){return null};p.ha=function(){return this.f};p.error=function(){};p.lc=function(a){this.Za=a};p.yb=function(){};p.vd=function(){};p.Fc=function(){};p.Gc=function(){};p.Cd=function(){};p.Tc=function(){};
...
p.Vc=function(){this.b.Vc()};function jf(a,b,c){df.call(this,a);this.J=c;this.H=0;if(this.ja=b)this.Za=b.Za}t(jf,df);jf.prototype.Ac=function(){return this.ja.Ac()};jf.prototype.error=function(a){u.b(a)};jf.prototype.wa=function(){this.H++};jf.prototype.Hb=function(){if(!--this.H&&!this.J){var a=this.ja;a.b=a.g.pop()}};function kf(a,b,c){jf.call(this,a,b,c)}t(kf,jf);function lf(a,b){a.error(b,a.Ac())}function mf(a,b){lf(a,b);hf(a.ja,new jf(a.f,a.ja,!1))}p=kf.prototype;p.tb=function(){mf(this,"E_CSS_UNEXPECTED_SELECTOR")};
p.hd=function(){mf(this,"E_CSS_UNEXPECTED_FONT_FACE")};p.Jc=function(){mf(this,"E_CSS_UNEXPECTED_FOOTNOTE")};p.md=function(){mf(this,"E_CSS_UNEXPECTED_VIEWPORT")};p.fd=function(){mf(this,"E_CSS_UNEXPECTED_DEFINE")};p.ld=function(){mf(this,"E_CSS_UNEXPECTED_REGION")};p.kc=function(){mf(this,"E_CSS_UNEXPECTED_PAGE")};p.bc=function(){mf(this,"E_CSS_UNEXPECTED_WHEN")};p.gd=function(){mf(this,"E_CSS_UNEXPECTED_FLOW")};p.kd=function(){mf(this,"E_CSS_UNEXPECTED_PAGE_TEMPLATE")};p.jd=function(){mf(this,"E_CSS_UNEXPECTED_PAGE_MASTER")};
p.Mc=function(){mf(this,"E_CSS_UNEXPECTED_PARTITION")};p.Lc=function(){mf(this,"E_CSS_UNEXPECTED_PARTITION_GROUP")};p.Kc=function(){mf(this,"E_CSS_UNEXPECTED_SELECTOR_FUNC")};p.Vc=function(){mf(this,"E_CSS_UNEXPECTED_END_SELECTOR_FUNC")};p.rb=function(){this.error("E_CSS_UNEXPECTED_PROPERTY",this.Ac())};var nf=[],of=[],T=[],pf=[],qf=[],rf=[],sf=[],tf=[],uf=[],vf=[],wf=[],xf=[],yf=[];nf[1]=28;nf[36]=29;nf[7]=29;nf[9]=29;nf[14]=29;nf[18]=29;nf[20]=30;nf[13]=27;nf[0]=200;of[1]=46;of[0]=200;rf[1]=2;
...
new bc(e.ha(),g,f);break;case 19:f=new cc(e.ha(),g,f);break;case 21:f=new dc(e.ha(),g,f);break;case 18:if(1<d.length)switch(d[d.length-1]){case 22:d.pop();f=new ic(e.ha(),d.pop(),g,f);break;case 10:if(g.ge())f=new jc(e.ha(),g,f);else return Cf(a,"E_CSS_MEDIA_TEST",c),!1}else return Cf(a,"E_CSS_EXPR_COND",c),!1;break;case 22:if(18!=b)return Cf(a,"E_CSS_EXPR_COND",c),!1;case 10:return d.push(g),d.push(h),d.push(f),!1;default:return Cf(a,"F_UNEXPECTED_STATE",c),!1}}}d.push(f);return!1}
...
S(h);a.b=sf;l.splice(0,l.length);continue;case 29:a.b=rf;g.tb();continue;case 1:if(!k.b){a.b=xf;g.error("E_CSS_SPACE_EXPECTED",k);continue}g.Gb();case 2:if(34==Ve(h,1).type)if(S(h),S(h),n=a.V[k.text],null!=n)switch(k=R(h),k.type){case 1:g.yb(n,k.text);a.b=f?pf:T;S(h);break;case 36:g.yb(n,null);a.b=f?pf:T;S(h);break;default:a.b=vf,g.error("E_CSS_NAMESPACE",k)}else a.b=vf,g.error("E_CSS_UNDECLARED_PREFIX",k);else g.yb(a.J,k.text),a.b=f?pf:T,S(h);continue;case 3:if(!k.b){a.b=xf;g.error("E_CSS_SPACE_EXPECTED",
k);continue}g.Gb();case 4:if(34==Ve(h,1).type)switch(S(h),S(h),k=R(h),k.type){case 1:g.yb(null,k.text);a.b=f?pf:T;S(h);break;case 36:g.yb(null,null);a.b=f?pf:T;S(h);break;default:a.b=vf,g.error("E_CSS_NAMESPACE",k)}else g.yb(a.J,null),a.b=f?pf:T,S(h);continue;case 5:k.b&&g.Gb();case 6:g.Cd(k.text);a.b=f?pf:T;S(h);continue;case 7:k.b&&g.Gb();case 8:g.vd(k.text);a.b=f?pf:T;S(h);continue;case 55:k.b&&g.Gb();case 14:S(h);k=R(h);b:switch(k.type){case 1:g.Fc(k.text,null);S(h);a.b=f?pf:T;continue;case 6:m=
k.text;S(h);switch(m){case "not":a.b=rf;g.Kc("not");If(a,Number.POSITIVE_INFINITY,!1,!1,!1,!0)?a.b=T:a.b=xf;break a;case "lang":case "href-epub-type":if(k=R(h),1===k.type){n=[k.text];S(h);break}else break b;case "nth-child":case "nth-of-type":case "nth-last-child":case "nth-last-of-type":if(n=Ff(a))break;else break b;default:n=Ef(a)}k=R(h);if(11==k.type){g.Fc(m,n);S(h);a.b=f?pf:T;continue}}g.error("E_CSS_PSEUDOCLASS_SYNTAX",k);a.b=vf;continue;case 42:S(h);k=R(h);switch(k.type){case 1:g.Gc(k.text,
null);a.b=f?pf:T;S(h);continue;case 6:if(m=k.text,S(h),n=Ef(a),k=R(h),11==k.type){g.Gc(m,n);a.b=f?pf:T;S(h);continue}}g.error("E_CSS_PSEUDOELEM_SYNTAX",k);a.b=vf;continue;case 9:k.b&&g.Gb();case 10:S(h);k=R(h);if(1==k.type)m=k.text,S(h);else if(36==k.type)m=null,S(h);else if(34==k.type)m="";else{a.b=xf;g.error("E_CSS_ATTR",k);S(h);continue}k=R(h);if(34==k.type){n=m?a.V[m]:m;if(null==n){a.b=xf;g.error("E_CSS_UNDECLARED_PREFIX",k);S(h);continue}S(h);k=R(h);if(1!=k.type){a.b=xf;g.error("E_CSS_ATTR_NAME_EXPECTED",
k);continue}m=k.text;S(h);k=R(h)}else n="";switch(k.type){case 39:case 45:case 44:case 43:case 42:case 46:case 50:r=k.type;S(h);k=R(h);break;case 15:g.Tc(n,m,0,null);a.b=f?pf:T;S(h);continue;default:a.b=xf;g.error("E_CSS_ATTR_OP_EXPECTED",k);continue}switch(k.type){case 1:case 2:g.Tc(n,m,r,k.text);S(h);k=R(h);break;default:a.b=xf;g.error("E_CSS_ATTR_VAL_EXPECTED",k);continue}if(15!=k.type){a.b=xf;g.error("E_CSS_ATTR",k);continue}a.b=f?pf:T;S(h);continue;case 11:g.ud();a.b=qf;S(h);continue;case 12:g.rd();
a.b=qf;S(h);continue;case 56:g.yd();a.b=qf;S(h);continue;case 13:a.Z?(a.h.push("-epubx-region"),a.Z=!1):a.X?(a.h.push("page"),a.X=!1):a.h.push("[selector]");g.wa();a.b=nf;S(h);continue;case 41:g.ic();a.b=rf;S(h);continue;case 15:l.push(C(k.text));S(h);continue;case 16:try{l.push(cf(k.text))}catch(z){g.error("E_CSS_COLOR",k),a.b=vf}S(h);continue;case 17:l.push(new Cc(k.I));S(h);continue;case 18:l.push(new Dc(k.I));S(h);continue;case 19:l.push(new D(k.I,k.text));S(h);continue;case 20:l.push(new Ac(k.text));
S(h);continue;case 21:l.push(new Fc(oa(k.text,a.fa)));S(h);continue;case 22:Bf(a,",",k);l.push(",");S(h);continue;case 23:l.push(xc);S(h);continue;case 24:m=k.text.toLowerCase();"-epubx-expr"==m?(a.b=tf,a.j=0,l.push("{")):(l.push(m),l.push("("));S(h);continue;case 25:Bf(a,")",k);S(h);continue;case 47:S(h);k=R(h);m=Ve(h,1);if(1==k.type&&"important"==k.text.toLowerCase()&&(17==m.type||0==m.type||13==m.type)){S(h);a.C=!0;continue}Cf(a,"E_CSS_SYNTAX",k);continue;case 54:m=Ve(h,1);switch(m.type){case 4:case 3:case 5:if(!m.b){S(h);
...
k.I)),S(h),a.b=uf);continue;case 36:l.push(-k.type);S(h);continue;case 37:a.b=tf;Df(a,k.type,k);l.push(k.type);S(h);continue;case 45:"and"==k.text.toLowerCase()?(a.b=tf,Df(a,52,k),l.push(52),S(h)):Cf(a,"E_CSS_SYNTAX",k);continue;case 39:Df(a,k.type,k)&&(a.g?a.b=sf:Cf(a,"E_CSS_UNBALANCED_PAR",k));S(h);continue;case 43:Df(a,11,k)&&(a.g||3==a.j?Cf(a,"E_CSS_UNEXPECTED_BRC",k):(1==a.j?g.bc(l.pop()):(k=l.pop(),g.bc(k)),a.h.push("media"),g.wa(),a.b=nf));S(h);continue;case 49:if(Df(a,11,k))if(a.g||3!=a.j)Cf(a,
"E_CSS_UNEXPECTED_SEMICOL",k);else return a.A=l.pop(),a.H=!0,a.b=nf,S(h),!1;S(h);continue;case 40:l.push(k.type);S(h);continue;case 27:a.b=nf;S(h);g.Hb();a.h.length&&a.h.pop();continue;case 30:m=k.text.toLowerCase();switch(m){case "import":S(h);k=R(h);if(2==k.type||8==k.type){a.O=k.text;S(h);k=R(h);if(17==k.type||0==k.type)return a.H=!0,S(h),!1;a.g=null;a.j=3;a.b=tf;l.push("{");continue}g.error("E_CSS_IMPORT_SYNTAX",k);a.b=vf;continue;case "namespace":S(h);k=R(h);switch(k.type){case 1:m=k.text;S(h);
...
Ve(h,1).type){S(h);S(h);switch(m){case "font-face":g.hd();break;case "-epubx-page-template":g.kd();break;case "-epubx-define":g.fd();break;case "-epubx-viewport":g.md()}a.h.push(m);g.wa();continue}break;case "-adapt-footnote-area":S(h);k=R(h);switch(k.type){case 12:S(h);g.Jc(null);a.h.push(m);g.wa();continue;case 50:if(S(h),k=R(h),1==k.type&&12==Ve(h,1).type){m=k.text;S(h);S(h);g.Jc(m);a.h.push("-adapt-footnote-area");g.wa();continue}}break;case "-epubx-region":S(h);g.ld();a.Z=!0;a.b=rf;continue;
case "page":S(h);g.kc();a.X=!0;a.b=qf;continue;case "top-left-corner":case "top-left":case "top-center":case "top-right":case "top-right-corner":case "right-top":case "right-middle":case "right-bottom":case "bottom-right-corner":case "bottom-right":case "bottom-center":case "bottom-left":case "bottom-left-corner":case "left-bottom":case "left-middle":case "left-top":S(h);k=R(h);if(12==k.type){S(h);g.Qd(m);a.h.push(m);g.wa();continue}break;case "-epubx-when":S(h);a.g=null;a.j=1;a.b=tf;l.push("{");
continue;case "media":S(h);a.g=null;a.j=2;a.b=tf;l.push("{");continue;case "-epubx-flow":if(1==Ve(h,1).type&&12==Ve(h,2).type){g.gd(Ve(h,1).text);S(h);S(h);S(h);a.h.push(m);g.wa();continue}break;case "-epubx-page-master":case "-epubx-partition":case "-epubx-partition-group":S(h);k=R(h);r=n=null;var q=[];1==k.type&&(n=k.text,S(h),k=R(h));18==k.type&&1==Ve(h,1).type&&(r=Ve(h,1).text,S(h),S(h),k=R(h));for(;6==k.type&&"class"==k.text.toLowerCase()&&1==Ve(h,1).type&&11==Ve(h,2).type;)q.push(Ve(h,1).text),
...
function Kf(a,b,c,d,e){var f=I("parseStylesheet"),g=new zf(nf,a,b,c),h=null;e&&(h=Lf(new Te(e,b),b,c));if(h=Gf(g,d,h&&h.ra()))b.bc(h),b.wa();ge(function(){for(;!If(g,100,!1,!1,!1,!1);){if(g.H){var a=oa(g.O,c);g.A&&(b.bc(g.A),b.wa());var d=I("parseStylesheet.import");Mf(a,b,null,null).then(function(){g.A&&b.Hb();g.H=!1;g.O=null;g.A=null;O(d,!0)});return M(d)}a=ee();if(a.za)return a}return L(!1)}).then(function(){h&&b.Hb();O(f,!0)});return M(f)}
...
function og(a,b){if(!a.length)return b;for(var c=b.N,d,e=a.length-1;0<=e&&!(d=a[e],e===a.length-1&&d.N<b.N)&&!(d.R<b.N&&d.U-.1<=b.U&&d.T+.1>=b.T);e--)c=Math.min(c,d.R);for(var f=Math.min(c,d.N);0<=e&&!(d=a[e],d.N<=b.R||d.U-.1>b.U||d.T+.1<b.T);e--)f=d.R;f=Math.max(f,b.R);return c<=f?null:new Rf(b.U,f,b.T,c)};function pg(){this.b={}}t(pg,pc);pg.prototype.Rb=function(a){this.b[a.name]=!0;return a};pg.prototype.ub=function(a){this.Sb(a.values);return a};function qg(a){this.value=a}t(qg,pc);qg.prototype.oc=function(a){this.value=a.I;return a};function rg(a,b){if(a){var c=new qg(b);try{return a.ba(c),c.value}catch(d){u.b(d,"toInt: ")}}return b}function sg(){this.f=!1;this.b=[];this.name=null}t(sg,pc);sg.prototype.rc=function(a){this.f&&this.b.push(a);return null};
sg.prototype.qc=function(a){this.f&&!a.I&&this.b.push(new D(0,"px"));return null};sg.prototype.ub=function(a){this.Sb(a.values);return null};sg.prototype.zb=function(a){this.f||(this.f=!0,this.Sb(a.values),this.f=!1,this.name=a.name.toLowerCase());return null};
function tg(a,b,c,d,e,f){if(a){var g=new sg;try{a.ba(g);var h;a:{if(0<g.b.length){a=[];for(var l=0;l<g.b.length;l++){var k=g.b[l];if("%"==k.ga){var m=l%2?e:d;3==l&&"circle"==g.name&&(m=Math.sqrt((d*d+e*e)/2));a.push(k.I*m/100)}else a.push(k.I*Cb(f,k.ga,!1))}switch(g.name){case "polygon":if(!(a.length%2)){f=[];for(g=0;g<a.length;g+=2)f.push(new Sf(b+a[g],c+a[g+1]));h=new Xf(f);break a}break;case "rectangle":if(4==a.length){h=$f(b+a[0],c+a[1],b+a[0]+a[2],c+a[1]+a[3]);break a}break;case "ellipse":if(4==
a.length){h=Zf(b+a[0],c+a[1],a[2],a[3]);break a}break;case "circle":if(3==a.length){h=Zf(b+a[0],c+a[1],a[2],a[2]);break a}}}h=null}return h}catch(n){u.b(n,"toShape:")}}return $f(b,c,b+d,c+e)}function ug(a){this.f=a;this.b={};this.name=null}t(ug,pc);ug.prototype.Rb=function(a){this.name=a.toString();this.b[this.name]=this.f?0:(this.b[this.name]||0)+1;return a};ug.prototype.oc=function(a){this.name&&(this.b[this.name]+=a.I-(this.f?0:1));return a};ug.prototype.ub=function(a){this.Sb(a.values);return a};
function vg(a,b){var c=new ug(b);try{a.ba(c)}catch(d){u.b(d,"toCounters:")}return c.b}function wg(a,b){this.b=a;this.f=b}t(wg,qc);wg.prototype.sc=function(a){return new Fc(this.f.Oc(a.url,this.b))};function xg(a){this.g=this.h=null;this.f=0;this.b=a}function yg(a,b){this.b=-1;this.f=a;this.g=b}function zg(){this.b=[];this.f=[];this.match=[];this.g=[];this.error=[];this.h=!0}zg.prototype.connect=function(a,b){for(var c=0;c<a.length;c++)this.f[a[c]].b=b;a.splice(0,a.length)};
...
p.qd=function(a){return this.b&64?a:null};p.sc=function(a){return this.b&128?a:null};p.ub=function(){return null};p.Qb=function(){return null};p.zb=function(){return null};p.nc=function(){return null};var Bg=new Dg(0,U,U);
...
k.ba(f.b);if(m){if(m!==k&&b===e)for(e=[],k=0;k<g;k++)e[k]=b[k];b!==e&&(e[g-d]=m);g++;f=f.h}else f=f.g}}return f===a.b&&(c?0<e.length:g==b.length)?e:null}p=Gg.prototype;p.kb=function(a){for(var b=null,c=this.f;c!==this.b&&c!==this.g;)a?c.f?c=c.h:(b=a.ba(c.b))?(a=null,c=c.h):c=c.g:c=c.g;return c===this.b?b:null};p.Sd=function(a){return this.kb(a)};p.Td=function(a){return this.kb(a)};p.Pc=function(a){return this.kb(a)};p.Rb=function(a){return this.kb(a)};p.rc=function(a){return this.kb(a)};p.qc=function(a){return this.kb(a)};
p.oc=function(a){return this.kb(a)};p.qd=function(a){return this.kb(a)};p.sc=function(a){return this.kb(a)};p.ub=function(){return null};p.Qb=function(){return null};p.zb=function(a){return this.kb(a)};p.nc=function(){return null};function Ig(a){Gg.call(this,a)}t(Ig,Gg);Ig.prototype.ub=function(a){var b=Hg(this,a.values,!1,0);return b===a.values?a:b?new rc(b):null};
Ig.prototype.Qb=function(a){for(var b=this.f,c=!1;b;){if(b.b instanceof Jg){c=!0;break}b=b.g}return c?(b=Hg(this,a.values,!1,0),b===a.values?a:b?new sc(b):null):null};Ig.prototype.h=function(a,b){return Hg(this,a,!0,b)};function Jg(a){Gg.call(this,a)}t(Jg,Gg);Jg.prototype.ub=function(a){return this.kb(a)};Jg.prototype.Qb=function(a){var b=Hg(this,a.values,!1,0);return b===a.values?a:b?new sc(b):null};Jg.prototype.h=function(a,b){for(var c=this.f,d;c!==this.g;){if(d=c.b.h(a,b))return d;c=c.g}return null};
function Kg(a,b){Gg.call(this,b);this.name=a}t(Kg,Gg);Kg.prototype.kb=function(){return null};Kg.prototype.zb=function(a){if(a.name.toLowerCase()!=this.name)return null;var b=Hg(this,a.values,!1,0);return b===a.values?a:b?new tc(a.name,b):null};function Lg(){}Lg.prototype.b=function(a,b){return b};Lg.prototype.g=function(){};function Mg(a,b){this.name=b;this.h=a.g[this.name]}t(Mg,Lg);
Mg.prototype.b=function(a,b,c){if(c.values[this.name])return b;if(a=this.h.h(a,b)){var d=a.length;this.g(1<d?new rc(a):a[0],c);return b+d}return b};Mg.prototype.g=function(a,b){b.values[this.name]=a};function Ng(a,b){Mg.call(this,a,b[0]);this.f=b}t(Ng,Mg);Ng.prototype.g=function(a,b){for(var c=0;c<this.f.length;c++)b.values[this.f[c]]=a};function Og(a,b){this.f=a;this.me=b}t(Og,Lg);
Og.prototype.b=function(a,b,c){var d=b;if(this.me)if(a[b]==xc){if(++b==a.length)return d}else return d;var e=this.f[0].b(a,b,c);if(e==b)return d;b=e;for(d=1;d<this.f.length&&b<a.length;d++){e=this.f[d].b(a,b,c);if(e==b)break;b=e}return b};function Pg(){this.b=this.ib=null;this.error=!1;this.values={};this.f=null}p=Pg.prototype;p.clone=function(){var a=new this.constructor;a.ib=this.ib;a.b=this.b;a.f=this.f;return a};p.Wd=function(a,b){this.ib=a;this.b=b};p.dc=function(){this.error=!0;return 0};
function Qg(a,b){a.dc([b]);return null}p.Sd=function(a){return Qg(this,a)};p.Pc=function(a){return Qg(this,a)};p.Rb=function(a){return Qg(this,a)};p.rc=function(a){return Qg(this,a)};p.qc=function(a){return Qg(this,a)};p.oc=function(a){return Qg(this,a)};p.qd=function(a){return Qg(this,a)};p.sc=function(a){return Qg(this,a)};p.ub=function(a){this.dc(a.values);return null};p.Qb=function(){this.error=!0;return null};p.zb=function(a){return Qg(this,a)};p.nc=function(){this.error=!0;return null};
function Rg(){Pg.call(this)}t(Rg,Pg);Rg.prototype.dc=function(a){for(var b=0,c=0;b<a.length;){var d=this.ib[c].b(a,b,this);if(d>b)b=d,c=0;else if(++c==this.ib.length){this.error=!0;break}}return b};function Sg(){Pg.call(this)}t(Sg,Pg);Sg.prototype.dc=function(a){if(a.length>this.ib.length||!a.length)return this.error=!0,0;for(var b=0;b<this.ib.length;b++){for(var c=b;c>=a.length;)c=1==c?0:c-2;if(this.ib[b].b(a,c,this)!=c+1)return this.error=!0,0}return a.length};function Tg(){Pg.call(this)}t(Tg,Pg);
Tg.prototype.dc=function(a){for(var b=a.length,c=0;c<a.length;c++)if(a[c]===xc){b=c;break}if(b>this.ib.length||!a.length)return this.error=!0,0;for(c=0;c<this.ib.length;c++){for(var d=c;d>=b;)d=1==d?0:d-2;var e;if(b+1<a.length)for(e=b+c+1;e>=a.length;)e-=e==b+2?1:2;else e=d;if(2!=this.ib[c].b([a[d],a[e]],0,this))return this.error=!0,0}return a.length};function Ug(){Pg.call(this)}t(Ug,Rg);
Ug.prototype.Qb=function(a){for(var b={},c=0;c<a.values.length;c++){this.values={};if(a.values[c]instanceof sc)this.error=!0;else{a.values[c].ba(this);for(var d=b,e=this.values,f=0;f<this.b.length;f++){var g=this.b[f],h=e[g]||this.f.l[g],l=d[g];l||(l=[],d[g]=l);l.push(h)}this.values["background-color"]&&c!=a.values.length-1&&(this.error=!0)}if(this.error)return null}this.values={};for(var k in b)this.values[k]="background-color"==k?b[k].pop():new sc(b[k]);return null};
function Vg(){Pg.call(this)}t(Vg,Rg);Vg.prototype.Wd=function(a,b){Rg.prototype.Wd.call(this,a,b);this.b.push("font-family","line-height","font-size")};
Vg.prototype.dc=function(a){var b=Rg.prototype.dc.call(this,a);if(b+2>a.length)return this.error=!0,b;this.error=!1;var c=this.f.g;if(!a[b].ba(c["font-size"]))return this.error=!0,b;this.values["font-size"]=a[b++];if(a[b]===xc){b++;if(b+2>a.length||!a[b].ba(c["line-height"]))return this.error=!0,b;this.values["line-height"]=a[b++]}var d=b==a.length-1?a[b]:new rc(a.slice(b,a.length));if(!d.ba(c["font-family"]))return this.error=!0,b;this.values["font-family"]=d;return a.length};
Vg.prototype.Qb=function(a){a.values[0].ba(this);if(this.error)return null;for(var b=[this.values["font-family"]],c=1;c<a.values.length;c++)b.push(a.values[c]);a=new sc(b);a.ba(this.f.g["font-family"])?this.values["font-family"]=a:this.error=!0;return null};Vg.prototype.Rb=function(a){if(a=this.f.f[a.name])for(var b in a)this.values[b]=a[b];else this.error=!0;return null};var Wg={SIMPLE:Rg,INSETS:Sg,INSETS_SLASH:Tg,COMMA:Ug,FONT:Vg};
...
d.push(n.clone())}else n={},n[g.text.toLowerCase()]=C(g.text),d.push($g(new Dg(0,n,U)));h=!1;break;case 5:n={};n[""+g.I]=new Dc(g.I);d.push($g(new Dg(0,n,U)));h=!1;break;case 34:k("|");break;case 25:k("||");break;case 14:h||k(" ");e.push({qe:d,ke:f,vc:"["});f="";d=[];h=!0;break;case 6:h||k(" ");e.push({qe:d,ke:f,vc:"(",hc:g.text});f="";d=[];h=!0;break;case 15:g=l();n=e.pop();if("["!=n.vc)throw Error("']' unexpected");d=n.qe;d.push(g);f=n.ke;h=!1;break;case 11:g=l();n=e.pop();if("("!=n.vc)throw Error("')' unexpected");
d=n.qe;d.push(ah(n.hc,g));f=n.ke;h=!1;break;case 18:if(h)throw Error("':' unexpected");S(b);d.push(Yg(d.pop(),R(b)));break;case 22:if(h)throw Error("'?' unexpected");d.push(Zg(d.pop(),0,1));break;case 36:if(h)throw Error("'*' unexpected");d.push(Zg(d.pop(),0,Number.POSITIVE_INFINITY));break;case 23:if(h)throw Error("'+' unexpected");d.push(Zg(d.pop(),1,Number.POSITIVE_INFINITY));break;case 12:S(b);g=R(b);if(5!=g.type)throw Error("<int> expected");var r=n=g.I;S(b);g=R(b);if(16==g.type){S(b);g=R(b);
if(5!=g.type)throw Error("<int> expected");r=g.I;S(b);g=R(b)}if(13!=g.type)throw Error("'}' expected");d.push(Zg(d.pop(),n,r));break;case 17:m=l();if(0<e.length)throw Error("unclosed '"+e.pop().vc+"'");break;default:throw Error("unexpected token");}S(b);ch(c)?a.b[c]=m:a.g[c]=1!=m.b.length||m.b[0].f?new Ig(m):m.b[0].b}}
...
function Wh(){this.b=null}t(Wh,W);Wh.prototype.apply=function(a){a.Sa&&this.b.apply(a)};Wh.prototype.f=function(){return 6};function Xh(){this.b=null}t(Xh,W);Xh.prototype.apply=function(a){a.ta&&this.b.apply(a)};Xh.prototype.f=function(){return 12};function Yh(a,b){this.b=null;this.h=a;this.vc=b}t(Yh,W);function Zh(a,b){var c=a.h;b-=a.vc;return c?!(b%c)&&0<=b/c:!b}function $h(a,b){Yh.call(this,a,b)}t($h,Yh);$h.prototype.apply=function(a){Zh(this,a.Ma)&&this.b.apply(a)};$h.prototype.f=function(){return 5};
function ai(a,b){Yh.call(this,a,b)}t(ai,Yh);ai.prototype.apply=function(a){Zh(this,a.wb[a.j][a.f])&&this.b.apply(a)};ai.prototype.f=function(){return 5};function bi(a,b){Yh.call(this,a,b)}t(bi,Yh);bi.prototype.apply=function(a){var b=a.V;null===b&&(b=a.V=a.b.parentNode.childElementCount-a.Ma+1);Zh(this,b)&&this.b.apply(a)};bi.prototype.f=function(){return 4};function ci(a,b){Yh.call(this,a,b)}t(ci,Yh);
...
vi.prototype.Rb=function(a){var b=this.f,c=b.J,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.C)];b.C++;break;case "close-quote":return 0<b.C&&b.C--,c[2*Math.min(d,b.C)+1];case "no-open-quote":return b.C++,new Ac("");case "no-close-quote":return 0<b.C&&b.C--,new Ac("")}return a};
...
yi={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},zi={Qf:!1,yc:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",ad:"\u5341\u767e\u5343",hf:"\u8ca0"};
function Ai(a){if(9999<a||-9999>a)return""+a;if(!a)return zi.yc.charAt(0);var b=new Da;0>a&&(b.append(zi.hf),a=-a);if(10>a)b.append(zi.yc.charAt(a));else if(zi.Rf&&19>=a)b.append(zi.ad.charAt(0)),a&&b.append(zi.ad.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(zi.yc.charAt(c)),b.append(zi.ad.charAt(2)));if(c=Math.floor(a/100)%10)b.append(zi.yc.charAt(c)),b.append(zi.ad.charAt(1));if(c=Math.floor(a/10)%10)b.append(zi.yc.charAt(c)),b.append(zi.ad.charAt(0));(a%=10)&&b.append(zi.yc.charAt(a))}return b.toString()}
...
function Mi(){this.j=0;this.b={};this.Nc={};this.h={};this.f={};this.Ca={};this.g={};this.Ec={};this.order=0}Mi.prototype.clone=function(){var a=new Mi;a.j=this.j;for(var b in this.b)a.b[b]=this.b[b];Li(this.Nc,a.Nc);Li(this.h,a.h);Li(this.f,a.f);Li(this.Ca,a.Ca);Li(this.g,a.g);Li(this.Ec,a.Ec);a.order=this.order;return a};function Lh(a,b,c){var d=a[b];d&&(c=d.l(c));a[b]=c}Mi.prototype.je=function(){return this.order+=Ki};
function Ni(a,b,c,d){this.A=a;this.l=b;this.tc=c;this.Xa=d;this.h=[[],[]];this.w={};this.G=this.F=this.b=null;this.xa=this.fa=this.X=this.j=this.f="";this.Z=this.O=null;this.ta=this.Sa=!0;this.g={};this.H=[{}];this.J=[new Ac("\u201c"),new Ac("\u201d"),new Ac("\u2018"),new Ac("\u2019")];this.C=0;this.lang="";this.Cb=[0];this.Ma=0;this.ka=[{}];this.wb=this.ka[0];this.V=null;this.Ab=[this.V];this.Bb=[{}];this.vb=this.ka[0];this.xb=[]}function li(a,b){a.w[b]=(a.w[b]||0)+1}
function Oi(a,b,c){(b=b[c])&&b.apply(a)}var Pi=[];function Qi(a,b,c,d){a.b=null;a.F=d;a.j="";a.f="";a.X="";a.fa="";a.G=b;a.xa="";a.O=Pi;a.Z=c;Ri(a)}function Si(a,b,c){a.g[b]?a.g[b].push(c):a.g[b]=[c];c=a.H[a.H.length-1];c||(c={},a.H[a.H.length-1]=c);c[b]=!0}
...
Si(a,k,0),h=a.g[k],h[h.length-1]+=d[k];c===id&&(c=a.g["ua-list-item"],b["ua-list-item-count"]=new V(new Cc(c[c.length-1]),0));a.H.push(null)}function Ui(a){var b=a.H.pop();if(b)for(var c in b)(b=a.g[c])&&(1==b.length?delete a.g[c]:b.pop())}function qi(a,b,c){Ti(a,b);b.content&&(b.content=b.content.Wc(new vi(a,c,a.Xa)));Ui(a)}var Vi="before transclusion-before footnote-call footnote-marker inner first-letter first-line  transclusion-after after".split(" ");
function Wi(a,b,c){a.xb.push(b);a.Z=null;a.b=b;a.F=c;a.j=b.namespaceURI;a.f=b.localName;var d=a.A.b[a.j];a.xa=d?d+a.f:"";a.X=b.getAttribute("id");a.fa=b.getAttributeNS("http://www.w3.org/XML/1998/namespace","id");(d=b.getAttribute("class"))?a.G=d.split(/\s+/):a.G=Pi;(d=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))?a.O=d.split(/\s+/):a.O=Pi;"style"==a.f&&"http://www.gribuser.ru/xml/fictionbook/2.0"==a.j&&(a.G=[b.getAttribute("name")||""]);if(d=Ba(b))a.h[a.h.length-1].push(new ri(a.lang)),
a.lang=d.toLowerCase();var d=a.ta,e=a.Cb;a.Ma=++e[e.length-1];e.push(0);var e=a.ka,f=a.wb=e[e.length-1],g=f[a.j];g||(g=f[a.j]={});g[a.f]=(g[a.f]||0)+1;e.push({});e=a.Ab;null!==e[e.length-1]?a.V=--e[e.length-1]:a.V=null;e.push(null);e=a.Bb;(f=a.vb=e[e.length-1])&&f[a.j]&&f[a.j][a.f]--;e.push({});Ri(a);Xi(a,b);e=c.quotes;c=null;e&&(e=e.evaluate(a.l))&&(c=new si(a.J),e===F?a.J=[new Ac(""),new Ac("")]:e instanceof rc&&(a.J=e.values));Ti(a,a.F);e=a.X||a.fa||b.getAttribute("name")||"";if(d||e){var h={};
Object.keys(a.g).forEach(function(a){h[a]=Array.from(this.g[a])},a);Yi(a.tc,e,h)}if(d=a.F._pseudos)for(e=!0,f=0;f<Vi.length;f++)(g=Vi[f])||(e=!1),(g=d[g])&&(e?qi(a,g,b):a.h[a.h.length-2].push(new pi(g,b)));c&&a.h[a.h.length-2].push(c)}function Zi(a,b){for(var c in b)yh(c)&&(b[c]=b[c].Wc(a))}function Xi(a,b){var c=new ti(b),d=a.F,e=d._pseudos,f;for(f in e)Zi(c,e[f]);Zi(c,d)}
function Ri(a){var b;for(b=0;b<a.G.length;b++)Oi(a,a.A.Ca,a.G[b]);for(b=0;b<a.O.length;b++)Oi(a,a.A.f,a.O[b]);Oi(a,a.A.g,a.X);Oi(a,a.A.Nc,a.f);""!=a.f&&Oi(a,a.A.Nc,"*");Oi(a,a.A.h,a.xa);null!==a.Z&&(Oi(a,a.A.Ec,a.Z),Oi(a,a.A.Ec,"*"));a.b=null;a.h.push([]);for(var c=1;-1<=c;--c){var d=a.h[a.h.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.Sa=!0;a.ta=!1}
Ni.prototype.pop=function(){for(var a=1;-1<=a;--a)for(var b=this.h[this.h.length-a-2],c=0;c<b.length;)b[c].pop(this,a)?b.splice(c,1):c++;this.h.pop();this.Sa=!1};var $i=null;function aj(a,b,c,d,e,f,g){jf.call(this,a,b,g);this.b=null;this.$=0;this.h=this.Ua=null;this.A=!1;this.W=c;this.j=d?d.j:$i?$i.clone():new Mi;this.F=e;this.w=f;this.l=0}t(aj,kf);aj.prototype.He=function(a){Lh(this.j.Nc,"*",a)};function bj(a,b){var c=Dh(a.b,b);c!==b&&c.g(a.j)||a.He(c)}
aj.prototype.yb=function(a,b){if(b||a)this.$+=1,b&&a?this.b.push(new Oh(a,b.toLowerCase())):b?this.b.push(new Nh(b.toLowerCase())):this.b.push(new Qh(a))};aj.prototype.vd=function(a){this.h?(u.b("::"+this.h,"followed by ."+a),this.b.push(new hi(""))):(this.$+=256,this.b.push(new Kh(a)))};var cj={"nth-child":$h,"nth-of-type":ai,"nth-last-child":bi,"nth-last-of-type":ci};
aj.prototype.Fc=function(a,b){if(this.h)u.b("::"+this.h,"followed by :"+a),this.b.push(new hi(""));else{switch(a.toLowerCase()){case "enabled":this.b.push(new ei);break;case "disabled":this.b.push(new fi);break;case "checked":this.b.push(new gi);break;case "root":this.b.push(new Xh);break;case "link":this.b.push(new Nh("a"));this.b.push(new Rh("","href"));break;case "-adapt-href-epub-type":case "href-epub-type":if(b&&1==b.length&&"string"==typeof b[0]){var c=new RegExp("(^|s)"+qa(b[0])+"($|s)");this.b.push(new Ph(c))}else this.b.push(new hi(""));
...
break;case "last-child":this.b.push(new bi(0,1));break;case "first-of-type":this.b.push(new ai(0,1));break;case "last-of-type":this.b.push(new ci(0,1));break;case "only-child":this.b.push(new Wh);this.b.push(new bi(0,1));break;case "only-of-type":this.b.push(new ai(0,1));this.b.push(new ci(0,1));break;case "empty":this.b.push(new di);break;case "before":case "after":case "first-line":case "first-letter":this.Gc(a,b);return;default:u.b("unknown pseudo-class selector: "+a),this.b.push(new hi(""))}this.$+=
256}};
aj.prototype.Gc=function(a,b){switch(a){case "before":case "after":case "first-line":case "first-letter":case "footnote-call":case "footnote-marker":case "inner":this.h?(u.b("Double pseudoelement ::"+this.h+"::"+a),this.b.push(new hi(""))):this.h=a;break;case "first-n-lines":if(b&&1==b.length&&"number"==typeof b[0]){var c=Math.round(b[0]);if(0<c&&c==b[0]){this.h?(u.b("Double pseudoelement ::"+this.h+"::"+a),this.b.push(new hi(""))):this.h="first-"+c+"-lines";break}}default:u.b("Unrecognized pseudoelement: ::"+a),
this.b.push(new hi(""))}this.$+=1};aj.prototype.Cd=function(a){this.$+=65536;this.b.push(new Mh(a))};
aj.prototype.Tc=function(a,b,c,d){this.$+=256;b=b.toLowerCase();d=d||"";var e;switch(c){case 0:e=new Rh(a,b);break;case 39:e=new Sh(a,b,d);break;case 45:!d||d.match(/\s/)?e=new hi(""):e=new Uh(a,b,new RegExp("(^|\\s)"+qa(d)+"($|\\s)"));break;case 44:e=new Uh(a,b,new RegExp("^"+qa(d)+"($|-)"));break;case 43:d?e=new Uh(a,b,new RegExp("^"+qa(d))):e=new hi("");break;case 42:d?e=new Uh(a,b,new RegExp(qa(d)+"$")):e=new hi("");break;case 46:d?e=new Uh(a,b,new RegExp(qa(d))):e=new hi("");break;case 50:"supported"==
d?e=new Th(a,b):(u.b("Unsupported :: attr selector op:",d),e=new hi(""));break;default:u.b("Unsupported attr selector:",c),e=new hi("")}this.b.push(e)};var dj=0;p=aj.prototype;p.Gb=function(){var a="d"+dj++;bj(this,new Ih(new ki(a)));this.b=[new hi(a)]};p.ud=function(){var a="c"+dj++;bj(this,new Ih(new mi(a)));this.b=[new hi(a)]};p.rd=function(){var a="a"+dj++;bj(this,new Ih(new ni(a)));this.b=[new hi(a)]};p.yd=function(){var a="f"+dj++;bj(this,new Ih(new oi(a)));this.b=[new hi(a)]};
p.ic=function(){ej(this);this.h=null;this.A=!1;this.$=0;this.b=[]};p.tb=function(){var a;0!=this.l?(mf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.l=1,this.Ua={},this.h=null,this.$=0,this.A=!1,this.b=[])};p.error=function(a,b){kf.prototype.error.call(this,a,b);1==this.l&&(this.l=0)};p.lc=function(a){kf.prototype.lc.call(this,a);this.l=0};p.wa=function(){ej(this);kf.prototype.wa.call(this);1==this.l&&(this.l=0)};p.Hb=function(){kf.prototype.Hb.call(this)};
function ej(a){if(a.b){var b=a.$+a.j.je();bj(a,a.Me(b));a.b=null;a.h=null;a.A=!1;a.$=0}}p.Me=function(a){var b=this.F;this.A&&(b=b?"xxx-bogus-xxx":"footnote");return new Jh(this.Ua,a,this.h,b)};p.rb=function(a,b,c){gh(this.w,a,b,c,this)};p.Bc=function(a,b){lf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};p.od=function(a,b){lf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
p.sb=function(a,b,c){"display"!=a||b!==md&&b!==ld||(this.sb("flow-options",new rc([Wc,rd]),c),this.sb("flow-into",b,c),b=Mc);(Jd.SIMPLE_PROPERTY||[]).forEach(function(d){d=d({name:a,value:b,important:c});a=d.name;b=d.value;c=d.important});var d=c?ef(this):ff(this);zh(this.Ua,a,this.W?new vh(b,d,this.W):new V(b,d))};p.Kc=function(a){switch(a){case "not":a=new fj(this),a.tb(),hf(this.ja,a)}};function fj(a){aj.call(this,a.f,a.ja,a.W,a,a.F,a.w,!1);this.parent=a;this.g=a.b}t(fj,aj);p=fj.prototype;
p.Kc=function(a){"not"==a&&mf(this,"E_CSS_UNEXPECTED_NOT")};p.wa=function(){mf(this,"E_CSS_UNEXPECTED_RULE_BODY")};p.ic=function(){mf(this,"E_CSS_UNEXPECTED_NEXT_SELECTOR")};p.Vc=function(){this.b&&0<this.b.length&&this.g.push(new ji(this.b));this.parent.$+=this.$;var a=this.ja;a.b=a.g.pop()};p.error=function(a,b){aj.prototype.error.call(this,a,b);var c=this.ja;c.b=c.g.pop()};function gj(a,b){jf.call(this,a,b,!1)}t(gj,kf);
gj.prototype.rb=function(a,b){if(this.f.values[a])this.error("E_CSS_NAME_REDEFINED "+a,this.Ac());else{var c=a.match(/height|^(top|bottom)$/)?"vh":"vw",c=new ec(this.f,100,c),c=b.ra(this.f,c);this.f.values[a]=c}};function hj(a,b,c,d,e){jf.call(this,a,b,!1);this.Ua=d;this.W=c;this.b=e}t(hj,kf);hj.prototype.rb=function(a,b,c){c?u.b("E_IMPORTANT_NOT_ALLOWED"):gh(this.b,a,b,c,this)};hj.prototype.Bc=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};
hj.prototype.od=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};hj.prototype.sb=function(a,b,c){c=c?ef(this):ff(this);c+=this.order;this.order+=Ki;zh(this.Ua,a,this.W?new vh(b,c,this.W):new V(b,c))};function ij(a,b){Jf.call(this,a);this.Ua={};this.b=b;this.order=0}t(ij,Jf);ij.prototype.rb=function(a,b,c){gh(this.b,a,b,c,this)};ij.prototype.Bc=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};ij.prototype.od=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};
ij.prototype.sb=function(a,b,c){c=(c?67108864:50331648)+this.order;this.order+=Ki;zh(this.Ua,a,new V(b,c))};function jj(a,b,c){return(a=a["writing-mode"])&&(b=a.evaluate(b,"writing-mode"))&&b!==bd?b===zd:c}function kj(a,b,c,d){var e={},f;for(f in a)yh(f)&&(e[f]=a[f]);a=a._regions;if((c||d)&&a)for(d&&(d=["footnote"],c=c?c.concat(d):d),d=0;d<c.length;d++){f=a[c[d]];for(var g in f)yh(g)&&(e[g]=wh(b,e[g],f[g]))}return e}
function lj(a,b,c,d){c=c?th:uh;for(var e in a)if(a.hasOwnProperty(e)){var f=a[e];if(f){var g=c[e];if(g){var h=a[g];if(h&&h.Va>f.Va)continue;g=oh[g]?g:e}else g=e;b[g]=d(e,f)}}};var mj=!1,nj={Ff:"ltr",Gf:"rtl"};ba("vivliostyle.constants.PageProgression",nj);nj.LTR="ltr";nj.RTL="rtl";var oj={Ve:"left",We:"right"};ba("vivliostyle.constants.PageSide",oj);oj.LEFT="left";oj.RIGHT="right";var pj={LOADING:"loading",Ef:"interactive",Bf:"complete"};ba("vivliostyle.constants.ReadyState",pj);pj.LOADING="loading";pj.INTERACTIVE="interactive";pj.COMPLETE="complete";function qj(a,b,c){this.w=a;this.url=b;this.b=c;this.lang=null;this.h=-1;this.root=c.documentElement;b=a=null;if("http://www.w3.org/1999/xhtml"==this.root.namespaceURI){for(var d=this.root.firstChild;d;d=d.nextSibling)if(1==d.nodeType&&(c=d,"http://www.w3.org/1999/xhtml"==c.namespaceURI))switch(c.localName){case "head":b=c;break;case "body":a=c}this.lang=this.root.getAttribute("lang")}else if("http://www.gribuser.ru/xml/fictionbook/2.0"==this.root.namespaceURI){b=this.root;for(d=this.root.firstChild;d;d=
...
var zj={Jf:"text/html",Kf:"text/xml",wf:"application/xml",vf:"application/xhtml_xml",Df:"image/svg+xml"};function Aj(a,b,c){c=c||new DOMParser;var d;try{d=c.parseFromString(a,b)}catch(e){}if(d){a=d.documentElement;if("parsererror"===a.localName)return null;for(a=a.firstChild;a;a=a.nextSibling)if("parsererror"===a.localName)return null}else return null;return d}
...
function Ej(){var a=Fj;return new Dj(function(b){return a.hc(b)&&1==b.nodeType&&"http://www.idpf.org/2008/embedding"==b.getAttribute("Algorithm")})}function Gj(){var a=Ej(),b=Fj;return new Dj(function(c){if(!b.hc(c))return!1;c=new sj([c]);c=rj(c,"EncryptionMethod");a&&(c=Hj(c,a));return 0<c.b.length})}var Fj=new Dj(function(){return!0});function sj(a){this.b=a}function Hj(a,b){for(var c=[],d=0;d<a.b.length;d++){var e=a.b[d];b.hc(e)&&c.push(e)}return new sj(c)}
...
function Wj(a,b,c){Object.keys(a.b).forEach(function(a){for(var b=this.b[a],c=0;c<b.length;)this.K.contains(b[c])?c++:b.splice(c,1);b.length||delete this.b[a]},a);for(var d=a.w,e=0;e<d.length;e++){var f=d[e];v(f.target,f.name,f.value.toString())}e=Xj(c,a.K);a.f.width=e.width;a.f.height=e.height;for(e=0;e<b.length;e++)if(c=b[e],f=a.b[c.Hc],d=a.b[c.kf],f&&d&&(f=Rj(f,c.action)))for(var g=0;g<d.length;g++)d[g].addEventListener(c.event,f,!1)}
...
function bk(a,b,c,d,e,f,g,h,l){this.b=a;this.element=b;this.f=c;this.Va=d;this.l=e;this.h=f;this.nf=g;this.j=h;this.hb=-1;this.g=l}function ck(a,b){return a.h?!b.h||a.Va>b.Va?!0:a.j:!1}function dk(a,b){return a.top-b.top}function ek(a,b){return b.right-a.right}
function fk(a,b){if(a===b)return!0;if(!a||!b||a.ia!==b.ia||a.M!==b.M||a.na.length!==b.na.length)return!1;for(var c=0;c<a.na.length;c++){var d=a[c],e=b[c];if(!(d===e||d&&e&&d.node===e.node&&d.Wa===e.Wa&&d.qa===e.qa&&d.Aa===e.Aa&&d.va===e.va))return!1}return!0}function gk(a){return{na:[{node:a.S,Wa:hk,qa:a.qa,Aa:null,va:null}],ia:0,M:!1,La:a.La}}function ik(a,b){var c=new jk(a.node,b,0);c.Wa=a.Wa;c.qa=a.qa;c.Aa=a.Aa;c.va=a.va?ik(a.va,kk(b)):null;c.L=a.L;return c}var hk=0;
function lk(a,b,c,d,e,f,g){this.ja=a;this.Md=d;this.pe=null;this.root=b;this.ea=c;this.type=f;e&&(e.pe=this);this.b=g}function mk(a,b){this.lf=a;this.count=b}
function jk(a,b,c){this.S=a;this.parent=b;this.pa=c;this.ia=0;this.M=!1;this.Wa=hk;this.qa=b?b.qa:null;this.va=this.Aa=null;this.fa=!1;this.Da=!0;this.b=!1;this.l=b?b.l:0;this.display=null;this.H=nk;this.V=this.A=this.j=null;this.O="baseline";this.X="top";this.sd=this.Z=0;this.G=!1;this.Tb=b?b.Tb:0;this.h=b?b.h:null;this.w=b?b.w:!1;this.J=this.zc=!1;this.C=this.D=this.F=this.g=null;this.qb=b?b.qb:{};this.u=b?b.u:!1;this.ka=b?b.ka:"ltr";this.f=b?b.f:null;this.La=this.lang=null;this.L=b?b.L:null}
function ok(a){a.Da=!0;a.l=a.parent?a.parent.l:0;a.D=null;a.C=null;a.ia=0;a.M=!1;a.display=null;a.H=nk;a.j=null;a.A=null;a.V=null;a.O="baseline";a.G=!1;a.Tb=a.parent?a.parent.Tb:0;a.h=a.parent?a.parent.h:null;a.w=a.parent?a.parent.w:!1;a.g=null;a.F=null;a.Aa=null;a.zc=!1;a.J=!1;a.u=a.parent?a.parent.u:!1;a.Aa=null;a.La=null;a.L=a.parent?a.parent.L:null}
function pk(a){var b=new jk(a.S,a.parent,a.pa);b.ia=a.ia;b.M=a.M;b.Aa=a.Aa;b.Wa=a.Wa;b.qa=a.qa;b.va=a.va;b.Da=a.Da;b.l=a.l;b.display=a.display;b.H=a.H;b.j=a.j;b.A=a.A;b.V=a.V;b.O=a.O;b.X=a.X;b.Z=a.Z;b.sd=a.sd;b.zc=a.zc;b.J=a.J;b.G=a.G;b.Tb=a.Tb;b.h=a.h;b.w=a.w;b.g=a.g;b.F=a.F;b.D=a.D;b.C=a.C;b.f=a.f;b.u=a.u;b.b=a.b;b.La=a.La;b.L=a.L;return b}jk.prototype.modify=function(){return this.fa?pk(this):this};function kk(a){var b=a;do{if(b.fa)break;b.fa=!0;b=b.parent}while(b);return a}
jk.prototype.clone=function(){for(var a=pk(this),b=a,c;c=b.parent;)c=pk(c),b=b.parent=c;return a};function qk(a){return{node:a.S,Wa:a.Wa,qa:a.qa,Aa:a.Aa,va:a.va?qk(a.va):null,L:a.L}}function rk(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(qk(b)),b=b.parent;while(b);b=a.La?sk(a.La,a.ia,-1):a.ia;return{na:c,ia:b,M:a.M,La:a.La}}function tk(a){for(a=a.parent;a;){if(a.zc)return!0;a=a.parent}return!1}function uk(a,b){for(var c=a;c;)c.Da||b(c),c=c.parent}
...
function Ck(a){this.element=a;this.cb=this.bb=this.height=this.width=this.G=this.A=this.H=this.w=this.Z=this.borderTop=this.fa=this.borderLeft=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.xa=this.Ib=null;this.ka=this.wb=this.Xa=this.xb=this.la=0;this.u=!1}function Dk(a){return a.marginTop+a.borderTop+a.A}function Ek(a){return a.marginBottom+a.Z+a.G}function Fk(a){return a.marginLeft+a.borderLeft+a.w}function Gk(a){return a.marginRight+a.fa+a.H}
...
function Jk(a,b,c){a.top=b;a.height=c;v(a.element,"top",b+"px");v(a.element,"height",c+"px")}function Kk(a,b,c){a.left=b;a.width=c;v(a.element,"left",b+"px");v(a.element,"width",c+"px")}function Lk(a){a=a.element;for(var b;b=a.lastChild;)a.removeChild(b)}function Mk(a){var b=a.bb+a.left+a.marginLeft+a.borderLeft,c=a.cb+a.top+a.marginTop+a.borderTop;return new Rf(b,c,b+(a.w+a.width+a.H),c+(a.A+a.height+a.G))}Ck.prototype.zd=function(a,b){var c=Nk(this);return tg(a,c.U,c.R,c.T-c.U,c.N-c.R,b)};
function Nk(a){var b=a.bb+a.left,c=a.cb+a.top;return new Rf(b,c,b+(Fk(a)+a.width+Gk(a)),c+(Dk(a)+a.height+Ek(a)))}function Ok(a,b,c){this.b=a;this.f=b;this.g=c}t(Ok,pc);Ok.prototype.Pc=function(a){this.b.appendChild(this.b.ownerDocument.createTextNode(a.mc));return null};Ok.prototype.sc=function(a){if(this.g.url)this.b.setAttribute("src",a.url);else{var b=this.b.ownerDocument.createElementNS("http://www.w3.org/1999/xhtml","img");b.setAttribute("src",a.url);this.b.appendChild(b)}return null};
Ok.prototype.ub=function(a){this.Sb(a.values);return null};Ok.prototype.nc=function(a){a=a.ra().evaluate(this.f);"string"===typeof a&&this.b.appendChild(this.b.ownerDocument.createTextNode(a));return null};function Pk(a){return!!a&&a!==kd&&a!==F&&a!==bd};function Qk(a,b,c){this.g=a;this.f=b;this.b=c}function Rk(){this.map=[]}function Sk(a){return a.map.length?a.map[a.map.length-1].b:0}function Tk(a,b){if(a.map.length){var c=a.map[a.map.length-1],d=c.b+b-c.f;c.f==c.g?(c.f=b,c.g=b,c.b=d):a.map.push(new Qk(b,b,d))}else a.map.push(new Qk(b,b,b))}function Uk(a,b){a.map.length?a.map[a.map.length-1].f=b:a.map.push(new Qk(b,0,0))}function Vk(a,b){var c=La(a.map.length,function(c){return b<=a.map[c].f}),c=a.map[c];return c.b-Math.max(0,c.g-b)}
function Wk(a,b){var c=La(a.map.length,function(c){return b<=a.map[c].b}),c=a.map[c];return c.g-(c.b-b)}function Xk(a,b,c,d,e,f,g,h){this.C=a;this.style=b;this.offset=c;this.F=d;this.j=e;this.b=e.b;this.Pa=f;this.Ya=g;this.G=h;this.l=this.w=null;this.A={};this.g=this.f=this.h=null;Yk(this)&&(b=b._pseudos)&&b.before&&(a=new Xk(a,b.before,c,!1,e,Zk(this),g,!0),c=$k(a,"content"),Pk(c)&&(this.h=a,this.g=a.g));this.g=al(bl(this,"before"),this.g);this.Ya&&cl[this.g]&&(e.g=al(e.g,this.g))}
...
function jl(a,b,c,d,e,f,g,h){this.ea=a;this.root=a.root;this.Ma=c;this.h=d;this.w=f;this.f=this.root;this.O={};this.V={};this.C={};this.G=[];this.A=this.J=this.H=null;this.X=new Ni(b,d,g,h);this.g=new Rk;this.Ba=!0;this.fa=[];this.xa=e;this.ta=this.ka=!1;this.b=a=tj(a,this.root);this.Z={};this.j=new fl(d);Tk(this.g,a);d=kl(this,this.root);Wi(this.X,this.root,d);ll(this,d,!1);this.F=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.F=
!1}this.fa.push(!0);this.V={};this.V["e"+a]=d;this.b++;ml(this,-1)}function nl(a,b,c,d){return(b=b[d])&&b.evaluate(a.h)!==c[d]}function ol(a,b,c){for(var d in c){var e=b[d];e?(a.O[d]=e,delete b[d]):(e=c[d])&&(a.O[d]=new V(e,33554432))}}var pl=["column-count","column-width"];
function ll(a,b,c){c||["writing-mode","direction"].forEach(function(a){b[a]&&(this.O[a]=b[a])},a);if(!a.ka){var d=nl(a,b,a.w.j,"background-color")?b["background-color"].evaluate(a.h):null,e=nl(a,b,a.w.j,"background-image")?b["background-image"].evaluate(a.h):null;if(d&&d!==bd||e&&e!==bd)ol(a,b,a.w.j),a.ka=!0}if(!a.ta)for(d=0;d<pl.length;d++)if(nl(a,b,a.w.w,pl[d])){ol(a,b,a.w.w);a.ta=!0;break}if(!c&&(c=b["font-size"])){d=c.evaluate(a.h);c=d.I;switch(d.ga){case "em":case "rem":c*=a.h.w;break;case "ex":case "rex":c*=
a.h.w*yb.ex/yb.em;break;case "%":c*=a.h.w/100;break;default:(d=yb[d.ga])&&(c*=d)}a.h.ta=c}}function ql(a){for(var b=0;!a.F&&(b+=5E3,rl(a,b,0)!=Number.POSITIVE_INFINITY););return a.O}function kl(a,b){if(b.style instanceof CSSStyleDeclaration){var c=b.getAttribute("style");if(c){var d=a.ea.url,e=new ij(a.Ma,a.w),c=new Te(c,e);try{If(new zf(of,c,e,d),Number.POSITIVE_INFINITY,!1,!0,!1,!1)}catch(f){u.b(f,"Style attribute parse error:")}return e.Ua}}return{}}
...
function sl(a,b,c,d,e){var f=0,g=Number.POSITIVE_INFINITY,h=!1,l=!1,k=!1,m=c["flow-options"];if(m){var n;a:{if(h=m.evaluate(a.h,"flow-options")){l=new pg;try{h.ba(l);n=l.b;break a}catch(r){u.b(r,"toSet:")}}n={}}h=!!n.exclusive;l=!!n["static"];k=!!n.last}(n=c["flow-linger"])&&(g=rg(n.evaluate(a.h,"flow-linger"),Number.POSITIVE_INFINITY));(c=c["flow-priority"])&&(f=rg(c.evaluate(a.h,"flow-priority"),0));c=a.Z[e]||null;n=a.C[b];n||(n=gl(a.j),n=a.C[b]=new ak(n?n.j.b:null));d=new bk(b,d,e,f,g,h,l,k,c);
a.G.push(d);a.J==b&&(a.J=null);a.H&&ul(a.H,d,n);return d}function vl(a,b,c,d){cl[b]&&(d=a.C[d].b,(!d.length||d[d.length-1]<c)&&d.push(c));a.Z[c]=al(a.Z[c],b)}
function rl(a,b,c){var d=-1;if(b<=a.b&&(d=Vk(a.g,b),d+=c,d<Sk(a.g)))return Wk(a.g,d);if(!a.f)return Number.POSITIVE_INFINITY;for(var e=a.h;;){var f=a.f.firstChild;if(!f)for(;;){if(1==a.f.nodeType){var f=a.X,g=a.f;if(f.xb.pop()!==g)throw Error("Invalid call to popElement");f.Cb.pop();f.ka.pop();f.Ab.pop();f.Bb.pop();f.pop();Ui(f);a.Ba=a.fa.pop();g=a.j.pop(a.b);f=null;g.f&&(f=bl(g.f,"before"),vl(a,f,g.f.Pa?il(a.j,g):g.f.offset,g.b),f=bl(g.f,"after"));f=al(f,bl(g,"after"));vl(a,f,a.b,g.b)}if(f=a.f.nextSibling)break;
a.f=a.f.parentNode;if(a.f===a.root)return a.f=null,b<a.b&&(0>d&&(d=Vk(a.g,b),d+=c),d<=Sk(a.g))?Wk(a.g,d):Number.POSITIVE_INFINITY}a.f=f;if(1!=a.f.nodeType){a.b+=a.f.textContent.length;var f=a.j,g=a.f,h=gl(f);(f.Pa||f.Ya)&&Yk(h)&&(h=$k(h,"white-space",kd).toString(),Zj(g,Yj(h))||(f.Pa=!1,f.Ya=!1));a.Ba?Tk(a.g,a.b):Uk(a.g,a.b)}else{g=a.f;f=kl(a,g);a.fa.push(a.Ba);Wi(a.X,g,f);(h=g.getAttribute("id")||g.getAttributeNS("http://www.w3.org/XML/1998/namespace","id"))&&h===a.A&&(a.A=null);a.F||"body"!=g.localName||
...
function Tl(a){if(null===a.order)throw Error("The page float is not yet added");return a.order}function Ul(a){if(!a.id)throw Error("The page float is not yet added");return a.id}function Vl(){this.b=[];this.f=0}Vl.prototype.je=function(){return this.f++};Vl.prototype.Yd=function(a){if(0<=this.b.findIndex(function(b){return b.S===a.S}))throw Error("A page float with the same source node is already registered");var b=a.order=this.je();a.id="pf"+b;this.b.push(a)};
Vl.prototype.de=function(a){var b=this.b.findIndex(function(b){return b.S===a});return 0<=b?this.b[b]:null};function Wl(a,b){var c=a.b.findIndex(function(a){return a.id===b});return 0<=c?a.b[c]:null}function Xl(a,b,c){this.b=Ul(a);this.f=b;this.Ub=c}Xl.prototype.zd=function(){return this.Ub.zd(null,null)};function Yl(a,b,c){this.gb=a;this.b=b;this.f=c}
function Zl(a,b,c,d,e,f,g){(this.parent=a)&&a.j.push(this);this.j=[];this.f=b;this.K=c;this.h=d;this.J=e;this.G=f||a&&a.G||ad;this.F=g||a&&a.F||jd;this.Cc=!1;this.A=a?a.A:new Vl;this.C=[];this.b=[];this.l=[];this.w={};this.g=[];a:{b=this;for(a=this.parent;a;){if(b=$l(a,b,this.f,this.h,this.J)){a=b;break a}b=a;a=a.parent}a=null}this.H=a?[].concat(a.g):[]}function am(a,b){if(!a.parent)throw Error("No PageFloatLayoutContext for "+b);return a.parent}
function $l(a,b,c,d,e){b=a.j.indexOf(b);0>b&&(b=a.j.length);for(--b;0<=b;b--){var f=a.j[b];if(f.f===c&&f.h===d&&f.J===e||(f=$l(f,null,c,d,e)))return f}return null}function bm(a,b){return b&&b!==a.f?bm(am(a,b),b):a.K}function cm(a,b){a.K=b;dm(a)}Zl.prototype.Yd=function(a){this.A.Yd(a)};function em(a,b){return b===a.f?a:em(am(a,b),b)}Zl.prototype.de=function(a){return this.A.de(a)};function fm(a,b){var c=Ul(b),d=b.b;d===a.f?0>a.C.indexOf(c)&&a.C.push(c):fm(am(a,d),b)}
function gm(a,b){var c=Ul(b),d=b.b;return d===a.f?0<=a.C.indexOf(c):gm(am(a,d),b)}function hm(a,b){return Wl(a.A,b.b)}function im(a,b,c){var d=hm(a,b).b;d!==a.f?im(am(a,d),b,c):0>a.b.indexOf(b)&&(a.b.push(b),a.b.sort(function(a,b){var c=hm(this,a),d=hm(this,b);return Tl(c)-Tl(d)}.bind(a)));c||jm(a)}function km(a,b,c){var d=hm(a,b).b;d!==a.f?km(am(a,d),b,c):(b=a.b.indexOf(b),0<=b&&(b=a.b.splice(b,1)[0],(b=b.Ub&&b.Ub.element)&&b.parentNode&&b.parentNode.removeChild(b),c||jm(a)))}
function lm(a,b){if(b.b!==a.f)return lm(am(a,b.b),b);var c=Ul(b),d=a.b.findIndex(function(a){return a.b===c});return 0<=d?a.b[d]:null}function mm(a){return 0<a.b.length?!0:a.parent?mm(a.parent):!1}function nm(a,b,c){b.b===a.f?a.w[Ul(b)]=c:nm(am(a,b.b),b,c)}function om(a,b){if(pm(a).some(function(a){return Ul(a.gb)===b}))return!0;var c=a.w[b];return c?a.K&&a.K.element?a.K.element.contains(c):!1:!1}
function qm(a,b,c,d){d=d||a.h;b.b===a.f?(c=new Yl(b,c,d),d=a.g.findIndex(function(a){return a.gb===b}),0<=d?a.g.splice(d,1,c):a.g.push(c)):qm(am(a,b.b),b,c,d)}function rm(a){return 0<a.g.length?!0:a.parent?rm(a.parent):!1}function sm(a,b){var c=Tl(b);return a.g.some(function(a){return Tl(a.gb)<c})?!0:a.parent?sm(a.parent,b):!1}function pm(a,b){b=b||a.h;var c=a.H.filter(function(a){return!b||a.f===b});a.parent&&(c=pm(a.parent,b).concat(c));return c.sort(function(a,b){return Tl(a.gb)-Tl(b.gb)})}
function tm(a,b){b=b||a.h;var c=a.g.filter(function(a){return!b||a.f===b});return a.parent?tm(a.parent,b).concat(c):c}function um(a){for(var b=a.b.length-1;0<=b;b--){var c=a.b[b];if(!om(a,c.b)){km(a,c);b=hm(a,c);fm(a,b);vm(a,b);return}}for(b=a.g.length-1;0<=b;b--)om(a,Ul(a.g[b].gb))||a.g.splice(b,1);a.H.forEach(function(a){if(!(0<=this.g.findIndex(function(b){return b?a===b?!0:a.gb===b.gb&&fk(a.b,b.b):!1}))){var b=Ul(a.gb);this.b.some(function(a){return a.b===b})||this.g.push(a)}},a)}
function jm(a){a.K&&(a.j.forEach(function(a){a.K&&a.K.element===this.K.element&&a.b.forEach(function(a){(a=a.Ub.element)&&a.parentNode&&a.parentNode.removeChild(a)})},a),Lk(a.K));a.j.splice(0);Object.keys(a.w).forEach(function(a){delete this.w[a]},a);a.Cc=!0}function wm(a){return a.Cc||!!a.parent&&wm(a.parent)}function xm(a,b){return Ll(b,a.G.toString(),a.F.toString()||null,Pl)}
...
function Nm(){}function Om(a){if(!a)return null;for(a=a.L;a;){var b=a.ec();if(b)return b;a=a.te()}return null}function Pm(a,b){this.h=a;this.w=b;this.j=!1;this.l=null}t(Pm,Nm);Pm.prototype.f=function(a,b){if(b<this.b())return null;this.j||(this.l=Qm(a,this,0<b),this.j=!0);return this.l};Pm.prototype.b=function(){return this.w};Pm.prototype.g=function(){return Om(this.h[0])};function Rm(a,b,c,d){this.position=a;this.A=b;this.w=c;this.la=d;this.h=!1;this.l=0}t(Rm,Nm);
Rm.prototype.f=function(a,b){this.h||(this.l=Km(this.position,a.b,0,a.u),this.h=!0);var c=this.l,d=this.g();d&&(c+=(a.u?-1:1)*Sm(d));this.w=this.position.b=Tm(a,c);b<this.b()?c=null:(a.la=this.la,c=this.position);return c};Rm.prototype.b=function(){if(!this.h)throw Error("EdgeBreakPosition.prototype.updateEdge not called");return(Jl[this.A]?1:0)+(this.w?3:0)+(this.position.parent?this.position.parent.l:0)};Rm.prototype.g=function(){return Om(this.position)};
function Um(a,b,c){this.pa=a;this.f=b;this.b=c}function Vm(a){for(var b=1;b<a.length;b++){var c=a[b-1],d=a[b];c===d?u.b("validateCheckPoints: duplicate entry"):c.pa>=d.pa?u.b("validateCheckPoints: incorrect boxOffset"):c.S==d.S&&(d.M?c.M&&u.b("validateCheckPoints: duplicate after points"):c.M?u.b("validateCheckPoints: inconsistent after point"):d.pa-c.pa!=d.ia-c.ia&&u.b("validateCheckPoints: boxOffset inconsistent with offsetInNode"))}}function Wm(a){this.parent=a}Wm.prototype.se=function(){return"Block formatting context (adapt.layout.BlockFormattingContext)"};
Wm.prototype.Ie=function(a,b){return b};Wm.prototype.te=function(){return this.parent};Wm.prototype.ec=function(){return null};function Xm(a,b,c,d,e){Ck.call(this,a);this.bf=a.lastChild;this.h=b;this.b=c;this.Sa=d;this.cf=a.ownerDocument;this.f=e;cm(e,this);this.Vd=null;this.we=this.ye=!1;this.F=this.lb=this.ya=this.X=this.V=0;this.J=this.Ud=this.O=this.ta=null;this.Zd=!1;this.j=this.g=this.C=null;this.Bb=!0;this.Ab=this.tc=this.Cb=0;this.l=!0;this.Ma=null}t(Xm,Ck);
function Ym(a,b){return!!b.j&&(!a.ye||!!b.parent)}function Tm(a,b){return a.u?b<a.F:b>a.F}function Zm(a){var b=Hm(a.f);return a.Ib.concat(b)}Xm.prototype.vb=function(a){var b=this,c=I("openAllViews"),d=a.na;$m(b.h,b.element,b.we);var e=d.length-1,f=null;ge(function(){for(;0<=e;){f=ik(d[e],f);e!==d.length-1||f.L||(f.L=b.Vd);if(!e){var c=f,h;h=a;h=h.La?sk(h.La,h.ia,1):h.ia;c.ia=h;f.M=a.M;f.La=a.La;if(f.M)break}c=an(b.h,f,!e&&!f.ia);e--;if(c.za())return c}return L(!1)}).then(function(){O(c,f)});return M(c)};
...
function en(a,b,c){var d=I("buildViewToNextBlockEdge");he(function(d){b.D&&!fn(b)&&c.push(kk(b));cn(a,b).then(function(e){e!==b&&(b=e,fn(b)||c.push(kk(b)));gn(a.h,b).then(function(c){if(b=c){if(!hn(a.Sa,b)&&(b=b.modify(),b.b=!0,a.l)){Q(d);return}Ym(a,b)&&!a.u?jn(a,b).then(function(a){(b=a)?P(d):Q(d)}):b.Da?P(d):Q(d)}else Q(d)})})}).then(function(){O(d,b)});return M(d)}
function kn(a,b){if(!b.D)return L(b);var c=b.S,d=I("buildDeepElementView");he(function(d){cn(a,b).then(function(e){if(e!==b){for(var f=e;f&&f.S!=c;)f=f.parent;if(!f){b=e;Q(d);return}}gn(a.h,e).then(function(e){(b=e)&&b.S!=c?hn(a.Sa,b)?P(d):(b=b.modify(),b.b=!0,a.l?Q(d):P(d)):Q(d)})})}).then(function(){O(d,b)});return M(d)}
...
function sn(a,b,c){if(a=qn(a.b,b))c.marginLeft=X(a.marginLeft),c.borderLeft=X(a.borderLeftWidth),c.w=X(a.paddingLeft),c.marginTop=X(a.marginTop),c.borderTop=X(a.borderTopWidth),c.A=X(a.paddingTop),c.marginRight=X(a.marginRight),c.fa=X(a.borderRightWidth),c.H=X(a.paddingRight),c.marginBottom=X(a.marginBottom),c.Z=X(a.borderBottomWidth),c.G=X(a.paddingBottom)}function tn(a,b,c){b=new Um(b,c,c);a.g?a.g.push(b):a.g=[b]}
function un(a,b,c,d){if(a.g&&a.g[a.g.length-1].b)return tn(a,b,c),L(!0);var e=new Rf(a.V,a.ya,a.X,a.lb),f=ng(a.J,e);f&&(d=Math.max(d,f.R*Hk(a)));d+=40*Hk(a);var g=a.O,h=!g;if(h){f=a.element.ownerDocument.createElement("div");v(f,"position","absolute");var l=a.h.clone(),k=new Zl(a.f,"column",null,a.f.h,c.na[0].node,null,null),g=new Xm(f,l,a.b,a.Sa,k);g.Bb=!1;cm(k,g);a.O=g;g.u=vn(a.h,a.u,f);g.we=!0;a.u?(g.left=0,v(g.element,"width","2em")):(g.top=a.lb,v(g.element,"height","2em"))}a.element.appendChild(g.element);
sn(a,g.element,g);f=Hk(a)*(d-a.ya);a.u?g.height=a.ta.N-a.ta.R-Dk(g)-Ek(g):g.width=a.ta.T-a.ta.U-Fk(g)-Gk(g);var m=(e=og(a.J,e))?e.N:a.lb;d=Hk(a)*(m-d)-(a.u?Fk(g)-Gk(g):Dk(g)+Ek(g));if(h&&18>d)return a.element.removeChild(g.element),a.O=null,tn(a,b,c),L(!0);if(!a.u&&g.top<f)return a.element.removeChild(g.element),tn(a,b,c),L(!0);var n=I("layoutFootnoteInner");a.u?Kk(g,0,d):Jk(g,f,d);g.bb=a.bb+a.left+Fk(a);g.cb=a.cb+a.top+Dk(a);g.Ib=a.Ib;var r=new vk(c);h?(wn(g),d=L(!0)):Zm(g).length?d=xn(g):(yn(g),
d=L(!0));d.then(function(){zn(g,r).then(function(d){if(h&&d)a.element.removeChild(g.element),tn(a,b,c),a.O=null,O(n,!0);else{g.la+=.01;a.u?(a.F=m+(g.la+Fk(g)+Gk(g)),Kk(g,0,g.la)):(a.F=m-(g.la+Dk(g)+Ek(g)),Jk(g,a.F-a.ya,g.la));var e;!a.u&&0<Zm(g).length?e=xn(g):e=L(d);e.then(function(d){d=new Um(b,c,d?d.Ba:null);a.g?a.g.push(d):a.g=[d];O(n,!0)})}})});return M(n)}
...
k.D.appendChild(m);var n=Xj(a.b,m),h=Math.max(a.u?n.top:n.left,h),l=Math.min(a.u?n.bottom:n.right,l);k.D.removeChild(m);m=a.u?g.N-g.R:g.T-g.U;"left"==e?l=Math.max(l,h+m):h=Math.min(h,l-m);k.D.appendChild(b.D)}m=new Rf(h,Hk(a)*a.ya,l,Hk(a)*a.lb);h=g;a.u&&(h=hg(g));l=Hk(a);h.R<a.Ab*l&&(n=h.N-h.R,h.R=a.Ab*l,h.N=h.R+n);a:for(var l=a.J,n=h,r=n.R,q=n.T-n.U,z=n.N-n.R,y=mg(l,r);;){var A=r+z;if(A>m.N)break a;for(var H=m.U,G=m.T,J=y;J<l.length&&l[J].R<A;J++){var K=l[J];K.U>H&&(H=K.U);K.T<G&&(G=K.T)}if(H+q<=
...
g.R-m.top-m.bottom+"px");v(d,"position","absolute");v(d,"display",b.display);l=null;if(k)if(k.J)l=k;else a:{for(k=k.parent;k;){if(k.J){l=k;break a}k=k.parent}l=null}l?(m=l.D.ownerDocument.createElement("div"),m.style.position="absolute",l.u?m.style.right="0":m.style.left="0",m.style.top="0",l.D.appendChild(m),k=Xj(a.b,m),l.D.removeChild(m)):k={left:a.u?a.lb:a.V,right:a.u?a.ya:a.X,top:a.u?a.V:a.ya};(l?l.u:a.u)?v(d,"right",k.right-g.T+a.H+"px"):v(d,"left",g.U-k.left+a.w+"px");v(d,"top",g.R-k.top+a.A+
"px");b.C&&(b.C.parentNode.removeChild(b.C),b.C=null);k=a.u?g.U:g.N;g=a.u?g.T:g.R;if(Tm(a,k)&&a.C.length)b=b.modify(),b.b=!0,O(c,b);else{mn(a);m=new Rf(a.u?a.lb:a.V,a.u?a.V:a.ya,a.u?a.ya:a.X,a.u?a.X:a.lb);a.u&&(m=hg(m));l=a.J;for(h=[new Vf(h.R,h.N,h.U,h.T)];0<h.length&&h[0].N<=m.R;)h.shift();if(h.length){h[0].R<m.R&&(h[0].R=m.R);n=l.length?l[l.length-1].N:m.R;n<m.N&&l.push(new Vf(n,m.N,m.U,m.T));r=mg(l,h[0].R);for(q=0;q<h.length;q++){z=h[q];if(r==l.length)break;l[r].R<z.R&&(n=l[r],r++,l.splice(r,
0,new Vf(z.R,n.N,n.U,n.T)),n.N=z.R);for(;r<l.length&&(n=l[r++],n.N>z.N&&(l.splice(r,0,new Vf(z.N,n.N,n.U,n.T)),n.N=z.N),z.U!=z.T&&("left"==e?n.U=Math.min(z.T,m.T):n.T=Math.max(z.U,m.U)),n.N!=z.N););}lg(m,l)}nn(a);"left"==e?a.Cb=k:a.tc=k;a.Ab=g;En(a,k);O(c,f)}});return M(c)}
function Fn(a,b){var c=a.element.ownerDocument.createElement("div");v(c,"position","absolute");var d=em(a.f,b.b),e=new Zl(d,"column",null,a.f.h,b.S,null,null),d=bm(d),c=new Gn(b,c,a.h.clone(),a.b,a.Sa,e,d);cm(e,c);var f=a.f,e=bm(f,b.b),g=Mk(e),d=c.element;e.element.parentNode.appendChild(d);Ik(c,e);c.element=d;c.ye=!0;c.width=g.T-g.U;c.height=g.N-g.R;c.marginLeft=c.marginRight=c.marginTop=c.marginBottom=0;c.borderLeft=c.fa=c.borderTop=c.Z=0;c.w=c.H=c.A=c.G=0;Kk(c,g.U-e.bb,c.width);Jk(c,g.R-e.cb,c.height);
c.Ib=(e.Ib||[]).concat();c.Bb=!mm(f);c.xa=null;wn(c);(f=Em(f,c,b,!0,!mm(f)))?(mn(c),wn(c)):e.element.parentNode.removeChild(d);return f?c:null}
...
function Dn(a,b){var c=a.f,d=b.H,e=b.S,f=b.j,g=c.de(e);return(g?L(g):Kn(a,d,b.V,b).oa(function(a){d=a;g=new Sl(e,d,f);c.Yd(g);return L(g)})).oa(function(d){var e=gk(b),f=Jn(b);return lm(c,d)?(nm(c,d,f.D),L(f)):gm(c,d)||sm(c,d)?(qm(c,d,e),nm(c,d,f.D),L(f)):Hn(a,e,d).oa(function(a){if(a)return L(null);nm(c,d,f.D);return L(f)})})}
...
function On(a,b,c,d){var e=I("processLineStyling");Vm(d);var f=d.concat([]);d.splice(0,d.length);var g=0,h=b.f;0==h.count&&(h=h.lf);he(function(d){if(h){var e=Pn(a,f),l=h.count-g;if(e.length<=l)Q(d);else{var n=Qn(a,f,e[l-1]);n?Rn(a,n,!1,!1).then(function(){g+=l;dn(a.h,n,0).then(function(e){b=e;Nn(b,!1);h=b.f;f=[];en(a,b,f).then(function(a){c=a;P(d)})})}):Q(d)}}else Q(d)}).then(function(){Array.prototype.push.apply(d,f);Vm(d);O(e,c)});return M(e)}
...
function Wn(a,b){if(!a.g)return L(!0);for(var c=!1,d=a.g.length-1;0<=d;--d){var e=a.g[d];if(e.pa<=b)break;a.g.pop();e.b!==e.f&&(c=!0)}if(!c)return L(!0);var f=I("clearFootnotes"),g=a.la+a.ya,h=a.g;a.O=null;a.g=null;var l=0;ge(function(){for(;l<h.length;){var b=h[l++],b=un(a,b.pa,b.f,g);if(b.za())return b}return L(!1)}).then(function(){O(f,!0)});return M(f)}
function Xn(a,b){var c=0;uk(b,function(a){if("clone"===a.qb["box-decoration-break"]){var b=rn(this,a.D);c+=a.u?-b.left:b.bottom;"table"===a.display&&(c+=a.sd)}}.bind(a));return c}
function Qm(a,b,c){for(var d=b.h,e=d[0];e.parent&&e.Da;)e=e.parent;var f;c?f=c=1:(c=Math.max((e.qb.widows||2)-0,1),f=Math.max((e.qb.orphans||2)-0,1));var e=Xn(a,e),g=Pn(a,d),h=a.F-e;(d=b.g())&&(h-=(a.u?-1:1)*Sm(d));d=La(g.length,function(b){return a.u?g[b]<h:g[b]>h});d=Math.min(g.length-c,d);if(d<f)return null;h=g[d-1];if(b=Qn(a,b.h,h))a.la=Hk(a)*(h-a.ya);return b}function Rn(a,b,c,d){var e=Mm(b.L).b(a,b,c,d);e||(e=Yn.b(a,b,c,d));return e}
Xm.prototype.Jb=function(){var a=null,b=null,c,d=0;do{c=d;for(var d=Number.MAX_VALUE,e=this.C.length-1;0<=e&&!b;--e){var a=this.C[e],b=a.f(this,c),f=a.b();f>c&&(d=Math.min(d,f))}}while(d>c&&!b);return{Uc:b?a:null,B:b}};
function Zn(a,b,c,d){var e=I("findAcceptableBreak"),f=a.Jb().B,g=!1;if(!f){u.b("Could not find any page breaks?!!");if(a.Bb)return $n(a,b).then(function(b){b?(b=b.modify(),b.b=!1,Rn(a,b,g,!0).then(function(){O(e,b)})):O(e,b)}),M(e);f=c;g=!0;a.la=d}Rn(a,f,g,!0).then(function(){O(e,f)});return M(e)}function ao(a){a=a.toString();return""==a||"auto"==a||!!a.match(/^0+(.0*)?[^0-9]/)}
function bo(a,b,c,d,e){var f;if(!(f=!b))a:{for(f=b.D;f;){if(f.parentNode===f.ownerDocument){f=!1;break a}f=f.parentNode}f=!0}if(f)return!1;f=Km(b,a.b,0,a.u);var g=b.M?b.parent&&b.parent.L:b.L;g&&(g=g.ec())&&(f+=(a.u?-1:1)*Sm(g));g=Tm(a,f);c&&(f+=Sn(a,c));En(a,f);if((d=a.l?d:!0)||!g)c=kk(b),b=Mm(b.L).g(c,e,g,a.la),a.C.push(b);return g}
function co(a,b){if(b.D.parentNode){var c=pn(a,b.D),d=b.D.ownerDocument.createElement("div");a.u?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.D.parentNode.insertBefore(d,b.D);var e=Xj(a.b,d),e=a.u?e.right:e.top,f=Hk(a),g;switch(b.A){case "left":g=a.Cb;break;case "right":g=a.tc;break;default:g=f*Math.max(a.tc*f,a.Cb*f)}e*f>=g*f?b.D.parentNode.removeChild(d):(e=Math.max(1,(g-e)*f),a.u?d.style.width=
...
function eo(a,b,c,d){function e(){return!!d||!c&&!!cl[m]}function f(){b=r[0]||b;b.D.parentNode.removeChild(b.D);h.j=m}var g=b.M?b.parent&&b.parent.L:b.L;if(g&&!(g instanceof Wm))return L(b);var h=a,l=I("skipEdges"),k=!d&&c&&b&&b.M,m=d,n=null,r=[],q=[],z=!1;he(function(a){for(;b;){do if(b.D){if(b.Da&&1!=b.D.nodeType){if(Zj(b.D,b.Tb))break;if(!b.M){e()?f():bo(h,n,null,!0,m)?(b=(h.l?n||b:b).modify(),b.b=!0):(b=b.modify(),b.g=m);Q(a);return}}if(!b.M&&(b.A&&co(h,b),!(b.L instanceof Wm)||Ym(h,b)||b.G)){r.push(kk(b));
m=al(m,b.g);if(e())f();else if(bo(h,n,null,!0,m)||!hn(h.Sa,b))b=(h.l?n||b:b).modify(),b.b=!0;Q(a);return}if(1==b.D.nodeType){var d=b.D.style;if(b.M){if(z){if(e()){f();Q(a);return}r=[];k=c=!1;m=null}z=!1;n=kk(b);q.push(n);m=al(m,b.F);if(d&&(!ao(d.paddingBottom)||!ao(d.borderBottomWidth))){if(bo(h,n,null,!0,m)&&(b=(h.l?n||b:b).modify(),b.b=!0,h.l)){Q(a);return}q=[n];n=null}}else{r.push(kk(b));m=al(m,b.g);if(!hn(h.Sa,b)&&(bo(h,n,null,!1,m),b=b.modify(),b.b=!0,h.l)){Q(a);return}if(Jm[b.D.localName]){e()?
f():bo(h,n,null,!0,m)&&(b=(h.l?n||b:b).modify(),b.b=!0);Q(a);return}!d||ao(d.paddingTop)&&ao(d.borderTopWidth)||(k=!1,q=[]);z=!0}}}while(0);d=gn(h.h,b,k);if(d.za()){d.then(function(c){b=c;P(a)});return}b=d.get()}bo(h,n,q,!1,m)?n&&h.l&&(b=n.modify(),b.b=!0):cl[m]&&(h.j=m);Q(a)}).then(function(){n&&(h.Ma=rk(n));O(l,b)});return M(l)}
function $n(a,b){var c=kk(b),d=I("skipEdges"),e=null,f=!1;he(function(d){for(;b;){do if(b.D){if(b.Da&&1!=b.D.nodeType){if(Zj(b.D,b.Tb))break;if(!b.M){cl[e]&&(a.j=e);Q(d);return}}if(!b.M&&(Ym(a,b)||b.G)){e=al(e,b.g);cl[e]&&(a.j=e);Q(d);return}if(1==b.D.nodeType){var g=b.D.style;if(b.M){if(f){if(cl[e]){a.j=e;Q(d);return}e=null}f=!1;e=al(e,b.F)}else{e=al(e,b.g);if(Jm[b.D.localName]){cl[e]&&(a.j=e);Q(d);return}if(g&&(!ao(g.paddingTop)||!ao(g.borderTopWidth))){Q(d);return}}f=!0}}while(0);g=gn(a.h,b);if(g.za()){g.then(function(a){b=
...
function yn(a){var b=a.element.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.A+"px";b.style.right=a.H+"px";b.style.bottom=a.G+"px";b.style.left=a.w+"px";a.element.appendChild(b);var c=Xj(a.b,b);a.element.removeChild(b);var b=a.bb+a.left+Fk(a),d=a.cb+a.top+Dk(a);a.ta=new Rf(b,d,b+a.width,d+a.height);a.V=c?a.u?c.top:c.left:0;a.X=c?a.u?c.bottom:c.right:0;a.ya=c?a.u?c.right:c.top:0;a.lb=c?a.u?c.left:c.bottom:0;a.Cb=a.ya;a.tc=a.ya;a.Ab=a.ya;a.F=a.lb;var c=a.ta,e,b=a.bb+a.left+
Fk(a),d=a.cb+a.top+Dk(a);e=new Rf(b,d,b+a.width,d+a.height);if(a.xa){b=a.xa;d=e.U;e=e.R;for(var f=[],g=0;g<b.b.length;g++){var h=b.b[g];f.push(new Sf(h.f+d,h.b+e))}b=new Xf(f)}else b=$f(e.U,e.R,e.T,e.N);a.J=kg(c,[b],Zm(a),a.Xa,a.u);nn(a);a.g=null}function wn(a){a.Ud=[];v(a.element,"width",a.width+"px");v(a.element,"height",a.height+"px");yn(a);a.la=0;a.Zd=!1;a.j=null;a.Ma=null}function En(a,b){a.la=Math.max(Hk(a)*(b-a.ya),a.la)}
...
function zn(a,b,c,d){a.Ud.push(b);b.Ba.M&&(a.Ma=b.Ba);if(a.l&&a.Zd)return L(b);var e=I("layout");ho(a,b).then(function(){a.vb(b.Ba).then(function(b){var f=b,h=a.la;a.C=[];he(function(e){for(;b;){var g=!0;fo(a,b,c,d||null).then(function(d){c=!1;b=d;wm(a.f)?Q(e):a.j?Q(e):b&&a.l&&b&&b.b?Zn(a,b,f,h).then(function(a){b=a;Q(e)}):g?g=!1:P(e)});if(g){g=!1;return}}Q(e)}).then(function(){if(wm(a.f))O(e,null);else{var c=a.O;c&&(a.element.appendChild(c.element),a.u?a.la=this.ya-this.lb:a.la=c.top+Dk(c)+c.la+
Ek(c));if(b){a.Zd=!0;c=new vk(rk(b));if(a.g){for(var d=[],f=0;f<a.g.length;f++){var g=a.g[f].b;g&&d.push(g)}c.b=d.length?d:null}O(e,c)}else O(e,null)}})})});return M(e)}
function xn(a){for(var b=a.Ud,c=a.element.lastChild;c!=a.bf;){var d=c.previousSibling;a.element===c.parentNode&&c.getAttribute("data-adapt-pseudo")||a.element.removeChild(c);c=d}mn(a);wn(a);var e=I("redoLayout"),f=0,g=null,h=!0;he(function(c){if(f<b.length){var d=b[f++];zn(a,d,h).then(function(a){h=!1;a?(g=a,Q(c)):P(c)})}else Q(c)}).then(function(){O(e,g)});return M(e)}function io(){}
...
function to(a,b){var c=a.f[b],d=a.h[b];d||(d=a.h[b]=[]);for(var e=!1,f=0;f<a.g.length;){var g=a.g[f];g.cc===b?(g.Ic=!0,a.g.splice(f,1),c&&(e=c.indexOf(g),0<=e&&c.splice(e,1)),d.push(g),e=!0):f++}e||uo(a,b,!0)}function uo(a,b,c){a.w.some(function(a){return a.cc===b})||a.w.push(new po(b,c))}
function zo(a,b,c){var d=Object.keys(a.j.b);if(0<d.length){var e=oo(a.b);d.forEach(function(a){this.A[a]=e;var d=this.C[a];if(d&&d.aa<c&&(d=this.h[a])){var f=this.f[a];f||(f=this.f[a]=[]);for(var g;g=d.shift();)g.Ic=!1,f.push(g)}this.C[a]={P:b,aa:c}},a)}for(var d=a.G,f;f=a.w.shift();){f.Kd=d;f.P=b;f.aa=c;var g;f.Ic?(g=a.h[f.cc])||(g=a.h[f.cc]=[]):(g=a.f[f.cc])||(g=a.f[f.cc]=[]);g.every(function(a){return!(f===a||a&&f.cc===a.cc&&f.Ic===a.Ic&&f.P===a.P&&f.aa===a.aa)})&&g.push(f)}a.j=null}
function Ao(a,b){var c=[];Object.keys(b.b).forEach(function(a){(a=this.f[a])&&(c=c.concat(a))},a);c.sort(function(a,b){return a.P-b.P||a.aa-b.aa});var d=[],e=null;c.forEach(function(a){e&&e.P===a.P&&e.aa===a.aa?e.cd.push(a):(e={P:a.P,aa:a.aa,Kd:a.Kd,cd:[a]},d.push(e))});return d}function Bo(a,b){a.H.push(a.g);a.g=b}
function hn(a,b){if(!b||b.M)return!0;var c=b.D;if(!c||1!==c.nodeType)return!0;c=c.getAttribute("id")||c.getAttribute("name");return c&&(a.b.h[c]||a.b.f[c])?(c=a.b.C[c])?a.aa>=c.aa:!0:!0};var Co=1;function Do(a,b,c,d,e){this.b={};this.j=[];this.g=null;this.index=0;this.f=a;this.name=b;this.Pb=c;this.Ca=d;this.parent=e;this.l="p"+Co++;e&&(this.index=e.j.length,e.j.push(this))}Do.prototype.h=function(){throw Error("E_UNEXPECTED_CALL");};Do.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Eo(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}function Fo(a,b){for(var c=0;c<a.j.length;c++)a.j[c].clone({parent:b})}
function Go(a){Do.call(this,a,null,null,[],null);this.b.width=new V(Dd,0);this.b.height=new V(Ed,0)}t(Go,Do);
function Ho(a,b){this.g=b;var c=this;sb.call(this,a,function(a,b){var d=a.match(/^([^.]+)\.([^.]+)$/);if(d){var e=c.g.w[d[1]];if(e&&(e=this.Ma[e])){if(b){var d=d[2],h=e.fa[d];if(h)e=h;else{switch(d){case "columns":var h=e.b.f,l=new kc(h,0),k=Io(e,"column-count"),m=Io(e,"column-width"),n=Io(e,"column-gap"),h=x(h,mc(h,new hc(h,"min",[l,k]),w(h,m,n)),n)}h&&(e.fa[d]=h);e=h}}else e=Io(e,d[2]);return e}}return null})}t(Ho,sb);
function Jo(a,b,c,d,e,f,g){a=a instanceof Ho?a:new Ho(a,this);Do.call(this,a,b,c,d,e);this.g=this;this.W=f;this.$=g;this.b.width=new V(Dd,0);this.b.height=new V(Ed,0);this.b["wrap-flow"]=new V(Lc,0);this.b.position=new V(od,0);this.b.overflow=new V(Ad,0);this.w={}}t(Jo,Do);Jo.prototype.h=function(a){return new Ko(a,this)};Jo.prototype.clone=function(a){a=new Jo(this.f,this.name,a.Pb||this.Pb,this.Ca,this.parent,this.W,this.$);Eo(this,a);Fo(this,a);return a};
function Lo(a,b,c,d,e){Do.call(this,a,b,c,d,e);this.g=e.g;b&&(this.g.w[b]=this.l);this.b["wrap-flow"]=new V(Lc,0)}t(Lo,Do);Lo.prototype.h=function(a){return new Mo(a,this)};Lo.prototype.clone=function(a){a=new Lo(a.parent.f,this.name,this.Pb,this.Ca,a.parent);Eo(this,a);Fo(this,a);return a};function No(a,b,c,d,e){Do.call(this,a,b,c,d,e);this.g=e.g;b&&(this.g.w[b]=this.l)}t(No,Do);No.prototype.h=function(a){return new Oo(a,this)};
No.prototype.clone=function(a){a=new No(a.parent.f,this.name,this.Pb,this.Ca,a.parent);Eo(this,a);Fo(this,a);return a};function Y(a,b,c){return b&&b!==Lc?b.ra(a,c):null}function Po(a,b,c){return b&&b!==Lc?b.ra(a,c):a.b}function Qo(a,b,c){return b?b===Lc?null:b.ra(a,c):a.b}function Ro(a,b,c,d){return b&&c!==F?b.ra(a,d):a.b}function So(a,b,c){return b?b===Bd?a.j:b===Xc?a.h:b.ra(a,a.b):c}
function To(a,b){this.f=a;this.b=b;this.J={};this.style={};this.A=this.C=null;this.w=[];this.O=this.V=this.g=this.h=!1;this.G=this.H=0;this.F=null;this.ka={};this.fa={};this.xa=this.u=!1;a&&a.w.push(this)}function Uo(a){a.H=0;a.G=0}function Vo(a,b,c){b=Io(a,b);c=Io(a,c);if(!b||!c)throw Error("E_INTERNAL");return w(a.b.f,b,c)}
function Io(a,b){var c=a.ka[b];if(c)return c;var d=a.style[b];d&&(c=d.ra(a.b.f,a.b.f.b));switch(b){case "margin-left-edge":c=Io(a,"left");break;case "margin-top-edge":c=Io(a,"top");break;case "margin-right-edge":c=Vo(a,"border-right-edge","margin-right");break;case "margin-bottom-edge":c=Vo(a,"border-bottom-edge","margin-bottom");break;case "border-left-edge":c=Vo(a,"margin-left-edge","margin-left");break;case "border-top-edge":c=Vo(a,"margin-top-edge","margin-top");break;case "border-right-edge":c=
...
Vo(a,"padding-top-edge","padding-top");break;case "right-edge":c=Vo(a,"left-edge","width");break;case "bottom-edge":c=Vo(a,"top-edge","height")}if(!c){if("extent"==b)d=a.u?"width":"height";else if("measure"==b)d=a.u?"height":"width";else{var e=a.u?th:uh,d=b,f;for(f in e)d=d.replace(f,e[f])}d!=b&&(c=Io(a,d))}c&&(a.ka[b]=c);return c}
...
function Zo(a,b){b.Ma[a.b.l]=a;var c=a.b.f,d=a.style,e=a.f?$o(a.f,b):null,e=kj(a.J,b,e,!1);a.u=jj(e,b,a.f?a.f.u:!1);lj(e,d,a.u,function(a,b){return b.value});a.C=new vb(c,function(){return a.H},"autoWidth");a.A=new vb(c,function(){return a.G},"autoHeight");a.Dd();a.Ed();Xo(a);Wo(a)}function ap(a,b,c){(a=a.style[c])&&(a=Qf(b,a,c));return a}function Z(a,b,c){(a=a.style[c])&&(a=Qf(b,a,c));return Hc(a,b)}
function $o(a,b){var c;a:{if(c=a.J["region-id"]){for(var d=[],e=0;e<c.length;e++){var f=c[e].evaluate(b,"");f&&f!==B&&d.push(f)}if(d.length){c=d;break a}}c=null}if(c){d=[];for(e=0;e<c.length;e++)d[e]=c[e].toString();return d}return null}function bp(a,b,c,d,e){if(a=ap(a,b,d))a.Yb()&&zb(a.ga)&&(a=new D(Hc(a,b),"px")),"font-family"===d&&(a=Dl(e,a)),v(c,d,a.toString())}
...
function dp(a,b,c){var d=Z(a,b,"right"),e=Z(a,b,"snap-height"),f=Z(a,b,"margin-right"),g=Z(a,b,"padding-right");b=Z(a,b,"border-right-width");v(c.element,"margin-right",f+"px");v(c.element,"padding-right",g+"px");v(c.element,"border-right-width",b+"px");c.marginRight=f;c.fa=b;a.u&&0<e&&(a=d+Gk(c),a-=Math.floor(a/e)*e,0<a&&(c.wb=e-a,g+=c.wb));c.H=g;c.xb=e}
function ep(a,b,c){var d=Z(a,b,"snap-height"),e=Z(a,b,"top"),f=Z(a,b,"margin-top"),g=Z(a,b,"padding-top");b=Z(a,b,"border-top-width");c.top=e;c.marginTop=f;c.borderTop=b;c.Xa=d;!a.u&&0<d&&(a=e+Dk(c),a-=Math.floor(a/d)*d,0<a&&(c.ka=d-a,g+=c.ka));c.A=g;v(c.element,"top",e+"px");v(c.element,"margin-top",f+"px");v(c.element,"padding-top",g+"px");v(c.element,"border-top-width",b+"px")}
function fp(a,b,c){var d=Z(a,b,"margin-bottom"),e=Z(a,b,"padding-bottom"),f=Z(a,b,"border-bottom-width");a=Z(a,b,"height")-c.ka;v(c.element,"height",a+"px");v(c.element,"margin-bottom",d+"px");v(c.element,"padding-bottom",e+"px");v(c.element,"border-bottom-width",f+"px");c.height=a-c.ka;c.marginBottom=d;c.Z=f;c.G=e}function gp(a,b,c){a.u?(ep(a,b,c),fp(a,b,c)):(dp(a,b,c),cp(a,b,c))}
function hp(a,b,c){v(c.element,"border-top-width","0px");var d=Z(a,b,"max-height");a.V?Jk(c,0,d):(ep(a,b,c),d-=c.ka,c.height=d,v(c.element,"height",d+"px"))}function ip(a,b,c){v(c.element,"border-left-width","0px");var d=Z(a,b,"max-width");a.O?Kk(c,0,d):(dp(a,b,c),d-=c.wb,c.width=d,a=Z(a,b,"right"),v(c.element,"right",a+"px"),v(c.element,"width",d+"px"))}
...
To.prototype.Xc=function(a,b,c,d,e,f,g){this.u?this.H=b.la+b.wb:this.G=b.la+b.ka;var h=(this.u||!d)&&this.g,l=(!this.u||!d)&&this.h;if(l||h)l&&v(b.element,"width","auto"),h&&v(b.element,"height","auto"),d=Xj(f,d?d.element:b.element),l&&(this.H=Math.ceil(d.right-d.left-b.w-b.borderLeft-b.H-b.fa),this.u&&(this.H+=b.wb)),h&&(this.G=d.bottom-d.top-b.A-b.borderTop-b.G-b.Z,this.u||(this.G+=b.ka));(this.u?this.g:this.h)&&gp(this,a,b);if(this.u?this.h:this.g){if(this.u?this.O:this.V)this.u?dp(this,a,b):ep(this,
...
function Kp(a,b,c,d,e,f){var g=I("createRefShadow");a.ea.w.load(b).then(function(h){if(h){var l=yj(h,b);if(l){var k=a.H,m=k.H[h.url];if(!m){var m=k.style.l.f[h.url],n=new Ab(0,k.Nb(),k.Mb(),k.w),m=new jl(h,m.g,m.f,n,k.l,m.w,new no(k.j,h.url),new mo(k.j,h.url,m.f,m.b));k.H[h.url]=m}f=new lk(d,l,h,e,f,c,m)}}O(g,f)});return M(g)}
function Lp(a,b,c,d,e,f,g,h){var l=I("createShadows"),k=e.template,m;k instanceof Fc?m=Kp(a,k.url,2,b,h,null):m=L(null);m.then(function(k){var m=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var n=b.getAttribute("href"),z=null;n?z=h?h.ea:a.ea:h&&(n="http://www.w3.org/1999/xhtml"==h.ja.namespaceURI?h.ja.getAttribute("href"):h.ja.getAttributeNS("http://www.w3.org/1999/xlink","href"),z=h.Md?h.Md.ea:a.ea);n&&(n=oa(n,z.url),m=Kp(a,n,3,b,h,k))}m||(m=L(k));var y=null;
...
function Np(a,b){for(var c=a.B.S,d=[],e=null,f=a.B.qa,g=-1;c&&1==c.nodeType;){var h=f&&f.root==c;if(!h||2==f.type){var l=(f?f.b:a.j).l(c,!1);d.push(l);e=e||Ba(c)}h?(c=f.ja,f=f.Md):(c=c.parentNode,g++)}c=Cb(a.b,"em",!g);c={"font-size":new V(new D(c,"px"),0)};f=new Eh(c,a.b);for(g=d.length-1;0<=g;--g){var h=d[g],l=[],k;for(k in h)ih[k]&&l.push(k);l.sort(Hd);for(var m=0;m<l.length;m++){var n=l[m];f.f=n;var r=h[n];r.value!==bd&&(c[n]=r.Wc(f))}}for(var q in b)ih[q]||(c[q]=b[q]);return{lang:e,Ua:c}}
...
function Rp(a,b){var c=kh().filter(function(a){return b[a]});if(c.length){var d=a.B.qb;if(a.B.parent){var d=a.B.qb={},e;for(e in a.B.parent.qb)d[e]=a.B.parent.qb[e]}c.forEach(function(a){var c=b[a];if(c){if(c instanceof Dc)d[a]=c.I;else if(c instanceof Bc)d[a]=c.name;else if(c instanceof D)switch(c.ga){case "dpi":case "dpcm":case "dppx":d[a]=c.I*yb[c.ga]}else d[a]=c;delete b[a]}})}}
function Sp(a,b,c,d,e,f){for(var g=Jd.RESOLVE_FORMATTING_CONTEXT||[],h=0;h<g.length;h++){var l=g[h](a,b,c,d,e,f);if(l){a.L=l;break}}}
function Tp(a,b,c){var d=!0,e=I("createElementView"),f=a.S,g=a.B.qa?a.B.qa.b:a.j,h=g.l(f,!1),l={};if(!a.B.parent){var k=Np(a,h),h=k.Ua;a.B.lang=k.lang}var m=h["float-reference"]&&Ql(h["float-reference"].value.toString());a.B.parent&&m&&Rl(m)&&(k=Np(a,h),h=k.Ua,a.B.lang=k.lang);a.B.u=Mp(a,a.B.u,h,l);Rp(a,l);Qp(a);l.direction&&(a.B.ka=l.direction.toString());if((k=l["flow-into"])&&k.toString()!=a.C)return O(e,!1),M(e);var n=l.display;if(n===F)return O(e,!1),M(e);var r=!a.B.parent;a.B.G=n===Zc;Lp(a,
f,r,h,l,g,a.b,a.B.qa).then(function(g){a.B.Aa=g;g=l.position;var k=l["float"],q=l.clear,A=a.B.u?zd:ad,H=a.B.parent?a.B.parent.u?zd:ad:A,G="true"===f.getAttribute("data-vivliostyle-flow-root");a.B.zc=yp(n,g,k,l.overflow,A,H,G);a.B.J=g===od||g===Ic||g===Yc;tk(a.B)&&(q=null,k===$c||m&&Rl(m)||(k=null));A=k===hd||k===pd||k===wd||k===Qc||k===fd||k===ed||k===Oc||k===Nc||k===$c;k&&(delete l["float"],k===$c&&(a.h?(A=!1,l.display=Mc):l.display=cd));q&&(q===bd&&a.B.parent&&a.B.parent.A&&(q=C(a.B.parent.A)),
...
default:q=!1}a.B.Da=q;a.B.display=n?n.toString():"inline";a.B.j=A?k.toString():null;a.B.H=m||nk;a.B.V=l["column-span"];if(!a.B.Da){if(q=l["break-after"])a.B.F=q.toString();if(q=l["break-before"])a.B.g=q.toString()}a.B.O=l["vertical-align"]&&l["vertical-align"].toString()||"baseline";a.B.X=l["caption-side"]&&l["caption-side"].toString()||"top";q=l["border-collapse"];if(!q||q===C("separate"))if(A=l["border-spacing"])A.Zc()?(q=A.values[0],A=A.values[1]):q=A,q.Yb()&&(a.B.Z=Hc(q,a.b)),A.Yb()&&(a.B.sd=
Hc(A,a.b));if(q=l["x-first-pseudo"])a.B.f=new mk(a.B.parent?a.B.parent.f:null,q.I);if(q=l["white-space"])q=Yj(q.toString()),null!==q&&(a.B.Tb=q);(q=l["hyphenate-character"])&&q!==Lc&&(a.B.h=q.mc);q=l["overflow-wrap"]||["word-wrap"];a.B.w=l["word-break"]===Sc||q===Tc;Sp(a.B,b,n,g,k,r);a.B.parent&&a.B.parent.L&&(b=a.B.parent.L.Ie(a.B,b));var K=!1,Pa=null,Ca=[],ua=f.namespaceURI,N=f.localName;if("http://www.w3.org/1999/xhtml"==ua)"html"==N||"body"==N||"script"==N||"link"==N||"meta"==N?N="div":"vide_"==
N?N="video":"audi_"==N?N="audio":"object"==N&&(K=!!a.f),f.getAttribute("data-adapt-pseudo")&&h.content&&h.content.value&&h.content.value.url&&(N="img");else if("http://www.idpf.org/2007/ops"==ua)N="span",ua="http://www.w3.org/1999/xhtml";else if("http://www.gribuser.ru/xml/fictionbook/2.0"==ua){ua="http://www.w3.org/1999/xhtml";if("image"==N){if(N="div",(g=f.getAttributeNS("http://www.w3.org/1999/xlink","href"))&&"#"==g.charAt(0)&&(g=yj(a.ea,g)))Pa=Up(a,ua,"img"),g="data:"+(g.getAttribute("content-type")||
"image/jpeg")+";base64,"+g.textContent.replace(/[ \t\n\t]/g,""),Ca.push(me(Pa,g))}else N=Op[N];N||(N=a.B.Da?"span":"div")}else if("http://www.daisy.org/z3986/2005/ncx/"==ua)if(ua="http://www.w3.org/1999/xhtml","ncx"==N||"navPoint"==N)N="div";else if("navLabel"==N){if(N="span",k=f.parentNode){g=null;for(k=k.firstChild;k;k=k.nextSibling)if(1==k.nodeType&&(q=k,"http://www.daisy.org/z3986/2005/ncx/"==q.namespaceURI&&"content"==q.localName)){g=q.getAttribute("src");break}g&&(N="a",f=f.ownerDocument.createElementNS(ua,
...
"true"==g.getAttribute("data-adapt-process-children")):g=Up(a,ua,N);"a"==N&&g.addEventListener("click",a.page.J,!1);Pa&&(Bn(a,a.B,"inner",Pa),g.appendChild(Pa));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&Fp(g);var h=a.B.qb["image-resolution"],k=[],m=l.width,n=l.height,r=f.getAttribute("width"),q=f.getAttribute("height"),m=m===Lc||!m&&!r,n=n===Lc||!n&&!q;if("http://www.gribuser.ru/xml/fictionbook/2.0"!=f.namespaceURI||"td"==N){for(var r=f.attributes,z=r.length,q=null,y=
0;y<z;y++){var A=r[y],H=A.namespaceURI,G=A.localName,A=A.nodeValue;if(H)if("http://www.w3.org/2000/xmlns/"==H)continue;else"http://www.w3.org/1999/xlink"==H&&"href"==G&&(A=Pp(a,A));else{if(G.match(/^on/))continue;if("style"==G)continue;if(("id"==G||"name"==G)&&b){A=a.g.Rd(A,a.ea.url);g.setAttribute(G,A);Vj(a.page,g,A);continue}"src"==G||"href"==G||"poster"==G?(A=Pp(a,A),"href"===G&&(A=a.g.Oc(A,a.ea.url))):"srcset"==G&&(A=A.split(",").map(function(b){return Pp(a,b.trim())}).join(","));if("poster"===
G&&"video"===N&&"http://www.w3.org/1999/xhtml"===ua&&m&&n){var Xa=new Image,yc=me(Xa,A);Ca.push(yc);k.push({Ee:Xa,element:g,Be:yc})}}"http://www.w3.org/2000/svg"==ua&&/^[A-Z\-]+$/.test(G)&&(G=G.toLowerCase());-1!=Vp.indexOf(G.toLowerCase())&&(A=zp(A,a.ea.url,a.g));H&&(Xa=Ep[H])&&(G=Xa+":"+G);"src"!=G||H||"img"!=N&&"input"!=N||"http://www.w3.org/1999/xhtml"!=ua?"href"==G&&"image"==N&&"http://www.w3.org/2000/svg"==ua&&"http://www.w3.org/1999/xlink"==H?a.page.j.push(me(g,A)):H?g.setAttributeNS(H,G,A):
g.setAttribute(G,A):q=A}q&&(Xa="input"===N?new Image:g,r=me(Xa,q),Xa!==g&&(g.src=q),m||n?(m&&n&&h&&1!==h&&k.push({Ee:Xa,element:g,Be:r}),Ca.push(r)):a.page.j.push(r))}delete l.content;(m=l["list-style-image"])&&m instanceof Fc&&(m=m.url,Ca.push(me(new Image,m)));Wp(a,l);Xp(a,g,l);if(!a.B.Da&&(m=null,b?c&&(m=a.B.u?Dp:Cp):m="clone"!==a.B.qb["box-decoration-break"]?a.B.u?Bp:Ap:a.B.u?Dp:Cp,m))for(var Mn in m)v(g,Mn,m[Mn]);J&&g.setAttribute("value",l["ua-list-item-count"].stringValue());a.D=g;Ca.length?
...
"px"):v(b,"min-width",h+"px"))}})}function Wp(a,b){(Jd.PREPROCESS_ELEMENT_STYLE||[]).forEach(function(c){c(a.B,b)})}function Zp(a){var b=I("createTextNodeView");$p(a).then(function(){var c=a.ia||0,c=aq(a.B.La).substr(c);a.D=document.createTextNode(c);O(b,!0)});return M(b)}
function $p(a){if(a.B.La)return L(!0);var b,c=b=a.S.textContent,d=I("preprocessTextContent"),e=Jd.PREPROCESS_TEXT_CONTENT||[],f=0;ge(function(){return f>=e.length?L(!1):e[f++](a.B,c).oa(function(a){c=a;return L(!0)})}).then(function(){a.B.La=bq(b,c,0);O(d,!0)});return M(d)}
...
function dq(a){if(null==a.qa||"content"!=a.S.localName||"http://www.pyroxy.com/ns/shadow"!=a.S.namespaceURI)return a;var b=a.pa,c=a.qa,d=a.parent,e,f;c.pe?(f=c.pe,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.Md,e=c.ja.firstChild,c=2);var g=a.S.nextSibling;g?(a.S=g,ok(a)):a.va?a=a.va:e?a=null:(a=a.parent.modify(),a.M=!0);if(e)return b=new jk(e,d,b),b.qa=f,b.Wa=c,b.va=a,b;a.pa=b;return a}
function eq(a){var b=a.pa+1;if(a.M){if(!a.parent)return null;if(3!=a.Wa){var c=a.S.nextSibling;if(c)return a=a.modify(),a.pa=b,a.S=c,ok(a),dq(a)}if(a.va)return a=a.va.modify(),a.pa=b,a;a=a.parent.modify()}else{if(a.Aa&&(c=a.Aa.root,2==a.Aa.type&&(c=c.firstChild),c))return b=new jk(c,a,b),b.qa=a.Aa,b.Wa=a.Aa.type,dq(b);if(c=a.S.firstChild)return dq(new jk(c,a,b));1!=a.S.nodeType&&(c=aq(a.La),b+=c.length-1-a.ia);a=a.modify()}a.pa=b;a.M=!0;return a}
...
function qq(a){var b={width:Dd,height:Ed,Vb:Fd,Eb:Fd},c=a.size;if(c&&c.value!==Lc){var d=c.value;d.Zc()?(c=d.values[0],d=d.values[1]):(c=d,d=null);if(c.Yb())b.width=c,b.height=d||c;else if(c=lq[c.name.toLowerCase()])d&&d===gd?(b.width=c.height,b.height=c.width):(b.width=c.width,b.height=c.height)}(c=a.marks)&&c.value!==F&&(b.Eb=pq);a=a.bleed;a&&a.value!==Lc?a.value&&a.value.Yb()&&(b.Vb=a.value):c&&(a=!1,c.value.Zc()?a=c.value.values.some(function(a){return a===Uc}):a=c.value===Uc,a&&(b.Vb=new D(6,
"pt")));return b}function rq(a,b){var c={},d=a.Vb.I*Cb(b,a.Vb.ga,!1),e=a.Eb.I*Cb(b,a.Eb.ga,!1),f=d+e,g=a.width;c.Nb=g===Dd?b.Y.Wb?b.Y.Wb.width*Cb(b,"px",!1):(b.Y.pb?Math.floor(b.Xa/2)-b.Y.jc:b.Xa)-2*f:g.I*Cb(b,g.ga,!1);g=a.height;c.Mb=g===Ed?b.Y.Wb?b.Y.Wb.height*Cb(b,"px",!1):b.Cb-2*f:g.I*Cb(b,g.ga,!1);c.Vb=d;c.Eb=e;c.xd=f;return c}function sq(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
function tq(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg",c||"polyline");a.setAttribute("stroke","black");a.setAttribute("stroke-width",b);a.setAttribute("fill","none");return a}var uq={Mf:"top left",Nf:"top right",zf:"bottom left",Af:"bottom right"};
...
k.appendChild(l);a=tq(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));k.appendChild(a);b.split(" ").forEach(function(a){k.style[a]=f+"px"});return k}var wq={Lf:"top",yf:"bottom",Ve:"left",We:"right"};
...
Gq.prototype.j=function(a,b){var c=this.J,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}Ko.prototype.j.call(this,a,b)};Gq.prototype.Dd=function(){var a=this.style;a.left=Fd;a["margin-left"]=Fd;a["border-left-width"]=Fd;a["padding-left"]=Fd;a["padding-right"]=Fd;a["border-right-width"]=Fd;a["margin-right"]=Fd;a.right=Fd};
Gq.prototype.Ed=function(){var a=this.style;a.top=Fd;a["margin-top"]=Fd;a["border-top-width"]=Fd;a["padding-top"]=Fd;a["padding-bottom"]=Fd;a["border-bottom-width"]=Fd;a["margin-bottom"]=Fd;a.bottom=Fd};Gq.prototype.Z=function(a,b,c){b=b.H;var d={start:this.l.marginLeft,end:this.l.marginRight,ma:this.l.gc},e={start:this.l.marginTop,end:this.l.marginBottom,ma:this.l.fc};Jq(this,b.top,!0,d,a,c);Jq(this,b.bottom,!0,d,a,c);Jq(this,b.left,!1,e,a,c);Jq(this,b.right,!1,e,a,c)};
...
function Jq(a,b,c,d,e,f){var g=a.b.f,h={},l={},k={},m;for(m in b){var n=Aq[m];if(n){var r=b[m],q=a.ta[m],z=new Kq(r,q.style,c,g,f);h[n.sa]=r;l[n.sa]=q;k[n.sa]=z}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.ma.evaluate(e);var y=Oq(k,b),A=!1,H={};Object.keys(h).forEach(function(a){var b=Y(g,l[a].style[c?"max-width":"max-height"],d.ma);b&&(b=b.evaluate(e),y[a]>b&&(b=k[a]=new Nq(h[a],l[a].style,c,g,f,b),H[a]=b.f(),A=!0))});A&&(y=Oq(k,b),A=!1,["start","center","end"].forEach(function(a){y[a]=H[a]||y[a]}));
var G={};Object.keys(h).forEach(function(a){var b=Y(g,l[a].style[c?"min-width":"min-height"],d.ma);b&&(b=b.evaluate(e),y[a]<b&&(b=k[a]=new Nq(h[a],l[a].style,c,g,f,b),G[a]=b.f(),A=!0))});A&&(y=Oq(k,b),["start","center","end"].forEach(function(a){y[a]=G[a]||y[a]}));var J=a+b,K=a+(a+b);["start","center","end"].forEach(function(a){var b=y[a];if(b){var d=h[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(K-b)/2;break;case "end":e=J-b}c?Kk(d,e,b-Fk(d)-Gk(d)):Jk(d,e,b-Dk(d)-Ek(d))}})}
function Oq(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=Pq(d,g.length?new Mq(g):null,b);g.jb&&(f.center=g.jb);d=g.jb||d.f();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=Pq(c,e,b),c.jb&&(f.start=c.jb),c.Qc&&(f.end=c.Qc);return f}
function Pq(a,b,c){var d={jb:null,Qc:null};if(a&&b)if(a.b()&&b.b()){var e=a.g(),f=b.g();0<e&&0<f?(f=e+f,f<c?d.jb=c*e/f:(a=a.h(),b=b.h(),b=a+b,b<c?d.jb=a+(c-b)*(e-a)/(f-b):0<b&&(d.jb=c*a/b)),0<d.jb&&(d.Qc=c-d.jb)):0<e?d.jb=c:0<f&&(d.Qc=c)}else a.b()?d.jb=Math.max(c-b.f(),0):b.b()&&(d.Qc=Math.max(c-a.f(),0));else a?a.b()&&(d.jb=c):b&&b.b()&&(d.Qc=c);return d}Gq.prototype.Ob=function(a,b,c,d,e){Gq.Ue.Ob.call(this,a,b,c,d,e);b.element.setAttribute("data-vivliostyle-page-box",!0)};
function Hq(a,b){Oo.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.fc=this.gc=null}t(Hq,Oo);
...
d["padding-bottom"]=new E(c.marginBottom)};Hq.prototype.Dd=function(){var a=Qq(this,{start:"left",end:"right",ma:"width"});this.gc=a.ue;this.marginLeft=a.Oe;this.marginRight=a.Ne};Hq.prototype.Ed=function(){var a=Qq(this,{start:"top",end:"bottom",ma:"height"});this.fc=a.ue;this.marginTop=a.Oe;this.marginBottom=a.Ne};
function Qq(a,b){var c=a.style,d=a.b.f,e=b.start,f=b.end,g=b.ma,h=a.b.F[g].ra(d,null),l=Y(d,c[g],h),k=Y(d,c["margin-"+e],h),m=Y(d,c["margin-"+f],h),n=Po(d,c["padding-"+e],h),r=Po(d,c["padding-"+f],h),q=Ro(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),z=Ro(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),y=x(d,h,w(d,w(d,q,n),w(d,z,r)));l?(y=x(d,y,l),k||m?k?m=x(d,y,k):k=x(d,y,m):m=k=mc(d,y,new tb(d,.5))):(k||(k=d.b),m||(m=d.b),l=x(d,y,w(d,k,m)));c[e]=new E(k);c[f]=new E(m);c["margin-"+e]=
Fd;c["margin-"+f]=Fd;c["padding-"+e]=new E(n);c["padding-"+f]=new E(r);c["border-"+e+"-width"]=new E(q);c["border-"+f+"-width"]=new E(z);c[g]=new E(l);c["max-"+g]=new E(l);return{ue:x(d,h,w(d,k,m)),Oe:k,Ne:m}}Hq.prototype.Ob=function(a,b,c,d,e){Oo.prototype.Ob.call(this,a,b,c,d,e);c.O=b.element};function Iq(a,b){Oo.call(this,a,b);var c=b.A;this.l=Aq[c];a.ta[c]=this;this.xa=!0}t(Iq,Oo);p=Iq.prototype;
p.Ob=function(a,b,c,d,e){var f=b.element;v(f,"display","flex");var g=ap(this,a,"vertical-align"),h=null;g===C("middle")?h="center":g===C("top")?h="flex-start":g===C("bottom")&&(h="flex-end");h&&(v(f,"flex-flow",this.u?"row":"column"),v(f,"justify-content",h));Oo.prototype.Ob.call(this,a,b,c,d,e)};
...
function Rq(a,b,c){function d(a){if(y)return y;y={ma:z?z.evaluate(a):null,$a:l?l.evaluate(a):null,ab:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[r,m,n,q].forEach(function(b){b&&(c+=b.evaluate(a))});(null===y.$a||null===y.ab)&&c+y.ma+y.$a+y.ab>b&&(null===y.$a&&(y.$a=0),null===y.ab&&(y.Sf=0));null!==y.ma&&null!==y.$a&&null!==y.ab&&(y.ab=null);null===y.ma&&null!==y.$a&&null!==y.ab?y.ma=b-c-y.$a-y.ab:null!==y.ma&&null===y.$a&&null!==y.ab?y.$a=b-c-y.ma-y.ab:null!==y.ma&&null!==y.$a&&null===y.ab?y.ab=
b-c-y.ma-y.$a:null===y.ma?(y.$a=y.ab=0,y.ma=b-c):y.$a=y.ab=(b-c-y.ma)/2;return y}var e=a.style;a=a.b.f;var f=b.Fd,g=b.Jd;b=b.ma;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],l=Qo(a,e["margin-"+f],h),k=Qo(a,e["margin-"+g],h),m=Po(a,e["padding-"+f],h),n=Po(a,e["padding-"+g],h),r=Ro(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),q=Ro(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),z=Y(a,e[b],h),y=null;e[b]=new E(new vb(a,function(){var a=d(this).ma;return null===a?0:a},b));e["margin-"+
f]=new E(new vb(a,function(){var a=d(this).$a;return null===a?0:a},"margin-"+f));e["margin-"+g]=new E(new vb(a,function(){var a=d(this).ab;return null===a?0:a},"margin-"+g));"left"===f?e.left=new E(w(a,c.marginLeft,c.gc)):"top"===f&&(e.top=new E(w(a,c.marginTop,c.fc)))}p.Dd=function(){var a=this.f.l;this.l.Ha?Rq(this,{Fd:"right",Jd:"left",ma:"width"},a):this.l.Ia?Rq(this,{Fd:"left",Jd:"right",ma:"width"},a):this.sa({start:"left",end:"right",ma:"width"},a)};
p.Ed=function(){var a=this.f.l;this.l.Ja?Rq(this,{Fd:"bottom",Jd:"top",ma:"height"},a):this.l.Ga?Rq(this,{Fd:"top",Jd:"bottom",ma:"height"},a):this.sa({start:"top",end:"bottom",ma:"height"},a)};p.Xc=function(a,b,c,d,e,f,g){Oo.prototype.Xc.call(this,a,b,c,d,e,f,g);a=c.H;c=this.b.A;d=this.l;d.Ha||d.Ia?d.Ja||d.Ga||(d.Ha?a.left[c]=b:d.Ia&&(a.right[c]=b)):d.Ja?a.top[c]=b:d.Ga&&(a.bottom[c]=b)};
...
function Uq(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof V?e.value+"":Uq(a,e);c.push(d+f+(e.Va||""))}return c.sort().join("^")}function Vq(a,b,c){c=c.clone({Pb:"vivliostyle-page-rule-master"});var d=c.b,e=b.size;if(e){var f=qq(b),e=e.Va;d.width=wh(a.f,d.width,new V(f.width,e));d.height=wh(a.f,d.height,new V(f.height,e))}["counter-reset","counter-increment"].forEach(function(a){d[a]&&(b[a]=d[a])});c=c.h(a.h);c.j(a.b,a.g);qp(c,a.f);return c}
function Wq(a){this.b=null;this.h=a}t(Wq,W);Wq.prototype.apply=function(a){a.Z===this.h&&this.b.apply(a)};Wq.prototype.f=function(){return 3};Wq.prototype.g=function(a){this.b&&Lh(a.Ec,this.h,this.b);return!0};function Xq(a){this.b=null;this.h=a}t(Xq,W);Xq.prototype.apply=function(a){1===(new fc(this.h,"page-number")).evaluate(a.l)&&this.b.apply(a)};Xq.prototype.f=function(){return 2};function Yq(a){this.b=null;this.h=a}t(Yq,W);
...
function ar(a){this.b=null;this.h=a}t(ar,W);ar.prototype.apply=function(a){(new fc(this.h,"verso-page")).evaluate(a.l)&&this.b.apply(a)};ar.prototype.f=function(){return 1};function br(a,b){Jh.call(this,a,b,null,null)}t(br,Jh);br.prototype.apply=function(a){var b=a.l,c=a.F,d=this.style;a=this.$;Ch(b,c,d,a,null,null);if(d=d._marginBoxes){var c=Ah(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);Ch(b,f,d[e],a,null,null)}}};
function cr(a,b,c,d,e){aj.call(this,a,b,null,c,null,d,!1);this.O=e;this.G=[];this.g="";this.C=[]}t(cr,aj);p=cr.prototype;p.kc=function(){this.tb()};p.yb=function(a,b){if(this.g=b)this.b.push(new Wq(b)),this.$+=65536};
p.Fc=function(a,b){b&&mf(this,"E_INVALID_PAGE_SELECTOR :"+a+"("+b.join("")+")");this.C.push(":"+a);switch(a.toLowerCase()){case "first":this.b.push(new Xq(this.f));this.$+=256;break;case "left":this.b.push(new Yq(this.f));this.$+=1;break;case "right":this.b.push(new Zq(this.f));this.$+=1;break;case "recto":this.b.push(new $q(this.f));this.$+=1;break;case "verso":this.b.push(new ar(this.f));this.$+=1;break;default:mf(this,"E_INVALID_PAGE_SELECTOR :"+a)}};
function dr(a){var b;a.g||a.C.length?b=[a.g].concat(a.C.sort()):b=null;a.G.push({le:b,$:a.$});a.g="";a.C=[]}p.ic=function(){dr(this);aj.prototype.ic.call(this)};p.wa=function(){dr(this);aj.prototype.wa.call(this)};
p.sb=function(a,b,c){if("bleed"!==a&&"marks"!==a||this.G.some(function(a){return!a.le})){aj.prototype.sb.call(this,a,b,c);var d=this.Ua[a],e=this.O;if("bleed"===a||"marks"===a)e[""]||(e[""]={}),Object.keys(e).forEach(function(b){zh(e[b],a,d)});else if("size"===a){var f=e[""];this.G.forEach(function(b){var c=new V(d.value,d.Va+b.$);b=b.le?b.le.join(""):"";var g=e[b];g?(c=(b=g[a])?wh(null,c,b):c,zh(g,a,c)):(g=e[b]={},zh(g,a,c),f&&["bleed","marks"].forEach(function(a){f[a]&&zh(g,a,f[a])},this))},this)}}};
p.He=function(a){Lh(this.j.Ec,"*",a)};p.Me=function(a){return new br(this.Ua,a)};p.Qd=function(a){var b=Ah(this.Ua,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);hf(this.ja,new er(this.f,this.ja,this.w,c))};function er(a,b,c,d){jf.call(this,a,b,!1);this.g=c;this.b=d}t(er,kf);er.prototype.rb=function(a,b,c){gh(this.g,a,b,c,this)};er.prototype.Bc=function(a,b){lf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};er.prototype.od=function(a,b){lf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
er.prototype.sb=function(a,b,c){zh(this.b,a,new V(b,c?ef(this):ff(this)))};var fr=new je(function(){var a=I("uaStylesheetBase");hh.get().then(function(b){var c=oa("user-agent-base.css",na);b=new aj(null,null,null,null,null,b,!0);b.lc("UA");$i=b.j;Mf(c,b,null,null).Fa(a)});return M(a)},"uaStylesheetBaseFetcher");
...
function kr(a,b,c,d,e,f,g,h,l,k,m){Ab.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.ea=b;this.lang=b.lang||c;this.viewport=d;this.l={body:!0};this.g=e;this.A=this.b=this.H=this.f=this.F=null;this.C=0;this.Ab=f;this.h=new Cl(this.style.C);this.Ma={};this.X=null;this.j=m;this.Bb=new Zl(null,null,null,null,null,null,null);this.V={};this.xa=null;this.vb=g;this.xb=h;this.Z=l;this.wb=k;for(var n in a.h)(b=a.h[n]["flow-consume"])&&(b.evaluate(this,"flow-consume")==Jc?this.l[n]=!0:delete this.l[n]);
this.Sa={};this.ka=this.fa=0}t(kr,Ab);
function lr(a){var b=I("StyleInstance.init"),c=new no(a.j,a.ea.url),d=new mo(a.j,a.ea.url,a.style.f,a.style.b);a.f=new jl(a.ea,a.style.g,a.style.f,a,a.l,a.style.w,c,d);d.h=a.f;tl(a.f,a);a.H={};a.H[a.ea.url]=a.f;var e=ql(a.f);a.xa=kq(e);a.F=new rp(a.style.H);c=new Ni(a.style.g,a,c,d);a.F.j(c,e);qp(a.F,a);a.X=new Sq(c,a.style.b,a.F,a,e);e=[];for(c=0;c<a.style.j.length;c++)if(d=a.style.j[c],!d.W||d.W.evaluate(a))d=zl(d.Zb,a),d=new Al(d),e.push(d);Il(a.Ab,e,a.h).Fa(b);var f=a.style.G;Object.keys(f).forEach(function(a){var b=
rq(qq(f[a]),this);this.Sa[a]={width:b.Nb+2*b.xd,height:b.Mb+2*b.xd}},a);return M(b)}function ul(a,b,c){if(a=a.b)a.f[b.b]||(a.f[b.b]=c),c=a.b[b.b],c||(c=new yk,a.b[b.b]=c),c.b.push(new xk(new vk({na:[{node:b.element,Wa:hk,qa:null,Aa:null,va:null}],ia:0,M:!1,La:null}),b))}function mr(a,b){for(var c=Number.POSITIVE_INFINITY,d=0;d<b.b.length;d++){for(var e=b.b[d].f.Ba,f=e.na[0].node,g=e.ia,h=e.M,l=0;f.ownerDocument!=a.ea.b;)l++,f=e.na[l].node,h=!1,g=0;e=uj(a.ea,f,g,h);e<c&&(c=e)}return c}
...
function or(a,b){var c=a.b,d=nr(a,c);if(d==Number.POSITIVE_INFINITY)return null;for(var e=a.F.w,f,g=0;g<e.length;g++)if(f=e[g],"vivliostyle-page-rule-master"!==f.b.Pb){var h=1,l=ap(f,a,"utilization");l&&l.he()&&(h=l.I);var l=Cb(a,"em",!1),k=a.Nb()*a.Mb();a.C=rl(a.f,d,Math.ceil(h*k/(l*l)));h=a;l=c;k=void 0;for(k in l.b){var m=l.b[k];if(m&&0<m.b.length){var n=m.b[0].b;if(mr(h,m)===n.f){a:switch(n=m.g,n){case "left":case "right":case "recto":case "verso":break a;default:n=null}m.g=Kl(al(n,m.b[0].b.g))}}}a.A=
c.clone();h=a;l=h.b.page;k=void 0;for(k in h.b.b)for(m=h.b.b[k],n=m.b.length-1;0<=n;n--){var r=m.b[n];0>r.b.hb&&r.b.f<h.C&&(r.b.hb=l)}Bb(a,a.style.b);h=ap(f,a,"enabled");if(!h||h===Bd){c=a;u.debug("Location - page",c.b.page);u.debug("  current:",d);u.debug("  lookup:",c.C);d=void 0;for(d in c.b.b)for(e=c.b.b[d],g=0;g<e.b.length;g++)u.debug("  Chunk",d+":",e.b[g].b.f);d=a.X;e=f;f=b;c=e.b;Object.keys(f).length?(e=c,g=Uq(d,f),e=e.l+"^"+g,g=d.j[e],g||("background-host"===c.Pb?(c=d,f=(new Cq(c.l,c.h.b,
f)).h(c.h),f.j(c.b,c.g),qp(f,c.f),g=f):g=Vq(d,f,c),d.j[e]=g),f=g.b,f.f.g=f,f=g):(c.f.g=c,f=e);return f}}throw Error("No enabled page masters");}function ir(a,b){var c=a.A.f,d=c[b.b].f;if(d){var e=b.f,f=c[d].b;if(!f.length||e<f[0])return!1;var c=La(f.length,function(a){return f[a]>e})-1,c=f[c],d=a.A.b[d],g=mr(a,d);return c<g?!1:g<c?!0:!hr(a,d.g)}return!1}function pr(a,b,c){a=a.b.f[c];a.L||(a.L=new Wm(null));b.Vd=a.L}
function qr(a){var b=a.f,c=pm(b),d=I("layoutDeferredPageFloats"),e=!1,f=0;he(function(d){if(f===c.length||rm(b))Q(d);else{var g=c[f++],l=g.gb;lm(b,l)?P(d):Hn(a,g.b,l).then(function(a){a?(a=wm(b.parent))?Q(d):(wm(b)&&!a&&(e=!0,b.Cc=!1),P(d)):P(d)})}}).then(function(){e&&jm(b);O(d,!0)});return M(d)}
function rr(a,b,c){var d=a.b.b[c];if(!d||!hr(a,d.g))return L(!0);d.g="any";pr(a,b,c);wn(b);a.l[c]&&0<b.J.length&&(b.Bb=!1);var e=I("layoutColumn");qr(b).then(function(){if(wm(b.f))O(e,!0);else{var c=[],g=[],h=!0;he(function(e){for(;0<d.b.length-g.length;){for(var f=0;0<=g.indexOf(f);)f++;var l=d.b[f];if(l.b.f>a.C||ir(a,l.b))break;for(var n=f+1;n<d.b.length;n++)if(!(0<=g.indexOf(n))){var r=d.b[n];if(r.b.f>a.C||ir(a,r.b))break;ck(r.b,l.b)&&(l=r,f=n)}var q=l.b,z=!0;zn(b,l.f,h,d.f).then(function(a){if(wm(b.f))Q(e);
else if(h=!1,!l.b.nf||a&&!q.h||c.push(f),q.h)g.push(f),Q(e);else{var k=!!a||!!b.j,m;0<tm(b.f).length&&b.Ma?a?(m=a.clone(),m.Ba=b.Ma):m=new vk(b.Ma):m=null;if(b.j&&m)l.f=m,d.f=b.j,b.j=null;else{g.push(f);if(a||m)l.f=a||m,c.push(f);b.j&&(d.g=Kl(b.j))}k?Q(e):z?z=!1:P(e)}});if(z){z=!1;return}}Q(e)}).then(function(){if(!wm(b.f)){d.b=d.b.filter(function(a,b){return 0<=c.indexOf(b)||0>g.indexOf(b)});"column"===d.f&&(d.f=null);var a=Im(b.f);En(b,a)}O(e,!0)})}});return M(e)}
function sr(a,b,c,d,e,f,g,h,l,k,m,n,r,q,z){var y=b.u?b.h&&b.O:b.g&&b.V,A=f.element,H=new Zl(l,"column",null,h,null,null,null),G=a.b.clone(),J=I("createAndLayoutColumn"),K;he(function(b){if(1<k){var J=a.viewport.b.createElement("div");v(J,"position","absolute");A.appendChild(J);K=new Xm(J,q,a.g,z,H);K.u=f.u;K.Xa=f.Xa;K.xb=f.xb;f.u?(J=g*(n+m)+f.A,Kk(K,f.w,f.width),Jk(K,J,n)):(J=g*(n+m)+f.w,Jk(K,f.A,f.height),Kk(K,J,n));K.bb=c;K.cb=d}else K=new Xm(A,q,a.g,z,H),Ik(K,f);K.Ib=y?[]:e.concat();K.xa=r;cm(H,
K);0<=K.width?rr(a,K,h).then(function(){wm(H)||um(H);wm(K.f)&&!wm(l)?(K.f.Cc=!1,a.b=G.clone(),K.element!==A&&A.removeChild(K.element),P(b)):Q(b)}):(um(H),Q(b))}).then(function(){O(J,K)});return M(J)}function tr(a,b,c,d,e){var f=ap(c,a,"writing-mode")||null;a=ap(c,a,"direction")||null;return new Zl(b,"region",d,e,null,f,a)}
function ur(a,b,c,d,e,f,g,h){Uo(c);var l=ap(c,a,"enabled");if(l&&l!==Bd)return L(!0);var k=I("layoutContainer"),m=ap(c,a,"wrap-flow")===Lc,l=ap(c,a,"flow-from"),n=a.viewport.b.createElement("div"),r=ap(c,a,"position");v(n,"position",r?r.name:"absolute");d.insertBefore(n,d.firstChild);var q=new Ck(n);q.u=c.u;q.Ib=g;c.Ob(a,q,b,a.h,a.g);q.bb=e;q.cb=f;e+=q.left+q.marginLeft+q.borderLeft;f+=q.top+q.marginTop+q.borderTop;(c instanceof Hq||c instanceof Ko&&!(c instanceof Gq))&&cm(h,q);var z=a.b.clone(),
y=!1;if(l&&l.Je())if(a.V[l.toString()])wm(h)||c.Xc(a,q,b,null,1,a.g,a.h),l=L(!0);else{var A=I("layoutContainer.inner"),H=l.toString(),G=tr(a,h,c,q,H),J=Z(c,a,"column-count"),K=Z(c,a,"column-gap"),Pa=1<J?Z(c,a,"column-width"):q.width,l=$o(c,a),Ca=0,r=ap(c,a,"shape-inside"),ua=tg(r,0,0,q.width,q.height,a),N=new Jp(H,a,a.viewport,a.f,l,a.ea,a.h,a.style.F,a,b,a.vb,a.xb,a.wb),Xa=new lo(a.j,a.b.page-1),yc=0,zc=null;he(function(b){sr(a,c,e,f,g,q,yc++,H,G,J,K,Pa,ua,N,Xa).then(function(c){wm(h)?Q(b):(yc!==
J||wm(G)||um(G),wm(G)?(yc=0,a.b=z.clone(),G.Cc=!1,P(b)):(zc=c,zc.j&&"column"!=zc.j&&(yc=J,"region"!=zc.j&&(a.V[H]=!0)),Ca=Math.max(Ca,zc.la),yc<J?P(b):Q(b)))})}).then(function(){if(!wm(h)){zc.element===n&&(q=zc);q.la=Ca;c.Xc(a,q,b,zc,J,a.g,a.h);var d=a.b.b[H];d&&"region"===d.f&&(d.f=null)}O(A,!0)});l=M(A)}else{if((l=ap(c,a,"content"))&&Pk(l)){r="span";l.url&&(r="img");var Kj=a.viewport.b.createElement(r);l.ba(new Ok(Kj,a,l));n.appendChild(Kj);"img"==r&&pp(c,a,Kj,a.h);op(c,a,q,a.h)}else c.xa&&(d.removeChild(n),
y=!0);y||c.Xc(a,q,b,null,1,a.g,a.h);l=L(!0)}l.then(function(){if(wm(h))O(k,!0);else{if(!c.g||0<Math.floor(q.la)){if(!y&&!m){var l=ap(c,a,"shape-outside"),l=q.zd(l,a);g.push(l)}}else if(!c.w.length){d.removeChild(n);O(k,!0);return}var r=c.w.length-1;ge(function(){for(;0<=r;){var d=c.w[r--],d=ur(a,b,d,n,e,f,g,h);if(d.za())return d.oa(function(){return L(!wm(h))});if(wm(h))break}return L(!1)}).then(function(){O(k,!0)})}});return M(k)}
function vr(a){var b=a.b.page,c;for(c in a.b.b)for(var d=a.b.b[c],e=d.b.length-1;0<=e;e--){var f=d.b[e];0<=f.b.hb&&f.b.hb+f.b.l-1<=b&&d.b.splice(e,1)}}function wr(a,b){for(var c in a.l){var d=b.b[c];if(d&&0<d.b.length)return!1}return!0}
function xr(a,b,c){a.V={};c?(a.b=c.clone(),ml(a.f,c.g)):(a.b=new Ak,ml(a.f,-1));a.lang&&b.g.setAttribute("lang",a.lang);c=a.b;c.page++;Bb(a,a.style.b);a.A=c.clone();var d=Tq(a.X),e=or(a,d);if(!e)return L(null);Tj(b,e.b.b.width.value===Dd);Uj(b,e.b.b.height.value===Ed);a.j.j=b;xo(a.j,d,a);var f=rq(qq(d),a);yr(a,f,b);yq(d,f,b,a);var g=f.Eb+f.Vb,d=ap(e,a,"writing-mode")||ad,f=ap(e,a,"direction")||jd,h=new Zl(a.Bb,"page",null,null,null,d,f),l=I("layoutNextPage");he(function(c){ur(a,b,e,b.g,g,g,[],h).then(function(){wm(h)||
um(h);wm(h)?(a.b=a.A.clone(),h.Cc=!1,P(c)):Q(c)})}).then(function(){e.Z(a,b,a.g);var d=new fc(e.b.f,"left-page");b.l=d.evaluate(a)?"left":"right";vr(a);c=a.b;Object.keys(c.b).forEach(function(b){b=c.b[b];var d=b.f;!d||"page"!==d&&hr(a,d)||(b.f=null)});a.b=a.A=null;c.g=a.f.b;Wj(b,a.style.l.J[a.ea.url],a.g);wr(a,c)&&(c=null);O(l,c)});return M(l)}
function yr(a,b,c){a.O=b.Nb;a.J=b.Mb;a.ka=b.Nb+2*b.xd;a.fa=b.Mb+2*b.xd;c.K.style.width=a.ka+"px";c.K.style.height=a.fa+"px";c.g.style.left=b.Eb+"px";c.g.style.right=b.Eb+"px";c.g.style.top=b.Eb+"px";c.g.style.bottom=b.Eb+"px";c.g.style.padding=b.Vb+"px"}function zr(a,b,c,d){aj.call(this,a.j,a,b,c,d,a.h,!c);this.g=a;this.C=!1}t(zr,aj);p=zr.prototype;p.kd=function(){};p.jd=function(a,b,c){a=new Jo(this.g.w,a,b,c,this.g.G,this.W,ff(this.ja));hf(this.g,new wp(a.f,this.g,a,this.w))};
p.bc=function(a){a=a.b;this.W&&(a=lc(this.f,this.W,a));hf(this.g,new zr(this.g,a,this,this.F))};p.fd=function(){hf(this.g,new gj(this.f,this.ja))};p.hd=function(){var a={};this.g.A.push({Zb:a,W:this.W});hf(this.g,new hj(this.f,this.ja,null,a,this.g.h))};p.gd=function(a){var b=this.g.l[a];b||(b={},this.g.l[a]=b);hf(this.g,new hj(this.f,this.ja,null,b,this.g.h))};p.md=function(){var a={};this.g.H.push(a);hf(this.g,new hj(this.f,this.ja,this.W,a,this.g.h))};
p.Jc=function(a){var b=this.g.C;if(a){var c=Ah(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}hf(this.g,new hj(this.f,this.ja,null,b,this.g.h))};p.ld=function(){this.C=!0;this.tb()};p.kc=function(){var a=new cr(this.g.w,this.g,this,this.w,this.g.F);hf(this.g,a);a.kc()};p.wa=function(){aj.prototype.wa.call(this);if(this.C){this.C=!1;var a="R"+this.g.O++,b=C(a),c;this.W?c=new vh(b,0,this.W):c=new V(b,0);Bh(this.Ua,"region-id").push(c);this.Hb();a=new zr(this.g,this.W,this,a);hf(this.g,a);a.wa()}};
...
Er.prototype.V=function(a){this.b.push({url:a.url,text:a.text,Za:"Author",Ca:null,media:null})};Er.prototype.X=function(a){this.b.push({url:a.url,text:a.text,Za:"User",Ca:null,media:null})};
function Dr(a,b){var c=I("OPSDocStore.load"),d=b.url;Cj(b,a).then(function(b){if(b){for(var e=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),h=0;h<g.length;h++){var l=g[h],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),n=l.getAttribute("action"),l=l.getAttribute("ref");k&&m&&n&&l&&e.push({kf:k,event:m,action:n,Hc:l})}a.J[d]=e;var r=[];r.push({url:oa("user-agent-page.css",na),text:null,Za:"UA",
Ca:null,media:null});if(e=b.l)for(e=e.firstChild;e;e=e.nextSibling)if(1==e.nodeType)if(g=e,h=g.namespaceURI,k=g.localName,"http://www.w3.org/1999/xhtml"==h)if("style"==k)r.push({url:d,text:g.textContent,Za:"Author",Ca:null,media:null});else if("link"==k){if(m=g.getAttribute("rel"),h=g.getAttribute("class"),k=g.getAttribute("media"),"stylesheet"==m||"alternate stylesheet"==m&&h)g=g.getAttribute("href"),g=oa(g,d),r.push({url:g,text:null,Ca:h,media:k,Za:"Author"})}else"meta"==k&&"viewport"==g.getAttribute("name")&&
r.push({url:d,text:Ar(g),Za:"Author",Ca:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==h?"stylesheet"==k&&"text/css"==g.getAttribute("type")&&r.push({url:d,text:g.textContent,Za:"Author",Ca:null,media:null}):"http://example.com/sse"==h&&"property"===k&&(h=g.getElementsByTagName("name")[0])&&"stylesheet"===h.textContent&&(g=g.getElementsByTagName("value")[0])&&(g=oa(g.textContent,d),r.push({url:g,text:null,Ca:null,media:null,Za:"Author"}));for(h=0;h<a.b.length;h++)r.push(a.b[h]);
for(var q="",h=0;h<r.length;h++)q+=r[h].url,q+="^",r[h].text&&(q+=r[h].text),q+="^";var z=a.H[q];z?(a.f[d]=z,O(c,b)):(e=a.w[q],e||(e=new je(function(){var b=I("fetchStylesheet"),c=0,d=new Br(a.l);ge(function(){if(c<r.length){var a=r[c++];d.lc(a.Za);return null!==a.text?Nf(a.text,d,a.url,a.Ca,a.media).nd(!0):Mf(a.url,d,a.Ca,a.media)}return L(!1)}).then(function(){z=new gr(a,d.j,d.w,d.J.j,d.G,d.A,d.C,d.l,d.H,d.F);a.H[q]=z;delete a.w[q];O(b,z)});return M(b)},"FetchStylesheet "+d),a.w[q]=e,e.start()),
...
Lr.prototype.ed=function(a,b,c,d,e){if(this.page)return L(this.page);var f=this,g=I("showTOC"),h=new Sj(a,a);this.page=h;this.b.load(this.url).then(function(d){var k=f.b.f[d.url],l=jr(k,c,1E5,e);b=new jq(b.window,l.fontSize,b.root,l.width,l.height);var n=new kr(k,d,f.lang,b,f.f,f.l,f.Gd(d),f.j,0,f.h,f.g);f.Qa=n;n.Y=f.Y;lr(n).then(function(){xr(n,h,null).then(function(){Mr(f,a,2);O(g,h)})})});return M(g)};
Lr.prototype.Yc=function(){if(this.page){var a=this.page;this.Qa=this.page=null;v(a.K,"visibility","none");var b=a.K.parentNode;b&&b.removeChild(a.K)}};Lr.prototype.ie=function(){return!!this.page};function Or(){Er.call(this,Pr(this));this.g=new $e(Cj,"document");this.F=new $e(bf,"text");this.G={};this.fa={};this.A={};this.C={}}t(Or,Er);function Pr(a){return function(b){return a.A[b]}}
...
return M(d)}function Rr(a,b,c,d){var e=b+c,f=a.G[e];if(f)return L(f);var g=I("loadOPF");a.g.load(e,void 0,void 0).then(function(c){c?a.g.load(b+"META-INF/encryption.xml",void 0,void 0).then(function(h){(d?a.F.load(b+"?r=list"):L(null)).then(function(d){f=new Sr(a,b);Tr(f,c,h,d,b+"?r=manifest").then(function(){a.G[e]=f;a.fa[b]=f;O(g,f)})})}):u.error("Received an empty response for EPUB OPF "+e+". This may be caused by the server not allowing cross origin requests.")});return M(g)}
function Ur(a,b,c){var d=I("EPUBDocStore.load");b=la(b);(a.C[b]=Dr(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,dd:null})).Fa(d);return M(d)}
Or.prototype.load=function(a){var b=la(a);if(a=this.C[b])return a.za()?a:L(a.get());var c=I("EPUBDocStore.load");a=Or.Ue.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?O(c,a):u.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return M(c)};function Vr(){this.id=null;this.src="";this.h=this.f=null;this.P=-1;this.l=0;this.w=null;this.b=this.g=0;this.$b=this.hb=null;this.j=Oa}
...
a.namespaceURI)return{name:Yr.dcterms+a.localName,order:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Od:null,scheme:null};return null});var l=Qa(g,function(a){return a.Od});g=d(Qa(g,function(a){return a.Od?null:a.name}));var k=null;g[Zr]&&(k=g[Zr][0].v);c(g);return g}function cs(){var a=window.MathJax;return a?a.Hub:null}var ds={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function Sr(a,b){this.h=a;this.l=this.f=this.b=this.j=this.g=null;this.C=b;this.A=null;this.V={};this.lang=null;this.F=0;this.J={};this.X=this.O=this.Z=null;this.G={};this.H=null;this.w=es(this);cs()&&(lh["http://www.w3.org/1998/Math/MathML"]=!0)}
function es(a){function b(){}b.prototype.Rd=function(a,b){return"viv-id-"+qa(b+(a?"#"+a:""),":")};b.prototype.Oc=function(b,d){var c=b.match(/^([^#]*)#?(.*)$/);if(c){var f=c[1]||d,c=c[2];if(f&&a.j.some(function(a){return a.src===f}))return"#"+this.Rd(c,f)}return b};b.prototype.pf=function(a){"#"===a.charAt(0)&&(a=a.substring(1));a.indexOf("viv-id-")||(a=a.substring(7));return(a=Ja(a).match(/^([^#]*)#?(.*)$/))?[a[1],a[2]]:[]};return new b}
...
(a.O=d);!a.X&&d.j["cover-image"]&&(a.X=d);return d});a.f=Na(a.j,Wr);a.l=Na(a.j,function(b){return fs(a,b.src)});for(var l in h)for(g=l;;){g=a.f[h[g]];if(!g)break;if(ds[g.f]){a.G[l]=g.src;break}g=g.src}a.b=Ra(rj(rj(f,"spine"),"itemref").b,function(b,c){var d=b.getAttribute("idref");if(d=a.f[d])d.h=b,d.P=c;return d});if(l=Mj(rj(f,"spine"),"toc")[0])a.Z=a.f[l];if(l=Mj(rj(f,"spine"),"page-progression-direction")[0]){a:switch(l){case "ltr":l="ltr";break a;case "rtl":l="rtl";break a;default:throw Error("unknown PageProgression: "+
...
function js(a,b){return Qd("resolveFragment",function(c){if(b){var d=new fb;gb(d,b);var e;if(a.g){var f=hb(d,a.g.b);if(1!=f.node.nodeType||f.M||!f.Hc){O(c,null);return}var g=f.node,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.f[h]){O(c,null);return}e=a.f[h];d=f.Hc}else e=a.b[0];a.h.load(e.src).then(function(a){var b=hb(d,a.b);a=uj(a,b.node,b.offset,b.M);O(c,{P:e.P,Ea:a,aa:-1})})}else O(c,null)},function(a,d){u.b(d,"Cannot resolve fragment:",b);O(a,null)})}
function ks(a,b){return Qd("resolveEPage",function(c){if(0>=b)O(c,{P:0,Ea:0,aa:-1});else{var d=La(a.b.length,function(c){c=a.b[c];return c.g+c.b>b}),e=a.b[d];a.h.load(e.src).then(function(a){b-=e.g;b>e.b&&(b=e.b);var f=0;0<b&&(a=vj(a),f=Math.round(a*b/e.b),f==a&&f--);O(c,{P:d,Ea:f,aa:-1})})}},function(a,d){u.b(d,"Cannot resolve epage:",b);O(a,null)})}
function ls(a,b){var c=a.b[b.P];if(0>=b.Ea)return L(c.g);var d=I("getEPage");a.h.load(c.src).then(function(a){a=vj(a);O(d,c.g+Math.min(a,b.Ea)*c.b/a)});return M(d)}function ms(a,b){return{page:a,position:{P:a.P,aa:b,Ea:a.offset}}}function ns(a,b,c,d,e){this.b=a;this.viewport=b;this.j=c;this.w=e;this.ac=[];this.l=[];this.Y=kb(d);this.h=new hq(b);this.f=new vo(a.w)}function os(a,b){var c=a.ac[b.P];return c?c.nb[b.aa]:null}p=ns.prototype;
p.Kb=function(a){return this.b.H?this.b.H:(a=this.ac[a?a.P:0])?a.Qa.xa:null};
function ps(a,b,c,d){c.K.style.display="none";c.K.style.visibility="visible";c.K.style.position="";c.K.style.top="";c.K.style.left="";c.K.setAttribute("data-vivliostyle-page-side",c.l);var e=b.nb[d];c.G=!b.item.P&&!d;b.nb[d]=c;e?(b.Qa.viewport.f.replaceChild(c.K,e.K),Ua(e,{type:"replaced",target:null,currentTarget:null,Pe:c})):b.Qa.viewport.f.appendChild(c.K);a.w({width:b.Qa.ka,height:b.Qa.fa},b.Qa.Sa,b.item.P,b.Qa.Z+d)}
function qs(a,b,c){var d=I("renderSinglePage"),e=rs(a,b,c);xr(b.Qa,e,c).then(function(f){var g=(c=f)?c.page-1:b.Ra.length-1;ps(a,b,e,g);zo(a.f,e.P,g);f=null;if(c){var h=b.Ra[c.page];b.Ra[c.page]=c;h&&b.nb[c.page]&&(Bk(c,h)||(f=qs(a,b,c)))}f||(f=L(!0));f.then(function(){var b=Ao(a.f,e),f=0;he(function(c){f++;if(f>b.length)Q(c);else{var d=b[f-1];d.cd=d.cd.filter(function(a){return!a.Ic});d.cd.length?ss(a,d.P).then(function(b){b?(yo(a.f,d.Kd),Bo(a.f,d.cd),qs(a,b,b.Ra[d.aa]).then(function(b){var d=a.f;
d.b=d.F.pop();d=a.f;d.g=d.H.pop();d=b.Dc.position;d.P===e.P&&d.aa===g&&(e=b.Dc.page);P(c)})):P(c)}):P(c)}}).then(function(){O(d,{Dc:ms(e,g),Qe:c})})})});return M(d)}function ts(a,b){var c=a.aa,d=-1;0>c&&(d=a.Ea,c=La(b.Ra.length,function(a){return nr(b.Qa,b.Ra[a],!0)>d}),c=c===b.Ra.length?b.complete?b.Ra.length-1:Number.POSITIVE_INFINITY:c-1);return{P:a.P,aa:c,Ea:d}}
function us(a,b,c){var d=I("findPage");ss(a,b.P).then(function(e){if(e){var f=null,g;he(function(d){var h=ts(b,e);g=h.aa;(f=e.nb[g])?Q(d):e.complete?(g=e.Ra.length-1,f=e.nb[g],Q(d)):c?vs(a,h).then(function(a){a&&(f=a.page);Q(d)}):fe(100).then(function(){P(d)})}).then(function(){O(d,ms(f,g))})}else O(d,null)});return M(d)}
function vs(a,b){var c=I("renderPage");ss(a,b.P).then(function(d){if(d){var e=ts(b,d),f=e.aa,g=e.Ea,h=d.nb[f];h?O(c,ms(h,f)):he(function(b){if(f<d.Ra.length)Q(b);else if(d.complete)f=d.Ra.length-1,Q(b);else{var c=d.Ra[d.Ra.length-1];qs(a,d,c).then(function(e){var k=e.Dc.page;(c=e.Qe)?0<=g&&nr(d.Qa,c)>g?(h=k,f=d.Ra.length-2,Q(b)):P(b):(h=k,f=e.Dc.position.aa,d.complete=!0,k.A=d.item.P===a.b.b.length-1,Q(b))})}}).then(function(){h=h||d.nb[f];var b=d.Ra[f];h?O(c,ms(h,f)):qs(a,d,b).then(function(b){b.Qe||
(d.complete=!0,b.Dc.page.A=d.item.P===a.b.b.length-1);O(c,b.Dc)})})}else O(c,null)});return M(c)}p.Pd=function(){return ws(this,{P:this.b.b.length-1,aa:Number.POSITIVE_INFINITY,Ea:-1})};function ws(a,b){var c=I("renderAllPages");b||(b={P:0,aa:0,Ea:0});var d=b.P,e=b.aa,f=0,g;he(function(c){vs(a,{P:f,aa:f===d?e:Number.POSITIVE_INFINITY,Ea:f===d?b.Ea:-1}).then(function(a){g=a;++f>d?Q(c):P(c)})}).then(function(){O(c,g)});return M(c)}p.$e=function(){return us(this,{P:0,aa:0,Ea:-1})};
p.df=function(){return us(this,{P:this.b.b.length-1,aa:Number.POSITIVE_INFINITY,Ea:-1})};p.nextPage=function(a,b){var c=this,d=a.P,e=a.aa,f=I("nextPage");ss(c,d).then(function(a){if(a){if(a.complete&&e==a.Ra.length-1){if(d>=c.b.b.length-1){O(f,null);return}d++;e=0}else e++;us(c,{P:d,aa:e,Ea:-1},b).Fa(f)}else O(f,null)});return M(f)};p.Nd=function(a){var b=a.P;if(a=a.aa)a--;else{if(!b)return L(null);b--;a=Number.POSITIVE_INFINITY}return us(this,{P:b,aa:a,Ea:-1})};
function xs(a,b,c){b="left"===b.l;a="ltr"===a.Kb(c);return!b&&a||b&&!a}function ys(a,b,c){var d=I("getCurrentSpread"),e=os(a,b);if(!e)return L({left:null,right:null});var f="left"===e.l;(xs(a,e,b)?a.Nd(b):a.nextPage(b,c)).then(function(a){a=a&&a.page;f?O(d,{left:e,right:a}):O(d,{left:a,right:e})});return M(d)}p.jf=function(a,b){var c=os(this,a);if(!c)return L(null);var c=xs(this,c,a),d=this.nextPage(a,!!b);if(c)return d;var e=this;return d.oa(function(a){return a?e.nextPage(a.position,!!b):L(null)})};
p.mf=function(a){var b=os(this,a);if(!b)return L(null);b=xs(this,b,a);a=this.Nd(a);if(b){var c=this;return a.oa(function(a){return a?c.Nd(a.position):L(null)})}return a};function zs(a,b){var c=I("navigateToEPage");ks(a.b,b).then(function(b){b?us(a,b).Fa(c):O(c,null)});return M(c)}function As(a,b){var c=I("navigateToCFI");js(a.b,b).then(function(b){b?us(a,b).Fa(c):O(c,null)});return M(c)}
function Bs(a,b,c){u.debug("Navigate to",b);var d=fs(a.b,la(b));if(!d){if(a.b.g&&b.match(/^#epubcfi\(/))d=fs(a.b,a.b.g.url);else if("#"===b.charAt(0)){var e=a.b.w.pf(b);a.b.g?d=fs(a.b,e[0]):d=e[0];b=d+(e[1]?"#"+e[1]:"")}if(null==d)return L(null)}var f=a.b.l[d];if(!f)return a.b.g&&d==fs(a.b,a.b.g.url)&&(d=b.indexOf("#"),0<=d)?As(a,b.substr(d+1)):L(null);var g=I("navigateTo");ss(a,f.P).then(function(d){var e=yj(d.ea,b);e?us(a,{P:f.P,aa:-1,Ea:tj(d.ea,e)}).Fa(g):c.P!==f.P?us(a,{P:f.P,aa:0,Ea:-1}).Fa(g):
O(g,null)});return M(g)}
function rs(a,b,c){var d=b.Qa.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.style.position="absolute";e.style.top="0";e.style.left="0";mj||(e.style.visibility="hidden");d.h.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);var g=new Sj(e,f);g.P=b.item.P;g.position=c;g.offset=nr(b.Qa,c);g.offset||(b=a.b.w.Rd("",b.item.src),f.setAttribute("id",b),Vj(g,f,b));d!==a.viewport&&(a=Of(null,new Te(nb(a.viewport.width,
...
function ss(a,b){if(b>=a.b.b.length)return L(null);var c=a.ac[b];if(c)return L(c);var d=I("getPageViewItem"),e=a.l[b];if(e){var f=$d(d);e.push(f);return M(d)}var e=a.l[b]=[],g=a.b.b[b],h=a.b.h;h.load(g.src).then(function(f){g.b||1!=a.b.b.length||(g.b=Math.ceil(vj(f)/2700),a.b.F=g.b);var k=h.f[f.url],l=a.Gd(f),n=a.viewport,r=jr(k,n.width,n.height,n.fontSize);if(r.width!=n.width||r.height!=n.height||r.fontSize!=n.fontSize)n=new jq(n.window,r.fontSize,n.root,r.width,r.height);r=a.ac[b-1];null!==g.hb?
r=g.hb-1:(r=r?r.Qa.Z+r.nb.length:0,null!==g.$b&&(r+=g.$b));wo(a.f,r);var q=new kr(k,f,a.b.lang,n,a.h,a.j,l,a.b.G,r,a.b.w,a.f);q.Y=a.Y;lr(q).then(function(){c={item:g,ea:f,Qa:q,Ra:[null],nb:[],complete:!1};a.ac[b]=c;O(d,c);e.forEach(function(a){a.eb(c)})})});return M(d)}function Ds(a){return a.ac.some(function(a){return a&&0<a.nb.length})}
p.ed=function(){var a=this.b,b=a.O||a.Z;if(!b)return L(null);var c=I("showTOC");this.g||(this.g=new Lr(a.h,b.src,a.lang,this.h,this.j,this.Y,this,a.G,a.w,this.f));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background=
"#EEE";e.style.border="1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.g.ed(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";O(c,a)});return M(c)};p.Yc=function(){this.g&&this.g.Yc()};p.ie=function(){return this.g&&this.g.ie()};var Es={Hf:"singlePage",If:"spread",xf:"autoSpread"};
function Fs(a,b,c,d){var e=this;this.window=a;this.pd=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);mj&&b.setAttribute("data-vivliostyle-debug",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Xa=c;this.Sa=d;a=a.document;this.xa=new El(a.head,b);this.A="loading";this.O=[];this.h=null;this.Lb=this.Ka=!1;this.f=this.j=this.g=this.C=null;this.fontSize=16;this.zoom=1;this.F=!1;this.X="singlePage";this.ka=!1;this.Pd=!0;this.Y=jb();this.fa=[];this.J=function(){};this.w=function(){};
this.Z=function(){e.Ka=!0;e.J()};this.Ld=this.Ld.bind(this);this.G=function(){};this.H=a.getElementById("vivliostyle-page-rules");this.V=!1;this.l=null;this.ta={loadEPUB:this.Xe,loadXML:this.Ye,configure:this.ae,moveTo:this.Ma,toc:this.ed};Gs(this)}function Gs(a){ka(1,function(a){Hs(this,{t:"debug",content:a})}.bind(a));ka(2,function(a){Hs(this,{t:"info",content:a})}.bind(a));ka(3,function(a){Hs(this,{t:"warn",content:a})}.bind(a));ka(4,function(a){Hs(this,{t:"error",content:a})}.bind(a))}
function Hs(a,b){b.i=a.Xa;a.Sa(b)}function Is(a,b){a.A!==b&&(a.A=b,a.pd.setAttribute("data-vivliostyle-viewer-status",b),Hs(a,{t:"readystatechange"}))}p=Fs.prototype;
p.Xe=function(a){Js.f("beforeRender");Is(this,"loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=I("loadEPUB"),h=this;h.ae(a).then(function(){var a=new Or;Fr(a,e,f).then(function(){var e=oa(b,h.window.location.href);h.O=[e];Qr(a,e,d).then(function(a){h.h=a;Ks(h,c).then(function(){O(g,!0)})})})});return M(g)};
p.Ye=function(a){Js.f("beforeRender");Is(this,"loading");var b=a.url,c=a.document,d=a.fragment,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=I("loadXML"),h=this;h.ae(a).then(function(){var a=new Or;Fr(a,e,f).then(function(){var e=b.map(function(a,b){return{url:oa(a.url,h.window.location.href),index:b,hb:a.hb,$b:a.$b}});h.O=e.map(function(a){return a.url});h.h=new Sr(a,"");hs(h.h,e,c).then(function(){Ks(h,d).then(function(){O(g,!0)})})})});return M(g)};
...
p.ae=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.C=null,this.window.addEventListener("resize",this.Z,!1),this.Ka=!0):this.window.removeEventListener("resize",this.Z,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.Ka=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:Ns(this,b["margin-left"])||0,marginRight:Ns(this,b["margin-right"])||0,marginTop:Ns(this,b["margin-top"])||0,marginBottom:Ns(this,b["margin-bottom"])||
0,width:Ns(this,b.width)||0,height:Ns(this,b.height)||0},200<=b.width||200<=b.height)&&(this.window.removeEventListener("resize",this.Z,!1),this.C=b,this.Ka=!0);"boolean"==typeof a.hyphenate&&(this.Y.Bd=a.hyphenate,this.Ka=!0);"boolean"==typeof a.horizontal&&(this.Y.Ad=a.horizontal,this.Ka=!0);"boolean"==typeof a.nightMode&&(this.Y.Hd=a.nightMode,this.Ka=!0);"number"==typeof a.lineHeight&&(this.Y.lineHeight=a.lineHeight,this.Ka=!0);"number"==typeof a.columnWidth&&(this.Y.wd=a.columnWidth,this.Ka=
!0);"string"==typeof a.fontFamily&&(this.Y.fontFamily=a.fontFamily,this.Ka=!0);"boolean"==typeof a.load&&(this.ka=a.load);"boolean"==typeof a.renderAllPages&&(this.Pd=a.renderAllPages);"string"==typeof a.userAgentRootURL&&(ma=a.userAgentRootURL.replace(/resources\/?$/,""),na=a.userAgentRootURL);"string"==typeof a.rootURL&&(ma=a.rootURL,na=ma+"resources/");"string"==typeof a.pageViewMode&&a.pageViewMode!==this.X&&(this.X=a.pageViewMode,this.Ka=!0);"number"==typeof a.pageBorder&&a.pageBorder!==this.Y.jc&&
(this.viewport=null,this.Y.jc=a.pageBorder,this.Ka=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=a.zoom,this.Lb=!0);"boolean"==typeof a.fitToScreen&&a.fitToScreen!==this.F&&(this.F=a.fitToScreen,this.Lb=!0);"object"==typeof a.defaultPaperSize&&"number"==typeof a.defaultPaperSize.width&&"number"==typeof a.defaultPaperSize.height&&(this.viewport=null,this.Y.Wb=a.defaultPaperSize,this.Ka=!0);Os(this,a);return L(!0)};
function Os(a,b){(Jd.CONFIGURATION||[]).forEach(function(a){a=a(b);this.Ka=a.Ka||this.Ka;this.Lb=a.Lb||this.Lb}.bind(a))}p.Ld=function(a){var b=this.g,c=this.j,d=a.target;c?c.left!==d&&c.right!==d||Ps(this,a.Pe):b===a.target&&Ps(this,a.Pe)};function Qs(a,b){var c=[];a.g&&c.push(a.g);a.j&&(c.push(a.j.left),c.push(a.j.right));c.forEach(function(a){a&&b(a)})}function Rs(a){Qs(a,function(a){a.removeEventListener("hyperlink",this.G,!1);a.removeEventListener("replaced",this.Ld,!1)}.bind(a))}
function Ss(a){Rs(a);Qs(a,function(a){v(a.K,"display","none")});a.g=null;a.j=null}function Ts(a,b){b.addEventListener("hyperlink",a.G,!1);b.addEventListener("replaced",a.Ld,!1);v(b.K,"visibility","visible");v(b.K,"display","block")}function Us(a,b){Ss(a);a.g=b;Ts(a,b)}function Vs(a){var b=I("reportPosition");is(a.h,a.f.P,a.f.Ea).then(function(c){var d=a.g;(a.ka&&0<d.j.length?le(d.j):L(!0)).then(function(){Ws(a,d,c).Fa(b)})});return M(b)}
function Xs(a){var b=a.pd;if(a.C){var c=a.C;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new jq(a.window,a.fontSize,b,c.width,c.height)}return new jq(a.window,a.fontSize,b)}
function Ys(a){var b=Xs(a),c;a:switch(a.X){case "singlePage":c=!1;break a;case "spread":c=!0;break a;default:c=1.45<=b.width/b.height&&800<b.width}var d=a.Y.pb!==c;a.Y.pb=c;a.pd.setAttribute("data-vivliostyle-spread-view",c);if(a.C||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;if(!d&&b.width==a.viewport.width&&b.height==a.viewport.height)return!0;if(d=a.b&&Ds(a.b)){a:{d=a.b.ac;for(c=0;c<d.length;c++){var e=d[c];if(e)for(var e=e.nb,f=0;f<e.length;f++){var g=e[f];if(g.F&&g.C){d=!0;break a}}}d=
!1}d=!d}return d?(a.viewport.width=b.width,a.viewport.height=b.height,a.Lb=!0):!1}p.qf=function(a,b,c,d){this.fa[d]=a;Zs(this,b,c,d)};function Zs(a,b,c,d){if(!a.V&&a.H&&!c&&!d){var e="";Object.keys(b).forEach(function(a){e+="@page "+a+"{size:";a=b[a];e+=a.width+"px "+a.height+"px;}"});a.H.textContent=e;a.V=!0}}
function $s(a){if(a.b){a.b.Yc();for(var b=a.b,c=b.ac,d=0;d<c.length;d++){var e=c[d];e&&e.nb.splice(0)}for(b=b.viewport.root;b.lastChild;)b.removeChild(b.lastChild)}a.H&&(a.H.textContent="",a.V=!1);a.viewport=Xs(a);b=a.viewport;v(b.g,"width","");v(b.g,"height","");v(b.f,"width","");v(b.f,"height","");v(b.f,"transform","");a.b=new ns(a.h,a.viewport,a.xa,a.Y,a.qf.bind(a))}
function Ps(a,b,c){a.Lb=!1;Rs(a);if(a.Y.pb)return ys(a.b,a.f,c).oa(function(c){Ss(a);a.j=c;c.left&&(Ts(a,c.left),c.right||c.left.K.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Ts(a,c.right),c.left||c.right.K.setAttribute("data-vivliostyle-unpaired-page",!0));c=at(a,c);a.viewport.zoom(c.width,c.height,a.F?bt(a,c):a.zoom);a.g=b;return L(null)});Us(a,b);a.viewport.zoom(b.f.width,b.f.height,a.F?bt(a,b.f):a.zoom);a.g=b;return L(null)}
function at(a,b){var c=0,d=0;b.left&&(c+=b.left.f.width,d=b.left.f.height);b.right&&(c+=b.right.f.width,d=Math.max(d,b.right.f.height));b.left&&b.right&&(c+=2*a.Y.jc);return{width:c,height:d}}var ct={Cf:"fit inside viewport"};function bt(a,b){return Math.min(a.viewport.width/b.width,a.viewport.height/b.height)}function dt(){this.name="RenderingCanceledError";this.message="Page rendering has been canceled";this.stack=Error().stack}t(dt,Error);
function Ls(a){if(a.l){var b=a.l;Rd(b,new dt);if(b!==Ld&&b.b){b.b.h=!0;var c=new ae(b);b.w="interrupt";b.b=c;b.f.eb(c)}}a.l=null}
function Ms(a){a.Ka=!1;a.Lb=!1;if(Ys(a))return L(!0);Is(a,"loading");Ls(a);var b=Td(Ld.f,function(){return Qd("resize",function(c){a.l=b;Js.f("render (resize)");$s(a);a.f&&(a.f.aa=-1);ws(a.b,a.f).then(function(d){a.f=d.position;Ps(a,d.page,!0).then(function(){Vs(a).then(function(d){Is(a,"interactive");(a.Pd?a.b.Pd():L(null)).then(function(){a.l===b&&(a.l=null);Js.b("render (resize)");Is(a,"complete");Hs(a,{t:"loaded"});O(c,d)})})})})},function(a,b){if(b instanceof dt)Js.b("render (resize)"),u.debug(b.message);
else throw b;})});return L(!0)}function Ws(a,b,c){var d=I("sendLocationNotification"),e={t:"nav",first:b.G,last:b.A};ls(a.h,a.f).then(function(b){e.epage=b;e.epageCount=a.h.F;c&&(e.cfi=c);Hs(a,e);O(d,!0)});return M(d)}Fs.prototype.Kb=function(){return this.b?this.b.Kb(this.f):null};
Fs.prototype.Ma=function(a){var b=this;"complete"!==this.A&&Is(this,"loading");if("string"==typeof a.where){switch(a.where){case "next":a=this.Y.pb?this.b.jf:this.b.nextPage;break;case "previous":a=this.Y.pb?this.b.mf:this.b.Nd;break;case "last":a=this.b.df;break;case "first":a=this.b.$e;break;default:return L(!0)}if(a){var c=a;a=function(){return c.call(b.b,b.f)}}}else if("number"==typeof a.epage){var d=a.epage;a=function(){return zs(b.b,d)}}else if("string"==typeof a.url){var e=a.url;a=function(){return Bs(b.b,
...
Fs.prototype.ed=function(a){var b=!!a.autohide;a=a.v;var c=this.b.ie();if(c){if("show"==a)return L(!0)}else if("hide"==a)return L(!0);if(c)return this.b.Yc(),L(!0);var d=this,e=I("showTOC");this.b.ed(b).then(function(a){if(a){if(b){var c=function(){d.b.Yc()};a.addEventListener("hyperlink",c,!1);a.K.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.G,!1)}O(e,!0)});return M(e)};
function et(a,b){var c=b.a||"";return Qd("runCommand",function(d){var e=a.ta[c];e?e.call(a,b).then(function(){Hs(a,{t:"done",a:c});O(d,!0)}):(u.error("No such action:",c),O(d,!0))},function(a,b){u.error(b,"Error during action:",c);O(a,!0)})}function ft(a){return"string"==typeof a?JSON.parse(a):a}
function gt(a,b){var c=ft(b),d=null;Sd(function(){var b=I("commandLoop"),f=Ld.f;a.G=function(b){var c="#"===b.href.charAt(0)||a.O.some(function(a){return b.href.substr(0,a.length)==a});if(c){b.preventDefault();var d={t:"hyperlink",href:b.href,internal:c};Td(f,function(){Hs(a,d);return L(!0)})}};he(function(b){if(a.Ka)Ms(a).then(function(){P(b)});else if(a.Lb)a.g&&Ps(a,a.g).then(function(){P(b)});else if(c){var e=c;c=null;et(a,e).then(function(){P(b)})}else e=I("waitForCommand"),d=$d(e,self),M(e).then(function(){P(b)})}).Fa(b);
return M(b)});a.J=function(){var a=d;a&&(d=null,a.eb())};a.w=function(b){if(c)return!1;c=ft(b);a.J();return!0};a.window.adapt_command=a.w};function bq(a,b,c){if(a==b)return a?[[0,a]]:[];if(0>c||a.length<c)c=null;var d=ht(a,b),e=a.substring(0,d);a=a.substring(d);b=b.substring(d);var d=it(a,b),f=a.substring(a.length-d);a=a.substring(0,a.length-d);b=b.substring(0,b.length-d);a=jt(a,b);e&&a.unshift([0,e]);f&&a.push([0,f]);kt(a);null!=c&&(a=lt(a,c));return a}
...
0;for(var l=c-d,k=!!(l%2),m=0,n=0,r=0,q=0,z=0;z<e;z++){for(var y=-z+m;y<=z-n;y+=2){var A=e+y,H;H=y==-z||y!=z&&g[A-1]<g[A+1]?g[A+1]:g[A-1]+1;for(var G=H-y;H<c&&G<d&&a.charAt(H)==b.charAt(G);)H++,G++;g[A]=H;if(H>c)n+=2;else if(G>d)m+=2;else if(k&&(A=e+l-y,0<=A&&A<f&&-1!=h[A])){var J=c-h[A];if(H>=J){c=nt(a,b,H,G);break a}}}for(y=-z+r;y<=z-q;y+=2){A=e+y;J=y==-z||y!=z&&h[A-1]<h[A+1]?h[A+1]:h[A-1]+1;for(H=J-y;J<c&&H<d&&a.charAt(c-J-1)==b.charAt(d-H-1);)J++,H++;h[A]=J;if(J>c)q+=2;else if(H>d)r+=2;else if(!k&&
(A=e+l-y,0<=A&&A<f&&-1!=g[A]&&(H=g[A],G=e+H-A,J=c-J,H>=J))){c=nt(a,b,H,G);break a}}}c=[[-1,a],[1,b]]}return c}function nt(a,b,c,d){var e=a.substring(c),f=b.substring(d);a=bq(a.substring(0,c),b.substring(0,d));e=bq(e,f);return a.concat(e)}function ht(a,b){if(!a||!b||a.charAt(0)!=b.charAt(0))return 0;for(var c=0,d=Math.min(a.length,b.length),e=d,f=0;c<e;)a.substring(f,e)==b.substring(f,e)?f=c=e:d=e,e=Math.floor((d-c)/2+c);return e}
...
function mt(a,b){function c(a,b,c){for(var d=a.substring(c,c+Math.floor(a.length/4)),e=-1,f="",g,h,k,l;-1!=(e=b.indexOf(d,e+1));){var m=ht(a.substring(c),b.substring(e)),J=it(a.substring(0,c),b.substring(0,e));f.length<J+m&&(f=b.substring(e-J,e)+b.substring(e,e+m),g=a.substring(0,c-J),h=a.substring(c+m),k=b.substring(0,e-J),l=b.substring(e+m))}return 2*f.length>=a.length?[g,h,k,l,f]:null}var d=a.length>b.length?a:b,e=a.length>b.length?b:a;if(4>d.length||2*e.length<d.length)return null;var f=c(d,e,
...
e[1]],[0,e[1]]),e=f[1].slice(e[1].length),0<e.length&&d.splice(c+2,0,[f[0],e]),ot(d,c,3)):a}function ot(a,b,c){for(c=b+c-1;0<=c&&c>=b-1;c--)if(c+1<a.length){var d=a[c],e=a[c+1];d[0]===e[1]&&a.splice(c,2,[d[0],d[1]+e[1]])}return a};function aq(a){return a.reduce(function(a,c){return c[0]===bq.b?a:a+c[1]},"")}function sk(a,b,c){var d=0,e=0;a.some(function(a){for(var f=0;f<a[1].length;f++){switch(a[0]*c){case bq.f:d++;break;case bq.b:d--;e++;break;case bq.g:e++}if(e>b)return!0}return!1});return Math.max(Math.min(b,e-1)+d,0)};function pt(){}pt.prototype.Ge=function(a){return{B:a,Sc:!1,Fb:!1}};pt.prototype.Se=function(){};pt.prototype.oe=function(){};pt.prototype.uc=function(){};function qt(a,b){this.b=a;this.f=b}
function rt(a,b){var c=a.b,d=c.Ge(b),e=I("LayoutIterator");he(function(a){for(var b;d.B;){b=d.B.D?1!==d.B.D.nodeType?Zj(d.B.D,d.B.Tb)?void 0:d.B.M?void 0:c.Se(d):d.B.Da?void 0:d.B.M?c.uc(d):c.oe(d):void 0;b=(b&&b.za()?b:L(!0)).oa(function(){return d.Fb?L(null):gn(this.f,d.B,d.Sc)}.bind(this));if(b.za()){b.then(function(b){d.Fb?Q(a):(d.B=b,P(a))});return}if(d.Fb){Q(a);return}d.B=b.get()}Q(a)}.bind(a)).then(function(){O(e,d.B)});return M(e)}function st(a){this.$c=a}t(st,pt);p=st.prototype;p.Te=function(){};
p.ze=function(){};p.Ge=function(a){return{B:a,Sc:!!this.$c&&a.M,Fb:!1,$c:this.$c,wc:null,Id:!1,Le:[],Ke:null}};p.Se=function(a){a.Id=!1};p.oe=function(a){a.Le.push(kk(a.B));a.wc=al(a.wc,a.B.g);a.Id=!0;return this.Te(a)};p.uc=function(a){var b;a.Id?(b=(b=void 0,L(!0)),b=b.oa(function(){a.Fb||(a.Le=[],a.$c=!1,a.Sc=!1,a.wc=null);return L(!0)})):b=(b=this.ze(a))&&b.za()?b:L(!0);return b.oa(function(){a.Fb||(a.Id=!1,a.Ke=kk(a.B),a.wc=al(a.wc,a.B.F));return L(!0)})};
function tt(a,b,c){this.ne=[];this.b=Object.create(a);this.b.element=b;this.b.h=a.h.clone();this.b.l=!1;this.b.Vd=c.L;a=Xn(this.b,c);this.b.F-=a;var d=this;this.b.vb=function(a){return Xm.prototype.vb.call(this,a).oa(function(a){var b=kk(a);d.ne.push(b);return L(a)})}}tt.prototype.Jb=function(a){var b=this.b.Jb();if(a){a=b.Uc?b.Uc.b():Number.MAX_VALUE;var c=this.ne[0],c=new Rm(kk(c),null,c.b,0),d=c.f(this.b,a);if(d&&c.b()<a)return{Uc:c,B:d}}return b};
function ut(a){this.u=a;this.b=this.f=null;this.A=[];this.w=[];this.C=this.F=0;this.g=this.h=!1;this.l=this.j=!0}function vt(a,b,c){b=Xj(c,b);return a.u?b.width:b.height}function wt(a){a.h=a.g=!1;a.A=[];a.w=[];a.j=!0;a.l=!0}function Sm(a){return(a.g?0:a.C)-(a.h?a.F:0)}function xt(a){a.A.forEach(function(a){a.parentNode.removeChild(a)});a.A=[]}function yt(a){a.w.forEach(function(a){a.parentNode.removeChild(a)});a.w=[]};function zt(a,b){this.g(a,"end",b)}function At(a,b){this.g(a,"start",b)}function Bt(a,b,c){c||(c=this.j.now());var d=this.h[a];d||(d=this.h[a]=[]);var e;for(a=d.length-1;0<=a&&(!(e=d[a])||e[b]);a--)e=null;e||(e={},d.push(e));e[b]=c}function Ct(){}function Dt(a){this.j=a;this.h={};this.registerEndTiming=this.b=this.registerStartTiming=this.f=this.g=Ct}
Dt.prototype.l=function(){var a=this.h,b="";Object.keys(a).forEach(function(c){for(var d=a[c],e=d.length,f=0;f<e;f++){var g=d[f];b+=c;1<e&&(b+="("+f+")");b+=" => start: "+g.start+", end: "+g.end+", duration: "+(g.end-g.start)+"\n"}});u.g(b)};Dt.prototype.w=function(){this.registerEndTiming=this.b=this.registerStartTiming=this.f=this.g=Ct};Dt.prototype.A=function(){this.g=Bt;this.registerStartTiming=this.f=At;this.registerEndTiming=this.b=zt};
var Et={now:Date.now},Js,Ft=Js=new Dt(window&&window.performance||Et);Bt.call(Ft,"load_vivliostyle","start",void 0);ba("vivliostyle.profile.profiler",Ft);Dt.prototype.printTimings=Dt.prototype.l;Dt.prototype.disable=Dt.prototype.w;Dt.prototype.enable=Dt.prototype.A;function Gt(a,b,c){var d=a.B,e=d.display,f=d.parent?d.parent.display:null;return"table-row"===e&&!Ht(f)&&"table"!==f&&"inline-table"!==f||"table-cell"===e&&"table-row"!==f&&!Ht(f)&&"table"!==f&&"inline-table"!==f||d.L instanceof It&&d.L!==b?kn(c,d).oa(function(b){a.B=b;return L(!0)}):null}function Ht(a){return"table-row-group"===a||"table-header-group"===a||"table-footer-group"===a}function Jt(a,b){this.rowIndex=a;this.S=b;this.b=[]}
function Kt(a){return Math.min.apply(null,a.b.map(function(a){return a.height}))}function Lt(a,b,c){this.rowIndex=a;this.h=b;this.g=c;this.b=c.colSpan||1;this.rowSpan=c.rowSpan||1;this.height=0;this.f=null}function Mt(a,b,c){this.rowIndex=a;this.b=b;this.xc=c}function Nt(a,b,c){this.g=a;this.b=c;this.bd=new tt(a,b,c);this.f=!1}Nt.prototype.Jb=function(){var a=this.b.D,b=this.b.O;"middle"!==b&&"bottom"!==b||v(a,"vertical-align","top");var c=this.bd.Jb(!0);v(a,"vertical-align",b);return c};
function Ot(a,b){this.D=a;this.b=b}function Pt(a,b,c,d){Rm.call(this,a,b,c,d);this.L=a.L;this.rowIndex=this.j=null}t(Pt,Rm);Pt.prototype.f=function(a,b){var c=Rm.prototype.f.call(this,a,b);return b<this.b()?null:Qt(this).every(function(a){return!!a.B})?c:null};Pt.prototype.b=function(){var a=Rm.prototype.b.call(this);Qt(this).forEach(function(b){a+=b.Uc.b()});return a};function Qt(a){a.j||(a.j=Rt(a).map(function(a){return a.Jb()}));return a.j}
function Rt(a){return St(a.L,null!=a.rowIndex?a.rowIndex:a.rowIndex=Tt(a.L,a.position.S)).map(a.L.ee,a.L)}function Ut(a,b,c){this.rowIndex=a;this.j=b;this.L=c;this.h=null}t(Ut,Nm);Ut.prototype.f=function(a,b){if(b<this.b())return null;var c=Vt(this),d=Wt(this);return d.every(function(a){return!!a.B})&&d.some(function(a,b){var d=a.B,e=c[b].bd.ne[0];return!(e.D===d.D&&e.M===d.M&&e.ia===d.ia)})?this.j:null};
Ut.prototype.b=function(){var a=this.L,b=0;Xt(a,a.f[this.rowIndex])||(b+=10);Wt(this).forEach(function(a){b+=a.Uc.b()});return b};function Wt(a){a.h||(a.h=Vt(a).map(function(a){return a.Jb()}));return a.h}Ut.prototype.g=function(){return Om(this.j)};function Vt(a){return Yt(a.L,a.rowIndex).map(a.L.ee,a.L)}function It(a,b){this.parent=a;this.j=b;this.u=this.G=!1;this.w=-1;this.J=0;this.C=[];this.F=this.l=null;this.O=0;this.f=[];this.H=[];this.h=[];this.A=null;this.b=[];this.g=null}p=It.prototype;
p.se=function(){return"Table formatting context (vivliostyle.table.TableFormattingContext)"};p.Ie=function(a,b){if(!b)return b;switch(a.display){case "table-row":return!this.b.length;case "table-cell":return!this.b.some(function(b){return b.$d.na[0].node===a.S});default:return b}};p.te=function(){return this.parent};function Zt(a,b){do if(b.S===a.j)return b.D;while(b=b.parent);return null}function $t(a,b){var c=a.H[b];c||(c=a.H[b]=[]);return c}
function Tt(a,b){return a.f.findIndex(function(a){return b===a.S})}function Yt(a,b){return $t(a,b).reduce(function(a,b){return b.xc!==a[a.length-1]?a.concat(b.xc):a},[])}function St(a,b){return Yt(a,b).filter(function(a){return a.rowIndex+a.rowSpan-1>b})}p.ee=function(a){return this.h[a.rowIndex][a.h]};function Xt(a,b){return Kt(b)>a.J/2}function au(a){0>a.w&&(a.w=Math.max.apply(null,a.f.map(function(a){return a.b.reduce(function(a,b){return a+b.b},0)})));return a.w}
function bu(a,b){a.f.forEach(function(a){a.b.forEach(function(a){var c=Xj(b,a.g);a.g=null;a.height=this.u?c.width:c.height},this)},a)}p.ec=function(){return this.g};function cu(a,b){this.L=a;this.h=b;this.rowIndex=-1;this.f=0;this.g=!1}t(cu,pt);
cu.prototype.oe=function(a){var b=this.L,c=Gt(a,b,this.h);if(c)return c;a=a.B;switch(a.display){case "table":b.O=a.Z;break;case "table-caption":b.C.push(new Ot(a.D,a.X));break;case "table-header-group":this.b=!0;b=b.g;b.f||(b.f=a.D);break;case "table-footer-group":this.b=!0;b=b.g;b.b||(b.b=a.D);break;case "table-row":this.b||(this.g=!0,this.rowIndex++,this.f=0,b.f[this.rowIndex]=new Jt(this.rowIndex,a.S))}return L(!0)};
cu.prototype.uc=function(a){var b=this.L,c=a.B,d=c.display,e=this.h.b;if(c.S===b.j)c=qn(e,Zt(b,c)),b.J=parseFloat(c[b.u?"height":"width"]),a.Fb=!0;else switch(d){case "table-header-group":case "table-footer-group":this.b=!1;break;case "table-row":this.b||(b.A=c.D,this.g=!1);break;case "table-cell":if(!this.b){this.g||(this.rowIndex++,this.f=0,this.g=!0);a=this.rowIndex;c=new Lt(this.rowIndex,this.f,c.D);d=b.f[a];d||(b.f[a]=new Jt(a,null),d=b.f[a]);d.b.push(c);for(var d=a+c.rowSpan,e=$t(b,a),f=0;e[f];)f++;
for(;a<d;a++)for(var e=$t(b,a),g=f;g<f+c.b;g++){var h=e[g]=new Mt(a,g,c);c.f||(c.f=h)}this.f++}}};function du(a,b){this.$c=!0;this.L=a;this.f=b;this.l=!1;this.b=-1;this.g=0;this.w=b.l;b.l=!1}t(du,st);var eu={"table-caption":!0,"table-column-group":!0,"table-column":!0,"table-header-group":!0,"table-footer-group":!0};
function fu(a,b,c,d){var e=b.rowIndex,f=b.h,g=c.D;if(1<b.b){v(g,"box-sizing","border-box");for(var h=a.L.F,l=0,k=0;k<b.b;k++)l+=h[b.f.b+k];l+=a.L.O*(b.b-1);v(g,a.L.u?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new Nt(a.f,b,c);a=a.L;(g=a.h[e])||(g=a.h[e]=[]);g[f]=c;1===d.Ba.na.length&&d.Ba.M&&(c.f=!0);return zn(c.bd.b,d,!0).nd(!0)}function gu(a,b){var c=a.L.b[0];return c?c.xc.f.b===b:!1}
function hu(a){var b=a.L.b;if(!b.length)return[];var c=[],d=0;do{var e=b[d],f=e.xc.rowIndex;if(f<a.b){var g=c[f];g||(g=c[f]=[]);g.push(e);b.splice(d,1)}else d++}while(d<b.length);return c}
function iu(a,b){var c=a.L,d=hu(a),e=d.reduce(function(a){return a+1},0);if(0===e)return L(!0);var f=a.f.h,g=b.B;g.D.parentNode.removeChild(g.D);var h=I("layoutRowSpanningCellsFromPreviousFragment"),l=L(!0),k=0,m=[];d.forEach(function(a){l=l.oa(function(){var b=ik(a[0].$d.na[1],g.parent);return an(f,b,!1).oa(function(){function d(a){for(;h<a;){if(!(0<=m.indexOf(h))){var c=b.D.ownerDocument.createElement("td");v(c,"padding","0");b.D.appendChild(c)}h++}}var g=L(!0),h=0;a.forEach(function(a){g=g.oa(function(){var c=
a.xc;d(c.f.b);var g=a.$d,l=ik(g.na[0],b);l.ia=g.ia;l.M=g.M;return an(f,l,!1).oa(function(){for(var b=a.ve,d=0;d<c.b;d++)m.push(h+d);h+=c.b;return fu(this,c,l,b).oa(function(){l.D.rowSpan=c.rowIndex+c.rowSpan-this.b+e-k;return L(!0)}.bind(this))}.bind(this))}.bind(this))},this);return g.oa(function(){d(au(c));k++;return L(!0)})}.bind(this))}.bind(this))},a);l.then(function(){an(f,g,!0,b.Sc).then(function(){O(h,!0)})});return M(h)}
function ju(a,b){if(a.j||a.h)return L(!0);var c=b.B,d=a.L;0>a.b?a.b=Tt(d,c.S):a.b++;a.g=0;a.l=!0;return iu(a,b).oa(function(){bo(this.f,b.Ke,null,!0,b.wc)&&!St(d,this.b-1).length&&(this.f.l=this.w,c.b=!0,b.Fb=!0);return L(!0)}.bind(a))}
function ku(a,b){if(a.j||a.h)return L(!0);var c=b.B;a.l||(0>a.b?a.b=0:a.b++,a.g=0,a.l=!0);var d=a.L.f[a.b].b[a.g],e=kk(c).modify();e.M=!0;b.B=e;var f=I("startTableCell");gu(a,d.f.b)?(e=a.L.b.shift(),e=L(e.ve)):e=gn(a.f.h,c,b.Sc).oa(function(a){a.D&&c.D.removeChild(a.D);return L(new vk(gk(a)))});e.then(function(a){fu(this,d,c,a).then(function(){this.uc(b);this.g++;O(f,!0)}.bind(this))}.bind(a));return M(f)}
du.prototype.Te=function(a){var b=Gt(a,this.L,this.f);if(b)return b;b=a.B.display;return"table-header-group"===b?(this.j=!0,L(!0)):"table-footer-group"===b?(this.h=!0,L(!0)):"table-row"===b?ju(this,a):"table-cell"===b?ku(this,a):L(!0)};du.prototype.ze=function(a){a=a.B;"table-row"===a.display&&(this.l=!1,this.j||this.h||(a=kk(a).modify(),a.M=!1,this.f.C.push(new Ut(this.b,a,this.L))));return L(!0)};
du.prototype.uc=function(a){var b=a.B,c=b.display;"table-header-group"===c?this.j=!1:"table-footer-group"===c&&(this.h=!1);if(c&&eu[c])b.D.parentNode.removeChild(b.D);else if(b.S===this.L.j)this.f.l=this.w,a.Fb=!0;else return st.prototype.uc.call(this,a);return L(!0)};function lu(){}
function mu(a,b,c,d){for(var e=a.ownerDocument,f=e.createElement("tr"),g=[],h=0;h<b;h++){var l=e.createElement("td");f.appendChild(l);g.push(l)}a.parentNode.insertBefore(f,a.nextSibling);b=g.map(function(a){a=Xj(d,a);return c?a.height:a.width});a.parentNode.removeChild(f);return b}function nu(a){var b=[];for(a=a.firstElementChild;a;)"colgroup"===a.localName&&b.push(a),a=a.nextElementSibling;return b}
function ou(a){var b=[];a.forEach(function(a){var c=a.span;a.removeAttribute("span");for(var e=a.firstElementChild;e;){if("col"===e.localName){var f=e.span;e.removeAttribute("span");for(c-=f;1<f--;){var g=e.cloneNode(!0);a.insertBefore(g,e);b.push(g)}b.push(e)}e=e.nextElementSibling}for(;0<c--;)e=a.ownerDocument.createElement("col"),a.appendChild(e),b.push(e)});return b}
function pu(a,b,c,d){if(a.length<c){var e=d.ownerDocument.createElement("colgroup");b.push(e);for(b=a.length;b<c;b++){var f=d.ownerDocument.createElement("col");e.appendChild(f);a.push(f)}}}function qu(a,b,c){var d=a.u,e=a.A;if(e){a.A=null;var f=e.ownerDocument.createDocumentFragment(),g=au(a);if(0<g){var h=a.F=mu(e,g,d,c.b);c=nu(b);e=ou(c);pu(e,c,g,b);e.forEach(function(a,b){v(a,d?"height":"width",h[b]+"px")});c.forEach(function(a){f.appendChild(a.cloneNode(!0))})}a.l=f}}
function ru(a,b,c){var d=b.L;d.u=b.u;d.g=new ut(d.u);var e=I("TableLayoutProcessor.doInitialLayout");rt(new qt(new cu(b.L,c),c.h),b).then(function(a){var b=a.D,f=Xj(c.b,b);Tm(c,c.u?f.left:f.bottom)?(qu(d,b,c),bu(d,c.b),a=d.g,b=c.b,a.f&&(a.F=vt(a,a.f,b)),a.b&&(a.C=vt(a,a.b,b)),O(e,null)):O(e,a)}.bind(a));return M(e)}function su(a,b,c){var d=a.C;d.forEach(function(a,f){a&&(b.insertBefore(a.D,c),"top"===a.b&&(d[f]=null))})}
function tu(a,b){if(a.l&&b){var c=nu(b);c&&c.forEach(function(a){b.removeChild(a)})}}lu.prototype.f=function(a,b){var c=a.L,d=I("TableLayoutProcessor.layout"),e=uu(a,c),f=kk(a),g=[].concat(c.b),h=[].concat(b.C);e.g(this,a,b).then(function(l){var k=e.f(l,c,b);e.b(l,c,k);if(k)O(d,l);else{for(l=f.D||f.parent.D;k=l.lastChild;)l.removeChild(k);for(;k=l.nextSibling;)k.parentNode.removeChild(k);tu(c,Zt(c,f));b.C=h;c.h=[];c.b=g;this.f(a,b).Fa(d)}}.bind(this));return M(d)};
lu.prototype.g=function(a,b,c,d){return new Pt(a,b,c,d)};
lu.prototype.b=function(a,b){var c=b.L,d=c.g;d.j||b.S===c.j&&b.M||yt(d);if("table-row"===b.display){var e=Tt(c,b.S);c.b=[];var f;f=b.M?St(c,e):Yt(c,e);if(f.length){var g=I("TableLayoutProcessor.finishBreak"),h=0;he(function(a){if(h===f.length)Q(a);else{var b=f[h++],d=c.ee(b),g=d.Jb().B,l=d.b,q=rk(l),z=new vk(rk(g));c.b.push({$d:q,ve:z,xc:b});l=l.D;jo(d.b);e<b.rowIndex+b.rowSpan-1&&(l.rowSpan=e-b.rowIndex+1);d.f?P(a):Rn(d.bd.b,g,!1,!0).then(function(){var b=c.ec();if(b){var e=c.u,f=d.g,g=d.bd.b.element,
h=d.b.D,k=Xj(f.b,h),h=rn(f,h);e?v(g,"max-width",k.right-f.F-Sm(b)-h.right+"px"):v(g,"max-height",f.F-Sm(b)-k.top-h.top+"px");v(g,"overflow","hidden")}P(a)})}}).then(function(){d&&wt(d);c.h=[];go(b,!1);jo(b);O(g,!0)});return M(g)}}d&&wt(d);c.h=[];return null};function uu(a,b){if(b.G){var c=b.ec();a.S===b.j&&!a.M&&c&&(c.h=!1,c.l=!1);return new vu}return new wu}function wu(){}wu.prototype.g=function(a,b,c){return ru(a,b,c)};wu.prototype.f=function(a){return!!a};wu.prototype.b=function(a,b){b.G=!0};
function vu(){}vu.prototype.g=function(a,b,c){a=b.L;var d=a.g,e=Zt(a,b),f=e.firstChild;su(a,e,f);a.l&&e.insertBefore(a.l.cloneNode(!0),f);if(d.f&&!d.h){var g=d.f.cloneNode(!0);d.A.push(g);e.insertBefore(g,f)}d.b&&!d.g&&(g=d.b.cloneNode(!0),d.w.push(g),e.insertBefore(g,f));a=new du(a,c);c=new qt(a,c.h);a=I("TableFormattingContext.doLayout");rt(c,b).Fa(a);return M(a)};
vu.prototype.f=function(a,b,c){var d=b.ec();if(!d)return!0;c=c.Jb();return a.S===b.j&&a.M&&d.g?(d.g=!1,d.j=!1):!d.g&&d.j&&d.b||!d.h&&d.l&&d.f?!!c.B&&!c.B.b:!0};vu.prototype.b=function(a,b,c){(a=b.ec())&&!c&&(xt(a),yt(a),!a.g&&a.j&&a.b?a.g=!0:!a.h&&a.l&&a.f&&(a.h=!0))};var xu=new lu;Kd("RESOLVE_FORMATTING_CONTEXT",function(a,b,c){return b?c===td?(b=a.parent,new It(b?b.L:null,a.S)):null:null});Kd("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof It?xu:null});Array.from||(Array.from=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e],e):a[e];return c});
...
Object.assign||(Object.assign=function(a,b){if(!b)return a;Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function yu(a){function b(a){return"number"===typeof a?a:null}function c(a){return"string"===typeof a?{url:a,hb:null,$b:null}:{url:a.url,hb:b(a.startPage),$b:b(a.skipPagesBefore)}}return Array.isArray(a)?a.map(c):a?[c(a)]:null}function zu(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}
function Au(a,b){mj=a.debug;this.g=!1;this.h=a;this.Db=new Fs(a.window||window,a.viewportElement,"main",this.Ze.bind(this));this.f={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,pageViewMode:"autoSpread",zoom:1,fitToScreen:!1,defaultPaperSize:void 0};b&&this.Re(b);this.b=new Ta;Object.defineProperty(this,"readyState",{get:function(){return this.Db.A}})}p=Au.prototype;p.Re=function(a){var b=Object.assign({a:"configure"},zu(a));this.Db.w(b);Object.assign(this.f,a)};
p.Ze=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});Ua(this.b,b)};p.rf=function(a,b){this.b.addEventListener(a,b,!1)};p.uf=function(a,b){this.b.removeEventListener(a,b,!1)};p.ef=function(a,b,c){a||Ua(this.b,{type:"error",content:"No URL specified"});Bu(this,a,null,b,c)};p.sf=function(a,b,c){a||Ua(this.b,{type:"error",content:"No URL specified"});Bu(this,null,a,b,c)};
function Bu(a,b,c,d,e){function f(a){if(a)return a.map(function(a){return{url:a.url||null,text:a.text||null}})}d=d||{};var g=f(d.authorStyleSheet),h=f(d.userStyleSheet);e&&Object.assign(a.f,e);b=Object.assign({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.h.userAgentRootURL,url:yu(b)||c,document:d.documentObject,fragment:d.fragment,authorStyleSheet:g,userStyleSheet:h},zu(a.f));a.g?a.Db.w(b):(a.g=!0,gt(a.Db,b))}p.Kb=function(){return this.Db.Kb()};
p.gf=function(a){a:switch(a){case "left":a="ltr"===this.Kb()?"previous":"next";break a;case "right":a="ltr"===this.Kb()?"next":"previous"}this.Db.w({a:"moveTo",where:a})};p.ff=function(a){this.Db.w({a:"moveTo",url:a})};p.tf=function(a){a:{var b=this.Db;if(!b.g)throw Error("no page exists.");switch(a){case "fit inside viewport":a=bt(b,b.Y.pb?at(b,b.j):b.g.f);break a;default:throw Error("unknown zoom type: "+a);}}return a};p.af=function(){return this.Db.fa};ba("vivliostyle.viewer.Viewer",Au);
Au.prototype.setOptions=Au.prototype.Re;Au.prototype.addListener=Au.prototype.rf;Au.prototype.removeListener=Au.prototype.uf;Au.prototype.loadDocument=Au.prototype.ef;Au.prototype.loadEPUB=Au.prototype.sf;Au.prototype.getCurrentPageProgression=Au.prototype.Kb;Au.prototype.navigateToPage=Au.prototype.gf;Au.prototype.navigateToInternalUrl=Au.prototype.ff;Au.prototype.queryZoomFactor=Au.prototype.tf;Au.prototype.getPageSizes=Au.prototype.af;ba("vivliostyle.viewer.ZoomType",ct);
ct.FIT_INSIDE_VIEWPORT="fit inside viewport";ba("vivliostyle.viewer.PageViewMode",Es);Es.SINGLE_PAGE="singlePage";Es.SPREAD="spread";Es.AUTO_SPREAD="autoSpread";Bt.call(Js,"load_vivliostyle","end",void 0);var Cu=16,Du="ltr";function Eu(a){window.adapt_command(a)}function Fu(){Eu({a:"moveTo",where:"ltr"===Du?"previous":"next"})}function Gu(){Eu({a:"moveTo",where:"ltr"===Du?"next":"previous"})}
function Hu(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)Eu({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)Eu({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)Eu({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)Eu({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)Gu(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)Fu(),a.preventDefault();else if("0"===b||"U+0030"===c)Eu({a:"configure",fontSize:Math.round(Cu)}),a.preventDefault();else if("t"===b||"U+0054"===c)Eu({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)Cu*=1.2,Eu({a:"configure",fontSize:Math.round(Cu)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)Cu/=1.2,Eu({a:"configure",
fontSize:Math.round(Cu)}),a.preventDefault()}
function Iu(a){switch(a.t){case "loaded":a=a.viewer;var b=Du=a.Kb();a.pd.setAttribute("data-vivliostyle-page-progression",b);a.pd.setAttribute("data-vivliostyle-spread-view",a.Y.pb);window.addEventListener("keydown",Hu,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Fu,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Gu,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(ra(location.href,Ha(a||"")));break;case "hyperlink":a.internal&&Eu({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+m+"; margin: 0; }",document.head.appendChild(g));gt(new Fs(window,k,"main",Iu),a)});
