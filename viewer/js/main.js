 ...
 *
 * Vivliostyle core 2016.4.1-pre.20160622060639
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
{K:"inline-size",L:"height"},{K:"block-size",L:"width"}]}},ga=ea(!0),ha=ea(!1),ja={"horizontal-tb":[{K:"line-left",L:"left"},{K:"line-right",L:"right"},{K:"over",L:"top"},{K:"under",L:"bottom"}],"vertical-rl":[{K:"line-left",L:"top"},{K:"line-right",L:"bottom"},{K:"over",L:"right"},{K:"under",L:"left"}],"vertical-lr":[{K:"line-left",L:"top"},{K:"line-right",L:"bottom"},{K:"over",L:"right"},{K:"under",L:"left"}]};var ka=!1,la={we:"ltr",xe:"rtl"};ba("vivliostyle.constants.PageProgression",la);la.LTR="ltr";la.RTL="rtl";var ma={Sd:"left",Td:"right"};ba("vivliostyle.constants.PageSide",ma);ma.LEFT="left";ma.RIGHT="right";function na(a){var b=a.error,c=b&&(b.frameTrace||b.stack);a=[].concat(a.messages);b&&(0<a.length&&(a=a.concat(["\n"])),a=a.concat([b.toString()]),c&&(a=a.concat(["\n"]).concat(c)));return a}function oa(a){a=Array.b(a);var b=null;a[0]instanceof Error&&(b=a.shift());return{error:b,messages:a}}function pa(a){function b(a){return function(b){return a.apply(c,b)}}var c=a||console;this.f=b(c.debug||c.log);this.h=b(c.info||c.log);this.j=b(c.warn||c.log);this.g=b(c.error||c.log);this.d={}}
...
hb.prototype.e=function(a){a.append("/");a.append(this.index.toString());if(this.id||this.Xa)a.append("["),this.id&&a.append(this.id),this.Xa&&(a.append(";s="),a.append(this.Xa)),a.append("]")};
hb.prototype.f=function(a){if(1!=a.fa.nodeType)throw Error("E_CFI_NOT_ELEMENT");var b=a.fa,c=b.children,d=c.length,e=Math.floor(this.index/2)-1;0>e||0==d?(c=b.firstChild,a.fa=c||b):(c=c[Math.min(e,d-1)],this.index&1&&((b=c.nextSibling)&&1!=b.nodeType?c=b:a.J=!0),a.fa=c);if(this.id&&(a.J||this.id!=bb(a.fa)))throw Error("E_CFI_ID_MISMATCH");a.Xa=this.Xa;return!0};function ib(a,b,c,d){this.offset=a;this.d=b;this.b=c;this.Xa=d}
ib.prototype.f=function(a){if(0<this.offset&&!a.J){for(var b=this.offset,c=a.fa;;){var d=c.nodeType;if(1==d)break;var e=c.nextSibling;if(3<=d&&5>=d){d=c.textContent.length;if(b<=d)break;if(!e){b=d;break}b-=d}if(!e){b=0;break}c=e}a.fa=c;a.offset=b}a.Xa=this.Xa;return!0};
ib.prototype.e=function(a){a.append(":");a.append(this.offset.toString());if(this.d||this.b||this.Xa){a.append("[");if(this.d||this.b)this.d&&a.append(this.d.replace(/[\[\]\(\),=;^]/g,cb)),a.append(","),this.b&&a.append(this.b.replace(/[\[\]\(\),=;^]/g,cb));this.Xa&&(a.append(";s="),a.append(this.Xa));a.append("]")}};function jb(){this.ga=null}
...
function(){return this.pb()});fc(this,"pref-font-family",function(){return this.T.fontFamily});fc(this,"pref-night-mode",function(){return this.T.bd});fc(this,"pref-hyphenate",function(){return this.T.Vc});fc(this,"pref-margin",function(){return this.T.margin});fc(this,"pref-line-height",function(){return this.T.lineHeight});fc(this,"pref-column-width",function(){return this.T.Rc*this.fontSize});fc(this,"pref-horizontal",function(){return this.T.Uc});fc(this,"pref-spread-view",function(){return this.T.Ya})}}
...
function lc(a,b,c,d){this.za=b;this.hb=c;this.H=null;this.qb=function(){return this.H?this.H:this.T.Ya?Math.floor(b/2)-this.T.Mb:b};this.D=null;this.pb=function(){return this.D?this.D:c};this.j=d;this.S=null;this.fontSize=function(){return this.S?this.S:d};this.T=Yb;this.w={}}function mc(a,b){a.w[b.j]={};for(var c=0;c<b.children.length;c++)mc(a,b.children[c])}
function nc(a,b,c){return"vw"==b?a.qb()/100:"vh"==b?a.pb()/100:"em"==b||"rem"==b?c?a.j:a.fontSize():"ex"==b||"rex"==b?jc.ex*(c?a.j:a.fontSize())/jc.em:jc[b]}function oc(a,b,c){do{var d=b.values[c];if(d||b.h&&(d=b.h.call(a,c,!1)))return d;b=b.parent}while(b);throw Error("Name '"+c+"' is undefined");}
...
e}else if(null!=f&&null==c)return 0!==f;return!1}function rc(a){this.b=a;this.f="_"+dc++}n=rc.prototype;n.toString=function(){var a=new Ia;this.pa(a,0);return a.toString()};n.pa=function(){throw Error("F_ABSTRACT");};n.Pa=function(){throw Error("F_ABSTRACT");};n.Fa=function(){return this};n.Bb=function(a){return a===this};function sc(a,b,c,d){var e=d[a.f];if(null!=e)return e===Zb?!1:e;d[a.f]=Zb;b=a.Bb(b,c,d);return d[a.f]=b}
n.evaluate=function(a){var b;b=(b=a.w[this.b.j])?b[this.f]:void 0;if("undefined"!=typeof b)return b;b=this.Pa(a);var c=this.f,d=this.b,e=a.w[d.j];e||(e={},a.w[d.j]=e);return e[c]=b};n.yd=function(){return!1};function tc(a,b){rc.call(this,a);this.d=b}u(tc,rc);n=tc.prototype;n.rd=function(){throw Error("F_ABSTRACT");};n.wd=function(){throw Error("F_ABSTRACT");};n.Pa=function(a){a=this.d.evaluate(a);return this.wd(a)};n.Bb=function(a,b,c){return a===this||sc(this.d,a,b,c)};
n.pa=function(a,b){10<b&&a.append("(");a.append(this.rd());this.d.pa(a,10);10<b&&a.append(")")};n.Fa=function(a,b){var c=this.d.Fa(a,b);return c===this.d?this:new this.constructor(this.b,c)};function C(a,b,c){rc.call(this,a);this.d=b;this.e=c}u(C,rc);n=C.prototype;n.nc=function(){throw Error("F_ABSTRACT");};n.Da=function(){throw Error("F_ABSTRACT");};n.Va=function(){throw Error("F_ABSTRACT");};n.Pa=function(a){var b=this.d.evaluate(a);a=this.e.evaluate(a);return this.Va(b,a)};
n.Bb=function(a,b,c){return a===this||sc(this.d,a,b,c)||sc(this.e,a,b,c)};n.pa=function(a,b){var c=this.nc();c<=b&&a.append("(");this.d.pa(a,c);a.append(this.Da());this.e.pa(a,c);c<=b&&a.append(")")};n.Fa=function(a,b){var c=this.d.Fa(a,b),d=this.e.Fa(a,b);return c===this.d&&d===this.e?this:new this.constructor(this.b,c,d)};function uc(a,b,c){C.call(this,a,b,c)}u(uc,C);uc.prototype.nc=function(){return 1};function vc(a,b,c){C.call(this,a,b,c)}u(vc,C);vc.prototype.nc=function(){return 2};
function wc(a,b,c){C.call(this,a,b,c)}u(wc,C);wc.prototype.nc=function(){return 3};function xc(a,b,c){C.call(this,a,b,c)}u(xc,C);xc.prototype.nc=function(){return 4};function yc(a,b){tc.call(this,a,b)}u(yc,tc);yc.prototype.rd=function(){return"!"};yc.prototype.wd=function(a){return!a};function zc(a,b){tc.call(this,a,b)}u(zc,tc);zc.prototype.rd=function(){return"-"};zc.prototype.wd=function(a){return-a};function Ac(a,b,c){C.call(this,a,b,c)}u(Ac,uc);Ac.prototype.Da=function(){return"&&"};
...
Ec.prototype.Va=function(a,b){return a<b};function Fc(a,b,c){C.call(this,a,b,c)}u(Fc,vc);Fc.prototype.Da=function(){return"<="};Fc.prototype.Va=function(a,b){return a<=b};function Gc(a,b,c){C.call(this,a,b,c)}u(Gc,vc);Gc.prototype.Da=function(){return">"};Gc.prototype.Va=function(a,b){return a>b};function Hc(a,b,c){C.call(this,a,b,c)}u(Hc,vc);Hc.prototype.Da=function(){return">="};Hc.prototype.Va=function(a,b){return a>=b};function Ic(a,b,c){C.call(this,a,b,c)}u(Ic,vc);Ic.prototype.Da=function(){return"=="};
Ic.prototype.Va=function(a,b){return a==b};function Jc(a,b,c){C.call(this,a,b,c)}u(Jc,vc);Jc.prototype.Da=function(){return"!="};Jc.prototype.Va=function(a,b){return a!=b};function Kc(a,b,c){C.call(this,a,b,c)}u(Kc,wc);Kc.prototype.Da=function(){return"+"};Kc.prototype.Va=function(a,b){return a+b};function Lc(a,b,c){C.call(this,a,b,c)}u(Lc,wc);Lc.prototype.Da=function(){return" - "};Lc.prototype.Va=function(a,b){return a-b};function Mc(a,b,c){C.call(this,a,b,c)}u(Mc,xc);Mc.prototype.Da=function(){return"*"};
Mc.prototype.Va=function(a,b){return a*b};function Nc(a,b,c){C.call(this,a,b,c)}u(Nc,xc);Nc.prototype.Da=function(){return"/"};Nc.prototype.Va=function(a,b){return a/b};function Oc(a,b,c){C.call(this,a,b,c)}u(Oc,xc);Oc.prototype.Da=function(){return"%"};Oc.prototype.Va=function(a,b){return a%b};function Pc(a,b,c){rc.call(this,a);this.C=b;this.ha=c.toLowerCase()}u(Pc,rc);Pc.prototype.pa=function(a){a.append(this.C.toString());a.append(Ka(this.ha))};
Pc.prototype.Pa=function(a){return this.C*nc(a,this.ha,!1)};function Qc(a,b){rc.call(this,a);this.d=b}u(Qc,rc);Qc.prototype.pa=function(a){a.append(this.d)};Qc.prototype.Pa=function(a){return oc(a,this.b,this.d).evaluate(a)};Qc.prototype.Bb=function(a,b,c){return a===this||sc(oc(b,this.b,this.d),a,b,c)};function Rc(a,b,c){rc.call(this,a);this.d=b;this.name=c}u(Rc,rc);Rc.prototype.pa=function(a){this.d&&a.append("not ");a.append(Ka(this.name))};
Rc.prototype.Pa=function(a){var b=this.name;a="all"===b||!!a.T.vd[b];return this.d?!a:a};Rc.prototype.Bb=function(a,b,c){return a===this||sc(this.value,a,b,c)};Rc.prototype.yd=function(){return!0};function gc(a,b,c){rc.call(this,a);this.Kb=b;this.d=c}u(gc,rc);gc.prototype.pa=function(a){a.append(this.d)};gc.prototype.Pa=function(a){return this.Kb.call(a)};function Sc(a,b,c){rc.call(this,a);this.e=b;this.d=c}u(Sc,rc);
Sc.prototype.pa=function(a){a.append(this.e);var b=this.d;a.append("(");for(var c=0;c<b.length;c++)c&&a.append(","),b[c].pa(a,0);a.append(")")};Sc.prototype.Pa=function(a){return pc(a,this.b,this.e,this.d,!1).Fa(a,this.d).evaluate(a)};Sc.prototype.Bb=function(a,b,c){if(a===this)return!0;for(var d=0;d<this.d.length;d++)if(sc(this.d[d],a,b,c))return!0;return sc(pc(b,this.b,this.e,this.d,!0),a,b,c)};
...
Uc.prototype.Pa=function(a){return qc(a,this.name.name,this.value)};Uc.prototype.Bb=function(a,b,c){return a===this||sc(this.value,a,b,c)};Uc.prototype.Fa=function(a,b){var c=this.value.Fa(a,b);return c===this.value?this:new Uc(this.b,this.name,c)};function Vc(a,b){rc.call(this,a);this.index=b}u(Vc,rc);Vc.prototype.pa=function(a){a.append("$");a.append(this.index.toString())};Vc.prototype.Fa=function(a,b){var c=b[this.index];if(!c)throw Error("Parameter missing: "+this.index);return c};
function Wc(a,b,c){return b===a.f||b===a.b||c==a.f||c==a.b?a.f:b===a.g||b===a.d?c:c===a.g||c===a.d?b:new Ac(a,b,c)}function D(a,b,c){return b===a.b?c:c===a.b?b:new Kc(a,b,c)}function E(a,b,c){return b===a.b?new zc(a,c):c===a.b?b:new Lc(a,b,c)}function Xc(a,b,c){return b===a.b||c===a.b?a.b:b===a.d?c:c===a.d?b:new Mc(a,b,c)}function Yc(a,b,c){return b===a.b?a.b:c===a.d?b:new Nc(a,b,c)};var Zc={};function $c(){}n=$c.prototype;n.wb=function(a){for(var b=0;b<a.length;b++)a[b].U(this)};n.nd=function(){throw Error("E_CSS_EMPTY_NOT_ALLOWED");};n.od=function(){throw Error("E_CSS_SLASH_NOT_ALLOWED");};n.jc=function(){throw Error("E_CSS_STR_NOT_ALLOWED");};n.vb=function(){throw Error("E_CSS_IDENT_NOT_ALLOWED");};n.Tb=function(){throw Error("E_CSS_NUMERIC_NOT_ALLOWED");};n.Sb=function(){throw Error("E_CSS_NUM_NOT_ALLOWED");};n.Rb=function(a){return this.Sb(a)};
n.Jc=function(){throw Error("E_CSS_COLOR_NOT_ALLOWED");};n.kc=function(){throw Error("E_CSS_URL_NOT_ALLOWED");};n.gb=function(){throw Error("E_CSS_LIST_NOT_ALLOWED");};n.ub=function(){throw Error("E_CSS_COMMA_NOT_ALLOWED");};n.kb=function(){throw Error("E_CSS_FUNC_NOT_ALLOWED");};n.Qb=function(){throw Error("E_CSS_EXPR_NOT_ALLOWED");};function ad(){}u(ad,$c);n=ad.prototype;
n.wb=function(a){for(var b=null,c=0;c<a.length;c++){var d=a[c],e=d.U(this);if(b)b[c]=e;else if(d!==e){b=Array(a.length);for(d=0;d<c;d++)b[d]=a[d];b[c]=e}}return b||a};n.jc=function(a){return a};n.vb=function(a){return a};n.od=function(a){return a};n.Tb=function(a){return a};n.Sb=function(a){return a};n.Rb=function(a){return a};n.Jc=function(a){return a};n.kc=function(a){return a};n.gb=function(a){var b=this.wb(a.values);return b===a.values?a:new bd(b)};
n.ub=function(a){var b=this.wb(a.values);return b===a.values?a:new cd(b)};n.kb=function(a){var b=this.wb(a.values);return b===a.values?a:new dd(a.name,b)};n.Qb=function(a){return a};function ed(){}n=ed.prototype;n.toString=function(){var a=new Ia;this.Aa(a,!0);return a.toString()};n.stringValue=function(){var a=new Ia;this.Aa(a,!1);return a.toString()};n.ja=function(){throw Error("F_ABSTRACT");};n.Aa=function(a){a.append("[error]")};n.xd=function(){return!1};n.Zb=function(){return!1};n.zd=function(){return!1};
n.Md=function(){return!1};n.$c=function(){return!1};function fd(){if(G)throw Error("E_INVALID_CALL");}u(fd,ed);fd.prototype.ja=function(a){return new B(a,"")};fd.prototype.Aa=function(){};fd.prototype.U=function(a){return a.nd(this)};var G=new fd;function gd(){if(hd)throw Error("E_INVALID_CALL");}u(gd,ed);gd.prototype.ja=function(a){return new B(a,"/")};gd.prototype.Aa=function(a){a.append("/")};gd.prototype.U=function(a){return a.od(this)};var hd=new gd;function id(a){this.b=a}u(id,ed);
id.prototype.ja=function(a){return new B(a,this.b)};id.prototype.Aa=function(a,b){b?(a.append('"'),a.append(La(this.b)),a.append('"')):a.append(this.b)};id.prototype.U=function(a){return a.jc(this)};function jd(a){this.name=a;if(Zc[a])throw Error("E_INVALID_CALL");Zc[a]=this}u(jd,ed);jd.prototype.ja=function(a){return new B(a,this.name)};jd.prototype.Aa=function(a,b){b?a.append(Ka(this.name)):a.append(this.name)};jd.prototype.U=function(a){return a.vb(this)};jd.prototype.Md=function(){return!0};
function H(a){var b=Zc[a];b||(b=new jd(a));return b}function I(a,b){this.C=a;this.ha=b.toLowerCase()}u(I,ed);I.prototype.ja=function(a,b){return 0==this.C?a.b:b&&"%"==this.ha?100==this.C?b:new Mc(a,b,new B(a,this.C/100)):new Pc(a,this.C,this.ha)};I.prototype.Aa=function(a){a.append(this.C.toString());a.append(this.ha)};I.prototype.U=function(a){return a.Tb(this)};I.prototype.Zb=function(){return!0};function kd(a){this.C=a}u(kd,ed);
kd.prototype.ja=function(a){return 0==this.C?a.b:1==this.C?a.d:new B(a,this.C)};kd.prototype.Aa=function(a){a.append(this.C.toString())};kd.prototype.U=function(a){return a.Sb(this)};kd.prototype.zd=function(){return!0};function ld(a){this.C=a}u(ld,kd);ld.prototype.U=function(a){return a.Rb(this)};function md(a){this.b=a}u(md,ed);md.prototype.Aa=function(a){a.append("#");var b=this.b.toString(16);a.append("000000".substr(b.length));a.append(b)};md.prototype.U=function(a){return a.Jc(this)};
function nd(a){this.url=a}u(nd,ed);nd.prototype.Aa=function(a){a.append('url("');a.append(La(this.url));a.append('")')};nd.prototype.U=function(a){return a.kc(this)};function od(a,b,c,d){var e=b.length;b[0].Aa(a,d);for(var f=1;f<e;f++)a.append(c),b[f].Aa(a,d)}function bd(a){this.values=a}u(bd,ed);bd.prototype.Aa=function(a,b){od(a,this.values," ",b)};bd.prototype.U=function(a){return a.gb(this)};bd.prototype.$c=function(){return!0};function cd(a){this.values=a}u(cd,ed);
cd.prototype.Aa=function(a,b){od(a,this.values,",",b)};cd.prototype.U=function(a){return a.ub(this)};function dd(a,b){this.name=a;this.values=b}u(dd,ed);dd.prototype.Aa=function(a,b){a.append(Ka(this.name));a.append("(");od(a,this.values,",",b);a.append(")")};dd.prototype.U=function(a){return a.kb(this)};function J(a){this.d=a}u(J,ed);J.prototype.ja=function(){return this.d};J.prototype.Aa=function(a){a.append("-epubx-expr(");this.d.pa(a,0);a.append(")")};J.prototype.U=function(a){return a.Qb(this)};
J.prototype.xd=function(){return!0};function pd(a,b){if(a){if(a.Zb())return nc(b,a.ha,!1)*a.C;if(a.zd())return a.C}return 0}var qd=H("absolute"),rd=H("all"),sd=H("always"),td=H("auto");H("avoid");var ud=H("block"),vd=H("block-end"),wd=H("block-start"),xd=H("both"),yd=H("bottom"),zd=H("crop"),Ad=H("cross"),Bd=H("exclusive"),Cd=H("false"),Dd=H("fixed"),Ed=H("flex"),Fd=H("footnote");H("hidden");
...
l=k}f.b[l]=g}var l=c,m=l.d;l.d=null;m&&m.e==l&&(m.e=null,k=Re,Re=m,N(m.top,l.e),Re=k);b=a.e.currentTime();if(b>=a.h)break}}catch(p){v.error(p)}a.g=!1;a.d.length()&&cf(a)},b)}}$e.prototype.Wa=function(a,b){var c=this.e.currentTime();a.Q=this.Q++;a.b=c+(b||0);a:{for(var c=this.d,d=c.b.length;1<d;){var e=Math.floor(d/2),f=c.b[e];if(0<df(f,a)){c.b[d]=a;break a}c.b[d]=f;d=e}c.b[1]=a}cf(this)};
function Ze(a,b,c){var d=new ef(a,c||"");d.top=new Te(d,null,"bootstrap");d.top.b=Ue;d.top.then(function(){function a(){d.h=!1;for(var b=0;b<d.g.length;b++){var c=d.g[b];try{c()}catch(e){v.error(e)}}}try{b().then(function(b){d.f=b;a()})}catch(c){Xe(d,c),a()}});c=Re;Re=d;a.Wa(ff(d.top,"bootstrap"));Re=c;return d}function gf(a){this.d=a;this.Q=this.b=0;this.e=null}function df(a,b){return b.b-a.b||b.Q-a.Q}gf.prototype.Wa=function(a,b){this.e=a;this.d.d.Wa(this,b)};
function ef(a,b){this.d=a;this.name=b;this.g=[];this.b=null;this.h=!0;this.e=this.top=this.j=this.f=null}function hf(a,b){a.g.push(b)}ef.prototype.join=function(){var a=K("Task.join");if(this.h){var b=ff(a,this),c=this;hf(this,function(){b.Wa(c.f)})}else N(a,this.f);return M(a)};
function Xe(a,b,c){var d=b.frameTrace;if(!d){for(var d=b.stack?b.stack+"\n\t---- async ---\n":"",e=a.top;e;e=e.parent)d+="\t",d+=e.name,d+="\n";b.frameTrace=d}if(c){for(d=a.top;d&&d!=c;)d=d.parent;d==c&&(a.top=d)}for(a.b=b;a.top&&!a.top.g;)a.top=a.top.parent;a.top?(b=a.b,a.b=null,a.top.g(a.top,b)):a.b&&v.error(a.b,"Unhandled exception in task",a.name)}function Ve(a){this.value=a}n=Ve.prototype;n.then=function(a){a(this.value)};n.Hc=function(a){return a(this.value)};n.ld=function(a){return new Ve(a)};
n.ua=function(a){N(a,this.value)};n.Ca=function(){return!1};n.oc=function(){return this.value};function jf(a){this.b=a}n=jf.prototype;n.then=function(a){this.b.then(a)};n.Hc=function(a){if(this.Ca()){var b=new Te(this.b.d,this.b.parent,"AsyncResult.thenAsync");b.b=Ue;this.b.parent=b;this.b.then(function(c){a(c).then(function(a){N(b,a)})});return M(b)}return a(this.b.e)};n.ld=function(a){return this.Ca()?this.Hc(function(){return new Ve(a)}):new Ve(a)};
n.ua=function(a){this.Ca()?this.then(function(b){N(a,b)}):N(a,this.b.e)};n.Ca=function(){return this.b.b==Ue};n.oc=function(){if(this.Ca())throw Error("Result is pending");return this.b.e};function Te(a,b,c){this.d=a;this.parent=b;this.name=c;this.e=null;this.b=0;this.g=this.f=null}function kf(a){if(!Re)throw Error("F_TASK_NO_CONTEXT");if(a!==Re.top)throw Error("F_TASK_NOT_TOP_FRAME");}function M(a){return new jf(a)}
...
function lf(){var a=K("Frame.timeSlice"),b=a.d.d;b.e.currentTime()>=b.h?(v.debug("-- time slice --"),ff(a).Wa(!0)):N(a,!0);return M(a)}function mf(a){function b(d){try{for(;d;){var e=a();if(e.Ca()){e.then(b);return}e.then(function(a){d=a})}N(c,!0)}catch(f){Xe(c.d,f,c)}}var c=K("Frame.loop");b(!0);return M(c)}function nf(a){var b=Re;if(!b)throw Error("E_TASK_NO_CONTEXT");return mf(function(){var c;do c=new of(b,b.top),b.top=c,c.b=Ue,a(c),c=M(c);while(!c.Ca()&&c.oc());return c})}
function ff(a,b){kf(a);if(a.d.e)throw Error("E_TASK_ALREADY_SUSPENDED");var c=new gf(a.d);a.d.e=c;Re=null;a.d.j=b||null;return c}function of(a,b){Te.call(this,a,b,"loop")}u(of,Te);function pf(a){N(a,!0)}function O(a){N(a,!1)};function qf(a,b,c,d,e){var f=K("ajax"),g=new XMLHttpRequest,h=ff(f,g),l={status:0,url:a,contentType:null,responseText:null,responseXML:null,yc:null};g.open(c||"GET",a,!0);b&&(g.responseType=b);g.onreadystatechange=function(){if(4===g.readyState){l.status=g.status;if(200==l.status||0==l.status)if(b&&"document"!==b||!g.responseXML){var c=g.response;b&&"text"!==b||"string"!=typeof c?c?"string"==typeof c?l.yc=rf([c]):l.yc=c:v.b("Unexpected empty success response for",a):l.responseText=c;if(c=g.getResponseHeader("Content-Type"))l.contentType=
c.replace(/(.*);.*$/,"$1")}else l.responseXML=g.responseXML,l.contentType=g.responseXML.contentType;h.Wa(l)}};try{d?(g.setRequestHeader("Content-Type",e||"text/plain; charset=UTF-8"),g.send(d)):g.send(null)}catch(k){v.b(k,"Error fetching "+a),h.Wa(l)}return M(f)}function rf(a){var b=window.WebKitBlobBuilder||window.MSBlobBuilder;if(b){for(var b=new b,c=0;c<a.length;c++)b.append(a[c]);return b.getBlob("application/octet-stream")}return new Blob(a,{type:"application/octet-stream"})}
function sf(a){var b=K("readBlob"),c=new FileReader,d=ff(b,c);c.addEventListener("load",function(){d.Wa(c.result)},!1);c.readAsArrayBuffer(a);return M(b)}function tf(a,b){this.I=a;this.type=b;this.g={};this.e={}}tf.prototype.load=function(a,b,c){a=ta(a);var d=this.g[a];return"undefined"!=typeof d?L(d):uf(this.sc(a,b,c))};
function vf(a,b,c,d){var e=K("fetch");qf(b,a.type).then(function(f){if(c&&400<=f.status)throw Error(d||"Failed to fetch required resource: "+b);a.I(f,a).then(function(c){delete a.e[b];a.g[b]=c;N(e,c)})});return M(e)}tf.prototype.sc=function(a,b,c){a=ta(a);if(this.g[a])return null;var d=this.e[a];if(!d){var e=this,d=new wf(function(){return vf(e,a,b,c)},"Fetch "+a);e.e[a]=d;d.start()}return d};function xf(a){a=a.responseText;return L(a?JSON.parse(a):null)};function yf(a){var b=parseInt(a,16);if(isNaN(b))throw Error("E_CSS_COLOR");if(6==a.length)return new md(b);if(3==a.length)return new md(b&15|(b&15)<<4|(b&240)<<4|(b&240)<<8|(b&3840)<<8|(b&3840)<<12);throw Error("E_CSS_COLOR");}function zf(a){this.d=a;this.bb="Author"}n=zf.prototype;n.Xb=function(){return null};n.X=function(){return this.d};n.error=function(){};n.Pb=function(a){this.bb=a};n.ib=function(){};n.Qc=function(){};n.ac=function(){};n.bc=function(){};n.Wc=function(){};n.qc=function(){};
n.mb=function(){};n.Pc=function(){};n.Oc=function(){};n.Tc=function(){};n.Lb=function(){};n.fb=function(){};n.Cc=function(){};n.ec=function(){};n.Gc=function(){};n.Ac=function(){};n.Fc=function(){};n.Ob=function(){};n.kd=function(){};n.Eb=function(){};n.Bc=function(){};n.Ec=function(){};n.Dc=function(){};n.hc=function(){};n.gc=function(){};n.ra=function(){};n.cb=function(){};n.nb=function(){};n.fc=function(){};n.rc=function(){};
function Af(a){switch(a.bb){case "UA":return 0;case "User":return 100663296;default:return 83886080}}function Bf(a){switch(a.bb){case "UA":return 0;case "User":return 16777216;default:return 33554432}}function Cf(){zf.call(this,null);this.e=[];this.b=null}u(Cf,zf);function Df(a,b){a.e.push(a.b);a.b=b}n=Cf.prototype;n.Xb=function(){return null};n.X=function(){return this.b.X()};n.error=function(a,b){this.b.error(a,b)};
n.Pb=function(a){zf.prototype.Pb.call(this,a);0<this.e.length&&(this.b=this.e[0],this.e=[]);this.b.Pb(a)};n.ib=function(a,b){this.b.ib(a,b)};n.Qc=function(a){this.b.Qc(a)};n.ac=function(a,b){this.b.ac(a,b)};n.bc=function(a,b){this.b.bc(a,b)};n.Wc=function(a){this.b.Wc(a)};n.qc=function(a,b,c,d){this.b.qc(a,b,c,d)};n.mb=function(){this.b.mb()};n.Pc=function(){this.b.Pc()};n.Oc=function(){this.b.Oc()};n.Tc=function(){this.b.Tc()};n.Lb=function(){this.b.Lb()};n.fb=function(){this.b.fb()};n.Cc=function(){this.b.Cc()};
n.ec=function(a){this.b.ec(a)};n.Gc=function(){this.b.Gc()};n.Ac=function(){this.b.Ac()};n.Fc=function(){this.b.Fc()};n.Ob=function(){this.b.Ob()};n.kd=function(a){this.b.kd(a)};n.Eb=function(a){this.b.Eb(a)};n.Bc=function(a){this.b.Bc(a)};n.Ec=function(){this.b.Ec()};n.Dc=function(a,b,c){this.b.Dc(a,b,c)};n.hc=function(a,b,c){this.b.hc(a,b,c)};n.gc=function(a,b,c){this.b.gc(a,b,c)};n.ra=function(){this.b.ra()};n.cb=function(a,b,c){this.b.cb(a,b,c)};n.nb=function(){this.b.nb()};n.fc=function(a){this.b.fc(a)};
n.rc=function(){this.b.rc()};function Ef(a,b,c){zf.call(this,a);this.H=c;this.D=0;this.$=b}u(Ef,zf);Ef.prototype.Xb=function(){return this.$.Xb()};Ef.prototype.error=function(a){v.b(a)};Ef.prototype.ra=function(){this.D++};Ef.prototype.nb=function(){if(0==--this.D&&!this.H){var a=this.$;a.b=a.e.pop()}};function Ff(a,b,c){Ef.call(this,a,b,c)}u(Ff,Ef);function Gf(a,b){a.error(b,a.Xb())}function Hf(a,b){Gf(a,b);Df(a.$,new Ef(a.d,a.$,!1))}n=Ff.prototype;n.fb=function(){Hf(this,"E_CSS_UNEXPECTED_SELECTOR")};
n.Cc=function(){Hf(this,"E_CSS_UNEXPECTED_FONT_FACE")};n.ec=function(){Hf(this,"E_CSS_UNEXPECTED_FOOTNOTE")};n.Gc=function(){Hf(this,"E_CSS_UNEXPECTED_VIEWPORT")};n.Ac=function(){Hf(this,"E_CSS_UNEXPECTED_DEFINE")};n.Fc=function(){Hf(this,"E_CSS_UNEXPECTED_REGION")};n.Ob=function(){Hf(this,"E_CSS_UNEXPECTED_PAGE")};n.Eb=function(){Hf(this,"E_CSS_UNEXPECTED_WHEN")};n.Bc=function(){Hf(this,"E_CSS_UNEXPECTED_FLOW")};n.Ec=function(){Hf(this,"E_CSS_UNEXPECTED_PAGE_TEMPLATE")};n.Dc=function(){Hf(this,"E_CSS_UNEXPECTED_PAGE_MASTER")};
n.hc=function(){Hf(this,"E_CSS_UNEXPECTED_PARTITION")};n.gc=function(){Hf(this,"E_CSS_UNEXPECTED_PARTITION_GROUP")};n.fc=function(){Hf(this,"E_CSS_UNEXPECTED_SELECTOR_FUNC")};n.rc=function(){Hf(this,"E_CSS_UNEXPECTED_END_SELECTOR_FUNC")};n.cb=function(){this.error("E_CSS_UNEXPECTED_PROPERTY",this.Xb())};var If=[],Jf=[],P=[],Kf=[],Lf=[],Mf=[],Nf=[],Of=[],S=[],Pf=[],Qf=[],Rf=[],Sf=[];If[1]=28;If[36]=29;If[7]=29;If[9]=29;If[14]=29;If[18]=29;If[20]=30;If[13]=27;If[0]=200;Jf[1]=46;Jf[0]=200;Mf[1]=2;
...
g,f);break;case 19:f=new Nc(e.X(),g,f);break;case 21:f=new Oc(e.X(),g,f);break;case 18:if(1<d.length)switch(d[d.length-1]){case 22:d.pop();f=new Tc(e.X(),d.pop(),g,f);break;case 10:if(g.yd())f=new Uc(e.X(),g,f);else return Wf(a,"E_CSS_MEDIA_TEST",c),!1}else return Wf(a,"E_CSS_EXPR_COND",c),!1;break;case 22:if(18!=b)return Wf(a,"E_CSS_EXPR_COND",c),!1;case 10:return d.push(g),d.push(h),d.push(f),!1;default:return Wf(a,"F_UNEXPECTED_STATE",c),!1}}}d.push(f);return!1}
...
a.b=Nf;l.splice(0,l.length);continue;case 29:a.b=Mf;g.fb();continue;case 1:if(!k.b){a.b=Rf;g.error("E_CSS_SPACE_EXPECTED",k);continue}g.mb();case 2:if(34==z(h,1).type)if(A(h),A(h),p=a.I[k.text],null!=p)switch(k=y(h),k.type){case 1:g.ib(p,k.text);a.b=f?Kf:P;A(h);break;case 36:g.ib(p,null);a.b=f?Kf:P;A(h);break;default:a.b=Pf,g.error("E_CSS_NAMESPACE",k)}else a.b=Pf,g.error("E_CSS_UNDECLARED_PREFIX",k);else g.ib(a.D,k.text),a.b=f?Kf:P,A(h);continue;case 3:if(!k.b){a.b=Rf;g.error("E_CSS_SPACE_EXPECTED",
k);continue}g.mb();case 4:if(34==z(h,1).type)switch(A(h),A(h),k=y(h),k.type){case 1:g.ib(null,k.text);a.b=f?Kf:P;A(h);break;case 36:g.ib(null,null);a.b=f?Kf:P;A(h);break;default:a.b=Pf,g.error("E_CSS_NAMESPACE",k)}else g.ib(a.D,null),a.b=f?Kf:P,A(h);continue;case 5:k.b&&g.mb();case 6:g.Wc(k.text);a.b=f?Kf:P;A(h);continue;case 7:k.b&&g.mb();case 8:g.Qc(k.text);a.b=f?Kf:P;A(h);continue;case 55:k.b&&g.mb();case 14:A(h);k=y(h);b:switch(k.type){case 1:g.ac(k.text,null);A(h);a.b=f?Kf:P;continue;case 6:m=
k.text;A(h);switch(m){case "not":a.b=Mf;g.fc("not");bg(a,Number.POSITIVE_INFINITY,!1,!1,!1,!0)?a.b=P:a.b=Rf;break a;case "lang":case "href-epub-type":if(k=y(h),1===k.type){p=[k.text];A(h);break}else break b;case "nth-child":case "nth-of-type":case "nth-last-child":case "nth-last-of-type":if(p=Zf(a))break;else break b;default:p=Yf(a)}k=y(h);if(11==k.type){g.ac(m,p);A(h);a.b=f?Kf:P;continue}}g.error("E_CSS_PSEUDOCLASS_SYNTAX",k);a.b=Pf;continue;case 42:A(h);k=y(h);switch(k.type){case 1:g.bc(k.text,
null);a.b=f?Kf:P;A(h);continue;case 6:if(m=k.text,A(h),p=Yf(a),k=y(h),11==k.type){g.bc(m,p);a.b=f?Kf:P;A(h);continue}}g.error("E_CSS_PSEUDOELEM_SYNTAX",k);a.b=Pf;continue;case 9:k.b&&g.mb();case 10:A(h);k=y(h);if(1==k.type)m=k.text,A(h);else if(36==k.type)m=null,A(h);else if(34==k.type)m="";else{a.b=Rf;g.error("E_CSS_ATTR",k);A(h);continue}k=y(h);if(34==k.type){p=m?a.I[m]:m;if(null==p){a.b=Rf;g.error("E_CSS_UNDECLARED_PREFIX",k);A(h);continue}A(h);k=y(h);if(1!=k.type){a.b=Rf;g.error("E_CSS_ATTR_NAME_EXPECTED",
k);continue}m=k.text;A(h);k=y(h)}else p="";switch(k.type){case 39:case 45:case 44:case 43:case 42:case 46:case 50:r=k.type;A(h);k=y(h);break;case 15:g.qc(p,m,0,null);a.b=f?Kf:P;A(h);continue;default:a.b=Rf;g.error("E_CSS_ATTR_OP_EXPECTED",k);continue}switch(k.type){case 1:case 2:g.qc(p,m,r,k.text);A(h);k=y(h);break;default:a.b=Rf;g.error("E_CSS_ATTR_VAL_EXPECTED",k);continue}if(15!=k.type){a.b=Rf;g.error("E_CSS_ATTR",k);continue}a.b=f?Kf:P;A(h);continue;case 11:g.Pc();a.b=Lf;A(h);continue;case 12:g.Oc();
a.b=Lf;A(h);continue;case 56:g.Tc();a.b=Lf;A(h);continue;case 13:a.S?(a.f.push("-epubx-region"),a.S=!1):a.O?(a.f.push("page"),a.O=!1):a.f.push("[selector]");g.ra();a.b=If;A(h);continue;case 41:g.Lb();a.b=Mf;A(h);continue;case 15:l.push(H(k.text));A(h);continue;case 16:try{l.push(yf(k.text))}catch(t){g.error("E_CSS_COLOR",k),a.b=Pf}A(h);continue;case 17:l.push(new kd(k.C));A(h);continue;case 18:l.push(new ld(k.C));A(h);continue;case 19:l.push(new I(k.C,k.text));A(h);continue;case 20:l.push(new id(k.text));
...
function dg(a,b,c,d,e){var f=K("parseStylesheet"),g=new Tf(If,a,b,c),h=null;e&&(h=eg(new Tb(e,b),b,c));if(h=$f(g,d,h&&h.ja()))b.Eb(h),b.ra();mf(function(){for(;!bg(g,100,!1,!1,!1,!1);){if(g.B){var a=va(g.H,c);g.k&&(b.Eb(g.k),b.ra());var d=K("parseStylesheet.import");fg(a,b,null,null).then(function(){g.k&&b.nb();g.B=!1;g.H=null;g.k=null;N(d,!0)});return M(d)}a=lf();if(a.Ca)return a}return L(!1)}).then(function(){h&&b.nb();N(f,!0)});return M(f)}
...
function jg(a,b,c){if(b.xd())a:{b=b.d;a=b.evaluate(a);switch(typeof a){case "number":c=ig[c]?a==Math.round(a)?new ld(a):new kd(a):new I(a,"px");break a;case "string":c=a?hg(b.b,new Tb(a,null)):G;break a;case "boolean":c=a?he:Cd;break a;case "undefined":c=G;break a}throw Error("E_UNEXPECTED");}else c=b;return c};function kg(){this.b={}}u(kg,$c);kg.prototype.vb=function(a){this.b[a.name]=!0;return a};kg.prototype.gb=function(a){this.wb(a.values);return a};function lg(a){this.value=a}u(lg,$c);lg.prototype.Rb=function(a){this.value=a.C;return a};function mg(a,b){if(a){var c=new lg(b);try{return a.U(c),c.value}catch(d){v.b(d,"toInt: ")}}return b}function ng(){this.d=!1;this.b=[];this.name=null}u(ng,$c);ng.prototype.Tb=function(a){this.d&&this.b.push(a);return null};
ng.prototype.Sb=function(a){this.d&&0==a.C&&this.b.push(new I(0,"px"));return null};ng.prototype.gb=function(a){this.wb(a.values);return null};ng.prototype.kb=function(a){this.d||(this.d=!0,this.wb(a.values),this.d=!1,this.name=a.name.toLowerCase());return null};
...
a.length){h=xe(b+a[0],c+a[1],a[2],a[3]);break a}break;case "circle":if(3==a.length){h=xe(b+a[0],c+a[1],a[2],a[2]);break a}}}h=null}return h}catch(p){v.b(p,"toShape:")}}return ye(b,c,b+d,c+e)}function pg(a){this.d=a;this.b={};this.name=null}u(pg,$c);pg.prototype.vb=function(a){this.name=a.toString();this.b[this.name]=this.d?0:(this.b[this.name]||0)+1;return a};pg.prototype.Rb=function(a){this.name&&(this.b[this.name]+=a.C-(this.d?0:1));return a};pg.prototype.gb=function(a){this.wb(a.values);return a};
function qg(a,b){var c=new pg(b);try{a.U(c)}catch(d){v.b(d,"toCounters:")}return c.b};function wf(a,b){this.sc=a;this.name=b;this.d=!1;this.b=this.f=null;this.e=[]}wf.prototype.start=function(){if(!this.b){var a=this;this.b=Ze(Re.d,function(){var b=K("Fetcher.run");a.sc().then(function(c){var d=a.e;a.d=!0;a.f=c;a.b=null;a.e=[];if(d)for(var e=0;e<d.length;e++)try{d[e](c)}catch(f){v.error(f,"Error:")}N(b,c)});return M(b)},this.name)}};function rg(a,b){a.d?b(a.f):a.e.push(b)}function uf(a){if(a.d)return L(a.f);a.start();return a.b.join()}
function sg(a){if(0==a.length)return L(!0);if(1==a.length)return uf(a[0]).ld(!0);var b=K("waitForFetches"),c=0;mf(function(){for(;c<a.length;){var b=a[c++];if(!b.d)return uf(b).ld(!0)}return L(!1)}).then(function(){N(b,!0)});return M(b)}
function tg(a,b){var c=null,d=null;"img"==a.localName&&(c=a.getAttribute("width"),d=a.getAttribute("height"));var e=new wf(function(){function e(b){"img"==a.localName&&(c||a.removeAttribute("width"),d||a.removeAttribute("height"));h.Wa(b?b.type:"timeout")}var g=K("loadImage"),h=ff(g,a);a.addEventListener("load",e,!1);a.addEventListener("error",e,!1);a.addEventListener("abort",e,!1);"http://www.w3.org/2000/svg"==a.namespaceURI?(a.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",b),setTimeout(e,
...
n.od=function(a){return this.b&2048?a:null};n.jc=function(a){return this.b&2?a:null};n.vb=function(a){var b=this.d[a.name.toLowerCase()];return b?b:this.b&4?a:null};n.Tb=function(a){return 0!=a.C||this.b&512?0>a.C&&!(this.b&256)?null:this.e[a.ha]?a:null:"%"==a.ha&&this.b&1024?a:null};n.Sb=function(a){return 0==a.C?this.b&512?a:null:0>=a.C&&!(this.b&256)?null:this.b&16?a:null};n.Rb=function(a){return 0==a.C?this.b&512?a:null:0>=a.C&&!(this.b&256)?null:this.b&48?a:(a=this.d[""+a.C])?a:null};
n.Jc=function(a){return this.b&64?a:null};n.kc=function(a){return this.b&128?a:null};n.gb=function(){return null};n.ub=function(){return null};n.kb=function(){return null};n.Qb=function(){return null};var zg=new Bg(0,U,U);
...
continue}}else m=k.U(f.b);if(m){if(m!==k&&b===e)for(e=[],k=0;k<g;k++)e[k]=b[k];b!==e&&(e[g-d]=m);g++;f=f.f}else f=f.e}}return f===a.b&&(c?0<e.length:g==b.length)?e:null}n=Eg.prototype;n.Ua=function(a){for(var b=null,c=this.d;c!==this.b&&c!==this.e;)a?0!=c.d?c=c.f:(b=a.U(c.b))?(a=null,c=c.f):c=c.e:c=c.e;return c===this.b?b:null};n.nd=function(a){return this.Ua(a)};n.od=function(a){return this.Ua(a)};n.jc=function(a){return this.Ua(a)};n.vb=function(a){return this.Ua(a)};n.Tb=function(a){return this.Ua(a)};
n.Sb=function(a){return this.Ua(a)};n.Rb=function(a){return this.Ua(a)};n.Jc=function(a){return this.Ua(a)};n.kc=function(a){return this.Ua(a)};n.gb=function(){return null};n.ub=function(){return null};n.kb=function(a){return this.Ua(a)};n.Qb=function(){return null};function Gg(a){Eg.call(this,a)}u(Gg,Eg);Gg.prototype.gb=function(a){var b=Fg(this,a.values,!1,0);return b===a.values?a:b?new bd(b):null};
Gg.prototype.ub=function(a){for(var b=this.d,c=!1;b;){if(b.b instanceof Hg){c=!0;break}b=b.e}return c?(b=Fg(this,a.values,!1,0),b===a.values?a:b?new cd(b):null):null};Gg.prototype.f=function(a,b){return Fg(this,a,!0,b)};function Hg(a){Eg.call(this,a)}u(Hg,Eg);Hg.prototype.gb=function(a){return this.Ua(a)};Hg.prototype.ub=function(a){var b=Fg(this,a.values,!1,0);return b===a.values?a:b?new cd(b):null};Hg.prototype.f=function(a,b){for(var c=this.d,d;c!==this.e;){if(d=c.b.f(a,b))return d;c=c.e}return null};
function Ig(a,b){Eg.call(this,b);this.name=a}u(Ig,Eg);Ig.prototype.Ua=function(){return null};Ig.prototype.kb=function(a){if(a.name.toLowerCase()!=this.name)return null;var b=Fg(this,a.values,!1,0);return b===a.values?a:b?new dd(a.name,b):null};function Jg(){}Jg.prototype.b=function(a,b){return b};Jg.prototype.e=function(){};function Kg(a,b){this.name=b;this.f=a.e[this.name]}u(Kg,Jg);
Kg.prototype.b=function(a,b,c){if(c.values[this.name])return b;if(a=this.f.f(a,b)){var d=a.length;this.e(1<d?new bd(a):a[0],c);return b+d}return b};Kg.prototype.e=function(a,b){b.values[this.name]=a};function Lg(a,b){Kg.call(this,a,b[0]);this.d=b}u(Lg,Kg);Lg.prototype.e=function(a,b){for(var c=0;c<this.d.length;c++)b.values[this.d[c]]=a};function Mg(a,b){this.d=a;this.Dd=b}u(Mg,Jg);
Mg.prototype.b=function(a,b,c){var d=b;if(this.Dd)if(a[b]==hd){if(++b==a.length)return d}else return d;var e=this.d[0].b(a,b,c);if(e==b)return d;b=e;for(d=1;d<this.d.length&&b<a.length;d++){e=this.d[d].b(a,b,c);if(e==b)break;b=e}return b};function Ng(){this.b=this.Ra=null;this.error=!1;this.values={};this.d=null}n=Ng.prototype;n.clone=function(){var a=new this.constructor;a.Ra=this.Ra;a.b=this.b;a.d=this.d;return a};n.qd=function(a,b){this.Ra=a;this.b=b};n.Hb=function(){this.error=!0;return 0};
function Og(a,b){a.Hb([b]);return null}n.nd=function(a){return Og(this,a)};n.jc=function(a){return Og(this,a)};n.vb=function(a){return Og(this,a)};n.Tb=function(a){return Og(this,a)};n.Sb=function(a){return Og(this,a)};n.Rb=function(a){return Og(this,a)};n.Jc=function(a){return Og(this,a)};n.kc=function(a){return Og(this,a)};n.gb=function(a){this.Hb(a.values);return null};n.ub=function(){this.error=!0;return null};n.kb=function(a){return Og(this,a)};n.Qb=function(){this.error=!0;return null};
function Pg(){Ng.call(this)}u(Pg,Ng);Pg.prototype.Hb=function(a){for(var b=0,c=0;b<a.length;){var d=this.Ra[c].b(a,b,this);if(d>b)b=d,c=0;else if(++c==this.Ra.length){this.error=!0;break}}return b};function Qg(){Ng.call(this)}u(Qg,Ng);Qg.prototype.Hb=function(a){if(a.length>this.Ra.length||0==a.length)return this.error=!0,0;for(var b=0;b<this.Ra.length;b++){for(var c=b;c>=a.length;)c=1==c?0:c-2;if(this.Ra[b].b(a,c,this)!=c+1)return this.error=!0,0}return a.length};function Rg(){Ng.call(this)}
u(Rg,Ng);Rg.prototype.Hb=function(a){for(var b=a.length,c=0;c<a.length;c++)if(a[c]===hd){b=c;break}if(b>this.Ra.length||0==a.length)return this.error=!0,0;for(c=0;c<this.Ra.length;c++){for(var d=c;d>=b;)d=1==d?0:d-2;var e;if(b+1<a.length)for(e=b+c+1;e>=a.length;)e-=e==b+2?1:2;else e=d;if(2!=this.Ra[c].b([a[d],a[e]],0,this))return this.error=!0,0}return a.length};function Sg(){Ng.call(this)}u(Sg,Pg);
Sg.prototype.ub=function(a){for(var b={},c=0;c<a.values.length;c++){this.values={};if(a.values[c]instanceof cd)this.error=!0;else{a.values[c].U(this);for(var d=b,e=this.values,f=0;f<this.b.length;f++){var g=this.b[f],h=e[g]||this.d.h[g],l=d[g];l||(l=[],d[g]=l);l.push(h)}this.values["background-color"]&&c!=a.values.length-1&&(this.error=!0)}if(this.error)return null}this.values={};for(var k in b)this.values[k]="background-color"==k?b[k].pop():new cd(b[k]);return null};function Tg(){Ng.call(this)}
u(Tg,Pg);Tg.prototype.qd=function(a,b){Pg.prototype.qd.call(this,a,b);this.b.push("font-family","line-height","font-size")};
...
Tg.prototype.ub=function(a){a.values[0].U(this);if(this.error)return null;for(var b=[this.values["font-family"]],c=1;c<a.values.length;c++)b.push(a.values[c]);a=new cd(b);a.U(this.d.e["font-family"])?this.values["font-family"]=a:this.error=!0;return null};Tg.prototype.vb=function(a){if(a=this.d.d[a.name])for(var b in a)this.values[b]=a[b];else this.error=!0;return null};var Ug={SIMPLE:Pg,INSETS:Qg,INSETS_SLASH:Rg,COMMA:Sg,FONT:Tg};
...
function eh(a,b,c,d,e){var f="",g=b;b=b.toLowerCase();var h=b.match(/^-([a-z]+)-([-a-z0-9]+)$/);h&&(f=h[1],b=h[2]);if((h=a.k[b])&&h[f])if(f=a.e[b])(a=c===Hd||c.xd()?c:c.U(f))?e.eb(b,a,d):e.Yb(g,c);else if(b=a.f[b].clone(),c===Hd)for(c=0;c<b.b.length;c++)e.eb(b.b[c],Hd,d);else{c.U(b);if(b.error)d=!1;else{for(a=0;a<b.b.length;a++)f=b.b[a],e.eb(f,b.values[f]||b.d.h[f],d);d=!0}d||e.Yb(g,c)}else e.Ic(g,c)}
...
var Ch={ye:"text/html",ze:"text/xml",qe:"application/xml",pe:"application/xhtml_xml",ve:"image/svg+xml"};function Dh(a,b,c){c=c||new DOMParser;var d;try{d=c.parseFromString(a,b)}catch(e){}if(d){a=d.documentElement;if("parsererror"===a.localName)return null;for(a=a.firstChild;a;a=a.nextSibling)if("parsererror"===a.localName)return null}else return null;return d}
...
function Fh(a,b){var c=a.responseXML;if(!c){var d=new DOMParser,e=a.responseText;if(e){var f=Eh(a);(c=Dh(e,f||"application/xml",d))&&!f&&(f=c.documentElement,"html"!==f.localName.toLowerCase()||f.namespaceURI?"svg"===f.localName.toLowerCase()&&"image/svg+xml"!==c.contentType&&(c=Dh(e,"image/svg+xml",d)):c=Dh(e,"text/html",d));c||(c=Dh(e,"text/html",d))}}c=c?new th(b,a.url,c):null;return L(c)}function Gh(a){this.Kb=a}
...
function ci(a){this.d=a;this.b=[]}function di(a,b,c,d,e,f,g,h,l){this.b=a;this.g=b;this.d=c;this.Ga=d;this.j=e;this.f=f;this.ie=g;this.h=h;this.Qa=-1;this.e=l}function ei(a,b){return a.f?!b.f||a.Ga>b.Ga?!0:a.h:!1}function fi(a,b){return a.top-b.top}function gi(a,b){return b.right-a.right}
function hi(a,b){if(a===b)return!0;if(!a||!b||a.da!==b.da||a.J!==b.J||a.ga.length!==b.ga.length)return!1;for(var c=0;c<a.ga.length;c++){var d=a[c],e=b[c];if(!(d===e||d&&e&&d.fa===e.fa&&d.Ha===e.Ha&&d.ea===e.ea&&d.sa===e.sa&&d.qa===e.qa))return!1}return!0}function ii(a,b,c,d,e,f,g){this.$=a;this.fd=d;this.Ed=null;this.root=b;this.Z=c;this.type=f;e&&(e.Ed=this);this.b=g}function ji(a,b){this.ge=a;this.count=b}
...
function Ai(a){this.d=a;this.H=this.D=this.height=this.width=this.u=this.k=this.w=this.j=this.Ta=this.ba=this.Za=this.S=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.yb=this.I=null;this.oa=this.Gb=this.ab=this.mc=this.e=0;this.b=!1}function Bi(a){return a.marginTop+a.ba+a.k}function Ci(a){return a.marginBottom+a.Ta+a.u}function Di(a){return a.marginLeft+a.S+a.j}function Ei(a){return a.marginRight+a.Za+a.w}
function Fi(a,b){a.d=b.d;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.S=b.S;a.Za=b.Za;a.ba=b.ba;a.Ta=b.Ta;a.j=b.j;a.w=b.w;a.k=b.k;a.u=b.u;a.width=b.width;a.height=b.height;a.D=b.D;a.H=b.H;a.yb=b.yb;a.I=b.I;a.e=b.e;a.mc=b.mc;a.ab=b.ab;a.b=b.b}function Gi(a,b,c){a.top=b;a.height=c;w(a.d,"top",b+"px");w(a.d,"height",c+"px")}function Hi(a,b,c){a.left=b;a.width=c;w(a.d,"left",b+"px");w(a.d,"width",c+"px")}
function Ii(a,b){this.b=a;this.d=b}u(Ii,$c);Ii.prototype.jc=function(a){this.b.appendChild(this.b.ownerDocument.createTextNode(a.b));return null};Ii.prototype.kc=function(a){var b=this.b.ownerDocument.createElementNS("http://www.w3.org/1999/xhtml","img");b.setAttribute("src",a.url);this.b.appendChild(b);return null};Ii.prototype.gb=function(a){this.wb(a.values);return null};
...
var gj=fj({before:"right",after:"left",start:"top",end:"bottom"}),hj=fj({before:"top",after:"bottom",start:"left",end:"right"});function V(a,b){this.value=a;this.Ga=b}n=V.prototype;n.Jd=function(){return this};n.tc=function(a){a=this.value.U(a);return a===this.value?this:new V(a,this.Ga)};n.Kd=function(a){return 0==a?this:new V(this.value,this.Ga+a)};n.evaluate=function(a,b){return jg(a,this.value,b)};n.Gd=function(){return!0};function ij(a,b,c){V.call(this,a,b);this.M=c}u(ij,V);
ij.prototype.Jd=function(){return new V(this.value,this.Ga)};ij.prototype.tc=function(a){a=this.value.U(a);return a===this.value?this:new ij(a,this.Ga,this.M)};ij.prototype.Kd=function(a){return 0==a?this:new ij(this.value,this.Ga+a,this.M)};ij.prototype.Gd=function(a){return!!this.M.evaluate(a)};function jj(a,b,c){return(null==b||c.Ga>b.Ga)&&c.Gd(a)?c.Jd():b}var kj={"region-id":!0};function lj(a){return"_"!=a.charAt(0)&&!kj[a]}function mj(a,b,c){c?a[b]=c:delete a[b]}
function nj(a,b){var c=a[b];c||(c={},a[b]=c);return c}function oj(a,b){var c=a[b];c||(c=[],a[b]=c);return c}function pj(a,b,c,d,e,f){if(e){var g=nj(b,"_pseudos");b=g[e];b||(b={},g[e]=b)}f&&(e=nj(b,"_regions"),b=e[f],b||(b={},e[f]=b));for(var h in c)"_"!=h.charAt(0)&&(kj[h]?(f=c[h],e=oj(b,h),Array.prototype.push.apply(e,f)):mj(b,h,jj(a,b[h],c[h].Kd(d))))}
...
rj.prototype.Tb=function(a){if("em"==a.ha||"ex"==a.ha){var b=nc(this.d,a.ha,!1)/nc(this.d,"em",!1);return new I(a.C*b*sj(this),"px")}if("%"==a.ha){if("font-size"===this.b)return new I(a.C/100*sj(this),"px");b=this.b.match(/height|^(top|bottom)$/)?"vh":"vw";return new I(a.C,b)}return a};rj.prototype.Qb=function(a){return"font-size"==this.b?jg(this.d,a,this.b).U(this):a};function tj(){}tj.prototype.apply=function(){};tj.prototype.h=function(a){return new uj([this,a])};tj.prototype.clone=function(){return this};
...
Hj.prototype.apply=function(a){if(a.b){var b=a.b.getAttributeNS(this.g,this.name);b&&b.match(this.f)&&this.b.apply(a)}};function Ij(a){this.b=null;this.f=a}u(Ij,W);Ij.prototype.apply=function(a){a.lang.match(this.f)&&this.b.apply(a)};function Jj(){this.b=null}u(Jj,W);Jj.prototype.apply=function(a){a.Ta&&this.b.apply(a)};Jj.prototype.d=function(){return 6};function Kj(){this.b=null}u(Kj,W);Kj.prototype.apply=function(a){a.ma&&this.b.apply(a)};Kj.prototype.d=function(){return 12};
function Lj(a,b){this.b=null;this.f=a;this.Ub=b}u(Lj,W);function Mj(a,b){var c=a.f;b-=a.Ub;return 0===c?0===b:0===b%c&&0<=b/c}function Nj(a,b){Lj.call(this,a,b)}u(Nj,Lj);Nj.prototype.apply=function(a){Mj(this,a.za)&&this.b.apply(a)};Nj.prototype.d=function(){return 5};function Oj(a,b){Lj.call(this,a,b)}u(Oj,Lj);Oj.prototype.apply=function(a){Mj(this,a.ab[a.e][a.d])&&this.b.apply(a)};Oj.prototype.d=function(){return 5};function Pj(a,b){Lj.call(this,a,b)}u(Pj,Lj);
Pj.prototype.apply=function(a){var b=a.I;null===b&&(b=a.I=a.b.parentNode.childElementCount-a.za+1);Mj(this,b)&&this.b.apply(a)};Pj.prototype.d=function(){return 4};function Qj(a,b){Lj.call(this,a,b)}u(Qj,Lj);Qj.prototype.apply=function(a){var b=a.$a;if(!b[a.e]){var c=a.b;do{var d=c.namespaceURI,e=c.localName,f=b[d];f||(f=b[d]={});f[e]=(f[e]||0)+1}while(c=c.nextElementSibling)}Mj(this,b[a.e][a.d])&&this.b.apply(a)};Qj.prototype.d=function(){return 4};function Rj(){this.b=null}u(Rj,W);
...
hk.prototype.kb=function(a){if("attr"!==a.name)return ad.prototype.kb.call(this,a);var b="string",c=null,d=null;a.values[0]instanceof bd?(2<=a.values[0].values.length&&(b=a.values[0].values[1].stringValue()),c=a.values[0].values[0].stringValue()):c=a.values[0].stringValue();d=1<a.values.length?ik(a.values[1].stringValue(),b):ik(null,b);return this.b&&this.b.hasAttribute(c)?ik(this.b.getAttribute(c),b):d};function jk(a,b,c){this.d=a;this.b=c}u(jk,ad);
jk.prototype.vb=function(a){var b=this.d,c=b.D,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.l)];b.l++;break;case "close-quote":return 0<b.l&&b.l--,c[2*Math.min(d,b.l)+1];case "no-open-quote":return b.l++,new id("");case "no-close-quote":return 0<b.l&&b.l--,new id("")}return a};
...
mk={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},nk={Fe:!1,Vb:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",wc:"\u5341\u767e\u5343",ce:"\u8ca0"};
function ok(a){if(9999<a||-9999>a)return""+a;if(0==a)return nk.Vb.charAt(0);var b=new Ia;0>a&&(b.append(nk.ce),a=-a);if(10>a)b.append(nk.Vb.charAt(a));else if(nk.Ge&&19>=a)b.append(nk.wc.charAt(0)),0!=a&&b.append(nk.wc.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(nk.Vb.charAt(c)),b.append(nk.wc.charAt(2)));if(c=Math.floor(a/100)%10)b.append(nk.Vb.charAt(c)),b.append(nk.wc.charAt(1));if(c=Math.floor(a/10)%10)b.append(nk.Vb.charAt(c)),b.append(nk.wc.charAt(0));(a%=10)&&b.append(nk.Vb.charAt(a))}return b.toString()}
...
jk.prototype.kb=function(a){switch(a.name){case "counter":if(2>=a.values.length)return qk(this,a.values);break;case "counters":if(3>=a.values.length)return sk(this,a.values);break;case "target-counter":if(3>=a.values.length)return uk(this,a.values);break;case "target-counters":if(4>=a.values.length)return wk(this,a.values)}v.b("E_CSS_CONTENT_PROP:",a.toString());return new id("")};var yk=1/1048576;function zk(a,b){for(var c in a)b[c]=a[c].clone()}
function Ak(){this.g=0;this.b={};this.ic={};this.f={};this.d={};this.Ba={};this.e={};this.$b={};this.Q=0}Ak.prototype.clone=function(){var a=new Ak;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b];zk(this.ic,a.ic);zk(this.f,a.f);zk(this.d,a.d);zk(this.Ba,a.Ba);zk(this.e,a.e);zk(this.$b,a.$b);a.Q=this.Q;return a};function yj(a,b,c){var d=a[b];d&&(c=d.h(c));a[b]=c}
function Bk(a,b,c,d){this.k=a;this.h=b;this.Gb=c;this.Za=d;this.g=[[],[]];this.j={};this.w=this.u=this.b=null;this.oa=this.ba=this.O=this.e=this.d="";this.S=this.H=null;this.ma=this.Ta=!0;this.f={};this.B=[{}];this.D=[new id("\u201c"),new id("\u201d"),new id("\u2018"),new id("\u2019")];this.l=0;this.lang="";this.zb=[0];this.za=0;this.ka=[{}];this.ab=this.ka[0];this.I=null;this.xb=[this.I];this.yb=[{}];this.$a=this.ka[0];this.hb=[]}function Zj(a,b){a.j[b]=(a.j[b]||0)+1}
...
break;case "last-child":this.b.push(new Pj(0,1));break;case "first-of-type":this.b.push(new Oj(0,1));break;case "last-of-type":this.b.push(new Qj(0,1));break;case "only-child":this.b.push(new Jj);this.b.push(new Pj(0,1));break;case "only-of-type":this.b.push(new Oj(0,1));this.b.push(new Qj(0,1));break;case "empty":this.b.push(new Rj);break;case "before":case "after":case "first-line":case "first-letter":this.bc(a,b);return;default:v.b("unknown pseudo-class selector: "+a),this.b.push(new Vj(""))}this.P+=
256}};
Pk.prototype.bc=function(a,b){switch(a){case "before":case "after":case "first-line":case "first-letter":case "footnote-call":case "footnote-marker":case "inner":this.f?(v.b("Double pseudoelement ::"+this.f+"::"+a),this.b.push(new Vj(""))):this.f=a;break;case "first-n-lines":if(b&&1==b.length&&"number"==typeof b[0]){var c=Math.round(b[0]);if(0<c&&c==b[0]){this.f?(v.b("Double pseudoelement ::"+this.f+"::"+a),this.b.push(new Vj(""))):this.f="first-"+c+"-lines";break}}default:v.b("Unrecognized pseudoelement: ::"+a),
this.b.push(new Vj(""))}this.P+=1};Pk.prototype.Wc=function(a){this.P+=65536;this.b.push(new zj(a))};
Pk.prototype.qc=function(a,b,c,d){this.P+=256;b=b.toLowerCase();d=d||"";var e;switch(c){case 0:e=new Ej(a,b);break;case 39:e=new Fj(a,b,d);break;case 45:!d||d.match(/\s/)?e=new Vj(""):e=new Hj(a,b,new RegExp("(^|\\s)"+xa(d)+"($|\\s)"));break;case 44:e=new Hj(a,b,new RegExp("^"+xa(d)+"($|-)"));break;case 43:d?e=new Hj(a,b,new RegExp("^"+xa(d))):e=new Vj("");break;case 42:d?e=new Hj(a,b,new RegExp(xa(d)+"$")):e=new Vj("");break;case 46:d?e=new Hj(a,b,new RegExp(xa(d))):e=new Vj("");break;case 50:"supported"==
d?e=new Gj(a,b):(v.b("Unsupported :: attr selector op:",d),e=new Vj(""));break;default:v.b("Unsupported attr selector:",c),e=new Vj("")}this.b.push(e)};var Sk=0;n=Pk.prototype;n.mb=function(){var a="d"+Sk++;Qk(this,new vj(new Yj(a)));this.b=[new Vj(a)]};n.Pc=function(){var a="c"+Sk++;Qk(this,new vj(new ak(a)));this.b=[new Vj(a)]};n.Oc=function(){var a="a"+Sk++;Qk(this,new vj(new bk(a)));this.b=[new Vj(a)]};n.Tc=function(){var a="f"+Sk++;Qk(this,new vj(new ck(a)));this.b=[new Vj(a)]};
n.Lb=function(){Tk(this);this.f=null;this.l=!1;this.P=0;this.b=[]};n.fb=function(){var a;0!=this.j?(Hf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.j=1,this.h={},this.f=null,this.P=0,this.l=!1,this.b=[])};n.error=function(a,b){Ff.prototype.error.call(this,a,b);1==this.j&&(this.j=0)};n.Pb=function(a){Ff.prototype.Pb.call(this,a);this.j=0};n.ra=function(){Tk(this);Ff.prototype.ra.call(this);1==this.j&&(this.j=0)};n.nb=function(){Ff.prototype.nb.call(this)};
function Tk(a){if(a.b){var b=a.P,c;c=a.g;c=c.Q+=yk;Qk(a,a.Nd(b+c));a.b=null;a.f=null;a.l=!1;a.P=0}}n.Nd=function(a){var b=this.w;this.l&&(b=b?"xxx-bogus-xxx":"footnote");return new wj(this.h,a,this.f,b)};n.cb=function(a,b,c){eh(this.k,a,b,c,this)};n.Yb=function(a,b){Gf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};n.Ic=function(a,b){Gf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
n.eb=function(a,b,c){"display"!=a||b!==Td&&b!==Sd||(this.eb("flow-options",new bd([Bd,Yd]),c),this.eb("flow-into",b,c),b=ud);(Wi.SIMPLE_PROPERTY||[]).forEach(function(d){d=d({name:a,value:b,important:c});a=d.name;b=d.value;c=d.important});var d=c?Af(this):Bf(this);mj(this.h,a,this.M?new ij(b,d,this.M):new V(b,d))};n.fc=function(a){switch(a){case "not":a=new Uk(this),a.fb(),Df(this.$,a)}};function Uk(a){Pk.call(this,a.d,a.$,a.M,a,a.w,a.k,!1);this.parent=a;this.e=a.b}u(Uk,Pk);n=Uk.prototype;
n.fc=function(a){"not"==a&&Hf(this,"E_CSS_UNEXPECTED_NOT")};n.ra=function(){Hf(this,"E_CSS_UNEXPECTED_RULE_BODY")};n.Lb=function(){Hf(this,"E_CSS_UNEXPECTED_NEXT_SELECTOR")};n.rc=function(){this.b&&0<this.b.length&&this.e.push(new Xj(this.b));this.parent.P+=this.P;var a=this.$;a.b=a.e.pop()};n.error=function(a,b){Pk.prototype.error.call(this,a,b);var c=this.$;c.b=c.e.pop()};function Vk(a,b){Ef.call(this,a,b,!1)}u(Vk,Ff);
Vk.prototype.cb=function(a,b){if(this.d.values[a])this.error("E_CSS_NAME_REDEFINED "+a,this.Xb());else{var c=a.match(/height|^(top|bottom)$/)?"vh":"vw",c=new Pc(this.d,100,c),c=b.ja(this.d,c);this.d.values[a]=c}};function Wk(a,b,c,d,e){Ef.call(this,a,b,!1);this.b=d;this.M=c;this.e=e}u(Wk,Ff);Wk.prototype.cb=function(a,b,c){c?v.b("E_IMPORTANT_NOT_ALLOWED"):eh(this.e,a,b,c,this)};Wk.prototype.Yb=function(a,b){v.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};
Wk.prototype.Ic=function(a,b){v.b("E_INVALID_PROPERTY",a+":",b.toString())};Wk.prototype.eb=function(a,b,c){c=c?Af(this):Bf(this);c+=this.Q;this.Q+=yk;mj(this.b,a,this.M?new ij(b,c,this.M):new V(b,c))};function Xk(a,b){cg.call(this,a);this.b={};this.e=b;this.Q=0}u(Xk,cg);Xk.prototype.cb=function(a,b,c){eh(this.e,a,b,c,this)};Xk.prototype.Yb=function(a,b){v.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};Xk.prototype.Ic=function(a,b){v.b("E_INVALID_PROPERTY",a+":",b.toString())};
Xk.prototype.eb=function(a,b,c){c=(c?67108864:50331648)+this.Q;this.Q+=yk;mj(this.b,a,new V(b,c))};function Yk(a,b,c){return(a=a["writing-mode"])&&(b=a.evaluate(b,"writing-mode"))&&b!==Hd?b===fe:c}function Zk(a,b,c,d){var e={},f;for(f in a)lj(f)&&(e[f]=a[f]);a=a._regions;if((c||d)&&a)for(d&&(d=["footnote"],c=c?c.concat(d):d),d=0;d<c.length;d++){f=a[c[d]];for(var g in f)lj(g)&&(e[g]=jj(b,e[g],f[g]))}return e}
...
function El(a,b,c){var d=-1;if(b<=a.b&&(d=fl(a.e,b),d+=c,d<cl(a.e)))return gl(a.e,d);if(null==a.d)return Number.POSITIVE_INFINITY;for(var e=a.f;;){var f=a.d.firstChild;if(null==f)for(;;){if(1==a.d.nodeType){var f=a.O,g=a.d;if(f.hb.pop()!==g)throw Error("Invalid call to popElement");f.zb.pop();f.ka.pop();f.xb.pop();f.yb.pop();f.pop();Ik(f);a.Na=a.ba.pop();g=a.g.pop(a.b);f=null;g.d&&(f=ml(g.d,"before"),Il(a,f,g.d.Ea?sl(a.g,g):g.d.offset,g.b),f=ml(g.d,"after"));f=ll(f,ml(g,"after"));Il(a,f,a.b,g.b)}if(f=
...
d)}}}tl.prototype.h=function(a,b){var c=wh(this.Z,a),d="e"+c;b&&(c=xh(this.Z,a,0,!0));this.b<=c&&El(this,c,0);return this.I[d]};var Jl=1;function Kl(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.index=0;this.d=a;this.name=b;this.tb=c;this.Ba=d;this.parent=e;this.g="p"+Jl++;e&&(this.index=e.children.length,e.children.push(this))}Kl.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Kl.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Ll(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
...
function Ol(a,b){this.e=b;var c=this;ec.call(this,a,function(a,b){var f=a.match(/^([^.]+)\.([^.]+)$/);if(f){var g=c.e.h[f[1]];if(g&&(g=this.ka[g])){if(b){var f=f[2],h=g.ba[f];if(h)g=h;else{switch(f){case "columns":var h=g.d.d,l=new Vc(h,0),k=Pl(g,"column-count"),m=Pl(g,"column-width"),p=Pl(g,"column-gap"),h=E(h,Xc(h,new Sc(h,"min",[l,k]),D(h,m,p)),p)}h&&(g.ba[f]=h);g=h}}else g=Pl(g,f[2]);return g}}return null})}u(Ol,ec);
function Ql(a,b,c,d,e,f,g){a=a instanceof Ol?a:new Ol(a,this);Kl.call(this,a,b,c,d,e);this.e=this;this.M=f;this.P=g;this.b.width=new V(je,0);this.b.height=new V(ke,0);this.b["wrap-flow"]=new V(td,0);this.b.position=new V(Vd,0);this.b.overflow=new V(ge,0);this.h={}}u(Ql,Kl);Ql.prototype.f=function(a){return new Rl(a,this)};Ql.prototype.clone=function(a){a=new Ql(this.d,this.name,a.tb||this.tb,this.Ba,this.parent,this.M,this.P);Ll(this,a);Ml(this,a);return a};
function Sl(a,b,c,d,e){Kl.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.h[b]=this.g);this.b["wrap-flow"]=new V(td,0)}u(Sl,Kl);Sl.prototype.f=function(a){return new Tl(a,this)};Sl.prototype.clone=function(a){a=new Sl(a.parent.d,this.name,this.tb,this.Ba,a.parent);Ll(this,a);Ml(this,a);return a};function Ul(a,b,c,d,e){Kl.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.h[b]=this.g)}u(Ul,Kl);Ul.prototype.f=function(a){return new Vl(a,this)};
Ul.prototype.clone=function(a){a=new Ul(a.parent.d,this.name,this.tb,this.Ba,a.parent);Ll(this,a);Ml(this,a);return a};function X(a,b,c){return b&&b!==td?b.ja(a,c):null}function Wl(a,b,c){return b&&b!==td?b.ja(a,c):a.b}function Xl(a,b,c){return b?b===td?null:b.ja(a,c):a.b}function Yl(a,b,c,d){return b&&c!==Qd?b.ja(a,d):a.b}function Zl(a,b,c){return b?b===he?a.g:b===Cd?a.f:b.ja(a,a.b):c}
...
function fm(a,b){b.ka[a.d.g]=a;var c=a.d.d,d=a.style,e=a.e?gm(a.e,b):null,e=Zk(a.D,b,e,!1);a.b=Yk(e,b,a.e?a.e.b:!1);$k(e,d,a.b,function(a,b){return b.value});a.l=new gc(c,function(){return a.B},"autoWidth");a.k=new gc(c,function(){return a.w},"autoHeight");a.Xc();a.Yc();dm(a);cm(a)}function hm(a,b,c){(a=a.style[c])&&(a=jg(b,a,c));return a}function Y(a,b,c){(a=a.style[c])&&(a=jg(b,a,c));return pd(a,b)}
function gm(a,b){var c;a:{if(c=a.D["region-id"]){for(var d=[],e=0;e<c.length;e++){var f=c[e].evaluate(b,"");f&&f!==G&&d.push(f)}if(d.length){c=d;break a}}c=null}if(c){d=[];for(e=0;e<c.length;e++)d[e]=c[e].toString();return d}return null}function im(a,b,c,d,e){if(a=hm(a,b,d))a.Zb()&&kc(a.ha)&&(a=new I(pd(a,b),"px")),"font-family"===d&&(a=nh(e,a)),w(c.d,d,a.toString())}
...
function km(a,b,c){var d=Y(a,b,"right"),e=Y(a,b,"snap-height"),f=Y(a,b,"margin-right"),g=Y(a,b,"padding-right");b=Y(a,b,"border-right-width");w(c.d,"margin-right",f+"px");w(c.d,"padding-right",g+"px");w(c.d,"border-right-width",b+"px");c.marginRight=f;c.Za=b;a.b&&0<e&&(a=d+Ei(c),a=a-Math.floor(a/e)*e,0<a&&(c.Gb=e-a,g+=c.Gb));c.w=g;c.mc=e}
function lm(a,b,c){var d=Y(a,b,"snap-height"),e=Y(a,b,"top"),f=Y(a,b,"margin-top"),g=Y(a,b,"padding-top");b=Y(a,b,"border-top-width");c.top=e;c.marginTop=f;c.ba=b;c.ab=d;!a.b&&0<d&&(a=e+Bi(c),a=a-Math.floor(a/d)*d,0<a&&(c.oa=d-a,g+=c.oa));c.k=g;w(c.d,"top",e+"px");w(c.d,"margin-top",f+"px");w(c.d,"padding-top",g+"px");w(c.d,"border-top-width",b+"px")}
function mm(a,b,c){var d=Y(a,b,"margin-bottom"),e=Y(a,b,"padding-bottom"),f=Y(a,b,"border-bottom-width");a=Y(a,b,"height")-c.oa;w(c.d,"height",a+"px");w(c.d,"margin-bottom",d+"px");w(c.d,"padding-bottom",e+"px");w(c.d,"border-bottom-width",f+"px");c.height=a-c.oa;c.marginBottom=d;c.Ta=f;c.u=e}function nm(a,b,c){a.b?(lm(a,b,c),mm(a,b,c)):(km(a,b,c),jm(a,b,c))}
function om(a,b,c){w(c.d,"border-top-width","0px");var d=Y(a,b,"max-height");a.I?Gi(c,0,d):(lm(a,b,c),d-=c.oa,c.height=d,w(c.d,"height",d+"px"))}function pm(a,b,c){w(c.d,"border-left-width","0px");var d=Y(a,b,"max-width");a.H?Hi(c,0,d):(km(a,b,c),d-=c.Gb,c.width=d,a=Y(a,b,"right"),w(c.d,"right",a+"px"),w(c.d,"width",d+"px"))}
...
Vl.prototype.O=function(a){var b=this.d.d,c=this.style,d=Zl(b,c.required,b.f)!==b.f;if(d||this.f){var e;e=(e=c["flow-from"])?e.ja(b,b.b):new B(b,"body");e=new Sc(b,"has-content",[e]);a=Wc(b,a,e)}a=xm(this,a,c["required-partitions"],!1);a=xm(this,a,c["conflicting-partitions"],!0);d&&(c=(c=this.u.style.enabled)?c.ja(b,null):b.g,c=Wc(b,c,a),this.u.style.enabled=new J(c));return a};Vl.prototype.sb=function(a,b,c,d,e){w(b.d,"overflow","hidden");$l.prototype.sb.call(this,a,b,c,d,e)};
function ym(a,b,c,d){Ef.call(this,a,b,!1);this.target=c;this.b=d}u(ym,Ff);ym.prototype.cb=function(a,b,c){eh(this.b,a,b,c,this)};ym.prototype.Ic=function(a,b){Gf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};ym.prototype.Yb=function(a,b){Gf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};ym.prototype.eb=function(a,b,c){this.target.b[a]=new V(b,c?50331648:67108864)};function zm(a,b,c,d){ym.call(this,a,b,c,d)}u(zm,ym);
function Am(a,b,c,d){ym.call(this,a,b,c,d);c.b.width=new V(ie,0);c.b.height=new V(ie,0)}u(Am,ym);Am.prototype.hc=function(a,b,c){a=new Ul(this.d,a,b,c,this.target);Df(this.$,new zm(this.d,this.$,a,this.b))};Am.prototype.gc=function(a,b,c){a=new Sl(this.d,a,b,c,this.target);a=new Am(this.d,this.$,a,this.b);Df(this.$,a)};function Bm(a,b,c,d){ym.call(this,a,b,c,d)}u(Bm,ym);Bm.prototype.hc=function(a,b,c){a=new Ul(this.d,a,b,c,this.target);Df(this.$,new zm(this.d,this.$,a,this.b))};
Bm.prototype.gc=function(a,b,c){a=new Sl(this.d,a,b,c,this.target);a=new Am(this.d,this.$,a,this.b);Df(this.$,a)};var Cm={"text-indent":"0px","margin-top":"0px","padding-top":"0px","border-top-width":"0px","border-top-style":"none","border-top-color":"transparent","border-top-left-radius":"0px","border-top-right-radius":"0px"},Dm={"text-indent":"0px","margin-right":"0px","padding-right":"0px","border-right-width":"0px","border-right-style":"none","border-right-color":"transparent","border-top-right-radius":"0px","border-bottom-right-radius":"0px"},Em={"margin-top":"0px"},Fm={"margin-right":"0px"},Gm={};
...
function Nm(a,b,c,d,e,f){var g=K("createRefShadow");a.Z.j.load(b).then(function(h){if(h){var l=Bh(h,b);if(l){var k=a.H,m=k.B[h.url];if(!m){var m=k.style.h.b[h.url],p=new lc(0,k.qb(),k.pb(),k.j),m=new tl(h,m.e,m.d,p,k.g,m.j,new Om(k.f,h.url),new Pm(k.f,h.url,m.d,m.b));k.B[h.url]=m}f=new ii(d,l,h,e,f,c,m)}}N(g,f)});return M(g)}
function Qm(a,b,c,d,e,f,g,h){var l=K("createShadows"),k=e.template,m;k instanceof nd?m=Nm(a,k.url,2,b,h,null):m=L(null);m.then(function(k){var m=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var t=b.getAttribute("href"),q=null;t?q=h?h.Z:a.Z:h&&(t="http://www.w3.org/1999/xhtml"==h.$.namespaceURI?h.$.getAttribute("href"):h.$.getAttributeNS("http://www.w3.org/1999/xlink","href"),q=h.fd?h.fd.Z:a.Z);t&&(t=va(t,q.url),m=Nm(a,t,3,b,h,k))}null==m&&(m=L(k));m.then(function(k){var m;
...
"name"==t)&&b){r=a.j.md(r,a.Z.url);g.setAttribute(t,r);Yh(a.page,g,r);continue}"src"==t||"href"==t||"poster"==t?r=a.j.b(Vm(a,r),a.Z.url):"srcset"==t&&(r=r.split(",").map(function(b){return Vm(a,b.trim())}).join(","))}if(q){var x=Gm[q];x&&(t=x+":"+t)}"src"!=t||q||"img"!=F||"http://www.w3.org/1999/xhtml"!=ia?"href"==t&&"image"==F&&"http://www.w3.org/2000/svg"==ia&&"http://www.w3.org/1999/xlink"==q?a.page.g.push(tg(g,r)):q?g.setAttributeNS(q,t,r):g.setAttribute(t,r):m=r}m&&(h=tg(g,m),k=l.width,m=l.height,
...
function wn(a,b,c,d){Ai.call(this,a);this.pd=a.lastChild;this.g=b;this.za=c;this.zb=d;this.Wd=a.ownerDocument;this.Lc=!1;this.ma=this.Oa=this.ta=this.ka=this.O=0;this.hb=this.xb=this.l=this.$a=null;this.sd=!1;this.h=this.f=this.B=null;this.Id=!0;this.Mc=this.Kc=this.Nc=0}u(wn,Ai);wn.prototype.clone=function(){var a=new wn(this.d,this.g,this.za,this.zb);Fi(a,this);a.pd=this.pd;a.Lc=this.Lc;a.l=this.l?this.l.clone():null;a.xb=this.xb.concat();return a};function xn(a,b){return a.b?b<a.ma:b>a.ma}
function yn(a,b,c){var d=new ki(b.fa,c,0);d.Ha=b.Ha;d.ea=b.ea;d.sa=b.sa;d.qa=b.qa?yn(a,b.qa,ni(c)):null;return d}function zn(a,b){var c=K("openAllViews"),d=b.ga;Rm(a.g,a.d,a.Lc);var e=d.length-1,f=null;mf(function(){for(;0<=e;){f=yn(a,d[e],f);if(0==e&&(f.da=b.da,f.J=b.J,f.J))break;var c=$m(a.g,f,0==e&&0==f.da);e--;if(c.Ca())return c}return L(!1)}).then(function(){N(c,f)});return M(c)}var An=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
function Bn(a,b){if(b.f&&b.e&&!b.J&&0==b.f.count&&1!=b.A.nodeType){var c=b.A.textContent.match(An);return fn(a.g,b,c[0].length)}return L(b)}function Cn(a,b,c){var d=K("buildViewToNextBlockEdge");nf(function(d){b.A&&c.push(ni(b));Bn(a,b).then(function(f){f!==b&&(b=f,c.push(ni(b)));cn(a.g,b).then(function(c){(b=c)?Dn(a.zb,b)?b.k&&!a.b?En(a,b).then(function(c){b=c;!b||b.d||0<a.g.e.b.length?O(d):pf(d)}):b.e?pf(d):O(d):(b=b.modify(),b.d=!0,O(d)):O(d)})})}).then(function(){N(d,b)});return M(d)}
function Fn(a,b){if(!b.A)return L(b);var c=b.Y,d=K("buildDeepElementView");nf(function(d){Bn(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.Y!=c;)g=g.parent;if(null==g){b=f;O(d);return}}cn(a.g,f).then(function(f){(b=f)&&b.Y!=c?Dn(a.zb,b)?pf(d):(b=b.modify(),b.d=!0,O(d)):O(d)})})}).then(function(){N(d,b)});return M(d)}
...
function Mn(a,b,c){if(a=ln(a.za,b))c.marginLeft=Z(a.marginLeft),c.S=Z(a.borderLeftWidth),c.j=Z(a.paddingLeft),c.marginTop=Z(a.marginTop),c.ba=Z(a.borderTopWidth),c.k=Z(a.paddingTop),c.marginRight=Z(a.marginRight),c.Za=Z(a.borderRightWidth),c.w=Z(a.paddingRight),c.marginBottom=Z(a.marginBottom),c.Ta=Z(a.borderBottomWidth),c.u=Z(a.paddingBottom)}function Nn(a,b,c){b=new un(b,c,c);a.f?a.f.push(b):a.f=[b]}
function On(a,b,c,d){if(a.f&&a.f[a.f.length-1].b)return Nn(a,b,c),L(!0);d+=40*(a.b?-1:1);var e=a.l,f=!e;if(f){var g=a.d.ownerDocument.createElement("div");w(g,"position","absolute");var h=a.g.clone(),e=new wn(g,h,a.za,a.zb);a.l=e;e.b=gn(a.g,a.b,g);e.Lc=!0;a.b?(e.left=0,w(e.d,"width","2em")):(e.top=a.Oa,w(e.d,"height","2em"))}a.d.appendChild(e.d);Mn(a,e.d,e);g=(a.b?-1:1)*(d-a.ta);a.b?e.height=a.$a.R-a.$a.W-Bi(e)-Ci(e):e.width=a.$a.V-a.$a.aa-Di(e)-Ei(e);d=(a.b?-1:1)*(a.Oa-d)-(a.b?Di(e)-Ei(e):Bi(e)+
...
function eo(a,b,c){var d=K("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,h=a.B.length-1;0<=h&&!e;--h){var e=a.B[h].d(a,f),l=a.B[h].b();l>f&&(g=Math.min(g,l))}while(g>f&&!e);var k=!1;if(!e){v.b("Could not find any page breaks?!!");if(a.Id)return fo(a,b).then(function(b){b?(b=b.modify(),b.d=!1,$n(a,b,k,!0).then(function(){N(d,b)})):N(d,b)}),M(d);e=c;k=!0}$n(a,e,k,!0).then(function(){N(d,e)});return M(d)}
...
function io(a,b){if(b.A.parentNode){var c=Kn(a,b.A),d=b.A.ownerDocument.createElement("div");a.b?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.A.parentNode.insertBefore(d,b.A);var e=d.getBoundingClientRect(),e=a.b?e.right:e.top,f=a.b?-1:1,g;switch(b.l){case "left":g=a.Nc;break;case "right":g=a.Kc;break;default:g=f*Math.max(a.Kc*f,a.Nc*f)}e*f>=g*f?b.A.parentNode.removeChild(d):(e=Math.max(1,(g-e)*
...
function jo(a,b,c){function d(){b=k[0]||b;b.A.parentNode.removeChild(b.A);e.h=h}var e=a,f=K("skipEdges"),g=c&&b&&b.J,h=null,l=null,k=[],m=[],p=!1;nf(function(a){for(;b;){do if(b.A){if(!Dn(e.zb,b)){b=b.modify();b.d=!0;O(a);return}if(b.e&&1!=b.A.nodeType){if(bi(b.A,b.w))break;if(!b.J){!c&&nl[h]?d():ho(e,l,null,!0,h)?(b=(l||b).modify(),b.d=!0):(b=b.modify(),b.h=h);O(a);return}}if(!b.J&&(b.l&&io(e,b),b.k||b.B)){k.push(ni(b));h=ll(h,b.h);!c&&nl[h]?d():ho(e,l,null,!0,h)&&(b=(l||b).modify(),b.d=!0);O(a);
...
c;pf(a)});return}b=f.oc()}ho(e,l,m,!1,h)?l&&(b=l.modify(),b.d=!0):nl[h]&&(e.h=h);O(a)}).then(function(){N(f,b)});return M(f)}
...
function xk(a,b,c,d){var e=po(b),f=qo(a,b);return new gc(a.d,function(){var b=a.b.g.b[f]?a.b.b:a.b.k[f]||null;if(b){so(a.b,f);var b=b[c]||[],h=ro(a,e,f,!0)[c]||[];return d(b.concat(h))}to(a.b,f,!1);return"??"},"target-counters-"+c+"-of-"+b)}function uo(a){this.D=a;this.h={};this.k={};this.b={};this.b.page=[0];this.w={};this.u=[];this.l={};this.g=null;this.j=[];this.d=[];this.B=[];this.e={};this.f={}}function vo(a,b){var c=a.b.page;c&&c.length?c[c.length-1]=b:a.b.page=[b]}
function wo(a,b,c){a.w=no(a.b);var d,e=b["counter-reset"];e&&(e=e.evaluate(c))&&(d=qg(e,!0));if(d)for(var f in d){var e=a,g=f,h=d[f];e.b[g]?e.b[g].push(h):e.b[g]=[h]}var l;(b=b["counter-increment"])&&(c=b.evaluate(c))&&(l=qg(c,!1));l?"page"in l||(l.page=1):l={page:1};for(var k in l)a.b[k]||(c=a,b=k,c.b[b]?c.b[b].push(0):c.b[b]=[0]),c=a.b[k],c[c.length-1]+=l[k]}function xo(a,b){a.u.push(a.b);a.b=no(b)}
function so(a,b){var c=a.e[b],d=a.f[b];d||(d=a.f[b]=[]);for(var e=!1,f=0;f<a.d.length;){var g=a.d[f];g.Fb===b?(g.dc=!0,a.d.splice(f,1),c&&(e=c.indexOf(g),0<=e&&c.splice(e,1)),d.push(g),e=!0):f++}e||to(a,b,!0)}function to(a,b,c){a.j.some(function(a){return a.Fb===b})||a.j.push(new oo(b,c))}
function yo(a,b,c){var d=Object.keys(a.g.b);if(0<d.length){var e=no(a.b);d.forEach(function(a){this.k[a]=e;var d=this.l[a];if(d&&d.G<c&&(d=this.f[a])){var f=this.e[a];f||(f=this.e[a]=[]);for(var g;g=d.shift();)g.dc=!1,f.push(g)}this.l[a]={F:b,G:c}},a)}for(var d=a.w,f;f=a.j.shift();){f.dd=d;f.F=b;f.G=c;var g;f.dc?(g=a.f[f.Fb])||(g=a.f[f.Fb]=[]):(g=a.e[f.Fb])||(g=a.e[f.Fb]=[]);g.every(function(a){return!(f===a||a&&f.Fb===a.Fb&&f.dc===a.dc&&f.F===a.F&&f.G===a.G)})&&g.push(f)}a.g=null}
function zo(a,b){var c=[];Object.keys(b.b).forEach(function(a){(a=this.e[a])&&(c=c.concat(a))},a);c.sort(function(a,b){return a.F-b.F||a.G-b.G});var d=[],e=null;c.forEach(function(a){e&&e.F===a.F&&e.G===a.G?e.xc.push(a):(e={F:a.F,G:a.G,dd:a.dd,xc:[a]},d.push(e))});return d}function Ao(a,b){a.B.push(a.d);a.d=b}function Dn(a,b){if(!b||b.J)return!0;var c=b.A;if(!c||1!==c.nodeType)return!0;c=c.getAttribute("id")||c.getAttribute("name");return c?(c=a.b.l[c])?a.G>=c.G:!0:!0};function Bo(a,b){this.e(a,"end",b)}function Co(a,b){this.e(a,"start",b)}function Do(a,b,c){c||(c=this.g.now());var d=this.f[a];d||(d=this.f[a]=[]);var e;for(a=d.length-1;0<=a&&(!(e=d[a])||e[b]);a--)e=null;e||(e={},d.push(e));e[b]=c}function Eo(){}function Fo(a){this.g=a;this.f={};this.registerEndTiming=this.d=this.registerStartTiming=this.b=this.e=Eo}
Fo.prototype.h=function(){var a=this.f,b="";Object.keys(a).forEach(function(c){for(var d=a[c],e=d.length,f=0;f<e;f++){var g=d[f];b+=c;1<e&&(b+="("+f+")");b+=" => start: "+g.start+", end: "+g.end+", duration: "+(g.end-g.start)+"\n"}});v.e(b)};Fo.prototype.j=function(){this.registerEndTiming=this.d=this.registerStartTiming=this.b=this.e=Eo};Fo.prototype.k=function(){this.e=Do;this.registerStartTiming=this.b=Co;this.registerEndTiming=this.d=Bo};
var Go={now:Date.now},Ho,Io=Ho=new Fo(window&&window.performance||Go);Do.call(Io,"load_vivliostyle","start",void 0);ba("vivliostyle.profile.profiler",Io);Fo.prototype.printTimings=Fo.prototype.h;Fo.prototype.disable=Fo.prototype.j;Fo.prototype.enable=Fo.prototype.k;function Jo(a,b,c){function d(c){return ln(a,b).getPropertyValue(c)}function e(){w(b,"display","block");w(b,"position","static");return d(Q)}function f(){w(b,"display","inline-block");w(q,Q,"99999999px");var a=d(Q);w(q,Q,"");return a}function g(){w(b,"display","inline-block");w(q,Q,"0");var a=d(Q);w(q,Q,"");return a}function h(){var a=e(),b=g(),c=parseFloat(a);if(c<=parseFloat(b))return b;b=f();return c<=parseFloat(b)?a:b}function l(){throw Error("Getting fill-available block size is not implemented");
...
R?g():d(sa);break;case "fit-content width":c=R?d(sa):h();break;case "fit-content height":c=R?h():d(sa)}Fa[a]=parseFloat(c);w(b,"position",m);w(b,"display",k)});w(b,"width",p);w(b,"height",r);t.insertBefore(b,q);t.removeChild(q);return Fa};function Ko(a){var b=a["writing-mode"],b=b&&b.value;a=(a=a.direction)&&a.value;return b===ee||b!==fe&&a!==Zd?"ltr":"rtl"}
var Lo={a5:{width:new I(148,"mm"),height:new I(210,"mm")},a4:{width:new I(210,"mm"),height:new I(297,"mm")},a3:{width:new I(297,"mm"),height:new I(420,"mm")},b5:{width:new I(176,"mm"),height:new I(250,"mm")},b4:{width:new I(250,"mm"),height:new I(353,"mm")},"jis-b5":{width:new I(182,"mm"),height:new I(257,"mm")},"jis-b4":{width:new I(257,"mm"),height:new I(364,"mm")},letter:{width:new I(8.5,"in"),height:new I(11,"in")},legal:{width:new I(8.5,"in"),height:new I(14,"in")},ledger:{width:new I(11,"in"),
height:new I(17,"in")}},Mo=new I(.24,"pt"),No=new I(3,"mm"),Oo=new I(10,"mm"),Po=new I(13,"mm");
function Qo(a){var b={width:je,height:ke,Ab:le,lb:le},c=a.size;if(c&&c.value!==td){var d=c.value;d.$c()?(c=d.values[0],d=d.values[1]):(c=d,d=null);if(c.Zb())b.width=c,b.height=d||c;else if(c=Lo[c.name.toLowerCase()])d&&d===Md?(b.width=c.height,b.height=c.width):(b.width=c.width,b.height=c.height)}(c=a.marks)&&c.value!==Qd&&(b.lb=Po);a=a.bleed;a&&a.value!==td?a.value&&a.value.Zb()&&(b.Ab=a.value):c&&(a=!1,c.value.$c()?a=c.value.values.some(function(a){return a===zd}):a=c.value===zd,a&&(b.Ab=new I(6,
"pt")));return b}function Ro(a,b){var c={},d=a.Ab.C*nc(b,a.Ab.ha,!1),e=a.lb.C*nc(b,a.lb.ha,!1),f=d+e,g=a.width;c.qb=g===je?(b.T.Ya?Math.floor(b.za/2)-b.T.Mb:b.za)-2*f:g.C*nc(b,g.ha,!1);g=a.height;c.pb=g===ke?b.hb-2*f:g.C*nc(b,g.ha,!1);c.Ab=d;c.lb=e;c.Sc=f;return c}function So(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
function To(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg",c||"polyline");a.setAttribute("stroke","black");a.setAttribute("stroke-width",b);a.setAttribute("fill","none");return a}var Uo={Be:"top left",Ce:"top right",se:"bottom left",te:"bottom right"};
function Vo(a,b,c,d,e,f){var g=d;g<=e+2*jc.mm&&(g=e+d/2);var h=Math.max(d,g),l=e+h+c/2,k=So(a,l,l),g=[[0,e+d],[d,e+d],[d,e+d-g]];d=g.map(function(a){return[a[1],a[0]]});if("top right"===b||"bottom right"===b)g=g.map(function(a){return[e+h-a[0],a[1]]}),d=d.map(function(a){return[e+h-a[0],a[1]]});if("bottom left"===b||"bottom right"===b)g=g.map(function(a){return[a[0],e+h-a[1]]}),d=d.map(function(a){return[a[0],e+h-a[1]]});l=To(a,c);l.setAttribute("points",g.map(function(a){return a.join(",")}).join(" "));
k.appendChild(l);a=To(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));k.appendChild(a);b.split(" ").forEach(function(a){k.style[a]=f+"px"});return k}var Wo={Ae:"top",re:"bottom",Sd:"left",Td:"right"};
function Xo(a,b,c,d,e){var f=2*d,g;"top"===b||"bottom"===b?(g=f,f=d):g=d;var h=So(a,g,f),l=To(a,c);l.setAttribute("points","0,"+f/2+" "+g+","+f/2);h.appendChild(l);l=To(a,c);l.setAttribute("points",g/2+",0 "+g/2+","+f);h.appendChild(l);a=To(a,c,"circle");a.setAttribute("cx",g/2);a.setAttribute("cy",f/2);a.setAttribute("r",d/4);h.appendChild(a);var k;switch(b){case "top":k="bottom";break;case "bottom":k="top";break;case "left":k="right";break;case "right":k="left"}Object.keys(Wo).forEach(function(a){a=
Wo[a];a===b?h.style[a]=e+"px":a!==k&&(h.style[a]="0",h.style["margin-"+a]="auto")});return h}function Yo(a,b,c,d){var e=!1,f=!1;if(a=a.marks)a=a.value,a.$c()?a.values.forEach(function(a){a===zd?e=!0:a===Ad&&(f=!0)}):a===zd?e=!0:a===Ad&&(f=!0);if(e||f){var g=c.N,h=g.ownerDocument,l=b.Ab,k=pd(Mo,d),m=pd(No,d),p=pd(Oo,d);e&&Object.keys(Uo).forEach(function(a){a=Vo(h,Uo[a],k,p,l,m);g.appendChild(a)});f&&Object.keys(Wo).forEach(function(a){a=Xo(h,Wo[a],k,p,m);g.appendChild(a)})}}
var Zo=function(){var a={width:!0,height:!0,"block-size":!0,"inline-size":!0,margin:!0,padding:!0,border:!0,outline:!0,"outline-width":!0,"outline-style":!0,"outline-color":!0};"left right top bottom before after start end block-start block-end inline-start inline-end".split(" ").forEach(function(b){a["margin-"+b]=!0;a["padding-"+b]=!0;a["border-"+b+"-width"]=!0;a["border-"+b+"-style"]=!0;a["border-"+b+"-color"]=!0});return a}(),$o={"top-left-corner":{Q:1,ya:!0,va:!1,wa:!0,xa:!0,la:null},"top-left":{Q:2,
...
va:!0,wa:!1,xa:!1,la:"center"},"bottom-left":{Q:12,ya:!1,va:!0,wa:!1,xa:!1,la:"start"},"bottom-left-corner":{Q:13,ya:!1,va:!0,wa:!0,xa:!1,la:null},"left-bottom":{Q:14,ya:!1,va:!1,wa:!0,xa:!1,la:"end"},"left-middle":{Q:15,ya:!1,va:!1,wa:!0,xa:!1,la:"center"},"left-top":{Q:16,ya:!1,va:!1,wa:!0,xa:!1,la:"start"}},ap=Object.keys($o).sort(function(a,b){return $o[a].Q-$o[b].Q});
function bp(a,b,c){Ql.call(this,a,null,"vivliostyle-page-rule-master",[],b,null,0);a=Qo(c);new cp(this.d,this,c,a);this.k={};dp(this,c);this.b.position=new V(Vd,0);this.b.width=new V(a.width,0);this.b.height=new V(a.height,0);for(var d in c)Zo[d]||"background-clip"===d||(this.b[d]=c[d])}u(bp,Ql);function dp(a,b){var c=b._marginBoxes;c&&ap.forEach(function(d){c[d]&&(a.k[d]=new ep(a.d,a,d,b))})}bp.prototype.f=function(a){return new fp(a,this)};
function cp(a,b,c,d){Ul.call(this,a,null,null,[],b);this.l=d;this.b["z-index"]=new V(new ld(0),0);this.b["flow-from"]=new V(H("body"),0);this.b.position=new V(qd,0);this.b.overflow=new V(ge,0);for(var e in Zo)Zo.hasOwnProperty(e)&&(this.b[e]=c[e])}u(cp,Ul);cp.prototype.f=function(a){return new gp(a,this)};
function ep(a,b,c,d){Ul.call(this,a,null,null,[],b);this.j=c;a=d._marginBoxes[this.j];for(var e in d)if(b=d[e],c=a[e],Yi[e]||c&&c.value===Hd)this.b[e]=b;for(e in a)Object.prototype.hasOwnProperty.call(a,e)&&(b=a[e])&&b.value!==Hd&&(this.b[e]=b)}u(ep,Ul);ep.prototype.f=function(a){return new hp(a,this)};function fp(a,b){Rl.call(this,a,b);this.j=null;this.ma={}}u(fp,Rl);
fp.prototype.h=function(a,b){var c=this.D,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}Rl.prototype.h.call(this,a,b)};fp.prototype.Xc=function(){var a=this.style;a.left=le;a["margin-left"]=le;a["border-left-width"]=le;a["padding-left"]=le;a["padding-right"]=le;a["border-right-width"]=le;a["margin-right"]=le;a.right=le};
fp.prototype.Yc=function(){var a=this.style;a.top=le;a["margin-top"]=le;a["border-top-width"]=le;a["padding-top"]=le;a["padding-bottom"]=le;a["border-bottom-width"]=le;a["margin-bottom"]=le;a.bottom=le};fp.prototype.S=function(a,b,c){b=b.u;var d={start:this.j.marginLeft,end:this.j.marginRight,ca:this.j.Jb},e={start:this.j.marginTop,end:this.j.marginBottom,ca:this.j.Ib};ip(this,b.top,!0,d,a,c);ip(this,b.bottom,!0,d,a,c);ip(this,b.left,!1,e,a,c);ip(this,b.right,!1,e,a,c)};
function jp(a,b,c,d,e){this.N=a;this.l=e;this.g=c;this.k=!X(d,b[c?"width":"height"],new Pc(d,0,"px"));this.h=null}jp.prototype.b=function(){return this.k};function kp(a){a.h||(a.h=Jo(a.l,a.N.d,a.g?["max-content width","min-content width"]:["max-content height","min-content height"]));return a.h}jp.prototype.e=function(){var a=kp(this);return this.g?Di(this.N)+a["max-content width"]+Ei(this.N):Bi(this.N)+a["max-content height"]+Ci(this.N)};
jp.prototype.f=function(){var a=kp(this);return this.g?Di(this.N)+a["min-content width"]+Ei(this.N):Bi(this.N)+a["min-content height"]+Ci(this.N)};jp.prototype.d=function(){return this.g?Di(this.N)+this.N.width+Ei(this.N):Bi(this.N)+this.N.height+Ci(this.N)};function lp(a){this.g=a}lp.prototype.b=function(){return this.g.some(function(a){return a.b()})};lp.prototype.e=function(){var a=this.g.map(function(a){return a.e()});return Math.max.apply(null,a)*a.length};
lp.prototype.f=function(){var a=this.g.map(function(a){return a.f()});return Math.max.apply(null,a)*a.length};lp.prototype.d=function(){var a=this.g.map(function(a){return a.d()});return Math.max.apply(null,a)*a.length};function mp(a,b,c,d,e,f){jp.call(this,a,b,c,d,e);this.j=f}u(mp,jp);mp.prototype.b=function(){return!1};mp.prototype.e=function(){return this.d()};mp.prototype.f=function(){return this.d()};mp.prototype.d=function(){return this.g?Di(this.N)+this.j+Ei(this.N):Bi(this.N)+this.j+Ci(this.N)};
function ip(a,b,c,d,e,f){var g=a.d.d,h={},l={},k={},m;for(m in b){var p=$o[m];if(p){var r=b[m],t=a.ma[m],q=new jp(r,t.style,c,g,f);h[p.la]=r;l[p.la]=t;k[p.la]=q}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.ca.evaluate(e);var x=np(k,b),R=!1,Q={};Object.keys(h).forEach(function(a){var b=X(g,l[a].style[c?"max-width":"max-height"],d.ca);b&&(b=b.evaluate(e),x[a]>b&&(b=k[a]=new mp(h[a],l[a].style,c,g,f,b),Q[a]=b.d(),R=!0))});R&&(x=np(k,b),R=!1,["start","center","end"].forEach(function(a){x[a]=Q[a]||x[a]}));
var sa={};Object.keys(h).forEach(function(a){var b=X(g,l[a].style[c?"min-width":"min-height"],d.ca);b&&(b=b.evaluate(e),x[a]<b&&(b=k[a]=new mp(h[a],l[a].style,c,g,f,b),sa[a]=b.d(),R=!0))});R&&(x=np(k,b),["start","center","end"].forEach(function(a){x[a]=sa[a]||x[a]}));var Fa=a+b,ia=a+(a+b);["start","center","end"].forEach(function(a){var b=x[a];if(b){var d=h[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(ia-b)/2;break;case "end":e=Fa-b}c?Hi(d,e,b-Di(d)-Ei(d)):Gi(d,e,b-Bi(d)-
Ci(d))}})}function np(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=op(d,g.length?new lp(g):null,b);g.Sa&&(f.center=g.Sa);d=g.Sa||d.d();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=op(c,e,b),c.Sa&&(f.start=c.Sa),c.lc&&(f.end=c.lc);return f}
function op(a,b,c){var d={Sa:null,lc:null};if(a&&b)if(a.b()&&b.b()){var e=a.e(),f=b.e();0<e&&0<f?(f=e+f,f<c?d.Sa=c*e/f:(a=a.f(),b=b.f(),b=a+b,b<c?d.Sa=a+(c-b)*(e-a)/(f-b):0<b&&(d.Sa=c*a/b)),0<d.Sa&&(d.lc=c-d.Sa)):0<e?d.Sa=c:0<f&&(d.lc=c)}else a.b()?d.Sa=Math.max(c-b.d(),0):b.b()&&(d.lc=Math.max(c-a.d(),0));else a?a.b()&&(d.Sa=c):b&&b.b()&&(d.lc=c);return d}fp.prototype.sb=function(a,b,c,d,e){fp.Rd.sb.call(this,a,b,c,d,e);b.d.setAttribute("data-vivliostyle-page-box",!0)};
function gp(a,b){Vl.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.Ib=this.Jb=null}u(gp,Vl);
gp.prototype.h=function(a,b){var c=this.D,d;for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(d.match(/^column.*$/)||d.match(/^background-/))&&(c[d]=b[d]);Vl.prototype.h.call(this,a,b);d=this.e;c={Jb:this.Jb,Ib:this.Ib,marginTop:this.marginTop,marginRight:this.marginRight,marginBottom:this.marginBottom,marginLeft:this.marginLeft};d.j=c;d=d.style;d.width=new J(c.Jb);d.height=new J(c.Ib);d["padding-left"]=new J(c.marginLeft);d["padding-right"]=new J(c.marginRight);d["padding-top"]=new J(c.marginTop);
d["padding-bottom"]=new J(c.marginBottom)};gp.prototype.Xc=function(){var a=pp(this,{start:"left",end:"right",ca:"width"});this.Jb=a.Hd;this.marginLeft=a.Pd;this.marginRight=a.Od};gp.prototype.Yc=function(){var a=pp(this,{start:"top",end:"bottom",ca:"height"});this.Ib=a.Hd;this.marginTop=a.Pd;this.marginBottom=a.Od};
function pp(a,b){var c=a.style,d=a.d.d,e=b.start,f=b.end,g=b.ca,h=a.d.l[g].ja(d,null),l=X(d,c[g],h),k=X(d,c["margin-"+e],h),m=X(d,c["margin-"+f],h),p=Wl(d,c["padding-"+e],h),r=Wl(d,c["padding-"+f],h),t=Yl(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),q=Yl(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),x=E(d,h,D(d,D(d,t,p),D(d,q,r)));l?(x=E(d,x,l),k||m?k?m=E(d,x,k):k=E(d,x,m):m=k=Xc(d,x,new B(d,.5))):(k||(k=d.b),m||(m=d.b),l=E(d,x,D(d,k,m)));c[e]=new J(k);c[f]=new J(m);c["margin-"+e]=
le;c["margin-"+f]=le;c["padding-"+e]=new J(p);c["padding-"+f]=new J(r);c["border-"+e+"-width"]=new J(t);c["border-"+f+"-width"]=new J(q);c[g]=new J(l);c["max-"+g]=new J(l);return{Hd:E(d,h,D(d,k,m)),Pd:k,Od:m}}gp.prototype.sb=function(a,b,c,d,e){Vl.prototype.sb.call(this,a,b,c,d,e);c.w=b.d};function hp(a,b){Vl.call(this,a,b);var c=b.j;this.j=$o[c];a.ma[c]=this;this.oa=!0}u(hp,Vl);n=hp.prototype;
n.sb=function(a,b,c,d,e){var f=b.d;w(f,"display","flex");var g=hm(this,a,"vertical-align"),h=null;g===H("middle")?h="center":g===H("top")?h="flex-start":g===H("bottom")&&(h="flex-end");h&&(w(f,"flex-flow",this.b?"row":"column"),w(f,"justify-content",h));Vl.prototype.sb.call(this,a,b,c,d,e)};
...
function qp(a,b,c){function d(a){if(x)return x;x={ca:q?q.evaluate(a):null,La:l?l.evaluate(a):null,Ma:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[r,m,p,t].forEach(function(b){b&&(c+=b.evaluate(a))});(null===x.La||null===x.Ma)&&c+x.ca+x.La+x.Ma>b&&(null===x.La&&(x.La=0),null===x.Ma&&(x.He=0));null!==x.ca&&null!==x.La&&null!==x.Ma&&(x.Ma=null);null===x.ca&&null!==x.La&&null!==x.Ma?x.ca=b-c-x.La-x.Ma:null!==x.ca&&null===x.La&&null!==x.Ma?x.La=b-c-x.ca-x.Ma:null!==x.ca&&null!==x.La&&null===x.Ma?x.Ma=
b-c-x.ca-x.La:null===x.ca?(x.La=x.Ma=0,x.ca=b-c):x.La=x.Ma=(b-c-x.ca)/2;return x}var e=a.style;a=a.d.d;var f=b.Zc,g=b.cd;b=b.ca;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],l=Xl(a,e["margin-"+f],h),k=Xl(a,e["margin-"+g],h),m=Wl(a,e["padding-"+f],h),p=Wl(a,e["padding-"+g],h),r=Yl(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),t=Yl(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),q=X(a,e[b],h),x=null;e[b]=new J(new gc(a,function(){var a=d(this).ca;return null===a?0:a},b));e["margin-"+
f]=new J(new gc(a,function(){var a=d(this).La;return null===a?0:a},"margin-"+f));e["margin-"+g]=new J(new gc(a,function(){var a=d(this).Ma;return null===a?0:a},"margin-"+g));"left"===f?e.left=new J(D(a,c.marginLeft,c.Jb)):"top"===f&&(e.top=new J(D(a,c.marginTop,c.Ib)))}n.Xc=function(){var a=this.e.j;this.j.wa?qp(this,{Zc:"right",cd:"left",ca:"width"},a):this.j.xa?qp(this,{Zc:"left",cd:"right",ca:"width"},a):this.la({start:"left",end:"right",ca:"width"},a)};
n.Yc=function(){var a=this.e.j;this.j.ya?qp(this,{Zc:"bottom",cd:"top",ca:"height"},a):this.j.va?qp(this,{Zc:"top",cd:"bottom",ca:"height"},a):this.la({start:"top",end:"bottom",ca:"height"},a)};n.uc=function(a,b,c,d,e,f,g){Vl.prototype.uc.call(this,a,b,c,d,e,f,g);a=c.u;c=this.d.j;d=this.j;d.wa||d.xa?d.ya||d.va||(d.wa?a.left[c]=b:d.xa&&(a.right[c]=b)):d.ya?a.top[c]=b:d.va&&(a.bottom[c]=b)};
function rp(a,b,c,d,e){this.b=a;this.h=b;this.f=c;this.d=d;this.e=e;this.g={};a=this.h;b=new Qc(a,"page-number");b=new Ic(a,new Oc(a,b,new B(a,2)),a.b);c=new yc(a,b);a.values["recto-page"]=c;a.values["verso-page"]=b;"ltr"===Ko(this.e)?(a.values["left-page"]=b,b=new yc(a,b),a.values["right-page"]=b):(c=new yc(a,b),a.values["left-page"]=c,a.values["right-page"]=b)}function sp(a){var b={};Ek(a.b,[],"",b);a.b.pop();return b}
function tp(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof V?e.value+"":tp(a,e);c.push(d+f+(e.Ga||""))}return c.sort().join("^")}function up(a,b,c){c=c.clone({tb:"vivliostyle-page-rule-master"});var d=c.b,e=b.size;if(e){var f=Qo(b),e=e.Ga;d.width=jj(a.d,d.width,new V(f.width,e));d.height=jj(a.d,d.height,new V(f.height,e))}["counter-reset","counter-increment"].forEach(function(a){d[a]&&(b[a]=d[a])});c=c.f(a.f);c.h(a.b,a.e);vm(c,a.d);return c}
function vp(a){this.b=null;this.f=a}u(vp,W);vp.prototype.apply=function(a){a.S===this.f&&this.b.apply(a)};vp.prototype.d=function(){return 3};vp.prototype.e=function(a){this.b&&yj(a.$b,this.f,this.b);return!0};function wp(a){this.b=null;this.f=a}u(wp,W);wp.prototype.apply=function(a){1===(new Qc(this.f,"page-number")).evaluate(a.h)&&this.b.apply(a)};wp.prototype.d=function(){return 2};function xp(a){this.b=null;this.f=a}u(xp,W);
xp.prototype.apply=function(a){(new Qc(this.f,"left-page")).evaluate(a.h)&&this.b.apply(a)};xp.prototype.d=function(){return 1};function yp(a){this.b=null;this.f=a}u(yp,W);yp.prototype.apply=function(a){(new Qc(this.f,"right-page")).evaluate(a.h)&&this.b.apply(a)};yp.prototype.d=function(){return 1};function zp(a){this.b=null;this.f=a}u(zp,W);zp.prototype.apply=function(a){(new Qc(this.f,"recto-page")).evaluate(a.h)&&this.b.apply(a)};zp.prototype.d=function(){return 1};
function Ap(a){this.b=null;this.f=a}u(Ap,W);Ap.prototype.apply=function(a){(new Qc(this.f,"verso-page")).evaluate(a.h)&&this.b.apply(a)};Ap.prototype.d=function(){return 1};function Bp(a,b){wj.call(this,a,b,null,null)}u(Bp,wj);Bp.prototype.apply=function(a){var b=a.h,c=a.u,d=this.style;a=this.P;pj(b,c,d,a,null,null);if(d=d._marginBoxes){var c=nj(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);pj(b,f,d[e],a,null,null)}}};
function Cp(a,b,c,d,e){Pk.call(this,a,b,null,c,null,d,!1);this.I=e;this.B=[];this.e="";this.u=[]}u(Cp,Pk);n=Cp.prototype;n.Ob=function(){this.fb()};n.ib=function(a,b){if(this.e=b)this.b.push(new vp(b)),this.P+=65536};
n.ac=function(a,b){b&&Hf(this,"E_INVALID_PAGE_SELECTOR :"+a+"("+b.join("")+")");this.u.push(":"+a);switch(a.toLowerCase()){case "first":this.b.push(new wp(this.d));this.P+=256;break;case "left":this.b.push(new xp(this.d));this.P+=1;break;case "right":this.b.push(new yp(this.d));this.P+=1;break;case "recto":this.b.push(new zp(this.d));this.P+=1;break;case "verso":this.b.push(new Ap(this.d));this.P+=1;break;default:Hf(this,"E_INVALID_PAGE_SELECTOR :"+a)}};
function Dp(a){var b;a.e||a.u.length?b=[a.e].concat(a.u.sort()):b=null;a.B.push({Cd:b,P:a.P});a.e="";a.u=[]}n.Lb=function(){Dp(this);Pk.prototype.Lb.call(this)};n.ra=function(){Dp(this);Pk.prototype.ra.call(this)};
n.eb=function(a,b,c){if("bleed"!==a&&"marks"!==a||this.B.some(function(a){return null===a.Cd})){Pk.prototype.eb.call(this,a,b,c);var d=this.h[a],e=this.I;if("bleed"===a||"marks"===a)e[""]||(e[""]={}),Object.keys(e).forEach(function(b){mj(e[b],a,d)});else if("size"===a){var f=e[""];this.B.forEach(function(b){var c=new V(d.value,d.Ga+b.P);b=b.Cd?b.Cd.join(""):"";var l=e[b];l?(c=(b=l[a])?jj(null,c,b):c,mj(l,a,c)):(l=e[b]={},mj(l,a,c),f&&["bleed","marks"].forEach(function(a){f[a]&&mj(l,a,f[a])},this))},
this)}}};n.Ld=function(a){yj(this.g.$b,"*",a)};n.Nd=function(a){return new Bp(this.h,a)};n.kd=function(a){var b=nj(this.h,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);Df(this.$,new Ep(this.d,this.$,this.k,c))};function Ep(a,b,c,d){Ef.call(this,a,b,!1);this.e=c;this.b=d}u(Ep,Ff);Ep.prototype.cb=function(a,b,c){eh(this.e,a,b,c,this)};Ep.prototype.Yb=function(a,b){Gf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Ep.prototype.Ic=function(a,b){Gf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
Ep.prototype.eb=function(a,b,c){mj(this.b,a,new V(b,c?Af(this):Bf(this)))};var Fp=new wf(function(){var a=K("uaStylesheetBase");uf(fh).then(function(b){var c=va("user-agent-base.css",ua);b=new Pk(null,null,null,null,null,b,!0);b.Pb("UA");Ok=b.g;fg(c,b,null,null).ua(a)});return M(a)},"uaStylesheetBaseFetcher");
function Gp(a,b,c,d,e,f,g,h,l,k){this.h=a;this.d=b;this.b=c;this.e=d;this.B=e;this.g=f;this.l=a.H;this.u=g;this.f=h;this.k=l;this.w=k;this.j=a.f;ic(this.b,function(a){var b=this.b,c;c=(c=b.b[a])?(c=c.b[0])?c.b:null:null;var d;d=b.b[a];if(d=Hp(this,d?d.d:"any"))d=(a=b.b[a])?0<a.b.length&&a.b[0].b.d<=this.l:!1;return d&&!!c&&!Ip(this,c)});hc(this.b,new gc(this.b,function(){return this.ma+this.b.page},"page-number"))}
...
function Kp(a,b,c,d,e,f,g,h,l,k,m){lc.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.Z=b;this.lang=b.lang||c;this.viewport=d;this.g={body:!0};this.e=e;this.k=this.b=this.B=this.d=this.u=null;this.l=0;this.ab=f;this.h=new mh(this.style.l);this.ka={};this.O=null;this.f=m;this.I={};this.ba=null;this.Ta=g;this.$a=h;this.ma=l;this.Za=k;for(var p in a.f)(b=a.f[p]["flow-consume"])&&(b.evaluate(this,"flow-consume")==rd?this.g[p]=!0:delete this.g[p]);this.oa={}}u(Kp,lc);
function Lp(a){var b=K("StyleInstance.init"),c=new Om(a.f,a.Z.url),d=new Pm(a.f,a.Z.url,a.style.d,a.style.b);a.d=new tl(a.Z,a.style.e,a.style.d,a,a.g,a.style.j,c,d);d.f=a.d;Gl(a.d,a);a.B={};a.B[a.Z.url]=a.d;var e=Dl(a.d);a.ba=Ko(e);a.u=new wm(a.style.B);c=new Bk(a.style.e,a,c,d);a.u.h(c,e);vm(a.u,a);a.O=new rp(c,a.style.b,a.u,a,e);e=[];for(c=0;c<a.style.g.length;c++)if(d=a.style.g[c],!d.M||d.M.evaluate(a))d=jh(d.Cb,a),d=new kh(d),e.push(d);sh(a.ab,e,a.h).ua(b);var f=a.style.w;Object.keys(f).forEach(function(a){var b=
Ro(Qo(f[a]),this);this.oa[a]={width:b.qb+2*b.Sc,height:b.pb+2*b.Sc}},a);return M(b)}function Hl(a,b,c){if(a=a.b)a.e[b.b]||(a.e[b.b]=c),c=a.b[b.b],c||(c=new wi,a.b[b.b]=c),c.b.push(new vi(new ti({ga:[{fa:b.g,Ha:0,ea:null,sa:null,qa:null}],da:0,J:!1}),b))}function Mp(a,b){for(var c=Number.POSITIVE_INFINITY,d=0;d<b.b.length;d++){for(var e=b.b[d].d.Na,f=e.ga[0].fa,g=e.da,h=e.J,l=0;f.ownerDocument!=a.Z.b;)l++,f=e.ga[l].fa,h=!1,g=0;e=xh(a.Z,f,g,h);e<c&&(c=e)}return c}
function Np(a,b){if(!b)return 0;var c=Number.POSITIVE_INFINITY,d;for(d in a.g){var e=b.b[d];if((!e||0==e.b.length)&&a.b){e=a.d;e.D=d;for(var f=0;null!=e.D&&(f+=5E3,El(e,f,0)!=Number.POSITIVE_INFINITY););e=a.b.b[d];b!=a.b&&e&&(e=e.clone(),b.b[d]=e)}e&&(e=Mp(a,e),e<c&&(c=e))}return c}function Hp(a,b){switch(b){case "left":case "right":case "recto":case "verso":return(new Qc(a.style.b,b+"-page")).evaluate(a);default:return!0}}
function Op(a,b){var c=a.b,d=Np(a,c);if(d==Number.POSITIVE_INFINITY)return null;for(var e=a.u.children,f,g=0;g<e.length;g++)if(f=e[g],"vivliostyle-page-rule-master"!==f.d.tb){var h=1,l=hm(f,a,"utilization");l&&l.zd()&&(h=l.C);var l=nc(a,"em",!1),k=a.qb()*a.pb();a.l=El(a.d,d,Math.ceil(h*k/(l*l)));h=a;l=c;k=void 0;for(k in l.b){var m=l.b[k];if(m&&0<m.b.length){var p=m.b[0].b;if(Mp(h,m)===p.d){a:switch(p=m.d,p){case "left":case "right":case "recto":case "verso":break a;default:p=null}m.d=on(ll(p,m.b[0].b.e))}}}a.k=
c.clone();h=a;l=h.b.page;k=void 0;for(k in h.b.b)for(m=h.b.b[k],p=m.b.length-1;0<=p;p--){var r=m.b[p];0>r.b.Qa&&r.b.d<h.l&&(r.b.Qa=l)}mc(a,a.style.b);h=hm(f,a,"enabled");if(!h||h===he){c=a;v.debug("Location - page",c.b.page);v.debug("  current:",d);v.debug("  lookup:",c.l);d=void 0;for(d in c.b.b)for(e=c.b.b[d],g=0;g<e.b.length;g++)v.debug("  Chunk",d+":",e.b[g].b.d);d=a.O;e=f;f=b;c=e.d;0===Object.keys(f).length?(c.d.e=c,f=e):(e=c,g=tp(d,f),e=e.g+"^"+g,g=d.g[e],g||("background-host"===c.tb?(c=d,f=
(new bp(c.h,c.f.d,f)).f(c.f),f.h(c.b,c.e),vm(f,c.d),g=f):g=up(d,f,c),d.g[e]=g),f=g.d,f.d.e=f,f=g);return f}}throw Error("No enabled page masters");}function Ip(a,b){var c=a.k.e,d=c[b.b].d;if(d){var e=b.d,f=c[d].b;if(!f.length||e<f[0])return!1;var c=Qa(f.length,function(a){return f[a]>e})-1,c=f[c],d=a.k.b[d],g=Mp(a,d);return c<g?!1:g<c?!0:!Hp(a,d.d)}return!1}
function Pp(a,b,c){var d=a.b.b[c];if(!d||!Hp(a,d.d))return L(!0);d.d="any";Pn(b);a.g[c]&&0<b.hb.length&&(b.Id=!1);var e=K("layoutColumn"),f=[],g=[],h=!0;nf(function(c){for(;0<d.b.length-g.length;){for(var e=0;0<=g.indexOf(e);)e++;var m=d.b[e];if(m.b.d>a.l||Ip(a,m.b))break;for(var p=e+1;p<d.b.length;p++)if(!(0<=g.indexOf(p))){var r=d.b[p];if(r.b.d>a.l||Ip(a,r.b))break;ei(r.b,m.b)&&(m=r,e=p)}var t=m.b,q=!0;Sn(b,m.d,h).then(function(a){h=!1;m.b.ie&&(null===a||t.f)&&f.push(e);t.f?(g.push(e),O(c)):(a?
...
function Qp(a,b,c,d,e,f,g,h){am(c);var l=hm(c,a,"enabled");if(l&&l!==he)return L(!0);var k=K("layoutContainer"),m=hm(c,a,"wrap-flow")===td,p=c.b?c.g&&c.H:c.f&&c.I,l=hm(c,a,"flow-from"),r=a.viewport.b.createElement("div"),t=hm(c,a,"position");w(r,"position",t?t.name:"absolute");d.insertBefore(r,d.firstChild);var q=new Ai(r);q.b=c.b;c.sb(a,q,b,a.h,a.e);q.D=e;q.H=f;e+=q.left+q.marginLeft+q.S;f+=q.top+q.marginTop+q.ba;if(l&&l.Md())if(a.I[l.toString()])c.uc(a,q,b,null,1,a.e,a.h),l=L(!0);else{var x=K("layoutContainer.inner"),
R=l.toString(),Q=Y(c,a,"column-count"),sa=Y(c,a,"column-gap"),Fa=1<Q?Y(c,a,"column-width"):q.width,l=gm(c,a),ia=0,t=hm(c,a,"shape-inside"),F=og(t,0,0,q.width,q.height,a),T=new Mm(R,a,a.viewport,a.d,l,a.Z,a.h,a.style.u,a,b,a.Ta,a.$a,h,a.Za),zl=new mo(a.f,a.b.page-1),ai=0,ca=null;nf(function(b){for(;ai<Q;){var c=ai++;if(1<Q){var d=a.viewport.b.createElement("div");w(d,"position","absolute");r.appendChild(d);ca=new wn(d,T,a.e,zl);ca.b=q.b;ca.ab=q.ab;ca.mc=q.mc;q.b?(w(d,"margin-left",q.j+"px"),w(d,"margin-right",
q.w+"px"),c=c*(Fa+sa)+q.k,Hi(ca,0,q.width),Gi(ca,c,Fa)):(w(d,"margin-top",q.k+"px"),w(d,"margin-bottom",q.u+"px"),c=c*(Fa+sa)+q.j,Gi(ca,0,q.height),Hi(ca,c,Fa));ca.D=e+q.j;ca.H=f+q.k}else ca=new wn(r,T,a.e,zl),Fi(ca,q),q=ca;ca.I=p?[]:g;ca.yb=F;if(0<=ca.width){var k=K("inner");Pp(a,ca,R).then(function(){ca.h&&"column"!=ca.h&&(ai=Q,"region"!=ca.h&&(a.I[R]=!0));N(k,!0)});c=M(k)}else c=L(!0);if(c.Ca()){c.then(function(){0<h.b.length?O(b):(ia=Math.max(ia,ca.e),pf(b))});return}0<h.b.length||(ia=Math.max(ia,
ca.e))}O(b)}).then(function(){q.e=ia;c.uc(a,q,b,ca,Q,a.e,a.h);N(x,!0)});l=M(x)}else{l=hm(c,a,"content");t=!1;if(l&&Ji(l)){var Bl=a.viewport.b.createElement("span");l.U(new Ii(Bl,a));r.appendChild(Bl);um(c,a,q,a.h)}else c.oa&&(d.removeChild(r),t=!0);t||c.uc(a,q,b,null,1,a.e,a.h);l=L(!0)}l.then(function(){if(!c.f||0<Math.floor(q.e)){if(!m){var l=q.D+q.left,p=q.H+q.top,t=Di(q)+q.width+Ei(q),x=Bi(q)+q.height+Ci(q),F=hm(c,a,"shape-outside"),l=og(F,l,p,t,x,a);$a(a.viewport.root)&&g.push(we(l,0,-1.25*nc(a,
"em",!1)));g.push(l)}}else if(0==c.children.length){d.removeChild(r);N(k,!0);return}var Q=c.children.length-1;mf(function(){for(;0<=Q;){var d=c.children[Q--],d=Qp(a,b,d,r,e,f,g,h);if(d.Ca())return d}return L(!1)}).then(function(){N(k,!0)})});return M(k)}
function Rp(a,b,c){a.I={};c?(a.b=c.clone(),wl(a.d,c.d)):(a.b=new yi,wl(a.d,-1));a.lang&&b.d.setAttribute("lang",a.lang);c=a.b;c.page++;mc(a,a.style.b);a.k=c.clone();var d=sp(a.O),e=Op(a,d);if(!e)return L(null);e.d.b.width.value===je&&Wh(b);e.d.b.height.value===ke&&Xh(b);a.f.g=b;wo(a.f,d,a);var f=Ro(Qo(d),a);Sp(a,f,b);Yo(d,f,b,a);var g=f.lb+f.Ab,d=hm(e,a,"writing-mode")||Gd,f=hm(e,a,"direction")||Pd,h=new Pi(b.B.bind(b),d,f),l=[],k=K("layoutNextPage");nf(function(d){Qp(a,b,e,b.d,g,g,l.concat(),h).then(function(){if(0<
h.b.length){l=l.concat(Ui(h));h.b.splice(0,h.b.length);c=a.b=a.k.clone();for(var e;e=b.d.lastChild;)b.d.removeChild(e);pf(d)}else O(d)})}).then(function(){e.S(a,b,a.e);var d=new Qc(e.d.d,"left-page");b.j=d.evaluate(a)?"left":"right";var d=a.b.page,f;for(f in a.b.b)for(var g=a.b.b[f],h=g.b.length-1;0<=h;h--){var l=g.b[h];0<=l.b.Qa&&l.b.Qa+l.b.j-1<=d&&g.b.splice(h,1)}a.b=a.k=null;c.d=a.d.b;Zh(b,a.style.h.D[a.Z.url]);var x;a:{for(x in a.g)if((f=c.b[x])&&0<f.b.length){x=!1;break a}x=!0}x&&(c=null);N(k,
c)});return M(k)}function Sp(a,b,c){a.H=b.qb;a.D=b.pb;c.N.style.width=b.qb+2*b.Sc+"px";c.N.style.height=b.pb+2*b.Sc+"px";c.d.style.left=b.lb+"px";c.d.style.right=b.lb+"px";c.d.style.top=b.lb+"px";c.d.style.bottom=b.lb+"px";c.d.style.padding=b.Ab+"px"}function Tp(a,b,c,d){Pk.call(this,a.g,a,b,c,d,a.f,!c);this.e=a;this.u=!1}u(Tp,Pk);n=Tp.prototype;n.Ec=function(){};n.Dc=function(a,b,c){a=new Ql(this.e.j,a,b,c,this.e.w,this.M,Bf(this.$));Df(this.e,new Bm(a.d,this.e,a,this.k))};
n.Eb=function(a){a=a.d;null!=this.M&&(a=Wc(this.d,this.M,a));Df(this.e,new Tp(this.e,a,this,this.w))};n.Ac=function(){Df(this.e,new Vk(this.d,this.$))};n.Cc=function(){var a={};this.e.k.push({Cb:a,M:this.M});Df(this.e,new Wk(this.d,this.$,null,a,this.e.f))};n.Bc=function(a){var b=this.e.h[a];b||(b={},this.e.h[a]=b);Df(this.e,new Wk(this.d,this.$,null,b,this.e.f))};n.Gc=function(){var a={};this.e.B.push(a);Df(this.e,new Wk(this.d,this.$,this.M,a,this.e.f))};
n.ec=function(a){var b=this.e.l;if(a){var c=nj(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Df(this.e,new Wk(this.d,this.$,null,b,this.e.f))};n.Fc=function(){this.u=!0;this.fb()};n.Ob=function(){var a=new Cp(this.e.j,this.e,this,this.k,this.e.u);Df(this.e,a);a.Ob()};n.ra=function(){Pk.prototype.ra.call(this);if(this.u){this.u=!1;var a="R"+this.e.H++,b=H(a),c;this.M?c=new ij(b,0,this.M):c=new V(b,0);oj(this.h,"region-id").push(c);this.nb();a=new Tp(this.e,this.M,this,a);Df(this.e,a);a.ra()}};
function Up(a){var b=a.getAttribute("content");if(!b)return"";a={};for(var c;null!=(c=b.match(/^,?\s*([-A-Za-z_.][-A-Za-z_0-9.]*)\s*=\s*([-+A-Za-z_0-9.]*)\s*/));)b=b.substr(c[0].length),a[c[1]]=c[2];b=a.width-0;a=a.height-0;return b&&a?"@-epubx-viewport{width:"+b+"px;height:"+a+"px;}":""}function Vp(a){Cf.call(this);this.f=a;this.g=new ec(null);this.j=new ec(this.g);this.w=new Nl(this.g);this.D=new Tp(this,null,null,null);this.H=0;this.k=[];this.l={};this.h={};this.B=[];this.u={};this.b=this.D}
u(Vp,Cf);Vp.prototype.error=function(a){v.b("CSS parser:",a)};function Wp(a,b){return Xp(b,a)}function Yp(a){tf.call(this,Wp,"document");this.H=a;this.B={};this.h={};this.b={};this.D={};this.f=null;this.j=[]}u(Yp,tf);function Zp(a){var b=va("user-agent.xml",ua),c=K("OPSDocStore.init");uf(fh).then(function(d){a.f=d;uf(Fp).then(function(){a.load(b).then(function(){N(c,!0)})})});return M(c)}function $p(a,b){a.j.push({url:b.url,text:b.text,bb:"User",Ba:null,media:null})}
function Xp(a,b){var c=K("OPSDocStore.load"),d=b.url;Fh(b,a).then(function(b){if(b){for(var f=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),h=0;h<g.length;h++){var l=g[h],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=l.getAttribute("action"),l=l.getAttribute("ref");k&&m&&p&&l&&f.push({fe:k,event:m,action:p,cc:l})}a.D[d]=f;var r=[],f=va("user-agent-page.css",ua);r.push({url:f,text:null,
bb:"UA",Ba:null,media:null});for(h=0;h<a.j.length;h++)r.push(a.j[h]);if(f=b.h)for(f=f.firstChild;f;f=f.nextSibling)if(1==f.nodeType)if(g=f,h=g.namespaceURI,k=g.localName,"http://www.w3.org/1999/xhtml"==h)if("style"==k)r.push({url:d,text:g.textContent,bb:"Author",Ba:null,media:null});else if("link"==k){if(m=g.getAttribute("rel"),h=g.getAttribute("class"),k=g.getAttribute("media"),"stylesheet"==m||"alternate stylesheet"==m&&h)g=g.getAttribute("href"),g=va(g,d),r.push({url:g,text:null,Ba:h,media:k,bb:"Author"})}else"meta"==
k&&"viewport"==g.getAttribute("name")&&r.push({url:d,text:Up(g),bb:"Author",M:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==h?"stylesheet"==k&&"text/css"==g.getAttribute("type")&&r.push({url:d,text:g.textContent,bb:"Author",Ba:null,media:null}):"http://example.com/sse"==h&&"property"===k&&(h=g.getElementsByTagName("name")[0])&&"stylesheet"===h.textContent&&(g=g.getElementsByTagName("value")[0])&&(g=va(g.textContent,d),r.push({url:g,text:null,Ba:null,media:null,bb:"Author"}));
for(var t="",h=0;h<r.length;h++)t+=r[h].url,t+="^",r[h].text&&(t+=r[h].text),t+="^";var q=a.B[t];q?(a.b[d]=q,N(c,b)):(f=a.h[t],f||(f=new wf(function(){var b=K("fetchStylesheet"),c=0,d=new Vp(a.f);mf(function(){if(c<r.length){var a=r[c++];d.Pb(a.bb);return null!==a.text?gg(a.text,d,a.url,a.Ba,a.media).ld(!0):fg(a.url,d,a.Ba,a.media)}return L(!1)}).then(function(){q=new Gp(a,d.g,d.j,d.D.g,d.w,d.k,d.l,d.h,d.B,d.u);a.B[t]=q;delete a.h[t];N(b,q)});return M(b)},"FetchStylesheet "+d),a.h[t]=f,f.start()),
uf(f).then(function(f){a.b[d]=f;N(c,b)}))}else N(c,null)});return M(c)};function aq(a,b,c,d,e,f,g,h,l,k){this.b=a;this.url=b;this.lang=c;this.d=d;this.h=e;this.T=Xb(f);this.j=g;this.g=h;this.f=l;this.e=k;this.Ja=this.page=null}function bq(a,b,c){if(0!=c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=Ha(d,"height","auto")&&(w(d,"height","auto"),bq(a,d,c));"absolute"==Ha(d,"position","static")&&(w(d,"position","relative"),bq(a,d,c))}}
function cq(a){var b=a.target,c="\u25b8"==b.textContent;b.textContent=c?"\u25be":"\u25b8";for(b=b.parentNode.firstChild;b;)if(1!=b.nodeType)b=b.nextSibling;else{var d=b;"toc-container"==d.getAttribute("data-adapt-class")?b=d.firstChild:("toc-node"==d.getAttribute("data-adapt-class")&&(d.style.height=c?"auto":"0px"),b=b.nextSibling)}a.stopPropagation()}
aq.prototype.ad=function(a){var b=this.j.ad(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",w(e,"cursor","pointer"),e.addEventListener("click",cq,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
aq.prototype.zc=function(a,b,c,d,e){if(this.page)return L(this.page);var f=this,g=K("showTOC"),h=new Vh(a,a);this.page=h;this.b.load(this.url).then(function(d){var k=f.b.b[d.url],m=Jp(k,c,1E5,e);b=new mn(b.f,m.fontSize,b.root,m.width,m.height);var p=new Kp(k,d,f.lang,b,f.d,f.h,f.ad(d),f.g,0,f.f,f.e);f.Ja=p;p.T=f.T;Lp(p).then(function(){Rp(p,h,null).then(function(){bq(f,a,2);N(g,h)})})});return M(g)};
aq.prototype.vc=function(){if(this.page){var a=this.page;this.Ja=this.page=null;w(a.N,"visibility","none");var b=a.N.parentNode;b&&b.removeChild(a.N)}};aq.prototype.Ad=function(){return!!this.page};function dq(){Yp.call(this,eq(this));this.d=new tf(Fh,"document");this.u=new tf(xf,"text");this.w={};this.O={};this.k={};this.l={}}u(dq,Yp);function eq(a){return function(b){return a.k[b]}}
function fq(a,b,c){var d=K("loadEPUBDoc");"/"!==b.substring(b.length-1)&&(b+="/");c&&a.u.sc(b+"?r=list");a.d.sc(b+"META-INF/encryption.xml");var e=b+"META-INF/container.xml";a.d.load(e,!0,"Failed to fetch EPUB container.xml from "+e).then(function(f){if(f){f=Ph(uh(uh(uh(new vh([f.b]),"container"),"rootfiles"),"rootfile"),"full-path");for(var g=0;g<f.length;g++){var h=f[g];if(h){gq(a,b,h,c).ua(d);return}}N(d,null)}else v.error("Received an empty response for EPUB container.xml "+e+". This may be caused by the server not allowing cross origin requests.")});
return M(d)}function gq(a,b,c,d){var e=b+c,f=a.w[e];if(f)return L(f);var g=K("loadOPF");a.d.load(e,void 0,void 0).then(function(c){c?a.d.load(b+"META-INF/encryption.xml",void 0,void 0).then(function(l){(d?a.u.load(b+"?r=list"):L(null)).then(function(d){f=new hq(a,b);iq(f,c,l,d,b+"?r=manifest").then(function(){a.w[e]=f;a.O[b]=f;N(g,f)})})}):v.error("Received an empty response for EPUB OPF "+e+". This may be caused by the server not allowing cross origin requests.")});return M(g)}
function jq(a,b,c){var d=K("EPUBDocStore.load");b=ta(b);(a.l[b]=Xp(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,yc:null})).ua(d);return M(d)}
dq.prototype.load=function(a){var b=ta(a);if(a=this.l[b])return a.Ca()?a:L(a.oc());var c=K("EPUBDocStore.load");a=dq.Rd.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?N(c,a):v.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return M(c)};function kq(){this.id=null;this.src="";this.f=this.d=null;this.F=-1;this.h=0;this.j=null;this.b=this.e=0;this.Db=this.Qa=null;this.g=Ta}
function lq(a){return a.id}function mq(a){var b=Pe(a);return function(a){var d=K("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));sf(e).then(function(a){a=new DataView(a);for(var c=0;c<a.byteLength;c++){var e=a.getUint8(c),e=e^b[c%20];a.setUint8(c,e)}N(d,rf([a,f]))});return M(d)}}
var nq={dcterms:"http://purl.org/dc/terms/",marc:"http://id.loc.gov/vocabulary/",media:"http://www.idpf.org/epub/vocab/overlays/#",onix:"http://www.editeur.org/ONIX/book/codelists/current.html#",xsd:"http://www.w3.org/2001/XMLSchema#"},oq=nq.dcterms+"language",pq=nq.dcterms+"title";
function qq(a,b){var c={};return function(d,e){var f,g,h=d.r||c,l=e.r||c;if(a==pq&&(f="main"==h["http://idpf.org/epub/vocab/package/#title-type"],g="main"==l["http://idpf.org/epub/vocab/package/#title-type"],f!=g))return f?-1:1;f=parseInt(h["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(f)&&(f=Number.MAX_VALUE);g=parseInt(l["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(g)&&(g=Number.MAX_VALUE);return f!=g?f-g:a!=oq&&b&&(f=(h[oq]||h["http://idpf.org/epub/vocab/package/#alternate-script"])==
b,g=(l[oq]||l["http://idpf.org/epub/vocab/package/#alternate-script"])==b,f!=g)?f?-1:1:d.o-e.o}}
function rq(a,b){function c(a){for(var b in a){var d=a[b];d.sort(qq(b,k));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return Wa(a,function(a){return Va(a,function(a){var b={v:a.value,o:a.Q};a.Ie&&(b.s=a.scheme);if(a.id||a.lang){var c=l[a.id];if(c||a.lang)a.lang&&(a={name:oq,value:a.lang,lang:null,id:null,hd:a.id,scheme:null,Q:a.Q},c?c.push(a):c=[a]),c=Ua(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in nq)f[g]=nq[g];for(;null!=(g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/));)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=nq;var h=1;g=Nh(Oh(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),Q:h++,hd:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:nq.dcterms+a.localName,Q:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),hd:null,scheme:null};return null});var l=Ua(g,function(a){return a.hd});g=d(Ua(g,function(a){return a.hd?null:a.name}));var k=null;g[oq]&&(k=g[oq][0].v);c(g);return g}function sq(){var a=window.MathJax;return a?a.Hub:null}var tq={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function hq(a,b){this.f=a;this.h=this.d=this.b=this.g=this.e=null;this.l=b;this.k=null;this.I={};this.lang=null;this.w=0;this.u={};this.O=this.H=this.S=null;this.B={};this.D=null;this.j=uq(this);sq()&&(Zi["http://www.w3.org/1998/Math/MathML"]=!0)}
function uq(a){function b(){}b.prototype.md=function(a,b){return encodeURIComponent(b+(a?"#"+a:""))};b.prototype.b=function(b,d){var e=b.match(/^([^#]*)#?(.*)$/);if(e){var f=e[1]||d,e=e[2];if(f&&a.g.some(function(a){return a.src===f}))return"#"+this.md(e,f)}return b};b.prototype.je=function(a){"#"===a.charAt(0)&&(a=a.substring(1));return(a=decodeURIComponent(a).match(/^([^#]*)#?(.*)$/))?[a[1],a[2]]:[]};return new b}
function vq(a,b){return a.l?b.substr(0,a.l.length)==a.l?decodeURI(b.substr(a.l.length)):null:b}
function iq(a,b,c,d,e){a.e=b;var f=uh(new vh([b.b]),"package"),g=Ph(f,"unique-identifier")[0];g&&(g=Bh(b,b.url+"#"+g))&&(a.k=g.textContent.replace(/[ \n\r\t]/g,""));var h={};a.g=Va(Lh(uh(uh(f,"manifest"),"item")),function(c){var d=new kq,e=b.url;d.id=c.getAttribute("id");d.src=va(c.getAttribute("href"),e);d.d=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.g=f}(c=c.getAttribute("fallback"))&&!tq[d.d]&&(h[d.src]=c);!a.H&&
d.g.nav&&(a.H=d);!a.O&&d.g["cover-image"]&&(a.O=d);return d});a.d=Sa(a.g,lq);a.h=Sa(a.g,function(b){return vq(a,b.src)});for(var l in h)for(g=l;;){g=a.d[h[g]];if(!g)break;if(tq[g.d]){a.B[l]=g.src;break}g=g.src}a.b=Va(Lh(uh(uh(f,"spine"),"itemref")),function(b,c){var d=b.getAttribute("idref");if(d=a.d[d])d.f=b,d.F=c;return d});if(l=Ph(uh(f,"spine"),"toc")[0])a.S=a.d[l];if(l=Ph(uh(f,"spine"),"page-progression-direction")[0]){a:switch(l){case "ltr":l="ltr";break a;case "rtl":l="rtl";break a;default:throw Error("unknown PageProgression: "+
l);}a.D=l}var g=c?Ph(uh(uh(Kh(uh(uh(new vh([c.b]),"encryption"),"EncryptedData"),Jh()),"CipherData"),"CipherReference"),"URI"):[],k=Lh(uh(uh(f,"bindings"),"mediaType"));for(c=0;c<k.length;c++){var m=k[c].getAttribute("handler");(l=k[c].getAttribute("media-type"))&&m&&a.d[m]&&(a.I[l]=a.d[m].src)}a.u=rq(uh(f,"metadata"),Ph(f,"prefix")[0]);a.u[oq]&&(a.lang=a.u[oq][0].v);if(!d){if(0<g.length&&a.k)for(d=mq(a.k),c=0;c<g.length;c++)a.f.k[a.l+g[c]]=d;return L(!0)}f=new Ia;k={};if(0<g.length&&a.k)for(l="1040:"+
Qe(a.k),c=0;c<g.length;c++)k[g[c]]=l;for(c=0;c<d.length;c++){var p=d[c];if(m=p.n){var r=decodeURI(m),g=a.h[r];l=null;g&&(g.j=0!=p.m,g.h=p.c,g.d&&(l=g.d.replace(/\s+/g,"")));g=k[r];if(l||g)f.append(m),f.append(" "),f.append(l||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}wq(a);return qf(e,"","POST",f.toString(),"text/plain")}function wq(a){for(var b=0,c=0;c<a.b.length;c++){var d=a.b[c],e=Math.ceil(d.h/1024);d.e=b;d.b=e;b+=e}a.w=b}
function xq(a,b,c){a.d={};a.h={};a.g=[];a.b=a.g;var d=a.e=new th(null,"",(new DOMParser).parseFromString("<spine></spine>","text/xml"));b.forEach(function(a){var b=new kq;b.F=a.index;b.id="item"+(a.index+1);b.src=a.url;b.Qa=a.Qa;b.Db=a.Db;var c=d.b.createElement("itemref");c.setAttribute("idref",b.id);d.root.appendChild(c);b.f=c;this.d[b.id]=b;this.h[a.url]=b;this.g.push(b)},a);return c?jq(a.f,b[0].url,c):L(null)}
function yq(a,b,c){var d=a.b[b],e=K("getCFI");a.f.load(d.src).then(function(a){var b=zh(a,c),h=null;b&&(a=xh(a,b,0,!1),h=new jb,mb(h,b,c-a),d.f&&mb(h,d.f,0),h=h.toString());N(e,h)});return M(e)}
function zq(a,b){return We("resolveFragment",function(c){if(b){var d=new jb;kb(d,b);var e;if(a.e){var f=lb(d,a.e.b);if(1!=f.fa.nodeType||f.J||!f.cc){N(c,null);return}var g=f.fa,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.d[h]){N(c,null);return}e=a.d[h];d=f.cc}else e=a.b[0];a.f.load(e.src).then(function(a){var b=lb(d,a.b);a=xh(a,b.fa,b.offset,b.J);N(c,{F:e.F,na:a,G:-1})})}else N(c,null)},function(a,d){v.b(d,"Cannot resolve fragment:",b);N(a,null)})}
function Aq(a,b){return We("resolveEPage",function(c){if(0>=b)N(c,{F:0,na:0,G:-1});else{var d=Qa(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.f.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=yh(a),g=Math.round(a*b/e.b),g==a&&g--);N(c,{F:d,na:g,G:-1})})}},function(a,d){v.b(d,"Cannot resolve epage:",b);N(a,null)})}
function Bq(a,b){var c=a.b[b.F];if(0>=b.na)return L(c.e);var d=K("getEPage");a.f.load(c.src).then(function(a){a=yh(a);var f=Math.min(a,b.na);N(d,c.e+f*c.b/a)});return M(d)}function Cq(a,b,c,d,e){this.b=a;this.viewport=b;this.g=c;this.h=e;this.Nb=[];this.na=this.G=this.F=0;this.T=Xb(d);this.f=new jn(b.f);this.d=new uo(a.j)}function Dq(a){var b=a.Nb[a.F];return b?b.rb[a.G]:null}n=Cq.prototype;n.ob=function(){if(this.b.D)return this.b.D;var a=this.Nb[this.F];return a?a.Ja.ba:null};
function Eq(a,b,c,d){c.N.style.display="none";c.N.style.visibility="visible";c.N.style.position="";c.N.style.top="";c.N.style.left="";c.N.setAttribute("data-vivliostyle-page-side",c.j);var e=b.rb[d];e?(b.Ja.viewport.d.replaceChild(c.N,e.N),Ya(e,{type:"replaced",target:null,currentTarget:null,de:c})):b.Ja.viewport.d.appendChild(c.N);a.h(b.Ja.oa,b.item.F,d);c.l=0==b.item.F&&0==d;b.rb[d]=c}
function Fq(a,b,c){var d=K("renderSinglePage"),e=Gq(a,b,c);Rp(b.Ja,e,c).then(function(f){var g=(c=f)?c.page-1:b.Ka.length-1;Eq(a,b,e,g);yo(a.d,a.F,g);var h=a.F,l=a.G,k=a.na;f=null;if(c){var m=b.Ka[c.page];b.Ka[c.page]=c;m&&b.rb[c.page]&&!zi(c,m)&&(a.G=c.page,f=Fq(a,b,c))}f||(f=L(!0));f.then(function(){var b=zo(a.d,e),f=0;nf(function(c){f++;if(f>b.length)O(c);else{var d=b[f-1];d.xc=d.xc.filter(function(a){return!a.dc});0===d.xc.length?pf(c):(a.F=d.F,a.G=d.G,Hq(a).then(function(b){b?(xo(a.d,d.dd),Ao(a.d,
d.xc),Fq(a,b,b.Ka[a.G]).then(function(){var b=a.d;b.b=b.u.pop();b=a.d;b.d=b.B.pop();pf(c)})):pf(c)}))}}).then(function(){a.F=h;a.G=l;a.na=k;N(d,{page:e,position:c,G:g})})})});return M(d)}
function Iq(a){var b=K("renderPage");Hq(a).then(function(c){if(c){var d=-1;if(0>a.G){var d=a.na,e=Qa(c.Ka.length,function(a){return Np(c.Ja,c.Ka[a])>d});a.G=e==c.Ka.length?Number.POSITIVE_INFINITY:e-1}var f=c.rb[a.G];f?(a.na=f.offset,N(b,f)):nf(function(b){if(a.G<c.Ka.length)O(b);else if(c.complete)a.G=c.Ka.length-1,O(b);else{var e=c.Ka[c.Ka.length-1];Fq(a,c,e).then(function(l){var k=l.page;e=l.position;l=l.G;e?0<=d&&Np(c.Ja,e)>d?(f=k,a.G=c.Ka.length-2,O(b)):pf(b):(f=k,a.G=l,0>d&&(a.na=k.offset),
c.complete=!0,k.k=c.item.F==a.b.b.length-1,O(b))})}}).then(function(){f=f||c.rb[a.G];var e=c.Ka[a.G];0>d&&(a.na=Np(c.Ja,e));f?N(b,f):Fq(a,c,e).then(function(d){var f=d.page;e=d.position;e||(c.complete=!0,f.k=c.item.F==a.b.b.length-1);N(b,f)})})}else N(b,null)});return M(b)}n.jd=function(){return Jq(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};
function Jq(a,b,c){var d=K("renderAllPages"),e=a.F,f=a.G;a.F=0;nf(function(d){a.G=a.F==b?c:Number.POSITIVE_INFINITY;Iq(a).then(function(){++a.F>b?O(d):pf(d)})}).then(function(){a.F=e;a.G=f;Iq(a).ua(d)});return M(d)}n.Yd=function(){this.G=this.F=0;return Iq(this)};n.Zd=function(){this.F=this.b.b.length-1;this.G=Number.POSITIVE_INFINITY;return Iq(this)};
n.nextPage=function(){var a=this,b=K("nextPage");Hq(a).then(function(c){if(c){if(c.complete&&a.G==c.Ka.length-1){if(a.F>=a.b.b.length-1){N(b,null);return}a.F++;a.G=0}else a.G++;Iq(a).ua(b)}else N(b,null)});return M(b)};n.gd=function(){if(0==this.G){if(0==this.F)return L(null);this.F--;this.G=Number.POSITIVE_INFINITY}else this.G--;return Iq(this)};function Kq(a,b){var c="left"===b.j,d="ltr"===a.ob();return!c&&d||c&&!d}
function Lq(a){var b=K("getCurrentSpread"),c=Dq(a);if(!c)return L({left:null,right:null});var d=a.F,e=a.G,f="left"===c.j;(Kq(a,c)?a.gd():a.nextPage()).then(function(g){a.F=d;a.G=e;Iq(a).then(function(){f?N(b,{left:c,right:g}):N(b,{left:g,right:c})})});return M(b)}n.ee=function(){var a=Dq(this);if(!a)return L(null);var a=Kq(this,a),b=this.nextPage();if(a)return b;var c=this;return b.Hc(function(){return c.nextPage()})};
n.he=function(){var a=Dq(this);if(!a)return L(null);var a=Kq(this,a),b=this.gd();if(a){var c=this;return b.Hc(function(){return c.gd()})}return b};function Mq(a,b){var c=K("navigateToEPage");Aq(a.b,b).then(function(b){b&&(a.F=b.F,a.G=b.G,a.na=b.na);Iq(a).ua(c)});return M(c)}function Nq(a,b){var c=K("navigateToCFI");zq(a.b,b).then(function(b){b&&(a.F=b.F,a.G=b.G,a.na=b.na);Iq(a).ua(c)});return M(c)}
function Oq(a,b){v.debug("Navigate to",b);var c=vq(a.b,ta(b));if(!c){if(a.b.e&&b.match(/^#epubcfi\(/))c=vq(a.b,a.b.e.url);else if("#"===b.charAt(0)){var d=a.b.j.je(b);a.b.e?c=vq(a.b,d[0]):c=d[0];b=c+(d[1]?"#"+d[1]:"")}if(null==c)return L(null)}d=a.b.h[c];if(!d)return a.b.e&&c==vq(a.b,a.b.e.url)&&(c=b.indexOf("#"),0<=c)?Nq(a,b.substr(c+1)):L(null);d.F!=a.F&&(a.F=d.F,a.G=0);var e=K("navigateTo");Hq(a).then(function(c){var d=Bh(c.Z,b);d&&(a.na=wh(c.Z,d),a.G=-1);Iq(a).ua(e)});return M(e)}
function Gq(a,b,c){var d=b.Ja.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.style.position="absolute";e.style.top="0";e.style.left="0";ka||(e.style.visibility="hidden");d.root.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);var g=new Vh(e,f);g.F=b.item.F;g.position=c;g.offset=Np(b.Ja,c);0===g.offset&&(b=a.b.j.md("",b.item.src),f.setAttribute("id",b),Yh(g,f,b));d!==a.viewport&&(a=$b(a.viewport.width,
a.viewport.height,d.width,d.height),a=hg(null,new Tb(a,null)),g.h.push(new Sh(e,"transform",a)));return g}function Pq(a,b){var c=sq();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=K("navigateToEPage"),f=ff(c);d.Push(function(){f.Wa(e)});return M(c)}return L(null)}
n.ad=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=va(f,a.url),g=c.getAttribute("media-type");if(!g){var h=vq(b.b,f);h&&(h=b.b.h[h])&&(g=h.d)}if(g&&(h=b.b.I[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Ma(f),l=Ma(g),g=new Ia;g.append(h);g.append("?src=");g.append(f);g.append("&type=");g.append(l);for(h=c.firstChild;h;h=h.nextSibling)1==h.nodeType&&
...
c.namespaceURI)e=Pq(c,d);else if("http://example.com/sse"==c.namespaceURI){e=d?d.ownerDocument:b.viewport.b;g=c.localName;switch(g){case "t":case "tab":case "ec":case "nt":case "fraction":case "comment":case "mark":g="span";break;case "ruby":case "rp":case "rt":break;default:g="div"}e=e.createElement(g);e.setAttribute("data-adapt-process-children","true");e=L(e)}else e=c.dataset&&"true"==c.dataset.mathTypeset?Pq(c,d):L(null);return e}};
function Hq(a){if(a.F>=a.b.b.length)return L(null);var b=a.Nb[a.F];if(b)return L(b);var c=a.b.b[a.F],d=a.b.f,e=K("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(yh(f)/2700),a.b.w=c.b);var g=d.b[f.url],h=a.ad(f),l=a.viewport,k=Jp(g,l.width,l.height,l.fontSize);if(k.width!=l.width||k.height!=l.height||k.fontSize!=l.fontSize)l=new mn(l.f,k.fontSize,l.root,k.width,k.height);k=a.Nb[a.F-1];null!==c.Qa?k=c.Qa-1:(k=k?k.Ja.ma+k.rb.length:0,null!==c.Db&&(k+=c.Db));
vo(a.d,k);var m=new Kp(g,f,a.b.lang,l,a.f,a.g,h,a.b.B,k,a.b.j,a.d);m.T=a.T;Lp(m).then(function(){b={item:c,Z:f,Ja:m,Ka:[null],rb:[],complete:!1};a.Nb[a.F]=b;N(e,b)})});return M(e)}function Qq(a){return{F:a.F,G:a.G,na:a.na}}function Rq(a,b){b?(a.F=b.F,a.G=-1,a.na=b.na):(a.F=0,a.G=0,a.na=0);return Jq(a,a.F,a.G)}
n.zc=function(){var a=this.b,b=a.H||a.S;if(!b)return L(null);var c=K("showTOC");this.e||(this.e=new aq(a.f,b.src,a.lang,this.f,this.g,this.T,this,a.B,a.j,this.d));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background=
"#EEE";e.style.border="1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.e.zc(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";N(c,a)});return M(c)};n.vc=function(){this.e&&this.e.vc()};n.Ad=function(){return this.e&&this.e.Ad()};function Sq(a,b,c,d){var e=this;this.h=a;this.jb=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.za=c;this.oa=d;a=a.document;this.ka=new oh(a.head,b);this.H=[];this.g=null;this.D=this.d=!1;this.f=this.j=this.e=this.l=null;this.fontSize=16;this.zoom=1;this.S=!1;this.jd=!0;this.T=Wb();this.B=function(){};this.k=function(){};this.O=function(){e.d=!0;e.B()};this.ed=this.ed.bind(this);this.u=function(){};this.w=a.getElementById("vivliostyle-page-rules");
this.I=!1;this.ba={loadEPUB:this.Ud,loadXML:this.Vd,configure:this.ud,moveTo:this.ma,toc:this.zc};Tq(this)}function Tq(a){ra(1,function(a){Uq(this,{t:"debug",content:a})}.bind(a));ra(2,function(a){Uq(this,{t:"info",content:a})}.bind(a));ra(3,function(a){Uq(this,{t:"warn",content:a})}.bind(a));ra(4,function(a){Uq(this,{t:"error",content:a})}.bind(a))}function Uq(a,b){b.i=a.za;a.oa(b)}n=Sq.prototype;
n.Ud=function(a){Ho.b("loadEPUB");Ho.b("loadFirstPage");this.jb.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet;this.viewport=null;var f=K("loadEPUB"),g=this;g.ud(a).then(function(){var a=new dq;if(e)for(var l=0;l<e.length;l++)$p(a,e[l]);Zp(a).then(function(){var e=va(b,g.h.location.href);g.H=[e];fq(a,e,d).then(function(a){g.g=a;zq(g.g,c).then(function(a){g.f=a;Vq(g).then(function(){g.jb.setAttribute("data-vivliostyle-viewer-status",
"complete");Ho.d("loadEPUB");Uq(g,{t:"loaded",metadata:g.g.u});N(f,!0)})})})})});return M(f)};
n.Vd=function(a){Ho.b("loadXML");Ho.b("loadFirstPage");this.jb.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.document,d=a.fragment,e=a.userStyleSheet;this.viewport=null;var f=K("loadXML"),g=this;g.ud(a).then(function(){var a=new dq;if(e)for(var l=0;l<e.length;l++)$p(a,e[l]);Zp(a).then(function(){var e=b.map(function(a,b){return{url:va(a.url,g.h.location.href),index:b,Qa:a.Qa,Db:a.Db}});g.H=e.map(function(a){return a.url});g.g=new hq(a,"");xq(g.g,e,c).then(function(){zq(g.g,
d).then(function(a){g.f=a;Vq(g).then(function(){g.jb.setAttribute("data-vivliostyle-viewer-status","complete");Ho.d("loadXML");Uq(g,{t:"loaded"});N(f,!0)})})})})});return M(f)};function Wq(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*jc.ex*a.fontSize/jc.em;if(d=jc[d])return c*d}return c}
n.ud=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.l=null,this.h.addEventListener("resize",this.O,!1),this.d=!0):this.h.removeEventListener("resize",this.O,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.d=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:Wq(this,b["margin-left"])||0,marginRight:Wq(this,b["margin-right"])||0,marginTop:Wq(this,b["margin-top"])||0,marginBottom:Wq(this,b["margin-bottom"])||
0,width:Wq(this,b.width)||0,height:Wq(this,b.height)||0},200<=b.width||200<=b.height)&&(this.h.removeEventListener("resize",this.O,!1),this.l=b,this.d=!0);"boolean"==typeof a.hyphenate&&(this.T.Vc=a.hyphenate,this.d=!0);"boolean"==typeof a.horizontal&&(this.T.Uc=a.horizontal,this.d=!0);"boolean"==typeof a.nightMode&&(this.T.bd=a.nightMode,this.d=!0);"number"==typeof a.lineHeight&&(this.T.lineHeight=a.lineHeight,this.d=!0);"number"==typeof a.columnWidth&&(this.T.Rc=a.columnWidth,this.d=!0);"string"==
typeof a.fontFamily&&(this.T.fontFamily=a.fontFamily,this.d=!0);"boolean"==typeof a.load&&(this.S=a.load);"boolean"==typeof a.renderAllPages&&(this.jd=a.renderAllPages);"string"==typeof a.userAgentRootURL&&(ua=a.userAgentRootURL);"boolean"==typeof a.spreadView&&a.spreadView!==this.T.Ya&&(this.viewport=null,this.T.Ya=a.spreadView,this.d=!0);"number"==typeof a.pageBorder&&a.pageBorder!==this.T.Mb&&(this.viewport=null,this.T.Mb=a.pageBorder,this.d=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=
a.zoom,this.D=!0);return L(!0)};n.ed=function(a){var b=this.e;b===a.target&&(b=a.de);Xq(this,b)};function Yq(a){var b=[];a.e&&(b.push(a.e),a.e=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(w(a.N,"display","none"),a.removeEventListener("hyperlink",this.u,!1),a.removeEventListener("replaced",this.ed,!1))},a)}function Zq(a,b){b.addEventListener("hyperlink",a.u,!1);b.addEventListener("replaced",a.ed,!1);w(b.N,"visibility","visible");w(b.N,"display","block")}
function $q(a,b){Yq(a);a.e=b;Zq(a,b)}function ar(a){var b=K("reportPosition");a.f||(a.f=Qq(a.b));yq(a.g,a.f.F,a.f.na).then(function(c){var d=a.e;(a.S&&0<d.g.length?sg(d.g):L(!0)).then(function(){br(a,d,c).ua(b)})});return M(b)}
function cr(a){var b=a.jb;if(a.l){var c=a.l;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new mn(a.h,a.fontSize,b,c.width,c.height)}return new mn(a.h,a.fontSize,b)}
function dr(a){if(a.l||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=cr(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.Nb;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.rb,d=0;d<c.length;d++){var e=c[d];if(e.I&&e.H){a=!0;break a}}}a=!1}b=!a}return b}n.ke=function(a,b,c){if(!this.I&&this.w&&0===b&&0===c){var d="";Object.keys(a).forEach(function(b){d+="@page "+b+"{size:";b=a[b];d+=b.width+"px "+b.height+"px;}"});this.w.textContent=d;this.I=!0}};
function er(a){if(a.b){a.b.vc();for(var b=a.b.Nb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.rb,e;e=d.shift();)e=e.N,e.parentNode.removeChild(e)}}a.w&&(a.w.textContent="",a.I=!1);a.viewport=cr(a);b=a.viewport;w(b.e,"width","");w(b.e,"height","");w(b.d,"width","");w(b.d,"height","");w(b.d,"transform","");a.b=new Cq(a.g,a.viewport,a.ka,a.T,a.ke.bind(a))}
function Xq(a,b){a.D=!1;if(a.T.Ya)return Lq(a.b).Hc(function(c){Yq(a);a.j=c;c.left&&(Zq(a,c.left),c.right||c.left.N.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Zq(a,c.right),c.left||c.right.N.setAttribute("data-vivliostyle-unpaired-page",!0));c=fr(a,c);a.viewport.zoom(c.width,c.height,a.zoom);a.e=b;return L(null)});$q(a,b);a.viewport.zoom(b.e.width,b.e.height,a.zoom);a.e=b;return L(null)}
function fr(a,b){var c=0,d=0;b.left&&(c+=b.left.e.width,d=b.left.e.height);b.right&&(c+=b.right.e.width,d=Math.max(d,b.right.e.height));b.left&&b.right&&(c+=2*a.T.Mb);return{width:c,height:d}}var gr={ue:"fit inside viewport"};
function Vq(a){a.d=!1;if(dr(a))return L(!0);"complete"===a.jb.getAttribute("data-vivliostyle-viewer-status")&&a.jb.setAttribute("data-vivliostyle-viewer-status","resizing");Uq(a,{t:"resizestart"});var b=K("resize");a.b&&!a.f&&(a.f=Qq(a.b));er(a);Rq(a.b,a.f).then(function(c){Xq(a,c).then(function(){ar(a).then(function(c){Ho.d("loadFirstPage");(a.jd?a.b.jd():L(null)).then(function(){a.jb.setAttribute("data-vivliostyle-viewer-status","complete");Uq(a,{t:"resizeend"});N(b,c)})})})});return M(b)}
function br(a,b,c){var d=K("sendLocationNotification"),e={t:"nav",first:b.l,last:b.k};Bq(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.w;c&&(e.cfi=c);Uq(a,e);N(d,!0)});return M(d)}Sq.prototype.ob=function(){return this.b?this.b.ob():null};
Sq.prototype.ma=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.T.Ya?this.b.ee:this.b.nextPage;break;case "previous":a=this.T.Ya?this.b.he:this.b.gd;break;case "last":a=this.b.Zd;break;case "first":a=this.b.Yd;break;default:return L(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return Mq(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return Oq(b.b,d)}}else return L(!0);var e=K("nextPage");a.call(b.b).then(function(a){a?(b.f=
null,Xq(b,a).then(function(){ar(b).ua(e)})):N(e,!0)});return M(e)};Sq.prototype.zc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.Ad();if(c){if("show"==a)return L(!0)}else if("hide"==a)return L(!0);if(c)return this.b.vc(),L(!0);var d=this,e=K("showTOC");this.b.zc(b).then(function(a){if(a){if(b){var c=function(){d.b.vc()};a.addEventListener("hyperlink",c,!1);a.N.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.u,!1)}N(e,!0)});return M(e)};
function hr(a,b){var c=b.a||"";return We("runCommand",function(d){var e=a.ba[c];e?e.call(a,b).then(function(){Uq(a,{t:"done",a:c});N(d,!0)}):(v.error("No such action:",c),N(d,!0))},function(a,b){v.error(b,"Error during action:",c);N(a,!0)})}function ir(a){return"string"==typeof a?JSON.parse(a):a}
function jr(a,b){var c=ir(b),d=null;Ye(function(){var b=K("commandLoop"),f=Re.d;a.u=function(b){var c="#"===b.href.charAt(0)||a.H.some(function(a){return b.href.substr(0,a.length)==a}),d={t:"hyperlink",href:b.href,internal:c};Ze(f,function(){Uq(a,d);return L(!0)})};nf(function(b){if(a.d)Vq(a).then(function(){pf(b)});else if(a.D)a.e&&Xq(a,a.e).then(function(){pf(b)});else if(c){var e=c;c=null;hr(a,e).then(function(){pf(b)})}else e=K("waitForCommand"),d=ff(e,self),M(e).then(function(){pf(b)})}).ua(b);
return M(b)});a.B=function(){var a=d;a&&(d=null,a.Wa())};a.k=function(b){if(c)return!1;c=ir(b);a.B();return!0};a.h.adapt_command=a.k};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Wb||(Object.Wb=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function kr(a){function b(a){return"number"===typeof a?a:null}function c(a){return"string"===typeof a?{url:a,Qa:null,Db:null}:{url:a.url,Qa:b(a.startPage),Db:b(a.skipPagesBefore)}}return Array.isArray(a)?a.map(c):a?[c(a)]:null}function lr(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}
function mr(a,b){ka=a.debug;this.f=a;this.b=new Sq(a.window||window,a.viewportElement,"main",this.Xd.bind(this));this.e={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,spreadView:!1,zoom:1};b&&this.Qd(b);this.d=new Xa}n=mr.prototype;n.Qd=function(a){var b=Object.Wb({a:"configure"},lr(a));this.b.k(b);Object.Wb(this.e,a)};n.Xd=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});Ya(this.d,b)};n.le=function(a,b){this.d.addEventListener(a,b,!1)};
n.oe=function(a,b){this.d.removeEventListener(a,b,!1)};n.$d=function(a,b,c){a||Ya(this.d,{type:"error",content:"No URL specified"});nr(this,a,null,b,c)};n.me=function(a,b,c){a||Ya(this.d,{type:"error",content:"No URL specified"});nr(this,null,a,b,c)};
function nr(a,b,c,d,e){d=d||{};var f,g=d.userStyleSheet;g&&(f=g.map(function(a){return{url:a.url||null,text:a.text||null}}));e&&Object.Wb(a.e,e);b=Object.Wb({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.f.userAgentRootURL,url:kr(b)||c,document:d.documentObject,fragment:d.fragment,userStyleSheet:f},lr(a.e));jr(a.b,b)}n.ob=function(){return this.b.ob()};
n.be=function(a){a:switch(a){case "left":a="ltr"===this.ob()?"previous":"next";break a;case "right":a="ltr"===this.ob()?"next":"previous";break a}this.b.k({a:"moveTo",where:a})};n.ae=function(a){this.b.k({a:"moveTo",url:a})};n.ne=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.T.Ya?fr(b,b.j):b.e.e;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ba("vivliostyle.viewer.Viewer",mr);mr.prototype.setOptions=mr.prototype.Qd;mr.prototype.addListener=mr.prototype.le;mr.prototype.removeListener=mr.prototype.oe;mr.prototype.loadDocument=mr.prototype.$d;mr.prototype.loadEPUB=mr.prototype.me;mr.prototype.getCurrentPageProgression=mr.prototype.ob;mr.prototype.navigateToPage=mr.prototype.be;mr.prototype.navigateToInternalUrl=mr.prototype.ae;mr.prototype.queryZoomFactor=mr.prototype.ne;ba("vivliostyle.viewer.ZoomType",gr);gr.FIT_INSIDE_VIEWPORT="fit inside viewport";
Do.call(Ho,"load_vivliostyle","end",void 0);var or=16,pr="ltr";function qr(a){window.adapt_command(a)}function rr(){qr({a:"moveTo",where:"ltr"===pr?"previous":"next"})}function sr(){qr({a:"moveTo",where:"ltr"===pr?"next":"previous"})}
function tr(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)qr({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)qr({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)qr({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)qr({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)sr(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)rr(),a.preventDefault();else if("0"===b||"U+0030"===c)qr({a:"configure",fontSize:Math.round(or)}),a.preventDefault();else if("t"===b||"U+0054"===c)qr({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)or*=1.2,qr({a:"configure",fontSize:Math.round(or)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)or/=1.2,qr({a:"configure",
fontSize:Math.round(or)}),a.preventDefault()}
function ur(a){switch(a.t){case "loaded":a=a.viewer;var b=pr=a.ob();a.jb.setAttribute("data-vivliostyle-page-progression",b);a.jb.setAttribute("data-vivliostyle-spread-view",a.T.Ya);window.addEventListener("keydown",tr,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",rr,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",sr,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(ya(location.href,Ma(a||"")));break;case "hyperlink":a.internal&&qr({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+m+"; margin: 0; }",document.head.appendChild(g));jr(new Sq(window,k,"main",ur),a)});
