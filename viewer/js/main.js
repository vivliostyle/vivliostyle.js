 ...
 *
 * Vivliostyle core 2016.2.0-pre.20160224090604
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
Ak.prototype.g=function(a,b){var c=zh(this.aa,a),d="e"+c;b&&(c=Ah(this.aa,a,0,!0));this.b<=c&&Ik(this,c,0);return this.w[d]};var Mk=1;function Nk(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.h=0;this.d=a;this.name=b;this.kb=c;this.ya=d;this.parent=e;this.g="p"+Mk++;e&&(this.h=e.children.length,e.children.push(this))}Nk.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Nk.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Rk(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
function Sk(a,b){for(var c=0;c<a.children.length;c++)a.children[c].clone({parent:b})}function Tk(a){Nk.call(this,a,null,null,[],null);this.b.width=new U(ne,0);this.b.height=new U(oe,0)}t(Tk,Nk);
...
function Wk(a,b,c,d,e,f,g){a=a instanceof Uk?a:new Uk(a,this);Nk.call(this,a,b,c,d,e);this.e=this;this.H=f;this.R=g;this.b.width=new U(ne,0);this.b.height=new U(oe,0);this.b["wrap-flow"]=new U(Ad,0);this.b.position=new U($d,0);this.b.overflow=new U(ke,0);this.j={}}t(Wk,Nk);Wk.prototype.f=function(a){return new Xk(a,this)};Wk.prototype.clone=function(a){a=new Wk(this.d,this.name,a.kb||this.kb,this.ya,this.parent,this.H,this.R);Rk(this,a);Sk(this,a);return a};
function Yk(a,b,c,d,e){Nk.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.j[b]=this.g);this.b["wrap-flow"]=new U(Ad,0)}t(Yk,Nk);Yk.prototype.f=function(a){return new Zk(a,this)};Yk.prototype.clone=function(a){a=new Yk(a.parent.d,this.name,this.kb,this.ya,a.parent);Rk(this,a);Sk(this,a);return a};function $k(a,b,c,d,e){Nk.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.j[b]=this.g)}t($k,Nk);$k.prototype.f=function(a){return new al(a,this)};
...
J=h.toString(),X=Y(c,a,"column-count"),P=Y(c,a,"column-gap"),F=1<X?Y(c,a,"column-width"):v.width,h=ll(c,a),Ea=0,r=ml(c,a,"shape-inside"),pb=qg(r,0,0,v.width,v.height,a),Ok=new Pl(J,a,a.viewport,a.d,h,a.aa,a.f,a.style.u,a,b,a.Ia,a.Ja,k),xh=0,Z=null;rf(function(b){for(;xh<X;){var c=xh++;if(1<X){var d=a.viewport.b.createElement("div");w(d,"position","absolute");q.appendChild(d);Z=new um(d,Ok,a.g);Z.b=v.b;Z.Ja=v.Ja;Z.ac=v.ac;v.b?(w(d,"margin-left",v.j+"px"),w(d,"margin-right",v.D+"px"),c=c*(F+P)+v.k,
yi(Z,0,v.width),xi(Z,c,F)):(w(d,"margin-top",v.k+"px"),w(d,"margin-bottom",v.w+"px"),c=c*(F+P)+v.j,xi(Z,0,v.height),yi(Z,c,F));Z.A=e+v.j;Z.B=f+v.k}else Z=new um(q,Ok,a.g),wi(Z,v),v=Z;Z.G=p?[]:g;Z.Zb=pb;if(0<=Z.width){var h=L("inner");xo(a,Z,J).then(function(){Z.L&&"column"!=Z.L&&(xh=X,"region"!=Z.L&&(a.D[J]=!0));O(h,!0)});c=N(h)}else c=M(!0);if(c.za()){c.then(function(){0<k.b.length?Q(b):(Ea=Math.max(Ea,Z.e),tf(b))});return}0<k.b.length||(Ea=Math.max(Ea,Z.e))}Q(b)}).then(function(){v.e=Ea;c.fc(a,
v,b,Z,X,a.g,a.f);O(y,!0)});h=N(y)}else{h=ml(c,a,"content");r=!1;if(h&&Ai(h)){var Pk=a.viewport.b.createElement("span");h.S(new zi(Pk,a));q.appendChild(Pk);zl(c,a,v,a.f)}else c.wa&&(d.removeChild(q),r=!0);r||c.fc(a,v,b,null,1,a.g,a.f);h=M(!0)}h.then(function(){if(!c.f||0<Math.floor(v.e)){if(!n){var h=v.A+v.left,p=v.B+v.top,r=ui(v)+v.width+vi(v),y=si(v)+v.height+ti(v),F=ml(c,a,"shape-outside"),h=qg(F,h,p,r,y,a);gb(a.viewport.root)&&g.push(Ae(h,0,-1.25*vc(a,"em",!1)));g.push(h)}}else if(0==c.children.length){d.removeChild(q);
...
function So(a,b,c){var d=L("EPUBDocStore.load");b=qa(b);(a.l[b]=Fo(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,ic:null})).qa(d);return N(d)}
Mo.prototype.load=function(a){var b=qa(a);if(a=this.l[b])return a.za()?a:M(a.cc());var c=L("EPUBDocStore.load");a=Mo.Bd.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?O(c,a):u.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return N(c)};function To(){this.id=null;this.src="";this.f=this.d=null;this.F=-1;this.h=0;this.j=null;this.b=this.e=0;this.g=$a}function Uo(a){return a.id}
function Vo(a){var b=Te(a);return function(a){var d=L("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));wf(e).then(function(a){a=new DataView(a);for(var c=0;c<a.byteLength;c++){var e=a.getUint8(c),e=e^b[c%20];a.setUint8(c,e)}O(d,vf([a,f]))});return N(d)}}
var Wo={dcterms:"http://purl.org/dc/terms/",marc:"http://id.loc.gov/vocabulary/",media:"http://www.idpf.org/epub/vocab/overlays/#",onix:"http://www.editeur.org/ONIX/book/codelists/current.html#",xsd:"http://www.w3.org/2001/XMLSchema#"},Xo=Wo.dcterms+"language",Yo=Wo.dcterms+"title";
function Zo(a,b){var c={};return function(d,e){var f,g,k=d.r||c,h=e.r||c;if(a==Yo&&(f="main"==k["http://idpf.org/epub/vocab/package/#title-type"],g="main"==h["http://idpf.org/epub/vocab/package/#title-type"],f!=g))return f?-1:1;f=parseInt(k["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(f)&&(f=Number.MAX_VALUE);g=parseInt(h["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(g)&&(g=Number.MAX_VALUE);return f!=g?f-g:a!=Xo&&b&&(f=(k[Xo]||k["http://idpf.org/epub/vocab/package/#alternate-script"])==
b,g=(h[Xo]||h["http://idpf.org/epub/vocab/package/#alternate-script"])==b,f!=g)?f?-1:1:d.o-e.o}}
function $o(a,b){function c(a){for(var b in a){var d=a[b];d.sort(Zo(b,l));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return cb(a,function(a){return bb(a,function(a){var b={v:a.value,o:a.N};a.oe&&(b.s=a.scheme);if(a.id||a.lang){var c=h[a.id];if(c||a.lang)a.lang&&(a={name:Xo,value:a.lang,lang:null,id:null,Tc:a.id,scheme:null,N:a.N},c?c.push(a):c=[a]),c=ab(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in Wo)f[g]=Wo[g];for(;null!=(g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/));)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=Wo;var k=1;g=Qh(Rh(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),N:k++,Tc:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:Wo.dcterms+a.localName,N:k++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Tc:null,scheme:null};return null});var h=ab(g,function(a){return a.Tc});g=d(ab(g,function(a){return a.Tc?null:a.name}));var l=null;g[Xo]&&(l=g[Xo][0].v);c(g);return g}function ap(){var a=window.MathJax;return a?a.Hub:null}var bp={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function Qo(a,b){this.e=a;this.h=this.d=this.b=this.g=this.f=null;this.k=b;this.j=null;this.D={};this.lang=null;this.u=0;this.l={};this.G=this.B=this.L=null;this.w={};this.A=null;ap()&&(Ni["http://www.w3.org/1998/Math/MathML"]=!0)}function cp(a,b){return a.k?b.substr(0,a.k.length)==a.k?decodeURI(b.substr(a.k.length)):null:b}
function Ro(a,b,c,d,e){a.f=b;var f=wh(new yh([b.b]),"package"),g=Sh(f,"unique-identifier")[0];g&&(g=Eh(b,b.url+"#"+g))&&(a.j=g.textContent.replace(/[ \n\r\t]/g,""));var k={};a.g=bb(Oh(wh(wh(f,"manifest"),"item")),function(c){var d=new To,e=b.url;d.id=c.getAttribute("id");d.src=sa(c.getAttribute("href"),e);d.d=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.g=f}(c=c.getAttribute("fallback"))&&!bp[d.d]&&(k[d.src]=c);!a.B&&
d.g.nav&&(a.B=d);!a.G&&d.g["cover-image"]&&(a.G=d);return d});a.d=Za(a.g,Uo);a.h=Za(a.g,function(b){return cp(a,b.src)});for(var h in k)for(g=h;;){g=a.d[k[g]];if(!g)break;if(bp[g.d]){a.w[h]=g.src;break}g=g.src}a.b=bb(Oh(wh(wh(f,"spine"),"itemref")),function(b,c){var d=b.getAttribute("idref");if(d=a.d[d])d.f=b,d.F=c;return d});if(h=Sh(wh(f,"spine"),"toc")[0])a.L=a.d[h];if(h=Sh(wh(f,"spine"),"page-progression-direction")[0]){a:switch(h){case "ltr":h="ltr";break a;case "rtl":h="rtl";break a;default:throw Error("unknown PageProgression: "+
h);}a.A=h}var g=c?Sh(wh(wh(Nh(wh(wh(new yh([c.b]),"encryption"),"EncryptedData"),Mh()),"CipherData"),"CipherReference"),"URI"):[],l=Oh(wh(wh(f,"bindings"),"mediaType"));for(c=0;c<l.length;c++){var n=l[c].getAttribute("handler");(h=l[c].getAttribute("media-type"))&&n&&a.d[n]&&(a.D[h]=a.d[n].src)}a.l=$o(wh(f,"metadata"),Sh(f,"prefix")[0]);a.l[Xo]&&(a.lang=a.l[Xo][0].v);if(!d){if(0<g.length&&a.j)for(d=Vo(a.j),c=0;c<g.length;c++)a.e.k[a.k+g[c]]=d;return M(!0)}f=new Pa;l={};if(0<g.length&&a.j)for(h="1040:"+
Ue(a.j),c=0;c<g.length;c++)l[g[c]]=h;for(c=0;c<d.length;c++){var p=d[c];if(n=p.n){var q=decodeURI(n),g=a.h[q];h=null;g&&(g.j=0!=p.m,g.h=p.c,g.d&&(h=g.d.replace(/\s+/g,"")));g=l[q];if(h||g)f.append(n),f.append(" "),f.append(h||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}dp(a);return uf(e,"","POST",f.toString(),"text/plain")}function dp(a){for(var b=0,c=0;c<a.b.length;c++){var d=a.b[c],e=Math.ceil(d.h/1024);d.e=b;d.b=e;b+=e}a.u=b}
function ep(a,b,c){a.d={};a.h={};a.g=[];a.b=a.g;var d=a.f=new vh(null,"",(new DOMParser).parseFromString("<spine></spine>","text/xml"));b.forEach(function(a,b){var c=new To;c.F=b;c.id="item"+(b+1);c.src=a;var k=d.b.createElement("itemref");k.setAttribute("idref",c.id);d.root.appendChild(k);c.f=k;this.d[c.id]=c;this.h[a]=c;this.g.push(c)},a);return c?So(a.e,b[0],c):M(null)}
function fp(a,b,c){var d=a.b[b],e=L("getCFI");a.e.load(d.src).then(function(a){var b=Ch(a,c),k=null;b&&(a=Ah(a,b,0,!1),k=new rb,ub(k,b,c-a),d.f&&ub(k,d.f,0),k=k.toString());O(e,k)});return N(e)}
function gp(a,b){return $e("resolveFragment",function(c){if(b){var d=new rb;sb(d,b);var e;if(a.f){var f=tb(d,a.f.b);if(1!=f.ga.nodeType||f.K||!f.Rb){O(c,null);return}var g=f.ga,k=g.getAttribute("idref");if("itemref"!=g.localName||!k||!a.d[k]){O(c,null);return}e=a.d[k];d=f.Rb}else e=a.b[0];a.e.load(e.src).then(function(a){var b=tb(d,a.b);a=Ah(a,b.ga,b.offset,b.K);O(c,{F:e.F,la:a,P:-1})})}else O(c,null)},function(a,d){u.b(d,"Cannot resolve fragment:",b);O(a,null)})}
function hp(a,b){return $e("resolveEPage",function(c){if(0>=b)O(c,{F:0,la:0,P:-1});else{var d=Xa(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.e.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=Bh(a),g=Math.round(a*b/e.b),g==a&&g--);O(c,{F:d,la:g,P:-1})})}},function(a,d){u.b(d,"Cannot resolve epage:",b);O(a,null)})}
function ip(a,b){var c=a.b[b.F];if(0>=b.la)return M(c.e);var d=L("getEPage");a.e.load(c.src).then(function(a){a=Bh(a);var f=Math.min(a,b.la);O(d,c.e+f*c.b/a)});return N(d)}function jp(a,b,c,d,e){this.b=a;this.viewport=b;this.f=c;this.g=e;this.Bb=[];this.la=this.P=this.F=0;this.Q=dc(d);this.e=new hm(b.f)}function kp(a){var b=a.Bb[a.F];return b?b.$a[a.P]:null}m=jp.prototype;m.gb=function(){if(this.b.A)return this.b.A;var a=this.Bb[this.F];return a?a.Ca.ea:null};
function lp(a){var b=L("renderPage");mp(a).then(function(c){if(c){var d=-1;if(0>a.P){var d=a.la,e=Xa(c.Fa.length,function(a){return vo(c.Ca,c.Fa[a])>d});a.P=e==c.Fa.length?Number.POSITIVE_INFINITY:e-1}var f=c.$a[a.P];f?(a.la=f.offset,O(b,f)):rf(function(b){if(a.P<c.Fa.length)Q(b);else if(c.complete)a.P=c.Fa.length-1,Q(b);else{var e=c.Fa[c.Fa.length-1],h=np(a,c,e);zo(c.Ca,h,e).then(function(l){h.M.style.display="none";h.M.style.visibility="visible";h.M.setAttribute("data-vivliostyle-page-side",h.g);
l=(e=l)?e.d-1:c.Fa.length-1;a.g(c.Ca.L,c.item.F,l);e?(c.$a[l]=h,c.Fa.push(e),0<=d&&vo(c.Ca,e)>d?(f=h,a.P=c.Fa.length-2,Q(b)):(h.k=0==c.item.F&&0==l,tf(b))):(c.$a.push(h),f=h,a.P=l,0>d&&(a.la=h.offset),c.complete=!0,h.k=0==c.item.F&&0==l,h.l=c.item.F==a.b.b.length-1,Q(b))})}}).then(function(){f=f||c.$a[a.P];var e=c.Fa[a.P];0>d&&(a.la=vo(c.Ca,e));if(f)O(b,f);else{var k=np(a,c,e);zo(c.Ca,k,e).then(function(d){k.M.style.display="none";k.M.style.visibility="visible";k.M.setAttribute("data-vivliostyle-page-side",
k.g);d=(e=d)?e.d-1:c.Fa.length-1;a.g(c.Ca.L,c.item.F,d);e?(c.$a[d]=k,c.Fa[a.P+1]=e):(c.$a.push(k),c.complete=!0,k.l=c.item.F==a.b.b.length-1);k.k=0==c.item.F&&0==d;O(b,k)})}})}else O(b,null)});return N(b)}m.Uc=function(){return op(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};function op(a,b,c){var d=L("renderAllPages"),e=a.F,f=a.P;a.F=0;rf(function(d){a.P=a.F==b?c:Number.POSITIVE_INFINITY;lp(a).then(function(){++a.F>b?Q(d):tf(d)})}).then(function(){a.F=e;a.P=f;lp(a).qa(d)});return N(d)}
m.Hd=function(){this.P=this.F=0;return lp(this)};m.Id=function(){this.F=this.b.b.length-1;this.P=Number.POSITIVE_INFINITY;return lp(this)};m.nextPage=function(){var a=this,b=L("nextPage");mp(a).then(function(c){if(c){if(c.complete&&a.P==c.Fa.length-1){if(a.F>=a.b.b.length-1){O(b,null);return}a.F++;a.P=0}else a.P++;lp(a).qa(b)}else O(b,null)});return N(b)};m.Sc=function(){if(0==this.P){if(0==this.F)return M(null);this.F--;this.P=Number.POSITIVE_INFINITY}else this.P--;return lp(this)};
function pp(a,b){var c="left"===b.g,d="ltr"===a.gb();return!c&&d||c&&!d}function qp(a){var b=L("getCurrentSpread"),c=kp(a);if(!c)return M({left:null,right:null});var d=a.F,e=a.P,f="left"===c.g;(pp(a,c)?a.Sc():a.nextPage()).then(function(g){a.F=d;a.P=e;lp(a).then(function(){f?O(b,{left:c,right:g}):O(b,{left:g,right:c})})});return N(b)}m.Nd=function(){var a=kp(this);if(!a)return M(null);var a=pp(this,a),b=this.nextPage();if(a)return b;var c=this;return b.sc(function(){return c.nextPage()})};
m.Qd=function(){var a=kp(this);if(!a)return M(null);var a=pp(this,a),b=this.Sc();if(a){var c=this;return b.sc(function(){return c.Sc()})}return b};function rp(a,b){var c=L("navigateToEPage");hp(a.b,b).then(function(b){b&&(a.F=b.F,a.P=b.P,a.la=b.la);lp(a).qa(c)});return N(c)}function sp(a,b){var c=L("navigateToCFI");gp(a.b,b).then(function(b){b&&(a.F=b.F,a.P=b.P,a.la=b.la);lp(a).qa(c)});return N(c)}
function tp(a,b){u.debug("Navigate to",b);var c=cp(a.b,qa(b));if(null==c&&(a.b.f&&b.match(/^#epubcfi\(/)&&(c=cp(a.b,a.b.f.url)),null==c))return M(null);var d=a.b.h[c];if(!d)return a.b.f&&c==cp(a.b,a.b.f.url)&&(c=b.indexOf("#"),0<=c)?sp(a,b.substr(c+1)):M(null);d.F!=a.F&&(a.F=d.F,a.P=0);var e=L("navigateTo");mp(a).then(function(c){var d=Eh(c.aa,b);d&&(a.la=zh(c.aa,d),a.P=-1);lp(a).qa(e)});return N(e)}
function np(a,b,c){var d=b.Ca.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);ia||(e.style.visibility="hidden");d.d.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);f=new Xh(e,f);f.F=b.item.F;f.position=c;f.offset=vo(b.Ca,c);d!==a.viewport&&(a=gc(a.viewport.width,a.viewport.height,d.width,d.height),a=jg(null,new ac(a,null)),f.h.push(new Uh(e,"transform",a)));return f}
function up(a,b){var c=ap();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=L("navigateToEPage"),f=kf(c);d.Push(function(){f.Sa(e)});return N(c)}return M(null)}
m.Oc=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=sa(f,a.url),g=c.getAttribute("media-type");if(!g){var k=cp(b.b,f);k&&(k=b.b.h[k])&&(g=k.d)}if(g&&(k=b.b.D[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Ta(f),h=Ta(g),g=new Pa;g.append(k);g.append("?src=");g.append(f);g.append("&type=");g.append(h);for(k=c.firstChild;k;k=k.nextSibling)1==k.nodeType&&
...
c.namespaceURI)e=up(c,d);else if("http://example.com/sse"==c.namespaceURI){e=d?d.ownerDocument:b.viewport.b;g=c.localName;switch(g){case "t":case "tab":case "ec":case "nt":case "fraction":case "comment":case "mark":g="span";break;case "ruby":case "rp":case "rt":break;default:g="div"}e=e.createElement(g);e.setAttribute("data-adapt-process-children","true");e=M(e)}else e=M(null);return e}};
function mp(a){if(a.F>=a.b.b.length)return M(null);var b=a.Bb[a.F];if(b)return M(b);var c=a.b.b[a.F],d=a.b.e,e=L("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(Bh(f)/2700),a.b.u=c.b);var g=d.b[f.url],k=a.Oc(f),h=a.viewport,l=so(g,h.width,h.height,h.fontSize);if(l.width!=h.width||l.height!=h.height||l.fontSize!=h.fontSize)h=new jm(h.f,l.fontSize,h.root,l.width,l.height);var l=a.Bb[a.F-1],n=new to(g,f,a.b.lang,h,a.e,a.f,k,a.b.w,l?l.Ca.oa+l.$a.length:0);l&&
po(n.k,l.Ca.k);n.Q=a.Q;uo(n).then(function(){b={item:c,aa:f,Ca:n,Fa:[null],$a:[],complete:!1};a.Bb[a.F]=b;O(e,b)})});return N(e)}function vp(a){return{F:a.F,P:a.P,la:a.la}}function wp(a,b){b?(a.F=b.F,a.P=-1,a.la=b.la):(a.F=0,a.P=0,a.la=0);return op(a,a.F,a.P)}
...
!1;this.na={loadEPUB:this.wa,loadXML:this.Ia,configure:this.A,moveTo:this.Ja,toc:this.jc};yp(this)}function yp(a){pa(1,function(a){zp(this,{t:"debug",content:a})}.bind(a));pa(2,function(a){zp(this,{t:"info",content:a})}.bind(a));pa(3,function(a){zp(this,{t:"warn",content:a})}.bind(a));pa(4,function(a){zp(this,{t:"error",content:a})}.bind(a))}function zp(a,b){b.i=a.cb;a.Ka(b)}
xp.prototype.wa=function(a){qn.b("loadEPUB");qn.b("loadFirstPage");this.bb.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet;this.viewport=null;var f=L("loadEPUB"),g=this;g.A(a).then(function(){var a=new Mo;if(e)for(var h=0;h<e.length;h++)Io(a,e[h]);Ho(a).then(function(){var e=sa(b,g.h.location.href);g.G=[e];Oo(a,e,d).then(function(a){g.g=a;gp(g.g,c).then(function(a){g.f=a;Ap(g).then(function(){g.bb.setAttribute("data-vivliostyle-viewer-status",
"complete");qn.d("loadEPUB");zp(g,{t:"loaded",metadata:g.g.l});O(f,!0)})})})})});return N(f)};
xp.prototype.Ia=function(a){qn.b("loadXML");qn.b("loadFirstPage");this.bb.setAttribute("data-vivliostyle-viewer-status","loading");var b;"string"===typeof a.url?b=[a.url]:b=a.url;var c=a.document,d=a.fragment,e=a.userStyleSheet;this.viewport=null;var f=L("loadXML"),g=this;g.A(a).then(function(){var a=new Mo;if(e)for(var h=0;h<e.length;h++)Io(a,e[h]);Ho(a).then(function(){var e=b.map(function(a){return sa(a,g.h.location.href)});g.G=e;g.g=new Qo(a,"");ep(g.g,e,c).then(function(){gp(g.g,d).then(function(a){g.f=
a;Ap(g).then(function(){g.bb.setAttribute("data-vivliostyle-viewer-status","complete");qn.d("loadXML");zp(g,{t:"loaded"});O(f,!0)})})})})});return N(f)};function Bp(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*rc.ex*a.fontSize/rc.em;if(d=rc[d])return c*d}return c}
xp.prototype.A=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.l=null,this.h.addEventListener("resize",this.Y,!1),this.d=!0):this.h.removeEventListener("resize",this.Y,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.d=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:Bp(this,b["margin-left"])||0,marginRight:Bp(this,b["margin-right"])||0,marginTop:Bp(this,b["margin-top"])||0,marginBottom:Bp(this,b["margin-bottom"])||
0,width:Bp(this,b.width)||0,height:Bp(this,b.height)||0},200<=b.width||200<=b.height)&&(this.h.removeEventListener("resize",this.Y,!1),this.l=b,this.d=!0);"boolean"==typeof a.hyphenate&&(this.Q.Ic=a.hyphenate,this.d=!0);"boolean"==typeof a.horizontal&&(this.Q.Hc=a.horizontal,this.d=!0);"boolean"==typeof a.nightMode&&(this.Q.Pc=a.nightMode,this.d=!0);"number"==typeof a.lineHeight&&(this.Q.lineHeight=a.lineHeight,this.d=!0);"number"==typeof a.columnWidth&&(this.Q.Dc=a.columnWidth,this.d=!0);"string"==
...
a.zoom,this.D=!0);return M(!0)};function Cp(a){var b=[];a.e&&(b.push(a.e),a.e=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(w(a.M,"display","none"),a.removeEventListener("hyperlink",this.u,!1))},a)}function Dp(a,b){b.addEventListener("hyperlink",a.u,!1);w(b.M,"visibility","visible");w(b.M,"display","block")}function Ep(a,b){Cp(a);a.e=b;Dp(a,b)}
function Fp(a){var b=L("reportPosition");a.f||(a.f=vp(a.b));fp(a.g,a.f.F,a.f.la).then(function(c){var d=a.e;(a.ea&&0<d.f.length?ug(d.f):M(!0)).then(function(){Gp(a,d,c).qa(b)})});return N(b)}function Hp(a){var b=a.bb;if(a.l){var c=a.l;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new jm(a.h,a.fontSize,b,c.width,c.height)}return new jm(a.h,a.fontSize,b)}
function Ip(a){if(a.l||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=Hp(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.Bb;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.$a,d=0;d<c.length;d++){var e=c[d];if(e.G&&e.D){a=!0;break a}}}a=!1}b=!a}return b}
xp.prototype.ub=function(a,b,c){if(!this.L&&this.w&&0===b&&0===c){var d="";Object.keys(a).forEach(function(b){d+="@page "+b+"{size:";b=a[b];d+=b.width+"px "+b.height+"px;}"});this.w.textContent=d;this.L=!0}};
function Jp(a){if(a.b){a.b.gc();for(var b=a.b.Bb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.$a,e;e=d.shift();)e=e.M,e.parentNode.removeChild(e)}}a.w&&(a.w.textContent="",a.L=!1);a.viewport=Hp(a);b=a.viewport;w(b.e,"width","");w(b.e,"height","");w(b.d,"width","");w(b.d,"height","");w(b.d,"transform","");a.b=new jp(a.g,a.viewport,a.oa,a.Q,a.ub.bind(a))}
function Kp(a,b){a.D=!1;if(a.Q.Ua)return qp(a.b).sc(function(c){Cp(a);a.j=c;c.left&&(Dp(a,c.left),c.right||c.left.M.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Dp(a,c.right),c.left||c.right.M.setAttribute("data-vivliostyle-unpaired-page",!0));c=Lp(a,c);a.viewport.zoom(c.width,c.height,a.zoom);a.e=b;return M(null)});Ep(a,b);a.viewport.zoom(b.d.width,b.d.height,a.zoom);a.e=b;return M(null)}
function Lp(a,b){var c=0,d=0;b.left&&(c+=b.left.d.width,d=b.left.d.height);b.right&&(c+=b.right.d.width,d=Math.max(d,b.right.d.height));b.left&&b.right&&(c+=2*a.Q.Ab);return{width:c,height:d}}var Mp={ae:"fit inside viewport"};
function Ap(a){a.d=!1;if(Ip(a))return M(!0);"complete"===a.bb.getAttribute("data-vivliostyle-viewer-status")&&a.bb.setAttribute("data-vivliostyle-viewer-status","resizing");zp(a,{t:"resizestart"});var b=L("resize");a.b&&!a.f&&(a.f=vp(a.b));Jp(a);wp(a.b,a.f).then(function(c){Kp(a,c).then(function(){Fp(a).then(function(c){qn.d("loadFirstPage");(a.Uc?a.b.Uc():M(null)).then(function(){a.bb.setAttribute("data-vivliostyle-viewer-status","complete");zp(a,{t:"resizeend"});O(b,c)})})})});return N(b)}
function Gp(a,b,c){var d=L("sendLocationNotification"),e={t:"nav",first:b.k,last:b.l};ip(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.u;c&&(e.cfi=c);zp(a,e);O(d,!0)});return N(d)}xp.prototype.gb=function(){return this.b?this.b.gb():null};
xp.prototype.Ja=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.Q.Ua?this.b.Nd:this.b.nextPage;break;case "previous":a=this.Q.Ua?this.b.Qd:this.b.Sc;break;case "last":a=this.b.Id;break;case "first":a=this.b.Hd;break;default:return M(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return rp(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return tp(b.b,d)}}else return M(!0);var e=L("nextPage");a.call(b.b).then(function(a){a?(b.f=
null,Kp(b,a).then(function(){Fp(b).qa(e)})):O(e,!0)});return N(e)};xp.prototype.jc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.hd();if(c){if("show"==a)return M(!0)}else if("hide"==a)return M(!0);if(c)return this.b.gc(),M(!0);var d=this,e=L("showTOC");this.b.jc(b).then(function(a){if(a){if(b){var c=function(){d.b.gc()};a.addEventListener("hyperlink",c,!1);a.M.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.u,!1)}O(e,!0)});return N(e)};
function Np(a,b){var c=b.a||"";return $e("runCommand",function(d){var e=a.na[c];e?e.call(a,b).then(function(){zp(a,{t:"done",a:c});O(d,!0)}):(u.error("No such action:",c),O(d,!0))},function(a,b){u.error(b,"Error during action:",c);O(a,!0)})}function Op(a){return"string"==typeof a?JSON.parse(a):a}
function Pp(a,b){var c=Op(b),d=null;bf(function(){var b=L("commandLoop"),f=Ve.d;a.u=function(b){var c=a.G.some(function(a){return b.href.substr(0,a.length)==a}),d={t:"hyperlink",href:b.href,internal:c};cf(f,function(){zp(a,d);return M(!0)})};rf(function(b){if(a.d)Ap(a).then(function(){tf(b)});else if(a.D)a.e&&Kp(a,a.e).then(function(){tf(b)});else if(c){var e=c;c=null;Np(a,e).then(function(){tf(b)})}else e=L("waitForCommand"),d=kf(e,self),N(e).then(function(){tf(b)})}).qa(b);return N(b)});a.B=function(){var a=
d;a&&(d=null,a.Sa())};a.k=function(b){if(c)return!1;c=Op(b);a.B();return!0};a.h.adapt_command=a.k};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Jb||(Object.Jb=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function Qp(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}function Rp(a,b){ia=a.debug;this.f=a;this.b=new xp(a.window||window,a.viewportElement,"main",this.Gd.bind(this));this.e={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,spreadView:!1,zoom:1};b&&this.Ad(b);this.d=new db}m=Rp.prototype;
m.Ad=function(a){var b=Object.Jb({a:"configure"},Qp(a));this.b.k(b);Object.Jb(this.e,a)};m.Gd=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});eb(this.d,b)};m.Sd=function(a,b){this.d.addEventListener(a,b,!1)};m.Vd=function(a,b){this.d.removeEventListener(a,b,!1)};m.Jd=function(a,b,c){a||eb(this.d,{type:"error",content:"No URL specified"});Sp(this,a,null,b,c)};m.Td=function(a,b,c){a||eb(this.d,{type:"error",content:"No URL specified"});Sp(this,null,a,b,c)};
function Sp(a,b,c,d,e){d=d||{};var f,g=d.userStyleSheet;g&&(f=g.map(function(a){return{url:a.url||null,text:a.text||null}}));e&&Object.Jb(a.e,e);b=Object.Jb({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.f.userAgentRootURL,url:b||c,document:d.documentObject,fragment:d.fragment,userStyleSheet:f},Qp(a.e));Pp(a.b,b)}m.gb=function(){return this.b.gb()};
m.Ld=function(a){a:switch(a){case "left":a="ltr"===this.gb()?"previous":"next";break a;case "right":a="ltr"===this.gb()?"next":"previous";break a}this.b.k({a:"moveTo",where:a})};m.Kd=function(a){this.b.k({a:"moveTo",url:a})};m.Ud=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.Q.Ua?Lp(b,b.j):b.e.d;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ba("vivliostyle.viewer.Viewer",Rp);Rp.prototype.setOptions=Rp.prototype.Ad;Rp.prototype.addListener=Rp.prototype.Sd;Rp.prototype.removeListener=Rp.prototype.Vd;Rp.prototype.loadDocument=Rp.prototype.Jd;Rp.prototype.loadEPUB=Rp.prototype.Td;Rp.prototype.getCurrentPageProgression=Rp.prototype.gb;Rp.prototype.navigateToPage=Rp.prototype.Ld;Rp.prototype.navigateToInternalUrl=Rp.prototype.Kd;Rp.prototype.queryZoomFactor=Rp.prototype.Ud;ba("vivliostyle.viewer.ZoomType",Mp);Mp.FIT_INSIDE_VIEWPORT="fit inside viewport";
mn.call(qn,"load_vivliostyle","end",void 0);var Tp=16,Up="ltr";function Vp(a){window.adapt_command(a)}function Wp(){Vp({a:"moveTo",where:"ltr"===Up?"previous":"next"})}function Xp(){Vp({a:"moveTo",where:"ltr"===Up?"next":"previous"})}
function Yp(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)Vp({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)Vp({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)Vp({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)Vp({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)Xp(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)Wp(),a.preventDefault();else if("0"===b||"U+0030"===c)Vp({a:"configure",fontSize:Math.round(Tp)}),a.preventDefault();else if("t"===b||"U+0054"===c)Vp({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)Tp*=1.2,Vp({a:"configure",fontSize:Math.round(Tp)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)Tp/=1.2,Vp({a:"configure",
fontSize:Math.round(Tp)}),a.preventDefault()}
function Zp(a){switch(a.t){case "loaded":a=a.viewer;var b=Up=a.gb();a.bb.setAttribute("data-vivliostyle-page-progression",b);a.bb.setAttribute("data-vivliostyle-spread-view",a.Q.Ua);window.addEventListener("keydown",Yp,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Wp,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Xp,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(va(location.href,Ta(a||"")));break;case "hyperlink":a.internal&&Vp({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+n+"; margin: 0; }",document.head.appendChild(g));Pp(new xp(window,l,"main",Zp),a)});
