 ...
 *
 * Vivliostyle core 2016.2.0-pre.20160226043203
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function Jk(a,b,c,d,e){var f=0,g=Number.POSITIVE_INFINITY,k=!1,h=!1,l=!1,n=c["flow-options"];if(n){var p;a:{if(k=n.evaluate(a.f,"flow-options")){h=new mg;try{k.S(h);p=h.b;break a}catch(r){u.b(r,"toSet:")}}p={}}k=!!p.exclusive;h=!!p["static"];l=!!p.last}(p=c["flow-linger"])&&(g=og(p.evaluate(a.f,"flow-linger"),Number.POSITIVE_INFINITY));(c=c["flow-priority"])&&(f=og(c.evaluate(a.f,"flow-priority"),0));d=new bi(b,d,e,f,g,k,h,l);a.B.push(d);a.l==b&&(a.l=null);a.k&&Lk(a.k,d)}
...
ol(this,a,b):rl(this,a,b)}if(1<e&&(f=Y(this,a,"column-rule-width"),k=ml(this,a,"column-rule-style"),h=ml(this,a,"column-rule-color"),0<f&&k&&k!=Vd&&h!=he)){var l=Y(this,a,"column-gap"),n=this.b?b.height:b.width,p=this.b?"border-top":"border-left";for(d=1;d<e;d++){var r=(n+l)*d/e-l/2+b.j-f/2,q=b.height+b.k+b.w,v=b.d.ownerDocument.createElement("div");w(v,"position","absolute");w(v,this.b?"left":"top","0px");w(v,this.b?"top":"left",r+"px");w(v,this.b?"height":"width","0px");w(v,this.b?"width":"height",
q+"px");w(v,p,f+"px "+k.toString()+(h?" "+h.toString():""));b.d.insertBefore(v,b.d.firstChild)}}for(d=0;d<wl.length;d++)nl(this,a,b,wl[d],g);for(d=0;d<yl.length;d++)e=b,g=yl[d],f=c.h,(k=ml(this,a,g))&&f.push(new Uh(e.d,g,k))};
...
function Rl(a,b,c,d,e,f,g,k){var h=L("createShadows"),l=e.template,n;l instanceof ud?n=Ql(a,l.url,2,b,k,null):n=M(null);n.then(function(l){var n=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var q=b.getAttribute("href"),v=null;q?v=k?k.aa:a.aa:k&&(q="http://www.w3.org/1999/xhtml"==k.$.namespaceURI?k.$.getAttribute("href"):k.$.getAttributeNS("http://www.w3.org/1999/xlink","href"),v=k.Rc?k.Rc.aa:a.aa);q&&(q=sa(q,v.url),n=Ql(a,q,3,b,k,l))}null==n&&(n=M(l));n.then(function(l){var n;
if(n=d._pseudos){for(var r=Ll.createElementNS("http://www.pyroxy.com/ns/shadow","root"),p=r,q=0;q<Ml.length;q++){var v=Ml[q],pb;if(v){if(!n[v])continue;if(!("footnote-marker"!=v||c&&a.j))continue;if(v.match(/^first-/)&&(pb=e.display,!pb||pb===Od))continue;pb=Ll.createElementNS("http://www.w3.org/1999/xhtml","span");pb.setAttribute("data-adapt-pseudo",v)}else pb=Ll.createElementNS("http://www.pyroxy.com/ns/shadow","content");p.appendChild(pb);v.match(/^first-/)&&(p=pb)}l=new fi(b,r,null,k,l,2,new Ol(b,
...
"inner",J),f.appendChild(J));"iframe"==f.localName&&"http://www.w3.org/1999/xhtml"==f.namespaceURI&&Kl(f);if("http://www.gribuser.ru/xml/fictionbook/2.0"!=e.namespaceURI||"td"==F){for(var g=e.attributes,h=g.length,l=null,n=0;n<h;n++){var p=g[n],r=p.namespaceURI,q=p.localName,p=p.nodeValue;if(r)if("http://www.w3.org/2000/xmlns/"==r)continue;else"http://www.w3.org/1999/xlink"==r&&"href"==q&&(p=Wl(a,p));else{if(q.match(/^on/))continue;if("style"==q)continue;if("id"==q){$h(a.e,f,p);continue}"src"==q||
"href"==q||"poster"==q?p=Wl(a,p):"srcset"==q&&(p=p.split(",").map(function(b){return Wl(a,b.trim())}).join(","))}if(r){var Ea=Jl[r];Ea&&(q=Ea+":"+q)}"src"!=q||r||"img"!=F||"http://www.w3.org/1999/xhtml"!=P?"href"==q&&"image"==F&&"http://www.w3.org/2000/svg"==P&&"http://www.w3.org/1999/xlink"==r?a.e.f.push(vg(f,p)):r?f.setAttributeNS(r,q,p):f.setAttribute(q,p):l=p}l&&(g=vg(f,l),h=k.width,l=k.height,h&&h!==Ad&&l&&l!==Ad?a.e.f.push(g):X.push(g))}delete k.content;(g=k["list-style-image"])&&g instanceof
...
l)):Hi(k,b,vm(a,n)).then(function(){O(c,null)});else{e=Bi(e,a.b,g);for(var p=a.Ka,r=a.od,q=b.parent;q&&q.d;)q=q.parent;if(q){var v=q.b.ownerDocument.createElement("div");v.style.left="0px";v.style.top="0px";a.b?(v.style.bottom="0px",v.style.width="1px"):(v.style.right="0px",v.style.height="1px");q.b.appendChild(v);var y=v.getBoundingClientRect(),p=Math.max(a.b?y.top:y.left,p),r=Math.min(a.b?y.bottom:y.right,r);q.b.removeChild(v);q=a.b?n.O-n.U:n.T-n.W;"left"==e?r=Math.max(r,p+q):p=Math.min(p,r-q)}p=
new se(p,(a.b?-1:1)*a.Ea,r,(a.b?-1:1)*a.Za);r=n;a.b&&(r=Ke(n));Pe(p,a.cb,r,e);a.b&&(n=new se(-r.O,r.W,-r.U,r.T));w(d,"left",n.W-(a.b?a.Za:a.Ka)+a.j+"px");w(d,"top",n.U-(a.b?a.Ka:a.Ea)+a.k+"px");n=a.b?n.W:n.O;wm(a,n)&&0!=a.u.length?(b=b.modify(),b.e=!0,O(c,b)):(Fm(a),p=a.b?Ke(a.h):a.h,a.b?r=Ke(vm(a,new se(-r.O,r.W,-r.U,r.T))):r=vm(a,r),Qe(p,a.cb,r,e),Gm(a),"left"==e?a.xc=n:a.yc=n,Tm(a,n),O(c,l))}});return N(c)}
...
d(P);break;case "fit-content width":c=J?d(P):k();break;case "fit-content height":c=J?k():d(P)}F[a]=parseFloat(c);w(b,"position",n);w(b,"display",l)});w(b,"width",p);w(b,"height",r);q.insertBefore(b,v);q.removeChild(v);return F};function tn(a){var b=a["writing-mode"],b=b&&b.value;a=(a=a.direction)&&a.value;return b===ie||b!==je&&a!==ee?"ltr":"rtl"}
...
function Sn(a,b,c,d,e,f){var g=a.d.d,k={},h={},l={},n;for(n in b){var p=Jn[n];if(p){var r=b[n],q=a.oa[n],v=new Tn(r,q.style,c,g,f);k[p.ia]=r;h[p.ia]=q;l[p.ia]=v}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.Z.evaluate(e);var y=Xn(l,b),J=!1,X={};Object.keys(k).forEach(function(a){var b=W(g,h[a].style[c?"max-width":"max-height"],d.Z);b&&(b=b.evaluate(e),y[a]>b&&(b=l[a]=new Wn(k[a],h[a].style,c,g,f,b),X[a]=b.d(),J=!0))});J&&(y=Xn(l,b),J=!1,["start","center","end"].forEach(function(a){y[a]=X[a]||y[a]}));
...
function Zn(a,b){var c=a.style,d=a.d.d,e=b.start,f=b.end,g=b.Z,k=a.d.u[g].ha(d,null),h=W(d,c[g],k),l=W(d,c["margin-"+e],k),n=W(d,c["margin-"+f],k),p=bl(d,c["padding-"+e],k),r=bl(d,c["padding-"+f],k),q=dl(d,c["border-"+e+"-width"],c["border-"+e+"-style"],k),v=dl(d,c["border-"+f+"-width"],c["border-"+f+"-style"],k),y=E(d,k,D(d,D(d,q,p),D(d,v,r)));h?(y=E(d,y,h),l||n?l?n=E(d,y,l):l=E(d,y,n):n=l=dd(d,y,new mc(d,.5))):(l||(l=d.b),n||(n=d.b),h=E(d,y,D(d,l,n)));c[e]=new K(l);c[f]=new K(n);c["margin-"+e]=
...
m.ia=function(a,b){var c=this.style,d=this.d.d,e=a.start,f=a.end,g="left"===e,k=g?b.yb:b.xb,h=W(d,c[a.Z],k),g=g?b.marginLeft:b.marginTop;if("start"===this.j.ia)c[e]=new K(g);else if(h){var l=bl(d,c["margin-"+e],k),n=bl(d,c["margin-"+f],k),p=bl(d,c["padding-"+e],k),r=bl(d,c["padding-"+f],k),q=dl(d,c["border-"+e+"-width"],c["border-"+e+"-style"],k),f=dl(d,c["border-"+f+"-width"],c["border-"+f+"-style"],k),h=D(d,h,D(d,D(d,p,r),D(d,D(d,q,f),D(d,l,n))));switch(this.j.ia){case "center":c[e]=new K(D(d,g,
ed(d,E(d,k,h),new mc(d,2))));break;case "end":c[e]=new K(E(d,D(d,g,k),h))}}};
function $n(a,b,c){function d(a){if(y)return y;y={Z:v?v.evaluate(a):null,Ga:h?h.evaluate(a):null,Ha:l?l.evaluate(a):null};var b=k.evaluate(a),c=0;[r,n,p,q].forEach(function(b){b&&(c+=b.evaluate(a))});(null===y.Ga||null===y.Ha)&&c+y.Z+y.Ga+y.Ha>b&&(null===y.Ga&&(y.Ga=0),null===y.Ha&&(y.ne=0));null!==y.Z&&null!==y.Ga&&null!==y.Ha&&(y.Ha=null);null===y.Z&&null!==y.Ga&&null!==y.Ha?y.Z=b-c-y.Ga-y.Ha:null!==y.Z&&null===y.Ga&&null!==y.Ha?y.Ga=b-c-y.Z-y.Ha:null!==y.Z&&null!==y.Ga&&null===y.Ha?y.Ha=b-c-y.Z-
y.Ga:null===y.Z?(y.Ga=y.Ha=0,y.Z=b-c):y.Ga=y.Ha=(b-c-y.Z)/2;return y}var e=a.style;a=a.d.d;var f=b.Mc,g=b.Qc;b=b.Z;var k=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],h=cl(a,e["margin-"+f],k),l=cl(a,e["margin-"+g],k),n=bl(a,e["padding-"+f],k),p=bl(a,e["padding-"+g],k),r=dl(a,e["border-"+f+"-width"],e["border-"+f+"-style"],k),q=dl(a,e["border-"+g+"-width"],e["border-"+g+"-style"],k),v=W(a,e[b],k),y=null;e[b]=new K(new oc(a,function(){var a=d(this).Z;return null===a?0:a},b));e["margin-"+f]=new K(new oc(a,
...
function vo(a,b){if(!b)return 0;var c=Number.POSITIVE_INFINITY,d;for(d in a.e){var e=b.b[d];if((!e||0==e.b.length)&&a.b){var f=a.d;f.l=d;for(e=0;null!=f.l&&(e+=5E3,Ik(f,e,0)!=Number.POSITIVE_INFINITY););e=a.b.b[d];b!=a.b&&e&&(e=e.clone(),b.b[d]=e)}if(e){for(var f=a,g=Number.POSITIVE_INFINITY,k=0;k<e.b.length;k++){for(var h=e.b[k].d.Ra,l=h.ja[0].ga,n=h.ba,p=h.K,r=0;l.ownerDocument!=f.aa.b;)r++,l=h.ja[r].ga,p=!1,n=0;h=Ah(f.aa,l,n,p);h<g&&(g=h)}f=g;f<c&&(c=f)}}return c}
...
function xo(a,b,c){var d=a.b.b[c];if(!d)return M(!0);Nm(b);a.e[c]&&0<b.cb.length&&(b.pd=!1);var e=L("layoutColumn"),f=[],g=[];rf(function(c){for(;0<d.b.length-g.length;){for(var e=0;0<=g.indexOf(e);)e++;var l=d.b[e];if(l.b.b>a.j)break;for(var n=1;n<d.b.length;n++)if(!(0<=g.indexOf(n))){var p=d.b[n];if(p.b.b>a.j)break;ci(p.b,l.b)&&(l=p,e=n)}var r=l.b,q=!0;Qm(b,l.d).then(function(a){l.b.Rd&&(null===a||r.d)&&f.push(e);r.d?(g.push(e),Q(c)):a?(l.d=a,Q(c)):(g.push(e),q?q=!1:tf(c))});if(q){q=!1;return}}Q(c)}).then(function(){d.b=
d.b.filter(function(a,b){return 0<=f.indexOf(b)||0>g.indexOf(b)});O(e,!0)});return N(e)}
function yo(a,b,c,d,e,f,g,k){var h=ml(c,a,"enabled");if(h&&h!==le)return M(!0);var l=L("layoutContainer"),n=ml(c,a,"wrap-flow")===Ad,p=c.b?c.g&&c.D:c.f&&c.G,h=ml(c,a,"flow-from"),r=a.viewport.b.createElement("div"),q=ml(c,a,"position");w(r,"position",q?q.name:"absolute");d.insertBefore(r,d.firstChild);var v=new ri(r);v.b=c.b;c.jb(a,v,b,a.f);v.A=e;v.B=f;e+=v.left+v.marginLeft+v.Y;f+=v.top+v.marginTop+v.ea;if(h&&h.wd())if(a.D[h.toString()])c.fc(a,v,b,null,1,a.g,a.f),h=M(!0);else{var y=L("layoutContainer.inner"),
J=h.toString(),X=Y(c,a,"column-count"),P=Y(c,a,"column-gap"),F=1<X?Y(c,a,"column-width"):v.width,h=ll(c,a),Ea=0,q=ml(c,a,"shape-inside"),pb=qg(q,0,0,v.width,v.height,a),Ok=new Pl(J,a,a.viewport,a.d,h,a.aa,a.f,a.style.u,a,b,a.Ia,a.Ja,k),xh=0,Z=null;rf(function(b){for(;xh<X;){var c=xh++;if(1<X){var d=a.viewport.b.createElement("div");w(d,"position","absolute");r.appendChild(d);Z=new um(d,Ok,a.g);Z.b=v.b;Z.Ja=v.Ja;Z.ac=v.ac;v.b?(w(d,"margin-left",v.j+"px"),w(d,"margin-right",v.D+"px"),c=c*(F+P)+v.k,
yi(Z,0,v.width),xi(Z,c,F)):(w(d,"margin-top",v.k+"px"),w(d,"margin-bottom",v.w+"px"),c=c*(F+P)+v.j,xi(Z,0,v.height),yi(Z,c,F));Z.A=e+v.j;Z.B=f+v.k}else Z=new um(r,Ok,a.g),wi(Z,v),v=Z;Z.G=p?[]:g;Z.Zb=pb;if(0<=Z.width){var h=L("inner");xo(a,Z,J).then(function(){Z.L&&"column"!=Z.L&&(xh=X,"region"!=Z.L&&(a.D[J]=!0));O(h,!0)});c=N(h)}else c=M(!0);if(c.za()){c.then(function(){0<k.b.length?Q(b):(Ea=Math.max(Ea,Z.e),tf(b))});return}0<k.b.length||(Ea=Math.max(Ea,Z.e))}Q(b)}).then(function(){v.e=Ea;c.fc(a,
v,b,Z,X,a.g,a.f);O(y,!0)});h=N(y)}else{h=ml(c,a,"content");q=!1;if(h&&Ai(h)){var Pk=a.viewport.b.createElement("span");h.S(new zi(Pk,a));r.appendChild(Pk);zl(c,a,v,a.f)}else c.wa&&(d.removeChild(r),q=!0);q||c.fc(a,v,b,null,1,a.g,a.f);h=M(!0)}h.then(function(){if(!c.f||0<Math.floor(v.e)){if(!n){var h=v.A+v.left,p=v.B+v.top,q=ui(v)+v.width+vi(v),y=si(v)+v.height+ti(v),F=ml(c,a,"shape-outside"),h=qg(F,h,p,q,y,a);gb(a.viewport.root)&&g.push(Ae(h,0,-1.25*vc(a,"em",!1)));g.push(h)}}else if(0==c.children.length){d.removeChild(r);
O(l,!0);return}var J=c.children.length-1;qf(function(){for(;0<=J;){var d=c.children[J--],d=yo(a,b,d,r,e,f,g,k);if(d.za())return d}return M(!1)}).then(function(){O(l,!0)})});return N(l)}
