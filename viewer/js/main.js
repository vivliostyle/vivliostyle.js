 ...
 *
 * Vivliostyle core 2019.1.100-pre.20190117083511
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function yc(a,b,c){return b===a.h||b===a.b||c==a.h||c==a.b?a.h:b===a.j||b===a.f?c:c===a.j||c===a.f?b:new cc(a,b,c)}function y(a,b,c){return b===a.b?c:c===a.b?b:new mc(a,b,c)}function B(a,b,c){return b===a.b?new bc(a,c):c===a.b?b:new nc(a,b,c)}function zc(a,b,c){return b===a.b||c===a.b?a.b:b===a.f?c:c===a.f?b:new oc(a,b,c)}function Ac(a,b,c){return b===a.b?a.b:c===a.f?b:new pc(a,b,c)};var Bc={};function Cc(){}n=Cc.prototype;n.lc=function(a){for(var b=0;b<a.length;b++)a[b].fa(this)};n.Ne=function(){throw Error("E_CSS_EMPTY_NOT_ALLOWED");};n.Oe=function(){throw Error("E_CSS_SLASH_NOT_ALLOWED");};n.sd=function(){throw Error("E_CSS_STR_NOT_ALLOWED");};n.kc=function(){throw Error("E_CSS_IDENT_NOT_ALLOWED");};n.Uc=function(){throw Error("E_CSS_NUMERIC_NOT_ALLOWED");};n.Tc=function(){throw Error("E_CSS_NUM_NOT_ALLOWED");};n.Sc=function(a){return this.Tc(a)};
...
n.Pf=function(){return!1};n.Nd=function(){return!1};function Ic(){if(C)throw Error("E_INVALID_CALL");}v(Ic,Hc);Ic.prototype.za=function(a){return new Gb(a,"")};Ic.prototype.Ya=function(){};Ic.prototype.fa=function(a){return a.Ne(this)};var C=new Ic;function Jc(){if(Kc)throw Error("E_INVALID_CALL");}v(Jc,Hc);Jc.prototype.za=function(a){return new Gb(a,"/")};Jc.prototype.Ya=function(a){a.append("/")};Jc.prototype.fa=function(a){return a.Oe(this)};var Kc=new Jc;function Lc(a){this.Qc=a}v(Lc,Hc);
Lc.prototype.za=function(a){return new Gb(a,this.Qc)};Lc.prototype.Ya=function(a,b){b?(a.append('"'),a.append(Sa(this.Qc)),a.append('"')):a.append(this.Qc)};Lc.prototype.fa=function(a){return a.sd(this)};function Mc(a){this.name=a;if(Bc[a])throw Error("E_INVALID_CALL");Bc[a]=this}v(Mc,Hc);Mc.prototype.za=function(a){return new Gb(a,this.name)};Mc.prototype.Ya=function(a,b){b?a.append(Ra(this.name)):a.append(this.name)};Mc.prototype.fa=function(a){return a.kc(this)};Mc.prototype.Pf=function(){return!0};
function D(a){var b=Bc[a];b||(b=new Mc(a));return b}function F(a,b){this.L=a;this.ka=b.toLowerCase()}v(F,Hc);F.prototype.za=function(a,b){return this.L?b&&"%"==this.ka?100==this.L?b:new oc(a,b,new Gb(a,this.L/100)):new rc(a,this.L,this.ka):a.b};F.prototype.Ya=function(a){a.append(this.L.toString());a.append(this.ka)};F.prototype.fa=function(a){return a.Uc(this)};F.prototype.uc=function(){return!0};function Nc(a){this.L=a}v(Nc,Hc);
Nc.prototype.za=function(a){return this.L?1==this.L?a.f:new Gb(a,this.L):a.b};Nc.prototype.Ya=function(a){a.append(this.L.toString())};Nc.prototype.fa=function(a){return a.Tc(this)};Nc.prototype.cf=function(){return!0};function Oc(a){this.L=a}v(Oc,Nc);Oc.prototype.fa=function(a){return a.Sc(this)};function Pc(a){this.b=a}v(Pc,Hc);Pc.prototype.Ya=function(a){a.append("#");var b=this.b.toString(16);a.append("000000".substr(b.length));a.append(b)};Pc.prototype.fa=function(a){return a.ce(this)};
function Qc(a){this.url=a}v(Qc,Hc);Qc.prototype.Ya=function(a){a.append('url("');a.append(Sa(this.url));a.append('")')};Qc.prototype.fa=function(a){return a.Vc(this)};function Rc(a,b,c,d){var e=b.length;b[0].Ya(a,d);for(var f=1;f<e;f++)a.append(c),b[f].Ya(a,d)}function Ec(a){this.values=a}v(Ec,Hc);Ec.prototype.Ya=function(a,b){Rc(a,this.values," ",b)};Ec.prototype.fa=function(a){return a.Mb(this)};Ec.prototype.Nd=function(){return!0};function Fc(a){this.values=a}v(Fc,Hc);
Fc.prototype.Ya=function(a,b){Rc(a,this.values,",",b)};Fc.prototype.fa=function(a){return a.jc(this)};function Gc(a,b){this.name=a;this.values=b}v(Gc,Hc);Gc.prototype.Ya=function(a,b){a.append(Ra(this.name));a.append("(");Rc(a,this.values,",",b);a.append(")")};Gc.prototype.fa=function(a){return a.Rb(this)};function G(a){this.Hc=a}v(G,Hc);G.prototype.za=function(){return this.Hc};G.prototype.Ya=function(a){a.append("-epubx-expr(");this.Hc.Fa(a,0);a.append(")")};G.prototype.fa=function(a){return a.Rc(this)};
...
function le(a,b,c){var d=b.frameTrace;if(!d){for(var d=b.stack?b.stack+"\n\t---- async ---\n":"",e=a.top;e;e=e.parent)d+="\t",d+=e.name,d+="\n";b.frameTrace=d}if(c){for(d=a.top;d&&d!=c;)d=d.parent;d==c&&(a.top=d)}for(a.g=b;a.top&&!a.top.j;)a.top=a.top.parent;a.top?(b=a.g,a.g=null,a.top.j(a.top,b)):a.g&&w.error(a.g,"Unhandled exception in task",a.name)}function je(a){this.value=a}n=je.prototype;n.then=function(a){a(this.value)};n.ea=function(a){return a(this.value)};n.Cc=function(a){return new je(a)};
n.Ja=function(a){O(a,this.value)};n.Wa=function(){return!1};n.get=function(){return this.value};function xe(a){this.b=a}n=xe.prototype;n.then=function(a){this.b.then(a)};n.ea=function(a){if(this.Wa()){var b=new he(this.b.f,this.b.parent,"AsyncResult.thenAsync");b.b=ie;this.b.parent=b;this.b.then(function(c){a(c).then(function(a){O(b,a)})});return b.result()}return a(this.b.g)};n.Cc=function(a){return this.Wa()?this.ea(function(){return new je(a)}):new je(a)};
...
oh.prototype.jc=function(a){for(var b={},c=0;c<a.values.length;c++){this.values={};if(a.values[c]instanceof Fc)this.error=!0;else{a.values[c].fa(this);for(var d=this.values,e=t(this.f),f=e.next();!f.done;f=e.next()){var f=f.value,g=d[f]||this.b.l[f],h=b[f];h||(h=[],b[f]=h);h.push(g)}this.values["background-color"]&&c!=a.values.length-1&&(this.error=!0)}if(this.error)return null}this.values={};for(var l in b)this.values[l]="background-color"==l?b[l].pop():new Fc(b[l]);return null};
...
ph.prototype.jc=function(a){a.values[0].fa(this);if(this.error)return null;for(var b=[this.values["font-family"]],c=1;c<a.values.length;c++)b.push(a.values[c]);a=new Fc(b);a.fa(this.b.g["font-family"])?this.values["font-family"]=a:this.error=!0;return null};ph.prototype.kc=function(a){if(a=this.b.f[a.name])for(var b in a)this.values[b]=a[b];else this.error=!0;return null};var qh={SIMPLE:lh,INSETS:mh,INSETS_SLASH:nh,COMMA:oh,FONT:ph};
...
{"block-size":"height","inline-size":"width"});function V(a,b){this.value=a;this.ab=b}n=V.prototype;n.Kf=function(){return this};n.Id=function(a){a=this.value.fa(a);return a===this.value?this:new V(a,this.ab)};n.Mf=function(a){return a?new V(this.value,this.ab+a):this};n.evaluate=function(a,b){return kg(a,this.value,b)};n.tf=function(){return!0};function Th(a,b,c){V.call(this,a,b);this.ia=c}v(Th,V);Th.prototype.Kf=function(){return new V(this.value,this.ab)};
Th.prototype.Id=function(a){a=this.value.fa(a);return a===this.value?this:new Th(a,this.ab,this.ia)};Th.prototype.Mf=function(a){return a?new Th(this.value,this.ab+a,this.ia):this};Th.prototype.tf=function(a){return!!this.ia.evaluate(a)};function Uh(a,b,c){return(!b||c.ab>b.ab)&&c.tf(a)?c.Kf():b}var Vh={"region-id":!0,"fragment-selector-id":!0};function Wh(a){return"_"!=a.charAt(0)&&!Vh[a]}function Xh(a,b,c){c?a[b]=c:delete a[b]}function Yh(a,b){var c=a[b];c||(c={},a[b]=c);return c}
...
function Cm(a,b){var c=a.b,d=c.Nf(b),e=L("LayoutIterator");Ce(function(b){for(var e;d.w;){e=d.w.A?1!==d.w.A.nodeType?Jk(d.w.A,d.w.nc)?void 0:d.w.K?c.xf(d):c.pf(d):d.w.xa?d.w.K?c.wf(d):c.eg(d):d.w.K?c.mc(d):c.ud(d):void 0;e=(e&&e.Wa()?e:M(!0)).ea(function(){return d.Ob?M(null):Dm(a.f,d.w,d.yd)});if(e.Wa()){e.then(function(a){d.Ob?Q(b):(d.w=a,P(b))});return}if(d.Ob){Q(b);return}d.w=e.get()}Q(b)}).then(function(){O(e,d.w)});return e.result()}function Em(a){this.bc=a}v(Em,Am);n=Em.prototype;n.fg=function(){};
n.Hf=function(){};n.Nf=function(a){return{w:a,yd:!!this.bc&&a.K,Ob:!1,bc:this.bc,Xc:null,Ee:!1,Qf:[],dd:null}};n.pf=function(a){a.Ee=!1};n.ud=function(a){a.Qf.push(Wk(a.w));a.Xc=Ql(a.Xc,a.w.g);a.Ee=!0;return this.fg(a)};n.mc=function(a){var b;a.Ee?(b=(b=void 0,M(!0)),b=b.ea(function(){a.Ob||(a.Qf=[],a.bc=!1,a.yd=!1,a.Xc=null);return M(!0)})):b=(b=this.Hf(a))&&b.Wa()?b:M(!0);return b.ea(function(){a.Ob||(a.Ee=!1,a.dd=Wk(a.w),a.Xc=Ql(a.Xc,a.w.G));return M(!0)})};
function Fm(a,b,c){this.nf=[];this.ya=Object.create(a);this.ya.element=b;this.ya.j=a.j.clone();this.ya.u=!1;this.ya.ff=c.D;this.ya.Fd=a;a=Gm(this.ya,c);this.ya.da-=a;var d=this;this.ya.Ad=function(a){return Hm.prototype.Ad.call(this,a).ea(function(a){d.nf.push(Wk(a));return M(a)})}}function Im(a,b){return Jm(a.ya,b,!0)}Fm.prototype.$b=function(a){var b=this.ya.$b();if(a){a=Wk(this.nf[0]);var c=new Km(a,null,a.wa,0);c.f(this.ya,0);if(!b.w)return{Ab:c,w:a}}return b};
...
function $o(a,b){var c=a.l,d=bo(b),e=c.Ye(cl(b));return(e?M(e):d.Ff(b,c,a)).ea(function(e){var f=Sk(b),h=Xo(a,b),l=d.rf(e,c),f=new $m(e,f);if(l&&Zm(l,e))return rn(c,e,h.A),M(h);if(kn(c,e)||wn(c,e))return vn(c,f),rn(c,e,h.A),M(h);if(a.sa)return M(null);var k=go(h,a.f,0,a.b);return po(a,k)?M(h):Vo(a,f,d,k,l).ea(function(a){if(a)return M(null);rn(c,e,h.A);return M(h)})})}
...
So.prototype.Ad=function(a){var b=this;return Hm.prototype.Ad.call(this,a).ea(function(a){if(a){for(var c=a;c.parent;)c=c.parent;c=c.A;b.Sb.push(c);b.qe&&Kp(b,c);b.$f.push(No(b,c));if(b.qe){var e=b.Aa;if(b.bg.b){if("block-end"===e||"left"===e)e=Na(c,"height"),""!==e&&"auto"!==e&&x(c,"margin-top","auto")}else if("block-end"===e||"bottom"===e)e=Na(c,"width"),""!==e&&"auto"!==e&&x(c,"margin-left","auto")}}return M(a)})};
...
function Nr(a){if(a.w.Oa)return M(!0);var b,c=b=a.M.textContent,d=L("preprocessTextContent"),e=ee("PREPROCESS_TEXT_CONTENT"),f=0;Be(function(){return f>=e.length?M(!1):e[f++](a.w,c).ea(function(a){c=a;return M(!0)})}).then(function(){a.w.Oa=Pr(b,c,0);O(d,!0)});return d.result()}
...
var Ur={"box-decoration-break":!0,"float-min-wrap-block":!0,"float-reference":!0,"flow-into":!0,"flow-linger":!0,"flow-options":!0,"flow-priority":!0,"footnote-policy":!0,page:!0};function Ir(a,b,c){var d=c["background-image"];d&&Tr(a,d);var d=c.position===Ed,e;for(e in c)if(!Ur[e]){var f=c[e],f=f.fa(new Rg(a.ca.url,a.h));f.uc()&&Mb(f.ka)&&(f=new F(Sc(f,a.b),"px"));xk[e]||d&&yk[e]?a.page.u.push(new zk(b,e,f)):x(b,e,f.toString())}}
function Yo(a,b,c,d){if(!b.K){var e=(b.ua?b.ua.b:a.l).l(a.M,!1);if(e=e._pseudos)if(e=e[c])c={},b.b=tr(a,b.b,"rtl"===b.direction,e,c),b=c.content,El(b)&&(b.fa(new Dl(d,a.b,b,a.B)),delete c.content),Ir(a,d,c)}}
...
function yt(a,b,c,d,e,f,g,h,l,k){function m(){p.b=q.clone();return zt(p,b,c,d,e,f,g,r,h,l,k,z).ea(function(a){return a?M({Bb:a,position:p.b}):M(null)})}var p=a,q=p.b.clone(),r=xt(p,g,c,h,l),z=!0;return m().ea(function(a){if(!a)return M(null);if(1>=k)return M(a.Bb);var b=Eq(c,p,"column-fill")||Xc,b=it(k,b,m,r,h,a.Bb,p.b.b[l]);if(!b)return M(a.Bb);z=!1;g.g=!0;r.g=!0;return Zs(b,a).ea(function(a){g.g=!1;g.Lc=!1;r.g=!1;p.b=a.position;return M(a.Bb)})})}
...
E,a.j);Sq(c,a,r,a.j)}else c.va&&(d.removeChild(p),z=!0);z||c.Jd(a,r,b,null,1,a.g,a.j);l=M(!0)}l.then(function(){if(Gn(h))O(k,!0);else{if(!c.h||0<Math.floor(r.h)){if(!z&&!m){var l=Eq(c,a,"shape-outside"),l=Bl(r,l,a);g.push(l)}}else if(!c.children.length){d.removeChild(p);O(k,!0);return}var q=c.children.length-1;Be(function(){for(;0<=q;){var d=c.children[q--],d=At(a,b,d,p,e,f,g,h);if(d.Wa())return d.ea(function(){return M(!Gn(h))});if(Gn(h))break}return M(!1)}).then(function(){O(k,!0)})}});return k.result()}
...
n.ac=function(a){return this.b.O?this.b.O:(a=this.Pb[a?a.R:0])?a.fb.G:null};
function xu(a,b,c,d){c.I.style.display="none";c.I.style.visibility="visible";c.I.style.position="";c.I.style.top="";c.I.style.left="";c.I.setAttribute("data-vivliostyle-page-side",c.f);var e=b.hb[d];c.B=!b.item.R&&!d;b.hb[d]=c;if(a.b.G){if(!d&&0<b.item.R){var f=a.b.b[b.item.R-1];b.item.b=f.b+f.f}b.item.f=b.hb.length;a.b.f=a.b.b.reduce(function(a,b){return a+b.f},0);a.b.u&&a.b.u(a.b.f)}if(e)b.fb.viewport.f.replaceChild(c.I,e.I),eb(e,{type:"replaced",target:null,currentTarget:null,Vf:c});else{e=null;
