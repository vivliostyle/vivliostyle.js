 ...
 *
 * Vivliostyle core 2019.1.100-pre.20190224080415
 */
(function(factory) {
...
function fg(a,b,c,d,e,f){var g=a.u,h=a.f,l=a.F,k,m,p,q;e&&(a.j=2,a.F.push("{"));a:for(;0<b;--b)switch(k=R(h),a.b[k.type]){case 28:if(18!=tf(h,1).type){eg(a)?(g.error("E_CSS_COLON_EXPECTED",tf(h,1)),a.b=Uf):(a.b=Pf,g.Tb());continue}m=tf(h,2);if(!(m.b||1!=m.type&&6!=m.type)){if(0<=h.b)throw Error("F_CSSTOK_BAD_CALL mark");h.b=h.f}a.g=k.text;a.C=!1;S(h);S(h);a.b=Qf;l.splice(0,l.length);continue;case 46:if(18!=tf(h,1).type){a.b=Uf;g.error("E_CSS_COLON_EXPECTED",tf(h,1));continue}a.g=k.text;a.C=!1;S(h);
...
(17==m.type||0==m.type||13==m.type)){S(h);a.C=!0;continue}$f(a,"E_CSS_SYNTAX",k);continue;case 54:m=tf(h,1);switch(m.type){case 4:case 3:case 5:if(!m.b){S(h);continue}}a.b===Qf&&0<=h.b?(uf(h),a.b=Pf,g.Tb()):$f(a,"E_CSS_UNEXPECTED_PLUS",k);continue;case 26:S(h);case 48:h.b=-1;(m=Zf(a,";",k))&&a.g&&g.Qb(a.g,m,a.C);a.b=d?Mf:Lf;continue;case 44:S(h);h.b=-1;m=Zf(a,";",k);if(c)return a.result=m,!0;a.g&&m&&g.Qb(a.g,m,a.C);if(d)return!0;$f(a,"E_CSS_SYNTAX",k);continue;case 31:m=tf(h,1);9==m.type?(10!=tf(h,
...
bj.prototype.rc=function(a){var b=this.f,c=b.J,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.C)];b.C++;break;case "close-quote":return 0<b.C&&b.C--,c[2*Math.min(d,b.C)+1];case "no-open-quote":return b.C++,new Oc("");case "no-close-quote":return 0<b.C&&b.C--,new Oc("")}return a};
...
function sj(a,b,c,d){this.u=a;this.l=b;this.Zb=c;this.xb=d;this.h=[[],[]];this.ca={};this.G=this.F=this.ua=this.b=null;this.Ba=this.la=this.Y=this.j=this.f="";this.Z=this.N=null;this.ta=this.ob=!0;this.g={};this.H=[{}];this.J=[new Oc("\u201c"),new Oc("\u201d"),new Oc("\u2018"),new Oc("\u2019")];this.C=0;this.lang="";this.Mb=[0];this.Za=0;this.sa=[{}];this.Cb=this.sa[0];this.S=null;this.Lb=[this.S];this.Jb=[{}];this.yb=this.sa[0];this.A={};this.fb=[];this.Kb=[]}
...
function Ij(a){for(var b=1;-1<=b;--b)for(var c=a.h[a.h.length-b-2],d=0;d<c.length;)c[d].f(a,b)?c.splice(d,1):d++;a.h.pop();a.ob=!1}var Jj=null;function Kj(a,b,c,d,e,f,g){Hf.call(this,a,b,g);this.b=null;this.ba=0;this.h=this.mb=null;this.C=!1;this.ia=c;this.l=d?d.l:Jj?Jj.clone():new rj;this.G=e;this.A=f;this.u=0;this.j=null}v(Kj,If);Kj.prototype.Uf=function(a){oi(this.l.Ad,"*",a)};function Lj(a,b){var c=ei(a.b,b);c!==b&&c.g(a.l)||a.Uf(c)}
...
n.te=function(){var a="f"+Nj++;Lj(this,new ki(new Vi(a,this.j,null)));this.b=[new Li(a)];this.j=null};n.Sc=function(){Oj(this);this.h=null;this.C=!1;this.ba=0;this.b=[]};n.Tb=function(){var a;0!=this.u?(Kf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.u=1,this.mb={},this.h=null,this.ba=0,this.C=!1,this.b=[])};n.error=function(a,b){If.prototype.error.call(this,a,b);1==this.u&&(this.u=0)};n.Wc=function(a){If.prototype.Wc.call(this,a);this.u=0};
n.La=function(){Oj(this);If.prototype.La.call(this);1==this.u&&(this.u=0)};n.dc=function(){If.prototype.dc.call(this)};function Oj(a){if(a.b){var b=a.ba+a.l.nf();Lj(a,a.Xf(b));a.b=null;a.h=null;a.j=null;a.C=!1;a.ba=0}}n.Xf=function(a){var b=this.G;this.C&&(b=b?"xxx-bogus-xxx":"footnote");return new li(this.mb,a,this.h,b,this.j)};n.Qb=function(a,b,c){Eh(this.A,a,b,c,this)};n.kd=function(a,b){Jf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};
...
function Uk(a,b){if(a===b)return!0;if(!a||!b||a.na!==b.na||a.K!==b.K||a.pa.length!==b.pa.length)return!1;for(var c=0;c<a.pa.length;c++)if(!Sk(a.pa[c],b.pa[c]))return!1;return!0}function Vk(a){return{pa:[{node:a.M,kb:Wk,wa:a.wa,Ja:null,Ga:null,Sa:0}],na:0,K:!1,Qa:a.Qa}}function Xk(a,b){var c=new Yk(a.node,b,0);c.kb=a.kb;c.wa=a.wa;c.Ja=a.Ja;c.Ga=a.Ga?Xk(a.Ga,Zk(b)):null;c.D=a.D;c.Sa=a.Sa+1;return c}var Wk=0;
...
this.D=b?b.D:null;this.u=null;this.ua={};this.Sa=1;this.Y=this.J=null}function cl(a){a.ya=!0;a.j=a.parent?a.parent.j:0;a.B=null;a.C=null;a.na=0;a.K=!1;a.display=null;a.W=bl;a.Ca=null;a.l=null;a.N=null;a.ca=null;a.Z="baseline";a.H=!1;a.uc=a.parent?a.parent.uc:0;a.F=a.parent?a.parent.F:null;a.A=a.parent?a.parent.A:!1;a.g=null;a.G=null;a.Ja=null;a.hd=!1;a.S=!1;a.b=a.parent?a.parent.b:!1;a.Ja=null;a.Qa=null;a.D=a.parent?a.parent.D:null;a.u=null;a.ua={};a.Sa=1;a.J=null;a.Y=null}
function dl(a){var b=new Yk(a.M,a.parent,a.Ma);b.na=a.na;b.K=a.K;b.Ja=a.Ja;b.kb=a.kb;b.wa=a.wa;b.Ga=a.Ga;b.ya=a.ya;b.j=a.j;b.display=a.display;b.W=a.W;b.Ca=a.Ca;b.l=a.l;b.N=a.N;b.ca=a.ca;b.Z=a.Z;b.la=a.la;b.sa=a.sa;b.ta=a.ta;b.hd=a.hd;b.S=a.S;b.H=a.H;b.uc=a.uc;b.F=a.F;b.A=a.A;b.g=a.g;b.G=a.G;b.B=a.B;b.C=a.C;b.f=a.f;b.b=a.b;b.xa=a.xa;b.Qa=a.Qa;b.D=a.D;b.u=a.u;b.ua=Object.create(a.ua);b.Sa=a.Sa;b.J=a.J;b.Y=a.Y;return b}Yk.prototype.modify=function(){return this.Ba?dl(this):this};
function Zk(a){var b=a;do{if(b.Ba)break;b.Ba=!0;b=b.parent}while(b);return a}Yk.prototype.clone=function(){for(var a=dl(this),b=a,c;c=b.parent;)c=dl(c),b=b.parent=c;return a};function el(a){return{node:a.M,kb:a.kb,wa:a.wa,Ja:a.Ja,Ga:a.Ga?el(a.Ga):null,D:a.D,Sa:a.Sa}}function fl(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(el(b)),b=b.parent;while(b);b=a.Qa?gl(a.Qa,a.na,-1):a.na;return{pa:c,na:b,K:a.K,Qa:a.Qa}}function hl(a){for(a=a.parent;a;){if(a.hd)return!0;a=a.parent}return!1}
function il(a,b){for(var c=a;c;)c.ya||b(c),c=c.parent}function jl(a,b){return a.D===b&&!!a.parent&&a.parent.D===b}function kl(a){this.f=a;this.b=null}kl.prototype.clone=function(){var a=new kl(this.f);if(this.b){a.b=[];for(var b=0;b<this.b.length;++b)a.b[b]=this.b[b]}return a};function ll(a,b){if(!b)return!1;if(a===b)return!0;if(!Uk(a.f,b.f))return!1;if(a.b){if(!b.b||a.b.length!==b.b.length)return!1;for(var c=0;c<a.b.length;c++)if(!Uk(a.b[c],b.b[c]))return!1}else if(b.b)return!1;return!0}
...
function am(a,b){if(!b.ib)return b.offset;var c=a.b.length-1,d=a.b[c];d===b&&(c--,d=a.b[c]);for(;0<=c;){if(d.b!==b.b)return b.offset;if(!d.ib||d.C)return d.offset;b=d;d=a.b[--c]}throw Error("No block start offset found!");}
function bm(a,b,c,d,e,f,g,h){this.da=a;this.root=a.root;this.fb=c;this.h=d;this.A=f;this.f=this.root;this.F={};this.Y={};this.G={};this.J=[];this.C=this.S=this.N=null;this.Ba=g;this.Z=new sj(b,d,g,h);this.g=new Jl;this.u=!0;this.la=[];this.Za=e;this.ua=this.ta=!1;this.b=a=hk(a,this.root);this.ca={};this.j=new Yl(d);Ll(this.g,a);d=cm(this,this.root);Ej(this.Z,this.root,d,a);dm(this,d,!1);this.H=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.H=
...
Ql(l)&&(l=Sl(l,"white-space",Dd).toString(),Mk(g,Lk(l))||(f.ib=!1,f.pb=!1)),a.u?Ll(a.g,a.b):Ml(a.g,a.b);else{g=a.f;f=cm(a,g);a.la.push(a.u);Ej(a.Z,g,f,a.b);(l=g.getAttribute("id")||g.getAttributeNS("http://www.w3.org/XML/1998/namespace","id"))&&l===a.C&&(a.C=null);a.H||"body"!=g.localName||g.parentNode!=a.root||(dm(a,f,!0),a.H=!0);(l=f["flow-into"])?(l=l.evaluate(e,"flow-into").toString(),h=km(a,l,f,g,a.b),a.u=!!a.Za[l],g=a.j.push(f,a.b,g===a.root,h)):g=a.j.push(f,a.b,g===a.root);l=am(a.j,g);nm(a,
...
function pn(a){a.Qc=!0;a.g||(a.I&&(a.children.forEach(function(a){Gn(this,a)&&a.b.forEach(function(a){(a=a.b.element)&&a.parentNode&&a.parentNode.removeChild(a)})},a),Cl(a.I)),a.children.forEach(function(a){a.C.splice(0)}),a.children.splice(0),Object.keys(a.l).forEach(function(a){delete this.l[a]},a))}function Hn(a){a=a.children.splice(0);a.forEach(function(a){a.b.forEach(function(a){(a=a.b.element)&&a.parentNode&&a.parentNode.removeChild(a)})});return a}
...
c?["block-start","block-end"]:[c]:[d];var l=b.Ia();d.forEach(function(a){switch(a){case "block-start":case "inline-start":h[a]=!f(this,a);break;case "block-end":case "inline-end":h[a]=!g(this,a);break;default:throw Error("Unexpected side: "+a);}},a);return h}function $n(a){return(a.parent?$n(a.parent):[]).concat(a.C)}function ao(a,b,c){c===a.W?a.C.push(b):ao(fn(a,c),b,c)}
...
function po(a,b){this.h=a;this.Tc=b;this.j=!1;this.l=null}v(po,no);po.prototype.f=function(a,b){if(b<this.b())return null;this.j||(this.l=qo(a,this,0<b),this.j=!0);return this.l};po.prototype.b=function(){return this.Tc};po.prototype.g=function(){return this.j?this.l:this.h[this.h.length-1]};function Nm(a,b,c,d){this.position=a;this.F=b;this.A=this.j=c;this.C=d;this.h=!1;this.xc=0}v(Nm,no);
Nm.prototype.f=function(a,b){if(!this.h){var c=Jm(a,this.position);this.xc=jo(this.position,a.f,0,a.b)+c;this.h=!0}var c=this.xc,d=oo(this.g(),ro(a));this.A=so(a,c+(a.b?-1:1)*d.He);this.j=this.position.xa=so(a,c+(a.b?-1:1)*d.current);b<this.b()?c=null:(a.h=this.C+to(a,this),c=this.position);return c};
...
wo.prototype.Ye=function(){};wo.prototype.Xe=function(){};function Km(a,b,c,d,e){rl.call(this,a);this.j=b;this.f=c;this.Zb=d;this.Ng=a.ownerDocument;this.l=e;hn(e,this);this.kf=null;this.$f=this.gg=!1;this.la=this.sa=this.C=this.fb=this.ua=0;this.Cb=this.dg=this.cg=null;this.Ld=!1;this.g=this.N=null;this.Kb=!0;this.ye=this.Fe=this.Ee=0;this.u=!0;this.xb=null;this.A=[];this.ta=this.Md=null;this.jf=NaN}v(Km,rl);function xo(a,b){return!!b.Ca&&(!a.gg||!!b.parent)}
function so(a,b){return a.b?b<a.la:b>a.la}function yo(a,b){if(a)for(var c;(c=a.lastChild)!=b;)a.removeChild(c)}Km.prototype.Lc=function(a){var b=this,c=L("openAllViews"),d=a.pa;zo(b.j,b.element,b.$f);var e=d.length-1,f=null;Ee(function(){for(;0<=e;){f=Xk(d[e],f);e!==d.length-1||f.D||(f.D=b.kf);if(!e){var c=f,h;h=a;h=h.Qa?gl(h.Qa,h.na,1):h.na;c.na=h;f.K=a.K;f.Qa=a.Qa;if(f.K)break}c=Ao(b.j,f,!e&&!f.na);e--;if(c.Xa())return c}return M(!1)}).then(function(){O(c,f)});return c.result()};var Bo=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
...
function No(a){for(var b=a.element.firstChild,c=a.b?a.b?a.ua:a.C:a.b?a.sa:a.ua,d=a.b?a.b?a.fb:a.sa:a.b?a.C:a.fb,e=t(a.Cb),f=e.next();!f.done;f=e.next()){var f=f.value,g=f.R-f.T;f.left=Lo(a,b,"left",f.V-c,g);f.right=Lo(a,b,"right",d-f.U,g)}}
function Oo(a,b,c,d,e){var f;if(b&&Po(b.B))return NaN;if(b&&b.K&&!b.ya&&(f=jo(b,a.f,0,a.b),!isNaN(f)))return f;b=c[d];for(e-=b.Ma;;){f=jo(b,a.f,e,a.b);if(!isNaN(f))return f;if(0<e)e--;else{d--;if(0>d)return a.C;b=c[d];1!=b.B.nodeType&&(e=b.B.textContent.length)}}}function X(a){return"number"==typeof a?a:(a=a.match(/^(-?[0-9]*(\.[0-9]*)?)px$/))?parseFloat(a[0]):0}
...
Kk(a.f,m),h=Math.max(a.b?p.top:p.left,h),l=Math.min(a.b?p.bottom:p.right,l);k.B.removeChild(m);m=a.b?g.R-g.T:g.U-g.V;"left"==e?l=Math.max(l,h+m):h=Math.min(h,l-m);k.B.appendChild(b.B)}m=new og(h,wl(a)*a.C,l,wl(a)*a.sa);h=g;a.b&&(h=Fg(g));l=wl(a);h.T<a.ye*l&&(p=h.R-h.T,h.T=a.ye*l,h.R=h.T+p);a:for(var l=a.Cb,p=h,q=p.T,r=p.U-p.V,z=p.R-p.T,u=Jg(l,q);;){var A=q+z;if(A>m.R)break a;for(var H=m.V,E=m.U,K=u;K<l.length&&l[K].T<A;K++){var I=l[K];I.V>H&&(H=I.V);I.U<E&&(E=I.U)}if(H+r<=E||u>=l.length){"left"==
e?(p.V=H,p.U=H+r):(p.V=E-r,p.U=E);p.R+=q-p.T;p.T=q;break a}q=l[u].R;u++}a.b&&(g=new og(-h.R,h.V,-h.T,h.U));a:{m=Qn(a.f,d);l=new qg;if(m){if("border-box"==m.boxSizing){m=Qo(a,d);break a}l.left=X(m.marginLeft)+X(m.borderLeftWidth)+X(m.paddingLeft);l.top=X(m.marginTop)+X(m.borderTopWidth)+X(m.paddingTop);l.right=X(m.marginRight)+X(m.borderRightWidth)+X(m.paddingRight);l.bottom=X(m.marginBottom)+X(m.borderBottomWidth)+X(m.paddingBottom)}m=l}x(d,"width",g.U-g.V-m.left-m.right+"px");x(d,"height",g.R-g.T-
m.top-m.bottom+"px");x(d,"position","absolute");x(d,"display",b.display);l=null;if(k)if(k.S)l=k;else a:{for(k=k.parent;k;){if(k.S){l=k;break a}k=k.parent}l=null}l?(m=l.B.ownerDocument.createElement("div"),m.style.position="absolute",l.b?m.style.right="0":m.style.left="0",m.style.top="0",l.B.appendChild(m),k=Kk(a.f,m),l.B.removeChild(m)):k={left:(a.b?a.sa:a.ua)-a.H,right:(a.b?a.C:a.fb)+a.Y,top:(a.b?a.ua:a.C)-a.J};(l?l.b:a.b)?x(d,"right",k.right-g.U+"px"):x(d,"left",g.V-k.left+"px");x(d,"top",g.T-k.top+
"px");b.C&&(b.C.parentNode.removeChild(b.C),b.C=null);k=a.b?g.V:g.R;g=a.b?g.U:g.T;if(so(a,k)&&a.N.length)b=b.modify(),b.xa=!0,O(c,b);else{Mo(a);m=new og(a.b?a.sa:a.ua,a.b?a.ua:a.C,a.b?a.C:a.fb,a.b?a.fb:a.sa);a.b&&(m=Fg(m));l=a.Cb;for(p=[new sg(h.T,h.R,h.V,h.U)];0<p.length&&p[0].R<=m.T;)p.shift();if(p.length){p[0].T<m.T&&(p[0].T=m.T);h=l.length?l[l.length-1].R:m.T;h<m.R&&l.push(new sg(h,m.R,m.V,m.U));h=Jg(l,p[0].T);p=t(p);for(q=p.next();!q.done;q=p.next()){r=q.value;if(h==l.length)break;l[h].T<r.T&&
...
e*(h-a.C)+l;return b}function op(a,b){var c=b;do c=c.parent;while(c&&c.ya);return c?(c=Zk(c).modify(),c.K=!0,jo(c,a.f,0,a.b)):NaN}function np(a,b){var c=b.findIndex(function(a){return a.xa});if(0>c)return{xc:NaN,If:null};var d=b[c];return{xc:Oo(a,null,b,c,d.Ma),If:d}}Km.prototype.Na=function(a,b,c){var d=lo(a.D).Na(this,a,b,c);d||(d=pp.Na(this,a,b,c));return d};
...
a;P(d)});return}b=g.get()}c=null;Q(d)}).then(function(){O(d,c)});return d.result()}function Ho(a,b){return Xm(b.W)||"footnote"===b.Ca?cp(a,b):So(a,b)}function Bp(a,b,c,d){var e=L("layoutNext");Ap(a,b,c,d||null).then(function(d){b=d;!b||a.g||a.u&&b&&b.xa?O(e,b):lo(b.D).je(b,a,c).Ea(e)});return e.result()}function lp(a,b,c){if(b)for(var d=b.parent;b;b=d,d=d?d.parent:null)lo((d||b).D).Fd(a,d,b,c),c=!1}
function Wo(a){a.dg=[];x(a.element,"width",a.width+"px");x(a.element,"height",a.height+"px");var b=a.element.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.J+"px";b.style.right=a.Y+"px";b.style.bottom=a.S+"px";b.style.left=a.H+"px";a.element.appendChild(b);var c=Kk(a.f,b);a.element.removeChild(b);var b=a.F+a.left+ul(a),d=a.G+a.top+sl(a);a.cg=new og(b,d,b+a.width,d+a.height);a.ua=c?a.b?c.top:c.left:0;a.fb=c?a.b?c.bottom:c.right:0;a.C=c?a.b?c.right:c.top:0;a.sa=c?a.b?c.left:
c.bottom:0;a.Ee=a.C;a.Fe=a.C;a.ye=a.C;a.la=a.sa;c=a.cg;b=a.F+a.left+ul(a);d=a.G+a.top+sl(a);d=new og(b,d,b+a.width,d+a.height);if(a.Lb){for(var b=d.V,d=d.T,e=[],f=t(a.Lb.b),g=f.next();!g.done;g=f.next())g=g.value,e.push(new pg(g.f+b,g.b+d));b=new ug(e)}else b=xg(d.V,d.T,d.U,d.R);b=[b];d=Vn(a.l);a.Cb=Hg(c,b,a.ob.concat(d),a.Mb,a.b);No(a);a.h=0;a.Ld=!1;a.g=null;a.xb=null}function vp(a,b,c,d){var e=Zk(b);b=lo(b.D);var f=Jm(a,e);c=b.Kf(e,c,d,a.h+f);a.N.push(c)}
function To(a,b){isNaN(b)||(a.h=Math.max(wl(a)*(b-a.C),a.h))}
...
q),p?e=B(a,r,p):p=e=Cc(a,r,new Ib(a,.5)))):(e||(e=a.b),p||(p=a.b),d||q||h||(d=a.b),d||h?d||q?h||q||(h=this.C,this.j=!0):d=a.b:(h=this.C,this.j=!0),r=B(a,c,y(a,y(a,e,r),y(a,p,z))),this.j&&(l||(l=B(a,r,d?d:q)),this.b||!Y(a,b["column-width"],null)&&!Y(a,b["column-count"],null)||(h=l,this.j=!1)),d?h?q||(q=B(a,r,y(a,d,h))):h=B(a,r,y(a,d,q)):d=B(a,r,y(a,q,h)));a=vq(a,b["snap-width"]||(this.g?this.g.style["snap-width"]:null),c);b.left=new G(d);b["margin-left"]=new G(e);b["border-left-width"]=new G(f);b["padding-left"]=
...
function Fq(a,b){b.ob[a.f.j]=a;var c=a.f.f,d=a.style,e=a.g?Gq(a.g,b):null,e=Vj(a.J,b,e,!1);a.b=Tj(e,b,a.g?a.g.b:!1);a.Z=Uj(e,b,a.g?a.g.Z:!1);Zj(e,d,a.b,a.Z,function(a,b){return b.value});a.C=new Kb(c,function(){return a.H},"autoWidth");a.A=new Kb(c,function(){return a.G},"autoHeight");a.Ae();a.Be();Dq(a);Cq(a)}function Hq(a,b,c){(a=a.style[c])&&(a=ng(b,a,c));return a}function Z(a,b,c){(a=a.style[c])&&(a=ng(b,a,c));return Vc(a,b)}
...
function Xq(a,b){a.j&&(a.N=Eq(a,"right",a.C,b)||Eq(a,"margin-right",a.C,b)||Eq(a,"border-right-width",a.C,b)||Eq(a,"padding-right",a.C,b));a.h&&(a.S=Eq(a,"top",a.A,b)||Eq(a,"margin-top",a.A,b)||Eq(a,"border-top-width",a.A,b)||Eq(a,"padding-top",a.A,b));for(var c=t(a.children),d=c.next();!d.done;d=c.next())Xq(d.value,b)}function Yq(a){zq.call(this,null,a)}v(Yq,zq);Yq.prototype.l=function(a,b){zq.prototype.l.call(this,a,b);this.children.sort(function(a,b){return b.f.ba-a.f.ba||a.f.index-b.f.index})};
...
function ur(a,b,c,d,e,f){var g=L("createRefShadow");a.da.u.load(b).then(function(h){if(h){var l=mk(h,b);if(l){var k=a.J,m=k.N[h.url];if(!m){var m=k.style.F.f[h.url],p=new Qb(0,k.jc(),k.ic(),k.u),m=new bm(h,m.g,m.f,p,k.l,m.G,new Rp(k.h,h.url),new Sp(k.h,h.url,m.f,m.b));k.N[h.url]=m}f=new $k(d,l,h,e,f,c,m)}}O(g,f)});return g.result()}
...
function Cr(a,b,c,d,e,f){for(var g=he("RESOLVE_FORMATTING_CONTEXT"),h=0;h<g.length;h++){var l=g[h](a,b,c,d,e,f);if(l){a.D=l;break}}}
...
var p=k.display;if(p===J)return O(e,!1),e.result();var q=!a.w.parent;a.w.H=p===od;vr(a,f,q,h,k,g,a.b,a.w.wa).then(function(l){a.w.Ja=l;l=k.position;var r=k["float"],u=k.clear,A=a.w.b?Wd:sd,H=a.w.parent?a.w.parent.b?Wd:sd:A,E="true"===f.getAttribute("data-vivliostyle-flow-root");a.w.hd=fr(p,l,r,k.overflow,A,H,E);a.w.S=l===Hd||l===Wc||l===nd;!hl(a.w)||r===pd||m&&Xm(m)||(u=r=null);A=r===zd||r===Id||r===Td||r===fd||r===xd||r===wd||r===dd||r===cd||r===Ld||r===pd;r&&(delete k["float"],r===pd&&(a.f?(A=!1,
...
(a.w.ta=Vc(A,a.b));a.w.Y=k["footnote-policy"];if(u=k["x-first-pseudo"])a.w.f=new al(a.w.parent?a.w.parent.f:null,u.L);a.w.ya||Fr(a,f,h,g,a.b);if(u=k["white-space"])u=Lk(u.toString()),null!==u&&(a.w.uc=u);(u=k["hyphenate-character"])&&u!==Zc&&(a.w.F=u.Xc);u=k["overflow-wrap"]||["word-wrap"];a.w.A=k["word-break"]===hd||u===id;Cr(a.w,b,p,l,r,q);a.w.parent&&a.w.parent.D&&(b=a.w.parent.D.ff(a.w,b));a.w.ya||(a.w.u=Gr(k),Hr(a,f,g));var I=!1,ma=null,Ca=[],Da=f.namespaceURI,N=f.localName;if("http://www.w3.org/1999/xhtml"==
...
u.localName)){l=u.getAttribute("src");break}l&&(N="a",f=f.ownerDocument.createElementNS(Da,"a"),f.setAttribute("href",l))}}else N="span";else"http://www.pyroxy.com/ns/shadow"==Da?(Da="http://www.w3.org/1999/xhtml",N=a.w.ya?"span":"div"):I=!!a.g;K?b?N="li":(N="div",p=bd,k.display=p):"body"==N||"li"==N?N="div":"q"==N?N="span":"a"==N&&(l=k["hyperlink-processing"])&&"normal"!=l.toString()&&(N="span");k.behavior&&"none"!=k.behavior.toString()&&a.g&&(I=!0);f.dataset&&"true"===f.getAttribute("data-math-typeset")&&
(I=!0);var sb;I?sb=a.g(f,a.w.parent?a.w.parent.B:null,k):sb=M(null);sb.then(function(g){g?I&&(d="true"==g.getAttribute("data-adapt-process-children")):g=Ir(a,Da,N);"a"==N&&g.addEventListener("click",a.page.J,!1);ma&&(ap(a,a.w,"inner",ma),g.appendChild(ma));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&mr(g);var h=a.w.h["image-resolution"],l=[],m=k.width,p=k.height,q=f.getAttribute("width"),r=f.getAttribute("height"),m=m===Zc||!m&&!q,p=p===Zc||!p&&!r;if("http://www.gribuser.ru/xml/fictionbook/2.0"!=
f.namespaceURI||"td"==N){for(var q=f.attributes,u=q.length,r=null,z=0;z<u;z++){var A=q[z],H=A.namespaceURI,E=A.localName,A=A.nodeValue;if(H)if("http://www.w3.org/2000/xmlns/"==H)continue;else"http://www.w3.org/1999/xlink"==H&&"href"==E&&(A=zr(a,A));else{if(E.match(/^on/))continue;if("style"==E)continue;if(("id"==E||"name"==E)&&b){A=a.h.Re(A,a.da.url);g.setAttribute(E,A);Ik(a.page,g,A);continue}"src"==E||"href"==E||"poster"==E?(A=zr(a,A),"href"===E&&(A=a.h.oc(A,a.da.url))):"srcset"==E&&(A=A.split(",").map(function(b){return zr(a,
b.trim())}).join(","));if("poster"===E&&"video"===N&&"http://www.w3.org/1999/xhtml"===Da&&m&&p){var sb=new Image,Jp=Ke(sb,A);Ca.push(Jp);l.push({Rf:sb,element:g,Of:Jp})}}"http://www.w3.org/2000/svg"==Da&&/^[A-Z\-]+$/.test(E)&&(E=E.toLowerCase());Jr.includes(E.toLowerCase())&&(A=gr(A,a.da.url,a.h));H&&(sb=lr[H])&&(E=sb+":"+E);"src"!=E||H||"img"!=N&&"input"!=N||"http://www.w3.org/1999/xhtml"!=Da?"href"==E&&"image"==N&&"http://www.w3.org/2000/svg"==Da&&"http://www.w3.org/1999/xlink"==H?a.page.j.push(Ke(g,
A)):H?g.setAttributeNS(H,E,A):g.setAttribute(E,A):r=A}r&&(sb="input"===N?new Image:g,q=Ke(sb,r),sb!==g&&(g.src=r),m||p?(m&&p&&h&&1!==h&&l.push({Rf:sb,element:g,Of:q}),Ca.push(q)):a.page.j.push(q))}delete k.content;(m=k["list-style-image"])&&m instanceof Tc&&(m=m.url,Ca.push(Ke(new Image,m)));Kr(a,k);Lr(a,g,k);if(!a.w.ya&&(m=null,b?c&&(m=a.w.b?kr:jr):m="clone"!==a.w.h["box-decoration-break"]?a.w.b?ir:hr:a.w.b?kr:jr,m))for(var Kp in m)x(g,Kp,m[Kp]);K&&g.setAttribute("value",k["ua-list-item-count"].stringValue());
...
"px"):x(b,"min-width",h+"px"))}})}function Kr(a,b){he("PREPROCESS_ELEMENT_STYLE").forEach(function(c){c(a.w,b)})}function Hr(a,b,c){for(b=b.firstChild;b;b=b.nextSibling)if(1===b.nodeType){var d={},e=c.l(b,!1);wr(a,a.w.b,"rtl"===a.w.direction,e,d);if(Gr(d)){if(a.w.D instanceof zp&&!jl(a.w,a.w.D))break;c=a.w.parent;a.w.D=new zp(c&&c.D,a.w.M);Or(a.w.D,a.w.b);break}}}
...
function Ir(a,b,c){return"http://www.w3.org/1999/xhtml"==b?a.C.createElement(c):a.C.createElementNS(b,c)}function Mp(a){a&&il(a,function(a){var b=a.h["box-decoration-break"];b&&"slice"!==b||(b=a.B,a.b?(x(b,"padding-left","0"),x(b,"border-left","none"),x(b,"border-top-left-radius","0"),x(b,"border-bottom-left-radius","0")):(x(b,"padding-bottom","0"),x(b,"border-bottom","none"),x(b,"border-bottom-left-radius","0"),x(b,"border-bottom-right-radius","0")))})}
...
var k=b.style.display,m=b.style.position,p=b.style.width,q=b.style.maxWidth,r=b.style.minWidth,z=b.style.height,u=b.style.maxHeight,A=b.style.minHeight,H=b.parentNode,E=b.ownerDocument.createElement("div");x(E,"position",m);H.insertBefore(E,b);E.appendChild(b);x(b,"width","auto");x(b,"max-width","none");x(b,"min-width","0");x(b,"height","auto");x(b,"max-height","none");x(b,"min-height","0");var K=Oa("writing-mode"),K=(K?d(K[0]):null)||d("writing-mode"),I="vertical-rl"===K||"tb-rl"===K||"vertical-lr"===
...
function ts(a,b,c,d){tq.call(this,a,null,null,[],b);this.C=d;this.b["z-index"]=new V(new Rc(0),0);this.b["flow-from"]=new V(D("body"),0);this.b.position=new V(Wc,0);this.b.overflow=new V(Xd,0);for(var e in ps)ps.hasOwnProperty(e)&&(this.b[e]=c[e])}v(ts,tq);ts.prototype.h=function(a){return new xs(a,this)};
...
function zs(a,b,c,d,e,f){var g=a.f.f,h={},l={},k={},m;for(m in b){var p=qs[m];if(p){var q=b[m],r=a.ta[m],z=new As(q,r.style,c,g,f);h[p.Da]=q;l[p.Da]=r;k[p.Da]=z}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.va.evaluate(e);var u=Es(k,b),A=!1,H={};Object.keys(h).forEach(function(a){var b=Y(g,l[a].style[c?"max-width":"max-height"],d.va);b&&(b=b.evaluate(e),u[a]>b&&(b=k[a]=new Ds(h[a],l[a].style,c,g,f,b),H[a]=b.f(),A=!0))});A&&(u=Es(k,b),A=!1,["start","center","end"].forEach(function(a){u[a]=H[a]||u[a]}));
var E={};Object.keys(h).forEach(function(a){var b=Y(g,l[a].style[c?"min-width":"min-height"],d.va);b&&(b=b.evaluate(e),u[a]<b&&(b=k[a]=new Ds(h[a],l[a].style,c,g,f,b),E[a]=b.f(),A=!0))});A&&(u=Es(k,b),["start","center","end"].forEach(function(a){u[a]=E[a]||u[a]}));var K=a+b,I=a+(a+b);["start","center","end"].forEach(function(a){var b=u[a];if(b){var d=h[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(I-b)/2;break;case "end":e=K-b}c?zl(d,e,b-ul(d)-vl(d)):yl(d,e,b-sl(d)-tl(d))}})}
...
function Gs(a,b){var c=a.style,d=a.f.f,e=b.start,f=b.end,g=b.va,h=a.f.C[g].Aa(d,null),l=Y(d,c[g],h),k=Y(d,c["margin-"+e],h),m=Y(d,c["margin-"+f],h),p=vq(d,c["padding-"+e],h),q=vq(d,c["padding-"+f],h),r=xq(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),z=xq(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),u=B(d,h,y(d,y(d,r,p),y(d,z,q)));l?(u=B(d,u,l),k||m?k?m=B(d,u,k):k=B(d,u,m):m=k=Cc(d,u,new Ib(d,.5))):(k||(k=d.b),m||(m=d.b),l=B(d,u,y(d,k,m)));c[e]=new G(k);c[f]=new G(m);c["margin-"+e]=
be;c["margin-"+f]=be;c["padding-"+e]=new G(p);c["padding-"+f]=new G(q);c["border-"+e+"-width"]=new G(r);c["border-"+f+"-width"]=new G(z);c[g]=new G(l);c["max-"+g]=new G(l);return{Gf:B(d,h,y(d,k,m)),Zf:k,Yf:m}}xs.prototype.kc=function(a,b,c,d,e){uq.prototype.kc.call(this,a,b,c,d,e);c.C=b.element;a.ca=parseFloat(c.C.style.width);a.Z=parseFloat(c.C.style.height)};function ys(a,b){uq.call(this,a,b);var c=b.u;this.u=qs[c];a.ta[c]=this;this.ua=!0}v(ys,uq);n=ys.prototype;
...
function xt(a,b,c){var d=a.b.b[c];if(!d||!nt(a,d.g))return M(!0);d.g="any";vt(a,b,c);Wo(b);a.l[c]&&0<b.Cb.length&&(b.Kb=!1);var e=L("layoutColumn");wt(b).then(function(){if(Jn(b.l))O(e,!0);else{var f=[],g=[],h=!0;Fe(function(e){if(!tn(b.l,c))for(var k={};0<d.b.length-g.length;){for(k.index=0;g.includes(k.index);)k.index++;k.selected=d.b[k.index];if(k.selected.qa.f>a.C||ot(a,k.selected.qa))break;for(var l=k.index+1;l<d.b.length;l++)if(!g.includes(l)){var p=d.b[l];if(p.qa.f>a.C||ot(a,p.qa))break;Pk(p.qa,
...
function yt(a,b,c,d,e,f,g,h,l,k,m,p,q,r,z){var u=b.b?b.j&&b.N:b.h&&b.S,A=f.element,H=new dn(l,"column",null,h,null,null,null),E=a.b.clone(),K=L("createAndLayoutColumn"),I;Fe(function(b){var K=new mo([new hq(a.h,a.b.page-1)].concat($n(H)));if(1<k){var ma=a.viewport.b.createElement("div");x(ma,"position","absolute");A.appendChild(ma);I=new Km(ma,r,a.g,K,H);I.Kb=z;I.b=f.b;I.Mb=f.Mb;I.Rd=f.Rd;f.b?(K=g*(p+m)+f.J,zl(I,f.H,f.width),yl(I,K,p)):(K=g*(p+m)+f.H,yl(I,f.J,f.height),zl(I,K,p));I.F=c;I.G=d}else I=
new Km(A,r,a.g,K,H),xl(I,f);I.ob=u?[]:e.concat();I.Lb=q;hn(H,I);0<=I.width?xt(a,I,h).then(function(){Jn(H)||Fn(H);Jn(I.l)&&!Jn(l)?(I.l.Qc=!1,a.b=E.clone(),I.element!==A&&A.removeChild(I.element),P(b)):Q(b)}):(Fn(H),Q(b))}).then(function(){O(K,I)});return K.result()}function zt(a,b,c,d,e){var f=Hq(c,a,"writing-mode")||null;a=Hq(c,a,"direction")||null;return new dn(b,"region",d,e,null,f,a)}
...
function Bt(a,b,c,d,e,f,g,h,l,k,m,p){var q=L("layoutFlowColumns"),r=a.b.clone(),z=Z(c,a,"column-gap"),u=1<m?Z(c,a,"column-width"):l.width,A=Gq(c,a),H=Hq(c,a,"shape-inside"),E=Rg(H,0,0,l.width,l.height,a),K=new rr(k,a,a.viewport,a.f,A,a.da,a.j,a.style.u,a,b,a.Kb,a.Jb,a.Lb),I=0,ma=null,Ca=[];Fe(function(b){yt(a,c,d,e,f,l,I++,k,h,m,z,u,E,K,p).then(function(c){Jn(g)?(Ca=null,Q(b)):((c.g&&"column"!==c.g||I===m)&&!Jn(h)&&Fn(h),Jn(h)?(I=0,a.b=r.clone(),h.Qc=!1,h.g?(Ca=null,Q(b)):P(b)):(ma=c,Ca[I-1]=ma,ma.g&&
...
c.Qd(a,r,b,null,1,a.g,a.j),l=M(!0);else{var u=L("layoutContainer.inner"),A=l.toString(),H=Z(c,a,"column-count");At(a,b,c,e,f,g,h,r,A,H).then(function(d){if(!Jn(h)){var e=d[0];e.element===p&&(r=e);r.h=Math.max.apply(null,d.map(function(a){return a.h}));c.Qd(a,r,b,e,H,a.g,a.j);(d=a.b.b[A])&&"region"===d.f&&(d.f=null)}O(u,!0)});l=u.result()}else{if((l=Hq(c,a,"content"))&&Hl(l)){q="span";l.url&&(q="img");var E=a.viewport.b.createElement(q);l.fa(new Gl(E,a,l,fq(a.h)));p.appendChild(E);"img"==q&&Wq(c,a,
E,a.j);Vq(c,a,r,a.j)}else c.ua&&(d.removeChild(p),z=!0);z||c.Qd(a,r,b,null,1,a.g,a.j);l=M(!0)}l.then(function(){if(Jn(h))O(k,!0);else{if(!c.h||0<Math.floor(r.h)){if(!z&&!m){var l=Hq(c,a,"shape-outside"),l=El(r,l,a);g.push(l)}}else if(!c.children.length){d.removeChild(p);O(k,!0);return}var q=c.children.length-1;Ee(function(){for(;0<=q;){var d=c.children[q--],d=Ct(a,b,d,p,e,f,g,h);if(d.Xa())return d.ea(function(){return M(!Jn(h))});if(Jn(h))break}return M(!1)}).then(function(){O(k,!0)})}});return k.result()}
...
Jt.prototype.error=function(a){w.b("CSS parser:",a)};function Kt(a,b){return Lt(b,a)}function Mt(a){yf.call(this,Kt,"document");this.S=a;this.H={};this.A={};this.f={};this.N={};this.u=null;this.b=[];this.J=!1}v(Mt,yf);function Nt(a,b,c){Ot(a,b,c);var d=Ba("user-agent.xml",Aa),e=L("OPSDocStore.init");Fh.get().then(function(b){a.u=b;lt.get().then(function(){a.load(d).then(function(){a.J=!0;O(e,!0)})})});return e.result()}function Ot(a,b,c){a.b.splice(0);b&&b.forEach(a.Y,a);c&&c.forEach(a.Z,a)}
...
function Lt(a,b){var c=L("OPSDocStore.load"),d=b.url;qk(b,a).then(function(b){if(b){if(a.J)for(var e=he("PREPROCESS_SINGLE_DOCUMENT"),g=0;g<e.length;g++)try{e[g](b.b)}catch(u){w.b("Error during single document preprocessing:",u)}for(var e=[],h=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),g=0;g<h.length;g++){var l=h[g],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=l.getAttribute("action"),
l=l.getAttribute("ref");k&&m&&p&&l&&e.push({Hg:k,event:m,action:p,sd:l})}a.N[d]=e;var q=[];q.push({url:Ba("user-agent-page.css",Aa),text:null,qb:"UA",Pa:null,media:null});if(g=b.l)for(g=g.firstChild;g;g=g.nextSibling)if(1==g.nodeType)if(e=g,h=e.namespaceURI,k=e.localName,"http://www.w3.org/1999/xhtml"==h)if("style"==k)h=e.getAttribute("class"),k=e.getAttribute("media"),m=e.getAttribute("title"),q.push({url:d,text:e.textContent,qb:"Author",Pa:m?h:null,media:k});else if("link"==k){if(m=e.getAttribute("rel"),
h=e.getAttribute("class"),k=e.getAttribute("media"),"stylesheet"==m||"alternate stylesheet"==m&&h)m=e.getAttribute("href"),m=Ba(m,d),e=e.getAttribute("title"),q.push({url:m,text:null,Pa:e?h:null,media:k,qb:"Author"})}else"meta"==k&&"viewport"==e.getAttribute("name")&&q.push({url:d,text:It(e),qb:"Author",Pa:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==h?"stylesheet"==k&&"text/css"==e.getAttribute("type")&&q.push({url:d,text:e.textContent,qb:"Author",Pa:null,media:null}):"http://example.com/sse"==
h&&"property"===k&&(h=e.getElementsByTagName("name")[0])&&"stylesheet"===h.textContent&&(e=e.getElementsByTagName("value")[0])&&(m=Ba(e.textContent,d),q.push({url:m,text:null,Pa:null,media:null,qb:"Author"}));for(g=0;g<a.b.length;g++)q.push(a.b[g]);for(var r="",g=0;g<q.length;g++)r+=q[g].url,r+="^",q[g].text&&(r+=q[g].text),r+="^";var z=a.H[r];z?(a.f[d]=z,O(c,b)):(g=a.A[r],g||(g=new He(function(){var b=L("fetchStylesheet"),c=0,d=new Jt(a.u);Ee(function(){if(c<q.length){var a=q[c++];d.Wc(a.qb);return null!==
a.text?kg(a.text,d,a.url,a.Pa,a.media).Hc(!0):jg(a.url,d,a.Pa,a.media)}return M(!1)}).then(function(){z=new mt(a,d.j,d.u,d.J.l,d.G,d.A,d.C,d.l,d.H,d.F);a.H[r]=z;delete a.A[r];O(b,z)});return b.result()},"FetchStylesheet "+d),a.A[r]=g,g.start()),g.get().then(function(e){a.f[d]=e;O(c,b)}))}else O(c,null)});return c.result()};function Pt(a){return String.fromCharCode(a>>>24&255,a>>>16&255,a>>>8&255,a&255)}
...
Tt.prototype.Uc=function(a,b,c,d,e){if(this.page)return M(this.page);var f=this,g=L("showTOC"),h=new Fk(a,a);this.page=h;this.b.load(this.url).then(function(d){var k=f.b.f[d.url],k=new mt(f.b,k.f,k.b,Jj.clone(),k.C,k.l,k.u,k.h,k.j,k.A),l=pt(k,c,1E5,e);b=new $r(b.window,l.fontSize,b.root,l.width,l.height);var p=new qt(k,d,f.lang,b,f.f,f.l,f.Ge(d),f.j,0,f.h,f.g);f.nb=p;p.$=f.$;rt(p).then(function(){Ft(p,h,null).then(function(){Array.from(h.I.querySelectorAll("[data-vivliostyle-toc-box]>*>*>*>*>*[style*='display: none']")).forEach(function(a){a.setAttribute("aria-hidden",
"true");a.setAttribute("hidden","hidden")});Ut(f,a,2);O(g,h)})})});return g.result()};Tt.prototype.Td=function(){this.page&&(this.page.I.style.visibility="hidden",this.page.I.setAttribute("aria-hidden","true"))};Tt.prototype.Rc=function(){return!!this.page&&"visible"===this.page.I.style.visibility};function Wt(){Mt.call(this,Xt(this));this.h=new yf(qk,"document");this.g=new yf(Af,"text");this.G={};this.la={};this.C={};this.F={}}v(Wt,Mt);function Xt(a){return function(b){return a.C[b]}}
function Yt(a,b,c){var d=L("loadEPUBDoc");vf(b,null,"HEAD").then(function(e){if(400<=e.status){var f=b;"/"!==f.substring(f.length-1)&&(f+="/");c&&a.g.fetch(f+"?r=list");a.h.fetch(f+"META-INF/encryption.xml");a.h.load(f+"META-INF/container.xml",void 0,void 0).then(function(g){if(g){g=zk(fk(fk(fk(new gk([g.b]),"container"),"rootfiles"),"rootfile"),"full-path");g=t(g);for(var h=g.next();!h.done;h=g.next())if(h=h.value){Zt(a,f,h,c).Ea(d);return}}w.error("Failed to fetch a source document from "+b+" ("+
e.status+(e.statusText?" "+e.statusText:"")+")");O(d,null)})}else if(e.status||e.responseXML||e.responseText||e.vd||e.contentType||!/\/[^/.]+(?:[#?]|$)/.test(b)||(b=b.replace(/([#?]|$)/,"/$1")),"application/oebps-package+xml"==e.contentType||/\.opf(?:[#?]|$)/.test(b)){var g=t(b.match(/^((?:.*\/)?)([^/]*)$/));g.next();var h=g.next().value,g=g.next().value;Zt(a,h,g,c).Ea(d)}else"application/ld+json"==e.contentType||"application/webpub+json"==e.contentType||"application/audiobook+json"==e.contentType||
"application/json"==e.contentType||/\.json(?:ld)?(?:[#?]|$)/.test(b)?a.g.load(b,!0,void 0).then(function(c){if(c){var e=new $t(a,b);au(e,c).then(function(){O(d,e)})}else w.error("Received an empty response for "+b+". This may be caused by the server not allowing cross-origin resource sharing (CORS)."),O(d,null)}):bu(a,b).Ea(d)});return d.result()}
function Zt(a,b,c,d){var e=b+c,f=a.G[e];if(f)return M(f);var g=L("loadOPF");a.h.load(e,!0,"Failed to fetch EPUB OPF "+e).then(function(c){c?a.h.load(b+"META-INF/encryption.xml",void 0,void 0).then(function(h){(d?a.g.load(b+"?r=list",void 0,void 0):M(null)).then(function(d){f=new $t(a,b);cu(f,c,h,d,b+"?r=manifest").then(function(){a.G[e]=f;a.la[b]=f;O(g,f)})})}):w.error("Received an empty response for EPUB OPF "+e+". This may be caused by the server not allowing cross-origin resource sharing (CORS).")});
return g.result()}
function bu(a,b){var c=L("loadWebPub");a.load(b).then(function(d){if(d){var e=d.b,f=new $t(a,b);e.body&&e.body.setAttribute("data-vivliostyle-primary-entry",!0);var g=e.querySelector("link[rel='publication'],link[rel='manifest'][type='application/webpub+json']");if(g){var h=g.getAttribute("href");/^#/.test(h)?(g=JSON.parse(e.getElementById(h.substr(1)).textContent),au(f,g,e).then(function(){O(c,f)})):a.g.load(g.href,void 0,void 0).then(function(a){au(f,a,e).then(function(){O(c,f)})})}else au(f,{},
...
function $t(a,b){this.h=a;this.C=this.g=this.b=this.u=this.j=null;this.F=b;this.N=null;this.Z={};this.lang=null;this.l=0;this.G=!1;this.S=!0;this.A=null;this.f={};this.ca=this.Yb=this.lf=null;this.Y={};this.J=null;this.H=pu(this);nu()&&(Jh["http://www.w3.org/1998/Math/MathML"]=!0)}
...
function qu(a,b){if(b.startsWith("data:"))return b===a.F?"":b;if(a.F){var c=Ba("",a.F);if(b===c||b+"/"===c)return"";"/"!=c.charAt(c.length-1)&&(c+="/");return b.substr(0,c.length)==c?decodeURI(b.substr(c.length)):null}return b}
...
d.l.nav&&(a.Yb=d);!a.ca&&d.l["cover-image"]&&(a.ca=d);return d});a.g=ab(a.u,fu);a.C=ab(a.u,function(b){return qu(a,b.src)});for(var l in h)for(g=l;;){g=a.g[h[g]];if(!g)break;if(ou[g.g]){a.Y[l]=g.src;break}g=g.src}a.b=db(fk(fk(f,"spine"),"itemref").X,function(b,c){var d=b.getAttribute("idref");if(d=a.g[d])d.j=b,d.P=c;return d});if(l=zk(fk(f,"spine"),"toc")[0])a.lf=a.g[l];if(l=zk(fk(f,"spine"),"page-progression-direction")[0]){a:switch(l){case "ltr":l="ltr";break a;case "rtl":l="rtl";break a;default:throw Error("unknown PageProgression: "+
l);}a.J=l}var g=c?zk(fk(fk(vk(fk(fk(new gk([c.b]),"encryption"),"EncryptedData"),uk()),"CipherData"),"CipherReference"),"URI"):[],k=fk(fk(f,"bindings"),"mediaType").X;for(c=0;c<k.length;c++){var m=k[c].getAttribute("handler");(l=k[c].getAttribute("media-type"))&&m&&a.g[m]&&(a.Z[l]=a.g[m].src)}a.f=mu(fk(f,"metadata"),zk(f,"prefix")[0]);a.f[iu]&&(a.lang=a.f[iu][0].v);a.f[ku]&&(a.G="pre-paginated"===a.f[ku][0].v);if(!d){if(0<g.length&&a.N)for(d=gu(a.N),c=0;c<g.length;c++)a.h.C[a.F+g[c]]=d;a.G&&ru(a);
return M(!0)}f=new Ra;k={};if(0<g.length&&a.N)for(l="1040:"+St(a.N),c=0;c<g.length;c++)k[g[c]]=l;for(c=0;c<d.length;c++){var p=d[c];if(m=p.n){var q=decodeURI(m),g=a.C[q];l=null;g&&(g.A=0!=p.m,g.u=p.c,g.g&&(l=g.g.replace(/\s+/g,"")));g=k[q];if(l||g)f.append(m),f.append(" "),f.append(l||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}ru(a);return vf(e,"","POST",f.toString(),"text/plain")}
function ru(a){for(var b=0,c=t(a.b),d=c.next();!d.done;d=c.next()){var d=d.value,e=a.G?1:Math.ceil(d.u/1024);d.b=b;d.f=e;b+=e}a.l=b;a.A&&a.A(a.l)}function su(a,b){a.S=b||a.G}
function tu(a,b){a.A=b;if(a.S)return a.G&&!a.l&&ru(a),M(!0);var c=0,d=0,e=L("countEPages");Fe(function(b){if(d===a.b.length)Q(b);else{var e=a.b[d++];e.b=c;a.h.load(e.src).then(function(d){var f=1800,g=d.lang||a.lang;g&&g.match(/^(ja|ko|zh)/)&&(f/=3);e.f=Math.ceil(jk(d)/f);c+=e.f;a.l=c;a.A&&a.A(a.l);P(b)})}}).Ea(e);return e.result()}
function uu(a,b,c){a.g={};a.C={};a.u=[];a.b=a.u;var d=a.j=new ek(null,"",(new DOMParser).parseFromString("<spine></spine>","text/xml"));b.forEach(function(a){var b=new eu;b.P=a.index;b.id="item"+(a.index+1);b.src=a.url;b.wb=a.wb;b.nc=a.nc;var c=d.b.createElement("itemref");c.setAttribute("idref",b.id);d.root.appendChild(c);b.j=c;this.g[b.id]=b;c=qu(this,a.url);null==c&&(c=a.url);this.C[c]=b;this.u.push(b)},a);return c?du(a.h,b[0].url,c):M(null)}
function au(a,b,c){b.readingProgression&&(a.J=b.readingProgression);void 0===a.f&&(a.f={});var d=c&&c.title||b.name||b.metadata&&b.metadata.title;d&&(a.f[ju]=[{v:d}]);var e=qu(a,a.F);!b.readingOrder&&c&&null!==e&&(b.readingOrder=[encodeURI(e)],Array.from(c.querySelectorAll("[role=doc-toc] a[href],[role=directory] a[href],nav a[href],.toc a[href],#toc a[href]")).forEach(function(c){c=qu(a,ya(c.href));null!==c&&(c=encodeURI(c),-1==b.readingOrder.indexOf(c)&&b.readingOrder.push(c))}));var f=[],g=0,h=
-1;[b.readingOrder,b.resources].forEach(function(b){b instanceof Array&&b.forEach(function(b){var c="string"===typeof b?b:b.url||b.href,d="string"===typeof b?"":b.oh||b.href&&b.type||"";if("text/html"===d||"application/xhtml+xml"===d||/(^|\/)([^/]+\.(x?html|htm|xht)|[^/.]*)([#?]|$)/.test(c))c={url:Ba(Ea(c),a.F),index:g++,wb:null,nc:null},"contents"===b.rel&&-1===h&&(h=c.index),f.push(c)})});var l=L("initWithWebPubManifest");uu(a,f).then(function(){-1!==h&&(a.Yb=a.u[h]);a.Yb||(a.Yb=a.C[e]);O(l,!0)});
return l.result()}function vu(a,b,c){var d=a.b[b],e=L("getCFI");a.h.load(d.src).then(function(a){var b=kk(a,c),f=null;b&&(a=ik(a,b,0,!1),f=new ub,xb(f,b,c-a),d.j&&xb(f,d.j,0),f=f.toString());O(e,f)});return e.result()}
...
function Ou(a,b,c,d){w.debug("Navigate to",b);var e=qu(a.O,ya(b));if(!e){if(a.O.j&&b.match(/^#epubcfi\(/))e=qu(a.O,a.O.j.url);else if("#"===b.charAt(0)){var f=a.O.H.Kg(b);a.O.j?(e=qu(a.O,f[0]),null==e&&(e=f[0])):e=f[0];b=f[0]+(f[1]?"#"+f[1]:"")}if(null==e)return M(null)}var g=a.O.C[e];if(!g)return a.O.j&&e==qu(a.O,a.O.j.url)&&(e=b.indexOf("#"),0<=e)?Nu(a,b.substr(e+1),d):M(null);var h=L("navigateTo");Fu(a,g.P).then(function(e){if(e){var f=mk(e.da,b);f?Hu(a,{P:g.P,aa:-1,Fa:hk(e.da,f)},d).Ea(h):c.P!==
...
n.Ge=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=Ba(f,a.url),g=c.getAttribute("media-type");if(!g){var h=qu(b.O,f);h&&(h=b.O.C[h])&&(g=h.g)}if(g&&(h=b.O.Z[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Va(f),l=Va(g),g=new Ra;g.append(h);g.append("?src=");g.append(f);g.append("&type=");g.append(l);for(h=c.firstChild;h;h=h.nextSibling)1==h.nodeType&&
...
function Tu(a,b,c,d){var e=this;this.window=a;this.ge=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);ak&&b.setAttribute("data-vivliostyle-debug",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Ba=c;this.ua=d;a=a.document;this.sa=new wm(a.head,b);this.u="loading";this.J=[];this.O=null;this.hc=this.Ya=!1;this.f=this.j=this.g=this.A=null;this.fontSize=16;this.zoom=1;this.C=!1;this.S="singlePage";this.ca=!1;this.Rb=!0;this.$=yb();this.Z=[];this.H=function(){};this.h=function(){};
this.Y=function(){e.Ya=!0;e.H()};this.Me=this.Me.bind(this);this.F=function(){};this.G=a.getElementById("vivliostyle-page-rules");this.N=!1;this.l=null;this.la={loadEPUB:this.rg,loadXML:this.sg,configure:this.$e,moveTo:this.ta,toc:this.Uc};Uu(this)}function Uu(a){xa(1,function(b){Vu(a,{t:"debug",content:b})});xa(2,function(b){Vu(a,{t:"info",content:b})});xa(3,function(b){Vu(a,{t:"warn",content:b})});xa(4,function(b){Vu(a,{t:"error",content:b})})}function Vu(a,b){b.i=a.Ba;a.ua(b)}
function Wu(a,b){a.u!==b&&(a.u=b,a.ge.setAttribute("data-vivliostyle-viewer-status",b),Vu(a,{t:"readystatechange"}))}n=Tu.prototype;
n.rg=function(a){Xu.f("beforeRender");Wu(this,"loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=L("loadEPUB"),h=this;h.$e(a).then(function(){var a=new Wt;Nt(a,e,f).then(function(){var e=Ba(Ea(b),h.window.location.href);h.J=[e];Yt(a,e,d).then(function(a){a?(h.O=a,Yu(h,c).then(function(){O(g,!0)})):O(g,!1)})})});return g.result()};
...
(this.viewport=null,this.$.Dc=a.pageBorder,this.Ya=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=a.zoom,this.hc=!0);"boolean"==typeof a.fitToScreen&&a.fitToScreen!==this.C&&(this.C=a.fitToScreen,this.hc=!0);"object"==typeof a.defaultPaperSize&&"number"==typeof a.defaultPaperSize.width&&"number"==typeof a.defaultPaperSize.height&&(this.viewport=null,this.$.vc=a.defaultPaperSize,this.Ya=!0);bv(this,a);return M(!0)};
...
function cv(a,b,c){a.hc=!1;ev(a);if(a.$.ub)return Lu(a.b,a.f,c).ea(function(c){fv(a);a.j=c;c.left&&(gv(a,c.left),c.right?c.left.I.removeAttribute("data-vivliostyle-unpaired-page"):c.left.I.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(gv(a,c.right),c.left?c.right.I.removeAttribute("data-vivliostyle-unpaired-page"):c.right.I.setAttribute("data-vivliostyle-unpaired-page",!0));c=ov(a,c);a.viewport.zoom(c.width,c.height,a.C?pv(a,c):a.zoom);a.g=b;return M(null)});hv(a,b);a.viewport.zoom(b.g.width,
b.g.height,a.C?pv(a,b.g):a.zoom);a.g=b;return M(null)}function ov(a,b){var c=0,d=0;b.left&&(c+=b.left.g.width,d=b.left.g.height);b.right&&(c+=b.right.g.width,d=Math.max(d,b.right.g.height));b.left&&b.right&&(c+=2*a.$.Dc);return{width:c,height:d}}var qv={$g:"fit inside viewport"};function pv(a,b){return Math.min(a.viewport.width/b.width,a.viewport.height/b.height)}function rv(){this.name="RenderingCanceledError";this.message="Page rendering has been canceled";this.stack=Error().stack}v(rv,Error);
...
var Ov={now:Date.now},Xu,Pv=Xu=new Nv(window&&window.performance||Ov);Lv.call(Pv,"load_vivliostyle","start",void 0);oa("vivliostyle.profile.profiler",Pv);Nv.prototype.printTimings=Nv.prototype.l;Nv.prototype.disable=Nv.prototype.u;Nv.prototype.enable=Nv.prototype.A;function uo(a){return(a=a.D)&&a instanceof zp?a:null}function Qv(a,b,c){var d=a.b;return d&&!d.Bc&&(a=Rv(a,b),a.B)?!d.yc||d.Bc?M(!0):Sv(d,d.yc,a,null,c):M(!0)}function Tv(a,b,c){var d=a.b;return d&&(a=Rv(a,b),a.B)?!d.zc||d.Cc?M(!0):Sv(d,d.zc,a,a.B.firstChild,c):M(!0)}function Uv(a,b){a&&Vv(a.K?a.parent:a,function(a,d){a instanceof yp||b.A.push(new Wv(d))})}function Vv(a,b){for(var c=a;c;c=c.parent){var d=c.D;d&&d instanceof zp&&!jl(c,d)&&b(d,c)}}
...
function cw(a,b,c){for(var d=[];a;a=a.parentNode){if(b.M===a)return b.K;d.push(a)}for(a=b.M;a;a=a.parentNode){var e=d.indexOf(a);if(0<=e)return c?!e:!1;for(e=a;e;e=e.previousElementSibling)if(d.includes(e))return!0}return b.K}function dw(a){return!a.Bc&&a.re&&a.yc||!a.Cc&&a.gd&&a.zc?!0:!1}function ew(a){this.D=a}ew.prototype.b=function(){};ew.prototype.f=function(a){return!!a};
ew.prototype.g=function(a,b,c,d){(a=this.D.b)&&!a.j&&(a.C&&(a.H=Op(a.C,c,a.N),a.C=null),a.u&&(a.G=Op(a.u,c,a.N),a.u=null),a.j=!0);return d};function fw(a){this.D=a}fw.prototype.b=function(){};fw.prototype.f=function(){return!0};fw.prototype.g=function(a,b,c,d){return d};function gw(a){this.D=a}v(gw,ew);gw.prototype.b=function(a,b){ew.prototype.b.call(this,a,b);var c=L("BlockLayoutProcessor.doInitialLayout");Fm(new Em(new hw(a.D),b.j),a).Ea(c);return c.result()};gw.prototype.f=function(){return!1};
function iw(a){this.D=a}v(iw,fw);iw.prototype.b=function(a,b){jl(a,this.D)||a.K||b.A.unshift(new Wv(a));return jw(a,b)};function Wv(a){this.w=Rv(a.D,a)}n=Wv.prototype;n.ke=function(a,b){var c=this.w.D.b;return c&&!Po(this.w.B)&&dw(c)?b&&!a||a&&a.xa?!1:!0:!0};n.nd=function(){var a=this.w.D.b;return a&&dw(a)?(!a.Bc&&a.re&&a.yc?a.Bc=!0:!a.Cc&&a.gd&&a.zc&&(a.Cc=!0),!0):!1};n.cd=function(a,b,c,d){(c=this.w.D.b)&&a&&d.u&&(!b||aw(c,b))&&(c.Bc=!1,c.re=!1)};
n.Na=function(a,b){var c=this.w.D,d=this.w.D.b;if(!d)return M(!0);var e=this.w;return Tv(c,e,b).ea(function(){return Qv(c,e,b).ea(function(){d.Cc=d.Bc=!1;d.re=!0;d.gd=!0;return M(!0)})})};n.se=function(a){return a instanceof Wv?this.w.D===a.w.D:!1};n.ue=function(){return 10};function kw(a){Om.call(this);this.D=a}v(kw,Om);kw.prototype.qf=function(a){var b=this.D.b;return jl(a,this.D)||b.j?(jl(a,this.D)||a.K||!b||(b.Cc=!1,b.gd=!1),new iw(this.D)):new gw(this.D)};function hw(a){this.D=a}v(hw,Hm);
hw.prototype.Cd=function(a){var b=this.D,c=a.w,d=b.b;if(c.parent&&b.j===c.parent.M){switch(c.u){case "header":if(d.zc)c.u="none";else return Zv(d,c),M(!0);break;case "footer":if(d.yc)c.u="none";else return $v(d,c),M(!0)}d.g||(d.g=c.M)}return Hm.prototype.Cd.call(this,a)};hw.prototype.tc=function(a){var b=this.D,c=a.w;c.M===b.j&&(b.b.J=a.ld&&a.ld.M,a.Vb=!0);return"header"===c.u||"footer"===c.u?M(!0):Hm.prototype.tc.call(this,a)};function lw(){}v(lw,Lp);
lw.prototype.je=function(a,b,c){if(xo(b,a))return Ho(b,a);var d=a.D;return Xv(d,a)?(c&&Uv(a.parent,b),jl(a,d)?Lp.prototype.je.call(this,a,b,c):Pm(new kw(d),a,b)):Jo(b,a)};lw.prototype.Ze=function(a){var b=uo(a).b;if(!b)return!1;b.h||b.A!==a.M&&b.l!==a.M||a.B.parentNode.removeChild(a.B);return!1};
function jw(a,b){var c=a.D,d=L("doLayout"),e=Gm(b.j,a,!1);Io(e,b).then(function(a){var e=a;Fe(function(a){for(var d={};e;){d.Oa=!0;Bp(b,e,!1).then(function(d){return function(f){e=f;Jn(b.l)?Q(a):b.g?Q(a):e&&b.u&&e&&e.xa?Q(a):e&&e.K&&e.M==c.j?Q(a):d.Oa?d.Oa=!1:P(a)}}(d));if(d.Oa){d.Oa=!1;return}d={Oa:d.Oa}}Q(a)}).then(function(){O(d,e)})});return d.result()}lw.prototype.Na=function(a,b,c,d){return Lp.prototype.Na.call(this,a,b,c,d)};lw.prototype.Fd=function(a,b,c,d){Lp.prototype.Fd(a,b,c,d)};
function ro(a){for(var b=[],c=a;c;c=c.Md)c.A.forEach(function(c){if(c instanceof Wv){var d=c.w.D.b;b.push(d)}c instanceof mw&&(d=new nw(c.w,c.f),b.push(d));c instanceof ow&&pw(c,a).forEach(function(a){b.push(a)})});return b}var qw=new lw;ge("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof zp&&!(a instanceof yp)?qw:null});function rw(a,b){if(!a||!a.J||a.K||xo(b,a))return M(a);var c=a.J;return sw(c,b,a).ea(function(d){var e=a.B;e.appendChild(d);var f=Op(d,b,a.b);e.removeChild(d);b.A.push(new mw(a,c,f));return M(a)})}function tw(a,b,c){this.b=a;this.f=b;this.Nb=c}tw.prototype.matches=function(){var a=uw[this.b];return!!a&&null!=a.Sa&&Ci(a.Sa,this.f,this.Nb)};function uj(a){this.b=a}uj.prototype.matches=function(){return this.b.some(function(a){return a.matches()})};function vj(a){this.b=a}vj.prototype.matches=function(){return this.b.every(function(a){return a.matches()})};
...
function zw(a,b,c){var d=a.w,e=d.display,f=d.parent?d.parent.display:null,g=!1;if("inline-table"===f&&!(d.D instanceof yp))for(var h=d.parent;h;h=h.parent)if(h.D instanceof yp){g=h.D===b;break}return g||"table-row"===e&&!Aw(f)&&"table"!==f&&"inline-table"!==f||"table-cell"===e&&"table-row"!==f&&!Aw(f)&&"table"!==f&&"inline-table"!==f||d.D instanceof yp&&d.D!==b?Jo(c,d).ea(function(b){a.w=b;return M(!0)}):null}
...
Fw.prototype.ec=function(){var a=this.b.B,b=this.b.Z;"middle"!==b&&"bottom"!==b||x(a,"vertical-align","top");var c=this.lc.ec(!0);x(a,"vertical-align",b);return c};function Gw(a,b){this.B=a;this.b=b}function Hw(a,b,c,d){Nm.call(this,a,b,c,d);this.D=a.D;this.rowIndex=this.l=null}v(Hw,Nm);Hw.prototype.f=function(a,b){var c=Nm.prototype.f.call(this,a,b);return b<this.b()?null:Iw(this).every(function(a){return!!a.w})?c:null};
Hw.prototype.b=function(){var a=Nm.prototype.b.call(this);Iw(this).forEach(function(b){a+=b.Eb.b()});return a};function Iw(a){a.l||(a.l=Jw(a).map(function(a){return a.ec()}));return a.l}function Jw(a){return Kw(a.D,null!=a.rowIndex?a.rowIndex:a.rowIndex=Lw(a.D,a.position.M)).map(a.D.Sd,a.D)}function Mw(a,b,c){this.rowIndex=a;this.j=b;this.D=c;this.h=null}v(Mw,no);
Mw.prototype.f=function(a,b){if(b<this.b())return null;var c=Nw(this),d=Ow(this),e=d.every(function(a){return!!a.w})&&d.some(function(a,b){var d=c[b].lc,e=a.w,f=d.tf[0];return!(f.B===e.B&&f.K===e.K&&f.na===e.na)&&!Uk(fl(e),d.za.xb)});this.j.xa=d.some(function(a){return a.w&&a.w.xa});return e?this.j:null};Mw.prototype.b=function(){var a=this.D,b=0;Cw(a.g[this.rowIndex])>a.N/2||(b+=10);Ow(this).forEach(function(a){b+=a.Eb.b()});return b};
function Ow(a){a.h||(a.h=Nw(a).map(function(a){return a.ec()}));return a.h}function Nw(a){return Pw(a.D,a.rowIndex).map(a.D.Sd,a.D)}function yp(a,b){zp.call(this,a,b);this.F=b;this.u=!1;this.G=-1;this.N=0;this.H=[];this.J=this.A=null;this.S=0;this.g=[];this.l=[];this.f=[];this.C=null;this.h=[];this.b=null}v(yp,zp);n=yp.prototype;n.We=function(){return"Table formatting context (vivliostyle.table.TableFormattingContext)"};
...
function bx(a,b){this.gc=!0;this.D=a;this.f=b;this.l=!1;this.b=-1;this.g=0;this.u=b.u;b.u=!1}v(bx,Hm);var cx={"table-caption":!0,"table-column-group":!0,"table-column":!0};
function dx(a,b,c,d){var e=b.rowIndex,f=b.Ra,g=c.B;if(1<b.f){x(g,"box-sizing","border-box");for(var h=a.D.J,l=0,k=0;k<b.f;k++)l+=h[b.b.Ra+k];l+=a.D.S*(b.f-1);x(g,a.D.u?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new Fw(a.f,b,c);a=a.D;(g=a.f[e])||(g=a.f[e]=[]);g[f]=c;1===d.f.pa.length&&d.f.K&&(c.f=!0);return Lm(c.lc,d).Hc(!0)}function ex(a,b){var c=a.D.h[0];return c?c.bc.b.Ra===b:!1}
function fx(a){var b=a.D.h;if(!b.length)return[];var c=[],d=0;do{var e=b[d],f=e.bc.rowIndex;if(f<a.b){var g=c[f];g||(g=c[f]=[]);g.push(e);b.splice(d,1)}else d++}while(d<b.length);return c}
function gx(a,b){var c=a.D,d=fx(a),e=d.reduce(function(a){return a+1},0);if(0===e)return M(!0);var f=a.f.j,g=b.w;g.B.parentNode.removeChild(g.B);var h=L("layoutRowSpanningCellsFromPreviousFragment"),l=M(!0),k=0,m=[];d.forEach(function(a){var b=this;l=l.ea(function(){var d=Xk(a[0].Id.pa[1],g.parent);return Ao(f,d,!1).ea(function(){function g(a){for(;l<a;){if(!m.includes(l)){var b=d.B.ownerDocument.createElement("td");x(b,"padding","0");d.B.appendChild(b)}l++}}var h=M(!0),l=0;a.forEach(function(a){var b=
...
function ox(a,b,c,d){if(a.length<c){var e=d.ownerDocument.createElement("colgroup");b.push(e);for(b=a.length;b<c;b++){var f=d.ownerDocument.createElement("col");e.appendChild(f);a.push(f)}}}function px(a,b,c){var d=a.u,e=a.C;if(e){a.C=null;var f=e.ownerDocument.createDocumentFragment(),g=Rw(a);if(0<g){var h=a.J=lx(e,g,d,c.f);c=mx(b);e=nx(c);ox(e,c,g,b);e.forEach(function(a,b){x(a,d?"height":"width",h[b]+"px")});c.forEach(function(a){f.appendChild(a.cloneNode(!0))})}a.A=f}}
function qx(a,b,c){var d=b.D;d.u=b.b;Or(d,b.b);var e=yw(b.M);ww(b.M);var f=L("TableLayoutProcessor.doInitialLayout"),g=Zk(b);Fm(new Em(new Zw(b.D,c),c.j),b).then(function(a){var h=a.B,k=Kk(c.f,h),k=c.b?k.left:k.bottom,k=k+(c.b?-1:1)*oo(b,ro(c)).current;so(c,k)||e&&e.tg?(px(d,h,c),Sw(d,c.f),O(f,null)):(c.N.push(new rx(g)),O(f,a))}.bind(a));return f.result()}function sx(a,b,c){var d=a.H;d.forEach(function(a,f){a&&(b.insertBefore(a.B,c),"top"===a.b&&(d[f]=null))})}
function tx(a,b){if(a.A&&b){var c=mx(b);c&&c.forEach(function(a){b.removeChild(a)})}}function ux(a,b){var c=a.D,d=Xv(c,a),e=d.firstChild;sx(c,d,e);c.A&&!mx(d).length&&d.insertBefore(c.A.cloneNode(!0),e);c=new bx(c,b);c=new Em(c,b.j);d=L("TableFormattingContext.doLayout");Fm(c,a).Ea(d);return d.result()}n=kx.prototype;n.je=function(a,b,c){var d=a.D;return Xv(d,a)?(c&&Uv(a.parent,b),Pm(new vx(d,this),a,b)):Jo(b,a)};n.Kf=function(a,b,c,d){return new Hw(a,b,c,d)};n.Ze=function(){return!1};n.Af=function(){return!1};
...
function zx(a,b){return Bx(a,b).map(function(a){return{Kd:a.yg.lc.za.A,Eb:a.Eb}})}function Bx(a,b){var c=Number.MAX_VALUE;a&&"table-row"===a.display&&(c=Lw(b,a.M)+1);for(var c=Math.min(b.f.length,c),d=[],e=0;e<c;e++)b.f[e]&&b.f[e].forEach(function(a){a&&d.push({yg:a,Eb:a.ec().w})});return d}function pw(a,b){var c=a.w.D,d=Tw(c,b);return d?Uw(c,d):Ww(c)}n.se=function(a){return a instanceof ow?this.w.D===a.w.D:!1};var Cx=new kx;
ge("RESOLVE_FORMATTING_CONTEXT",function(a,b,c){return b?c===Od?(b=a.parent,new yp(b?b.D:null,a.M)):null:null});ge("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof yp?Cx:null});Array.from||(Array.from=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e],e):a[e];return c});
...
oa("vivliostyle.viewerapp.main",function(a){var b=a&&a.fragment||Fa("f"),c=a&&a.epubURL||Fa("b"),d=a&&a.xmlURL||Fa("x"),e=a&&a.defaultPageWidth||Fa("w"),f=a&&a.defaultPageHeight||Fa("h"),g=a&&a.defaultPageSize||Fa("size"),h=a&&a.orientation||Fa("orientation"),l=Fa("spread"),l=a&&a.spreadView||!!l&&"false"!=l,k=a&&a.viewportElement||document.body;a={a:c?"loadEPUB":"loadXML",url:c||d,autoresize:!0,fragment:b,renderAllPages:!0,userAgentRootURL:a&&a.uaRoot||null,document:a&&a.document||null,userStyleSheet:a&&
