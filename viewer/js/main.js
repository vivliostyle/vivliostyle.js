 ...
 *
 * Vivliostyle core 2019.1.103-pre.20190401171152
 */
(function(factory) {
...
n.he=function(a){return this.b&64?a:null};n.bd=function(a){return this.b&128?a:null};n.Ub=function(){return null};n.oc=function(){return null};n.Xb=function(){return null};n.Yc=function(a){return a};var Zg=new ah(0,U,U);
...
function yt(a,b,c,d,e,f,g,h,l,k,m,p,q,r,z){var u=b.b?b.j&&b.N:b.h&&b.S,A=f.element,E=new dn(l,"column",null,h,null,null,null),I=a.b.clone(),K=L("createAndLayoutColumn"),H;Fe(function(b){var K=new mo([new hq(a.h,a.b.page-1)].concat($n(E)));if(1<k){var ma=a.viewport.b.createElement("div");x(ma,"position","absolute");A.appendChild(ma);H=new Km(ma,r,a.g,K,E);H.Kb=z;H.b=f.b;H.Mb=f.Mb;H.Rd=f.Rd;f.b?(K=g*(p+m)+f.J,zl(H,f.I,f.width),yl(H,K,p)):(K=g*(p+m)+f.I,yl(H,f.J,f.height),zl(H,K,p));H.F=c;H.G=d}else H=
...
function Bt(a,b,c,d,e,f,g,h,l,k,m,p){var q=L("layoutFlowColumns"),r=a.b.clone(),z=Z(c,a,"column-gap"),u=1<m?Z(c,a,"column-width"):l.width,A=Gq(c,a),E=Hq(c,a,"shape-inside"),I=Rg(E,0,0,l.width,l.height,a),K=new rr(k,a,a.viewport,a.f,A,a.da,a.j,a.style.F,a,b,a.Kb,a.Jb,a.Lb),H=0,ma=null,Ca=[];Fe(function(b){yt(a,c,d,e,f,l,H++,k,h,m,z,u,I,K,p).then(function(c){Jn(g)?(Ca=null,Q(b)):((c.g&&"column"!==c.g||H===m)&&!Jn(h)&&Fn(h),Jn(h)?(H=0,a.b=r.clone(),h.Qc=!1,h.g?(Ca=null,Q(b)):P(b)):(ma=c,Ca[H-1]=ma,ma.g&&
