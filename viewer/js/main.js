...
function en(a){if((a=a.size)&&a.value!==ld){var b=a.value;b.od()?(a=b.values[0],b=b.values[1]):(a=b,b=null);return a.Fc()?{width:a,height:b||a}:(a=cn[a.name.toLowerCase()])?b&&b===Bd?{width:a.height,height:a.width}:{width:a.width,height:a.height}:dn}return dn}
