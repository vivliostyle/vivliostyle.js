 ...
 *
 * Vivliostyle core 2016.4.1-pre.20160609102923
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
{K:"inline-size",L:"height"},{K:"block-size",L:"width"}]}},ha=fa(!0),ia=fa(!1),ja={"horizontal-tb":[{K:"line-left",L:"left"},{K:"line-right",L:"right"},{K:"over",L:"top"},{K:"under",L:"bottom"}],"vertical-rl":[{K:"line-left",L:"top"},{K:"line-right",L:"bottom"},{K:"over",L:"right"},{K:"under",L:"left"}],"vertical-lr":[{K:"line-left",L:"top"},{K:"line-right",L:"bottom"},{K:"over",L:"right"},{K:"under",L:"left"}]};var ka=!1,la={ue:"ltr",ve:"rtl"};ca("vivliostyle.constants.PageProgression",la);la.LTR="ltr";la.RTL="rtl";var ma={Qd:"left",Rd:"right"};ca("vivliostyle.constants.PageSide",ma);ma.LEFT="left";ma.RIGHT="right";function na(a){var b=a.error,c=b&&(b.frameTrace||b.stack);a=[].concat(a.messages);b&&(0<a.length&&(a=a.concat(["\n"])),a=a.concat([b.toString()]),c&&(a=a.concat(["\n"]).concat(c)));return a}function pa(a){a=Array.b(a);var b=null;a[0]instanceof Error&&(b=a.shift());return{error:b,messages:a}}function qa(a){function b(a){return function(b){return a.apply(c,b)}}var c=a||console;this.f=b(c.debug||c.log);this.h=b(c.info||c.log);this.j=b(c.warn||c.log);this.g=b(c.error||c.log);this.d={}}
function ra(a,b,c){(a=a.d[b])&&a.forEach(function(a){a(c)})}function sa(a,b){var c=u,d=c.d[a];d||(d=c.d[a]=[]);d.push(b)}qa.prototype.debug=function(a){var b=pa(arguments);this.f(na(b));ra(this,1,b)};qa.prototype.e=function(a){var b=pa(arguments);this.h(na(b));ra(this,2,b)};qa.prototype.b=function(a){var b=pa(arguments);this.j(na(b));ra(this,3,b)};qa.prototype.error=function(a){var b=pa(arguments);this.g(na(b));ra(this,4,b)};var u=new qa;function ta(a){var b=a.match(/^([^#]*)/);return b?b[1]:a}var ua=window.location.href;
...
function Fa(a,b){if("writing-mode"===b){var c=document.createElement("span");if("-ms-"===a)return c.style.setProperty(a+b,"tb-rl"),"tb-rl"===c.style["writing-mode"];c.style.setProperty(a+b,"vertical-rl");return"vertical-rl"===c.style[a+b]}return"string"===typeof document.documentElement.style[Ba(a,b)]}
function Ha(a){var b=Da[a];if(b||null===b)return b;switch(a){case "writing-mode":if(Fa("-ms-","writing-mode"))return Da[a]="-ms-writing-mode";break;case "filter":if(Fa("-webkit-","filter"))return Da[a]="-webkit-filter"}for(b=0;b<Ca.length;b++){var c=Ca[b];if(Fa(c,a))return b=c+a,Da[a]=b}u.b("Property not supported by the browser: ",a);return Da[a]=null}
function x(a,b,c){try{var d=Ha(b);if(d){if("-ms-writing-mode"===d)switch(c){case "horizontal-tb":c="lr-tb";break;case "vertical-rl":c="tb-rl";break;case "vertical-lr":c="tb-lr"}a&&a.style&&a.style.setProperty(d,c)}}catch(e){u.b(e)}}function Ia(a,b,c){try{return a.style.getPropertyValue(Da[b]||b)}catch(d){}return c||""}function Ja(){this.b=[]}Ja.prototype.append=function(a){this.b.push(a);return this};Ja.prototype.toString=function(){var a=this.b.join("");this.b=[a];return a};
...
function xa(a){return a.replace(/[^-a-zA-Z0-9_]/g,Pa)}function Qa(a){if(!a)throw"Assert failed";}function Ra(a,b){for(var c=0,d=a;;){Qa(c<=d);Qa(0==c||!b(c-1));Qa(d==a||b(d));if(c==d)return c;var e=c+d>>1;b(e)?d=e:c=e+1}}function Sa(a,b){return a-b}function Ua(a,b){for(var c={},d=0;d<a.length;d++){var e=a[d],f=b(e);f&&!c[f]&&(c[f]=e)}return c}var Va={};function Wa(a,b){for(var c={},d=0;d<a.length;d++){var e=a[d],f=b(e);f&&(c[f]?c[f].push(e):c[f]=[e])}return c}
function Xa(a,b){for(var c=Array(a.length),d=0;d<a.length;d++)c[d]=b(a[d],d);return c}function Ya(a,b){var c={},d;for(d in a)c[d]=b(a[d],d);return c}function Za(){this.f={}}function $a(a,b){var c=a.f[b.type];if(c){b.target=a;b.currentTarget=a;for(var d=0;d<c.length;d++)c[d](b)}}Za.prototype.addEventListener=function(a,b,c){c||((c=this.f[a])?c.push(b):this.f[a]=[b])};Za.prototype.removeEventListener=function(a,b,c){!c&&(a=this.f[a])&&(b=a.indexOf(b),0<=b&&a.splice(b,0))};var ab=null;
function bb(a){if(null==ab){var b=a.ownerDocument,c=b.createElement("div");c.style.position="absolute";c.style.top="0px";c.style.left="0px";c.style.width="100px";c.style.height="100px";c.style.overflow="hidden";c.style.lineHeight="16px";c.style.fontSize="16px";a.appendChild(c);var d=b.createElement("div");d.style.width="0px";d.style.height="14px";d.style.cssFloat="left";c.appendChild(d);d=b.createElement("div");d.style.width="50px";d.style.height="50px";d.style.cssFloat="left";d.style.clear="left";
c.appendChild(d);d=b.createTextNode("a a a a a a a a a a a a a a a a");c.appendChild(d);b=b.createRange();b.setStart(d,0);b.setEnd(d,1);ab=40>b.getBoundingClientRect().left;a.removeChild(c)}return ab}var cb=null;function db(a){return 1==a.nodeType&&(a=a.getAttribute("id"))&&a.match(/^[-a-zA-Z_0-9.\u007F-\uFFFF]+$/)?a:null}function eb(a){return"^"+a}function fb(a){return a.substr(1)}function gb(a){return a?a.replace(/\^[\[\]\(\),=;^]/g,fb):a}
function hb(a){for(var b={};a;){var c=a.match(/^;([^;=]+)=(([^;]|\^;)*)/);if(!c)break;var d=c[1],e;a:{e=c[2];var f=[];do{var g=e.match(/^(\^,|[^,])*/),h=gb(g[0]);e=e.substr(g[0].length+1);if(!e&&!f.length){e=h;break a}f.push(h)}while(e);e=f}b[d]=e;a=a.substr(c[0].length)}return b}function ib(){}ib.prototype.e=function(a){a.append("!")};ib.prototype.f=function(){return!1};function jb(a,b,c){this.b=a;this.id=b;this.Wa=c}
jb.prototype.e=function(a){a.append("/");a.append(this.b.toString());if(this.id||this.Wa)a.append("["),this.id&&a.append(this.id),this.Wa&&(a.append(";s="),a.append(this.Wa)),a.append("]")};
jb.prototype.f=function(a){if(1!=a.fa.nodeType)throw Error("E_CFI_NOT_ELEMENT");var b=a.fa,c=b.children,d=c.length,e=Math.floor(this.b/2)-1;0>e||0==d?(c=b.firstChild,a.fa=c||b):(c=c[Math.min(e,d-1)],this.b&1&&((b=c.nextSibling)&&1!=b.nodeType?c=b:a.J=!0),a.fa=c);if(this.id&&(a.J||this.id!=db(a.fa)))throw Error("E_CFI_ID_MISMATCH");a.Wa=this.Wa;return!0};function kb(a,b,c,d){this.offset=a;this.d=b;this.b=c;this.Wa=d}
kb.prototype.f=function(a){if(0<this.offset&&!a.J){for(var b=this.offset,c=a.fa;;){var d=c.nodeType;if(1==d)break;var e=c.nextSibling;if(3<=d&&5>=d){d=c.textContent.length;if(b<=d)break;if(!e){b=d;break}b-=d}if(!e){b=0;break}c=e}a.fa=c;a.offset=b}a.Wa=this.Wa;return!0};
kb.prototype.e=function(a){a.append(":");a.append(this.offset.toString());if(this.d||this.b||this.Wa){a.append("[");if(this.d||this.b)this.d&&a.append(this.d.replace(/[\[\]\(\),=;^]/g,eb)),a.append(","),this.b&&a.append(this.b.replace(/[\[\]\(\),=;^]/g,eb));this.Wa&&(a.append(";s="),a.append(this.Wa));a.append("]")}};function lb(){this.ga=null}
function mb(a,b){var c=b.match(/^#?epubcfi\((.*)\)$/);if(!c)throw Error("E_CFI_NOT_CFI");for(var d=c[1],e=0,f=[];;)switch(d.charAt(e)){case "/":e++;c=d.substr(e).match(/^(0|[1-9][0-9]*)(\[([-a-zA-Z_0-9.\u007F-\uFFFF]+)(;([^\]]|\^\])*)?\])?/);if(!c)throw Error("E_CFI_NUMBER_EXPECTED");var e=e+c[0].length,g=parseInt(c[1],10),h=c[3],c=hb(c[4]);f.push(new jb(g,h,za(c.s)));break;case ":":e++;c=d.substr(e).match(/^(0|[1-9][0-9]*)(\[((([^\];,]|\^[\];,])*)(,(([^\];,]|\^[\];,])*))?)(;([^]]|\^\])*)?\])?/);
if(!c)throw Error("E_CFI_NUMBER_EXPECTED");e+=c[0].length;g=parseInt(c[1],10);(h=c[4])&&(h=gb(h));var l=c[7];l&&(l=gb(l));c=hb(c[10]);f.push(new kb(g,h,l,za(c.s)));break;case "!":e++;f.push(new ib);break;case "~":case "@":case "":a.ga=f;return;default:throw Error("E_CFI_PARSE_ERROR");}}function nb(a,b){for(var c={fa:b.documentElement,offset:0,J:!1,Wa:null,ac:null},d=0;d<a.ga.length;d++)if(!a.ga[d].f(c)){++d<a.ga.length&&(c.ac=new lb,c.ac.ga=a.ga.slice(d));break}return c}
lb.prototype.trim=function(a,b){return a.replace(/\s+/g," ").match(b?/^[ -\uD7FF\uE000-\uFFFF]{0,8}/:/[ -\uD7FF\uE000-\uFFFF]{0,8}$/)[0].replace(/^\s/,"").replace(/\s$/,"")};
function ob(a,b,c){for(var d=!1,e=null,f=[],g=b.parentNode,h="",l="";b;){switch(b.nodeType){case 3:case 4:case 5:var k=b.textContent,m=k.length;d?(c+=m,h||(h=k)):(c>m&&(c=m),d=!0,h=k.substr(0,c),l=k.substr(c));b=b.previousSibling;continue;case 8:b=b.previousSibling;continue}break}if(0<c||h||l)h=a.trim(h,!1),l=a.trim(l,!0),f.push(new kb(c,h,l,e)),e=null;for(;g&&g&&9!=g.nodeType;){c=d?null:db(b);for(d=d?1:0;b;)1==b.nodeType&&(d+=2),b=b.previousSibling;f.push(new jb(d,c,e));e=null;b=g;g=g.parentNode;
d=!1}f.reverse();a.ga?(f.push(new ib),a.ga=f.concat(a.ga)):a.ga=f}lb.prototype.toString=function(){if(!this.ga)return"";var a=new Ja;a.append("epubcfi(");for(var b=0;b<this.ga.length;b++)this.ga[b].e(a);a.append(")");return a.toString()};function pb(a){a=a.substr(1);if(a.match(/^[^0-9a-fA-F\n\r]$/))return a;a=parseInt(a,16);return isNaN(a)?"":65535>=a?String.fromCharCode(a):1114111>=a?String.fromCharCode(55296|a>>10&1023,56320|a&1023):"\ufffd"}function qb(a){return a.replace(/\\([0-9a-fA-F]{0,6}(\r\n|[ \n\r\t\f])?|[^0-9a-fA-F\n\r])/g,pb)}function rb(){this.type=0;this.b=!1;this.C=0;this.text="";this.position=0}
function sb(a,b){var c=Array(128),d;for(d=0;128>d;d++)c[d]=a;c[NaN]=35==a?35:72;for(d=0;d<b.length;d+=2)c[b[d]]=b[d+1];return c}var tb=[72,72,72,72,72,72,72,72,72,1,1,72,1,1,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,1,4,34,6,7,8,9,33,10,11,12,13,14,15,16,17,2,2,2,2,2,2,2,2,2,2,18,19,20,21,22,23,24,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,25,29,26,30,3,72,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,27,31,28,32,72];tb[NaN]=80;
var ub=[43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,52,43,43,43,43,39,43,43,39,39,39,39,39,39,39,39,39,39,43,43,43,43,43,43,43,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,43,44,43,43,39,43,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,43,43,43,43,43];ub[NaN]=43;
var vb=[72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,78,59,72,59,59,59,59,59,59,59,59,59,59,72,72,72,72,72,72,72,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,72,61,72,72,78,72,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,78,72,72,72,72,72];ub[NaN]=43;
var wb=[35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,57,59,35,58,58,58,58,58,58,58,58,58,58,35,35,35,35,35,35,35,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,35,61,35,35,60,35,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,35,35,35,35,35];wb[NaN]=35;
var xb=[45,45,45,45,45,45,45,45,45,73,45,45,45,45,45,45,45,45,45,45,45,45,45,45,45,45,45,45,45,45,45,45,73,45,45,45,45,45,45,45,53,45,45,45,45,45,45,45,39,39,39,39,39,39,39,39,39,39,45,45,45,45,45,45,45,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,45,44,45,45,39,45,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,39,45,45,45,45,45];xb[NaN]=45;
var yb=[37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,37,41,37,37,37,37,37,37,37,37,42,37,39,39,39,39,39,39,39,39,39,39,37,37,37,37,37,37,37,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,37,37,37,37,40,37,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,37,37,37,37,37];yb[NaN]=37;
var zb=[38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,38,41,38,38,38,38,38,38,38,38,38,38,39,39,39,39,39,39,39,39,39,39,38,38,38,38,38,38,38,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,38,38,38,38,40,38,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,38,38,38,38,38];zb[NaN]=38;
var Ab=sb(35,[61,36]),Bb=sb(35,[58,77]),Cb=sb(35,[61,36,124,50]),Db=sb(35,[38,51]),Eb=sb(35,[42,54]),Fb=sb(39,[42,55]),Gb=sb(54,[42,55,47,56]),Hb=sb(62,[62,56]),Ib=sb(35,[61,36,33,70]),Jb=sb(62,[45,71]),Kb=sb(63,[45,56]),Lb=sb(76,[9,72,10,72,13,72,32,72]),Mb=sb(39,[39,46,10,72,13,72,92,48]),Nb=sb(39,[34,46,10,72,13,72,92,49]),Ob=sb(39,[39,47,10,74,13,74,92,48]),Pb=sb(39,[34,47,10,74,13,74,92,49]),Qb=sb(64,[9,39,32,39,34,66,39,65,41,72,10,39,13,39]),Rb=sb(39,[41,67,9,79,10,79,13,79,32,79,92,75,40,
72,91,72,93,72,123,72,125,72,NaN,67]),Sb=sb(39,[39,68,10,74,13,74,92,75,NaN,67]),Tb=sb(39,[34,68,10,74,13,74,92,75,NaN,67]),Ub=sb(72,[9,39,10,39,13,39,32,39,41,69]);function Vb(a,b){this.h=b;this.e=15;this.j=a;this.g=Array(this.e+1);this.b=-1;for(var c=this.position=this.d=this.f=0;c<=this.e;c++)this.g[c]=new rb}function y(a){a.f==a.d&&Wb(a);return a.g[a.d]}function z(a,b){(a.f-a.d&a.e)<=b&&Wb(a);return a.g[a.d+b&a.e]}function A(a){a.d=a.d+1&a.e}
...
function Wb(a){var b=a.f,c=0<=a.b?a.b:a.d,d=a.e;b>=c?c+=d:c--;if(c==b){if(0>a.b)throw Error("F_CSSTOK_INTERNAL");for(var b=2*(a.e+1)-1,c=Array(b+1),d=a.b,e=0;d!=a.f;)c[e]=a.g[d],d==a.d&&(a.d=e),d=d+1&a.e,e++;a.b=0;a.f=e;a.e=b;for(a.g=c;e<=b;)c[e++]=new rb;b=a.f;c=d=a.e}for(var e=tb,f=a.j,g=a.position,h=a.g,l=0,k=0,m="",p=0,r=!1,v=h[b],q=-9;;){var w=f.charCodeAt(g);switch(e[w]||e[65]){case 72:l=51;m=isNaN(w)?"E_CSS_UNEXPECTED_EOF":"E_CSS_UNEXPECTED_CHAR";g++;break;case 1:g++;r=!0;continue;case 2:k=
g++;e=yb;continue;case 3:l=1;k=g++;e=ub;continue;case 4:k=g++;l=31;e=Ab;continue;case 33:l=2;k=++g;e=Mb;continue;case 34:l=2;k=++g;e=Nb;continue;case 6:k=++g;l=7;e=ub;continue;case 7:k=g++;l=32;e=Ab;continue;case 8:k=g++;l=21;break;case 9:k=g++;l=32;e=Db;continue;case 10:k=g++;l=10;break;case 11:k=g++;l=11;break;case 12:k=g++;l=36;e=Ab;continue;case 13:k=g++;l=23;break;case 14:k=g++;l=16;break;case 15:l=24;k=g++;e=wb;continue;case 16:k=g++;e=vb;continue;case 78:k=g++;l=9;e=ub;continue;case 17:k=g++;
l=19;e=Eb;continue;case 18:k=g++;l=18;e=Bb;continue;case 77:g++;l=50;break;case 19:k=g++;l=17;break;case 20:k=g++;l=38;e=Ib;continue;case 21:k=g++;l=39;e=Ab;continue;case 22:k=g++;l=37;e=Ab;continue;case 23:k=g++;l=22;break;case 24:k=++g;l=20;e=ub;continue;case 25:k=g++;l=14;break;case 26:k=g++;l=15;break;case 27:k=g++;l=12;break;case 28:k=g++;l=13;break;case 29:q=k=g++;l=1;e=Lb;continue;case 30:k=g++;l=33;e=Ab;continue;case 31:k=g++;l=34;e=Cb;continue;case 32:k=g++;l=35;e=Ab;continue;case 35:break;
case 36:g++;l=l+41-31;break;case 37:l=5;p=parseInt(f.substring(k,g),10);break;case 38:l=4;p=parseFloat(f.substring(k,g));break;case 39:g++;continue;case 40:l=3;p=parseFloat(f.substring(k,g));k=g++;e=ub;continue;case 41:l=3;p=parseFloat(f.substring(k,g));m="%";k=g++;break;case 42:g++;e=zb;continue;case 43:m=f.substring(k,g);break;case 44:q=g++;e=Lb;continue;case 45:m=qb(f.substring(k,g));break;case 46:m=f.substring(k,g);g++;break;case 47:m=qb(f.substring(k,g));g++;break;case 48:q=g;g+=2;e=Ob;continue;
case 49:q=g;g+=2;e=Pb;continue;case 50:g++;l=25;break;case 51:g++;l=26;break;case 52:m=f.substring(k,g);if(1==l){g++;if("url"==m.toLowerCase()){e=Qb;continue}l=6}break;case 53:m=qb(f.substring(k,g));if(1==l){g++;if("url"==m.toLowerCase()){e=Qb;continue}l=6}break;case 54:e=Fb;g++;continue;case 55:e=Gb;g++;continue;case 56:e=tb;g++;continue;case 57:e=Hb;g++;continue;case 58:l=5;e=yb;g++;continue;case 59:l=4;e=zb;g++;continue;case 60:l=1;e=ub;g++;continue;case 61:l=1;e=Lb;q=g++;continue;case 62:g--;
break;case 63:g-=2;break;case 64:k=g++;e=Rb;continue;case 65:k=++g;e=Sb;continue;case 66:k=++g;e=Tb;continue;case 67:l=8;m=qb(f.substring(k,g));g++;break;case 69:g++;break;case 70:e=Jb;g++;continue;case 71:e=Kb;g++;continue;case 79:if(8>g-q&&f.substring(q+1,g+1).match(/^[0-9a-fA-F]{0,6}(\r\n|[\n\r])|[ \t]$/)){g++;continue}case 68:l=8;m=qb(f.substring(k,g));g++;e=Ub;continue;case 74:g++;if(9>g-q&&f.substring(q+1,g).match(/^[0-9a-fA-F]{0,6}(\r\n|[\n\r])$/))continue;l=51;m="E_CSS_UNEXPECTED_NEWLINE";
break;case 73:if(9>g-q&&f.substring(q+1,g+1).match(/^[0-9a-fA-F]{0,6}[ \t]$/)){g++;continue}m=qb(f.substring(k,g));break;case 75:q=g++;continue;case 76:g++;e=xb;continue;default:if(e!==tb){l=51;m="E_CSS_UNEXPECTED_STATE";break}k=g;l=0}v.type=l;v.b=r;v.C=p;v.text=m;v.position=k;b++;if(b>=c)break;e=tb;r=!1;v=h[b&d]}a.position=g;a.f=b&d};function Yb(){return{fontFamily:"serif",lineHeight:1.25,margin:8,Uc:!0,Qc:25,Tc:!1,ad:!1,Xa:!1,Kb:1,sd:{print:!0}}}function Zb(a){return{fontFamily:a.fontFamily,lineHeight:a.lineHeight,margin:a.margin,Uc:a.Uc,Qc:a.Qc,Tc:a.Tc,ad:a.ad,Xa:a.Xa,Kb:a.Kb,sd:Object.Ub({},a.sd)}}var $b=Yb(),ac={};function bc(a,b,c,d){a=Math.min((a-0)/c,(b-0)/d);return"matrix("+a+",0,0,"+a+",0,0)"}function cc(a){return'"'+Ma(a+"")+'"'}function dc(a){return La(a+"")}function ec(a,b){return a?La(a)+"."+La(b):La(b)}var fc=0;
function gc(a,b){this.parent=a;this.j="S"+fc++;this.children=[];this.b=new B(this,0);this.d=new B(this,1);this.g=new B(this,!0);this.f=new B(this,!1);a&&a.children.push(this);this.values={};this.l={};this.k={};this.h=b;if(!a){var c=this.k;c.floor=Math.floor;c.ceil=Math.ceil;c.round=Math.round;c.sqrt=Math.sqrt;c.min=Math.min;c.max=Math.max;c.letterbox=bc;c["css-string"]=cc;c["css-name"]=dc;c["typeof"]=function(a){return typeof a};hc(this,"page-width",function(){return this.pb()});hc(this,"page-height",
...
function nc(a,b,c,d){this.za=b;this.gb=c;this.H=null;this.pb=function(){return this.H?this.H:this.T.Xa?Math.floor(b/2)-this.T.Kb:b};this.D=null;this.ob=function(){return this.D?this.D:c};this.j=d;this.S=null;this.fontSize=function(){return this.S?this.S:d};this.T=$b;this.w={}}function oc(a,b){a.w[b.j]={};for(var c=0;c<b.children.length;c++)oc(a,b.children[c])}
...
n.Ic=function(){throw Error("E_CSS_COLOR_NOT_ALLOWED");};n.ic=function(){throw Error("E_CSS_URL_NOT_ALLOWED");};n.fb=function(){throw Error("E_CSS_LIST_NOT_ALLOWED");};n.tb=function(){throw Error("E_CSS_COMMA_NOT_ALLOWED");};n.jb=function(){throw Error("E_CSS_FUNC_NOT_ALLOWED");};n.Ob=function(){throw Error("E_CSS_EXPR_NOT_ALLOWED");};function bd(){}t(bd,ad);n=bd.prototype;
n.vb=function(a){for(var b=null,c=0;c<a.length;c++){var d=a[c],e=d.U(this);if(b)b[c]=e;else if(d!==e){b=Array(a.length);for(d=0;d<c;d++)b[d]=a[d];b[c]=e}}return b||a};n.hc=function(a){return a};n.ub=function(a){return a};n.md=function(a){return a};n.Rb=function(a){return a};n.Qb=function(a){return a};n.Pb=function(a){return a};n.Ic=function(a){return a};n.ic=function(a){return a};n.fb=function(a){var b=this.vb(a.values);return b===a.values?a:new cd(b)};
...
function Ie(a){return new ve(Xa(a.b,Ge))}
function Je(a,b,c,d,e){e&&(a=He(a),b=Xa(b,Ie),c=Xa(c,Ie));e=b.length;var f=c?c.length:0,g=[],h=[],l,k,m;for(l=0;l<e;l++)we(b[l],h,l);for(l=0;l<f;l++)we(c[l],h,l+e);b=h.length;h.sort(ue);for(c=0;h[c].e>=e;)c++;c=h[c].b.y;c>a.W&&g.push(new te(a.W,c,a.V,a.V));l=0;for(var p=[];l<b&&(m=h[l]).b.y<c;)m.d.y>c&&p.push(m),l++;for(;l<b||0<p.length;){var r=a.R,v=Ee(Math.ceil(c+8),d);for(k=0;k<p.length&&r>v;k++)m=p[k],m.b.x==m.d.x?m.d.y<r&&(r=Math.max(Fe(m.d.y,d),v)):m.b.x!=m.d.x&&(r=v);r>a.R&&(r=a.R);for(;l<
b&&(m=h[l]).b.y<r;)if(m.d.y<c)l++;else if(m.b.y<v){if(m.b.y!=m.d.y||m.b.y!=c)p.push(m),r=v;l++}else{k=Fe(m.b.y,d);k<r&&(r=k);break}v=[];for(k=0;k<p.length;k++)Ce(v,p[k],c,r);v.sort(function(a,b){return a.x-b.x||a.d-b.d});v=De(v,e,f);if(0==v.length)g.push(new te(c,r,a.V,a.V));else{var q=0,w=a.aa;for(k=0;k<v.length;k+=2){var M=Math.max(a.aa,v[k]),da=Math.min(a.V,v[k+1])-M;da>q&&(q=da,w=M)}0==q?g.push(new te(c,r,a.V,a.V)):g.push(new te(c,r,Math.max(w,a.aa),Math.min(w+q,a.V)))}if(r==a.R)break;c=r;for(k=
...
function Re(a){a=Pe(a);for(var b=new Ja,c=0;c<a.length;c++)b.append(Oe(a[c]));a=b.toString();b=new Ja;for(c=0;c<a.length;c++)b.append((a.charCodeAt(c)|256).toString(16).substr(1));return b.toString()};var Se=null,Te=null;function L(a){if(!Se)throw Error("E_TASK_NO_CONTEXT");Se.name||(Se.name=a);var b=Se;a=new Ue(b,b.top,a);b.top=a;a.b=Ve;return a}function N(a){return new We(a)}function Xe(a,b,c){a=L(a);a.g=c;try{b(a)}catch(d){Ye(a.d,d,a)}return O(a)}function Ze(a){var b=$e,c;Se?c=Se.d:(c=Te)||(c=new af(new bf));b(c,a,void 0)}var Ve=1;function bf(){}bf.prototype.currentTime=function(){return(new Date).valueOf()};function cf(a,b){return setTimeout(a,b)}
function af(a){this.e=a;this.f=1;this.slice=25;this.h=0;this.d=new Aa;this.b=this.j=null;this.g=!1;this.Q=0;Te||(Te=this)}
...
function ff(a,b){this.d=a;this.name=b;this.g=[];this.b=null;this.h=!0;this.e=this.top=this.j=this.f=null}function jf(a,b){a.g.push(b)}ff.prototype.join=function(){var a=L("Task.join");if(this.h){var b=gf(a,this),c=this;jf(this,function(){b.Va(c.f)})}else P(a,this.f);return O(a)};
...
n.ua=function(a){P(a,this.value)};n.Ca=function(){return!1};n.mc=function(){return this.value};function kf(a){this.b=a}n=kf.prototype;n.then=function(a){this.b.then(a)};n.Fc=function(a){if(this.Ca()){var b=new Ue(this.b.d,this.b.parent,"AsyncResult.thenAsync");b.b=Ve;this.b.parent=b;this.b.then(function(c){a(c).then(function(a){P(b,a)})});return O(b)}return a(this.b.e)};n.kd=function(a){return this.Ca()?this.Fc(function(){return new We(a)}):new We(a)};
n.ua=function(a){this.Ca()?this.then(function(b){P(a,b)}):P(a,this.b.e)};n.Ca=function(){return this.b.b==Ve};n.mc=function(){if(this.Ca())throw Error("Result is pending");return this.b.e};function Ue(a,b,c){this.d=a;this.parent=b;this.name=c;this.e=null;this.b=0;this.g=this.f=null}function lf(a){if(!Se)throw Error("F_TASK_NO_CONTEXT");if(a!==Se.top)throw Error("F_TASK_NOT_TOP_FRAME");}function O(a){return new kf(a)}
function P(a,b){lf(a);Se.b||(a.e=b);a.b=2;var c=a.parent;Se.top=c;if(a.f){try{a.f(b)}catch(d){Ye(a.d,d,c)}a.b=3}}Ue.prototype.then=function(a){switch(this.b){case Ve:if(this.f)throw Error("F_TASK_FRAME_ALREADY_HAS_CALLBACK");this.f=a;break;case 2:var b=this.d,c=this.parent;try{a(this.e),this.b=3}catch(d){this.b=3,Ye(b,d,c)}break;case 3:throw Error("F_TASK_DEAD_FRAME");default:throw Error("F_TASK_UNEXPECTED_FRAME_STATE "+this.b);}};
function mf(){var a=L("Frame.timeSlice"),b=a.d.d;b.e.currentTime()>=b.h?(u.debug("-- time slice --"),gf(a).Va(!0)):P(a,!0);return O(a)}function nf(a){function b(d){try{for(;d;){var e=a();if(e.Ca()){e.then(b);return}e.then(function(a){d=a})}P(c,!0)}catch(f){Ye(c.d,f,c)}}var c=L("Frame.loop");b(!0);return O(c)}function of(a){var b=Se;if(!b)throw Error("E_TASK_NO_CONTEXT");return nf(function(){var c;do c=new pf(b,b.top),b.top=c,c.b=Ve,a(c),c=O(c);while(!c.Ca()&&c.mc());return c})}
function gf(a,b){lf(a);if(a.d.e)throw Error("E_TASK_ALREADY_SUSPENDED");var c=new hf(a.d);a.d.e=c;Se=null;a.d.j=b||null;return c}function pf(a,b){Ue.call(this,a,b,"loop")}t(pf,Ue);function qf(a){P(a,!0)}function Q(a){P(a,!1)};function rf(a,b,c,d,e){var f=L("ajax"),g=new XMLHttpRequest,h=gf(f,g),l={status:0,url:a,contentType:null,responseText:null,responseXML:null,wc:null};g.open(c||"GET",a,!0);b&&(g.responseType=b);g.onreadystatechange=function(){if(4===g.readyState){l.status=g.status;if(200==l.status||0==l.status)if(b&&"document"!==b||!g.responseXML){var c=g.response;b&&"text"!==b||"string"!=typeof c?c?"string"==typeof c?l.wc=sf([c]):l.wc=c:u.b("Unexpected empty success response for",a):l.responseText=c;if(c=g.getResponseHeader("Content-Type"))l.contentType=
c.replace(/(.*);.*$/,"$1")}else l.responseXML=g.responseXML,l.contentType=g.responseXML.contentType;h.Va(l)}};try{d?(g.setRequestHeader("Content-Type",e||"text/plain; charset=UTF-8"),g.send(d)):g.send(null)}catch(k){u.b(k,"Error fetching "+a),h.Va(l)}return O(f)}function sf(a){var b=window.WebKitBlobBuilder||window.MSBlobBuilder;if(b){for(var b=new b,c=0;c<a.length;c++)b.append(a[c]);return b.getBlob("application/octet-stream")}return new Blob(a,{type:"application/octet-stream"})}
function tf(a){var b=L("readBlob"),c=new FileReader,d=gf(b,c);c.addEventListener("load",function(){d.Va(c.result)},!1);c.readAsArrayBuffer(a);return O(b)}function uf(a,b){this.I=a;this.type=b;this.g={};this.e={}}uf.prototype.load=function(a,b,c){a=ta(a);var d=this.g[a];return"undefined"!=typeof d?N(d):vf(this.qc(a,b,c))};
function wf(a,b,c,d){var e=L("fetch");rf(b,a.type).then(function(f){if(c&&400<=f.status)throw Error(d||"Failed to fetch required resource: "+b);a.I(f,a).then(function(c){delete a.e[b];a.g[b]=c;P(e,c)})});return O(e)}uf.prototype.qc=function(a,b,c){a=ta(a);if(this.g[a])return null;var d=this.e[a];if(!d){var e=this,d=new xf(function(){return wf(e,a,b,c)},"Fetch "+a);e.e[a]=d;d.start()}return d};function yf(a){a=a.responseText;return N(a?JSON.parse(a):null)};function zf(a){var b=parseInt(a,16);if(isNaN(b))throw Error("E_CSS_COLOR");if(6==a.length)return new nd(b);if(3==a.length)return new nd(b&15|(b&15)<<4|(b&240)<<4|(b&240)<<8|(b&3840)<<8|(b&3840)<<12);throw Error("E_CSS_COLOR");}function Af(a){this.d=a;this.ab="Author"}n=Af.prototype;n.Vb=function(){return null};n.Y=function(){return this.d};n.error=function(){};n.Nb=function(a){this.ab=a};n.hb=function(){};n.Pc=function(){};n.Zb=function(){};n.$b=function(){};n.Vc=function(){};n.nc=function(){};
n.lb=function(){};n.Oc=function(){};n.Nc=function(){};n.Sc=function(){};n.Jb=function(){};n.eb=function(){};n.Ac=function(){};n.cc=function(){};n.Ec=function(){};n.yc=function(){};n.Dc=function(){};n.Mb=function(){};n.jd=function(){};n.Cb=function(){};n.zc=function(){};n.Cc=function(){};n.Bc=function(){};n.fc=function(){};n.ec=function(){};n.ra=function(){};n.bb=function(){};n.mb=function(){};n.dc=function(){};n.oc=function(){};
...
n.fc=function(){If(this,"E_CSS_UNEXPECTED_PARTITION")};n.ec=function(){If(this,"E_CSS_UNEXPECTED_PARTITION_GROUP")};n.dc=function(){If(this,"E_CSS_UNEXPECTED_SELECTOR_FUNC")};n.oc=function(){If(this,"E_CSS_UNEXPECTED_END_SELECTOR_FUNC")};n.bb=function(){this.error("E_CSS_UNEXPECTED_PROPERTY",this.Vb())};var Jf=[],Kf=[],R=[],Lf=[],Mf=[],Nf=[],Of=[],Pf=[],S=[],Qf=[],Rf=[],Sf=[],Tf=[];Jf[1]=28;Jf[36]=29;Jf[7]=29;Jf[9]=29;Jf[14]=29;Jf[18]=29;Jf[20]=30;Jf[13]=27;Jf[0]=200;Kf[1]=46;Kf[0]=200;Nf[1]=2;
...
function cg(a,b,c,d,e,f){var g=a.j,h=a.d,l=a.u,k,m,p,r;e&&(a.g=2,a.u.push("{"));a:for(;0<b;--b)switch(k=y(h),a.b[k.type]){case 28:if(18!=z(h,1).type){bg(a)?(g.error("E_CSS_COLON_EXPECTED",z(h,1)),a.b=Rf):(a.b=Nf,g.eb());continue}m=z(h,2);if(!(m.b||1!=m.type&&6!=m.type)){if(0<=h.b)throw Error("F_CSSTOK_BAD_CALL mark");h.b=h.d}a.e=k.text;a.l=!1;A(h);A(h);a.b=Of;l.splice(0,l.length);continue;case 46:if(18!=z(h,1).type){a.b=Rf;g.error("E_CSS_COLON_EXPECTED",z(h,1));continue}a.e=k.text;a.l=!1;A(h);A(h);
a.b=Of;l.splice(0,l.length);continue;case 29:a.b=Nf;g.eb();continue;case 1:if(!k.b){a.b=Sf;g.error("E_CSS_SPACE_EXPECTED",k);continue}g.lb();case 2:if(34==z(h,1).type)if(A(h),A(h),p=a.I[k.text],null!=p)switch(k=y(h),k.type){case 1:g.hb(p,k.text);a.b=f?Lf:R;A(h);break;case 36:g.hb(p,null);a.b=f?Lf:R;A(h);break;default:a.b=Qf,g.error("E_CSS_NAMESPACE",k)}else a.b=Qf,g.error("E_CSS_UNDECLARED_PREFIX",k);else g.hb(a.D,k.text),a.b=f?Lf:R,A(h);continue;case 3:if(!k.b){a.b=Sf;g.error("E_CSS_SPACE_EXPECTED",
k);continue}g.lb();case 4:if(34==z(h,1).type)switch(A(h),A(h),k=y(h),k.type){case 1:g.hb(null,k.text);a.b=f?Lf:R;A(h);break;case 36:g.hb(null,null);a.b=f?Lf:R;A(h);break;default:a.b=Qf,g.error("E_CSS_NAMESPACE",k)}else g.hb(a.D,null),a.b=f?Lf:R,A(h);continue;case 5:k.b&&g.lb();case 6:g.Vc(k.text);a.b=f?Lf:R;A(h);continue;case 7:k.b&&g.lb();case 8:g.Pc(k.text);a.b=f?Lf:R;A(h);continue;case 55:k.b&&g.lb();case 14:A(h);k=y(h);b:switch(k.type){case 1:g.Zb(k.text,null);A(h);a.b=f?Lf:R;continue;case 6:m=
k.text;A(h);switch(m){case "not":a.b=Nf;g.dc("not");cg(a,Number.POSITIVE_INFINITY,!1,!1,!1,!0)?a.b=R:a.b=Sf;break a;case "lang":case "href-epub-type":if(k=y(h),1===k.type){p=[k.text];A(h);break}else break b;case "nth-child":case "nth-of-type":case "nth-last-child":case "nth-last-of-type":if(p=$f(a))break;else break b;default:p=Zf(a)}k=y(h);if(11==k.type){g.Zb(m,p);A(h);a.b=f?Lf:R;continue}}g.error("E_CSS_PSEUDOCLASS_SYNTAX",k);a.b=Qf;continue;case 42:A(h);k=y(h);switch(k.type){case 1:g.$b(k.text,
null);a.b=f?Lf:R;A(h);continue;case 6:if(m=k.text,A(h),p=Zf(a),k=y(h),11==k.type){g.$b(m,p);a.b=f?Lf:R;A(h);continue}}g.error("E_CSS_PSEUDOELEM_SYNTAX",k);a.b=Qf;continue;case 9:k.b&&g.lb();case 10:A(h);k=y(h);if(1==k.type)m=k.text,A(h);else if(36==k.type)m=null,A(h);else if(34==k.type)m="";else{a.b=Sf;g.error("E_CSS_ATTR",k);A(h);continue}k=y(h);if(34==k.type){p=m?a.I[m]:m;if(null==p){a.b=Sf;g.error("E_CSS_UNDECLARED_PREFIX",k);A(h);continue}A(h);k=y(h);if(1!=k.type){a.b=Sf;g.error("E_CSS_ATTR_NAME_EXPECTED",
k);continue}m=k.text;A(h);k=y(h)}else p="";switch(k.type){case 39:case 45:case 44:case 43:case 42:case 46:case 50:r=k.type;A(h);k=y(h);break;case 15:g.nc(p,m,0,null);a.b=f?Lf:R;A(h);continue;default:a.b=Sf;g.error("E_CSS_ATTR_OP_EXPECTED",k);continue}switch(k.type){case 1:case 2:g.nc(p,m,r,k.text);A(h);k=y(h);break;default:a.b=Sf;g.error("E_CSS_ATTR_VAL_EXPECTED",k);continue}if(15!=k.type){a.b=Sf;g.error("E_CSS_ATTR",k);continue}a.b=f?Lf:R;A(h);continue;case 11:g.Oc();a.b=Mf;A(h);continue;case 12:g.Nc();
...
continue}}a.b===Of&&0<=h.b?(Xb(h),a.b=Nf,g.eb()):Xf(a,"E_CSS_UNEXPECTED_PLUS",k);continue;case 26:A(h);case 48:h.b=-1;(m=Wf(a,";",k))&&a.e&&g.bb(a.e,m,a.l);a.b=d?Kf:Jf;continue;case 44:A(h);h.b=-1;m=Wf(a,";",k);if(c)return a.w=m,!0;a.e&&m&&g.bb(a.e,m,a.l);if(d)return!0;Xf(a,"E_CSS_SYNTAX",k);continue;case 31:m=z(h,1);9==m.type?(10!=z(h,2).type||z(h,2).b?(l.push(new Rc(g.Y(),ec(k.text,m.text))),a.b=S):(l.push(k.text,m.text,"("),A(h)),A(h)):(2==a.g||3==a.g?"not"==k.text.toLowerCase()?(A(h),l.push(new Sc(g.Y(),
!0,m.text))):("only"==k.text.toLowerCase()&&(A(h),k=m),l.push(new Sc(g.Y(),!1,k.text))):l.push(new Rc(g.Y(),k.text)),a.b=S);A(h);continue;case 38:l.push(null,k.text,"(");A(h);continue;case 32:l.push(new B(g.Y(),k.C));A(h);a.b=S;continue;case 33:m=k.text;"%"==m&&(m=a.e&&a.e.match(/height|^(top|bottom)$/)?"vh":"vw");l.push(new Qc(g.Y(),k.C,m));A(h);a.b=S;continue;case 34:l.push(new B(g.Y(),k.text));A(h);a.b=S;continue;case 35:A(h);k=y(h);5!=k.type||k.b?Xf(a,"E_CSS_SYNTAX",k):(l.push(new Wc(g.Y(),k.C)),
A(h),a.b=S);continue;case 36:l.push(-k.type);A(h);continue;case 37:a.b=Pf;Yf(a,k.type,k);l.push(k.type);A(h);continue;case 45:"and"==k.text.toLowerCase()?(a.b=Pf,Yf(a,52,k),l.push(52),A(h)):Xf(a,"E_CSS_SYNTAX",k);continue;case 39:Yf(a,k.type,k)&&(a.e?a.b=Of:Xf(a,"E_CSS_UNBALANCED_PAR",k));A(h);continue;case 43:Yf(a,11,k)&&(a.e||3==a.g?Xf(a,"E_CSS_UNEXPECTED_BRC",k):(1==a.g?g.Cb(l.pop()):(k=l.pop(),g.Cb(k)),a.f.push("media"),g.ra(),a.b=Jf));A(h);continue;case 49:if(Yf(a,11,k))if(a.e||3!=a.g)Xf(a,"E_CSS_UNEXPECTED_SEMICOL",
k);else return a.k=l.pop(),a.B=!0,a.b=Jf,A(h),!1;A(h);continue;case 40:l.push(k.type);A(h);continue;case 27:a.b=Jf;A(h);g.mb();a.f.length&&a.f.pop();continue;case 30:m=k.text.toLowerCase();switch(m){case "import":A(h);k=y(h);if(2==k.type||8==k.type){a.H=k.text;A(h);k=y(h);if(17==k.type||0==k.type)return a.B=!0,A(h),!1;a.e=null;a.g=3;a.b=Pf;l.push("{");continue}g.error("E_CSS_IMPORT_SYNTAX",k);a.b=Qf;continue;case "namespace":A(h);k=y(h);switch(k.type){case 1:m=k.text;A(h);k=y(h);if((2==k.type||8==
...
function eg(a,b,c,d,e){var f=L("parseStylesheet"),g=new Uf(Jf,a,b,c),h=null;e&&(h=fg(new Vb(e,b),b,c));if(h=ag(g,d,h&&h.ja()))b.Cb(h),b.ra();nf(function(){for(;!cg(g,100,!1,!1,!1,!1);){if(g.B){var a=va(g.H,c);g.k&&(b.Cb(g.k),b.ra());var d=L("parseStylesheet.import");gg(a,b,null,null).then(function(){g.k&&b.mb();g.B=!1;g.H=null;g.k=null;P(d,!0)});return O(d)}a=mf();if(a.Ca)return a}return N(!1)}).then(function(){h&&b.mb();P(f,!0)});return O(f)}
function hg(a,b,c,d,e){return Xe("parseStylesheetFromText",function(f){var g=new Vb(a,b);eg(g,b,c,d,e).ua(f)},function(b,c){u.b(c,"Failed to parse stylesheet text: "+a);P(b,!1)})}function gg(a,b,c,d){return Xe("parseStylesheetFromURL",function(e){rf(a).then(function(f){f.responseText?hg(f.responseText,b,a,c,d).then(function(b){b||u.b("Failed to parse stylesheet from "+a);P(e,!0)}):P(e,!0)})},function(b,c){u.b(c,"Exception while fetching and parsing:",a);P(b,!0)})}
...
function kg(a,b,c){if(b.vd())a:{b=b.d;a=b.evaluate(a);switch(typeof a){case "number":c=jg[c]?a==Math.round(a)?new md(a):new ld(a):new J(a,"px");break a;case "string":c=a?ig(b.b,new Vb(a,null)):H;break a;case "boolean":c=a?ie:Dd;break a;case "undefined":c=H;break a}throw Error("E_UNEXPECTED");}else c=b;return c};function lg(){this.b={}}t(lg,ad);lg.prototype.ub=function(a){this.b[a.name]=!0;return a};lg.prototype.fb=function(a){this.vb(a.values);return a};function mg(a){this.value=a}t(mg,ad);mg.prototype.Pb=function(a){this.value=a.C;return a};function ng(a,b){if(a){var c=new mg(b);try{return a.U(c),c.value}catch(d){u.b(d,"toInt: ")}}return b}function og(){this.d=!1;this.b=[];this.name=null}t(og,ad);og.prototype.Rb=function(a){this.d&&this.b.push(a);return null};
og.prototype.Qb=function(a){this.d&&0==a.C&&this.b.push(new J(0,"px"));return null};og.prototype.fb=function(a){this.vb(a.values);return null};og.prototype.jb=function(a){this.d||(this.d=!0,this.vb(a.values),this.d=!1,this.name=a.name.toLowerCase());return null};
...
300)):a.src=b;return O(g)},"loadElement "+b);e.start();return e};function vg(a){this.e=this.f=null;this.d=0;this.b=a}function wg(a,b){this.b=-1;this.d=a;this.e=b}function xg(){this.b=[];this.d=[];this.match=[];this.e=[];this.error=[];this.f=!0}function yg(a,b,c){for(var d=0;d<b.length;d++)a.d[b[d]].b=c;b.splice(0,b.length)}
...
n.Ic=function(a){return this.b&64?a:null};n.ic=function(a){return this.b&128?a:null};n.fb=function(){return null};n.tb=function(){return null};n.jb=function(){return null};n.Ob=function(){return null};var Ag=new Cg(0,T,T);
...
n.Qb=function(a){return this.Ta(a)};n.Pb=function(a){return this.Ta(a)};n.Ic=function(a){return this.Ta(a)};n.ic=function(a){return this.Ta(a)};n.fb=function(){return null};n.tb=function(){return null};n.jb=function(a){return this.Ta(a)};n.Ob=function(){return null};function Hg(a){Fg.call(this,a)}t(Hg,Fg);Hg.prototype.fb=function(a){var b=Gg(this,a.values,!1,0);return b===a.values?a:b?new cd(b):null};
Hg.prototype.tb=function(a){for(var b=this.d,c=!1;b;){if(b.b instanceof Ig){c=!0;break}b=b.e}return c?(b=Gg(this,a.values,!1,0),b===a.values?a:b?new dd(b):null):null};Hg.prototype.f=function(a,b){return Gg(this,a,!0,b)};function Ig(a){Fg.call(this,a)}t(Ig,Fg);Ig.prototype.fb=function(a){return this.Ta(a)};Ig.prototype.tb=function(a){var b=Gg(this,a.values,!1,0);return b===a.values?a:b?new dd(b):null};Ig.prototype.f=function(a,b){for(var c=this.d,d;c!==this.e;){if(d=c.b.f(a,b))return d;c=c.e}return null};
...
function Pg(a,b){a.Fb([b]);return null}n.ld=function(a){return Pg(this,a)};n.hc=function(a){return Pg(this,a)};n.ub=function(a){return Pg(this,a)};n.Rb=function(a){return Pg(this,a)};n.Qb=function(a){return Pg(this,a)};n.Pb=function(a){return Pg(this,a)};n.Ic=function(a){return Pg(this,a)};n.ic=function(a){return Pg(this,a)};n.fb=function(a){this.Fb(a.values);return null};n.tb=function(){this.error=!0;return null};n.jb=function(a){return Pg(this,a)};n.Ob=function(){this.error=!0;return null};
...
function ah(a){a.b.HASHCOLOR=Zg(new Cg(64,T,T));a.b.POS_INT=Zg(new Cg(32,T,T));a.b.POS_NUM=Zg(new Cg(16,T,T));a.b.POS_PERCENTAGE=Zg(new Cg(8,T,{"%":H}));a.b.NEGATIVE=Zg(new Cg(256,T,T));a.b.ZERO=Zg(new Cg(512,T,T));a.b.ZERO_PERCENTAGE=Zg(new Cg(1024,T,T));a.b.POS_LENGTH=Zg(new Cg(8,T,{em:H,ex:H,ch:H,rem:H,vh:H,vw:H,vmin:H,vmax:H,cm:H,mm:H,"in":H,px:H,pt:H,pc:H,q:H}));a.b.POS_ANGLE=Zg(new Cg(8,T,{deg:H,grad:H,rad:H,turn:H}));a.b.POS_TIME=Zg(new Cg(8,T,{s:H,ms:H}));a.b.FREQUENCY=Zg(new Cg(8,T,{Hz:H,
kHz:H}));a.b.RESOLUTION=Zg(new Cg(8,T,{dpi:H,dpcm:H,dppx:H}));a.b.URI=Zg(new Cg(128,T,T));a.b.IDENT=Zg(new Cg(4,T,T));a.b.STRING=Zg(new Cg(2,T,T));var b={"font-family":I("sans-serif")};a.d.caption=b;a.d.icon=b;a.d.menu=b;a.d["message-box"]=b;a.d["small-caption"]=b;a.d["status-bar"]=b}function bh(a){return!!a.match(/^[A-Z_0-9]+$/)}
...
d.push(p.clone())}else p={},p[g.text]=I(g.text),d.push(Zg(new Cg(0,p,T)));h=!1;break;case 5:p={};p[""+g.C]=new md(g.C);d.push(Zg(new Cg(0,p,T)));h=!1;break;case 34:k("|");break;case 25:k("||");break;case 14:h||k(" ");e.push({Dd:d,zd:f,Sb:"["});f="";d=[];h=!0;break;case 6:h||k(" ");e.push({Dd:d,zd:f,Sb:"(",Ib:g.text});f="";d=[];h=!0;break;case 15:g=l();p=e.pop();if("["!=p.Sb)throw Error("']' unexpected");d=p.Dd;d.push(g);f=p.zd;h=!1;break;case 11:g=l();p=e.pop();if("("!=p.Sb)throw Error("')' unexpected");
...
function fh(a,b,c,d,e){var f="",g=b;b=b.toLowerCase();var h=b.match(/^-([a-z]+)-([-a-z0-9]+)$/);h&&(f=h[1],b=h[2]);if((h=a.k[b])&&h[f])if(f=a.e[b])(a=c===Id||c.vd()?c:c.U(f))?e.cb(b,a,d):e.Wb(g,c);else if(b=a.f[b].clone(),c===Id)for(c=0;c<b.b.length;c++)e.cb(b.b[c],Id,d);else{c.U(b);if(b.error)d=!1;else{for(a=0;a<b.b.length;a++)f=b.b[a],e.cb(f,b.values[f]||b.d.h[f],d);d=!0}d||e.Wb(g,c)}else e.Hc(g,c)}
...
mh(l,f,c);u.e("Starting to load font:",f);var q=!1;nf(function(){var a=k.getBoundingClientRect(),b=a.bottom-a.top;if(r!=a.right-a.left||v!=b)return q=!0,N(!1);(new Date).valueOf()>m?a=N(!1):(a=L("Frame.sleep"),gf(a).Va(!0,10),a=O(a));return a}).then(function(){q?u.e("Loaded font:",f):u.b("Failed to load font:",f);a.b.removeChild(k);P(e,l)});return O(e)}
function sh(a,b,c){var d=b.src,e=a.e[d];e?sg(e,function(a){if(a.d==b.d){var e=b.b,h=c.b[e];a=a.b;if(h){if(h!=a)throw Error("E_FONT_FAMILY_INCONSISTENT "+b.b);}else c.b[e]=a;u.b("Found already-loaded font:",d)}else u.b("E_FONT_FACE_INCOMPATIBLE",b.src)}):(e=new xf(function(){var e=L("loadFont"),g=c.d?c.d(d):null;g?rf(d,"blob").then(function(d){d.wc?g(d.wc).then(function(d){rh(a,b,d,c).ua(e)}):P(e,null)}):rh(a,b,null,c).ua(e);return O(e)},"loadFont "+d),a.e[d]=e,e.start());return e}
...
function Gh(a,b){var c=a.responseXML;if(!c){var d=new DOMParser,e=a.responseText;if(e){var f=Fh(a);(c=Eh(e,f||"application/xml",d))&&!f&&(f=c.documentElement,"html"!==f.localName.toLowerCase()||f.namespaceURI?"svg"===f.localName.toLowerCase()&&"image/svg+xml"!==c.contentType&&(c=Eh(e,"image/svg+xml",d)):c=Eh(e,"text/html",d));c||(c=Eh(e,"text/html",d))}}c=c?new uh(b,a.url,c):null;return N(c)}function Hh(a){this.Ib=a}
...
function Wh(a,b){this.f={};this.N=a;this.d=b;this.w=null;this.h=[];var c=this;this.D=function(a){var b=a.currentTarget,f=b.getAttribute("href")||b.getAttributeNS("http://www.w3.org/1999/xlink","href");f&&(a.preventDefault(),$a(c,{type:"hyperlink",target:null,currentTarget:null,Be:b,href:f}))};this.b={};this.e={width:0,height:0};this.k=this.l=!1;this.F=0;this.position=null;this.offset=-1;this.j=null;this.g=[];this.u={top:{},bottom:{},left:{},right:{}}}t(Wh,Za);
...
function mi(a){a.e=!0;a.j=a.parent?a.parent.j:0;a.A=null;a.u=null;a.da=0;a.J=!1;a.display=null;a.k=null;a.l=null;a.B=!1;a.w=a.parent?a.parent.w:0;a.h=null;a.D=null;a.sa=null;a.I=!1;a.H=!1;a.b=a.parent?a.parent.b:!1;a.sa=null}function ni(a){var b=new li(a.Z,a.parent,a.ia);b.da=a.da;b.J=a.J;b.sa=a.sa;b.Ha=a.Ha;b.ea=a.ea;b.qa=a.qa;b.e=a.e;b.j=a.j;b.display=a.display;b.k=a.k;b.l=a.l;b.I=a.I;b.H=a.H;b.B=a.B;b.w=a.w;b.h=a.h;b.D=a.D;b.A=a.A;b.u=a.u;b.f=a.f;b.b=a.b;b.d=a.d;return b}
li.prototype.modify=function(){return this.S?ni(this):this};function oi(a){var b=a;do{if(b.S)break;b.S=!0;b=b.parent}while(b);return a}li.prototype.clone=function(){for(var a=ni(this),b=a,c;null!=(c=b.parent);)c=ni(c),b=b.parent=c;return a};function pi(a){return{fa:a.Z,Ha:a.Ha,ea:a.ea,sa:a.sa,qa:a.qa?pi(a.qa):null}}function qi(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(pi(b)),b=b.parent;while(b);return{ga:c,da:a.da,J:a.J}}
function ri(a){for(a=a.parent;a;){if(a.I)return!0;a=a.parent}return!1}function si(a){for(a=a.parent;a;){if(a.H)return a;a=a.parent}return null}function ti(a,b){for(var c=a;c;){c.e||b(c);if(c.I)break;c=c.parent}}function ui(a){this.Na=a;this.b=this.d=null}ui.prototype.clone=function(){var a=new ui(this.Na);if(this.d){a.d=[];for(var b=0;b<this.d.length;++b)a.d[b]=this.d[b]}if(this.b)for(a.b=[],b=0;b<this.b.length;++b)a.b[b]=this.b[b];return a};
...
function Bi(a){this.d=a;this.H=this.D=this.height=this.width=this.u=this.k=this.w=this.j=this.Sa=this.ba=this.Ya=this.S=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.xb=this.I=null;this.oa=this.Eb=this.$a=this.kc=this.e=0;this.b=!1}function Ci(a){return a.marginTop+a.ba+a.k}function Di(a){return a.marginBottom+a.Sa+a.u}function Ei(a){return a.marginLeft+a.S+a.j}function Fi(a){return a.marginRight+a.Ya+a.w}
function Gi(a,b){a.d=b.d;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.S=b.S;a.Ya=b.Ya;a.ba=b.ba;a.Sa=b.Sa;a.j=b.j;a.w=b.w;a.k=b.k;a.u=b.u;a.width=b.width;a.height=b.height;a.D=b.D;a.H=b.H;a.xb=b.xb;a.I=b.I;a.e=b.e;a.kc=b.kc;a.$a=b.$a;a.b=b.b}function Hi(a,b,c){a.top=b;a.height=c;x(a.d,"top",b+"px");x(a.d,"height",c+"px")}function Ii(a,b,c){a.left=b;a.width=c;x(a.d,"left",b+"px");x(a.d,"width",c+"px")}
function Ji(a,b){this.b=a;this.d=b}t(Ji,ad);Ji.prototype.hc=function(a){this.b.appendChild(this.b.ownerDocument.createTextNode(a.b));return null};Ji.prototype.ic=function(a){var b=this.b.ownerDocument.createElementNS("http://www.w3.org/1999/xhtml","img");b.setAttribute("src",a.url);this.b.appendChild(b);return null};Ji.prototype.fb=function(a){this.vb(a.values);return null};
Ji.prototype.Ob=function(a){a=a.ja().evaluate(this.d);"string"===typeof a&&this.b.appendChild(this.b.ownerDocument.createTextNode(a));return null};function Ki(a){return null!=a&&a!==Sd&&a!==Rd&&a!==Id};function Li(a){a=a.toString();switch(a){case "inline-flex":a="flex";break;case "inline-grid":a="grid";break;case "inline-table":a="table";break;case "inline":case "table-row-group":case "table-column":case "table-column-group":case "table-header-group":case "table-footer-group":case "table-row":case "table-cell":case "table-caption":case "inline-block":a="block";break}return I(a)}
function Mi(a,b,c,d){if(a!==Rd)if(b===rd||b===Ed)c=Rd,a=Li(a);else if(c&&c!==Rd||d)a=Li(a);return{display:a,position:b,b:c}}function Ni(a,b,c,d,e,f){e=e||f||Hd;return!!c&&c!==Rd||b===rd||b===Ed||a===Kd||a===be||a===ae||(a===vd||a===Pd)&&!!d&&d!==he||!!f&&e!==f};function Oi(a,b,c){b=b?"vertical-rl":"horizontal-tb";if("top"===a||"bottom"===a)a=ea(a,b,c||null,ia);"block-start"===a&&(a="inline-start");"block-end"===a&&(a="inline-end");if("inline-start"===a||"inline-end"===a){c=ea(a,b,c||null,ha);a:{var d=ja[b];if(!d)throw Error("unknown writing-mode: "+b);for(b=0;b<d.length;b++)if(d[b].L===c){b=d[b].K;break a}b=c}"line-left"===b?a="left":"line-right"===b&&(a="right")}"left"!==a&&"right"!==a&&(u.b("Invalid float value: "+a+". Fallback to left."),a="left");return a}
function Pi(a,b){this.d=oi(a);this.b=b}function Qi(a,b,c){this.e=a;this.g=b;this.f=c;this.d=[];this.b=[]}
function Ri(a,b,c){b.parentNode&&b.parentNode.removeChild(b);x(b,"float","none");x(b,"position","absolute");var d=a.g.toString(),e=a.f.toString(),f=ea(c,d,e||null,ha),g=ea(c,d,e||null,ia);x(b,f,"0");switch(g){case "inline-start":case "inline-end":d=ea("block-start",d,e||null,ha);x(b,d,"0");break;case "block-start":case "block-end":c=ea("inline-start",d,e||null,ha);x(b,c,"0");d=ea("max-inline-size",d,e||null,ha);Ia(b,d)||x(b,d,"100%");break;default:throw Error("unknown float direction: "+c);}a.e().appendChild(b)}
function Si(a,b,c){b=qi(b);for(var d=0;d<a.d.length;d++){var e=a.d[d];if(Ti(c,b,qi(e.d)))return e}return null}function Ui(a,b,c){var d=L("tryToAddFloat");b=new Pi(b,c);a.d.push(b);a.b.push(b);P(d,b);return O(d)}function Vi(a){return a.b.map(function(a){a=a.b;return new ve([new qe(a.aa,a.W),new qe(a.V,a.W),new qe(a.V,a.R),new qe(a.aa,a.R)])})};var Wi={SIMPLE_PROPERTY:"SIMPLE_PROPERTY"},Xi={};function Yi(a,b){if(Wi[a]){var c=Xi[a];c||(c=Xi[a]=[]);c.push(b)}else u.b(Error("Skipping unknown plugin hook '"+a+"'."))}ca("vivliostyle.plugin.registerHook",Yi);ca("vivliostyle.plugin.removeHook",function(a,b){if(Wi[a]){var c=Xi[a];if(c){var d=c.indexOf(b);0<=d&&c.splice(d,1)}}else u.b(Error("Ignoring unknown plugin hook '"+a+"'."))});for(var Zi={azimuth:!0,"border-collapse":!0,"border-spacing":!0,"caption-side":!0,color:!0,cursor:!0,direction:!0,elevation:!0,"empty-cells":!0,"font-kerning":!0,"font-size":!0,"font-family":!0,"font-feature-settings":!0,"font-style":!0,"font-variant":!0,"font-weight":!0,"letter-spacing":!0,"line-break":!0,"line-height":!0,"list-style-image":!0,"list-style-position":!0,"list-style-type":!0,orphans:!0,"overflow-wrap":!0,"pitch-range":!0,quotes:!0,richness:!0,"ruby-align":!0,"ruby-position":!0,"speak-header":!0,
"speak-numeral":!0,"speak-punctuation":!0,"speech-rate":!0,stress:!0,"tab-size":!0,"text-align":!0,"text-align-last":!0,"text-decoration-skip":!0,"text-emphasis-color":!0,"text-emphasis-position":!0,"text-emphasis-style":!0,"text-combine-upright":!0,"text-indent":!0,"text-justify":!0,"text-size-adjust":!0,"text-transform":!0,"text-underline-position":!0,visibility:!0,"voice-family":!0,volume:!0,"white-space":!0,widows:!0,"word-break":!0,"word-spacing":!0,"word-wrap":!0,"writing-mode":!0},$i={"http://www.idpf.org/2007/ops":!0,
"http://www.w3.org/1999/xhtml":!0,"http://www.w3.org/2000/svg":!0},aj="margin-% padding-% border-%-width border-%-style border-%-color %".split(" "),bj=["left","right","top","bottom"],cj={width:!0,height:!0},dj=0;dj<aj.length;dj++)for(var ej=0;ej<bj.length;ej++){var fj=aj[dj].replace("%",bj[ej]);cj[fj]=!0}function gj(a){for(var b={},c=0;c<aj.length;c++)for(var d in a){var e=aj[c].replace("%",d),f=aj[c].replace("%",a[d]);b[e]=f;b[f]=e}return b}
var hj=gj({before:"right",after:"left",start:"top",end:"bottom"}),ij=gj({before:"top",after:"bottom",start:"left",end:"right"});function V(a,b){this.value=a;this.Ga=b}n=V.prototype;n.Hd=function(){return this};n.rc=function(a){a=this.value.U(a);return a===this.value?this:new V(a,this.Ga)};n.Id=function(a){return 0==a?this:new V(this.value,this.Ga+a)};n.evaluate=function(a,b){return kg(a,this.value,b)};n.Ed=function(){return!0};function jj(a,b,c){V.call(this,a,b);this.M=c}t(jj,V);
jj.prototype.Hd=function(){return new V(this.value,this.Ga)};jj.prototype.rc=function(a){a=this.value.U(a);return a===this.value?this:new jj(a,this.Ga,this.M)};jj.prototype.Id=function(a){return 0==a?this:new jj(this.value,this.Ga+a,this.M)};jj.prototype.Ed=function(a){return!!this.M.evaluate(a)};function kj(a,b,c){return(null==b||c.Ga>b.Ga)&&c.Ed(a)?c.Hd():b}var lj={"region-id":!0};function mj(a){return"_"!=a.charAt(0)&&!lj[a]}function nj(a,b,c){c?a[b]=c:delete a[b]}
function oj(a,b){var c=a[b];c||(c={},a[b]=c);return c}function pj(a,b){var c=a[b];c||(c=[],a[b]=c);return c}function qj(a,b,c,d,e,f){if(e){var g=oj(b,"_pseudos");b=g[e];b||(b={},g[e]=b)}f&&(e=oj(b,"_regions"),b=e[f],b||(b={},e[f]=b));for(var h in c)"_"!=h.charAt(0)&&(lj[h]?(f=c[h],e=pj(b,h),Array.prototype.push.apply(e,f)):nj(b,h,kj(a,b[h],c[h].Id(d))))}
function rj(a,b){if(0<a.length){a.sort(function(a,b){return b.d()-a.d()});for(var c=null,d=a.length-1;0<=d;d--)c=a[d],c.b=b,b=c;return c}return b}function sj(a,b){this.e=a;this.d=b;this.b=""}t(sj,bd);function tj(a){a=a.e["font-size"].value;var b;a:switch(a.ha.toLowerCase()){case "px":case "in":case "pt":case "pc":case "cm":case "mm":case "q":b=!0;break a;default:b=!1}if(!b)throw Error("Unexpected state");return a.C*lc[a.ha]}
sj.prototype.Rb=function(a){if("em"==a.ha||"ex"==a.ha){var b=pc(this.d,a.ha,!1)/pc(this.d,"em",!1);return new J(a.C*b*tj(this),"px")}if("%"==a.ha){if("font-size"===this.b)return new J(a.C/100*tj(this),"px");b=this.b.match(/height|^(top|bottom)$/)?"vh":"vw";return new J(a.C,b)}return a};sj.prototype.Ob=function(a){return"font-size"==this.b?kg(this.d,a,this.b).U(this):a};function uj(){}uj.prototype.apply=function(){};uj.prototype.h=function(a){return new vj([this,a])};uj.prototype.clone=function(){return this};
function wj(a){this.b=a}t(wj,uj);wj.prototype.apply=function(a){a.f[a.f.length-1].push(this.b.b())};function vj(a){this.b=a}t(vj,uj);vj.prototype.apply=function(a){for(var b=0;b<this.b.length;b++)this.b[b].apply(a)};vj.prototype.h=function(a){this.b.push(a);return this};vj.prototype.clone=function(){return new vj([].concat(this.b))};function xj(a,b,c,d){this.style=a;this.P=b;this.b=c;this.f=d}t(xj,uj);xj.prototype.apply=function(a){qj(a.g,a.u,this.style,this.P,this.b,this.f)};
function W(){this.b=null}t(W,uj);W.prototype.apply=function(a){this.b.apply(a)};W.prototype.d=function(){return 0};W.prototype.e=function(){return!1};function yj(a){this.b=null;this.f=a}t(yj,W);yj.prototype.apply=function(a){0<=a.w.indexOf(this.f)&&this.b.apply(a)};yj.prototype.d=function(){return 10};yj.prototype.e=function(a){this.b&&zj(a.Ba,this.f,this.b);return!0};function Aj(a){this.b=null;this.id=a}t(Aj,W);Aj.prototype.apply=function(a){a.O!=this.id&&a.ba!=this.id||this.b.apply(a)};
Aj.prototype.d=function(){return 11};Aj.prototype.e=function(a){this.b&&zj(a.e,this.id,this.b);return!0};function Bj(a){this.b=null;this.localName=a}t(Bj,W);Bj.prototype.apply=function(a){a.d==this.localName&&this.b.apply(a)};Bj.prototype.d=function(){return 8};Bj.prototype.e=function(a){this.b&&zj(a.gc,this.localName,this.b);return!0};function Cj(a,b){this.b=null;this.f=a;this.localName=b}t(Cj,W);Cj.prototype.apply=function(a){a.d==this.localName&&a.e==this.f&&this.b.apply(a)};Cj.prototype.d=function(){return 8};
Cj.prototype.e=function(a){if(this.b){var b=a.b[this.f];b||(b="ns"+a.g++ +":",a.b[this.f]=b);zj(a.f,b+this.localName,this.b)}return!0};function Dj(a){this.b=null;this.f=a}t(Dj,W);Dj.prototype.apply=function(a){var b=a.b;if(b&&"a"==a.d){var c=b.getAttribute("href");c&&c.match(/^#/)&&(b=b.ownerDocument.getElementById(c.substring(1)))&&(b=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))&&b.match(this.f)&&this.b.apply(a)}};function Ej(a){this.b=null;this.f=a}t(Ej,W);
Ej.prototype.apply=function(a){a.e==this.f&&this.b.apply(a)};function Fj(a,b){this.b=null;this.f=a;this.name=b}t(Fj,W);Fj.prototype.apply=function(a){a.b&&a.b.hasAttributeNS(this.f,this.name)&&this.b.apply(a)};function Gj(a,b,c){this.b=null;this.f=a;this.name=b;this.value=c}t(Gj,W);Gj.prototype.apply=function(a){a.b&&a.b.getAttributeNS(this.f,this.name)==this.value&&this.b.apply(a)};Gj.prototype.d=function(){return"type"==this.name&&"http://www.idpf.org/2007/ops"==this.f?9:0};
Gj.prototype.e=function(a){return"type"==this.name&&"http://www.idpf.org/2007/ops"==this.f?(this.b&&zj(a.d,this.value,this.b),!0):!1};function Hj(a,b){this.b=null;this.f=a;this.name=b}t(Hj,W);Hj.prototype.apply=function(a){if(a.b){var b=a.b.getAttributeNS(this.f,this.name);b&&$i[b]&&this.b.apply(a)}};Hj.prototype.d=function(){return 0};Hj.prototype.e=function(){return!1};function Ij(a,b,c){this.b=null;this.g=a;this.name=b;this.f=c}t(Ij,W);
Ij.prototype.apply=function(a){if(a.b){var b=a.b.getAttributeNS(this.g,this.name);b&&b.match(this.f)&&this.b.apply(a)}};function Jj(a){this.b=null;this.f=a}t(Jj,W);Jj.prototype.apply=function(a){a.lang.match(this.f)&&this.b.apply(a)};function Kj(){this.b=null}t(Kj,W);Kj.prototype.apply=function(a){a.Sa&&this.b.apply(a)};Kj.prototype.d=function(){return 6};function Lj(){this.b=null}t(Lj,W);Lj.prototype.apply=function(a){a.ma&&this.b.apply(a)};Lj.prototype.d=function(){return 12};
function Mj(a,b){this.b=null;this.f=a;this.Sb=b}t(Mj,W);function Nj(a,b){var c=a.f;b-=a.Sb;return 0===c?0===b:0===b%c&&0<=b/c}function Oj(a,b){Mj.call(this,a,b)}t(Oj,Mj);Oj.prototype.apply=function(a){Nj(this,a.za)&&this.b.apply(a)};Oj.prototype.d=function(){return 5};function Pj(a,b){Mj.call(this,a,b)}t(Pj,Mj);Pj.prototype.apply=function(a){Nj(this,a.$a[a.e][a.d])&&this.b.apply(a)};Pj.prototype.d=function(){return 5};function Qj(a,b){Mj.call(this,a,b)}t(Qj,Mj);
Qj.prototype.apply=function(a){var b=a.I;null===b&&(b=a.I=a.b.parentNode.childElementCount-a.za+1);Nj(this,b)&&this.b.apply(a)};Qj.prototype.d=function(){return 4};function Rj(a,b){Mj.call(this,a,b)}t(Rj,Mj);Rj.prototype.apply=function(a){var b=a.Za;if(!b[a.e]){var c=a.b;do{var d=c.namespaceURI,e=c.localName,f=b[d];f||(f=b[d]={});f[e]=(f[e]||0)+1}while(c=c.nextElementSibling)}Nj(this,b[a.e][a.d])&&this.b.apply(a)};Rj.prototype.d=function(){return 4};function Sj(){this.b=null}t(Sj,W);
Sj.prototype.apply=function(a){for(var b=a.b.firstChild;b;){switch(b.nodeType){case Node.ELEMENT_NODE:return;case Node.TEXT_NODE:if(0<b.length)return}b=b.nextSibling}this.b.apply(a)};Sj.prototype.d=function(){return 4};function Tj(){this.b=null}t(Tj,W);Tj.prototype.apply=function(a){!1===a.b.disabled&&this.b.apply(a)};Tj.prototype.d=function(){return 5};function Uj(){this.b=null}t(Uj,W);Uj.prototype.apply=function(a){!0===a.b.disabled&&this.b.apply(a)};Uj.prototype.d=function(){return 5};
function Vj(){this.b=null}t(Vj,W);Vj.prototype.apply=function(a){var b=a.b;!0!==b.selected&&!0!==b.checked||this.b.apply(a)};Vj.prototype.d=function(){return 5};function Wj(a){this.b=null;this.M=a}t(Wj,W);Wj.prototype.apply=function(a){a.j[this.M]&&this.b.apply(a)};Wj.prototype.d=function(){return 5};function Xj(){this.b=!1}t(Xj,uj);Xj.prototype.apply=function(){this.b=!0};Xj.prototype.clone=function(){var a=new Xj;a.b=this.b;return a};
function Yj(a){this.b=null;this.f=new Xj;this.g=rj(a,this.f)}t(Yj,W);Yj.prototype.apply=function(a){this.g.apply(a);this.f.b||this.b.apply(a);this.f.b=!1};Yj.prototype.d=function(){return this.g.d()};function Zj(a){this.M=a}Zj.prototype.b=function(){return this};Zj.prototype.push=function(a,b){0==b&&ak(a,this.M);return!1};Zj.prototype.pop=function(a,b){return 0==b?(a.j[this.M]--,!0):!1};function bk(a){this.M=a}bk.prototype.b=function(){return this};
...
dk.prototype.push=function(a,b){this.d&&(-1==b?ak(a,this.M):0==b&&a.j[this.M]--);return!1};dk.prototype.pop=function(a,b){if(this.d){if(-1==b)return a.j[this.M]--,!0;0==b&&ak(a,this.M)}else 0==b&&(this.d=!0,ak(a,this.M));return!1};function ek(a){this.d=a}ek.prototype.b=function(){return this};ek.prototype.push=function(){return!1};ek.prototype.pop=function(a,b){return 0==b?(fk(a,this.d),!0):!1};function gk(a){this.lang=a}gk.prototype.b=function(){return this};gk.prototype.push=function(){return!1};
gk.prototype.pop=function(a,b){return 0==b?(a.lang=this.lang,!0):!1};function hk(a){this.d=a}hk.prototype.b=function(){return this};hk.prototype.push=function(){return!1};hk.prototype.pop=function(a,b){return 0==b?(a.D=this.d,!0):!1};function ik(a){this.b=a}t(ik,bd);function jk(a,b){switch(b){case "url":return a?new od(a):new od("about:invalid");default:return a?new jd(a):new jd("")}}
ik.prototype.jb=function(a){if("attr"!==a.name)return bd.prototype.jb.call(this,a);var b="string",c=null,d=null;a.values[0]instanceof cd?(2<=a.values[0].values.length&&(b=a.values[0].values[1].stringValue()),c=a.values[0].values[0].stringValue()):c=a.values[0].stringValue();d=1<a.values.length?jk(a.values[1].stringValue(),b):jk(null,b);return this.b&&this.b.hasAttribute(c)?jk(this.b.getAttribute(c),b):d};function kk(a,b,c){this.d=a;this.b=c}t(kk,bd);
kk.prototype.ub=function(a){var b=this.d,c=b.D,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.l)];b.l++;break;case "close-quote":return 0<b.l&&b.l--,c[2*Math.min(d,b.l)+1];case "no-open-quote":return b.l++,new jd("");case "no-close-quote":return 0<b.l&&b.l--,new jd("")}return a};
...
nk={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},ok={De:!1,Tb:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",uc:"\u5341\u767e\u5343",ae:"\u8ca0"};
function pk(a){if(9999<a||-9999>a)return""+a;if(0==a)return ok.Tb.charAt(0);var b=new Ja;0>a&&(b.append(ok.ae),a=-a);if(10>a)b.append(ok.Tb.charAt(a));else if(ok.Ee&&19>=a)b.append(ok.uc.charAt(0)),0!=a&&b.append(ok.uc.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(ok.Tb.charAt(c)),b.append(ok.uc.charAt(2)));if(c=Math.floor(a/100)%10)b.append(ok.Tb.charAt(c)),b.append(ok.uc.charAt(1));if(c=Math.floor(a/10)%10)b.append(ok.Tb.charAt(c)),b.append(ok.uc.charAt(0));(a%=10)&&b.append(ok.Tb.charAt(a))}return b.toString()}
...
function rk(a,b){var c=b[0].toString(),d=1<b.length?b[1].stringValue():"decimal",e=a.d.h[c];if(e&&e.length)return new jd(qk(e&&e.length&&e[e.length-1]||0,d));c=new K(sk(a.b,c,function(a){return qk(a||0,d)}));return new cd([c])}
function tk(a,b){var c=b[0].toString(),d=b[1].stringValue(),e=2<b.length?b[2].stringValue():"decimal",f=a.d.h[c],g=new Ja;if(f&&f.length)for(var h=0;h<f.length;h++)0<h&&g.append(d),g.append(qk(f[h],e));c=new K(uk(a.b,c,function(a){var b=[];if(a.length)for(var c=0;c<a.length;c++)b.push(qk(a[c],e));a=g.toString();a.length&&b.push(a);return b.length?b.join(d):qk(0,e)}));return new cd([c])}
...
kk.prototype.jb=function(a){switch(a.name){case "counter":if(2>=a.values.length)return rk(this,a.values);break;case "counters":if(3>=a.values.length)return tk(this,a.values);break;case "target-counter":if(3>=a.values.length)return vk(this,a.values);break;case "target-counters":if(4>=a.values.length)return xk(this,a.values)}u.b("E_CSS_CONTENT_PROP:",a.toString());return new jd("")};var zk=1/1048576;function Ak(a,b){for(var c in a)b[c]=a[c].clone()}
function Bk(){this.g=0;this.b={};this.gc={};this.f={};this.d={};this.Ba={};this.e={};this.Yb={};this.Q=0}Bk.prototype.clone=function(){var a=new Bk;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b];Ak(this.gc,a.gc);Ak(this.f,a.f);Ak(this.d,a.d);Ak(this.Ba,a.Ba);Ak(this.e,a.e);Ak(this.Yb,a.Yb);a.Q=this.Q;return a};function zj(a,b,c){var d=a[b];d&&(c=d.h(c));a[b]=c}
function Ck(a,b,c,d){this.k=a;this.g=b;this.Eb=c;this.Ya=d;this.f=[[],[]];this.j={};this.w=this.u=this.b=null;this.oa=this.ba=this.O=this.e=this.d="";this.S=this.H=null;this.ma=this.Sa=!0;this.h={};this.B=[{}];this.D=[new jd("\u201c"),new jd("\u201d"),new jd("\u2018"),new jd("\u2019")];this.l=0;this.lang="";this.yb=[0];this.za=0;this.ka=[{}];this.$a=this.ka[0];this.I=null;this.wb=[this.I];this.xb=[{}];this.Za=this.ka[0];this.gb=[]}function ak(a,b){a.j[b]=(a.j[b]||0)+1}
function Dk(a,b,c){(b=b[c])&&b.apply(a)}var Ek=[];function Fk(a,b,c,d){a.b=null;a.u=d;a.e="";a.d="";a.O="";a.ba="";a.w=b;a.oa="";a.H=Ek;a.S=c;Gk(a)}function Hk(a,b,c){a.h[b]?a.h[b].push(c):a.h[b]=[c];c=a.B[a.B.length-1];c||(c={},a.B[a.B.length-1]=c);c[b]=!0}
function Ik(a,b){var c=Jd,d=b.display;d&&(c=d.evaluate(a.g));var e=null,d=null,f=b["counter-reset"];f&&(f=f.evaluate(a.g))&&(e=rg(f,!0));(f=b["counter-increment"])&&(f=f.evaluate(a.g))&&(d=rg(f,!1));"ol"!=a.d&&"ul"!=a.d||"http://www.w3.org/1999/xhtml"!=a.e||(e||(e={}),e["ua-list-item"]=0);c===Pd&&(d||(d={}),d["ua-list-item"]=1);if(e)for(var g in e)Hk(a,g,e[g]);if(d)for(var h in d)a.h[h]||Hk(a,h,0),g=a.h[h],g[g.length-1]+=d[h];c===Pd&&(c=a.h["ua-list-item"],b["ua-list-item-count"]=new V(new ld(c[c.length-
1]),0));a.B.push(null)}function Jk(a){var b=a.B.pop();if(b)for(var c in b)(b=a.h[c])&&(1==b.length?delete a.h[c]:b.pop())}function fk(a,b){Ik(a,b);b.content&&(b.content=b.content.rc(new kk(a,0,a.Ya)));Jk(a)}var Kk="before transclusion-before footnote-call footnote-marker inner first-letter first-line  transclusion-after after".split(" ");
function Lk(a,b,c){a.gb.push(b);a.S=null;a.b=b;a.u=c;a.e=b.namespaceURI;a.d=b.localName;var d=a.k.b[a.e];a.oa=d?d+a.d:"";a.O=b.getAttribute("id");a.ba=b.getAttributeNS("http://www.w3.org/XML/1998/namespace","id");(d=b.getAttribute("class"))?a.w=d.split(/\s+/):a.w=Ek;(d=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))?a.H=d.split(/\s+/):a.H=Ek;"style"==a.d&&"http://www.gribuser.ru/xml/fictionbook/2.0"==a.e&&(a.w=[b.getAttribute("name")||""]);(d=b.getAttributeNS("http://www.w3.org/XML/1998/namespace",
"lang"))||"http://www.w3.org/1999/xhtml"!=a.e||(d=b.getAttribute("lang"));d&&(a.f[a.f.length-1].push(new gk(a.lang)),a.lang=d.toLowerCase());var d=a.ma,e=a.yb;a.za=++e[e.length-1];e.push(0);var e=a.ka,f=a.$a=e[e.length-1],g=f[a.e];g||(g=f[a.e]={});g[a.d]=(g[a.d]||0)+1;e.push({});e=a.wb;null!==e[e.length-1]?a.I=--e[e.length-1]:a.I=null;e.push(null);e=a.xb;(f=a.Za=e[e.length-1])&&f[a.e]&&f[a.e][a.d]--;e.push({});Gk(a);Mk(a,b);c=c.quotes;b=null;c&&(c=c.evaluate(a.g))&&(b=new hk(a.D),c===Rd?a.D=[new jd(""),
new jd("")]:c instanceof cd&&(a.D=c.values));Ik(a,a.u);c=a.O||a.ba||"";if(d||c){var h={};Object.keys(a.h).forEach(function(a){h[a]=Array.b(this.h[a])},a);Nk(a.Eb,c,h)}if(c=a.u._pseudos)for(d=!0,e=0;e<Kk.length;e++)(f=Kk[e])||(d=!1),(f=c[f])&&(d?fk(a,f):a.f[a.f.length-2].push(new ek(f)));b&&a.f[a.f.length-2].push(b)}function Ok(a,b){for(var c in b)mj(c)&&(b[c]=b[c].rc(a))}function Mk(a,b){var c=new ik(b),d=a.u,e=d._pseudos,f;for(f in e)Ok(c,e[f]);Ok(c,d)}
function Gk(a){var b;for(b=0;b<a.w.length;b++)Dk(a,a.k.Ba,a.w[b]);for(b=0;b<a.H.length;b++)Dk(a,a.k.d,a.H[b]);Dk(a,a.k.e,a.O);Dk(a,a.k.gc,a.d);""!=a.d&&Dk(a,a.k.gc,"*");Dk(a,a.k.f,a.oa);null!==a.S&&(Dk(a,a.k.Yb,a.S),Dk(a,a.k.Yb,"*"));a.b=null;a.f.push([]);for(var c=1;-1<=c;--c){var d=a.f[a.f.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.Sa=!0;a.ma=!1}
Ck.prototype.pop=function(){for(var a=1;-1<=a;--a)for(var b=this.f[this.f.length-a-2],c=0;c<b.length;)b[c].pop(this,a)?b.splice(c,1):c++;this.f.pop();this.Sa=!1};var Pk=null;function Qk(a,b,c,d,e,f,g){Ff.call(this,a,b,g);this.b=null;this.P=0;this.f=this.h=null;this.l=!1;this.M=c;this.g=d?d.g:Pk?Pk.clone():new Bk;this.w=e;this.k=f;this.j=0}t(Qk,Gf);Qk.prototype.Jd=function(a){zj(this.g.gc,"*",a)};function Rk(a,b){var c=rj(a.b,b);c!==b&&c.e(a.g)||a.Jd(c)}
Qk.prototype.hb=function(a,b){if(b||a)this.P+=1,b&&a?this.b.push(new Cj(a,b.toLowerCase())):b?this.b.push(new Bj(b.toLowerCase())):this.b.push(new Ej(a))};Qk.prototype.Pc=function(a){this.f?(u.b("::"+this.f,"followed by ."+a),this.b.push(new Wj(""))):(this.P+=256,this.b.push(new yj(a)))};var Sk={"nth-child":Oj,"nth-of-type":Pj,"nth-last-child":Qj,"nth-last-of-type":Rj};
Qk.prototype.Zb=function(a,b){if(this.f)u.b("::"+this.f,"followed by :"+a),this.b.push(new Wj(""));else{switch(a.toLowerCase()){case "enabled":this.b.push(new Tj);break;case "disabled":this.b.push(new Uj);break;case "checked":this.b.push(new Vj);break;case "root":this.b.push(new Lj);break;case "link":this.b.push(new Bj("a"));this.b.push(new Fj("","href"));break;case "-adapt-href-epub-type":case "href-epub-type":if(b&&1==b.length&&"string"==typeof b[0]){var c=new RegExp("(^|s)"+xa(b[0])+"($|s)");this.b.push(new Dj(c))}else this.b.push(new Wj(""));
break;case "-adapt-footnote-content":case "footnote-content":this.l=!0;break;case "visited":case "active":case "hover":case "focus":this.b.push(new Wj(""));break;case "lang":b&&1==b.length&&"string"==typeof b[0]?this.b.push(new Jj(new RegExp("^"+xa(b[0].toLowerCase())+"($|-)"))):this.b.push(new Wj(""));break;case "nth-child":case "nth-last-child":case "nth-of-type":case "nth-last-of-type":c=Sk[a.toLowerCase()];b&&2==b.length?this.b.push(new c(b[0],b[1])):this.b.push(new Wj(""));break;case "first-child":this.b.push(new Kj);
break;case "last-child":this.b.push(new Qj(0,1));break;case "first-of-type":this.b.push(new Pj(0,1));break;case "last-of-type":this.b.push(new Rj(0,1));break;case "only-child":this.b.push(new Kj);this.b.push(new Qj(0,1));break;case "only-of-type":this.b.push(new Pj(0,1));this.b.push(new Rj(0,1));break;case "empty":this.b.push(new Sj);break;case "before":case "after":case "first-line":case "first-letter":this.$b(a,b);return;default:u.b("unknown pseudo-class selector: "+a),this.b.push(new Wj(""))}this.P+=
256}};
Qk.prototype.$b=function(a,b){switch(a){case "before":case "after":case "first-line":case "first-letter":case "footnote-call":case "footnote-marker":case "inner":this.f?(u.b("Double pseudoelement ::"+this.f+"::"+a),this.b.push(new Wj(""))):this.f=a;break;case "first-n-lines":if(b&&1==b.length&&"number"==typeof b[0]){var c=Math.round(b[0]);if(0<c&&c==b[0]){this.f?(u.b("Double pseudoelement ::"+this.f+"::"+a),this.b.push(new Wj(""))):this.f="first-"+c+"-lines";break}}default:u.b("Unrecognized pseudoelement: ::"+a),
this.b.push(new Wj(""))}this.P+=1};Qk.prototype.Vc=function(a){this.P+=65536;this.b.push(new Aj(a))};
Qk.prototype.nc=function(a,b,c,d){this.P+=256;b=b.toLowerCase();d=d||"";var e;switch(c){case 0:e=new Fj(a,b);break;case 39:e=new Gj(a,b,d);break;case 45:!d||d.match(/\s/)?e=new Wj(""):e=new Ij(a,b,new RegExp("(^|\\s)"+xa(d)+"($|\\s)"));break;case 44:e=new Ij(a,b,new RegExp("^"+xa(d)+"($|-)"));break;case 43:d?e=new Ij(a,b,new RegExp("^"+xa(d))):e=new Wj("");break;case 42:d?e=new Ij(a,b,new RegExp(xa(d)+"$")):e=new Wj("");break;case 46:d?e=new Ij(a,b,new RegExp(xa(d))):e=new Wj("");break;case 50:"supported"==
d?e=new Hj(a,b):(u.b("Unsupported :: attr selector op:",d),e=new Wj(""));break;default:u.b("Unsupported attr selector:",c),e=new Wj("")}this.b.push(e)};var Tk=0;n=Qk.prototype;n.lb=function(){var a="d"+Tk++;Rk(this,new wj(new Zj(a)));this.b=[new Wj(a)]};n.Oc=function(){var a="c"+Tk++;Rk(this,new wj(new bk(a)));this.b=[new Wj(a)]};n.Nc=function(){var a="a"+Tk++;Rk(this,new wj(new ck(a)));this.b=[new Wj(a)]};n.Sc=function(){var a="f"+Tk++;Rk(this,new wj(new dk(a)));this.b=[new Wj(a)]};
n.Jb=function(){Uk(this);this.f=null;this.l=!1;this.P=0;this.b=[]};n.eb=function(){var a;0!=this.j?(If(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.j=1,this.h={},this.f=null,this.P=0,this.l=!1,this.b=[])};n.error=function(a,b){Gf.prototype.error.call(this,a,b);1==this.j&&(this.j=0)};n.Nb=function(a){Gf.prototype.Nb.call(this,a);this.j=0};n.ra=function(){Uk(this);Gf.prototype.ra.call(this);1==this.j&&(this.j=0)};n.mb=function(){Gf.prototype.mb.call(this)};
function Uk(a){if(a.b){var b=a.P,c;c=a.g;c=c.Q+=zk;Rk(a,a.Ld(b+c));a.b=null;a.f=null;a.l=!1;a.P=0}}n.Ld=function(a){var b=this.w;this.l&&(b=b?"xxx-bogus-xxx":"footnote");return new xj(this.h,a,this.f,b)};n.bb=function(a,b,c){fh(this.k,a,b,c,this)};n.Wb=function(a,b){Hf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};n.Hc=function(a,b){Hf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
n.cb=function(a,b,c){"display"!=a||b!==Ud&&b!==Td||(this.cb("flow-options",new cd([Cd,Zd]),c),this.cb("flow-into",b,c),b=vd);(Xi.SIMPLE_PROPERTY||[]).forEach(function(d){d=d({name:a,value:b,important:c});a=d.name;b=d.value;c=d.important});var d=c?Bf(this):Cf(this);nj(this.h,a,this.M?new jj(b,d,this.M):new V(b,d))};n.dc=function(a){switch(a){case "not":a=new Vk(this),a.eb(),Ef(this.$,a)}};function Vk(a){Qk.call(this,a.d,a.$,a.M,a,a.w,a.k,!1);this.parent=a;this.e=a.b}t(Vk,Qk);n=Vk.prototype;
n.dc=function(a){"not"==a&&If(this,"E_CSS_UNEXPECTED_NOT")};n.ra=function(){If(this,"E_CSS_UNEXPECTED_RULE_BODY")};n.Jb=function(){If(this,"E_CSS_UNEXPECTED_NEXT_SELECTOR")};n.oc=function(){this.b&&0<this.b.length&&this.e.push(new Yj(this.b));this.parent.P+=this.P;var a=this.$;a.b=a.e.pop()};n.error=function(a,b){Qk.prototype.error.call(this,a,b);var c=this.$;c.b=c.e.pop()};function Wk(a,b){Ff.call(this,a,b,!1)}t(Wk,Gf);
Wk.prototype.bb=function(a,b){if(this.d.values[a])this.error("E_CSS_NAME_REDEFINED "+a,this.Vb());else{var c=a.match(/height|^(top|bottom)$/)?"vh":"vw",c=new Qc(this.d,100,c),c=b.ja(this.d,c);this.d.values[a]=c}};function Xk(a,b,c,d,e){Ff.call(this,a,b,!1);this.b=d;this.M=c;this.e=e}t(Xk,Gf);Xk.prototype.bb=function(a,b,c){c?u.b("E_IMPORTANT_NOT_ALLOWED"):fh(this.e,a,b,c,this)};Xk.prototype.Wb=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};
Xk.prototype.Hc=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};Xk.prototype.cb=function(a,b,c){c=c?Bf(this):Cf(this);c+=this.Q;this.Q+=zk;nj(this.b,a,this.M?new jj(b,c,this.M):new V(b,c))};function Yk(a,b){dg.call(this,a);this.b={};this.e=b;this.Q=0}t(Yk,dg);Yk.prototype.bb=function(a,b,c){fh(this.e,a,b,c,this)};Yk.prototype.Wb=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};Yk.prototype.Hc=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};
Yk.prototype.cb=function(a,b,c){c=(c?67108864:50331648)+this.Q;this.Q+=zk;nj(this.b,a,new V(b,c))};function Zk(a,b,c){return(a=a["writing-mode"])&&(b=a.evaluate(b,"writing-mode"))&&b!==Id?b===ge:c}function $k(a,b,c,d){var e={},f;for(f in a)mj(f)&&(e[f]=a[f]);a=a._regions;if((c||d)&&a)for(d&&(d=["footnote"],c=c?c.concat(d):d),d=0;d<c.length;d++){f=a[c[d]];for(var g in f)mj(g)&&(e[g]=kj(b,e[g],f[g]))}return e}
...
function hl(a,b){var c=Ra(a.map.length,function(c){return b<=a.map[c].b}),c=a.map[c];return c.e-(c.b-b)}function il(a,b,c,d,e,f,g,h){this.l=a;this.style=b;this.offset=c;this.u=d;this.g=e;this.b=e.b;this.Ea=f;this.Ia=g;this.w=h;this.h=this.j=null;this.k={};this.e=this.d=this.f=null;jl(this)&&(b=b._pseudos)&&b.before&&(a=new il(a,b.before,c,!1,e,kl(this),g,!0),c=ll(a,"content"),Ki(c)&&(this.f=a,this.e=a.e));this.e=ml(nl(this,"before"),this.e);this.Ia&&ol[this.e]&&(e.e=ml(e.e,this.e))}
function ll(a,b,c){if(!(b in a.k)){var d=a.style[b];a.k[b]=d?d.evaluate(a.l,b):c||null}return a.k[b]}function pl(a){return ll(a,"display",Jd)}function kl(a){if(null===a.j){var b=pl(a),c=ll(a,"position"),d=ll(a,"float");a.j=Mi(b,c,d,a.u).display===vd}return a.j}function jl(a){null===a.h&&(a.h=a.w&&pl(a)!==Rd);return a.h}function nl(a,b){var c=null;if(kl(a)){var d=ll(a,"break-"+b);d&&(c=d.toString())}return c}function ql(a){this.e=a;this.b=[];this.Ia=this.Ea=!0;this.d=[]}
...
function ul(a,b,c,d,e,f,g,h){this.X=a;this.root=a.root;this.za=c;this.f=d;this.j=f;this.d=this.root;this.H={};this.I={};this.l={};this.w=[];this.k=this.D=this.B=null;this.O=new Ck(b,d,g,h);this.e=new cl;this.Na=!0;this.ba=[];this.oa=e;this.ma=this.ka=!1;this.b=a=xh(a,this.root);this.S={};this.g=new ql(d);el(this.e,a);d=vl(this,this.root);Lk(this.O,this.root,d);wl(this,d,!1);this.u=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.u=
!1}this.ba.push(!0);this.I={};this.I["e"+a]=d;this.b++;xl(this,-1)}function yl(a,b,c,d){return(b=b[d])&&b.evaluate(a.f)!==c[d]}function zl(a,b,c){for(var d in c){var e=b[d];e?(a.H[d]=e,delete b[d]):(e=c[d])&&(a.H[d]=new V(e,33554432))}}var Cl=["column-count","column-width"];
function wl(a,b,c){c||["writing-mode","direction"].forEach(function(a){b[a]&&(this.H[a]=b[a])},a);if(!a.ka){var d=yl(a,b,a.j.g,"background-color")?b["background-color"].evaluate(a.f):null,e=yl(a,b,a.j.g,"background-image")?b["background-image"].evaluate(a.f):null;if(d&&d!==Id||e&&e!==Id)zl(a,b,a.j.g),a.ka=!0}if(!a.ma)for(d=0;d<Cl.length;d++)if(yl(a,b,a.j.j,Cl[d])){zl(a,b,a.j.j);a.ma=!0;break}if(!c&&(c=b["font-size"])){d=c.evaluate(a.f);c=d.C;switch(d.ha){case "em":case "rem":c*=a.f.j;break;case "ex":case "rex":c*=
a.f.j*lc.ex/lc.em;break;case "%":c*=a.f.j/100;break;default:(d=lc[d.ha])&&(c*=d)}a.f.S=c}}function Dl(a){for(var b=0;!a.u&&(b+=5E3,El(a,b,0)!=Number.POSITIVE_INFINITY););return a.H}function vl(a,b){if(b.style instanceof CSSStyleDeclaration){var c=b.getAttribute("style");if(c){var d=a.X.url,e=new Yk(a.za,a.j),c=new Vb(c,e);try{cg(new Uf(Kf,c,e,d),Number.POSITIVE_INFINITY,!1,!0,!1,!1)}catch(f){u.b(f,"Style attribute parse error:")}return e.b}}return{}}
function xl(a,b){if(!(b>=a.b)){var c=a.f,d=xh(a.X,a.root);if(b<d){var e=a.h(a.root,!1),f=e["flow-into"],f=f?f.evaluate(c,"flow-into").toString():"body",f=Fl(a,f,e,a.root,d);0===a.g.b.length&&a.g.push(e,d,!0,f)}d=Ah(a.X,b);e=yh(a.X,d,0,!1);if(!(e>=a.b))for(;;){if(1!=d.nodeType)e+=d.textContent.length;else{var g=d;if(e!=xh(a.X,g))throw Error("Inconsistent offset");var h=a.h(g,!1);if(f=h["flow-into"])f=f.evaluate(c,"flow-into").toString(),Fl(a,f,h,g,e);e++}if(e>=a.b)break;f=d.firstChild;if(null==f)for(;!(f=
...
function Fl(a,b,c,d,e){var f=0,g=Number.POSITIVE_INFINITY,h=!1,l=!1,k=!1,m=c["flow-options"];if(m){var p;a:{if(h=m.evaluate(a.f,"flow-options")){l=new lg;try{h.U(l);p=l.b;break a}catch(r){u.b(r,"toSet:")}}p={}}h=!!p.exclusive;l=!!p["static"];k=!!p.last}(p=c["flow-linger"])&&(g=ng(p.evaluate(a.f,"flow-linger"),Number.POSITIVE_INFINITY));(c=c["flow-priority"])&&(f=ng(c.evaluate(a.f,"flow-priority"),0));c=a.S[e]||null;p=a.l[b];p||(p=rl(a.g),p=a.l[b]=new di(p?p.g.b:null));d=new ei(b,d,e,f,g,h,l,k,c);
a.w.push(d);a.D==b&&(a.D=null);a.B&&Hl(a.B,d,p);return d}function Il(a,b,c,d){ol[b]&&(d=a.l[d].b,(0===d.length||d[d.length-1]<c)&&d.push(c));a.S[c]=ml(a.S[c],b)}
function El(a,b,c){var d=-1;if(b<=a.b&&(d=gl(a.e,b),d+=c,d<dl(a.e)))return hl(a.e,d);if(null==a.d)return Number.POSITIVE_INFINITY;for(var e=a.f;;){var f=a.d.firstChild;if(null==f)for(;;){if(1==a.d.nodeType){var f=a.O,g=a.d;if(f.gb.pop()!==g)throw Error("Invalid call to popElement");f.yb.pop();f.ka.pop();f.wb.pop();f.xb.pop();f.pop();Jk(f);a.Na=a.ba.pop();g=a.g.pop(a.b);f=null;g.d&&(f=nl(g.d,"before"),Il(a,f,g.d.Ea?tl(a.g,g):g.d.offset,g.b),f=nl(g.d,"after"));f=ml(f,nl(g,"after"));Il(a,f,a.b,g.b)}if(f=
a.d.nextSibling)break;a.d=a.d.parentNode;if(a.d===a.root)return a.d=null,b<a.b&&(0>d&&(d=gl(a.e,b),d+=c),d<=dl(a.e))?hl(a.e,d):Number.POSITIVE_INFINITY}a.d=f;if(1!=a.d.nodeType){a.b+=a.d.textContent.length;var f=a.g,g=a.d,h=rl(f);(f.Ea||f.Ia)&&jl(h)&&(h=ll(h,"white-space",Sd).toString(),ci(g,bi(h))||(f.Ea=!1,f.Ia=!1));a.Na?el(a.e,a.b):fl(a.e,a.b)}else{g=a.d;f=vl(a,g);a.ba.push(a.Na);Lk(a.O,g,f);(h=g.getAttribute("id")||g.getAttributeNS("http://www.w3.org/XML/1998/namespace","id"))&&h===a.k&&(a.k=
null);a.u||"body"!=g.localName||g.parentNode!=a.root||(wl(a,f,!0),a.u=!0);if(h=f["flow-into"]){var h=h.evaluate(e,"flow-into").toString(),l=Fl(a,h,f,g,a.b);a.Na=!!a.oa[h];g=a.g.push(f,a.b,g===a.root,l)}else g=a.g.push(f,a.b,g===a.root);h=tl(a.g,g);Il(a,g.e,h,g.b);g.f&&(l=nl(g.f,"after"),Il(a,l,g.f.Ea?h:g.offset,g.b));a.Na&&pl(g)===Rd&&(a.Na=!1);if(xh(a.X,a.d)!=a.b)throw Error("Inconsistent offset");a.I["e"+a.b]=f;a.b++;a.Na?el(a.e,a.b):fl(a.e,a.b);if(b<a.b&&(0>d&&(d=gl(a.e,b),d+=c),d<=dl(a.e)))return hl(a.e,
d)}}}ul.prototype.h=function(a,b){var c=xh(this.X,a),d="e"+c;b&&(c=yh(this.X,a,0,!0));this.b<=c&&El(this,c,0);return this.I[d]};var Jl=1;function Kl(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.h=0;this.d=a;this.name=b;this.sb=c;this.Ba=d;this.parent=e;this.g="p"+Jl++;e&&(this.h=e.children.length,e.children.push(this))}Kl.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Kl.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Ll(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
...
function $l(a,b){this.e=a;this.d=b;this.D={};this.style={};this.k=this.l=null;this.children=[];this.H=this.I=this.f=this.g=!1;this.w=this.B=0;this.u=null;this.ka={};this.ba={};this.oa=this.b=!1;a&&a.children.push(this)}function am(a){a.B=0;a.w=0}function bm(a,b,c){b=Pl(a,b);c=Pl(a,c);if(!b||!c)throw Error("E_INTERNAL");return E(a.d.d,b,c)}
...
bm(a,"padding-top-edge","padding-top");break;case "right-edge":c=bm(a,"left-edge","width");break;case "bottom-edge":c=bm(a,"top-edge","height")}if(!c){if("extent"==b)d=a.b?"width":"height";else if("measure"==b)d=a.b?"height":"width";else{var e=a.b?hj:ij,d=b,f;for(f in e)d=d.replace(f,e[f])}d!=b&&(c=Pl(a,d))}c&&(a.ka[b]=c);return c}
...
function fm(a,b){b.ka[a.d.g]=a;var c=a.d.d,d=a.style,e=a.e?gm(a.e,b):null,e=$k(a.D,b,e,!1);a.b=Zk(e,b,a.e?a.e.b:!1);al(e,d,a.b,function(a,b){return b.value});a.l=new ic(c,function(){return a.B},"autoWidth");a.k=new ic(c,function(){return a.w},"autoHeight");a.Wc();a.Xc();dm(a);cm(a)}function hm(a,b,c){(a=a.style[c])&&(a=kg(b,a,c));return a}function Y(a,b,c){(a=a.style[c])&&(a=kg(b,a,c));return qd(a,b)}
...
function jm(a,b,c){var d=Y(a,b,"left"),e=Y(a,b,"margin-left"),f=Y(a,b,"padding-left"),g=Y(a,b,"border-left-width");a=Y(a,b,"width");Ii(c,d,a);x(c.d,"margin-left",e+"px");x(c.d,"padding-left",f+"px");x(c.d,"border-left-width",g+"px");c.marginLeft=e;c.S=g;c.j=f}
function km(a,b,c){var d=Y(a,b,"right"),e=Y(a,b,"snap-height"),f=Y(a,b,"margin-right"),g=Y(a,b,"padding-right");b=Y(a,b,"border-right-width");x(c.d,"margin-right",f+"px");x(c.d,"padding-right",g+"px");x(c.d,"border-right-width",b+"px");c.marginRight=f;c.Ya=b;a.b&&0<e&&(a=d+Fi(c),a=a-Math.floor(a/e)*e,0<a&&(c.Eb=e-a,g+=c.Eb));c.w=g;c.kc=e}
function lm(a,b,c){var d=Y(a,b,"snap-height"),e=Y(a,b,"top"),f=Y(a,b,"margin-top"),g=Y(a,b,"padding-top");b=Y(a,b,"border-top-width");c.top=e;c.marginTop=f;c.ba=b;c.$a=d;!a.b&&0<d&&(a=e+Ci(c),a=a-Math.floor(a/d)*d,0<a&&(c.oa=d-a,g+=c.oa));c.k=g;x(c.d,"top",e+"px");x(c.d,"margin-top",f+"px");x(c.d,"padding-top",g+"px");x(c.d,"border-top-width",b+"px")}
...
function om(a,b,c){x(c.d,"border-top-width","0px");var d=Y(a,b,"max-height");a.I?Hi(c,0,d):(lm(a,b,c),d-=c.oa,c.height=d,x(c.d,"height",d+"px"))}function pm(a,b,c){x(c.d,"border-left-width","0px");var d=Y(a,b,"max-width");a.H?Ii(c,0,d):(km(a,b,c),d-=c.Eb,c.width=d,a=Y(a,b,"right"),x(c.d,"right",a+"px"),x(c.d,"width",d+"px"))}
...
$l.prototype.sc=function(a,b,c,d,e,f,g){this.b?this.B=b.e+b.Eb:this.w=b.e+b.oa;f=(this.b||!d)&&this.f;var h=(!this.b||!d)&&this.g,l=null;if(h||f)h&&x(b.d,"width","auto"),f&&x(b.d,"height","auto"),l=(d?d.d:b.d).getBoundingClientRect(),h&&(this.B=Math.ceil(l.right-l.left-b.j-b.S-b.w-b.Ya),this.b&&(this.B+=b.Eb)),f&&(this.w=l.bottom-l.top-b.k-b.ba-b.u-b.Sa,this.b||(this.w+=b.oa));(this.b?this.f:this.g)&&nm(this,a,b);if(this.b?this.g:this.f){if(this.b?this.H:this.I)this.b?km(this,a,b):lm(this,a,b);this.b?
...
$l.prototype.h=function(a,b){var c=this.D,d=this.d.b,e;for(e in d)mj(e)&&nj(c,e,d[e]);if("background-host"==this.d.sb)for(e in b)if(e.match(/^background-/)||"writing-mode"==e)c[e]=b[e];if("layout-host"==this.d.sb)for(e in b)e.match(/^background-/)||"writing-mode"==e||(c[e]=b[e]);Fk(a,this.d.Ba,null,c);c.content&&(c.content=c.content.rc(new kk(a,0,a.Ya)));fm(this,a.g);for(c=0;c<this.d.children.length;c++)this.d.children[c].f(this).h(a,b);a.pop()};
...
Lm.prototype.h=function(a){var b=Km(a);this.b&&b&&b.match(/after$/)&&(this.style=this.b.h(this.f,!0),this.b=null);var c=this.style._pseudos[b]||{};if(!this.e[b]){this.e[b]=!0;var d=c.content;d&&(d=d.evaluate(this.d),Ki(d)&&d.U(new Ji(a,this.d)))}if(b.match(/^first-/)&&!c["x-first-pseudo"]){a=1;var e;"first-letter"==b?a=0:null!=(e=b.match(/^first-([0-9]+)-lines$/))&&(a=e[1]-0);c["x-first-pseudo"]=new V(new md(a),0)}return c};
function Mm(a,b,c,d,e,f,g,h,l,k,m,p,r,v){this.w=a;this.d=b;this.viewport=c;this.l=c.b;this.j=d;this.D=e;this.X=f;this.B=g;this.k=h;this.H=l;this.page=k;this.f=m;this.u=p;this.e=r;this.g=v;this.I=this.b=null;this.h=!1;this.Z=null;this.da=0;this.A=null}Mm.prototype.clone=function(){return new Mm(this.w,this.d,this.viewport,this.j,this.D,this.X,this.B,this.k,this.H,this.page,this.f,this.u,this.e,this.g)};
function Nm(a,b,c,d,e,f){var g=L("createRefShadow");a.X.j.load(b).then(function(h){if(h){var l=Ch(h,b);if(l){var k=a.H,m=k.B[h.url];if(!m){var m=k.style.h.b[h.url],p=new nc(0,k.pb(),k.ob(),k.j),m=new ul(h,m.e,m.d,p,k.g,m.j,new Om(k.f,h.url),new Pm(k.f,h.url,m.d,m.b));k.B[h.url]=m}f=new ji(d,l,h,e,f,c,m)}}P(g,f)});return O(g)}
function Qm(a,b,c,d,e,f,g,h){var l=L("createShadows"),k=e.template,m;k instanceof od?m=Nm(a,k.url,2,b,h,null):m=N(null);m.then(function(k){var m=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var v=b.getAttribute("href"),q=null;v?q=h?h.X:a.X:h&&(v="http://www.w3.org/1999/xhtml"==h.$.namespaceURI?h.$.getAttribute("href"):h.$.getAttributeNS("http://www.w3.org/1999/xlink","href"),q=h.ed?h.ed.X:a.X);v&&(v=va(v,q.url),m=Nm(a,v,3,b,h,k))}null==m&&(m=N(k));m.then(function(k){var m;
if(m=d._pseudos){for(var p=[],r=Im.createElementNS("http://www.pyroxy.com/ns/shadow","root"),q=r,v=0;v<Jm.length;v++){var U=Jm[v],F;if(U){if(!m[U])continue;if(!("footnote-marker"!=U||c&&a.h))continue;if(U.match(/^first-/)&&(F=e.display,!F||F===Jd))continue;if("before"===U||"after"===U)if(F=m[U].content,!F||F===Sd||F===Rd)continue;p.push(U);F=Im.createElementNS("http://www.w3.org/1999/xhtml","span");F.setAttribute("data-adapt-pseudo",U)}else F=Im.createElementNS("http://www.pyroxy.com/ns/shadow","content");
q.appendChild(F);U.match(/^first-/)&&(q=F)}k=p.length?new ji(b,r,null,h,k,2,new Lm(b,d,f,g)):k}P(l,k)})});return O(l)}function Rm(a,b,c){a.I=b;a.h=c}function Sm(a,b,c,d){var e=a.d;c=$k(c,e,a.D,a.h);b=Zk(c,e,b);al(c,d,b,function(b,c){var d=c.evaluate(e,b);"font-family"==b&&(d=oh(a.B,d));return d});var f=Mi(d.display||Jd,d.position,d["float"],a.Z===a.X.root);["display","position","float"].forEach(function(a){f[a]&&(d[a]=f[a])});return b}
function Tm(a,b){for(var c=a.b.Z,d=[],e=a.b.ea,f=-1;c&&1==c.nodeType;){var g=e&&e.root==c;if(!g||2==e.type){var h=(e?e.b:a.j).h(c,!1);d.push(h)}g?(c=e.$,e=e.ed):(c=c.parentNode,f++)}c=pc(a.d,"em",0===f);c={"font-size":new V(new J(c,"px"),0)};e=new sj(c,a.d);for(f=d.length-1;0<=f;--f){var g=d[f],h=[],l;for(l in g)Zi[l]&&h.push(l);h.sort(oe);for(var k=0;k<h.length;k++){var m=h[k];e.b=m;c[m]=g[m].rc(e)}}for(var p in b)Zi[p]||(c[p]=b[p]);return c}
var Um={a:"a",sub:"sub",sup:"sup",table:"table",tr:"tr",td:"td",th:"th",code:"code",body:"div",p:"p",v:"p",date:"p",emphasis:"em",strong:"strong",style:"span",strikethrough:"del"};function Vm(a,b){b=va(b,a.X.url);return a.u[b]||b}
function Wm(a,b,c){var d=!0,e=L("createElementView"),f=a.Z,g=a.b.ea?a.b.ea.b:a.j,h=g.h(f,!1),l={};a.b.parent||(h=Tm(a,h));a.b.b=Sm(a,a.b.b,h,l);l.direction&&(a.b.O=l.direction.toString());var k=l["flow-into"];if(k&&k.toString()!=a.w)return P(e,!1),O(e);var m=l.display;if(m===Rd)return P(e,!1),O(e);var p=null==a.b.parent;a.b.B=m===Fd;Qm(a,f,p,h,l,g,a.d,a.b.ea).then(function(g){a.b.sa=g;var h=l.position;g=l["float-reference"];var k=l["float"],w=l.clear,M=a.b.b?ge:Hd;a.b.I=Ni(m,h,k,l.overflow,M,a.b.parent?
a.b.parent.b?ge:Hd:M);a.b.H=h===Wd||h===rd||h===Ed;ri(a.b)&&(w=null,k!==Gd&&(k=null));h=k===Od||k===Xd||k===de||k===zd||k===Md||k===Ld||k===xd||k===wd||k===Gd;k&&(delete l["float"],k===Gd&&(a.h?(h=!1,l.display=vd):l.display=Jd));w&&(w===Id&&a.b.parent&&a.b.parent.l&&(w=I(a.b.parent.l)),w===Od||w===Xd||w===yd)&&(delete l.clear,l.display&&l.display!=Jd&&(a.b.l=w.toString()));var da=m===Pd&&l["ua-list-item-count"];h||l["break-inside"]&&l["break-inside"]!==ud?a.b.j++:m===ce&&(a.b.j+=10);a.b.e=!h&&!m||
m===Jd;a.b.display=m?m.toString():"inline";a.b.k=h?k.toString():null;a.b.ba=g?g.toString():null;if(!a.b.e){if(g=l["break-after"])a.b.D=g.toString();if(g=l["break-before"])a.b.h=g.toString()}if(g=l["x-first-pseudo"])a.b.f=new ki(a.b.parent?a.b.parent.f:null,g.C);if(g=l["white-space"])g=bi(g.toString()),null!==g&&(a.b.w=g);var oa=!1,Ea=null,Ta=[],U=f.namespaceURI,F=f.localName;if("http://www.w3.org/1999/xhtml"==U)"html"==F||"body"==F||"script"==F||"link"==F||"meta"==F?F="div":"vide_"==F?F="video":"audi_"==
F?F="audio":"object"==F&&(oa=!!a.f);else if("http://www.idpf.org/2007/ops"==U)F="span",U="http://www.w3.org/1999/xhtml";else if("http://www.gribuser.ru/xml/fictionbook/2.0"==U){U="http://www.w3.org/1999/xhtml";if("image"==F){if(F="div",(g=f.getAttributeNS("http://www.w3.org/1999/xlink","href"))&&"#"==g.charAt(0)&&(g=Ch(a.X,g)))Ea=a.createElement(U,"img"),g="data:"+(g.getAttribute("content-type")||"image/jpeg")+";base64,"+g.textContent.replace(/[ \t\n\t]/g,""),Ta.push(ug(Ea,g))}else F=Um[F];F||(F=
a.b.e?"span":"div")}else if("http://www.daisy.org/z3986/2005/ncx/"==U)if(U="http://www.w3.org/1999/xhtml","ncx"==F||"navPoint"==F)F="div";else if("navLabel"==F){if(F="span",k=f.parentNode){g=null;for(k=k.firstChild;k;k=k.nextSibling)if(1==k.nodeType&&(w=k,"http://www.daisy.org/z3986/2005/ncx/"==w.namespaceURI&&"content"==w.localName)){g=w.getAttribute("src");break}g&&(F="a",f=f.ownerDocument.createElementNS(U,"a"),f.setAttribute("href",g))}}else F="span";else"http://www.pyroxy.com/ns/shadow"==U?(U=
"http://www.w3.org/1999/xhtml",F=a.b.e?"span":"div"):oa=!!a.f;da?b?F="li":(F="div",m=vd,l.display=m):"body"==F||"li"==F?F="div":"q"==F?F="span":"a"==F&&(g=l["hyperlink-processing"])&&"normal"!=g.toString()&&(F="span");l.behavior&&"none"!=l.behavior.toString()&&a.f&&(oa=!0);f.dataset&&"true"==f.dataset.mathTypeset&&(oa=!0);var Ga;oa?Ga=a.f(f,a.b.parent?a.b.parent.A:null,l):Ga=N(null);Ga.then(function(g){g?oa&&(d="true"==g.getAttribute("data-adapt-process-children")):g=a.createElement(U,F);"a"==F&&
g.addEventListener("click",a.page.D,!1);Ea&&(Xm(a,a.b,"inner",Ea),g.appendChild(Ea));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&Hm(g);if("http://www.gribuser.ru/xml/fictionbook/2.0"!=f.namespaceURI||"td"==F){for(var h=f.attributes,k=h.length,m=null,r=0;r<k;r++){var q=h[r],v=q.namespaceURI,w=q.localName,q=q.nodeValue;if(v)if("http://www.w3.org/2000/xmlns/"==v)continue;else"http://www.w3.org/1999/xlink"==v&&"href"==w&&(q=Vm(a,q));else{if(w.match(/^on/))continue;if("style"==
w)continue;if(("id"==w||"name"==w)&&b){q=a.g.Gc(q,a.X.url);g.setAttribute(w,q);Zh(a.page,g,q);continue}"src"==w||"href"==w||"poster"==w?q=a.g.b(Vm(a,q),a.X.url):"srcset"==w&&(q=q.split(",").map(function(b){return Vm(a,b.trim())}).join(","))}if(v){var M=Gm[v];M&&(w=M+":"+w)}"src"!=w||v||"img"!=F||"http://www.w3.org/1999/xhtml"!=U?"href"==w&&"image"==F&&"http://www.w3.org/2000/svg"==U&&"http://www.w3.org/1999/xlink"==v?a.page.g.push(ug(g,q)):v?g.setAttributeNS(v,w,q):g.setAttribute(w,q):m=q}p&&b&&Zh(a.page,
g,a.g.Gc("",a.X.url));m&&(h=ug(g,m),k=l.width,m=l.height,k&&k!==ud&&m&&m!==ud?a.page.g.push(h):Ta.push(h))}delete l.content;(h=l["list-style-image"])&&h instanceof od&&(h=h.url,Ta.push(ug(new Image,h)));Ym(a,g,l);k=l.widows;m=l.orphans;h=l["box-decoration-break"];if(k||m||h){if(a.b.parent){a.b.g={};for(var Ga in a.b.parent.g)a.b.g[Ga]=a.b.parent.g[Ga]}k instanceof md&&(a.b.g.widows=k.C);m instanceof md&&(a.b.g.orphans=m.C);h instanceof kd&&(a.b.g["box-decoration-break"]=h.name)}if(!a.b.e&&(Ga=null,
b?c&&(Ga=a.b.b?Fm:Em):Ga=h!==I("clone")?a.b.b?Dm:Cm:a.b.b?Fm:Em,Ga))for(var Bl in Ga)x(g,Bl,Ga[Bl]);da&&g.setAttribute("value",l["ua-list-item-count"].stringValue());a.A=g;Ta.length?tg(Ta).then(function(){P(e,d)}):mf().then(function(){P(e,d)})})});return O(e)}
function Zm(a,b,c){var d=L("createNodeView"),e=!0;1==a.Z.nodeType?b=Wm(a,b,c):(8==a.Z.nodeType?a.A=null:a.A=document.createTextNode(a.Z.textContent.substr(a.da||0)),b=N(!0));b.then(function(b){e=b;(a.b.A=a.A)&&(b=a.b.parent?a.b.parent.A:a.I)&&b.appendChild(a.A);P(d,e)});return O(d)}function $m(a,b,c,d){(a.b=b)?(a.Z=b.Z,a.da=b.da):(a.Z=null,a.da=-1);a.A=null;return a.b?Zm(a,c,!!d):N(!0)}
...
function cn(a,b,c){b=bn(b);if(!b||b.J)return N(b);var d=L("nextInTree");$m(a,b,!0,c).then(function(a){b.A&&a||(b=b.modify(),b.J=!0,b.A||(b.e=!0));P(d,b)});return O(d)}function dn(a,b){if(b instanceof dd)for(var c=b.values,d=0;d<c.length;d++)dn(a,c[d]);else b instanceof od&&(c=b.url,a.page.g.push(ug(new Image,c)))}var en={"box-decoration-break":!0,"flow-into":!0,"flow-linger":!0,"flow-priority":!0,"flow-options":!0,page:!0,"float-reference":!0};
function Ym(a,b,c){var d=c["background-image"];d&&dn(a,d);var d=c.position===Wd,e;for(e in c)if(!en[e]){var f=c[e];Rh[e]||d&&Sh[e]?a.page.h.push(new Th(b,e,f)):(f.Xb()&&mc(f.ha)&&(f=new J(qd(f,a.d),"px")),x(b,e,f.toString()))}}function Xm(a,b,c,d){if(!b.J){var e=(b.ea?b.ea.b:a.j).h(a.Z,!1);if(e=e._pseudos)if(e=e[c])c={},b.b=Sm(a,b.b,e,c),b=c.content,Ki(b)&&(b.U(new Ji(d,a.d)),delete c.content),Ym(a,d,c)}}
function fn(a,b,c){var d=L("peelOff"),e=b.f,f=b.da,g=b.J;if(0<c)b.A.textContent=b.A.textContent.substr(0,c),f+=c;else if(!g&&b.A&&0==f){var h=b.A.parentNode;h&&h.removeChild(b.A)}for(var l=b.ia+c,k=[];b.f===e;)k.push(b),b=b.parent;var m=k.pop(),p=m.qa;nf(function(){for(;0<k.length;){m=k.pop();b=new li(m.Z,b,l);0==k.length&&(b.da=f,b.J=g);b.Ha=m.Ha;b.ea=m.ea;b.sa=m.sa;b.qa=m.qa?m.qa:p;p=null;var c=$m(a,b,!1);if(c.Ca())return c}return N(!1)}).then(function(){P(d,b)});return O(d)}
...
function hn(a){ti(a,function(a){var c=a.g["box-decoration-break"];c&&"slice"!==c||(c=a.A,a.b?(x(c,"padding-left","0"),x(c,"border-left","none"),x(c,"border-top-left-radius","0"),x(c,"border-bottom-left-radius","0")):(x(c,"padding-bottom","0"),x(c,"border-bottom","none"),x(c,"border-bottom-left-radius","0"),x(c,"border-bottom-right-radius","0")))})}
function Ti(a,b,c){return b.da===c.da&&b.J==c.J&&b.ga.length===c.ga.length&&b.ga.every(function(a,b){var f;f=c.ga[b];if(a.ea)if(f.ea){var g=1===a.fa.nodeType?a.fa:a.fa.parentElement,h=1===f.fa.nodeType?f.fa:f.fa.parentElement;f=a.ea.$===f.ea.$&&Km(g)===Km(h)}else f=!1;else f=a.fa===f.fa;return f}.bind(a))}function jn(a){this.b=a}function kn(a){return a.getClientRects()}function ln(a,b){return a.b.getComputedStyle(b,null)}
...
mn.prototype.zoom=function(a,b,c){x(this.e,"width",a*c+"px");x(this.e,"height",b*c+"px");x(this.d,"width",a+"px");x(this.d,"height",b+"px");x(this.d,"transform","scale("+c+")")};Yi("SIMPLE_PROPERTY",function(a){var b=a.name,c=a.value;switch(b){case "page-break-before":case "page-break-after":case "page-break-inside":return{name:b.replace(/^page-/,""),value:c===td?Vd:c,important:a.important};default:return a}});var ol={page:!0,left:!0,right:!0,recto:!0,verso:!0,column:!0,region:!0},nn={avoid:!0,"avoid-page":!0,"avoid-column":!0,"avoid-region":!0};
...
function wn(a,b,c,d){Bi.call(this,a);this.nd=a.lastChild;this.g=b;this.za=c;this.yb=d;this.Ud=a.ownerDocument;this.Kc=!1;this.ma=this.Oa=this.ta=this.ka=this.O=0;this.gb=this.wb=this.l=this.Za=null;this.qd=!1;this.h=this.f=this.B=null;this.Gd=!0;this.Lc=this.Jc=this.Mc=0}t(wn,Bi);wn.prototype.clone=function(){var a=new wn(this.d,this.g,this.za,this.yb);Gi(a,this);a.nd=this.nd;a.Kc=this.Kc;a.l=this.l?this.l.clone():null;a.wb=this.wb.concat();return a};function xn(a,b){return a.b?b<a.ma:b>a.ma}
function yn(a,b,c){var d=new li(b.fa,c,0);d.Ha=b.Ha;d.ea=b.ea;d.sa=b.sa;d.qa=b.qa?yn(a,b.qa,oi(c)):null;return d}function zn(a,b){var c=L("openAllViews"),d=b.ga;Rm(a.g,a.d,a.Kc);var e=d.length-1,f=null;nf(function(){for(;0<=e;){f=yn(a,d[e],f);if(0==e&&(f.da=b.da,f.J=b.J,f.J))break;var c=$m(a.g,f,0==e&&0==f.da);e--;if(c.Ca())return c}return N(!1)}).then(function(){P(c,f)});return O(c)}var An=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
function Bn(a,b){if(b.f&&b.e&&!b.J&&0==b.f.count&&1!=b.A.nodeType){var c=b.A.textContent.match(An);return fn(a.g,b,c[0].length)}return N(b)}function Cn(a,b,c){var d=L("buildViewToNextBlockEdge");of(function(d){b.A&&c.push(oi(b));Bn(a,b).then(function(f){f!==b&&(b=f,c.push(oi(b)));cn(a.g,b).then(function(c){(b=c)?Dn(a.yb,b)?b.k&&!a.b?En(a,b).then(function(c){b=c;!b||b.d||0<a.g.e.b.length?Q(d):qf(d)}):b.e?qf(d):Q(d):(b=b.modify(),b.d=!0,Q(d)):Q(d)})})}).then(function(){P(d,b)});return O(d)}
function Fn(a,b){if(!b.A)return N(b);var c=b.Z,d=L("buildDeepElementView");of(function(d){Bn(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.Z!=c;)g=g.parent;if(null==g){b=f;Q(d);return}}cn(a.g,f).then(function(f){(b=f)&&b.Z!=c?Dn(a.yb,b)?qf(d):(b=b.modify(),b.d=!0,Q(d)):Q(d)})})}).then(function(){P(d,b)});return O(d)}
function Gn(a,b,c,d,e){var f=a.Ud.createElement("div");a.b?(x(f,"height",d+"px"),x(f,"width",e+"px")):(x(f,"width",d+"px"),x(f,"height",e+"px"));x(f,"float",c);x(f,"clear",c);a.d.insertBefore(f,b);return f}function Hn(a){for(var b=a.d.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.d.removeChild(b);else break}b=c}}
...
function Z(a){return"number"==typeof a?a:(a=a.match(/^(-?[0-9]*(\.[0-9]*)?)px$/))?parseFloat(a[0]):0}function Kn(a,b){var c=ln(a.za,b),d=new re;c&&(d.left=Z(c.marginLeft),d.top=Z(c.marginTop),d.right=Z(c.marginRight),d.bottom=Z(c.marginBottom));return d}
function Ln(a,b){var c=ln(a.za,b),d=new re;if(c){if("border-box"==c.boxSizing)return Kn(a,b);d.left=Z(c.marginLeft)+Z(c.borderLeftWidth)+Z(c.paddingLeft);d.top=Z(c.marginTop)+Z(c.borderTopWidth)+Z(c.paddingTop);d.right=Z(c.marginRight)+Z(c.borderRightWidth)+Z(c.paddingRight);d.bottom=Z(c.marginBottom)+Z(c.borderBottomWidth)+Z(c.paddingBottom)}return d}
...
function On(a,b,c,d){if(a.f&&a.f[a.f.length-1].b)return Nn(a,b,c),N(!0);d+=40*(a.b?-1:1);var e=a.l,f=!e;if(f){var g=a.d.ownerDocument.createElement("div");x(g,"position","absolute");var h=a.g.clone(),e=new wn(g,h,a.za,a.yb);a.l=e;e.b=gn(a.g,a.b,g);e.Kc=!0;a.b?(e.left=0,x(e.d,"width","2em")):(e.top=a.Oa,x(e.d,"height","2em"))}a.d.appendChild(e.d);Mn(a,e.d,e);g=(a.b?-1:1)*(d-a.ta);a.b?e.height=a.Za.R-a.Za.W-Ci(e)-Di(e):e.width=a.Za.V-a.Za.aa-Ei(e)-Fi(e);d=(a.b?-1:1)*(a.Oa-d)-(a.b?Ei(e)-Fi(e):Ci(e)+
Di(e));if(f&&18>d)return a.d.removeChild(e.d),a.l=null,Nn(a,b,c),N(!0);if(!a.b&&e.top<g)return a.d.removeChild(e.d),Nn(a,b,c),N(!0);var l=L("layoutFootnoteInner");a.b?Ii(e,0,d):Hi(e,g,d);e.D=a.D+a.left+Ei(a);e.H=a.H+a.top+Ci(a);e.I=a.I;var k=new ui(c);f?(Pn(e),d=N(!0)):0==e.I.length?(Qn(e),d=N(!0)):d=Rn(e);d.then(function(){Sn(e,k).then(function(d){if(f&&d)a.d.removeChild(e.d),Nn(a,b,c),a.l=null,P(l,!0);else{a.b?(a.ma=a.Oa+(e.e+Ei(e)+Fi(e)),Ii(e,0,e.e)):(a.ma=a.Oa-(e.e+Ci(e)+Di(e)),Hi(e,a.ma-a.ta,
e.e));var g;!a.b&&0<e.I.length?g=Rn(e):g=N(d);g.then(function(d){d=new un(b,c,d?d.Na:null);a.f?a.f.push(d):a.f=[d];P(l,!0)})}})});return O(l)}
function Tn(a,b){var c=L("layoutFootnote"),d=b.A;d.setAttribute("style","");x(d,"display","inline-block");d.textContent="M";var e=d.getBoundingClientRect(),f=a.b?e.left:e.bottom;d.textContent="";Xm(a.g,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d={ga:[{fa:b.Z,Ha:0,ea:b.ea,sa:null,qa:null}],da:0,J:!1};e=b.ia;b=b.modify();b.J=!0;On(a,e,d,f).then(function(){a.l&&a.l.d.parentNode&&a.d.removeChild(a.l.d);xn(a,f)&&0!=a.B.length&&(b.d=!0);P(c,b)});return O(c)}
function Un(a,b){var c=L("layoutFloat"),d=b.A,e=b.k,f=b.ba,g=b.parent?b.parent.O:"ltr",h=a.g.e,l=b.A.parentNode;"page"===f?Ri(h,d,e):(x(d,"float","none"),x(d,"display","inline-block"),x(d,"vertical-align","top"));Fn(a,b).then(function(k){var m=d.getBoundingClientRect(),p=Kn(a,d),m=new pe(m.left-p.left,m.top-p.top,m.right+p.right,m.bottom+p.bottom);if("page"===f)Si(h,b,a.g)?(m=l.ownerDocument.createElement("span"),x(m,"width","0"),x(m,"height","0"),l.appendChild(m),k.A=m,P(c,k)):Ui(h,b,m).then(function(){P(c,
null)});else{e=Oi(e,a.b,g);for(var r=a.O,v=a.ka,p=b.parent;p&&p.e;)p=p.parent;if(p){var q=p.A.ownerDocument.createElement("div");q.style.left="0px";q.style.top="0px";a.b?(q.style.bottom="0px",q.style.width="1px"):(q.style.right="0px",q.style.height="1px");p.A.appendChild(q);var w=q.getBoundingClientRect(),r=Math.max(a.b?w.top:w.left,r),v=Math.min(a.b?w.bottom:w.right,v);p.A.removeChild(q);q=a.b?m.R-m.W:m.V-m.aa;"left"==e?v=Math.max(v,r+q):r=Math.min(r,v-q);p.A.appendChild(b.A)}q=new pe(r,(a.b?-1:
1)*a.ta,v,(a.b?-1:1)*a.Oa);r=m;a.b&&(r=He(m));v=a.b?-1:1;r.W<a.Lc*v&&(w=r.R-r.W,r.W=a.Lc*v,r.R=r.W+w);Me(q,a.gb,r,e);a.b&&(m=new pe(-r.R,r.aa,-r.W,r.V));q=Ln(a,d);x(d,"width",m.V-m.aa-q.left-q.right+"px");x(d,"height",m.R-m.W-q.top-q.bottom+"px");x(d,"position","absolute");x(d,"display",b.display);v=null;p&&(p.H?v=p:v=si(p));v?(q=v.A.ownerDocument.createElement("div"),q.style.position="absolute",v.b?q.style.right="0":q.style.left="0",q.style.top="0",v.A.appendChild(q),p=q.getBoundingClientRect(),
v.A.removeChild(q)):p={left:a.b?a.Oa:a.O,right:a.b?a.ta:a.ka,top:a.b?a.O:a.ta};(v?v.b:a.b)?x(d,"right",p.right-m.V+a.w+"px"):x(d,"left",m.aa-p.left+a.j+"px");x(d,"top",m.W-p.top+a.k+"px");b.u&&(b.u.parentNode.removeChild(b.u),b.u=null);p=a.b?m.aa:m.R;m=a.b?m.V:m.W;xn(a,p)&&0!=a.B.length?(b=b.modify(),b.d=!0,P(c,b)):(Hn(a),q=new pe(a.b?a.Oa:a.O,a.b?a.O:a.ta,a.b?a.ta:a.ka,a.b?a.ka:a.Oa),a.b&&(q=He(q)),Ne(q,a.gb,r,e),In(a),"left"==e?a.Mc=p:a.Jc=p,a.Lc=m,Vn(a,p),P(c,k))}});return O(c)}
...
"1"))}}function Xn(a,b,c,d){var e=L("processLineStyling");vn(d);var f=d.concat([]);d.splice(0,d.length);var g=0,h=b.f;0==h.count&&(h=h.ee);of(function(d){if(h){var e=Yn(a,f),m=h.count-g;if(e.length<=m)Q(d);else{var p=Zn(a,f,e[m-1]);$n(a,p,!1,!1).then(function(){g+=m;fn(a.g,p,0).then(function(e){b=e;Wn(b,!1);h=b.f;f=[];Cn(a,b,f).then(function(b){c=b;0<a.g.e.b.length?Q(d):qf(d)})})})}}else Q(d)}).then(function(){Array.prototype.push.apply(d,f);vn(d);P(e,c)});return O(e)}
...
function bo(a,b){var c=L("layoutBreakableBlock"),d=[];Cn(a,b,d).then(function(e){if(0<a.g.e.b.length)P(c,e);else{var f=d.length-1;if(0>f)P(c,e);else{var f=Jn(a,e,d,f,d[f].ia),g=xn(a,f);null==e&&(f+=ao(a,d));Vn(a,f);var h;b.f?h=Xn(a,b,e,d):h=N(e);h.then(function(b){0<d.length&&(a.B.push(new rn(d,d[0].j)),g&&(2!=d.length&&0<a.B.length||d[0].Z!=d[1].Z||!pn[d[0].Z.localName])&&b&&(b=b.modify(),b.d=!0));P(c,b)})}}});return O(c)}
...
function co(a,b){if(!a.f)return N(!0);for(var c=!1,d=a.f.length-1;0<=d;--d){var e=a.f[d];if(e.ia<=b)break;a.f.pop();e.b!==e.d&&(c=!0)}if(!c)return N(!0);var f=L("clearFootnotes"),g=a.e+a.ta,h=a.f;a.l=null;a.f=null;var l=0;nf(function(){for(;l<h.length;){var b=h[l++],b=On(a,b.ia,b.d,g);if(b.Ca())return b}return N(!1)}).then(function(){P(f,!0)});return O(f)}
function sn(a,b,c){for(var d=b.e,e=d[0];e.parent&&e.e;)e=e.parent;var f;c?f=c=1:(c=Math.max((e.g.widows||2)-0,1),f=Math.max((e.g.orphans||2)-0,1));var g=0;ti(e,function(b){if("clone"===b.g["box-decoration-break"]){var c=ln(a.za,b.A),d=new re;c&&(d.left=Z(c.borderLeftWidth)+Z(c.paddingLeft),d.top=Z(c.borderTopWidth)+Z(c.paddingTop),d.right=Z(c.borderRightWidth)+Z(c.paddingRight),d.bottom=Z(c.borderBottomWidth)+Z(c.paddingBottom));g+=b.b?-d.left:d.bottom}});var h=Yn(a,d),l=a.ma-g,d=Ra(h.length,function(b){return a.b?
...
function eo(a,b,c){var d=L("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,h=a.B.length-1;0<=h&&!e;--h){var e=a.B[h].d(a,f),l=a.B[h].b();l>f&&(g=Math.min(g,l))}while(g>f&&!e);var k=!1;if(!e){u.b("Could not find any page breaks?!!");if(a.Gd)return fo(a,b).then(function(b){b?(b=b.modify(),b.d=!1,$n(a,b,k,!0).then(function(){P(d,b)})):P(d,b)}),O(d);e=c;k=!0}$n(a,e,k,!0).then(function(){P(d,e)});return O(d)}
function go(a){a=a.toString();return""==a||"auto"==a||!!a.match(/^0+(.0*)?[^0-9]/)}function ho(a,b,c,d,e){if(!b)return!1;var f=qn(b,0,a.b),g=xn(a,f);c&&(f+=ao(a,c));Vn(a,f);if(d||!g)b=new tn(oi(b),e,g,a.e),a.B.push(b);return g}
function io(a,b){if(b.A.parentNode){var c=Kn(a,b.A),d=b.A.ownerDocument.createElement("div");a.b?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.A.parentNode.insertBefore(d,b.A);var e=d.getBoundingClientRect(),e=a.b?e.right:e.top,f=a.b?-1:1,g;switch(b.l){case "left":g=a.Mc;break;case "right":g=a.Jc;break;default:g=f*Math.max(a.Jc*f,a.Mc*f)}e*f>=g*f?b.A.parentNode.removeChild(d):(e=Math.max(1,(g-e)*
...
function jo(a,b,c){function d(){b=k[0]||b;b.A.parentNode.removeChild(b.A);e.h=h}var e=a,f=L("skipEdges"),g=c&&b&&b.J,h=null,l=null,k=[],m=[],p=!1;of(function(a){for(;b;){do if(b.A){if(!Dn(e.yb,b)){b=b.modify();b.d=!0;Q(a);return}if(b.e&&1!=b.A.nodeType){if(ci(b.A,b.w))break;if(!b.J){!c&&ol[h]?d():ho(e,l,null,!0,h)?(b=(l||b).modify(),b.d=!0):(b=b.modify(),b.h=h);Q(a);return}}if(!b.J&&(b.l&&io(e,b),b.k||b.B)){k.push(oi(b));h=ml(h,b.h);!c&&ol[h]?d():ho(e,l,null,!0,h)&&(b=(l||b).modify(),b.d=!0);Q(a);
return}if(1==b.A.nodeType){var f=b.A.style;if(b.J){if(p){if(!c&&ol[h]){d();Q(a);return}k=[];g=c=!1;h=null}p=!1;l=oi(b);m.push(l);h=ml(h,b.D);if(f&&(!go(f.paddingBottom)||!go(f.borderBottomWidth))){if(ho(e,l,null,!0,h)){b=(l||b).modify();b.d=!0;Q(a);return}m=[l];l=null}}else{k.push(oi(b));h=ml(h,b.h);if(pn[b.A.localName]){!c&&ol[h]?d():ho(e,l,null,!0,h)&&(b=(l||b).modify(),b.d=!0);Q(a);return}!f||go(f.paddingTop)&&go(f.borderTopWidth)||(g=!1,m=[]);p=!0}}}while(0);f=cn(e.g,b,g);if(f.Ca()){f.then(function(c){b=
c;qf(a)});return}b=f.mc()}ho(e,l,m,!1,h)?l&&(b=l.modify(),b.d=!0):ol[h]&&(e.h=h);Q(a)}).then(function(){P(f,b)});return O(f)}
function fo(a,b){var c=oi(b),d=L("skipEdges"),e=null,f=!1;of(function(d){for(;b;){do if(b.A){if(b.e&&1!=b.A.nodeType){if(ci(b.A,b.w))break;if(!b.J){ol[e]&&(a.h=e);Q(d);return}}if(!b.J&&(b.k||b.B)){e=ml(e,b.h);ol[e]&&(a.h=e);Q(d);return}if(1==b.A.nodeType){var h=b.A.style;if(b.J){if(f){if(ol[e]){a.h=e;Q(d);return}e=null}f=!1;e=ml(e,b.D)}else{e=ml(e,b.h);if(pn[b.A.localName]){ol[e]&&(a.h=e);Q(d);return}if(h&&(!go(h.paddingTop)||!go(h.borderTopWidth))){Q(d);return}}f=!0}}while(0);h=cn(a.g,b);if(h.Ca()){h.then(function(a){b=
a;qf(d)});return}b=h.mc()}c=null;Q(d)}).then(function(){P(d,c)});return O(d)}function En(a,b){return"footnote"==b.k?Tn(a,b):Un(a,b)}function ko(a,b,c){var d=L("layoutNext");jo(a,b,c).then(function(c){b=c;if(!b||a.h||b.d)P(d,b);else if(b.k)En(a,b).ua(d);else{a:if(b.J)c=!0;else{switch(b.Z.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!b.B}c?bo(a,b).ua(d):Fn(a,b).ua(d)}});return O(d)}
function Qn(a){var b=a.d.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.k+"px";b.style.right=a.w+"px";b.style.bottom=a.u+"px";b.style.left=a.j+"px";a.d.appendChild(b);var c=b.getBoundingClientRect();a.d.removeChild(b);var b=a.D+a.left+Ei(a),d=a.H+a.top+Ci(a);a.Za=new pe(b,d,b+a.width,d+a.height);a.O=c?a.b?c.top:c.left:0;a.ka=c?a.b?c.bottom:c.right:0;a.ta=c?a.b?c.right:c.top:0;a.Oa=c?a.b?c.left:c.bottom:0;a.Mc=a.ta;a.Jc=a.ta;a.Lc=a.ta;a.ma=a.Oa;c=a.Za;b=a.D+a.left+Ei(a);
d=a.H+a.top+Ci(a);b=a.xb?xe(a.xb,b,d):ze(b,d,b+a.width,d+a.height);a.gb=Je(c,[b],a.I,a.$a,a.b);In(a);a.f=null}function Pn(a){a.wb=[];x(a.d,"width",a.width+"px");x(a.d,"height",a.height+"px");Qn(a);a.e=0;a.qd=!1;a.h=null}function Vn(a,b){a.e=Math.max((a.b?-1:1)*(b-a.ta),a.e)}function lo(a,b){var c=b.b;if(!c)return N(!0);var d=L("layoutOverflownFootnotes"),e=0;nf(function(){for(;e<c.length;){var b=c[e++],b=On(a,0,b,a.ta);if(b.Ca())return b}return N(!1)}).then(function(){P(d,!0)});return O(d)}
function Sn(a,b,c){a.wb.push(b);if(a.qd)return N(b);var d=L("layout");lo(a,b).then(function(){zn(a,b.Na).then(function(b){var f=b;a.B=[];of(function(d){for(;b;){var h=!0;ko(a,b,c).then(function(l){c=!1;b=l;0<a.g.e.b.length?Q(d):a.h?Q(d):b&&b.d?eo(a,b,f).then(function(a){b=a;Q(d)}):h?h=!1:qf(d)});if(h){h=!1;return}}Q(d)}).then(function(){var c=a.l;c&&(a.d.appendChild(c.d),a.b?a.e=this.ta-this.Oa:a.e=c.top+Ci(c)+c.e+Di(c));if(b)if(0<a.g.e.b.length)P(d,null);else{a.qd=!0;c=new ui(qi(b));if(a.f){for(var f=
[],l=0;l<a.f.length;l++){var k=a.f[l].b;k&&f.push(k)}c.b=f.length?f:null}P(d,c)}else P(d,null)})})});return O(d)}function Rn(a){for(var b=a.wb,c=a.d.lastChild;c!=a.nd;){var d=c.previousSibling;a.d===c.parentNode&&Km(c)||a.d.removeChild(c);c=d}Hn(a);Pn(a);var e=L("redoLayout"),f=0,g=null,h=!0;of(function(c){if(f<b.length){var d=b[f++];Sn(a,d,h).then(function(a){h=!1;a?(g=a,Q(c)):qf(c)})}else Q(c)}).then(function(){P(e,g)});return O(e)};function mo(a,b){this.b=a;this.G=b}function Pm(a,b,c,d){this.b=a;this.e=b;this.g=c;this.d=d;this.f=null}function Om(a,b){this.b=a;this.d=b}function no(a){var b={};Object.keys(a).forEach(function(c){b[c]=Array.b(a[c])});return b}function oo(a,b){this.Db=a;this.bc=b;this.cd=null;this.G=this.F=-1}function Nk(a,b,c){b=a.b.D.Gc(b,a.d);a.b.h[b]=c}function po(a){return(a=a.match(/^[^#]*#(.*)$/))?a[1]:null}function qo(a,b){var c=a.b.D.b(va(b,a.e),a.e);"#"===c.charAt(0)&&(c=c.substring(1));return c}
function sk(a,b,c){return new ic(a.d,function(){var d=a.b.b[b];return c(d&&d.length?d[d.length-1]:null)},"page-counter-"+b)}function uk(a,b,c){return new ic(a.d,function(){return c(a.b.b[b]||[])},"page-counters-"+b)}function ro(a,b,c,d){var e=a.b.h[c];if(!e&&d&&b){d=a.f;if(b){d.k=b;for(b=0;d.k&&(b+=5E3,El(d,b,0)!==Number.POSITIVE_INFINITY););d.k=null}e=a.b.h[c]}return e||null}
function wk(a,b,c,d){var e=po(b),f=qo(a,b),g=ro(a,e,f,!1);return g&&g[c]?(b=g[c],new B(a.g,d(b[b.length-1]||null))):new ic(a.d,function(){if(g=ro(a,e,f,!0)){if(g[c]){var b=g[c];return d(b[b.length-1]||null)}if(b=a.b.g.b[f]?a.b.b:a.b.k[f]||null)return so(a.b,f),b[c]?(b=b[c],d(b[b.length-1]||null)):d(0);to(a.b,f,!1);return"??"}to(a.b,f,!1);return"??"},"target-counter-"+c+"-of-"+b)}
function yk(a,b,c,d){var e=po(b),f=qo(a,b);return new ic(a.d,function(){var b=a.b.g.b[f]?a.b.b:a.b.k[f]||null;if(b){so(a.b,f);var b=b[c]||[],h=ro(a,e,f,!0)[c]||[];return d(b.concat(h))}to(a.b,f,!1);return"??"},"target-counters-"+c+"-of-"+b)}function uo(a){this.D=a;this.h={};this.k={};this.b={};this.b.page=[0];this.w={};this.u=[];this.l={};this.g=null;this.j=[];this.d=[];this.B=[];this.e={};this.f={}}
function vo(a,b,c){a.w=no(a.b);var d,e=b["counter-reset"];e&&(e=e.evaluate(c))&&(d=rg(e,!0));if(d)for(var f in d){var e=a,g=f,h=d[f];e.b[g]?e.b[g].push(h):e.b[g]=[h]}var l;(b=b["counter-increment"])&&(c=b.evaluate(c))&&(l=rg(c,!1));l?"page"in l||(l.page=1):l={page:1};for(var k in l)a.b[k]||(c=a,b=k,c.b[b]?c.b[b].push(0):c.b[b]=[0]),c=a.b[k],c[c.length-1]+=l[k]}function wo(a,b){a.u.push(a.b);a.b=no(b)}
...
function yo(a,b){var c=[];Object.keys(b.b).forEach(function(a){(a=this.e[a])&&(c=c.concat(a))},a);c.sort(function(a,b){return a.F-b.F||a.G-b.G});var d=[],e=null;c.forEach(function(a){e&&e.F===a.F&&e.G===a.G?e.vc.push(a):(e={F:a.F,G:a.G,cd:a.cd,vc:[a]},d.push(e))});return d}function zo(a,b){a.B.push(a.d);a.d=b}function Dn(a,b){if(!b||b.J)return!0;var c=b.A;if(!c||1!==c.nodeType)return!0;c=c.getAttribute("id")||c.getAttribute("name");return c?(c=a.b.l[c])?a.G>=c.G:!0:!0};function Ao(a,b){this.e(a,"end",b)}function Bo(a,b){this.e(a,"start",b)}function Co(a,b,c){c||(c=this.g.now());var d=this.f[a];d||(d=this.f[a]=[]);var e;for(a=d.length-1;0<=a&&(!(e=d[a])||e[b]);a--)e=null;e||(e={},d.push(e));e[b]=c}function Do(){}function Eo(a){this.g=a;this.f={};this.registerEndTiming=this.d=this.registerStartTiming=this.b=this.e=Do}
Eo.prototype.h=function(){var a=this.f,b="";Object.keys(a).forEach(function(c){for(var d=a[c],e=d.length,f=0;f<e;f++){var g=d[f];b+=c;1<e&&(b+="("+f+")");b+=" => start: "+g.start+", end: "+g.end+", duration: "+(g.end-g.start)+"\n"}});u.e(b)};Eo.prototype.j=function(){this.registerEndTiming=this.d=this.registerStartTiming=this.b=this.e=Do};Eo.prototype.k=function(){this.e=Co;this.registerStartTiming=this.b=Bo;this.registerEndTiming=this.d=Ao};
var Fo={now:Date.now},Go,Ho=Go=new Eo(window&&window.performance||Fo);Co.call(Ho,"load_vivliostyle","start",void 0);ca("vivliostyle.profile.profiler",Ho);Eo.prototype.printTimings=Eo.prototype.h;Eo.prototype.disable=Eo.prototype.j;Eo.prototype.enable=Eo.prototype.k;function Io(a,b,c){function d(c){return ln(a,b).getPropertyValue(c)}function e(){x(b,"display","block");x(b,"position","static");return d(da)}function f(){x(b,"display","inline-block");x(q,da,"99999999px");var a=d(da);x(q,da,"");return a}function g(){x(b,"display","inline-block");x(q,da,"0");var a=d(da);x(q,da,"");return a}function h(){var a=e(),b=g(),c=parseFloat(a);if(c<=parseFloat(b))return b;b=f();return c<=parseFloat(b)?a:b}function l(){throw Error("Getting fill-available block size is not implemented");
}var k=b.style.display,m=b.style.position,p=b.style.width,r=b.style.height,v=b.parentNode,q=b.ownerDocument.createElement("div");x(q,"position",m);v.insertBefore(q,b);q.appendChild(b);x(b,"width","auto");x(b,"height","auto");var w=Ha("writing-mode"),w=(w?d(w):null)||d("writing-mode"),M="vertical-rl"===w||"tb-rl"===w||"vertical-lr"===w||"tb-lr"===w,da=M?"height":"width",oa=M?"width":"height",Ea={};c.forEach(function(a){var c;switch(a){case "fill-available inline size":c=e();break;case "max-content inline size":c=
f();break;case "min-content inline size":c=g();break;case "fit-content inline size":c=h();break;case "fill-available block size":c=l();break;case "max-content block size":case "min-content block size":case "fit-content block size":c=d(oa);break;case "fill-available width":c=M?l():e();break;case "fill-available height":c=M?e():l();break;case "max-content width":c=M?d(oa):f();break;case "max-content height":c=M?f():d(oa);break;case "min-content width":c=M?d(oa):g();break;case "min-content height":c=
M?g():d(oa);break;case "fit-content width":c=M?d(oa):h();break;case "fit-content height":c=M?h():d(oa)}Ea[a]=parseFloat(c);x(b,"position",m);x(b,"display",k)});x(b,"width",p);x(b,"height",r);v.insertBefore(b,q);v.removeChild(q);return Ea};function Jo(a){var b=a["writing-mode"],b=b&&b.value;a=(a=a.direction)&&a.value;return b===fe||b!==ge&&a!==$d?"ltr":"rtl"}
var Ko={a5:{width:new J(148,"mm"),height:new J(210,"mm")},a4:{width:new J(210,"mm"),height:new J(297,"mm")},a3:{width:new J(297,"mm"),height:new J(420,"mm")},b5:{width:new J(176,"mm"),height:new J(250,"mm")},b4:{width:new J(250,"mm"),height:new J(353,"mm")},"jis-b5":{width:new J(182,"mm"),height:new J(257,"mm")},"jis-b4":{width:new J(257,"mm"),height:new J(364,"mm")},letter:{width:new J(8.5,"in"),height:new J(11,"in")},legal:{width:new J(8.5,"in"),height:new J(14,"in")},ledger:{width:new J(11,"in"),
height:new J(17,"in")}},Lo=new J(.24,"pt"),Mo=new J(3,"mm"),No=new J(10,"mm"),Oo=new J(13,"mm");
function Po(a){var b={width:ke,height:le,zb:me,kb:me},c=a.size;if(c&&c.value!==ud){var d=c.value;d.Zc()?(c=d.values[0],d=d.values[1]):(c=d,d=null);if(c.Xb())b.width=c,b.height=d||c;else if(c=Ko[c.name.toLowerCase()])d&&d===Nd?(b.width=c.height,b.height=c.width):(b.width=c.width,b.height=c.height)}(c=a.marks)&&c.value!==Rd&&(b.kb=Oo);a=a.bleed;a&&a.value!==ud?a.value&&a.value.Xb()&&(b.zb=a.value):c&&(a=!1,c.value.Zc()?a=c.value.values.some(function(a){return a===Ad}):a=c.value===Ad,a&&(b.zb=new J(6,
"pt")));return b}function Qo(a,b){var c={},d=a.zb.C*pc(b,a.zb.ha,!1),e=a.kb.C*pc(b,a.kb.ha,!1),f=d+e,g=a.width;c.pb=g===ke?(b.T.Xa?Math.floor(b.za/2)-b.T.Kb:b.za)-2*f:g.C*pc(b,g.ha,!1);g=a.height;c.ob=g===le?b.gb-2*f:g.C*pc(b,g.ha,!1);c.zb=d;c.kb=e;c.Rc=f;return c}function Ro(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
...
function Uo(a,b,c,d,e,f){var g=d;g<=e+2*lc.mm&&(g=e+d/2);var h=Math.max(d,g),l=e+h+c/2,k=Ro(a,l,l),g=[[0,e+d],[d,e+d],[d,e+d-g]];d=g.map(function(a){return[a[1],a[0]]});if("top right"===b||"bottom right"===b)g=g.map(function(a){return[e+h-a[0],a[1]]}),d=d.map(function(a){return[e+h-a[0],a[1]]});if("bottom left"===b||"bottom right"===b)g=g.map(function(a){return[a[0],e+h-a[1]]}),d=d.map(function(a){return[a[0],e+h-a[1]]});l=So(a,c);l.setAttribute("points",g.map(function(a){return a.join(",")}).join(" "));
...
Vo[a];a===b?h.style[a]=e+"px":a!==k&&(h.style[a]="0",h.style["margin-"+a]="auto")});return h}function Xo(a,b,c,d){var e=!1,f=!1;if(a=a.marks)a=a.value,a.Zc()?a.values.forEach(function(a){a===Ad?e=!0:a===Bd&&(f=!0)}):a===Ad?e=!0:a===Bd&&(f=!0);if(e||f){var g=c.N,h=g.ownerDocument,l=b.zb,k=qd(Lo,d),m=qd(Mo,d),p=qd(No,d);e&&Object.keys(To).forEach(function(a){a=Uo(h,To[a],k,p,l,m);g.appendChild(a)});f&&Object.keys(Vo).forEach(function(a){a=Wo(h,Vo[a],k,p,m);g.appendChild(a)})}}
...
function ap(a,b,c){Ql.call(this,a,null,"vivliostyle-page-rule-master",[],b,null,0);a=Po(c);new bp(this.d,this,c,a);this.l={};cp(this,c);this.b.position=new V(Wd,0);this.b.width=new V(a.width,0);this.b.height=new V(a.height,0);for(var d in c)Yo[d]||"background-clip"===d||(this.b[d]=c[d])}t(ap,Ql);function cp(a,b){var c=b._marginBoxes;c&&$o.forEach(function(d){c[d]&&(a.l[d]=new dp(a.d,a,d,b))})}ap.prototype.f=function(a){return new ep(a,this)};
function bp(a,b,c,d){Ul.call(this,a,null,null,[],b);this.u=d;this.b["z-index"]=new V(new md(0),0);this.b["flow-from"]=new V(I("body"),0);this.b.position=new V(rd,0);this.b.overflow=new V(he,0);for(var e in Yo)Yo.hasOwnProperty(e)&&(this.b[e]=c[e])}t(bp,Ul);bp.prototype.f=function(a){return new fp(a,this)};
function dp(a,b,c,d){Ul.call(this,a,null,null,[],b);this.k=c;a=d._marginBoxes[this.k];for(var e in d)if(b=d[e],c=a[e],Zi[e]||c&&c.value===Id)this.b[e]=b;for(e in a)Object.prototype.hasOwnProperty.call(a,e)&&(b=a[e])&&b.value!==Id&&(this.b[e]=b)}t(dp,Ul);dp.prototype.f=function(a){return new gp(a,this)};function ep(a,b){Rl.call(this,a,b);this.j=null;this.ma={}}t(ep,Rl);
ep.prototype.h=function(a,b){var c=this.D,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}Rl.prototype.h.call(this,a,b)};ep.prototype.Wc=function(){var a=this.style;a.left=me;a["margin-left"]=me;a["border-left-width"]=me;a["padding-left"]=me;a["padding-right"]=me;a["border-right-width"]=me;a["margin-right"]=me;a.right=me};
ep.prototype.Xc=function(){var a=this.style;a.top=me;a["margin-top"]=me;a["border-top-width"]=me;a["padding-top"]=me;a["padding-bottom"]=me;a["border-bottom-width"]=me;a["margin-bottom"]=me;a.bottom=me};ep.prototype.S=function(a,b,c){b=b.u;var d={start:this.j.marginLeft,end:this.j.marginRight,ca:this.j.Hb},e={start:this.j.marginTop,end:this.j.marginBottom,ca:this.j.Gb};hp(this,b.top,!0,d,a,c);hp(this,b.bottom,!0,d,a,c);hp(this,b.left,!1,e,a,c);hp(this,b.right,!1,e,a,c)};
function ip(a,b,c,d,e){this.N=a;this.l=e;this.g=c;this.k=!X(d,b[c?"width":"height"],new Qc(d,0,"px"));this.h=null}ip.prototype.b=function(){return this.k};function jp(a){a.h||(a.h=Io(a.l,a.N.d,a.g?["max-content width","min-content width"]:["max-content height","min-content height"]));return a.h}ip.prototype.e=function(){var a=jp(this);return this.g?Ei(this.N)+a["max-content width"]+Fi(this.N):Ci(this.N)+a["max-content height"]+Di(this.N)};
ip.prototype.f=function(){var a=jp(this);return this.g?Ei(this.N)+a["min-content width"]+Fi(this.N):Ci(this.N)+a["min-content height"]+Di(this.N)};ip.prototype.d=function(){return this.g?Ei(this.N)+this.N.width+Fi(this.N):Ci(this.N)+this.N.height+Di(this.N)};function kp(a){this.g=a}kp.prototype.b=function(){return this.g.some(function(a){return a.b()})};kp.prototype.e=function(){var a=this.g.map(function(a){return a.e()});return Math.max.apply(null,a)*a.length};
kp.prototype.f=function(){var a=this.g.map(function(a){return a.f()});return Math.max.apply(null,a)*a.length};kp.prototype.d=function(){var a=this.g.map(function(a){return a.d()});return Math.max.apply(null,a)*a.length};function lp(a,b,c,d,e,f){ip.call(this,a,b,c,d,e);this.j=f}t(lp,ip);lp.prototype.b=function(){return!1};lp.prototype.e=function(){return this.d()};lp.prototype.f=function(){return this.d()};lp.prototype.d=function(){return this.g?Ei(this.N)+this.j+Fi(this.N):Ci(this.N)+this.j+Di(this.N)};
function hp(a,b,c,d,e,f){var g=a.d.d,h={},l={},k={},m;for(m in b){var p=Zo[m];if(p){var r=b[m],v=a.ma[m],q=new ip(r,v.style,c,g,f);h[p.la]=r;l[p.la]=v;k[p.la]=q}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.ca.evaluate(e);var w=mp(k,b),M=!1,da={};Object.keys(h).forEach(function(a){var b=X(g,l[a].style[c?"max-width":"max-height"],d.ca);b&&(b=b.evaluate(e),w[a]>b&&(b=k[a]=new lp(h[a],l[a].style,c,g,f,b),da[a]=b.d(),M=!0))});M&&(w=mp(k,b),M=!1,["start","center","end"].forEach(function(a){w[a]=da[a]||
w[a]}));var oa={};Object.keys(h).forEach(function(a){var b=X(g,l[a].style[c?"min-width":"min-height"],d.ca);b&&(b=b.evaluate(e),w[a]<b&&(b=k[a]=new lp(h[a],l[a].style,c,g,f,b),oa[a]=b.d(),M=!0))});M&&(w=mp(k,b),["start","center","end"].forEach(function(a){w[a]=oa[a]||w[a]}));var Ea=a+b,Ta=a+(a+b);["start","center","end"].forEach(function(a){var b=w[a];if(b){var d=h[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(Ta-b)/2;break;case "end":e=Ea-b}c?Ii(d,e,b-Ei(d)-Fi(d)):Hi(d,e,
b-Ci(d)-Di(d))}})}function mp(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=np(d,g.length?new kp(g):null,b);g.Ra&&(f.center=g.Ra);d=g.Ra||d.d();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=np(c,e,b),c.Ra&&(f.start=c.Ra),c.jc&&(f.end=c.jc);return f}
...
function fp(a,b){Vl.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.Gb=this.Hb=null}t(fp,Vl);
...
d["padding-bottom"]=new K(c.marginBottom)};fp.prototype.Wc=function(){var a=op(this,{start:"left",end:"right",ca:"width"});this.Hb=a.Fd;this.marginLeft=a.Nd;this.marginRight=a.Md};fp.prototype.Xc=function(){var a=op(this,{start:"top",end:"bottom",ca:"height"});this.Gb=a.Fd;this.marginTop=a.Nd;this.marginBottom=a.Md};
...
me;c["margin-"+f]=me;c["padding-"+e]=new K(p);c["padding-"+f]=new K(r);c["border-"+e+"-width"]=new K(v);c["border-"+f+"-width"]=new K(q);c[g]=new K(l);c["max-"+g]=new K(l);return{Fd:G(d,h,E(d,k,m)),Nd:k,Md:m}}fp.prototype.rb=function(a,b,c,d,e){Vl.prototype.rb.call(this,a,b,c,d,e);c.w=b.d};function gp(a,b){Vl.call(this,a,b);var c=b.k;this.j=Zo[c];a.ma[c]=this;this.oa=!0}t(gp,Vl);n=gp.prototype;
...
function pp(a,b,c){function d(a){if(w)return w;w={ca:q?q.evaluate(a):null,La:l?l.evaluate(a):null,Ma:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[r,m,p,v].forEach(function(b){b&&(c+=b.evaluate(a))});(null===w.La||null===w.Ma)&&c+w.ca+w.La+w.Ma>b&&(null===w.La&&(w.La=0),null===w.Ma&&(w.Fe=0));null!==w.ca&&null!==w.La&&null!==w.Ma&&(w.Ma=null);null===w.ca&&null!==w.La&&null!==w.Ma?w.ca=b-c-w.La-w.Ma:null!==w.ca&&null===w.La&&null!==w.Ma?w.La=b-c-w.ca-w.Ma:null!==w.ca&&null!==w.La&&null===w.Ma?w.Ma=
...
f]=new K(new ic(a,function(){var a=d(this).La;return null===a?0:a},"margin-"+f));e["margin-"+g]=new K(new ic(a,function(){var a=d(this).Ma;return null===a?0:a},"margin-"+g));"left"===f?e.left=new K(E(a,c.marginLeft,c.Hb)):"top"===f&&(e.top=new K(E(a,c.marginTop,c.Gb)))}n.Wc=function(){var a=this.e.j;this.j.wa?pp(this,{Yc:"right",bd:"left",ca:"width"},a):this.j.xa?pp(this,{Yc:"left",bd:"right",ca:"width"},a):this.la({start:"left",end:"right",ca:"width"},a)};
n.Xc=function(){var a=this.e.j;this.j.ya?pp(this,{Yc:"bottom",bd:"top",ca:"height"},a):this.j.va?pp(this,{Yc:"top",bd:"bottom",ca:"height"},a):this.la({start:"top",end:"bottom",ca:"height"},a)};n.sc=function(a,b,c,d,e,f,g){Vl.prototype.sc.call(this,a,b,c,d,e,f,g);a=c.u;c=this.d.k;d=this.j;d.wa||d.xa?d.ya||d.va||(d.wa?a.left[c]=b:d.xa&&(a.right[c]=b)):d.ya?a.top[c]=b:d.va&&(a.bottom[c]=b)};
function qp(a,b,c,d,e){this.b=a;this.h=b;this.f=c;this.d=d;this.e=e;this.g={};a=this.h;b=new Rc(a,"page-number");b=new Jc(a,new Pc(a,b,new B(a,2)),a.b);c=new zc(a,b);a.values["recto-page"]=c;a.values["verso-page"]=b;"ltr"===Jo(this.e)?(a.values["left-page"]=b,b=new zc(a,b),a.values["right-page"]=b):(c=new zc(a,b),a.values["left-page"]=c,a.values["right-page"]=b)}function rp(a){var b={};Fk(a.b,[],"",b);a.b.pop();return b}
function sp(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof V?e.value+"":sp(a,e);c.push(d+f+(e.Ga||""))}return c.sort().join("^")}function tp(a){this.b=null;this.f=a}t(tp,W);tp.prototype.apply=function(a){a.S===this.f&&this.b.apply(a)};tp.prototype.d=function(){return 3};tp.prototype.e=function(a){this.b&&zj(a.Yb,this.f,this.b);return!0};function up(a){this.b=null;this.f=a}t(up,W);
up.prototype.apply=function(a){1===(new Rc(this.f,"page-number")).evaluate(a.g)&&this.b.apply(a)};up.prototype.d=function(){return 2};function vp(a){this.b=null;this.f=a}t(vp,W);vp.prototype.apply=function(a){(new Rc(this.f,"left-page")).evaluate(a.g)&&this.b.apply(a)};vp.prototype.d=function(){return 1};function wp(a){this.b=null;this.f=a}t(wp,W);wp.prototype.apply=function(a){(new Rc(this.f,"right-page")).evaluate(a.g)&&this.b.apply(a)};wp.prototype.d=function(){return 1};
function xp(a){this.b=null;this.f=a}t(xp,W);xp.prototype.apply=function(a){(new Rc(this.f,"recto-page")).evaluate(a.g)&&this.b.apply(a)};xp.prototype.d=function(){return 1};function yp(a){this.b=null;this.f=a}t(yp,W);yp.prototype.apply=function(a){(new Rc(this.f,"verso-page")).evaluate(a.g)&&this.b.apply(a)};yp.prototype.d=function(){return 1};function zp(a,b){xj.call(this,a,b,null,null)}t(zp,xj);
zp.prototype.apply=function(a){var b=a.g,c=a.u,d=this.style;a=this.P;qj(b,c,d,a,null,null);if(d=d._marginBoxes){var c=oj(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);qj(b,f,d[e],a,null,null)}}};function Ap(a,b,c,d,e){Qk.call(this,a,b,null,c,null,d,!1);this.I=e;this.B=[];this.e="";this.u=[]}t(Ap,Qk);n=Ap.prototype;n.Mb=function(){this.eb()};n.hb=function(a,b){if(this.e=b)this.b.push(new tp(b)),this.P+=65536};
n.Zb=function(a,b){b&&If(this,"E_INVALID_PAGE_SELECTOR :"+a+"("+b.join("")+")");this.u.push(":"+a);switch(a.toLowerCase()){case "first":this.b.push(new up(this.d));this.P+=256;break;case "left":this.b.push(new vp(this.d));this.P+=1;break;case "right":this.b.push(new wp(this.d));this.P+=1;break;case "recto":this.b.push(new xp(this.d));this.P+=1;break;case "verso":this.b.push(new yp(this.d));this.P+=1;break;default:If(this,"E_INVALID_PAGE_SELECTOR :"+a)}};
function Bp(a){var b;a.e||a.u.length?b=[a.e].concat(a.u.sort()):b=null;a.B.push({Ad:b,P:a.P});a.e="";a.u=[]}n.Jb=function(){Bp(this);Qk.prototype.Jb.call(this)};n.ra=function(){Bp(this);Qk.prototype.ra.call(this)};
n.cb=function(a,b,c){if("bleed"!==a&&"marks"!==a||this.B.some(function(a){return null===a.Ad})){Qk.prototype.cb.call(this,a,b,c);var d=this.h[a],e=this.I;if("bleed"===a||"marks"===a)e[""]||(e[""]={}),Object.keys(e).forEach(function(b){nj(e[b],a,d)});else if("size"===a){var f=e[""];this.B.forEach(function(b){var c=new V(d.value,d.Ga+b.P);b=b.Ad?b.Ad.join(""):"";var l=e[b];l?(c=(b=l[a])?kj(null,c,b):c,nj(l,a,c)):(l=e[b]={},nj(l,a,c),f&&["bleed","marks"].forEach(function(a){f[a]&&nj(l,a,f[a])},this))},
this)}}};n.Jd=function(a){zj(this.g.Yb,"*",a)};n.Ld=function(a){return new zp(this.h,a)};n.jd=function(a){var b=oj(this.h,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);Ef(this.$,new Cp(this.d,this.$,this.k,c))};function Cp(a,b,c,d){Ff.call(this,a,b,!1);this.e=c;this.b=d}t(Cp,Gf);Cp.prototype.bb=function(a,b,c){fh(this.e,a,b,c,this)};Cp.prototype.Wb=function(a,b){Hf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Cp.prototype.Hc=function(a,b){Hf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
Cp.prototype.cb=function(a,b,c){nj(this.b,a,new V(b,c?Bf(this):Cf(this)))};var Dp=new xf(function(){var a=L("uaStylesheetBase");vf(gh).then(function(b){var c=va("user-agent-base.css",ua);b=new Qk(null,null,null,null,null,b,!0);b.Nb("UA");Pk=b.g;gg(c,b,null,null).ua(a)});return O(a)},"uaStylesheetBaseFetcher");
function Ep(a,b,c,d,e,f,g,h,l,k){this.h=a;this.d=b;this.b=c;this.e=d;this.B=e;this.g=f;this.l=a.H;this.u=g;this.f=h;this.k=l;this.w=k;this.j=a.f;kc(this.b,function(a){var b=this.b,c;c=(c=b.b[a])?(c=c.b[0])?c.b:null:null;var d;d=b.b[a];if(d=Fp(this,d?d.d:"any"))d=(a=b.b[a])?0<a.b.length&&a.b[0].b.d<=this.l:!1;return d&&!!c&&!Gp(this,c)});jc(this.b,new ic(this.b,function(){return this.ma+this.b.page},"page-number"))}
function Hp(a,b,c,d){if(a.k.length){var e=new nc(0,b,c,d);a=a.k;for(var f={},g=0;g<a.length;g++)qj(e,f,a[g],0,null,null);g=f.width;a=f.height;var f=f["text-zoom"],h=1;if(g&&a||f){var l=lc.em;(f?f.evaluate(e,"text-zoom"):null)===Yd&&(h=l/d,d=l,b*=h,c*=h);if(g&&a&&(g=qd(g.evaluate(e,"width"),e),e=qd(a.evaluate(e,"height"),e),0<g&&0<e))return{width:g,height:e,fontSize:d}}}return{width:b,height:c,fontSize:d}}
function Ip(a,b,c,d,e,f,g,h,l,k,m){nc.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.X=b;this.lang=b.lang||c;this.viewport=d;this.g={body:!0};this.e=e;this.k=this.b=this.B=this.d=this.u=null;this.l=0;this.$a=f;this.h=new nh(this.style.l);this.ka={};this.O=null;this.f=m;this.I={};this.ba=null;this.Sa=g;this.Za=h;this.ma=l;this.Ya=k;for(var p in a.f)(b=a.f[p]["flow-consume"])&&(b.evaluate(this,"flow-consume")==sd?this.g[p]=!0:delete this.g[p]);this.oa={}}t(Ip,nc);
function Jp(a){var b=L("StyleInstance.init"),c=new Om(a.f,a.X.url),d=new Pm(a.f,a.X.url,a.style.d,a.style.b);a.d=new ul(a.X,a.style.e,a.style.d,a,a.g,a.style.j,c,d);d.f=a.d;Gl(a.d,a);a.B={};a.B[a.X.url]=a.d;var e=Dl(a.d);a.ba=Jo(e);a.u=new wm(a.style.B);c=new Ck(a.style.e,a,c,d);a.u.h(c,e);vm(a.u,a);a.O=new qp(c,a.style.b,a.u,a,e);e=[];for(c=0;c<a.style.g.length;c++)if(d=a.style.g[c],!d.M||d.M.evaluate(a))d=kh(d.Bb,a),d=new lh(d),e.push(d);th(a.$a,e,a.h).ua(b);var f=a.style.w;Object.keys(f).forEach(function(a){var b=
Qo(Po(f[a]),this);this.oa[a]={width:b.pb+2*b.Rc,height:b.ob+2*b.Rc}},a);return O(b)}function Hl(a,b,c){if(a=a.b)a.e[b.b]||(a.e[b.b]=c),c=a.b[b.b],c||(c=new xi,a.b[b.b]=c),c.b.push(new wi(new ui({ga:[{fa:b.h,Ha:0,ea:null,sa:null,qa:null}],da:0,J:!1}),b))}function Kp(a,b){for(var c=Number.POSITIVE_INFINITY,d=0;d<b.b.length;d++){for(var e=b.b[d].d.Na,f=e.ga[0].fa,g=e.da,h=e.J,l=0;f.ownerDocument!=a.X.b;)l++,f=e.ga[l].fa,h=!1,g=0;e=yh(a.X,f,g,h);e<c&&(c=e)}return c}
function Lp(a,b){if(!b)return 0;var c=Number.POSITIVE_INFINITY,d;for(d in a.g){var e=b.b[d];if((!e||0==e.b.length)&&a.b){e=a.d;e.D=d;for(var f=0;null!=e.D&&(f+=5E3,El(e,f,0)!=Number.POSITIVE_INFINITY););e=a.b.b[d];b!=a.b&&e&&(e=e.clone(),b.b[d]=e)}e&&(e=Kp(a,e),e<c&&(c=e))}return c}function Fp(a,b){switch(b){case "left":case "right":case "recto":case "verso":return(new Rc(a.style.b,b+"-page")).evaluate(a);default:return!0}}
function Mp(a,b){var c=a.b,d=Lp(a,c);if(d==Number.POSITIVE_INFINITY)return null;for(var e=a.u.children,f,g=0;g<e.length;g++)if(f=e[g],"vivliostyle-page-rule-master"!==f.d.sb){var h=1,l=hm(f,a,"utilization");l&&l.xd()&&(h=l.C);var l=pc(a,"em",!1),k=a.pb()*a.ob();a.l=El(a.d,d,Math.ceil(h*k/(l*l)));h=a;l=c;k=void 0;for(k in l.b){var m=l.b[k];if(m&&0<m.b.length){var p=m.b[0].b;if(Kp(h,m)===p.d){a:switch(p=m.d,p){case "left":case "right":case "recto":case "verso":break a;default:p=null}m.d=on(ml(p,m.b[0].b.e))}}}a.k=
c.clone();h=a;l=h.b.page;k=void 0;for(k in h.b.b)for(m=h.b.b[k],p=m.b.length-1;0<=p;p--){var r=m.b[p];0>r.b.g&&r.b.d<h.l&&(r.b.g=l)}oc(a,a.style.b);h=hm(f,a,"enabled");if(!h||h===ie){c=a;u.debug("Location - page",c.b.page);u.debug("  current:",d);u.debug("  lookup:",c.l);d=void 0;for(d in c.b.b)for(e=c.b.b[d],g=0;g<e.b.length;g++)u.debug("  Chunk",d+":",e.b[g].b.d);d=a.O;e=b;g=f.d;if(0===Object.keys(e).length)g.d.e=g;else{f=g;c=sp(d,e);f=f.g+"^"+c;c=d.g[f];if(!c){if("background-host"===g.sb)c=d,e=
(new ap(c.h,c.f.d,e)).f(c.f),e.h(c.b,c.e),vm(e,c.d),c=e;else{c=d;h=e;e=g.clone({sb:"vivliostyle-page-rule-master"});if(g=h.size)h=Po(h),g=g.Ga,e.b.width=kj(c.d,e.b.width,new V(h.width,g)),e.b.height=kj(c.d,e.b.height,new V(h.height,g));e=e.f(c.f);e.h(c.b,c.e);vm(e,c.d);c=e}d.g[f]=c}f=c.d;f.d.e=f;f=c}return f}}throw Error("No enabled page masters");}
function Gp(a,b){var c=a.k.e,d=c[b.b].d;if(d){var e=b.d,f=c[d].b;if(!f.length||e<f[0])return!1;var c=Ra(f.length,function(a){return f[a]>e})-1,c=f[c],d=a.k.b[d],g=Kp(a,d);return c<g?!1:g<c?!0:!Fp(a,d.d)}return!1}
function Np(a,b,c){var d=a.b.b[c];if(!d||!Fp(a,d.d))return N(!0);d.d="any";Pn(b);a.g[c]&&0<b.gb.length&&(b.Gd=!1);var e=L("layoutColumn"),f=[],g=[],h=!0;of(function(c){for(;0<d.b.length-g.length;){for(var e=0;0<=g.indexOf(e);)e++;var m=d.b[e];if(m.b.d>a.l||Gp(a,m.b))break;for(var p=e+1;p<d.b.length;p++)if(!(0<=g.indexOf(p))){var r=d.b[p];if(r.b.d>a.l||Gp(a,r.b))break;fi(r.b,m.b)&&(m=r,e=p)}var v=m.b,q=!0;Sn(b,m.d,h).then(function(a){h=!1;m.b.ge&&(null===a||v.f)&&f.push(e);v.f?(g.push(e),Q(c)):(a?
m.d=a:g.push(e),b.h&&(d.d=on(b.h)),a||b.h?Q(c):q?q=!1:qf(c))});if(q){q=!1;return}}Q(c)}).then(function(){d.b=d.b.filter(function(a,b){return 0<=f.indexOf(b)||0>g.indexOf(b)});P(e,!0)});return O(e)}
function Op(a,b,c,d,e,f,g,h){am(c);var l=hm(c,a,"enabled");if(l&&l!==ie)return N(!0);var k=L("layoutContainer"),m=hm(c,a,"wrap-flow")===ud,p=c.b?c.g&&c.H:c.f&&c.I,l=hm(c,a,"flow-from"),r=a.viewport.b.createElement("div"),v=hm(c,a,"position");x(r,"position",v?v.name:"absolute");d.insertBefore(r,d.firstChild);var q=new Bi(r);q.b=c.b;c.rb(a,q,b,a.h,a.e);q.D=e;q.H=f;e+=q.left+q.marginLeft+q.S;f+=q.top+q.marginTop+q.ba;if(l&&l.Kd())if(a.I[l.toString()])c.sc(a,q,b,null,1,a.e,a.h),l=N(!0);else{var w=L("layoutContainer.inner"),
M=l.toString(),da=Y(c,a,"column-count"),oa=Y(c,a,"column-gap"),Ea=1<da?Y(c,a,"column-width"):q.width,l=gm(c,a),Ta=0,v=hm(c,a,"shape-inside"),U=pg(v,0,0,q.width,q.height,a),F=new Mm(M,a,a.viewport,a.d,l,a.X,a.h,a.style.u,a,b,a.Sa,a.Za,h,a.Ya),Ga=new mo(a.f,a.b.page-1),ai=0,ba=null;of(function(b){for(;ai<da;){var c=ai++;if(1<da){var d=a.viewport.b.createElement("div");x(d,"position","absolute");r.appendChild(d);ba=new wn(d,F,a.e,Ga);ba.b=q.b;ba.$a=q.$a;ba.kc=q.kc;q.b?(x(d,"margin-left",q.j+"px"),x(d,
"margin-right",q.w+"px"),c=c*(Ea+oa)+q.k,Ii(ba,0,q.width),Hi(ba,c,Ea)):(x(d,"margin-top",q.k+"px"),x(d,"margin-bottom",q.u+"px"),c=c*(Ea+oa)+q.j,Hi(ba,0,q.height),Ii(ba,c,Ea));ba.D=e+q.j;ba.H=f+q.k}else ba=new wn(r,F,a.e,Ga),Gi(ba,q),q=ba;ba.I=p?[]:g;ba.xb=U;if(0<=ba.width){var k=L("inner");Np(a,ba,M).then(function(){ba.h&&"column"!=ba.h&&(ai=da,"region"!=ba.h&&(a.I[M]=!0));P(k,!0)});c=O(k)}else c=N(!0);if(c.Ca()){c.then(function(){0<h.b.length?Q(b):(Ta=Math.max(Ta,ba.e),qf(b))});return}0<h.b.length||
(Ta=Math.max(Ta,ba.e))}Q(b)}).then(function(){q.e=Ta;c.sc(a,q,b,ba,da,a.e,a.h);P(w,!0)});l=O(w)}else{l=hm(c,a,"content");v=!1;if(l&&Ki(l)){var Al=a.viewport.b.createElement("span");l.U(new Ji(Al,a));r.appendChild(Al);um(c,a,q,a.h)}else c.oa&&(d.removeChild(r),v=!0);v||c.sc(a,q,b,null,1,a.e,a.h);l=N(!0)}l.then(function(){if(!c.f||0<Math.floor(q.e)){if(!m){var l=q.D+q.left,p=q.H+q.top,v=Ei(q)+q.width+Fi(q),w=Ci(q)+q.height+Di(q),F=hm(c,a,"shape-outside"),l=pg(F,l,p,v,w,a);bb(a.viewport.root)&&g.push(xe(l,
0,-1.25*pc(a,"em",!1)));g.push(l)}}else if(0==c.children.length){d.removeChild(r);P(k,!0);return}var M=c.children.length-1;nf(function(){for(;0<=M;){var d=c.children[M--],d=Op(a,b,d,r,e,f,g,h);if(d.Ca())return d}return N(!1)}).then(function(){P(k,!0)})});return O(k)}
function Pp(a,b,c){a.I={};c?(a.b=c.clone(),xl(a.d,c.d)):(a.b=new zi,xl(a.d,-1));a.lang&&b.d.setAttribute("lang",a.lang);c=a.b;c.page++;oc(a,a.style.b);a.k=c.clone();var d=rp(a.O),e=Mp(a,d);if(!e)return N(null);e.d.b.width.value===ke&&Xh(b);e.d.b.height.value===le&&Yh(b);a.f.g=b;vo(a.f,d,a);var f=Qo(Po(d),a);Qp(a,f,b);Xo(d,f,b,a);var g=f.kb+f.zb,d=hm(e,a,"writing-mode")||Hd,f=hm(e,a,"direction")||Qd,h=new Qi(b.B.bind(b),d,f),l=[],k=L("layoutNextPage");of(function(d){Op(a,b,e,b.d,g,g,l.concat(),h).then(function(){if(0<
h.b.length){l=l.concat(Vi(h));h.b.splice(0,h.b.length);c=a.b=a.k.clone();for(var e;e=b.d.lastChild;)b.d.removeChild(e);qf(d)}else Q(d)})}).then(function(){e.S(a,b,a.e);var d=new Rc(e.d.d,"left-page");b.j=d.evaluate(a)?"left":"right";var d=a.b.page,f;for(f in a.b.b)for(var g=a.b.b[f],h=g.b.length-1;0<=h;h--){var l=g.b[h];0<=l.b.g&&l.b.g+l.b.k-1<=d&&g.b.splice(h,1)}a.b=a.k=null;c.d=a.d.b;$h(b,a.style.h.D[a.X.url]);var w;a:{for(w in a.g)if((f=c.b[w])&&0<f.b.length){w=!1;break a}w=!0}w&&(c=null);P(k,
c)});return O(k)}function Qp(a,b,c){a.H=b.pb;a.D=b.ob;c.N.style.width=b.pb+2*b.Rc+"px";c.N.style.height=b.ob+2*b.Rc+"px";c.d.style.left=b.kb+"px";c.d.style.right=b.kb+"px";c.d.style.top=b.kb+"px";c.d.style.bottom=b.kb+"px";c.d.style.padding=b.zb+"px"}function Rp(a,b,c,d){Qk.call(this,a.g,a,b,c,d,a.f,!c);this.e=a;this.u=!1}t(Rp,Qk);n=Rp.prototype;n.Cc=function(){};n.Bc=function(a,b,c){a=new Ql(this.e.j,a,b,c,this.e.w,this.M,Cf(this.$));Ef(this.e,new Bm(a.d,this.e,a,this.k))};
n.Cb=function(a){a=a.d;null!=this.M&&(a=Xc(this.d,this.M,a));Ef(this.e,new Rp(this.e,a,this,this.w))};n.yc=function(){Ef(this.e,new Wk(this.d,this.$))};n.Ac=function(){var a={};this.e.k.push({Bb:a,M:this.M});Ef(this.e,new Xk(this.d,this.$,null,a,this.e.f))};n.zc=function(a){var b=this.e.h[a];b||(b={},this.e.h[a]=b);Ef(this.e,new Xk(this.d,this.$,null,b,this.e.f))};n.Ec=function(){var a={};this.e.B.push(a);Ef(this.e,new Xk(this.d,this.$,this.M,a,this.e.f))};
n.cc=function(a){var b=this.e.l;if(a){var c=oj(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Ef(this.e,new Xk(this.d,this.$,null,b,this.e.f))};n.Dc=function(){this.u=!0;this.eb()};n.Mb=function(){var a=new Ap(this.e.j,this.e,this,this.k,this.e.u);Ef(this.e,a);a.Mb()};n.ra=function(){Qk.prototype.ra.call(this);if(this.u){this.u=!1;var a="R"+this.e.H++,b=I(a),c;this.M?c=new jj(b,0,this.M):c=new V(b,0);pj(this.h,"region-id").push(c);this.mb();a=new Rp(this.e,this.M,this,a);Ef(this.e,a);a.ra()}};
function Sp(a){var b=a.getAttribute("content");if(!b)return"";a={};for(var c;null!=(c=b.match(/^,?\s*([-A-Za-z_.][-A-Za-z_0-9.]*)\s*=\s*([-+A-Za-z_0-9.]*)\s*/));)b=b.substr(c[0].length),a[c[1]]=c[2];b=a.width-0;a=a.height-0;return b&&a?"@-epubx-viewport{width:"+b+"px;height:"+a+"px;}":""}function Tp(a){Df.call(this);this.f=a;this.g=new gc(null);this.j=new gc(this.g);this.w=new Nl(this.g);this.D=new Rp(this,null,null,null);this.H=0;this.k=[];this.l={};this.h={};this.B=[];this.u={};this.b=this.D}
t(Tp,Df);Tp.prototype.error=function(a){u.b("CSS parser:",a)};function Up(a,b){return Vp(b,a)}function Wp(a){uf.call(this,Up,"document");this.H=a;this.B={};this.h={};this.b={};this.D={};this.f=null;this.j=[]}t(Wp,uf);function Xp(a){var b=va("user-agent.xml",ua),c=L("OPSDocStore.init");vf(gh).then(function(d){a.f=d;vf(Dp).then(function(){a.load(b).then(function(){P(c,!0)})})});return O(c)}function Yp(a,b){a.j.push({url:b.url,text:b.text,ab:"User",Ba:null,media:null})}
function Vp(a,b){var c=L("OPSDocStore.load"),d=b.url;Gh(b,a).then(function(b){if(b){for(var f=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),h=0;h<g.length;h++){var l=g[h],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=l.getAttribute("action"),l=l.getAttribute("ref");k&&m&&p&&l&&f.push({de:k,event:m,action:p,ac:l})}a.D[d]=f;var r=[],f=va("user-agent-page.css",ua);r.push({url:f,text:null,
...
k&&"viewport"==g.getAttribute("name")&&r.push({url:d,text:Sp(g),ab:"Author",M:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==h?"stylesheet"==k&&"text/css"==g.getAttribute("type")&&r.push({url:d,text:g.textContent,ab:"Author",Ba:null,media:null}):"http://example.com/sse"==h&&"property"===k&&(h=g.getElementsByTagName("name")[0])&&"stylesheet"===h.textContent&&(g=g.getElementsByTagName("value")[0])&&(g=va(g.textContent,d),r.push({url:g,text:null,Ba:null,media:null,ab:"Author"}));
for(var v="",h=0;h<r.length;h++)v+=r[h].url,v+="^",r[h].text&&(v+=r[h].text),v+="^";var q=a.B[v];q?(a.b[d]=q,P(c,b)):(f=a.h[v],f||(f=new xf(function(){var b=L("fetchStylesheet"),c=0,d=new Tp(a.f);nf(function(){if(c<r.length){var a=r[c++];d.Nb(a.ab);return null!==a.text?hg(a.text,d,a.url,a.Ba,a.media).kd(!0):gg(a.url,d,a.Ba,a.media)}return N(!1)}).then(function(){q=new Ep(a,d.g,d.j,d.D.g,d.w,d.k,d.l,d.h,d.B,d.u);a.B[v]=q;delete a.h[v];P(b,q)});return O(b)},"FetchStylesheet "+d),a.h[v]=f,f.start()),
vf(f).then(function(f){a.b[d]=f;P(c,b)}))}else P(c,null)});return O(c)};function Zp(a,b,c,d,e,f,g,h,l,k){this.b=a;this.url=b;this.lang=c;this.d=d;this.h=e;this.T=Zb(f);this.j=g;this.g=h;this.f=l;this.e=k;this.Ja=this.page=null}function $p(a,b,c){if(0!=c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=Ia(d,"height","auto")&&(x(d,"height","auto"),$p(a,d,c));"absolute"==Ia(d,"position","static")&&(x(d,"position","relative"),$p(a,d,c))}}
...
Zp.prototype.$c=function(a){var b=this.j.$c(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",x(e,"cursor","pointer"),e.addEventListener("click",aq,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
e.textContent="\u25b9",x(e,"margin-left","-1em"),x(e,"display","inline-block"),x(e,"width","1em"),x(e,"text-align","left"),x(e,"cursor","default"),x(e,"font-family","Menlo,sans-serif"),g.appendChild(e),x(g,"overflow","hidden"),g.setAttribute("data-adapt-class","toc-node"),"toc-node"!=a&&"toc-container"!=a||x(g,"height","0px")):"toc-node"==a&&g.setAttribute("data-adapt-class","toc-container");return N(g)}};
Zp.prototype.xc=function(a,b,c,d,e){if(this.page)return N(this.page);var f=this,g=L("showTOC"),h=new Wh(a,a);this.page=h;this.b.load(this.url).then(function(d){var k=f.b.b[d.url],m=Hp(k,c,1E5,e);b=new mn(b.f,m.fontSize,b.root,m.width,m.height);var p=new Ip(k,d,f.lang,b,f.d,f.h,f.$c(d),f.g,0,f.f,f.e);f.Ja=p;p.T=f.T;Jp(p).then(function(){Pp(p,h,null).then(function(){$p(f,a,2);P(g,h)})})});return O(g)};
Zp.prototype.tc=function(){if(this.page){var a=this.page;this.Ja=this.page=null;x(a.N,"visibility","none");var b=a.N.parentNode;b&&b.removeChild(a.N)}};Zp.prototype.yd=function(){return!!this.page};function bq(){Wp.call(this,cq(this));this.d=new uf(Gh,"document");this.u=new uf(yf,"text");this.w={};this.O={};this.k={};this.l={}}t(bq,Wp);function cq(a){return function(b){return a.k[b]}}
function dq(a,b,c){var d=L("loadEPUBDoc");"/"!==b.substring(b.length-1)&&(b+="/");c&&a.u.qc(b+"?r=list");a.d.qc(b+"META-INF/encryption.xml");var e=b+"META-INF/container.xml";a.d.load(e,!0,"Failed to fetch EPUB container.xml from "+e).then(function(f){if(f){f=Qh(vh(vh(vh(new wh([f.b]),"container"),"rootfiles"),"rootfile"),"full-path");for(var g=0;g<f.length;g++){var h=f[g];if(h){eq(a,b,h,c).ua(d);return}}P(d,null)}else u.error("Received an empty response for EPUB container.xml "+e+". This may be caused by the server not allowing cross origin requests.")});
return O(d)}function eq(a,b,c,d){var e=b+c,f=a.w[e];if(f)return N(f);var g=L("loadOPF");a.d.load(e,void 0,void 0).then(function(c){c?a.d.load(b+"META-INF/encryption.xml",void 0,void 0).then(function(l){(d?a.u.load(b+"?r=list"):N(null)).then(function(d){f=new fq(a,b);gq(f,c,l,d,b+"?r=manifest").then(function(){a.w[e]=f;a.O[b]=f;P(g,f)})})}):u.error("Received an empty response for EPUB OPF "+e+". This may be caused by the server not allowing cross origin requests.")});return O(g)}
function hq(a,b,c){var d=L("EPUBDocStore.load");b=ta(b);(a.l[b]=Vp(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,wc:null})).ua(d);return O(d)}
bq.prototype.load=function(a){var b=ta(a);if(a=this.l[b])return a.Ca()?a:N(a.mc());var c=L("EPUBDocStore.load");a=bq.Pd.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?P(c,a):u.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return O(c)};function iq(){this.id=null;this.src="";this.f=this.d=null;this.F=-1;this.h=0;this.j=null;this.b=this.e=0;this.g=Va}function jq(a){return a.id}
function kq(a){var b=Qe(a);return function(a){var d=L("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));tf(e).then(function(a){a=new DataView(a);for(var c=0;c<a.byteLength;c++){var e=a.getUint8(c),e=e^b[c%20];a.setUint8(c,e)}P(d,sf([a,f]))});return O(d)}}
...
function pq(a,b){function c(a){for(var b in a){var d=a[b];d.sort(oq(b,k));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return Ya(a,function(a){return Xa(a,function(a){var b={v:a.value,o:a.Q};a.Ge&&(b.s=a.scheme);if(a.id||a.lang){var c=l[a.id];if(c||a.lang)a.lang&&(a={name:mq,value:a.lang,lang:null,id:null,gd:a.id,scheme:null,Q:a.Q},c?c.push(a):c=[a]),c=Wa(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in lq)f[g]=lq[g];for(;null!=(g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/));)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=lq;var h=1;g=Oh(Ph(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),Q:h++,gd:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:lq.dcterms+a.localName,Q:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),gd:null,scheme:null};return null});var l=Wa(g,function(a){return a.gd});g=d(Wa(g,function(a){return a.gd?null:a.name}));var k=null;g[mq]&&(k=g[mq][0].v);c(g);return g}function qq(){var a=window.MathJax;return a?a.Hub:null}var rq={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function fq(a,b){this.f=a;this.h=this.d=this.b=this.g=this.e=null;this.l=b;this.k=null;this.I={};this.lang=null;this.w=0;this.u={};this.O=this.H=this.S=null;this.B={};this.D=null;this.j=sq(this);qq()&&($i["http://www.w3.org/1998/Math/MathML"]=!0)}
function sq(a){function b(){}b.prototype.Gc=function(a,b){return encodeURIComponent(b+(a?"#"+a:""))};b.prototype.b=function(b,d){var e=b.match(/^([^#]*)#?(.*)$/);if(e){var f=e[1]||d,e=e[2];if(f&&a.g.some(function(a){return a.src===f}))return"#"+this.Gc(e,f)}return b};b.prototype.he=function(a){"#"===a.charAt(0)&&(a=a.substring(1));return(a=decodeURIComponent(a).match(/^([^#]*)#?(.*)$/))?[a[1],a[2]]:[]};return new b}
function tq(a,b){return a.l?b.substr(0,a.l.length)==a.l?decodeURI(b.substr(a.l.length)):null:b}
function gq(a,b,c,d,e){a.e=b;var f=vh(new wh([b.b]),"package"),g=Qh(f,"unique-identifier")[0];g&&(g=Ch(b,b.url+"#"+g))&&(a.k=g.textContent.replace(/[ \n\r\t]/g,""));var h={};a.g=Xa(Mh(vh(vh(f,"manifest"),"item")),function(c){var d=new iq,e=b.url;d.id=c.getAttribute("id");d.src=va(c.getAttribute("href"),e);d.d=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.g=f}(c=c.getAttribute("fallback"))&&!rq[d.d]&&(h[d.src]=c);!a.H&&
d.g.nav&&(a.H=d);!a.O&&d.g["cover-image"]&&(a.O=d);return d});a.d=Ua(a.g,jq);a.h=Ua(a.g,function(b){return tq(a,b.src)});for(var l in h)for(g=l;;){g=a.d[h[g]];if(!g)break;if(rq[g.d]){a.B[l]=g.src;break}g=g.src}a.b=Xa(Mh(vh(vh(f,"spine"),"itemref")),function(b,c){var d=b.getAttribute("idref");if(d=a.d[d])d.f=b,d.F=c;return d});if(l=Qh(vh(f,"spine"),"toc")[0])a.S=a.d[l];if(l=Qh(vh(f,"spine"),"page-progression-direction")[0]){a:switch(l){case "ltr":l="ltr";break a;case "rtl":l="rtl";break a;default:throw Error("unknown PageProgression: "+
l);}a.D=l}var g=c?Qh(vh(vh(Lh(vh(vh(new wh([c.b]),"encryption"),"EncryptedData"),Kh()),"CipherData"),"CipherReference"),"URI"):[],k=Mh(vh(vh(f,"bindings"),"mediaType"));for(c=0;c<k.length;c++){var m=k[c].getAttribute("handler");(l=k[c].getAttribute("media-type"))&&m&&a.d[m]&&(a.I[l]=a.d[m].src)}a.u=pq(vh(f,"metadata"),Qh(f,"prefix")[0]);a.u[mq]&&(a.lang=a.u[mq][0].v);if(!d){if(0<g.length&&a.k)for(d=kq(a.k),c=0;c<g.length;c++)a.f.k[a.l+g[c]]=d;return N(!0)}f=new Ja;k={};if(0<g.length&&a.k)for(l="1040:"+
Re(a.k),c=0;c<g.length;c++)k[g[c]]=l;for(c=0;c<d.length;c++){var p=d[c];if(m=p.n){var r=decodeURI(m),g=a.h[r];l=null;g&&(g.j=0!=p.m,g.h=p.c,g.d&&(l=g.d.replace(/\s+/g,"")));g=k[r];if(l||g)f.append(m),f.append(" "),f.append(l||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}uq(a);return rf(e,"","POST",f.toString(),"text/plain")}function uq(a){for(var b=0,c=0;c<a.b.length;c++){var d=a.b[c],e=Math.ceil(d.h/1024);d.e=b;d.b=e;b+=e}a.w=b}
function vq(a,b,c){a.d={};a.h={};a.g=[];a.b=a.g;var d=a.e=new uh(null,"",(new DOMParser).parseFromString("<spine></spine>","text/xml"));b.forEach(function(a,b){var c=new iq;c.F=b;c.id="item"+(b+1);c.src=a;var h=d.b.createElement("itemref");h.setAttribute("idref",c.id);d.root.appendChild(h);c.f=h;this.d[c.id]=c;this.h[a]=c;this.g.push(c)},a);return c?hq(a.f,b[0],c):N(null)}
function wq(a,b,c){var d=a.b[b],e=L("getCFI");a.f.load(d.src).then(function(a){var b=Ah(a,c),h=null;b&&(a=yh(a,b,0,!1),h=new lb,ob(h,b,c-a),d.f&&ob(h,d.f,0),h=h.toString());P(e,h)});return O(e)}
function xq(a,b){return Xe("resolveFragment",function(c){if(b){var d=new lb;mb(d,b);var e;if(a.e){var f=nb(d,a.e.b);if(1!=f.fa.nodeType||f.J||!f.ac){P(c,null);return}var g=f.fa,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.d[h]){P(c,null);return}e=a.d[h];d=f.ac}else e=a.b[0];a.f.load(e.src).then(function(a){var b=nb(d,a.b);a=yh(a,b.fa,b.offset,b.J);P(c,{F:e.F,na:a,G:-1})})}else P(c,null)},function(a,d){u.b(d,"Cannot resolve fragment:",b);P(a,null)})}
function yq(a,b){return Xe("resolveEPage",function(c){if(0>=b)P(c,{F:0,na:0,G:-1});else{var d=Ra(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.f.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=zh(a),g=Math.round(a*b/e.b),g==a&&g--);P(c,{F:d,na:g,G:-1})})}},function(a,d){u.b(d,"Cannot resolve epage:",b);P(a,null)})}
function zq(a,b){var c=a.b[b.F];if(0>=b.na)return N(c.e);var d=L("getEPage");a.f.load(c.src).then(function(a){a=zh(a);var f=Math.min(a,b.na);P(d,c.e+f*c.b/a)});return O(d)}function Aq(a,b,c,d,e){this.b=a;this.viewport=b;this.g=c;this.h=e;this.Lb=[];this.na=this.G=this.F=0;this.T=Zb(d);this.f=new jn(b.f);this.d=new uo(a.j)}function Bq(a){var b=a.Lb[a.F];return b?b.qb[a.G]:null}n=Aq.prototype;n.nb=function(){if(this.b.D)return this.b.D;var a=this.Lb[this.F];return a?a.Ja.ba:null};
function Cq(a,b,c,d){c.N.style.display="none";c.N.style.visibility="visible";c.N.style.position="";c.N.style.top="";c.N.style.left="";c.N.setAttribute("data-vivliostyle-page-side",c.j);var e=b.qb[d];e?(b.Ja.viewport.d.replaceChild(c.N,e.N),$a(e,{type:"replaced",target:null,currentTarget:null,be:c})):b.Ja.viewport.d.appendChild(c.N);a.h(b.Ja.oa,b.item.F,d);c.l=0==b.item.F&&0==d;b.qb[d]=c}
function Dq(a,b,c){var d=L("renderSinglePage"),e=Eq(a,b,c);Pp(b.Ja,e,c).then(function(f){var g=(c=f)?c.page-1:b.Ka.length-1;Cq(a,b,e,g);xo(a.d,a.F,g);var h=a.F,l=a.G,k=a.na;f=null;if(c){var m=b.Ka[c.page];b.Ka[c.page]=c;m&&b.qb[c.page]&&!Ai(c,m)&&(a.G=c.page,f=Dq(a,b,c))}f||(f=N(!0));f.then(function(){var b=yo(a.d,e),f=0;of(function(c){f++;if(f>b.length)Q(c);else{var d=b[f-1];d.vc=d.vc.filter(function(a){return!a.bc});0===d.vc.length?qf(c):(a.F=d.F,a.G=d.G,Fq(a).then(function(b){b?(wo(a.d,d.cd),zo(a.d,
d.vc),Dq(a,b,b.Ka[a.G]).then(function(){var b=a.d;b.b=b.u.pop();b=a.d;b.d=b.B.pop();qf(c)})):qf(c)}))}}).then(function(){a.F=h;a.G=l;a.na=k;P(d,{page:e,position:c,G:g})})})});return O(d)}
function Gq(a){var b=L("renderPage");Fq(a).then(function(c){if(c){var d=-1;if(0>a.G){var d=a.na,e=Ra(c.Ka.length,function(a){return Lp(c.Ja,c.Ka[a])>d});a.G=e==c.Ka.length?Number.POSITIVE_INFINITY:e-1}var f=c.qb[a.G];f?(a.na=f.offset,P(b,f)):of(function(b){if(a.G<c.Ka.length)Q(b);else if(c.complete)a.G=c.Ka.length-1,Q(b);else{var e=c.Ka[c.Ka.length-1];Dq(a,c,e).then(function(l){var k=l.page;e=l.position;l=l.G;e?0<=d&&Lp(c.Ja,e)>d?(f=k,a.G=c.Ka.length-2,Q(b)):qf(b):(f=k,a.G=l,0>d&&(a.na=k.offset),
c.complete=!0,k.k=c.item.F==a.b.b.length-1,Q(b))})}}).then(function(){f=f||c.qb[a.G];var e=c.Ka[a.G];0>d&&(a.na=Lp(c.Ja,e));f?P(b,f):Dq(a,c,e).then(function(d){var f=d.page;e=d.position;e||(c.complete=!0,f.k=c.item.F==a.b.b.length-1);P(b,f)})})}else P(b,null)});return O(b)}n.hd=function(){return Hq(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};
function Hq(a,b,c){var d=L("renderAllPages"),e=a.F,f=a.G;a.F=0;of(function(d){a.G=a.F==b?c:Number.POSITIVE_INFINITY;Gq(a).then(function(){++a.F>b?Q(d):qf(d)})}).then(function(){a.F=e;a.G=f;Gq(a).ua(d)});return O(d)}n.Wd=function(){this.G=this.F=0;return Gq(this)};n.Xd=function(){this.F=this.b.b.length-1;this.G=Number.POSITIVE_INFINITY;return Gq(this)};
n.nextPage=function(){var a=this,b=L("nextPage");Fq(a).then(function(c){if(c){if(c.complete&&a.G==c.Ka.length-1){if(a.F>=a.b.b.length-1){P(b,null);return}a.F++;a.G=0}else a.G++;Gq(a).ua(b)}else P(b,null)});return O(b)};n.fd=function(){if(0==this.G){if(0==this.F)return N(null);this.F--;this.G=Number.POSITIVE_INFINITY}else this.G--;return Gq(this)};function Iq(a,b){var c="left"===b.j,d="ltr"===a.nb();return!c&&d||c&&!d}
function Jq(a){var b=L("getCurrentSpread"),c=Bq(a);if(!c)return N({left:null,right:null});var d=a.F,e=a.G,f="left"===c.j;(Iq(a,c)?a.fd():a.nextPage()).then(function(g){a.F=d;a.G=e;Gq(a).then(function(){f?P(b,{left:c,right:g}):P(b,{left:g,right:c})})});return O(b)}n.ce=function(){var a=Bq(this);if(!a)return N(null);var a=Iq(this,a),b=this.nextPage();if(a)return b;var c=this;return b.Fc(function(){return c.nextPage()})};
n.fe=function(){var a=Bq(this);if(!a)return N(null);var a=Iq(this,a),b=this.fd();if(a){var c=this;return b.Fc(function(){return c.fd()})}return b};function Kq(a,b){var c=L("navigateToEPage");yq(a.b,b).then(function(b){b&&(a.F=b.F,a.G=b.G,a.na=b.na);Gq(a).ua(c)});return O(c)}function Lq(a,b){var c=L("navigateToCFI");xq(a.b,b).then(function(b){b&&(a.F=b.F,a.G=b.G,a.na=b.na);Gq(a).ua(c)});return O(c)}
function Mq(a,b){u.debug("Navigate to",b);var c=tq(a.b,ta(b));if(!c){if(a.b.e&&b.match(/^#epubcfi\(/))c=tq(a.b,a.b.e.url);else if("#"===b.charAt(0)){var d=a.b.j.he(b);a.b.e?c=tq(a.b,d[0]):c=d[0];b=c+(d[1]?"#"+d[1]:"")}if(null==c)return N(null)}d=a.b.h[c];if(!d)return a.b.e&&c==tq(a.b,a.b.e.url)&&(c=b.indexOf("#"),0<=c)?Lq(a,b.substr(c+1)):N(null);d.F!=a.F&&(a.F=d.F,a.G=0);var e=L("navigateTo");Fq(a).then(function(c){var d=Ch(c.X,b);d&&(a.na=xh(c.X,d),a.G=-1);Gq(a).ua(e)});return O(e)}
function Eq(a,b,c){var d=b.Ja.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.style.position="absolute";e.style.top="0";e.style.left="0";ka||(e.style.visibility="hidden");d.root.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);var g=new Wh(e,f);g.F=b.item.F;g.position=c;g.offset=Lp(b.Ja,c);0===g.offset&&f.setAttribute("id",a.b.j.Gc("",b.item.src));d!==a.viewport&&(a=bc(a.viewport.width,a.viewport.height,
d.width,d.height),a=ig(null,new Vb(a,null)),g.h.push(new Th(e,"transform",a)));return g}function Nq(a,b){var c=qq();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=L("navigateToEPage"),f=gf(c);d.Push(function(){f.Va(e)});return O(c)}return N(null)}
n.$c=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=va(f,a.url),g=c.getAttribute("media-type");if(!g){var h=tq(b.b,f);h&&(h=b.b.h[h])&&(g=h.d)}if(g&&(h=b.b.I[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Na(f),l=Na(g),g=new Ja;g.append(h);g.append("?src=");g.append(f);g.append("&type=");g.append(l);for(h=c.firstChild;h;h=h.nextSibling)1==h.nodeType&&
...
c.namespaceURI)e=Nq(c,d);else if("http://example.com/sse"==c.namespaceURI){e=d?d.ownerDocument:b.viewport.b;g=c.localName;switch(g){case "t":case "tab":case "ec":case "nt":case "fraction":case "comment":case "mark":g="span";break;case "ruby":case "rp":case "rt":break;default:g="div"}e=e.createElement(g);e.setAttribute("data-adapt-process-children","true");e=N(e)}else e=c.dataset&&"true"==c.dataset.mathTypeset?Nq(c,d):N(null);return e}};
function Fq(a){if(a.F>=a.b.b.length)return N(null);var b=a.Lb[a.F];if(b)return N(b);var c=a.b.b[a.F],d=a.b.f,e=L("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(zh(f)/2700),a.b.w=c.b);var g=d.b[f.url],h=a.$c(f),l=a.viewport,k=Hp(g,l.width,l.height,l.fontSize);if(k.width!=l.width||k.height!=l.height||k.fontSize!=l.fontSize)l=new mn(l.f,k.fontSize,l.root,k.width,k.height);var k=a.Lb[a.F-1],m=new Ip(g,f,a.b.lang,l,a.f,a.g,h,a.b.B,k?k.Ja.ma+k.qb.length:0,a.b.j,
a.d);m.T=a.T;Jp(m).then(function(){b={item:c,X:f,Ja:m,Ka:[null],qb:[],complete:!1};a.Lb[a.F]=b;P(e,b)})});return O(e)}function Oq(a){return{F:a.F,G:a.G,na:a.na}}function Pq(a,b){b?(a.F=b.F,a.G=-1,a.na=b.na):(a.F=0,a.G=0,a.na=0);return Hq(a,a.F,a.G)}
n.xc=function(){var a=this.b,b=a.H||a.S;if(!b)return N(null);var c=L("showTOC");this.e||(this.e=new Zp(a.f,b.src,a.lang,this.f,this.g,this.T,this,a.B,a.j,this.d));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background=
"#EEE";e.style.border="1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.e.xc(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";P(c,a)});return O(c)};n.tc=function(){this.e&&this.e.tc()};n.yd=function(){return this.e&&this.e.yd()};function Qq(a,b,c,d){var e=this;this.h=a;this.ib=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.za=c;this.oa=d;a=a.document;this.ka=new ph(a.head,b);this.H=[];this.g=null;this.D=this.d=!1;this.f=this.j=this.e=this.l=null;this.fontSize=16;this.zoom=1;this.S=!1;this.hd=!0;this.T=Yb();this.B=function(){};this.k=function(){};this.O=function(){e.d=!0;e.B()};this.dd=this.dd.bind(this);this.u=function(){};this.w=a.getElementById("vivliostyle-page-rules");
this.I=!1;this.ba={loadEPUB:this.Sd,loadXML:this.Td,configure:this.rd,moveTo:this.ma,toc:this.xc};Rq(this)}function Rq(a){sa(1,function(a){Sq(this,{t:"debug",content:a})}.bind(a));sa(2,function(a){Sq(this,{t:"info",content:a})}.bind(a));sa(3,function(a){Sq(this,{t:"warn",content:a})}.bind(a));sa(4,function(a){Sq(this,{t:"error",content:a})}.bind(a))}function Sq(a,b){b.i=a.za;a.oa(b)}n=Qq.prototype;
n.Sd=function(a){Go.b("loadEPUB");Go.b("loadFirstPage");this.ib.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet;this.viewport=null;var f=L("loadEPUB"),g=this;g.rd(a).then(function(){var a=new bq;if(e)for(var l=0;l<e.length;l++)Yp(a,e[l]);Xp(a).then(function(){var e=va(b,g.h.location.href);g.H=[e];dq(a,e,d).then(function(a){g.g=a;xq(g.g,c).then(function(a){g.f=a;Tq(g).then(function(){g.ib.setAttribute("data-vivliostyle-viewer-status",
"complete");Go.d("loadEPUB");Sq(g,{t:"loaded",metadata:g.g.u});P(f,!0)})})})})});return O(f)};
n.Td=function(a){Go.b("loadXML");Go.b("loadFirstPage");this.ib.setAttribute("data-vivliostyle-viewer-status","loading");var b;"string"===typeof a.url?b=[a.url]:b=a.url;var c=a.document,d=a.fragment,e=a.userStyleSheet;this.viewport=null;var f=L("loadXML"),g=this;g.rd(a).then(function(){var a=new bq;if(e)for(var l=0;l<e.length;l++)Yp(a,e[l]);Xp(a).then(function(){var e=b.map(function(a){return va(a,g.h.location.href)});g.H=e;g.g=new fq(a,"");vq(g.g,e,c).then(function(){xq(g.g,d).then(function(a){g.f=
a;Tq(g).then(function(){g.ib.setAttribute("data-vivliostyle-viewer-status","complete");Go.d("loadXML");Sq(g,{t:"loaded"});P(f,!0)})})})})});return O(f)};function Uq(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*lc.ex*a.fontSize/lc.em;if(d=lc[d])return c*d}return c}
n.rd=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.l=null,this.h.addEventListener("resize",this.O,!1),this.d=!0):this.h.removeEventListener("resize",this.O,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.d=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:Uq(this,b["margin-left"])||0,marginRight:Uq(this,b["margin-right"])||0,marginTop:Uq(this,b["margin-top"])||0,marginBottom:Uq(this,b["margin-bottom"])||
0,width:Uq(this,b.width)||0,height:Uq(this,b.height)||0},200<=b.width||200<=b.height)&&(this.h.removeEventListener("resize",this.O,!1),this.l=b,this.d=!0);"boolean"==typeof a.hyphenate&&(this.T.Uc=a.hyphenate,this.d=!0);"boolean"==typeof a.horizontal&&(this.T.Tc=a.horizontal,this.d=!0);"boolean"==typeof a.nightMode&&(this.T.ad=a.nightMode,this.d=!0);"number"==typeof a.lineHeight&&(this.T.lineHeight=a.lineHeight,this.d=!0);"number"==typeof a.columnWidth&&(this.T.Qc=a.columnWidth,this.d=!0);"string"==
typeof a.fontFamily&&(this.T.fontFamily=a.fontFamily,this.d=!0);"boolean"==typeof a.load&&(this.S=a.load);"boolean"==typeof a.renderAllPages&&(this.hd=a.renderAllPages);"string"==typeof a.userAgentRootURL&&(ua=a.userAgentRootURL);"boolean"==typeof a.spreadView&&a.spreadView!==this.T.Xa&&(this.viewport=null,this.T.Xa=a.spreadView,this.d=!0);"number"==typeof a.pageBorder&&a.pageBorder!==this.T.Kb&&(this.viewport=null,this.T.Kb=a.pageBorder,this.d=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=
a.zoom,this.D=!0);return N(!0)};n.dd=function(a){var b=this.e;b===a.target&&(b=a.be);Vq(this,b)};function Wq(a){var b=[];a.e&&(b.push(a.e),a.e=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(x(a.N,"display","none"),a.removeEventListener("hyperlink",this.u,!1),a.removeEventListener("replaced",this.dd,!1))},a)}function Xq(a,b){b.addEventListener("hyperlink",a.u,!1);b.addEventListener("replaced",a.dd,!1);x(b.N,"visibility","visible");x(b.N,"display","block")}
function Yq(a,b){Wq(a);a.e=b;Xq(a,b)}function Zq(a){var b=L("reportPosition");a.f||(a.f=Oq(a.b));wq(a.g,a.f.F,a.f.na).then(function(c){var d=a.e;(a.S&&0<d.g.length?tg(d.g):N(!0)).then(function(){$q(a,d,c).ua(b)})});return O(b)}
function ar(a){var b=a.ib;if(a.l){var c=a.l;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new mn(a.h,a.fontSize,b,c.width,c.height)}return new mn(a.h,a.fontSize,b)}
function br(a){if(a.l||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=ar(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.Lb;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.qb,d=0;d<c.length;d++){var e=c[d];if(e.I&&e.H){a=!0;break a}}}a=!1}b=!a}return b}n.ie=function(a,b,c){if(!this.I&&this.w&&0===b&&0===c){var d="";Object.keys(a).forEach(function(b){d+="@page "+b+"{size:";b=a[b];d+=b.width+"px "+b.height+"px;}"});this.w.textContent=d;this.I=!0}};
function cr(a){if(a.b){a.b.tc();for(var b=a.b.Lb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.qb,e;e=d.shift();)e=e.N,e.parentNode.removeChild(e)}}a.w&&(a.w.textContent="",a.I=!1);a.viewport=ar(a);b=a.viewport;x(b.e,"width","");x(b.e,"height","");x(b.d,"width","");x(b.d,"height","");x(b.d,"transform","");a.b=new Aq(a.g,a.viewport,a.ka,a.T,a.ie.bind(a))}
function Vq(a,b){a.D=!1;if(a.T.Xa)return Jq(a.b).Fc(function(c){Wq(a);a.j=c;c.left&&(Xq(a,c.left),c.right||c.left.N.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Xq(a,c.right),c.left||c.right.N.setAttribute("data-vivliostyle-unpaired-page",!0));c=dr(a,c);a.viewport.zoom(c.width,c.height,a.zoom);a.e=b;return N(null)});Yq(a,b);a.viewport.zoom(b.e.width,b.e.height,a.zoom);a.e=b;return N(null)}
function dr(a,b){var c=0,d=0;b.left&&(c+=b.left.e.width,d=b.left.e.height);b.right&&(c+=b.right.e.width,d=Math.max(d,b.right.e.height));b.left&&b.right&&(c+=2*a.T.Kb);return{width:c,height:d}}var er={se:"fit inside viewport"};
function Tq(a){a.d=!1;if(br(a))return N(!0);"complete"===a.ib.getAttribute("data-vivliostyle-viewer-status")&&a.ib.setAttribute("data-vivliostyle-viewer-status","resizing");Sq(a,{t:"resizestart"});var b=L("resize");a.b&&!a.f&&(a.f=Oq(a.b));cr(a);Pq(a.b,a.f).then(function(c){Vq(a,c).then(function(){Zq(a).then(function(c){Go.d("loadFirstPage");(a.hd?a.b.hd():N(null)).then(function(){a.ib.setAttribute("data-vivliostyle-viewer-status","complete");Sq(a,{t:"resizeend"});P(b,c)})})})});return O(b)}
function $q(a,b,c){var d=L("sendLocationNotification"),e={t:"nav",first:b.l,last:b.k};zq(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.w;c&&(e.cfi=c);Sq(a,e);P(d,!0)});return O(d)}Qq.prototype.nb=function(){return this.b?this.b.nb():null};
Qq.prototype.ma=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.T.Xa?this.b.ce:this.b.nextPage;break;case "previous":a=this.T.Xa?this.b.fe:this.b.fd;break;case "last":a=this.b.Xd;break;case "first":a=this.b.Wd;break;default:return N(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return Kq(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return Mq(b.b,d)}}else return N(!0);var e=L("nextPage");a.call(b.b).then(function(a){a?(b.f=
null,Vq(b,a).then(function(){Zq(b).ua(e)})):P(e,!0)});return O(e)};Qq.prototype.xc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.yd();if(c){if("show"==a)return N(!0)}else if("hide"==a)return N(!0);if(c)return this.b.tc(),N(!0);var d=this,e=L("showTOC");this.b.xc(b).then(function(a){if(a){if(b){var c=function(){d.b.tc()};a.addEventListener("hyperlink",c,!1);a.N.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.u,!1)}P(e,!0)});return O(e)};
function fr(a,b){var c=b.a||"";return Xe("runCommand",function(d){var e=a.ba[c];e?e.call(a,b).then(function(){Sq(a,{t:"done",a:c});P(d,!0)}):(u.error("No such action:",c),P(d,!0))},function(a,b){u.error(b,"Error during action:",c);P(a,!0)})}function gr(a){return"string"==typeof a?JSON.parse(a):a}
function hr(a,b){var c=gr(b),d=null;Ze(function(){var b=L("commandLoop"),f=Se.d;a.u=function(b){var c="#"===b.href.charAt(0)||a.H.some(function(a){return b.href.substr(0,a.length)==a}),d={t:"hyperlink",href:b.href,internal:c};$e(f,function(){Sq(a,d);return N(!0)})};of(function(b){if(a.d)Tq(a).then(function(){qf(b)});else if(a.D)a.e&&Vq(a,a.e).then(function(){qf(b)});else if(c){var e=c;c=null;fr(a,e).then(function(){qf(b)})}else e=L("waitForCommand"),d=gf(e,self),O(e).then(function(){qf(b)})}).ua(b);
return O(b)});a.B=function(){var a=d;a&&(d=null,a.Va())};a.k=function(b){if(c)return!1;c=gr(b);a.B();return!0};a.h.adapt_command=a.k};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Ub||(Object.Ub=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function ir(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}function jr(a,b){ka=a.debug;this.f=a;this.b=new Qq(a.window||window,a.viewportElement,"main",this.Vd.bind(this));this.e={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,spreadView:!1,zoom:1};b&&this.Od(b);this.d=new Za}n=jr.prototype;
n.Od=function(a){var b=Object.Ub({a:"configure"},ir(a));this.b.k(b);Object.Ub(this.e,a)};n.Vd=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});$a(this.d,b)};n.je=function(a,b){this.d.addEventListener(a,b,!1)};n.me=function(a,b){this.d.removeEventListener(a,b,!1)};n.Yd=function(a,b,c){a||$a(this.d,{type:"error",content:"No URL specified"});kr(this,a,null,b,c)};n.ke=function(a,b,c){a||$a(this.d,{type:"error",content:"No URL specified"});kr(this,null,a,b,c)};
function kr(a,b,c,d,e){d=d||{};var f,g=d.userStyleSheet;g&&(f=g.map(function(a){return{url:a.url||null,text:a.text||null}}));e&&Object.Ub(a.e,e);b=Object.Ub({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.f.userAgentRootURL,url:b||c,document:d.documentObject,fragment:d.fragment,userStyleSheet:f},ir(a.e));hr(a.b,b)}n.nb=function(){return this.b.nb()};
n.$d=function(a){a:switch(a){case "left":a="ltr"===this.nb()?"previous":"next";break a;case "right":a="ltr"===this.nb()?"next":"previous";break a}this.b.k({a:"moveTo",where:a})};n.Zd=function(a){this.b.k({a:"moveTo",url:a})};n.le=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.T.Xa?dr(b,b.j):b.e.e;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ca("vivliostyle.viewer.Viewer",jr);jr.prototype.setOptions=jr.prototype.Od;jr.prototype.addListener=jr.prototype.je;jr.prototype.removeListener=jr.prototype.me;jr.prototype.loadDocument=jr.prototype.Yd;jr.prototype.loadEPUB=jr.prototype.ke;jr.prototype.getCurrentPageProgression=jr.prototype.nb;jr.prototype.navigateToPage=jr.prototype.$d;jr.prototype.navigateToInternalUrl=jr.prototype.Zd;jr.prototype.queryZoomFactor=jr.prototype.le;ca("vivliostyle.viewer.ZoomType",er);er.FIT_INSIDE_VIEWPORT="fit inside viewport";
Co.call(Go,"load_vivliostyle","end",void 0);var lr=16,mr="ltr";function nr(a){window.adapt_command(a)}function or(){nr({a:"moveTo",where:"ltr"===mr?"previous":"next"})}function pr(){nr({a:"moveTo",where:"ltr"===mr?"next":"previous"})}
function qr(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)nr({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)nr({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)nr({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)nr({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)pr(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)or(),a.preventDefault();else if("0"===b||"U+0030"===c)nr({a:"configure",fontSize:Math.round(lr)}),a.preventDefault();else if("t"===b||"U+0054"===c)nr({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)lr*=1.2,nr({a:"configure",fontSize:Math.round(lr)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)lr/=1.2,nr({a:"configure",
fontSize:Math.round(lr)}),a.preventDefault()}
function rr(a){switch(a.t){case "loaded":a=a.viewer;var b=mr=a.nb();a.ib.setAttribute("data-vivliostyle-page-progression",b);a.ib.setAttribute("data-vivliostyle-spread-view",a.T.Xa);window.addEventListener("keydown",qr,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",or,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",pr,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(ya(location.href,Na(a||"")));break;case "hyperlink":a.internal&&nr({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+m+"; margin: 0; }",document.head.appendChild(g));hr(new Qq(window,k,"main",rr),a)});
