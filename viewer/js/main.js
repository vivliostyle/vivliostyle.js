...
function ei(){this.g=0;this.b={};this.Mb={};this.f={};this.d={};this.wa={};this.e={};this.Fb={};this.M=0}ei.prototype.clone=function(){var a=new ei;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b];di(this.Mb,a.Mb);di(this.f,a.f);di(this.d,a.d);di(this.wa,a.wa);di(this.e,a.e);di(this.Fb,a.Fb);a.M=this.M;return a};function th(a,b,c){var d=a[b];d&&(c=d.g(c));a[b]=c}
...
function ji(a){var b;for(b=0;b<a.u.length;b++)gi(a,a.j.wa,a.u[b]);for(b=0;b<a.D.length;b++)gi(a,a.j.d,a.D[b]);gi(a,a.j.e,a.O);gi(a,a.j.Mb,a.f);""!=a.f&&gi(a,a.j.Mb,"*");gi(a,a.j.f,a.ca);null!==a.I&&(gi(a,a.j.Fb,a.I),gi(a,a.j.Fb,"*"));a.e=null;a.b.push([]);for(var c=1;-1<=c;--c){var d=a.b[a.b.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.ma=!0;a.Ea=!1}
...
m.gb=function(){var a;0!=this.j?(wf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.j=1,this.k={},this.g=null,this.d=0,this.l=!1,this.b=[])};m.R=function(a,b){uf.prototype.R.call(this,a,b);1==this.j&&(this.j=0)};m.vb=function(a){uf.prototype.vb.call(this,a);this.j=0};m.la=function(){si(this);uf.prototype.la.call(this);1==this.j&&(this.j=0)};m.Ta=function(){uf.prototype.Ta.call(this)};function si(a){if(a.b){var b=a.d,c;c=a.h;c=c.M+=ci;ri(a,a.nd(b+c));a.b=null;a.g=null;a.l=!1;a.d=0}}
...
function zk(a,b,c){Pj.call(this,a);this.Pc=a.lastChild;this.h=b;this.lc=c;this.sd=a.ownerDocument;this.mc=!1;this.ma=this.kb=this.Na=this.Rc=0;this.nc=this.Xa=this.l=this.f=null;this.Qc=!1;this.O=this.g=this.u=null;this.dd=!0;this.qc=this.oc=0}t(zk,Pj);zk.prototype.clone=function(){var a=new zk(this.d,this.h,this.lc);Uj(a,this);a.Pc=this.Pc;a.mc=this.mc;a.l=this.l?this.l.clone():null;a.Xa=this.Xa.concat();return a};
...
1)*a.f.Q);q=n;a.b&&(q=ue(n));ze(p,a.nc,q,e);a.b&&(n=new ce(-q.Q,q.V,-q.T,q.U));u(d,"left",n.V-a.f.V+a.j+"px");u(d,"top",n.T-a.f.T+a.k+"px");n=a.b?n.V:n.Q;Bk(a,n)&&0!=a.u.length?(b=b.modify(),b.overflow=!0,O(c,b)):(Ok(a),p=a.b?ue(a.f):a.f,Ae(p,a.nc,q,e),Pk(a),"left"==e?a.oc=n:a.qc=n,jl(a,n),O(c,l))}});return N(c)}
...
me(b,d,b+a.width,d+a.height);a.nc=we(c,[b],a.A,a.Sa,a.b);Pk(a);a.g=null}function Zk(a){a.Xa=[];u(a.d,"width",a.width+"px");u(a.d,"height",a.height+"px");$k(a);a.e=0;a.Qc=!1;a.O=null}function jl(a,b){a.e=Math.max((a.b?-1:1)*(b-a.Na),a.e)}function zl(a,b){var c=b.b;if(!c)return M(!0);var d=L("layoutOverflownFootnotes"),e=0;af(function(){for(;e<c.length;){var b=c[e++],b=Xk(a,0,b,a.Na);if(b.xa())return b}return M(!1)}).then(function(){O(d,!0)});return N(d)}
function bl(a,b){a.Xa.push(b);if(a.Qc)return M(b);var c=L("layout");zl(a,b).then(function(){Dk(a,b.Pa).then(function(b){var e=b,f=!0;a.u=[];bf(function(c){for(;b;){var h=!0;yl(a,b,f).then(function(k){f=!1;b=k;0<a.h.f.b.length?Q(c):a.O?Q(c):b&&b.overflow?sl(a,b,e).then(function(a){b=a;Q(c)}):h?h=!1:df(c)});if(h){h=!1;return}}Q(c)}).then(function(){var e=a.l;e&&(a.d.appendChild(e.d),a.b?a.e=this.Na-this.kb:a.e=e.top+Qj(e)+e.e+Rj(e));if(b)if(0<a.h.f.b.length)O(c,null);else{a.Qc=!0;e=new Lj(Kj(b));if(a.g){for(var f=
...
Wj(Z,0,v.width),Vj(Z,c,F)):(u(d,"margin-top",v.k+"px"),u(d,"margin-bottom",v.w+"px"),c=c*(F+P)+v.j,Vj(Z,0,v.height),Wj(Z,c,F));Z.B=e+v.j;Z.D=f+v.k}else Z=new zk(q,Qk,a.f),Uj(Z,v),v=Z;Z.A=p?[]:g;Z.Pb=lb;if(0<=Z.width){var k=L("inner");Un(a,Z,I).then(function(){Z.O&&"column"!=Z.O&&(zh=W,"region"!=Z.O&&(a.D[I]=!0));O(k,!0)});c=N(k)}else c=M(!0);if(c.xa()){c.then(function(){0<h.b.length?Q(b):(Ea=Math.max(Ea,Z.e),df(b))});return}0<h.b.length||(Ea=Math.max(Ea,Z.e))}Q(b)}).then(function(){v.e=Ea;c.Wb(a,
...
function wo(a,b){function c(a){for(var b in a){var d=a[b];d.sort(vo(b,l));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return Pa(a,function(a){return Oa(a,function(a){var b={v:a.value,o:a.M};a.$d&&(b.s=a.scheme);if(a.id||a.lang){var c=k[a.id];if(c||a.lang)a.lang&&(a={name:to,value:a.lang,lang:null,id:null,Kc:a.id,scheme:null,M:a.M},c?c.push(a):c=[a]),c=Na(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in so)f[g]=so[g];for(;null!=(g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/));)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=so;var h=1;g=ej(fj(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),M:h++,Kc:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:so.dcterms+a.localName,M:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Kc:null,scheme:null};return null});var k=Na(g,function(a){return a.Kc});g=d(Na(g,function(a){return a.Kc?null:a.name}));var l=null;g[to]&&(l=g[to][0].v);c(g);return g}function xo(){var a=window.MathJax;return a?a.Hub:null}var yo={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
...
function Do(a,b){return Ke("resolveFragment",function(c){if(b){var d=new cb;db(d,b);var e;if(a.f){var f=eb(d,a.f.b);if(1!=f.ea.nodeType||f.K||!f.Ib){O(c,null);return}var g=f.ea,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.d[h]){O(c,null);return}e=a.d[h];d=f.Ib}else e=a.b[0];a.e.load(e.src).then(function(a){var b=eb(d,a.b);a=Oi(a,b.ea,b.offset,b.K);O(c,{F:e.F,ka:a,N:-1})})}else O(c,null)},function(a){w("Error resolving fragment "+b);O(a,null)})}
...
function Fo(a,b){var c=a.b[b.F];if(0>=b.ka)return M(c.e);var d=L("getEPage");a.e.load(c.src).then(function(a){a=Pi(a);var f=Math.min(a,b.ka);O(d,c.e+f*c.b/a)});return N(d)}function Go(a,b,c,d){this.b=a;this.viewport=b;this.f=c;this.tb=[];this.ka=this.N=this.F=0;this.S=Rb(d);this.e=new Qm(b.d)}function Ho(a){var b=a.tb[a.F];return b?b.Ya[a.N]:null}m=Go.prototype;m.cb=function(){if(this.b.A)return this.b.A;var a=this.tb[this.F];return a?a.Ga.O:null};
...
1]=h,c.Ha[a.N+1]=e):(c.Ya.push(h),c.complete=!0,h.k=c.item.F==a.b.b.length-1);h.j=0==c.item.F&&0==a.N;O(b,h)})}})}else O(b,null)});return N(b)}m.Lc=function(){return Lo(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};function Lo(a,b,c){var d=L("renderAllPages"),e=a.F,f=a.N;a.F=0;bf(function(d){a.N=a.F==b?c:Number.POSITIVE_INFINITY;Io(a).then(function(){++a.F>b?Q(d):df(d)})}).then(function(){a.F=e;a.N=f;Io(a).oa(d)});return N(d)}m.vd=function(){this.N=this.F=0;return Io(this)};
m.wd=function(){this.F=this.b.b.length-1;this.N=Number.POSITIVE_INFINITY;return Io(this)};m.nextPage=function(){var a=this,b=L("nextPage");Jo(a).then(function(c){if(c){if(c.complete&&a.N==c.Ha.length-1){if(a.F>=a.b.b.length-1){O(b,null);return}a.F++;a.N=0}else a.N++;Io(a).oa(b)}else O(b,null)});return N(b)};m.Jc=function(){if(0==this.N){if(0==this.F)return M(null);this.F--;this.N=Number.POSITIVE_INFINITY}else this.N--;return Io(this)};
function Mo(a,b){var c="left"===b.f,d="ltr"===a.cb();return!c&&d||c&&!d}function No(a){var b=L("getCurrentSpread"),c=Ho(a);if(!c)return M({left:null,right:null});var d=a.F,e=a.N,f="left"===c.f;(Mo(a,c)?a.Jc():a.nextPage()).then(function(g){a.F=d;a.N=e;Io(a).then(function(){f?O(b,{left:c,right:g}):O(b,{left:g,right:c})})});return N(b)}m.Bd=function(){var a=Ho(this);if(!a)return M(null);var a=Mo(this,a),b=this.nextPage();if(a)return b;var c=this;return b.ic(function(){return c.nextPage()})};
m.Ed=function(){var a=Ho(this);if(!a)return M(null);var a=Mo(this,a),b=this.Jc();if(a){var c=this;return b.ic(function(){return c.Jc()})}return b};function Oo(a,b){var c=L("navigateToEPage");Eo(a.b,b).then(function(b){b&&(a.F=b.F,a.N=b.N,a.ka=b.ka);Io(a).oa(c)});return N(c)}function Po(a,b){var c=L("navigateToCFI");Do(a.b,b).then(function(b){b&&(a.F=b.F,a.N=b.N,a.ka=b.ka);Io(a).oa(c)});return N(c)}
...
Mn(n.h,l.Ga.h);n.S=a.S;Rn(n).then(function(){b={item:c,$:f,Ga:n,Ha:[null],Ya:[],complete:!1};a.tb[a.F]=b;O(e,b)})});return N(e)}function So(a){return{F:a.F,N:a.N,ka:a.ka}}function To(a,b){b?(a.F=b.F,a.N=-1,a.ka=b.ka):(a.F=0,a.N=0,a.ka=0);return Lo(a,a.F,a.N)}
m.ac=function(){var a=this.b,b=a.B||a.O;if(!b)return M(null);var c=L("showTOC");this.d||(this.d=new go(a.e,b.src,a.lang,this.e,this.f,this.S,this,a.w));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";e.style.border=
