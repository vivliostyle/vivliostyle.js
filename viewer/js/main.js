 ...
 *
 * Vivliostyle core 2016.10.1-pre.20161130140543
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
th.prototype.cc=function(a){if("em"==a.ea||"ex"==a.ea){var b=Ab(this.b,a.ea,!1)/Ab(this.b,"em",!1);return new D(a.H*b*uh(this),"px")}if("rem"==a.ea||"rex"==a.ea)return b=Ab(this.b,a.ea,!1)/Ab(this.b,"rem",!1),new D(a.H*b*this.b.fontSize(),"px");if("%"==a.ea){if("font-size"===this.f)return new D(a.H/100*uh(this),"px");b=this.f.match(/height|^(top|bottom)$/)?"vh":"vw";return new D(a.H,b)}return a};th.prototype.$b=function(a){return"font-size"==this.f?Hf(this.b,a,this.f).$(this):a};function vh(){}
vh.prototype.apply=function(){};vh.prototype.l=function(a){return new wh([this,a])};vh.prototype.clone=function(){return this};function xh(a){this.b=a}t(xh,vh);xh.prototype.apply=function(a){a.j[a.j.length-1].push(this.b.b())};function wh(a){this.b=a}t(wh,vh);wh.prototype.apply=function(a){for(var b=0;b<this.b.length;b++)this.b[b].apply(a)};wh.prototype.l=function(a){this.b.push(a);return this};wh.prototype.clone=function(){return new wh([].concat(this.b))};
