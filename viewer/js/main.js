 ...
 *
 * Vivliostyle core 2016.4.1-pre.20160608113702
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function Ha(a){var b=Ea[a];if(b||null===b)return b;switch(a){case "writing-mode":if(Ga("-ms-","writing-mode"))return Ea[a]="-ms-writing-mode";break;case "filter":if(Ga("-webkit-","filter"))return Ea[a]="-webkit-filter"}for(b=0;b<Da.length;b++){var c=Da[b];if(Ga(c,a))return b=c+a,Ea[a]=b}v.b("Property not supported by the browser: ",a);return Ea[a]=null}
function x(a,b,c){try{var d=Ha(b);if(d){if("-ms-writing-mode"===d)switch(c){case "horizontal-tb":c="lr-tb";break;case "vertical-rl":c="tb-rl";break;case "vertical-lr":c="tb-lr"}a&&a.style&&a.style.setProperty(d,c)}}catch(e){v.b(e)}}function Ia(a,b,c){try{return a.style.getPropertyValue(Ea[b]||b)}catch(d){}return c||""}function Ja(){this.b=[]}Ja.prototype.append=function(a){this.b.push(a);return this};Ja.prototype.toString=function(){var a=this.b.join("");this.b=[a];return a};
...
function Vb(a){var b=a.f,c=0<=a.b?a.b:a.d,d=a.e;b>=c?c+=d:c--;if(c==b){if(0>a.b)throw Error("F_CSSTOK_INTERNAL");for(var b=2*(a.e+1)-1,c=Array(b+1),d=a.b,e=0;d!=a.f;)c[e]=a.g[d],d==a.d&&(a.d=e),d=d+1&a.e,e++;a.b=0;a.f=e;a.e=b;for(a.g=c;e<=b;)c[e++]=new qb;b=a.f;c=d=a.e}for(var e=sb,f=a.j,g=a.position,h=a.g,l=0,k=0,m="",p=0,r=!1,t=h[b],q=-9;;){var w=f.charCodeAt(g);switch(e[w]||e[65]){case 72:l=51;m=isNaN(w)?"E_CSS_UNEXPECTED_EOF":"E_CSS_UNEXPECTED_CHAR";g++;break;case 1:g++;r=!0;continue;case 2:k=
...
function(){return this.nb()});hc(this,"pref-font-family",function(){return this.T.fontFamily});hc(this,"pref-night-mode",function(){return this.T.ad});hc(this,"pref-hyphenate",function(){return this.T.Uc});hc(this,"pref-margin",function(){return this.T.margin});hc(this,"pref-line-height",function(){return this.T.lineHeight});hc(this,"pref-column-width",function(){return this.T.Qc*this.fontSize});hc(this,"pref-horizontal",function(){return this.T.Tc});hc(this,"pref-spread-view",function(){return this.T.Xa})}}
...
function nc(a,b,c,d){this.za=b;this.gb=c;this.H=null;this.ob=function(){return this.H?this.H:this.T.Xa?Math.floor(b/2)-this.T.Kb:b};this.D=null;this.nb=function(){return this.D?this.D:c};this.j=d;this.S=null;this.fontSize=function(){return this.S?this.S:d};this.T=Zb;this.w={}}function oc(a,b){a.w[b.j]={};for(var c=0;c<b.children.length;c++)oc(a,b.children[c])}
function pc(a,b,c){return"vw"==b?a.ob()/100:"vh"==b?a.nb()/100:"em"==b||"rem"==b?c?a.j:a.fontSize():"ex"==b||"rex"==b?lc.ex*(c?a.j:a.fontSize())/lc.em:lc[b]}function qc(a,b,c){do{var d=b.values[c];if(d||b.h&&(d=b.h.call(a,c,!1)))return d;b=b.parent}while(b);throw Error("Name '"+c+"' is undefined");}
...
e}else if(null!=f&&null==c)return 0!==f;return!1}function C(a){this.b=a;this.f="_"+fc++}n=C.prototype;n.toString=function(){var a=new Ja;this.pa(a,0);return a.toString()};n.pa=function(){throw Error("F_ABSTRACT");};n.Pa=function(){throw Error("F_ABSTRACT");};n.Fa=function(){return this};n.zb=function(a){return a===this};function tc(a,b,c,d){var e=d[a.f];if(null!=e)return e===$b?!1:e;d[a.f]=$b;b=a.zb(b,c,d);return d[a.f]=b}
n.evaluate=function(a){var b;b=(b=a.w[this.b.j])?b[this.f]:void 0;if("undefined"!=typeof b)return b;b=this.Pa(a);var c=this.f,d=this.b,e=a.w[d.j];e||(e={},a.w[d.j]=e);return e[c]=b};n.wd=function(){return!1};function uc(a,b){C.call(this,a);this.d=b}u(uc,C);n=uc.prototype;n.pd=function(){throw Error("F_ABSTRACT");};n.ud=function(){throw Error("F_ABSTRACT");};n.Pa=function(a){a=this.d.evaluate(a);return this.ud(a)};n.zb=function(a,b,c){return a===this||tc(this.d,a,b,c)};
n.pa=function(a,b){10<b&&a.append("(");a.append(this.pd());this.d.pa(a,10);10<b&&a.append(")")};n.Fa=function(a,b){var c=this.d.Fa(a,b);return c===this.d?this:new this.constructor(this.b,c)};function D(a,b,c){C.call(this,a);this.d=b;this.e=c}u(D,C);n=D.prototype;n.lc=function(){throw Error("F_ABSTRACT");};n.Da=function(){throw Error("F_ABSTRACT");};n.Ua=function(){throw Error("F_ABSTRACT");};n.Pa=function(a){var b=this.d.evaluate(a);a=this.e.evaluate(a);return this.Ua(b,a)};
n.zb=function(a,b,c){return a===this||tc(this.d,a,b,c)||tc(this.e,a,b,c)};n.pa=function(a,b){var c=this.lc();c<=b&&a.append("(");this.d.pa(a,c);a.append(this.Da());this.e.pa(a,c);c<=b&&a.append(")")};n.Fa=function(a,b){var c=this.d.Fa(a,b),d=this.e.Fa(a,b);return c===this.d&&d===this.e?this:new this.constructor(this.b,c,d)};function vc(a,b,c){D.call(this,a,b,c)}u(vc,D);vc.prototype.lc=function(){return 1};function wc(a,b,c){D.call(this,a,b,c)}u(wc,D);wc.prototype.lc=function(){return 2};
function xc(a,b,c){D.call(this,a,b,c)}u(xc,D);xc.prototype.lc=function(){return 3};function yc(a,b,c){D.call(this,a,b,c)}u(yc,D);yc.prototype.lc=function(){return 4};function zc(a,b){uc.call(this,a,b)}u(zc,uc);zc.prototype.pd=function(){return"!"};zc.prototype.ud=function(a){return!a};function Ac(a,b){uc.call(this,a,b)}u(Ac,uc);Ac.prototype.pd=function(){return"-"};Ac.prototype.ud=function(a){return-a};function Bc(a,b,c){D.call(this,a,b,c)}u(Bc,vc);Bc.prototype.Da=function(){return"&&"};
Bc.prototype.Pa=function(a){return this.d.evaluate(a)&&this.e.evaluate(a)};function Cc(a,b,c){D.call(this,a,b,c)}u(Cc,Bc);Cc.prototype.Da=function(){return" and "};function Dc(a,b,c){D.call(this,a,b,c)}u(Dc,vc);Dc.prototype.Da=function(){return"||"};Dc.prototype.Pa=function(a){return this.d.evaluate(a)||this.e.evaluate(a)};function Ec(a,b,c){D.call(this,a,b,c)}u(Ec,Dc);Ec.prototype.Da=function(){return", "};function Fc(a,b,c){D.call(this,a,b,c)}u(Fc,wc);Fc.prototype.Da=function(){return"<"};
Fc.prototype.Ua=function(a,b){return a<b};function Gc(a,b,c){D.call(this,a,b,c)}u(Gc,wc);Gc.prototype.Da=function(){return"<="};Gc.prototype.Ua=function(a,b){return a<=b};function Hc(a,b,c){D.call(this,a,b,c)}u(Hc,wc);Hc.prototype.Da=function(){return">"};Hc.prototype.Ua=function(a,b){return a>b};function Ic(a,b,c){D.call(this,a,b,c)}u(Ic,wc);Ic.prototype.Da=function(){return">="};Ic.prototype.Ua=function(a,b){return a>=b};function Jc(a,b,c){D.call(this,a,b,c)}u(Jc,wc);Jc.prototype.Da=function(){return"=="};
Jc.prototype.Ua=function(a,b){return a==b};function Kc(a,b,c){D.call(this,a,b,c)}u(Kc,wc);Kc.prototype.Da=function(){return"!="};Kc.prototype.Ua=function(a,b){return a!=b};function Lc(a,b,c){D.call(this,a,b,c)}u(Lc,xc);Lc.prototype.Da=function(){return"+"};Lc.prototype.Ua=function(a,b){return a+b};function Mc(a,b,c){D.call(this,a,b,c)}u(Mc,xc);Mc.prototype.Da=function(){return" - "};Mc.prototype.Ua=function(a,b){return a-b};function Nc(a,b,c){D.call(this,a,b,c)}u(Nc,yc);Nc.prototype.Da=function(){return"*"};
Nc.prototype.Ua=function(a,b){return a*b};function Oc(a,b,c){D.call(this,a,b,c)}u(Oc,yc);Oc.prototype.Da=function(){return"/"};Oc.prototype.Ua=function(a,b){return a/b};function Pc(a,b,c){D.call(this,a,b,c)}u(Pc,yc);Pc.prototype.Da=function(){return"%"};Pc.prototype.Ua=function(a,b){return a%b};function Qc(a,b,c){C.call(this,a);this.C=b;this.ha=c.toLowerCase()}u(Qc,C);Qc.prototype.pa=function(a){a.append(this.C.toString());a.append(La(this.ha))};
Qc.prototype.Pa=function(a){return this.C*pc(a,this.ha,!1)};function Rc(a,b){C.call(this,a);this.d=b}u(Rc,C);Rc.prototype.pa=function(a){a.append(this.d)};Rc.prototype.Pa=function(a){return qc(a,this.b,this.d).evaluate(a)};Rc.prototype.zb=function(a,b,c){return a===this||tc(qc(b,this.b,this.d),a,b,c)};function Sc(a,b,c){C.call(this,a);this.d=b;this.name=c}u(Sc,C);Sc.prototype.pa=function(a){this.d&&a.append("not ");a.append(La(this.name))};
Sc.prototype.Pa=function(a){var b=this.name;a="all"===b||!!a.T.sd[b];return this.d?!a:a};Sc.prototype.zb=function(a,b,c){return a===this||tc(this.value,a,b,c)};Sc.prototype.wd=function(){return!0};function ic(a,b,c){C.call(this,a);this.Ib=b;this.d=c}u(ic,C);ic.prototype.pa=function(a){a.append(this.d)};ic.prototype.Pa=function(a){return this.Ib.call(a)};function Tc(a,b,c){C.call(this,a);this.e=b;this.d=c}u(Tc,C);
Tc.prototype.pa=function(a){a.append(this.e);var b=this.d;a.append("(");for(var c=0;c<b.length;c++)c&&a.append(","),b[c].pa(a,0);a.append(")")};Tc.prototype.Pa=function(a){return rc(a,this.b,this.e,this.d,!1).Fa(a,this.d).evaluate(a)};Tc.prototype.zb=function(a,b,c){if(a===this)return!0;for(var d=0;d<this.d.length;d++)if(tc(this.d[d],a,b,c))return!0;return tc(rc(b,this.b,this.e,this.d,!0),a,b,c)};
Tc.prototype.Fa=function(a,b){for(var c,d=c=this.d,e=0;e<c.length;e++){var f=c[e].Fa(a,b);if(c!==d)d[e]=f;else if(f!==c[e]){for(var d=Array(c.length),g=0;g<e;g++)d[g]=c[g];d[e]=f}}c=d;return c===this.d?this:new Tc(this.b,this.e,c)};function Uc(a,b,c,d){C.call(this,a);this.d=b;this.g=c;this.e=d}u(Uc,C);Uc.prototype.pa=function(a,b){0<b&&a.append("(");this.d.pa(a,0);a.append("?");this.g.pa(a,0);a.append(":");this.e.pa(a,0);0<b&&a.append(")")};
Uc.prototype.Pa=function(a){return this.d.evaluate(a)?this.g.evaluate(a):this.e.evaluate(a)};Uc.prototype.zb=function(a,b,c){return a===this||tc(this.d,a,b,c)||tc(this.g,a,b,c)||tc(this.e,a,b,c)};Uc.prototype.Fa=function(a,b){var c=this.d.Fa(a,b),d=this.g.Fa(a,b),e=this.e.Fa(a,b);return c===this.d&&d===this.g&&e===this.e?this:new Uc(this.b,c,d,e)};function B(a,b){C.call(this,a);this.d=b}u(B,C);
B.prototype.pa=function(a){switch(typeof this.d){case "number":case "boolean":a.append(this.d.toString());break;case "string":a.append('"');a.append(Ma(this.d));a.append('"');break;default:throw Error("F_UNEXPECTED_STATE");}};B.prototype.Pa=function(){return this.d};function Vc(a,b,c){C.call(this,a);this.name=b;this.value=c}u(Vc,C);Vc.prototype.pa=function(a){a.append("(");a.append(Ma(this.name.name));a.append(":");this.value.pa(a,0);a.append(")")};
Vc.prototype.Pa=function(a){return sc(a,this.name.name,this.value)};Vc.prototype.zb=function(a,b,c){return a===this||tc(this.value,a,b,c)};Vc.prototype.Fa=function(a,b){var c=this.value.Fa(a,b);return c===this.value?this:new Vc(this.b,this.name,c)};function Wc(a,b){C.call(this,a);this.d=b}u(Wc,C);Wc.prototype.pa=function(a){a.append("$");a.append(this.d.toString())};Wc.prototype.Fa=function(a,b){var c=b[this.d];if(!c)throw Error("Parameter missing: "+this.d);return c};
function Xc(a,b,c){return b===a.f||b===a.b||c==a.f||c==a.b?a.f:b===a.g||b===a.d?c:c===a.g||c===a.d?b:new Bc(a,b,c)}function E(a,b,c){return b===a.b?c:c===a.b?b:new Lc(a,b,c)}function G(a,b,c){return b===a.b?new Ac(a,c):c===a.b?b:new Mc(a,b,c)}function Yc(a,b,c){return b===a.b||c===a.b?a.b:b===a.d?c:c===a.d?b:new Nc(a,b,c)}function Zc(a,b,c){return b===a.b?a.b:c===a.d?b:new Oc(a,b,c)};var $c={};function ad(){}n=ad.prototype;n.ub=function(a){for(var b=0;b<a.length;b++)a[b].U(this)};n.ld=function(){throw Error("E_CSS_EMPTY_NOT_ALLOWED");};n.md=function(){throw Error("E_CSS_SLASH_NOT_ALLOWED");};n.hc=function(){throw Error("E_CSS_STR_NOT_ALLOWED");};n.tb=function(){throw Error("E_CSS_IDENT_NOT_ALLOWED");};n.Rb=function(){throw Error("E_CSS_NUMERIC_NOT_ALLOWED");};n.Qb=function(){throw Error("E_CSS_NUM_NOT_ALLOWED");};n.Pb=function(a){return this.Qb(a)};
n.Ic=function(){throw Error("E_CSS_COLOR_NOT_ALLOWED");};n.ic=function(){throw Error("E_CSS_URL_NOT_ALLOWED");};n.eb=function(){throw Error("E_CSS_LIST_NOT_ALLOWED");};n.sb=function(){throw Error("E_CSS_COMMA_NOT_ALLOWED");};n.jb=function(){throw Error("E_CSS_FUNC_NOT_ALLOWED");};n.Ob=function(){throw Error("E_CSS_EXPR_NOT_ALLOWED");};function bd(){}u(bd,ad);n=bd.prototype;
n.ub=function(a){for(var b=null,c=0;c<a.length;c++){var d=a[c],e=d.U(this);if(b)b[c]=e;else if(d!==e){b=Array(a.length);for(d=0;d<c;d++)b[d]=a[d];b[c]=e}}return b||a};n.hc=function(a){return a};n.tb=function(a){return a};n.md=function(a){return a};n.Rb=function(a){return a};n.Qb=function(a){return a};n.Pb=function(a){return a};n.Ic=function(a){return a};n.ic=function(a){return a};n.eb=function(a){var b=this.ub(a.values);return b===a.values?a:new cd(b)};
n.sb=function(a){var b=this.ub(a.values);return b===a.values?a:new dd(b)};n.jb=function(a){var b=this.ub(a.values);return b===a.values?a:new ed(a.name,b)};n.Ob=function(a){return a};function fd(){}n=fd.prototype;n.toString=function(){var a=new Ja;this.Aa(a,!0);return a.toString()};n.stringValue=function(){var a=new Ja;this.Aa(a,!1);return a.toString()};n.ja=function(){throw Error("F_ABSTRACT");};n.Aa=function(a){a.append("[error]")};n.vd=function(){return!1};n.Xb=function(){return!1};n.xd=function(){return!1};
n.Kd=function(){return!1};n.Zc=function(){return!1};function gd(){if(H)throw Error("E_INVALID_CALL");}u(gd,fd);gd.prototype.ja=function(a){return new B(a,"")};gd.prototype.Aa=function(){};gd.prototype.U=function(a){return a.ld(this)};var H=new gd;function hd(){if(id)throw Error("E_INVALID_CALL");}u(hd,fd);hd.prototype.ja=function(a){return new B(a,"/")};hd.prototype.Aa=function(a){a.append("/")};hd.prototype.U=function(a){return a.md(this)};var id=new hd;function jd(a){this.b=a}u(jd,fd);
jd.prototype.ja=function(a){return new B(a,this.b)};jd.prototype.Aa=function(a,b){b?(a.append('"'),a.append(Ma(this.b)),a.append('"')):a.append(this.b)};jd.prototype.U=function(a){return a.hc(this)};function kd(a){this.name=a;if($c[a])throw Error("E_INVALID_CALL");$c[a]=this}u(kd,fd);kd.prototype.ja=function(a){return new B(a,this.name)};kd.prototype.Aa=function(a,b){b?a.append(La(this.name)):a.append(this.name)};kd.prototype.U=function(a){return a.tb(this)};kd.prototype.Kd=function(){return!0};
...
function Je(a,b,c,d,e){e&&(a=He(a),b=Wa(b,Ie),c=Wa(c,Ie));e=b.length;var f=c?c.length:0,g=[],h=[],l,k,m;for(l=0;l<e;l++)we(b[l],h,l);for(l=0;l<f;l++)we(c[l],h,l+e);b=h.length;h.sort(ue);for(c=0;h[c].e>=e;)c++;c=h[c].b.y;c>a.W&&g.push(new te(a.W,c,a.V,a.V));l=0;for(var p=[];l<b&&(m=h[l]).b.y<c;)m.d.y>c&&p.push(m),l++;for(;l<b||0<p.length;){var r=a.R,t=Ee(Math.ceil(c+8),d);for(k=0;k<p.length&&r>t;k++)m=p[k],m.b.x==m.d.x?m.d.y<r&&(r=Math.max(Fe(m.d.y,d),t)):m.b.x!=m.d.x&&(r=t);r>a.R&&(r=a.R);for(;l<
b&&(m=h[l]).b.y<r;)if(m.d.y<c)l++;else if(m.b.y<t){if(m.b.y!=m.d.y||m.b.y!=c)p.push(m),r=t;l++}else{k=Fe(m.b.y,d);k<r&&(r=k);break}t=[];for(k=0;k<p.length;k++)Ce(t,p[k],c,r);t.sort(function(a,b){return a.x-b.x||a.d-b.d});t=De(t,e,f);if(0==t.length)g.push(new te(c,r,a.V,a.V));else{var q=0,w=a.aa;for(k=0;k<t.length;k+=2){var Q=Math.max(a.aa,t[k]),P=Math.min(a.V,t[k+1])-Q;P>q&&(q=P,w=Q)}0==q?g.push(new te(c,r,a.V,a.V)):g.push(new te(c,r,Math.max(w,a.aa),Math.min(w+q,a.V)))}if(r==a.R)break;c=r;for(k=
...
function $e(a,b,c){var d=new ff(a,c||"");d.top=new Ue(d,null,"bootstrap");d.top.b=Ve;d.top.then(function(){function a(){d.h=!1;for(var b=0;b<d.g.length;b++){var c=d.g[b];try{c()}catch(e){v.error(e)}}}try{b().then(function(b){d.f=b;a()})}catch(c){Ye(d,c),a()}});c=Se;Se=d;a.Va(gf(d.top,"bootstrap"));Se=c;return d}function hf(a){this.d=a;this.Q=this.b=0;this.e=null}function ef(a,b){return b.b-a.b||b.Q-a.Q}hf.prototype.Va=function(a,b){this.e=a;this.d.d.Va(this,b)};
...
function mf(){var a=L("Frame.timeSlice"),b=a.d.d;b.e.currentTime()>=b.h?(v.debug("-- time slice --"),gf(a).Va(!0)):O(a,!0);return N(a)}function nf(a){function b(d){try{for(;d;){var e=a();if(e.Ca()){e.then(b);return}e.then(function(a){d=a})}O(c,!0)}catch(f){Ye(c.d,f,c)}}var c=L("Frame.loop");b(!0);return N(c)}function of(a){var b=Se;if(!b)throw Error("E_TASK_NO_CONTEXT");return nf(function(){var c;do c=new pf(b,b.top),b.top=c,c.b=Ve,a(c),c=N(c);while(!c.Ca()&&c.mc());return c})}
function gf(a,b){lf(a);if(a.d.e)throw Error("E_TASK_ALREADY_SUSPENDED");var c=new hf(a.d);a.d.e=c;Se=null;a.d.j=b||null;return c}function pf(a,b){Ue.call(this,a,b,"loop")}u(pf,Ue);function qf(a){O(a,!0)}function R(a){O(a,!1)};function rf(a,b,c,d,e){var f=L("ajax"),g=new XMLHttpRequest,h=gf(f,g),l={status:0,url:a,contentType:null,responseText:null,responseXML:null,wc:null};g.open(c||"GET",a,!0);b&&(g.responseType=b);g.onreadystatechange=function(){if(4===g.readyState){l.status=g.status;if(200==l.status||0==l.status)if(b&&"document"!==b||!g.responseXML){var c=g.response;b&&"text"!==b||"string"!=typeof c?c?"string"==typeof c?l.wc=sf([c]):l.wc=c:v.b("Unexpected empty success response for",a):l.responseText=c;if(c=g.getResponseHeader("Content-Type"))l.contentType=
...
a.b=Of;l.splice(0,l.length);continue;case 29:a.b=Nf;g.cb();continue;case 1:if(!k.b){a.b=Sf;g.error("E_CSS_SPACE_EXPECTED",k);continue}g.kb();case 2:if(34==z(h,1).type)if(A(h),A(h),p=a.I[k.text],null!=p)switch(k=y(h),k.type){case 1:g.hb(p,k.text);a.b=f?Lf:S;A(h);break;case 36:g.hb(p,null);a.b=f?Lf:S;A(h);break;default:a.b=Qf,g.error("E_CSS_NAMESPACE",k)}else a.b=Qf,g.error("E_CSS_UNDECLARED_PREFIX",k);else g.hb(a.D,k.text),a.b=f?Lf:S,A(h);continue;case 3:if(!k.b){a.b=Sf;g.error("E_CSS_SPACE_EXPECTED",
k);continue}g.kb();case 4:if(34==z(h,1).type)switch(A(h),A(h),k=y(h),k.type){case 1:g.hb(null,k.text);a.b=f?Lf:S;A(h);break;case 36:g.hb(null,null);a.b=f?Lf:S;A(h);break;default:a.b=Qf,g.error("E_CSS_NAMESPACE",k)}else g.hb(a.D,null),a.b=f?Lf:S,A(h);continue;case 5:k.b&&g.kb();case 6:g.Vc(k.text);a.b=f?Lf:S;A(h);continue;case 7:k.b&&g.kb();case 8:g.Pc(k.text);a.b=f?Lf:S;A(h);continue;case 55:k.b&&g.kb();case 14:A(h);k=y(h);b:switch(k.type){case 1:g.Zb(k.text,null);A(h);a.b=f?Lf:S;continue;case 6:m=
...
null);a.b=f?Lf:S;A(h);continue;case 6:if(m=k.text,A(h),p=Zf(a),k=y(h),11==k.type){g.$b(m,p);a.b=f?Lf:S;A(h);continue}}g.error("E_CSS_PSEUDOELEM_SYNTAX",k);a.b=Qf;continue;case 9:k.b&&g.kb();case 10:A(h);k=y(h);if(1==k.type)m=k.text,A(h);else if(36==k.type)m=null,A(h);else if(34==k.type)m="";else{a.b=Sf;g.error("E_CSS_ATTR",k);A(h);continue}k=y(h);if(34==k.type){p=m?a.I[m]:m;if(null==p){a.b=Sf;g.error("E_CSS_UNDECLARED_PREFIX",k);A(h);continue}A(h);k=y(h);if(1!=k.type){a.b=Sf;g.error("E_CSS_ATTR_NAME_EXPECTED",
...
function dg(a){Af.call(this,null);this.d=a}u(dg,Af);dg.prototype.error=function(a){throw Error(a);};dg.prototype.Y=function(){return this.d};
function eg(a,b,c,d,e){var f=L("parseStylesheet"),g=new Uf(Jf,a,b,c),h=null;e&&(h=fg(new Ub(e,b),b,c));if(h=ag(g,d,h&&h.ja()))b.Bb(h),b.ra();nf(function(){for(;!cg(g,100,!1,!1,!1,!1);){if(g.A){var a=wa(g.H,c);g.k&&(b.Bb(g.k),b.ra());var d=L("parseStylesheet.import");gg(a,b,null,null).then(function(){g.k&&b.lb();g.A=!1;g.H=null;g.k=null;O(d,!0)});return N(d)}a=mf();if(a.Ca)return a}return M(!1)}).then(function(){h&&b.lb();O(f,!0)});return N(f)}
function hg(a,b,c,d,e){return Xe("parseStylesheetFromText",function(f){var g=new Ub(a,b);eg(g,b,c,d,e).ua(f)},function(b,c){v.b(c,"Failed to parse stylesheet text: "+a);O(b,!1)})}function gg(a,b,c,d){return Xe("parseStylesheetFromURL",function(e){rf(a).then(function(f){f.responseText?hg(f.responseText,b,a,c,d).then(function(b){b||v.b("Failed to parse stylesheet from "+a);O(e,!0)}):O(e,!0)})},function(b,c){v.b(c,"Exception while fetching and parsing:",a);O(b,!0)})}
...
function kg(a,b,c){if(b.vd())a:{b=b.d;a=b.evaluate(a);switch(typeof a){case "number":c=jg[c]?a==Math.round(a)?new md(a):new ld(a):new J(a,"px");break a;case "string":c=a?ig(b.b,new Ub(a,null)):H;break a;case "boolean":c=a?ie:Dd;break a;case "undefined":c=H;break a}throw Error("E_UNEXPECTED");}else c=b;return c};function lg(){this.b={}}u(lg,ad);lg.prototype.tb=function(a){this.b[a.name]=!0;return a};lg.prototype.eb=function(a){this.ub(a.values);return a};function mg(a){this.value=a}u(mg,ad);mg.prototype.Pb=function(a){this.value=a.C;return a};function ng(a,b){if(a){var c=new mg(b);try{return a.U(c),c.value}catch(d){v.b(d,"toInt: ")}}return b}function og(){this.d=!1;this.b=[];this.name=null}u(og,ad);og.prototype.Rb=function(a){this.d&&this.b.push(a);return null};
og.prototype.Qb=function(a){this.d&&0==a.C&&this.b.push(new J(0,"px"));return null};og.prototype.eb=function(a){this.ub(a.values);return null};og.prototype.jb=function(a){this.d||(this.d=!0,this.ub(a.values),this.d=!1,this.name=a.name.toLowerCase());return null};
...
continue}}else m=k.U(f.b);if(m){if(m!==k&&b===e)for(e=[],k=0;k<g;k++)e[k]=b[k];b!==e&&(e[g-d]=m);g++;f=f.f}else f=f.e}}return f===a.b&&(c?0<e.length:g==b.length)?e:null}n=Fg.prototype;n.Ta=function(a){for(var b=null,c=this.d;c!==this.b&&c!==this.e;)a?0!=c.d?c=c.f:(b=a.U(c.b))?(a=null,c=c.f):c=c.e:c=c.e;return c===this.b?b:null};n.ld=function(a){return this.Ta(a)};n.md=function(a){return this.Ta(a)};n.hc=function(a){return this.Ta(a)};n.tb=function(a){return this.Ta(a)};n.Rb=function(a){return this.Ta(a)};
n.Qb=function(a){return this.Ta(a)};n.Pb=function(a){return this.Ta(a)};n.Ic=function(a){return this.Ta(a)};n.ic=function(a){return this.Ta(a)};n.eb=function(){return null};n.sb=function(){return null};n.jb=function(a){return this.Ta(a)};n.Ob=function(){return null};function Hg(a){Fg.call(this,a)}u(Hg,Fg);Hg.prototype.eb=function(a){var b=Gg(this,a.values,!1,0);return b===a.values?a:b?new cd(b):null};
...
function Jg(a,b){Fg.call(this,b);this.name=a}u(Jg,Fg);Jg.prototype.Ta=function(){return null};Jg.prototype.jb=function(a){if(a.name.toLowerCase()!=this.name)return null;var b=Gg(this,a.values,!1,0);return b===a.values?a:b?new ed(a.name,b):null};function Kg(){}Kg.prototype.b=function(a,b){return b};Kg.prototype.e=function(){};function Lg(a,b){this.name=b;this.f=a.e[this.name]}u(Lg,Kg);
Lg.prototype.b=function(a,b,c){if(c.values[this.name])return b;if(a=this.f.f(a,b)){var d=a.length;this.e(1<d?new cd(a):a[0],c);return b+d}return b};Lg.prototype.e=function(a,b){b.values[this.name]=a};function Mg(a,b){Lg.call(this,a,b[0]);this.d=b}u(Mg,Lg);Mg.prototype.e=function(a,b){for(var c=0;c<this.d.length;c++)b.values[this.d[c]]=a};function Ng(a,b){this.d=a;this.Bd=b}u(Ng,Kg);
Ng.prototype.b=function(a,b,c){var d=b;if(this.Bd)if(a[b]==id){if(++b==a.length)return d}else return d;var e=this.d[0].b(a,b,c);if(e==b)return d;b=e;for(d=1;d<this.d.length&&b<a.length;d++){e=this.d[d].b(a,b,c);if(e==b)break;b=e}return b};function Og(){this.b=this.Qa=null;this.error=!1;this.values={};this.d=null}n=Og.prototype;n.clone=function(){var a=new this.constructor;a.Qa=this.Qa;a.b=this.b;a.d=this.d;return a};n.od=function(a,b){this.Qa=a;this.b=b};n.Eb=function(){this.error=!0;return 0};
function Pg(a,b){a.Eb([b]);return null}n.ld=function(a){return Pg(this,a)};n.hc=function(a){return Pg(this,a)};n.tb=function(a){return Pg(this,a)};n.Rb=function(a){return Pg(this,a)};n.Qb=function(a){return Pg(this,a)};n.Pb=function(a){return Pg(this,a)};n.Ic=function(a){return Pg(this,a)};n.ic=function(a){return Pg(this,a)};n.eb=function(a){this.Eb(a.values);return null};n.sb=function(){this.error=!0;return null};n.jb=function(a){return Pg(this,a)};n.Ob=function(){this.error=!0;return null};
function Qg(){Og.call(this)}u(Qg,Og);Qg.prototype.Eb=function(a){for(var b=0,c=0;b<a.length;){var d=this.Qa[c].b(a,b,this);if(d>b)b=d,c=0;else if(++c==this.Qa.length){this.error=!0;break}}return b};function Rg(){Og.call(this)}u(Rg,Og);Rg.prototype.Eb=function(a){if(a.length>this.Qa.length||0==a.length)return this.error=!0,0;for(var b=0;b<this.Qa.length;b++){for(var c=b;c>=a.length;)c=1==c?0:c-2;if(this.Qa[b].b(a,c,this)!=c+1)return this.error=!0,0}return a.length};function Sg(){Og.call(this)}
u(Sg,Og);Sg.prototype.Eb=function(a){for(var b=a.length,c=0;c<a.length;c++)if(a[c]===id){b=c;break}if(b>this.Qa.length||0==a.length)return this.error=!0,0;for(c=0;c<this.Qa.length;c++){for(var d=c;d>=b;)d=1==d?0:d-2;var e;if(b+1<a.length)for(e=b+c+1;e>=a.length;)e-=e==b+2?1:2;else e=d;if(2!=this.Qa[c].b([a[d],a[e]],0,this))return this.error=!0,0}return a.length};function Tg(){Og.call(this)}u(Tg,Qg);
...
function rh(a,b,c,d){var e=L("initFont"),f=b.src,g={},h;for(h in hh)g[h]=b.Ab[h];d=qh(a,b,d);g["font-family"]=I(d);var l=new lh(g),k=a.b.ownerDocument.createElement("span");k.textContent="M";var m=(new Date).valueOf()+1E3;b=a.d.ownerDocument.createElement("style");h=ih+jh++;b.textContent=mh(l,"",sf([h]));a.d.appendChild(b);a.b.appendChild(k);k.style.visibility="hidden";k.style.fontFamily=d;for(var p in hh)x(k,p,g[p].toString());var g=k.getBoundingClientRect(),r=g.right-g.left,t=g.bottom-g.top;b.textContent=
mh(l,f,c);v.e("Starting to load font:",f);var q=!1;nf(function(){var a=k.getBoundingClientRect(),b=a.bottom-a.top;if(r!=a.right-a.left||t!=b)return q=!0,M(!1);(new Date).valueOf()>m?a=M(!1):(a=L("Frame.sleep"),gf(a).Va(!0,10),a=N(a));return a}).then(function(){q?v.e("Loaded font:",f):v.b("Failed to load font:",f);a.b.removeChild(k);O(e,l)});return N(e)}
function sh(a,b,c){var d=b.src,e=a.e[d];e?sg(e,function(a){if(a.d==b.d){var e=b.b,h=c.b[e];a=a.b;if(h){if(h!=a)throw Error("E_FONT_FAMILY_INCONSISTENT "+b.b);}else c.b[e]=a;v.b("Found already-loaded font:",d)}else v.b("E_FONT_FACE_INCOMPATIBLE",b.src)}):(e=new xf(function(){var e=L("loadFont"),g=c.d?c.d(d):null;g?rf(d,"blob").then(function(d){d.wc?g(d.wc).then(function(d){rh(a,b,d,c).ua(e)}):O(e,null)}):rh(a,b,null,c).ua(e);return N(e)},"loadFont "+d),a.e[d]=e,e.start());return e}
...
function Ai(a){this.d=a;this.H=this.D=this.height=this.width=this.u=this.k=this.w=this.j=this.za=this.ba=this.Sa=this.S=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.wb=this.I=null;this.oa=this.Db=this.Za=this.kc=this.e=0;this.b=!1}function Bi(a){return a.marginTop+a.ba+a.k}function Ci(a){return a.marginBottom+a.za+a.u}function Di(a){return a.marginLeft+a.S+a.j}function Ei(a){return a.marginRight+a.Sa+a.w}
function Fi(a,b){a.d=b.d;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.S=b.S;a.Sa=b.Sa;a.ba=b.ba;a.za=b.za;a.j=b.j;a.w=b.w;a.k=b.k;a.u=b.u;a.width=b.width;a.height=b.height;a.D=b.D;a.H=b.H;a.wb=b.wb;a.I=b.I;a.e=b.e;a.kc=b.kc;a.Za=b.Za;a.b=b.b}function Gi(a,b,c){a.top=b;a.height=c;x(a.d,"top",b+"px");x(a.d,"height",c+"px")}function Hi(a,b,c){a.left=b;a.width=c;x(a.d,"left",b+"px");x(a.d,"width",c+"px")}
function Ii(a,b){this.b=a;this.d=b}u(Ii,ad);Ii.prototype.hc=function(a){this.b.appendChild(this.b.ownerDocument.createTextNode(a.b));return null};Ii.prototype.ic=function(a){var b=this.b.ownerDocument.createElementNS("http://www.w3.org/1999/xhtml","img");b.setAttribute("src",a.url);this.b.appendChild(b);return null};Ii.prototype.eb=function(a){this.ub(a.values);return null};
...
function qj(a,b){if(0<a.length){a.sort(function(a,b){return b.d()-a.d()});for(var c=null,d=a.length-1;0<=d;d--)c=a[d],c.b=b,b=c;return c}return b}function rj(a,b){this.e=a;this.d=b;this.b=""}u(rj,bd);function sj(a){a=a.e["font-size"].value;var b;a:switch(a.ha.toLowerCase()){case "px":case "in":case "pt":case "pc":case "cm":case "mm":case "q":b=!0;break a;default:b=!1}if(!b)throw Error("Unexpected state");return a.C*lc[a.ha]}
...
function vj(a){this.b=a}u(vj,tj);vj.prototype.apply=function(a){a.f[a.f.length-1].push(this.b.b())};function uj(a){this.b=a}u(uj,tj);uj.prototype.apply=function(a){for(var b=0;b<this.b.length;b++)this.b[b].apply(a)};uj.prototype.h=function(a){this.b.push(a);return this};uj.prototype.clone=function(){return new uj([].concat(this.b))};function wj(a,b,c,d){this.style=a;this.P=b;this.b=c;this.f=d}u(wj,tj);wj.prototype.apply=function(a){pj(a.g,a.u,this.style,this.P,this.b,this.f)};
...
function Lj(a,b){this.b=null;this.f=a;this.Sb=b}u(Lj,W);function Mj(a,b){var c=a.f;b-=a.Sb;return 0===c?0===b:0===b%c&&0<=b/c}function Nj(a,b){Lj.call(this,a,b)}u(Nj,Lj);Nj.prototype.apply=function(a){Mj(this,a.za)&&this.b.apply(a)};Nj.prototype.d=function(){return 5};function Oj(a,b){Lj.call(this,a,b)}u(Oj,Lj);Oj.prototype.apply=function(a){Mj(this,a.fb[a.e][a.d])&&this.b.apply(a)};Oj.prototype.d=function(){return 5};function Pj(a,b){Lj.call(this,a,b)}u(Pj,Lj);
...
fk.prototype.pop=function(a,b){return 0==b?(a.lang=this.lang,!0):!1};function gk(a){this.d=a}gk.prototype.b=function(){return this};gk.prototype.push=function(){return!1};gk.prototype.pop=function(a,b){return 0==b?(a.D=this.d,!0):!1};function hk(a){this.b=a}u(hk,bd);function ik(a,b){switch(b){case "url":return a?new od(a):new od("about:invalid");default:return a?new jd(a):new jd("")}}
hk.prototype.jb=function(a){if("attr"!==a.name)return bd.prototype.jb.call(this,a);var b="string",c=null,d=null;a.values[0]instanceof cd?(2<=a.values[0].values.length&&(b=a.values[0].values[1].stringValue()),c=a.values[0].values[0].stringValue()):c=a.values[0].stringValue();d=1<a.values.length?ik(a.values[1].stringValue(),b):ik(null,b);return this.b&&this.b.hasAttribute(c)?ik(this.b.getAttribute(c),b):d};function jk(a,b,c){this.d=a;this.b=c}u(jk,bd);
jk.prototype.tb=function(a){var b=this.d,c=b.D,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.l)];b.l++;break;case "close-quote":return 0<b.l&&b.l--,c[2*Math.min(d,b.l)+1];case "no-open-quote":return b.l++,new jd("");case "no-close-quote":return 0<b.l&&b.l--,new jd("")}return a};
...
jk.prototype.jb=function(a){switch(a.name){case "counter":if(2>=a.values.length)return qk(this,a.values);break;case "counters":if(3>=a.values.length)return sk(this,a.values);break;case "target-counter":if(3>=a.values.length)return uk(this,a.values);break;case "target-counters":if(4>=a.values.length)return wk(this,a.values)}v.b("E_CSS_CONTENT_PROP:",a.toString());return new jd("")};var yk=1/1048576;function zk(a,b){for(var c in a)b[c]=a[c].clone()}
...
function Bk(a,b,c,d){this.k=a;this.g=b;this.Db=c;this.Ya=d;this.f=[[],[]];this.j={};this.w=this.u=this.b=null;this.oa=this.ba=this.O=this.e=this.d="";this.S=this.H=null;this.ma=this.Sa=!0;this.h={};this.A=[{}];this.D=[new jd("\u201c"),new jd("\u201d"),new jd("\u2018"),new jd("\u2019")];this.l=0;this.lang="";this.xb=[0];this.za=0;this.ka=[{}];this.fb=this.ka[0];this.I=null;this.vb=[this.I];this.wb=[{}];this.Za=this.ka[0];this.gb=[]}function Zj(a,b){a.j[b]=(a.j[b]||0)+1}
...
d?e=new Gj(a,b):(v.b("Unsupported :: attr selector op:",d),e=new Vj(""));break;default:v.b("Unsupported attr selector:",c),e=new Vj("")}this.b.push(e)};var Sk=0;n=Pk.prototype;n.kb=function(){var a="d"+Sk++;Qk(this,new vj(new Yj(a)));this.b=[new Vj(a)]};n.Oc=function(){var a="c"+Sk++;Qk(this,new vj(new ak(a)));this.b=[new Vj(a)]};n.Nc=function(){var a="a"+Sk++;Qk(this,new vj(new bk(a)));this.b=[new Vj(a)]};n.Sc=function(){var a="f"+Sk++;Qk(this,new vj(new ck(a)));this.b=[new Vj(a)]};
n.Jb=function(){Tk(this);this.f=null;this.l=!1;this.P=0;this.b=[]};n.cb=function(){var a;0!=this.j?(If(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.j=1,this.h={},this.f=null,this.P=0,this.l=!1,this.b=[])};n.error=function(a,b){Gf.prototype.error.call(this,a,b);1==this.j&&(this.j=0)};n.Nb=function(a){Gf.prototype.Nb.call(this,a);this.j=0};n.ra=function(){Tk(this);Gf.prototype.ra.call(this);1==this.j&&(this.j=0)};n.lb=function(){Gf.prototype.lb.call(this)};
...
function Fl(a,b,c,d,e){var f=0,g=Number.POSITIVE_INFINITY,h=!1,l=!1,k=!1,m=c["flow-options"];if(m){var p;a:{if(h=m.evaluate(a.f,"flow-options")){l=new lg;try{h.U(l);p=l.b;break a}catch(r){v.b(r,"toSet:")}}p={}}h=!!p.exclusive;l=!!p["static"];k=!!p.last}(p=c["flow-linger"])&&(g=ng(p.evaluate(a.f,"flow-linger"),Number.POSITIVE_INFINITY));(c=c["flow-priority"])&&(f=ng(c.evaluate(a.f,"flow-priority"),0));c=a.S[e]||null;p=a.l[b];p||(p=ql(a.g),p=a.l[b]=new di(p?p.g.b:null));d=new ei(b,d,e,f,g,h,l,k,c);
...
function El(a,b,c){var d=-1;if(b<=a.b&&(d=fl(a.e,b),d+=c,d<cl(a.e)))return gl(a.e,d);if(null==a.d)return Number.POSITIVE_INFINITY;for(var e=a.f;;){var f=a.d.firstChild;if(null==f)for(;;){if(1==a.d.nodeType){var f=a.O,g=a.d;if(f.gb.pop()!==g)throw Error("Invalid call to popElement");f.xb.pop();f.ka.pop();f.vb.pop();f.wb.pop();f.pop();Ik(f);a.Na=a.ba.pop();g=a.g.pop(a.b);f=null;g.d&&(f=ml(g.d,"before"),Il(a,f,g.d.Ea?sl(a.g,g):g.d.offset,g.b),f=ml(g.d,"after"));f=ll(f,ml(g,"after"));Il(a,f,a.b,g.b)}if(f=
...
d)}}}tl.prototype.h=function(a,b){var c=xh(this.X,a),d="e"+c;b&&(c=yh(this.X,a,0,!0));this.b<=c&&El(this,c,0);return this.I[d]};var Jl=1;function Kl(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.h=0;this.d=a;this.name=b;this.rb=c;this.Ba=d;this.parent=e;this.g="p"+Jl++;e&&(this.h=e.children.length,e.children.push(this))}Kl.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Kl.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Ll(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
function Ml(a,b){for(var c=0;c<a.children.length;c++)a.children[c].clone({parent:b})}function Nl(a){Kl.call(this,a,null,null,[],null);this.b.width=new V(ke,0);this.b.height=new V(le,0)}u(Nl,Kl);
function Ol(a,b){this.e=b;var c=this;gc.call(this,a,function(a,b){var f=a.match(/^([^.]+)\.([^.]+)$/);if(f){var g=c.e.j[f[1]];if(g&&(g=this.ka[g])){if(b){var f=f[2],h=g.ba[f];if(h)g=h;else{switch(f){case "columns":var h=g.d.d,l=new Wc(h,0),k=Pl(g,"column-count"),m=Pl(g,"column-width"),p=Pl(g,"column-gap"),h=G(h,Yc(h,new Tc(h,"min",[l,k]),E(h,m,p)),p)}h&&(g.ba[f]=h);g=h}}else g=Pl(g,f[2]);return g}}return null})}u(Ol,gc);
function Ql(a,b,c,d,e,f,g){a=a instanceof Ol?a:new Ol(a,this);Kl.call(this,a,b,c,d,e);this.e=this;this.M=f;this.P=g;this.b.width=new V(ke,0);this.b.height=new V(le,0);this.b["wrap-flow"]=new V(ud,0);this.b.position=new V(Wd,0);this.b.overflow=new V(he,0);this.j={}}u(Ql,Kl);Ql.prototype.f=function(a){return new Rl(a,this)};Ql.prototype.clone=function(a){a=new Ql(this.d,this.name,a.rb||this.rb,this.Ba,this.parent,this.M,this.P);Ll(this,a);Ml(this,a);return a};
function Sl(a,b,c,d,e){Kl.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.j[b]=this.g);this.b["wrap-flow"]=new V(ud,0)}u(Sl,Kl);Sl.prototype.f=function(a){return new Tl(a,this)};Sl.prototype.clone=function(a){a=new Sl(a.parent.d,this.name,this.rb,this.Ba,a.parent);Ll(this,a);Ml(this,a);return a};function Ul(a,b,c,d,e){Kl.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.j[b]=this.g)}u(Ul,Kl);Ul.prototype.f=function(a){return new Vl(a,this)};
Ul.prototype.clone=function(a){a=new Ul(a.parent.d,this.name,this.rb,this.Ba,a.parent);Ll(this,a);Ml(this,a);return a};function X(a,b,c){return b&&b!==ud?b.ja(a,c):null}function Wl(a,b,c){return b&&b!==ud?b.ja(a,c):a.b}function Xl(a,b,c){return b?b===ud?null:b.ja(a,c):a.b}function Yl(a,b,c,d){return b&&c!==Rd?b.ja(a,d):a.b}function Zl(a,b,c){return b?b===ie?a.g:b===Dd?a.f:b.ja(a,a.b):c}
...
$l.prototype.Wc=function(){var a=this.d.d,b=this.style,c=this.e?this.e.style.width.ja(a,null):null,d=X(a,b.left,c),e=X(a,b["margin-left"],c),f=Yl(a,b["border-left-width"],b["border-left-style"],c),g=Wl(a,b["padding-left"],c),h=X(a,b.width,c),l=X(a,b["max-width"],c),k=Wl(a,b["padding-right"],c),m=Yl(a,b["border-right-width"],b["border-right-style"],c),p=X(a,b["margin-right"],c),r=X(a,b.right,c),t=E(a,f,g),q=E(a,f,k);d&&r&&h?(t=G(a,c,E(a,h,E(a,E(a,d,t),q))),e?p?r=G(a,t,p):p=G(a,t,E(a,r,e)):(t=G(a,t,
r),p?e=G(a,t,p):p=e=Yc(a,t,new B(a,.5)))):(e||(e=a.b),p||(p=a.b),d||r||h||(d=a.b),d||h?d||r?h||r||(h=this.l,this.g=!0):d=a.b:(h=this.l,this.g=!0),t=G(a,c,E(a,E(a,e,t),E(a,p,q))),this.g&&(l||(l=G(a,t,d?d:r)),this.b||!X(a,b["column-width"],null)&&!X(a,b["column-count"],null)||(h=l,this.g=!1)),d?h?r||(r=G(a,t,E(a,d,h))):h=G(a,t,E(a,d,r)):d=G(a,t,E(a,r,h)));a=Wl(a,b["snap-width"]||(this.e?this.e.style["snap-width"]:null),c);b.left=new K(d);b["margin-left"]=new K(e);b["border-left-width"]=new K(f);b["padding-left"]=
...
$l.prototype.Xc=function(){var a=this.d.d,b=this.style,c=this.e?this.e.style.width.ja(a,null):null,d=this.e?this.e.style.height.ja(a,null):null,e=X(a,b.top,d),f=X(a,b["margin-top"],c),g=Yl(a,b["border-top-width"],b["border-top-style"],c),h=Wl(a,b["padding-top"],c),l=X(a,b.height,d),k=X(a,b["max-height"],d),m=Wl(a,b["padding-bottom"],c),p=Yl(a,b["border-bottom-width"],b["border-bottom-style"],c),r=X(a,b["margin-bottom"],c),t=X(a,b.bottom,d),q=E(a,g,h),w=E(a,p,m);e&&t&&l?(d=G(a,d,E(a,l,E(a,E(a,e,q),
w))),f?r?t=G(a,d,f):r=G(a,d,E(a,t,f)):(d=G(a,d,t),r?f=G(a,d,r):r=f=Yc(a,d,new B(a,.5)))):(f||(f=a.b),r||(r=a.b),e||t||l||(e=a.b),e||l?e||t?l||t||(l=this.k,this.f=!0):e=a.b:(l=this.k,this.f=!0),d=G(a,d,E(a,E(a,f,q),E(a,r,w))),this.f&&(k||(k=G(a,d,e?e:t)),this.b&&(X(a,b["column-width"],null)||X(a,b["column-count"],null))&&(l=k,this.f=!1)),e?l?t||(t=G(a,d,E(a,e,l))):l=G(a,d,E(a,t,e)):e=G(a,d,E(a,t,l)));a=Wl(a,b["snap-height"]||(this.e?this.e.style["snap-height"]:null),c);b.top=new K(e);b["margin-top"]=
new K(f);b["border-top-width"]=new K(g);b["padding-top"]=new K(h);b.height=new K(l);b["max-height"]=new K(k?k:l);b["padding-bottom"]=new K(m);b["border-bottom-width"]=new K(p);b["margin-bottom"]=new K(r);b.bottom=new K(t);b["snap-height"]=new K(a)};
...
function km(a,b,c){var d=Y(a,b,"right"),e=Y(a,b,"snap-height"),f=Y(a,b,"margin-right"),g=Y(a,b,"padding-right");b=Y(a,b,"border-right-width");x(c.d,"margin-right",f+"px");x(c.d,"padding-right",g+"px");x(c.d,"border-right-width",b+"px");c.marginRight=f;c.Sa=b;a.b&&0<e&&(a=d+Ei(c),a=a-Math.floor(a/e)*e,0<a&&(c.Db=e-a,g+=c.Db));c.w=g;c.kc=e}
...
function om(a,b,c){x(c.d,"border-top-width","0px");var d=Y(a,b,"max-height");a.I?Gi(c,0,d):(lm(a,b,c),d-=c.oa,c.height=d,x(c.d,"height",d+"px"))}function pm(a,b,c){x(c.d,"border-left-width","0px");var d=Y(a,b,"max-width");a.H?Hi(c,0,d):(km(a,b,c),d-=c.Db,c.width=d,a=Y(a,b,"right"),x(c.d,"right",a+"px"),x(c.d,"width",d+"px"))}
...
$l.prototype.qb=function(a,b,c,d){this.e&&this.b==this.e.b||x(b.d,"writing-mode",this.b?"vertical-rl":"horizontal-tb");(this.b?this.g:this.f)?this.b?pm(this,a,b):om(this,a,b):(this.b?km(this,a,b):lm(this,a,b),this.b?jm(this,a,b):mm(this,a,b));(this.b?this.f:this.g)?this.b?om(this,a,b):pm(this,a,b):nm(this,a,b);for(c=0;c<qm.length;c++)im(this,a,b,qm[c],d)};function um(a,b,c,d){for(var e=0;e<sm.length;e++)im(a,b,c,sm[e],d)}
$l.prototype.sc=function(a,b,c,d,e,f,g){this.b?this.A=b.e+b.Db:this.w=b.e+b.oa;f=(this.b||!d)&&this.f;var h=(!this.b||!d)&&this.g,l=null;if(h||f)h&&x(b.d,"width","auto"),f&&x(b.d,"height","auto"),l=(d?d.d:b.d).getBoundingClientRect(),h&&(this.A=Math.ceil(l.right-l.left-b.j-b.S-b.w-b.Sa),this.b&&(this.A+=b.Db)),f&&(this.w=l.bottom-l.top-b.k-b.ba-b.u-b.za,this.b||(this.w+=b.oa));(this.b?this.f:this.g)&&nm(this,a,b);if(this.b?this.g:this.f){if(this.b?this.H:this.I)this.b?km(this,a,b):lm(this,a,b);this.b?
jm(this,a,b):mm(this,a,b)}if(1<e&&(f=Y(this,a,"column-rule-width"),h=hm(this,a,"column-rule-style"),l=hm(this,a,"column-rule-color"),0<f&&h&&h!=Rd&&l!=ee)){var k=Y(this,a,"column-gap"),m=this.b?b.height:b.width,p=this.b?"border-top":"border-left";for(d=1;d<e;d++){var r=(m+k)*d/e-k/2+b.j-f/2,t=b.height+b.k+b.u,q=b.d.ownerDocument.createElement("div");x(q,"position","absolute");x(q,this.b?"left":"top","0px");x(q,this.b?"top":"left",r+"px");x(q,this.b?"height":"width","0px");x(q,this.b?"width":"height",
t+"px");x(q,p,f+"px "+h.toString()+(l?" "+l.toString():""));b.d.insertBefore(q,b.d.firstChild)}}for(d=0;d<rm.length;d++)im(this,a,b,rm[d],g);for(d=0;d<tm.length;d++)e=b,g=tm[d],f=c.h,(h=hm(this,a,g))&&f.push(new Th(e.d,g,h))};
...
Vl.prototype.O=function(a){var b=this.d.d,c=this.style,d=Zl(b,c.required,b.f)!==b.f;if(d||this.f){var e;e=(e=c["flow-from"])?e.ja(b,b.b):new B(b,"body");e=new Tc(b,"has-content",[e]);a=Xc(b,a,e)}a=xm(this,a,c["required-partitions"],!1);a=xm(this,a,c["conflicting-partitions"],!0);d&&(c=(c=this.u.style.enabled)?c.ja(b,null):b.g,c=Xc(b,c,a),this.u.style.enabled=new K(c));return a};Vl.prototype.qb=function(a,b,c,d,e){x(b.d,"overflow","hidden");$l.prototype.qb.call(this,a,b,c,d,e)};
function ym(a,b,c,d){Ff.call(this,a,b,!1);this.target=c;this.b=d}u(ym,Gf);ym.prototype.ab=function(a,b,c){fh(this.b,a,b,c,this)};ym.prototype.Hc=function(a,b){Hf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};ym.prototype.Wb=function(a,b){Hf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};ym.prototype.bb=function(a,b,c){this.target.b[a]=new V(b,c?50331648:67108864)};function zm(a,b,c,d){ym.call(this,a,b,c,d)}u(zm,ym);
function Am(a,b,c,d){ym.call(this,a,b,c,d);c.b.width=new V(je,0);c.b.height=new V(je,0)}u(Am,ym);Am.prototype.fc=function(a,b,c){a=new Ul(this.d,a,b,c,this.target);Ef(this.$,new zm(this.d,this.$,a,this.b))};Am.prototype.ec=function(a,b,c){a=new Sl(this.d,a,b,c,this.target);a=new Am(this.d,this.$,a,this.b);Ef(this.$,a)};function Bm(a,b,c,d){ym.call(this,a,b,c,d)}u(Bm,ym);Bm.prototype.fc=function(a,b,c){a=new Ul(this.d,a,b,c,this.target);Ef(this.$,new zm(this.d,this.$,a,this.b))};
...
function Mm(a,b,c,d,e,f,g,h,l,k,m,p,r,t){this.w=a;this.d=b;this.viewport=c;this.l=c.b;this.j=d;this.D=e;this.X=f;this.A=g;this.k=h;this.H=l;this.page=k;this.f=m;this.u=p;this.e=r;this.g=t;this.I=this.b=null;this.h=!1;this.Z=null;this.da=0;this.B=null}Mm.prototype.clone=function(){return new Mm(this.w,this.d,this.viewport,this.j,this.D,this.X,this.A,this.k,this.H,this.page,this.f,this.u,this.e,this.g)};
function Nm(a,b,c,d,e,f){var g=L("createRefShadow");a.X.j.load(b).then(function(h){if(h){var l=Ch(h,b);if(l){var k=a.H,m=k.A[h.url];if(!m){var m=k.style.h.b[h.url],p=new nc(0,k.ob(),k.nb(),k.j),m=new tl(h,m.e,m.d,p,k.g,m.j,new Om(k.f,h.url),new Pm(k.f,h.url,m.d,m.b));k.A[h.url]=m}f=new ji(d,l,h,e,f,c,m)}}O(g,f)});return N(g)}
function Qm(a,b,c,d,e,f,g,h){var l=L("createShadows"),k=e.template,m;k instanceof od?m=Nm(a,k.url,2,b,h,null):m=M(null);m.then(function(k){var m=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var t=b.getAttribute("href"),q=null;t?q=h?h.X:a.X:h&&(t="http://www.w3.org/1999/xhtml"==h.$.namespaceURI?h.$.getAttribute("href"):h.$.getAttributeNS("http://www.w3.org/1999/xlink","href"),q=h.ed?h.ed.X:a.X);t&&(t=wa(t,q.url),m=Nm(a,t,3,b,h,k))}null==m&&(m=M(k));m.then(function(k){var m;
if(m=d._pseudos){for(var p=[],r=Im.createElementNS("http://www.pyroxy.com/ns/shadow","root"),q=r,t=0;t<Jm.length;t++){var F=Jm[t],ia;if(F){if(!m[F])continue;if(!("footnote-marker"!=F||c&&a.h))continue;if(F.match(/^first-/)&&(ia=e.display,!ia||ia===Jd))continue;if("before"===F||"after"===F)if(ia=m[F].content,!ia||ia===Sd||ia===Rd)continue;p.push(F);ia=Im.createElementNS("http://www.w3.org/1999/xhtml","span");ia.setAttribute("data-adapt-pseudo",F)}else ia=Im.createElementNS("http://www.pyroxy.com/ns/shadow",
...
"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&Hm(g);if("http://www.gribuser.ru/xml/fictionbook/2.0"!=f.namespaceURI||"td"==F){for(var h=f.attributes,k=h.length,m=null,r=0;r<k;r++){var q=h[r],t=q.namespaceURI,w=q.localName,q=q.nodeValue;if(t)if("http://www.w3.org/2000/xmlns/"==t)continue;else"http://www.w3.org/1999/xlink"==t&&"href"==w&&(q=Vm(a,q));else{if(w.match(/^on/))continue;if("style"==w)continue;if(("id"==w||"name"==w)&&b){q=a.g.Gc(q,a.X.url);g.setAttribute(w,q);$h(a.page,
g,q);continue}"src"==w||"href"==w||"poster"==w?q=a.g.b(Vm(a,q),a.X.url):"srcset"==w&&(q=q.split(",").map(function(b){return Vm(a,b.trim())}).join(","))}if(t){var ia=Gm[t];ia&&(w=ia+":"+w)}"src"!=w||t||"img"!=F||"http://www.w3.org/1999/xhtml"!=ha?"href"==w&&"image"==F&&"http://www.w3.org/2000/svg"==ha&&"http://www.w3.org/1999/xlink"==t?a.page.g.push(ug(g,q)):t?g.setAttributeNS(t,w,q):g.setAttribute(w,q):m=q}p&&b&&$h(a.page,g,a.g.Gc("",a.X.url));m&&(h=ug(g,m),k=l.width,m=l.height,k&&k!==ud&&m&&m!==
...
l.bottom&&1>Math.abs(g.right-l.right)){b.push({top:g.top,left:l.left,bottom:l.bottom,right:l.right});break}}h==d.length&&(v.b("Could not fix character box"),b.push(g))}a=b}for(b=d=0;b<a.length;b++)f=a[b],g=c?f.bottom-f.top:f.right-f.left,f.right>f.left&&f.bottom>f.top&&(isNaN(e)||g>d)&&(e=c?f.left:f.bottom,d=g);return e}function pn(a,b){this.e=a;this.f=b}pn.prototype.d=function(a,b){return b<this.f?null:qn(a,this,0<b)};pn.prototype.b=function(){return this.f};
...
function tn(a){for(var b=1;b<a.length;b++){var c=a[b-1],d=a[b];c===d?v.b("validateCheckPoints: duplicate entry"):c.ia>=d.ia?v.b("validateCheckPoints: incorrect boxOffset"):c.Z==d.Z&&(d.J?c.J&&v.b("validateCheckPoints: duplicate after points"):c.J?v.b("validateCheckPoints: inconsistent after point"):d.ia-c.ia!=d.da-c.da&&v.b("validateCheckPoints: boxOffset inconsistent with offsetInNode"))}}
function un(a,b,c,d){Ai.call(this,a);this.nd=a.lastChild;this.g=b;this.fb=c;this.xb=d;this.Ud=a.ownerDocument;this.Kc=!1;this.ma=this.Oa=this.ta=this.ka=this.O=0;this.gb=this.vb=this.l=this.Ya=null;this.qd=!1;this.h=this.f=this.A=null;this.Gd=!0;this.Lc=this.Jc=this.Mc=0}u(un,Ai);un.prototype.clone=function(){var a=new un(this.d,this.g,this.fb,this.xb);Fi(a,this);a.nd=this.nd;a.Kc=this.Kc;a.l=this.l?this.l.clone():null;a.vb=this.vb.concat();return a};function vn(a,b){return a.b?b<a.ma:b>a.ma}
...
function zn(a,b){if(b.e&&b.d&&!b.J&&0==b.e.count&&1!=b.B.nodeType){var c=b.B.textContent.match(yn);return fn(a.g,b,c[0].length)}return M(b)}function An(a,b,c){var d=L("buildViewToNextBlockEdge");of(function(d){b.B&&c.push(oi(b));zn(a,b).then(function(f){f!==b&&(b=f,c.push(oi(b)));cn(a.g,b).then(function(c){(b=c)?Bn(a.xb,b)?b.j&&!a.b?Cn(a,b).then(function(c){b=c;!b||b.b||0<a.g.e.b.length?R(d):qf(d)}):b.d?qf(d):R(d):(b=b.modify(),b.b=!0,R(d)):R(d)})})}).then(function(){O(d,b)});return N(d)}
function Dn(a,b){if(!b.B)return M(b);var c=b.Z,d=L("buildDeepElementView");of(function(d){zn(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.Z!=c;)g=g.parent;if(null==g){b=f;R(d);return}}cn(a.g,f).then(function(f){(b=f)&&b.Z!=c?Bn(a.xb,b)?qf(d):(b=b.modify(),b.b=!0,R(d)):R(d)})})}).then(function(){O(d,b)});return N(d)}
...
null)});else{e=Ni(e,a.b,g);for(var r=a.O,t=a.ka,p=b.parent;p&&p.d;)p=p.parent;if(p){var q=p.B.ownerDocument.createElement("div");q.style.left="0px";q.style.top="0px";a.b?(q.style.bottom="0px",q.style.width="1px"):(q.style.right="0px",q.style.height="1px");p.B.appendChild(q);var w=q.getBoundingClientRect(),r=Math.max(a.b?w.top:w.left,r),t=Math.min(a.b?w.bottom:w.right,t);p.B.removeChild(q);q=a.b?m.R-m.W:m.V-m.aa;"left"==e?t=Math.max(t,r+q):r=Math.min(r,t-q);p.B.appendChild(b.B)}q=new pe(r,(a.b?-1:
1)*a.ta,t,(a.b?-1:1)*a.Oa);r=m;a.b&&(r=He(m));t=a.b?-1:1;r.W<a.Lc*t&&(w=r.R-r.W,r.W=a.Lc*t,r.R=r.W+w);Me(q,a.gb,r,e);a.b&&(m=new pe(-r.R,r.aa,-r.W,r.V));q=Jn(a,d);x(d,"width",m.V-m.aa-q.left-q.right+"px");x(d,"height",m.R-m.W-q.top-q.bottom+"px");x(d,"position","absolute");x(d,"display",b.display);t=null;p&&(p.H?t=p:t=si(p));t?(q=t.B.ownerDocument.createElement("div"),q.style.position="absolute",t.f?q.style.right="0":q.style.left="0",q.style.top="0",t.B.appendChild(q),p=q.getBoundingClientRect(),
t.B.removeChild(q)):p={left:a.b?a.Oa:a.O,right:a.b?a.ta:a.ka,top:a.b?a.O:a.ta};(t?t.f:a.b)?x(d,"right",p.right-m.V+a.w+"px"):x(d,"left",m.aa-p.left+a.j+"px");x(d,"top",m.W-p.top+a.k+"px");b.u&&(b.u.parentNode.removeChild(b.u),b.u=null);p=a.b?m.aa:m.R;m=a.b?m.V:m.W;vn(a,p)&&0!=a.A.length?(b=b.modify(),b.b=!0,O(c,b)):(Fn(a),q=new pe(a.b?a.Oa:a.O,a.b?a.O:a.ta,a.b?a.ta:a.ka,a.b?a.ka:a.Oa),a.b&&(q=He(q)),Ne(q,a.gb,r,e),Gn(a),"left"==e?a.Mc=p:a.Jc=p,a.Lc=m,Tn(a,p),O(c,k))}});return N(c)}
...
function bo(a,b,c){var d=L("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,h=a.A.length-1;0<=h&&!e;--h){var e=a.A[h].d(a,f),l=a.A[h].b();l>f&&(g=Math.min(g,l))}while(g>f&&!e);var k=!1;if(!e){v.b("Could not find any page breaks?!!");if(a.Gd)return co(a,b).then(function(b){b?(b=b.modify(),b.b=!1,Yn(a,b,k,!0).then(function(){O(d,b)})):O(d,b)}),N(d);e=c;k=!0}Yn(a,e,k,!0).then(function(){O(d,e)});return N(d)}
...
function qo(a,b){var c=a.e[b],d=a.f[b];d||(d=a.f[b]=[]);for(var e=!1,f=0;f<a.d.length;){var g=a.d[f];g.Cb===b?(g.bc=!0,a.d.splice(f,1),c&&(e=c.indexOf(g),0<=e&&c.splice(e,1)),d.push(g),e=!0):f++}e||ro(a,b,!0)}function ro(a,b,c){a.j.some(function(a){return a.Cb===b})||a.j.push(new mo(b,c))}
function vo(a,b,c){var d=Object.keys(a.g.b);if(0<d.length){var e=lo(a.b);d.forEach(function(a){this.k[a]=e;var d=this.l[a];if(d&&d.G<c&&(d=this.f[a])){var f=this.e[a];f||(f=this.e[a]=[]);for(var g;g=d.shift();)g.bc=!1,f.push(g)}this.l[a]={F:b,G:c}},a)}for(var d=a.w,f;f=a.j.shift();){f.cd=d;f.F=b;f.G=c;var g;f.bc?(g=a.f[f.Cb])||(g=a.f[f.Cb]=[]):(g=a.e[f.Cb])||(g=a.e[f.Cb]=[]);g.every(function(a){return!(f===a||a&&f.Cb===a.Cb&&f.bc===a.bc&&f.F===a.F&&f.G===a.G)})&&g.push(f)}a.g=null}
...
Co.prototype.h=function(){var a=this.f,b="";Object.keys(a).forEach(function(c){for(var d=a[c],e=d.length,f=0;f<e;f++){var g=d[f];b+=c;1<e&&(b+="("+f+")");b+=" => start: "+g.start+", end: "+g.end+", duration: "+(g.end-g.start)+"\n"}});v.e(b)};Co.prototype.j=function(){this.registerEndTiming=this.d=this.registerStartTiming=this.b=this.e=Bo};Co.prototype.k=function(){this.e=Ao;this.registerStartTiming=this.b=zo;this.registerEndTiming=this.d=yo};
...
Q?g():d(sa);break;case "fit-content width":c=Q?d(sa):h();break;case "fit-content height":c=Q?h():d(sa)}Fa[a]=parseFloat(c);x(b,"position",m);x(b,"display",k)});x(b,"width",p);x(b,"height",r);t.insertBefore(b,q);t.removeChild(q);return Fa};function Ho(a){var b=a["writing-mode"],b=b&&b.value;a=(a=a.direction)&&a.value;return b===fe||b!==ge&&a!==$d?"ltr":"rtl"}
...
function No(a){var b={width:ke,height:le,Fb:me,yb:me},c=a.size;if(c&&c.value!==ud){var d=c.value;d.Zc()?(c=d.values[0],d=d.values[1]):(c=d,d=null);if(c.Xb())b.width=c,b.height=d||c;else if(c=Io[c.name.toLowerCase()])d&&d===Nd?(b.width=c.height,b.height=c.width):(b.width=c.width,b.height=c.height)}(c=a.marks)&&c.value!==Rd&&(b.yb=Mo);a=a.bleed;a&&a.value!==ud?a.value&&a.value.Xb()&&(b.Fb=a.value):c&&(a=!1,c.value.Zc()?a=c.value.values.some(function(a){return a===Ad}):a=c.value===Ad,a&&(b.Fb=new J(6,
"pt")));return b}function Oo(a,b){var c={},d=a.Fb.C*pc(b,a.Fb.ha,!1),e=a.yb.C*pc(b,a.yb.ha,!1),f=d+e,g=a.width;c.ob=g===ke?(b.T.Xa?Math.floor(b.za/2)-b.T.Kb:b.za)-2*f:g.C*pc(b,g.ha,!1);g=a.height;c.nb=g===le?b.gb-2*f:g.C*pc(b,g.ha,!1);c.Fb=d;c.yb=e;c.Rc=f;return c}function Po(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
...
To[a];a===b?h.style[a]=e+"px":a!==k&&(h.style[a]="0",h.style["margin-"+a]="auto")});return h}function Vo(a,b,c,d){var e=!1,f=!1;if(a=a.marks)a=a.value,a.Zc()?a.values.forEach(function(a){a===Ad?e=!0:a===Bd&&(f=!0)}):a===Ad?e=!0:a===Bd&&(f=!0);if(e||f){var g=c.N,h=g.ownerDocument,l=b.Fb,k=qd(Jo,d),m=qd(Ko,d),p=qd(Lo,d);e&&Object.keys(Ro).forEach(function(a){a=So(h,Ro[a],k,p,l,m);g.appendChild(a)});f&&Object.keys(To).forEach(function(a){a=Uo(h,To[a],k,p,m);g.appendChild(a)})}}
...
function $o(a,b,c,d){Ul.call(this,a,null,null,[],b);this.u=d;this.b["z-index"]=new V(new md(0),0);this.b["flow-from"]=new V(I("body"),0);this.b.position=new V(rd,0);this.b.overflow=new V(he,0);for(var e in Wo)Wo.hasOwnProperty(e)&&(this.b[e]=c[e])}u($o,Ul);$o.prototype.f=function(a){return new dp(a,this)};
function bp(a,b,c,d){Ul.call(this,a,null,null,[],b);this.k=c;a=d._marginBoxes[this.k];for(var e in d)if(b=d[e],c=a[e],Yi[e]||c&&c.value===Id)this.b[e]=b;for(e in a)Object.prototype.hasOwnProperty.call(a,e)&&(b=a[e])&&b.value!==Id&&(this.b[e]=b)}u(bp,Ul);bp.prototype.f=function(a){return new ep(a,this)};function cp(a,b){Rl.call(this,a,b);this.j=null;this.ma={}}u(cp,Rl);
...
ip.prototype.f=function(){var a=this.g.map(function(a){return a.f()});return Math.max.apply(null,a)*a.length};ip.prototype.d=function(){var a=this.g.map(function(a){return a.d()});return Math.max.apply(null,a)*a.length};function jp(a,b,c,d,e,f){gp.call(this,a,b,c,d,e);this.j=f}u(jp,gp);jp.prototype.b=function(){return!1};jp.prototype.e=function(){return this.d()};jp.prototype.f=function(){return this.d()};jp.prototype.d=function(){return this.g?Di(this.N)+this.j+Ei(this.N):Bi(this.N)+this.j+Ci(this.N)};
function fp(a,b,c,d,e,f){var g=a.d.d,h={},l={},k={},m;for(m in b){var p=Xo[m];if(p){var r=b[m],t=a.ma[m],q=new gp(r,t.style,c,g,f);h[p.la]=r;l[p.la]=t;k[p.la]=q}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.ca.evaluate(e);var w=kp(k,b),Q=!1,P={};Object.keys(h).forEach(function(a){var b=X(g,l[a].style[c?"max-width":"max-height"],d.ca);b&&(b=b.evaluate(e),w[a]>b&&(b=k[a]=new jp(h[a],l[a].style,c,g,f,b),P[a]=b.d(),Q=!0))});Q&&(w=kp(k,b),Q=!1,["start","center","end"].forEach(function(a){w[a]=P[a]||w[a]}));
...
function mp(a,b){var c=a.style,d=a.d.d,e=b.start,f=b.end,g=b.ca,h=a.d.u[g].ja(d,null),l=X(d,c[g],h),k=X(d,c["margin-"+e],h),m=X(d,c["margin-"+f],h),p=Wl(d,c["padding-"+e],h),r=Wl(d,c["padding-"+f],h),t=Yl(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),q=Yl(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),w=G(d,h,E(d,E(d,t,p),E(d,q,r)));l?(w=G(d,w,l),k||m?k?m=G(d,w,k):k=G(d,w,m):m=k=Yc(d,w,new B(d,.5))):(k||(k=d.b),m||(m=d.b),l=G(d,w,E(d,k,m)));c[e]=new K(k);c[f]=new K(m);c["margin-"+e]=
me;c["margin-"+f]=me;c["padding-"+e]=new K(p);c["padding-"+f]=new K(r);c["border-"+e+"-width"]=new K(t);c["border-"+f+"-width"]=new K(q);c[g]=new K(l);c["max-"+g]=new K(l);return{Fd:G(d,h,E(d,k,m)),Nd:k,Md:m}}dp.prototype.qb=function(a,b,c,d,e){Vl.prototype.qb.call(this,a,b,c,d,e);c.w=b.d};function ep(a,b){Vl.call(this,a,b);var c=b.k;this.j=Xo[c];a.ma[c]=this;this.oa=!0}u(ep,Vl);n=ep.prototype;
n.qb=function(a,b,c,d,e){var f=b.d;x(f,"display","flex");var g=hm(this,a,"vertical-align"),h=null;g===I("middle")?h="center":g===I("top")?h="flex-start":g===I("bottom")&&(h="flex-end");h&&(x(f,"flex-flow",this.b?"row":"column"),x(f,"justify-content",h));Vl.prototype.qb.call(this,a,b,c,d,e)};
n.la=function(a,b){var c=this.style,d=this.d.d,e=a.start,f=a.end,g="left"===e,h=g?b.Hb:b.Gb,l=X(d,c[a.ca],h),g=g?b.marginLeft:b.marginTop;if("start"===this.j.la)c[e]=new K(g);else if(l){var k=Wl(d,c["margin-"+e],h),m=Wl(d,c["margin-"+f],h),p=Wl(d,c["padding-"+e],h),r=Wl(d,c["padding-"+f],h),t=Yl(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),f=Yl(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),l=E(d,l,E(d,E(d,p,r),E(d,E(d,t,f),E(d,k,m))));switch(this.j.la){case "center":c[e]=new K(E(d,
g,Zc(d,G(d,h,l),new B(d,2))));break;case "end":c[e]=new K(G(d,E(d,g,h),l))}}};
function np(a,b,c){function d(a){if(w)return w;w={ca:q?q.evaluate(a):null,La:l?l.evaluate(a):null,Ma:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[r,m,p,t].forEach(function(b){b&&(c+=b.evaluate(a))});(null===w.La||null===w.Ma)&&c+w.ca+w.La+w.Ma>b&&(null===w.La&&(w.La=0),null===w.Ma&&(w.Fe=0));null!==w.ca&&null!==w.La&&null!==w.Ma&&(w.Ma=null);null===w.ca&&null!==w.La&&null!==w.Ma?w.ca=b-c-w.La-w.Ma:null!==w.ca&&null===w.La&&null!==w.Ma?w.La=b-c-w.ca-w.Ma:null!==w.ca&&null!==w.La&&null===w.Ma?w.Ma=
b-c-w.ca-w.La:null===w.ca?(w.La=w.Ma=0,w.ca=b-c):w.La=w.Ma=(b-c-w.ca)/2;return w}var e=a.style;a=a.d.d;var f=b.Yc,g=b.bd;b=b.ca;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],l=Xl(a,e["margin-"+f],h),k=Xl(a,e["margin-"+g],h),m=Wl(a,e["padding-"+f],h),p=Wl(a,e["padding-"+g],h),r=Yl(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),t=Yl(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),q=X(a,e[b],h),w=null;e[b]=new K(new ic(a,function(){var a=d(this).ca;return null===a?0:a},b));e["margin-"+
...
function qp(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof V?e.value+"":qp(a,e);c.push(d+f+(e.Ga||""))}return c.sort().join("^")}function rp(a){this.b=null;this.f=a}u(rp,W);rp.prototype.apply=function(a){a.S===this.f&&this.b.apply(a)};rp.prototype.d=function(){return 3};rp.prototype.e=function(a){this.b&&yj(a.Yb,this.f,this.b);return!0};function sp(a){this.b=null;this.f=a}u(sp,W);
sp.prototype.apply=function(a){1===(new Rc(this.f,"page-number")).evaluate(a.g)&&this.b.apply(a)};sp.prototype.d=function(){return 2};function tp(a){this.b=null;this.f=a}u(tp,W);tp.prototype.apply=function(a){(new Rc(this.f,"left-page")).evaluate(a.g)&&this.b.apply(a)};tp.prototype.d=function(){return 1};function up(a){this.b=null;this.f=a}u(up,W);up.prototype.apply=function(a){(new Rc(this.f,"right-page")).evaluate(a.g)&&this.b.apply(a)};up.prototype.d=function(){return 1};
function vp(a){this.b=null;this.f=a}u(vp,W);vp.prototype.apply=function(a){(new Rc(this.f,"recto-page")).evaluate(a.g)&&this.b.apply(a)};vp.prototype.d=function(){return 1};function wp(a){this.b=null;this.f=a}u(wp,W);wp.prototype.apply=function(a){(new Rc(this.f,"verso-page")).evaluate(a.g)&&this.b.apply(a)};wp.prototype.d=function(){return 1};function xp(a,b){wj.call(this,a,b,null,null)}u(xp,wj);
xp.prototype.apply=function(a){var b=a.g,c=a.u,d=this.style;a=this.P;pj(b,c,d,a,null,null);if(d=d._marginBoxes){var c=nj(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);pj(b,f,d[e],a,null,null)}}};function yp(a,b,c,d,e){Pk.call(this,a,b,null,c,null,d,!1);this.I=e;this.A=[];this.e="";this.u=[]}u(yp,Pk);n=yp.prototype;n.Mb=function(){this.cb()};n.hb=function(a,b){if(this.e=b)this.b.push(new rp(b)),this.P+=65536};
...
function Kp(a,b){var c=a.b,d=Jp(a,c);if(d==Number.POSITIVE_INFINITY)return null;for(var e=a.u.children,f,g=0;g<e.length;g++)if(f=e[g],"vivliostyle-page-rule-master"!==f.d.rb){var h=1,l=hm(f,a,"utilization");l&&l.xd()&&(h=l.C);var l=pc(a,"em",!1),k=a.ob()*a.nb();a.l=El(a.d,d,Math.ceil(h*k/(l*l)));h=a;l=c;k=void 0;for(k in l.b){var m=l.b[k];if(m&&0<m.b.length){var p=m.b[0].b;if(Ip(h,m)===p.d){a:switch(p=m.d,p){case "left":case "right":case "recto":case "verso":break a;default:p=null}m.d=mn(ll(p,m.b[0].b.e))}}}a.k=
c.clone();h=a;l=h.b.page;k=void 0;for(k in h.b.b)for(m=h.b.b[k],p=m.b.length-1;0<=p;p--){var r=m.b[p];0>r.b.g&&r.b.d<h.l&&(r.b.g=l)}oc(a,a.style.b);h=hm(f,a,"enabled");if(!h||h===ie){c=a;v.debug("Location - page",c.b.page);v.debug("  current:",d);v.debug("  lookup:",c.l);d=void 0;for(d in c.b.b)for(e=c.b.b[d],g=0;g<e.b.length;g++)v.debug("  Chunk",d+":",e.b[g].b.d);d=a.O;e=b;g=f.d;if(0===Object.keys(e).length)g.d.e=g;else{f=g;c=qp(d,e);f=f.g+"^"+c;c=d.g[f];if(!c){if("background-host"===g.rb)c=d,e=
(new Zo(c.h,c.f.d,e)).f(c.f),e.h(c.b,c.e),vm(e,c.d),c=e;else{c=d;h=e;e=g.clone({rb:"vivliostyle-page-rule-master"});if(g=h.size)h=No(h),g=g.Ga,e.b.width=jj(c.d,e.b.width,new V(h.width,g)),e.b.height=jj(c.d,e.b.height,new V(h.height,g));e=e.f(c.f);e.h(c.b,c.e);vm(e,c.d);c=e}d.g[f]=c}f=c.d;f.d.e=f;f=c}return f}}throw Error("No enabled page masters");}
...
function Mp(a,b,c,d,e,f,g,h){am(c);var l=hm(c,a,"enabled");if(l&&l!==ie)return M(!0);var k=L("layoutContainer"),m=hm(c,a,"wrap-flow")===ud,p=c.b?c.g&&c.H:c.f&&c.I,l=hm(c,a,"flow-from"),r=a.viewport.b.createElement("div"),t=hm(c,a,"position");x(r,"position",t?t.name:"absolute");d.insertBefore(r,d.firstChild);var q=new Ai(r);q.b=c.b;c.qb(a,q,b,a.h,a.e);q.D=e;q.H=f;e+=q.left+q.marginLeft+q.S;f+=q.top+q.marginTop+q.ba;if(l&&l.Kd())if(a.I[l.toString()])c.sc(a,q,b,null,1,a.e,a.h),l=M(!0);else{var w=L("layoutContainer.inner"),
Q=l.toString(),P=Y(c,a,"column-count"),sa=Y(c,a,"column-gap"),Fa=1<P?Y(c,a,"column-width"):q.width,l=gm(c,a),ha=0,t=hm(c,a,"shape-inside"),F=pg(t,0,0,q.width,q.height,a),ia=new Mm(Q,a,a.viewport,a.d,l,a.X,a.h,a.style.u,a,b,a.Sa,a.Za,h,a.Ya),ul=new ko(a.f,a.b.page-1),Xh=0,ba=null;of(function(b){for(;Xh<P;){var c=Xh++;if(1<P){var d=a.viewport.b.createElement("div");x(d,"position","absolute");r.appendChild(d);ba=new un(d,ia,a.e,ul);ba.b=q.b;ba.Za=q.Za;ba.kc=q.kc;q.b?(x(d,"margin-left",q.j+"px"),x(d,
"margin-right",q.w+"px"),c=c*(Fa+sa)+q.k,Hi(ba,0,q.width),Gi(ba,c,Fa)):(x(d,"margin-top",q.k+"px"),x(d,"margin-bottom",q.u+"px"),c=c*(Fa+sa)+q.j,Gi(ba,0,q.height),Hi(ba,c,Fa));ba.D=e+q.j;ba.H=f+q.k}else ba=new un(r,ia,a.e,ul),Fi(ba,q),q=ba;ba.I=p?[]:g;ba.wb=F;if(0<=ba.width){var k=L("inner");Lp(a,ba,Q).then(function(){ba.h&&"column"!=ba.h&&(Xh=P,"region"!=ba.h&&(a.I[Q]=!0));O(k,!0)});c=N(k)}else c=M(!0);if(c.Ca()){c.then(function(){0<h.b.length?R(b):(ha=Math.max(ha,ba.e),qf(b))});return}0<h.b.length||
(ha=Math.max(ha,ba.e))}R(b)}).then(function(){q.e=ha;c.sc(a,q,b,ba,P,a.e,a.h);O(w,!0)});l=N(w)}else{l=hm(c,a,"content");t=!1;if(l&&Ji(l)){var wl=a.viewport.b.createElement("span");l.U(new Ii(wl,a));r.appendChild(wl);um(c,a,q,a.h)}else c.oa&&(d.removeChild(r),t=!0);t||c.sc(a,q,b,null,1,a.e,a.h);l=M(!0)}l.then(function(){if(!c.f||0<Math.floor(q.e)){if(!m){var l=q.D+q.left,p=q.H+q.top,t=Di(q)+q.width+Ei(q),w=Bi(q)+q.height+Ci(q),F=hm(c,a,"shape-outside"),l=pg(F,l,p,t,w,a);ab(a.viewport.root)&&g.push(xe(l,
...
function Np(a,b,c){a.I={};c?(a.b=c.clone(),zl(a.d,c.d)):(a.b=new yi,zl(a.d,-1));a.lang&&b.d.setAttribute("lang",a.lang);c=a.b;c.page++;oc(a,a.style.b);a.k=c.clone();var d=pp(a.O),e=Kp(a,d);if(!e)return M(null);e.d.b.width.value===ke&&Yh(b);e.d.b.height.value===le&&Zh(b);a.f.g=b;to(a.f,d,a);var f=Oo(No(d),a);Op(a,f,b);Vo(d,f,b,a);var d=hm(e,a,"writing-mode")||Hd,f=hm(e,a,"direction")||Qd,g=new Pi(b.A.bind(b),d,f),h=[],l=L("layoutNextPage");of(function(d){Mp(a,b,e,b.d,0,0,h.concat(),g).then(function(){if(0<
g.b.length){h=h.concat(Ui(g));g.b.splice(0,g.b.length);c=a.b=a.k.clone();for(var e;e=b.d.lastChild;)b.d.removeChild(e);qf(d)}else R(d)})}).then(function(){e.S(a,b,a.e);var d=new Rc(e.d.d,"left-page");b.j=d.evaluate(a)?"left":"right";var d=a.b.page,f;for(f in a.b.b)for(var g=a.b.b[f],h=g.b.length-1;0<=h;h--){var t=g.b[h];0<=t.b.g&&t.b.g+t.b.k-1<=d&&g.b.splice(h,1)}a.b=a.k=null;c.d=a.d.b;ai(b,a.style.h.D[a.X.url]);var q;a:{for(q in a.g)if((f=c.b[q])&&0<f.b.length){q=!1;break a}q=!0}q&&(c=null);O(l,
c)});return N(l)}function Op(a,b,c){a.H=b.ob;a.D=b.nb;c.N.style.width=b.ob+2*b.Rc+"px";c.N.style.height=b.nb+2*b.Rc+"px";c.d.style.left=b.yb+"px";c.d.style.right=b.yb+"px";c.d.style.top=b.yb+"px";c.d.style.bottom=b.yb+"px";c.d.style.padding=b.Fb+"px"}function Pp(a,b,c,d){Pk.call(this,a.g,a,b,c,d,a.f,!c);this.e=a;this.u=!1}u(Pp,Pk);n=Pp.prototype;n.Cc=function(){};n.Bc=function(a,b,c){a=new Ql(this.e.j,a,b,c,this.e.w,this.M,Cf(this.$));Ef(this.e,new Bm(a.d,this.e,a,this.k))};
n.Bb=function(a){a=a.d;null!=this.M&&(a=Xc(this.d,this.M,a));Ef(this.e,new Pp(this.e,a,this,this.w))};n.yc=function(){Ef(this.e,new Vk(this.d,this.$))};n.Ac=function(){var a={};this.e.k.push({Ab:a,M:this.M});Ef(this.e,new Wk(this.d,this.$,null,a,this.e.f))};n.zc=function(a){var b=this.e.h[a];b||(b={},this.e.h[a]=b);Ef(this.e,new Wk(this.d,this.$,null,b,this.e.f))};n.Ec=function(){var a={};this.e.A.push(a);Ef(this.e,new Wk(this.d,this.$,this.M,a,this.e.f))};
n.cc=function(a){var b=this.e.l;if(a){var c=nj(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Ef(this.e,new Wk(this.d,this.$,null,b,this.e.f))};n.Dc=function(){this.u=!0;this.cb()};n.Mb=function(){var a=new yp(this.e.j,this.e,this,this.k,this.e.u);Ef(this.e,a);a.Mb()};n.ra=function(){Pk.prototype.ra.call(this);if(this.u){this.u=!1;var a="R"+this.e.H++,b=I(a),c;this.M?c=new ij(b,0,this.M):c=new V(b,0);oj(this.h,"region-id").push(c);this.lb();a=new Pp(this.e,this.M,this,a);Ef(this.e,a);a.ra()}};
...
u(Rp,Df);Rp.prototype.error=function(a){v.b("CSS parser:",a)};function Sp(a,b){return Tp(b,a)}function Up(a){uf.call(this,Sp,"document");this.H=a;this.A={};this.h={};this.b={};this.D={};this.f=null;this.j=[]}u(Up,uf);function Vp(a){var b=wa("user-agent.xml",va),c=L("OPSDocStore.init");vf(gh).then(function(d){a.f=d;vf(Bp).then(function(){a.load(b).then(function(){O(c,!0)})})});return N(c)}function Wp(a,b){a.j.push({url:b.url,text:b.text,$a:"User",Ba:null,media:null})}
...
for(var t="",h=0;h<r.length;h++)t+=r[h].url,t+="^",r[h].text&&(t+=r[h].text),t+="^";var q=a.A[t];q?(a.b[d]=q,O(c,b)):(f=a.h[t],f||(f=new xf(function(){var b=L("fetchStylesheet"),c=0,d=new Rp(a.f);nf(function(){if(c<r.length){var a=r[c++];d.Nb(a.$a);return null!==a.text?hg(a.text,d,a.url,a.Ba,a.media).kd(!0):gg(a.url,d,a.Ba,a.media)}return M(!1)}).then(function(){q=new Cp(a,d.g,d.j,d.D.g,d.w,d.k,d.l,d.h,d.A,d.u);a.A[t]=q;delete a.h[t];O(b,q)});return N(b)},"FetchStylesheet "+d),a.h[t]=f,f.start()),
...
function vq(a,b){return Xe("resolveFragment",function(c){if(b){var d=new kb;lb(d,b);var e;if(a.e){var f=mb(d,a.e.b);if(1!=f.fa.nodeType||f.J||!f.ac){O(c,null);return}var g=f.fa,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.d[h]){O(c,null);return}e=a.d[h];d=f.ac}else e=a.b[0];a.f.load(e.src).then(function(a){var b=mb(d,a.b);a=yh(a,b.fa,b.offset,b.J);O(c,{F:e.F,na:a,G:-1})})}else O(c,null)},function(a,d){v.b(d,"Cannot resolve fragment:",b);O(a,null)})}
function wq(a,b){return Xe("resolveEPage",function(c){if(0>=b)O(c,{F:0,na:0,G:-1});else{var d=Ra(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.f.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=zh(a),g=Math.round(a*b/e.b),g==a&&g--);O(c,{F:d,na:g,G:-1})})}},function(a,d){v.b(d,"Cannot resolve epage:",b);O(a,null)})}
function xq(a,b){var c=a.b[b.F];if(0>=b.na)return M(c.e);var d=L("getEPage");a.f.load(c.src).then(function(a){a=zh(a);var f=Math.min(a,b.na);O(d,c.e+f*c.b/a)});return N(d)}function yq(a,b,c,d,e){this.b=a;this.viewport=b;this.g=c;this.h=e;this.Lb=[];this.na=this.G=this.F=0;this.T=Yb(d);this.f=new hn(b.f);this.d=new so(a.j)}function zq(a){var b=a.Lb[a.F];return b?b.pb[a.G]:null}n=yq.prototype;n.mb=function(){if(this.b.D)return this.b.D;var a=this.Lb[this.F];return a?a.Ja.ba:null};
function Aq(a,b,c,d){c.N.style.display="none";c.N.style.visibility="visible";c.N.style.position="";c.N.style.top="";c.N.style.left="";c.N.setAttribute("data-vivliostyle-page-side",c.j);var e=b.pb[d];e?(b.Ja.viewport.d.replaceChild(c.N,e.N),Za(e,{type:"replaced",target:null,currentTarget:null,be:c})):b.Ja.viewport.d.appendChild(c.N);a.h(b.Ja.oa,b.item.F,d);c.l=0==b.item.F&&0==d;b.pb[d]=c}
function Bq(a,b,c){var d=L("renderSinglePage"),e=Cq(a,b,c);Np(b.Ja,e,c).then(function(f){var g=(c=f)?c.page-1:b.Ka.length-1;Aq(a,b,e,g);vo(a.d,a.F,g);var h=a.F,l=a.G,k=a.na;f=null;if(c){var m=b.Ka[c.page];b.Ka[c.page]=c;m&&b.pb[c.page]&&!zi(c,m)&&(a.G=c.page,f=Bq(a,b,c))}f||(f=M(!0));f.then(function(){var b=wo(a.d,e),f=0;of(function(c){f++;if(f>b.length)R(c);else{var d=b[f-1];d.vc=d.vc.filter(function(a){return!a.bc});0===d.vc.length?qf(c):(a.F=d.F,a.G=d.G,Dq(a).then(function(b){b?(uo(a.d,d.cd),xo(a.d,
...
n.nextPage=function(){var a=this,b=L("nextPage");Dq(a).then(function(c){if(c){if(c.complete&&a.G==c.Ka.length-1){if(a.F>=a.b.b.length-1){O(b,null);return}a.F++;a.G=0}else a.G++;Eq(a).ua(b)}else O(b,null)});return N(b)};n.fd=function(){if(0==this.G){if(0==this.F)return M(null);this.F--;this.G=Number.POSITIVE_INFINITY}else this.G--;return Eq(this)};function Gq(a,b){var c="left"===b.j,d="ltr"===a.mb();return!c&&d||c&&!d}
...
function Dq(a){if(a.F>=a.b.b.length)return M(null);var b=a.Lb[a.F];if(b)return M(b);var c=a.b.b[a.F],d=a.b.f,e=L("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(zh(f)/2700),a.b.w=c.b);var g=d.b[f.url],h=a.$c(f),l=a.viewport,k=Fp(g,l.width,l.height,l.fontSize);if(k.width!=l.width||k.height!=l.height||k.fontSize!=l.fontSize)l=new kn(l.f,k.fontSize,l.root,k.width,k.height);var k=a.Lb[a.F-1],m=new Gp(g,f,a.b.lang,l,a.f,a.g,h,a.b.A,k?k.Ja.ma+k.pb.length:0,a.b.j,
a.d);m.T=a.T;Hp(m).then(function(){b={item:c,X:f,Ja:m,Ka:[null],pb:[],complete:!1};a.Lb[a.F]=b;O(e,b)})});return N(e)}function Mq(a){return{F:a.F,G:a.G,na:a.na}}function Nq(a,b){b?(a.F=b.F,a.G=-1,a.na=b.na):(a.F=0,a.G=0,a.na=0);return Fq(a,a.F,a.G)}
...
function $q(a){if(a.l||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=Zq(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.Lb;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.pb,d=0;d<c.length;d++){var e=c[d];if(e.I&&e.H){a=!0;break a}}}a=!1}b=!a}return b}n.ie=function(a,b,c){if(!this.I&&this.w&&0===b&&0===c){var d="";Object.keys(a).forEach(function(b){d+="@page "+b+"{size:";b=a[b];d+=b.width+"px "+b.height+"px;}"});this.w.textContent=d;this.I=!0}};
function ar(a){if(a.b){a.b.tc();for(var b=a.b.Lb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.pb,e;e=d.shift();)e=e.N,e.parentNode.removeChild(e)}}a.w&&(a.w.textContent="",a.I=!1);a.viewport=Zq(a);b=a.viewport;x(b.e,"width","");x(b.e,"height","");x(b.d,"width","");x(b.d,"height","");x(b.d,"transform","");a.b=new yq(a.g,a.viewport,a.ka,a.T,a.ie.bind(a))}
...
function Yq(a,b,c){var d=L("sendLocationNotification"),e={t:"nav",first:b.l,last:b.k};xq(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.w;c&&(e.cfi=c);Qq(a,e);O(d,!0)});return N(d)}Oq.prototype.mb=function(){return this.b?this.b.mb():null};
...
function dr(a,b){var c=b.a||"";return Xe("runCommand",function(d){var e=a.ba[c];e?e.call(a,b).then(function(){Qq(a,{t:"done",a:c});O(d,!0)}):(v.error("No such action:",c),O(d,!0))},function(a,b){v.error(b,"Error during action:",c);O(a,!0)})}function er(a){return"string"==typeof a?JSON.parse(a):a}
...
function ir(a,b,c,d,e){d=d||{};var f,g=d.userStyleSheet;g&&(f=g.map(function(a){return{url:a.url||null,text:a.text||null}}));e&&Object.Ub(a.e,e);b=Object.Ub({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.f.userAgentRootURL,url:b||c,document:d.documentObject,fragment:d.fragment,userStyleSheet:f},gr(a.e));fr(a.b,b)}n.mb=function(){return this.b.mb()};
n.$d=function(a){a:switch(a){case "left":a="ltr"===this.mb()?"previous":"next";break a;case "right":a="ltr"===this.mb()?"next":"previous";break a}this.b.k({a:"moveTo",where:a})};n.Zd=function(a){this.b.k({a:"moveTo",url:a})};n.le=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.T.Xa?br(b,b.j):b.e.e;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ca("vivliostyle.viewer.Viewer",hr);hr.prototype.setOptions=hr.prototype.Od;hr.prototype.addListener=hr.prototype.je;hr.prototype.removeListener=hr.prototype.me;hr.prototype.loadDocument=hr.prototype.Yd;hr.prototype.loadEPUB=hr.prototype.ke;hr.prototype.getCurrentPageProgression=hr.prototype.mb;hr.prototype.navigateToPage=hr.prototype.$d;hr.prototype.navigateToInternalUrl=hr.prototype.Zd;hr.prototype.queryZoomFactor=hr.prototype.le;ca("vivliostyle.viewer.ZoomType",cr);cr.FIT_INSIDE_VIEWPORT="fit inside viewport";
