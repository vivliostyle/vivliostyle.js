 ...
 *
 * Vivliostyle core 2019.1.100-pre.20190129151257
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
a.text?hg(a.text,d,a.url,a.Oa,a.media).Ec(!0):gg(a.url,d,a.Oa,a.media)}return M(!1)}).then(function(){z=new jt(a,d.j,d.u,d.J.l,d.G,d.B,d.D,d.l,d.H,d.F);a.H[r]=z;delete a.u[r];O(b,z)});return b.result()},"FetchStylesheet "+d),a.u[r]=g,g.start()),g.get().then(function(e){a.f[d]=e;O(c,b)}))}else O(c,null)});return c.result()};function Mt(a){return String.fromCharCode(a>>>24&255,a>>>16&255,a>>>8&255,a&255)}
