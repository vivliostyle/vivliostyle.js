 ...
 *
 * Vivliostyle core 2016.2.0-pre.20160128085104
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function wh(a,b){var c=b.getAttribute("id");c&&!a.d[c]&&(a.d[c]=b);(c=b.getAttributeNS("http://www.w3.org/XML/1998/namespace","id"))&&!a.d[c]&&(a.d[c]=b);for(c=b.firstElementChild;c;c=c.nextElementSibling)wh(a,c)}function xh(a,b){var c=b.match(/([^#]*)\#(.+)$/);if(!c||c[1]&&c[1]!=a.url)return null;var c=c[2],d=a.b.getElementById(c);!d&&a.b.getElementsByName&&(d=a.b.getElementsByName(c)[0]);d||(a.d||(a.d={},wh(a,a.b.documentElement)),d=a.d[c]);return d}
