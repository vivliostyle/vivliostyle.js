 ...
 *
 * Vivliostyle core 2019.1.100-pre.20190130084057
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function Bh(a,b,c,d,e){var f="",g=b;b=b.toLowerCase();var h=b.match(/^-([a-z]+)-([-a-z0-9]+)$/);h&&(f=h[1],b=h[2]);if((h=a.A[b])&&h[f])if(f=a.g[b])(a=c===qd||c.df()?c:c.fa(f))?e.Nb(b,a,d):e.gd(g,c);else if(b=a.h[b].clone(),c===qd)for(c=t(b.f),g=c.next();!g.done;g=c.next())e.Nb(g.value,qd,d);else{c.fa(b);if(b.error)d=!1;else{a=t(b.f);for(f=a.next();!f.done;f=a.next())f=f.value,e.Nb(f,b.values[f]||b.b.l[f],d);d=!0}d||e.gd(g,c)}else e.de(g,c)}
...
function pj(a,b,c,d){this.u=a;this.l=b;this.Gc=c;this.zb=d;this.h=[[],[]];this.ca={};this.G=this.F=this.wa=this.b=null;this.Da=this.la=this.Y=this.j=this.f="";this.Z=this.N=null;this.ta=this.ub=!0;this.g={};this.H=[{}];this.J=[new Lc("\u201c"),new Lc("\u201d"),new Lc("\u2018"),new Lc("\u2019")];this.D=0;this.lang="";this.Wb=[0];this.eb=0;this.sa=[{}];this.Gb=this.sa[0];this.R=null;this.Vb=[this.R];this.Ub=[{}];this.Ab=this.sa[0];this.A={};this.kb=[];this.Hb=[]}
...
function Mj(a){Hj.call(this,a.f,a.oa,a.ia,a,a.G,a.A,!1);this.parent=a;this.g=a.b}v(Mj,Hj);n=Mj.prototype;n.sd=function(a){"not"==a&&Hf(this,"E_CSS_UNEXPECTED_NOT")};n.Ja=function(){Hf(this,"E_CSS_UNEXPECTED_RULE_BODY")};n.Pc=function(){Hf(this,"E_CSS_UNEXPECTED_NEXT_SELECTOR")};n.Kd=function(){this.b&&0<this.b.length&&this.g.push(new Ki(this.b));this.parent.ba+=this.ba;var a=this.oa;a.b=a.g.pop()};n.error=function(a,b){Hj.prototype.error.call(this,a,b);var c=this.oa;c.b=c.g.pop()};
...
this.C=b?b.C:null;this.u=null;this.wa={};this.Ra=1;this.Y=this.J=null}function $k(a){a.ya=!0;a.j=a.parent?a.parent.j:0;a.B=null;a.D=null;a.na=0;a.K=!1;a.display=null;a.W=Zk;a.Ba=null;a.l=null;a.N=null;a.ca=null;a.Z="baseline";a.H=!1;a.qc=a.parent?a.parent.qc:0;a.F=a.parent?a.parent.F:null;a.A=a.parent?a.parent.A:!1;a.g=null;a.G=null;a.Ia=null;a.ed=!1;a.R=!1;a.b=a.parent?a.parent.b:!1;a.Ia=null;a.Pa=null;a.C=a.parent?a.parent.C:null;a.u=null;a.wa={};a.Ra=1;a.J=null;a.Y=null}
...
function Mn(a,b,c,d){function e(a,d,e){if("%"===a.ka)a=e*a.L/100;else{e=a.L;var f=a.ka,g;b:switch(f.toLowerCase()){case "em":case "ex":case "rem":g=!0;break b;default:g=!1}if(g){for(;d&&1!==d.nodeType;)d=d.parentNode;d=parseFloat(Nn(c,d)["font-size"]);a=ei(a,d,b.b).L}else a=(d=Pb(b.b,f,!1))?e*d:a}return a}var f=a.I.F,g=a.I.G,h=Al(a.I),l={top:h.T-g,left:h.V-f,bottom:h.P-g,right:h.U-f,Lc:0,Kc:0},k=a.b;0<k.length&&(l=k.reduce(function(b,c){if(d&&!d(c,a))return b;var f=Bn(a,c.Ba),g=c.b,k=c.Jb[0].ja.j,
...
function Vn(a,b){function c(a){return function(b){return tn(a,Wm(b.ja))}}function d(a,b){return a.Jb.some(c(b))}for(var e=Al(b),e=b.b?e.V:e.P,f=a;f;){if(f.f.some(c(f)))return e;f=f.parent}f=Ln(a,"block-start",b.j,b.f,d);return Ln(a,"block-end",b.j,b.f,d)*tl(b)<e*tl(b)?e:f}
...
function Ko(a){for(var b=a.element.firstChild,c=a.b?a.b?a.wa:a.D:a.b?a.sa:a.wa,d=a.b?a.b?a.kb:a.sa:a.b?a.D:a.kb,e=t(a.Gb),f=e.next();!f.done;f=e.next()){var f=f.value,g=f.P-f.T;f.left=Io(a,b,"left",f.V-c,g);f.right=Io(a,b,"right",d-f.U,g)}}
...
Hk(a.f,m),h=Math.max(a.b?p.top:p.left,h),l=Math.min(a.b?p.bottom:p.right,l);k.B.removeChild(m);m=a.b?g.P-g.T:g.U-g.V;"left"==e?l=Math.max(l,h+m):h=Math.min(h,l-m);k.B.appendChild(b.B)}m=new lg(h,tl(a)*a.D,l,tl(a)*a.sa);h=g;a.b&&(h=Cg(g));l=tl(a);h.T<a.we*l&&(p=h.P-h.T,h.T=a.we*l,h.P=h.T+p);a:for(var l=a.Gb,p=h,q=p.T,r=p.U-p.V,z=p.P-p.T,u=Gg(l,q);;){var A=q+z;if(A>m.P)break a;for(var H=m.V,E=m.U,K=u;K<l.length&&l[K].T<A;K++){var I=l[K];I.V>H&&(H=I.V);I.U<E&&(E=I.U)}if(H+r<=E||u>=l.length){"left"==
...
"px");b.D&&(b.D.parentNode.removeChild(b.D),b.D=null);k=a.b?g.V:g.P;g=a.b?g.U:g.T;if(po(a,k)&&a.N.length)b=b.modify(),b.xa=!0,O(c,b);else{Jo(a);m=new lg(a.b?a.sa:a.wa,a.b?a.wa:a.D,a.b?a.D:a.kb,a.b?a.kb:a.sa);a.b&&(m=Cg(m));l=a.Gb;for(p=[new pg(h.T,h.P,h.V,h.U)];0<p.length&&p[0].P<=m.T;)p.shift();if(p.length){p[0].T<m.T&&(p[0].T=m.T);h=l.length?l[l.length-1].P:m.T;h<m.P&&l.push(new pg(h,m.P,m.V,m.U));h=Gg(l,p[0].T);p=t(p);for(q=p.next();!q.done;q=p.next()){r=q.value;if(h==l.length)break;l[h].T<r.T&&
...
new hl(cl(b));O(e,c)}else O(e,null)})})})});return e.result()}function Ap(a,b){var c=L("doFinishBreakOfFragmentLayoutConstraints"),d=[].concat(a.A);d.sort(function(a,b){return a.se()-b.se()});var e=0;Be(function(){return e<d.length?d[e++].Ma(b,a).Ec(!0):M(!1)}).then(function(){O(c,!0)});return c.result()}
...
function Dr(a){var b=a["repeat-on-break"];return b!==J&&(b===Wc&&(b=a.display===Pd?od:a.display===Od?nd:J),b&&b!==J)?b.toString():null}function Mr(a){var b=L("createTextNodeView");Nr(a).then(function(){var c=a.na||0,c=Or(a.w.Pa).substr(c);a.B=document.createTextNode(c);O(b,!0)});return b.result()}
...
function Ct(a,b,c){var d=b.I===b.h;a.Y={};c?(a.b=c.clone(),bm(a.f,c.g)):(a.b=new ml,bm(a.f,-1));a.lang&&b.h.setAttribute("lang",a.lang);c=a.b;c.page++;Ob(a,a.style.b);a.A=c.clone();var e=d?{}:Gs(a.Z),f=rt(a,e);if(!f)return M(null);var g=0;if(!d){Dk(b,f.f.b.width.value===Xd);Ek(b,f.f.b.height.value===Yd);a.h.j=b;Yp(a.h,e,a);var h=es(ds(e),a);Dt(a,h,b);ls(e,h,b,a);g=h.Yb+h.Xb}var e=Eq(f,a,"writing-mode")||pd,h=Eq(f,a,"direction")||zd,l=new an(a.Gb,"page",null,null,null,e,h),k=L("layoutNextPage");Ce(function(c){zt(a,
b,f,b.h,g,g+1,[],l).then(function(){Gn(l)||Cn(l);Gn(l)?(a.b=a.A.clone(),l.Nc=!1,P(c)):Q(c)})}).then(function(){f.ca(a,b,a.g);if(!d){var e=new sc(f.f.f,"left-page");b.f=e.evaluate(a)?"left":"right";At(a);c=a.b;Object.keys(c.b).forEach(function(b){b=c.b[b];var d=b.f;!d||"page"!==d&&kt(a,d)||(b.f=null)})}a.b=a.A=null;c.g=a.f.b;Gk(b,a.style.F.N[a.da.url],a.g);Bt(a,c)&&(c=null);O(k,c)});return k.result()}
...
a.text?hg(a.text,d,a.url,a.Oa,a.media).Ec(!0):gg(a.url,d,a.Oa,a.media)}return M(!1)}).then(function(){z=new jt(a,d.j,d.u,d.J.l,d.G,d.A,d.D,d.l,d.H,d.F);a.H[r]=z;delete a.u[r];O(b,z)});return b.result()},"FetchStylesheet "+d),a.u[r]=g,g.start()),g.get().then(function(e){a.f[d]=e;O(c,b)}))}else O(c,null)});return c.result()};function Mt(a){return String.fromCharCode(a>>>24&255,a>>>16&255,a>>>8&255,a&255)}
...
function Xt(a,b){this.g=a;this.D=this.f=this.b=this.l=this.h=null;this.J=b;this.G=null;this.Z={};this.lang=null;this.j=0;this.N=!1;this.H=!0;this.u=null;this.A={};this.ca=this.Se=this.kf=null;this.Y={};this.R=null;this.F=ku(this);iu()&&(Gh["http://www.w3.org/1998/Math/MathML"]=!0)}
...
l);}a.R=l}var g=c?wk(ck(ck(sk(ck(ck(new dk([c.b]),"encryption"),"EncryptedData"),rk()),"CipherData"),"CipherReference"),"URI"):[],k=ck(ck(f,"bindings"),"mediaType").X;for(c=0;c<k.length;c++){var m=k[c].getAttribute("handler");(l=k[c].getAttribute("media-type"))&&m&&a.f[m]&&(a.Z[l]=a.f[m].src)}a.A=hu(ck(f,"metadata"),wk(f,"prefix")[0]);a.A[du]&&(a.lang=a.A[du][0].v);a.A[fu]&&(a.N="pre-paginated"===a.A[fu][0].v);if(!d){if(0<g.length&&a.G)for(d=bu(a.G),c=0;c<g.length;c++)a.g.A[a.J+g[c]]=d;a.N&&mu(a);
return M(!0)}f=new Pa;k={};if(0<g.length&&a.G)for(l="1040:"+Pt(a.G),c=0;c<g.length;c++)k[g[c]]=l;for(c=0;c<d.length;c++){var p=d[c];if(m=p.n){var q=decodeURI(m),g=a.D[q];l=null;g&&(g.A=0!=p.m,g.u=p.c,g.g&&(l=g.g.replace(/\s+/g,"")));g=k[q];if(l||g)f.append(m),f.append(" "),f.append(l||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}mu(a);return sf(e,"","POST",f.toString(),"text/plain")}
function mu(a){for(var b=0,c=t(a.b),d=c.next();!d.done;d=c.next()){var d=d.value,e=a.N?1:Math.ceil(d.u/1024);d.b=b;d.f=e;b+=e}a.j=b;a.u&&a.u(a.j)}function nu(a,b){a.H=b||a.N}
function ou(a,b){a.u=b;if(a.H)return a.N&&!a.j&&mu(a),M(!0);var c=0,d=0,e=L("estimatePageCount");Ce(function(b){if(d===a.b.length)Q(b);else{var e=a.b[d++];e.b=c;a.g.load(e.src).then(function(d){var f=1800,g=d.lang||a.lang;g&&g.match(/^(ja|ko|zh)/)&&(f/=3);e.f=Math.ceil(gk(d)/f);c+=e.f;a.j=c;a.u&&a.u(a.j);P(b)})}}).Ka(e);return e.result()}
...
function su(a,b){return ke("resolveEPage",function(c){if(0>=b)O(c,{O:0,Ea:0,aa:-1});else if(a.H){var d=a.b.findIndex(function(a){return!a.b&&!a.f||a.b<=b&&a.b+a.f>b});-1==d&&(d=a.b.length-1);var e=a.b[d];e&&e.f||(e=a.b[--d]);O(c,{O:d,Ea:-1,aa:Math.floor(b-e.b)})}else{var f=Xa(a.b.length,function(c){c=a.b[c];return c.b+c.f>b});f==a.b.length&&f--;var g=a.b[f];a.g.load(g.src).then(function(a){b-=g.b;b>g.f&&(b=g.f);var d=0;0<b&&(a=gk(a),d=Math.round(a*b/g.f),d==a&&d--);O(c,{O:f,Ea:d,aa:-1})})}},function(a,
d){w.b(d,"Cannot resolve epage:",b);O(a,null)})}function tu(a,b){var c=a.b[b.O];if(a.H)return M(c.b+b.aa);if(0>=b.Ea)return M(c.b);var d=L("getEPage");a.g.load(c.src).then(function(a){a=gk(a);O(d,c.b+Math.min(a,b.Ea)*c.f/a)});return d.result()}function uu(a,b){return{page:a,position:{O:a.O,aa:b,Ea:a.offset}}}function vu(a,b,c,d,e){this.S=a;this.viewport=b;this.h=c;this.l=e;this.Rb=[];this.j=[];this.$=xb(d);this.g=new Vr(b);this.f=new Wp(a.F);this.vf=!1}
function wu(a,b){var c=a.Rb[b.O];return c?c.ab[b.aa]:null}n=vu.prototype;n.cc=function(a){return this.S.R?this.S.R:(a=this.Rb[a?a.O:0])?a.nb.G:null};
function xu(a,b,c,d){c.I.style.display="none";c.I.style.visibility="visible";c.I.style.position="";c.I.style.top="";c.I.style.left="";c.I.setAttribute("data-vivliostyle-page-side",c.f);var e=b.ab[d];c.u=!b.item.O&&!d;b.ab[d]=c;if(a.S.H){if(!d&&0<b.item.O){var f=a.S.b[b.item.O-1];b.item.b=f.b+f.f}b.item.f=b.ab.length;a.S.j=a.S.b.reduce(function(a,b){return a+b.f},0);a.S.u&&a.S.u(a.S.j)}if(e)b.nb.viewport.f.replaceChild(c.I,e.I),eb(e,{type:"replaced",target:null,currentTarget:null,$f:c});else{e=null;
if(0<d)e=b.ab[d-1].I.nextElementSibling;else for(f=b.item.O+1;f<a.Rb.length;f++){var g=a.Rb[f];if(g&&g.ab[0]){e=g.ab[0].I;break}}b.nb.viewport.f.insertBefore(c.I,e)}a.l({width:b.nb.sa,height:b.nb.la},b.nb.Da,b.item.O,b.nb.ca+d)}
function yu(a,b,c){var d=L("renderSinglePage"),e=zu(a,b,c);Ct(b.nb,e,c).then(function(f){var g=(c=f)?c.page-1:b.ib.length-1;xu(a,b,e,g);$p(a.f,e.O,g);f=null;if(c){var h=b.ib[c.page];b.ib[c.page]=c;h&&b.ab[c.page]&&(nl(c,h)||(f=yu(a,b,c)))}f||(f=M(!0));f.then(function(){var f=aq(a.f,e),h=0;Ce(function(b){h++;if(h>f.length)Q(b);else{var c=f[h-1];c.Vd=c.Vd.filter(function(a){return!a.qd});c.Vd.length?Au(a,c.O).then(function(d){d?(Zp(a.f,c.Je),bq(a.f,c.Vd),yu(a,d,d.ib[c.aa]).then(function(c){var d=a.f;
d.b=d.F.pop();d=a.f;d.g=d.H.pop();d=c.Ud.position;d.O===e.O&&d.aa===g&&(e=c.Ud.page);P(b)})):P(b)}):P(b)}}).then(function(){e.I.parentElement||(e=b.ab[g]);e.A=!c&&b.item.O===a.S.b.length-1;e.A&&dq(a.f,a.viewport);O(d,{Ud:uu(e,g),ag:c})})})});return d.result()}
...
function Cu(a,b,c){var d=L("findPage");Au(a,b.O).then(function(e){if(e){var f=null,g;Ce(function(d){var h=Bu(b,e);g=h.aa;(f=e.ab[g])?Q(d):e.complete?(g=e.ib.length-1,f=e.ab[g],Q(d)):c?Du(a,h).then(function(a){a&&(f=a.page,g=a.position.aa);Q(d)}):Ae(100).then(function(){P(d)})}).then(function(){O(d,uu(f,g))})}else O(d,null)});return d.result()}
function Du(a,b){var c=L("renderPage");Au(a,b.O).then(function(d){if(d){var e=Bu(b,d),f=e.aa,g=e.Ea,h=d.ab[f];h?O(c,uu(h,f)):Ce(function(b){if(f<d.ib.length)Q(b);else if(d.complete)f=d.ib.length-1,Q(b);else{var c=d.ib[d.ib.length-1];yu(a,d,c).then(function(a){var e=a.Ud.page;(c=a.ag)?0<=g&&qt(d.nb,c)>g?(h=e,f=d.ib.length-2,Q(b)):P(b):(h=e,f=a.Ud.position.aa,d.complete=!0,Q(b))})}}).then(function(){h=h||d.ab[f];var b=d.ib[f];h?O(c,uu(h,f)):yu(a,d,b).then(function(a){a.ag||(d.complete=!0);O(c,a.Ud)})})}else O(c,
null)});return c.result()}n.Mb=function(){return Eu(this,{O:this.S.b.length-1,aa:Number.POSITIVE_INFINITY,Ea:-1},!1)};function Eu(a,b,c){var d=L("renderPagesUpto");b||(b={O:0,aa:0,Ea:0});var e=b.O,f=b.aa,g=0;c&&(g=e);var h;Ce(function(c){Du(a,{O:g,aa:g===e?f:Number.POSITIVE_INFINITY,Ea:g===e?b.Ea:-1}).then(function(a){h=a;++g>e?Q(c):P(c)})}).then(function(){O(d,h)});return d.result()}n.wg=function(a,b){return Cu(this,{O:0,aa:0,Ea:-1},b)};
n.zg=function(a,b){return Cu(this,{O:this.S.b.length-1,aa:Number.POSITIVE_INFINITY,Ea:-1},b)};n.nextPage=function(a,b){var c=this,d=a.O,e=a.aa,f=L("nextPage");Au(c,d).then(function(a){if(a){if(a.complete&&e==a.ib.length-1){if(d>=c.S.b.length-1){O(f,null);return}d++;e=0}else e++;Cu(c,{O:d,aa:e,Ea:-1},b).Ka(f)}else O(f,null)});return f.result()};n.Me=function(a,b){var c=a.O,d=a.aa;if(d)d--;else{if(!c)return M(null);c--;d=Number.POSITIVE_INFINITY}return Cu(this,{O:c,aa:d,Ea:-1},b)};
...
function Hu(a,b,c){var d=L("navigateToEPage");su(a.S,b).then(function(b){b?Cu(a,b,c).Ka(d):O(d,null)});return d.result()}function Iu(a,b,c){var d=L("navigateToCFI");ru(a.S,b).then(function(b){b?Cu(a,b,c).Ka(d):O(d,null)});return d.result()}
function Ju(a,b,c,d){w.debug("Navigate to",b);var e=lu(a.S,xa(b));if(!e){if(a.S.h&&b.match(/^#epubcfi\(/))e=lu(a.S,a.S.h.url);else if("#"===b.charAt(0)){var f=a.S.F.Jg(b);a.S.h?e=lu(a.S,f[0]):e=f[0];b=f[0]+(f[1]?"#"+f[1]:"")}if(null==e)return M(null)}var g=a.S.D[e];if(!g)return a.S.h&&e==lu(a.S,a.S.h.url)&&(e=b.indexOf("#"),0<=e)?Iu(a,b.substr(e+1),d):M(null);var h=L("navigateTo");Au(a,g.O).then(function(e){var f=jk(e.da,b);f?Cu(a,{O:g.O,aa:-1,Ea:ek(e.da,f)},d).Ka(h):c.O!==g.O?Cu(a,{O:g.O,aa:0,Ea:-1},
d).Ka(h):O(h,null)});return h.result()}
function zu(a,b,c){var d=b.nb.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.setAttribute("role","region");e.style.position="absolute";e.style.top="0";e.style.left="0";Xj||(e.style.visibility="hidden",e.setAttribute("aria-hidden","true"));d.h.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);var g=new Ck(e,f);g.O=b.item.O;g.position=c;g.offset=qt(b.nb,c);g.offset||(b=a.S.F.Pe("",b.item.src),f.setAttribute("id",
...
function Au(a,b){if(b>=a.S.b.length)return M(null);var c=a.Rb[b];if(c)return M(c);var d=L("getPageViewItem"),e=a.j[b];if(e){var f=ue(d);e.push(f);return d.result()}var e=a.j[b]=[],g=a.S.b[b],h=a.S.g;h.load(g.src).then(function(f){g.j=f.b.title;var k=h.f[f.url],l=a.Ee(f),p=a.viewport,q=mt(k,p.width,p.height,p.fontSize,a.$);if(q.width!=p.width||q.height!=p.height||q.fontSize!=p.fontSize)p=new Xr(p.window,q.fontSize,p.root,q.width,q.height);q=a.Rb[b-1];null!==g.wb?q=g.wb-1:(q=!(0<b)||q&&q.complete?q?
q.nb.ca+q.ab.length:0:g.b||b,null!==g.Bc&&(q+=g.Bc));Xp(a.f,q);var r=new nt(k,f,a.S.lang,p,a.g,a.h,l,a.S.Y,q,a.S.F,a.f,a.S.R);r.$=a.$;ot(r).then(function(){c={item:g,da:f,nb:r,ib:[null],ab:[],complete:!1};a.Rb[b]=c;O(d,c);e.forEach(function(a){a.sb(c)})})});return d.result()}function Mu(a){return a.Rb.some(function(a){return a&&0<a.ab.length})}
n.Rc=function(a){var b=this.S,c=b.Se||b.kf;this.vf=a;if(!c)return M(null);if(this.b&&this.b.page)return this.b.page.I.style.visibility="visible",this.b.page.I.setAttribute("aria-hidden","false"),M(this.b.page);var d=L("showTOC");this.b||(this.b=new Qt(b.g,c.src,b.lang,this.g,this.h,this.$,this,b.Y,b.F,this.f));a=this.viewport;var b=Math.min(350,Math.round(.67*a.width)-16),c=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.visibility="hidden";e.style.width=b+10+"px";e.style.maxHeight=
...
n.Ze=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.A=null,this.window.addEventListener("resize",this.Y,!1),this.Xa=!0):this.window.removeEventListener("resize",this.Y,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.Xa=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:Wu(this,b["margin-left"])||0,marginRight:Wu(this,b["margin-right"])||0,marginTop:Wu(this,b["margin-top"])||0,marginBottom:Wu(this,b["margin-bottom"])||
...
function Vu(a){a.Xa=!1;a.ec=!1;if(gv(a))return M(!0);Ru(a,"loading");Uu(a);var b=ne(fe.f,function(){return ke("resize",function(c){a.l=b;Su.f("render (resize)");iv(a);a.f&&(a.f.aa=-1);nu(a.S,a.Mb);Eu(a.b,a.f,!a.Mb).then(function(d){a.f=d.position;Yu(a,d.page,!0).then(function(){Ru(a,"interactive");ou(a.S,function(b){b={t:"nav",epageCount:b,first:a.g.u,last:a.g.A,metadata:a.S.A,itemTitle:a.S.b[a.f.O].j};if(a.g.u||!a.f.aa&&a.S.b[a.f.O].b)b.epage=a.S.b[a.f.O].b;Qu(a,b)}).then(function(){dv(a).then(function(d){(a.Mb?
a.b.Mb():M(null)).then(function(){a.l===b&&(a.l=null);Su.b("render (resize)");a.Mb&&Ru(a,"complete");Qu(a,{t:"loaded"});O(c,d)})})})})})},function(a,b){if(b instanceof mv)Su.b("render (resize)"),w.debug(b.message);else throw b;})});return M(!0)}function ev(a,b,c){var d=L("sendLocationNotification"),e={t:"nav",first:b.u,last:b.A,metadata:a.S.A,itemTitle:a.S.b[b.O].j};tu(a.S,a.f).then(function(b){e.epage=b;e.epageCount=a.S.j;c&&(e.cfi=c);Qu(a,e);O(d,!0)});return d.result()}
...
n.oc=function(a){var b=this.C,c=a.w,d=c.display,e=this.h.f;Vw(this,a);if(c.M===b.F)d=Nn(e,Sv(b,c)),b.N=parseFloat(d[b.u?"height":"width"]),b.b.J=a.hd&&a.hd.M,a.Qb=!0;else switch(d){case "table-header-group":case "table-footer-group":if(this.b)return this.b=!1,M(!0);break;case "table-row":this.b||(b.D=c.B,this.g=!1);break;case "table-cell":if(!this.b){this.g||(this.rowIndex++,this.Qa=0,this.g=!0);d=this.rowIndex;c=new yw(this.rowIndex,this.Qa,c.B);e=b.g[d];e||(b.g[d]=new ww(d,null),e=b.g[d]);e.b.push(c);
...
function Zw(a,b,c,d){var e=b.rowIndex,f=b.Qa,g=c.B;if(1<b.f){x(g,"box-sizing","border-box");for(var h=a.C.J,l=0,k=0;k<b.f;k++)l+=h[b.b.Qa+k];l+=a.C.R*(b.f-1);x(g,a.C.u?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new Aw(a.f,b,c);a=a.C;(g=a.f[e])||(g=a.f[e]=[]);g[f]=c;1===d.f.pa.length&&d.f.K&&(c.f=!0);return Im(c.ic,d).Ec(!0)}function $w(a,b){var c=a.C.h[0];return c?c.Zb.b.Qa===b:!1}
