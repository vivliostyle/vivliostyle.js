 ...
 *
 * Vivliostyle core 2019.1.103-pre.20190402012042
 */
(function(factory) {
...
k);continue}g.cc();case 4:if(34==tf(h,1).type)switch(S(h),S(h),k=R(h),k.type){case 1:g.Wb(null,k.text);a.b=f?Nf:T;S(h);break;case 36:g.Wb(null,null);a.b=f?Nf:T;S(h);break;default:a.b=Tf,g.error("E_CSS_NAMESPACE",k)}else g.Wb(a.I,null),a.b=f?Nf:T,S(h);continue;case 5:k.b&&g.cc();case 6:g.ze(k.text);a.b=f?Nf:T;S(h);continue;case 7:k.b&&g.cc();case 8:g.oe(k.text);a.b=f?Nf:T;S(h);continue;case 55:k.b&&g.cc();case 14:S(h);k=R(h);b:switch(k.type){case 1:g.qd(k.text,null);S(h);a.b=f?Nf:T;continue;case 6:m=
...
n.he=function(a){return this.b&64?a:null};n.bd=function(a){return this.b&128?a:null};n.Ub=function(){return null};n.qc=function(){return null};n.Xb=function(){return null};n.Yc=function(a){return a};var Zg=new ah(0,U,U);
...
function Yk(a,b,c){this.M=a;this.parent=b;this.Ma=c;this.na=0;this.K=!1;this.kb=Wk;this.wa=b?b.wa:null;this.Fa=this.Ja=null;this.Ba=!1;this.ya=!0;this.xa=!1;this.j=b?b.j:0;this.display=null;this.W=bl;this.ca=this.N=this.l=this.Ca=null;this.Z="baseline";this.la="top";this.ta=this.sa=0;this.I=!1;this.uc=b?b.uc:0;this.F=b?b.F:null;this.B=b?b.B:!1;this.S=this.hd=!1;this.D=this.A=this.G=this.g=null;this.h=b?b.h:{};this.b=b?b.b:!1;this.direction=b?b.direction:"ltr";this.f=b?b.f:null;this.Qa=this.lang=null;
this.C=b?b.C:null;this.u=null;this.ua={};this.Sa=1;this.Y=this.J=null}function cl(a){a.ya=!0;a.j=a.parent?a.parent.j:0;a.A=null;a.D=null;a.na=0;a.K=!1;a.display=null;a.W=bl;a.Ca=null;a.l=null;a.N=null;a.ca=null;a.Z="baseline";a.I=!1;a.uc=a.parent?a.parent.uc:0;a.F=a.parent?a.parent.F:null;a.B=a.parent?a.parent.B:!1;a.g=null;a.G=null;a.Ja=null;a.hd=!1;a.S=!1;a.b=a.parent?a.parent.b:!1;a.Ja=null;a.Qa=null;a.C=a.parent?a.parent.C:null;a.u=null;a.ua={};a.Sa=1;a.J=null;a.Y=null}
function dl(a){var b=new Yk(a.M,a.parent,a.Ma);b.na=a.na;b.K=a.K;b.Ja=a.Ja;b.kb=a.kb;b.wa=a.wa;b.Fa=a.Fa;b.ya=a.ya;b.j=a.j;b.display=a.display;b.W=a.W;b.Ca=a.Ca;b.l=a.l;b.N=a.N;b.ca=a.ca;b.Z=a.Z;b.la=a.la;b.sa=a.sa;b.ta=a.ta;b.hd=a.hd;b.S=a.S;b.I=a.I;b.uc=a.uc;b.F=a.F;b.B=a.B;b.g=a.g;b.G=a.G;b.A=a.A;b.D=a.D;b.f=a.f;b.b=a.b;b.xa=a.xa;b.Qa=a.Qa;b.C=a.C;b.u=a.u;b.ua=Object.create(a.ua);b.Sa=a.Sa;b.J=a.J;b.Y=a.Y;return b}Yk.prototype.modify=function(){return this.Ba?dl(this):this};
...
n.kc=function(a,b,c,d,e){var f=b.element;x(f,"display","flex");var g=Hq(this,a,"vertical-align"),h=null;g===D("middle")?h="center":g===D("top")?h="flex-start":g===D("bottom")&&(h="flex-end");h&&(x(f,"flex-flow",this.b?"row":"column"),x(f,"justify-content",h));uq.prototype.kc.call(this,a,b,c,d,e)};
...
Object.keys(f).forEach(function(a){var b=hs(gs(f[a]),this);this.xb[a]={width:b.jc+2*b.qe,height:b.ic+2*b.qe}},a);return b.result()}function mm(a,b,c){if(a=a.b)a.f[b.b]||(a.f[b.b]=c),c=a.b[b.b],c||(c=new nl,a.b[b.b]=c),c.b.push(new ml(new kl({pa:[{node:b.element,kb:Wk,wa:null,Ja:null,Fa:null,Sa:0}],na:0,K:!1,Qa:null}),b))}
...
function Gt(a,b,c){a.Y=b.jc;a.S=b.ic;a.Ba=b.jc+2*b.qe;a.ua=b.ic+2*b.qe;c.H.style.width=a.Ba+"px";c.H.style.height=a.ua+"px";c.h.style.left=b.ac+"px";c.h.style.right=b.ac+"px";c.h.style.top=b.ac+"px";c.h.style.bottom=b.ac+"px";c.h.style.padding=b.$b+"px";c.h.style.paddingTop=b.$b+1+"px"}function Ht(a,b,c,d){Kj.call(this,a.j,a,b,c,d,a.h,!c);this.g=a;this.F=!1}v(Ht,Kj);n=Ht.prototype;n.ce=function(){};
...
n.ee=function(){var a={};this.g.I.push(a);Gf(this.g,new Rj(this.f,this.oa,this.ia,a,this.g.h))};n.wd=function(a){var b=this.g.D;if(a){var c=ai(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Gf(this.g,new Rj(this.f,this.oa,null,b,this.g.h))};n.de=function(){this.F=!0;this.Tb()};n.Vc=function(){var a=new Ts(this.g.u,this.g,this,this.B,this.g.F);Gf(this.g,a);a.Vc()};
n.La=function(){Kj.prototype.La.call(this);if(this.F){this.F=!1;var a="R"+this.g.N++,b=D(a),c;this.ia?c=new Wh(b,0,this.ia):c=new V(b,0);ci(this.mb,"region-id").push(c);this.dc();a=new Ht(this.g,this.ia,this,a);Gf(this.g,a);a.La()}};
...
return c.result()};function gu(){this.id=null;this.src="";this.j=this.h=this.g=null;this.P=-1;this.u=0;this.B=null;this.f=this.b=0;this.nc=this.wb=null;this.l=bb}function hu(a){return a.id}
...
function Du(a,b){var c=a.Ib[b.P];return c?c.Ka[b.aa]:null}n=Cu.prototype;n.fc=function(a){return this.O.J?this.O.J:(a=this.Ib[a?a.P:0])?a.nb.I:null};
...
n.Oe=function(a,b){var c=a.P,d=a.aa;if(d)d--;else{if(!c)return M(null);c--;d=Number.POSITIVE_INFINITY}return Ju(this,{P:c,aa:d,Da:-1},b)};function Mu(a,b,c){b="left"===b.b;a="ltr"===a.fc(c);return!b&&a||b&&!a}function Nu(a,b,c){var d=L("getCurrentSpread"),e=Du(a,b);if(!e)return M({left:null,right:null});var f="left"===e.b;(Mu(a,e,b)?a.Oe(b,c):a.nextPage(b,c)).then(function(c){var e=Du(a,b);(c=c&&c.page)&&c.b===e.b&&(c=null);f?O(d,{left:e,right:c}):O(d,{left:c,right:e})});return d.result()}
...
(this.viewport=null,this.$.Dc=a.pageBorder,this.Ya=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=a.zoom,this.hc=!0);"boolean"==typeof a.fitToScreen&&a.fitToScreen!==this.D&&(this.D=a.fitToScreen,this.hc=!0);"object"==typeof a.defaultPaperSize&&"number"==typeof a.defaultPaperSize.width&&"number"==typeof a.defaultPaperSize.height&&(this.viewport=null,this.$.vc=a.defaultPaperSize,this.Ya=!0);dv(this,a);return M(!0)};
function dv(a,b){he("CONFIGURATION").forEach(function(c){c=c(b);a.Ya=c.Ya||a.Ya;a.hc=c.hc||a.hc})}n.Me=function(a){var b=this.g,c=this.j,d=a.target;c?c.left!==d&&c.right!==d||ev(this,a.ag):b===a.target&&ev(this,a.ag)};function fv(a,b){var c=[];a.g&&c.push(a.g);a.j&&(c.push(a.j.left),c.push(a.j.right));c.forEach(function(a){a&&b(a)})}function gv(a){fv(a,function(b){b.removeEventListener("hyperlink",a.F,!1);b.removeEventListener("replaced",a.Me,!1)})}
...
Vu.prototype.fc=function(){return this.b?this.b.fc(this.f):null};
...
function wv(a,b){var c=vv(b),d=null;pe(function(){var b=L("commandLoop"),f=ie.f;a.F=function(b){var c="#"===b.href.charAt(0)||a.J.some(function(a){return b.href.substr(0,a.length)==a});if(c){b.preventDefault();var d={t:"hyperlink",href:b.href,internal:c};qe(f,function(){Xu(a,d);return M(!0)})}};Fe(function(b){if(a.Ya)bv(a).then(function(){P(b)});else if(a.hc)a.g&&ev(a,a.g).then(function(){P(b)});else if(c){var e=c;c=null;uv(a,e).then(function(){P(b)})}else e=L("waitForCommand"),d=xe(e,self),e.result().then(function(){P(b)})}).Ga(b);
...
jw.prototype.Cd=function(a){var b=this.C,c=a.w,d=b.b;if(c.parent&&b.j===c.parent.M){switch(c.u){case "header":if(d.zc)c.u="none";else return aw(d,c),M(!0);break;case "footer":if(d.yc)c.u="none";else return bw(d,c),M(!0)}d.g||(d.g=c.M)}return Hm.prototype.Cd.call(this,a)};jw.prototype.tc=function(a){var b=this.C,c=a.w;c.M===b.j&&(b.b.J=a.ld&&a.ld.M,a.Vb=!0);return"header"===c.u||"footer"===c.u?M(!0):Hm.prototype.tc.call(this,a)};function nw(){}v(nw,Jp);
...
function Qw(a){a.h||(a.h=Pw(a).map(function(a){return a.ec()}));return a.h}function Pw(a){return Rw(a.C,a.rowIndex).map(a.C.Sd,a.C)}function yp(a,b){zp.call(this,a,b);this.F=b;this.u=!1;this.G=-1;this.N=0;this.I=[];this.J=this.B=null;this.S=0;this.g=[];this.l=[];this.f=[];this.D=null;this.h=[];this.b=null}v(yp,zp);n=yp.prototype;n.We=function(){return"Table formatting context (vivliostyle.table.TableFormattingContext)"};
n.ff=function(a,b){if(!b)return b;switch(a.display){case "table-row":return!this.h.length;case "table-cell":return!this.h.some(function(b){return b.Id.pa[0].node===a.M});default:return b}};function Sw(a,b){var c=a.l[b];c||(c=a.l[b]=[]);return c}function Nw(a,b){return a.g.findIndex(function(a){return b===a.M})}function Rw(a,b){return Sw(a,b).reduce(function(a,b){return b.bc!==a[a.length-1]?a.concat(b.bc):a},[])}function Mw(a,b){return Rw(a,b).filter(function(a){return a.rowIndex+a.rowSpan-1>b})}
...
function Vw(a,b){if(!b)return null;var c=null,d=0;a:for(;d<a.f.length;d++)if(a.f[d])for(var e=0;e<a.f[d].length;e++)if(a.f[d][e]&&b===a.f[d][e].lc.za){c=a.g[d].b[e];break a}if(!c)return null;for(;d<a.l.length;d++)for(;e<a.l[d].length;e++){var f=a.l[d][e];if(f.bc===c)return{rowIndex:f.rowIndex,Ra:f.Ra}}return null}function Ww(a,b){var c=[];return a.l.reduce(function(d,e,f){if(f>=b.rowIndex)return d;e=a.Sd(e[b.Ra].bc);if(!e||c.includes(e))return d;Xw(e.lc.za,d);c.push(e);return d},[])}
function Yw(a){var b=[];a.g.forEach(function(c){c.b.forEach(function(c,e){b[e]||(b[e]={Jf:[],elements:[]});var d=b[e],g=a.Sd(c);g&&!d.Jf.includes(g)&&(Xw(g.lc.za,d.elements),d.Jf.push(g))})});return[new Zw(b.map(function(a){return a.elements}))]}function Xw(a,b){a.B.forEach(function(a){a instanceof Yv&&b.push(a.w.C.b);a instanceof qw&&rw(a,null).forEach(function(a){b.push(a)})})}n.Ye=function(){return[].concat(this.h)};n.Xe=function(a){this.h=a};function Zw(a){this.f=a}
...
for(var e=d+c.rowSpan,f=Sw(b,d),g=0;f[g];)g++;for(;d<e;d++)for(var f=Sw(b,d),h=g;h<g+c.f;h++){var l=f[h]=new Gw(d,h,c);c.b||(c.b=l)}this.Ra++}}return Hm.prototype.tc.call(this,a)};n.uf=function(a){cx(this,a)};n.Df=function(a){cx(this,a)};n.kg=function(a){cx(this,a)};n.Cf=function(a){cx(this,a)};function cx(a,b){var c=b.w;c&&c.A&&!Fo(c)&&a.f.push(c.clone())}function bx(a,b){0<a.f.length&&Ko(a.h,b.w,a.f);a.f=[]}
function dx(a,b){this.gc=!0;this.C=a;this.f=b;this.l=!1;this.b=-1;this.g=0;this.u=b.u;b.u=!1}v(dx,Hm);var ex={"table-caption":!0,"table-column-group":!0,"table-column":!0};
function fx(a,b,c,d){var e=b.rowIndex,f=b.Ra,g=c.A;if(1<b.f){x(g,"box-sizing","border-box");for(var h=a.C.J,l=0,k=0;k<b.f;k++)l+=h[b.b.Ra+k];l+=a.C.S*(b.f-1);x(g,a.C.u?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new Hw(a.f,b,c);a=a.C;(g=a.f[e])||(g=a.f[e]=[]);g[f]=c;1===d.f.pa.length&&d.f.K&&(c.f=!0);return Lm(c.lc,d).Hc(!0)}function gx(a,b){var c=a.C.h[0];return c?c.bc.b.Ra===b:!1}
function hx(a){var b=a.C.h;if(!b.length)return[];var c=[],d=0;do{var e=b[d],f=e.bc.rowIndex;if(f<a.b){var g=c[f];g||(g=c[f]=[]);g.push(e);b.splice(d,1)}else d++}while(d<b.length);return c}
...
dx.prototype.tc=function(a){var b=a.w,c=this.C.b,d=b.display;"table-header-group"===d?c&&!c.h&&c.B===b.M?(this.j=!1,b.A.parentNode.removeChild(b.A)):x(b.A,"display","table-row-group"):"table-footer-group"===d&&(c&&!c.h&&c.l===b.M?(this.h=!1,b.A.parentNode.removeChild(b.A)):x(b.A,"display","table-row-group"));if(d&&ex[d])b.A.parentNode.removeChild(b.A);else if(b.M===this.C.F)b.xa=tp(this.f,b,null),this.f.u=this.u,a.Vb=!0;else return Hm.prototype.tc.call(this,a);return M(!0)};var zw=[];
...
function Bx(a,b){return Dx(a,b).map(function(a){return{Kd:a.yg.lc.za.B,Eb:a.Eb}})}function Dx(a,b){var c=Number.MAX_VALUE;a&&"table-row"===a.display&&(c=Nw(b,a.M)+1);for(var c=Math.min(b.f.length,c),d=[],e=0;e<c;e++)b.f[e]&&b.f[e].forEach(function(a){a&&d.push({yg:a,Eb:a.ec().w})});return d}function rw(a,b){var c=a.w.C,d=Vw(c,b);return d?Ww(c,d):Yw(c)}n.se=function(a){return a instanceof qw?this.w.C===a.w.C:!1};var Ex=new mx;
...
function Ix(a,b,c,d,e){function f(a){if(a)return a.map(function(a){return{url:a.url||null,text:a.text||null}})}d=d||{};var g=f(d.authorStyleSheet),h=f(d.userStyleSheet);e&&Object.assign(a.f,e);b=Object.assign({a:b?"loadXML":"loadPublication",userAgentRootURL:a.h.userAgentRootURL,url:Fx(b)||c,document:d.documentObject,fragment:d.fragment,authorStyleSheet:g,userStyleSheet:h},Gx(a.f));a.g?a.gb.h(b):(a.g=!0,wv(a.gb,b))}n.fc=function(){return this.gb.fc()};
...
function Px(a){switch(a.t){case "loaded":a=a.viewer;var b=Kx=a.fc();a.ge.setAttribute("data-vivliostyle-page-progression",b);a.ge.setAttribute("data-vivliostyle-spread-view",a.$.ub);window.addEventListener("keydown",Ox,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Mx,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Nx,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
