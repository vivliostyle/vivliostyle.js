...
function yk(a,b,c){Oj.call(this,a);this.Rc=a.lastChild;this.h=b;this.mc=c;this.vd=a.ownerDocument;this.nc=!1;this.na=this.jb=this.Qa=this.Tc=0;this.oc=this.Oa=this.l=this.f=null;this.Sc=!1;this.M=this.g=this.u=null;this.hd=!0;this.rc=this.qc=0}t(yk,Oj);yk.prototype.clone=function(){var a=new yk(this.d,this.h,this.mc);Tj(a,this);a.Rc=this.Rc;a.nc=this.nc;a.l=this.l?this.l.clone():null;a.Oa=this.Oa.concat();return a};
...
function Un(a,b,c){var d=a.b.b[c];if(!d)return M(!0);a.e[c]&&0<b.A.length&&(b.hd=!1);Zk(b);var e=L("layoutColumn"),f=[];bf(function(c){for(;0<d.b.length;){var e=0,h=d.b[e];if(h.b.b>a.h)break;for(var l=1;l<d.b.length;l++){var n=d.b[l];if(n.b.b>a.h)break;zj(n.b,h.b)&&(h=n,e=l)}var p=h.b,q=!0;bl(b,h.d).then(function(a){h.b.Hd&&(null===a||p.d)&&f.push(h);p.d?(d.b.splice(e,1),Q(c)):a?(h.d=a,Q(c)):(d.b.splice(e,1),q?q=!1:df(c))});if(q){q=!1;return}}Q(c)}).then(function(){0<f.length&&(d.b=f.concat(d.b));
O(e,!0)});return N(e)}
function Vn(a,b,c,d,e,f,g,k){var h=Yl(c,a,"enabled");if(h&&h!==Vd)return M(!0);var l=L("layoutContainer"),n=Yl(c,a,"wrap-flow")===ld,p=c.b?c.g&&c.D:c.f&&c.I,h=Yl(c,a,"flow-from"),q=a.viewport.b.createElement("div"),r=Yl(c,a,"position");u(q,"position",r?r.name:"absolute");d.insertBefore(q,d.firstChild);var v=new Oj(q);v.b=c.b;c.tb(a,v,b);v.B=e;v.D=f;e+=v.left+v.marginLeft+v.aa;f+=v.top+v.marginTop+v.ga;if(h&&h.od())if(a.I[h.toString()])c.Yb(a,v,b,null,1,a.f),h=M(!0);else{var y=L("layoutContainer.inner"),
I=h.toString(),W=Y(c,a,"column-count"),P=Y(c,a,"column-gap"),E=1<W?Y(c,a,"column-width"):v.width,h=Xl(c,a),Ea=0,r=Yl(c,a,"shape-inside"),mb=ag(r,0,0,v.width,v.height,a),Qk=new Dm(I,a,a.viewport,a.d,h,a.$,a.na,a.style.u,a,b,a.Fa,a.Ga,k),yh=0,Z=null;bf(function(b){for(;yh<W;){var c=yh++;if(1<W){var d=a.viewport.b.createElement("div");u(d,"position","absolute");q.appendChild(d);Z=new yk(d,Qk,a.f);Z.b=v.b;Z.Ga=v.Ga;Z.Tb=v.Tb;v.b?(u(d,"margin-left",v.j+"px"),u(d,"margin-right",v.I+"px"),c=c*(E+P)+v.k,
Vj(Z,0,v.width),Uj(Z,c,E)):(u(d,"margin-top",v.k+"px"),u(d,"margin-bottom",v.w+"px"),c=c*(E+P)+v.j,Uj(Z,0,v.height),Vj(Z,c,E));Z.B=e+v.j;Z.D=f+v.k}else Z=new yk(q,Qk,a.f),Tj(Z,v),v=Z;Z.A=p?[]:g;Z.Rb=mb;if(0<=Z.width){var h=L("inner");Un(a,Z,I).then(function(){Z.M&&"column"!=Z.M&&(yh=W,"region"!=Z.M&&(a.I[I]=!0));O(h,!0)});c=N(h)}else c=M(!0);if(c.za()){c.then(function(){0<k.b.length?Q(b):(Ea=Math.max(Ea,Z.e),df(b))});return}0<k.b.length||(Ea=Math.max(Ea,Z.e))}Q(b)}).then(function(){v.e=Ea;c.Yb(a,
v,b,Z,W,a.f);O(y,!0)});h=N(y)}else{h=Yl(c,a,"content");r=!1;if(h&&Xj(h)){var Rk=a.viewport.b.createElement("span");h.S(new Wj(Rk,a));q.appendChild(Rk);km(c,a,v)}else c.wa&&(d.removeChild(q),r=!0);r||c.Yb(a,v,b,null,1,a.f);h=M(!0)}h.then(function(){if(!c.f||0<Math.floor(v.e)){if(!n){var h=v.B+v.left,p=v.D+v.top,r=Rj(v)+v.width+Sj(v),y=Pj(v)+v.height+Qj(v),E=Yl(c,a,"shape-outside"),h=ag(E,h,p,r,y,a);Ta(a.viewport.root)&&g.push(ke(h,0,-1.25*hc(a,"em",!1)));g.push(h)}}else if(0==c.children.length){d.removeChild(q);
...
null,fp(b,a).then(function(){ap(b).pa(e)})):O(e,!0)});return N(e)};Uo.prototype.bc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.bd();if(c){if("show"==a)return M(!0)}else if("hide"==a)return M(!0);if(c)return this.b.Zb(),M(!0);var d=this,e=L("showTOC");this.b.bc(b).then(function(a){if(a){if(b){var c=function(){d.b.Zb()};a.addEventListener("hyperlink",c,!1);a.L.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.w,!1)}O(e,!0)});return N(e)};
