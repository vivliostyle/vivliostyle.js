 ...
 *
 * Vivliostyle core 2016.4.1-pre.20160530093848
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
"1"))}}function Hn(a,b,c,d){var e=K("processLineStyling");fn(d);var f=d.concat([]);d.splice(0,d.length);var g=0,h=b.d;0==h.count&&(h=h.Vd);of(function(d){if(h){var e=In(a,f),m=h.count-g;if(e.length<=m)P(d);else{var p=Jn(a,f,e[m-1]);Kn(a,p,!1,!1).then(function(){g+=m;Tm(a.g,p,0).then(function(e){b=e;Gn(b,!1);h=b.d;f=[];nn(a,b,f).then(function(b){c=b;0<a.g.f.b.length?P(d):qf(d)})})})}}else P(d)}).then(function(){Array.prototype.push.apply(d,f);fn(d);O(e,c)});return N(e)}
...
function On(a,b,c){var d=K("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,h=a.B.length-1;0<=h&&!e;--h){var e=a.B[h].d(a,f),l=a.B[h].b();l>f&&(g=Math.min(g,l))}while(g>f&&!e);var k=!1;if(!e){v.b("Could not find any page breaks?!!");if(a.yd)return Pn(a,b).then(function(b){b?(b=b.modify(),b.e=!1,Kn(a,b,k,!0).then(function(){O(d,b)})):O(d,b)}),N(d);e=c;k=!0}Kn(a,e,k,!0).then(function(){O(d,e)});return N(d)}
...
function oo(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg",c||"polyline");a.setAttribute("stroke","black");a.setAttribute("stroke-width",b);a.setAttribute("fill","none");return a}var po={oe:"top left",pe:"top right",fe:"bottom left",ge:"bottom right"};
...
k.appendChild(l);a=oo(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));k.appendChild(a);b.split(" ").forEach(function(a){k.style[a]=f+"px"});return k}var ro={ne:"top",ee:"bottom",Jd:"left",Kd:"right"};
...
d["padding-bottom"]=new J(c.marginBottom)};Co.prototype.Rc=function(){var a=Lo(this,{start:"left",end:"right",ca:"width"});this.Fb=a.zd;this.marginLeft=a.Gd;this.marginRight=a.Fd};Co.prototype.Sc=function(){var a=Lo(this,{start:"top",end:"bottom",ca:"height"});this.Eb=a.zd;this.marginTop=a.Gd;this.marginBottom=a.Fd};
...
me;c["margin-"+f]=me;c["padding-"+e]=new J(p);c["padding-"+f]=new J(r);c["border-"+e+"-width"]=new J(t);c["border-"+f+"-width"]=new J(q);c[g]=new J(l);c["max-"+g]=new J(l);return{zd:E(d,h,D(d,k,m)),Gd:k,Fd:m}}Co.prototype.qb=function(a,b,c,d,e){Jl.prototype.qb.call(this,a,b,c,d,e);c.w=b.d};function Do(a,b){Jl.call(this,a,b);var c=b.k;this.j=vo[c];a.ma[c]=this;this.na=!0}u(Do,Jl);n=Do.prototype;
...
function mp(a,b,c){var d=a.b.b[c];if(!d||!ep(a,d.d))return M(!0);d.d="any";zn(b);a.f[c]&&0<b.gb.length&&(b.yd=!1);var e=K("layoutColumn"),f=[],g=[],h=!0;of(function(c){for(;0<d.b.length-g.length;){for(var e=0;0<=g.indexOf(e);)e++;var m=d.b[e];if(m.b.d>a.k||fp(a,m.b))break;for(var p=e+1;p<d.b.length;p++)if(!(0<=g.indexOf(p))){var r=d.b[p];if(r.b.d>a.k||fp(a,r.b))break;ei(r.b,m.b)&&(m=r,e=p)}var t=m.b,q=!0;Cn(b,m.d,h).then(function(a){h=!1;m.b.Xd&&(null===a||t.f)&&f.push(e);t.f?(g.push(e),P(c)):(a?
...
Bp.prototype.load=function(a){var b=ta(a);if(a=this.l[b])return a.Ca()?a:M(a.jc());var c=K("EPUBDocStore.load");a=Bp.Id.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?O(c,a):v.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return N(c)};function Ip(){this.id=null;this.src="";this.f=this.d=null;this.H=-1;this.h=0;this.j=null;this.b=this.e=0;this.g=Ta}function Jp(a){return a.id}
...
function Fp(a,b){this.f=a;this.h=this.d=this.b=this.g=this.e=null;this.k=b;this.j=null;this.G={};this.lang=null;this.w=0;this.u={};this.N=this.F=this.R=null;this.B={};this.D=null;this.l=Sp(this);Qp()&&(Ui["http://www.w3.org/1998/Math/MathML"]=!0)}
function Sp(a){function b(){}b.prototype.vd=function(a,b){return encodeURIComponent(b+(a?"#"+a:""))};b.prototype.b=function(b,d){var e=b.match(/^([^#]*)#?(.*)$/);if(e){var f=e[1]||d,e=e[2];if(f&&a.g.some(function(a){return a.src===f}))return"#"+this.vd(e,f)}return b};b.prototype.Yd=function(a){"#"===a.charAt(0)&&(a=a.substring(1));return(a=decodeURIComponent(a).match(/^([^#]*)#?(.*)$/))?[a[1],a[2]]:[]};return new b}
...
function eq(a,b,c){var d=K("renderAllPages"),e=a.H,f=a.S;a.H=0;of(function(d){a.S=a.H==b?c:Number.POSITIVE_INFINITY;bq(a).then(function(){++a.H>b?P(d):qf(d)})}).then(function(){a.H=e;a.S=f;bq(a).ta(d)});return N(d)}n.Nd=function(){this.S=this.H=0;return bq(this)};n.Od=function(){this.H=this.b.b.length-1;this.S=Number.POSITIVE_INFINITY;return bq(this)};
...
function cq(a){if(a.H>=a.b.b.length)return M(null);var b=a.Jb[a.H];if(b)return M(b);var c=a.b.b[a.H],d=a.b.f,e=K("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(zh(f)/2700),a.b.w=c.b);var g=d.b[f.url],h=a.Vc(f),l=a.viewport,k=gp(g,l.width,l.height,l.fontSize);if(k.width!=l.width||k.height!=l.height||k.fontSize!=l.fontSize)l=new Xm(l.f,k.fontSize,l.root,k.width,k.height);var k=a.Jb[a.H-1],m=new hp(g,f,a.b.lang,l,a.e,a.f,h,a.b.B,k?k.Ba.na+k.hb.length:0,a.b.l);
...
n.tc=function(){var a=this.b,b=a.F||a.R;if(!b)return M(null);var c=K("showTOC");this.d||(this.d=new yp(a.f,b.src,a.lang,this.e,this.f,this.T,this,a.B,a.l));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";
...
"complete");bo.d("loadEPUB");pq(g,{t:"loaded",metadata:g.g.u});O(f,!0)})})})})});return N(f)};
...
function Bq(a,b){var c=0,d=0;b.left&&(c+=b.left.d.width,d=b.left.d.height);b.right&&(c+=b.right.d.width,d=Math.max(d,b.right.d.height));b.left&&b.right&&(c+=2*a.T.Ib);return{width:c,height:d}}var Cq={he:"fit inside viewport"};
...
nq.prototype.Ma=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.T.$a?this.b.Td:this.b.nextPage;break;case "previous":a=this.T.$a?this.b.Wd:this.b.Zc;break;case "last":a=this.b.Od;break;case "first":a=this.b.Nd;break;default:return M(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return hq(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return jq(b.b,d)}}else return M(!0);var e=K("nextPage");a.call(b.b).then(function(a){a?(b.f=
...
ca("vivliostyle.viewer.Viewer",Hq);Hq.prototype.setOptions=Hq.prototype.Hd;Hq.prototype.addListener=Hq.prototype.Zd;Hq.prototype.removeListener=Hq.prototype.be;Hq.prototype.loadDocument=Hq.prototype.Pd;Hq.prototype.loadEPUB=Hq.prototype.$d;Hq.prototype.getCurrentPageProgression=Hq.prototype.nb;Hq.prototype.navigateToPage=Hq.prototype.Rd;Hq.prototype.navigateToInternalUrl=Hq.prototype.Qd;Hq.prototype.queryZoomFactor=Hq.prototype.ae;ca("vivliostyle.viewer.ZoomType",Cq);Cq.FIT_INSIDE_VIEWPORT="fit inside viewport";
