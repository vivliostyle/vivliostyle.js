...
function Ob(a){switch(a){case "q":case "rem":return!0;default:return!1}}function Pb(a,b,c,d){this.xb=b;this.Mb=c;this.Y=null;this.ic=function(){return this.Y?this.Y:this.$.ub?Math.floor(b/2)-this.$.Cc:b};this.R=null;this.hc=function(){return this.R?this.R:c};this.u=d;this.Za=null;this.fontSize=function(){return this.Za?this.Za:d};this.$=zb;this.J={};this.G=this.Z=this.ca=null}function Qb(a,b){a.J[b.u]={};for(var c=0;c<b.children.length;c++)Qb(a,b.children[c])}
...
function Ac(a,b,c){return b===a.h||b===a.b||c==a.h||c==a.b?a.h:b===a.j||b===a.f?c:c===a.j||c===a.f?b:new ec(a,b,c)}function y(a,b,c){return b===a.b?c:c===a.b?b:new oc(a,b,c)}function B(a,b,c){return b===a.b?new dc(a,c):c===a.b?b:new pc(a,b,c)}function Bc(a,b,c){return b===a.b||c===a.b?a.b:b===a.f?c:c===a.f?b:new qc(a,b,c)}function Cc(a,b,c){return b===a.b?a.b:c===a.f?b:new rc(a,b,c)};var Dc={};function Ec(){}n=Ec.prototype;n.rc=function(a){for(var b=0;b<a.length;b++)a[b].fa(this)};n.Se=function(){throw Error("E_CSS_EMPTY_NOT_ALLOWED");};n.Te=function(){throw Error("E_CSS_SLASH_NOT_ALLOWED");};n.Ad=function(){throw Error("E_CSS_STR_NOT_ALLOWED");};n.qc=function(){throw Error("E_CSS_IDENT_NOT_ALLOWED");};n.$c=function(){throw Error("E_CSS_NUMERIC_NOT_ALLOWED");};n.Zc=function(){throw Error("E_CSS_NUM_NOT_ALLOWED");};n.Yc=function(a){return this.Zc(a)};
n.he=function(){throw Error("E_CSS_COLOR_NOT_ALLOWED");};n.ad=function(){throw Error("E_CSS_URL_NOT_ALLOWED");};n.Ub=function(){throw Error("E_CSS_LIST_NOT_ALLOWED");};n.oc=function(){throw Error("E_CSS_COMMA_NOT_ALLOWED");};n.Xb=function(){throw Error("E_CSS_FUNC_NOT_ALLOWED");};n.Xc=function(){throw Error("E_CSS_EXPR_NOT_ALLOWED");};function Fc(){}v(Fc,Ec);n=Fc.prototype;
n.rc=function(a){for(var b=null,c=0;c<a.length;c++){var d=a[c],e=d.fa(this);if(b)b[c]=e;else if(d!==e){b=Array(a.length);for(d=0;d<c;d++)b[d]=a[d];b[c]=e}}return b||a};n.Ad=function(a){return a};n.qc=function(a){return a};n.Te=function(a){return a};n.$c=function(a){return a};n.Zc=function(a){return a};n.Yc=function(a){return a};n.he=function(a){return a};n.ad=function(a){return a};n.Ub=function(a){var b=this.rc(a.values);return b===a.values?a:new Gc(b)};
n.oc=function(a){var b=this.rc(a.values);return b===a.values?a:new Hc(b)};n.Xb=function(a){var b=this.rc(a.values);return b===a.values?a:new Ic(a.name,b)};n.Xc=function(a){return a};function Jc(){}n=Jc.prototype;n.toString=function(){var a=new Qa;this.$a(a,!0);return a.toString()};n.stringValue=function(){var a=new Qa;this.$a(a,!1);return a.toString()};n.Aa=function(){throw Error("F_ABSTRACT");};n.$a=function(a){a.append("[error]")};n.ef=function(){return!1};n.zc=function(){return!1};n.hf=function(){return!1};
...
Nc.prototype.Aa=function(a){return new Hb(a,this.Wc)};Nc.prototype.$a=function(a,b){b?(a.append('"'),a.append(Ta(this.Wc)),a.append('"')):a.append(this.Wc)};Nc.prototype.fa=function(a){return a.Ad(this)};function Oc(a){this.name=a;if(Dc[a])throw Error("E_INVALID_CALL");Dc[a]=this}v(Oc,Jc);Oc.prototype.Aa=function(a){return new Hb(a,this.name)};Oc.prototype.$a=function(a,b){b?a.append(Sa(this.name)):a.append(this.name)};Oc.prototype.fa=function(a){return a.qc(this)};Oc.prototype.Vf=function(){return!0};
...
n.bc=function(){};n.ne=function(){};n.me=function(){};n.te=function(){};n.Rc=function(){};n.Tb=function(){};n.ae=function(){};n.vd=function(){};n.ee=function(){};n.Zd=function(){};n.de=function(){};n.Uc=function(){};n.Qe=function(){};n.Ec=function(){};n.$d=function(){};n.ce=function(){};n.be=function(){};n.yd=function(){};n.xd=function(){};n.La=function(){};n.Qb=function(){};n.cc=function(){};n.wd=function(){};n.Nd=function(){};
...
S(h);a.b=Pf;l.splice(0,l.length);continue;case 29:a.b=Of;g.Tb();continue;case 1:if(!k.b){a.b=Uf;g.error("E_CSS_SPACE_EXPECTED",k);continue}g.bc();case 2:if(34==sf(h,1).type)if(S(h),S(h),p=a.N[k.text],null!=p)switch(k=R(h),k.type){case 1:g.Wb(p,k.text);a.b=f?Mf:T;S(h);break;case 36:g.Wb(p,null);a.b=f?Mf:T;S(h);break;default:a.b=Sf,g.error("E_CSS_NAMESPACE",k)}else a.b=Sf,g.error("E_CSS_UNDECLARED_PREFIX",k);else g.Wb(a.H,k.text),a.b=f?Mf:T,S(h);continue;case 3:if(!k.b){a.b=Uf;g.error("E_CSS_SPACE_EXPECTED",
k);continue}g.bc();case 4:if(34==sf(h,1).type)switch(S(h),S(h),k=R(h),k.type){case 1:g.Wb(null,k.text);a.b=f?Mf:T;S(h);break;case 36:g.Wb(null,null);a.b=f?Mf:T;S(h);break;default:a.b=Sf,g.error("E_CSS_NAMESPACE",k)}else g.Wb(a.H,null),a.b=f?Mf:T,S(h);continue;case 5:k.b&&g.bc();case 6:g.ze(k.text);a.b=f?Mf:T;S(h);continue;case 7:k.b&&g.bc();case 8:g.oe(k.text);a.b=f?Mf:T;S(h);continue;case 55:k.b&&g.bc();case 14:S(h);k=R(h);b:switch(k.type){case 1:g.pd(k.text,null);S(h);a.b=f?Mf:T;continue;case 6:m=
...
null);a.b=f?Mf:T;S(h);continue;case 6:m=k.text;S(h);if("nth-fragment"==m){if(p=bg(a),!p)break}else p=ag(a);k=R(h);if(11==k.type){g.qd(m,p);a.b=f?Mf:T;S(h);continue}}g.error("E_CSS_PSEUDOELEM_SYNTAX",k);a.b=Sf;continue;case 9:k.b&&g.bc();case 10:S(h);k=R(h);if(1==k.type)m=k.text,S(h);else if(36==k.type)m=null,S(h);else if(34==k.type)m="";else{a.b=Uf;g.error("E_CSS_ATTR",k);S(h);continue}k=R(h);if(34==k.type){p=m?a.N[m]:m;if(null==p){a.b=Uf;g.error("E_CSS_UNDECLARED_PREFIX",k);S(h);continue}S(h);k=
...
3==a.j?Zf(a,"E_CSS_UNEXPECTED_BRC",k):(1==a.j?g.Ec(l.pop()):(k=l.pop(),g.Ec(k)),a.h.push("media"),g.La(),a.b=Kf));S(h);continue;case 49:if($f(a,11,k))if(a.g||3!=a.j)Zf(a,"E_CSS_UNEXPECTED_SEMICOL",k);else return a.A=l.pop(),a.G=!0,a.b=Kf,S(h),!1;S(h);continue;case 40:l.push(k.type);S(h);continue;case 27:a.b=Kf;S(h);g.cc();a.h.length&&a.h.pop();continue;case 30:m=k.text.toLowerCase();switch(m){case "import":S(h);k=R(h);if(2==k.type||8==k.type){a.J=k.text;S(h);k=R(h);if(17==k.type||0==k.type)return a.G=
...
function gg(a,b,c,d,e){var f=L("parseStylesheet"),g=new Wf(Kf,a,b,c),h=null;e&&(h=hg(new qf(e,b),b,c));if(h=cg(g,d,h&&h.Aa()))b.Ec(h),b.La();De(function(){for(var a={};!eg(g,100,!1,!1,!1,!1);){if(g.G){var d=Aa(g.J,c);g.A&&(b.Ec(g.A),b.La());a.Ce=L("parseStylesheet.import");ig(d,b,null,null).then(function(a){return function(){g.A&&b.cc();g.G=!1;g.J=null;g.A=null;O(a.Ce,!0)}}(a));return a.Ce.result()}d=Be();if(d.Xa)return d;a={Ce:a.Ce}}return M(!1)}).then(function(){h&&b.cc();O(f,!0)});return f.result()}
...
k.fa(f.eb);if(m){if(m!==k&&b===e)for(e=[],k=0;k<g;k++)e[k]=b[k];b!==e&&(e[g-d]=m);g++;f=f.g}else f=f.f}}return f===a.b&&(c?0<e.length:g==b.length)?e:null}n=ch.prototype;n.Cb=function(a){for(var b=null,c=this.f;c!==this.b&&c!==this.g;)a?c.b?c=c.g:(b=a.fa(c.eb))?(a=null,c=c.g):c=c.f:c=c.f;return c===this.b?b:null};n.Se=function(a){return this.Cb(a)};n.Te=function(a){return this.Cb(a)};n.Ad=function(a){return this.Cb(a)};n.qc=function(a){return this.Cb(a)};n.$c=function(a){return this.Cb(a)};n.Zc=function(a){return this.Cb(a)};
n.Yc=function(a){return this.Cb(a)};n.he=function(a){return this.Cb(a)};n.ad=function(a){return this.Cb(a)};n.Ub=function(){return null};n.oc=function(){return null};n.Xb=function(a){return this.Cb(a)};n.Xc=function(){return null};function eh(a){ch.call(this,a)}v(eh,ch);eh.prototype.Ub=function(a){var b=dh(this,a.values,!1,0);return b===a.values?a:b?new Gc(b):null};
eh.prototype.oc=function(a){for(var b=this.f,c=!1;b;){if(b.eb instanceof fh){c=!0;break}b=b.f}return c?(b=dh(this,a.values,!1,0),b===a.values?a:b?new Hc(b):null):null};eh.prototype.h=function(a,b){return dh(this,a,!0,b)};function fh(a){ch.call(this,a)}v(fh,ch);fh.prototype.Ub=function(a){return this.Cb(a)};fh.prototype.oc=function(a){var b=dh(this,a.values,!1,0);return b===a.values?a:b?new Hc(b):null};fh.prototype.h=function(a,b){for(var c=this.f,d;c!==this.g;){if(d=c.eb.h(a,b))return d;c=c.f}return null};
...
function mh(a,b){a.Hc([b]);return null}n.Se=function(a){return mh(this,a)};n.Ad=function(a){return mh(this,a)};n.qc=function(a){return mh(this,a)};n.$c=function(a){return mh(this,a)};n.Zc=function(a){return mh(this,a)};n.Yc=function(a){return mh(this,a)};n.he=function(a){return mh(this,a)};n.ad=function(a){return mh(this,a)};n.Ub=function(a){this.Hc(a.values);return null};n.oc=function(){this.error=!0;return null};n.Xb=function(a){return mh(this,a)};n.Xc=function(){this.error=!0;return null};
...
qh.prototype.oc=function(a){for(var b={},c=0;c<a.values.length;c++){this.values={};if(a.values[c]instanceof Hc)this.error=!0;else{a.values[c].fa(this);for(var d=this.values,e=t(this.f),f=e.next();!f.done;f=e.next()){var f=f.value,g=d[f]||this.b.l[f],h=b[f];h||(h=[],b[f]=h);h.push(g)}this.values["background-color"]&&c!=a.values.length-1&&(this.error=!0)}if(this.error)return null}this.values={};for(var l in b)this.values[l]="background-color"==l?b[l].pop():new Hc(b[l]);return null};
...
rh.prototype.oc=function(a){a.values[0].fa(this);if(this.error)return null;for(var b=[this.values["font-family"]],c=1;c<a.values.length;c++)b.push(a.values[c]);a=new Hc(b);a.fa(this.b.g["font-family"])?this.values["font-family"]=a:this.error=!0;return null};rh.prototype.qc=function(a){if(a=this.b.f[a.name])for(var b in a)this.values[b]=a[b];else this.error=!0;return null};var sh={SIMPLE:nh,INSETS:oh,INSETS_SLASH:ph,COMMA:qh,FONT:rh};
...
aj.prototype.qc=function(a){var b=this.f,c=b.J,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.C)];b.C++;break;case "close-quote":return 0<b.C&&b.C--,c[2*Math.min(d,b.C)+1];case "no-open-quote":return b.C++,new Nc("");case "no-close-quote":return 0<b.C&&b.C--,new Nc("")}return a};
...
n.La=function(){Nj(this);Hf.prototype.La.call(this);1==this.u&&(this.u=0)};n.cc=function(){Hf.prototype.cc.call(this)};function Nj(a){if(a.b){var b=a.ba+a.l.nf();Kj(a,a.Xf(b));a.b=null;a.h=null;a.j=null;a.C=!1;a.ba=0}}n.Xf=function(a){var b=this.G;this.C&&(b=b?"xxx-bogus-xxx":"footnote");return new ki(this.mb,a,this.h,b,this.j)};n.Qb=function(a,b,c){Dh(this.A,a,b,c,this)};n.jd=function(a,b){If(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};
...
function Sl(a,b){if(a)if(b){var c=!!Ul[a],d=!!Ul[b];if(c&&d)switch(b){case "column":return a;case "region":return"column"===a?b:a;default:return b}else return d?b:c?a:Am[b]?b:Am[a]?a:b}else return a;else return b}function Bm(a){switch(a){case "left":case "right":case "recto":case "verso":return a;default:return"any"}};function Cm(){}n=Cm.prototype;n.Tf=function(a){return{w:a,Fd:!1,Vb:!1}};n.uf=function(){};n.Df=function(){};n.kg=function(){};n.Cf=function(){};n.Bd=function(){};n.sc=function(){};function Dm(a,b){this.b=a;this.f=b}
function Em(a,b){var c=a.b,d=c.Tf(b),e=L("LayoutIterator");Ee(function(b){for(var e;d.w;){e=d.w.B?1!==d.w.B.nodeType?Lk(d.w.B,d.w.tc)?void 0:d.w.K?c.Df(d):c.uf(d):d.w.ya?d.w.K?c.Cf(d):c.kg(d):d.w.K?c.sc(d):c.Bd(d):void 0;e=(e&&e.Xa()?e:M(!0)).ea(function(){return d.Vb?M(null):Fm(a.f,d.w,d.Fd)});if(e.Xa()){e.then(function(a){d.Vb?Q(b):(d.w=a,P(b))});return}if(d.Vb){Q(b);return}d.w=e.get()}Q(b)}).then(function(){O(e,d.w)});return e.result()}function Gm(a){this.fc=a}v(Gm,Cm);n=Gm.prototype;n.lg=function(){};
n.Nf=function(){};n.Tf=function(a){return{w:a,Fd:!!this.fc&&a.K,Vb:!1,fc:this.fc,cd:null,Je:!1,Wf:[],kd:null}};n.uf=function(a){a.Je=!1};n.Bd=function(a){a.Wf.push(Yk(a.w));a.cd=Sl(a.cd,a.w.g);a.Je=!0;return this.lg(a)};n.sc=function(a){var b;a.Je?(b=(b=void 0,M(!0)),b=b.ea(function(){a.Vb||(a.Wf=[],a.fc=!1,a.Fd=!1,a.cd=null);return M(!0)})):b=(b=this.Nf(a))&&b.Xa()?b:M(!0);return b.ea(function(){a.Vb||(a.Je=!1,a.kd=Yk(a.w),a.cd=Sl(a.cd,a.w.G));return M(!0)})};
function Hm(a,b,c){this.tf=[];this.za=Object.create(a);this.za.element=b;this.za.j=a.j.clone();this.za.u=!1;this.za.kf=c.D;this.za.Md=a;a=Im(this.za,c);this.za.la-=a;var d=this;this.za.Hd=function(a){return Jm.prototype.Hd.call(this,a).ea(function(a){d.tf.push(Yk(a));return M(a)})}}function Km(a,b){return Lm(a.za,b,!0)}Hm.prototype.dc=function(a){var b=this.za.dc();if(a){a=Yk(this.tf[0]);var c=new Mm(a,null,a.xa,0);c.f(this.za,0);if(!b.w)return{Db:c,w:a}}return b};
...
Jm.prototype.dc=function(){var a=null,b=null,c,d=0;do{c=d;for(var d=Number.MAX_VALUE,e=this.N.length-1;0<=e&&!b;--e){var a=this.N[e],b=a.f(this,c),f=a.b();f>c&&(d=Math.min(d,f))}}while(d>c&&!b&&this.Kb);return{Db:b?a:null,w:b}};
...
function Oo(a){for(;a;){if(a.parentNode===a.ownerDocument)return!1;a=a.parentNode}return!0}function Bp(a,b){Nm.call(this);this.fc=a;this.A=b||null;this.l=null;this.b=0;this.j=!1;this.g={Wd:null}}v(Bp,Nm);n=Bp.prototype;n.qf=function(){return new Fp(this.fc,this.A,this.g)};n.eg=function(a,b){b.A=[];b.Md||(Ip=[])};n.Jd=function(a){for(Nm.prototype.Jd.call(this,a);a;){var b=a.B;b&&xo(b.parentNode,b);a=a.parent}};n.yf=function(a,b){Nm.prototype.yf.call(this,a,b);this.l=b.g;this.b=b.h;this.j=b.Ld};
...
function tr(a,b,c,d,e,f){var g=L("createRefShadow");a.da.u.load(b).then(function(h){if(h){var l=lk(h,b);if(l){var k=a.J,m=k.N[h.url];if(!m){var m=k.style.F.f[h.url],p=new Pb(0,k.ic(),k.hc(),k.u),m=new am(h,m.g,m.f,p,k.l,m.G,new Qp(k.h,h.url),new Rp(k.h,h.url,m.f,m.b));k.N[h.url]=m}f=new Zk(d,l,h,e,f,c,m)}}O(g,f)});return g.result()}
...
Object.keys(f).forEach(function(a){var b=gs(fs(f[a]),this);this.ob[a]={width:b.ic+2*b.qe,height:b.hc+2*b.qe}},a);return b.result()}function lm(a,b,c){if(a=a.b)a.f[b.b]||(a.f[b.b]=c),c=a.b[b.b],c||(c=new ml,a.b[b.b]=c),c.b.push(new ll(new jl({pa:[{node:b.element,kb:Vk,wa:null,Ja:null,Ga:null,Sa:0}],na:0,K:!1,Qa:null}),b))}
...
function Ft(a,b,c){a.Y=b.ic;a.R=b.hc;a.Ba=b.ic+2*b.qe;a.ua=b.hc+2*b.qe;c.I.style.width=a.Ba+"px";c.I.style.height=a.ua+"px";c.h.style.left=b.$b+"px";c.h.style.right=b.$b+"px";c.h.style.top=b.$b+"px";c.h.style.bottom=b.$b+"px";c.h.style.padding=b.Zb+"px";c.h.style.paddingTop=b.Zb+1+"px"}function Gt(a,b,c,d){Jj.call(this,a.j,a,b,c,d,a.h,!c);this.g=a;this.F=!1}v(Gt,Jj);n=Gt.prototype;n.ce=function(){};
...
function du(){this.id=null;this.src="";this.h=this.j=this.g=null;this.O=-1;this.u=0;this.A=null;this.f=this.b=0;this.mc=this.wb=null;this.l=ab}function eu(a){return a.id}
...
function Zt(a,b){this.h=a;this.C=this.f=this.b=this.u=this.j=null;this.R=b;this.J=null;this.Z={};this.lang=null;this.l=0;this.F=!1;this.N=!0;this.A=null;this.g={};this.ca=this.Yb=this.lf=null;this.Y={};this.H=null;this.G=ou(this);mu()&&(Ih["http://www.w3.org/1998/Math/MathML"]=!0)}
...
function $t(a,b,c){b.readingProgression&&(a.H=b.readingProgression);void 0===a.g&&(a.g={});var d=c&&c.title||b.name||b.metadata&&b.metadata.title;d&&(a.g[iu]=[{v:d}]);var e=pu(a,a.R);!b.readingOrder&&c&&(b.readingOrder=[encodeURI(e)],(c=c.querySelector("[role=doc-toc]")||c.querySelector("[role=directory], nav, .toc, #toc"))&&Array.from(c.querySelectorAll("a[href]")).forEach(function(c){c=encodeURI(pu(a,xa(c.href)));-1==b.readingOrder.indexOf(c)&&b.readingOrder.push(c)}));var f=[],g=0,h=-1;[b.readingOrder,
b.resources].forEach(function(c){c instanceof Array&&c.forEach(function(d){var e="string"===typeof d?d:d.url||d.href,k="string"===typeof d?"":d.oh||d.href&&d.type||"";if(c===b.readingOrder||"text/html"===k||"application/xhtml+xml"===k||/(^|\/)([^/]+\.(x?html|htm|xht)|[^/.]*)([#?]|$)/.test(e))e={url:Aa(Ba(e),a.R),index:g++,wb:null,mc:null},"contents"===d.rel&&-1===h&&(h=e.index),f.push(e)})});var l=L("initWithWebPubManifest");tu(a,f).then(function(){-1!==h&&(a.Yb=a.u[h]);a.Yb||(a.Yb=a.C[e]);O(l,!0)});
return l.result()}function uu(a,b,c){var d=a.b[b],e=L("getCFI");a.h.load(d.src).then(function(a){var b=jk(a,c),f=null;b&&(a=hk(a,b,0,!1),f=new tb,wb(f,b,c-a),d.h&&wb(f,d.h,0),f=f.toString());O(e,f)});return e.result()}
...
function Au(a,b){var c=a.Hb[b.O];return c?c.Ka[b.aa]:null}n=zu.prototype;n.ec=function(a){return this.S.H?this.S.H:(a=this.Hb[a?a.O:0])?a.nb.H:null};
...
n.Oe=function(a,b){var c=a.O,d=a.aa;if(d)d--;else{if(!c)return M(null);c--;d=Number.POSITIVE_INFINITY}return Gu(this,{O:c,aa:d,Fa:-1},b)};function Ju(a,b,c){b="left"===b.b;a="ltr"===a.ec(c);return!b&&a||b&&!a}function Ku(a,b,c){var d=L("getCurrentSpread"),e=Au(a,b);if(!e)return M({left:null,right:null});var f="left"===e.b;(Ju(a,e,b)?a.Oe(b,c):a.nextPage(b,c)).then(function(c){var e=Au(a,b);(c=c&&c.page)&&c.b===e.b&&(c=null);f?O(d,{left:e,right:c}):O(d,{left:c,right:e})});return d.result()}
...
(this.viewport=null,this.$.Cc=a.pageBorder,this.Ya=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=a.zoom,this.gc=!0);"boolean"==typeof a.fitToScreen&&a.fitToScreen!==this.C&&(this.C=a.fitToScreen,this.gc=!0);"object"==typeof a.defaultPaperSize&&"number"==typeof a.defaultPaperSize.width&&"number"==typeof a.defaultPaperSize.height&&(this.viewport=null,this.$.uc=a.defaultPaperSize,this.Ya=!0);av(this,a);return M(!0)};
function av(a,b){ge("CONFIGURATION").forEach(function(c){c=c(b);a.Ya=c.Ya||a.Ya;a.gc=c.gc||a.gc})}n.Me=function(a){var b=this.g,c=this.j,d=a.target;c?c.left!==d&&c.right!==d||bv(this,a.ag):b===a.target&&bv(this,a.ag)};function cv(a,b){var c=[];a.g&&c.push(a.g);a.j&&(c.push(a.j.left),c.push(a.j.right));c.forEach(function(a){a&&b(a)})}function dv(a){cv(a,function(b){b.removeEventListener("hyperlink",a.F,!1);b.removeEventListener("replaced",a.Me,!1)})}
...
gw.prototype.Bd=function(a){var b=this.D,c=a.w,d=b.b;if(c.parent&&b.j===c.parent.M){switch(c.u){case "header":if(d.yc)c.u="none";else return Yv(d,c),M(!0);break;case "footer":if(d.xc)c.u="none";else return Zv(d,c),M(!0)}d.g||(d.g=c.M)}return Gm.prototype.Bd.call(this,a)};gw.prototype.sc=function(a){var b=this.D,c=a.w;c.M===b.j&&(b.b.J=a.kd&&a.kd.M,a.Vb=!0);return"header"===c.u||"footer"===c.u?M(!0):Gm.prototype.sc.call(this,a)};function kw(){}v(kw,Kp);
...
for(var e=d+c.rowSpan,f=Pw(b,d),g=0;f[g];)g++;for(;d<e;d++)for(var f=Pw(b,d),h=g;h<g+c.f;h++){var l=f[h]=new Dw(d,h,c);c.b||(c.b=l)}this.Ra++}}return Gm.prototype.sc.call(this,a)};n.uf=function(a){$w(this,a)};n.Df=function(a){$w(this,a)};n.kg=function(a){$w(this,a)};n.Cf=function(a){$w(this,a)};function $w(a,b){var c=b.w;c&&c.B&&!Eo(c)&&a.f.push(c.clone())}function Zw(a,b){0<a.f.length&&Jo(a.h,b.w,a.f);a.f=[]}
function ax(a,b){this.fc=!0;this.D=a;this.f=b;this.l=!1;this.b=-1;this.g=0;this.u=b.u;b.u=!1}v(ax,Gm);var bx={"table-caption":!0,"table-column-group":!0,"table-column":!0};
function cx(a,b,c,d){var e=b.rowIndex,f=b.Ra,g=c.B;if(1<b.f){x(g,"box-sizing","border-box");for(var h=a.D.J,l=0,k=0;k<b.f;k++)l+=h[b.b.Ra+k];l+=a.D.R*(b.f-1);x(g,a.D.u?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new Ew(a.f,b,c);a=a.D;(g=a.f[e])||(g=a.f[e]=[]);g[f]=c;1===d.f.pa.length&&d.f.K&&(c.f=!0);return Km(c.kc,d).Gc(!0)}function dx(a,b){var c=a.D.h[0];return c?c.ac.b.Ra===b:!1}
function ex(a){var b=a.D.h;if(!b.length)return[];var c=[],d=0;do{var e=b[d],f=e.ac.rowIndex;if(f<a.b){var g=c[f];g||(g=c[f]=[]);g.push(e);b.splice(d,1)}else d++}while(d<b.length);return c}
...
function yx(a,b){return Ax(a,b).map(function(a){return{Kd:a.yg.kc.za.A,Db:a.Db}})}function Ax(a,b){var c=Number.MAX_VALUE;a&&"table-row"===a.display&&(c=Kw(b,a.M)+1);for(var c=Math.min(b.f.length,c),d=[],e=0;e<c;e++)b.f[e]&&b.f[e].forEach(function(a){a&&d.push({yg:a,Db:a.dc().w})});return d}function ow(a,b){var c=a.w.D,d=Sw(c,b);return d?Tw(c,d):Vw(c)}n.se=function(a){return a instanceof nw?this.w.D===a.w.D:!1};var Bx=new jx;
...
n.Eg=function(a,b){if("epage"===a)this.gb.h({a:"moveTo",epage:b});else{var c;a:switch(a){case "left":c="ltr"===this.ec()?"previous":"next";break a;case "right":c="ltr"===this.ec()?"next":"previous";break a;default:c=a}this.gb.h({a:"moveTo",where:c})}};n.Dg=function(a){this.gb.h({a:"moveTo",url:a})};n.Qc=function(){return this.gb.b&&this.gb.b.S&&(this.gb.b.S.Yb||this.gb.b.S.lf)?!!this.gb.b.Qc():null};n.Tc=function(a,b){this.gb.h({a:"toc",v:null==a?"toggle":a?"show":"hide",autohide:b})};
...
Ex.prototype.getCurrentPageProgression=Ex.prototype.ec;Ex.prototype.navigateToPage=Ex.prototype.Eg;Ex.prototype.navigateToInternalUrl=Ex.prototype.Dg;Ex.prototype.isTOCVisible=Ex.prototype.Qc;Ex.prototype.showTOC=Ex.prototype.Tc;Ex.prototype.queryZoomFactor=Ex.prototype.Rg;Ex.prototype.getPageSizes=Ex.prototype.zg;na("vivliostyle.viewer.ZoomType",pv);pv.FIT_INSIDE_VIEWPORT="fit inside viewport";na("vivliostyle.viewer.PageViewMode",Ru);Ru.SINGLE_PAGE="singlePage";Ru.SPREAD="spread";
...
function Mx(a){switch(a.t){case "loaded":a=a.viewer;var b=Hx=a.ec();a.ge.setAttribute("data-vivliostyle-page-progression",b);a.ge.setAttribute("data-vivliostyle-spread-view",a.$.ub);window.addEventListener("keydown",Lx,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Jx,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Kx,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
