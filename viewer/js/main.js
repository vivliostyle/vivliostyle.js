 ...
 *
 * Vivliostyle core 2016.2.0-pre.20160318123349
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
k?l.toString():null;a.b.N=g?g.toString():null;if(!a.b.b){if(g=h["break-after"])a.b.B=g.toString();if(g=h["break-before"])a.b.j=g.toString()}if(g=h["x-first-pseudo"])a.b.d=new ii(a.b.parent?a.b.parent.d:null,g.D);if(g=h["white-space"])switch(g.toString()){case "normal":case "nowrap":a.b.w=0;break;case "pre-line":a.b.w=1;break;case "pre":case "pre-wrap":a.b.w=2}var J=!1,W=null,la=[],X=f.namespaceURI,F=f.localName;if("http://www.w3.org/1999/xhtml"==X)"html"==F||"body"==F||"script"==F||"link"==F||"meta"==
...
new te(p,(a.b?-1:1)*a.Fa,q,(a.b?-1:1)*a.$a);q=m;a.b&&(q=Le(m));Qe(p,a.eb,q,e);a.b&&(m=new te(-q.P,q.X,-q.V,q.U));w(d,"left",m.X-(a.b?a.$a:a.La)+a.j+"px");w(d,"top",m.V-(a.b?a.La:a.Fa)+a.k+"px");m=a.b?m.X:m.P;Bm(a,m)&&0!=a.w.length?(b=b.modify(),b.e=!0,O(c,b)):(Km(a),p=a.b?Le(a.h):a.h,a.b?q=Le(Am(a,new te(-q.P,q.X,-q.V,q.U))):q=Am(a,q),Re(p,a.eb,q,e),Lm(a),"left"==e?a.yc=m:a.zc=m,Ym(a,m),O(c,l))}});return N(c)}
...
function gn(a,b,c){var d=L("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,k=a.w.length-1;0<=k&&!e;--k){var e=a.w[k].d(a,f),h=a.w[k].b();h>f&&(g=Math.min(g,h))}while(g>f&&!e);var l=!1;if(!e){v.b("Could not find any page breaks?!!");if(a.qd)return hn(a,b).then(function(b){b?(b=b.modify(),b.e=!1,cn(a,b,l,!0).then(function(){O(d,b)})):O(d,b)}),N(d);e=c;l=!0}cn(a,e,l,!0).then(function(){O(d,e)});return N(d)}
...
function Hm(a,b){return"footnote"==b.h?Wm(a,b):Xm(a,b)}function nn(a,b,c){var d=L("layoutNext");mn(a,b,c).then(function(c){b=c;if(!b||a.N||b.e)O(d,b);else if(b.h)Hm(a,b).ra(d);else{a:if(b.L)c=!0;else{switch(b.Y.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!b.C}c?en(a,b).ra(d):Im(a,b).ra(d)}});return N(d)}
...
function Vm(a,b){a.vb.push(b);if(a.ad)return M(b);var c=L("layout");on(a,b).then(function(){Dm(a,b.Sa).then(function(b){var e=b,f=!0;a.w=[];sf(function(c){for(;b;){var k=!0;nn(a,b,f).then(function(h){f=!1;b=h;0<a.g.f.b.length?P(c):a.N?P(c):b&&b.e?gn(a,b,e).then(function(a){b=a;P(c)}):k?k=!1:uf(c)});if(k){k=!1;return}}P(c)}).then(function(){var e=a.l;e&&(a.d.appendChild(e.d),a.b?a.e=this.Fa-this.$a:a.e=e.top+ui(e)+e.e+vi(e));if(b)if(0<a.g.f.b.length)O(c,null);else{a.ad=!0;e=new pi(oi(b));if(a.f){for(var f=
