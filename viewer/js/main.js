 ...
 *
 * Vivliostyle core 2016.2.0-pre.20160325053352
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
Jg.prototype.nb=function(a){for(var b=this.d,c=!1;b;){if(b.d instanceof Kg){c=!0;break}b=b.f}return c?(b=Ig(this,a.values,!1,0),b===a.values?a:b?new kd(b):null):null};Jg.prototype.f=function(a,b){return Ig(this,a,!0,b)};function Kg(a){Hg.call(this,a)}u(Kg,Hg);Kg.prototype.Za=function(a){return this.Qa(a)};Kg.prototype.nb=function(a){var b=Ig(this,a.values,!1,0);return b===a.values?a:b?new kd(b):null};function Lg(a,b){Hg.call(this,b);this.name=a}u(Lg,Hg);Lg.prototype.Qa=function(){return null};
Lg.prototype.ub=function(a){if(a.name.toLowerCase()!=this.name)return null;var b=Ig(this,a.values,!1,0);return b===a.values?a:b?new ld(a.name,b):null};function Mg(){}Mg.prototype.b=function(a,b){return b};Mg.prototype.e=function(){};function Ng(a,b){this.name=b;this.f=a.e[this.name]}u(Ng,Mg);Ng.prototype.b=function(a,b,c){if(c.values[this.name])return b;if(a=this.f.f(a,b)){var d=a.length;this.e(1<d?new jd(a):a[0],c);return b+d}return b};Ng.prototype.e=function(a,b){b.values[this.name]=a};
function Og(a,b){Ng.call(this,a,b[0]);this.d=b}u(Og,Ng);Og.prototype.e=function(a,b){for(var c=0;c<this.d.length;c++)b.values[this.d[c]]=a};function Pg(a,b){this.d=a;this.md=b}u(Pg,Mg);Pg.prototype.b=function(a,b,c){var d=b;if(this.md)if(a[b]==pd){if(++b==a.length)return d}else return d;var e=this.d[0].b(a,b,c);if(e==b)return d;b=e;for(d=1;d<this.d.length&&b<a.length;d++){e=this.d[d].b(a,b,c);if(e==b)break;b=e}return b};function Qg(){this.b=this.Oa=null;this.error=!1;this.values={};this.d=null}
n=Qg.prototype;n.clone=function(){var a=new this.constructor;a.Oa=this.Oa;a.b=this.b;a.d=this.d;return a};n.bd=function(a,b){this.Oa=a;this.b=b};n.wb=function(){this.error=!0;return 0};function Rg(a,b){a.wb([b]);return null}n.Yc=function(a){return Rg(this,a)};n.Xb=function(a){return Rg(this,a)};n.ob=function(a){return Rg(this,a)};n.Ib=function(a){return Rg(this,a)};n.Hb=function(a){return Rg(this,a)};n.Gb=function(a){return Rg(this,a)};n.vc=function(a){return Rg(this,a)};
n.Yb=function(a){return Rg(this,a)};n.Za=function(a){this.wb(a.values);return null};n.nb=function(){this.error=!0;return null};n.ub=function(a){return Rg(this,a)};n.Fb=function(){this.error=!0;return null};function Sg(){Qg.call(this)}u(Sg,Qg);Sg.prototype.wb=function(a){for(var b=0,c=0;b<a.length;){var d=this.Oa[c].b(a,b,this);if(d>b)b=d,c=0;else if(++c==this.Oa.length){this.error=!0;break}}return b};function Tg(){Qg.call(this)}u(Tg,Qg);
Tg.prototype.wb=function(a){if(a.length>this.Oa.length||0==a.length)return this.error=!0,0;for(var b=0;b<this.Oa.length;b++){for(var c=b;c>=a.length;)c=1==c?0:c-2;if(this.Oa[b].b(a,c,this)!=c+1)return this.error=!0,0}return a.length};function Ug(){Qg.call(this)}u(Ug,Qg);
Ug.prototype.wb=function(a){for(var b=a.length,c=0;c<a.length;c++)if(a[c]===pd){b=c;break}if(b>this.Oa.length||0==a.length)return this.error=!0,0;for(c=0;c<this.Oa.length;c++){for(var d=c;d>=b;)d=1==d?0:d-2;var e;if(b+1<a.length)for(e=b+c+1;e>=a.length;)e-=e==b+2?1:2;else e=d;if(2!=this.Oa[c].b([a[d],a[e]],0,this))return this.error=!0,0}return a.length};function Vg(){Qg.call(this)}u(Vg,Sg);
Vg.prototype.nb=function(a){for(var b={},c=0;c<a.values.length;c++){this.values={};if(a.values[c]instanceof kd)this.error=!0;else{a.values[c].T(this);for(var d=b,e=this.values,f=0;f<this.b.length;f++){var g=this.b[f],k=e[g]||this.d.h[g],h=d[g];h||(h=[],d[g]=h);h.push(k)}this.values["background-color"]&&c!=a.values.length-1&&(this.error=!0)}if(this.error)return null}this.values={};for(var l in b)this.values[l]="background-color"==l?b[l].pop():new kd(b[l]);return null};function Wg(){Qg.call(this)}
u(Wg,Sg);Wg.prototype.bd=function(a,b){Sg.prototype.bd.call(this,a,b);this.b.push("font-family","line-height","font-size")};
...
function Yg(){this.e={};this.k={};this.h={};this.b={};this.d={};this.f={};this.j=[];this.g=[]}function Zg(a,b){var c;if(3==b.type)c=new I(b.D,b.text);else if(7==b.type)c=Df(b.text);else if(1==b.type)c=H(b.text);else throw Error("unexpected replacement");if(Dg(a)){var d=a.b[0].d.d,e;for(e in d)d[e]=c;return a}throw Error("unexpected replacement");}
...
if(5!=g.type)throw Error("<int> expected");q=g.D;A(b);g=x(b)}if(13!=g.type)throw Error("'}' expected");d.push($g(d.pop(),p,q));break;case 17:m=h();if(0<e.length)throw Error("unclosed '"+e.pop().Bc+"'");break;default:throw Error("unexpected token");}A(b);dh(c)?a.b[c]=m:a.e[c]=1!=m.b.length||0!=m.b[0].b?new Jg(m):m.b[0].d}}
...
c[0]}for(;;){var h=eh(d,f,3);if(!h)break;var l=z(f,1),m;1==l.type&&Xg[l.text]?(m=new Xg[l.text],A(f)):m=new Sg;m.d=d;g=!1;k=[];c=!1;for(var p=[],q=[];!g;)switch(A(f),l=x(f),l.type){case 1:if(d.e[l.text])k.push(new Ng(m.d,l.text)),q.push(l.text);else if(d.f[l.text]instanceof Tg){var t=d.f[l.text];k.push(new Og(t.d,t.b));q.push.apply(q,t.b)}else throw Error("'"+l.text+"' is neither a simple property nor an inset shorthand");break;case 19:if(0<k.length||c)throw Error("unexpected slash");c=!0;break;case 14:p.push({md:c,
...
function Zh(a,b){this.e={};this.M=a;this.b=b;this.w=null;this.h=[];var c=this;this.C=function(a){var b=a.currentTarget,f=b.getAttribute("href")||b.getAttributeNS("http://www.w3.org/1999/xlink","href");f&&(a.preventDefault(),fb(c,{type:"hyperlink",target:null,currentTarget:null,je:b,href:f}))};this.j={};this.d={width:0,height:0};this.l=this.k=!1;this.G=0;this.position=null;this.offset=-1;this.g=null;this.f=[];this.u={top:{},bottom:{},left:{},right:{}}}u(Zh,eb);
...
function Rj(a){if(9999<a||-9999>a)return""+a;if(0==a)return Qj.Jb.charAt(0);var b=new Qa;0>a&&(b.append(Qj.Md),a=-a);if(10>a)b.append(Qj.Jb.charAt(a));else if(Qj.me&&19>=a)b.append(Qj.ic.charAt(0)),0!=a&&b.append(Qj.ic.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(Qj.Jb.charAt(c)),b.append(Qj.ic.charAt(2)));if(c=Math.floor(a/100)%10)b.append(Qj.Jb.charAt(c)),b.append(Qj.ic.charAt(1));if(c=Math.floor(a/10)%10)b.append(Qj.Jb.charAt(c)),b.append(Qj.ic.charAt(0));(a%=10)&&b.append(Qj.Jb.charAt(a))}return b.toString()}
...
"1"))}}function $m(a,b,c,d){var e=L("processLineStyling");ym(d);var f=d.concat([]);d.splice(0,d.length);var g=0,k=b.d;0==k.count&&(k=k.Pd);sf(function(d){if(k){var e=an(a,f),m=k.count-g;if(e.length<=m)P(d);else{var p=bn(a,f,e[m-1]);cn(a,p,!1,!1).then(function(){g+=m;km(a.g,p,0).then(function(e){b=e;Zm(b,!1);k=b.d;f=[];Gm(a,b,f).then(function(b){c=b;0<a.g.f.b.length?P(d):uf(d)})})})}}else P(d)}).then(function(){Array.prototype.push.apply(d,f);ym(d);O(e,c)});return N(e)}
...
function Co(a,b,c){var d=a.b.b[c];if(!d)return M(!0);Sm(b);a.e[c]&&0<b.eb.length&&(b.qd=!1);var e=L("layoutColumn"),f=[],g=[];sf(function(c){for(;0<d.b.length-g.length;){for(var e=0;0<=g.indexOf(e);)e++;var l=d.b[e];if(l.b.b>a.j)break;for(var m=1;m<d.b.length;m++)if(!(0<=g.indexOf(m))){var p=d.b[m];if(p.b.b>a.j)break;ei(p.b,l.b)&&(l=p,e=m)}var q=l.b,t=!0;Vm(b,l.d).then(function(a){l.b.Rd&&(null===a||q.d)&&f.push(e);q.d?(g.push(e),P(c)):a?(l.d=a,P(c)):(g.push(e),t?t=!1:uf(c))});if(t){t=!1;return}}P(c)}).then(function(){d.b=
...
h.name,h.value.toString());for(d=0;d<f.length;d++)if(g=f[d],k=b.j[g.Sb],h=b.j[g.Od],k&&h&&(k=Yh(k,g.action)))for(var y=0;y<h.length;y++)h[y].addEventListener(g.event,k,!1);var J;a:{for(J in a.e)if((f=c.b[J])&&0<f.b.length){J=!1;break a}J=!0}J&&(c=null);O(l,c)});return N(l)}
...
ba("vivliostyle.viewer.Viewer",Wp);Wp.prototype.setOptions=Wp.prototype.Bd;Wp.prototype.addListener=Wp.prototype.Sd;Wp.prototype.removeListener=Wp.prototype.Vd;Wp.prototype.loadDocument=Wp.prototype.Jd;Wp.prototype.loadEPUB=Wp.prototype.Td;Wp.prototype.getCurrentPageProgression=Wp.prototype.hb;Wp.prototype.navigateToPage=Wp.prototype.Ld;Wp.prototype.navigateToInternalUrl=Wp.prototype.Kd;Wp.prototype.queryZoomFactor=Wp.prototype.Ud;ba("vivliostyle.viewer.ZoomType",Rp);Rp.FIT_INSIDE_VIEWPORT="fit inside viewport";
