 ...
 *
 * Vivliostyle core 2019.1.103-pre.20190305085806
 */
(function(factory) {
...
"true");a.setAttribute("hidden","hidden")});for(var b=a.firstElementChild.firstElementChild;b&&b.nextElementSibling;)b.nextElementSibling.remove();Ut(f,a,2);O(g,h)})})});return g.result()};Tt.prototype.Td=function(){this.page&&(this.page.I.style.visibility="hidden",this.page.I.setAttribute("aria-hidden","true"))};Tt.prototype.Rc=function(){return!!this.page&&"visible"===this.page.I.style.visibility};function Wt(){Mt.call(this,Xt(this));this.u=new yf(qk,"document");this.l=new yf(Af,"text");this.G={};this.la={};this.C={};this.F={}}v(Wt,Mt);function Xt(a){return function(b){return a.C[b]}}
