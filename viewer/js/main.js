 ...
 *
 * Vivliostyle core 2016.4.1-pre.20160614052510
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function qk(a,b){var c=b[0].toString(),d=1<b.length?b[1].stringValue():"decimal",e=a.d.h[c];if(e&&e.length)return new id(pk(e&&e.length&&e[e.length-1]||0,d));c=new J(rk(a.b,c,function(a){return pk(a||0,d)}));return new bd([c])}
function sk(a,b){var c=b[0].toString(),d=b[1].stringValue(),e=2<b.length?b[2].stringValue():"decimal",f=a.d.h[c],g=new Ia;if(f&&f.length)for(var h=0;h<f.length;h++)0<h&&g.append(d),g.append(pk(f[h],e));c=new J(tk(a.b,c,function(a){var b=[];if(a.length)for(var c=0;c<a.length;c++)b.push(pk(a[c],e));a=g.toString();a.length&&b.push(a);return b.length?b.join(d):pk(0,e)}));return new bd([c])}
...
function Ck(a,b,c){(b=b[c])&&b.apply(a)}var Dk=[];function Ek(a,b,c,d){a.b=null;a.u=d;a.e="";a.d="";a.O="";a.ba="";a.w=b;a.oa="";a.H=Dk;a.S=c;Fk(a)}function Gk(a,b,c){a.h[b]?a.h[b].push(c):a.h[b]=[c];c=a.B[a.B.length-1];c||(c={},a.B[a.B.length-1]=c);c[b]=!0}
function Hk(a,b){var c=Id,d=b.display;d&&(c=d.evaluate(a.g));var e=null,d=null,f=b["counter-reset"];f&&(f=f.evaluate(a.g))&&(e=qg(f,!0));(f=b["counter-increment"])&&(f=f.evaluate(a.g))&&(d=qg(f,!1));"ol"!=a.d&&"ul"!=a.d||"http://www.w3.org/1999/xhtml"!=a.e||(e||(e={}),e["ua-list-item"]=0);c===Od&&(d||(d={}),d["ua-list-item"]=1);if(e)for(var g in e)Gk(a,g,e[g]);if(d)for(var h in d)a.h[h]||Gk(a,h,0),g=a.h[h],g[g.length-1]+=d[h];c===Od&&(c=a.h["ua-list-item"],b["ua-list-item-count"]=new V(new kd(c[c.length-
1]),0));a.B.push(null)}function Ik(a){var b=a.B.pop();if(b)for(var c in b)(b=a.h[c])&&(1==b.length?delete a.h[c]:b.pop())}function ek(a,b){Hk(a,b);b.content&&(b.content=b.content.rc(new jk(a,0,a.Ya)));Ik(a)}var Jk="before transclusion-before footnote-call footnote-marker inner first-letter first-line  transclusion-after after".split(" ");
...
"lang"))||"http://www.w3.org/1999/xhtml"!=a.e||(d=b.getAttribute("lang"));d&&(a.f[a.f.length-1].push(new fk(a.lang)),a.lang=d.toLowerCase());var d=a.ma,e=a.yb;a.za=++e[e.length-1];e.push(0);var e=a.ka,f=a.$a=e[e.length-1],g=f[a.e];g||(g=f[a.e]={});g[a.d]=(g[a.d]||0)+1;e.push({});e=a.wb;null!==e[e.length-1]?a.I=--e[e.length-1]:a.I=null;e.push(null);e=a.xb;(f=a.Za=e[e.length-1])&&f[a.e]&&f[a.e][a.d]--;e.push({});Fk(a);Lk(a,b);c=c.quotes;b=null;c&&(c=c.evaluate(a.g))&&(b=new gk(a.D),c===Qd?a.D=[new id(""),
new id("")]:c instanceof bd&&(a.D=c.values));Hk(a,a.u);c=a.O||a.ba||"";if(d||c){var h={};Object.keys(a.h).forEach(function(a){h[a]=Array.b(this.h[a])},a);Mk(a.Eb,c,h)}if(c=a.u._pseudos)for(d=!0,e=0;e<Jk.length;e++)(f=Jk[e])||(d=!1),(f=c[f])&&(d?ek(a,f):a.f[a.f.length-2].push(new dk(f)));b&&a.f[a.f.length-2].push(b)}function Nk(a,b){for(var c in b)lj(c)&&(b[c]=b[c].rc(a))}function Lk(a,b){var c=new hk(b),d=a.u,e=d._pseudos,f;for(f in e)Nk(c,e[f]);Nk(c,d)}
...
!1}this.ba.push(!0);this.I={};this.I["e"+a]=d;this.b++;wl(this,-1)}function xl(a,b,c,d){return(b=b[d])&&b.evaluate(a.f)!==c[d]}function zl(a,b,c){for(var d in c){var e=b[d];e?(a.H[d]=e,delete b[d]):(e=c[d])&&(a.H[d]=new V(e,33554432))}}var Cl=["column-count","column-width"];
function vl(a,b,c){c||["writing-mode","direction"].forEach(function(a){b[a]&&(this.H[a]=b[a])},a);if(!a.ka){var d=xl(a,b,a.j.g,"background-color")?b["background-color"].evaluate(a.f):null,e=xl(a,b,a.j.g,"background-image")?b["background-image"].evaluate(a.f):null;if(d&&d!==Hd||e&&e!==Hd)zl(a,b,a.j.g),a.ka=!0}if(!a.ma)for(d=0;d<Cl.length;d++)if(xl(a,b,a.j.j,Cl[d])){zl(a,b,a.j.j);a.ma=!0;break}if(!c&&(c=b["font-size"])){d=c.evaluate(a.f);c=d.C;switch(d.ha){case "em":case "rem":c*=a.f.j;break;case "ex":case "rex":c*=
...
function up(a){this.b=null;this.f=a}u(up,W);up.prototype.apply=function(a){a.S===this.f&&this.b.apply(a)};up.prototype.d=function(){return 3};up.prototype.e=function(a){this.b&&yj(a.Yb,this.f,this.b);return!0};function vp(a){this.b=null;this.f=a}u(vp,W);vp.prototype.apply=function(a){1===(new Qc(this.f,"page-number")).evaluate(a.g)&&this.b.apply(a)};vp.prototype.d=function(){return 2};function wp(a){this.b=null;this.f=a}u(wp,W);
wp.prototype.apply=function(a){(new Qc(this.f,"left-page")).evaluate(a.g)&&this.b.apply(a)};wp.prototype.d=function(){return 1};function xp(a){this.b=null;this.f=a}u(xp,W);xp.prototype.apply=function(a){(new Qc(this.f,"right-page")).evaluate(a.g)&&this.b.apply(a)};xp.prototype.d=function(){return 1};function yp(a){this.b=null;this.f=a}u(yp,W);yp.prototype.apply=function(a){(new Qc(this.f,"recto-page")).evaluate(a.g)&&this.b.apply(a)};yp.prototype.d=function(){return 1};
function zp(a){this.b=null;this.f=a}u(zp,W);zp.prototype.apply=function(a){(new Qc(this.f,"verso-page")).evaluate(a.g)&&this.b.apply(a)};zp.prototype.d=function(){return 1};function Ap(a,b){wj.call(this,a,b,null,null)}u(Ap,wj);Ap.prototype.apply=function(a){var b=a.g,c=a.u,d=this.style;a=this.P;pj(b,c,d,a,null,null);if(d=d._marginBoxes){var c=nj(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);pj(b,f,d[e],a,null,null)}}};
...
R=l.toString(),Q=Y(c,a,"column-count"),sa=Y(c,a,"column-gap"),Fa=1<Q?Y(c,a,"column-width"):q.width,l=gm(c,a),ia=0,t=hm(c,a,"shape-inside"),F=og(t,0,0,q.width,q.height,a),T=new Mm(R,a,a.viewport,a.d,l,a.Z,a.h,a.style.u,a,b,a.Sa,a.Za,h,a.Ya),yl=new mo(a.f,a.b.page-1),$h=0,ca=null;nf(function(b){for(;$h<Q;){var c=$h++;if(1<Q){var d=a.viewport.b.createElement("div");w(d,"position","absolute");r.appendChild(d);ca=new wn(d,T,a.e,yl);ca.b=q.b;ca.$a=q.$a;ca.kc=q.kc;q.b?(w(d,"margin-left",q.j+"px"),w(d,"margin-right",
q.w+"px"),c=c*(Fa+sa)+q.k,Hi(ca,0,q.width),Gi(ca,c,Fa)):(w(d,"margin-top",q.k+"px"),w(d,"margin-bottom",q.u+"px"),c=c*(Fa+sa)+q.j,Gi(ca,0,q.height),Hi(ca,c,Fa));ca.D=e+q.j;ca.H=f+q.k}else ca=new wn(r,T,a.e,yl),Fi(ca,q),q=ca;ca.I=p?[]:g;ca.xb=F;if(0<=ca.width){var k=K("inner");Op(a,ca,R).then(function(){ca.h&&"column"!=ca.h&&($h=Q,"region"!=ca.h&&(a.I[R]=!0));N(k,!0)});c=M(k)}else c=L(!0);if(c.Ca()){c.then(function(){0<h.b.length?O(b):(ia=Math.max(ia,ca.e),pf(b))});return}0<h.b.length||(ia=Math.max(ia,
ca.e))}O(b)}).then(function(){q.e=ia;c.sc(a,q,b,ca,Q,a.e,a.h);N(x,!0)});l=M(x)}else{l=hm(c,a,"content");t=!1;if(l&&Ji(l)){var Al=a.viewport.b.createElement("span");l.U(new Ii(Al,a));r.appendChild(Al);um(c,a,q,a.h)}else c.oa&&(d.removeChild(r),t=!0);t||c.sc(a,q,b,null,1,a.e,a.h);l=L(!0)}l.then(function(){if(!c.f||0<Math.floor(q.e)){if(!m){var l=q.D+q.left,p=q.H+q.top,t=Di(q)+q.width+Ei(q),x=Bi(q)+q.height+Ci(q),F=hm(c,a,"shape-outside"),l=og(F,l,p,t,x,a);$a(a.viewport.root)&&g.push(we(l,0,-1.25*nc(a,
