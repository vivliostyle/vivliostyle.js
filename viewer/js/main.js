...
if(!c)throw Error("E_CFI_NUMBER_EXPECTED");e+=c[0].length;g=parseInt(c[1],10);(h=c[4])&&(h=Ya(h));var k=c[7];k&&(k=Ya(k));c=Za(c[10]);f.push(new bb(g,h,k,ia(c.s)));break;case "!":e++;f.push(new $a);break;case "~":case "@":case "":a.ha=f;return;default:throw Error("E_CFI_PARSE_ERROR");}}function eb(a,b){for(var c={ea:b.documentElement,offset:0,K:!1,Qa:null,Ib:null},d=0;d<a.ha.length;d++)if(!a.ha[d].f(c)){++d<a.ha.length&&(c.Ib=new cb,c.Ib.ha=a.ha.slice(d));break}return c}
...
e}return!1}function B(a){this.b=a;this.f="_"+Yb++}m=B.prototype;m.toString=function(){var a=new Aa;this.ja(a,0);return a.toString()};m.ja=function(){throw Error("F_ABSTRACT");};m.Fa=function(){throw Error("F_ABSTRACT");};m.Aa=function(){return this};m.pb=function(a){return a===this};function lc(a,b,c,d){var e=d[a.f];if(null!=e)return e===Tb?!1:e;d[a.f]=Tb;b=a.pb(b,c,d);return d[a.f]=b}
m.evaluate=function(a){var b;b=(b=a.A[this.b.j])?b[this.f]:void 0;if("undefined"!=typeof b)return b;b=this.Fa(a);var c=this.f,d=this.b,e=a.A[d.j];e||(e={},a.A[d.j]=e);return e[c]=b};m.ld=function(){return!1};function mc(a,b){B.call(this,a);this.d=b}t(mc,B);m=mc.prototype;m.Tc=function(){throw Error("F_ABSTRACT");};m.Uc=function(){throw Error("F_ABSTRACT");};m.Fa=function(a){a=this.d.evaluate(a);return this.Uc(a)};m.pb=function(a,b,c){return a===this||lc(this.d,a,b,c)};
m.ja=function(a,b){10<b&&a.append("(");a.append(this.Tc());this.d.ja(a,10);10<b&&a.append(")")};m.Aa=function(a,b){var c=this.d.Aa(a,b);return c===this.d?this:new this.constructor(this.b,c)};function C(a,b,c){B.call(this,a);this.d=b;this.e=c}t(C,B);m=C.prototype;m.Sb=function(){throw Error("F_ABSTRACT");};m.za=function(){throw Error("F_ABSTRACT");};m.Oa=function(){throw Error("F_ABSTRACT");};m.Fa=function(a){var b=this.d.evaluate(a);a=this.e.evaluate(a);return this.Oa(b,a)};
m.pb=function(a,b,c){return a===this||lc(this.d,a,b,c)||lc(this.e,a,b,c)};m.ja=function(a,b){var c=this.Sb();c<=b&&a.append("(");this.d.ja(a,c);a.append(this.za());this.e.ja(a,c);c<=b&&a.append(")")};m.Aa=function(a,b){var c=this.d.Aa(a,b),d=this.e.Aa(a,b);return c===this.d&&d===this.e?this:new this.constructor(this.b,c,d)};function nc(a,b,c){C.call(this,a,b,c)}t(nc,C);nc.prototype.Sb=function(){return 1};function oc(a,b,c){C.call(this,a,b,c)}t(oc,C);oc.prototype.Sb=function(){return 2};
function pc(a,b,c){C.call(this,a,b,c)}t(pc,C);pc.prototype.Sb=function(){return 3};function qc(a,b,c){C.call(this,a,b,c)}t(qc,C);qc.prototype.Sb=function(){return 4};function rc(a,b){mc.call(this,a,b)}t(rc,mc);rc.prototype.Tc=function(){return"!"};rc.prototype.Uc=function(a){return!a};function sc(a,b){mc.call(this,a,b)}t(sc,mc);sc.prototype.Tc=function(){return"-"};sc.prototype.Uc=function(a){return-a};function tc(a,b,c){C.call(this,a,b,c)}t(tc,nc);tc.prototype.za=function(){return"&&"};
...
Lc.prototype.pb=function(a,b,c){if(a===this)return!0;for(var d=0;d<this.d.length;d++)if(lc(this.d[d],a,b,c))return!0;return lc(jc(b,this.b,this.e,this.d,!0),a,b,c)};Lc.prototype.Aa=function(a,b){for(var c,d=c=this.d,e=0;e<c.length;e++){var f=c[e].Aa(a,b);if(c!==d)d[e]=f;else if(f!==c[e]){for(var d=Array(c.length),g=0;g<e;g++)d[g]=c[g];d[e]=f}}c=d;return c===this.d?this:new Lc(this.b,this.e,c)};function Mc(a,b,c,d){B.call(this,a);this.d=b;this.g=c;this.e=d}t(Mc,B);
Mc.prototype.ja=function(a,b){0<b&&a.append("(");this.d.ja(a,0);a.append("?");this.g.ja(a,0);a.append(":");this.e.ja(a,0);0<b&&a.append(")")};Mc.prototype.Fa=function(a){return this.d.evaluate(a)?this.g.evaluate(a):this.e.evaluate(a)};Mc.prototype.pb=function(a,b,c){return a===this||lc(this.d,a,b,c)||lc(this.g,a,b,c)||lc(this.e,a,b,c)};Mc.prototype.Aa=function(a,b){var c=this.d.Aa(a,b),d=this.g.Aa(a,b),e=this.e.Aa(a,b);return c===this.d&&d===this.g&&e===this.e?this:new Mc(this.b,c,d,e)};
...
Nc.prototype.Fa=function(a){return kc(a,this.name.name,this.value)};Nc.prototype.pb=function(a,b,c){return a===this||lc(this.value,a,b,c)};Nc.prototype.Aa=function(a,b){var c=this.value.Aa(a,b);return c===this.value?this:new Nc(this.b,this.name,c)};function Oc(a,b){B.call(this,a);this.d=b}t(Oc,B);Oc.prototype.ja=function(a){a.append("$");a.append(this.d.toString())};Oc.prototype.Aa=function(a,b){var c=b[this.d];if(!c)throw Error("Parameter missing: "+this.d);return c};
function Pc(a,b,c){return b===a.f||b===a.b||c==a.f||c==a.b?a.f:b===a.g||b===a.d?c:c===a.g||c===a.d?b:new tc(a,b,c)}function D(a,b,c){return b===a.b?c:c===a.b?b:new Dc(a,b,c)}function E(a,b,c){return b===a.b?new sc(a,c):c===a.b?b:new Ec(a,b,c)}function Qc(a,b,c){return b===a.b||c===a.b?a.b:b===a.d?c:c===a.d?b:new Fc(a,b,c)}function Rc(a,b,c){return b===a.b?a.b:c===a.d?b:new Gc(a,b,c)};var Sc={};function Tc(){}m=Tc.prototype;m.ab=function(a){for(var b=0;b<a.length;b++)a[b].P(this)};m.Nc=function(){throw Error("E_CSS_EMPTY_NOT_ALLOWED");};m.Oc=function(){throw Error("E_CSS_SLASH_NOT_ALLOWED");};m.Nb=function(){throw Error("E_CSS_STR_NOT_ALLOWED");};m.jb=function(){throw Error("E_CSS_IDENT_NOT_ALLOWED");};m.zb=function(){throw Error("E_CSS_NUMERIC_NOT_ALLOWED");};m.yb=function(){throw Error("E_CSS_NUM_NOT_ALLOWED");};m.xb=function(a){return this.yb(a)};
...
m.ab=function(a){for(var b=null,c=0;c<a.length;c++){var d=a[c],e=d.P(this);if(b)b[c]=e;else if(d!==e){b=Array(a.length);for(d=0;d<c;d++)b[d]=a[d];b[c]=e}}return b||a};m.Nb=function(a){return a};m.jb=function(a){return a};m.Oc=function(a){return a};m.zb=function(a){return a};m.yb=function(a){return a};m.xb=function(a){return a};m.kc=function(a){return a};m.Ab=function(a){return a};m.Ra=function(a){var b=this.ab(a.values);return b===a.values?a:new Vc(b)};
m.hb=function(a){var b=this.ab(a.values);return b===a.values?a:new Wc(b)};m.ib=function(a){var b=this.ab(a.values);return b===a.values?a:new Xc(a.name,b)};m.wb=function(a){return a};function Yc(){}m=Yc.prototype;m.toString=function(){var a=new Aa;this.va(a,!0);return a.toString()};m.stringValue=function(){var a=new Aa;this.va(a,!1);return a.toString()};m.ia=function(){throw Error("F_ABSTRACT");};m.va=function(a){a.append("[error]")};m.Vc=function(){return!1};m.Xc=function(){return!1};m.Wc=function(){return!1};
m.kd=function(){return!1};m.md=function(){return!1};function Zc(){if(G)throw Error("E_INVALID_CALL");}t(Zc,Yc);Zc.prototype.ia=function(a){return new $b(a,"")};Zc.prototype.va=function(){};Zc.prototype.P=function(a){return a.Nc(this)};var G=new Zc;function $c(){if(ad)throw Error("E_INVALID_CALL");}t($c,Yc);$c.prototype.ia=function(a){return new $b(a,"/")};$c.prototype.va=function(a){a.append("/")};$c.prototype.P=function(a){return a.Oc(this)};var ad=new $c;function bd(a){this.d=a}t(bd,Yc);
bd.prototype.ia=function(a){return new $b(a,this.d)};bd.prototype.va=function(a,b){b?(a.append('"'),a.append(Da(this.d)),a.append('"')):a.append(this.d)};bd.prototype.P=function(a){return a.Nb(this)};function cd(a){this.name=a;if(Sc[a])throw Error("E_INVALID_CALL");Sc[a]=this}t(cd,Yc);cd.prototype.ia=function(a){return new $b(a,this.name)};cd.prototype.va=function(a,b){b?a.append(Ca(this.name)):a.append(this.name)};cd.prototype.P=function(a){return a.jb(this)};cd.prototype.kd=function(){return!0};
...
Wc.prototype.P=function(a){return a.hb(this)};function Xc(a,b){this.name=a;this.values=b}t(Xc,Yc);Xc.prototype.va=function(a,b){a.append(Ca(this.name));a.append("(");hd(a,this.values,",",b);a.append(")")};Xc.prototype.P=function(a){return a.ib(this)};function K(a){this.e=a}t(K,Yc);K.prototype.ia=function(){return this.e};K.prototype.va=function(a){a.append("-epubx-expr(");this.e.ja(a,0);a.append(")")};K.prototype.P=function(a){return a.wb(this)};K.prototype.Vc=function(){return!0};
function id(a,b){if(a){if(a.Xc())return hc(b,a.b)*a.C;if(a.Wc())return a.C}return 0}
...
function Le(a,b,c){var d=b.frameTrace;if(!d){for(var d=b.stack?b.stack+"\n\t---- async ---\n":"",e=a.top;e;e=e.parent)d+="\t",d+=e.name,d+="\n";b.frameTrace=d}if(c){for(d=a.top;d&&d!=c;)d=d.parent;d==c&&(a.top=d)}for(a.b=b;a.top&&!a.top.g;)a.top=a.top.parent;a.top?(b=a.b,a.b=null,a.top.g(a.top,b)):a.b&&Qe("Unhandled exception in task "+a.name,a.b)}function Je(a){this.value=a}m=Je.prototype;m.then=function(a){a(this.value)};m.ic=function(a){return a(this.value)};m.bd=function(a){return new Je(a)};
m.oa=function(a){O(a,this.value)};m.xa=function(){return!1};m.Tb=function(){return this.value};function Ye(a){this.b=a}m=Ye.prototype;m.then=function(a){this.b.then(a)};m.ic=function(a){if(this.xa()){var b=new He(this.b.d,this.b.parent,"AsyncResult.thenAsync");b.b=Ie;this.b.parent=b;this.b.then(function(c){a(c).then(function(a){O(b,a)})});return N(b)}return a(this.b.e)};m.bd=function(a){return this.xa()?this.ic(function(){return new Je(a)}):new Je(a)};
m.oa=function(a){this.xa()?this.then(function(b){O(a,b)}):O(a,this.b.e)};m.xa=function(){return this.b.b==Ie};m.Tb=function(){if(this.xa())throw Error("Result is pending");return this.b.e};function He(a,b,c){this.d=a;this.parent=b;this.name=c;this.e=null;this.b=0;this.g=this.f=null}function Ze(a){if(!Fe)throw Error("F_TASK_NO_CONTEXT");if(a!==Fe.top)throw Error("F_TASK_NOT_TOP_FRAME");}function N(a){return new Ye(a)}
...
function $e(){var a=L("Frame.timeSlice"),b=a.d.d;b.e.currentTime()>=b.h?(w("-- time slice --"),Ve(a).Va(!0)):O(a,!0);return N(a)}function af(a){function b(d){try{for(;d;){var e=a();if(e.xa()){e.then(b);return}e.then(function(a){d=a})}O(c,!0)}catch(f){Le(c.d,f,c)}}var c=L("Frame.loop");b(!0);return N(c)}function bf(a){var b=Fe;if(!b)throw Error("E_TASK_NO_CONTEXT");return af(function(){var c;do c=new cf(b,b.top),b.top=c,c.b=Ie,a(c),c=N(c);while(!c.xa()&&c.Tb());return c})}
function Ve(a,b){Ze(a);if(a.d.e)throw Error("E_TASK_ALREADY_SUSPENDED");var c=new We(a.d);a.d.e=c;Fe=null;a.d.j=b||null;return c}function cf(a,b){He.call(this,a,b,"loop")}t(cf,He);function df(a){O(a,!0)}function Q(a){O(a,!1)};function ef(a,b,c,d,e){var f=L("ajax"),g=new XMLHttpRequest,h=Ve(f,g),k={status:0,url:a,contentType:null,responseText:null,responseXML:null,$b:null};g.open(c||"GET",a,!0);b&&(g.responseType=b);g.onreadystatechange=function(){if(4===g.readyState){k.status=g.status;if(200==k.status||0==k.status)if(b&&"document"!==b||!g.responseXML){var c=g.response;b&&"text"!==b||"string"!=typeof c?c?"string"==typeof c?k.$b=ff([c]):k.$b=c:w("Unexpected empty success response for "+a):k.responseText=c;if(c=g.getResponseHeader("Content-Type"))k.contentType=
...
function Pf(a,b,c,d){for(var e=a.h,f=a.w,g=a.u,h,k,l,n;0<b;--b)switch(h=x(f),a.b[h.type]){case 28:if(18!=z(f,1).type){Of(a)?(e.R("E_CSS_COLON_EXPECTED",z(f,1)),a.b=Ef):(a.b=Af,e.gb());continue}k=z(f,2);if(!(k.b||1!=k.type&&6!=k.type)){if(0<=f.b)throw Error("F_CSSTOK_BAD_CALL mark");f.b=f.d}a.d=h.text;a.k=!1;A(f);A(f);a.b=Bf;g.splice(0,g.length);continue;case 46:if(18!=z(f,1).type){a.b=Ef;e.R("E_CSS_COLON_EXPECTED",z(f,1));continue}a.d=h.text;a.k=!1;A(f);A(f);a.b=Bf;g.splice(0,g.length);continue;case 29:a.b=
Af;e.gb();continue;case 1:if(!h.b){a.b=Ff;e.R("E_CSS_SPACE_EXPECTED",h);continue}e.bb();case 2:if(34==z(f,1).type)if(A(f),A(f),l=a.D[h.text],null!=l)switch(h=x(f),h.type){case 1:e.Za(l,h.text);a.b=R;A(f);break;case 36:e.Za(l,null);a.b=R;A(f);break;default:a.b=Df,e.R("E_CSS_NAMESPACE",h)}else a.b=Df,e.R("E_CSS_UNDECLARED_PREFIX",h);else e.Za(a.A,h.text),a.b=R,A(f);continue;case 3:if(!h.b){a.b=Ff;e.R("E_CSS_SPACE_EXPECTED",h);continue}e.bb();case 4:if(34==z(f,1).type)switch(A(f),A(f),h=x(f),h.type){case 1:e.Za(null,
h.text);a.b=R;A(f);break;case 36:e.Za(null,null);a.b=R;A(f);break;default:a.b=Df,e.R("E_CSS_NAMESPACE",h)}else e.Za(a.A,null),a.b=R,A(f);continue;case 5:h.b&&e.bb();case 6:e.Ac(h.text);a.b=R;A(f);continue;case 7:h.b&&e.bb();case 8:e.uc(h.text);a.b=R;A(f);continue;case 55:h.b&&e.bb();case 14:A(f);h=x(f);switch(h.type){case 1:e.Gb(h.text,null);A(f);a.b=R;continue;case 6:if(k=h.text,A(f),l=Mf(a),h=x(f),11==h.type){e.Gb(k,l);A(f);a.b=R;continue}}e.R("E_CSS_PSEUDOCLASS_SYNTAX",h);a.b=Df;continue;case 42:A(f);
h=x(f);switch(h.type){case 1:e.Hb(h.text,null);a.b=R;A(f);continue;case 6:if(k=h.text,A(f),l=Mf(a),h=x(f),11==h.type){e.Hb(k,l);a.b=R;A(f);continue}}e.R("E_CSS_PSEUDOELEM_SYNTAX",h);a.b=Df;continue;case 9:h.b&&e.bb();case 10:A(f);h=x(f);if(1==h.type)k=h.text,A(f);else if(36==h.type)k=null,A(f);else if(34==h.type)k="";else{a.b=Ff;e.R("E_CSS_ATTR",h);A(f);continue}h=x(f);if(34==h.type){l=k?a.D[k]:k;if(null==l){a.b=Ff;e.R("E_CSS_UNDECLARED_PREFIX",h);A(f);continue}A(f);h=x(f);if(1!=h.type){a.b=Ff;e.R("E_CSS_ATTR_NAME_EXPECTED",
h);continue}k=h.text;A(f);h=x(f)}else l="";switch(h.type){case 39:case 45:case 44:case 46:case 50:n=h.type;A(f);h=x(f);break;case 15:e.Ub(l,k,0,null);a.b=R;A(f);continue;default:a.b=Ff;e.R("E_CSS_ATTR_OP_EXPECTED",h);continue}switch(h.type){case 1:case 2:e.Ub(l,k,n,h.text);A(f);h=x(f);break;default:a.b=Ff;e.R("E_CSS_ATTR_VAL_EXPECTED",h);continue}if(15!=h.type){a.b=Ff;e.R("E_CSS_ATTR",h);continue}a.b=R;A(f);continue;case 11:e.tc();a.b=zf;A(f);continue;case 12:e.rc();a.b=zf;A(f);continue;case 56:e.xc();
a.b=zf;A(f);continue;case 13:a.M?(a.e.push("-epubx-region"),a.M=!1):a.I?(a.e.push("page"),a.I=!1):a.e.push("[selector]");e.la();a.b=xf;A(f);continue;case 41:e.Fc();a.b=Af;A(f);continue;case 15:g.push(H(h.text));A(f);continue;case 16:try{g.push(nf(h.text))}catch(p){e.R("E_CSS_COLOR",h),a.b=Df}A(f);continue;case 17:g.push(new dd(h.C));A(f);continue;case 18:g.push(new ed(h.C));A(f);continue;case 19:g.push(new J(h.C,h.text));A(f);continue;case 20:g.push(new bd(h.text));A(f);continue;case 21:g.push(new gd(ea(h.text,
...
function Vf(a,b,c){if(b.Vc())a:{b=b.e;a=b.evaluate(a);switch(typeof a){case "number":c=Uf[c]?a==Math.round(a)?new ed(a):new dd(a):new J(a,"px");break a;case "string":c=a?Tf(b.b,new Ob(a)):G;break a;case "boolean":c=a?Vd:td;break a;case "undefined":c=G;break a}throw Error("E_UNEXPECTED");}else c=b;return c};function Wf(){this.b={}}t(Wf,Tc);Wf.prototype.jb=function(a){this.b[a.name]=!0;return a};Wf.prototype.Ra=function(a){this.ab(a.values);return a};function Xf(a){this.value=a}t(Xf,Tc);Xf.prototype.xb=function(a){this.value=a.C;return a};function Yf(a,b){if(a){var c=new Xf(b);try{return a.P(c),c.value}catch(d){w("toInt: "+d)}}return b}function Zf(){this.d=!1;this.b=[];this.name=null}t(Zf,Tc);Zf.prototype.zb=function(a){this.d&&this.b.push(a);return null};
Zf.prototype.yb=function(a){this.d&&0==a.C&&this.b.push(new J(0,"px"));return null};Zf.prototype.Ra=function(a){this.ab(a.values);return null};Zf.prototype.ib=function(a){this.d||(this.d=!0,this.ab(a.values),this.d=!1,this.name=a.name.toLowerCase());return null};
...
le(b+a[0],c+a[1],a[2],a[3]);break a}break;case "circle":if(3==a.length){h=le(b+a[0],c+a[1],a[2],a[2]);break a}}}h=null}return h}catch(p){w("toShape: "+p)}}return me(b,c,b+d,c+e)}function ag(a){this.d=a;this.b={};this.name=null}t(ag,Tc);ag.prototype.jb=function(a){this.name=a.toString();this.b[this.name]=this.d?0:(this.b[this.name]||0)+1;return a};ag.prototype.xb=function(a){this.name&&(this.b[this.name]+=a.C-(this.d?0:1));return a};ag.prototype.Ra=function(a){this.ab(a.values);return a};
function bg(a,b){var c=new ag(b);try{a.P(c)}catch(d){w("toCounters: "+d)}return c.b}function cg(){this.url=null;this.b=!1}t(cg,Tc);cg.prototype.Ab=function(a){this.url||(this.url=a.url);return a};var dg={opentype:!0,truetype:!0,woff:!0,woff2:!0};cg.prototype.ib=function(a){if("format"==a.name.toLowerCase())for(var b=0;b<a.values.length;b++)if(dg[a.values[b].stringValue()]){this.b=!0;break}return a};
cg.prototype.Ra=function(a){2==a.values.length&&(this.b=!1,a.values[1].P(this),this.b&&a.values[0].P(this));return a};cg.prototype.hb=function(a){this.ab(a.values);return a};function lf(a,b){this.Vb=a;this.name=b;this.d=!1;this.e=this.b=this.f=null}lf.prototype.start=function(){if(!this.b){var a=this;this.b=Ne(Fe.d,function(){var b=L("Fetcher.run");a.Vb().then(function(c){var d=a.e;a.d=!0;a.f=c;a.b=null;a.e=null;if(d)for(var e=0;e<d.length;e++)try{d[e](c)}catch(f){w("Error: "+f)}O(b,c)});return N(b)},this.name)}};function eg(a,b){a.d?b(a.f):a.e.push(b)}function jf(a){if(a.d)return M(a.f);a.start();return a.b.join()}
function fg(a){if(0==a.length)return M(!0);if(1==a.length)return jf(a[0]).bd(!0);var b=L("waitForFetches"),c=0;af(function(){for(;c<a.length;){var b=a[c++];if(!b.d)return jf(b).bd(!0)}return M(!1)}).then(function(){O(b,!0)});return N(b)}
...
f.f}}return f===a.b&&(c?0<e.length:g==b.length)?e:null}m=rg.prototype;m.Ma=function(a){for(var b=null,c=this.d;c!==this.b&&c!==this.e;)a?0!=c.b?c=c.e:(b=a.P(c.d))?(a=null,c=c.e):c=c.f:c=c.f;return c===this.b?b:null};m.Nc=function(a){return this.Ma(a)};m.Oc=function(a){return this.Ma(a)};m.Nb=function(a){return this.Ma(a)};m.jb=function(a){return this.Ma(a)};m.zb=function(a){return this.Ma(a)};m.yb=function(a){return this.Ma(a)};m.xb=function(a){return this.Ma(a)};m.kc=function(a){return this.Ma(a)};
m.Ab=function(a){return this.Ma(a)};m.Ra=function(){return null};m.hb=function(){return null};m.ib=function(a){return this.Ma(a)};m.wb=function(){return null};function ug(a){rg.call(this,a)}t(ug,rg);ug.prototype.Ra=function(a){var b=sg(this,a.values,!1,0);return b===a.values?a:b?new Vc(b):null};ug.prototype.f=function(a,b){return sg(this,a,!0,b)};function tg(a){rg.call(this,a)}t(tg,rg);tg.prototype.Ra=function(a){return this.Ma(a)};
tg.prototype.hb=function(a){var b=sg(this,a.values,!1,0);return b===a.values?a:b?new Wc(b):null};function vg(a,b){rg.call(this,b);this.name=a}t(vg,rg);vg.prototype.Ma=function(){return null};vg.prototype.ib=function(a){if(a.name.toLowerCase()!=this.name)return null;var b=sg(this,a.values,!1,0);return b===a.values?a:b?new Xc(a.name,b):null};function wg(){}wg.prototype.b=function(a,b){return b};wg.prototype.e=function(){};
function xg(a,b,c){this.name=b;this.d=a.e[this.name];c&&this.d instanceof tg&&(this.d=this.d.d.d)}t(xg,wg);xg.prototype.b=function(a,b,c){if(c.values[this.name])return b;if(a=this.d.f(a,b)){var d=a.length;this.e(1<d?new Vc(a):a[0],c);return b+d}return b};xg.prototype.e=function(a,b){b.values[this.name]=a};function yg(a,b){xg.call(this,a,b[0],!1);this.f=b}t(yg,xg);yg.prototype.e=function(a,b){for(var c=0;c<this.f.length;c++)b.values[this.f[c]]=a};function zg(a,b){this.d=a;this.$c=b}t(zg,wg);
zg.prototype.b=function(a,b,c){var d=b;if(this.$c)if(a[b]==ad){if(++b==a.length)return d}else return d;var e=this.d[0].b(a,b,c);if(e==b)return d;b=e;for(d=1;d<this.d.length&&b<a.length;d++){e=this.d[d].b(a,b,c);if(e==b)break;b=e}return b};function Ag(){this.d=this.Ka=null;this.b=!1;this.values={};this.e=null}m=Ag.prototype;m.rd=function(a){return new xg(this.e,a,!1)};m.clone=function(){var a=new this.constructor;a.Ka=this.Ka;a.d=this.d;a.e=this.e;return a};m.Sc=function(a,b){this.Ka=a;this.d=b};
m.mb=function(){this.b=!0;return 0};function Bg(a,b){a.mb([b]);return null}m.Nc=function(a){return Bg(this,a)};m.Nb=function(a){return Bg(this,a)};m.jb=function(a){return Bg(this,a)};m.zb=function(a){return Bg(this,a)};m.yb=function(a){return Bg(this,a)};m.xb=function(a){return Bg(this,a)};m.kc=function(a){return Bg(this,a)};m.Ab=function(a){return Bg(this,a)};m.Ra=function(a){this.mb(a.values);return null};m.hb=function(){this.b=!0;return null};m.ib=function(a){return Bg(this,a)};
m.wb=function(){this.b=!0;return null};function Cg(){Ag.call(this)}t(Cg,Ag);Cg.prototype.mb=function(a){for(var b=0,c=0;b<a.length;){var d=this.Ka[c].b(a,b,this);if(d>b)b=d,c=0;else if(++c==this.Ka.length){this.b=!0;break}}return b};function Dg(){Ag.call(this)}t(Dg,Ag);Dg.prototype.mb=function(a){if(a.length>this.Ka.length||0==a.length)return this.b=!0,0;for(var b=0;b<this.Ka.length;b++){for(var c=b;c>=a.length;)c=1==c?0:c-2;if(this.Ka[b].b(a,c,this)!=c+1)return this.b=!0,0}return a.length};
function Eg(){Ag.call(this)}t(Eg,Ag);Eg.prototype.mb=function(a){for(var b=a.length,c=0;c<a.length;c++)if(a[c]===ad){b=c;break}if(b>this.Ka.length||0==a.length)return this.b=!0,0;for(c=0;c<this.Ka.length;c++){for(var d=c;d>=b;)d=1==d?0:d-2;var e;if(b+1<a.length)for(e=b+c+1;e>=a.length;)e-=e==b+2?1:2;else e=d;if(2!=this.Ka[c].b([a[d],a[e]],0,this))return this.b=!0,0}return a.length};function Fg(){Ag.call(this)}t(Fg,Cg);Fg.prototype.rd=function(a){return new xg(this.e,a,!0)};
Fg.prototype.hb=function(a){for(var b={},c=0;c<a.values.length;c++){this.values={};a.values[c].P(this);for(var d=b,e=this.values,f=0;f<this.d.length;f++){var g=this.d[f],h=e[g]||this.e.h[g],k=d[g];k||(k=[],d[g]=k);k.push(h)}this.values["background-color"]&&c!=a.values.length-1&&(this.b=!0);if(this.b)return null}this.values={};for(var l in b)this.values[l]="background-color"==l?b[l].pop():new Wc(b[l]);return null};function Gg(){Ag.call(this)}t(Gg,Cg);
Gg.prototype.Sc=function(a,b){Cg.prototype.Sc.call(this,a,b);this.d.push("font-family","line-height","font-size")};
Gg.prototype.mb=function(a){var b=Cg.prototype.mb.call(this,a);if(b+2>a.length)return this.b=!0,b;this.b=!1;var c=this.e.e;if(!a[b].P(c["font-size"]))return this.b=!0,b;this.values["font-size"]=a[b++];if(a[b]===ad){b++;if(b+2>a.length||!a[b].P(c["line-height"]))return this.b=!0,b;this.values["line-height"]=a[b++]}var d=b==a.length-1?a[b]:new Vc(a.slice(b,a.length));if(!d.P(c["font-family"]))return this.b=!0,b;this.values["font-family"]=d;return a.length};
Gg.prototype.hb=function(a){a.values[0].P(this);if(this.b)return null;for(var b=[this.values["font-family"]],c=1;c<a.values.length;c++)b.push(a.values[c]);a=new Wc(b);a.P(this.e.e["font-family"])?this.values["font-family"]=a:this.b=!0;return null};Gg.prototype.jb=function(a){if(a=this.e.d[a.name])for(var b in a)this.values[b]=a[b];else this.b=!0;return null};var Hg={SIMPLE:Cg,INSETS:Dg,INSETS_SLASH:Eg,COMMA:Fg,FONT:Gg};
...
d.push(p.clone())}else p={},p[g.text]=H(g.text),d.push(Lg(new og(0,p,T)));h=!1;break;case 5:p={};p[""+g.C]=new ed(g.C);d.push(Lg(new og(0,p,T)));h=!1;break;case 34:l("|");break;case 25:l("||");break;case 14:h||l(" ");e.push({cd:d,Zc:f,sc:"["});f="";d=[];h=!0;break;case 6:h||l(" ");e.push({cd:d,Zc:f,sc:"(",qb:g.text});f="";d=[];h=!0;break;case 15:g=k();p=e.pop();if("["!=p.sc)throw Error("']' unexpected");d=p.cd;d.push(g);f=p.Zc;h=!1;break;case 11:g=k();p=e.pop();if("("!=p.sc)throw Error("')' unexpected");
d=p.cd;d.push(Mg(p.qb,g));f=p.Zc;h=!1;break;case 18:if(h)throw Error("':' unexpected");A(b);d.push(Jg(d.pop(),x(b)));break;case 22:if(h)throw Error("'?' unexpected");d.push(Kg(d.pop(),0,1));break;case 36:if(h)throw Error("'*' unexpected");d.push(Kg(d.pop(),0,Number.POSITIVE_INFINITY));break;case 23:if(h)throw Error("'+' unexpected");d.push(Kg(d.pop(),1,Number.POSITIVE_INFINITY));break;case 12:A(b);g=x(b);if(5!=g.type)throw Error("<int> expected");var q=p=g.C;A(b);g=x(b);if(16==g.type){A(b);g=x(b);
if(5!=g.type)throw Error("<int> expected");q=g.C;A(b);g=x(b)}if(13!=g.type)throw Error("'}' expected");d.push(Kg(d.pop(),p,q));break;case 17:n=k();if(0<e.length)throw Error("unclosed '"+e.pop().sc+"'");break;default:throw Error("unexpected token");}A(b);Og(c)?a.b[c]=n:a.e[c]=1!=n.b.length||0!=n.b[0].b?new ug(n):n.b[0].d}}
...
function Sg(a,b,c,d,e){var f="",g=b;b=b.toLowerCase();var h=b.match(/^-([a-z]+)-([-a-z0-9]+)$/);h&&(f=h[1],b=h[2]);if((h=a.k[b])&&h[f])if(f=a.e[b])(a=c===xd||c.Vc()?c:c.P(f))?e.fb(b,a,d):e.Db(g,c);else if(b=a.f[b].clone(),c===xd)for(c=0;c<b.d.length;c++)e.fb(b.d[c],xd,d);else{c.P(b);if(b.b)d=!1;else{for(a=0;a<b.d.length;a++)f=b.d[a],e.fb(f,b.values[f]||b.e.h[f],d);d=!0}d||e.Db(g,c)}else e.jc(g,c)}
...
function nh(a){a=a.e["font-size"].value;var b;a:switch(a.b.toLowerCase()){case "px":case "in":case "pt":case "pc":case "cm":case "mm":case "q":b=!0;break a;default:b=!1}if(!b)throw Error("Unexpected state");return a.C*ec[a.b]}mh.prototype.zb=function(a){if("em"==a.b||"ex"==a.b)return new J(hc(this.d,a.b)/hc(this.d,"em")*a.C*nh(this),"px");if("%"==a.b){if("font-size"===this.b)return new J(a.C/100*nh(this),"px");var b=this.b.match(/height|^(top|bottom)$/)?"vh":"vw";return new J(a.C,b)}return a};
mh.prototype.wb=function(a){return"font-size"==this.b?Vf(this.d,a,this.b).P(this):a};function oh(){}oh.prototype.apply=function(){};oh.prototype.g=function(a){return new ph([this,a])};oh.prototype.clone=function(){return this};function qh(a){this.b=a}t(qh,oh);qh.prototype.apply=function(a){a.b[a.b.length-1].push(this.b.b())};function ph(a){this.b=a}t(ph,oh);ph.prototype.apply=function(a){for(var b=0;b<this.b.length;b++)this.b[b].apply(a)};ph.prototype.g=function(a){this.b.push(a);return this};
...
Vh={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},Wh={Xd:!1,Bb:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",Zb:"\u5341\u767e\u5343",Ad:"\u8ca0"};
function Xh(a){if(9999<a||-9999>a)return""+a;if(0==a)return Wh.Bb.charAt(0);var b=new Aa;0>a&&(b.append(Wh.Ad),a=-a);if(10>a)b.append(Wh.Bb.charAt(a));else if(Wh.Yd&&19>=a)b.append(Wh.Zb.charAt(0)),0!=a&&b.append(Wh.Zb.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(Wh.Bb.charAt(c)),b.append(Wh.Zb.charAt(2)));if(c=Math.floor(a/100)%10)b.append(Wh.Bb.charAt(c)),b.append(Wh.Zb.charAt(1));if(c=Math.floor(a/10)%10)b.append(Wh.Bb.charAt(c)),b.append(Wh.Zb.charAt(0));(a%=10)&&b.append(Wh.Bb.charAt(a))}return b.toString()}
...
Sh.prototype.ib=function(a){switch(a.name){case "attr":if(1==a.values.length)return new bd(this.d&&this.d.getAttribute(a.values[0].stringValue())||"");break;case "counter":if(2>=a.values.length)return Zh(this,a.values);break;case "counters":if(3>=a.values.length)return ai(this,a.values)}w("E_CSS_CONTENT_PROP: "+a.toString());return new bd("")};var ci=1/1048576;function di(a,b){for(var c in a)b[c]=a[c].clone()}
function ei(){this.g=0;this.b={};this.Mb={};this.f={};this.d={};this.wa={};this.e={};this.Fb={};this.N=0}ei.prototype.clone=function(){var a=new ei;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b];di(this.Mb,a.Mb);di(this.f,a.f);di(this.d,a.d);di(this.wa,a.wa);di(this.e,a.e);di(this.Fb,a.Fb);a.N=this.N;return a};function th(a,b,c){var d=a[b];d&&(c=d.g(c));a[b]=c}
function fi(a,b,c){this.j=a;this.d=b;this.Sa=c;this.b=[[],[]];this.h={};this.u=this.w=this.e=null;this.ca=this.fa=this.M=this.k=this.f="";this.I=this.D=null;this.Ea=this.ma=!0;this.g={};this.A=[{}];this.B=[new bd("\u201c"),new bd("\u201d"),new bd("\u2018"),new bd("\u2019")];this.l=0;this.lang="";this.Xa=[0];this.ua=0;this.ya=[]}function Kh(a,b){a.h[b]=(a.h[b]||0)+1}function gi(a,b,c){(b=b[c])&&b.apply(a)}var hi=[];
function ii(a,b,c,d){a.e=null;a.w=d;a.k="";a.f="";a.M="";a.fa="";a.u=b;a.ca="";a.D=hi;a.I=c;ji(a)}function ki(a,b,c){a.g[b]?a.g[b].push(c):a.g[b]=[c];c=a.A[a.A.length-1];c||(c={},a.A[a.A.length-1]=c);c[b]=!0}
...
1]),0));a.A.push(null)}function mi(a){var b=a.A.pop();if(b)for(var c in b)(b=a.g[c])&&(1==b.length?delete a.g[c]:b.pop())}function Ph(a,b,c){li(a,b);b.content&&(b.content=b.content.wc(new Sh(a,c)));mi(a)}var ni="before transclusion-before footnote-call footnote-marker inner first-letter first-line  transclusion-after after".split(" ");
function oi(a,b,c){a.ya.push(b);a.I=null;a.e=b;a.w=c;a.k=b.namespaceURI;a.f=b.localName;var d=a.j.b[a.k];a.ca=d?d+a.f:"";a.M=b.getAttribute("id");a.fa=b.getAttributeNS("http://www.w3.org/XML/1998/namespace","id");(d=b.getAttribute("class"))?a.u=d.split(/\s+/):a.u=hi;(d=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))?a.D=d.split(/\s+/):a.D=hi;"style"==a.f&&"http://www.gribuser.ru/xml/fictionbook/2.0"==a.k&&(a.u=[b.getAttribute("name")||""]);(d=b.getAttributeNS("http://www.w3.org/XML/1998/namespace",
...
function ji(a){var b;for(b=0;b<a.u.length;b++)gi(a,a.j.wa,a.u[b]);for(b=0;b<a.D.length;b++)gi(a,a.j.d,a.D[b]);gi(a,a.j.e,a.M);gi(a,a.j.Mb,a.f);""!=a.f&&gi(a,a.j.Mb,"*");gi(a,a.j.f,a.ca);null!==a.I&&(gi(a,a.j.Fb,a.I),gi(a,a.j.Fb,"*"));a.e=null;a.b.push([]);for(var c=1;-1<=c;--c){var d=a.b[a.b.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.ma=!0;a.Ea=!1}
fi.prototype.pop=function(){for(var a=1;-1<=a;--a)for(var b=this.b[this.b.length-a-2],c=0;c<b.length;)b[c].pop(this,a)?b.splice(c,1):c++;this.b.pop();this.ma=!1};var pi=null;function qi(a,b,c,d,e,f,g){tf.call(this,a,b,g);this.b=null;this.d=0;this.k=null;this.w=0;this.g=null;this.l=!1;this.J=c;this.h=d?d.h:pi?pi.clone():new ei;this.B=e;this.u=f;this.j=0}t(qi,uf);m=qi.prototype;m.jd=function(a){th(this.h.Mb,"*",a)};
function ri(a,b){var c=a.b;if(0<c.length){c.sort(function(a,b){return b.d()-a.d()});for(var d=null,e=c.length-1;0<=e;e--)d=c[e],d.b=b,b=d;if(d.e(a.h))return}a.jd(b)}m.Za=function(a,b){if(b||a)this.d+=1,b&&a?this.b.push(new wh(a,b)):b?this.b.push(new vh(b)):this.b.push(new yh(a))};m.uc=function(a){this.g?(w("::"+this.g+" followed by ."+a),this.b.push(new Ih(""))):(this.d+=256,this.b.push(new sh(a)))};
m.Gb=function(a,b){if(this.g)w("::"+this.g+" followed by :"+a),this.b.push(new Ih(""));else{switch(a.toLowerCase()){case "first-child":this.b.push(new Fh);break;case "root":this.b.push(new Gh);break;case "link":this.b.push(new vh("a"));this.b.push(new Ah("","href"));break;case "-adapt-href-epub-type":case "href-epub-type":if(b&&1==b.length&&"string"==typeof b[0]){var c=new RegExp("(^|s)"+ga(b[0])+"($|s)");this.b.push(new xh(c))}else this.b.push(new Ih(""));break;case "-adapt-footnote-content":case "footnote-content":this.l=
!0;break;case "visited":case "active":case "hover":case "focus":this.b.push(new Ih(""));break;case "lang":b&&1==b.length&&"string"==typeof b[0]?this.b.push(new Eh(new RegExp("^"+ga(b[0].toLowerCase())+"($|-)"))):this.b.push(new Ih(""));break;case "nth-child":b&&1==b.length&&"number"==typeof b[0]?this.b.push(new Hh(b[0])):this.b.push(new Ih(""));break;case "before":case "after":case "first-line":case "first-letter":this.Hb(a,b);return;default:this.b.push(new Ih(""))}this.d+=256}};
m.Hb=function(a,b){switch(a){case "before":case "after":case "first-line":case "first-letter":case "footnote-call":case "footnote-marker":case "inner":this.g?(w("Double pseudoelement ::"+this.g+"::"+a),this.b.push(new Ih(""))):this.g=a;break;case "first-n-lines":if(b&&1==b.length&&"number"==typeof b[0]){var c=Math.round(b[0]);if(0<c&&c==b[0]){this.g?(w("Double pseudoelement ::"+this.g+"::"+a),this.b.push(new Ih(""))):this.g="first-"+c+"-lines";break}}default:w("Unrecognized pseudoelement: ::"+a),
this.b.push(new Ih(""))}this.d+=1};m.Ac=function(a){this.d+=65536;this.b.push(new uh(a))};m.Ub=function(a,b,c,d){this.d+=256;d=d||"";switch(c){case 0:this.b.push(new Ah(a,b));break;case 39:this.b.push(new Bh(a,b,d));break;case 45:this.b.push(new Dh(a,b,new RegExp("(^|s)"+ga(d)+"($|s)")));break;case 44:this.b.push(new Dh(a,b,new RegExp("^"+ga(d)+"($|-)")));break;case 50:"supported"==d?this.b.push(new Ch(a,b)):w("Unsupported :: attr selector op: "+d);break;default:w("Unsupported attr selector: "+c)}};
m.bb=function(){var a="d"+this.w++;ri(this,new qh(new Jh(a)));this.b=[new Ih(a)]};m.tc=function(){var a="c"+this.w++;ri(this,new qh(new Lh(a)));this.b=[new Ih(a)]};m.rc=function(){var a="a"+this.w++;ri(this,new qh(new Mh(a)));this.b=[new Ih(a)]};m.xc=function(){var a="f"+this.w++;ri(this,new qh(new Nh(a)));this.b=[new Ih(a)]};m.Fc=function(){si(this);this.g=null;this.l=!1;this.d=0;this.b=[]};
m.gb=function(){var a;0!=this.j?(wf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.j=1,this.k={},this.g=null,this.d=0,this.l=!1,this.b=[])};m.R=function(a,b){uf.prototype.R.call(this,a,b);1==this.j&&(this.j=0)};m.vb=function(a){uf.prototype.vb.call(this,a);this.j=0};m.la=function(){si(this);uf.prototype.la.call(this);1==this.j&&(this.j=0)};m.Ta=function(){uf.prototype.Ta.call(this)};function si(a){if(a.b){var b=a.d,c;c=a.h;c=c.N+=ci;ri(a,a.nd(b+c));a.b=null;a.g=null;a.l=!1;a.d=0}}
m.nd=function(a){var b=this.B;this.l&&(b=b?"xxx-bogus-xxx":"footnote");return new rh(this.k,a,this.g,b)};m.Ia=function(a,b,c){Sg(this.u,a,b,c,this)};m.Db=function(a,b){vf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};m.jc=function(a,b){vf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};m.fb=function(a,b,c){"display"!=a||b!==Id&&b!==Hd||(this.fb("flow-options",new Vc([sd,Md]),c),this.fb("flow-into",b,c),b=nd);c=c?pf(this):qf(this);ih(this.k,a,this.J?new eh(b,c,this.J):new U(b,c))};
function ti(a,b){tf.call(this,a,b,!1)}t(ti,uf);ti.prototype.Ia=function(a,b){if(this.e.values[a])this.R("E_CSS_NAME_REDEFINED "+a,this.Cb());else{var c=a.match(/height|^(top|bottom)$/)?"vh":"vw",c=new Ic(this.e,100,c),c=b.ia(this.e,c);this.e.values[a]=c}};function ui(a,b,c,d,e){tf.call(this,a,b,!1);this.b=d;this.J=c;this.d=e}t(ui,uf);ui.prototype.Ia=function(a,b,c){c?w("E_IMPORTANT_NOT_ALLOWED"):Sg(this.d,a,b,c,this)};ui.prototype.Db=function(a,b){w("E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};
ui.prototype.jc=function(a,b){w("E_INVALID_PROPERTY "+a+": "+b.toString())};ui.prototype.fb=function(a,b,c){c=c?pf(this):qf(this);c+=this.N;this.N+=ci;ih(this.b,a,this.J?new eh(b,c,this.J):new U(b,c))};function vi(a,b){Qf.call(this,a);this.b={};this.d=b;this.N=0}t(vi,Qf);vi.prototype.Ia=function(a,b,c){Sg(this.d,a,b,c,this)};vi.prototype.Db=function(a,b){w("E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};vi.prototype.jc=function(a,b){w("E_INVALID_PROPERTY "+a+": "+b.toString())};
vi.prototype.fb=function(a,b,c){c=(c?67108864:50331648)+this.N;this.N+=ci;ih(this.b,a,new U(b,c))};var wi=new lf(function(){var a=L("uaStylesheetBase");jf(Tg).then(function(b){var c=ea("user-agent-base.css",da);b=new qi(null,null,null,null,null,b,!0);b.vb("UA");pi=b.h;Sf(c,b,null).oa(a)});return N(a)},"uaStylesheetBaseFetcher");function xi(a,b,c){return(a=a["writing-mode"])&&(b=a.evaluate(b,"writing-mode"))&&b!==xd?b===Td:c}
function yi(a,b,c,d){var e={},f;for(f in a)hh(f)&&(e[f]=a[f]);a=a._regions;if((c||d)&&a)for(d&&(d=["footnote"],c=c?c.concat(d):d),d=0;d<c.length;d++){f=a[c[d]];for(var g in f)hh(g)&&(e[g]=fh(b,e[g],f[g]))}return e}function zi(a,b,c,d){c=c?ch:dh;for(var e in a)if(a.hasOwnProperty(e)){var f=a[e];if(f){var g=c[e];if(g){var h=a[g];if(h&&h.Da>f.Da)continue;g=Yg[g]?g:e}else g=e;b[g]=d(e,f)}}};var Ai={"font-style":Gd,"font-variant":Gd,"font-weight":Gd},Bi="OTTO"+(new Date).valueOf(),Ci=1;function Di(a){a=this.sb=a;var b=new Aa,c;for(c in Ai)b.append(" "),b.append(a[c].toString());this.d=b.toString();if(c=this.sb.src){a=new cg;try{c.P(a)}catch(d){w("toFontSrcURL: "+d)}c=a.url}else c=null;this.src=c;this.e=[];this.f=[];this.b=(c=this.sb["font-family"])?c.stringValue():null}
function Ei(a,b,c){var d=new Aa;d.append("@font-face {\n  font-family: ");d.append(a.b);d.append(";\n  ");for(var e in Ai)d.append(e),d.append(": "),a.sb[e].va(d,!0),d.append(";\n  ");c?(d.append('src: url("'),b=(window.URL||window.webkitURL).createObjectURL(c),d.append(b),a.e.push(b),a.f.push(c)):(d.append('src: url("'),d.append(Da(b)));d.append('");\n}\n');return d.toString()}function Fi(a){this.d=a;this.b={}}function Gi(a,b){this.d=a;this.b=b;this.e={};this.f=0}
function Hi(a,b,c){b=b.b;var d=c.b[b];if(d)return d;d="Fnt_"+ ++a.f;return c.b[b]=d}
function Ii(a,b,c,d){var e=L("initFont"),f=b.src,g={},h;for(h in Ai)g[h]=b.sb[h];d=Hi(a,b,d);g["font-family"]=H(d);var k=new Di(g),l=a.b.ownerDocument.createElement("span");l.textContent="M";var n=(new Date).valueOf()+1E3;b=a.d.ownerDocument.createElement("style");h=Bi+Ci++;b.textContent=Ei(k,"",ff([h]));a.d.appendChild(b);a.b.appendChild(l);l.style.visibility="hidden";l.style.fontFamily=d;for(var p in Ai)u(l,p,g[p].toString());var g=l.getBoundingClientRect(),q=g.right-g.left,r=g.bottom-g.top;b.textContent=
...
function Dj(a,b,c,d,e,f,g){this.Z=a;this.Ic=d;this.ad=null;this.root=b;this.$=c;this.type=f;e&&(e.ad=this);this.b=g}function Ej(a,b){this.Dd=a;this.count=b}function Fj(a,b,c){this.X=a;this.parent=b;this.da=c;this.aa=0;this.K=!1;this.Ja=0;this.ba=b?b.ba:null;this.na=this.ta=null;this.I=!1;this.d=!0;this.e=!1;this.h=b?b.h:0;this.w=this.j=this.M=null;this.A=b?b.A:0;this.k=b?b.k:!1;this.b=this.B=this.u=null;this.l=b?b.l:{};this.g=b?b.g:!1;this.D=b?b.D:"ltr";this.f=b?b.f:null}
function Gj(a){a.d=!0;a.h=a.parent?a.parent.h:0;a.b=null;a.aa=0;a.K=!1;a.j=null;a.w=null;a.u=null;a.B=null;a.ta=null;a.k=a.parent?a.parent.k:!1;a.g=a.parent?a.parent.g:!1;a.ta=null}function Hj(a){var b=new Fj(a.X,a.parent,a.da);b.aa=a.aa;b.K=a.K;b.ta=a.ta;b.Ja=a.Ja;b.ba=a.ba;b.na=a.na;b.d=a.d;b.h=a.h;b.j=a.j;b.w=a.w;b.k=a.k;b.A=a.A;b.u=a.u;b.B=a.B;b.b=a.b;b.f=a.f;b.g=a.g;b.e=a.e;return b}Fj.prototype.modify=function(){return this.I?Hj(this):this};
function Ij(a){var b=a;do{if(b.I)break;b.I=!0;b=b.parent}while(b);return a}Fj.prototype.clone=function(){for(var a=Hj(this),b=a,c;null!=(c=b.parent);)c=Hj(c),b=b.parent=c;return a};function Jj(a){return{ea:a.X,Ja:a.Ja,ba:a.ba,ta:a.ta,na:a.na?Jj(a.na):null}}function Kj(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(Jj(b)),b=b.parent;while(b);return{ha:c,aa:a.aa,K:a.K}}function Lj(a){this.Pa=a;this.b=this.d=null}
...
function wk(a,b,c,d){this.position=a;this.f=b;this.g=c;this.e=d}wk.prototype.d=function(a,b){var c;b<this.b()?c=null:(a.e=this.e,c=this.position);return c};wk.prototype.b=function(){return("avoid"==this.f?1:0)+(this.g?3:0)+(this.position.parent?this.position.parent.h:0)};function xk(a,b,c){this.da=a;this.d=b;this.b=c}
...
function zk(a,b,c){Pj.call(this,a);this.Pc=a.lastChild;this.h=b;this.lc=c;this.sd=a.ownerDocument;this.mc=!1;this.ma=this.kb=this.Na=this.Rc=0;this.nc=this.Xa=this.l=this.f=null;this.Qc=!1;this.M=this.g=this.u=null;this.dd=!0;this.qc=this.oc=0}t(zk,Pj);zk.prototype.clone=function(){var a=new zk(this.d,this.h,this.lc);Uj(a,this);a.Pc=this.Pc;a.mc=this.mc;a.l=this.l?this.l.clone():null;a.Xa=this.Xa.concat();return a};
function Ak(a,b){var c=b.getBoundingClientRect(),d=(a.b?a.kb:a.Rc)-a.f.V,e=(a.b?a.Rc:a.Na)-a.f.T;return{left:c.left-d,top:c.top-e,right:c.right-d,bottom:c.bottom-e}}function Bk(a,b){return a.b?b<a.ma:b>a.ma}function Ck(a,b,c){var d=new Fj(b.ea,c,0);d.Ja=b.Ja;d.ba=b.ba;d.ta=b.ta;d.na=b.na?Ck(a,b.na,Ij(c)):null;return d}
function Dk(a,b){var c=L("openAllViews"),d=b.ha;Ek(a.h,a.d,a.mc);var e=d.length-1,f=null;af(function(){for(;0<=e;){f=Ck(a,d[e],f);if(0==e&&(f.aa=b.aa,f.K=b.K,f.K))break;var c=Fk(a.h,f,0==e&&0==f.aa);e--;if(c.xa())return c}return M(!1)}).then(function(){O(c,f)});return N(c)}var Gk=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
function Hk(a,b){if(b.f&&b.d&&!b.K&&0==b.f.count&&1!=b.b.nodeType){var c=b.b.textContent.match(Gk);return Ik(a.h,b,c[0].length)}return M(b)}function Jk(a,b,c){var d=L("buildViewToNextBlockEdge");bf(function(d){b.b&&c.push(Ij(b));Hk(a,b).then(function(f){f!==b&&(b=f,c.push(Ij(b)));Kk(a.h,b).then(function(c){(b=c)?b.j&&!a.b?Lk(a,b).then(function(c){b=c;!b||b.e||0<a.h.f.b.length?Q(d):df(d)}):b.d?df(d):Q(d):Q(d)})})}).then(function(){O(d,b)});return N(d)}
...
1)*a.f.Q);q=n;a.b&&(q=ue(n));ze(p,a.nc,q,e);a.b&&(n=new ce(-q.Q,q.V,-q.T,q.U));u(d,"left",n.V-a.f.V+a.j+"px");u(d,"top",n.T-a.f.T+a.k+"px");n=a.b?n.V:n.Q;Bk(a,n)&&0!=a.u.length?(b=b.modify(),b.e=!0,O(c,b)):(Ok(a),p=a.b?ue(a.f):a.f,Ae(p,a.nc,q,e),Pk(a),"left"==e?a.oc=n:a.qc=n,jl(a,n),O(c,l))}});return N(c)}
...
"1"))}}function ll(a,b,c,d){var e=L("processLineStyling");yk(d);var f=d.concat([]);d.splice(0,d.length);var g=0,h=b.f;0==h.count&&(h=h.Dd);bf(function(d){if(h){var e=ml(a,f),n=h.count-g;if(e.length<=n)Q(d);else{var p=nl(a,f,e[n-1]);ol(a,p,!1,!1).then(function(){g+=n;Ik(a.h,p,0).then(function(e){b=e;kl(b,!1);h=b.f;f=[];Jk(a,b,f).then(function(b){c=b;0<a.h.f.b.length?Q(d):df(d)})})})}}else Q(d)}).then(function(){Array.prototype.push.apply(d,f);yk(d);O(e,c)});return N(e)}
...
function vk(a,b,c){var d=b.e,e;if(c)e=c=1;else{for(e=d[0];e.parent&&e.d;)e=e.parent;c=Math.max((e.l.widows||1)-0,1);e=Math.max((e.l.orphans||1)-0,1)}var f=ml(a,d),g=a.ma,d=Ja(f.length,function(b){return a.b?f[b]<g:f[b]>g}),d=Math.min(f.length-c,d);if(d<e)return null;g=f[d-1];if(b=nl(a,b.e,g))a.e=(a.b?-1:1)*(g-a.Na);return b}
...
function sl(a,b,c){var d=L("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,h=a.u.length-1;0<=h&&!e;--h){var e=a.u[h].d(a,f),k=a.u[h].b();k>f&&(g=Math.min(g,k))}while(g>f&&!e);var l=!1;if(!e){w("Could not find any page breaks?!!");if(a.dd)return tl(a,b).then(function(b){b?(b=b.modify(),b.e=!1,ol(a,b,l,!0).then(function(){O(d,b)})):O(d,b)}),N(d);e=c;l=!0}ol(a,e,l,!0).then(function(){O(d,e)});return N(d)}
...
function xl(a,b,c){var d=L("skipEdges"),e=c?"avoid":null,f=null,g=[];bf(function(c){for(;b;){do if(b.b){if(b.d&&1!=b.b.nodeType){if(yj(b.b,b.A))break;if(!b.K){vl(a,f,null,!0,e)?(b=(f||b).modify(),b.e=!0):(b=b.modify(),b.u=e);Q(c);return}}if(!b.K&&(b.w&&wl(a,b),b.j)){vl(a,f,null,!0,e)&&(b=(f||b).modify(),b.e=!0);Q(c);return}if(1==b.b.nodeType){var d=b.b.style;if(b.K){if(f=Ij(b),g.push(f),e=qk(b.B,e),d&&(!ul(d.paddingBottom)||!ul(d.borderBottomWidth))){if(vl(a,f,null,!0,e)){b=(f||b).modify();b.e=!0;
Q(c);return}g=[f];f=e=null}}else{if((e=qk(b.u,e))&&"avoid"!=e&&"auto"!=e){Q(c);a.M=e;return}if(rk[b.b.localName]){vl(a,f,null,!0,e)&&(b=(f||b).modify(),b.e=!0);Q(c);return}if(d&&(!ul(d.paddingTop)||!ul(d.borderTopWidth))){if(vl(a,f,null,!0,e)){b=(f||b).modify();b.e=!0;Q(c);return}f=e=null;g=[]}}}}while(0);d=Kk(a.h,b);if(d.xa()){d.then(function(a){b=a;df(c)});return}b=d.Tb()}0!=a.u.length&&vl(a,f,g,!1,e)&&f&&(b=f.modify(),b.e=!0);Q(c)}).then(function(){O(d,b)});return N(d)}
function tl(a,b){var c=b,d=L("skipEdges"),e=null;bf(function(d){for(;b;){do if(b.b){if(b.d&&1!=b.b.nodeType){if(yj(b.b,b.A))break;if(!b.K){Q(d);return}}if(!b.K&&b.j){Q(d);return}if(1==b.b.nodeType){var g=b.b.style;if(b.K)e=qk(b.B,e);else{if((e=qk(b.u,e))&&"avoid"!=e&&"auto"!=e){Q(d);a.M=e;return}if(rk[b.b.localName]){Q(d);return}if(g&&(!ul(g.paddingTop)||!ul(g.borderTopWidth))){Q(d);return}}}}while(0);g=Kk(a.h,b);if(g.xa()){g.then(function(a){b=a;df(d)});return}b=g.Tb()}c=null;Q(d)}).then(function(){O(d,
c)});return N(d)}function Lk(a,b){return"footnote"==b.j?cl(a,b):el(a,b)}function yl(a,b,c){var d=L("layoutNext");xl(a,b,c).then(function(c){b=c;if(!b||a.M||b.e)O(d,b);else if(b.j)Lk(a,b).oa(d);else{a:{if(!b.K)switch(b.X.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!0}c?ql(a,b).oa(d):Mk(a,b).oa(d)}});return N(d)}
function $k(a){var b=a.d.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.k+"px";b.style.right=a.I+"px";b.style.bottom=a.w+"px";b.style.left=a.j+"px";a.d.appendChild(b);var c=b.getBoundingClientRect();a.d.removeChild(b);var b=a.B+a.left+Sj(a),d=a.D+a.top+Qj(a);a.f=new ce(b,d,b+a.width,d+a.height);a.Rc=c?a.b?c.top:c.left:0;a.Na=c?a.b?c.right:c.top:0;a.kb=c?a.b?c.left:c.bottom:0;a.oc=a.Na;a.qc=a.Na;a.ma=a.kb;c=a.f;b=a.B+a.left+Sj(a);d=a.D+a.top+Qj(a);b=a.Pb?ke(a.Pb,b,d):
me(b,d,b+a.width,d+a.height);a.nc=we(c,[b],a.A,a.Sa,a.b);Pk(a);a.g=null}function Zk(a){a.Xa=[];u(a.d,"width",a.width+"px");u(a.d,"height",a.height+"px");$k(a);a.e=0;a.Qc=!1;a.M=null}function jl(a,b){a.e=Math.max((a.b?-1:1)*(b-a.Na),a.e)}function zl(a,b){var c=b.b;if(!c)return M(!0);var d=L("layoutOverflownFootnotes"),e=0;af(function(){for(;e<c.length;){var b=c[e++],b=Xk(a,0,b,a.Na);if(b.xa())return b}return M(!1)}).then(function(){O(d,!0)});return N(d)}
function bl(a,b){a.Xa.push(b);if(a.Qc)return M(b);var c=L("layout");zl(a,b).then(function(){Dk(a,b.Pa).then(function(b){var e=b,f=!0;a.u=[];bf(function(c){for(;b;){var h=!0;yl(a,b,f).then(function(k){f=!1;b=k;0<a.h.f.b.length?Q(c):a.M?Q(c):b&&b.e?sl(a,b,e).then(function(a){b=a;Q(c)}):h?h=!1:df(c)});if(h){h=!1;return}}Q(c)}).then(function(){var e=a.l;e&&(a.d.appendChild(e.d),a.b?a.e=this.Na-this.kb:a.e=e.top+Qj(e)+e.e+Rj(e));if(b)if(0<a.h.f.b.length)O(c,null);else{a.Qc=!0;e=new Lj(Kj(b));if(a.g){for(var f=
[],k=0;k<a.g.length;k++){var l=a.g[k].b;l&&f.push(l)}e.b=f.length?f:null}O(c,e)}else O(c,null)})})});return N(c)}function al(a){for(var b=a.Xa;a.d.lastChild!=a.Pc;)a.d.removeChild(a.d.lastChild);Ok(a);Zk(a);var c=L("redoLayout"),d=0,e=null;bf(function(c){if(d<b.length){var g=b[d++];bl(a,g).then(function(a){a?(e=a,Q(c)):df(c)})}else Q(c)}).then(function(){O(c,e)});return N(c)};var Al=1;function Bl(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.h=0;this.d=a;this.name=b;this.eb=c;this.wa=d;this.parent=e;this.g="p"+Al++;e&&(this.h=e.children.length,e.children.push(this))}Bl.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Bl.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Cl(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
...
function Hl(a,b,c,d,e,f,g){a=a instanceof Fl?a:new Fl(a,this);Bl.call(this,a,b,c,d,e);this.e=this;this.J=f;this.j=g;this.b.width=new U(Yd,0);this.b.height=new U(Zd,0);this.b["wrap-flow"]=new U(ld,0);this.b.position=new U(Jd,0);this.b.overflow=new U(vd,0);this.k={}}t(Hl,Bl);Hl.prototype.f=function(a){return new Il(a,this)};Hl.prototype.clone=function(a){a=new Hl(this.d,this.name,a.eb||this.eb,this.wa,this.parent,this.J,this.j);Cl(this,a);Dl(this,a);return a};
function Jl(a,b,c,d,e){Bl.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.k[b]=this.g);this.b["wrap-flow"]=new U(ld,0)}t(Jl,Bl);Jl.prototype.f=function(a){return new Kl(a,this)};Jl.prototype.clone=function(a){a=new Jl(a.parent.d,this.name,this.eb,this.wa,a.parent);Cl(this,a);Dl(this,a);return a};function Ll(a,b,c,d,e){Bl.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.k[b]=this.g)}t(Ll,Bl);Ll.prototype.f=function(a){return new Ml(a,this)};
Ll.prototype.clone=function(a){a=new Ll(a.parent.d,this.name,this.eb,this.wa,a.parent);Cl(this,a);Dl(this,a);return a};function X(a,b,c){return b&&b!==ld?b.ia(a,c):null}function Nl(a,b,c){return b&&b!==ld?b.ia(a,c):a.b}function Ol(a,b,c){return b?b===ld?null:b.ia(a,c):a.b}function Pl(a,b,c,d){return b&&c!==Fd?b.ia(a,d):a.b}function Ql(a,b,c){return b?b===Vd?a.g:b===td?a.f:b.ia(a,a.b):c}
...
function Wl(a,b){b.fa[a.d.g]=a;var c=a.d.d,d=a.style,e=a.e?Xl(a.e,b):null,e=yi(a.B,b,e,!1);a.b=xi(e,b,a.e?a.e.b:!1);zi(e,d,a.b,function(a,b){return b.value});a.l=new bc(c,function(){return a.A},"autoWidth");a.k=new bc(c,function(){return a.w},"autoHeight");a.Bc();a.Cc();Ul(a);Tl(a)}function Yl(a,b,c){(a=a.style[c])&&(a=Vf(b,a,c));return a}function Y(a,b,c){(a=a.style[c])&&(a=Vf(b,a,c));return id(a,b)}
...
function am(a,b,c){var d=Y(a,b,"right"),e=Y(a,b,"snap-height"),f=Y(a,b,"margin-right"),g=Y(a,b,"padding-right");b=Y(a,b,"border-right-width");u(c.d,"margin-right",f+"px");u(c.d,"padding-right",g+"px");u(c.d,"border-right-width",b+"px");c.marginRight=f;c.Ea=b;a.b&&0<e&&(a=d+Tj(c),a=a-Math.floor(a/e)*e,0<a&&(c.Qb=e-a,g+=c.Qb));c.I=g;c.Rb=e}
...
function em(a,b,c){u(c.d,"border-top-width","0px");var d=Y(a,b,"max-height");a.I?Vj(c,0,d):(bm(a,b,c),d-=c.ua,c.height=d,u(c.d,"height",d+"px"))}function fm(a,b,c){u(c.d,"border-left-width","0px");var d=Y(a,b,"max-width");a.D?Wj(c,0,d):(am(a,b,c),d-=c.Qb,c.width=d,a=Y(a,b,"right"),u(c.d,"right",a+"px"),u(c.d,"width",d+"px"))}
...
function Dm(a,b,c,d,e,f,g,h,k,l,n,p,q){this.A=a;this.g=b;this.viewport=c;this.u=c.b;this.k=d;this.D=e;this.$=f;this.B=g;this.l=h;this.I=k;this.d=l;this.h=n;this.w=p;this.f=q;this.M=this.b=null;this.j=!1;this.X=null;this.aa=0;this.e=null}Dm.prototype.clone=function(){return new Dm(this.A,this.g,this.viewport,this.k,this.D,this.$,this.B,this.l,this.I,this.d,this.h,this.w,this.f)};
...
function Fm(a,b,c,d,e,f,g,h){var k=L("createShadows"),l=e.template,n;l instanceof gd?n=Em(a,l.url,2,b,h,null):n=M(null);n.then(function(l){var n=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var r=b.getAttribute("href"),v=null;r?v=h?h.$:a.$:h&&(r="http://www.w3.org/1999/xhtml"==h.Z.namespaceURI?h.Z.getAttribute("href"):h.Z.getAttributeNS("http://www.w3.org/1999/xlink","href"),v=h.Ic?h.Ic.$:a.$);r&&(r=ea(r,v.url),n=Em(a,r,3,b,h,l))}null==n&&(n=M(l));n.then(function(l){var n;
...
function Km(a,b){var c=!0,d=L("createElementView"),e=a.X,f=a.b.ba?a.b.ba.b:a.k,g=f.g(e,!1),h={};a.b.parent||(g=Hm(a,g));a.b.g=Gm(a,a.b.g,g,h);h.direction&&(a.b.D=h.direction.toString());var k=h["flow-into"];if(k&&k.toString()!=a.A)return O(d,!1),N(d);var l=h.display;if(l===Fd)return O(d,!1),N(d);Fm(a,e,null==a.b.parent,g,h,f,a.g,a.b.ba).then(function(f){a.b.ta=f;var g=a.b.parent&&a.b.parent.k;f=h["float-reference"];var k=h["float"],r=h.clear;if(h.position===jd||h.position===Jd)a.b.k=!0,k=null;g&&
(r=null,k!==ud&&(k=null));g=k===Cd||k===Kd||k===Qd||k===rd||k===Ad||k===zd||k===pd||k===od||k===ud;k&&(delete h["float"],k===ud&&(a.j?(g=!1,h.display=nd):h.display=yd),a.b.k=!0);r&&(r===xd&&a.b.parent&&a.b.parent.w&&(r=H(a.b.parent.w)),r===Cd||r===Kd||r===qd)&&(delete h.clear,h.display&&h.display!=yd&&(a.b.w=r.toString()));h.overflow===vd&&(a.b.k=!0);var v=l===Dd&&h["ua-list-item-count"];g||l===Od||h["break-inside"]===md||h["page-break-inside"]===md?a.b.h++:l===Pd&&(a.b.h+=10);a.b.d=!g&&!l||l===yd;
a.b.j=g?k.toString():null;a.b.M=f?f.toString():null;if(!a.b.d){if(f=h["break-after"]||h["page-break-after"])a.b.B=f.toString();if(f=h["break-before"]||h["page-break-before"])a.b.u=f.toString()}if(f=h["x-first-pseudo"])a.b.f=new Ej(a.b.parent?a.b.parent.f:null,f.C);if(f=h["white-space"])switch(f.toString()){case "normal":case "nowrap":a.b.A=0;break;case "pre-line":a.b.A=1;break;case "pre":case "pre-wrap":a.b.A=2}var y=!1,I=null,W=[],P=e.namespaceURI,F=e.localName;if("http://www.w3.org/1999/xhtml"==
...
W.push(gg(new Image,g)));Lm(a,f,h);g=h.widows;k=h.orphans;if(g||k){if(a.b.parent){a.b.l={};for(var Xd in a.b.parent.l)a.b.l[Xd]=a.b.parent.l[Xd]}g instanceof ed&&(a.b.l.widows=g.C);k instanceof ed&&(a.b.l.orphans=k.C)}if(!b&&!a.b.d){Xd=a.b.g?xm:wm;for(var Rk in Xd)u(f,Rk,Xd[Rk])}v&&f.setAttribute("value",h["ua-list-item-count"].stringValue());a.e=f;W.length?fg(W).then(function(){O(d,c)}):$e().then(function(){O(d,c)})})});return N(d)}
function Mm(a,b){var c=L("createNodeView"),d,e=!0;1==a.X.nodeType?d=Km(a,b):(8==a.X.nodeType?a.e=null:a.e=document.createTextNode(a.X.textContent.substr(a.aa||0)),d=M(!0));d.then(function(b){e=b;(a.b.b=a.e)&&(b=a.b.parent?a.b.parent.b:a.M)&&b.appendChild(a.e);O(c,e)});return N(c)}function Fk(a,b,c){(a.b=b)?(a.X=b.X,a.aa=b.aa):(a.X=null,a.aa=-1);a.e=null;return a.b?Mm(a,c):M(!0)}
function Nm(a){if(null==a.ba||"content"!=a.X.localName||"http://www.pyroxy.com/ns/shadow"!=a.X.namespaceURI)return a;var b=a.da,c=a.ba,d=a.parent,e,f;c.ad?(f=c.ad,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.Ic,e=c.Z.firstChild,c=2);var g=a.X.nextSibling;g?(a.X=g,Gj(a)):a.na?a=a.na:e?a=null:(a=a.parent.modify(),a.K=!0);if(e)return b=new Fj(e,d,b),b.ba=f,b.Ja=c,b.na=a,b;a.da=b;return a}
...
function dl(a,b,c,d){if(!b.K){var e=(b.ba?b.ba.b:a.k).g(a.X,!1);if(e=e._pseudos)e=e[c],c={},b.g=Gm(a,b.g,e,c),b=c.content,Yj(b)&&(b.P(new Xj(d,a.g)),delete c.content),Lm(a,d,c)}}
function Ik(a,b,c){var d=L("peelOff"),e=b.f,f=b.aa,g=b.K;if(0<c)b.b.textContent=b.b.textContent.substr(0,c),f+=c;else if(!g&&b.b&&0==f){var h=b.b.parentNode;h&&h.removeChild(b.b)}for(var k=b.da+c,l=[];b.f===e;)l.push(b),b=b.parent;var n=l.pop(),p=n.na;af(function(){for(;0<l.length;){n=l.pop();b=new Fj(n.X,b,k);0==l.length&&(b.aa=f,b.K=g);b.Ja=n.Ja;b.ba=n.ba;b.ta=n.ta;b.na=n.na?n.na:p;p=null;var c=Fk(a,b,!1);if(c.xa())return c}return M(!1)}).then(function(){O(d,b)});return N(d)}
...
function en(a){if((a=a.size)&&a.value!==ld){var b=a.value;b.md()?(a=b.values[0],b=b.values[1]):(a=b,b=null);return a.Xc()?{width:a,height:b||a}:(a=cn[a.name.toLowerCase()])?b&&b===Bd?{width:a.height,height:a.width}:{width:a.width,height:a.height}:dn}return dn}
var fn=function(){var a={width:!0,height:!0,"block-size":!0,"inline-size":!0,margin:!0,padding:!0,border:!0,outline:!0,"outline-width":!0,"outline-style":!0,"outline-color":!0};"left right top bottom before after start end block-start block-end inline-start inline-end".split(" ").forEach(function(b){a["margin-"+b]=!0;a["padding-"+b]=!0;a["border-"+b+"-width"]=!0;a["border-"+b+"-style"]=!0;a["border-"+b+"-color"]=!0});return a}(),gn={"top-left-corner":{N:1,sa:!0,pa:!1,qa:!0,ra:!0,ga:null},"top-left":{N:2,
sa:!0,pa:!1,qa:!1,ra:!1,ga:"start"},"top-center":{N:3,sa:!0,pa:!1,qa:!1,ra:!1,ga:"center"},"top-right":{N:4,sa:!0,pa:!1,qa:!1,ra:!1,ga:"end"},"top-right-corner":{N:5,sa:!0,pa:!1,qa:!1,ra:!0,ga:null},"right-top":{N:6,sa:!1,pa:!1,qa:!1,ra:!0,ga:"start"},"right-middle":{N:7,sa:!1,pa:!1,qa:!1,ra:!0,ga:"center"},"right-bottom":{N:8,sa:!1,pa:!1,qa:!1,ra:!0,ga:"end"},"bottom-right-corner":{N:9,sa:!1,pa:!0,qa:!1,ra:!0,ga:null},"bottom-right":{N:10,sa:!1,pa:!0,qa:!1,ra:!1,ga:"end"},"bottom-center":{N:11,sa:!1,
pa:!0,qa:!1,ra:!1,ga:"center"},"bottom-left":{N:12,sa:!1,pa:!0,qa:!1,ra:!1,ga:"start"},"bottom-left-corner":{N:13,sa:!1,pa:!0,qa:!0,ra:!1,ga:null},"left-bottom":{N:14,sa:!1,pa:!1,qa:!0,ra:!1,ga:"end"},"left-middle":{N:15,sa:!1,pa:!1,qa:!0,ra:!1,ga:"center"},"left-top":{N:16,sa:!1,pa:!1,qa:!0,ra:!1,ga:"start"}},hn=Object.keys(gn).sort(function(a,b){return gn[a].N-gn[b].N});
...
nn.prototype.h=function(a,b){var c=this.B,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}Il.prototype.h.call(this,a,b)};nn.prototype.Bc=function(){var a=this.style;a.left=$d;a["margin-left"]=$d;a["border-left-width"]=$d;a["padding-left"]=$d;a["padding-right"]=$d;a["border-right-width"]=$d;a["margin-right"]=$d;a.right=$d};
nn.prototype.Cc=function(){var a=this.style;a.top=$d;a["margin-top"]=$d;a["border-top-width"]=$d;a["padding-top"]=$d;a["padding-bottom"]=$d;a["border-bottom-width"]=$d;a["margin-bottom"]=$d;a.bottom=$d};nn.prototype.ca=function(a,b,c){b=b.l;var d={start:this.j.marginLeft,end:this.j.marginRight,Y:this.j.ob},e={start:this.j.marginTop,end:this.j.marginBottom,Y:this.j.nb};qn(this,b.top,!0,d,a,c);qn(this,b.bottom,!0,d,a,c);qn(this,b.left,!1,e,a,c);qn(this,b.right,!1,e,a,c)};
...
function vn(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=wn(d,g.length?new tn(g):null,b);g.La&&(f.center=g.La);d=g.La||d.d();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=wn(c,e,b),c.La&&(f.start=c.La),c.Ob&&(f.end=c.Ob);return f}
function wn(a,b,c){var d={La:null,Ob:null};if(a&&b)if(a.b()&&b.b()){var e=a.e(),f=b.e();0<e&&0<f?(f=e+f,f<c?d.La=c*e/f:(a=a.f(),b=b.f(),b=a+b,b<c?d.La=a+(c-b)*(e-a)/(f-b):0<b&&(d.La=c*a/b)),0<d.La&&(d.Ob=c-d.La)):0<e?d.La=c:0<f&&(d.Ob=c)}else a.b()?d.La=Math.max(c-b.d(),0):b.b()&&(d.Ob=Math.max(c-a.d(),0));else a?a.b()&&(d.La=c):b&&b.b()&&(d.Ob=c);return d}function on(a,b){Ml.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.nb=this.ob=null}t(on,Ml);
on.prototype.h=function(a,b){var c=this.B,d;for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(d.match(/^column.*$/)||d.match(/^background-/))&&(c[d]=b[d]);Ml.prototype.h.call(this,a,b);d=this.e;c={ob:this.ob,nb:this.nb,marginTop:this.marginTop,marginRight:this.marginRight,marginBottom:this.marginBottom,marginLeft:this.marginLeft};d.j=c;d=d.style;d.width=new K(c.ob);d.height=new K(c.nb);d["padding-left"]=new K(c.marginLeft);d["padding-right"]=new K(c.marginRight);d["padding-top"]=new K(c.marginTop);
d["padding-bottom"]=new K(c.marginBottom)};on.prototype.Bc=function(){var a=xn(this,{start:"left",end:"right",Y:"width"});this.ob=a.fd;this.marginLeft=a.pd;this.marginRight=a.od};on.prototype.Cc=function(){var a=xn(this,{start:"top",end:"bottom",Y:"height"});this.nb=a.fd;this.marginTop=a.pd;this.marginBottom=a.od};
...
$d;c["margin-"+f]=$d;c["padding-"+e]=new K(p);c["padding-"+f]=new K(q);c["border-"+e+"-width"]=new K(r);c["border-"+f+"-width"]=new K(v);c[g]=new K(k);c["max-"+g]=new K(k);return{fd:E(d,h,D(d,l,n)),pd:l,od:n}}on.prototype.rb=function(a,b,c){Ml.prototype.rb.call(this,a,b,c);c.u=b.d};function pn(a,b){Ml.call(this,a,b);var c=b.l;this.j=gn[c];a.ua[c]=this;this.ya=!0}t(pn,Ml);m=pn.prototype;
m.rb=function(a,b,c){var d=b.d;u(d,"display","flex");var e=Yl(this,a,"vertical-align"),f=null;e===H("middle")?f="center":e===H("top")?f="flex-start":e===H("bottom")&&(f="flex-end");f&&(u(d,"flex-flow",this.b?"row":"column"),u(d,"justify-content",f));Ml.prototype.rb.call(this,a,b,c)};
m.ga=function(a,b){var c=this.style,d=this.d.d,e=a.start,f=a.end,g="left"===e,h=g?b.ob:b.nb,k=X(d,c[a.Y],h),g=g?b.marginLeft:b.marginTop;if("start"===this.j.ga)c[e]=new K(g);else if(k){var l=Nl(d,c["margin-"+e],h),n=Nl(d,c["margin-"+f],h),p=Nl(d,c["padding-"+e],h),q=Nl(d,c["padding-"+f],h),r=Pl(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),f=Pl(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),k=D(d,k,D(d,D(d,p,q),D(d,D(d,r,f),D(d,l,n))));switch(this.j.ga){case "center":c[e]=new K(D(d,g,
...
y.Ba:null===y.Y?(y.Ba=y.Ca=0,y.Y=b-c):y.Ba=y.Ca=(b-c-y.Y)/2;return y}var e=a.style;a=a.d.d;var f=b.Dc,g=b.Hc;b=b.Y;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],k=Ol(a,e["margin-"+f],h),l=Ol(a,e["margin-"+g],h),n=Nl(a,e["padding-"+f],h),p=Nl(a,e["padding-"+g],h),q=Pl(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),r=Pl(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),v=X(a,e[b],h),y=null;e[b]=new K(new bc(a,function(){var a=d(this).Y;return null===a?0:a},b));e["margin-"+f]=new K(new bc(a,
function(){var a=d(this).Ba;return null===a?0:a},"margin-"+f));e["margin-"+g]=new K(new bc(a,function(){var a=d(this).Ca;return null===a?0:a},"margin-"+g));"left"===f?e.left=new K(D(a,c.marginLeft,c.ob)):"top"===f&&(e.top=new K(D(a,c.marginTop,c.nb)))}m.Bc=function(){var a=this.e.j;this.j.qa?yn(this,{Dc:"right",Hc:"left",Y:"width"},a):this.j.ra?yn(this,{Dc:"left",Hc:"right",Y:"width"},a):this.ga({start:"left",end:"right",Y:"width"},a)};
m.Cc=function(){var a=this.e.j;this.j.sa?yn(this,{Dc:"bottom",Hc:"top",Y:"height"},a):this.j.pa?yn(this,{Dc:"top",Hc:"bottom",Y:"height"},a):this.ga({start:"top",end:"bottom",Y:"height"},a)};m.Wb=function(a,b,c,d,e,f){Ml.prototype.Wb.call(this,a,b,c,d,e,f);a=c.l;c=this.d.l;d=this.j;d.qa||d.ra?d.sa||d.pa||(d.qa?a.left[c]=b:d.ra&&(a.right[c]=b)):d.sa?a.top[c]=b:d.pa&&(a.bottom[c]=b)};
...
function Bn(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof U?e.value+"":Bn(a,e);c.push(d+f+(e.Da||""))}return c.sort().join("^")}function Cn(a){this.b=null;this.f=a}t(Cn,V);Cn.prototype.apply=function(a){a.I===this.f&&this.b.apply(a)};Cn.prototype.d=function(){return 3};Cn.prototype.e=function(a){this.b&&th(a.Fb,this.f,this.b);return!0};function Dn(a){this.b=null;this.f=a}t(Dn,V);
...
In.prototype.apply=function(a){var b=a.d,c=a.w,d=this.style,e=this.b;lh(b,c,d,e,null,null);if(d=d._marginBoxes){var c=jh(c,"_marginBoxes"),f;for(f in d)if(d.hasOwnProperty(f)){var g=c[f];g||(g={},c[f]=g);lh(b,g,d[f],e,null,null);g.content&&(g.content=g.content.wc(new Sh(a,null)))}}};function Jn(a,b,c,d){qi.call(this,a,b,null,c,null,d,!1);this.f=""}t(Jn,qi);m=Jn.prototype;m.ub=function(){this.f+="@page ";this.gb()};m.Za=function(a,b){this.f+=b;b&&(this.b.push(new Cn(b)),this.d+=65536)};
...
m.Ta=function(){this.f+="}";document.getElementById("vivliostyle-page-rules").textContent+=this.f;qi.prototype.Ta.call(this)};m.Ia=function(a,b,c){"size"===a&&(this.f+="size: "+b.toString()+(c?"!important":"")+";");qi.prototype.Ia.call(this,a,b,c)};m.jd=function(a){th(this.h.Fb,"*",a)};m.nd=function(a){return new In(this.k,a)};m.Mc=function(a){var b=jh(this.k,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);sf(this.Z,new Kn(this.e,this.Z,this.u,c))};
function Kn(a,b,c,d){tf.call(this,a,b,!1);this.d=c;this.b=d}t(Kn,uf);Kn.prototype.Ia=function(a,b,c){Sg(this.d,a,b,c,this)};Kn.prototype.Db=function(a,b){vf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Kn.prototype.jc=function(a,b){vf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};Kn.prototype.fb=function(a,b,c){ih(this.b,a,new U(b,c?pf(this):qf(this)))};function Ln(a){this.d=a;this.b={};this.b.page=[0]}
...
function Tn(a,b){var c=Sn(a,a.b);if(c==Number.POSITIVE_INFINITY)return null;for(var d=a.j.children,e,f=0;f<d.length;f++)if(e=d[f],"vivliostyle-page-rule-master"!==e.d.eb){var g=1,h=Yl(e,a,"utilization");h&&h.Wc()&&(g=h.C);h=hc(a,"em");a.g=pk(a.d,c,Math.ceil(g*a.l()*a.k()/(h*h)));var g=a,h=g.b.d,k=void 0;for(k in g.b.b)for(var l=g.b.b[k],n=l.b.length-1;0<=n;n--){var p=l.b[n];0>p.b.e&&p.b.b<g.g&&(p.b.e=h)}gc(a,a.style.b);g=Yl(e,a,"enabled");if(!g||g===Vd){d=a;w("Location - page "+d.b.d);w("  currnt: "+
c);w("  lookup: "+d.g);c=void 0;for(c in d.b.b)for(f=d.b.b[c],g=0;g<f.b.length;g++)w("  Chunk "+c+": "+f.b[g].b.b);c=a.I;f=b;g=e.d;if(0===Object.keys(f).length)g.d.e=g;else{e=g;d=Bn(c,f);e=e.g+"^"+d;d=c.g[e];if(!d){if("background-host"===g.eb)d=c,f=(new jn(d.h,d.f.d,f)).f(d.f),f.h(d.b,d.e),lm(f,d.d),d=f;else{d=c;h=f;f=g.clone({eb:"vivliostyle-page-rule-master"});if(g=h.size)h=en(h),g=g.Da,f.b.width=fh(d.d,f.b.width,new U(h.width,g)),f.b.height=fh(d.d,f.b.height,new U(h.height,g));f=f.f(d.f);f.h(d.b,
...
O(e,!0)});return N(e)}
function Vn(a,b,c,d,e,f,g,h){var k=Yl(c,a,"enabled");if(k&&k!==Vd)return M(!0);var l=L("layoutContainer"),n=Yl(c,a,"wrap-flow")===ld,p=c.b?c.g&&c.D:c.f&&c.I,k=Yl(c,a,"flow-from"),q=a.viewport.b.createElement("div"),r=Yl(c,a,"position");u(q,"position",r?r.name:"absolute");d.insertBefore(q,d.firstChild);var v=new Pj(q);v.b=c.b;c.rb(a,v,b);v.B=e;v.D=f;e+=v.left+v.marginLeft+v.ca;f+=v.top+v.marginTop+v.fa;if(k&&k.kd())if(a.D[k.toString()])c.Wb(a,v,b,null,1,a.f),k=M(!0);else{var y=L("layoutContainer.inner"),
I=k.toString(),W=Y(c,a,"column-count"),P=Y(c,a,"column-gap"),F=1<W?Y(c,a,"column-width"):v.width,k=Xl(c,a),Ea=0,r=Yl(c,a,"shape-inside"),lb=$f(r,0,0,v.width,v.height,a),Qk=new Dm(I,a,a.viewport,a.d,k,a.$,a.ca,a.style.u,a,b,a.ua,a.ya,h),zh=0,Z=null;bf(function(b){for(;zh<W;){var c=zh++;if(1<W){var d=a.viewport.b.createElement("div");u(d,"position","absolute");q.appendChild(d);Z=new zk(d,Qk,a.f);Z.b=v.b;Z.Sa=v.Sa;Z.Rb=v.Rb;v.b?(u(d,"margin-left",v.j+"px"),u(d,"margin-right",v.I+"px"),c=c*(F+P)+v.k,
Wj(Z,0,v.width),Vj(Z,c,F)):(u(d,"margin-top",v.k+"px"),u(d,"margin-bottom",v.w+"px"),c=c*(F+P)+v.j,Vj(Z,0,v.height),Wj(Z,c,F));Z.B=e+v.j;Z.D=f+v.k}else Z=new zk(q,Qk,a.f),Uj(Z,v),v=Z;Z.A=p?[]:g;Z.Pb=lb;if(0<=Z.width){var k=L("inner");Un(a,Z,I).then(function(){Z.M&&"column"!=Z.M&&(zh=W,"region"!=Z.M&&(a.D[I]=!0));O(k,!0)});c=N(k)}else c=M(!0);if(c.xa()){c.then(function(){0<h.b.length?Q(b):(Ea=Math.max(Ea,Z.e),df(b))});return}0<h.b.length||(Ea=Math.max(Ea,Z.e))}Q(b)}).then(function(){v.e=Ea;c.Wb(a,
v,b,Z,W,a.f);O(y,!0)});k=N(y)}else k=Yl(c,a,"content"),r=!1,k&&Yj(k)?(k.P(new Xj(q,a)),km(c,a,v)):c.ya&&(d.removeChild(q),r=!0),r||c.Wb(a,v,b,null,1,a.f),k=M(!0);k.then(function(){if(!c.f||0<Math.floor(v.e)){if(!n){var k=v.B+v.left,p=v.D+v.top,r=Sj(v)+v.width+Tj(v),y=Qj(v)+v.height+Rj(v),F=Yl(c,a,"shape-outside"),k=$f(F,k,p,r,y,a);Ta(a.viewport.root)&&g.push(ke(k,0,-1.25*hc(a,"em")));g.push(k)}}else if(0==c.children.length){d.removeChild(q);O(l,!0);return}var I=c.children.length-1;af(function(){for(;0<=
...
h.value.toString());for(d=0;d<f.length;d++)if(g=f[d],k=b.h[g.Ib],h=b.h[g.Cd],k&&h&&(k=sj(k,g.action)))for(var y=0;y<h.length;y++)h[y].addEventListener(g.event,k,!1);var I;a:{for(I in a.e)if((f=c.b[I])&&0<f.b.length){I=!1;break a}I=!0}I&&(c=null);O(l,c)});return N(l)}function Xn(a,b){var c=en(b),d=c.width;d===Yd?a.w=null:a.w=d.C*hc(a,d.b);c=c.height;c===Zd?a.u=null:a.u=c.C*hc(a,c.b)}function Yn(a,b,c,d){qi.call(this,a.g,a,b,c,d,a.f,!c);this.f=a;this.A=!1}t(Yn,qi);m=Yn.prototype;m.fc=function(){};
m.ec=function(a,b,c){a=new Hl(this.f.j,a,b,c,this.f.u,this.J,qf(this.Z));sf(this.f,new rm(a.d,this.f,a,this.u))};m.lb=function(a){a=a.e;null!=this.J&&(a=Pc(this.e,this.J,a));sf(this.f,new Yn(this.f,a,this,this.B))};m.bc=function(){sf(this.f,new ti(this.e,this.Z))};m.dc=function(){var a={};this.f.k.push({sb:a,J:this.J});sf(this.f,new ui(this.e,this.Z,null,a,this.f.f))};m.cc=function(a){var b=this.f.h[a];b||(b={},this.f.h[a]=b);sf(this.f,new ui(this.e,this.Z,null,b,this.f.f))};
m.hc=function(){var a={};this.f.w.push(a);sf(this.f,new ui(this.e,this.Z,this.J,a,this.f.f))};m.Jb=function(a){var b=this.f.l;if(a){var c=jh(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}sf(this.f,new ui(this.e,this.Z,null,b,this.f.f))};m.gc=function(){this.A=!0;this.gb()};m.ub=function(){var a=new Jn(this.f.j,this.f,this,this.u);sf(this.f,a);a.ub()};
...
go.prototype.Ec=function(a){var b=this.h.Ec(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",u(e,"cursor","pointer"),e.addEventListener("click",io,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
go.prototype.ac=function(a,b,c,d,e){if(this.b)return M(this.b);var f=this,g=L("showTOC"),h=new tj(a);this.b=h;this.d.load(this.url).then(function(d){var l=f.d.b[d.url],n=Pn(l,c,1E5,e);b=new Rm(b.d,n.fontSize,b.root,n.width,n.height);var p=new Qn(l,d,f.lang,b,f.e,f.g,f.Ec(d),f.f,0);f.Ga=p;p.S=f.S;Rn(p).then(function(){Wn(p,h,null).then(function(){ho(f,a,2);O(g,h)})})});return N(g)};
go.prototype.Yb=function(){if(this.b){var a=this.b;this.Ga=this.b=null;u(a.L,"visibility","none");var b=a.L.parentNode;b&&b.removeChild(a.L)}};go.prototype.Yc=function(){return!!this.b};function jo(){co.call(this,ko(this));this.d=new hf(Wi,"document");this.u=new hf(mf,"text");this.w={};this.M={};this.k={};this.l={}}t(jo,co);function ko(a){return function(b){return a.k[b]}}
function lo(a,b,c){var d=L("loadEPUBDoc");c&&a.u.Vb(b+"?r=list");a.d.Vb(b+"META-INF/encryption.xml");a.d.load(b+"META-INF/container.xml").then(function(e){e=gj(Li(Li(Li(new Mi([e.b]),"container"),"rootfiles"),"rootfile"),"full-path");for(var f=0;f<e.length;f++){var g=e[f];if(g){mo(a,b,g,c).oa(d);return}}O(d,null)});return N(d)}
function mo(a,b,c,d){var e=b+c,f=a.w[e];if(f)return M(f);var g=L("loadOPF");a.d.load(e).then(function(c){a.d.load(b+"META-INF/encryption.xml").then(function(k){(d?a.u.load(b+"?r=list"):M(null)).then(function(d){f=new no(a,b);oo(f,c,k,d,b+"?r=manifest").then(function(){a.w[e]=f;a.M[b]=f;O(g,f)})})})});return N(g)}jo.prototype.load=function(a){a=ca(a);var b=this.l[a];return b?b.xa()?b:M(b.Tb()):jo.Gd.load.call(this,a)};
...
function wo(a,b){function c(a){for(var b in a){var d=a[b];d.sort(vo(b,l));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return Pa(a,function(a){return Oa(a,function(a){var b={v:a.value,o:a.N};a.$d&&(b.s=a.scheme);if(a.id||a.lang){var c=k[a.id];if(c||a.lang)a.lang&&(a={name:to,value:a.lang,lang:null,id:null,Kc:a.id,scheme:null,N:a.N},c?c.push(a):c=[a]),c=Na(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in so)f[g]=so[g];for(;null!=(g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/));)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=so;var h=1;g=ej(fj(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),N:h++,Kc:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:so.dcterms+a.localName,N:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Kc:null,scheme:null};return null});var k=Na(g,function(a){return a.Kc});g=d(Na(g,function(a){return a.Kc?null:a.name}));var l=null;g[to]&&(l=g[to][0].v);c(g);return g}function xo(){var a=window.MathJax;return a?a.Hub:null}var yo={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function no(a,b){this.e=a;this.g=this.d=this.b=this.h=this.f=null;this.k=b;this.j=null;this.D={};this.lang=null;this.u=0;this.l={};this.I=this.B=this.M=null;this.w={};this.A=null;xo()&&(Vg["http://www.w3.org/1998/Math/MathML"]=!0)}function zo(a,b){return a.k?b.substr(0,a.k.length)==a.k?decodeURI(b.substr(a.k.length)):null:b}
...
function Bo(a,b,c){var d=new po;d.F=0;d.id="item1";d.src=b;a.d={item1:d};a.g={};a.g[b]=d;a.h=[d];a.b=a.h;c?(a=a.e,d=L("EPUBDocStore.load"),b=ca(b),(a.l[b]=bo(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,$b:null})).oa(d),c=N(d)):c=M(null);return c}function Co(a,b,c){var d=a.b[b],e=L("getCFI");a.e.load(d.src).then(function(a){var b=Qi(a,c),h=null;b&&(a=Oi(a,b,0,!1),h=new cb,gb(h,b,c-a),d.g&&gb(h,d.g,0),h=h.toString());O(e,h)});return N(e)}
function Do(a,b){return Ke("resolveFragment",function(c){if(b){var d=new cb;db(d,b);var e;if(a.f){var f=eb(d,a.f.b);if(1!=f.ea.nodeType||f.K||!f.Ib){O(c,null);return}var g=f.ea,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.d[h]){O(c,null);return}e=a.d[h];d=f.Ib}else e=a.b[0];a.e.load(e.src).then(function(a){var b=eb(d,a.b);a=Oi(a,b.ea,b.offset,b.K);O(c,{F:e.F,ka:a,O:-1})})}else O(c,null)},function(a){w("Error resolving fragment "+b);O(a,null)})}
function Eo(a,b){return Ke("resolveEPage",function(c){if(0>=b)O(c,{F:0,ka:0,O:-1});else{var d=Ja(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.e.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=Pi(a),g=Math.round(a*b/e.b),g==a&&g--);O(c,{F:d,ka:g,O:-1})})}},function(a){w("Error resolving epage: "+b);O(a,null)})}
function Fo(a,b){var c=a.b[b.F];if(0>=b.ka)return M(c.e);var d=L("getEPage");a.e.load(c.src).then(function(a){a=Pi(a);var f=Math.min(a,b.ka);O(d,c.e+f*c.b/a)});return N(d)}function Go(a,b,c,d){this.b=a;this.viewport=b;this.f=c;this.tb=[];this.ka=this.O=this.F=0;this.S=Rb(d);this.e=new Qm(b.d)}function Ho(a){var b=a.tb[a.F];return b?b.Ya[a.O]:null}m=Go.prototype;m.cb=function(){if(this.b.A)return this.b.A;var a=this.tb[this.F];return a?a.Ga.M:null};
function Io(a){var b=L("renderPage");Jo(a).then(function(c){if(c){var d=-1;if(0>a.O){var d=a.ka,e=Ja(c.Ha.length,function(a){return Sn(c.Ga,c.Ha[a])>d});a.O=e==c.Ha.length?Number.POSITIVE_INFINITY:e-1}var f=c.Ya[a.O];f?(a.ka=f.offset,O(b,f)):bf(function(b){if(a.O<c.Ha.length)Q(b);else if(c.complete)a.O=c.Ha.length-1,Q(b);else{var e=c.Ha[c.Ha.length-1],k=Ko(a,c,e);Wn(c.Ga,k,e).then(function(l){k.L.style.display="none";k.L.style.visibility="visible";k.L.setAttribute("data-vivliostyle-page-side",k.f);
(e=l)?(c.Ya[e.d-1]=k,c.Ha.push(e),0<=d&&Sn(c.Ga,e)>d?(f=k,a.O=c.Ha.length-2,Q(b)):(k.j=0==c.item.F&&0==e.d-1,df(b))):(c.Ya.push(k),f=k,a.O=c.Ha.length-1,0>d&&(a.ka=k.offset),c.complete=!0,k.j=0==c.item.F&&0==a.O,k.k=c.item.F==a.b.b.length-1,Q(b))})}}).then(function(){if(f=f||c.Ya[a.O])O(b,f);else{var e=c.Ha[a.O];0>d&&(a.ka=Sn(c.Ga,e));var h=Ko(a,c,e);Wn(c.Ga,h,e).then(function(d){h.L.style.display="none";h.L.style.visibility="visible";h.L.setAttribute("data-vivliostyle-page-side",h.f);(e=d)?(c.Ya[e.d-
1]=h,c.Ha[a.O+1]=e):(c.Ya.push(h),c.complete=!0,h.k=c.item.F==a.b.b.length-1);h.j=0==c.item.F&&0==a.O;O(b,h)})}})}else O(b,null)});return N(b)}m.Lc=function(){return Lo(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};function Lo(a,b,c){var d=L("renderAllPages"),e=a.F,f=a.O;a.F=0;bf(function(d){a.O=a.F==b?c:Number.POSITIVE_INFINITY;Io(a).then(function(){++a.F>b?Q(d):df(d)})}).then(function(){a.F=e;a.O=f;Io(a).oa(d)});return N(d)}m.vd=function(){this.O=this.F=0;return Io(this)};
m.wd=function(){this.F=this.b.b.length-1;this.O=Number.POSITIVE_INFINITY;return Io(this)};m.nextPage=function(){var a=this,b=L("nextPage");Jo(a).then(function(c){if(c){if(c.complete&&a.O==c.Ha.length-1){if(a.F>=a.b.b.length-1){O(b,null);return}a.F++;a.O=0}else a.O++;Io(a).oa(b)}else O(b,null)});return N(b)};m.Jc=function(){if(0==this.O){if(0==this.F)return M(null);this.F--;this.O=Number.POSITIVE_INFINITY}else this.O--;return Io(this)};
function Mo(a,b){var c="left"===b.f,d="ltr"===a.cb();return!c&&d||c&&!d}function No(a){var b=L("getCurrentSpread"),c=Ho(a);if(!c)return M({left:null,right:null});var d=a.F,e=a.O,f="left"===c.f;(Mo(a,c)?a.Jc():a.nextPage()).then(function(g){a.F=d;a.O=e;Io(a).then(function(){f?O(b,{left:c,right:g}):O(b,{left:g,right:c})})});return N(b)}m.Bd=function(){var a=Ho(this);if(!a)return M(null);var a=Mo(this,a),b=this.nextPage();if(a)return b;var c=this;return b.ic(function(){return c.nextPage()})};
m.Ed=function(){var a=Ho(this);if(!a)return M(null);var a=Mo(this,a),b=this.Jc();if(a){var c=this;return b.ic(function(){return c.Jc()})}return b};function Oo(a,b){var c=L("navigateToEPage");Eo(a.b,b).then(function(b){b&&(a.F=b.F,a.O=b.O,a.ka=b.ka);Io(a).oa(c)});return N(c)}function Po(a,b){var c=L("navigateToCFI");Do(a.b,b).then(function(b){b&&(a.F=b.F,a.O=b.O,a.ka=b.ka);Io(a).oa(c)});return N(c)}
function Qo(a,b){w("Navigate to "+b);var c=zo(a.b,ca(b));if(null==c&&(a.b.f&&b.match(/^#epubcfi\(/)&&(c=zo(a.b,a.b.f.url)),null==c))return M(null);var d=a.b.g[c];if(!d)return a.b.f&&c==zo(a.b,a.b.f.url)&&(c=b.indexOf("#"),0<=c)?Po(a,b.substr(c+1)):M(null);d.F!=a.F&&(a.F=d.F,a.O=0);var e=L("navigateTo");Jo(a).then(function(c){var d=Si(c.$,b);d&&(a.ka=Ni(c.$,d),a.O=-1);Io(a).oa(e)});return N(e)}
...
function Jo(a){if(a.F>=a.b.b.length)return M(null);var b=a.tb[a.F];if(b)return M(b);var c=a.b.b[a.F],d=a.b.e,e=L("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(Pi(f)/2700),a.b.u=c.b);var g=d.b[f.url],h=a.Ec(f),k=a.viewport,l=Pn(g,k.width,k.height,k.fontSize);if(l.width!=k.width||l.height!=k.height||l.fontSize!=k.fontSize)k=new Rm(k.d,l.fontSize,k.root,l.width,l.height);var l=a.tb[a.F-1],n=new Qn(g,f,a.b.lang,k,a.e,a.f,h,a.b.w,l?l.Ga.ma+l.Ya.length:0);l&&
Mn(n.h,l.Ga.h);n.S=a.S;Rn(n).then(function(){b={item:c,$:f,Ga:n,Ha:[null],Ya:[],complete:!1};a.tb[a.F]=b;O(e,b)})});return N(e)}function So(a){return{F:a.F,O:a.O,ka:a.ka}}function To(a,b){b?(a.F=b.F,a.O=-1,a.ka=b.ka):(a.F=0,a.O=0,a.ka=0);return Lo(a,a.F,a.O)}
m.ac=function(){var a=this.b,b=a.B||a.M;if(!b)return M(null);var c=L("showTOC");this.d||(this.d=new go(a.e,b.src,a.lang,this.e,this.f,this.S,this,a.w));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";e.style.border=
"1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.d.ac(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";O(c,a)});return N(c)};m.Yb=function(){this.d&&this.d.Yb()};m.Yc=function(){return this.d&&this.d.Yc()};function Uo(a,b,c,d){var e=this;this.j=a;this.$a=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Xa=c;this.Sa=d;this.ma=new Gi(a.document.head,b);this.A="";this.g=null;this.I=this.d=!1;this.f=this.k=this.e=this.u=null;this.fontSize=16;this.h=1;this.ca=!1;this.Lc=!0;this.S=Qb();this.D=function(){};this.l=function(){};this.M=function(){e.d=!0;e.D()};this.w=function(){};this.fa={loadEPUB:this.ua,loadXML:this.ya,configure:this.B,
moveTo:this.Ea,toc:this.ac}}function Vo(a,b){b.i=a.Xa;a.Sa(b)}
Uo.prototype.ua=function(a){Zm.b("loadEPUB");Zm.b("loadFirstPage");this.$a.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet;this.viewport=null;var f=L("loadEPUB"),g=this;g.B(a).then(function(){var a=new jo;if(e)for(var k=0;k<e.length;k++)fo(a,e[k]);eo(a).then(function(){var e=ea(b,g.j.location.href);g.A=e;lo(a,e,d).then(function(a){g.g=a;Do(g.g,c).then(function(a){g.f=a;Wo(g).then(function(){g.$a.setAttribute("data-vivliostyle-viewer-status",
"complete");Zm.d("loadEPUB");Vo(g,{t:"loaded",metadata:g.g.l});O(f,!0)})})})})});return N(f)};
Uo.prototype.ya=function(a){Zm.b("loadXML");Zm.b("loadFirstPage");this.$a.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.document,d=a.fragment,e=a.userStyleSheet;this.viewport=null;var f=L("loadXML"),g=this;g.B(a).then(function(){var a=new jo;if(e)for(var k=0;k<e.length;k++)fo(a,e[k]);eo(a).then(function(){var e=ea(b,g.j.location.href);g.A=e;g.g=new no(a,"");Bo(g.g,e,c).then(function(){Do(g.g,d).then(function(a){g.f=a;Wo(g).then(function(){g.$a.setAttribute("data-vivliostyle-viewer-status",
...
typeof a.fontFamily&&(this.S.fontFamily=a.fontFamily,this.d=!0);"boolean"==typeof a.load&&(this.ca=a.load);"boolean"==typeof a.renderAllPages&&(this.Lc=a.renderAllPages);"string"==typeof a.userAgentRootURL&&(da=a.userAgentRootURL);"boolean"==typeof a.spreadView&&a.spreadView!==this.S.Wa&&(this.viewport=null,this.S.Wa=a.spreadView,this.d=!0);"number"==typeof a.pageBorder&&a.pageBorder!==this.S.Eb&&(this.viewport=null,this.S.Eb=a.pageBorder,this.d=!0);"number"==typeof a.zoom&&a.zoom!==this.h&&(this.h=
...
function ap(a){var b=L("reportPosition");a.f||(a.f=So(a.b));Co(a.g,a.f.F,a.f.ka).then(function(c){var d=a.e;(a.ca&&0<d.e.length?fg(d.e):M(!0)).then(function(){bp(a,d,c).oa(b)})});return N(b)}function cp(a){var b=a.$a;if(a.u){var c=a.u;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new Rm(a.j,a.fontSize,b,c.width,c.height)}return new Rm(a.j,a.fontSize,b)}
function dp(a){if(a.u||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=cp(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.tb;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.Ya,d=0;d<c.length;d++){var e=c[d];if(e.D&&e.B){a=!0;break a}}}a=!1}b=!a}return b}
function ep(a){if(a.b){a.b.Yb();for(var b=a.b.tb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.Ya,e;e=d.shift();)e=e.L,e.parentNode.removeChild(e)}}a.viewport=cp(a);b=a.viewport.e;u(b,"width","");u(b,"height","");a.b=new Go(a.g,a.viewport,a.ma,a.S)}
function fp(a,b){a.I=!1;if(a.S.Wa)return No(a.b).ic(function(c){Yo(a);a.k=c;c.left&&(Zo(a,c.left),c.right||c.left.L.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Zo(a,c.right),c.left||c.right.L.setAttribute("data-vivliostyle-unpaired-page",!0));var d=gp(a,c);Sm(a.viewport,d.width*a.h,d.height*a.h);c.left&&xj(c.left,a.h);c.right&&xj(c.right,a.h);a.e=b;return M(null)});$o(a,b);hp(a,b);a.e=b;return M(null)}function hp(a,b){Sm(a.viewport,b.b.width*a.h,b.b.height*a.h);xj(b,a.h)}
function gp(a,b){var c=0,d=0;b.left&&(c+=b.left.b.width,d=b.left.b.height);b.right&&(c+=b.right.b.width,d=Math.max(d,b.right.b.height));b.left&&b.right&&(c+=2*a.S.Eb);return{width:c,height:d}}var ip={Nd:"fit inside viewport"};
function Wo(a){a.d=!1;if(dp(a))return M(!0);"complete"===a.$a.getAttribute("data-vivliostyle-viewer-status")&&a.$a.setAttribute("data-vivliostyle-viewer-status","resizing");Vo(a,{t:"resizestart"});var b=L("resize");a.b&&!a.f&&(a.f=So(a.b));ep(a);To(a.b,a.f).then(function(c){fp(a,c).then(function(){ap(a).then(function(c){Zm.d("loadFirstPage");(a.Lc?a.b.Lc():M(null)).then(function(){a.$a.setAttribute("data-vivliostyle-viewer-status","complete");Vo(a,{t:"resizeend"});O(b,c)})})})});return N(b)}
...
Uo.prototype.Ea=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.S.Wa?this.b.Bd:this.b.nextPage;break;case "previous":a=this.S.Wa?this.b.Ed:this.b.Jc;break;case "last":a=this.b.wd;break;case "first":a=this.b.vd;break;default:return M(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return Oo(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return Qo(b.b,d)}}else return M(!0);var e=L("nextPage");a.call(b.b).then(function(a){a?(b.f=
null,fp(b,a).then(function(){ap(b).oa(e)})):O(e,!0)});return N(e)};Uo.prototype.ac=function(a){var b=!!a.autohide;a=a.v;var c=this.b.Yc();if(c){if("show"==a)return M(!0)}else if("hide"==a)return M(!0);if(c)return this.b.Yb(),M(!0);var d=this,e=L("showTOC");this.b.ac(b).then(function(a){if(a){if(b){var c=function(){d.b.Yb()};a.addEventListener("hyperlink",c,!1);a.L.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.w,!1)}O(e,!0)});return N(e)};
...
m.zd=function(a){a:switch(a){case "left":a="ltr"===this.cb()?"previous":"next";break a;case "right":a="ltr"===this.cb()?"next":"previous";break a}this.b.l({a:"moveTo",where:a})};m.yd=function(a){this.b.l({a:"moveTo",url:a})};m.Jd=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.S.Wa?gp(b,b.k):b.e.b;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ba("vivliostyle.viewer.Viewer",np);np.prototype.setOptions=np.prototype.qd;np.prototype.addListener=np.prototype.Hd;np.prototype.removeListener=np.prototype.Kd;np.prototype.loadDocument=np.prototype.xd;np.prototype.loadEPUB=np.prototype.Id;np.prototype.getCurrentPageProgression=np.prototype.cb;np.prototype.navigateToPage=np.prototype.zd;np.prototype.navigateToInternalUrl=np.prototype.yd;np.prototype.queryZoomFactor=np.prototype.Jd;ba("vivliostyle.viewer.ZoomType",ip);ip.FIT_INSIDE_VIEWPORT="fit inside viewport";
...
function vp(a){switch(a.t){case "loaded":a=a.viewer;var b=qp=a.cb();a.$a.setAttribute("data-vivliostyle-page-progression",b);a.$a.setAttribute("data-vivliostyle-spread-view",a.S.Wa);window.addEventListener("keydown",up,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",sp,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",tp,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
