 ...
 *
 * Vivliostyle core 2016.7.1-pre.20160915102040
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function G(a){var b=ad[a];b||(b=new ld(a));return b}function H(a,b){this.B=a;this.X=b.toLowerCase()}t(H,gd);H.prototype.ja=function(a,b){return 0==this.B?a.b:b&&"%"==this.X?100==this.B?b:new Oc(a,b,new fc(a,this.B/100)):new Rc(a,this.B,this.X)};H.prototype.Ba=function(a){a.append(this.B.toString());a.append(this.X)};H.prototype.U=function(a){return a.Tb(this)};H.prototype.$b=function(){return!0};function md(a){this.B=a}t(md,gd);
md.prototype.ja=function(a){return 0==this.B?a.b:1==this.B?a.d:new fc(a,this.B)};md.prototype.Ba=function(a){a.append(this.B.toString())};md.prototype.U=function(a){return a.Sb(this)};md.prototype.yd=function(){return!0};function nd(a){this.B=a}t(nd,md);nd.prototype.U=function(a){return a.Rb(this)};function od(a){this.b=a}t(od,gd);od.prototype.Ba=function(a){a.append("#");var b=this.b.toString(16);a.append("000000".substr(b.length));a.append(b)};od.prototype.U=function(a){return a.Ic(this)};
...
n.qc=function(){this.b.qc()};function Ff(a,b,c){Af.call(this,a);this.H=c;this.D=0;if(this.aa=b)this.Ja=b.Ja}t(Ff,Af);Ff.prototype.Yb=function(){return this.aa.Yb()};Ff.prototype.error=function(a){u.b(a)};Ff.prototype.qa=function(){this.D++};Ff.prototype.nb=function(){if(0==--this.D&&!this.H){var a=this.aa;a.b=a.e.pop()}};function Gf(a,b,c){Ff.call(this,a,b,c)}t(Gf,Ff);function Hf(a,b){a.error(b,a.Yb())}function If(a,b){Hf(a,b);Ef(a.aa,new Ff(a.d,a.aa,!1))}n=Gf.prototype;n.fb=function(){If(this,"E_CSS_UNEXPECTED_SELECTOR")};
...
function Yf(a,b,c){for(var d=a.u,e=a.j,f=d.pop(),g;;){var h=d.pop();if(11==b){for(g=[f];16==h;)g.unshift(d.pop()),h=d.pop();if("string"==typeof h){if("{"==h){for(;2<=g.length;)a=g.shift(),c=g.shift(),a=new Fc(e.Y(),a,c),g.unshift(a);d.push(new I(g[0]));return!0}if("("==h){b=d.pop();f=d.pop();f=new Uc(e.Y(),cc(f,b),g);b=0;continue}}if(10==h){f.xd()&&(f=new Wc(e.Y(),f,null));b=0;continue}}else if("string"==typeof h){d.push(h);break}if(0>h)if(-31==h)f=new Ac(e.Y(),f);else if(-24==h)f=new Bc(e.Y(),f);
else return Xf(a,"F_UNEXPECTED_STATE",c),!1;else{if(Tf[b]>Tf[h]){d.push(h);break}g=d.pop();switch(h){case 26:f=new Cc(e.Y(),g,f);break;case 52:f=new Dc(e.Y(),g,f);break;case 25:f=new Ec(e.Y(),g,f);break;case 38:f=new Gc(e.Y(),g,f);break;case 37:f=new Ic(e.Y(),g,f);break;case 48:f=new Hc(e.Y(),g,f);break;case 47:f=new Jc(e.Y(),g,f);break;case 39:case 49:f=new Kc(e.Y(),g,f);break;case 41:f=new Lc(e.Y(),g,f);break;case 23:f=new Mc(e.Y(),g,f);break;case 24:f=new Nc(e.Y(),g,f);break;case 36:f=new Oc(e.Y(),
g,f);break;case 19:f=new Pc(e.Y(),g,f);break;case 21:f=new Qc(e.Y(),g,f);break;case 18:if(1<d.length)switch(d[d.length-1]){case 22:d.pop();f=new Vc(e.Y(),d.pop(),g,f);break;case 10:if(g.xd())f=new Wc(e.Y(),g,f);else return Xf(a,"E_CSS_MEDIA_TEST",c),!1}else return Xf(a,"E_CSS_EXPR_COND",c),!1;break;case 22:if(18!=b)return Xf(a,"E_CSS_EXPR_COND",c),!1;case 10:return d.push(g),d.push(h),d.push(f),!1;default:return Xf(a,"F_UNEXPECTED_STATE",c),!1}}}d.push(f);return!1}
function Zf(a){for(var b=[];;){var c=y(a.d);switch(c.type){case 1:b.push(c.text);break;case 23:b.push("+");break;case 4:case 5:b.push(c.B);break;default:return b}A(a.d)}}
function $f(a){var b=!1,c=y(a.d);if(23===c.type)b=!0,A(a.d),c=y(a.d);else if(1===c.type&&("even"===c.text||"odd"===c.text))return A(a.d),[2,"odd"===c.text?1:0];switch(c.type){case 3:if(b&&0>c.B)break;case 1:if(b&&"-"===c.text.charAt(0))break;if("n"===c.text||"-n"===c.text){if(b&&c.b)break;b="-n"===c.text?-1:1;3===c.type&&(b=c.B);var d=0;A(a.d);var c=y(a.d),e=24===c.type,f=23===c.type||e;f&&(A(a.d),c=y(a.d));if(5===c.type){d=c.B;if(1/d===1/-0){if(d=0,f)break}else if(0>d){if(f)break}else if(0<=d&&!f)break;
A(a.d)}else if(f)break;return[b,e&&0<d?-d:d]}if("n-"===c.text||"-n-"===c.text){if(b&&c.b)break;b="-n-"===c.text?-1:1;3===c.type&&(b=c.B);A(a.d);c=y(a.d);if(5===c.type&&!(0>c.B||1/c.B===1/-0))return A(a.d),[b,c.B]}else{if(d=c.text.match(/^n(-[0-9]+)$/)){if(b&&c.b)break;A(a.d);return[3===c.type?c.B:1,parseInt(d[1],10)]}if(d=c.text.match(/^-n(-[0-9]+)$/))return A(a.d),[-1,parseInt(d[1],10)]}break;case 5:if(b&&(c.b||0>c.B))break;A(a.d);return[0,c.B]}return null}
function ag(a,b,c){a=a.j.Y();if(!a)return null;c=c||a.g;if(b){b=b.split(/\s+/);for(var d=0;d<b.length;d++)switch(b[d]){case "vertical":c=Yc(a,c,new Ac(a,new Sc(a,"pref-horizontal")));break;case "horizontal":c=Yc(a,c,new Sc(a,"pref-horizontal"));break;case "day":c=Yc(a,c,new Ac(a,new Sc(a,"pref-night-mode")));break;case "night":c=Yc(a,c,new Sc(a,"pref-night-mode"));break;default:c=a.f}}return c===a.g?null:new I(c)}
...
continue}}a.b===Of&&0<=h.b?(Vb(h),a.b=Nf,g.fb()):Xf(a,"E_CSS_UNEXPECTED_PLUS",k);continue;case 26:A(h);case 48:h.b=-1;(m=Wf(a,";",k))&&a.e&&g.cb(a.e,m,a.l);a.b=d?Kf:Jf;continue;case 44:A(h);h.b=-1;m=Wf(a,";",k);if(c)return a.w=m,!0;a.e&&m&&g.cb(a.e,m,a.l);if(d)return!0;Xf(a,"E_CSS_SYNTAX",k);continue;case 31:m=z(h,1);9==m.type?(10!=z(h,2).type||z(h,2).b?(l.push(new Sc(g.Y(),cc(k.text,m.text))),a.b=R):(l.push(k.text,m.text,"("),A(h)),A(h)):(2==a.g||3==a.g?"not"==k.text.toLowerCase()?(A(h),l.push(new Tc(g.Y(),
!0,m.text))):("only"==k.text.toLowerCase()&&(A(h),k=m),l.push(new Tc(g.Y(),!1,k.text))):l.push(new Sc(g.Y(),k.text)),a.b=R);A(h);continue;case 38:l.push(null,k.text,"(");A(h);continue;case 32:l.push(new fc(g.Y(),k.B));A(h);a.b=R;continue;case 33:m=k.text;"%"==m&&(m=a.e&&a.e.match(/height|^(top|bottom)$/)?"vh":"vw");l.push(new Rc(g.Y(),k.B,m));A(h);a.b=R;continue;case 34:l.push(new fc(g.Y(),k.text));A(h);a.b=R;continue;case 35:A(h);k=y(h);5!=k.type||k.b?Xf(a,"E_CSS_SYNTAX",k):(l.push(new Xc(g.Y(),
k.B)),A(h),a.b=R);continue;case 36:l.push(-k.type);A(h);continue;case 37:a.b=Pf;Yf(a,k.type,k);l.push(k.type);A(h);continue;case 45:"and"==k.text.toLowerCase()?(a.b=Pf,Yf(a,52,k),l.push(52),A(h)):Xf(a,"E_CSS_SYNTAX",k);continue;case 39:Yf(a,k.type,k)&&(a.e?a.b=Of:Xf(a,"E_CSS_UNBALANCED_PAR",k));A(h);continue;case 43:Yf(a,11,k)&&(a.e||3==a.g?Xf(a,"E_CSS_UNEXPECTED_BRC",k):(1==a.g?g.Eb(l.pop()):(k=l.pop(),g.Eb(k)),a.f.push("media"),g.qa(),a.b=Jf));A(h);continue;case 49:if(Yf(a,11,k))if(a.e||3!=a.g)Xf(a,
"E_CSS_UNEXPECTED_SEMICOL",k);else return a.k=l.pop(),a.C=!0,a.b=Jf,A(h),!1;A(h);continue;case 40:l.push(k.type);A(h);continue;case 27:a.b=Jf;A(h);g.nb();a.f.length&&a.f.pop();continue;case 30:m=k.text.toLowerCase();switch(m){case "import":A(h);k=y(h);if(2==k.type||8==k.type){a.H=k.text;A(h);k=y(h);if(17==k.type||0==k.type)return a.C=!0,A(h),!1;a.e=null;a.g=3;a.b=Pf;l.push("{");continue}g.error("E_CSS_IMPORT_SYNTAX",k);a.b=Qf;continue;case "namespace":A(h);k=y(h);switch(k.type){case 1:m=k.text;A(h);
...
function kg(a,b,c){if(b.wd())a:{b=b.d;a=b.evaluate(a);switch(typeof a){case "number":c=jg[c]?a==Math.round(a)?new nd(a):new md(a):new H(a,"px");break a;case "string":c=a?ig(b.b,new Tb(a,null)):F;break a;case "boolean":c=a?je:Fd;break a;case "undefined":c=F;break a}throw Error("E_UNEXPECTED");}else c=b;return c};function lg(){this.b={}}t(lg,bd);lg.prototype.vb=function(a){this.b[a.name]=!0;return a};lg.prototype.gb=function(a){this.wb(a.values);return a};function mg(a){this.value=a}t(mg,bd);mg.prototype.Rb=function(a){this.value=a.B;return a};function ng(a,b){if(a){var c=new mg(b);try{return a.U(c),c.value}catch(d){u.b(d,"toInt: ")}}return b}function og(){this.d=!1;this.b=[];this.name=null}t(og,bd);og.prototype.Tb=function(a){this.d&&this.b.push(a);return null};
og.prototype.Sb=function(a){this.d&&0==a.B&&this.b.push(new H(0,"px"));return null};og.prototype.gb=function(a){this.wb(a.values);return null};og.prototype.kb=function(a){this.d||(this.d=!0,this.wb(a.values),this.d=!1,this.name=a.name.toLowerCase());return null};
function pg(a,b,c,d,e,f){if(a){var g=new og;try{a.U(g);var h;a:{if(0<g.b.length){a=[];for(var l=0;l<g.b.length;l++){var k=g.b[l];if("%"==k.X){var m=0==l%2?d:e;3==l&&"circle"==g.name&&(m=Math.sqrt((d*d+e*e)/2));a.push(k.B*m/100)}else a.push(k.B*pc(f,k.X,!1))}switch(g.name){case "polygon":if(0==a.length%2){f=[];for(g=0;g<a.length;g+=2)f.push({x:b+a[g],y:c+a[g+1]});h=new we(f);break a}break;case "rectangle":if(4==a.length){h=ze(b+a[0],c+a[1],b+a[0]+a[2],c+a[1]+a[3]);break a}break;case "ellipse":if(4==
...
function Wg(){this.e={};this.k={};this.h={};this.b={};this.d={};this.f={};this.j=[];this.g=[]}function Xg(a,b){var c;if(3==b.type)c=new H(b.B,b.text);else if(7==b.type)c=zf(b.text);else if(1==b.type)c=G(b.text);else throw Error("unexpected replacement");if(Bg(a)){var d=a.b[0].b.d,e;for(e in d)d[e]=c;return a}throw Error("unexpected replacement");}
...
d.push(p.clone())}else p={},p[g.text]=G(g.text),d.push(Zg(new Cg(0,p,T)));h=!1;break;case 5:p={};p[""+g.B]=new nd(g.B);d.push(Zg(new Cg(0,p,T)));h=!1;break;case 34:k("|");break;case 25:k("||");break;case 14:h||k(" ");e.push({Ed:d,Ad:f,Vb:"["});f="";d=[];h=!0;break;case 6:h||k(" ");e.push({Ed:d,Ad:f,Vb:"(",Kb:g.text});f="";d=[];h=!0;break;case 15:g=l();p=e.pop();if("["!=p.Vb)throw Error("']' unexpected");d=p.Ed;d.push(g);f=p.Ad;h=!1;break;case 11:g=l();p=e.pop();if("("!=p.Vb)throw Error("')' unexpected");
d=p.Ed;d.push($g(p.Kb,g));f=p.Ad;h=!1;break;case 18:if(h)throw Error("':' unexpected");A(b);d.push(Xg(d.pop(),y(b)));break;case 22:if(h)throw Error("'?' unexpected");d.push(Yg(d.pop(),0,1));break;case 36:if(h)throw Error("'*' unexpected");d.push(Yg(d.pop(),0,Number.POSITIVE_INFINITY));break;case 23:if(h)throw Error("'+' unexpected");d.push(Yg(d.pop(),1,Number.POSITIVE_INFINITY));break;case 12:A(b);g=y(b);if(5!=g.type)throw Error("<int> expected");var r=p=g.B;A(b);g=y(b);if(16==g.type){A(b);g=y(b);
if(5!=g.type)throw Error("<int> expected");r=g.B;A(b);g=y(b)}if(13!=g.type)throw Error("'}' expected");d.push(Yg(d.pop(),p,r));break;case 17:m=l();if(0<e.length)throw Error("unclosed '"+e.pop().Vb+"'");break;default:throw Error("unexpected token");}A(b);bh(c)?a.b[c]=m:a.e[c]=1!=m.b.length||0!=m.b[0].d?new Hg(m):m.b[0].b}}
...
var gh=new xf(function(){var a=L("loadValidatorSet.load"),b=va("validation.txt",ua),c=rf(b),d=new Wg;ah(d);c.then(function(c){try{if(c.responseText){var f=new Tb(c.responseText,null);for(dh(d,f);;){var g=ch(d,f,2);if(!g)break;for(c=[];;){A(f);var h=y(f);if(17==h.type){A(f);break}switch(h.type){case 1:c.push(G(h.text));break;case 4:c.push(new md(h.B));break;case 5:c.push(new nd(h.B));break;case 3:c.push(new H(h.B,h.text));break;default:throw Error("unexpected token");}}d.h[g]=1<c.length?new dd(c):
...
function ii(a,b){if(a===b)return!0;if(!a||!b||a.ea!==b.ea||a.J!==b.J||a.ha.length!==b.ha.length)return!1;for(var c=0;c<a.ha.length;c++){var d=a[c],e=b[c];if(!(d===e||d&&e&&d.ga===e.ga&&d.Ha===e.Ha&&d.fa===e.fa&&d.sa===e.sa&&d.pa===e.pa))return!1}return!0}function ji(a,b,c,d,e,f,g){this.aa=a;this.ed=d;this.Dd=null;this.root=b;this.$=c;this.type=f;e&&(e.Dd=this);this.b=g}function ki(a,b){this.he=a;this.count=b}
function li(a,b,c){this.Z=a;this.parent=b;this.ia=c;this.ea=0;this.J=!1;this.Ha=0;this.fa=b?b.fa:null;this.pa=this.sa=null;this.S=!1;this.e=!0;this.d=!1;this.j=b?b.j:0;this.l=this.k=this.ca=this.display=null;this.C=!1;this.w=b?b.w:0;this.H=this.I=!1;this.u=this.A=this.D=this.h=null;this.g=b?b.g:{};this.b=b?b.b:!1;this.O=b?b.O:"ltr";this.f=b?b.f:null}
function mi(a){a.e=!0;a.j=a.parent?a.parent.j:0;a.A=null;a.u=null;a.ea=0;a.J=!1;a.display=null;a.k=null;a.l=null;a.C=!1;a.w=a.parent?a.parent.w:0;a.h=null;a.D=null;a.sa=null;a.I=!1;a.H=!1;a.b=a.parent?a.parent.b:!1;a.sa=null}function ni(a){var b=new li(a.Z,a.parent,a.ia);b.ea=a.ea;b.J=a.J;b.sa=a.sa;b.Ha=a.Ha;b.fa=a.fa;b.pa=a.pa;b.e=a.e;b.j=a.j;b.display=a.display;b.k=a.k;b.l=a.l;b.I=a.I;b.H=a.H;b.C=a.C;b.w=a.w;b.h=a.h;b.D=a.D;b.A=a.A;b.u=a.u;b.f=a.f;b.b=a.b;b.d=a.d;return b}
li.prototype.modify=function(){return this.S?ni(this):this};function oi(a){var b=a;do{if(b.S)break;b.S=!0;b=b.parent}while(b);return a}li.prototype.clone=function(){for(var a=ni(this),b=a,c;null!=(c=b.parent);)c=ni(c),b=b.parent=c;return a};function pi(a){return{ga:a.Z,Ha:a.Ha,fa:a.fa,sa:a.sa,pa:a.pa?pi(a.pa):null}}function qi(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(pi(b)),b=b.parent;while(b);return{ha:c,ea:a.ea,J:a.J}}
...
function Bi(a){this.element=a;this.D=this.C=this.height=this.width=this.l=this.j=this.u=this.h=this.Aa=this.S=this.Ua=this.O=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.yb=this.H=null;this.ma=this.zb=this.bb=this.Gb=this.d=0;this.b=!1}function Ci(a){return a.marginTop+a.S+a.j}function Di(a){return a.marginBottom+a.Aa+a.l}function Ei(a){return a.marginLeft+a.O+a.h}function Fi(a){return a.marginRight+a.Ua+a.u}
function Gi(a,b){a.element=b.element;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.O=b.O;a.Ua=b.Ua;a.S=b.S;a.Aa=b.Aa;a.h=b.h;a.u=b.u;a.j=b.j;a.l=b.l;a.width=b.width;a.height=b.height;a.C=b.C;a.D=b.D;a.yb=b.yb;a.H=b.H;a.d=b.d;a.Gb=b.Gb;a.bb=b.bb;a.b=b.b}function Hi(a,b,c){a.top=b;a.height=c;v(a.element,"top",b+"px");v(a.element,"height",c+"px")}
...
function sj(a,b){if(0<a.length){a.sort(function(a,b){return b.d()-a.d()});for(var c=null,d=a.length-1;0<=d;d--)c=a[d],c.b=b,b=c;return c}return b}function tj(a,b){this.e=a;this.b=b;this.d=""}t(tj,cd);function uj(a){a=a.e["font-size"].value;var b;a:switch(a.X.toLowerCase()){case "px":case "in":case "pt":case "pc":case "cm":case "mm":case "q":b=!0;break a;default:b=!1}if(!b)throw Error("Unexpected state");return a.B*lc[a.X]}
tj.prototype.Tb=function(a){if("em"==a.X||"ex"==a.X){var b=pc(this.b,a.X,!1)/pc(this.b,"em",!1);return new H(a.B*b*uj(this),"px")}if("rem"==a.X||"rex"==a.X)return b=pc(this.b,a.X,!1)/pc(this.b,"rem",!1),new H(a.B*b*this.b.fontSize(),"px");if("%"==a.X){if("font-size"===this.d)return new H(a.B/100*uj(this),"px");b=this.d.match(/height|^(top|bottom)$/)?"vh":"vw";return new H(a.B,b)}return a};tj.prototype.Qb=function(a){return"font-size"==this.d?kg(this.b,a,this.d).U(this):a};function vj(){}
vj.prototype.apply=function(){};vj.prototype.h=function(a){return new wj([this,a])};vj.prototype.clone=function(){return this};function xj(a){this.b=a}t(xj,vj);xj.prototype.apply=function(a){a.g[a.g.length-1].push(this.b.b())};function wj(a){this.b=a}t(wj,vj);wj.prototype.apply=function(a){for(var b=0;b<this.b.length;b++)this.b[b].apply(a)};wj.prototype.h=function(a){this.b.push(a);return this};wj.prototype.clone=function(){return new wj([].concat(this.b))};
function yj(a,b,c,d){this.style=a;this.P=b;this.b=c;this.f=d}t(yj,vj);yj.prototype.apply=function(a){rj(a.h,a.u,this.style,this.P,this.b,this.f)};function V(){this.b=null}t(V,vj);V.prototype.apply=function(a){this.b.apply(a)};V.prototype.d=function(){return 0};V.prototype.e=function(){return!1};function zj(a){this.b=null;this.f=a}t(zj,V);zj.prototype.apply=function(a){0<=a.w.indexOf(this.f)&&this.b.apply(a)};zj.prototype.d=function(){return 10};
zj.prototype.e=function(a){this.b&&Aj(a.va,this.f,this.b);return!0};function Bj(a){this.b=null;this.id=a}t(Bj,V);Bj.prototype.apply=function(a){a.O!=this.id&&a.ca!=this.id||this.b.apply(a)};Bj.prototype.d=function(){return 11};Bj.prototype.e=function(a){this.b&&Aj(a.e,this.id,this.b);return!0};function Cj(a){this.b=null;this.localName=a}t(Cj,V);Cj.prototype.apply=function(a){a.d==this.localName&&this.b.apply(a)};Cj.prototype.d=function(){return 8};
Cj.prototype.e=function(a){this.b&&Aj(a.jc,this.localName,this.b);return!0};function Dj(a,b){this.b=null;this.f=a;this.localName=b}t(Dj,V);Dj.prototype.apply=function(a){a.d==this.localName&&a.e==this.f&&this.b.apply(a)};Dj.prototype.d=function(){return 8};Dj.prototype.e=function(a){if(this.b){var b=a.b[this.f];b||(b="ns"+a.g++ +":",a.b[this.f]=b);Aj(a.f,b+this.localName,this.b)}return!0};function Ej(a){this.b=null;this.f=a}t(Ej,V);
Ej.prototype.apply=function(a){var b=a.b;if(b&&"a"==a.d){var c=b.getAttribute("href");c&&c.match(/^#/)&&(b=b.ownerDocument.getElementById(c.substring(1)))&&(b=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))&&b.match(this.f)&&this.b.apply(a)}};function Fj(a){this.b=null;this.f=a}t(Fj,V);Fj.prototype.apply=function(a){a.e==this.f&&this.b.apply(a)};function Gj(a,b){this.b=null;this.f=a;this.name=b}t(Gj,V);Gj.prototype.apply=function(a){a.b&&a.b.hasAttributeNS(this.f,this.name)&&this.b.apply(a)};
function Hj(a,b,c){this.b=null;this.f=a;this.name=b;this.value=c}t(Hj,V);Hj.prototype.apply=function(a){a.b&&a.b.getAttributeNS(this.f,this.name)==this.value&&this.b.apply(a)};Hj.prototype.d=function(){return"type"==this.name&&"http://www.idpf.org/2007/ops"==this.f?9:0};Hj.prototype.e=function(a){return"type"==this.name&&"http://www.idpf.org/2007/ops"==this.f?(this.b&&Aj(a.d,this.value,this.b),!0):!1};function Ij(a,b){this.b=null;this.f=a;this.name=b}t(Ij,V);
Ij.prototype.apply=function(a){if(a.b){var b=a.b.getAttributeNS(this.f,this.name);b&&aj[b]&&this.b.apply(a)}};Ij.prototype.d=function(){return 0};Ij.prototype.e=function(){return!1};function Jj(a,b,c){this.b=null;this.g=a;this.name=b;this.f=c}t(Jj,V);Jj.prototype.apply=function(a){if(a.b){var b=a.b.getAttributeNS(this.g,this.name);b&&b.match(this.f)&&this.b.apply(a)}};function Kj(a){this.b=null;this.f=a}t(Kj,V);Kj.prototype.apply=function(a){a.lang.match(this.f)&&this.b.apply(a)};
function Lj(){this.b=null}t(Lj,V);Lj.prototype.apply=function(a){a.Ua&&this.b.apply(a)};Lj.prototype.d=function(){return 6};function Mj(){this.b=null}t(Mj,V);Mj.prototype.apply=function(a){a.ma&&this.b.apply(a)};Mj.prototype.d=function(){return 12};function Nj(a,b){this.b=null;this.f=a;this.Vb=b}t(Nj,V);function Oj(a,b){var c=a.f;b-=a.Vb;return 0===c?0===b:0===b%c&&0<=b/c}function Pj(a,b){Nj.call(this,a,b)}t(Pj,Nj);Pj.prototype.apply=function(a){Oj(this,a.Aa)&&this.b.apply(a)};Pj.prototype.d=function(){return 5};
function Qj(a,b){Nj.call(this,a,b)}t(Qj,Nj);Qj.prototype.apply=function(a){Oj(this,a.bb[a.e][a.d])&&this.b.apply(a)};Qj.prototype.d=function(){return 5};function Rj(a,b){Nj.call(this,a,b)}t(Rj,Nj);Rj.prototype.apply=function(a){var b=a.I;null===b&&(b=a.I=a.b.parentNode.childElementCount-a.Aa+1);Oj(this,b)&&this.b.apply(a)};Rj.prototype.d=function(){return 4};function Sj(a,b){Nj.call(this,a,b)}t(Sj,Nj);
Sj.prototype.apply=function(a){var b=a.ab;if(!b[a.e]){var c=a.b;do{var d=c.namespaceURI,e=c.localName,f=b[d];f||(f=b[d]={});f[e]=(f[e]||0)+1}while(c=c.nextElementSibling)}Oj(this,b[a.e][a.d])&&this.b.apply(a)};Sj.prototype.d=function(){return 4};function Tj(){this.b=null}t(Tj,V);Tj.prototype.apply=function(a){for(var b=a.b.firstChild;b;){switch(b.nodeType){case Node.ELEMENT_NODE:return;case Node.TEXT_NODE:if(0<b.length)return}b=b.nextSibling}this.b.apply(a)};Tj.prototype.d=function(){return 4};
function Uj(){this.b=null}t(Uj,V);Uj.prototype.apply=function(a){!1===a.b.disabled&&this.b.apply(a)};Uj.prototype.d=function(){return 5};function Vj(){this.b=null}t(Vj,V);Vj.prototype.apply=function(a){!0===a.b.disabled&&this.b.apply(a)};Vj.prototype.d=function(){return 5};function Wj(){this.b=null}t(Wj,V);Wj.prototype.apply=function(a){var b=a.b;!0!==b.selected&&!0!==b.checked||this.b.apply(a)};Wj.prototype.d=function(){return 5};function Xj(a){this.b=null;this.M=a}t(Xj,V);
Xj.prototype.apply=function(a){a.j[this.M]&&this.b.apply(a)};Xj.prototype.d=function(){return 5};function Yj(){this.b=!1}t(Yj,vj);Yj.prototype.apply=function(){this.b=!0};Yj.prototype.clone=function(){var a=new Yj;a.b=this.b;return a};function Zj(a){this.b=null;this.f=new Yj;this.g=sj(a,this.f)}t(Zj,V);Zj.prototype.apply=function(a){this.g.apply(a);this.f.b||this.b.apply(a);this.f.b=!1};Zj.prototype.d=function(){return this.g.d()};function ak(a){this.M=a}ak.prototype.b=function(){return this};
ak.prototype.push=function(a,b){0==b&&bk(a,this.M);return!1};ak.prototype.pop=function(a,b){return 0==b?(a.j[this.M]--,!0):!1};function ck(a){this.M=a}ck.prototype.b=function(){return this};ck.prototype.push=function(a,b){0==b?bk(a,this.M):1==b&&a.j[this.M]--;return!1};ck.prototype.pop=function(a,b){if(0==b)return a.j[this.M]--,!0;1==b&&bk(a,this.M);return!1};function dk(a){this.M=a;this.d=!1}dk.prototype.b=function(){return new dk(this.M)};
dk.prototype.push=function(a){return this.d?(a.j[this.M]--,!0):!1};dk.prototype.pop=function(a,b){if(this.d)return a.j[this.M]--,!0;0==b&&(this.d=!0,bk(a,this.M));return!1};function ek(a){this.M=a;this.d=!1}ek.prototype.b=function(){return new ek(this.M)};ek.prototype.push=function(a,b){this.d&&(-1==b?bk(a,this.M):0==b&&a.j[this.M]--);return!1};ek.prototype.pop=function(a,b){if(this.d){if(-1==b)return a.j[this.M]--,!0;0==b&&bk(a,this.M)}else 0==b&&(this.d=!0,bk(a,this.M));return!1};
function fk(a,b){this.d=a;this.element=b}fk.prototype.b=function(){return this};fk.prototype.push=function(){return!1};fk.prototype.pop=function(a,b){return 0==b?(gk(a,this.d,this.element),!0):!1};function hk(a){this.lang=a}hk.prototype.b=function(){return this};hk.prototype.push=function(){return!1};hk.prototype.pop=function(a,b){return 0==b?(a.lang=this.lang,!0):!1};function ik(a){this.d=a}ik.prototype.b=function(){return this};ik.prototype.push=function(){return!1};
ik.prototype.pop=function(a,b){return 0==b?(a.D=this.d,!0):!1};function jk(a){this.element=a}t(jk,cd);function kk(a,b){switch(b){case "url":return a?new pd(a):new pd("about:invalid");default:return a?new kd(a):new kd("")}}
...
function Dk(a,b,c,d){this.k=a;this.h=b;this.Gb=c;this.$a=d;this.g=[[],[]];this.j={};this.w=this.u=this.b=null;this.ra=this.ca=this.O=this.e=this.d="";this.S=this.H=null;this.ma=this.Ua=!0;this.f={};this.C=[{}];this.D=[new kd("\u201c"),new kd("\u201d"),new kd("\u2018"),new kd("\u2019")];this.l=0;this.lang="";this.zb=[0];this.Aa=0;this.ka=[{}];this.bb=this.ka[0];this.I=null;this.xb=[this.I];this.yb=[{}];this.ab=this.ka[0];this.hb=[]}function bk(a,b){a.j[b]=(a.j[b]||0)+1}
function Ek(a,b,c){(b=b[c])&&b.apply(a)}var Fk=[];function Gk(a,b,c,d){a.b=null;a.u=d;a.e="";a.d="";a.O="";a.ca="";a.w=b;a.ra="";a.H=Fk;a.S=c;Hk(a)}function Ik(a,b,c){a.f[b]?a.f[b].push(c):a.f[b]=[c];c=a.C[a.C.length-1];c||(c={},a.C[a.C.length-1]=c);c[b]=!0}
...
function vl(a,b,c,d,e,f,g,h){this.$=a;this.root=a.root;this.Aa=c;this.f=d;this.j=f;this.d=this.root;this.H={};this.I={};this.l={};this.w=[];this.k=this.D=this.C=null;this.O=new Dk(b,d,g,h);this.e=new dl;this.Oa=!0;this.ca=[];this.ra=e;this.ma=this.ka=!1;this.b=a=xh(a,this.root);this.S={};this.g=new rl(d);fl(this.e,a);d=wl(this,this.root);Mk(this.O,this.root,d);xl(this,d,!1);this.u=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.u=
...
function xl(a,b,c){c||["writing-mode","direction"].forEach(function(a){b[a]&&(this.H[a]=b[a])},a);if(!a.ka){var d=zl(a,b,a.j.g,"background-color")?b["background-color"].evaluate(a.f):null,e=zl(a,b,a.j.g,"background-image")?b["background-image"].evaluate(a.f):null;if(d&&d!==Kd||e&&e!==Kd)Bl(a,b,a.j.g),a.ka=!0}if(!a.ma)for(d=0;d<Fl.length;d++)if(zl(a,b,a.j.j,Fl[d])){Bl(a,b,a.j.j);a.ma=!0;break}if(!c&&(c=b["font-size"])){d=c.evaluate(a.f);c=d.B;switch(d.X){case "em":case "rem":c*=a.f.j;break;case "ex":case "rex":c*=
a.f.j*lc.ex/lc.em;break;case "%":c*=a.f.j/100;break;default:(d=lc[d.X])&&(c*=d)}a.f.S=c}}function Gl(a){for(var b=0;!a.u&&(b+=5E3,Hl(a,b,0)!=Number.POSITIVE_INFINITY););return a.H}function wl(a,b){if(b.style instanceof CSSStyleDeclaration){var c=b.getAttribute("style");if(c){var d=a.$.url,e=new Zk(a.Aa,a.j),c=new Tb(c,e);try{cg(new Uf(Kf,c,e,d),Number.POSITIVE_INFINITY,!1,!0,!1,!1)}catch(f){u.b(f,"Style attribute parse error:")}return e.b}}return{}}
function yl(a,b){if(!(b>=a.b)){var c=a.f,d=xh(a.$,a.root);if(b<d){var e=a.h(a.root,!1),f=e["flow-into"],f=f?f.evaluate(c,"flow-into").toString():"body",f=Il(a,f,e,a.root,d);0===a.g.b.length&&a.g.push(e,d,!0,f)}d=Ah(a.$,b);e=yh(a.$,d,0,!1);if(!(e>=a.b))for(;;){if(1!=d.nodeType)e+=d.textContent.length;else{var g=d;if(e!=xh(a.$,g))throw Error("Inconsistent offset");var h=a.h(g,!1);if(f=h["flow-into"])f=f.evaluate(c,"flow-into").toString(),Il(a,f,h,g,e);e++}if(e>=a.b)break;f=d.firstChild;if(null==f)for(;!(f=
d.nextSibling);)if(d=d.parentNode,d===a.root)return;d=f}}}function Jl(a,b){a.C=b;for(var c=0;c<a.w.length;c++)Kl(a.C,a.w[c],a.l[a.w[c].b])}
...
a.w.push(d);a.D==b&&(a.D=null);a.C&&Kl(a.C,d,p);return d}function Ll(a,b,c,d){pl[b]&&(d=a.l[d].b,(0===d.length||d[d.length-1]<c)&&d.push(c));a.S[c]=nl(a.S[c],b)}
...
null);a.u||"body"!=g.localName||g.parentNode!=a.root||(xl(a,f,!0),a.u=!0);if(h=f["flow-into"]){var h=h.evaluate(e,"flow-into").toString(),l=Il(a,h,f,g,a.b);a.Oa=!!a.ra[h];g=a.g.push(f,a.b,g===a.root,l)}else g=a.g.push(f,a.b,g===a.root);h=ul(a.g,g);Ll(a,g.e,h,g.b);g.f&&(l=ol(g.f,"after"),Ll(a,l,g.f.Ea?h:g.offset,g.b));a.Oa&&ql(g)===K&&(a.Oa=!1);if(xh(a.$,a.d)!=a.b)throw Error("Inconsistent offset");a.I["e"+a.b]=f;a.b++;a.Oa?fl(a.e,a.b):gl(a.e,a.b);if(b<a.b&&(0>d&&(d=hl(a.e,b),d+=c),d<=el(a.e)))return il(a.e,
d)}}}vl.prototype.h=function(a,b){var c=xh(this.$,a),d="e"+c;b&&(c=yh(this.$,a,0,!0));this.b<=c&&Hl(this,c,0);return this.I[d]};var Ml=1;function Nl(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.index=0;this.d=a;this.name=b;this.tb=c;this.va=d;this.parent=e;this.g="p"+Ml++;e&&(this.index=e.children.length,e.children.push(this))}Nl.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Nl.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Ol(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
...
function cm(a,b){this.e=a;this.d=b;this.D={};this.style={};this.k=this.l=null;this.children=[];this.H=this.I=this.f=this.g=!1;this.w=this.C=0;this.u=null;this.ka={};this.ca={};this.ra=this.b=!1;a&&a.children.push(this)}function dm(a){a.C=0;a.w=0}function em(a,b,c){b=Sl(a,b);c=Sl(a,c);if(!b||!c)throw Error("E_INTERNAL");return C(a.d.d,b,c)}
...
function im(a,b){b.ka[a.d.g]=a;var c=a.d.d,d=a.style,e=a.e?jm(a.e,b):null,e=al(a.D,b,e,!1);a.b=$k(e,b,a.e?a.e.b:!1);bl(e,d,a.b,function(a,b){return b.value});a.l=new ic(c,function(){return a.C},"autoWidth");a.k=new ic(c,function(){return a.w},"autoHeight");a.Wc();a.Xc();gm(a);fm(a)}function km(a,b,c){(a=a.style[c])&&(a=kg(b,a,c));return a}function Y(a,b,c){(a=a.style[c])&&(a=kg(b,a,c));return rd(a,b)}
function jm(a,b){var c;a:{if(c=a.D["region-id"]){for(var d=[],e=0;e<c.length;e++){var f=c[e].evaluate(b,"");f&&f!==F&&d.push(f)}if(d.length){c=d;break a}}c=null}if(c){d=[];for(e=0;e<c.length;e++)d[e]=c[e].toString();return d}return null}function lm(a,b,c,d,e){if(a=km(a,b,d))a.$b()&&mc(a.X)&&(a=new H(rd(a,b),"px")),"font-family"===d&&(a=oh(e,a)),v(c.element,d,a.toString())}
...
cm.prototype.tc=function(a,b,c,d,e,f,g){this.b?this.C=b.d+b.zb:this.w=b.d+b.ma;f=(this.b||!d)&&this.f;var h=(!this.b||!d)&&this.g,l=null;if(h||f)h&&v(b.element,"width","auto"),f&&v(b.element,"height","auto"),l=(d?d.element:b.element).getBoundingClientRect(),h&&(this.C=Math.ceil(l.right-l.left-b.h-b.O-b.u-b.Ua),this.b&&(this.C+=b.zb)),f&&(this.w=l.bottom-l.top-b.j-b.S-b.l-b.Aa,this.b||(this.w+=b.ma));(this.b?this.f:this.g)&&qm(this,a,b);if(this.b?this.g:this.f){if(this.b?this.H:this.I)this.b?nm(this,
...
function Dm(a,b,c,d){Bm.call(this,a,b,c,d);c.b.width=new U(ke,0);c.b.height=new U(ke,0)}t(Dm,Bm);Dm.prototype.ic=function(a,b,c){a=new Xl(this.d,a,b,c,this.target);Ef(this.aa,new Cm(this.d,this.aa,a,this.b))};Dm.prototype.hc=function(a,b,c){a=new Vl(this.d,a,b,c,this.target);a=new Dm(this.d,this.aa,a,this.b);Ef(this.aa,a)};function Em(a,b,c,d){Bm.call(this,a,b,c,d)}t(Em,Bm);Em.prototype.ic=function(a,b,c){a=new Xl(this.d,a,b,c,this.target);Ef(this.aa,new Cm(this.d,this.aa,a,this.b))};
Em.prototype.hc=function(a,b,c){a=new Vl(this.d,a,b,c,this.target);a=new Dm(this.d,this.aa,a,this.b);Ef(this.aa,a)};var Fm={"text-indent":"0px","margin-top":"0px","padding-top":"0px","border-top-width":"0px","border-top-style":"none","border-top-color":"transparent","border-top-left-radius":"0px","border-top-right-radius":"0px"},Gm={"text-indent":"0px","margin-right":"0px","padding-right":"0px","border-right-width":"0px","border-right-style":"none","border-right-color":"transparent","border-top-right-radius":"0px","border-bottom-right-radius":"0px"},Hm={"margin-top":"0px"},Im={"margin-right":"0px"},Jm={};
...
function Pm(a,b,c,d,e,f,g,h,l,k,m,p,r,w){this.w=a;this.d=b;this.viewport=c;this.l=c.b;this.h=d;this.D=e;this.$=f;this.C=g;this.k=h;this.H=l;this.page=k;this.f=m;this.u=p;this.e=r;this.j=w;this.I=this.b=null;this.g=!1;this.Z=null;this.ea=0;this.A=null}Pm.prototype.clone=function(){return new Pm(this.w,this.d,this.viewport,this.h,this.D,this.$,this.C,this.k,this.H,this.page,this.f,this.u,this.e,this.j)};
function Qm(a,b,c,d,e,f){var g=L("createRefShadow");a.$.j.load(b).then(function(h){if(h){var l=Ch(h,b);if(l){var k=a.H,m=k.C[h.url];if(!m){var m=k.style.h.b[h.url],p=new nc(0,k.qb(),k.pb(),k.j),m=new vl(h,m.e,m.d,p,k.g,m.j,new Rm(k.f,h.url),new Sm(k.f,h.url,m.d,m.b));k.C[h.url]=m}f=new ji(d,l,h,e,f,c,m)}}O(g,f)});return N(g)}
function Tm(a,b,c,d,e,f,g,h){var l=L("createShadows"),k=e.template,m;k instanceof pd?m=Qm(a,k.url,2,b,h,null):m=M(null);m.then(function(k){var m=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var w=b.getAttribute("href"),q=null;w?q=h?h.$:a.$:h&&(w="http://www.w3.org/1999/xhtml"==h.aa.namespaceURI?h.aa.getAttribute("href"):h.aa.getAttributeNS("http://www.w3.org/1999/xlink","href"),q=h.ed?h.ed.$:a.$);w&&(w=va(w,q.url),m=Qm(a,w,3,b,h,k))}null==m&&(m=M(k));m.then(function(k){var m;
...
q.appendChild(J);E.match(/^first-/)&&(q=J)}k=p.length?new ji(b,r,null,h,k,2,new Om(b,d,f,g)):k}O(l,k)})});return N(l)}function Um(a,b,c){a.I=b;a.g=c}function Vm(a,b,c,d){var e=a.d;c=al(c,e,a.D,a.g);b=$k(c,e,b);bl(c,d,b,function(b,c){var d=c.evaluate(e,b);"font-family"==b&&(d=oh(a.C,d));return d});var f=Mi(d.display||Ld,d.position,d["float"],a.Z===a.$.root);["display","position","float"].forEach(function(a){f[a]&&(d[a]=f[a])});return b}
function Wm(a,b){for(var c=a.b.Z,d=[],e=a.b.fa,f=-1;c&&1==c.nodeType;){var g=e&&e.root==c;if(!g||2==e.type){var h=(e?e.b:a.h).h(c,!1);d.push(h)}g?(c=e.aa,e=e.ed):(c=c.parentNode,f++)}c=pc(a.d,"em",0===f);c={"font-size":new U(new H(c,"px"),0)};e=new tj(c,a.d);for(f=d.length-1;0<=f;--f){var g=d[f],h=[],l;for(l in g)Zi[l]&&h.push(l);h.sort(pe);for(var k=0;k<h.length;k++){var m=h[k];e.d=m;var p=g[m];p.value!==Kd&&(c[m]=p.sc(e))}}for(var r in b)Zi[r]||(c[r]=b[r]);return c}
var Xm={a:"a",sub:"sub",sup:"sup",table:"table",tr:"tr",td:"td",th:"th",code:"code",body:"div",p:"p",v:"p",date:"p",emphasis:"em",strong:"strong",style:"span",strikethrough:"del"};function Ym(a,b){b=va(b,a.$.url);return a.u[b]||b}
function Zm(a,b){var c=$i.filter(function(a){return b[a]});if(c.length){var d=a.b.g;if(a.b.parent){var d=a.b.g={},e;for(e in a.b.parent.g)d[e]=a.b.parent.g[e]}c.forEach(function(a){var c=b[a];if(c){if(c instanceof nd)d[a]=c.B;else if(c instanceof ld)d[a]=c.name;else if(c instanceof H)switch(c.X){case "dpi":case "dpcm":case "dppx":d[a]=c.B*lc[c.X]}delete b[a]}})}}
function $m(a,b,c){var d=!0,e=L("createElementView"),f=a.Z,g=a.b.fa?a.b.fa.b:a.h,h=g.h(f,!1),l={};a.b.parent||(h=Wm(a,h));a.b.b=Vm(a,a.b.b,h,l);Zm(a,l);l.direction&&(a.b.O=l.direction.toString());var k=l["flow-into"];if(k&&k.toString()!=a.w)return O(e,!1),N(e);var m=l.display;if(m===K)return O(e,!1),N(e);k=null==a.b.parent;a.b.C=m===Hd;Tm(a,f,k,h,l,g,a.d,a.b.fa).then(function(g){a.b.sa=g;var h=l.position;g=l["float-reference"];var k=l["float"],q=l.clear,x=a.b.b?he:Jd;a.b.I=Ni(m,h,k,l.overflow,x,a.b.parent?
...
Mb)continue;else"http://www.w3.org/1999/xlink"==Mb&&"href"==ya&&(J=Ym(a,J));else{if(ya.match(/^on/))continue;if("style"==ya)continue;if(("id"==ya||"name"==ya)&&b){J=a.j.ld(J,a.$.url);g.setAttribute(ya,J);Zh(a.page,g,J);continue}"src"==ya||"href"==ya||"poster"==ya?(J=Ym(a,J),"href"===ya&&(J=a.j.b(J,a.$.url))):"srcset"==ya&&(J=J.split(",").map(function(b){return Ym(a,b.trim())}).join(","));if("poster"===ya&&"video"===E&&"http://www.w3.org/1999/xhtml"===la&&m&&p){var hc=new Image,Dl=ug(hc,J);Ka.push(Dl);
...
l!==K&&k===K?v(b,"width",h+"px"):l===K&&k!==K?v(b,"height",g+"px"):"%"!==l.X?v(b,"max-width",Math.min(h,rd(l,a.d))+"px"):"%"!==k.X?v(b,"max-height",Math.min(g,rd(k,a.d))+"px"):e?v(b,"height",g+"px"):v(b,"width",h+"px")}else 1>c&&(l=d["min-width"]||ne,k=d["min-height"]||ne,0===l.B&&0===k.B?v(b,"min-width",h+"px"):0!==l.B&&0===k.B?v(b,"width",h+"px"):0===l.B&&0!==k.B?v(b,"height",g+"px"):"%"!==l.X?v(b,"min-width",Math.max(h,rd(l,a.d))+"px"):"%"!==k.X?v(b,"min-height",Math.max(g,rd(k,a.d))+"px"):e?v(b,
"height",g+"px"):v(b,"width",h+"px"))}})}function dn(a,b,c){var d=L("createNodeView"),e=!0;1==a.Z.nodeType?b=$m(a,b,c):(8==a.Z.nodeType?a.A=null:a.A=document.createTextNode(a.Z.textContent.substr(a.ea||0)),b=M(!0));b.then(function(b){e=b;(a.b.A=a.A)&&(b=a.b.parent?a.b.parent.A:a.I)&&b.appendChild(a.A);O(d,e)});return N(d)}function en(a,b,c,d){(a.b=b)?(a.Z=b.Z,a.ea=b.ea):(a.Z=null,a.ea=-1);a.A=null;return a.b?dn(a,c,!!d):M(!0)}
function fn(a){if(null==a.fa||"content"!=a.Z.localName||"http://www.pyroxy.com/ns/shadow"!=a.Z.namespaceURI)return a;var b=a.ia,c=a.fa,d=a.parent,e,f;c.Dd?(f=c.Dd,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.ed,e=c.aa.firstChild,c=2);var g=a.Z.nextSibling;g?(a.Z=g,mi(a)):a.pa?a=a.pa:e?a=null:(a=a.parent.modify(),a.J=!0);if(e)return b=new li(e,d,b),b.fa=f,b.Ha=c,b.pa=a,b;a.ia=b;return a}
function gn(a){var b=a.ia+1;if(a.J){if(!a.parent)return null;if(3!=a.Ha){var c=a.Z.nextSibling;if(c)return a=a.modify(),a.ia=b,a.Z=c,mi(a),fn(a)}if(a.pa)return a=a.pa.modify(),a.ia=b,a;a=a.parent.modify()}else{if(a.sa&&(c=a.sa.root,2==a.sa.type&&(c=c.firstChild),c))return b=new li(c,a,b),b.fa=a.sa,b.Ha=a.sa.type,fn(b);if(c=a.Z.firstChild)return fn(new li(c,a,b));1!=a.Z.nodeType&&(b+=a.Z.textContent.length-1-a.ea);a=a.modify()}a.ia=b;a.J=!0;return a}
...
function bn(a,b,c){var d=c["background-image"];d&&jn(a,d);var d=c.position===Xd,e;for(e in c)if(!kn[e]){var f=c[e];f.$b()&&mc(f.X)&&(f=new H(rd(f,a.d),"px"));Rh[e]||d&&Sh[e]?a.page.h.push(new Th(b,e,f)):v(b,e,f.toString())}}function an(a,b,c,d){if(!b.J){var e=(b.fa?b.fa.b:a.h).h(a.Z,!1);if(e=e._pseudos)if(e=e[c])c={},b.b=Vm(a,b.b,e,c),b=c.content,Ki(b)&&(b.U(new Ji(d,a.d)),delete c.content),bn(a,d,c)}}
function ln(a,b,c){var d=L("peelOff"),e=b.f,f=b.ea,g=b.J;if(0<c)b.A.textContent=b.A.textContent.substr(0,c),f+=c;else if(!g&&b.A&&0==f){var h=b.A.parentNode;h&&h.removeChild(b.A)}for(var l=b.ia+c,k=[];b.f===e;)k.push(b),b=b.parent;var m=k.pop(),p=m.pa;nf(function(){for(;0<k.length;){m=k.pop();b=new li(m.Z,b,l);0==k.length&&(b.ea=f,b.J=g);b.Ha=m.Ha;b.fa=m.fa;b.sa=m.sa;b.pa=m.pa?m.pa:p;p=null;var c=en(a,b,!1);if(c.Ca())return c}return M(!1)}).then(function(){O(d,b)});return N(d)}
...
function nn(a){a&&ti(a,function(a){var c=a.g["box-decoration-break"];c&&"slice"!==c||(c=a.A,a.b?(v(c,"padding-left","0"),v(c,"border-left","none"),v(c,"border-top-left-radius","0"),v(c,"border-bottom-left-radius","0")):(v(c,"padding-bottom","0"),v(c,"border-bottom","none"),v(c,"border-bottom-left-radius","0"),v(c,"border-bottom-right-radius","0")))})}
function Ti(a,b,c){return b.ea===c.ea&&b.J==c.J&&b.ha.length===c.ha.length&&b.ha.every(function(a,b){var f;f=c.ha[b];if(a.fa)if(f.fa){var g=1===a.ga.nodeType?a.ga:a.ga.parentElement,h=1===f.ga.nodeType?f.ga:f.ga.parentElement;f=a.fa.aa===f.fa.aa&&Nm(g)===Nm(h)}else f=!1;else f=a.ga===f.ga;return f}.bind(a))}function on(a){this.b=a}function pn(a){return a.getClientRects()}function qn(a,b){return a.b.getComputedStyle(b,null)}
...
function An(a){for(var b=1;b<a.length;b++){var c=a[b-1],d=a[b];c===d?u.b("validateCheckPoints: duplicate entry"):c.ia>=d.ia?u.b("validateCheckPoints: incorrect boxOffset"):c.Z==d.Z&&(d.J?c.J&&u.b("validateCheckPoints: duplicate after points"):c.J?u.b("validateCheckPoints: inconsistent after point"):d.ia-c.ia!=d.ea-c.ea&&u.b("validateCheckPoints: boxOffset inconsistent with offsetInNode"))}}
...
function Kn(a,b){if(!b.A)return M(b);var c=b.Z,d=L("buildDeepElementView");of(function(d){Gn(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.Z!=c;)g=g.parent;if(null==g){b=f;P(d);return}}hn(a.f,f).then(function(f){(b=f)&&b.Z!=c?In(a.ab,b)?qf(d):(b=b.modify(),b.d=!0,P(d)):P(d)})})}).then(function(){O(d,b)});return N(d)}
...
1)*(a.Pa-d)-(a.b?Ei(e)-Fi(e):Ci(e)+Di(e));if(f&&18>d)return a.element.removeChild(e.element),a.k=null,Sn(a,b,c),M(!0);if(!a.b&&e.top<g)return a.element.removeChild(e.element),Sn(a,b,c),M(!0);var l=L("layoutFootnoteInner");a.b?Ii(e,0,d):Hi(e,g,d);e.C=a.C+a.left+Ei(a);e.D=a.D+a.top+Ci(a);e.H=a.H;var k=new ui(c);f?(Un(e),d=M(!0)):0==e.H.length?(Vn(e),d=M(!0)):d=Wn(e);d.then(function(){Xn(e,k).then(function(d){if(f&&d)a.element.removeChild(e.element),Sn(a,b,c),a.k=null,O(l,!0);else{a.b?(a.ka=a.Pa+(e.d+
...
function ho(a,b){var c=L("layoutBreakableBlock"),d=[];Hn(a,b,d).then(function(e){if(0<a.f.e.b.length)O(c,e);else{var f=d.length-1;if(0>f)O(c,e);else{var f=On(a,e,d,f,d[f].ia),g=Cn(a,f);null==e&&(f+=go(a,d));$n(a,f);var h;b.f?h=bo(a,b,e,d):h=M(e);h.then(function(b){0<d.length&&(a.w.push(new wn(d,d[0].j)),g&&(2!=d.length&&0<a.w.length||d[0].Z!=d[1].Z||!un[d[0].Z.localName])&&b&&(b=b.modify(),b.d=!0));O(c,b)})}}});return N(c)}
...
function oo(a,b,c){function d(){b=k[0]||b;b.A.parentNode.removeChild(b.A);e.g=h}var e=a,f=L("skipEdges"),g=c&&b&&b.J,h=null,l=null,k=[],m=[],p=!1;of(function(a){for(;b;){do if(b.A){if(b.e&&1!=b.A.nodeType){if(bi(b.A,b.w))break;if(!b.J){!c&&pl[h]?d():mo(e,l,null,!0,h)?(b=(l||b).modify(),b.d=!0):(b=b.modify(),b.h=h);P(a);return}}if(!b.J&&(b.l&&no(e,b),b.k||b.C)){k.push(oi(b));h=nl(h,b.h);if(!c&&pl[h])d();else if(mo(e,l,null,!0,h)||!In(e.ab,b))b=(l||b).modify(),b.d=!0;P(a);return}if(1==b.A.nodeType){var f=
...
"pt")));return b}function Wo(a,b){var c={},d=a.Ab.B*pc(b,a.Ab.X,!1),e=a.lb.B*pc(b,a.lb.X,!1),f=d+e,g=a.width;c.qb=g===le?(b.T.Za?Math.floor(b.Aa/2)-b.T.Mb:b.Aa)-2*f:g.B*pc(b,g.X,!1);g=a.height;c.pb=g===me?b.hb-2*f:g.B*pc(b,g.X,!1);c.Ab=d;c.lb=e;c.Rc=f;return c}function Xo(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
...
function Hp(a,b,c,d,e){Rk.call(this,a,b,null,c,null,d,!1);this.I=e;this.C=[];this.e="";this.u=[]}t(Hp,Rk);n=Hp.prototype;n.Ob=function(){this.fb()};n.ib=function(a,b){if(this.e=b)this.b.push(new Ap(b)),this.P+=65536};
...
function Ip(a){var b;a.e||a.u.length?b=[a.e].concat(a.u.sort()):b=null;a.C.push({Bd:b,P:a.P});a.e="";a.u=[]}n.Lb=function(){Ip(this);Rk.prototype.Lb.call(this)};n.qa=function(){Ip(this);Rk.prototype.qa.call(this)};
n.eb=function(a,b,c){if("bleed"!==a&&"marks"!==a||this.C.some(function(a){return null===a.Bd})){Rk.prototype.eb.call(this,a,b,c);var d=this.h[a],e=this.I;if("bleed"===a||"marks"===a)e[""]||(e[""]={}),Object.keys(e).forEach(function(b){oj(e[b],a,d)});else if("size"===a){var f=e[""];this.C.forEach(function(b){var c=new U(d.value,d.Ga+b.P);b=b.Bd?b.Bd.join(""):"";var l=e[b];l?(c=(b=l[a])?lj(null,c,b):c,oj(l,a,c)):(l=e[b]={},oj(l,a,c),f&&["bleed","marks"].forEach(function(a){f[a]&&oj(l,a,f[a])},this))},
this)}}};n.Md=function(a){Aj(this.g.ac,"*",a)};n.Od=function(a){return new Gp(this.h,a)};n.jd=function(a){var b=pj(this.h,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);Ef(this.aa,new Jp(this.d,this.aa,this.k,c))};function Jp(a,b,c,d){Ff.call(this,a,b,!1);this.e=c;this.b=d}t(Jp,Gf);Jp.prototype.cb=function(a,b,c){fh(this.e,a,b,c,this)};Jp.prototype.Zb=function(a,b){Hf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Jp.prototype.Hc=function(a,b){Hf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
...
function Tp(a,b){var c=a.b,d=Sp(a,c);if(d==Number.POSITIVE_INFINITY)return null;for(var e=a.u.children,f,g=0;g<e.length;g++)if(f=e[g],"vivliostyle-page-rule-master"!==f.d.tb){var h=1,l=km(f,a,"utilization");l&&l.yd()&&(h=l.B);var l=pc(a,"em",!1),k=a.qb()*a.pb();a.l=Hl(a.d,d,Math.ceil(h*k/(l*l)));h=a;l=c;k=void 0;for(k in l.b){var m=l.b[k];if(m&&0<m.b.length){var p=m.b[0].b;if(Rp(h,m)===p.d){a:switch(p=m.d,p){case "left":case "right":case "recto":case "verso":break a;default:p=null}m.d=tn(nl(p,m.b[0].b.e))}}}a.k=
...
function Vp(a,b,c,d,e,f,g,h){dm(c);var l=km(c,a,"enabled");if(l&&l!==je)return M(!0);var k=L("layoutContainer"),m=km(c,a,"wrap-flow")===vd,p=c.b?c.g&&c.H:c.f&&c.I,l=km(c,a,"flow-from"),r=a.viewport.b.createElement("div"),w=km(c,a,"position");v(r,"position",w?w.name:"absolute");d.insertBefore(r,d.firstChild);var q=new Bi(r);q.b=c.b;c.sb(a,q,b,a.h,a.e);q.C=e;q.D=f;e+=q.left+q.marginLeft+q.O;f+=q.top+q.marginTop+q.S;var x=!1;if(l&&l.Nd())if(a.I[l.toString()])c.tc(a,q,b,null,1,a.e,a.h),l=M(!0);else{var S=
L("layoutContainer.inner"),X=l.toString(),ga=Y(c,a,"column-count"),Ka=Y(c,a,"column-gap"),la=1<ga?Y(c,a,"column-width"):q.width,l=jm(c,a),E=0,w=km(c,a,"shape-inside"),J=pg(w,0,0,q.width,q.height,a),Al=new Pm(X,a,a.viewport,a.d,l,a.$,a.h,a.style.u,a,b,a.Ua,a.ab,h,a.$a),Cl=new ro(a.f,a.b.page-1),di=0,da=null;of(function(b){for(;di<ga;){var c=di++;if(1<ga){var d=a.viewport.b.createElement("div");v(d,"position","absolute");r.appendChild(d);da=new Bn(d,Al,a.e,Cl);da.b=q.b;da.bb=q.bb;da.Gb=q.Gb;q.b?(v(d,
"margin-left",q.h+"px"),v(d,"margin-right",q.u+"px"),c=c*(la+Ka)+q.j,Ii(da,0,q.width),Hi(da,c,la)):(v(d,"margin-top",q.j+"px"),v(d,"margin-bottom",q.l+"px"),c=c*(la+Ka)+q.h,Hi(da,0,q.height),Ii(da,c,la));da.C=e+q.h;da.D=f+q.j}else da=new Bn(r,Al,a.e,Cl),Gi(da,q),q=da;da.H=p?[]:g;da.yb=J;if(0<=da.width){var k=L("inner");Up(a,da,X).then(function(){da.g&&"column"!=da.g&&(di=ga,"region"!=da.g&&(a.I[X]=!0));O(k,!0)});c=N(k)}else c=M(!0);if(c.Ca()){c.then(function(){0<h.b.length?P(b):(E=Math.max(E,da.d),
qf(b))});return}0<h.b.length||(E=Math.max(E,da.d))}P(b)}).then(function(){q.d=E;c.tc(a,q,b,da,ga,a.e,a.h);O(S,!0)});l=N(S)}else(l=km(c,a,"content"))&&Ki(l)?(w=a.viewport.b.createElement("span"),l.U(new Ji(w,a)),r.appendChild(w),xm(c,a,q,a.h)):c.ra&&(d.removeChild(r),x=!0),x||c.tc(a,q,b,null,1,a.e,a.h),l=M(!0);l.then(function(){if(!c.f||0<Math.floor(q.d)){if(!x&&!m){var l=q.C+q.left,p=q.D+q.top,w=Ei(q)+q.width+Fi(q),E=Ci(q)+q.height+Di(q),X=km(c,a,"shape-outside"),l=pg(X,l,p,w,E,a);g.push(l)}}else if(0==
...
for(var w="",h=0;h<r.length;h++)w+=r[h].url,w+="^",r[h].text&&(w+=r[h].text),w+="^";var q=a.C[w];q?(a.b[d]=q,O(c,b)):(f=a.j[w],f||(f=new xf(function(){var b=L("fetchStylesheet"),c=0,d=new $p(a.g);nf(function(){if(c<r.length){var a=r[c++];d.Pb(a.Ja);return null!==a.text?hg(a.text,d,a.url,a.va,a.media).kd(!0):gg(a.url,d,a.va,a.media)}return M(!1)}).then(function(){q=new Lp(a,d.g,d.j,d.D.g,d.w,d.k,d.l,d.h,d.C,d.u);a.C[w]=q;delete a.j[w];O(b,q)});return N(b)},"FetchStylesheet "+d),a.j[w]=f,f.start()),
...
function nq(a,b){this.f=a;this.h=this.d=this.b=this.g=this.e=null;this.l=b;this.k=null;this.I={};this.lang=null;this.w=0;this.u={};this.O=this.H=this.S=null;this.C={};this.D=null;this.j=Aq(this);yq()&&(aj["http://www.w3.org/1998/Math/MathML"]=!0)}
...
d.wc),Lq(a,b,b.La[a.G]).then(function(){var b=a.d;b.b=b.u.pop();b=a.d;b.e=b.C.pop();qf(c)})):qf(c)}))}}).then(function(){a.F=h;a.G=l;a.na=k;O(d,{page:e,position:c,G:g})})})});return N(d)}
...
function Uq(a,b){u.debug("Navigate to",b);var c=Bq(a.b,ta(b));if(!c){if(a.b.e&&b.match(/^#epubcfi\(/))c=Bq(a.b,a.b.e.url);else if("#"===b.charAt(0)){var d=a.b.j.ke(b);a.b.e?c=Bq(a.b,d[0]):c=d[0];b=c+(d[1]?"#"+d[1]:"")}if(null==c)return M(null)}d=a.b.h[c];if(!d)return a.b.e&&c==Bq(a.b,a.b.e.url)&&(c=b.indexOf("#"),0<=c)?Tq(a,b.substr(c+1)):M(null);d.F!=a.F&&(a.F=d.F,a.G=0);var e=L("navigateTo");Nq(a).then(function(c){var d=Ch(c.$,b);d&&(a.na=xh(c.$,d),a.G=-1);Oq(a).ua(e)});return N(e)}
...
Ao(a.d,k);var m=new Pp(g,f,a.b.lang,l,a.f,a.g,h,a.b.C,k,a.b.j,a.d);m.T=a.T;Qp(m).then(function(){b={item:c,$:f,Ka:m,La:[null],rb:[],complete:!1};a.Nb[a.F]=b;O(e,b)})});return N(e)}function Wq(a){return{F:a.F,G:a.G,na:a.na}}function Xq(a,b){b?(a.F=b.F,a.G=-1,a.na=b.na):(a.F=0,a.G=0,a.na=0);return Pq(a,a.F,a.G)}
n.yc=function(){var a=this.b,b=a.H||a.S;if(!b)return M(null);var c=L("showTOC");this.e||(this.e=new gq(a.f,b.src,a.lang,this.f,this.g,this.T,this,a.C,a.j,this.d));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background=
"#EEE";e.style.border="1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.e.yc(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";O(c,a)});return N(c)};n.uc=function(){this.e&&this.e.uc()};n.zd=function(){return this.e&&this.e.zd()};function Yq(a,b,c,d){var e=this;this.h=a;this.jb=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Aa=c;this.ra=d;a=a.document;this.ka=new ph(a.head,b);this.H=[];this.g=null;this.D=this.d=!1;this.f=this.j=this.e=this.l=null;this.fontSize=16;this.zoom=1;this.S=!1;this.hd=!0;this.T=Wb();this.C=function(){};this.k=function(){};this.O=function(){e.d=!0;e.C()};this.dd=this.dd.bind(this);this.u=function(){};this.w=a.getElementById("vivliostyle-page-rules");
