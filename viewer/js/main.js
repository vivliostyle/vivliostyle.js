 ...
 *
 * Vivliostyle core 2019.1.103-pre.20190309101549
 */
(function(factory) {
...
function Yk(a,b,c){this.M=a;this.parent=b;this.Ma=c;this.na=0;this.K=!1;this.kb=Wk;this.wa=b?b.wa:null;this.Fa=this.Ja=null;this.Ba=!1;this.ya=!0;this.xa=!1;this.j=b?b.j:0;this.display=null;this.W=bl;this.ca=this.N=this.l=this.Ca=null;this.Z="baseline";this.la="top";this.ta=this.sa=0;this.H=!1;this.uc=b?b.uc:0;this.F=b?b.F:null;this.B=b?b.B:!1;this.S=this.hd=!1;this.D=this.A=this.G=this.g=null;this.h=b?b.h:{};this.b=b?b.b:!1;this.direction=b?b.direction:"ltr";this.f=b?b.f:null;this.Qa=this.lang=null;
...
Pa:null,media:null}):"http://example.com/sse"==l&&"property"===m&&(l=f.getElementsByTagName("name")[0])&&"stylesheet"===l.textContent&&(f=f.getElementsByTagName("value")[0])&&(p=Ba(f.textContent,d),r.push({url:p,text:null,Pa:null,media:null,qb:"Author"}));if(!e)for(h=0;h<a.b.length;h++)r.push(a.b[h]);for(var z="",h=0;h<r.length;h++)z+=r[h].url,z+="^",r[h].text&&(z+=r[h].text),z+="^";var u=a.H[z];u?(a.g[d]=u,O(c,b)):(h=a.u[z],h||(h=new He(function(){var b=L("fetchStylesheet"),c=0,d=new Jt(a.l);Ee(function(){if(c<
r.length){var a=r[c++];d.Wc(a.qb);return null!==a.text?kg(a.text,d,a.url,a.Pa,a.media).Hc(!0):jg(a.url,d,a.Pa,a.media)}return M(!1)}).then(function(){u=new mt(a,d.j,d.u,d.J.l,d.G,d.B,d.D,d.l,d.H,d.F);a.H[z]=u;delete a.u[z];O(b,u)});return b.result()},"FetchStylesheet "+d),a.u[z]=h,h.start()),h.get().then(function(e){a.g[d]=e;O(c,b)}))}else O(c,null)});return c.result()};function Pt(a){return String.fromCharCode(a>>>24&255,a>>>16&255,a>>>8&255,a&255)}
...
function bu(a,b){this.h=a;this.D=this.g=this.b=this.u=this.j=null;this.G=b;this.N=null;this.Z={};this.lang=null;this.l=0;this.F=!1;this.S=!0;this.B=null;this.f={};this.ca=this.Yb=this.lf=null;this.Y={};this.J=null;this.H=ru(this);pu()&&(Jh["http://www.w3.org/1998/Math/MathML"]=!0)}
...
function yu(a,b){return ne("resolveFragment",function(c){if(b){var d=new ub;vb(d,b);var e;if(a.j){var f=wb(d,a.j.b);if(1!=f.node.nodeType||f.K||!f.sd){O(c,null);return}var g=f.node,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.g[h]){O(c,null);return}e=a.g[h];d=f.sd}else e=a.b[0];a.h.load(e.src).then(function(a){var b=wb(d,a.b);a=ik(a,b.node,b.offset,b.K);O(c,{P:e.P,Ea:a,aa:-1})})}else O(c,null)},function(a,d){w.b(d,"Cannot resolve fragment:",b);O(a,null)})}
function zu(a,b){return ne("resolveEPage",function(c){if(0>=b)O(c,{P:0,Ea:0,aa:-1});else if(a.S){var d=a.b.findIndex(function(a){return!a.b&&!a.f||a.b<=b&&a.b+a.f>b});-1==d&&(d=a.b.length-1);var e=a.b[d];e&&e.f||(e=a.b[--d]);O(c,{P:d,Ea:-1,aa:Math.floor(b-e.b)})}else{var f=Za(a.b.length,function(c){c=a.b[c];return c.b+c.f>b});f==a.b.length&&f--;var g=a.b[f];a.h.load(g.src).then(function(a){b-=g.b;b>g.f&&(b=g.f);var d=0;0<b&&(a=jk(a),d=Math.round(a*b/g.f),d==a&&d--);O(c,{P:f,Ea:d,aa:-1})})}},function(a,
d){w.b(d,"Cannot resolve epage:",b);O(a,null)})}function Au(a,b){var c=a.b[b.P];if(a.S)return M(c.b+b.aa);if(0>=b.Ea)return M(c.b);var d=L("getEPage");a.h.load(c.src).then(function(a){a=jk(a);O(d,c.b+Math.min(a,b.Ea)*c.f/a)});return d.result()}function Bu(a,b){return{page:a,position:{P:a.P,aa:b,Ea:a.offset}}}function Cu(a,b,c,d,e){this.O=a;this.viewport=b;this.j=c;this.l=e;this.Ib=[];this.g=[];this.$=zb(d);this.h=new Yr(b);this.f=new Zp(a.H);this.wf=!1}
function Du(a,b){var c=a.Ib[b.P];return c?c.Ka[b.aa]:null}n=Cu.prototype;n.fc=function(a){return this.O.J?this.O.J:(a=this.Ib[a?a.P:0])?a.nb.H:null};
...
d.b=d.F.pop();d=a.f;d.g=d.H.pop();d=c.Xd.position;d.P===e.P&&d.aa===g&&(e=c.Xd.page);P(b)})):P(b)}):P(b)}}).then(function(){e.I.parentElement||(e=b.Ka[g]);e.B=!c&&b.item.P===a.O.b.length-1;e.B&&gq(a.f,a.viewport);O(d,{Xd:Bu(e,g),bg:c})})})});return d.result()}
function Iu(a,b){var c=a.aa,d=-1;0>c?(d=a.Ea,c=Za(b.jb.length,function(a){return tt(b.nb,b.jb[a],!0)>d}),c=c===b.jb.length?b.complete?b.jb.length-1:Number.POSITIVE_INFINITY:c-1):c===Number.POSITIVE_INFINITY&&-1!==a.Ea&&(d=a.Ea);return{P:a.P,aa:c,Ea:d}}
...
function Ku(a,b){var c=L("renderPage");Hu(a,b.P).then(function(d){if(d){var e=Iu(b,d),f=e.aa,g=e.Ea,h=d.Ka[f];h?O(c,Bu(h,f)):Fe(function(b){if(f<d.jb.length)Q(b);else if(d.complete)f=d.jb.length-1,Q(b);else{var c=d.jb[d.jb.length-1];Fu(a,d,c).then(function(a){var e=a.Xd.page;(c=a.bg)?0<=g&&tt(d.nb,c)>g?(h=e,f=d.jb.length-2,Q(b)):P(b):(h=e,f=a.Xd.position.aa,d.complete=!0,Q(b))})}}).then(function(){h=h||d.Ka[f];var b=d.jb[f];h?O(c,Bu(h,f)):Fu(a,d,b).then(function(a){a.bg||(d.complete=!0);O(c,a.Xd)})})}else O(c,
null)});return c.result()}n.Rb=function(){return Lu(this,{P:this.O.b.length-1,aa:Number.POSITIVE_INFINITY,Ea:-1},!1)};function Lu(a,b,c){var d=L("renderPagesUpto");b||(b={P:0,aa:0,Ea:0});var e=b.P,f=b.aa,g=0;c&&(g=e);var h;Fe(function(c){Ku(a,{P:g,aa:g===e?f:Number.POSITIVE_INFINITY,Ea:g===e?b.Ea:-1}).then(function(a){h=a;++g>e?Q(c):P(c)})}).then(function(){O(d,h)});return d.result()}n.xg=function(a,b){return Ju(this,{P:0,aa:0,Ea:-1},b)};
n.Ag=function(a,b){return Ju(this,{P:this.O.b.length-1,aa:Number.POSITIVE_INFINITY,Ea:-1},b)};n.nextPage=function(a,b){var c=this,d=this,e=a.P,f=a.aa,g=L("nextPage");Hu(d,e).then(function(a){if(a){if(a.complete&&f==a.jb.length-1){if(e>=d.O.b.length-1){O(g,null);return}e++;f=0;var h=c.Ib[e],k=h&&h.Ka[0];a=a.Ka[a.Ka.length-1];k&&a&&k.b==a.b&&(h.Ka.forEach(function(a){a.I&&a.I.remove()}),c.Ib[e]=null,c.g[e]=null)}else f++;Ju(d,{P:e,aa:f,Ea:-1},b).Ga(g)}else O(g,null)});return g.result()};
n.Oe=function(a,b){var c=a.P,d=a.aa;if(d)d--;else{if(!c)return M(null);c--;d=Number.POSITIVE_INFINITY}return Ju(this,{P:c,aa:d,Ea:-1},b)};function Mu(a,b,c){b="left"===b.b;a="ltr"===a.fc(c);return!b&&a||b&&!a}function Nu(a,b,c){var d=L("getCurrentSpread"),e=Du(a,b);if(!e)return M({left:null,right:null});var f="left"===e.b;(Mu(a,e,b)?a.Oe(b,c):a.nextPage(b,c)).then(function(c){var e=Du(a,b);(c=c&&c.page)&&c.b===e.b&&(c=null);f?O(d,{left:e,right:c}):O(d,{left:c,right:e})});return d.result()}
...
function Qu(a,b,c,d){w.debug("Navigate to",b);var e=su(a.O,ya(b));if(!e){if(a.O.j&&b.match(/^#epubcfi\(/))e=su(a.O,a.O.j.url);else if("#"===b.charAt(0)){var f=a.O.H.Kg(b);a.O.j?(e=su(a.O,f[0]),null==e&&(e=f[0])):e=f[0];b=f[0]+(f[1]?"#"+f[1]:"")}if(null==e)return M(null)}var g=a.O.D[e];if(!g)return a.O.j&&e==su(a.O,a.O.j.url)&&(e=b.indexOf("#"),0<=e)?Pu(a,b.substr(e+1),d):M(null);var h=L("navigateTo");Hu(a,g.P).then(function(e){if(e){var f=mk(e.da,b);f?Ju(a,{P:g.P,aa:-1,Ea:hk(e.da,f)},d).Ga(h):c.P!==
g.P?Ju(a,{P:g.P,aa:0,Ea:-1},d).Ga(h):O(h,null)}else O(h,null)});return h.result()}
...
function hv(a){gv(a);fv(a,function(a){x(a.I,"display","none");a.I.setAttribute("aria-hidden","true")});a.g=null;a.j=null}function iv(a,b){b.addEventListener("hyperlink",a.F,!1);b.addEventListener("replaced",a.Me,!1);x(b.I,"visibility","visible");x(b.I,"display","block");b.I.setAttribute("aria-hidden","false")}function jv(a,b){hv(a);a.g=b;iv(a,b)}
function kv(a){var b=L("reportPosition");xu(a.O,a.f.P,a.f.Ea).then(function(c){var d=a.g;(a.ca&&0<d.j.length?Je(d.j):M(!0)).then(function(){lv(a,d,c).Ga(b)})});return b.result()}function mv(a){var b=a.ge;if(a.B){var c=a.B;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new $r(a.window,a.fontSize,b,c.width,c.height)}return new $r(a.window,a.fontSize,b)}
...
function ev(a,b,c){a.hc=!1;gv(a);if(a.$.ub)return Nu(a.b,a.f,c).ea(function(c){hv(a);a.j=c;c.left&&(iv(a,c.left),c.right?c.left.I.removeAttribute("data-vivliostyle-unpaired-page"):c.left.I.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(iv(a,c.right),c.left?c.right.I.removeAttribute("data-vivliostyle-unpaired-page"):c.right.I.setAttribute("data-vivliostyle-unpaired-page",!0));c=qv(a,c);a.viewport.zoom(c.width,c.height,a.D?rv(a,c):a.zoom);a.g=b;return M(null)});jv(a,b);a.viewport.zoom(b.g.width,
b.g.height,a.D?rv(a,b.g):a.zoom);a.g=b;return M(null)}function qv(a,b){var c=0,d=0;b.left&&(c+=b.left.g.width,d=b.left.g.height);b.right&&(c+=b.right.g.width,d=Math.max(d,b.right.g.height));b.left&&b.right&&(c+=2*a.$.Dc);return{width:c,height:d}}var sv={$g:"fit inside viewport"};function rv(a,b){return Math.min(a.viewport.width/b.width,a.viewport.height/b.height)}function tv(){this.name="RenderingCanceledError";this.message="Page rendering has been canceled";this.stack=Error().stack}v(tv,Error);
function av(a){if(a.l){var b=a.l;oe(b,new tv);if(b!==ie&&b.b){b.b.g=!0;var c=new ye(b);b.l="interrupt";b.b=c;b.f.tb(c)}}a.l=null}
function bv(a){a.Ya=!1;a.hc=!1;if(nv(a))return M(!0);Yu(a,"loading");av(a);var b=qe(ie.f,function(){return ne("resize",function(c){a.O?(a.l=b,Zu.f("render (resize)"),pv(a),a.f&&(a.f.aa=-1),uu(a.O,a.Rb),Lu(a.b,a.f,!a.Rb).then(function(d){d?(a.f=d.position,ev(a,d.page,!0).then(function(){Yu(a,"interactive");vu(a.O,function(b){b={t:"nav",epageCount:b,first:a.g.u,last:a.g.B,metadata:a.O.f,docTitle:a.O.b[a.f.P].h};if(a.g.u||!a.f.aa&&a.O.b[a.f.P].b)b.epage=a.O.b[a.f.P].b;Xu(a,b)}).then(function(){kv(a).then(function(d){(a.Rb?
...
n.Rg=function(a){a:{var b=this.gb;if(!b.g)throw Error("no page exists.");switch(a){case "fit inside viewport":a=rv(b,b.$.ub?qv(b,b.j):b.g.g);break a;default:throw Error("unknown zoom type: "+a);}}return a};n.zg=function(){return this.gb.Z};oa("vivliostyle.viewer.Viewer",Hx);Hx.prototype.setOptions=Hx.prototype.jg;Hx.prototype.addListener=Hx.prototype.Pg;Hx.prototype.removeListener=Hx.prototype.Sg;Hx.prototype.loadDocument=Hx.prototype.Bg;Hx.prototype.loadPublication=Hx.prototype.Qg;
