 ...
 *
 * Vivliostyle core 2017.2.1-pre.20170518113055
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
if(!c)throw Error("E_CFI_NUMBER_EXPECTED");e+=c[0].length;g=parseInt(c[1],10);(h=c[4])&&(h=ab(h));var l=c[7];l&&(l=ab(l));c=bb(c[10]);f.push(new eb(g,h,l,sa(c.s)));break;case "!":e++;f.push(new cb);break;case "~":case "@":case "":a.ma=f;return;default:throw Error("E_CFI_PARSE_ERROR");}}function hb(a,b){for(var c={node:b.documentElement,offset:0,K:!1,qb:null,Zc:null},d=0;d<a.ma.length;d++)if(!a.ma[d].h(c)){++d<a.ma.length&&(c.Zc=new fb,c.Zc.ma=a.ma.slice(d));break}return c}
...
function Ab(a,b,c,d){this.Sa=b;this.Db=c;this.O=null;this.Tb=function(){return this.O?this.O:this.X.rb?Math.floor(b/2)-this.X.Ec:b};this.J=null;this.Sb=function(){return this.J?this.J:c};this.A=d;this.na=null;this.fontSize=function(){return this.na?this.na:d};this.X=lb;this.H={}}function Bb(a,b){a.H[b.A]={};for(var c=0;c<b.C.length;c++)Bb(a,b.C[c])}
function Cb(a,b,c){return"vw"==b?a.Tb()/100:"vh"==b?a.Sb()/100:"em"==b||"rem"==b?c?a.A:a.fontSize():"ex"==b||"rex"==b?yb.ex*(c?a.A:a.fontSize())/yb.em:yb[b]}function Db(a,b,c){do{var d=b.values[c];if(d||b.l&&(d=b.l.call(a,c,!1)))return d;b=b.parent}while(b);throw Error("Name '"+c+"' is undefined");}
...
n.evaluate=function(a){var b;b=(b=a.H[this.b.A])?b[this.h]:void 0;if("undefined"!=typeof b)return b;b=this.jb(a);var c=this.h,d=this.b,e=a.H[d.A];e||(e={},a.H[d.A]=e);return e[c]=b};n.Je=function(){return!1};function Ib(a,b){Gb.call(this,a);this.f=b}t(Ib,Gb);n=Ib.prototype;n.se=function(){throw Error("F_ABSTRACT");};n.De=function(){throw Error("F_ABSTRACT");};n.jb=function(a){a=this.f.evaluate(a);return this.De(a)};n.gc=function(a,b,c){return a===this||Hb(this.f,a,b,c)};
...
bc.prototype.ob=function(a,b){return a*b};function cc(a,b,c){Jb.call(this,a,b,c)}t(cc,Nb);cc.prototype.Va=function(){return"/"};cc.prototype.ob=function(a,b){return a/b};function dc(a,b,c){Jb.call(this,a,b,c)}t(dc,Nb);dc.prototype.Va=function(){return"%"};dc.prototype.ob=function(a,b){return a%b};function ec(a,b,c){Gb.call(this,a);this.M=b;this.ga=c.toLowerCase()}t(ec,Gb);ec.prototype.wa=function(a){a.append(this.M.toString());a.append(Fa(this.ga))};
ec.prototype.jb=function(a){return this.M*Cb(a,this.ga,!1)};function fc(a,b){Gb.call(this,a);this.f=b}t(fc,Gb);fc.prototype.wa=function(a){a.append(this.f)};fc.prototype.jb=function(a){return Db(a,this.b,this.f).evaluate(a)};fc.prototype.gc=function(a,b,c){return a===this||Hb(Db(b,this.b,this.f),a,b,c)};function gc(a,b,c){Gb.call(this,a);this.f=b;this.name=c}t(gc,Gb);gc.prototype.wa=function(a){this.f&&a.append("not ");a.append(Fa(this.name))};
...
n.Xb=function(a){var b=this.Zb(a.values);return b===a.values?a:new sc(b)};n.Hb=function(a){var b=this.Zb(a.values);return b===a.values?a:new tc(a.name,b)};n.Ic=function(a){return a};function uc(){}n=uc.prototype;n.toString=function(){var a=new Ca;this.Ta(a,!0);return a.toString()};n.stringValue=function(){var a=new Ca;this.Ta(a,!1);return a.toString()};n.sa=function(){throw Error("F_ABSTRACT");};n.Ta=function(a){a.append("[error]")};n.He=function(){return!1};n.jc=function(){return!1};n.Ke=function(){return!1};
n.xf=function(){return!1};n.wd=function(){return!1};function vc(){if(B)throw Error("E_INVALID_CALL");}t(vc,uc);vc.prototype.sa=function(a){return new tb(a,"")};vc.prototype.Ta=function(){};vc.prototype.ba=function(a){return a.pe(this)};var B=new vc;function wc(){if(xc)throw Error("E_INVALID_CALL");}t(wc,uc);wc.prototype.sa=function(a){return new tb(a,"/")};wc.prototype.Ta=function(a){a.append("/")};wc.prototype.ba=function(a){return a.qe(this)};var xc=new wc;function yc(a){this.Hc=a}t(yc,uc);
yc.prototype.sa=function(a){return new tb(a,this.Hc)};yc.prototype.Ta=function(a,b){b?(a.append('"'),a.append(Ga(this.Hc)),a.append('"')):a.append(this.Hc)};yc.prototype.ba=function(a){return a.gd(this)};function zc(a){this.name=a;if(oc[a])throw Error("E_INVALID_CALL");oc[a]=this}t(zc,uc);zc.prototype.sa=function(a){return new tb(a,this.name)};zc.prototype.Ta=function(a,b){b?a.append(Fa(this.name)):a.append(this.name)};zc.prototype.ba=function(a){return a.Yb(this)};zc.prototype.xf=function(){return!0};
function C(a){var b=oc[a];b||(b=new zc(a));return b}function D(a,b){this.M=a;this.ga=b.toLowerCase()}t(D,uc);D.prototype.sa=function(a,b){return this.M?b&&"%"==this.ga?100==this.M?b:new bc(a,b,new tb(a,this.M/100)):new ec(a,this.M,this.ga):a.b};D.prototype.Ta=function(a){a.append(this.M.toString());a.append(this.ga)};D.prototype.ba=function(a){return a.Lc(this)};D.prototype.jc=function(){return!0};function Ac(a){this.M=a}t(Ac,uc);
Ac.prototype.sa=function(a){return this.M?1==this.M?a.f:new tb(a,this.M):a.b};Ac.prototype.Ta=function(a){a.append(this.M.toString())};Ac.prototype.ba=function(a){return a.Kc(this)};Ac.prototype.Ke=function(){return!0};function Bc(a){this.M=a}t(Bc,Ac);Bc.prototype.ba=function(a){return a.Jc(this)};function Ec(a){this.f=a}t(Ec,uc);Ec.prototype.Ta=function(a){a.append("#");var b=this.f.toString(16);a.append("000000".substr(b.length));a.append(b)};Ec.prototype.ba=function(a){return a.Md(this)};
...
72,91,72,93,72,123,72,125,72,NaN,67]),We=we(39,[39,68,10,74,13,74,92,75,NaN,67]),Xe=we(39,[34,68,10,74,13,74,92,75,NaN,67]),Ye=we(72,[9,39,10,39,13,39,32,39,41,69]);function Ze(a,b){this.l=b;this.g=15;this.A=a;this.j=Array(this.g+1);this.b=-1;for(var c=this.position=this.f=this.h=0;c<=this.g;c++)this.j[c]=new ve}function Q(a){a.h==a.f&&$e(a);return a.j[a.f]}function R(a,b){(a.h-a.f&a.g)<=b&&$e(a);return a.j[a.f+b&a.g]}function S(a){a.f=a.f+1&a.g}
...
function Jf(a){for(var b=[];;){var c=Q(a.f);switch(c.type){case 1:b.push(c.text);break;case 23:b.push("+");break;case 4:case 5:b.push(c.M);break;default:return b}S(a.f)}}
function Kf(a){var b=!1,c=Q(a.f);if(23===c.type)b=!0,S(a.f),c=Q(a.f);else if(1===c.type&&("even"===c.text||"odd"===c.text))return S(a.f),[2,"odd"===c.text?1:0];switch(c.type){case 3:if(b&&0>c.M)break;case 1:if(b&&"-"===c.text.charAt(0))break;if("n"===c.text||"-n"===c.text){if(b&&c.b)break;b="-n"===c.text?-1:1;3===c.type&&(b=c.M);var d=0;S(a.f);var c=Q(a.f),e=24===c.type,f=23===c.type||e;f&&(S(a.f),c=Q(a.f));if(5===c.type){d=c.M;if(1/d===1/-0){if(d=0,f)break}else if(0>d){if(f)break}else if(0<=d&&!f)break;
S(a.f)}else if(f)break;return[b,e&&0<d?-d:d]}if("n-"===c.text||"-n-"===c.text){if(!b||!c.b)if(b="-n-"===c.text?-1:1,3===c.type&&(b=c.M),S(a.f),c=Q(a.f),5===c.type&&!(0>c.M||1/c.M===1/-0))return S(a.f),[b,c.M]}else{if(d=c.text.match(/^n(-[0-9]+)$/)){if(b&&c.b)break;S(a.f);return[3===c.type?c.M:1,parseInt(d[1],10)]}if(d=c.text.match(/^-n(-[0-9]+)$/))return S(a.f),[-1,parseInt(d[1],10)]}break;case 5:if(!b||!(c.b||0>c.M))return S(a.f),[0,c.M]}return null}
function Lf(a,b,c){a=a.A.ia();if(!a)return null;c=c||a.j;if(b){b=b.split(/\s+/);for(var d=0;d<b.length;d++)switch(b[d]){case "vertical":c=lc(a,c,new Ob(a,new fc(a,"pref-horizontal")));break;case "horizontal":c=lc(a,c,new fc(a,"pref-horizontal"));break;case "day":c=lc(a,c,new Ob(a,new fc(a,"pref-night-mode")));break;case "night":c=lc(a,c,new fc(a,"pref-night-mode"));break;default:c=a.h}}return c===a.j?null:new E(c)}
...
function Nf(a,b,c,d,e,f){var g=a.A,h=a.f,l=a.G,k,m,p,q;e&&(a.j=2,a.G.push("{"));a:for(;0<b;--b)switch(k=Q(h),a.b[k.type]){case 28:if(18!=R(h,1).type){Mf(a)?(g.error("E_CSS_COLON_EXPECTED",R(h,1)),a.b=Bf):(a.b=wf,g.yb());continue}m=R(h,2);if(!(m.b||1!=m.type&&6!=m.type)){if(0<=h.b)throw Error("F_CSSTOK_BAD_CALL mark");h.b=h.f}a.g=k.text;a.D=!1;S(h);S(h);a.b=xf;l.splice(0,l.length);continue;case 46:if(18!=R(h,1).type){a.b=Bf;g.error("E_CSS_COLON_EXPECTED",R(h,1));continue}a.g=k.text;a.D=!1;S(h);S(h);
...
T;S(h);continue;case 11:g.Rd();a.b=vf;S(h);continue;case 12:g.Pd();a.b=vf;S(h);continue;case 56:g.Wd();a.b=vf;S(h);continue;case 13:a.W?(a.h.push("-epubx-region"),a.W=!1):a.T?(a.h.push("page"),a.T=!1):a.h.push("[selector]");g.Aa();a.b=sf;S(h);continue;case 41:g.Dc();a.b=wf;S(h);continue;case 15:l.push(C(k.text));S(h);continue;case 16:try{l.push(hf(k.text))}catch(z){g.error("E_CSS_COLOR",k),a.b=Af}S(h);continue;case 17:l.push(new Ac(k.M));S(h);continue;case 18:l.push(new Bc(k.M));S(h);continue;case 19:l.push(new D(k.M,
...
m.text,"("),S(h)),S(h)):(2==a.j||3==a.j?"not"==k.text.toLowerCase()?(S(h),l.push(new gc(g.ia(),!0,m.text))):("only"==k.text.toLowerCase()&&(S(h),k=m),l.push(new gc(g.ia(),!1,k.text))):l.push(new fc(g.ia(),k.text)),a.b=zf);S(h);continue;case 38:l.push(null,k.text,"(");S(h);continue;case 32:l.push(new tb(g.ia(),k.M));S(h);a.b=zf;continue;case 33:m=k.text;"%"==m&&(m=a.g&&a.g.match(/height|^(top|bottom)$/)?"vh":"vw");l.push(new ec(g.ia(),k.M,m));S(h);a.b=zf;continue;case 34:l.push(new tb(g.ia(),k.text));
S(h);a.b=zf;continue;case 35:S(h);k=Q(h);5!=k.type||k.b?Hf(a,"E_CSS_SYNTAX",k):(l.push(new kc(g.ia(),k.M)),S(h),a.b=zf);continue;case 36:l.push(-k.type);S(h);continue;case 37:a.b=yf;If(a,k.type,k);l.push(k.type);S(h);continue;case 45:"and"==k.text.toLowerCase()?(a.b=yf,If(a,52,k),l.push(52),S(h)):Hf(a,"E_CSS_SYNTAX",k);continue;case 39:If(a,k.type,k)&&(a.g?a.b=xf:Hf(a,"E_CSS_UNBALANCED_PAR",k));S(h);continue;case 43:If(a,11,k)&&(a.g||3==a.j?Hf(a,"E_CSS_UNEXPECTED_BRC",k):(1==a.j?g.qc(l.pop()):(k=
...
function Pf(a,b,c,d,e){var f=K("parseStylesheet"),g=new Ef(sf,a,b,c),h=null;e&&(h=Qf(new Ze(e,b),b,c));if(h=Lf(g,d,h&&h.sa()))b.qc(h),b.Aa();me(function(){for(;!Nf(g,100,!1,!1,!1,!1);){if(g.H){var a=oa(g.J,c);g.C&&(b.qc(g.C),b.Aa());var d=K("parseStylesheet.import");Rf(a,b,null,null).then(function(){g.C&&b.Nb();g.H=!1;g.J=null;g.C=null;N(d,!0)});return d.result()}a=ke();if(a.Pa)return a}return L(!1)}).then(function(){h&&b.Nb();N(f,!0)});return f.result()}
...
function sg(a,b){if(!a.length)return b;for(var c=b.P,d,e=a.length-1;0<=e&&!(d=a[e],e===a.length-1&&d.P<b.P)&&!(d.S<b.P&&d.U-.1<=b.U&&d.V+.1>=b.V);e--)c=Math.min(c,d.S);for(var f=Math.min(c,d.P);0<=e&&!(d=a[e],d.P<=b.S||d.U-.1>b.U||d.V+.1<b.V);e--)f=d.S;f=Math.max(f,b.S);return c<=f?null:new Wf(b.U,f,b.V,c)};function tg(){this.b={}}t(tg,pc);tg.prototype.Yb=function(a){this.b[a.name]=!0;return a};tg.prototype.zb=function(a){this.Zb(a.values);return a};function ug(a){this.value=a}t(ug,pc);ug.prototype.Jc=function(a){this.value=a.M;return a};function vg(a,b){if(a){var c=new ug(b);try{return a.ba(c),c.value}catch(d){v.b(d,"toInt: ")}}return b}function wg(){this.f=!1;this.b=[];this.name=null}t(wg,pc);wg.prototype.Lc=function(a){this.f&&this.b.push(a);return null};
wg.prototype.Kc=function(a){this.f&&!a.M&&this.b.push(new D(0,"px"));return null};wg.prototype.zb=function(a){this.Zb(a.values);return null};wg.prototype.Hb=function(a){this.f||(this.f=!0,this.Zb(a.values),this.f=!1,this.name=a.name.toLowerCase());return null};
function xg(a,b,c,d,e,f){if(a){var g=new wg;try{a.ba(g);var h;a:{if(0<g.b.length){a=[];for(var l=0;l<g.b.length;l++){var k=g.b[l];if("%"==k.ga){var m=l%2?e:d;3==l&&"circle"==g.name&&(m=Math.sqrt((d*d+e*e)/2));a.push(k.M*m/100)}else a.push(k.M*Cb(f,k.ga,!1))}switch(g.name){case "polygon":if(!(a.length%2)){f=[];for(g=0;g<a.length;g+=2)f.push(new Xf(b+a[g],c+a[g+1]));h=new bg(f);break a}break;case "rectangle":if(4==a.length){h=eg(b+a[0],c+a[1],b+a[0]+a[2],c+a[1]+a[3]);break a}break;case "ellipse":if(4==
...
n.qe=function(a){return this.b&2048?a:null};n.gd=function(a){return this.b&2?a:null};n.Yb=function(a){var b=this.f[a.name.toLowerCase()];return b?b:this.b&4?a:null};n.Lc=function(a){return a.M||this.b&512?0>a.M&&!(this.b&256)?null:this.g[a.ga]?a:null:"%"==a.ga&&this.b&1024?a:null};n.Kc=function(a){return a.M?0>=a.M&&!(this.b&256)?null:this.b&16?a:null:this.b&512?a:null};n.Jc=function(a){return a.M?0>=a.M&&!(this.b&256)?null:this.b&48?a:(a=this.f[""+a.M])?a:null:this.b&512?a:null};
...
function ah(){this.g={};this.C={};this.l={};this.b={};this.f={};this.h={};this.A=[];this.j=[]}function bh(a,b){var c;if(3==b.type)c=new D(b.M,b.text);else if(7==b.type)c=hf(b.text);else if(1==b.type)c=C(b.text);else throw Error("unexpected replacement");if(Gg(a)){var d=a.b[0].b.f,e;for(e in d)d[e]=c;return a}throw Error("unexpected replacement");}
...
d.push(p.clone())}else p={},p[g.text.toLowerCase()]=C(g.text),d.push(dh(new Hg(0,p,U)));h=!1;break;case 5:p={};p[""+g.M]=new Bc(g.M);d.push(dh(new Hg(0,p,U)));h=!1;break;case 34:k("|");break;case 25:k("||");break;case 14:h||k(" ");e.push({Ue:d,Ne:f,ub:"["});f="";d=[];h=!0;break;case 6:h||k(" ");e.push({Ue:d,Ne:f,ub:"(",Bc:g.text});f="";d=[];h=!0;break;case 15:g=l();p=e.pop();if("["!=p.ub)throw Error("']' unexpected");d=p.Ue;d.push(g);f=p.Ne;h=!1;break;case 11:g=l();p=e.pop();if("("!=p.ub)throw Error("')' unexpected");
d=p.Ue;d.push(eh(p.Bc,g));f=p.Ne;h=!1;break;case 18:if(h)throw Error("':' unexpected");S(b);d.push(bh(d.pop(),Q(b)));break;case 22:if(h)throw Error("'?' unexpected");d.push(ch(d.pop(),0,1));break;case 36:if(h)throw Error("'*' unexpected");d.push(ch(d.pop(),0,Number.POSITIVE_INFINITY));break;case 23:if(h)throw Error("'+' unexpected");d.push(ch(d.pop(),1,Number.POSITIVE_INFINITY));break;case 12:S(b);g=Q(b);if(5!=g.type)throw Error("<int> expected");var q=p=g.M;S(b);g=Q(b);if(16==g.type){S(b);g=Q(b);
if(5!=g.type)throw Error("<int> expected");q=g.M;S(b);g=Q(b)}if(13!=g.type)throw Error("'}' expected");d.push(ch(d.pop(),p,q));break;case 17:m=l();if(0<e.length)throw Error("unclosed '"+e.pop().ub+"'");break;default:throw Error("unexpected token");}S(b);gh(c)?a.b[c]=m:a.g[c]=1!=m.b.length||m.b[0].f?new Mg(m):m.b[0].b}}
...
var lh=new pe(function(){var a=K("loadValidatorSet.load"),b=oa("validation.txt",na),c=bf(b),d=new ah;fh(d);c.then(function(c){try{if(c.responseText){var e=new Ze(c.responseText,null);for(ih(d,e);;){var g=hh(d,e,2);if(!g)break;for(c=[];;){S(e);var h=Q(e);if(17==h.type){S(e);break}switch(h.type){case 1:c.push(C(h.text));break;case 4:c.push(new Ac(h.M));break;case 5:c.push(new Bc(h.M));break;case 3:c.push(new D(h.M,h.text));break;default:throw Error("unexpected token");}}d.l[g]=1<c.length?new rc(c):
...
var xh=wh({before:"right",after:"left",start:"top",end:"bottom"}),yh=wh({before:"top",after:"bottom",start:"left",end:"right"});function V(a,b){this.value=a;this.Ua=b}n=V.prototype;n.qf=function(){return this};n.rd=function(a){a=this.value.ba(a);return a===this.value?this:new V(a,this.Ua)};n.uf=function(a){return a?new V(this.value,this.Ua+a):this};n.evaluate=function(a,b){return Vf(a,this.value,b)};n.We=function(){return!0};function zh(a,b,c){V.call(this,a,b);this.ea=c}t(zh,V);
zh.prototype.qf=function(){return new V(this.value,this.Ua)};zh.prototype.rd=function(a){a=this.value.ba(a);return a===this.value?this:new zh(a,this.Ua,this.ea)};zh.prototype.uf=function(a){return a?new zh(this.value,this.Ua+a,this.ea):this};zh.prototype.We=function(a){return!!this.ea.evaluate(a)};function Ah(a,b,c){return(!b||c.Ua>b.Ua)&&c.We(a)?c.qf():b}var Bh={"region-id":!0,"fragment-selector-id":!0};function Ch(a){return"_"!=a.charAt(0)&&!Bh[a]}function Dh(a,b,c){c?a[b]=c:delete a[b]}
...
function Hh(a,b,c,d,e,f,g){[{id:e,Kf:"_pseudos"},{id:f,Kf:"_regions"}].forEach(function(a){if(a.id){var c=Eh(b,a.Kf);b=c[a.id];b||(b={},c[a.id]=b)}});g&&(e=Fh(b),b={},e.push({ig:b,Yf:g}));for(var h in c)"_"!=h.charAt(0)&&(Bh[h]?(g=c[h],e=Gh(b,h),Array.prototype.push.apply(e,g)):Dh(b,h,Ah(a,b[h],c[h].uf(d))))}function Ih(a,b){if(0<a.length){a.sort(function(a,b){return b.f()-a.f()});for(var c=null,d=a.length-1;0<=d;d--)c=a[d],c.b=b,b=c;return c}return b}
function Jh(a,b){this.g=a;this.b=b;this.f=""}t(Jh,qc);function Kh(a){a=a.g["font-size"].value;var b;a:switch(a.ga.toLowerCase()){case "px":case "in":case "pt":case "pc":case "cm":case "mm":case "q":b=!0;break a;default:b=!1}if(!b)throw Error("Unexpected state");return a.M*yb[a.ga]}
Jh.prototype.Lc=function(a){if("em"==a.ga||"ex"==a.ga){var b=Cb(this.b,a.ga,!1)/Cb(this.b,"em",!1);return new D(a.M*b*Kh(this),"px")}if("rem"==a.ga||"rex"==a.ga)return b=Cb(this.b,a.ga,!1)/Cb(this.b,"rem",!1),new D(a.M*b*this.b.fontSize(),"px");if("%"==a.ga){if("font-size"===this.f)return new D(a.M/100*Kh(this),"px");if("line-height"===this.f)return a;b=this.f.match(/height|^(top|bottom)$/)?"vh":"vw";return new D(a.M,b)}return a};
...
Hi={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},Ii={Ig:!1,Oc:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",xd:"\u5341\u767e\u5343",ag:"\u8ca0"};
function Ji(a){if(9999<a||-9999>a)return""+a;if(!a)return Ii.Oc.charAt(0);var b=new Ca;0>a&&(b.append(Ii.ag),a=-a);if(10>a)b.append(Ii.Oc.charAt(a));else if(Ii.Jg&&19>=a)b.append(Ii.xd.charAt(0)),a&&b.append(Ii.xd.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(Ii.Oc.charAt(c)),b.append(Ii.xd.charAt(2)));if(c=Math.floor(a/100)%10)b.append(Ii.Oc.charAt(c)),b.append(Ii.xd.charAt(1));if(c=Math.floor(a/10)%10)b.append(Ii.Oc.charAt(c)),b.append(Ii.xd.charAt(0));(a%=10)&&b.append(Ii.Oc.charAt(a))}return b.toString()}
...
function Wi(a,b,c,d){this.A=a;this.l=b;this.Nc=c;this.Ab=d;this.h=[[],[]];this.ha={};this.H=this.G=this.Ia=this.b=null;this.Ra=this.la=this.W=this.j=this.f="";this.Z=this.O=null;this.ra=this.tb=!0;this.g={};this.I=[{}];this.J=[new yc("\u201c"),new yc("\u201d"),new yc("\u2018"),new yc("\u2019")];this.D=0;this.lang="";this.vc=[0];this.Sa=0;this.na=[{}];this.Cb=this.na[0];this.T=null;this.uc=[this.T];this.tc=[{}];this.Bb=this.na[0];this.C={};this.sb=[];this.Db=[]}
...
function hj(a,b,c,d){a.Db.push(b);a.Z=null;a.b=b;a.Ia=d;a.G=c;a.j=b.namespaceURI;a.f=b.localName;d=a.A.b[a.j];a.Ra=d?d+a.f:"";a.W=b.getAttribute("id");a.la=b.getAttributeNS("http://www.w3.org/XML/1998/namespace","id");(d=b.getAttribute("class"))?a.H=d.split(/\s+/):a.H=aj;(d=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))?a.O=d.split(/\s+/):a.O=aj;"style"==a.f&&"http://www.gribuser.ru/xml/fictionbook/2.0"==a.j&&(a.H=[b.getAttribute("name")||""]);if(d=Ba(b))a.h[a.h.length-1].push(new Ai(a.lang)),
a.lang=d.toLowerCase();d=a.ra;var e=a.vc;a.Sa=++e[e.length-1];e.push(0);var e=a.na,f=a.Cb=e[e.length-1],g=f[a.j];g||(g=f[a.j]={});g[a.f]=(g[a.f]||0)+1;e.push({});e=a.uc;null!==e[e.length-1]?a.T=--e[e.length-1]:a.T=null;e.push(null);e=a.tc;(f=a.Bb=e[e.length-1])&&f[a.j]&&f[a.j][a.f]--;e.push({});cj(a);ij(a,b);e=c.quotes;c=null;e&&(e=e.evaluate(a.l))&&(c=new Bi(a.J),e===F?a.J=[new yc(""),new yc("")]:e instanceof rc&&(a.J=e.values));ej(a,a.G);e=a.W||a.la||b.getAttribute("name")||"";if(d||e){var h={};
...
function cj(a){var b;for(b=0;b<a.H.length;b++)$i(a,a.A.Da,a.H[b]);for(b=0;b<a.O.length;b++)$i(a,a.A.f,a.O[b]);$i(a,a.A.g,a.W);$i(a,a.A.ed,a.f);""!=a.f&&$i(a,a.A.ed,"*");$i(a,a.A.h,a.Ra);null!==a.Z&&($i(a,a.A.Vc,a.Z),$i(a,a.A.Vc,"*"));a.b=null;a.h.push([]);for(var c=1;-1<=c;--c){var d=a.h[a.h.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.tb=!0;a.ra=!1}
Wi.prototype.pop=function(){for(var a=1;-1<=a;--a)for(var b=this.h[this.h.length-a-2],c=0;c<b.length;)b[c].pop(this,a)?b.splice(c,1):c++;this.h.pop();this.tb=!1};var lj=null;function mj(a,b,c,d,e,f,g){of.call(this,a,b,g);this.b=null;this.Y=0;this.h=this.ab=null;this.D=!1;this.ea=c;this.l=d?d.l:lj?lj.clone():new Vi;this.H=e;this.C=f;this.A=0;this.j=null}t(mj,pf);mj.prototype.wf=function(a){Rh(this.l.ed,"*",a)};function nj(a,b){var c=Ih(a.b,b);c!==b&&c.g(a.l)||a.wf(c)}
...
n.Wd=function(){var a="f"+pj++;nj(this,new Nh(new xi(a,this.j,null)));this.b=[new ni(a)];this.j=null};n.Dc=function(){qj(this);this.h=null;this.D=!1;this.Y=0;this.b=[]};n.yb=function(){var a;0!=this.A?(rf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.A=1,this.ab={},this.h=null,this.Y=0,this.D=!1,this.b=[])};n.error=function(a,b){pf.prototype.error.call(this,a,b);1==this.A&&(this.A=0)};n.Gc=function(a){pf.prototype.Gc.call(this,a);this.A=0};
n.Aa=function(){qj(this);pf.prototype.Aa.call(this);1==this.A&&(this.A=0)};n.Nb=function(){pf.prototype.Nb.call(this)};function qj(a){if(a.b){var b=a.Y+a.l.Me();nj(a,a.Bf(b));a.b=null;a.h=null;a.j=null;a.D=!1;a.Y=0}}n.Bf=function(a){var b=this.H;this.D&&(b=b?"xxx-bogus-xxx":"footnote");return new Oh(this.ab,a,this.h,b,this.j)};n.wb=function(a,b,c){kh(this.C,a,b,c,this)};n.Sc=function(a,b){qf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};
...
var Oj={Bg:"text/html",Cg:"text/xml",og:"application/xml",ng:"application/xhtml_xml",vg:"image/svg+xml"};function Pj(a,b,c){c=c||new DOMParser;var d;try{d=c.parseFromString(a,b)}catch(e){}if(d){a=d.documentElement;if("parsererror"===a.localName)return null;for(a=a.firstChild;a;a=a.nextSibling)if("parsererror"===a.localName)return null}else return null;return d}
...
function gk(a,b){this.h={};this.L=a;this.g=b;this.O=null;this.A=[];var c=this;this.J=function(a){var b=a.currentTarget,d=b.getAttribute("href")||b.getAttributeNS("http://www.w3.org/1999/xlink","href");d&&Ua(c,{type:"hyperlink",target:null,currentTarget:null,Gg:b,href:d,preventDefault:function(){a.preventDefault()}})};this.b={};this.f={width:0,height:0};this.C=this.H=!1;this.D=this.G=!0;this.R=0;this.position=null;this.offset=-1;this.l=null;this.j=[];this.I={top:{},bottom:{},left:{},right:{}}}
t(gk,Ta);function hk(a,b){(a.G=b)?a.L.setAttribute("data-vivliostyle-auto-page-width",!0):a.L.removeAttribute("data-vivliostyle-auto-page-width")}function ik(a,b){(a.D=b)?a.L.setAttribute("data-vivliostyle-auto-page-height",!0):a.L.removeAttribute("data-vivliostyle-auto-page-height")}function jk(a,b,c){var d=a.b[c];d?d.push(b):a.b[c]=[b]}
function kk(a,b,c){Object.keys(a.b).forEach(function(a){for(var b=this.b[a],c=0;c<b.length;)this.L.contains(b[c])?c++:b.splice(c,1);b.length||delete this.b[a]},a);for(var d=a.A,e=0;e<d.length;e++){var f=d[e];w(f.target,f.name,f.value.toString())}e=lk(c,a.L);a.f.width=e.width;a.f.height=e.height;for(e=0;e<b.length;e++)if(c=b[e],f=a.b[c.Zc],d=a.b[c.cg],f&&d&&(f=fk(f,c.action)))for(var g=0;g<d.length;g++)d[g].addEventListener(c.event,f,!1)}
...
function pk(a,b,c,d,e,f,g,h,l){this.b=a;this.element=b;this.f=c;this.Ua=d;this.l=e;this.h=f;this.fg=g;this.j=h;this.kb=-1;this.g=l}function qk(a,b){return a.h?!b.h||a.Ua>b.Ua?!0:a.j:!1}function rk(a,b){return a.top-b.top}function sk(a,b){return b.right-a.right}function tk(a,b){return a===b?!0:a&&b?a.node===b.node&&a.Za===b.Za&&uk(a.pa,b.pa)&&uk(a.za,b.za)&&tk(a.va,b.va):!1}
function vk(a,b){if(a===b)return!0;if(!a||!b||a.ja!==b.ja||a.K!==b.K||a.ma.length!==b.ma.length)return!1;for(var c=0;c<a.ma.length;c++)if(!tk(a.ma[c],b.ma[c]))return!1;return!0}function wk(a){return{ma:[{node:a.N,Za:xk,pa:a.pa,za:null,va:null,Ka:0}],ja:0,K:!1,Ha:a.Ha}}function zk(a,b){var c=new Ak(a.node,b,0);c.Za=a.Za;c.pa=a.pa;c.za=a.za;c.va=a.va?zk(a.va,Bk(b)):null;c.F=a.F;c.Ka=a.Ka+1;return c}var xk=0;
function Ck(a,b,c,d,e,f,g){this.ka=a;this.Wc=d;this.Te=null;this.root=b;this.aa=c;this.type=f;e&&(e.Te=this);this.b=g}function uk(a,b){return a===b||!!a&&!!b&&(b?a.ka===b.ka&&a.aa===b.aa&&a.type===b.type&&uk(a.Wc,b.Wc):!1)}function Dk(a,b){this.dg=a;this.count=b}
function Ak(a,b,c){this.N=a;this.parent=b;this.Ca=c;this.ja=0;this.K=!1;this.Za=xk;this.pa=b?b.pa:null;this.va=this.za=null;this.na=!1;this.ta=!0;this.b=!1;this.l=b?b.l:0;this.display=null;this.H=Ek;this.W=this.C=this.ya=null;this.T="baseline";this.Z="top";this.Qd=this.ha=0;this.I=!1;this.ac=b?b.ac:0;this.h=b?b.h:null;this.A=b?b.A:!1;this.O=this.Qc=!1;this.D=this.B=this.G=this.g=null;this.vb=b?b.vb:{};this.u=b?b.u:!1;this.ra=b?b.ra:"ltr";this.f=b?b.f:null;this.Ha=this.lang=null;this.F=b?b.F:null;
this.j=null;this.la={};this.Ka=1;this.J=null}function Fk(a){a.ta=!0;a.l=a.parent?a.parent.l:0;a.B=null;a.D=null;a.ja=0;a.K=!1;a.display=null;a.H=Ek;a.ya=null;a.C=null;a.W=null;a.T="baseline";a.I=!1;a.ac=a.parent?a.parent.ac:0;a.h=a.parent?a.parent.h:null;a.A=a.parent?a.parent.A:!1;a.g=null;a.G=null;a.za=null;a.Qc=!1;a.O=!1;a.u=a.parent?a.parent.u:!1;a.za=null;a.Ha=null;a.F=a.parent?a.parent.F:null;a.j=null;a.la={};a.Ka=1;a.J=null}
function Gk(a){var b=new Ak(a.N,a.parent,a.Ca);b.ja=a.ja;b.K=a.K;b.za=a.za;b.Za=a.Za;b.pa=a.pa;b.va=a.va;b.ta=a.ta;b.l=a.l;b.display=a.display;b.H=a.H;b.ya=a.ya;b.C=a.C;b.W=a.W;b.T=a.T;b.Z=a.Z;b.ha=a.ha;b.Qd=a.Qd;b.Qc=a.Qc;b.O=a.O;b.I=a.I;b.ac=a.ac;b.h=a.h;b.A=a.A;b.g=a.g;b.G=a.G;b.B=a.B;b.D=a.D;b.f=a.f;b.u=a.u;b.b=a.b;b.Ha=a.Ha;b.F=a.F;b.j=a.j;b.la=Object.create(a.la);b.Ka=a.Ka;b.J=a.J;return b}Ak.prototype.modify=function(){return this.na?Gk(this):this};
function Bk(a){var b=a;do{if(b.na)break;b.na=!0;b=b.parent}while(b);return a}Ak.prototype.clone=function(){for(var a=Gk(this),b=a,c;c=b.parent;)c=Gk(c),b=b.parent=c;return a};function Hk(a){return{node:a.N,Za:a.Za,pa:a.pa,za:a.za,va:a.va?Hk(a.va):null,F:a.F,Ka:a.Ka}}function Ik(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(Hk(b)),b=b.parent;while(b);b=a.Ha?Jk(a.Ha,a.ja,-1):a.ja;return{ma:c,ja:b,K:a.K,Ha:a.Ha}}function Kk(a){for(a=a.parent;a;){if(a.Qc)return!0;a=a.parent}return!1}
...
function Uk(a){this.element=a;this.hb=this.gb=this.height=this.width=this.H=this.D=this.I=this.C=this.Z=this.borderTop=this.ha=this.borderLeft=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.Ia=this.Ac=null;this.na=this.Cb=this.Sa=this.Db=this.xa=0;this.u=!1}function Vk(a){return a.marginTop+a.borderTop+a.D}function Wk(a){return a.marginBottom+a.Z+a.H}function Xk(a){return a.marginLeft+a.borderLeft+a.C}function Yk(a){return a.marginRight+a.ha+a.I}
...
function tl(a,b,c){if(!(b in a.C)){var d=a.style[b];a.C[b]=d?d.evaluate(a.D,b):c||null}return a.C[b]}function xl(a){return tl(a,"display",ed)}function sl(a){if(null===a.A){var b=xl(a),c=tl(a,"position"),d=tl(a,"float");a.A=yl(b,c,d,a.G).display===Mc}return a.A}function rl(a){null===a.l&&(a.l=a.H&&xl(a)!==F);return a.l}function vl(a,b){var c=null;if(sl(a)){var d=tl(a,"break-"+b);d&&(c=d.toString())}return c}function zl(a){this.g=a;this.b=[];this.bb=this.Wa=!0;this.f=[]}
...
function Dl(a,b,c,d,e,f,g,h){this.aa=a;this.root=a.root;this.Sa=c;this.h=d;this.C=f;this.f=this.root;this.T={};this.W={};this.G={};this.I=[];this.D=this.O=this.J=null;this.Z=new Wi(b,d,g,h);this.g=new kl;this.A=!0;this.la=[];this.Ra=e;this.Ia=this.ra=!1;this.b=a=Ij(a,this.root);this.ha={};this.j=new zl(d);ml(this.g,a);d=El(this,this.root);hj(this.Z,this.root,d,a);Fl(this,d,!1);this.H=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.H=
...
function Fl(a,b,c){c||["writing-mode","direction"].forEach(function(a){b[a]&&(this.T[a]=b[a])},a);if(!a.ra){var d=Hl(a,b,a.C.j,"background-color")?b["background-color"].evaluate(a.h):null,e=Hl(a,b,a.C.j,"background-image")?b["background-image"].evaluate(a.h):null;if(d&&d!==dd||e&&e!==dd)Il(a,b,a.C.j),a.ra=!0}if(!a.Ia)for(d=0;d<Jl.length;d++)if(Hl(a,b,a.C.A,Jl[d])){Il(a,b,a.C.A);a.Ia=!0;break}if(!c&&(c=b["font-size"])){d=c.evaluate(a.h);c=d.M;switch(d.ga){case "em":case "rem":c*=a.h.A;break;case "ex":case "rex":c*=
a.h.A*yb.ex/yb.em;break;case "%":c*=a.h.A/100;break;default:(d=yb[d.ga])&&(c*=d)}a.h.na=c}}function Kl(a){for(var b=0;!a.H&&(b+=5E3,Ll(a,b,0)!=Number.POSITIVE_INFINITY););return a.T}function El(a,b){if(b.style instanceof CSSStyleDeclaration){var c=b.getAttribute("style");if(c){var d=a.aa.url,e=new uj(a.Sa,a.C),c=new Ze(c,e);try{Nf(new Ef(tf,c,e,d),Number.POSITIVE_INFINITY,!1,!0,!1,!1)}catch(f){v.b(f,"Style attribute parse error:")}return e.ab}}return{}}
...
function Ll(a,b,c){var d=-1;if(b<=a.b&&(d=ol(a.g,b),d+=c,d<ll(a.g)))return pl(a.g,d);if(!a.f)return Number.POSITIVE_INFINITY;for(var e=a.h;;){var f=a.f.firstChild;if(!f)for(;;){if(1==a.f.nodeType){var f=a.Z,g=a.f;if(f.Db.pop()!==g)throw Error("Invalid call to popElement");f.vc.pop();f.na.pop();f.uc.pop();f.tc.pop();f.pop();fj(f);a.A=a.la.pop();g=a.j.pop(a.b);f=null;g.f&&(f=vl(g.f,"before"),Pl(a,f,g.f.Wa?Cl(a.j,g):g.f.offset,g.b),f=vl(g.f,"after"));f=ul(f,vl(g,"after"));Pl(a,f,a.b,g.b)}if(f=a.f.nextSibling)break;
a.f=a.f.parentNode;if(a.f===a.root)return a.f=null,b<a.b&&(0>d&&(d=ol(a.g,b),d+=c),d<=ll(a.g))?pl(a.g,d):Number.POSITIVE_INFINITY}a.f=f;if(1!=a.f.nodeType){a.b+=a.f.textContent.length;var f=a.j,g=a.f,h=Al(f);(f.Wa||f.bb)&&rl(h)&&(h=tl(h,"white-space",md).toString(),nk(g,mk(h))||(f.Wa=!1,f.bb=!1));a.A?ml(a.g,a.b):nl(a.g,a.b)}else{g=a.f;f=El(a,g);a.la.push(a.A);hj(a.Z,g,f,a.b);(h=g.getAttribute("id")||g.getAttributeNS("http://www.w3.org/XML/1998/namespace","id"))&&h===a.D&&(a.D=null);a.H||"body"!=g.localName||
g.parentNode!=a.root||(Fl(a,f,!0),a.H=!0);if(h=f["flow-into"]){var h=h.evaluate(e,"flow-into").toString(),l=Ml(a,h,f,g,a.b);a.A=!!a.Ra[h];g=a.j.push(f,a.b,g===a.root,l)}else g=a.j.push(f,a.b,g===a.root);h=Cl(a.j,g);Pl(a,g.g,h,g.b);g.h&&(l=vl(g.h,"after"),Pl(a,l,g.h.Wa?h:g.offset,g.b));a.A&&xl(g)===F&&(a.A=!1);if(Ij(a.aa,a.f)!=a.b)throw Error("Inconsistent offset");a.W["e"+a.b]=f;a.b++;a.A?ml(a.g,a.b):nl(a.g,a.b);if(b<a.b&&(0>d&&(d=ol(a.g,b),d+=c),d<=ll(a.g)))return pl(a.g,d)}}}
...
function ul(a,b){if(a)if(b){var c=!!wl[a],d=!!wl[b];if(c&&d)switch(b){case "column":return a;case "region":return"column"===a?b:a;default:return b}else return d?b:c?a:cm[b]?b:cm[a]?a:b}else return a;else return b}function dm(a){switch(a){case "left":case "right":case "recto":case "verso":return a;default:return"any"}};function em(){}n=em.prototype;n.vf=function(a){return{w:a,nd:!1,Eb:!1}};n.Se=function(){};n.$e=function(){};n.If=function(){};n.Ze=function(){};n.hd=function(){};n.$b=function(){};function fm(a,b){this.b=a;this.f=b}
function gm(a,b){var c=a.b,d=c.vf(b),e=K("LayoutIterator");ne(function(a){for(var b;d.w;){b=d.w.B?1!==d.w.B.nodeType?nk(d.w.B,d.w.ac)?void 0:d.w.K?c.$e(d):c.Se(d):d.w.ta?d.w.K?c.Ze(d):c.If(d):d.w.K?c.$b(d):c.hd(d):void 0;b=(b&&b.Pa()?b:L(!0)).fa(function(){return d.Eb?L(null):hm(this.f,d.w,d.nd)}.bind(this));if(b.Pa()){b.then(function(b){d.Eb?P(a):(d.w=b,O(a))});return}if(d.Eb){P(a);return}d.w=b.get()}P(a)}.bind(a)).then(function(){N(e,d.w)});return e.result()}function im(a){this.Qb=a}t(im,em);
n=im.prototype;n.Jf=function(){};n.kf=function(){};n.vf=function(a){return{w:a,nd:!!this.Qb&&a.K,Eb:!1,Qb:this.Qb,zc:null,ge:!1,Af:[],Cc:null}};n.Se=function(a){a.ge=!1};n.hd=function(a){a.Af.push(Bk(a.w));a.zc=ul(a.zc,a.w.g);a.ge=!0;return this.Jf(a)};n.$b=function(a){var b;a.ge?(b=(b=void 0,L(!0)),b=b.fa(function(){a.Eb||(a.Af=[],a.Qb=!1,a.nd=!1,a.zc=null);return L(!0)})):b=(b=this.kf(a))&&b.Pa()?b:L(!0);return b.fa(function(){a.Eb||(a.ge=!1,a.Cc=Bk(a.w),a.zc=ul(a.zc,a.w.G));return L(!0)})};
function jm(a,b,c){this.Re=[];this.b=Object.create(a);this.b.element=b;this.b.j=a.j.clone();this.b.h=!1;this.b.xe=c.F;this.b.Bb=a;a=km(this.b,c);this.b.O-=a;var d=this;this.b.tb=function(a){return lm.prototype.tb.call(this,a).fa(function(a){d.Re.push(Bk(a));return L(a)})}}function mm(a,b){return nm(a.b,b,!0)}jm.prototype.Ob=function(a){var b=this.b.Ob();if(a){a=Bk(this.Re[0]);var c=new om(a,null,a.b,0);c.f(this.b,0);if(!b.w)return{Fb:c,w:a}}return b};
...
function Hm(a,b,c,d,e,f,g){(this.parent=a)&&a.j.push(this);this.j=[];this.f=b;this.L=c;this.h=d;this.J=e;this.H=f||a&&a.H||cd;this.G=g||a&&a.G||ld;this.Tc=!1;this.C=a?a.C:new Bm;this.D=[];this.b=[];this.l=[];this.A={};this.g=[];a:{b=this;for(a=this.parent;a;){if(b=Im(a,b,this.f,this.h,this.J)){a=b;break a}b=a;a=a.parent}a=null}this.I=a?[].concat(a.g):[]}function Jm(a,b){if(!a.parent)throw Error("No PageFloatLayoutContext for "+b);return a.parent}
function Im(a,b,c,d,e){b=a.j.indexOf(b);0>b&&(b=a.j.length);for(--b;0<=b;b--){var f=a.j[b];if(f.f===c&&f.h===d&&vk(f.J,e)||(f=Im(f,null,c,d,e)))return f}return null}function Km(a,b){return b&&b!==a.f?Km(Jm(a,b),b):a.L}function Lm(a,b){a.L=b;Mm(a)}Hm.prototype.Od=function(a){this.C.Od(a)};function Nm(a,b){return b===a.f?a:Nm(Jm(a,b),b)}Hm.prototype.Ee=function(a){return this.C.Ee(a)};function Om(a,b){var c=Am(b),d=b.b;d===a.f?0>a.D.indexOf(c)&&a.D.push(c):Om(Jm(a,d),b)}
...
function Rm(a){a.L&&(a.j.forEach(function(a){dn(this,a)&&a.b.forEach(function(a){(a=a.dc.element)&&a.parentNode&&a.parentNode.removeChild(a)})},a),el(a.L));a.j.splice(0);Object.keys(a.A).forEach(function(a){delete this.A[a]},a);a.Tc=!0}function en(a){return a.Tc||!!a.parent&&en(a.parent)}function fn(a,b){return sm(b,a.H.toString(),a.G.toString()||null,wm)}function cn(a,b){var c=fn(a,b);if("block-end"===c||"inline-end"===c)for(var d=0;d<a.b.length;){var e=a.b[d];fn(a,e.ya)===c?Sm(a,e):d++}}
...
function rn(a){var b=a.b.map(function(a){return a.Xd()});return a.parent?rn(a.parent).concat(b):b}function Mm(a){var b=a.L.element&&a.L.element.parentNode;b&&a.b.forEach(function(a){b.appendChild(a.dc.element)})}function sn(a){var b=Km(a).u;return a.b.reduce(function(a,d){var c=gl(d.dc);return b?Math.min(a,c.U):Math.max(a,c.P)},b?Infinity:0)}
function tn(a,b){function c(a){return function(b){return Fm(a,Am(b.qa))}}function d(a,b){return a.Lb.some(c(b))}for(var e=fl(b),e=b.u?e.U:e.P,f=a;f;){if(f.g.some(c(f)))return e;f=f.parent}f=ln(a,"block-start",d);return ln(a,"block-end",d)*Zk(b)<e*Zk(b)?e:f}var un=[];function vn(a){for(var b=un.length-1;0<=b;b--){var c=un[b];if(c.bf(a))return c}throw Error("No PageFloatLayoutStrategy found for "+a);}
function wn(a){for(var b=un.length-1;0<=b;b--){var c=un[b];if(c.af(a))return c}throw Error("No PageFloatLayoutStrategy found for "+a);}function xn(){}n=xn.prototype;n.bf=function(a){return ym(a.H)};n.af=function(){return!0};n.gf=function(a,b,c){var d=a.H,e=a.ya,f=Ik(a);return yn(c,d,a.W,a).fa(function(a){d=a;a=new zm(f,d,e,b.h);b.Od(a);return L(a)})};n.hf=function(a,b,c){return new Cm(a[0].qa.b,b,a,c)};n.Ve=function(a,b){return Tm(b,a)};n.Ye=function(){};un.push(new xn);var zn={img:!0,svg:!0,audio:!0,video:!0};
function An(a,b,c,d){var e=a.B;if(!e)return NaN;if(1==e.nodeType){if(a.K){var f=lk(b,e);if(f.right>=f.left&&f.bottom>=f.top)return d?f.left:f.bottom}return NaN}var f=NaN,g=e.ownerDocument.createRange(),h=e.textContent.length;if(!h)return NaN;a.K&&(c+=h);c>=h&&(c=h-1);g.setStart(e,c);g.setEnd(e,c+1);a=Bn(b,g);if(c=d){c=document.body;if(null==Va){var l=c.ownerDocument,g=l.createElement("div");g.style.position="absolute";g.style.top="0px";g.style.left="0px";g.style.width="100px";g.style.height="100px";
...
function Dn(){}Dn.prototype.g=function(){return null};function En(a,b){return{current:b.reduce(function(b,d){return b+d.b(a)},0),ee:b.reduce(function(b,d){return b+d.G(a)},0)}}function Fn(a,b){this.h=a;this.A=b;this.j=!1;this.l=null}t(Fn,Dn);Fn.prototype.f=function(a,b){if(b<this.b())return null;this.j||(this.l=Gn(a,this,0<b),this.j=!0);return this.l};Fn.prototype.b=function(){return this.A};Fn.prototype.g=function(){return this.j?this.l:this.h[this.h.length-1]};
function om(a,b,c,d){this.position=a;this.D=b;this.A=this.C=c;this.xa=d;this.h=!1;this.l=0}t(om,Dn);om.prototype.f=function(a,b){this.h||(this.l=An(this.position,a.f,0,a.u),this.h=!0);var c=this.l,d=En(this.g(),Hn(a));this.A=In(a,c+(a.u?-1:1)*d.ee);this.C=this.position.b=In(a,c+(a.u?-1:1)*d.current);b<this.b()?c=null:(a.xa=this.xa+Jn(a,this),c=this.position);return c};
om.prototype.b=function(){if(!this.h)throw Error("EdgeBreakPosition.prototype.updateEdge not called");var a;if((a=this.g())&&a.parent){var b=Kn(a.parent);a=b?(b=b.b)?a&&b.g===a.N:!1:!1}else a=!1;a=a&&!this.A;return(cm[this.D]?1:0)+(this.C&&!a?3:0)+(this.position.parent?this.position.parent.l:0)};om.prototype.g=function(){return this.position};
function Ln(a){for(var b=1;b<a.length;b++){var c=a[b-1],d=a[b];c===d?v.b("validateCheckPoints: duplicate entry"):c.Ca>=d.Ca?v.b("validateCheckPoints: incorrect boxOffset"):c.N==d.N&&(d.K?c.K&&v.b("validateCheckPoints: duplicate after points"):c.K||d.Ca-c.Ca!=d.ja-c.ja&&v.b("validateCheckPoints: boxOffset inconsistent with offsetInNode"))}}function Mn(a){this.parent=a}Mn.prototype.te=function(){return"Block formatting context (adapt.layout.BlockFormattingContext)"};Mn.prototype.Ie=function(a,b){return b};
Mn.prototype.ve=function(){};Mn.prototype.ue=function(){};function lm(a,b,c,d,e){Uk.call(this,a);this.j=b;this.f=c;this.sb=d;this.Vf=a.ownerDocument;this.g=e;Lm(e,this);this.xe=null;this.jf=this.sf=!1;this.O=this.J=this.A=this.la=this.W=0;this.ra=this.pf=this.lf=null;this.Ab=!1;this.b=this.G=null;this.Ae=!0;this.tc=this.Nc=this.vc=0;this.h=!0;this.Ra=null;this.l=[];this.T=this.Bb=null}t(lm,Uk);function Nn(a,b){return!!b.ya&&(!a.sf||!!b.parent)}function In(a,b){return a.u?b<a.O:b>a.O}
lm.prototype.tb=function(a){var b=this,c=K("openAllViews"),d=a.ma;On(b.j,b.element,b.jf);var e=d.length-1,f=null;me(function(){for(;0<=e;){f=zk(d[e],f);e!==d.length-1||f.F||(f.F=b.xe);if(!e){var c=f,h;h=a;h=h.Ha?Jk(h.Ha,h.ja,1):h.ja;c.ja=h;f.K=a.K;f.Ha=a.Ha;if(f.K)break}c=Pn(b.j,f,!e&&!f.ja);e--;if(c.Pa())return c}return L(!1)}).then(function(){N(c,f)});return c.result()};var Qn=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
function Rn(a,b){if(b.f&&b.ta&&!b.K&&!b.f.count&&1!=b.B.nodeType){var c=b.B.textContent.match(Qn);return Sn(a.j,b,c[0].length)}return L(b)}
...
function Yn(a,b){if(!b.B)return L(b);var c=[],d=b.N,e=K("buildDeepElementView");ne(function(e){b.B&&b.ta&&!Un(b)?c.push(Bk(b)):(0<c.length&&Zn(a,b,c),c=[]);Rn(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.N!=d;)g=g.parent;if(!g){b=f;P(e);return}Un(f)||c.push(Bk(f))}Vn(a,f).then(function(c){(b=c)&&b.N!=d?a.sb.bc(b)?O(e):(b=b.modify(),b.b=!0,a.h?P(e):O(e)):P(e)})})}).then(function(){0<c.length&&Zn(a,b,c);N(e,b)});return e.result()}
function $n(a,b,c,d,e){var f=a.Vf.createElement("div");a.u?(e>=a.height&&(e-=.1),w(f,"height",d+"px"),w(f,"width",e+"px")):(d>=a.width&&(d-=.1),w(f,"width",d+"px"),w(f,"height",e+"px"));w(f,"float",c);w(f,"clear",c);a.element.insertBefore(f,b);return f}function ao(a){for(var b=a.element.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.element.removeChild(b);else break}b=c}}
function bo(a){for(var b=a.element.firstChild,c=a.ra,d=a.u?a.u?a.W:a.A:a.u?a.J:a.W,e=a.u?a.u?a.la:a.J:a.u?a.A:a.la,f=0;f<c.length;f++){var g=c[f],h=g.P-g.S;g.left=$n(a,b,"left",g.U-d,h);g.right=$n(a,b,"right",e-g.V,h)}}function co(a,b,c,d,e){var f;if(b&&eo(b.B))return NaN;if(b&&b.K&&!b.ta&&(f=An(b,a.f,0,a.u),!isNaN(f)))return f;b=c[d];for(e-=b.Ca;;){f=An(b,a.f,e,a.u);if(!isNaN(f))return f;if(0<e)e--;else{d--;if(0>d)return a.A;b=c[d];1!=b.B.nodeType&&(e=b.B.textContent.length)}}}
function X(a){return"number"==typeof a?a:(a=a.match(/^(-?[0-9]*(\.[0-9]*)?)px$/))?parseFloat(a[0]):0}function fo(a,b){var c=go(a.f,b),d=new Yf;c&&(d.left=X(c.marginLeft),d.top=X(c.marginTop),d.right=X(c.marginRight),d.bottom=X(c.marginBottom));return d}function ho(a,b){var c=go(a.f,b),d=new Yf;c&&(d.left=X(c.borderLeftWidth)+X(c.paddingLeft),d.top=X(c.borderTopWidth)+X(c.paddingTop),d.right=X(c.borderRightWidth)+X(c.paddingRight),d.bottom=X(c.borderBottomWidth)+X(c.paddingBottom));return d}
function io(a,b){var c=K("layoutFloat"),d=b.B,e=b.ya;w(d,"float","none");w(d,"display","inline-block");w(d,"vertical-align","top");Yn(a,b).then(function(f){for(var g=lk(a.f,d),h=fo(a,d),g=new Wf(g.left-h.left,g.top-h.top,g.right+h.right,g.bottom+h.bottom),h=a.W,l=a.la,k=b.parent;k&&k.ta;)k=k.parent;if(k){var m=k.B.ownerDocument.createElement("div");m.style.left="0px";m.style.top="0px";a.u?(m.style.bottom="0px",m.style.width="1px"):(m.style.right="0px",m.style.height="1px");k.B.appendChild(m);var p=
lk(a.f,m),h=Math.max(a.u?p.top:p.left,h),l=Math.min(a.u?p.bottom:p.right,l);k.B.removeChild(m);m=a.u?g.P-g.S:g.V-g.U;"left"==e?l=Math.max(l,h+m):h=Math.min(h,l-m);k.B.appendChild(b.B)}m=new Wf(h,Zk(a)*a.A,l,Zk(a)*a.J);h=g;a.u&&(h=mg(g));l=Zk(a);h.S<a.tc*l&&(p=h.P-h.S,h.S=a.tc*l,h.P=h.S+p);a:for(var l=a.ra,p=h,q=p.S,r=p.V-p.U,z=p.P-p.S,u=qg(l,q);;){var A=q+z;if(A>m.P)break a;for(var H=m.U,G=m.V,I=u;I<l.length&&l[I].S<A;I++){var J=l[I];J.U>H&&(H=J.U);J.V<G&&(G=J.V)}if(H+r<=G||u>=l.length){"left"==e?
(p.U=H,p.V=H+r):(p.U=G-r,p.V=G);p.P+=q-p.S;p.S=q;break a}q=l[u].P;u++}a.u&&(g=new Wf(-h.P,h.U,-h.S,h.V));a:{m=go(a.f,d);l=new Yf;if(m){if("border-box"==m.boxSizing){m=fo(a,d);break a}l.left=X(m.marginLeft)+X(m.borderLeftWidth)+X(m.paddingLeft);l.top=X(m.marginTop)+X(m.borderTopWidth)+X(m.paddingTop);l.right=X(m.marginRight)+X(m.borderRightWidth)+X(m.paddingRight);l.bottom=X(m.marginBottom)+X(m.borderBottomWidth)+X(m.paddingBottom)}m=l}w(d,"width",g.V-g.U-m.left-m.right+"px");w(d,"height",g.P-g.S-
m.top-m.bottom+"px");w(d,"position","absolute");w(d,"display",b.display);l=null;if(k)if(k.O)l=k;else a:{for(k=k.parent;k;){if(k.O){l=k;break a}k=k.parent}l=null}l?(m=l.B.ownerDocument.createElement("div"),m.style.position="absolute",l.u?m.style.right="0":m.style.left="0",m.style.top="0",l.B.appendChild(m),k=lk(a.f,m),l.B.removeChild(m)):k={left:a.u?a.J:a.W,right:a.u?a.A:a.la,top:a.u?a.W:a.A};(l?l.u:a.u)?w(d,"right",k.right-g.V+a.I+"px"):w(d,"left",g.U-k.left+a.C+"px");w(d,"top",g.S-k.top+a.D+"px");
b.D&&(b.D.parentNode.removeChild(b.D),b.D=null);k=a.u?g.U:g.P;g=a.u?g.V:g.S;if(In(a,k)&&a.G.length)b=b.modify(),b.b=!0,N(c,b);else{ao(a);m=new Wf(a.u?a.J:a.W,a.u?a.W:a.A,a.u?a.A:a.la,a.u?a.la:a.J);a.u&&(m=mg(m));l=a.ra;for(h=[new $f(h.S,h.P,h.U,h.V)];0<h.length&&h[0].P<=m.S;)h.shift();if(h.length){h[0].S<m.S&&(h[0].S=m.S);p=l.length?l[l.length-1].P:m.S;p<m.P&&l.push(new $f(p,m.P,m.U,m.V));q=qg(l,h[0].S);for(r=0;r<h.length;r++){z=h[r];if(q==l.length)break;l[q].S<z.S&&(p=l[q],q++,l.splice(q,0,new $f(z.S,
p.P,p.U,p.V)),p.P=z.S);for(;q<l.length&&(p=l[q++],p.P>z.P&&(l.splice(q,0,new $f(z.P,p.P,p.U,p.V)),p.P=z.P),z.U!=z.V&&("left"==e?p.U=Math.min(z.V,m.V):p.V=Math.max(z.U,m.U)),p.P!=z.P););}pg(m,l)}bo(a);"left"==e?a.vc=k:a.Nc=k;a.tc=g;jo(a,k);N(c,f)}});return c.result()}
function ko(a,b,c,d,e){var f=a.element.ownerDocument.createElement("div");w(f,"position","absolute");var g=Nm(a.g,b.b),h=new Hm(g,"column",null,a.g.h,b.f,null,null),g=Km(g),f=new lo(c,f,a.j.clone(),a.f,a.sb,h,g);Lm(h,f);var g=b.b,l=a.g;b=Km(l,g);h=f.element;b.element.parentNode.appendChild(h);f.sf=!0;f.gb=b.gb;f.hb=b.hb;f.u=b.u;f.marginLeft=f.marginRight=f.marginTop=f.marginBottom=0;f.borderLeft=f.ha=f.borderTop=f.Z=0;f.C=f.I=f.D=f.H=0;f.Ac=(b.Ac||[]).concat();f.Ae=!Um(l);f.Ia=null;var k=fl(b);bl(f,
k.U-b.gb,k.V-k.U);al(f,k.S-b.hb,k.P-k.S);e.Ye(f,b,a);mo(f);(a=!!nn(l,f,g,c,d,!0,!Um(l)))?(ao(f),mo(f)):b.element.parentNode.removeChild(h);return a?f:null}
function no(a,b,c,d,e,f,g){var h=a.g;b=(g?g.Lb:[]).concat(b);var l=ko(a,b[0].qa,c,f,e),k={nf:l,Oe:null,Ff:null};if(!l)return L(k);var m=K("layoutSinglePageFloatFragment"),p=!1,q=0;ne(function(a){q>=b.length?P(a):nm(l,new Nk(b[q].b),!0).then(function(b){k.Ff=b;!b||d?(q++,O(a)):(p=!0,P(a))})}).then(function(){if(!p){var a=nn(h,l,b[0].qa.b,c,f,!1,d);a?(a=e.hf(b,a,l),Qm(h,a,!0),k.Oe=a):p=!0}N(m,k)});return m.result()}
function oo(a,b,c,d,e){function f(a,c){c?Sm(g,c,!0):a&&a.element.parentNode.removeChild(a.element);hn(g,h.b);Xm(g,b)}var g=a.g,h=b.qa;gn(g,h);var l=K("layoutPageFloatInner");no(a,[b],h.ya,!Um(g),c,d,e).then(function(b){var c=b.nf,d=b.Oe,k=b.Ff;d?po(a,h.b,[e]).then(function(a){a?(Qm(g,d),jn(g,h.b),k&&Xm(g,new Gm(h,k.f)),N(l,!0)):(f(c,d),N(l,!1))}):(f(c,d),N(l,!1))});return l.result()}
function po(a,b,c){var d=a.g,e=kn(d,b),f=[],g=[],h=!1,l=K("layoutStashedPageFloats"),k=0;ne(function(b){if(k>=e.length)P(b);else{var d=e[k];if(0<=c.indexOf(d))k++,O(b);else{var l=wn(d.Lb[0].qa);no(a,d.Lb,d.ya,!1,l,null).then(function(a){var c=a.nf;c&&f.push(c);(a=a.Oe)?(g.push(a),k++,O(b)):(h=!0,P(b))})}}}).then(function(){h?(g.forEach(function(a){Sm(d,a,!0)}),f.forEach(function(a){(a=a.element)&&a.parentNode&&a.parentNode.removeChild(a)})):e.forEach(function(a){(a=a.dc.element)&&a.parentNode&&a.parentNode.removeChild(a)});
N(l,!h)});return l.result()}function qo(a,b){var c=b.B.parentNode,d=c.ownerDocument.createElement("span");d.setAttribute("data-adapt-spec","1");"footnote"===b.ya&&ro(a.j,b,"footnote-call",d);c.appendChild(d);c.removeChild(b.B);c=b.modify();c.K=!0;c.B=d;return c}
function yn(a,b,c,d){var e=K("resolveFloatReferenceFromColumnSpan"),f=a.g,g=Nm(f,"region");Km(f).width<Km(g).width&&"column"===b?c===Lc?Yn(a,Bk(d)).then(function(c){var d=c.B;c=on(a.f,d,[so])[so];d=fo(a,d);c=a.u?c+(d.top+d.bottom):c+(d.left+d.right);c>a.width?N(e,"region"):N(e,b)}):c===Jc?N(e,"region"):N(e,b):N(e,b);return e.result()}
function to(a,b){var c=a.g,d=vn(b),e=c.Ee(Ik(b));return(e?L(e):d.gf(b,c,a)).fa(function(e){var f=wk(b),h=qo(a,b),l=d.Ve(e,c),f=new Gm(e,f);if(l&&Dm(l,e))return Vm(c,e,h.B),L(h);if(Pm(c,e)||Ym(c,e))return Xm(c,f),Vm(c,e,h.B),L(h);if(a.T)return L(null);var k=An(h,a.f,0,a.u);return In(a,k)?L(h):oo(a,f,d,k,l).fa(function(a){if(a)return L(null);Vm(c,e,h.B);return L(h)})})}
function uo(a,b){if(!a.K||a.ta){for(var c=a.B,d="";c&&b&&!d&&(1!=c.nodeType||(d=c.style.textAlign,b));c=c.parentNode);if(!b||"justify"==d){var c=a.B,e=c.ownerDocument,f=a.u,d=e.createElement("span");d.style.visibility="hidden";var g=document.body;if(null===Wa){var h=g.ownerDocument,l=h.createElement("div");l.style.position="absolute";l.style.top="0px";l.style.left="0px";l.style.width="30px";l.style.height="100px";l.style.lineHeight="16px";l.style.fontSize="16px";l.style.textAlign="justify";g.appendChild(l);
var k=h.createTextNode("a | ");l.appendChild(k);var m=h.createElement("span");m.style.display="inline-block";m.style.width="30px";l.appendChild(m);h=h.createRange();h.setStart(k,0);h.setEnd(k,3);Wa=27>h.getBoundingClientRect().right;g.removeChild(l)}Wa?f?d.style.marginTop="100%":d.style.marginLeft="100%":(d.style.display="inline-block",f?d.style.height="100%":d.style.width="100%");d.textContent=" #";d.style.lineHeight="80px";d.setAttribute("data-adapt-spec","1");f=b&&(a.K||1!=c.nodeType)?c.nextSibling:
...
function vo(a,b,c,d){var e=K("processLineStyling");Ln(d);var f=d.concat([]);d.splice(0,d.length);var g=0,h=b.f;0==h.count&&(h=h.dg);ne(function(d){if(h){var e=wo(a,f),l=h.count-g;if(e.length<=l)P(d);else{var p=xo(a,f,e[l-1]);p?a.Ea(p,!1,!1).then(function(){g+=l;Sn(a.j,p,0).then(function(e){b=e;uo(b,!1);h=b.f;f=[];Tn(a,b,f).then(function(a){c=a;O(d)})})}):P(d)}}else P(d)}).then(function(){Array.prototype.push.apply(d,f);Ln(d);N(e,c)});return e.result()}
function yo(a,b){for(var c=0,d=0,e=b.length-1;0<=e;e--){var f=b[e];if(!f.K||!f.B||1!=f.B.nodeType)break;f=fo(a,f.B);f=a.u?-f.left:f.bottom;0<f?c=Math.max(c,f):d=Math.min(d,f)}return c-d}
function zo(a,b){var c=K("layoutBreakableBlock"),d=[];Tn(a,b,d).then(function(e){var f=d.length-1;if(0>f)N(c,e);else{var f=co(a,e,d,f,d[f].Ca),g=!1;if(!e||!eo(e.B)){var h=En(e,Hn(a)),g=In(a,f+(a.u?-1:1)*h.ee);In(a,f+(a.u?-1:1)*h.current)&&!a.T&&(a.T=e)}e||(f+=yo(a,d));jo(a,f);var l;b.f?l=vo(a,b,e,d):l=L(e);l.then(function(b){Zn(a,b,d);0<d.length&&(a.G.push(new Fn(d,d[0].l)),g&&(2!=d.length&&0<a.G.length||d[0].N!=d[1].N||!zn[d[0].N.localName])&&b&&(b=b.modify(),b.b=!0));N(c,b)})}});return c.result()}
function Zn(a,b,c){Qd("POST_LAYOUT_BLOCK").forEach(function(a){a(b,c,this)}.bind(a))}
function xo(a,b,c){Ln(b);for(var d=0,e=b[0].Ca,f=d,g=b.length-1,h=b[g].Ca,l;e<h;){l=e+Math.ceil((h-e)/2);for(var f=d,k=g;f<k;){var m=f+Math.ceil((k-f)/2);b[m].Ca>l?k=m-1:f=m}k=co(a,null,b,f,l);if(a.u?k<c:k>c){for(h=l-1;b[f].Ca==l;)f--;g=f}else jo(a,k),e=l,d=f}b=b[f];c=e;a=b.B;1!=a.nodeType?(Ao(b),e=b,e.K?e.ja=a.length:(c-=e.Ca,b=a.data,173==b.charCodeAt(c)?(a.replaceData(c,b.length-c,e.A?"":e.h||e.parent&&e.parent.h||"-"),a=c+1):(d=b.charAt(c),c++,f=b.charAt(c),a.replaceData(c,b.length-c,!e.A&&Ia(d)&&
Ia(f)?e.h||e.parent&&e.parent.h||"-":""),a=c),c=a,0<c&&(a=c,e=e.modify(),e.ja+=a,e.g=null))):e=b;return e}function Ao(a){Qd("RESOLVE_TEXT_NODE_BREAKER").reduce(function(b,c){return c(a)||b},Bo)}var Bo=new function(){};function Un(a){return a?(a=a.B)&&1===a.nodeType?!!a.getAttribute("data-adapt-spec"):!1:!1}
...
function km(a,b){var c=0;Lk(b,function(a){if("clone"===a.vb["box-decoration-break"]){var b=ho(this,a.B);c+=a.u?-b.left:b.bottom;"table"===a.display&&(c+=a.Qd)}}.bind(a));return c}function Jn(a,b){return(b?En(b.g(),Hn(a)):En(null,Hn(a))).current}
function Gn(a,b,c){for(var d=b.h,e=d[0];e.parent&&e.ta;)e=e.parent;var f;c?f=c=1:(c=Math.max((e.vb.widows||2)-0,1),f=Math.max((e.vb.orphans||2)-0,1));var e=km(a,e),g=wo(a,d),h=a.O-e,d=Jn(a,b),h=h-Zk(a)*d,e=La(g.length,function(b){return a.u?g[b]<h:g[b]>h}),e=Math.min(g.length-c,e);if(e<f)return null;h=g[e-1];if(b=xo(a,b.h,h))a.xa=Zk(a)*(h-a.A)+d;return b}lm.prototype.Ea=function(a,b,c){var d=Cn(a.F).Ea(this,a,b,c);d||(d=Co.Ea(this,a,b,c));return d};
lm.prototype.Ob=function(){var a=null,b=null,c,d=0;do{c=d;for(var d=Number.MAX_VALUE,e=this.G.length-1;0<=e&&!b;--e){var a=this.G[e],b=a.f(this,c),f=a.b();f>c&&(d=Math.min(d,f))}}while(d>c&&!b);return{Fb:b?a:null,w:b}};
function Do(a,b,c,d,e){if(en(a.g)||a.b||!c)return L(b);var f=K("doFinishBreak"),g=!1;if(!b){v.b("Could not find any page breaks?!!");if(a.Ae)return Eo(a,c).then(function(b){b?(b=b.modify(),b.b=!1,a.Ea(b,g,!0).then(function(){N(f,b)})):N(f,b)}),f.result();b=d;g=!0;a.xa=e}a.Ea(b,g,!0).then(function(){N(f,b)});return f.result()}function Fo(a){a=a.toString();return""==a||"auto"==a||!!a.match(/^0+(.0*)?[^0-9]/)}
function Go(a,b,c,d,e){if(!b||eo(b.B))return!1;var f=An(b,a.f,0,a.u),g=En(b,Hn(a)),h=In(a,f+(a.u?-1:1)*g.ee);In(a,f+(a.u?-1:1)*g.current)&&!a.T&&(a.T=b);c&&(f+=yo(a,c));jo(a,f);d=a.h?d:!0;!d&&h||Ho(a,b,e,h);return h}
function Io(a,b){if(!b.B.parentNode)return!1;var c=fo(a,b.B),d=b.B.ownerDocument.createElement("div");a.u?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.B.parentNode.insertBefore(d,b.B);var e=lk(a.f,d),e=a.u?e.right:e.top,f=Zk(a),g=b.C,h=Infinity*-Zk(a);"all"===g&&(h=tn(a.g,a));switch(g){case "left":h=f*Math.max(h*f,a.vc*f);break;case "right":h=f*Math.max(h*f,a.Nc*f);break;default:h=f*Math.max(h*
f,Math.max(a.Nc*f,a.vc*f))}if(e*f>=h*f)return b.B.parentNode.removeChild(d),!1;e=Math.max(1,(h-e)*f);a.u?d.style.width=e+"px":d.style.height=e+"px";e=lk(a.f,d);e=a.u?e.left:e.bottom;a.u?(h=e+c.right-h,0<h==0<=c.right&&(h+=c.right),d.style.marginLeft=h+"px"):(h-=e+c.top,0<h==0<=c.top&&(h+=c.top),d.style.marginBottom=h+"px");b.D=d;return!0}function Jo(a){return a instanceof Mn?!0:a instanceof Ko?!1:a instanceof Lo?!0:!1}
function Mo(a,b,c,d){function e(){return!!d||!c&&!!wl[m]}function f(){b=q[0]||b;b.B.parentNode.removeChild(b.B);h.b=m}var g=b.K?b.parent&&b.parent.F:b.F;if(g&&!Jo(g))return L(b);var h=a,l=K("skipEdges"),k=!d&&c&&b&&b.K,m=d,p=null,q=[],r=[],z=!1;ne(function(a){for(;b;){var d=Cn(b.F);do if(b.B){if(b.ta&&1!=b.B.nodeType){if(nk(b.B,b.ac))break;if(!b.K){e()?f():Go(h,p,null,!0,m)?(b=(h.h?p||b:b).modify(),b.b=!0):(b=b.modify(),b.g=m);P(a);return}}if(!b.K){if(d&&d.we(b))break;b.C&&Io(h,b)&&c&&!h.G.length&&
Ho(h,Bk(b),m,!1);if(!Jo(b.F)||b.F instanceof Lo||Nn(h,b)||b.I){q.push(Bk(b));m=ul(m,b.g);if(e())f();else if(Go(h,p,null,!0,m)||!h.sb.bc(b))b=(h.h?p||b:b).modify(),b.b=!0;P(a);return}}if(1==b.B.nodeType){var g=b.B.style;if(b.K){if(!(b.ta||d&&d.Xe(b,h.h))){if(z){if(e()){f();P(a);return}q=[];k=c=!1;m=null}z=!1;p=Bk(b);r.push(p);m=ul(m,b.G);if(g&&(!Fo(g.paddingBottom)||!Fo(g.borderBottomWidth))){if(Go(h,p,null,!0,m)&&(b=(h.h?p||b:b).modify(),b.b=!0,h.h)){P(a);return}r=[p];p=null}}}else{q.push(Bk(b));
m=ul(m,b.g);if(!h.sb.bc(b)&&(Go(h,p,null,!1,m),b=b.modify(),b.b=!0,h.h)){P(a);return}if(zn[b.B.localName]){e()?f():Go(h,p,null,!0,m)&&(b=(h.h?p||b:b).modify(),b.b=!0);P(a);return}!g||Fo(g.paddingTop)&&Fo(g.borderTopWidth)||(k=!1,r=[]);z=!0}}}while(0);d=Vn(h,b,k);if(d.Pa()){d.then(function(c){b=c;O(a)});return}b=d.get()}Go(h,p,r,!1,m)?p&&h.h&&(b=p.modify(),b.b=!0):wl[m]&&(h.b=m);P(a)}).then(function(){p&&(h.Ra=Ik(p));N(l,b)});return l.result()}
function Eo(a,b){var c=Bk(b),d=K("skipEdges"),e=null,f=!1;ne(function(d){for(;b;){do if(b.B){if(b.ta&&1!=b.B.nodeType){if(nk(b.B,b.ac))break;if(!b.K){wl[e]&&(a.b=e);P(d);return}}if(!b.K&&(Nn(a,b)||b.I)){e=ul(e,b.g);wl[e]&&(a.b=e);P(d);return}if(1==b.B.nodeType){var g=b.B.style;if(b.K){if(f){if(wl[e]){a.b=e;P(d);return}e=null}f=!1;e=ul(e,b.G)}else{e=ul(e,b.g);if(zn[b.B.localName]){wl[e]&&(a.b=e);P(d);return}if(g&&(!Fo(g.paddingTop)||!Fo(g.borderTopWidth))){P(d);return}}f=!0}}while(0);g=hm(a.j,b);if(g.Pa()){g.then(function(a){b=
a;O(d)});return}b=g.get()}c=null;P(d)}).then(function(){N(d,c)});return d.result()}function Wn(a,b){return ym(b.H)||"footnote"===b.ya?to(a,b):io(a,b)}function No(a,b,c,d){var e=K("layoutNext");Mo(a,b,c,d||null).then(function(d){b=d;!b||a.b||a.h&&b&&b.b?N(e,b):Cn(b.F).Nd(b,a,c).Ba(e)});return e.result()}function Oo(a,b,c){if(b)for(var d=b.parent;b;b=d,d=d?d.parent:null)Cn((d||b).F).ld(a,d,b,c),c=!1}
function mo(a){a.pf=[];w(a.element,"width",a.width+"px");w(a.element,"height",a.height+"px");var b=a.element.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.D+"px";b.style.right=a.I+"px";b.style.bottom=a.H+"px";b.style.left=a.C+"px";a.element.appendChild(b);var c=lk(a.f,b);a.element.removeChild(b);var b=a.gb+a.left+Xk(a),d=a.hb+a.top+Vk(a);a.lf=new Wf(b,d,b+a.width,d+a.height);a.W=c?a.u?c.top:c.left:0;a.la=c?a.u?c.bottom:c.right:0;a.A=c?a.u?c.right:c.top:0;a.J=c?a.u?c.left:
c.bottom:0;a.vc=a.A;a.Nc=a.A;a.tc=a.A;a.O=a.J;var c=a.lf,e,b=a.gb+a.left+Xk(a),d=a.hb+a.top+Vk(a);e=new Wf(b,d,b+a.width,d+a.height);if(a.Ia){b=a.Ia;d=e.U;e=e.S;for(var f=[],g=0;g<b.b.length;g++){var h=b.b[g];f.push(new Xf(h.f+d,h.b+e))}b=new bg(f)}else b=eg(e.U,e.S,e.V,e.P);b=[b];d=rn(a.g);a.ra=og(c,b,a.Ac.concat(d),a.Sa,a.u);bo(a);a.xa=0;a.Ab=!1;a.b=null;a.Ra=null}function Ho(a,b,c,d){var e=Bk(b);b=Cn(b.F).ff(e,c,d,a.xa);a.G.push(b)}
function jo(a,b){isNaN(b)||(a.xa=Math.max(Zk(a)*(b-a.A),a.xa))}
function nm(a,b,c,d){a.pf.push(b);b.f.K&&(a.Ra=b.f);if(a.h&&a.Ab)return L(b);var e=K("layout");a.tb(b.f).then(function(b){var f=null;if(b.B)f=Bk(b);else{var h=function(b){b.w.B&&(f=b.w,a.j.removeEventListener("nextInTree",h))};a.j.addEventListener("nextInTree",h)}var l=new Po(c,d);qm(l,b,a).then(function(b){Do(a,b,l.A.zd,f,l.b).then(function(b){var c=null;a.Bb?c=L(null):c=Ro(a,b);c.then(function(){if(en(a.g))N(e,null);else if(b){a.Ab=!0;var c=new Nk(Ik(b));N(e,c)}else N(e,null)})})})});return e.result()}
function Ro(a,b){var c=K("doFinishBreakOfFragmentLayoutConstraints"),d=[].concat(a.l);d.sort(function(a,b){return a.Fe()-b.Fe()});var e=0;me(function(){return e<d.length?d[e++].Ea(b,this).sc(!0):L(!1)}.bind(a)).then(function(){N(c,!0)});return c.result()}
function So(a,b,c,d){var e=K("doLayout"),f=null;a.G=[];a.T=null;ne(function(e){for(;b;){var g=!0;No(a,b,c,d||null).then(function(h){c=!1;d=null;a.T&&a.h?(a.b=null,b=a.T,b.b=!0):b=h;en(a.g)?P(e):a.b?P(e):b&&a.h&&b&&b.b?(f=b,b=a.Ob().w,P(e)):g?g=!1:O(e)});if(g){g=!1;return}}a.xa+=Jn(a);P(e)}).then(function(){N(e,{w:b,zd:f})});return e.result()}function eo(a){for(;a;){if(a.parentNode===a.ownerDocument)return!1;a=a.parentNode}return!0}
function Po(a,b){pm.call(this);this.Qb=a;this.J=b||null;this.G=null;this.b=0;this.D=!1;this.A={zd:null}}t(Po,pm);Po.prototype.j=function(){return new To(this.Qb,this.J,this.A)};Po.prototype.I=function(a,b){b.l=[];b.Bb||(Uo=[])};Po.prototype.l=function(a,b){pm.prototype.l.call(this,a,b);this.G=b.b;this.b=b.xa;this.D=b.Ab};Po.prototype.f=function(a,b){pm.prototype.f.call(this,a,b);b.b=this.G;b.xa=this.b;b.Ab=this.D};function To(a,b,c){this.Qb=a;this.j=b;this.h=c}
To.prototype.b=function(a,b){var c=K("adapt.layout.DefaultLayoutMode.doLayout");Vo(a,b).then(function(){So(b,a,this.Qb,this.j).then(function(a){this.h.zd=a.zd;N(c,a.w)}.bind(this))}.bind(this));return c.result()};To.prototype.f=function(a,b){return en(b.g)||b.b||0>=b.l.length?!0:b.l.every(function(c){return c.bc(a,this.h.zd,b)}.bind(this))};To.prototype.g=function(a,b,c,d){d||(d=!c.l.some(function(b){return b.yd(a)}));c.l.forEach(function(e){e.md(d,a,b,c)});return d};function Wo(){}n=Wo.prototype;
n.Nd=function(a,b){var c;if(Nn(b,a))c=Wn(b,a);else{a:if(a.K)c=!0;else{switch(a.N.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!a.I}c=c?zo(b,a):Yn(b,a)}return c};n.ff=function(a,b,c,d){return new om(Bk(a),b,c,d)};n.we=function(){return!1};n.Xe=function(){return!1};n.ld=function(a,b,c,d){if(c.B&&c.B.parentNode){a=c.B.parentNode;b=c.B;if(a)for(var e;(e=a.lastChild)!=b;)a.removeChild(e);d&&a.removeChild(c.B)}};
n.Ea=function(a,b,c,d){c=c||!!b.B&&1==b.B.nodeType&&!b.K;Oo(a,b,c);d&&(uo(b,!0),Xo(c?b:b.parent));return L(!0)};var Co=new Wo;Pd("RESOLVE_FORMATTING_CONTEXT",function(a,b,c,d,e,f){b=a.parent;return!b&&a.F?null:b&&a.F!==b.F?null:a.Qc||!a.F&&yl(c,d,e,f).display===Mc?new Mn(b?b.F:null):null});Pd("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof Mn?Co:null});function lo(a,b,c,d,e,f,g){lm.call(this,b,c,d,e,f);this.ya=a;this.yf=g;this.zf=[];this.rf=[];this.uc=!0}t(lo,lm);
lo.prototype.tb=function(a){return lm.prototype.tb.call(this,a).fa(function(a){if(a){for(var b=a;b.parent;)b=b.parent;b=b.B;this.zf.push(b);this.uc&&Yo(this,b);this.rf.push(fo(this,b));if(this.uc){var d=this.ya;if(this.yf.u){if("block-end"===d||"left"===d)d=Aa(b,"height"),""!==d&&"auto"!==d&&w(b,"margin-top","auto")}else if("block-end"===d||"bottom"===d)d=Aa(b,"width"),""!==d&&"auto"!==d&&w(b,"margin-left","auto")}}return L(a)}.bind(this))};
function Yo(a,b){function c(a,c){a.forEach(function(a){var d=Aa(b,a);d&&"%"===d.charAt(d.length-1)&&w(b,a,c*parseFloat(d)/100+"px")})}var d=fl(a.yf),e=d.V-d.U,d=d.P-d.S;c(["width","max-width","min-width"],e);c(["height","max-height","min-height"],d);c("margin-top margin-right margin-bottom margin-left padding-top padding-right padding-bottom padding-left".split(" "),a.u?d:e);["margin-top","margin-right","margin-bottom","margin-left"].forEach(function(a){"auto"===Aa(b,a)&&w(b,a,"0")})}
function qn(a){return Math.max.apply(null,a.zf.map(function(a,c){var b=lk(this.f,a),e=this.rf[c];return this.u?e.top+b.height+e.bottom:e.left+b.width+e.right},a))}function Zo(a,b,c){var d=lk(b.f,a);a=fo(b,a);return c?d.width+a.left+a.right:d.height+a.top+a.bottom};function $o(a,b){this.b=a;this.$=b}function ap(a,b,c,d){this.b=a;this.g=b;this.j=c;this.f=d;this.h=null}function bp(a,b){this.b=a;this.f=b}function cp(a){var b={};Object.keys(a).forEach(function(c){b[c]=Array.from(a[c])});return b}function dp(a,b){this.rc=a;this.$c=b;this.ie=null;this.$=this.R=-1}function jj(a,b,c){b=a.b.J.oe(b,a.f);a.b.l[b]=c}function ep(a){return(a=a.match(/^[^#]*#(.*)$/))?a[1]:null}function fp(a,b){var c=a.b.J.fd(oa(b,a.g),a.g);"#"===c.charAt(0)&&(c=c.substring(1));return c}
function Mi(a,b,c){return new vb(a.f,function(){var d=a.b.b[b];return c(d&&d.length?d[d.length-1]:null)},"page-counter-"+b)}function Oi(a,b,c){return new vb(a.f,function(){return c(a.b.b[b]||[])},"page-counters-"+b)}function gp(a,b,c,d){var e=a.b.l[c];if(!e&&d&&b){d=a.h;if(b){d.D=b;for(b=0;d.D&&(b+=5E3,Ll(d,b,0)!==Number.POSITIVE_INFINITY););d.D=null}e=a.b.l[c]}return e||null}
function Qi(a,b,c,d){var e=ep(b),f=fp(a,b),g=gp(a,e,f,!1);return g&&g[c]?(b=g[c],new tb(a.j,d(b[b.length-1]||null))):new vb(a.f,function(){if(g=gp(a,e,f,!0)){if(g[c]){var b=g[c];return d(b[b.length-1]||null)}if(b=a.b.j.b[f]?a.b.b:a.b.C[f]||null)return hp(a.b,f),b[c]?(b=b[c],d(b[b.length-1]||null)):d(0);ip(a.b,f,!1);return"??"}ip(a.b,f,!1);return"??"},"target-counter-"+c+"-of-"+b)}
function Si(a,b,c,d){var e=ep(b),f=fp(a,b);return new vb(a.f,function(){var b=a.b.j.b[f]?a.b.b:a.b.C[f]||null;if(b){hp(a.b,f);var b=b[c]||[],h=gp(a,e,f,!0)[c]||[];return d(b.concat(h))}ip(a.b,f,!1);return"??"},"target-counters-"+c+"-of-"+b)}function jp(a){this.J=a;this.l={};this.C={};this.b={};this.b.page=[0];this.H={};this.G=[];this.D={};this.j=null;this.A=[];this.g=[];this.I=[];this.f={};this.h={}}function kp(a,b){var c=a.b.page;c&&c.length?c[c.length-1]=b:a.b.page=[b]}
function lp(a,b,c){a.H=cp(a.b);var d,e=b["counter-reset"];e&&(e=e.evaluate(c))&&(d=zg(e,!0));if(d)for(var f in d){var e=a,g=f,h=d[f];e.b[g]?e.b[g].push(h):e.b[g]=[h]}var l;(b=b["counter-increment"])&&(c=b.evaluate(c))&&(l=zg(c,!1));l?"page"in l||(l.page=1):l={page:1};for(var k in l)a.b[k]||(c=a,b=k,c.b[b]?c.b[b].push(0):c.b[b]=[0]),c=a.b[k],c[c.length-1]+=l[k]}function mp(a,b){a.G.push(a.b);a.b=cp(b)}
function hp(a,b){var c=a.f[b],d=a.h[b];d||(d=a.h[b]=[]);for(var e=!1,f=0;f<a.g.length;){var g=a.g[f];g.rc===b?(g.$c=!0,a.g.splice(f,1),c&&(e=c.indexOf(g),0<=e&&c.splice(e,1)),d.push(g),e=!0):f++}e||ip(a,b,!0)}function ip(a,b,c){a.A.some(function(a){return a.rc===b})||a.A.push(new dp(b,c))}
function np(a,b,c){var d=Object.keys(a.j.b);if(0<d.length){var e=cp(a.b);d.forEach(function(a){this.C[a]=e;var d=this.D[a];if(d&&d.$<c&&(d=this.h[a])){var f=this.f[a];f||(f=this.f[a]=[]);for(var g;g=d.shift();)g.$c=!1,f.push(g)}this.D[a]={R:b,$:c}},a)}for(var d=a.H,f;f=a.A.shift();){f.ie=d;f.R=b;f.$=c;var g;f.$c?(g=a.h[f.rc])||(g=a.h[f.rc]=[]):(g=a.f[f.rc])||(g=a.f[f.rc]=[]);g.every(function(a){return!(f===a||a&&f.rc===a.rc&&f.$c===a.$c&&f.R===a.R&&f.$===a.$)})&&g.push(f)}a.j=null}
function op(a,b){var c=[];Object.keys(b.b).forEach(function(a){(a=this.f[a])&&(c=c.concat(a))},a);c.sort(function(a,b){return a.R-b.R||a.$-b.$});var d=[],e=null;c.forEach(function(a){e&&e.R===a.R&&e.$===a.$?e.Ad.push(a):(e={R:a.R,$:a.$,ie:a.ie,Ad:[a]},d.push(e))});return d}function pp(a,b){a.I.push(a.g);a.g=b}
$o.prototype.bc=function(a){if(!a||a.K)return!0;a=a.B;if(!a||1!==a.nodeType)return!0;a=a.getAttribute("id")||a.getAttribute("name");return a&&(this.b.h[a]||this.b.f[a])?(a=this.b.D[a])?this.$>=a.$:!0:!0};var qp=1;function rp(a,b,c,d,e){this.b={};this.j=[];this.g=null;this.index=0;this.f=a;this.name=b;this.Wb=c;this.Da=d;this.parent=e;this.l="p"+qp++;e&&(this.index=e.j.length,e.j.push(this))}rp.prototype.h=function(){throw Error("E_UNEXPECTED_CALL");};rp.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function sp(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}function tp(a,b){for(var c=0;c<a.j.length;c++)a.j[c].clone({parent:b})}
function up(a){rp.call(this,a,null,null,[],null);this.b.width=new V(Id,0);this.b.height=new V(Jd,0)}t(up,rp);
function vp(a,b){this.g=b;var c=this;sb.call(this,a,function(a,b){var d=a.match(/^([^.]+)\.([^.]+)$/);if(d){var e=c.g.A[d[1]];if(e&&(e=this.Ia[e])){if(b){var d=d[2],h=e.ha[d];if(h)e=h;else{switch(d){case "columns":var h=e.b.f,l=new kc(h,0),k=wp(e,"column-count"),m=wp(e,"column-width"),p=wp(e,"column-gap"),h=y(h,mc(h,new hc(h,"min",[l,k]),x(h,m,p)),p)}h&&(e.ha[d]=h);e=h}}else e=wp(e,d[2]);return e}}return null})}t(vp,sb);
function xp(a,b,c,d,e,f,g){a=a instanceof vp?a:new vp(a,this);rp.call(this,a,b,c,d,e);this.g=this;this.ea=f;this.Y=g;this.b.width=new V(Id,0);this.b.height=new V(Jd,0);this.b["wrap-flow"]=new V(Lc,0);this.b.position=new V(qd,0);this.b.overflow=new V(Fd,0);this.A={}}t(xp,rp);xp.prototype.h=function(a){return new yp(a,this)};xp.prototype.clone=function(a){a=new xp(this.f,this.name,a.Wb||this.Wb,this.Da,this.parent,this.ea,this.Y);sp(this,a);tp(this,a);return a};
function zp(a,b,c,d,e){rp.call(this,a,b,c,d,e);this.g=e.g;b&&(this.g.A[b]=this.l);this.b["wrap-flow"]=new V(Lc,0)}t(zp,rp);zp.prototype.h=function(a){return new Ap(a,this)};zp.prototype.clone=function(a){a=new zp(a.parent.f,this.name,this.Wb,this.Da,a.parent);sp(this,a);tp(this,a);return a};function Bp(a,b,c,d,e){rp.call(this,a,b,c,d,e);this.g=e.g;b&&(this.g.A[b]=this.l)}t(Bp,rp);Bp.prototype.h=function(a){return new Cp(a,this)};
Bp.prototype.clone=function(a){a=new Bp(a.parent.f,this.name,this.Wb,this.Da,a.parent);sp(this,a);tp(this,a);return a};function Y(a,b,c){return b&&b!==Lc?b.sa(a,c):null}function Dp(a,b,c){return b&&b!==Lc?b.sa(a,c):a.b}function Ep(a,b,c){return b?b===Lc?null:b.sa(a,c):a.b}function Fp(a,b,c,d){return b&&c!==F?b.sa(a,d):a.b}function Gp(a,b,c){return b?b===Gd?a.j:b===Xc?a.h:b.sa(a,a.b):c}
function Hp(a,b){this.f=a;this.b=b;this.J={};this.style={};this.C=this.D=null;this.A=[];this.O=this.T=this.g=this.h=!1;this.H=this.I=0;this.G=null;this.la={};this.ha={};this.ra=this.u=!1;a&&a.A.push(this)}function Ip(a){a.I=0;a.H=0}function Jp(a,b,c){b=wp(a,b);c=wp(a,c);if(!b||!c)throw Error("E_INTERNAL");return x(a.b.f,b,c)}
function wp(a,b){var c=a.la[b];if(c)return c;var d=a.style[b];d&&(c=d.sa(a.b.f,a.b.f.b));switch(b){case "margin-left-edge":c=wp(a,"left");break;case "margin-top-edge":c=wp(a,"top");break;case "margin-right-edge":c=Jp(a,"border-right-edge","margin-right");break;case "margin-bottom-edge":c=Jp(a,"border-bottom-edge","margin-bottom");break;case "border-left-edge":c=Jp(a,"margin-left-edge","margin-left");break;case "border-top-edge":c=Jp(a,"margin-top-edge","margin-top");break;case "border-right-edge":c=
Jp(a,"padding-right-edge","border-right-width");break;case "border-bottom-edge":c=Jp(a,"padding-bottom-edge","border-bottom-width");break;case "padding-left-edge":c=Jp(a,"border-left-edge","border-left-width");break;case "padding-top-edge":c=Jp(a,"border-top-edge","border-top-width");break;case "padding-right-edge":c=Jp(a,"right-edge","padding-right");break;case "padding-bottom-edge":c=Jp(a,"bottom-edge","padding-bottom");break;case "left-edge":c=Jp(a,"padding-left-edge","padding-left");break;case "top-edge":c=
Jp(a,"padding-top-edge","padding-top");break;case "right-edge":c=Jp(a,"left-edge","width");break;case "bottom-edge":c=Jp(a,"top-edge","height")}if(!c){if("extent"==b)d=a.u?"width":"height";else if("measure"==b)d=a.u?"height":"width";else{var e=a.u?xh:yh,d=b,f;for(f in e)d=d.replace(f,e[f])}d!=b&&(c=wp(a,d))}c&&(a.la[b]=c);return c}
function Kp(a){var b=a.b.f,c=a.style,d=Gp(b,c.enabled,b.j),e=Y(b,c.page,b.b);if(e)var f=new fc(b,"page-number"),d=lc(b,d,new Yb(b,e,f));(e=Y(b,c["min-page-width"],b.b))&&(d=lc(b,d,new Xb(b,new fc(b,"page-width"),e)));(e=Y(b,c["min-page-height"],b.b))&&(d=lc(b,d,new Xb(b,new fc(b,"page-height"),e)));d=a.W(d);c.enabled=new E(d)}Hp.prototype.W=function(a){return a};
Hp.prototype.ae=function(){var a=this.b.f,b=this.style,c=this.f?this.f.style.width.sa(a,null):null,d=Y(a,b.left,c),e=Y(a,b["margin-left"],c),f=Fp(a,b["border-left-width"],b["border-left-style"],c),g=Dp(a,b["padding-left"],c),h=Y(a,b.width,c),l=Y(a,b["max-width"],c),k=Dp(a,b["padding-right"],c),m=Fp(a,b["border-right-width"],b["border-right-style"],c),p=Y(a,b["margin-right"],c),q=Y(a,b.right,c),r=x(a,f,g),z=x(a,f,k);d&&q&&h?(r=y(a,c,x(a,h,x(a,x(a,d,r),z))),e?p?q=y(a,r,p):p=y(a,r,x(a,q,e)):(r=y(a,r,
q),p?e=y(a,r,p):p=e=mc(a,r,new tb(a,.5)))):(e||(e=a.b),p||(p=a.b),d||q||h||(d=a.b),d||h?d||q?h||q||(h=this.D,this.h=!0):d=a.b:(h=this.D,this.h=!0),r=y(a,c,x(a,x(a,e,r),x(a,p,z))),this.h&&(l||(l=y(a,r,d?d:q)),this.u||!Y(a,b["column-width"],null)&&!Y(a,b["column-count"],null)||(h=l,this.h=!1)),d?h?q||(q=y(a,r,x(a,d,h))):h=y(a,r,x(a,d,q)):d=y(a,r,x(a,q,h)));a=Dp(a,b["snap-width"]||(this.f?this.f.style["snap-width"]:null),c);b.left=new E(d);b["margin-left"]=new E(e);b["border-left-width"]=new E(f);b["padding-left"]=
...
Hp.prototype.be=function(){var a=this.b.f,b=this.style,c=this.f?this.f.style.width.sa(a,null):null,d=this.f?this.f.style.height.sa(a,null):null,e=Y(a,b.top,d),f=Y(a,b["margin-top"],c),g=Fp(a,b["border-top-width"],b["border-top-style"],c),h=Dp(a,b["padding-top"],c),l=Y(a,b.height,d),k=Y(a,b["max-height"],d),m=Dp(a,b["padding-bottom"],c),p=Fp(a,b["border-bottom-width"],b["border-bottom-style"],c),q=Y(a,b["margin-bottom"],c),r=Y(a,b.bottom,d),z=x(a,g,h),u=x(a,p,m);e&&r&&l?(d=y(a,d,x(a,l,x(a,x(a,e,z),
u))),f?q?r=y(a,d,f):q=y(a,d,x(a,r,f)):(d=y(a,d,r),q?f=y(a,d,q):q=f=mc(a,d,new tb(a,.5)))):(f||(f=a.b),q||(q=a.b),e||r||l||(e=a.b),e||l?e||r?l||r||(l=this.C,this.g=!0):e=a.b:(l=this.C,this.g=!0),d=y(a,d,x(a,x(a,f,z),x(a,q,u))),this.g&&(k||(k=y(a,d,e?e:r)),this.u&&(Y(a,b["column-width"],null)||Y(a,b["column-count"],null))&&(l=k,this.g=!1)),e?l?r||(r=y(a,d,x(a,e,l))):l=y(a,d,x(a,r,e)):e=y(a,d,x(a,r,l)));a=Dp(a,b["snap-height"]||(this.f?this.f.style["snap-height"]:null),c);b.top=new E(e);b["margin-top"]=
...
function Lp(a){var b=a.b.f,c=a.style;a=Y(b,c[a.u?"height":"width"],null);var d=Y(b,c["column-width"],a),e=Y(b,c["column-count"],null),f;(f=(f=c["column-gap"])&&f!==md?f.sa(b,null):null)||(f=new ec(b,1,"em"));d&&!e&&(e=new hc(b,"floor",[nc(b,x(b,a,f),x(b,d,f))]),e=new hc(b,"max",[b.f,e]));e||(e=b.f);d=y(b,nc(b,x(b,a,f),e),f);c["column-width"]=new E(d);c["column-count"]=new E(e);c["column-gap"]=new E(f)}function Mp(a,b,c,d){a=a.style[b].sa(a.b.f,null);return Hb(a,c,d,{})}
function Np(a,b){b.Ia[a.b.l]=a;var c=a.b.f,d=a.style,e=a.f?Op(a.f,b):null,e=wj(a.J,b,e,!1);a.u=vj(e,b,a.f?a.f.u:!1);Aj(e,d,a.u,function(a,b){return b.value});a.D=new vb(c,function(){return a.I},"autoWidth");a.C=new vb(c,function(){return a.H},"autoHeight");a.ae();a.be();Lp(a);Kp(a)}function Pp(a,b,c){(a=a.style[c])&&(a=Vf(b,a,c));return a}function Z(a,b,c){(a=a.style[c])&&(a=Vf(b,a,c));return Hc(a,b)}
function Op(a,b){var c;a:{if(c=a.J["region-id"]){for(var d=[],e=0;e<c.length;e++){var f=c[e].evaluate(b,"");f&&f!==B&&d.push(f)}if(d.length){c=d;break a}}c=null}if(c){d=[];for(e=0;e<c.length;e++)d[e]=c[e].toString();return d}return null}function Qp(a,b,c,d,e){if(a=Pp(a,b,d))a.jc()&&zb(a.ga)&&(a=new D(Hc(a,b),"px")),"font-family"===d&&(a=Xl(e,a)),w(c,d,a.toString())}
function Rp(a,b,c){var d=Z(a,b,"left"),e=Z(a,b,"margin-left"),f=Z(a,b,"padding-left"),g=Z(a,b,"border-left-width");a=Z(a,b,"width");bl(c,d,a);w(c.element,"margin-left",e+"px");w(c.element,"padding-left",f+"px");w(c.element,"border-left-width",g+"px");c.marginLeft=e;c.borderLeft=g;c.C=f}
function Sp(a,b,c){var d=Z(a,b,"right"),e=Z(a,b,"snap-height"),f=Z(a,b,"margin-right"),g=Z(a,b,"padding-right");b=Z(a,b,"border-right-width");w(c.element,"margin-right",f+"px");w(c.element,"padding-right",g+"px");w(c.element,"border-right-width",b+"px");c.marginRight=f;c.ha=b;a.u&&0<e&&(a=d+Yk(c),a-=Math.floor(a/e)*e,0<a&&(c.Cb=e-a,g+=c.Cb));c.I=g;c.Db=e}
function Tp(a,b,c){var d=Z(a,b,"snap-height"),e=Z(a,b,"top"),f=Z(a,b,"margin-top"),g=Z(a,b,"padding-top");b=Z(a,b,"border-top-width");c.top=e;c.marginTop=f;c.borderTop=b;c.Sa=d;!a.u&&0<d&&(a=e+Vk(c),a-=Math.floor(a/d)*d,0<a&&(c.na=d-a,g+=c.na));c.D=g;w(c.element,"top",e+"px");w(c.element,"margin-top",f+"px");w(c.element,"padding-top",g+"px");w(c.element,"border-top-width",b+"px")}
function Up(a,b,c){var d=Z(a,b,"margin-bottom"),e=Z(a,b,"padding-bottom"),f=Z(a,b,"border-bottom-width");a=Z(a,b,"height")-c.na;w(c.element,"height",a+"px");w(c.element,"margin-bottom",d+"px");w(c.element,"padding-bottom",e+"px");w(c.element,"border-bottom-width",f+"px");c.height=a-c.na;c.marginBottom=d;c.Z=f;c.H=e}function Vp(a,b,c){a.u?(Tp(a,b,c),Up(a,b,c)):(Sp(a,b,c),Rp(a,b,c))}
function Wp(a,b,c){w(c.element,"border-top-width","0px");var d=Z(a,b,"max-height");a.T?al(c,0,d):(Tp(a,b,c),d-=c.na,c.height=d,w(c.element,"height",d+"px"))}function Xp(a,b,c){w(c.element,"border-left-width","0px");var d=Z(a,b,"max-width");a.O?bl(c,0,d):(Sp(a,b,c),d-=c.Cb,c.width=d,a=Z(a,b,"right"),w(c.element,"right",a+"px"),w(c.element,"width",d+"px"))}
var Yp="border-left-style border-right-style border-top-style border-bottom-style border-left-color border-right-color border-top-color border-bottom-color outline-style outline-color outline-width overflow visibility".split(" "),Zp="border-top-left-radius border-top-right-radius border-bottom-right-radius border-bottom-left-radius border-image-source border-image-slice border-image-width border-image-outset border-image-repeat background-attachment background-color background-image background-repeat background-position background-clip background-origin background-size opacity z-index".split(" "),
$p="color font-family font-size font-style font-weight font-variant line-height letter-spacing text-align text-decoration text-indent text-transform white-space word-spacing".split(" "),aq=["width","height"],bq=["transform","transform-origin"];
Hp.prototype.Ub=function(a,b,c,d){this.f&&this.u==this.f.u||w(b.element,"writing-mode",this.u?"vertical-rl":"horizontal-tb");(this.u?this.h:this.g)?this.u?Xp(this,a,b):Wp(this,a,b):(this.u?Sp(this,a,b):Tp(this,a,b),this.u?Rp(this,a,b):Up(this,a,b));(this.u?this.g:this.h)?this.u?Wp(this,a,b):Xp(this,a,b):Vp(this,a,b);for(c=0;c<Yp.length;c++)Qp(this,a,b.element,Yp[c],d)};function cq(a,b,c,d){for(var e=0;e<$p.length;e++)Qp(a,b,c.element,$p[e],d)}
function dq(a,b,c,d){for(var e=0;e<aq.length;e++)Qp(a,b,c,aq[e],d)}
Hp.prototype.sd=function(a,b,c,d,e,f,g){this.u?this.I=b.xa+b.Cb:this.H=b.xa+b.na;var h=(this.u||!d)&&this.g,l=(!this.u||!d)&&this.h;if(l||h)l&&w(b.element,"width","auto"),h&&w(b.element,"height","auto"),d=lk(f,d?d.element:b.element),l&&(this.I=Math.ceil(d.right-d.left-b.C-b.borderLeft-b.I-b.ha),this.u&&(this.I+=b.Cb)),h&&(this.H=d.bottom-d.top-b.D-b.borderTop-b.H-b.Z,this.u||(this.H+=b.na));(this.u?this.g:this.h)&&Vp(this,a,b);if(this.u?this.h:this.g){if(this.u?this.O:this.T)this.u?Sp(this,a,b):Tp(this,
a,b);this.u?Rp(this,a,b):Up(this,a,b)}if(1<e&&(l=Z(this,a,"column-rule-width"),d=Pp(this,a,"column-rule-style"),f=Pp(this,a,"column-rule-color"),0<l&&d&&d!=F&&f!=Cd))for(var k=Z(this,a,"column-gap"),m=this.u?b.height:b.width,p=this.u?"border-top":"border-left",h=1;h<e;h++){var q=(m+k)*h/e-k/2+b.C-l/2,r=b.height+b.D+b.H,z=b.element.ownerDocument.createElement("div");w(z,"position","absolute");w(z,this.u?"left":"top","0px");w(z,this.u?"top":"left",q+"px");w(z,this.u?"height":"width","0px");w(z,this.u?
"width":"height",r+"px");w(z,p,l+"px "+d.toString()+(f?" "+f.toString():""));b.element.insertBefore(z,b.element.firstChild)}for(h=0;h<Zp.length;h++)Qp(this,a,b.element,Zp[h],g);for(h=0;h<bq.length;h++)e=b,g=bq[h],l=c.A,(d=Pp(this,a,g))&&l.push(new dk(e.element,g,d))};
Hp.prototype.j=function(a,b){var c=this.J,d=this.b.b,e;for(e in d)Ch(e)&&Dh(c,e,d[e]);if("background-host"==this.b.Wb)for(e in b)if(e.match(/^background-/)||"writing-mode"==e)c[e]=b[e];if("layout-host"==this.b.Wb)for(e in b)e.match(/^background-/)||"writing-mode"==e||(c[e]=b[e]);bj(a,this.b.Da,null,c);c.content&&(c.content=c.content.rd(new Ei(a,null,a.Ab)));Np(this,a.l);for(c=0;c<this.b.j.length;c++)this.b.j[c].h(this).j(a,b);a.pop()};
function eq(a,b){a.h&&(a.O=Mp(a,"right",a.D,b)||Mp(a,"margin-right",a.D,b)||Mp(a,"border-right-width",a.D,b)||Mp(a,"padding-right",a.D,b));a.g&&(a.T=Mp(a,"top",a.C,b)||Mp(a,"margin-top",a.C,b)||Mp(a,"border-top-width",a.C,b)||Mp(a,"padding-top",a.C,b));for(var c=0;c<a.A.length;c++)eq(a.A[c],b)}function fq(a){Hp.call(this,null,a)}t(fq,Hp);fq.prototype.j=function(a,b){Hp.prototype.j.call(this,a,b);this.A.sort(function(a,b){return b.b.Y-a.b.Y||a.b.index-b.b.index})};
function yp(a,b){Hp.call(this,a,b);this.G=this}t(yp,Hp);yp.prototype.W=function(a){var b=this.b.g;b.ea&&(a=lc(b.f,a,b.ea));return a};yp.prototype.Z=function(){};function Ap(a,b){Hp.call(this,a,b);this.G=a.G}t(Ap,Hp);function Cp(a,b){Hp.call(this,a,b);this.G=a.G}t(Cp,Hp);function gq(a,b,c,d){var e=null;c instanceof zc&&(e=[c]);c instanceof sc&&(e=c.values);if(e)for(a=a.b.f,c=0;c<e.length;c++)if(e[c]instanceof zc){var f=qb(e[c].name,"enabled"),f=new fc(a,f);d&&(f=new Ob(a,f));b=lc(a,b,f)}return b}
Cp.prototype.W=function(a){var b=this.b.f,c=this.style,d=Gp(b,c.required,b.h)!==b.h;if(d||this.g){var e;e=(e=c["flow-from"])?e.sa(b,b.b):new tb(b,"body");e=new hc(b,"has-content",[e]);a=lc(b,a,e)}a=gq(this,a,c["required-partitions"],!1);a=gq(this,a,c["conflicting-partitions"],!0);d&&(c=(c=this.G.style.enabled)?c.sa(b,null):b.j,c=lc(b,c,a),this.G.style.enabled=new E(c));return a};Cp.prototype.Ub=function(a,b,c,d,e){w(b.element,"overflow","hidden");Hp.prototype.Ub.call(this,a,b,c,d,e)};
function hq(a,b,c,d){of.call(this,a,b,!1);this.target=c;this.b=d}t(hq,pf);hq.prototype.wb=function(a,b,c){kh(this.b,a,b,c,this)};hq.prototype.Kd=function(a,b){qf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};hq.prototype.Sc=function(a,b){qf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};hq.prototype.xb=function(a,b,c){this.target.b[a]=new V(b,c?50331648:67108864)};function iq(a,b,c,d){hq.call(this,a,b,c,d)}t(iq,hq);
function jq(a,b,c,d){hq.call(this,a,b,c,d);c.b.width=new V(Hd,0);c.b.height=new V(Hd,0)}t(jq,hq);jq.prototype.dd=function(a,b,c){a=new Bp(this.f,a,b,c,this.target);nf(this.ka,new iq(this.f,this.ka,a,this.b))};jq.prototype.cd=function(a,b,c){a=new zp(this.f,a,b,c,this.target);a=new jq(this.f,this.ka,a,this.b);nf(this.ka,a)};function kq(a,b,c,d){hq.call(this,a,b,c,d)}t(kq,hq);kq.prototype.dd=function(a,b,c){a=new Bp(this.f,a,b,c,this.target);nf(this.ka,new iq(this.f,this.ka,a,this.b))};
kq.prototype.cd=function(a,b,c){a=new zp(this.f,a,b,c,this.target);a=new jq(this.f,this.ka,a,this.b);nf(this.ka,a)};function lq(a){a=a.toString();switch(a){case "inline-flex":a="flex";break;case "inline-grid":a="grid";break;case "inline-table":a="table";break;case "inline":case "table-row-group":case "table-column":case "table-column-group":case "table-header-group":case "table-footer-group":case "table-row":case "table-cell":case "table-caption":case "inline-block":a="block"}return C(a)}function yl(a,b,c,d){if(a!==F)if(b===Ic||b===Yc)c=F,a=lq(a);else if(c&&c!==F||d)a=lq(a);return{display:a,position:b,qa:c}}
function mq(a,b,c,d,e,f,g){e=e||f||cd;return!!g||!!c&&c!==F||b===Ic||b===Yc||a===fd||a===yd||a===xd||a==Zc||(a===Mc||a===kd)&&!!d&&d!==Fd||!!f&&e!==f};function nq(a,b,c){return a.replace(/[uU][rR][lL]\(\s*\"((\\([^0-9a-fA-F]+|[0-9a-fA-F]+\s*)|[^\"\r\n])+)\"/gm,function(a,e){return'url("'+c.fd(e,b)+'"'}).replace(/[uU][rR][lL]\(\s*\'((\\([^0-9a-fA-F]+|[0-9a-fA-F]+\s*)|[^\'\r\n])+)\'/gm,function(a,e){return"url('"+c.fd(e,b)+"'"}).replace(/[uU][rR][lL]\(\s*((\\([^0-9a-fA-F]+|[0-9a-fA-F]+\s*)|[^\"\'\r\n\)\s])+)/gm,function(a,e){return"url("+c.fd(e,b)})};var oq={"text-indent":"0px","margin-top":"0px","padding-top":"0px","border-top-width":"0px","border-top-style":"none","border-top-color":"transparent","border-top-left-radius":"0px","border-top-right-radius":"0px"},pq={"text-indent":"0px","margin-right":"0px","padding-right":"0px","border-right-width":"0px","border-right-style":"none","border-right-color":"transparent","border-top-right-radius":"0px","border-bottom-right-radius":"0px"},qq={"margin-top":"0px"},rq={"margin-right":"0px"},sq={};
function tq(a){a.addEventListener("load",function(){a.contentWindow.navigator.epubReadingSystem={name:"adapt",version:"0.1",layoutStyle:"paginated",hasFeature:function(a){switch(a){case "mouse-events":return!0}return!1}}},!1)}var uq=(new DOMParser).parseFromString('<root xmlns="http://www.pyroxy.com/ns/shadow"/>',"text/xml"),vq="footnote-marker first-5-lines first-4-lines first-3-lines first-2-lines first-line first-letter before  after".split(" ");
function wq(a,b){a.setAttribute("data-adapt-pseudo",b)}function xq(a,b,c,d){this.style=b;this.element=a;this.b=c;this.g=d;this.f={}}xq.prototype.l=function(a){var b=a.getAttribute("data-adapt-pseudo")||"";this.b&&b&&b.match(/after$/)&&(this.style=this.b.l(this.element,!0),this.b=null);a=this.style._pseudos[b]||{};if(b.match(/^first-/)&&!a["x-first-pseudo"]){var c=1;if("first-letter"==b)c=0;else if(b=b.match(/^first-([0-9]+)-lines$/))c=b[1]-0;a["x-first-pseudo"]=new V(new Bc(c),0)}return a};
xq.prototype.na=function(a,b){var c=a.getAttribute("data-adapt-pseudo")||"";this.f[c]||(this.f[c]=!0,(c=b.content)&&il(c)&&c.ba(new hl(a,this.g,c)))};function yq(a,b,c,d,e,f,g,h,l,k,m,p,q){this.h={};this.H=a;this.b=b;this.viewport=c;this.D=c.b;this.l=d;this.A=e;this.aa=f;this.I=g;this.C=h;this.J=l;this.page=k;this.g=m;this.G=p;this.j=q;this.O=this.w=null;this.f=!1;this.N=null;this.ja=0;this.B=null}t(yq,Ta);
yq.prototype.clone=function(){return new yq(this.H,this.b,this.viewport,this.l,this.A,this.aa,this.I,this.C,this.J,this.page,this.g,this.G,this.j)};function zq(a,b,c,d){a=a._pseudos;if(!a)return null;var e={},f;for(f in a){var g=e[f]={};zj(g,a[f],d);xj(g,d,a[f]);yj(a[f],b,c,function(a,b){zj(g,b,d);Aq(b,function(a){zj(g,a,d)})})}return e}
function Bq(a,b,c,d,e,f){var g=K("createRefShadow");a.aa.A.load(b).then(function(h){if(h){var l=Nj(h,b);if(l){var k=a.J,m=k.I[h.url];if(!m){var m=k.style.l.f[h.url],p=new Ab(0,k.Tb(),k.Sb(),k.A),m=new Dl(h,m.g,m.f,p,k.l,m.A,new bp(k.j,h.url),new ap(k.j,h.url,m.f,m.b));k.I[h.url]=m}f=new Ck(d,l,h,e,f,c,m)}}N(g,f)});return g.result()}
function Cq(a,b,c,d,e,f,g,h){var l=K("createShadows"),k=e.template,m;k instanceof Fc?m=Bq(a,k.url,2,b,h,null):m=L(null);m.then(function(k){var m=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var p=b.getAttribute("href"),z=null;p?z=h?h.aa:a.aa:h&&(p="http://www.w3.org/1999/xhtml"==h.ka.namespaceURI?h.ka.getAttribute("href"):h.ka.getAttributeNS("http://www.w3.org/1999/xlink","href"),z=h.Wc?h.Wc.aa:a.aa);p&&(p=oa(p,z.url),m=Bq(a,p,3,b,h,k))}m||(m=L(k));var u=null;
m.then(function(c){e.display===yd?u=Bq(a,oa("user-agent.xml#table-cell",na),2,b,h,c):u=L(c)});u.then(function(k){var m=zq(d,a.A,a.f,g);if(m){for(var p=[],q=uq.createElementNS("http://www.pyroxy.com/ns/shadow","root"),r=q,u=0;u<vq.length;u++){var z=vq[u],A;if(z){if(!m[z])continue;if(!("footnote-marker"!=z||c&&a.f))continue;if(z.match(/^first-/)&&(A=e.display,!A||A===ed))continue;if("before"===z||"after"===z)if(A=m[z].content,!A||A===md||A===F)continue;p.push(z);A=uq.createElementNS("http://www.w3.org/1999/xhtml",
"span");wq(A,z)}else A=uq.createElementNS("http://www.pyroxy.com/ns/shadow","content");r.appendChild(A);z.match(/^first-/)&&(r=A)}k=p.length?new Ck(b,q,null,h,k,2,new xq(b,d,f,g)):k}N(l,k)})});return l.result()}function On(a,b,c){a.O=b;a.f=c}
function Dq(a,b,c,d){var e=a.b;c=wj(c,e,a.A,a.f);b=vj(c,e,b);Aj(c,d,b,function(b,c){var d=c.evaluate(e,b);"font-family"==b&&(d=Xl(a.I,d));return d});var f=yl(d.display||ed,d.position,d["float"],a.N===a.aa.root);["display","position","float"].forEach(function(a){f[a]&&(d[a]=f[a])});return b}
function Eq(a,b){for(var c=a.w.N,d=[],e=null,f=a.w.pa,g=-1;c&&1==c.nodeType;){var h=f&&f.root==c;if(!h||2==f.type){var l=(f?f.b:a.l).l(c,!1);d.push(l);e=e||Ba(c)}h?(c=f.ka,f=f.Wc):(c=c.parentNode,g++)}c=Cb(a.b,"em",!g);c={"font-size":new V(new D(c,"px"),0)};f=new Jh(c,a.b);for(g=d.length-1;0<=g;--g){var h=d[g],l=[],k;for(k in h)mh[k]&&l.push(k);l.sort(Md);for(var m=0;m<l.length;m++){var p=l[m];f.f=p;var q=h[p];q.value!==dd&&(c[p]=q.rd(f))}}for(var r in b)mh[r]||(c[r]=b[r]);return{lang:e,ab:c}}
var Fq={a:"a",sub:"sub",sup:"sup",table:"table",tr:"tr",td:"td",th:"th",code:"code",body:"div",p:"p",v:"p",date:"p",emphasis:"em",strong:"strong",style:"span",strikethrough:"del"};function Gq(a,b){b=oa(b,a.aa.url);return a.G[b]||b}function Hq(a){a.w.lang=Ba(a.w.N)||a.w.parent&&a.w.parent.lang||a.w.lang}
function Iq(a,b){var c=oh().filter(function(a){return b[a]});if(c.length){var d=a.w.vb;if(a.w.parent){var d=a.w.vb={},e;for(e in a.w.parent.vb)d[e]=a.w.parent.vb[e]}c.forEach(function(a){var c=b[a];if(c){if(c instanceof Bc)d[a]=c.M;else if(c instanceof zc)d[a]=c.name;else if(c instanceof D)switch(c.ga){case "dpi":case "dpcm":case "dppx":d[a]=c.M*yb[c.ga]}else d[a]=c;delete b[a]}})}}
function Jq(a,b,c,d,e,f){for(var g=Qd("RESOLVE_FORMATTING_CONTEXT"),h=0;h<g.length;h++){var l=g[h](a,b,c,d,e,f);if(l){a.F=l;break}}}
function Kq(a,b,c){var d=!0,e=K("createElementView"),f=a.N,g=a.w.pa?a.w.pa.b:a.l,h=g.l(f,!1);if(!a.w.pa){var l=Ij(a.aa,f);Lq(l,a.w.Ka,0)}var k={};a.w.parent||(l=Eq(a,h),h=l.ab,a.w.lang=l.lang);var m=h["float-reference"]&&xm(h["float-reference"].value.toString());a.w.parent&&m&&ym(m)&&(l=Eq(a,h),h=l.ab,a.w.lang=l.lang);a.w.u=Dq(a,a.w.u,h,k);g.na(f,k);Iq(a,k);Hq(a);k.direction&&(a.w.ra=k.direction.toString());if((l=k["flow-into"])&&l.toString()!=a.H)return N(e,!1),e.result();var p=k.display;if(p===
F)return N(e,!1),e.result();var q=!a.w.parent;a.w.I=p===Zc;Cq(a,f,q,h,k,g,a.b,a.w.pa).then(function(l){a.w.za=l;l=k.position;var r=k["float"],u=k.clear,A=a.w.u?Ed:cd,H=a.w.parent?a.w.parent.u?Ed:cd:A,G="true"===f.getAttribute("data-vivliostyle-flow-root");a.w.Qc=mq(p,l,r,k.overflow,A,H,G);a.w.O=l===qd||l===Ic||l===Yc;Kk(a.w)&&(u!==Jc&&(u=null),r===$c||m&&ym(m)||(r=null));A=r===jd||r===rd||r===Bd||r===Qc||r===hd||r===gd||r===Oc||r===Nc||r===td||r===$c;r&&(delete k["float"],r===$c&&(a.f?(A=!1,k.display=
Mc):k.display=ed));u&&(u===dd&&a.w.parent&&a.w.parent.C&&(u=C(a.w.parent.C)),u===jd||u===rd||u===Pc||u===Jc)&&(delete k.clear,k.display&&k.display!=ed&&(a.w.C=u.toString()));var I=p===kd&&k["ua-list-item-count"];(A||k["break-inside"]&&k["break-inside"]!==Lc)&&a.w.l++;if(!(u=!A&&!p))a:switch(p.toString()){case "inline":case "inline-block":case "inline-list-item":case "inline-flex":case "inline-grid":case "ruby":case "inline-table":u=!0;break a;default:u=!1}if(!u)a:switch(p.toString()){case "ruby-base":case "ruby-text":case "ruby-base-container":case "ruby-text-container":u=
!0;break a;default:u=!1}a.w.ta=u;a.w.display=p?p.toString():"inline";a.w.ya=A?r.toString():null;a.w.H=m||Ek;a.w.W=k["column-span"];if(!a.w.ta){if(u=k["break-after"])a.w.G=u.toString();if(u=k["break-before"])a.w.g=u.toString()}a.w.T=k["vertical-align"]&&k["vertical-align"].toString()||"baseline";a.w.Z=k["caption-side"]&&k["caption-side"].toString()||"top";u=k["border-collapse"];if(!u||u===C("separate"))if(A=k["border-spacing"])A.wd()?(u=A.values[0],A=A.values[1]):u=A,u.jc()&&(a.w.ha=Hc(u,a.b)),A.jc()&&
(a.w.Qd=Hc(A,a.b));if(u=k["x-first-pseudo"])a.w.f=new Dk(a.w.parent?a.w.parent.f:null,u.M);a.w.ta||Mq(a,f,h,g,a.b);if(u=k["white-space"])u=mk(u.toString()),null!==u&&(a.w.ac=u);(u=k["hyphenate-character"])&&u!==Lc&&(a.w.h=u.Hc);u=k["overflow-wrap"]||["word-wrap"];a.w.A=k["word-break"]===Sc||u===Tc;Jq(a.w,b,p,l,r,q);a.w.parent&&a.w.parent.F&&(b=a.w.parent.F.Ie(a.w,b));a.w.ta||(a.w.j=Nq(k),Oq(a,f,g));var J=!1,Pa=null,Da=[],va=f.namespaceURI,M=f.localName;if("http://www.w3.org/1999/xhtml"==va)"html"==
M||"body"==M||"script"==M||"link"==M||"meta"==M?M="div":"vide_"==M?M="video":"audi_"==M?M="audio":"object"==M&&(J=!!a.g),f.getAttribute("data-adapt-pseudo")&&h.content&&h.content.value&&h.content.value.url&&(M="img");else if("http://www.idpf.org/2007/ops"==va)M="span",va="http://www.w3.org/1999/xhtml";else if("http://www.gribuser.ru/xml/fictionbook/2.0"==va){va="http://www.w3.org/1999/xhtml";if("image"==M){if(M="div",(l=f.getAttributeNS("http://www.w3.org/1999/xlink","href"))&&"#"==l.charAt(0)&&(l=
Nj(a.aa,l)))Pa=Pq(a,va,"img"),l="data:"+(l.getAttribute("content-type")||"image/jpeg")+";base64,"+l.textContent.replace(/[ \t\n\t]/g,""),Da.push(se(Pa,l))}else M=Fq[M];M||(M=a.w.ta?"span":"div")}else if("http://www.daisy.org/z3986/2005/ncx/"==va)if(va="http://www.w3.org/1999/xhtml","ncx"==M||"navPoint"==M)M="div";else if("navLabel"==M){if(M="span",r=f.parentNode){l=null;for(r=r.firstChild;r;r=r.nextSibling)if(1==r.nodeType&&(u=r,"http://www.daisy.org/z3986/2005/ncx/"==u.namespaceURI&&"content"==u.localName)){l=
u.getAttribute("src");break}l&&(M="a",f=f.ownerDocument.createElementNS(va,"a"),f.setAttribute("href",l))}}else M="span";else"http://www.pyroxy.com/ns/shadow"==va?(va="http://www.w3.org/1999/xhtml",M=a.w.ta?"span":"div"):J=!!a.g;I?b?M="li":(M="div",p=Mc,k.display=p):"body"==M||"li"==M?M="div":"q"==M?M="span":"a"==M&&(l=k["hyperlink-processing"])&&"normal"!=l.toString()&&(M="span");k.behavior&&"none"!=k.behavior.toString()&&a.g&&(J=!0);f.dataset&&"true"===f.getAttribute("data-math-typeset")&&(J=!0);
var Za;J?Za=a.g(f,a.w.parent?a.w.parent.B:null,k):Za=L(null);Za.then(function(g){g?J&&(d="true"==g.getAttribute("data-adapt-process-children")):g=Pq(a,va,M);"a"==M&&g.addEventListener("click",a.page.J,!1);Pa&&(ro(a,a.w,"inner",Pa),g.appendChild(Pa));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&tq(g);var h=a.w.vb["image-resolution"],l=[],m=k.width,p=k.height,q=f.getAttribute("width"),r=f.getAttribute("height"),m=m===Lc||!m&&!q,p=p===Lc||!p&&!r;if("http://www.gribuser.ru/xml/fictionbook/2.0"!=
f.namespaceURI||"td"==M){for(var q=f.attributes,u=q.length,r=null,z=0;z<u;z++){var A=q[z],H=A.namespaceURI,G=A.localName,A=A.nodeValue;if(H)if("http://www.w3.org/2000/xmlns/"==H)continue;else"http://www.w3.org/1999/xlink"==H&&"href"==G&&(A=Gq(a,A));else{if(G.match(/^on/))continue;if("style"==G)continue;if(("id"==G||"name"==G)&&b){A=a.j.oe(A,a.aa.url);g.setAttribute(G,A);jk(a.page,g,A);continue}"src"==G||"href"==G||"poster"==G?(A=Gq(a,A),"href"===G&&(A=a.j.fd(A,a.aa.url))):"srcset"==G&&(A=A.split(",").map(function(b){return Gq(a,
b.trim())}).join(","));if("poster"===G&&"video"===M&&"http://www.w3.org/1999/xhtml"===va&&m&&p){var Za=new Image,Cc=se(Za,A);Da.push(Cc);l.push({tf:Za,element:g,mf:Cc})}}"http://www.w3.org/2000/svg"==va&&/^[A-Z\-]+$/.test(G)&&(G=G.toLowerCase());-1!=Qq.indexOf(G.toLowerCase())&&(A=nq(A,a.aa.url,a.j));H&&(Za=sq[H])&&(G=Za+":"+G);"src"!=G||H||"img"!=M&&"input"!=M||"http://www.w3.org/1999/xhtml"!=va?"href"==G&&"image"==M&&"http://www.w3.org/2000/svg"==va&&"http://www.w3.org/1999/xlink"==H?a.page.j.push(se(g,
A)):H?g.setAttributeNS(H,G,A):g.setAttribute(G,A):r=A}r&&(Za="input"===M?new Image:g,q=se(Za,r),Za!==g&&(g.src=r),m||p?(m&&p&&h&&1!==h&&l.push({tf:Za,element:g,mf:q}),Da.push(q)):a.page.j.push(q))}delete k.content;(m=k["list-style-image"])&&m instanceof Fc&&(m=m.url,Da.push(se(new Image,m)));Rq(a,k);Sq(a,g,k);if(!a.w.ta&&(m=null,b?c&&(m=a.w.u?rq:qq):m="clone"!==a.w.vb["box-decoration-break"]?a.w.u?pq:oq:a.w.u?rq:qq,m))for(var Qo in m)w(g,Qo,m[Qo]);I&&g.setAttribute("value",k["ua-list-item-count"].stringValue());
a.B=g;Da.length?re(Da).then(function(){0<h&&Tq(a,l,h,k,a.w.u);N(e,d)}):ke().then(function(){N(e,d)})})});return e.result()}function Mq(a,b,c,d,e){var f=zq(c,a.A,a.f,e);f&&f["after-if-continues"]&&f["after-if-continues"].content&&(a.w.J=new Uq(b,new xq(b,c,d,e)))}var Qq="color-profile clip-path cursor filter marker marker-start marker-end marker-mid fill stroke mask".split(" ");
function Tq(a,b,c,d,e){b.forEach(function(b){if("load"===b.mf.get().get()){var f=b.tf,h=f.width/c,f=f.height/c;b=b.element;if(0<h&&0<f)if(d["box-sizing"]===Rc&&(d["border-left-style"]!==F&&(h+=Hc(d["border-left-width"],a.b)),d["border-right-style"]!==F&&(h+=Hc(d["border-right-width"],a.b)),d["border-top-style"]!==F&&(f+=Hc(d["border-top-width"],a.b)),d["border-bottom-style"]!==F&&(f+=Hc(d["border-bottom-width"],a.b))),1<c){var l=d["max-width"]||F,k=d["max-height"]||F;l===F&&k===F?w(b,"max-width",
h+"px"):l!==F&&k===F?w(b,"width",h+"px"):l===F&&k!==F?w(b,"height",f+"px"):"%"!==l.ga?w(b,"max-width",Math.min(h,Hc(l,a.b))+"px"):"%"!==k.ga?w(b,"max-height",Math.min(f,Hc(k,a.b))+"px"):e?w(b,"height",f+"px"):w(b,"width",h+"px")}else 1>c&&(l=d["min-width"]||Kd,k=d["min-height"]||Kd,l.M||k.M?l.M&&!k.M?w(b,"width",h+"px"):!l.M&&k.M?w(b,"height",f+"px"):"%"!==l.ga?w(b,"min-width",Math.max(h,Hc(l,a.b))+"px"):"%"!==k.ga?w(b,"min-height",Math.max(f,Hc(k,a.b))+"px"):e?w(b,"height",f+"px"):w(b,"width",h+
"px"):w(b,"min-width",h+"px"))}})}function Rq(a,b){Qd("PREPROCESS_ELEMENT_STYLE").forEach(function(c){c(a.w,b)})}function Oq(a,b,c){for(b=b.firstChild;b;b=b.nextSibling)if(1===b.nodeType){var d={},e=c.l(b,!1);Dq(a,a.w.u,e,d);if(Nq(d)){if(a.w.F instanceof Lo&&!Mk(a.w,a.w.F))break;c=a.w.parent;a.w.F=new Lo(c&&c.F,a.w.N);Vq(a.w.F,a.w.u);break}}}function Nq(a){var b=a["repeat-on-break"];return b!==F&&(b===Lc&&(b=a.display===Ad?bd:a.display===zd?ad:F),b&&b!==F)?b.toString():null}
function Wq(a){var b=K("createTextNodeView");Xq(a).then(function(){var c=a.ja||0,c=Yq(a.w.Ha).substr(c);a.B=document.createTextNode(c);N(b,!0)});return b.result()}function Xq(a){if(a.w.Ha)return L(!0);var b,c=b=a.N.textContent,d=K("preprocessTextContent"),e=Qd("PREPROCESS_TEXT_CONTENT"),f=0;me(function(){return f>=e.length?L(!1):e[f++](a.w,c).fa(function(a){c=a;return L(!0)})}).then(function(){a.w.Ha=Zq(b,c,0);N(d,!0)});return d.result()}
function $q(a,b,c){var d=K("createNodeView"),e=!0;1==a.N.nodeType?b=Kq(a,b,c):8==a.N.nodeType?(a.B=null,b=L(!0)):b=Wq(a);b.then(function(b){e=b;(a.w.B=a.B)&&(b=a.w.parent?a.w.parent.B:a.O)&&b.appendChild(a.B);N(d,e)});return d.result()}function Pn(a,b,c,d){(a.w=b)?(a.N=b.N,a.ja=b.ja):(a.N=null,a.ja=-1);a.B=null;return a.w?$q(a,c,!!d):L(!0)}
function ar(a){if(null==a.pa||"content"!=a.N.localName||"http://www.pyroxy.com/ns/shadow"!=a.N.namespaceURI)return a;var b=a.Ca,c=a.pa,d=a.parent,e,f;c.Te?(f=c.Te,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.Wc,e=c.ka.firstChild,c=2);var g=a.N.nextSibling;g?(a.N=g,Fk(a)):a.va?a=a.va:e?a=null:(a=a.parent.modify(),a.K=!0);if(e)return b=new Ak(e,d,b),b.pa=f,b.Za=c,b.va=a,b;a.Ca=b;return a}
function br(a){var b=a.Ca+1;if(a.K){if(!a.parent)return null;if(3!=a.Za){var c=a.N.nextSibling;if(c)return a=a.modify(),a.Ca=b,a.N=c,Fk(a),ar(a)}if(a.va)return a=a.va.modify(),a.Ca=b,a;a=a.parent.modify()}else{if(a.za&&(c=a.za.root,2==a.za.type&&(c=c.firstChild),c))return b=new Ak(c,a,b),b.pa=a.za,b.Za=a.za.type,ar(b);if(c=a.N.firstChild)return ar(new Ak(c,a,b));1!=a.N.nodeType&&(c=Yq(a.Ha),b+=c.length-1-a.ja);a=a.modify()}a.Ca=b;a.K=!0;return a}
function hm(a,b,c){b=br(b);if(!b||b.K)return L(b);var d=K("nextInTree");Pn(a,b,!0,c).then(function(a){b.B&&a||(b=b.modify(),b.K=!0,b.B||(b.ta=!0));Ua(this,{type:"nextInTree",w:b});N(d,b)}.bind(a));return d.result()}function cr(a,b){if(b instanceof sc)for(var c=b.values,d=0;d<c.length;d++)cr(a,c[d]);else b instanceof Fc&&(c=b.url,a.page.j.push(se(new Image,c)))}var dr={"box-decoration-break":!0,"flow-into":!0,"flow-linger":!0,"flow-priority":!0,"flow-options":!0,page:!0,"float-reference":!0};
function Sq(a,b,c){var d=c["background-image"];d&&cr(a,d);var d=c.position===qd,e;for(e in c)if(!dr[e]){var f=c[e],f=f.ba(new Ag(a.aa.url,a.j));f.jc()&&zb(f.ga)&&(f=new D(Hc(f,a.b),"px"));bk[e]||d&&ck[e]?a.page.A.push(new dk(b,e,f)):w(b,e,f.toString())}}function ro(a,b,c,d){if(!b.K){var e=(b.pa?b.pa.b:a.l).l(a.N,!1);if(e=e._pseudos)if(e=e[c])c={},b.u=Dq(a,b.u,e,c),b=c.content,il(b)&&(b.ba(new hl(d,a.b,b)),delete c.content),Sq(a,d,c)}}
function Sn(a,b,c){var d=K("peelOff"),e=b.f,f=b.ja,g=b.K;if(0<c)b.B.textContent=b.B.textContent.substr(0,c),f+=c;else if(!g&&b.B&&!f){var h=b.B.parentNode;h&&h.removeChild(b.B)}for(var l=b.Ca+c,k=[];b.f===e;)k.push(b),b=b.parent;var m=k.pop(),p=m.va;me(function(){for(;0<k.length;){m=k.pop();b=new Ak(m.N,b,l);k.length||(b.ja=f,b.K=g);b.Za=m.Za;b.pa=m.pa;b.za=m.za;b.va=m.va?m.va:p;p=null;var c=Pn(a,b,!1);if(c.Pa())return c}return L(!1)}).then(function(){N(d,b)});return d.result()}
function Pq(a,b,c){return"http://www.w3.org/1999/xhtml"==b?a.D.createElement(c):a.D.createElementNS(b,c)}function Xo(a){a&&Lk(a,function(a){var b=a.vb["box-decoration-break"];b&&"slice"!==b||(b=a.B,a.u?(w(b,"padding-left","0"),w(b,"border-left","none"),w(b,"border-top-left-radius","0"),w(b,"border-bottom-left-radius","0")):(w(b,"padding-bottom","0"),w(b,"border-bottom","none"),w(b,"border-bottom-left-radius","0"),w(b,"border-bottom-right-radius","0")))})}
function er(a){this.b=a.h;this.window=a.window}function fr(a,b){var c=b.left,d=b.top;return{left:a.left-c,top:a.top-d,right:a.right-c,bottom:a.bottom-d,width:a.width,height:a.height}}function Bn(a,b){var c=b.getClientRects(),d=a.b.getBoundingClientRect();return Array.from(c).map(function(a){return fr(a,d)},a)}function lk(a,b){var c=b.getBoundingClientRect(),d=a.b.getBoundingClientRect();return fr(c,d)}function go(a,b){return a.window.getComputedStyle(b,null)}
...
this.g=b;this.f=c;this.h=f;b=go(new er(this),this.root);this.width=d||parseFloat(b.width)||a.innerWidth;this.height=e||parseFloat(b.height)||a.innerHeight}gr.prototype.zoom=function(a,b,c){w(this.g,"width",a*c+"px");w(this.g,"height",b*c+"px");w(this.f,"width",a+"px");w(this.f,"height",b+"px");w(this.f,"transform","scale("+c+")")};var so="min-content inline size",pn="fit-content inline size";
function on(a,b,c){function d(c){return go(a,b).getPropertyValue(c)}function e(){w(b,"display","block");w(b,"position","static");return d(Pa)}function f(){w(b,"display","inline-block");w(G,Pa,"99999999px");var a=d(Pa);w(G,Pa,"");return a}function g(){w(b,"display","inline-block");w(G,Pa,"0");var a=d(Pa);w(G,Pa,"");return a}function h(){var a=e(),b=g(),c=parseFloat(a);if(c<=parseFloat(b))return b;b=f();return c<=parseFloat(b)?a:b}function l(){throw Error("Getting fill-available block size is not implemented");}
...
I||"tb-lr"===I,Pa=J?"height":"width",Da=J?"width":"height",va={};c.forEach(function(a){var c;switch(a){case "fill-available inline size":c=e();break;case "max-content inline size":c=f();break;case so:c=g();break;case pn:c=h();break;case "fill-available block size":c=l();break;case "max-content block size":case "min-content block size":case "fit-content block size":c=d(Da);break;case "fill-available width":c=J?l():e();break;case "fill-available height":c=J?e():l();break;case "max-content width":c=
J?d(Da):f();break;case "max-content height":c=J?f():d(Da);break;case "min-content width":c=J?d(Da):g();break;case "min-content height":c=J?g():d(Da);break;case "fit-content width":c=J?d(Da):h();break;case "fit-content height":c=J?h():d(Da)}va[a]=parseFloat(c);w(b,"position",m);w(b,"display",k)});w(b,"width",p);w(b,"max-width",q);w(b,"min-width",r);w(b,"height",z);w(b,"max-height",u);w(b,"min-height",A);H.insertBefore(b,G);H.removeChild(G);return va};function hr(a){var b=a["writing-mode"],b=b&&b.value;a=(a=a.direction)&&a.value;return b===Dd||b!==Ed&&a!==vd?"ltr":"rtl"}
var ir={a5:{width:new D(148,"mm"),height:new D(210,"mm")},a4:{width:new D(210,"mm"),height:new D(297,"mm")},a3:{width:new D(297,"mm"),height:new D(420,"mm")},b5:{width:new D(176,"mm"),height:new D(250,"mm")},b4:{width:new D(250,"mm"),height:new D(353,"mm")},"jis-b5":{width:new D(182,"mm"),height:new D(257,"mm")},"jis-b4":{width:new D(257,"mm"),height:new D(364,"mm")},letter:{width:new D(8.5,"in"),height:new D(11,"in")},legal:{width:new D(8.5,"in"),height:new D(14,"in")},ledger:{width:new D(11,"in"),
height:new D(17,"in")}},jr=new D(.24,"pt"),kr=new D(3,"mm"),lr=new D(10,"mm"),mr=new D(13,"mm");
function nr(a){var b={width:Id,height:Jd,ec:Kd,Jb:Kd},c=a.size;if(c&&c.value!==Lc){var d=c.value;d.wd()?(c=d.values[0],d=d.values[1]):(c=d,d=null);if(c.jc())b.width=c,b.height=d||c;else if(c=ir[c.name.toLowerCase()])d&&d===id?(b.width=c.height,b.height=c.width):(b.width=c.width,b.height=c.height)}(c=a.marks)&&c.value!==F&&(b.Jb=mr);a=a.bleed;a&&a.value!==Lc?a.value&&a.value.jc()&&(b.ec=a.value):c&&(a=!1,c.value.wd()?a=c.value.values.some(function(a){return a===Uc}):a=c.value===Uc,a&&(b.ec=new D(6,
"pt")));return b}function or(a,b){var c={},d=a.ec.M*Cb(b,a.ec.ga,!1),e=a.Jb.M*Cb(b,a.Jb.ga,!1),f=d+e,g=a.width;c.Tb=g===Id?b.X.fc?b.X.fc.width*Cb(b,"px",!1):(b.X.rb?Math.floor(b.Sa/2)-b.X.Ec:b.Sa)-2*f:g.M*Cb(b,g.ga,!1);g=a.height;c.Sb=g===Jd?b.X.fc?b.X.fc.height*Cb(b,"px",!1):b.Db-2*f:g.M*Cb(b,g.ga,!1);c.ec=d;c.Jb=e;c.Ud=f;return c}function pr(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
function qr(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg",c||"polyline");a.setAttribute("stroke","black");a.setAttribute("stroke-width",b);a.setAttribute("fill","none");return a}var rr={Eg:"top left",Fg:"top right",rg:"bottom left",sg:"bottom right"};
function sr(a,b,c,d,e,f){var g=d;g<=e+2*yb.mm&&(g=e+d/2);var h=Math.max(d,g),l=e+h+c/2,k=pr(a,l,l),g=[[0,e+d],[d,e+d],[d,e+d-g]];d=g.map(function(a){return[a[1],a[0]]});if("top right"===b||"bottom right"===b)g=g.map(function(a){return[e+h-a[0],a[1]]}),d=d.map(function(a){return[e+h-a[0],a[1]]});if("bottom left"===b||"bottom right"===b)g=g.map(function(a){return[a[0],e+h-a[1]]}),d=d.map(function(a){return[a[0],e+h-a[1]]});l=qr(a,c);l.setAttribute("points",g.map(function(a){return a.join(",")}).join(" "));
k.appendChild(l);a=qr(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));k.appendChild(a);b.split(" ").forEach(function(a){k.style[a]=f+"px"});return k}var tr={Dg:"top",qg:"bottom",Mf:"left",Nf:"right"};
function ur(a,b,c,d,e){var f=2*d,g;"top"===b||"bottom"===b?(g=f,f=d):g=d;var h=pr(a,g,f),l=qr(a,c);l.setAttribute("points","0,"+f/2+" "+g+","+f/2);h.appendChild(l);l=qr(a,c);l.setAttribute("points",g/2+",0 "+g/2+","+f);h.appendChild(l);a=qr(a,c,"circle");a.setAttribute("cx",g/2);a.setAttribute("cy",f/2);a.setAttribute("r",d/4);h.appendChild(a);var k;switch(b){case "top":k="bottom";break;case "bottom":k="top";break;case "left":k="right";break;case "right":k="left"}Object.keys(tr).forEach(function(a){a=
tr[a];a===b?h.style[a]=e+"px":a!==k&&(h.style[a]="0",h.style["margin-"+a]="auto")});return h}function vr(a,b,c,d){var e=!1,f=!1;if(a=a.marks)a=a.value,a.wd()?a.values.forEach(function(a){a===Uc?e=!0:a===Vc&&(f=!0)}):a===Uc?e=!0:a===Vc&&(f=!0);if(e||f){var g=c.L,h=g.ownerDocument,l=b.ec,k=Hc(jr,d),m=Hc(kr,d),p=Hc(lr,d);e&&Object.keys(rr).forEach(function(a){a=sr(h,rr[a],k,p,l,m);g.appendChild(a)});f&&Object.keys(tr).forEach(function(a){a=ur(h,tr[a],k,p,m);g.appendChild(a)})}}
var wr=function(){var a={width:!0,height:!0,"block-size":!0,"inline-size":!0,margin:!0,padding:!0,border:!0,outline:!0,"outline-width":!0,"outline-style":!0,"outline-color":!0};"left right top bottom before after start end block-start block-end inline-start inline-end".split(" ").forEach(function(b){a["margin-"+b]=!0;a["padding-"+b]=!0;a["border-"+b+"-width"]=!0;a["border-"+b+"-style"]=!0;a["border-"+b+"-color"]=!0});return a}(),xr={"top-left-corner":{order:1,Oa:!0,La:!1,Ma:!0,Na:!0,ua:null},"top-left":{order:2,
...
"bottom-center":{order:11,Oa:!1,La:!0,Ma:!1,Na:!1,ua:"center"},"bottom-left":{order:12,Oa:!1,La:!0,Ma:!1,Na:!1,ua:"start"},"bottom-left-corner":{order:13,Oa:!1,La:!0,Ma:!0,Na:!1,ua:null},"left-bottom":{order:14,Oa:!1,La:!1,Ma:!0,Na:!1,ua:"end"},"left-middle":{order:15,Oa:!1,La:!1,Ma:!0,Na:!1,ua:"center"},"left-top":{order:16,Oa:!1,La:!1,Ma:!0,Na:!1,ua:"start"}},yr=Object.keys(xr).sort(function(a,b){return xr[a].order-xr[b].order});
function zr(a,b,c){xp.call(this,a,null,"vivliostyle-page-rule-master",[],b,null,0);a=nr(c);new Ar(this.f,this,c,a);this.D={};Br(this,c);this.b.position=new V(qd,0);this.b.width=new V(a.width,0);this.b.height=new V(a.height,0);for(var d in c)wr[d]||"background-clip"===d||(this.b[d]=c[d])}t(zr,xp);function Br(a,b){var c=b._marginBoxes;c&&yr.forEach(function(d){c[d]&&(a.D[d]=new Cr(a.f,a,d,b))})}zr.prototype.h=function(a){return new Dr(a,this)};
function Ar(a,b,c,d){Bp.call(this,a,null,null,[],b);this.G=d;this.b["z-index"]=new V(new Bc(0),0);this.b["flow-from"]=new V(C("body"),0);this.b.position=new V(Ic,0);this.b.overflow=new V(Fd,0);for(var e in wr)wr.hasOwnProperty(e)&&(this.b[e]=c[e])}t(Ar,Bp);Ar.prototype.h=function(a){return new Er(a,this)};
function Cr(a,b,c,d){Bp.call(this,a,null,null,[],b);this.C=c;a=d._marginBoxes[this.C];for(var e in d)if(b=d[e],c=a[e],mh[e]||c&&c.value===dd)this.b[e]=b;for(e in a)Object.prototype.hasOwnProperty.call(a,e)&&(b=a[e])&&b.value!==dd&&(this.b[e]=b)}t(Cr,Bp);Cr.prototype.h=function(a){return new Fr(a,this)};function Dr(a,b){yp.call(this,a,b);this.l=null;this.na={}}t(Dr,yp);
Dr.prototype.j=function(a,b){var c=this.J,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}yp.prototype.j.call(this,a,b)};Dr.prototype.ae=function(){var a=this.style;a.left=Kd;a["margin-left"]=Kd;a["border-left-width"]=Kd;a["padding-left"]=Kd;a["padding-right"]=Kd;a["border-right-width"]=Kd;a["margin-right"]=Kd;a.right=Kd};
Dr.prototype.be=function(){var a=this.style;a.top=Kd;a["margin-top"]=Kd;a["border-top-width"]=Kd;a["padding-top"]=Kd;a["padding-bottom"]=Kd;a["border-bottom-width"]=Kd;a["margin-bottom"]=Kd;a.bottom=Kd};Dr.prototype.Z=function(a,b,c){b=b.I;var d={start:this.l.marginLeft,end:this.l.marginRight,oa:this.l.yc},e={start:this.l.marginTop,end:this.l.marginBottom,oa:this.l.xc};Gr(this,b.top,!0,d,a,c);Gr(this,b.bottom,!0,d,a,c);Gr(this,b.left,!1,e,a,c);Gr(this,b.right,!1,e,a,c)};
function Hr(a,b,c,d,e){this.L=a;this.D=e;this.j=c;this.C=!Y(d,b[c?"width":"height"],new ec(d,0,"px"));this.l=null}Hr.prototype.b=function(){return this.C};function Ir(a){a.l||(a.l=on(a.D,a.L.element,a.j?["max-content width","min-content width"]:["max-content height","min-content height"]));return a.l}Hr.prototype.g=function(){var a=Ir(this);return this.j?Xk(this.L)+a["max-content width"]+Yk(this.L):Vk(this.L)+a["max-content height"]+Wk(this.L)};
Hr.prototype.h=function(){var a=Ir(this);return this.j?Xk(this.L)+a["min-content width"]+Yk(this.L):Vk(this.L)+a["min-content height"]+Wk(this.L)};Hr.prototype.f=function(){return this.j?Xk(this.L)+this.L.width+Yk(this.L):Vk(this.L)+this.L.height+Wk(this.L)};function Jr(a){this.j=a}Jr.prototype.b=function(){return this.j.some(function(a){return a.b()})};Jr.prototype.g=function(){var a=this.j.map(function(a){return a.g()});return Math.max.apply(null,a)*a.length};
Jr.prototype.h=function(){var a=this.j.map(function(a){return a.h()});return Math.max.apply(null,a)*a.length};Jr.prototype.f=function(){var a=this.j.map(function(a){return a.f()});return Math.max.apply(null,a)*a.length};function Kr(a,b,c,d,e,f){Hr.call(this,a,b,c,d,e);this.A=f}t(Kr,Hr);Kr.prototype.b=function(){return!1};Kr.prototype.g=function(){return this.f()};Kr.prototype.h=function(){return this.f()};Kr.prototype.f=function(){return this.j?Xk(this.L)+this.A+Yk(this.L):Vk(this.L)+this.A+Wk(this.L)};
function Gr(a,b,c,d,e,f){var g=a.b.f,h={},l={},k={},m;for(m in b){var p=xr[m];if(p){var q=b[m],r=a.na[m],z=new Hr(q,r.style,c,g,f);h[p.ua]=q;l[p.ua]=r;k[p.ua]=z}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.oa.evaluate(e);var u=Lr(k,b),A=!1,H={};Object.keys(h).forEach(function(a){var b=Y(g,l[a].style[c?"max-width":"max-height"],d.oa);b&&(b=b.evaluate(e),u[a]>b&&(b=k[a]=new Kr(h[a],l[a].style,c,g,f,b),H[a]=b.f(),A=!0))});A&&(u=Lr(k,b),A=!1,["start","center","end"].forEach(function(a){u[a]=H[a]||u[a]}));
var G={};Object.keys(h).forEach(function(a){var b=Y(g,l[a].style[c?"min-width":"min-height"],d.oa);b&&(b=b.evaluate(e),u[a]<b&&(b=k[a]=new Kr(h[a],l[a].style,c,g,f,b),G[a]=b.f(),A=!0))});A&&(u=Lr(k,b),["start","center","end"].forEach(function(a){u[a]=G[a]||u[a]}));var I=a+b,J=a+(a+b);["start","center","end"].forEach(function(a){var b=u[a];if(b){var d=h[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(J-b)/2;break;case "end":e=I-b}c?bl(d,e,b-Xk(d)-Yk(d)):al(d,e,b-Vk(d)-Wk(d))}})}
function Lr(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=Mr(d,g.length?new Jr(g):null,b);g.mb&&(f.center=g.mb);d=g.mb||d.f();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=Mr(c,e,b),c.mb&&(f.start=c.mb),c.jd&&(f.end=c.jd);return f}
function Mr(a,b,c){var d={mb:null,jd:null};if(a&&b)if(a.b()&&b.b()){var e=a.g(),f=b.g();0<e&&0<f?(f=e+f,f<c?d.mb=c*e/f:(a=a.h(),b=b.h(),b=a+b,b<c?d.mb=a+(c-b)*(e-a)/(f-b):0<b&&(d.mb=c*a/b)),0<d.mb&&(d.jd=c-d.mb)):0<e?d.mb=c:0<f&&(d.jd=c)}else a.b()?d.mb=Math.max(c-b.f(),0):b.b()&&(d.jd=Math.max(c-a.f(),0));else a?a.b()&&(d.mb=c):b&&b.b()&&(d.jd=c);return d}Dr.prototype.Ub=function(a,b,c,d,e){Dr.Lf.Ub.call(this,a,b,c,d,e);b.element.setAttribute("data-vivliostyle-page-box",!0)};
function Er(a,b){Cp.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.xc=this.yc=null}t(Er,Cp);
Er.prototype.j=function(a,b){var c=this.J,d;for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(d.match(/^column.*$/)||d.match(/^background-/))&&(c[d]=b[d]);Cp.prototype.j.call(this,a,b);d=this.f;c={yc:this.yc,xc:this.xc,marginTop:this.marginTop,marginRight:this.marginRight,marginBottom:this.marginBottom,marginLeft:this.marginLeft};d.l=c;d=d.style;d.width=new E(c.yc);d.height=new E(c.xc);d["padding-left"]=new E(c.marginLeft);d["padding-right"]=new E(c.marginRight);d["padding-top"]=new E(c.marginTop);
d["padding-bottom"]=new E(c.marginBottom)};Er.prototype.ae=function(){var a=Nr(this,{start:"left",end:"right",oa:"width"});this.yc=a.cf;this.marginLeft=a.Df;this.marginRight=a.Cf};Er.prototype.be=function(){var a=Nr(this,{start:"top",end:"bottom",oa:"height"});this.xc=a.cf;this.marginTop=a.Df;this.marginBottom=a.Cf};
function Nr(a,b){var c=a.style,d=a.b.f,e=b.start,f=b.end,g=b.oa,h=a.b.G[g].sa(d,null),l=Y(d,c[g],h),k=Y(d,c["margin-"+e],h),m=Y(d,c["margin-"+f],h),p=Dp(d,c["padding-"+e],h),q=Dp(d,c["padding-"+f],h),r=Fp(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),z=Fp(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),u=y(d,h,x(d,x(d,r,p),x(d,z,q)));l?(u=y(d,u,l),k||m?k?m=y(d,u,k):k=y(d,u,m):m=k=mc(d,u,new tb(d,.5))):(k||(k=d.b),m||(m=d.b),l=y(d,u,x(d,k,m)));c[e]=new E(k);c[f]=new E(m);c["margin-"+e]=
Kd;c["margin-"+f]=Kd;c["padding-"+e]=new E(p);c["padding-"+f]=new E(q);c["border-"+e+"-width"]=new E(r);c["border-"+f+"-width"]=new E(z);c[g]=new E(l);c["max-"+g]=new E(l);return{cf:y(d,h,x(d,k,m)),Df:k,Cf:m}}Er.prototype.Ub=function(a,b,c,d,e){Cp.prototype.Ub.call(this,a,b,c,d,e);c.O=b.element};function Fr(a,b){Cp.call(this,a,b);var c=b.C;this.l=xr[c];a.na[c]=this;this.ra=!0}t(Fr,Cp);n=Fr.prototype;
n.Ub=function(a,b,c,d,e){var f=b.element;w(f,"display","flex");var g=Pp(this,a,"vertical-align"),h=null;g===C("middle")?h="center":g===C("top")?h="flex-start":g===C("bottom")&&(h="flex-end");h&&(w(f,"flex-flow",this.u?"row":"column"),w(f,"justify-content",h));Cp.prototype.Ub.call(this,a,b,c,d,e)};
n.ua=function(a,b){var c=this.style,d=this.b.f,e=a.start,f=a.end,g="left"===e,h=g?b.yc:b.xc,l=Y(d,c[a.oa],h),g=g?b.marginLeft:b.marginTop;if("start"===this.l.ua)c[e]=new E(g);else if(l){var k=Dp(d,c["margin-"+e],h),m=Dp(d,c["margin-"+f],h),p=Dp(d,c["padding-"+e],h),q=Dp(d,c["padding-"+f],h),r=Fp(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),f=Fp(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),l=x(d,l,x(d,x(d,p,q),x(d,x(d,r,f),x(d,k,m))));switch(this.l.ua){case "center":c[e]=new E(x(d,
g,nc(d,y(d,h,l),new tb(d,2))));break;case "end":c[e]=new E(y(d,x(d,g,h),l))}}};
function Or(a,b,c){function d(a){if(u)return u;u={oa:z?z.evaluate(a):null,eb:l?l.evaluate(a):null,fb:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[q,m,p,r].forEach(function(b){b&&(c+=b.evaluate(a))});(null===u.eb||null===u.fb)&&c+u.oa+u.eb+u.fb>b&&(null===u.eb&&(u.eb=0),null===u.fb&&(u.Kg=0));null!==u.oa&&null!==u.eb&&null!==u.fb&&(u.fb=null);null===u.oa&&null!==u.eb&&null!==u.fb?u.oa=b-c-u.eb-u.fb:null!==u.oa&&null===u.eb&&null!==u.fb?u.eb=b-c-u.oa-u.fb:null!==u.oa&&null!==u.eb&&null===u.fb?u.fb=
b-c-u.oa-u.eb:null===u.oa?(u.eb=u.fb=0,u.oa=b-c):u.eb=u.fb=(b-c-u.oa)/2;return u}var e=a.style;a=a.b.f;var f=b.ce,g=b.he;b=b.oa;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],l=Ep(a,e["margin-"+f],h),k=Ep(a,e["margin-"+g],h),m=Dp(a,e["padding-"+f],h),p=Dp(a,e["padding-"+g],h),q=Fp(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),r=Fp(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),z=Y(a,e[b],h),u=null;e[b]=new E(new vb(a,function(){var a=d(this).oa;return null===a?0:a},b));e["margin-"+
f]=new E(new vb(a,function(){var a=d(this).eb;return null===a?0:a},"margin-"+f));e["margin-"+g]=new E(new vb(a,function(){var a=d(this).fb;return null===a?0:a},"margin-"+g));"left"===f?e.left=new E(x(a,c.marginLeft,c.yc)):"top"===f&&(e.top=new E(x(a,c.marginTop,c.xc)))}n.ae=function(){var a=this.f.l;this.l.Ma?Or(this,{ce:"right",he:"left",oa:"width"},a):this.l.Na?Or(this,{ce:"left",he:"right",oa:"width"},a):this.ua({start:"left",end:"right",oa:"width"},a)};
n.be=function(){var a=this.f.l;this.l.Oa?Or(this,{ce:"bottom",he:"top",oa:"height"},a):this.l.La?Or(this,{ce:"top",he:"bottom",oa:"height"},a):this.ua({start:"top",end:"bottom",oa:"height"},a)};n.sd=function(a,b,c,d,e,f,g){Cp.prototype.sd.call(this,a,b,c,d,e,f,g);a=c.I;c=this.b.C;d=this.l;d.Ma||d.Na?d.Oa||d.La||(d.Ma?a.left[c]=b:d.Na&&(a.right[c]=b)):d.Oa?a.top[c]=b:d.La&&(a.bottom[c]=b)};
function Pr(a,b,c,d,e){this.b=a;this.l=b;this.h=c;this.f=d;this.g=e;this.j={};a=this.l;b=new fc(a,"page-number");b=new Yb(a,new dc(a,b,new tb(a,2)),a.b);c=new Ob(a,b);a.values["recto-page"]=c;a.values["verso-page"]=b;"ltr"===hr(this.g)?(a.values["left-page"]=b,b=new Ob(a,b),a.values["right-page"]=b):(c=new Ob(a,b),a.values["left-page"]=c,a.values["right-page"]=b)}function Qr(a){var b={};bj(a.b,[],"",b);a.b.pop();return b}
function Rr(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof V?e.value+"":Rr(a,e);c.push(d+f+(e.Ua||""))}return c.sort().join("^")}function Sr(a,b,c){c=c.clone({Wb:"vivliostyle-page-rule-master"});var d=c.b,e=b.size;if(e){var f=nr(b),e=e.Ua;d.width=Ah(a.f,d.width,new V(f.width,e));d.height=Ah(a.f,d.height,new V(f.height,e))}["counter-reset","counter-increment"].forEach(function(a){d[a]&&(b[a]=d[a])});c=c.h(a.h);c.j(a.b,a.g);eq(c,a.f);return c}
function Tr(a){this.b=null;this.h=a}t(Tr,W);Tr.prototype.apply=function(a){a.Z===this.h&&this.b.apply(a)};Tr.prototype.f=function(){return 3};Tr.prototype.g=function(a){this.b&&Rh(a.Vc,this.h,this.b);return!0};function Ur(a){this.b=null;this.h=a}t(Ur,W);Ur.prototype.apply=function(a){1===(new fc(this.h,"page-number")).evaluate(a.l)&&this.b.apply(a)};Ur.prototype.f=function(){return 2};function Vr(a){this.b=null;this.h=a}t(Vr,W);
Vr.prototype.apply=function(a){(new fc(this.h,"left-page")).evaluate(a.l)&&this.b.apply(a)};Vr.prototype.f=function(){return 1};function Wr(a){this.b=null;this.h=a}t(Wr,W);Wr.prototype.apply=function(a){(new fc(this.h,"right-page")).evaluate(a.l)&&this.b.apply(a)};Wr.prototype.f=function(){return 1};function Xr(a){this.b=null;this.h=a}t(Xr,W);Xr.prototype.apply=function(a){(new fc(this.h,"recto-page")).evaluate(a.l)&&this.b.apply(a)};Xr.prototype.f=function(){return 1};
function Yr(a){this.b=null;this.h=a}t(Yr,W);Yr.prototype.apply=function(a){(new fc(this.h,"verso-page")).evaluate(a.l)&&this.b.apply(a)};Yr.prototype.f=function(){return 1};function Zr(a,b){Oh.call(this,a,b,null,null,null)}t(Zr,Oh);Zr.prototype.apply=function(a){var b=a.l,c=a.G,d=this.style;a=this.Y;Hh(b,c,d,a,null,null,null);if(d=d._marginBoxes){var c=Eh(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);Hh(b,f,d[e],a,null,null,null)}}};
function $r(a,b,c,d,e){mj.call(this,a,b,null,c,null,d,!1);this.T=e;this.I=[];this.g="";this.G=[]}t($r,mj);n=$r.prototype;n.Fc=function(){this.yb()};n.Gb=function(a,b){if(this.g=b)this.b.push(new Tr(b)),this.Y+=65536};
n.Xc=function(a,b){b&&rf(this,"E_INVALID_PAGE_SELECTOR :"+a+"("+b.join("")+")");this.G.push(":"+a);switch(a.toLowerCase()){case "first":this.b.push(new Ur(this.f));this.Y+=256;break;case "left":this.b.push(new Vr(this.f));this.Y+=1;break;case "right":this.b.push(new Wr(this.f));this.Y+=1;break;case "recto":this.b.push(new Xr(this.f));this.Y+=1;break;case "verso":this.b.push(new Yr(this.f));this.Y+=1;break;default:rf(this,"E_INVALID_PAGE_SELECTOR :"+a)}};
function as(a){var b;a.g||a.G.length?b=[a.g].concat(a.G.sort()):b=null;a.I.push({Pe:b,Y:a.Y});a.g="";a.G=[]}n.Dc=function(){as(this);mj.prototype.Dc.call(this)};n.Aa=function(){as(this);mj.prototype.Aa.call(this)};
...
n.wf=function(a){Rh(this.l.Vc,"*",a)};n.Bf=function(a){return new Zr(this.ab,a)};n.ne=function(a){var b=Eh(this.ab,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);nf(this.ka,new bs(this.f,this.ka,this.C,c))};function bs(a,b,c,d){of.call(this,a,b,!1);this.g=c;this.b=d}t(bs,pf);bs.prototype.wb=function(a,b,c){kh(this.g,a,b,c,this)};bs.prototype.Sc=function(a,b){qf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};bs.prototype.Kd=function(a,b){qf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
bs.prototype.xb=function(a,b,c){Dh(this.b,a,new V(b,c?kf(this):lf(this)))};var cs=new pe(function(){var a=K("uaStylesheetBase");lh.get().then(function(b){var c=oa("user-agent-base.css",na);b=new mj(null,null,null,null,null,b,!0);b.Gc("UA");lj=b.l;Rf(c,b,null,null).Ba(a)});return a.result()},"uaStylesheetBaseFetcher");
function ds(a,b,c,d,e,f,g,h,l,k){this.l=a;this.f=b;this.b=c;this.g=d;this.I=e;this.j=f;this.D=a.T;this.G=g;this.h=h;this.C=l;this.H=k;this.A=a.l;xb(this.b,function(a){var b=this.b,c;c=(c=b.b[a])?(c=c.b[0])?c.b:null:null;var d;d=b.b[a];if(d=es(this,d?d.g:"any"))d=(a=b.b[a])?0<a.b.length&&a.b[0].b.f<=this.D:!1;return d&&!!c&&!fs(this,c)});wb(this.b,new vb(this.b,function(){return this.Z+this.b.page},"page-number"))}
...
function hs(a,b,c,d,e,f,g,h,l,k,m){Ab.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.aa=b;this.lang=b.lang||c;this.viewport=d;this.l={body:!0};this.g=e;this.C=this.b=this.I=this.f=this.G=null;this.D=0;this.Bb=f;this.h=new Wl(this.style.D);this.Ia={};this.W=null;this.j=m;this.Cb=new Hm(null,null,null,null,null,null,null);this.T={};this.ra=null;this.sb=g;this.Ab=h;this.Z=l;this.tb=k;for(var p in a.h)(b=a.h[p]["flow-consume"])&&(b.evaluate(this,"flow-consume")==Jc?this.l[p]=!0:delete this.l[p]);
this.Ra={};this.la=this.ha=0}t(hs,Ab);
function is(a){var b=K("StyleInstance.init"),c=new bp(a.j,a.aa.url),d=new ap(a.j,a.aa.url,a.style.f,a.style.b);a.f=new Dl(a.aa,a.style.g,a.style.f,a,a.l,a.style.A,c,d);d.h=a.f;Nl(a.f,a);a.I={};a.I[a.aa.url]=a.f;var e=Kl(a.f);a.ra=hr(e);a.G=new fq(a.style.I);c=new Wi(a.style.g,a,c,d);a.G.j(c,e);eq(a.G,a);a.W=new Pr(c,a.style.b,a.G,a,e);e=[];for(c=0;c<a.style.j.length;c++)if(d=a.style.j[c],!d.ea||d.ea.evaluate(a))d=Tl(d.mc,a),d=new Ul(d),e.push(d);bm(a.Bb,e,a.h).Ba(b);var f=a.style.H;Object.keys(f).forEach(function(a){var b=
or(nr(f[a]),this);this.Ra[a]={width:b.Tb+2*b.Ud,height:b.Sb+2*b.Ud}},a);return b.result()}function Ol(a,b,c){if(a=a.b)a.f[b.b]||(a.f[b.b]=c),c=a.b[b.b],c||(c=new Qk,a.b[b.b]=c),c.b.push(new Pk(new Nk({ma:[{node:b.element,Za:xk,pa:null,za:null,va:null,Ka:0}],ja:0,K:!1,Ha:null}),b))}function js(a,b){for(var c=Number.POSITIVE_INFINITY,d=0;d<b.b.length;d++){for(var e=b.b[d].f.f,f=e.ma[0].node,g=e.ja,h=e.K,l=0;f.ownerDocument!=a.aa.b;)l++,f=e.ma[l].node,h=!1,g=0;e=Jj(a.aa,f,g,h);e<c&&(c=e)}return c}
function ks(a,b,c){if(!b)return 0;var d=Number.POSITIVE_INFINITY,e;for(e in a.l){var f=b.b[e];if(!(c||f&&f.b.length)&&a.b){f=a.f;f.O=e;for(var g=0;null!=f.O&&(g+=5E3,Ll(f,g,0)!=Number.POSITIVE_INFINITY););f=a.b.b[e];b!=a.b&&f&&(f=f.clone(),b.b[e]=f)}f&&(f=js(a,f),f<d&&(d=f))}return d}function es(a,b){switch(b){case "left":case "right":case "recto":case "verso":return(new fc(a.style.b,b+"-page")).evaluate(a);default:return!0}}
function ls(a,b){var c=a.b,d=ks(a,c);if(d==Number.POSITIVE_INFINITY)return null;for(var e=a.G.A,f,g=0;g<e.length;g++)if(f=e[g],"vivliostyle-page-rule-master"!==f.b.Wb){var h=1,l=Pp(f,a,"utilization");l&&l.Ke()&&(h=l.M);var l=Cb(a,"em",!1),k=a.Tb()*a.Sb();a.D=Ll(a.f,d,Math.ceil(h*k/(l*l)));h=a;l=c;k=void 0;for(k in l.b){var m=l.b[k];if(m&&0<m.b.length){var p=m.b[0].b;if(js(h,m)===p.f){a:switch(p=m.g,p){case "left":case "right":case "recto":case "verso":break a;default:p=null}m.g=dm(ul(p,m.b[0].b.g))}}}a.C=
c.clone();h=a;l=h.b.page;k=void 0;for(k in h.b.b)for(m=h.b.b[k],p=m.b.length-1;0<=p;p--){var q=m.b[p];0>q.b.kb&&q.b.f<h.D&&(q.b.kb=l)}Bb(a,a.style.b);h=Pp(f,a,"enabled");if(!h||h===Gd){c=a;v.debug("Location - page",c.b.page);v.debug("  current:",d);v.debug("  lookup:",c.D);d=void 0;for(d in c.b.b)for(e=c.b.b[d],g=0;g<e.b.length;g++)v.debug("  Chunk",d+":",e.b[g].b.f);d=a.W;e=f;f=b;c=e.b;Object.keys(f).length?(e=c,g=Rr(d,f),e=e.l+"^"+g,g=d.j[e],g||("background-host"===c.Wb?(c=d,f=(new zr(c.l,c.h.b,
f)).h(c.h),f.j(c.b,c.g),eq(f,c.f),g=f):g=Sr(d,f,c),d.j[e]=g),f=g.b,f.f.g=f,f=g):(c.f.g=c,f=e);return f}}throw Error("No enabled page masters");}function fs(a,b){var c=a.C.f,d=c[b.b].f;if(d){var e=b.f,f=c[d].b;if(!f.length||e<f[0])return!1;var c=La(f.length,function(a){return f[a]>e})-1,c=f[c],d=a.C.b[d],g=js(a,d);return c<g?!1:g<c?!0:!es(a,d.g)}return!1}function ms(a,b,c){a=a.b.f[c];a.F||(a.F=new Mn(null));b.xe=a.F}
function ns(a){var b=a.g,c=Wm(b),d=K("layoutDeferredPageFloats"),e=!1,f=0;ne(function(d){if(f===c.length)P(d);else{var g=c[f++],l=g.qa,k=wn(l),m=k.Ve(l,b);m&&Dm(m,l)?O(d):Pm(b,l)||Ym(b,l)?(Xm(b,g),P(d)):oo(a,g,k,null,m).then(function(a){a?(a=en(b.parent))?P(d):(en(b)&&!a&&(e=!0,b.Tc=!1),O(d)):P(d)})}}).then(function(){e&&Rm(b);N(d,!0)});return d.result()}
function os(a,b,c){var d=a.b.b[c];if(!d||!es(a,d.g))return L(!0);d.g="any";ms(a,b,c);mo(b);a.l[c]&&0<b.ra.length&&(b.Ae=!1);var e=K("layoutColumn");ns(b).then(function(){if(en(b.g))N(e,!0);else{var c=[],g=[],h=!0;ne(function(e){for(;0<d.b.length-g.length;){for(var f=0;0<=g.indexOf(f);)f++;var l=d.b[f];if(l.b.f>a.D||fs(a,l.b))break;for(var p=f+1;p<d.b.length;p++)if(!(0<=g.indexOf(p))){var q=d.b[p];if(q.b.f>a.D||fs(a,q.b))break;qk(q.b,l.b)&&(l=q,f=p)}var r=l.b,z=!0;nm(b,l.f,h,d.f).then(function(a){if(en(b.g))P(e);
else if(h=!1,!l.b.fg||a&&!r.h||c.push(f),r.h)g.push(f),P(e);else{var k=!!a||!!b.b,m;0<Zm(b.g).length&&b.Ra?a?(m=a.clone(),m.f=b.Ra):m=new Nk(b.Ra):m=null;if(b.b&&m)l.f=m,d.f=b.b,b.b=null;else{g.push(f);if(a||m)l.f=a||m,c.push(f);b.b&&(d.g=dm(b.b))}k?P(e):z?z=!1:O(e)}});if(z){z=!1;return}}P(e)}).then(function(){if(!en(b.g)){d.b=d.b.filter(function(a,b){return 0<=c.indexOf(b)||0>g.indexOf(b)});"column"===d.f&&(d.f=null);var a=sn(b.g);jo(b,a)}N(e,!0)})}});return e.result()}
...
J);0<=J.width?os(a,J,h).then(function(){en(H)||bn(H);en(J.g)&&!en(l)?(J.g.Tc=!1,a.b=G.clone(),J.element!==A&&A.removeChild(J.element),O(b)):P(b)}):(bn(H),P(b))}).then(function(){N(I,J)});return I.result()}function qs(a,b,c,d,e){var f=Pp(c,a,"writing-mode")||null;a=Pp(c,a,"direction")||null;return new Hm(b,"region",d,e,null,f,a)}
function rs(a,b,c,d,e,f,g,h){Ip(c);var l=Pp(c,a,"enabled");if(l&&l!==Gd)return L(!0);var k=K("layoutContainer"),m=Pp(c,a,"wrap-flow")===Lc,l=Pp(c,a,"flow-from"),p=a.viewport.b.createElement("div"),q=Pp(c,a,"position");w(p,"position",q?q.name:"absolute");d.insertBefore(p,d.firstChild);var r=new Uk(p);r.u=c.u;r.Ac=g;c.Ub(a,r,b,a.h,a.g);r.gb=e;r.hb=f;e+=r.left+r.marginLeft+r.borderLeft;f+=r.top+r.marginTop+r.borderTop;(c instanceof Er||c instanceof yp&&!(c instanceof Dr))&&Lm(h,r);var z=a.b.clone(),
u=!1;if(l&&l.xf())if(a.T[l.toString()])en(h)||c.sd(a,r,b,null,1,a.g,a.h),l=L(!0);else{var A=K("layoutContainer.inner"),H=l.toString(),G=qs(a,h,c,r,H),I=Z(c,a,"column-count"),J=Z(c,a,"column-gap"),Pa=1<I?Z(c,a,"column-width"):r.width,l=Op(c,a),Da=0,q=Pp(c,a,"shape-inside"),va=xg(q,0,0,r.width,r.height,a),M=new yq(H,a,a.viewport,a.f,l,a.aa,a.h,a.style.G,a,b,a.sb,a.Ab,a.tb),Za=new $o(a.j,a.b.page-1),Cc=0,Dc=null;ne(function(b){ps(a,c,e,f,g,r,Cc++,H,G,I,J,Pa,va,M,Za).then(function(c){en(h)?P(b):((c.b&&
"column"!==c.b||Cc===I)&&!en(G)&&bn(G),en(G)?(Cc=0,a.b=z.clone(),G.Tc=!1,O(b)):(Dc=c,Dc.b&&"column"!=Dc.b&&(Cc=I,"region"!=Dc.b&&(a.T[H]=!0)),Da=Math.max(Da,Dc.xa),Cc<I?O(b):P(b)))})}).then(function(){if(!en(h)){Dc.element===p&&(r=Dc);r.xa=Da;c.sd(a,r,b,Dc,I,a.g,a.h);var d=a.b.b[H];d&&"region"===d.f&&(d.f=null)}N(A,!0)});l=A.result()}else{if((l=Pp(c,a,"content"))&&il(l)){q="span";l.url&&(q="img");var yk=a.viewport.b.createElement(q);l.ba(new hl(yk,a,l));p.appendChild(yk);"img"==q&&dq(c,a,yk,a.h);
cq(c,a,r,a.h)}else c.ra&&(d.removeChild(p),u=!0);u||c.sd(a,r,b,null,1,a.g,a.h);l=L(!0)}l.then(function(){if(en(h))N(k,!0);else{if(!c.g||0<Math.floor(r.xa)){if(!u&&!m){var l=Pp(c,a,"shape-outside"),l=r.Xd(l,a);g.push(l)}}else if(!c.A.length){d.removeChild(p);N(k,!0);return}var q=c.A.length-1;me(function(){for(;0<=q;){var d=c.A[q--],d=rs(a,b,d,p,e,f,g,h);if(d.Pa())return d.fa(function(){return L(!en(h))});if(en(h))break}return L(!1)}).then(function(){N(k,!0)})}});return k.result()}
function ss(a){var b=a.b.page,c;for(c in a.b.b)for(var d=a.b.b[c],e=d.b.length-1;0<=e;e--){var f=d.b[e];0<=f.b.kb&&f.b.kb+f.b.l-1<=b&&d.b.splice(e,1)}}function ts(a,b){for(var c in a.l){var d=b.b[c];if(d&&0<d.b.length)return!1}return!0}
function us(a,b,c){a.T={};c?(a.b=c.clone(),Gl(a.f,c.g)):(a.b=new Sk,Gl(a.f,-1));a.lang&&b.g.setAttribute("lang",a.lang);c=a.b;c.page++;Bb(a,a.style.b);a.C=c.clone();var d=Qr(a.W),e=ls(a,d);if(!e)return L(null);hk(b,e.b.b.width.value===Id);ik(b,e.b.b.height.value===Jd);a.j.j=b;lp(a.j,d,a);var f=or(nr(d),a);vs(a,f,b);vr(d,f,b,a);var g=f.Jb+f.ec,d=Pp(e,a,"writing-mode")||cd,f=Pp(e,a,"direction")||ld,h=new Hm(a.Cb,"page",null,null,null,d,f),l=K("layoutNextPage");ne(function(c){rs(a,b,e,b.g,g,g,[],h).then(function(){en(h)||
bn(h);en(h)?(a.b=a.C.clone(),h.Tc=!1,O(c)):P(c)})}).then(function(){e.Z(a,b,a.g);var d=new fc(e.b.f,"left-page");b.l=d.evaluate(a)?"left":"right";ss(a);c=a.b;Object.keys(c.b).forEach(function(b){b=c.b[b];var d=b.f;!d||"page"!==d&&es(a,d)||(b.f=null)});a.b=a.C=null;c.g=a.f.b;kk(b,a.style.l.O[a.aa.url],a.g);ts(a,c)&&(c=null);N(l,c)});return l.result()}
function vs(a,b,c){a.O=b.Tb;a.J=b.Sb;a.la=b.Tb+2*b.Ud;a.ha=b.Sb+2*b.Ud;c.L.style.width=a.la+"px";c.L.style.height=a.ha+"px";c.g.style.left=b.Jb+"px";c.g.style.right=b.Jb+"px";c.g.style.top=b.Jb+"px";c.g.style.bottom=b.Jb+"px";c.g.style.padding=b.ec+"px"}function ws(a,b,c,d){mj.call(this,a.j,a,b,c,d,a.h,!c);this.g=a;this.G=!1}t(ws,mj);n=ws.prototype;n.Hd=function(){};n.Gd=function(a,b,c){a=new xp(this.g.A,a,b,c,this.g.H,this.ea,lf(this.ka));nf(this.g,new kq(a.f,this.g,a,this.C))};
n.qc=function(a){a=a.b;this.ea&&(a=lc(this.f,this.ea,a));nf(this.g,new ws(this.g,a,this,this.H))};n.Dd=function(){nf(this.g,new sj(this.f,this.ka))};n.Fd=function(){var a={};this.g.C.push({mc:a,ea:this.ea});nf(this.g,new tj(this.f,this.ka,null,a,this.g.h))};n.Ed=function(a){var b=this.g.l[a];b||(b={},this.g.l[a]=b);nf(this.g,new tj(this.f,this.ka,null,b,this.g.h))};n.Jd=function(){var a={};this.g.I.push(a);nf(this.g,new tj(this.f,this.ka,this.ea,a,this.g.h))};
n.ad=function(a){var b=this.g.D;if(a){var c=Eh(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}nf(this.g,new tj(this.f,this.ka,null,b,this.g.h))};n.Id=function(){this.G=!0;this.yb()};n.Fc=function(){var a=new $r(this.g.A,this.g,this,this.C,this.g.G);nf(this.g,a);a.Fc()};n.Aa=function(){mj.prototype.Aa.call(this);if(this.G){this.G=!1;var a="R"+this.g.O++,b=C(a),c;this.ea?c=new zh(b,0,this.ea):c=new V(b,0);Gh(this.ab,"region-id").push(c);this.Nb();a=new ws(this.g,this.ea,this,a);nf(this.g,a);a.Aa()}};
function xs(a){var b=a.getAttribute("content");if(!b)return"";a={};for(var c;c=b.match(/^,?\s*([-A-Za-z_.][-A-Za-z_0-9.]*)\s*=\s*([-+A-Za-z_0-9.]*)\s*/);)b=b.substr(c[0].length),a[c[1]]=c[2];b=a.width-0;a=a.height-0;return b&&a?"@-epubx-viewport{width:"+b+"px;height:"+a+"px;}":""}function ys(a){mf.call(this);this.h=a;this.j=new sb(null);this.A=new sb(this.j);this.H=new up(this.j);this.J=new ws(this,null,null,null);this.O=0;this.C=[];this.D={};this.l={};this.I=[];this.G={};this.b=this.J}t(ys,mf);
ys.prototype.error=function(a){v.b("CSS parser:",a)};function zs(a,b){return As(b,a)}function Bs(a){ef.call(this,zs,"document");this.T=a;this.I={};this.A={};this.f={};this.O={};this.l=null;this.b=[];this.J=!1}t(Bs,ef);function Cs(a,b,c){Ds(a,b,c);var d=oa("user-agent.xml",na),e=K("OPSDocStore.init");lh.get().then(function(b){a.l=b;cs.get().then(function(){a.load(d).then(function(){a.J=!0;N(e,!0)})})});return e.result()}function Ds(a,b,c){a.b.splice(0);b&&b.forEach(a.W,a);c&&c.forEach(a.Z,a)}
Bs.prototype.W=function(a){var b=a.url;b&&(b=oa(b,ma));this.b.push({url:b,text:a.text,cb:"Author",Da:null,media:null})};Bs.prototype.Z=function(a){var b=a.url;b&&(b=oa(b,ma));this.b.push({url:b,text:a.text,cb:"User",Da:null,media:null})};
function As(a,b){var c=K("OPSDocStore.load"),d=b.url;Rj(b,a).then(function(b){if(b){if(a.J)for(var e=Qd("PREPROCESS_SINGLE_DOCUMENT"),g=0;g<e.length;g++)e[g](b.b);for(var e=[],h=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),g=0;g<h.length;g++){var l=h[g],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=l.getAttribute("action"),l=l.getAttribute("ref");k&&m&&p&&l&&e.push({cg:k,event:m,action:p,
...
text:null,Da:h,media:k,cb:"Author"})}else"meta"==k&&"viewport"==e.getAttribute("name")&&q.push({url:d,text:xs(e),cb:"Author",Da:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==h?"stylesheet"==k&&"text/css"==e.getAttribute("type")&&q.push({url:d,text:e.textContent,cb:"Author",Da:null,media:null}):"http://example.com/sse"==h&&"property"===k&&(h=e.getElementsByTagName("name")[0])&&"stylesheet"===h.textContent&&(e=e.getElementsByTagName("value")[0])&&(e=oa(e.textContent,d),q.push({url:e,
text:null,Da:null,media:null,cb:"Author"}));for(g=0;g<a.b.length;g++)q.push(a.b[g]);for(var r="",g=0;g<q.length;g++)r+=q[g].url,r+="^",q[g].text&&(r+=q[g].text),r+="^";var z=a.I[r];z?(a.f[d]=z,N(c,b)):(g=a.A[r],g||(g=new pe(function(){var b=K("fetchStylesheet"),c=0,d=new ys(a.l);me(function(){if(c<q.length){var a=q[c++];d.Gc(a.cb);return null!==a.text?Sf(a.text,d,a.url,a.Da,a.media).sc(!0):Rf(a.url,d,a.Da,a.media)}return L(!1)}).then(function(){z=new ds(a,d.j,d.A,d.J.l,d.H,d.C,d.D,d.l,d.I,d.G);a.I[r]=
z;delete a.A[r];N(b,z)});return b.result()},"FetchStylesheet "+d),a.A[r]=g,g.start()),g.get().then(function(e){a.f[d]=e;N(c,b)}))}else N(c,null)});return c.result()};function Es(a){return String.fromCharCode(a>>>24&255,a>>>16&255,a>>>8&255,a&255)}
function Fs(a){var b=new Ca;b.append(a);var c=55-a.length&63;for(b.append("\u0080");0<c;)c--,b.append("\x00");b.append("\x00\x00\x00\x00");b.append(Es(8*a.length));a=b.toString();for(var b=[1732584193,4023233417,2562383102,271733878,3285377520],c=[],d,e=0;e<a.length;e+=64){for(d=0;16>d;d++){var f=a.substr(e+4*d,4);c[d]=(f.charCodeAt(0)&255)<<24|(f.charCodeAt(1)&255)<<16|(f.charCodeAt(2)&255)<<8|f.charCodeAt(3)&255}for(;80>d;d++)f=c[d-3]^c[d-8]^c[d-14]^c[d-16],c[d]=f<<1|f>>>31;var f=b[0],g=b[1],h=
b[2],l=b[3],k=b[4],m;for(d=0;80>d;d++)m=20>d?(g&h|~g&l)+1518500249:40>d?(g^h^l)+1859775393:60>d?(g&h|g&l|h&l)+2400959708:(g^h^l)+3395469782,m+=(f<<5|f>>>27)+k+c[d],k=l,l=h,h=g<<30|g>>>2,g=f,f=m;b[0]=b[0]+f|0;b[1]=b[1]+g|0;b[2]=b[2]+h|0;b[3]=b[3]+l|0;b[4]=b[4]+k|0}return b}function Gs(a){a=Fs(a);for(var b=[],c=0;c<a.length;c++){var d=a[c];b.push(d>>>24&255,d>>>16&255,d>>>8&255,d&255)}return b}
function Hs(a){a=Fs(a);for(var b=new Ca,c=0;c<a.length;c++)b.append(Es(a[c]));a=b.toString();b=new Ca;for(c=0;c<a.length;c++)b.append((a.charCodeAt(c)|256).toString(16).substr(1));return b.toString()};function Is(a,b,c,d,e,f,g,h,l,k){this.b=a;this.url=b;this.lang=c;this.f=d;this.l=e;this.X=kb(f);this.A=g;this.j=h;this.h=l;this.g=k;this.Xa=this.page=null}function Js(a,b,c){if(c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=Aa(d,"height","auto")&&(w(d,"height","auto"),Js(a,d,c));"absolute"==Aa(d,"position","static")&&(w(d,"position","relative"),Js(a,d,c))}}
function Ks(a){var b=a.target,c="\u25b8"==b.textContent;b.textContent=c?"\u25be":"\u25b8";for(b=b.parentNode.firstChild;b;)if(1!=b.nodeType)b=b.nextSibling;else{var d=b;"toc-container"==d.getAttribute("data-adapt-class")?b=d.firstChild:("toc-node"==d.getAttribute("data-adapt-class")&&(d.style.height=c?"auto":"0px"),b=b.nextSibling)}a.stopPropagation()}
Is.prototype.de=function(a){var b=this.A.de(a);return function(a,d,e){var c=e.behavior;if(!c||"toc-node"!=c.toString()&&"toc-container"!=c.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",w(e,"cursor","pointer"),e.addEventListener("click",Ks,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==c.toString()?(e=d.ownerDocument.createElement("div"),
...
Is.prototype.Cd=function(a,b,c,d,e){if(this.page)return L(this.page);var f=this,g=K("showTOC"),h=new gk(a,a);this.page=h;this.b.load(this.url).then(function(d){var k=f.b.f[d.url],l=gs(k,c,1E5,e);b=new gr(b.window,l.fontSize,b.root,l.width,l.height);var p=new hs(k,d,f.lang,b,f.f,f.l,f.de(d),f.j,0,f.h,f.g);f.Xa=p;p.X=f.X;is(p).then(function(){us(p,h,null).then(function(){Js(f,a,2);N(g,h)})})});return g.result()};
Is.prototype.vd=function(){if(this.page){var a=this.page;this.Xa=this.page=null;w(a.L,"visibility","none");var b=a.L.parentNode;b&&b.removeChild(a.L)}};Is.prototype.Le=function(){return!!this.page};function Ls(){Bs.call(this,Ms(this));this.g=new ef(Rj,"document");this.G=new ef(gf,"text");this.H={};this.la={};this.C={};this.D={}}t(Ls,Bs);function Ms(a){return function(b){return a.C[b]}}
function Ns(a,b,c){var d=K("loadEPUBDoc");"/"!==b.substring(b.length-1)&&(b+="/");c&&a.G.fetch(b+"?r=list");a.g.fetch(b+"META-INF/encryption.xml");var e=b+"META-INF/container.xml";a.g.load(e,!0,"Failed to fetch EPUB container.xml from "+e).then(function(f){if(f){f=ak(Gj(Gj(Gj(new Hj([f.b]),"container"),"rootfiles"),"rootfile"),"full-path");for(var g=0;g<f.length;g++){var h=f[g];if(h){Os(a,b,h,c).Ba(d);return}}N(d,null)}else v.error("Received an empty response for EPUB container.xml "+e+". This may be caused by the server not allowing cross origin requests.")});
return d.result()}function Os(a,b,c,d){var e=b+c,f=a.H[e];if(f)return L(f);var g=K("loadOPF");a.g.load(e,void 0,void 0).then(function(c){c?a.g.load(b+"META-INF/encryption.xml",void 0,void 0).then(function(h){(d?a.G.load(b+"?r=list"):L(null)).then(function(d){f=new Ps(a,b);Qs(f,c,h,d,b+"?r=manifest").then(function(){a.H[e]=f;a.la[b]=f;N(g,f)})})}):v.error("Received an empty response for EPUB OPF "+e+". This may be caused by the server not allowing cross origin requests.")});return g.result()}
function Rs(a,b,c){var d=K("EPUBDocStore.load");b=la(b);(a.D[b]=As(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,Bd:null})).Ba(d);return d.result()}
Ls.prototype.load=function(a){var b=la(a);if(a=this.D[b])return a.Pa()?a:L(a.get());var c=K("EPUBDocStore.load");a=Ls.Lf.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?N(c,a):v.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return c.result()};function Ss(){this.id=null;this.src="";this.h=this.f=null;this.R=-1;this.l=0;this.A=null;this.b=this.g=0;this.nc=this.kb=null;this.j=Oa}
function Ts(a){return a.id}function Us(a){var b=Gs(a);return function(a){var c=K("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));df(e).then(function(a){a=new DataView(a);for(var d=0;d<a.byteLength;d++){var e=a.getUint8(d),e=e^b[d%20];a.setUint8(d,e)}N(c,cf([a,f]))});return c.result()}}
var Vs={dcterms:"http://purl.org/dc/terms/",marc:"http://id.loc.gov/vocabulary/",media:"http://www.idpf.org/epub/vocab/overlays/#",onix:"http://www.editeur.org/ONIX/book/codelists/current.html#",xsd:"http://www.w3.org/2001/XMLSchema#"},Ws=Vs.dcterms+"language",Xs=Vs.dcterms+"title";
function Ys(a,b){var c={};return function(d,e){var f,g,h=d.r||c,l=e.r||c;if(a==Xs&&(f="main"==h["http://idpf.org/epub/vocab/package/#title-type"],g="main"==l["http://idpf.org/epub/vocab/package/#title-type"],f!=g))return f?-1:1;f=parseInt(h["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(f)&&(f=Number.MAX_VALUE);g=parseInt(l["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(g)&&(g=Number.MAX_VALUE);return f!=g?f-g:a!=Ws&&b&&(f=(h[Ws]||h["http://idpf.org/epub/vocab/package/#alternate-script"])==
b,g=(l[Ws]||l["http://idpf.org/epub/vocab/package/#alternate-script"])==b,f!=g)?f?-1:1:d.o-e.o}}
function Zs(a,b){function c(a){for(var b in a){var d=a[b];d.sort(Ys(b,k));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return Sa(a,function(a){return Ra(a,function(a){var b={v:a.value,o:a.order};a.Lg&&(b.s=a.scheme);if(a.id||a.lang){var c=l[a.id];if(c||a.lang)a.lang&&(a={name:Ws,value:a.lang,lang:null,id:null,le:a.id,scheme:null,order:a.order},c?c.push(a):c=[a]),c=Qa(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=
a[1]?f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in Vs)f[g]=Vs[g];for(;g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/);)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=Vs;var h=1;g=Yj(Zj(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),order:h++,le:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:Vs.dcterms+a.localName,order:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),le:null,scheme:null};return null});var l=Qa(g,function(a){return a.le});g=d(Qa(g,function(a){return a.le?null:a.name}));var k=null;g[Ws]&&(k=g[Ws][0].v);c(g);return g}function $s(){var a=window.MathJax;return a?a.Hub:null}var at={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function Ps(a,b){this.h=a;this.l=this.f=this.b=this.j=this.g=null;this.D=b;this.C=null;this.T={};this.lang=null;this.G=0;this.J={};this.W=this.O=this.Z=null;this.H={};this.I=null;this.A=bt(this);$s()&&(ph["http://www.w3.org/1998/Math/MathML"]=!0)}
function bt(a){function b(){}b.prototype.oe=function(a,b){return"viv-id-"+qa(b+(a?"#"+a:""),":")};b.prototype.fd=function(b,d){var c=b.match(/^([^#]*)#?(.*)$/);if(c){var f=c[1]||d,c=c[2];if(f&&a.j.some(function(a){return a.src===f}))return"#"+this.oe(c,f)}return b};b.prototype.gg=function(a){"#"===a.charAt(0)&&(a=a.substring(1));a.indexOf("viv-id-")||(a=a.substring(7));return(a=Ja(a).match(/^([^#]*)#?(.*)$/))?[a[1],a[2]]:[]};return new b}
function ct(a,b){return a.D?b.substr(0,a.D.length)==a.D?decodeURI(b.substr(a.D.length)):null:b}
function Qs(a,b,c,d,e){a.g=b;var f=Gj(new Hj([b.b]),"package"),g=ak(f,"unique-identifier")[0];g&&(g=Nj(b,b.url+"#"+g))&&(a.C=g.textContent.replace(/[ \n\r\t]/g,""));var h={};a.j=Ra(Gj(Gj(f,"manifest"),"item").b,function(c){var d=new Ss,e=b.url;d.id=c.getAttribute("id");d.src=oa(c.getAttribute("href"),e);d.f=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.j=f}(c=c.getAttribute("fallback"))&&!at[d.f]&&(h[d.src]=c);!a.O&&d.j.nav&&
(a.O=d);!a.W&&d.j["cover-image"]&&(a.W=d);return d});a.f=Na(a.j,Ts);a.l=Na(a.j,function(b){return ct(a,b.src)});for(var l in h)for(g=l;;){g=a.f[h[g]];if(!g)break;if(at[g.f]){a.H[l]=g.src;break}g=g.src}a.b=Ra(Gj(Gj(f,"spine"),"itemref").b,function(b,c){var d=b.getAttribute("idref");if(d=a.f[d])d.h=b,d.R=c;return d});if(l=ak(Gj(f,"spine"),"toc")[0])a.Z=a.f[l];if(l=ak(Gj(f,"spine"),"page-progression-direction")[0]){a:switch(l){case "ltr":l="ltr";break a;case "rtl":l="rtl";break a;default:throw Error("unknown PageProgression: "+
l);}a.I=l}var g=c?ak(Gj(Gj(Wj(Gj(Gj(new Hj([c.b]),"encryption"),"EncryptedData"),Vj()),"CipherData"),"CipherReference"),"URI"):[],k=Gj(Gj(f,"bindings"),"mediaType").b;for(c=0;c<k.length;c++){var m=k[c].getAttribute("handler");(l=k[c].getAttribute("media-type"))&&m&&a.f[m]&&(a.T[l]=a.f[m].src)}a.J=Zs(Gj(f,"metadata"),ak(f,"prefix")[0]);a.J[Ws]&&(a.lang=a.J[Ws][0].v);if(!d){if(0<g.length&&a.C)for(d=Us(a.C),c=0;c<g.length;c++)a.h.C[a.D+g[c]]=d;return L(!0)}f=new Ca;k={};if(0<g.length&&a.C)for(l="1040:"+
Hs(a.C),c=0;c<g.length;c++)k[g[c]]=l;for(c=0;c<d.length;c++){var p=d[c];if(m=p.n){var q=decodeURI(m),g=a.l[q];l=null;g&&(g.A=0!=p.m,g.l=p.c,g.f&&(l=g.f.replace(/\s+/g,"")));g=k[q];if(l||g)f.append(m),f.append(" "),f.append(l||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}dt(a);return bf(e,"","POST",f.toString(),"text/plain")}function dt(a){for(var b=0,c=0;c<a.b.length;c++){var d=a.b[c],e=Math.ceil(d.l/1024);d.g=b;d.b=e;b+=e}a.G=b}
function et(a,b,c){a.f={};a.l={};a.j=[];a.b=a.j;var d=a.g=new Fj(null,"",(new DOMParser).parseFromString("<spine></spine>","text/xml"));b.forEach(function(a){var b=new Ss;b.R=a.index;b.id="item"+(a.index+1);b.src=a.url;b.kb=a.kb;b.nc=a.nc;var c=d.b.createElement("itemref");c.setAttribute("idref",b.id);d.root.appendChild(c);b.h=c;this.f[b.id]=b;this.l[a.url]=b;this.j.push(b)},a);return c?Rs(a.h,b[0].url,c):L(null)}
function ft(a,b,c){var d=a.b[b],e=K("getCFI");a.h.load(d.src).then(function(a){var b=Lj(a,c),f=null;b&&(a=Jj(a,b,0,!1),f=new fb,ib(f,b,c-a),d.h&&ib(f,d.h,0),f=f.toString());N(e,f)});return e.result()}
function gt(a,b){return Wd("resolveFragment",function(c){if(b){var d=new fb;gb(d,b);var e;if(a.g){var f=hb(d,a.g.b);if(1!=f.node.nodeType||f.K||!f.Zc){N(c,null);return}var g=f.node,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.f[h]){N(c,null);return}e=a.f[h];d=f.Zc}else e=a.b[0];a.h.load(e.src).then(function(a){var b=hb(d,a.b);a=Jj(a,b.node,b.offset,b.K);N(c,{R:e.R,Ga:a,$:-1})})}else N(c,null)},function(a,d){v.b(d,"Cannot resolve fragment:",b);N(a,null)})}
function ht(a,b){return Wd("resolveEPage",function(c){if(0>=b)N(c,{R:0,Ga:0,$:-1});else{var d=La(a.b.length,function(c){c=a.b[c];return c.g+c.b>b}),e=a.b[d];a.h.load(e.src).then(function(a){b-=e.g;b>e.b&&(b=e.b);var f=0;0<b&&(a=Kj(a),f=Math.round(a*b/e.b),f==a&&f--);N(c,{R:d,Ga:f,$:-1})})}},function(a,d){v.b(d,"Cannot resolve epage:",b);N(a,null)})}
function it(a,b){var c=a.b[b.R];if(0>=b.Ga)return L(c.g);var d=K("getEPage");a.h.load(c.src).then(function(a){a=Kj(a);N(d,c.g+Math.min(a,b.Ga)*c.b/a)});return d.result()}function jt(a,b){return{page:a,position:{R:a.R,$:b,Ga:a.offset}}}function kt(a,b,c,d,e){this.b=a;this.viewport=b;this.j=c;this.A=e;this.oc=[];this.l=[];this.X=kb(d);this.h=new er(b);this.f=new jp(a.A)}function lt(a,b){var c=a.oc[b.R];return c?c.pb[b.$]:null}n=kt.prototype;
n.Pb=function(a){return this.b.I?this.b.I:(a=this.oc[a?a.R:0])?a.Xa.ra:null};
function mt(a,b,c,d){c.L.style.display="none";c.L.style.visibility="visible";c.L.style.position="";c.L.style.top="";c.L.style.left="";c.L.setAttribute("data-vivliostyle-page-side",c.l);var e=b.pb[d];c.H=!b.item.R&&!d;b.pb[d]=c;e?(b.Xa.viewport.f.replaceChild(c.L,e.L),Ua(e,{type:"replaced",target:null,currentTarget:null,Ef:c})):b.Xa.viewport.f.appendChild(c.L);a.A({width:b.Xa.la,height:b.Xa.ha},b.Xa.Ra,b.item.R,b.Xa.Z+d)}
function nt(a,b,c){var d=K("renderSinglePage"),e=ot(a,b,c);us(b.Xa,e,c).then(function(f){var g=(c=f)?c.page-1:b.Ya.length-1;mt(a,b,e,g);np(a.f,e.R,g);f=null;if(c){var h=b.Ya[c.page];b.Ya[c.page]=c;h&&b.pb[c.page]&&(Tk(c,h)||(f=nt(a,b,c)))}f||(f=L(!0));f.then(function(){var b=op(a.f,e),f=0;ne(function(c){f++;if(f>b.length)P(c);else{var d=b[f-1];d.Ad=d.Ad.filter(function(a){return!a.$c});d.Ad.length?pt(a,d.R).then(function(b){b?(mp(a.f,d.ie),pp(a.f,d.Ad),nt(a,b,b.Ya[d.$]).then(function(b){var d=a.f;
d.b=d.G.pop();d=a.f;d.g=d.I.pop();d=b.Uc.position;d.R===e.R&&d.$===g&&(e=b.Uc.page);O(c)})):O(c)}):O(c)}}).then(function(){N(d,{Uc:jt(e,g),Gf:c})})})});return d.result()}function qt(a,b){var c=a.$,d=-1;0>c&&(d=a.Ga,c=La(b.Ya.length,function(a){return ks(b.Xa,b.Ya[a],!0)>d}),c=c===b.Ya.length?b.complete?b.Ya.length-1:Number.POSITIVE_INFINITY:c-1);return{R:a.R,$:c,Ga:d}}
function rt(a,b,c){var d=K("findPage");pt(a,b.R).then(function(e){if(e){var f=null,g;ne(function(d){var h=qt(b,e);g=h.$;(f=e.pb[g])?P(d):e.complete?(g=e.Ya.length-1,f=e.pb[g],P(d)):c?st(a,h).then(function(a){a&&(f=a.page);P(d)}):le(100).then(function(){O(d)})}).then(function(){N(d,jt(f,g))})}else N(d,null)});return d.result()}
function st(a,b){var c=K("renderPage");pt(a,b.R).then(function(d){if(d){var e=qt(b,d),f=e.$,g=e.Ga,h=d.pb[f];h?N(c,jt(h,f)):ne(function(b){if(f<d.Ya.length)P(b);else if(d.complete)f=d.Ya.length-1,P(b);else{var c=d.Ya[d.Ya.length-1];nt(a,d,c).then(function(e){var k=e.Uc.page;(c=e.Gf)?0<=g&&ks(d.Xa,c)>g?(h=k,f=d.Ya.length-2,P(b)):O(b):(h=k,f=e.Uc.position.$,d.complete=!0,k.C=d.item.R===a.b.b.length-1,P(b))})}}).then(function(){h=h||d.pb[f];var b=d.Ya[f];h?N(c,jt(h,f)):nt(a,d,b).then(function(b){b.Gf||
(d.complete=!0,b.Uc.page.C=d.item.R===a.b.b.length-1);N(c,b.Uc)})})}else N(c,null)});return c.result()}n.me=function(){return tt(this,{R:this.b.b.length-1,$:Number.POSITIVE_INFINITY,Ga:-1})};function tt(a,b){var c=K("renderAllPages");b||(b={R:0,$:0,Ga:0});var d=b.R,e=b.$,f=0,g;ne(function(c){st(a,{R:f,$:f===d?e:Number.POSITIVE_INFINITY,Ga:f===d?b.Ga:-1}).then(function(a){g=a;++f>d?P(c):O(c)})}).then(function(){N(c,g)});return c.result()}n.Sf=function(){return rt(this,{R:0,$:0,Ga:-1})};
n.Wf=function(){return rt(this,{R:this.b.b.length-1,$:Number.POSITIVE_INFINITY,Ga:-1})};n.nextPage=function(a,b){var c=this,d=a.R,e=a.$,f=K("nextPage");pt(c,d).then(function(a){if(a){if(a.complete&&e==a.Ya.length-1){if(d>=c.b.b.length-1){N(f,null);return}d++;e=0}else e++;rt(c,{R:d,$:e,Ga:-1},b).Ba(f)}else N(f,null)});return f.result()};n.ke=function(a){var b=a.R;if(a=a.$)a--;else{if(!b)return L(null);b--;a=Number.POSITIVE_INFINITY}return rt(this,{R:b,$:a,Ga:-1})};
function ut(a,b,c){b="left"===b.l;a="ltr"===a.Pb(c);return!b&&a||b&&!a}function vt(a,b,c){var d=K("getCurrentSpread"),e=lt(a,b);if(!e)return L({left:null,right:null});var f="left"===e.l;(ut(a,e,b)?a.ke(b):a.nextPage(b,c)).then(function(a){a=a&&a.page;f?N(d,{left:e,right:a}):N(d,{left:a,right:e})});return d.result()}
n.bg=function(a,b){var c=lt(this,a);if(!c)return L(null);var c=ut(this,c,a),d=this.nextPage(a,!!b);if(c)return d;var e=this;return d.fa(function(a){return a?e.nextPage(a.position,!!b):L(null)})};n.eg=function(a){var b=lt(this,a);if(!b)return L(null);b=ut(this,b,a);a=this.ke(a);if(b){var c=this;return a.fa(function(a){return a?c.ke(a.position):L(null)})}return a};function wt(a,b){var c=K("navigateToEPage");ht(a.b,b).then(function(b){b?rt(a,b).Ba(c):N(c,null)});return c.result()}
function xt(a,b){var c=K("navigateToCFI");gt(a.b,b).then(function(b){b?rt(a,b).Ba(c):N(c,null)});return c.result()}
function yt(a,b,c){v.debug("Navigate to",b);var d=ct(a.b,la(b));if(!d){if(a.b.g&&b.match(/^#epubcfi\(/))d=ct(a.b,a.b.g.url);else if("#"===b.charAt(0)){var e=a.b.A.gg(b);a.b.g?d=ct(a.b,e[0]):d=e[0];b=d+(e[1]?"#"+e[1]:"")}if(null==d)return L(null)}var f=a.b.l[d];if(!f)return a.b.g&&d==ct(a.b,a.b.g.url)&&(d=b.indexOf("#"),0<=d)?xt(a,b.substr(d+1)):L(null);var g=K("navigateTo");pt(a,f.R).then(function(d){var e=Nj(d.aa,b);e?rt(a,{R:f.R,$:-1,Ga:Ij(d.aa,e)}).Ba(g):c.R!==f.R?rt(a,{R:f.R,$:0,Ga:-1}).Ba(g):
N(g,null)});return g.result()}
function ot(a,b,c){var d=b.Xa.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.style.position="absolute";e.style.top="0";e.style.left="0";Bj||(e.style.visibility="hidden");d.h.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);var g=new gk(e,f);g.R=b.item.R;g.position=c;g.offset=ks(b.Xa,c);g.offset||(b=a.b.A.oe("",b.item.src),f.setAttribute("id",b),jk(g,f,b));d!==a.viewport&&(a=Tf(null,new Ze(nb(a.viewport.width,
a.viewport.height,d.width,d.height),null)),g.A.push(new dk(e,"transform",a)));return g}function zt(a,b){var c=$s();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=K("makeMathJaxView"),f=fe(c);d.Push(function(){f.ib(e)});return c.result()}return L(null)}
n.de=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=oa(f,a.url),g=c.getAttribute("media-type");if(!g){var h=ct(b.b,f);h&&(h=b.b.l[h])&&(g=h.f)}if(g&&(h=b.b.T[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Ha(f),l=Ha(g),g=new Ca;g.append(h);g.append("?src=");g.append(f);g.append("&type=");g.append(l);for(h=c.firstChild;h;h=h.nextSibling)1==h.nodeType&&
...
c.namespaceURI)e=zt(c,d);else if("http://example.com/sse"==c.namespaceURI){e=d?d.ownerDocument:b.viewport.b;g=c.localName;switch(g){case "t":case "tab":case "ec":case "nt":case "fraction":case "comment":case "mark":g="span";break;case "ruby":case "rp":case "rt":break;default:g="div"}e=e.createElement(g);e.setAttribute("data-adapt-process-children","true");e=L(e)}else e=c.dataset&&"true"==c.dataset.mathTypeset?zt(c,d):L(null);return e}};
function pt(a,b){if(b>=a.b.b.length)return L(null);var c=a.oc[b];if(c)return L(c);var d=K("getPageViewItem"),e=a.l[b];if(e){var f=fe(d);e.push(f);return d.result()}var e=a.l[b]=[],g=a.b.b[b],h=a.b.h;h.load(g.src).then(function(f){g.b||1!=a.b.b.length||(g.b=Math.ceil(Kj(f)/2700),a.b.G=g.b);var k=h.f[f.url],l=a.de(f),p=a.viewport,q=gs(k,p.width,p.height,p.fontSize);if(q.width!=p.width||q.height!=p.height||q.fontSize!=p.fontSize)p=new gr(p.window,q.fontSize,p.root,q.width,q.height);q=a.oc[b-1];null!==
g.kb?q=g.kb-1:(q=q?q.Xa.Z+q.pb.length:0,null!==g.nc&&(q+=g.nc));kp(a.f,q);var r=new hs(k,f,a.b.lang,p,a.h,a.j,l,a.b.H,q,a.b.A,a.f);r.X=a.X;is(r).then(function(){c={item:g,aa:f,Xa:r,Ya:[null],pb:[],complete:!1};a.oc[b]=c;N(d,c);e.forEach(function(a){a.ib(c)})})});return d.result()}function At(a){return a.oc.some(function(a){return a&&0<a.pb.length})}
n.Cd=function(){var a=this.b,b=a.O||a.Z;if(!b)return L(null);var c=K("showTOC");this.g||(this.g=new Is(a.h,b.src,a.lang,this.h,this.j,this.X,this,a.H,a.A,this.f));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background=
"#EEE";e.style.border="1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.g.Cd(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";N(c,a)});return c.result()};n.vd=function(){this.g&&this.g.vd()};n.Le=function(){return this.g&&this.g.Le()};var Bt={zg:"singlePage",Ag:"spread",pg:"autoSpread"};
...
this.Z=function(){e.Qa=!0;e.J()};this.je=this.je.bind(this);this.H=function(){};this.I=a.getElementById("vivliostyle-page-rules");this.T=!1;this.l=null;this.na={loadEPUB:this.Of,loadXML:this.Pf,configure:this.ye,moveTo:this.Ia,toc:this.Cd};Dt(this)}function Dt(a){ka(1,function(a){Et(this,{t:"debug",content:a})}.bind(a));ka(2,function(a){Et(this,{t:"info",content:a})}.bind(a));ka(3,function(a){Et(this,{t:"warn",content:a})}.bind(a));ka(4,function(a){Et(this,{t:"error",content:a})}.bind(a))}
function Et(a,b){b.i=a.Sa;a.Ra(b)}function Ft(a,b){a.C!==b&&(a.C=b,a.Ld.setAttribute("data-vivliostyle-viewer-status",b),Et(a,{t:"readystatechange"}))}n=Ct.prototype;
n.Of=function(a){Gt.f("beforeRender");Ft(this,"loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=K("loadEPUB"),h=this;h.ye(a).then(function(){var a=new Ls;Cs(a,e,f).then(function(){var e=oa(b,h.window.location.href);h.O=[e];Ns(a,e,d).then(function(a){h.h=a;Ht(h,c).then(function(){N(g,!0)})})})});return g.result()};
n.Pf=function(a){Gt.f("beforeRender");Ft(this,"loading");var b=a.url,c=a.document,d=a.fragment,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=K("loadXML"),h=this;h.ye(a).then(function(){var a=new Ls;Cs(a,e,f).then(function(){var e=b.map(function(a,b){return{url:oa(a.url,h.window.location.href),index:b,kb:a.kb,nc:a.nc}});h.O=e.map(function(a){return a.url});h.h=new Ps(a,"");et(h.h,e,c).then(function(){Ht(h,d).then(function(){N(g,!0)})})})});return g.result()};
function Ht(a,b){It(a);var c;b?c=gt(a.h,b).fa(function(b){a.f=b;return L(!0)}):c=L(!0);return c.fa(function(){Gt.b("beforeRender");return Jt(a)})}function Kt(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*yb.ex*a.fontSize/yb.em;if(d=yb[d])return c*d}return c}
n.ye=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.D=null,this.window.addEventListener("resize",this.Z,!1),this.Qa=!0):this.window.removeEventListener("resize",this.Z,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.Qa=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:Kt(this,b["margin-left"])||0,marginRight:Kt(this,b["margin-right"])||0,marginTop:Kt(this,b["margin-top"])||0,marginBottom:Kt(this,b["margin-bottom"])||
0,width:Kt(this,b.width)||0,height:Kt(this,b.height)||0},200<=b.width||200<=b.height)&&(this.window.removeEventListener("resize",this.Z,!1),this.D=b,this.Qa=!0);"boolean"==typeof a.hyphenate&&(this.X.Zd=a.hyphenate,this.Qa=!0);"boolean"==typeof a.horizontal&&(this.X.Yd=a.horizontal,this.Qa=!0);"boolean"==typeof a.nightMode&&(this.X.fe=a.nightMode,this.Qa=!0);"number"==typeof a.lineHeight&&(this.X.lineHeight=a.lineHeight,this.Qa=!0);"number"==typeof a.columnWidth&&(this.X.Td=a.columnWidth,this.Qa=
...
(this.viewport=null,this.X.Ec=a.pageBorder,this.Qa=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=a.zoom,this.Rb=!0);"boolean"==typeof a.fitToScreen&&a.fitToScreen!==this.G&&(this.G=a.fitToScreen,this.Rb=!0);"object"==typeof a.defaultPaperSize&&"number"==typeof a.defaultPaperSize.width&&"number"==typeof a.defaultPaperSize.height&&(this.viewport=null,this.X.fc=a.defaultPaperSize,this.Qa=!0);Lt(this,a);return L(!0)};
function Lt(a,b){Qd("CONFIGURATION").forEach(function(a){a=a(b);this.Qa=a.Qa||this.Qa;this.Rb=a.Rb||this.Rb}.bind(a))}n.je=function(a){var b=this.g,c=this.j,d=a.target;c?c.left!==d&&c.right!==d||Mt(this,a.Ef):b===a.target&&Mt(this,a.Ef)};function Nt(a,b){var c=[];a.g&&c.push(a.g);a.j&&(c.push(a.j.left),c.push(a.j.right));c.forEach(function(a){a&&b(a)})}function Ot(a){Nt(a,function(a){a.removeEventListener("hyperlink",this.H,!1);a.removeEventListener("replaced",this.je,!1)}.bind(a))}
function Pt(a){Ot(a);Nt(a,function(a){w(a.L,"display","none")});a.g=null;a.j=null}function Qt(a,b){b.addEventListener("hyperlink",a.H,!1);b.addEventListener("replaced",a.je,!1);w(b.L,"visibility","visible");w(b.L,"display","block")}function Rt(a,b){Pt(a);a.g=b;Qt(a,b)}function St(a){var b=K("reportPosition");ft(a.h,a.f.R,a.f.Ga).then(function(c){var d=a.g;(a.la&&0<d.j.length?re(d.j):L(!0)).then(function(){Tt(a,d,c).Ba(b)})});return b.result()}
function Ut(a){var b=a.Ld;if(a.D){var c=a.D;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new gr(a.window,a.fontSize,b,c.width,c.height)}return new gr(a.window,a.fontSize,b)}
function Vt(a){var b=Ut(a),c;a:switch(a.W){case "singlePage":c=!1;break a;case "spread":c=!0;break a;default:c=1.45<=b.width/b.height&&800<b.width}var d=a.X.rb!==c;a.X.rb=c;a.Ld.setAttribute("data-vivliostyle-spread-view",c);if(a.D||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;if(!d&&b.width==a.viewport.width&&b.height==a.viewport.height)return!0;if(d=a.b&&At(a.b)){a:{d=a.b.oc;for(c=0;c<d.length;c++){var e=d[c];if(e)for(var e=e.pb,f=0;f<e.length;f++){var g=e[f];if(g.G&&g.D){d=!0;break a}}}d=
!1}d=!d}return d?(a.viewport.width=b.width,a.viewport.height=b.height,a.Rb=!0):!1}n.hg=function(a,b,c,d){this.ha[d]=a;Wt(this,b,c,d)};function Wt(a,b,c,d){if(!a.T&&a.I&&!c&&!d){var e="";Object.keys(b).forEach(function(a){e+="@page "+a+"{size:";a=b[a];e+=a.width+"px "+a.height+"px;}"});a.I.textContent=e;a.T=!0}}
function Xt(a){if(a.b){a.b.vd();for(var b=a.b,c=b.oc,d=0;d<c.length;d++){var e=c[d];e&&e.pb.splice(0)}for(b=b.viewport.root;b.lastChild;)b.removeChild(b.lastChild)}a.I&&(a.I.textContent="",a.T=!1);a.viewport=Ut(a);b=a.viewport;w(b.g,"width","");w(b.g,"height","");w(b.f,"width","");w(b.f,"height","");w(b.f,"transform","");a.b=new kt(a.h,a.viewport,a.ra,a.X,a.hg.bind(a))}
function Mt(a,b,c){a.Rb=!1;Ot(a);if(a.X.rb)return vt(a.b,a.f,c).fa(function(c){Pt(a);a.j=c;c.left&&(Qt(a,c.left),c.right||c.left.L.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Qt(a,c.right),c.left||c.right.L.setAttribute("data-vivliostyle-unpaired-page",!0));c=Yt(a,c);a.viewport.zoom(c.width,c.height,a.G?Zt(a,c):a.zoom);a.g=b;return L(null)});Rt(a,b);a.viewport.zoom(b.f.width,b.f.height,a.G?Zt(a,b.f):a.zoom);a.g=b;return L(null)}
function Yt(a,b){var c=0,d=0;b.left&&(c+=b.left.f.width,d=b.left.f.height);b.right&&(c+=b.right.f.width,d=Math.max(d,b.right.f.height));b.left&&b.right&&(c+=2*a.X.Ec);return{width:c,height:d}}var $t={ug:"fit inside viewport"};function Zt(a,b){return Math.min(a.viewport.width/b.width,a.viewport.height/b.height)}function au(){this.name="RenderingCanceledError";this.message="Page rendering has been canceled";this.stack=Error().stack}t(au,Error);
function It(a){if(a.l){var b=a.l;Xd(b,new au);if(b!==Rd&&b.b){b.b.g=!0;var c=new ge(b);b.l="interrupt";b.b=c;b.f.ib(c)}}a.l=null}
function Jt(a){a.Qa=!1;a.Rb=!1;if(Vt(a))return L(!0);Ft(a,"loading");It(a);var b=Zd(Rd.f,function(){return Wd("resize",function(c){a.l=b;Gt.f("render (resize)");Xt(a);a.f&&(a.f.$=-1);tt(a.b,a.f).then(function(d){a.f=d.position;Mt(a,d.page,!0).then(function(){St(a).then(function(d){Ft(a,"interactive");(a.me?a.b.me():L(null)).then(function(){a.l===b&&(a.l=null);Gt.b("render (resize)");Ft(a,"complete");Et(a,{t:"loaded"});N(c,d)})})})})},function(a,b){if(b instanceof au)Gt.b("render (resize)"),v.debug(b.message);
else throw b;})});return L(!0)}function Tt(a,b,c){var d=K("sendLocationNotification"),e={t:"nav",first:b.H,last:b.C};it(a.h,a.f).then(function(b){e.epage=b;e.epageCount=a.h.G;c&&(e.cfi=c);Et(a,e);N(d,!0)});return d.result()}Ct.prototype.Pb=function(){return this.b?this.b.Pb(this.f):null};
Ct.prototype.Ia=function(a){var b=this;"complete"!==this.C&&Ft(this,"loading");if("string"==typeof a.where){switch(a.where){case "next":a=this.X.rb?this.b.bg:this.b.nextPage;break;case "previous":a=this.X.rb?this.b.eg:this.b.ke;break;case "last":a=this.b.Wf;break;case "first":a=this.b.Sf;break;default:return L(!0)}if(a){var c=a;a=function(){return c.call(b.b,b.f)}}}else if("number"==typeof a.epage){var d=a.epage;a=function(){return wt(b.b,d)}}else if("string"==typeof a.url){var e=a.url;a=function(){return yt(b.b,
e,b.f)}}else return L(!0);var f=K("moveTo");a.call(b.b).then(function(a){var c;if(a){b.f=a.position;var d=K("moveTo.showCurrent");c=d.result();Mt(b,a.page).then(function(){St(b).Ba(d)})}else c=L(!0);c.then(function(a){"loading"===b.C&&Ft(b,"interactive");N(f,a)})});return f.result()};
Ct.prototype.Cd=function(a){var b=!!a.autohide;a=a.v;var c=this.b.Le();if(c){if("show"==a)return L(!0)}else if("hide"==a)return L(!0);if(c)return this.b.vd(),L(!0);var d=this,e=K("showTOC");this.b.Cd(b).then(function(a){if(a){if(b){var c=function(){d.b.vd()};a.addEventListener("hyperlink",c,!1);a.L.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.H,!1)}N(e,!0)});return e.result()};
function bu(a,b){var c=b.a||"";return Wd("runCommand",function(d){var e=a.na[c];e?e.call(a,b).then(function(){Et(a,{t:"done",a:c});N(d,!0)}):(v.error("No such action:",c),N(d,!0))},function(a,b){v.error(b,"Error during action:",c);N(a,!0)})}function cu(a){return"string"==typeof a?JSON.parse(a):a}
function du(a,b){var c=cu(b),d=null;Yd(function(){var b=K("commandLoop"),f=Rd.f;a.H=function(b){var c="#"===b.href.charAt(0)||a.O.some(function(a){return b.href.substr(0,a.length)==a});if(c){b.preventDefault();var d={t:"hyperlink",href:b.href,internal:c};Zd(f,function(){Et(a,d);return L(!0)})}};ne(function(b){if(a.Qa)Jt(a).then(function(){O(b)});else if(a.Rb)a.g&&Mt(a,a.g).then(function(){O(b)});else if(c){var e=c;c=null;bu(a,e).then(function(){O(b)})}else e=K("waitForCommand"),d=fe(e,self),e.result().then(function(){O(b)})}).Ba(b);
return b.result()});a.J=function(){var a=d;a&&(d=null,a.ib())};a.A=function(b){if(c)return!1;c=cu(b);a.J();return!0};a.window.adapt_command=a.A};function Zq(a,b,c){if(a==b)return a?[[0,a]]:[];if(0>c||a.length<c)c=null;var d=eu(a,b),e=a.substring(0,d);a=a.substring(d);b=b.substring(d);var d=fu(a,b),f=a.substring(a.length-d);a=a.substring(0,a.length-d);b=b.substring(0,b.length-d);a=gu(a,b);e&&a.unshift([0,e]);f&&a.push([0,f]);hu(a);null!=c&&(a=iu(a,c));return a}
function gu(a,b){var c;if(!a)return[[1,b]];if(!b)return[[-1,a]];c=a.length>b.length?a:b;var d=a.length>b.length?b:a,e=c.indexOf(d);if(-1!=e)return c=[[1,c.substring(0,e)],[0,d],[1,c.substring(e+d.length)]],a.length>b.length&&(c[0][0]=c[2][0]=-1),c;if(1==d.length)return[[-1,a],[1,b]];var f=ju(a,b);if(f)return d=f[1],e=f[3],c=f[4],f=Zq(f[0],f[2]),d=Zq(d,e),f.concat([[0,c]],d);a:{c=a.length;for(var d=b.length,e=Math.ceil((c+d)/2),f=2*e,g=Array(f),h=Array(f),l=0;l<f;l++)g[l]=-1,h[l]=-1;g[e+1]=0;h[e+1]=
0;for(var l=c-d,k=!!(l%2),m=0,p=0,q=0,r=0,z=0;z<e;z++){for(var u=-z+m;u<=z-p;u+=2){var A=e+u,H;H=u==-z||u!=z&&g[A-1]<g[A+1]?g[A+1]:g[A-1]+1;for(var G=H-u;H<c&&G<d&&a.charAt(H)==b.charAt(G);)H++,G++;g[A]=H;if(H>c)p+=2;else if(G>d)m+=2;else if(k&&(A=e+l-u,0<=A&&A<f&&-1!=h[A])){var I=c-h[A];if(H>=I){c=ku(a,b,H,G);break a}}}for(u=-z+q;u<=z-r;u+=2){A=e+u;I=u==-z||u!=z&&h[A-1]<h[A+1]?h[A+1]:h[A-1]+1;for(H=I-u;I<c&&H<d&&a.charAt(c-I-1)==b.charAt(d-H-1);)I++,H++;h[A]=I;if(I>c)r+=2;else if(H>d)q+=2;else if(!k&&
(A=e+l-u,0<=A&&A<f&&-1!=g[A]&&(H=g[A],G=e+H-A,I=c-I,H>=I))){c=ku(a,b,H,G);break a}}}c=[[-1,a],[1,b]]}return c}function ku(a,b,c,d){var e=a.substring(c),f=b.substring(d);a=Zq(a.substring(0,c),b.substring(0,d));e=Zq(e,f);return a.concat(e)}function eu(a,b){if(!a||!b||a.charAt(0)!=b.charAt(0))return 0;for(var c=0,d=Math.min(a.length,b.length),e=d,f=0;c<e;)a.substring(f,e)==b.substring(f,e)?f=c=e:d=e,e=Math.floor((d-c)/2+c);return e}
function fu(a,b){if(!a||!b||a.charAt(a.length-1)!=b.charAt(b.length-1))return 0;for(var c=0,d=Math.min(a.length,b.length),e=d,f=0;c<e;)a.substring(a.length-e,a.length-f)==b.substring(b.length-e,b.length-f)?f=c=e:d=e,e=Math.floor((d-c)/2+c);return e}
function ju(a,b){function c(a,b,c){for(var d=a.substring(c,c+Math.floor(a.length/4)),e=-1,f="",g,h,k,l;-1!=(e=b.indexOf(d,e+1));){var m=eu(a.substring(c),b.substring(e)),I=fu(a.substring(0,c),b.substring(0,e));f.length<I+m&&(f=b.substring(e-I,e)+b.substring(e,e+m),g=a.substring(0,c-I),h=a.substring(c+m),k=b.substring(0,e-I),l=b.substring(e+m))}return 2*f.length>=a.length?[g,h,k,l,f]:null}var d=a.length>b.length?a:b,e=a.length>b.length?b:a;if(4>d.length||2*e.length<d.length)return null;var f=c(d,e,
...
function hu(a){a.push([0,""]);for(var b=0,c=0,d=0,e="",f="",g;b<a.length;)switch(a[b][0]){case 1:d++;f+=a[b][1];b++;break;case -1:c++;e+=a[b][1];b++;break;case 0:if(1<c+d){if(c&&d){if(g=eu(f,e))0<b-c-d&&0==a[b-c-d-1][0]?a[b-c-d-1][1]+=f.substring(0,g):(a.splice(0,0,[0,f.substring(0,g)]),b++),f=f.substring(g),e=e.substring(g);if(g=fu(f,e))a[b][1]=f.substring(f.length-g)+a[b][1],f=f.substring(0,f.length-g),e=e.substring(0,e.length-g)}c?d?a.splice(b-c-d,c+d,[-1,e],[1,f]):a.splice(b-c,c+d,[-1,e]):a.splice(b-
...
a[b+1][1],a.splice(b+1,1),c=!0)),b++;c&&hu(a)}Zq.f=1;Zq.b=-1;Zq.g=0;
function iu(a,b){var c;a:{var d=a;if(0===b)c=[0,d];else{var e=0;for(c=0;c<d.length;c++){var f=d[c];if(-1===f[0]||0===f[0]){var g=e+f[1].length;if(b===g){c=[c+1,d];break a}if(b<g){d=d.slice();g=b-e;e=[f[0],f[1].slice(0,g)];f=[f[0],f[1].slice(g)];d.splice(c,1,e,f);c=[c+1,d];break a}e=g}}throw Error("cursor_pos is out of bounds!");}}d=c[1];c=c[0];e=d[c];f=d[c+1];return null==e||0!==e[0]?a:null!=f&&e[1]+f[1]===f[1]+e[1]?(d.splice(c,2,f,e),lu(d,c,2)):null!=f&&0===f[1].indexOf(e[1])?(d.splice(c,2,[f[0],
e[1]],[0,e[1]]),e=f[1].slice(e[1].length),0<e.length&&d.splice(c+2,0,[f[0],e]),lu(d,c,3)):a}function lu(a,b,c){for(c=b+c-1;0<=c&&c>=b-1;c--)if(c+1<a.length){var d=a[c],e=a[c+1];d[0]===e[1]&&a.splice(c,2,[d[0],d[1]+e[1]])}return a};function Yq(a){return a.reduce(function(a,c){return c[0]===Zq.b?a:a+c[1]},"")}function Jk(a,b,c){var d=0,e=0;a.some(function(a){for(var f=0;f<a[1].length;f++){switch(a[0]*c){case Zq.f:d++;break;case Zq.b:d--;e++;break;case Zq.g:e++}if(e>b)return!0}return!1});return Math.max(Math.min(b,e-1)+d,0)};function mu(a,b,c){zm.call(this,a,b,"block-end",c)}t(mu,zm);mu.prototype.Ge=function(a){return!(a instanceof mu)};function nu(a,b,c){Cm.call(this,a,"block-end",b,c)}t(nu,Cm);nu.prototype.Fa=function(){return Infinity};nu.prototype.b=function(a){return a instanceof mu?!0:this.Fa()<a.Fa()};function ou(){}n=ou.prototype;n.bf=function(a){return"footnote"===a.ya};n.af=function(a){return a instanceof mu};
n.gf=function(a,b){var c="region",d=Nm(b,c);dn(Nm(b,"page"),d)&&(c="page");d=Ik(a);c=new mu(d,c,b.h);b.Od(c);return L(c)};n.hf=function(a,b,c){return new nu(a[0].qa.b,a,c)};n.Ve=function(a,b){return Nm(b,a.b).b.filter(function(a){return a instanceof nu})[0]||null};
n.Ye=function(a,b,c){a.jf=!0;a.uc=!1;var d=a.element,e=c.j;b=b.u;var f={},g;g=e.C._pseudos;b=Dq(e,b,e.C,f);if(g&&g.before){var h={},l=Pq(e,"http://www.w3.org/1999/xhtml","span");wq(l,"before");d.appendChild(l);Dq(e,b,g.before,h);delete h.content;Sq(e,l,h)}delete f.content;Sq(e,d,f);a.u=b;Yo(a,d);if(e=go(c.f,d))a.marginLeft=X(e.marginLeft),a.borderLeft=X(e.borderLeftWidth),a.C=X(e.paddingLeft),a.marginTop=X(e.marginTop),a.borderTop=X(e.borderTopWidth),a.D=X(e.paddingTop),a.marginRight=X(e.marginRight),
a.ha=X(e.borderRightWidth),a.I=X(e.paddingRight),a.marginBottom=X(e.marginBottom),a.Z=X(e.borderBottomWidth),a.H=X(e.paddingBottom);if(c=go(c.f,d))a.width=X(c.width),a.height=X(c.height)};un.push(new ou);function pu(a,b){this.g(a,"end",b)}function qu(a,b){this.g(a,"start",b)}function ru(a,b,c){c||(c=this.j.now());var d=this.h[a];d||(d=this.h[a]=[]);var e;for(a=d.length-1;0<=a&&(!(e=d[a])||e[b]);a--)e=null;e||(e={},d.push(e));e[b]=c}function su(){}function tu(a){this.j=a;this.h={};this.registerEndTiming=this.b=this.registerStartTiming=this.f=this.g=su}
tu.prototype.l=function(){var a=this.h,b="";Object.keys(a).forEach(function(c){for(var d=a[c],e=d.length,f=0;f<e;f++){var g=d[f];b+=c;1<e&&(b+="("+f+")");b+=" => start: "+g.start+", end: "+g.end+", duration: "+(g.end-g.start)+"\n"}});v.g(b)};tu.prototype.A=function(){this.registerEndTiming=this.b=this.registerStartTiming=this.f=this.g=su};tu.prototype.C=function(){this.g=ru;this.registerStartTiming=this.f=qu;this.registerEndTiming=this.b=pu};
var uu={now:Date.now},Gt,vu=Gt=new tu(window&&window.performance||uu);ru.call(vu,"load_vivliostyle","start",void 0);ba("vivliostyle.profile.profiler",vu);tu.prototype.printTimings=tu.prototype.l;tu.prototype.disable=tu.prototype.A;tu.prototype.enable=tu.prototype.C;function Kn(a){return(a=a.F)&&a instanceof Lo?a:null}function wu(a,b,c){var d=a.b;return d&&!d.kc&&(a=xu(a,b),a.B)?!d.hc||d.kc?L(!0):yu(d,d.hc,a,null,c):L(!0)}function zu(a,b,c){var d=a.b;return d&&(a=xu(a,b),a.B)?!d.ic||d.lc?L(!0):yu(d,d.ic,a,a.B.firstChild,c):L(!0)}function Au(a,b){a&&Bu(a.K?a.parent:a,function(a,d){a instanceof Ko||b.l.push(new Cu(d))})}function Bu(a,b){for(var c=a;c;c=c.parent){var d=c.F;d&&d instanceof Lo&&!Mk(c,d)&&b(d,c)}}
function Lo(a,b){this.parent=a;this.j=b;this.b=null}Lo.prototype.te=function(){return"Repetitive elements owner formatting context (vivliostyle.repetitiveelements.RepetitiveElementsOwnerFormattingContext)"};Lo.prototype.Ie=function(a,b){return b};function Du(a,b){var c=xu(a,b);return c?c.B:null}function xu(a,b){do if(!Mk(b,a)&&b.N===a.j)return b;while(b=b.parent);return null}
function Vq(a,b){a.b||Uo.some(function(a){return a.root===this.j?(this.b=a.elements,!0):!1}.bind(a))||(a.b=new Eu(b,a.j),Uo.push({root:a.j,elements:a.b}))}Lo.prototype.ve=function(){};Lo.prototype.ue=function(){};var Uo=[];function Eu(a,b){this.u=a;this.hc=this.ic=this.A=this.D=this.l=this.C=null;this.H=this.I=0;this.kc=this.lc=!1;this.Pc=this.Vd=!0;this.j=!1;this.W=b;this.J=this.g=null;this.O=[];this.T=[]}function Fu(a,b){a.ic||(a.ic=wk(b),a.C=b.N,a.D=b.B)}
function Gu(a,b){a.hc||(a.hc=wk(b),a.l=b.N,a.A=b.B)}function yu(a,b,c,d,e){var f=c.B,g=c.B.ownerDocument.createElement("div");f.appendChild(g);var h=new jm(e,g,c),l=h.b.b;h.b.b=null;a.h=!0;return mm(h,new Nk(b)).fa(function(){this.h=!1;f.removeChild(g);if(f)for(;g.firstChild;){var a=g.firstChild;g.removeChild(a);a.setAttribute("data-adapt-spec","1");d?f.insertBefore(a,d):f.appendChild(a)}h.b.b=l;return L(!0)}.bind(a))}
Eu.prototype.b=function(a){var b=0;if(a&&!this.f(a))return b;if(!this.kc||a&&Hu(this,a))b+=this.H;this.lc||(b+=this.I);return b};Eu.prototype.G=function(a){var b=0;if(a&&!this.f(a))return b;a&&Hu(this,a)&&(b+=this.H);this.Pc||(b+=this.I);return b};function Hu(a,b){return Iu(b,a.T,function(){return Ju(this.J,b,!1)}.bind(a))}Eu.prototype.f=function(a){return Iu(a,this.O,function(){return Ju(this.W,a,!0)}.bind(this))};
function Iu(a,b,c){var d=b.filter(function(b){return b.w.N===a.N&&b.w.K===a.K});if(0<d.length)return d[0].result;c=c(a);b.push({w:a,result:c});return c}function Ju(a,b,c){for(var d=[];a;a=a.parentNode){if(b.N===a)return b.K;d.push(a)}for(a=b.N;a;a=a.parentNode){var e=d.indexOf(a);if(0<=e)return c?!e:!1;for(e=a;e;e=e.previousElementSibling)if(0<=d.indexOf(e))return!0}return b.K}function Ku(a){return!a.kc&&a.Vd&&a.hc||!a.lc&&a.Pc&&a.ic?!0:!1}function Lu(a){this.F=a}Lu.prototype.b=function(){};
Lu.prototype.f=function(a){return!!a};Lu.prototype.g=function(a,b,c,d){(a=this.F.b)&&!a.j&&(a.D&&(a.I=Zo(a.D,c,a.u),a.D=null),a.A&&(a.H=Zo(a.A,c,a.u),a.A=null),a.j=!0);return d};function Mu(a){this.F=a}Mu.prototype.b=function(){};Mu.prototype.f=function(){return!0};Mu.prototype.g=function(a,b,c,d){return d};function Nu(a){this.F=a}t(Nu,Lu);Nu.prototype.b=function(a,b){Lu.prototype.b.call(this,a,b);var c=K("BlockLayoutProcessor.doInitialLayout");gm(new fm(new Ou(a.F),b.j),a).Ba(c);return c.result()};
Nu.prototype.f=function(){return!1};function Pu(a){this.F=a}t(Pu,Mu);Pu.prototype.b=function(a,b){Mk(a,this.F)||a.K||b.l.unshift(new Cu(a));return Qu(a,b)};function Cu(a){this.w=xu(a.F,a)}n=Cu.prototype;n.bc=function(a,b){var c=this.w.F.b;return c&&!eo(this.w.B)&&Ku(c)?b&&!a||a&&a.b?!1:!0:!0};n.yd=function(){var a=this.w.F.b;return a&&Ku(a)?(!a.kc&&a.Vd&&a.hc?a.kc=!0:!a.lc&&a.Pc&&a.ic&&(a.lc=!0),!0):!1};n.md=function(a,b,c,d){(c=this.w.F.b)&&a&&d.h&&(!b||Hu(c,b))&&(c.kc=!1,c.Vd=!1)};
n.Ea=function(a,b){var c=this.w.F,d=this.w.F.b;if(!d)return L(!0);var e=this.w;return zu(c,e,b).fa(function(){return wu(c,e,b).fa(function(){d.lc=d.kc=!1;d.Vd=!0;d.Pc=!0;return L(!0)})})};n.Ce=function(a){return a instanceof Cu?this.w.F===a.w.F:!1};n.Fe=function(){return 10};function Ru(a){pm.call(this);this.F=a}t(Ru,pm);Ru.prototype.j=function(a){var b=this.F.b;return Mk(a,this.F)||b.j?(Mk(a,this.F)||a.K||!b||(b.lc=!1,b.Pc=!1),new Pu(this.F)):new Nu(this.F)};function Ou(a){this.F=a}t(Ou,im);
Ou.prototype.hd=function(a){var b=this.F,c=a.w,d=b.b;if(c.parent&&b.j===c.parent.N){switch(c.j){case "header":if(d.ic)c.j="none";else return Fu(d,c),L(!0);break;case "footer":if(d.hc)c.j="none";else return Gu(d,c),L(!0)}d.g||(d.g=c.N)}return im.prototype.hd.call(this,a)};Ou.prototype.$b=function(a){var b=this.F,c=a.w;c.N===b.j&&(b.b.J=a.Cc&&a.Cc.N,a.Eb=!0);return"header"===c.j||"footer"===c.j?L(!0):im.prototype.$b.call(this,a)};function Su(){}t(Su,Wo);
Su.prototype.Nd=function(a,b,c){if(Nn(b,a))return Wn(b,a);var d=a.F;return Du(d,a)?(c&&Au(a.parent,b),Mk(a,d)?Wo.prototype.Nd.call(this,a,b,c):qm(new Ru(d),a,b)):Yn(b,a)};Su.prototype.we=function(a){var b=Kn(a).b;if(!b)return!1;b.h||b.C!==a.N&&b.l!==a.N||a.B.parentNode.removeChild(a.B);return!1};
function Qu(a,b){var c=a.F,d=K("doLayout"),e=hm(b.j,a,!1);Xn(e,b).then(function(a){var e=a;ne(function(a){for(;e;){var d=!0;No(b,e,!1).then(function(f){e=f;en(b.g)?P(a):b.b?P(a):e&&b.h&&e&&e.b?P(a):e&&e.K&&e.N==c.j?P(a):d?d=!1:O(a)});if(d){d=!1;return}}P(a)}).then(function(){N(d,e)})});return d.result()}Su.prototype.Ea=function(a,b,c,d){return Wo.prototype.Ea.call(this,a,b,c,d)};Su.prototype.ld=function(a,b,c,d){Wo.prototype.ld(a,b,c,d)};
function Hn(a){for(var b=[],c=a;c;c=c.Bb)c.l.forEach(function(c){if(c instanceof Cu){var d=c.w.F.b;b.push(d)}c instanceof Tu&&(d=new Uu(c.w,c.f),b.push(d));c instanceof Vu&&Wu(c,a).forEach(function(a){b.push(a)})});return b}var Xu=new Su;Pd("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof Lo&&!(a instanceof Ko)?Xu:null});function Yu(a,b){if(!a||!a.J||a.K)return L(a);var c=a.J;return Zu(c,b,a).fa(function(d){var e=a.B;e.appendChild(d);var f=Zo(d,b,a.u);e.removeChild(d);b.l.push(new Tu(a,c,f));return L(a)})}function $u(a,b,c){this.b=a;this.f=b;this.ub=c}$u.prototype.matches=function(){var a=av[this.b];return!!a&&null!=a.Ka&&ei(a.Ka,this.f,this.ub)};function Yi(a){this.b=a}Yi.prototype.matches=function(){return this.b.some(function(a){return a.matches()})};function Zi(a){this.b=a}Zi.prototype.matches=function(){return this.b.every(function(a){return a.matches()})};
function Xi(a,b){var c=b.split("_");if("NFS"==c[0])return new $u(a,parseInt(c[1],10),parseInt(c[2],10));fa("unknown view condition. condition="+b);return null}function xj(a,b,c){Aq(c,function(c){zj(a,c,b)})}function Aq(a,b){var c=a._viewConditionalStyles;c&&c.forEach(function(a){a.Yf.matches()&&b(a.ig)})}function Lq(a,b,c){var d=av;if(!d[a]||d[a].Ua<=c)d[a]={Ka:b,Ua:c}}var av={};function Uq(a,b){this.b=b;this.N=a}
function Zu(a,b,c){var d=c.B.ownerDocument.createElement("div"),e=new jm(b,d,c),f=e.b.b;e.b.b=null;return mm(e,bv(a)).fa(function(){this.b.f["after-if-continues"]=!1;e.b.b=f;var a=d.firstChild;w(a,"display","block");return L(a)}.bind(a))}function bv(a){var b=uq.createElementNS("http://www.w3.org/1999/xhtml","div");wq(b,"after-if-continues");a=new Ck(a.N,b,null,null,null,3,a.b);return new Nk({ma:[{node:b,Za:a.type,pa:a,za:null,va:null}],ja:0,K:!1,Ha:null})}
function Tu(a,b,c){this.w=a;this.b=b;this.f=c}n=Tu.prototype;n.bc=function(a,b){return b&&!a||a&&a.b?!1:!0};n.yd=function(){return!1};n.md=function(){};n.Ea=function(a,b){return(new Uu(this.w,this.f)).f(a)?Zu(this.b,b,this.w).fa(function(a){this.w.B.appendChild(a);return L(!0)}.bind(this)):L(!0)};n.Ce=function(a){return a instanceof Tu?this.b==a.b:!1};n.Fe=function(){return 9};function Uu(a,b){this.w=a;this.g=b}Uu.prototype.b=function(a){return this.f(a)?this.g:0};Uu.prototype.G=function(a){return this.b(a)};
Uu.prototype.f=function(a){if(!a)return!1;var b=a.pa?a.pa.ka:a.N;if(b===this.w.N)return!!a.K;for(a=b.parentNode;a;a=a.parentNode)if(a===this.w.N)return!0;return!1};function Xn(a,b){return a.fa(function(a){return Yu(a,b)})}function Vo(a,b){var c=K("vivliostyle.selectors.processAfterIfContinuesOfAncestors"),d=a;me(function(){if(d){var a=Yu(d,b);d=d.parent;return a.sc(!0)}return L(!1)}).then(function(){N(c,!0)});return c.result()};function cv(a,b,c){var d=a.w,e=d.display,f=d.parent?d.parent.display:null;return"table-row"===e&&!dv(f)&&"table"!==f&&"inline-table"!==f||"table-cell"===e&&"table-row"!==f&&!dv(f)&&"table"!==f&&"inline-table"!==f||d.F instanceof Ko&&d.F!==b?Yn(c,d).fa(function(b){a.w=b;return L(!0)}):null}function dv(a){return"table-row-group"===a||"table-header-group"===a||"table-footer-group"===a}function ev(a,b){this.rowIndex=a;this.N=b;this.cells=[]}
function fv(a){return Math.min.apply(null,a.cells.map(function(a){return a.height}))}function gv(a,b,c){this.rowIndex=a;this.Ja=b;this.f=c;this.b=c.colSpan||1;this.rowSpan=c.rowSpan||1;this.height=0;this.cc=null}function hv(a,b,c){this.rowIndex=a;this.Ja=b;this.Kb=c}function iv(a,b,c){this.g=a;this.b=c;this.Vb=new jm(a,b,c);this.f=!1}iv.prototype.Ob=function(){var a=this.b.B,b=this.b.T;"middle"!==b&&"bottom"!==b||w(a,"vertical-align","top");var c=this.Vb.Ob(!0);w(a,"vertical-align",b);return c};
function jv(a,b){this.B=a;this.b=b}function kv(a,b,c,d){om.call(this,a,b,c,d);this.F=a.F;this.rowIndex=this.j=null}t(kv,om);kv.prototype.f=function(a,b){var c=om.prototype.f.call(this,a,b);return b<this.b()?null:lv(this).every(function(a){return!!a.w})?c:null};kv.prototype.b=function(){var a=om.prototype.b.call(this);lv(this).forEach(function(b){a+=b.Fb.b()});return a};function lv(a){a.j||(a.j=mv(a).map(function(a){return a.Ob()}));return a.j}
function mv(a){return nv(a.F,null!=a.rowIndex?a.rowIndex:a.rowIndex=ov(a.F,a.position.N)).map(a.F.ud,a.F)}function pv(a,b,c){this.rowIndex=a;this.j=b;this.F=c;this.h=null}t(pv,Dn);pv.prototype.f=function(a,b){if(b<this.b())return null;var c=qv(this),d=rv(this),e=d.every(function(a){return!!a.w})&&d.some(function(a,b){var d=a.w,e=c[b].Vb.Re[0];return!(e.B===d.B&&e.K===d.K&&e.ja===d.ja)});this.j.b=d.some(function(a){return a.w&&a.w.b});return e?this.j:null};
pv.prototype.b=function(){var a=this.F,b=0;sv(a,a.g[this.rowIndex])||(b+=10);rv(this).forEach(function(a){b+=a.Fb.b()});return b};function rv(a){a.h||(a.h=qv(a).map(function(a){return a.Ob()}));return a.h}function qv(a){return tv(a.F,a.rowIndex).map(a.F.ud,a.F)}function Ko(a,b){Lo.call(this,a,b);this.G=b;this.u=!1;this.C=-1;this.J=0;this.H=[];this.I=this.A=null;this.O=0;this.g=[];this.l=[];this.f=[];this.D=null;this.h=[];this.b=null}t(Ko,Lo);n=Ko.prototype;n.te=function(){return"Table formatting context (vivliostyle.table.TableFormattingContext)"};
n.Ie=function(a,b){if(!b)return b;switch(a.display){case "table-row":return!this.h.length;case "table-cell":return!this.h.some(function(b){return b.pd.ma[0].node===a.N});default:return b}};function uv(a,b){var c=a.l[b];c||(c=a.l[b]=[]);return c}function ov(a,b){return a.g.findIndex(function(a){return b===a.N})}function tv(a,b){return uv(a,b).reduce(function(a,b){return b.Kb!==a[a.length-1]?a.concat(b.Kb):a},[])}function nv(a,b){return tv(a,b).filter(function(a){return a.rowIndex+a.rowSpan-1>b})}
n.ud=function(a){return this.f[a.rowIndex]&&this.f[a.rowIndex][a.Ja]};function sv(a,b){return fv(b)>a.J/2}function vv(a){0>a.C&&(a.C=Math.max.apply(null,a.g.map(function(a){return a.cells.reduce(function(a,b){return a+b.b},0)})));return a.C}function wv(a,b){a.g.forEach(function(a){a.cells.forEach(function(a){var c=lk(b,a.f);a.f=null;a.height=this.u?c.width:c.height},this)},a)}
function xv(a,b){if(!b)return null;var c=null,d=0;a:for(;d<a.f.length;d++)if(a.f[d])for(var e=0;e<a.f[d].length;e++)if(a.f[d][e]&&b===a.f[d][e].Vb.b){c=a.g[d].cells[e];break a}if(!c)return null;for(;d<a.l.length;d++)for(;e<a.l[d].length;e++){var f=a.l[d][e];if(f.Kb===c)return{rowIndex:f.rowIndex,Ja:f.Ja}}return null}
function yv(a,b){var c=[];return a.l.reduce(function(a,e,f){if(f>=b.rowIndex)return a;e=this.ud(e[b.Ja].Kb);if(!e||0<=c.indexOf(e))return a;zv(e.Vb.b,a);c.push(e);return a}.bind(a),[])}function Av(a){var b=[];a.g.forEach(function(a){a.cells.forEach(function(a,c){b[c]||(b[c]={ef:[],elements:[]});var d=b[c],e=this.ud(a);!e||0<=d.ef.indexOf(e)||(zv(e.Vb.b,d.elements),d.ef.push(e))}.bind(this))}.bind(a));return[new Bv(b.map(function(a){return a.elements}))]}
function zv(a,b){a.l.forEach(function(a){a instanceof Cu&&b.push(a.w.F.b);a instanceof Vu&&Wu(a,null).forEach(function(a){b.push(a)})})}n.ve=function(){return[].concat(this.h)};n.ue=function(a){this.h=a};function Bv(a){this.f=a}Bv.prototype.b=function(a){return Cv(this,a,function(a){return a.current})};Bv.prototype.G=function(a){return Cv(this,a,function(a){return a.ee})};function Cv(a,b,c){var d=0;a.f.forEach(function(a){a=En(b,a);d=Math.max(d,c(a))});return d}
function Dv(a,b){this.F=a;this.h=b;this.rowIndex=-1;this.Ja=0;this.g=!1;this.f=[]}t(Dv,im);n=Dv.prototype;
n.hd=function(a){var b=this.F,c=cv(a,b,this.h);if(c)return c;Ev(this,a);var c=a.w,d=b.b;switch(c.display){case "table":b.O=c.ha;break;case "table-caption":b.H.push(new jv(c.B,c.Z));break;case "table-header-group":return d.ic||(this.b=!0,Fu(d,c)),L(!0);case "table-footer-group":return d.hc||(this.b=!0,Gu(d,c)),L(!0);case "table-row":this.b||(this.g=!0,this.rowIndex++,this.Ja=0,b.g[this.rowIndex]=new ev(this.rowIndex,c.N),d.g||(d.g=c.N))}return im.prototype.hd.call(this,a)};
n.$b=function(a){var b=this.F,c=a.w,d=c.display,e=this.h.f;Ev(this,a);if(c.N===b.G)d=go(e,Du(b,c)),b.J=parseFloat(d[b.u?"height":"width"]),b.b.J=a.Cc&&a.Cc.N,a.Eb=!0;else switch(d){case "table-header-group":case "table-footer-group":if(this.b)return this.b=!1,L(!0);break;case "table-row":this.b||(b.D=c.B,this.g=!1);break;case "table-cell":if(!this.b){this.g||(this.rowIndex++,this.Ja=0,this.g=!0);d=this.rowIndex;c=new gv(this.rowIndex,this.Ja,c.B);e=b.g[d];e||(b.g[d]=new ev(d,null),e=b.g[d]);e.cells.push(c);
for(var e=d+c.rowSpan,f=uv(b,d),g=0;f[g];)g++;for(;d<e;d++)for(var f=uv(b,d),h=g;h<g+c.b;h++){var l=f[h]=new hv(d,h,c);c.cc||(c.cc=l)}this.Ja++}}return im.prototype.$b.call(this,a)};n.Se=function(a){Fv(this,a)};n.$e=function(a){Fv(this,a)};n.If=function(a){Fv(this,a)};n.Ze=function(a){Fv(this,a)};function Fv(a,b){var c=b.w;c&&c.B&&!Un(c)&&a.f.push(c.clone())}function Ev(a,b){0<a.f.length&&Zn(a.h,b.w,a.f);a.f=[]}
function Gv(a,b){this.Qb=!0;this.F=a;this.f=b;this.l=!1;this.b=-1;this.g=0;this.A=b.h;b.h=!1}t(Gv,im);var Hv={"table-caption":!0,"table-column-group":!0,"table-column":!0};
function Iv(a,b,c,d){var e=b.rowIndex,f=b.Ja,g=c.B;if(1<b.b){w(g,"box-sizing","border-box");for(var h=a.F.I,l=0,k=0;k<b.b;k++)l+=h[b.cc.Ja+k];l+=a.F.O*(b.b-1);w(g,a.F.u?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new iv(a.f,b,c);a=a.F;(g=a.f[e])||(g=a.f[e]=[]);g[f]=c;1===d.f.ma.length&&d.f.K&&(c.f=!0);return mm(c.Vb,d).sc(!0)}function Jv(a,b){var c=a.F.h[0];return c?c.Kb.cc.Ja===b:!1}
function Kv(a){var b=a.F.h;if(!b.length)return[];var c=[],d=0;do{var e=b[d],f=e.Kb.rowIndex;if(f<a.b){var g=c[f];g||(g=c[f]=[]);g.push(e);b.splice(d,1)}else d++}while(d<b.length);return c}
function Lv(a,b){var c=a.F,d=Kv(a),e=d.reduce(function(a){return a+1},0);if(0===e)return L(!0);var f=a.f.j,g=b.w;g.B.parentNode.removeChild(g.B);var h=K("layoutRowSpanningCellsFromPreviousFragment"),l=L(!0),k=0,m=[];d.forEach(function(a){l=l.fa(function(){var b=zk(a[0].pd.ma[1],g.parent);return Pn(f,b,!1).fa(function(){function d(a){for(;h<a;){if(!(0<=m.indexOf(h))){var c=b.B.ownerDocument.createElement("td");w(c,"padding","0");b.B.appendChild(c)}h++}}var g=L(!0),h=0;a.forEach(function(a){g=g.fa(function(){var c=
a.Kb;d(c.cc.Ja);var g=a.pd,l=zk(g.ma[0],b);l.ja=g.ja;l.K=g.K;l.Ka=g.ma[0].Ka+1;return Pn(f,l,!1).fa(function(){for(var b=a.df,d=0;d<c.b;d++)m.push(h+d);h+=c.b;return Iv(this,c,l,b).fa(function(){l.B.rowSpan=c.rowIndex+c.rowSpan-this.b+e-k;return L(!0)}.bind(this))}.bind(this))}.bind(this))},this);return g.fa(function(){d(vv(c));k++;return L(!0)})}.bind(this))}.bind(this))},a);l.then(function(){Pn(f,g,!0,b.nd).then(function(){N(h,!0)})});return h.result()}
function Mv(a,b){if(a.j||a.h)return L(!0);var c=b.w,d=a.F;0>a.b?a.b=ov(d,c.N):a.b++;a.g=0;a.l=!0;return Lv(a,b).fa(function(){Nv(this);Go(this.f,b.Cc,null,!0,b.zc)&&!nv(d,this.b-1).length&&(this.f.h=this.A,c.b=!0,b.Eb=!0);return L(!0)}.bind(a))}function Nv(a){a.F.g[a.b].cells.forEach(function(a){var b=this.F.h[a.Ja];b&&b.Kb.cc.Ja==a.cc.Ja&&(a=b.pd.ma[0],b=Ij(this.f.j.aa,a.node),Lq(b,a.Ka+1,1))}.bind(a))}
function Ov(a,b){if(a.j||a.h)return L(!0);var c=b.w;a.l||(0>a.b?a.b=0:a.b++,a.g=0,a.l=!0);var d=a.F.g[a.b].cells[a.g],e=Bk(c).modify();e.K=!0;b.w=e;var f=K("startTableCell");Jv(a,d.cc.Ja)?(e=a.F.h.shift(),c.Ka=e.pd.ma[0].Ka+1,e=L(e.df)):e=Vn(a.f,c,b.nd).fa(function(a){a.B&&c.B.removeChild(a.B);return L(new Nk(wk(a)))});e.then(function(a){Iv(this,d,c,a).then(function(){this.$b(b);this.g++;N(f,!0)}.bind(this))}.bind(a));return f.result()}
Gv.prototype.Jf=function(a){var b=cv(a,this.F,this.f);if(b)return b;var b=a.w,c=this.F.b,d=b.display;return"table-header-group"===d&&c&&c.C===b.N?(this.j=!0,L(!0)):"table-footer-group"===d&&c&&c.l===b.N?(this.h=!0,L(!0)):"table-row"===d?Mv(this,a):"table-cell"===d?Ov(this,a):L(!0)};Gv.prototype.kf=function(a){a=a.w;"table-row"===a.display&&(this.l=!1,this.j||this.h||(a=Bk(a).modify(),a.K=!1,this.f.G.push(new pv(this.b,a,this.F))));return L(!0)};
Gv.prototype.$b=function(a){var b=a.w,c=this.F.b,d=b.display;"table-header-group"===d?c&&!c.h&&c.C===b.N?(this.j=!1,b.B.parentNode.removeChild(b.B)):w(b.B,"display","table-row-group"):"table-footer-group"===d&&(c&&!c.h&&c.l===b.N?(this.h=!1,b.B.parentNode.removeChild(b.B)):w(b.B,"display","table-row-group"));if(d&&Hv[d])b.B.parentNode.removeChild(b.B);else if(b.N===this.F.G)!(c=b.B.style)||Fo(c.paddingBottom)&&Fo(c.borderBottomWidth)||(b.b=Go(this.f,a.Cc,null,!1,a.zc)),this.f.h=this.A,a.Eb=!0;else return im.prototype.$b.call(this,
a);return L(!0)};function Pv(){}function Qv(a,b,c,d){for(var e=a.ownerDocument,f=e.createElement("tr"),g=[],h=0;h<b;h++){var l=e.createElement("td");f.appendChild(l);g.push(l)}a.parentNode.insertBefore(f,a.nextSibling);b=g.map(function(a){a=lk(d,a);return c?a.height:a.width});a.parentNode.removeChild(f);return b}function Rv(a){var b=[];for(a=a.firstElementChild;a;)"colgroup"===a.localName&&b.push(a),a=a.nextElementSibling;return b}
function Sv(a){var b=[];a.forEach(function(a){var c=a.span;a.removeAttribute("span");for(var e=a.firstElementChild;e;){if("col"===e.localName){var f=e.span;e.removeAttribute("span");for(c-=f;1<f--;){var g=e.cloneNode(!0);a.insertBefore(g,e);b.push(g)}b.push(e)}e=e.nextElementSibling}for(;0<c--;)e=a.ownerDocument.createElement("col"),a.appendChild(e),b.push(e)});return b}
function Tv(a,b,c,d){if(a.length<c){var e=d.ownerDocument.createElement("colgroup");b.push(e);for(b=a.length;b<c;b++){var f=d.ownerDocument.createElement("col");e.appendChild(f);a.push(f)}}}function Uv(a,b,c){var d=a.u,e=a.D;if(e){a.D=null;var f=e.ownerDocument.createDocumentFragment(),g=vv(a);if(0<g){var h=a.I=Qv(e,g,d,c.f);c=Rv(b);e=Sv(c);Tv(e,c,g,b);e.forEach(function(a,b){w(a,d?"height":"width",h[b]+"px")});c.forEach(function(a){f.appendChild(a.cloneNode(!0))})}a.A=f}}
function Vv(a,b,c){var d=b.F;d.u=b.u;Vq(d,b.u);var e=K("TableLayoutProcessor.doInitialLayout");gm(new fm(new Dv(b.F,c),c.j),b).then(function(a){var f=a.B,h=lk(c.f,f),h=c.u?h.left:h.bottom,h=h+(c.u?-1:1)*En(b,Hn(c)).current;In(c,h)?(Uv(d,f,c),wv(d,c.f),N(e,null)):N(e,a)}.bind(a));return e.result()}function Wv(a,b,c){var d=a.H;d.forEach(function(a,f){a&&(b.insertBefore(a.B,c),"top"===a.b&&(d[f]=null))})}function Xv(a,b){if(a.A&&b){var c=Rv(b);c&&c.forEach(function(a){b.removeChild(a)})}}
function Yv(a,b){var c=a.F,d=Du(c,a),e=d.firstChild;Wv(c,d,e);c.A&&!Rv(d).length&&d.insertBefore(c.A.cloneNode(!0),e);c=new Gv(c,b);c=new fm(c,b.j);d=K("TableFormattingContext.doLayout");gm(c,a).Ba(d);return d.result()}n=Pv.prototype;n.Nd=function(a,b,c){var d=a.F;return Du(d,a)?(c&&Au(a.parent,b),qm(new Zv(d,this),a,b)):Yn(b,a)};n.ff=function(a,b,c,d){return new kv(a,b,c,d)};n.we=function(){return!1};n.Xe=function(){return!1};
n.Ea=function(a,b,c,d){var e=b.F;if("table-row"===b.display){var f=ov(e,b.N);e.h=[];var g;g=b.K?nv(e,f):tv(e,f);if(g.length){var h=K("TableLayoutProcessor.finishBreak"),l=0;ne(function(a){if(l===g.length)P(a);else{var b=g[l++],c=e.ud(b),d=c.Ob().w,h=c.b,k=Ik(h),u=new Nk(Ik(d));e.h.push({pd:k,df:u,Kb:b});h=h.B;Xo(c.b);f<b.rowIndex+b.rowSpan-1&&(h.rowSpan=f-b.rowIndex+1);c.f?O(a):c.Vb.Ea(d,!1,!0).then(function(){var b=e.b;if(b){var f=e.u,g=c.g,h=c.Vb.b.element,k=c.b.B,l=lk(g.f,k),k=ho(g,k);f?(b=l.right-
g.O-b.b(d)-k.right,w(h,"max-width",b+"px")):(b=g.O-b.b(d)-l.top-k.top,w(h,"max-height",b+"px"));w(h,"overflow","hidden")}O(a)})}}).then(function(){Oo(a,b,!1);Xo(b);e.f=[];N(h,!0)});return h.result()}}e.f=[];return Co.Ea(a,b,c,d)};n.ld=function(a,b,c,d){Wo.prototype.ld(a,b,c,d)};function Zv(a,b){pm.call(this);this.A=b;this.b=a}t(Zv,pm);Zv.prototype.j=function(a){var b=this.b.b;return b&&b.j?(a.N===this.b.G&&!a.K&&b&&(b.lc=!1,b.Pc=!1),new $v(this.b)):new aw(this.b,this.A)};
Zv.prototype.g=function(a){pm.prototype.g.call(this,a);Xv(this.b,Du(this.b,a))};Zv.prototype.f=function(a,b){pm.prototype.f.call(this,a,b);this.b.f=[]};function aw(a,b){this.F=a;this.h=b}t(aw,Lu);aw.prototype.b=function(a,b){Lu.prototype.b.call(this,a,b);return Vv(this.h,a,b)};function $v(a){this.F=a}t($v,Mu);$v.prototype.b=function(a,b){var c=this.F.b;if(c&&!Hu(c,a)){var d=new Vu(a);b.l.some(function(a){return d.Ce(a)})||b.l.unshift(d)}return Yv(a,b)};function Vu(a){Cu.call(this,a);this.b=[]}
t(Vu,Cu);n=Vu.prototype;n.bc=function(a,b,c){var d=this.w.F.b;return!d||c.Bb||eo(this.w.B)||!Ku(d)?!0:b&&!a||a&&a.b?!1:!0};n.yd=function(a){return bw(a,this.w.F).some(function(b){return b.ze.some(function(b){return b.yd(a)})})?!0:Cu.prototype.yd.call(this,a)};n.md=function(a,b,c,d){var e=this.w.F;this.b=bw(b,e);this.b.forEach(function(b){b.ze.forEach(function(e){e.md(a,b.Fb,c,d)})});a||(Xv(e,Du(e,this.w)),cw(c));Cu.prototype.md.call(this,a,b,c,d)};
n.Ea=function(a,b){var c=K("finishBreak"),d=this.b.reduce(function(a,b){return a.concat(b.ze.map(function(a){return{Qf:a,Fb:b.Fb}}))},[]),e=0;me(function(){if(e<d.length){var a=d[e++];return a.Qf.Ea(a.Fb,b).sc(!0)}return L(!1)}).then(function(){N(c,!0)});return c.result().fa(function(){return Cu.prototype.Ea.call(this,a,b)}.bind(this))};function cw(a){if(a&&"table-row"===a.display&&a.B)for(;a.B.previousElementSibling;){var b=a.B.previousElementSibling;b.parentNode&&b.parentNode.removeChild(b)}}
function bw(a,b){return dw(a,b).map(function(a){return{ze:a.Tf.Vb.b.l,Fb:a.Fb}})}function dw(a,b){var c=Number.MAX_VALUE;a&&"table-row"===a.display&&(c=ov(b,a.N)+1);for(var c=Math.min(b.f.length,c),d=[],e=0;e<c;e++)b.f[e]&&b.f[e].forEach(function(a){a&&d.push({Tf:a,Fb:a.Ob().w})});return d}function Wu(a,b){var c=a.w.F,d=xv(c,b);return d?yv(c,d):Av(c)}n.Ce=function(a){return a instanceof Vu?this.w.F===a.w.F:!1};var ew=new Pv;
Pd("RESOLVE_FORMATTING_CONTEXT",function(a,b,c){return b?c===wd?(b=a.parent,new Ko(b?b.F:null,a.N)):null:null});Pd("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof Ko?ew:null});Array.from||(Array.from=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e],e):a[e];return c});
...
Object.assign||(Object.assign=function(a,b){if(!b)return a;Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function fw(a){function b(a){return"number"===typeof a?a:null}function c(a){return"string"===typeof a?{url:a,kb:null,nc:null}:{url:a.url,kb:b(a.startPage),nc:b(a.skipPagesBefore)}}return Array.isArray(a)?a.map(c):a?[c(a)]:null}function gw(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}
function hw(a,b){Bj=a.debug;this.g=!1;this.h=a;this.Ib=new Ct(a.window||window,a.viewportElement,"main",this.Rf.bind(this));this.f={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,pageViewMode:"autoSpread",zoom:1,fitToScreen:!1,defaultPaperSize:void 0};b&&this.Hf(b);this.b=new Ta;Object.defineProperty(this,"readyState",{get:function(){return this.Ib.C}})}n=hw.prototype;n.Hf=function(a){var b=Object.assign({a:"configure"},gw(a));this.Ib.A(b);Object.assign(this.f,a)};
n.Rf=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});Ua(this.b,b)};n.jg=function(a,b){this.b.addEventListener(a,b,!1)};n.mg=function(a,b){this.b.removeEventListener(a,b,!1)};n.Xf=function(a,b,c){a||Ua(this.b,{type:"error",content:"No URL specified"});iw(this,a,null,b,c)};n.kg=function(a,b,c){a||Ua(this.b,{type:"error",content:"No URL specified"});iw(this,null,a,b,c)};
function iw(a,b,c,d,e){function f(a){if(a)return a.map(function(a){return{url:a.url||null,text:a.text||null}})}d=d||{};var g=f(d.authorStyleSheet),h=f(d.userStyleSheet);e&&Object.assign(a.f,e);b=Object.assign({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.h.userAgentRootURL,url:fw(b)||c,document:d.documentObject,fragment:d.fragment,authorStyleSheet:g,userStyleSheet:h},gw(a.f));a.g?a.Ib.A(b):(a.g=!0,du(a.Ib,b))}n.Pb=function(){return this.Ib.Pb()};
n.$f=function(a){a:switch(a){case "left":a="ltr"===this.Pb()?"previous":"next";break a;case "right":a="ltr"===this.Pb()?"next":"previous"}this.Ib.A({a:"moveTo",where:a})};n.Zf=function(a){this.Ib.A({a:"moveTo",url:a})};n.lg=function(a){a:{var b=this.Ib;if(!b.g)throw Error("no page exists.");switch(a){case "fit inside viewport":a=Zt(b,b.X.rb?Yt(b,b.j):b.g.f);break a;default:throw Error("unknown zoom type: "+a);}}return a};n.Uf=function(){return this.Ib.ha};ba("vivliostyle.viewer.Viewer",hw);
hw.prototype.setOptions=hw.prototype.Hf;hw.prototype.addListener=hw.prototype.jg;hw.prototype.removeListener=hw.prototype.mg;hw.prototype.loadDocument=hw.prototype.Xf;hw.prototype.loadEPUB=hw.prototype.kg;hw.prototype.getCurrentPageProgression=hw.prototype.Pb;hw.prototype.navigateToPage=hw.prototype.$f;hw.prototype.navigateToInternalUrl=hw.prototype.Zf;hw.prototype.queryZoomFactor=hw.prototype.lg;hw.prototype.getPageSizes=hw.prototype.Uf;ba("vivliostyle.viewer.ZoomType",$t);
$t.FIT_INSIDE_VIEWPORT="fit inside viewport";ba("vivliostyle.viewer.PageViewMode",Bt);Bt.SINGLE_PAGE="singlePage";Bt.SPREAD="spread";Bt.AUTO_SPREAD="autoSpread";ru.call(Gt,"load_vivliostyle","end",void 0);var jw=16,kw="ltr";function lw(a){window.adapt_command(a)}function mw(){lw({a:"moveTo",where:"ltr"===kw?"previous":"next"})}function nw(){lw({a:"moveTo",where:"ltr"===kw?"next":"previous"})}
function ow(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)lw({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)lw({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)lw({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)lw({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)nw(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)mw(),a.preventDefault();else if("0"===b||"U+0030"===c)lw({a:"configure",fontSize:Math.round(jw)}),a.preventDefault();else if("t"===b||"U+0054"===c)lw({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)jw*=1.2,lw({a:"configure",fontSize:Math.round(jw)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)jw/=1.2,lw({a:"configure",
fontSize:Math.round(jw)}),a.preventDefault()}
function pw(a){switch(a.t){case "loaded":a=a.viewer;var b=kw=a.Pb();a.Ld.setAttribute("data-vivliostyle-page-progression",b);a.Ld.setAttribute("data-vivliostyle-spread-view",a.X.rb);window.addEventListener("keydown",ow,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",mw,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",nw,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(ra(location.href,Ha(a||"")));break;case "hyperlink":a.internal&&lw({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+m+"; margin: 0; }",document.head.appendChild(g));du(new Ct(window,k,"main",pw),a)});
