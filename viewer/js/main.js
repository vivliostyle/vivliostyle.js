...
pb.prototype.g=function(a){a.append("/");a.append(this.index.toString());if(this.id||this.Cb)a.append("["),this.id&&a.append(this.id),this.Cb&&(a.append(";s="),a.append(this.Cb)),a.append("]")};
...
rb.prototype.h=function(a){if(0<this.offset&&!a.I){for(var b=this.offset,c=a.node;;){var d=c.nodeType;if(1==d)break;var e=c.nextSibling;if(3<=d&&5>=d){d=c.textContent.length;if(b<=d)break;if(!e){b=d;break}b-=d}if(!e){b=0;break}c=e}a.node=c;a.offset=b}a.Cb=this.Cb;return!0};
...
function Nb(a,b,c,d){this.Pa=b;this.Fb=c;this.N=null;this.cc=function(){return this.N?this.N:this.Z.Db?Math.floor(b/2)-this.Z.Lc:b};this.J=null;this.bc=function(){return this.J?this.J:c};this.u=d;this.ra=null;this.fontSize=function(){return this.ra?this.ra:d};this.Z=yb;this.G={}}function Ob(a,b){a.G[b.u]={};for(var c=0;c<b.children.length;c++)Ob(a,b.children[c])}
...
Zi.prototype.ic=function(a){var b=this.f,c=b.J,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.C)];b.C++;break;case "close-quote":return 0<b.C&&b.C--,c[2*Math.min(d,b.C)+1];case "no-open-quote":return b.C++,new Lc("");case "no-close-quote":return 0<b.C&&b.C--,new Lc("")}return a};
...
a.lang=d.toLowerCase();d=a.sa;var e=a.Rb;a.Pa=++e[e.length-1];e.push(0);var e=a.ra,f=a.Eb=e[e.length-1],g=f[a.j];g||(g=f[a.j]={});g[a.f]=(g[a.f]||0)+1;e.push({});e=a.Qb;null!==e[e.length-1]?a.P=--e[e.length-1]:a.P=null;e.push(null);e=a.Pb;(f=a.wb=e[e.length-1])&&f[a.j]&&f[a.j][a.f]--;e.push({});wj(a);Cj(a,b);e=c.quotes;c=null;e&&(e=e.evaluate(a.l))&&(c=new Wi(a.J),e===J?a.J=[new Lc(""),new Lc("")]:e instanceof Ec&&(a.J=e.values));yj(a,a.F);e=a.X||a.ha||b.getAttribute("name")||"";if(d||e){var h={};
...
n.ne=function(){var a="f"+Kj++;Ij(this,new hi(new Si(a,this.j,null)));this.b=[new Ii(a)];this.j=null};n.Kc=function(){Lj(this);this.h=null;this.C=!1;this.$=0;this.b=[]};n.Kb=function(){var a;0!=this.u?(Hf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.u=1,this.kb={},this.h=null,this.$=0,this.C=!1,this.b=[])};n.error=function(a,b){Ff.prototype.error.call(this,a,b);1==this.u&&(this.u=0)};n.Oc=function(a){Ff.prototype.Oc.call(this,a);this.u=0};
...
function nk(a,b){var c=a.responseXML;if(!c){var d=new DOMParser,e=a.responseText;if(e){var f=mk(a);(c=lk(e,f||"application/xml",d))&&!f&&(f=c.documentElement,"html"!==f.localName.toLowerCase()||f.namespaceURI?"svg"===f.localName.toLowerCase()&&"image/svg+xml"!==c.contentType&&(c=lk(e,"image/svg+xml",d)):c=lk(e,"text/html",d));c||(c=lk(e,"text/html",d))}}c=c?new bk(b,a.url,c):null;return M(c)}function ok(a){this.Ic=a}
...
function Lk(a,b,c,d,e,f,g,h,l){this.b=a;this.element=b;this.f=c;this.ab=d;this.l=e;this.h=f;this.u=g;this.j=h;this.sb=-1;this.g=l}function Mk(a,b){return a.h?!b.h||a.ab>b.ab?!0:a.j:!1}function Nk(a,b){return a.top-b.top}function Ok(a,b){return b.right-a.right}function Pk(a,b){return a===b?!0:a&&b?a.node===b.node&&a.hb===b.hb&&Qk(a.ua,b.ua)&&Qk(a.Ga,b.Ga)&&Pk(a.Da,b.Da):!1}
...
this.D=b?b.D:null;this.u=null;this.va={};this.Ra=1;this.X=this.J=null}function $k(a){a.xa=!0;a.l=a.parent?a.parent.l:0;a.A=null;a.C=null;a.ma=0;a.I=!1;a.display=null;a.V=Zk;a.Aa=null;a.j=null;a.N=null;a.ga=null;a.Y="baseline";a.H=!1;a.lc=a.parent?a.parent.lc:0;a.F=a.parent?a.parent.F:null;a.B=a.parent?a.parent.B:!1;a.g=null;a.G=null;a.Ga=null;a.$c=!1;a.P=!1;a.b=a.parent?a.parent.b:!1;a.Ga=null;a.Oa=null;a.D=a.parent?a.parent.D:null;a.u=null;a.va={};a.Ra=1;a.J=null;a.X=null}
function al(a){var b=new Vk(a.M,a.parent,a.Ia);b.ma=a.ma;b.I=a.I;b.Ga=a.Ga;b.hb=a.hb;b.ua=a.ua;b.Da=a.Da;b.xa=a.xa;b.l=a.l;b.display=a.display;b.V=a.V;b.Aa=a.Aa;b.j=a.j;b.N=a.N;b.ga=a.ga;b.Y=a.Y;b.ha=a.ha;b.ra=a.ra;b.sa=a.sa;b.$c=a.$c;b.P=a.P;b.H=a.H;b.lc=a.lc;b.F=a.F;b.B=a.B;b.g=a.g;b.G=a.G;b.A=a.A;b.C=a.C;b.f=a.f;b.b=a.b;b.wa=a.wa;b.Oa=a.Oa;b.D=a.D;b.u=a.u;b.va=Object.create(a.va);b.Ra=a.Ra;b.J=a.J;b.X=a.X;return b}Vk.prototype.modify=function(){return this.Ca?al(this):this};
...
function wl(a,b,c){a.left=b;a.width=c;x(a.element,"left",b+"px");x(a.element,"width",c+"px")}function xl(a,b,c){a.b?wl(a,b+c*tl(a),c):vl(a,b,c)}function yl(a,b,c){a.b?vl(a,b,c):wl(a,b,c)}function zl(a){a=a.element;for(var b;b=a.lastChild;)a.removeChild(b)}function Al(a){var b=a.F+a.left+a.marginLeft+a.Y,c=a.G+a.top+a.marginTop+a.ga;return new lg(b,c,b+(a.H+a.width+a.X),c+(a.J+a.height+a.P))}function Bl(a,b,c){a=Cl(a);return Og(b,a.U,a.R,a.T-a.U,a.O-a.R,c)}
...
function Zl(a,b,c,d,e,f,g,h){this.ba=a;this.root=a.root;this.ib=c;this.h=d;this.B=f;this.f=this.root;this.P={};this.X={};this.F={};this.H=[];this.C=this.N=this.J=null;this.Ca=g;this.Y=new pj(b,d,g,h);this.g=new Gl;this.u=!0;this.ha=[];this.Pa=e;this.va=this.sa=!1;this.b=a=ek(a,this.root);this.ga={};this.j=new Vl(d);Il(this.g,a);d=$l(this,this.root);Bj(this.Y,this.root,d,a);am(this,d,!1);this.G=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.G=
!1}this.ha.push(!0);this.X={};this.X["e"+a]=d;this.b++;bm(this,-1)}function cm(a,b,c,d){return(b=b[d])&&b.evaluate(a.h)!==c[d]}function dm(a,b,c){for(var d in c){var e=b[d];e?(a.P[d]=e,delete b[d]):(e=c[d])&&(a.P[d]=new V(e,33554432))}}var em=["column-count","column-width","column-fill"];
function am(a,b,c){c||["writing-mode","direction"].forEach(function(a){b[a]&&(this.P[a]=b[a])},a);if(!a.sa){var d=cm(a,b,a.B.j,"background-color")?b["background-color"].evaluate(a.h):null,e=cm(a,b,a.B.j,"background-image")?b["background-image"].evaluate(a.h):null;if(d&&d!==qd||e&&e!==qd)dm(a,b,a.B.j),a.sa=!0}if(!a.va)for(d=0;d<em.length;d++)if(cm(a,b,a.B.u,em[d])){dm(a,b,a.B.u);a.va=!0;break}if(!c&&(c=b["font-size"])){d=c.evaluate(a.h);c=d.K;switch(d.ka){case "em":case "rem":c*=a.h.u;break;case "ex":c*=
...
d.nextSibling);)if(d=d.parentNode,d===a.root)return;d=f}}}function im(a,b){a.J=b;for(var c=0;c<a.H.length;c++)jm(a.J,a.H[c],a.F[a.H[c].b])}
function hm(a,b,c,d,e){var f=0,g=Number.POSITIVE_INFINITY,h=!1,l=!1,k=!1,m=c["flow-options"];if(m){var p;a:{if(h=m.evaluate(a.h,"flow-options")){l=new Jg;try{h.ca(l);p=l.b;break a}catch(q){w.b(q,"toSet:")}}p={}}k=p;h=!!k.exclusive;l=!!k["static"];k=!!k.last}(p=c["flow-linger"])&&(g=Lg(p.evaluate(a.h,"flow-linger"),Number.POSITIVE_INFINITY));(c=c["flow-priority"])&&(f=Lg(c.evaluate(a.h,"flow-priority"),0));c=a.ga[e]||null;p=a.F[b];p||(p=Wl(a.j),p=a.F[b]=new Kk(p?p.pa.b:null));d=new Lk(b,d,e,f,g,h,
l,k,c);a.H.push(d);a.N==b&&(a.N=null);a.J&&jm(a.J,d,p);return d}function km(a,b,c,d){Sl[b]&&(d=a.F[d].b,(!d.length||d[d.length-1]<c)&&d.push(c));a.ga[c]=Ql(a.ga[c],b)}
...
Nl(l)&&(l=Pl(l,"white-space",Ad).toString(),Jk(g,Ik(l))||(f.eb=!1,f.lb=!1)),a.u?Il(a.g,a.b):Jl(a.g,a.b);else{g=a.f;f=$l(a,g);a.ha.push(a.u);Bj(a.Y,g,f,a.b);(l=g.getAttribute("id")||g.getAttributeNS("http://www.w3.org/XML/1998/namespace","id"))&&l===a.C&&(a.C=null);a.G||"body"!=g.localName||g.parentNode!=a.root||(am(a,f,!0),a.G=!0);(l=f["flow-into"])?(l=l.evaluate(e,"flow-into").toString(),h=hm(a,l,f,g,a.b),a.u=!!a.Pa[l],g=a.j.push(f,a.b,g===a.root,h)):g=a.j.push(f,a.b,g===a.root);l=Yl(a.j,g);km(a,
g.g,l,g.b);g.h&&(h=Rl(g.h,"after"),km(a,h,g.h.eb?l:g.offset,g.b));a.u&&Tl(g)===J&&(a.u=!1);if(ek(a.ba,a.f)!=a.b)throw Error("Inconsistent offset");a.X["e"+a.b]=f;a.b++;a.u?Il(a.g,a.b):Jl(a.g,a.b);if(b<a.b&&(0>d&&(d=Kl(a.g,b),d+=c),d<=Hl(a.g)))return Ll(a.g,d)}}}Zl.prototype.l=function(a,b){var c=ek(this.ba,a),d="e"+c;b&&(c=fk(this.ba,a,0,!0));this.b<=c&&gm(this,c,0);return this.X[d]};Zl.prototype.ra=function(){};var lm={"font-style":Ad,"font-variant":Ad,"font-weight":Ad},mm="OTTO"+(new Date).valueOf(),nm=1;function om(a,b){var c={},d;for(d in a)c[d]=a[d].evaluate(b,d);for(var e in lm)c[e]||(c[e]=lm[e]);return c}function pm(a){a=this.vc=a;var b=new Pa,c;for(c in lm)b.append(" "),b.append(a[c].toString());this.f=b.toString();this.src=this.vc.src?this.vc.src.toString():null;this.g=[];this.h=[];this.b=(c=this.vc["font-family"])?c.stringValue():null}
...
function Fn(a,b){b.forEach(function(a){this.children.push(a);fn(a)},a)}function Gn(a){return a.Jc||!!a.parent&&Gn(a.parent)}function Bn(a,b){return Om(b,a.F.toString(),a.direction.toString()||null,Sm)}function Hn(a,b){var c=b.V;if(c!==a.V)Hn(cn(a,c),b);else if(c=Bn(a,b.Aa),"block-end"===c||"snap-block"===c||"inline-end"===c)for(var d=0;d<a.b.length;){var e=a.b[d],f=Bn(a,e.Aa);(f===c||"snap-block"===c&&"block-end"===f)&&e.f(b)?(a.j.push(e),a.b.splice(d,1)):d++}}
...
function Mn(a,b,c,d){function e(a,d,e){if("%"===a.ka)a=e*a.K/100;else{e=a.K;var f=a.ka,g;b:switch(f.toLowerCase()){case "em":case "ex":case "rem":g=!0;break b;default:g=!1}if(g){for(;d&&1!==d.nodeType;)d=d.parentNode;d=parseFloat(Nn(c,d)["font-size"]);a=ei(a,d,b.b).K}else a=(d=Pb(b.b,f,!1))?e*d:a}return a}var f=a.L.F,g=a.L.G,h=Al(a.L),l={top:h.R-g,left:h.U-f,bottom:h.O-g,right:h.T-f,Hc:0,Gc:0},k=a.b;0<k.length&&(l=k.reduce(function(b,c){if(d&&!d(c,a))return b;var f=Bn(a,c.Aa),g=c.b,k=c.Hb[0].ja.j,
...
function zo(a,b){if(b.f&&b.xa&&!b.I&&!b.f.count&&1!=b.A.nodeType){var c=b.A.textContent.match(yo);return Ao(a.j,b,c[0].length)}return M(b)}
function Bo(a,b,c){var d=!1,e=L("buildViewToNextBlockEdge");Ce(function(e){b.A&&!Co(b)&&c.push(Wk(b));zo(a,b).then(function(f){f!==b&&(b=f,Co(b)||c.push(Wk(b)));Do(a,b).then(function(c){if(b=c){if(d||!a.Cc.b(b))d=!0,b=b.modify(),b.wa=!0;uo(a,b)&&!a.b?Eo(a,b).then(function(c){b=c;Gn(a.l)&&(b=null);b?P(e):Q(e)}):b.xa?P(e):Q(e)}else Q(e)})})}).then(function(){O(e,b)});return e.result()}function Do(a,b,c){b=Dm(a.j,b,c);return Fo(b,a)}
function Go(a,b){if(!b.A)return M(b);var c=[],d=b.M,e=L("buildDeepElementView");Ce(function(e){b.A&&b.xa&&!Co(b)?c.push(Wk(b)):(0<c.length&&Ho(a,b,c),c=[]);zo(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.M!=d;)g=g.parent;if(!g){b=f;Q(e);return}Co(f)||c.push(Wk(f))}Do(a,f).then(function(c){(b=c)&&b.M!=d?a.Cc.b(b)?P(e):(b=b.modify(),b.wa=!0,a.u?Q(e):P(e)):Q(e)})})}).then(function(){0<c.length&&Ho(a,b,c);O(e,b)});return e.result()}
...
m.top-m.bottom+"px");x(d,"position","absolute");x(d,"display",b.display);l=null;if(k)if(k.P)l=k;else a:{for(k=k.parent;k;){if(k.P){l=k;break a}k=k.parent}l=null}l?(m=l.A.ownerDocument.createElement("div"),m.style.position="absolute",l.b?m.style.right="0":m.style.left="0",m.style.top="0",l.A.appendChild(m),k=Hk(a.f,m),l.A.removeChild(m)):k={left:(a.b?a.ra:a.va)-a.H,right:(a.b?a.C:a.ib)+a.X,top:(a.b?a.va:a.C)-a.J};(l?l.b:a.b)?x(d,"right",k.right-g.T+"px"):x(d,"left",g.U-k.left+"px");x(d,"top",g.R-k.top+
...
a.parentNode.removeChild(a)});O(l,!h)});return l.result()}function Xo(a,b){var c=b.A.parentNode,d=c.ownerDocument.createElement("span");d.setAttribute("data-adapt-spec","1");"footnote"===b.Aa&&Yo(a.j,b,"footnote-call",d);c.appendChild(d);c.removeChild(b.A);c=b.modify();c.I=!0;c.A=d;return c}
...
function fp(a,b){for(var c=0,d=0,e=b.length-1;0<=e;e--){var f=b[e];if(!f.I||!f.A||1!=f.A.nodeType)break;f=No(a,f.A);f=a.b?-f.left:f.bottom;0<f?c=Math.max(c,f):d=Math.min(d,f)}return c-d}
...
e*(h-a.C)+l;return b}function lp(a,b){var c=b;do c=c.parent;while(c&&c.xa);return c?(c=Wk(c).modify(),c.I=!0,go(c,a.f,0,a.b)):NaN}function kp(a,b){var c=b.findIndex(function(a){return a.wa});if(0>c)return{oc:NaN,Cf:null};var d=b[c];return{oc:Lo(a,null,b,c,d.Ia),Cf:d}}Hm.prototype.Ja=function(a,b,c){var d=io(a.D).Ja(this,a,b,c);d||(d=mp.Ja(this,a,b,c));return d};
Hm.prototype.Yb=function(){var a=null,b=null,c,d=0;do{c=d;for(var d=Number.MAX_VALUE,e=this.N.length-1;0<=e&&!b;--e){var a=this.N[e],b=a.f(this,c),f=a.b();f>c&&(d=Math.min(d,f))}}while(d>c&&!b&&this.Fb);return{yb:b?a:null,w:b}};
...
f():rp(h,p,null,!0,m)&&(b=(h.u?p||b:b).modify(),b.wa=!0);Q(a);return}!g||pp(g.paddingTop)&&pp(g.borderTopWidth)||(k=!1,r=[]);z=!0}}}while(0);d=Do(h,b,k);if(d.Wa()){d.then(function(c){b=c;P(a)});return}b=d.get()}rp(h,p,r,!h.u,m)?p&&h.u&&(b=p.modify(),b.wa=!0):Sl[m]&&(h.g=m);Q(a)}).then(function(){p&&(h.vb=cl(p));O(l,b)});return l.result()}
...
new hl(cl(b));O(e,c)}else O(e,null)})})})});return e.result()}function Cp(a,b){var c=L("doFinishBreakOfFragmentLayoutConstraints"),d=[].concat(a.B);d.sort(function(a,b){return a.oe()-b.oe()});var e=0;Be(function(){return e<d.length?d[e++].Ja(b,a).Ac(!0):M(!1)}).then(function(){O(c,!0)});return c.result()}
...
function Up(a,b){var c=a.f[b],d=a.h[b];d||(d=a.h[b]=[]);for(var e=!1,f=0;f<a.g.length;){var g=a.g[f];g.zc===b?(g.ld=!0,a.g.splice(f,1),c&&(e=c.indexOf(g),0<=e&&c.splice(e,1)),d.push(g),e=!0):f++}e||Vp(a,b,!0)}function Vp(a,b,c){a.u.some(function(a){return a.zc===b})||a.u.push(new Np(b,c))}
...
function aq(a,b){var c=[];Object.keys(b.b).forEach(function(a){(a=this.f[a])&&(c=c.concat(a))},a);c.sort(function(a,b){return a.S-b.S||a.aa-b.aa});var d=[],e=null;c.forEach(function(a){e&&e.S===a.S&&e.aa===a.aa?e.Qd.push(a):(e={S:a.S,aa:a.aa,Fe:a.Fe,Qd:[a]},d.push(e))});return d}function bq(a,b){a.H.push(a.g);a.g=b}function Sp(a,b,c,d){"pages"===b&&a.He.push({Fc:d,format:c})}function cq(a){return a.N.bind(a)}
Wp.prototype.N=function(a,b,c){return 0<=this.He.findIndex(function(b){return b.Fc===a})?(c=c.createElement("span"),c.textContent=b,c.setAttribute("data-vivliostyle-pages-counter",a.g),c):null};function dq(a,b){var c=a.b.page[0];Array.from(b.root.querySelectorAll("[data-vivliostyle-pages-counter]")).forEach(function(a){var b=a.getAttribute("data-vivliostyle-pages-counter"),d=this.He.findIndex(function(a){return a.Fc.g===b});a.textContent=this.He[d].format([c])},a)}
...
function Jq(a,b,c){var d=Z(a,b,"margin-bottom"),e=Z(a,b,"padding-bottom"),f=Z(a,b,"border-bottom-width");a=Z(a,b,"height")-c.wb;x(c.element,"height",a+"px");x(c.element,"margin-bottom",d+"px");x(c.element,"padding-bottom",e+"px");x(c.element,"border-bottom-width",f+"px");c.height=a-c.wb;c.marginBottom=d;c.Ca=f;c.P=e}function Kq(a,b,c){a.b?(Iq(a,b,c),Jq(a,b,c)):(Hq(a,b,c),Gq(a,b,c))}
...
function sr(a,b,c,d,e){var f=a.b;d=Sj(d,f,a.u,a.f);b=Qj(d,f,b);c=Rj(d,f,c);Wj(d,e,b,c,function(b,c){var d=c.evaluate(f,b);"font-family"==b&&(d=sm(a.J,d));return d});var g=Ul(e.display||rd,e.position,e["float"],a.M===a.ba.root);["display","position","float"].forEach(function(a){g[a]&&(e[a]=g[a])});return b}
...
f.getAttribute("data-math-typeset")&&(I=!0);var qb;I?qb=a.g(f,a.w.parent?a.w.parent.A:null,k):qb=M(null);qb.then(function(g){g?I&&(d="true"==g.getAttribute("data-adapt-process-children")):g=Er(a,Da,N);"a"==N&&g.addEventListener("click",a.page.J,!1);ja&&(Yo(a,a.w,"inner",ja),g.appendChild(ja));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&ir(g);var h=a.w.h["image-resolution"],l=[],m=k.width,p=k.height,q=f.getAttribute("width"),r=f.getAttribute("height"),m=m===Wc||!m&&!q,p=
...
ts.prototype.ve=function(){var a=this.style;a.top=new F(-1,"px");a["margin-top"]=Zd;a["border-top-width"]=Zd;a["padding-top"]=Zd;a["padding-bottom"]=Zd;a["border-bottom-width"]=Zd;a["margin-bottom"]=Zd;a.bottom=Zd};ts.prototype.ga=function(a,b,c){b=b.H;var d={start:this.u.marginLeft,end:this.u.marginRight,ta:this.u.Ec},e={start:this.u.marginTop,end:this.u.marginBottom,ta:this.u.Dc};ws(this,b.top,!0,d,a,c);ws(this,b.bottom,!0,d,a,c);ws(this,b.left,!1,e,a,c);ws(this,b.right,!1,e,a,c)};
...
function Bs(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=Cs(d,g.length?new zs(g):null,b);g.ub&&(f.center=g.ub);d=g.ub||d.f();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=Cs(c,e,b),c.ub&&(f.start=c.ub),c.ud&&(f.end=c.ud);return f}
function Cs(a,b,c){var d={ub:null,ud:null};if(a&&b)if(a.b()&&b.b()){var e=a.g(),f=b.g();0<e&&0<f?(f=e+f,f<c?d.ub=c*e/f:(a=a.h(),b=b.h(),b=a+b,b<c?d.ub=a+(c-b)*(e-a)/(f-b):0<b&&(d.ub=c*a/b)),0<d.ub&&(d.ud=c-d.ub)):0<e?d.ub=c:0<f&&(d.ud=c)}else a.b()?d.ub=Math.max(c-b.f(),0):b.b()&&(d.ud=Math.max(c-a.f(),0));else a?a.b()&&(d.ub=c):b&&b.b()&&(d.ud=c);return d}ts.prototype.dc=function(a,b,c,d,e){ts.hg.dc.call(this,a,b,c,d,e);b.element.setAttribute("data-vivliostyle-page-box",!0)};
function us(a,b){rq.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.Dc=this.Ec=null}v(us,rq);
...
d["padding-bottom"]=new G(c.marginBottom)};us.prototype.ue=function(){var a=Ds(this,{start:"left",end:"right",ta:"width"});this.Ec=a.Af;this.marginLeft=a.Tf;this.marginRight=a.Sf};us.prototype.ve=function(){var a=Ds(this,{start:"top",end:"bottom",ta:"height"});this.Dc=a.Af;this.marginTop=a.Tf;this.marginBottom=a.Sf};
...
f]=new G(new Ib(a,function(){var a=d(this).nb;return null===a?0:a},"margin-"+f));e["margin-"+g]=new G(new Ib(a,function(){var a=d(this).ob;return null===a?0:a},"margin-"+g));"left"===f?e.left=new G(y(a,c.marginLeft,c.Ec)):"top"===f&&(e.top=new G(y(a,c.marginTop,c.Dc)))}n.ue=function(){var a=this.g.u;this.u.Ta?Es(this,{xe:"right",Ee:"left",ta:"width"},a):this.u.Ua?Es(this,{xe:"left",Ee:"right",ta:"width"},a):this.Ba({start:"left",end:"right",ta:"width"},a)};
...
function Fs(a,b,c,d,e){this.b=a;this.l=b;this.h=c;this.f=d;this.g=e;this.j={};a=this.l;b=new sc(a,"page-number");b=new kc(a,new qc(a,b,new Gb(a,2)),a.b);c=new ac(a,b);a.values["recto-page"]=c;a.values["verso-page"]=b;"ltr"===Yr(this.g)?(a.values["left-page"]=b,b=new ac(a,b),a.values["right-page"]=b):(c=new ac(a,b),a.values["left-page"]=c,a.values["right-page"]=b)}function Gs(a){var b={};vj(a.b,[],"",b);Fj(a.b);return b}
function Hs(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof V?""+e.value:Hs(a,e);c.push(d+f+(e.ab||""))}return c.sort().join("^")}function Is(a,b,c){c=c.clone({fc:"vivliostyle-page-rule-master"});var d=c.b,e=b.size;if(e){var f=ds(b),e=e.ab;d.width=Uh(a.f,d.width,new V(f.width,e));d.height=Uh(a.f,d.height,new V(f.height,e))}["counter-reset","counter-increment"].forEach(function(a){d[a]&&(b[a]=d[a])});c=c.h(a.h);c.l(a.b,a.g);Uq(c,a.f);return c}
...
function Rs(a){var b;a.g||a.F.length?b=[a.g].concat(a.F.sort()):b=null;a.H.push({lf:b,$:a.$});a.g="";a.F=[]}n.Kc=function(){Rs(this);Hj.prototype.Kc.call(this)};n.Ha=function(){Rs(this);Hj.prototype.Ha.call(this)};
...
function at(a,b){var c=a.b.element;b.zb.forEach(function(a){c.appendChild(a.element)});Fn(a.B,b.og)}function bt(a){var b=a[a.length-1];if(!b.Mc||(a=a[a.length-2])&&b.Mc>=a.Mc)return!1;a=b.dd.zb;b=Math.max.apply(null,a.map(function(a){return a.h}));a=Math.max.apply(null,a.map(function(a){return $n(a.l)}));return b>a+1}function ct(a,b){var c=Math.max.apply(null,a[a.length-1].dd.zb.map(function(a){return isNaN(a.ef)?a.h:a.h-a.ef+1}))-1;c<Vs(b)?Us(b,c):Us(b,Vs(b)-1)}
...
function nt(a,b,c,d,e,f,g,h,l,k,m){Nb.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.ba=b;this.lang=b.lang||c;this.viewport=d;this.l={body:!0};this.g=e;this.B=this.b=this.H=this.f=this.F=null;this.C=0;this.wb=f;this.j=new rm(this.style.B);this.va={};this.X=null;this.h=m;this.Eb=new an(null,null,null,null,null,null,null);this.P={};this.sa=null;this.ib=g;this.vb=h;this.Y=l;this.qb=k;for(var p in a.h)(b=a.h[p]["flow-consume"])&&(b.evaluate(this,"flow-consume")==Uc?this.l[p]=!0:delete this.l[p]);
this.Ca={};this.ha=this.ga=0}v(nt,Nb);
...
c.clone();h=a;l=h.b.page;k=void 0;for(k in h.b.b)for(var m=h.b.b[k],p=m.b.length-1;0<=p;p--){var q=m.b[p];0>q.pa.sb&&q.pa.f<h.C&&(q.pa.sb=l)}Ob(a,a.style.b);h=Eq(f,a,"enabled");if(!h||h===Vd){c=a;w.debug("Location - page",c.b.page);w.debug("  current:",d);w.debug("  lookup:",c.C);d=void 0;for(d in c.b.b)for(e=t(c.b.b[d].b),g=e.next();!g.done;g=e.next())w.debug("  Chunk",d+":",g.value.pa.f);d=a.X;e=f;f=b;c=e.f;Object.keys(f).length?(e=c,g=Hs(d,f),e=e.j+"^"+g,g=d.j[e],g||("background-host"===c.fc?(c=
d,f=(new ps(c.l,c.h.f,f)).h(c.h),f.l(c.b,c.g),Uq(f,c.f),g=f):g=Is(d,f,c),d.j[e]=g),f=g.f,f.f.g=f,f=g):(c.f.g=c,f=e);return f}}throw Error("No enabled page masters");}function lt(a,b){var c=a.B.f,d=c[b.b].f;if(d){var e=b.f,f=c[d].b;if(!f.length||e<f[0])return!1;var c=Xa(f.length,function(a){return f[a]>e})-1,c=f[c],d=a.B.b[d],g=pt(a,d);return c<g?!1:g<c?!0:!kt(a,d.g)}return!1}function st(a,b,c){a=a.b.f[c];a.D||(a.D=new to(null));b.ff=a.D}
function tt(a){var b=a.l,c=un(b),d=L("layoutDeferredPageFloats"),e=!1,f=0;Ce(function(d){if(f===c.length)Q(d);else{var g=c[f++],l=g.ja,k=jn(l),m=k.rf(l,b);m&&Zm(m,l)?P(d):kn(b,l)||wn(b,l)?(vn(b,g),Q(d)):Vo(a,g,k,null,m).then(function(a){a?(a=Gn(b.parent))?Q(d):(Gn(b)&&!a&&(e=!0,b.Jc=!1),P(d)):Q(d)})}}).then(function(){e&&mn(b);O(d,!0)});return d.result()}
...
k.selected.pa)&&(k.selected=p,k.index=l)}k.pa=k.selected.pa;k.Ka=!0;Jm(b,k.selected.b,h,d.f).then(function(a){return function(c){if(Gn(b.l))Q(e);else if(h=!1,a.selected.pa.u&&(null===c||a.pa.h)&&f.push(a.index),a.pa.h)g.push(a.index),Q(e);else{var k=!!c||!!b.g,l;0<xn(b.l).length&&b.vb?c?(l=c.clone(),l.f=b.vb):l=new hl(b.vb):l=null;if(b.g&&l)a.selected.b=l,d.f=b.g,b.g=null;else{g.push(a.index);if(c||l)a.selected.b=c||l,f.push(a.index);b.g&&(d.g=zm(b.g))}k?Q(e):(b.Fb=!1,a.Ka?a.Ka=!1:P(e))}}}(k));if(k.Ka){k.Ka=
...
function xt(a,b,c,d,e,f,g,h,l,k){function m(){p.b=q.clone();return yt(p,b,c,d,e,f,g,r,h,l,k,z).fa(function(a){return a?M({zb:a,position:p.b}):M(null)})}var p=a,q=p.b.clone(),r=wt(p,g,c,h,l),z=!0;return m().fa(function(a){if(!a)return M(null);if(1>=k)return M(a.zb);var b=Eq(c,p,"column-fill")||Xc,b=ht(k,b,m,r,h,a.zb,p.b.b[l]);if(!b)return M(a.zb);z=!1;g.g=!0;r.g=!0;return Ys(b,a).fa(function(a){g.g=!1;g.Jc=!1;r.g=!1;p.b=a.position;return M(a.zb)})})}
...
function At(a){var b=a.b.page,c;for(c in a.b.b)for(var d=a.b.b[c],e=d.b.length-1;0<=e;e--){var f=d.b[e];0<=f.pa.sb&&f.pa.sb+f.pa.l-1<=b&&d.b.splice(e,1)}}function Bt(a,b){for(var c in a.l){var d=b.b[c];if(d&&0<d.b.length)return!1}return!0}
...
Cn(h);Gn(h)?(a.b=a.B.clone(),h.Jc=!1,P(c)):Q(c)})}).then(function(){e.ga(a,b,a.g);var d=new sc(e.f.f,"left-page");b.l=d.evaluate(a)?"left":"right";At(a);c=a.b;Object.keys(c.b).forEach(function(b){b=c.b[b];var d=b.f;!d||"page"!==d&&kt(a,d)||(b.f=null)});a.b=a.B=null;c.g=a.f.b;Gk(b,a.style.j.N[a.ba.url],a.g);Bt(a,c)&&(c=null);O(l,c)});return l.result()}
function Dt(a,b,c){a.N=b.cc;a.J=b.bc;a.ha=b.cc+2*b.ke;a.ga=b.bc+2*b.ke;c.L.style.width=a.ha+"px";c.L.style.height=a.ga+"px";c.g.style.left=b.Ub+"px";c.g.style.right=b.Ub+"px";c.g.style.top=b.Ub+"px";c.g.style.bottom=b.Ub+"px";c.g.style.padding=b.Tb+"px";c.g.style.paddingTop=b.Tb+1+"px"}function Et(a,b,c,d){Hj.call(this,a.j,a,b,c,d,a.h,!c);this.g=a;this.F=!1}v(Et,Hj);n=Et.prototype;n.Xd=function(){};
...
function Xt(a,b){this.h=a;this.l=this.f=this.b=this.j=this.g=null;this.C=b;this.B=null;this.P={};this.lang=null;this.F=0;this.J={};this.X=this.N=this.Y=null;this.G={};this.H=null;this.u=ju(this);hu()&&(Gh["http://www.w3.org/1998/Math/MathML"]=!0)}
...
function ou(a,b){return ke("resolveFragment",function(c){if(b){var d=new sb;tb(d,b);var e;if(a.g){var f=ub(d,a.g.b);if(1!=f.node.nodeType||f.I||!f.kd){O(c,null);return}var g=f.node,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.f[h]){O(c,null);return}e=a.f[h];d=f.kd}else e=a.b[0];a.h.load(e.src).then(function(a){var b=ub(d,a.b);a=fk(a,b.node,b.offset,b.I);O(c,{S:e.S,Na:a,aa:-1})})}else O(c,null)},function(a,d){w.b(d,"Cannot resolve fragment:",b);O(a,null)})}
...
function zu(a,b,c){var d=L("findPage");xu(a,b.S).then(function(e){if(e){var f=null,g;Ce(function(d){var h=yu(b,e);g=h.aa;(f=e.Bb[g])?Q(d):e.complete?(g=e.gb.length-1,f=e.Bb[g],Q(d)):c?Au(a,h).then(function(a){a&&(f=a.page);Q(d)}):Ae(100).then(function(){P(d)})}).then(function(){O(d,ru(f,g))})}else O(d,null)});return d.result()}
function Au(a,b){var c=L("renderPage");xu(a,b.S).then(function(d){if(d){var e=yu(b,d),f=e.aa,g=e.Na,h=d.Bb[f];h?O(c,ru(h,f)):Ce(function(b){if(f<d.gb.length)Q(b);else if(d.complete)f=d.gb.length-1,Q(b);else{var c=d.gb[d.gb.length-1];vu(a,d,c).then(function(a){var e=a.Pd.page;(c=a.Wf)?0<=g&&qt(d.fb,c)>g?(h=e,f=d.gb.length-2,Q(b)):P(b):(h=e,f=a.Pd.position.aa,d.complete=!0,Q(b))})}}).then(function(){h=h||d.Bb[f];var b=d.gb[f];h?O(c,ru(h,f)):vu(a,d,b).then(function(a){a.Wf||(d.complete=!0);O(c,a.Pd)})})}else O(c,
...
function xu(a,b){if(b>=a.b.b.length)return M(null);var c=a.xc[b];if(c)return M(c);var d=L("getPageViewItem"),e=a.l[b];if(e){var f=ue(d);e.push(f);return d.result()}var e=a.l[b]=[],g=a.b.b[b],h=a.b.h;h.load(g.src).then(function(f){g.b||1!=a.b.b.length||(g.b=Math.ceil(gk(f)/2700),a.b.F=g.b);var k=h.f[f.url],l=a.Ae(f),p=a.viewport,q=mt(k,p.width,p.height,p.fontSize);if(q.width!=p.width||q.height!=p.height||q.fontSize!=p.fontSize)p=new Wr(p.window,q.fontSize,p.root,q.width,q.height);q=a.xc[b-1];null!==
g.sb?q=g.sb-1:(q=q?q.fb.Y+q.Bb.length:0,null!==g.wc&&(q+=g.wc));Xp(a.f,q);var r=new nt(k,f,a.b.lang,p,a.h,a.j,l,a.b.G,q,a.b.u,a.f);r.Z=a.Z;ot(r).then(function(){c={item:g,ba:f,fb:r,gb:[null],Bb:[],complete:!1};a.xc[b]=c;O(d,c);e.forEach(function(a){a.pb(c)})})});return d.result()}function Ju(a){for(var b=t(a.xc),c=b.next();!c.done;c=b.next())(c=c.value)&&c.Bb.splice(0);for(a=a.viewport.root;a.lastChild;)a.removeChild(a.lastChild)}
function Ku(a){return a.xc.some(function(a){return a&&0<a.Bb.length})}
n.Sd=function(){var a=this.b,b=a.N||a.Y;if(!b)return M(null);var c=L("showTOC");this.g||(this.g=new Qt(a.h,b.src,a.lang,this.h,this.j,this.Z,this,a.G,a.u,this.f));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background=
...
(this.viewport=null,this.Z.Lc=a.pageBorder,this.Xa=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=a.zoom,this.ac=!0);"boolean"==typeof a.fitToScreen&&a.fitToScreen!==this.F&&(this.F=a.fitToScreen,this.ac=!0);"object"==typeof a.defaultPaperSize&&"number"==typeof a.defaultPaperSize.width&&"number"==typeof a.defaultPaperSize.height&&(this.viewport=null,this.Z.mc=a.defaultPaperSize,this.Xa=!0);Vu(this,a);return M(!0)};
...
Mu.prototype.va=function(a){var b=this;"complete"!==this.B&&Pu(this,"loading");if("string"==typeof a.where){switch(a.where){case "next":a=this.Z.Db?this.b.Ag:this.b.nextPage;break;case "previous":a=this.Z.Db?this.b.Dg:this.b.Ie;break;case "last":a=this.b.ug;break;case "first":a=this.b.rg;break;default:return M(!0)}if(a){var c=a;a=function(){return c.call(b.b,b.f)}}}else if("number"==typeof a.epage){var d=a.epage;a=function(){return Eu(b.b,d)}}else if("string"==typeof a.url){var e=a.url;a=function(){return Gu(b.b,
...
return b.result()});a.J=function(){var a=d;a&&(d=null,a.pb())};a.u=function(b){if(c)return!1;c=mv(b);a.J();return!0};a.window.adapt_command=a.u};function Or(a,b,c){if(a==b)return a?[[0,a]]:[];if(0>c||a.length<c)c=null;var d=ov(a,b),e=a.substring(0,d);a=a.substring(d);b=b.substring(d);var d=pv(a,b),f=a.substring(a.length-d);a=a.substring(0,a.length-d);b=b.substring(0,b.length-d);a=qv(a,b);e&&a.unshift([0,e]);f&&a.push([0,f]);rv(a);null!=c&&(a=sv(a,c));return a}
function qv(a,b){var c;if(!a)return[[1,b]];if(!b)return[[-1,a]];c=a.length>b.length?a:b;var d=a.length>b.length?b:a,e=c.indexOf(d);if(-1!=e)return c=[[1,c.substring(0,e)],[0,d],[1,c.substring(e+d.length)]],a.length>b.length&&(c[0][0]=c[2][0]=-1),c;if(1==d.length)return[[-1,a],[1,b]];var f=tv(a,b);if(f)return d=f[1],e=f[3],c=f[4],f=Or(f[0],f[2]),d=Or(d,e),f.concat([[0,c]],d);a:{c=a.length;for(var d=b.length,e=Math.ceil((c+d)/2),f=2*e,g=Array(f),h=Array(f),l=0;l<f;l++)g[l]=-1,h[l]=-1;g[e+1]=0;h[e+1]=
...
function tv(a,b){function c(a,b,c){for(var d=a.substring(c,c+Math.floor(a.length/4)),e=-1,f="",g,h,k,l;-1!=(e=b.indexOf(d,e+1));){var m=ov(a.substring(c),b.substring(e)),K=pv(a.substring(0,c),b.substring(0,e));f.length<K+m&&(f=b.substring(e-K,e)+b.substring(e,e+m),g=a.substring(0,c-K),h=a.substring(c+m),k=b.substring(0,e-K),l=b.substring(e+m))}return 2*f.length>=a.length?[g,h,k,l,f]:null}var d=a.length>b.length?a:b,e=a.length>b.length?b:a;if(4>d.length||2*e.length<d.length)return null;var f=c(d,e,
...
function Lw(a,b){if(!b)return null;var c=null,d=0;a:for(;d<a.f.length;d++)if(a.f[d])for(var e=0;e<a.f[d].length;e++)if(a.f[d][e]&&b===a.f[d][e].ec.ya){c=a.g[d].b[e];break a}if(!c)return null;for(;d<a.l.length;d++)for(;e<a.l[d].length;e++){var f=a.l[d][e];if(f.Vb===c)return{rowIndex:f.rowIndex,Qa:f.Qa}}return null}function Mw(a,b){var c=[];return a.l.reduce(function(d,e,f){if(f>=b.rowIndex)return d;e=a.Kd(e[b.Qa].Vb);if(!e||c.includes(e))return d;Nw(e.ec.ya,d);c.push(e);return d},[])}
function Ow(a){var b=[];a.g.forEach(function(c){c.b.forEach(function(c,e){b[e]||(b[e]={Df:[],elements:[]});var d=b[e],g=a.Kd(c);g&&!d.Df.includes(g)&&(Nw(g.ec.ya,d.elements),d.Df.push(g))})});return[new Pw(b.map(function(a){return a.elements}))]}function Nw(a,b){a.B.forEach(function(a){a instanceof Ov&&b.push(a.w.D.b);a instanceof gw&&hw(a,null).forEach(function(a){b.push(a)})})}n.Te=function(){return[].concat(this.h)};n.Se=function(a){this.h=a};function Pw(a){this.f=a}
Pw.prototype.b=function(a){return Qw(this,a,function(a){return a.current})};Pw.prototype.F=function(a){return Qw(this,a,function(a){return a.Be})};function Qw(a,b,c){var d=0;a.f.forEach(function(a){a=lo(b,a);d=Math.max(d,c(a))});return d}function Rw(a,b){this.D=a;this.h=b;this.rowIndex=-1;this.Qa=0;this.g=!1;this.f=[]}v(Rw,Em);n=Rw.prototype;
n.sd=function(a){var b=this.D,c=rw(a,b,this.h);if(c)return c;Sw(this,a);var c=a.w,d=b.b;switch(c.display){case "table":b.P=c.ra;break;case "table-caption":b.H.push(new yw(c.A,c.ha));break;case "table-header-group":return d.rc||(this.b=!0,Rv(d,c)),M(!0);case "table-footer-group":return d.qc||(this.b=!0,Sv(d,c)),M(!0);case "table-row":this.b||(this.g=!0,this.rowIndex++,this.Qa=0,b.g[this.rowIndex]=new tw(this.rowIndex,c.M),d.g||(d.g=c.M))}return Em.prototype.sd.call(this,a)};
n.kc=function(a){var b=this.D,c=a.w,d=c.display,e=this.h.f;Sw(this,a);if(c.M===b.F)d=Nn(e,Pv(b,c)),b.N=parseFloat(d[b.u?"height":"width"]),b.b.J=a.cd&&a.cd.M,a.Mb=!0;else switch(d){case "table-header-group":case "table-footer-group":if(this.b)return this.b=!1,M(!0);break;case "table-row":this.b||(b.C=c.A,this.g=!1);break;case "table-cell":if(!this.b){this.g||(this.rowIndex++,this.Qa=0,this.g=!0);d=this.rowIndex;c=new vw(this.rowIndex,this.Qa,c.A);e=b.g[d];e||(b.g[d]=new tw(d,null),e=b.g[d]);e.b.push(c);
for(var e=d+c.rowSpan,f=Iw(b,d),g=0;f[g];)g++;for(;d<e;d++)for(var f=Iw(b,d),h=g;h<g+c.f;h++){var l=f[h]=new ww(d,h,c);c.b||(c.b=l)}this.Qa++}}return Em.prototype.kc.call(this,a)};n.pf=function(a){Tw(this,a)};n.xf=function(a){Tw(this,a)};n.eg=function(a){Tw(this,a)};n.wf=function(a){Tw(this,a)};function Tw(a,b){var c=b.w;c&&c.A&&!Co(c)&&a.f.push(c.clone())}function Sw(a,b){0<a.f.length&&Ho(a.h,b.w,a.f);a.f=[]}
function Uw(a,b){this.$b=!0;this.D=a;this.f=b;this.l=!1;this.b=-1;this.g=0;this.u=b.u;b.u=!1}v(Uw,Em);var Vw={"table-caption":!0,"table-column-group":!0,"table-column":!0};
function Ww(a,b,c,d){var e=b.rowIndex,f=b.Qa,g=c.A;if(1<b.f){x(g,"box-sizing","border-box");for(var h=a.D.J,l=0,k=0;k<b.f;k++)l+=h[b.b.Qa+k];l+=a.D.P*(b.f-1);x(g,a.D.u?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new xw(a.f,b,c);a=a.D;(g=a.f[e])||(g=a.f[e]=[]);g[f]=c;1===d.f.oa.length&&d.f.I&&(c.f=!0);return Im(c.ec,d).Ac(!0)}function Xw(a,b){var c=a.D.h[0];return c?c.Vb.b.Qa===b:!1}
function Yw(a){var b=a.D.h;if(!b.length)return[];var c=[],d=0;do{var e=b[d],f=e.Vb.rowIndex;if(f<a.b){var g=c[f];g||(g=c[f]=[]);g.push(e);b.splice(d,1)}else d++}while(d<b.length);return c}
function Zw(a,b){var c=a.D,d=Yw(a),e=d.reduce(function(a){return a+1},0);if(0===e)return M(!0);var f=a.f.j,g=b.w;g.A.parentNode.removeChild(g.A);var h=L("layoutRowSpanningCellsFromPreviousFragment"),l=M(!0),k=0,m=[];d.forEach(function(a){var b=this;l=l.fa(function(){var d=Uk(a[0].Ad.oa[1],g.parent);return xo(f,d,!1).fa(function(){function g(a){for(;l<a;){if(!m.includes(l)){var b=d.A.ownerDocument.createElement("td");x(b,"padding","0");d.A.appendChild(b)}l++}}var h=M(!0),l=0;a.forEach(function(a){var b=
this;h=h.fa(function(){var c=a.Vb;g(c.b.Qa);var h=a.Ad,p=Uk(h.oa[0],d);p.ma=h.ma;p.I=h.I;p.Ra=h.oa[0].Ra+1;return xo(f,p,!1).fa(function(){for(var d=a.Bf,f=0;f<c.f;f++)m.push(l+f);l+=c.f;return Ww(b,c,p,d).fa(function(){p.A.rowSpan=c.rowIndex+c.rowSpan-b.b+e-k;return M(!0)})})})},b);return h.fa(function(){g(Jw(c));k++;return M(!0)})})})},a);l.then(function(){xo(f,g,!0,b.xd).then(function(){O(h,!0)})});return h.result()}
function $w(a,b){if(a.j||a.h)return M(!0);var c=b.w,d=a.D;0>a.b?a.b=Dw(d,c.M):a.b++;a.g=0;a.l=!0;return Zw(a,b).fa(function(){ax(a);rp(a.f,b.cd,null,!0,b.Wc)&&!Cw(d,a.b-1).length&&(a.f.u=a.u,c.wa=!0,b.Mb=!0);return M(!0)})}function ax(a){a.D.g[a.b].b.forEach(function(b){var c=a.D.h[b.Qa];c&&c.Vb.b.Qa==b.b.Qa&&(b=c.Ad.oa[0],c=ek(a.f.j.ba,b.node),Ar(c,b.Ra+1,1))})}
...
Uw.prototype.fg=function(a){var b=rw(a,this.D,this.f);if(b)return b;var b=a.w,c=this.D.b,d=b.display;return"table-header-group"===d&&c&&c.B===b.M?(this.j=!0,M(!0)):"table-footer-group"===d&&c&&c.l===b.M?(this.h=!0,M(!0)):"table-row"===d?$w(this,a):"table-cell"===d?bx(this,a):M(!0)};Uw.prototype.Hf=function(a){a=a.w;"table-row"===a.display&&(this.l=!1,this.j||this.h||(a=Wk(a).modify(),a.I=!1,this.f.N.push(new Ew(this.b,a,this.D))));return M(!0)};
Uw.prototype.kc=function(a){var b=a.w,c=this.D.b,d=b.display;"table-header-group"===d?c&&!c.h&&c.B===b.M?(this.j=!1,b.A.parentNode.removeChild(b.A)):x(b.A,"display","table-row-group"):"table-footer-group"===d&&(c&&!c.h&&c.l===b.M?(this.h=!1,b.A.parentNode.removeChild(b.A)):x(b.A,"display","table-row-group"));if(d&&Vw[d])b.A.parentNode.removeChild(b.A);else if(b.M===this.D.F)b.wa=qp(this.f,b,null),this.f.u=this.u,a.Mb=!0;else return Em.prototype.kc.call(this,a);return M(!0)};var pw=[];
function cx(){}function dx(a,b,c,d){for(var e=a.ownerDocument,f=e.createElement("tr"),g=[],h=0;h<b;h++){var l=e.createElement("td");f.appendChild(l);g.push(l)}a.parentNode.insertBefore(f,a.nextSibling);b=g.map(function(a){a=Hk(d,a);return c?a.height:a.width});a.parentNode.removeChild(f);return b}function ex(a){var b=[];for(a=a.firstElementChild;a;)"colgroup"===a.localName&&b.push(a),a=a.nextElementSibling;return b}
...
function rx(a,b){return tx(a,b).map(function(a){return{Cd:a.sg.ec.ya.B,yb:a.yb}})}function tx(a,b){var c=Number.MAX_VALUE;a&&"table-row"===a.display&&(c=Dw(b,a.M)+1);for(var c=Math.min(b.f.length,c),d=[],e=0;e<c;e++)b.f[e]&&b.f[e].forEach(function(a){a&&d.push({sg:a,yb:a.Yb().w})});return d}function hw(a,b){var c=a.w.D,d=Lw(c,b);return d?Mw(c,d):Ow(c)}n.me=function(a){return a instanceof gw?this.w.D===a.w.D:!1};var ux=new cx;
de("RESOLVE_FORMATTING_CONTEXT",function(a,b,c){return b?c===Ld?(b=a.parent,new vp(b?b.D:null,a.M)):null:null});de("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof vp?ux:null});Array.from||(Array.from=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e],e):a[e];return c});
...
function xx(a,b){Xj=a.debug;this.g=!1;this.h=a;this.Sb=new Mu(a.window||window,a.viewportElement,"main",this.qg.bind(this));this.f={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,pageViewMode:"autoSpread",zoom:1,fitToScreen:!1,defaultPaperSize:void 0};b&&this.dg(b);this.b=new db;Object.defineProperty(this,"readyState",{get:function(){return this.Sb.B}})}n=xx.prototype;n.dg=function(a){var b=Object.assign({a:"configure"},wx(a));this.Sb.u(b);Object.assign(this.f,a)};
...
function yx(a,b,c,d,e){function f(a){if(a)return a.map(function(a){return{url:a.url||null,text:a.text||null}})}d=d||{};var g=f(d.authorStyleSheet),h=f(d.userStyleSheet);e&&Object.assign(a.f,e);b=Object.assign({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.h.userAgentRootURL,url:vx(b)||c,document:d.documentObject,fragment:d.fragment,authorStyleSheet:g,userStyleSheet:h},wx(a.f));a.g?a.Sb.u(b):(a.g=!0,nv(a.Sb,b))}n.Zb=function(){return this.Sb.Zb()};
n.yg=function(a){a:switch(a){case "left":a="ltr"===this.Zb()?"previous":"next";break a;case "right":a="ltr"===this.Zb()?"next":"previous"}this.Sb.u({a:"moveTo",where:a})};n.xg=function(a){this.Sb.u({a:"moveTo",url:a})};n.Lg=function(a){a:{var b=this.Sb;if(!b.g)throw Error("no page exists.");switch(a){case "fit inside viewport":a=iv(b,b.Z.Db?hv(b,b.j):b.g.f);break a;default:throw Error("unknown zoom type: "+a);}}return a};n.tg=function(){return this.Sb.ga};na("vivliostyle.viewer.Viewer",xx);
xx.prototype.setOptions=xx.prototype.dg;xx.prototype.addListener=xx.prototype.Jg;xx.prototype.removeListener=xx.prototype.Mg;xx.prototype.loadDocument=xx.prototype.vg;xx.prototype.loadEPUB=xx.prototype.Kg;xx.prototype.getCurrentPageProgression=xx.prototype.Zb;xx.prototype.navigateToPage=xx.prototype.yg;xx.prototype.navigateToInternalUrl=xx.prototype.xg;xx.prototype.queryZoomFactor=xx.prototype.Lg;xx.prototype.getPageSizes=xx.prototype.tg;na("vivliostyle.viewer.ZoomType",jv);
jv.FIT_INSIDE_VIEWPORT="fit inside viewport";na("vivliostyle.viewer.PageViewMode",Lu);Lu.SINGLE_PAGE="singlePage";Lu.SPREAD="spread";Lu.AUTO_SPREAD="autoSpread";Dv.call(Qu,"load_vivliostyle","end",void 0);var zx=16,Ax="ltr";function Bx(a){window.adapt_command(a)}function Cx(){Bx({a:"moveTo",where:"ltr"===Ax?"previous":"next"})}function Dx(){Bx({a:"moveTo",where:"ltr"===Ax?"next":"previous"})}
function Ex(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)Bx({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)Bx({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)Bx({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)Bx({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)Dx(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)Cx(),a.preventDefault();else if("0"===b||"U+0030"===c)Bx({a:"configure",fontSize:Math.round(zx)}),a.preventDefault();else if("t"===b||"U+0054"===c)Bx({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)zx*=1.2,Bx({a:"configure",fontSize:Math.round(zx)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)zx/=1.2,Bx({a:"configure",
fontSize:Math.round(zx)}),a.preventDefault()}
...
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(Fa(location.href,Ta(a||"")));break;case "hyperlink":a.internal&&Bx({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+m+"; margin: 0; }",document.head.appendChild(g));nv(new Mu(window,k,"main",Fx),a)});
...
},{"../models/viewer-options":11,"../utils/key-util":15,"knockout":1}],20:[function(require,module,exports){
/*
 * Copyright 2015 Trim-marks Inc.
 *
 * This file is part of Vivliostyle UI.
