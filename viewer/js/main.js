 ...
 *
 * Vivliostyle core 2017.2.1-pre.20170303002808
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
if(!c)throw Error("E_CFI_NUMBER_EXPECTED");e+=c[0].length;g=parseInt(c[1],10);(h=c[4])&&(h=ab(h));var l=c[7];l&&(l=ab(l));c=bb(c[10]);f.push(new eb(g,h,l,sa(c.s)));break;case "!":e++;f.push(new cb);break;case "~":case "@":case "":a.na=f;return;default:throw Error("E_CFI_PARSE_ERROR");}}function hb(a,b){for(var c={node:b.documentElement,offset:0,M:!1,ob:null,Gc:null},d=0;d<a.na.length;d++)if(!a.na[d].h(c)){++d<a.na.length&&(c.Gc=new fb,c.Gc.na=a.na.slice(d));break}return c}
...
function Ab(a,b,c,d){this.Xa=b;this.Cb=c;this.O=null;this.Nb=function(){return this.O?this.O:this.aa.pb?Math.floor(b/2)-this.aa.ic:b};this.J=null;this.Mb=function(){return this.J?this.J:c};this.w=d;this.ta=null;this.fontSize=function(){return this.ta?this.ta:d};this.aa=lb;this.G={}}function Bb(a,b){a.G[b.w]={};for(var c=0;c<b.A.length;c++)Bb(a,b.A[c])}
...
e}else if(null!=f&&!c)return!!f;return!1}function Gb(a){this.b=a;this.h="_"+rb++}p=Gb.prototype;p.toString=function(){var a=new Da;this.ua(a,0);return a.toString()};p.ua=function(){throw Error("F_ABSTRACT");};p.fb=function(){throw Error("F_ABSTRACT");};p.Ta=function(){return this};p.Wb=function(a){return a===this};function Hb(a,b,c,d){var e=d[a.h];if(null!=e)return e===mb?!1:e;d[a.h]=mb;b=a.Wb(b,c,d);return d[a.h]=b}
p.evaluate=function(a){var b;b=(b=a.G[this.b.w])?b[this.h]:void 0;if("undefined"!=typeof b)return b;b=this.fb(a);var c=this.h,d=this.b,e=a.G[d.w];e||(e={},a.G[d.w]=e);return e[c]=b};p.fe=function(){return!1};function Ib(a,b){Gb.call(this,a);this.f=b}t(Ib,Gb);p=Ib.prototype;p.Wd=function(){throw Error("F_ABSTRACT");};p.be=function(){throw Error("F_ABSTRACT");};p.fb=function(a){a=this.f.evaluate(a);return this.be(a)};p.Wb=function(a,b,c){return a===this||Hb(this.f,a,b,c)};
p.ua=function(a,b){10<b&&a.append("(");a.append(this.Wd());this.f.ua(a,10);10<b&&a.append(")")};p.Ta=function(a,b){var c=this.f.Ta(a,b);return c===this.f?this:new this.constructor(this.b,c)};function Jb(a,b,c){Gb.call(this,a);this.f=b;this.g=c}t(Jb,Gb);p=Jb.prototype;p.Qc=function(){throw Error("F_ABSTRACT");};p.Oa=function(){throw Error("F_ABSTRACT");};p.mb=function(){throw Error("F_ABSTRACT");};p.fb=function(a){var b=this.f.evaluate(a);a=this.g.evaluate(a);return this.mb(b,a)};
p.Wb=function(a,b,c){return a===this||Hb(this.f,a,b,c)||Hb(this.g,a,b,c)};p.ua=function(a,b){var c=this.Qc();c<=b&&a.append("(");this.f.ua(a,c);a.append(this.Oa());this.g.ua(a,c);c<=b&&a.append(")")};p.Ta=function(a,b){var c=this.f.Ta(a,b),d=this.g.Ta(a,b);return c===this.f&&d===this.g?this:new this.constructor(this.b,c,d)};function Kb(a,b,c){Jb.call(this,a,b,c)}t(Kb,Jb);Kb.prototype.Qc=function(){return 1};function Lb(a,b,c){Jb.call(this,a,b,c)}t(Lb,Jb);Lb.prototype.Qc=function(){return 2};
...
jc.prototype.fb=function(a){return Fb(a,this.name.name,this.value)};jc.prototype.Wb=function(a,b,c){return a===this||Hb(this.value,a,b,c)};jc.prototype.Ta=function(a,b){var c=this.value.Ta(a,b);return c===this.value?this:new jc(this.b,this.name,c)};function kc(a,b){Gb.call(this,a);this.index=b}t(kc,Gb);kc.prototype.ua=function(a){a.append("$");a.append(this.index.toString())};kc.prototype.Ta=function(a,b){var c=b[this.index];if(!c)throw Error("Parameter missing: "+this.index);return c};
function lc(a,b,c){return b===a.h||b===a.b||c==a.h||c==a.b?a.h:b===a.j||b===a.f?c:c===a.j||c===a.f?b:new Qb(a,b,c)}function w(a,b,c){return b===a.b?c:c===a.b?b:new $b(a,b,c)}function x(a,b,c){return b===a.b?new Pb(a,c):c===a.b?b:new ac(a,b,c)}function mc(a,b,c){return b===a.b||c===a.b?a.b:b===a.f?c:c===a.f?b:new bc(a,b,c)}function nc(a,b,c){return b===a.b?a.b:c===a.f?b:new cc(a,b,c)};var oc={};function pc(){}p=pc.prototype;p.Sb=function(a){for(var b=0;b<a.length;b++)a[b].ba(this)};p.Rd=function(){throw Error("E_CSS_EMPTY_NOT_ALLOWED");};p.Sd=function(){throw Error("E_CSS_SLASH_NOT_ALLOWED");};p.Oc=function(){throw Error("E_CSS_STR_NOT_ALLOWED");};p.Rb=function(){throw Error("E_CSS_IDENT_NOT_ALLOWED");};p.qc=function(){throw Error("E_CSS_NUMERIC_NOT_ALLOWED");};p.oc=function(){throw Error("E_CSS_NUM_NOT_ALLOWED");};p.nc=function(a){return this.oc(a)};
p.pd=function(){throw Error("E_CSS_COLOR_NOT_ALLOWED");};p.rc=function(){throw Error("E_CSS_URL_NOT_ALLOWED");};p.ub=function(){throw Error("E_CSS_LIST_NOT_ALLOWED");};p.Qb=function(){throw Error("E_CSS_COMMA_NOT_ALLOWED");};p.zb=function(){throw Error("E_CSS_FUNC_NOT_ALLOWED");};p.mc=function(){throw Error("E_CSS_EXPR_NOT_ALLOWED");};function qc(){}t(qc,pc);p=qc.prototype;
p.Sb=function(a){for(var b=null,c=0;c<a.length;c++){var d=a[c],e=d.ba(this);if(b)b[c]=e;else if(d!==e){b=Array(a.length);for(d=0;d<c;d++)b[d]=a[d];b[c]=e}}return b||a};p.Oc=function(a){return a};p.Rb=function(a){return a};p.Sd=function(a){return a};p.qc=function(a){return a};p.oc=function(a){return a};p.nc=function(a){return a};p.pd=function(a){return a};p.rc=function(a){return a};p.ub=function(a){var b=this.Sb(a.values);return b===a.values?a:new rc(b)};
p.Qb=function(a){var b=this.Sb(a.values);return b===a.values?a:new sc(b)};p.zb=function(a){var b=this.Sb(a.values);return b===a.values?a:new tc(a.name,b)};p.mc=function(a){return a};function uc(){}p=uc.prototype;p.toString=function(){var a=new Da;this.Ma(a,!0);return a.toString()};p.stringValue=function(){var a=new Da;this.Ma(a,!1);return a.toString()};p.ra=function(){throw Error("F_ABSTRACT");};p.Ma=function(a){a.append("[error]")};p.ee=function(){return!1};p.Xb=function(){return!1};p.ge=function(){return!1};
...
Ac.prototype.ra=function(a){return new tb(a,this.lc)};Ac.prototype.Ma=function(a,b){b?(a.append('"'),a.append(Ga(this.lc)),a.append('"')):a.append(this.lc)};Ac.prototype.ba=function(a){return a.Oc(this)};function Bc(a){this.name=a;if(oc[a])throw Error("E_INVALID_CALL");oc[a]=this}t(Bc,uc);Bc.prototype.ra=function(a){return new tb(a,this.name)};Bc.prototype.Ma=function(a,b){b?a.append(Fa(this.name)):a.append(this.name)};Bc.prototype.ba=function(a){return a.Rb(this)};Bc.prototype.Ie=function(){return!0};
function C(a){var b=oc[a];b||(b=new Bc(a));return b}function D(a,b){this.I=a;this.ga=b.toLowerCase()}t(D,uc);D.prototype.ra=function(a,b){return this.I?b&&"%"==this.ga?100==this.I?b:new bc(a,b,new tb(a,this.I/100)):new ec(a,this.I,this.ga):a.b};D.prototype.Ma=function(a){a.append(this.I.toString());a.append(this.ga)};D.prototype.ba=function(a){return a.qc(this)};D.prototype.Xb=function(){return!0};function Cc(a){this.I=a}t(Cc,uc);
...
c.replace(/(.*);.*$/,"$1")}else l.responseXML=g.responseXML,l.contentType=g.responseXML.contentType;h.eb(l)}};try{d?(g.setRequestHeader("Content-Type",e||"text/plain; charset=UTF-8"),g.send(d)):g.send(null)}catch(k){u.b(k,"Error fetching "+a),h.eb(l)}return M(f)}function Ye(a){var b=window.WebKitBlobBuilder||window.MSBlobBuilder;if(b){for(var b=new b,c=0;c<a.length;c++)b.append(a[c]);return b.getBlob("application/octet-stream")}return new Blob(a,{type:"application/octet-stream"})}
function Ze(a){var b=I("readBlob"),c=new FileReader,d=$d(b,c);c.addEventListener("load",function(){d.eb(c.result)},!1);c.readAsArrayBuffer(a);return M(b)}function $e(a,b){this.Y=a;this.type=b;this.h={};this.j={}}$e.prototype.load=function(a,b,c){a=la(a);var d=this.h[a];return"undefined"!=typeof d?L(d):this.fetch(a,b,c).get()};
...
function bf(a){a=a.responseText;return L(a?JSON.parse(a):null)};function cf(a){var b=parseInt(a,16);if(isNaN(b))throw Error("E_CSS_COLOR");if(6==a.length)return new Ec(b);if(3==a.length)return new Ec(b&15|(b&15)<<4|(b&240)<<4|(b&240)<<8|(b&3840)<<8|(b&3840)<<12);throw Error("E_CSS_COLOR");}function df(a){this.f=a;this.Za="Author"}p=df.prototype;p.zc=function(){return null};p.ha=function(){return this.f};p.error=function(){};p.kc=function(a){this.Za=a};p.yb=function(){};p.ud=function(){};p.Ec=function(){};p.Fc=function(){};p.Bd=function(){};p.Sc=function(){};
p.Gb=function(){};p.sd=function(){};p.qd=function(){};p.xd=function(){};p.hc=function(){};p.tb=function(){};p.gd=function(){};p.Ic=function(){};p.ld=function(){};p.ed=function(){};p.kd=function(){};p.jc=function(){};p.Pd=function(){};p.ac=function(){};p.fd=function(){};p.jd=function(){};p.hd=function(){};p.Lc=function(){};p.Kc=function(){};p.wa=function(){};p.rb=function(){};p.Hb=function(){};p.Jc=function(){};p.Uc=function(){};
...
k);continue}g.Gb();case 4:if(34==Ve(h,1).type)switch(S(h),S(h),k=R(h),k.type){case 1:g.yb(null,k.text);a.b=f?pf:T;S(h);break;case 36:g.yb(null,null);a.b=f?pf:T;S(h);break;default:a.b=vf,g.error("E_CSS_NAMESPACE",k)}else g.yb(a.J,null),a.b=f?pf:T,S(h);continue;case 5:k.b&&g.Gb();case 6:g.Bd(k.text);a.b=f?pf:T;S(h);continue;case 7:k.b&&g.Gb();case 8:g.ud(k.text);a.b=f?pf:T;S(h);continue;case 55:k.b&&g.Gb();case 14:S(h);k=R(h);b:switch(k.type){case 1:g.Ec(k.text,null);S(h);a.b=f?pf:T;continue;case 6:m=
...
null);a.b=f?pf:T;S(h);continue;case 6:if(m=k.text,S(h),n=Ef(a),k=R(h),11==k.type){g.Fc(m,n);a.b=f?pf:T;S(h);continue}}g.error("E_CSS_PSEUDOELEM_SYNTAX",k);a.b=vf;continue;case 9:k.b&&g.Gb();case 10:S(h);k=R(h);if(1==k.type)m=k.text,S(h);else if(36==k.type)m=null,S(h);else if(34==k.type)m="";else{a.b=xf;g.error("E_CSS_ATTR",k);S(h);continue}k=R(h);if(34==k.type){n=m?a.V[m]:m;if(null==n){a.b=xf;g.error("E_CSS_UNDECLARED_PREFIX",k);S(h);continue}S(h);k=R(h);if(1!=k.type){a.b=xf;g.error("E_CSS_ATTR_NAME_EXPECTED",
...
function og(a,b){if(!a.length)return b;for(var c=b.N,d,e=a.length-1;0<=e&&!(d=a[e],e===a.length-1&&d.N<b.N)&&!(d.R<b.N&&d.U-.1<=b.U&&d.T+.1>=b.T);e--)c=Math.min(c,d.R);for(var f=Math.min(c,d.N);0<=e&&!(d=a[e],d.N<=b.R||d.U-.1>b.U||d.T+.1<b.T);e--)f=d.R;f=Math.max(f,b.R);return c<=f?null:new Rf(b.U,f,b.T,c)};function pg(){this.b={}}t(pg,pc);pg.prototype.Rb=function(a){this.b[a.name]=!0;return a};pg.prototype.ub=function(a){this.Sb(a.values);return a};function qg(a){this.value=a}t(qg,pc);qg.prototype.nc=function(a){this.value=a.I;return a};function rg(a,b){if(a){var c=new qg(b);try{return a.ba(c),c.value}catch(d){u.b(d,"toInt: ")}}return b}function sg(){this.f=!1;this.b=[];this.name=null}t(sg,pc);sg.prototype.qc=function(a){this.f&&this.b.push(a);return null};
sg.prototype.oc=function(a){this.f&&!a.I&&this.b.push(new D(0,"px"));return null};sg.prototype.ub=function(a){this.Sb(a.values);return null};sg.prototype.zb=function(a){this.f||(this.f=!0,this.Sb(a.values),this.f=!1,this.name=a.name.toLowerCase());return null};
...
p.Sd=function(a){return this.b&2048?a:null};p.Oc=function(a){return this.b&2?a:null};p.Rb=function(a){var b=this.f[a.name.toLowerCase()];return b?b:this.b&4?a:null};p.qc=function(a){return a.I||this.b&512?0>a.I&&!(this.b&256)?null:this.g[a.ga]?a:null:"%"==a.ga&&this.b&1024?a:null};p.oc=function(a){return a.I?0>=a.I&&!(this.b&256)?null:this.b&16?a:null:this.b&512?a:null};p.nc=function(a){return a.I?0>=a.I&&!(this.b&256)?null:this.b&48?a:(a=this.f[""+a.I])?a:null:this.b&512?a:null};
p.pd=function(a){return this.b&64?a:null};p.rc=function(a){return this.b&128?a:null};p.ub=function(){return null};p.Qb=function(){return null};p.zb=function(){return null};p.mc=function(){return null};var Bg=new Dg(0,U,U);
...
k.ba(f.b);if(m){if(m!==k&&b===e)for(e=[],k=0;k<g;k++)e[k]=b[k];b!==e&&(e[g-d]=m);g++;f=f.h}else f=f.g}}return f===a.b&&(c?0<e.length:g==b.length)?e:null}p=Gg.prototype;p.kb=function(a){for(var b=null,c=this.f;c!==this.b&&c!==this.g;)a?c.f?c=c.h:(b=a.ba(c.b))?(a=null,c=c.h):c=c.g:c=c.g;return c===this.b?b:null};p.Rd=function(a){return this.kb(a)};p.Sd=function(a){return this.kb(a)};p.Oc=function(a){return this.kb(a)};p.Rb=function(a){return this.kb(a)};p.qc=function(a){return this.kb(a)};p.oc=function(a){return this.kb(a)};
p.nc=function(a){return this.kb(a)};p.pd=function(a){return this.kb(a)};p.rc=function(a){return this.kb(a)};p.ub=function(){return null};p.Qb=function(){return null};p.zb=function(a){return this.kb(a)};p.mc=function(){return null};function Ig(a){Gg.call(this,a)}t(Ig,Gg);Ig.prototype.ub=function(a){var b=Hg(this,a.values,!1,0);return b===a.values?a:b?new rc(b):null};
...
Og.prototype.b=function(a,b,c){var d=b;if(this.le)if(a[b]==xc){if(++b==a.length)return d}else return d;var e=this.f[0].b(a,b,c);if(e==b)return d;b=e;for(d=1;d<this.f.length&&b<a.length;d++){e=this.f[d].b(a,b,c);if(e==b)break;b=e}return b};function Pg(){this.b=this.ib=null;this.error=!1;this.values={};this.f=null}p=Pg.prototype;p.clone=function(){var a=new this.constructor;a.ib=this.ib;a.b=this.b;a.f=this.f;return a};p.Vd=function(a,b){this.ib=a;this.b=b};p.cc=function(){this.error=!0;return 0};
function Qg(a,b){a.cc([b]);return null}p.Rd=function(a){return Qg(this,a)};p.Oc=function(a){return Qg(this,a)};p.Rb=function(a){return Qg(this,a)};p.qc=function(a){return Qg(this,a)};p.oc=function(a){return Qg(this,a)};p.nc=function(a){return Qg(this,a)};p.pd=function(a){return Qg(this,a)};p.rc=function(a){return Qg(this,a)};p.ub=function(a){this.cc(a.values);return null};p.Qb=function(){this.error=!0;return null};p.zb=function(a){return Qg(this,a)};p.mc=function(){this.error=!0;return null};
function Rg(){Pg.call(this)}t(Rg,Pg);Rg.prototype.cc=function(a){for(var b=0,c=0;b<a.length;){var d=this.ib[c].b(a,b,this);if(d>b)b=d,c=0;else if(++c==this.ib.length){this.error=!0;break}}return b};function Sg(){Pg.call(this)}t(Sg,Pg);Sg.prototype.cc=function(a){if(a.length>this.ib.length||!a.length)return this.error=!0,0;for(var b=0;b<this.ib.length;b++){for(var c=b;c>=a.length;)c=1==c?0:c-2;if(this.ib[b].b(a,c,this)!=c+1)return this.error=!0,0}return a.length};function Tg(){Pg.call(this)}t(Tg,Pg);
...
var th=sh({before:"right",after:"left",start:"top",end:"bottom"}),uh=sh({before:"top",after:"bottom",start:"left",end:"right"});function V(a,b){this.value=a;this.Va=b}p=V.prototype;p.Ce=function(){return this};p.Vc=function(a){a=this.value.ba(a);return a===this.value?this:new V(a,this.Va)};p.Ee=function(a){return a?new V(this.value,this.Va+a):this};p.evaluate=function(a,b){return Qf(a,this.value,b)};p.qe=function(){return!0};function vh(a,b,c){V.call(this,a,b);this.W=c}t(vh,V);
vh.prototype.Ce=function(){return new V(this.value,this.Va)};vh.prototype.Vc=function(a){a=this.value.ba(a);return a===this.value?this:new vh(a,this.Va,this.W)};vh.prototype.Ee=function(a){return a?new vh(this.value,this.Va+a,this.W):this};vh.prototype.qe=function(a){return!!this.W.evaluate(a)};function wh(a,b,c){return(!b||c.Va>b.Va)&&c.qe(a)?c.Ce():b}var xh={"region-id":!0};function yh(a){return"_"!=a.charAt(0)&&!xh[a]}function zh(a,b,c){c?a[b]=c:delete a[b]}
...
function Ni(a,b,c,d){this.A=a;this.l=b;this.sc=c;this.Xa=d;this.h=[[],[]];this.w={};this.G=this.F=this.b=null;this.xa=this.fa=this.X=this.j=this.f="";this.Y=this.O=null;this.ta=this.Sa=!0;this.g={};this.H=[{}];this.J=[new Ac("\u201c"),new Ac("\u201d"),new Ac("\u2018"),new Ac("\u2019")];this.C=0;this.lang="";this.Cb=[0];this.La=0;this.ka=[{}];this.wb=this.ka[0];this.V=null;this.Ab=[this.V];this.Bb=[{}];this.vb=this.ka[0];this.xb=[]}function li(a,b){a.w[b]=(a.w[b]||0)+1}
function Oi(a,b,c){(b=b[c])&&b.apply(a)}var Pi=[];function Qi(a,b,c,d){a.b=null;a.F=d;a.j="";a.f="";a.X="";a.fa="";a.G=b;a.xa="";a.O=Pi;a.Y=c;Ri(a)}function Si(a,b,c){a.g[b]?a.g[b].push(c):a.g[b]=[c];c=a.H[a.H.length-1];c||(c={},a.H[a.H.length-1]=c);c[b]=!0}
...
Si(a,k,0),h=a.g[k],h[h.length-1]+=d[k];c===id&&(c=a.g["ua-list-item"],b["ua-list-item-count"]=new V(new Cc(c[c.length-1]),0));a.H.push(null)}function Ui(a){var b=a.H.pop();if(b)for(var c in b)(b=a.g[c])&&(1==b.length?delete a.g[c]:b.pop())}function qi(a,b,c){Ti(a,b);b.content&&(b.content=b.content.Vc(new vi(a,c,a.Xa)));Ui(a)}var Vi="before transclusion-before footnote-call footnote-marker inner first-letter first-line  transclusion-after after".split(" ");
...
a.lang=d.toLowerCase();var d=a.ta,e=a.Cb;a.La=++e[e.length-1];e.push(0);var e=a.ka,f=a.wb=e[e.length-1],g=f[a.j];g||(g=f[a.j]={});g[a.f]=(g[a.f]||0)+1;e.push({});e=a.Ab;null!==e[e.length-1]?a.V=--e[e.length-1]:a.V=null;e.push(null);e=a.Bb;(f=a.vb=e[e.length-1])&&f[a.j]&&f[a.j][a.f]--;e.push({});Ri(a);Xi(a,b);e=c.quotes;c=null;e&&(e=e.evaluate(a.l))&&(c=new si(a.J),e===F?a.J=[new Ac(""),new Ac("")]:e instanceof rc&&(a.J=e.values));Ti(a,a.F);e=a.X||a.fa||b.getAttribute("name")||"";if(d||e){var h={};
...
Ni.prototype.pop=function(){for(var a=1;-1<=a;--a)for(var b=this.h[this.h.length-a-2],c=0;c<b.length;)b[c].pop(this,a)?b.splice(c,1):c++;this.h.pop();this.Sa=!1};var $i=null;function aj(a,b,c,d,e,f,g){jf.call(this,a,b,g);this.b=null;this.Z=0;this.h=this.Ua=null;this.A=!1;this.W=c;this.j=d?d.j:$i?$i.clone():new Mi;this.F=e;this.w=f;this.l=0}t(aj,kf);aj.prototype.Ge=function(a){Lh(this.j.Mc,"*",a)};function bj(a,b){var c=Dh(a.b,b);c!==b&&c.g(a.j)||a.Ge(c)}
...
d?e=new Th(a,b):(u.b("Unsupported :: attr selector op:",d),e=new hi(""));break;default:u.b("Unsupported attr selector:",c),e=new hi("")}this.b.push(e)};var dj=0;p=aj.prototype;p.Gb=function(){var a="d"+dj++;bj(this,new Ih(new ki(a)));this.b=[new hi(a)]};p.sd=function(){var a="c"+dj++;bj(this,new Ih(new mi(a)));this.b=[new hi(a)]};p.qd=function(){var a="a"+dj++;bj(this,new Ih(new ni(a)));this.b=[new hi(a)]};p.xd=function(){var a="f"+dj++;bj(this,new Ih(new oi(a)));this.b=[new hi(a)]};
p.hc=function(){ej(this);this.h=null;this.A=!1;this.Z=0;this.b=[]};p.tb=function(){var a;0!=this.l?(mf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.l=1,this.Ua={},this.h=null,this.Z=0,this.A=!1,this.b=[])};p.error=function(a,b){kf.prototype.error.call(this,a,b);1==this.l&&(this.l=0)};p.kc=function(a){kf.prototype.kc.call(this,a);this.l=0};p.wa=function(){ej(this);kf.prototype.wa.call(this);1==this.l&&(this.l=0)};p.Hb=function(){kf.prototype.Hb.call(this)};
function ej(a){if(a.b){var b=a.Z+a.j.ie();bj(a,a.Le(b));a.b=null;a.h=null;a.A=!1;a.Z=0}}p.Le=function(a){var b=this.F;this.A&&(b=b?"xxx-bogus-xxx":"footnote");return new Jh(this.Ua,a,this.h,b)};p.rb=function(a,b,c){gh(this.w,a,b,c,this)};p.Ac=function(a,b){lf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};p.nd=function(a,b){lf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
p.sb=function(a,b,c){"display"!=a||b!==md&&b!==ld||(this.sb("flow-options",new rc([Wc,rd]),c),this.sb("flow-into",b,c),b=Mc);(Jd.SIMPLE_PROPERTY||[]).forEach(function(d){d=d({name:a,value:b,important:c});a=d.name;b=d.value;c=d.important});var d=c?ef(this):ff(this);zh(this.Ua,a,this.W?new vh(b,d,this.W):new V(b,d))};p.Jc=function(a){switch(a){case "not":a=new fj(this),a.tb(),hf(this.ja,a)}};function fj(a){aj.call(this,a.f,a.ja,a.W,a,a.F,a.w,!1);this.parent=a;this.g=a.b}t(fj,aj);p=fj.prototype;
...
gj.prototype.rb=function(a,b){if(this.f.values[a])this.error("E_CSS_NAME_REDEFINED "+a,this.zc());else{var c=a.match(/height|^(top|bottom)$/)?"vh":"vw",c=new ec(this.f,100,c),c=b.ra(this.f,c);this.f.values[a]=c}};function hj(a,b,c,d,e){jf.call(this,a,b,!1);this.Ua=d;this.W=c;this.b=e}t(hj,kf);hj.prototype.rb=function(a,b,c){c?u.b("E_IMPORTANT_NOT_ALLOWED"):gh(this.b,a,b,c,this)};hj.prototype.Ac=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};
hj.prototype.nd=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};hj.prototype.sb=function(a,b,c){c=c?ef(this):ff(this);c+=this.order;this.order+=Ki;zh(this.Ua,a,this.W?new vh(b,c,this.W):new V(b,c))};function ij(a,b){Jf.call(this,a);this.Ua={};this.b=b;this.order=0}t(ij,Jf);ij.prototype.rb=function(a,b,c){gh(this.b,a,b,c,this)};ij.prototype.Ac=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};ij.prototype.nd=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};
...
var zj={If:"text/html",Jf:"text/xml",vf:"application/xml",uf:"application/xhtml_xml",Cf:"image/svg+xml"};function Aj(a,b,c){c=c||new DOMParser;var d;try{d=c.parseFromString(a,b)}catch(e){}if(d){a=d.documentElement;if("parsererror"===a.localName)return null;for(a=a.firstChild;a;a=a.nextSibling)if("parsererror"===a.localName)return null}else return null;return d}
...
function Wj(a,b,c){Object.keys(a.b).forEach(function(a){for(var b=this.b[a],c=0;c<b.length;)this.K.contains(b[c])?c++:b.splice(c,1);b.length||delete this.b[a]},a);for(var d=a.w,e=0;e<d.length;e++){var f=d[e];v(f.target,f.name,f.value.toString())}e=Xj(c,a.K);a.f.width=e.width;a.f.height=e.height;for(e=0;e<b.length;e++)if(c=b[e],f=a.b[c.Gc],d=a.b[c.jf],f&&d&&(f=Rj(f,c.action)))for(var g=0;g<d.length;g++)d[g].addEventListener(c.event,f,!1)}
...
function bk(a,b,c,d,e,f,g,h,l){this.b=a;this.element=b;this.f=c;this.Va=d;this.l=e;this.h=f;this.mf=g;this.j=h;this.hb=-1;this.g=l}function ck(a,b){return a.h?!b.h||a.Va>b.Va?!0:a.j:!1}function dk(a,b){return a.top-b.top}function ek(a,b){return b.right-a.right}
function fk(a,b){if(a===b)return!0;if(!a||!b||a.ia!==b.ia||a.M!==b.M||a.na.length!==b.na.length)return!1;for(var c=0;c<a.na.length;c++){var d=a[c],e=b[c];if(!(d===e||d&&e&&d.node===e.node&&d.Wa===e.Wa&&d.qa===e.qa&&d.Aa===e.Aa&&d.va===e.va))return!1}return!0}function gk(a){return{na:[{node:a.S,Wa:hk,qa:a.qa,Aa:null,va:null}],ia:0,M:!1,Ka:a.Ka}}function ik(a,b){var c=new jk(a.node,b,0);c.Wa=a.Wa;c.qa=a.qa;c.Aa=a.Aa;c.va=a.va?ik(a.va,kk(b)):null;c.L=a.L;return c}var hk=0;
function lk(a,b,c,d,e,f,g){this.ja=a;this.Ld=d;this.oe=null;this.root=b;this.ea=c;this.type=f;e&&(e.oe=this);this.b=g}function mk(a,b){this.kf=a;this.count=b}
function jk(a,b,c){this.S=a;this.parent=b;this.pa=c;this.ia=0;this.M=!1;this.Wa=hk;this.qa=b?b.qa:null;this.va=this.Aa=null;this.fa=!1;this.Da=!0;this.b=!1;this.l=b?b.l:0;this.display=null;this.H=nk;this.V=this.A=this.j=null;this.O="baseline";this.X="top";this.rd=this.Y=0;this.G=!1;this.Tb=b?b.Tb:0;this.h=b?b.h:null;this.w=b?b.w:!1;this.J=this.yc=!1;this.C=this.D=this.F=this.g=null;this.qb=b?b.qb:{};this.u=b?b.u:!1;this.ka=b?b.ka:"ltr";this.f=b?b.f:null;this.Ka=this.lang=null;this.L=b?b.L:null}
...
function pk(a){var b=new jk(a.S,a.parent,a.pa);b.ia=a.ia;b.M=a.M;b.Aa=a.Aa;b.Wa=a.Wa;b.qa=a.qa;b.va=a.va;b.Da=a.Da;b.l=a.l;b.display=a.display;b.H=a.H;b.j=a.j;b.A=a.A;b.V=a.V;b.O=a.O;b.X=a.X;b.Y=a.Y;b.rd=a.rd;b.yc=a.yc;b.J=a.J;b.G=a.G;b.Tb=a.Tb;b.h=a.h;b.w=a.w;b.g=a.g;b.F=a.F;b.D=a.D;b.C=a.C;b.f=a.f;b.u=a.u;b.b=a.b;b.Ka=a.Ka;b.L=a.L;return b}jk.prototype.modify=function(){return this.fa?pk(this):this};function kk(a){var b=a;do{if(b.fa)break;b.fa=!0;b=b.parent}while(b);return a}
jk.prototype.clone=function(){for(var a=pk(this),b=a,c;c=b.parent;)c=pk(c),b=b.parent=c;return a};function qk(a){return{node:a.S,Wa:a.Wa,qa:a.qa,Aa:a.Aa,va:a.va?qk(a.va):null,L:a.L}}function rk(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(qk(b)),b=b.parent;while(b);b=a.Ka?sk(a.Ka,a.ia,-1):a.ia;return{na:c,ia:b,M:a.M,Ka:a.Ka}}function tk(a){for(a=a.parent;a;){if(a.yc)return!0;a=a.parent}return!1}function uk(a,b){for(var c=a;c;)c.Da||b(c),c=c.parent}
...
function Ck(a){this.element=a;this.cb=this.bb=this.height=this.width=this.G=this.A=this.H=this.w=this.Y=this.borderTop=this.fa=this.borderLeft=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.xa=this.Ib=null;this.ka=this.wb=this.Xa=this.xb=this.la=0;this.u=!1}function Dk(a){return a.marginTop+a.borderTop+a.A}function Ek(a){return a.marginBottom+a.Y+a.G}function Fk(a){return a.marginLeft+a.borderLeft+a.w}function Gk(a){return a.marginRight+a.fa+a.H}
function Hk(a){return a.u?-1:1}function Ik(a,b){a.element=b.element;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.borderLeft=b.borderLeft;a.fa=b.fa;a.borderTop=b.borderTop;a.Y=b.Y;a.w=b.w;a.H=b.H;a.A=b.A;a.G=b.G;a.width=b.width;a.height=b.height;a.bb=b.bb;a.cb=b.cb;a.xa=b.xa;a.Ib=b.Ib;a.la=b.la;a.xb=b.xb;a.Xa=b.Xa;a.u=b.u}
function Jk(a,b,c){a.top=b;a.height=c;v(a.element,"top",b+"px");v(a.element,"height",c+"px")}function Kk(a,b,c){a.left=b;a.width=c;v(a.element,"left",b+"px");v(a.element,"width",c+"px")}function Lk(a){a=a.element;for(var b;b=a.lastChild;)a.removeChild(b)}function Mk(a){var b=a.bb+a.left+a.marginLeft+a.borderLeft,c=a.cb+a.top+a.marginTop+a.borderTop;return new Rf(b,c,b+(a.w+a.width+a.H),c+(a.A+a.height+a.G))}Ck.prototype.yd=function(a,b){var c=Nk(this);return tg(a,c.U,c.R,c.T-c.U,c.N-c.R,b)};
...
function jl(a,b,c,d,e,f,g,h){this.ea=a;this.root=a.root;this.La=c;this.h=d;this.w=f;this.f=this.root;this.O={};this.V={};this.C={};this.G=[];this.A=this.J=this.H=null;this.X=new Ni(b,d,g,h);this.g=new Rk;this.Ba=!0;this.fa=[];this.xa=e;this.ta=this.ka=!1;this.b=a=tj(a,this.root);this.Y={};this.j=new fl(d);Tk(this.g,a);d=kl(this,this.root);Wi(this.X,this.root,d);ll(this,d,!1);this.F=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.F=
...
function jm(a){a.K&&(a.j.forEach(function(a){a.K&&a.K.element===this.K.element&&a.b.forEach(function(a){(a=a.Ub.element)&&a.parentNode&&a.parentNode.removeChild(a)})},a),Lk(a.K));a.j.splice(0);Object.keys(a.w).forEach(function(a){delete this.w[a]},a);a.Bc=!0}function wm(a){return a.Bc||!!a.parent&&wm(a.parent)}function xm(a,b){return Ll(b,a.G.toString(),a.F.toString()||null,Pl)}
...
Wm.prototype.He=function(a,b){return b};Wm.prototype.se=function(){return this.parent};Wm.prototype.dc=function(){return null};function Xm(a,b,c,d,e){Ck.call(this,a);this.af=a.lastChild;this.h=b;this.b=c;this.Sa=d;this.bf=a.ownerDocument;this.f=e;cm(e,this);this.Ud=null;this.ve=this.xe=!1;this.F=this.lb=this.ya=this.X=this.V=0;this.J=this.Td=this.O=this.ta=null;this.Yd=!1;this.j=this.g=this.C=null;this.Bb=!0;this.Ab=this.sc=this.Cb=0;this.l=!0;this.La=null}t(Xm,Ck);
function Ym(a,b){return!!b.j&&(!a.xe||!!b.parent)}function Tm(a,b){return a.u?b<a.F:b>a.F}function Zm(a){var b=Hm(a.f);return a.Ib.concat(b)}Xm.prototype.vb=function(a){var b=this,c=I("openAllViews"),d=a.na;$m(b.h,b.element,b.ve);var e=d.length-1,f=null;ge(function(){for(;0<=e;){f=ik(d[e],f);e!==d.length-1||f.L||(f.L=b.Ud);if(!e){var c=f,h;h=a;h=h.Ka?sk(h.Ka,h.ia,1):h.ia;c.ia=h;f.M=a.M;f.Ka=a.Ka;if(f.M)break}c=an(b.h,f,!e&&!f.ia);e--;if(c.za())return c}return L(!1)}).then(function(){O(c,f)});return M(c)};
...
function ln(a,b,c,d,e){var f=a.bf.createElement("div");a.u?(e>=a.height&&(e-=.1),v(f,"height",d+"px"),v(f,"width",e+"px")):(d>=a.width&&(d-=.1),v(f,"width",d+"px"),v(f,"height",e+"px"));v(f,"float",c);v(f,"clear",c);a.element.insertBefore(f,b);return f}function mn(a){for(var b=a.element.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.element.removeChild(b);else break}b=c}}
...
0,new Vf(z.R,n.N,n.U,n.T)),n.N=z.R);for(;r<l.length&&(n=l[r++],n.N>z.N&&(l.splice(r,0,new Vf(z.N,n.N,n.U,n.T)),n.N=z.N),z.U!=z.T&&("left"==e?n.U=Math.min(z.T,m.T):n.T=Math.max(z.U,m.U)),n.N!=z.N););}lg(m,l)}nn(a);"left"==e?a.Cb=k:a.sc=k;a.Ab=g;En(a,k);O(c,f)}});return M(c)}
function Fn(a,b){var c=a.element.ownerDocument.createElement("div");v(c,"position","absolute");var d=em(a.f,b.b),e=new Zl(d,"column",null,a.f.h,b.S,null,null),d=bm(d),c=new Gn(b,c,a.h.clone(),a.b,a.Sa,e,d);cm(e,c);var f=a.f,e=bm(f,b.b),g=Mk(e),d=c.element;e.element.parentNode.appendChild(d);Ik(c,e);c.element=d;c.xe=!0;c.width=g.T-g.U;c.height=g.N-g.R;c.marginLeft=c.marginRight=c.marginTop=c.marginBottom=0;c.borderLeft=c.fa=c.borderTop=c.Y=0;c.w=c.H=c.A=c.G=0;Kk(c,g.U-e.bb,c.width);Jk(c,g.R-e.cb,c.height);
...
function On(a,b,c,d){var e=I("processLineStyling");Vm(d);var f=d.concat([]);d.splice(0,d.length);var g=0,h=b.f;0==h.count&&(h=h.kf);he(function(d){if(h){var e=Pn(a,f),l=h.count-g;if(e.length<=l)Q(d);else{var n=Qn(a,f,e[l-1]);n?Rn(a,n,!1,!1).then(function(){g+=l;dn(a.h,n,0).then(function(e){b=e;Nn(b,!1);h=b.f;f=[];en(a,b,f).then(function(a){c=a;P(d)})})}):Q(d)}}else Q(d)}).then(function(){Array.prototype.push.apply(d,f);Vm(d);O(e,c)});return M(e)}
...
Xm.prototype.Jb=function(){var a=null,b=null,c,d=0;do{c=d;for(var d=Number.MAX_VALUE,e=this.C.length-1;0<=e&&!b;--e){var a=this.C[e],b=a.f(this,c),f=a.b();f>c&&(d=Math.min(d,f))}}while(d>c&&!b);return{Tc:b?a:null,B:b}};
...
function bo(a,b,c,d,e){var f;if(!(f=!b))a:{for(f=b.D;f;){if(f.parentNode===f.ownerDocument){f=!1;break a}f=f.parentNode}f=!0}if(f)return!1;f=Km(b,a.b,0,a.u);var g=b.M?b.parent&&b.parent.L:b.L;g&&(g=g.dc())&&(f+=(a.u?-1:1)*Sm(g));g=Tm(a,f);c&&(f+=Sn(a,c));En(a,f);if((d=a.l?d:!0)||!g)c=kk(b),b=Mm(b.L).g(c,e,g,a.la),a.C.push(b);return g}
function co(a,b){if(b.D.parentNode){var c=pn(a,b.D),d=b.D.ownerDocument.createElement("div");a.u?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.D.parentNode.insertBefore(d,b.D);var e=Xj(a.b,d),e=a.u?e.right:e.top,f=Hk(a),g;switch(b.A){case "left":g=a.Cb;break;case "right":g=a.sc;break;default:g=f*Math.max(a.sc*f,a.Cb*f)}e*f>=g*f?b.D.parentNode.removeChild(d):(e=Math.max(1,(g-e)*f),a.u?d.style.width=
...
function yn(a){var b=a.element.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.A+"px";b.style.right=a.H+"px";b.style.bottom=a.G+"px";b.style.left=a.w+"px";a.element.appendChild(b);var c=Xj(a.b,b);a.element.removeChild(b);var b=a.bb+a.left+Fk(a),d=a.cb+a.top+Dk(a);a.ta=new Rf(b,d,b+a.width,d+a.height);a.V=c?a.u?c.top:c.left:0;a.X=c?a.u?c.bottom:c.right:0;a.ya=c?a.u?c.right:c.top:0;a.lb=c?a.u?c.left:c.bottom:0;a.Cb=a.ya;a.sc=a.ya;a.Ab=a.ya;a.F=a.lb;var c=a.ta,e,b=a.bb+a.left+
Fk(a),d=a.cb+a.top+Dk(a);e=new Rf(b,d,b+a.width,d+a.height);if(a.xa){b=a.xa;d=e.U;e=e.R;for(var f=[],g=0;g<b.b.length;g++){var h=b.b[g];f.push(new Sf(h.f+d,h.b+e))}b=new Xf(f)}else b=$f(e.U,e.R,e.T,e.N);a.J=kg(c,[b],Zm(a),a.Xa,a.u);nn(a);a.g=null}function wn(a){a.Td=[];v(a.element,"width",a.width+"px");v(a.element,"height",a.height+"px");yn(a);a.la=0;a.Yd=!1;a.j=null;a.La=null}function En(a,b){a.la=Math.max(Hk(a)*(b-a.ya),a.la)}
...
function to(a,b){var c=a.f[b],d=a.h[b];d||(d=a.h[b]=[]);for(var e=!1,f=0;f<a.g.length;){var g=a.g[f];g.bc===b?(g.Hc=!0,a.g.splice(f,1),c&&(e=c.indexOf(g),0<=e&&c.splice(e,1)),d.push(g),e=!0):f++}e||uo(a,b,!0)}function uo(a,b,c){a.w.some(function(a){return a.bc===b})||a.w.push(new po(b,c))}
function zo(a,b,c){var d=Object.keys(a.j.b);if(0<d.length){var e=oo(a.b);d.forEach(function(a){this.A[a]=e;var d=this.C[a];if(d&&d.$<c&&(d=this.h[a])){var f=this.f[a];f||(f=this.f[a]=[]);for(var g;g=d.shift();)g.Hc=!1,f.push(g)}this.C[a]={P:b,$:c}},a)}for(var d=a.G,f;f=a.w.shift();){f.Jd=d;f.P=b;f.$=c;var g;f.Hc?(g=a.h[f.bc])||(g=a.h[f.bc]=[]):(g=a.f[f.bc])||(g=a.f[f.bc]=[]);g.every(function(a){return!(f===a||a&&f.bc===a.bc&&f.Hc===a.Hc&&f.P===a.P&&f.$===a.$)})&&g.push(f)}a.j=null}
...
function Ho(a,b){this.g=b;var c=this;sb.call(this,a,function(a,b){var d=a.match(/^([^.]+)\.([^.]+)$/);if(d){var e=c.g.w[d[1]];if(e&&(e=this.La[e])){if(b){var d=d[2],h=e.fa[d];if(h)e=h;else{switch(d){case "columns":var h=e.b.f,l=new kc(h,0),k=Io(e,"column-count"),m=Io(e,"column-width"),n=Io(e,"column-gap"),h=x(h,mc(h,new hc(h,"min",[l,k]),w(h,m,n)),n)}h&&(e.fa[d]=h);e=h}}else e=Io(e,d[2]);return e}}return null})}t(Ho,sb);
function Jo(a,b,c,d,e,f,g){a=a instanceof Ho?a:new Ho(a,this);Do.call(this,a,b,c,d,e);this.g=this;this.W=f;this.Z=g;this.b.width=new V(Dd,0);this.b.height=new V(Ed,0);this.b["wrap-flow"]=new V(Lc,0);this.b.position=new V(od,0);this.b.overflow=new V(Ad,0);this.w={}}t(Jo,Do);Jo.prototype.h=function(a){return new Ko(a,this)};Jo.prototype.clone=function(a){a=new Jo(this.f,this.name,a.Pb||this.Pb,this.Ca,this.parent,this.W,this.Z);Eo(this,a);Fo(this,a);return a};
...
function fp(a,b,c){var d=Z(a,b,"margin-bottom"),e=Z(a,b,"padding-bottom"),f=Z(a,b,"border-bottom-width");a=Z(a,b,"height")-c.ka;v(c.element,"height",a+"px");v(c.element,"margin-bottom",d+"px");v(c.element,"padding-bottom",e+"px");v(c.element,"border-bottom-width",f+"px");c.height=a-c.ka;c.marginBottom=d;c.Y=f;c.G=e}function gp(a,b,c){a.u?(ep(a,b,c),fp(a,b,c)):(dp(a,b,c),cp(a,b,c))}
...
To.prototype.Wc=function(a,b,c,d,e,f,g){this.u?this.H=b.la+b.wb:this.G=b.la+b.ka;var h=(this.u||!d)&&this.g,l=(!this.u||!d)&&this.h;if(l||h)l&&v(b.element,"width","auto"),h&&v(b.element,"height","auto"),d=Xj(f,d?d.element:b.element),l&&(this.H=Math.ceil(d.right-d.left-b.w-b.borderLeft-b.H-b.fa),this.u&&(this.H+=b.wb)),h&&(this.G=d.bottom-d.top-b.A-b.borderTop-b.G-b.Y,this.u||(this.G+=b.ka));(this.u?this.g:this.h)&&gp(this,a,b);if(this.u?this.h:this.g){if(this.u?this.O:this.V)this.u?dp(this,a,b):ep(this,
...
function Np(a,b){for(var c=a.B.S,d=[],e=null,f=a.B.qa,g=-1;c&&1==c.nodeType;){var h=f&&f.root==c;if(!h||2==f.type){var l=(f?f.b:a.j).l(c,!1);d.push(l);e=e||Ba(c)}h?(c=f.ja,f=f.Ld):(c=c.parentNode,g++)}c=Cb(a.b,"em",!g);c={"font-size":new V(new D(c,"px"),0)};f=new Eh(c,a.b);for(g=d.length-1;0<=g;--g){var h=d[g],l=[],k;for(k in h)ih[k]&&l.push(k);l.sort(Hd);for(var m=0;m<l.length;m++){var n=l[m];f.f=n;var r=h[n];r.value!==bd&&(c[n]=r.Vc(f))}}for(var q in b)ih[q]||(c[q]=b[q]);return{lang:e,Ua:c}}
...
default:q=!1}a.B.Da=q;a.B.display=n?n.toString():"inline";a.B.j=A?k.toString():null;a.B.H=m||nk;a.B.V=l["column-span"];if(!a.B.Da){if(q=l["break-after"])a.B.F=q.toString();if(q=l["break-before"])a.B.g=q.toString()}a.B.O=l["vertical-align"]&&l["vertical-align"].toString()||"baseline";a.B.X=l["caption-side"]&&l["caption-side"].toString()||"top";q=l["border-collapse"];if(!q||q===C("separate"))if(A=l["border-spacing"])A.Yc()?(q=A.values[0],A=A.values[1]):q=A,q.Xb()&&(a.B.Y=Hc(q,a.b)),A.Xb()&&(a.B.rd=
Hc(A,a.b));if(q=l["x-first-pseudo"])a.B.f=new mk(a.B.parent?a.B.parent.f:null,q.I);if(q=l["white-space"])q=Yj(q.toString()),null!==q&&(a.B.Tb=q);(q=l["hyphenate-character"])&&q!==Lc&&(a.B.h=q.lc);q=l["overflow-wrap"]||["word-wrap"];a.B.w=l["word-break"]===Sc||q===Tc;Sp(a.B,b,n,g,k,r);a.B.parent&&a.B.parent.L&&(b=a.B.parent.L.He(a.B,b));var K=!1,Oa=null,Ca=[],ua=f.namespaceURI,N=f.localName;if("http://www.w3.org/1999/xhtml"==ua)"html"==N||"body"==N||"script"==N||"link"==N||"meta"==N?N="div":"vide_"==
N?N="video":"audi_"==N?N="audio":"object"==N&&(K=!!a.f),f.getAttribute("data-adapt-pseudo")&&h.content&&h.content.value&&h.content.value.url&&(N="img");else if("http://www.idpf.org/2007/ops"==ua)N="span",ua="http://www.w3.org/1999/xhtml";else if("http://www.gribuser.ru/xml/fictionbook/2.0"==ua){ua="http://www.w3.org/1999/xhtml";if("image"==N){if(N="div",(g=f.getAttributeNS("http://www.w3.org/1999/xlink","href"))&&"#"==g.charAt(0)&&(g=yj(a.ea,g)))Oa=Up(a,ua,"img"),g="data:"+(g.getAttribute("content-type")||
"image/jpeg")+";base64,"+g.textContent.replace(/[ \t\n\t]/g,""),Ca.push(me(Oa,g))}else N=Op[N];N||(N=a.B.Da?"span":"div")}else if("http://www.daisy.org/z3986/2005/ncx/"==ua)if(ua="http://www.w3.org/1999/xhtml","ncx"==N||"navPoint"==N)N="div";else if("navLabel"==N){if(N="span",k=f.parentNode){g=null;for(k=k.firstChild;k;k=k.nextSibling)if(1==k.nodeType&&(q=k,"http://www.daisy.org/z3986/2005/ncx/"==q.namespaceURI&&"content"==q.localName)){g=q.getAttribute("src");break}g&&(N="a",f=f.ownerDocument.createElementNS(ua,
"a"),f.setAttribute("href",g))}}else N="span";else"http://www.pyroxy.com/ns/shadow"==ua?(ua="http://www.w3.org/1999/xhtml",N=a.B.Da?"span":"div"):K=!!a.f;J?b?N="li":(N="div",n=Mc,l.display=n):"body"==N||"li"==N?N="div":"q"==N?N="span":"a"==N&&(g=l["hyperlink-processing"])&&"normal"!=g.toString()&&(N="span");l.behavior&&"none"!=l.behavior.toString()&&a.f&&(K=!0);f.dataset&&"true"==f.dataset.mathTypeset&&(K=!0);var Wa;K?Wa=a.f(f,a.B.parent?a.B.parent.D:null,l):Wa=L(null);Wa.then(function(g){g?K&&(d=
"true"==g.getAttribute("data-adapt-process-children")):g=Up(a,ua,N);"a"==N&&g.addEventListener("click",a.page.J,!1);Oa&&(Bn(a,a.B,"inner",Oa),g.appendChild(Oa));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&Fp(g);var h=a.B.qb["image-resolution"],k=[],m=l.width,n=l.height,r=f.getAttribute("width"),q=f.getAttribute("height"),m=m===Lc||!m&&!r,n=n===Lc||!n&&!q;if("http://www.gribuser.ru/xml/fictionbook/2.0"!=f.namespaceURI||"td"==N){for(var r=f.attributes,z=r.length,q=null,y=
...
G&&"video"===N&&"http://www.w3.org/1999/xhtml"===ua&&m&&n){var Wa=new Image,yc=me(Wa,A);Ca.push(yc);k.push({De:Wa,element:g,Ae:yc})}}"http://www.w3.org/2000/svg"==ua&&/^[A-Z\-]+$/.test(G)&&(G=G.toLowerCase());-1!=Vp.indexOf(G.toLowerCase())&&(A=zp(A,a.ea.url,a.g));H&&(Wa=Ep[H])&&(G=Wa+":"+G);"src"!=G||H||"img"!=N&&"input"!=N||"http://www.w3.org/1999/xhtml"!=ua?"href"==G&&"image"==N&&"http://www.w3.org/2000/svg"==ua&&"http://www.w3.org/1999/xlink"==H?a.page.j.push(me(g,A)):H?g.setAttributeNS(H,G,A):
...
function eq(a){var b=a.pa+1;if(a.M){if(!a.parent)return null;if(3!=a.Wa){var c=a.S.nextSibling;if(c)return a=a.modify(),a.pa=b,a.S=c,ok(a),dq(a)}if(a.va)return a=a.va.modify(),a.pa=b,a;a=a.parent.modify()}else{if(a.Aa&&(c=a.Aa.root,2==a.Aa.type&&(c=c.firstChild),c))return b=new jk(c,a,b),b.qa=a.Aa,b.Wa=a.Aa.type,dq(b);if(c=a.S.firstChild)return dq(new jk(c,a,b));1!=a.S.nodeType&&(c=aq(a.Ka),b+=c.length-1-a.ia);a=a.modify()}a.pa=b;a.M=!0;return a}
...
function qq(a){var b={width:Dd,height:Ed,Vb:Fd,Eb:Fd},c=a.size;if(c&&c.value!==Lc){var d=c.value;d.Yc()?(c=d.values[0],d=d.values[1]):(c=d,d=null);if(c.Xb())b.width=c,b.height=d||c;else if(c=lq[c.name.toLowerCase()])d&&d===gd?(b.width=c.height,b.height=c.width):(b.width=c.width,b.height=c.height)}(c=a.marks)&&c.value!==F&&(b.Eb=pq);a=a.bleed;a&&a.value!==Lc?a.value&&a.value.Xb()&&(b.Vb=a.value):c&&(a=!1,c.value.Yc()?a=c.value.values.some(function(a){return a===Uc}):a=c.value===Uc,a&&(b.Vb=new D(6,
"pt")));return b}function rq(a,b){var c={},d=a.Vb.I*Cb(b,a.Vb.ga,!1),e=a.Eb.I*Cb(b,a.Eb.ga,!1),f=d+e,g=a.width;c.Nb=g===Dd?(b.aa.pb?Math.floor(b.Xa/2)-b.aa.ic:b.Xa)-2*f:g.I*Cb(b,g.ga,!1);g=a.height;c.Mb=g===Ed?b.Cb-2*f:g.I*Cb(b,g.ga,!1);c.Vb=d;c.Eb=e;c.wd=f;return c}function sq(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
function tq(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg",c||"polyline");a.setAttribute("stroke","black");a.setAttribute("stroke-width",b);a.setAttribute("fill","none");return a}var uq={Lf:"top left",Mf:"top right",yf:"bottom left",zf:"bottom right"};
...
k.appendChild(l);a=tq(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));k.appendChild(a);b.split(" ").forEach(function(a){k.style[a]=f+"px"});return k}var wq={Kf:"top",xf:"bottom",Ue:"left",Ve:"right"};
...
Gq.prototype.Dd=function(){var a=this.style;a.top=Fd;a["margin-top"]=Fd;a["border-top-width"]=Fd;a["padding-top"]=Fd;a["padding-bottom"]=Fd;a["border-bottom-width"]=Fd;a["margin-bottom"]=Fd;a.bottom=Fd};Gq.prototype.Y=function(a,b,c){b=b.H;var d={start:this.l.marginLeft,end:this.l.marginRight,ma:this.l.fc},e={start:this.l.marginTop,end:this.l.marginBottom,ma:this.l.ec};Jq(this,b.top,!0,d,a,c);Jq(this,b.bottom,!0,d,a,c);Jq(this,b.left,!1,e,a,c);Jq(this,b.right,!1,e,a,c)};
...
function Oq(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=Pq(d,g.length?new Mq(g):null,b);g.jb&&(f.center=g.jb);d=g.jb||d.f();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=Pq(c,e,b),c.jb&&(f.start=c.jb),c.Pc&&(f.end=c.Pc);return f}
function Pq(a,b,c){var d={jb:null,Pc:null};if(a&&b)if(a.b()&&b.b()){var e=a.g(),f=b.g();0<e&&0<f?(f=e+f,f<c?d.jb=c*e/f:(a=a.h(),b=b.h(),b=a+b,b<c?d.jb=a+(c-b)*(e-a)/(f-b):0<b&&(d.jb=c*a/b)),0<d.jb&&(d.Pc=c-d.jb)):0<e?d.jb=c:0<f&&(d.Pc=c)}else a.b()?d.jb=Math.max(c-b.f(),0):b.b()&&(d.Pc=Math.max(c-a.f(),0));else a?a.b()&&(d.jb=c):b&&b.b()&&(d.Pc=c);return d}Gq.prototype.Ob=function(a,b,c,d,e){Gq.Te.Ob.call(this,a,b,c,d,e);b.element.setAttribute("data-vivliostyle-page-box",!0)};
...
d["padding-bottom"]=new E(c.marginBottom)};Hq.prototype.Cd=function(){var a=Qq(this,{start:"left",end:"right",ma:"width"});this.fc=a.te;this.marginLeft=a.Ne;this.marginRight=a.Me};Hq.prototype.Dd=function(){var a=Qq(this,{start:"top",end:"bottom",ma:"height"});this.ec=a.te;this.marginTop=a.Ne;this.marginBottom=a.Me};
...
Fd;c["margin-"+f]=Fd;c["padding-"+e]=new E(n);c["padding-"+f]=new E(r);c["border-"+e+"-width"]=new E(q);c["border-"+f+"-width"]=new E(z);c[g]=new E(l);c["max-"+g]=new E(l);return{te:x(d,h,w(d,k,m)),Ne:k,Me:m}}Hq.prototype.Ob=function(a,b,c,d,e){Oo.prototype.Ob.call(this,a,b,c,d,e);c.O=b.element};function Iq(a,b){Oo.call(this,a,b);var c=b.A;this.l=Aq[c];a.ta[c]=this;this.xa=!0}t(Iq,Oo);p=Iq.prototype;
...
p.sa=function(a,b){var c=this.style,d=this.b.f,e=a.start,f=a.end,g="left"===e,h=g?b.fc:b.ec,l=Y(d,c[a.ma],h),g=g?b.marginLeft:b.marginTop;if("start"===this.l.sa)c[e]=new E(g);else if(l){var k=Po(d,c["margin-"+e],h),m=Po(d,c["margin-"+f],h),n=Po(d,c["padding-"+e],h),r=Po(d,c["padding-"+f],h),q=Ro(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),f=Ro(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),l=w(d,l,w(d,w(d,n,r),w(d,w(d,q,f),w(d,k,m))));switch(this.l.sa){case "center":c[e]=new E(w(d,
g,nc(d,x(d,h,l),new tb(d,2))));break;case "end":c[e]=new E(x(d,w(d,g,h),l))}}};
function Rq(a,b,c){function d(a){if(y)return y;y={ma:z?z.evaluate(a):null,$a:l?l.evaluate(a):null,ab:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[r,m,n,q].forEach(function(b){b&&(c+=b.evaluate(a))});(null===y.$a||null===y.ab)&&c+y.ma+y.$a+y.ab>b&&(null===y.$a&&(y.$a=0),null===y.ab&&(y.Rf=0));null!==y.ma&&null!==y.$a&&null!==y.ab&&(y.ab=null);null===y.ma&&null!==y.$a&&null!==y.ab?y.ma=b-c-y.$a-y.ab:null!==y.ma&&null===y.$a&&null!==y.ab?y.$a=b-c-y.ma-y.ab:null!==y.ma&&null!==y.$a&&null===y.ab?y.ab=
b-c-y.ma-y.$a:null===y.ma?(y.$a=y.ab=0,y.ma=b-c):y.$a=y.ab=(b-c-y.ma)/2;return y}var e=a.style;a=a.b.f;var f=b.Ed,g=b.Id;b=b.ma;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],l=Qo(a,e["margin-"+f],h),k=Qo(a,e["margin-"+g],h),m=Po(a,e["padding-"+f],h),n=Po(a,e["padding-"+g],h),r=Ro(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),q=Ro(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),z=Y(a,e[b],h),y=null;e[b]=new E(new vb(a,function(){var a=d(this).ma;return null===a?0:a},b));e["margin-"+
f]=new E(new vb(a,function(){var a=d(this).$a;return null===a?0:a},"margin-"+f));e["margin-"+g]=new E(new vb(a,function(){var a=d(this).ab;return null===a?0:a},"margin-"+g));"left"===f?e.left=new E(w(a,c.marginLeft,c.fc)):"top"===f&&(e.top=new E(w(a,c.marginTop,c.ec)))}p.Cd=function(){var a=this.f.l;this.l.Ha?Rq(this,{Ed:"right",Id:"left",ma:"width"},a):this.l.Ia?Rq(this,{Ed:"left",Id:"right",ma:"width"},a):this.sa({start:"left",end:"right",ma:"width"},a)};
p.Dd=function(){var a=this.f.l;this.l.Ja?Rq(this,{Ed:"bottom",Id:"top",ma:"height"},a):this.l.Ga?Rq(this,{Ed:"top",Id:"bottom",ma:"height"},a):this.sa({start:"top",end:"bottom",ma:"height"},a)};p.Wc=function(a,b,c,d,e,f,g){Oo.prototype.Wc.call(this,a,b,c,d,e,f,g);a=c.H;c=this.b.A;d=this.l;d.Ha||d.Ia?d.Ja||d.Ga||(d.Ha?a.left[c]=b:d.Ia&&(a.right[c]=b)):d.Ja?a.top[c]=b:d.Ga&&(a.bottom[c]=b)};
...
p.sb=function(a,b,c){if("bleed"!==a&&"marks"!==a||this.G.some(function(a){return!a.ke})){aj.prototype.sb.call(this,a,b,c);var d=this.Ua[a],e=this.O;if("bleed"===a||"marks"===a)e[""]||(e[""]={}),Object.keys(e).forEach(function(b){zh(e[b],a,d)});else if("size"===a){var f=e[""];this.G.forEach(function(b){var c=new V(d.value,d.Va+b.Z);b=b.ke?b.ke.join(""):"";var g=e[b];g?(c=(b=g[a])?wh(null,c,b):c,zh(g,a,c)):(g=e[b]={},zh(g,a,c),f&&["bleed","marks"].forEach(function(a){f[a]&&zh(g,a,f[a])},this))},this)}}};
p.Ge=function(a){Lh(this.j.Dc,"*",a)};p.Le=function(a){return new br(this.Ua,a)};p.Pd=function(a){var b=Ah(this.Ua,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);hf(this.ja,new er(this.f,this.ja,this.w,c))};function er(a,b,c,d){jf.call(this,a,b,!1);this.g=c;this.b=d}t(er,kf);er.prototype.rb=function(a,b,c){gh(this.g,a,b,c,this)};er.prototype.Ac=function(a,b){lf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};er.prototype.nd=function(a,b){lf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
...
function qr(a){var b=a.f,c=pm(b),d=I("layoutDeferredPageFloats"),e=!1,f=0;he(function(d){if(f===c.length||rm(b))Q(d);else{var g=c[f++],l=g.gb;lm(b,l)?P(d):Hn(a,g.b,l).then(function(a){a?(a=wm(b.parent))?Q(d):(wm(b)&&!a&&(e=!0,b.Bc=!1),P(d)):P(d)})}}).then(function(){e&&jm(b);O(d,!0)});return M(d)}
...
else if(h=!1,!l.b.mf||a&&!q.h||c.push(f),q.h)g.push(f),Q(e);else{var k=!!a||!!b.j,m;0<tm(b.f).length&&b.La?a?(m=a.clone(),m.Ba=b.La):m=new vk(b.La):m=null;if(b.j&&m)l.f=m,d.f=b.j,b.j=null;else{g.push(f);if(a||m)l.f=a||m,c.push(f);b.j&&(d.g=Kl(b.j))}k?Q(e):z?z=!1:P(e)}});if(z){z=!1;return}}Q(e)}).then(function(){if(!wm(b.f)){d.b=d.b.filter(function(a,b){return 0<=c.indexOf(b)||0>g.indexOf(b)});"column"===d.f&&(d.f=null);var a=Im(b.f);En(b,a)}O(e,!0)})}});return M(e)}
...
y=!1;if(l&&l.Ie())if(a.V[l.toString()])wm(h)||c.Wc(a,q,b,null,1,a.g,a.h),l=L(!0);else{var A=I("layoutContainer.inner"),H=l.toString(),G=tr(a,h,c,q,H),J=Z(c,a,"column-count"),K=Z(c,a,"column-gap"),Oa=1<J?Z(c,a,"column-width"):q.width,l=$o(c,a),Ca=0,r=ap(c,a,"shape-inside"),ua=tg(r,0,0,q.width,q.height,a),N=new Jp(H,a,a.viewport,a.f,l,a.ea,a.h,a.style.F,a,b,a.vb,a.xb,a.wb),Wa=new lo(a.j,a.b.page-1),yc=0,zc=null;he(function(b){sr(a,c,e,f,g,q,yc++,H,G,J,K,Oa,ua,N,Wa).then(function(c){wm(h)?Q(b):(yc!==
J||wm(G)||um(G),wm(G)?(yc=0,a.b=z.clone(),G.Bc=!1,P(b)):(zc=c,zc.j&&"column"!=zc.j&&(yc=J,"region"!=zc.j&&(a.V[H]=!0)),Ca=Math.max(Ca,zc.la),yc<J?P(b):Q(b)))})}).then(function(){if(!wm(h)){zc.element===n&&(q=zc);q.la=Ca;c.Wc(a,q,b,zc,J,a.g,a.h);var d=a.b.b[H];d&&"region"===d.f&&(d.f=null)}O(A,!0)});l=M(A)}else{if((l=ap(c,a,"content"))&&Pk(l)){r="span";l.url&&(r="img");var Kj=a.viewport.b.createElement(r);l.ba(new Ok(Kj,a,l));n.appendChild(Kj);"img"==r&&pp(c,a,Kj,a.h);op(c,a,q,a.h)}else c.xa&&(d.removeChild(n),
y=!0);y||c.Wc(a,q,b,null,1,a.g,a.h);l=L(!0)}l.then(function(){if(wm(h))O(k,!0);else{if(!c.g||0<Math.floor(q.la)){if(!y&&!m){var l=ap(c,a,"shape-outside"),l=q.yd(l,a);g.push(l)}}else if(!c.w.length){d.removeChild(n);O(k,!0);return}var r=c.w.length-1;ge(function(){for(;0<=r;){var d=c.w[r--],d=ur(a,b,d,n,e,f,g,h);if(d.za())return d.oa(function(){return L(!wm(h))});if(wm(h))break}return L(!1)}).then(function(){O(k,!0)})}});return M(k)}
...
function yr(a,b,c){a.O=b.Nb;a.J=b.Mb;a.ka=b.Nb+2*b.wd;a.fa=b.Mb+2*b.wd;c.K.style.width=a.ka+"px";c.K.style.height=a.fa+"px";c.g.style.left=b.Eb+"px";c.g.style.right=b.Eb+"px";c.g.style.top=b.Eb+"px";c.g.style.bottom=b.Eb+"px";c.g.style.padding=b.Vb+"px"}function zr(a,b,c,d){aj.call(this,a.j,a,b,c,d,a.h,!c);this.g=a;this.C=!1}t(zr,aj);p=zr.prototype;p.jd=function(){};p.hd=function(a,b,c){a=new Jo(this.g.w,a,b,c,this.g.G,this.W,ff(this.ja));hf(this.g,new wp(a.f,this.g,a,this.w))};
p.ac=function(a){a=a.b;this.W&&(a=lc(this.f,this.W,a));hf(this.g,new zr(this.g,a,this,this.F))};p.ed=function(){hf(this.g,new gj(this.f,this.ja))};p.gd=function(){var a={};this.g.A.push({Yb:a,W:this.W});hf(this.g,new hj(this.f,this.ja,null,a,this.g.h))};p.fd=function(a){var b=this.g.l[a];b||(b={},this.g.l[a]=b);hf(this.g,new hj(this.f,this.ja,null,b,this.g.h))};p.ld=function(){var a={};this.g.H.push(a);hf(this.g,new hj(this.f,this.ja,this.W,a,this.g.h))};
p.Ic=function(a){var b=this.g.C;if(a){var c=Ah(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}hf(this.g,new hj(this.f,this.ja,null,b,this.g.h))};p.kd=function(){this.C=!0;this.tb()};p.jc=function(){var a=new cr(this.g.w,this.g,this,this.w,this.g.F);hf(this.g,a);a.jc()};p.wa=function(){aj.prototype.wa.call(this);if(this.C){this.C=!1;var a="R"+this.g.O++,b=C(a),c;this.W?c=new vh(b,0,this.W):c=new V(b,0);Bh(this.Ua,"region-id").push(c);this.Hb();a=new zr(this.g,this.W,this,a);hf(this.g,a);a.wa()}};
...
function Dr(a,b){var c=I("OPSDocStore.load"),d=b.url;Cj(b,a).then(function(b){if(b){for(var e=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),h=0;h<g.length;h++){var l=g[h],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),n=l.getAttribute("action"),l=l.getAttribute("ref");k&&m&&n&&l&&e.push({jf:k,event:m,action:n,Gc:l})}a.J[d]=e;var r=[];r.push({url:oa("user-agent-page.css",na),text:null,Za:"UA",
...
Lr.prototype.dd=function(a,b,c,d,e){if(this.page)return L(this.page);var f=this,g=I("showTOC"),h=new Sj(a,a);this.page=h;this.b.load(this.url).then(function(d){var k=f.b.f[d.url],l=jr(k,c,1E5,e);b=new jq(b.window,l.fontSize,b.root,l.width,l.height);var n=new kr(k,d,f.lang,b,f.f,f.l,f.Fd(d),f.j,0,f.h,f.g);f.Qa=n;n.aa=f.aa;lr(n).then(function(){xr(n,h,null).then(function(){Mr(f,a,2);O(g,h)})})});return M(g)};
Lr.prototype.Xc=function(){if(this.page){var a=this.page;this.Qa=this.page=null;v(a.K,"visibility","none");var b=a.K.parentNode;b&&b.removeChild(a.K)}};Lr.prototype.he=function(){return!!this.page};function Or(){Er.call(this,Pr(this));this.g=new $e(Cj,"document");this.F=new $e(bf,"text");this.G={};this.fa={};this.A={};this.C={}}t(Or,Er);function Pr(a){return function(b){return a.A[b]}}
...
function es(a){function b(){}b.prototype.Qd=function(a,b){return"viv-id-"+qa(b+(a?"#"+a:""),":")};b.prototype.Nc=function(b,d){var c=b.match(/^([^#]*)#?(.*)$/);if(c){var f=c[1]||d,c=c[2];if(f&&a.j.some(function(a){return a.src===f}))return"#"+this.Qd(c,f)}return b};b.prototype.nf=function(a){"#"===a.charAt(0)&&(a=a.substring(1));a.indexOf("viv-id-")||(a=a.substring(7));return(a=Ja(a).match(/^([^#]*)#?(.*)$/))?[a[1],a[2]]:[]};return new b}
...
function ls(a,b){var c=a.b[b.P];if(0>=b.Ea)return L(c.g);var d=I("getEPage");a.h.load(c.src).then(function(a){a=vj(a);O(d,c.g+Math.min(a,b.Ea)*c.b/a)});return M(d)}function ms(a,b){return{page:a,position:{P:a.P,$:b,Ea:a.offset}}}function ns(a,b,c,d,e){this.b=a;this.viewport=b;this.j=c;this.w=e;this.$b=[];this.l=[];this.aa=kb(d);this.h=new hq(b);this.f=new vo(a.w)}function os(a,b){var c=a.$b[b.P];return c?c.nb[b.$]:null}p=ns.prototype;
p.Kb=function(a){return this.b.H?this.b.H:(a=this.$b[a?a.P:0])?a.Qa.xa:null};
function ps(a,b,c,d){c.K.style.display="none";c.K.style.visibility="visible";c.K.style.position="";c.K.style.top="";c.K.style.left="";c.K.setAttribute("data-vivliostyle-page-side",c.l);var e=b.nb[d];c.G=!b.item.P&&!d;b.nb[d]=c;e?(b.Qa.viewport.f.replaceChild(c.K,e.K),Ua(e,{type:"replaced",target:null,currentTarget:null,Oe:c})):b.Qa.viewport.f.appendChild(c.K);a.w({width:b.Qa.ka,height:b.Qa.fa},b.Qa.Sa,b.item.P,b.Qa.Y+d)}
function qs(a,b,c){var d=I("renderSinglePage"),e=rs(a,b,c);xr(b.Qa,e,c).then(function(f){var g=(c=f)?c.page-1:b.Ra.length-1;ps(a,b,e,g);zo(a.f,e.P,g);f=null;if(c){var h=b.Ra[c.page];b.Ra[c.page]=c;h&&b.nb[c.page]&&(Bk(c,h)||(f=qs(a,b,c)))}f||(f=L(!0));f.then(function(){var b=Ao(a.f,e),f=0;he(function(c){f++;if(f>b.length)Q(c);else{var d=b[f-1];d.bd=d.bd.filter(function(a){return!a.Hc});d.bd.length?ss(a,d.P).then(function(b){b?(yo(a.f,d.Jd),Bo(a.f,d.bd),qs(a,b,b.Ra[d.$]).then(function(b){var d=a.f;
...
function us(a,b,c){var d=I("findPage");ss(a,b.P).then(function(e){if(e){var f=null,g;he(function(d){var h=ts(b,e);g=h.$;(f=e.nb[g])?Q(d):e.complete?(g=e.Ra.length-1,f=e.nb[g],Q(d)):c?vs(a,h).then(function(a){a&&(f=a.page);Q(d)}):fe(100).then(function(){P(d)})}).then(function(){O(d,ms(f,g))})}else O(d,null)});return M(d)}
function vs(a,b){var c=I("renderPage");ss(a,b.P).then(function(d){if(d){var e=ts(b,d),f=e.$,g=e.Ea,h=d.nb[f];h?O(c,ms(h,f)):he(function(b){if(f<d.Ra.length)Q(b);else if(d.complete)f=d.Ra.length-1,Q(b);else{var c=d.Ra[d.Ra.length-1];qs(a,d,c).then(function(e){var k=e.Cc.page;(c=e.Pe)?0<=g&&nr(d.Qa,c)>g?(h=k,f=d.Ra.length-2,Q(b)):P(b):(h=k,f=e.Cc.position.$,d.complete=!0,k.A=d.item.P===a.b.b.length-1,Q(b))})}}).then(function(){h=h||d.nb[f];var b=d.Ra[f];h?O(c,ms(h,f)):qs(a,d,b).then(function(b){b.Pe||
...
function ss(a,b){if(b>=a.b.b.length)return L(null);var c=a.$b[b];if(c)return L(c);var d=I("getPageViewItem"),e=a.l[b];if(e){var f=$d(d);e.push(f);return M(d)}var e=a.l[b]=[],g=a.b.b[b],h=a.b.h;h.load(g.src).then(function(f){g.b||1!=a.b.b.length||(g.b=Math.ceil(vj(f)/2700),a.b.F=g.b);var k=h.f[f.url],l=a.Fd(f),n=a.viewport,r=jr(k,n.width,n.height,n.fontSize);if(r.width!=n.width||r.height!=n.height||r.fontSize!=n.fontSize)n=new jq(n.window,r.fontSize,n.root,r.width,r.height);r=a.$b[b-1];null!==g.hb?
r=g.hb-1:(r=r?r.Qa.Y+r.nb.length:0,null!==g.Zb&&(r+=g.Zb));wo(a.f,r);var q=new kr(k,f,a.b.lang,n,a.h,a.j,l,a.b.G,r,a.b.w,a.f);q.aa=a.aa;lr(q).then(function(){c={item:g,ea:f,Qa:q,Ra:[null],nb:[],complete:!1};a.$b[b]=c;O(d,c);e.forEach(function(a){a.eb(c)})})});return M(d)}function Ds(a){return a.$b.some(function(a){return a&&0<a.nb.length})}
...
"#EEE";e.style.border="1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.g.dd(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";O(c,a)});return M(c)};p.Xc=function(){this.g&&this.g.Xc()};p.he=function(){return this.g&&this.g.he()};var Es={Gf:"singlePage",Hf:"spread",wf:"autoSpread"};
function Fs(a,b,c,d){var e=this;this.window=a;this.od=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);mj&&b.setAttribute("data-vivliostyle-debug",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Xa=c;this.Sa=d;a=a.document;this.xa=new El(a.head,b);this.A="loading";this.O=[];this.h=null;this.Lb=this.Na=!1;this.f=this.j=this.g=this.C=null;this.fontSize=16;this.zoom=1;this.F=!1;this.X="singlePage";this.ka=!1;this.Od=!0;this.aa=jb();this.fa=[];this.J=function(){};this.w=function(){};
this.Y=function(){e.Na=!0;e.J()};this.Kd=this.Kd.bind(this);this.G=function(){};this.H=a.getElementById("vivliostyle-page-rules");this.V=!1;this.l=null;this.ta={loadEPUB:this.We,loadXML:this.Xe,configure:this.$d,moveTo:this.La,toc:this.dd};Gs(this)}function Gs(a){ka(1,function(a){Hs(this,{t:"debug",content:a})}.bind(a));ka(2,function(a){Hs(this,{t:"info",content:a})}.bind(a));ka(3,function(a){Hs(this,{t:"warn",content:a})}.bind(a));ka(4,function(a){Hs(this,{t:"error",content:a})}.bind(a))}
function Hs(a,b){b.i=a.Xa;a.Sa(b)}function Is(a,b){a.A!==b&&(a.A=b,a.od.setAttribute("data-vivliostyle-viewer-status",b),Hs(a,{t:"readystatechange"}))}p=Fs.prototype;
...
!0);"string"==typeof a.fontFamily&&(this.aa.fontFamily=a.fontFamily,this.Na=!0);"boolean"==typeof a.load&&(this.ka=a.load);"boolean"==typeof a.renderAllPages&&(this.Od=a.renderAllPages);"string"==typeof a.userAgentRootURL&&(ma=a.userAgentRootURL.replace(/resources\/?$/,""),na=a.userAgentRootURL);"string"==typeof a.rootURL&&(ma=a.rootURL,na=ma+"resources/");"string"==typeof a.pageViewMode&&a.pageViewMode!==this.X&&(this.X=a.pageViewMode,this.Na=!0);"number"==typeof a.pageBorder&&a.pageBorder!==this.aa.ic&&
(this.viewport=null,this.aa.ic=a.pageBorder,this.Na=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=a.zoom,this.Lb=!0);"boolean"==typeof a.fitToScreen&&a.fitToScreen!==this.F&&(this.F=a.fitToScreen,this.Lb=!0);Os(this,a);return L(!0)};function Os(a,b){(Jd.CONFIGURATION||[]).forEach(function(a){a=a(b);this.Na=a.Na||this.Na;this.Lb=a.Lb||this.Lb}.bind(a))}p.Kd=function(a){var b=this.g,c=this.j,d=a.target;c?c.left!==d&&c.right!==d||Ps(this,a.Oe):b===a.target&&Ps(this,a.Oe)};
...
function Us(a,b){Ss(a);a.g=b;Ts(a,b)}function Vs(a){var b=I("reportPosition");is(a.h,a.f.P,a.f.Ea).then(function(c){var d=a.g;(a.ka&&0<d.j.length?le(d.j):L(!0)).then(function(){Ws(a,d,c).Fa(b)})});return M(b)}function Xs(a){var b=a.od;if(a.C){var c=a.C;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new jq(a.window,a.fontSize,b,c.width,c.height)}return new jq(a.window,a.fontSize,b)}
function Ys(a){var b=Xs(a),c;a:switch(a.X){case "singlePage":c=!1;break a;case "spread":c=!0;break a;default:c=1.45<=b.width/b.height&&800<b.width}var d=a.aa.pb!==c;a.aa.pb=c;a.od.setAttribute("data-vivliostyle-spread-view",c);if(a.C||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;if(!d&&b.width==a.viewport.width&&b.height==a.viewport.height)return!0;if(d=a.b&&Ds(a.b)){a:{d=a.b.$b;for(c=0;c<d.length;c++){var e=d[c];if(e)for(var e=e.nb,f=0;f<e.length;f++){var g=e[f];if(g.F&&g.C){d=!0;break a}}}d=
!1}d=!d}return d?(a.viewport.width=b.width,a.viewport.height=b.height,a.Lb=!0):!1}p.pf=function(a,b,c,d){this.fa[d]=a;Zs(this,b,c,d)};function Zs(a,b,c,d){if(!a.V&&a.H&&!c&&!d){var e="";Object.keys(b).forEach(function(a){e+="@page "+a+"{size:";a=b[a];e+=a.width+"px "+a.height+"px;}"});a.H.textContent=e;a.V=!0}}
function $s(a){if(a.b){a.b.Xc();for(var b=a.b,c=b.$b,d=0;d<c.length;d++){var e=c[d];e&&e.nb.splice(0)}for(b=b.viewport.root;b.lastChild;)b.removeChild(b.lastChild)}a.H&&(a.H.textContent="",a.V=!1);a.viewport=Xs(a);b=a.viewport;v(b.g,"width","");v(b.g,"height","");v(b.f,"width","");v(b.f,"height","");v(b.f,"transform","");a.b=new ns(a.h,a.viewport,a.xa,a.aa,a.pf.bind(a))}
function Ps(a,b,c){a.Lb=!1;Rs(a);if(a.aa.pb)return ys(a.b,a.f,c).oa(function(c){Ss(a);a.j=c;c.left&&(Ts(a,c.left),c.right||c.left.K.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(Ts(a,c.right),c.left||c.right.K.setAttribute("data-vivliostyle-unpaired-page",!0));c=at(a,c);a.viewport.zoom(c.width,c.height,a.F?bt(a,c):a.zoom);a.g=b;return L(null)});Us(a,b);a.viewport.zoom(b.f.width,b.f.height,a.F?bt(a,b.f):a.zoom);a.g=b;return L(null)}
function at(a,b){var c=0,d=0;b.left&&(c+=b.left.f.width,d=b.left.f.height);b.right&&(c+=b.right.f.width,d=Math.max(d,b.right.f.height));b.left&&b.right&&(c+=2*a.aa.ic);return{width:c,height:d}}var ct={Bf:"fit inside viewport"};function bt(a,b){return Math.min(a.viewport.width/b.width,a.viewport.height/b.height)}function dt(){this.name="RenderingCanceledError";this.message="Page rendering has been canceled";this.stack=Error().stack}t(dt,Error);
function Ls(a){if(a.l){var b=a.l;Rd(b,new dt);if(b!==Ld&&b.b){b.b.h=!0;var c=new ae(b);b.w="interrupt";b.b=c;b.f.eb(c)}}a.l=null}
function Ms(a){a.Na=!1;a.Lb=!1;if(Ys(a))return L(!0);Is(a,"loading");Ls(a);var b=Td(Ld.f,function(){return Qd("resize",function(c){a.l=b;Js.f("render (resize)");$s(a);a.f&&(a.f.$=-1);ws(a.b,a.f).then(function(d){a.f=d.position;Ps(a,d.page,!0).then(function(){Vs(a).then(function(d){Is(a,"interactive");(a.Od?a.b.Od():L(null)).then(function(){a.l===b&&(a.l=null);Js.b("render (resize)");Is(a,"complete");Hs(a,{t:"loaded"});O(c,d)})})})})},function(a,b){if(b instanceof dt)Js.b("render (resize)"),u.debug(b.message);
...
Fs.prototype.La=function(a){var b=this;"complete"!==this.A&&Is(this,"loading");if("string"==typeof a.where){switch(a.where){case "next":a=this.aa.pb?this.b.hf:this.b.nextPage;break;case "previous":a=this.aa.pb?this.b.lf:this.b.Md;break;case "last":a=this.b.cf;break;case "first":a=this.b.Ze;break;default:return L(!0)}if(a){var c=a;a=function(){return c.call(b.b,b.f)}}}else if("number"==typeof a.epage){var d=a.epage;a=function(){return zs(b.b,d)}}else if("string"==typeof a.url){var e=a.url;a=function(){return Bs(b.b,
...
function gt(a,b){var c=ft(b),d=null;Sd(function(){var b=I("commandLoop"),f=Ld.f;a.G=function(b){var c="#"===b.href.charAt(0)||a.O.some(function(a){return b.href.substr(0,a.length)==a});if(c){b.preventDefault();var d={t:"hyperlink",href:b.href,internal:c};Td(f,function(){Hs(a,d);return L(!0)})}};he(function(b){if(a.Na)Ms(a).then(function(){P(b)});else if(a.Lb)a.g&&Ps(a,a.g).then(function(){P(b)});else if(c){var e=c;c=null;et(a,e).then(function(){P(b)})}else e=I("waitForCommand"),d=$d(e,self),M(e).then(function(){P(b)})}).Fa(b);
...
e[1]],[0,e[1]]),e=f[1].slice(e[1].length),0<e.length&&d.splice(c+2,0,[f[0],e]),ot(d,c,3)):a}function ot(a,b,c){for(c=b+c-1;0<=c&&c>=b-1;c--)if(c+1<a.length){var d=a[c],e=a[c+1];d[0]===e[1]&&a.splice(c,2,[d[0],d[1]+e[1]])}return a};function aq(a){return a.reduce(function(a,c){return c[0]===bq.b?a:a+c[1]},"")}function sk(a,b,c){var d=0,e=0;a.some(function(a){for(var f=0;f<a[1].length;f++){switch(a[0]*c){case bq.f:d++;break;case bq.b:d--;e++;break;case bq.g:e++}if(e>b)return!0}return!1});return Math.max(Math.min(b,e-1)+d,0)};function pt(){}pt.prototype.Fe=function(a){return{B:a,Rc:!1,Fb:!1}};pt.prototype.Re=function(){};pt.prototype.ne=function(){};pt.prototype.tc=function(){};function qt(a,b){this.b=a;this.f=b}
function rt(a,b){var c=a.b,d=c.Fe(b),e=I("LayoutIterator");he(function(a){for(var b;d.B;){b=d.B.D?1!==d.B.D.nodeType?Zj(d.B.D,d.B.Tb)?void 0:d.B.M?void 0:c.Re(d):d.B.Da?void 0:d.B.M?c.tc(d):c.ne(d):void 0;b=(b&&b.za()?b:L(!0)).oa(function(){return d.Fb?L(null):gn(this.f,d.B,d.Rc)}.bind(this));if(b.za()){b.then(function(b){d.Fb?Q(a):(d.B=b,P(a))});return}if(d.Fb){Q(a);return}d.B=b.get()}Q(a)}.bind(a)).then(function(){O(e,d.B)});return M(e)}function st(a){this.Zc=a}t(st,pt);p=st.prototype;p.Se=function(){};
p.ye=function(){};p.Fe=function(a){return{B:a,Rc:!!this.Zc&&a.M,Fb:!1,Zc:this.Zc,vc:null,Hd:!1,Ke:[],Je:null}};p.Re=function(a){a.Hd=!1};p.ne=function(a){a.Ke.push(kk(a.B));a.vc=al(a.vc,a.B.g);a.Hd=!0;return this.Se(a)};p.tc=function(a){var b;a.Hd?(b=(b=void 0,L(!0)),b=b.oa(function(){a.Fb||(a.Ke=[],a.Zc=!1,a.Rc=!1,a.vc=null);return L(!0)})):b=(b=this.ye(a))&&b.za()?b:L(!0);return b.oa(function(){a.Fb||(a.Hd=!1,a.Je=kk(a.B),a.vc=al(a.vc,a.B.F));return L(!0)})};
function tt(a,b,c){this.me=[];this.b=Object.create(a);this.b.element=b;this.b.h=a.h.clone();this.b.l=!1;this.b.Ud=c.L;a=Xn(this.b,c);this.b.F-=a;var d=this;this.b.vb=function(a){return Xm.prototype.vb.call(this,a).oa(function(a){var b=kk(a);d.me.push(b);return L(a)})}}tt.prototype.Jb=function(a){var b=this.b.Jb();if(a){a=b.Tc?b.Tc.b():Number.MAX_VALUE;var c=this.me[0],c=new Rm(kk(c),null,c.b,0),d=c.f(this.b,a);if(d&&c.b()<a)return{Tc:c,B:d}}return b};
...
function Kt(a){return Math.min.apply(null,a.b.map(function(a){return a.height}))}function Lt(a,b,c){this.rowIndex=a;this.h=b;this.g=c;this.b=c.colSpan||1;this.rowSpan=c.rowSpan||1;this.height=0;this.f=null}function Mt(a,b,c){this.rowIndex=a;this.b=b;this.wc=c}function Nt(a,b,c){this.g=a;this.b=c;this.ad=new tt(a,b,c);this.f=!1}Nt.prototype.Jb=function(){var a=this.b.D,b=this.b.O;"middle"!==b&&"bottom"!==b||v(a,"vertical-align","top");var c=this.ad.Jb(!0);v(a,"vertical-align",b);return c};
function Ot(a,b){this.D=a;this.b=b}function Pt(a,b,c,d){Rm.call(this,a,b,c,d);this.L=a.L;this.rowIndex=this.j=null}t(Pt,Rm);Pt.prototype.f=function(a,b){var c=Rm.prototype.f.call(this,a,b);return b<this.b()?null:Qt(this).every(function(a){return!!a.B})?c:null};Pt.prototype.b=function(){var a=Rm.prototype.b.call(this);Qt(this).forEach(function(b){a+=b.Tc.b()});return a};function Qt(a){a.j||(a.j=Rt(a).map(function(a){return a.Jb()}));return a.j}
function Rt(a){return St(a.L,null!=a.rowIndex?a.rowIndex:a.rowIndex=Tt(a.L,a.position.S)).map(a.L.de,a.L)}function Ut(a,b,c){this.rowIndex=a;this.j=b;this.L=c;this.h=null}t(Ut,Nm);Ut.prototype.f=function(a,b){if(b<this.b())return null;var c=Vt(this),d=Wt(this);return d.every(function(a){return!!a.B})&&d.some(function(a,b){var d=a.B,e=c[b].ad.me[0];return!(e.D===d.D&&e.M===d.M&&e.ia===d.ia)})?this.j:null};
Ut.prototype.b=function(){var a=this.L,b=0;Xt(a,a.f[this.rowIndex])||(b+=10);Wt(this).forEach(function(a){b+=a.Tc.b()});return b};function Wt(a){a.h||(a.h=Vt(a).map(function(a){return a.Jb()}));return a.h}Ut.prototype.g=function(){return Om(this.j)};function Vt(a){return Yt(a.L,a.rowIndex).map(a.L.de,a.L)}function It(a,b){this.parent=a;this.j=b;this.u=this.G=!1;this.w=-1;this.J=0;this.C=[];this.F=this.l=null;this.O=0;this.f=[];this.H=[];this.h=[];this.A=null;this.b=[];this.g=null}p=It.prototype;
p.re=function(){return"Table formatting context (vivliostyle.table.TableFormattingContext)"};p.He=function(a,b){if(!b)return b;switch(a.display){case "table-row":return!this.b.length;case "table-cell":return!this.b.some(function(b){return b.Zd.na[0].node===a.S});default:return b}};p.se=function(){return this.parent};function Zt(a,b){do if(b.S===a.j)return b.D;while(b=b.parent);return null}function $t(a,b){var c=a.H[b];c||(c=a.H[b]=[]);return c}
function Tt(a,b){return a.f.findIndex(function(a){return b===a.S})}function Yt(a,b){return $t(a,b).reduce(function(a,b){return b.wc!==a[a.length-1]?a.concat(b.wc):a},[])}function St(a,b){return Yt(a,b).filter(function(a){return a.rowIndex+a.rowSpan-1>b})}p.de=function(a){return this.h[a.rowIndex][a.h]};function Xt(a,b){return Kt(b)>a.J/2}function au(a){0>a.w&&(a.w=Math.max.apply(null,a.f.map(function(a){return a.b.reduce(function(a,b){return a+b.b},0)})));return a.w}
function bu(a,b){a.f.forEach(function(a){a.b.forEach(function(a){var c=Xj(b,a.g);a.g=null;a.height=this.u?c.width:c.height},this)},a)}p.dc=function(){return this.g};function cu(a,b){this.L=a;this.h=b;this.rowIndex=-1;this.f=0;this.g=!1}t(cu,pt);
cu.prototype.ne=function(a){var b=this.L,c=Gt(a,b,this.h);if(c)return c;a=a.B;switch(a.display){case "table":b.O=a.Y;break;case "table-caption":b.C.push(new Ot(a.D,a.X));break;case "table-header-group":this.b=!0;b=b.g;b.f||(b.f=a.D);break;case "table-footer-group":this.b=!0;b=b.g;b.b||(b.b=a.D);break;case "table-row":this.b||(this.g=!0,this.rowIndex++,this.f=0,b.f[this.rowIndex]=new Jt(this.rowIndex,a.S))}return L(!0)};
cu.prototype.tc=function(a){var b=this.L,c=a.B,d=c.display,e=this.h.b;if(c.S===b.j)c=qn(e,Zt(b,c)),b.J=parseFloat(c[b.u?"height":"width"]),a.Fb=!0;else switch(d){case "table-header-group":case "table-footer-group":this.b=!1;break;case "table-row":this.b||(b.A=c.D,this.g=!1);break;case "table-cell":if(!this.b){this.g||(this.rowIndex++,this.f=0,this.g=!0);a=this.rowIndex;c=new Lt(this.rowIndex,this.f,c.D);d=b.f[a];d||(b.f[a]=new Jt(a,null),d=b.f[a]);d.b.push(c);for(var d=a+c.rowSpan,e=$t(b,a),f=0;e[f];)f++;
for(;a<d;a++)for(var e=$t(b,a),g=f;g<f+c.b;g++){var h=e[g]=new Mt(a,g,c);c.f||(c.f=h)}this.f++}}};function du(a,b){this.Zc=!0;this.L=a;this.f=b;this.l=!1;this.b=-1;this.g=0;this.w=b.l;b.l=!1}t(du,st);var eu={"table-caption":!0,"table-column-group":!0,"table-column":!0,"table-header-group":!0,"table-footer-group":!0};
function fu(a,b,c,d){var e=b.rowIndex,f=b.h,g=c.D;if(1<b.b){v(g,"box-sizing","border-box");for(var h=a.L.F,l=0,k=0;k<b.b;k++)l+=h[b.f.b+k];l+=a.L.O*(b.b-1);v(g,a.L.u?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new Nt(a.f,b,c);a=a.L;(g=a.h[e])||(g=a.h[e]=[]);g[f]=c;1===d.Ba.na.length&&d.Ba.M&&(c.f=!0);return zn(c.ad.b,d,!0).md(!0)}function gu(a,b){var c=a.L.b[0];return c?c.wc.f.b===b:!1}
function hu(a){var b=a.L.b;if(!b.length)return[];var c=[],d=0;do{var e=b[d],f=e.wc.rowIndex;if(f<a.b){var g=c[f];g||(g=c[f]=[]);g.push(e);b.splice(d,1)}else d++}while(d<b.length);return c}
function iu(a,b){var c=a.L,d=hu(a),e=d.reduce(function(a){return a+1},0);if(0===e)return L(!0);var f=a.f.h,g=b.B;g.D.parentNode.removeChild(g.D);var h=I("layoutRowSpanningCellsFromPreviousFragment"),l=L(!0),k=0,m=[];d.forEach(function(a){l=l.oa(function(){var b=ik(a[0].Zd.na[1],g.parent);return an(f,b,!1).oa(function(){function d(a){for(;h<a;){if(!(0<=m.indexOf(h))){var c=b.D.ownerDocument.createElement("td");v(c,"padding","0");b.D.appendChild(c)}h++}}var g=L(!0),h=0;a.forEach(function(a){g=g.oa(function(){var c=
a.wc;d(c.f.b);var g=a.Zd,l=ik(g.na[0],b);l.ia=g.ia;l.M=g.M;return an(f,l,!1).oa(function(){for(var b=a.ue,d=0;d<c.b;d++)m.push(h+d);h+=c.b;return fu(this,c,l,b).oa(function(){l.D.rowSpan=c.rowIndex+c.rowSpan-this.b+e-k;return L(!0)}.bind(this))}.bind(this))}.bind(this))},this);return g.oa(function(){d(au(c));k++;return L(!0)})}.bind(this))}.bind(this))},a);l.then(function(){an(f,g,!0,b.Rc).then(function(){O(h,!0)})});return M(h)}
function ju(a,b){if(a.j||a.h)return L(!0);var c=b.B,d=a.L;0>a.b?a.b=Tt(d,c.S):a.b++;a.g=0;a.l=!0;return iu(a,b).oa(function(){bo(this.f,b.Je,null,!0,b.vc)&&!St(d,this.b-1).length&&(this.f.l=this.w,c.b=!0,b.Fb=!0);return L(!0)}.bind(a))}
...
du.prototype.Se=function(a){var b=Gt(a,this.L,this.f);if(b)return b;b=a.B.display;return"table-header-group"===b?(this.j=!0,L(!0)):"table-footer-group"===b?(this.h=!0,L(!0)):"table-row"===b?ju(this,a):"table-cell"===b?ku(this,a):L(!0)};du.prototype.ye=function(a){a=a.B;"table-row"===a.display&&(this.l=!1,this.j||this.h||(a=kk(a).modify(),a.M=!1,this.f.C.push(new Ut(this.b,a,this.L))));return L(!0)};
du.prototype.tc=function(a){var b=a.B,c=b.display;"table-header-group"===c?this.j=!1:"table-footer-group"===c&&(this.h=!1);if(c&&eu[c])b.D.parentNode.removeChild(b.D);else if(b.S===this.L.j)this.f.l=this.w,a.Fb=!0;else return st.prototype.tc.call(this,a);return L(!0)};function lu(){}
...
lu.prototype.b=function(a,b){var c=b.L,d=c.g;d.j||b.S===c.j&&b.M||yt(d);if("table-row"===b.display){var e=Tt(c,b.S);c.b=[];var f;f=b.M?St(c,e):Yt(c,e);if(f.length){var g=I("TableLayoutProcessor.finishBreak"),h=0;he(function(a){if(h===f.length)Q(a);else{var b=f[h++],d=c.de(b),g=d.Jb().B,l=d.b,q=rk(l),z=new vk(rk(g));c.b.push({Zd:q,ue:z,wc:b});l=l.D;jo(d.b);e<b.rowIndex+b.rowSpan-1&&(l.rowSpan=e-b.rowIndex+1);d.f?P(a):Rn(d.ad.b,g,!1,!0).then(function(){var b=c.dc();if(b){var e=c.u,f=d.g,g=d.ad.b.element,
h=d.b.D,k=Xj(f.b,h),h=rn(f,h);e?v(g,"max-width",k.right-f.F-Sm(b)-h.right+"px"):v(g,"max-height",f.F-Sm(b)-k.top-h.top+"px");v(g,"overflow","hidden")}P(a)})}}).then(function(){d&&wt(d);c.h=[];go(b,!1);jo(b);O(g,!0)});return M(g)}}d&&wt(d);c.h=[];return null};function uu(a,b){if(b.G){var c=b.dc();a.S===b.j&&!a.M&&c&&(c.h=!1,c.l=!1);return new vu}return new wu}function wu(){}wu.prototype.g=function(a,b,c){return ru(a,b,c)};wu.prototype.f=function(a){return!!a};wu.prototype.b=function(a,b){b.G=!0};
...
Object.assign||(Object.assign=function(a,b){if(!b)return a;Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function yu(a){function b(a){return"number"===typeof a?a:null}function c(a){return"string"===typeof a?{url:a,hb:null,Zb:null}:{url:a.url,hb:b(a.startPage),Zb:b(a.skipPagesBefore)}}return Array.isArray(a)?a.map(c):a?[c(a)]:null}function zu(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}
function Au(a,b){mj=a.debug;this.g=!1;this.h=a;this.Db=new Fs(a.window||window,a.viewportElement,"main",this.Ye.bind(this));this.f={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,pageViewMode:"autoSpread",zoom:1,fitToScreen:!1};b&&this.Qe(b);this.b=new Ta;Object.defineProperty(this,"readyState",{get:function(){return this.Db.A}})}p=Au.prototype;p.Qe=function(a){var b=Object.assign({a:"configure"},zu(a));this.Db.w(b);Object.assign(this.f,a)};
p.Ye=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});Ua(this.b,b)};p.qf=function(a,b){this.b.addEventListener(a,b,!1)};p.tf=function(a,b){this.b.removeEventListener(a,b,!1)};p.df=function(a,b,c){a||Ua(this.b,{type:"error",content:"No URL specified"});Bu(this,a,null,b,c)};p.rf=function(a,b,c){a||Ua(this.b,{type:"error",content:"No URL specified"});Bu(this,null,a,b,c)};
...
p.ff=function(a){a:switch(a){case "left":a="ltr"===this.Kb()?"previous":"next";break a;case "right":a="ltr"===this.Kb()?"next":"previous"}this.Db.w({a:"moveTo",where:a})};p.ef=function(a){this.Db.w({a:"moveTo",url:a})};p.sf=function(a){a:{var b=this.Db;if(!b.g)throw Error("no page exists.");switch(a){case "fit inside viewport":a=bt(b,b.aa.pb?at(b,b.j):b.g.f);break a;default:throw Error("unknown zoom type: "+a);}}return a};p.$e=function(){return this.Db.fa};ba("vivliostyle.viewer.Viewer",Au);
Au.prototype.setOptions=Au.prototype.Qe;Au.prototype.addListener=Au.prototype.qf;Au.prototype.removeListener=Au.prototype.tf;Au.prototype.loadDocument=Au.prototype.df;Au.prototype.loadEPUB=Au.prototype.rf;Au.prototype.getCurrentPageProgression=Au.prototype.Kb;Au.prototype.navigateToPage=Au.prototype.ff;Au.prototype.navigateToInternalUrl=Au.prototype.ef;Au.prototype.queryZoomFactor=Au.prototype.sf;Au.prototype.getPageSizes=Au.prototype.$e;ba("vivliostyle.viewer.ZoomType",ct);
...
function Iu(a){switch(a.t){case "loaded":a=a.viewer;var b=Du=a.Kb();a.od.setAttribute("data-vivliostyle-page-progression",b);a.od.setAttribute("data-vivliostyle-spread-view",a.aa.pb);window.addEventListener("keydown",Hu,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Fu,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Gu,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
