...
rb.prototype.h=function(a){if(0<this.offset&&!a.I){for(var b=this.offset,c=a.node;;){var d=c.nodeType;if(1==d)break;var e=c.nextSibling;if(3<=d&&5>=d){d=c.textContent.length;if(b<=d)break;if(!e){b=d;break}b-=d}if(!e){b=0;break}c=e}a.node=c;a.offset=b}a.Db=this.Db;return!0};
...
a.lang=d.toLowerCase();d=a.sa;var e=a.Rb;a.Pa=++e[e.length-1];e.push(0);var e=a.ra,f=a.Eb=e[e.length-1],g=f[a.j];g||(g=f[a.j]={});g[a.f]=(g[a.f]||0)+1;e.push({});e=a.Qb;null!==e[e.length-1]?a.P=--e[e.length-1]:a.P=null;e.push(null);e=a.Pb;(f=a.xb=e[e.length-1])&&f[a.j]&&f[a.j][a.f]--;e.push({});wj(a);Cj(a,b);e=c.quotes;c=null;e&&(e=e.evaluate(a.l))&&(c=new Wi(a.J),e===J?a.J=[new Lc(""),new Lc("")]:e instanceof Ec&&(a.J=e.values));yj(a,a.F);e=a.X||a.ha||b.getAttribute("name")||"";if(d||e){var h={};
...
function nt(a,b,c,d,e,f,g,h,l,k,m){Nb.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.ba=b;this.lang=b.lang||c;this.viewport=d;this.l={body:!0};this.g=e;this.B=this.b=this.H=this.f=this.F=null;this.C=0;this.xb=f;this.j=new rm(this.style.B);this.va={};this.X=null;this.h=m;this.Eb=new an(null,null,null,null,null,null,null);this.P={};this.sa=null;this.ib=g;this.wb=h;this.Y=l;this.qb=k;for(var p in a.h)(b=a.h[p]["flow-consume"])&&(b.evaluate(this,"flow-consume")==Uc?this.l[p]=!0:delete this.l[p]);
...
n.Zb=function(a){return this.b.H?this.b.H:(a=this.yc[a?a.S:0])?a.fb.sa:null};
...
g.tb?q=g.tb-1:(q=q?q.fb.Y+q.Cb.length:0,null!==g.xc&&(q+=g.xc));Xp(a.f,q);var r=new nt(k,f,a.b.lang,p,a.h,a.j,l,a.b.G,q,a.b.u,a.f);r.Z=a.Z;ot(r).then(function(){c={item:g,ba:f,fb:r,gb:[null],Cb:[],complete:!1};a.yc[b]=c;O(d,c);e.forEach(function(a){a.pb(c)})})});return d.result()}function Ju(a){for(var b=t(a.yc),c=b.next();!c.done;c=b.next())(c=c.value)&&c.Cb.splice(0);for(a=a.viewport.root;a.lastChild;)a.removeChild(a.lastChild)}
...
n.yg=function(a){a:switch(a){case "left":a="ltr"===this.Zb()?"previous":"next";break a;case "right":a="ltr"===this.Zb()?"next":"previous"}this.Sb.u({a:"moveTo",where:a})};n.xg=function(a){this.Sb.u({a:"moveTo",url:a})};n.Lg=function(a){a:{var b=this.Sb;if(!b.g)throw Error("no page exists.");switch(a){case "fit inside viewport":a=iv(b,b.Z.sb?hv(b,b.j):b.g.f);break a;default:throw Error("unknown zoom type: "+a);}}return a};n.tg=function(){return this.Sb.ga};na("vivliostyle.viewer.Viewer",xx);
