 ...
 *
 * Vivliostyle core 2019.1.100-pre.20190116012728
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function la(a,b){fa();a instanceof String&&(a+="");var c=0,d={next:function(){if(c<a.length){var e=c++;return{value:b(e,a[e]),done:!1}}d.next=function(){return{done:!0,value:void 0}};return d.next()}};d[Symbol.iterator]=function(){return d};return d}ja("Array.prototype.values",function(a){return a?a:function(){return la(this,function(a,c){return c})}});
...
rb.prototype.h=function(a){if(0<this.offset&&!a.K){for(var b=this.offset,c=a.node;;){var d=c.nodeType;if(1==d)break;var e=c.nextSibling;if(3<=d&&5>=d){d=c.textContent.length;if(b<=d)break;if(!e){b=d;break}b-=d}if(!e){b=0;break}c=e}a.node=c;a.offset=b}a.Db=this.Db;return!0};
rb.prototype.g=function(a){a.append(":");a.append(this.offset.toString());if(this.f||this.b||this.Db){a.append("[");if(this.f||this.b)this.f&&a.append(this.f.replace(/[\[\]\(\),=;^]/g,kb)),a.append(","),this.b&&a.append(this.b.replace(/[\[\]\(\),=;^]/g,kb));this.Db&&(a.append(";s="),a.append(this.Db));a.append("]")}};function sb(){this.pa=null}
...
if(!c)throw Error("E_CFI_NUMBER_EXPECTED");e+=c[0].length;g=parseInt(c[1],10);(h=c[4])&&(h=mb(h));var l=c[7];l&&(l=mb(l));c=nb(c[10]);f.push(new rb(g,h,l,Ga(c.s)));break;case "!":e++;f.push(new ob);break;case "~":case "@":case "":a.pa=f;return;default:throw Error("E_CFI_PARSE_ERROR");}}function ub(a,b){for(var c={node:b.documentElement,offset:0,K:!1,Db:null,ld:null},d=0;d<a.pa.length;d++)if(!a.pa[d].h(c)){c.ld=new sb;c.ld.pa=a.pa.slice(d+1);break}return c}
...
function Nb(a,b,c,d){this.Pa=b;this.Fb=c;this.O=null;this.ec=function(){return this.O?this.O:this.Z.tb?Math.floor(b/2)-this.Z.xc:b};this.N=null;this.dc=function(){return this.N?this.N:c};this.u=d;this.sa=null;this.fontSize=function(){return this.sa?this.sa:d};this.Z=yb;this.H={}}function Ob(a,b){a.H[b.u]={};for(var c=0;c<b.children.length;c++)Ob(a,b.children[c])}
function Pb(a,b,c){return"vw"==b?a.ec()/100:"vh"==b?a.dc()/100:"em"==b||"rem"==b?c?a.u:a.fontSize():"ex"==b?Lb.ex*(c?a.u:a.fontSize())/Lb.em:Lb[b]}function Qb(a,b,c){do{var d=b.values[c];if(d||b.l&&(d=b.l.call(a,c,!1)))return d;b=b.parent}while(b);throw Error("Name '"+c+"' is undefined");}
...
function Sb(a,b,c){var d="",e=b.match(/^(min|max)-(.*)$/);e&&(d=e[1],b=e[2]);var f=e=null;switch(b){case "width":case "height":case "device-width":case "device-height":case "color":c&&(e=c.evaluate(a))}switch(b){case "width":f=a.ec();break;case "height":f=a.dc();break;case "device-width":f=window.screen.availWidth;break;case "device-height":f=window.screen.availHeight;break;case "color":f=window.screen.pixelDepth}if(null!=f&&null!=e)switch(d){case "min":return f>=e;case "max":return f<=e;default:return f==
e}else if(null!=f&&!c)return!!f;return!1}function Tb(a){this.b=a;this.g="_"+Eb++}n=Tb.prototype;n.toString=function(){var a=new Pa;this.Fa(a,0);return a.toString()};n.Fa=function(){throw Error("F_ABSTRACT");};n.sb=function(){throw Error("F_ABSTRACT");};n.kb=function(){return this};n.qc=function(a){return a===this};function Ub(a,b,c,d){var e=d[a.g];if(null!=e)return e===zb?!1:e;d[a.g]=zb;b=a.qc(b,c,d);return d[a.g]=b}
n.evaluate=function(a){var b;b=(b=a.H[this.b.u])?b[this.g]:void 0;if("undefined"!=typeof b)return b;b=this.sb(a);var c=this.g,d=this.b,e=a.H[d.u];e||(e={},a.H[d.u]=e);return e[c]=b};n.bf=function(){return!1};function Vb(a,b){Tb.call(this,a);this.f=b}v(Vb,Tb);n=Vb.prototype;n.Qe=function(){throw Error("F_ABSTRACT");};n.Xe=function(){throw Error("F_ABSTRACT");};n.sb=function(a){a=this.f.evaluate(a);return this.Xe(a)};n.qc=function(a,b,c){return a===this||Ub(this.f,a,b,c)};
n.Fa=function(a,b){10<b&&a.append("(");a.append(this.Qe());this.f.Fa(a,10);10<b&&a.append(")")};n.kb=function(a,b){var c=this.f.kb(a,b);return c===this.f?this:new this.constructor(this.b,c)};function Wb(a,b,c){Tb.call(this,a);this.f=b;this.h=c}v(Wb,Tb);n=Wb.prototype;n.wd=function(){throw Error("F_ABSTRACT");};n.cb=function(){throw Error("F_ABSTRACT");};n.Cb=function(){throw Error("F_ABSTRACT");};n.sb=function(a){var b=this.f.evaluate(a);a=this.h.evaluate(a);return this.Cb(b,a)};
n.qc=function(a,b,c){return a===this||Ub(this.f,a,b,c)||Ub(this.h,a,b,c)};n.Fa=function(a,b){var c=this.wd();c<=b&&a.append("(");this.f.Fa(a,c);a.append(this.cb());this.h.Fa(a,c);c<=b&&a.append(")")};n.kb=function(a,b){var c=this.f.kb(a,b),d=this.h.kb(a,b);return c===this.f&&d===this.h?this:new this.constructor(this.b,c,d)};function Xb(a,b,c){Wb.call(this,a,b,c)}v(Xb,Wb);Xb.prototype.wd=function(){return 1};function Yb(a,b,c){Wb.call(this,a,b,c)}v(Yb,Wb);Yb.prototype.wd=function(){return 2};
function Zb(a,b,c){Wb.call(this,a,b,c)}v(Zb,Wb);Zb.prototype.wd=function(){return 3};function $b(a,b,c){Wb.call(this,a,b,c)}v($b,Wb);$b.prototype.wd=function(){return 4};function ac(a,b){Vb.call(this,a,b)}v(ac,Vb);ac.prototype.Qe=function(){return"!"};ac.prototype.Xe=function(a){return!a};function bc(a,b){Vb.call(this,a,b)}v(bc,Vb);bc.prototype.Qe=function(){return"-"};bc.prototype.Xe=function(a){return-a};function cc(a,b,c){Wb.call(this,a,b,c)}v(cc,Xb);cc.prototype.cb=function(){return"&&"};
cc.prototype.sb=function(a){return this.f.evaluate(a)&&this.h.evaluate(a)};function dc(a,b,c){Wb.call(this,a,b,c)}v(dc,cc);dc.prototype.cb=function(){return" and "};function ec(a,b,c){Wb.call(this,a,b,c)}v(ec,Xb);ec.prototype.cb=function(){return"||"};ec.prototype.sb=function(a){return this.f.evaluate(a)||this.h.evaluate(a)};function fc(a,b,c){Wb.call(this,a,b,c)}v(fc,ec);fc.prototype.cb=function(){return", "};function gc(a,b,c){Wb.call(this,a,b,c)}v(gc,Yb);gc.prototype.cb=function(){return"<"};
gc.prototype.Cb=function(a,b){return a<b};function hc(a,b,c){Wb.call(this,a,b,c)}v(hc,Yb);hc.prototype.cb=function(){return"<="};hc.prototype.Cb=function(a,b){return a<=b};function ic(a,b,c){Wb.call(this,a,b,c)}v(ic,Yb);ic.prototype.cb=function(){return">"};ic.prototype.Cb=function(a,b){return a>b};function jc(a,b,c){Wb.call(this,a,b,c)}v(jc,Yb);jc.prototype.cb=function(){return">="};jc.prototype.Cb=function(a,b){return a>=b};function kc(a,b,c){Wb.call(this,a,b,c)}v(kc,Yb);kc.prototype.cb=function(){return"=="};
kc.prototype.Cb=function(a,b){return a==b};function lc(a,b,c){Wb.call(this,a,b,c)}v(lc,Yb);lc.prototype.cb=function(){return"!="};lc.prototype.Cb=function(a,b){return a!=b};function mc(a,b,c){Wb.call(this,a,b,c)}v(mc,Zb);mc.prototype.cb=function(){return"+"};mc.prototype.Cb=function(a,b){return a+b};function nc(a,b,c){Wb.call(this,a,b,c)}v(nc,Zb);nc.prototype.cb=function(){return" - "};nc.prototype.Cb=function(a,b){return a-b};function oc(a,b,c){Wb.call(this,a,b,c)}v(oc,$b);oc.prototype.cb=function(){return"*"};
oc.prototype.Cb=function(a,b){return a*b};function pc(a,b,c){Wb.call(this,a,b,c)}v(pc,$b);pc.prototype.cb=function(){return"/"};pc.prototype.Cb=function(a,b){return a/b};function qc(a,b,c){Wb.call(this,a,b,c)}v(qc,$b);qc.prototype.cb=function(){return"%"};qc.prototype.Cb=function(a,b){return a%b};function rc(a,b,c){Tb.call(this,a);this.L=b;this.ka=c.toLowerCase()}v(rc,Tb);rc.prototype.Fa=function(a){a.append(this.L.toString());a.append(Ra(this.ka))};
rc.prototype.sb=function(a){return this.L*Pb(a,this.ka,!1)};function sc(a,b){Tb.call(this,a);this.f=b}v(sc,Tb);sc.prototype.Fa=function(a){a.append(this.f)};sc.prototype.sb=function(a){return Qb(a,this.b,this.f).evaluate(a)};sc.prototype.qc=function(a,b,c){return a===this||Ub(Qb(b,this.b,this.f),a,b,c)};function tc(a,b,c){Tb.call(this,a);this.f=b;this.name=c}v(tc,Tb);tc.prototype.Fa=function(a){this.f&&a.append("not ");a.append(Ra(this.name))};
tc.prototype.sb=function(a){var b=this.name;a="all"===b||!!a.Z.We[b];return this.f?!a:a};tc.prototype.qc=function(a,b,c){return a===this||Ub(this.value,a,b,c)};tc.prototype.bf=function(){return!0};function Ib(a,b,c){Tb.call(this,a);this.Kc=b;this.Qc=c}v(Ib,Tb);Ib.prototype.Fa=function(a){a.append(this.Qc)};Ib.prototype.sb=function(a){return this.Kc.call(a)};function uc(a,b,c){Tb.call(this,a);this.h=b;this.f=c}v(uc,Tb);
uc.prototype.Fa=function(a){a.append(this.h);var b=this.f;a.append("(");for(var c=0;c<b.length;c++)c&&a.append(","),b[c].Fa(a,0);a.append(")")};uc.prototype.sb=function(a){return Rb(a,this.b,this.h,this.f,!1).kb(a,this.f).evaluate(a)};uc.prototype.qc=function(a,b,c){if(a===this)return!0;for(var d=0;d<this.f.length;d++)if(Ub(this.f[d],a,b,c))return!0;return Ub(Rb(b,this.b,this.h,this.f,!0),a,b,c)};
uc.prototype.kb=function(a,b){for(var c=this.f,d=c,e=0;e<c.length;e++){var f=c[e].kb(a,b);if(c!==d)d[e]=f;else if(f!==c[e]){for(var d=Array(c.length),g=0;g<e;g++)d[g]=c[g];d[e]=f}}c=d;return c===this.f?this:new uc(this.b,this.h,c)};function vc(a,b,c,d){Tb.call(this,a);this.f=b;this.j=c;this.h=d}v(vc,Tb);vc.prototype.Fa=function(a,b){0<b&&a.append("(");this.f.Fa(a,0);a.append("?");this.j.Fa(a,0);a.append(":");this.h.Fa(a,0);0<b&&a.append(")")};
vc.prototype.sb=function(a){return this.f.evaluate(a)?this.j.evaluate(a):this.h.evaluate(a)};vc.prototype.qc=function(a,b,c){return a===this||Ub(this.f,a,b,c)||Ub(this.j,a,b,c)||Ub(this.h,a,b,c)};vc.prototype.kb=function(a,b){var c=this.f.kb(a,b),d=this.j.kb(a,b),e=this.h.kb(a,b);return c===this.f&&d===this.j&&e===this.h?this:new vc(this.b,c,d,e)};function Gb(a,b){Tb.call(this,a);this.f=b}v(Gb,Tb);
Gb.prototype.Fa=function(a){switch(typeof this.f){case "number":case "boolean":a.append(this.f.toString());break;case "string":a.append('"');a.append(Sa(this.f));a.append('"');break;default:throw Error("F_UNEXPECTED_STATE");}};Gb.prototype.sb=function(){return this.f};function wc(a,b,c){Tb.call(this,a);this.name=b;this.value=c}v(wc,Tb);wc.prototype.Fa=function(a){a.append("(");a.append(Sa(this.name.name));a.append(":");this.value.Fa(a,0);a.append(")")};
wc.prototype.sb=function(a){return Sb(a,this.name.name,this.value)};wc.prototype.qc=function(a,b,c){return a===this||Ub(this.value,a,b,c)};wc.prototype.kb=function(a,b){var c=this.value.kb(a,b);return c===this.value?this:new wc(this.b,this.name,c)};function xc(a,b){Tb.call(this,a);this.index=b}v(xc,Tb);xc.prototype.Fa=function(a){a.append("$");a.append(this.index.toString())};xc.prototype.kb=function(a,b){var c=b[this.index];if(!c)throw Error("Parameter missing: "+this.index);return c};
function yc(a,b,c){return b===a.h||b===a.b||c==a.h||c==a.b?a.h:b===a.j||b===a.f?c:c===a.j||c===a.f?b:new cc(a,b,c)}function y(a,b,c){return b===a.b?c:c===a.b?b:new mc(a,b,c)}function B(a,b,c){return b===a.b?new bc(a,c):c===a.b?b:new nc(a,b,c)}function zc(a,b,c){return b===a.b||c===a.b?a.b:b===a.f?c:c===a.f?b:new oc(a,b,c)}function Ac(a,b,c){return b===a.b?a.b:c===a.f?b:new pc(a,b,c)};var Bc={};function Cc(){}n=Cc.prototype;n.lc=function(a){for(var b=0;b<a.length;b++)a[b].ea(this)};n.Ne=function(){throw Error("E_CSS_EMPTY_NOT_ALLOWED");};n.Oe=function(){throw Error("E_CSS_SLASH_NOT_ALLOWED");};n.sd=function(){throw Error("E_CSS_STR_NOT_ALLOWED");};n.kc=function(){throw Error("E_CSS_IDENT_NOT_ALLOWED");};n.Uc=function(){throw Error("E_CSS_NUMERIC_NOT_ALLOWED");};n.Tc=function(){throw Error("E_CSS_NUM_NOT_ALLOWED");};n.Sc=function(a){return this.Tc(a)};
n.ce=function(){throw Error("E_CSS_COLOR_NOT_ALLOWED");};n.Vc=function(){throw Error("E_CSS_URL_NOT_ALLOWED");};n.Mb=function(){throw Error("E_CSS_LIST_NOT_ALLOWED");};n.jc=function(){throw Error("E_CSS_COMMA_NOT_ALLOWED");};n.Rb=function(){throw Error("E_CSS_FUNC_NOT_ALLOWED");};n.Rc=function(){throw Error("E_CSS_EXPR_NOT_ALLOWED");};function Dc(){}v(Dc,Cc);n=Dc.prototype;
n.lc=function(a){for(var b=null,c=0;c<a.length;c++){var d=a[c],e=d.ea(this);if(b)b[c]=e;else if(d!==e){b=Array(a.length);for(d=0;d<c;d++)b[d]=a[d];b[c]=e}}return b||a};n.sd=function(a){return a};n.kc=function(a){return a};n.Oe=function(a){return a};n.Uc=function(a){return a};n.Tc=function(a){return a};n.Sc=function(a){return a};n.ce=function(a){return a};n.Vc=function(a){return a};n.Mb=function(a){var b=this.lc(a.values);return b===a.values?a:new Ec(b)};
n.jc=function(a){var b=this.lc(a.values);return b===a.values?a:new Fc(b)};n.Rb=function(a){var b=this.lc(a.values);return b===a.values?a:new Gc(a.name,b)};n.Rc=function(a){return a};function Hc(){}n=Hc.prototype;n.toString=function(){var a=new Pa;this.Ya(a,!0);return a.toString()};n.stringValue=function(){var a=new Pa;this.Ya(a,!1);return a.toString()};n.za=function(){throw Error("F_ABSTRACT");};n.Ya=function(a){a.append("[error]")};n.$e=function(){return!1};n.uc=function(){return!1};n.cf=function(){return!1};
n.Pf=function(){return!1};n.Nd=function(){return!1};function Ic(){if(C)throw Error("E_INVALID_CALL");}v(Ic,Hc);Ic.prototype.za=function(a){return new Gb(a,"")};Ic.prototype.Ya=function(){};Ic.prototype.ea=function(a){return a.Ne(this)};var C=new Ic;function Jc(){if(Kc)throw Error("E_INVALID_CALL");}v(Jc,Hc);Jc.prototype.za=function(a){return new Gb(a,"/")};Jc.prototype.Ya=function(a){a.append("/")};Jc.prototype.ea=function(a){return a.Oe(this)};var Kc=new Jc;function Lc(a){this.Qc=a}v(Lc,Hc);
Lc.prototype.za=function(a){return new Gb(a,this.Qc)};Lc.prototype.Ya=function(a,b){b?(a.append('"'),a.append(Sa(this.Qc)),a.append('"')):a.append(this.Qc)};Lc.prototype.ea=function(a){return a.sd(this)};function Mc(a){this.name=a;if(Bc[a])throw Error("E_INVALID_CALL");Bc[a]=this}v(Mc,Hc);Mc.prototype.za=function(a){return new Gb(a,this.name)};Mc.prototype.Ya=function(a,b){b?a.append(Ra(this.name)):a.append(this.name)};Mc.prototype.ea=function(a){return a.kc(this)};Mc.prototype.Pf=function(){return!0};
function D(a){var b=Bc[a];b||(b=new Mc(a));return b}function F(a,b){this.L=a;this.ka=b.toLowerCase()}v(F,Hc);F.prototype.za=function(a,b){return this.L?b&&"%"==this.ka?100==this.L?b:new oc(a,b,new Gb(a,this.L/100)):new rc(a,this.L,this.ka):a.b};F.prototype.Ya=function(a){a.append(this.L.toString());a.append(this.ka)};F.prototype.ea=function(a){return a.Uc(this)};F.prototype.uc=function(){return!0};function Nc(a){this.L=a}v(Nc,Hc);
Nc.prototype.za=function(a){return this.L?1==this.L?a.f:new Gb(a,this.L):a.b};Nc.prototype.Ya=function(a){a.append(this.L.toString())};Nc.prototype.ea=function(a){return a.Tc(this)};Nc.prototype.cf=function(){return!0};function Oc(a){this.L=a}v(Oc,Nc);Oc.prototype.ea=function(a){return a.Sc(this)};function Pc(a){this.b=a}v(Pc,Hc);Pc.prototype.Ya=function(a){a.append("#");var b=this.b.toString(16);a.append("000000".substr(b.length));a.append(b)};Pc.prototype.ea=function(a){return a.ce(this)};
function Qc(a){this.url=a}v(Qc,Hc);Qc.prototype.Ya=function(a){a.append('url("');a.append(Sa(this.url));a.append('")')};Qc.prototype.ea=function(a){return a.Vc(this)};function Rc(a,b,c,d){var e=b.length;b[0].Ya(a,d);for(var f=1;f<e;f++)a.append(c),b[f].Ya(a,d)}function Ec(a){this.values=a}v(Ec,Hc);Ec.prototype.Ya=function(a,b){Rc(a,this.values," ",b)};Ec.prototype.ea=function(a){return a.Mb(this)};Ec.prototype.Nd=function(){return!0};function Fc(a){this.values=a}v(Fc,Hc);
Fc.prototype.Ya=function(a,b){Rc(a,this.values,",",b)};Fc.prototype.ea=function(a){return a.jc(this)};function Gc(a,b){this.name=a;this.values=b}v(Gc,Hc);Gc.prototype.Ya=function(a,b){a.append(Ra(this.name));a.append("(");Rc(a,this.values,",",b);a.append(")")};Gc.prototype.ea=function(a){return a.Rb(this)};function G(a){this.Hc=a}v(G,Hc);G.prototype.za=function(){return this.Hc};G.prototype.Ya=function(a){a.append("-epubx-expr(");this.Hc.Fa(a,0);a.append(")")};G.prototype.ea=function(a){return a.Rc(this)};
G.prototype.$e=function(){return!0};function Sc(a,b){if(a){if(a.uc())return Pb(b,a.ka,!1)*a.L;if(a.cf())return a.L}return 0}var Tc=D("absolute"),Uc=D("all"),Vc=D("always"),Wc=D("auto");D("avoid");var Xc=D("balance"),Yc=D("balance-all"),Zc=D("block"),$c=D("block-end"),ad=D("block-start"),bd=D("both"),cd=D("bottom"),dd=D("border-box"),ed=D("break-all"),fd=D("break-word"),gd=D("crop"),hd=D("cross");D("column");
...
l=k}f.b[l]=g}if(!c.g){var m=c.f;c.f=null;m&&m.b==c&&(m.b=null,l=fe,fe=m,O(m.top,c.result),fe=l)}b=a.g.currentTime();if(b>=a.l)break}}catch(p){w.error(p)}a.j=!1;a.f.length()&&re(a)},b)}}oe.prototype.qb=function(a,b){var c=this.g.currentTime();a.order=this.order++;a.b=c+(b||0);a:{for(var c=this.f,d=c.b.length;1<d;){var e=Math.floor(d/2),f=c.b[e];if(0<se(f,a)){c.b[d]=a;break a}c.b[d]=f;d=e}c.b[1]=a}re(this)};
function ne(a,b,c){var d=new te(a,c||"");d.top=new he(d,null,"bootstrap");d.top.b=ie;d.top.then(function(){function a(){d.j=!1;for(var a=t(d.h),b=a.next();!b.done;b=a.next()){b=b.value;try{b()}catch(h){w.error(h)}}}try{b().then(function(b){d.result=b;a()})}catch(f){le(d,f),a()}});c=fe;fe=d;a.qb(ue(d.top,"bootstrap"));fe=c;return d}function ve(a){this.f=a;this.order=this.b=0;this.result=null;this.g=!1}function se(a,b){return b.b-a.b||b.order-a.order}
ve.prototype.qb=function(a,b){this.result=a;this.f.f.qb(this,b)};function te(a,b){this.f=a;this.name=b;this.h=[];this.g=null;this.j=!0;this.b=this.top=this.l=this.result=null}function we(a,b){a.h.push(b)}te.prototype.join=function(){var a=L("Task.join");if(this.j){var b=ue(a,this),c=this;we(this,function(){b.qb(c.result)})}else O(a,this.result);return a.result()};
function le(a,b,c){var d=b.frameTrace;if(!d){for(var d=b.stack?b.stack+"\n\t---- async ---\n":"",e=a.top;e;e=e.parent)d+="\t",d+=e.name,d+="\n";b.frameTrace=d}if(c){for(d=a.top;d&&d!=c;)d=d.parent;d==c&&(a.top=d)}for(a.g=b;a.top&&!a.top.j;)a.top=a.top.parent;a.top?(b=a.g,a.g=null,a.top.j(a.top,b)):a.g&&w.error(a.g,"Unhandled exception in task",a.name)}function je(a){this.value=a}n=je.prototype;n.then=function(a){a(this.value)};n.ha=function(a){return a(this.value)};n.Cc=function(a){return new je(a)};
n.Ja=function(a){O(a,this.value)};n.Wa=function(){return!1};n.get=function(){return this.value};function xe(a){this.b=a}n=xe.prototype;n.then=function(a){this.b.then(a)};n.ha=function(a){if(this.Wa()){var b=new he(this.b.f,this.b.parent,"AsyncResult.thenAsync");b.b=ie;this.b.parent=b;this.b.then(function(c){a(c).then(function(a){O(b,a)})});return b.result()}return a(this.b.g)};n.Cc=function(a){return this.Wa()?this.ha(function(){return new je(a)}):new je(a)};
n.Ja=function(a){this.Wa()?this.then(function(b){O(a,b)}):O(a,this.b.g)};n.Wa=function(){return this.b.b==ie};n.get=function(){if(this.Wa())throw Error("Result is pending");return this.b.g};function he(a,b,c){this.f=a;this.parent=b;this.name=c;this.g=null;this.b=0;this.j=this.h=null}function ye(a){if(!fe)throw Error("F_TASK_NO_CONTEXT");if(a!==fe.top)throw Error("F_TASK_NOT_TOP_FRAME");}he.prototype.result=function(){return new xe(this)};
...
function ze(){var a=L("Frame.timeSlice"),b=a.f.f;b.g.currentTime()>=b.l?(w.debug("-- time slice --"),ue(a).qb(!0)):O(a,!0);return a.result()}function Ae(a){var b=L("Frame.sleep");ue(b).qb(!0,a);return b.result()}function Be(a){function b(d){try{for(;d;){var e=a();if(e.Wa()){e.then(b);return}e.then(function(a){d=a})}O(c,!0)}catch(f){le(c.f,f,c)}}var c=L("Frame.loop");b(!0);return c.result()}
...
function Ge(a){if(!a.length)return M(!0);if(1==a.length)return a[0].get().Cc(!0);var b=L("waitForFetches"),c=0;Be(function(){for(;c<a.length;){var b=a[c++];if(!b.f)return b.get().Cc(!0)}return M(!1)}).then(function(){O(b,!0)});return b.result()}
function He(a,b){var c=null,d=null;"img"==a.localName&&(c=a.getAttribute("width"),d=a.getAttribute("height"));var e=new Ee(function(){function e(b){l||(l=!0,"img"==a.localName&&(c||a.removeAttribute("width"),d||a.removeAttribute("height")),h.qb(b?b.type:"timeout"))}var g=L("loadImage"),h=ue(g,a),l=!1;a.addEventListener("load",e,!1);a.addEventListener("error",e,!1);a.addEventListener("abort",e,!1);"http://www.w3.org/2000/svg"==a.namespaceURI?(a.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",
...
break;case 73:if(9>g-z&&f.substring(z+1,g+1).match(/^[0-9a-fA-F]{0,6}[ \t]$/)){g++;continue}m=Je(f.substring(k,g));break;case 75:z=g++;continue;case 76:g++;e=Qe;continue;default:e!==Me?(l=51,m="E_CSS_UNEXPECTED_STATE"):(k=g,l=0)}r.type=l;r.b=q;r.L=p;r.text=m;r.position=k;b++;if(b>=c)break;e=Me;q=!1;r=h[b&d]}a.position=g;a.h=b&d};function sf(a,b,c,d,e){var f=L("ajax"),g=new XMLHttpRequest,h=ue(f,g),l={status:0,url:a,contentType:null,responseText:null,responseXML:null,Sd:null};g.open(c||"GET",a,!0);b&&(g.responseType=b);g.onreadystatechange=function(){if(4===g.readyState){l.status=g.status;if(200==l.status||!l.status)if(b&&"document"!==b||!g.responseXML||"parsererror"==g.responseXML.documentElement.localName)if((!b||"document"===b)&&g.response instanceof HTMLDocument)l.responseXML=g.response,l.contentType=g.response.contentType;
else{var c=g.response;b&&"text"!==b||"string"!=typeof c?c?"string"==typeof c?l.Sd=tf([c]):l.Sd=c:w.b("Unexpected empty success response for",a):l.responseText=c;if(c=g.getResponseHeader("Content-Type"))l.contentType=c.replace(/(.*);.*$/,"$1")}else l.responseXML=g.responseXML,l.contentType=g.responseXML.contentType;h.qb(l)}};try{d?(g.setRequestHeader("Content-Type",e||"text/plain; charset=UTF-8"),g.send(d)):(a.match(/file:\/\/.*(\.html$|\.htm$)/)&&g.overrideMimeType("text/html"),g.send(null))}catch(k){w.b(k,
"Error fetching "+a),h.qb(l)}return f.result()}function tf(a){var b=window.WebKitBlobBuilder||window.MSBlobBuilder;if(b){for(var b=new b,c=0;c<a.length;c++)b.append(a[c]);return b.getBlob("application/octet-stream")}return new Blob(a,{type:"application/octet-stream"})}function uf(a){var b=L("readBlob"),c=new FileReader,d=ue(b,c);c.addEventListener("load",function(){d.qb(c.result)},!1);c.readAsArrayBuffer(a);return b.result()}function vf(a,b){this.ba=a;this.type=b;this.h={};this.j={}}
vf.prototype.load=function(a,b,c){a=xa(a);var d=this.h[a];return"undefined"!=typeof d?M(d):this.fetch(a,b,c).get()};function wf(a,b,c,d){var e=L("fetch");sf(b,a.type).then(function(f){if(c&&400<=f.status)throw Error(d||"Failed to fetch required resource: "+b);a.ba(f,a).then(function(c){delete a.j[b];a.h[b]=c;O(e,c)})});return e.result()}
vf.prototype.fetch=function(a,b,c){a=xa(a);if(this.h[a])return null;var d=this.j[a];if(!d){var e=this,d=new Ee(function(){return wf(e,a,b,c)},"Fetch "+a);e.j[a]=d;d.start()}return d};vf.prototype.get=function(a){return this.h[xa(a)]};function xf(a){a=a.responseText;return M(a?JSON.parse(a):null)};function yf(a){var b=parseInt(a,16);if(isNaN(b))throw Error("E_CSS_COLOR");if(6==a.length)return new Pc(b);if(3==a.length)return new Pc(b&15|(b&15)<<4|(b&240)<<4|(b&240)<<8|(b&3840)<<8|(b&3840)<<12);throw Error("E_CSS_COLOR");}function zf(a){this.f=a;this.nb="Author"}n=zf.prototype;n.bd=function(){return null};n.ma=function(){return this.f};n.error=function(){};n.Pc=function(a){this.nb=a};n.Qb=function(){};n.je=function(){};n.jd=function(){};n.kd=function(){};n.ue=function(){};n.zd=function(){};
n.Yb=function(){};n.ie=function(){};n.he=function(){};n.oe=function(){};n.Mc=function(){};n.Lb=function(){};n.Wd=function(){};n.nd=function(){};n.$d=function(){};n.Ud=function(){};n.Zd=function(){};n.Oc=function(){};n.Le=function(){};n.Ac=function(){};n.Vd=function(){};n.Yd=function(){};n.Xd=function(){};n.qd=function(){};n.pd=function(){};n.Ia=function(){};n.Ib=function(){};n.Zb=function(){};n.od=function(){};n.Gd=function(){};
function Af(a){switch(a.nb){case "UA":return 0;case "User":return 100663296;default:return 83886080}}function Bf(a){switch(a.nb){case "UA":return 0;case "User":return 16777216;default:return 33554432}}function Cf(){zf.call(this,null);this.g=[];this.b=null}v(Cf,zf);function Df(a,b){a.g.push(a.b);a.b=b}n=Cf.prototype;n.bd=function(){return null};n.ma=function(){return this.b.ma()};n.error=function(a,b){this.b.error(a,b)};
n.Pc=function(a){zf.prototype.Pc.call(this,a);0<this.g.length&&(this.b=this.g[0],this.g=[]);this.b.Pc(a)};n.Qb=function(a,b){this.b.Qb(a,b)};n.je=function(a){this.b.je(a)};n.jd=function(a,b){this.b.jd(a,b)};n.kd=function(a,b){this.b.kd(a,b)};n.ue=function(a){this.b.ue(a)};n.zd=function(a,b,c,d){this.b.zd(a,b,c,d)};n.Yb=function(){this.b.Yb()};n.ie=function(){this.b.ie()};n.he=function(){this.b.he()};n.oe=function(){this.b.oe()};n.Mc=function(){this.b.Mc()};n.Lb=function(){this.b.Lb()};n.Wd=function(){this.b.Wd()};
n.nd=function(a){this.b.nd(a)};n.$d=function(){this.b.$d()};n.Ud=function(){this.b.Ud()};n.Zd=function(){this.b.Zd()};n.Oc=function(){this.b.Oc()};n.Le=function(a){this.b.Le(a)};n.Ac=function(a){this.b.Ac(a)};n.Vd=function(a){this.b.Vd(a)};n.Yd=function(){this.b.Yd()};n.Xd=function(a,b,c){this.b.Xd(a,b,c)};n.qd=function(a,b,c){this.b.qd(a,b,c)};n.pd=function(a,b,c){this.b.pd(a,b,c)};n.Ia=function(){this.b.Ia()};n.Ib=function(a,b,c){this.b.Ib(a,b,c)};n.Zb=function(){this.b.Zb()};n.od=function(a){this.b.od(a)};
n.Gd=function(){this.b.Gd()};function Ef(a,b,c){zf.call(this,a);this.N=c;this.J=0;if(this.oa=b)this.nb=b.nb}v(Ef,zf);Ef.prototype.bd=function(){return this.oa.bd()};Ef.prototype.error=function(a){w.b(a)};Ef.prototype.Ia=function(){this.J++};Ef.prototype.Zb=function(){if(!--this.J&&!this.N){var a=this.oa;a.b=a.g.pop()}};function Ff(a,b,c){Ef.call(this,a,b,c)}v(Ff,Ef);function Gf(a,b){a.error(b,a.bd())}function Hf(a,b){Gf(a,b);Df(a.oa,new Ef(a.f,a.oa,!1))}n=Ff.prototype;n.Lb=function(){Hf(this,"E_CSS_UNEXPECTED_SELECTOR")};
n.Wd=function(){Hf(this,"E_CSS_UNEXPECTED_FONT_FACE")};n.nd=function(){Hf(this,"E_CSS_UNEXPECTED_FOOTNOTE")};n.$d=function(){Hf(this,"E_CSS_UNEXPECTED_VIEWPORT")};n.Ud=function(){Hf(this,"E_CSS_UNEXPECTED_DEFINE")};n.Zd=function(){Hf(this,"E_CSS_UNEXPECTED_REGION")};n.Oc=function(){Hf(this,"E_CSS_UNEXPECTED_PAGE")};n.Ac=function(){Hf(this,"E_CSS_UNEXPECTED_WHEN")};n.Vd=function(){Hf(this,"E_CSS_UNEXPECTED_FLOW")};n.Yd=function(){Hf(this,"E_CSS_UNEXPECTED_PAGE_TEMPLATE")};n.Xd=function(){Hf(this,"E_CSS_UNEXPECTED_PAGE_MASTER")};
n.qd=function(){Hf(this,"E_CSS_UNEXPECTED_PARTITION")};n.pd=function(){Hf(this,"E_CSS_UNEXPECTED_PARTITION_GROUP")};n.od=function(){Hf(this,"E_CSS_UNEXPECTED_SELECTOR_FUNC")};n.Gd=function(){Hf(this,"E_CSS_UNEXPECTED_END_SELECTOR_FUNC")};n.Ib=function(){this.error("E_CSS_UNEXPECTED_PROPERTY",this.bd())};var If=[],Jf=[],T=[],Kf=[],Lf=[],Mf=[],Nf=[],Of=[],Pf=[],Qf=[],Rf=[],Sf=[],Tf=[];If[1]=28;If[36]=29;If[7]=29;If[9]=29;If[14]=29;If[18]=29;If[20]=30;If[13]=27;If[0]=200;Jf[1]=46;Jf[0]=200;Mf[1]=2;
...
new oc(e.ma(),g,f);break;case 19:f=new pc(e.ma(),g,f);break;case 21:f=new qc(e.ma(),g,f);break;case 18:if(1<d.length)switch(d[d.length-1]){case 22:d.pop();f=new vc(e.ma(),d.pop(),g,f);break;case 10:if(g.bf())f=new wc(e.ma(),g,f);else return Xf(a,"E_CSS_MEDIA_TEST",c),!1}else return Xf(a,"E_CSS_EXPR_COND",c),!1;break;case 22:if(18!=b)return Xf(a,"E_CSS_EXPR_COND",c),!1;case 10:return d.push(g),d.push(h),d.push(f),!1;default:return Xf(a,"F_UNEXPECTED_STATE",c),!1}}}d.push(f);return!1}
...
function cg(a,b,c,d,e,f){var g=a.u,h=a.f,l=a.F,k,m,p,q;e&&(a.j=2,a.F.push("{"));a:for(;0<b;--b)switch(k=R(h),a.b[k.type]){case 28:if(18!=qf(h,1).type){bg(a)?(g.error("E_CSS_COLON_EXPECTED",qf(h,1)),a.b=Rf):(a.b=Mf,g.Lb());continue}m=qf(h,2);if(!(m.b||1!=m.type&&6!=m.type)){if(0<=h.b)throw Error("F_CSSTOK_BAD_CALL mark");h.b=h.f}a.g=k.text;a.C=!1;S(h);S(h);a.b=Nf;l.splice(0,l.length);continue;case 46:if(18!=qf(h,1).type){a.b=Rf;g.error("E_CSS_COLON_EXPECTED",qf(h,1));continue}a.g=k.text;a.C=!1;S(h);
S(h);a.b=Nf;l.splice(0,l.length);continue;case 29:a.b=Mf;g.Lb();continue;case 1:if(!k.b){a.b=Sf;g.error("E_CSS_SPACE_EXPECTED",k);continue}g.Yb();case 2:if(34==qf(h,1).type)if(S(h),S(h),p=a.N[k.text],null!=p)switch(k=R(h),k.type){case 1:g.Qb(p,k.text);a.b=f?Kf:T;S(h);break;case 36:g.Qb(p,null);a.b=f?Kf:T;S(h);break;default:a.b=Qf,g.error("E_CSS_NAMESPACE",k)}else a.b=Qf,g.error("E_CSS_UNDECLARED_PREFIX",k);else g.Qb(a.H,k.text),a.b=f?Kf:T,S(h);continue;case 3:if(!k.b){a.b=Sf;g.error("E_CSS_SPACE_EXPECTED",
k);continue}g.Yb();case 4:if(34==qf(h,1).type)switch(S(h),S(h),k=R(h),k.type){case 1:g.Qb(null,k.text);a.b=f?Kf:T;S(h);break;case 36:g.Qb(null,null);a.b=f?Kf:T;S(h);break;default:a.b=Qf,g.error("E_CSS_NAMESPACE",k)}else g.Qb(a.H,null),a.b=f?Kf:T,S(h);continue;case 5:k.b&&g.Yb();case 6:g.ue(k.text);a.b=f?Kf:T;S(h);continue;case 7:k.b&&g.Yb();case 8:g.je(k.text);a.b=f?Kf:T;S(h);continue;case 55:k.b&&g.Yb();case 14:S(h);k=R(h);b:switch(k.type){case 1:g.jd(k.text,null);S(h);a.b=f?Kf:T;continue;case 6:m=
k.text;S(h);switch(m){case "not":a.b=Mf;g.od("not");cg(a,Number.POSITIVE_INFINITY,!1,!1,!1,!0)?a.b=T:a.b=Sf;break a;case "lang":case "href-epub-type":if(k=R(h),1===k.type){p=[k.text];S(h);break}else break b;case "nth-child":case "nth-of-type":case "nth-last-child":case "nth-last-of-type":if(p=$f(a))break;else break b;default:p=Zf(a)}k=R(h);if(11==k.type){g.jd(m,p);S(h);a.b=f?Kf:T;continue}}g.error("E_CSS_PSEUDOCLASS_SYNTAX",k);a.b=Qf;continue;case 42:S(h);k=R(h);switch(k.type){case 1:g.kd(k.text,
null);a.b=f?Kf:T;S(h);continue;case 6:m=k.text;S(h);if("nth-fragment"==m){if(p=$f(a),!p)break}else p=Zf(a);k=R(h);if(11==k.type){g.kd(m,p);a.b=f?Kf:T;S(h);continue}}g.error("E_CSS_PSEUDOELEM_SYNTAX",k);a.b=Qf;continue;case 9:k.b&&g.Yb();case 10:S(h);k=R(h);if(1==k.type)m=k.text,S(h);else if(36==k.type)m=null,S(h);else if(34==k.type)m="";else{a.b=Sf;g.error("E_CSS_ATTR",k);S(h);continue}k=R(h);if(34==k.type){p=m?a.N[m]:m;if(null==p){a.b=Sf;g.error("E_CSS_UNDECLARED_PREFIX",k);S(h);continue}S(h);k=
R(h);if(1!=k.type){a.b=Sf;g.error("E_CSS_ATTR_NAME_EXPECTED",k);continue}m=k.text;S(h);k=R(h)}else p="";switch(k.type){case 39:case 45:case 44:case 43:case 42:case 46:case 50:q=k.type;S(h);k=R(h);break;case 15:g.zd(p,m,0,null);a.b=f?Kf:T;S(h);continue;default:a.b=Sf;g.error("E_CSS_ATTR_OP_EXPECTED",k);continue}switch(k.type){case 1:case 2:g.zd(p,m,q,k.text);S(h);k=R(h);break;default:a.b=Sf;g.error("E_CSS_ATTR_VAL_EXPECTED",k);continue}if(15!=k.type){a.b=Sf;g.error("E_CSS_ATTR",k);continue}a.b=f?Kf:
T;S(h);continue;case 11:g.ie();a.b=Lf;S(h);continue;case 12:g.he();a.b=Lf;S(h);continue;case 56:g.oe();a.b=Lf;S(h);continue;case 13:a.X?(a.h.push("-epubx-region"),a.X=!1):a.O?(a.h.push("page"),a.O=!1):a.h.push("[selector]");g.Ia();a.b=If;S(h);continue;case 41:g.Mc();a.b=Mf;S(h);continue;case 15:l.push(D(k.text));S(h);continue;case 16:try{l.push(yf(k.text))}catch(z){g.error("E_CSS_COLOR",k),a.b=Qf}S(h);continue;case 17:l.push(new Nc(k.L));S(h);continue;case 18:l.push(new Oc(k.L));S(h);continue;case 19:l.push(new F(k.L,
...
S(h);a.b=Pf;continue;case 35:S(h);k=R(h);5!=k.type||k.b?Xf(a,"E_CSS_SYNTAX",k):(l.push(new xc(g.ma(),k.L)),S(h),a.b=Pf);continue;case 36:l.push(-k.type);S(h);continue;case 37:a.b=Of;Yf(a,k.type,k);l.push(k.type);S(h);continue;case 45:"and"==k.text.toLowerCase()?(a.b=Of,Yf(a,52,k),l.push(52),S(h)):Xf(a,"E_CSS_SYNTAX",k);continue;case 39:Yf(a,k.type,k)&&(a.g?a.b=Nf:Xf(a,"E_CSS_UNBALANCED_PAR",k));S(h);continue;case 43:Yf(a,11,k)&&(a.g||3==a.j?Xf(a,"E_CSS_UNEXPECTED_BRC",k):(1==a.j?g.Ac(l.pop()):(k=
l.pop(),g.Ac(k)),a.h.push("media"),g.Ia(),a.b=If));S(h);continue;case 49:if(Yf(a,11,k))if(a.g||3!=a.j)Xf(a,"E_CSS_UNEXPECTED_SEMICOL",k);else return a.B=l.pop(),a.G=!0,a.b=If,S(h),!1;S(h);continue;case 40:l.push(k.type);S(h);continue;case 27:a.b=If;S(h);g.Zb();a.h.length&&a.h.pop();continue;case 30:m=k.text.toLowerCase();switch(m){case "import":S(h);k=R(h);if(2==k.type||8==k.type){a.J=k.text;S(h);k=R(h);if(17==k.type||0==k.type)return a.G=!0,S(h),!1;a.g=null;a.j=3;a.b=Of;l.push("{");continue}g.error("E_CSS_IMPORT_SYNTAX",
...
function eg(a,b,c,d,e){var f=L("parseStylesheet"),g=new Uf(If,a,b,c),h=null;e&&(h=fg(new of(e,b),b,c));if(h=ag(g,d,h&&h.za()))b.Ac(h),b.Ia();Be(function(){for(var a={};!cg(g,100,!1,!1,!1,!1);){if(g.G){var d=Aa(g.J,c);g.B&&(b.Ac(g.B),b.Ia());a.xe=L("parseStylesheet.import");gg(d,b,null,null).then(function(a){return function(){g.B&&b.Zb();g.G=!1;g.J=null;g.B=null;O(a.xe,!0)}}(a));return a.xe.result()}d=ze();if(d.Wa)return d;a={xe:a.xe}}return M(!1)}).then(function(){h&&b.Zb();O(f,!0)});return f.result()}
function hg(a,b,c,d,e){return ke("parseStylesheetFromText",function(f){var g=new of(a,b);eg(g,b,c,d,e).Ja(f)},function(b,c){w.b(c,"Failed to parse stylesheet text: "+a);O(b,!1)})}function gg(a,b,c,d){return ke("parseStylesheetFromURL",function(e){sf(a).then(function(f){f.responseText?hg(f.responseText,b,a,c,d).then(function(b){b||w.b("Failed to parse stylesheet from "+a);O(e,!0)}):O(e,!0)})},function(b,c){w.b(c,"Exception while fetching and parsing:",a);O(b,!0)})}
...
function yg(a,b,c){c=b+c;for(var d=Array(c),e=Array(c),f=0;f<=c;f++)d[f]=0,e[f]=0;for(var g=[],h=!1,l=a.length,k=0;k<l;k++){var m=a[k];d[m.b]+=m.h;e[m.b]+=m.g;for(var p=!1,f=0;f<b;f++)if(d[f]&&!e[f]){p=!0;break}if(p)for(f=b;f<=c;f++)if(d[f]||e[f]){p=!1;break}h!=p&&(g.push(m.f),h=p)}return g}function zg(a,b){return b?Math.ceil(a/b)*b:a}function Ag(a,b){return b?Math.floor(a/b)*b:a}function Bg(a){return new mg(a.b,-a.f)}function Cg(a){return new lg(a.S,-a.T,a.P,-a.U)}
function Dg(a){return new rg(bb(a.b,Bg))}
function Eg(a,b,c,d,e){e&&(a=Cg(a),b=bb(b,Dg),c=bb(c,Dg));e=b.length;var f=c?c.length:0,g=[],h=[],l,k,m;for(l=0;l<e;l++)sg(b[l],h,l);for(l=0;l<f;l++)sg(c[l],h,l+e);b=h.length;h.sort(qg);for(c=0;h[c].g>=e;)c++;c=h[c].b.b;c>a.S&&g.push(new pg(a.S,c,a.T,a.T));l=0;for(var p=[];l<b&&(m=h[l]).b.b<c;)m.f.b>c&&p.push(m),l++;for(;l<b||0<p.length;){var q=a.P,r=Math.min(zg(Math.ceil(c+8),d),a.P);for(k=0;k<p.length&&q>r;k++)m=p[k],m.b.f==m.f.f?m.f.b<q&&(q=Math.max(Ag(m.f.b,d),r)):m.b.f!=m.f.f&&(q=r);q>a.P&&(q=
a.P);for(;l<b&&(m=h[l]).b.b<q;)if(m.f.b<c)l++;else if(m.b.b<r){if(m.b.b!=m.f.b||m.b.b!=c)p.push(m),q=r;l++}else{k=Ag(m.b.b,d);k<q&&(q=k);break}r=[];for(k=0;k<p.length;k++)xg(r,p[k],c,q);r.sort(function(a,b){return a.f-b.f||a.g-b.g});r=yg(r,e,f);if(r.length){var z=0,u=a.U;for(k=0;k<r.length;k+=2){var A=Math.max(a.U,r[k]),H=Math.min(a.T,r[k+1])-A;H>z&&(z=H,u=A)}z?g.push(new pg(c,q,Math.max(u,a.U),Math.min(u+z,a.T))):g.push(new pg(c,q,a.T,a.T))}else g.push(new pg(c,q,a.T,a.T));if(q==a.P)break;c=q;for(k=
p.length-1;0<=k;k--)p[k].f.b<=q&&p.splice(k,1)}Fg(a,g);return g}function Fg(a,b){for(var c=b.length-1,d=new pg(a.P,a.P,a.U,a.T);0<=c;){var e=d,d=b[c];if(1>d.P-d.S||d.U==e.U&&d.T==e.T)e.S=d.S,b.splice(c,1),d=e;c--}}function Gg(a,b){for(var c=0,d=a.length;c<d;){var e=Math.floor((c+d)/2);b>=a[e].P?c=e+1:d=e}return c}
function Hg(a,b){if(!a.length)return b;for(var c=b.S,d,e=0;e<a.length&&!(d=a[e],d.P>b.S&&d.U-.1<=b.U&&d.T+.1>=b.T);e++)c=Math.max(c,d.P);for(var f=c;e<a.length&&!(d=a[e],d.S>=b.P||d.U-.1>b.U||d.T+.1<b.T);e++)f=d.P;f=e===a.length?b.P:Math.min(f,b.P);return f<=c?null:new lg(b.U,c,b.T,f)}
function Ig(a,b){if(!a.length)return b;for(var c=b.P,d,e=a.length-1;0<=e&&!(d=a[e],e===a.length-1&&d.P<b.P)&&!(d.S<b.P&&d.U-.1<=b.U&&d.T+.1>=b.T);e--)c=Math.min(c,d.S);for(var f=Math.min(c,d.P);0<=e&&!(d=a[e],d.P<=b.S||d.U-.1>b.U||d.T+.1<b.T);e--)f=d.S;f=Math.max(f,b.S);return c<=f?null:new lg(b.U,f,b.T,c)};function Jg(){this.b={}}v(Jg,Cc);Jg.prototype.kc=function(a){this.b[a.name]=!0;return a};Jg.prototype.Mb=function(a){this.lc(a.values);return a};function Kg(a){this.value=a}v(Kg,Cc);Kg.prototype.Sc=function(a){this.value=a.L;return a};function Lg(a,b){if(a){var c=new Kg(b);try{return a.ea(c),c.value}catch(d){w.b(d,"toInt: ")}}return b}function Mg(){this.b=!1;this.f=[];this.name=null}v(Mg,Cc);Mg.prototype.Uc=function(a){this.b&&this.f.push(a);return null};
Mg.prototype.Tc=function(a){this.b&&!a.L&&this.f.push(new F(0,"px"));return null};Mg.prototype.Mb=function(a){this.lc(a.values);return null};Mg.prototype.Rb=function(a){this.b||(this.b=!0,this.lc(a.values),this.b=!1,this.name=a.name.toLowerCase());return null};
...
case "circle":if(3==g.length)return tg(b+g[0],c+g[1],g[2],g[2])}}return null}function Og(a,b,c,d,e,f){if(a){var g=new Mg;try{return a.ea(g),Ng(g,b,c,d,e,f)}catch(h){w.b(h,"toShape:")}}return ug(b,c,b+d,c+e)}function Pg(a){this.f=a;this.b={};this.name=null}v(Pg,Cc);Pg.prototype.kc=function(a){this.name=a.toString();this.b[this.name]=this.f?0:(this.b[this.name]||0)+1;return a};Pg.prototype.Sc=function(a){this.name&&(this.b[this.name]+=a.L-(this.f?0:1));return a};
Pg.prototype.Mb=function(a){this.lc(a.values);return a};function Qg(a,b){var c=new Pg(b);try{a.ea(c)}catch(d){w.b(d,"toCounters:")}return c.b}function Rg(a,b){this.b=a;this.f=b}v(Rg,Dc);Rg.prototype.Vc=function(a){return new Qc(this.f.ic(a.url,this.b))};function Sg(a){this.f=this.g=null;this.b=0;this.bb=a}function Tg(a,b){this.b=-1;this.f=a;this.g=b}function Ug(){this.W=[];this.b=[];this.match=[];this.f=[];this.error=[];this.g=!0}Ug.prototype.connect=function(a,b){for(var c=0;c<a.length;c++)this.b[a[c]].b=b;a.splice(0,a.length)};
...
d);if(2==c||3==c)for(f=0;f<b.f.length;f++)a.match.push(b.f[f]+g);else if(a.g){for(f=0;f<b.f.length;f++)a.f.push(b.f[f]+g);a.g=b.g}else for(f=0;f<b.f.length;f++)a.error.push(b.f[f]+g);for(f=0;f<b.error.length;f++)a.error.push(b.error[f]+g);b.W=null;b.b=null}}}var U={};function $g(){}v($g,Cc);$g.prototype.h=function(a,b){var c=a[b].ea(this);return c?[c]:null};function Yg(a,b,c){this.b=a;this.f=b;this.g=c}v(Yg,$g);n=Yg.prototype;n.Ne=function(a){return this.b&1?a:null};
n.Oe=function(a){return this.b&2048?a:null};n.sd=function(a){return this.b&2?a:null};n.kc=function(a){var b=this.f[a.name.toLowerCase()];return b?b:this.b&4?a:null};n.Uc=function(a){return a.L||this.b&512?0>a.L&&!(this.b&256)?null:this.g[a.ka]?a:null:"%"==a.ka&&this.b&1024?a:null};n.Tc=function(a){return a.L?0>=a.L&&!(this.b&256)?null:this.b&16?a:null:this.b&512?a:null};n.Sc=function(a){return a.L?0>=a.L&&!(this.b&256)?null:this.b&48?a:(a=this.f[""+a.L])?a:null:this.b&512?a:null};
n.ce=function(a){return this.b&64?a:null};n.Vc=function(a){return this.b&128?a:null};n.Mb=function(){return null};n.jc=function(){return null};n.Rb=function(){return null};n.Rc=function(){return null};var Wg=new Yg(0,U,U);
...
function bh(a,b,c,d){for(var e=c?[]:b,f=a.f,g=d,h=null,l=null;f!==a.b&&f!==a.g;)if(g>=b.length)f=f.f;else{var k=b[g],m;if(f.b)m=!0,-1==f.b?(h?h.push(l):h=[l],l=[]):-2==f.b?0<h.length?l=h.pop():l=null:0<f.b&&!(f.b%2)?l[Math.floor((f.b-1)/2)]="taken":m=null==l[Math.floor((f.b-1)/2)],f=m?f.g:f.f;else{if(!g&&!c&&f.bb instanceof ch&&a instanceof ch){if(m=(new Ec(b)).ea(f.bb)){g=b.length;f=f.g;continue}}else if(!g&&!c&&f.bb instanceof dh&&a instanceof ch){if(m=(new Fc(b)).ea(f.bb)){g=b.length;f=f.g;continue}}else m=
k.ea(f.bb);if(m){if(m!==k&&b===e)for(e=[],k=0;k<g;k++)e[k]=b[k];b!==e&&(e[g-d]=m);g++;f=f.g}else f=f.f}}return f===a.b&&(c?0<e.length:g==b.length)?e:null}n=ah.prototype;n.zb=function(a){for(var b=null,c=this.f;c!==this.b&&c!==this.g;)a?c.b?c=c.g:(b=a.ea(c.bb))?(a=null,c=c.g):c=c.f:c=c.f;return c===this.b?b:null};n.Ne=function(a){return this.zb(a)};n.Oe=function(a){return this.zb(a)};n.sd=function(a){return this.zb(a)};n.kc=function(a){return this.zb(a)};n.Uc=function(a){return this.zb(a)};n.Tc=function(a){return this.zb(a)};
n.Sc=function(a){return this.zb(a)};n.ce=function(a){return this.zb(a)};n.Vc=function(a){return this.zb(a)};n.Mb=function(){return null};n.jc=function(){return null};n.Rb=function(a){return this.zb(a)};n.Rc=function(){return null};function ch(a){ah.call(this,a)}v(ch,ah);ch.prototype.Mb=function(a){var b=bh(this,a.values,!1,0);return b===a.values?a:b?new Ec(b):null};
ch.prototype.jc=function(a){for(var b=this.f,c=!1;b;){if(b.bb instanceof dh){c=!0;break}b=b.f}return c?(b=bh(this,a.values,!1,0),b===a.values?a:b?new Fc(b):null):null};ch.prototype.h=function(a,b){return bh(this,a,!0,b)};function dh(a){ah.call(this,a)}v(dh,ah);dh.prototype.Mb=function(a){return this.zb(a)};dh.prototype.jc=function(a){var b=bh(this,a.values,!1,0);return b===a.values?a:b?new Fc(b):null};dh.prototype.h=function(a,b){for(var c=this.f,d;c!==this.g;){if(d=c.bb.h(a,b))return d;c=c.f}return null};
function eh(a,b){ah.call(this,b);this.name=a}v(eh,ah);eh.prototype.zb=function(){return null};eh.prototype.Rb=function(a){if(a.name.toLowerCase()!=this.name)return null;var b=bh(this,a.values,!1,0);return b===a.values?a:b?new Gc(a.name,b):null};function fh(){}fh.prototype.b=function(a,b){return b};fh.prototype.f=function(){};function gh(a,b){this.name=b;this.bb=a.g[this.name]}v(gh,fh);
...
ih.prototype.b=function(a,b,c){var d=b;if(this.mf)if(a[b]==Kc){if(++b==a.length)return d}else return d;var e=this.W[0].b(a,b,c);if(e==b)return d;b=e;for(d=1;d<this.W.length&&b<a.length;d++){e=this.W[d].b(a,b,c);if(e==b)break;b=e}return b};function jh(){this.f=this.vb=null;this.error=!1;this.values={};this.b=null}n=jh.prototype;n.clone=function(){var a=new this.constructor;a.vb=this.vb;a.f=this.f;a.b=this.b;return a};n.Pe=function(a,b){this.vb=a;this.f=b};n.Dc=function(){this.error=!0;return 0};
function kh(a,b){a.Dc([b]);return null}n.Ne=function(a){return kh(this,a)};n.sd=function(a){return kh(this,a)};n.kc=function(a){return kh(this,a)};n.Uc=function(a){return kh(this,a)};n.Tc=function(a){return kh(this,a)};n.Sc=function(a){return kh(this,a)};n.ce=function(a){return kh(this,a)};n.Vc=function(a){return kh(this,a)};n.Mb=function(a){this.Dc(a.values);return null};n.jc=function(){this.error=!0;return null};n.Rb=function(a){return kh(this,a)};n.Rc=function(){this.error=!0;return null};
function lh(){jh.call(this)}v(lh,jh);lh.prototype.Dc=function(a){for(var b=0,c=0;b<a.length;){var d=this.vb[c].b(a,b,this);if(d>b)b=d,c=0;else if(++c==this.vb.length){this.error=!0;break}}return b};function mh(){jh.call(this)}v(mh,jh);mh.prototype.Dc=function(a){if(a.length>this.vb.length||!a.length)return this.error=!0,0;for(var b=0;b<this.vb.length;b++){for(var c=b;c>=a.length;)c=1==c?0:c-2;if(this.vb[b].b(a,c,this)!=c+1)return this.error=!0,0}return a.length};function nh(){jh.call(this)}v(nh,jh);
nh.prototype.Dc=function(a){for(var b=a.length,c=0;c<a.length;c++)if(a[c]===Kc){b=c;break}if(b>this.vb.length||!a.length)return this.error=!0,0;for(c=0;c<this.vb.length;c++){for(var d=c;d>=b;)d=1==d?0:d-2;var e;if(b+1<a.length)for(e=b+c+1;e>=a.length;)e-=e==b+2?1:2;else e=d;if(2!=this.vb[c].b([a[d],a[e]],0,this))return this.error=!0,0}return a.length};function oh(){jh.call(this)}v(oh,lh);
oh.prototype.jc=function(a){for(var b={},c=0;c<a.values.length;c++){this.values={};if(a.values[c]instanceof Fc)this.error=!0;else{a.values[c].ea(this);for(var d=this.values,e=t(this.f),f=e.next();!f.done;f=e.next()){var f=f.value,g=d[f]||this.b.l[f],h=b[f];h||(h=[],b[f]=h);h.push(g)}this.values["background-color"]&&c!=a.values.length-1&&(this.error=!0)}if(this.error)return null}this.values={};for(var l in b)this.values[l]="background-color"==l?b[l].pop():new Fc(b[l]);return null};
...
ph.prototype.Dc=function(a){var b=lh.prototype.Dc.call(this,a);if(b+2>a.length)return this.error=!0,b;this.error=!1;var c=this.b.g;if(!a[b].ea(c["font-size"]))return this.error=!0,b;this.values["font-size"]=a[b++];if(a[b]===Kc){b++;if(b+2>a.length||!a[b].ea(c["line-height"]))return this.error=!0,b;this.values["line-height"]=a[b++]}var d=b==a.length-1?a[b]:new Ec(a.slice(b,a.length));if(!d.ea(c["font-family"]))return this.error=!0,b;this.values["font-family"]=d;return a.length};
ph.prototype.jc=function(a){a.values[0].ea(this);if(this.error)return null;for(var b=[this.values["font-family"]],c=1;c<a.values.length;c++)b.push(a.values[c]);a=new Fc(b);a.ea(this.b.g["font-family"])?this.values["font-family"]=a:this.error=!0;return null};ph.prototype.kc=function(a){if(a=this.b.f[a.name])for(var b in a)this.values[b]=a[b];else this.error=!0;return null};var qh={SIMPLE:lh,INSETS:mh,INSETS_SLASH:nh,COMMA:oh,FONT:ph};
...
function zh(a,b){for(var c={};;){var d=yh(a,b,1);if(!d)break;c.ra=[];var e=[];c.$a="";var f=void 0;c.Za=!0;c.cg=a;for(var g=function(a){return function(){if(!a.ra.length)throw Error("No values");var b;if(1==a.ra.length)b=a.ra[0];else{var c=a.$a,d=a.ra;b=new Ug;if("||"==c){for(c=0;c<d.length;c++){var e=new Ug;if(e.W.length)throw Error("invalid call");var f=new Sg(Wg);f.b=2*c+1;e.W.push(f);var f=new Tg(0,!0),g=new Tg(0,!1);e.f.push(e.b.length);e.b.push(g);e.match.push(e.b.length);e.b.push(f);Zg(e,d[c],
...
{"block-size":"height","inline-size":"width"});function V(a,b){this.value=a;this.ab=b}n=V.prototype;n.Kf=function(){return this};n.Id=function(a){a=this.value.ea(a);return a===this.value?this:new V(a,this.ab)};n.Mf=function(a){return a?new V(this.value,this.ab+a):this};n.evaluate=function(a,b){return kg(a,this.value,b)};n.tf=function(){return!0};function Th(a,b,c){V.call(this,a,b);this.ia=c}v(Th,V);Th.prototype.Kf=function(){return new V(this.value,this.ab)};
Th.prototype.Id=function(a){a=this.value.ea(a);return a===this.value?this:new Th(a,this.ab,this.ia)};Th.prototype.Mf=function(a){return a?new Th(this.value,this.ab+a,this.ia):this};Th.prototype.tf=function(a){return!!this.ia.evaluate(a)};function Uh(a,b,c){return(!b||c.ab>b.ab)&&c.tf(a)?c.Kf():b}var Vh={"region-id":!0,"fragment-selector-id":!0};function Wh(a){return"_"!=a.charAt(0)&&!Vh[a]}function Xh(a,b,c){c?a[b]=c:delete a[b]}function Yh(a,b){var c=a[b];c||(c={},a[b]=c);return c}
...
ci.prototype.Uc=function(a){if("font-size"===this.b){var b=di(this),c=this.f;a=ei(a,b,c);var d=a.ka,e=a.L;return"px"===d?a:"%"===d?new F(e/100*b,"px"):new F(e*Pb(c,d,!1),"px")}if("em"==a.ka||"ex"==a.ka||"rem"==a.ka)return ei(a,di(this),this.f);if("%"==a.ka){if("line-height"===this.b)return a;b=this.b.match(/height|^(top|bottom)$/)?"vh":"vw";return new F(a.L,b)}return a};ci.prototype.Rc=function(a){return"font-size"==this.b?kg(this.f,a,this.b).ea(this):a};
...
vi.prototype.apply=function(a){a.lang.match(this.h)&&this.b.apply(a)};function wi(){this.b=null}v(wi,W);wi.prototype.apply=function(a){a.rb&&this.b.apply(a)};wi.prototype.f=function(){return 6};function xi(){this.b=null}v(xi,W);xi.prototype.apply=function(a){a.sa&&this.b.apply(a)};xi.prototype.f=function(){return 12};function yi(a,b){this.b=null;this.h=a;this.Gb=b}v(yi,W);function zi(a,b,c){a-=c;return b?!(a%b)&&0<=a/b:!a}function Ai(a,b){yi.call(this,a,b)}v(Ai,yi);
Ai.prototype.apply=function(a){zi(a.Pa,this.h,this.Gb)&&this.b.apply(a)};Ai.prototype.f=function(){return 5};function Bi(a,b){yi.call(this,a,b)}v(Bi,yi);Bi.prototype.apply=function(a){zi(a.Eb[a.j][a.f],this.h,this.Gb)&&this.b.apply(a)};Bi.prototype.f=function(){return 5};function Ci(a,b){yi.call(this,a,b)}v(Ci,yi);Ci.prototype.apply=function(a){var b=a.O;null===b&&(b=a.O=a.b.parentNode.childElementCount-a.Pa+1);zi(b,this.h,this.Gb)&&this.b.apply(a)};Ci.prototype.f=function(){return 4};
function Di(a,b){yi.call(this,a,b)}v(Di,yi);Di.prototype.apply=function(a){var b=a.yb;if(!b[a.j]){var c=a.b;do{var d=c.namespaceURI,e=c.localName,f=b[d];f||(f=b[d]={});f[e]=(f[e]||0)+1}while(c=c.nextElementSibling)}zi(b[a.j][a.f],this.h,this.Gb)&&this.b.apply(a)};Di.prototype.f=function(){return 4};function Ei(){this.b=null}v(Ei,W);Ei.prototype.apply=function(a){for(var b=a.b.firstChild;b;){switch(b.nodeType){case Node.ELEMENT_NODE:return;case Node.TEXT_NODE:if(0<b.length)return}b=b.nextSibling}this.b.apply(a)};
...
Xi.prototype.Rb=function(a){if("attr"!==a.name)return Dc.prototype.Rb.call(this,a);var b="string",c;a.values[0]instanceof Ec?(2<=a.values[0].values.length&&(b=a.values[0].values[1].stringValue()),c=a.values[0].values[0].stringValue()):c=a.values[0].stringValue();a=1<a.values.length?Yi(a.values[1].stringValue(),b):Yi(null,b);return this.element&&this.element.hasAttribute(c)?Yi(this.element.getAttribute(c),b):a};function Zi(a,b,c){this.f=a;this.element=b;this.b=c}v(Zi,Dc);
Zi.prototype.kc=function(a){var b=this.f,c=b.J,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.C)];b.C++;break;case "close-quote":return 0<b.C&&b.C--,c[2*Math.min(d,b.C)+1];case "no-open-quote":return b.C++,new Lc("");case "no-close-quote":return 0<b.C&&b.C--,new Lc("")}return a};
...
bj={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},cj={ih:!1,Zc:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",Od:"\u5341\u767e\u5343",zg:"\u8ca0"};
function dj(a){if(9999<a||-9999>a)return""+a;if(!a)return cj.Zc.charAt(0);var b=new Pa;0>a&&(b.append(cj.zg),a=-a);if(10>a)b.append(cj.Zc.charAt(a));else if(cj.jh&&19>=a)b.append(cj.Od.charAt(0)),a&&b.append(cj.Od.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(cj.Zc.charAt(c)),b.append(cj.Od.charAt(2)));if(c=Math.floor(a/100)%10)b.append(cj.Zc.charAt(c)),b.append(cj.Od.charAt(1));if(c=Math.floor(a/10)%10)b.append(cj.Zc.charAt(c)),b.append(cj.Od.charAt(0));(a%=10)&&b.append(cj.Zc.charAt(a))}return b.toString()}
...
Zi.prototype.Rb=function(a){switch(a.name){case "counter":if(2>=a.values.length)return ej(this,a.values);break;case "counters":if(3>=a.values.length)return gj(this,a.values);break;case "target-counter":if(3>=a.values.length)return ij(this,a.values);break;case "target-counters":if(4>=a.values.length)return kj(this,a.values)}w.b("E_CSS_CONTENT_PROP:",a.toString());return new Lc("")};var mj=1/1048576;function nj(a,b){for(var c in a)b[c]=a[c].clone()}
function oj(){this.j=0;this.b={};this.rd={};this.h={};this.f={};this.Na={};this.g={};this.gd={};this.order=0}oj.prototype.clone=function(){var a=new oj;a.j=this.j;for(var b in this.b)a.b[b]=this.b[b];nj(this.rd,a.rd);nj(this.h,a.h);nj(this.f,a.f);nj(this.Na,a.Na);nj(this.g,a.g);nj(this.gd,a.gd);a.order=this.order;return a};function li(a,b,c){var d=a[b];d&&(c=d.l(c));a[b]=c}oj.prototype.hf=function(){return this.order+=mj};
function pj(a,b,c,d){this.u=a;this.l=b;this.Ec=c;this.xb=d;this.h=[[],[]];this.ba={};this.G=this.F=this.va=this.b=null;this.Ca=this.da=this.X=this.j=this.f="";this.Y=this.N=null;this.sa=this.rb=!0;this.g={};this.H=[{}];this.J=[new Lc("\u201c"),new Lc("\u201d"),new Lc("\u2018"),new Lc("\u2019")];this.C=0;this.lang="";this.Ub=[0];this.Pa=0;this.la=[{}];this.Eb=this.la[0];this.O=null;this.Tb=[this.O];this.Sb=[{}];this.yb=this.la[0];this.B={};this.jb=[];this.Fb=[]}
function Oi(a,b,c){a.ba[b]--;a.B[b]&&(a.B[b]=a.B[b].filter(function(a){return a!==c}),a.B[b].length||delete a.B[b])}function ji(a,b){var c=null;b&&(c=qj(a.va,b));var d=a.jb.map(function(b){return(b=a.B[b])&&0<b.length?1===b.length?b[0]:new rj([].concat(b)):null}).filter(function(a){return a});return 0>=d.length?c:c?new sj([c].concat(d)):1===d.length?d[0]:new sj(d)}function tj(a,b,c){(b=b[c])&&b.apply(a)}var uj=[];
function vj(a,b,c,d){a.b=null;a.va=null;a.F=d;a.j="";a.f="";a.X="";a.da="";a.G=b;a.Ca="";a.N=uj;a.Y=c;wj(a)}function xj(a,b,c){a.g[b]?a.g[b].push(c):a.g[b]=[c];c=a.H[a.H.length-1];c||(c={},a.H[a.H.length-1]=c);c[b]=!0}
...
xj(a,k,0),h=a.g[k],h[h.length-1]+=d[k];c===yd&&(c=a.g["ua-list-item"],b["ua-list-item-count"]=new V(new Nc(c[c.length-1]),0));a.H.push(null)}function zj(a){var b=a.H.pop();if(b)for(var c in b)(b=a.g[c])&&(1==b.length?delete a.g[c]:b.pop())}function Ui(a,b,c){yj(a,b);b.content&&(b.content=b.content.Id(new Zi(a,c,a.xb)));zj(a)}var Aj="before transclusion-before footnote-call footnote-marker inner first-letter first-line  transclusion-after after".split(" ");
function Bj(a,b,c,d){a.Fb.push(b);a.Y=null;a.b=b;a.va=d;a.F=c;a.j=b.namespaceURI;a.f=b.localName;d=a.u.b[a.j];a.Ca=d?d+a.f:"";a.X=b.getAttribute("id");a.da=b.getAttributeNS("http://www.w3.org/XML/1998/namespace","id");(d=b.getAttribute("class"))?a.G=d.split(/\s+/):a.G=uj;(d=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))?a.N=d.split(/\s+/):a.N=uj;"style"==a.f&&"http://www.gribuser.ru/xml/fictionbook/2.0"==a.j&&(a.G=[b.getAttribute("name")||""]);if(d=Oa(b))a.h[a.h.length-1].push(new Vi(a.lang)),
a.lang=d.toLowerCase();d=a.sa;var e=a.Ub;a.Pa=++e[e.length-1];e.push(0);var e=a.la,f=a.Eb=e[e.length-1],g=f[a.j];g||(g=f[a.j]={});g[a.f]=(g[a.f]||0)+1;e.push({});e=a.Tb;null!==e[e.length-1]?a.O=--e[e.length-1]:a.O=null;e.push(null);e=a.Sb;(f=a.yb=e[e.length-1])&&f[a.j]&&f[a.j][a.f]--;e.push({});wj(a);Cj(a,b);e=c.quotes;c=null;e&&(e=e.evaluate(a.l))&&(c=new Wi(a.J),e===J?a.J=[new Lc(""),new Lc("")]:e instanceof Ec&&(a.J=e.values));yj(a,a.F);e=a.X||a.da||b.getAttribute("name")||"";if(d||e){var h={};
Object.keys(a.g).forEach(function(a){h[a]=Array.from(this.g[a])},a);Dj(a.Ec,e,h)}if(d=a.F._pseudos)for(e=!0,f=t(Aj),g=f.next();!g.done;g=f.next())(g=g.value)||(e=!1),(g=d[g])&&(e?Ui(a,g,b):a.h[a.h.length-2].push(new Ti(g,b)));c&&a.h[a.h.length-2].push(c)}function Ej(a,b){for(var c in b)Wh(c)&&(b[c]=b[c].Id(a))}function Cj(a,b){var c=new Xi(b),d=a.F,e=d._pseudos,f;for(f in e)Ej(c,e[f]);Ej(c,d)}
function wj(a){var b;for(b=0;b<a.G.length;b++)tj(a,a.u.Na,a.G[b]);for(b=0;b<a.N.length;b++)tj(a,a.u.f,a.N[b]);tj(a,a.u.g,a.X);tj(a,a.u.rd,a.f);""!=a.f&&tj(a,a.u.rd,"*");tj(a,a.u.h,a.Ca);null!==a.Y&&(tj(a,a.u.gd,a.Y),tj(a,a.u.gd,"*"));a.b=null;a.h.push([]);for(var c=1;-1<=c;--c){var d=a.h[a.h.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.rb=!0;a.sa=!1}
function Fj(a){for(var b=1;-1<=b;--b)for(var c=a.h[a.h.length-b-2],d=0;d<c.length;)c[d].f(a,b)?c.splice(d,1):d++;a.h.pop();a.rb=!1}var Gj=null;function Hj(a,b,c,d,e,f,g){Ef.call(this,a,b,g);this.b=null;this.aa=0;this.h=this.lb=null;this.C=!1;this.ia=c;this.l=d?d.l:Gj?Gj.clone():new oj;this.G=e;this.B=f;this.u=0;this.j=null}v(Hj,Ff);Hj.prototype.Of=function(a){li(this.l.rd,"*",a)};function Ij(a,b){var c=bi(a.b,b);c!==b&&c.g(a.l)||a.Of(c)}
Hj.prototype.Qb=function(a,b){if(b||a)this.aa+=1,b&&a?this.b.push(new oi(a,b.toLowerCase())):b?this.b.push(new ni(b.toLowerCase())):this.b.push(new qi(a))};Hj.prototype.je=function(a){this.h?(w.b("::"+this.h,"followed by ."+a),this.b.push(new Ii(""))):(this.aa+=256,this.b.push(new ki(a)))};var Jj={"nth-child":Ai,"nth-of-type":Bi,"nth-last-child":Ci,"nth-last-of-type":Di};
Hj.prototype.jd=function(a,b){if(this.h)w.b("::"+this.h,"followed by :"+a),this.b.push(new Ii(""));else{switch(a.toLowerCase()){case "enabled":this.b.push(new Fi);break;case "disabled":this.b.push(new Gi);break;case "checked":this.b.push(new Hi);break;case "root":this.b.push(new xi);break;case "link":this.b.push(new ni("a"));this.b.push(new ri("","href"));break;case "-adapt-href-epub-type":case "href-epub-type":if(b&&1==b.length&&"string"==typeof b[0]){var c=new RegExp("(^|s)"+Ea(b[0])+"($|s)");this.b.push(new pi(c))}else this.b.push(new Ii(""));
...
break;case "last-child":this.b.push(new Ci(0,1));break;case "first-of-type":this.b.push(new Bi(0,1));break;case "last-of-type":this.b.push(new Di(0,1));break;case "only-child":this.b.push(new wi);this.b.push(new Ci(0,1));break;case "only-of-type":this.b.push(new Bi(0,1));this.b.push(new Di(0,1));break;case "empty":this.b.push(new Ei);break;case "before":case "after":case "first-line":case "first-letter":this.kd(a,b);return;default:w.b("unknown pseudo-class selector: "+a),this.b.push(new Ii(""))}this.aa+=
256}};
Hj.prototype.kd=function(a,b){switch(a){case "before":case "after":case "first-line":case "first-letter":case "footnote-call":case "footnote-marker":case "inner":case "after-if-continues":this.h?(w.b("Double pseudoelement ::"+this.h+"::"+a),this.b.push(new Ii(""))):this.h=a;break;case "first-n-lines":if(b&&1==b.length&&"number"==typeof b[0]){var c=Math.round(b[0]);if(0<c&&c==b[0]){this.h?(w.b("Double pseudoelement ::"+this.h+"::"+a),this.b.push(new Ii(""))):this.h="first-"+c+"-lines";break}}case "nth-fragment":b&&2==
b.length?this.j="NFS_"+b[0]+"_"+b[1]:this.b.push(new Ii(""));break;default:w.b("Unrecognized pseudoelement: ::"+a),this.b.push(new Ii(""))}this.aa+=1};Hj.prototype.ue=function(a){this.aa+=65536;this.b.push(new mi(a))};
Hj.prototype.zd=function(a,b,c,d){this.aa+=256;b=b.toLowerCase();d=d||"";var e;switch(c){case 0:e=new ri(a,b);break;case 39:e=new si(a,b,d);break;case 45:!d||d.match(/\s/)?e=new Ii(""):e=new ui(a,b,new RegExp("(^|\\s)"+Ea(d)+"($|\\s)"));break;case 44:e=new ui(a,b,new RegExp("^"+Ea(d)+"($|-)"));break;case 43:d?e=new ui(a,b,new RegExp("^"+Ea(d))):e=new Ii("");break;case 42:d?e=new ui(a,b,new RegExp(Ea(d)+"$")):e=new Ii("");break;case 46:d?e=new ui(a,b,new RegExp(Ea(d))):e=new Ii("");break;case 50:"supported"==
d?e=new ti(a,b):(w.b("Unsupported :: attr selector op:",d),e=new Ii(""));break;default:w.b("Unsupported attr selector:",c),e=new Ii("")}this.b.push(e)};var Kj=0;n=Hj.prototype;n.Yb=function(){var a="d"+Kj++;Ij(this,new hi(new Pi(a,this.j,null)));this.b=[new Ii(a)];this.j=null};n.ie=function(){var a="c"+Kj++;Ij(this,new hi(new Qi(a,this.j,null)));this.b=[new Ii(a)];this.j=null};n.he=function(){var a="a"+Kj++;Ij(this,new hi(new Ri(a,this.j,null)));this.b=[new Ii(a)];this.j=null};
n.oe=function(){var a="f"+Kj++;Ij(this,new hi(new Si(a,this.j,null)));this.b=[new Ii(a)];this.j=null};n.Mc=function(){Lj(this);this.h=null;this.C=!1;this.aa=0;this.b=[]};n.Lb=function(){var a;0!=this.u?(Hf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.u=1,this.lb={},this.h=null,this.aa=0,this.C=!1,this.b=[])};n.error=function(a,b){Ff.prototype.error.call(this,a,b);1==this.u&&(this.u=0)};n.Pc=function(a){Ff.prototype.Pc.call(this,a);this.u=0};
n.Ia=function(){Lj(this);Ff.prototype.Ia.call(this);1==this.u&&(this.u=0)};n.Zb=function(){Ff.prototype.Zb.call(this)};function Lj(a){if(a.b){var b=a.aa+a.l.hf();Ij(a,a.Rf(b));a.b=null;a.h=null;a.j=null;a.C=!1;a.aa=0}}n.Rf=function(a){var b=this.G;this.C&&(b=b?"xxx-bogus-xxx":"footnote");return new ii(this.lb,a,this.h,b,this.j)};n.Ib=function(a,b,c){Bh(this.B,a,b,c,this)};n.cd=function(a,b){Gf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};
n.ae=function(a,b){Gf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};n.Kb=function(a,b,c){"display"!=a||b!==Cd&&b!==Bd||(this.Kb("flow-options",new Ec([id,Jd]),c),this.Kb("flow-into",b,c),b=Zc);ee("SIMPLE_PROPERTY").forEach(function(d){d=d({name:a,value:b,important:c});a=d.name;b=d.value;c=d.important});var d=c?Af(this):Bf(this);Xh(this.lb,a,this.ia?new Th(b,d,this.ia):new V(b,d))};n.od=function(a){switch(a){case "not":a=new Mj(this),a.Lb(),Df(this.oa,a)}};
function Mj(a){Hj.call(this,a.f,a.oa,a.ia,a,a.G,a.B,!1);this.parent=a;this.g=a.b}v(Mj,Hj);n=Mj.prototype;n.od=function(a){"not"==a&&Hf(this,"E_CSS_UNEXPECTED_NOT")};n.Ia=function(){Hf(this,"E_CSS_UNEXPECTED_RULE_BODY")};n.Mc=function(){Hf(this,"E_CSS_UNEXPECTED_NEXT_SELECTOR")};n.Gd=function(){this.b&&0<this.b.length&&this.g.push(new Ki(this.b));this.parent.aa+=this.aa;var a=this.oa;a.b=a.g.pop()};n.error=function(a,b){Hj.prototype.error.call(this,a,b);var c=this.oa;c.b=c.g.pop()};
function Nj(a,b){Ef.call(this,a,b,!1)}v(Nj,Ff);Nj.prototype.Ib=function(a,b){if(this.f.values[a])this.error("E_CSS_NAME_REDEFINED "+a,this.bd());else{var c=a.match(/height|^(top|bottom)$/)?"vh":"vw",c=new rc(this.f,100,c),c=b.za(this.f,c);this.f.values[a]=c}};function Oj(a,b,c,d,e){Ef.call(this,a,b,!1);this.lb=d;this.ia=c;this.b=e}v(Oj,Ff);Oj.prototype.Ib=function(a,b,c){c?w.b("E_IMPORTANT_NOT_ALLOWED"):Bh(this.b,a,b,c,this)};Oj.prototype.cd=function(a,b){w.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};
Oj.prototype.ae=function(a,b){w.b("E_INVALID_PROPERTY",a+":",b.toString())};Oj.prototype.Kb=function(a,b,c){c=c?Af(this):Bf(this);c+=this.order;this.order+=mj;Xh(this.lb,a,this.ia?new Th(b,c,this.ia):new V(b,c))};function Pj(a,b){dg.call(this,a);this.lb={};this.b=b;this.order=0}v(Pj,dg);Pj.prototype.Ib=function(a,b,c){Bh(this.b,a,b,c,this)};Pj.prototype.cd=function(a,b){w.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};Pj.prototype.ae=function(a,b){w.b("E_INVALID_PROPERTY",a+":",b.toString())};
Pj.prototype.Kb=function(a,b,c){c=(c?67108864:50331648)+this.order;this.order+=mj;Xh(this.lb,a,new V(b,c))};function Qj(a,b,c){return(a=a["writing-mode"])&&(b=a.evaluate(b,"writing-mode"))&&b!==qd?b===Td:c}function Rj(a,b,c){return(a=a.direction)&&(b=a.evaluate(b,"direction"))&&b!==qd?b===Kd:c}function Sj(a,b,c,d){var e={},f;for(f in a)Wh(f)&&(e[f]=a[f]);Tj(e,b,a);Uj(a,c,d,function(a,c){Vj(e,c,b);Tj(e,b,c)});return e}
...
function nk(a,b){var c=a.responseXML;if(!c){var d=new DOMParser,e=a.responseText;if(e){var f=mk(a);(c=lk(e,f||"application/xml",d))&&!f&&(f=c.documentElement,"html"!==f.localName.toLowerCase()||f.namespaceURI?"svg"===f.localName.toLowerCase()&&"image/svg+xml"!==c.contentType&&(c=lk(e,"image/svg+xml",d)):c=lk(e,"text/html",d));c||(c=lk(e,"text/html",d))}}c=c?new bk(b,a.url,c):null;return M(c)}function ok(a){this.Kc=a}
function pk(){var a=qk;return new ok(function(b){return a.Kc(b)&&1==b.nodeType&&"http://www.idpf.org/2008/embedding"==b.getAttribute("Algorithm")})}function rk(){var a=pk(),b=qk;return new ok(function(c){if(!b.Kc(c))return!1;c=new dk([c]);c=ck(c,"EncryptionMethod");a&&(c=sk(c,a));return 0<c.size()})}var qk=new ok(function(){return!0});function dk(a){this.W=a}dk.prototype.size=function(){return this.W.length};
function sk(a,b){for(var c=[],d=t(a.W),e=d.next();!e.done;e=d.next())e=e.value,b.Kc(e)&&c.push(e);return new dk(c)}function tk(a,b){function c(a){d.push(a)}for(var d=[],e=0;e<a.W.length;e++)b(a.W[e],c);return new dk(d)}dk.prototype.forEach=function(a){for(var b=[],c=0;c<this.W.length;c++)b.push(a(this.W[c]));return b};function uk(a,b){for(var c=[],d=0;d<a.W.length;d++){var e=b(a.W[d]);null!=e&&c.push(e)}return c}
...
function Ck(a,b){this.j={};this.I=a;this.h=b;this.N=null;this.u=[];var c=this;this.J=function(a){var b=a.currentTarget,d=b.getAttribute("href")||b.getAttributeNS("http://www.w3.org/1999/xlink","href");d&&eb(c,{type:"hyperlink",target:null,currentTarget:null,gh:b,href:d,preventDefault:function(){a.preventDefault()}})};this.b={};this.g={width:0,height:0};this.C=this.B=!1;this.F=this.G=!0;this.R=0;this.position=null;this.offset=-1;this.f=null;this.l=[];this.H={top:{},bottom:{},left:{},right:{}}}
v(Ck,db);function Dk(a,b){(a.G=b)?a.I.setAttribute("data-vivliostyle-auto-page-width",!0):a.I.removeAttribute("data-vivliostyle-auto-page-width")}function Ek(a,b){(a.F=b)?a.I.setAttribute("data-vivliostyle-auto-page-height",!0):a.I.removeAttribute("data-vivliostyle-auto-page-height")}function Fk(a,b,c){var d=a.b[c];d?d.push(b):a.b[c]=[b]}
function Gk(a,b,c){Object.keys(a.b).forEach(function(a){for(var b=this.b[a],c=0;c<b.length;)this.I.contains(b[c])?c++:b.splice(c,1);b.length||delete this.b[a]},a);for(var d=a.u,e=0;e<d.length;e++){var f=d[e];x(f.target,f.name,f.value.toString())}e=Hk(c,a.I);a.g.width=e.width;a.g.height=e.height;for(e=0;e<b.length;e++)if(c=b[e],f=a.b[c.ld],d=a.b[c.Bg],f&&d&&(f=Bk(f,c.action)))for(var g=0;g<d.length;g++)d[g].addEventListener(c.event,f,!1)}
...
function Lk(a,b,c,d,e,f,g,h,l){this.b=a;this.element=b;this.f=c;this.ab=d;this.l=e;this.h=f;this.u=g;this.j=h;this.ub=-1;this.g=l}function Mk(a,b){return a.h?!b.h||a.ab>b.ab?!0:a.j:!1}function Nk(a,b){return a.top-b.top}function Ok(a,b){return b.right-a.right}function Pk(a,b){return a===b?!0:a&&b?a.node===b.node&&a.ib===b.ib&&Qk(a.ua,b.ua)&&Qk(a.Ha,b.Ha)&&Pk(a.Ea,b.Ea):!1}
function Rk(a,b){if(a===b)return!0;if(!a||!b||a.na!==b.na||a.K!==b.K||a.pa.length!==b.pa.length)return!1;for(var c=0;c<a.pa.length;c++)if(!Pk(a.pa[c],b.pa[c]))return!1;return!0}function Sk(a){return{pa:[{node:a.M,ib:Tk,ua:a.ua,Ha:null,Ea:null,Ra:0}],na:0,K:!1,Oa:a.Oa}}function Uk(a,b){var c=new Vk(a.node,b,0);c.ib=a.ib;c.ua=a.ua;c.Ha=a.Ha;c.Ea=a.Ea?Uk(a.Ea,Wk(b)):null;c.D=a.D;c.Ra=a.Ra+1;return c}var Tk=0;
function Xk(a,b,c,d,e,f,g){this.oa=a;this.hd=d;this.qf=null;this.root=b;this.ca=c;this.type=f;e&&(e.qf=this);this.b=g}function Qk(a,b){return a===b||!!a&&!!b&&(b?a.oa===b.oa&&a.ca===b.ca&&a.type===b.type&&Qk(a.hd,b.hd):!1)}function Yk(a,b){this.Cg=a;this.count=b}
function Vk(a,b,c){this.M=a;this.parent=b;this.Ka=c;this.na=0;this.K=!1;this.ib=Tk;this.ua=b?b.ua:null;this.Ea=this.Ha=null;this.Ca=!1;this.xa=!0;this.wa=!1;this.j=b?b.j:0;this.display=null;this.V=Zk;this.ba=this.N=this.l=this.Aa=null;this.Y="baseline";this.da="top";this.sa=this.la=0;this.H=!1;this.nc=b?b.nc:0;this.F=b?b.F:null;this.B=b?b.B:!1;this.O=this.ad=!1;this.C=this.A=this.G=this.g=null;this.h=b?b.h:{};this.b=b?b.b:!1;this.direction=b?b.direction:"ltr";this.f=b?b.f:null;this.Oa=this.lang=null;
this.D=b?b.D:null;this.u=null;this.va={};this.Ra=1;this.X=this.J=null}function $k(a){a.xa=!0;a.j=a.parent?a.parent.j:0;a.A=null;a.C=null;a.na=0;a.K=!1;a.display=null;a.V=Zk;a.Aa=null;a.l=null;a.N=null;a.ba=null;a.Y="baseline";a.H=!1;a.nc=a.parent?a.parent.nc:0;a.F=a.parent?a.parent.F:null;a.B=a.parent?a.parent.B:!1;a.g=null;a.G=null;a.Ha=null;a.ad=!1;a.O=!1;a.b=a.parent?a.parent.b:!1;a.Ha=null;a.Oa=null;a.D=a.parent?a.parent.D:null;a.u=null;a.va={};a.Ra=1;a.J=null;a.X=null}
function al(a){var b=new Vk(a.M,a.parent,a.Ka);b.na=a.na;b.K=a.K;b.Ha=a.Ha;b.ib=a.ib;b.ua=a.ua;b.Ea=a.Ea;b.xa=a.xa;b.j=a.j;b.display=a.display;b.V=a.V;b.Aa=a.Aa;b.l=a.l;b.N=a.N;b.ba=a.ba;b.Y=a.Y;b.da=a.da;b.la=a.la;b.sa=a.sa;b.ad=a.ad;b.O=a.O;b.H=a.H;b.nc=a.nc;b.F=a.F;b.B=a.B;b.g=a.g;b.G=a.G;b.A=a.A;b.C=a.C;b.f=a.f;b.b=a.b;b.wa=a.wa;b.Oa=a.Oa;b.D=a.D;b.u=a.u;b.va=Object.create(a.va);b.Ra=a.Ra;b.J=a.J;b.X=a.X;return b}Vk.prototype.modify=function(){return this.Ca?al(this):this};
function Wk(a){var b=a;do{if(b.Ca)break;b.Ca=!0;b=b.parent}while(b);return a}Vk.prototype.clone=function(){for(var a=al(this),b=a,c;c=b.parent;)c=al(c),b=b.parent=c;return a};function bl(a){return{node:a.M,ib:a.ib,ua:a.ua,Ha:a.Ha,Ea:a.Ea?bl(a.Ea):null,D:a.D,Ra:a.Ra}}function cl(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(bl(b)),b=b.parent;while(b);b=a.Oa?dl(a.Oa,a.na,-1):a.na;return{pa:c,na:b,K:a.K,Oa:a.Oa}}function el(a){for(a=a.parent;a;){if(a.ad)return!0;a=a.parent}return!1}
...
function ol(a){this.element=a;this.G=this.F=this.height=this.width=this.O=this.J=this.X=this.H=this.Ca=this.ba=this.Pa=this.Y=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.Tb=this.rb=null;this.yb=this.Hd=this.Ub=this.Kd=this.h=0;this.b=!1}function pl(a){return a.marginTop+a.ba+a.J}function ql(a){return a.marginBottom+a.Ca+a.O}function rl(a){return a.marginLeft+a.Y+a.H}function sl(a){return a.marginRight+a.Pa+a.X}function tl(a){return a.b?-1:1}
function ul(a,b){a.element=b.element;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.Y=b.Y;a.Pa=b.Pa;a.ba=b.ba;a.Ca=b.Ca;a.H=b.H;a.X=b.X;a.J=b.J;a.O=b.O;a.width=b.width;a.height=b.height;a.F=b.F;a.G=b.G;a.Tb=b.Tb;a.rb=b.rb;a.h=b.h;a.Kd=b.Kd;a.Ub=b.Ub;a.b=b.b}function vl(a,b,c){a.top=b;a.height=c;x(a.element,"top",b+"px");x(a.element,"height",c+"px")}
function wl(a,b,c){a.left=b;a.width=c;x(a.element,"left",b+"px");x(a.element,"width",c+"px")}function xl(a,b,c){a.b?wl(a,b+c*tl(a),c):vl(a,b,c)}function yl(a,b,c){a.b?vl(a,b,c):wl(a,b,c)}function zl(a){a=a.element;for(var b;b=a.lastChild;)a.removeChild(b)}function Al(a){var b=a.F+a.left+a.marginLeft+a.Y,c=a.G+a.top+a.marginTop+a.ba;return new lg(b,c,b+(a.H+a.width+a.X),c+(a.J+a.height+a.O))}function Bl(a,b,c){a=Cl(a);return Og(b,a.U,a.S,a.T-a.U,a.P-a.S,c)}
function Cl(a){var b=a.F+a.left,c=a.G+a.top;return new lg(b,c,b+(rl(a)+a.width+sl(a)),c+(pl(a)+a.height+ql(a)))}function Dl(a,b,c,d){this.b=a;this.f=b;this.h=c;this.g=d}v(Dl,Cc);Dl.prototype.sd=function(a){this.b.appendChild(this.b.ownerDocument.createTextNode(a.Qc));return null};Dl.prototype.Vc=function(a){if(this.h.url)this.b.setAttribute("src",a.url);else{var b=this.b.ownerDocument.createElementNS("http://www.w3.org/1999/xhtml","img");b.setAttribute("src",a.url);this.b.appendChild(b)}return null};
Dl.prototype.Mb=function(a){this.lc(a.values);return null};Dl.prototype.Rc=function(a){var b=a.za();a=b.evaluate(this.f);"string"===typeof a&&((b=this.g(b,a,this.b.ownerDocument))||(b=this.b.ownerDocument.createTextNode(a)),this.b.appendChild(b));return null};function El(a){return!!a&&a!==Ad&&a!==J&&a!==qd};function Fl(a,b,c){this.g=a;this.f=b;this.b=c}function Gl(){this.map=[]}function Hl(a){return a.map.length?a.map[a.map.length-1].b:0}function Il(a,b){if(a.map.length){var c=a.map[a.map.length-1],d=c.b+b-c.f;c.f==c.g?(c.f=b,c.g=b,c.b=d):a.map.push(new Fl(b,b,d))}else a.map.push(new Fl(b,b,b))}function Jl(a,b){a.map.length?a.map[a.map.length-1].f=b:a.map.push(new Fl(b,0,0))}function Kl(a,b){var c=Xa(a.map.length,function(c){return b<=a.map[c].f}),c=a.map[c];return c.b-Math.max(0,c.g-b)}
function Ll(a,b){var c=Xa(a.map.length,function(c){return b<=a.map[c].b}),c=a.map[c];return c.g-(c.b-b)}function Ml(a,b,c,d,e,f,g,h){this.B=a;this.style=b;this.offset=c;this.C=d;this.qa=e;this.b=e.b;this.eb=f;this.mb=g;this.F=h;this.j=this.l=null;this.u={};this.g=this.f=this.h=null;Nl(this)&&(b=b._pseudos)&&b.before&&(a=new Ml(a,b.before,c,!1,e,Ol(this),g,!0),c=Pl(a,"content"),El(c)&&(this.h=a,this.g=a.g));this.g=Ql(Rl(this,"before"),this.g);this.mb&&Sl[this.g]&&(e.g=Ql(e.g,this.g))}
...
function Wl(a){return a.b[a.b.length-1]}function Xl(a){return a.b.every(function(a){return Tl(a)!==J})}Vl.prototype.push=function(a,b,c,d){var e=Wl(this);d&&e&&d.b!==e.b&&this.f.push({eb:this.eb,mb:this.mb});e=d||e.qa;d=this.mb||!!d;var f=Xl(this);a=new Ml(this.g,a,b,c,e,d||this.eb,d,f);this.b.push(a);this.eb=Nl(a)?!a.h&&Ol(a):this.eb;this.mb=Nl(a)?!a.h&&d:this.mb;return a};
...
function Zl(a,b,c,d,e,f,g,h){this.ca=a;this.root=a.root;this.jb=c;this.h=d;this.B=f;this.f=this.root;this.F={};this.X={};this.G={};this.J=[];this.C=this.O=this.N=null;this.Ca=g;this.Y=new pj(b,d,g,h);this.g=new Gl;this.u=!0;this.da=[];this.Pa=e;this.va=this.sa=!1;this.b=a=ek(a,this.root);this.ba={};this.j=new Vl(d);Il(this.g,a);d=$l(this,this.root);Bj(this.Y,this.root,d,a);am(this,d,!1);this.H=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.H=
!1}this.da.push(!0);this.X={};this.X["e"+a]=d;this.b++;bm(this,-1)}function cm(a,b,c,d){return(b=b[d])&&b.evaluate(a.h)!==c[d]}function dm(a,b,c){for(var d in c){var e=b[d];e?(a.F[d]=e,delete b[d]):(e=c[d])&&(a.F[d]=new V(e,33554432))}}var em=["column-count","column-width","column-fill"];
...
a.h.u*Lb.ex/Lb.em;break;case "%":d*=a.h.u/100;break;default:(e=Lb[e.ka])&&(d*=e)}a.h.sa=d}}function fm(a){for(var b=0;!a.H&&(b+=5E3,gm(a,b,0)!=Number.POSITIVE_INFINITY););return a.F}function $l(a,b){if(b.style instanceof CSSStyleDeclaration){var c=b.getAttribute("style");if(c){var d=a.ca.url,e=new Pj(a.jb,a.B),c=new of(c,e);try{cg(new Uf(Jf,c,e,d),Number.POSITIVE_INFINITY,!1,!0,!1,!1)}catch(f){w.b(f,"Style attribute parse error:")}return e.lb}}return{}}
function bm(a,b){if(!(b>=a.b)){var c=a.h,d=ek(a.ca,a.root);if(b<d){var e=a.l(a.root,!1),f=e["flow-into"],f=f?f.evaluate(c,"flow-into").toString():"body",f=hm(a,f,e,a.root,d);!a.j.b.length&&a.j.push(e,d,!0,f)}d=hk(a.ca,b);e=fk(a.ca,d,0,!1);if(!(e>=a.b))for(;;){if(1!=d.nodeType)e+=d.textContent.length;else{var g=d;if(e!=ek(a.ca,g))throw Error("Inconsistent offset");var h=a.l(g,!1);if(f=h["flow-into"])f=f.evaluate(c,"flow-into").toString(),hm(a,f,h,g,e);e++}if(e>=a.b)break;f=d.firstChild;if(!f)for(;!(f=
...
function hm(a,b,c,d,e){var f=0,g=Number.POSITIVE_INFINITY,h=!1,l=!1,k=!1,m=c["flow-options"];if(m){var p;a:{if(h=m.evaluate(a.h,"flow-options")){l=new Jg;try{h.ea(l);p=l.b;break a}catch(q){w.b(q,"toSet:")}}p={}}k=p;h=!!k.exclusive;l=!!k["static"];k=!!k.last}(p=c["flow-linger"])&&(g=Lg(p.evaluate(a.h,"flow-linger"),Number.POSITIVE_INFINITY));(c=c["flow-priority"])&&(f=Lg(c.evaluate(a.h,"flow-priority"),0));c=a.ba[e]||null;p=a.G[b];p||(p=Wl(a.j),p=a.G[b]=new Kk(p?p.qa.b:null));d=new Lk(b,d,e,f,g,h,
l,k,c);a.J.push(d);a.O==b&&(a.O=null);a.N&&jm(a.N,d,p);return d}function km(a,b,c,d){Sl[b]&&(d=a.G[d].b,(!d.length||d[d.length-1]<c)&&d.push(c));a.ba[c]=Ql(a.ba[c],b)}
function gm(a,b,c){var d=-1;if(b<=a.b&&(d=Kl(a.g,b),d+=c,d<Hl(a.g)))return Ll(a.g,d);if(!a.f)return Number.POSITIVE_INFINITY;for(var e=a.h;;){var f=a.f.firstChild;if(!f)for(;;){if(1==a.f.nodeType){var f=a.Y,g=a.f;if(f.Fb.pop()!==g)throw Error("Invalid call to popElement");f.Ub.pop();f.la.pop();f.Tb.pop();f.Sb.pop();Fj(f);zj(f);a.u=a.da.pop();var f=a.j,h=a.b,l=g=f.b.pop(),k=f.eb,m=f.mb;if(Nl(l)){var p=l.style._pseudos;p&&p.after&&(h=new Ml(l.B,p.after,h,!1,l.qa,k,m,!0),k=Pl(h,"content"),El(k)&&(l.f=
h))}f.mb&&g.f&&(l=Rl(g.f,"before"),g.qa.g=Ql(g.qa.g,l));if(l=Wl(f))l.b===g.b?Nl(g)&&(f.eb=f.mb=!1):(l=f.f.pop(),f.eb=l.eb,f.mb=l.mb);f=null;g.f&&(f=Rl(g.f,"before"),km(a,f,g.f.eb?Yl(a.j,g):g.f.offset,g.b),f=Rl(g.f,"after"));f=Ql(f,Rl(g,"after"));km(a,f,a.b,g.b)}if(f=a.f.nextSibling)break;a.f=a.f.parentNode;if(a.f===a.root)return a.f=null,b<a.b&&(0>d&&(d=Kl(a.g,b),d+=c),d<=Hl(a.g))?Ll(a.g,d):Number.POSITIVE_INFINITY}a.f=f;if(1!=a.f.nodeType)a.b+=a.f.textContent.length,f=a.j,g=a.f,l=Wl(f),(f.eb||f.mb)&&
Nl(l)&&(l=Pl(l,"white-space",Ad).toString(),Jk(g,Ik(l))||(f.eb=!1,f.mb=!1)),a.u?Il(a.g,a.b):Jl(a.g,a.b);else{g=a.f;f=$l(a,g);a.da.push(a.u);Bj(a.Y,g,f,a.b);(l=g.getAttribute("id")||g.getAttributeNS("http://www.w3.org/XML/1998/namespace","id"))&&l===a.C&&(a.C=null);a.H||"body"!=g.localName||g.parentNode!=a.root||(am(a,f,!0),a.H=!0);(l=f["flow-into"])?(l=l.evaluate(e,"flow-into").toString(),h=hm(a,l,f,g,a.b),a.u=!!a.Pa[l],g=a.j.push(f,a.b,g===a.root,h)):g=a.j.push(f,a.b,g===a.root);l=Yl(a.j,g);km(a,
g.g,l,g.b);g.h&&(h=Rl(g.h,"after"),km(a,h,g.h.eb?l:g.offset,g.b));a.u&&Tl(g)===J&&(a.u=!1);if(ek(a.ca,a.f)!=a.b)throw Error("Inconsistent offset");a.X["e"+a.b]=f;a.b++;a.u?Il(a.g,a.b):Jl(a.g,a.b);if(b<a.b&&(0>d&&(d=Kl(a.g,b),d+=c),d<=Hl(a.g)))return Ll(a.g,d)}}}Zl.prototype.l=function(a,b){var c=ek(this.ca,a),d="e"+c;b&&(c=fk(this.ca,a,0,!0));this.b<=c&&gm(this,c,0);return this.X[d]};Zl.prototype.la=function(){};var lm={"font-style":Ad,"font-variant":Ad,"font-weight":Ad},mm="OTTO"+(new Date).valueOf(),nm=1;function om(a,b){var c={},d;for(d in a)c[d]=a[d].evaluate(b,d);for(var e in lm)c[e]||(c[e]=lm[e]);return c}function pm(a){a=this.yc=a;var b=new Pa,c;for(c in lm)b.append(" "),b.append(a[c].toString());this.f=b.toString();this.src=this.yc.src?this.yc.src.toString():null;this.g=[];this.h=[];this.b=(c=this.yc["font-family"])?c.stringValue():null}
function qm(a,b,c){var d=new Pa;d.append("@font-face {\n  font-family: ");d.append(a.b);d.append(";\n  ");for(var e in lm)d.append(e),d.append(": "),a.yc[e].Ya(d,!0),d.append(";\n  ");c?(d.append('src: url("'),b=(window.URL||window.webkitURL).createObjectURL(c),d.append(b),a.g.push(b),a.h.push(c),d.append('")')):(d.append("src: "),d.append(b));d.append(";\n}\n");return d.toString()}function rm(a){this.f=a;this.b={}}
...
function vm(a,b,c,d){var e=L("initFont"),f=b.src,g={},h;for(h in lm)g[h]=b.yc[h];d=um(a,b,d);g["font-family"]=D(d);var l=new pm(g),k=a.body.ownerDocument.createElement("span");k.textContent="M";var m=(new Date).valueOf()+1E3;b=a.b.ownerDocument.createElement("style");h=mm+nm++;b.textContent=qm(l,"",tf([h]));a.b.appendChild(b);a.body.appendChild(k);k.style.visibility="hidden";k.style.fontFamily=d;for(var p in lm)x(k,p,g[p].toString());var g=k.getBoundingClientRect(),q=g.right-g.left,r=g.bottom-g.top;
...
function Ql(a,b){if(a)if(b){var c=!!Sl[a],d=!!Sl[b];if(c&&d)switch(b){case "column":return a;case "region":return"column"===a?b:a;default:return b}else return d?b:c?a:ym[b]?b:ym[a]?a:b}else return a;else return b}function zm(a){switch(a){case "left":case "right":case "recto":case "verso":return a;default:return"any"}};function Am(){}n=Am.prototype;n.Nf=function(a){return{w:a,yd:!1,Ob:!1}};n.pf=function(){};n.xf=function(){};n.eg=function(){};n.wf=function(){};n.ud=function(){};n.mc=function(){};function Bm(a,b){this.b=a;this.f=b}
function Cm(a,b){var c=a.b,d=c.Nf(b),e=L("LayoutIterator");Ce(function(b){for(var e;d.w;){e=d.w.A?1!==d.w.A.nodeType?Jk(d.w.A,d.w.nc)?void 0:d.w.K?c.xf(d):c.pf(d):d.w.xa?d.w.K?c.wf(d):c.eg(d):d.w.K?c.mc(d):c.ud(d):void 0;e=(e&&e.Wa()?e:M(!0)).ha(function(){return d.Ob?M(null):Dm(a.f,d.w,d.yd)});if(e.Wa()){e.then(function(a){d.Ob?Q(b):(d.w=a,P(b))});return}if(d.Ob){Q(b);return}d.w=e.get()}Q(b)}).then(function(){O(e,d.w)});return e.result()}function Em(a){this.bc=a}v(Em,Am);n=Em.prototype;n.fg=function(){};
n.Hf=function(){};n.Nf=function(a){return{w:a,yd:!!this.bc&&a.K,Ob:!1,bc:this.bc,Xc:null,Ee:!1,Qf:[],dd:null}};n.pf=function(a){a.Ee=!1};n.ud=function(a){a.Qf.push(Wk(a.w));a.Xc=Ql(a.Xc,a.w.g);a.Ee=!0;return this.fg(a)};n.mc=function(a){var b;a.Ee?(b=(b=void 0,M(!0)),b=b.ha(function(){a.Ob||(a.Qf=[],a.bc=!1,a.yd=!1,a.Xc=null);return M(!0)})):b=(b=this.Hf(a))&&b.Wa()?b:M(!0);return b.ha(function(){a.Ob||(a.Ee=!1,a.dd=Wk(a.w),a.Xc=Ql(a.Xc,a.w.G));return M(!0)})};
function Fm(a,b,c){this.nf=[];this.ya=Object.create(a);this.ya.element=b;this.ya.j=a.j.clone();this.ya.u=!1;this.ya.ff=c.D;this.ya.Fd=a;a=Gm(this.ya,c);this.ya.da-=a;var d=this;this.ya.Ad=function(a){return Hm.prototype.Ad.call(this,a).ha(function(a){d.nf.push(Wk(a));return M(a)})}}function Im(a,b){return Jm(a.ya,b,!0)}Fm.prototype.$b=function(a){var b=this.ya.$b();if(a){a=Wk(this.nf[0]);var c=new Km(a,null,a.wa,0);c.f(this.ya,0);if(!b.w)return{Ab:c,w:a}}return b};
Fm.prototype.La=function(a,b,c){return this.ya.La(a,b,c)};function Lm(){this.u=this.h=null}function Mm(a,b,c){a.Zf(b,c);return Nm(a,b,c)}function Nm(a,b,c){var d=L("vivliostyle.layoututil.AbstractLayoutRetryer.tryLayout");a.sf(b,c);var e=a.kf(b);e.b(b,c).then(function(a){var f=e.f(a,c);(f=e.g(a,this.f,c,f))?O(d,a):(this.Cd(this.f),this.de(b,c),Nm(this,this.f,c).Ja(d))}.bind(a));return d.result()}Lm.prototype.Zf=function(){};
Lm.prototype.Cd=function(a){a=a.A||a.parent.A;for(var b;b=a.lastChild;)a.removeChild(b);for(;b=a.nextSibling;)b.parentNode.removeChild(b)};Lm.prototype.sf=function(a,b){this.f=Wk(a);this.h=[].concat(b.N);this.C=[].concat(b.B);a.D&&(this.u=a.D.Te())};Lm.prototype.de=function(a,b){b.N=this.h;b.B=this.C;a.D&&a.D.Se(this.u)};function Om(a,b,c,d){d=d[b];if(!d)throw Error("unknown writing-mode: "+b);b=d[c||"ltr"];if(!b)throw Error("unknown direction: "+c);c=t(b);for(b=c.next();!b.done;b=c.next())if(b=b.value,b=a.replace(b.h,b.b),b!==a)return b;return a}function Pm(a){var b=Qm,c={};Object.keys(b).forEach(function(d){var e=c[d]={},f=b[d];Object.keys(f).forEach(function(b){e[b]=f[b].map(function(b){return{h:new RegExp("(-?)"+(a?b.fa:b.ga)+"(-?)"),b:"$1"+(a?b.ga:b.fa)+"$2"}})})});return c}
var Qm={"horizontal-tb":{ltr:[{fa:"inline-start",ga:"left"},{fa:"inline-end",ga:"right"},{fa:"block-start",ga:"top"},{fa:"block-end",ga:"bottom"},{fa:"inline-size",ga:"width"},{fa:"block-size",ga:"height"}],rtl:[{fa:"inline-start",ga:"right"},{fa:"inline-end",ga:"left"},{fa:"block-start",ga:"top"},{fa:"block-end",ga:"bottom"},{fa:"inline-size",ga:"width"},{fa:"block-size",ga:"height"}]},"vertical-rl":{ltr:[{fa:"inline-start",ga:"top"},{fa:"inline-end",ga:"bottom"},{fa:"block-start",ga:"right"},{fa:"block-end",
...
ga:"top"},{fa:"block-start",ga:"left"},{fa:"block-end",ga:"right"},{fa:"inline-size",ga:"height"},{fa:"block-size",ga:"width"}]}},Rm=Pm(!0),Sm=Pm(!1);var Zk="inline";function Tm(a){switch(a){case "inline":return Zk;case "column":return"column";case "region":return"region";case "page":return"page";default:throw Error("Unknown float-reference: "+a);}}function Um(a){switch(a){case Zk:return!1;case "column":case "region":case "page":return!0;default:throw Error("Unknown float-reference: "+a);}}function Vm(a,b,c,d,e,f){this.b=a;this.V=b;this.Aa=c;this.h=d;this.f=e;this.j=f;this.id=this.order=null}
Vm.prototype.Ga=function(){if(null===this.order)throw Error("The page float is not yet added");return this.order};function Wm(a){if(!a.id)throw Error("The page float is not yet added");return a.id}Vm.prototype.Ze=function(){return!1};function Xm(){this.b=[];this.f=0}Xm.prototype.hf=function(){return this.f++};
Xm.prototype.ge=function(a){if(0<=this.b.findIndex(function(b){return Rk(b.b,a.b)}))throw Error("A page float with the same source node is already registered");var b=a.order=this.hf();a.id="pf"+b;this.b.push(a)};Xm.prototype.Ye=function(a){var b=this.b.findIndex(function(b){return Rk(b.b,a)});return 0<=b?this.b[b]:null};function Ym(a,b,c,d,e){this.V=a;this.Aa=b;this.Hb=c;this.b=d;this.g=e}function Zm(a,b){return a.Hb.some(function(a){return a.ja===b})}
Ym.prototype.Ga=function(){var a=this.Hb.map(function(a){return a.ja});return Math.min.apply(null,a.map(function(a){return a.Ga()}))};Ym.prototype.f=function(a){return this.Ga()<a.Ga()};function $m(a,b){this.ja=a;this.b=b}
function an(a,b,c,d,e,f,g){(this.parent=a)&&a.children.push(this);this.children=[];this.V=b;this.I=c;this.h=d;this.H=e;this.F=f||a&&a.F||pd;this.direction=g||a&&a.direction||zd;this.Lc=!1;this.u=a?a.u:new Xm;this.B=[];this.b=[];this.j=[];this.l={};this.f=[];a:{b=this;for(a=this.parent;a;){if(b=bn(a,b,this.V,this.h,this.H)){a=b;break a}b=a;a=a.parent}a=null}this.G=a?[].concat(a.f):[];this.C=[];this.g=!1}function cn(a,b){if(!a.parent)throw Error("No PageFloatLayoutContext for "+b);return a.parent}
function bn(a,b,c,d,e){b=a.children.indexOf(b);0>b&&(b=a.children.length);for(--b;0<=b;b--){var f=a.children[b];if(f.V===c&&f.h===d&&Rk(f.H,e)||(f=bn(f,null,c,d,e)))return f}return null}function dn(a,b){return b&&b!==a.V?dn(cn(a,b),b):a.I}function en(a,b){a.I=b;fn(a)}an.prototype.ge=function(a){this.u.ge(a)};function gn(a,b){return b===a.V?a:gn(cn(a,b),b)}an.prototype.Ye=function(a){return this.u.Ye(a)};
function hn(a,b){var c=Wm(b),d=b.V;d===a.V?a.B.includes(c)||(a.B.push(c),jn(b).ig(b,a)):hn(cn(a,d),b)}function kn(a,b){var c=Wm(b),d=b.V;return d===a.V?a.B.includes(c):kn(cn(a,d),b)}function ln(a,b,c){var d=b.V;d!==a.V?ln(cn(a,d),b,c):a.b.includes(b)||(a.b.push(b),a.b.sort(function(a,b){return a.Ga()-b.Ga()}));c||mn(a)}function nn(a,b,c){var d=b.V;d!==a.V?nn(cn(a,d),b,c):(b=a.b.indexOf(b),0<=b&&(b=a.b.splice(b,1)[0],(b=b.b&&b.b.element)&&b.parentNode&&b.parentNode.removeChild(b),c||mn(a)))}
...
function tn(a,b){if(un(a).some(function(a){return Wm(a.ja)===b}))return!0;var c=sn(a)[b];return c?a.I&&a.I.element?a.I.element.contains(c):!1:!1}function vn(a,b){var c=b.ja;if(c.V===a.V){var d=a.f.findIndex(function(a){return a.ja===c});0<=d?a.f.splice(d,1,b):a.f.push(b)}else vn(cn(a,c.V),b)}function wn(a,b,c){if(!c&&b.V!==a.V)return wn(cn(a,b.V),b,!1);var d=b.Ga();return a.f.some(function(a){return a.ja.Ga()<d&&!b.Ze(a.ja)})?!0:a.parent?wn(a.parent,b,!0):!1}
function un(a,b){b=b||a.h;var c=a.G.filter(function(a){return!b||a.ja.f===b});a.parent&&(c=un(a.parent,b).concat(c));return c.sort(function(a,b){return a.ja.Ga()-b.ja.Ga()})}function xn(a,b){b=b||a.h;var c=a.f.filter(function(a){return!b||a.ja.f===b});return a.parent?xn(a.parent,b).concat(c):c}function yn(a){for(var b=[],c=[],d=a.children.length-1;0<=d;d--){var e=a.children[d];c.includes(e.h)||(c.push(e.h),b=b.concat(e.f.map(function(a){return a.ja})),b=b.concat(yn(e)))}return b}
...
function An(a){var b=yn(a),c=a.b.reduce(function(a,b){return a.concat(b.Hb.map(function(a){return a.ja}))},[]);c.sort(function(a,b){return b.Ga()-a.Ga()});for(var d={},c=t(c),e=c.next();!e.done;d={ja:d.ja,order:d.order},e=c.next())if(d.ja=e.value,d.order=d.ja.Ga(),b.some(function(a){return function(b){return!a.ja.Ze(b)&&a.order>b.Ga()}}(d)))return a.g?mn(a):(hn(a,d.ja),b=on(a,d.ja),nn(a,b)),!0;return!1}
...
function mn(a){a.Lc=!0;a.g||(a.I&&(a.children.forEach(function(a){Dn(this,a)&&a.b.forEach(function(a){(a=a.b.element)&&a.parentNode&&a.parentNode.removeChild(a)})},a),zl(a.I)),a.children.forEach(function(a){a.C.splice(0)}),a.children.splice(0),Object.keys(a.l).forEach(function(a){delete this.l[a]},a))}function En(a){a=a.children.splice(0);a.forEach(function(a){a.b.forEach(function(a){(a=a.b.element)&&a.parentNode&&a.parentNode.removeChild(a)})});return a}
function Fn(a,b){b.forEach(function(a){this.children.push(a);fn(a)},a)}function Gn(a){return a.Lc||!!a.parent&&Gn(a.parent)}function Bn(a,b){return Om(b,a.F.toString(),a.direction.toString()||null,Sm)}function Hn(a,b){var c=b.V;if(c!==a.V)Hn(cn(a,c),b);else if(c=Bn(a,b.Aa),"block-end"===c||"snap-block"===c||"inline-end"===c)for(var d=0;d<a.b.length;){var e=a.b[d],f=Bn(a,e.Aa);(f===c||"snap-block"===c&&"block-end"===f)&&e.f(b)?(a.j.push(e),a.b.splice(d,1)):d++}}
function In(a,b){b!==a.V?In(cn(a,b),b):(a.j.forEach(function(a){ln(this,a,!0)},a),a.j.splice(0))}function Jn(a,b){b!==a.V?Jn(cn(a,b),b):a.j.splice(0)}function Kn(a,b){return b===a.V?a.j.concat().sort(function(a,b){return b.Ga()-a.Ga()}):Kn(cn(a,b),b)}
...
function Mn(a,b,c,d){function e(a,d,e){if("%"===a.ka)a=e*a.L/100;else{e=a.L;var f=a.ka,g;b:switch(f.toLowerCase()){case "em":case "ex":case "rem":g=!0;break b;default:g=!1}if(g){for(;d&&1!==d.nodeType;)d=d.parentNode;d=parseFloat(Nn(c,d)["font-size"]);a=ei(a,d,b.b).L}else a=(d=Pb(b.b,f,!1))?e*d:a}return a}var f=a.I.F,g=a.I.G,h=Al(a.I),l={top:h.S-g,left:h.U-f,bottom:h.P-g,right:h.T-f,Jc:0,Ic:0},k=a.b;0<k.length&&(l=k.reduce(function(b,c){if(d&&!d(c,a))return b;var f=Bn(a,c.Aa),g=c.b,k=c.Hb[0].ja.j,
l=b.top,m=b.left,p=b.bottom,E=b.right,K=b.Jc,I=b.Ic;switch(f){case "inline-start":g.b?l=Math.max(l,g.top+g.height):m=Math.max(m,g.left+g.width);break;case "block-start":g.b?(k&&g.left<E&&(K=e(k,g.Sb[0],h.T-h.U)),E=Math.min(E,g.left)):(k&&g.top+g.height>l&&(K=e(k,g.Sb[0],h.P-h.S)),l=Math.max(l,g.top+g.height));break;case "inline-end":g.b?p=Math.min(p,g.top):E=Math.min(E,g.left);break;case "block-end":g.b?(k&&g.left+g.width>m&&(I=e(k,g.Sb[0],h.T-h.U)),m=Math.max(m,g.left+g.width)):(k&&g.top<p&&(I=e(k,
g.Sb[0],h.P-h.S)),p=Math.min(p,g.top));break;default:throw Error("Unknown logical float side: "+f);}return{top:l,left:m,bottom:p,right:E,Jc:K,Ic:I}},l));l.left+=f;l.right+=f;l.top+=g;l.bottom+=g;return l}
function On(a,b,c,d,e,f,g,h){function l(a,c){var d=a(b.Eb,c);return d?(b.b&&(d=new lg(-d.P,d.U,-d.S,d.T)),m=b.b?Math.min(m,d.T):Math.max(m,d.S),p=b.b?Math.max(p,d.U):Math.min(p,d.P),!0):g}if(c!==a.V)return On(cn(a,c),b,c,d,e,f,g,h);var k=Bn(a,d);if("snap-block"===k){if(!h["block-start"]&&!h["block-end"])return null}else if(!h[k])return null;var m=Ln(a,"block-start",b.j,b.f),p=Ln(a,"block-end",b.j,b.f);c=Ln(a,"inline-start",b.j,b.f);var q=Ln(a,"inline-end",b.j,b.f),r=b.b?b.F:b.G,z=b.b?b.G:b.F,m=b.b?
...
ql(b));var A=(p-m)*tl(b);if("snap-block"===k&&(null===e?k="block-start":(k=Al(a.I),k=tl(a.I)*(e-(a.I.b?k.T:k.S))<=tl(a.I)*((a.I.b?k.U:k.P)-e-u)?"block-start":"block-end"),!h[k]))if(h["block-end"])k="block-end";else return null;if(!g&&A<u)return null;a="inline-start"===k||"inline-end"===k?Pn(b.f,b.element,[Qn])[Qn]:b.qe?Rn(b):b.b?b.height:b.width;e=a+(b.b?pl(b):rl(b))+(b.b?ql(b):sl(b));if(!g&&q-c<e)return null}m-=r;p-=r;c-=z;q-=z;switch(k){case "inline-start":case "block-start":case "snap-block":yl(b,
...
function Tn(a){var b=dn(a).b;return a.b.reduce(function(a,d){var c=Cl(d.b);return b?Math.min(a,c.U):Math.max(a,c.P)},b?Infinity:0)}function Un(a){var b=dn(a).b;return a.b.filter(function(a){return"block-end"===a.Aa}).reduce(function(a,d){var c=Cl(d.b);return b?Math.max(a,c.T):Math.min(a,c.S)},b?0:Infinity)}
function Vn(a,b){function c(a){return function(b){return tn(a,Wm(b.ja))}}function d(a,b){return a.Hb.some(c(b))}for(var e=Al(b),e=b.b?e.U:e.P,f=a;f;){if(f.f.some(c(f)))return e;f=f.parent}f=Ln(a,"block-start",b.j,b.f,d);return Ln(a,"block-end",b.j,b.f,d)*tl(b)<e*tl(b)?e:f}
...
function io(a){for(var b=ee("RESOLVE_LAYOUT_PROCESSOR"),c=0;c<b.length;c++){var d=b[c](a);if(d)return d}throw Error("No processor found for a formatting context: "+a.Re());}function jo(a){this.Dd=a}jo.prototype.b=function(a){return this.Dd.every(function(b){return b.b(a)})};function ko(){}ko.prototype.u=function(){};ko.prototype.g=function(){return null};function lo(a,b){return{current:b.reduce(function(b,d){return b+d.b(a)},0),Ce:b.reduce(function(b,d){return b+d.F(a)},0)}}
function mo(a,b){this.h=a;this.Nc=b;this.j=!1;this.l=null}v(mo,ko);mo.prototype.f=function(a,b){if(b<this.b())return null;this.j||(this.l=no(a,this,0<b),this.j=!0);return this.l};mo.prototype.b=function(){return this.Nc};mo.prototype.g=function(){return this.j?this.l:this.h[this.h.length-1]};function Km(a,b,c,d){this.position=a;this.F=b;this.B=this.j=c;this.C=d;this.h=!1;this.rc=0}v(Km,ko);
Km.prototype.f=function(a,b){if(!this.h){var c=Gm(a,this.position);this.rc=go(this.position,a.f,0,a.b)+c;this.h=!0}var c=this.rc,d=lo(this.g(),oo(a));this.B=po(a,c+(a.b?-1:1)*d.Ce);this.j=this.position.wa=po(a,c+(a.b?-1:1)*d.current);b<this.b()?c=null:(a.h=this.C+qo(a,this),c=this.position);return c};
...
function so(a){for(var b=1;b<a.length;b++){var c=a[b-1],d=a[b];c===d?w.b("validateCheckPoints: duplicate entry"):c.Ka>=d.Ka?w.b("validateCheckPoints: incorrect boxOffset"):c.M==d.M&&(d.K?c.K&&w.b("validateCheckPoints: duplicate after points"):c.K||d.Ka-c.Ka!=d.na-c.na&&w.b("validateCheckPoints: boxOffset inconsistent with offsetInNode"))}}function to(a){this.parent=a}to.prototype.Re=function(){return"Block formatting context (adapt.layout.BlockFormattingContext)"};to.prototype.af=function(a,b){return b};
to.prototype.Te=function(){};to.prototype.Se=function(){};function Hm(a,b,c,d,e){ol.call(this,a);this.j=b;this.f=c;this.Ec=d;this.Hg=a.ownerDocument;this.l=e;en(e,this);this.ff=null;this.Uf=this.ag=!1;this.da=this.la=this.C=this.jb=this.va=0;this.Eb=this.Yf=this.Xf=null;this.Ed=!1;this.g=this.N=null;this.Fb=!0;this.te=this.Ae=this.ze=0;this.u=!0;this.xb=null;this.B=[];this.sa=this.Fd=null;this.ef=NaN}v(Hm,ol);function uo(a,b){return!!b.Aa&&(!a.ag||!!b.parent)}
function po(a,b){return a.b?b<a.da:b>a.da}function vo(a,b){if(a)for(var c;(c=a.lastChild)!=b;)a.removeChild(c)}Hm.prototype.Ad=function(a){var b=this,c=L("openAllViews"),d=a.pa;wo(b.j,b.element,b.Uf);var e=d.length-1,f=null;Be(function(){for(;0<=e;){f=Uk(d[e],f);e!==d.length-1||f.D||(f.D=b.ff);if(!e){var c=f,h;h=a;h=h.Oa?dl(h.Oa,h.na,1):h.na;c.na=h;f.K=a.K;f.Oa=a.Oa;if(f.K)break}c=xo(b.j,f,!e&&!f.na);e--;if(c.Wa())return c}return M(!1)}).then(function(){O(c,f)});return c.result()};var yo=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
function zo(a,b){if(b.f&&b.xa&&!b.K&&!b.f.count&&1!=b.A.nodeType){var c=b.A.textContent.match(yo);return Ao(a.j,b,c[0].length)}return M(b)}
function Bo(a,b,c){var d=!1,e=L("buildViewToNextBlockEdge");Ce(function(e){b.A&&!Co(b)&&c.push(Wk(b));zo(a,b).then(function(f){f!==b&&(b=f,Co(b)||c.push(Wk(b)));Do(a,b).then(function(c){if(b=c){if(d||!a.Ec.b(b))d=!0,b=b.modify(),b.wa=!0;uo(a,b)&&!a.b?Eo(a,b).then(function(c){b=c;Gn(a.l)&&(b=null);b?P(e):Q(e)}):b.xa?P(e):Q(e)}else Q(e)})})}).then(function(){O(e,b)});return e.result()}function Do(a,b,c){b=Dm(a.j,b,c);return Fo(b,a)}
function Go(a,b){if(!b.A)return M(b);var c=[],d=b.M,e=L("buildDeepElementView");Ce(function(e){b.A&&b.xa&&!Co(b)?c.push(Wk(b)):(0<c.length&&Ho(a,b,c),c=[]);zo(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.M!=d;)g=g.parent;if(!g){b=f;Q(e);return}Co(f)||c.push(Wk(f))}Do(a,f).then(function(c){(b=c)&&b.M!=d?a.Ec.b(b)?P(e):(b=b.modify(),b.wa=!0,a.u?Q(e):P(e)):Q(e)})})}).then(function(){0<c.length&&Ho(a,b,c);O(e,b)});return e.result()}
...
function Ko(a){for(var b=a.element.firstChild,c=a.b?a.b?a.va:a.C:a.b?a.la:a.va,d=a.b?a.b?a.jb:a.la:a.b?a.C:a.jb,e=t(a.Eb),f=e.next();!f.done;f=e.next()){var f=f.value,g=f.P-f.S;f.left=Io(a,b,"left",f.U-c,g);f.right=Io(a,b,"right",d-f.T,g)}}
function Lo(a,b,c,d,e){var f;if(b&&Mo(b.A))return NaN;if(b&&b.K&&!b.xa&&(f=go(b,a.f,0,a.b),!isNaN(f)))return f;b=c[d];for(e-=b.Ka;;){f=go(b,a.f,e,a.b);if(!isNaN(f))return f;if(0<e)e--;else{d--;if(0>d)return a.C;b=c[d];1!=b.A.nodeType&&(e=b.A.textContent.length)}}}function X(a){return"number"==typeof a?a:(a=a.match(/^(-?[0-9]*(\.[0-9]*)?)px$/))?parseFloat(a[0]):0}
...
function Po(a,b){var c=L("layoutFloat"),d=b.A,e=b.Aa;x(d,"float","none");x(d,"display","inline-block");x(d,"vertical-align","top");Go(a,b).then(function(f){for(var g=Hk(a.f,d),h=No(a,d),g=new lg(g.left-h.left,g.top-h.top,g.right+h.right,g.bottom+h.bottom),h=a.va,l=a.jb,k=b.parent;k&&k.xa;)k=k.parent;if(k){var m=k.A.ownerDocument.createElement("div");m.style.left="0px";m.style.top="0px";a.b?(m.style.bottom="0px",m.style.width="1px"):(m.style.right="0px",m.style.height="1px");k.A.appendChild(m);var p=
Hk(a.f,m),h=Math.max(a.b?p.top:p.left,h),l=Math.min(a.b?p.bottom:p.right,l);k.A.removeChild(m);m=a.b?g.P-g.S:g.T-g.U;"left"==e?l=Math.max(l,h+m):h=Math.min(h,l-m);k.A.appendChild(b.A)}m=new lg(h,tl(a)*a.C,l,tl(a)*a.la);h=g;a.b&&(h=Cg(g));l=tl(a);h.S<a.te*l&&(p=h.P-h.S,h.S=a.te*l,h.P=h.S+p);a:for(var l=a.Eb,p=h,q=p.S,r=p.T-p.U,z=p.P-p.S,u=Gg(l,q);;){var A=q+z;if(A>m.P)break a;for(var H=m.U,E=m.T,K=u;K<l.length&&l[K].S<A;K++){var I=l[K];I.U>H&&(H=I.U);I.T<E&&(E=I.T)}if(H+r<=E||u>=l.length){"left"==
e?(p.U=H,p.T=H+r):(p.U=E-r,p.T=E);p.P+=q-p.S;p.S=q;break a}q=l[u].P;u++}a.b&&(g=new lg(-h.P,h.U,-h.S,h.T));a:{m=Nn(a.f,d);l=new ng;if(m){if("border-box"==m.boxSizing){m=No(a,d);break a}l.left=X(m.marginLeft)+X(m.borderLeftWidth)+X(m.paddingLeft);l.top=X(m.marginTop)+X(m.borderTopWidth)+X(m.paddingTop);l.right=X(m.marginRight)+X(m.borderRightWidth)+X(m.paddingRight);l.bottom=X(m.marginBottom)+X(m.borderBottomWidth)+X(m.paddingBottom)}m=l}x(d,"width",g.T-g.U-m.left-m.right+"px");x(d,"height",g.P-g.S-
m.top-m.bottom+"px");x(d,"position","absolute");x(d,"display",b.display);l=null;if(k)if(k.O)l=k;else a:{for(k=k.parent;k;){if(k.O){l=k;break a}k=k.parent}l=null}l?(m=l.A.ownerDocument.createElement("div"),m.style.position="absolute",l.b?m.style.right="0":m.style.left="0",m.style.top="0",l.A.appendChild(m),k=Hk(a.f,m),l.A.removeChild(m)):k={left:(a.b?a.la:a.va)-a.H,right:(a.b?a.C:a.jb)+a.X,top:(a.b?a.va:a.C)-a.J};(l?l.b:a.b)?x(d,"right",k.right-g.T+"px"):x(d,"left",g.U-k.left+"px");x(d,"top",g.S-k.top+
"px");b.C&&(b.C.parentNode.removeChild(b.C),b.C=null);k=a.b?g.U:g.P;g=a.b?g.T:g.S;if(po(a,k)&&a.N.length)b=b.modify(),b.wa=!0,O(c,b);else{Jo(a);m=new lg(a.b?a.la:a.va,a.b?a.va:a.C,a.b?a.C:a.jb,a.b?a.jb:a.la);a.b&&(m=Cg(m));l=a.Eb;for(p=[new pg(h.S,h.P,h.U,h.T)];0<p.length&&p[0].P<=m.S;)p.shift();if(p.length){p[0].S<m.S&&(p[0].S=m.S);h=l.length?l[l.length-1].P:m.S;h<m.P&&l.push(new pg(h,m.P,m.U,m.T));h=Gg(l,p[0].S);p=t(p);for(q=p.next();!q.done;q=p.next()){r=q.value;if(h==l.length)break;l[h].S<r.S&&
(q=l[h],h++,l.splice(h,0,new pg(r.S,q.P,q.U,q.T)),q.P=r.S);for(;h<l.length&&(q=l[h++],q.P>r.P&&(l.splice(h,0,new pg(r.P,q.P,q.U,q.T)),q.P=r.P),r.U!=r.T&&("left"==e?q.U=Math.min(r.T,m.T):q.T=Math.max(r.U,m.U)),q.P!=r.P););}Fg(m,l)}Ko(a);"left"==e?a.ze=k:a.Ae=k;a.te=g;Qo(a,k);O(c,f)}});return c.result()}
function Ro(a,b,c,d,e,f){var g=a.element.ownerDocument.createElement("div");x(g,"position","absolute");var h=gn(a.l,b.V),l=new an(null,"column",null,a.l.h,b.b,null,null),h=dn(h),g=new So(c,g,a.j.clone(),a.f,a.Ec,l,h);en(l,g);var h=b.V,k=a.l;b=dn(k,h);l=g.element;b.element.parentNode.appendChild(l);g.ag=!0;g.F=b.F;g.G=b.G;g.b=b.b;g.marginLeft=g.marginRight=g.marginTop=g.marginBottom=0;g.Y=g.Pa=g.ba=g.Ca=0;g.H=g.X=g.J=g.O=0;g.rb=(b.rb||[]).concat();g.Fb=!pn(k);g.Tb=null;var m=Al(b);wl(g,m.U-b.F,m.T-
m.U);vl(g,m.S-b.G,m.P-m.S);e.vf(g,b,a);To(g);(a=!!On(k,g,h,c,d,!0,!pn(k),f))?(Jo(g),To(g)):b.element.parentNode.removeChild(l);return a?g:null}
...
a.parentNode.removeChild(a)});O(l,!h)});return l.result()}function Xo(a,b){var c=b.A.parentNode,d=c.ownerDocument.createElement("span");d.setAttribute("data-adapt-spec","1");"footnote"===b.Aa&&Yo(a.j,b,"footnote-call",d);c.appendChild(d);c.removeChild(b.A);c=b.modify();c.K=!0;c.A=d;return c}
...
function $o(a,b){var c=a.l,d=bo(b),e=c.Ye(cl(b));return(e?M(e):d.Ff(b,c,a)).ha(function(e){var f=Sk(b),h=Xo(a,b),l=d.rf(e,c),f=new $m(e,f);if(l&&Zm(l,e))return rn(c,e,h.A),M(h);if(kn(c,e)||wn(c,e))return vn(c,f),rn(c,e,h.A),M(h);if(a.sa)return M(null);var k=go(h,a.f,0,a.b);return po(a,k)?M(h):Vo(a,f,d,k,l).ha(function(a){if(a)return M(null);rn(c,e,h.A);return M(h)})})}
function ap(a,b,c){if(!b.K||b.xa){if(c){for(var d="",e=b.parent;e&&!d;e=e.parent)!e.xa&&e.A&&(d=e.A.style.textAlign);if("justify"!==d)return}var f=b.A,g=f.ownerDocument,h=c&&(b.K||1!=f.nodeType);(d=h?f.nextSibling:f)&&!d.parentNode&&(d=null);if(e=f.parentNode||b.parent&&b.parent.A){var l=d,k=document.body;if(null===hb){var m=k.ownerDocument,p=m.createElement("div");p.style.position="absolute";p.style.top="0px";p.style.left="0px";p.style.width="40px";p.style.height="100px";p.style.lineHeight="16px";
...
function cp(a,b,c,d){var e=L("processLineStyling");so(d);var f=d.concat([]);d.splice(0,d.length);var g=0,h=b.f;0==h.count&&(h=h.Cg);Ce(function(d){if(h){var e=dp(a,f),l=h.count-g;if(e.length<=l)Q(d);else{var p=ep(a,f,e[l-1]);p?a.La(p,!1,!1).then(function(){g+=l;Ao(a.j,p,0).then(function(e){b=e;ap(a,b,!1);h=b.f;f=[];Bo(a,b,f).then(function(a){c=a;P(d)})})}):Q(d)}}else Q(d)}).then(function(){Array.prototype.push.apply(d,f);so(d);O(e,c)});return e.result()}
...
function gp(a,b){var c=L("layoutBreakableBlock"),d=[];Bo(a,b,d).then(function(e){var f=d.length-1;if(0>f)O(c,e);else{var f=Lo(a,e,d,f,d[f].Ka),g=!1;if(!e||!Mo(e.A)){var h=lo(e,oo(a)),g=po(a,f+(a.b?-1:1)*h.Ce);po(a,f+(a.b?-1:1)*h.current)&&!a.sa&&(a.sa=e)}e||(f+=fp(a,d));Qo(a,f);var l;b.f?l=cp(a,b,e,d):l=M(e);l.then(function(b){Ho(a,b,d);0<d.length&&(a.N.push(new mo(d,d[0].j)),g&&(2!=d.length&&0<a.N.length||d[0].M!=d[1].M||!fo[d[0].M.localName])&&b&&(b=b.modify(),b.wa=!0));O(c,b)})}});return c.result()}
function Ho(a,b,c){ee("POST_LAYOUT_BLOCK").forEach(function(d){d(b,c,a)})}
function ep(a,b,c){so(b);var d=a.b?c-1:c+1,e=0,f=b[0].Ka;c=e;for(var g=b.length-1,h=b[g].Ka,l;f<h;){l=f+Math.ceil((h-f)/2);c=e;for(var k=g;c<k;){var m=c+Math.ceil((k-c)/2);b[m].Ka>l?k=m-1:c=m}k=Lo(a,null,b,c,l);if(a.b?k<=d:k>=d){for(h=l-1;b[c].Ka==l;)c--;g=c}else Qo(a,k),f=l,e=c}d=f;b=b[c];c=b.A;1!=c.nodeType&&(hp(b),b.K?b.na=c.length:(e=d-b.Ka,d=c.data,173==d.charCodeAt(e)?(c.replaceData(e,d.length-e,b.B?"":bp(b)),c=e+1):(f=d.charAt(e),e++,g=d.charAt(e),c.replaceData(e,d.length-e,!b.B&&Ua(f)&&Ua(g)?
...
h-1)){h=a.b?k.bottom:k.right;a.b?(e=d?Math.max(e,k.right):k.right,g=d?Math.min(g,k.left):k.left):(e=d?Math.min(e,k.top):k.top,g=d?Math.max(g,k.bottom):k.bottom);d++;l++;continue}0<d&&(c.push(g),d=0);if(l>=f.length)break}c.sort(Ya);a.b&&c.reverse();return c}function Gm(a,b){var c=0;fl(b,function(b){if("clone"===b.h["box-decoration-break"]){var d=Oo(a,b.A);c+=b.b?-d.left:d.bottom;"table"===b.display&&(c+=b.sa)}});return c}function qo(a,b){return(b?lo(b.g(),oo(a)):lo(null,oo(a))).current}
function no(a,b,c){for(var d=b.h,e=d[0];e.parent&&e.xa;)e=e.parent;var f;c?f=c=1:(c=Math.max((e.h.widows||2)-0,1),f=Math.max((e.h.orphans||2)-0,1));var e=Gm(a,e),g=dp(a,d),h=a.da-e,e=tl(a),l=qo(a,b),h=h-e*l,k=kp(a,d);isNaN(k.rc)&&(k.rc=Infinity*e);var d=Xa(g.length,function(b){b=g[b];return a.b?b<h||b<=k.rc:b>h||b>=k.rc}),m=0>=d;m&&(d=Xa(g.length,function(b){return a.b?g[b]<h:g[b]>h}));d=Math.min(g.length-c,d);if(d<f)return null;h=g[d-1];if(b=m?k.Cf:ep(a,b.h,h))c=lp(a,b),!isNaN(c)&&c<h&&(h=c),a.h=
e*(h-a.C)+l;return b}function lp(a,b){var c=b;do c=c.parent;while(c&&c.xa);return c?(c=Wk(c).modify(),c.K=!0,go(c,a.f,0,a.b)):NaN}function kp(a,b){var c=b.findIndex(function(a){return a.wa});if(0>c)return{rc:NaN,Cf:null};var d=b[c];return{rc:Lo(a,null,b,c,d.Ka),Cf:d}}Hm.prototype.La=function(a,b,c){var d=io(a.D).La(this,a,b,c);d||(d=mp.La(this,a,b,c));return d};
Hm.prototype.$b=function(){var a=null,b=null,c,d=0;do{c=d;for(var d=Number.MAX_VALUE,e=this.N.length-1;0<=e&&!b;--e){var a=this.N[e],b=a.f(this,c),f=a.b();f>c&&(d=Math.min(d,f))}}while(d>c&&!b&&this.Fb);return{Ab:b?a:null,w:b}};
function np(a,b,c,d,e){if(Gn(a.l)||a.g||!c)return M(b);var f=L("doFinishBreak"),g=!1;if(!b){if(a.Fb)return w.b("Could not find any page breaks?!!"),op(a,c).then(function(b){b?(b=b.modify(),b.wa=!1,a.La(b,g,!0).then(function(){O(f,b)})):O(f,b)}),f.result();b=d;g=!0;a.h=e}a.La(b,g,!0).then(function(){O(f,b)});return f.result()}function pp(a){a=a.toString();return""==a||"auto"==a||!!a.match(/^0+(.0*)?[^0-9]/)}
function qp(a,b,c){if(!b||Mo(b.A))return!1;var d=go(b,a.f,0,a.b),e=lo(b,oo(a)),f=po(a,d+(a.b?-1:1)*e.Ce);po(a,d+(a.b?-1:1)*e.current)&&!a.sa?a.sa=b:c&&(b=d+fp(a,c),e=a.da-tl(a)*e.current,d=a.b?Math.min(d,Math.max(b,e)):Math.max(d,Math.min(b,e)));Qo(a,d);return f}function rp(a,b,c,d,e){if(!b||Mo(b.A))return!1;c=qp(a,b,c);!d&&c||sp(a,b,e,c);return c}
function tp(a,b){if(!b.A.parentNode)return!1;var c=No(a,b.A),d=b.A.ownerDocument.createElement("div");a.b?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.A.parentNode.insertBefore(d,b.A);var e=Hk(a.f,d),e=a.b?e.right:e.top,f=tl(a),g=b.l,h=Infinity*-tl(a);"all"===g&&(h=Vn(a.l,a));switch(g){case "left":h=f*Math.max(h*f,a.ze*f);break;case "right":h=f*Math.max(h*f,a.Ae*f);break;default:h=f*Math.max(h*
f,Math.max(a.Ae*f,a.ze*f))}if(e*f>=h*f)return b.A.parentNode.removeChild(d),!1;e=Math.max(1,(h-e)*f);a.b?d.style.width=e+"px":d.style.height=e+"px";e=Hk(a.f,d);e=a.b?e.left:e.bottom;a.b?(h=e+c.right-h,0<h==0<=c.right&&(h+=c.right),d.style.marginLeft=h+"px"):(h-=e+c.top,0<h==0<=c.top&&(h+=c.top),d.style.marginBottom=h+"px");b.C=d;return!0}function up(a){return a instanceof to?!0:a instanceof vp?!1:a instanceof wp?!0:!1}
function xp(a,b,c,d){function e(){return!!d||!c&&!!Sl[m]}function f(){b=q[0]||b;b.A.parentNode.removeChild(b.A);h.g=m}var g=b.K?b.parent&&b.parent.D:b.D;if(g&&!up(g))return M(b);var h=a,l=L("skipEdges"),k=!d&&c&&b&&b.K,m=d,p=null,q=[],r=[],z=!1;Ce(function(a){for(;b;){var d=io(b.D);do if(b.A){if(b.xa&&1!=b.A.nodeType){if(Jk(b.A,b.nc))break;if(!b.K){e()?f():rp(h,p,null,!0,m)?(b=(h.u?p||b:b).modify(),b.wa=!0):(b=b.modify(),b.g=m);Q(a);return}}if(!b.K){if(d&&d.Ue(b))break;b.l&&tp(h,b)&&c&&!h.N.length&&
sp(h,Wk(b),m,!1);if(!up(b.D)||b.D instanceof wp||uo(h,b)||b.H){q.push(Wk(b));m=Ql(m,b.g);if(e())f();else if(rp(h,p,null,!0,m)||!h.Ec.b(b))b=(h.u?p||b:b).modify(),b.wa=!0;Q(a);return}}if(1==b.A.nodeType){var g=b.A.style;if(b.K){if(!(b.xa||d&&d.uf(b,h.u))){if(z){if(e()){f();Q(a);return}q=[];k=c=!1;m=null}z=!1;p=Wk(b);r.push(p);m=Ql(m,b.G);!g||pp(g.paddingBottom)&&pp(g.borderBottomWidth)||(r=[p])}}else{q.push(Wk(b));m=Ql(m,b.g);if(!h.Ec.b(b)&&(rp(h,p,null,!h.u,m),b=b.modify(),b.wa=!0,h.u)){Q(a);return}if(fo[b.A.localName]){e()?
f():rp(h,p,null,!0,m)&&(b=(h.u?p||b:b).modify(),b.wa=!0);Q(a);return}!g||pp(g.paddingTop)&&pp(g.borderTopWidth)||(k=!1,r=[]);z=!0}}}while(0);d=Do(h,b,k);if(d.Wa()){d.then(function(c){b=c;P(a)});return}b=d.get()}rp(h,p,r,!h.u,m)?p&&h.u&&(b=p.modify(),b.wa=!0):Sl[m]&&(h.g=m);Q(a)}).then(function(){p&&(h.xb=cl(p));O(l,b)});return l.result()}
function op(a,b){var c=Wk(b),d=L("skipEdges"),e=null,f=!1;Ce(function(d){for(;b;){do if(b.A){if(b.xa&&1!=b.A.nodeType){if(Jk(b.A,b.nc))break;if(!b.K){Sl[e]&&(a.g=e);Q(d);return}}if(!b.K&&(uo(a,b)||b.H)){e=Ql(e,b.g);Sl[e]&&(a.g=e);Q(d);return}if(1==b.A.nodeType){var g=b.A.style;if(b.K){if(f){if(Sl[e]){a.g=e;Q(d);return}e=null}f=!1;e=Ql(e,b.G)}else{e=Ql(e,b.g);if(fo[b.A.localName]){Sl[e]&&(a.g=e);Q(d);return}if(g&&(!pp(g.paddingTop)||!pp(g.borderTopWidth))){Q(d);return}}f=!0}}while(0);g=Dm(a.j,b);if(g.Wa()){g.then(function(a){b=
a;P(d)});return}b=g.get()}c=null;Q(d)}).then(function(){O(d,c)});return d.result()}function Eo(a,b){return Um(b.V)||"footnote"===b.Aa?$o(a,b):Po(a,b)}function yp(a,b,c,d){var e=L("layoutNext");xp(a,b,c,d||null).then(function(d){b=d;!b||a.g||a.u&&b&&b.wa?O(e,b):io(b.D).ee(b,a,c).Ja(e)});return e.result()}function ip(a,b,c){if(b)for(var d=b.parent;b;b=d,d=d?d.parent:null)io((d||b).D).xd(a,d,b,c),c=!1}
function To(a){a.Yf=[];x(a.element,"width",a.width+"px");x(a.element,"height",a.height+"px");var b=a.element.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.J+"px";b.style.right=a.X+"px";b.style.bottom=a.O+"px";b.style.left=a.H+"px";a.element.appendChild(b);var c=Hk(a.f,b);a.element.removeChild(b);var b=a.F+a.left+rl(a),d=a.G+a.top+pl(a);a.Xf=new lg(b,d,b+a.width,d+a.height);a.va=c?a.b?c.top:c.left:0;a.jb=c?a.b?c.bottom:c.right:0;a.C=c?a.b?c.right:c.top:0;a.la=c?a.b?c.left:
c.bottom:0;a.ze=a.C;a.Ae=a.C;a.te=a.C;a.da=a.la;c=a.Xf;b=a.F+a.left+rl(a);d=a.G+a.top+pl(a);d=new lg(b,d,b+a.width,d+a.height);if(a.Tb){for(var b=d.U,d=d.S,e=[],f=t(a.Tb.b),g=f.next();!g.done;g=f.next())g=g.value,e.push(new mg(g.f+b,g.b+d));b=new rg(e)}else b=ug(d.U,d.S,d.T,d.P);b=[b];d=Sn(a.l);a.Eb=Eg(c,b,a.rb.concat(d),a.Ub,a.b);Ko(a);a.h=0;a.Ed=!1;a.g=null;a.xb=null}function sp(a,b,c,d){var e=Wk(b);b=io(b.D);var f=Gm(a,e);c=b.Ef(e,c,d,a.h+f);a.N.push(c)}
function Qo(a,b){isNaN(b)||(a.h=Math.max(tl(a)*(b-a.C),a.h))}
function Jm(a,b,c,d){a.Yf.push(b);b.f.K&&(a.xb=b.f);if(a.u&&a.Ed)return M(b);if(Zn(a.l,a))return b.f.K&&1===b.f.pa.length?M(null):M(b);var e=L("layout");a.Ad(b.f).then(function(b){var f=null;if(b.A)f=Wk(b);else{var h=function(b){b.w.A&&(f=b.w,a.j.removeEventListener("nextInTree",h))};a.j.addEventListener("nextInTree",h)}var l=new zp(c,d);Mm(l,b,a).then(function(b){np(a,b,l.g.Pd,f,l.b).then(function(b){var c=null;a.Fd?c=M(null):c=Ap(a,b);c.then(function(){if(Gn(a.l))O(e,null);else if(b){a.Ed=!0;var c=
new hl(cl(b));O(e,c)}else O(e,null)})})})});return e.result()}function Ap(a,b){var c=L("doFinishBreakOfFragmentLayoutConstraints"),d=[].concat(a.B);d.sort(function(a,b){return a.pe()-b.pe()});var e=0;Be(function(){return e<d.length?d[e++].La(b,a).Cc(!0):M(!1)}).then(function(){O(c,!0)});return c.result()}
function Dp(a,b,c,d){var e=L("doLayout"),f=null;a.N=[];a.sa=null;Ce(function(e){for(var g={};b;){g.Ma=!0;yp(a,b,c,d||null).then(function(g){return function(h){c=!1;d=null;a.sa&&a.u?(a.g=null,b=a.sa,b.wa=!0):b=h;Gn(a.l)?Q(e):a.g?Q(e):b&&a.u&&b&&b.wa?(f=b,h=a.$b(),b=h.w,h.Ab&&h.Ab.u(a),Q(e)):g.Ma?g.Ma=!1:P(e)}}(g));if(g.Ma){g.Ma=!1;return}g={Ma:g.Ma}}a.h+=qo(a);Q(e)}).then(function(){O(e,{w:b,Pd:f})});return e.result()}function Ep(a){var b=Un(a.l);0<b&&isFinite(b)&&(a.ef=tl(a)*(b-a.C-a.h))}
function Mo(a){for(;a;){if(a.parentNode===a.ownerDocument)return!1;a=a.parentNode}return!0}function zp(a,b){Lm.call(this);this.bc=a;this.B=b||null;this.l=null;this.b=0;this.j=!1;this.g={Pd:null}}v(zp,Lm);n=zp.prototype;n.kf=function(){return new Fp(this.bc,this.B,this.g)};n.Zf=function(a,b){b.B=[];b.Fd||(Gp=[])};n.Cd=function(a){for(Lm.prototype.Cd.call(this,a);a;){var b=a.A;b&&vo(b.parentNode,b);a=a.parent}};n.sf=function(a,b){Lm.prototype.sf.call(this,a,b);this.l=b.g;this.b=b.h;this.j=b.Ed};
n.de=function(a,b){Lm.prototype.de.call(this,a,b);b.g=this.l;b.h=this.b;b.Ed=this.j};function Fp(a,b,c){this.bc=a;this.j=b;this.h=c}Fp.prototype.b=function(a,b){var c=this,d=L("adapt.layout.DefaultLayoutMode.doLayout");Hp(a,b).then(function(){Dp(b,a,c.bc,c.j).then(function(a){c.h.Pd=a.Pd;O(d,a.w)})});return d.result()};Fp.prototype.f=function(a,b){var c=this;return Gn(b.l)||b.g||0>=b.B.length?!0:b.B.every(function(d){return d.fe(a,c.h.Pd,b)})};
Fp.prototype.g=function(a,b,c,d){d||(d=!c.B.some(function(b){return b.fd(a)}));c.B.forEach(function(e){e.Wc(d,a,b,c)});return d};function Ip(){}n=Ip.prototype;n.ee=function(a,b){var c;if(uo(b,a))c=Eo(b,a);else{a:if(a.K)c=!0;else{switch(a.M.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!a.H}c=c?gp(b,a):Go(b,a)}return c};n.Ef=function(a,b,c,d){return new Km(Wk(a),b,c,d)};n.Ue=function(){return!1};n.uf=function(){return!1};
n.xd=function(a,b,c,d){c.A&&c.A.parentNode&&(a=c.A.parentNode,vo(a,c.A),d&&a.removeChild(c.A))};n.La=function(a,b,c,d){c=c||!!b.A&&1==b.A.nodeType&&!b.K;ip(a,b,c);d&&(ap(a,b,!0),Jp(c?b:b.parent));return M(!0)};var mp=new Ip;de("RESOLVE_FORMATTING_CONTEXT",function(a,b,c,d,e,f){b=a.parent;return!b&&a.D?null:b&&a.D!==b.D?null:a.ad||!a.D&&Ul(c,d,e,f).display===Zc?new to(b?b.D:null):null});de("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof to?mp:null});
function So(a,b,c,d,e,f,g){Hm.call(this,b,c,d,e,f);this.Aa=a;this.bg=g;this.Sb=[];this.$f=[];this.qe=!0}v(So,Hm);
So.prototype.Ad=function(a){var b=this;return Hm.prototype.Ad.call(this,a).ha(function(a){if(a){for(var c=a;c.parent;)c=c.parent;c=c.A;b.Sb.push(c);b.qe&&Kp(b,c);b.$f.push(No(b,c));if(b.qe){var e=b.Aa;if(b.bg.b){if("block-end"===e||"left"===e)e=Na(c,"height"),""!==e&&"auto"!==e&&x(c,"margin-top","auto")}else if("block-end"===e||"bottom"===e)e=Na(c,"width"),""!==e&&"auto"!==e&&x(c,"margin-left","auto")}}return M(a)})};
...
function Up(a,b){var c=a.f[b],d=a.h[b];d||(d=a.h[b]=[]);for(var e=!1,f=0;f<a.g.length;){var g=a.g[f];g.Bc===b?(g.md=!0,a.g.splice(f,1),c&&(e=c.indexOf(g),0<=e&&c.splice(e,1)),d.push(g),e=!0):f++}e||Vp(a,b,!0)}function Vp(a,b,c){a.u.some(function(a){return a.Bc===b})||a.u.push(new Np(b,c))}
function $p(a,b,c){var d=Object.keys(a.j.b);if(0<d.length){var e=Mp(a.b);d.forEach(function(a){this.B[a]=e;var d=this.C[a];if(d&&d.$<c&&(d=this.h[a])){var f=this.f[a];f||(f=this.f[a]=[]);for(var g;g=d.shift();)g.md=!1,f.push(g)}this.C[a]={R:b,$:c}},a)}for(var d=a.G,f;f=a.u.shift();){f.Ge=d;f.R=b;f.$=c;var g=void 0;f.md?(g=a.h[f.Bc])||(g=a.h[f.Bc]=[]):(g=a.f[f.Bc])||(g=a.f[f.Bc]=[]);g.every(function(a){return!(f===a||a&&f.Bc===a.Bc&&f.md===a.md&&f.R===a.R&&f.$===a.$)})&&g.push(f)}a.j=null}
function aq(a,b){var c=[];Object.keys(b.b).forEach(function(a){(a=this.f[a])&&(c=c.concat(a))},a);c.sort(function(a,b){return a.R-b.R||a.$-b.$});var d=[],e=null;c.forEach(function(a){e&&e.R===a.R&&e.$===a.$?e.Rd.push(a):(e={R:a.R,$:a.$,Ge:a.Ge,Rd:[a]},d.push(e))});return d}function bq(a,b){a.H.push(a.g);a.g=b}function Sp(a,b,c,d){"pages"===b&&a.Ie.push({Hc:d,format:c})}function cq(a){return a.N.bind(a)}
Wp.prototype.N=function(a,b,c){return 0<=this.Ie.findIndex(function(b){return b.Hc===a})?(c=c.createElement("span"),c.textContent=b,c.setAttribute("data-vivliostyle-pages-counter",a.g),c):null};function dq(a,b){var c=a.b.page[0];Array.from(b.root.querySelectorAll("[data-vivliostyle-pages-counter]")).forEach(function(a){var b=a.getAttribute("data-vivliostyle-pages-counter"),d=this.Ie.findIndex(function(a){return a.Hc.g===b});a.textContent=this.Ie[d].format([c])},a)}
function eq(a,b){this.f=a;this.$=b}eq.prototype.b=function(a){if(!a||a.K)return!0;a=a.A;if(!a||1!==a.nodeType)return!0;a=a.getAttribute("id")||a.getAttribute("name");return a&&(this.f.h[a]||this.f.f[a])?(a=this.f.C[a])?this.$>=a.$:!0:!0};var fq=1;function gq(a,b,c,d,e){this.b={};this.children=[];this.g=null;this.index=0;this.f=a;this.name=b;this.hc=c;this.Na=d;this.parent=e;this.j="p"+fq++;e&&(this.index=e.children.length,e.children.push(this))}gq.prototype.h=function(){throw Error("E_UNEXPECTED_CALL");};gq.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function hq(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
...
function kq(a,b){this.g=b;var c=this;Fb.call(this,a,function(a,b){var d=a.match(/^([^.]+)\.([^.]+)$/);if(d){var e=c.g.l[d[1]];if(e&&(e=this.va[e])){if(b){var d=d[2],h=e.da[d];if(h)e=h;else{switch(d){case "columns":var h=e.f.f,l=new xc(h,0),k=lq(e,"column-count"),m=lq(e,"column-width"),p=lq(e,"column-gap"),h=B(h,zc(h,new uc(h,"min",[l,k]),y(h,m,p)),p)}h&&(e.da[d]=h);e=h}}else e=lq(e,d[2]);return e}}return null})}v(kq,Fb);
function mq(a,b,c,d,e,f,g){a=a instanceof kq?a:new kq(a,this);gq.call(this,a,b,c,d,e);this.g=this;this.ia=f;this.aa=g;this.b.width=new V(Xd,0);this.b.height=new V(Yd,0);this.b["wrap-flow"]=new V(Wc,0);this.b.position=new V(Ed,0);this.b.overflow=new V(Ud,0);this.b.top=new V(new F(-1,"px"),0);this.l={}}v(mq,gq);mq.prototype.h=function(a){return new nq(a,this)};mq.prototype.clone=function(a){a=new mq(this.f,this.name,a.hc||this.hc,this.Na,this.parent,this.ia,this.aa);hq(this,a);iq(this,a);return a};
function oq(a,b,c,d,e){gq.call(this,a,b,c,d,e);this.g=e.g;b&&(this.g.l[b]=this.j);this.b["wrap-flow"]=new V(Wc,0)}v(oq,gq);oq.prototype.h=function(a){return new pq(a,this)};oq.prototype.clone=function(a){a=new oq(a.parent.f,this.name,this.hc,this.Na,a.parent);hq(this,a);iq(this,a);return a};function qq(a,b,c,d,e){gq.call(this,a,b,c,d,e);this.g=e.g;b&&(this.g.l[b]=this.j)}v(qq,gq);qq.prototype.h=function(a){return new rq(a,this)};
qq.prototype.clone=function(a){a=new qq(a.parent.f,this.name,this.hc,this.Na,a.parent);hq(this,a);iq(this,a);return a};function Y(a,b,c){return b&&b!==Wc?b.za(a,c):null}function sq(a,b,c){return b&&b!==Wc?b.za(a,c):a.b}function tq(a,b,c){return b?b===Wc?null:b.za(a,c):a.b}function uq(a,b,c,d){return b&&c!==J?b.za(a,d):a.b}function vq(a,b,c){return b?b===Vd?a.j:b===jd?a.h:b.za(a,a.b):c}
function wq(a,b){this.g=a;this.f=b;this.J={};this.style={};this.B=this.C=null;this.children=[];this.N=this.O=this.h=this.j=!1;this.G=this.H=0;this.F=null;this.la={};this.da={};this.va=this.Y=this.b=!1;a&&a.children.push(this)}function xq(a){a.H=0;a.G=0}function yq(a,b,c){b=lq(a,b);c=lq(a,c);if(!b||!c)throw Error("E_INTERNAL");return y(a.f.f,b,c)}
function lq(a,b){var c=a.la[b];if(c)return c;var d=a.style[b];d&&(c=d.za(a.f.f,a.f.f.b));switch(b){case "margin-left-edge":c=lq(a,"left");break;case "margin-top-edge":c=lq(a,"top");break;case "margin-right-edge":c=yq(a,"border-right-edge","margin-right");break;case "margin-bottom-edge":c=yq(a,"border-bottom-edge","margin-bottom");break;case "border-left-edge":c=yq(a,"margin-left-edge","margin-left");break;case "border-top-edge":c=yq(a,"margin-top-edge","margin-top");break;case "border-right-edge":c=
...
yq(a,"padding-top-edge","padding-top");break;case "right-edge":c=yq(a,"left-edge","width");break;case "bottom-edge":c=yq(a,"top-edge","height")}if(!c){if("extent"==b)d=a.b?"width":"height";else if("measure"==b)d=a.b?"height":"width";else{var e=a.b?Ph:Qh,d=b,f;for(f in e)d=d.replace(f,e[f])}d!=b&&(c=lq(a,d))}c&&(a.la[b]=c);return c}
...
function Hq(a,b,c){var d=Z(a,b,"right"),e=Z(a,b,"snap-height"),f=Z(a,b,"margin-right"),g=Z(a,b,"padding-right");b=Z(a,b,"border-right-width");x(c.element,"margin-right",f+"px");x(c.element,"padding-right",g+"px");x(c.element,"border-right-width",b+"px");c.marginRight=f;c.Pa=b;a.b&&0<e&&(a=d+sl(c),a-=Math.floor(a/e)*e,0<a&&(c.Hd=e-a,g+=c.Hd));c.X=g;c.Kd=e}
function Iq(a,b,c){var d=Z(a,b,"snap-height"),e=Z(a,b,"top"),f=Z(a,b,"margin-top"),g=Z(a,b,"padding-top");b=Z(a,b,"border-top-width");c.top=e;c.marginTop=f;c.ba=b;c.Ub=d;!a.b&&0<d&&(a=e+pl(c),a-=Math.floor(a/d)*d,0<a&&(c.yb=d-a,g+=c.yb));c.J=g;x(c.element,"top",e+"px");x(c.element,"margin-top",f+"px");x(c.element,"padding-top",g+"px");x(c.element,"border-top-width",b+"px")}
function Jq(a,b,c){var d=Z(a,b,"margin-bottom"),e=Z(a,b,"padding-bottom"),f=Z(a,b,"border-bottom-width");a=Z(a,b,"height")-c.yb;x(c.element,"height",a+"px");x(c.element,"margin-bottom",d+"px");x(c.element,"padding-bottom",e+"px");x(c.element,"border-bottom-width",f+"px");c.height=a-c.yb;c.marginBottom=d;c.Ca=f;c.O=e}function Kq(a,b,c){a.b?(Iq(a,b,c),Jq(a,b,c)):(Hq(a,b,c),Gq(a,b,c))}
function Lq(a,b,c){x(c.element,"border-top-width","0px");var d=Z(a,b,"max-height");a.O?vl(c,0,d):(Iq(a,b,c),d-=c.yb,c.height=d,x(c.element,"height",d+"px"))}function Mq(a,b,c){x(c.element,"border-left-width","0px");var d=Z(a,b,"max-width");a.N?wl(c,0,d):(Hq(a,b,c),d-=c.Hd,c.width=d,a=Z(a,b,"right"),x(c.element,"right",a+"px"),x(c.element,"width",d+"px"))}
...
wq.prototype.l=function(a,b){var c=this.J,d=this.f.b,e;for(e in d)Wh(e)&&Xh(c,e,d[e]);if("background-host"==this.f.hc)for(e in b)if(e.match(/^background-/)||"writing-mode"==e)c[e]=b[e];if("layout-host"==this.f.hc)for(e in b)e.match(/^background-/)||"writing-mode"==e||(c[e]=b[e]);vj(a,this.f.Na,null,c);c.content&&(c.content=c.content.Id(new Zi(a,null,a.xb)));Cq(this,a.l);c=t(this.f.children);for(d=c.next();!d.done;d=c.next())d.value.h(this).l(a,b);Fj(a)};
function Uq(a,b){a.j&&(a.N=Bq(a,"right",a.C,b)||Bq(a,"margin-right",a.C,b)||Bq(a,"border-right-width",a.C,b)||Bq(a,"padding-right",a.C,b));a.h&&(a.O=Bq(a,"top",a.B,b)||Bq(a,"margin-top",a.B,b)||Bq(a,"border-top-width",a.B,b)||Bq(a,"padding-top",a.B,b));for(var c=t(a.children),d=c.next();!d.done;d=c.next())Uq(d.value,b)}function Vq(a){wq.call(this,null,a)}v(Vq,wq);Vq.prototype.l=function(a,b){wq.prototype.l.call(this,a,b);this.children.sort(function(a,b){return b.f.aa-a.f.aa||a.f.index-b.f.index})};
function nq(a,b){wq.call(this,a,b);this.F=this}v(nq,wq);nq.prototype.X=function(a){var b=this.f.g;b.ia&&(a=yc(b.f,a,b.ia));return a};nq.prototype.ba=function(){};function pq(a,b){wq.call(this,a,b);this.F=a.F}v(pq,wq);function rq(a,b){wq.call(this,a,b);this.F=a.F}v(rq,wq);
...
rq.prototype.X=function(a){var b=this.f.f,c=this.style,d=vq(b,c.required,b.h)!==b.h;if(d||this.h){var e=c["flow-from"],e=e?e.za(b,b.b):new Gb(b,"body"),e=new uc(b,"has-content",[e]);a=yc(b,a,e)}a=Wq(this,a,c["required-partitions"],!1);a=Wq(this,a,c["conflicting-partitions"],!0);d&&(c=(c=this.F.style.enabled)?c.za(b,null):b.j,c=yc(b,c,a),this.F.style.enabled=new G(c));return a};rq.prototype.fc=function(a,b,c,d,e){x(b.element,"overflow","hidden");wq.prototype.fc.call(this,a,b,c,d,e)};
function Xq(a,b,c,d){Ef.call(this,a,b,!1);this.target=c;this.b=d}v(Xq,Ff);Xq.prototype.Ib=function(a,b,c){Bh(this.b,a,b,c,this)};Xq.prototype.ae=function(a,b){Gf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};Xq.prototype.cd=function(a,b){Gf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Xq.prototype.Kb=function(a,b,c){this.target.b[a]=new V(b,c?50331648:67108864)};function Yq(a,b,c,d){Xq.call(this,a,b,c,d)}v(Yq,Xq);
function Zq(a,b,c,d){Xq.call(this,a,b,c,d);c.b.width=new V(Wd,0);c.b.height=new V(Wd,0)}v(Zq,Xq);Zq.prototype.qd=function(a,b,c){a=new qq(this.f,a,b,c,this.target);Df(this.oa,new Yq(this.f,this.oa,a,this.b))};Zq.prototype.pd=function(a,b,c){a=new oq(this.f,a,b,c,this.target);a=new Zq(this.f,this.oa,a,this.b);Df(this.oa,a)};function $q(a,b,c,d){Xq.call(this,a,b,c,d)}v($q,Xq);$q.prototype.qd=function(a,b,c){a=new qq(this.f,a,b,c,this.target);Df(this.oa,new Yq(this.f,this.oa,a,this.b))};
$q.prototype.pd=function(a,b,c){a=new oq(this.f,a,b,c,this.target);a=new Zq(this.f,this.oa,a,this.b);Df(this.oa,a)};function ar(a){a=a.toString();switch(a){case "inline-flex":a="flex";break;case "inline-grid":a="grid";break;case "inline-table":a="table";break;case "inline":case "table-row-group":case "table-column":case "table-column-group":case "table-header-group":case "table-footer-group":case "table-row":case "table-cell":case "table-caption":case "inline-block":a="block"}return D(a)}function Ul(a,b,c,d){if(a!==J)if(b===Tc||b===kd)c=J,a=ar(a);else if(c&&c!==J||d)a=ar(a);return{display:a,position:b,ja:c}}
function br(a){switch(a.toString()){case "inline":case "inline-block":case "inline-list-item":case "inline-flex":case "inline-grid":case "ruby":case "inline-table":return!0;default:return!1}}function cr(a,b,c,d,e,f,g){e=e||f||pd;return!!g||!!c&&c!==J||b===Tc||b===kd||a===sd||a===Nd||a===Md||a==ld||(a===Zc||a===yd)&&!!d&&d!==Ud||!!f&&e!==f};function dr(a,b,c){return a.replace(/[uU][rR][lL]\(\s*\"((\\([^0-9a-fA-F]+|[0-9a-fA-F]+\s*)|[^\"\r\n])+)\"/gm,function(a,e){return'url("'+c.ic(e,b)+'"'}).replace(/[uU][rR][lL]\(\s*\'((\\([^0-9a-fA-F]+|[0-9a-fA-F]+\s*)|[^\'\r\n])+)\'/gm,function(a,e){return"url('"+c.ic(e,b)+"'"}).replace(/[uU][rR][lL]\(\s*((\\([^0-9a-fA-F]+|[0-9a-fA-F]+\s*)|[^\"\'\r\n\)\s])+)/gm,function(a,e){return"url("+c.ic(e,b)})}
dr=function(a,b,c){return a.replace(/[uU][rR][lL]\(\s*\"((\\([^0-9a-fA-F]+|[0-9a-fA-F]+\s*)|[^\"\r\n])+)\"/gm,function(a,e){return'url("'+c.ic(e,b)+'"'}).replace(/[uU][rR][lL]\(\s*\'((\\([^0-9a-fA-F]+|[0-9a-fA-F]+\s*)|[^\'\r\n])+)\'/gm,function(a,e){return"url('"+c.ic(e,b)+"'"}).replace(/[uU][rR][lL]\(\s*((\\([^0-9a-fA-F]+|[0-9a-fA-F]+\s*)|[^\"\'\r\n\)\s])+)/gm,function(a,e){return"url("+c.ic(e,b)})};var er={"text-indent":"0px","margin-top":"0px","padding-top":"0px","border-top-width":"0px","border-top-style":"none","border-top-color":"transparent","border-top-left-radius":"0px","border-top-right-radius":"0px"},fr={"text-indent":"0px","margin-right":"0px","padding-right":"0px","border-right-width":"0px","border-right-style":"none","border-right-color":"transparent","border-top-right-radius":"0px","border-bottom-right-radius":"0px"},gr={"margin-top":"0px"},hr={"margin-right":"0px"},ir={};
...
nr.prototype.la=function(a,b){var c=a.getAttribute("data-adapt-pseudo")||"";this.f[c]||(this.f[c]=!0,(c=b.content)&&El(c)&&c.ea(new Dl(a,this.g,c,this.h)))};function or(a,b,c,d,e,f,g,h,l,k,m,p,q){this.j={};this.H=a;this.b=b;this.viewport=c;this.F=c.b;this.l=d;this.B=cq(d.Ca.b);this.u=e;this.ca=f;this.J=g;this.C=h;this.N=l;this.page=k;this.g=m;this.G=p;this.h=q;this.O=this.w=null;this.f=!1;this.M=null;this.na=0;this.A=null}v(or,db);
or.prototype.clone=function(){return new or(this.H,this.b,this.viewport,this.l,this.u,this.ca,this.J,this.C,this.N,this.page,this.g,this.G,this.h)};function pr(a,b,c,d){a=a._pseudos;if(!a)return null;var e={},f={},g;for(g in a)f.Yc=e[g]={},Vj(f.Yc,a[g],d),Tj(f.Yc,d,a[g]),Uj(a[g],b,c,function(a){return function(b,c){Vj(a.Yc,c,d);qr(c,function(b){Vj(a.Yc,b,d)})}}(f)),f={Yc:f.Yc};return e}
function rr(a,b,c,d,e,f){var g=L("createRefShadow");a.ca.u.load(b).then(function(h){if(h){var l=jk(h,b);if(l){var k=a.N,m=k.J[h.url];if(!m){var m=k.style.j.f[h.url],p=new Nb(0,k.ec(),k.dc(),k.u),m=new Zl(h,m.g,m.f,p,k.l,m.l,new Op(k.h,h.url),new Pp(k.h,h.url,m.f,m.b));k.J[h.url]=m}f=new Xk(d,l,h,e,f,c,m)}}O(g,f)});return g.result()}
function sr(a,b,c,d,e,f,g,h){var l=L("createShadows"),k=e.template,m;k instanceof Qc?m=rr(a,k.url,2,b,h,null):m=M(null);m.then(function(k){var m=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var p=b.getAttribute("href"),z=null;p?z=h?h.ca:a.ca:h&&(p="http://www.w3.org/1999/xhtml"==h.oa.namespaceURI?h.oa.getAttribute("href"):h.oa.getAttributeNS("http://www.w3.org/1999/xlink","href"),z=h.hd?h.hd.ca:a.ca);p&&(p=Aa(p,z.url),m=rr(a,p,3,b,h,k))}m||(m=M(k));var u=null;
m.then(function(c){e.display===Nd?u=rr(a,Aa("user-agent.xml#table-cell",za),2,b,h,c):u=M(c)});u.then(function(k){var m=pr(d,a.u,a.f,g);if(m){for(var p=[],q=kr.createElementNS("http://www.pyroxy.com/ns/shadow","root"),r=q,u=t(lr),z=u.next();!z.done;z=u.next()){var z=z.value,A;if(z){if(!m[z])continue;if(!("footnote-marker"!=z||c&&a.f))continue;if(z.match(/^first-/)&&(A=e.display,!A||A===rd))continue;if("before"===z||"after"===z)if(A=m[z].content,!A||A===Ad||A===J)continue;p.push(z);A=kr.createElementNS("http://www.w3.org/1999/xhtml",
"span");mr(A,z)}else A=kr.createElementNS("http://www.pyroxy.com/ns/shadow","content");r.appendChild(A);z.match(/^first-/)&&(r=A)}k=p.length?new Xk(b,q,null,h,k,2,new nr(b,d,f,g,a.B)):k}O(l,k)})});return l.result()}function wo(a,b,c){a.O=b;a.f=c}
function tr(a,b,c,d,e){var f=a.b;d=Sj(d,f,a.u,a.f);b=Qj(d,f,b);c=Rj(d,f,c);Wj(d,e,b,c,function(b,c){var d=c.evaluate(f,b);"font-family"==b&&(d=sm(a.J,d));return d});var g=Ul(e.display||rd,e.position,e["float"],a.M===a.ca.root);["display","position","float"].forEach(function(a){g[a]&&(e[a]=g[a])});return b}
function ur(a,b){for(var c=a.w.M,d=[],e=null,f=a.w.ua,g=-1;c&&1==c.nodeType;){var h=f&&f.root==c;if(!h||2==f.type){var l=(f?f.b:a.l).l(c,!1);d.push(l);e=e||Oa(c)}h?(c=f.oa,f=f.hd):(c=c.parentNode,g++)}c=Pb(a.b,"em",!g);c={"font-size":new V(new F(c,"px"),0)};f=new ci(c,a.b);for(g=d.length-1;0<=g;--g){var h=d[g],l=[],k;for(k in h)Dh[k]&&l.push(k);l.sort(ae);for(var l=t(l),m=l.next();!m.done;m=l.next()){m=m.value;f.b=m;var p=h[m];p.value!==qd&&(c[m]=p.Id(f))}}for(var q in b)Dh[q]||(c[q]=b[q]);return{lang:e,
lb:c}}var vr={a:"a",sub:"sub",sup:"sup",table:"table",tr:"tr",td:"td",th:"th",code:"code",body:"div",p:"p",v:"p",date:"p",emphasis:"em",strong:"strong",style:"span",strikethrough:"del"};function wr(a,b){b=Aa(b,a.ca.url);return a.G[b]||b}function xr(a){a.w.lang=Oa(a.w.M)||a.w.parent&&a.w.parent.lang||a.w.lang}
...
function zr(a,b,c,d,e,f){for(var g=ee("RESOLVE_FORMATTING_CONTEXT"),h=0;h<g.length;h++){var l=g[h](a,b,c,d,e,f);if(l){a.D=l;break}}}
function Ar(a,b,c){var d=!0,e=L("createElementView"),f=a.M,g=a.w.ua?a.w.ua.b:a.l,h=g.l(f,!1);if(!a.w.ua){var l=ek(a.ca,f);Br(l,a.w.Ra,0)}var k={};a.w.parent||(l=ur(a,h),h=l.lb,a.w.lang=l.lang);var m=h["float-reference"]&&Tm(h["float-reference"].value.toString());a.w.parent&&m&&Um(m)&&(l=ur(a,h),h=l.lb,a.w.lang=l.lang);a.w.b=tr(a,a.w.b,"rtl"===a.w.direction,h,k);g.la(f,k);yr(a,k);xr(a);k.direction&&(a.w.direction=k.direction.toString());if((l=k["flow-into"])&&l.toString()!=a.H)return O(e,!1),e.result();
var p=k.display;if(p===J)return O(e,!1),e.result();var q=!a.w.parent;a.w.H=p===ld;sr(a,f,q,h,k,g,a.b,a.w.ua).then(function(l){a.w.Ha=l;l=k.position;var r=k["float"],u=k.clear,A=a.w.b?Td:pd,H=a.w.parent?a.w.parent.b?Td:pd:A,E="true"===f.getAttribute("data-vivliostyle-flow-root");a.w.ad=cr(p,l,r,k.overflow,A,H,E);a.w.O=l===Ed||l===Tc||l===kd;!el(a.w)||r===md||m&&Um(m)||(u=r=null);A=r===wd||r===Fd||r===Qd||r===cd||r===ud||r===td||r===ad||r===$c||r===Id||r===md;r&&(delete k["float"],r===md&&(a.f?(A=!1,
k.display=Zc):k.display=rd));u&&(u===qd&&a.w.parent&&a.w.parent.l&&(u=D(a.w.parent.l)),u===wd||u===Fd||u===Qd||u===cd||u===bd||u===Uc||u===Gd)&&(delete k.clear,k.display&&k.display!=rd&&(a.w.l=u.toString()));var K=p===yd&&k["ua-list-item-count"];(A||k["break-inside"]&&k["break-inside"]!==Wc)&&a.w.j++;p&&p!==rd&&br(p)&&a.w.j++;if(!(u=!A&&!p||br(p)))a:switch(p.toString()){case "ruby-base":case "ruby-text":case "ruby-base-container":case "ruby-text-container":u=!0;break a;default:u=!1}a.w.xa=u;a.w.display=
p?p.toString():"inline";a.w.Aa=A?r.toString():null;a.w.V=m||Zk;a.w.N=k["float-min-wrap-block"]||null;a.w.ba=k["column-span"];if(!a.w.xa){if(u=k["break-after"])a.w.G=u.toString();if(u=k["break-before"])a.w.g=u.toString()}a.w.Y=k["vertical-align"]&&k["vertical-align"].toString()||"baseline";a.w.da=k["caption-side"]&&k["caption-side"].toString()||"top";u=k["border-collapse"];if(!u||u===D("separate"))if(A=k["border-spacing"])A.Nd()?(u=A.values[0],A=A.values[1]):u=A,u.uc()&&(a.w.la=Sc(u,a.b)),A.uc()&&
(a.w.sa=Sc(A,a.b));a.w.X=k["footnote-policy"];if(u=k["x-first-pseudo"])a.w.f=new Yk(a.w.parent?a.w.parent.f:null,u.L);a.w.xa||Cr(a,f,h,g,a.b);if(u=k["white-space"])u=Ik(u.toString()),null!==u&&(a.w.nc=u);(u=k["hyphenate-character"])&&u!==Wc&&(a.w.F=u.Qc);u=k["overflow-wrap"]||["word-wrap"];a.w.B=k["word-break"]===ed||u===fd;zr(a.w,b,p,l,r,q);a.w.parent&&a.w.parent.D&&(b=a.w.parent.D.af(a.w,b));a.w.xa||(a.w.u=Dr(k),Er(a,f,g));var I=!1,ka=null,Ca=[],Da=f.namespaceURI,N=f.localName;if("http://www.w3.org/1999/xhtml"==
...
(l=jk(a.ca,l)))ka=Fr(a,Da,"img"),l="data:"+(l.getAttribute("content-type")||"image/jpeg")+";base64,"+l.textContent.replace(/[ \t\n\t]/g,""),Ca.push(He(ka,l))}else N=vr[N];N||(N=a.w.xa?"span":"div")}else if("http://www.daisy.org/z3986/2005/ncx/"==Da)if(Da="http://www.w3.org/1999/xhtml","ncx"==N||"navPoint"==N)N="div";else if("navLabel"==N){if(N="span",r=f.parentNode){l=null;for(r=r.firstChild;r;r=r.nextSibling)if(1==r.nodeType&&(u=r,"http://www.daisy.org/z3986/2005/ncx/"==u.namespaceURI&&"content"==
u.localName)){l=u.getAttribute("src");break}l&&(N="a",f=f.ownerDocument.createElementNS(Da,"a"),f.setAttribute("href",l))}}else N="span";else"http://www.pyroxy.com/ns/shadow"==Da?(Da="http://www.w3.org/1999/xhtml",N=a.w.xa?"span":"div"):I=!!a.g;K?b?N="li":(N="div",p=Zc,k.display=p):"body"==N||"li"==N?N="div":"q"==N?N="span":"a"==N&&(l=k["hyperlink-processing"])&&"normal"!=l.toString()&&(N="span");k.behavior&&"none"!=k.behavior.toString()&&a.g&&(I=!0);f.dataset&&"true"===f.getAttribute("data-math-typeset")&&
(I=!0);var qb;I?qb=a.g(f,a.w.parent?a.w.parent.A:null,k):qb=M(null);qb.then(function(g){g?I&&(d="true"==g.getAttribute("data-adapt-process-children")):g=Fr(a,Da,N);"a"==N&&g.addEventListener("click",a.page.J,!1);ka&&(Yo(a,a.w,"inner",ka),g.appendChild(ka));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&jr(g);var h=a.w.h["image-resolution"],l=[],m=k.width,p=k.height,q=f.getAttribute("width"),r=f.getAttribute("height"),m=m===Wc||!m&&!q,p=p===Wc||!p&&!r;if("http://www.gribuser.ru/xml/fictionbook/2.0"!=
f.namespaceURI||"td"==N){for(var q=f.attributes,u=q.length,r=null,z=0;z<u;z++){var A=q[z],H=A.namespaceURI,E=A.localName,A=A.nodeValue;if(H)if("http://www.w3.org/2000/xmlns/"==H)continue;else"http://www.w3.org/1999/xlink"==H&&"href"==E&&(A=wr(a,A));else{if(E.match(/^on/))continue;if("style"==E)continue;if(("id"==E||"name"==E)&&b){A=a.h.Me(A,a.ca.url);g.setAttribute(E,A);Fk(a.page,g,A);continue}"src"==E||"href"==E||"poster"==E?(A=wr(a,A),"href"===E&&(A=a.h.ic(A,a.ca.url))):"srcset"==E&&(A=A.split(",").map(function(b){return wr(a,
b.trim())}).join(","));if("poster"===E&&"video"===N&&"http://www.w3.org/1999/xhtml"===Da&&m&&p){var qb=new Image,Bp=He(qb,A);Ca.push(Bp);l.push({Lf:qb,element:g,If:Bp})}}"http://www.w3.org/2000/svg"==Da&&/^[A-Z\-]+$/.test(E)&&(E=E.toLowerCase());Gr.includes(E.toLowerCase())&&(A=dr(A,a.ca.url,a.h));H&&(qb=ir[H])&&(E=qb+":"+E);"src"!=E||H||"img"!=N&&"input"!=N||"http://www.w3.org/1999/xhtml"!=Da?"href"==E&&"image"==N&&"http://www.w3.org/2000/svg"==Da&&"http://www.w3.org/1999/xlink"==H?a.page.l.push(He(g,
A)):H?g.setAttributeNS(H,E,A):g.setAttribute(E,A):r=A}r&&(qb="input"===N?new Image:g,q=He(qb,r),qb!==g&&(g.src=r),m||p?(m&&p&&h&&1!==h&&l.push({Lf:qb,element:g,If:q}),Ca.push(q)):a.page.l.push(q))}delete k.content;(m=k["list-style-image"])&&m instanceof Qc&&(m=m.url,Ca.push(He(new Image,m)));Hr(a,k);Ir(a,g,k);if(!a.w.xa&&(m=null,b?c&&(m=a.w.b?hr:gr):m="clone"!==a.w.h["box-decoration-break"]?a.w.b?fr:er:a.w.b?hr:gr,m))for(var Cp in m)x(g,Cp,m[Cp]);K&&g.setAttribute("value",k["ua-list-item-count"].stringValue());
a.A=g;Ca.length?Ge(Ca).then(function(){0<h&&Jr(a,l,h,k,a.w.b);O(e,d)}):ze().then(function(){O(e,d)})})});return e.result()}function Cr(a,b,c,d,e){var f=pr(c,a.u,a.f,e);f&&f["after-if-continues"]&&f["after-if-continues"].content&&(a.w.J=new Kr(b,new nr(b,c,d,e,a.B)))}var Gr="color-profile clip-path cursor filter marker marker-start marker-end marker-mid fill stroke mask".split(" ");
...
"px"):x(b,"min-width",h+"px"))}})}function Hr(a,b){ee("PREPROCESS_ELEMENT_STYLE").forEach(function(c){c(a.w,b)})}function Er(a,b,c){for(b=b.firstChild;b;b=b.nextSibling)if(1===b.nodeType){var d={},e=c.l(b,!1);tr(a,a.w.b,"rtl"===a.w.direction,e,d);if(Dr(d)){if(a.w.D instanceof wp&&!gl(a.w,a.w.D))break;c=a.w.parent;a.w.D=new wp(c&&c.D,a.w.M);Lr(a.w.D,a.w.b);break}}}
function Dr(a){var b=a["repeat-on-break"];return b!==J&&(b===Wc&&(b=a.display===Pd?od:a.display===Od?nd:J),b&&b!==J)?b.toString():null}function Mr(a){var b=L("createTextNodeView");Nr(a).then(function(){var c=a.na||0,c=Or(a.w.Oa).substr(c);a.A=document.createTextNode(c);O(b,!0)});return b.result()}
function Nr(a){if(a.w.Oa)return M(!0);var b,c=b=a.M.textContent,d=L("preprocessTextContent"),e=ee("PREPROCESS_TEXT_CONTENT"),f=0;Be(function(){return f>=e.length?M(!1):e[f++](a.w,c).ha(function(a){c=a;return M(!0)})}).then(function(){a.w.Oa=Pr(b,c,0);O(d,!0)});return d.result()}
function Qr(a,b,c){var d=L("createNodeView"),e=!0;1==a.M.nodeType?b=Ar(a,b,c):8==a.M.nodeType?(a.A=null,b=M(!0)):b=Mr(a);b.then(function(b){e=b;(a.w.A=a.A)&&(b=a.w.parent?a.w.parent.A:a.O)&&b.appendChild(a.A);O(d,e)});return d.result()}function xo(a,b,c,d){(a.w=b)?(a.M=b.M,a.na=b.na):(a.M=null,a.na=-1);a.A=null;return a.w?Qr(a,c,!!d):M(!0)}
function Rr(a){if(null==a.ua||"content"!=a.M.localName||"http://www.pyroxy.com/ns/shadow"!=a.M.namespaceURI)return a;var b=a.Ka,c=a.ua,d=a.parent,e,f;c.qf?(f=c.qf,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.hd,e=c.oa.firstChild,c=2);var g=a.M.nextSibling;g?(a.M=g,$k(a)):a.Ea?a=a.Ea:e?a=null:(a=a.parent.modify(),a.K=!0);if(e)return b=new Vk(e,d,b),b.ua=f,b.ib=c,b.Ea=a,b;a.Ka=b;return a}
function Sr(a){var b=a.Ka+1;if(a.K){if(!a.parent)return null;if(3!=a.ib){var c=a.M.nextSibling;if(c)return a=a.modify(),a.Ka=b,a.M=c,$k(a),Rr(a)}if(a.Ea)return a=a.Ea.modify(),a.Ka=b,a;a=a.parent.modify()}else{if(a.Ha&&(c=a.Ha.root,2==a.Ha.type&&(c=c.firstChild),c))return b=new Vk(c,a,b),b.ua=a.Ha,b.ib=a.Ha.type,Rr(b);if(c=a.M.firstChild)return Rr(new Vk(c,a,b));1!=a.M.nodeType&&(c=Or(a.Oa),b+=c.length-1-a.na);a=a.modify()}a.Ka=b;a.K=!0;return a}
function Dm(a,b,c){b=Sr(b);if(!b||b.K)return M(b);var d=L("nextInTree");xo(a,b,!0,c).then(function(c){b.A&&c||(b=b.modify(),b.K=!0,b.A||(b.xa=!0));eb(a,{type:"nextInTree",w:b});O(d,b)});return d.result()}function Tr(a,b){if(b instanceof Fc)for(var c=b.values,d=0;d<c.length;d++)Tr(a,c[d]);else b instanceof Qc&&(c=b.url,a.page.l.push(He(new Image,c)))}
var Ur={"box-decoration-break":!0,"float-min-wrap-block":!0,"float-reference":!0,"flow-into":!0,"flow-linger":!0,"flow-options":!0,"flow-priority":!0,"footnote-policy":!0,page:!0};function Ir(a,b,c){var d=c["background-image"];d&&Tr(a,d);var d=c.position===Ed,e;for(e in c)if(!Ur[e]){var f=c[e],f=f.ea(new Rg(a.ca.url,a.h));f.uc()&&Mb(f.ka)&&(f=new F(Sc(f,a.b),"px"));xk[e]||d&&yk[e]?a.page.u.push(new zk(b,e,f)):x(b,e,f.toString())}}
function Yo(a,b,c,d){if(!b.K){var e=(b.ua?b.ua.b:a.l).l(a.M,!1);if(e=e._pseudos)if(e=e[c])c={},b.b=tr(a,b.b,"rtl"===b.direction,e,c),b=c.content,El(b)&&(b.ea(new Dl(d,a.b,b,a.B)),delete c.content),Ir(a,d,c)}}
function Ao(a,b,c){var d=L("peelOff"),e=b.f,f=b.na,g=b.K;if(0<c)b.A.textContent=b.A.textContent.substr(0,c),f+=c;else if(!g&&b.A&&!f){var h=b.A.parentNode;h&&h.removeChild(b.A)}for(var l=b.Ka+c,k=[];b.f===e;)k.push(b),b=b.parent;var m=k.pop(),p=m.Ea;Be(function(){for(;0<k.length;){m=k.pop();b=new Vk(m.M,b,l);k.length||(b.na=f,b.K=g);b.ib=m.ib;b.ua=m.ua;b.Ha=m.Ha;b.Ea=m.Ea?m.Ea:p;p=null;var c=xo(a,b,!1);if(c.Wa())return c}return M(!1)}).then(function(){O(d,b)});return d.result()}
function Fr(a,b,c){return"http://www.w3.org/1999/xhtml"==b?a.F.createElement(c):a.F.createElementNS(b,c)}function Jp(a){a&&fl(a,function(a){var b=a.h["box-decoration-break"];b&&"slice"!==b||(b=a.A,a.b?(x(b,"padding-left","0"),x(b,"border-left","none"),x(b,"border-top-left-radius","0"),x(b,"border-bottom-left-radius","0")):(x(b,"padding-bottom","0"),x(b,"border-bottom","none"),x(b,"border-bottom-left-radius","0"),x(b,"border-bottom-right-radius","0")))})}
...
this.g=b;this.f=c;this.h=f;b=Nn(new Vr(this),this.root);this.width=d||parseFloat(b.width)||a.innerWidth;this.height=e||parseFloat(b.height)||a.innerHeight}function Yr(a){x(a.g,"width","");x(a.g,"height","");x(a.f,"width","");x(a.f,"height","");x(a.f,"transform","")}Xr.prototype.zoom=function(a,b,c){x(this.g,"width",a*c+"px");x(this.g,"height",b*c+"px");x(this.f,"width",a+"px");x(this.f,"height",b+"px");x(this.f,"transform","scale("+c+")")};var Zo="min-content inline size",Qn="fit-content inline size";
function Pn(a,b,c){function d(c){return Nn(a,b).getPropertyValue(c)}function e(){x(b,"display","block");x(b,"position","static");return d(ka)}function f(){x(b,"display","inline-block");x(E,ka,"99999999px");var a=d(ka);x(E,ka,"");return a}function g(){x(b,"display","inline-block");x(E,ka,"0");var a=d(ka);x(E,ka,"");return a}function h(){var a=e(),b=g(),c=parseFloat(a);if(c<=parseFloat(b))return b;b=f();return c<=parseFloat(b)?a:b}function l(){throw Error("Getting fill-available block size is not implemented");}
...
function es(a){var b={width:Xd,height:Yd,Vb:Zd,Wb:Zd},c=a.size;if(c&&c.value!==Wc){var d=c.value;d.Nd()?(c=d.values[0],d=d.values[1]):(c=d,d=null);if(c.uc())b.width=c,b.height=d||c;else if(c=$r[c.name.toLowerCase()])d&&d===vd?(b.width=c.height,b.height=c.width):(b.width=c.width,b.height=c.height)}(c=a.marks)&&c.value!==J&&(b.Wb=ds);a=a.bleed;a&&a.value!==Wc?a.value&&a.value.uc()&&(b.Vb=a.value):c&&(a=!1,c.value.Nd()?a=c.value.values.some(function(a){return a===gd}):a=c.value===gd,a&&(b.Vb=new F(6,
"pt")));return b}function fs(a,b){var c={},d=a.Vb.L*Pb(b,a.Vb.ka,!1),e=a.Wb.L*Pb(b,a.Wb.ka,!1),f=d+e,g=a.width;c.ec=g===Xd?b.Z.oc?b.Z.oc.width*Pb(b,"px",!1):(b.Z.tb?Math.floor(b.Pa/2)-b.Z.xc:b.Pa)-2*f:g.L*Pb(b,g.ka,!1);g=a.height;c.dc=g===Yd?b.Z.oc?b.Z.oc.height*Pb(b,"px",!1):b.Fb-2*f:g.L*Pb(b,g.ka,!1);c.Vb=d;c.Wb=e;c.le=f;return c}function gs(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
function hs(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg",c||"polyline");a.setAttribute("stroke","black");a.setAttribute("stroke-width",b);a.setAttribute("fill","none");return a}var is={eh:"top left",fh:"top right",Rg:"bottom left",Sg:"bottom right"};
function js(a,b,c,d,e,f){var g=d;g<=e+2*Lb.mm&&(g=e+d/2);var h=Math.max(d,g),l=e+h+c/2,k=gs(a,l,l),g=[[0,e+d],[d,e+d],[d,e+d-g]];d=g.map(function(a){return[a[1],a[0]]});if("top right"===b||"bottom right"===b)g=g.map(function(a){return[e+h-a[0],a[1]]}),d=d.map(function(a){return[e+h-a[0],a[1]]});if("bottom left"===b||"bottom right"===b)g=g.map(function(a){return[a[0],e+h-a[1]]}),d=d.map(function(a){return[a[0],e+h-a[1]]});l=hs(a,c);l.setAttribute("points",g.map(function(a){return a.join(",")}).join(" "));
k.appendChild(l);a=hs(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));k.appendChild(a);b.split(" ").forEach(function(a){k.style[a]=f+"px"});return k}var ks={dh:"top",Qg:"bottom",jg:"left",kg:"right"};
...
ks[a];a===b?h.style[a]=e+"px":a!==k&&(h.style[a]="0",h.style["margin-"+a]="auto")});return h}function ms(a,b,c,d){var e=!1,f=!1;if(a=a.marks)a=a.value,a.Nd()?a.values.forEach(function(a){a===gd?e=!0:a===hd&&(f=!0)}):a===gd?e=!0:a===hd&&(f=!0);if(e||f){var g=c.I,h=g.ownerDocument,l=b.Vb,k=Sc(as,d),m=Sc(bs,d),p=Sc(cs,d);e&&Object.keys(is).forEach(function(a){a=js(h,is[a],k,p,l,m);g.appendChild(a)});f&&Object.keys(ks).forEach(function(a){a=ls(h,ks[a],k,p,m);g.appendChild(a)})}}
...
"bottom-center":{order:11,Va:!1,Sa:!0,Ta:!1,Ua:!1,Ba:"center"},"bottom-left":{order:12,Va:!1,Sa:!0,Ta:!1,Ua:!1,Ba:"start"},"bottom-left-corner":{order:13,Va:!1,Sa:!0,Ta:!0,Ua:!1,Ba:null},"left-bottom":{order:14,Va:!1,Sa:!1,Ta:!0,Ua:!1,Ba:"end"},"left-middle":{order:15,Va:!1,Sa:!1,Ta:!0,Ua:!1,Ba:"center"},"left-top":{order:16,Va:!1,Sa:!1,Ta:!0,Ua:!1,Ba:"start"}},ps=Object.keys(os).sort(function(a,b){return os[a].order-os[b].order});
function qs(a,b,c){mq.call(this,a,null,"vivliostyle-page-rule-master",[],b,null,0);a=es(c);new rs(this.f,this,c,a);this.B={};ss(this,c);this.b.position=new V(Ed,0);this.b.width=new V(a.width,0);this.b.height=new V(a.height,0);for(var d in c)ns[d]||"background-clip"===d||(this.b[d]=c[d])}v(qs,mq);function ss(a,b){var c=b._marginBoxes;c&&ps.forEach(function(d){c[d]&&(a.B[d]=new ts(a.f,a,d,b))})}qs.prototype.h=function(a){return new us(a,this)};
function rs(a,b,c,d){qq.call(this,a,null,null,[],b);this.C=d;this.b["z-index"]=new V(new Oc(0),0);this.b["flow-from"]=new V(D("body"),0);this.b.position=new V(Tc,0);this.b.overflow=new V(Ud,0);for(var e in ns)ns.hasOwnProperty(e)&&(this.b[e]=c[e])}v(rs,qq);rs.prototype.h=function(a){return new vs(a,this)};
function ts(a,b,c,d){qq.call(this,a,null,null,[],b);this.u=c;a=d._marginBoxes[this.u];for(var e in d)if(b=d[e],c=a[e],Dh[e]||c&&c.value===qd)this.b[e]=b;for(e in a)Object.prototype.hasOwnProperty.call(a,e)&&(b=a[e])&&b.value!==qd&&(this.b[e]=b)}v(ts,qq);ts.prototype.h=function(a){return new ws(a,this)};function us(a,b){nq.call(this,a,b);this.u=null;this.sa={}}v(us,nq);
us.prototype.l=function(a,b){var c=this.J,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}nq.prototype.l.call(this,a,b)};us.prototype.ve=function(){var a=this.style;a.left=Zd;a["margin-left"]=Zd;a["border-left-width"]=Zd;a["padding-left"]=Zd;a["padding-right"]=Zd;a["border-right-width"]=Zd;a["margin-right"]=Zd;a.right=Zd};
us.prototype.we=function(){var a=this.style;a.top=new F(-1,"px");a["margin-top"]=Zd;a["border-top-width"]=Zd;a["padding-top"]=Zd;a["padding-bottom"]=Zd;a["border-bottom-width"]=Zd;a["margin-bottom"]=Zd;a.bottom=Zd};us.prototype.ba=function(a,b,c){b=b.H;var d={start:this.u.marginLeft,end:this.u.marginRight,ta:this.u.Gc},e={start:this.u.marginTop,end:this.u.marginBottom,ta:this.u.Fc};xs(this,b.top,!0,d,a,c);xs(this,b.bottom,!0,d,a,c);xs(this,b.left,!1,e,a,c);xs(this,b.right,!1,e,a,c)};
function ys(a,b,c,d,e){this.I=a;this.B=e;this.j=c;this.u=!Y(d,b[c?"width":"height"],new rc(d,0,"px"));this.size=null}ys.prototype.b=function(){return this.u};function zs(a){a.size||(a.size=Pn(a.B,a.I.element,a.j?["max-content width","min-content width"]:["max-content height","min-content height"]));return a.size}ys.prototype.g=function(){var a=zs(this);return this.j?rl(this.I)+a["max-content width"]+sl(this.I):pl(this.I)+a["max-content height"]+ql(this.I)};
ys.prototype.h=function(){var a=zs(this);return this.j?rl(this.I)+a["min-content width"]+sl(this.I):pl(this.I)+a["min-content height"]+ql(this.I)};ys.prototype.f=function(){return this.j?rl(this.I)+this.I.width+sl(this.I):pl(this.I)+this.I.height+ql(this.I)};function As(a){this.j=a}As.prototype.b=function(){return this.j.some(function(a){return a.b()})};As.prototype.g=function(){var a=this.j.map(function(a){return a.g()});return Math.max.apply(null,a)*a.length};
As.prototype.h=function(){var a=this.j.map(function(a){return a.h()});return Math.max.apply(null,a)*a.length};As.prototype.f=function(){var a=this.j.map(function(a){return a.f()});return Math.max.apply(null,a)*a.length};function Bs(a,b,c,d,e,f){ys.call(this,a,b,c,d,e);this.l=f}v(Bs,ys);Bs.prototype.b=function(){return!1};Bs.prototype.g=function(){return this.f()};Bs.prototype.h=function(){return this.f()};Bs.prototype.f=function(){return this.j?rl(this.I)+this.l+sl(this.I):pl(this.I)+this.l+ql(this.I)};
function xs(a,b,c,d,e,f){var g=a.f.f,h={},l={},k={},m;for(m in b){var p=os[m];if(p){var q=b[m],r=a.sa[m],z=new ys(q,r.style,c,g,f);h[p.Ba]=q;l[p.Ba]=r;k[p.Ba]=z}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.ta.evaluate(e);var u=Cs(k,b),A=!1,H={};Object.keys(h).forEach(function(a){var b=Y(g,l[a].style[c?"max-width":"max-height"],d.ta);b&&(b=b.evaluate(e),u[a]>b&&(b=k[a]=new Bs(h[a],l[a].style,c,g,f,b),H[a]=b.f(),A=!0))});A&&(u=Cs(k,b),A=!1,["start","center","end"].forEach(function(a){u[a]=H[a]||u[a]}));
var E={};Object.keys(h).forEach(function(a){var b=Y(g,l[a].style[c?"min-width":"min-height"],d.ta);b&&(b=b.evaluate(e),u[a]<b&&(b=k[a]=new Bs(h[a],l[a].style,c,g,f,b),E[a]=b.f(),A=!0))});A&&(u=Cs(k,b),["start","center","end"].forEach(function(a){u[a]=E[a]||u[a]}));var K=a+b,I=a+(a+b);["start","center","end"].forEach(function(a){var b=u[a];if(b){var d=h[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(I-b)/2;break;case "end":e=K-b}c?wl(d,e,b-rl(d)-sl(d)):vl(d,e,b-pl(d)-ql(d))}})}
function Cs(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=Ds(d,g.length?new As(g):null,b);g.wb&&(f.center=g.wb);d=g.wb||d.f();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=Ds(c,e,b),c.wb&&(f.start=c.wb),c.vd&&(f.end=c.vd);return f}
function Ds(a,b,c){var d={wb:null,vd:null};if(a&&b)if(a.b()&&b.b()){var e=a.g(),f=b.g();0<e&&0<f?(f=e+f,f<c?d.wb=c*e/f:(a=a.h(),b=b.h(),b=a+b,b<c?d.wb=a+(c-b)*(e-a)/(f-b):0<b&&(d.wb=c*a/b)),0<d.wb&&(d.vd=c-d.wb)):0<e?d.wb=c:0<f&&(d.vd=c)}else a.b()?d.wb=Math.max(c-b.f(),0):b.b()&&(d.vd=Math.max(c-a.f(),0));else a?a.b()&&(d.wb=c):b&&b.b()&&(d.vd=c);return d}us.prototype.fc=function(a,b,c,d,e){us.hg.fc.call(this,a,b,c,d,e);b.element.setAttribute("data-vivliostyle-page-box",!0)};
function vs(a,b){rq.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.Fc=this.Gc=null}v(vs,rq);
vs.prototype.l=function(a,b){var c=this.J,d;for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(d.match(/^column.*$/)||d.match(/^background-/))&&(c[d]=b[d]);rq.prototype.l.call(this,a,b);d=this.g;c={Gc:this.Gc,Fc:this.Fc,marginTop:this.marginTop,marginRight:this.marginRight,marginBottom:this.marginBottom,marginLeft:this.marginLeft};d.u=c;d=d.style;d.width=new G(c.Gc);d.height=new G(c.Fc);d["padding-left"]=new G(c.marginLeft);d["padding-right"]=new G(c.marginRight);d["padding-top"]=new G(c.marginTop);
d["padding-bottom"]=new G(c.marginBottom)};vs.prototype.ve=function(){var a=Es(this,{start:"left",end:"right",ta:"width"});this.Gc=a.Af;this.marginLeft=a.Tf;this.marginRight=a.Sf};vs.prototype.we=function(){var a=Es(this,{start:"top",end:"bottom",ta:"height"});this.Fc=a.Af;this.marginTop=a.Tf;this.marginBottom=a.Sf};
function Es(a,b){var c=a.style,d=a.f.f,e=b.start,f=b.end,g=b.ta,h=a.f.C[g].za(d,null),l=Y(d,c[g],h),k=Y(d,c["margin-"+e],h),m=Y(d,c["margin-"+f],h),p=sq(d,c["padding-"+e],h),q=sq(d,c["padding-"+f],h),r=uq(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),z=uq(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),u=B(d,h,y(d,y(d,r,p),y(d,z,q)));l?(u=B(d,u,l),k||m?k?m=B(d,u,k):k=B(d,u,m):m=k=zc(d,u,new Gb(d,.5))):(k||(k=d.b),m||(m=d.b),l=B(d,u,y(d,k,m)));c[e]=new G(k);c[f]=new G(m);c["margin-"+e]=
Zd;c["margin-"+f]=Zd;c["padding-"+e]=new G(p);c["padding-"+f]=new G(q);c["border-"+e+"-width"]=new G(r);c["border-"+f+"-width"]=new G(z);c[g]=new G(l);c["max-"+g]=new G(l);return{Af:B(d,h,y(d,k,m)),Tf:k,Sf:m}}vs.prototype.fc=function(a,b,c,d,e){rq.prototype.fc.call(this,a,b,c,d,e);c.N=b.element};function ws(a,b){rq.call(this,a,b);var c=b.u;this.u=os[c];a.sa[c]=this;this.va=!0}v(ws,rq);n=ws.prototype;
n.fc=function(a,b,c,d,e){var f=b.element;x(f,"display","flex");var g=Eq(this,a,"vertical-align"),h=null;g===D("middle")?h="center":g===D("top")?h="flex-start":g===D("bottom")&&(h="flex-end");h&&(x(f,"flex-flow",this.b?"row":"column"),x(f,"justify-content",h));rq.prototype.fc.call(this,a,b,c,d,e)};
n.Ba=function(a,b){var c=this.style,d=this.f.f,e=a.start,f=a.end,g="left"===e,h=g?b.Gc:b.Fc,l=Y(d,c[a.ta],h),g=g?b.marginLeft:b.marginTop;if("start"===this.u.Ba)c[e]=new G(g);else if(l){var k=sq(d,c["margin-"+e],h),m=sq(d,c["margin-"+f],h),p=sq(d,c["padding-"+e],h),q=sq(d,c["padding-"+f],h),r=uq(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),f=uq(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),l=y(d,l,y(d,y(d,p,q),y(d,y(d,r,f),y(d,k,m))));switch(this.u.Ba){case "center":c[e]=new G(y(d,
g,Ac(d,B(d,h,l),new Gb(d,2))));break;case "end":c[e]=new G(B(d,y(d,g,h),l))}}};
function Fs(a,b,c){function d(a){if(u)return u;u={ta:z?z.evaluate(a):null,ob:l?l.evaluate(a):null,pb:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[q,m,p,r].forEach(function(b){b&&(c+=b.evaluate(a))});(null===u.ob||null===u.pb)&&c+u.ta+u.ob+u.pb>b&&(null===u.ob&&(u.ob=0),null===u.pb&&(u.kh=0));null!==u.ta&&null!==u.ob&&null!==u.pb&&(u.pb=null);null===u.ta&&null!==u.ob&&null!==u.pb?u.ta=b-c-u.ob-u.pb:null!==u.ta&&null===u.ob&&null!==u.pb?u.ob=b-c-u.ta-u.pb:null!==u.ta&&null!==u.ob&&null===u.pb?u.pb=
b-c-u.ta-u.ob:null===u.ta?(u.ob=u.pb=0,u.ta=b-c):u.ob=u.pb=(b-c-u.ta)/2;return u}var e=a.style;a=a.f.f;var f=b.ye,g=b.Fe;b=b.ta;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],l=tq(a,e["margin-"+f],h),k=tq(a,e["margin-"+g],h),m=sq(a,e["padding-"+f],h),p=sq(a,e["padding-"+g],h),q=uq(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),r=uq(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),z=Y(a,e[b],h),u=null;e[b]=new G(new Ib(a,function(){var a=d(this).ta;return null===a?0:a},b));e["margin-"+
f]=new G(new Ib(a,function(){var a=d(this).ob;return null===a?0:a},"margin-"+f));e["margin-"+g]=new G(new Ib(a,function(){var a=d(this).pb;return null===a?0:a},"margin-"+g));"left"===f?e.left=new G(y(a,c.marginLeft,c.Gc)):"top"===f&&(e.top=new G(y(a,c.marginTop,c.Fc)))}n.ve=function(){var a=this.g.u;this.u.Ta?Fs(this,{ye:"right",Fe:"left",ta:"width"},a):this.u.Ua?Fs(this,{ye:"left",Fe:"right",ta:"width"},a):this.Ba({start:"left",end:"right",ta:"width"},a)};
n.we=function(){var a=this.g.u;this.u.Va?Fs(this,{ye:"bottom",Fe:"top",ta:"height"},a):this.u.Sa?Fs(this,{ye:"top",Fe:"bottom",ta:"height"},a):this.Ba({start:"top",end:"bottom",ta:"height"},a)};n.Jd=function(a,b,c,d,e,f,g){rq.prototype.Jd.call(this,a,b,c,d,e,f,g);a=c.H;c=this.f.u;d=this.u;d.Ta||d.Ua?d.Va||d.Sa||(d.Ta?a.left[c]=b:d.Ua&&(a.right[c]=b)):d.Va?a.top[c]=b:d.Sa&&(a.bottom[c]=b)};
function Gs(a,b,c,d,e){this.f=a;this.l=b;this.h=c;this.b=d;this.g=e;this.j={};a=this.l;b=new sc(a,"page-number");b=new kc(a,new qc(a,b,new Gb(a,2)),a.b);c=new ac(a,b);a.values["recto-page"]=c;a.values["verso-page"]=b;"ltr"===(this.b.G||Zr(this.g))?(a.values["left-page"]=b,b=new ac(a,b),a.values["right-page"]=b):(c=new ac(a,b),a.values["left-page"]=c,a.values["right-page"]=b)}function Hs(a){var b={};vj(a.f,[],"",b);Fj(a.f);return b}
function Is(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof V?""+e.value:Is(a,e);c.push(d+f+(e.ab||""))}return c.sort().join("^")}function Js(a,b,c){c=c.clone({hc:"vivliostyle-page-rule-master"});var d=c.b,e=b.size;if(e){var f=es(b),e=e.ab;d.width=Uh(a.b,d.width,new V(f.width,e));d.height=Uh(a.b,d.height,new V(f.height,e))}["counter-reset","counter-increment"].forEach(function(a){d[a]&&(b[a]=d[a])});c=c.h(a.h);c.l(a.f,a.g);Uq(c,a.b);return c}
function Ks(a){this.b=null;this.h=a}v(Ks,W);Ks.prototype.apply=function(a){a.Y===this.h&&this.b.apply(a)};Ks.prototype.f=function(){return 3};Ks.prototype.g=function(a){this.b&&li(a.gd,this.h,this.b);return!0};function Ls(a){this.b=null;this.h=a}v(Ls,W);Ls.prototype.apply=function(a){1===(new sc(this.h,"page-number")).evaluate(a.l)&&this.b.apply(a)};Ls.prototype.f=function(){return 2};function Ms(a){this.b=null;this.h=a}v(Ms,W);
Ms.prototype.apply=function(a){(new sc(this.h,"left-page")).evaluate(a.l)&&this.b.apply(a)};Ms.prototype.f=function(){return 1};function Ns(a){this.b=null;this.h=a}v(Ns,W);Ns.prototype.apply=function(a){(new sc(this.h,"right-page")).evaluate(a.l)&&this.b.apply(a)};Ns.prototype.f=function(){return 1};function Os(a){this.b=null;this.h=a}v(Os,W);Os.prototype.apply=function(a){(new sc(this.h,"recto-page")).evaluate(a.l)&&this.b.apply(a)};Os.prototype.f=function(){return 1};
function Ps(a){this.b=null;this.h=a}v(Ps,W);Ps.prototype.apply=function(a){(new sc(this.h,"verso-page")).evaluate(a.l)&&this.b.apply(a)};Ps.prototype.f=function(){return 1};function Qs(a,b){ii.call(this,a,b,null,null,null)}v(Qs,ii);Qs.prototype.apply=function(a){var b=a.l,c=a.F,d=this.style;a=this.aa;ai(b,c,d,a,null,null,null);if(d=d._marginBoxes){var c=Yh(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);ai(b,f,d[e],a,null,null,null)}}};
function Rs(a,b,c,d,e){Hj.call(this,a,b,null,c,null,d,!1);this.O=e;this.H=[];this.g="";this.F=[]}v(Rs,Hj);n=Rs.prototype;n.Oc=function(){this.Lb()};n.Qb=function(a,b){if(this.g=b)this.b.push(new Ks(b)),this.aa+=65536};
n.jd=function(a,b){b&&Hf(this,"E_INVALID_PAGE_SELECTOR :"+a+"("+b.join("")+")");this.F.push(":"+a);switch(a.toLowerCase()){case "first":this.b.push(new Ls(this.f));this.aa+=256;break;case "left":this.b.push(new Ms(this.f));this.aa+=1;break;case "right":this.b.push(new Ns(this.f));this.aa+=1;break;case "recto":this.b.push(new Os(this.f));this.aa+=1;break;case "verso":this.b.push(new Ps(this.f));this.aa+=1;break;default:Hf(this,"E_INVALID_PAGE_SELECTOR :"+a)}};
function Ss(a){var b;a.g||a.F.length?b=[a.g].concat(a.F.sort()):b=null;a.H.push({lf:b,aa:a.aa});a.g="";a.F=[]}n.Mc=function(){Ss(this);Hj.prototype.Mc.call(this)};n.Ia=function(){Ss(this);Hj.prototype.Ia.call(this)};
n.Kb=function(a,b,c){if("bleed"!==a&&"marks"!==a||this.H.some(function(a){return!a.lf})){Hj.prototype.Kb.call(this,a,b,c);var d=this.lb[a],e=this.O;if("bleed"===a||"marks"===a)e[""]||(e[""]={}),Object.keys(e).forEach(function(b){Xh(e[b],a,d)});else if("size"===a){var f=e[""];this.H.forEach(function(b){var c=new V(d.value,d.ab+b.aa);b=b.lf?b.lf.join(""):"";var g=e[b];g?(c=(b=g[a])?Uh(null,c,b):c,Xh(g,a,c)):(g=e[b]={},Xh(g,a,c),f&&["bleed","marks"].forEach(function(a){f[a]&&Xh(g,a,f[a])},this))},this)}}};
n.Of=function(a){li(this.l.gd,"*",a)};n.Rf=function(a){return new Qs(this.lb,a)};n.Le=function(a){var b=Yh(this.lb,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);Df(this.oa,new Ts(this.f,this.oa,this.B,c))};function Ts(a,b,c,d){Ef.call(this,a,b,!1);this.g=c;this.b=d}v(Ts,Ff);Ts.prototype.Ib=function(a,b,c){Bh(this.g,a,b,c,this)};Ts.prototype.cd=function(a,b){Gf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Ts.prototype.ae=function(a,b){Gf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
Ts.prototype.Kb=function(a,b,c){Xh(this.b,a,new V(b,c?Af(this):Bf(this)))};function Us(a){if(1>=a.length)return!1;var b=a[a.length-1].h;return a.slice(0,a.length-1).every(function(a){return b>a.h})}function Vs(a,b){a.b?a.width=b:a.height=b}function Ws(a){return a.b?a.width:a.height}function Xs(a,b){this.ed=a;this.Nc=b}function Ys(a,b,c){this.b=a;this.F=b;this.B=c;this.f=Ws(a)}
function Zs(a,b){var c=L("ColumnBalancer#balanceColumns");a.u(b);$s(a,b);zl(a.b);var d=[at(a,b)];Ce(function(b){a.l(d)?(a.C(d),a.F().then(function(c){$s(a,c);zl(a.b);c?(d.push(at(a,c)),P(b)):Q(b)})):Q(b)}).then(function(){var b=d.reduce(function(a,b){return b.Nc<a.Nc?b:a},d[0]);bt(a,b.ed);Vs(a.b,a.f);O(c,b.ed)});return c.result()}function at(a,b){var c=a.j(b);return new Xs(b,c)}Ys.prototype.u=function(){};function $s(a,b){var c=En(a.B);b&&(b.og=c)}
function bt(a,b){var c=a.b.element;b.Bb.forEach(function(a){c.appendChild(a.element)});Fn(a.B,b.og)}function ct(a){var b=a[a.length-1];if(!b.Nc||(a=a[a.length-2])&&b.Nc>=a.Nc)return!1;a=b.ed.Bb;b=Math.max.apply(null,a.map(function(a){return a.h}));a=Math.max.apply(null,a.map(function(a){return $n(a.l)}));return b>a+1}function dt(a,b){var c=Math.max.apply(null,a[a.length-1].ed.Bb.map(function(a){return isNaN(a.ef)?a.h:a.h-a.ef+1}))-1;c<Ws(b)?Vs(b,c):Vs(b,Ws(b)-1)}
function et(a,b,c,d){Ys.call(this,c,a,b);this.G=d;this.h=null;this.g=!1}v(et,Ys);et.prototype.u=function(a){var b=a.Bb.reduce(function(a,b){return a+b.h},0);Vs(this.b,b/this.G);this.h=a.position};function ft(a,b){return a.h?nl(a.h,b):!b}et.prototype.j=function(a){if(!ft(this,a.position))return Infinity;a=a.Bb;return Us(a)?Infinity:Math.max.apply(null,a.map(function(a){return a.h}))};
et.prototype.l=function(a){if(1===a.length)return!0;if(this.g)return ct(a);a=a[a.length-1];return ft(this,a.ed.position)&&!Us(a.ed.Bb)?this.g=!0:Ws(this.b)<this.f};et.prototype.C=function(a){this.g?dt(a,this.b):Vs(this.b,Math.min(this.f,Ws(this.b)+.1*this.f))};function gt(a,b,c){Ys.call(this,c,a,b)}v(gt,Ys);gt.prototype.j=function(a){if(a.Bb.every(function(a){return!a.h}))return Infinity;a=a.Bb.filter(function(a){return!a.g}).map(function(a){return a.h});return ht(a)};gt.prototype.l=function(a){return ct(a)};
gt.prototype.C=function(a){dt(a,this.b)};function it(a,b,c,d,e,f,g){if(b===Wc)return null;f=f[f.length-1];f=!(!f||!f.g);return!g.b.length||f?new et(c,d,e,a):b===Yc?new gt(c,d,e):null};var jt=new Ee(function(){var a=L("uaStylesheetBase");Ch.get().then(function(b){var c=Aa("user-agent-base.css",za);b=new Hj(null,null,null,null,null,b,!0);b.Pc("UA");Gj=b.l;gg(c,b,null,null).Ja(a)});return a.result()},"uaStylesheetBaseFetcher");
function kt(a,b,c,d,e,f,g,h,l,k){this.j=a;this.f=b;this.b=c;this.g=d;this.H=e;this.C=f;this.B=a.O;this.F=g;this.h=h;this.u=l;this.G=k;this.l=a.l;Kb(this.b,function(a){var b=this.b,c;c=(c=b.b[a])?(c=c.b[0])?c.qa:null:null;var d;d=b.b[a];if(d=lt(this,d?d.g:"any"))d=(a=b.b[a])?0<a.b.length&&a.b[0].qa.f<=this.C:!1;return d&&!!c&&!mt(this,c)});Jb(this.b,new Ib(this.b,function(){return this.ba+this.b.page},"page-number"))}
function nt(a,b,c,d,e){if(a.u.length){var f=new Nb(0,b,c,d);a=a.u;for(var g={},h=0;h<a.length;h++)ai(f,g,a[h],0,null,null,null);h=g.width;a=g.height;var l=g["text-zoom"];if(h&&a||l)if(g=Lb.em,(l?l.evaluate(f,"text-zoom"):null)===Hd&&(l=g/d,d=g,b*=l,c*=l),h&&a&&(h=Sc(h.evaluate(f,"width"),f),f=Sc(a.evaluate(f,"height"),f),0<h&&0<f))return{width:e&&e.tb?2*(h+e.xc):h,height:f,fontSize:d}}return{width:b,height:c,fontSize:d}}
function ot(a,b,c,d,e,f,g,h,l,k,m,p){Nb.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.ca=b;this.lang=b.lang||c;this.viewport=d;this.l={body:!0};this.g=e;this.B=this.b=this.J=this.f=this.F=null;this.C=0;this.yb=f;this.j=new rm(this.style.B);this.va={};this.Y=null;this.h=m;this.Eb=new an(null,null,null,null,null,null,null);this.X={};this.G=p||null;this.jb=g;this.xb=h;this.ba=l;this.rb=k;for(var q in a.h)(b=a.h[q]["flow-consume"])&&(b.evaluate(this,"flow-consume")==Uc?this.l[q]=!0:delete this.l[q]);
this.Ca={};this.la=this.da=0}v(ot,Nb);
function pt(a){var b=L("StyleInstance.init"),c=new Op(a.h,a.ca.url),d=new Pp(a.h,a.ca.url,a.style.f,a.style.b);a.f=new Zl(a.ca,a.style.g,a.style.f,a,a.l,a.style.l,c,d);d.h=a.f;im(a.f,a);a.J={};a.J[a.ca.url]=a.f;var e=fm(a.f);a.G||(a.G=Zr(e));a.F=new Vq(a.style.H);c=new pj(a.style.g,a,c,d);a.F.l(c,e);Uq(a.F,a);a.Y=new Gs(c,a.style.b,a.F,a,e);e=[];c=t(a.style.C);for(d=c.next();!d.done;d=c.next())if(d=d.value,!d.ia||d.ia.evaluate(a))d=om(d.yc,a),d=new pm(d),e.push(d);xm(a.yb,e,a.j).Ja(b);var f=a.style.G;
Object.keys(f).forEach(function(a){var b=fs(es(f[a]),this);this.Ca[a]={width:b.ec+2*b.le,height:b.dc+2*b.le}},a);return b.result()}function jm(a,b,c){if(a=a.b)a.f[b.b]||(a.f[b.b]=c),c=a.b[b.b],c||(c=new kl,a.b[b.b]=c),c.b.push(new jl(new hl({pa:[{node:b.element,ib:Tk,ua:null,Ha:null,Ea:null,Ra:0}],na:0,K:!1,Oa:null}),b))}
function qt(a,b){for(var c=Number.POSITIVE_INFINITY,d=0;d<b.b.length;d++){for(var e=b.b[d].b.f,f=e.pa[0].node,g=e.na,h=e.K,l=0;f.ownerDocument!=a.ca.b;)l++,f=e.pa[l].node,h=!1,g=0;e=fk(a.ca,f,g,h);e<c&&(c=e)}return c}
function rt(a,b,c){if(!b)return 0;var d=Number.POSITIVE_INFINITY,e;for(e in a.l){var f=b.b[e];if(!(c||f&&f.b.length)&&a.b){f=a.f;f.O=e;for(var g=0;null!=f.O&&(g+=5E3,gm(f,g,0)!=Number.POSITIVE_INFINITY););f=a.b.b[e];b!=a.b&&f&&(f=f.clone(),b.b[e]=f)}f&&(f=qt(a,f),f<d&&(d=f))}return d}function lt(a,b){switch(b){case "left":case "right":case "recto":case "verso":return(new sc(a.style.b,b+"-page")).evaluate(a);default:return!0}}
function st(a,b){var c=a.b,d=rt(a,c);if(d==Number.POSITIVE_INFINITY)return null;for(var e=a.F.children,f,g=0;g<e.length;g++)if(f=e[g],"vivliostyle-page-rule-master"!==f.f.hc){var h=1,l=Eq(f,a,"utilization");l&&l.cf()&&(h=l.L);var l=Pb(a,"em",!1),k=a.ec()*a.dc();a.C=gm(a.f,d,Math.ceil(h*k/(l*l)));h=a;l=void 0;for(l in c.b)if((k=c.b[l])&&0<k.b.length){var m=k.b[0].qa;if(qt(h,k)===m.f){a:switch(m=k.g,m){case "left":case "right":case "recto":case "verso":break a;default:m=null}k.g=zm(Ql(m,k.b[0].qa.g))}}a.B=
c.clone();h=a;l=h.b.page;k=void 0;for(k in h.b.b)for(var m=h.b.b[k],p=m.b.length-1;0<=p;p--){var q=m.b[p];0>q.qa.ub&&q.qa.f<h.C&&(q.qa.ub=l)}Ob(a,a.style.b);h=Eq(f,a,"enabled");if(!h||h===Vd){c=a;w.debug("Location - page",c.b.page);w.debug("  current:",d);w.debug("  lookup:",c.C);d=void 0;for(d in c.b.b)for(e=t(c.b.b[d].b),g=e.next();!g.done;g=e.next())w.debug("  Chunk",d+":",g.value.qa.f);d=a.Y;e=f;f=b;c=e.f;Object.keys(f).length?(e=c,g=Is(d,f),e=e.j+"^"+g,g=d.j[e],g||("background-host"===c.hc?(c=
d,f=(new qs(c.l,c.h.f,f)).h(c.h),f.l(c.f,c.g),Uq(f,c.b),g=f):g=Js(d,f,c),d.j[e]=g),f=g.f,f.f.g=f,f=g):(c.f.g=c,f=e);return f}}throw Error("No enabled page masters");}function mt(a,b){var c=a.B.f,d=c[b.b].f;if(d){var e=b.f,f=c[d].b;if(!f.length||e<f[0])return!1;var c=Xa(f.length,function(a){return f[a]>e})-1,c=f[c],d=a.B.b[d],g=qt(a,d);return c<g?!1:g<c?!0:!lt(a,d.g)}return!1}function tt(a,b,c){a=a.b.f[c];a.D||(a.D=new to(null));b.ff=a.D}
function ut(a){var b=a.l,c=un(b),d=L("layoutDeferredPageFloats"),e=!1,f=0;Ce(function(d){if(f===c.length)Q(d);else{var g=c[f++],l=g.ja,k=jn(l),m=k.rf(l,b);m&&Zm(m,l)?P(d):kn(b,l)||wn(b,l)?(vn(b,g),Q(d)):Vo(a,g,k,null,m).then(function(a){a?(a=Gn(b.parent))?Q(d):(Gn(b)&&!a&&(e=!0,b.Lc=!1),P(d)):Q(d)})}}).then(function(){e&&mn(b);O(d,!0)});return d.result()}
function vt(a,b,c){var d=a.b.b[c];if(!d||!lt(a,d.g))return M(!0);d.g="any";tt(a,b,c);To(b);a.l[c]&&0<b.Eb.length&&(b.Fb=!1);var e=L("layoutColumn");ut(b).then(function(){if(Gn(b.l))O(e,!0);else{var f=[],g=[],h=!0;Ce(function(e){if(!qn(b.l,c))for(var k={};0<d.b.length-g.length;){for(k.index=0;g.includes(k.index);)k.index++;k.selected=d.b[k.index];if(k.selected.qa.f>a.C||mt(a,k.selected.qa))break;for(var l=k.index+1;l<d.b.length;l++)if(!g.includes(l)){var p=d.b[l];if(p.qa.f>a.C||mt(a,p.qa))break;Mk(p.qa,
k.selected.qa)&&(k.selected=p,k.index=l)}k.qa=k.selected.qa;k.Ma=!0;Jm(b,k.selected.b,h,d.f).then(function(a){return function(c){if(Gn(b.l))Q(e);else if(h=!1,a.selected.qa.u&&(null===c||a.qa.h)&&f.push(a.index),a.qa.h)g.push(a.index),Q(e);else{var k=!!c||!!b.g,l;0<xn(b.l).length&&b.xb?c?(l=c.clone(),l.f=b.xb):l=new hl(b.xb):l=null;if(b.g&&l)a.selected.b=l,d.f=b.g,b.g=null;else{g.push(a.index);if(c||l)a.selected.b=c||l,f.push(a.index);b.g&&(d.g=zm(b.g))}k?Q(e):(b.Fb=!1,a.Ma?a.Ma=!1:P(e))}}}(k));if(k.Ma){k.Ma=
!1;return}k={selected:k.selected,qa:k.qa,index:k.index,Ma:k.Ma}}Q(e)}).then(function(){if(!Gn(b.l)){d.b=d.b.filter(function(a,b){return f.includes(b)||!g.includes(b)});"column"===d.f&&(d.f=null);Ep(b);var a=Tn(b.l);Qo(b,a)}O(e,!0)})}});return e.result()}
function wt(a,b,c,d,e,f,g,h,l,k,m,p,q,r,z){var u=b.b?b.j&&b.N:b.h&&b.O,A=f.element,H=new an(l,"column",null,h,null,null,null),E=a.b.clone(),K=L("createAndLayoutColumn"),I;Ce(function(b){var K=new jo([new eq(a.h,a.b.page-1)].concat(Xn(H)));if(1<k){var ka=a.viewport.b.createElement("div");x(ka,"position","absolute");A.appendChild(ka);I=new Hm(ka,r,a.g,K,H);I.Fb=z;I.b=f.b;I.Ub=f.Ub;I.Kd=f.Kd;f.b?(K=g*(p+m)+f.J,wl(I,f.H,f.width),vl(I,K,p)):(K=g*(p+m)+f.H,vl(I,f.J,f.height),wl(I,K,p));I.F=c;I.G=d}else I=
new Hm(A,r,a.g,K,H),ul(I,f);I.rb=u?[]:e.concat();I.Tb=q;en(H,I);0<=I.width?vt(a,I,h).then(function(){Gn(H)||Cn(H);Gn(I.l)&&!Gn(l)?(I.l.Lc=!1,a.b=E.clone(),I.element!==A&&A.removeChild(I.element),P(b)):Q(b)}):(Cn(H),Q(b))}).then(function(){O(K,I)});return K.result()}function xt(a,b,c,d,e){var f=Eq(c,a,"writing-mode")||null;a=Eq(c,a,"direction")||null;return new an(b,"region",d,e,null,f,a)}
function yt(a,b,c,d,e,f,g,h,l,k){function m(){p.b=q.clone();return zt(p,b,c,d,e,f,g,r,h,l,k,z).ha(function(a){return a?M({Bb:a,position:p.b}):M(null)})}var p=a,q=p.b.clone(),r=xt(p,g,c,h,l),z=!0;return m().ha(function(a){if(!a)return M(null);if(1>=k)return M(a.Bb);var b=Eq(c,p,"column-fill")||Xc,b=it(k,b,m,r,h,a.Bb,p.b.b[l]);if(!b)return M(a.Bb);z=!1;g.g=!0;r.g=!0;return Zs(b,a).ha(function(a){g.g=!1;g.Lc=!1;r.g=!1;p.b=a.position;return M(a.Bb)})})}
function zt(a,b,c,d,e,f,g,h,l,k,m,p){var q=L("layoutFlowColumns"),r=a.b.clone(),z=Z(c,a,"column-gap"),u=1<m?Z(c,a,"column-width"):l.width,A=Dq(c,a),H=Eq(c,a,"shape-inside"),E=Og(H,0,0,l.width,l.height,a),K=new or(k,a,a.viewport,a.f,A,a.ca,a.j,a.style.F,a,b,a.jb,a.xb,a.rb),I=0,ka=null,Ca=[];Ce(function(b){wt(a,c,d,e,f,l,I++,k,h,m,z,u,E,K,p).then(function(c){Gn(g)?(Ca=null,Q(b)):((c.g&&"column"!==c.g||I===m)&&!Gn(h)&&Cn(h),Gn(h)?(I=0,a.b=r.clone(),h.Lc=!1,h.g?(Ca=null,Q(b)):P(b)):(ka=c,Ca[I-1]=ka,ka.g&&
"column"!=ka.g&&(I=m,"region"!=ka.g&&(a.X[k]=!0)),I<m?P(b):Q(b)))})}).then(function(){O(q,Ca)});return q.result()}
function At(a,b,c,d,e,f,g,h){xq(c);var l=Eq(c,a,"enabled");if(l&&l!==Vd)return M(!0);var k=L("layoutContainer"),m=Eq(c,a,"wrap-flow")===Wc,l=Eq(c,a,"flow-from"),p=a.viewport.b.createElement("div"),q=Eq(c,a,"position");x(p,"position",q?q.name:"absolute");d.insertBefore(p,d.firstChild);var r=new ol(p);r.b=c.b;r.rb=g;c.fc(a,r,b,a.j,a.g);r.F=e;r.G=f;e+=r.left+r.marginLeft+r.Y;f+=r.top+r.marginTop+r.ba;(c instanceof vs||c instanceof nq&&!(c instanceof us))&&en(h,r);var z=!1;if(l&&l.Pf())if(a.X[l.toString()])Gn(h)||
c.Jd(a,r,b,null,1,a.g,a.j),l=M(!0);else{var u=L("layoutContainer.inner"),A=l.toString(),H=Z(c,a,"column-count");yt(a,b,c,e,f,g,h,r,A,H).then(function(d){if(!Gn(h)){var e=d[0];e.element===p&&(r=e);r.h=Math.max.apply(null,d.map(function(a){return a.h}));c.Jd(a,r,b,e,H,a.g,a.j);(d=a.b.b[A])&&"region"===d.f&&(d.f=null)}O(u,!0)});l=u.result()}else{if((l=Eq(c,a,"content"))&&El(l)){q="span";l.url&&(q="img");var E=a.viewport.b.createElement(q);l.ea(new Dl(E,a,l,cq(a.h)));p.appendChild(E);"img"==q&&Tq(c,a,
E,a.j);Sq(c,a,r,a.j)}else c.va&&(d.removeChild(p),z=!0);z||c.Jd(a,r,b,null,1,a.g,a.j);l=M(!0)}l.then(function(){if(Gn(h))O(k,!0);else{if(!c.h||0<Math.floor(r.h)){if(!z&&!m){var l=Eq(c,a,"shape-outside"),l=Bl(r,l,a);g.push(l)}}else if(!c.children.length){d.removeChild(p);O(k,!0);return}var q=c.children.length-1;Be(function(){for(;0<=q;){var d=c.children[q--],d=At(a,b,d,p,e,f,g,h);if(d.Wa())return d.ha(function(){return M(!Gn(h))});if(Gn(h))break}return M(!1)}).then(function(){O(k,!0)})}});return k.result()}
function Bt(a){var b=a.b.page,c;for(c in a.b.b)for(var d=a.b.b[c],e=d.b.length-1;0<=e;e--){var f=d.b[e];0<=f.qa.ub&&f.qa.ub+f.qa.l-1<=b&&d.b.splice(e,1)}}function Ct(a,b){for(var c in a.l){var d=b.b[c];if(d&&0<d.b.length)return!1}return!0}
function Dt(a,b,c){a.X={};c?(a.b=c.clone(),bm(a.f,c.g)):(a.b=new ml,bm(a.f,-1));a.lang&&b.h.setAttribute("lang",a.lang);c=a.b;c.page++;Ob(a,a.style.b);a.B=c.clone();var d=Hs(a.Y),e=st(a,d);if(!e)return M(null);Dk(b,e.f.b.width.value===Xd);Ek(b,e.f.b.height.value===Yd);a.h.j=b;Yp(a.h,d,a);var f=fs(es(d),a);Et(a,f,b);ms(d,f,b,a);var g=f.Wb+f.Vb,d=Eq(e,a,"writing-mode")||pd,f=Eq(e,a,"direction")||zd,h=new an(a.Eb,"page",null,null,null,d,f),l=L("layoutNextPage");Ce(function(c){At(a,b,e,b.h,g,g+1,[],h).then(function(){Gn(h)||
Cn(h);Gn(h)?(a.b=a.B.clone(),h.Lc=!1,P(c)):Q(c)})}).then(function(){e.ba(a,b,a.g);var d=new sc(e.f.f,"left-page");b.f=d.evaluate(a)?"left":"right";Bt(a);c=a.b;Object.keys(c.b).forEach(function(b){b=c.b[b];var d=b.f;!d||"page"!==d&&lt(a,d)||(b.f=null)});a.b=a.B=null;c.g=a.f.b;Gk(b,a.style.j.N[a.ca.url],a.g);Ct(a,c)&&(c=null);O(l,c)});return l.result()}
function Et(a,b,c){a.O=b.ec;a.N=b.dc;a.la=b.ec+2*b.le;a.da=b.dc+2*b.le;c.I.style.width=a.la+"px";c.I.style.height=a.da+"px";c.h.style.left=b.Wb+"px";c.h.style.right=b.Wb+"px";c.h.style.top=b.Wb+"px";c.h.style.bottom=b.Wb+"px";c.h.style.padding=b.Vb+"px";c.h.style.paddingTop=b.Vb+1+"px"}function Ft(a,b,c,d){Hj.call(this,a.j,a,b,c,d,a.h,!c);this.g=a;this.F=!1}v(Ft,Hj);n=Ft.prototype;n.Yd=function(){};
n.Xd=function(a,b,c){a=new mq(this.g.u,a,b,c,this.g.G,this.ia,Bf(this.oa));Df(this.g,new $q(a.f,this.g,a,this.B))};n.Ac=function(a){a=a.Hc;this.ia&&(a=yc(this.f,this.ia,a));Df(this.g,new Ft(this.g,a,this,this.G))};n.Ud=function(){Df(this.g,new Nj(this.f,this.oa))};n.Wd=function(){var a={};this.g.B.push({yc:a,ia:this.ia});Df(this.g,new Oj(this.f,this.oa,null,a,this.g.h))};n.Vd=function(a){var b=this.g.l[a];b||(b={},this.g.l[a]=b);Df(this.g,new Oj(this.f,this.oa,null,b,this.g.h))};
n.$d=function(){var a={};this.g.H.push(a);Df(this.g,new Oj(this.f,this.oa,this.ia,a,this.g.h))};n.nd=function(a){var b=this.g.C;if(a){var c=Yh(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Df(this.g,new Oj(this.f,this.oa,null,b,this.g.h))};n.Zd=function(){this.F=!0;this.Lb()};n.Oc=function(){var a=new Rs(this.g.u,this.g,this,this.B,this.g.F);Df(this.g,a);a.Oc()};
n.Ia=function(){Hj.prototype.Ia.call(this);if(this.F){this.F=!1;var a="R"+this.g.N++,b=D(a),c;this.ia?c=new Th(b,0,this.ia):c=new V(b,0);$h(this.lb,"region-id").push(c);this.Zb();a=new Ft(this.g,this.ia,this,a);Df(this.g,a);a.Ia()}};
function Gt(a){var b=a.getAttribute("content");if(!b)return"";a={};for(var c;c=b.match(/^,?\s*([-A-Za-z_.][-A-Za-z_0-9.]*)\s*=\s*([-+A-Za-z_0-9.]*)\s*/);)b=b.substr(c[0].length),a[c[1]]=c[2];b=a.width-0;a=a.height-0;return b&&a?"@-epubx-viewport{width:"+b+"px;height:"+a+"px;}":""}function Ht(a){Cf.call(this);this.h=a;this.j=new Fb(null);this.u=new Fb(this.j);this.G=new jq(this.j);this.J=new Ft(this,null,null,null);this.N=0;this.B=[];this.C={};this.l={};this.H=[];this.F={};this.b=this.J}v(Ht,Cf);
Ht.prototype.error=function(a){w.b("CSS parser:",a)};function It(a,b){return Jt(b,a)}function Kt(a){vf.call(this,It,"document");this.O=a;this.H={};this.u={};this.f={};this.N={};this.l=null;this.b=[];this.J=!1}v(Kt,vf);function Lt(a,b,c){Mt(a,b,c);var d=Aa("user-agent.xml",za),e=L("OPSDocStore.init");Ch.get().then(function(b){a.l=b;jt.get().then(function(){a.load(d).then(function(){a.J=!0;O(e,!0)})})});return e.result()}function Mt(a,b,c){a.b.splice(0);b&&b.forEach(a.X,a);c&&c.forEach(a.Y,a)}
Kt.prototype.X=function(a){var b=a.url;b&&(b=Aa(b,ya));this.b.push({url:b,text:a.text,nb:"Author",Na:null,media:null})};Kt.prototype.Y=function(a){var b=a.url;b&&(b=Aa(b,ya));this.b.push({url:b,text:a.text,nb:"User",Na:null,media:null})};
function Jt(a,b){var c=L("OPSDocStore.load"),d=b.url;nk(b,a).then(function(b){if(b){if(a.J)for(var e=ee("PREPROCESS_SINGLE_DOCUMENT"),g=0;g<e.length;g++)try{e[g](b.b)}catch(u){w.b("Error during single document preprocessing:",u)}for(var e=[],h=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),g=0;g<h.length;g++){var l=h[g],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=l.getAttribute("action"),
l=l.getAttribute("ref");k&&m&&p&&l&&e.push({Bg:k,event:m,action:p,ld:l})}a.N[d]=e;var q=[];q.push({url:Aa("user-agent-page.css",za),text:null,nb:"UA",Na:null,media:null});if(g=b.l)for(g=g.firstChild;g;g=g.nextSibling)if(1==g.nodeType)if(e=g,h=e.namespaceURI,k=e.localName,"http://www.w3.org/1999/xhtml"==h)if("style"==k)q.push({url:d,text:e.textContent,nb:"Author",Na:null,media:null});else if("link"==k){if(m=e.getAttribute("rel"),h=e.getAttribute("class"),k=e.getAttribute("media"),"stylesheet"==m||
"alternate stylesheet"==m&&h)m=e.getAttribute("href"),m=Aa(m,d),e=e.getAttribute("title"),q.push({url:m,text:null,Na:e?h:null,media:k,nb:"Author"})}else"meta"==k&&"viewport"==e.getAttribute("name")&&q.push({url:d,text:Gt(e),nb:"Author",Na:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==h?"stylesheet"==k&&"text/css"==e.getAttribute("type")&&q.push({url:d,text:e.textContent,nb:"Author",Na:null,media:null}):"http://example.com/sse"==h&&"property"===k&&(h=e.getElementsByTagName("name")[0])&&
"stylesheet"===h.textContent&&(e=e.getElementsByTagName("value")[0])&&(m=Aa(e.textContent,d),q.push({url:m,text:null,Na:null,media:null,nb:"Author"}));for(g=0;g<a.b.length;g++)q.push(a.b[g]);for(var r="",g=0;g<q.length;g++)r+=q[g].url,r+="^",q[g].text&&(r+=q[g].text),r+="^";var z=a.H[r];z?(a.f[d]=z,O(c,b)):(g=a.u[r],g||(g=new Ee(function(){var b=L("fetchStylesheet"),c=0,d=new Ht(a.l);Be(function(){if(c<q.length){var a=q[c++];d.Pc(a.nb);return null!==a.text?hg(a.text,d,a.url,a.Na,a.media).Cc(!0):gg(a.url,
d,a.Na,a.media)}return M(!1)}).then(function(){z=new kt(a,d.j,d.u,d.J.l,d.G,d.B,d.C,d.l,d.H,d.F);a.H[r]=z;delete a.u[r];O(b,z)});return b.result()},"FetchStylesheet "+d),a.u[r]=g,g.start()),g.get().then(function(e){a.f[d]=e;O(c,b)}))}else O(c,null)});return c.result()};function Nt(a){return String.fromCharCode(a>>>24&255,a>>>16&255,a>>>8&255,a&255)}
...
function Qt(a){a=Ot(a);for(var b=new Pa,c=0;c<a.length;c++)b.append(Nt(a[c]));a=b.toString();b=new Pa;for(c=0;c<a.length;c++)b.append((a.charCodeAt(c)|256).toString(16).substr(1));return b.toString()};function Rt(a,b,c,d,e,f,g,h,l,k){this.b=a;this.url=b;this.lang=c;this.f=d;this.l=e;this.Z=xb(f);this.u=g;this.j=h;this.h=l;this.g=k;this.fb=this.page=null}function St(a,b,c){if(c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=Na(d,"height","auto")&&(x(d,"height","auto"),St(a,d,c));"absolute"==Na(d,"position","static")&&(x(d,"position","relative"),St(a,d,c))}}
function Tt(a){var b=a.target,c="\u25b8"==b.textContent;b.textContent=c?"\u25be":"\u25b8";for(b=b.parentNode.firstChild;b;)if(1!=b.nodeType)b=b.nextSibling;else{var d=b;"toc-container"==d.getAttribute("data-adapt-class")?b=d.firstChild:("toc-node"==d.getAttribute("data-adapt-class")&&(d.style.height=c?"auto":"0px"),b=b.nextSibling)}a.stopPropagation()}
Rt.prototype.Be=function(a){var b=this.u.Be(a);return function(a,d,e){var c=e.behavior;if(!c||"toc-node"!=c.toString()&&"toc-container"!=c.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",x(e,"cursor","pointer"),e.addEventListener("click",Tt,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==c.toString()?(e=d.ownerDocument.createElement("div"),
...
Rt.prototype.Td=function(a,b,c,d,e){if(this.page)return M(this.page);var f=this,g=L("showTOC"),h=new Ck(a,a);this.page=h;this.b.load(this.url).then(function(d){var k=f.b.f[d.url],l=nt(k,c,1E5,e);b=new Xr(b.window,l.fontSize,b.root,l.width,l.height);var p=new ot(k,d,f.lang,b,f.f,f.l,f.Be(d),f.j,0,f.h,f.g);f.fb=p;p.Z=f.Z;pt(p).then(function(){Dt(p,h,null).then(function(){St(f,a,2);O(g,h)})})});return g.result()};
Rt.prototype.Md=function(){if(this.page){var a=this.page;this.fb=this.page=null;x(a.I,"visibility","none");var b=a.I.parentNode;b&&b.removeChild(a.I)}};Rt.prototype.df=function(){return!!this.page};function Ut(){Kt.call(this,Vt(this));this.g=new vf(nk,"document");this.F=new vf(xf,"text");this.G={};this.da={};this.B={};this.C={}}v(Ut,Kt);function Vt(a){return function(b){return a.B[b]}}
function Wt(a,b,c){var d=L("loadEPUBDoc");"/"!==b.substring(b.length-1)&&(b+="/");c&&a.F.fetch(b+"?r=list");a.g.fetch(b+"META-INF/encryption.xml");var e=b+"META-INF/container.xml";a.g.load(e,!0,"Failed to fetch EPUB container.xml from "+e).then(function(f){if(f){f=wk(ck(ck(ck(new dk([f.b]),"container"),"rootfiles"),"rootfile"),"full-path");f=t(f);for(var g=f.next();!g.done;g=f.next())if(g=g.value){Xt(a,b,g,c).Ja(d);return}O(d,null)}else w.error("Received an empty response for EPUB container.xml "+
e+". This may be caused by the server not allowing cross origin requests.")});return d.result()}
function Xt(a,b,c,d){var e=b+c,f=a.G[e];if(f)return M(f);var g=L("loadOPF");a.g.load(e,void 0,void 0).then(function(c){c?a.g.load(b+"META-INF/encryption.xml",void 0,void 0).then(function(h){(d?a.F.load(b+"?r=list"):M(null)).then(function(d){f=new Yt(a,b);Zt(f,c,h,d,b+"?r=manifest").then(function(){a.G[e]=f;a.da[b]=f;O(g,f)})})}):w.error("Received an empty response for EPUB OPF "+e+". This may be caused by the server not allowing cross origin requests.")});return g.result()}
function $t(a,b,c){var d=L("EPUBDocStore.load");b=xa(b);(a.C[b]=Jt(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,Sd:null})).Ja(d);return d.result()}
Ut.prototype.load=function(a){var b=xa(a);if(a=this.C[b])return a.Wa()?a:M(a.get());var c=L("EPUBDocStore.load");a=Ut.hg.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?O(c,a):w.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return c.result()};function au(){this.id=null;this.src="";this.h=this.g=null;this.R=-1;this.l=0;this.u=null;this.f=this.b=0;this.zc=this.ub=null;this.j=$a}
function bu(a){return a.id}function cu(a){var b=Pt(a);return function(a){var c=L("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));uf(e).then(function(a){a=new DataView(a);for(var d=0;d<a.byteLength;d++){var e=a.getUint8(d),e=e^b[d%20];a.setUint8(d,e)}O(c,tf([a,f]))});return c.result()}}
...
function Yt(a,b){this.g=a;this.B=this.f=this.b=this.l=this.h=null;this.H=b;this.F=null;this.ba={};this.lang=null;this.j=0;this.G=this.O=!1;this.u=null;this.J={};this.da=this.Y=this.la=null;this.X={};this.N=null;this.C=lu(this);ju()&&(Gh["http://www.w3.org/1998/Math/MathML"]=!0)}
...
function nu(a){for(var b=0,c=t(a.b),d=c.next();!d.done;d=c.next()){var d=d.value,e=a.O?1:Math.ceil(d.l/1024);d.b=b;d.f=e;b+=e}a.j=b;a.u&&a.u(a.j)}function ou(a,b,c){a.G=b||a.O;a.u=c;if(a.G)return a.j||nu(a),M(!0);var d=0,e=0;b=L("estimatePageCount");Ce(function(b){if(e===a.b.length)Q(b);else{var c=a.b[e++];c.b=d;a.g.load(c.src).then(function(e){var f=1800,g=e.lang||a.lang;g&&g.match(/^(ja|ko|zh)/)&&(f/=3);c.f=Math.ceil(gk(e)/f);d+=c.f;a.j=d;a.u&&a.u(a.j);P(b)})}}).Ja(b);return b.result()}
...
function su(a,b){return ke("resolveEPage",function(c){if(0>=b)O(c,{R:0,Da:0,$:-1});else if(a.G){var d=a.b.findIndex(function(a){return!a.b&&!a.f||a.b<=b&&a.b+a.f>b}),e=a.b[d];e&&e.f||(e=a.b[--d]);O(c,{R:d,Da:-1,$:b-e.b})}else{var f=Xa(a.b.length,function(c){c=a.b[c];return c.b+c.f>b});f==a.b.length&&f--;var g=a.b[f];a.g.load(g.src).then(function(a){b-=g.b;b>g.f&&(b=g.f);var d=0;0<b&&(a=gk(a),d=Math.round(a*b/g.f),d==a&&d--);O(c,{R:f,Da:d,$:-1})})}},function(a,d){w.b(d,"Cannot resolve epage:",b);O(a,
null)})}function tu(a,b){var c=a.b[b.R];if(0>=b.Da)return M(c.b);if(a.G)return M(c.b+b.$);var d=L("getEPage");a.g.load(c.src).then(function(a){a=gk(a);O(d,c.b+Math.min(a,b.Da)*c.f/a)});return d.result()}function uu(a,b){return{page:a,position:{R:a.R,$:b,Da:a.offset}}}function vu(a,b,c,d,e){this.b=a;this.viewport=b;this.j=c;this.u=e;this.Pb=[];this.l=[];this.Z=xb(d);this.h=new Vr(b);this.f=new Wp(a.C)}function wu(a,b){var c=a.Pb[b.R];return c?c.hb[b.$]:null}n=vu.prototype;
n.ac=function(a){return this.b.N?this.b.N:(a=this.Pb[a?a.R:0])?a.fb.G:null};
function xu(a,b,c,d){c.I.style.display="none";c.I.style.visibility="visible";c.I.style.position="";c.I.style.top="";c.I.style.left="";c.I.setAttribute("data-vivliostyle-page-side",c.f);var e=b.hb[d];c.B=!b.item.R&&!d;b.hb[d]=c;if(a.b.G){if(!d&&0<b.item.R){var f=a.b.b[b.item.R-1];b.item.b=f.b+f.f}b.item.f=b.hb.length;a.b.j=a.b.b.reduce(function(a,b){return a+b.f},0);a.b.u&&a.b.u(a.b.j)}if(e)b.fb.viewport.f.replaceChild(c.I,e.I),eb(e,{type:"replaced",target:null,currentTarget:null,Vf:c});else{e=null;
if(0<d)e=b.hb[d-1].I.nextElementSibling;else for(f=b.item.R+1;f<a.Pb.length;f++){var g=a.Pb[f];if(g&&g.hb[0]){e=g.hb[0].I;break}}b.fb.viewport.f.insertBefore(c.I,e)}a.u({width:b.fb.la,height:b.fb.da},b.fb.Ca,b.item.R,b.fb.ba+d)}
function yu(a,b,c){var d=L("renderSinglePage"),e=zu(a,b,c);Dt(b.fb,e,c).then(function(f){var g=(c=f)?c.page-1:b.gb.length-1;xu(a,b,e,g);$p(a.f,e.R,g);f=null;if(c){var h=b.gb[c.page];b.gb[c.page]=c;h&&b.hb[c.page]&&(nl(c,h)||(f=yu(a,b,c)))}f||(f=M(!0));f.then(function(){var f=aq(a.f,e),h=0;Ce(function(b){h++;if(h>f.length)Q(b);else{var c=f[h-1];c.Rd=c.Rd.filter(function(a){return!a.md});c.Rd.length?Au(a,c.R).then(function(d){d?(Zp(a.f,c.Ge),bq(a.f,c.Rd),yu(a,d,d.gb[c.$]).then(function(c){var d=a.f;
d.b=d.F.pop();d=a.f;d.g=d.H.pop();d=c.Qd.position;d.R===e.R&&d.$===g&&(e=c.Qd.page);P(b)})):P(b)}):P(b)}}).then(function(){e.C=!c&&b.item.R===a.b.b.length-1;e.C&&dq(a.f,a.viewport);O(d,{Qd:uu(e,g),Wf:c})})})});return d.result()}function Bu(a,b){var c=a.$,d=-1;0>c?(d=a.Da,c=Xa(b.gb.length,function(a){return rt(b.fb,b.gb[a],!0)>d}),c=c===b.gb.length?b.complete?b.gb.length-1:Number.POSITIVE_INFINITY:c-1):c===Number.POSITIVE_INFINITY&&-1!==a.Da&&(d=a.Da);return{R:a.R,$:c,Da:d}}
function Cu(a,b,c){var d=L("findPage");Au(a,b.R).then(function(e){if(e){var f=null,g;Ce(function(d){var h=Bu(b,e);g=h.$;(f=e.hb[g])?Q(d):e.complete?(g=e.gb.length-1,f=e.hb[g],Q(d)):c?Du(a,h).then(function(a){a&&(f=a.page,g=a.position.$);Q(d)}):Ae(100).then(function(){P(d)})}).then(function(){O(d,uu(f,g))})}else O(d,null)});return d.result()}
function Du(a,b){var c=L("renderPage");Au(a,b.R).then(function(d){if(d){var e=Bu(b,d),f=e.$,g=e.Da,h=d.hb[f];h?O(c,uu(h,f)):Ce(function(b){if(f<d.gb.length)Q(b);else if(d.complete)f=d.gb.length-1,Q(b);else{var c=d.gb[d.gb.length-1];yu(a,d,c).then(function(a){var e=a.Qd.page;(c=a.Wf)?0<=g&&rt(d.fb,c)>g?(h=e,f=d.gb.length-2,Q(b)):P(b):(h=e,f=a.Qd.position.$,d.complete=!0,Q(b))})}}).then(function(){h=h||d.hb[f];var b=d.gb[f];h?O(c,uu(h,f)):yu(a,d,b).then(function(a){a.Wf||(d.complete=!0);O(c,a.Qd)})})}else O(c,
...
n.Ag=function(a,b){var c=wu(this,a);if(!c)return M(null);var d=Fu(this,c,a),e=this.nextPage(a,b);if(d)return e;var f=this;return e.ha(function(a){return a?a.page.f===c.f?e:f.nextPage(a.position,b):M(null)})};n.Dg=function(a,b){var c=wu(this,a);if(!c)return M(null);var d=Fu(this,c,a),e=this.Je(a,b),f=c.I.previousElementSibling;if(d){var g=this;return e.ha(function(a){return a?a.page.f===c.f||a.page.I!==f?e:g.Je(a.position,b):M(null)})}return e};
...
function Ju(a,b,c,d){w.debug("Navigate to",b);var e=mu(a.b,xa(b));if(!e){if(a.b.h&&b.match(/^#epubcfi\(/))e=mu(a.b,a.b.h.url);else if("#"===b.charAt(0)){var f=a.b.C.Eg(b);a.b.h?e=mu(a.b,f[0]):e=f[0];b=f[0]+(f[1]?"#"+f[1]:"")}if(null==e)return M(null)}var g=a.b.B[e];if(!g)return a.b.h&&e==mu(a.b,a.b.h.url)&&(e=b.indexOf("#"),0<=e)?Iu(a,b.substr(e+1),d):M(null);var h=L("navigateTo");Au(a,g.R).then(function(e){var f=jk(e.ca,b);f?Cu(a,{R:g.R,$:-1,Da:ek(e.ca,f)},d).Ja(h):c.R!==g.R?Cu(a,{R:g.R,$:0,Da:-1},
d).Ja(h):O(h,null)});return h.result()}
function zu(a,b,c){var d=b.fb.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.style.position="absolute";e.style.top="0";e.style.left="0";Xj||(e.style.visibility="hidden");d.h.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);var g=new Ck(e,f);g.R=b.item.R;g.position=c;g.offset=rt(b.fb,c);g.offset||(b=a.b.C.Me("",b.item.src),f.setAttribute("id",b),Fk(g,f,b));d!==a.viewport&&(a=ig(null,new of(Ab(a.viewport.width,
...
function Au(a,b){if(b>=a.b.b.length)return M(null);var c=a.Pb[b];if(c)return M(c);var d=L("getPageViewItem"),e=a.l[b];if(e){var f=ue(d);e.push(f);return d.result()}var e=a.l[b]=[],g=a.b.b[b],h=a.b.g;h.load(g.src).then(function(f){var k=h.f[f.url],l=a.Be(f),p=a.viewport,q=nt(k,p.width,p.height,p.fontSize,a.Z);if(q.width!=p.width||q.height!=p.height||q.fontSize!=p.fontSize)p=new Xr(p.window,q.fontSize,p.root,q.width,q.height);q=a.Pb[b-1];null!==g.ub?q=g.ub-1:(q=!(0<b)||q&&q.complete?q?q.fb.ba+q.hb.length:
0:g.b||b,null!==g.zc&&(q+=g.zc));Xp(a.f,q);var r=new ot(k,f,a.b.lang,p,a.h,a.j,l,a.b.X,q,a.b.C,a.f,a.b.N);r.Z=a.Z;pt(r).then(function(){c={item:g,ca:f,fb:r,gb:[null],hb:[],complete:!1};a.Pb[b]=c;O(d,c);e.forEach(function(a){a.qb(c)})})});return d.result()}function Mu(a){for(var b=t(a.Pb),c=b.next();!c.done;c=b.next())(c=c.value)&&c.hb.splice(0);for(a=a.viewport.root;a.lastChild;)a.removeChild(a.lastChild)}function Nu(a){return a.Pb.some(function(a){return a&&0<a.hb.length})}
...
function Uu(a,b){Vu(a);var c;b?c=ru(a.h,b).ha(function(b){a.f=b;return M(!0)}):c=M(!0);return c.ha(function(){Tu.b("beforeRender");return Wu(a)})}function Xu(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d)return c*Lb.ex*a.fontSize/Lb.em;if(d=Lb[d])return c*d}return c}
...
function Zu(a,b,c){a.cc=!1;av(a);if(a.Z.tb)return Gu(a.b,a.f,c).ha(function(c){bv(a);a.j=c;c.left&&(cv(a,c.left),c.right?c.left.I.removeAttribute("data-vivliostyle-unpaired-page"):c.left.I.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(cv(a,c.right),c.left?c.right.I.removeAttribute("data-vivliostyle-unpaired-page"):c.right.I.setAttribute("data-vivliostyle-unpaired-page",!0));c=kv(a,c);a.viewport.zoom(c.width,c.height,a.F?lv(a,c):a.zoom);a.g=b;return M(null)});dv(a,b);a.viewport.zoom(b.g.width,
...
function fv(a,b,c){var d=L("sendLocationNotification"),e={t:"nav",first:b.B,last:b.C};tu(a.h,a.f).then(function(b){e.epage=b;e.epageCount=a.h.j;c&&(e.cfi=c);Ru(a,e);O(d,!0)});return d.result()}Pu.prototype.ac=function(){return this.b?this.b.ac(this.f):null};
...
function Ov(a,b,c,d,e){var f=c.A,g=c.A.ownerDocument.createElement("div");f.appendChild(g);var h=new Fm(e,g,c),l=h.ya.g;h.ya.g=null;a.h=!0;return Im(h,new hl(b)).ha(function(){a.h=!1;f.removeChild(g);if(f)for(;g.firstChild;){var b=g.firstChild;g.removeChild(b);b.setAttribute("data-adapt-spec","1");d?f.insertBefore(b,d):f.appendChild(b)}h.ya.g=l;return M(!0)})}Uv.prototype.b=function(a){var b=0;if(a&&!this.f(a))return b;if(!this.vc||a&&Xv(this,a))b+=this.G;this.wc||(b+=this.H);return b};
...
function cx(a,b){var c=a.D,d=bx(a),e=d.reduce(function(a){return a+1},0);if(0===e)return M(!0);var f=a.f.j,g=b.w;g.A.parentNode.removeChild(g.A);var h=L("layoutRowSpanningCellsFromPreviousFragment"),l=M(!0),k=0,m=[];d.forEach(function(a){var b=this;l=l.ha(function(){var d=Uk(a[0].Bd.pa[1],g.parent);return xo(f,d,!1).ha(function(){function g(a){for(;l<a;){if(!m.includes(l)){var b=d.A.ownerDocument.createElement("td");x(b,"padding","0");d.A.appendChild(b)}l++}}var h=M(!0),l=0;a.forEach(function(a){var b=
this;h=h.ha(function(){var c=a.Xb;g(c.b.Qa);var h=a.Bd,p=Uk(h.pa[0],d);p.na=h.na;p.K=h.K;p.Ra=h.pa[0].Ra+1;return xo(f,p,!1).ha(function(){for(var d=a.Bf,f=0;f<c.f;f++)m.push(l+f);l+=c.f;return $w(b,c,p,d).ha(function(){p.A.rowSpan=c.rowIndex+c.rowSpan-b.b+e-k;return M(!0)})})})},b);return h.ha(function(){g(Nw(c));k++;return M(!0)})})})},a);l.then(function(){xo(f,g,!0,b.yd).then(function(){O(h,!0)})});return h.result()}
function dx(a,b){if(a.j||a.h)return M(!0);var c=b.w,d=a.D;0>a.b?a.b=Hw(d,c.M):a.b++;a.g=0;a.l=!0;return cx(a,b).ha(function(){ex(a);rp(a.f,b.dd,null,!0,b.Xc)&&!Gw(d,a.b-1).length&&(a.f.u=a.u,c.wa=!0,b.Ob=!0);return M(!0)})}function ex(a){a.D.g[a.b].b.forEach(function(b){var c=a.D.h[b.Qa];c&&c.Xb.b.Qa==b.b.Qa&&(b=c.Bd.pa[0],c=ek(a.f.j.ca,b.node),Br(c,b.Ra+1,1))})}
function fx(a,b){if(a.j||a.h)return M(!0);var c=b.w;a.l||(0>a.b?a.b=0:a.b++,a.g=0,a.l=!0);var d=a.D.g[a.b].b[a.g],e=Wk(c).modify();e.K=!0;b.w=e;var f=L("startTableCell");ax(a,d.b.Qa)?(e=a.D.h.shift(),c.Ra=e.Bd.pa[0].Ra+1,e=M(e.Bf)):e=Do(a.f,c,b.yd).ha(function(a){a.A&&c.A.removeChild(a.A);return M(new hl(Sk(a)))});e.then(function(e){$w(a,d,c,e).then(function(){a.mc(b);a.g++;O(f,!0)})});return f.result()}
...
function getViewerOptionsFromURL() {
    ...
    var isEpub = _storesUrlParameters2["default"].getParameter("b").length && !_storesUrlParameters2["default"].getParameter("x").length;
    return {
...
var Navigation = (function () {
    function Navigation(viewerOptions, viewer, settingsPanel, navigationOptions) {
        ...
        this.pageNumber = _knockout2["default"].pureComputed({
            ...
            write: function write(pageNumberText) {
                ...
                var elem = document.getElementById('vivliostyle-page-number');
                ...
                setTimeout(function () {
                    if (_this2.viewer_.state.status() != _modelsVivliostyle2["default"].constants.ReadyState.LOADING && _this2.viewer_.epage() === epageOld) {
                        elem.value = _this2.viewer_.epageToPageNumber(epageOld);
                    }
                    elem.blur();
                }, 10);
            },
    ...
    _createClass(Navigation, [{
        ...
        value: function handleKey(key) {
            var isInputActive = document.activeElement && document.activeElement.tagName.toLowerCase() === 'input';
            switch (key) {
