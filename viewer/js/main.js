...
m.evaluate=function(a){var b;b=(b=a.B[this.b.j])?b[this.f]:void 0;if("undefined"!=typeof b)return b;b=this.Ha(a);var c=this.f,d=this.b,e=a.B[d.j];e||(e={},a.B[d.j]=e);return e[c]=b};m.Yc=function(){return!1};function yc(a,b){C.call(this,a);this.d=b}t(yc,C);m=yc.prototype;m.Uc=function(){throw Error("F_ABSTRACT");};m.Wc=function(){throw Error("F_ABSTRACT");};m.Ha=function(a){a=this.d.evaluate(a);return this.Wc(a)};m.kb=function(a,b,c){return a===this||xc(this.d,a,b,c)};
...
function ad(a,b,c){return b===a.f||b===a.b||c==a.f||c==a.b?a.f:b===a.g||b===a.d?c:c===a.g||c===a.d?b:new Fc(a,b,c)}function E(a,b,c){return b===a.b?c:c===a.b?b:new Pc(a,b,c)}function G(a,b,c){return b===a.b?new Ec(a,c):c===a.b?b:new Qc(a,b,c)}function bd(a,b,c){return b===a.b||c===a.b?a.b:b===a.d?c:c===a.d?b:new Rc(a,b,c)}function cd(a,b,c){return b===a.b?a.b:c===a.d?b:new Sc(a,b,c)};var dd={};function ed(){}m=ed.prototype;m.jb=function(a){for(var b=0;b<a.length;b++)a[b].R(this)};m.Pc=function(){throw Error("E_CSS_EMPTY_NOT_ALLOWED");};m.Qc=function(){throw Error("E_CSS_SLASH_NOT_ALLOWED");};m.Nb=function(){throw Error("E_CSS_STR_NOT_ALLOWED");};m.ib=function(){throw Error("E_CSS_IDENT_NOT_ALLOWED");};m.zb=function(){throw Error("E_CSS_NUMERIC_NOT_ALLOWED");};m.yb=function(){throw Error("E_CSS_NUM_NOT_ALLOWED");};m.xb=function(a){return this.yb(a)};
...
m.jb=function(a){for(var b=null,c=0;c<a.length;c++){var d=a[c],e=d.R(this);if(b)b[c]=e;else if(d!==e){b=Array(a.length);for(d=0;d<c;d++)b[d]=a[d];b[c]=e}}return b||a};m.Nb=function(a){return a};m.ib=function(a){return a};m.Qc=function(a){return a};m.zb=function(a){return a};m.yb=function(a){return a};m.xb=function(a){return a};m.mc=function(a){return a};m.Ob=function(a){return a};m.Xa=function(a){var b=this.jb(a.values);return b===a.values?a:new gd(b)};
m.nb=function(a){var b=this.jb(a.values);return b===a.values?a:new hd(b)};m.ob=function(a){var b=this.jb(a.values);return b===a.values?a:new id(a.name,b)};m.wb=function(a){return a};function jd(){}m=jd.prototype;m.toString=function(){var a=new Pa;this.wa(a,!0);return a.toString()};m.stringValue=function(){var a=new Pa;this.wa(a,!1);return a.toString()};m.ea=function(){throw Error("F_ABSTRACT");};m.wa=function(a){a.append("[error]")};m.Xc=function(){return!1};m.Fc=function(){return!1};m.Zc=function(){return!1};
m.od=function(){return!1};m.$c=function(){return!1};function kd(){if(H)throw Error("E_INVALID_CALL");}t(kd,jd);kd.prototype.ea=function(a){return new B(a,"")};kd.prototype.wa=function(){};kd.prototype.R=function(a){return a.Pc(this)};var H=new kd;function ld(){if(md)throw Error("E_INVALID_CALL");}t(ld,jd);ld.prototype.ea=function(a){return new B(a,"/")};ld.prototype.wa=function(a){a.append("/")};ld.prototype.R=function(a){return a.Qc(this)};var md=new ld;function nd(a){this.b=a}t(nd,jd);
...
function sd(a){this.url=a}t(sd,jd);sd.prototype.wa=function(a){a.append('url("');a.append(Sa(this.url));a.append('")')};sd.prototype.R=function(a){return a.Ob(this)};function td(a,b,c,d){var e=b.length;b[0].wa(a,d);for(var f=1;f<e;f++)a.append(c),b[f].wa(a,d)}function gd(a){this.values=a}t(gd,jd);gd.prototype.wa=function(a,b){td(a,this.values," ",b)};gd.prototype.R=function(a){return a.Xa(this)};gd.prototype.$c=function(){return!0};function hd(a){this.values=a}t(hd,jd);
...
L.prototype.Xc=function(){return!0};function ud(a,b){if(a){if(a.Fc())return tc(b,a.ia,!1)*a.C;if(a.Zc())return a.C}return 0}var vd=J("absolute"),wd=J("all"),xd=J("always"),yd=J("auto");J("avoid");
...
h=l}f.b[h]=g}var h=c,n=h.d;h.d=null;n&&n.e==h&&(n.e=null,l=Re,Re=n,Q(n.top,h.e),Re=l);b=a.e.currentTime();if(b>=a.h)break}}catch(p){u.error(p)}a.g=!1;a.d.length()&&cf(a)},b)}}$e.prototype.Va=function(a,b){var c=this.e.currentTime();a.N=this.N++;a.b=c+(b||0);a:{for(var c=this.d,d=c.b.length;1<d;){var e=Math.floor(d/2),f=c.b[e];if(0<df(f,a)){c.b[d]=a;break a}c.b[d]=f;d=e}c.b[1]=a}cf(this)};
function Ze(a,b,c){var d=new ef(a,c||"");d.top=new Te(d,null,"bootstrap");d.top.b=Ue;d.top.then(function(){function a(){d.h=!1;for(var b=0;b<d.g.length;b++){var c=d.g[b];try{c()}catch(e){u.error(e)}}}try{b().then(function(b){d.f=b;a()})}catch(c){Xe(d,c),a()}});c=Re;Re=d;a.Va(ff(d.top,"bootstrap"));Re=c;return d}function gf(a){this.d=a;this.N=this.b=0;this.e=null}function df(a,b){return b.b-a.b||b.N-a.N}gf.prototype.Va=function(a,b){this.e=a;this.d.d.Va(this,b)};
function ef(a,b){this.d=a;this.name=b;this.g=[];this.b=null;this.h=!0;this.e=this.top=this.j=this.f=null}function hf(a,b){a.g.push(b)}ef.prototype.join=function(){var a=M("Task.join");if(this.h){var b=ff(a,this),c=this;hf(this,function(){b.Va(c.f)})}else Q(a,this.f);return O(a)};
function Xe(a,b,c){var d=b.frameTrace;if(!d){for(var d=b.stack?b.stack+"\n\t---- async ---\n":"",e=a.top;e;e=e.parent)d+="\t",d+=e.name,d+="\n";b.frameTrace=d}if(c){for(d=a.top;d&&d!=c;)d=d.parent;d==c&&(a.top=d)}for(a.b=b;a.top&&!a.top.g;)a.top=a.top.parent;a.top?(b=a.b,a.b=null,a.top.g(a.top,b)):a.b&&u.error(a.b,"Unhandled exception in task",a.name)}function Ve(a){this.value=a}m=Ve.prototype;m.then=function(a){a(this.value)};m.kc=function(a){return a(this.value)};m.ed=function(a){return new Ve(a)};
m.oa=function(a){Q(a,this.value)};m.ya=function(){return!1};m.Wb=function(){return this.value};function jf(a){this.b=a}m=jf.prototype;m.then=function(a){this.b.then(a)};m.kc=function(a){if(this.ya()){var b=new Te(this.b.d,this.b.parent,"AsyncResult.thenAsync");b.b=Ue;this.b.parent=b;this.b.then(function(c){a(c).then(function(a){Q(b,a)})});return O(b)}return a(this.b.e)};m.ed=function(a){return this.ya()?this.kc(function(){return new Ve(a)}):new Ve(a)};
...
function lf(){var a=M("Frame.timeSlice"),b=a.d.d;b.e.currentTime()>=b.h?(u.d("-- time slice --"),ff(a).Va(!0)):Q(a,!0);return O(a)}function mf(a){function b(d){try{for(;d;){var e=a();if(e.ya()){e.then(b);return}e.then(function(a){d=a})}Q(c,!0)}catch(f){Xe(c.d,f,c)}}var c=M("Frame.loop");b(!0);return O(c)}function nf(a){var b=Re;if(!b)throw Error("E_TASK_NO_CONTEXT");return mf(function(){var c;do c=new of(b,b.top),b.top=c,c.b=Ue,a(c),c=O(c);while(!c.ya()&&c.Wb());return c})}
...
f.la(),a.b=If));A(g);continue;case 49:if(Wf(a,11,h))if(a.d||3!=a.f)Vf(a,"E_CSS_UNEXPECTED_SEMICOL",h);else return a.j=k.pop(),a.w=!0,a.b=If,A(g),!1;A(g);continue;case 40:k.push(h.type);A(g);continue;case 27:a.b=If;A(g);f.Ta();a.e.length&&a.e.pop();continue;case 30:l=h.text.toLowerCase();switch(l){case "import":A(g);h=x(g);if(2==h.type||8==h.type){a.D=h.text;A(g);h=x(g);if(17==h.type||0==h.type)return a.w=!0,A(g),!1;a.d=null;a.f=3;a.b=Nf;k.push("{");continue}f.error("E_CSS_IMPORT_SYNTAX",h);a.b=Of;
...
var fg={"z-index":!0,"column-count":!0,"flow-linger":!0,opacity:!0,page:!0,"flow-priority":!0,utilization:!0};function gg(a,b,c){if(b.Xc())a:{b=b.d;a=b.evaluate(a);switch(typeof a){case "number":c=fg[c]?a==Math.round(a)?new qd(a):new pd(a):new K(a,"px");break a;case "string":c=a?eg(b.b,new ac(a,null)):H;break a;case "boolean":c=a?he:Fd;break a;case "undefined":c=H;break a}throw Error("E_UNEXPECTED");}else c=b;return c};function hg(){this.b={}}t(hg,ed);hg.prototype.ib=function(a){this.b[a.name]=!0;return a};hg.prototype.Xa=function(a){this.jb(a.values);return a};function ig(a){this.value=a}t(ig,ed);ig.prototype.xb=function(a){this.value=a.C;return a};function jg(a,b){if(a){var c=new ig(b);try{return a.R(c),c.value}catch(d){u.b(d,"toInt: ")}}return b}function kg(){this.d=!1;this.b=[];this.name=null}t(kg,ed);kg.prototype.zb=function(a){this.d&&this.b.push(a);return null};
kg.prototype.yb=function(a){this.d&&0==a.C&&this.b.push(new K(0,"px"));return null};kg.prototype.Xa=function(a){this.jb(a.values);return null};kg.prototype.ob=function(a){this.d||(this.d=!0,this.jb(a.values),this.d=!1,this.name=a.name.toLowerCase());return null};
...
function qg(a,b){var c=null,d=null;"img"==a.localName&&(c=a.getAttribute("width"),d=a.getAttribute("height"));var e=new wf(function(){function e(b){"img"==a.localName&&(c||a.removeAttribute("width"),d||a.removeAttribute("height"));k.Va(b?b.type:"timeout")}var g=M("loadImage"),k=ff(g,a);a.addEventListener("load",e,!1);a.addEventListener("error",e,!1);a.addEventListener("abort",e,!1);"http://www.w3.org/2000/svg"==a.namespaceURI?(a.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",b),setTimeout(e,
...
f.f}}return f===a.b&&(c?0<e.length:g==b.length)?e:null}m=Bg.prototype;m.Oa=function(a){for(var b=null,c=this.d;c!==this.b&&c!==this.e;)a?0!=c.b?c=c.e:(b=a.R(c.d))?(a=null,c=c.e):c=c.f:c=c.f;return c===this.b?b:null};m.Pc=function(a){return this.Oa(a)};m.Qc=function(a){return this.Oa(a)};m.Nb=function(a){return this.Oa(a)};m.ib=function(a){return this.Oa(a)};m.zb=function(a){return this.Oa(a)};m.yb=function(a){return this.Oa(a)};m.xb=function(a){return this.Oa(a)};m.mc=function(a){return this.Oa(a)};
m.Ob=function(a){return this.Oa(a)};m.Xa=function(){return null};m.nb=function(){return null};m.ob=function(a){return this.Oa(a)};m.wb=function(){return null};function Eg(a){Bg.call(this,a)}t(Eg,Bg);Eg.prototype.Xa=function(a){var b=Cg(this,a.values,!1,0);return b===a.values?a:b?new gd(b):null};Eg.prototype.f=function(a,b){return Cg(this,a,!0,b)};function Dg(a){Bg.call(this,a)}t(Dg,Bg);Dg.prototype.Xa=function(a){return this.Oa(a)};
Dg.prototype.nb=function(a){var b=Cg(this,a.values,!1,0);return b===a.values?a:b?new hd(b):null};function Fg(a,b){Bg.call(this,b);this.name=a}t(Fg,Bg);Fg.prototype.Oa=function(){return null};Fg.prototype.ob=function(a){if(a.name.toLowerCase()!=this.name)return null;var b=Cg(this,a.values,!1,0);return b===a.values?a:b?new id(a.name,b):null};function Gg(){}Gg.prototype.b=function(a,b){return b};Gg.prototype.e=function(){};
...
Jg.prototype.b=function(a,b,c){var d=b;if(this.cd)if(a[b]==md){if(++b==a.length)return d}else return d;var e=this.d[0].b(a,b,c);if(e==b)return d;b=e;for(d=1;d<this.d.length&&b<a.length;d++){e=this.d[d].b(a,b,c);if(e==b)break;b=e}return b};function Kg(){this.b=this.Ma=null;this.error=!1;this.values={};this.d=null}m=Kg.prototype;m.vd=function(a){return new Hg(this.d,a,!1)};m.clone=function(){var a=new this.constructor;a.Ma=this.Ma;a.b=this.b;a.d=this.d;return a};
m.Tc=function(a,b){this.Ma=a;this.b=b};m.pb=function(){this.error=!0;return 0};function Lg(a,b){a.pb([b]);return null}m.Pc=function(a){return Lg(this,a)};m.Nb=function(a){return Lg(this,a)};m.ib=function(a){return Lg(this,a)};m.zb=function(a){return Lg(this,a)};m.yb=function(a){return Lg(this,a)};m.xb=function(a){return Lg(this,a)};m.mc=function(a){return Lg(this,a)};m.Ob=function(a){return Lg(this,a)};m.Xa=function(a){this.pb(a.values);return null};m.nb=function(){this.error=!0;return null};
m.ob=function(a){return Lg(this,a)};m.wb=function(){this.error=!0;return null};function Mg(){Kg.call(this)}t(Mg,Kg);Mg.prototype.pb=function(a){for(var b=0,c=0;b<a.length;){var d=this.Ma[c].b(a,b,this);if(d>b)b=d,c=0;else if(++c==this.Ma.length){this.error=!0;break}}return b};function Ng(){Kg.call(this)}t(Ng,Kg);
Ng.prototype.pb=function(a){if(a.length>this.Ma.length||0==a.length)return this.error=!0,0;for(var b=0;b<this.Ma.length;b++){for(var c=b;c>=a.length;)c=1==c?0:c-2;if(this.Ma[b].b(a,c,this)!=c+1)return this.error=!0,0}return a.length};function Og(){Kg.call(this)}t(Og,Kg);
Og.prototype.pb=function(a){for(var b=a.length,c=0;c<a.length;c++)if(a[c]===md){b=c;break}if(b>this.Ma.length||0==a.length)return this.error=!0,0;for(c=0;c<this.Ma.length;c++){for(var d=c;d>=b;)d=1==d?0:d-2;var e;if(b+1<a.length)for(e=b+c+1;e>=a.length;)e-=e==b+2?1:2;else e=d;if(2!=this.Ma[c].b([a[d],a[e]],0,this))return this.error=!0,0}return a.length};function Pg(){Kg.call(this)}t(Pg,Mg);Pg.prototype.vd=function(a){return new Hg(this.d,a,!0)};
...
Qg.prototype.nb=function(a){a.values[0].R(this);if(this.error)return null;for(var b=[this.values["font-family"]],c=1;c<a.values.length;c++)b.push(a.values[c]);a=new hd(b);a.R(this.d.e["font-family"])?this.values["font-family"]=a:this.error=!0;return null};Qg.prototype.ib=function(a){if(a=this.d.d[a.name])for(var b in a)this.values[b]=a[b];else this.error=!0;return null};var Rg={SIMPLE:Mg,INSETS:Ng,INSETS_SLASH:Og,COMMA:Pg,FONT:Qg};
...
function Xg(a){a.b.HASHCOLOR=Vg(new yg(64,U,U));a.b.POS_INT=Vg(new yg(32,U,U));a.b.POS_NUM=Vg(new yg(16,U,U));a.b.POS_PERCENTAGE=Vg(new yg(8,U,{"%":H}));a.b.NEGATIVE=Vg(new yg(256,U,U));a.b.ZERO=Vg(new yg(512,U,U));a.b.ZERO_PERCENTAGE=Vg(new yg(1024,U,U));a.b.POS_LENGTH=Vg(new yg(8,U,{em:H,ex:H,ch:H,rem:H,vh:H,vw:H,vmin:H,vmax:H,cm:H,mm:H,"in":H,px:H,pt:H,pc:H,q:H}));a.b.POS_ANGLE=Vg(new yg(8,U,{deg:H,grad:H,rad:H,turn:H}));a.b.POS_TIME=Vg(new yg(8,U,{s:H,ms:H}));a.b.FREQUENCY=Vg(new yg(8,U,{Hz:H,
kHz:H}));a.b.RESOLUTION=Vg(new yg(8,U,{dpi:H,dpcm:H,dppx:H}));a.b.URI=Vg(new yg(128,U,U));a.b.IDENT=Vg(new yg(4,U,U));a.b.STRING=Vg(new yg(2,U,U));var b={"font-family":J("sans-serif")};a.d.caption=b;a.d.icon=b;a.d.menu=b;a.d["message-box"]=b;a.d["small-caption"]=b;a.d["status-bar"]=b}function Yg(a){return!!a.match(/^[A-Z_0-9]+$/)}
...
d.push(p.clone())}else p={},p[g.text]=J(g.text),d.push(Vg(new yg(0,p,U)));k=!1;break;case 5:p={};p[""+g.C]=new qd(g.C);d.push(Vg(new yg(0,p,U)));k=!1;break;case 34:l("|");break;case 25:l("||");break;case 14:k||l(" ");e.push({fd:d,bd:f,tc:"["});f="";d=[];k=!0;break;case 6:k||l(" ");e.push({fd:d,bd:f,tc:"(",sb:g.text});f="";d=[];k=!0;break;case 15:g=h();p=e.pop();if("["!=p.tc)throw Error("']' unexpected");d=p.fd;d.push(g);f=p.bd;k=!1;break;case 11:g=h();p=e.pop();if("("!=p.tc)throw Error("')' unexpected");
...
if(5!=g.type)throw Error("<int> expected");q=g.C;A(b);g=x(b)}if(13!=g.type)throw Error("'}' expected");d.push(Ug(d.pop(),p,q));break;case 17:n=h();if(0<e.length)throw Error("unclosed '"+e.pop().tc+"'");break;default:throw Error("unexpected token");}A(b);Yg(c)?a.b[c]=n:a.e[c]=1!=n.b.length||0!=n.b[0].b?new Eg(n):n.b[0].d}}
...
c[0]}for(;;){var h=Zg(d,f,3);if(!h)break;var l=z(f,1),n;1==l.type&&Rg[l.text]?(n=new Rg[l.text],A(f)):n=new Mg;n.d=d;g=!1;k=[];c=!1;for(var p=[],q=[];!g;)switch(A(f),l=x(f),l.type){case 1:if(d.e[l.text])k.push(n.vd(l.text)),q.push(l.text);else if(d.f[l.text]instanceof Ng){var r=d.f[l.text];k.push(new Ig(r.d,r.b));q.push.apply(q,r.b)}else throw Error("'"+l.text+"' is neither a simple property nor an inset shorthand");break;case 19:if(0<k.length||c)throw Error("unexpected slash");c=!0;break;case 14:p.push({cd:c,
Ma:k});k=[];c=!1;break;case 15:var v=new Jg(k,c),y=p.pop(),k=y.Ma;c=y.cd;k.push(v);break;case 17:g=!0;A(f);break;default:throw Error("unexpected token");}n.Tc(k,q);d.f[h]=n}d.g=ah(d,["background"]);d.j=ah(d,"margin border padding columns column-gap column-rule column-fill".split(" "))}else u.error("Error: missing",b)}catch(I){u.error(I,"Error:")}Q(a,d)});return O(a)},"validatorFetcher");var dh={"font-style":Sd,"font-variant":Sd,"font-weight":Sd},eh="OTTO"+(new Date).valueOf(),fh=1;function gh(a){a=this.lb=a;var b=new Pa,c;for(c in dh)b.append(" "),b.append(a[c].toString());this.d=b.toString();this.src=this.lb.src?this.lb.src.toString():null;this.e=[];this.f=[];this.b=(c=this.lb["font-family"])?c.stringValue():null}
...
var xh={Vd:"text/html",Wd:"text/xml",Od:"application/xml",Nd:"application/xhtml_xml",Qd:"image/svg+xml"};function yh(a,b,c){c=c||new DOMParser;var d;try{d=c.parseFromString(a,b)}catch(e){}if(d){a=d.documentElement;if("parsererror"===a.localName)return null;for(a=a.firstChild;a;a=a.nextSibling)if("parsererror"===a.localName)return null}else return null;return d}
...
Cj.prototype.ib=function(a){var b=this.b,c=b.B,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.l)];b.l++;break;case "close-quote":return 0<b.l&&b.l--,c[2*Math.min(d,b.l)+1];case "no-open-quote":return b.l++,new nd("");case "no-close-quote":return 0<b.l&&b.l--,new nd("")}return a};
...
Fj={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},Gj={Zd:!1,Ab:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",ac:"\u5341\u767e\u5343",Dd:"\u8ca0"};
function Hj(a){if(9999<a||-9999>a)return""+a;if(0==a)return Gj.Ab.charAt(0);var b=new Pa;0>a&&(b.append(Gj.Dd),a=-a);if(10>a)b.append(Gj.Ab.charAt(a));else if(Gj.$d&&19>=a)b.append(Gj.ac.charAt(0)),0!=a&&b.append(Gj.ac.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(Gj.Ab.charAt(c)),b.append(Gj.ac.charAt(2)));if(c=Math.floor(a/100)%10)b.append(Gj.Ab.charAt(c)),b.append(Gj.ac.charAt(1));if(c=Math.floor(a/10)%10)b.append(Gj.Ab.charAt(c)),b.append(Gj.ac.charAt(0));(a%=10)&&b.append(Gj.Ab.charAt(a))}return b.toString()}
...
function Jj(a,b){var c=b[0].toString(),d=1<b.length?b[1].stringValue():"decimal",e=a.b.g[c];if(e&&e.length)return new nd(Ij(e&&e.length&&e[e.length-1]||0,d));c=new L(Kj(a.b.Ga,c,function(a){return Ij(a||0,d)}));return new gd([c])}
function Lj(a,b){var c=b[0].toString(),d=b[1].stringValue(),e=2<b.length?b[2].stringValue():"decimal",f=a.b.g[c],g=new Pa;if(f&&f.length)for(var k=0;k<f.length;k++)0<k&&g.append(d),g.append(Ij(f[k],e));c=new L(Mj(a.b.Ga,c,function(a){var b=[];if(a.length)for(var c=0;c<a.length;c++)b.push(Ij(a[c],e));a=g.toString();a.length&&b.push(a);return b.length?b.join(d):Ij(0,e)}));return new gd([c])}
...
function Qj(a,b,c){this.j=a;this.d=b;this.Ga=c;this.b=[[],[]];this.h={};this.u=this.w=this.e=null;this.$=this.fa=this.M=this.k=this.f="";this.I=this.D=null;this.Fa=this.ma=!0;this.g={};this.A=[{}];this.B=[new nd("\u201c"),new nd("\u201d"),new nd("\u2018"),new nd("\u2019")];this.l=0;this.lang="";this.Sa=[0];this.pa=0;this.va=[]}function uj(a,b){a.h[b]=(a.h[b]||0)+1}function Rj(a,b,c){(b=b[c])&&b.apply(a)}var Sj=[];
...
1]),0));a.A.push(null)}function Xj(a){var b=a.A.pop();if(b)for(var c in b)(b=a.g[c])&&(1==b.length?delete a.g[c]:b.pop())}function zj(a,b,c){Wj(a,b);b.content&&(b.content=b.content.xc(new Cj(a,c)));Xj(a)}var Yj="before transclusion-before footnote-call footnote-marker inner first-letter first-line  transclusion-after after".split(" ");
...
"lang"))||"http://www.w3.org/1999/xhtml"!=a.k||(d=b.getAttribute("lang"));d&&(a.b[a.b.length-1].push(new Aj(a.lang)),a.lang=d.toLowerCase());d=a.Sa;a.pa=++d[d.length-1];d.push([0]);Uj(a);d=c.quotes;c=null;d&&(d=d.evaluate(a.d))&&(c=new Bj(a.B),d===Rd?a.B=[new nd(""),new nd("")]:d instanceof gd&&(a.B=d.values));Wj(a,a.w);if(d=a.w._pseudos)for(var e=!0,f=0;f<Yj.length;f++){var g=Yj[f];g||(e=!1);(g=d[g])&&(e?zj(a,g,b):a.b[a.b.length-2].push(new yj(g,b)))}c&&a.b[a.b.length-2].push(c)}
...
Qj.prototype.pop=function(){for(var a=1;-1<=a;--a)for(var b=this.b[this.b.length-a-2],c=0;c<b.length;)b[c].pop(this,a)?b.splice(c,1):c++;this.b.pop();this.ma=!1};var ak=null;function bk(a,b,c,d,e,f,g){Ef.call(this,a,b,g);this.b=null;this.d=0;this.k=null;this.w=0;this.g=null;this.l=!1;this.J=c;this.h=d?d.h:ak?ak.clone():new Pj;this.B=e;this.u=f;this.j=0}t(bk,Ff);m=bk.prototype;m.nd=function(a){ej(this.h.Mb,"*",a)};
function ck(a,b){var c=a.b;if(0<c.length){c.sort(function(a,b){return b.d()-a.d()});for(var d=null,e=c.length-1;0<=e;e--)d=c[e],d.b=b,b=d;if(d.e(a.h))return}a.nd(b)}m.$a=function(a,b){if(b||a)this.d+=1,b&&a?this.b.push(new hj(a,b.toLowerCase())):b?this.b.push(new gj(b.toLowerCase())):this.b.push(new jj(a))};m.vc=function(a){this.g?(u.b("::"+this.g,"followed by ."+a),this.b.push(new sj(""))):(this.d+=256,this.b.push(new dj(a)))};
...
!0;break;case "visited":case "active":case "hover":case "focus":this.b.push(new sj(""));break;case "lang":b&&1==b.length&&"string"==typeof b[0]?this.b.push(new oj(new RegExp("^"+ua(b[0].toLowerCase())+"($|-)"))):this.b.push(new sj(""));break;case "nth-child":b&&1==b.length&&"number"==typeof b[0]?this.b.push(new rj(b[0])):this.b.push(new sj(""));break;case "before":case "after":case "first-line":case "first-letter":this.Hb(a,b);return;default:u.b("unknown pseudo-class selector: "+a),this.b.push(new sj(""))}this.d+=
256}};
m.Hb=function(a,b){switch(a){case "before":case "after":case "first-line":case "first-letter":case "footnote-call":case "footnote-marker":case "inner":this.g?(u.b("Double pseudoelement ::"+this.g+"::"+a),this.b.push(new sj(""))):this.g=a;break;case "first-n-lines":if(b&&1==b.length&&"number"==typeof b[0]){var c=Math.round(b[0]);if(0<c&&c==b[0]){this.g?(u.b("Double pseudoelement ::"+this.g+"::"+a),this.b.push(new sj(""))):this.g="first-"+c+"-lines";break}}default:u.b("Unrecognized pseudoelement: ::"+a),
this.b.push(new sj(""))}this.d+=1};m.Bc=function(a){this.d+=65536;this.b.push(new fj(a))};
...
m.bb=function(){var a="d"+this.w++;ck(this,new bj(new tj(a)));this.b=[new sj(a)]};m.uc=function(){var a="c"+this.w++;ck(this,new bj(new vj(a)));this.b=[new sj(a)]};m.sc=function(){var a="a"+this.w++;ck(this,new bj(new wj(a)));this.b=[new sj(a)]};m.yc=function(){var a="f"+this.w++;ck(this,new bj(new xj(a)));this.b=[new sj(a)]};m.Hc=function(){dk(this);this.g=null;this.l=!1;this.d=0;this.b=[]};
m.hb=function(){var a;0!=this.j?(Hf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.j=1,this.k={},this.g=null,this.d=0,this.l=!1,this.b=[])};m.error=function(a,b){Ff.prototype.error.call(this,a,b);1==this.j&&(this.j=0)};m.vb=function(a){Ff.prototype.vb.call(this,a);this.j=0};m.la=function(){dk(this);Ff.prototype.la.call(this);1==this.j&&(this.j=0)};m.Ta=function(){Ff.prototype.Ta.call(this)};function dk(a){if(a.b){var b=a.d,c;c=a.h;c=c.N+=Nj;ck(a,a.pd(b+c));a.b=null;a.g=null;a.l=!1;a.d=0}}
m.pd=function(a){var b=this.B;this.l&&(b=b?"xxx-bogus-xxx":"footnote");return new cj(this.k,a,this.g,b)};m.Ka=function(a,b,c){bh(this.u,a,b,c,this)};m.Db=function(a,b){Gf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};m.lc=function(a,b){Gf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
m.gb=function(a,b,c){"display"!=a||b!==Ud&&b!==Td||(this.gb("flow-options",new gd([Ed,$d]),c),this.gb("flow-into",b,c),b=zd);(Di.SIMPLE_PROPERTY||[]).forEach(function(d){d=d({name:a,value:b,important:c});a=d.name;b=d.value;c=d.important});var d=c?Af(this):Bf(this);Ui(this.k,a,this.J?new Qi(b,d,this.J):new V(b,d))};function ek(a,b){Ef.call(this,a,b,!1)}t(ek,Ff);
ek.prototype.Ka=function(a,b){if(this.e.values[a])this.error("E_CSS_NAME_REDEFINED "+a,this.Cb());else{var c=a.match(/height|^(top|bottom)$/)?"vh":"vw",c=new Uc(this.e,100,c),c=b.ea(this.e,c);this.e.values[a]=c}};function fk(a,b,c,d,e){Ef.call(this,a,b,!1);this.b=d;this.J=c;this.d=e}t(fk,Ff);fk.prototype.Ka=function(a,b,c){c?u.b("E_IMPORTANT_NOT_ALLOWED"):bh(this.d,a,b,c,this)};fk.prototype.Db=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};
fk.prototype.lc=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};fk.prototype.gb=function(a,b,c){c=c?Af(this):Bf(this);c+=this.N;this.N+=Nj;Ui(this.b,a,this.J?new Qi(b,c,this.J):new V(b,c))};function gk(a,b){ag.call(this,a);this.b={};this.d=b;this.N=0}t(gk,ag);gk.prototype.Ka=function(a,b,c){bh(this.d,a,b,c,this)};gk.prototype.Db=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};gk.prototype.lc=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};
gk.prototype.gb=function(a,b,c){c=(c?67108864:50331648)+this.N;this.N+=Nj;Ui(this.b,a,new V(b,c))};var hk=new wf(function(){var a=M("uaStylesheetBase");uf(ch).then(function(b){var c=sa("user-agent-base.css",ra);b=new bk(null,null,null,null,null,b,!0);b.vb("UA");ak=b.h;dg(c,b,null,null).oa(a)});return O(a)},"uaStylesheetBaseFetcher");function ik(a,b,c){return(a=a["writing-mode"])&&(b=a.evaluate(b,"writing-mode"))&&b!==Jd?b===fe:c}
function jk(a,b,c,d){var e={},f;for(f in a)Ti(f)&&(e[f]=a[f]);a=a._regions;if((c||d)&&a)for(d&&(d=["footnote"],c=c?c.concat(d):d),d=0;d<c.length;d++){f=a[c[d]];for(var g in f)Ti(g)&&(e[g]=Ri(b,e[g],f[g]))}return e}function kk(a,b,c,d){c=c?Oi:Pi;for(var e in a)if(a.hasOwnProperty(e)){var f=a[e];if(f){var g=c[e];if(g){var k=a[g];if(k&&k.Ea>f.Ea)continue;g=Ji[g]?g:e}else g=e;b[g]=d(e,f)}}};function lk(a,b,c){this.e=a;this.d=b;this.b=c}function mk(){this.map=[]}function nk(a){return 0==a.map.length?0:a.map[a.map.length-1].b}function ok(a,b){if(0==a.map.length)a.map.push(new lk(b,b,b));else{var c=a.map[a.map.length-1],d=c.b+b-c.d;c.d==c.e?(c.d=b,c.e=b,c.b=d):a.map.push(new lk(b,b,d))}}function pk(a,b){0==a.map.length?a.map.push(new lk(b,0,0)):a.map[a.map.length-1].d=b}function qk(a,b){var c=Xa(a.map.length,function(c){return b<=a.map[c].d}),c=a.map[c];return c.b-Math.max(0,c.e-b)}
...
d===a.root)return;d=f}}}function zk(a,b,c,d,e){var f=0,g=Number.POSITIVE_INFINITY,k=!1,h=!1,l=!1,n=c["flow-options"];if(n){var p;a:{if(k=n.evaluate(a.f,"flow-options")){h=new hg;try{k.R(h);p=h.b;break a}catch(q){u.b(q,"toSet:")}}p={}}k=!!p.exclusive;h=!!p["static"];l=!!p.last}(p=c["flow-linger"])&&(g=jg(p.evaluate(a.f,"flow-linger"),Number.POSITIVE_INFINITY));(c=c["flow-priority"])&&(f=jg(c.evaluate(a.f,"flow-priority"),0));d=new Vh(b,d,e,f,g,k,h,l);a.B.push(d);a.l==b&&(a.l=null);a.k&&Ak(a.k,d)}
function Bk(a,b,c){var d=-1;if(b<=a.b&&(d=qk(a.e,b),d+=c,d<nk(a.e)))return rk(a.e,d);if(null==a.d)return Number.POSITIVE_INFINITY;for(var e=a.f;;){var f=a.d.firstChild;if(null==f)for(;;){if(1==a.d.nodeType){var f=a.A,g=a.d;if(f.va.pop()!==g)throw Error("Invalid call to popElement");f.Sa.pop();f.pop();Xj(f);a.Qa=a.D.pop()}if(f=a.d.nextSibling)break;a.d=a.d.parentNode;if(a.d===a.root)return a.d=null,b<a.b&&(0>d&&(d=qk(a.e,b),d+=c),d<=nk(a.e))?rk(a.e,d):Number.POSITIVE_INFINITY}a.d=f;if(1!=a.d.nodeType)a.b+=
...
sk.prototype.g=function(a,b){var c=qh(this.Z,a),d="e"+c;b&&(c=rh(this.Z,a,0,!0));this.b<=c&&Bk(this,c,0);return this.w[d]};var Ck=1;function Dk(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.h=0;this.d=a;this.name=b;this.fb=c;this.xa=d;this.parent=e;this.g="p"+Ck++;e&&(this.h=e.children.length,e.children.push(this))}Dk.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Dk.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Ek(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
function Fk(a,b){for(var c=0;c<a.children.length;c++)a.children[c].clone({parent:b})}function Jk(a){Dk.call(this,a,null,null,[],null);this.b.width=new V(je,0);this.b.height=new V(ke,0)}t(Jk,Dk);
...
function Mk(a,b,c,d,e,f,g){a=a instanceof Kk?a:new Kk(a,this);Dk.call(this,a,b,c,d,e);this.e=this;this.J=f;this.j=g;this.b.width=new V(je,0);this.b.height=new V(ke,0);this.b["wrap-flow"]=new V(yd,0);this.b.position=new V(Wd,0);this.b.overflow=new V(Hd,0);this.k={}}t(Mk,Dk);Mk.prototype.f=function(a){return new Nk(a,this)};Mk.prototype.clone=function(a){a=new Mk(this.d,this.name,a.fb||this.fb,this.xa,this.parent,this.J,this.j);Ek(this,a);Fk(this,a);return a};
function Ok(a,b,c,d,e){Dk.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.k[b]=this.g);this.b["wrap-flow"]=new V(yd,0)}t(Ok,Dk);Ok.prototype.f=function(a){return new Pk(a,this)};Ok.prototype.clone=function(a){a=new Ok(a.parent.d,this.name,this.fb,this.xa,a.parent);Ek(this,a);Fk(this,a);return a};function Qk(a,b,c,d,e){Dk.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.k[b]=this.g)}t(Qk,Dk);Qk.prototype.f=function(a){return new Rk(a,this)};
Qk.prototype.clone=function(a){a=new Qk(a.parent.d,this.name,this.fb,this.xa,a.parent);Ek(this,a);Fk(this,a);return a};function Y(a,b,c){return b&&b!==yd?b.ea(a,c):null}function Sk(a,b,c){return b&&b!==yd?b.ea(a,c):a.b}function Tk(a,b,c){return b?b===yd?null:b.ea(a,c):a.b}function Uk(a,b,c,d){return b&&c!==Rd?b.ea(a,d):a.b}function Vk(a,b,c){return b?b===he?a.g:b===Fd?a.f:b.ea(a,a.b):c}
...
function al(a,b){b.pa[a.d.g]=a;var c=a.d.d,d=a.style,e=a.e?bl(a.e,b):null,e=jk(a.B,b,e,!1);a.b=ik(e,b,a.e?a.e.b:!1);kk(e,d,a.b,function(a,b){return b.value});a.l=new nc(c,function(){return a.A},"autoWidth");a.k=new nc(c,function(){return a.w},"autoHeight");a.Cc();a.Dc();Zk(a);Yk(a)}function cl(a,b,c){(a=a.style[c])&&(a=gg(b,a,c));return a}function Z(a,b,c){(a=a.style[c])&&(a=gg(b,a,c));return ud(a,b)}
function bl(a,b){var c;a:{if(c=a.B["region-id"]){for(var d=[],e=0;e<c.length;e++){var f=c[e].evaluate(b,"");f&&f!==H&&d.push(f)}if(d.length){c=d;break a}}c=null}if(c){d=[];for(e=0;e<c.length;e++)d[e]=c[e].toString();return d}return null}function dl(a,b,c,d){(a=cl(a,b,d))&&w(c.d,d,a.toString())}
function el(a,b,c){var d=Z(a,b,"left"),e=Z(a,b,"margin-left"),f=Z(a,b,"padding-left"),g=Z(a,b,"border-left-width");a=Z(a,b,"width");ri(c,d,a);w(c.d,"margin-left",e+"px");w(c.d,"padding-left",f+"px");w(c.d,"border-left-width",g+"px");c.marginLeft=e;c.$=g;c.j=f}
function fl(a,b,c){var d=Z(a,b,"right"),e=Z(a,b,"snap-height"),f=Z(a,b,"margin-right"),g=Z(a,b,"padding-right");b=Z(a,b,"border-right-width");w(c.d,"margin-right",f+"px");w(c.d,"padding-right",g+"px");w(c.d,"border-right-width",b+"px");c.marginRight=f;c.Fa=b;a.b&&0<e&&(a=d+oi(c),a=a-Math.floor(a/e)*e,0<a&&(c.Tb=e-a,g+=c.Tb));c.D=g;c.Ub=e}
function gl(a,b,c){var d=Z(a,b,"snap-height"),e=Z(a,b,"top"),f=Z(a,b,"margin-top"),g=Z(a,b,"padding-top");b=Z(a,b,"border-top-width");c.top=e;c.marginTop=f;c.fa=b;c.Ga=d;!a.b&&0<d&&(a=e+li(c),a=a-Math.floor(a/d)*d,0<a&&(c.pa=d-a,g+=c.pa));c.k=g;w(c.d,"top",e+"px");w(c.d,"margin-top",f+"px");w(c.d,"padding-top",g+"px");w(c.d,"border-top-width",b+"px")}
function hl(a,b,c){var d=Z(a,b,"margin-bottom"),e=Z(a,b,"padding-bottom"),f=Z(a,b,"border-bottom-width");a=Z(a,b,"height")-c.pa;w(c.d,"height",a+"px");w(c.d,"margin-bottom",d+"px");w(c.d,"padding-bottom",e+"px");w(c.d,"border-bottom-width",f+"px");c.height=a-c.pa;c.marginBottom=d;c.va=f;c.w=e}function il(a,b,c){a.b?(gl(a,b,c),hl(a,b,c)):(fl(a,b,c),el(a,b,c))}
function jl(a,b,c){w(c.d,"border-top-width","0px");var d=Z(a,b,"max-height");a.I?qi(c,0,d):(gl(a,b,c),d-=c.pa,c.height=d,w(c.d,"height",d+"px"))}function kl(a,b,c){w(c.d,"border-left-width","0px");var d=Z(a,b,"max-width");a.D?ri(c,0,d):(fl(a,b,c),d-=c.Tb,c.width=d,a=Z(a,b,"right"),w(c.d,"right",a+"px"),w(c.d,"width",d+"px"))}
...
Rk.prototype.M=function(a){var b=this.d.d,c=this.style,d=Vk(b,c.required,b.f)!==b.f;if(d||this.f){var e;e=(e=c["flow-from"])?e.ea(b,b.b):new B(b,"body");e=new Xc(b,"has-content",[e]);a=ad(b,a,e)}a=sl(this,a,c["required-partitions"],!1);a=sl(this,a,c["conflicting-partitions"],!0);d&&(c=(c=this.u.style.enabled)?c.ea(b,null):b.g,c=ad(b,c,a),this.u.style.enabled=new L(c));return a};Rk.prototype.eb=function(a,b,c){w(b.d,"overflow","hidden");Wk.prototype.eb.call(this,a,b,c)};
function tl(a,b,c,d){Ef.call(this,a,b,!1);this.target=c;this.b=d}t(tl,Ff);tl.prototype.Ka=function(a,b,c){bh(this.b,a,b,c,this)};tl.prototype.lc=function(a,b){Gf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};tl.prototype.Db=function(a,b){Gf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};tl.prototype.gb=function(a,b,c){this.target.b[a]=new V(b,c?50331648:67108864)};function ul(a,b,c,d){tl.call(this,a,b,c,d)}t(ul,tl);
...
function Hl(a,b,c,d,e,f,g,k){var h=M("createShadows"),l=e.template,n;l instanceof sd?n=Gl(a,l.url,2,b,k,null):n=N(null);n.then(function(l){var n=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var r=b.getAttribute("href"),v=null;r?v=k?k.Z:a.Z:k&&(r="http://www.w3.org/1999/xhtml"==k.Y.namespaceURI?k.Y.getAttribute("href"):k.Y.getAttributeNS("http://www.w3.org/1999/xlink","href"),v=k.Kc?k.Kc.Z:a.Z);r&&(r=sa(r,v.url),n=Gl(a,r,3,b,k,l))}null==n&&(n=N(l));n.then(function(l){var n;
if(n=d._pseudos){for(var q=Bl.createElementNS("http://www.pyroxy.com/ns/shadow","root"),p=q,r=0;r<Cl.length;r++){var v=Cl[r],ob;if(v){if(!n[v])continue;if(!("footnote-marker"!=v||c&&a.j))continue;if(v.match(/^first-/)&&(ob=e.display,!ob||ob===Kd))continue;ob=Bl.createElementNS("http://www.w3.org/1999/xhtml","span");ob.setAttribute("data-adapt-pseudo",v)}else ob=Bl.createElementNS("http://www.pyroxy.com/ns/shadow","content");p.appendChild(ob);v.match(/^first-/)&&(p=ob)}l=new Zh(b,q,null,k,l,2,new El(b,
...
"inner",I),f.appendChild(I));"iframe"==f.localName&&"http://www.w3.org/1999/xhtml"==f.namespaceURI&&Al(f);if("http://www.gribuser.ru/xml/fictionbook/2.0"!=e.namespaceURI||"td"==F){for(var g=e.attributes,h=g.length,l=null,n=0;n<h;n++){var p=g[n],q=p.namespaceURI,r=p.localName,p=p.nodeValue;if(q)if("http://www.w3.org/2000/xmlns/"==q)continue;else"http://www.w3.org/1999/xlink"==q&&"href"==r&&(p=Ml(a,p));else{if(r.match(/^on/))continue;if("style"==r)continue;if("id"==r){Th(a.e,f,p);continue}"src"==r||
"href"==r||"poster"==r?p=Ml(a,p):"srcset"==r&&(p=p.split(",").map(function(b){return Ml(a,b.trim())}).join(","))}if(q){var Ea=zl[q];Ea&&(r=Ea+":"+r)}"src"!=r||q||"img"!=F||"http://www.w3.org/1999/xhtml"!=P?"href"==r&&"image"==F&&"http://www.w3.org/2000/svg"==P&&"http://www.w3.org/1999/xlink"==q?a.e.e.push(qg(f,p)):q?f.setAttributeNS(q,r,p):f.setAttribute(r,p):l=p}l&&(g=qg(f,l),h=k.width,l=k.height,h&&h!==yd&&l&&l!==yd?a.e.e.push(g):W.push(g))}delete k.content;(g=k["list-style-image"])&&g instanceof
sd&&(g=g.url,W.push(qg(new Image,g)));Pl(a,f,k);g=k.widows;h=k.orphans;if(g||h){if(a.b.parent){a.b.l={};for(var Zd in a.b.parent.l)a.b.l[Zd]=a.b.parent.l[Zd]}g instanceof qd&&(a.b.l.widows=g.C);h instanceof qd&&(a.b.l.orphans=h.C)}if(!b&&!a.b.d){Zd=a.b.g?yl:xl;for(var Ik in Zd)w(f,Ik,Zd[Ik])}v&&f.setAttribute("value",k["ua-list-item-count"].stringValue());a.f=f;W.length?pg(W).then(function(){Q(d,c)}):lf().then(function(){Q(d,c)})})});return O(d)}
...
function Sl(a){if(null==a.ba||"content"!=a.W.localName||"http://www.pyroxy.com/ns/shadow"!=a.W.namespaceURI)return a;var b=a.ca,c=a.ba,d=a.parent,e,f;c.dd?(f=c.dd,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.Kc,e=c.Y.firstChild,c=2);var g=a.W.nextSibling;g?(a.W=g,bi(a)):a.na?a=a.na:e?a=null:(a=a.parent.modify(),a.K=!0);if(e)return b=new ai(e,d,b),b.ba=f,b.La=c,b.na=a,b;a.ca=b;return a}
function Tl(a){var b=a.ca+1;if(a.K){if(!a.parent)return null;if(3!=a.La){var c=a.W.nextSibling;if(c)return a=a.modify(),a.ca=b,a.W=c,bi(a),Sl(a)}if(a.na)return a=a.na.modify(),a.ca=b,a;a=a.parent.modify()}else{if(a.ua&&(c=a.ua.root,2==a.ua.type&&(c=c.firstChild),c))return b=new ai(c,a,b),b.ba=a.ua,b.La=a.ua.type,Sl(b);if(c=a.W.firstChild)return Sl(new ai(c,a,b));1!=a.W.nodeType&&(b+=a.W.textContent.length-1-a.aa);a=a.modify()}a.ca=b;a.K=!0;return a}
...
function km(a,b,c){ki.call(this,a);this.Rc=a.lastChild;this.g=b;this.nc=c;this.wd=a.ownerDocument;this.oc=!1;this.ma=this.Ya=this.Ba=this.gd=this.Sa=0;this.Qb=this.Rb=this.l=this.h=null;this.Sc=!1;this.M=this.f=this.u=null;this.hd=!0;this.rc=this.qc=0}t(km,ki);km.prototype.clone=function(){var a=new km(this.d,this.g,this.nc);pi(a,this);a.Rc=this.Rc;a.oc=this.oc;a.l=this.l?this.l.clone():null;a.Rb=this.Rb.concat();return a};
function lm(a,b){var c=(a.b?a.Ya:a.Sa)-a.h.V,d=(a.b?a.Sa:a.Ba)-a.h.T;return new oe(b.V-c,b.T-d,b.S-c,b.P-d)}function mm(a,b){return a.b?b<a.ma:b>a.ma}function nm(a,b,c){var d=new ai(b.da,c,0);d.La=b.La;d.ba=b.ba;d.ua=b.ua;d.na=b.na?nm(a,b.na,di(c)):null;return d}
function om(a,b){var c=M("openAllViews"),d=b.ha;Il(a.g,a.d,a.oc);var e=d.length-1,f=null;mf(function(){for(;0<=e;){f=nm(a,d[e],f);if(0==e&&(f.aa=b.aa,f.K=b.K,f.K))break;var c=Rl(a.g,f,0==e&&0==f.aa);e--;if(c.ya())return c}return N(!1)}).then(function(){Q(c,f)});return O(c)}var pm=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
function qm(a,b){if(b.f&&b.d&&!b.K&&0==b.f.count&&1!=b.b.nodeType){var c=b.b.textContent.match(pm);return Wl(a.g,b,c[0].length)}return N(b)}function rm(a,b,c){var d=M("buildViewToNextBlockEdge");nf(function(d){b.b&&c.push(di(b));qm(a,b).then(function(f){f!==b&&(b=f,c.push(di(b)));Ul(a.g,b).then(function(c){(b=c)?b.j&&!a.b?sm(a,b).then(function(c){b=c;!b||b.e||0<a.g.g.b.length?R(d):pf(d)}):b.d?pf(d):R(d):R(d)})})}).then(function(){Q(d,b)});return O(d)}
function tm(a,b){if(!b.b)return N(b);var c=b.W,d=M("buildDeepElementView");nf(function(d){qm(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.W!=c;)g=g.parent;if(null==g){b=f;R(d);return}}Ul(a.g,f).then(function(a){(b=a)&&b.W!=c?pf(d):R(d)})})}).then(function(){Q(d,b)});return O(d)}function um(a,b,c,d,e){var f=a.wd.createElement("div");a.b?(w(f,"height",d+"px"),w(f,"width",e+"px")):(w(f,"width",d+"px"),w(f,"height",e+"px"));w(f,"float",c);w(f,"clear",c);a.d.insertBefore(f,b);return f}
function vm(a){for(var b=a.d.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.d.removeChild(b);else break}b=c}}function wm(a){for(var b=a.d.firstChild,c=a.Qb,d=a.b?a.h.T:a.h.V,e=a.b?a.h.P:a.h.S,f=0;f<c.length;f++){var g=c[f],k=g.P-g.T;g.left=um(a,b,"left",g.V-d,k);g.right=um(a,b,"right",e-g.S,k)}}
function xm(a,b,c,d,e){var f;if(b&&b.K&&!b.d&&(f=em(b,0,a.b),!isNaN(f)))return f;b=c[d];for(e-=b.ca;;){f=em(b,e,a.b);if(!isNaN(f))return f;if(0<e)e--;else{d--;if(0>d)return a.Ba;b=c[d];1!=b.b.nodeType&&(e=b.b.textContent.length)}}}function ym(a){return"number"==typeof a?a:(a=a.match(/^(-?[0-9]*(\.[0-9]*)?)px$/))?parseFloat(a[0]):0}
function zm(a,b){var c=a.nc.b.getComputedStyle(b,null),d=new qe;c&&(d.left=ym(c.marginLeft),d.top=ym(c.marginTop),d.right=ym(c.marginRight),d.bottom=ym(c.marginBottom));return d}
function Am(a,b,c){if(a=a.nc.b.getComputedStyle(b,null))c.marginLeft=ym(a.marginLeft),c.$=ym(a.borderLeftWidth),c.j=ym(a.paddingLeft),c.marginTop=ym(a.marginTop),c.fa=ym(a.borderTopWidth),c.k=ym(a.paddingTop),c.marginRight=ym(a.marginRight),c.Fa=ym(a.borderRightWidth),c.D=ym(a.paddingRight),c.marginBottom=ym(a.marginBottom),c.va=ym(a.borderBottomWidth),c.w=ym(a.paddingBottom)}function Bm(a,b,c){b=new im(b,c,c);a.f?a.f.push(b):a.f=[b]}
function Cm(a,b,c,d){if(a.f&&a.f[a.f.length-1].b)return Bm(a,b,c),N(!0);d+=40*(a.b?-1:1);var e=a.l,f=!e;if(f){var g=a.d.ownerDocument.createElement("div");w(g,"position","absolute");var k=a.g.clone(),e=new km(g,k,a.nc);a.l=e;e.b=Xl(a.g,a.b,g);e.oc=!0;a.b?(e.left=0,w(e.d,"width","2em")):(e.top=a.Ya,w(e.d,"height","2em"))}a.d.appendChild(e.d);Am(a,e.d,e);g=(a.b?-1:1)*(d-a.Ba);a.b?e.height=a.h.P-a.h.T-li(e)-mi(e):e.width=a.h.S-a.h.V-ni(e)-oi(e);d=(a.b?-1:1)*(a.Ya-d)-(a.b?ni(e)-oi(e):li(e)+mi(e));if(f&&
18>d)return a.d.removeChild(e.d),a.l=null,Bm(a,b,c),N(!0);if(!a.b&&e.top<g)return a.d.removeChild(e.d),Bm(a,b,c),N(!0);var h=M("layoutFootnoteInner");a.b?ri(e,0,d):qi(e,g,d);e.A=a.A+a.left+ni(a);e.B=a.B+a.top+li(a);e.I=a.I;var l=new gi(c);f?(Dm(e),f=N(!0)):0==e.I.length?(Em(e),f=N(!0)):f=Fm(e);f.then(function(){Gm(e,l).then(function(d){a.b?(a.ma=a.Ya+(e.e+ni(e)+oi(e)),ri(e,0,e.e)):(a.ma=a.Ya-(e.e+li(e)+mi(e)),qi(e,a.ma-a.Ba,e.e));var f;!a.b&&0<e.I.length?f=Fm(e):f=N(d);f.then(function(d){d=new im(b,
c,d?d.Qa:null);a.f?a.f.push(d):a.f=[d];Q(h,!0)})})});return O(h)}
function Hm(a,b){var c=M("layoutFootnote"),d=b.b;d.setAttribute("style","");w(d,"display","inline-block");d.textContent="M";var e=d.getBoundingClientRect(),f=a.b?e.left:e.bottom;d.textContent="";Ol(a.g,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d={ha:[{da:b.W,La:0,ba:b.ba,ua:null,na:null}],aa:0,K:!1};e=b.ca;b=b.modify();b.K=!0;Cm(a,e,d,f).then(function(){a.l&&a.l.d.parentNode&&a.d.removeChild(a.l.d);mm(a,f)&&0!=a.u.length&&(b.e=!0);Q(c,b)});return O(c)}
function Im(a,b){var c=M("layoutFloat"),d=b.b,e=b.j,f=b.M,g=b.parent?b.parent.D:"ltr",k=a.g.g,h=b.b.parentNode;"page"===f?xi(k,d,e):(w(d,"float","none"),w(d,"position","absolute"),w(d,"left","auto"),w(d,"right","auto"),w(d,"top","auto"));tm(a,b).then(function(l){var n=d.getBoundingClientRect(),p=zm(a,d),n=new oe(n.left-p.left,n.top-p.top,n.right+p.right,n.bottom+p.bottom);if("page"===f)yi(k,b,a.g)?(n=h.ownerDocument.createElement("span"),w(n,"width","0"),w(n,"height","0"),h.appendChild(n),l.b=n,Q(c,
l)):Ai(k,b,lm(a,n)).then(function(){Q(c,null)});else{e=ui(e,a.b,g);for(var p=a.Sa,q=a.gd,r=b.parent;r&&r.d;)r=r.parent;if(r){var v=r.b.ownerDocument.createElement("div");v.style.left="0px";v.style.top="0px";a.b?(v.style.bottom="0px",v.style.width="1px"):(v.style.right="0px",v.style.height="1px");r.b.appendChild(v);var y=v.getBoundingClientRect(),p=Math.max(a.b?y.top:y.left,p),q=Math.min(a.b?y.bottom:y.right,q);r.b.removeChild(v);r=a.b?n.P-n.T:n.S-n.V;"left"==e?q=Math.max(q,p+r):p=Math.min(p,q-r)}p=
new oe(p,(a.b?-1:1)*a.Ba,q,(a.b?-1:1)*a.Ya);q=n;a.b&&(q=Ge(n));Le(p,a.Qb,q,e);a.b&&(n=new oe(-q.P,q.V,-q.T,q.S));w(d,"left",n.V-(a.b?a.Ya:a.Sa)+a.j+"px");w(d,"top",n.T-(a.b?a.Sa:a.Ba)+a.k+"px");n=a.b?n.V:n.P;mm(a,n)&&0!=a.u.length?(b=b.modify(),b.e=!0,Q(c,b)):(vm(a),p=a.b?Ge(a.h):a.h,a.b?q=Ge(lm(a,new oe(-q.P,q.V,-q.T,q.S))):q=lm(a,q),Me(p,a.Qb,q,e),wm(a),"left"==e?a.qc=n:a.rc=n,Jm(a,n),Q(c,l))}});return O(c)}
...
"1"))}}function Lm(a,b,c,d){var e=M("processLineStyling");jm(d);var f=d.concat([]);d.splice(0,d.length);var g=0,k=b.f;0==k.count&&(k=k.Gd);nf(function(d){if(k){var e=Mm(a,f),n=k.count-g;if(e.length<=n)R(d);else{var p=Nm(a,f,e[n-1]);Om(a,p,!1,!1).then(function(){g+=n;Wl(a.g,p,0).then(function(e){b=e;Km(b,!1);k=b.f;f=[];rm(a,b,f).then(function(b){c=b;0<a.g.g.b.length?R(d):pf(d)})})})}}else R(d)}).then(function(){Array.prototype.push.apply(d,f);jm(d);Q(e,c)});return O(e)}
function Pm(a,b){for(var c=0,d=0,e=b.length-1;0<=e;e--){var f=b[e];if(!f.K||!f.b||1!=f.b.nodeType)break;f=zm(a,f.b);f=a.b?-f.left:f.bottom;0<f?c=Math.max(c,f):d=Math.min(d,f)}return c-d}
function Qm(a,b){var c=M("layoutBreakableBlock"),d=[];rm(a,b,d).then(function(e){if(0<a.g.g.b.length)Q(c,e);else{var f=d.length-1;if(0>f)Q(c,e);else{var f=xm(a,e,d,f,d[f].ca),g=mm(a,f);null==e&&(f+=Pm(a,d));Jm(a,f);var k;b.f?k=Lm(a,b,e,d):k=N(e);k.then(function(b){0<d.length&&(a.u.push(new fm(d,d[0].h)),g&&(2!=d.length&&0<a.u.length||d[0].W!=d[1].W||!dm[d[0].W.localName])&&b&&(b=b.modify(),b.e=!0));Q(c,b)})}}});return O(c)}
function Nm(a,b,c){jm(b);for(var d=0,e=b[0].ca,f=d,g=b.length-1,k=b[g].ca,h;e<k;){h=e+Math.ceil((k-e)/2);for(var f=d,l=g;f<l;){var n=f+Math.ceil((l-f)/2);b[n].ca>h?l=n-1:f=n}l=xm(a,null,b,f,h);if(a.b?l<c:l>c){for(k=h-1;b[f].ca==h;)f--;g=f}else Jm(a,l),e=h,d=f}a=b[f];b=a.b;1!=b.nodeType&&(a.K?a.aa=b.length:(e-=a.ca,c=b.data,173==c.charCodeAt(e)?(b.replaceData(e,c.length-e,"-"),e++):(d=c.charAt(e),e++,f=c.charAt(e),b.replaceData(e,c.length-e,Ua(d)&&Ua(f)?"-":"")),0<e&&(a=a.modify(),a.aa+=e,a.u=null)));
return a}
function Mm(a,b){for(var c=[],d=b[0].b,e=b[b.length-1].b,f=[],g=d.ownerDocument.createRange(),k=!1,h=null,l=!1,n=!0;n;){var p=!0;do{var q=null;d==e&&(n=!1);1!=d.nodeType?(l||(g.setStartBefore(d),l=!0),h=d):k?k=!1:d.getAttribute("data-adapt-spec")?p=!l:q=d.firstChild;q||(q=d.nextSibling,q||(k=!0,q=d.parentNode));d=q}while(p&&n);if(l){g.setEndAfter(h);l=Zl(g);for(p=0;p<l.length;p++)f.push(l[p]);l=!1}}f.sort(a.b?Yh:Xh);h=d=k=g=e=0;for(n=a.b?-1:1;;){if(h<f.length&&(l=f[h],p=1,0<d&&(p=Math.max(a.b?l.right-
...
function Rm(a,b){if(!a.f)return N(!0);for(var c=!1,d=a.f.length-1;0<=d;--d){var e=a.f[d];if(e.ca<=b)break;a.f.pop();e.b!==e.d&&(c=!0)}if(!c)return N(!0);var f=M("clearFootnotes"),g=a.e+a.Ba,k=a.f;a.l=null;a.f=null;var h=0;mf(function(){for(;h<k.length;){var b=k[h++],b=Cm(a,b.ca,b.d,g);if(b.ya())return b}return N(!1)}).then(function(){Q(f,!0)});return O(f)}
function gm(a,b,c){var d=b.e,e;if(c)e=c=1;else{for(e=d[0];e.parent&&e.d;)e=e.parent;c=Math.max((e.l.widows||2)-0,1);e=Math.max((e.l.orphans||2)-0,1)}var f=Mm(a,d),g=a.ma,d=Xa(f.length,function(b){return a.b?f[b]<g:f[b]>g}),d=Math.min(f.length-c,d);if(d<e)return null;g=f[d-1];if(b=Nm(a,b.e,g))a.e=(a.b?-1:1)*(g-a.Ba);return b}
...
function Sm(a,b,c){var d=M("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,k=a.u.length-1;0<=k&&!e;--k){var e=a.u[k].d(a,f),h=a.u[k].b();h>f&&(g=Math.min(g,h))}while(g>f&&!e);var l=!1;if(!e){u.b("Could not find any page breaks?!!");if(a.hd)return Tm(a,b).then(function(b){b?(b=b.modify(),b.e=!1,Om(a,b,l,!0).then(function(){Q(d,b)})):Q(d,b)}),O(d);e=c;l=!0}Om(a,e,l,!0).then(function(){Q(d,e)});return O(d)}
function Um(a){a=a.toString();return""==a||"auto"==a||!!a.match(/^0+(.0*)?[^0-9]/)}function Vm(a,b,c,d,e){if(!b)return!1;var f=em(b,0,a.b),g=mm(a,f);c&&(f+=Pm(a,c));Jm(a,f);if(d||!g)b=new hm(di(b),e,g,a.e),a.u.push(b);return g}
function Wm(a,b){if(b.b.parentNode){var c=zm(a,b.b),d=b.b.ownerDocument.createElement("div");a.b?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.b.parentNode.insertBefore(d,b.b);var e=d.getBoundingClientRect(),e=a.b?e.right:e.top,f=a.b?-1:1,g;switch(b.w){case "left":g=a.qc;break;case "right":g=a.rc;break;default:g=f*Math.max(a.rc*f,a.qc*f)}e*f>=g*f?b.b.parentNode.removeChild(d):(e=Math.max(1,(g-e)*
...
function Em(a){var b=a.d.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.k+"px";b.style.right=a.D+"px";b.style.bottom=a.w+"px";b.style.left=a.j+"px";a.d.appendChild(b);var c=b.getBoundingClientRect();a.d.removeChild(b);var b=a.A+a.left+ni(a),d=a.B+a.top+li(a);a.h=new oe(b,d,b+a.width,d+a.height);a.Sa=c?a.b?c.top:c.left:0;a.gd=c?a.b?c.bottom:c.right:0;a.Ba=c?a.b?c.right:c.top:0;a.Ya=c?a.b?c.left:c.bottom:0;a.qc=a.Ba;a.rc=a.Ba;a.ma=a.Ya;c=a.h;b=a.A+a.left+ni(a);d=a.B+a.top+
li(a);b=a.Sb?we(a.Sb,b,d):ye(b,d,b+a.width,d+a.height);a.Qb=Ie(c,[b],a.I,a.Ga,a.b);wm(a);a.f=null}function Dm(a){a.Rb=[];w(a.d,"width",a.width+"px");w(a.d,"height",a.height+"px");Em(a);a.e=0;a.Sc=!1;a.M=null}function Jm(a,b){a.e=Math.max((a.b?-1:1)*(b-a.Ba),a.e)}function Zm(a,b){var c=b.b;if(!c)return N(!0);var d=M("layoutOverflownFootnotes"),e=0;mf(function(){for(;e<c.length;){var b=c[e++],b=Cm(a,0,b,a.Ba);if(b.ya())return b}return N(!1)}).then(function(){Q(d,!0)});return O(d)}
function Gm(a,b){a.Rb.push(b);if(a.Sc)return N(b);var c=M("layout");Zm(a,b).then(function(){om(a,b.Qa).then(function(b){var e=b,f=!0;a.u=[];nf(function(c){for(;b;){var k=!0;Ym(a,b,f).then(function(h){f=!1;b=h;0<a.g.g.b.length?R(c):a.M?R(c):b&&b.e?Sm(a,b,e).then(function(a){b=a;R(c)}):k?k=!1:pf(c)});if(k){k=!1;return}}R(c)}).then(function(){var e=a.l;e&&(a.d.appendChild(e.d),a.b?a.e=this.Ba-this.Ya:a.e=e.top+li(e)+e.e+mi(e));if(b)if(0<a.g.g.b.length)Q(c,null);else{a.Sc=!0;e=new gi(fi(b));if(a.f){for(var f=
[],h=0;h<a.f.length;h++){var l=a.f[h].b;l&&f.push(l)}e.b=f.length?f:null}Q(c,e)}else Q(c,null)})})});return O(c)}function Fm(a){for(var b=a.Rb,c=a.d.lastChild;c!=a.Rc;){var d=c.previousSibling;a.d===c.parentNode&&Dl(c)||a.d.removeChild(c);c=d}vm(a);Dm(a);var e=M("redoLayout"),f=0,g=null;nf(function(c){if(f<b.length){var d=b[f++];Gm(a,d).then(function(a){a?(g=a,R(c)):pf(c)})}else R(c)}).then(function(){Q(e,g)});return O(e)};function $m(a,b){this.e(a,"end",b)}function an(a,b){this.e(a,"start",b)}function bn(a,b,c){c||(c=this.g.now());var d=this.f[a];d||(d=this.f[a]=[]);var e;for(a=d.length-1;0<=a&&(!(e=d[a])||e[b]);a--)e=null;e||(e={},d.push(e));e[b]=c}function cn(){}function dn(a){this.g=a;this.f={};this.registerEndTiming=this.d=this.registerStartTiming=this.b=this.e=cn}
...
d(P);break;case "fit-content width":c=I?d(P):k();break;case "fit-content height":c=I?k():d(P)}F[a]=parseFloat(c);w(b,"position",n);w(b,"display",l)});w(b,"width",p);w(b,"height",q);r.insertBefore(b,v);r.removeChild(v);return F};function jn(a){var b=a["writing-mode"],b=b&&b.value;a=(a=a.direction)&&a.value;return b===ee||b!==fe&&a!==ae?"ltr":"rtl"}
...
height:new K(17,"in")}},ln={width:je,height:ke};function mn(a){if((a=a.size)&&a.value!==yd){var b=a.value;b.$c()?(a=b.values[0],b=b.values[1]):(a=b,b=null);return a.Fc()?{width:a,height:b||a}:(a=kn[a.name.toLowerCase()])?b&&b===Nd?{width:a.height,height:a.width}:{width:a.width,height:a.height}:ln}return ln}
...
un.prototype.h=function(a,b){var c=this.B,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}Nk.prototype.h.call(this,a,b)};un.prototype.Cc=function(){var a=this.style;a.left=le;a["margin-left"]=le;a["border-left-width"]=le;a["padding-left"]=le;a["padding-right"]=le;a["border-right-width"]=le;a["margin-right"]=le;a.right=le};
un.prototype.Dc=function(){var a=this.style;a.top=le;a["margin-top"]=le;a["border-top-width"]=le;a["padding-top"]=le;a["padding-bottom"]=le;a["border-bottom-width"]=le;a["margin-bottom"]=le;a.bottom=le};un.prototype.$=function(a,b,c){b=b.l;var d={start:this.j.marginLeft,end:this.j.marginRight,X:this.j.rb},e={start:this.j.marginTop,end:this.j.marginBottom,X:this.j.qb};xn(this,b.top,!0,d,a,c);xn(this,b.bottom,!0,d,a,c);xn(this,b.left,!1,e,a,c);xn(this,b.right,!1,e,a,c)};
function yn(a,b,c,d,e){this.L=a;this.l=e;this.g=c;this.k=!Y(d,b[c?"width":"height"],new Uc(d,0,"px"));this.h=null}yn.prototype.b=function(){return this.k};function zn(a){a.h||(a.h=hn(a.l,a.L.d,a.g?["max-content width","min-content width"]:["max-content height","min-content height"]));return a.h}yn.prototype.e=function(){var a=zn(this);return this.g?ni(this.L)+a["max-content width"]+oi(this.L):li(this.L)+a["max-content height"]+mi(this.L)};
...
function Cn(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=Dn(d,g.length?new An(g):null,b);g.Na&&(f.center=g.Na);d=g.Na||d.d();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=Dn(c,e,b),c.Na&&(f.start=c.Na),c.Pb&&(f.end=c.Pb);return f}
function Dn(a,b,c){var d={Na:null,Pb:null};if(a&&b)if(a.b()&&b.b()){var e=a.e(),f=b.e();0<e&&0<f?(f=e+f,f<c?d.Na=c*e/f:(a=a.f(),b=b.f(),b=a+b,b<c?d.Na=a+(c-b)*(e-a)/(f-b):0<b&&(d.Na=c*a/b)),0<d.Na&&(d.Pb=c-d.Na)):0<e?d.Na=c:0<f&&(d.Pb=c)}else a.b()?d.Na=Math.max(c-b.d(),0):b.b()&&(d.Pb=Math.max(c-a.d(),0));else a?a.b()&&(d.Na=c):b&&b.b()&&(d.Pb=c);return d}un.prototype.eb=function(a,b,c){un.ud.eb.call(this,a,b,c);b.d.setAttribute("data-vivliostyle-page-box",!0)};
...
d["padding-bottom"]=new L(c.marginBottom)};vn.prototype.Cc=function(){var a=En(this,{start:"left",end:"right",X:"width"});this.rb=a.kd;this.marginLeft=a.rd;this.marginRight=a.qd};vn.prototype.Dc=function(){var a=En(this,{start:"top",end:"bottom",X:"height"});this.qb=a.kd;this.marginTop=a.rd;this.marginBottom=a.qd};
function En(a,b){var c=a.style,d=a.d.d,e=b.start,f=b.end,g=b.X,k=a.d.w[g].ea(d,null),h=Y(d,c[g],k),l=Y(d,c["margin-"+e],k),n=Y(d,c["margin-"+f],k),p=Sk(d,c["padding-"+e],k),q=Sk(d,c["padding-"+f],k),r=Uk(d,c["border-"+e+"-width"],c["border-"+e+"-style"],k),v=Uk(d,c["border-"+f+"-width"],c["border-"+f+"-style"],k),y=G(d,k,E(d,E(d,r,p),E(d,v,q)));h?(y=G(d,y,h),l||n?l?n=G(d,y,l):l=G(d,y,n):n=l=bd(d,y,new B(d,.5))):(l||(l=d.b),n||(n=d.b),h=G(d,y,E(d,l,n)));c[e]=new L(l);c[f]=new L(n);c["margin-"+e]=le;
c["margin-"+f]=le;c["padding-"+e]=new L(p);c["padding-"+f]=new L(q);c["border-"+e+"-width"]=new L(r);c["border-"+f+"-width"]=new L(v);c[g]=new L(h);c["max-"+g]=new L(h);return{kd:G(d,k,E(d,l,n)),rd:l,qd:n}}vn.prototype.eb=function(a,b,c){Rk.prototype.eb.call(this,a,b,c);c.u=b.d};function wn(a,b){Rk.call(this,a,b);var c=b.l;this.j=on[c];a.pa[c]=this;this.va=!0}t(wn,Rk);m=wn.prototype;
m.eb=function(a,b,c){var d=b.d;w(d,"display","flex");var e=cl(this,a,"vertical-align"),f=null;e===J("middle")?f="center":e===J("top")?f="flex-start":e===J("bottom")&&(f="flex-end");f&&(w(d,"flex-flow",this.b?"row":"column"),w(d,"justify-content",f));Rk.prototype.eb.call(this,a,b,c)};
m.ga=function(a,b){var c=this.style,d=this.d.d,e=a.start,f=a.end,g="left"===e,k=g?b.rb:b.qb,h=Y(d,c[a.X],k),g=g?b.marginLeft:b.marginTop;if("start"===this.j.ga)c[e]=new L(g);else if(h){var l=Sk(d,c["margin-"+e],k),n=Sk(d,c["margin-"+f],k),p=Sk(d,c["padding-"+e],k),q=Sk(d,c["padding-"+f],k),r=Uk(d,c["border-"+e+"-width"],c["border-"+e+"-style"],k),f=Uk(d,c["border-"+f+"-width"],c["border-"+f+"-style"],k),h=E(d,h,E(d,E(d,p,q),E(d,E(d,r,f),E(d,l,n))));switch(this.j.ga){case "center":c[e]=new L(E(d,g,
cd(d,G(d,k,h),new B(d,2))));break;case "end":c[e]=new L(G(d,E(d,g,k),h))}}};
function Fn(a,b,c){function d(a){if(y)return y;y={X:v?v.evaluate(a):null,Ca:h?h.evaluate(a):null,Da:l?l.evaluate(a):null};var b=k.evaluate(a),c=0;[q,n,p,r].forEach(function(b){b&&(c+=b.evaluate(a))});(null===y.Ca||null===y.Da)&&c+y.X+y.Ca+y.Da>b&&(null===y.Ca&&(y.Ca=0),null===y.Da&&(y.ae=0));null!==y.X&&null!==y.Ca&&null!==y.Da&&(y.Da=null);null===y.X&&null!==y.Ca&&null!==y.Da?y.X=b-c-y.Ca-y.Da:null!==y.X&&null===y.Ca&&null!==y.Da?y.Ca=b-c-y.X-y.Da:null!==y.X&&null!==y.Ca&&null===y.Da?y.Da=b-c-y.X-
y.Ca:null===y.X?(y.Ca=y.Da=0,y.X=b-c):y.Ca=y.Da=(b-c-y.X)/2;return y}var e=a.style;a=a.d.d;var f=b.Ec,g=b.Jc;b=b.X;var k=G(a,c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],new B(a,2)),h=Tk(a,e["margin-"+f],k),l=Tk(a,e["margin-"+g],k),n=Sk(a,e["padding-"+f],k),p=Sk(a,e["padding-"+g],k),q=Uk(a,e["border-"+f+"-width"],e["border-"+f+"-style"],k),r=Uk(a,e["border-"+g+"-width"],e["border-"+g+"-style"],k),v=Y(a,e[b],k),y=null;e[b]=new L(new nc(a,function(){var a=d(this).X;return null===a?0:a},b));
e["margin-"+f]=new L(new nc(a,function(){var a=d(this).Ca;return null===a?0:a},"margin-"+f));e["margin-"+g]=new L(new nc(a,function(){var a=d(this).Da;return null===a?0:a},"margin-"+g));"left"===f?e.left=new L(E(a,c.marginLeft,c.rb)):"top"===f&&(e.top=new L(E(a,c.marginTop,c.qb)))}m.Cc=function(){var a=this.e.j;this.j.ra?Fn(this,{Ec:"right",Jc:"left",X:"width"},a):this.j.sa?Fn(this,{Ec:"left",Jc:"right",X:"width"},a):this.ga({start:"left",end:"right",X:"width"},a)};
m.Dc=function(){var a=this.e.j;this.j.ta?Fn(this,{Ec:"bottom",Jc:"top",X:"height"},a):this.j.qa?Fn(this,{Ec:"top",Jc:"bottom",X:"height"},a):this.ga({start:"top",end:"bottom",X:"height"},a)};m.Zb=function(a,b,c,d,e,f){Rk.prototype.Zb.call(this,a,b,c,d,e,f);a=c.l;c=this.d.l;d=this.j;d.ra||d.sa?d.ta||d.qa||(d.ra?a.left[c]=b:d.sa&&(a.right[c]=b)):d.ta?a.top[c]=b:d.qa&&(a.bottom[c]=b)};
...
function In(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof V?e.value+"":In(a,e);c.push(d+f+(e.Ea||""))}return c.sort().join("^")}function Jn(a){this.b=null;this.f=a}t(Jn,X);Jn.prototype.apply=function(a){a.I===this.f&&this.b.apply(a)};Jn.prototype.d=function(){return 3};Jn.prototype.e=function(a){this.b&&ej(a.Fb,this.f,this.b);return!0};function Kn(a){this.b=null;this.f=a}t(Kn,X);
...
m.Ta=function(){this.f+="}";document.getElementById("vivliostyle-page-rules").textContent+=this.f;bk.prototype.Ta.call(this)};
m.Ka=function(a,b,c){if("size"===a){var d=b.$c()&&b.values[1]===Nd,e=(d?b.values[0]:b).toString().toLowerCase(),f=kn[e];f&&("a5"===e||"a4"===e||"a3"===e||"b5"===e||"b4"===e||"letter"===e||"legal"===e||"ledger"===e?d&&(e+=" landscape"):(e=f.width.stringValue(),f=f.height.stringValue(),e=d?f+" "+e:e+" "+f));this.f+="size: "+e+(c?" !important":"")+";"}bk.prototype.Ka.call(this,a,b,c)};m.nd=function(a){ej(this.h.Fb,"*",a)};m.pd=function(a){return new Pn(this.k,a)};
m.Oc=function(a){var b=Vi(this.k,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);Df(this.Y,new Rn(this.e,this.Y,this.u,c))};function Rn(a,b,c,d){Ef.call(this,a,b,!1);this.d=c;this.b=d}t(Rn,Ff);Rn.prototype.Ka=function(a,b,c){bh(this.d,a,b,c,this)};Rn.prototype.Db=function(a,b){Gf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Rn.prototype.lc=function(a,b){Gf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};Rn.prototype.gb=function(a,b,c){Ui(this.b,a,new V(b,c?Af(this):Bf(this)))};
...
function Xn(a,b,c,d,e,f,g,k,h){rc.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.Z=b;this.lang=b.lang||c;this.viewport=d;this.e={body:!0};this.f=e;this.b=this.D=this.d=this.k=null;this.h=0;this.Sa=f;this.ma=new ih(this.style.l);this.pa={};this.M=null;this.j=new Sn(a.b);this.I={};this.fa=null;this.Fa=g;this.Ga=k;this.va=h;for(var l in a.e)(b=a.e[l]["flow-consume"])&&(b.evaluate(this,"flow-consume")==wd?this.e[l]=!0:delete this.e[l])}t(Xn,rc);
...
k);f=e;g=void 0;for(g in dh)f[g]||(f[g]=dh[g]);e=new gh(e);c.push(e)}}d=a.Sa;a=a.ma;e=[];for(f=0;f<c.length;f++)g=c[f],g.src&&g.b?e.push(mh(d,g,a)):u.b("E_FONT_FACE_INVALID");pg(e).oa(b);return O(b)}function Ak(a,b){var c=a.b;if(c){var d=c.b[b.f];d||(d=new ii,c.b[b.f]=d);d.b.push(new hi(new gi({ha:[{da:b.g,La:0,ba:null,ua:null,na:null}],aa:0,K:!1}),b))}}
function Zn(a,b){if(!b)return 0;var c=Number.POSITIVE_INFINITY,d;for(d in a.e){var e=b.b[d];if((!e||0==e.b.length)&&a.b){var f=a.d;f.l=d;for(e=0;null!=f.l&&(e+=5E3,Bk(f,e,0)!=Number.POSITIVE_INFINITY););e=a.b.b[d];b!=a.b&&e&&(e=e.clone(),b.b[d]=e)}if(e){for(var f=a,g=Number.POSITIVE_INFINITY,k=0;k<e.b.length;k++){for(var h=e.b[k].d.Qa,l=h.ha[0].da,n=h.aa,p=h.K,q=0;l.ownerDocument!=f.Z.b;)q++,l=h.ha[q].da,p=!1,n=0;h=rh(f.Z,l,n,p);h<g&&(g=h)}f=g;f<c&&(c=f)}}return c}
function $n(a,b){var c=Zn(a,a.b);if(c==Number.POSITIVE_INFINITY)return null;for(var d=a.k.children,e,f=0;f<d.length;f++)if(e=d[f],"vivliostyle-page-rule-master"!==e.d.fb){var g=1,k=cl(e,a,"utilization");k&&k.Zc()&&(g=k.C);k=tc(a,"em",!1);a.h=Bk(a.d,c,Math.ceil(g*a.u()*a.l()/(k*k)));var g=a,k=g.b.d,h=void 0;for(h in g.b.b)for(var l=g.b.b[h],n=l.b.length-1;0<=n;n--){var p=l.b[n];0>p.b.e&&p.b.b<g.h&&(p.b.e=k)}sc(a,a.style.b);g=cl(e,a,"enabled");if(!g||g===he){d=a;u.d("Location - page",d.b.d);u.d("  current:",
c);u.d("  lookup:",d.h);c=void 0;for(c in d.b.b)for(f=d.b.b[c],g=0;g<f.b.length;g++)u.d("  Chunk",c+":",f.b[g].b.b);c=a.M;f=b;g=e.d;if(0===Object.keys(f).length)g.d.e=g;else{e=g;d=In(c,f);e=e.g+"^"+d;d=c.g[e];if(!d){if("background-host"===g.fb)d=c,f=(new qn(d.h,d.f.d,f)).f(d.f),f.h(d.b,d.e),ql(f,d.d),d=f;else{d=c;k=f;f=g.clone({fb:"vivliostyle-page-rule-master"});if(g=k.size)k=mn(k),g=g.Ea,f.b.width=Ri(d.d,f.b.width,new V(k.width,g)),f.b.height=Ri(d.d,f.b.height,new V(k.height,g));f=f.f(d.f);f.h(d.b,
d.e);ql(f,d.d);d=f}c.g[e]=d}e=d.d;e.d.e=e;e=d}return e}}throw Error("No enabled page masters");}
function ao(a,b,c){var d=a.b.b[c];if(!d)return N(!0);Dm(b);a.e[c]&&0<b.Qb.length&&(b.hd=!1);var e=M("layoutColumn"),f=[];nf(function(c){for(;0<d.b.length;){var e=0,h=d.b[e];if(h.b.b>a.h)break;for(var l=1;l<d.b.length;l++){var n=d.b[l];if(n.b.b>a.h)break;Wh(n.b,h.b)&&(h=n,e=l)}var p=h.b,q=!0;Gm(b,h.d).then(function(a){h.b.Id&&(null===a||p.d)&&f.push(h);p.d?(d.b.splice(e,1),R(c)):a?(h.d=a,R(c)):(d.b.splice(e,1),q?q=!1:pf(c))});if(q){q=!1;return}}R(c)}).then(function(){0<f.length&&(d.b=f.concat(d.b));
Q(e,!0)});return O(e)}
function bo(a,b,c,d,e,f,g,k){var h=cl(c,a,"enabled");if(h&&h!==he)return N(!0);var l=M("layoutContainer"),n=cl(c,a,"wrap-flow")===yd,p=c.b?c.g&&c.D:c.f&&c.I,h=cl(c,a,"flow-from"),q=a.viewport.b.createElement("div"),r=cl(c,a,"position");w(q,"position",r?r.name:"absolute");d.insertBefore(q,d.firstChild);var v=new ki(q);v.b=c.b;c.eb(a,v,b);v.A=e;v.B=f;e+=v.left+v.marginLeft+v.$;f+=v.top+v.marginTop+v.fa;if(h&&h.od())if(a.I[h.toString()])c.Zb(a,v,b,null,1,a.f),h=N(!0);else{var y=M("layoutContainer.inner"),
I=h.toString(),W=Z(c,a,"column-count"),P=Z(c,a,"column-gap"),F=1<W?Z(c,a,"column-width"):v.width,h=bl(c,a),Ea=0,r=cl(c,a,"shape-inside"),ob=lg(r,0,0,v.width,v.height,a),Gk=new Fl(I,a,a.viewport,a.d,h,a.Z,a.ma,a.style.u,a,b,a.Fa,a.Ga,k),sh=0,aa=null;nf(function(b){for(;sh<W;){var c=sh++;if(1<W){var d=a.viewport.b.createElement("div");w(d,"position","absolute");q.appendChild(d);aa=new km(d,Gk,a.f);aa.b=v.b;aa.Ga=v.Ga;aa.Ub=v.Ub;v.b?(w(d,"margin-left",v.j+"px"),w(d,"margin-right",v.D+"px"),c=c*(F+P)+
v.k,ri(aa,0,v.width),qi(aa,c,F)):(w(d,"margin-top",v.k+"px"),w(d,"margin-bottom",v.w+"px"),c=c*(F+P)+v.j,qi(aa,0,v.height),ri(aa,c,F));aa.A=e+v.j;aa.B=f+v.k}else aa=new km(q,Gk,a.f),pi(aa,v),v=aa;aa.I=p?[]:g;aa.Sb=ob;if(0<=aa.width){var h=M("inner");ao(a,aa,I).then(function(){aa.M&&"column"!=aa.M&&(sh=W,"region"!=aa.M&&(a.I[I]=!0));Q(h,!0)});c=O(h)}else c=N(!0);if(c.ya()){c.then(function(){0<k.b.length?R(b):(Ea=Math.max(Ea,aa.e),pf(b))});return}0<k.b.length||(Ea=Math.max(Ea,aa.e))}R(b)}).then(function(){v.e=
Ea;c.Zb(a,v,b,aa,W,a.f);Q(y,!0)});h=O(y)}else{h=cl(c,a,"content");r=!1;if(h&&ti(h)){var Hk=a.viewport.b.createElement("span");h.R(new si(Hk,a));q.appendChild(Hk);pl(c,a,v)}else c.va&&(d.removeChild(q),r=!0);r||c.Zb(a,v,b,null,1,a.f);h=N(!0)}h.then(function(){if(!c.f||0<Math.floor(v.e)){if(!n){var h=v.A+v.left,p=v.B+v.top,r=ni(v)+v.width+oi(v),y=li(v)+v.height+mi(v),F=cl(c,a,"shape-outside"),h=lg(F,h,p,r,y,a);gb(a.viewport.root)&&g.push(we(h,0,-1.25*tc(a,"em",!1)));g.push(h)}}else if(0==c.children.length){d.removeChild(q);
Q(l,!0);return}var I=c.children.length-1;mf(function(){for(;0<=I;){var d=c.children[I--],d=bo(a,b,d,q,e,f,g,k);if(d.ya())return d}return N(!1)}).then(function(){Q(l,!0)})});return O(l)}
...
for(d=0;d<f.length;d++)if(g=f[d],k=b.h[g.Ib],h=b.h[g.Fd],k&&h&&(k=Ph(k,g.action)))for(var y=0;y<h.length;y++)h[y].addEventListener(g.event,k,!1);var I;a:{for(I in a.e)if((f=c.b[I])&&0<f.b.length){I=!1;break a}I=!0}I&&(c=null);Q(l,c)});return O(l)}function eo(a,b){var c=mn(b),d=c.width;d===je?a.A=null:a.A=d.C*tc(a,d.ia,!1);c=c.height;c===ke?a.w=null:a.w=c.C*tc(a,c.ia,!1)}function fo(a,b,c,d){bk.call(this,a.g,a,b,c,d,a.f,!c);this.f=a;this.A=!1}t(fo,bk);m=fo.prototype;m.hc=function(){};
m.gc=function(a,b,c){a=new Mk(this.f.j,a,b,c,this.f.u,this.J,Bf(this.Y));Df(this.f,new wl(a.d,this.f,a,this.u))};m.mb=function(a){a=a.d;null!=this.J&&(a=ad(this.e,this.J,a));Df(this.f,new fo(this.f,a,this,this.B))};m.dc=function(){Df(this.f,new ek(this.e,this.Y))};m.fc=function(){var a={};this.f.k.push({lb:a,J:this.J});Df(this.f,new fk(this.e,this.Y,null,a,this.f.f))};m.ec=function(a){var b=this.f.h[a];b||(b={},this.f.h[a]=b);Df(this.f,new fk(this.e,this.Y,null,b,this.f.f))};
m.jc=function(){var a={};this.f.w.push(a);Df(this.f,new fk(this.e,this.Y,this.J,a,this.f.f))};m.Jb=function(a){var b=this.f.l;if(a){var c=Vi(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Df(this.f,new fk(this.e,this.Y,null,b,this.f.f))};m.ic=function(){this.A=!0;this.hb()};m.ub=function(){var a=new Qn(this.f.j,this.f,this,this.u);Df(this.f,a);a.ub()};
m.la=function(){bk.prototype.la.call(this);if(this.A){this.A=!1;var a="R"+this.f.B++,b=J(a),c;this.J?c=new Qi(b,0,this.J):c=new V(b,0);Wi(this.k,"region-id").push(c);this.Ta();a=new fo(this.f,this.J,this,a);Df(this.f,a);a.la()}};
...
Ua:"UA",xa:null,media:null});for(k=0;k<a.j.length;k++)q.push(a.j[k]);if(f=b.h)for(f=f.firstChild;f;f=f.nextSibling)if(1==f.nodeType)if(g=f,k=g.namespaceURI,l=g.localName,"http://www.w3.org/1999/xhtml"==k)if("style"==l)q.push({url:d,text:g.textContent,Ua:"Author",xa:null,media:null});else if("link"==l){if(n=g.getAttribute("rel"),k=g.getAttribute("class"),l=g.getAttribute("media"),"stylesheet"==n||"alternate stylesheet"==n&&k)g=g.getAttribute("href"),g=sa(g,d),q.push({url:g,text:null,xa:k,media:l,Ua:"Author"})}else"meta"==
l&&"viewport"==g.getAttribute("name")&&q.push({url:d,text:go(g),Ua:"Author",J:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==k?"stylesheet"==l&&"text/css"==g.getAttribute("type")&&q.push({url:d,text:g.textContent,Ua:"Author",xa:null,media:null}):"http://example.com/sse"==k&&"property"===l&&(k=g.getElementsByTagName("name")[0])&&"stylesheet"===k.textContent&&(g=g.getElementsByTagName("value")[0])&&(g=sa(g.textContent,d),q.push({url:g,text:null,xa:null,media:null,Ua:"Author"}));
for(var r="",k=0;k<q.length;k++)r+=q[k].url,r+="^",q[k].text&&(r+=q[k].text),r+="^";var v=a.A[r];v?(a.b[d]=v,Q(c,b)):(f=a.h[r],f||(f=new wf(function(){var b=M("fetchStylesheet"),c=0,d=new ho(a.f);mf(function(){if(c<q.length){var a=q[c++];d.vb(a.Ua);var b;if(null!==a.text){b=a.url;var e=a.xa,f=a.media,a=new ac(a.text,d);b=bg(a,d,b,e,f)}else b=dg(a.url,d,a.xa,a.media);return b}return N(!1)}).then(function(){v=new Vn(a,d.g,d.j,d.A.h,d.u,d.k,d.l,d.h,d.w);a.A[r]=v;delete a.h[r];Q(b,v)});return O(b)},"FetchStylesheet "+
d),a.h[r]=f,f.start()),uf(f).then(function(f){a.b[d]=f;Q(c,b)}))}else Q(c,null)});return O(c)};function no(a,b,c,d,e,f,g,k){this.d=a;this.url=b;this.lang=c;this.e=d;this.g=e;this.Q=dc(f);this.h=g;this.f=k;this.Ia=this.b=null}function oo(a,b,c){if(0!=c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=Oa(d,"height","auto")&&(w(d,"height","auto"),oo(a,d,c));"absolute"==Oa(d,"position","static")&&(w(d,"position","relative"),oo(a,d,c))}}
...
no.prototype.Gc=function(a){var b=this.h.Gc(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",w(e,"cursor","pointer"),e.addEventListener("click",po,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
no.prototype.cc=function(a,b,c,d,e){if(this.b)return N(this.b);var f=this,g=M("showTOC"),k=new Qh(a);this.b=k;this.d.load(this.url).then(function(d){var l=f.d.b[d.url],n=Wn(l,c,1E5,e);b=new $l(b.f,n.fontSize,b.root,n.width,n.height);var p=new Xn(l,d,f.lang,b,f.e,f.g,f.Gc(d),f.f,0);f.Ia=p;p.Q=f.Q;Yn(p).then(function(){co(p,k,null).then(function(){oo(f,a,2);Q(g,k)})})});return O(g)};
no.prototype.$b=function(){if(this.b){var a=this.b;this.Ia=this.b=null;w(a.L,"visibility","none");var b=a.L.parentNode;b&&b.removeChild(a.L)}};no.prototype.ad=function(){return!!this.b};function qo(){ko.call(this,ro(this));this.d=new tf(Ah,"document");this.u=new tf(xf,"text");this.w={};this.M={};this.k={};this.l={}}t(qo,ko);function ro(a){return function(b){return a.k[b]}}
function so(a,b,c){var d=M("loadEPUBDoc");"/"!==b.substring(b.length-1)&&(b+="/");c&&a.u.Yb(b+"?r=list");a.d.Yb(b+"META-INF/encryption.xml");var e=b+"META-INF/container.xml";a.d.load(e,!0,"Failed to fetch EPUB container.xml from "+e).then(function(f){if(f){f=Lh(oh(oh(oh(new ph([f.b]),"container"),"rootfiles"),"rootfile"),"full-path");for(var g=0;g<f.length;g++){var k=f[g];if(k){to(a,b,k,c).oa(d);return}}Q(d,null)}else u.error("Received an empty response for EPUB container.xml "+e+". This may be caused by the server not allowing cross origin requests.")});
...
qo.prototype.load=function(a){var b=qa(a);if(a=this.l[b])return a.ya()?a:N(a.Wb());var c=M("EPUBDocStore.load");a=qo.ud.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?Q(c,a):u.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return O(c)};function wo(){this.id=null;this.src="";this.g=this.d=null;this.F=-1;this.h=0;this.j=null;this.b=this.e=0;this.f=$a}function xo(a){return a.id}
...
a.namespaceURI)return{name:zo.dcterms+a.localName,N:k++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Mc:null,scheme:null};return null});var h=ab(g,function(a){return a.Mc});g=d(ab(g,function(a){return a.Mc?null:a.name}));var l=null;g[Ao]&&(l=g[Ao][0].v);c(g);return g}function Eo(){var a=window.MathJax;return a?a.Hub:null}var Fo={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
...
function Mo(a,b){var c=a.b[b.F];if(0>=b.ka)return N(c.e);var d=M("getEPage");a.e.load(c.src).then(function(a){a=th(a);var f=Math.min(a,b.ka);Q(d,c.e+f*c.b/a)});return O(d)}function No(a,b,c,d){this.b=a;this.viewport=b;this.f=c;this.tb=[];this.ka=this.O=this.F=0;this.Q=dc(d);this.e=new Yl(b.f)}function Oo(a){var b=a.tb[a.F];return b?b.Za[a.O]:null}m=No.prototype;m.cb=function(){if(this.b.A)return this.b.A;var a=this.tb[this.F];return a?a.Ia.fa:null};
function Po(a){var b=M("renderPage");Qo(a).then(function(c){if(c){var d=-1;if(0>a.O){var d=a.ka,e=Xa(c.Ja.length,function(a){return Zn(c.Ia,c.Ja[a])>d});a.O=e==c.Ja.length?Number.POSITIVE_INFINITY:e-1}var f=c.Za[a.O];f?(a.ka=f.offset,Q(b,f)):nf(function(b){if(a.O<c.Ja.length)R(b);else if(c.complete)a.O=c.Ja.length-1,R(b);else{var e=c.Ja[c.Ja.length-1],h=Ro(a,c,e);co(c.Ia,h,e).then(function(l){h.L.style.display="none";h.L.style.visibility="visible";h.L.setAttribute("data-vivliostyle-page-side",h.f);
(e=l)?(c.Za[e.d-1]=h,c.Ja.push(e),0<=d&&Zn(c.Ia,e)>d?(f=h,a.O=c.Ja.length-2,R(b)):(h.j=0==c.item.F&&0==e.d-1,pf(b))):(c.Za.push(h),f=h,a.O=c.Ja.length-1,0>d&&(a.ka=h.offset),c.complete=!0,h.j=0==c.item.F&&0==a.O,h.k=c.item.F==a.b.b.length-1,R(b))})}}).then(function(){if(f=f||c.Za[a.O])Q(b,f);else{var e=c.Ja[a.O];0>d&&(a.ka=Zn(c.Ia,e));var k=Ro(a,c,e);co(c.Ia,k,e).then(function(d){k.L.style.display="none";k.L.style.visibility="visible";k.L.setAttribute("data-vivliostyle-page-side",k.f);(e=d)?(c.Za[e.d-
1]=k,c.Ja[a.O+1]=e):(c.Za.push(k),c.complete=!0,k.k=c.item.F==a.b.b.length-1);k.j=0==c.item.F&&0==a.O;Q(b,k)})}})}else Q(b,null)});return O(b)}m.Nc=function(){return So(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};function So(a,b,c){var d=M("renderAllPages"),e=a.F,f=a.O;a.F=0;nf(function(d){a.O=a.F==b?c:Number.POSITIVE_INFINITY;Po(a).then(function(){++a.F>b?R(d):pf(d)})}).then(function(){a.F=e;a.O=f;Po(a).oa(d)});return O(d)}m.yd=function(){this.O=this.F=0;return Po(this)};
m.zd=function(){this.F=this.b.b.length-1;this.O=Number.POSITIVE_INFINITY;return Po(this)};m.nextPage=function(){var a=this,b=M("nextPage");Qo(a).then(function(c){if(c){if(c.complete&&a.O==c.Ja.length-1){if(a.F>=a.b.b.length-1){Q(b,null);return}a.F++;a.O=0}else a.O++;Po(a).oa(b)}else Q(b,null)});return O(b)};m.Lc=function(){if(0==this.O){if(0==this.F)return N(null);this.F--;this.O=Number.POSITIVE_INFINITY}else this.O--;return Po(this)};
function To(a,b){var c="left"===b.f,d="ltr"===a.cb();return!c&&d||c&&!d}function Uo(a){var b=M("getCurrentSpread"),c=Oo(a);if(!c)return N({left:null,right:null});var d=a.F,e=a.O,f="left"===c.f;(To(a,c)?a.Lc():a.nextPage()).then(function(g){a.F=d;a.O=e;Po(a).then(function(){f?Q(b,{left:c,right:g}):Q(b,{left:g,right:c})})});return O(b)}m.Ed=function(){var a=Oo(this);if(!a)return N(null);var a=To(this,a),b=this.nextPage();if(a)return b;var c=this;return b.kc(function(){return c.nextPage()})};
m.Hd=function(){var a=Oo(this);if(!a)return N(null);var a=To(this,a),b=this.Lc();if(a){var c=this;return b.kc(function(){return c.Lc()})}return b};function Vo(a,b){var c=M("navigateToEPage");Lo(a.b,b).then(function(b){b&&(a.F=b.F,a.O=b.O,a.ka=b.ka);Po(a).oa(c)});return O(c)}function Wo(a,b){var c=M("navigateToCFI");Ko(a.b,b).then(function(b){b&&(a.F=b.F,a.O=b.O,a.ka=b.ka);Po(a).oa(c)});return O(c)}
...
function Ro(a,b,c){var d=b.Ia.viewport,e=d.b.createElement("div");d.d.appendChild(e);e.style.position="relative";e.style.visibility="hidden";e.style.left="0px";e.style.top="0px";var f=new Qh(e);f.F=b.item.F;f.position=c;f.offset=Zn(b.Ia,c);d!==a.viewport&&(a=gc(a.viewport.width,a.viewport.height,d.width,d.height),a=eg(null,new ac(a,null)),f.g.push(new Nh(e,"transform",a)));return f}
function Yo(a,b){var c=Eo();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=M("navigateToEPage"),f=ff(c);d.Push(function(){f.Va(e)});return O(c)}return N(null)}
...
function Qo(a){if(a.F>=a.b.b.length)return N(null);var b=a.tb[a.F];if(b)return N(b);var c=a.b.b[a.F],d=a.b.e,e=M("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(th(f)/2700),a.b.u=c.b);var g=d.b[f.url],k=a.Gc(f),h=a.viewport,l=Wn(g,h.width,h.height,h.fontSize);if(l.width!=h.width||l.height!=h.height||l.fontSize!=h.fontSize)h=new $l(h.f,l.fontSize,h.root,l.width,l.height);var l=a.tb[a.F-1],n=new Xn(g,f,a.b.lang,h,a.e,a.f,k,a.b.w,l?l.Ia.va+l.Za.length:0);l&&
Tn(n.j,l.Ia.j);n.Q=a.Q;Yn(n).then(function(){b={item:c,Z:f,Ia:n,Ja:[null],Za:[],complete:!1};a.tb[a.F]=b;Q(e,b)})});return O(e)}function Zo(a){return{F:a.F,O:a.O,ka:a.ka}}function $o(a,b){b?(a.F=b.F,a.O=-1,a.ka=b.ka):(a.F=0,a.O=0,a.ka=0);return So(a,a.F,a.O)}
m.cc=function(){var a=this.b,b=a.B||a.M;if(!b)return N(null);var c=M("showTOC");this.d||(this.d=new no(a.e,b.src,a.lang,this.e,this.f,this.Q,this,a.w));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";e.style.border=
"1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.d.cc(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";Q(c,a)});return O(c)};m.$b=function(){this.d&&this.d.$b()};m.ad=function(){return this.d&&this.d.ad()};function ap(a,b,c,d){var e=this;this.h=a;this.ab=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Ga=c;this.Fa=d;this.fa=new jh(a.document.head,b);this.w="";this.g=null;this.D=this.d=!1;this.f=this.j=this.e=this.l=null;this.fontSize=16;this.zoom=1;this.M=!1;this.Nc=!0;this.Q=cc();this.B=function(){};this.k=function(){};this.I=function(){e.d=!0;e.B()};this.u=function(){};this.$={loadEPUB:this.ma,loadXML:this.pa,configure:this.A,
moveTo:this.va,toc:this.cc};bp(this)}function bp(a){pa(1,function(a){cp(this,{t:"debug",content:a})}.bind(a));pa(2,function(a){cp(this,{t:"info",content:a})}.bind(a));pa(3,function(a){cp(this,{t:"warn",content:a})}.bind(a));pa(4,function(a){cp(this,{t:"error",content:a})}.bind(a))}function cp(a,b){b.i=a.Ga;a.Fa(b)}
ap.prototype.ma=function(a){fn.b("loadEPUB");fn.b("loadFirstPage");this.ab.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet;this.viewport=null;var f=M("loadEPUB"),g=this;g.A(a).then(function(){var a=new qo;if(e)for(var h=0;h<e.length;h++)mo(a,e[h]);lo(a).then(function(){var e=sa(b,g.h.location.href);g.w=e;so(a,e,d).then(function(a){g.g=a;Ko(g.g,c).then(function(a){g.f=a;dp(g).then(function(){g.ab.setAttribute("data-vivliostyle-viewer-status",
"complete");fn.d("loadEPUB");cp(g,{t:"loaded",metadata:g.g.l});Q(f,!0)})})})})});return O(f)};
ap.prototype.pa=function(a){fn.b("loadXML");fn.b("loadFirstPage");this.ab.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.document,d=a.fragment,e=a.userStyleSheet;this.viewport=null;var f=M("loadXML"),g=this;g.A(a).then(function(){var a=new qo;if(e)for(var h=0;h<e.length;h++)mo(a,e[h]);lo(a).then(function(){var e=sa(b,g.h.location.href);g.w=e;g.g=new uo(a,"");Io(g.g,e,c).then(function(){Ko(g.g,d).then(function(a){g.f=a;dp(g).then(function(){g.ab.setAttribute("data-vivliostyle-viewer-status",
...
function ip(a){var b=M("reportPosition");a.f||(a.f=Zo(a.b));Jo(a.g,a.f.F,a.f.ka).then(function(c){var d=a.e;(a.M&&0<d.e.length?pg(d.e):N(!0)).then(function(){jp(a,d,c).oa(b)})});return O(b)}function kp(a){var b=a.ab;if(a.l){var c=a.l;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new $l(a.h,a.fontSize,b,c.width,c.height)}return new $l(a.h,a.fontSize,b)}
function lp(a){if(a.l||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=kp(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.tb;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.Za,d=0;d<c.length;d++){var e=c[d];if(e.D&&e.B){a=!0;break a}}}a=!1}b=!a}return b}
function mp(a){if(a.b){a.b.$b();for(var b=a.b.tb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.Za,e;e=d.shift();)e=e.L,e.parentNode.removeChild(e)}}a.viewport=kp(a);b=a.viewport;w(b.e,"width","");w(b.e,"height","");w(b.d,"width","");w(b.d,"height","");w(b.d,"transform","");a.b=new No(a.g,a.viewport,a.fa,a.Q)}
function np(a,b){a.D=!1;if(a.Q.Wa)return Uo(a.b).kc(function(c){fp(a);a.j=c;c.left&&(gp(a,c.left),c.right||c.left.L.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(gp(a,c.right),c.left||c.right.L.setAttribute("data-vivliostyle-unpaired-page",!0));c=op(a,c);a.viewport.zoom(c.width,c.height,a.zoom);a.e=b;return N(null)});hp(a,b);a.viewport.zoom(b.b.width,b.b.height,a.zoom);a.e=b;return N(null)}
function op(a,b){var c=0,d=0;b.left&&(c+=b.left.b.width,d=b.left.b.height);b.right&&(c+=b.right.b.width,d=Math.max(d,b.right.b.height));b.left&&b.right&&(c+=2*a.Q.Eb);return{width:c,height:d}}var pp={Pd:"fit inside viewport"};
function dp(a){a.d=!1;if(lp(a))return N(!0);"complete"===a.ab.getAttribute("data-vivliostyle-viewer-status")&&a.ab.setAttribute("data-vivliostyle-viewer-status","resizing");cp(a,{t:"resizestart"});var b=M("resize");a.b&&!a.f&&(a.f=Zo(a.b));mp(a);$o(a.b,a.f).then(function(c){np(a,c).then(function(){ip(a).then(function(c){fn.d("loadFirstPage");(a.Nc?a.b.Nc():N(null)).then(function(){a.ab.setAttribute("data-vivliostyle-viewer-status","complete");cp(a,{t:"resizeend"});Q(b,c)})})})});return O(b)}
function jp(a,b,c){var d=M("sendLocationNotification"),e={t:"nav",first:b.j,last:b.k};Mo(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.u;c&&(e.cfi=c);cp(a,e);Q(d,!0)});return O(d)}ap.prototype.cb=function(){return this.b?this.b.cb():null};
ap.prototype.va=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.Q.Wa?this.b.Ed:this.b.nextPage;break;case "previous":a=this.Q.Wa?this.b.Hd:this.b.Lc;break;case "last":a=this.b.zd;break;case "first":a=this.b.yd;break;default:return N(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return Vo(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return Xo(b.b,d)}}else return N(!0);var e=M("nextPage");a.call(b.b).then(function(a){a?(b.f=
null,np(b,a).then(function(){ip(b).oa(e)})):Q(e,!0)});return O(e)};ap.prototype.cc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.ad();if(c){if("show"==a)return N(!0)}else if("hide"==a)return N(!0);if(c)return this.b.$b(),N(!0);var d=this,e=M("showTOC");this.b.cc(b).then(function(a){if(a){if(b){var c=function(){d.b.$b()};a.addEventListener("hyperlink",c,!1);a.L.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.u,!1)}Q(e,!0)});return O(e)};
...
function sp(a,b){var c=rp(b),d=null;Ye(function(){var b=M("commandLoop"),f=Re.d;a.u=function(b){var c={t:"hyperlink",href:b.href,internal:b.href.substr(0,a.w.length)==a.w};Ze(f,function(){cp(a,c);return N(!0)})};nf(function(b){if(a.d)dp(a).then(function(){pf(b)});else if(a.D)a.e&&np(a,a.e).then(function(){pf(b)});else if(c){var e=c;c=null;qp(a,e).then(function(){pf(b)})}else e=M("waitForCommand"),d=ff(e,self),O(e).then(function(){pf(b)})}).oa(b);return O(b)});a.B=function(){var a=d;a&&(d=null,a.Va())};
a.k=function(b){if(c)return!1;c=rp(b);a.B();return!0};a.h.adapt_command=a.k};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Bb||(Object.Bb=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function tp(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}function up(a,b){this.f=a;this.b=new ap(a.window||window,a.viewportElement,"main",this.xd.bind(this));this.e={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,spreadView:!1,zoom:1};b&&this.sd(b);this.d=new db}m=up.prototype;
m.sd=function(a){var b=Object.Bb({a:"configure"},tp(a));this.b.k(b);Object.Bb(this.e,a)};m.xd=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});eb(this.d,b)};m.Jd=function(a,b){this.d.addEventListener(a,b,!1)};m.Md=function(a,b){this.d.removeEventListener(a,b,!1)};m.Ad=function(a,b,c){a||eb(this.d,{type:"error",content:"No URL specified"});vp(this,a,null,b,c)};m.Kd=function(a,b,c){a||eb(this.d,{type:"error",content:"No URL specified"});vp(this,null,a,b,c)};
function vp(a,b,c,d,e){d=d||{};var f,g=d.userStyleSheet;g&&(f=g.map(function(a){return{url:a.url||null,text:a.text||null}}));e&&Object.Bb(a.e,e);b=Object.Bb({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.f.userAgentRootURL,url:b||c,document:d.documentObject,fragment:d.fragment,userStyleSheet:f},tp(a.e));sp(a.b,b)}m.cb=function(){return this.b.cb()};
m.Cd=function(a){a:switch(a){case "left":a="ltr"===this.cb()?"previous":"next";break a;case "right":a="ltr"===this.cb()?"next":"previous";break a}this.b.k({a:"moveTo",where:a})};m.Bd=function(a){this.b.k({a:"moveTo",url:a})};m.Ld=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.Q.Wa?op(b,b.j):b.e.b;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ca("vivliostyle.viewer.Viewer",up);up.prototype.setOptions=up.prototype.sd;up.prototype.addListener=up.prototype.Jd;up.prototype.removeListener=up.prototype.Md;up.prototype.loadDocument=up.prototype.Ad;up.prototype.loadEPUB=up.prototype.Kd;up.prototype.getCurrentPageProgression=up.prototype.cb;up.prototype.navigateToPage=up.prototype.Cd;up.prototype.navigateToInternalUrl=up.prototype.Bd;up.prototype.queryZoomFactor=up.prototype.Ld;ca("vivliostyle.viewer.ZoomType",pp);pp.FIT_INSIDE_VIEWPORT="fit inside viewport";
...
function Cp(a){switch(a.t){case "loaded":a=a.viewer;var b=xp=a.cb();a.ab.setAttribute("data-vivliostyle-page-progression",b);a.ab.setAttribute("data-vivliostyle-spread-view",a.Q.Wa);window.addEventListener("keydown",Bp,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",zp,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Ap,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
