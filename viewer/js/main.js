 ...
 *
 * Vivliostyle core 2016.7.1-pre.20160727064913
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
b=a.B+a.left+Di(a);d=a.D+a.top+Bi(a);if(a.yb){for(var e=a.yb,f=[],g=0;g<e.b.length;g++){var h=e.b[g];f.push(new qe(h.x+b,h.y+d))}b=new ve(f)}else b=ye(b,d,b+a.width,d+a.height);a.hb=Ie(c,[b],a.H,a.ab,a.b);Mn(a);a.e=null}function Tn(a){a.xb=[];w(a.element,"width",a.width+"px");w(a.element,"height",a.height+"px");Un(a);a.d=0;a.pd=!1;a.g=null}function Zn(a,b){a.d=Math.max((a.b?-1:1)*(b-a.ta),a.d)}
...
"margin-left",q.h+"px"),w(d,"margin-right",q.u+"px"),c=c*(ja+Ja)+q.j,Hi(ca,0,q.width),Gi(ca,c,ja)):(w(d,"margin-top",q.j+"px"),w(d,"margin-bottom",q.l+"px"),c=c*(ja+Ja)+q.h,Gi(ca,0,q.height),Hi(ca,c,ja));ca.B=e+q.h;ca.D=f+q.j}else ca=new An(r,Al,a.e,Cl),Fi(ca,q),q=ca;ca.H=p?[]:g;ca.yb=J;if(0<=ca.width){var k=L("inner");Tp(a,ca,W).then(function(){ca.g&&"column"!=ca.g&&(di=ea,"region"!=ca.g&&(a.I[W]=!0));O(k,!0)});c=N(k)}else c=M(!0);if(c.Ca()){c.then(function(){0<h.b.length?P(b):(E=Math.max(E,ca.d),
...
a.zoom,this.D=!0);return M(!0)};n.dd=function(a){var b=this.e,c=this.j,d=a.target;c?c.left!==d&&c.right!==d||ar(this,a.Rd):b===a.target&&ar(this,a.Rd)};function br(a){var b=[];a.e&&(b.push(a.e),a.e=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(w(a.N,"display","none"),a.removeEventListener("hyperlink",this.u,!1),a.removeEventListener("replaced",this.dd,!1))},a)}
function cr(a,b){b.addEventListener("hyperlink",a.u,!1);b.addEventListener("replaced",a.dd,!1);w(b.N,"visibility","visible");w(b.N,"display","block")}function dr(a,b){br(a);a.e=b;cr(a,b)}function er(a){var b=L("reportPosition");a.f||(a.f=Uq(a.b));Cq(a.g,a.f.F,a.f.na).then(function(c){var d=a.e;(a.S&&0<d.g.length?sg(d.g):M(!0)).then(function(){fr(a,d,c).ua(b)})});return N(b)}
