 ...
 *
 * Vivliostyle core 2016.7.1-pre.20160802021125
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
e}else if(null!=f&&null==c)return 0!==f;return!1}function tc(a){this.b=a;this.f="_"+dc++}n=tc.prototype;n.toString=function(){var a=new Ia;this.oa(a,0);return a.toString()};n.oa=function(){throw Error("F_ABSTRACT");};n.Pa=function(){throw Error("F_ABSTRACT");};n.Fa=function(){return this};n.Bb=function(a){return a===this};function uc(a,b,c,d){var e=d[a.f];if(null!=e)return e===Zb?!1:e;d[a.f]=Zb;b=a.Bb(b,c,d);return d[a.f]=b}
n.evaluate=function(a){var b;b=(b=a.w[this.b.j])?b[this.f]:void 0;if("undefined"!=typeof b)return b;b=this.Pa(a);var c=this.f,d=this.b,e=a.w[d.j];e||(e={},a.w[d.j]=e);return e[c]=b};n.xd=function(){return!1};function vc(a,b){tc.call(this,a);this.d=b}t(vc,tc);n=vc.prototype;n.rd=function(){throw Error("F_ABSTRACT");};n.vd=function(){throw Error("F_ABSTRACT");};n.Pa=function(a){a=this.d.evaluate(a);return this.vd(a)};n.Bb=function(a,b,c){return a===this||uc(this.d,a,b,c)};
n.oa=function(a,b){10<b&&a.append("(");a.append(this.rd());this.d.oa(a,10);10<b&&a.append(")")};n.Fa=function(a,b){var c=this.d.Fa(a,b);return c===this.d?this:new this.constructor(this.b,c)};function B(a,b,c){tc.call(this,a);this.d=b;this.e=c}t(B,tc);n=B.prototype;n.nc=function(){throw Error("F_ABSTRACT");};n.Da=function(){throw Error("F_ABSTRACT");};n.Va=function(){throw Error("F_ABSTRACT");};n.Pa=function(a){var b=this.d.evaluate(a);a=this.e.evaluate(a);return this.Va(b,a)};
...
Cc.prototype.Pa=function(a){return this.d.evaluate(a)&&this.e.evaluate(a)};function Dc(a,b,c){B.call(this,a,b,c)}t(Dc,Cc);Dc.prototype.Da=function(){return" and "};function Ec(a,b,c){B.call(this,a,b,c)}t(Ec,wc);Ec.prototype.Da=function(){return"||"};Ec.prototype.Pa=function(a){return this.d.evaluate(a)||this.e.evaluate(a)};function Fc(a,b,c){B.call(this,a,b,c)}t(Fc,Ec);Fc.prototype.Da=function(){return", "};function Gc(a,b,c){B.call(this,a,b,c)}t(Gc,xc);Gc.prototype.Da=function(){return"<"};
Gc.prototype.Va=function(a,b){return a<b};function Hc(a,b,c){B.call(this,a,b,c)}t(Hc,xc);Hc.prototype.Da=function(){return"<="};Hc.prototype.Va=function(a,b){return a<=b};function Ic(a,b,c){B.call(this,a,b,c)}t(Ic,xc);Ic.prototype.Da=function(){return">"};Ic.prototype.Va=function(a,b){return a>b};function Jc(a,b,c){B.call(this,a,b,c)}t(Jc,xc);Jc.prototype.Da=function(){return">="};Jc.prototype.Va=function(a,b){return a>=b};function Kc(a,b,c){B.call(this,a,b,c)}t(Kc,xc);Kc.prototype.Da=function(){return"=="};
Kc.prototype.Va=function(a,b){return a==b};function Lc(a,b,c){B.call(this,a,b,c)}t(Lc,xc);Lc.prototype.Da=function(){return"!="};Lc.prototype.Va=function(a,b){return a!=b};function Mc(a,b,c){B.call(this,a,b,c)}t(Mc,yc);Mc.prototype.Da=function(){return"+"};Mc.prototype.Va=function(a,b){return a+b};function Nc(a,b,c){B.call(this,a,b,c)}t(Nc,yc);Nc.prototype.Da=function(){return" - "};Nc.prototype.Va=function(a,b){return a-b};function Oc(a,b,c){B.call(this,a,b,c)}t(Oc,zc);Oc.prototype.Da=function(){return"*"};
Oc.prototype.Va=function(a,b){return a*b};function Pc(a,b,c){B.call(this,a,b,c)}t(Pc,zc);Pc.prototype.Da=function(){return"/"};Pc.prototype.Va=function(a,b){return a/b};function Qc(a,b,c){B.call(this,a,b,c)}t(Qc,zc);Qc.prototype.Da=function(){return"%"};Qc.prototype.Va=function(a,b){return a%b};function Rc(a,b,c){tc.call(this,a);this.C=b;this.aa=c.toLowerCase()}t(Rc,tc);Rc.prototype.oa=function(a){a.append(this.C.toString());a.append(La(this.aa))};
Rc.prototype.Pa=function(a){return this.C*pc(a,this.aa,!1)};function Sc(a,b){tc.call(this,a);this.d=b}t(Sc,tc);Sc.prototype.oa=function(a){a.append(this.d)};Sc.prototype.Pa=function(a){return qc(a,this.b,this.d).evaluate(a)};Sc.prototype.Bb=function(a,b,c){return a===this||uc(qc(b,this.b,this.d),a,b,c)};function Tc(a,b,c){tc.call(this,a);this.d=b;this.name=c}t(Tc,tc);Tc.prototype.oa=function(a){this.d&&a.append("not ");a.append(La(this.name))};
Tc.prototype.Pa=function(a){var b=this.name;a="all"===b||!!a.T.ud[b];return this.d?!a:a};Tc.prototype.Bb=function(a,b,c){return a===this||uc(this.value,a,b,c)};Tc.prototype.xd=function(){return!0};function ic(a,b,c){tc.call(this,a);this.Kb=b;this.d=c}t(ic,tc);ic.prototype.oa=function(a){a.append(this.d)};ic.prototype.Pa=function(a){return this.Kb.call(a)};function Uc(a,b,c){tc.call(this,a);this.e=b;this.d=c}t(Uc,tc);
Uc.prototype.oa=function(a){a.append(this.e);var b=this.d;a.append("(");for(var c=0;c<b.length;c++)c&&a.append(","),b[c].oa(a,0);a.append(")")};Uc.prototype.Pa=function(a){return rc(a,this.b,this.e,this.d,!1).Fa(a,this.d).evaluate(a)};Uc.prototype.Bb=function(a,b,c){if(a===this)return!0;for(var d=0;d<this.d.length;d++)if(uc(this.d[d],a,b,c))return!0;return uc(rc(b,this.b,this.e,this.d,!0),a,b,c)};
...
n.ub=function(a){var b=this.wb(a.values);return b===a.values?a:new ed(b)};n.kb=function(a){var b=this.wb(a.values);return b===a.values?a:new fd(a.name,b)};n.Qb=function(a){return a};function gd(){}n=gd.prototype;n.toString=function(){var a=new Ia;this.Aa(a,!0);return a.toString()};n.stringValue=function(){var a=new Ia;this.Aa(a,!1);return a.toString()};n.ja=function(){throw Error("F_ABSTRACT");};n.Aa=function(a){a.append("[error]")};n.wd=function(){return!1};n.$b=function(){return!1};n.yd=function(){return!1};
n.Nd=function(){return!1};n.Zc=function(){return!1};function hd(){if(F)throw Error("E_INVALID_CALL");}t(hd,gd);hd.prototype.ja=function(a){return new fc(a,"")};hd.prototype.Aa=function(){};hd.prototype.U=function(a){return a.md(this)};var F=new hd;function id(){if(jd)throw Error("E_INVALID_CALL");}t(id,gd);id.prototype.ja=function(a){return new fc(a,"/")};id.prototype.Aa=function(a){a.append("/")};id.prototype.U=function(a){return a.nd(this)};var jd=new id;function kd(a){this.b=a}t(kd,gd);
kd.prototype.ja=function(a){return new fc(a,this.b)};kd.prototype.Aa=function(a,b){b?(a.append('"'),a.append(Ma(this.b)),a.append('"')):a.append(this.b)};kd.prototype.U=function(a){return a.kc(this)};function ld(a){this.name=a;if(ad[a])throw Error("E_INVALID_CALL");ad[a]=this}t(ld,gd);ld.prototype.ja=function(a){return new fc(a,this.name)};ld.prototype.Aa=function(a,b){b?a.append(La(this.name)):a.append(this.name)};ld.prototype.U=function(a){return a.vb(this)};ld.prototype.Nd=function(){return!0};
function G(a){var b=ad[a];b||(b=new ld(a));return b}function H(a,b){this.C=a;this.aa=b.toLowerCase()}t(H,gd);H.prototype.ja=function(a,b){return 0==this.C?a.b:b&&"%"==this.aa?100==this.C?b:new Oc(a,b,new fc(a,this.C/100)):new Rc(a,this.C,this.aa)};H.prototype.Aa=function(a){a.append(this.C.toString());a.append(this.aa)};H.prototype.U=function(a){return a.Tb(this)};H.prototype.$b=function(){return!0};function md(a){this.C=a}t(md,gd);
md.prototype.ja=function(a){return 0==this.C?a.b:1==this.C?a.d:new fc(a,this.C)};md.prototype.Aa=function(a){a.append(this.C.toString())};md.prototype.U=function(a){return a.Sb(this)};md.prototype.yd=function(){return!0};function nd(a){this.C=a}t(nd,md);nd.prototype.U=function(a){return a.Rb(this)};function od(a){this.b=a}t(od,gd);od.prototype.Aa=function(a){a.append("#");var b=this.b.toString(16);a.append("000000".substr(b.length));a.append(b)};od.prototype.U=function(a){return a.Ic(this)};
function pd(a){this.url=a}t(pd,gd);pd.prototype.Aa=function(a){a.append('url("');a.append(Ma(this.url));a.append('")')};pd.prototype.U=function(a){return a.lc(this)};function qd(a,b,c,d){var e=b.length;b[0].Aa(a,d);for(var f=1;f<e;f++)a.append(c),b[f].Aa(a,d)}function dd(a){this.values=a}t(dd,gd);dd.prototype.Aa=function(a,b){qd(a,this.values," ",b)};dd.prototype.U=function(a){return a.gb(this)};dd.prototype.Zc=function(){return!0};function ed(a){this.values=a}t(ed,gd);
ed.prototype.Aa=function(a,b){qd(a,this.values,",",b)};ed.prototype.U=function(a){return a.ub(this)};function fd(a,b){this.name=a;this.values=b}t(fd,gd);fd.prototype.Aa=function(a,b){a.append(La(this.name));a.append("(");qd(a,this.values,",",b);a.append(")")};fd.prototype.U=function(a){return a.kb(this)};function I(a){this.d=a}t(I,gd);I.prototype.ja=function(){return this.d};I.prototype.Aa=function(a){a.append("-epubx-expr(");this.d.oa(a,0);a.append(")")};I.prototype.U=function(a){return a.Qb(this)};
...
l=k}f.b[l]=g}var l=c,m=l.d;l.d=null;m&&m.e==l&&(m.e=null,k=Se,Se=m,O(m.top,l.e),Se=k);b=a.e.currentTime();if(b>=a.h)break}}catch(p){u.error(p)}a.g=!1;a.d.length()&&df(a)},b)}}af.prototype.Wa=function(a,b){var c=this.e.currentTime();a.Q=this.Q++;a.b=c+(b||0);a:{for(var c=this.d,d=c.b.length;1<d;){var e=Math.floor(d/2),f=c.b[e];if(0<ef(f,a)){c.b[d]=a;break a}c.b[d]=f;d=e}c.b[1]=a}df(this)};
function $e(a,b,c){var d=new ff(a,c||"");d.top=new Ue(d,null,"bootstrap");d.top.b=Ve;d.top.then(function(){function a(){d.h=!1;for(var b=0;b<d.g.length;b++){var c=d.g[b];try{c()}catch(e){u.error(e)}}}try{b().then(function(b){d.f=b;a()})}catch(c){Ye(d,c),a()}});c=Se;Se=d;a.Wa(gf(d.top,"bootstrap"));Se=c;return d}function hf(a){this.d=a;this.Q=this.b=0;this.e=null}function ef(a,b){return b.b-a.b||b.Q-a.Q}hf.prototype.Wa=function(a,b){this.e=a;this.d.d.Wa(this,b)};
function ff(a,b){this.d=a;this.name=b;this.g=[];this.b=null;this.h=!0;this.e=this.top=this.j=this.f=null}function jf(a,b){a.g.push(b)}ff.prototype.join=function(){var a=L("Task.join");if(this.h){var b=gf(a,this),c=this;jf(this,function(){b.Wa(c.f)})}else O(a,this.f);return N(a)};
...
function mf(){var a=L("Frame.timeSlice"),b=a.d.d;b.e.currentTime()>=b.h?(u.debug("-- time slice --"),gf(a).Wa(!0)):O(a,!0);return N(a)}function nf(a){function b(d){try{for(;d;){var e=a();if(e.Ca()){e.then(b);return}e.then(function(a){d=a})}O(c,!0)}catch(f){Ye(c.d,f,c)}}var c=L("Frame.loop");b(!0);return N(c)}function of(a){var b=Se;if(!b)throw Error("E_TASK_NO_CONTEXT");return nf(function(){var c;do c=new pf(b,b.top),b.top=c,c.b=Ve,a(c),c=N(c);while(!c.Ca()&&c.Ub());return c})}
...
c.replace(/(.*);.*$/,"$1")}else l.responseXML=g.responseXML,l.contentType=g.responseXML.contentType;h.Wa(l)}};try{d?(g.setRequestHeader("Content-Type",e||"text/plain; charset=UTF-8"),g.send(d)):g.send(null)}catch(k){u.b(k,"Error fetching "+a),h.Wa(l)}return N(f)}function sf(a){var b=window.WebKitBlobBuilder||window.MSBlobBuilder;if(b){for(var b=new b,c=0;c<a.length;c++)b.append(a[c]);return b.getBlob("application/octet-stream")}return new Blob(a,{type:"application/octet-stream"})}
function tf(a){var b=L("readBlob"),c=new FileReader,d=gf(b,c);c.addEventListener("load",function(){d.Wa(c.result)},!1);c.readAsArrayBuffer(a);return N(b)}function uf(a,b){this.I=a;this.type=b;this.g={};this.e={}}uf.prototype.load=function(a,b,c){a=ta(a);var d=this.g[a];return"undefined"!=typeof d?M(d):vf(this.rc(a,b,c))};
function wf(a,b,c,d){var e=L("fetch");rf(b,a.type).then(function(f){if(c&&400<=f.status)throw Error(d||"Failed to fetch required resource: "+b);a.I(f,a).then(function(c){delete a.e[b];a.g[b]=c;O(e,c)})});return N(e)}uf.prototype.rc=function(a,b,c){a=ta(a);if(this.g[a])return null;var d=this.e[a];if(!d){var e=this,d=new xf(function(){return wf(e,a,b,c)},"Fetch "+a);e.e[a]=d;d.start()}return d};function yf(a){a=a.responseText;return M(a?JSON.parse(a):null)};function zf(a){var b=parseInt(a,16);if(isNaN(b))throw Error("E_CSS_COLOR");if(6==a.length)return new od(b);if(3==a.length)return new od(b&15|(b&15)<<4|(b&240)<<4|(b&240)<<8|(b&3840)<<8|(b&3840)<<12);throw Error("E_CSS_COLOR");}function Af(a){this.d=a;this.bb="Author"}n=Af.prototype;n.Yb=function(){return null};n.X=function(){return this.d};n.error=function(){};n.Pb=function(a){this.bb=a};n.ib=function(){};n.Pc=function(){};n.bc=function(){};n.cc=function(){};n.Vc=function(){};n.oc=function(){};
...
function ug(a,b){var c=null,d=null;"img"==a.localName&&(c=a.getAttribute("width"),d=a.getAttribute("height"));var e=new xf(function(){function e(b){"img"==a.localName&&(c||a.removeAttribute("width"),d||a.removeAttribute("height"));h.Wa(b?b.type:"timeout")}var g=L("loadImage"),h=gf(g,a);a.addEventListener("load",e,!1);a.addEventListener("error",e,!1);a.addEventListener("abort",e,!1);"http://www.w3.org/2000/svg"==a.namespaceURI?(a.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",b),setTimeout(e,
...
mh(l,f,c);u.e("Starting to load font:",f);var q=!1;nf(function(){var a=k.getBoundingClientRect(),b=a.bottom-a.top;if(r!=a.right-a.left||w!=b)return q=!0,M(!1);(new Date).valueOf()>m?a=M(!1):(a=L("Frame.sleep"),gf(a).Wa(!0,10),a=N(a));return a}).then(function(){q?u.e("Loaded font:",f):u.b("Failed to load font:",f);a.b.removeChild(k);O(e,l)});return N(e)}
...
function ci(a){this.d=a;this.b=[]}function ei(a,b,c,d,e,f,g,h,l){this.b=a;this.element=b;this.d=c;this.Ga=d;this.h=e;this.f=f;this.je=g;this.g=h;this.Qa=-1;this.e=l}function fi(a,b){return a.f?!b.f||a.Ga>b.Ga?!0:a.g:!1}function gi(a,b){return a.top-b.top}function hi(a,b){return b.right-a.right}
...
function Bi(a){this.element=a;this.D=this.B=this.height=this.width=this.l=this.j=this.u=this.h=this.za=this.S=this.Ta=this.O=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.yb=this.H=null;this.ma=this.zb=this.ab=this.Gb=this.d=0;this.b=!1}function Ci(a){return a.marginTop+a.S+a.j}function Di(a){return a.marginBottom+a.za+a.l}function Ei(a){return a.marginLeft+a.O+a.h}function Fi(a){return a.marginRight+a.Ta+a.u}
function Gi(a,b){a.element=b.element;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.O=b.O;a.Ta=b.Ta;a.S=b.S;a.za=b.za;a.h=b.h;a.u=b.u;a.j=b.j;a.l=b.l;a.width=b.width;a.height=b.height;a.B=b.B;a.D=b.D;a.yb=b.yb;a.H=b.H;a.d=b.d;a.Gb=b.Gb;a.ab=b.ab;a.b=b.b}function Hi(a,b,c){a.top=b;a.height=c;v(a.element,"top",b+"px");v(a.element,"height",c+"px")}
...
function V(){this.b=null}t(V,vj);V.prototype.apply=function(a){this.b.apply(a)};V.prototype.d=function(){return 0};V.prototype.e=function(){return!1};function zj(a){this.b=null;this.f=a}t(zj,V);zj.prototype.apply=function(a){0<=a.w.indexOf(this.f)&&this.b.apply(a)};zj.prototype.d=function(){return 10};zj.prototype.e=function(a){this.b&&Aj(a.Ba,this.f,this.b);return!0};function Bj(a){this.b=null;this.id=a}t(Bj,V);Bj.prototype.apply=function(a){a.O!=this.id&&a.ca!=this.id||this.b.apply(a)};
...
Jj.prototype.apply=function(a){if(a.b){var b=a.b.getAttributeNS(this.g,this.name);b&&b.match(this.f)&&this.b.apply(a)}};function Kj(a){this.b=null;this.f=a}t(Kj,V);Kj.prototype.apply=function(a){a.lang.match(this.f)&&this.b.apply(a)};function Lj(){this.b=null}t(Lj,V);Lj.prototype.apply=function(a){a.Ta&&this.b.apply(a)};Lj.prototype.d=function(){return 6};function Mj(){this.b=null}t(Mj,V);Mj.prototype.apply=function(a){a.ma&&this.b.apply(a)};Mj.prototype.d=function(){return 12};
function Nj(a,b){this.b=null;this.f=a;this.Vb=b}t(Nj,V);function Oj(a,b){var c=a.f;b-=a.Vb;return 0===c?0===b:0===b%c&&0<=b/c}function Pj(a,b){Nj.call(this,a,b)}t(Pj,Nj);Pj.prototype.apply=function(a){Oj(this,a.za)&&this.b.apply(a)};Pj.prototype.d=function(){return 5};function Qj(a,b){Nj.call(this,a,b)}t(Qj,Nj);Qj.prototype.apply=function(a){Oj(this,a.ab[a.e][a.d])&&this.b.apply(a)};Qj.prototype.d=function(){return 5};function Rj(a,b){Nj.call(this,a,b)}t(Rj,Nj);
Rj.prototype.apply=function(a){var b=a.I;null===b&&(b=a.I=a.b.parentNode.childElementCount-a.za+1);Oj(this,b)&&this.b.apply(a)};Rj.prototype.d=function(){return 4};function Sj(a,b){Nj.call(this,a,b)}t(Sj,Nj);Sj.prototype.apply=function(a){var b=a.$a;if(!b[a.e]){var c=a.b;do{var d=c.namespaceURI,e=c.localName,f=b[d];f||(f=b[d]={});f[e]=(f[e]||0)+1}while(c=c.nextElementSibling)}Oj(this,b[a.e][a.d])&&this.b.apply(a)};Sj.prototype.d=function(){return 4};function Tj(){this.b=null}t(Tj,V);
...
function Ck(){this.g=0;this.b={};this.jc={};this.f={};this.d={};this.Ba={};this.e={};this.ac={};this.Q=0}Ck.prototype.clone=function(){var a=new Ck;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b];Bk(this.jc,a.jc);Bk(this.f,a.f);Bk(this.d,a.d);Bk(this.Ba,a.Ba);Bk(this.e,a.e);Bk(this.ac,a.ac);a.Q=this.Q;return a};function Aj(a,b,c){var d=a[b];d&&(c=d.h(c));a[b]=c}
function Dk(a,b,c,d){this.k=a;this.h=b;this.Gb=c;this.Za=d;this.g=[[],[]];this.j={};this.w=this.u=this.b=null;this.ra=this.ca=this.O=this.e=this.d="";this.S=this.H=null;this.ma=this.Ta=!0;this.f={};this.B=[{}];this.D=[new kd("\u201c"),new kd("\u201d"),new kd("\u2018"),new kd("\u2019")];this.l=0;this.lang="";this.zb=[0];this.za=0;this.ka=[{}];this.ab=this.ka[0];this.I=null;this.xb=[this.I];this.yb=[{}];this.$a=this.ka[0];this.hb=[]}function bk(a,b){a.j[b]=(a.j[b]||0)+1}
...
function vl(a,b,c,d,e,f,g,h){this.Z=a;this.root=a.root;this.za=c;this.f=d;this.j=f;this.d=this.root;this.H={};this.I={};this.l={};this.w=[];this.k=this.D=this.B=null;this.O=new Dk(b,d,g,h);this.e=new dl;this.Na=!0;this.ca=[];this.ra=e;this.ma=this.ka=!1;this.b=a=xh(a,this.root);this.S={};this.g=new rl(d);fl(this.e,a);d=wl(this,this.root);Mk(this.O,this.root,d);xl(this,d,!1);this.u=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.u=
...
function Hl(a,b,c){var d=-1;if(b<=a.b&&(d=hl(a.e,b),d+=c,d<el(a.e)))return il(a.e,d);if(null==a.d)return Number.POSITIVE_INFINITY;for(var e=a.f;;){var f=a.d.firstChild;if(null==f)for(;;){if(1==a.d.nodeType){var f=a.O,g=a.d;if(f.hb.pop()!==g)throw Error("Invalid call to popElement");f.zb.pop();f.ka.pop();f.xb.pop();f.yb.pop();f.pop();Kk(f);a.Na=a.ca.pop();g=a.g.pop(a.b);f=null;g.d&&(f=ol(g.d,"before"),Ll(a,f,g.d.Ea?ul(a.g,g):g.d.offset,g.b),f=ol(g.d,"after"));f=nl(f,ol(g,"after"));Ll(a,f,a.b,g.b)}if(f=
a.d.nextSibling)break;a.d=a.d.parentNode;if(a.d===a.root)return a.d=null,b<a.b&&(0>d&&(d=hl(a.e,b),d+=c),d<=el(a.e))?il(a.e,d):Number.POSITIVE_INFINITY}a.d=f;if(1!=a.d.nodeType){a.b+=a.d.textContent.length;var f=a.g,g=a.d,h=sl(f);(f.Ea||f.Ia)&&kl(h)&&(h=ml(h,"white-space",Td).toString(),bi(g,ai(h))||(f.Ea=!1,f.Ia=!1));a.Na?fl(a.e,a.b):gl(a.e,a.b)}else{g=a.d;f=wl(a,g);a.ca.push(a.Na);Mk(a.O,g,f);(h=g.getAttribute("id")||g.getAttributeNS("http://www.w3.org/XML/1998/namespace","id"))&&h===a.k&&(a.k=
null);a.u||"body"!=g.localName||g.parentNode!=a.root||(xl(a,f,!0),a.u=!0);if(h=f["flow-into"]){var h=h.evaluate(e,"flow-into").toString(),l=Il(a,h,f,g,a.b);a.Na=!!a.ra[h];g=a.g.push(f,a.b,g===a.root,l)}else g=a.g.push(f,a.b,g===a.root);h=ul(a.g,g);Ll(a,g.e,h,g.b);g.f&&(l=ol(g.f,"after"),Ll(a,l,g.f.Ea?h:g.offset,g.b));a.Na&&ql(g)===K&&(a.Na=!1);if(xh(a.Z,a.d)!=a.b)throw Error("Inconsistent offset");a.I["e"+a.b]=f;a.b++;a.Na?fl(a.e,a.b):gl(a.e,a.b);if(b<a.b&&(0>d&&(d=hl(a.e,b),d+=c),d<=el(a.e)))return il(a.e,
d)}}}vl.prototype.h=function(a,b){var c=xh(this.Z,a),d="e"+c;b&&(c=yh(this.Z,a,0,!0));this.b<=c&&Hl(this,c,0);return this.I[d]};var Ml=1;function Nl(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.index=0;this.d=a;this.name=b;this.tb=c;this.Ba=d;this.parent=e;this.g="p"+Ml++;e&&(this.index=e.children.length,e.children.push(this))}Nl.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Nl.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Ol(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
...
function Tl(a,b,c,d,e,f,g){a=a instanceof Rl?a:new Rl(a,this);Nl.call(this,a,b,c,d,e);this.e=this;this.M=f;this.P=g;this.b.width=new U(le,0);this.b.height=new U(me,0);this.b["wrap-flow"]=new U(vd,0);this.b.position=new U(Xd,0);this.b.overflow=new U(ie,0);this.h={}}t(Tl,Nl);Tl.prototype.f=function(a){return new Ul(a,this)};Tl.prototype.clone=function(a){a=new Tl(this.d,this.name,a.tb||this.tb,this.Ba,this.parent,this.M,this.P);Ol(this,a);Pl(this,a);return a};
function Vl(a,b,c,d,e){Nl.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.h[b]=this.g);this.b["wrap-flow"]=new U(vd,0)}t(Vl,Nl);Vl.prototype.f=function(a){return new Wl(a,this)};Vl.prototype.clone=function(a){a=new Vl(a.parent.d,this.name,this.tb,this.Ba,a.parent);Ol(this,a);Pl(this,a);return a};function Xl(a,b,c,d,e){Nl.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.h[b]=this.g)}t(Xl,Nl);Xl.prototype.f=function(a){return new Yl(a,this)};
Xl.prototype.clone=function(a){a=new Xl(a.parent.d,this.name,this.tb,this.Ba,a.parent);Ol(this,a);Pl(this,a);return a};function W(a,b,c){return b&&b!==vd?b.ja(a,c):null}function Zl(a,b,c){return b&&b!==vd?b.ja(a,c):a.b}function $l(a,b,c){return b?b===vd?null:b.ja(a,c):a.b}function am(a,b,c,d){return b&&c!==K?b.ja(a,d):a.b}function bm(a,b,c){return b?b===je?a.g:b===Fd?a.f:b.ja(a,a.b):c}
...
function Bn(a,b,c,d){Bi.call(this,a);this.od=a.lastChild;this.f=b;this.ra=c;this.$a=d;this.Yd=a.ownerDocument;this.Jc=!1;this.ka=this.Oa=this.ta=this.ca=this.I=0;this.hb=this.xb=this.k=this.Za=null;this.pd=!1;this.g=this.e=this.w=null;this.Gd=!0;this.Kc=this.Mc=this.Lc=0}t(Bn,Bi);Bn.prototype.clone=function(){var a=new Bn(this.element,this.f,this.ra,this.$a);Gi(a,this);a.od=this.od;a.Jc=this.Jc;a.k=this.k?this.k.clone():null;a.xb=this.xb.concat();return a};
...
function Gn(a,b){if(b.f&&b.e&&!b.J&&0==b.f.count&&1!=b.A.nodeType){var c=b.A.textContent.match(Fn);return ln(a.f,b,c[0].length)}return M(b)}function Hn(a,b,c){var d=L("buildViewToNextBlockEdge");of(function(d){b.A&&c.push(oi(b));Gn(a,b).then(function(f){f!==b&&(b=f,c.push(oi(b)));hn(a.f,b).then(function(c){(b=c)?In(a.$a,b)?b.k&&!a.b?Jn(a,b).then(function(c){b=c;!b||b.d||0<a.f.e.b.length?P(d):qf(d)}):b.e?qf(d):P(d):(b=b.modify(),b.d=!0,P(d)):P(d)})})}).then(function(){O(d,b)});return N(d)}
function Kn(a,b){if(!b.A)return M(b);var c=b.Y,d=L("buildDeepElementView");of(function(d){Gn(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.Y!=c;)g=g.parent;if(null==g){b=f;P(d);return}}hn(a.f,f).then(function(f){(b=f)&&b.Y!=c?In(a.$a,b)?qf(d):(b=b.modify(),b.d=!0,P(d)):P(d)})})}).then(function(){O(d,b)});return N(d)}
...
function Rn(a,b,c){if(a=qn(a.ra,b))c.marginLeft=Z(a.marginLeft),c.O=Z(a.borderLeftWidth),c.h=Z(a.paddingLeft),c.marginTop=Z(a.marginTop),c.S=Z(a.borderTopWidth),c.j=Z(a.paddingTop),c.marginRight=Z(a.marginRight),c.Ta=Z(a.borderRightWidth),c.u=Z(a.paddingRight),c.marginBottom=Z(a.marginBottom),c.za=Z(a.borderBottomWidth),c.l=Z(a.paddingBottom)}function Sn(a,b,c){b=new zn(b,c,c);a.e?a.e.push(b):a.e=[b]}
function Tn(a,b,c,d){if(a.e&&a.e[a.e.length-1].b)return Sn(a,b,c),M(!0);d+=40*(a.b?-1:1);var e=a.k,f=!e;if(f){var g=a.element.ownerDocument.createElement("div");v(g,"position","absolute");var h=a.f.clone(),e=new Bn(g,h,a.ra,a.$a);a.k=e;e.b=mn(a.f,a.b,g);e.Jc=!0;a.b?(e.left=0,v(e.element,"width","2em")):(e.top=a.Oa,v(e.element,"height","2em"))}a.element.appendChild(e.element);Rn(a,e.element,e);g=(a.b?-1:1)*(d-a.ta);a.b?e.height=a.Za.R-a.Za.W-Ci(e)-Di(e):e.width=a.Za.V-a.Za.ba-Ei(e)-Fi(e);d=(a.b?-1:
1)*(a.Oa-d)-(a.b?Ei(e)-Fi(e):Ci(e)+Di(e));if(f&&18>d)return a.element.removeChild(e.element),a.k=null,Sn(a,b,c),M(!0);if(!a.b&&e.top<g)return a.element.removeChild(e.element),Sn(a,b,c),M(!0);var l=L("layoutFootnoteInner");a.b?Ii(e,0,d):Hi(e,g,d);e.B=a.B+a.left+Ei(a);e.D=a.D+a.top+Ci(a);e.H=a.H;var k=new ui(c);f?(Un(e),d=M(!0)):0==e.H.length?(Vn(e),d=M(!0)):d=Wn(e);d.then(function(){Xn(e,k).then(function(d){if(f&&d)a.element.removeChild(e.element),Sn(a,b,c),a.k=null,O(l,!0);else{a.b?(a.ka=a.Oa+(e.d+
Ei(e)+Fi(e)),Ii(e,0,e.d)):(a.ka=a.Oa-(e.d+Ci(e)+Di(e)),Hi(e,a.ka-a.ta,e.d));var g;!a.b&&0<e.H.length?g=Wn(e):g=M(d);g.then(function(d){d=new zn(b,c,d?d.Na:null);a.e?a.e.push(d):a.e=[d];O(l,!0)})}})});return N(l)}
...
1)*a.ta,w,(a.b?-1:1)*a.Oa);r=m;a.b&&(r=He(m));w=a.b?-1:1;r.W<a.Kc*w&&(x=r.R-r.W,r.W=a.Kc*w,r.R=r.W+x);Me(q,a.hb,r,e);a.b&&(m=new qe(-r.R,r.ba,-r.W,r.V));q=Qn(a,d);v(d,"width",m.V-m.ba-q.left-q.right+"px");v(d,"height",m.R-m.W-q.top-q.bottom+"px");v(d,"position","absolute");v(d,"display",b.display);w=null;p&&(p.H?w=p:w=si(p));w?(q=w.A.ownerDocument.createElement("div"),q.style.position="absolute",w.b?q.style.right="0":q.style.left="0",q.style.top="0",w.A.appendChild(q),p=q.getBoundingClientRect(),
w.A.removeChild(q)):p={left:a.b?a.Oa:a.I,right:a.b?a.ta:a.ca,top:a.b?a.I:a.ta};(w?w.b:a.b)?v(d,"right",p.right-m.V+a.u+"px"):v(d,"left",m.ba-p.left+a.h+"px");v(d,"top",m.W-p.top+a.j+"px");b.u&&(b.u.parentNode.removeChild(b.u),b.u=null);p=a.b?m.ba:m.R;m=a.b?m.V:m.W;Cn(a,p)&&0!=a.w.length?(b=b.modify(),b.d=!0,O(c,b)):(Mn(a),q=new qe(a.b?a.Oa:a.I,a.b?a.I:a.ta,a.b?a.ta:a.ca,a.b?a.ca:a.Oa),a.b&&(q=He(q)),Ne(q,a.hb,r,e),Nn(a),"left"==e?a.Lc=p:a.Mc=p,a.Kc=m,$n(a,p),O(c,k))}});return N(c)}
...
function oo(a,b,c){function d(){b=k[0]||b;b.A.parentNode.removeChild(b.A);e.g=h}var e=a,f=L("skipEdges"),g=c&&b&&b.J,h=null,l=null,k=[],m=[],p=!1;of(function(a){for(;b;){do if(b.A){if(b.e&&1!=b.A.nodeType){if(bi(b.A,b.w))break;if(!b.J){!c&&pl[h]?d():mo(e,l,null,!0,h)?(b=(l||b).modify(),b.d=!0):(b=b.modify(),b.h=h);P(a);return}}if(!b.J&&(b.l&&no(e,b),b.k||b.B)){k.push(oi(b));h=nl(h,b.h);if(!c&&pl[h])d();else if(mo(e,l,null,!0,h)||!In(e.$a,b))b=(l||b).modify(),b.d=!0;P(a);return}if(1==b.A.nodeType){var f=
b.A.style;if(b.J){if(p){if(!c&&pl[h]){d();P(a);return}k=[];g=c=!1;h=null}p=!1;l=oi(b);m.push(l);h=nl(h,b.D);if(f&&(!lo(f.paddingBottom)||!lo(f.borderBottomWidth))){if(mo(e,l,null,!0,h)){b=(l||b).modify();b.d=!0;P(a);return}m=[l];l=null}}else{k.push(oi(b));h=nl(h,b.h);if(!In(e.$a,b)){mo(e,l,null,!1,h);b=b.modify();b.d=!0;P(a);return}if(un[b.A.localName]){!c&&pl[h]?d():mo(e,l,null,!0,h)&&(b=(l||b).modify(),b.d=!0);P(a);return}!f||lo(f.paddingTop)&&lo(f.borderTopWidth)||(g=!1,m=[]);p=!0}}}while(0);f=
...
function Vn(a){var b=a.element.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.j+"px";b.style.right=a.u+"px";b.style.bottom=a.l+"px";b.style.left=a.h+"px";a.element.appendChild(b);var c=b.getBoundingClientRect();a.element.removeChild(b);var b=a.B+a.left+Ei(a),d=a.D+a.top+Ci(a);a.Za=new qe(b,d,b+a.width,d+a.height);a.I=c?a.b?c.top:c.left:0;a.ca=c?a.b?c.bottom:c.right:0;a.ta=c?a.b?c.right:c.top:0;a.Oa=c?a.b?c.left:c.bottom:0;a.Lc=a.ta;a.Mc=a.ta;a.Kc=a.ta;a.ka=a.Oa;c=a.Za;
b=a.B+a.left+Ei(a);d=a.D+a.top+Ci(a);if(a.yb){for(var e=a.yb,f=[],g=0;g<e.b.length;g++){var h=e.b[g];f.push(new re(h.x+b,h.y+d))}b=new we(f)}else b=ze(b,d,b+a.width,d+a.height);a.hb=Je(c,[b],a.H,a.ab,a.b);Nn(a);a.e=null}function Un(a){a.xb=[];v(a.element,"width",a.width+"px");v(a.element,"height",a.height+"px");Vn(a);a.d=0;a.pd=!1;a.g=null}function $n(a,b){a.d=Math.max((a.b?-1:1)*(b-a.ta),a.d)}
...
function Xn(a,b,c){a.xb.push(b);if(a.pd)return M(b);var d=L("layout");qo(a,b).then(function(){En(a,b.Na).then(function(b){var f=b;a.w=[];of(function(d){for(;b;){var h=!0;po(a,b,c).then(function(l){c=!1;b=l;0<a.f.e.b.length?P(d):a.g?P(d):b&&b.d?jo(a,b,f).then(function(a){b=a;P(d)}):h?h=!1:qf(d)});if(h){h=!1;return}}P(d)}).then(function(){var c=a.k;c&&(a.element.appendChild(c.element),a.b?a.d=this.ta-this.Oa:a.d=c.top+Ci(c)+c.d+Di(c));if(b)if(0<a.f.e.b.length)O(d,null);else{a.pd=!0;c=new ui(qi(b));
...
"pt")));return b}function Wo(a,b){var c={},d=a.Ab.C*pc(b,a.Ab.aa,!1),e=a.lb.C*pc(b,a.lb.aa,!1),f=d+e,g=a.width;c.qb=g===le?(b.T.Ya?Math.floor(b.za/2)-b.T.Mb:b.za)-2*f:g.C*pc(b,g.aa,!1);g=a.height;c.pb=g===me?b.hb-2*f:g.C*pc(b,g.aa,!1);c.Ab=d;c.lb=e;c.Rc=f;return c}function Xo(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
...
Di(d))}})}function sp(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=tp(d,g.length?new qp(g):null,b);g.Sa&&(f.center=g.Sa);d=g.Sa||d.d();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=tp(c,e,b),c.Sa&&(f.start=c.Sa),c.mc&&(f.end=c.mc);return f}
function tp(a,b,c){var d={Sa:null,mc:null};if(a&&b)if(a.b()&&b.b()){var e=a.e(),f=b.e();0<e&&0<f?(f=e+f,f<c?d.Sa=c*e/f:(a=a.f(),b=b.f(),b=a+b,b<c?d.Sa=a+(c-b)*(e-a)/(f-b):0<b&&(d.Sa=c*a/b)),0<d.Sa&&(d.mc=c-d.Sa)):0<e?d.Sa=c:0<f&&(d.mc=c)}else a.b()?d.Sa=Math.max(c-b.d(),0):b.b()&&(d.mc=Math.max(c-a.d(),0));else a?a.b()&&(d.Sa=c):b&&b.b()&&(d.mc=c);return d}kp.prototype.sb=function(a,b,c,d,e){kp.Td.sb.call(this,a,b,c,d,e);b.element.setAttribute("data-vivliostyle-page-box",!0)};
...
function vp(a,b,c){function d(a){if(x)return x;x={da:q?q.evaluate(a):null,La:l?l.evaluate(a):null,Ma:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[r,m,p,w].forEach(function(b){b&&(c+=b.evaluate(a))});(null===x.La||null===x.Ma)&&c+x.da+x.La+x.Ma>b&&(null===x.La&&(x.La=0),null===x.Ma&&(x.Ie=0));null!==x.da&&null!==x.La&&null!==x.Ma&&(x.Ma=null);null===x.da&&null!==x.La&&null!==x.Ma?x.da=b-c-x.La-x.Ma:null!==x.da&&null===x.La&&null!==x.Ma?x.La=b-c-x.da-x.Ma:null!==x.da&&null!==x.La&&null===x.Ma?x.Ma=
b-c-x.da-x.La:null===x.da?(x.La=x.Ma=0,x.da=b-c):x.La=x.Ma=(b-c-x.da)/2;return x}var e=a.style;a=a.d.d;var f=b.Yc,g=b.bd;b=b.da;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],l=$l(a,e["margin-"+f],h),k=$l(a,e["margin-"+g],h),m=Zl(a,e["padding-"+f],h),p=Zl(a,e["padding-"+g],h),r=am(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),w=am(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),q=W(a,e[b],h),x=null;e[b]=new I(new ic(a,function(){var a=d(this).da;return null===a?0:a},b));e["margin-"+
f]=new I(new ic(a,function(){var a=d(this).La;return null===a?0:a},"margin-"+f));e["margin-"+g]=new I(new ic(a,function(){var a=d(this).Ma;return null===a?0:a},"margin-"+g));"left"===f?e.left=new I(C(a,c.marginLeft,c.Jb)):"top"===f&&(e.top=new I(C(a,c.marginTop,c.Ib)))}n.Wc=function(){var a=this.e.j;this.j.wa?vp(this,{Yc:"right",bd:"left",da:"width"},a):this.j.xa?vp(this,{Yc:"left",bd:"right",da:"width"},a):this.la({start:"left",end:"right",da:"width"},a)};
n.Xc=function(){var a=this.e.j;this.j.ya?vp(this,{Yc:"bottom",bd:"top",da:"height"},a):this.j.va?vp(this,{Yc:"top",bd:"bottom",da:"height"},a):this.la({start:"top",end:"bottom",da:"height"},a)};n.tc=function(a,b,c,d,e,f,g){Yl.prototype.tc.call(this,a,b,c,d,e,f,g);a=c.u;c=this.d.j;d=this.j;d.wa||d.xa?d.ya||d.va||(d.wa?a.left[c]=b:d.xa&&(a.right[c]=b)):d.ya?a.top[c]=b:d.va&&(a.bottom[c]=b)};
...
function Pp(a,b,c,d,e,f,g,h,l,k,m){nc.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.Z=b;this.lang=b.lang||c;this.viewport=d;this.g={body:!0};this.e=e;this.k=this.b=this.B=this.d=this.u=null;this.l=0;this.ab=f;this.h=new nh(this.style.l);this.ka={};this.O=null;this.f=m;this.I={};this.ca=null;this.Ta=g;this.$a=h;this.ma=l;this.Za=k;for(var p in a.f)(b=a.f[p]["flow-consume"])&&(b.evaluate(this,"flow-consume")==td?this.g[p]=!0:delete this.g[p]);this.ra={}}t(Pp,nc);
function Qp(a){var b=L("StyleInstance.init"),c=new Rm(a.f,a.Z.url),d=new Sm(a.f,a.Z.url,a.style.d,a.style.b);a.d=new vl(a.Z,a.style.e,a.style.d,a,a.g,a.style.j,c,d);d.f=a.d;Jl(a.d,a);a.B={};a.B[a.Z.url]=a.d;var e=Gl(a.d);a.ca=Po(e);a.u=new zm(a.style.B);c=new Dk(a.style.e,a,c,d);a.u.h(c,e);ym(a.u,a);a.O=new wp(c,a.style.b,a.u,a,e);e=[];for(c=0;c<a.style.g.length;c++)if(d=a.style.g[c],!d.M||d.M.evaluate(a))d=kh(d.Cb,a),d=new lh(d),e.push(d);th(a.ab,e,a.h).ua(b);var f=a.style.w;Object.keys(f).forEach(function(a){var b=
Wo(Vo(f[a]),this);this.ra[a]={width:b.qb+2*b.Rc,height:b.pb+2*b.Rc}},a);return N(b)}function Kl(a,b,c){if(a=a.b)a.e[b.b]||(a.e[b.b]=c),c=a.b[b.b],c||(c=new xi,a.b[b.b]=c),c.b.push(new wi(new ui({ha:[{ga:b.element,Ha:0,fa:null,sa:null,pa:null}],ea:0,J:!1}),b))}function Rp(a,b){for(var c=Number.POSITIVE_INFINITY,d=0;d<b.b.length;d++){for(var e=b.b[d].d.Na,f=e.ha[0].ga,g=e.ea,h=e.J,l=0;f.ownerDocument!=a.Z.b;)l++,f=e.ha[l].ga,h=!1,g=0;e=yh(a.Z,f,g,h);e<c&&(c=e)}return c}
...
c.clone();h=a;l=h.b.page;k=void 0;for(k in h.b.b)for(m=h.b.b[k],p=m.b.length-1;0<=p;p--){var r=m.b[p];0>r.b.Qa&&r.b.d<h.l&&(r.b.Qa=l)}oc(a,a.style.b);h=km(f,a,"enabled");if(!h||h===je){c=a;u.debug("Location - page",c.b.page);u.debug("  current:",d);u.debug("  lookup:",c.l);d=void 0;for(d in c.b.b)for(e=c.b.b[d],g=0;g<e.b.length;g++)u.debug("  Chunk",d+":",e.b[g].b.d);d=a.O;e=f;f=b;c=e.d;0===Object.keys(f).length?(c.d.e=c,f=e):(e=c,g=yp(d,f),e=e.g+"^"+g,g=d.g[e],g||("background-host"===c.tb?(c=d,f=
...
L("layoutContainer.inner"),X=l.toString(),ga=Y(c,a,"column-count"),Ka=Y(c,a,"column-gap"),la=1<ga?Y(c,a,"column-width"):q.width,l=jm(c,a),E=0,w=km(c,a,"shape-inside"),J=pg(w,0,0,q.width,q.height,a),Al=new Pm(X,a,a.viewport,a.d,l,a.Z,a.h,a.style.u,a,b,a.Ta,a.$a,h,a.Za),Cl=new ro(a.f,a.b.page-1),di=0,da=null;of(function(b){for(;di<ga;){var c=di++;if(1<ga){var d=a.viewport.b.createElement("div");v(d,"position","absolute");r.appendChild(d);da=new Bn(d,Al,a.e,Cl);da.b=q.b;da.ab=q.ab;da.Gb=q.Gb;q.b?(v(d,
...
h.b.length){l=l.concat(Vi(h));h.b.splice(0,h.b.length);c=a.b=a.k.clone();for(var e;e=b.d.lastChild;)b.d.removeChild(e);qf(d)}else P(d)})}).then(function(){e.S(a,b,a.e);var d=new Sc(e.d.d,"left-page");b.j=d.evaluate(a)?"left":"right";var d=a.b.page,f;for(f in a.b.b)for(var g=a.b.b[f],h=g.b.length-1;0<=h;h--){var l=g.b[h];0<=l.b.Qa&&l.b.Qa+l.b.h-1<=d&&g.b.splice(h,1)}a.b=a.k=null;c.d=a.d.b;$h(b,a.style.h.D[a.Z.url]);var x;a:{for(x in a.g)if((f=c.b[x])&&0<f.b.length){x=!1;break a}x=!0}x&&(c=null);O(k,
...
t($p,Df);$p.prototype.error=function(a){u.b("CSS parser:",a)};function aq(a,b){return bq(b,a)}function cq(a){uf.call(this,aq,"document");this.H=a;this.B={};this.h={};this.b={};this.D={};this.f=null;this.j=[]}t(cq,uf);function dq(a){var b=va("user-agent.xml",ua),c=L("OPSDocStore.init");vf(gh).then(function(d){a.f=d;vf(Kp).then(function(){a.load(b).then(function(){O(c,!0)})})});return N(c)}function eq(a,b){a.j.push({url:b.url,text:b.text,bb:"User",Ba:null,media:null})}
...
k&&"viewport"==g.getAttribute("name")&&r.push({url:d,text:Zp(g),bb:"Author",M:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==h?"stylesheet"==k&&"text/css"==g.getAttribute("type")&&r.push({url:d,text:g.textContent,bb:"Author",Ba:null,media:null}):"http://example.com/sse"==h&&"property"===k&&(h=g.getElementsByTagName("name")[0])&&"stylesheet"===h.textContent&&(g=g.getElementsByTagName("value")[0])&&(g=va(g.textContent,d),r.push({url:g,text:null,Ba:null,media:null,bb:"Author"}));
for(var w="",h=0;h<r.length;h++)w+=r[h].url,w+="^",r[h].text&&(w+=r[h].text),w+="^";var q=a.B[w];q?(a.b[d]=q,O(c,b)):(f=a.h[w],f||(f=new xf(function(){var b=L("fetchStylesheet"),c=0,d=new $p(a.f);nf(function(){if(c<r.length){var a=r[c++];d.Pb(a.bb);return null!==a.text?hg(a.text,d,a.url,a.Ba,a.media).kd(!0):gg(a.url,d,a.Ba,a.media)}return M(!1)}).then(function(){q=new Lp(a,d.g,d.j,d.D.g,d.w,d.k,d.l,d.h,d.B,d.u);a.B[w]=q;delete a.h[w];O(b,q)});return N(b)},"FetchStylesheet "+d),a.h[w]=f,f.start()),
vf(f).then(function(f){a.b[d]=f;O(c,b)}))}else O(c,null)});return N(c)};function fq(a,b,c,d,e,f,g,h,l,k){this.b=a;this.url=b;this.lang=c;this.d=d;this.h=e;this.T=Xb(f);this.j=g;this.g=h;this.f=l;this.e=k;this.Ja=this.page=null}function gq(a,b,c){if(0!=c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=Ha(d,"height","auto")&&(v(d,"height","auto"),gq(a,d,c));"absolute"==Ha(d,"position","static")&&(v(d,"position","relative"),gq(a,d,c))}}
function hq(a){var b=a.target,c="\u25b8"==b.textContent;b.textContent=c?"\u25be":"\u25b8";for(b=b.parentNode.firstChild;b;)if(1!=b.nodeType)b=b.nextSibling;else{var d=b;"toc-container"==d.getAttribute("data-adapt-class")?b=d.firstChild:("toc-node"==d.getAttribute("data-adapt-class")&&(d.style.height=c?"auto":"0px"),b=b.nextSibling)}a.stopPropagation()}
fq.prototype.$c=function(a){var b=this.j.$c(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",v(e,"cursor","pointer"),e.addEventListener("click",hq,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
fq.prototype.yc=function(a,b,c,d,e){if(this.page)return M(this.page);var f=this,g=L("showTOC"),h=new Wh(a,a);this.page=h;this.b.load(this.url).then(function(d){var k=f.b.b[d.url],m=Op(k,c,1E5,e);b=new rn(b.f,m.fontSize,b.root,m.width,m.height);var p=new Pp(k,d,f.lang,b,f.d,f.h,f.$c(d),f.g,0,f.f,f.e);f.Ja=p;p.T=f.T;Qp(p).then(function(){Wp(p,h,null).then(function(){gq(f,a,2);O(g,h)})})});return N(g)};
fq.prototype.uc=function(){if(this.page){var a=this.page;this.Ja=this.page=null;v(a.N,"visibility","none");var b=a.N.parentNode;b&&b.removeChild(a.N)}};fq.prototype.zd=function(){return!!this.page};function iq(){cq.call(this,jq(this));this.d=new uf(Gh,"document");this.u=new uf(yf,"text");this.w={};this.O={};this.k={};this.l={}}t(iq,cq);function jq(a){return function(b){return a.k[b]}}
function kq(a,b,c){var d=L("loadEPUBDoc");"/"!==b.substring(b.length-1)&&(b+="/");c&&a.u.rc(b+"?r=list");a.d.rc(b+"META-INF/encryption.xml");var e=b+"META-INF/container.xml";a.d.load(e,!0,"Failed to fetch EPUB container.xml from "+e).then(function(f){if(f){f=Qh(vh(vh(vh(new wh([f.b]),"container"),"rootfiles"),"rootfile"),"full-path");for(var g=0;g<f.length;g++){var h=f[g];if(h){lq(a,b,h,c).ua(d);return}}O(d,null)}else u.error("Received an empty response for EPUB container.xml "+e+". This may be caused by the server not allowing cross origin requests.")});
return N(d)}function lq(a,b,c,d){var e=b+c,f=a.w[e];if(f)return M(f);var g=L("loadOPF");a.d.load(e,void 0,void 0).then(function(c){c?a.d.load(b+"META-INF/encryption.xml",void 0,void 0).then(function(l){(d?a.u.load(b+"?r=list"):M(null)).then(function(d){f=new mq(a,b);nq(f,c,l,d,b+"?r=manifest").then(function(){a.w[e]=f;a.O[b]=f;O(g,f)})})}):u.error("Received an empty response for EPUB OPF "+e+". This may be caused by the server not allowing cross origin requests.")});return N(g)}
function oq(a,b,c){var d=L("EPUBDocStore.load");b=ta(b);(a.l[b]=bq(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,xc:null})).ua(d);return N(d)}
iq.prototype.load=function(a){var b=ta(a);if(a=this.l[b])return a.Ca()?a:M(a.Ub());var c=L("EPUBDocStore.load");a=iq.Td.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?O(c,a):u.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return N(c)};function pq(){this.id=null;this.src="";this.f=this.d=null;this.F=-1;this.h=0;this.j=null;this.b=this.e=0;this.Db=this.Qa=null;this.g=Ua}
function qq(a){return a.id}function rq(a){var b=Qe(a);return function(a){var d=L("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));tf(e).then(function(a){a=new DataView(a);for(var c=0;c<a.byteLength;c++){var e=a.getUint8(c),e=e^b[c%20];a.setUint8(c,e)}O(d,sf([a,f]))});return N(d)}}
var sq={dcterms:"http://purl.org/dc/terms/",marc:"http://id.loc.gov/vocabulary/",media:"http://www.idpf.org/epub/vocab/overlays/#",onix:"http://www.editeur.org/ONIX/book/codelists/current.html#",xsd:"http://www.w3.org/2001/XMLSchema#"},tq=sq.dcterms+"language",uq=sq.dcterms+"title";
function vq(a,b){var c={};return function(d,e){var f,g,h=d.r||c,l=e.r||c;if(a==uq&&(f="main"==h["http://idpf.org/epub/vocab/package/#title-type"],g="main"==l["http://idpf.org/epub/vocab/package/#title-type"],f!=g))return f?-1:1;f=parseInt(h["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(f)&&(f=Number.MAX_VALUE);g=parseInt(l["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(g)&&(g=Number.MAX_VALUE);return f!=g?f-g:a!=tq&&b&&(f=(h[tq]||h["http://idpf.org/epub/vocab/package/#alternate-script"])==
b,g=(l[tq]||l["http://idpf.org/epub/vocab/package/#alternate-script"])==b,f!=g)?f?-1:1:d.o-e.o}}
function wq(a,b){function c(a){for(var b in a){var d=a[b];d.sort(vq(b,k));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return Xa(a,function(a){return Wa(a,function(a){var b={v:a.value,o:a.Q};a.Je&&(b.s=a.scheme);if(a.id||a.lang){var c=l[a.id];if(c||a.lang)a.lang&&(a={name:tq,value:a.lang,lang:null,id:null,gd:a.id,scheme:null,Q:a.Q},c?c.push(a):c=[a]),c=Va(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in sq)f[g]=sq[g];for(;null!=(g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/));)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=sq;var h=1;g=Oh(Ph(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),Q:h++,gd:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:sq.dcterms+a.localName,Q:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),gd:null,scheme:null};return null});var l=Va(g,function(a){return a.gd});g=d(Va(g,function(a){return a.gd?null:a.name}));var k=null;g[tq]&&(k=g[tq][0].v);c(g);return g}function xq(){var a=window.MathJax;return a?a.Hub:null}var yq={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function mq(a,b){this.f=a;this.h=this.d=this.b=this.g=this.e=null;this.l=b;this.k=null;this.I={};this.lang=null;this.w=0;this.u={};this.O=this.H=this.S=null;this.B={};this.D=null;this.j=zq(this);xq()&&(aj["http://www.w3.org/1998/Math/MathML"]=!0)}
function zq(a){function b(){}b.prototype.ld=function(a,b){return encodeURIComponent(b+(a?"#"+a:""))};b.prototype.b=function(b,d){var e=b.match(/^([^#]*)#?(.*)$/);if(e){var f=e[1]||d,e=e[2];if(f&&a.g.some(function(a){return a.src===f}))return"#"+this.ld(e,f)}return b};b.prototype.ke=function(a){"#"===a.charAt(0)&&(a=a.substring(1));return(a=decodeURIComponent(a).match(/^([^#]*)#?(.*)$/))?[a[1],a[2]]:[]};return new b}
function Aq(a,b){return a.l?b.substr(0,a.l.length)==a.l?decodeURI(b.substr(a.l.length)):null:b}
function nq(a,b,c,d,e){a.e=b;var f=vh(new wh([b.b]),"package"),g=Qh(f,"unique-identifier")[0];g&&(g=Ch(b,b.url+"#"+g))&&(a.k=g.textContent.replace(/[ \n\r\t]/g,""));var h={};a.g=Wa(Mh(vh(vh(f,"manifest"),"item")),function(c){var d=new pq,e=b.url;d.id=c.getAttribute("id");d.src=va(c.getAttribute("href"),e);d.d=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.g=f}(c=c.getAttribute("fallback"))&&!yq[d.d]&&(h[d.src]=c);!a.H&&
d.g.nav&&(a.H=d);!a.O&&d.g["cover-image"]&&(a.O=d);return d});a.d=Ta(a.g,qq);a.h=Ta(a.g,function(b){return Aq(a,b.src)});for(var l in h)for(g=l;;){g=a.d[h[g]];if(!g)break;if(yq[g.d]){a.B[l]=g.src;break}g=g.src}a.b=Wa(Mh(vh(vh(f,"spine"),"itemref")),function(b,c){var d=b.getAttribute("idref");if(d=a.d[d])d.f=b,d.F=c;return d});if(l=Qh(vh(f,"spine"),"toc")[0])a.S=a.d[l];if(l=Qh(vh(f,"spine"),"page-progression-direction")[0]){a:switch(l){case "ltr":l="ltr";break a;case "rtl":l="rtl";break a;default:throw Error("unknown PageProgression: "+
l);}a.D=l}var g=c?Qh(vh(vh(Lh(vh(vh(new wh([c.b]),"encryption"),"EncryptedData"),Kh()),"CipherData"),"CipherReference"),"URI"):[],k=Mh(vh(vh(f,"bindings"),"mediaType"));for(c=0;c<k.length;c++){var m=k[c].getAttribute("handler");(l=k[c].getAttribute("media-type"))&&m&&a.d[m]&&(a.I[l]=a.d[m].src)}a.u=wq(vh(f,"metadata"),Qh(f,"prefix")[0]);a.u[tq]&&(a.lang=a.u[tq][0].v);if(!d){if(0<g.length&&a.k)for(d=rq(a.k),c=0;c<g.length;c++)a.f.k[a.l+g[c]]=d;return M(!0)}f=new Ia;k={};if(0<g.length&&a.k)for(l="1040:"+
Re(a.k),c=0;c<g.length;c++)k[g[c]]=l;for(c=0;c<d.length;c++){var p=d[c];if(m=p.n){var r=decodeURI(m),g=a.h[r];l=null;g&&(g.j=0!=p.m,g.h=p.c,g.d&&(l=g.d.replace(/\s+/g,"")));g=k[r];if(l||g)f.append(m),f.append(" "),f.append(l||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}Bq(a);return rf(e,"","POST",f.toString(),"text/plain")}function Bq(a){for(var b=0,c=0;c<a.b.length;c++){var d=a.b[c],e=Math.ceil(d.h/1024);d.e=b;d.b=e;b+=e}a.w=b}
function Cq(a,b,c){a.d={};a.h={};a.g=[];a.b=a.g;var d=a.e=new uh(null,"",(new DOMParser).parseFromString("<spine></spine>","text/xml"));b.forEach(function(a){var b=new pq;b.F=a.index;b.id="item"+(a.index+1);b.src=a.url;b.Qa=a.Qa;b.Db=a.Db;var c=d.b.createElement("itemref");c.setAttribute("idref",b.id);d.root.appendChild(c);b.f=c;this.d[b.id]=b;this.h[a.url]=b;this.g.push(b)},a);return c?oq(a.f,b[0].url,c):M(null)}
function Dq(a,b,c){var d=a.b[b],e=L("getCFI");a.f.load(d.src).then(function(a){var b=Ah(a,c),h=null;b&&(a=yh(a,b,0,!1),h=new ib,lb(h,b,c-a),d.f&&lb(h,d.f,0),h=h.toString());O(e,h)});return N(e)}
function Eq(a,b){return Xe("resolveFragment",function(c){if(b){var d=new ib;jb(d,b);var e;if(a.e){var f=kb(d,a.e.b);if(1!=f.ga.nodeType||f.J||!f.dc){O(c,null);return}var g=f.ga,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.d[h]){O(c,null);return}e=a.d[h];d=f.dc}else e=a.b[0];a.f.load(e.src).then(function(a){var b=kb(d,a.b);a=yh(a,b.ga,b.offset,b.J);O(c,{F:e.F,na:a,G:-1})})}else O(c,null)},function(a,d){u.b(d,"Cannot resolve fragment:",b);O(a,null)})}
function Fq(a,b){return Xe("resolveEPage",function(c){if(0>=b)O(c,{F:0,na:0,G:-1});else{var d=Ra(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.f.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=zh(a),g=Math.round(a*b/e.b),g==a&&g--);O(c,{F:d,na:g,G:-1})})}},function(a,d){u.b(d,"Cannot resolve epage:",b);O(a,null)})}
function Gq(a,b){var c=a.b[b.F];if(0>=b.na)return M(c.e);var d=L("getEPage");a.f.load(c.src).then(function(a){a=zh(a);var f=Math.min(a,b.na);O(d,c.e+f*c.b/a)});return N(d)}function Hq(a,b,c,d,e){this.b=a;this.viewport=b;this.g=c;this.h=e;this.Nb=[];this.na=this.G=this.F=0;this.T=Xb(d);this.f=new on(b.f);this.d=new zo(a.j)}function Iq(a){var b=a.Nb[a.F];return b?b.rb[a.G]:null}n=Hq.prototype;n.ob=function(){if(this.b.D)return this.b.D;var a=this.Nb[this.F];return a?a.Ja.ca:null};
...
function Kq(a,b,c){var d=L("renderSinglePage"),e=Lq(a,b,c);Wp(b.Ja,e,c).then(function(f){var g=(c=f)?c.page-1:b.Ka.length-1;Jq(a,b,e,g);Do(a.d,a.F,g);var h=a.F,l=a.G,k=a.na;f=null;if(c){var m=b.Ka[c.page];b.Ka[c.page]=c;m&&b.rb[c.page]&&!Ai(c,m)&&(a.G=c.page,f=Kq(a,b,c))}f||(f=M(!0));f.then(function(){var b=Eo(a.d,e),f=0;of(function(c){f++;if(f>b.length)P(c);else{var d=b[f-1];d.wc=d.wc.filter(function(a){return!a.ec});0===d.wc.length?qf(c):(a.F=d.F,a.G=d.G,Mq(a).then(function(b){b?(Co(a.d,d.cd),Fo(a.d,
d.wc),Kq(a,b,b.Ka[a.G]).then(function(){var b=a.d;b.b=b.u.pop();b=a.d;b.e=b.B.pop();qf(c)})):qf(c)}))}}).then(function(){a.F=h;a.G=l;a.na=k;O(d,{page:e,position:c,G:g})})})});return N(d)}
function Nq(a){var b=L("renderPage");Mq(a).then(function(c){if(c){var d=-1;if(0>a.G){var d=a.na,e=Ra(c.Ka.length,function(a){return Sp(c.Ja,c.Ka[a])>d});a.G=e==c.Ka.length?Number.POSITIVE_INFINITY:e-1}var f=c.rb[a.G];f?(a.na=f.offset,O(b,f)):of(function(b){if(a.G<c.Ka.length)P(b);else if(c.complete)a.G=c.Ka.length-1,P(b);else{var e=c.Ka[c.Ka.length-1];Kq(a,c,e).then(function(l){var k=l.page;e=l.position;l=l.G;e?0<=d&&Sp(c.Ja,e)>d?(f=k,a.G=c.Ka.length-2,P(b)):qf(b):(f=k,a.G=l,0>d&&(a.na=k.offset),
c.complete=!0,k.k=c.item.F==a.b.b.length-1,P(b))})}}).then(function(){f=f||c.rb[a.G];var e=c.Ka[a.G];0>d&&(a.na=Sp(c.Ja,e));f?O(b,f):Kq(a,c,e).then(function(d){var f=d.page;e=d.position;e||(c.complete=!0,f.k=c.item.F==a.b.b.length-1);O(b,f)})})}else O(b,null)});return N(b)}n.hd=function(){return Oq(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};
function Oq(a,b,c){var d=L("renderAllPages"),e=a.F,f=a.G;a.F=0;of(function(d){a.G=a.F==b?c:Number.POSITIVE_INFINITY;Nq(a).then(function(){++a.F>b?P(d):qf(d)})}).then(function(){a.F=e;a.G=f;Nq(a).ua(d)});return N(d)}n.$d=function(){this.G=this.F=0;return Nq(this)};n.ae=function(){this.F=this.b.b.length-1;this.G=Number.POSITIVE_INFINITY;return Nq(this)};
n.nextPage=function(){var a=this,b=L("nextPage");Mq(a).then(function(c){if(c){if(c.complete&&a.G==c.Ka.length-1){if(a.F>=a.b.b.length-1){O(b,null);return}a.F++;a.G=0}else a.G++;Nq(a).ua(b)}else O(b,null)});return N(b)};n.fd=function(){if(0==this.G){if(0==this.F)return M(null);this.F--;this.G=Number.POSITIVE_INFINITY}else this.G--;return Nq(this)};function Pq(a,b){var c="left"===b.j,d="ltr"===a.ob();return!c&&d||c&&!d}
function Qq(a){var b=L("getCurrentSpread"),c=Iq(a);if(!c)return M({left:null,right:null});var d=a.F,e=a.G,f="left"===c.j;(Pq(a,c)?a.fd():a.nextPage()).then(function(g){a.F=d;a.G=e;Nq(a).then(function(){f?O(b,{left:c,right:g}):O(b,{left:g,right:c})})});return N(b)}n.fe=function(){var a=Iq(this);if(!a)return M(null);var a=Pq(this,a),b=this.nextPage();if(a)return b;var c=this;return b.Gc(function(){return c.nextPage()})};
n.ie=function(){var a=Iq(this);if(!a)return M(null);var a=Pq(this,a),b=this.fd();if(a){var c=this;return b.Gc(function(){return c.fd()})}return b};function Rq(a,b){var c=L("navigateToEPage");Fq(a.b,b).then(function(b){b&&(a.F=b.F,a.G=b.G,a.na=b.na);Nq(a).ua(c)});return N(c)}function Sq(a,b){var c=L("navigateToCFI");Eq(a.b,b).then(function(b){b&&(a.F=b.F,a.G=b.G,a.na=b.na);Nq(a).ua(c)});return N(c)}
function Tq(a,b){u.debug("Navigate to",b);var c=Aq(a.b,ta(b));if(!c){if(a.b.e&&b.match(/^#epubcfi\(/))c=Aq(a.b,a.b.e.url);else if("#"===b.charAt(0)){var d=a.b.j.ke(b);a.b.e?c=Aq(a.b,d[0]):c=d[0];b=c+(d[1]?"#"+d[1]:"")}if(null==c)return M(null)}d=a.b.h[c];if(!d)return a.b.e&&c==Aq(a.b,a.b.e.url)&&(c=b.indexOf("#"),0<=c)?Sq(a,b.substr(c+1)):M(null);d.F!=a.F&&(a.F=d.F,a.G=0);var e=L("navigateTo");Mq(a).then(function(c){var d=Ch(c.Z,b);d&&(a.na=xh(c.Z,d),a.G=-1);Nq(a).ua(e)});return N(e)}
function Lq(a,b,c){var d=b.Ja.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.style.position="absolute";e.style.top="0";e.style.left="0";ka||(e.style.visibility="hidden");d.root.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);var g=new Wh(e,f);g.F=b.item.F;g.position=c;g.offset=Sp(b.Ja,c);0===g.offset&&(b=a.b.j.ld("",b.item.src),f.setAttribute("id",b),Zh(g,f,b));d!==a.viewport&&(a=$b(a.viewport.width,
a.viewport.height,d.width,d.height),a=ig(null,new Tb(a,null)),g.h.push(new Th(e,"transform",a)));return g}function Uq(a,b){var c=xq();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=L("navigateToEPage"),f=gf(c);d.Push(function(){f.Wa(e)});return N(c)}return M(null)}
n.$c=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=va(f,a.url),g=c.getAttribute("media-type");if(!g){var h=Aq(b.b,f);h&&(h=b.b.h[h])&&(g=h.d)}if(g&&(h=b.b.I[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Na(f),l=Na(g),g=new Ia;g.append(h);g.append("?src=");g.append(f);g.append("&type=");g.append(l);for(h=c.firstChild;h;h=h.nextSibling)1==h.nodeType&&
...
c.namespaceURI)e=Uq(c,d);else if("http://example.com/sse"==c.namespaceURI){e=d?d.ownerDocument:b.viewport.b;g=c.localName;switch(g){case "t":case "tab":case "ec":case "nt":case "fraction":case "comment":case "mark":g="span";break;case "ruby":case "rp":case "rt":break;default:g="div"}e=e.createElement(g);e.setAttribute("data-adapt-process-children","true");e=M(e)}else e=c.dataset&&"true"==c.dataset.mathTypeset?Uq(c,d):M(null);return e}};
function Mq(a){if(a.F>=a.b.b.length)return M(null);var b=a.Nb[a.F];if(b)return M(b);var c=a.b.b[a.F],d=a.b.f,e=L("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(zh(f)/2700),a.b.w=c.b);var g=d.b[f.url],h=a.$c(f),l=a.viewport,k=Op(g,l.width,l.height,l.fontSize);if(k.width!=l.width||k.height!=l.height||k.fontSize!=l.fontSize)l=new rn(l.f,k.fontSize,l.root,k.width,k.height);k=a.Nb[a.F-1];null!==c.Qa?k=c.Qa-1:(k=k?k.Ja.ma+k.rb.length:0,null!==c.Db&&(k+=c.Db));
Ao(a.d,k);var m=new Pp(g,f,a.b.lang,l,a.f,a.g,h,a.b.B,k,a.b.j,a.d);m.T=a.T;Qp(m).then(function(){b={item:c,Z:f,Ja:m,Ka:[null],rb:[],complete:!1};a.Nb[a.F]=b;O(e,b)})});return N(e)}function Vq(a){return{F:a.F,G:a.G,na:a.na}}function Wq(a,b){b?(a.F=b.F,a.G=-1,a.na=b.na):(a.F=0,a.G=0,a.na=0);return Oq(a,a.F,a.G)}
n.yc=function(){var a=this.b,b=a.H||a.S;if(!b)return M(null);var c=L("showTOC");this.e||(this.e=new fq(a.f,b.src,a.lang,this.f,this.g,this.T,this,a.B,a.j,this.d));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background=
"#EEE";e.style.border="1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.e.yc(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";O(c,a)});return N(c)};n.uc=function(){this.e&&this.e.uc()};n.zd=function(){return this.e&&this.e.zd()};function Xq(a,b,c,d){var e=this;this.h=a;this.jb=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.za=c;this.ra=d;a=a.document;this.ka=new ph(a.head,b);this.H=[];this.g=null;this.D=this.d=!1;this.f=this.j=this.e=this.l=null;this.fontSize=16;this.zoom=1;this.S=!1;this.hd=!0;this.T=Wb();this.B=function(){};this.k=function(){};this.O=function(){e.d=!0;e.B()};this.dd=this.dd.bind(this);this.u=function(){};this.w=a.getElementById("vivliostyle-page-rules");
this.I=!1;this.ca={loadEPUB:this.Wd,loadXML:this.Xd,configure:this.sd,moveTo:this.ma,toc:this.yc};Yq(this)}function Yq(a){sa(1,function(a){Zq(this,{t:"debug",content:a})}.bind(a));sa(2,function(a){Zq(this,{t:"info",content:a})}.bind(a));sa(3,function(a){Zq(this,{t:"warn",content:a})}.bind(a));sa(4,function(a){Zq(this,{t:"error",content:a})}.bind(a))}function Zq(a,b){b.i=a.za;a.ra(b)}n=Xq.prototype;
n.Wd=function(a){Mo.b("loadEPUB");Mo.b("loadFirstPage");this.jb.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet;this.viewport=null;var f=L("loadEPUB"),g=this;g.sd(a).then(function(){var a=new iq;if(e)for(var l=0;l<e.length;l++)eq(a,e[l]);dq(a).then(function(){var e=va(b,g.h.location.href);g.H=[e];kq(a,e,d).then(function(a){g.g=a;Eq(g.g,c).then(function(a){g.f=a;$q(g).then(function(){g.jb.setAttribute("data-vivliostyle-viewer-status",
"complete");Mo.d("loadEPUB");Zq(g,{t:"loaded",metadata:g.g.u});O(f,!0)})})})})});return N(f)};
n.Xd=function(a){Mo.b("loadXML");Mo.b("loadFirstPage");this.jb.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.document,d=a.fragment,e=a.userStyleSheet;this.viewport=null;var f=L("loadXML"),g=this;g.sd(a).then(function(){var a=new iq;if(e)for(var l=0;l<e.length;l++)eq(a,e[l]);dq(a).then(function(){var e=b.map(function(a,b){return{url:va(a.url,g.h.location.href),index:b,Qa:a.Qa,Db:a.Db}});g.H=e.map(function(a){return a.url});g.g=new mq(a,"");Cq(g.g,e,c).then(function(){Eq(g.g,
d).then(function(a){g.f=a;$q(g).then(function(){g.jb.setAttribute("data-vivliostyle-viewer-status","complete");Mo.d("loadXML");Zq(g,{t:"loaded"});O(f,!0)})})})})});return N(f)};function ar(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*lc.ex*a.fontSize/lc.em;if(d=lc[d])return c*d}return c}
n.sd=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.l=null,this.h.addEventListener("resize",this.O,!1),this.d=!0):this.h.removeEventListener("resize",this.O,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.d=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:ar(this,b["margin-left"])||0,marginRight:ar(this,b["margin-right"])||0,marginTop:ar(this,b["margin-top"])||0,marginBottom:ar(this,b["margin-bottom"])||
...
a.zoom,this.D=!0);return M(!0)};n.dd=function(a){var b=this.e,c=this.j,d=a.target;c?c.left!==d&&c.right!==d||br(this,a.Rd):b===a.target&&br(this,a.Rd)};function cr(a){var b=[];a.e&&(b.push(a.e),a.e=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(v(a.N,"display","none"),a.removeEventListener("hyperlink",this.u,!1),a.removeEventListener("replaced",this.dd,!1))},a)}
function dr(a,b){b.addEventListener("hyperlink",a.u,!1);b.addEventListener("replaced",a.dd,!1);v(b.N,"visibility","visible");v(b.N,"display","block")}function er(a,b){cr(a);a.e=b;dr(a,b)}function fr(a){var b=L("reportPosition");a.f||(a.f=Vq(a.b));Dq(a.g,a.f.F,a.f.na).then(function(c){var d=a.e;(a.S&&0<d.g.length?tg(d.g):M(!0)).then(function(){gr(a,d,c).ua(b)})});return N(b)}
function hr(a){var b=a.jb;if(a.l){var c=a.l;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new rn(a.h,a.fontSize,b,c.width,c.height)}return new rn(a.h,a.fontSize,b)}
function ir(a){if(a.l||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=hr(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.Nb;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.rb,d=0;d<c.length;d++){var e=c[d];if(e.I&&e.H){a=!0;break a}}}a=!1}b=!a}return b}n.le=function(a,b,c){if(!this.I&&this.w&&0===b&&0===c){var d="";Object.keys(a).forEach(function(b){d+="@page "+b+"{size:";b=a[b];d+=b.width+"px "+b.height+"px;}"});this.w.textContent=d;this.I=!0}};
function jr(a){if(a.b){a.b.uc();for(var b=a.b.Nb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.rb,e;e=d.shift();)e=e.N,e.parentNode.removeChild(e)}}a.w&&(a.w.textContent="",a.I=!1);a.viewport=hr(a);b=a.viewport;v(b.e,"width","");v(b.e,"height","");v(b.d,"width","");v(b.d,"height","");v(b.d,"transform","");a.b=new Hq(a.g,a.viewport,a.ka,a.T,a.le.bind(a))}
function br(a,b){a.D=!1;if(a.T.Ya)return Qq(a.b).Gc(function(c){cr(a);a.j=c;c.left&&(dr(a,c.left),c.right||c.left.N.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(dr(a,c.right),c.left||c.right.N.setAttribute("data-vivliostyle-unpaired-page",!0));c=kr(a,c);a.viewport.zoom(c.width,c.height,a.zoom);a.e=b;return M(null)});er(a,b);a.viewport.zoom(b.e.width,b.e.height,a.zoom);a.e=b;return M(null)}
function kr(a,b){var c=0,d=0;b.left&&(c+=b.left.e.width,d=b.left.e.height);b.right&&(c+=b.right.e.width,d=Math.max(d,b.right.e.height));b.left&&b.right&&(c+=2*a.T.Mb);return{width:c,height:d}}var lr={ve:"fit inside viewport"};
function $q(a){a.d=!1;if(ir(a))return M(!0);"complete"===a.jb.getAttribute("data-vivliostyle-viewer-status")&&a.jb.setAttribute("data-vivliostyle-viewer-status","resizing");Zq(a,{t:"resizestart"});var b=L("resize");a.b&&!a.f&&(a.f=Vq(a.b));jr(a);Wq(a.b,a.f).then(function(c){br(a,c).then(function(){fr(a).then(function(c){Mo.d("loadFirstPage");(a.hd?a.b.hd():M(null)).then(function(){a.jb.setAttribute("data-vivliostyle-viewer-status","complete");Zq(a,{t:"resizeend"});O(b,c)})})})});return N(b)}
function gr(a,b,c){var d=L("sendLocationNotification"),e={t:"nav",first:b.l,last:b.k};Gq(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.w;c&&(e.cfi=c);Zq(a,e);O(d,!0)});return N(d)}Xq.prototype.ob=function(){return this.b?this.b.ob():null};
Xq.prototype.ma=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.T.Ya?this.b.fe:this.b.nextPage;break;case "previous":a=this.T.Ya?this.b.ie:this.b.fd;break;case "last":a=this.b.ae;break;case "first":a=this.b.$d;break;default:return M(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return Rq(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return Tq(b.b,d)}}else return M(!0);var e=L("nextPage");a.call(b.b).then(function(a){a?(b.f=
null,br(b,a).then(function(){fr(b).ua(e)})):O(e,!0)});return N(e)};Xq.prototype.yc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.zd();if(c){if("show"==a)return M(!0)}else if("hide"==a)return M(!0);if(c)return this.b.uc(),M(!0);var d=this,e=L("showTOC");this.b.yc(b).then(function(a){if(a){if(b){var c=function(){d.b.uc()};a.addEventListener("hyperlink",c,!1);a.N.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.u,!1)}O(e,!0)});return N(e)};
function mr(a,b){var c=b.a||"";return Xe("runCommand",function(d){var e=a.ca[c];e?e.call(a,b).then(function(){Zq(a,{t:"done",a:c});O(d,!0)}):(u.error("No such action:",c),O(d,!0))},function(a,b){u.error(b,"Error during action:",c);O(a,!0)})}function nr(a){return"string"==typeof a?JSON.parse(a):a}
function or(a,b){var c=nr(b),d=null;Ze(function(){var b=L("commandLoop"),f=Se.d;a.u=function(b){var c="#"===b.href.charAt(0)||a.H.some(function(a){return b.href.substr(0,a.length)==a});if(c){b.preventDefault();var d={t:"hyperlink",href:b.href,internal:c};$e(f,function(){Zq(a,d);return M(!0)})}};of(function(b){if(a.d)$q(a).then(function(){qf(b)});else if(a.D)a.e&&br(a,a.e).then(function(){qf(b)});else if(c){var e=c;c=null;mr(a,e).then(function(){qf(b)})}else e=L("waitForCommand"),d=gf(e,self),N(e).then(function(){qf(b)})}).ua(b);
return N(b)});a.B=function(){var a=d;a&&(d=null,a.Wa())};a.k=function(b){if(c)return!1;c=nr(b);a.B();return!0};a.h.adapt_command=a.k};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Xb||(Object.Xb=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function pr(a){function b(a){return"number"===typeof a?a:null}function c(a){return"string"===typeof a?{url:a,Qa:null,Db:null}:{url:a.url,Qa:b(a.startPage),Db:b(a.skipPagesBefore)}}return Array.isArray(a)?a.map(c):a?[c(a)]:null}function qr(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}
function rr(a,b){ka=a.debug;this.f=a;this.b=new Xq(a.window||window,a.viewportElement,"main",this.Zd.bind(this));this.e={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,spreadView:!1,zoom:1};b&&this.Sd(b);this.d=new Ya}n=rr.prototype;n.Sd=function(a){var b=Object.Xb({a:"configure"},qr(a));this.b.k(b);Object.Xb(this.e,a)};n.Zd=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});Za(this.d,b)};n.me=function(a,b){this.d.addEventListener(a,b,!1)};
n.pe=function(a,b){this.d.removeEventListener(a,b,!1)};n.be=function(a,b,c){a||Za(this.d,{type:"error",content:"No URL specified"});sr(this,a,null,b,c)};n.ne=function(a,b,c){a||Za(this.d,{type:"error",content:"No URL specified"});sr(this,null,a,b,c)};
function sr(a,b,c,d,e){d=d||{};var f,g=d.userStyleSheet;g&&(f=g.map(function(a){return{url:a.url||null,text:a.text||null}}));e&&Object.Xb(a.e,e);b=Object.Xb({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.f.userAgentRootURL,url:pr(b)||c,document:d.documentObject,fragment:d.fragment,userStyleSheet:f},qr(a.e));or(a.b,b)}n.ob=function(){return this.b.ob()};
n.de=function(a){a:switch(a){case "left":a="ltr"===this.ob()?"previous":"next";break a;case "right":a="ltr"===this.ob()?"next":"previous";break a}this.b.k({a:"moveTo",where:a})};n.ce=function(a){this.b.k({a:"moveTo",url:a})};n.oe=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.T.Ya?kr(b,b.j):b.e.e;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ba("vivliostyle.viewer.Viewer",rr);rr.prototype.setOptions=rr.prototype.Sd;rr.prototype.addListener=rr.prototype.me;rr.prototype.removeListener=rr.prototype.pe;rr.prototype.loadDocument=rr.prototype.be;rr.prototype.loadEPUB=rr.prototype.ne;rr.prototype.getCurrentPageProgression=rr.prototype.ob;rr.prototype.navigateToPage=rr.prototype.de;rr.prototype.navigateToInternalUrl=rr.prototype.ce;rr.prototype.queryZoomFactor=rr.prototype.oe;ba("vivliostyle.viewer.ZoomType",lr);lr.FIT_INSIDE_VIEWPORT="fit inside viewport";
Io.call(Mo,"load_vivliostyle","end",void 0);var tr=16,ur="ltr";function vr(a){window.adapt_command(a)}function wr(){vr({a:"moveTo",where:"ltr"===ur?"previous":"next"})}function xr(){vr({a:"moveTo",where:"ltr"===ur?"next":"previous"})}
function yr(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)vr({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)vr({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)vr({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)vr({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)xr(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)wr(),a.preventDefault();else if("0"===b||"U+0030"===c)vr({a:"configure",fontSize:Math.round(tr)}),a.preventDefault();else if("t"===b||"U+0054"===c)vr({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)tr*=1.2,vr({a:"configure",fontSize:Math.round(tr)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)tr/=1.2,vr({a:"configure",
fontSize:Math.round(tr)}),a.preventDefault()}
function zr(a){switch(a.t){case "loaded":a=a.viewer;var b=ur=a.ob();a.jb.setAttribute("data-vivliostyle-page-progression",b);a.jb.setAttribute("data-vivliostyle-spread-view",a.T.Ya);window.addEventListener("keydown",yr,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",wr,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",xr,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(za(location.href,Na(a||"")));break;case "hyperlink":a.internal&&vr({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+m+"; margin: 0; }",document.head.appendChild(g));or(new Xq(window,k,"main",zr),a)});
