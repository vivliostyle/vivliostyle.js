 ...
 *
 * Vivliostyle core 2019.1.100-pre.20190208032303
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function Aa(a,b){if(!b||a.match(/^\w{2,}:/))return a.toLowerCase().match("^javascript:")?"#":a;b.match(/^\w{2,}:\/\/[^\/]+$/)&&(b+="/");var c;if(a.match(/^\/\//))return(c=b.match(/^(\w{2,}:)\/\//))?c[1]+a:a;if(a.match(/^\//))return(c=b.match(/^(\w{2,}:\/\/[^\/]+)\//))?c[1]+a:a;a.match(/^\.(\/|$)/)&&(a=a.substr(2));c=b;var d=c.match(/^([^#?]*)/);b=d?d[1]:c;if(a.match(/^\#/))return b+a;c=b.lastIndexOf("/");if(0>c)return a;if(c<b.length-1&&b.lastIndexOf(".")<c){if(""==a)return b;b+="/";c=b.length-1}for(d=
b.substr(0,c+1)+a;;){c=d.indexOf("/../");if(0>=c)break;var e=d.lastIndexOf("/",c-1);if(0>=e)break;d=d.substr(0,e)+d.substr(c+3)}return d.replace(/\/(\.\/)+/g,"/")}
...
sb.prototype.h=function(a){if(0<this.offset&&!a.K){for(var b=this.offset,c=a.node;;){var d=c.nodeType;if(1==d)break;var e=c.nextSibling;if(3<=d&&5>=d){d=c.textContent.length;if(b<=d)break;if(!e){b=d;break}b-=d}if(!e){b=0;break}c=e}a.node=c;a.offset=b}a.Hb=this.Hb;return!0};
sb.prototype.g=function(a){a.append(":");a.append(this.offset.toString());if(this.f||this.b||this.Hb){a.append("[");if(this.f||this.b)this.f&&a.append(this.f.replace(/[\[\]\(\),=;^]/g,lb)),a.append(","),this.b&&a.append(this.b.replace(/[\[\]\(\),=;^]/g,lb));this.Hb&&(a.append(";s="),a.append(this.Hb));a.append("]")}};function tb(){this.pa=null}
...
if(!c)throw Error("E_CFI_NUMBER_EXPECTED");e+=c[0].length;g=parseInt(c[1],10);(h=c[4])&&(h=nb(h));var l=c[7];l&&(l=nb(l));c=ob(c[10]);f.push(new sb(g,h,l,Ha(c.s)));break;case "!":e++;f.push(new pb);break;case "~":case "@":case "":a.pa=f;return;default:throw Error("E_CFI_PARSE_ERROR");}}function vb(a,b){for(var c={node:b.documentElement,offset:0,K:!1,Hb:null,sd:null},d=0;d<a.pa.length;d++)if(!a.pa[d].h(c)){c.sd=new tb;c.sd.pa=a.pa.slice(d+1);break}return c}
...
d=!1}f.reverse();a.pa?(f.push(new pb),a.pa=f.concat(a.pa)):a.pa=f}tb.prototype.toString=function(){if(!this.pa)return"";var a=new Qa;a.append("epubcfi(");for(var b=0;b<this.pa.length;b++)this.pa[b].g(a);a.append(")");return a.toString()};function xb(){return{fontFamily:"serif",lineHeight:1.25,margin:8,Ae:!1,se:25,ze:!1,Le:!1,ub:!1,Dc:1,df:{vivliostyle:!0,print:!0},vc:void 0}}function yb(a){return{fontFamily:a.fontFamily,lineHeight:a.lineHeight,margin:a.margin,Ae:a.Ae,se:a.se,ze:a.ze,Le:a.Le,ub:a.ub,Dc:a.Dc,df:Object.assign({},a.df),vc:a.vc?Object.assign({},a.vc):void 0}}var zb=xb(),Ab={};function Bb(a,b,c,d){a=Math.min((a-0)/c,(b-0)/d);return"matrix("+a+",0,0,"+a+",0,0)"}function Cb(a){return'"'+Ta(""+a)+'"'}
function Db(a){return Sa(""+a)}function Eb(a,b){return a?Sa(a)+"."+Sa(b):Sa(b)}var Fb=0;
function Gb(a,b){this.parent=a;this.u="S"+Fb++;this.children=[];this.b=new Hb(this,0);this.f=new Hb(this,1);this.j=new Hb(this,!0);this.h=new Hb(this,!1);a&&a.children.push(this);this.values={};this.D={};this.B={};this.l=b;if(!a){var c=this.B;c.floor=Math.floor;c.ceil=Math.ceil;c.round=Math.round;c.sqrt=Math.sqrt;c.min=Math.min;c.max=Math.max;c.letterbox=Bb;c["css-string"]=Cb;c["css-name"]=Db;c["typeof"]=function(a){return typeof a};Ib(this,"page-width",function(){return this.ic()});Ib(this,"page-height",
function(){return this.hc()});Ib(this,"pref-font-family",function(){return this.$.fontFamily});Ib(this,"pref-night-mode",function(){return this.$.Le});Ib(this,"pref-hyphenate",function(){return this.$.Ae});Ib(this,"pref-margin",function(){return this.$.margin});Ib(this,"pref-line-height",function(){return this.$.lineHeight});Ib(this,"pref-column-width",function(){return this.$.se*this.fontSize});Ib(this,"pref-horizontal",function(){return this.$.ze});Ib(this,"pref-spread-view",function(){return this.$.ub})}}
function Ib(a,b,c){a.values[b]=new Jb(a,c,b)}function Kb(a,b){a.values["page-number"]=b}function Lb(a,b){a.B["has-content"]=b}function Mb(a){switch(a.toLowerCase()){case "vw":case "vh":case "vi":case "vb":case "vmin":case "vmax":case "pvw":case "pvh":case "pvi":case "pvb":case "pvmin":case "pvmax":return!0;default:return!1}}var Nb={px:1,"in":96,pt:4/3,pc:16,cm:96/2.54,mm:96/25.4,q:96/2.54/40,em:16,rem:16,ex:8,dppx:1,dpi:1/96,dpcm:2.54/96};
function Ob(a){switch(a){case "q":case "rem":return!0;default:return!1}}function Pb(a,b,c,d){this.xb=b;this.Nb=c;this.Y=null;this.ic=function(){return this.Y?this.Y:this.$.ub?Math.floor(b/2)-this.$.Dc:b};this.S=null;this.hc=function(){return this.S?this.S:c};this.u=d;this.Za=null;this.fontSize=function(){return this.Za?this.Za:d};this.$=zb;this.J={};this.G=this.Z=this.ha=null}function Qb(a,b){a.J[b.u]={};for(var c=0;c<b.children.length;c++)Qb(a,b.children[c])}
function Rb(a,b,c){if(Mb(b)){var d=a.ic()/100,e=a.hc()/100,f=null!=a.ha?a.ha/100:d,g=null!=a.Z?a.Z/100:e;switch(b){case "vw":return f;case "vh":return g;case "vi":return a.G?g:f;case "vb":return a.G?f:g;case "vmin":return f<g?f:g;case "vmax":return f>g?f:g;case "pvw":return d;case "pvh":return e;case "pvi":return a.G?e:d;case "pvb":return a.G?d:e;case "pvmin":return d<e?d:e;case "pvmax":return d>e?d:e}}return"em"==b||"rem"==b?c?a.u:a.fontSize():"ex"==b?Nb.ex*(c?a.u:a.fontSize())/Nb.em:Nb[b]}
...
e}else if(null!=f&&!c)return!!f;return!1}function Vb(a){this.b=a;this.g="_"+Fb++}n=Vb.prototype;n.toString=function(){var a=new Qa;this.Ha(a,0);return a.toString()};n.Ha=function(){throw Error("F_ABSTRACT");};n.yb=function(){throw Error("F_ABSTRACT");};n.lb=function(){return this};n.wc=function(a){return a===this};function Wb(a,b,c,d){var e=d[a.g];if(null!=e)return e===Ab?!1:e;d[a.g]=Ab;b=a.wc(b,c,d);return d[a.g]=b}
n.evaluate=function(a){var b;b=(b=a.J[this.b.u])?b[this.g]:void 0;if("undefined"!=typeof b)return b;b=this.yb(a);var c=this.g,d=this.b,e=a.J[d.u];e||(e={},a.J[d.u]=e);return e[c]=b};n.kf=function(){return!1};function Xb(a,b){Vb.call(this,a);this.f=b}v(Xb,Vb);n=Xb.prototype;n.Ye=function(){throw Error("F_ABSTRACT");};n.ef=function(){throw Error("F_ABSTRACT");};n.yb=function(a){a=this.f.evaluate(a);return this.ef(a)};n.wc=function(a,b,c){return a===this||Wb(this.f,a,b,c)};
n.Ha=function(a,b){10<b&&a.append("(");a.append(this.Ye());this.f.Ha(a,10);10<b&&a.append(")")};n.lb=function(a,b){var c=this.f.lb(a,b);return c===this.f?this:new this.constructor(this.b,c)};function Yb(a,b,c){Vb.call(this,a);this.f=b;this.h=c}v(Yb,Vb);n=Yb.prototype;n.Dd=function(){throw Error("F_ABSTRACT");};n.hb=function(){throw Error("F_ABSTRACT");};n.Fb=function(){throw Error("F_ABSTRACT");};n.yb=function(a){var b=this.f.evaluate(a);a=this.h.evaluate(a);return this.Fb(b,a)};
n.wc=function(a,b,c){return a===this||Wb(this.f,a,b,c)||Wb(this.h,a,b,c)};n.Ha=function(a,b){var c=this.Dd();c<=b&&a.append("(");this.f.Ha(a,c);a.append(this.hb());this.h.Ha(a,c);c<=b&&a.append(")")};n.lb=function(a,b){var c=this.f.lb(a,b),d=this.h.lb(a,b);return c===this.f&&d===this.h?this:new this.constructor(this.b,c,d)};function Zb(a,b,c){Yb.call(this,a,b,c)}v(Zb,Yb);Zb.prototype.Dd=function(){return 1};function $b(a,b,c){Yb.call(this,a,b,c)}v($b,Yb);$b.prototype.Dd=function(){return 2};
function ac(a,b,c){Yb.call(this,a,b,c)}v(ac,Yb);ac.prototype.Dd=function(){return 3};function bc(a,b,c){Yb.call(this,a,b,c)}v(bc,Yb);bc.prototype.Dd=function(){return 4};function cc(a,b){Xb.call(this,a,b)}v(cc,Xb);cc.prototype.Ye=function(){return"!"};cc.prototype.ef=function(a){return!a};function dc(a,b){Xb.call(this,a,b)}v(dc,Xb);dc.prototype.Ye=function(){return"-"};dc.prototype.ef=function(a){return-a};function ec(a,b,c){Yb.call(this,a,b,c)}v(ec,Zb);ec.prototype.hb=function(){return"&&"};
ec.prototype.yb=function(a){return this.f.evaluate(a)&&this.h.evaluate(a)};function fc(a,b,c){Yb.call(this,a,b,c)}v(fc,ec);fc.prototype.hb=function(){return" and "};function gc(a,b,c){Yb.call(this,a,b,c)}v(gc,Zb);gc.prototype.hb=function(){return"||"};gc.prototype.yb=function(a){return this.f.evaluate(a)||this.h.evaluate(a)};function hc(a,b,c){Yb.call(this,a,b,c)}v(hc,gc);hc.prototype.hb=function(){return", "};function ic(a,b,c){Yb.call(this,a,b,c)}v(ic,$b);ic.prototype.hb=function(){return"<"};
...
tc.prototype.yb=function(a){return this.L*Rb(a,this.ka,!1)};function uc(a,b){Vb.call(this,a);this.f=b}v(uc,Vb);uc.prototype.Ha=function(a){a.append(this.f)};uc.prototype.yb=function(a){return Sb(a,this.b,this.f).evaluate(a)};uc.prototype.wc=function(a,b,c){return a===this||Wb(Sb(b,this.b,this.f),a,b,c)};function vc(a,b,c){Vb.call(this,a);this.f=b;this.name=c}v(vc,Vb);vc.prototype.Ha=function(a){this.f&&a.append("not ");a.append(Sa(this.name))};
vc.prototype.yb=function(a){var b=this.name;a="all"===b||!!a.$.df[b];return this.f?!a:a};vc.prototype.wc=function(a,b,c){return a===this||Wb(this.value,a,b,c)};vc.prototype.kf=function(){return!0};function Jb(a,b,c){Vb.call(this,a);this.Pc=b;this.Xc=c}v(Jb,Vb);Jb.prototype.Ha=function(a){a.append(this.Xc)};Jb.prototype.yb=function(a){return this.Pc.call(a)};function wc(a,b,c){Vb.call(this,a);this.h=b;this.f=c}v(wc,Vb);
wc.prototype.Ha=function(a){a.append(this.h);var b=this.f;a.append("(");for(var c=0;c<b.length;c++)c&&a.append(","),b[c].Ha(a,0);a.append(")")};wc.prototype.yb=function(a){return Tb(a,this.b,this.h,this.f,!1).lb(a,this.f).evaluate(a)};wc.prototype.wc=function(a,b,c){if(a===this)return!0;for(var d=0;d<this.f.length;d++)if(Wb(this.f[d],a,b,c))return!0;return Wb(Tb(b,this.b,this.h,this.f,!0),a,b,c)};
...
xc.prototype.yb=function(a){return this.f.evaluate(a)?this.j.evaluate(a):this.h.evaluate(a)};xc.prototype.wc=function(a,b,c){return a===this||Wb(this.f,a,b,c)||Wb(this.j,a,b,c)||Wb(this.h,a,b,c)};xc.prototype.lb=function(a,b){var c=this.f.lb(a,b),d=this.j.lb(a,b),e=this.h.lb(a,b);return c===this.f&&d===this.j&&e===this.h?this:new xc(this.b,c,d,e)};function Hb(a,b){Vb.call(this,a);this.f=b}v(Hb,Vb);
Hb.prototype.Ha=function(a){switch(typeof this.f){case "number":case "boolean":a.append(this.f.toString());break;case "string":a.append('"');a.append(Ta(this.f));a.append('"');break;default:throw Error("F_UNEXPECTED_STATE");}};Hb.prototype.yb=function(){return this.f};function yc(a,b,c){Vb.call(this,a);this.name=b;this.value=c}v(yc,Vb);yc.prototype.Ha=function(a){a.append("(");a.append(Ta(this.name.name));a.append(":");this.value.Ha(a,0);a.append(")")};
yc.prototype.yb=function(a){return Ub(a,this.name.name,this.value)};yc.prototype.wc=function(a,b,c){return a===this||Wb(this.value,a,b,c)};yc.prototype.lb=function(a,b){var c=this.value.lb(a,b);return c===this.value?this:new yc(this.b,this.name,c)};function zc(a,b){Vb.call(this,a);this.index=b}v(zc,Vb);zc.prototype.Ha=function(a){a.append("$");a.append(this.index.toString())};zc.prototype.lb=function(a,b){var c=b[this.index];if(!c)throw Error("Parameter missing: "+this.index);return c};
function Ac(a,b,c){return b===a.h||b===a.b||c==a.h||c==a.b?a.h:b===a.j||b===a.f?c:c===a.j||c===a.f?b:new ec(a,b,c)}function y(a,b,c){return b===a.b?c:c===a.b?b:new oc(a,b,c)}function B(a,b,c){return b===a.b?new dc(a,c):c===a.b?b:new pc(a,b,c)}function Bc(a,b,c){return b===a.b||c===a.b?a.b:b===a.f?c:c===a.f?b:new qc(a,b,c)}function Cc(a,b,c){return b===a.b?a.b:c===a.f?b:new rc(a,b,c)};var Dc={};function Ec(){}n=Ec.prototype;n.rc=function(a){for(var b=0;b<a.length;b++)a[b].ea(this)};n.Ve=function(){throw Error("E_CSS_EMPTY_NOT_ALLOWED");};n.We=function(){throw Error("E_CSS_SLASH_NOT_ALLOWED");};n.Ad=function(){throw Error("E_CSS_STR_NOT_ALLOWED");};n.qc=function(){throw Error("E_CSS_IDENT_NOT_ALLOWED");};n.ad=function(){throw Error("E_CSS_NUMERIC_NOT_ALLOWED");};n.$c=function(){throw Error("E_CSS_NUM_NOT_ALLOWED");};n.Zc=function(a){return this.$c(a)};
n.ke=function(){throw Error("E_CSS_COLOR_NOT_ALLOWED");};n.bd=function(){throw Error("E_CSS_URL_NOT_ALLOWED");};n.Vb=function(){throw Error("E_CSS_LIST_NOT_ALLOWED");};n.oc=function(){throw Error("E_CSS_COMMA_NOT_ALLOWED");};n.Yb=function(){throw Error("E_CSS_FUNC_NOT_ALLOWED");};n.Yc=function(){throw Error("E_CSS_EXPR_NOT_ALLOWED");};function Fc(){}v(Fc,Ec);n=Fc.prototype;
n.rc=function(a){for(var b=null,c=0;c<a.length;c++){var d=a[c],e=d.ea(this);if(b)b[c]=e;else if(d!==e){b=Array(a.length);for(d=0;d<c;d++)b[d]=a[d];b[c]=e}}return b||a};n.Ad=function(a){return a};n.qc=function(a){return a};n.We=function(a){return a};n.ad=function(a){return a};n.$c=function(a){return a};n.Zc=function(a){return a};n.ke=function(a){return a};n.bd=function(a){return a};n.Vb=function(a){var b=this.rc(a.values);return b===a.values?a:new Gc(b)};
n.oc=function(a){var b=this.rc(a.values);return b===a.values?a:new Hc(b)};n.Yb=function(a){var b=this.rc(a.values);return b===a.values?a:new Ic(a.name,b)};n.Yc=function(a){return a};function Jc(){}n=Jc.prototype;n.toString=function(){var a=new Qa;this.$a(a,!0);return a.toString()};n.stringValue=function(){var a=new Qa;this.$a(a,!1);return a.toString()};n.Aa=function(){throw Error("F_ABSTRACT");};n.$a=function(a){a.append("[error]")};n.hf=function(){return!1};n.Ac=function(){return!1};n.lf=function(){return!1};
n.Yf=function(){return!1};n.Ud=function(){return!1};function Kc(){if(C)throw Error("E_INVALID_CALL");}v(Kc,Jc);Kc.prototype.Aa=function(a){return new Hb(a,"")};Kc.prototype.$a=function(){};Kc.prototype.ea=function(a){return a.Ve(this)};var C=new Kc;function Lc(){if(Mc)throw Error("E_INVALID_CALL");}v(Lc,Jc);Lc.prototype.Aa=function(a){return new Hb(a,"/")};Lc.prototype.$a=function(a){a.append("/")};Lc.prototype.ea=function(a){return a.We(this)};var Mc=new Lc;function Nc(a){this.Xc=a}v(Nc,Jc);
Nc.prototype.Aa=function(a){return new Hb(a,this.Xc)};Nc.prototype.$a=function(a,b){b?(a.append('"'),a.append(Ta(this.Xc)),a.append('"')):a.append(this.Xc)};Nc.prototype.ea=function(a){return a.Ad(this)};function Oc(a){this.name=a;if(Dc[a])throw Error("E_INVALID_CALL");Dc[a]=this}v(Oc,Jc);Oc.prototype.Aa=function(a){return new Hb(a,this.name)};Oc.prototype.$a=function(a,b){b?a.append(Sa(this.name)):a.append(this.name)};Oc.prototype.ea=function(a){return a.qc(this)};Oc.prototype.Yf=function(){return!0};
function D(a){var b=Dc[a];b||(b=new Oc(a));return b}function F(a,b){this.L=a;this.ka=b.toLowerCase()}v(F,Jc);F.prototype.Aa=function(a,b){return this.L?b&&"%"==this.ka?100==this.L?b:new qc(a,b,new Hb(a,this.L/100)):new tc(a,this.L,this.ka):a.b};F.prototype.$a=function(a){a.append(this.L.toString());a.append(this.ka)};F.prototype.ea=function(a){return a.ad(this)};F.prototype.Ac=function(){return!0};function Pc(a){this.L=a}v(Pc,Jc);
Pc.prototype.Aa=function(a){return this.L?1==this.L?a.f:new Hb(a,this.L):a.b};Pc.prototype.$a=function(a){a.append(this.L.toString())};Pc.prototype.ea=function(a){return a.$c(this)};Pc.prototype.lf=function(){return!0};function Qc(a){this.L=a}v(Qc,Pc);Qc.prototype.ea=function(a){return a.Zc(this)};function Rc(a){this.b=a}v(Rc,Jc);Rc.prototype.$a=function(a){a.append("#");var b=this.b.toString(16);a.append("000000".substr(b.length));a.append(b)};Rc.prototype.ea=function(a){return a.ke(this)};
function Sc(a){this.url=a}v(Sc,Jc);Sc.prototype.$a=function(a){a.append('url("');a.append(Ta(this.url));a.append('")')};Sc.prototype.ea=function(a){return a.bd(this)};function Tc(a,b,c,d){var e=b.length;b[0].$a(a,d);for(var f=1;f<e;f++)a.append(c),b[f].$a(a,d)}function Gc(a){this.values=a}v(Gc,Jc);Gc.prototype.$a=function(a,b){Tc(a,this.values," ",b)};Gc.prototype.ea=function(a){return a.Vb(this)};Gc.prototype.Ud=function(){return!0};function Hc(a){this.values=a}v(Hc,Jc);
Hc.prototype.$a=function(a,b){Tc(a,this.values,",",b)};Hc.prototype.ea=function(a){return a.oc(this)};function Ic(a,b){this.name=a;this.values=b}v(Ic,Jc);Ic.prototype.$a=function(a,b){a.append(Sa(this.name));a.append("(");Tc(a,this.values,",",b);a.append(")")};Ic.prototype.ea=function(a){return a.Yb(this)};function G(a){this.Mc=a}v(G,Jc);G.prototype.Aa=function(){return this.Mc};G.prototype.$a=function(a){a.append("-epubx-expr(");this.Mc.Ha(a,0);a.append(")")};G.prototype.ea=function(a){return a.Yc(this)};
G.prototype.hf=function(){return!0};function Uc(a,b){if(a){if(a.Ac())return Rb(b,a.ka,!1)*a.L;if(a.lf())return a.L}return 0}var Vc=D("absolute"),Wc=D("all"),Xc=D("always"),Yc=D("auto");D("avoid");var Zc=D("balance"),$c=D("balance-all"),ad=D("block"),bd=D("block-end"),cd=D("block-start"),dd=D("both"),ed=D("bottom"),fd=D("border-box"),gd=D("break-all"),hd=D("break-word"),id=D("crop"),jd=D("cross");D("column");
...
function ne(a,b,c){var d=b.frameTrace;if(!d){for(var d=b.stack?b.stack+"\n\t---- async ---\n":"",e=a.top;e;e=e.parent)d+="\t",d+=e.name,d+="\n";b.frameTrace=d}if(c){for(d=a.top;d&&d!=c;)d=d.parent;d==c&&(a.top=d)}for(a.g=b;a.top&&!a.top.j;)a.top=a.top.parent;a.top?(b=a.g,a.g=null,a.top.j(a.top,b)):a.g&&w.error(a.g,"Unhandled exception in task",a.name)}function le(a){this.value=a}n=le.prototype;n.then=function(a){a(this.value)};n.da=function(a){return a(this.value)};n.Hc=function(a){return new le(a)};
n.Ea=function(a){O(a,this.value)};n.Xa=function(){return!1};n.get=function(){return this.value};function ze(a){this.b=a}n=ze.prototype;n.then=function(a){this.b.then(a)};n.da=function(a){if(this.Xa()){var b=new je(this.b.f,this.b.parent,"AsyncResult.thenAsync");b.b=ke;this.b.parent=b;this.b.then(function(c){a(c).then(function(a){O(b,a)})});return b.result()}return a(this.b.g)};n.Hc=function(a){return this.Xa()?this.da(function(){return new le(a)}):new le(a)};
...
function vf(a){var b=window.WebKitBlobBuilder||window.MSBlobBuilder;if(b){for(var b=new b,c=0;c<a.length;c++)b.append(a[c]);return b.getBlob("application/octet-stream")}return new Blob(a,{type:"application/octet-stream"})}function wf(a){var b=L("readBlob"),c=new FileReader,d=we(b,c);c.addEventListener("load",function(){d.tb(c.result)},!1);c.readAsArrayBuffer(a);return b.result()}function xf(a,b){this.Z=a;this.type=b;this.$d={};this.j={}}
xf.prototype.load=function(a,b,c){a=xa(a);var d=this.$d[a];return"undefined"!=typeof d?M(d):this.fetch(a,b,c).get()};function yf(a,b,c,d){var e=L("fetch");uf(b,a.type).then(function(f){if(400<=f.status&&c)throw Error((d||"Failed to fetch required resource: "+b)+(" ("+f.status+(f.statusText?" "+f.statusText:"")+")"));a.Z(f,a).then(function(c){delete a.j[b];a.$d[b]=c;O(e,c)})});return e.result()}
xf.prototype.fetch=function(a,b,c){a=xa(a);if(this.$d[a])return null;var d=this.j[a];if(!d){var e=this,d=new Ge(function(){return yf(e,a,b,c)},"Fetch "+a);e.j[a]=d;d.start()}return d};xf.prototype.get=function(a){return this.$d[xa(a)]};function zf(a){a=a.responseText;return M(a?JSON.parse(a):null)};function Af(a){var b=parseInt(a,16);if(isNaN(b))throw Error("E_CSS_COLOR");if(6==a.length)return new Rc(b);if(3==a.length)return new Rc(b&15|(b&15)<<4|(b&240)<<4|(b&240)<<8|(b&3840)<<8|(b&3840)<<12);throw Error("E_CSS_COLOR");}function Bf(a){this.f=a;this.qb="Author"}n=Bf.prototype;n.jd=function(){return null};n.la=function(){return this.f};n.error=function(){};n.Wc=function(a){this.qb=a};n.Xb=function(){};n.re=function(){};n.qd=function(){};n.rd=function(){};n.Ce=function(){};n.Gd=function(){};
n.bc=function(){};n.qe=function(){};n.pe=function(){};n.we=function(){};n.Sc=function(){};n.Ub=function(){};n.de=function(){};n.vd=function(){};n.he=function(){};n.be=function(){};n.ge=function(){};n.Vc=function(){};n.Te=function(){};n.Fc=function(){};n.ce=function(){};n.fe=function(){};n.ee=function(){};n.yd=function(){};n.xd=function(){};n.La=function(){};n.Rb=function(){};n.cc=function(){};n.wd=function(){};n.Nd=function(){};
function Cf(a){switch(a.qb){case "UA":return 0;case "User":return 100663296;default:return 83886080}}function Df(a){switch(a.qb){case "UA":return 0;case "User":return 16777216;default:return 33554432}}function Ef(){Bf.call(this,null);this.g=[];this.b=null}v(Ef,Bf);function Ff(a,b){a.g.push(a.b);a.b=b}n=Ef.prototype;n.jd=function(){return null};n.la=function(){return this.b.la()};n.error=function(a,b){this.b.error(a,b)};
n.Wc=function(a){Bf.prototype.Wc.call(this,a);0<this.g.length&&(this.b=this.g[0],this.g=[]);this.b.Wc(a)};n.Xb=function(a,b){this.b.Xb(a,b)};n.re=function(a){this.b.re(a)};n.qd=function(a,b){this.b.qd(a,b)};n.rd=function(a,b){this.b.rd(a,b)};n.Ce=function(a){this.b.Ce(a)};n.Gd=function(a,b,c,d){this.b.Gd(a,b,c,d)};n.bc=function(){this.b.bc()};n.qe=function(){this.b.qe()};n.pe=function(){this.b.pe()};n.we=function(){this.b.we()};n.Sc=function(){this.b.Sc()};n.Ub=function(){this.b.Ub()};n.de=function(){this.b.de()};
n.vd=function(a){this.b.vd(a)};n.he=function(){this.b.he()};n.be=function(){this.b.be()};n.ge=function(){this.b.ge()};n.Vc=function(){this.b.Vc()};n.Te=function(a){this.b.Te(a)};n.Fc=function(a){this.b.Fc(a)};n.ce=function(a){this.b.ce(a)};n.fe=function(){this.b.fe()};n.ee=function(a,b,c){this.b.ee(a,b,c)};n.yd=function(a,b,c){this.b.yd(a,b,c)};n.xd=function(a,b,c){this.b.xd(a,b,c)};n.La=function(){this.b.La()};n.Rb=function(a,b,c){this.b.Rb(a,b,c)};n.cc=function(){this.b.cc()};n.wd=function(a){this.b.wd(a)};
n.Nd=function(){this.b.Nd()};function Gf(a,b,c){Bf.call(this,a);this.N=c;this.J=0;if(this.na=b)this.qb=b.qb}v(Gf,Bf);Gf.prototype.jd=function(){return this.na.jd()};Gf.prototype.error=function(a){w.b(a)};Gf.prototype.La=function(){this.J++};Gf.prototype.cc=function(){if(!--this.J&&!this.N){var a=this.na;a.b=a.g.pop()}};function Hf(a,b,c){Gf.call(this,a,b,c)}v(Hf,Gf);function If(a,b){a.error(b,a.jd())}function Jf(a,b){If(a,b);Ff(a.na,new Gf(a.f,a.na,!1))}n=Hf.prototype;n.Ub=function(){Jf(this,"E_CSS_UNEXPECTED_SELECTOR")};
n.de=function(){Jf(this,"E_CSS_UNEXPECTED_FONT_FACE")};n.vd=function(){Jf(this,"E_CSS_UNEXPECTED_FOOTNOTE")};n.he=function(){Jf(this,"E_CSS_UNEXPECTED_VIEWPORT")};n.be=function(){Jf(this,"E_CSS_UNEXPECTED_DEFINE")};n.ge=function(){Jf(this,"E_CSS_UNEXPECTED_REGION")};n.Vc=function(){Jf(this,"E_CSS_UNEXPECTED_PAGE")};n.Fc=function(){Jf(this,"E_CSS_UNEXPECTED_WHEN")};n.ce=function(){Jf(this,"E_CSS_UNEXPECTED_FLOW")};n.fe=function(){Jf(this,"E_CSS_UNEXPECTED_PAGE_TEMPLATE")};n.ee=function(){Jf(this,"E_CSS_UNEXPECTED_PAGE_MASTER")};
n.yd=function(){Jf(this,"E_CSS_UNEXPECTED_PARTITION")};n.xd=function(){Jf(this,"E_CSS_UNEXPECTED_PARTITION_GROUP")};n.wd=function(){Jf(this,"E_CSS_UNEXPECTED_SELECTOR_FUNC")};n.Nd=function(){Jf(this,"E_CSS_UNEXPECTED_END_SELECTOR_FUNC")};n.Rb=function(){this.error("E_CSS_UNEXPECTED_PROPERTY",this.jd())};var Kf=[],Lf=[],T=[],Mf=[],Nf=[],Of=[],Pf=[],Qf=[],Rf=[],Sf=[],Tf=[],Uf=[],Vf=[];Kf[1]=28;Kf[36]=29;Kf[7]=29;Kf[9]=29;Kf[14]=29;Kf[18]=29;Kf[20]=30;Kf[13]=27;Kf[0]=200;Lf[1]=46;Lf[0]=200;Of[1]=2;
...
function $f(a,b,c){for(var d=a.F,e=a.u,f=d.pop(),g;;){var h=d.pop();if(11==b){for(g=[f];16==h;)g.unshift(d.pop()),h=d.pop();if("string"==typeof h){if("{"==h){for(;2<=g.length;)a=g.shift(),c=g.shift(),a=new hc(e.la(),a,c),g.unshift(a);d.push(new G(g[0]));return!0}if("("==h){b=d.pop();f=d.pop();f=new wc(e.la(),Eb(f,b),g);b=0;continue}}if(10==h){f.kf()&&(f=new yc(e.la(),f,null));b=0;continue}}else if("string"==typeof h){d.push(h);break}if(0>h)if(-31==h)f=new cc(e.la(),f);else if(-24==h)f=new dc(e.la(),
f);else return Zf(a,"F_UNEXPECTED_STATE",c),!1;else{if(Vf[b]>Vf[h]){d.push(h);break}g=d.pop();switch(h){case 26:f=new ec(e.la(),g,f);break;case 52:f=new fc(e.la(),g,f);break;case 25:f=new gc(e.la(),g,f);break;case 38:f=new ic(e.la(),g,f);break;case 37:f=new kc(e.la(),g,f);break;case 48:f=new jc(e.la(),g,f);break;case 47:f=new lc(e.la(),g,f);break;case 39:case 49:f=new mc(e.la(),g,f);break;case 41:f=new nc(e.la(),g,f);break;case 23:f=new oc(e.la(),g,f);break;case 24:f=new pc(e.la(),g,f);break;case 36:f=
new qc(e.la(),g,f);break;case 19:f=new rc(e.la(),g,f);break;case 21:f=new sc(e.la(),g,f);break;case 18:if(1<d.length)switch(d[d.length-1]){case 22:d.pop();f=new xc(e.la(),d.pop(),g,f);break;case 10:if(g.kf())f=new yc(e.la(),g,f);else return Zf(a,"E_CSS_MEDIA_TEST",c),!1}else return Zf(a,"E_CSS_EXPR_COND",c),!1;break;case 22:if(18!=b)return Zf(a,"E_CSS_EXPR_COND",c),!1;case 10:return d.push(g),d.push(h),d.push(f),!1;default:return Zf(a,"F_UNEXPECTED_STATE",c),!1}}}d.push(f);return!1}
...
function eg(a,b,c,d,e,f){var g=a.u,h=a.f,l=a.F,k,m,p,q;e&&(a.j=2,a.F.push("{"));a:for(;0<b;--b)switch(k=R(h),a.b[k.type]){case 28:if(18!=sf(h,1).type){dg(a)?(g.error("E_CSS_COLON_EXPECTED",sf(h,1)),a.b=Tf):(a.b=Of,g.Ub());continue}m=sf(h,2);if(!(m.b||1!=m.type&&6!=m.type)){if(0<=h.b)throw Error("F_CSSTOK_BAD_CALL mark");h.b=h.f}a.g=k.text;a.D=!1;S(h);S(h);a.b=Pf;l.splice(0,l.length);continue;case 46:if(18!=sf(h,1).type){a.b=Tf;g.error("E_CSS_COLON_EXPECTED",sf(h,1));continue}a.g=k.text;a.D=!1;S(h);
S(h);a.b=Pf;l.splice(0,l.length);continue;case 29:a.b=Of;g.Ub();continue;case 1:if(!k.b){a.b=Uf;g.error("E_CSS_SPACE_EXPECTED",k);continue}g.bc();case 2:if(34==sf(h,1).type)if(S(h),S(h),p=a.N[k.text],null!=p)switch(k=R(h),k.type){case 1:g.Xb(p,k.text);a.b=f?Mf:T;S(h);break;case 36:g.Xb(p,null);a.b=f?Mf:T;S(h);break;default:a.b=Sf,g.error("E_CSS_NAMESPACE",k)}else a.b=Sf,g.error("E_CSS_UNDECLARED_PREFIX",k);else g.Xb(a.H,k.text),a.b=f?Mf:T,S(h);continue;case 3:if(!k.b){a.b=Uf;g.error("E_CSS_SPACE_EXPECTED",
k);continue}g.bc();case 4:if(34==sf(h,1).type)switch(S(h),S(h),k=R(h),k.type){case 1:g.Xb(null,k.text);a.b=f?Mf:T;S(h);break;case 36:g.Xb(null,null);a.b=f?Mf:T;S(h);break;default:a.b=Sf,g.error("E_CSS_NAMESPACE",k)}else g.Xb(a.H,null),a.b=f?Mf:T,S(h);continue;case 5:k.b&&g.bc();case 6:g.Ce(k.text);a.b=f?Mf:T;S(h);continue;case 7:k.b&&g.bc();case 8:g.re(k.text);a.b=f?Mf:T;S(h);continue;case 55:k.b&&g.bc();case 14:S(h);k=R(h);b:switch(k.type){case 1:g.qd(k.text,null);S(h);a.b=f?Mf:T;continue;case 6:m=
k.text;S(h);switch(m){case "not":a.b=Of;g.wd("not");eg(a,Number.POSITIVE_INFINITY,!1,!1,!1,!0)?a.b=T:a.b=Uf;break a;case "lang":case "href-epub-type":if(k=R(h),1===k.type){p=[k.text];S(h);break}else break b;case "nth-child":case "nth-of-type":case "nth-last-child":case "nth-last-of-type":if(p=bg(a))break;else break b;default:p=ag(a)}k=R(h);if(11==k.type){g.qd(m,p);S(h);a.b=f?Mf:T;continue}}g.error("E_CSS_PSEUDOCLASS_SYNTAX",k);a.b=Sf;continue;case 42:S(h);k=R(h);switch(k.type){case 1:g.rd(k.text,
null);a.b=f?Mf:T;S(h);continue;case 6:m=k.text;S(h);if("nth-fragment"==m){if(p=bg(a),!p)break}else p=ag(a);k=R(h);if(11==k.type){g.rd(m,p);a.b=f?Mf:T;S(h);continue}}g.error("E_CSS_PSEUDOELEM_SYNTAX",k);a.b=Sf;continue;case 9:k.b&&g.bc();case 10:S(h);k=R(h);if(1==k.type)m=k.text,S(h);else if(36==k.type)m=null,S(h);else if(34==k.type)m="";else{a.b=Uf;g.error("E_CSS_ATTR",k);S(h);continue}k=R(h);if(34==k.type){p=m?a.N[m]:m;if(null==p){a.b=Uf;g.error("E_CSS_UNDECLARED_PREFIX",k);S(h);continue}S(h);k=
R(h);if(1!=k.type){a.b=Uf;g.error("E_CSS_ATTR_NAME_EXPECTED",k);continue}m=k.text;S(h);k=R(h)}else p="";switch(k.type){case 39:case 45:case 44:case 43:case 42:case 46:case 50:q=k.type;S(h);k=R(h);break;case 15:g.Gd(p,m,0,null);a.b=f?Mf:T;S(h);continue;default:a.b=Uf;g.error("E_CSS_ATTR_OP_EXPECTED",k);continue}switch(k.type){case 1:case 2:g.Gd(p,m,q,k.text);S(h);k=R(h);break;default:a.b=Uf;g.error("E_CSS_ATTR_VAL_EXPECTED",k);continue}if(15!=k.type){a.b=Uf;g.error("E_CSS_ATTR",k);continue}a.b=f?Mf:
T;S(h);continue;case 11:g.qe();a.b=Nf;S(h);continue;case 12:g.pe();a.b=Nf;S(h);continue;case 56:g.we();a.b=Nf;S(h);continue;case 13:a.Y?(a.h.push("-epubx-region"),a.Y=!1):a.S?(a.h.push("page"),a.S=!1):a.h.push("[selector]");g.La();a.b=Kf;S(h);continue;case 41:g.Sc();a.b=Of;S(h);continue;case 15:l.push(D(k.text));S(h);continue;case 16:try{l.push(Af(k.text))}catch(z){g.error("E_CSS_COLOR",k),a.b=Sf}S(h);continue;case 17:l.push(new Pc(k.L));S(h);continue;case 18:l.push(new Qc(k.L));S(h);continue;case 19:Mb(k.text)?
l.push(new G(new tc(g.la(),k.L,k.text))):l.push(new F(k.L,k.text));S(h);continue;case 20:l.push(new Nc(k.text));S(h);continue;case 21:l.push(new Sc(Aa(k.text,a.Z)));S(h);continue;case 22:Yf(a,",",k);l.push(",");S(h);continue;case 23:l.push(Mc);S(h);continue;case 24:m=k.text.toLowerCase();"-epubx-expr"==m||"calc"==m?(a.b=Qf,a.j=0,l.push("{")):(l.push(m),l.push("("));S(h);continue;case 25:Yf(a,")",k);S(h);continue;case 47:S(h);k=R(h);m=sf(h,1);if(1==k.type&&"important"==k.text.toLowerCase()&&(17==m.type||
0==m.type||13==m.type)){S(h);a.D=!0;continue}Zf(a,"E_CSS_SYNTAX",k);continue;case 54:m=sf(h,1);switch(m.type){case 4:case 3:case 5:if(!m.b){S(h);continue}}a.b===Pf&&0<=h.b?(tf(h),a.b=Of,g.Ub()):Zf(a,"E_CSS_UNEXPECTED_PLUS",k);continue;case 26:S(h);case 48:h.b=-1;(m=Yf(a,";",k))&&a.g&&g.Rb(a.g,m,a.D);a.b=d?Lf:Kf;continue;case 44:S(h);h.b=-1;m=Yf(a,";",k);if(c)return a.result=m,!0;a.g&&m&&g.Rb(a.g,m,a.D);if(d)return!0;Zf(a,"E_CSS_SYNTAX",k);continue;case 31:m=sf(h,1);9==m.type?(10!=sf(h,2).type||sf(h,
2).b?(l.push(new uc(g.la(),Eb(k.text,m.text))),a.b=Rf):(l.push(k.text,m.text,"("),S(h)),S(h)):(2==a.j||3==a.j?"not"==k.text.toLowerCase()?(S(h),l.push(new vc(g.la(),!0,m.text))):("only"==k.text.toLowerCase()&&(S(h),k=m),l.push(new vc(g.la(),!1,k.text))):l.push(new uc(g.la(),k.text)),a.b=Rf);S(h);continue;case 38:l.push(null,k.text,"(");S(h);continue;case 32:l.push(new Hb(g.la(),k.L));S(h);a.b=Rf;continue;case 33:m=k.text;"%"==m&&(m=a.g&&a.g.match(/height|^(top|bottom)$/)?"vh":"vw");l.push(new tc(g.la(),
k.L,m));S(h);a.b=Rf;continue;case 34:l.push(new Hb(g.la(),k.text));S(h);a.b=Rf;continue;case 35:S(h);k=R(h);5!=k.type||k.b?Zf(a,"E_CSS_SYNTAX",k):(l.push(new zc(g.la(),k.L)),S(h),a.b=Rf);continue;case 36:l.push(-k.type);S(h);continue;case 37:a.b=Qf;$f(a,k.type,k);l.push(k.type);S(h);continue;case 45:"and"==k.text.toLowerCase()?(a.b=Qf,$f(a,52,k),l.push(52),S(h)):Zf(a,"E_CSS_SYNTAX",k);continue;case 39:$f(a,k.type,k)&&(a.g?a.b=Pf:Zf(a,"E_CSS_UNBALANCED_PAR",k));S(h);continue;case 43:$f(a,11,k)&&(a.g||
3==a.j?Zf(a,"E_CSS_UNEXPECTED_BRC",k):(1==a.j?g.Fc(l.pop()):(k=l.pop(),g.Fc(k)),a.h.push("media"),g.La(),a.b=Kf));S(h);continue;case 49:if($f(a,11,k))if(a.g||3!=a.j)Zf(a,"E_CSS_UNEXPECTED_SEMICOL",k);else return a.B=l.pop(),a.G=!0,a.b=Kf,S(h),!1;S(h);continue;case 40:l.push(k.type);S(h);continue;case 27:a.b=Kf;S(h);g.cc();a.h.length&&a.h.pop();continue;case 30:m=k.text.toLowerCase();switch(m){case "import":S(h);k=R(h);if(2==k.type||8==k.type){a.J=k.text;S(h);k=R(h);if(17==k.type||0==k.type)return a.G=
...
m,k);S(h);S(h);continue}g.error("E_CSS_CHARSET_SYNTAX",k);a.b=Sf;continue;case "font-face":case "-epubx-page-template":case "-epubx-define":case "-epubx-viewport":if(12==sf(h,1).type){S(h);S(h);switch(m){case "font-face":g.de();break;case "-epubx-page-template":g.fe();break;case "-epubx-define":g.be();break;case "-epubx-viewport":g.he()}a.h.push(m);g.La();continue}break;case "-adapt-footnote-area":S(h);k=R(h);switch(k.type){case 12:S(h);g.vd(null);a.h.push(m);g.La();continue;case 50:if(S(h),k=R(h),
1==k.type&&12==sf(h,1).type){m=k.text;S(h);S(h);g.vd(m);a.h.push("-adapt-footnote-area");g.La();continue}}break;case "-epubx-region":S(h);g.ge();a.Y=!0;a.b=Of;continue;case "page":S(h);g.Vc();a.S=!0;a.b=Nf;continue;case "top-left-corner":case "top-left":case "top-center":case "top-right":case "top-right-corner":case "right-top":case "right-middle":case "right-bottom":case "bottom-right-corner":case "bottom-right":case "bottom-center":case "bottom-left":case "bottom-left-corner":case "left-bottom":case "left-middle":case "left-top":S(h);
k=R(h);if(12==k.type){S(h);g.Te(m);a.h.push(m);g.La();continue}break;case "-epubx-when":S(h);a.g=null;a.j=1;a.b=Qf;l.push("{");continue;case "media":S(h);a.g=null;a.j=2;a.b=Qf;l.push("{");continue;case "-epubx-flow":if(1==sf(h,1).type&&12==sf(h,2).type){g.ce(sf(h,1).text);S(h);S(h);S(h);a.h.push(m);g.La();continue}break;case "-epubx-page-master":case "-epubx-partition":case "-epubx-partition-group":S(h);k=R(h);q=p=null;var r=[];1==k.type&&(p=k.text,S(h),k=R(h));18==k.type&&1==sf(h,1).type&&(q=sf(h,
1).text,S(h),S(h),k=R(h));for(;6==k.type&&"class"==k.text.toLowerCase()&&1==sf(h,1).type&&11==sf(h,2).type;)r.push(sf(h,1).text),S(h),S(h),S(h),k=R(h);if(12==k.type){S(h);switch(m){case "-epubx-page-master":g.ee(p,q,r);break;case "-epubx-partition":g.yd(p,q,r);break;case "-epubx-partition-group":g.xd(p,q,r)}a.h.push(m);g.La();continue}break;case "":g.error("E_CSS_UNEXPECTED_AT"+m,k);a.b=Uf;continue;default:g.error("E_CSS_AT_UNKNOWN "+m,k);a.b=Sf;continue}g.error("E_CSS_AT_SYNTAX "+m,k);a.b=Sf;continue;
case 50:if(c||d)return!0;a.l.push(k.type+1);S(h);continue;case 52:if(c||d)return!0;if(!a.l.length){a.b=Kf;continue}case 51:0<a.l.length&&a.l[a.l.length-1]==k.type&&a.l.pop();a.l.length||13!=k.type||(a.b=Kf);S(h);continue;case 53:if(c||d)return!0;a.l.length||(a.b=Kf);S(h);continue;case 200:return f&&(S(h),g.Nd()),!0;default:if(c||d)return!0;if(e)return $f(a,11,k)?(a.result=l.pop(),!0):!1;if(f)return 51==k.type?g.error(k.text,k):g.error("E_CSS_SYNTAX",k),!1;a.b===Pf&&0<=h.b?(tf(h),a.b=Of,g.Ub()):a.b!==
Sf&&a.b!==Uf&&a.b!==Tf?(51==k.type?g.error(k.text,k):g.error("E_CSS_SYNTAX",k),a.b=dg(a)?Tf:Uf):S(h)}return!1}function fg(a){Bf.call(this,null);this.f=a}v(fg,Bf);fg.prototype.error=function(a){throw Error(a);};fg.prototype.la=function(){return this.f};
function gg(a,b,c,d,e){var f=L("parseStylesheet"),g=new Wf(Kf,a,b,c),h=null;e&&(h=hg(new qf(e,b),b,c));if(h=cg(g,d,h&&h.Aa()))b.Fc(h),b.La();De(function(){for(var a={};!eg(g,100,!1,!1,!1,!1);){if(g.G){var d=Aa(g.J,c);g.B&&(b.Fc(g.B),b.La());a.Fe=L("parseStylesheet.import");ig(d,b,null,null).then(function(a){return function(){g.B&&b.cc();g.G=!1;g.J=null;g.B=null;O(a.Fe,!0)}}(a));return a.Fe.result()}d=Be();if(d.Xa)return d;a={Fe:a.Fe}}return M(!1)}).then(function(){h&&b.cc();O(f,!0)});return f.result()}
...
function Kg(a,b){if(!a.length)return b;for(var c=b.P,d,e=a.length-1;0<=e&&!(d=a[e],e===a.length-1&&d.P<b.P)&&!(d.T<b.P&&d.V-.1<=b.V&&d.U+.1>=b.U);e--)c=Math.min(c,d.T);for(var f=Math.min(c,d.P);0<=e&&!(d=a[e],d.P<=b.T||d.V-.1>b.V||d.U+.1<b.U);e--)f=d.T;f=Math.max(f,b.T);return c<=f?null:new ng(b.V,f,b.U,c)};function Lg(){this.b={}}v(Lg,Ec);Lg.prototype.qc=function(a){this.b[a.name]=!0;return a};Lg.prototype.Vb=function(a){this.rc(a.values);return a};function Mg(a){this.value=a}v(Mg,Ec);Mg.prototype.Zc=function(a){this.value=a.L;return a};function Ng(a,b){if(a){var c=new Mg(b);try{return a.ea(c),c.value}catch(d){w.b(d,"toInt: ")}}return b}function Og(){this.b=!1;this.f=[];this.name=null}v(Og,Ec);Og.prototype.ad=function(a){this.b&&this.f.push(a);return null};
Og.prototype.$c=function(a){this.b&&!a.L&&this.f.push(new F(0,"px"));return null};Og.prototype.Vb=function(a){this.rc(a.values);return null};Og.prototype.Yb=function(a){this.b||(this.b=!0,this.rc(a.values),this.b=!1,this.name=a.name.toLowerCase());return null};
...
d);if(2==c||3==c)for(f=0;f<b.f.length;f++)a.match.push(b.f[f]+g);else if(a.g){for(f=0;f<b.f.length;f++)a.f.push(b.f[f]+g);a.g=b.g}else for(f=0;f<b.f.length;f++)a.error.push(b.f[f]+g);for(f=0;f<b.error.length;f++)a.error.push(b.error[f]+g);b.X=null;b.b=null}}}var U={};function bh(){}v(bh,Ec);bh.prototype.h=function(a,b){var c=a[b].ea(this);return c?[c]:null};function $g(a,b,c){this.b=a;this.f=b;this.g=c}v($g,bh);n=$g.prototype;n.Ve=function(a){return this.b&1?a:null};
n.We=function(a){return this.b&2048?a:null};n.Ad=function(a){return this.b&2?a:null};n.qc=function(a){var b=this.f[a.name.toLowerCase()];return b?b:this.b&4?a:null};n.ad=function(a){return a.L||this.b&512?0>a.L&&!(this.b&256)?null:this.g[a.ka]?a:null:"%"==a.ka&&this.b&1024?a:null};n.$c=function(a){return a.L?0>=a.L&&!(this.b&256)?null:this.b&16?a:null:this.b&512?a:null};n.Zc=function(a){return a.L?0>=a.L&&!(this.b&256)?null:this.b&48?a:(a=this.f[""+a.L])?a:null:this.b&512?a:null};
n.ke=function(a){return this.b&64?a:null};n.bd=function(a){return this.b&128?a:null};n.Vb=function(){return null};n.oc=function(){return null};n.Yb=function(){return null};n.Yc=function(){return null};var Yg=new $g(0,U,U);
...
function dh(a,b,c,d){for(var e=c?[]:b,f=a.f,g=d,h=null,l=null;f!==a.b&&f!==a.g;)if(g>=b.length)f=f.f;else{var k=b[g],m;if(f.b)m=!0,-1==f.b?(h?h.push(l):h=[l],l=[]):-2==f.b?0<h.length?l=h.pop():l=null:0<f.b&&!(f.b%2)?l[Math.floor((f.b-1)/2)]="taken":m=null==l[Math.floor((f.b-1)/2)],f=m?f.g:f.f;else{if(!g&&!c&&f.eb instanceof eh&&a instanceof eh){if(m=(new Gc(b)).ea(f.eb)){g=b.length;f=f.g;continue}}else if(!g&&!c&&f.eb instanceof fh&&a instanceof eh){if(m=(new Hc(b)).ea(f.eb)){g=b.length;f=f.g;continue}}else m=
k.ea(f.eb);if(m){if(m!==k&&b===e)for(e=[],k=0;k<g;k++)e[k]=b[k];b!==e&&(e[g-d]=m);g++;f=f.g}else f=f.f}}return f===a.b&&(c?0<e.length:g==b.length)?e:null}n=ch.prototype;n.Cb=function(a){for(var b=null,c=this.f;c!==this.b&&c!==this.g;)a?c.b?c=c.g:(b=a.ea(c.eb))?(a=null,c=c.g):c=c.f:c=c.f;return c===this.b?b:null};n.Ve=function(a){return this.Cb(a)};n.We=function(a){return this.Cb(a)};n.Ad=function(a){return this.Cb(a)};n.qc=function(a){return this.Cb(a)};n.ad=function(a){return this.Cb(a)};n.$c=function(a){return this.Cb(a)};
n.Zc=function(a){return this.Cb(a)};n.ke=function(a){return this.Cb(a)};n.bd=function(a){return this.Cb(a)};n.Vb=function(){return null};n.oc=function(){return null};n.Yb=function(a){return this.Cb(a)};n.Yc=function(){return null};function eh(a){ch.call(this,a)}v(eh,ch);eh.prototype.Vb=function(a){var b=dh(this,a.values,!1,0);return b===a.values?a:b?new Gc(b):null};
eh.prototype.oc=function(a){for(var b=this.f,c=!1;b;){if(b.eb instanceof fh){c=!0;break}b=b.f}return c?(b=dh(this,a.values,!1,0),b===a.values?a:b?new Hc(b):null):null};eh.prototype.h=function(a,b){return dh(this,a,!0,b)};function fh(a){ch.call(this,a)}v(fh,ch);fh.prototype.Vb=function(a){return this.Cb(a)};fh.prototype.oc=function(a){var b=dh(this,a.values,!1,0);return b===a.values?a:b?new Hc(b):null};fh.prototype.h=function(a,b){for(var c=this.f,d;c!==this.g;){if(d=c.eb.h(a,b))return d;c=c.f}return null};
function gh(a,b){ch.call(this,b);this.name=a}v(gh,ch);gh.prototype.Cb=function(){return null};gh.prototype.Yb=function(a){if(a.name.toLowerCase()!=this.name)return null;var b=dh(this,a.values,!1,0);return b===a.values?a:b?new Ic(a.name,b):null};function hh(){}hh.prototype.b=function(a,b){return b};hh.prototype.f=function(){};function ih(a,b){this.name=b;this.eb=a.g[this.name]}v(ih,hh);
ih.prototype.b=function(a,b,c){if(c.values[this.name])return b;if(a=this.eb.h(a,b)){var d=a.length;this.f(1<d?new Gc(a):a[0],c);return b+d}return b};ih.prototype.f=function(a,b){b.values[this.name]=a};function jh(a,b){ih.call(this,a,b[0]);this.g=b}v(jh,ih);jh.prototype.f=function(a,b){for(var c=0;c<this.g.length;c++)b.values[this.g[c]]=a};function kh(a,b){this.X=a;this.vf=b}v(kh,hh);
kh.prototype.b=function(a,b,c){var d=b;if(this.vf)if(a[b]==Mc){if(++b==a.length)return d}else return d;var e=this.X[0].b(a,b,c);if(e==b)return d;b=e;for(d=1;d<this.X.length&&b<a.length;d++){e=this.X[d].b(a,b,c);if(e==b)break;b=e}return b};function lh(){this.f=this.zb=null;this.error=!1;this.values={};this.b=null}n=lh.prototype;n.clone=function(){var a=new this.constructor;a.zb=this.zb;a.f=this.f;a.b=this.b;return a};n.Xe=function(a,b){this.zb=a;this.f=b};n.Ic=function(){this.error=!0;return 0};
function mh(a,b){a.Ic([b]);return null}n.Ve=function(a){return mh(this,a)};n.Ad=function(a){return mh(this,a)};n.qc=function(a){return mh(this,a)};n.ad=function(a){return mh(this,a)};n.$c=function(a){return mh(this,a)};n.Zc=function(a){return mh(this,a)};n.ke=function(a){return mh(this,a)};n.bd=function(a){return mh(this,a)};n.Vb=function(a){this.Ic(a.values);return null};n.oc=function(){this.error=!0;return null};n.Yb=function(a){return mh(this,a)};n.Yc=function(){this.error=!0;return null};
function nh(){lh.call(this)}v(nh,lh);nh.prototype.Ic=function(a){for(var b=0,c=0;b<a.length;){var d=this.zb[c].b(a,b,this);if(d>b)b=d,c=0;else if(++c==this.zb.length){this.error=!0;break}}return b};function oh(){lh.call(this)}v(oh,lh);oh.prototype.Ic=function(a){if(a.length>this.zb.length||!a.length)return this.error=!0,0;for(var b=0;b<this.zb.length;b++){for(var c=b;c>=a.length;)c=1==c?0:c-2;if(this.zb[b].b(a,c,this)!=c+1)return this.error=!0,0}return a.length};function ph(){lh.call(this)}v(ph,lh);
...
qh.prototype.oc=function(a){for(var b={},c=0;c<a.values.length;c++){this.values={};if(a.values[c]instanceof Hc)this.error=!0;else{a.values[c].ea(this);for(var d=this.values,e=t(this.f),f=e.next();!f.done;f=e.next()){var f=f.value,g=d[f]||this.b.l[f],h=b[f];h||(h=[],b[f]=h);h.push(g)}this.values["background-color"]&&c!=a.values.length-1&&(this.error=!0)}if(this.error)return null}this.values={};for(var l in b)this.values[l]="background-color"==l?b[l].pop():new Hc(b[l]);return null};
function rh(){lh.call(this)}v(rh,nh);rh.prototype.Xe=function(a,b){nh.prototype.Xe.call(this,a,b);this.f.push("font-family","line-height","font-size")};
rh.prototype.Ic=function(a){var b=nh.prototype.Ic.call(this,a);if(b+2>a.length)return this.error=!0,b;this.error=!1;var c=this.b.g;if(!a[b].ea(c["font-size"]))return this.error=!0,b;this.values["font-size"]=a[b++];if(a[b]===Mc){b++;if(b+2>a.length||!a[b].ea(c["line-height"]))return this.error=!0,b;this.values["line-height"]=a[b++]}var d=b==a.length-1?a[b]:new Gc(a.slice(b,a.length));if(!d.ea(c["font-family"]))return this.error=!0,b;this.values["font-family"]=d;return a.length};
rh.prototype.oc=function(a){a.values[0].ea(this);if(this.error)return null;for(var b=[this.values["font-family"]],c=1;c<a.values.length;c++)b.push(a.values[c]);a=new Hc(b);a.ea(this.b.g["font-family"])?this.values["font-family"]=a:this.error=!0;return null};rh.prototype.qc=function(a){if(a=this.b.f[a.name])for(var b in a)this.values[b]=a[b];else this.error=!0;return null};var sh={SIMPLE:nh,INSETS:oh,INSETS_SLASH:ph,COMMA:qh,FONT:rh};
...
function Bh(a,b){for(var c={};;){var d=Ah(a,b,1);if(!d)break;c.ra=[];var e=[];c.bb="";var f=void 0;c.ab=!0;c.lg=a;for(var g=function(a){return function(){if(!a.ra.length)throw Error("No values");var b;if(1==a.ra.length)b=a.ra[0];else{var c=a.bb,d=a.ra;b=new Wg;if("||"==c){for(c=0;c<d.length;c++){var e=new Wg;if(e.X.length)throw Error("invalid call");var f=new Ug(Yg);f.b=2*c+1;e.X.push(f);var f=new Vg(0,!0),g=new Vg(0,!1);e.f.push(e.b.length);e.b.push(g);e.match.push(e.b.length);e.b.push(f);ah(e,d[c],
...
!0}}(c),l=null;!l;)switch(S(b),f=R(b),f.type){case 1:c.ab||h(" ");if(zh(f.text)){var k=a.b[f.text];if(!k)throw Error("'"+f.text+"' unexpected");c.ra.push(k.clone())}else k={},k[f.text.toLowerCase()]=D(f.text),c.ra.push(wh(new $g(0,k,U)));c.ab=!1;break;case 5:k={};k[""+f.L]=new Qc(f.L);c.ra.push(wh(new $g(0,k,U)));c.ab=!1;break;case 34:h("|");break;case 25:h("||");break;case 14:c.ab||h(" ");e.push({ra:c.ra,bb:c.bb,Ob:"["});c.bb="";c.ra=[];c.ab=!0;break;case 6:c.ab||h(" ");e.push({ra:c.ra,bb:c.bb,Ob:"(",
Pc:f.text});c.bb="";c.ra=[];c.ab=!0;break;case 15:f=g();k=e.pop();if("["!=k.Ob)throw Error("']' unexpected");c.ra=k.ra;c.ra.push(f);c.bb=k.bb;c.ab=!1;break;case 11:f=g();k=e.pop();if("("!=k.Ob)throw Error("')' unexpected");c.ra=k.ra;c.ra.push(xh(k.Pc,f));c.bb=k.bb;c.ab=!1;break;case 18:if(c.ab)throw Error("':' unexpected");S(b);c.ra.push(uh(c.ra.pop(),R(b)));break;case 22:if(c.ab)throw Error("'?' unexpected");c.ra.push(vh(c.ra.pop(),0,1));break;case 36:if(c.ab)throw Error("'*' unexpected");c.ra.push(vh(c.ra.pop(),
0,Number.POSITIVE_INFINITY));break;case 23:if(c.ab)throw Error("'+' unexpected");c.ra.push(vh(c.ra.pop(),1,Number.POSITIVE_INFINITY));break;case 12:S(b);f=R(b);if(5!=f.type)throw Error("<int> expected");var m=k=f.L;S(b);f=R(b);if(16==f.type){S(b);f=R(b);if(5!=f.type)throw Error("<int> expected");m=f.L;S(b);f=R(b)}if(13!=f.type)throw Error("'}' expected");c.ra.push(vh(c.ra.pop(),k,m));break;case 17:l=g();if(0<e.length)throw Error("unclosed '"+e.pop().Ob+"'");break;default:throw Error("unexpected token");
}S(b);zh(d)?a.b[d]=l:a.g[d]=1!=l.X.length||l.X[0].b?new eh(l):l.X[0].eb;c={ra:c.ra,lg:c.lg,bb:c.bb,ab:c.ab}}}function Ch(a,b){for(var c={},d=t(b),e=d.next();!e.done;e=d.next())for(var e=e.value,f=a.h[e],e=t(f?f.f:[e]),f=e.next();!f.done;f=e.next()){var f=f.value,g=a.l[f];g?c[f]=g:w.b("Unknown property in makePropSet:",f)}return c}
function Dh(a,b,c,d,e){var f="",g=b;b=b.toLowerCase();var h=b.match(/^-([a-z]+)-([-a-z0-9]+)$/);h&&(f=h[1],b=h[2]);if((h=a.B[b])&&h[f])if(f=a.g[b])(a=c===sd||c.hf()?c:c.ea(f))?e.Tb(b,a,d):e.kd(g,c);else if(b=a.h[b].clone(),c===sd)for(c=t(b.f),g=c.next();!g.done;g=c.next())e.Tb(g.value,sd,d);else{c.ea(b);if(b.error)d=!1;else{a=t(b.f);for(f=a.next();!f.done;f=a.next())f=f.value,e.Tb(f,b.values[f]||b.b.l[f],d);d=!0}d||e.kd(g,c)}else e.ie(g,c)}
...
{"block-size":"height","inline-size":"width"});function V(a,b){this.value=a;this.cb=b}n=V.prototype;n.Tf=function(){return this};n.Pd=function(a){a=this.value.ea(a);return a===this.value?this:new V(a,this.cb)};n.Vf=function(a){return a?new V(this.value,this.cb+a):this};n.evaluate=function(a,b){return mg(a,this.value,b)};n.Cf=function(){return!0};function Vh(a,b,c){V.call(this,a,b);this.ia=c}v(Vh,V);Vh.prototype.Tf=function(){return new V(this.value,this.cb)};
Vh.prototype.Pd=function(a){a=this.value.ea(a);return a===this.value?this:new Vh(a,this.cb,this.ia)};Vh.prototype.Vf=function(a){return a?new Vh(this.value,this.cb+a,this.ia):this};Vh.prototype.Cf=function(a){return!!this.ia.evaluate(a)};function Wh(a,b,c){return(!b||c.cb>b.cb)&&c.Cf(a)?c.Tf():b}var Xh={"region-id":!0,"fragment-selector-id":!0};function Yh(a){return"_"!=a.charAt(0)&&!Xh[a]}function Zh(a,b,c){c?a[b]=c:delete a[b]}function $h(a,b){var c=a[b];c||(c={},a[b]=c);return c}
function ai(a){var b=a._viewConditionalStyles;b||(b=[],a._viewConditionalStyles=b);return b}function bi(a,b){var c=a[b];c||(c=[],a[b]=c);return c}function ci(a,b,c,d,e,f,g){[{id:e,pg:"_pseudos"},{id:f,pg:"_regions"}].forEach(function(a){if(a.id){var c=$h(b,a.pg);b=c[a.id];b||(b={},c[a.id]=b)}});g&&(e=ai(b),b={},e.push({Qg:b,Fg:g}));for(var h in c)"_"!=h.charAt(0)&&(Xh[h]?(g=c[h],e=bi(b,h),Array.prototype.push.apply(e,g)):Zh(b,h,Wh(a,b[h],c[h].Vf(d))))}
...
xi.prototype.apply=function(a){a.lang.match(this.h)&&this.b.apply(a)};function yi(){this.b=null}v(yi,W);yi.prototype.apply=function(a){a.ob&&this.b.apply(a)};yi.prototype.f=function(){return 6};function zi(){this.b=null}v(zi,W);zi.prototype.apply=function(a){a.ta&&this.b.apply(a)};zi.prototype.f=function(){return 12};function Ai(a,b){this.b=null;this.h=a;this.Ob=b}v(Ai,W);function Bi(a,b,c){a-=c;return b?!(a%b)&&0<=a/b:!a}function Ci(a,b){Ai.call(this,a,b)}v(Ci,Ai);
Ci.prototype.apply=function(a){Bi(a.Za,this.h,this.Ob)&&this.b.apply(a)};Ci.prototype.f=function(){return 5};function Di(a,b){Ai.call(this,a,b)}v(Di,Ai);Di.prototype.apply=function(a){Bi(a.Kb[a.j][a.f],this.h,this.Ob)&&this.b.apply(a)};Di.prototype.f=function(){return 5};function Ei(a,b){Ai.call(this,a,b)}v(Ei,Ai);Ei.prototype.apply=function(a){var b=a.S;null===b&&(b=a.S=a.b.parentNode.childElementCount-a.Za+1);Bi(b,this.h,this.Ob)&&this.b.apply(a)};Ei.prototype.f=function(){return 4};
function Fi(a,b){Ai.call(this,a,b)}v(Fi,Ai);Fi.prototype.apply=function(a){var b=a.Bb;if(!b[a.j]){var c=a.b;do{var d=c.namespaceURI,e=c.localName,f=b[d];f||(f=b[d]={});f[e]=(f[e]||0)+1}while(c=c.nextElementSibling)}Bi(b[a.j][a.f],this.h,this.Ob)&&this.b.apply(a)};Fi.prototype.f=function(){return 4};function Gi(){this.b=null}v(Gi,W);Gi.prototype.apply=function(a){for(var b=a.b.firstChild;b;){switch(b.nodeType){case Node.ELEMENT_NODE:return;case Node.TEXT_NODE:if(0<b.length)return}b=b.nextSibling}this.b.apply(a)};
...
Zi.prototype.Yb=function(a){if("attr"!==a.name)return Fc.prototype.Yb.call(this,a);var b="string",c;a.values[0]instanceof Gc?(2<=a.values[0].values.length&&(b=a.values[0].values[1].stringValue()),c=a.values[0].values[0].stringValue()):c=a.values[0].stringValue();a=1<a.values.length?$i(a.values[1].stringValue(),b):$i(null,b);return this.element&&this.element.hasAttribute(c)?$i(this.element.getAttribute(c),b):a};function aj(a,b,c){this.f=a;this.element=b;this.b=c}v(aj,Fc);
aj.prototype.qc=function(a){var b=this.f,c=b.J,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.D)];b.D++;break;case "close-quote":return 0<b.D&&b.D--,c[2*Math.min(d,b.D)+1];case "no-open-quote":return b.D++,new Nc("");case "no-close-quote":return 0<b.D&&b.D--,new Nc("")}return a};
...
dj={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},ej={sh:!1,fd:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",Vd:"\u5341\u767e\u5343",Ig:"\u8ca0"};
function fj(a){if(9999<a||-9999>a)return""+a;if(!a)return ej.fd.charAt(0);var b=new Qa;0>a&&(b.append(ej.Ig),a=-a);if(10>a)b.append(ej.fd.charAt(a));else if(ej.uh&&19>=a)b.append(ej.Vd.charAt(0)),a&&b.append(ej.Vd.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(ej.fd.charAt(c)),b.append(ej.Vd.charAt(2)));if(c=Math.floor(a/100)%10)b.append(ej.fd.charAt(c)),b.append(ej.Vd.charAt(1));if(c=Math.floor(a/10)%10)b.append(ej.fd.charAt(c)),b.append(ej.Vd.charAt(0));(a%=10)&&b.append(ej.fd.charAt(a))}return b.toString()}
...
aj.prototype.Yb=function(a){switch(a.name){case "counter":if(2>=a.values.length)return gj(this,a.values);break;case "counters":if(3>=a.values.length)return ij(this,a.values);break;case "target-counter":if(3>=a.values.length)return kj(this,a.values);break;case "target-counters":if(4>=a.values.length)return mj(this,a.values)}w.b("E_CSS_CONTENT_PROP:",a.toString());return new Nc("")};var oj=1/1048576;function pj(a,b){for(var c in a)b[c]=a[c].clone()}
function qj(){this.j=0;this.b={};this.zd={};this.h={};this.f={};this.Pa={};this.g={};this.od={};this.order=0}qj.prototype.clone=function(){var a=new qj;a.j=this.j;for(var b in this.b)a.b[b]=this.b[b];pj(this.zd,a.zd);pj(this.h,a.h);pj(this.f,a.f);pj(this.Pa,a.Pa);pj(this.g,a.g);pj(this.od,a.od);a.order=this.order;return a};function ni(a,b,c){var d=a[b];d&&(c=d.l(c));a[b]=c}qj.prototype.rf=function(){return this.order+=oj};
function rj(a,b,c,d){this.u=a;this.l=b;this.Jc=c;this.xb=d;this.h=[[],[]];this.ha={};this.G=this.F=this.ua=this.b=null;this.Ba=this.oa=this.Y=this.j=this.f="";this.Z=this.N=null;this.ta=this.ob=!0;this.g={};this.H=[{}];this.J=[new Nc("\u201c"),new Nc("\u201d"),new Nc("\u2018"),new Nc("\u2019")];this.D=0;this.lang="";this.Nb=[0];this.Za=0;this.sa=[{}];this.Kb=this.sa[0];this.S=null;this.Mb=[this.S];this.Jb=[{}];this.Bb=this.sa[0];this.B={};this.fb=[];this.Lb=[]}
function Qi(a,b,c){a.ha[b]--;a.B[b]&&(a.B[b]=a.B[b].filter(function(a){return a!==c}),a.B[b].length||delete a.B[b])}function li(a,b){var c=null;b&&(c=sj(a.ua,b));var d=a.fb.map(function(b){return(b=a.B[b])&&0<b.length?1===b.length?b[0]:new tj([].concat(b)):null}).filter(function(a){return a});return 0>=d.length?c:c?new uj([c].concat(d)):1===d.length?d[0]:new uj(d)}function vj(a,b,c){(b=b[c])&&b.apply(a)}var wj=[];
function xj(a,b,c,d){a.b=null;a.ua=null;a.F=d;a.j="";a.f="";a.Y="";a.oa="";a.G=b;a.Ba="";a.N=wj;a.Z=c;yj(a)}function zj(a,b,c){a.g[b]?a.g[b].push(c):a.g[b]=[c];c=a.H[a.H.length-1];c||(c={},a.H[a.H.length-1]=c);c[b]=!0}
...
function Dj(a,b,c,d){a.Lb.push(b);a.Z=null;a.b=b;a.ua=d;a.F=c;a.j=b.namespaceURI;a.f=b.localName;d=a.u.b[a.j];a.Ba=d?d+a.f:"";a.Y=b.getAttribute("id");a.oa=b.getAttributeNS("http://www.w3.org/XML/1998/namespace","id");(d=b.getAttribute("class"))?a.G=d.split(/\s+/):a.G=wj;(d=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))?a.N=d.split(/\s+/):a.N=wj;"style"==a.f&&"http://www.gribuser.ru/xml/fictionbook/2.0"==a.j&&(a.G=[b.getAttribute("name")||""]);if(d=Pa(b))a.h[a.h.length-1].push(new Xi(a.lang)),
a.lang=d.toLowerCase();d=a.ta;var e=a.Nb;a.Za=++e[e.length-1];e.push(0);var e=a.sa,f=a.Kb=e[e.length-1],g=f[a.j];g||(g=f[a.j]={});g[a.f]=(g[a.f]||0)+1;e.push({});e=a.Mb;null!==e[e.length-1]?a.S=--e[e.length-1]:a.S=null;e.push(null);e=a.Jb;(f=a.Bb=e[e.length-1])&&f[a.j]&&f[a.j][a.f]--;e.push({});yj(a);Ej(a,b);e=c.quotes;c=null;e&&(e=e.evaluate(a.l))&&(c=new Yi(a.J),e===J?a.J=[new Nc(""),new Nc("")]:e instanceof Gc&&(a.J=e.values));Aj(a,a.F);e=a.Y||a.oa||b.getAttribute("name")||"";if(d||e){var h={};
Object.keys(a.g).forEach(function(a){h[a]=Array.from(this.g[a])},a);Fj(a.Jc,e,h)}if(d=a.F._pseudos)for(e=!0,f=t(Cj),g=f.next();!g.done;g=f.next())(g=g.value)||(e=!1),(g=d[g])&&(e?Wi(a,g,b):a.h[a.h.length-2].push(new Vi(g,b)));c&&a.h[a.h.length-2].push(c)}function Gj(a,b){for(var c in b)Yh(c)&&(b[c]=b[c].Pd(a))}function Ej(a,b){var c=new Zi(b),d=a.F,e=d._pseudos,f;for(f in e)Gj(c,e[f]);Gj(c,d)}
function yj(a){var b;for(b=0;b<a.G.length;b++)vj(a,a.u.Pa,a.G[b]);for(b=0;b<a.N.length;b++)vj(a,a.u.f,a.N[b]);vj(a,a.u.g,a.Y);vj(a,a.u.zd,a.f);""!=a.f&&vj(a,a.u.zd,"*");vj(a,a.u.h,a.Ba);null!==a.Z&&(vj(a,a.u.od,a.Z),vj(a,a.u.od,"*"));a.b=null;a.h.push([]);for(var c=1;-1<=c;--c){var d=a.h[a.h.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.ob=!0;a.ta=!1}
function Hj(a){for(var b=1;-1<=b;--b)for(var c=a.h[a.h.length-b-2],d=0;d<c.length;)c[d].f(a,b)?c.splice(d,1):d++;a.h.pop();a.ob=!1}var Ij=null;function Jj(a,b,c,d,e,f,g){Gf.call(this,a,b,g);this.b=null;this.ba=0;this.h=this.mb=null;this.D=!1;this.ia=c;this.l=d?d.l:Ij?Ij.clone():new qj;this.G=e;this.B=f;this.u=0;this.j=null}v(Jj,Hf);Jj.prototype.Xf=function(a){ni(this.l.zd,"*",a)};function Kj(a,b){var c=di(a.b,b);c!==b&&c.g(a.l)||a.Xf(c)}
Jj.prototype.Xb=function(a,b){if(b||a)this.ba+=1,b&&a?this.b.push(new qi(a,b.toLowerCase())):b?this.b.push(new pi(b.toLowerCase())):this.b.push(new si(a))};Jj.prototype.re=function(a){this.h?(w.b("::"+this.h,"followed by ."+a),this.b.push(new Ki(""))):(this.ba+=256,this.b.push(new mi(a)))};var Lj={"nth-child":Ci,"nth-of-type":Di,"nth-last-child":Ei,"nth-last-of-type":Fi};
...
b.length?this.j="NFS_"+b[0]+"_"+b[1]:this.b.push(new Ki(""));break;default:w.b("Unrecognized pseudoelement: ::"+a),this.b.push(new Ki(""))}this.ba+=1};Jj.prototype.Ce=function(a){this.ba+=65536;this.b.push(new oi(a))};
Jj.prototype.Gd=function(a,b,c,d){this.ba+=256;b=b.toLowerCase();d=d||"";var e;switch(c){case 0:e=new ti(a,b);break;case 39:e=new ui(a,b,d);break;case 45:!d||d.match(/\s/)?e=new Ki(""):e=new wi(a,b,new RegExp("(^|\\s)"+Fa(d)+"($|\\s)"));break;case 44:e=new wi(a,b,new RegExp("^"+Fa(d)+"($|-)"));break;case 43:d?e=new wi(a,b,new RegExp("^"+Fa(d))):e=new Ki("");break;case 42:d?e=new wi(a,b,new RegExp(Fa(d)+"$")):e=new Ki("");break;case 46:d?e=new wi(a,b,new RegExp(Fa(d))):e=new Ki("");break;case 50:"supported"==
d?e=new vi(a,b):(w.b("Unsupported :: attr selector op:",d),e=new Ki(""));break;default:w.b("Unsupported attr selector:",c),e=new Ki("")}this.b.push(e)};var Mj=0;n=Jj.prototype;n.bc=function(){var a="d"+Mj++;Kj(this,new ji(new Ri(a,this.j,null)));this.b=[new Ki(a)];this.j=null};n.qe=function(){var a="c"+Mj++;Kj(this,new ji(new Si(a,this.j,null)));this.b=[new Ki(a)];this.j=null};n.pe=function(){var a="a"+Mj++;Kj(this,new ji(new Ti(a,this.j,null)));this.b=[new Ki(a)];this.j=null};
n.we=function(){var a="f"+Mj++;Kj(this,new ji(new Ui(a,this.j,null)));this.b=[new Ki(a)];this.j=null};n.Sc=function(){Nj(this);this.h=null;this.D=!1;this.ba=0;this.b=[]};n.Ub=function(){var a;0!=this.u?(Jf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.u=1,this.mb={},this.h=null,this.ba=0,this.D=!1,this.b=[])};n.error=function(a,b){Hf.prototype.error.call(this,a,b);1==this.u&&(this.u=0)};n.Wc=function(a){Hf.prototype.Wc.call(this,a);this.u=0};
n.La=function(){Nj(this);Hf.prototype.La.call(this);1==this.u&&(this.u=0)};n.cc=function(){Hf.prototype.cc.call(this)};function Nj(a){if(a.b){var b=a.ba+a.l.rf();Kj(a,a.$f(b));a.b=null;a.h=null;a.j=null;a.D=!1;a.ba=0}}n.$f=function(a){var b=this.G;this.D&&(b=b?"xxx-bogus-xxx":"footnote");return new ki(this.mb,a,this.h,b,this.j)};n.Rb=function(a,b,c){Dh(this.B,a,b,c,this)};n.kd=function(a,b){If(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};
n.ie=function(a,b){If(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};n.Tb=function(a,b,c){"display"!=a||b!==Ed&&b!==Dd||(this.Tb("flow-options",new Gc([kd,Ld]),c),this.Tb("flow-into",b,c),b=ad);ge("SIMPLE_PROPERTY").forEach(function(d){d=d({name:a,value:b,important:c});a=d.name;b=d.value;c=d.important});var d=c?Cf(this):Df(this);Zh(this.mb,a,this.ia?new Vh(b,d,this.ia):new V(b,d))};n.wd=function(a){switch(a){case "not":a=new Oj(this),a.Ub(),Ff(this.na,a)}};
function Oj(a){Jj.call(this,a.f,a.na,a.ia,a,a.G,a.B,!1);this.parent=a;this.g=a.b}v(Oj,Jj);n=Oj.prototype;n.wd=function(a){"not"==a&&Jf(this,"E_CSS_UNEXPECTED_NOT")};n.La=function(){Jf(this,"E_CSS_UNEXPECTED_RULE_BODY")};n.Sc=function(){Jf(this,"E_CSS_UNEXPECTED_NEXT_SELECTOR")};n.Nd=function(){this.b&&0<this.b.length&&this.g.push(new Mi(this.b));this.parent.ba+=this.ba;var a=this.na;a.b=a.g.pop()};n.error=function(a,b){Jj.prototype.error.call(this,a,b);var c=this.na;c.b=c.g.pop()};
function Pj(a,b){Gf.call(this,a,b,!1)}v(Pj,Hf);Pj.prototype.Rb=function(a,b){if(this.f.values[a])this.error("E_CSS_NAME_REDEFINED "+a,this.jd());else{var c=a.match(/height|^(top|bottom)$/)?"vh":"vw",c=new tc(this.f,100,c),c=b.Aa(this.f,c);this.f.values[a]=c}};function Qj(a,b,c,d,e){Gf.call(this,a,b,!1);this.mb=d;this.ia=c;this.b=e}v(Qj,Hf);Qj.prototype.Rb=function(a,b,c){c?w.b("E_IMPORTANT_NOT_ALLOWED"):Dh(this.b,a,b,c,this)};Qj.prototype.kd=function(a,b){w.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};
Qj.prototype.ie=function(a,b){w.b("E_INVALID_PROPERTY",a+":",b.toString())};Qj.prototype.Tb=function(a,b,c){c=c?Cf(this):Df(this);c+=this.order;this.order+=oj;Zh(this.mb,a,this.ia?new Vh(b,c,this.ia):new V(b,c))};function Rj(a,b){fg.call(this,a);this.mb={};this.b=b;this.order=0}v(Rj,fg);Rj.prototype.Rb=function(a,b,c){Dh(this.b,a,b,c,this)};Rj.prototype.kd=function(a,b){w.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};Rj.prototype.ie=function(a,b){w.b("E_INVALID_PROPERTY",a+":",b.toString())};
Rj.prototype.Tb=function(a,b,c){c=(c?67108864:50331648)+this.order;this.order+=oj;Zh(this.mb,a,new V(b,c))};function Sj(a,b,c){return(a=a["writing-mode"])&&(b=a.evaluate(b,"writing-mode"))&&b!==sd?b===Vd:c}function Tj(a,b,c){return(a=a.direction)&&(b=a.evaluate(b,"direction"))&&b!==sd?b===Md:c}function Uj(a,b,c,d){var e={},f;for(f in a)Yh(f)&&(e[f]=a[f]);Vj(e,b,a);Wj(a,c,d,function(a,c){Xj(e,c,b);Vj(e,b,c)});return e}
function Wj(a,b,c,d){a=a._regions;if((b||c)&&a)for(c&&(c=["footnote"],b=b?b.concat(c):c),b=t(b),c=b.next();!c.done;c=b.next()){c=c.value;var e=a[c];e&&d(c,e)}}function Xj(a,b,c){for(var d in b)Yh(d)&&(a[d]=Wh(c,a[d],b[d]))}function Yj(a,b,c,d,e){c=c?d?Th:Rh:d?Uh:Sh;for(var f in a)if(a.hasOwnProperty(f)&&(d=a[f])){var g=c[f];if(g){var h=a[g];if(h&&h.cb>d.cb)continue;g=Mh[g]?g:f}else g=f;b[g]=e(f,d)}};var Zj=!1,ak={hh:"ltr",ih:"rtl"};na("vivliostyle.constants.PageProgression",ak);ak.LTR="ltr";ak.RTL="rtl";var bk={sg:"left",tg:"right"};na("vivliostyle.constants.PageSide",bk);bk.LEFT="left";bk.RIGHT="right";var ck={LOADING:"loading",gh:"interactive",dh:"complete"};na("vivliostyle.constants.ReadyState",ck);ck.LOADING="loading";ck.INTERACTIVE="interactive";ck.COMPLETE="complete";function dk(a,b,c){this.u=a;this.url=b;this.b=c;this.lang=null;this.h=-1;this.root=c.documentElement;b=a=null;if("http://www.w3.org/1999/xhtml"==this.root.namespaceURI){for(var d=this.root.firstChild;d;d=d.nextSibling)if(1==d.nodeType&&(c=d,"http://www.w3.org/1999/xhtml"==c.namespaceURI))switch(c.localName){case "head":b=c;break;case "body":a=c}this.lang=this.root.getAttribute("lang")}else if("http://www.gribuser.ru/xml/fictionbook/2.0"==this.root.namespaceURI){b=this.root;for(d=this.root.firstChild;d;d=
...
var mk={lh:"text/html",mh:"text/xml",Yg:"application/xml",Xg:"application/xhtml_xml",fh:"image/svg+xml"};function nk(a,b,c){c=c||new DOMParser;var d;try{d=c.parseFromString(a,b)}catch(e){}if(d){a=d.documentElement;if("parsererror"===a.localName)return null;for(a=a.firstChild;a;a=a.nextSibling)if("parsererror"===a.localName)return null}else return null;return d}
...
function Ek(a,b){this.Qb={};this.I=a;this.h=b;this.D=null;this.l=[];var c=this;this.J=function(a){var b=a.currentTarget,d=b.getAttribute("href")||b.getAttributeNS("http://www.w3.org/1999/xlink","href");d&&fb(c,{type:"hyperlink",target:null,currentTarget:null,qh:b,href:d,preventDefault:function(){a.preventDefault()}})};this.f={};this.g={width:0,height:0};this.B=this.u=!1;this.F=this.G=!0;this.O=0;this.position=null;this.offset=-1;this.b=null;this.j=[];this.H={top:{},bottom:{},left:{},right:{}}}
...
function Tk(a,b){if(a===b)return!0;if(!a||!b||a.ma!==b.ma||a.K!==b.K||a.pa.length!==b.pa.length)return!1;for(var c=0;c<a.pa.length;c++)if(!Rk(a.pa[c],b.pa[c]))return!1;return!0}function Uk(a){return{pa:[{node:a.M,kb:Vk,wa:a.wa,Ja:null,Ga:null,Sa:0}],ma:0,K:!1,Qa:a.Qa}}function Wk(a,b){var c=new Xk(a.node,b,0);c.kb=a.kb;c.wa=a.wa;c.Ja=a.Ja;c.Ga=a.Ga?Wk(a.Ga,Yk(b)):null;c.C=a.C;c.Sa=a.Sa+1;return c}var Vk=0;
function Zk(a,b,c,d,e,f,g){this.na=a;this.pd=d;this.yf=null;this.root=b;this.ca=c;this.type=f;e&&(e.yf=this);this.b=g}function Sk(a,b){return a===b||!!a&&!!b&&(b?a.na===b.na&&a.ca===b.ca&&a.type===b.type&&Sk(a.pd,b.pd):!1)}function $k(a,b){this.Lg=a;this.count=b}
function Xk(a,b,c){this.M=a;this.parent=b;this.Ma=c;this.ma=0;this.K=!1;this.kb=Vk;this.wa=b?b.wa:null;this.Ga=this.Ja=null;this.Ba=!1;this.ya=!0;this.xa=!1;this.j=b?b.j:0;this.display=null;this.W=al;this.ha=this.N=this.l=this.Ca=null;this.Z="baseline";this.oa="top";this.ta=this.sa=0;this.H=!1;this.tc=b?b.tc:0;this.F=b?b.F:null;this.B=b?b.B:!1;this.S=this.hd=!1;this.D=this.A=this.G=this.g=null;this.h=b?b.h:{};this.b=b?b.b:!1;this.direction=b?b.direction:"ltr";this.f=b?b.f:null;this.Qa=this.lang=null;
this.C=b?b.C:null;this.u=null;this.ua={};this.Sa=1;this.Y=this.J=null}function bl(a){a.ya=!0;a.j=a.parent?a.parent.j:0;a.A=null;a.D=null;a.ma=0;a.K=!1;a.display=null;a.W=al;a.Ca=null;a.l=null;a.N=null;a.ha=null;a.Z="baseline";a.H=!1;a.tc=a.parent?a.parent.tc:0;a.F=a.parent?a.parent.F:null;a.B=a.parent?a.parent.B:!1;a.g=null;a.G=null;a.Ja=null;a.hd=!1;a.S=!1;a.b=a.parent?a.parent.b:!1;a.Ja=null;a.Qa=null;a.C=a.parent?a.parent.C:null;a.u=null;a.ua={};a.Sa=1;a.J=null;a.Y=null}
function cl(a){var b=new Xk(a.M,a.parent,a.Ma);b.ma=a.ma;b.K=a.K;b.Ja=a.Ja;b.kb=a.kb;b.wa=a.wa;b.Ga=a.Ga;b.ya=a.ya;b.j=a.j;b.display=a.display;b.W=a.W;b.Ca=a.Ca;b.l=a.l;b.N=a.N;b.ha=a.ha;b.Z=a.Z;b.oa=a.oa;b.sa=a.sa;b.ta=a.ta;b.hd=a.hd;b.S=a.S;b.H=a.H;b.tc=a.tc;b.F=a.F;b.B=a.B;b.g=a.g;b.G=a.G;b.A=a.A;b.D=a.D;b.f=a.f;b.b=a.b;b.xa=a.xa;b.Qa=a.Qa;b.C=a.C;b.u=a.u;b.ua=Object.create(a.ua);b.Sa=a.Sa;b.J=a.J;b.Y=a.Y;return b}Xk.prototype.modify=function(){return this.Ba?cl(this):this};
function Yk(a){var b=a;do{if(b.Ba)break;b.Ba=!0;b=b.parent}while(b);return a}Xk.prototype.clone=function(){for(var a=cl(this),b=a,c;c=b.parent;)c=cl(c),b=b.parent=c;return a};function dl(a){return{node:a.M,kb:a.kb,wa:a.wa,Ja:a.Ja,Ga:a.Ga?dl(a.Ga):null,C:a.C,Sa:a.Sa}}function el(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(dl(b)),b=b.parent;while(b);b=a.Qa?fl(a.Qa,a.ma,-1):a.ma;return{pa:c,ma:b,K:a.K,Qa:a.Qa}}function gl(a){for(a=a.parent;a;){if(a.hd)return!0;a=a.parent}return!1}
...
function Rl(a,b,c){if(!(b in a.u)){var d=a.style[b];a.u[b]=d?d.evaluate(a.B,b):c||null}return a.u[b]}function Vl(a){return Rl(a,"display",td)}function Ql(a){if(null===a.l){var b=Vl(a),c=Rl(a,"position"),d=Rl(a,"float");a.l=Wl(b,c,d,a.D).display===ad}return a.l}function Pl(a){null===a.j&&(a.j=a.F&&Vl(a)!==J);return a.j}function Tl(a,b){var c=null;if(Ql(a)){var d=Rl(a,"break-"+b);d&&(c=d.toString())}return c}function Xl(a){this.g=a;this.b=[];this.pb=this.ib=!0;this.f=[]}
...
function am(a,b,c,d,e,f,g,h){this.ca=a;this.root=a.root;this.fb=c;this.h=d;this.B=f;this.f=this.root;this.F={};this.Y={};this.G={};this.J=[];this.D=this.S=this.N=null;this.Ba=g;this.Z=new rj(b,d,g,h);this.g=new Il;this.u=!0;this.oa=[];this.Za=e;this.ua=this.ta=!1;this.b=a=gk(a,this.root);this.ha={};this.j=new Xl(d);Kl(this.g,a);d=bm(this,this.root);Dj(this.Z,this.root,d,a);cm(this,d,!1);this.H=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.H=
!1}this.oa.push(!0);this.Y={};this.Y["e"+a]=d;this.b++;dm(this,-1)}function em(a,b,c,d){return(b=b[d])&&b.evaluate(a.h)!==c[d]}function fm(a,b,c){for(var d in c){var e=b[d];e?(a.F[d]=e,delete b[d]):(e=c[d])&&(a.F[d]=new V(e,33554432))}}var gm=["column-count","column-width","column-fill"];
function cm(a,b,c){["writing-mode","direction"].forEach(function(d){!b[d]||c&&a.F[d]||(a.F[d]=b[d])});if(!a.ta){var d=em(a,b,a.B.j,"background-color")?b["background-color"].evaluate(a.h):null,e=em(a,b,a.B.j,"background-image")?b["background-image"].evaluate(a.h):null;if(d&&d!==sd||e&&e!==sd)fm(a,b,a.B.j),a.ta=!0}if(!a.ua)for(d=0;d<gm.length;d++)if(em(a,b,a.B.u,gm[d])){fm(a,b,a.B.u);a.ua=!0;break}if(!c&&(d=b["font-size"])){e=d.evaluate(a.h);d=e.L;switch(e.ka){case "em":case "rem":d*=a.h.u;break;case "ex":d*=
a.h.u*Nb.ex/Nb.em;break;case "%":d*=a.h.u/100;break;default:(e=Nb[e.ka])&&(d*=e)}a.h.Za=d}}function hm(a){for(var b=0;!a.H&&(b+=5E3,im(a,b,0)!=Number.POSITIVE_INFINITY););return a.F}function bm(a,b){if(b.style instanceof CSSStyleDeclaration){var c=b.getAttribute("style");if(c){var d=a.ca.url,e=new Rj(a.fb,a.B),c=new qf(c,e);try{eg(new Wf(Lf,c,e,d),Number.POSITIVE_INFINITY,!1,!0,!1,!1)}catch(f){w.b(f,"Style attribute parse error:")}return e.mb}}return{}}
function dm(a,b){if(!(b>=a.b)){var c=a.h,d=gk(a.ca,a.root);if(b<d){var e=a.l(a.root,!1),f=e["flow-into"],f=f?f.evaluate(c,"flow-into").toString():"body",f=jm(a,f,e,a.root,d);!a.j.b.length&&a.j.push(e,d,!0,f)}d=jk(a.ca,b);e=hk(a.ca,d,0,!1);if(!(e>=a.b))for(;;){if(1!=d.nodeType)e+=d.textContent.length;else{var g=d;if(e!=gk(a.ca,g))throw Error("Inconsistent offset");var h=a.l(g,!1);if(f=h["flow-into"])f=f.evaluate(c,"flow-into").toString(),jm(a,f,h,g,e);e++}if(e>=a.b)break;f=d.firstChild;if(!f)for(;!(f=
...
function jm(a,b,c,d,e){var f=0,g=Number.POSITIVE_INFINITY,h=!1,l=!1,k=!1,m=c["flow-options"];if(m){var p;a:{if(h=m.evaluate(a.h,"flow-options")){l=new Lg;try{h.ea(l);p=l.b;break a}catch(q){w.b(q,"toSet:")}}p={}}k=p;h=!!k.exclusive;l=!!k["static"];k=!!k.last}(p=c["flow-linger"])&&(g=Ng(p.evaluate(a.h,"flow-linger"),Number.POSITIVE_INFINITY));(c=c["flow-priority"])&&(f=Ng(c.evaluate(a.h,"flow-priority"),0));c=a.ha[e]||null;p=a.G[b];p||(p=Yl(a.j),p=a.G[b]=new Mk(p?p.qa.b:null));d=new Nk(b,d,e,f,g,h,
l,k,c);a.J.push(d);a.S==b&&(a.S=null);a.N&&lm(a.N,d,p);return d}function mm(a,b,c,d){Ul[b]&&(d=a.G[d].b,(!d.length||d[d.length-1]<c)&&d.push(c));a.ha[c]=Sl(a.ha[c],b)}
function im(a,b,c){var d=-1;if(b<=a.b&&(d=Ml(a.g,b),d+=c,d<Jl(a.g)))return Nl(a.g,d);if(!a.f)return Number.POSITIVE_INFINITY;for(var e=a.h;;){var f=a.f.firstChild;if(!f)for(;;){if(1==a.f.nodeType){var f=a.Z,g=a.f;if(f.Lb.pop()!==g)throw Error("Invalid call to popElement");f.Nb.pop();f.sa.pop();f.Mb.pop();f.Jb.pop();Hj(f);Bj(f);a.u=a.oa.pop();var f=a.j,h=a.b,l=g=f.b.pop(),k=f.ib,m=f.pb;if(Pl(l)){var p=l.style._pseudos;p&&p.after&&(h=new Ol(l.B,p.after,h,!1,l.qa,k,m,!0),k=Rl(h,"content"),Gl(k)&&(l.f=
...
function Sl(a,b){if(a)if(b){var c=!!Ul[a],d=!!Ul[b];if(c&&d)switch(b){case "column":return a;case "region":return"column"===a?b:a;default:return b}else return d?b:c?a:Am[b]?b:Am[a]?a:b}else return a;else return b}function Bm(a){switch(a){case "left":case "right":case "recto":case "verso":return a;default:return"any"}};function Cm(){}n=Cm.prototype;n.Wf=function(a){return{w:a,Fd:!1,Wb:!1}};n.xf=function(){};n.Gf=function(){};n.ng=function(){};n.Ff=function(){};n.Bd=function(){};n.sc=function(){};function Dm(a,b){this.b=a;this.f=b}
function Em(a,b){var c=a.b,d=c.Wf(b),e=L("LayoutIterator");Ee(function(b){for(var e;d.w;){e=d.w.A?1!==d.w.A.nodeType?Lk(d.w.A,d.w.tc)?void 0:d.w.K?c.Gf(d):c.xf(d):d.w.ya?d.w.K?c.Ff(d):c.ng(d):d.w.K?c.sc(d):c.Bd(d):void 0;e=(e&&e.Xa()?e:M(!0)).da(function(){return d.Wb?M(null):Fm(a.f,d.w,d.Fd)});if(e.Xa()){e.then(function(a){d.Wb?Q(b):(d.w=a,P(b))});return}if(d.Wb){Q(b);return}d.w=e.get()}Q(b)}).then(function(){O(e,d.w)});return e.result()}function Gm(a){this.fc=a}v(Gm,Cm);n=Gm.prototype;n.og=function(){};
n.Qf=function(){};n.Wf=function(a){return{w:a,Fd:!!this.fc&&a.K,Wb:!1,fc:this.fc,dd:null,Me:!1,Zf:[],ld:null}};n.xf=function(a){a.Me=!1};n.Bd=function(a){a.Zf.push(Yk(a.w));a.dd=Sl(a.dd,a.w.g);a.Me=!0;return this.og(a)};n.sc=function(a){var b;a.Me?(b=(b=void 0,M(!0)),b=b.da(function(){a.Wb||(a.Zf=[],a.fc=!1,a.Fd=!1,a.dd=null);return M(!0)})):b=(b=this.Qf(a))&&b.Xa()?b:M(!0);return b.da(function(){a.Wb||(a.Me=!1,a.ld=Yk(a.w),a.dd=Sl(a.dd,a.w.G));return M(!0)})};
function Hm(a,b,c){this.wf=[];this.za=Object.create(a);this.za.element=b;this.za.j=a.j.clone();this.za.u=!1;this.za.nf=c.C;this.za.Md=a;a=Im(this.za,c);this.za.oa-=a;var d=this;this.za.Hd=function(a){return Jm.prototype.Hd.call(this,a).da(function(a){d.wf.push(Yk(a));return M(a)})}}function Km(a,b){return Lm(a.za,b,!0)}Hm.prototype.dc=function(a){var b=this.za.dc();if(a){a=Yk(this.wf[0]);var c=new Mm(a,null,a.xa,0);c.f(this.za,0);if(!b.w)return{Db:c,w:a}}return b};
Hm.prototype.Na=function(a,b,c){return this.za.Na(a,b,c)};function Nm(){this.u=this.h=null}function Om(a,b,c){a.hg(b,c);return Pm(a,b,c)}function Pm(a,b,c){var d=L("vivliostyle.layoututil.AbstractLayoutRetryer.tryLayout");a.Bf(b,c);var e=a.tf(b);e.b(b,c).then(function(a){var f=e.f(a,c);(f=e.g(a,this.f,c,f))?O(d,a):(this.Jd(this.f),this.le(b,c),Pm(this,this.f,c).Ea(d))}.bind(a));return d.result()}Nm.prototype.hg=function(){};
Nm.prototype.Jd=function(a){a=a.A||a.parent.A;for(var b;b=a.lastChild;)a.removeChild(b);for(;b=a.nextSibling;)b.parentNode.removeChild(b)};Nm.prototype.Bf=function(a,b){this.f=Yk(a);this.h=[].concat(b.N);this.D=[].concat(b.B);a.C&&(this.u=a.C.af())};Nm.prototype.le=function(a,b){b.N=this.h;b.B=this.D;a.C&&a.C.$e(this.u)};function Qm(a,b,c,d){d=d[b];if(!d)throw Error("unknown writing-mode: "+b);b=d[c||"ltr"];if(!b)throw Error("unknown direction: "+c);c=t(b);for(b=c.next();!b.done;b=c.next())if(b=b.value,b=a.replace(b.h,b.b),b!==a)return b;return a}function Rm(a){var b=Sm,c={};Object.keys(b).forEach(function(d){var e=c[d]={},f=b[d];Object.keys(f).forEach(function(b){e[b]=f[b].map(function(b){return{h:new RegExp("(-?)"+(a?b.fa:b.ga)+"(-?)"),b:"$1"+(a?b.ga:b.fa)+"$2"}})})});return c}
var Sm={"horizontal-tb":{ltr:[{fa:"inline-start",ga:"left"},{fa:"inline-end",ga:"right"},{fa:"block-start",ga:"top"},{fa:"block-end",ga:"bottom"},{fa:"inline-size",ga:"width"},{fa:"block-size",ga:"height"}],rtl:[{fa:"inline-start",ga:"right"},{fa:"inline-end",ga:"left"},{fa:"block-start",ga:"top"},{fa:"block-end",ga:"bottom"},{fa:"inline-size",ga:"width"},{fa:"block-size",ga:"height"}]},"vertical-rl":{ltr:[{fa:"inline-start",ga:"top"},{fa:"inline-end",ga:"bottom"},{fa:"block-start",ga:"right"},{fa:"block-end",
ga:"left"},{fa:"inline-size",ga:"height"},{fa:"block-size",ga:"width"}],rtl:[{fa:"inline-start",ga:"bottom"},{fa:"inline-end",ga:"top"},{fa:"block-start",ga:"right"},{fa:"block-end",ga:"left"},{fa:"inline-size",ga:"height"},{fa:"block-size",ga:"width"}]},"vertical-lr":{ltr:[{fa:"inline-start",ga:"top"},{fa:"inline-end",ga:"bottom"},{fa:"block-start",ga:"left"},{fa:"block-end",ga:"right"},{fa:"inline-size",ga:"height"},{fa:"block-size",ga:"width"}],rtl:[{fa:"inline-start",ga:"bottom"},{fa:"inline-end",
ga:"top"},{fa:"block-start",ga:"left"},{fa:"block-end",ga:"right"},{fa:"inline-size",ga:"height"},{fa:"block-size",ga:"width"}]}},Tm=Rm(!0),Um=Rm(!1);var al="inline";function Vm(a){switch(a){case "inline":return al;case "column":return"column";case "region":return"region";case "page":return"page";default:throw Error("Unknown float-reference: "+a);}}function Wm(a){switch(a){case al:return!1;case "column":case "region":case "page":return!0;default:throw Error("Unknown float-reference: "+a);}}function Xm(a,b,c,d,e,f){this.b=a;this.W=b;this.Ca=c;this.h=d;this.f=e;this.j=f;this.id=this.order=null}
Xm.prototype.Ia=function(){if(null===this.order)throw Error("The page float is not yet added");return this.order};function Ym(a){if(!a.id)throw Error("The page float is not yet added");return a.id}Xm.prototype.gf=function(){return!1};function Zm(){this.b=[];this.f=0}Zm.prototype.rf=function(){return this.f++};
Zm.prototype.oe=function(a){if(0<=this.b.findIndex(function(b){return Tk(b.b,a.b)}))throw Error("A page float with the same source node is already registered");var b=a.order=this.rf();a.id="pf"+b;this.b.push(a)};Zm.prototype.ff=function(a){var b=this.b.findIndex(function(b){return Tk(b.b,a)});return 0<=b?this.b[b]:null};function $m(a,b,c,d,e){this.W=a;this.Ca=b;this.Pb=c;this.b=d;this.g=e}function an(a,b){return a.Pb.some(function(a){return a.ja===b})}
$m.prototype.Ia=function(){var a=this.Pb.map(function(a){return a.ja});return Math.min.apply(null,a.map(function(a){return a.Ia()}))};$m.prototype.f=function(a){return this.Ia()<a.Ia()};function bn(a,b){this.ja=a;this.b=b}
...
function Bn(a){if(Cn(a))return!0;for(var b=a.b.length-1;0<=b;b--){var c=a.b[b],d;a:{d=a;for(var e=c.Pb.length-1;0<=e;e--){var f=c.Pb[e].ja;if(!vn(d,Ym(f))){d=f;break a}}d=null}if(d){if(a.g)on(a);else if(pn(a,c),kn(a,d),c=Dn(a,c.Ca),"block-end"===c||"inline-end"===c)for(b=0;b<a.b.length;)d=a.b[b],Dn(a,d.Ca)===c?pn(a,d):b++;return!0}}return"region"===a.W&&a.parent.g?Bn(a.parent):!1}
function Cn(a){var b=An(a),c=a.b.reduce(function(a,b){return a.concat(b.Pb.map(function(a){return a.ja}))},[]);c.sort(function(a,b){return b.Ia()-a.Ia()});for(var d={},c=t(c),e=c.next();!e.done;d={ja:d.ja,order:d.order},e=c.next())if(d.ja=e.value,d.order=d.ja.Ia(),b.some(function(a){return function(b){return!a.ja.gf(b)&&a.order>b.Ia()}}(d)))return a.g?on(a):(kn(a,d.ja),b=qn(a,d.ja),pn(a,b)),!0;return!1}
...
function Xn(a,b){function c(a){return function(b){return vn(a,Ym(b.ja))}}function d(a,b){return a.Pb.some(c(b))}for(var e=Cl(b),e=b.b?e.V:e.P,f=a;f;){if(f.f.some(c(f)))return e;f=f.parent}f=Nn(a,"block-start",b.j,b.f,d);return Nn(a,"block-end",b.j,b.f,d)*vl(b)<e*vl(b)?e:f}
...
function eo(a){for(var b=co.length-1;0<=b;b--){var c=co[b];if(c.If(a))return c}throw Error("No PageFloatLayoutStrategy found for "+a);}function ln(a){for(var b=co.length-1;0<=b;b--){var c=co[b];if(c.Hf(a))return c}throw Error("No PageFloatLayoutStrategy found for "+a);}function fo(){}n=fo.prototype;n.If=function(a){return Wm(a.W)};n.Hf=function(){return!0};n.Of=function(a,b,c){var d=a.W,e=a.Ca,f=el(a);return go(c,d,a.ha,a).da(function(c){d=c;c=new Xm(f,d,e,a.l,b.h,a.N);b.oe(c);return M(c)})};
n.Pf=function(a,b,c,d){return new $m(a[0].ja.W,b,a,c,d)};n.Af=function(a,b){return qn(b,a)};n.Ef=function(){};n.rg=function(){};co.push(new fo);var ho={img:!0,svg:!0,audio:!0,video:!0};
...
function ko(a){for(var b=ge("RESOLVE_LAYOUT_PROCESSOR"),c=0;c<b.length;c++){var d=b[c](a);if(d)return d}throw Error("No processor found for a formatting context: "+a.Ze());}function lo(a){this.Kd=a}lo.prototype.b=function(a){return this.Kd.every(function(b){return b.b(a)})};function mo(){}mo.prototype.u=function(){};mo.prototype.g=function(){return null};function no(a,b){return{current:b.reduce(function(b,d){return b+d.b(a)},0),Ke:b.reduce(function(b,d){return b+d.F(a)},0)}}
...
Mm.prototype.f=function(a,b){if(!this.h){var c=Im(a,this.position);this.xc=io(this.position,a.f,0,a.b)+c;this.h=!0}var c=this.xc,d=no(this.g(),qo(a));this.B=ro(a,c+(a.b?-1:1)*d.Ke);this.j=this.position.xa=ro(a,c+(a.b?-1:1)*d.current);b<this.b()?c=null:(a.h=this.D+so(a,this),c=this.position);return c};
...
function uo(a){for(var b=1;b<a.length;b++){var c=a[b-1],d=a[b];c===d?w.b("validateCheckPoints: duplicate entry"):c.Ma>=d.Ma?w.b("validateCheckPoints: incorrect boxOffset"):c.M==d.M&&(d.K?c.K&&w.b("validateCheckPoints: duplicate after points"):c.K||d.Ma-c.Ma!=d.ma-c.ma&&w.b("validateCheckPoints: boxOffset inconsistent with offsetInNode"))}}function vo(a){this.parent=a}vo.prototype.Ze=function(){return"Block formatting context (adapt.layout.BlockFormattingContext)"};vo.prototype.jf=function(a,b){return b};
vo.prototype.af=function(){};vo.prototype.$e=function(){};function Jm(a,b,c,d,e){ql.call(this,a);this.j=b;this.f=c;this.Jc=d;this.Rg=a.ownerDocument;this.l=e;gn(e,this);this.nf=null;this.cg=this.jg=!1;this.oa=this.sa=this.D=this.fb=this.ua=0;this.Kb=this.gg=this.fg=null;this.Ld=!1;this.g=this.N=null;this.Lb=!0;this.Be=this.Ie=this.He=0;this.u=!0;this.xb=null;this.B=[];this.ta=this.Md=null;this.mf=NaN}v(Jm,ql);function wo(a,b){return!!b.Ca&&(!a.jg||!!b.parent)}
function ro(a,b){return a.b?b<a.oa:b>a.oa}function xo(a,b){if(a)for(var c;(c=a.lastChild)!=b;)a.removeChild(c)}Jm.prototype.Hd=function(a){var b=this,c=L("openAllViews"),d=a.pa;yo(b.j,b.element,b.cg);var e=d.length-1,f=null;De(function(){for(;0<=e;){f=Wk(d[e],f);e!==d.length-1||f.C||(f.C=b.nf);if(!e){var c=f,h;h=a;h=h.Qa?fl(h.Qa,h.ma,1):h.ma;c.ma=h;f.K=a.K;f.Qa=a.Qa;if(f.K)break}c=zo(b.j,f,!e&&!f.ma);e--;if(c.Xa())return c}return M(!1)}).then(function(){O(c,f)});return c.result()};var Ao=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
...
function Do(a,b,c){var d=!1,e=L("buildViewToNextBlockEdge");Ee(function(e){b.A&&!Eo(b)&&c.push(Yk(b));Bo(a,b).then(function(f){f!==b&&(b=f,Eo(b)||c.push(Yk(b)));Fo(a,b).then(function(c){if(b=c){if(d||!a.Jc.b(b))d=!0,b=b.modify(),b.xa=!0;wo(a,b)&&!a.b?Go(a,b).then(function(c){b=c;In(a.l)&&(b=null);b?P(e):Q(e)}):b.ya?P(e):Q(e)}else Q(e)})})}).then(function(){O(e,b)});return e.result()}function Fo(a,b,c){b=Fm(a.j,b,c);return Ho(b,a)}
function Io(a,b){if(!b.A)return M(b);var c=[],d=b.M,e=L("buildDeepElementView");Ee(function(e){b.A&&b.ya&&!Eo(b)?c.push(Yk(b)):(0<c.length&&Jo(a,b,c),c=[]);Bo(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.M!=d;)g=g.parent;if(!g){b=f;Q(e);return}Eo(f)||c.push(Yk(f))}Fo(a,f).then(function(c){(b=c)&&b.M!=d?a.Jc.b(b)?P(e):(b=b.modify(),b.xa=!0,a.u?Q(e):P(e)):Q(e)})})}).then(function(){0<c.length&&Jo(a,b,c);O(e,b)});return e.result()}
function Ko(a,b,c,d,e){var f=a.Rg.createElement("div");a.b?(e>=a.height&&(e-=.1),x(f,"height",d+"px"),x(f,"width",e+"px")):(d>=a.width&&(d-=.1),x(f,"width",d+"px"),x(f,"height",e+"px"));x(f,"float",c);x(f,"clear",c);a.element.insertBefore(f,b);return f}function Lo(a){for(var b=a.element.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.element.removeChild(b);else break}b=c}}
function Mo(a){for(var b=a.element.firstChild,c=a.b?a.b?a.ua:a.D:a.b?a.sa:a.ua,d=a.b?a.b?a.fb:a.sa:a.b?a.D:a.fb,e=t(a.Kb),f=e.next();!f.done;f=e.next()){var f=f.value,g=f.P-f.T;f.left=Ko(a,b,"left",f.V-c,g);f.right=Ko(a,b,"right",d-f.U,g)}}
...
Jk(a.f,m),h=Math.max(a.b?p.top:p.left,h),l=Math.min(a.b?p.bottom:p.right,l);k.A.removeChild(m);m=a.b?g.P-g.T:g.U-g.V;"left"==e?l=Math.max(l,h+m):h=Math.min(h,l-m);k.A.appendChild(b.A)}m=new ng(h,vl(a)*a.D,l,vl(a)*a.sa);h=g;a.b&&(h=Eg(g));l=vl(a);h.T<a.Be*l&&(p=h.P-h.T,h.T=a.Be*l,h.P=h.T+p);a:for(var l=a.Kb,p=h,q=p.T,r=p.U-p.V,z=p.P-p.T,u=Ig(l,q);;){var A=q+z;if(A>m.P)break a;for(var H=m.V,E=m.U,K=u;K<l.length&&l[K].T<A;K++){var I=l[K];I.V>H&&(H=I.V);I.U<E&&(E=I.U)}if(H+r<=E||u>=l.length){"left"==
...
m.top-m.bottom+"px");x(d,"position","absolute");x(d,"display",b.display);l=null;if(k)if(k.S)l=k;else a:{for(k=k.parent;k;){if(k.S){l=k;break a}k=k.parent}l=null}l?(m=l.A.ownerDocument.createElement("div"),m.style.position="absolute",l.b?m.style.right="0":m.style.left="0",m.style.top="0",l.A.appendChild(m),k=Jk(a.f,m),l.A.removeChild(m)):k={left:(a.b?a.sa:a.ua)-a.H,right:(a.b?a.D:a.fb)+a.Y,top:(a.b?a.ua:a.D)-a.J};(l?l.b:a.b)?x(d,"right",k.right-g.U+"px"):x(d,"left",g.V-k.left+"px");x(d,"top",g.T-k.top+
"px");b.D&&(b.D.parentNode.removeChild(b.D),b.D=null);k=a.b?g.V:g.P;g=a.b?g.U:g.T;if(ro(a,k)&&a.N.length)b=b.modify(),b.xa=!0,O(c,b);else{Lo(a);m=new ng(a.b?a.sa:a.ua,a.b?a.ua:a.D,a.b?a.D:a.fb,a.b?a.fb:a.sa);a.b&&(m=Eg(m));l=a.Kb;for(p=[new rg(h.T,h.P,h.V,h.U)];0<p.length&&p[0].P<=m.T;)p.shift();if(p.length){p[0].T<m.T&&(p[0].T=m.T);h=l.length?l[l.length-1].P:m.T;h<m.P&&l.push(new rg(h,m.P,m.V,m.U));h=Ig(l,p[0].T);p=t(p);for(q=p.next();!q.done;q=p.next()){r=q.value;if(h==l.length)break;l[h].T<r.T&&
(q=l[h],h++,l.splice(h,0,new rg(r.T,q.P,q.V,q.U)),q.P=r.T);for(;h<l.length&&(q=l[h++],q.P>r.P&&(l.splice(h,0,new rg(r.P,q.P,q.V,q.U)),q.P=r.P),r.V!=r.U&&("left"==e?q.V=Math.min(r.U,m.U):q.U=Math.max(r.V,m.V)),q.P!=r.P););}Hg(m,l)}Mo(a);"left"==e?a.He=k:a.Ie=k;a.Be=g;So(a,k);O(c,f)}});return c.result()}
function To(a,b,c,d,e,f){var g=a.element.ownerDocument.createElement("div");x(g,"position","absolute");var h=jn(a.l,b.W),l=new cn(null,"column",null,a.l.h,b.b,null,null),h=fn(h),g=new Uo(c,g,a.j.clone(),a.f,a.Jc,l,h);gn(l,g);var h=b.W,k=a.l;b=fn(k,h);l=g.element;b.element.parentNode.appendChild(l);g.jg=!0;g.F=b.F;g.G=b.G;g.b=b.b;g.marginLeft=g.marginRight=g.marginTop=g.marginBottom=0;g.Z=g.Za=g.ha=g.Ba=0;g.H=g.Y=g.J=g.S=0;g.ob=(b.ob||[]).concat();g.Lb=!rn(k);g.Mb=null;var m=Cl(b);yl(g,m.V-b.F,m.U-
m.V);xl(g,m.T-b.G,m.P-m.T);e.Ef(g,b,a);Vo(g);(a=!!Qn(k,g,h,c,d,!0,!rn(k),f))?(Lo(g),Vo(g)):b.element.parentNode.removeChild(l);return a?g:null}
function Wo(a,b,c,d,e,f,g,h){var l=a.l;b=(h?h.Pb:[]).concat(b);var k=b[0].ja,m=Yn(l,k,c,d),p=To(a,k,c,g,f,m),q={Sf:p,sf:null,qf:null};if(!p)return M(q);var r=L("layoutSinglePageFloatFragment"),z=!1,u=0;Ee(function(a){u>=b.length?Q(a):Lm(p,new jl(b[u].b),!0).then(function(b){q.qf=b;!b||e?(u++,P(a)):(z=!0,Q(a))})}).then(function(){if(!z){var a=Qn(l,p,k.W,c,g,!1,e,m);a?(a=f.Pf(b,a,p,!!q.qf),nn(l,a,!0),q.sf=a):z=!0}O(r,q)});return r.result()}
function Xo(a,b,c,d,e){function f(a,c){c?pn(g,c,!0):a&&a.element.parentNode.removeChild(a.element);Kn(g,h.W);xn(g,b)}var g=a.l,h=b.ja;Jn(g,h);var l=L("layoutPageFloatInner");Wo(a,[b],h.Ca,h.h,!rn(g),c,d,e).then(function(b){var c=b.Sf,d=b.sf,k=b.qf;d?Yo(a,h.W,[e]).then(function(a){a?(nn(g,d),Ln(g,h.W),k&&xn(g,new bn(h,k.f)),O(l,!0)):(f(c,d),O(l,!1))}):(f(c,d),O(l,!1))});return l.result()}
function Yo(a,b,c){var d=a.l,e=Mn(d,b),f=[],g=[],h=!1,l=L("layoutStashedPageFloats"),k=0;Ee(function(b){if(k>=e.length)Q(b);else{var d=e[k];if(c.includes(d))k++,P(b);else{var l=ln(d.Pb[0].ja);Wo(a,d.Pb,d.Ca,null,!1,l,null).then(function(a){var c=a.Sf;c&&f.push(c);(a=a.sf)?(g.push(a),k++,P(b)):(h=!0,Q(b))})}}}).then(function(){h?(g.forEach(function(a){pn(d,a,!0)}),f.forEach(function(a){(a=a.element)&&a.parentNode&&a.parentNode.removeChild(a)})):e.forEach(function(a){(a=a.b.element)&&a.parentNode&&
...
function go(a,b,c,d){var e=L("resolveFloatReferenceFromColumnSpan"),f=a.l,g=jn(f,"region");fn(f).width<fn(g).width&&"column"===b?c===Yc?Io(a,Yk(d)).then(function(c){var d=c.A;c=Rn(a.f,d,[ap])[ap];d=Po(a,d);c=a.b?c+(d.top+d.bottom):c+(d.left+d.right);c>a.width?O(e,"region"):O(e,b)}):c===Wc?O(e,"region"):O(e,b):O(e,b);return e.result()}
function bp(a,b){var c=a.l,d=eo(b),e=c.ff(el(b));return(e?M(e):d.Of(b,c,a)).da(function(e){var f=Uk(b),h=Zo(a,b),l=d.Af(e,c),f=new bn(e,f);if(l&&an(l,e))return tn(c,e,h.A),M(h);if(mn(c,e)||yn(c,e))return xn(c,f),tn(c,e,h.A),M(h);if(a.ta)return M(null);var k=io(h,a.f,0,a.b);return ro(a,k)?M(h):Xo(a,f,d,k,l).da(function(a){if(a)return M(null);tn(c,e,h.A);return M(h)})})}
function cp(a,b,c){if(!b.K||b.ya){if(c){for(var d="",e=b.parent;e&&!d;e=e.parent)!e.ya&&e.A&&(d=e.A.style.textAlign);if("justify"!==d)return}var f=b.A,g=f.ownerDocument,h=c&&(b.K||1!=f.nodeType);(d=h?f.nextSibling:f)&&!d.parentNode&&(d=null);if(e=f.parentNode||b.parent&&b.parent.A){var l=d,k=document.body;if(null===ib){var m=k.ownerDocument,p=m.createElement("div");p.style.position="absolute";p.style.top="0px";p.style.left="0px";p.style.width="40px";p.style.height="100px";p.style.lineHeight="16px";
...
function ep(a,b,c,d){var e=L("processLineStyling");uo(d);var f=d.concat([]);d.splice(0,d.length);var g=0,h=b.f;0==h.count&&(h=h.Lg);Ee(function(d){if(h){var e=fp(a,f),l=h.count-g;if(e.length<=l)Q(d);else{var p=gp(a,f,e[l-1]);p?a.Na(p,!1,!1).then(function(){g+=l;Co(a.j,p,0).then(function(e){b=e;cp(a,b,!1);h=b.f;f=[];Do(a,b,f).then(function(a){c=a;P(d)})})}):Q(d)}}else Q(d)}).then(function(){Array.prototype.push.apply(d,f);uo(d);O(e,c)});return e.result()}
...
function ip(a,b){var c=L("layoutBreakableBlock"),d=[];Do(a,b,d).then(function(e){var f=d.length-1;if(0>f)O(c,e);else{var f=No(a,e,d,f,d[f].Ma),g=!1;if(!e||!Oo(e.A)){var h=no(e,qo(a)),g=ro(a,f+(a.b?-1:1)*h.Ke);ro(a,f+(a.b?-1:1)*h.current)&&!a.ta&&(a.ta=e)}e||(f+=hp(a,d));So(a,f);var l;b.f?l=ep(a,b,e,d):l=M(e);l.then(function(b){Jo(a,b,d);0<d.length&&(a.N.push(new oo(d,d[0].j)),g&&(2!=d.length&&0<a.N.length||d[0].M!=d[1].M||!ho[d[0].M.localName])&&b&&(b=b.modify(),b.xa=!0));O(c,b)})}});return c.result()}
function Jo(a,b,c){ge("POST_LAYOUT_BLOCK").forEach(function(d){d(b,c,a)})}
function gp(a,b,c){uo(b);var d=a.b?c-1:c+1,e=0,f=b[0].Ma;c=e;for(var g=b.length-1,h=b[g].Ma,l;f<h;){l=f+Math.ceil((h-f)/2);c=e;for(var k=g;c<k;){var m=c+Math.ceil((k-c)/2);b[m].Ma>l?k=m-1:c=m}k=No(a,null,b,c,l);if(a.b?k<=d:k>=d){for(h=l-1;b[c].Ma==l;)c--;g=c}else So(a,k),f=l,e=c}d=f;b=b[c];c=b.A;1!=c.nodeType&&(jp(b),b.K?b.ma=c.length:(e=d-b.Ma,d=c.data,173==d.charCodeAt(e)?(c.replaceData(e,d.length-e,b.B?"":dp(b)),c=e+1):(f=d.charAt(e),e++,g=d.charAt(e),c.replaceData(e,d.length-e,!b.B&&Va(f)&&Va(g)?
dp(b):""),c=e),e=c,0<e&&(c=e,b=b.modify(),b.ma+=c,b.g=null)));kp(a,b,!1);return b}function jp(a){ge("RESOLVE_TEXT_NODE_BREAKER").reduce(function(b,c){return c(a)||b},lp)}var lp=new function(){};function dp(a){return a.F||a.parent&&a.parent.F||"-"}function Eo(a){return a?(a=a.A)&&1===a.nodeType?!!a.getAttribute("data-adapt-spec"):!1:!1}
...
h-1)){h=a.b?k.bottom:k.right;a.b?(e=d?Math.max(e,k.right):k.right,g=d?Math.min(g,k.left):k.left):(e=d?Math.min(e,k.top):k.top,g=d?Math.max(g,k.bottom):k.bottom);d++;l++;continue}0<d&&(c.push(g),d=0);if(l>=f.length)break}c.sort(Za);a.b&&c.reverse();return c}function Im(a,b){var c=0;hl(b,function(b){if("clone"===b.h["box-decoration-break"]){var d=Qo(a,b.A);c+=b.b?-d.left:d.bottom;"table"===b.display&&(c+=b.ta)}});return c}function so(a,b){return(b?no(b.g(),qo(a)):no(null,qo(a))).current}
function po(a,b,c){for(var d=b.h,e=d[0];e.parent&&e.ya;)e=e.parent;var f;c?f=c=1:(c=Math.max((e.h.widows||2)-0,1),f=Math.max((e.h.orphans||2)-0,1));var e=Im(a,e),g=fp(a,d),h=a.oa-e,e=vl(a),l=so(a,b),h=h-e*l,k=mp(a,d);isNaN(k.xc)&&(k.xc=Infinity*e);var d=Ya(g.length,function(b){b=g[b];return a.b?b<h||b<=k.xc:b>h||b>=k.xc}),m=0>=d;m&&(d=Ya(g.length,function(b){return a.b?g[b]<h:g[b]>h}));d=Math.min(g.length-c,d);if(d<f)return null;h=g[d-1];if(b=m?k.Lf:gp(a,b.h,h))c=np(a,b),!isNaN(c)&&c<h&&(h=c),a.h=
e*(h-a.D)+l;return b}function np(a,b){var c=b;do c=c.parent;while(c&&c.ya);return c?(c=Yk(c).modify(),c.K=!0,io(c,a.f,0,a.b)):NaN}function mp(a,b){var c=b.findIndex(function(a){return a.xa});if(0>c)return{xc:NaN,Lf:null};var d=b[c];return{xc:No(a,null,b,c,d.Ma),Lf:d}}Jm.prototype.Na=function(a,b,c){var d=ko(a.C).Na(this,a,b,c);d||(d=op.Na(this,a,b,c));return d};
Jm.prototype.dc=function(){var a=null,b=null,c,d=0;do{c=d;for(var d=Number.MAX_VALUE,e=this.N.length-1;0<=e&&!b;--e){var a=this.N[e],b=a.f(this,c),f=a.b();f>c&&(d=Math.min(d,f))}}while(d>c&&!b&&this.Lb);return{Db:b?a:null,w:b}};
function pp(a,b,c,d,e){if(In(a.l)||a.g||!c)return M(b);var f=L("doFinishBreak"),g=!1;if(!b){if(a.Lb)return w.b("Could not find any page breaks?!!"),qp(a,c).then(function(b){b?(b=b.modify(),b.xa=!1,a.Na(b,g,!0).then(function(){O(f,b)})):O(f,b)}),f.result();b=d;g=!0;a.h=e}a.Na(b,g,!0).then(function(){O(f,b)});return f.result()}function rp(a){a=a.toString();return""==a||"auto"==a||!!a.match(/^0+(.0*)?[^0-9]/)}
function sp(a,b,c){if(!b||Oo(b.A))return!1;var d=io(b,a.f,0,a.b),e=no(b,qo(a)),f=ro(a,d+(a.b?-1:1)*e.Ke);ro(a,d+(a.b?-1:1)*e.current)&&!a.ta?a.ta=b:c&&(b=d+hp(a,c),e=a.oa-vl(a)*e.current,d=a.b?Math.min(d,Math.max(b,e)):Math.max(d,Math.min(b,e)));So(a,d);return f}function tp(a,b,c,d,e){if(!b||Oo(b.A))return!1;c=sp(a,b,c);!d&&c||up(a,b,e,c);return c}
function vp(a,b){if(!b.A.parentNode)return!1;var c=Po(a,b.A),d=b.A.ownerDocument.createElement("div");a.b?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.A.parentNode.insertBefore(d,b.A);var e=Jk(a.f,d),e=a.b?e.right:e.top,f=vl(a),g=b.l,h=Infinity*-vl(a);"all"===g&&(h=Xn(a.l,a));switch(g){case "left":h=f*Math.max(h*f,a.He*f);break;case "right":h=f*Math.max(h*f,a.Ie*f);break;default:h=f*Math.max(h*
f,Math.max(a.Ie*f,a.He*f))}if(e*f>=h*f)return b.A.parentNode.removeChild(d),!1;e=Math.max(1,(h-e)*f);a.b?d.style.width=e+"px":d.style.height=e+"px";e=Jk(a.f,d);e=a.b?e.left:e.bottom;a.b?(h=e+c.right-h,0<h==0<=c.right&&(h+=c.right),d.style.marginLeft=h+"px"):(h-=e+c.top,0<h==0<=c.top&&(h+=c.top),d.style.marginBottom=h+"px");b.D=d;return!0}function wp(a){return a instanceof vo?!0:a instanceof xp?!1:a instanceof yp?!0:!1}
function zp(a,b,c,d){function e(){return!!d||!c&&!!Ul[m]}function f(){b=q[0]||b;b.A.parentNode.removeChild(b.A);h.g=m}var g=b.K?b.parent&&b.parent.C:b.C;if(g&&!wp(g))return M(b);var h=a,l=L("skipEdges"),k=!d&&c&&b&&b.K,m=d,p=null,q=[],r=[],z=!1;Ee(function(a){for(;b;){var d=ko(b.C);do if(b.A){if(b.ya&&1!=b.A.nodeType){if(Lk(b.A,b.tc))break;if(!b.K){e()?f():tp(h,p,null,!0,m)?(b=(h.u?p||b:b).modify(),b.xa=!0):(b=b.modify(),b.g=m);Q(a);return}}if(!b.K){if(d&&d.bf(b))break;b.l&&vp(h,b)&&c&&!h.N.length&&
up(h,Yk(b),m,!1);if(!wp(b.C)||b.C instanceof yp||wo(h,b)||b.H){q.push(Yk(b));m=Sl(m,b.g);if(e())f();else if(tp(h,p,null,!0,m)||!h.Jc.b(b))b=(h.u?p||b:b).modify(),b.xa=!0;Q(a);return}}if(1==b.A.nodeType){var g=b.A.style;if(b.K){if(!(b.ya||d&&d.Df(b,h.u))){if(z){if(e()){f();Q(a);return}q=[];k=c=!1;m=null}z=!1;p=Yk(b);r.push(p);m=Sl(m,b.G);!g||rp(g.paddingBottom)&&rp(g.borderBottomWidth)||(r=[p])}}else{q.push(Yk(b));m=Sl(m,b.g);if(!h.Jc.b(b)&&(tp(h,p,null,!h.u,m),b=b.modify(),b.xa=!0,h.u)){Q(a);return}if(ho[b.A.localName]){e()?
...
function qp(a,b){var c=Yk(b),d=L("skipEdges"),e=null,f=!1;Ee(function(d){for(;b;){do if(b.A){if(b.ya&&1!=b.A.nodeType){if(Lk(b.A,b.tc))break;if(!b.K){Ul[e]&&(a.g=e);Q(d);return}}if(!b.K&&(wo(a,b)||b.H)){e=Sl(e,b.g);Ul[e]&&(a.g=e);Q(d);return}if(1==b.A.nodeType){var g=b.A.style;if(b.K){if(f){if(Ul[e]){a.g=e;Q(d);return}e=null}f=!1;e=Sl(e,b.G)}else{e=Sl(e,b.g);if(ho[b.A.localName]){Ul[e]&&(a.g=e);Q(d);return}if(g&&(!rp(g.paddingTop)||!rp(g.borderTopWidth))){Q(d);return}}f=!0}}while(0);g=Fm(a.j,b);if(g.Xa()){g.then(function(a){b=
a;P(d)});return}b=g.get()}c=null;Q(d)}).then(function(){O(d,c)});return d.result()}function Go(a,b){return Wm(b.W)||"footnote"===b.Ca?bp(a,b):Ro(a,b)}function Ap(a,b,c,d){var e=L("layoutNext");zp(a,b,c,d||null).then(function(d){b=d;!b||a.g||a.u&&b&&b.xa?O(e,b):ko(b.C).me(b,a,c).Ea(e)});return e.result()}function kp(a,b,c){if(b)for(var d=b.parent;b;b=d,d=d?d.parent:null)ko((d||b).C).Ed(a,d,b,c),c=!1}
function Vo(a){a.gg=[];x(a.element,"width",a.width+"px");x(a.element,"height",a.height+"px");var b=a.element.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.J+"px";b.style.right=a.Y+"px";b.style.bottom=a.S+"px";b.style.left=a.H+"px";a.element.appendChild(b);var c=Jk(a.f,b);a.element.removeChild(b);var b=a.F+a.left+tl(a),d=a.G+a.top+rl(a);a.fg=new ng(b,d,b+a.width,d+a.height);a.ua=c?a.b?c.top:c.left:0;a.fb=c?a.b?c.bottom:c.right:0;a.D=c?a.b?c.right:c.top:0;a.sa=c?a.b?c.left:
c.bottom:0;a.He=a.D;a.Ie=a.D;a.Be=a.D;a.oa=a.sa;c=a.fg;b=a.F+a.left+tl(a);d=a.G+a.top+rl(a);d=new ng(b,d,b+a.width,d+a.height);if(a.Mb){for(var b=d.V,d=d.T,e=[],f=t(a.Mb.b),g=f.next();!g.done;g=f.next())g=g.value,e.push(new og(g.f+b,g.b+d));b=new tg(e)}else b=wg(d.V,d.T,d.U,d.P);b=[b];d=Un(a.l);a.Kb=Gg(c,b,a.ob.concat(d),a.Nb,a.b);Mo(a);a.h=0;a.Ld=!1;a.g=null;a.xb=null}function up(a,b,c,d){var e=Yk(b);b=ko(b.C);var f=Im(a,e);c=b.Nf(e,c,d,a.h+f);a.N.push(c)}
function So(a,b){isNaN(b)||(a.h=Math.max(vl(a)*(b-a.D),a.h))}
function Lm(a,b,c,d){a.gg.push(b);b.f.K&&(a.xb=b.f);if(a.u&&a.Ld)return M(b);if(ao(a.l,a))return b.f.K&&1===b.f.pa.length?M(null):M(b);var e=L("layout");a.Hd(b.f).then(function(b){var f=null;if(b.A)f=Yk(b);else{var h=function(b){b.w.A&&(f=b.w,a.j.removeEventListener("nextInTree",h))};a.j.addEventListener("nextInTree",h)}var l=new Bp(c,d);Om(l,b,a).then(function(b){pp(a,b,l.g.Wd,f,l.b).then(function(b){var c=null;a.Md?c=M(null):c=Cp(a,b);c.then(function(){if(In(a.l))O(e,null);else if(b){a.Ld=!0;var c=
new jl(el(b));O(e,c)}else O(e,null)})})})});return e.result()}function Cp(a,b){var c=L("doFinishBreakOfFragmentLayoutConstraints"),d=[].concat(a.B);d.sort(function(a,b){return a.xe()-b.xe()});var e=0;De(function(){return e<d.length?d[e++].Na(b,a).Hc(!0):M(!1)}).then(function(){O(c,!0)});return c.result()}
function Dp(a,b,c,d){var e=L("doLayout"),f=null;a.N=[];a.ta=null;Ee(function(e){for(var g={};b;){g.Oa=!0;Ap(a,b,c,d||null).then(function(g){return function(h){c=!1;d=null;a.ta&&a.u?(a.g=null,b=a.ta,b.xa=!0):b=h;In(a.l)?Q(e):a.g?Q(e):b&&a.u&&b&&b.xa?(f=b,h=a.dc(),b=h.w,h.Db&&h.Db.u(a),Q(e)):g.Oa?g.Oa=!1:P(e)}}(g));if(g.Oa){g.Oa=!1;return}g={Oa:g.Oa}}a.h+=so(a);Q(e)}).then(function(){O(e,{w:b,Wd:f})});return e.result()}function Ep(a){var b=Wn(a.l);0<b&&isFinite(b)&&(a.mf=vl(a)*(b-a.D-a.h))}
function Oo(a){for(;a;){if(a.parentNode===a.ownerDocument)return!1;a=a.parentNode}return!0}function Bp(a,b){Nm.call(this);this.fc=a;this.B=b||null;this.l=null;this.b=0;this.j=!1;this.g={Wd:null}}v(Bp,Nm);n=Bp.prototype;n.tf=function(){return new Fp(this.fc,this.B,this.g)};n.hg=function(a,b){b.B=[];b.Md||(Ip=[])};n.Jd=function(a){for(Nm.prototype.Jd.call(this,a);a;){var b=a.A;b&&xo(b.parentNode,b);a=a.parent}};n.Bf=function(a,b){Nm.prototype.Bf.call(this,a,b);this.l=b.g;this.b=b.h;this.j=b.Ld};
n.le=function(a,b){Nm.prototype.le.call(this,a,b);b.g=this.l;b.h=this.b;b.Ld=this.j};function Fp(a,b,c){this.fc=a;this.j=b;this.h=c}Fp.prototype.b=function(a,b){var c=this,d=L("adapt.layout.DefaultLayoutMode.doLayout");Jp(a,b).then(function(){Dp(b,a,c.fc,c.j).then(function(a){c.h.Wd=a.Wd;O(d,a.w)})});return d.result()};Fp.prototype.f=function(a,b){var c=this;return In(b.l)||b.g||0>=b.B.length?!0:b.B.every(function(d){return d.ne(a,c.h.Wd,b)})};
Fp.prototype.g=function(a,b,c,d){d||(d=!c.B.some(function(b){return b.nd(a)}));c.B.forEach(function(e){e.cd(d,a,b,c)});return d};function Kp(){}n=Kp.prototype;n.me=function(a,b){var c;if(wo(b,a))c=Go(b,a);else{a:if(a.K)c=!0;else{switch(a.M.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!a.H}c=c?ip(b,a):Io(b,a)}return c};n.Nf=function(a,b,c,d){return new Mm(Yk(a),b,c,d)};n.bf=function(){return!1};n.Df=function(){return!1};
n.Ed=function(a,b,c,d){c.A&&c.A.parentNode&&(a=c.A.parentNode,xo(a,c.A),d&&a.removeChild(c.A))};n.Na=function(a,b,c,d){c=c||!!b.A&&1==b.A.nodeType&&!b.K;kp(a,b,c);d&&(cp(a,b,!0),Lp(c?b:b.parent));return M(!0)};var op=new Kp;fe("RESOLVE_FORMATTING_CONTEXT",function(a,b,c,d,e,f){b=a.parent;return!b&&a.C?null:b&&a.C!==b.C?null:a.hd||!a.C&&Wl(c,d,e,f).display===ad?new vo(b?b.C:null):null});fe("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof vo?op:null});
function Uo(a,b,c,d,e,f,g){Jm.call(this,b,c,d,e,f);this.Ca=a;this.kg=g;this.Jb=[];this.ig=[];this.ye=!0}v(Uo,Jm);
Uo.prototype.Hd=function(a){var b=this;return Jm.prototype.Hd.call(this,a).da(function(a){if(a){for(var c=a;c.parent;)c=c.parent;c=c.A;b.Jb.push(c);b.ye&&Mp(b,c);b.ig.push(Po(b,c));if(b.ye){var e=b.Ca;if(b.kg.b){if("block-end"===e||"left"===e)e=Oa(c,"height"),""!==e&&"auto"!==e&&x(c,"margin-top","auto")}else if("block-end"===e||"bottom"===e)e=Oa(c,"width"),""!==e&&"auto"!==e&&x(c,"margin-left","auto")}}return M(a)})};
function Mp(a,b){function c(a,c){a.forEach(function(a){var d=Oa(b,a);d&&"%"===d.charAt(d.length-1)&&x(b,a,c*parseFloat(d)/100+"px")})}var d=Cl(a.kg),e=d.U-d.V,d=d.P-d.T;c(["width","max-width","min-width"],e);c(["height","max-height","min-height"],d);c("margin-top margin-right margin-bottom margin-left padding-top padding-right padding-bottom padding-left".split(" "),a.b?d:e);["margin-top","margin-right","margin-bottom","margin-left"].forEach(function(a){"auto"===Oa(b,a)&&x(b,a,"0")})}
function Tn(a){return Math.max.apply(null,a.Jb.map(function(a,c){var b=Jk(this.f,a),e=this.ig[c];return this.b?e.top+b.height+e.bottom:e.left+b.width+e.right},a))}function Np(a,b,c){var d=Jk(b.f,a);a=Po(b,a);return c?d.width+a.left+a.right:d.height+a.top+a.bottom};function Op(a){var b={};Object.keys(a).forEach(function(c){b[c]=Array.from(a[c])});return b}function Pp(a,b){this.Gc=a;this.ud=b;this.Oe=null;this.aa=this.O=-1}function Qp(a,b){this.b=a;this.f=b}function Fj(a,b,c){b=a.b.J.Ue(b,a.f);a.b.l[b]=c}function Rp(a,b,c,d){this.b=a;this.g=b;this.j=c;this.f=d;this.h=null}function Sp(a){return(a=a.match(/^[^#]*#(.*)$/))?a[1]:null}function Tp(a,b){var c=a.b.J.nc(Aa(b,a.g),a.g);"#"===c.charAt(0)&&(c=c.substring(1));return c}
...
function lj(a,b,c,d){var e=Sp(b),f=Tp(a,b),g=Vp(a,e,f,!1);return g&&g[c]?(b=g[c],new Hb(a.j,d(b[b.length-1]||null))):new Jb(a.f,function(){if(g=Vp(a,e,f,!0)){if(g[c]){var b=g[c];return d(b[b.length-1]||null)}if(b=a.b.j.f[f]?a.b.b:a.b.B[f]||null)return Wp(a.b,f),b[c]?(b=b[c],d(b[b.length-1]||null)):d(0);Xp(a.b,f,!1);return"??"}Xp(a.b,f,!1);return"??"},"target-counter-"+c+"-of-"+b)}
function nj(a,b,c,d){var e=Sp(b),f=Tp(a,b);return new Jb(a.f,function(){var b=a.b.j.f[f]?a.b.b:a.b.B[f]||null;if(b){Wp(a.b,f);var b=b[c]||[],h=Vp(a,e,f,!0)[c]||[];return d(b.concat(h))}Xp(a.b,f,!1);return"??"},"target-counters-"+c+"-of-"+b)}function Yp(a){this.J=a;this.l={};this.B={};this.b={};this.b.page=[0];this.G={};this.F=[];this.D={};this.j=null;this.u=[];this.g=[];this.H=[];this.f={};this.h={};this.Qe=[]}function Zp(a,b){var c=a.b.page;c&&c.length?c[c.length-1]=b:a.b.page=[b]}
...
function bq(a,b,c){var d=Object.keys(a.j.f);if(0<d.length){var e=Op(a.b);d.forEach(function(a){this.B[a]=e;var d=this.D[a];if(d&&d.aa<c&&(d=this.h[a])){var f=this.f[a];f||(f=this.f[a]=[]);for(var g;g=d.shift();)g.ud=!1,f.push(g)}this.D[a]={O:b,aa:c}},a)}for(var d=a.G,f;f=a.u.shift();){f.Oe=d;f.O=b;f.aa=c;var g=void 0;f.ud?(g=a.h[f.Gc])||(g=a.h[f.Gc]=[]):(g=a.f[f.Gc])||(g=a.f[f.Gc]=[]);g.every(function(a){return!(f===a||a&&f.Gc===a.Gc&&f.ud===a.ud&&f.O===a.O&&f.aa===a.aa)})&&g.push(f)}a.j=null}
function cq(a,b){var c=[];Object.keys(b.f).forEach(function(a){(a=this.f[a])&&(c=c.concat(a))},a);c.sort(function(a,b){return a.O-b.O||a.aa-b.aa});var d=[],e=null;c.forEach(function(a){e&&e.O===a.O&&e.aa===a.aa?e.Zd.push(a):(e={O:a.O,aa:a.aa,Oe:a.Oe,Zd:[a]},d.push(e))});return d}function dq(a,b){a.H.push(a.g);a.g=b}function Up(a,b,c,d){"pages"===b&&a.Qe.push({Mc:d,format:c})}function eq(a){return a.N.bind(a)}
Yp.prototype.N=function(a,b,c){return 0<=this.Qe.findIndex(function(b){return b.Mc===a})?(c=c.createElement("span"),c.textContent=b,c.setAttribute("data-vivliostyle-pages-counter",a.g),c):null};function fq(a,b){var c=a.b.page[0];Array.from(b.root.querySelectorAll("[data-vivliostyle-pages-counter]")).forEach(function(a){var b=a.getAttribute("data-vivliostyle-pages-counter"),d=this.Qe.findIndex(function(a){return a.Mc.g===b});a.textContent=this.Qe[d].format([c])},a)}
...
function mq(a,b){this.g=b;var c=this;Gb.call(this,a,function(a,b){var d=a.match(/^([^.]+)\.([^.]+)$/);if(d){var e=c.g.l[d[1]];if(e&&(e=this.fb[e])){if(b){var d=d[2],h=e.oa[d];if(h)e=h;else{switch(d){case "columns":var h=e.f.f,l=new zc(h,0),k=nq(e,"column-count"),m=nq(e,"column-width"),p=nq(e,"column-gap"),h=B(h,Bc(h,new wc(h,"min",[l,k]),y(h,m,p)),p)}h&&(e.oa[d]=h);e=h}}else e=nq(e,d[2]);return e}}return null})}v(mq,Gb);
...
function yq(a,b){this.g=a;this.f=b;this.J={};this.style={};this.B=this.D=null;this.children=[];this.N=this.S=this.h=this.j=!1;this.G=this.H=0;this.F=null;this.sa={};this.oa={};this.ua=this.Z=this.b=!1;a&&a.children.push(this)}function zq(a){a.H=0;a.G=0}function Aq(a,b,c){b=nq(a,b);c=nq(a,c);if(!b||!c)throw Error("E_INTERNAL");return y(a.f.f,b,c)}
...
function Eq(a,b){b.fb[a.f.j]=a;var c=a.f.f,d=a.style,e=a.g?Fq(a.g,b):null,e=Uj(a.J,b,e,!1);a.b=Sj(e,b,a.g?a.g.b:!1);a.Z=Tj(e,b,a.g?a.g.Z:!1);Yj(e,d,a.b,a.Z,function(a,b){return b.value});a.D=new Jb(c,function(){return a.H},"autoWidth");a.B=new Jb(c,function(){return a.G},"autoHeight");a.De();a.Ee();Cq(a);Bq(a)}function Gq(a,b,c){(a=a.style[c])&&(a=mg(b,a,c));return a}function Z(a,b,c){(a=a.style[c])&&(a=mg(b,a,c));return Uc(a,b)}
...
function Kq(a,b,c){var d=Z(a,b,"snap-height"),e=Z(a,b,"top"),f=Z(a,b,"margin-top"),g=Z(a,b,"padding-top");b=Z(a,b,"border-top-width");c.top=e;c.marginTop=f;c.ha=b;c.Nb=d;!a.b&&0<d&&(a=e+rl(c),a-=Math.floor(a/d)*d,0<a&&(c.Bb=d-a,g+=c.Bb));c.J=g;x(c.element,"top",e+"px");x(c.element,"margin-top",f+"px");x(c.element,"padding-top",g+"px");x(c.element,"border-top-width",b+"px")}
...
function Wq(a,b){a.j&&(a.N=Dq(a,"right",a.D,b)||Dq(a,"margin-right",a.D,b)||Dq(a,"border-right-width",a.D,b)||Dq(a,"padding-right",a.D,b));a.h&&(a.S=Dq(a,"top",a.B,b)||Dq(a,"margin-top",a.B,b)||Dq(a,"border-top-width",a.B,b)||Dq(a,"padding-top",a.B,b));for(var c=t(a.children),d=c.next();!d.done;d=c.next())Wq(d.value,b)}function Xq(a){yq.call(this,null,a)}v(Xq,yq);Xq.prototype.l=function(a,b){yq.prototype.l.call(this,a,b);this.children.sort(function(a,b){return b.f.ba-a.f.ba||a.f.index-b.f.index})};
function pq(a,b){yq.call(this,a,b);this.F=this}v(pq,yq);pq.prototype.Y=function(a){var b=this.f.g;b.ia&&(a=Ac(b.f,a,b.ia));return a};pq.prototype.ha=function(){};function rq(a,b){yq.call(this,a,b);this.F=a.F}v(rq,yq);function tq(a,b){yq.call(this,a,b);this.F=a.F}v(tq,yq);
...
tq.prototype.Y=function(a){var b=this.f.f,c=this.style,d=xq(b,c.required,b.h)!==b.h;if(d||this.h){var e=c["flow-from"],e=e?e.Aa(b,b.b):new Hb(b,"body"),e=new wc(b,"has-content",[e]);a=Ac(b,a,e)}a=Yq(this,a,c["required-partitions"],!1);a=Yq(this,a,c["conflicting-partitions"],!0);d&&(c=(c=this.F.style.enabled)?c.Aa(b,null):b.j,c=Ac(b,c,a),this.F.style.enabled=new G(c));return a};tq.prototype.jc=function(a,b,c,d,e){x(b.element,"overflow","hidden");yq.prototype.jc.call(this,a,b,c,d,e)};
function Zq(a,b,c,d){Gf.call(this,a,b,!1);this.target=c;this.b=d}v(Zq,Hf);Zq.prototype.Rb=function(a,b,c){Dh(this.b,a,b,c,this)};Zq.prototype.ie=function(a,b){If(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};Zq.prototype.kd=function(a,b){If(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Zq.prototype.Tb=function(a,b,c){this.target.b[a]=new V(b,c?50331648:67108864)};function $q(a,b,c,d){Zq.call(this,a,b,c,d)}v($q,Zq);
function ar(a,b,c,d){Zq.call(this,a,b,c,d);c.b.width=new V(Yd,0);c.b.height=new V(Yd,0)}v(ar,Zq);ar.prototype.yd=function(a,b,c){a=new sq(this.f,a,b,c,this.target);Ff(this.na,new $q(this.f,this.na,a,this.b))};ar.prototype.xd=function(a,b,c){a=new qq(this.f,a,b,c,this.target);a=new ar(this.f,this.na,a,this.b);Ff(this.na,a)};function br(a,b,c,d){Zq.call(this,a,b,c,d)}v(br,Zq);br.prototype.yd=function(a,b,c){a=new sq(this.f,a,b,c,this.target);Ff(this.na,new $q(this.f,this.na,a,this.b))};
br.prototype.xd=function(a,b,c){a=new qq(this.f,a,b,c,this.target);a=new ar(this.f,this.na,a,this.b);Ff(this.na,a)};function cr(a){a=a.toString();switch(a){case "inline-flex":a="flex";break;case "inline-grid":a="grid";break;case "inline-table":a="table";break;case "inline":case "table-row-group":case "table-column":case "table-column-group":case "table-header-group":case "table-footer-group":case "table-row":case "table-cell":case "table-caption":case "inline-block":a="block"}return D(a)}function Wl(a,b,c,d){if(a!==J)if(b===Vc||b===md)c=J,a=cr(a);else if(c&&c!==J||d)a=cr(a);return{display:a,position:b,ja:c}}
...
pr.prototype.sa=function(a,b){var c=a.getAttribute("data-adapt-pseudo")||"";this.f[c]||(this.f[c]=!0,(c=b.content)&&Gl(c)&&c.ea(new Fl(a,this.g,c,this.h)))};function qr(a,b,c,d,e,f,g,h,l,k,m,p,q){this.Qb={};this.G=a;this.b=b;this.viewport=c;this.D=c.b;this.j=d;this.u=eq(d.Ba.b);this.l=e;this.ca=f;this.H=g;this.B=h;this.J=l;this.page=k;this.g=m;this.F=p;this.h=q;this.N=this.w=null;this.f=!1;this.M=null;this.ma=0;this.A=null}v(qr,eb);
qr.prototype.clone=function(){return new qr(this.G,this.b,this.viewport,this.j,this.l,this.ca,this.H,this.B,this.J,this.page,this.g,this.F,this.h)};function rr(a,b,c,d){a=a._pseudos;if(!a)return null;var e={},f={},g;for(g in a)f.ed=e[g]={},Xj(f.ed,a[g],d),Vj(f.ed,d,a[g]),Wj(a[g],b,c,function(a){return function(b,c){Xj(a.ed,c,d);sr(c,function(b){Xj(a.ed,b,d)})}}(f)),f={ed:f.ed};return e}
function tr(a,b,c,d,e,f){var g=L("createRefShadow");a.ca.u.load(b).then(function(h){if(h){var l=lk(h,b);if(l){var k=a.J,m=k.N[h.url];if(!m){var m=k.style.F.f[h.url],p=new Pb(0,k.ic(),k.hc(),k.u),m=new am(h,m.g,m.f,p,k.l,m.G,new Qp(k.h,h.url),new Rp(k.h,h.url,m.f,m.b));k.N[h.url]=m}f=new Zk(d,l,h,e,f,c,m)}}O(g,f)});return g.result()}
function ur(a,b,c,d,e,f,g,h){var l=L("createShadows"),k=e.template,m;k instanceof Sc?m=tr(a,k.url,2,b,h,null):m=M(null);m.then(function(k){var m=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var p=b.getAttribute("href"),z=null;p?z=h?h.ca:a.ca:h&&(p="http://www.w3.org/1999/xhtml"==h.na.namespaceURI?h.na.getAttribute("href"):h.na.getAttributeNS("http://www.w3.org/1999/xlink","href"),z=h.pd?h.pd.ca:a.ca);p&&(p=Aa(p,z.url),m=tr(a,p,3,b,h,k))}m||(m=M(k));var u=null;
...
function vr(a,b,c,d,e){var f=a.b;d=Uj(d,f,a.l,a.f);b=Sj(d,f,b);c=Tj(d,f,c);Yj(d,e,b,c,function(b,c){var d=c.evaluate(f,b);"font-family"==b&&(d=um(a.H,d));return d});var g=Wl(e.display||td,e.position,e["float"],a.M===a.ca.root);["display","position","float"].forEach(function(a){g[a]&&(e[a]=g[a])});return b}
function wr(a,b){for(var c=a.w.M,d=[],e=null,f=a.w.wa,g=-1;c&&1==c.nodeType;){var h=f&&f.root==c;if(!h||2==f.type){var l=(f?f.b:a.j).l(c,!1);d.push(l);e=e||Pa(c)}h?(c=f.na,f=f.pd):(c=c.parentNode,g++)}c=Rb(a.b,"em",!g);c={"font-size":new V(new F(c,"px"),0)};f=new ei(c,a.b);for(g=d.length-1;0<=g;--g){var h=d[g],l=[],k;for(k in h)Fh[k]&&l.push(k);l.sort(ce);for(var l=t(l),m=l.next();!m.done;m=l.next()){m=m.value;f.b=m;var p=h[m];p.value!==sd&&(c[m]=p.Pd(f))}}for(var q in b)Fh[q]||(c[q]=b[q]);return{lang:e,
mb:c}}var xr={a:"a",sub:"sub",sup:"sup",table:"table",tr:"tr",td:"td",th:"th",code:"code",body:"div",p:"p",v:"p",date:"p",emphasis:"em",strong:"strong",style:"span",strikethrough:"del"};function yr(a,b){b=Aa(b,a.ca.url);return a.F[b]||b}function zr(a){a.w.lang=Pa(a.w.M)||a.w.parent&&a.w.parent.lang||a.w.lang}
...
function Cr(a,b,c){var d=!0,e=L("createElementView"),f=a.M,g=a.w.wa?a.w.wa.b:a.j,h=g.l(f,!1);if(!a.w.wa){var l=gk(a.ca,f);Dr(l,a.w.Sa,0)}var k={};a.w.parent||(l=wr(a,h),h=l.mb,a.w.lang=l.lang);var m=h["float-reference"]&&Vm(h["float-reference"].value.toString());a.w.parent&&m&&Wm(m)&&(l=wr(a,h),h=l.mb,a.w.lang=l.lang);a.w.b=vr(a,a.w.b,"rtl"===a.w.direction,h,k);g.sa(f,k);Ar(a,k);zr(a);k.direction&&(a.w.direction=k.direction.toString());if((l=k["flow-into"])&&l.toString()!=a.G)return O(e,!1),e.result();
...
p?p.toString():"inline";a.w.Ca=A?r.toString():null;a.w.W=m||al;a.w.N=k["float-min-wrap-block"]||null;a.w.ha=k["column-span"];if(!a.w.ya){if(u=k["break-after"])a.w.G=u.toString();if(u=k["break-before"])a.w.g=u.toString()}a.w.Z=k["vertical-align"]&&k["vertical-align"].toString()||"baseline";a.w.oa=k["caption-side"]&&k["caption-side"].toString()||"top";u=k["border-collapse"];if(!u||u===D("separate"))if(A=k["border-spacing"])A.Ud()?(u=A.values[0],A=A.values[1]):u=A,u.Ac()&&(a.w.sa=Uc(u,a.b)),A.Ac()&&
(a.w.ta=Uc(A,a.b));a.w.Y=k["footnote-policy"];if(u=k["x-first-pseudo"])a.w.f=new $k(a.w.parent?a.w.parent.f:null,u.L);a.w.ya||Er(a,f,h,g,a.b);if(u=k["white-space"])u=Kk(u.toString()),null!==u&&(a.w.tc=u);(u=k["hyphenate-character"])&&u!==Yc&&(a.w.F=u.Xc);u=k["overflow-wrap"]||["word-wrap"];a.w.B=k["word-break"]===gd||u===hd;Br(a.w,b,p,l,r,q);a.w.parent&&a.w.parent.C&&(b=a.w.parent.C.jf(a.w,b));a.w.ya||(a.w.u=Fr(k),Gr(a,f,g));var I=!1,ma=null,Ca=[],Da=f.namespaceURI,N=f.localName;if("http://www.w3.org/1999/xhtml"==
...
(I=!0);var rb;I?rb=a.g(f,a.w.parent?a.w.parent.A:null,k):rb=M(null);rb.then(function(g){g?I&&(d="true"==g.getAttribute("data-adapt-process-children")):g=Hr(a,Da,N);"a"==N&&g.addEventListener("click",a.page.J,!1);ma&&($o(a,a.w,"inner",ma),g.appendChild(ma));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&lr(g);var h=a.w.h["image-resolution"],l=[],m=k.width,p=k.height,q=f.getAttribute("width"),r=f.getAttribute("height"),m=m===Yc||!m&&!q,p=p===Yc||!p&&!r;if("http://www.gribuser.ru/xml/fictionbook/2.0"!=
f.namespaceURI||"td"==N){for(var q=f.attributes,u=q.length,r=null,z=0;z<u;z++){var A=q[z],H=A.namespaceURI,E=A.localName,A=A.nodeValue;if(H)if("http://www.w3.org/2000/xmlns/"==H)continue;else"http://www.w3.org/1999/xlink"==H&&"href"==E&&(A=yr(a,A));else{if(E.match(/^on/))continue;if("style"==E)continue;if(("id"==E||"name"==E)&&b){A=a.h.Ue(A,a.ca.url);g.setAttribute(E,A);Hk(a.page,g,A);continue}"src"==E||"href"==E||"poster"==E?(A=yr(a,A),"href"===E&&(A=a.h.nc(A,a.ca.url))):"srcset"==E&&(A=A.split(",").map(function(b){return yr(a,
b.trim())}).join(","));if("poster"===E&&"video"===N&&"http://www.w3.org/1999/xhtml"===Da&&m&&p){var rb=new Image,Gp=Je(rb,A);Ca.push(Gp);l.push({Uf:rb,element:g,Rf:Gp})}}"http://www.w3.org/2000/svg"==Da&&/^[A-Z\-]+$/.test(E)&&(E=E.toLowerCase());Ir.includes(E.toLowerCase())&&(A=fr(A,a.ca.url,a.h));H&&(rb=kr[H])&&(E=rb+":"+E);"src"!=E||H||"img"!=N&&"input"!=N||"http://www.w3.org/1999/xhtml"!=Da?"href"==E&&"image"==N&&"http://www.w3.org/2000/svg"==Da&&"http://www.w3.org/1999/xlink"==H?a.page.j.push(Je(g,
A)):H?g.setAttributeNS(H,E,A):g.setAttribute(E,A):r=A}r&&(rb="input"===N?new Image:g,q=Je(rb,r),rb!==g&&(g.src=r),m||p?(m&&p&&h&&1!==h&&l.push({Uf:rb,element:g,Rf:q}),Ca.push(q)):a.page.j.push(q))}delete k.content;(m=k["list-style-image"])&&m instanceof Sc&&(m=m.url,Ca.push(Je(new Image,m)));Jr(a,k);Kr(a,g,k);if(!a.w.ya&&(m=null,b?c&&(m=a.w.b?jr:ir):m="clone"!==a.w.h["box-decoration-break"]?a.w.b?hr:gr:a.w.b?jr:ir,m))for(var Hp in m)x(g,Hp,m[Hp]);K&&g.setAttribute("value",k["ua-list-item-count"].stringValue());
a.A=g;Ca.length?Ie(Ca).then(function(){0<h&&Lr(a,l,h,k,a.w.b);O(e,d)}):Be().then(function(){O(e,d)})})});return e.result()}function Er(a,b,c,d,e){var f=rr(c,a.l,a.f,e);f&&f["after-if-continues"]&&f["after-if-continues"].content&&(a.w.J=new Mr(b,new pr(b,c,d,e,a.u)))}var Ir="color-profile clip-path cursor filter marker marker-start marker-end marker-mid fill stroke mask".split(" ");
function Lr(a,b,c,d,e){b.forEach(function(b){if("load"===b.Rf.get().get()){var f=b.Uf,h=f.width/c,f=f.height/c;b=b.element;if(0<h&&0<f)if(d["box-sizing"]===fd&&(d["border-left-style"]!==J&&(h+=Uc(d["border-left-width"],a.b)),d["border-right-style"]!==J&&(h+=Uc(d["border-right-width"],a.b)),d["border-top-style"]!==J&&(f+=Uc(d["border-top-width"],a.b)),d["border-bottom-style"]!==J&&(f+=Uc(d["border-bottom-width"],a.b))),1<c){var l=d["max-width"]||J,k=d["max-height"]||J;l===J&&k===J?x(b,"max-width",
...
function Fr(a){var b=a["repeat-on-break"];return b!==J&&(b===Yc&&(b=a.display===Rd?qd:a.display===Qd?pd:J),b&&b!==J)?b.toString():null}function Or(a){var b=L("createTextNodeView");Pr(a).then(function(){var c=a.ma||0,c=Qr(a.w.Qa).substr(c);a.A=document.createTextNode(c);O(b,!0)});return b.result()}
function Pr(a){if(a.w.Qa)return M(!0);var b,c=b=a.M.textContent,d=L("preprocessTextContent"),e=ge("PREPROCESS_TEXT_CONTENT"),f=0;De(function(){return f>=e.length?M(!1):e[f++](a.w,c).da(function(a){c=a;return M(!0)})}).then(function(){a.w.Qa=Rr(b,c,0);O(d,!0)});return d.result()}
function Sr(a,b,c){var d=L("createNodeView"),e=!0;1==a.M.nodeType?b=Cr(a,b,c):8==a.M.nodeType?(a.A=null,b=M(!0)):b=Or(a);b.then(function(b){e=b;(a.w.A=a.A)&&(b=a.w.parent?a.w.parent.A:a.N)&&b.appendChild(a.A);O(d,e)});return d.result()}function zo(a,b,c,d){(a.w=b)?(a.M=b.M,a.ma=b.ma):(a.M=null,a.ma=-1);a.A=null;return a.w?Sr(a,c,!!d):M(!0)}
function Tr(a){if(null==a.wa||"content"!=a.M.localName||"http://www.pyroxy.com/ns/shadow"!=a.M.namespaceURI)return a;var b=a.Ma,c=a.wa,d=a.parent,e,f;c.yf?(f=c.yf,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.pd,e=c.na.firstChild,c=2);var g=a.M.nextSibling;g?(a.M=g,bl(a)):a.Ga?a=a.Ga:e?a=null:(a=a.parent.modify(),a.K=!0);if(e)return b=new Xk(e,d,b),b.wa=f,b.kb=c,b.Ga=a,b;a.Ma=b;return a}
function Ur(a){var b=a.Ma+1;if(a.K){if(!a.parent)return null;if(3!=a.kb){var c=a.M.nextSibling;if(c)return a=a.modify(),a.Ma=b,a.M=c,bl(a),Tr(a)}if(a.Ga)return a=a.Ga.modify(),a.Ma=b,a;a=a.parent.modify()}else{if(a.Ja&&(c=a.Ja.root,2==a.Ja.type&&(c=c.firstChild),c))return b=new Xk(c,a,b),b.wa=a.Ja,b.kb=a.Ja.type,Tr(b);if(c=a.M.firstChild)return Tr(new Xk(c,a,b));1!=a.M.nodeType&&(c=Qr(a.Qa),b+=c.length-1-a.ma);a=a.modify()}a.Ma=b;a.K=!0;return a}
function Fm(a,b,c){b=Ur(b);if(!b||b.K)return M(b);var d=L("nextInTree");zo(a,b,!0,c).then(function(c){b.A&&c||(b=b.modify(),b.K=!0,b.A||(b.ya=!0));fb(a,{type:"nextInTree",w:b});O(d,b)});return d.result()}function Vr(a,b){if(b instanceof Hc)for(var c=b.values,d=0;d<c.length;d++)Vr(a,c[d]);else b instanceof Sc&&(c=b.url,a.page.j.push(Je(new Image,c)))}
var Wr={"box-decoration-break":!0,"float-min-wrap-block":!0,"float-reference":!0,"flow-into":!0,"flow-linger":!0,"flow-options":!0,"flow-priority":!0,"footnote-policy":!0,page:!0};function Kr(a,b,c){var d=c["background-image"];d&&Vr(a,d);var d=c.position===Gd,e;for(e in c)if(!Wr[e]){var f=c[e],f=f.ea(new Tg(a.ca.url,a.h));f.Ac()&&Ob(f.ka)&&(f=new F(Uc(f,a.b),"px"));zk[e]||d&&Ak[e]?a.page.l.push(new Bk(b,e,f)):x(b,e,f.toString())}}
function $o(a,b,c,d){if(!b.K){var e=(b.wa?b.wa.b:a.j).l(a.M,!1);if(e=e._pseudos)if(e=e[c])c={},b.b=vr(a,b.b,"rtl"===b.direction,e,c),b=c.content,Gl(b)&&(b.ea(new Fl(d,a.b,b,a.u)),delete c.content),Kr(a,d,c)}}
function Co(a,b,c){var d=L("peelOff"),e=b.f,f=b.ma,g=b.K;if(0<c)b.A.textContent=b.A.textContent.substr(0,c),f+=c;else if(!g&&b.A&&!f){var h=b.A.parentNode;h&&h.removeChild(b.A)}for(var l=b.Ma+c,k=[];b.f===e;)k.push(b),b=b.parent;var m=k.pop(),p=m.Ga;De(function(){for(;0<k.length;){m=k.pop();b=new Xk(m.M,b,l);k.length||(b.ma=f,b.K=g);b.kb=m.kb;b.wa=m.wa;b.Ja=m.Ja;b.Ga=m.Ga?m.Ga:p;p=null;var c=zo(a,b,!1);if(c.Xa())return c}return M(!1)}).then(function(){O(d,b)});return d.result()}
function Hr(a,b,c){return"http://www.w3.org/1999/xhtml"==b?a.D.createElement(c):a.D.createElementNS(b,c)}function Lp(a){a&&hl(a,function(a){var b=a.h["box-decoration-break"];b&&"slice"!==b||(b=a.A,a.b?(x(b,"padding-left","0"),x(b,"border-left","none"),x(b,"border-top-left-radius","0"),x(b,"border-bottom-left-radius","0")):(x(b,"padding-bottom","0"),x(b,"border-bottom","none"),x(b,"border-bottom-left-radius","0"),x(b,"border-bottom-right-radius","0")))})}
...
function fs(a){var b={width:Zd,height:$d,Zb:ae,$b:ae},c=a.size;if(c&&c.value!==Yc){var d=c.value;d.Ud()?(c=d.values[0],d=d.values[1]):(c=d,d=null);if(c.Ac())b.width=c,b.height=d||c;else if(c=as[c.name.toLowerCase()])d&&d===xd?(b.width=c.height,b.height=c.width):(b.width=c.width,b.height=c.height)}(c=a.marks)&&c.value!==J&&(b.$b=es);a=a.bleed;a&&a.value!==Yc?a.value&&a.value.Ac()&&(b.Zb=a.value):c&&(a=!1,c.value.Ud()?a=c.value.values.some(function(a){return a===id}):a=c.value===id,a&&(b.Zb=new F(6,
"pt")));return b}function gs(a,b){var c={},d=a.Zb.L*Rb(b,a.Zb.ka,!1),e=a.$b.L*Rb(b,a.$b.ka,!1),f=d+e,g=a.width;c.ic=g===Zd?b.$.vc?b.$.vc.width*Rb(b,"px",!1):(b.$.ub?Math.floor(b.xb/2)-b.$.Dc:b.xb)-2*f:g.L*Rb(b,g.ka,!1);g=a.height;c.hc=g===$d?b.$.vc?b.$.vc.height*Rb(b,"px",!1):b.Nb-2*f:g.L*Rb(b,g.ka,!1);c.Zb=d;c.$b=e;c.te=f;return c}function hs(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
function is(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg",c||"polyline");a.setAttribute("stroke","black");a.setAttribute("stroke-width",b);a.setAttribute("fill","none");return a}var js={oh:"top left",ph:"top right",ah:"bottom left",bh:"bottom right"};
...
k.appendChild(l);a=is(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));k.appendChild(a);b.split(" ").forEach(function(a){k.style[a]=f+"px"});return k}var ls={nh:"top",$g:"bottom",sg:"left",tg:"right"};
...
ls[a];a===b?h.style[a]=e+"px":a!==k&&(h.style[a]="0",h.style["margin-"+a]="auto")});return h}function ns(a,b,c,d){var e=!1,f=!1;if(a=a.marks)a=a.value,a.Ud()?a.values.forEach(function(a){a===id?e=!0:a===jd&&(f=!0)}):a===id?e=!0:a===jd&&(f=!0);if(e||f){var g=c.I,h=g.ownerDocument,l=b.Zb,k=Uc(bs,d),m=Uc(cs,d),p=Uc(ds,d);e&&Object.keys(js).forEach(function(a){a=ks(h,js[a],k,p,l,m);g.appendChild(a)});f&&Object.keys(ls).forEach(function(a){a=ms(h,ls[a],k,p,m);g.appendChild(a)})}}
...
function rs(a,b,c){oq.call(this,a,null,"vivliostyle-page-rule-master",[],b,null,0);a=fs(c);new ss(this.f,this,c,a);this.B={};ts(this,c);this.b.position=new V(Gd,0);this.b.width=new V(a.width,0);this.b.height=new V(a.height,0);for(var d in c)os[d]||"background-clip"===d||(this.b[d]=c[d])}v(rs,oq);function ts(a,b){var c=b._marginBoxes;c&&qs.forEach(function(d){c[d]&&(a.B[d]=new us(a.f,a,d,b))})}rs.prototype.h=function(a){return new vs(a,this)};
...
vs.prototype.l=function(a,b){var c=this.J,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}pq.prototype.l.call(this,a,b)};vs.prototype.De=function(){var a=this.style;a.left=ae;a["margin-left"]=ae;a["border-left-width"]=ae;a["padding-left"]=ae;a["padding-right"]=ae;a["border-right-width"]=ae;a["margin-right"]=ae;a.right=ae};
vs.prototype.Ee=function(){var a=this.style;a.top=new F(-1,"px");a["margin-top"]=ae;a["border-top-width"]=ae;a["padding-top"]=ae;a["padding-bottom"]=ae;a["border-bottom-width"]=ae;a["margin-bottom"]=ae;a.bottom=ae};vs.prototype.ha=function(a,b,c){b=b.H;var d={start:this.u.marginLeft,end:this.u.marginRight,va:this.u.Lc},e={start:this.u.marginTop,end:this.u.marginBottom,va:this.u.Kc};ys(this,b.top,!0,d,a,c);ys(this,b.bottom,!0,d,a,c);ys(this,b.left,!1,e,a,c);ys(this,b.right,!1,e,a,c)};
function zs(a,b,c,d,e){this.I=a;this.B=e;this.j=c;this.u=!Y(d,b[c?"width":"height"],new tc(d,0,"px"));this.size=null}zs.prototype.b=function(){return this.u};function As(a){a.size||(a.size=Rn(a.B,a.I.element,a.j?["max-content width","min-content width"]:["max-content height","min-content height"]));return a.size}zs.prototype.g=function(){var a=As(this);return this.j?tl(this.I)+a["max-content width"]+ul(this.I):rl(this.I)+a["max-content height"]+sl(this.I)};
...
function Ds(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=Es(d,g.length?new Bs(g):null,b);g.Ab&&(f.center=g.Ab);d=g.Ab||d.f();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=Es(c,e,b),c.Ab&&(f.start=c.Ab),c.Cd&&(f.end=c.Cd);return f}
function Es(a,b,c){var d={Ab:null,Cd:null};if(a&&b)if(a.b()&&b.b()){var e=a.g(),f=b.g();0<e&&0<f?(f=e+f,f<c?d.Ab=c*e/f:(a=a.h(),b=b.h(),b=a+b,b<c?d.Ab=a+(c-b)*(e-a)/(f-b):0<b&&(d.Ab=c*a/b)),0<d.Ab&&(d.Cd=c-d.Ab)):0<e?d.Ab=c:0<f&&(d.Cd=c)}else a.b()?d.Ab=Math.max(c-b.f(),0):b.b()&&(d.Cd=Math.max(c-a.f(),0));else a?a.b()&&(d.Ab=c):b&&b.b()&&(d.Cd=c);return d}vs.prototype.jc=function(a,b,c,d,e){vs.qg.jc.call(this,a,b,c,d,e);b.element.setAttribute("data-vivliostyle-page-box",!0)};
function ws(a,b){tq.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.Kc=this.Lc=null}v(ws,tq);
ws.prototype.l=function(a,b){var c=this.J,d;for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(d.match(/^column.*$/)||d.match(/^background-/))&&(c[d]=b[d]);tq.prototype.l.call(this,a,b);d=this.g;c={Lc:this.Lc,Kc:this.Kc,marginTop:this.marginTop,marginRight:this.marginRight,marginBottom:this.marginBottom,marginLeft:this.marginLeft};d.u=c;d=d.style;d.width=new G(c.Lc);d.height=new G(c.Kc);d["padding-left"]=new G(c.marginLeft);d["padding-right"]=new G(c.marginRight);d["padding-top"]=new G(c.marginTop);
d["padding-bottom"]=new G(c.marginBottom)};ws.prototype.De=function(){var a=Fs(this,{start:"left",end:"right",va:"width"});this.Lc=a.Jf;this.marginLeft=a.bg;this.marginRight=a.ag};ws.prototype.Ee=function(){var a=Fs(this,{start:"top",end:"bottom",va:"height"});this.Kc=a.Jf;this.marginTop=a.bg;this.marginBottom=a.ag};
...
ae;c["margin-"+f]=ae;c["padding-"+e]=new G(p);c["padding-"+f]=new G(q);c["border-"+e+"-width"]=new G(r);c["border-"+f+"-width"]=new G(z);c[g]=new G(l);c["max-"+g]=new G(l);return{Jf:B(d,h,y(d,k,m)),bg:k,ag:m}}ws.prototype.jc=function(a,b,c,d,e){tq.prototype.jc.call(this,a,b,c,d,e);c.D=b.element;a.ha=parseFloat(c.D.style.width);a.Z=parseFloat(c.D.style.height)};function xs(a,b){tq.call(this,a,b);var c=b.u;this.u=ps[c];a.ta[c]=this;this.ua=!0}v(xs,tq);n=xs.prototype;
...
n.Da=function(a,b){var c=this.style,d=this.f.f,e=a.start,f=a.end,g="left"===e,h=g?b.Lc:b.Kc,l=Y(d,c[a.va],h),g=g?b.marginLeft:b.marginTop;if("start"===this.u.Da)c[e]=new G(g);else if(l){var k=uq(d,c["margin-"+e],h),m=uq(d,c["margin-"+f],h),p=uq(d,c["padding-"+e],h),q=uq(d,c["padding-"+f],h),r=wq(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),f=wq(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),l=y(d,l,y(d,y(d,p,q),y(d,y(d,r,f),y(d,k,m))));switch(this.u.Da){case "center":c[e]=new G(y(d,
g,Cc(d,B(d,h,l),new Hb(d,2))));break;case "end":c[e]=new G(B(d,y(d,g,h),l))}}};
function Gs(a,b,c){function d(a){if(u)return u;u={va:z?z.evaluate(a):null,rb:l?l.evaluate(a):null,sb:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[q,m,p,r].forEach(function(b){b&&(c+=b.evaluate(a))});(null===u.rb||null===u.sb)&&c+u.va+u.rb+u.sb>b&&(null===u.rb&&(u.rb=0),null===u.sb&&(u.wh=0));null!==u.va&&null!==u.rb&&null!==u.sb&&(u.sb=null);null===u.va&&null!==u.rb&&null!==u.sb?u.va=b-c-u.rb-u.sb:null!==u.va&&null===u.rb&&null!==u.sb?u.rb=b-c-u.va-u.sb:null!==u.va&&null!==u.rb&&null===u.sb?u.sb=
b-c-u.va-u.rb:null===u.va?(u.rb=u.sb=0,u.va=b-c):u.rb=u.sb=(b-c-u.va)/2;return u}var e=a.style;a=a.f.f;var f=b.Ge,g=b.Ne;b=b.va;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],l=vq(a,e["margin-"+f],h),k=vq(a,e["margin-"+g],h),m=uq(a,e["padding-"+f],h),p=uq(a,e["padding-"+g],h),q=wq(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),r=wq(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),z=Y(a,e[b],h),u=null;e[b]=new G(new Jb(a,function(){var a=d(this).va;return null===a?0:a},b));e["margin-"+
f]=new G(new Jb(a,function(){var a=d(this).rb;return null===a?0:a},"margin-"+f));e["margin-"+g]=new G(new Jb(a,function(){var a=d(this).sb;return null===a?0:a},"margin-"+g));"left"===f?e.left=new G(y(a,c.marginLeft,c.Lc)):"top"===f&&(e.top=new G(y(a,c.marginTop,c.Kc)))}n.De=function(){var a=this.g.u;this.u.Ua?Gs(this,{Ge:"right",Ne:"left",va:"width"},a):this.u.Va?Gs(this,{Ge:"left",Ne:"right",va:"width"},a):this.Da({start:"left",end:"right",va:"width"},a)};
n.Ee=function(){var a=this.g.u;this.u.Wa?Gs(this,{Ge:"bottom",Ne:"top",va:"height"},a):this.u.Ta?Gs(this,{Ge:"top",Ne:"bottom",va:"height"},a):this.Da({start:"top",end:"bottom",va:"height"},a)};n.Qd=function(a,b,c,d,e,f,g){tq.prototype.Qd.call(this,a,b,c,d,e,f,g);a=c.H;c=this.f.u;d=this.u;d.Ua||d.Va?d.Wa||d.Ta||(d.Ua?a.left[c]=b:d.Va&&(a.right[c]=b)):d.Wa?a.top[c]=b:d.Ta&&(a.bottom[c]=b)};
...
function Ss(a,b,c,d,e){Jj.call(this,a,b,null,c,null,d,!1);this.S=e;this.H=[];this.g="";this.F=[]}v(Ss,Jj);n=Ss.prototype;n.Vc=function(){this.Ub()};n.Xb=function(a,b){if(this.g=b)this.b.push(new Ls(b)),this.ba+=65536};
...
function Ts(a){var b;a.g||a.F.length?b=[a.g].concat(a.F.sort()):b=null;a.H.push({uf:b,ba:a.ba});a.g="";a.F=[]}n.Sc=function(){Ts(this);Jj.prototype.Sc.call(this)};n.La=function(){Ts(this);Jj.prototype.La.call(this)};
n.Tb=function(a,b,c){if("bleed"!==a&&"marks"!==a||this.H.some(function(a){return!a.uf})){Jj.prototype.Tb.call(this,a,b,c);var d=this.mb[a],e=this.S;if("bleed"===a||"marks"===a)e[""]||(e[""]={}),Object.keys(e).forEach(function(b){Zh(e[b],a,d)});else if("size"===a){var f=e[""];this.H.forEach(function(b){var c=new V(d.value,d.cb+b.ba);b=b.uf?b.uf.join(""):"";var g=e[b];g?(c=(b=g[a])?Wh(null,c,b):c,Zh(g,a,c)):(g=e[b]={},Zh(g,a,c),f&&["bleed","marks"].forEach(function(a){f[a]&&Zh(g,a,f[a])},this))},this)}}};
n.Xf=function(a){ni(this.l.od,"*",a)};n.$f=function(a){return new Rs(this.mb,a)};n.Te=function(a){var b=$h(this.mb,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);Ff(this.na,new Us(this.f,this.na,this.B,c))};function Us(a,b,c,d){Gf.call(this,a,b,!1);this.g=c;this.b=d}v(Us,Hf);Us.prototype.Rb=function(a,b,c){Dh(this.g,a,b,c,this)};Us.prototype.kd=function(a,b){If(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Us.prototype.ie=function(a,b){If(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
Us.prototype.Tb=function(a,b,c){Zh(this.b,a,new V(b,c?Cf(this):Df(this)))};function Vs(a){if(1>=a.length)return!1;var b=a[a.length-1].h;return a.slice(0,a.length-1).every(function(a){return b>a.h})}function Ws(a,b){a.b?a.width=b:a.height=b}function Xs(a){return a.b?a.width:a.height}function Ys(a,b){this.md=a;this.Tc=b}function Zs(a,b,c){this.b=a;this.F=b;this.B=c;this.f=Xs(a)}
function $s(a,b){var c=L("ColumnBalancer#balanceColumns");a.u(b);at(a,b);Bl(a.b);var d=[bt(a,b)];Ee(function(b){a.l(d)?(a.D(d),a.F().then(function(c){at(a,c);Bl(a.b);c?(d.push(bt(a,c)),P(b)):Q(b)})):Q(b)}).then(function(){var b=d.reduce(function(a,b){return b.Tc<a.Tc?b:a},d[0]);ct(a,b.md);Ws(a.b,a.f);O(c,b.md)});return c.result()}function bt(a,b){var c=a.j(b);return new Ys(b,c)}Zs.prototype.u=function(){};function at(a,b){var c=Gn(a.B);b&&(b.xg=c)}
function ct(a,b){var c=a.b.element;b.Eb.forEach(function(a){c.appendChild(a.element)});Hn(a.B,b.xg)}function dt(a){var b=a[a.length-1];if(!b.Tc||(a=a[a.length-2])&&b.Tc>=a.Tc)return!1;a=b.md.Eb;b=Math.max.apply(null,a.map(function(a){return a.h}));a=Math.max.apply(null,a.map(function(a){return bo(a.l)}));return b>a+1}function et(a,b){var c=Math.max.apply(null,a[a.length-1].md.Eb.map(function(a){return isNaN(a.mf)?a.h:a.h-a.mf+1}))-1;c<Xs(b)?Ws(b,c):Ws(b,Xs(b)-1)}
...
function pt(a,b,c,d,e,f,g,h,l,k,m,p){Pb.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.ca=b;this.lang=b.lang||c;this.viewport=d;this.l={body:!0};this.g=e;this.B=this.b=this.N=this.f=this.F=null;this.D=0;this.Mb=f;this.j=new tm(this.style.H);this.fb={};this.sa=null;this.h=m;this.Jb=new cn(null,null,null,null,null,null,null);this.oa={};this.H=p||null;this.Bb=g;this.Lb=h;this.ta=l;this.Kb=k;for(var q in a.h)(b=a.h[q]["flow-consume"])&&(b.evaluate(this,"flow-consume")==Wc?this.l[q]=!0:delete this.l[q]);
this.ob={};this.Ba=this.ua=0}v(pt,Pb);
function qt(a){var b=L("StyleInstance.init"),c=new Qp(a.h,a.ca.url),d=new Rp(a.h,a.ca.url,a.style.f,a.style.b);a.f=new am(a.ca,a.style.g,a.style.f,a,a.l,a.style.G,c,d);d.h=a.f;km(a.f,a);a.N={};a.N[a.ca.url]=a.f;var e=hm(a.f);a.H||(a.H=$r(e));a.F=new Xq(a.style.D);c=new rj(a.style.g,a,c,d);a.F.l(c,e);Wq(a.F,a);a.sa=new Hs(c,a.style.b,a.F,a,e);e=[];c=t(a.style.l);for(d=c.next();!d.done;d=c.next())if(d=d.value,!d.ia||d.ia.evaluate(a))d=qm(d.Ec,a),d=new rm(d),e.push(d);zm(a.Mb,e,a.j).Ea(b);var f=a.style.B;
Object.keys(f).forEach(function(a){var b=gs(fs(f[a]),this);this.ob[a]={width:b.ic+2*b.te,height:b.hc+2*b.te}},a);return b.result()}function lm(a,b,c){if(a=a.b)a.f[b.b]||(a.f[b.b]=c),c=a.b[b.b],c||(c=new ml,a.b[b.b]=c),c.b.push(new ll(new jl({pa:[{node:b.element,kb:Vk,wa:null,Ja:null,Ga:null,Sa:0}],ma:0,K:!1,Qa:null}),b))}
function rt(a,b){for(var c=Number.POSITIVE_INFINITY,d=0;d<b.b.length;d++){for(var e=b.b[d].b.f,f=e.pa[0].node,g=e.ma,h=e.K,l=0;f.ownerDocument!=a.ca.b;)l++,f=e.pa[l].node,h=!1,g=0;e=hk(a.ca,f,g,h);e<c&&(c=e)}return c}
...
function tt(a,b){var c=a.b,d=st(a,c);if(d==Number.POSITIVE_INFINITY)return null;for(var e=a.F.children,f,g=0;g<e.length;g++)if(f=e[g],"vivliostyle-page-rule-master"!==f.f.lc){var h=1,l=Gq(f,a,"utilization");l&&l.lf()&&(h=l.L);var l=Rb(a,"em",!1),k=a.ic()*a.hc();a.D=im(a.f,d,Math.ceil(h*k/(l*l)));h=a;l=void 0;for(l in c.b)if((k=c.b[l])&&0<k.b.length){var m=k.b[0].qa;if(rt(h,k)===m.f){a:switch(m=k.g,m){case "left":case "right":case "recto":case "verso":break a;default:m=null}k.g=Bm(Sl(m,k.b[0].qa.g))}}a.B=
c.clone();h=a;l=h.b.page;k=void 0;for(k in h.b.b)for(var m=h.b.b[k],p=m.b.length-1;0<=p;p--){var q=m.b[p];0>q.qa.wb&&q.qa.f<h.D&&(q.qa.wb=l)}Qb(a,a.style.b);h=Gq(f,a,"enabled");if(!h||h===Xd){c=a;w.debug("Location - page",c.b.page);w.debug("  current:",d);w.debug("  lookup:",c.D);d=void 0;for(d in c.b.b)for(e=t(c.b.b[d].b),g=e.next();!g.done;g=e.next())w.debug("  Chunk",d+":",g.value.qa.f);d=a.sa;e=f;f=b;c=e.f;Object.keys(f).length?(e=c,g=Js(d,f),e=e.j+"^"+g,g=d.j[e],g||("background-host"===c.lc?
(c=d,f=(new rs(c.l,c.h.f,f)).h(c.h),f.l(c.f,c.g),Wq(f,c.b),g=f):g=Ks(d,f,c),d.j[e]=g),f=g.f,f.f.g=f,f=g):(c.f.g=c,f=e);return f}}throw Error("No enabled page masters");}function nt(a,b){var c=a.B.f,d=c[b.b].f;if(d){var e=b.f,f=c[d].b;if(!f.length||e<f[0])return!1;var c=Ya(f.length,function(a){return f[a]>e})-1,c=f[c],d=a.B.b[d],g=rt(a,d);return c<g?!1:g<c?!0:!mt(a,d.g)}return!1}function ut(a,b,c){a=a.b.f[c];a.C||(a.C=new vo(null));b.nf=a.C}
function vt(a){var b=a.l,c=wn(b),d=L("layoutDeferredPageFloats"),e=!1,f=0;Ee(function(d){if(f===c.length)Q(d);else{var g=c[f++],l=g.ja,k=ln(l),m=k.Af(l,b);m&&an(m,l)?P(d):mn(b,l)||yn(b,l)?(xn(b,g),Q(d)):Xo(a,g,k,null,m).then(function(a){a?(a=In(b.parent))?Q(d):(In(b)&&!a&&(e=!0,b.Qc=!1),P(d)):Q(d)})}}).then(function(){e&&on(b);O(d,!0)});return d.result()}
function wt(a,b,c){var d=a.b.b[c];if(!d||!mt(a,d.g))return M(!0);d.g="any";ut(a,b,c);Vo(b);a.l[c]&&0<b.Kb.length&&(b.Lb=!1);var e=L("layoutColumn");vt(b).then(function(){if(In(b.l))O(e,!0);else{var f=[],g=[],h=!0;Ee(function(e){if(!sn(b.l,c))for(var k={};0<d.b.length-g.length;){for(k.index=0;g.includes(k.index);)k.index++;k.selected=d.b[k.index];if(k.selected.qa.f>a.D||nt(a,k.selected.qa))break;for(var l=k.index+1;l<d.b.length;l++)if(!g.includes(l)){var p=d.b[l];if(p.qa.f>a.D||nt(a,p.qa))break;Ok(p.qa,
k.selected.qa)&&(k.selected=p,k.index=l)}k.qa=k.selected.qa;k.Oa=!0;Lm(b,k.selected.b,h,d.f).then(function(a){return function(c){if(In(b.l))Q(e);else if(h=!1,a.selected.qa.u&&(null===c||a.qa.h)&&f.push(a.index),a.qa.h)g.push(a.index),Q(e);else{var k=!!c||!!b.g,l;0<zn(b.l).length&&b.xb?c?(l=c.clone(),l.f=b.xb):l=new jl(b.xb):l=null;if(b.g&&l)a.selected.b=l,d.f=b.g,b.g=null;else{g.push(a.index);if(c||l)a.selected.b=c||l,f.push(a.index);b.g&&(d.g=Bm(b.g))}k?Q(e):(b.Lb=!1,a.Oa?a.Oa=!1:P(e))}}}(k));if(k.Oa){k.Oa=
...
function xt(a,b,c,d,e,f,g,h,l,k,m,p,q,r,z){var u=b.b?b.j&&b.N:b.h&&b.S,A=f.element,H=new cn(l,"column",null,h,null,null,null),E=a.b.clone(),K=L("createAndLayoutColumn"),I;Ee(function(b){var K=new lo([new gq(a.h,a.b.page-1)].concat(Zn(H)));if(1<k){var ma=a.viewport.b.createElement("div");x(ma,"position","absolute");A.appendChild(ma);I=new Jm(ma,r,a.g,K,H);I.Lb=z;I.b=f.b;I.Nb=f.Nb;I.Rd=f.Rd;f.b?(K=g*(p+m)+f.J,yl(I,f.H,f.width),xl(I,K,p)):(K=g*(p+m)+f.H,xl(I,f.J,f.height),yl(I,K,p));I.F=c;I.G=d}else I=
new Jm(A,r,a.g,K,H),wl(I,f);I.ob=u?[]:e.concat();I.Mb=q;gn(H,I);0<=I.width?wt(a,I,h).then(function(){In(H)||En(H);In(I.l)&&!In(l)?(I.l.Qc=!1,a.b=E.clone(),I.element!==A&&A.removeChild(I.element),P(b)):Q(b)}):(En(H),Q(b))}).then(function(){O(K,I)});return K.result()}function yt(a,b,c,d,e){var f=Gq(c,a,"writing-mode")||null;a=Gq(c,a,"direction")||null;return new cn(b,"region",d,e,null,f,a)}
function zt(a,b,c,d,e,f,g,h,l,k){function m(){p.b=q.clone();return At(p,b,c,d,e,f,g,r,h,l,k,z).da(function(a){return a?M({Eb:a,position:p.b}):M(null)})}var p=a,q=p.b.clone(),r=yt(p,g,c,h,l),z=!0;return m().da(function(a){if(!a)return M(null);if(1>=k)return M(a.Eb);var b=Gq(c,p,"column-fill")||Zc,b=jt(k,b,m,r,h,a.Eb,p.b.b[l]);if(!b)return M(a.Eb);z=!1;g.g=!0;r.g=!0;return $s(b,a).da(function(a){g.g=!1;g.Qc=!1;r.g=!1;p.b=a.position;return M(a.Eb)})})}
function At(a,b,c,d,e,f,g,h,l,k,m,p){var q=L("layoutFlowColumns"),r=a.b.clone(),z=Z(c,a,"column-gap"),u=1<m?Z(c,a,"column-width"):l.width,A=Fq(c,a),H=Gq(c,a,"shape-inside"),E=Qg(H,0,0,l.width,l.height,a),K=new qr(k,a,a.viewport,a.f,A,a.ca,a.j,a.style.u,a,b,a.Bb,a.Lb,a.Kb),I=0,ma=null,Ca=[];Ee(function(b){xt(a,c,d,e,f,l,I++,k,h,m,z,u,E,K,p).then(function(c){In(g)?(Ca=null,Q(b)):((c.g&&"column"!==c.g||I===m)&&!In(h)&&En(h),In(h)?(I=0,a.b=r.clone(),h.Qc=!1,h.g?(Ca=null,Q(b)):P(b)):(ma=c,Ca[I-1]=ma,ma.g&&
"column"!=ma.g&&(I=m,"region"!=ma.g&&(a.oa[k]=!0)),I<m?P(b):Q(b)))})}).then(function(){O(q,Ca)});return q.result()}
function Bt(a,b,c,d,e,f,g,h){zq(c);var l=Gq(c,a,"enabled");if(l&&l!==Xd)return M(!0);var k=L("layoutContainer"),m=Gq(c,a,"wrap-flow")===Yc,l=Gq(c,a,"flow-from"),p=a.viewport.b.createElement("div"),q=Gq(c,a,"position");x(p,"position",q?q.name:"absolute");d.insertBefore(p,d.firstChild);var r=new ql(p);r.b=c.b;r.ob=g;c.jc(a,r,b,a.j,a.g);r.F=e;r.G=f;e+=r.left+r.marginLeft+r.Z;f+=r.top+r.marginTop+r.ha;(c instanceof ws||c instanceof pq&&!(c instanceof vs))&&gn(h,r);var z=!1;if(l&&l.Yf())if(a.oa[l.toString()])In(h)||
c.Qd(a,r,b,null,1,a.g,a.j),l=M(!0);else{var u=L("layoutContainer.inner"),A=l.toString(),H=Z(c,a,"column-count");zt(a,b,c,e,f,g,h,r,A,H).then(function(d){if(!In(h)){var e=d[0];e.element===p&&(r=e);r.h=Math.max.apply(null,d.map(function(a){return a.h}));c.Qd(a,r,b,e,H,a.g,a.j);(d=a.b.b[A])&&"region"===d.f&&(d.f=null)}O(u,!0)});l=u.result()}else{if((l=Gq(c,a,"content"))&&Gl(l)){q="span";l.url&&(q="img");var E=a.viewport.b.createElement(q);l.ea(new Fl(E,a,l,eq(a.h)));p.appendChild(E);"img"==q&&Vq(c,a,
E,a.j);Uq(c,a,r,a.j)}else c.ua&&(d.removeChild(p),z=!0);z||c.Qd(a,r,b,null,1,a.g,a.j);l=M(!0)}l.then(function(){if(In(h))O(k,!0);else{if(!c.h||0<Math.floor(r.h)){if(!z&&!m){var l=Gq(c,a,"shape-outside"),l=Dl(r,l,a);g.push(l)}}else if(!c.children.length){d.removeChild(p);O(k,!0);return}var q=c.children.length-1;De(function(){for(;0<=q;){var d=c.children[q--],d=Bt(a,b,d,p,e,f,g,h);if(d.Xa())return d.da(function(){return M(!In(h))});if(In(h))break}return M(!1)}).then(function(){O(k,!0)})}});return k.result()}
...
function Et(a,b,c){var d=b.I===b.h;a.oa={};c?(a.b=c.clone(),dm(a.f,c.g)):(a.b=new ol,dm(a.f,-1));a.lang&&b.h.setAttribute("lang",a.lang);c=a.b;c.page++;Qb(a,a.style.b);a.B=c.clone();var e=d?{}:Is(a.sa),f=tt(a,e);if(!f)return M(null);var g=0;if(!d){Fk(b,f.f.b.width.value===Zd);Gk(b,f.f.b.height.value===$d);a.h.j=b;$p(a.h,e,a);var h=gs(fs(e),a);Ft(a,h,b);ns(e,h,b,a);g=h.$b+h.Zb}e=!d&&Gq(f,a,"writing-mode")||rd;a.G=e!=rd;var h=Gq(f,a,"direction")||Bd,l=new cn(a.Jb,"page",null,null,null,e,h),k=L("layoutNextPage");
Ee(function(c){Bt(a,b,f,b.h,g,g+1,[],l).then(function(){In(l)||En(l);In(l)?(a.b=a.B.clone(),l.Qc=!1,P(c)):Q(c)})}).then(function(){f.ha(a,b,a.g);if(!d){var e=new uc(f.f.f,"left-page");b.b=e.evaluate(a)?"left":"right";Ct(a);c=a.b;Object.keys(c.b).forEach(function(b){b=c.b[b];var d=b.f;!d||"page"!==d&&mt(a,d)||(b.f=null)})}a.b=a.B=null;c.g=a.f.b;Ik(b,a.style.F.J[a.ca.url],a.g);Dt(a,c)&&(c=null);O(k,c)});return k.result()}
function Ft(a,b,c){a.Y=b.ic;a.S=b.hc;a.Ba=b.ic+2*b.te;a.ua=b.hc+2*b.te;c.I.style.width=a.Ba+"px";c.I.style.height=a.ua+"px";c.h.style.left=b.$b+"px";c.h.style.right=b.$b+"px";c.h.style.top=b.$b+"px";c.h.style.bottom=b.$b+"px";c.h.style.padding=b.Zb+"px";c.h.style.paddingTop=b.Zb+1+"px"}function Gt(a,b,c,d){Jj.call(this,a.j,a,b,c,d,a.h,!c);this.g=a;this.F=!1}v(Gt,Jj);n=Gt.prototype;n.fe=function(){};
n.ee=function(a,b,c){a=new oq(this.g.u,a,b,c,this.g.G,this.ia,Df(this.na));Ff(this.g,new br(a.f,this.g,a,this.B))};n.Fc=function(a){a=a.Mc;this.ia&&(a=Ac(this.f,this.ia,a));Ff(this.g,new Gt(this.g,a,this,this.G))};n.be=function(){Ff(this.g,new Pj(this.f,this.na))};n.de=function(){var a={};this.g.B.push({Ec:a,ia:this.ia});Ff(this.g,new Qj(this.f,this.na,null,a,this.g.h))};n.ce=function(a){var b=this.g.l[a];b||(b={},this.g.l[a]=b);Ff(this.g,new Qj(this.f,this.na,null,b,this.g.h))};
n.he=function(){var a={};this.g.H.push(a);Ff(this.g,new Qj(this.f,this.na,this.ia,a,this.g.h))};n.vd=function(a){var b=this.g.D;if(a){var c=$h(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Ff(this.g,new Qj(this.f,this.na,null,b,this.g.h))};n.ge=function(){this.F=!0;this.Ub()};n.Vc=function(){var a=new Ss(this.g.u,this.g,this,this.B,this.g.F);Ff(this.g,a);a.Vc()};
n.La=function(){Jj.prototype.La.call(this);if(this.F){this.F=!1;var a="R"+this.g.N++,b=D(a),c;this.ia?c=new Vh(b,0,this.ia):c=new V(b,0);bi(this.mb,"region-id").push(c);this.cc();a=new Gt(this.g,this.ia,this,a);Ff(this.g,a);a.La()}};
...
It.prototype.error=function(a){w.b("CSS parser:",a)};function Jt(a,b){return Kt(b,a)}function Lt(a){xf.call(this,Jt,"document");this.N=a;this.G={};this.u={};this.f={};this.J={};this.l=null;this.b=[];this.H=!1}v(Lt,xf);function Mt(a,b,c){Nt(a,b,c);var d=Aa("user-agent.xml",za),e=L("OPSDocStore.init");Eh.get().then(function(b){a.l=b;kt.get().then(function(){a.load(d).then(function(){a.H=!0;O(e,!0)})})});return e.result()}function Nt(a,b,c){a.b.splice(0);b&&b.forEach(a.S,a);c&&c.forEach(a.Y,a)}
Lt.prototype.S=function(a){var b=a.url;b&&(b=Aa(Ba(b),ya));this.b.push({url:b,text:a.text,qb:"Author",Pa:null,media:null})};Lt.prototype.Y=function(a){var b=a.url;b&&(b=Aa(Ba(b),ya));this.b.push({url:b,text:a.text,qb:"User",Pa:null,media:null})};
function Kt(a,b){var c=L("OPSDocStore.load"),d=b.url;pk(b,a).then(function(b){if(b){if(a.H)for(var e=ge("PREPROCESS_SINGLE_DOCUMENT"),g=0;g<e.length;g++)try{e[g](b.b)}catch(u){w.b("Error during single document preprocessing:",u)}for(var e=[],h=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),g=0;g<h.length;g++){var l=h[g],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=l.getAttribute("action"),
l=l.getAttribute("ref");k&&m&&p&&l&&e.push({Kg:k,event:m,action:p,sd:l})}a.J[d]=e;var q=[];q.push({url:Aa("user-agent-page.css",za),text:null,qb:"UA",Pa:null,media:null});if(g=b.l)for(g=g.firstChild;g;g=g.nextSibling)if(1==g.nodeType)if(e=g,h=e.namespaceURI,k=e.localName,"http://www.w3.org/1999/xhtml"==h)if("style"==k)h=e.getAttribute("class"),k=e.getAttribute("media"),m=e.getAttribute("title"),q.push({url:d,text:e.textContent,qb:"Author",Pa:m?h:null,media:k});else if("link"==k){if(m=e.getAttribute("rel"),
...
h&&"property"===k&&(h=e.getElementsByTagName("name")[0])&&"stylesheet"===h.textContent&&(e=e.getElementsByTagName("value")[0])&&(m=Aa(e.textContent,d),q.push({url:m,text:null,Pa:null,media:null,qb:"Author"}));for(g=0;g<a.b.length;g++)q.push(a.b[g]);for(var r="",g=0;g<q.length;g++)r+=q[g].url,r+="^",q[g].text&&(r+=q[g].text),r+="^";var z=a.G[r];z?(a.f[d]=z,O(c,b)):(g=a.u[r],g||(g=new Ge(function(){var b=L("fetchStylesheet"),c=0,d=new It(a.l);De(function(){if(c<q.length){var a=q[c++];d.Wc(a.qb);return null!==
a.text?jg(a.text,d,a.url,a.Pa,a.media).Hc(!0):ig(a.url,d,a.Pa,a.media)}return M(!1)}).then(function(){z=new lt(a,d.j,d.u,d.J.l,d.G,d.B,d.D,d.l,d.H,d.F);a.G[r]=z;delete a.u[r];O(b,z)});return b.result()},"FetchStylesheet "+d),a.u[r]=g,g.start()),g.get().then(function(e){a.f[d]=e;O(c,b)}))}else O(c,null)});return c.result()};function Ot(a){return String.fromCharCode(a>>>24&255,a>>>16&255,a>>>8&255,a&255)}
...
e.status+(e.statusText?" "+e.statusText:"")+")");O(d,null)})}else if("application/oebps-package+xml"==e.contentType||/\.opf(?:[#?]|$)/.test(b)){var g=t(b.match(/^((?:.*\/)?)([^/]*)$/));g.next();var h=g.next().value,g=g.next().value;Yt(a,h,g,c).Ea(d)}else"application/ld+json"==e.contentType||"application/webpub+json"==e.contentType||"application/audiobook+json"==e.contentType||"application/json"==e.contentType||/\.json(?:ld)?(?:[#?]|$)/.test(b)?a.g.load(b,!0,void 0).then(function(c){var e=new Zt(a,
b);$t(e,c).then(function(){O(d,e)})}):au(a,b).Ea(d)});return d.result()}
function Yt(a,b,c,d){var e=b+c,f=a.F[e];if(f)return M(f);var g=L("loadOPF");a.h.load(e,!0,"Failed to fetch EPUB OPF "+e).then(function(c){c?a.h.load(b+"META-INF/encryption.xml",void 0,void 0).then(function(h){(d?a.g.load(b+"?r=list",void 0,void 0):M(null)).then(function(d){f=new Zt(a,b);bu(f,c,h,d,b+"?r=manifest").then(function(){a.F[e]=f;a.ha[b]=f;O(g,f)})})}):w.error("Received an empty response for EPUB OPF "+e+". This may be caused by the server not allowing cross origin requests.")});return g.result()}
function au(a,b){var c=L("loadWebPub");a.load(b).then(function(d){if(d){var e=d.b,f=new Zt(a,b);e.body&&e.body.setAttribute("data-vivliostyle-primary-entry",!0);var g=e.querySelector("link[rel='publication'],link[rel='manifest'][type='application/webpub+json']");g?(g=g.href,g.substr(0,b.length)===b&&("#"===g.charAt(b.length)||"/"===g.charAt(b.length)&&"#"===g.charAt(b.length+1))&&(g=g.substr("#"===g.charAt(b.length)?b.length:b.length+1)),/^#/.test(g)?(g=JSON.parse(e.getElementById(g.substr(1)).textContent),
$t(f,g,e).then(function(){O(c,f)})):a.g.load(g,void 0,void 0).then(function(a){$t(f,a,e).then(function(){O(c,f)})})):$t(f,{},e).then(function(){f.uc.src!==d.url||e.querySelector("[role=doc-toc], [role=directory], nav, .toc, #toc")||(f.uc=null);O(c,f)})}else w.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return c.result()}
function cu(a,b,c){var d=L("EPUBDocStore.load");b=xa(b);(a.D[b]=Kt(a,{status:200,statusText:"",url:b,contentType:c.contentType,responseText:null,responseXML:c,ae:null})).Ea(d);return d.result()}
Vt.prototype.load=function(a){var b=xa(a);if(a=this.D[b])return a.Xa()?a:M(a.get());var c=L("EPUBDocStore.load");a=Vt.qg.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?O(c,a):w.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return c.result()};function du(){this.id=null;this.src="";this.h=this.title=this.g=null;this.O=-1;this.l=0;this.u=null;this.f=this.b=0;this.mc=this.wb=null;this.j=ab}
function eu(a){return a.id}function fu(a){var b=Qt(a);return function(a){var c=L("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));wf(e).then(function(a){a=new DataView(a);for(var d=0;d<a.byteLength;d++){var e=a.getUint8(d),e=e^b[d%20];a.setUint8(d,e)}O(c,vf([a,f]))});return c.result()}}
...
function lu(a,b){function c(a){for(var b in a){var d=a[b];d.sort(ku(b,k));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return db(a,function(a){return cb(a,function(a){var b={v:a.value,o:a.order};a.xh&&(b.s=a.scheme);if(a.id||a.lang){var c=l[a.id];if(c||a.lang)a.lang&&(a={name:hu,value:a.lang,lang:null,id:null,Se:a.id,scheme:null,order:a.order},c?c.push(a):c=[a]),c=bb(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=
a[2]?f[a[2]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in gu)f[g]=gu[g];for(;g=b.match(/^\s*([A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/);)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=gu;var h=1;g=wk(xk(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),order:h++,Se:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:gu.dcterms+a.localName,order:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Se:null,scheme:null};return null});var l=bb(g,function(a){return a.Se});g=d(bb(g,function(a){return a.Se?null:a.name}));var k=null;g[hu]&&(k=g[hu][0].v);c(g);return g}function mu(){var a=window.MathJax;return a?a.Hub:null}var nu={"application/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function Zt(a,b){this.g=a;this.B=this.f=this.b=this.l=this.h=null;this.N=b;this.H=null;this.Y={};this.lang=null;this.j=0;this.D=!1;this.J=!0;this.u=null;this.Gb={};this.Z=this.uc=this.pf=null;this.S={};this.G=null;this.F=ou(this);mu()&&(Ih["http://www.w3.org/1998/Math/MathML"]=!0)}
function ou(a){function b(){}b.prototype.Ue=function(a,b){return"viv-id-"+Fa(b+(a?"#"+a:""),":")};b.prototype.nc=function(b,d){var c=b.match(/^([^#]*)#?(.*)$/);if(c){var f=c[1]||d,c=c[2];if(f&&a.l.some(function(a){return a.src===f}))return"#"+this.Ue(c,f)}return b};b.prototype.Og=function(a){"#"===a.charAt(0)&&(a=a.substring(1));a.indexOf("viv-id-")||(a=a.substring(7));return(a=Wa(a).match(/^([^#]*)#?(.*)$/))?[a[1],a[2]]:[]};return new b}
function pu(a,b){if(a.N){var c=Aa("",a.N);if(b===c)return"";"/"!=c.charAt(c.length-1)&&(c+="/");return b.substr(0,c.length)==c?decodeURI(b.substr(c.length)):null}return b}
function bu(a,b,c,d,e){a.h=b;var f=ek(new fk([b.b]),"package"),g=yk(f,"unique-identifier")[0];g&&(g=lk(b,b.url+"#"+g))&&(a.H=g.textContent.replace(/[ \n\r\t]/g,""));var h={};a.l=cb(ek(ek(f,"manifest"),"item").X,function(c){var d=new du,e=b.url;d.id=c.getAttribute("id");d.src=Aa(c.getAttribute("href"),e);d.g=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.j=f}(c=c.getAttribute("fallback"))&&!nu[d.g]&&(h[d.src]=c);!a.uc&&
d.j.nav&&(a.uc=d);!a.Z&&d.j["cover-image"]&&(a.Z=d);return d});a.f=$a(a.l,eu);a.B=$a(a.l,function(b){return pu(a,b.src)});for(var l in h)for(g=l;;){g=a.f[h[g]];if(!g)break;if(nu[g.g]){a.S[l]=g.src;break}g=g.src}a.b=cb(ek(ek(f,"spine"),"itemref").X,function(b,c){var d=b.getAttribute("idref");if(d=a.f[d])d.h=b,d.O=c;return d});if(l=yk(ek(f,"spine"),"toc")[0])a.pf=a.f[l];if(l=yk(ek(f,"spine"),"page-progression-direction")[0]){a:switch(l){case "ltr":l="ltr";break a;case "rtl":l="rtl";break a;default:throw Error("unknown PageProgression: "+
l);}a.G=l}var g=c?yk(ek(ek(uk(ek(ek(new fk([c.b]),"encryption"),"EncryptedData"),tk()),"CipherData"),"CipherReference"),"URI"):[],k=ek(ek(f,"bindings"),"mediaType").X;for(c=0;c<k.length;c++){var m=k[c].getAttribute("handler");(l=k[c].getAttribute("media-type"))&&m&&a.f[m]&&(a.Y[l]=a.f[m].src)}a.Gb=lu(ek(f,"metadata"),yk(f,"prefix")[0]);a.Gb[hu]&&(a.lang=a.Gb[hu][0].v);a.Gb[ju]&&(a.D="pre-paginated"===a.Gb[ju][0].v);if(!d){if(0<g.length&&a.H)for(d=fu(a.H),c=0;c<g.length;c++)a.g.B[a.N+g[c]]=d;a.D&&
qu(a);return M(!0)}f=new Qa;k={};if(0<g.length&&a.H)for(l="1040:"+Rt(a.H),c=0;c<g.length;c++)k[g[c]]=l;for(c=0;c<d.length;c++){var p=d[c];if(m=p.n){var q=decodeURI(m),g=a.B[q];l=null;g&&(g.u=0!=p.m,g.l=p.c,g.g&&(l=g.g.replace(/\s+/g,"")));g=k[q];if(l||g)f.append(m),f.append(" "),f.append(l||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}qu(a);return uf(e,"","POST",f.toString(),"text/plain")}
function qu(a){for(var b=0,c=t(a.b),d=c.next();!d.done;d=c.next()){var d=d.value,e=a.D?1:Math.ceil(d.l/1024);d.b=b;d.f=e;b+=e}a.j=b;a.u&&a.u(a.j)}function ru(a,b){a.J=b||a.D}
function su(a,b){a.u=b;if(a.J)return a.D&&!a.j&&qu(a),M(!0);var c=0,d=0,e=L("countEPages");Ee(function(b){if(d===a.b.length)Q(b);else{var e=a.b[d++];e.b=c;a.g.load(e.src).then(function(d){var f=1800,g=d.lang||a.lang;g&&g.match(/^(ja|ko|zh)/)&&(f/=3);e.f=Math.ceil(ik(d)/f);c+=e.f;a.j=c;a.u&&a.u(a.j);P(b)})}}).Ea(e);return e.result()}
function tu(a,b,c){a.f={};a.B={};a.l=[];a.b=a.l;var d=a.h=new dk(null,"",(new DOMParser).parseFromString("<spine></spine>","text/xml"));b.forEach(function(a){var b=new du;b.O=a.index;b.id="item"+(a.index+1);b.src=a.url;b.wb=a.wb;b.mc=a.mc;var c=d.b.createElement("itemref");c.setAttribute("idref",b.id);d.root.appendChild(c);b.h=c;this.f[b.id]=b;c=pu(this,a.url);null==c&&(c=a.url);this.B[c]=b;this.l.push(b)},a);return c?cu(a.g,b[0].url,c):M(null)}
function $t(a,b,c){b.Ng&&(a.G=b.Ng);void 0===a.Gb&&(a.Gb={});var d=c&&c.title||b.name||b.Gb&&b.Gb.title;d&&(a.Gb[iu]=[{yh:d}]);var e=pu(a,a.N);!b.Yd&&c&&(b.Yd=[e],(c=c.querySelector("[role=doc-toc]")||c.querySelector("[role=directory], nav, .toc, #toc"))&&Array.from(c.querySelectorAll("a[href]")).forEach(function(c){c=pu(a,xa(c.href));-1==b.Yd.indexOf(c)&&b.Yd.push(c)}));var f=[],g=0,h=-1;[b.Yd,b.$d].forEach(function(c){c instanceof Array&&c.forEach(function(d){var e="string"===typeof d?d:d.url||
d.href;if(c===b.Yd||/\.(x?html|htm|xht)$/.test(e))e={url:Aa(Ba(e),a.N),index:g++,wb:null,mc:null},"contents"===d.rel&&-1===h&&(h=e.index),f.push(e)})});var l=L("initWithWebPubManifest");tu(a,f).then(function(){-1!==h&&(a.uc=a.l[h]);a.uc||(a.uc=a.B[e]);O(l,!0)});return l.result()}function uu(a,b,c){var d=a.b[b],e=L("getCFI");a.g.load(d.src).then(function(a){var b=jk(a,c),f=null;b&&(a=hk(a,b,0,!1),f=new tb,wb(f,b,c-a),d.h&&wb(f,d.h,0),f=f.toString());O(e,f)});return e.result()}
function vu(a,b){return me("resolveFragment",function(c){if(b){var d=new tb;ub(d,b);var e;if(a.h){var f=vb(d,a.h.b);if(1!=f.node.nodeType||f.K||!f.sd){O(c,null);return}var g=f.node,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.f[h]){O(c,null);return}e=a.f[h];d=f.sd}else e=a.b[0];a.g.load(e.src).then(function(a){var b=vb(d,a.b);a=hk(a,b.node,b.offset,b.K);O(c,{O:e.O,Fa:a,aa:-1})})}else O(c,null)},function(a,d){w.b(d,"Cannot resolve fragment:",b);O(a,null)})}
function wu(a,b){return me("resolveEPage",function(c){if(0>=b)O(c,{O:0,Fa:0,aa:-1});else if(a.J){var d=a.b.findIndex(function(a){return!a.b&&!a.f||a.b<=b&&a.b+a.f>b});-1==d&&(d=a.b.length-1);var e=a.b[d];e&&e.f||(e=a.b[--d]);O(c,{O:d,Fa:-1,aa:Math.floor(b-e.b)})}else{var f=Ya(a.b.length,function(c){c=a.b[c];return c.b+c.f>b});f==a.b.length&&f--;var g=a.b[f];a.g.load(g.src).then(function(a){b-=g.b;b>g.f&&(b=g.f);var d=0;0<b&&(a=ik(a),d=Math.round(a*b/g.f),d==a&&d--);O(c,{O:f,Fa:d,aa:-1})})}},function(a,
d){w.b(d,"Cannot resolve epage:",b);O(a,null)})}function xu(a,b){var c=a.b[b.O];if(a.J)return M(c.b+b.aa);if(0>=b.Fa)return M(c.b);var d=L("getEPage");a.g.load(c.src).then(function(a){a=ik(a);O(d,c.b+Math.min(a,b.Fa)*c.f/a)});return d.result()}function yu(a,b){return{page:a,position:{O:a.O,aa:b,Fa:a.offset}}}function zu(a,b,c,d,e){this.R=a;this.viewport=b;this.j=c;this.l=e;this.Ib=[];this.g=[];this.$=yb(d);this.h=new Xr(b);this.f=new Yp(a.F);this.zf=!1}
function Au(a,b){var c=a.Ib[b.O];return c?c.Ka[b.aa]:null}n=zu.prototype;n.ec=function(a){return this.R.G?this.R.G:(a=this.Ib[a?a.O:0])?a.nb.H:null};
function Bu(a,b,c,d){c.I.style.display="none";c.I.style.visibility="visible";c.I.style.position="";c.I.style.top="";c.I.style.left="";c.I.setAttribute("data-vivliostyle-page-side",c.b);var e=b.Ka[d];c.u=!b.item.O&&!d;b.Ka[d]=c;if(a.R.J){if(!d&&0<b.item.O){var f=a.R.b[b.item.O-1];b.item.b=f.b+f.f}b.item.f=b.Ka.length;a.R.j=a.R.b.reduce(function(a,b){return a+b.f},0);a.R.u&&a.R.u(a.R.j)}if(e)b.nb.viewport.f.replaceChild(c.I,e.I),fb(e,{type:"replaced",target:null,currentTarget:null,dg:c});else{e=null;
if(0<d)e=b.Ka[d-1].I.nextElementSibling;else for(f=b.item.O+1;f<a.Ib.length;f++){var g=a.Ib[f];if(g&&g.Ka[0]){e=g.Ka[0].I;break}}b.nb.viewport.f.insertBefore(c.I,e)}a.l({width:b.nb.Ba,height:b.nb.ua},b.nb.ob,b.item.O,b.nb.ta+d)}
function Cu(a,b,c){var d=L("renderSinglePage"),e=Du(a,b,c);Et(b.nb,e,c).then(function(f){var g=(c=f)?c.page-1:b.jb.length-1;Bu(a,b,e,g);bq(a.f,e.O,g);f=null;if(c){var h=b.jb[c.page];b.jb[c.page]=c;h&&b.Ka[c.page]&&(pl(c,h)||(f=Cu(a,b,c)))}f||(f=M(!0));f.then(function(){var f=cq(a.f,e),h=0;Ee(function(b){h++;if(h>f.length)Q(b);else{var c=f[h-1];c.Zd=c.Zd.filter(function(a){return!a.ud});c.Zd.length?Eu(a,c.O).then(function(d){d?(aq(a.f,c.Oe),dq(a.f,c.Zd),Cu(a,d,d.jb[c.aa]).then(function(c){var d=a.f;
d.b=d.F.pop();d=a.f;d.g=d.H.pop();d=c.Xd.position;d.O===e.O&&d.aa===g&&(e=c.Xd.page);P(b)})):P(b)}):P(b)}}).then(function(){e.I.parentElement||(e=b.Ka[g]);e.B=!c&&b.item.O===a.R.b.length-1;e.B&&fq(a.f,a.viewport);O(d,{Xd:yu(e,g),eg:c})})})});return d.result()}
function Fu(a,b){var c=a.aa,d=-1;0>c?(d=a.Fa,c=Ya(b.jb.length,function(a){return st(b.nb,b.jb[a],!0)>d}),c=c===b.jb.length?b.complete?b.jb.length-1:Number.POSITIVE_INFINITY:c-1):c===Number.POSITIVE_INFINITY&&-1!==a.Fa&&(d=a.Fa);return{O:a.O,aa:c,Fa:d}}
function Gu(a,b,c){var d=L("findPage");Eu(a,b.O).then(function(e){if(e){var f=null,g;Ee(function(d){var h=Fu(b,e);g=h.aa;(f=e.Ka[g])?Q(d):e.complete?(g=e.jb.length-1,f=e.Ka[g],Q(d)):c?Hu(a,h).then(function(a){a&&(f=a.page,g=a.position.aa);Q(d)}):Ce(100).then(function(){P(d)})}).then(function(){O(d,yu(f,g))})}else O(d,null)});return d.result()}
function Hu(a,b){var c=L("renderPage");Eu(a,b.O).then(function(d){if(d){var e=Fu(b,d),f=e.aa,g=e.Fa,h=d.Ka[f];h?O(c,yu(h,f)):Ee(function(b){if(f<d.jb.length)Q(b);else if(d.complete)f=d.jb.length-1,Q(b);else{var c=d.jb[d.jb.length-1];Cu(a,d,c).then(function(a){var e=a.Xd.page;(c=a.eg)?0<=g&&st(d.nb,c)>g?(h=e,f=d.jb.length-2,Q(b)):P(b):(h=e,f=a.Xd.position.aa,d.complete=!0,Q(b))})}}).then(function(){h=h||d.Ka[f];var b=d.jb[f];h?O(c,yu(h,f)):Cu(a,d,b).then(function(a){a.eg||(d.complete=!0);O(c,a.Xd)})})}else O(c,
null)});return c.result()}n.Sb=function(){return Iu(this,{O:this.R.b.length-1,aa:Number.POSITIVE_INFINITY,Fa:-1},!1)};function Iu(a,b,c){var d=L("renderPagesUpto");b||(b={O:0,aa:0,Fa:0});var e=b.O,f=b.aa,g=0;c&&(g=e);var h;Ee(function(c){Hu(a,{O:g,aa:g===e?f:Number.POSITIVE_INFINITY,Fa:g===e?b.Fa:-1}).then(function(a){h=a;++g>e?Q(c):P(c)})}).then(function(){O(d,h)});return d.result()}n.Ag=function(a,b){return Gu(this,{O:0,aa:0,Fa:-1},b)};
n.Dg=function(a,b){return Gu(this,{O:this.R.b.length-1,aa:Number.POSITIVE_INFINITY,Fa:-1},b)};n.nextPage=function(a,b){var c=this,d=this,e=a.O,f=a.aa,g=L("nextPage");Eu(d,e).then(function(a){if(a){if(a.complete&&f==a.jb.length-1){if(e>=d.R.b.length-1){O(g,null);return}e++;f=0;var h=c.Ib[e],k=h&&h.Ka[0];a=a.Ka[a.Ka.length-1];k&&a&&k.b==a.b&&(h.Ka.forEach(function(a){a.I&&a.I.remove()}),c.Ib[e]=null,c.g[e]=null)}else f++;Gu(d,{O:e,aa:f,Fa:-1},b).Ea(g)}else O(g,null)});return g.result()};
n.Re=function(a,b){var c=a.O,d=a.aa;if(d)d--;else{if(!c)return M(null);c--;d=Number.POSITIVE_INFINITY}return Gu(this,{O:c,aa:d,Fa:-1},b)};function Ju(a,b,c){b="left"===b.b;a="ltr"===a.ec(c);return!b&&a||b&&!a}function Ku(a,b,c){var d=L("getCurrentSpread"),e=Au(a,b);if(!e)return M({left:null,right:null});var f="left"===e.b;(Ju(a,e,b)?a.Re(b,c):a.nextPage(b,c)).then(function(c){var e=Au(a,b);(c=c&&c.page)&&c.b===e.b&&(c=null);f?O(d,{left:e,right:c}):O(d,{left:c,right:e})});return d.result()}
n.Jg=function(a,b){var c=Au(this,a);if(!c)return M(null);var d=Ju(this,c,a),e=this.nextPage(a,b);if(d)return e;var f=this;return e.da(function(a){if(a){if(a.page.b===c.b)return e;var d=f.nextPage(a.position,b);return d.da(function(a){return a?d:e})}return M(null)})};n.Mg=function(a,b){var c=Au(this,a);if(!c)return M(null);var d=Ju(this,c,a),e=this.Re(a,b),f=c.I.previousElementSibling;if(d){var g=this;return e.da(function(a){return a?a.page.b===c.b||a.page.I!==f?e:g.Re(a.position,b):M(null)})}return e};
function Lu(a,b,c){var d=L("navigateToEPage");wu(a.R,b).then(function(b){b?Gu(a,b,c).Ea(d):O(d,null)});return d.result()}function Mu(a,b,c){var d=L("navigateToCFI");vu(a.R,b).then(function(b){b?Gu(a,b,c).Ea(d):O(d,null)});return d.result()}
function Nu(a,b,c,d){w.debug("Navigate to",b);var e=pu(a.R,xa(b));if(!e){if(a.R.h&&b.match(/^#epubcfi\(/))e=pu(a.R,a.R.h.url);else if("#"===b.charAt(0)){var f=a.R.F.Og(b);a.R.h?e=pu(a.R,f[0]):e=f[0];b=f[0]+(f[1]?"#"+f[1]:"")}if(null==e)return M(null)}var g=a.R.B[e];if(!g)return a.R.h&&e==pu(a.R,a.R.h.url)&&(e=b.indexOf("#"),0<=e)?Mu(a,b.substr(e+1),d):M(null);var h=L("navigateTo");Eu(a,g.O).then(function(e){if(e){var f=lk(e.ca,b);f?Gu(a,{O:g.O,aa:-1,Fa:gk(e.ca,f)},d).Ea(h):c.O!==g.O?Gu(a,{O:g.O,aa:0,
Fa:-1},d).Ea(h):O(h,null)}else O(h,null)});return h.result()}
function Du(a,b,c){var d=b.nb.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.setAttribute("role","region");e.style.position="absolute";e.style.top="0";e.style.left="0";Zj||(e.style.visibility="hidden",e.setAttribute("aria-hidden","true"));d.h.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);var g=new Ek(e,f);g.O=b.item.O;g.position=c;g.offset=st(b.nb,c);g.offset||(b=a.R.F.Ue("",b.item.src),f.setAttribute("id",
...
n.Je=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=Aa(f,a.url),g=c.getAttribute("media-type");if(!g){var h=pu(b.R,f);h&&(h=b.R.B[h])&&(g=h.g)}if(g&&(h=b.R.Y[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Ua(f),l=Ua(g),g=new Qa;g.append(h);g.append("?src=");g.append(f);g.append("&type=");g.append(l);for(h=c.firstChild;h;h=h.nextSibling)1==h.nodeType&&
...
function Eu(a,b){if(-1===b||b>=a.R.b.length)return M(null);var c=a.Ib[b];if(c)return M(c);var d=L("getPageViewItem"),e=a.g[b];if(e){var f=we(d);e.push(f);return d.result()}var e=a.g[b]=[],g=a.R.b[b],h=a.R.g;h.load(g.src).then(function(f){g.title=f.b.title;var k=h.f[f.url],l=a.Je(f),p=a.viewport,q=ot(k,p.width,p.height,p.fontSize,a.$);if(q.width!=p.width||q.height!=p.height||q.fontSize!=p.fontSize)p=new Zr(p.window,q.fontSize,p.root,q.width,q.height);q=a.Ib[b-1];null!==g.wb?q=g.wb-1:(!(0<b)||q&&q.complete?
q=q?q.nb.ta+q.Ka.length:0:(q=g.b||b,a.R.D||q%2||q++),null!==g.mc&&(q+=g.mc));Zp(a.f,q);var r=new pt(k,f,a.R.lang,p,a.h,a.j,l,a.R.S,q,a.R.F,a.f,a.R.G);r.$=a.$;qt(r).then(function(){c={item:g,ca:f,nb:r,jb:[null],Ka:[],complete:!1};a.Ib[b]=c;O(d,c);e.forEach(function(a){a.tb(c)})})});return d.result()}function Qu(a){return a.Ib.some(function(a){return a&&0<a.Ka.length})}
n.Uc=function(a){var b=this.R,c=b.uc||b.pf;this.zf=a;if(!c)return M(null);if(this.b&&this.b.page)return this.b.page.I.style.visibility="visible",this.b.page.I.setAttribute("aria-hidden","false"),M(this.b.page);var d=L("showTOC");this.b||(this.b=new St(b.g,c.src,b.lang,this.h,this.j,this.$,this,b.S,b.F,this.f));a=this.viewport;var b=Math.min(350,Math.round(.67*a.width)-16),c=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.visibility="hidden";e.style.width=b+10+"px";e.style.maxHeight=
c+"px";e.setAttribute("data-vivliostyle-toc-box","true");e.setAttribute("role","navigation");this.b.Uc(e,a,b,c,this.viewport.fontSize).then(function(a){e.style.visibility="visible";e.setAttribute("aria-hidden","false");O(d,a)});return d.result()};n.Td=function(){this.b&&this.b.Td()};n.Rc=function(){return!!this.b&&this.b.Rc()};var Ru={jh:"singlePage",kh:"spread",Zg:"autoSpread"};
function Su(a,b,c,d){var e=this;this.window=a;this.je=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);Zj&&b.setAttribute("data-vivliostyle-debug",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Ba=c;this.ua=d;a=a.document;this.sa=new vm(a.head,b);this.u="loading";this.J=[];this.R=null;this.gc=this.Ya=!1;this.f=this.j=this.g=this.B=null;this.fontSize=16;this.zoom=1;this.D=!1;this.S="singlePage";this.ha=!1;this.Sb=!0;this.$=xb();this.Z=[];this.H=function(){};this.h=function(){};
this.Y=function(){e.Ya=!0;e.H()};this.Pe=this.Pe.bind(this);this.F=function(){};this.G=a.getElementById("vivliostyle-page-rules");this.N=!1;this.l=null;this.oa={loadEPUB:this.ug,loadXML:this.vg,configure:this.cf,moveTo:this.ta,toc:this.Uc};Tu(this)}function Tu(a){wa(1,function(b){Uu(a,{t:"debug",content:b})});wa(2,function(b){Uu(a,{t:"info",content:b})});wa(3,function(b){Uu(a,{t:"warn",content:b})});wa(4,function(b){Uu(a,{t:"error",content:b})})}function Uu(a,b){b.i=a.Ba;a.ua(b)}
function Vu(a,b){a.u!==b&&(a.u=b,a.je.setAttribute("data-vivliostyle-viewer-status",b),Uu(a,{t:"readystatechange"}))}n=Su.prototype;
n.ug=function(a){Wu.f("beforeRender");Vu(this,"loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=L("loadEPUB"),h=this;h.cf(a).then(function(){var a=new Vt;Mt(a,e,f).then(function(){var e=Aa(Ba(b),h.window.location.href);h.J=[e];Xt(a,e,d).then(function(a){a?(h.R=a,Xu(h,c).then(function(){O(g,!0)})):O(g,!1)})})});return g.result()};
n.vg=function(a){Wu.f("beforeRender");Vu(this,"loading");var b=a.url,c=a.document,d=a.fragment,e=a.authorStyleSheet,f=a.userStyleSheet;this.viewport=null;var g=L("loadXML"),h=this;h.cf(a).then(function(){var a=new Vt;Mt(a,e,f).then(function(){var e=b.map(function(a,b){return{url:Aa(Ba(a.url),h.window.location.href),index:b,wb:a.wb,mc:a.mc}});h.J=e.map(function(a){return a.url});h.R=new Zt(a,"");tu(h.R,e,c).then(function(){Xu(h,d).then(function(){O(g,!0)})})})});return g.result()};
function Xu(a,b){Yu(a);var c;b?c=vu(a.R,b).da(function(b){a.f=b;return M(!0)}):c=M(!0);return c.da(function(){Wu.b("beforeRender");return Zu(a)})}function $u(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d)return c*Nb.ex*a.fontSize/Nb.em;if(d=Nb[d])return c*d}return c}
n.cf=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.B=null,this.window.addEventListener("resize",this.Y,!1),this.Ya=!0):this.window.removeEventListener("resize",this.Y,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.Ya=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:$u(this,b["margin-left"])||0,marginRight:$u(this,b["margin-right"])||0,marginTop:$u(this,b["margin-top"])||0,marginBottom:$u(this,b["margin-bottom"])||
0,width:$u(this,b.width)||0,height:$u(this,b.height)||0},200<=b.width||200<=b.height)&&(this.window.removeEventListener("resize",this.Y,!1),this.B=b,this.Ya=!0);"boolean"==typeof a.hyphenate&&(this.$.Ae=a.hyphenate,this.Ya=!0);"boolean"==typeof a.horizontal&&(this.$.ze=a.horizontal,this.Ya=!0);"boolean"==typeof a.nightMode&&(this.$.Le=a.nightMode,this.Ya=!0);"number"==typeof a.lineHeight&&(this.$.lineHeight=a.lineHeight,this.Ya=!0);"number"==typeof a.columnWidth&&(this.$.se=a.columnWidth,this.Ya=
!0);"string"==typeof a.fontFamily&&(this.$.fontFamily=a.fontFamily,this.Ya=!0);"boolean"==typeof a.load&&(this.ha=a.load);"boolean"==typeof a.renderAllPages&&(this.Sb=a.renderAllPages);"string"==typeof a.userAgentRootURL&&(ya=a.userAgentRootURL.replace(/resources\/?$/,""),za=a.userAgentRootURL);"string"==typeof a.rootURL&&(ya=a.rootURL,za=ya+"resources/");"string"==typeof a.pageViewMode&&a.pageViewMode!==this.S&&(this.S=a.pageViewMode,this.Ya=!0);"number"==typeof a.pageBorder&&a.pageBorder!==this.$.Dc&&
(this.viewport=null,this.$.Dc=a.pageBorder,this.Ya=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=a.zoom,this.gc=!0);"boolean"==typeof a.fitToScreen&&a.fitToScreen!==this.D&&(this.D=a.fitToScreen,this.gc=!0);"object"==typeof a.defaultPaperSize&&"number"==typeof a.defaultPaperSize.width&&"number"==typeof a.defaultPaperSize.height&&(this.viewport=null,this.$.vc=a.defaultPaperSize,this.Ya=!0);av(this,a);return M(!0)};
function av(a,b){ge("CONFIGURATION").forEach(function(c){c=c(b);a.Ya=c.Ya||a.Ya;a.gc=c.gc||a.gc})}n.Pe=function(a){var b=this.g,c=this.j,d=a.target;c?c.left!==d&&c.right!==d||bv(this,a.dg):b===a.target&&bv(this,a.dg)};function cv(a,b){var c=[];a.g&&c.push(a.g);a.j&&(c.push(a.j.left),c.push(a.j.right));c.forEach(function(a){a&&b(a)})}function dv(a){cv(a,function(b){b.removeEventListener("hyperlink",a.F,!1);b.removeEventListener("replaced",a.Pe,!1)})}
function ev(a){dv(a);cv(a,function(a){x(a.I,"display","none");a.I.setAttribute("aria-hidden","true")});a.g=null;a.j=null}function fv(a,b){b.addEventListener("hyperlink",a.F,!1);b.addEventListener("replaced",a.Pe,!1);x(b.I,"visibility","visible");x(b.I,"display","block");b.I.setAttribute("aria-hidden","false")}function gv(a,b){ev(a);a.g=b;fv(a,b)}
function hv(a){var b=L("reportPosition");uu(a.R,a.f.O,a.f.Fa).then(function(c){var d=a.g;(a.ha&&0<d.j.length?Ie(d.j):M(!0)).then(function(){iv(a,d,c).Ea(b)})});return b.result()}function jv(a){var b=a.je;if(a.B){var c=a.B;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new Zr(a.window,a.fontSize,b,c.width,c.height)}return new Zr(a.window,a.fontSize,b)}
function kv(a){var b=jv(a),c;a:switch(a.S){case "singlePage":c=!1;break a;case "spread":c=!0;break a;default:c=1.45<=b.width/b.height&&800<b.width}var d=a.$.ub!==c;a.$.ub=c;a.je.setAttribute("data-vivliostyle-spread-view",c);if(a.B||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;if(!d&&b.width==a.viewport.width&&b.height==a.viewport.height||!d&&b.width==a.viewport.width&&b.height!=a.viewport.height&&/Android|iPhone|iPad|iPod/.test(navigator.userAgent))return!0;if(c=a.b&&Qu(a.b)){a:{c=t(a.b.Ib);
for(d=c.next();!d.done;d=c.next())if(d=d.value)for(var d=t(d.Ka),e=d.next();!e.done;e=d.next())if(e=e.value,e.G&&e.F){c=!0;break a}c=!1}c=!c}return c?(a.viewport.width=b.width,a.viewport.height=b.height,a.gc=!0):!1}n.Pg=function(a,b,c,d){this.Z[d]=a;lv(this,b)};function lv(a,b){if(!a.N&&a.G){var c="";Object.keys(b).forEach(function(a){c+="@page "+a+"{margin:0;size:";a=b[a];c+=a.width+"px "+a.height+"px;}"});a.G.textContent=c;a.N=!0}}
function mv(a){var b=!1,c=!1;if(a.b){b=a.b.Rc();c=a.b.zf;a.b.Td();for(var d=a.b,e=t(d.Ib),f=e.next();!f.done;f=e.next())(f=f.value)&&f.Ka.splice(0);for(d=d.viewport.root;d.lastChild;)d.removeChild(d.lastChild)}a.G&&(a.G.textContent="",a.N=!1);a.viewport=jv(a);d=a.viewport;x(d.g,"width","");x(d.g,"height","");x(d.f,"width","");x(d.f,"height","");x(d.f,"transform","");a.b=new zu(a.R,a.viewport,a.sa,a.$,a.Pg.bind(a));b&&a.h({a:"toc",v:"show",autohide:c})}
function bv(a,b,c){a.gc=!1;dv(a);if(a.$.ub)return Ku(a.b,a.f,c).da(function(c){ev(a);a.j=c;c.left&&(fv(a,c.left),c.right?c.left.I.removeAttribute("data-vivliostyle-unpaired-page"):c.left.I.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(fv(a,c.right),c.left?c.right.I.removeAttribute("data-vivliostyle-unpaired-page"):c.right.I.setAttribute("data-vivliostyle-unpaired-page",!0));c=nv(a,c);a.viewport.zoom(c.width,c.height,a.D?ov(a,c):a.zoom);a.g=b;return M(null)});gv(a,b);a.viewport.zoom(b.g.width,
b.g.height,a.D?ov(a,b.g):a.zoom);a.g=b;return M(null)}function nv(a,b){var c=0,d=0;b.left&&(c+=b.left.g.width,d=b.left.g.height);b.right&&(c+=b.right.g.width,d=Math.max(d,b.right.g.height));b.left&&b.right&&(c+=2*a.$.Dc);return{width:c,height:d}}var pv={eh:"fit inside viewport"};function ov(a,b){return Math.min(a.viewport.width/b.width,a.viewport.height/b.height)}function qv(){this.name="RenderingCanceledError";this.message="Page rendering has been canceled";this.stack=Error().stack}v(qv,Error);
function Yu(a){if(a.l){var b=a.l;ne(b,new qv);if(b!==he&&b.b){b.b.g=!0;var c=new xe(b);b.l="interrupt";b.b=c;b.f.tb(c)}}a.l=null}
function Zu(a){a.Ya=!1;a.gc=!1;if(kv(a))return M(!0);Vu(a,"loading");Yu(a);var b=pe(he.f,function(){return me("resize",function(c){a.R?(a.l=b,Wu.f("render (resize)"),mv(a),a.f&&(a.f.aa=-1),ru(a.R,a.Sb),Iu(a.b,a.f,!a.Sb).then(function(d){a.f=d.position;bv(a,d.page,!0).then(function(){Vu(a,"interactive");su(a.R,function(b){b={t:"nav",epageCount:b,first:a.g.u,last:a.g.B,metadata:a.R.Gb,itemTitle:a.R.b[a.f.O].title};if(a.g.u||!a.f.aa&&a.R.b[a.f.O].b)b.epage=a.R.b[a.f.O].b;Uu(a,b)}).then(function(){hv(a).then(function(d){(a.Sb?
a.b.Sb():M(null)).then(function(){a.l===b&&(a.l=null);Wu.b("render (resize)");a.Sb&&Vu(a,"complete");Uu(a,{t:"loaded"});O(c,d)})})})})})):O(c,!1)},function(a,b){if(b instanceof qv)Wu.b("render (resize)"),w.debug(b.message);else throw b;})});return M(!0)}function iv(a,b,c){var d=L("sendLocationNotification"),e={t:"nav",first:b.u,last:b.B,metadata:a.R.Gb,itemTitle:a.R.b[b.O].title};xu(a.R,a.f).then(function(b){e.epage=b;e.epageCount=a.R.j;c&&(e.cfi=c);Uu(a,e);O(d,!0)});return d.result()}
Su.prototype.ec=function(){return this.b?this.b.ec(this.f):null};
Su.prototype.ta=function(a){var b=this;"complete"!==this.u&&"next"!==a.where&&Vu(this,"loading");if("string"==typeof a.where){switch(a.where){case "next":a=this.$.ub?this.b.Jg:this.b.nextPage;break;case "previous":a=this.$.ub?this.b.Mg:this.b.Re;break;case "last":a=this.b.Dg;break;case "first":a=this.b.Ag;break;default:return M(!0)}if(a){var c=a;a=function(){return c.call(b.b,b.f,!b.Sb)}}}else if("number"==typeof a.epage){var d=a.epage;a=function(){return Lu(b.b,d,!b.Sb)}}else if("string"==typeof a.url){var e=
a.url;a=function(){return Nu(b.b,e,b.f,!b.Sb)}}else return M(!0);var f=L("moveTo");a.call(b.b).then(function(a){var c;if(a){b.f=a.position;var d=L("moveTo.showCurrent");c=d.result();bv(b,a.page,!b.Sb).then(function(){hv(b).Ea(d)})}else c=M(!0);c.then(function(a){"loading"===b.u&&Vu(b,"interactive");O(f,a)})});return f.result()};
Su.prototype.Uc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.Rc(),d=b!=this.b.zf&&"hide"!=a;if(c){if("show"==a&&!d)return M(!0)}else if("hide"==a)return M(!0);if(c&&"show"!=a)return this.b.Td(),M(!0);var e=this,f=L("showTOC");this.b.Uc(b).then(function(a){a&&(d&&(a.Qb={}),b&&a.addEventListener("hyperlink",function(){e.b.Td()},!1),a.addEventListener("hyperlink",e.F,!1));O(f,!0)});return f.result()};
function rv(a,b){var c=b.a||"";return me("runCommand",function(d){var e=a.oa[c];e?e.call(a,b).then(function(){Uu(a,{t:"done",a:c});O(d,!0)}):(w.error("No such action:",c),O(d,!0))},function(a,b){w.error(b,"Error during action:",c);O(a,!0)})}function sv(a){return"string"==typeof a?JSON.parse(a):a}
function tv(a,b){var c=sv(b),d=null;oe(function(){var b=L("commandLoop"),f=he.f;a.F=function(b){var c="#"===b.href.charAt(0)||a.J.some(function(a){return b.href.substr(0,a.length)==a});if(c){b.preventDefault();var d={t:"hyperlink",href:b.href,internal:c};pe(f,function(){Uu(a,d);return M(!0)})}};Ee(function(b){if(a.Ya)Zu(a).then(function(){P(b)});else if(a.gc)a.g&&bv(a,a.g).then(function(){P(b)});else if(c){var e=c;c=null;rv(a,e).then(function(){P(b)})}else e=L("waitForCommand"),d=we(e,self),e.result().then(function(){P(b)})}).Ea(b);
...
function Cv(a,b,c){for(c=b+c-1;0<=c&&c>=b-1;c--)if(c+1<a.length){var d=a[c],e=a[c+1];d[0]===e[1]&&a.splice(c,2,[d[0],d[1]+e[1]])}return a};function Qr(a){return a.reduce(function(a,c){return c[0]===Rr.b?a:a+c[1]},"")}function fl(a,b,c){var d=0,e=0;a.some(function(a){for(var f=0;f<a[1].length;f++){switch(a[0]*c){case Rr.f:d++;break;case Rr.b:d--;e++;break;case Rr.g:e++}if(e>b)return!0}return!1});return Math.max(Math.min(b,e-1)+d,0)};function Dv(a,b,c,d,e){Xm.call(this,a,b,"block-end",null,c,e);this.g=d}v(Dv,Xm);Dv.prototype.gf=function(a){return!(a instanceof Dv)};function Ev(a,b,c,d){$m.call(this,a,"block-end",b,c,d)}v(Ev,$m);Ev.prototype.Ia=function(){return Infinity};Ev.prototype.f=function(a){return a instanceof Dv?!0:this.Ia()<a.Ia()};function Fv(a){this.f=a}Fv.prototype.b=function(a){a=el(a);return!Tk(a,this.f.b)};function Gv(){}n=Gv.prototype;n.If=function(a){return"footnote"===a.Ca};
n.Hf=function(a){return a instanceof Dv};n.Of=function(a,b){var c="region",d=jn(b,c);Fn(jn(b,"page"),d)&&(c="page");d=el(a);c=new Dv(d,c,b.h,a.Y,a.N);b.oe(c);return M(c)};n.Pf=function(a,b,c,d){return new Ev(a[0].ja.W,a,c,d)};n.Af=function(a,b){return jn(b,a.W).b.filter(function(a){return a instanceof Ev})[0]||null};
n.Ef=function(a,b,c){a.cg=!0;a.ye=!1;var d=a.element,e=c.j;b=b.b;var f=c.j.w&&"rtl"===c.j.w.direction,g={},h=e.B._pseudos;b=vr(e,b,f,e.B,g);if(h&&h.before){var l={},k=Hr(e,"http://www.w3.org/1999/xhtml","span");or(k,"before");d.appendChild(k);vr(e,b,f,h.before,l);delete l.content;Kr(e,k,l)}delete g.content;Kr(e,d,g);a.b=b;Mp(a,d);if(e=Pn(c.f,d))a.marginLeft=X(e.marginLeft),a.Z=X(e.borderLeftWidth),a.H=X(e.paddingLeft),a.marginTop=X(e.marginTop),a.ha=X(e.borderTopWidth),a.J=X(e.paddingTop),a.marginRight=
X(e.marginRight),a.Za=X(e.borderRightWidth),a.Y=X(e.paddingRight),a.marginBottom=X(e.marginBottom),a.Ba=X(e.borderBottomWidth),a.S=X(e.paddingBottom);if(c=Pn(c.f,d))a.width=X(c.width),a.height=X(c.height)};n.rg=function(a,b){switch(a.g){case zd:$n(b,new Fv(a),a.W)}};co.push(new Gv);function Hv(a){return a.reduce(function(a,c){return a+c},0)/a.length}function it(a){var b=Hv(a);return Hv(a.map(function(a){a-=b;return a*a}))};function Iv(a,b){this.g(a,"end",b)}function Jv(a,b){this.g(a,"start",b)}function Kv(a,b,c){c||(c=this.j.now());var d=this.h[a];d||(d=this.h[a]=[]);var e;for(a=d.length-1;0<=a&&(!(e=d[a])||e[b]);a--)e=null;e||(e={},d.push(e));e[b]=c}function Lv(){}function Mv(a){this.j=a;this.h={};this.registerEndTiming=this.b=this.registerStartTiming=this.f=this.g=Lv}
Mv.prototype.l=function(){var a=this.h,b="";Object.keys(a).forEach(function(c){for(var d=a[c],e=d.length,f=0;f<e;f++){var g=d[f];b+=c;1<e&&(b+="("+f+")");b+=" => start: "+g.start+", end: "+g.end+", duration: "+(g.end-g.start)+"\n"}});w.g(b)};Mv.prototype.u=function(){this.registerEndTiming=this.b=this.registerStartTiming=this.f=this.g=Lv};Mv.prototype.B=function(){this.g=Kv;this.registerStartTiming=this.f=Jv;this.registerEndTiming=this.b=Iv};
var Nv={now:Date.now},Wu,Ov=Wu=new Mv(window&&window.performance||Nv);Kv.call(Ov,"load_vivliostyle","start",void 0);na("vivliostyle.profile.profiler",Ov);Mv.prototype.printTimings=Mv.prototype.l;Mv.prototype.disable=Mv.prototype.u;Mv.prototype.enable=Mv.prototype.B;function to(a){return(a=a.C)&&a instanceof yp?a:null}function Pv(a,b,c){var d=a.b;return d&&!d.Bc&&(a=Qv(a,b),a.A)?!d.yc||d.Bc?M(!0):Rv(d,d.yc,a,null,c):M(!0)}function Sv(a,b,c){var d=a.b;return d&&(a=Qv(a,b),a.A)?!d.zc||d.Cc?M(!0):Rv(d,d.zc,a,a.A.firstChild,c):M(!0)}function Tv(a,b){a&&Uv(a.K?a.parent:a,function(a,d){a instanceof xp||b.B.push(new Vv(d))})}function Uv(a,b){for(var c=a;c;c=c.parent){var d=c.C;d&&d instanceof yp&&!il(c,d)&&b(d,c)}}
function yp(a,b){this.parent=a;this.j=b;this.b=null}yp.prototype.Ze=function(){return"Repetitive elements owner formatting context (vivliostyle.repetitiveelements.RepetitiveElementsOwnerFormattingContext)"};yp.prototype.jf=function(a,b){return b};function Wv(a,b){var c=Qv(a,b);return c?c.A:null}function Qv(a,b){do if(!il(b,a)&&b.M===a.j)return b;while(b=b.parent);return null}
function Nr(a,b){a.b||Ip.some(function(b){return b.root===a.j?(a.b=b.elements,!0):!1})||(a.b=new Xv(b,a.j),Ip.push({root:a.j,elements:a.b}))}yp.prototype.af=function(){};yp.prototype.$e=function(){};var Ip=[];function Xv(a,b){this.N=a;this.yc=this.zc=this.u=this.D=this.l=this.B=null;this.G=this.H=0;this.Bc=this.Cc=!1;this.gd=this.ue=!0;this.j=!1;this.Z=b;this.J=this.g=null;this.S=[];this.Y=[]}function Yv(a,b){a.zc||(a.zc=Uk(b),a.B=b.M,a.D=b.A)}function Zv(a,b){a.yc||(a.yc=Uk(b),a.l=b.M,a.u=b.A)}
function Rv(a,b,c,d,e){var f=c.A,g=c.A.ownerDocument.createElement("div");f.appendChild(g);var h=new Hm(e,g,c),l=h.za.g;h.za.g=null;a.h=!0;return Km(h,new jl(b)).da(function(){a.h=!1;f.removeChild(g);if(f)for(;g.firstChild;){var b=g.firstChild;g.removeChild(b);b.setAttribute("data-adapt-spec","1");d?f.insertBefore(b,d):f.appendChild(b)}h.za.g=l;return M(!0)})}Xv.prototype.b=function(a){var b=0;if(a&&!this.f(a))return b;if(!this.Bc||a&&$v(this,a))b+=this.G;this.Cc||(b+=this.H);return b};
...
function bw(a,b,c){for(var d=[];a;a=a.parentNode){if(b.M===a)return b.K;d.push(a)}for(a=b.M;a;a=a.parentNode){var e=d.indexOf(a);if(0<=e)return c?!e:!1;for(e=a;e;e=e.previousElementSibling)if(d.includes(e))return!0}return b.K}function cw(a){return!a.Bc&&a.ue&&a.yc||!a.Cc&&a.gd&&a.zc?!0:!1}function dw(a){this.C=a}dw.prototype.b=function(){};dw.prototype.f=function(a){return!!a};
dw.prototype.g=function(a,b,c,d){(a=this.C.b)&&!a.j&&(a.D&&(a.H=Np(a.D,c,a.N),a.D=null),a.u&&(a.G=Np(a.u,c,a.N),a.u=null),a.j=!0);return d};function ew(a){this.C=a}ew.prototype.b=function(){};ew.prototype.f=function(){return!0};ew.prototype.g=function(a,b,c,d){return d};function fw(a){this.C=a}v(fw,dw);fw.prototype.b=function(a,b){dw.prototype.b.call(this,a,b);var c=L("BlockLayoutProcessor.doInitialLayout");Em(new Dm(new gw(a.C),b.j),a).Ea(c);return c.result()};fw.prototype.f=function(){return!1};
function hw(a){this.C=a}v(hw,ew);hw.prototype.b=function(a,b){il(a,this.C)||a.K||b.B.unshift(new Vv(a));return iw(a,b)};function Vv(a){this.w=Qv(a.C,a)}n=Vv.prototype;n.ne=function(a,b){var c=this.w.C.b;return c&&!Oo(this.w.A)&&cw(c)?b&&!a||a&&a.xa?!1:!0:!0};n.nd=function(){var a=this.w.C.b;return a&&cw(a)?(!a.Bc&&a.ue&&a.yc?a.Bc=!0:!a.Cc&&a.gd&&a.zc&&(a.Cc=!0),!0):!1};n.cd=function(a,b,c,d){(c=this.w.C.b)&&a&&d.u&&(!b||$v(c,b))&&(c.Bc=!1,c.ue=!1)};
n.Na=function(a,b){var c=this.w.C,d=this.w.C.b;if(!d)return M(!0);var e=this.w;return Sv(c,e,b).da(function(){return Pv(c,e,b).da(function(){d.Cc=d.Bc=!1;d.ue=!0;d.gd=!0;return M(!0)})})};n.ve=function(a){return a instanceof Vv?this.w.C===a.w.C:!1};n.xe=function(){return 10};function jw(a){Nm.call(this);this.C=a}v(jw,Nm);jw.prototype.tf=function(a){var b=this.C.b;return il(a,this.C)||b.j?(il(a,this.C)||a.K||!b||(b.Cc=!1,b.gd=!1),new hw(this.C)):new fw(this.C)};function gw(a){this.C=a}v(gw,Gm);
gw.prototype.Bd=function(a){var b=this.C,c=a.w,d=b.b;if(c.parent&&b.j===c.parent.M){switch(c.u){case "header":if(d.zc)c.u="none";else return Yv(d,c),M(!0);break;case "footer":if(d.yc)c.u="none";else return Zv(d,c),M(!0)}d.g||(d.g=c.M)}return Gm.prototype.Bd.call(this,a)};gw.prototype.sc=function(a){var b=this.C,c=a.w;c.M===b.j&&(b.b.J=a.ld&&a.ld.M,a.Wb=!0);return"header"===c.u||"footer"===c.u?M(!0):Gm.prototype.sc.call(this,a)};function kw(){}v(kw,Kp);
kw.prototype.me=function(a,b,c){if(wo(b,a))return Go(b,a);var d=a.C;return Wv(d,a)?(c&&Tv(a.parent,b),il(a,d)?Kp.prototype.me.call(this,a,b,c):Om(new jw(d),a,b)):Io(b,a)};kw.prototype.bf=function(a){var b=to(a).b;if(!b)return!1;b.h||b.B!==a.M&&b.l!==a.M||a.A.parentNode.removeChild(a.A);return!1};
function iw(a,b){var c=a.C,d=L("doLayout"),e=Fm(b.j,a,!1);Ho(e,b).then(function(a){var e=a;Ee(function(a){for(var d={};e;){d.Oa=!0;Ap(b,e,!1).then(function(d){return function(f){e=f;In(b.l)?Q(a):b.g?Q(a):e&&b.u&&e&&e.xa?Q(a):e&&e.K&&e.M==c.j?Q(a):d.Oa?d.Oa=!1:P(a)}}(d));if(d.Oa){d.Oa=!1;return}d={Oa:d.Oa}}Q(a)}).then(function(){O(d,e)})});return d.result()}kw.prototype.Na=function(a,b,c,d){return Kp.prototype.Na.call(this,a,b,c,d)};kw.prototype.Ed=function(a,b,c,d){Kp.prototype.Ed(a,b,c,d)};
function qo(a){for(var b=[],c=a;c;c=c.Md)c.B.forEach(function(c){if(c instanceof Vv){var d=c.w.C.b;b.push(d)}c instanceof lw&&(d=new mw(c.w,c.f),b.push(d));c instanceof nw&&ow(c,a).forEach(function(a){b.push(a)})});return b}var pw=new kw;fe("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof yp&&!(a instanceof xp)?pw:null});function qw(a,b){if(!a||!a.J||a.K||wo(b,a))return M(a);var c=a.J;return rw(c,b,a).da(function(d){var e=a.A;e.appendChild(d);var f=Np(d,b,a.b);e.removeChild(d);b.B.push(new lw(a,c,f));return M(a)})}function sw(a,b,c){this.b=a;this.f=b;this.Ob=c}sw.prototype.matches=function(){var a=tw[this.b];return!!a&&null!=a.Sa&&Bi(a.Sa,this.f,this.Ob)};function tj(a){this.b=a}tj.prototype.matches=function(){return this.b.some(function(a){return a.matches()})};function uj(a){this.b=a}uj.prototype.matches=function(){return this.b.every(function(a){return a.matches()})};
function sj(a,b){var c=b.split("_");if("NFS"==c[0])return new sw(a,parseInt(c[1],10),parseInt(c[2],10));ra("unknown view condition. condition="+b);return null}function Vj(a,b,c){sr(c,function(c){Xj(a,c,b)})}function sr(a,b){var c=a._viewConditionalStyles;c&&c.forEach(function(a){a.Fg.matches()&&b(a.Qg)})}function Dr(a,b,c){var d=tw;if(!d[a]||d[a].cb<=c)d[a]={Sa:b,cb:c}}var tw={};function Mr(a,b){this.b=b;this.M=a}
function rw(a,b,c){var d=c.A.ownerDocument.createElement("div"),e=new Hm(b,d,c),f=e.za.g;e.za.g=null;return Km(e,uw(a)).da(function(){a.b.f["after-if-continues"]=!1;e.za.g=f;var b=d.firstChild;x(b,"display","block");return M(b)})}function uw(a){var b=mr.createElementNS("http://www.w3.org/1999/xhtml","div");or(b,"after-if-continues");a=new Zk(a.M,b,null,null,null,3,a.b);return new jl({pa:[{node:b,kb:a.type,wa:a,Ja:null,Ga:null}],ma:0,K:!1,Qa:null})}function lw(a,b,c){this.w=a;this.b=b;this.f=c}n=lw.prototype;
n.ne=function(a,b){return b&&!a||a&&a.xa?!1:!0};n.nd=function(){return!1};n.cd=function(){};n.Na=function(a,b){var c=this;return(new mw(this.w,this.f)).f(a)?rw(this.b,b,this.w).da(function(a){c.w.A.appendChild(a);return M(!0)}):M(!0)};n.ve=function(a){return a instanceof lw?this.b==a.b:!1};n.xe=function(){return 9};function mw(a,b){this.w=a;this.g=b}mw.prototype.b=function(a){return this.f(a)?this.g:0};mw.prototype.F=function(a){return this.b(a)};
mw.prototype.f=function(a){if(!a)return!1;var b=a.wa?a.wa.na:a.M;if(b===this.w.M)return!!a.K;for(a=b.parentNode;a;a=a.parentNode)if(a===this.w.M)return!0;return!1};function Ho(a,b){return a.da(function(a){return qw(a,b)})}function Jp(a,b){var c=L("vivliostyle.selectors.processAfterIfContinuesOfAncestors"),d=a;De(function(){if(d){var a=qw(d,b);d=d.parent;return a.Hc(!0)}return M(!1)}).then(function(){O(c,!0)});return c.result()};function vw(a){var b=ww.findIndex(function(b){return b.root===a});0<=b&&ww.splice(b,1)}function xw(a){var b=ww.findIndex(function(b){return b.root===a});return(b=ww[b])?b.Sg:null}
function yw(a,b,c){var d=a.w,e=d.display,f=d.parent?d.parent.display:null,g=!1;if("inline-table"===f&&!(d.C instanceof xp))for(var h=d.parent;h;h=h.parent)if(h.C instanceof xp){g=h.C===b;break}return g||"table-row"===e&&!zw(f)&&"table"!==f&&"inline-table"!==f||"table-cell"===e&&"table-row"!==f&&!zw(f)&&"table"!==f&&"inline-table"!==f||d.C instanceof xp&&d.C!==b?Io(c,d).da(function(b){a.w=b;return M(!0)}):null}
function zw(a){return"table-row-group"===a||"table-header-group"===a||"table-footer-group"===a}function Aw(a,b){this.rowIndex=a;this.M=b;this.b=[]}function Bw(a){return Math.min.apply(null,a.b.map(function(a){return a.height}))}function Cw(a,b,c){this.rowIndex=a;this.Ra=b;this.g=c;this.f=c.colSpan||1;this.rowSpan=c.rowSpan||1;this.height=0;this.b=null}function Dw(a,b,c){this.rowIndex=a;this.Ra=b;this.ac=c}function Ew(a,b,c){this.g=a;this.b=c;this.kc=new Hm(a,b,c);this.f=!1}
Ew.prototype.dc=function(){var a=this.b.A,b=this.b.Z;"middle"!==b&&"bottom"!==b||x(a,"vertical-align","top");var c=this.kc.dc(!0);x(a,"vertical-align",b);return c};function Fw(a,b){this.A=a;this.b=b}function Gw(a,b,c,d){Mm.call(this,a,b,c,d);this.C=a.C;this.rowIndex=this.l=null}v(Gw,Mm);Gw.prototype.f=function(a,b){var c=Mm.prototype.f.call(this,a,b);return b<this.b()?null:Hw(this).every(function(a){return!!a.w})?c:null};
Gw.prototype.b=function(){var a=Mm.prototype.b.call(this);Hw(this).forEach(function(b){a+=b.Db.b()});return a};function Hw(a){a.l||(a.l=Iw(a).map(function(a){return a.dc()}));return a.l}function Iw(a){return Jw(a.C,null!=a.rowIndex?a.rowIndex:a.rowIndex=Kw(a.C,a.position.M)).map(a.C.Sd,a.C)}function Lw(a,b,c){this.rowIndex=a;this.j=b;this.C=c;this.h=null}v(Lw,mo);
Lw.prototype.f=function(a,b){if(b<this.b())return null;var c=Mw(this),d=Nw(this),e=d.every(function(a){return!!a.w})&&d.some(function(a,b){var d=c[b].kc,e=a.w,f=d.wf[0];return!(f.A===e.A&&f.K===e.K&&f.ma===e.ma)&&!Tk(el(e),d.za.xb)});this.j.xa=d.some(function(a){return a.w&&a.w.xa});return e?this.j:null};Lw.prototype.b=function(){var a=this.C,b=0;Bw(a.g[this.rowIndex])>a.N/2||(b+=10);Nw(this).forEach(function(a){b+=a.Db.b()});return b};
function Nw(a){a.h||(a.h=Mw(a).map(function(a){return a.dc()}));return a.h}function Mw(a){return Ow(a.C,a.rowIndex).map(a.C.Sd,a.C)}function xp(a,b){yp.call(this,a,b);this.F=b;this.u=!1;this.G=-1;this.N=0;this.H=[];this.J=this.B=null;this.S=0;this.g=[];this.l=[];this.f=[];this.D=null;this.h=[];this.b=null}v(xp,yp);n=xp.prototype;n.Ze=function(){return"Table formatting context (vivliostyle.table.TableFormattingContext)"};
n.jf=function(a,b){if(!b)return b;switch(a.display){case "table-row":return!this.h.length;case "table-cell":return!this.h.some(function(b){return b.Id.pa[0].node===a.M});default:return b}};function Pw(a,b){var c=a.l[b];c||(c=a.l[b]=[]);return c}function Kw(a,b){return a.g.findIndex(function(a){return b===a.M})}function Ow(a,b){return Pw(a,b).reduce(function(a,b){return b.ac!==a[a.length-1]?a.concat(b.ac):a},[])}function Jw(a,b){return Ow(a,b).filter(function(a){return a.rowIndex+a.rowSpan-1>b})}
...
function Sw(a,b){if(!b)return null;var c=null,d=0;a:for(;d<a.f.length;d++)if(a.f[d])for(var e=0;e<a.f[d].length;e++)if(a.f[d][e]&&b===a.f[d][e].kc.za){c=a.g[d].b[e];break a}if(!c)return null;for(;d<a.l.length;d++)for(;e<a.l[d].length;e++){var f=a.l[d][e];if(f.ac===c)return{rowIndex:f.rowIndex,Ra:f.Ra}}return null}function Tw(a,b){var c=[];return a.l.reduce(function(d,e,f){if(f>=b.rowIndex)return d;e=a.Sd(e[b.Ra].ac);if(!e||c.includes(e))return d;Uw(e.kc.za,d);c.push(e);return d},[])}
function Vw(a){var b=[];a.g.forEach(function(c){c.b.forEach(function(c,e){b[e]||(b[e]={Mf:[],elements:[]});var d=b[e],g=a.Sd(c);g&&!d.Mf.includes(g)&&(Uw(g.kc.za,d.elements),d.Mf.push(g))})});return[new Ww(b.map(function(a){return a.elements}))]}function Uw(a,b){a.B.forEach(function(a){a instanceof Vv&&b.push(a.w.C.b);a instanceof nw&&ow(a,null).forEach(function(a){b.push(a)})})}n.af=function(){return[].concat(this.h)};n.$e=function(a){this.h=a};function Ww(a){this.f=a}
Ww.prototype.b=function(a){return Xw(this,a,function(a){return a.current})};Ww.prototype.F=function(a){return Xw(this,a,function(a){return a.Ke})};function Xw(a,b,c){var d=0;a.f.forEach(function(a){a=no(b,a);d=Math.max(d,c(a))});return d}function Yw(a,b){this.C=a;this.h=b;this.rowIndex=-1;this.Ra=0;this.g=!1;this.f=[]}v(Yw,Gm);n=Yw.prototype;
n.Bd=function(a){var b=this.C,c=yw(a,b,this.h);if(c)return c;Zw(this,a);var c=a.w,d=b.b;switch(c.display){case "table":b.S=c.sa;break;case "table-caption":b.H.push(new Fw(c.A,c.oa));break;case "table-header-group":return d.zc||(this.b=!0,Yv(d,c)),M(!0);case "table-footer-group":return d.yc||(this.b=!0,Zv(d,c)),M(!0);case "table-row":this.b||(this.g=!0,this.rowIndex++,this.Ra=0,b.g[this.rowIndex]=new Aw(this.rowIndex,c.M),d.g||(d.g=c.M))}return Gm.prototype.Bd.call(this,a)};
n.sc=function(a){var b=this.C,c=a.w,d=c.display,e=this.h.f;Zw(this,a);if(c.M===b.F)d=Pn(e,Wv(b,c)),b.N=parseFloat(d[b.u?"height":"width"]),b.b.J=a.ld&&a.ld.M,a.Wb=!0;else switch(d){case "table-header-group":case "table-footer-group":if(this.b)return this.b=!1,M(!0);break;case "table-row":this.b||(b.D=c.A,this.g=!1);break;case "table-cell":if(!this.b){this.g||(this.rowIndex++,this.Ra=0,this.g=!0);d=this.rowIndex;c=new Cw(this.rowIndex,this.Ra,c.A);e=b.g[d];e||(b.g[d]=new Aw(d,null),e=b.g[d]);e.b.push(c);
for(var e=d+c.rowSpan,f=Pw(b,d),g=0;f[g];)g++;for(;d<e;d++)for(var f=Pw(b,d),h=g;h<g+c.f;h++){var l=f[h]=new Dw(d,h,c);c.b||(c.b=l)}this.Ra++}}return Gm.prototype.sc.call(this,a)};n.xf=function(a){$w(this,a)};n.Gf=function(a){$w(this,a)};n.ng=function(a){$w(this,a)};n.Ff=function(a){$w(this,a)};function $w(a,b){var c=b.w;c&&c.A&&!Eo(c)&&a.f.push(c.clone())}function Zw(a,b){0<a.f.length&&Jo(a.h,b.w,a.f);a.f=[]}
function ax(a,b){this.fc=!0;this.C=a;this.f=b;this.l=!1;this.b=-1;this.g=0;this.u=b.u;b.u=!1}v(ax,Gm);var bx={"table-caption":!0,"table-column-group":!0,"table-column":!0};
function cx(a,b,c,d){var e=b.rowIndex,f=b.Ra,g=c.A;if(1<b.f){x(g,"box-sizing","border-box");for(var h=a.C.J,l=0,k=0;k<b.f;k++)l+=h[b.b.Ra+k];l+=a.C.S*(b.f-1);x(g,a.C.u?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new Ew(a.f,b,c);a=a.C;(g=a.f[e])||(g=a.f[e]=[]);g[f]=c;1===d.f.pa.length&&d.f.K&&(c.f=!0);return Km(c.kc,d).Hc(!0)}function dx(a,b){var c=a.C.h[0];return c?c.ac.b.Ra===b:!1}
function ex(a){var b=a.C.h;if(!b.length)return[];var c=[],d=0;do{var e=b[d],f=e.ac.rowIndex;if(f<a.b){var g=c[f];g||(g=c[f]=[]);g.push(e);b.splice(d,1)}else d++}while(d<b.length);return c}
function fx(a,b){var c=a.C,d=ex(a),e=d.reduce(function(a){return a+1},0);if(0===e)return M(!0);var f=a.f.j,g=b.w;g.A.parentNode.removeChild(g.A);var h=L("layoutRowSpanningCellsFromPreviousFragment"),l=M(!0),k=0,m=[];d.forEach(function(a){var b=this;l=l.da(function(){var d=Wk(a[0].Id.pa[1],g.parent);return zo(f,d,!1).da(function(){function g(a){for(;l<a;){if(!m.includes(l)){var b=d.A.ownerDocument.createElement("td");x(b,"padding","0");d.A.appendChild(b)}l++}}var h=M(!0),l=0;a.forEach(function(a){var b=
this;h=h.da(function(){var c=a.ac;g(c.b.Ra);var h=a.Id,p=Wk(h.pa[0],d);p.ma=h.ma;p.K=h.K;p.Sa=h.pa[0].Sa+1;return zo(f,p,!1).da(function(){for(var d=a.Kf,f=0;f<c.f;f++)m.push(l+f);l+=c.f;return cx(b,c,p,d).da(function(){p.A.rowSpan=c.rowIndex+c.rowSpan-b.b+e-k;return M(!0)})})})},b);return h.da(function(){g(Qw(c));k++;return M(!0)})})})},a);l.then(function(){zo(f,g,!0,b.Fd).then(function(){O(h,!0)})});return h.result()}
function gx(a,b){if(a.j||a.h)return M(!0);var c=b.w,d=a.C;0>a.b?a.b=Kw(d,c.M):a.b++;a.g=0;a.l=!0;return fx(a,b).da(function(){hx(a);tp(a.f,b.ld,null,!0,b.dd)&&!Jw(d,a.b-1).length&&(a.f.u=a.u,c.xa=!0,b.Wb=!0);return M(!0)})}function hx(a){a.C.g[a.b].b.forEach(function(b){var c=a.C.h[b.Ra];c&&c.ac.b.Ra==b.b.Ra&&(b=c.Id.pa[0],c=gk(a.f.j.ca,b.node),Dr(c,b.Sa+1,1))})}
function ix(a,b){if(a.j||a.h)return M(!0);var c=b.w;a.l||(0>a.b?a.b=0:a.b++,a.g=0,a.l=!0);var d=a.C.g[a.b].b[a.g],e=Yk(c).modify();e.K=!0;b.w=e;var f=L("startTableCell");dx(a,d.b.Ra)?(e=a.C.h.shift(),c.Sa=e.Id.pa[0].Sa+1,e=M(e.Kf)):e=Fo(a.f,c,b.Fd).da(function(a){a.A&&c.A.removeChild(a.A);return M(new jl(Uk(a)))});e.then(function(e){cx(a,d,c,e).then(function(){a.sc(b);a.g++;O(f,!0)})});return f.result()}
ax.prototype.og=function(a){var b=yw(a,this.C,this.f);if(b)return b;var b=a.w,c=this.C.b,d=b.display;return"table-header-group"===d&&c&&c.B===b.M?(this.j=!0,M(!0)):"table-footer-group"===d&&c&&c.l===b.M?(this.h=!0,M(!0)):"table-row"===d?gx(this,a):"table-cell"===d?ix(this,a):M(!0)};ax.prototype.Qf=function(a){a=a.w;"table-row"===a.display&&(this.l=!1,this.j||this.h||(a=Yk(a).modify(),a.K=!1,this.f.N.push(new Lw(this.b,a,this.C))));return M(!0)};
ax.prototype.sc=function(a){var b=a.w,c=this.C.b,d=b.display;"table-header-group"===d?c&&!c.h&&c.B===b.M?(this.j=!1,b.A.parentNode.removeChild(b.A)):x(b.A,"display","table-row-group"):"table-footer-group"===d&&(c&&!c.h&&c.l===b.M?(this.h=!1,b.A.parentNode.removeChild(b.A)):x(b.A,"display","table-row-group"));if(d&&bx[d])b.A.parentNode.removeChild(b.A);else if(b.M===this.C.F)b.xa=sp(this.f,b,null),this.f.u=this.u,a.Wb=!0;else return Gm.prototype.sc.call(this,a);return M(!0)};var ww=[];
...
function nx(a,b,c,d){if(a.length<c){var e=d.ownerDocument.createElement("colgroup");b.push(e);for(b=a.length;b<c;b++){var f=d.ownerDocument.createElement("col");e.appendChild(f);a.push(f)}}}function ox(a,b,c){var d=a.u,e=a.D;if(e){a.D=null;var f=e.ownerDocument.createDocumentFragment(),g=Qw(a);if(0<g){var h=a.J=kx(e,g,d,c.f);c=lx(b);e=mx(c);nx(e,c,g,b);e.forEach(function(a,b){x(a,d?"height":"width",h[b]+"px")});c.forEach(function(a){f.appendChild(a.cloneNode(!0))})}a.B=f}}
function px(a,b,c){var d=b.C;d.u=b.b;Nr(d,b.b);var e=xw(b.M);vw(b.M);var f=L("TableLayoutProcessor.doInitialLayout"),g=Yk(b);Em(new Dm(new Yw(b.C,c),c.j),b).then(function(a){var h=a.A,k=Jk(c.f,h),k=c.b?k.left:k.bottom,k=k+(c.b?-1:1)*no(b,qo(c)).current;ro(c,k)||e&&e.wg?(ox(d,h,c),Rw(d,c.f),O(f,null)):(c.N.push(new qx(g)),O(f,a))}.bind(a));return f.result()}function rx(a,b,c){var d=a.H;d.forEach(function(a,f){a&&(b.insertBefore(a.A,c),"top"===a.b&&(d[f]=null))})}
function sx(a,b){if(a.B&&b){var c=lx(b);c&&c.forEach(function(a){b.removeChild(a)})}}function tx(a,b){var c=a.C,d=Wv(c,a),e=d.firstChild;rx(c,d,e);c.B&&!lx(d).length&&d.insertBefore(c.B.cloneNode(!0),e);c=new ax(c,b);c=new Dm(c,b.j);d=L("TableFormattingContext.doLayout");Em(c,a).Ea(d);return d.result()}n=jx.prototype;n.me=function(a,b,c){var d=a.C;return Wv(d,a)?(c&&Tv(a.parent,b),Om(new ux(d,this),a,b)):Io(b,a)};n.Nf=function(a,b,c,d){return new Gw(a,b,c,d)};n.bf=function(){return!1};n.Df=function(){return!1};
n.Na=function(a,b,c,d){var e=b.C;if("table-row"===b.display){var f=Kw(e,b.M);e.h=[];var g;g=b.K?Jw(e,f):Ow(e,f);if(g.length){var h=L("TableLayoutProcessor.finishBreak"),l=0;Ee(function(a){if(l===g.length)Q(a);else{var b=g[l++],c=e.Sd(b),d=c.dc().w,h=c.b,k=el(h),u=new jl(el(d));e.h.push({Id:k,Kf:u,ac:b});h=h.A;Lp(c.b);f<b.rowIndex+b.rowSpan-1&&(h.rowSpan=f-b.rowIndex+1);c.f?P(a):c.kc.Na(d,!1,!0).then(function(){var b=e.b;if(b){var f=e.u,g=c.g,h=c.kc.za.element,k=c.b.A,l=Jk(g.f,k),k=Qo(g,k);f?(b=l.right-
g.oa-b.b(d)-k.right,x(h,"max-width",b+"px")):(b=g.oa-b.b(d)-l.top-k.top,x(h,"max-height",b+"px"));x(h,"overflow","hidden")}P(a)})}}).then(function(){kp(a,b,!1);Lp(b);e.f=[];O(h,!0)});return h.result()}}e.f=[];return op.Na(a,b,c,d)};n.Ed=function(a,b,c,d){Kp.prototype.Ed(a,b,c,d)};function ux(a,b){Nm.call(this);this.g=b;this.b=a}v(ux,Nm);ux.prototype.tf=function(a){var b=this.b.b;return b&&b.j?(a.M===this.b.F&&!a.K&&b&&(b.Cc=!1,b.gd=!1),new vx(this.b)):new wx(this.b,this.g)};
ux.prototype.Jd=function(a){Nm.prototype.Jd.call(this,a);sx(this.b,Wv(this.b,a))};ux.prototype.le=function(a,b){Nm.prototype.le.call(this,a,b);this.b.f=[]};function wx(a,b){this.C=a;this.h=b}v(wx,dw);wx.prototype.b=function(a,b){dw.prototype.b.call(this,a,b);return px(this.h,a,b)};function qx(a){Mm.call(this,a,null,a.xa,0)}v(qx,Mm);qx.prototype.b=function(){if(!this.h)throw Error("EdgeBreakPosition.prototype.updateEdge not called");return(this.j?3:0)+(this.position.parent?this.position.parent.j:0)};
qx.prototype.u=function(a){a.B.push(new xx(this.position.M))};function xx(a){this.b=a}n=xx.prototype;n.ne=function(){return!1};n.nd=function(){return!0};n.cd=function(a,b){ww.push({root:b.M,Sg:{wg:!0}})};n.Na=function(){return M(!0)};n.ve=function(a){return a instanceof xx&&a.b===this.b};n.xe=function(){return 0};function vx(a){this.C=a}v(vx,ew);vx.prototype.b=function(a,b){var c=this.C.b;if(c&&!$v(c,a)){var d=new nw(a);b.B.some(function(a){return d.ve(a)})||b.B.unshift(d)}return tx(a,b)};
function nw(a){Vv.call(this,a);this.b=[]}v(nw,Vv);n=nw.prototype;n.ne=function(a,b,c){var d=this.w.C.b;return!d||c.Md||Oo(this.w.A)||!cw(d)?!0:b&&!a||a&&a.xa?!1:!0};n.nd=function(a){return yx(a,this.w.C).some(function(b){return b.Kd.some(function(b){return b.nd(a)})})?!0:Vv.prototype.nd.call(this,a)};n.cd=function(a,b,c,d){var e=this.w.C;this.b=yx(b,e);this.b.forEach(function(b){b.Kd.forEach(function(e){e.cd(a,b.Db,c,d)})});a||(sx(e,Wv(e,this.w)),zx(c));Vv.prototype.cd.call(this,a,b,c,d)};
n.Na=function(a,b){var c=this,d=L("finishBreak"),e=this.b.reduce(function(a,b){return a.concat(b.Kd.map(function(a){return{yg:a,Db:b.Db}}))},[]),f=0;De(function(){if(f<e.length){var a=e[f++];return a.yg.Na(a.Db,b).Hc(!0)}return M(!1)}).then(function(){O(d,!0)});return d.result().da(function(){return Vv.prototype.Na.call(c,a,b)})};function zx(a){if(a&&"table-row"===a.display&&a.A)for(;a.A.previousElementSibling;){var b=a.A.previousElementSibling;b.parentNode&&b.parentNode.removeChild(b)}}
function yx(a,b){return Ax(a,b).map(function(a){return{Kd:a.Bg.kc.za.B,Db:a.Db}})}function Ax(a,b){var c=Number.MAX_VALUE;a&&"table-row"===a.display&&(c=Kw(b,a.M)+1);for(var c=Math.min(b.f.length,c),d=[],e=0;e<c;e++)b.f[e]&&b.f[e].forEach(function(a){a&&d.push({Bg:a,Db:a.dc().w})});return d}function ow(a,b){var c=a.w.C,d=Sw(c,b);return d?Tw(c,d):Vw(c)}n.ve=function(a){return a instanceof nw?this.w.C===a.w.C:!1};var Bx=new jx;
fe("RESOLVE_FORMATTING_CONTEXT",function(a,b,c){return b?c===Nd?(b=a.parent,new xp(b?b.C:null,a.M)):null:null});fe("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof xp?Bx:null});Array.from||(Array.from=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e],e):a[e];return c});
...
Object.assign||(Object.assign=function(a,b){if(!b)return a;Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function Cx(a){function b(a){return"number"===typeof a?a:null}function c(a){return"string"===typeof a?{url:a,wb:null,mc:null}:{url:a.url,wb:b(a.startPage),mc:b(a.skipPagesBefore)}}return Array.isArray(a)?a.map(c):a?[c(a)]:null}function Dx(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}
function Ex(a,b){Zj=a.debug;this.g=!1;this.h=a;this.gb=new Su(a.window||window,a.viewportElement,"main",this.zg.bind(this));this.f={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,pageViewMode:"autoSpread",zoom:1,fitToScreen:!1,defaultPaperSize:void 0};b&&this.mg(b);this.b=new eb;Object.defineProperty(this,"readyState",{get:function(){return this.gb.u}})}n=Ex.prototype;n.mg=function(a){var b=Object.assign({a:"configure"},Dx(a));this.gb.h(b);Object.assign(this.f,a)};
n.zg=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});fb(this.b,b)};n.Tg=function(a,b){this.b.addEventListener(a,b,!1)};n.Wg=function(a,b){this.b.removeEventListener(a,b,!1)};n.Eg=function(a,b,c){a||fb(this.b,{type:"error",content:"No URL specified"});Fx(this,a,null,b,c)};n.Ug=function(a,b,c){a||fb(this.b,{type:"error",content:"No URL specified"});Fx(this,null,a,b,c)};
function Fx(a,b,c,d,e){function f(a){if(a)return a.map(function(a){return{url:a.url||null,text:a.text||null}})}d=d||{};var g=f(d.authorStyleSheet),h=f(d.userStyleSheet);e&&Object.assign(a.f,e);b=Object.assign({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.h.userAgentRootURL,url:Cx(b)||c,document:d.documentObject,fragment:d.fragment,authorStyleSheet:g,userStyleSheet:h},Dx(a.f));a.g?a.gb.h(b):(a.g=!0,tv(a.gb,b))}n.ec=function(){return this.gb.ec()};
n.Hg=function(a,b){if("epage"===a)this.gb.h({a:"moveTo",epage:b});else{var c;a:switch(a){case "left":c="ltr"===this.ec()?"previous":"next";break a;case "right":c="ltr"===this.ec()?"next":"previous";break a;default:c=a}this.gb.h({a:"moveTo",where:c})}};n.Gg=function(a){this.gb.h({a:"moveTo",url:a})};n.Rc=function(){return this.gb.b&&this.gb.b.R&&(this.gb.b.R.uc||this.gb.b.R.pf)?!!this.gb.b.Rc():null};n.Uc=function(a,b){this.gb.h({a:"toc",v:null==a?"toggle":a?"show":"hide",autohide:b})};
n.Vg=function(a){a:{var b=this.gb;if(!b.g)throw Error("no page exists.");switch(a){case "fit inside viewport":a=ov(b,b.$.ub?nv(b,b.j):b.g.g);break a;default:throw Error("unknown zoom type: "+a);}}return a};n.Cg=function(){return this.gb.Z};na("vivliostyle.viewer.Viewer",Ex);Ex.prototype.setOptions=Ex.prototype.mg;Ex.prototype.addListener=Ex.prototype.Tg;Ex.prototype.removeListener=Ex.prototype.Wg;Ex.prototype.loadDocument=Ex.prototype.Eg;Ex.prototype.loadEPUB=Ex.prototype.Ug;
Ex.prototype.getCurrentPageProgression=Ex.prototype.ec;Ex.prototype.navigateToPage=Ex.prototype.Hg;Ex.prototype.navigateToInternalUrl=Ex.prototype.Gg;Ex.prototype.isTOCVisible=Ex.prototype.Rc;Ex.prototype.showTOC=Ex.prototype.Uc;Ex.prototype.queryZoomFactor=Ex.prototype.Vg;Ex.prototype.getPageSizes=Ex.prototype.Cg;na("vivliostyle.viewer.ZoomType",pv);pv.FIT_INSIDE_VIEWPORT="fit inside viewport";na("vivliostyle.viewer.PageViewMode",Ru);Ru.SINGLE_PAGE="singlePage";Ru.SPREAD="spread";
...
function Mx(a){switch(a.t){case "loaded":a=a.viewer;var b=Hx=a.ec();a.je.setAttribute("data-vivliostyle-page-progression",b);a.je.setAttribute("data-vivliostyle-spread-view",a.$.ub);window.addEventListener("keydown",Lx,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Jx,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Kx,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
