 ...
 *
 * Vivliostyle core 2016.7.1-pre.20161024153903
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function pn(a,b,c,d){if(a.e&&a.e[a.e.length-1].b)return on(a,b,c),L(!0);d+=40*(a.b?-1:1);var e=a.l,f=!e;if(f){var g=a.element.ownerDocument.createElement("div");v(g,"position","absolute");var h=a.f.clone(),e=new Sm(g,h,a.g,a.Ra);a.l=e;e.b=qn(a.f,a.b,g);e.Lc=!0;a.b?(e.left=0,v(e.element,"width","2em")):(e.top=a.Ta,v(e.element,"height","2em"))}a.element.appendChild(e.element);nn(a,e.element,e);g=(a.b?-1:1)*(d-a.sa);a.b?e.height=a.Qa.S-a.Qa.W-Ei(e)-Fi(e):e.width=a.Qa.V-a.Qa.ca-Gi(e)-Ii(e);d=(a.b?-1:
1)*(a.Ta-d)-(a.b?Gi(e)-Ii(e):Ei(e)+Fi(e));if(f&&18>d)return a.element.removeChild(e.element),a.l=null,on(a,b,c),L(!0);if(!a.b&&e.top<g)return a.element.removeChild(e.element),on(a,b,c),L(!0);var l=K("layoutFootnoteInner");a.b?Li(e,0,d):Ki(e,g,d);e.D=a.D+a.left+Gi(a);e.F=a.F+a.top+Ei(a);e.G=a.G;var k=new wi(c);f?(rn(e),d=L(!0)):0==e.G.length?(sn(e),d=L(!0)):d=tn(e);d.then(function(){un(e,k).then(function(d){if(f&&d)a.element.removeChild(e.element),on(a,b,c),a.l=null,N(l,!0);else{a.b?(a.ja=a.Ta+(e.d+
Gi(e)+Ii(e)),Li(e,0,e.d)):(a.ja=a.Ta-(e.d+Ei(e)+Fi(e)),Ki(e,a.ja-a.sa,e.d));var g;!a.b&&0<e.G.length?g=tn(e):g=L(d);g.then(function(d){d=new Qm(b,c,d?d.Oa:null);a.e?a.e.push(d):a.e=[d];N(l,!0)})}})});return M(l)}
...
k.appendChild(l);a=Ao(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));k.appendChild(a);b.split(" ").forEach(function(a){k.style[a]=f+"px"});return k}var Do={Je:"top",we:"bottom",Wd:"left",Xd:"right"};
...
K("layoutContainer.inner"),X=l.toString(),ja=Y(c,a,"column-count"),Ma=Y(c,a,"column-gap"),ea=1<ja?Y(c,a,"column-width"):r.width,l=km(c,a),E=0,w=lm(c,a,"shape-inside"),S=qg(w,0,0,r.width,r.height,a),cm=new wp(X,a,a.viewport,a.d,l,a.X,a.h,a.style.u,a,b,a.Ja,a.Ra,h,a.Qa),dm=new Rn(a.f,a.b.page-1),Hi=0,fa=null;qf(function(b){for(;Hi<ja;){var c=Hi++;if(1<ja){var d=a.viewport.b.createElement("div");v(d,"position","absolute");q.appendChild(d);fa=new Sm(d,cm,a.e,dm);fa.b=r.b;fa.Sa=r.Sa;fa.Hb=r.Hb;r.b?(v(d,
"margin-left",r.j+"px"),v(d,"margin-right",r.w+"px"),c=c*(ea+Ma)+r.k,Li(fa,0,r.width),Ki(fa,c,ea)):(v(d,"margin-top",r.k+"px"),v(d,"margin-bottom",r.u+"px"),c=c*(ea+Ma)+r.j,Ki(fa,0,r.height),Li(fa,c,ea));fa.D=e+r.j;fa.F=f+r.k}else fa=new Sm(q,cm,a.e,dm),Ji(fa,r),r=fa;fa.G=p?[]:g;fa.xb=S;if(0<=fa.width){var k=K("inner");$p(a,fa,X).then(function(){fa.h&&"column"!=fa.h&&(Hi=ja,"region"!=fa.h&&(a.G[X]=!0));N(k,!0)});c=M(k)}else c=L(!0);if(c.Ca()){c.then(function(){0<h.b.length?P(b):(E=Math.max(E,fa.d),
sf(b))});return}0<h.b.length||(E=Math.max(E,fa.d))}P(b)}).then(function(){r.d=E;c.vc(a,r,b,fa,ja,a.e,a.h);N(O,!0)});l=M(O)}else(l=lm(c,a,"content"))&&Ni(l)?(w=a.viewport.b.createElement("span"),l.U(new Mi(w,a)),q.appendChild(w),Am(c,a,r,a.h)):c.na&&(d.removeChild(q),y=!0),y||c.vc(a,r,b,null,1,a.e,a.h),l=L(!0);l.then(function(){if(!c.f||0<Math.floor(r.d)){if(!y&&!m){var l=r.D+r.left,p=r.F+r.top,w=Gi(r)+r.width+Ii(r),E=Ei(r)+r.height+Fi(r),X=lm(c,a,"shape-outside"),l=qg(X,l,p,w,E,a);g.push(l)}}else if(0==
...
oq.prototype.load=function(a){var b=wa(a);if(a=this.l[b])return a.Ca()?a:L(a.get());var c=K("EPUBDocStore.load");a=oq.Vd.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?N(c,a):u.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return M(c)};function vq(){this.id=null;this.src="";this.f=this.d=null;this.H=-1;this.h=0;this.j=null;this.b=this.e=0;this.Db=this.Wa=null;this.g=Wa}
...
a.d;d.b=d.u.pop();d=a.d;d.e=d.A.pop();d=b.bc.position;d.H===e.H&&d.R===g&&(e=b.bc.page);sf(c)})):sf(c)})}}).then(function(){N(d,{bc:Nq(e,g),Td:c})})})});return M(d)}function Uq(a,b){var c=a.R,d=-1;0>c&&(d=a.ta,c=Ta(b.Fa.length,function(a){return Yp(b.Va,b.Fa[a],!0)>d}),c=c===b.Fa.length?b.complete?b.Fa.length-1:Number.POSITIVE_INFINITY:c-1);return{H:a.H,R:c,ta:d}}
...
function fr(a,b,c,d){var e=this;this.h=a;this.Jc=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);ma&&b.setAttribute("data-vivliostyle-debug",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Sa=c;this.Ra=d;a=a.document;this.Ja=new rh(a.head,b);this.w="loading";this.O=[];this.g=null;this.k=this.d=!1;this.f=this.j=this.e=this.A=null;this.fontSize=16;this.zoom=1;this.N=!1;this.ia="autoSpread";this.na=!1;this.kd=!0;this.T=Xb();this.F=function(){};this.u=function(){};this.ja=
function(){e.d=!0;e.F()};this.fd=this.fd.bind(this);this.D=function(){};this.G=a.getElementById("vivliostyle-page-rules");this.Z=!1;this.l=null;this.Aa={loadEPUB:this.Yd,loadXML:this.Zd,configure:this.vd,moveTo:this.Qa,toc:this.Ac};gr(this)}function gr(a){va(1,function(a){hr(this,{t:"debug",content:a})}.bind(a));va(2,function(a){hr(this,{t:"info",content:a})}.bind(a));va(3,function(a){hr(this,{t:"warn",content:a})}.bind(a));va(4,function(a){hr(this,{t:"error",content:a})}.bind(a))}
...
!0);"boolean"==typeof a.fitToScreen&&a.fitToScreen!==this.N&&(this.N=a.fitToScreen,this.k=!0);return L(!0)};n.fd=function(a){var b=this.j,c=a.target;if(this.e===a.target||b&&(b.left===c||b.right===c))this.e=a.he,this.k=!0,this.F()};function nr(a){var b=[];a.e&&(b.push(a.e),a.e=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(v(a.L,"display","none"),a.removeEventListener("hyperlink",this.D,!1),a.removeEventListener("replaced",this.fd,!1))},a)}
function or(a,b){b.addEventListener("hyperlink",a.D,!1);b.addEventListener("replaced",a.fd,!1);v(b.L,"visibility","visible");v(b.L,"display","block")}function pr(a,b){nr(a);a.e=b;or(a,b)}function qr(a){var b=K("reportPosition");Jq(a.g,a.f.H,a.f.ta).then(function(c){var d=a.e;(a.na&&0<d.g.length?vg(d.g):L(!0)).then(function(){rr(a,d,c).ua(b)})});return M(b)}
function sr(a){var b=a.Jc;if(a.A){var c=a.A;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new Pp(a.h,a.fontSize,b,c.width,c.height)}return new Pp(a.h,a.fontSize,b)}
function tr(a){var b=sr(a),c;a:switch(a.ia){case "singlePage":c=!1;break a;case "spread":c=!0;break a;default:c=1.45<=b.width/b.height&&800<b.width}var d=a.T.cb!==c;a.T.cb=c;a.Jc.setAttribute("data-vivliostyle-spread-view",c);if(a.A||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;if(!d&&b.width==a.viewport.width&&b.height==a.viewport.height)return!0;if(d=a.b&&dr(a.b)){a:{d=a.b.Eb;for(c=0;c<d.length;c++){var e=d[c];if(e)for(var e=e.ab,f=0;f<e.length;f++){var g=e[f];if(g.u&&g.l){d=!0;break a}}}d=
!1}d=!d}return d?(a.viewport.width=b.width,a.viewport.height=b.height,a.k=!0):!1}n.oe=function(a,b,c){if(!this.Z&&this.G&&0===b&&0===c){var d="";Object.keys(a).forEach(function(b){d+="@page "+b+"{size:";b=a[b];d+=b.width+"px "+b.height+"px;}"});this.G.textContent=d;this.Z=!0}};
function ur(a){if(a.b){a.b.wc();for(var b=a.b,c=b.Eb,d=0;d<c.length;d++){var e=c[d];e&&e.ab.splice(0)}for(b=b.viewport.root;b.lastChild;)b.removeChild(b.lastChild)}a.G&&(a.G.textContent="",a.Z=!1);a.viewport=sr(a);b=a.viewport;v(b.e,"width","");v(b.e,"height","");v(b.d,"width","");v(b.d,"height","");v(b.d,"transform","");a.b=new Oq(a.g,a.viewport,a.Ja,a.T,a.oe.bind(a))}
function vr(a,b,c){a.k=!1;if(a.T.cb)return Zq(a.b,a.f,c).Qb(function(c){nr(a);a.j=c;c.left&&(or(a,c.left),c.right||c.left.L.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(or(a,c.right),c.left||c.right.L.setAttribute("data-vivliostyle-unpaired-page",!0));c=wr(a,c);a.viewport.zoom(c.width,c.height,xr(a,c));a.e=b;return L(null)});pr(a,b);yr(a,b);a.e=b;return L(null)}function yr(a,b){var c=xr(a,b.d);a.viewport.zoom(b.d.width,b.d.height,c)}
function xr(a,b){return a.N?Math.min(a.viewport.width/b.width,a.viewport.height/b.height):a.zoom}function wr(a,b){var c=0,d=0;b.left&&(c+=b.left.d.width,d=b.left.d.height);b.right&&(c+=b.right.d.width,d=Math.max(d,b.right.d.height));b.left&&b.right&&(c+=2*a.T.Nb);return{width:c,height:d}}var zr={Ae:"fit inside viewport"};function Ar(){this.name="RenderingCanceledError";this.message="Page rendering has been canceled";this.stack=Error().stack}t(Ar,Error);
function kr(a){if(a.l){var b=a.l;Ze(b,new Ar||Error("E_TASK_INTERRUPT"));if(b!==Te&&b.b){b.b.f=!0;var c=new jf(b);b.j="interrupt";b.b=c;b.d.Pa(c)}}a.l=null}
function lr(a){a.d=!1;a.k=!1;if(tr(a))return L(!0);ir(a,"loading");kr(a);var b=af(Te.d,function(){return Ye("resize",function(c){a.l=b;oo.d("render (resize)");ur(a);a.f&&(a.f.R=-1);Xq(a.b,a.f).then(function(d){a.f=d.position;vr(a,d.page,!0).then(function(){qr(a).then(function(d){ir(a,"interactive");(a.kd?a.b.kd():L(null)).then(function(){a.l===b&&(a.l=null);oo.b("render (resize)");ir(a,"complete");hr(a,{t:"loaded"});N(c,d)})})})})},function(a,b){if(b instanceof Ar)oo.b("render (resize)"),u.debug(b.message);
else throw b;})});return L(!0)}function rr(a,b,c){var d=K("sendLocationNotification"),e={t:"nav",first:b.w,last:b.k};Mq(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.u;c&&(e.cfi=c);hr(a,e);N(d,!0)});return M(d)}fr.prototype.ob=function(){return this.b?this.b.ob(this.f):null};
fr.prototype.Qa=function(a){var b=this;"complete"!==this.w&&ir(this,"loading");if("string"==typeof a.where){switch(a.where){case "next":a=this.T.cb?this.b.ie:this.b.nextPage;break;case "previous":a=this.T.cb?this.b.le:this.b.hd;break;case "last":a=this.b.ce;break;case "first":a=this.b.be;break;default:return L(!0)}if(a){var c=a;a=function(){return c.call(b.b,b.f)}}}else if("number"==typeof a.epage){var d=a.epage;a=function(){return $q(b.b,d)}}else if("string"==typeof a.url){var e=a.url;a=function(){return br(b.b,
e,b.f)}}else return L(!0);var f=K("moveTo");a.call(b.b).then(function(a){var c;if(a){b.f=a.position;var d=K("moveTo.showCurrent");c=M(d);vr(b,a.page).then(function(){qr(b).ua(d)})}else c=L(!0);c.then(function(a){"loading"===b.w&&ir(b,"interactive");N(f,a)})});return M(f)};
...
function Br(a,b){var c=b.a||"";return Ye("runCommand",function(d){var e=a.Aa[c];e?e.call(a,b).then(function(){hr(a,{t:"done",a:c});N(d,!0)}):(u.error("No such action:",c),N(d,!0))},function(a,b){u.error(b,"Error during action:",c);N(a,!0)})}function Cr(a){return"string"==typeof a?JSON.parse(a):a}
function Dr(a,b){var c=Cr(b),d=null;$e(function(){var b=K("commandLoop"),f=Te.d;a.D=function(b){var c="#"===b.href.charAt(0)||a.O.some(function(a){return b.href.substr(0,a.length)==a});if(c){b.preventDefault();var d={t:"hyperlink",href:b.href,internal:c};af(f,function(){hr(a,d);return L(!0)})}};qf(function(b){if(a.d)lr(a).then(function(){sf(b)});else if(a.k)a.e&&vr(a,a.e).then(function(){sf(b)});else if(c){var e=c;c=null;Br(a,e).then(function(){sf(b)})}else e=K("waitForCommand"),d=hf(e,self),M(e).then(function(){sf(b)})}).ua(b);
return M(b)});a.F=function(){var a=d;a&&(d=null,a.Pa())};a.u=function(b){if(c)return!1;c=Cr(b);a.F();return!0};a.h.adapt_command=a.u};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Yb||(Object.Yb=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function Er(a){function b(a){return"number"===typeof a?a:null}function c(a){return"string"===typeof a?{url:a,Wa:null,Db:null}:{url:a.url,Wa:b(a.startPage),Db:b(a.skipPagesBefore)}}return Array.isArray(a)?a.map(c):a?[c(a)]:null}function Fr(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}
function Gr(a,b){ma=a.debug;this.e=!1;this.f=a;this.zb=new fr(a.window||window,a.viewportElement,"main",this.ae.bind(this));this.d={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,pageViewMode:"autoSpread",zoom:1,fitToScreen:!1};b&&this.Ud(b);this.b=new $a;Object.defineProperty(this,"readyState",{get:function(){return this.zb.w}})}n=Gr.prototype;n.Ud=function(a){var b=Object.Yb({a:"configure"},Fr(a));this.zb.u(b);Object.Yb(this.d,a)};
n.ae=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});ab(this.b,b)};n.pe=function(a,b){this.b.addEventListener(a,b,!1)};n.se=function(a,b){this.b.removeEventListener(a,b,!1)};n.de=function(a,b,c){a||ab(this.b,{type:"error",content:"No URL specified"});Hr(this,a,null,b,c)};n.qe=function(a,b,c){a||ab(this.b,{type:"error",content:"No URL specified"});Hr(this,null,a,b,c)};
function Hr(a,b,c,d,e){function f(a){if(a)return a.map(function(a){return{url:a.url||null,text:a.text||null}})}d=d||{};var g=f(d.authorStyleSheet),h=f(d.userStyleSheet);e&&Object.Yb(a.d,e);b=Object.Yb({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.f.userAgentRootURL,url:Er(b)||c,document:d.documentObject,fragment:d.fragment,authorStyleSheet:g,userStyleSheet:h},Fr(a.d));a.e?a.zb.u(b):(a.e=!0,Dr(a.zb,b))}n.ob=function(){return this.zb.ob()};
n.fe=function(a){a:switch(a){case "left":a="ltr"===this.ob()?"previous":"next";break a;case "right":a="ltr"===this.ob()?"next":"previous";break a}this.zb.u({a:"moveTo",where:a})};n.ee=function(a){this.zb.u({a:"moveTo",url:a})};n.re=function(a){var b;a:{b=this.zb;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.T.cb?wr(b,b.j):b.e.d;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ba("vivliostyle.viewer.Viewer",Gr);Gr.prototype.setOptions=Gr.prototype.Ud;Gr.prototype.addListener=Gr.prototype.pe;Gr.prototype.removeListener=Gr.prototype.se;Gr.prototype.loadDocument=Gr.prototype.de;Gr.prototype.loadEPUB=Gr.prototype.qe;Gr.prototype.getCurrentPageProgression=Gr.prototype.ob;Gr.prototype.navigateToPage=Gr.prototype.fe;Gr.prototype.navigateToInternalUrl=Gr.prototype.ee;Gr.prototype.queryZoomFactor=Gr.prototype.re;ba("vivliostyle.viewer.ZoomType",zr);zr.FIT_INSIDE_VIEWPORT="fit inside viewport";
ba("vivliostyle.viewer.PageViewMode",er);er.SINGLE_PAGE="singlePage";er.SPREAD="spread";er.AUTO_SPREAD="autoSpread";ko.call(oo,"load_vivliostyle","end",void 0);var Ir=16,Jr="ltr";function Kr(a){window.adapt_command(a)}function Lr(){Kr({a:"moveTo",where:"ltr"===Jr?"previous":"next"})}function Mr(){Kr({a:"moveTo",where:"ltr"===Jr?"next":"previous"})}
function Nr(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)Kr({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)Kr({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)Kr({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)Kr({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)Mr(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)Lr(),a.preventDefault();else if("0"===b||"U+0030"===c)Kr({a:"configure",fontSize:Math.round(Ir)}),a.preventDefault();else if("t"===b||"U+0054"===c)Kr({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)Ir*=1.2,Kr({a:"configure",fontSize:Math.round(Ir)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)Ir/=1.2,Kr({a:"configure",
fontSize:Math.round(Ir)}),a.preventDefault()}
function Or(a){switch(a.t){case "loaded":a=a.viewer;var b=Jr=a.ob();a.Jc.setAttribute("data-vivliostyle-page-progression",b);a.Jc.setAttribute("data-vivliostyle-spread-view",a.T.cb);window.addEventListener("keydown",Nr,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Lr,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Mr,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(Ba(location.href,Pa(a||"")));break;case "hyperlink":a.internal&&Kr({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+m+"; margin: 0; }",document.head.appendChild(g));Dr(new fr(window,k,"main",Or),a)});
