...
Kh={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},Lh={Pd:!1,wb:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",Vb:"\u5341\u767e\u5343",yd:"\u8ca0"};
function Mh(a){if(9999<a||-9999>a)return""+a;if(0==a)return Lh.wb.charAt(0);var b=new Aa;0>a&&(b.append(Lh.yd),a=-a);if(10>a)b.append(Lh.wb.charAt(a));else if(Lh.Qd&&19>=a)b.append(Lh.Vb.charAt(0)),0!=a&&b.append(Lh.Vb.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(Lh.wb.charAt(c)),b.append(Lh.Vb.charAt(2)));if(c=Math.floor(a/100)%10)b.append(Lh.wb.charAt(c)),b.append(Lh.Vb.charAt(1));if(c=Math.floor(a/10)%10)b.append(Lh.wb.charAt(c)),b.append(Lh.Vb.charAt(0));(a%=10)&&b.append(Lh.wb.charAt(a))}return b.toString()}
...
function Zh(a){var b;for(b=0;b<a.u.length;b++)Wh(a,a.j.ta,a.u[b]);for(b=0;b<a.F.length;b++)Wh(a,a.j.d,a.F[b]);Wh(a,a.j.e,a.Q);Wh(a,a.j.Ib,a.f);""!=a.f&&Wh(a,a.j.Ib,"*");Wh(a,a.j.f,a.Y);null!==a.H&&(Wh(a,a.j.Ab,a.H),Wh(a,a.j.Ab,"*"));a.e=null;a.b.push([]);for(var c=1;-1<=c;--c){var d=a.b[a.b.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.la=!0;a.va=!1}
...
function Mj(a,b,c,d,e,f,g){this.X=a;this.root=a.root;this.ba=c;this.f=d;this.h=f;this.d=this.root;this.u={};this.w={};this.B=[];this.l=this.k=null;this.A=new Vh(b,d,g);this.e=new Gj;this.La=!0;this.F=[];this.Y=e;this.Q=this.H=!1;this.b=a=Ci(a,this.root);Ij(this.e,a);b=Nj(this,this.root);di(this.A,this.root,b);Oj(this,b,!1);this.j=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.j=!1}this.F.push(!0);this.w={};this.w["e"+a]=
...
c)});return P(d)}function rk(a,b){return"footnote"==b.h?Jk(a,b):Lk(a,b)}function al(a,b,c){var d=M("layoutNext");$k(a,b,c).then(function(c){b=c;if(!b||a.Q||b.overflow)Q(d,b);else if(b.h)rk(a,b).ka(d);else{a:{if(!b.I)switch(b.T.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!0}c?Tk(a,b).ka(d):sk(a,b).ka(d)}});return P(d)}
...
de(b,d,b+a.width,d+a.height);a.kc=ne(c,[b],a.A,a.fb,a.b);vk(a);a.g=null}function Dk(a){a.ib=[];u(a.d,"width",a.width+"px");u(a.d,"height",a.height+"px");Ek(a);a.e=0;a.Nc=!1;a.Q=null}function Mk(a,b){a.e=Math.max((a.b?-1:1)*(b-a.Ja),a.e)}function bl(a,b){var c=b.b;if(!c)return O(!0);var d=M("layoutOverflownFootnotes"),e=0;Qe(function(){for(;e<c.length;){var b=c[e++],b=Bk(a,0,b,a.Ja);if(b.ua())return b}return O(!1)}).then(function(){Q(d,!0)});return P(d)}
function Ik(a,b){a.ib.push(b);if(a.Nc)return O(b);var c=M("layout");bl(a,b).then(function(){jk(a,b.La).then(function(b){var e=b,f=!0;a.u=[];Re(function(c){for(;b;){var h=!0;al(a,b,f).then(function(k){f=!1;b=k;a.Q?R(c):b&&b.overflow?Vk(a,b,e).then(function(a){b=a;R(c)}):h?h=!1:Te(c)});if(h){h=!1;return}}R(c)}).then(function(){var e=a.l;e&&(a.d.appendChild(e.d),a.b?a.e=this.Ja-this.gb:a.e=e.top+wj(e)+e.e+xj(e));if(b){a.Nc=!0;var f=e=b,k=[];do f.e&&f.parent&&f.parent.e!==f.e||k.push(qj(f)),f=f.parent;
...
function hl(a,b){this.e=b;var c=this;Yb.call(this,a,function(a,b){var f=a.match(/^([^.]+)\.([^.]+)$/);if(f){var g=c.e.k[f[1]];if(g&&(g=this.Y[g])){if(b){var f=f[2],h=g.ba[f];if(h)g=h;else{switch(f){case "columns":var h=g.d.d,k=new Nc(h,0),l=il(g,"column-count"),n=il(g,"column-width"),p=il(g,"column-gap"),h=F(h,Pc(h,new Kc(h,"min",[k,l]),E(h,n,p)),p)}h&&(g.ba[f]=h);g=h}}else g=il(g,f[2]);return g}}return null})}t(hl,Yb);
...
function vl(a){var b=a.d.d,c=a.style,d=sl(b,c.enabled,b.g),e=X(b,c.page,b.b);if(e)var f=new Ic(b,"page-number"),d=Oc(b,d,new Ac(b,e,f));(e=X(b,c["min-page-width"],b.b))&&(d=Oc(b,d,new zc(b,new Ic(b,"page-width"),e)));(e=X(b,c["min-page-height"],b.b))&&(d=Oc(b,d,new zc(b,new Ic(b,"page-height"),e)));d=a.Q(d);c.enabled=new L(d)}tl.prototype.Q=function(a){return a};
...
function yl(a,b){b.Y[a.d.g]=a;var c=a.d.d,d=a.style,e=a.e?zl(a.e,b):null,e=ni(a.B,b,e,!1);a.b=mi(e,b,a.e?a.e.b:!1);oi(e,d,a.b,function(a,b){return b.value});a.l=new ac(c,function(){return a.A},"autoWidth");a.k=new ac(c,function(){return a.w},"autoHeight");a.yc();a.zc();wl(a);vl(a)}function Al(a,b,c){(a=a.style[c])&&(a=Kf(b,a,c));return a}function Y(a,b,c){(a=a.style[c])&&(a=Kf(b,a,c));return hd(a,b)}
...
function Om(a,b,c){function d(a){if(x)return x;x={W:y?y.evaluate(a):null,za:k?k.evaluate(a):null,Aa:l?l.evaluate(a):null};var b=h.evaluate(a),c=0;[r,n,p,q].forEach(function(b){b&&(c+=b.evaluate(a))});(null===x.za||null===x.Aa)&&c+x.W+x.za+x.Aa>b&&(null===x.za&&(x.za=0),null===x.Aa&&(x.Rd=0));null!==x.W&&null!==x.za&&null!==x.Aa&&(x.Aa=null);null===x.W&&null!==x.za&&null!==x.Aa?x.W=b-c-x.za-x.Aa:null!==x.W&&null===x.za&&null!==x.Aa?x.za=b-c-x.W-x.Aa:null!==x.W&&null!==x.za&&null===x.Aa?x.Aa=b-c-x.W-
...
h.toString(),I=Y(c,a,"column-count"),J=Y(c,a,"column-gap"),C=1<I?Y(c,a,"column-width"):q.width,h=zl(c,a),N=0,r=Al(c,a,"shape-inside"),qh=Pf(r,0,0,q.width,q.height,a),Wa=new bm(x,a,a.viewport,a.d,h,a.X,a.Q,a.style.u,a,b,a.la,a.ra),rh=0,Z=null;Re(function(b){for(;rh<I;){var c=rh++;if(1<I){var d=a.viewport.b.createElement("div");u(d,"position","absolute");p.appendChild(d);Z=new fk(d,Wa,a.f);Z.b=q.b;Z.fb=q.fb;Z.Nb=q.Nb;q.b?(u(d,"margin-left",q.h+"px"),u(d,"margin-right",q.H+"px"),c=c*(C+J)+q.j,Cj(Z,0,
q.width),Bj(Z,c,C)):(u(d,"margin-top",q.j+"px"),u(d,"margin-bottom",q.w+"px"),c=c*(C+J)+q.h,Bj(Z,0,q.height),Cj(Z,c,C));Z.B=e+q.h;Z.F=f+q.j}else Z=new fk(p,Wa,a.f),Aj(Z,q),q=Z;Z.A=n?[]:g;Z.Lb=qh;if(0<=Z.width){var h=M("inner");jn(a,Z,x).then(function(){Z.Q&&"column"!=Z.Q&&(rh=I,"region"!=Z.Q&&(a.F[x]=!0));Q(h,!0)});c=P(h)}else c=O(!0);if(c.ua()){c.then(function(){N=Math.max(N,Z.e);Te(b)});return}N=Math.max(N,Z.e)}R(b)}).then(function(){q.e=N;c.Sb(a,q,b,Z,I,a.f);Q(y,!0)});h=P(y)}else h=Al(c,a,"content"),
...
function Cn(a,b){this.e=a;this.g=this.d=this.b=this.h=this.f=null;this.k=b;this.j=null;this.B={};this.lang=null;this.u=0;this.l={};this.F=this.A=this.H=null;this.w={};Mn()&&(Kg["http://www.w3.org/1998/Math/MathML"]=!0)}function On(a,b){return a.k?b.substr(0,a.k.length)==a.k?decodeURI(b.substr(a.k.length)):null:b}
function Dn(a,b,c,d,e){a.f=b;var f=Ai(new Bi([b.b]),"package"),g=Ui(f,"unique-identifier")[0];g&&(g=Hi(b,b.url+"#"+g))&&(a.j=g.textContent.replace(/[ \n\r\t]/g,""));var h={};a.h=Na(Pi(Ai(Ai(f,"manifest"),"item")),function(c){var d=new En,e=b.url;d.id=c.getAttribute("id");d.src=ea(c.getAttribute("href"),e);d.d=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.f=f}(c=c.getAttribute("fallback"))&&!Nn[d.d]&&(h[d.src]=c);!a.A&&
d.f.nav&&(a.A=d);!a.F&&d.f["cover-image"]&&(a.F=d);return d});a.d=Ka(a.h,Fn);a.g=Ka(a.h,function(b){return On(a,b.src)});for(var k in h)for(g=k;;){g=a.d[h[g]];if(!g)break;if(Nn[g.d]){a.w[k]=g.src;break}g=g.src}a.b=Na(Pi(Ai(Ai(f,"spine"),"itemref")),function(b,c){var d=b.getAttribute("idref");if(d=a.d[d])d.g=b,d.D=c;return d});if(k=Ui(Ai(f,"spine"),"toc")[0])a.H=a.d[k];var g=Ui(Ai(Ai(Oi(Ai(Ai(new Bi([c.b]),"encryption"),"EncryptedData"),Ni()),"CipherData"),"CipherReference"),"URI"),l=Pi(Ai(Ai(f,"bindings"),
...
m.Bc=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=ea(f,a.url),g=c.getAttribute("media-type");if(!g){var h=On(b.b,f);h&&(h=b.b.g[h])&&(g=h.d)}if(g&&(h=b.b.B[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Ea(f),k=Ea(g),g=new Aa;g.append(h);g.append("?src=");g.append(f);g.append("&type=");g.append(k);for(h=c.firstChild;h;h=h.nextSibling)1==h.nodeType&&
...
io.prototype.B=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.u=null,this.j.addEventListener("resize",this.Q,!1),this.d=!0):this.j.removeEventListener("resize",this.Q,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.d=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:lo(this,b["margin-left"])||0,marginRight:lo(this,b["margin-right"])||0,marginTop:lo(this,b["margin-top"])||0,marginBottom:lo(this,b["margin-bottom"])||
0,width:lo(this,b.width)||0,height:lo(this,b.height)||0},200<=b.width||200<=b.height)&&(this.j.removeEventListener("resize",this.Q,!1),this.u=b,this.d=!0);"boolean"==typeof a.hyphenate&&(this.P.wc=a.hyphenate,this.d=!0);"boolean"==typeof a.horizontal&&(this.P.vc=a.horizontal,this.d=!0);"boolean"==typeof a.nightMode&&(this.P.Dc=a.nightMode,this.d=!0);"number"==typeof a.lineHeight&&(this.P.lineHeight=a.lineHeight,this.d=!0);"number"==typeof a.columnWidth&&(this.P.sc=a.columnWidth,this.d=!0);"string"==
typeof a.fontFamily&&(this.P.fontFamily=a.fontFamily,this.d=!0);"boolean"==typeof a.load&&(this.Y=a.load);"boolean"==typeof a.renderAllPages&&(this.Ic=a.renderAllPages);"string"==typeof a.userAgentRootURL&&(da=a.userAgentRootURL);"boolean"==typeof a.spreadView&&a.spreadView!==this.P.Ta&&(this.viewport=null,this.P.Ta=a.spreadView,this.d=!0);"number"==typeof a.pageBorder&&a.pageBorder!==this.P.zb&&(this.viewport=null,this.P.zb=a.pageBorder,this.d=!0);"number"==typeof a.zoom&&a.zoom!==this.h&&(this.h=
...
function to(a){if(a.b){a.b.Ub();for(var b=a.b.Eb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.Ya,e;e=d.shift();)e=e.J,e.parentNode.removeChild(e)}}a.viewport=ro(a);b=a.viewport.e;u(b,"width","");u(b,"height","");a.b=new Vn(a.g,a.viewport,a.la,a.P)}
function uo(a,b){a.H=!1;if(a.P.Ta)return ao(a.b).fc(function(c){mo(a);a.k=c;c.left&&(no(a,c.left),c.right||c.left.J.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(no(a,c.right),c.left||c.right.J.setAttribute("data-vivliostyle-unpaired-page",!0));var d=vo(a,c);qm(a.viewport,d.width*a.h,d.height*a.h);c.left&&ej(c.left,a.h);c.right&&ej(c.right,a.h);a.e=b;return O(null)});oo(a,b);wo(a,b);a.e=b;return O(null)}function wo(a,b){qm(a.viewport,b.b.width*a.h,b.b.height*a.h);ej(b,a.h)}
function vo(a,b){var c=0,d=0;b.left&&(c+=b.left.b.width,d=b.left.b.height);b.right&&(c+=b.right.b.width,d=Math.max(d,b.right.b.height));b.left&&b.right&&(c+=2*a.P.zb);return{width:c,height:d}}var xo={Id:"fit inside viewport"};
...
m.od=function(a){var b=Object.Tb({a:"configure"},Bo(a));this.b.l(b);Object.Tb(this.e,a)};m.rd=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});Qa(this.d,b)};m.Fd=function(a,b){this.d.addEventListener(a,b,!1)};m.Hd=function(a,b){this.d.removeEventListener(a,b,!1)};
m.vd=function(a,b,c){a||Qa(this.d,{type:"error",content:"No URL specified"});b=b||{};var d,e=b.userStyleSheet;e&&(d=e.map(function(a){return{url:a.url||null,text:a.text||null}}));c&&Object.Tb(this.e,c);a=Object.Tb({a:"loadXML",userAgentRootURL:this.f.userAgentRootURL,url:a,document:b.documentObject,fragment:b.fragment,userStyleSheet:d},Bo(this.e));Ao(this.b,a)};m.Xa=function(){return this.b.Xa()};
m.xd=function(a){a:switch(a){case "left":a="ltr"===this.Xa()?"previous":"next";break a;case "right":a="ltr"===this.Xa()?"next":"previous";break a}this.b.l({a:"moveTo",where:a})};m.wd=function(a){this.b.l({a:"moveTo",url:a})};m.Gd=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.P.Ta?vo(b,b.k):b.e.b;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ba("vivliostyle.viewer.Viewer",Co);Co.prototype.setOptions=Co.prototype.od;Co.prototype.addListener=Co.prototype.Fd;Co.prototype.removeListener=Co.prototype.Hd;Co.prototype.loadDocument=Co.prototype.vd;Co.prototype.getCurrentPageProgression=Co.prototype.Xa;Co.prototype.navigateToPage=Co.prototype.xd;Co.prototype.navigateToInternalUrl=Co.prototype.wd;Co.prototype.queryZoomFactor=Co.prototype.Gd;ba("vivliostyle.viewer.ZoomType",xo);xo.FIT_INSIDE_VIEWPORT="fit inside viewport";var Do=16,Eo="ltr";function Fo(a){window.adapt_command(a)}function Go(){Fo({a:"moveTo",where:"ltr"===Eo?"previous":"next"})}function Ho(){Fo({a:"moveTo",where:"ltr"===Eo?"next":"previous"})}
function Io(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)Fo({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)Fo({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)Fo({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)Fo({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)Ho(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)Go(),a.preventDefault();else if("0"===b||"U+0030"===c)Fo({a:"configure",fontSize:Math.round(Do)}),a.preventDefault();else if("t"===b||"U+0054"===c)Fo({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)Do*=1.2,Fo({a:"configure",fontSize:Math.round(Do)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)Do/=1.2,Fo({a:"configure",
fontSize:Math.round(Do)}),a.preventDefault()}
function Jo(a){switch(a.t){case "loaded":a=a.viewer;var b=Eo=a.Xa();a.ad.setAttribute("data-vivliostyle-page-progression",b);a.ad.setAttribute("data-vivliostyle-spread-view",a.P.Ta);window.addEventListener("keydown",Io,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Go,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Ho,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "error":v("Error: "+a.content);break;case "nav":(a=a.cfi)&&location.replace(ha(location.href,Ea(a||"")));break;case "hyperlink":a.internal&&Fo({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+n+"; margin: 0; }",document.head.appendChild(g));Ao(new io(window,l,"main",Jo),a)});
