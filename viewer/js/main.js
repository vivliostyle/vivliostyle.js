...
Gn.prototype.apply=function(a){var b=a.d,c=a.w,d=this.style;a=this.b;kh(b,c,d,a,null,null);if(d=d._marginBoxes){var c=ih(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);kh(b,f,d[e],a,null,null)}}};function Hn(a,b,c,d){pi.call(this,a,b,null,c,null,d,!1);this.f=""}t(Hn,pi);m=Hn.prototype;m.vb=function(){this.f+="@page ";this.gb()};m.$a=function(a,b){this.f+=b;b&&(this.b.push(new An(b)),this.d+=65536)};
