 ...
 *
 * Vivliostyle core 2019.1.103-pre.20190327123208
 */
(function(factory) {
...
function Jk(a,b,c){Object.keys(a.f).forEach(function(a){for(var b=this.f[a],c=0;c<b.length;)this.I.contains(b[c])?c++:b.splice(c,1);b.length||delete this.f[a]},a);for(var d=a.l,e=0;e<d.length;e++){var f=d[e];x(f.target,f.name,f.value.toString())}e=Kk(c,a.I);a.h.width=e.width;a.h.height=e.height;for(e=0;e<b.length;e++)if(c=b[e],f=a.f[c.sd],d=a.f[c.Hg],f&&d&&(f=Ek(f,c.action)))for(var g=0;g<d.length;g++)d[g].addEventListener(c.event,f,!1)}
...
function os(a,b,c,d){var e=!1,f=!1,g=a.marks;g&&(g=g.value,g.Ud()?g.values.forEach(function(a){a===jd?e=!0:a===kd&&(f=!0)}):g===jd?e=!0:g===kd&&(f=!0));if(e||f){var h=c.I,l=h.ownerDocument,k=b.$b,m=Vc(cs,d),p=Vc(ds,d),q=Vc(es,d);k&&(a=a["background-color"])&&a.value&&(c.g.style.backgroundColor=a.value.stringValue());e&&Object.keys(ks).forEach(function(a){a=ls(l,ks[a],m,q,k,p);h.appendChild(a)});f&&Object.keys(ms).forEach(function(a){a=ns(l,ms[a],m,q,p);h.appendChild(a)})}}
...
function Ft(a,b,c){var d=b.I===b.g;a.la={};c?(a.b=c.clone(),em(a.f,c.g)):(a.b=new pl,em(a.f,-1));a.lang&&b.g.setAttribute("lang",a.lang);c=a.b;c.page++;Rb(a,a.style.b);a.B=c.clone();var e=d?{}:Js(a.sa),f=ut(a,e);if(!f)return M(null);var g=0;if(!d){Gk(b,f.f.b.width.value===$d);Hk(b,f.f.b.height.value===ae);a.h.j=b;aq(a.h,e,a);var h=hs(gs(e),a);Gt(a,h,b);os(e,h,b,a);g=h.ac+h.$b}e=!d&&Hq(f,a,"writing-mode")||sd;a.G=e!=sd;var h=Hq(f,a,"direction")||Cd,l=new dn(a.Zb,"page",null,null,null,e,h),k=L("layoutNextPage");
Fe(function(c){Ct(a,b,f,b.g,g,g+1,[],l).then(function(){Jn(l)||Fn(l);Jn(l)?(a.b=a.B.clone(),l.Qc=!1,P(c)):Q(c)})}).then(function(){f.ca(a,b,a.g);if(!d){var e=new vc(f.f.f,"left-page");b.b=e.evaluate(a)?"left":"right";Dt(a);c=a.b;Object.keys(c.b).forEach(function(b){b=c.b[b];var d=b.f;!d||"page"!==d&&nt(a,d)||(b.f=null)})}a.b=a.B=null;c.g=a.f.b;Jk(b,a.style.j.N[a.da.url],a.g);Et(a,c)&&(c=null);O(k,c)});return k.result()}
function Gt(a,b,c){a.Y=b.jc;a.S=b.ic;a.Ba=b.jc+2*b.qe;a.ua=b.ic+2*b.qe;c.I.style.width=a.Ba+"px";c.I.style.height=a.ua+"px";c.g.style.left=b.ac+"px";c.g.style.right=b.ac+"px";c.g.style.top=b.ac+"px";c.g.style.bottom=b.ac+"px";c.g.style.padding=b.$b+"px";c.g.style.paddingTop=b.$b+1+"px"}function Ht(a,b,c,d){Kj.call(this,a.j,a,b,c,d,a.h,!c);this.g=a;this.F=!1}v(Ht,Kj);n=Ht.prototype;n.ce=function(){};
...
function ev(a,b,c){a.hc=!1;gv(a);if(a.$.ub)return Nu(a.b,a.f,c).ea(function(c){hv(a);a.j=c;c.left&&(iv(a,c.left),c.right?c.left.I.removeAttribute("data-vivliostyle-unpaired-page"):c.left.I.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(iv(a,c.right),c.left?c.right.I.removeAttribute("data-vivliostyle-unpaired-page"):c.right.I.setAttribute("data-vivliostyle-unpaired-page",!0));c=qv(a,c);a.viewport.zoom(c.width,c.height,a.D?rv(a,c):a.zoom);a.g=b;return M(null)});jv(a,b);a.viewport.zoom(b.h.width,
b.h.height,a.D?rv(a,b.h):a.zoom);a.g=b;return M(null)}function qv(a,b){var c=0,d=0;b.left&&(c+=b.left.h.width,d=b.left.h.height);b.right&&(c+=b.right.h.width,d=Math.max(d,b.right.h.height));b.left&&b.right&&(c+=2*a.$.Dc);return{width:c,height:d}}var sv={$g:"fit inside viewport"};function rv(a,b){return Math.min(a.viewport.width/b.width,a.viewport.height/b.height)}function tv(){this.name="RenderingCanceledError";this.message="Page rendering has been canceled";this.stack=Error().stack}v(tv,Error);
...
n.Rg=function(a){a:{var b=this.gb;if(!b.g)throw Error("no page exists.");switch(a){case "fit inside viewport":a=rv(b,b.$.ub?qv(b,b.j):b.g.h);break a;default:throw Error("unknown zoom type: "+a);}}return a};n.zg=function(){return this.gb.Z};oa("vivliostyle.viewer.Viewer",Hx);Hx.prototype.setOptions=Hx.prototype.jg;Hx.prototype.addListener=Hx.prototype.Pg;Hx.prototype.removeListener=Hx.prototype.Sg;Hx.prototype.loadDocument=Hx.prototype.Bg;Hx.prototype.loadPublication=Hx.prototype.Qg;
