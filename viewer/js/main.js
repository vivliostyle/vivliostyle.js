 ...
 *
 * Vivliostyle core 2016.4.1-pre.20160616012049
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
R=l.toString(),Q=Y(c,a,"column-count"),sa=Y(c,a,"column-gap"),Fa=1<Q?Y(c,a,"column-width"):q.width,l=gm(c,a),ia=0,t=hm(c,a,"shape-inside"),F=og(t,0,0,q.width,q.height,a),T=new Mm(R,a,a.viewport,a.d,l,a.Z,a.h,a.style.u,a,b,a.Sa,a.Za,h,a.Ya),zl=new mo(a.f,a.b.page-1),$h=0,ca=null;nf(function(b){for(;$h<Q;){var c=$h++;if(1<Q){var d=a.viewport.b.createElement("div");w(d,"position","absolute");r.appendChild(d);ca=new wn(d,T,a.e,zl);ca.b=q.b;ca.$a=q.$a;ca.kc=q.kc;q.b?(w(d,"margin-left",q.j+"px"),w(d,"margin-right",
