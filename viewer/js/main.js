 ...
 *
 * Vivliostyle core 2016.10.1-pre.20170113081719
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
Xa.prototype.h=function(a){if(1!=a.node.nodeType)throw Error("E_CFI_NOT_ELEMENT");var b=a.node,c=b.children,d=c.length,e=Math.floor(this.index/2)-1;0>e||!d?(c=b.firstChild,a.node=c||b):(c=c[Math.min(e,d-1)],this.index&1&&((b=c.nextSibling)&&1!=b.nodeType?c=b:a.L=!0),a.node=c);if(this.id&&(a.L||this.id!=Ra(a.node)))throw Error("E_CFI_ID_MISMATCH");a.jb=this.jb;return!0};function Za(a,b,c,d){this.offset=a;this.f=b;this.b=c;this.jb=d}
Za.prototype.h=function(a){if(0<this.offset&&!a.L){for(var b=this.offset,c=a.node;;){var d=c.nodeType;if(1==d)break;var e=c.nextSibling;if(3<=d&&5>=d){d=c.textContent.length;if(b<=d)break;if(!e){b=d;break}b-=d}if(!e){b=0;break}c=e}a.node=c;a.offset=b}a.jb=this.jb;return!0};
...
if(!c)throw Error("E_CFI_NUMBER_EXPECTED");e+=c[0].length;g=parseInt(c[1],10);(h=c[4])&&(h=Ua(h));var l=c[7];l&&(l=Ua(l));c=Va(c[10]);f.push(new Za(g,h,l,oa(c.s)));break;case "!":e++;f.push(new Wa);break;case "~":case "@":case "":a.ka=f;return;default:throw Error("E_CFI_PARSE_ERROR");}}function bb(a,b){for(var c={node:b.documentElement,offset:0,L:!1,jb:null,zc:null},d=0;d<a.ka.length;d++)if(!a.ka[d].h(c)){++d<a.ka.length&&(c.zc=new $a,c.zc.ka=a.ka.slice(d));break}return c}
...
ob(this,"pref-font-family",function(){return this.$.fontFamily});ob(this,"pref-night-mode",function(){return this.$.Cd});ob(this,"pref-hyphenate",function(){return this.$.wd});ob(this,"pref-margin",function(){return this.$.margin});ob(this,"pref-line-height",function(){return this.$.lineHeight});ob(this,"pref-column-width",function(){return this.$.rd*this.fontSize});ob(this,"pref-horizontal",function(){return this.$.vd});ob(this,"pref-spread-view",function(){return this.$.kb})}}
...
function vb(a,b,c,d){this.Ja=b;this.tb=c;this.M=null;this.Eb=function(){return this.M?this.M:this.$.kb?Math.floor(b/2)-this.$.dc:b};this.K=null;this.Db=function(){return this.K?this.K:c};this.u=d;this.W=null;this.fontSize=function(){return this.W?this.W:d};this.$=fb;this.G={}}function wb(a,b){a.G[b.u]={};for(var c=0;c<b.A.length;c++)wb(a,b.A[c])}
...
n.hd=function(){throw Error("E_CSS_COLOR_NOT_ALLOWED");};n.lc=function(){throw Error("E_CSS_URL_NOT_ALLOWED");};n.sb=function(){throw Error("E_CSS_LIST_NOT_ALLOWED");};n.Hb=function(){throw Error("E_CSS_COMMA_NOT_ALLOWED");};n.vb=function(){throw Error("E_CSS_FUNC_NOT_ALLOWED");};n.hc=function(){throw Error("E_CSS_EXPR_NOT_ALLOWED");};function nc(){}u(nc,mc);n=nc.prototype;
n.Jb=function(a){for(var b=null,c=0;c<a.length;c++){var d=a[c],e=d.aa(this);if(b)b[c]=e;else if(d!==e){b=Array(a.length);for(d=0;d<c;d++)b[d]=a[d];b[c]=e}}return b||a};n.Hc=function(a){return a};n.Ib=function(a){return a};n.Od=function(a){return a};n.kc=function(a){return a};n.jc=function(a){return a};n.ic=function(a){return a};n.hd=function(a){return a};n.lc=function(a){return a};n.sb=function(a){var b=this.Jb(a.values);return b===a.values?a:new oc(b)};
...
function he(a){if(!a.length)return J(!0);if(1==a.length)return a[0].get().ed(!0);var b=I("waitForFetches"),c=0;be(function(){for(;c<a.length;){var b=a[c++];if(!b.f)return b.get().ed(!0)}return J(!1)}).then(function(){M(b,!0)});return K(b)}
...
function Xe(a){a=a.responseText;return J(a?JSON.parse(a):null)};function Ye(a){var b=parseInt(a,16);if(isNaN(b))throw Error("E_CSS_COLOR");if(6==a.length)return new zc(b);if(3==a.length)return new zc(b&15|(b&15)<<4|(b&240)<<4|(b&240)<<8|(b&3840)<<8|(b&3840)<<12);throw Error("E_CSS_COLOR");}function Ze(a){this.f=a;this.Wa="Author"}n=Ze.prototype;n.tc=function(){return null};n.ga=function(){return this.f};n.error=function(){};n.fc=function(a){this.Wa=a};n.ub=function(){};n.qd=function(){};n.xc=function(){};n.yc=function(){};n.xd=function(){};n.Lc=function(){};
n.yb=function(){};n.pd=function(){};n.ld=function(){};n.ud=function(){};n.cc=function(){};n.rb=function(){};n.$c=function(){};n.Bc=function(){};n.dd=function(){};n.Yc=function(){};n.cd=function(){};n.ec=function(){};n.Ld=function(){};n.Vb=function(){};n.Zc=function(){};n.bd=function(){};n.ad=function(){};n.Ec=function(){};n.Dc=function(){};n.wa=function(){};n.pb=function(){};n.zb=function(){};n.Cc=function(){};n.Nc=function(){};
...
k);continue}m=k.text;R(h);k=O(h)}else p="";switch(k.type){case 39:case 45:case 44:case 43:case 42:case 46:case 50:q=k.type;R(h);k=O(h);break;case 15:g.Lc(p,m,0,null);a.b=f?kf:S;R(h);continue;default:a.b=sf;g.error("E_CSS_ATTR_OP_EXPECTED",k);continue}switch(k.type){case 1:case 2:g.Lc(p,m,q,k.text);R(h);k=O(h);break;default:a.b=sf;g.error("E_CSS_ATTR_VAL_EXPECTED",k);continue}if(15!=k.type){a.b=sf;g.error("E_CSS_ATTR",k);continue}a.b=f?kf:S;R(h);continue;case 11:g.pd();a.b=lf;R(h);continue;case 12:g.ld();
a.b=lf;R(h);continue;case 56:g.ud();a.b=lf;R(h);continue;case 13:a.W?(a.h.push("-epubx-region"),a.W=!1):a.V?(a.h.push("page"),a.V=!1):a.h.push("[selector]");g.wa();a.b=hf;R(h);continue;case 41:g.cc();a.b=mf;R(h);continue;case 15:l.push(C(k.text));R(h);continue;case 16:try{l.push(Ye(k.text))}catch(r){g.error("E_CSS_COLOR",k),a.b=qf}R(h);continue;case 17:l.push(new xc(k.I));R(h);continue;case 18:l.push(new yc(k.I));R(h);continue;case 19:l.push(new D(k.I,k.text));R(h);continue;case 20:l.push(new vc(k.text));
...
n.hd=function(a){return this.b&64?a:null};n.lc=function(a){return this.b&128?a:null};n.sb=function(){return null};n.Hb=function(){return null};n.vb=function(){return null};n.hc=function(){return null};var vg=new xg(0,T,T);
...
n.ic=function(a){return this.gb(a)};n.hd=function(a){return this.gb(a)};n.lc=function(a){return this.gb(a)};n.sb=function(){return null};n.Hb=function(){return null};n.vb=function(a){return this.gb(a)};n.hc=function(){return null};function Cg(a){Ag.call(this,a)}u(Cg,Ag);Cg.prototype.sb=function(a){var b=Bg(this,a.values,!1,0);return b===a.values?a:b?new oc(b):null};
...
function Kg(a,b){a.Yb([b]);return null}n.Nd=function(a){return Kg(this,a)};n.Hc=function(a){return Kg(this,a)};n.Ib=function(a){return Kg(this,a)};n.kc=function(a){return Kg(this,a)};n.jc=function(a){return Kg(this,a)};n.ic=function(a){return Kg(this,a)};n.hd=function(a){return Kg(this,a)};n.lc=function(a){return Kg(this,a)};n.sb=function(a){this.Yb(a.values);return null};n.Hb=function(){this.error=!0;return null};n.vb=function(a){return Kg(this,a)};n.hc=function(){this.error=!0;return null};
...
mi.prototype.pop=function(a,b){return b?!1:(a.K=this.f,!0)};function ni(a){this.element=a}u(ni,nc);function oi(a,b){switch(b){case "url":return a?new Ac(a):new Ac("about:invalid");default:return a?new vc(a):new vc("")}}
...
pi.prototype.Ib=function(a){var b=this.f,c=b.K,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.C)];b.C++;break;case "close-quote":return 0<b.C&&b.C--,c[2*Math.min(d,b.C)+1];case "no-open-quote":return b.C++,new vc("");case "no-close-quote":return 0<b.C&&b.C--,new vc("")}return a};
...
function Hi(a,b,c,d){this.A=a;this.l=b;this.Xb=c;this.lb=d;this.h=[[],[]];this.u={};this.G=this.F=this.b=null;this.sa=this.ha=this.V=this.j=this.f="";this.W=this.M=null;this.ra=this.Ta=!0;this.g={};this.H=[{}];this.K=[new vc("\u201c"),new vc("\u201d"),new vc("\u2018"),new vc("\u2019")];this.C=0;this.lang="";this.Nb=[0];this.Ja=0;this.pa=[{}];this.nb=this.pa[0];this.R=null;this.Lb=[this.R];this.Mb=[{}];this.mb=this.pa[0];this.tb=[]}function fi(a,b){a.u[b]=(a.u[b]||0)+1}
...
a.lang=d.toLowerCase();var d=a.ra,e=a.Nb;a.Ja=++e[e.length-1];e.push(0);var e=a.pa,f=a.nb=e[e.length-1],g=f[a.j];g||(g=f[a.j]={});g[a.f]=(g[a.f]||0)+1;e.push({});e=a.Lb;null!==e[e.length-1]?a.R=--e[e.length-1]:a.R=null;e.push(null);e=a.Mb;(f=a.mb=e[e.length-1])&&f[a.j]&&f[a.j][a.f]--;e.push({});Li(a);Ri(a,b);e=c.quotes;c=null;e&&(e=e.evaluate(a.l))&&(c=new mi(a.K),e===F?a.K=[new vc(""),new vc("")]:e instanceof oc&&(a.K=e.values));Ni(a,a.F);e=a.V||a.ha||b.getAttribute("name")||"";if(d||e){var h={};
...
Vi.prototype.ub=function(a,b){if(b||a)this.X+=1,b&&a?this.b.push(new Ih(a,b.toLowerCase())):b?this.b.push(new Hh(b.toLowerCase())):this.b.push(new Kh(a))};Vi.prototype.qd=function(a){this.h?(v.b("::"+this.h,"followed by ."+a),this.b.push(new bi(""))):(this.X+=256,this.b.push(new Eh(a)))};var Xi={"nth-child":Uh,"nth-of-type":Vh,"nth-last-child":Wh,"nth-last-of-type":Xh};
...
break;case "-adapt-footnote-content":case "footnote-content":this.A=!0;break;case "visited":case "active":case "hover":case "focus":this.b.push(new bi(""));break;case "lang":b&&1==b.length&&"string"==typeof b[0]?this.b.push(new Ph(new RegExp("^"+ma(b[0].toLowerCase())+"($|-)"))):this.b.push(new bi(""));break;case "nth-child":case "nth-last-child":case "nth-of-type":case "nth-last-of-type":c=Xi[a.toLowerCase()];b&&2==b.length?this.b.push(new c(b[0],b[1])):this.b.push(new bi(""));break;case "first-child":this.b.push(new Qh);
...
this.b.push(new bi(""))}this.X+=1};Vi.prototype.xd=function(a){this.X+=65536;this.b.push(new Gh(a))};
...
d?e=new Nh(a,b):(v.b("Unsupported :: attr selector op:",d),e=new bi(""));break;default:v.b("Unsupported attr selector:",c),e=new bi("")}this.b.push(e)};var Yi=0;n=Vi.prototype;n.yb=function(){var a="d"+Yi++;Wi(this,new Ch(new ei(a)));this.b=[new bi(a)]};n.pd=function(){var a="c"+Yi++;Wi(this,new Ch(new gi(a)));this.b=[new bi(a)]};n.ld=function(){var a="a"+Yi++;Wi(this,new Ch(new hi(a)));this.b=[new bi(a)]};n.ud=function(){var a="f"+Yi++;Wi(this,new Ch(new ii(a)));this.b=[new bi(a)]};
...
cj.prototype.fd=function(a,b){v.b("E_INVALID_PROPERTY",a+":",b.toString())};cj.prototype.qb=function(a,b,c){c=c?$e(this):af(this);c+=this.order;this.order+=Ei;th(this.Va,a,this.T?new ph(b,c,this.T):new U(b,c))};function dj(a,b){Ef.call(this,a);this.Va={};this.b=b;this.order=0}u(dj,Ef);dj.prototype.pb=function(a,b,c){ah(this.b,a,b,c,this)};dj.prototype.uc=function(a,b){v.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};dj.prototype.fd=function(a,b){v.b("E_INVALID_PROPERTY",a+":",b.toString())};
...
Mj.prototype.zoom=function(a){w(this.S,"transform","scale("+a+")")};Mj.prototype.M=function(){return this.K||this.S};function Sj(a){switch(a){case "normal":case "nowrap":return 0;case "pre-line":return 1;case "pre":case "pre-wrap":return 2;default:return null}}function Tj(a,b){if(1==a.nodeType)return!1;var c=a.textContent;switch(b){case 0:return!!c.match(/^\s*$/);case 1:return!!c.match(/^[ \t\f]*$/);case 2:return!c.length}throw Error("Unexpected whitespace: "+b);}
function Uj(a){this.f=a;this.b=[];this.J=null}function Vj(a,b,c,d,e,f,g,h,l){this.b=a;this.element=b;this.f=c;this.Ra=d;this.l=e;this.h=f;this.$e=g;this.j=h;this.cb=-1;this.g=l}function Wj(a,b){return a.h?!b.h||a.Ra>b.Ra?!0:a.j:!1}function Xj(a,b){return a.top-b.top}function Yj(a,b){return b.right-a.right}
function Zj(a,b){if(a===b)return!0;if(!a||!b||a.ea!==b.ea||a.L!==b.L||a.ka.length!==b.ka.length)return!1;for(var c=0;c<a.ka.length;c++){var d=a[c],e=b[c];if(!(d===e||d&&e&&d.node===e.node&&d.Sa===e.Sa&&d.ma===e.ma&&d.ya===e.ya&&d.va===e.va))return!1}return!0}function ak(a){return{ka:[{node:a.U,Sa:bk,ma:a.ma,ya:null,va:null}],ea:0,L:!1,Ia:a.Ia}}function ck(a,b){var c=new dk(a.node,b,0);c.Sa=a.Sa;c.ma=a.ma;c.ya=a.ya;c.va=a.va?ck(a.va,ek(b)):null;c.J=a.J;return c}var bk=0;
function fk(a,b,c,d,e,f,g){this.ia=a;this.Hd=d;this.ie=null;this.root=b;this.da=c;this.type=f;e&&(e.ie=this);this.b=g}function gk(a,b){this.Ye=a;this.count=b}
function dk(a,b,c){this.U=a;this.parent=b;this.na=c;this.ea=0;this.L=!1;this.Sa=bk;this.ma=b?b.ma:null;this.va=this.ya=null;this.W=!1;this.Ba=!0;this.b=!1;this.l=b?b.l:0;this.A=this.h=this.ha=this.display=null;this.K="baseline";this.M="top";this.nd=this.R=0;this.G=!1;this.Kb=b?b.Kb:0;this.j=b?b.j:null;this.u=b?b.u:!1;this.H=this.sc=!1;this.C=this.D=this.F=this.g=null;this.ob=b?b.ob:{};this.w=b?b.w:!1;this.V=b?b.V:"ltr";this.f=b?b.f:null;this.Ia=this.lang=null;this.J=b?b.J:null}
function hk(a){a.Ba=!0;a.l=a.parent?a.parent.l:0;a.D=null;a.C=null;a.ea=0;a.L=!1;a.display=null;a.h=null;a.A=null;a.K="baseline";a.G=!1;a.Kb=a.parent?a.parent.Kb:0;a.j=a.parent?a.parent.j:null;a.u=a.parent?a.parent.u:!1;a.g=null;a.F=null;a.ya=null;a.sc=!1;a.H=!1;a.w=a.parent?a.parent.w:!1;a.ya=null;a.Ia=null;a.J=a.parent?a.parent.J:null}
function ik(a){var b=new dk(a.U,a.parent,a.na);b.ea=a.ea;b.L=a.L;b.ya=a.ya;b.Sa=a.Sa;b.ma=a.ma;b.va=a.va;b.Ba=a.Ba;b.l=a.l;b.display=a.display;b.h=a.h;b.A=a.A;b.K=a.K;b.M=a.M;b.R=a.R;b.nd=a.nd;b.sc=a.sc;b.H=a.H;b.G=a.G;b.Kb=a.Kb;b.j=a.j;b.u=a.u;b.g=a.g;b.F=a.F;b.D=a.D;b.C=a.C;b.f=a.f;b.w=a.w;b.b=a.b;b.Ia=a.Ia;b.J=a.J;return b}dk.prototype.modify=function(){return this.W?ik(this):this};function ek(a){var b=a;do{if(b.W)break;b.W=!0;b=b.parent}while(b);return a}
dk.prototype.clone=function(){for(var a=ik(this),b=a,c;c=b.parent;)c=ik(c),b=b.parent=c;return a};function jk(a){return{node:a.U,Sa:a.Sa,ma:a.ma,ya:a.ya,va:a.va?jk(a.va):null,J:a.J}}function kk(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(jk(b)),b=b.parent;while(b);b=a.Ia?lk(a.Ia,a.ea,-1):a.ea;return{ka:c,ea:b,L:a.L,Ia:a.Ia}}function mk(a){for(a=a.parent;a;){if(a.sc)return!0;a=a.parent}return!1}function nk(a){for(a=a.parent;a;){if(a.H)return a;a=a.parent}return null}
...
function wk(a){this.element=a;this.R=this.M=this.height=this.width=this.H=this.A=this.K=this.u=this.Ja=this.pa=this.Ta=this.ha=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.Mb=this.V=null;this.sa=this.Nb=this.nb=this.Xb=this.g=0;this.w=!1}function xk(a){return a.marginTop+a.pa+a.A}function yk(a){return a.marginBottom+a.Ja+a.H}function zk(a){return a.marginLeft+a.ha+a.u}function Ak(a){return a.marginRight+a.Ta+a.K}
function Bk(a,b){a.element=b.element;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.ha=b.ha;a.Ta=b.Ta;a.pa=b.pa;a.Ja=b.Ja;a.u=b.u;a.K=b.K;a.A=b.A;a.H=b.H;a.width=b.width;a.height=b.height;a.M=b.M;a.R=b.R;a.Mb=b.Mb;a.V=b.V;a.g=b.g;a.Xb=b.Xb;a.nb=b.nb;a.w=b.w}function Ck(a,b,c){a.top=b;a.height=c;w(a.element,"top",b+"px");w(a.element,"height",c+"px")}
...
a.G.push(d);a.K==b&&(a.K=null);a.H&&kl(a.H,d,p);return d}function ll(a,b,c,d){Tk[b]&&(d=a.C[d].b,(!d.length||d[d.length-1]<c)&&d.push(c));a.W[c]=Rk(a.W[c],b)}
...
function Ml(a,b,c){this.na=a;this.f=b;this.b=c}function Nl(a){for(var b=1;b<a.length;b++){var c=a[b-1],d=a[b];c===d?v.b("validateCheckPoints: duplicate entry"):c.na>=d.na?v.b("validateCheckPoints: incorrect boxOffset"):c.U==d.U&&(d.L?c.L&&v.b("validateCheckPoints: duplicate after points"):c.L?v.b("validateCheckPoints: inconsistent after point"):d.na-c.na!=d.ea-c.ea&&v.b("validateCheckPoints: boxOffset inconsistent with offsetInNode"))}}function Ol(a){this.parent=a}Ol.prototype.le=function(){return"Block formatting context (adapt.layout.BlockFormattingContext)"};
Ol.prototype.xe=function(a,b){return b};Ol.prototype.me=function(){return this.parent};Ol.prototype.Zb=function(){return null};function Pl(a,b,c,d){wk.call(this,a);this.Td=a.lastChild;this.b=b;this.f=c;this.mb=d;this.Qe=a.ownerDocument;this.Ud=null;this.jd=!1;this.G=this.$a=this.za=this.ra=this.W=0;this.tb=this.Lb=this.C=this.lb=null;this.Yd=!1;this.l=this.h=this.F=null;this.se=!0;this.kd=this.od=this.md=0;this.j=!0}u(Pl,wk);
Pl.prototype.clone=function(){var a=new Pl(this.element,this.b,this.f,this.mb);Bk(a,this);a.Td=this.Td;a.jd=this.jd;a.C=this.C?this.C.clone():null;a.Lb=this.Lb.concat();return a};function Ll(a,b){return a.w?b<a.G:b>a.G}
Pl.prototype.Xd=function(a){var b=this,c=I("openAllViews"),d=a.ka;Ql(b.b,b.element,b.jd);var e=d.length-1,f=null;be(function(){for(;0<=e;){f=ck(d[e],f);e!==d.length-1||f.J||(f.J=b.Ud);if(!e){var c=f,h;h=a;h=h.Ia?lk(h.Ia,h.ea,1):h.ea;c.ea=h;f.L=a.L;f.Ia=a.Ia;if(f.L)break}c=Rl(b.b,f,!e&&!f.ea);e--;if(c.ua())return c}return J(!1)}).then(function(){M(c,f)});return K(c)};var Sl=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
function Tl(a,b){if(b.f&&b.Ba&&!b.L&&!b.f.count&&1!=b.D.nodeType){var c=b.D.textContent.match(Sl);return Ul(a.b,b,c[0].length)}return J(b)}
...
a.$a);q=m;a.w&&(q=cg(m));x=a.w?-1:1;q.ca<a.kd*x&&(t=q.Z-q.ca,q.ca=a.kd*x,q.Z=q.ca+t);hg(r,a.tb,q,e);a.w&&(m=new Mf(-q.Z,q.ja,-q.ca,q.ba));r=gm(a,d);w(d,"width",m.ba-m.ja-r.left-r.right+"px");w(d,"height",m.Z-m.ca-r.top-r.bottom+"px");w(d,"position","absolute");w(d,"display",b.display);x=null;p&&(p.H?x=p:x=nk(p));x?(r=x.D.ownerDocument.createElement("div"),r.style.position="absolute",x.w?r.style.right="0":r.style.left="0",r.style.top="0",x.D.appendChild(r),p=Rj(a.f,r),x.D.removeChild(r)):p={left:a.w?
a.$a:a.W,right:a.w?a.za:a.ra,top:a.w?a.W:a.za};(x?x.w:a.w)?w(d,"right",p.right-m.ba+a.K+"px"):w(d,"left",m.ja-p.left+a.u+"px");w(d,"top",m.ca-p.top+a.A+"px");b.C&&(b.C.parentNode.removeChild(b.C),b.C=null);p=a.w?m.ja:m.Z;m=a.w?m.ba:m.ca;Ll(a,p)&&a.F.length?(b=b.modify(),b.b=!0,M(c,b)):(am(a),r=new Mf(a.w?a.$a:a.W,a.w?a.W:a.za,a.w?a.za:a.ra,a.w?a.ra:a.$a),a.w&&(r=cg(r)),ig(r,a.tb,q,e),bm(a),"left"==e?a.md=p:a.od=p,a.kd=m,wm(a,p),M(c,k))}});return K(c)}
function xm(a,b){if(!a.L||a.Ba){for(var c=a.D,d="";c&&b&&!d&&(1!=c.nodeType||(d=c.style.textAlign,b));c=c.parentNode);if(!b||"justify"==d){var c=a.D,e=c.ownerDocument,d=e.createElement("span");d.style.visibility="hidden";var f=document.body;if(null===Qa){var g=f.ownerDocument,h=g.createElement("div");h.style.position="absolute";h.style.top="0px";h.style.left="0px";h.style.width="30px";h.style.height="100px";h.style.lineHeight="16px";h.style.fontSize="16px";h.style.textAlign="justify";f.appendChild(h);
...
function Cm(a,b){for(var c=0,d=0,e=b.length-1;0<=e;e--){var f=b[e];if(!f.L||!f.D||1!=f.D.nodeType)break;f=dm(a,f.D);f=a.w?-f.left:f.bottom;0<f?c=Math.max(c,f):d=Math.min(d,f)}return c-d}
...
function Nm(a,b,c,d){var e;if(!(e=!b))a:{for(e=b.D;e;){if(e.parentNode===e.ownerDocument){e=!1;break a}e=e.parentNode}e=!0}if(e)return!1;e=Cl(b,a.f,0,a.w);var f=b.L?b.parent&&b.parent.J:b.J;f&&(f=f.Zb())&&(e+=(a.w?-1:1)*Kl(f));f=Ll(a,e);c&&(e+=Cm(a,c));wm(a,e);c=ek(b);b=El(b.J).g(c,d,f,a.g);a.F.push(b);return f}
function Om(a,b){if(b.D.parentNode){var c=dm(a,b.D),d=b.D.ownerDocument.createElement("div");a.w?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.D.parentNode.insertBefore(d,b.D);var e=Rj(a.f,d),e=a.w?e.right:e.top,f=a.w?-1:1,g;switch(b.A){case "left":g=a.md;break;case "right":g=a.od;break;default:g=f*Math.max(a.od*f,a.md*f)}e*f>=g*f?b.D.parentNode.removeChild(d):(e=Math.max(1,(g-e)*f),a.w?d.style.width=
...
function Pm(a,b,c){function d(){b=m[0]||b;b.D.parentNode.removeChild(b.D);f.l=l}var e=b.L?b.parent&&b.parent.J:b.J;if(e&&!(e instanceof Ol))return J(b);var f=a,g=I("skipEdges"),h=c&&b&&b.L,l=null,k=null,m=[],p=[],q=!1;ce(function(a){for(;b;){do if(b.D){if(b.Ba&&1!=b.D.nodeType){if(Tj(b.D,b.Kb))break;if(!b.L){!c&&Tk[l]?d():Nm(f,k,null,l)?(b=(f.j?k||b:b).modify(),b.b=!0):(b=b.modify(),b.g=l);N(a);return}}if(!b.L&&(b.A&&Om(f,b),!(b.J instanceof Ol)||b.h||b.G)){m.push(ek(b));l=Rk(l,b.g);if(!c&&Tk[l])d();
else if(Nm(f,k,null,l)||!Xl(f.mb,b))b=(f.j?k||b:b).modify(),b.b=!0;N(a);return}if(1==b.D.nodeType){var e=b.D.style;if(b.L){if(q){if(!c&&Tk[l]){d();N(a);return}m=[];h=c=!1;l=null}q=!1;k=ek(b);p.push(k);l=Rk(l,b.F);if(e&&(!Mm(e.paddingBottom)||!Mm(e.borderBottomWidth))){if(Nm(f,k,null,l)&&(b=(f.j?k||b:b).modify(),b.b=!0,f.j)){N(a);return}p=[k];k=null}}else{m.push(ek(b));l=Rk(l,b.g);if(!Xl(f.mb,b)&&(Nm(f,k,null,l),b=b.modify(),b.b=!0,f.j)){N(a);return}if(Bl[b.D.localName]){!c&&Tk[l]?d():Nm(f,k,null,
...
function Lm(a,b){var c=ek(b),d=I("skipEdges"),e=null,f=!1;ce(function(d){for(;b;){do if(b.D){if(b.Ba&&1!=b.D.nodeType){if(Tj(b.D,b.Kb))break;if(!b.L){Tk[e]&&(a.l=e);N(d);return}}if(!b.L&&(b.h||b.G)){e=Rk(e,b.g);Tk[e]&&(a.l=e);N(d);return}if(1==b.D.nodeType){var g=b.D.style;if(b.L){if(f){if(Tk[e]){a.l=e;N(d);return}e=null}f=!1;e=Rk(e,b.F)}else{e=Rk(e,b.g);if(Bl[b.D.localName]){Tk[e]&&(a.l=e);N(d);return}if(g&&(!Mm(g.paddingTop)||!Mm(g.borderTopWidth))){N(d);return}}f=!0}}while(0);g=Wl(a.b,b);if(g.ua()){g.then(function(a){b=
a;ee(d)});return}b=g.get()}c=null;N(d)}).then(function(){M(d,c)});return K(d)}function Yl(a,b){return"footnote"==b.h?pm(a,b):rm(a,b)}function Qm(a,b,c){var d=I("layoutNext");Pm(a,b,c).then(function(c){b=c;!b||a.l||a.j&&b&&b.b?M(d,b):El(b.J).f(b,a).Da(d)});return K(d)}function Rm(a,b){do{var c=a.D.parentNode;if(!c)break;var d=c,e=a.D;if(d)for(var f;(f=d.lastChild)!=e;)d.removeChild(f);b&&(c.removeChild(a.D),b=!1);a=a.parent}while(a)}
function nm(a){var b=a.element.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.A+"px";b.style.right=a.K+"px";b.style.bottom=a.H+"px";b.style.left=a.u+"px";a.element.appendChild(b);var c=Rj(a.f,b);a.element.removeChild(b);var b=a.M+a.left+zk(a),d=a.R+a.top+xk(a);a.lb=new Mf(b,d,b+a.width,d+a.height);a.W=c?a.w?c.top:c.left:0;a.ra=c?a.w?c.bottom:c.right:0;a.za=c?a.w?c.right:c.top:0;a.$a=c?a.w?c.left:c.bottom:0;a.md=a.za;a.od=a.za;a.kd=a.za;a.G=a.$a;c=a.lb;b=a.M+a.left+zk(a);
...
Um.prototype.f=function(a,b){var c;if(a.h)c=Yl(b,a);else{a:if(a.L)c=!0;else{switch(a.U.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!a.G}c=c?Dm(b,a):Zl(b,a)}return c};Um.prototype.g=function(a,b,c,d){return new Jl(ek(a),b,c,d)};Um.prototype.b=function(a,b,c,d){c=c||!!b.D&&1==b.D.nodeType&&!b.L;Rm(b,c);d&&(xm(b,!0),Vm(c?b:b.parent));return Gm(a,b.na)};var Im=new Um;
Fd("RESOLVE_FORMATTING_CONTEXT",function(a,b,c,d,e,f){b=a.parent;return!b&&a.J?null:b&&a.J!==b.J?null:a.sc||!a.J&&Vk(c,d,e,f).display===Hc?new Ol(b?b.J:null):null});Fd("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof Ol?Im:null});function Wm(a,b){this.b=a;this.Y=b}function Xm(a,b,c,d){this.b=a;this.g=b;this.j=c;this.f=d;this.h=null}function Ym(a,b){this.b=a;this.f=b}function Zm(a){var b={};Object.keys(a).forEach(function(c){b[c]=Array.from(a[c])});return b}function $m(a,b){this.Wb=a;this.Ac=b;this.Fd=null;this.Y=this.N=-1}function Si(a,b,c){b=a.b.K.Md(b,a.f);a.b.l[b]=c}function an(a){return(a=a.match(/^[^#]*#(.*)$/))?a[1]:null}function bn(a,b){var c=a.b.K.Gc(ka(b,a.g),a.g);"#"===c.charAt(0)&&(c=c.substring(1));return c}
...
function En(a,b){this.f=a;this.b=b;this.K={};this.style={};this.A=this.C=null;this.u=[];this.M=this.R=this.g=this.h=!1;this.G=this.H=0;this.F=null;this.pa={};this.ha={};this.sa=this.w=!1;a&&a.u.push(this)}function Fn(a){a.H=0;a.G=0}function Gn(a,b,c){b=tn(a,b);c=tn(a,c);if(!b||!c)throw Error("E_INTERNAL");return y(a.b.f,b,c)}
...
function Kn(a,b){b.pa[a.b.l]=a;var c=a.b.f,d=a.style,e=a.f?Ln(a.f,b):null,e=fj(a.K,b,e,!1);a.w=ej(e,b,a.f?a.f.w:!1);gj(e,d,a.w,function(a,b){return b.value});a.C=new qb(c,function(){return a.H},"autoWidth");a.A=new qb(c,function(){return a.G},"autoHeight");a.yd();a.zd();In(a);Hn(a)}function Mn(a,b,c){(a=a.style[c])&&(a=Lf(b,a,c));return a}function Z(a,b,c){(a=a.style[c])&&(a=Lf(b,a,c));return Cc(a,b)}
function Ln(a,b){var c;a:{if(c=a.K["region-id"]){for(var d=[],e=0;e<c.length;e++){var f=c[e].evaluate(b,"");f&&f!==B&&d.push(f)}if(d.length){c=d;break a}}c=null}if(c){d=[];for(e=0;e<c.length;e++)d[e]=c[e].toString();return d}return null}function Nn(a,b,c,d,e){if(a=Mn(a,b,d))a.Rb()&&ub(a.fa)&&(a=new D(Cc(a,b),"px")),"font-family"===d&&(a=tl(e,a)),w(c,d,a.toString())}
...
En.prototype.Pc=function(a,b,c,d,e,f,g){this.w?this.H=b.g+b.Nb:this.G=b.g+b.sa;var h=(this.w||!d)&&this.g,l=(!this.w||!d)&&this.h;if(l||h)l&&w(b.element,"width","auto"),h&&w(b.element,"height","auto"),d=Rj(f,d?d.element:b.element),l&&(this.H=Math.ceil(d.right-d.left-b.u-b.ha-b.K-b.Ta),this.w&&(this.H+=b.Nb)),h&&(this.G=d.bottom-d.top-b.A-b.pa-b.H-b.Ja,this.w||(this.G+=b.sa));(this.w?this.g:this.h)&&Sn(this,a,b);if(this.w?this.h:this.g){if(this.w?this.M:this.R)this.w?Pn(this,a,b):Qn(this,a,b);this.w?
...
function Fo(a,b,c,d,e,f,g,h,l,k,m,p,q,x){this.F=a;this.b=b;this.viewport=c;this.A=c.b;this.l=d;this.H=e;this.da=f;this.G=g;this.u=h;this.K=l;this.page=k;this.g=m;this.C=p;this.f=q;this.h=x;this.M=this.B=null;this.j=!1;this.U=null;this.ea=0;this.D=null}Fo.prototype.clone=function(){return new Fo(this.F,this.b,this.viewport,this.l,this.H,this.da,this.G,this.u,this.K,this.page,this.g,this.C,this.f,this.h)};
function Go(a,b,c,d,e,f){var g=I("createRefShadow");a.da.u.load(b).then(function(h){if(h){var l=tj(h,b);if(l){var k=a.K,m=k.H[h.url];if(!m){var m=k.style.l.f[h.url],p=new vb(0,k.Eb(),k.Db(),k.u),m=new $k(h,m.g,m.f,p,k.l,m.u,new Ym(k.j,h.url),new Xm(k.j,h.url,m.f,m.b));k.H[h.url]=m}f=new fk(d,l,h,e,f,c,m)}}M(g,f)});return K(g)}
function Ho(a,b,c,d,e,f,g,h){var l=I("createShadows"),k=e.template,m;k instanceof Ac?m=Go(a,k.url,2,b,h,null):m=J(null);m.then(function(k){var m=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var p=b.getAttribute("href"),r=null;p?r=h?h.da:a.da:h&&(p="http://www.w3.org/1999/xhtml"==h.ia.namespaceURI?h.ia.getAttribute("href"):h.ia.getAttributeNS("http://www.w3.org/1999/xlink","href"),r=h.Hd?h.Hd.da:a.da);p&&(p=ka(p,r.url),m=Go(a,p,3,b,h,k))}m||(m=J(k));var t=null;
...
function Oo(a,b,c,d,e,f){for(var g=Ed.RESOLVE_FORMATTING_CONTEXT||[],h=0;h<g.length;h++){var l=g[h](a,b,c,d,e,f);if(l){a.J=l;break}}}
...
l["break-after"])a.B.F=k.toString();if(k=l["break-before"])a.B.g=k.toString()}a.B.K=l["vertical-align"]&&l["vertical-align"].toString()||"baseline";a.B.M=l["caption-side"]&&l["caption-side"].toString()||"top";k=l["border-collapse"];if(!k||k===C("separate"))if(t=l["border-spacing"])t.Rc()?(k=t.values[0],t=t.values[1]):k=t,k.Rb()&&(a.B.R=Cc(k,a.b)),t.Rb()&&(a.B.nd=Cc(t,a.b));if(k=l["x-first-pseudo"])a.B.f=new gk(a.B.parent?a.B.parent.f:null,k.I);if(k=l["white-space"])k=Sj(k.toString()),null!==k&&(a.B.Kb=
k);(k=l["hyphenate-character"])&&k!==Gc&&(a.B.j=k.gc);k=l["overflow-wrap"]||["word-wrap"];a.B.u=l["word-break"]===Nc||k===Oc;Oo(a.B,b,m,g,q,p);a.B.parent&&a.B.parent.J&&(b=a.B.parent.J.xe(a.B,b));var Ya=!1,pb=null,lc=[],va=f.namespaceURI,L=f.localName;if("http://www.w3.org/1999/xhtml"==va)"html"==L||"body"==L||"script"==L||"link"==L||"meta"==L?L="div":"vide_"==L?L="video":"audi_"==L?L="audio":"object"==L&&(Ya=!!a.g),f.getAttribute("data-adapt-pseudo")&&h.content&&h.content.value&&h.content.value.url&&
...
function $o(a){if(null==a.ma||"content"!=a.U.localName||"http://www.pyroxy.com/ns/shadow"!=a.U.namespaceURI)return a;var b=a.na,c=a.ma,d=a.parent,e,f;c.ie?(f=c.ie,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.Hd,e=c.ia.firstChild,c=2);var g=a.U.nextSibling;g?(a.U=g,hk(a)):a.va?a=a.va:e?a=null:(a=a.parent.modify(),a.L=!0);if(e)return b=new dk(e,d,b),b.ma=f,b.Sa=c,b.va=a,b;a.na=b;return a}
function ap(a){var b=a.na+1;if(a.L){if(!a.parent)return null;if(3!=a.Sa){var c=a.U.nextSibling;if(c)return a=a.modify(),a.na=b,a.U=c,hk(a),$o(a)}if(a.va)return a=a.va.modify(),a.na=b,a;a=a.parent.modify()}else{if(a.ya&&(c=a.ya.root,2==a.ya.type&&(c=c.firstChild),c))return b=new dk(c,a,b),b.ma=a.ya,b.Sa=a.ya.type,$o(b);if(c=a.U.firstChild)return $o(new dk(c,a,b));1!=a.U.nodeType&&(c=Xo(a.Ia),b+=c.length-1-a.ea);a=a.modify()}a.na=b;a.L=!0;return a}
function Wl(a,b,c){b=ap(b);if(!b||b.L)return J(b);var d=I("nextInTree");Rl(a,b,!0,c).then(function(a){b.D&&a||(b=b.modify(),b.L=!0,b.D||(b.Ba=!0));M(d,b)});return K(d)}function bp(a,b){if(b instanceof pc)for(var c=b.values,d=0;d<c.length;d++)bp(a,c[d]);else b instanceof Ac&&(c=b.url,a.page.j.push(ie(new Image,c)))}var cp={"box-decoration-break":!0,"flow-into":!0,"flow-linger":!0,"flow-priority":!0,"flow-options":!0,page:!0,"float-reference":!0};
function To(a,b,c){var d=c["background-image"];d&&bp(a,d);var d=c.position===jd,e;for(e in c)if(!cp[e]){var f=c[e],f=f.aa(new qg(a.da.url,a.h));f.Rb()&&ub(f.fa)&&(f=new D(Cc(f,a.b),"px"));Hj[e]||d&&Ij[e]?a.page.u.push(new Jj(b,e,f)):w(b,e,f.toString())}}function qm(a,b,c,d){if(!b.L){var e=(b.ma?b.ma.b:a.l).l(a.U,!1);if(e=e._pseudos)if(e=e[c])c={},b.w=Io(a,b.w,e,c),b=c.content,Fk(b)&&(b.aa(new Ek(d,a.b,b)),delete c.content),To(a,d,c)}}
function Ul(a,b,c){var d=I("peelOff"),e=b.f,f=b.ea,g=b.L;if(0<c)b.D.textContent=b.D.textContent.substr(0,c),f+=c;else if(!g&&b.D&&!f){var h=b.D.parentNode;h&&h.removeChild(b.D)}for(var l=b.na+c,k=[];b.f===e;)k.push(b),b=b.parent;var m=k.pop(),p=m.va;be(function(){for(;0<k.length;){m=k.pop();b=new dk(m.U,b,l);k.length||(b.ea=f,b.L=g);b.Sa=m.Sa;b.ma=m.ma;b.ya=m.ya;b.va=m.va?m.va:p;p=null;var c=Rl(a,b,!1);if(c.ua())return c}return J(!1)}).then(function(){M(d,b)});return K(d)}
...
"pt")));return b}function op(a,b){var c={},d=a.Pb.I*xb(b,a.Pb.fa,!1),e=a.wb.I*xb(b,a.wb.fa,!1),f=d+e,g=a.width;c.Eb=g===yd?(b.$.kb?Math.floor(b.Ja/2)-b.$.dc:b.Ja)-2*f:g.I*xb(b,g.fa,!1);g=a.height;c.Db=g===zd?b.tb-2*f:g.I*xb(b,g.fa,!1);c.Pb=d;c.wb=e;c.sd=f;return c}function pp(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
...
Dp.prototype.j=function(a,b){var c=this.K,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}vn.prototype.j.call(this,a,b)};Dp.prototype.yd=function(){var a=this.style;a.left=Ad;a["margin-left"]=Ad;a["border-left-width"]=Ad;a["padding-left"]=Ad;a["padding-right"]=Ad;a["border-right-width"]=Ad;a["margin-right"]=Ad;a.right=Ad};
Dp.prototype.zd=function(){var a=this.style;a.top=Ad;a["margin-top"]=Ad;a["border-top-width"]=Ad;a["padding-top"]=Ad;a["padding-bottom"]=Ad;a["border-bottom-width"]=Ad;a["margin-bottom"]=Ad;a.bottom=Ad};Dp.prototype.W=function(a,b,c){b=b.H;var d={start:this.l.marginLeft,end:this.l.marginRight,la:this.l.ac},e={start:this.l.marginTop,end:this.l.marginBottom,la:this.l.$b};Gp(this,b.top,!0,d,a,c);Gp(this,b.bottom,!0,d,a,c);Gp(this,b.left,!1,e,a,c);Gp(this,b.right,!1,e,a,c)};
...
b-c-t.la-t.Xa:null===t.la?(t.Xa=t.Ya=0,t.la=b-c):t.Xa=t.Ya=(b-c-t.la)/2;return t}var e=a.style;a=a.b.f;var f=b.Ad,g=b.Ed;b=b.la;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],l=Bn(a,e["margin-"+f],h),k=Bn(a,e["margin-"+g],h),m=An(a,e["padding-"+f],h),p=An(a,e["padding-"+g],h),q=Cn(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),x=Cn(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),r=Y(a,e[b],h),t=null;e[b]=new E(new qb(a,function(){var a=d(this).la;return null===a?0:a},b));e["margin-"+
f]=new E(new qb(a,function(){var a=d(this).Xa;return null===a?0:a},"margin-"+f));e["margin-"+g]=new E(new qb(a,function(){var a=d(this).Ya;return null===a?0:a},"margin-"+g));"left"===f?e.left=new E(y(a,c.marginLeft,c.ac)):"top"===f&&(e.top=new E(y(a,c.marginTop,c.$b)))}n.yd=function(){var a=this.f.l;this.l.Fa?Op(this,{Ad:"right",Ed:"left",la:"width"},a):this.l.Ga?Op(this,{Ad:"left",Ed:"right",la:"width"},a):this.qa({start:"left",end:"right",la:"width"},a)};
n.zd=function(){var a=this.f.l;this.l.Ha?Op(this,{Ad:"bottom",Ed:"top",la:"height"},a):this.l.Ea?Op(this,{Ad:"top",Ed:"bottom",la:"height"},a):this.qa({start:"top",end:"bottom",la:"height"},a)};n.Pc=function(a,b,c,d,e,f,g){zn.prototype.Pc.call(this,a,b,c,d,e,f,g);a=c.H;c=this.b.A;d=this.l;d.Fa||d.Ga?d.Ha||d.Ea||(d.Fa?a.left[c]=b:d.Ga&&(a.right[c]=b)):d.Ha?a.top[c]=b:d.Ea&&(a.bottom[c]=b)};
...
n.we=function(a){Fh(this.j.wc,"*",a)};n.Be=function(a){return new Zp(this.Va,a)};n.Ld=function(a){var b=uh(this.Va,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);cf(this.ia,new bq(this.f,this.ia,this.u,c))};function bq(a,b,c,d){df.call(this,a,b,!1);this.g=c;this.b=d}u(bq,ef);bq.prototype.pb=function(a,b,c){ah(this.g,a,b,c,this)};bq.prototype.uc=function(a,b){ff(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};bq.prototype.fd=function(a,b){ff(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
...
op(np(f[a]),this);this.sa[a]={width:b.Eb+2*b.sd,height:b.Db+2*b.sd}},a);return K(b)}function kl(a,b,c){if(a=a.b)a.f[b.b]||(a.f[b.b]=c),c=a.b[b.b],c||(c=new sk,a.b[b.b]=c),c.b.push(new rk(new pk({ka:[{node:b.element,Sa:bk,ma:null,ya:null,va:null}],ea:0,L:!1,Ia:null}),b))}function jq(a,b){for(var c=Number.POSITIVE_INFINITY,d=0;d<b.b.length;d++){for(var e=b.b[d].f.Pa,f=e.ka[0].node,g=e.ea,h=e.L,l=0;f.ownerDocument!=a.da.b;)l++,f=e.ka[l].node,h=!1,g=0;e=pj(a.da,f,g,h);e<c&&(c=e)}return c}
function kq(a,b,c){if(!b)return 0;var d=Number.POSITIVE_INFINITY,e;for(e in a.l){var f=b.b[e];if(!(c||f&&f.b.length)&&a.b){f=a.f;f.K=e;for(var g=0;null!=f.K&&(g+=5E3,hl(f,g,0)!=Number.POSITIVE_INFINITY););f=a.b.b[e];b!=a.b&&f&&(f=f.clone(),b.b[e]=f)}f&&(f=jq(a,f),f<d&&(d=f))}return d}function eq(a,b){switch(b){case "left":case "right":case "recto":case "verso":return(new bc(a.style.b,b+"-page")).evaluate(a);default:return!0}}
...
r.u+"px"),w(d,"margin-right",r.K+"px"),c=c*(Ya+W)+r.A,Dk(P,0,r.width),Ck(P,c,Ya)):(w(d,"margin-top",r.A+"px"),w(d,"margin-bottom",r.H+"px"),c=c*(Ya+W)+r.u,Ck(P,0,r.height),Dk(P,c,Ya));P.M=e+r.u;P.R=f+r.A}else P=new Pl(q,va,a.g,L),Bk(P,r),r=P;P.V=p?[]:g;P.Mb=lc;if(0<=P.width){var k=I("inner");nq(a,P,H).then(function(){P.l&&"column"!=P.l&&(Eb=G,"region"!=P.l&&(a.R[H]=!0));M(k,!0)});c=K(k)}else c=J(!0);if(c.ua()){c.then(function(){0<h.b.length?N(b):(pb=Math.max(pb,P.g),ee(b))});return}0<h.b.length||
(pb=Math.max(pb,P.g))}N(b)}).then(function(){r.g=pb;c.Pc(a,r,b,P,G,a.g,a.h);M(A,!0)});l=K(A)}else{if((l=Mn(c,a,"content"))&&Fk(l)){x="span";l.url&&(x="img");var Zi=a.viewport.b.createElement(x);l.aa(new Ek(Zi,a,l));q.appendChild(Zi);"img"==x&&ao(c,a,Zi,a.h);$n(c,a,r,a.h)}else c.sa&&(d.removeChild(q),t=!0);t||c.Pc(a,r,b,null,1,a.g,a.h);l=J(!0)}l.then(function(){if(!c.g||0<Math.floor(r.g)){if(!t&&!m){var l=r.M+r.left,p=r.R+r.top,x=zk(r)+r.width+Ak(r),A=xk(r)+r.height+yk(r),H=Mn(c,a,"shape-outside"),
...
h.b.length){l=l.concat(so(h));h.b.splice(0,h.b.length);c=a.b=a.A.clone();for(var e;e=b.g.lastChild;)b.g.removeChild(e);ee(d)}else N(d)})}).then(function(){e.W(a,b,a.g);var d=new bc(e.b.f,"left-page");b.l=d.evaluate(a)?"left":"right";var d=a.b.page,f;for(f in a.b.b)for(var g=a.b.b[f],h=g.b.length-1;0<=h;h--){var l=g.b[h];0<=l.b.cb&&l.b.cb+l.b.l-1<=d&&g.b.splice(h,1)}a.b=a.A=null;c.g=a.f.b;Qj(b,a.style.l.K[a.da.url],a.g);var t;a:{for(t in a.l)if((f=c.b[t])&&0<f.b.length){t=!1;break a}t=!0}t&&(c=null);
M(k,c)});return K(k)}function qq(a,b,c){a.M=b.Eb;a.K=b.Db;c.S.style.width=b.Eb+2*b.sd+"px";c.S.style.height=b.Db+2*b.sd+"px";c.g.style.left=b.wb+"px";c.g.style.right=b.wb+"px";c.g.style.top=b.wb+"px";c.g.style.bottom=b.wb+"px";c.g.style.padding=b.Pb+"px"}function rq(a,b,c,d){Vi.call(this,a.j,a,b,c,d,a.h,!c);this.g=a;this.C=!1}u(rq,Vi);n=rq.prototype;n.bd=function(){};n.ad=function(a,b,c){a=new un(this.g.u,a,b,c,this.g.G,this.T,af(this.ia));cf(this.g,new io(a.f,this.g,a,this.u))};
...
function sq(a){var b=a.getAttribute("content");if(!b)return"";a={};for(var c;c=b.match(/^,?\s*([-A-Za-z_.][-A-Za-z_0-9.]*)\s*=\s*([-+A-Za-z_0-9.]*)\s*/);)b=b.substr(c[0].length),a[c[1]]=c[2];b=a.width-0;a=a.height-0;return b&&a?"@-epubx-viewport{width:"+b+"px;height:"+a+"px;}":""}function tq(a){bf.call(this);this.h=a;this.j=new mb(null);this.u=new mb(this.j);this.G=new rn(this.j);this.K=new rq(this,null,null,null);this.M=0;this.A=[];this.C={};this.l={};this.H=[];this.F={};this.b=this.K}u(tq,bf);
tq.prototype.error=function(a){v.b("CSS parser:",a)};function uq(a,b){return vq(b,a)}function wq(a){Ve.call(this,uq,"document");this.M=a;this.H={};this.u={};this.f={};this.K={};this.l=null;this.b=[]}u(wq,Ve);function xq(a,b,c){yq(a,b,c);var d=ka("user-agent.xml",ja),e=I("OPSDocStore.init");bh.get().then(function(b){a.l=b;cq.get().then(function(){a.load(d).then(function(){M(e,!0)})})});return K(e)}function yq(a,b,c){a.b.splice(0);b&&b.forEach(a.R,a);c&&c.forEach(a.V,a)}
...
function vq(a,b){var c=I("OPSDocStore.load"),d=b.url;xj(b,a).then(function(b){if(b){for(var e=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),h=0;h<g.length;h++){var l=g[h],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=l.getAttribute("action"),l=l.getAttribute("ref");k&&m&&p&&l&&e.push({Xe:k,event:m,action:p,zc:l})}a.K[d]=e;var q=[];q.push({url:ka("user-agent-page.css",ja),text:null,Wa:"UA",
...
a.namespaceURI)return{name:Qq.dcterms+a.localName,order:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Jd:null,scheme:null};return null});var l=Ka(g,function(a){return a.Jd});g=d(Ka(g,function(a){return a.Jd?null:a.name}));var k=null;g[Rq]&&(k=g[Rq][0].v);c(g);return g}function Vq(){var a=window.MathJax;return a?a.Hub:null}var Wq={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function Kq(a,b){this.h=a;this.l=this.f=this.b=this.j=this.g=null;this.C=b;this.A=null;this.R={};this.lang=null;this.F=0;this.K={};this.V=this.M=this.W=null;this.G={};this.H=null;this.u=Xq(this);Vq()&&(fh["http://www.w3.org/1998/Math/MathML"]=!0)}
...
function br(a,b){return Ld("resolveFragment",function(c){if(b){var d=new $a;ab(d,b);var e;if(a.g){var f=bb(d,a.g.b);if(1!=f.node.nodeType||f.L||!f.zc){M(c,null);return}var g=f.node,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.f[h]){M(c,null);return}e=a.f[h];d=f.zc}else e=a.b[0];a.h.load(e.src).then(function(a){var b=bb(d,a.b);a=pj(a,b.node,b.offset,b.L);M(c,{N:e.N,Ca:a,Y:-1})})}else M(c,null)},function(a,d){v.b(d,"Cannot resolve fragment:",b);M(a,null)})}
...
function ir(a,b,c){var d=I("renderSinglePage"),e=jr(a,b,c);pq(b.bb,e,c).then(function(f){var g=(c=f)?c.page-1:b.Oa.length-1;hr(a,b,e,g);kn(a.f,e.N,g);f=null;if(c){var h=b.Oa[c.page];b.Oa[c.page]=c;h&&b.ib[c.page]&&(vk(c,h)||(f=ir(a,b,c)))}f||(f=J(!0));f.then(function(){var b=ln(a.f,e),f=0;ce(function(c){f++;if(f>b.length)N(c);else{var d=b[f-1];d.Vc=d.Vc.filter(function(a){return!a.Ac});d.Vc.length?kr(a,d.N).then(function(b){b?(jn(a.f,d.Fd),mn(a.f,d.Vc),ir(a,b,b.Oa[d.Y]).then(function(b){var d=a.f;
...
(d.complete=!0,b.vc.page.A=d.item.N===a.b.b.length-1);M(c,b.vc)})})}else M(c,null)});return K(c)}n.Kd=function(){return or(this,{N:this.b.b.length-1,Y:Number.POSITIVE_INFINITY,Ca:-1})};function or(a,b){var c=I("renderAllPages");b||(b={N:0,Y:0,Ca:0});var d=b.N,e=b.Y,f=0,g;ce(function(c){nr(a,{N:f,Y:f===d?e:Number.POSITIVE_INFINITY,Ca:f===d?b.Ca:-1}).then(function(a){g=a;++f>d?N(c):ee(c)})}).then(function(){M(c,g)});return K(c)}n.Pe=function(){return mr(this,{N:0,Y:0,Ca:-1})};
n.Re=function(){return mr(this,{N:this.b.b.length-1,Y:Number.POSITIVE_INFINITY,Ca:-1})};n.nextPage=function(a,b){var c=this,d=a.N,e=a.Y,f=I("nextPage");kr(c,d).then(function(a){if(a){if(a.complete&&e==a.Oa.length-1){if(d>=c.b.b.length-1){M(f,null);return}d++;e=0}else e++;mr(c,{N:d,Y:e,Ca:-1},b).Da(f)}else M(f,null)});return K(f)};n.Id=function(a){var b=a.N;if(a=a.Y)a--;else{if(!b)return J(null);b--;a=Number.POSITIVE_INFINITY}return mr(this,{N:b,Y:a,Ca:-1})};
function pr(a,b,c){b="left"===b.l;a="ltr"===a.Bb(c);return!b&&a||b&&!a}function qr(a,b,c){var d=I("getCurrentSpread"),e=gr(a,b);if(!e)return J({left:null,right:null});var f="left"===e.l;(pr(a,e,b)?a.Id(b):a.nextPage(b,c)).then(function(a){a=a&&a.page;f?M(d,{left:e,right:a}):M(d,{left:a,right:e})});return K(d)}n.We=function(a,b){var c=gr(this,a);if(!c)return J(null);var c=pr(this,c,a),d=this.nextPage(a,!!b);if(c)return d;var e=this;return d.xa(function(a){return a?e.nextPage(a.position,!!b):J(null)})};
n.Ze=function(a){var b=gr(this,a);if(!b)return J(null);b=pr(this,b,a);a=this.Id(a);if(b){var c=this;return a.xa(function(a){return a?c.Id(a.position):J(null)})}return a};function rr(a,b){var c=I("navigateToEPage");cr(a.b,b).then(function(b){b?mr(a,b).Da(c):M(c,null)});return K(c)}function sr(a,b){var c=I("navigateToCFI");br(a.b,b).then(function(b){b?mr(a,b).Da(c):M(c,null)});return K(c)}
...
0,width:Fr(this,b.width)||0,height:Fr(this,b.height)||0},200<=b.width||200<=b.height)&&(this.window.removeEventListener("resize",this.W,!1),this.C=b,this.La=!0);"boolean"==typeof a.hyphenate&&(this.$.wd=a.hyphenate,this.La=!0);"boolean"==typeof a.horizontal&&(this.$.vd=a.horizontal,this.La=!0);"boolean"==typeof a.nightMode&&(this.$.Cd=a.nightMode,this.La=!0);"number"==typeof a.lineHeight&&(this.$.lineHeight=a.lineHeight,this.La=!0);"number"==typeof a.columnWidth&&(this.$.rd=a.columnWidth,this.La=
!0);"string"==typeof a.fontFamily&&(this.$.fontFamily=a.fontFamily,this.La=!0);"boolean"==typeof a.load&&(this.ha=a.load);"boolean"==typeof a.renderAllPages&&(this.Kd=a.renderAllPages);"string"==typeof a.userAgentRootURL&&(ia=a.userAgentRootURL.replace(/resources\/?$/,""),ja=a.userAgentRootURL);"string"==typeof a.rootURL&&(ia=a.rootURL,ja=ia+"resources/");"string"==typeof a.pageViewMode&&a.pageViewMode!==this.V&&(this.V=a.pageViewMode,this.La=!0);"number"==typeof a.pageBorder&&a.pageBorder!==this.$.dc&&
(this.viewport=null,this.$.dc=a.pageBorder,this.La=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=a.zoom,this.Cb=!0);"boolean"==typeof a.fitToScreen&&a.fitToScreen!==this.F&&(this.F=a.fitToScreen,this.Cb=!0);Gr(this,a);return J(!0)};function Gr(a,b){(Ed.CONFIGURATION||[]).forEach(function(a){a=a(b);this.La=a.La||this.La;this.Cb=a.Cb||this.Cb}.bind(a))}n.Gd=function(a){var b=this.g,c=this.j,d=a.target;c?c.left!==d&&c.right!==d||Hr(this,a.Ee):b===a.target&&Hr(this,a.Ee)};
function Ir(a,b){var c=[];a.g&&c.push(a.g);a.j&&(c.push(a.j.left),c.push(a.j.right));c.forEach(function(a){a&&b(a)})}function Jr(a){Ir(a,function(a){a.removeEventListener("hyperlink",this.G,!1);a.removeEventListener("replaced",this.Gd,!1)}.bind(a))}function Kr(a){Jr(a);Ir(a,function(a){w(a.S,"display","none")});a.g=null;a.j=null}function Lr(a,b){b.addEventListener("hyperlink",a.G,!1);b.addEventListener("replaced",a.Gd,!1);w(b.S,"visibility","visible");w(b.S,"display","block")}
function Mr(a,b){Kr(a);a.g=b;Lr(a,b)}function Nr(a){var b=I("reportPosition");ar(a.h,a.f.N,a.f.Ca).then(function(c){var d=a.g;(a.ha&&0<d.j.length?he(d.j):J(!0)).then(function(){Or(a,d,c).Da(b)})});return K(b)}function Pr(a){var b=a.gd;if(a.C){var c=a.C;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new fp(a.window,a.fontSize,b,c.width,c.height)}return new fp(a.window,a.fontSize,b)}
function Qr(a){var b=Pr(a),c;a:switch(a.V){case "singlePage":c=!1;break a;case "spread":c=!0;break a;default:c=1.45<=b.width/b.height&&800<b.width}var d=a.$.kb!==c;a.$.kb=c;a.gd.setAttribute("data-vivliostyle-spread-view",c);if(a.C||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;if(!d&&b.width==a.viewport.width&&b.height==a.viewport.height)return!0;if(d=a.b&&vr(a.b)){a:{d=a.b.Ub;for(c=0;c<d.length;c++){var e=d[c];if(e)for(var e=e.ib,f=0;f<e.length;f++){var g=e[f];if(g.F&&g.C){d=!0;break a}}}d=
...
function Er(a){a.La=!1;a.Cb=!1;if(Qr(a))return J(!0);Ar(a,"loading");Dr(a);var b=Od(Gd.f,function(){return Ld("resize",function(c){a.l=b;Br.f("render (resize)");Rr(a);a.f&&(a.f.Y=-1);or(a.b,a.f).then(function(d){a.f=d.position;Hr(a,d.page,!0).then(function(){Nr(a).then(function(d){Ar(a,"interactive");(a.Kd?a.b.Kd():J(null)).then(function(){a.l===b&&(a.l=null);Br.b("render (resize)");Ar(a,"complete");zr(a,{t:"loaded"});M(c,d)})})})})},function(a,b){if(b instanceof Vr)Br.b("render (resize)"),v.debug(b.message);
...
xr.prototype.sa=function(a){var b=this;"complete"!==this.A&&Ar(this,"loading");if("string"==typeof a.where){switch(a.where){case "next":a=this.$.kb?this.b.We:this.b.nextPage;break;case "previous":a=this.$.kb?this.b.Ze:this.b.Id;break;case "last":a=this.b.Re;break;case "first":a=this.b.Pe;break;default:return J(!0)}if(a){var c=a;a=function(){return c.call(b.b,b.f)}}}else if("number"==typeof a.epage){var d=a.epage;a=function(){return rr(b.b,d)}}else if("string"==typeof a.url){var e=a.url;a=function(){return tr(b.b,
...
function is(a,b){var c=a.b,d=c.ve(b),e=I("LayoutIterator");ce(function(a){for(var b;d.B;){b=d.B.D?1!==d.B.D.nodeType?Tj(d.B.D,d.B.Kb)?void 0:d.B.L?void 0:c.He(d):d.B.Ba?void 0:d.B.L?c.mc(d):c.he(d):void 0;b=(b&&b.ua()?b:J(!0)).xa(function(){return d.xb?J(null):Wl(this.f,d.B,d.Kc)}.bind(this));if(b.ua()){b.then(function(b){d.xb?N(a):(d.B=b,ee(a))});return}if(d.xb){N(a);return}d.B=b.get()}N(a)}.bind(a)).then(function(){M(e,d.B)});return K(e)}function js(a){this.Sc=a}u(js,gs);n=js.prototype;n.Ie=function(){};
n.pe=function(){};n.ve=function(a){return{B:a,Kc:!!this.Sc&&a.L,xb:!1,Sc:this.Sc,oc:null,Dd:!1,Ae:[],ze:null}};n.He=function(a){a.Dd=!1};n.he=function(a){a.Ae.push(ek(a.B));a.oc=Rk(a.oc,a.B.g);a.Dd=!0;return this.Ie(a)};n.mc=function(a){var b;a.Dd?(b=(b=void 0,J(!0)),b=b.xa(function(){a.xb||(a.Ae=[],a.Sc=!1,a.Kc=!1,a.oc=null);return J(!0)})):b=(b=this.pe(a))&&b.ua()?b:J(!0);return b.xa(function(){a.xb||(a.Dd=!1,a.ze=ek(a.B),a.oc=Rk(a.oc,a.B.F));return J(!0)})};
function ks(a,b,c){this.ge=[];this.b=Object.create(a);this.b.element=b;this.b.b=a.b.clone();this.b.j=!1;this.b.Ud=c.J;a=Hm(this.b,c);this.b.G-=a;var d=this;this.b.Xd=function(a){return Pl.prototype.Xd.call(this,a).xa(function(a){var b=ek(a);d.ge.push(b);return J(a)})}}ks.prototype.Ab=function(a){var b=this.b.Ab();if(a){a=b.Mc?b.Mc.b():Number.MAX_VALUE;var c=this.ge[0],c=new Jl(ek(c),null,c.b,0),d=c.f(this.b,a);if(d&&c.b()<a)return{Mc:c,B:d}}return b};
...
var vs={now:Date.now},Br,ws=Br=new us(window&&window.performance||vs);ss.call(ws,"load_vivliostyle","start",void 0);ba("vivliostyle.profile.profiler",ws);us.prototype.printTimings=us.prototype.l;us.prototype.disable=us.prototype.u;us.prototype.enable=us.prototype.A;function xs(a,b,c){var d=a.B,e=d.display,f=d.parent?d.parent.display:null;return"table-row"===e&&!ys(f)&&"table"!==f&&"inline-table"!==f||"table-cell"===e&&"table-row"!==f&&!ys(f)&&"table"!==f&&"inline-table"!==f||d.J instanceof zs&&d.J!==b?Zl(c,d).xa(function(b){a.B=b;return J(!0)}):null}function ys(a){return"table-row-group"===a||"table-header-group"===a||"table-footer-group"===a}function As(a,b){this.rowIndex=a;this.U=b;this.b=[]}
function Bs(a){return Math.min.apply(null,a.b.map(function(a){return a.height}))}function Cs(a,b,c){this.rowIndex=a;this.h=b;this.g=c;this.b=c.colSpan||1;this.rowSpan=c.rowSpan||1;this.height=0;this.f=null}function Ds(a,b,c){this.rowIndex=a;this.b=b;this.qc=c}function Es(a,b,c){this.g=a;this.b=c;this.Uc=new ks(a,b,c);this.f=!1}Es.prototype.Ab=function(){var a=this.b.D,b=this.b.K;"middle"!==b&&"bottom"!==b||w(a,"vertical-align","top");var c=this.Uc.Ab(!0);w(a,"vertical-align",b);return c};
function Fs(a,b){this.D=a;this.b=b}function Gs(a,b,c,d){Jl.call(this,a,b,c,d);this.J=a.J;this.rowIndex=this.j=null}u(Gs,Jl);Gs.prototype.f=function(a,b){var c=Jl.prototype.f.call(this,a,b);return b<this.b()?null:Hs(this).every(function(a){return!!a.B})?c:null};Gs.prototype.b=function(){var a=Jl.prototype.b.call(this);Hs(this).forEach(function(b){a+=b.Mc.b()});return a};function Hs(a){a.j||(a.j=Is(a).map(function(a){return a.Ab()}));return a.j}
function Is(a){return Js(a.J,null!=a.rowIndex?a.rowIndex:a.rowIndex=Ks(a.J,a.position.U)).map(a.J.Zd,a.J)}function Ls(a,b,c){this.rowIndex=a;this.j=b;this.J=c;this.h=null}u(Ls,Fl);Ls.prototype.f=function(a,b){if(b<this.b())return null;var c=Ms(this),d=Ns(this);return d.every(function(a){return!!a.B})&&d.some(function(a,b){var d=a.B,e=c[b].Uc.ge[0];return!(e.D===d.D&&e.L===d.L&&e.ea===d.ea)})?this.j:null};
Ls.prototype.b=function(){var a=this.J,b=0;Os(a,a.f[this.rowIndex])||(b+=10);Ns(this).forEach(function(a){b+=a.Mc.b()});return b};function Ns(a){a.h||(a.h=Ms(a).map(function(a){return a.Ab()}));return a.h}Ls.prototype.g=function(){return Gl(this.j)};function Ms(a){return Ps(a.J,a.rowIndex).map(a.J.Zd,a.J)}function zs(a,b){this.parent=a;this.j=b;this.w=this.G=!1;this.u=-1;this.K=0;this.C=[];this.F=this.l=null;this.M=0;this.f=[];this.H=[];this.h=[];this.A=null;this.b=[];this.g=null}n=zs.prototype;
n.le=function(){return"Table formatting context (vivliostyle.table.TableFormattingContext)"};n.xe=function(a,b){if(!b)return b;switch(a.display){case "table-row":return!this.b.length;case "table-cell":return!this.b.some(function(b){return b.Rd.ka[0].node===a.U});default:return b}};n.me=function(){return this.parent};function Qs(a,b){do if(b.U===a.j)return b.D;while(b=b.parent);return null}function Rs(a,b){var c=a.H[b];c||(c=a.H[b]=[]);return c}
function Ks(a,b){return a.f.findIndex(function(a){return b===a.U})}function Ps(a,b){return Rs(a,b).reduce(function(a,b){return b.qc!==a[a.length-1]?a.concat(b.qc):a},[])}function Js(a,b){return Ps(a,b).filter(function(a){return a.rowIndex+a.rowSpan-1>b})}n.Zd=function(a){return this.h[a.rowIndex][a.h]};function Os(a,b){return Bs(b)>a.K/2}function Ss(a){0>a.u&&(a.u=Math.max.apply(null,a.f.map(function(a){return a.b.reduce(function(a,b){return a+b.b},0)})));return a.u}
function Ts(a,b){a.f.forEach(function(a){a.b.forEach(function(a){var c=Rj(b,a.g);a.g=null;a.height=this.w?c.width:c.height},this)},a)}n.Zb=function(){return this.g};function Us(a,b){this.J=a;this.h=b;this.rowIndex=-1;this.f=0;this.g=!1}u(Us,gs);
Us.prototype.he=function(a){var b=this.J,c=xs(a,b,this.h);if(c)return c;a=a.B;switch(a.display){case "table":b.M=a.R;break;case "table-caption":b.C.push(new Fs(a.D,a.M));break;case "table-header-group":this.b=!0;b=b.g;b.f||(b.f=a.D);break;case "table-footer-group":this.b=!0;b=b.g;b.b||(b.b=a.D);break;case "table-row":this.b||(this.g=!0,this.rowIndex++,this.f=0,b.f[this.rowIndex]=new As(this.rowIndex,a.U))}return J(!0)};
Us.prototype.mc=function(a){var b=this.J,c=a.B,d=c.display,e=this.h.f;if(c.U===b.j)c=em(e,Qs(b,c)),b.K=parseFloat(c[b.w?"height":"width"]),a.xb=!0;else switch(d){case "table-header-group":case "table-footer-group":this.b=!1;break;case "table-row":this.b||(b.A=c.D,this.g=!1);break;case "table-cell":if(!this.b){this.g||(this.rowIndex++,this.f=0,this.g=!0);a=this.rowIndex;c=new Cs(this.rowIndex,this.f,c.D);d=b.f[a];d||(b.f[a]=new As(a,null),d=b.f[a]);d.b.push(c);for(var d=a+c.rowSpan,e=Rs(b,a),f=0;e[f];)f++;
for(;a<d;a++)for(var e=Rs(b,a),g=f;g<f+c.b;g++){var h=e[g]=new Ds(a,g,c);c.f||(c.f=h)}this.f++}}};function Vs(a,b){this.Sc=!0;this.J=a;this.f=b;this.l=!1;this.b=-1;this.g=0;this.u=b.j;b.j=!1}u(Vs,js);var Ws={"table-caption":!0,"table-column-group":!0,"table-column":!0,"table-header-group":!0,"table-footer-group":!0};
function Xs(a,b,c,d){var e=b.rowIndex,f=b.h,g=c.D;if(1<b.b){w(g,"box-sizing","border-box");for(var h=a.J.F,l=0,k=0;k<b.b;k++)l+=h[b.f.b+k];l+=a.J.M*(b.b-1);w(g,a.J.w?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new Es(a.f,b,c);a=a.J;(g=a.h[e])||(g=a.h[e]=[]);g[f]=c;1===d.Pa.ka.length&&d.Pa.L&&(c.f=!0);return om(c.Uc.b,d,!0).ed(!0)}function Ys(a,b){var c=a.J.b[0];return c?c.qc.f.b===b:!1}
function Zs(a){var b=a.J.b;if(!b.length)return[];var c=[],d=0;do{var e=b[d],f=e.qc.rowIndex;if(f<a.b){var g=c[f];g||(g=c[f]=[]);g.push(e);b.splice(d,1)}else d++}while(d<b.length);return c}
function $s(a,b){var c=a.J,d=Zs(a),e=d.reduce(function(a){return a+1},0);if(0===e)return J(!0);var f=a.f.b,g=b.B;g.D.parentNode.removeChild(g.D);var h=I("layoutRowSpanningCellsFromPreviousFragment"),l=J(!0),k=0,m=[];d.forEach(function(a){l=l.xa(function(){var b=ck(a[0].Rd.ka[1],g.parent);return Rl(f,b,!1).xa(function(){function d(a){for(;h<a;){if(!(0<=m.indexOf(h))){var c=b.D.ownerDocument.createElement("td");w(c,"padding","0");b.D.appendChild(c)}h++}}var g=J(!0),h=0;a.forEach(function(a){g=g.xa(function(){var c=
a.qc;d(c.f.b);var g=a.Rd,l=ck(g.ka[0],b);l.ea=g.ea;l.L=g.L;return Rl(f,l,!1).xa(function(){for(var b=a.oe,d=0;d<c.b;d++)m.push(h+d);h+=c.b;return Xs(this,c,l,b).xa(function(){l.D.rowSpan=c.rowIndex+c.rowSpan-this.b+e-k;return J(!0)}.bind(this))}.bind(this))}.bind(this))},this);return g.xa(function(){d(Ss(c));k++;return J(!0)})}.bind(this))}.bind(this))},a);l.then(function(){Rl(f,g,!0,b.Kc).then(function(){M(h,!0)})});return K(h)}
function at(a,b){if(a.j||a.h)return J(!0);var c=b.B,d=a.J;0>a.b?a.b=Ks(d,c.U):a.b++;a.g=0;a.l=!0;return $s(a,b).xa(function(){Nm(this.f,b.ze,null,b.oc)&&!Js(d,this.b-1).length&&(this.f.j=this.u,c.b=!0,b.xb=!0);return J(!0)}.bind(a))}
function bt(a,b){if(a.j||a.h)return J(!0);var c=b.B;a.l||(0>a.b?a.b=0:a.b++,a.g=0,a.l=!0);var d=a.J.f[a.b].b[a.g],e=ek(c).modify();e.L=!0;b.B=e;var f=I("startTableCell");Ys(a,d.f.b)?(e=a.J.b.shift(),e=J(e.oe)):e=Wl(a.f.b,c,b.Kc).xa(function(a){a.D&&c.D.removeChild(a.D);return J(new pk(ak(a)))});e.then(function(a){Xs(this,d,c,a).then(function(){this.mc(b);this.g++;M(f,!0)}.bind(this))}.bind(a));return K(f)}
Vs.prototype.Ie=function(a){var b=xs(a,this.J,this.f);if(b)return b;b=a.B.display;return"table-header-group"===b?(this.j=!0,J(!0)):"table-footer-group"===b?(this.h=!0,J(!0)):"table-row"===b?at(this,a):"table-cell"===b?bt(this,a):J(!0)};Vs.prototype.pe=function(a){a=a.B;"table-row"===a.display&&(this.l=!1,this.j||this.h||(a=ek(a).modify(),a.L=!1,this.f.F.push(new Ls(this.b,a,this.J))));return J(!0)};
Vs.prototype.mc=function(a){var b=a.B,c=b.display;"table-header-group"===c?this.j=!1:"table-footer-group"===c&&(this.h=!1);if(c&&Ws[c])b.D.parentNode.removeChild(b.D);else if(b.U===this.J.j)this.f.j=this.u,a.xb=!0;else return js.prototype.mc.call(this,a);return J(!0)};function ct(){}
...
function gt(a,b,c,d){if(a.length<c){var e=d.ownerDocument.createElement("colgroup");b.push(e);for(b=a.length;b<c;b++){var f=d.ownerDocument.createElement("col");e.appendChild(f);a.push(f)}}}function ht(a,b,c){var d=a.w,e=a.A;if(e){a.A=null;var f=e.ownerDocument.createDocumentFragment(),g=Ss(a);if(0<g){var h=a.F=dt(e,g,d,c.f);c=et(b);e=ft(c);gt(e,c,g,b);e.forEach(function(a,b){w(a,d?"height":"width",h[b]+"px")});c.forEach(function(a){f.appendChild(a.cloneNode(!0))})}a.l=f}}
function it(a,b,c){var d=b.J;d.w=b.w;d.g=new ls(d.w);var e=I("TableLayoutProcessor.doInitialLayout");is(new hs(new Us(b.J,c),c.b),b).then(function(a){var b=a.D,f=Rj(c.f,b);Ll(c,c.w?f.left:f.bottom)?(ht(d,b,c),Ts(d,c.f),a=d.g,b=c.f,a.f&&(a.F=ms(a,a.f,b)),a.b&&(a.C=ms(a,a.b,b)),M(e,null)):M(e,a)}.bind(a));return K(e)}function jt(a,b,c){var d=a.C;d.forEach(function(a,f){a&&(b.insertBefore(a.D,c),"top"===a.b&&(d[f]=null))})}
function kt(a,b){if(a.l&&b){var c=et(b);c&&c.forEach(function(a){b.removeChild(a)})}}ct.prototype.f=function(a,b){var c=a.J,d=I("TableLayoutProcessor.layout"),e=lt(a,c),f=ek(a),g=[].concat(c.b),h=[].concat(b.F);e.g(this,a,b).then(function(l){var k=e.f(l,c,b);e.b(l,c,k);if(k)M(d,l);else{for(l=f.D||f.parent.D;k=l.lastChild;)l.removeChild(k);for(;k=l.nextSibling;)k.parentNode.removeChild(k);kt(c,Qs(c,f));b.F=h;c.h=[];c.b=g;this.f(a,b).Da(d)}}.bind(this));return K(d)};
ct.prototype.g=function(a,b,c,d){return new Gs(a,b,c,d)};
ct.prototype.b=function(a,b){var c=b.J,d=c.g;d.j||b.U===c.j&&b.L||ps(d);if("table-row"===b.display){var e=Ks(c,b.U);c.b=[];var f;f=b.L?Js(c,e):Ps(c,e);if(f.length){var g=I("TableLayoutProcessor.finishBreak"),h=0;ce(function(a){if(h===f.length)N(a);else{var b=f[h++],d=c.Zd(b),g=d.Ab().B,l=d.b,x=kk(l),r=new pk(kk(g));c.b.push({Rd:x,oe:r,qc:b});l=l.D;Vm(d.b);e<b.rowIndex+b.rowSpan-1&&(l.rowSpan=e-b.rowIndex+1);d.f?ee(a):Bm(d.Uc.b,g,!1,!0).then(function(){var b=c.Zb();if(b){var e=c.w,f=d.g,g=d.Uc.b.element,
h=d.b.D,k=Rj(f.f,h),h=fm(f,h);e?w(g,"max-width",k.right-f.G-Kl(b)-h.right+"px"):w(g,"max-height",f.G-Kl(b)-k.top-h.top+"px");w(g,"overflow","hidden")}ee(a)})}}).then(function(){d&&ns(d);c.h=[];Rm(b,!1);Vm(b);M(g,!0)});return K(g)}}d&&ns(d);c.h=[];return null};function lt(a,b){if(b.G){var c=b.Zb();a.U===b.j&&!a.L&&c&&(c.h=!1,c.l=!1);return new mt}return new nt}function nt(){}nt.prototype.g=function(a,b,c){return it(a,b,c)};nt.prototype.f=function(a){return!!a};nt.prototype.b=function(a,b){b.G=!0};
function mt(){}mt.prototype.g=function(a,b,c){a=b.J;var d=a.g,e=Qs(a,b),f=e.firstChild;jt(a,e,f);a.l&&e.insertBefore(a.l.cloneNode(!0),f);if(d.f&&!d.h){var g=d.f.cloneNode(!0);d.A.push(g);e.insertBefore(g,f)}d.b&&!d.g&&(g=d.b.cloneNode(!0),d.u.push(g),e.insertBefore(g,f));a=new Vs(a,c);c=new hs(a,c.b);a=I("TableFormattingContext.doLayout");is(c,b).Da(a);return K(a)};
mt.prototype.f=function(a,b,c){var d=b.Zb();if(!d)return!0;c=c.Ab();return a.U===b.j&&a.L&&d.g?(d.g=!1,d.j=!1):!d.g&&d.j&&d.b||!d.h&&d.l&&d.f?!!c.B&&!c.B.b:!0};mt.prototype.b=function(a,b,c){(a=b.Zb())&&!c&&(os(a),ps(a),!a.g&&a.j&&a.b?a.g=!0:!a.h&&a.l&&a.f&&(a.h=!0))};var ot=new ct;Fd("RESOLVE_FORMATTING_CONTEXT",function(a,b,c){return b?c===od?(b=a.parent,new zs(b?b.J:null,a.U)):null:null});Fd("RESOLVE_LAYOUT_PROCESSOR",function(a){return a instanceof zs?ot:null});Array.from||(Array.from=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e],e):a[e];return c});
...
function zt(a){switch(a.t){case "loaded":a=a.viewer;var b=ut=a.Bb();a.gd.setAttribute("data-vivliostyle-page-progression",b);a.gd.setAttribute("data-vivliostyle-spread-view",a.$.kb);window.addEventListener("keydown",yt,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",wt,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",xt,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
