 ...
 *
 * Vivliostyle core 2016.4.1-pre.20160420081837
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function ci(a,b,c,d,e,f,g){this.Y=a;this.Uc=d;this.pd=null;this.root=b;this.ba=c;this.type=f;e&&(e.pd=this);this.b=g}function di(a,b){this.Rd=a;this.count=b}function ei(a,b,c){this.Z=a;this.parent=b;this.ga=c;this.ca=0;this.L=!1;this.Na=0;this.da=b?b.da:null;this.qa=this.xa=null;this.H=!1;this.b=!0;this.e=!1;this.h=b?b.h:0;this.w=this.j=this.N=null;this.A=!1;this.k=b?b.k:0;this.l=b?b.l:!1;this.C=this.D=this.g=null;this.u=b?b.u:{};this.f=b?b.f:!1;this.F=b?b.F:"ltr";this.d=b?b.d:null}
function fi(a){a.b=!0;a.h=a.parent?a.parent.h:0;a.C=null;a.ca=0;a.L=!1;a.j=null;a.w=null;a.A=!1;a.k=a.parent?a.parent.k:0;a.g=null;a.D=null;a.xa=null;a.l=a.parent?a.parent.l:!1;a.f=a.parent?a.parent.f:!1;a.xa=null}function gi(a){var b=new ei(a.Z,a.parent,a.ga);b.ca=a.ca;b.L=a.L;b.xa=a.xa;b.Na=a.Na;b.da=a.da;b.qa=a.qa;b.b=a.b;b.h=a.h;b.j=a.j;b.w=a.w;b.l=a.l;b.A=a.A;b.k=a.k;b.g=a.g;b.D=a.D;b.C=a.C;b.d=a.d;b.f=a.f;b.e=a.e;return b}ei.prototype.modify=function(){return this.H?gi(this):this};
...
function Cm(a,b,c){var d=b.e,e;if(c)e=c=1;else{for(e=d[0];e.parent&&e.b;)e=e.parent;c=Math.max((e.u.widows||2)-0,1);e=Math.max((e.u.orphans||2)-0,1)}var f=hn(a,d),g=a.oa,d=Qa(f.length,function(b){return a.b?f[b]<g:f[b]>g}),d=Math.min(f.length-c,d);if(d<e)return null;g=f[d-1];if(b=jn(a,b.e,g))a.e=(a.b?-1:1)*(g-a.Ga);return b}
...
function tn(a,b,c){function d(){b=k[0]||b;b.C.parentNode.removeChild(b.C);e.u=h}var e=a,f=L("skipEdges"),g=c&&b&&b.L,h=null,l=null,k=[],m=[],p=!1;lf(function(a){for(;b;){do if(b.C){if(b.b&&1!=b.C.nodeType){if(Yh(b.C,b.k))break;if(!b.L){!c&&wm[h]?d():rn(e,l,null,!0,h)?(b=(l||b).modify(),b.e=!0):(b=b.modify(),b.g=h);P(a);return}}if(!b.L&&(b.w&&sn(e,b),b.j||b.A)){k.push(hi(b));h=ym(h,b.g);!c&&wm[h]?d():rn(e,l,null,!0,h)&&(b=(l||b).modify(),b.e=!0);P(a);return}if(1==b.C.nodeType){var f=b.C.style;if(b.L){if(p){if(!c&&
...
function pn(a,b){var c=b,d=L("skipEdges"),e=null,f=!1;lf(function(d){for(;b;){do if(b.C){if(b.b&&1!=b.C.nodeType){if(Yh(b.C,b.k))break;if(!b.L){wm[e]&&(a.u=e);P(d);return}}if(!b.L&&(b.j||b.A)){e=ym(e,b.g);wm[e]&&(a.u=e);P(d);return}if(1==b.C.nodeType){var h=b.C.style;if(b.L){if(f){if(wm[e]){a.u=e;P(d);return}e=null}f=!1;e=ym(e,b.D)}else{e=ym(e,b.g);if(zm[b.C.localName]){wm[e]&&(a.u=e);P(d);return}if(h&&(!qn(h.paddingTop)||!qn(h.borderTopWidth))){P(d);return}}f=!0}}while(0);h=om(a.g,b);if(h.Aa()){h.then(function(a){b=
