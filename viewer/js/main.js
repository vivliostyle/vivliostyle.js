 ...
 *
 * Vivliostyle core 2017.2.1-pre.20170412033653
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function pk(a,b,c,d,e,f,g){this.ka=a;this.Tc=d;this.Oe=null;this.root=b;this.fa=c;this.type=f;e&&(e.Oe=this);this.b=g}function ik(a,b){return a===b||!!a&&!!b&&(b?a.ka===b.ka&&a.fa===b.fa&&a.type===b.type&&ik(a.Tc,b.Tc):!1)}function qk(a,b){this.Uf=a;this.count=b}
