...
function Vv(a,b,c){for(var d=[];a;a=a.parentNode){if(b.M===a)return b.J;d.push(a)}for(a=b.M;a;a=a.parentNode){var e=d.indexOf(a);if(0<=e)return c?!e:!1;for(e=a;e;e=e.previousElementSibling)if(d.includes(e))return!0}return b.J}function Wv(a){return!a.tc&&a.le&&a.qc||!a.uc&&a.Zc&&a.rc?!0:!1}function Xv(a){this.D=a}Xv.prototype.b=function(){};Xv.prototype.f=function(a){return!!a};
...
function bw(a,b){var c=a.D,d=L("doLayout"),e=Dm(b.j,a,!1);Fo(e,b).then(function(a){var e=a;Ce(function(a){for(var d={};e;){d.Ka=!0;yp(b,e,!1).then(function(d){return function(f){e=f;Gn(b.l)?Q(a):b.g?Q(a):e&&b.u&&e&&e.wa?Q(a):e&&e.J&&e.M==c.j?Q(a):d.Ka?d.Ka=!1:P(a)}}(d));if(d.Ka){d.Ka=!1;return}d={Ka:d.Ka}}Q(a)}).then(function(){O(d,e)})});return d.result()}dw.prototype.Ja=function(a,b,c,d){return Ip.prototype.Ja.call(this,a,b,c,d)};dw.prototype.wd=function(a,b,c,d){Ip.prototype.wd(a,b,c,d)};
