 ...
 *
 * Vivliostyle core 2016.2.0-pre.20160128102014
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function(){return this.l()});nc(this,"pref-font-family",function(){return this.Q.fontFamily});nc(this,"pref-night-mode",function(){return this.Q.Ic});nc(this,"pref-hyphenate",function(){return this.Q.Bc});nc(this,"pref-margin",function(){return this.Q.margin});nc(this,"pref-line-height",function(){return this.Q.lineHeight});nc(this,"pref-column-width",function(){return this.Q.xc*this.fontSize});nc(this,"pref-horizontal",function(){return this.Q.Ac});nc(this,"pref-spread-view",function(){return this.Q.Wa})}}
...
function tc(a,b,c,d){this.A=null;this.u=function(){return this.A?this.A:this.Q.Wa?Math.floor(b/2)-this.Q.Eb:b};this.w=null;this.l=function(){return this.w?this.w:c};this.g=d;this.$=null;this.fontSize=function(){return this.$?this.$:d};this.Q=fc;this.B={}}function uc(a,b){a.B[b.j]={};for(var c=0;c<b.children.length;c++)uc(a,b.children[c])}function vc(a,b,c){return"vw"==b?a.u()/100:"vh"==b?a.l()/100:"em"==b||"rem"==b?c?a.g:a.fontSize():"ex"==b||"rex"==b?rc.ex*(c?a.g:a.fontSize())/rc.em:rc[b]}
...
m.oa=function(a){Q(a,this.value)};m.ya=function(){return!1};m.Wb=function(){return this.value};function lf(a){this.b=a}m=lf.prototype;m.then=function(a){this.b.then(a)};m.lc=function(a){if(this.ya()){var b=new Ve(this.b.d,this.b.parent,"AsyncResult.thenAsync");b.b=We;this.b.parent=b;this.b.then(function(c){a(c).then(function(a){Q(b,a)})});return O(b)}return a(this.b.e)};m.Pc=function(a){return this.ya()?this.lc(function(){return new Xe(a)}):new Xe(a)};
m.oa=function(a){this.ya()?this.then(function(b){Q(a,b)}):Q(a,this.b.e)};m.ya=function(){return this.b.b==We};m.Wb=function(){if(this.ya())throw Error("Result is pending");return this.b.e};function Ve(a,b,c){this.d=a;this.parent=b;this.name=c;this.e=null;this.b=0;this.g=this.f=null}function mf(a){if(!Te)throw Error("F_TASK_NO_CONTEXT");if(a!==Te.top)throw Error("F_TASK_NOT_TOP_FRAME");}function O(a){return new lf(a)}
...
Of;k.splice(0,k.length);continue;case 29:a.b=Nf;f.hb();continue;case 1:if(!h.b){a.b=Sf;f.error("E_CSS_SPACE_EXPECTED",h);continue}f.bb();case 2:if(34==z(g,1).type)if(A(g),A(g),n=a.I[h.text],null!=n)switch(h=x(g),h.type){case 1:f.$a(n,h.text);a.b=S;A(g);break;case 36:f.$a(n,null);a.b=S;A(g);break;default:a.b=Qf,f.error("E_CSS_NAMESPACE",h)}else a.b=Qf,f.error("E_CSS_UNDECLARED_PREFIX",h);else f.$a(a.B,h.text),a.b=S,A(g);continue;case 3:if(!h.b){a.b=Sf;f.error("E_CSS_SPACE_EXPECTED",h);continue}f.bb();
...
A(g);continue;case 19:k.push(new K(h.C,h.text));A(g);continue;case 20:k.push(new pd(h.text));A(g);continue;case 21:k.push(new ud(ta(h.text,a.fa)));A(g);continue;case 22:Wf(a,",",h);k.push(",");A(g);continue;case 23:k.push(od);A(g);continue;case 24:l=h.text.toLowerCase();"-epubx-expr"==l?(a.b=Pf,a.f=0,k.push("{")):(k.push(l),k.push("("));A(g);continue;case 25:Wf(a,")",h);A(g);continue;case 47:A(g);h=x(g);l=z(g,1);if(1==h.type&&"important"==h.text.toLowerCase()&&(17==l.type||0==l.type||13==l.type)){A(g);
...
function ph(a,b,c){var d=b.src,e=a.e[d];e?rg(e,function(a){if(a.d==b.d){var e=b.b,k=c.b[e];a=a.b;if(k){if(k!=a)throw Error("E_FONT_FAMILY_INCONSISTENT "+b.b);}else c.b[e]=a;u.b("Found already-loaded font:",d)}else u.b("E_FONT_FACE_INCOMPATIBLE",b.src)}):(e=new yf(function(){var e=M("loadFont"),g=c.d?c.d(d):null;g?sf(d,"blob").then(function(d){d.cc?g(d.cc).then(function(d){oh(a,b,d,c).oa(e)}):Q(e,null)}):oh(a,b,null,c).oa(e);return O(e)},"loadFont "+d),a.e[d]=e,e.start());return e};function qh(a,b,c){this.j=a;this.url=b;this.b=c;this.lang=null;this.f=-1;this.root=c.documentElement;a=null;if("http://www.w3.org/1999/xhtml"==this.root.namespaceURI){for(b=this.root.firstChild;b;b=b.nextSibling)if(1==b.nodeType&&(c=b,"http://www.w3.org/1999/xhtml"==c.namespaceURI))switch(c.localName){case "head":a=c}this.lang=this.root.getAttribute("lang")}else if("http://www.gribuser.ru/xml/fictionbook/2.0"==this.root.namespaceURI){a=this.root;for(b=this.root.firstChild;b;b=b.nextSibling);b=rh(rh(rh(rh(new th([this.b]),
...
function xh(a,b){for(var c,d=a.root;;){c=uh(a,d);if(c>=b)return d;var e=d.children;if(!e)break;var f=Ya(e.length,function(c){return uh(a,e[c])>b});if(0==f)break;if(f<e.length&&uh(a,e[f])<=b)throw Error("Consistency check failed!");d=e[f-1]}c=c+1;for(var f=d,g=f.firstChild||f.nextSibling,k=null;;){if(g){if(1==g.nodeType)break;k=f=g;c+=g.textContent.length;if(c>b)break}else if(f=f.parentNode,!f)break;g=f.nextSibling}return k||d}
...
var Ah={Vd:"text/html",Wd:"text/xml",Od:"application/xml",Nd:"application/xhtml_xml",Qd:"image/svg+xml"};function Bh(a,b,c){c=c||new DOMParser;var d;try{d=c.parseFromString(a,b)}catch(e){}if(d){a=d.documentElement;if("parsererror"===a.localName)return null;for(a=a.firstChild;a;a=a.nextSibling)if("parsererror"===a.localName)return null}else return null;return d}
...
function Dh(a,b){var c=a.responseXML;if(!c){var d=new DOMParser,e=a.responseText;if(e){var f=Ch(a);(c=Bh(e,f||"application/xml",d))&&!f&&(f=c.documentElement,"html"!==f.localName.toLowerCase()||f.namespaceURI?"svg"===f.localName.toLowerCase()&&"image/svg+xml"!==c.contentType&&(c=Bh(e,"image/svg+xml",d)):c=Bh(e,"text/html",d));c||(c=Bh(e,"text/html",d))}}c=c?new qh(b,a.url,c):null;return N(c)}function Eh(a){this.sb=a}
function Fh(){var a=Gh;return new Eh(function(b){return a.sb(b)&&1==b.nodeType&&"http://www.idpf.org/2008/embedding"==b.getAttribute("Algorithm")})}function Hh(){var a=Fh(),b=Gh;return new Eh(function(c){if(!b.sb(c))return!1;c=new th([c]);c=rh(c,"EncryptionMethod");a&&(c=Ih(c,a));return 0<c.b.length})}var Gh=new Eh(function(){return!0});function th(a){this.b=a}function Jh(a){return a.b}function Ih(a,b){for(var c=[],d=0;d<a.b.length;d++){var e=a.b[d];b.sb(e)&&c.push(e)}return new th(c)}
function Kh(a,b){function c(a){d.push(a)}for(var d=[],e=0;e<a.b.length;e++)b(a.b[e],c);return new th(d)}function Lh(a,b){for(var c=[],d=0;d<a.b.length;d++)c.push(b(a.b[d]));return c}function Mh(a,b){for(var c=[],d=0;d<a.b.length;d++){var e=b(a.b[d]);null!=e&&c.push(e)}return c}function rh(a,b){return Kh(a,function(a,d){for(var e=a.firstChild;e;e=e.nextSibling)e.localName==b&&d(e)})}function Nh(a){return Kh(a,function(a,c){for(var d=a.firstChild;d;d=d.nextSibling)1==d.nodeType&&c(d)})}
function Oh(a,b){return Mh(a,function(a){return 1==a.nodeType?a.getAttribute(b):null})}th.prototype.textContent=function(){return Lh(this,function(a){return a.textContent})};var Ph={transform:!0,"transform-origin":!0,position:!0};function Qh(a,b,c){this.target=a;this.name=b;this.value=c}var Rh={show:function(a){a.style.visibility="visible"},hide:function(a){a.style.visibility="hidden"},play:function(a){a.currentTime=0;a.play()},pause:function(a){a.pause()},resume:function(a){a.play()},mute:function(a){a.muted=!0},unmute:function(a){a.muted=!1}};function Sh(a,b){var c=Rh[b];return c?function(){for(var b=0;b<a.length;b++)try{c(a[b])}catch(e){}}:null}
function Th(a){this.d={};this.L=a;this.u=null;this.g=[];var b=this;this.A=function(a){var d=a.currentTarget,e=d.getAttribute("href")||d.getAttributeNS("http://www.w3.org/1999/xlink","href");e&&(a.preventDefault(),fb(b,{type:"hyperlink",target:null,currentTarget:null,Xd:d,href:e}))};this.h={};this.b={width:0,height:0};this.k=this.j=!1;this.F=0;this.position=null;this.offset=-1;this.f=null;this.e=[];this.l={top:{},bottom:{},left:{},right:{}}}t(Th,eb);
function Uh(a){a.D=!0;a.L.setAttribute("data-vivliostyle-auto-page-width",!0)}function Vh(a){a.B=!0;a.L.setAttribute("data-vivliostyle-auto-page-height",!0)}function Wh(a,b,c){var d=a.h[c];d?d.push(b):a.h[c]=[b]}Th.prototype.zoom=function(a){w(this.L,"transform","scale("+a+")")};Th.prototype.w=function(){return this.u||this.L};
function Xh(a,b){if(1==a.nodeType)return!1;var c=a.textContent;switch(b){case 0:return!!c.match(/^\s*$/);case 1:return!!c.match(/^[ \t\f]*$/);case 2:return 0==c.length}throw Error("Unexpected whitespace: "+b);}function Yh(a,b,c,d,e,f,g,k){this.f=a;this.g=b;this.b=c;this.Ea=d;this.j=e;this.d=f;this.Id=g;this.h=k;this.e=-1}function Zh(a,b){return a.d?!b.d||a.Ea>b.Ea?!0:a.h:!1}function $h(a,b){return a.top-b.top}function ai(a,b){return b.right-a.right}
function bi(a,b,c,d,e,f,g){this.Y=a;this.Kc=d;this.ed=null;this.root=b;this.Z=c;this.type=f;e&&(e.ed=this);this.b=g}function ci(a,b){this.Gd=a;this.count=b}function di(a,b,c){this.W=a;this.parent=b;this.ca=c;this.aa=0;this.K=!1;this.La=0;this.ba=b?b.ba:null;this.na=this.ua=null;this.I=!1;this.d=!0;this.e=!1;this.h=b?b.h:0;this.w=this.j=this.M=null;this.A=b?b.A:0;this.k=b?b.k:!1;this.b=this.B=this.u=null;this.l=b?b.l:{};this.g=b?b.g:!1;this.D=b?b.D:"ltr";this.f=b?b.f:null}
function ei(a){a.d=!0;a.h=a.parent?a.parent.h:0;a.b=null;a.aa=0;a.K=!1;a.j=null;a.w=null;a.u=null;a.B=null;a.ua=null;a.k=a.parent?a.parent.k:!1;a.g=a.parent?a.parent.g:!1;a.ua=null}function fi(a){var b=new di(a.W,a.parent,a.ca);b.aa=a.aa;b.K=a.K;b.ua=a.ua;b.La=a.La;b.ba=a.ba;b.na=a.na;b.d=a.d;b.h=a.h;b.j=a.j;b.w=a.w;b.k=a.k;b.A=a.A;b.u=a.u;b.B=a.B;b.b=a.b;b.f=a.f;b.g=a.g;b.e=a.e;return b}di.prototype.modify=function(){return this.I?fi(this):this};
function gi(a){var b=a;do{if(b.I)break;b.I=!0;b=b.parent}while(b);return a}di.prototype.clone=function(){for(var a=fi(this),b=a,c;null!=(c=b.parent);)c=fi(c),b=b.parent=c;return a};function hi(a){return{da:a.W,La:a.La,ba:a.ba,ua:a.ua,na:a.na?hi(a.na):null}}function ii(a){var b=a,c=[];do b.f&&b.parent&&b.parent.f!==b.f||c.push(hi(b)),b=b.parent;while(b);return{ha:c,aa:a.aa,K:a.K}}function ji(a){this.Qa=a;this.b=this.d=null}
ji.prototype.clone=function(){var a=new ji(this.Qa);if(this.d){a.d=[];for(var b=0;b<this.d.length;++b)a.d[b]=this.d[b]}if(this.b)for(a.b=[],b=0;b<this.b.length;++b)a.b[b]=this.b[b];return a};function ki(a,b){this.d=a;this.b=b}ki.prototype.clone=function(){return new ki(this.d.clone(),this.b)};function li(){this.b=[]}li.prototype.clone=function(){for(var a=new li,b=this.b,c=a.b,d=0;d<b.length;d++)c[d]=b[d].clone();return a};function mi(){this.d=0;this.b={};this.e=0}
mi.prototype.clone=function(){var a=new mi;a.d=this.d;a.f=this.f;a.e=this.e;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b].clone();return a};function ni(a){this.d=a;this.B=this.A=this.height=this.width=this.w=this.k=this.D=this.j=this.va=this.fa=this.Fa=this.$=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.Sb=this.I=null;this.pa=this.Tb=this.Ga=this.Ub=this.e=0;this.b=!1}function oi(a){return a.marginTop+a.fa+a.k}
function pi(a){return a.marginBottom+a.va+a.w}function qi(a){return a.marginLeft+a.$+a.j}function ri(a){return a.marginRight+a.Fa+a.D}function si(a,b){a.d=b.d;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.$=b.$;a.Fa=b.Fa;a.fa=b.fa;a.va=b.va;a.j=b.j;a.D=b.D;a.k=b.k;a.w=b.w;a.width=b.width;a.height=b.height;a.A=b.A;a.B=b.B;a.Sb=b.Sb;a.I=b.I;a.e=b.e;a.Ub=b.Ub;a.Ga=b.Ga;a.b=b.b}
function ti(a,b,c){a.top=b;a.height=c;w(a.d,"top",b+"px");w(a.d,"height",c+"px")}function ui(a,b,c){a.left=b;a.width=c;w(a.d,"left",b+"px");w(a.d,"width",c+"px")}function vi(a,b){this.b=a;this.d=b}t(vi,gd);vi.prototype.Nb=function(a){this.b.appendChild(this.b.ownerDocument.createTextNode(a.b));return null};vi.prototype.Ob=function(a){var b=this.b.ownerDocument.createElementNS("http://www.w3.org/1999/xhtml","img");b.setAttribute("src",a.url);this.b.appendChild(b);return null};
vi.prototype.Xa=function(a){this.jb(a.values);return null};vi.prototype.wb=function(a){a=a.ea().evaluate(this.d);"string"===typeof a&&this.b.appendChild(this.b.ownerDocument.createTextNode(a));return null};function wi(a){return null!=a&&a!==Ud&&a!==Td&&a!==Ld};function xi(a,b,c){b=b?"vertical-rl":"horizontal-tb";if("top"===a||"bottom"===a)a=da(a,b,c||null,ha);"block-start"===a&&(a="inline-start");"block-end"===a&&(a="inline-end");if("inline-start"===a||"inline-end"===a){c=da(a,b,c||null,ga);a:{var d=ia[b];if(!d)throw Error("unknown writing-mode: "+b);for(b=0;b<d.length;b++)if(d[b].H===c){b=d[b].G;break a}b=c}"line-left"===b?a="left":"line-right"===b&&(a="right")}"left"!==a&&"right"!==a&&(u.b("Invalid float value: "+a+". Fallback to left."),a="left");return a}
...
var Ri=Qi({before:"right",after:"left",start:"top",end:"bottom"}),Si=Qi({before:"top",after:"bottom",start:"left",end:"right"});function V(a,b){this.value=a;this.Ea=b}m=V.prototype;m.ld=function(){return this};m.yc=function(a){a=this.value.R(a);return a===this.value?this:new V(a,this.Ea)};m.md=function(a){return 0==a?this:new V(this.value,this.Ea+a)};m.evaluate=function(a,b){return jg(a,this.value,b)};m.jd=function(){return!0};function Ti(a,b,c){V.call(this,a,b);this.J=c}t(Ti,V);
Ti.prototype.ld=function(){return new V(this.value,this.Ea)};Ti.prototype.yc=function(a){a=this.value.R(a);return a===this.value?this:new Ti(a,this.Ea,this.J)};Ti.prototype.md=function(a){return 0==a?this:new Ti(this.value,this.Ea+a,this.J)};Ti.prototype.jd=function(a){return!!this.J.evaluate(a)};function Ui(a,b,c){return(null==b||c.Ea>b.Ea)&&c.jd(a)?c.ld():b}var Vi={"region-id":!0};function Wi(a){return"_"!=a.charAt(0)&&!Vi[a]}function Xi(a,b,c){c?a[b]=c:delete a[b]}
function Yi(a,b){var c=a[b];c||(c={},a[b]=c);return c}function Zi(a,b){var c=a[b];c||(c=[],a[b]=c);return c}function $i(a,b,c,d,e,f){if(e){var g=Yi(b,"_pseudos");b=g[e];b||(b={},g[e]=b)}f&&(e=Yi(b,"_regions"),b=e[f],b||(b={},e[f]=b));for(var k in c)"_"!=k.charAt(0)&&(Vi[k]?(f=c[k],e=Zi(b,k),Array.prototype.push.apply(e,f)):Xi(b,k,Ui(a,b[k],c[k].md(d))))}function aj(a,b){this.e=a;this.d=b;this.b=""}t(aj,hd);
function bj(a){a=a.e["font-size"].value;var b;a:switch(a.ia.toLowerCase()){case "px":case "in":case "pt":case "pc":case "cm":case "mm":case "q":b=!0;break a;default:b=!1}if(!b)throw Error("Unexpected state");return a.C*rc[a.ia]}
aj.prototype.zb=function(a){if("em"==a.ia||"ex"==a.ia){var b=vc(this.d,a.ia,!1)/vc(this.d,"em",!1);return new K(a.C*b*bj(this),"px")}if("%"==a.ia){if("font-size"===this.b)return new K(a.C/100*bj(this),"px");b=this.b.match(/height|^(top|bottom)$/)?"vh":"vw";return new K(a.C,b)}return a};aj.prototype.wb=function(a){return"font-size"==this.b?jg(this.d,a,this.b).R(this):a};function cj(){}cj.prototype.apply=function(){};cj.prototype.g=function(a){return new dj([this,a])};cj.prototype.clone=function(){return this};
function ej(a){this.b=a}t(ej,cj);ej.prototype.apply=function(a){a.b[a.b.length-1].push(this.b.b())};function dj(a){this.b=a}t(dj,cj);dj.prototype.apply=function(a){for(var b=0;b<this.b.length;b++)this.b[b].apply(a)};dj.prototype.g=function(a){this.b.push(a);return this};dj.prototype.clone=function(){return new dj([].concat(this.b))};function fj(a,b,c,d){this.style=a;this.b=b;this.d=c;this.e=d}t(fj,cj);fj.prototype.apply=function(a){$i(a.d,a.w,this.style,this.b,this.d,this.e)};
function X(){this.b=null}t(X,cj);X.prototype.apply=function(a){this.b.apply(a)};X.prototype.d=function(){return 0};X.prototype.e=function(){return!1};function gj(a){this.b=null;this.f=a}t(gj,X);gj.prototype.apply=function(a){0<=a.u.indexOf(this.f)&&this.b.apply(a)};gj.prototype.d=function(){return 10};gj.prototype.e=function(a){this.b&&hj(a.xa,this.f,this.b);return!0};function ij(a){this.b=null;this.id=a}t(ij,X);ij.prototype.apply=function(a){a.M!=this.id&&a.fa!=this.id||this.b.apply(a)};
ij.prototype.d=function(){return 11};ij.prototype.e=function(a){this.b&&hj(a.e,this.id,this.b);return!0};function jj(a){this.b=null;this.localName=a}t(jj,X);jj.prototype.apply=function(a){a.f==this.localName&&this.b.apply(a)};jj.prototype.d=function(){return 8};jj.prototype.e=function(a){this.b&&hj(a.Mb,this.localName,this.b);return!0};function kj(a,b){this.b=null;this.f=a;this.localName=b}t(kj,X);kj.prototype.apply=function(a){a.f==this.localName&&a.k==this.f&&this.b.apply(a)};kj.prototype.d=function(){return 8};
kj.prototype.e=function(a){if(this.b){var b=a.b[this.f];b||(b="ns"+a.g++ +":",a.b[this.f]=b);hj(a.f,b+this.localName,this.b)}return!0};function lj(a){this.b=null;this.f=a}t(lj,X);lj.prototype.apply=function(a){var b=a.e;if(b&&"a"==a.f){var c=b.getAttribute("href");c&&c.match(/^#/)&&(b=b.ownerDocument.getElementById(c.substring(1)))&&(b=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))&&b.match(this.f)&&this.b.apply(a)}};function mj(a){this.b=null;this.f=a}t(mj,X);
mj.prototype.apply=function(a){a.k==this.f&&this.b.apply(a)};function nj(a,b){this.b=null;this.f=a;this.name=b}t(nj,X);nj.prototype.apply=function(a){a.e&&a.e.hasAttributeNS(this.f,this.name)&&this.b.apply(a)};function oj(a,b,c){this.b=null;this.f=a;this.name=b;this.value=c}t(oj,X);oj.prototype.apply=function(a){a.e&&a.e.getAttributeNS(this.f,this.name)==this.value&&this.b.apply(a)};oj.prototype.d=function(){return"type"==this.name&&"http://www.idpf.org/2007/ops"==this.f?9:0};
oj.prototype.e=function(a){return"type"==this.name&&"http://www.idpf.org/2007/ops"==this.f?(this.b&&hj(a.d,this.value,this.b),!0):!1};function pj(a,b){this.b=null;this.f=a;this.name=b}t(pj,X);pj.prototype.apply=function(a){if(a.e){var b=a.e.getAttributeNS(this.f,this.name);b&&Ji[b]&&this.b.apply(a)}};pj.prototype.d=function(){return 0};pj.prototype.e=function(){return!1};function qj(a,b,c){this.b=null;this.h=a;this.name=b;this.f=c}t(qj,X);
qj.prototype.apply=function(a){if(a.e){var b=a.e.getAttributeNS(this.h,this.name);b&&b.match(this.f)&&this.b.apply(a)}};function rj(a){this.b=null;this.f=a}t(rj,X);rj.prototype.apply=function(a){a.lang.match(this.f)&&this.b.apply(a)};function sj(){this.b=null}t(sj,X);sj.prototype.apply=function(a){a.ma&&this.b.apply(a)};sj.prototype.d=function(){return 6};function tj(){this.b=null}t(tj,X);tj.prototype.apply=function(a){a.Fa&&this.b.apply(a)};tj.prototype.d=function(){return 12};
function uj(a){this.b=null;this.f=a}t(uj,X);uj.prototype.apply=function(a){a.pa===this.f&&this.b.apply(a)};uj.prototype.d=function(){return 5};function vj(a){this.b=null;this.J=a}t(vj,X);vj.prototype.apply=function(a){a.h[this.J]&&this.b.apply(a)};vj.prototype.d=function(){return 5};function wj(a){this.J=a}wj.prototype.b=function(){return this};wj.prototype.push=function(a,b){0==b&&xj(a,this.J);return!1};wj.prototype.pop=function(a,b){return 0==b?(a.h[this.J]--,!0):!1};function yj(a){this.J=a}
yj.prototype.b=function(){return this};yj.prototype.push=function(a,b){0==b?xj(a,this.J):1==b&&a.h[this.J]--;return!1};yj.prototype.pop=function(a,b){if(0==b)return a.h[this.J]--,!0;1==b&&xj(a,this.J);return!1};function zj(a){this.J=a;this.d=!1}zj.prototype.b=function(){return new zj(this.J)};zj.prototype.push=function(a){return this.d?(a.h[this.J]--,!0):!1};zj.prototype.pop=function(a,b){if(this.d)return a.h[this.J]--,!0;0==b&&(this.d=!0,xj(a,this.J));return!1};
function Aj(a){this.J=a;this.d=!1}Aj.prototype.b=function(){return new Aj(this.J)};Aj.prototype.push=function(a,b){this.d&&(-1==b?xj(a,this.J):0==b&&a.h[this.J]--);return!1};Aj.prototype.pop=function(a,b){if(this.d){if(-1==b)return a.h[this.J]--,!0;0==b&&xj(a,this.J)}else 0==b&&(this.d=!0,xj(a,this.J));return!1};function Bj(a,b){this.e=a;this.d=b}Bj.prototype.b=function(){return this};Bj.prototype.push=function(){return!1};Bj.prototype.pop=function(a,b){return 0==b?(Cj(a,this.e,this.d),!0):!1};
function Dj(a){this.lang=a}Dj.prototype.b=function(){return this};Dj.prototype.push=function(){return!1};Dj.prototype.pop=function(a,b){return 0==b?(a.lang=this.lang,!0):!1};function Ej(a){this.d=a}Ej.prototype.b=function(){return this};Ej.prototype.push=function(){return!1};Ej.prototype.pop=function(a,b){return 0==b?(a.B=this.d,!0):!1};function Fj(a,b){this.b=a;this.d=b}t(Fj,hd);
Fj.prototype.ib=function(a){var b=this.b,c=b.B,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.l)];b.l++;break;case "close-quote":return 0<b.l&&b.l--,c[2*Math.min(d,b.l)+1];case "no-open-quote":return b.l++,new pd("");case "no-close-quote":return 0<b.l&&b.l--,new pd("")}return a};
var Gj={roman:[4999,1E3,"M",900,"CM",500,"D",400,"CD",100,"C",90,"XC",50,"L",40,"XL",10,"X",9,"IX",5,"V",4,"IV",1,"I"],armenian:[9999,9E3,"\u0584",8E3,"\u0583",7E3,"\u0582",6E3,"\u0581",5E3,"\u0580",4E3,"\u057f",3E3,"\u057e",2E3,"\u057d",1E3,"\u057c",900,"\u057b",800,"\u057a",700,"\u0579",600,"\u0578",500,"\u0577",400,"\u0576",300,"\u0575",200,"\u0574",100,"\u0573",90,"\u0572",80,"\u0571",70,"\u0570",60,"\u056f",50,"\u056e",40,"\u056d",30,"\u056c",20,"\u056b",10,"\u056a",9,"\u0569",8,"\u0568",7,"\u0567",
...
3,"\u10d2",2,"\u10d1",1,"\u10d0"],hebrew:[999,400,"\u05ea",300,"\u05e9",200,"\u05e8",100,"\u05e7",90,"\u05e6",80,"\u05e4",70,"\u05e2",60,"\u05e1",50,"\u05e0",40,"\u05de",30,"\u05dc",20,"\u05db",19,"\u05d9\u05d8",18,"\u05d9\u05d7",17,"\u05d9\u05d6",16,"\u05d8\u05d6",15,"\u05d8\u05d5",10,"\u05d9",9,"\u05d8",8,"\u05d7",7,"\u05d6",6,"\u05d5",5,"\u05d4",4,"\u05d3",3,"\u05d2",2,"\u05d1",1,"\u05d0"]},Hj={latin:"a-z",alpha:"a-z",greek:"\u03b1-\u03c1\u03c3-\u03c9",russian:"\u0430-\u0438\u043a-\u0449\u044d-\u044f"},
Ij={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},Jj={Zd:!1,Ab:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",bc:"\u5341\u767e\u5343",Dd:"\u8ca0"};
function Kj(a){if(9999<a||-9999>a)return""+a;if(0==a)return Jj.Ab.charAt(0);var b=new Qa;0>a&&(b.append(Jj.Dd),a=-a);if(10>a)b.append(Jj.Ab.charAt(a));else if(Jj.$d&&19>=a)b.append(Jj.bc.charAt(0)),0!=a&&b.append(Jj.bc.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(Jj.Ab.charAt(c)),b.append(Jj.bc.charAt(2)));if(c=Math.floor(a/100)%10)b.append(Jj.Ab.charAt(c)),b.append(Jj.bc.charAt(1));if(c=Math.floor(a/10)%10)b.append(Jj.Ab.charAt(c)),b.append(Jj.bc.charAt(0));(a%=10)&&b.append(Jj.Ab.charAt(a))}return b.toString()}
function Lj(a,b){var c=!1,d=!1,e;null!=(e=b.match(/^upper-(.*)/))?(c=!0,b=e[1]):null!=(e=b.match(/^lower-(.*)/))&&(d=!0,b=e[1]);e="";if(Gj[b])a:{e=Gj[b];var f=a;if(f>e[0]||0>=f||f!=Math.round(f))e="";else{for(var g="",k=1;k<e.length;k+=2){var h=e[k],l=Math.floor(f/h);if(20<l){e="";break a}for(f-=l*h;0<l;)g+=e[k+1],l--}e=g}}else if(Hj[b])if(e=a,0>=e||e!=Math.round(e))e="";else{g=Hj[b];f=[];for(k=0;k<g.length;)if("-"==g.substr(k+1,1))for(l=g.charCodeAt(k),h=g.charCodeAt(k+2),k+=3;l<=h;l++)f.push(String.fromCharCode(l));
else f.push(g.substr(k++,1));g="";do e--,k=e%f.length,g=f[k]+g,e=(e-k)/f.length;while(0<e);e=g}else null!=Ij[b]?e=Ij[b]:"decimal-leading-zero"==b?(e=a+"",1==e.length&&(e="0"+e)):"cjk-ideographic"==b||"trad-chinese-informal"==b?e=Kj(a):e=a+"";return c?e.toUpperCase():d?e.toLowerCase():e}
function Mj(a,b){var c=b[0].toString(),d=1<b.length?b[1].stringValue():"decimal",e=a.b.g[c];if(e&&e.length)return new pd(Lj(e&&e.length&&e[e.length-1]||0,d));c=new L(Nj(a.b.Ga,c,function(a){return Lj(a||0,d)}));return new id([c])}
function Oj(a,b){var c=b[0].toString(),d=b[1].stringValue(),e=2<b.length?b[2].stringValue():"decimal",f=a.b.g[c],g=new Qa;if(f&&f.length)for(var k=0;k<f.length;k++)0<k&&g.append(d),g.append(Lj(f[k],e));c=new L(Pj(a.b.Ga,c,function(a){var b=[];if(a.length)for(var c=0;c<a.length;c++)b.push(Lj(a[c],e));a=g.toString();a.length&&b.push(a);return b.length?b.join(d):Lj(0,e)}));return new id([c])}
Fj.prototype.ob=function(a){switch(a.name){case "attr":if(1==a.values.length)return new pd(this.d&&this.d.getAttribute(a.values[0].stringValue())||"");break;case "counter":if(2>=a.values.length)return Mj(this,a.values);break;case "counters":if(3>=a.values.length)return Oj(this,a.values)}u.b("E_CSS_CONTENT_PROP:",a.toString());return new pd("")};var Qj=1/1048576;function Rj(a,b){for(var c in a)b[c]=a[c].clone()}
function Sj(){this.g=0;this.b={};this.Mb={};this.f={};this.d={};this.xa={};this.e={};this.Fb={};this.N=0}Sj.prototype.clone=function(){var a=new Sj;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b];Rj(this.Mb,a.Mb);Rj(this.f,a.f);Rj(this.d,a.d);Rj(this.xa,a.xa);Rj(this.e,a.e);Rj(this.Fb,a.Fb);a.N=this.N;return a};function hj(a,b,c){var d=a[b];d&&(c=d.g(c));a[b]=c}
function Tj(a,b,c){this.j=a;this.d=b;this.Ga=c;this.b=[[],[]];this.h={};this.u=this.w=this.e=null;this.$=this.fa=this.M=this.k=this.f="";this.I=this.D=null;this.Fa=this.ma=!0;this.g={};this.A=[{}];this.B=[new pd("\u201c"),new pd("\u201d"),new pd("\u2018"),new pd("\u2019")];this.l=0;this.lang="";this.Ta=[0];this.pa=0;this.va=[]}function xj(a,b){a.h[b]=(a.h[b]||0)+1}function Uj(a,b,c){(b=b[c])&&b.apply(a)}var Vj=[];
function Wj(a,b,c,d){a.e=null;a.w=d;a.k="";a.f="";a.M="";a.fa="";a.u=b;a.$="";a.D=Vj;a.I=c;Xj(a)}function Yj(a,b,c){a.g[b]?a.g[b].push(c):a.g[b]=[c];c=a.A[a.A.length-1];c||(c={},a.A[a.A.length-1]=c);c[b]=!0}
function Zj(a,b){var c=Md,d=b.display;d&&(c=d.evaluate(a.d));var e=null,d=null,f=b["counter-reset"];f&&(f=f.evaluate(a.d))&&(e=qg(f,!0));(f=b["counter-increment"])&&(f=f.evaluate(a.d))&&(d=qg(f,!1));"ol"!=a.f&&"ul"!=a.f||"http://www.w3.org/1999/xhtml"!=a.k||(e||(e={}),e["ua-list-item"]=0);c===Rd&&(d||(d={}),d["ua-list-item"]=1);if(e)for(var g in e)Yj(a,g,e[g]);if(d)for(var k in d)a.g[k]||Yj(a,k,0),g=a.g[k],g[g.length-1]+=d[k];c===Rd&&(c=a.g["ua-list-item"],b["ua-list-item-count"]=new V(new rd(c[c.length-
1]),0));a.A.push(null)}function ak(a){var b=a.A.pop();if(b)for(var c in b)(b=a.g[c])&&(1==b.length?delete a.g[c]:b.pop())}function Cj(a,b,c){Zj(a,b);b.content&&(b.content=b.content.yc(new Fj(a,c)));ak(a)}var bk="before transclusion-before footnote-call footnote-marker inner first-letter first-line  transclusion-after after".split(" ");
function ck(a,b,c){a.va.push(b);a.I=null;a.e=b;a.w=c;a.k=b.namespaceURI;a.f=b.localName;var d=a.j.b[a.k];a.$=d?d+a.f:"";a.M=b.getAttribute("id");a.fa=b.getAttributeNS("http://www.w3.org/XML/1998/namespace","id");(d=b.getAttribute("class"))?a.u=d.split(/\s+/):a.u=Vj;(d=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))?a.D=d.split(/\s+/):a.D=Vj;"style"==a.f&&"http://www.gribuser.ru/xml/fictionbook/2.0"==a.k&&(a.u=[b.getAttribute("name")||""]);(d=b.getAttributeNS("http://www.w3.org/XML/1998/namespace",
"lang"))||"http://www.w3.org/1999/xhtml"!=a.k||(d=b.getAttribute("lang"));d&&(a.b[a.b.length-1].push(new Dj(a.lang)),a.lang=d.toLowerCase());d=a.Ta;a.pa=++d[d.length-1];d.push([0]);Xj(a);d=c.quotes;c=null;d&&(d=d.evaluate(a.d))&&(c=new Ej(a.B),d===Td?a.B=[new pd(""),new pd("")]:d instanceof id&&(a.B=d.values));Zj(a,a.w);if(d=a.w._pseudos)for(var e=!0,f=0;f<bk.length;f++){var g=bk[f];g||(e=!1);(g=d[g])&&(e?Cj(a,g,b):a.b[a.b.length-2].push(new Bj(g,b)))}c&&a.b[a.b.length-2].push(c)}
function Xj(a){var b;for(b=0;b<a.u.length;b++)Uj(a,a.j.xa,a.u[b]);for(b=0;b<a.D.length;b++)Uj(a,a.j.d,a.D[b]);Uj(a,a.j.e,a.M);Uj(a,a.j.Mb,a.f);""!=a.f&&Uj(a,a.j.Mb,"*");Uj(a,a.j.f,a.$);null!==a.I&&(Uj(a,a.j.Fb,a.I),Uj(a,a.j.Fb,"*"));a.e=null;a.b.push([]);for(var c=1;-1<=c;--c){var d=a.b[a.b.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.ma=!0;a.Fa=!1}
Tj.prototype.pop=function(){for(var a=1;-1<=a;--a)for(var b=this.b[this.b.length-a-2],c=0;c<b.length;)b[c].pop(this,a)?b.splice(c,1):c++;this.b.pop();this.ma=!1};var dk=null;function ek(a,b,c,d,e,f,g){Gf.call(this,a,b,g);this.b=null;this.d=0;this.k=null;this.w=0;this.g=null;this.l=!1;this.J=c;this.h=d?d.h:dk?dk.clone():new Sj;this.B=e;this.u=f;this.j=0}t(ek,Hf);m=ek.prototype;m.nd=function(a){hj(this.h.Mb,"*",a)};
function fk(a,b){var c=a.b;if(0<c.length){c.sort(function(a,b){return b.d()-a.d()});for(var d=null,e=c.length-1;0<=e;e--)d=c[e],d.b=b,b=d;if(d.e(a.h))return}a.nd(b)}m.$a=function(a,b){if(b||a)this.d+=1,b&&a?this.b.push(new kj(a,b.toLowerCase())):b?this.b.push(new jj(b.toLowerCase())):this.b.push(new mj(a))};m.wc=function(a){this.g?(u.b("::"+this.g,"followed by ."+a),this.b.push(new vj(""))):(this.d+=256,this.b.push(new gj(a)))};
m.Gb=function(a,b){if(this.g)u.b("::"+this.g,"followed by :"+a),this.b.push(new vj(""));else{switch(a.toLowerCase()){case "first-child":this.b.push(new sj);break;case "root":this.b.push(new tj);break;case "link":this.b.push(new jj("a"));this.b.push(new nj("","href"));break;case "-adapt-href-epub-type":case "href-epub-type":if(b&&1==b.length&&"string"==typeof b[0]){var c=new RegExp("(^|s)"+va(b[0])+"($|s)");this.b.push(new lj(c))}else this.b.push(new vj(""));break;case "-adapt-footnote-content":case "footnote-content":this.l=
!0;break;case "visited":case "active":case "hover":case "focus":this.b.push(new vj(""));break;case "lang":b&&1==b.length&&"string"==typeof b[0]?this.b.push(new rj(new RegExp("^"+va(b[0].toLowerCase())+"($|-)"))):this.b.push(new vj(""));break;case "nth-child":b&&1==b.length&&"number"==typeof b[0]?this.b.push(new uj(b[0])):this.b.push(new vj(""));break;case "before":case "after":case "first-line":case "first-letter":this.Hb(a,b);return;default:u.b("unknown pseudo-class selector: "+a),this.b.push(new vj(""))}this.d+=
256}};
m.Hb=function(a,b){switch(a){case "before":case "after":case "first-line":case "first-letter":case "footnote-call":case "footnote-marker":case "inner":this.g?(u.b("Double pseudoelement ::"+this.g+"::"+a),this.b.push(new vj(""))):this.g=a;break;case "first-n-lines":if(b&&1==b.length&&"number"==typeof b[0]){var c=Math.round(b[0]);if(0<c&&c==b[0]){this.g?(u.b("Double pseudoelement ::"+this.g+"::"+a),this.b.push(new vj(""))):this.g="first-"+c+"-lines";break}}default:u.b("Unrecognized pseudoelement: ::"+a),
this.b.push(new vj(""))}this.d+=1};m.Cc=function(a){this.d+=65536;this.b.push(new ij(a))};
m.Xb=function(a,b,c,d){this.d+=256;b=b.toLowerCase();d=d||"";switch(c){case 0:this.b.push(new nj(a,b));break;case 39:this.b.push(new oj(a,b,d));break;case 45:this.b.push(new qj(a,b,new RegExp("(^|\\s)"+va(d)+"($|\\s)")));break;case 44:this.b.push(new qj(a,b,new RegExp("^"+va(d)+"($|-)")));break;case 50:"supported"==d?this.b.push(new pj(a,b)):u.b("Unsupported :: attr selector op:",d);break;default:u.b("Unsupported attr selector:",c)}};
m.bb=function(){var a="d"+this.w++;fk(this,new ej(new wj(a)));this.b=[new vj(a)]};m.vc=function(){var a="c"+this.w++;fk(this,new ej(new yj(a)));this.b=[new vj(a)]};m.tc=function(){var a="a"+this.w++;fk(this,new ej(new zj(a)));this.b=[new vj(a)]};m.zc=function(){var a="f"+this.w++;fk(this,new ej(new Aj(a)));this.b=[new vj(a)]};m.Hc=function(){gk(this);this.g=null;this.l=!1;this.d=0;this.b=[]};
m.hb=function(){var a;0!=this.j?(Jf(this,"E_CSS_UNEXPECTED_SELECTOR"),a=!0):a=!1;a||(this.j=1,this.k={},this.g=null,this.d=0,this.l=!1,this.b=[])};m.error=function(a,b){Hf.prototype.error.call(this,a,b);1==this.j&&(this.j=0)};m.vb=function(a){Hf.prototype.vb.call(this,a);this.j=0};m.la=function(){gk(this);Hf.prototype.la.call(this);1==this.j&&(this.j=0)};m.Ua=function(){Hf.prototype.Ua.call(this)};function gk(a){if(a.b){var b=a.d,c;c=a.h;c=c.N+=Qj;fk(a,a.pd(b+c));a.b=null;a.g=null;a.l=!1;a.d=0}}
m.pd=function(a){var b=this.B;this.l&&(b=b?"xxx-bogus-xxx":"footnote");return new fj(this.k,a,this.g,b)};m.Ka=function(a,b,c){eh(this.u,a,b,c,this)};m.Db=function(a,b){If(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};m.mc=function(a,b){If(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
m.gb=function(a,b,c){"display"!=a||b!==Wd&&b!==Vd||(this.gb("flow-options",new id([Gd,be]),c),this.gb("flow-into",b,c),b=Bd);(Gi.SIMPLE_PROPERTY||[]).forEach(function(d){d=d({name:a,value:b,important:c});a=d.name;b=d.value;c=d.important});var d=c?Cf(this):Df(this);Xi(this.k,a,this.J?new Ti(b,d,this.J):new V(b,d))};function hk(a,b){Gf.call(this,a,b,!1)}t(hk,Hf);
hk.prototype.Ka=function(a,b){if(this.e.values[a])this.error("E_CSS_NAME_REDEFINED "+a,this.Cb());else{var c=a.match(/height|^(top|bottom)$/)?"vh":"vw",c=new Wc(this.e,100,c),c=b.ea(this.e,c);this.e.values[a]=c}};function ik(a,b,c,d,e){Gf.call(this,a,b,!1);this.b=d;this.J=c;this.d=e}t(ik,Hf);ik.prototype.Ka=function(a,b,c){c?u.b("E_IMPORTANT_NOT_ALLOWED"):eh(this.d,a,b,c,this)};ik.prototype.Db=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};
ik.prototype.mc=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};ik.prototype.gb=function(a,b,c){c=c?Cf(this):Df(this);c+=this.N;this.N+=Qj;Xi(this.b,a,this.J?new Ti(b,c,this.J):new V(b,c))};function jk(a,b){cg.call(this,a);this.b={};this.d=b;this.N=0}t(jk,cg);jk.prototype.Ka=function(a,b,c){eh(this.d,a,b,c,this)};jk.prototype.Db=function(a,b){u.b("E_INVALID_PROPERTY_VALUE",a+":",b.toString())};jk.prototype.mc=function(a,b){u.b("E_INVALID_PROPERTY",a+":",b.toString())};
jk.prototype.gb=function(a,b,c){c=(c?67108864:50331648)+this.N;this.N+=Qj;Xi(this.b,a,new V(b,c))};var kk=new yf(function(){var a=M("uaStylesheetBase");wf(fh).then(function(b){var c=ta("user-agent-base.css",sa);b=new ek(null,null,null,null,null,b,!0);b.vb("UA");dk=b.h;fg(c,b,null,null).oa(a)});return O(a)},"uaStylesheetBaseFetcher");function lk(a,b,c){return(a=a["writing-mode"])&&(b=a.evaluate(b,"writing-mode"))&&b!==Ld?b===he:c}
function mk(a,b,c,d){var e={},f;for(f in a)Wi(f)&&(e[f]=a[f]);a=a._regions;if((c||d)&&a)for(d&&(d=["footnote"],c=c?c.concat(d):d),d=0;d<c.length;d++){f=a[c[d]];for(var g in f)Wi(g)&&(e[g]=Ui(b,e[g],f[g]))}return e}function nk(a,b,c,d){c=c?Ri:Si;for(var e in a)if(a.hasOwnProperty(e)){var f=a[e];if(f){var g=c[e];if(g){var k=a[g];if(k&&k.Ea>f.Ea)continue;g=Mi[g]?g:e}else g=e;b[g]=d(e,f)}}};function ok(a,b,c){this.e=a;this.d=b;this.b=c}function pk(){this.map=[]}function qk(a){return 0==a.map.length?0:a.map[a.map.length-1].b}function rk(a,b){if(0==a.map.length)a.map.push(new ok(b,b,b));else{var c=a.map[a.map.length-1],d=c.b+b-c.d;c.d==c.e?(c.d=b,c.e=b,c.b=d):a.map.push(new ok(b,b,d))}}function sk(a,b){0==a.map.length?a.map.push(new ok(b,0,0)):a.map[a.map.length-1].d=b}function tk(a,b){var c=Ya(a.map.length,function(c){return b<=a.map[c].d}),c=a.map[c];return c.b-Math.max(0,c.e-b)}
function uk(a,b){var c=Ya(a.map.length,function(c){return b<=a.map[c].b}),c=a.map[c];return c.e-(c.b-b)}
function vk(a,b,c,d,e,f,g){this.Z=a;this.root=a.root;this.fa=c;this.f=d;this.h=f;this.d=this.root;this.u={};this.w={};this.B=[];this.l=this.k=null;this.A=new Tj(b,d,g);this.e=new pk;this.Qa=!0;this.D=[];this.$=e;this.M=this.I=!1;this.b=a=uh(a,this.root);rk(this.e,a);b=wk(this,this.root);ck(this.A,this.root,b);xk(this,b,!1);this.j=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.j=!1}this.D.push(!0);this.w={};this.w["e"+a]=
b;this.b++;yk(this,-1)}function zk(a,b,c,d){return(b=b[d])&&b.evaluate(a.f)!==c[d]}function Ak(a,b,c){for(var d in c){var e=b[d];e?(a.u[d]=e,delete b[d]):(e=c[d])&&(a.u[d]=new V(e,33554432))}}var Bk=["column-count","column-width"];
function xk(a,b,c){c||["writing-mode","direction"].forEach(function(a){b[a]&&(this.u[a]=b[a])},a);if(!a.I){c=zk(a,b,a.h.g,"background-color")?b["background-color"].evaluate(a.f):null;var d=zk(a,b,a.h.g,"background-image")?b["background-image"].evaluate(a.f):null;if(c&&c!==Ld||d&&d!==Ld)Ak(a,b,a.h.g),a.I=!0}if(!a.M)for(c=0;c<Bk.length;c++)if(zk(a,b,a.h.j,Bk[c])){Ak(a,b,a.h.j);a.M=!0;break}if(c=b["font-size"]){d=c.evaluate(a.f);c=d.C;switch(d.ia){case "em":case "rem":c*=a.f.g;break;case "ex":case "rex":c*=
a.f.g*rc.ex/rc.em;break;case "%":c*=a.f.g/100;break;default:(d=rc[d.ia])&&(c*=d)}a.f.$=c}}function wk(a,b){if(b.style instanceof CSSStyleDeclaration){var c=b.getAttribute("style");if(c){var d=a.Z.url,e=new jk(a.fa,a.h),c=new bc(c,e);try{bg(new Uf(Lf,c,e,d),Number.POSITIVE_INFINITY,!1,!0,!1)}catch(f){u.b(f,"Style attribute parse error:")}return e.b}}return{}}
function yk(a,b){if(!(b>=a.b)){var c=a.f,d=uh(a.Z,a.root);if(b<d){var e=a.g(a.root,!1),f=e["flow-into"],f=f?f.evaluate(c,"flow-into").toString():"body";Ck(a,f,e,a.root,d)}d=xh(a.Z,b);e=vh(a.Z,d,0,!1);if(!(e>=a.b))for(;;){if(1!=d.nodeType)e+=d.textContent.length;else{var g=d;if(e!=uh(a.Z,g))throw Error("Inconsistent offset");var k=a.g(g,!1);if(f=k["flow-into"])f=f.evaluate(c,"flow-into").toString(),Ck(a,f,k,g,e);e++}if(e>=a.b)break;f=d.firstChild;if(null==f)for(;!(f=d.nextSibling);)if(d=d.parentNode,
d===a.root)return;d=f}}}function Ck(a,b,c,d,e){var f=0,g=Number.POSITIVE_INFINITY,k=!1,h=!1,l=!1,n=c["flow-options"];if(n){var p;a:{if(k=n.evaluate(a.f,"flow-options")){h=new kg;try{k.R(h);p=h.b;break a}catch(q){u.b(q,"toSet:")}}p={}}k=!!p.exclusive;h=!!p["static"];l=!!p.last}(p=c["flow-linger"])&&(g=mg(p.evaluate(a.f,"flow-linger"),Number.POSITIVE_INFINITY));(c=c["flow-priority"])&&(f=mg(c.evaluate(a.f,"flow-priority"),0));d=new Yh(b,d,e,f,g,k,h,l);a.B.push(d);a.l==b&&(a.l=null);a.k&&Dk(a.k,d)}
function Ek(a,b,c){var d=-1;if(b<=a.b&&(d=tk(a.e,b),d+=c,d<qk(a.e)))return uk(a.e,d);if(null==a.d)return Number.POSITIVE_INFINITY;for(var e=a.f;;){var f=a.d.firstChild;if(null==f)for(;;){if(1==a.d.nodeType){var f=a.A,g=a.d;if(f.va.pop()!==g)throw Error("Invalid call to popElement");f.Ta.pop();f.pop();ak(f);a.Qa=a.D.pop()}if(f=a.d.nextSibling)break;a.d=a.d.parentNode;if(a.d===a.root)return a.d=null,b<a.b&&(0>d&&(d=tk(a.e,b),d+=c),d<=qk(a.e))?uk(a.e,d):Number.POSITIVE_INFINITY}a.d=f;if(1!=a.d.nodeType)a.b+=
a.d.textContent.length,a.Qa?rk(a.e,a.b):sk(a.e,a.b);else{g=a.d;f=wk(a,g);a.D.push(a.Qa);ck(a.A,g,f);a.j||"body"!=g.localName||g.parentNode!=a.root||(xk(a,f,!0),a.j=!0);var k=f["flow-into"];k&&(k=k.evaluate(e,"flow-into").toString(),Ck(a,k,f,g,a.b),a.Qa=!!a.$[k]);a.Qa&&(g=f.display)&&g.evaluate(e,"display")===Td&&(a.Qa=!1);if(uh(a.Z,a.d)!=a.b)throw Error("Inconsistent offset");a.w["e"+a.b]=f;a.b++;a.Qa?rk(a.e,a.b):sk(a.e,a.b);if(b<a.b&&(0>d&&(d=tk(a.e,b),d+=c),d<=qk(a.e)))return uk(a.e,d)}}}
vk.prototype.g=function(a,b){var c=uh(this.Z,a),d="e"+c;b&&(c=vh(this.Z,a,0,!0));this.b<=c&&Ek(this,c,0);return this.w[d]};var Fk=1;function Gk(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.h=0;this.d=a;this.name=b;this.fb=c;this.xa=d;this.parent=e;this.g="p"+Fk++;e&&(this.h=e.children.length,e.children.push(this))}Gk.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Gk.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function Hk(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
function Lk(a,b){for(var c=0;c<a.children.length;c++)a.children[c].clone({parent:b})}function Mk(a){Gk.call(this,a,null,null,[],null);this.b.width=new V(le,0);this.b.height=new V(me,0)}t(Mk,Gk);
function Nk(a,b){this.e=b;var c=this;mc.call(this,a,function(a,b){var f=a.match(/^([^.]+)\.([^.]+)$/);if(f){var g=c.e.k[f[1]];if(g&&(g=this.pa[g])){if(b){var f=f[2],k=g.fa[f];if(k)g=k;else{switch(f){case "columns":var k=g.d.d,h=new bd(k,0),l=Ok(g,"column-count"),n=Ok(g,"column-width"),p=Ok(g,"column-gap"),k=G(k,dd(k,new Zc(k,"min",[h,l]),E(k,n,p)),p)}k&&(g.fa[f]=k);g=k}}else g=Ok(g,f[2]);return g}}return null})}t(Nk,mc);
function Pk(a,b,c,d,e,f,g){a=a instanceof Nk?a:new Nk(a,this);Gk.call(this,a,b,c,d,e);this.e=this;this.J=f;this.j=g;this.b.width=new V(le,0);this.b.height=new V(me,0);this.b["wrap-flow"]=new V(Ad,0);this.b.position=new V(Yd,0);this.b.overflow=new V(Jd,0);this.k={}}t(Pk,Gk);Pk.prototype.f=function(a){return new Qk(a,this)};Pk.prototype.clone=function(a){a=new Pk(this.d,this.name,a.fb||this.fb,this.xa,this.parent,this.J,this.j);Hk(this,a);Lk(this,a);return a};
function Rk(a,b,c,d,e){Gk.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.k[b]=this.g);this.b["wrap-flow"]=new V(Ad,0)}t(Rk,Gk);Rk.prototype.f=function(a){return new Sk(a,this)};Rk.prototype.clone=function(a){a=new Rk(a.parent.d,this.name,this.fb,this.xa,a.parent);Hk(this,a);Lk(this,a);return a};function Tk(a,b,c,d,e){Gk.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.k[b]=this.g)}t(Tk,Gk);Tk.prototype.f=function(a){return new Uk(a,this)};
Tk.prototype.clone=function(a){a=new Tk(a.parent.d,this.name,this.fb,this.xa,a.parent);Hk(this,a);Lk(this,a);return a};function Y(a,b,c){return b&&b!==Ad?b.ea(a,c):null}function Vk(a,b,c){return b&&b!==Ad?b.ea(a,c):a.b}function Wk(a,b,c){return b?b===Ad?null:b.ea(a,c):a.b}function Xk(a,b,c,d){return b&&c!==Td?b.ea(a,d):a.b}function Yk(a,b,c){return b?b===je?a.g:b===Hd?a.f:b.ea(a,a.b):c}
function Zk(a,b){this.e=a;this.d=b;this.B={};this.style={};this.k=this.l=null;this.children=[];this.D=this.I=this.f=this.g=!1;this.w=this.A=0;this.u=null;this.ma={};this.fa={};this.va=this.b=!1;a&&a.children.push(this)}function $k(a,b,c){b=Ok(a,b);c=Ok(a,c);if(!b||!c)throw Error("E_INTERNAL");return E(a.d.d,b,c)}
function Ok(a,b){var c=a.ma[b];if(c)return c;var d=a.style[b];d&&(c=d.ea(a.d.d,a.d.d.b));switch(b){case "margin-left-edge":c=Ok(a,"left");break;case "margin-top-edge":c=Ok(a,"top");break;case "margin-right-edge":c=$k(a,"border-right-edge","margin-right");break;case "margin-bottom-edge":c=$k(a,"border-bottom-edge","margin-bottom");break;case "border-left-edge":c=$k(a,"margin-left-edge","margin-left");break;case "border-top-edge":c=$k(a,"margin-top-edge","margin-top");break;case "border-right-edge":c=
$k(a,"padding-right-edge","border-right-width");break;case "border-bottom-edge":c=$k(a,"padding-bottom-edge","border-bottom-width");break;case "padding-left-edge":c=$k(a,"border-left-edge","border-left-width");break;case "padding-top-edge":c=$k(a,"border-top-edge","border-top-width");break;case "padding-right-edge":c=$k(a,"right-edge","padding-right");break;case "padding-bottom-edge":c=$k(a,"bottom-edge","padding-bottom");break;case "left-edge":c=$k(a,"padding-left-edge","padding-left");break;case "top-edge":c=
$k(a,"padding-top-edge","padding-top");break;case "right-edge":c=$k(a,"left-edge","width");break;case "bottom-edge":c=$k(a,"top-edge","height")}if(!c){if("extent"==b)d=a.b?"width":"height";else if("measure"==b)d=a.b?"height":"width";else{var e=a.b?Ri:Si,d=b,f;for(f in e)d=d.replace(f,e[f])}d!=b&&(c=Ok(a,d))}c&&(a.ma[b]=c);return c}
function al(a){var b=a.d.d,c=a.style,d=Yk(b,c.enabled,b.g),e=Y(b,c.page,b.b);if(e)var f=new Xc(b,"page-number"),d=cd(b,d,new Pc(b,e,f));(e=Y(b,c["min-page-width"],b.b))&&(d=cd(b,d,new Oc(b,new Xc(b,"page-width"),e)));(e=Y(b,c["min-page-height"],b.b))&&(d=cd(b,d,new Oc(b,new Xc(b,"page-height"),e)));d=a.M(d);c.enabled=new L(d)}Zk.prototype.M=function(a){return a};
Zk.prototype.Dc=function(){var a=this.d.d,b=this.style,c=this.e?this.e.style.width.ea(a,null):null,d=Y(a,b.left,c),e=Y(a,b["margin-left"],c),f=Xk(a,b["border-left-width"],b["border-left-style"],c),g=Vk(a,b["padding-left"],c),k=Y(a,b.width,c),h=Y(a,b["max-width"],c),l=Vk(a,b["padding-right"],c),n=Xk(a,b["border-right-width"],b["border-right-style"],c),p=Y(a,b["margin-right"],c),q=Y(a,b.right,c),r=E(a,f,g),v=E(a,f,l);d&&q&&k?(r=G(a,c,E(a,k,E(a,E(a,d,r),v))),e?p?q=G(a,r,p):p=G(a,r,E(a,q,e)):(r=G(a,r,
q),p?e=G(a,r,p):p=e=dd(a,r,new B(a,.5)))):(e||(e=a.b),p||(p=a.b),d||q||k||(d=a.b),d||k?d||q?k||q||(k=this.l,this.g=!0):d=a.b:(k=this.l,this.g=!0),r=G(a,c,E(a,E(a,e,r),E(a,p,v))),this.g&&(h||(h=G(a,r,d?d:q)),this.b||!Y(a,b["column-width"],null)&&!Y(a,b["column-count"],null)||(k=h,this.g=!1)),d?k?q||(q=G(a,r,E(a,d,k))):k=G(a,r,E(a,d,q)):d=G(a,r,E(a,q,k)));a=Vk(a,b["snap-width"]||(this.e?this.e.style["snap-width"]:null),c);b.left=new L(d);b["margin-left"]=new L(e);b["border-left-width"]=new L(f);b["padding-left"]=
...
Zk.prototype.Ec=function(){var a=this.d.d,b=this.style,c=this.e?this.e.style.width.ea(a,null):null,d=this.e?this.e.style.height.ea(a,null):null,e=Y(a,b.top,d),f=Y(a,b["margin-top"],c),g=Xk(a,b["border-top-width"],b["border-top-style"],c),k=Vk(a,b["padding-top"],c),h=Y(a,b.height,d),l=Y(a,b["max-height"],d),n=Vk(a,b["padding-bottom"],c),p=Xk(a,b["border-bottom-width"],b["border-bottom-style"],c),q=Y(a,b["margin-bottom"],c),r=Y(a,b.bottom,d),v=E(a,g,k),y=E(a,p,n);e&&r&&h?(d=G(a,d,E(a,h,E(a,E(a,e,v),
y))),f?q?r=G(a,d,f):q=G(a,d,E(a,r,f)):(d=G(a,d,r),q?f=G(a,d,q):q=f=dd(a,d,new B(a,.5)))):(f||(f=a.b),q||(q=a.b),e||r||h||(e=a.b),e||h?e||r?h||r||(h=this.k,this.f=!0):e=a.b:(h=this.k,this.f=!0),d=G(a,d,E(a,E(a,f,v),E(a,q,y))),this.f&&(l||(l=G(a,d,e?e:r)),this.b&&(Y(a,b["column-width"],null)||Y(a,b["column-count"],null))&&(h=l,this.f=!1)),e?h?r||(r=G(a,d,E(a,e,h))):h=G(a,d,E(a,r,e)):e=G(a,d,E(a,r,h)));a=Vk(a,b["snap-height"]||(this.e?this.e.style["snap-height"]:null),c);b.top=new L(e);b["margin-top"]=
...
function bl(a){var b=a.d.d,c=a.style;a=Y(b,c[a.b?"height":"width"],null);var d=Y(b,c["column-width"],a),e=Y(b,c["column-count"],null),f;(f=(f=c["column-gap"])&&f!==Ud?f.ea(b,null):null)||(f=new Wc(b,1,"em"));d&&!e&&(e=new Zc(b,"floor",[ed(b,E(b,a,f),E(b,d,f))]),e=new Zc(b,"max",[b.d,e]));e||(e=b.d);d=G(b,ed(b,E(b,a,f),e),f);c["column-width"]=new L(d);c["column-count"]=new L(e);c["column-gap"]=new L(f)}function cl(a,b,c,d){a=a.style[b].ea(a.d.d,null);return zc(a,c,d,{})}
function dl(a,b){b.pa[a.d.g]=a;var c=a.d.d,d=a.style,e=a.e?el(a.e,b):null,e=mk(a.B,b,e,!1);a.b=lk(e,b,a.e?a.e.b:!1);nk(e,d,a.b,function(a,b){return b.value});a.l=new oc(c,function(){return a.A},"autoWidth");a.k=new oc(c,function(){return a.w},"autoHeight");a.Dc();a.Ec();bl(a);al(a)}function fl(a,b,c){(a=a.style[c])&&(a=jg(b,a,c));return a}function Z(a,b,c){(a=a.style[c])&&(a=jg(b,a,c));return wd(a,b)}
function el(a,b){var c;a:{if(c=a.B["region-id"]){for(var d=[],e=0;e<c.length;e++){var f=c[e].evaluate(b,"");f&&f!==H&&d.push(f)}if(d.length){c=d;break a}}c=null}if(c){d=[];for(e=0;e<c.length;e++)d[e]=c[e].toString();return d}return null}function gl(a,b,c,d){if(a=fl(a,b,d))a.ac()&&sc(a.ia)&&(a=new K(wd(a,b),"px")),w(c.d,d,a.toString())}
function hl(a,b,c){var d=Z(a,b,"left"),e=Z(a,b,"margin-left"),f=Z(a,b,"padding-left"),g=Z(a,b,"border-left-width");a=Z(a,b,"width");ui(c,d,a);w(c.d,"margin-left",e+"px");w(c.d,"padding-left",f+"px");w(c.d,"border-left-width",g+"px");c.marginLeft=e;c.$=g;c.j=f}
function il(a,b,c){var d=Z(a,b,"right"),e=Z(a,b,"snap-height"),f=Z(a,b,"margin-right"),g=Z(a,b,"padding-right");b=Z(a,b,"border-right-width");w(c.d,"margin-right",f+"px");w(c.d,"padding-right",g+"px");w(c.d,"border-right-width",b+"px");c.marginRight=f;c.Fa=b;a.b&&0<e&&(a=d+ri(c),a=a-Math.floor(a/e)*e,0<a&&(c.Tb=e-a,g+=c.Tb));c.D=g;c.Ub=e}
function jl(a,b,c){var d=Z(a,b,"snap-height"),e=Z(a,b,"top"),f=Z(a,b,"margin-top"),g=Z(a,b,"padding-top");b=Z(a,b,"border-top-width");c.top=e;c.marginTop=f;c.fa=b;c.Ga=d;!a.b&&0<d&&(a=e+oi(c),a=a-Math.floor(a/d)*d,0<a&&(c.pa=d-a,g+=c.pa));c.k=g;w(c.d,"top",e+"px");w(c.d,"margin-top",f+"px");w(c.d,"padding-top",g+"px");w(c.d,"border-top-width",b+"px")}
...
function ml(a,b,c){w(c.d,"border-top-width","0px");var d=Z(a,b,"max-height");a.I?ti(c,0,d):(jl(a,b,c),d-=c.pa,c.height=d,w(c.d,"height",d+"px"))}function nl(a,b,c){w(c.d,"border-left-width","0px");var d=Z(a,b,"max-width");a.D?ui(c,0,d):(il(a,b,c),d-=c.Tb,c.width=d,a=Z(a,b,"right"),w(c.d,"right",a+"px"),w(c.d,"width",d+"px"))}
...
Zk.prototype.eb=function(a,b){this.e&&this.b==this.e.b||w(b.d,"writing-mode",this.b?"vertical-rl":"horizontal-tb");(this.b?this.g:this.f)?this.b?nl(this,a,b):ml(this,a,b):(this.b?il(this,a,b):jl(this,a,b),this.b?hl(this,a,b):kl(this,a,b));(this.b?this.f:this.g)?this.b?ml(this,a,b):nl(this,a,b):ll(this,a,b);for(var c=0;c<ol.length;c++)gl(this,a,b,ol[c])};function sl(a,b,c){for(var d=0;d<ql.length;d++)gl(a,b,c,ql[d])}
Zk.prototype.Zb=function(a,b,c,d,e){this.b?this.A=b.e+b.Tb:this.w=b.e+b.pa;var f=(this.b||!d)&&this.f,g=(!this.b||!d)&&this.g,k=null;if(g||f)g&&w(b.d,"width","auto"),f&&w(b.d,"height","auto"),k=(d?d.d:b.d).getBoundingClientRect(),g&&(this.A=Math.ceil(k.right-k.left-b.j-b.$-b.D-b.Fa),this.b&&(this.A+=b.Tb)),f&&(this.w=k.bottom-k.top-b.k-b.fa-b.w-b.va,this.b||(this.w+=b.pa));(this.b?this.f:this.g)&&ll(this,a,b);if(this.b?this.g:this.f){if(this.b?this.D:this.I)this.b?il(this,a,b):jl(this,a,b);this.b?
hl(this,a,b):kl(this,a,b)}if(1<e&&(f=Z(this,a,"column-rule-width"),g=fl(this,a,"column-rule-style"),k=fl(this,a,"column-rule-color"),0<f&&g&&g!=Td&&k!=fe)){var h=Z(this,a,"column-gap"),l=this.b?b.height:b.width,n=this.b?"border-top":"border-left";for(d=1;d<e;d++){var p=(l+h)*d/e-h/2+b.j-f/2,q=b.height+b.k+b.w,r=b.d.ownerDocument.createElement("div");w(r,"position","absolute");w(r,this.b?"left":"top","0px");w(r,this.b?"top":"left",p+"px");w(r,this.b?"height":"width","0px");w(r,this.b?"width":"height",
q+"px");w(r,n,f+"px "+g.toString()+(k?" "+k.toString():""));b.d.insertBefore(r,b.d.firstChild)}}for(d=0;d<pl.length;d++)gl(this,a,b,pl[d]);for(d=0;d<rl.length;d++)e=b,f=rl[d],g=c.g,(k=fl(this,a,f))&&g.push(new Qh(e.d,f,k))};
Zk.prototype.h=function(a,b){var c=this.B,d=this.d.b,e;for(e in d)Wi(e)&&Xi(c,e,d[e]);if("background-host"==this.d.fb)for(e in b)if(e.match(/^background-/)||"writing-mode"==e)c[e]=b[e];if("layout-host"==this.d.fb)for(e in b)e.match(/^background-/)||"writing-mode"==e||(c[e]=b[e]);Wj(a,this.d.xa,null,c);c.content&&(c.content=c.content.yc(new Fj(a,null)));dl(this,a.d);for(c=0;c<this.d.children.length;c++)this.d.children[c].f(this).h(a,b);a.pop()};
function tl(a,b){a.g&&(a.D=cl(a,"right",a.l,b)||cl(a,"margin-right",a.l,b)||cl(a,"border-right-width",a.l,b)||cl(a,"padding-right",a.l,b));a.f&&(a.I=cl(a,"top",a.k,b)||cl(a,"margin-top",a.k,b)||cl(a,"border-top-width",a.k,b)||cl(a,"padding-top",a.k,b));for(var c=0;c<a.children.length;c++)tl(a.children[c],b)}function ul(a){Zk.call(this,null,a)}t(ul,Zk);ul.prototype.h=function(a,b){Zk.prototype.h.call(this,a,b);this.children.sort(function(a,b){return b.d.j-a.d.j||a.d.h-b.d.h})};
function Qk(a,b){Zk.call(this,a,b);this.u=this}t(Qk,Zk);Qk.prototype.M=function(a){var b=this.d.e;b.J&&(a=cd(b.d,a,b.J));return a};Qk.prototype.$=function(){};function Sk(a,b){Zk.call(this,a,b);this.u=a.u}t(Sk,Zk);function Uk(a,b){Zk.call(this,a,b);this.u=a.u}t(Uk,Zk);function vl(a,b,c,d){var e=null;c instanceof qd&&(e=[c]);c instanceof jd&&(e=c.values);if(e)for(a=a.d.d,c=0;c<e.length;c++)if(e[c]instanceof qd){var f=kc(e[c].name,"enabled"),f=new Xc(a,f);d&&(f=new Fc(a,f));b=cd(a,b,f)}return b}
Uk.prototype.M=function(a){var b=this.d.d,c=this.style,d=Yk(b,c.required,b.f)!==b.f;if(d||this.f){var e;e=(e=c["flow-from"])?e.ea(b,b.b):new B(b,"body");e=new Zc(b,"has-content",[e]);a=cd(b,a,e)}a=vl(this,a,c["required-partitions"],!1);a=vl(this,a,c["conflicting-partitions"],!0);d&&(c=(c=this.u.style.enabled)?c.ea(b,null):b.g,c=cd(b,c,a),this.u.style.enabled=new L(c));return a};Uk.prototype.eb=function(a,b,c){w(b.d,"overflow","hidden");Zk.prototype.eb.call(this,a,b,c)};
function wl(a,b,c,d){Gf.call(this,a,b,!1);this.target=c;this.b=d}t(wl,Hf);wl.prototype.Ka=function(a,b,c){eh(this.b,a,b,c,this)};wl.prototype.mc=function(a,b){If(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};wl.prototype.Db=function(a,b){If(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};wl.prototype.gb=function(a,b,c){this.target.b[a]=new V(b,c?50331648:67108864)};function xl(a,b,c,d){wl.call(this,a,b,c,d)}t(xl,wl);
function yl(a,b,c,d){wl.call(this,a,b,c,d);c.b.width=new V(ke,0);c.b.height=new V(ke,0)}t(yl,wl);yl.prototype.Lb=function(a,b,c){a=new Tk(this.e,a,b,c,this.target);Ff(this.Y,new xl(this.e,this.Y,a,this.b))};yl.prototype.Kb=function(a,b,c){a=new Rk(this.e,a,b,c,this.target);a=new yl(this.e,this.Y,a,this.b);Ff(this.Y,a)};function zl(a,b,c,d){wl.call(this,a,b,c,d)}t(zl,wl);zl.prototype.Lb=function(a,b,c){a=new Tk(this.e,a,b,c,this.target);Ff(this.Y,new xl(this.e,this.Y,a,this.b))};
zl.prototype.Kb=function(a,b,c){a=new Rk(this.e,a,b,c,this.target);a=new yl(this.e,this.Y,a,this.b);Ff(this.Y,a)};var Al={"text-indent":"0px","margin-top":"0px","padding-top":"0px","border-top-width":"0px","border-top-style":"none","border-top-color":"transparent"},Bl={"text-indent":"0px","margin-right":"0px","padding-right":"0px","border-right-width":"0px","border-right-style":"none","border-right-color":"transparent"},Cl={};
...
function Gl(a){return a.getAttribute("data-adapt-pseudo")||""}function Hl(a,b,c,d){this.style=b;this.f=a;this.b=c;this.d=d;this.e={}}
Hl.prototype.g=function(a){var b=Gl(a);this.b&&b&&b.match(/after$/)&&(this.style=this.b.g(this.f,!0),this.b=null);var c=this.style._pseudos[b]||{};if(!this.e[b]){this.e[b]=!0;var d=c.content;d&&(d=d.evaluate(this.d),wi(d)&&d.R(new vi(a,this.d)))}if(b.match(/^first-/)&&!c["x-first-pseudo"]){a=1;var e;"first-letter"==b?a=0:null!=(e=b.match(/^first-([0-9]+)-lines$/))&&(a=e[1]-0);c["x-first-pseudo"]=new V(new sd(a),0)}return c};
function Il(a,b,c,d,e,f,g,k,h,l,n,p,q){this.A=a;this.d=b;this.viewport=c;this.u=c.b;this.k=d;this.D=e;this.Z=f;this.B=g;this.l=k;this.I=h;this.e=l;this.h=n;this.w=p;this.g=q;this.M=this.b=null;this.j=!1;this.W=null;this.aa=0;this.f=null}Il.prototype.clone=function(){return new Il(this.A,this.d,this.viewport,this.k,this.D,this.Z,this.B,this.l,this.I,this.e,this.h,this.w,this.g)};
function Jl(a,b,c,d,e,f){var g=M("createRefShadow");a.Z.j.load(b).then(function(k){if(k){var h=zh(k,b);if(h){var l=a.I,n=l.D[k.url];n||(n=l.style.h.b[k.url],n=new vk(k,n.d,n.g,new tc(0,l.u(),l.l(),l.g),l.e,n.j,l.j),l.D[k.url]=n);f=new bi(d,h,k,e,f,c,n)}}Q(g,f)});return O(g)}
function Kl(a,b,c,d,e,f,g,k){var h=M("createShadows"),l=e.template,n;l instanceof ud?n=Jl(a,l.url,2,b,k,null):n=N(null);n.then(function(l){var n=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var r=b.getAttribute("href"),v=null;r?v=k?k.Z:a.Z:k&&(r="http://www.w3.org/1999/xhtml"==k.Y.namespaceURI?k.Y.getAttribute("href"):k.Y.getAttributeNS("http://www.w3.org/1999/xlink","href"),v=k.Kc?k.Kc.Z:a.Z);r&&(r=ta(r,v.url),n=Jl(a,r,3,b,k,l))}null==n&&(n=N(l));n.then(function(l){var n;
if(n=d._pseudos){for(var q=El.createElementNS("http://www.pyroxy.com/ns/shadow","root"),p=q,r=0;r<Fl.length;r++){var v=Fl[r],ob;if(v){if(!n[v])continue;if(!("footnote-marker"!=v||c&&a.j))continue;if(v.match(/^first-/)&&(ob=e.display,!ob||ob===Md))continue;ob=El.createElementNS("http://www.w3.org/1999/xhtml","span");ob.setAttribute("data-adapt-pseudo",v)}else ob=El.createElementNS("http://www.pyroxy.com/ns/shadow","content");p.appendChild(ob);v.match(/^first-/)&&(p=ob)}l=new bi(b,q,null,k,l,2,new Hl(b,
d,f,g))}Q(h,l)})});return O(h)}function Ll(a,b,c){a.M=b;a.j=c}function Ml(a,b,c,d){var e=a.d;c=mk(c,e,a.D,a.j);b=lk(c,e,b);nk(c,d,b,function(b,c){var d=c.evaluate(e,b);if("font-family"==b){var h=a.B;if(d instanceof jd){for(var d=d.values,l=[],n=0;n<d.length;n++){var p=d[n],q=h.b[p.stringValue()];q&&l.push(I(q));l.push(p)}d=new jd(l)}else d=(h=h.b[d.stringValue()])?new jd([I(h),d]):d}return d});return b}
function Nl(a,b){for(var c=a.b.W,d=[],e=a.b.ba,f=-1;c&&1==c.nodeType;){var g=e&&e.root==c;if(!g||2==e.type){var k=(e?e.b:a.k).g(c,!1);d.push(k)}g?(c=e.Y,e=e.Kc):(c=c.parentNode,f++)}c=vc(a.d,"em",0===f);c={"font-size":new V(new K(c,"px"),0)};e=new aj(c,a.d);for(f=d.length-1;0<=f;--f){var g=d[f],k=[],h;for(h in g)Ii[h]&&k.push(h);k.sort(pe);for(var l=0;l<k.length;l++){var n=k[l];e.b=n;c[n]=g[n].yc(e)}}for(var p in b)Ii[p]||(c[p]=b[p]);return c}
var Ol={a:"a",sub:"sub",sup:"sup",table:"table",tr:"tr",td:"td",th:"th",code:"code",body:"div",p:"p",v:"p",date:"p",emphasis:"em",strong:"strong",style:"span",strikethrough:"del"};function Pl(a,b){b=ta(b,a.Z.url);return a.w[b]||b}
function Ql(a,b){var c=!0,d=M("createElementView"),e=a.W,f=a.b.ba?a.b.ba.b:a.k,g=f.g(e,!1),k={};a.b.parent||(g=Nl(a,g));a.b.g=Ml(a,a.b.g,g,k);k.direction&&(a.b.D=k.direction.toString());var h=k["flow-into"];if(h&&h.toString()!=a.A)return Q(d,!1),O(d);var l=k.display;if(l===Td)return Q(d,!1),O(d);Kl(a,e,null==a.b.parent,g,k,f,a.d,a.b.ba).then(function(f){a.b.ua=f;var g=a.b.parent&&a.b.parent.k;f=k["float-reference"];var h=k["float"],r=k.clear;if(k.position===xd||k.position===Yd)a.b.k=!0,h=null;g&&
...
null;a.b.M=f?f.toString():null;if(!a.b.d){if(f=k["break-after"])a.b.B=f.toString();if(f=k["break-before"])a.b.u=f.toString()}if(f=k["x-first-pseudo"])a.b.f=new ci(a.b.parent?a.b.parent.f:null,f.C);if(f=k["white-space"])switch(f.toString()){case "normal":case "nowrap":a.b.A=0;break;case "pre-line":a.b.A=1;break;case "pre":case "pre-wrap":a.b.A=2}var y=!1,J=null,W=[],P=e.namespaceURI,F=e.localName;if("http://www.w3.org/1999/xhtml"==P)"html"==F||"body"==F||"script"==F||"link"==F||"meta"==F?F="div":"vide_"==
F?F="video":"audi_"==F?F="audio":"object"==F&&(y=!!a.h);else if("http://www.idpf.org/2007/ops"==P)F="span",P="http://www.w3.org/1999/xhtml";else if("http://www.gribuser.ru/xml/fictionbook/2.0"==P){P="http://www.w3.org/1999/xhtml";if("image"==F){if(F="div",(f=e.getAttributeNS("http://www.w3.org/1999/xlink","href"))&&"#"==f.charAt(0)&&(f=zh(a.Z,f)))J=a.createElement(P,"img"),f="data:"+(f.getAttribute("content-type")||"image/jpeg")+";base64,"+f.textContent.replace(/[ \t\n\t]/g,""),W.push(tg(J,f))}else F=
Ol[F];F||(F=a.b.d?"span":"div")}else if("http://www.daisy.org/z3986/2005/ncx/"==P)if(P="http://www.w3.org/1999/xhtml","ncx"==F||"navPoint"==F)F="div";else if("navLabel"==F){if(F="span",h=e.parentNode){f=null;for(h=h.firstChild;h;h=h.nextSibling)if(1==h.nodeType&&(r=h,"http://www.daisy.org/z3986/2005/ncx/"==r.namespaceURI&&"content"==r.localName)){f=r.getAttribute("src");break}f&&(F="a",e=e.ownerDocument.createElementNS(P,"a"),e.setAttribute("href",f))}}else F="span";else"http://www.pyroxy.com/ns/shadow"==
P?(P="http://www.w3.org/1999/xhtml",F=a.b.d?"span":"div"):y=!!a.h;v?b?F="li":(F="div",l=Bd,k.display=l):"body"==F||"li"==F?F="div":"q"==F?F="span":"a"==F&&(f=k["hyperlink-processing"])&&"normal"!=f.toString()&&(F="span");k.behavior&&"none"!=k.behavior.toString()&&a.h&&(y=!0);var Ea;y?Ea=a.h(e,a.b.parent?a.b.parent.b:null,k):Ea=N(null);Ea.then(function(f){f?y&&(c="true"==f.getAttribute("data-adapt-process-children")):f=a.createElement(P,F);"a"==F&&f.addEventListener("click",a.e.A,!1);J&&(Rl(a,a.b,
"inner",J),f.appendChild(J));"iframe"==f.localName&&"http://www.w3.org/1999/xhtml"==f.namespaceURI&&Dl(f);if("http://www.gribuser.ru/xml/fictionbook/2.0"!=e.namespaceURI||"td"==F){for(var g=e.attributes,h=g.length,l=null,n=0;n<h;n++){var p=g[n],q=p.namespaceURI,r=p.localName,p=p.nodeValue;if(q)if("http://www.w3.org/2000/xmlns/"==q)continue;else"http://www.w3.org/1999/xlink"==q&&"href"==r&&(p=Pl(a,p));else{if(r.match(/^on/))continue;if("style"==r)continue;if("id"==r){Wh(a.e,f,p);continue}"src"==r||
"href"==r||"poster"==r?p=Pl(a,p):"srcset"==r&&(p=p.split(",").map(function(b){return Pl(a,b.trim())}).join(","))}if(q){var Ea=Cl[q];Ea&&(r=Ea+":"+r)}"src"!=r||q||"img"!=F||"http://www.w3.org/1999/xhtml"!=P?"href"==r&&"image"==F&&"http://www.w3.org/2000/svg"==P&&"http://www.w3.org/1999/xlink"==q?a.e.e.push(tg(f,p)):q?f.setAttributeNS(q,r,p):f.setAttribute(r,p):l=p}l&&(g=tg(f,l),h=k.width,l=k.height,h&&h!==Ad&&l&&l!==Ad?a.e.e.push(g):W.push(g))}delete k.content;(g=k["list-style-image"])&&g instanceof
ud&&(g=g.url,W.push(tg(new Image,g)));Sl(a,f,k);g=k.widows;h=k.orphans;if(g||h){if(a.b.parent){a.b.l={};for(var ae in a.b.parent.l)a.b.l[ae]=a.b.parent.l[ae]}g instanceof sd&&(a.b.l.widows=g.C);h instanceof sd&&(a.b.l.orphans=h.C)}if(!b&&!a.b.d){ae=a.b.g?Bl:Al;for(var Kk in ae)w(f,Kk,ae[Kk])}v&&f.setAttribute("value",k["ua-list-item-count"].stringValue());a.f=f;W.length?sg(W).then(function(){Q(d,c)}):nf().then(function(){Q(d,c)})})});return O(d)}
function Tl(a,b){var c=M("createNodeView"),d,e=!0;1==a.W.nodeType?d=Ql(a,b):(8==a.W.nodeType?a.f=null:a.f=document.createTextNode(a.W.textContent.substr(a.aa||0)),d=N(!0));d.then(function(b){e=b;(a.b.b=a.f)&&(b=a.b.parent?a.b.parent.b:a.M)&&b.appendChild(a.f);Q(c,e)});return O(c)}function Ul(a,b,c){(a.b=b)?(a.W=b.W,a.aa=b.aa):(a.W=null,a.aa=-1);a.f=null;return a.b?Tl(a,c):N(!0)}
function Vl(a){if(null==a.ba||"content"!=a.W.localName||"http://www.pyroxy.com/ns/shadow"!=a.W.namespaceURI)return a;var b=a.ca,c=a.ba,d=a.parent,e,f;c.ed?(f=c.ed,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.Kc,e=c.Y.firstChild,c=2);var g=a.W.nextSibling;g?(a.W=g,ei(a)):a.na?a=a.na:e?a=null:(a=a.parent.modify(),a.K=!0);if(e)return b=new di(e,d,b),b.ba=f,b.La=c,b.na=a,b;a.ca=b;return a}
function Wl(a){var b=a.ca+1;if(a.K){if(!a.parent)return null;if(3!=a.La){var c=a.W.nextSibling;if(c)return a=a.modify(),a.ca=b,a.W=c,ei(a),Vl(a)}if(a.na)return a=a.na.modify(),a.ca=b,a;a=a.parent.modify()}else{if(a.ua&&(c=a.ua.root,2==a.ua.type&&(c=c.firstChild),c))return b=new di(c,a,b),b.ba=a.ua,b.La=a.ua.type,Vl(b);if(c=a.W.firstChild)return Vl(new di(c,a,b));1!=a.W.nodeType&&(b+=a.W.textContent.length-1-a.aa);a=a.modify()}a.ca=b;a.K=!0;return a}
function Xl(a,b){b=Wl(b);if(!b||b.K)return N(b);var c=M("nextInTree");Ul(a,b,!0).then(function(a){b.b&&a||(b=b.modify(),b.K=!0,b.b||(b.d=!0));Q(c,b)});return O(c)}function Yl(a,b){if(b instanceof jd)for(var c=b.values,d=0;d<c.length;d++)Yl(a,c[d]);else b instanceof ud&&(c=b.url,a.e.e.push(tg(new Image,c)))}
function Sl(a,b,c){var d=c["background-image"];d&&Yl(a,d);for(var e in c)d=c[e],!Ph[e]||"position"==e&&d!==Yd?(d.ac()&&sc(d.ia)&&(d=new K(wd(d,a.d),"px")),w(b,e,d.toString())):a.e.g.push(new Qh(b,e,d))}function Rl(a,b,c,d){if(!b.K){var e=(b.ba?b.ba.b:a.k).g(a.W,!1);if(e=e._pseudos)if(e=e[c])c={},b.g=Ml(a,b.g,e,c),b=c.content,wi(b)&&(b.R(new vi(d,a.d)),delete c.content),Sl(a,d,c)}}
function Zl(a,b,c){var d=M("peelOff"),e=b.f,f=b.aa,g=b.K;if(0<c)b.b.textContent=b.b.textContent.substr(0,c),f+=c;else if(!g&&b.b&&0==f){var k=b.b.parentNode;k&&k.removeChild(b.b)}for(var h=b.ca+c,l=[];b.f===e;)l.push(b),b=b.parent;var n=l.pop(),p=n.na;of(function(){for(;0<l.length;){n=l.pop();b=new di(n.W,b,h);0==l.length&&(b.aa=f,b.K=g);b.La=n.La;b.ba=n.ba;b.ua=n.ua;b.na=n.na?n.na:p;p=null;var c=Ul(a,b,!1);if(c.ya())return c}return N(!1)}).then(function(){Q(d,b)});return O(d)}
Il.prototype.createElement=function(a,b){return"http://www.w3.org/1999/xhtml"==a?this.u.createElement(b):this.u.createElementNS(a,b)};function $l(a,b,c){var d={},e=a.l._pseudos;b=Ml(a,b,a.l,d);if(e&&e.before){var f={},g=a.createElement("http://www.w3.org/1999/xhtml","span");g.setAttribute("data-adapt-pseudo","before");c.appendChild(g);Ml(a,b,e.before,f);delete f.content;Sl(a,g,f)}delete d.content;Sl(a,c,d);return b}
function Ci(a,b,c){return b.aa===c.aa&&b.K==c.K&&b.ha.length===c.ha.length&&b.ha.every(function(a,b){var f;f=c.ha[b];if(a.ba)if(f.ba){var g=1===a.da.nodeType?a.da:a.da.parentElement,k=1===f.da.nodeType?f.da:f.da.parentElement;f=a.ba.Y===f.ba.Y&&Gl(g)===Gl(k)}else f=!1;else f=a.da===f.da;return f}.bind(a))}function am(a){this.b=a}function bm(a){return a.getClientRects()}
function cm(a,b,c,d,e){this.f=a;this.fontSize=b;this.b=a.document;this.root=c||this.b.body;b=this.root.firstElementChild;b||(b=this.b.createElement("div"),this.root.appendChild(b));c=b.firstElementChild;c||(c=this.b.createElement("div"),b.appendChild(c));this.e=b;this.d=c;b=(new am(a)).b.getComputedStyle(this.root,null);this.width=d||parseFloat(b.width)||a.innerWidth;this.height=e||parseFloat(b.height)||a.innerHeight}
cm.prototype.zoom=function(a,b,c){w(this.e,"width",a*c+"px");w(this.e,"height",b*c+"px");w(this.d,"width",a+"px");w(this.d,"height",b+"px");w(this.d,"transform","scale("+c+")")};Hi("SIMPLE_PROPERTY",function(a){var b=a.name,c=a.value;switch(b){case "page-break-before":case "page-break-after":case "page-break-inside":return{name:b.replace(/^page-/,""),value:c===zd?Xd:c,important:a.important};default:return a}});var dm={page:!0,left:!0,right:!0,recto:!0,verso:!0,column:!0,region:!0},em={avoid:!0,"avoid-page":!0,"avoid-column":!0,"avoid-region":!0};function fm(a,b){return a?b?dm[b]?b:dm[a]?a:em[b]?b:em[a]?a:b:a:b};var gm={img:!0,svg:!0,audio:!0,video:!0};
function hm(a,b,c){var d=a.b;if(!d)return NaN;if(1==d.nodeType){if(a.K){var e=d.getBoundingClientRect();if(e.right>=e.left&&e.bottom>=e.top)return c?e.left:e.bottom}return NaN}var e=NaN,f=d.ownerDocument.createRange(),g=d.textContent.length;if(!g)return NaN;a.K&&(b+=g);b>=g&&(b=g-1);f.setStart(d,b);f.setEnd(d,b+1);a=bm(f);if(b=c){b=document.body;if(null==ib){var k=b.ownerDocument,f=k.createElement("div");f.style.position="absolute";f.style.top="0px";f.style.left="0px";f.style.width="100px";f.style.height=
"100px";f.style.overflow="hidden";f.style.lineHeight="16px";f.style.fontSize="16px";w(f,"writing-mode","vertical-rl");b.appendChild(f);g=k.createTextNode("a a a a a a a a a a a a a a a a");f.appendChild(g);k=k.createRange();k.setStart(g,0);k.setEnd(g,1);ib=50>k.getBoundingClientRect().left;b.removeChild(f)}b=ib}if(b){b=d.ownerDocument.createRange();b.setStart(d,0);b.setEnd(d,d.textContent.length);d=bm(b);b=[];for(f=0;f<a.length;f++){g=a[f];for(k=0;k<d.length;k++){var h=d[k];if(g.top>=h.top&&g.bottom<=
h.bottom&&1>Math.abs(g.right-h.right)){b.push({top:g.top,left:h.left,bottom:h.bottom,right:h.right});break}}k==d.length&&(u.b("Could not fix character box"),b.push(g))}a=b}for(b=d=0;b<a.length;b++)f=a[b],g=c?f.bottom-f.top:f.right-f.left,f.right>f.left&&f.bottom>f.top&&(isNaN(e)||g>d)&&(e=c?f.left:f.bottom,d=g);return e}function im(a,b){this.e=a;this.f=b}im.prototype.d=function(a,b){return b<this.f?null:jm(a,this,0<b)};im.prototype.b=function(){return this.f};
function km(a,b,c,d){this.position=a;this.f=b;this.g=c;this.e=d}km.prototype.d=function(a,b){var c;b<this.b()?c=null:(a.e=this.e,c=this.position);return c};km.prototype.b=function(){return(em[this.f]?1:0)+(this.g?3:0)+(this.position.parent?this.position.parent.h:0)};function lm(a,b,c){this.ca=a;this.d=b;this.b=c}
function mm(a){for(var b=1;b<a.length;b++){var c=a[b-1],d=a[b];c===d?u.b("validateCheckPoints: duplicate entry"):c.ca>=d.ca?u.b("validateCheckPoints: incorrect boxOffset"):c.W==d.W&&(d.K?c.K&&u.b("validateCheckPoints: duplicate after points"):c.K?u.b("validateCheckPoints: inconsistent after point"):d.ca-c.ca!=d.aa-c.aa&&u.b("validateCheckPoints: boxOffset inconsistent with offsetInNode"))}}
function nm(a,b,c){ni.call(this,a);this.Sc=a.lastChild;this.g=b;this.oc=c;this.wd=a.ownerDocument;this.qc=!1;this.ma=this.Ya=this.Ba=this.gd=this.Ta=0;this.Qb=this.Rb=this.l=this.h=null;this.Tc=!1;this.M=this.f=this.u=null;this.hd=!0;this.sc=this.rc=0}t(nm,ni);nm.prototype.clone=function(){var a=new nm(this.d,this.g,this.oc);si(a,this);a.Sc=this.Sc;a.qc=this.qc;a.l=this.l?this.l.clone():null;a.Rb=this.Rb.concat();return a};
function om(a,b){var c=(a.b?a.Ya:a.Ta)-a.h.V,d=(a.b?a.Ta:a.Ba)-a.h.T;return new qe(b.V-c,b.T-d,b.S-c,b.P-d)}function pm(a,b){return a.b?b<a.ma:b>a.ma}function qm(a,b,c){var d=new di(b.da,c,0);d.La=b.La;d.ba=b.ba;d.ua=b.ua;d.na=b.na?qm(a,b.na,gi(c)):null;return d}
function rm(a,b){var c=M("openAllViews"),d=b.ha;Ll(a.g,a.d,a.qc);var e=d.length-1,f=null;of(function(){for(;0<=e;){f=qm(a,d[e],f);if(0==e&&(f.aa=b.aa,f.K=b.K,f.K))break;var c=Ul(a.g,f,0==e&&0==f.aa);e--;if(c.ya())return c}return N(!1)}).then(function(){Q(c,f)});return O(c)}var sm=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
function tm(a,b){if(b.f&&b.d&&!b.K&&0==b.f.count&&1!=b.b.nodeType){var c=b.b.textContent.match(sm);return Zl(a.g,b,c[0].length)}return N(b)}function um(a,b,c){var d=M("buildViewToNextBlockEdge");pf(function(d){b.b&&c.push(gi(b));tm(a,b).then(function(f){f!==b&&(b=f,c.push(gi(b)));Xl(a.g,b).then(function(c){(b=c)?b.j&&!a.b?vm(a,b).then(function(c){b=c;!b||b.e||0<a.g.g.b.length?R(d):rf(d)}):b.d?rf(d):R(d):R(d)})})}).then(function(){Q(d,b)});return O(d)}
function wm(a,b){if(!b.b)return N(b);var c=b.W,d=M("buildDeepElementView");pf(function(d){tm(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.W!=c;)g=g.parent;if(null==g){b=f;R(d);return}}Xl(a.g,f).then(function(a){(b=a)&&b.W!=c?rf(d):R(d)})})}).then(function(){Q(d,b)});return O(d)}function xm(a,b,c,d,e){var f=a.wd.createElement("div");a.b?(w(f,"height",d+"px"),w(f,"width",e+"px")):(w(f,"width",d+"px"),w(f,"height",e+"px"));w(f,"float",c);w(f,"clear",c);a.d.insertBefore(f,b);return f}
function ym(a){for(var b=a.d.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.d.removeChild(b);else break}b=c}}function zm(a){for(var b=a.d.firstChild,c=a.Qb,d=a.b?a.h.T:a.h.V,e=a.b?a.h.P:a.h.S,f=0;f<c.length;f++){var g=c[f],k=g.P-g.T;g.left=xm(a,b,"left",g.V-d,k);g.right=xm(a,b,"right",e-g.S,k)}}
function Am(a,b,c,d,e){var f;if(b&&b.K&&!b.d&&(f=hm(b,0,a.b),!isNaN(f)))return f;b=c[d];for(e-=b.ca;;){f=hm(b,e,a.b);if(!isNaN(f))return f;if(0<e)e--;else{d--;if(0>d)return a.Ba;b=c[d];1!=b.b.nodeType&&(e=b.b.textContent.length)}}}function Bm(a){return"number"==typeof a?a:(a=a.match(/^(-?[0-9]*(\.[0-9]*)?)px$/))?parseFloat(a[0]):0}
function Cm(a,b){var c=a.oc.b.getComputedStyle(b,null),d=new se;c&&(d.left=Bm(c.marginLeft),d.top=Bm(c.marginTop),d.right=Bm(c.marginRight),d.bottom=Bm(c.marginBottom));return d}
function Dm(a,b,c){if(a=a.oc.b.getComputedStyle(b,null))c.marginLeft=Bm(a.marginLeft),c.$=Bm(a.borderLeftWidth),c.j=Bm(a.paddingLeft),c.marginTop=Bm(a.marginTop),c.fa=Bm(a.borderTopWidth),c.k=Bm(a.paddingTop),c.marginRight=Bm(a.marginRight),c.Fa=Bm(a.borderRightWidth),c.D=Bm(a.paddingRight),c.marginBottom=Bm(a.marginBottom),c.va=Bm(a.borderBottomWidth),c.w=Bm(a.paddingBottom)}function Em(a,b,c){b=new lm(b,c,c);a.f?a.f.push(b):a.f=[b]}
function Fm(a,b,c,d){if(a.f&&a.f[a.f.length-1].b)return Em(a,b,c),N(!0);d+=40*(a.b?-1:1);var e=a.l,f=!e;if(f){var g=a.d.ownerDocument.createElement("div");w(g,"position","absolute");var k=a.g.clone(),e=new nm(g,k,a.oc);a.l=e;e.b=$l(a.g,a.b,g);e.qc=!0;a.b?(e.left=0,w(e.d,"width","2em")):(e.top=a.Ya,w(e.d,"height","2em"))}a.d.appendChild(e.d);Dm(a,e.d,e);g=(a.b?-1:1)*(d-a.Ba);a.b?e.height=a.h.P-a.h.T-oi(e)-pi(e):e.width=a.h.S-a.h.V-qi(e)-ri(e);d=(a.b?-1:1)*(a.Ya-d)-(a.b?qi(e)-ri(e):oi(e)+pi(e));if(f&&
18>d)return a.d.removeChild(e.d),a.l=null,Em(a,b,c),N(!0);if(!a.b&&e.top<g)return a.d.removeChild(e.d),Em(a,b,c),N(!0);var h=M("layoutFootnoteInner");a.b?ui(e,0,d):ti(e,g,d);e.A=a.A+a.left+qi(a);e.B=a.B+a.top+oi(a);e.I=a.I;var l=new ji(c);f?(Gm(e),f=N(!0)):0==e.I.length?(Hm(e),f=N(!0)):f=Im(e);f.then(function(){Jm(e,l).then(function(d){a.b?(a.ma=a.Ya+(e.e+qi(e)+ri(e)),ui(e,0,e.e)):(a.ma=a.Ya-(e.e+oi(e)+pi(e)),ti(e,a.ma-a.Ba,e.e));var f;!a.b&&0<e.I.length?f=Im(e):f=N(d);f.then(function(d){d=new lm(b,
c,d?d.Qa:null);a.f?a.f.push(d):a.f=[d];Q(h,!0)})})});return O(h)}
function Km(a,b){var c=M("layoutFootnote"),d=b.b;d.setAttribute("style","");w(d,"display","inline-block");d.textContent="M";var e=d.getBoundingClientRect(),f=a.b?e.left:e.bottom;d.textContent="";Rl(a.g,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d={ha:[{da:b.W,La:0,ba:b.ba,ua:null,na:null}],aa:0,K:!1};e=b.ca;b=b.modify();b.K=!0;Fm(a,e,d,f).then(function(){a.l&&a.l.d.parentNode&&a.d.removeChild(a.l.d);pm(a,f)&&0!=a.u.length&&(b.e=!0);Q(c,b)});return O(c)}
function Lm(a,b){var c=M("layoutFloat"),d=b.b,e=b.j,f=b.M,g=b.parent?b.parent.D:"ltr",k=a.g.g,h=b.b.parentNode;"page"===f?Ai(k,d,e):(w(d,"float","none"),w(d,"position","absolute"),w(d,"left","auto"),w(d,"right","auto"),w(d,"top","auto"));wm(a,b).then(function(l){var n=d.getBoundingClientRect(),p=Cm(a,d),n=new qe(n.left-p.left,n.top-p.top,n.right+p.right,n.bottom+p.bottom);if("page"===f)Bi(k,b,a.g)?(n=h.ownerDocument.createElement("span"),w(n,"width","0"),w(n,"height","0"),h.appendChild(n),l.b=n,Q(c,
l)):Di(k,b,om(a,n)).then(function(){Q(c,null)});else{e=xi(e,a.b,g);for(var p=a.Ta,q=a.gd,r=b.parent;r&&r.d;)r=r.parent;if(r){var v=r.b.ownerDocument.createElement("div");v.style.left="0px";v.style.top="0px";a.b?(v.style.bottom="0px",v.style.width="1px"):(v.style.right="0px",v.style.height="1px");r.b.appendChild(v);var y=v.getBoundingClientRect(),p=Math.max(a.b?y.top:y.left,p),q=Math.min(a.b?y.bottom:y.right,q);r.b.removeChild(v);r=a.b?n.P-n.T:n.S-n.V;"left"==e?q=Math.max(q,p+r):p=Math.min(p,q-r)}p=
new qe(p,(a.b?-1:1)*a.Ba,q,(a.b?-1:1)*a.Ya);q=n;a.b&&(q=Ie(n));Ne(p,a.Qb,q,e);a.b&&(n=new qe(-q.P,q.V,-q.T,q.S));w(d,"left",n.V-(a.b?a.Ya:a.Ta)+a.j+"px");w(d,"top",n.T-(a.b?a.Ta:a.Ba)+a.k+"px");n=a.b?n.V:n.P;pm(a,n)&&0!=a.u.length?(b=b.modify(),b.e=!0,Q(c,b)):(ym(a),p=a.b?Ie(a.h):a.h,a.b?q=Ie(om(a,new qe(-q.P,q.V,-q.T,q.S))):q=om(a,q),Oe(p,a.Qb,q,e),zm(a),"left"==e?a.rc=n:a.sc=n,Mm(a,n),Q(c,l))}});return O(c)}
function Nm(a,b){for(var c=a.b,d="";c&&b&&!d&&(1!=c.nodeType||(d=c.style.textAlign,b));c=c.parentNode);if(!b||"justify"==d){var c=a.b,e=c.ownerDocument,d=e.createElement("span");d.style.visibility="hidden";d.textContent=" ########################";d.setAttribute("data-adapt-spec","1");var f=b&&(a.K||1!=c.nodeType)?c.nextSibling:c;if(c=c.parentNode)c.insertBefore(d,f),b||(e=e.createElement("div"),c.insertBefore(e,f),d.style.lineHeight="80px",e.style.marginTop="-80px",e.style.height="0px",e.setAttribute("data-adapt-spec",
"1"))}}function Om(a,b,c,d){var e=M("processLineStyling");mm(d);var f=d.concat([]);d.splice(0,d.length);var g=0,k=b.f;0==k.count&&(k=k.Gd);pf(function(d){if(k){var e=Pm(a,f),n=k.count-g;if(e.length<=n)R(d);else{var p=Qm(a,f,e[n-1]);Rm(a,p,!1,!1).then(function(){g+=n;Zl(a.g,p,0).then(function(e){b=e;Nm(b,!1);k=b.f;f=[];um(a,b,f).then(function(b){c=b;0<a.g.g.b.length?R(d):rf(d)})})})}}else R(d)}).then(function(){Array.prototype.push.apply(d,f);mm(d);Q(e,c)});return O(e)}
function Sm(a,b){for(var c=0,d=0,e=b.length-1;0<=e;e--){var f=b[e];if(!f.K||!f.b||1!=f.b.nodeType)break;f=Cm(a,f.b);f=a.b?-f.left:f.bottom;0<f?c=Math.max(c,f):d=Math.min(d,f)}return c-d}
function Tm(a,b){var c=M("layoutBreakableBlock"),d=[];um(a,b,d).then(function(e){if(0<a.g.g.b.length)Q(c,e);else{var f=d.length-1;if(0>f)Q(c,e);else{var f=Am(a,e,d,f,d[f].ca),g=pm(a,f);null==e&&(f+=Sm(a,d));Mm(a,f);var k;b.f?k=Om(a,b,e,d):k=N(e);k.then(function(b){0<d.length&&(a.u.push(new im(d,d[0].h)),g&&(2!=d.length&&0<a.u.length||d[0].W!=d[1].W||!gm[d[0].W.localName])&&b&&(b=b.modify(),b.e=!0));Q(c,b)})}}});return O(c)}
function Qm(a,b,c){mm(b);for(var d=0,e=b[0].ca,f=d,g=b.length-1,k=b[g].ca,h;e<k;){h=e+Math.ceil((k-e)/2);for(var f=d,l=g;f<l;){var n=f+Math.ceil((l-f)/2);b[n].ca>h?l=n-1:f=n}l=Am(a,null,b,f,h);if(a.b?l<c:l>c){for(k=h-1;b[f].ca==h;)f--;g=f}else Mm(a,l),e=h,d=f}a=b[f];b=a.b;1!=b.nodeType&&(a.K?a.aa=b.length:(e-=a.ca,c=b.data,173==c.charCodeAt(e)?(b.replaceData(e,c.length-e,"-"),e++):(d=c.charAt(e),e++,f=c.charAt(e),b.replaceData(e,c.length-e,Va(d)&&Va(f)?"-":"")),0<e&&(a=a.modify(),a.aa+=e,a.u=null)));
return a}
function Pm(a,b){for(var c=[],d=b[0].b,e=b[b.length-1].b,f=[],g=d.ownerDocument.createRange(),k=!1,h=null,l=!1,n=!0;n;){var p=!0;do{var q=null;d==e&&(n=!1);1!=d.nodeType?(l||(g.setStartBefore(d),l=!0),h=d):k?k=!1:d.getAttribute("data-adapt-spec")?p=!l:q=d.firstChild;q||(q=d.nextSibling,q||(k=!0,q=d.parentNode));d=q}while(p&&n);if(l){g.setEndAfter(h);l=bm(g);for(p=0;p<l.length;p++)f.push(l[p]);l=!1}}f.sort(a.b?ai:$h);h=d=k=g=e=0;for(n=a.b?-1:1;;){if(h<f.length&&(l=f[h],p=1,0<d&&(p=Math.max(a.b?l.right-
...
function Um(a,b){if(!a.f)return N(!0);for(var c=!1,d=a.f.length-1;0<=d;--d){var e=a.f[d];if(e.ca<=b)break;a.f.pop();e.b!==e.d&&(c=!0)}if(!c)return N(!0);var f=M("clearFootnotes"),g=a.e+a.Ba,k=a.f;a.l=null;a.f=null;var h=0;of(function(){for(;h<k.length;){var b=k[h++],b=Fm(a,b.ca,b.d,g);if(b.ya())return b}return N(!1)}).then(function(){Q(f,!0)});return O(f)}
function jm(a,b,c){var d=b.e,e;if(c)e=c=1;else{for(e=d[0];e.parent&&e.d;)e=e.parent;c=Math.max((e.l.widows||2)-0,1);e=Math.max((e.l.orphans||2)-0,1)}var f=Pm(a,d),g=a.ma,d=Ya(f.length,function(b){return a.b?f[b]<g:f[b]>g}),d=Math.min(f.length-c,d);if(d<e)return null;g=f[d-1];if(b=Qm(a,b.e,g))a.e=(a.b?-1:1)*(g-a.Ba);return b}
function Rm(a,b,c,d){var e=b;c=c||null!=b.b&&1==b.b.nodeType&&!b.K;do{var f=e.b.parentNode;if(!f)break;var g=f,k=e.b;if(g)for(var h=void 0;(h=g.lastChild)!=k;)g.removeChild(h);c&&(f.removeChild(e.b),c=!1);e=e.parent}while(e);d&&Nm(b,!0);return Um(a,b.ca)}
function Vm(a,b,c){var d=M("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,k=a.u.length-1;0<=k&&!e;--k){var e=a.u[k].d(a,f),h=a.u[k].b();h>f&&(g=Math.min(g,h))}while(g>f&&!e);var l=!1;if(!e){u.b("Could not find any page breaks?!!");if(a.hd)return Wm(a,b).then(function(b){b?(b=b.modify(),b.e=!1,Rm(a,b,l,!0).then(function(){Q(d,b)})):Q(d,b)}),O(d);e=c;l=!0}Rm(a,e,l,!0).then(function(){Q(d,e)});return O(d)}
function Xm(a){a=a.toString();return""==a||"auto"==a||!!a.match(/^0+(.0*)?[^0-9]/)}function Ym(a,b,c,d,e){if(!b)return!1;var f=hm(b,0,a.b),g=pm(a,f);c&&(f+=Sm(a,c));Mm(a,f);if(d||!g)b=new km(gi(b),e,g,a.e),a.u.push(b);return g}
function Zm(a,b){if(b.b.parentNode){var c=Cm(a,b.b),d=b.b.ownerDocument.createElement("div");a.b?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.b.parentNode.insertBefore(d,b.b);var e=d.getBoundingClientRect(),e=a.b?e.right:e.top,f=a.b?-1:1,g;switch(b.w){case "left":g=a.rc;break;case "right":g=a.sc;break;default:g=f*Math.max(a.sc*f,a.rc*f)}e*f>=g*f?b.b.parentNode.removeChild(d):(e=Math.max(1,(g-e)*
...
function $m(a,b,c){var d=M("skipEdges"),e=null,f=null,g=[];pf(function(d){for(;b;){do if(b.b){if(b.d&&1!=b.b.nodeType){if(Xh(b.b,b.A))break;if(!b.K){Ym(a,f,null,!0,e)?(b=(f||b).modify(),b.e=!0):(b=b.modify(),b.u=e);R(d);return}}if(!b.K&&(b.w&&Zm(a,b),b.j)){Ym(a,f,null,!0,e)&&(b=(f||b).modify(),b.e=!0);R(d);return}if(1==b.b.nodeType){var h=b.b.style;if(b.K){if(f=gi(b),g.push(f),e=fm(e,b.B),h&&(!Xm(h.paddingBottom)||!Xm(h.borderBottomWidth))){if(Ym(a,f,null,!0,e)){b=(f||b).modify();b.e=!0;R(d);return}g=
[f];f=e=null}}else{e=fm(e,b.u);if(!c&&dm[e]){R(d);a.M=e;return}if(gm[b.b.localName]){Ym(a,f,null,!0,e)&&(b=(f||b).modify(),b.e=!0);R(d);return}if(h&&(!Xm(h.paddingTop)||!Xm(h.borderTopWidth))){if(Ym(a,f,null,!0,e)){b=(f||b).modify();b.e=!0;R(d);return}f=e=null;g=[]}}}}while(0);h=Xl(a.g,b);if(h.ya()){h.then(function(a){b=a;rf(d)});return}b=h.Wb()}0!=a.u.length&&Ym(a,f,g,!1,e)&&f&&(b=f.modify(),b.e=!0);R(d)}).then(function(){Q(d,b)});return O(d)}
function Wm(a,b){var c=b,d=M("skipEdges"),e=null;pf(function(d){for(;b;){do if(b.b){if(b.d&&1!=b.b.nodeType){if(Xh(b.b,b.A))break;if(!b.K){R(d);return}}if(!b.K&&b.j){R(d);return}if(1==b.b.nodeType){var g=b.b.style;if(b.K)e=fm(e,b.B);else{e=fm(e,b.u);if(dm[e]){R(d);a.M=e;return}if(gm[b.b.localName]){R(d);return}if(g&&(!Xm(g.paddingTop)||!Xm(g.borderTopWidth))){R(d);return}}}}while(0);g=Xl(a.g,b);if(g.ya()){g.then(function(a){b=a;rf(d)});return}b=g.Wb()}c=null;R(d)}).then(function(){Q(d,c)});return O(d)}
function vm(a,b){return"footnote"==b.j?Km(a,b):Lm(a,b)}function an(a,b,c){var d=M("layoutNext");$m(a,b,c).then(function(c){b=c;if(!b||a.M||b.e)Q(d,b);else if(b.j)vm(a,b).oa(d);else{a:{if(!b.K)switch(b.W.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!0}c?Tm(a,b).oa(d):wm(a,b).oa(d)}});return O(d)}
function Hm(a){var b=a.d.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.k+"px";b.style.right=a.D+"px";b.style.bottom=a.w+"px";b.style.left=a.j+"px";a.d.appendChild(b);var c=b.getBoundingClientRect();a.d.removeChild(b);var b=a.A+a.left+qi(a),d=a.B+a.top+oi(a);a.h=new qe(b,d,b+a.width,d+a.height);a.Ta=c?a.b?c.top:c.left:0;a.gd=c?a.b?c.bottom:c.right:0;a.Ba=c?a.b?c.right:c.top:0;a.Ya=c?a.b?c.left:c.bottom:0;a.rc=a.Ba;a.sc=a.Ba;a.ma=a.Ya;c=a.h;b=a.A+a.left+qi(a);d=a.B+a.top+
oi(a);b=a.Sb?ye(a.Sb,b,d):Ae(b,d,b+a.width,d+a.height);a.Qb=Ke(c,[b],a.I,a.Ga,a.b);zm(a);a.f=null}function Gm(a){a.Rb=[];w(a.d,"width",a.width+"px");w(a.d,"height",a.height+"px");Hm(a);a.e=0;a.Tc=!1;a.M=null}function Mm(a,b){a.e=Math.max((a.b?-1:1)*(b-a.Ba),a.e)}function bn(a,b){var c=b.b;if(!c)return N(!0);var d=M("layoutOverflownFootnotes"),e=0;of(function(){for(;e<c.length;){var b=c[e++],b=Fm(a,0,b,a.Ba);if(b.ya())return b}return N(!1)}).then(function(){Q(d,!0)});return O(d)}
function Jm(a,b){a.Rb.push(b);if(a.Tc)return N(b);var c=M("layout");bn(a,b).then(function(){rm(a,b.Qa).then(function(b){var e=b,f=!0;a.u=[];pf(function(c){for(;b;){var k=!0;an(a,b,f).then(function(h){f=!1;b=h;0<a.g.g.b.length?R(c):a.M?R(c):b&&b.e?Vm(a,b,e).then(function(a){b=a;R(c)}):k?k=!1:rf(c)});if(k){k=!1;return}}R(c)}).then(function(){var e=a.l;e&&(a.d.appendChild(e.d),a.b?a.e=this.Ba-this.Ya:a.e=e.top+oi(e)+e.e+pi(e));if(b)if(0<a.g.g.b.length)Q(c,null);else{a.Tc=!0;e=new ji(ii(b));if(a.f){for(var f=
[],h=0;h<a.f.length;h++){var l=a.f[h].b;l&&f.push(l)}e.b=f.length?f:null}Q(c,e)}else Q(c,null)})})});return O(c)}function Im(a){for(var b=a.Rb,c=a.d.lastChild;c!=a.Sc;){var d=c.previousSibling;a.d===c.parentNode&&Gl(c)||a.d.removeChild(c);c=d}ym(a);Gm(a);var e=M("redoLayout"),f=0,g=null;pf(function(c){if(f<b.length){var d=b[f++];Jm(a,d).then(function(a){a?(g=a,R(c)):rf(c)})}else R(c)}).then(function(){Q(e,g)});return O(e)};function cn(a,b){this.e(a,"end",b)}function dn(a,b){this.e(a,"start",b)}function en(a,b,c){c||(c=this.g.now());var d=this.f[a];d||(d=this.f[a]=[]);var e;for(a=d.length-1;0<=a&&(!(e=d[a])||e[b]);a--)e=null;e||(e={},d.push(e));e[b]=c}function fn(){}function gn(a){this.g=a;this.f={};this.registerEndTiming=this.d=this.registerStartTiming=this.b=this.e=fn}
gn.prototype.h=function(){var a=this.f,b="";Object.keys(a).forEach(function(c){for(var d=a[c],e=d.length,f=0;f<e;f++){var g=d[f];b+=c;1<e&&(b+="("+f+")");b+=" => start: "+g.start+", end: "+g.end+", duration: "+(g.end-g.start)+"\n"}});u.e(b)};gn.prototype.j=function(){this.registerEndTiming=this.d=this.registerStartTiming=this.b=this.e=fn};gn.prototype.k=function(){this.e=en;this.registerStartTiming=this.b=dn;this.registerEndTiming=this.d=cn};
var hn={now:Date.now},jn,kn=jn=new gn(window&&window.performance||hn);en.call(kn,"load_vivliostyle","start",void 0);ca("vivliostyle.profile.profiler",kn);gn.prototype.printTimings=gn.prototype.h;gn.prototype.disable=gn.prototype.j;gn.prototype.enable=gn.prototype.k;function ln(a,b,c){function d(c){return a.b.getComputedStyle(b,null).getPropertyValue(c)}function e(){w(b,"display","block");w(b,"position","static");return d(W)}function f(){w(b,"display","inline-block");w(v,W,"99999999px");var a=d(W);w(v,W,"");return a}function g(){w(b,"display","inline-block");w(v,W,"0");var a=d(W);w(v,W,"");return a}function k(){var a=e(),b=g(),c=parseFloat(a);if(c<=parseFloat(b))return b;b=f();return c<=parseFloat(b)?a:b}function h(){throw Error("Getting fill-available block size is not implemented");
}var l=b.style.display,n=b.style.position,p=b.style.width,q=b.style.height,r=b.parentNode,v=b.ownerDocument.createElement("div");w(v,"position",n);r.insertBefore(v,b);v.appendChild(b);w(b,"width","auto");w(b,"height","auto");var y=d(Oa["writing-mode"])||d("writing-mode"),J="vertical-rl"===y||"tb-rl"===y||"vertical-lr"===y||"tb-lr"===y,W=J?"height":"width",P=J?"width":"height",F={};c.forEach(function(a){var c;switch(a){case "fill-available inline size":c=e();break;case "max-content inline size":c=
...
d(P);break;case "fit-content width":c=J?d(P):k();break;case "fit-content height":c=J?k():d(P)}F[a]=parseFloat(c);w(b,"position",n);w(b,"display",l)});w(b,"width",p);w(b,"height",q);r.insertBefore(b,v);r.removeChild(v);return F};function mn(a){var b=a["writing-mode"],b=b&&b.value;a=(a=a.direction)&&a.value;return b===ge||b!==he&&a!==ce?"ltr":"rtl"}
var nn={a5:{width:new K(148,"mm"),height:new K(210,"mm")},a4:{width:new K(210,"mm"),height:new K(297,"mm")},a3:{width:new K(297,"mm"),height:new K(420,"mm")},b5:{width:new K(176,"mm"),height:new K(250,"mm")},b4:{width:new K(250,"mm"),height:new K(353,"mm")},"jis-b5":{width:new K(182,"mm"),height:new K(257,"mm")},"jis-b4":{width:new K(257,"mm"),height:new K(364,"mm")},letter:{width:new K(8.5,"in"),height:new K(11,"in")},legal:{width:new K(8.5,"in"),height:new K(14,"in")},ledger:{width:new K(11,"in"),
height:new K(17,"in")}},on={width:le,height:me};function pn(a){if((a=a.size)&&a.value!==Ad){var b=a.value;b.ad()?(a=b.values[0],b=b.values[1]):(a=b,b=null);return a.ac()?{width:a,height:b||a}:(a=nn[a.name.toLowerCase()])?b&&b===Pd?{width:a.height,height:a.width}:{width:a.width,height:a.height}:on}return on}
var qn=function(){var a={width:!0,height:!0,"block-size":!0,"inline-size":!0,margin:!0,padding:!0,border:!0,outline:!0,"outline-width":!0,"outline-style":!0,"outline-color":!0};"left right top bottom before after start end block-start block-end inline-start inline-end".split(" ").forEach(function(b){a["margin-"+b]=!0;a["padding-"+b]=!0;a["border-"+b+"-width"]=!0;a["border-"+b+"-style"]=!0;a["border-"+b+"-color"]=!0});return a}(),rn={"top-left-corner":{N:1,ta:!0,qa:!1,ra:!0,sa:!0,ga:null},"top-left":{N:2,
...
qa:!0,ra:!1,sa:!1,ga:"center"},"bottom-left":{N:12,ta:!1,qa:!0,ra:!1,sa:!1,ga:"start"},"bottom-left-corner":{N:13,ta:!1,qa:!0,ra:!0,sa:!1,ga:null},"left-bottom":{N:14,ta:!1,qa:!1,ra:!0,sa:!1,ga:"end"},"left-middle":{N:15,ta:!1,qa:!1,ra:!0,sa:!1,ga:"center"},"left-top":{N:16,ta:!1,qa:!1,ra:!0,sa:!1,ga:"start"}},sn=Object.keys(rn).sort(function(a,b){return rn[a].N-rn[b].N});
function tn(a,b,c){Pk.call(this,a,null,"vivliostyle-page-rule-master",[],b,null,0);a=pn(c);new un(this.d,this,c,a);this.u={};vn(this,c);this.b.position=new V(Yd,0);this.b.width=new V(a.width,0);this.b.height=new V(a.height,0);for(var d in c)qn[d]||"background-clip"===d||(this.b[d]=c[d])}t(tn,Pk);function vn(a,b){var c=b._marginBoxes;c&&sn.forEach(function(d){c[d]&&(a.u[d]=new wn(a.d,a,d,b))})}tn.prototype.f=function(a){return new xn(a,this)};
function un(a,b,c,d){Tk.call(this,a,null,null,[],b);this.w=d;this.b["z-index"]=new V(new sd(0),0);this.b["flow-from"]=new V(I("body"),0);this.b.position=new V(xd,0);this.b.overflow=new V(ie,0);for(var e in qn)qn.hasOwnProperty(e)&&(this.b[e]=c[e])}t(un,Tk);un.prototype.f=function(a){return new yn(a,this)};
function wn(a,b,c,d){Tk.call(this,a,null,null,[],b);this.l=c;a=d._marginBoxes[this.l];for(var e in d)if(b=d[e],c=a[e],Ii[e]||c&&c.value===Ld)this.b[e]=b;for(e in a)Object.prototype.hasOwnProperty.call(a,e)&&(b=a[e])&&b.value!==Ld&&(this.b[e]=b)}t(wn,Tk);wn.prototype.f=function(a){return new zn(a,this)};function xn(a,b){Qk.call(this,a,b);this.j=null;this.pa={}}t(xn,Qk);
xn.prototype.h=function(a,b){var c=this.B,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}Qk.prototype.h.call(this,a,b)};xn.prototype.Dc=function(){var a=this.style;a.left=ne;a["margin-left"]=ne;a["border-left-width"]=ne;a["padding-left"]=ne;a["padding-right"]=ne;a["border-right-width"]=ne;a["margin-right"]=ne;a.right=ne};
xn.prototype.Ec=function(){var a=this.style;a.top=ne;a["margin-top"]=ne;a["border-top-width"]=ne;a["padding-top"]=ne;a["padding-bottom"]=ne;a["border-bottom-width"]=ne;a["margin-bottom"]=ne;a.bottom=ne};xn.prototype.$=function(a,b,c){b=b.l;var d={start:this.j.marginLeft,end:this.j.marginRight,X:this.j.rb},e={start:this.j.marginTop,end:this.j.marginBottom,X:this.j.qb};An(this,b.top,!0,d,a,c);An(this,b.bottom,!0,d,a,c);An(this,b.left,!1,e,a,c);An(this,b.right,!1,e,a,c)};
function Bn(a,b,c,d,e){this.L=a;this.l=e;this.g=c;this.k=!Y(d,b[c?"width":"height"],new Wc(d,0,"px"));this.h=null}Bn.prototype.b=function(){return this.k};function Cn(a){a.h||(a.h=ln(a.l,a.L.d,a.g?["max-content width","min-content width"]:["max-content height","min-content height"]));return a.h}Bn.prototype.e=function(){var a=Cn(this);return this.g?qi(this.L)+a["max-content width"]+ri(this.L):oi(this.L)+a["max-content height"]+pi(this.L)};
Bn.prototype.f=function(){var a=Cn(this);return this.g?qi(this.L)+a["min-content width"]+ri(this.L):oi(this.L)+a["min-content height"]+pi(this.L)};Bn.prototype.d=function(){return this.g?qi(this.L)+this.L.width+ri(this.L):oi(this.L)+this.L.height+pi(this.L)};function Dn(a){this.g=a}Dn.prototype.b=function(){return this.g.some(function(a){return a.b()})};Dn.prototype.e=function(){var a=this.g.map(function(a){return a.e()});return Math.max.apply(null,a)*a.length};
Dn.prototype.f=function(){var a=this.g.map(function(a){return a.f()});return Math.max.apply(null,a)*a.length};Dn.prototype.d=function(){var a=this.g.map(function(a){return a.d()});return Math.max.apply(null,a)*a.length};function En(a,b,c,d,e,f){Bn.call(this,a,b,c,d,e);this.j=f}t(En,Bn);En.prototype.b=function(){return!1};En.prototype.e=function(){return this.d()};En.prototype.f=function(){return this.d()};En.prototype.d=function(){return this.g?qi(this.L)+this.j+ri(this.L):oi(this.L)+this.j+pi(this.L)};
function An(a,b,c,d,e,f){var g=a.d.d,k={},h={},l={},n;for(n in b){var p=rn[n];if(p){var q=b[n],r=a.pa[n],v=new Bn(q,r.style,c,g,f);k[p.ga]=q;h[p.ga]=r;l[p.ga]=v}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.X.evaluate(e);var y=Fn(l,b),J=!1,W={};Object.keys(k).forEach(function(a){var b=Y(g,h[a].style[c?"max-width":"max-height"],d.X);b&&(b=b.evaluate(e),y[a]>b&&(b=l[a]=new En(k[a],h[a].style,c,g,f,b),W[a]=b.d(),J=!0))});J&&(y=Fn(l,b),J=!1,["start","center","end"].forEach(function(a){y[a]=W[a]||y[a]}));
var P={};Object.keys(k).forEach(function(a){var b=Y(g,h[a].style[c?"min-width":"min-height"],d.X);b&&(b=b.evaluate(e),y[a]<b&&(b=l[a]=new En(k[a],h[a].style,c,g,f,b),P[a]=b.d(),J=!0))});J&&(y=Fn(l,b),["start","center","end"].forEach(function(a){y[a]=P[a]||y[a]}));var F=a+b,Ea=a+(a+b);["start","center","end"].forEach(function(a){var b=y[a];if(b){var d=k[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(Ea-b)/2;break;case "end":e=F-b}c?ui(d,e,b-qi(d)-ri(d)):ti(d,e,b-oi(d)-pi(d))}})}
function Fn(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=Gn(d,g.length?new Dn(g):null,b);g.Na&&(f.center=g.Na);d=g.Na||d.d();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=Gn(c,e,b),c.Na&&(f.start=c.Na),c.Pb&&(f.end=c.Pb);return f}
function Gn(a,b,c){var d={Na:null,Pb:null};if(a&&b)if(a.b()&&b.b()){var e=a.e(),f=b.e();0<e&&0<f?(f=e+f,f<c?d.Na=c*e/f:(a=a.f(),b=b.f(),b=a+b,b<c?d.Na=a+(c-b)*(e-a)/(f-b):0<b&&(d.Na=c*a/b)),0<d.Na&&(d.Pb=c-d.Na)):0<e?d.Na=c:0<f&&(d.Pb=c)}else a.b()?d.Na=Math.max(c-b.d(),0):b.b()&&(d.Pb=Math.max(c-a.d(),0));else a?a.b()&&(d.Na=c):b&&b.b()&&(d.Pb=c);return d}xn.prototype.eb=function(a,b,c){xn.ud.eb.call(this,a,b,c);b.d.setAttribute("data-vivliostyle-page-box",!0)};
function yn(a,b){Uk.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.qb=this.rb=null}t(yn,Uk);
yn.prototype.h=function(a,b){var c=this.B,d;for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(d.match(/^column.*$/)||d.match(/^background-/))&&(c[d]=b[d]);Uk.prototype.h.call(this,a,b);d=this.e;c={rb:this.rb,qb:this.qb,marginTop:this.marginTop,marginRight:this.marginRight,marginBottom:this.marginBottom,marginLeft:this.marginLeft};d.j=c;d=d.style;d.width=new L(c.rb);d.height=new L(c.qb);d["padding-left"]=new L(c.marginLeft);d["padding-right"]=new L(c.marginRight);d["padding-top"]=new L(c.marginTop);
d["padding-bottom"]=new L(c.marginBottom)};yn.prototype.Dc=function(){var a=Hn(this,{start:"left",end:"right",X:"width"});this.rb=a.kd;this.marginLeft=a.rd;this.marginRight=a.qd};yn.prototype.Ec=function(){var a=Hn(this,{start:"top",end:"bottom",X:"height"});this.qb=a.kd;this.marginTop=a.rd;this.marginBottom=a.qd};
function Hn(a,b){var c=a.style,d=a.d.d,e=b.start,f=b.end,g=b.X,k=a.d.w[g].ea(d,null),h=Y(d,c[g],k),l=Y(d,c["margin-"+e],k),n=Y(d,c["margin-"+f],k),p=Vk(d,c["padding-"+e],k),q=Vk(d,c["padding-"+f],k),r=Xk(d,c["border-"+e+"-width"],c["border-"+e+"-style"],k),v=Xk(d,c["border-"+f+"-width"],c["border-"+f+"-style"],k),y=G(d,k,E(d,E(d,r,p),E(d,v,q)));h?(y=G(d,y,h),l||n?l?n=G(d,y,l):l=G(d,y,n):n=l=dd(d,y,new B(d,.5))):(l||(l=d.b),n||(n=d.b),h=G(d,y,E(d,l,n)));c[e]=new L(l);c[f]=new L(n);c["margin-"+e]=ne;
c["margin-"+f]=ne;c["padding-"+e]=new L(p);c["padding-"+f]=new L(q);c["border-"+e+"-width"]=new L(r);c["border-"+f+"-width"]=new L(v);c[g]=new L(h);c["max-"+g]=new L(h);return{kd:G(d,k,E(d,l,n)),rd:l,qd:n}}yn.prototype.eb=function(a,b,c){Uk.prototype.eb.call(this,a,b,c);c.u=b.d};function zn(a,b){Uk.call(this,a,b);var c=b.l;this.j=rn[c];a.pa[c]=this;this.va=!0}t(zn,Uk);m=zn.prototype;
m.eb=function(a,b,c){var d=b.d;w(d,"display","flex");var e=fl(this,a,"vertical-align"),f=null;e===I("middle")?f="center":e===I("top")?f="flex-start":e===I("bottom")&&(f="flex-end");f&&(w(d,"flex-flow",this.b?"row":"column"),w(d,"justify-content",f));Uk.prototype.eb.call(this,a,b,c)};
m.ga=function(a,b){var c=this.style,d=this.d.d,e=a.start,f=a.end,g="left"===e,k=g?b.rb:b.qb,h=Y(d,c[a.X],k),g=g?b.marginLeft:b.marginTop;if("start"===this.j.ga)c[e]=new L(g);else if(h){var l=Vk(d,c["margin-"+e],k),n=Vk(d,c["margin-"+f],k),p=Vk(d,c["padding-"+e],k),q=Vk(d,c["padding-"+f],k),r=Xk(d,c["border-"+e+"-width"],c["border-"+e+"-style"],k),f=Xk(d,c["border-"+f+"-width"],c["border-"+f+"-style"],k),h=E(d,h,E(d,E(d,p,q),E(d,E(d,r,f),E(d,l,n))));switch(this.j.ga){case "center":c[e]=new L(E(d,g,
ed(d,G(d,k,h),new B(d,2))));break;case "end":c[e]=new L(G(d,E(d,g,k),h))}}};
function In(a,b,c){function d(a){if(y)return y;y={X:v?v.evaluate(a):null,Ca:h?h.evaluate(a):null,Da:l?l.evaluate(a):null};var b=k.evaluate(a),c=0;[q,n,p,r].forEach(function(b){b&&(c+=b.evaluate(a))});(null===y.Ca||null===y.Da)&&c+y.X+y.Ca+y.Da>b&&(null===y.Ca&&(y.Ca=0),null===y.Da&&(y.ae=0));null!==y.X&&null!==y.Ca&&null!==y.Da&&(y.Da=null);null===y.X&&null!==y.Ca&&null!==y.Da?y.X=b-c-y.Ca-y.Da:null!==y.X&&null===y.Ca&&null!==y.Da?y.Ca=b-c-y.X-y.Da:null!==y.X&&null!==y.Ca&&null===y.Da?y.Da=b-c-y.X-
y.Ca:null===y.X?(y.Ca=y.Da=0,y.X=b-c):y.Ca=y.Da=(b-c-y.X)/2;return y}var e=a.style;a=a.d.d;var f=b.Fc,g=b.Jc;b=b.X;var k=G(a,c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],new B(a,2)),h=Wk(a,e["margin-"+f],k),l=Wk(a,e["margin-"+g],k),n=Vk(a,e["padding-"+f],k),p=Vk(a,e["padding-"+g],k),q=Xk(a,e["border-"+f+"-width"],e["border-"+f+"-style"],k),r=Xk(a,e["border-"+g+"-width"],e["border-"+g+"-style"],k),v=Y(a,e[b],k),y=null;e[b]=new L(new oc(a,function(){var a=d(this).X;return null===a?0:a},b));
e["margin-"+f]=new L(new oc(a,function(){var a=d(this).Ca;return null===a?0:a},"margin-"+f));e["margin-"+g]=new L(new oc(a,function(){var a=d(this).Da;return null===a?0:a},"margin-"+g));"left"===f?e.left=new L(E(a,c.marginLeft,c.rb)):"top"===f&&(e.top=new L(E(a,c.marginTop,c.qb)))}m.Dc=function(){var a=this.e.j;this.j.ra?In(this,{Fc:"right",Jc:"left",X:"width"},a):this.j.sa?In(this,{Fc:"left",Jc:"right",X:"width"},a):this.ga({start:"left",end:"right",X:"width"},a)};
m.Ec=function(){var a=this.e.j;this.j.ta?In(this,{Fc:"bottom",Jc:"top",X:"height"},a):this.j.qa?In(this,{Fc:"top",Jc:"bottom",X:"height"},a):this.ga({start:"top",end:"bottom",X:"height"},a)};m.Zb=function(a,b,c,d,e,f){Uk.prototype.Zb.call(this,a,b,c,d,e,f);a=c.l;c=this.d.l;d=this.j;d.ra||d.sa?d.ta||d.qa||(d.ra?a.left[c]=b:d.sa&&(a.right[c]=b)):d.ta?a.top[c]=b:d.qa&&(a.bottom[c]=b)};
function Jn(a,b,c,d,e){this.b=a;this.h=b;this.f=c;this.d=d;this.e=e;this.g={};a=this.h;b=new Xc(a,"page-number");b=new Pc(a,new Vc(a,b,new B(a,2)),a.b);c=new Fc(a,b);a.values["recto-page"]=c;a.values["verso-page"]=b;"ltr"===mn(this.e)?(a.values["left-page"]=b,b=new Fc(a,b),a.values["right-page"]=b):(c=new Fc(a,b),a.values["left-page"]=c,a.values["right-page"]=b)}function Kn(a){var b={};Wj(a.b,[],"",b);a.b.pop();return b}
function Ln(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof V?e.value+"":Ln(a,e);c.push(d+f+(e.Ea||""))}return c.sort().join("^")}function Mn(a){this.b=null;this.f=a}t(Mn,X);Mn.prototype.apply=function(a){a.I===this.f&&this.b.apply(a)};Mn.prototype.d=function(){return 3};Mn.prototype.e=function(a){this.b&&hj(a.Fb,this.f,this.b);return!0};function Nn(a){this.b=null;this.f=a}t(Nn,X);
Nn.prototype.apply=function(a){1===(new Xc(this.f,"page-number")).evaluate(a.d)&&this.b.apply(a)};Nn.prototype.d=function(){return 2};function On(a){this.b=null;this.f=a}t(On,X);On.prototype.apply=function(a){(new Xc(this.f,"left-page")).evaluate(a.d)&&this.b.apply(a)};On.prototype.d=function(){return 1};function Pn(a){this.b=null;this.f=a}t(Pn,X);Pn.prototype.apply=function(a){(new Xc(this.f,"right-page")).evaluate(a.d)&&this.b.apply(a)};Pn.prototype.d=function(){return 1};
function Qn(a){this.b=null;this.f=a}t(Qn,X);Qn.prototype.apply=function(a){(new Xc(this.f,"recto-page")).evaluate(a.d)&&this.b.apply(a)};Qn.prototype.d=function(){return 1};function Rn(a){this.b=null;this.f=a}t(Rn,X);Rn.prototype.apply=function(a){(new Xc(this.f,"verso-page")).evaluate(a.d)&&this.b.apply(a)};Rn.prototype.d=function(){return 1};function Sn(a,b){fj.call(this,a,b,null,null)}t(Sn,fj);
Sn.prototype.apply=function(a){var b=a.d,c=a.w,d=this.style;a=this.b;$i(b,c,d,a,null,null);if(d=d._marginBoxes){var c=Yi(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);$i(b,f,d[e],a,null,null)}}};function Tn(a,b,c,d){ek.call(this,a,b,null,c,null,d,!1);this.f=""}t(Tn,ek);m=Tn.prototype;m.ub=function(){this.f+="@page ";this.hb()};m.$a=function(a,b){this.f+=b;b&&(this.b.push(new Mn(b)),this.d+=65536)};
m.Gb=function(a,b){b&&Jf(this,"E_INVALID_PAGE_SELECTOR :"+a+"("+b.join("")+")");this.f+=":"+a;switch(a.toLowerCase()){case "first":this.b.push(new Nn(this.e));this.d+=256;break;case "left":this.b.push(new On(this.e));this.d+=1;break;case "right":this.b.push(new Pn(this.e));this.d+=1;break;case "recto":this.b.push(new Qn(this.e));this.d+=1;break;case "verso":this.b.push(new Rn(this.e));this.d+=1;break;default:Jf(this,"E_INVALID_PAGE_SELECTOR :"+a)}};m.la=function(){this.f+="{";ek.prototype.la.call(this)};
m.Ua=function(){this.f+="}";document.getElementById("vivliostyle-page-rules").textContent+=this.f;ek.prototype.Ua.call(this)};
m.Ka=function(a,b,c){if("size"===a){var d=b.ad()&&b.values[1]===Pd,e=(d?b.values[0]:b).toString().toLowerCase(),f=nn[e];f&&("a5"===e||"a4"===e||"a3"===e||"b5"===e||"b4"===e||"letter"===e||"legal"===e||"ledger"===e?d&&(e+=" landscape"):(e=f.width.stringValue(),f=f.height.stringValue(),e=d?f+" "+e:e+" "+f));this.f+="size: "+e+(c?" !important":"")+";"}ek.prototype.Ka.call(this,a,b,c)};m.nd=function(a){hj(this.h.Fb,"*",a)};m.pd=function(a){return new Sn(this.k,a)};
m.Oc=function(a){var b=Yi(this.k,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);Ff(this.Y,new Un(this.e,this.Y,this.u,c))};function Un(a,b,c,d){Gf.call(this,a,b,!1);this.d=c;this.b=d}t(Un,Hf);Un.prototype.Ka=function(a,b,c){eh(this.d,a,b,c,this)};Un.prototype.Db=function(a,b){If(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Un.prototype.mc=function(a,b){If(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};Un.prototype.gb=function(a,b,c){Xi(this.b,a,new V(b,c?Cf(this):Df(this)))};
function Vn(a){this.d=a;this.b={};this.b.page=[0]}function Wn(a,b){Object.keys(b.b).forEach(function(a){this.b[a]=Array.b(b.b[a])},a)}function Nj(a,b,c){return new oc(a.d,function(){var d=a.b[b];return c(d&&d.length?d[d.length-1]:null)},"page-counter-"+b)}function Pj(a,b,c){return new oc(a.d,function(){return c(a.b[b]||[])},"page-counters-"+b)}
function Xn(a,b,c){var d,e=b["counter-reset"];e&&(e=e.evaluate(c))&&(d=qg(e,!0));if(d)for(var f in d){var e=a,g=f,k=d[f];e.b[g]?e.b[g].push(k):e.b[g]=[k]}var h;(b=b["counter-increment"])&&(c=b.evaluate(c))&&(h=qg(c,!1));h?"page"in h||(h.page=1):h={page:1};for(var l in h)a.b[l]||(c=a,b=l,c.b[b]?c.b[b].push(0):c.b[b]=[0]),c=a.b[l],c[c.length-1]+=h[l]};function Yn(a,b,c,d,e,f,g,k,h){this.h=a;this.g=b;this.b=c;this.d=d;this.w=e;this.f=f;this.l=a.D;this.u=g;this.e=k;this.k=h;this.j=a.f;qc(this.b,function(a){return(a=this.b.b[a])?0<a.b.length&&a.b[0].b.b<=this.h:!1});pc(this.b,new oc(this.b,function(){return this.va+this.b.d},"page-number"))}
function Zn(a,b,c,d){if(a.k.length){var e=new tc(0,b,c,d);a=a.k;for(var f={},g=0;g<a.length;g++)$i(e,f,a[g],0,null,null);g=f.width;a=f.height;var f=f["text-zoom"],k=1;if(g&&a||f){var h=rc.em;(f?f.evaluate(e,"text-zoom"):null)===$d&&(k=h/d,d=h,b*=k,c*=k);if(g&&a&&(g=wd(g.evaluate(e,"width"),e),e=wd(a.evaluate(e,"height"),e),0<g&&0<e))return{width:g,height:e,fontSize:d}}}return{width:b,height:c,fontSize:d}}
function $n(a,b,c,d,e,f,g,k,h){tc.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.Z=b;this.lang=b.lang||c;this.viewport=d;this.e={body:!0};this.f=e;this.b=this.D=this.d=this.k=null;this.h=0;this.Ta=f;this.ma=new lh(this.style.l);this.pa={};this.M=null;this.j=new Vn(a.b);this.I={};this.fa=null;this.Fa=g;this.Ga=k;this.va=h;for(var l in a.e)(b=a.e[l]["flow-consume"])&&(b.evaluate(this,"flow-consume")==yd?this.e[l]=!0:delete this.e[l])}t($n,tc);
function ao(a){var b=M("StyleInstance.init");a.d=new vk(a.Z,a.style.d,a.style.g,a,a.e,a.style.j,a.j);var c=a.d;c.k=a;for(var d=0;d<c.B.length;d++)Dk(c.k,c.B[d]);a.D={};c=a.D[a.Z.url]=a.d;for(d=0;!c.j&&(d+=5E3,Ek(c,d,0)!=Number.POSITIVE_INFINITY););c=c.u;a.fa=mn(c);a.k=new ul(a.style.w);d=new Tj(a.style.d,a,a.j);a.k.h(d,c);tl(a.k,a);a.M=new Jn(d,a.style.b,a.k,a,c);c=[];for(d=0;d<a.style.f.length;d++){var e=a.style.f[d];if(!e.J||e.J.evaluate(a)){var f=e.lb,g=a,e={},k=void 0;for(k in f)e[k]=f[k].evaluate(g,
k);f=e;g=void 0;for(g in gh)f[g]||(f[g]=gh[g]);e=new jh(e);c.push(e)}}d=a.Ta;a=a.ma;e=[];for(f=0;f<c.length;f++)g=c[f],g.src&&g.b?e.push(ph(d,g,a)):u.b("E_FONT_FACE_INVALID");sg(e).oa(b);return O(b)}function Dk(a,b){var c=a.b;if(c){var d=c.b[b.f];d||(d=new li,c.b[b.f]=d);d.b.push(new ki(new ji({ha:[{da:b.g,La:0,ba:null,ua:null,na:null}],aa:0,K:!1}),b))}}
function bo(a,b){if(!b)return 0;var c=Number.POSITIVE_INFINITY,d;for(d in a.e){var e=b.b[d];if((!e||0==e.b.length)&&a.b){var f=a.d;f.l=d;for(e=0;null!=f.l&&(e+=5E3,Ek(f,e,0)!=Number.POSITIVE_INFINITY););e=a.b.b[d];b!=a.b&&e&&(e=e.clone(),b.b[d]=e)}if(e){for(var f=a,g=Number.POSITIVE_INFINITY,k=0;k<e.b.length;k++){for(var h=e.b[k].d.Qa,l=h.ha[0].da,n=h.aa,p=h.K,q=0;l.ownerDocument!=f.Z.b;)q++,l=h.ha[q].da,p=!1,n=0;h=vh(f.Z,l,n,p);h<g&&(g=h)}f=g;f<c&&(c=f)}}return c}
function co(a,b){var c=bo(a,a.b);if(c==Number.POSITIVE_INFINITY)return null;for(var d=a.k.children,e,f=0;f<d.length;f++)if(e=d[f],"vivliostyle-page-rule-master"!==e.d.fb){var g=1,k=fl(e,a,"utilization");k&&k.$c()&&(g=k.C);k=vc(a,"em",!1);a.h=Ek(a.d,c,Math.ceil(g*a.u()*a.l()/(k*k)));var g=a,k=g.b.d,h=void 0;for(h in g.b.b)for(var l=g.b.b[h],n=l.b.length-1;0<=n;n--){var p=l.b[n];0>p.b.e&&p.b.b<g.h&&(p.b.e=k)}uc(a,a.style.b);g=fl(e,a,"enabled");if(!g||g===je){d=a;u.debug("Location - page",d.b.d);u.debug("  current:",
c);u.debug("  lookup:",d.h);c=void 0;for(c in d.b.b)for(f=d.b.b[c],g=0;g<f.b.length;g++)u.debug("  Chunk",c+":",f.b[g].b.b);c=a.M;f=b;g=e.d;if(0===Object.keys(f).length)g.d.e=g;else{e=g;d=Ln(c,f);e=e.g+"^"+d;d=c.g[e];if(!d){if("background-host"===g.fb)d=c,f=(new tn(d.h,d.f.d,f)).f(d.f),f.h(d.b,d.e),tl(f,d.d),d=f;else{d=c;k=f;f=g.clone({fb:"vivliostyle-page-rule-master"});if(g=k.size)k=pn(k),g=g.Ea,f.b.width=Ui(d.d,f.b.width,new V(k.width,g)),f.b.height=Ui(d.d,f.b.height,new V(k.height,g));f=f.f(d.f);
f.h(d.b,d.e);tl(f,d.d);d=f}c.g[e]=d}e=d.d;e.d.e=e;e=d}return e}}throw Error("No enabled page masters");}
function eo(a,b,c){var d=a.b.b[c];if(!d)return N(!0);Gm(b);a.e[c]&&0<b.Qb.length&&(b.hd=!1);var e=M("layoutColumn"),f=[];pf(function(c){for(;0<d.b.length;){var e=0,h=d.b[e];if(h.b.b>a.h)break;for(var l=1;l<d.b.length;l++){var n=d.b[l];if(n.b.b>a.h)break;Zh(n.b,h.b)&&(h=n,e=l)}var p=h.b,q=!0;Jm(b,h.d).then(function(a){h.b.Id&&(null===a||p.d)&&f.push(h);p.d?(d.b.splice(e,1),R(c)):a?(h.d=a,R(c)):(d.b.splice(e,1),q?q=!1:rf(c))});if(q){q=!1;return}}R(c)}).then(function(){0<f.length&&(d.b=f.concat(d.b));
Q(e,!0)});return O(e)}
function fo(a,b,c,d,e,f,g,k){var h=fl(c,a,"enabled");if(h&&h!==je)return N(!0);var l=M("layoutContainer"),n=fl(c,a,"wrap-flow")===Ad,p=c.b?c.g&&c.D:c.f&&c.I,h=fl(c,a,"flow-from"),q=a.viewport.b.createElement("div"),r=fl(c,a,"position");w(q,"position",r?r.name:"absolute");d.insertBefore(q,d.firstChild);var v=new ni(q);v.b=c.b;c.eb(a,v,b);v.A=e;v.B=f;e+=v.left+v.marginLeft+v.$;f+=v.top+v.marginTop+v.fa;if(h&&h.od())if(a.I[h.toString()])c.Zb(a,v,b,null,1,a.f),h=N(!0);else{var y=M("layoutContainer.inner"),
J=h.toString(),W=Z(c,a,"column-count"),P=Z(c,a,"column-gap"),F=1<W?Z(c,a,"column-width"):v.width,h=el(c,a),Ea=0,r=fl(c,a,"shape-inside"),ob=og(r,0,0,v.width,v.height,a),Ik=new Il(J,a,a.viewport,a.d,h,a.Z,a.ma,a.style.u,a,b,a.Fa,a.Ga,k),sh=0,aa=null;pf(function(b){for(;sh<W;){var c=sh++;if(1<W){var d=a.viewport.b.createElement("div");w(d,"position","absolute");q.appendChild(d);aa=new nm(d,Ik,a.f);aa.b=v.b;aa.Ga=v.Ga;aa.Ub=v.Ub;v.b?(w(d,"margin-left",v.j+"px"),w(d,"margin-right",v.D+"px"),c=c*(F+P)+
v.k,ui(aa,0,v.width),ti(aa,c,F)):(w(d,"margin-top",v.k+"px"),w(d,"margin-bottom",v.w+"px"),c=c*(F+P)+v.j,ti(aa,0,v.height),ui(aa,c,F));aa.A=e+v.j;aa.B=f+v.k}else aa=new nm(q,Ik,a.f),si(aa,v),v=aa;aa.I=p?[]:g;aa.Sb=ob;if(0<=aa.width){var h=M("inner");eo(a,aa,J).then(function(){aa.M&&"column"!=aa.M&&(sh=W,"region"!=aa.M&&(a.I[J]=!0));Q(h,!0)});c=O(h)}else c=N(!0);if(c.ya()){c.then(function(){0<k.b.length?R(b):(Ea=Math.max(Ea,aa.e),rf(b))});return}0<k.b.length||(Ea=Math.max(Ea,aa.e))}R(b)}).then(function(){v.e=
Ea;c.Zb(a,v,b,aa,W,a.f);Q(y,!0)});h=O(y)}else{h=fl(c,a,"content");r=!1;if(h&&wi(h)){var Jk=a.viewport.b.createElement("span");h.R(new vi(Jk,a));q.appendChild(Jk);sl(c,a,v)}else c.va&&(d.removeChild(q),r=!0);r||c.Zb(a,v,b,null,1,a.f);h=N(!0)}h.then(function(){if(!c.f||0<Math.floor(v.e)){if(!n){var h=v.A+v.left,p=v.B+v.top,r=qi(v)+v.width+ri(v),y=oi(v)+v.height+pi(v),F=fl(c,a,"shape-outside"),h=og(F,h,p,r,y,a);hb(a.viewport.root)&&g.push(ye(h,0,-1.25*vc(a,"em",!1)));g.push(h)}}else if(0==c.children.length){d.removeChild(q);
Q(l,!0);return}var J=c.children.length-1;of(function(){for(;0<=J;){var d=c.children[J--],d=fo(a,b,d,q,e,f,g,k);if(d.ya())return d}return N(!1)}).then(function(){Q(l,!0)})});return O(l)}
function go(a,b,c){a.I={};c?(a.b=c.clone(),yk(a.d,c.e)):(a.b=new mi,yk(a.d,-1));a.lang&&b.L.setAttribute("lang",a.lang);c=a.b;c.d++;uc(a,a.style.b);var d=Kn(a.M);ho(a,d);var e=co(a,d);if(!e)return N(null);e.d.b.width.value===le&&Uh(b);e.d.b.height.value===me&&Vh(b);Xn(a.j,d,a);var d=fl(e,a,"writing-mode")||Kd,f=fl(e,a,"direction")||Sd,g=new zi(b.w.bind(b),d,f),k=c.clone(),h=[],l=M("layoutNextPage");pf(function(d){fo(a,b,e,b.L,0,0,h.concat(),g).then(function(){if(0<g.b.length){h=h.concat(Ei(g));g.b.splice(0,
g.b.length);c=a.b=k.clone();for(var e;e=b.L.lastChild;)b.L.removeChild(e);rf(d)}else R(d)})}).then(function(){e.$(a,b,a.f);var d=new Xc(e.d.d,"left-page");b.f=d.evaluate(a)?"left":"right";var d=a.b.d,f;for(f in a.b.b)for(var g=a.b.b[f],h=g.b.length-1;0<=h;h--){var k=g.b[h];0<=k.b.e&&k.b.e+k.b.j-1<=d&&g.b.splice(h,1)}a.b=null;c.e=a.d.b;f=a.style.h.B[a.Z.url];d=b.L.firstElementChild.getBoundingClientRect();b.b.width=d.width;b.b.height=d.height;g=b.g;for(d=0;d<g.length;d++)h=g[d],w(h.target,h.name,h.value.toString());
for(d=0;d<f.length;d++)if(g=f[d],k=b.h[g.Ib],h=b.h[g.Fd],k&&h&&(k=Sh(k,g.action)))for(var y=0;y<h.length;y++)h[y].addEventListener(g.event,k,!1);var J;a:{for(J in a.e)if((f=c.b[J])&&0<f.b.length){J=!1;break a}J=!0}J&&(c=null);Q(l,c)});return O(l)}function ho(a,b){var c=pn(b),d=c.width;d===le?a.A=null:a.A=d.C*vc(a,d.ia,!1);c=c.height;c===me?a.w=null:a.w=c.C*vc(a,c.ia,!1)}function io(a,b,c,d){ek.call(this,a.g,a,b,c,d,a.f,!c);this.f=a;this.A=!1}t(io,ek);m=io.prototype;m.ic=function(){};
m.hc=function(a,b,c){a=new Pk(this.f.j,a,b,c,this.f.u,this.J,Df(this.Y));Ff(this.f,new zl(a.d,this.f,a,this.u))};m.mb=function(a){a=a.d;null!=this.J&&(a=cd(this.e,this.J,a));Ff(this.f,new io(this.f,a,this,this.B))};m.ec=function(){Ff(this.f,new hk(this.e,this.Y))};m.gc=function(){var a={};this.f.k.push({lb:a,J:this.J});Ff(this.f,new ik(this.e,this.Y,null,a,this.f.f))};m.fc=function(a){var b=this.f.h[a];b||(b={},this.f.h[a]=b);Ff(this.f,new ik(this.e,this.Y,null,b,this.f.f))};
m.kc=function(){var a={};this.f.w.push(a);Ff(this.f,new ik(this.e,this.Y,this.J,a,this.f.f))};m.Jb=function(a){var b=this.f.l;if(a){var c=Yi(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Ff(this.f,new ik(this.e,this.Y,null,b,this.f.f))};m.jc=function(){this.A=!0;this.hb()};m.ub=function(){var a=new Tn(this.f.j,this.f,this,this.u);Ff(this.f,a);a.ub()};
m.la=function(){ek.prototype.la.call(this);if(this.A){this.A=!1;var a="R"+this.f.B++,b=I(a),c;this.J?c=new Ti(b,0,this.J):c=new V(b,0);Zi(this.k,"region-id").push(c);this.Ua();a=new io(this.f,this.J,this,a);Ff(this.f,a);a.la()}};
function jo(a){var b=a.getAttribute("content");if(!b)return"";a={};for(var c;null!=(c=b.match(/^,?\s*([-A-Za-z_.][-A-Za-z_0-9.]*)\s*=\s*([-+A-Za-z_0-9.]*)\s*/));)b=b.substr(c[0].length),a[c[1]]=c[2];b=a.width-0;a=a.height-0;return b&&a?"@-epubx-viewport{width:"+b+"px;height:"+a+"px;}":""}function ko(a){Ef.call(this);this.f=a;this.g=new mc(null);this.j=new mc(this.g);this.u=new Mk(this.g);this.A=new io(this,null,null,null);this.B=0;this.k=[];this.l={};this.h={};this.w=[];this.b=this.A}t(ko,Ef);
ko.prototype.error=function(a){u.b("CSS parser:",a)};function lo(a,b){return mo(b,a)}function no(a){vf.call(this,lo,"document");this.D=a;this.A={};this.h={};this.b={};this.B={};this.f=null;this.j=[]}t(no,vf);function oo(a){var b=ta("user-agent.xml",sa),c=M("OPSDocStore.init");wf(fh).then(function(d){a.f=d;wf(kk).then(function(){a.load(b).then(function(){Q(c,!0)})})});return O(c)}function po(a,b){a.j.push({url:b.url,text:b.text,Va:"User",xa:null,media:null})}
function mo(a,b){var c=M("OPSDocStore.load"),d=b.url;Dh(b,a).then(function(b){if(b){for(var f=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),k=0;k<g.length;k++){var h=g[k],l=h.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),n=h.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=h.getAttribute("action"),h=h.getAttribute("ref");l&&n&&p&&h&&f.push({Fd:l,event:n,action:p,Ib:h})}a.B[d]=f;var q=[],f=ta("user-agent-page.css",sa);q.push({url:f,text:null,
...
l&&"viewport"==g.getAttribute("name")&&q.push({url:d,text:jo(g),Va:"Author",J:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==k?"stylesheet"==l&&"text/css"==g.getAttribute("type")&&q.push({url:d,text:g.textContent,Va:"Author",xa:null,media:null}):"http://example.com/sse"==k&&"property"===l&&(k=g.getElementsByTagName("name")[0])&&"stylesheet"===k.textContent&&(g=g.getElementsByTagName("value")[0])&&(g=ta(g.textContent,d),q.push({url:g,text:null,xa:null,media:null,Va:"Author"}));
for(var r="",k=0;k<q.length;k++)r+=q[k].url,r+="^",q[k].text&&(r+=q[k].text),r+="^";var v=a.A[r];v?(a.b[d]=v,Q(c,b)):(f=a.h[r],f||(f=new yf(function(){var b=M("fetchStylesheet"),c=0,d=new ko(a.f);of(function(){if(c<q.length){var a=q[c++];d.vb(a.Va);return null!==a.text?gg(a.text,d,a.url,a.xa,a.media).Pc(!0):fg(a.url,d,a.xa,a.media)}return N(!1)}).then(function(){v=new Yn(a,d.g,d.j,d.A.h,d.u,d.k,d.l,d.h,d.w);a.A[r]=v;delete a.h[r];Q(b,v)});return O(b)},"FetchStylesheet "+d),a.h[r]=f,f.start()),wf(f).then(function(f){a.b[d]=
f;Q(c,b)}))}else Q(c,null)});return O(c)};function qo(a,b,c,d,e,f,g,k){this.d=a;this.url=b;this.lang=c;this.e=d;this.g=e;this.Q=ec(f);this.h=g;this.f=k;this.Ia=this.b=null}function ro(a,b,c){if(0!=c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=Pa(d,"height","auto")&&(w(d,"height","auto"),ro(a,d,c));"absolute"==Pa(d,"position","static")&&(w(d,"position","relative"),ro(a,d,c))}}
function so(a){var b=a.target,c="\u25b8"==b.textContent;b.textContent=c?"\u25be":"\u25b8";for(b=b.parentNode.firstChild;b;)if(1!=b.nodeType)b=b.nextSibling;else{var d=b;"toc-container"==d.getAttribute("data-adapt-class")?b=d.firstChild:("toc-node"==d.getAttribute("data-adapt-class")&&(d.style.height=c?"auto":"0px"),b=b.nextSibling)}a.stopPropagation()}
qo.prototype.Gc=function(a){var b=this.h.Gc(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",w(e,"cursor","pointer"),e.addEventListener("click",so,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
qo.prototype.dc=function(a,b,c,d,e){if(this.b)return N(this.b);var f=this,g=M("showTOC"),k=new Th(a);this.b=k;this.d.load(this.url).then(function(d){var l=f.d.b[d.url],n=Zn(l,c,1E5,e);b=new cm(b.f,n.fontSize,b.root,n.width,n.height);var p=new $n(l,d,f.lang,b,f.e,f.g,f.Gc(d),f.f,0);f.Ia=p;p.Q=f.Q;ao(p).then(function(){go(p,k,null).then(function(){ro(f,a,2);Q(g,k)})})});return O(g)};
qo.prototype.$b=function(){if(this.b){var a=this.b;this.Ia=this.b=null;w(a.L,"visibility","none");var b=a.L.parentNode;b&&b.removeChild(a.L)}};qo.prototype.bd=function(){return!!this.b};function to(){no.call(this,uo(this));this.d=new vf(Dh,"document");this.u=new vf(zf,"text");this.w={};this.M={};this.k={};this.l={}}t(to,no);function uo(a){return function(b){return a.k[b]}}
function vo(a,b,c){var d=M("loadEPUBDoc");"/"!==b.substring(b.length-1)&&(b+="/");c&&a.u.Yb(b+"?r=list");a.d.Yb(b+"META-INF/encryption.xml");var e=b+"META-INF/container.xml";a.d.load(e,!0,"Failed to fetch EPUB container.xml from "+e).then(function(f){if(f){f=Oh(rh(rh(rh(new th([f.b]),"container"),"rootfiles"),"rootfile"),"full-path");for(var g=0;g<f.length;g++){var k=f[g];if(k){wo(a,b,k,c).oa(d);return}}Q(d,null)}else u.error("Received an empty response for EPUB container.xml "+e+". This may be caused by the server not allowing cross origin requests.")});
return O(d)}function wo(a,b,c,d){var e=b+c,f=a.w[e];if(f)return N(f);var g=M("loadOPF");a.d.load(e,void 0,void 0).then(function(c){c?a.d.load(b+"META-INF/encryption.xml",void 0,void 0).then(function(h){(d?a.u.load(b+"?r=list"):N(null)).then(function(d){f=new xo(a,b);yo(f,c,h,d,b+"?r=manifest").then(function(){a.w[e]=f;a.M[b]=f;Q(g,f)})})}):u.error("Received an empty response for EPUB OPF "+e+". This may be caused by the server not allowing cross origin requests.")});return O(g)}
to.prototype.load=function(a){var b=ra(a);if(a=this.l[b])return a.ya()?a:N(a.Wb());var c=M("EPUBDocStore.load");a=to.ud.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?Q(c,a):u.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return O(c)};function zo(){this.id=null;this.src="";this.g=this.d=null;this.F=-1;this.h=0;this.j=null;this.b=this.e=0;this.f=ab}function Ao(a){return a.id}
function Bo(a){var b=Re(a);return function(a){var d=M("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));uf(e).then(function(a){a=new DataView(a);for(var c=0;c<a.byteLength;c++){var e=a.getUint8(c),e=e^b[c%20];a.setUint8(c,e)}Q(d,tf([a,f]))});return O(d)}}
var Co={dcterms:"http://purl.org/dc/terms/",marc:"http://id.loc.gov/vocabulary/",media:"http://www.idpf.org/epub/vocab/overlays/#",onix:"http://www.editeur.org/ONIX/book/codelists/current.html#",xsd:"http://www.w3.org/2001/XMLSchema#"},Do=Co.dcterms+"language",Eo=Co.dcterms+"title";
function Fo(a,b){var c={};return function(d,e){var f,g,k=d.r||c,h=e.r||c;if(a==Eo&&(f="main"==k["http://idpf.org/epub/vocab/package/#title-type"],g="main"==h["http://idpf.org/epub/vocab/package/#title-type"],f!=g))return f?-1:1;f=parseInt(k["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(f)&&(f=Number.MAX_VALUE);g=parseInt(h["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(g)&&(g=Number.MAX_VALUE);return f!=g?f-g:a!=Do&&b&&(f=(k[Do]||k["http://idpf.org/epub/vocab/package/#alternate-script"])==
b,g=(h[Do]||h["http://idpf.org/epub/vocab/package/#alternate-script"])==b,f!=g)?f?-1:1:d.o-e.o}}
function Go(a,b){function c(a){for(var b in a){var d=a[b];d.sort(Fo(b,l));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return db(a,function(a){return cb(a,function(a){var b={v:a.value,o:a.N};a.be&&(b.s=a.scheme);if(a.id||a.lang){var c=h[a.id];if(c||a.lang)a.lang&&(a={name:Do,value:a.lang,lang:null,id:null,Mc:a.id,scheme:null,N:a.N},c?c.push(a):c=[a]),c=bb(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in Co)f[g]=Co[g];for(;null!=(g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/));)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=Co;var k=1;g=Mh(Nh(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),N:k++,Mc:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:Co.dcterms+a.localName,N:k++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Mc:null,scheme:null};return null});var h=bb(g,function(a){return a.Mc});g=d(bb(g,function(a){return a.Mc?null:a.name}));var l=null;g[Do]&&(l=g[Do][0].v);c(g);return g}function Ho(){var a=window.MathJax;return a?a.Hub:null}var Io={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function xo(a,b){this.e=a;this.g=this.d=this.b=this.h=this.f=null;this.k=b;this.j=null;this.D={};this.lang=null;this.u=0;this.l={};this.I=this.B=this.M=null;this.w={};this.A=null;Ho()&&(Ji["http://www.w3.org/1998/Math/MathML"]=!0)}function Jo(a,b){return a.k?b.substr(0,a.k.length)==a.k?decodeURI(b.substr(a.k.length)):null:b}
function yo(a,b,c,d,e){a.f=b;var f=rh(new th([b.b]),"package"),g=Oh(f,"unique-identifier")[0];g&&(g=zh(b,b.url+"#"+g))&&(a.j=g.textContent.replace(/[ \n\r\t]/g,""));var k={};a.h=cb(Jh(rh(rh(f,"manifest"),"item")),function(c){var d=new zo,e=b.url;d.id=c.getAttribute("id");d.src=ta(c.getAttribute("href"),e);d.d=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.f=f}(c=c.getAttribute("fallback"))&&!Io[d.d]&&(k[d.src]=c);!a.B&&
d.f.nav&&(a.B=d);!a.I&&d.f["cover-image"]&&(a.I=d);return d});a.d=$a(a.h,Ao);a.g=$a(a.h,function(b){return Jo(a,b.src)});for(var h in k)for(g=h;;){g=a.d[k[g]];if(!g)break;if(Io[g.d]){a.w[h]=g.src;break}g=g.src}a.b=cb(Jh(rh(rh(f,"spine"),"itemref")),function(b,c){var d=b.getAttribute("idref");if(d=a.d[d])d.g=b,d.F=c;return d});if(h=Oh(rh(f,"spine"),"toc")[0])a.M=a.d[h];if(h=Oh(rh(f,"spine"),"page-progression-direction")[0]){a:switch(h){case "ltr":h="ltr";break a;case "rtl":h="rtl";break a;default:throw Error("unknown PageProgression: "+
h);}a.A=h}var g=c?Oh(rh(rh(Ih(rh(rh(new th([c.b]),"encryption"),"EncryptedData"),Hh()),"CipherData"),"CipherReference"),"URI"):[],l=Jh(rh(rh(f,"bindings"),"mediaType"));for(c=0;c<l.length;c++){var n=l[c].getAttribute("handler");(h=l[c].getAttribute("media-type"))&&n&&a.d[n]&&(a.D[h]=a.d[n].src)}a.l=Go(rh(f,"metadata"),Oh(f,"prefix")[0]);a.l[Do]&&(a.lang=a.l[Do][0].v);if(!d){if(0<g.length&&a.j)for(d=Bo(a.j),c=0;c<g.length;c++)a.e.k[a.k+g[c]]=d;return N(!0)}f=new Qa;l={};if(0<g.length&&a.j)for(h="1040:"+
Se(a.j),c=0;c<g.length;c++)l[g[c]]=h;for(c=0;c<d.length;c++){var p=d[c];if(n=p.n){var q=decodeURI(n),g=a.g[q];h=null;g&&(g.j=0!=p.m,g.h=p.c,g.d&&(h=g.d.replace(/\s+/g,"")));g=l[q];if(h||g)f.append(n),f.append(" "),f.append(h||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}Ko(a);return sf(e,"","POST",f.toString(),"text/plain")}function Ko(a){for(var b=0,c=0;c<a.b.length;c++){var d=a.b[c],e=Math.ceil(d.h/1024);d.e=b;d.b=e;b+=e}a.u=b}
function Lo(a,b,c){var d=new zo;d.F=0;d.id="item1";d.src=b;a.d={item1:d};a.g={};a.g[b]=d;a.h=[d];a.b=a.h;c?(a=a.e,d=M("EPUBDocStore.load"),b=ra(b),(a.l[b]=mo(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,cc:null})).oa(d),c=O(d)):c=N(null);return c}function Mo(a,b,c){var d=a.b[b],e=M("getCFI");a.e.load(d.src).then(function(a){var b=xh(a,c),k=null;b&&(a=vh(a,b,0,!1),k=new sb,vb(k,b,c-a),d.g&&vb(k,d.g,0),k=k.toString());Q(e,k)});return O(e)}
function No(a,b){return Ye("resolveFragment",function(c){if(b){var d=new sb;tb(d,b);var e;if(a.f){var f=ub(d,a.f.b);if(1!=f.da.nodeType||f.K||!f.Ib){Q(c,null);return}var g=f.da,k=g.getAttribute("idref");if("itemref"!=g.localName||!k||!a.d[k]){Q(c,null);return}e=a.d[k];d=f.Ib}else e=a.b[0];a.e.load(e.src).then(function(a){var b=ub(d,a.b);a=vh(a,b.da,b.offset,b.K);Q(c,{F:e.F,ka:a,O:-1})})}else Q(c,null)},function(a,d){u.b(d,"Cannot resolve fragment:",b);Q(a,null)})}
function Oo(a,b){return Ye("resolveEPage",function(c){if(0>=b)Q(c,{F:0,ka:0,O:-1});else{var d=Ya(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.e.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=wh(a),g=Math.round(a*b/e.b),g==a&&g--);Q(c,{F:d,ka:g,O:-1})})}},function(a,d){u.b(d,"Cannot resolve epage:",b);Q(a,null)})}
function Po(a,b){var c=a.b[b.F];if(0>=b.ka)return N(c.e);var d=M("getEPage");a.e.load(c.src).then(function(a){a=wh(a);var f=Math.min(a,b.ka);Q(d,c.e+f*c.b/a)});return O(d)}function Qo(a,b,c,d){this.b=a;this.viewport=b;this.f=c;this.tb=[];this.ka=this.O=this.F=0;this.Q=ec(d);this.e=new am(b.f)}function Ro(a){var b=a.tb[a.F];return b?b.Za[a.O]:null}m=Qo.prototype;m.cb=function(){if(this.b.A)return this.b.A;var a=this.tb[this.F];return a?a.Ia.fa:null};
function So(a){var b=M("renderPage");To(a).then(function(c){if(c){var d=-1;if(0>a.O){var d=a.ka,e=Ya(c.Ja.length,function(a){return bo(c.Ia,c.Ja[a])>d});a.O=e==c.Ja.length?Number.POSITIVE_INFINITY:e-1}var f=c.Za[a.O];f?(a.ka=f.offset,Q(b,f)):pf(function(b){if(a.O<c.Ja.length)R(b);else if(c.complete)a.O=c.Ja.length-1,R(b);else{var e=c.Ja[c.Ja.length-1],h=Uo(a,c,e);go(c.Ia,h,e).then(function(l){h.L.style.display="none";h.L.style.visibility="visible";h.L.setAttribute("data-vivliostyle-page-side",h.f);
(e=l)?(c.Za[e.d-1]=h,c.Ja.push(e),0<=d&&bo(c.Ia,e)>d?(f=h,a.O=c.Ja.length-2,R(b)):(h.j=0==c.item.F&&0==e.d-1,rf(b))):(c.Za.push(h),f=h,a.O=c.Ja.length-1,0>d&&(a.ka=h.offset),c.complete=!0,h.j=0==c.item.F&&0==a.O,h.k=c.item.F==a.b.b.length-1,R(b))})}}).then(function(){if(f=f||c.Za[a.O])Q(b,f);else{var e=c.Ja[a.O];0>d&&(a.ka=bo(c.Ia,e));var k=Uo(a,c,e);go(c.Ia,k,e).then(function(d){k.L.style.display="none";k.L.style.visibility="visible";k.L.setAttribute("data-vivliostyle-page-side",k.f);(e=d)?(c.Za[e.d-
1]=k,c.Ja[a.O+1]=e):(c.Za.push(k),c.complete=!0,k.k=c.item.F==a.b.b.length-1);k.j=0==c.item.F&&0==a.O;Q(b,k)})}})}else Q(b,null)});return O(b)}m.Nc=function(){return Vo(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};function Vo(a,b,c){var d=M("renderAllPages"),e=a.F,f=a.O;a.F=0;pf(function(d){a.O=a.F==b?c:Number.POSITIVE_INFINITY;So(a).then(function(){++a.F>b?R(d):rf(d)})}).then(function(){a.F=e;a.O=f;So(a).oa(d)});return O(d)}m.yd=function(){this.O=this.F=0;return So(this)};
m.zd=function(){this.F=this.b.b.length-1;this.O=Number.POSITIVE_INFINITY;return So(this)};m.nextPage=function(){var a=this,b=M("nextPage");To(a).then(function(c){if(c){if(c.complete&&a.O==c.Ja.length-1){if(a.F>=a.b.b.length-1){Q(b,null);return}a.F++;a.O=0}else a.O++;So(a).oa(b)}else Q(b,null)});return O(b)};m.Lc=function(){if(0==this.O){if(0==this.F)return N(null);this.F--;this.O=Number.POSITIVE_INFINITY}else this.O--;return So(this)};
function Wo(a,b){var c="left"===b.f,d="ltr"===a.cb();return!c&&d||c&&!d}function Xo(a){var b=M("getCurrentSpread"),c=Ro(a);if(!c)return N({left:null,right:null});var d=a.F,e=a.O,f="left"===c.f;(Wo(a,c)?a.Lc():a.nextPage()).then(function(g){a.F=d;a.O=e;So(a).then(function(){f?Q(b,{left:c,right:g}):Q(b,{left:g,right:c})})});return O(b)}m.Ed=function(){var a=Ro(this);if(!a)return N(null);var a=Wo(this,a),b=this.nextPage();if(a)return b;var c=this;return b.lc(function(){return c.nextPage()})};
m.Hd=function(){var a=Ro(this);if(!a)return N(null);var a=Wo(this,a),b=this.Lc();if(a){var c=this;return b.lc(function(){return c.Lc()})}return b};function Yo(a,b){var c=M("navigateToEPage");Oo(a.b,b).then(function(b){b&&(a.F=b.F,a.O=b.O,a.ka=b.ka);So(a).oa(c)});return O(c)}function Zo(a,b){var c=M("navigateToCFI");No(a.b,b).then(function(b){b&&(a.F=b.F,a.O=b.O,a.ka=b.ka);So(a).oa(c)});return O(c)}
function $o(a,b){u.debug("Navigate to",b);var c=Jo(a.b,ra(b));if(null==c&&(a.b.f&&b.match(/^#epubcfi\(/)&&(c=Jo(a.b,a.b.f.url)),null==c))return N(null);var d=a.b.g[c];if(!d)return a.b.f&&c==Jo(a.b,a.b.f.url)&&(c=b.indexOf("#"),0<=c)?Zo(a,b.substr(c+1)):N(null);d.F!=a.F&&(a.F=d.F,a.O=0);var e=M("navigateTo");To(a).then(function(c){var d=zh(c.Z,b);d&&(a.ka=uh(c.Z,d),a.O=-1);So(a).oa(e)});return O(e)}
function Uo(a,b,c){var d=b.Ia.viewport,e=d.b.createElement("div");d.d.appendChild(e);e.style.position="relative";ja||(e.style.visibility="hidden");e.style.left="0px";e.style.top="0px";var f=new Th(e);f.F=b.item.F;f.position=c;f.offset=bo(b.Ia,c);d!==a.viewport&&(a=hc(a.viewport.width,a.viewport.height,d.width,d.height),a=hg(null,new bc(a,null)),f.g.push(new Qh(e,"transform",a)));return f}
function ap(a,b){var c=Ho();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=M("navigateToEPage"),f=hf(c);d.Push(function(){f.Ra(e)});return O(c)}return N(null)}
m.Gc=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=ta(f,a.url),g=c.getAttribute("media-type");if(!g){var k=Jo(b.b,f);k&&(k=b.b.g[k])&&(g=k.d)}if(g&&(k=b.b.D[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Ua(f),h=Ua(g),g=new Qa;g.append(k);g.append("?src=");g.append(f);g.append("&type=");g.append(h);for(k=c.firstChild;k;k=k.nextSibling)1==k.nodeType&&
...
function To(a){if(a.F>=a.b.b.length)return N(null);var b=a.tb[a.F];if(b)return N(b);var c=a.b.b[a.F],d=a.b.e,e=M("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(wh(f)/2700),a.b.u=c.b);var g=d.b[f.url],k=a.Gc(f),h=a.viewport,l=Zn(g,h.width,h.height,h.fontSize);if(l.width!=h.width||l.height!=h.height||l.fontSize!=h.fontSize)h=new cm(h.f,l.fontSize,h.root,l.width,l.height);var l=a.tb[a.F-1],n=new $n(g,f,a.b.lang,h,a.e,a.f,k,a.b.w,l?l.Ia.va+l.Za.length:0);l&&
Wn(n.j,l.Ia.j);n.Q=a.Q;ao(n).then(function(){b={item:c,Z:f,Ia:n,Ja:[null],Za:[],complete:!1};a.tb[a.F]=b;Q(e,b)})});return O(e)}function bp(a){return{F:a.F,O:a.O,ka:a.ka}}function cp(a,b){b?(a.F=b.F,a.O=-1,a.ka=b.ka):(a.F=0,a.O=0,a.ka=0);return Vo(a,a.F,a.O)}
m.dc=function(){var a=this.b,b=a.B||a.M;if(!b)return N(null);var c=M("showTOC");this.d||(this.d=new qo(a.e,b.src,a.lang,this.e,this.f,this.Q,this,a.w));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";e.style.border=
"1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.d.dc(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";Q(c,a)});return O(c)};m.$b=function(){this.d&&this.d.$b()};m.bd=function(){return this.d&&this.d.bd()};function dp(a,b,c,d){var e=this;this.h=a;this.ab=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Ga=c;this.Fa=d;this.fa=new mh(a.document.head,b);this.w="";this.g=null;this.D=this.d=!1;this.f=this.j=this.e=this.l=null;this.fontSize=16;this.zoom=1;this.M=!1;this.Nc=!0;this.Q=dc();this.B=function(){};this.k=function(){};this.I=function(){e.d=!0;e.B()};this.u=function(){};this.$={loadEPUB:this.ma,loadXML:this.pa,configure:this.A,
moveTo:this.va,toc:this.dc};ep(this)}function ep(a){qa(1,function(a){fp(this,{t:"debug",content:a})}.bind(a));qa(2,function(a){fp(this,{t:"info",content:a})}.bind(a));qa(3,function(a){fp(this,{t:"warn",content:a})}.bind(a));qa(4,function(a){fp(this,{t:"error",content:a})}.bind(a))}function fp(a,b){b.i=a.Ga;a.Fa(b)}
dp.prototype.ma=function(a){jn.b("loadEPUB");jn.b("loadFirstPage");this.ab.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet;this.viewport=null;var f=M("loadEPUB"),g=this;g.A(a).then(function(){var a=new to;if(e)for(var h=0;h<e.length;h++)po(a,e[h]);oo(a).then(function(){var e=ta(b,g.h.location.href);g.w=e;vo(a,e,d).then(function(a){g.g=a;No(g.g,c).then(function(a){g.f=a;gp(g).then(function(){g.ab.setAttribute("data-vivliostyle-viewer-status",
"complete");jn.d("loadEPUB");fp(g,{t:"loaded",metadata:g.g.l});Q(f,!0)})})})})});return O(f)};
dp.prototype.pa=function(a){jn.b("loadXML");jn.b("loadFirstPage");this.ab.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.document,d=a.fragment,e=a.userStyleSheet;this.viewport=null;var f=M("loadXML"),g=this;g.A(a).then(function(){var a=new to;if(e)for(var h=0;h<e.length;h++)po(a,e[h]);oo(a).then(function(){var e=ta(b,g.h.location.href);g.w=e;g.g=new xo(a,"");Lo(g.g,e,c).then(function(){No(g.g,d).then(function(a){g.f=a;gp(g).then(function(){g.ab.setAttribute("data-vivliostyle-viewer-status",
"complete");jn.d("loadXML");fp(g,{t:"loaded"});Q(f,!0)})})})})});return O(f)};function hp(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*rc.ex*a.fontSize/rc.em;if(d=rc[d])return c*d}return c}
dp.prototype.A=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.l=null,this.h.addEventListener("resize",this.I,!1),this.d=!0):this.h.removeEventListener("resize",this.I,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.d=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:hp(this,b["margin-left"])||0,marginRight:hp(this,b["margin-right"])||0,marginTop:hp(this,b["margin-top"])||0,marginBottom:hp(this,b["margin-bottom"])||
0,width:hp(this,b.width)||0,height:hp(this,b.height)||0},200<=b.width||200<=b.height)&&(this.h.removeEventListener("resize",this.I,!1),this.l=b,this.d=!0);"boolean"==typeof a.hyphenate&&(this.Q.Bc=a.hyphenate,this.d=!0);"boolean"==typeof a.horizontal&&(this.Q.Ac=a.horizontal,this.d=!0);"boolean"==typeof a.nightMode&&(this.Q.Ic=a.nightMode,this.d=!0);"number"==typeof a.lineHeight&&(this.Q.lineHeight=a.lineHeight,this.d=!0);"number"==typeof a.columnWidth&&(this.Q.xc=a.columnWidth,this.d=!0);"string"==
...
a.zoom,this.D=!0);return N(!0)};function ip(a){var b=[];a.e&&(b.push(a.e),a.e=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(w(a.L,"display","none"),a.removeEventListener("hyperlink",this.u,!1))},a)}function jp(a,b){b.addEventListener("hyperlink",a.u,!1);w(b.L,"visibility","visible");w(b.L,"display","block")}function kp(a,b){ip(a);a.e=b;jp(a,b)}
function lp(a){var b=M("reportPosition");a.f||(a.f=bp(a.b));Mo(a.g,a.f.F,a.f.ka).then(function(c){var d=a.e;(a.M&&0<d.e.length?sg(d.e):N(!0)).then(function(){mp(a,d,c).oa(b)})});return O(b)}function np(a){var b=a.ab;if(a.l){var c=a.l;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new cm(a.h,a.fontSize,b,c.width,c.height)}return new cm(a.h,a.fontSize,b)}
function op(a){if(a.l||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=np(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.tb;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.Za,d=0;d<c.length;d++){var e=c[d];if(e.D&&e.B){a=!0;break a}}}a=!1}b=!a}return b}
function pp(a){if(a.b){a.b.$b();for(var b=a.b.tb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.Za,e;e=d.shift();)e=e.L,e.parentNode.removeChild(e)}}a.viewport=np(a);b=a.viewport;w(b.e,"width","");w(b.e,"height","");w(b.d,"width","");w(b.d,"height","");w(b.d,"transform","");a.b=new Qo(a.g,a.viewport,a.fa,a.Q)}
function qp(a,b){a.D=!1;if(a.Q.Wa)return Xo(a.b).lc(function(c){ip(a);a.j=c;c.left&&(jp(a,c.left),c.right||c.left.L.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(jp(a,c.right),c.left||c.right.L.setAttribute("data-vivliostyle-unpaired-page",!0));c=rp(a,c);a.viewport.zoom(c.width,c.height,a.zoom);a.e=b;return N(null)});kp(a,b);a.viewport.zoom(b.b.width,b.b.height,a.zoom);a.e=b;return N(null)}
function rp(a,b){var c=0,d=0;b.left&&(c+=b.left.b.width,d=b.left.b.height);b.right&&(c+=b.right.b.width,d=Math.max(d,b.right.b.height));b.left&&b.right&&(c+=2*a.Q.Eb);return{width:c,height:d}}var sp={Pd:"fit inside viewport"};
function gp(a){a.d=!1;if(op(a))return N(!0);"complete"===a.ab.getAttribute("data-vivliostyle-viewer-status")&&a.ab.setAttribute("data-vivliostyle-viewer-status","resizing");fp(a,{t:"resizestart"});var b=M("resize");a.b&&!a.f&&(a.f=bp(a.b));pp(a);cp(a.b,a.f).then(function(c){qp(a,c).then(function(){lp(a).then(function(c){jn.d("loadFirstPage");(a.Nc?a.b.Nc():N(null)).then(function(){a.ab.setAttribute("data-vivliostyle-viewer-status","complete");fp(a,{t:"resizeend"});Q(b,c)})})})});return O(b)}
function mp(a,b,c){var d=M("sendLocationNotification"),e={t:"nav",first:b.j,last:b.k};Po(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.u;c&&(e.cfi=c);fp(a,e);Q(d,!0)});return O(d)}dp.prototype.cb=function(){return this.b?this.b.cb():null};
dp.prototype.va=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.Q.Wa?this.b.Ed:this.b.nextPage;break;case "previous":a=this.Q.Wa?this.b.Hd:this.b.Lc;break;case "last":a=this.b.zd;break;case "first":a=this.b.yd;break;default:return N(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return Yo(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return $o(b.b,d)}}else return N(!0);var e=M("nextPage");a.call(b.b).then(function(a){a?(b.f=
null,qp(b,a).then(function(){lp(b).oa(e)})):Q(e,!0)});return O(e)};dp.prototype.dc=function(a){var b=!!a.autohide;a=a.v;var c=this.b.bd();if(c){if("show"==a)return N(!0)}else if("hide"==a)return N(!0);if(c)return this.b.$b(),N(!0);var d=this,e=M("showTOC");this.b.dc(b).then(function(a){if(a){if(b){var c=function(){d.b.$b()};a.addEventListener("hyperlink",c,!1);a.L.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.u,!1)}Q(e,!0)});return O(e)};
function tp(a,b){var c=b.a||"";return Ye("runCommand",function(d){var e=a.$[c];e?e.call(a,b).then(function(){fp(a,{t:"done",a:c});Q(d,!0)}):(u.error("No such action:",c),Q(d,!0))},function(a,b){u.error(b,"Error during action:",c);Q(a,!0)})}function up(a){return"string"==typeof a?JSON.parse(a):a}
function vp(a,b){var c=up(b),d=null;$e(function(){var b=M("commandLoop"),f=Te.d;a.u=function(b){var c={t:"hyperlink",href:b.href,internal:b.href.substr(0,a.w.length)==a.w};af(f,function(){fp(a,c);return N(!0)})};pf(function(b){if(a.d)gp(a).then(function(){rf(b)});else if(a.D)a.e&&qp(a,a.e).then(function(){rf(b)});else if(c){var e=c;c=null;tp(a,e).then(function(){rf(b)})}else e=M("waitForCommand"),d=hf(e,self),O(e).then(function(){rf(b)})}).oa(b);return O(b)});a.B=function(){var a=d;a&&(d=null,a.Ra())};
a.k=function(b){if(c)return!1;c=up(b);a.B();return!0};a.h.adapt_command=a.k};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Bb||(Object.Bb=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function wp(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}function xp(a,b){ja=a.debug;this.f=a;this.b=new dp(a.window||window,a.viewportElement,"main",this.xd.bind(this));this.e={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,spreadView:!1,zoom:1};b&&this.sd(b);this.d=new eb}m=xp.prototype;
m.sd=function(a){var b=Object.Bb({a:"configure"},wp(a));this.b.k(b);Object.Bb(this.e,a)};m.xd=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});fb(this.d,b)};m.Jd=function(a,b){this.d.addEventListener(a,b,!1)};m.Md=function(a,b){this.d.removeEventListener(a,b,!1)};m.Ad=function(a,b,c){a||fb(this.d,{type:"error",content:"No URL specified"});yp(this,a,null,b,c)};m.Kd=function(a,b,c){a||fb(this.d,{type:"error",content:"No URL specified"});yp(this,null,a,b,c)};
function yp(a,b,c,d,e){d=d||{};var f,g=d.userStyleSheet;g&&(f=g.map(function(a){return{url:a.url||null,text:a.text||null}}));e&&Object.Bb(a.e,e);b=Object.Bb({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.f.userAgentRootURL,url:b||c,document:d.documentObject,fragment:d.fragment,userStyleSheet:f},wp(a.e));vp(a.b,b)}m.cb=function(){return this.b.cb()};
m.Cd=function(a){a:switch(a){case "left":a="ltr"===this.cb()?"previous":"next";break a;case "right":a="ltr"===this.cb()?"next":"previous";break a}this.b.k({a:"moveTo",where:a})};m.Bd=function(a){this.b.k({a:"moveTo",url:a})};m.Ld=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.Q.Wa?rp(b,b.j):b.e.b;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ca("vivliostyle.viewer.Viewer",xp);xp.prototype.setOptions=xp.prototype.sd;xp.prototype.addListener=xp.prototype.Jd;xp.prototype.removeListener=xp.prototype.Md;xp.prototype.loadDocument=xp.prototype.Ad;xp.prototype.loadEPUB=xp.prototype.Kd;xp.prototype.getCurrentPageProgression=xp.prototype.cb;xp.prototype.navigateToPage=xp.prototype.Cd;xp.prototype.navigateToInternalUrl=xp.prototype.Bd;xp.prototype.queryZoomFactor=xp.prototype.Ld;ca("vivliostyle.viewer.ZoomType",sp);sp.FIT_INSIDE_VIEWPORT="fit inside viewport";
en.call(jn,"load_vivliostyle","end",void 0);var zp=16,Ap="ltr";function Bp(a){window.adapt_command(a)}function Cp(){Bp({a:"moveTo",where:"ltr"===Ap?"previous":"next"})}function Dp(){Bp({a:"moveTo",where:"ltr"===Ap?"next":"previous"})}
function Ep(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)Bp({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)Bp({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)Bp({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)Bp({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)Dp(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)Cp(),a.preventDefault();else if("0"===b||"U+0030"===c)Bp({a:"configure",fontSize:Math.round(zp)}),a.preventDefault();else if("t"===b||"U+0054"===c)Bp({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)zp*=1.2,Bp({a:"configure",fontSize:Math.round(zp)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)zp/=1.2,Bp({a:"configure",
fontSize:Math.round(zp)}),a.preventDefault()}
function Fp(a){switch(a.t){case "loaded":a=a.viewer;var b=Ap=a.cb();a.ab.setAttribute("data-vivliostyle-page-progression",b);a.ab.setAttribute("data-vivliostyle-spread-view",a.Q.Wa);window.addEventListener("keydown",Ep,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Cp,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Dp,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "nav":(a=a.cfi)&&location.replace(wa(location.href,Ua(a||"")));break;case "hyperlink":a.internal&&Bp({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+n+"; margin: 0; }",document.head.appendChild(g));vp(new dp(window,l,"main",Fp),a)});
