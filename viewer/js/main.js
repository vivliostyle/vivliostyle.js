 ...
 *
 * Vivliostyle core 2019.1.100-pre.20190210171227
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function pu(a,b){if(a.R){var c=Aa("",a.R);if(b===c||b+"/"===c)return"";"/"!=c.charAt(c.length-1)&&(c+="/");return b.substr(0,c.length)==c?decodeURI(b.substr(c.length)):null}return b}
...
function $t(a,b,c){b.readingProgression&&(a.H=b.readingProgression);void 0===a.g&&(a.g={});var d=c&&c.title||b.name||b.metadata&&b.metadata.title;d&&(a.g[iu]=[{v:d}]);var e=pu(a,a.R);!b.readingOrder&&c&&null!==e&&(b.readingOrder=[encodeURI(e)],Array.from(c.querySelectorAll("[role=doc-toc] a[href],[role=directory] a[href],nav a[href],.toc a[href],#toc a[href]")).forEach(function(c){c=pu(a,xa(c.href));null!==c&&(c=encodeURI(c),-1==b.readingOrder.indexOf(c)&&b.readingOrder.push(c))}));var f=[],g=0,h=
-1;[b.readingOrder,b.resources].forEach(function(b){b instanceof Array&&b.forEach(function(b){var c="string"===typeof b?b:b.url||b.href,d="string"===typeof b?"":b.oh||b.href&&b.type||"";if("text/html"===d||"application/xhtml+xml"===d||/(^|\/)([^/]+\.(x?html|htm|xht)|[^/.]*)([#?]|$)/.test(c))c={url:Aa(Ba(c),a.R),index:g++,wb:null,mc:null},"contents"===b.rel&&-1===h&&(h=c.index),f.push(c)})});var l=L("initWithWebPubManifest");tu(a,f).then(function(){-1!==h&&(a.Yb=a.u[h]);a.Yb||(a.Yb=a.C[e]);O(l,!0)});
...
function getDefaultValues() {
    var isNotBook = !_storesUrlParameters2["default"].hasParameter("b");
    return {
