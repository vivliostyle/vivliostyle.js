 ...
 *
 * Vivliostyle core 2019.1.103-pre.20190329103509
 */
(function(factory) {
...
function Fk(a,b){this.Pb={};this.H=a;this.h=b;this.D=null;this.l=[];var c=this;this.J=function(a){var b=a.currentTarget,d=b.getAttribute("href")||b.getAttributeNS("http://www.w3.org/1999/xlink","href");d&&gb(c,{type:"hyperlink",target:null,currentTarget:null,mh:b,href:d,preventDefault:function(){a.preventDefault()}})};this.g={};this.f={width:0,height:0};this.B=this.u=!1;this.F=this.G=!0;this.P=0;this.position=null;this.offset=-1;this.b=null;this.j=[];this.I={top:{},bottom:{},left:{},right:{}}}
v(Fk,fb);function Gk(a,b){(a.G=b)?a.H.setAttribute("data-vivliostyle-auto-page-width",!0):a.H.removeAttribute("data-vivliostyle-auto-page-width")}function Hk(a,b){(a.F=b)?a.H.setAttribute("data-vivliostyle-auto-page-height",!0):a.H.removeAttribute("data-vivliostyle-auto-page-height")}function Ik(a,b,c){var d=a.g[c];d?d.push(b):a.g[c]=[b]}
function Jk(a,b,c){Object.keys(a.g).forEach(function(a){for(var b=this.g[a],c=0;c<b.length;)this.H.contains(b[c])?c++:b.splice(c,1);b.length||delete this.g[a]},a);for(var d=a.l,e=0;e<d.length;e++){var f=d[e];x(f.target,f.name,f.value.toString())}e=Kk(c,a.H);a.f.width=e.width;a.f.height=e.height;for(e=0;e<b.length;e++)if(c=b[e],f=a.g[c.sd],d=a.g[c.Hg],f&&d&&(f=Ek(f,c.action)))for(var g=0;g<d.length;g++)d[g].addEventListener(c.event,f,!1)}
