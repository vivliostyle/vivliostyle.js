 ...
 *
 * Vivliostyle core 2016.4.1-pre.20160527084219
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function(){return this.nb()});hc(this,"pref-font-family",function(){return this.S.fontFamily});hc(this,"pref-night-mode",function(){return this.S.Wc});hc(this,"pref-hyphenate",function(){return this.S.Pc});hc(this,"pref-margin",function(){return this.S.margin});hc(this,"pref-line-height",function(){return this.S.lineHeight});hc(this,"pref-column-width",function(){return this.S.Lc*this.fontSize});hc(this,"pref-horizontal",function(){return this.S.Oc});hc(this,"pref-spread-view",function(){return this.S.$a})}}
...
function nc(a,b,c,d){this.Fa=b;this.Ua=c;this.F=null;this.ob=function(){return this.F?this.F:this.S.$a?Math.floor(b/2)-this.S.Ib:b};this.D=null;this.nb=function(){return this.D?this.D:c};this.h=d;this.aa=null;this.fontSize=function(){return this.aa?this.aa:d};this.S=Yb;this.w={}}function oc(a,b){a.w[b.j]={};for(var c=0;c<b.children.length;c++)oc(a,b.children[c])}
...
function Xc(a,b,c){return b===a.f||b===a.b||c==a.f||c==a.b?a.f:b===a.g||b===a.d?c:c===a.g||c===a.d?b:new Bc(a,b,c)}function D(a,b,c){return b===a.b?c:c===a.b?b:new Lc(a,b,c)}function E(a,b,c){return b===a.b?new Ac(a,c):c===a.b?b:new Mc(a,b,c)}function Yc(a,b,c){return b===a.b||c===a.b?a.b:b===a.d?c:c===a.d?b:new Nc(a,b,c)}function Zc(a,b,c){return b===a.b?a.b:c===a.d?b:new Oc(a,b,c)};var $c={};function ad(){}n=ad.prototype;n.tb=function(a){for(var b=0;b<a.length;b++)a[b].T(this)};n.dd=function(){throw Error("E_CSS_EMPTY_NOT_ALLOWED");};n.ed=function(){throw Error("E_CSS_SLASH_NOT_ALLOWED");};n.ec=function(){throw Error("E_CSS_STR_NOT_ALLOWED");};n.sb=function(){throw Error("E_CSS_IDENT_NOT_ALLOWED");};n.Pb=function(){throw Error("E_CSS_NUMERIC_NOT_ALLOWED");};n.Ob=function(){throw Error("E_CSS_NUM_NOT_ALLOWED");};n.Nb=function(a){return this.Ob(a)};
n.Dc=function(){throw Error("E_CSS_COLOR_NOT_ALLOWED");};n.fc=function(){throw Error("E_CSS_URL_NOT_ALLOWED");};n.fb=function(){throw Error("E_CSS_LIST_NOT_ALLOWED");};n.rb=function(){throw Error("E_CSS_COMMA_NOT_ALLOWED");};n.jb=function(){throw Error("E_CSS_FUNC_NOT_ALLOWED");};n.Mb=function(){throw Error("E_CSS_EXPR_NOT_ALLOWED");};function bd(){}u(bd,ad);n=bd.prototype;
n.tb=function(a){for(var b=null,c=0;c<a.length;c++){var d=a[c],e=d.T(this);if(b)b[c]=e;else if(d!==e){b=Array(a.length);for(d=0;d<c;d++)b[d]=a[d];b[c]=e}}return b||a};n.ec=function(a){return a};n.sb=function(a){return a};n.ed=function(a){return a};n.Pb=function(a){return a};n.Ob=function(a){return a};n.Nb=function(a){return a};n.Dc=function(a){return a};n.fc=function(a){return a};n.fb=function(a){var b=this.tb(a.values);return b===a.values?a:new cd(b)};
n.rb=function(a){var b=this.tb(a.values);return b===a.values?a:new dd(b)};n.jb=function(a){var b=this.tb(a.values);return b===a.values?a:new ed(a.name,b)};n.Mb=function(a){return a};function fd(){}n=fd.prototype;n.toString=function(){var a=new Ia;this.za(a,!0);return a.toString()};n.stringValue=function(){var a=new Ia;this.za(a,!1);return a.toString()};n.ia=function(){throw Error("F_ABSTRACT");};n.za=function(a){a.append("[error]")};n.md=function(){return!1};n.Vb=function(){return!1};n.od=function(){return!1};
n.Cd=function(){return!1};n.Uc=function(){return!1};function gd(){if(G)throw Error("E_INVALID_CALL");}u(gd,fd);gd.prototype.ia=function(a){return new gc(a,"")};gd.prototype.za=function(){};gd.prototype.T=function(a){return a.dd(this)};var G=new gd;function hd(){if(id)throw Error("E_INVALID_CALL");}u(hd,fd);hd.prototype.ia=function(a){return new gc(a,"/")};hd.prototype.za=function(a){a.append("/")};hd.prototype.T=function(a){return a.ed(this)};var id=new hd;function jd(a){this.b=a}u(jd,fd);
jd.prototype.ia=function(a){return new gc(a,this.b)};jd.prototype.za=function(a,b){b?(a.append('"'),a.append(La(this.b)),a.append('"')):a.append(this.b)};jd.prototype.T=function(a){return a.ec(this)};function kd(a){this.name=a;if($c[a])throw Error("E_INVALID_CALL");$c[a]=this}u(kd,fd);kd.prototype.ia=function(a){return new gc(a,this.name)};kd.prototype.za=function(a,b){b?a.append(Ka(this.name)):a.append(this.name)};kd.prototype.T=function(a){return a.sb(this)};kd.prototype.Cd=function(){return!0};
function H(a){var b=$c[a];b||(b=new kd(a));return b}function I(a,b){this.C=a;this.fa=b.toLowerCase()}u(I,fd);I.prototype.ia=function(a,b){return 0==this.C?a.b:b&&"%"==this.fa?100==this.C?b:new Nc(a,b,new gc(a,this.C/100)):new Qc(a,this.C,this.fa)};I.prototype.za=function(a){a.append(this.C.toString());a.append(this.fa)};I.prototype.T=function(a){return a.Pb(this)};I.prototype.Vb=function(){return!0};function ld(a){this.C=a}u(ld,fd);
ld.prototype.ia=function(a){return 0==this.C?a.b:1==this.C?a.d:new gc(a,this.C)};ld.prototype.za=function(a){a.append(this.C.toString())};ld.prototype.T=function(a){return a.Ob(this)};ld.prototype.od=function(){return!0};function md(a){this.C=a}u(md,ld);md.prototype.T=function(a){return a.Nb(this)};function nd(a){this.b=a}u(nd,fd);nd.prototype.za=function(a){a.append("#");var b=this.b.toString(16);a.append("000000".substr(b.length));a.append(b)};nd.prototype.T=function(a){return a.Dc(this)};
function od(a){this.url=a}u(od,fd);od.prototype.za=function(a){a.append('url("');a.append(La(this.url));a.append('")')};od.prototype.T=function(a){return a.fc(this)};function pd(a,b,c,d){var e=b.length;b[0].za(a,d);for(var f=1;f<e;f++)a.append(c),b[f].za(a,d)}function cd(a){this.values=a}u(cd,fd);cd.prototype.za=function(a,b){pd(a,this.values," ",b)};cd.prototype.T=function(a){return a.fb(this)};cd.prototype.Uc=function(){return!0};function dd(a){this.values=a}u(dd,fd);
dd.prototype.za=function(a,b){pd(a,this.values,",",b)};dd.prototype.T=function(a){return a.rb(this)};function ed(a,b){this.name=a;this.values=b}u(ed,fd);ed.prototype.za=function(a,b){a.append(Ka(this.name));a.append("(");pd(a,this.values,",",b);a.append(")")};ed.prototype.T=function(a){return a.jb(this)};function J(a){this.d=a}u(J,fd);J.prototype.ia=function(){return this.d};J.prototype.za=function(a){a.append("-epubx-expr(");this.d.oa(a,0);a.append(")")};J.prototype.T=function(a){return a.Mb(this)};
...
function De(a,b,c){c=b+c;for(var d=Array(c),e=Array(c),f=0;f<=c;f++)d[f]=0,e[f]=0;for(var g=[],h=!1,l=a.length,k=0;k<l;k++){var m=a[k];d[m.b]+=m.e;e[m.b]+=m.d;for(var p=!1,f=0;f<b;f++)if(d[f]&&!e[f]){p=!0;break}if(p)for(f=b;f<=c;f++)if(d[f]||e[f]){p=!1;break}h!=p&&(g.push(m.x),h=p)}return g}function Ee(a,b){return b?Math.ceil(a/b)*b:a}function Fe(a,b){return b?Math.floor(a/b)*b:a}function Ge(a){return new qe(a.y,-a.x)}function He(a){return new pe(a.V,-a.U,a.Q,-a.$)}
function Ie(a){return new ve(Va(a.b,Ge))}
function Je(a,b,c,d,e){e&&(a=He(a),b=Va(b,Ie),c=Va(c,Ie));e=b.length;var f=c?c.length:0,g=[],h=[],l,k,m;for(l=0;l<e;l++)we(b[l],h,l);for(l=0;l<f;l++)we(c[l],h,l+e);b=h.length;h.sort(ue);for(c=0;h[c].e>=e;)c++;c=h[c].b.y;c>a.V&&g.push(new te(a.V,c,a.U,a.U));l=0;for(var p=[];l<b&&(m=h[l]).b.y<c;)m.d.y>c&&p.push(m),l++;for(;l<b||0<p.length;){var r=a.Q,t=Ee(Math.ceil(c+8),d);for(k=0;k<p.length&&r>t;k++)m=p[k],m.b.x==m.d.x?m.d.y<r&&(r=Math.max(Fe(m.d.y,d),t)):m.b.x!=m.d.x&&(r=t);r>a.Q&&(r=a.Q);for(;l<
b&&(m=h[l]).b.y<r;)if(m.d.y<c)l++;else if(m.b.y<t){if(m.b.y!=m.d.y||m.b.y!=c)p.push(m),r=t;l++}else{k=Fe(m.b.y,d);k<r&&(r=k);break}t=[];for(k=0;k<p.length;k++)Ce(t,p[k],c,r);t.sort(function(a,b){return a.x-b.x||a.d-b.d});t=De(t,e,f);if(0==t.length)g.push(new te(c,r,a.U,a.U));else{var q=0,y=a.$;for(k=0;k<t.length;k+=2){var L=Math.max(a.$,t[k]),Q=Math.min(a.U,t[k+1])-L;Q>q&&(q=Q,y=L)}0==q?g.push(new te(c,r,a.U,a.U)):g.push(new te(c,r,Math.max(y,a.$),Math.min(y+q,a.U)))}if(r==a.Q)break;c=r;for(k=p.length-
1;0<=k;k--)p[k].d.y<=r&&p.splice(k,1)}Ke(a,g);return g}function Ke(a,b){for(var c=b.length-1,d=new te(a.Q,a.Q,a.$,a.U);0<=c;){var e=d,d=b[c];d.$==e.$&&d.U==e.U&&(e.V=d.V,b.splice(c,1),d=e);c--}}function Le(a,b){for(var c=0,d=a.length;c<d;){var e=Math.floor((c+d)/2);b>=a[e].Q?c=e+1:d=e}return c}
function Me(a,b,c,d){for(var e=c.V,f=c.U-c.$,g=c.Q-c.V,h=Le(b,e);;){var l=e+g;if(l>a.Q)break;for(var k=a.$,m=a.U,p=h;p<b.length&&b[p].V<l;p++){var r=b[p];r.$>k&&(k=r.$);r.U<m&&(m=r.U)}if(k+f<=m||h>=b.length){"left"==d?(c.$=k,c.U=k+f):(c.$=m-f,c.U=m);c.Q+=e-c.V;c.V=e;break}e=b[h].Q;h++}}
function Ne(a,b,c,d){for(var e=null,e=[new te(c.V,c.Q,c.$,c.U)];0<e.length&&e[0].Q<=a.V;)e.shift();if(0!=e.length){e[0].V<a.V&&(e[0].V=a.V);c=0==b.length?a.V:b[b.length-1].Q;c<a.Q&&b.push(new te(c,a.Q,a.$,a.U));for(var f=Le(b,e[0].V),g=0;g<e.length;g++){var h=e[g];if(f==b.length)break;b[f].V<h.V&&(c=b[f],f++,b.splice(f,0,new te(h.V,c.Q,c.$,c.U)),c.Q=h.V);for(;f<b.length&&(c=b[f++],c.Q>h.Q&&(b.splice(f,0,new te(h.Q,c.Q,c.$,c.U)),c.Q=h.Q),h.$!=h.U&&("left"==d?c.$=Math.min(h.U,a.U):c.U=Math.max(h.$,
...
a.b=Of;l.splice(0,l.length);continue;case 29:a.b=Nf;g.eb();continue;case 1:if(!k.b){a.b=Sf;g.error("E_CSS_SPACE_EXPECTED",k);continue}g.kb();case 2:if(34==z(h,1).type)if(A(h),A(h),p=a.G[k.text],null!=p)switch(k=x(h),k.type){case 1:g.hb(p,k.text);a.b=f?Lf:R;A(h);break;case 36:g.hb(p,null);a.b=f?Lf:R;A(h);break;default:a.b=Qf,g.error("E_CSS_NAMESPACE",k)}else a.b=Qf,g.error("E_CSS_UNDECLARED_PREFIX",k);else g.hb(a.D,k.text),a.b=f?Lf:R,A(h);continue;case 3:if(!k.b){a.b=Sf;g.error("E_CSS_SPACE_EXPECTED",
k);continue}g.kb();case 4:if(34==z(h,1).type)switch(A(h),A(h),k=x(h),k.type){case 1:g.hb(null,k.text);a.b=f?Lf:R;A(h);break;case 36:g.hb(null,null);a.b=f?Lf:R;A(h);break;default:a.b=Qf,g.error("E_CSS_NAMESPACE",k)}else g.hb(a.D,null),a.b=f?Lf:R,A(h);continue;case 5:k.b&&g.kb();case 6:g.Qc(k.text);a.b=f?Lf:R;A(h);continue;case 7:k.b&&g.kb();case 8:g.Kc(k.text);a.b=f?Lf:R;A(h);continue;case 55:k.b&&g.kb();case 14:A(h);k=x(h);b:switch(k.type){case 1:g.Xb(k.text,null);A(h);a.b=f?Lf:R;continue;case 6:m=
...
null);a.b=f?Lf:R;A(h);continue;case 6:if(m=k.text,A(h),p=Zf(a),k=x(h),11==k.type){g.Yb(m,p);a.b=f?Lf:R;A(h);continue}}g.error("E_CSS_PSEUDOELEM_SYNTAX",k);a.b=Qf;continue;case 9:k.b&&g.kb();case 10:A(h);k=x(h);if(1==k.type)m=k.text,A(h);else if(36==k.type)m=null,A(h);else if(34==k.type)m="";else{a.b=Sf;g.error("E_CSS_ATTR",k);A(h);continue}k=x(h);if(34==k.type){p=m?a.G[m]:m;if(null==p){a.b=Sf;g.error("E_CSS_UNDECLARED_PREFIX",k);A(h);continue}A(h);k=x(h);if(1!=k.type){a.b=Sf;g.error("E_CSS_ATTR_NAME_EXPECTED",
...
"E_CSS_UNEXPECTED_SEMICOL",k);else return a.k=l.pop(),a.B=!0,a.b=Jf,A(h),!1;A(h);continue;case 40:l.push(k.type);A(h);continue;case 27:a.b=Jf;A(h);g.lb();a.f.length&&a.f.pop();continue;case 30:m=k.text.toLowerCase();switch(m){case "import":A(h);k=x(h);if(2==k.type||8==k.type){a.F=k.text;A(h);k=x(h);if(17==k.type||0==k.type)return a.B=!0,A(h),!1;a.e=null;a.g=3;a.b=Pf;l.push("{");continue}g.error("E_CSS_IMPORT_SYNTAX",k);a.b=Qf;continue;case "namespace":A(h);k=x(h);switch(k.type){case 1:m=k.text;A(h);
...
function eg(a,b,c,d,e){var f=K("parseStylesheet"),g=new Uf(Jf,a,b,c),h=null;e&&(h=fg(new Tb(e,b),b,c));if(h=ag(g,d,h&&h.ia()))b.Bb(h),b.pa();nf(function(){for(;!cg(g,100,!1,!1,!1,!1);){if(g.B){var a=va(g.F,c);g.k&&(b.Bb(g.k),b.pa());var d=K("parseStylesheet.import");gg(a,b,null,null).then(function(){g.k&&b.lb();g.B=!1;g.F=null;g.k=null;O(d,!0)});return N(d)}a=mf();if(a.Ca)return a}return M(!1)}).then(function(){h&&b.lb();O(f,!0)});return N(f)}
...
function Gg(a,b,c,d){for(var e=c?[]:b,f=a.d,g=d,h=null,l=null;f!==a.b&&f!==a.e;)if(g>=b.length)f=f.e;else{var k=b[g],m=k;if(0!=f.d)m=!0,-1==f.d?(h?h.push(l):h=[l],l=[]):-2==f.d?0<h.length?l=h.pop():l=null:0<f.d&&0==f.d%2?l[Math.floor((f.d-1)/2)]="taken":m=null==l[Math.floor((f.d-1)/2)],f=m?f.f:f.e;else{if(0==g&&!c&&f.b instanceof Hg&&a instanceof Hg){if(m=(new cd(b)).T(f.b)){g=b.length;f=f.f;continue}}else if(0==g&&!c&&f.b instanceof Ig&&a instanceof Hg){if(m=(new dd(b)).T(f.b)){g=b.length;f=f.f;
continue}}else m=k.T(f.b);if(m){if(m!==k&&b===e)for(e=[],k=0;k<g;k++)e[k]=b[k];b!==e&&(e[g-d]=m);g++;f=f.f}else f=f.e}}return f===a.b&&(c?0<e.length:g==b.length)?e:null}n=Fg.prototype;n.Va=function(a){for(var b=null,c=this.d;c!==this.b&&c!==this.e;)a?0!=c.d?c=c.f:(b=a.T(c.b))?(a=null,c=c.f):c=c.e:c=c.e;return c===this.b?b:null};n.dd=function(a){return this.Va(a)};n.ed=function(a){return this.Va(a)};n.ec=function(a){return this.Va(a)};n.sb=function(a){return this.Va(a)};n.Pb=function(a){return this.Va(a)};
n.Ob=function(a){return this.Va(a)};n.Nb=function(a){return this.Va(a)};n.Dc=function(a){return this.Va(a)};n.fc=function(a){return this.Va(a)};n.fb=function(){return null};n.rb=function(){return null};n.jb=function(a){return this.Va(a)};n.Mb=function(){return null};function Hg(a){Fg.call(this,a)}u(Hg,Fg);Hg.prototype.fb=function(a){var b=Gg(this,a.values,!1,0);return b===a.values?a:b?new cd(b):null};
Hg.prototype.rb=function(a){for(var b=this.d,c=!1;b;){if(b.b instanceof Ig){c=!0;break}b=b.e}return c?(b=Gg(this,a.values,!1,0),b===a.values?a:b?new dd(b):null):null};Hg.prototype.f=function(a,b){return Gg(this,a,!0,b)};function Ig(a){Fg.call(this,a)}u(Ig,Fg);Ig.prototype.fb=function(a){return this.Va(a)};Ig.prototype.rb=function(a){var b=Gg(this,a.values,!1,0);return b===a.values?a:b?new dd(b):null};Ig.prototype.f=function(a,b){for(var c=this.d,d;c!==this.e;){if(d=c.b.f(a,b))return d;c=c.e}return null};
function Jg(a,b){Fg.call(this,b);this.name=a}u(Jg,Fg);Jg.prototype.Va=function(){return null};Jg.prototype.jb=function(a){if(a.name.toLowerCase()!=this.name)return null;var b=Gg(this,a.values,!1,0);return b===a.values?a:b?new ed(a.name,b):null};function Kg(){}Kg.prototype.b=function(a,b){return b};Kg.prototype.e=function(){};function Lg(a,b){this.name=b;this.f=a.e[this.name]}u(Lg,Kg);
...
function Pg(a,b){a.Cb([b]);return null}n.dd=function(a){return Pg(this,a)};n.ec=function(a){return Pg(this,a)};n.sb=function(a){return Pg(this,a)};n.Pb=function(a){return Pg(this,a)};n.Ob=function(a){return Pg(this,a)};n.Nb=function(a){return Pg(this,a)};n.Dc=function(a){return Pg(this,a)};n.fc=function(a){return Pg(this,a)};n.fb=function(a){this.Cb(a.values);return null};n.rb=function(){this.error=!0;return null};n.jb=function(a){return Pg(this,a)};n.Mb=function(){this.error=!0;return null};
...
Tg.prototype.rb=function(a){for(var b={},c=0;c<a.values.length;c++){this.values={};if(a.values[c]instanceof dd)this.error=!0;else{a.values[c].T(this);for(var d=b,e=this.values,f=0;f<this.b.length;f++){var g=this.b[f],h=e[g]||this.d.h[g],l=d[g];l||(l=[],d[g]=l);l.push(h)}this.values["background-color"]&&c!=a.values.length-1&&(this.error=!0)}if(this.error)return null}this.values={};for(var k in b)this.values[k]="background-color"==k?b[k].pop():new dd(b[k]);return null};function Ug(){Og.call(this)}
...
Ug.prototype.rb=function(a){a.values[0].T(this);if(this.error)return null;for(var b=[this.values["font-family"]],c=1;c<a.values.length;c++)b.push(a.values[c]);a=new dd(b);a.T(this.d.e["font-family"])?this.values["font-family"]=a:this.error=!0;return null};Ug.prototype.sb=function(a){if(a=this.d.d[a.name])for(var b in a)this.values[b]=a[b];else this.error=!0;return null};var Vg={SIMPLE:Qg,INSETS:Rg,INSETS_SLASH:Sg,COMMA:Tg,FONT:Ug};
...
function fh(a,b,c,d,e){var f="",g=b;b=b.toLowerCase();var h=b.match(/^-([a-z]+)-([-a-z0-9]+)$/);h&&(f=h[1],b=h[2]);if((h=a.k[b])&&h[f])if(f=a.e[b])(a=c===Id||c.md()?c:c.T(f))?e.cb(b,a,d):e.Ub(g,c);else if(b=a.f[b].clone(),c===Id)for(c=0;c<b.b.length;c++)e.cb(b.b[c],Id,d);else{c.T(b);if(b.error)d=!1;else{for(a=0;a<b.b.length;a++)f=b.b[a],e.cb(f,b.values[f]||b.d.h[f],d);d=!0}d||e.Ub(g,c)}else e.Cc(g,c)}
...
var Dh={je:"text/html",ke:"text/xml",be:"application/xml",ae:"application/xhtml_xml",ge:"image/svg+xml"};function Eh(a,b,c){c=c||new DOMParser;var d;try{d=c.parseFromString(a,b)}catch(e){}if(d){a=d.documentElement;if("parsererror"===a.localName)return null;for(a=a.firstChild;a;a=a.nextSibling)if("parsererror"===a.localName)return null}else return null;return d}
...
function Xh(a,b){this.e={};this.I=a;this.b=b;this.w=null;this.h=[];var c=this;this.D=function(a){var b=a.currentTarget,f=b.getAttribute("href")||b.getAttributeNS("http://www.w3.org/1999/xlink","href");f&&(a.preventDefault(),Ya(c,{type:"hyperlink",target:null,currentTarget:null,oe:b,href:f}))};this.j={};this.d={width:0,height:0};this.l=this.k=!1;this.H=0;this.position=null;this.offset=-1;this.g=null;this.f=[];this.u={top:{},bottom:{},left:{},right:{}}}u(Xh,Xa);
...
ji.prototype.modify=function(){return this.W?li(this):this};function mi(a){var b=a;do{if(b.W)break;b.W=!0;b=b.parent}while(b);return a}ji.prototype.clone=function(){for(var a=li(this),b=a,c;null!=(c=b.parent);)c=li(c),b=b.parent=c;return a};function ni(a){return{ha:a.Y,Ra:a.Ra,ea:a.ea,ya:a.ya,sa:a.sa?ni(a.sa):null}}function oi(a){var b=a,c=[];do b.d&&b.parent&&b.parent.d!==b.d||c.push(ni(b)),b=b.parent;while(b);return{ka:c,da:a.da,M:a.M}}
...
var bj=aj({before:"right",after:"left",start:"top",end:"bottom"}),cj=aj({before:"top",after:"bottom",start:"left",end:"right"});function U(a,b){this.value=a;this.Ha=b}n=U.prototype;n.zd=function(){return this};n.nc=function(a){a=this.value.T(a);return a===this.value?this:new U(a,this.Ha)};n.Ad=function(a){return 0==a?this:new U(this.value,this.Ha+a)};n.evaluate=function(a,b){return kg(a,this.value,b)};n.wd=function(){return!0};function dj(a,b,c){U.call(this,a,b);this.L=c}u(dj,U);
dj.prototype.zd=function(){return new U(this.value,this.Ha)};dj.prototype.nc=function(a){a=this.value.T(a);return a===this.value?this:new dj(a,this.Ha,this.L)};dj.prototype.Ad=function(a){return 0==a?this:new dj(this.value,this.Ha+a,this.L)};dj.prototype.wd=function(a){return!!this.L.evaluate(a)};function ej(a,b,c){return(null==b||c.Ha>b.Ha)&&c.wd(a)?c.zd():b}var fj={"region-id":!0};function gj(a){return"_"!=a.charAt(0)&&!fj[a]}function hj(a,b,c){c?a[b]=c:delete a[b]}
function ij(a,b){var c=a[b];c||(c={},a[b]=c);return c}function jj(a,b){var c=a[b];c||(c=[],a[b]=c);return c}function kj(a,b,c,d,e,f){if(e){var g=ij(b,"_pseudos");b=g[e];b||(b={},g[e]=b)}f&&(e=ij(b,"_regions"),b=e[f],b||(b={},e[f]=b));for(var h in c)"_"!=h.charAt(0)&&(fj[h]?(f=c[h],e=jj(b,h),Array.prototype.push.apply(e,f)):hj(b,h,ej(a,b[h],c[h].Ad(d))))}
...
mj.prototype.Pb=function(a){if("em"==a.fa||"ex"==a.fa){var b=pc(this.d,a.fa,!1)/pc(this.d,"em",!1);return new I(a.C*b*nj(this),"px")}if("%"==a.fa){if("font-size"===this.b)return new I(a.C/100*nj(this),"px");b=this.b.match(/height|^(top|bottom)$/)?"vh":"vw";return new I(a.C,b)}return a};mj.prototype.Mb=function(a){return"font-size"==this.b?kg(this.d,a,this.b).T(this):a};function oj(){}oj.prototype.apply=function(){};oj.prototype.h=function(a){return new pj([this,a])};oj.prototype.clone=function(){return this};
...
ck.prototype.jb=function(a){if("attr"!==a.name)return bd.prototype.jb.call(this,a);var b="string",c=null,d=null;a.values[0]instanceof cd?(2<=a.values[0].values.length&&(b=a.values[0].values[1].stringValue()),c=a.values[0].values[0].stringValue()):c=a.values[0].stringValue();d=1<a.values.length?dk(a.values[1].stringValue(),b):dk(null,b);return this.b&&this.b.hasAttribute(c)?dk(this.b.getAttribute(c),b):d};function ek(a){this.b=a}u(ek,bd);
ek.prototype.sb=function(a){var b=this.b,c=b.D,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.l)];b.l++;break;case "close-quote":return 0<b.l&&b.l--,c[2*Math.min(d,b.l)+1];case "no-open-quote":return b.l++,new jd("");case "no-close-quote":return 0<b.l&&b.l--,new jd("")}return a};
...
hk={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},ik={qe:!1,Rb:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",rc:"\u5341\u767e\u5343",Rd:"\u8ca0"};
function jk(a){if(9999<a||-9999>a)return""+a;if(0==a)return ik.Rb.charAt(0);var b=new Ia;0>a&&(b.append(ik.Rd),a=-a);if(10>a)b.append(ik.Rb.charAt(a));else if(ik.re&&19>=a)b.append(ik.rc.charAt(0)),0!=a&&b.append(ik.rc.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(ik.Rb.charAt(c)),b.append(ik.rc.charAt(2)));if(c=Math.floor(a/100)%10)b.append(ik.Rb.charAt(c)),b.append(ik.rc.charAt(1));if(c=Math.floor(a/10)%10)b.append(ik.Rb.charAt(c)),b.append(ik.rc.charAt(0));(a%=10)&&b.append(ik.Rb.charAt(a))}return b.toString()}
...
function sk(a,b,c){this.k=a;this.g=b;this.wb=c;this.f=[[],[]];this.j={};this.w=this.u=this.b=null;this.la=this.na=this.W=this.e=this.d="";this.N=this.F=null;this.Ma=this.Fa=!0;this.h={};this.B=[{}];this.D=[new jd("\u201c"),new jd("\u201d"),new jd("\u2018"),new jd("\u2019")];this.l=0;this.lang="";this.xb=[0];this.ma=0;this.aa=[{}];this.Oa=this.aa[0];this.G=null;this.ub=[this.G];this.vb=[{}];this.Na=this.aa[0];this.Ua=[]}function Uj(a,b){a.j[b]=(a.j[b]||0)+1}
function tk(a,b,c){(b=b[c])&&b.apply(a)}var uk=[];function vk(a,b,c,d){a.b=null;a.u=d;a.e="";a.d="";a.W="";a.na="";a.w=b;a.la="";a.F=uk;a.N=c;wk(a)}function xk(a,b,c){a.h[b]?a.h[b].push(c):a.h[b]=[c];c=a.B[a.B.length-1];c||(c={},a.B[a.B.length-1]=c);c[b]=!0}
...
function Bk(a,b,c){a.Ua.push(b);a.N=null;a.b=b;a.u=c;a.e=b.namespaceURI;a.d=b.localName;var d=a.k.b[a.e];a.la=d?d+a.d:"";a.W=b.getAttribute("id");a.na=b.getAttributeNS("http://www.w3.org/XML/1998/namespace","id");(d=b.getAttribute("class"))?a.w=d.split(/\s+/):a.w=uk;(d=b.getAttributeNS("http://www.idpf.org/2007/ops","type"))?a.F=d.split(/\s+/):a.F=uk;"style"==a.d&&"http://www.gribuser.ru/xml/fictionbook/2.0"==a.e&&(a.w=[b.getAttribute("name")||""]);(d=b.getAttributeNS("http://www.w3.org/XML/1998/namespace",
"lang"))||"http://www.w3.org/1999/xhtml"!=a.e||(d=b.getAttribute("lang"));d&&(a.f[a.f.length-1].push(new ak(a.lang)),a.lang=d.toLowerCase());d=a.xb;a.ma=++d[d.length-1];d.push(0);var d=a.aa,e=a.Oa=d[d.length-1],f=e[a.e];f||(f=e[a.e]={});f[a.d]=(f[a.d]||0)+1;d.push({});d=a.ub;null!==d[d.length-1]?a.G=--d[d.length-1]:a.G=null;d.push(null);d=a.vb;(e=a.Na=d[d.length-1])&&e[a.e]&&e[a.e][a.d]--;d.push({});wk(a);b=new ck(b);var d=a.u,e=d._pseudos,g;for(g in e)Ck(b,e[g]);Ck(b,d);g=c.quotes;c=null;g&&(g=g.evaluate(a.g))&&
...
function wk(a){var b;for(b=0;b<a.w.length;b++)tk(a,a.k.Aa,a.w[b]);for(b=0;b<a.F.length;b++)tk(a,a.k.d,a.F[b]);tk(a,a.k.e,a.W);tk(a,a.k.dc,a.d);""!=a.d&&tk(a,a.k.dc,"*");tk(a,a.k.f,a.la);null!==a.N&&(tk(a,a.k.Wb,a.N),tk(a,a.k.Wb,"*"));a.b=null;a.f.push([]);for(var c=1;-1<=c;--c){var d=a.f[a.f.length-c-2];for(b=0;b<d.length;)d[b].push(a,c)?d.splice(b,1):b++}a.Fa=!0;a.Ma=!1}
sk.prototype.pop=function(){for(var a=1;-1<=a;--a)for(var b=this.f[this.f.length-a-2],c=0;c<b.length;)b[c].pop(this,a)?b.splice(c,1):c++;this.f.pop();this.Fa=!1};var Dk=null;function Ek(a,b,c,d,e,f,g){Ff.call(this,a,b,g);this.b=null;this.O=0;this.f=this.h=null;this.l=!1;this.L=c;this.g=d?d.g:Dk?Dk.clone():new rk;this.w=e;this.k=f;this.j=0}u(Ek,Gf);Ek.prototype.Bd=function(a){tj(this.g.dc,"*",a)};function Fk(a,b){var c=lj(a.b,b);c!==b&&c.e(a.g)||a.Bd(c)}
Ek.prototype.hb=function(a,b){if(b||a)this.O+=1,b&&a?this.b.push(new wj(a,b.toLowerCase())):b?this.b.push(new vj(b.toLowerCase())):this.b.push(new yj(a))};Ek.prototype.Kc=function(a){this.f?(v.b("::"+this.f,"followed by ."+a),this.b.push(new Qj(""))):(this.O+=256,this.b.push(new sj(a)))};var Gk={"nth-child":Ij,"nth-of-type":Jj,"nth-last-child":Kj,"nth-last-of-type":Lj};
...
function il(a,b,c,d,e,f,g){this.ba=a;this.root=a.root;this.na=c;this.f=d;this.j=f;this.d=this.root;this.D={};this.F={};this.k={};this.u=[];this.B=this.w=null;this.G=new sk(b,d,g);this.e=new Rk;this.Xa=!0;this.W=[];this.ma=e;this.la=this.aa=!1;this.b=a=xh(a,this.root);this.N={};this.g=new el(d);Tk(this.e,a);d=jl(this,this.root);Bk(this.G,this.root,d);kl(this,d,!1);this.l=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.l=!1}this.W.push(!0);
this.F={};this.F["e"+a]=d;this.b++;ll(this,-1)}function ml(a,b,c,d){return(b=b[d])&&b.evaluate(a.f)!==c[d]}function nl(a,b,c){for(var d in c){var e=b[d];e?(a.D[d]=e,delete b[d]):(e=c[d])&&(a.D[d]=new U(e,33554432))}}var ql=["column-count","column-width"];
function kl(a,b,c){c||["writing-mode","direction"].forEach(function(a){b[a]&&(this.D[a]=b[a])},a);if(!a.aa){var d=ml(a,b,a.j.g,"background-color")?b["background-color"].evaluate(a.f):null,e=ml(a,b,a.j.g,"background-image")?b["background-image"].evaluate(a.f):null;if(d&&d!==Id||e&&e!==Id)nl(a,b,a.j.g),a.aa=!0}if(!a.la)for(d=0;d<ql.length;d++)if(ml(a,b,a.j.j,ql[d])){nl(a,b,a.j.j);a.la=!0;break}if(!c&&(c=b["font-size"])){d=c.evaluate(a.f);c=d.C;switch(d.fa){case "em":case "rem":c*=a.f.h;break;case "ex":case "rex":c*=
a.f.h*lc.ex/lc.em;break;case "%":c*=a.f.h/100;break;default:(d=lc[d.fa])&&(c*=d)}a.f.aa=c}}function rl(a){for(var b=0;!a.l&&(b+=5E3,sl(a,b,0)!=Number.POSITIVE_INFINITY););return a.D}function jl(a,b){if(b.style instanceof CSSStyleDeclaration){var c=b.getAttribute("style");if(c){var d=a.ba.url,e=new Mk(a.na,a.j),c=new Tb(c,e);try{cg(new Uf(Kf,c,e,d),Number.POSITIVE_INFINITY,!1,!0,!1,!1)}catch(f){v.b(f,"Style attribute parse error:")}return e.b}}return{}}
function ll(a,b){if(!(b>=a.b)){var c=a.f,d=xh(a.ba,a.root);if(b<d){var e=a.h(a.root,!1),f=e["flow-into"],f=f?f.evaluate(c,"flow-into").toString():"body",f=tl(a,f,e,a.root,d);0===a.g.b.length&&a.g.push(e,d,!0,f)}d=Ah(a.ba,b);e=yh(a.ba,d,0,!1);if(!(e>=a.b))for(;;){if(1!=d.nodeType)e+=d.textContent.length;else{var g=d;if(e!=xh(a.ba,g))throw Error("Inconsistent offset");var h=a.h(g,!1);if(f=h["flow-into"])f=f.evaluate(c,"flow-into").toString(),tl(a,f,h,g,e);e++}if(e>=a.b)break;f=d.firstChild;if(null==
...
function sl(a,b,c){var d=-1;if(b<=a.b&&(d=Vk(a.e,b),d+=c,d<Sk(a.e)))return Wk(a.e,d);if(null==a.d)return Number.POSITIVE_INFINITY;for(var e=a.f;;){var f=a.d.firstChild;if(null==f)for(;;){if(1==a.d.nodeType){var f=a.G,g=a.d;if(f.Ua.pop()!==g)throw Error("Invalid call to popElement");f.xb.pop();f.aa.pop();f.ub.pop();f.vb.pop();f.pop();zk(f);a.Xa=a.W.pop();g=a.g.pop(a.b);f=null;g.d&&(f=bl(g.d,"before"),wl(a,f,g.d.Ea?hl(a.g,g):g.d.offset,g.b),f=bl(g.d,"after"));f=al(f,bl(g,"after"));wl(a,f,a.b,g.b)}if(f=
a.d.nextSibling)break;a.d=a.d.parentNode;if(a.d===a.root)return a.d=null,b<a.b&&(0>d&&(d=Vk(a.e,b),d+=c),d<=Sk(a.e))?Wk(a.e,d):Number.POSITIVE_INFINITY}a.d=f;if(1!=a.d.nodeType){a.b+=a.d.textContent.length;var f=a.g,g=a.d,h=fl(f);(f.Ea||f.Ia)&&Yk(h)&&(h=$k(h,"white-space",Sd).toString(),bi(g,ai(h))||(f.Ea=!1,f.Ia=!1));a.Xa?Tk(a.e,a.b):Uk(a.e,a.b)}else{g=a.d;f=jl(a,g);a.W.push(a.Xa);Bk(a.G,g,f);a.l||"body"!=g.localName||g.parentNode!=a.root||(kl(a,f,!0),a.l=!0);if(h=f["flow-into"]){var h=h.evaluate(e,
"flow-into").toString(),l=tl(a,h,f,g,a.b);a.Xa=!!a.ma[h];g=a.g.push(f,a.b,g===a.root,l)}else g=a.g.push(f,a.b,g===a.root);h=hl(a.g,g);wl(a,g.e,h,g.b);g.f&&(l=bl(g.f,"after"),wl(a,l,g.f.Ea?h:g.offset,g.b));a.Xa&&dl(g)===Rd&&(a.Xa=!1);if(xh(a.ba,a.d)!=a.b)throw Error("Inconsistent offset");a.F["e"+a.b]=f;a.b++;a.Xa?Tk(a.e,a.b):Uk(a.e,a.b);if(b<a.b&&(0>d&&(d=Vk(a.e,b),d+=c),d<=Sk(a.e)))return Wk(a.e,d)}}}
il.prototype.h=function(a,b){var c=xh(this.ba,a),d="e"+c;b&&(c=yh(this.ba,a,0,!0));this.b<=c&&sl(this,c,0);return this.F[d]};var xl=1;function yl(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.h=0;this.d=a;this.name=b;this.qb=c;this.Aa=d;this.parent=e;this.g="p"+xl++;e&&(this.h=e.children.length,e.children.push(this))}yl.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};yl.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function zl(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
...
function Cl(a,b){this.e=b;var c=this;fc.call(this,a,function(a,b){var f=a.match(/^([^.]+)\.([^.]+)$/);if(f){var g=c.e.j[f[1]];if(g&&(g=this.ma[g])){if(b){var f=f[2],h=g.aa[f];if(h)g=h;else{switch(f){case "columns":var h=g.d.d,l=new Wc(h,0),k=Dl(g,"column-count"),m=Dl(g,"column-width"),p=Dl(g,"column-gap"),h=E(h,Yc(h,new Tc(h,"min",[l,k]),D(h,m,p)),p)}h&&(g.aa[f]=h);g=h}}else g=Dl(g,f[2]);return g}}return null})}u(Cl,fc);
function El(a,b,c,d,e,f,g){a=a instanceof Cl?a:new Cl(a,this);yl.call(this,a,b,c,d,e);this.e=this;this.L=f;this.O=g;this.b.width=new U(ke,0);this.b.height=new U(le,0);this.b["wrap-flow"]=new U(ud,0);this.b.position=new U(Wd,0);this.b.overflow=new U(he,0);this.j={}}u(El,yl);El.prototype.f=function(a){return new Fl(a,this)};El.prototype.clone=function(a){a=new El(this.d,this.name,a.qb||this.qb,this.Aa,this.parent,this.L,this.O);zl(this,a);Al(this,a);return a};
function Gl(a,b,c,d,e){yl.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.j[b]=this.g);this.b["wrap-flow"]=new U(ud,0)}u(Gl,yl);Gl.prototype.f=function(a){return new Hl(a,this)};Gl.prototype.clone=function(a){a=new Gl(a.parent.d,this.name,this.qb,this.Aa,a.parent);zl(this,a);Al(this,a);return a};function Il(a,b,c,d,e){yl.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.j[b]=this.g)}u(Il,yl);Il.prototype.f=function(a){return new Jl(a,this)};
Il.prototype.clone=function(a){a=new Il(a.parent.d,this.name,this.qb,this.Aa,a.parent);zl(this,a);Al(this,a);return a};function W(a,b,c){return b&&b!==ud?b.ia(a,c):null}function Kl(a,b,c){return b&&b!==ud?b.ia(a,c):a.b}function Ll(a,b,c){return b?b===ud?null:b.ia(a,c):a.b}function Ml(a,b,c,d){return b&&c!==Rd?b.ia(a,d):a.b}function Nl(a,b,c){return b?b===ie?a.g:b===Dd?a.f:b.ia(a,a.b):c}
function Ol(a,b){this.e=a;this.d=b;this.D={};this.style={};this.k=this.l=null;this.children=[];this.F=this.G=this.f=this.g=!1;this.w=this.B=0;this.u=null;this.la={};this.aa={};this.na=this.b=!1;a&&a.children.push(this)}function Pl(a){a.B=0;a.w=0}function Ql(a,b,c){b=Dl(a,b);c=Dl(a,c);if(!b||!c)throw Error("E_INTERNAL");return D(a.d.d,b,c)}
...
function Yl(a,b,c){var d=X(a,b,"left"),e=X(a,b,"margin-left"),f=X(a,b,"padding-left"),g=X(a,b,"border-left-width");a=X(a,b,"width");Ci(c,d,a);w(c.d,"margin-left",e+"px");w(c.d,"padding-left",f+"px");w(c.d,"border-left-width",g+"px");c.marginLeft=e;c.W=g;c.j=f}
...
function im(a){var b=a.d.getBoundingClientRect();a.top=b.top-a.marginTop;a.left=b.left-a.marginLeft;b=a.d.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.k+"px";b.style.bottom=a.u+"px";b.style.left=a.j+"px";b.style.right=a.w+"px";a.d.appendChild(b);var c=b.getBoundingClientRect();a.d.removeChild(b);a.width=c.width;a.height=c.height}
Ol.prototype.pb=function(a,b,c,d){this.e&&this.b==this.e.b||w(b.d,"writing-mode",this.b?"vertical-rl":"horizontal-tb");(this.b?this.g:this.f)?this.b?dm(this,a,b):cm(this,a,b):(this.b?Zl(this,a,b):$l(this,a,b),this.b?Yl(this,a,b):am(this,a,b));(this.b?this.f:this.g)?this.b?cm(this,a,b):dm(this,a,b):bm(this,a,b);for(c=0;c<em.length;c++)Xl(this,a,b,em[c],d);im(b)};function jm(a,b,c,d){for(var e=0;e<gm.length;e++)Xl(a,b,c,gm[e],d)}
Ol.prototype.oc=function(a,b,c,d,e,f,g){this.b?this.B=b.e+b.xb:this.w=b.e+b.na;f=(this.b||!d)&&this.f;var h=(!this.b||!d)&&this.g,l=null;if(h||f)h&&w(b.d,"width","auto"),f&&w(b.d,"height","auto"),l=(d?d.d:b.d).getBoundingClientRect(),h&&(this.B=Math.ceil(l.right-l.left-b.j-b.W-b.w-b.Ma),this.b&&(this.B+=b.xb)),f&&(this.w=l.bottom-l.top-b.k-b.aa-b.u-b.Fa,this.b||(this.w+=b.na));(this.b?this.f:this.g)&&bm(this,a,b);if(this.b?this.g:this.f){if(this.b?this.F:this.G)this.b?Zl(this,a,b):$l(this,a,b);this.b?
...
t+"px");w(q,p,f+"px "+h.toString()+(l?" "+l.toString():""));b.d.insertBefore(q,b.d.firstChild)}}for(d=0;d<fm.length;d++)Xl(this,a,b,fm[d],g);for(d=0;d<hm.length;d++)e=b,g=hm[d],f=c.h,(h=Wl(this,a,g))&&f.push(new Uh(e.d,g,h));im(b)};
...
function km(a,b){a.g&&(a.F=Tl(a,"right",a.l,b)||Tl(a,"margin-right",a.l,b)||Tl(a,"border-right-width",a.l,b)||Tl(a,"padding-right",a.l,b));a.f&&(a.G=Tl(a,"top",a.k,b)||Tl(a,"margin-top",a.k,b)||Tl(a,"border-top-width",a.k,b)||Tl(a,"padding-top",a.k,b));for(var c=0;c<a.children.length;c++)km(a.children[c],b)}function lm(a){Ol.call(this,null,a)}u(lm,Ol);lm.prototype.h=function(a,b){Ol.prototype.h.call(this,a,b);this.children.sort(function(a,b){return b.d.O-a.d.O||a.d.h-b.d.h})};
function Fl(a,b){Ol.call(this,a,b);this.u=this}u(Fl,Ol);Fl.prototype.N=function(a){var b=this.d.e;b.L&&(a=Xc(b.d,a,b.L));return a};Fl.prototype.W=function(){};function Hl(a,b){Ol.call(this,a,b);this.u=a.u}u(Hl,Ol);function Jl(a,b){Ol.call(this,a,b);this.u=a.u}u(Jl,Ol);function mm(a,b,c,d){var e=null;c instanceof kd&&(e=[c]);c instanceof dd&&(e=c.values);if(e)for(a=a.d.d,c=0;c<e.length;c++)if(e[c]instanceof kd){var f=cc(e[c].name,"enabled"),f=new Rc(a,f);d&&(f=new zc(a,f));b=Xc(a,b,f)}return b}
Jl.prototype.N=function(a){var b=this.d.d,c=this.style,d=Nl(b,c.required,b.f)!==b.f;if(d||this.f){var e;e=(e=c["flow-from"])?e.ia(b,b.b):new gc(b,"body");e=new Tc(b,"has-content",[e]);a=Xc(b,a,e)}a=mm(this,a,c["required-partitions"],!1);a=mm(this,a,c["conflicting-partitions"],!0);d&&(c=(c=this.u.style.enabled)?c.ia(b,null):b.g,c=Xc(b,c,a),this.u.style.enabled=new J(c));return a};Jl.prototype.pb=function(a,b,c,d,e){w(b.d,"overflow","hidden");Ol.prototype.pb.call(this,a,b,c,d,e)};
function nm(a,b,c,d){Ff.call(this,a,b,!1);this.target=c;this.b=d}u(nm,Gf);nm.prototype.bb=function(a,b,c){fh(this.b,a,b,c,this)};nm.prototype.Cc=function(a,b){Hf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};nm.prototype.Ub=function(a,b){Hf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};nm.prototype.cb=function(a,b,c){this.target.b[a]=new U(b,c?50331648:67108864)};function om(a,b,c,d){nm.call(this,a,b,c,d)}u(om,nm);
function pm(a,b,c,d){nm.call(this,a,b,c,d);c.b.width=new U(je,0);c.b.height=new U(je,0)}u(pm,nm);pm.prototype.cc=function(a,b,c){a=new Il(this.d,a,b,c,this.target);Ef(this.Z,new om(this.d,this.Z,a,this.b))};pm.prototype.bc=function(a,b,c){a=new Gl(this.d,a,b,c,this.target);a=new pm(this.d,this.Z,a,this.b);Ef(this.Z,a)};function qm(a,b,c,d){nm.call(this,a,b,c,d)}u(qm,nm);qm.prototype.cc=function(a,b,c){a=new Il(this.d,a,b,c,this.target);Ef(this.Z,new om(this.d,this.Z,a,this.b))};
qm.prototype.bc=function(a,b,c){a=new Gl(this.d,a,b,c,this.target);a=new pm(this.d,this.Z,a,this.b);Ef(this.Z,a)};var rm={"text-indent":"0px","margin-top":"0px","padding-top":"0px","border-top-width":"0px","border-top-style":"none","border-top-color":"transparent"},sm={"text-indent":"0px","margin-right":"0px","padding-right":"0px","border-right-width":"0px","border-right-style":"none","border-right-color":"transparent"},tm={"margin-top":"0px"},um={"margin-right":"0px"},vm={};
function wm(a){a.addEventListener("load",function(){a.contentWindow.navigator.epubReadingSystem={name:"adapt",version:"0.1",layoutStyle:"paginated",hasFeature:function(a){switch(a){case "mouse-events":return!0}return!1}}},!1)}var xm=(new DOMParser).parseFromString('<root xmlns="http://www.pyroxy.com/ns/shadow"/>',"text/xml"),ym="footnote-marker first-5-lines first-4-lines first-3-lines first-2-lines first-line first-letter before  after".split(" ");
function zm(a){return a.getAttribute("data-adapt-pseudo")||""}function Am(a,b,c,d){this.style=b;this.f=a;this.b=c;this.d=d;this.e={}}
Am.prototype.h=function(a){var b=zm(a);this.b&&b&&b.match(/after$/)&&(this.style=this.b.h(this.f,!0),this.b=null);var c=this.style._pseudos[b]||{};if(!this.e[b]){this.e[b]=!0;var d=c.content;d&&(d=d.evaluate(this.d),Ei(d)&&d.T(new Di(a,this.d)))}if(b.match(/^first-/)&&!c["x-first-pseudo"]){a=1;var e;"first-letter"==b?a=0:null!=(e=b.match(/^first-([0-9]+)-lines$/))&&(a=e[1]-0);c["x-first-pseudo"]=new U(new md(a),0)}return c};
function Bm(a,b,c,d,e,f,g,h,l,k,m,p,r){this.w=a;this.d=b;this.viewport=c;this.l=c.b;this.j=d;this.D=e;this.ba=f;this.B=g;this.k=h;this.F=l;this.e=k;this.g=m;this.u=p;this.f=r;this.G=this.b=null;this.h=!1;this.Y=null;this.da=0;this.A=null}Bm.prototype.clone=function(){return new Bm(this.w,this.d,this.viewport,this.j,this.D,this.ba,this.B,this.k,this.F,this.e,this.g,this.u,this.f)};
function Cm(a,b,c,d,e,f){var g=K("createRefShadow");a.ba.j.load(b).then(function(h){if(h){var l=Ch(h,b);if(l){var k=a.F,m=k.B[h.url];if(!m){var m=k.style.h.b[h.url],p=new nc(0,k.ob(),k.nb(),k.h),m=new il(h,m.d,m.g,p,k.f,m.j,k.l);k.B[h.url]=m}f=new hi(d,l,h,e,f,c,m)}}O(g,f)});return N(g)}
function Dm(a,b,c,d,e,f,g,h){var l=K("createShadows"),k=e.template,m;k instanceof od?m=Cm(a,k.url,2,b,h,null):m=M(null);m.then(function(k){var m=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var t=b.getAttribute("href"),q=null;t?q=h?h.ba:a.ba:h&&(t="http://www.w3.org/1999/xhtml"==h.Z.namespaceURI?h.Z.getAttribute("href"):h.Z.getAttributeNS("http://www.w3.org/1999/xlink","href"),q=h.Yc?h.Yc.ba:a.ba);t&&(t=va(t,q.url),m=Cm(a,t,3,b,h,k))}null==m&&(m=M(k));m.then(function(k){var m=
d._pseudos;if(m){for(var p=[],r=xm.createElementNS("http://www.pyroxy.com/ns/shadow","root"),t=r,q=0;q<ym.length;q++){var sa=ym[q],Fa;if(sa){if(!m[sa])continue;if(!("footnote-marker"!=sa||c&&a.h))continue;if(sa.match(/^first-/)&&(Fa=e.display,!Fa||Fa===Jd))continue;if("before"===sa||"after"===sa)if(Fa=m[sa].content,!Fa||Fa===Sd||Fa===Rd)continue;p.push(sa);Fa=xm.createElementNS("http://www.w3.org/1999/xhtml","span");Fa.setAttribute("data-adapt-pseudo",sa)}else Fa=xm.createElementNS("http://www.pyroxy.com/ns/shadow",
"content");t.appendChild(Fa);sa.match(/^first-/)&&(t=Fa)}k=p.length?new hi(b,r,null,h,k,2,new Am(b,d,f,g)):k}O(l,k)})});return N(l)}function Em(a,b,c){a.G=b;a.h=c}function Fm(a,b,c,d){var e=a.d;c=Ok(c,e,a.D,a.h);b=Nk(c,e,b);Pk(c,d,b,function(b,c){var d=c.evaluate(e,b);"font-family"==b&&(d=oh(a.B,d));return d});var f=Gi(d.display||Jd,d.position,d["float"],a.Y===a.ba.root);["display","position","float"].forEach(function(a){f[a]&&(d[a]=f[a])});return b}
function Gm(a,b){for(var c=a.b.Y,d=[],e=a.b.ea,f=-1;c&&1==c.nodeType;){var g=e&&e.root==c;if(!g||2==e.type){var h=(e?e.b:a.j).h(c,!1);d.push(h)}g?(c=e.Z,e=e.Yc):(c=c.parentNode,f++)}c=pc(a.d,"em",0===f);c={"font-size":new U(new I(c,"px"),0)};e=new mj(c,a.d);for(f=d.length-1;0<=f;--f){var g=d[f],h=[],l;for(l in g)Ti[l]&&h.push(l);h.sort(oe);for(var k=0;k<h.length;k++){var m=h[k];e.b=m;c[m]=g[m].nc(e)}}for(var p in b)Ti[p]||(c[p]=b[p]);return c}
...
function Jm(a,b,c){var d=!0,e=K("createElementView"),f=a.Y,g=a.b.ea?a.b.ea.b:a.j,h=g.h(f,!1),l={};a.b.parent||(h=Gm(a,h));a.b.f=Fm(a,a.b.f,h,l);l.direction&&(a.b.N=l.direction.toString());var k=l["flow-into"];if(k&&k.toString()!=a.w)return O(e,!1),N(e);var m=l.display;if(m===Rd)return O(e,!1),N(e);a.b.B=m===Fd;Dm(a,f,null==a.b.parent,h,l,g,a.d,a.b.ea).then(function(g){a.b.ya=g;var h=l.position;g=l["float-reference"];var k=l["float"],q=l.clear;a.b.G=Hi(m,h,k,l.overflow);a.b.F=h===Wd||h===rd||h===Ed;
...
F||"li"==F?F="div":"q"==F?F="span":"a"==F&&(g=l["hyperlink-processing"])&&"normal"!=g.toString()&&(F="span");l.behavior&&"none"!=l.behavior.toString()&&a.g&&(L=!0);f.dataset&&"true"==f.dataset.mathTypeset&&(L=!0);var sa;L?sa=a.g(f,a.b.parent?a.b.parent.A:null,l):sa=M(null);sa.then(function(g){g?L&&(d="true"==g.getAttribute("data-adapt-process-children")):g=a.createElement(Y,F);"a"==F&&g.addEventListener("click",a.e.D,!1);Q&&(Km(a,a.b,"inner",Q),g.appendChild(Q));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==
g.namespaceURI&&wm(g);if("http://www.gribuser.ru/xml/fictionbook/2.0"!=f.namespaceURI||"td"==F){for(var h=f.attributes,k=h.length,m=null,p=0;p<k;p++){var r=h[p],q=r.namespaceURI,t=r.localName,r=r.nodeValue;if(q)if("http://www.w3.org/2000/xmlns/"==q)continue;else"http://www.w3.org/1999/xlink"==q&&"href"==t&&(r=Im(a,r));else{if(t.match(/^on/))continue;if("style"==t)continue;if("id"==t){$h(a.e,g,r);continue}"src"==t||"href"==t||"poster"==t?r=Im(a,r):"srcset"==t&&(r=r.split(",").map(function(b){return Im(a,
b.trim())}).join(","))}if(q){var sa=vm[q];sa&&(t=sa+":"+t)}"src"!=t||q||"img"!=F||"http://www.w3.org/1999/xhtml"!=Y?"href"==t&&"image"==F&&"http://www.w3.org/2000/svg"==Y&&"http://www.w3.org/1999/xlink"==q?a.e.f.push(ug(g,r)):q?g.setAttributeNS(q,t,r):g.setAttribute(t,r):m=r}m&&(h=ug(g,m),k=l.width,m=l.height,k&&k!==ud&&m&&m!==ud?a.e.f.push(h):qa.push(h))}delete l.content;(h=l["list-style-image"])&&h instanceof od&&(h=h.url,qa.push(ug(new Image,h)));Lm(a,g,l);h=l.widows;k=l.orphans;if(h||k){if(a.b.parent){a.b.k=
{};for(var ec in a.b.parent.k)a.b.k[ec]=a.b.parent.k[ec]}h instanceof md&&(a.b.k.widows=h.C);k instanceof md&&(a.b.k.orphans=k.C)}if(!a.b.b&&(ec=null,b?c&&(ec=a.b.f?um:tm):ec=a.b.f?sm:rm,ec))for(var pl in ec)w(g,pl,ec[pl]);y&&g.setAttribute("value",l["ua-list-item-count"].stringValue());a.A=g;qa.length?tg(qa).then(function(){O(e,d)}):mf().then(function(){O(e,d)})})});return N(e)}
function Mm(a,b,c){var d=K("createNodeView"),e=!0;1==a.Y.nodeType?b=Jm(a,b,c):(8==a.Y.nodeType?a.A=null:a.A=document.createTextNode(a.Y.textContent.substr(a.da||0)),b=M(!0));b.then(function(b){e=b;(a.b.A=a.A)&&(b=a.b.parent?a.b.parent.A:a.G)&&b.appendChild(a.A);O(d,e)});return N(d)}function Nm(a,b,c,d){(a.b=b)?(a.Y=b.Y,a.da=b.da):(a.Y=null,a.da=-1);a.A=null;return a.b?Mm(a,c,!!d):M(!0)}
function Om(a){if(null==a.ea||"content"!=a.Y.localName||"http://www.pyroxy.com/ns/shadow"!=a.Y.namespaceURI)return a;var b=a.ga,c=a.ea,d=a.parent,e,f;c.ud?(f=c.ud,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.Yc,e=c.Z.firstChild,c=2);var g=a.Y.nextSibling;g?(a.Y=g,ki(a)):a.sa?a=a.sa:e?a=null:(a=a.parent.modify(),a.M=!0);if(e)return b=new ji(e,d,b),b.ea=f,b.Ra=c,b.sa=a,b;a.ga=b;return a}
function Pm(a){var b=a.ga+1;if(a.M){if(!a.parent)return null;if(3!=a.Ra){var c=a.Y.nextSibling;if(c)return a=a.modify(),a.ga=b,a.Y=c,ki(a),Om(a)}if(a.sa)return a=a.sa.modify(),a.ga=b,a;a=a.parent.modify()}else{if(a.ya&&(c=a.ya.root,2==a.ya.type&&(c=c.firstChild),c))return b=new ji(c,a,b),b.ea=a.ya,b.Ra=a.ya.type,Om(b);if(c=a.Y.firstChild)return Om(new ji(c,a,b));1!=a.Y.nodeType&&(b+=a.Y.textContent.length-1-a.da);a=a.modify()}a.ga=b;a.M=!0;return a}
function Qm(a,b,c){b=Pm(b);if(!b||b.M)return M(b);var d=K("nextInTree");Nm(a,b,!0,c).then(function(a){b.A&&a||(b=b.modify(),b.M=!0,b.A||(b.b=!0));O(d,b)});return N(d)}function Rm(a,b){if(b instanceof dd)for(var c=b.values,d=0;d<c.length;d++)Rm(a,c[d]);else b instanceof od&&(c=b.url,a.e.f.push(ug(new Image,c)))}var Sm={"box-decoration-break":!0,"flow-into":!0,"flow-linger":!0,"flow-priority":!0,"flow-options":!0,page:!0,"float-reference":!0};
function Lm(a,b,c){var d=c["background-image"];d&&Rm(a,d);var d=c.position===Wd,e;for(e in c)if(!Sm[e]){var f=c[e];Sh[e]||d&&Th[e]?a.e.h.push(new Uh(b,e,f)):(f.Vb()&&mc(f.fa)&&(f=new I(qd(f,a.d),"px")),w(b,e,f.toString()))}}function Km(a,b,c,d){if(!b.M){var e=(b.ea?b.ea.b:a.j).h(a.Y,!1);if(e=e._pseudos)if(e=e[c])c={},b.f=Fm(a,b.f,e,c),b=c.content,Ei(b)&&(b.T(new Di(d,a.d)),delete c.content),Lm(a,d,c)}}
function Tm(a,b,c){var d=K("peelOff"),e=b.d,f=b.da,g=b.M;if(0<c)b.A.textContent=b.A.textContent.substr(0,c),f+=c;else if(!g&&b.A&&0==f){var h=b.A.parentNode;h&&h.removeChild(b.A)}for(var l=b.ga+c,k=[];b.d===e;)k.push(b),b=b.parent;var m=k.pop(),p=m.sa;nf(function(){for(;0<k.length;){m=k.pop();b=new ji(m.Y,b,l);0==k.length&&(b.da=f,b.M=g);b.Ra=m.Ra;b.ea=m.ea;b.ya=m.ya;b.sa=m.sa?m.sa:p;p=null;var c=Nm(a,b,!1);if(c.Ca())return c}return M(!1)}).then(function(){O(d,b)});return N(d)}
...
l.bottom&&1>Math.abs(g.right-l.right)){b.push({top:g.top,left:l.left,bottom:l.bottom,right:l.right});break}}h==d.length&&(v.b("Could not fix character box"),b.push(g))}a=b}for(b=d=0;b<a.length;b++)f=a[b],g=c?f.bottom-f.top:f.right-f.left,f.right>f.left&&f.bottom>f.top&&(isNaN(e)||g>d)&&(e=c?f.left:f.bottom,d=g);return e}function bn(a,b){this.e=a;this.f=b}bn.prototype.d=function(a,b){return b<this.f?null:cn(a,this,0<b)};bn.prototype.b=function(){return this.f};
function dn(a,b,c,d){this.position=a;this.f=b;this.g=c;this.e=d}dn.prototype.d=function(a,b){var c;b<this.b()?c=null:(a.e=this.e,c=this.position);return c};dn.prototype.b=function(){return(Ym[this.f]?1:0)+(this.g?3:0)+(this.position.parent?this.position.parent.h:0)};function en(a,b,c){this.ga=a;this.d=b;this.b=c}
function fn(a){for(var b=1;b<a.length;b++){var c=a[b-1],d=a[b];c===d?v.b("validateCheckPoints: duplicate entry"):c.ga>=d.ga?v.b("validateCheckPoints: incorrect boxOffset"):c.Y==d.Y&&(d.M?c.M&&v.b("validateCheckPoints: duplicate after points"):c.M?v.b("validateCheckPoints: inconsistent after point"):d.ga-c.ga!=d.da-c.da&&v.b("validateCheckPoints: boxOffset inconsistent with offsetInNode"))}}
function gn(a,b,c){vi.call(this,a);this.fd=a.lastChild;this.g=b;this.Ua=c;this.Kd=a.ownerDocument;this.Ec=!1;this.ma=this.Pa=this.ra=this.la=this.N=0;this.ub=this.vb=this.l=this.Na=null;this.gd=!1;this.h=this.f=this.B=null;this.xd=!0;this.Fc=this.Hc=this.Gc=0}u(gn,vi);gn.prototype.clone=function(){var a=new gn(this.d,this.g,this.Ua);Ai(a,this);a.fd=this.fd;a.Ec=this.Ec;a.l=this.l?this.l.clone():null;a.vb=this.vb.concat();return a};function hn(a,b){return a.b?b<a.ma:b>a.ma}
function jn(a,b,c){var d=new ji(b.ha,c,0);d.Ra=b.Ra;d.ea=b.ea;d.ya=b.ya;d.sa=b.sa?jn(a,b.sa,mi(c)):null;return d}function kn(a,b){var c=K("openAllViews"),d=b.ka;Em(a.g,a.d,a.Ec);var e=d.length-1,f=null;nf(function(){for(;0<=e;){f=jn(a,d[e],f);if(0==e&&(f.da=b.da,f.M=b.M,f.M))break;var c=Nm(a.g,f,0==e&&0==f.da);e--;if(c.Ca())return c}return M(!1)}).then(function(){O(c,f)});return N(c)}var ln=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
function mn(a,b){if(b.d&&b.b&&!b.M&&0==b.d.count&&1!=b.A.nodeType){var c=b.A.textContent.match(ln);return Tm(a.g,b,c[0].length)}return M(b)}function nn(a,b,c){var d=K("buildViewToNextBlockEdge");of(function(d){b.A&&c.push(mi(b));mn(a,b).then(function(f){f!==b&&(b=f,c.push(mi(b)));Qm(a.g,b).then(function(c){(b=c)?b.j&&!a.b?on(a,b).then(function(c){b=c;!b||b.e||0<a.g.f.b.length?P(d):qf(d)}):b.b?qf(d):P(d):P(d)})})}).then(function(){O(d,b)});return N(d)}
function pn(a,b){if(!b.A)return M(b);var c=b.Y,d=K("buildDeepElementView");of(function(d){mn(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.Y!=c;)g=g.parent;if(null==g){b=f;P(d);return}}Qm(a.g,f).then(function(a){(b=a)&&b.Y!=c?qf(d):P(d)})})}).then(function(){O(d,b)});return N(d)}function qn(a,b,c,d,e){var f=a.Kd.createElement("div");a.b?(w(f,"height",d+"px"),w(f,"width",e+"px")):(w(f,"width",d+"px"),w(f,"height",e+"px"));w(f,"float",c);w(f,"clear",c);a.d.insertBefore(f,b);return f}
function rn(a){for(var b=a.d.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.d.removeChild(b);else break}b=c}}function sn(a){for(var b=a.d.firstChild,c=a.ub,d=a.b?a.b?a.N:a.ra:a.b?a.Pa:a.N,e=a.b?a.b?a.la:a.Pa:a.b?a.ra:a.la,f=0;f<c.length;f++){var g=c[f],h=g.Q-g.V;g.left=qn(a,b,"left",g.$-d,h);g.right=qn(a,b,"right",e-g.U,h)}}
function tn(a,b,c,d,e){var f;if(b&&b.M&&!b.b&&(f=an(b,0,a.b),!isNaN(f)))return f;b=c[d];for(e-=b.ga;;){f=an(b,e,a.b);if(!isNaN(f))return f;if(0<e)e--;else{d--;if(0>d)return a.ra;b=c[d];1!=b.A.nodeType&&(e=b.A.textContent.length)}}}function Z(a){return"number"==typeof a?a:(a=a.match(/^(-?[0-9]*(\.[0-9]*)?)px$/))?parseFloat(a[0]):0}
function un(a,b){var c=a.Ua.b.getComputedStyle(b,null),d=new re;c&&(d.left=Z(c.marginLeft),d.top=Z(c.marginTop),d.right=Z(c.marginRight),d.bottom=Z(c.marginBottom));return d}
function vn(a,b){var c=a.Ua.b.getComputedStyle(b,null),d=new re;if(c){if("border-box"==c.boxSizing)return un(a,b);d.left=Z(c.marginLeft)+Z(c.borderLeftWidth)+Z(c.paddingLeft);d.top=Z(c.marginTop)+Z(c.borderTopWidth)+Z(c.paddingTop);d.right=Z(c.marginRight)+Z(c.borderRightWidth)+Z(c.paddingRight);d.bottom=Z(c.marginBottom)+Z(c.borderBottomWidth)+Z(c.paddingBottom)}return d}
function wn(a,b,c){if(a=a.Ua.b.getComputedStyle(b,null))c.marginLeft=Z(a.marginLeft),c.W=Z(a.borderLeftWidth),c.j=Z(a.paddingLeft),c.marginTop=Z(a.marginTop),c.aa=Z(a.borderTopWidth),c.k=Z(a.paddingTop),c.marginRight=Z(a.marginRight),c.Ma=Z(a.borderRightWidth),c.w=Z(a.paddingRight),c.marginBottom=Z(a.marginBottom),c.Fa=Z(a.borderBottomWidth),c.u=Z(a.paddingBottom)}function xn(a,b,c){b=new en(b,c,c);a.f?a.f.push(b):a.f=[b]}
function yn(a,b,c,d){if(a.f&&a.f[a.f.length-1].b)return xn(a,b,c),M(!0);d+=40*(a.b?-1:1);var e=a.l,f=!e;if(f){var g=a.d.ownerDocument.createElement("div");w(g,"position","absolute");var h=a.g.clone(),e=new gn(g,h,a.Ua);a.l=e;e.b=Um(a.g,a.b,g);e.Ec=!0;a.b?(e.left=0,w(e.d,"width","2em")):(e.top=a.Pa,w(e.d,"height","2em"))}a.d.appendChild(e.d);wn(a,e.d,e);g=(a.b?-1:1)*(d-a.ra);a.b?e.height=a.Na.Q-a.Na.V-wi(e)-xi(e):e.width=a.Na.U-a.Na.$-yi(e)-zi(e);d=(a.b?-1:1)*(a.Pa-d)-(a.b?yi(e)-zi(e):wi(e)+xi(e));
if(f&&18>d)return a.d.removeChild(e.d),a.l=null,xn(a,b,c),M(!0);if(!a.b&&e.top<g)return a.d.removeChild(e.d),xn(a,b,c),M(!0);var l=K("layoutFootnoteInner");a.b?Ci(e,0,d):Bi(e,g,d);e.D=a.D+a.left+yi(a);e.F=a.F+a.top+wi(a);e.G=a.G;var k=new ri(c);f?(zn(e),f=M(!0)):0==e.G.length?(An(e),f=M(!0)):f=Bn(e);f.then(function(){Cn(e,k).then(function(d){a.b?(a.ma=a.Pa+(e.e+yi(e)+zi(e)),Ci(e,0,e.e)):(a.ma=a.Pa-(e.e+wi(e)+xi(e)),Bi(e,a.ma-a.ra,e.e));var f;!a.b&&0<e.G.length?f=Bn(e):f=M(d);f.then(function(d){d=
new en(b,c,d?d.Xa:null);a.f?a.f.push(d):a.f=[d];O(l,!0)})})});return N(l)}
function Dn(a,b){var c=K("layoutFootnote"),d=b.A;d.setAttribute("style","");w(d,"display","inline-block");d.textContent="M";var e=d.getBoundingClientRect(),f=a.b?e.left:e.bottom;d.textContent="";Km(a.g,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d={ka:[{ha:b.Y,Ra:0,ea:b.ea,ya:null,sa:null}],da:0,M:!1};e=b.ga;b=b.modify();b.M=!0;yn(a,e,d,f).then(function(){a.l&&a.l.d.parentNode&&a.d.removeChild(a.l.d);hn(a,f)&&0!=a.B.length&&(b.e=!0);O(c,b)});return N(c)}
function En(a,b){var c=K("layoutFloat"),d=b.A,e=b.j,f=b.aa,g=b.parent?b.parent.N:"ltr",h=a.g.f,l=b.A.parentNode;"page"===f?Li(h,d,e):(w(d,"float","none"),w(d,"display","inline-block"),w(d,"vertical-align","top"));pn(a,b).then(function(k){var m=d.getBoundingClientRect(),p=un(a,d),m=new pe(m.left-p.left,m.top-p.top,m.right+p.right,m.bottom+p.bottom);if("page"===f)Mi(h,b,a.g)?(m=l.ownerDocument.createElement("span"),w(m,"width","0"),w(m,"height","0"),l.appendChild(m),k.A=m,O(c,k)):Oi(h,b,m).then(function(){O(c,
null)});else{e=Ii(e,a.b,g);for(var r=a.N,t=a.la,p=b.parent;p&&p.b;)p=p.parent;if(p){var q=p.A.ownerDocument.createElement("div");q.style.left="0px";q.style.top="0px";a.b?(q.style.bottom="0px",q.style.width="1px"):(q.style.right="0px",q.style.height="1px");p.A.appendChild(q);var y=q.getBoundingClientRect(),r=Math.max(a.b?y.top:y.left,r),t=Math.min(a.b?y.bottom:y.right,t);p.A.removeChild(q);q=a.b?m.Q-m.V:m.U-m.$;"left"==e?t=Math.max(t,r+q):r=Math.min(r,t-q);p.A.appendChild(b.A)}q=new pe(r,(a.b?-1:1)*
a.ra,t,(a.b?-1:1)*a.Pa);r=m;a.b&&(r=He(m));t=a.b?-1:1;r.V<a.Fc*t&&(y=r.Q-r.V,r.V=a.Fc*t,r.Q=r.V+y);Me(q,a.ub,r,e);a.b&&(m=new pe(-r.Q,r.$,-r.V,r.U));q=vn(a,d);w(d,"width",m.U-m.$-q.left-q.right+"px");w(d,"height",m.Q-m.V-q.top-q.bottom+"px");w(d,"position","absolute");w(d,"display",b.display);t=null;p&&(p.F?t=p:t=qi(p));t?(q=t.A.ownerDocument.createElement("div"),q.style.position="absolute",t.f?q.style.right="0":q.style.left="0",q.style.top="0",t.A.appendChild(q),p=q.getBoundingClientRect(),t.A.removeChild(q)):
p={left:a.b?a.Pa:a.N,right:a.b?a.ra:a.la,top:a.b?a.N:a.ra};(t?t.f:a.b)?w(d,"right",p.right-m.U+a.w+"px"):w(d,"left",m.$-p.left+a.j+"px");w(d,"top",m.V-p.top+a.k+"px");b.u&&(b.u.parentNode.removeChild(b.u),b.u=null);p=a.b?m.$:m.Q;m=a.b?m.U:m.V;hn(a,p)&&0!=a.B.length?(b=b.modify(),b.e=!0,O(c,b)):(rn(a),q=new pe(a.b?a.Pa:a.N,a.b?a.N:a.ra,a.b?a.ra:a.la,a.b?a.la:a.Pa),a.b&&(q=He(q)),Ne(q,a.ub,r,e),sn(a),"left"==e?a.Gc=p:a.Hc=p,a.Fc=m,Fn(a,p),O(c,k))}});return N(c)}
function Gn(a,b){for(var c=a.A,d="";c&&b&&!d&&(1!=c.nodeType||(d=c.style.textAlign,b));c=c.parentNode);if(!b||"justify"==d){var c=a.A,e=c.ownerDocument,d=e.createElement("span");d.style.visibility="hidden";d.textContent=" ########################";d.setAttribute("data-adapt-spec","1");var f=b&&(a.M||1!=c.nodeType)?c.nextSibling:c;if(c=c.parentNode)c.insertBefore(d,f),b||(e=e.createElement("div"),c.insertBefore(e,f),d.style.lineHeight="80px",e.style.marginTop="-80px",e.style.height="0px",e.setAttribute("data-adapt-spec",
"1"))}}function Hn(a,b,c,d){var e=K("processLineStyling");fn(d);var f=d.concat([]);d.splice(0,d.length);var g=0,h=b.d;0==h.count&&(h=h.Ud);of(function(d){if(h){var e=In(a,f),m=h.count-g;if(e.length<=m)P(d);else{var p=Jn(a,f,e[m-1]);Kn(a,p,!1,!1).then(function(){g+=m;Tm(a.g,p,0).then(function(e){b=e;Gn(b,!1);h=b.d;f=[];nn(a,b,f).then(function(b){c=b;0<a.g.f.b.length?P(d):qf(d)})})})}}else P(d)}).then(function(){Array.prototype.push.apply(d,f);fn(d);O(e,c)});return N(e)}
function Ln(a,b){for(var c=0,d=0,e=b.length-1;0<=e;e--){var f=b[e];if(!f.M||!f.A||1!=f.A.nodeType)break;f=un(a,f.A);f=a.b?-f.left:f.bottom;0<f?c=Math.max(c,f):d=Math.min(d,f)}return c-d}
function Mn(a,b){var c=K("layoutBreakableBlock"),d=[];nn(a,b,d).then(function(e){if(0<a.g.f.b.length)O(c,e);else{var f=d.length-1;if(0>f)O(c,e);else{var f=tn(a,e,d,f,d[f].ga),g=hn(a,f);null==e&&(f+=Ln(a,d));Fn(a,f);var h;b.d?h=Hn(a,b,e,d):h=M(e);h.then(function(b){0<d.length&&(a.B.push(new bn(d,d[0].h)),g&&(2!=d.length&&0<a.B.length||d[0].Y!=d[1].Y||!$m[d[0].Y.localName])&&b&&(b=b.modify(),b.e=!0));O(c,b)})}}});return N(c)}
function Jn(a,b,c){fn(b);for(var d=0,e=b[0].ga,f=d,g=b.length-1,h=b[g].ga,l;e<h;){l=e+Math.ceil((h-e)/2);for(var f=d,k=g;f<k;){var m=f+Math.ceil((k-f)/2);b[m].ga>l?k=m-1:f=m}k=tn(a,null,b,f,l);if(a.b?k<c:k>c){for(h=l-1;b[f].ga==l;)f--;g=f}else Fn(a,k),e=l,d=f}a=b[f];b=a.A;1!=b.nodeType&&(a.M?a.da=b.length:(e-=a.ga,c=b.data,173==c.charCodeAt(e)?(b.replaceData(e,c.length-e,"-"),e++):(d=c.charAt(e),e++,f=c.charAt(e),b.replaceData(e,c.length-e,Na(d)&&Na(f)?"-":"")),0<e&&(a=a.modify(),a.da+=e,a.g=null)));
return a}
function In(a,b){for(var c=[],d=b[0].A,e=b[b.length-1].A,f=[],g=d.ownerDocument.createRange(),h=!1,l=null,k=!1,m=!0;m;){var p=!0;do{var r=null;d==e&&(m=!1);1!=d.nodeType?(k||(g.setStartBefore(d),k=!0),l=d):h?h=!1:d.getAttribute("data-adapt-spec")?p=!k:r=d.firstChild;r||(r=d.nextSibling,r||(h=!0,r=d.parentNode));d=r}while(p&&m);if(k){g.setEndAfter(l);k=Wm(g);for(p=0;p<k.length;p++)f.push(k[p]);k=!1}}f.sort(a.b?gi:fi);l=d=h=g=e=0;for(m=a.b?-1:1;;){if(l<f.length&&(k=f[l],p=1,0<d&&(p=Math.max(a.b?k.right-
...
function Nn(a,b){if(!a.f)return M(!0);for(var c=!1,d=a.f.length-1;0<=d;--d){var e=a.f[d];if(e.ga<=b)break;a.f.pop();e.b!==e.d&&(c=!0)}if(!c)return M(!0);var f=K("clearFootnotes"),g=a.e+a.ra,h=a.f;a.l=null;a.f=null;var l=0;nf(function(){for(;l<h.length;){var b=h[l++],b=yn(a,b.ga,b.d,g);if(b.Ca())return b}return M(!1)}).then(function(){O(f,!0)});return N(f)}
function cn(a,b,c){var d=b.e,e;if(c)e=c=1;else{for(e=d[0];e.parent&&e.b;)e=e.parent;c=Math.max((e.k.widows||2)-0,1);e=Math.max((e.k.orphans||2)-0,1)}var f=In(a,d),g=a.ma,d=Qa(f.length,function(b){return a.b?f[b]<g:f[b]>g}),d=Math.min(f.length-c,d);if(d<e)return null;g=f[d-1];if(b=Jn(a,b.e,g))a.e=(a.b?-1:1)*(g-a.ra);return b}
function Kn(a,b,c,d){var e=b;c=c||null!=b.A&&1==b.A.nodeType&&!b.M;do{var f=e.A.parentNode;if(!f)break;var g=f,h=e.A;if(g)for(var l=void 0;(l=g.lastChild)!=h;)g.removeChild(l);c&&(f.removeChild(e.A),c=!1);e=e.parent}while(e);d&&Gn(b,!0);return Nn(a,b.ga)}
function On(a,b,c){var d=K("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,h=a.B.length-1;0<=h&&!e;--h){var e=a.B[h].d(a,f),l=a.B[h].b();l>f&&(g=Math.min(g,l))}while(g>f&&!e);var k=!1;if(!e){v.b("Could not find any page breaks?!!");if(a.xd)return Pn(a,b).then(function(b){b?(b=b.modify(),b.e=!1,Kn(a,b,k,!0).then(function(){O(d,b)})):O(d,b)}),N(d);e=c;k=!0}Kn(a,e,k,!0).then(function(){O(d,e)});return N(d)}
function Qn(a){a=a.toString();return""==a||"auto"==a||!!a.match(/^0+(.0*)?[^0-9]/)}function Rn(a,b,c,d,e){if(!b)return!1;var f=an(b,0,a.b),g=hn(a,f);c&&(f+=Ln(a,c));Fn(a,f);if(d||!g)b=new dn(mi(b),e,g,a.e),a.B.push(b);return g}
function Sn(a,b){if(b.A.parentNode){var c=un(a,b.A),d=b.A.ownerDocument.createElement("div");a.b?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.A.parentNode.insertBefore(d,b.A);var e=d.getBoundingClientRect(),e=a.b?e.right:e.top,f=a.b?-1:1,g;switch(b.l){case "left":g=a.Gc;break;case "right":g=a.Hc;break;default:g=f*Math.max(a.Hc*f,a.Gc*f)}e*f>=g*f?b.A.parentNode.removeChild(d):(e=Math.max(1,(g-e)*
...
function Tn(a,b,c){function d(){b=k[0]||b;b.A.parentNode.removeChild(b.A);e.h=h}var e=a,f=K("skipEdges"),g=c&&b&&b.M,h=null,l=null,k=[],m=[],p=!1;of(function(a){for(;b;){do if(b.A){if(b.b&&1!=b.A.nodeType){if(bi(b.A,b.w))break;if(!b.M){!c&&cl[h]?d():Rn(e,l,null,!0,h)?(b=(l||b).modify(),b.e=!0):(b=b.modify(),b.g=h);P(a);return}}if(!b.M&&(b.l&&Sn(e,b),b.j||b.B)){k.push(mi(b));h=al(h,b.g);!c&&cl[h]?d():Rn(e,l,null,!0,h)&&(b=(l||b).modify(),b.e=!0);P(a);return}if(1==b.A.nodeType){var f=b.A.style;if(b.M){if(p){if(!c&&
cl[h]){d();P(a);return}k=[];g=c=!1;h=null}p=!1;l=mi(b);m.push(l);h=al(h,b.D);if(f&&(!Qn(f.paddingBottom)||!Qn(f.borderBottomWidth))){if(Rn(e,l,null,!0,h)){b=(l||b).modify();b.e=!0;P(a);return}m=[l];l=null}}else{k.push(mi(b));h=al(h,b.g);if($m[b.A.localName]){!c&&cl[h]?d():Rn(e,l,null,!0,h)&&(b=(l||b).modify(),b.e=!0);P(a);return}!f||Qn(f.paddingTop)&&Qn(f.borderTopWidth)||(g=!1,m=[]);p=!0}}}while(0);f=Qm(e.g,b,g);if(f.Ca()){f.then(function(c){b=c;qf(a)});return}b=f.jc()}Rn(e,l,m,!1,h)?l&&(b=l.modify(),
b.e=!0):cl[h]&&(e.h=h);P(a)}).then(function(){O(f,b)});return N(f)}
function Pn(a,b){var c=mi(b),d=K("skipEdges"),e=null,f=!1;of(function(d){for(;b;){do if(b.A){if(b.b&&1!=b.A.nodeType){if(bi(b.A,b.w))break;if(!b.M){cl[e]&&(a.h=e);P(d);return}}if(!b.M&&(b.j||b.B)){e=al(e,b.g);cl[e]&&(a.h=e);P(d);return}if(1==b.A.nodeType){var h=b.A.style;if(b.M){if(f){if(cl[e]){a.h=e;P(d);return}e=null}f=!1;e=al(e,b.D)}else{e=al(e,b.g);if($m[b.A.localName]){cl[e]&&(a.h=e);P(d);return}if(h&&(!Qn(h.paddingTop)||!Qn(h.borderTopWidth))){P(d);return}}f=!0}}while(0);h=Qm(a.g,b);if(h.Ca()){h.then(function(a){b=
a;qf(d)});return}b=h.jc()}c=null;P(d)}).then(function(){O(d,c)});return N(d)}function on(a,b){return"footnote"==b.j?Dn(a,b):En(a,b)}function Un(a,b,c){var d=K("layoutNext");Tn(a,b,c).then(function(c){b=c;if(!b||a.h||b.e)O(d,b);else if(b.j)on(a,b).ta(d);else{a:if(b.M)c=!0;else{switch(b.Y.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!b.B}c?Mn(a,b).ta(d):pn(a,b).ta(d)}});return N(d)}
...
d=a.F+a.top+wi(a);b=a.wb?xe(a.wb,b,d):ze(b,d,b+a.width,d+a.height);a.ub=Je(c,[b],a.G,a.Oa,a.b);sn(a);a.f=null}function zn(a){a.vb=[];w(a.d,"width",a.width+"px");w(a.d,"height",a.height+"px");An(a);a.e=0;a.gd=!1;a.h=null}function Fn(a,b){a.e=Math.max((a.b?-1:1)*(b-a.ra),a.e)}function Vn(a,b){var c=b.b;if(!c)return M(!0);var d=K("layoutOverflownFootnotes"),e=0;nf(function(){for(;e<c.length;){var b=c[e++],b=yn(a,0,b,a.ra);if(b.Ca())return b}return M(!1)}).then(function(){O(d,!0)});return N(d)}
function Cn(a,b,c){a.vb.push(b);if(a.gd)return M(b);var d=K("layout");Vn(a,b).then(function(){kn(a,b.Xa).then(function(b){var f=b;a.B=[];of(function(d){for(;b;){var h=!0;Un(a,b,c).then(function(l){c=!1;b=l;0<a.g.f.b.length?P(d):a.h?P(d):b&&b.e?On(a,b,f).then(function(a){b=a;P(d)}):h?h=!1:qf(d)});if(h){h=!1;return}}P(d)}).then(function(){var c=a.l;c&&(a.d.appendChild(c.d),a.b?a.e=this.ra-this.Pa:a.e=c.top+wi(c)+c.e+xi(c));if(b)if(0<a.g.f.b.length)O(d,null);else{a.gd=!0;c=new ri(oi(b));if(a.f){for(var f=
[],l=0;l<a.f.length;l++){var k=a.f[l].b;k&&f.push(k)}c.b=f.length?f:null}O(d,c)}else O(d,null)})})});return N(d)}function Bn(a){for(var b=a.vb,c=a.d.lastChild;c!=a.fd;){var d=c.previousSibling;a.d===c.parentNode&&zm(c)||a.d.removeChild(c);c=d}rn(a);zn(a);var e=K("redoLayout"),f=0,g=null,h=!0;of(function(c){if(f<b.length){var d=b[f++];Cn(a,d,h).then(function(a){h=!1;a?(g=a,P(c)):qf(c)})}else P(c)}).then(function(){O(e,g)});return N(e)};function Wn(a,b){this.e(a,"end",b)}function Xn(a,b){this.e(a,"start",b)}function Yn(a,b,c){c||(c=this.g.now());var d=this.f[a];d||(d=this.f[a]=[]);var e;for(a=d.length-1;0<=a&&(!(e=d[a])||e[b]);a--)e=null;e||(e={},d.push(e));e[b]=c}function Zn(){}function $n(a){this.g=a;this.f={};this.registerEndTiming=this.d=this.registerStartTiming=this.b=this.e=Zn}
$n.prototype.h=function(){var a=this.f,b="";Object.keys(a).forEach(function(c){for(var d=a[c],e=d.length,f=0;f<e;f++){var g=d[f];b+=c;1<e&&(b+="("+f+")");b+=" => start: "+g.start+", end: "+g.end+", duration: "+(g.end-g.start)+"\n"}});v.e(b)};$n.prototype.j=function(){this.registerEndTiming=this.d=this.registerStartTiming=this.b=this.e=Zn};$n.prototype.k=function(){this.e=Yn;this.registerStartTiming=this.b=Xn;this.registerEndTiming=this.d=Wn};
var ao={now:Date.now},bo,co=bo=new $n(window&&window.performance||ao);Yn.call(co,"load_vivliostyle","start",void 0);ca("vivliostyle.profile.profiler",co);$n.prototype.printTimings=$n.prototype.h;$n.prototype.disable=$n.prototype.j;$n.prototype.enable=$n.prototype.k;function eo(a,b,c){function d(c){return a.b.getComputedStyle(b,null).getPropertyValue(c)}function e(){w(b,"display","block");w(b,"position","static");return d(Q)}function f(){w(b,"display","inline-block");w(q,Q,"99999999px");var a=d(Q);w(q,Q,"");return a}function g(){w(b,"display","inline-block");w(q,Q,"0");var a=d(Q);w(q,Q,"");return a}function h(){var a=e(),b=g(),c=parseFloat(a);if(c<=parseFloat(b))return b;b=f();return c<=parseFloat(b)?a:b}function l(){throw Error("Getting fill-available block size is not implemented");
...
L?g():d(qa);break;case "fit-content width":c=L?d(qa):h();break;case "fit-content height":c=L?h():d(qa)}Y[a]=parseFloat(c);w(b,"position",m);w(b,"display",k)});w(b,"width",p);w(b,"height",r);t.insertBefore(b,q);t.removeChild(q);return Y};function fo(a){var b=a["writing-mode"],b=b&&b.value;a=(a=a.direction)&&a.value;return b===fe||b!==ge&&a!==$d?"ltr":"rtl"}
var go={a5:{width:new I(148,"mm"),height:new I(210,"mm")},a4:{width:new I(210,"mm"),height:new I(297,"mm")},a3:{width:new I(297,"mm"),height:new I(420,"mm")},b5:{width:new I(176,"mm"),height:new I(250,"mm")},b4:{width:new I(250,"mm"),height:new I(353,"mm")},"jis-b5":{width:new I(182,"mm"),height:new I(257,"mm")},"jis-b4":{width:new I(257,"mm"),height:new I(364,"mm")},letter:{width:new I(8.5,"in"),height:new I(11,"in")},legal:{width:new I(8.5,"in"),height:new I(14,"in")},ledger:{width:new I(11,"in"),
height:new I(17,"in")}},ho=new I(.24,"pt"),io=new I(3,"mm"),jo=new I(10,"mm"),ko=new I(13,"mm");
function lo(a){var b={width:ke,height:le,Db:me,yb:me},c=a.size;if(c&&c.value!==ud){var d=c.value;d.Uc()?(c=d.values[0],d=d.values[1]):(c=d,d=null);if(c.Vb())b.width=c,b.height=d||c;else if(c=go[c.name.toLowerCase()])d&&d===Nd?(b.width=c.height,b.height=c.width):(b.width=c.width,b.height=c.height)}(c=a.marks)&&c.value!==Rd&&(b.yb=ko);a=a.bleed;a&&a.value!==ud?a.value&&a.value.Vb()&&(b.Db=a.value):c&&(a=!1,c.value.Uc()?a=c.value.values.some(function(a){return a===Ad}):a=c.value===Ad,a&&(b.Db=new I(6,
"pt")));return b}function mo(a,b){var c={},d=a.Db.C*pc(b,a.Db.fa,!1),e=a.yb.C*pc(b,a.yb.fa,!1),f=d+e,g=a.width;c.ob=g===ke?(b.S.$a?Math.floor(b.Fa/2)-b.S.Ib:b.Fa)-2*f:g.C*pc(b,g.fa,!1);g=a.height;c.nb=g===le?b.Ua-2*f:g.C*pc(b,g.fa,!1);c.Db=d;c.yb=e;c.Mc=f;return c}function no(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}
function oo(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg",c||"polyline");a.setAttribute("stroke","black");a.setAttribute("stroke-width",b);a.setAttribute("fill","none");return a}var po={me:"top left",ne:"top right",de:"bottom left",ee:"bottom right"};
function qo(a,b,c,d,e,f){var g=d;g<=e+2*lc.mm&&(g=e+d/2);var h=Math.max(d,g),l=e+h+c/2,k=no(a,l,l),g=[[0,e+d],[d,e+d],[d,e+d-g]];d=g.map(function(a){return[a[1],a[0]]});if("top right"===b||"bottom right"===b)g=g.map(function(a){return[e+h-a[0],a[1]]}),d=d.map(function(a){return[e+h-a[0],a[1]]});if("bottom left"===b||"bottom right"===b)g=g.map(function(a){return[a[0],e+h-a[1]]}),d=d.map(function(a){return[a[0],e+h-a[1]]});l=oo(a,c);l.setAttribute("points",g.map(function(a){return a.join(",")}).join(" "));
k.appendChild(l);a=oo(a,c);a.setAttribute("points",d.map(function(a){return a.join(",")}).join(" "));k.appendChild(a);b.split(" ").forEach(function(a){k.style[a]=f+"px"});return k}var ro={le:"top",ce:"bottom",Id:"left",Jd:"right"};
function so(a,b,c,d,e){var f=2*d,g;"top"===b||"bottom"===b?(g=f,f=d):g=d;var h=no(a,g,f),l=oo(a,c);l.setAttribute("points","0,"+f/2+" "+g+","+f/2);h.appendChild(l);l=oo(a,c);l.setAttribute("points",g/2+",0 "+g/2+","+f);h.appendChild(l);a=oo(a,c,"circle");a.setAttribute("cx",g/2);a.setAttribute("cy",f/2);a.setAttribute("r",d/4);h.appendChild(a);var k;switch(b){case "top":k="bottom";break;case "bottom":k="top";break;case "left":k="right";break;case "right":k="left"}Object.keys(ro).forEach(function(a){a=
ro[a];a===b?h.style[a]=e+"px":a!==k&&(h.style[a]="0",h.style["margin-"+a]="auto")});return h}function to(a,b,c,d){var e=!1,f=!1;if(a=a.marks)a=a.value,a.Uc()?a.values.forEach(function(a){a===Ad?e=!0:a===Bd&&(f=!0)}):a===Ad?e=!0:a===Bd&&(f=!0);if(e||f){var g=c.I,h=g.ownerDocument,l=b.Db,k=qd(ho,d),m=qd(io,d),p=qd(jo,d);e&&Object.keys(po).forEach(function(a){a=qo(h,po[a],k,p,l,m);g.appendChild(a)});f&&Object.keys(ro).forEach(function(a){a=so(h,ro[a],k,p,m);g.appendChild(a)})}}
var uo=function(){var a={width:!0,height:!0,"block-size":!0,"inline-size":!0,margin:!0,padding:!0,border:!0,outline:!0,"outline-width":!0,"outline-style":!0,"outline-color":!0};"left right top bottom before after start end block-start block-end inline-start inline-end".split(" ").forEach(function(b){a["margin-"+b]=!0;a["padding-"+b]=!0;a["border-"+b+"-width"]=!0;a["border-"+b+"-style"]=!0;a["border-"+b+"-color"]=!0});return a}(),vo={"top-left-corner":{P:1,xa:!0,ua:!1,va:!0,wa:!0,ja:null},"top-left":{P:2,
...
ua:!0,va:!1,wa:!1,ja:"center"},"bottom-left":{P:12,xa:!1,ua:!0,va:!1,wa:!1,ja:"start"},"bottom-left-corner":{P:13,xa:!1,ua:!0,va:!0,wa:!1,ja:null},"left-bottom":{P:14,xa:!1,ua:!1,va:!0,wa:!1,ja:"end"},"left-middle":{P:15,xa:!1,ua:!1,va:!0,wa:!1,ja:"center"},"left-top":{P:16,xa:!1,ua:!1,va:!0,wa:!1,ja:"start"}},wo=Object.keys(vo).sort(function(a,b){return vo[a].P-vo[b].P});
function xo(a,b,c){El.call(this,a,null,"vivliostyle-page-rule-master",[],b,null,0);a=lo(c);new yo(this.d,this,c,a);this.l={};zo(this,c);this.b.position=new U(Wd,0);this.b.width=new U(a.width,0);this.b.height=new U(a.height,0);for(var d in c)uo[d]||"background-clip"===d||(this.b[d]=c[d])}u(xo,El);function zo(a,b){var c=b._marginBoxes;c&&wo.forEach(function(d){c[d]&&(a.l[d]=new Ao(a.d,a,d,b))})}xo.prototype.f=function(a){return new Bo(a,this)};
function yo(a,b,c,d){Il.call(this,a,null,null,[],b);this.u=d;this.b["z-index"]=new U(new md(0),0);this.b["flow-from"]=new U(H("body"),0);this.b.position=new U(rd,0);this.b.overflow=new U(he,0);for(var e in uo)uo.hasOwnProperty(e)&&(this.b[e]=c[e])}u(yo,Il);yo.prototype.f=function(a){return new Co(a,this)};
function Ao(a,b,c,d){Il.call(this,a,null,null,[],b);this.k=c;a=d._marginBoxes[this.k];for(var e in d)if(b=d[e],c=a[e],Ti[e]||c&&c.value===Id)this.b[e]=b;for(e in a)Object.prototype.hasOwnProperty.call(a,e)&&(b=a[e])&&b.value!==Id&&(this.b[e]=b)}u(Ao,Il);Ao.prototype.f=function(a){return new Do(a,this)};function Bo(a,b){Fl.call(this,a,b);this.j=null;this.ma={}}u(Bo,Fl);
Bo.prototype.h=function(a,b){var c=this.D,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}Fl.prototype.h.call(this,a,b)};Bo.prototype.Rc=function(){var a=this.style;a.left=me;a["margin-left"]=me;a["border-left-width"]=me;a["padding-left"]=me;a["padding-right"]=me;a["border-right-width"]=me;a["margin-right"]=me;a.right=me};
Bo.prototype.Sc=function(){var a=this.style;a.top=me;a["margin-top"]=me;a["border-top-width"]=me;a["padding-top"]=me;a["padding-bottom"]=me;a["border-bottom-width"]=me;a["margin-bottom"]=me;a.bottom=me};Bo.prototype.W=function(a,b,c){b=b.u;var d={start:this.j.marginLeft,end:this.j.marginRight,ca:this.j.Fb},e={start:this.j.marginTop,end:this.j.marginBottom,ca:this.j.Eb};Eo(this,b.top,!0,d,a,c);Eo(this,b.bottom,!0,d,a,c);Eo(this,b.left,!1,e,a,c);Eo(this,b.right,!1,e,a,c)};
function Fo(a,b,c,d,e){this.I=a;this.l=e;this.g=c;this.k=!W(d,b[c?"width":"height"],new Qc(d,0,"px"));this.h=null}Fo.prototype.b=function(){return this.k};function Go(a){a.h||(a.h=eo(a.l,a.I.d,a.g?["max-content width","min-content width"]:["max-content height","min-content height"]));return a.h}Fo.prototype.e=function(){var a=Go(this);return this.g?yi(this.I)+a["max-content width"]+zi(this.I):wi(this.I)+a["max-content height"]+xi(this.I)};
Fo.prototype.f=function(){var a=Go(this);return this.g?yi(this.I)+a["min-content width"]+zi(this.I):wi(this.I)+a["min-content height"]+xi(this.I)};Fo.prototype.d=function(){return this.g?yi(this.I)+this.I.width+zi(this.I):wi(this.I)+this.I.height+xi(this.I)};function Ho(a){this.g=a}Ho.prototype.b=function(){return this.g.some(function(a){return a.b()})};Ho.prototype.e=function(){var a=this.g.map(function(a){return a.e()});return Math.max.apply(null,a)*a.length};
Ho.prototype.f=function(){var a=this.g.map(function(a){return a.f()});return Math.max.apply(null,a)*a.length};Ho.prototype.d=function(){var a=this.g.map(function(a){return a.d()});return Math.max.apply(null,a)*a.length};function Io(a,b,c,d,e,f){Fo.call(this,a,b,c,d,e);this.j=f}u(Io,Fo);Io.prototype.b=function(){return!1};Io.prototype.e=function(){return this.d()};Io.prototype.f=function(){return this.d()};Io.prototype.d=function(){return this.g?yi(this.I)+this.j+zi(this.I):wi(this.I)+this.j+xi(this.I)};
function Eo(a,b,c,d,e,f){var g=a.d.d,h={},l={},k={},m;for(m in b){var p=vo[m];if(p){var r=b[m],t=a.ma[m],q=new Fo(r,t.style,c,g,f);h[p.ja]=r;l[p.ja]=t;k[p.ja]=q}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.ca.evaluate(e);var y=Jo(k,b),L=!1,Q={};Object.keys(h).forEach(function(a){var b=W(g,l[a].style[c?"max-width":"max-height"],d.ca);b&&(b=b.evaluate(e),y[a]>b&&(b=k[a]=new Io(h[a],l[a].style,c,g,f,b),Q[a]=b.d(),L=!0))});L&&(y=Jo(k,b),L=!1,["start","center","end"].forEach(function(a){y[a]=Q[a]||y[a]}));
var qa={};Object.keys(h).forEach(function(a){var b=W(g,l[a].style[c?"min-width":"min-height"],d.ca);b&&(b=b.evaluate(e),y[a]<b&&(b=k[a]=new Io(h[a],l[a].style,c,g,f,b),qa[a]=b.d(),L=!0))});L&&(y=Jo(k,b),["start","center","end"].forEach(function(a){y[a]=qa[a]||y[a]}));var Y=a+b,F=a+(a+b);["start","center","end"].forEach(function(a){var b=y[a];if(b){var d=h[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(F-b)/2;break;case "end":e=Y-b}c?Ci(d,e,b-yi(d)-zi(d)):Bi(d,e,b-wi(d)-xi(d))}})}
function Jo(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=Ko(d,g.length?new Ho(g):null,b);g.Ta&&(f.center=g.Ta);d=g.Ta||d.d();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=Ko(c,e,b),c.Ta&&(f.start=c.Ta),c.gc&&(f.end=c.gc);return f}
function Ko(a,b,c){var d={Ta:null,gc:null};if(a&&b)if(a.b()&&b.b()){var e=a.e(),f=b.e();0<e&&0<f?(f=e+f,f<c?d.Ta=c*e/f:(a=a.f(),b=b.f(),b=a+b,b<c?d.Ta=a+(c-b)*(e-a)/(f-b):0<b&&(d.Ta=c*a/b)),0<d.Ta&&(d.gc=c-d.Ta)):0<e?d.Ta=c:0<f&&(d.gc=c)}else a.b()?d.Ta=Math.max(c-b.d(),0):b.b()&&(d.gc=Math.max(c-a.d(),0));else a?a.b()&&(d.Ta=c):b&&b.b()&&(d.gc=c);return d}Bo.prototype.pb=function(a,b,c,d,e){Bo.Hd.pb.call(this,a,b,c,d,e);b.d.setAttribute("data-vivliostyle-page-box",!0)};
function Co(a,b){Jl.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.Eb=this.Fb=null}u(Co,Jl);
...
d["padding-bottom"]=new J(c.marginBottom)};Co.prototype.Rc=function(){var a=Lo(this,{start:"left",end:"right",ca:"width"});this.Fb=a.yd;this.marginLeft=a.Fd;this.marginRight=a.Ed};Co.prototype.Sc=function(){var a=Lo(this,{start:"top",end:"bottom",ca:"height"});this.Eb=a.yd;this.marginTop=a.Fd;this.marginBottom=a.Ed};
function Lo(a,b){var c=a.style,d=a.d.d,e=b.start,f=b.end,g=b.ca,h=a.d.u[g].ia(d,null),l=W(d,c[g],h),k=W(d,c["margin-"+e],h),m=W(d,c["margin-"+f],h),p=Kl(d,c["padding-"+e],h),r=Kl(d,c["padding-"+f],h),t=Ml(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),q=Ml(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),y=E(d,h,D(d,D(d,t,p),D(d,q,r)));l?(y=E(d,y,l),k||m?k?m=E(d,y,k):k=E(d,y,m):m=k=Yc(d,y,new gc(d,.5))):(k||(k=d.b),m||(m=d.b),l=E(d,y,D(d,k,m)));c[e]=new J(k);c[f]=new J(m);c["margin-"+e]=
me;c["margin-"+f]=me;c["padding-"+e]=new J(p);c["padding-"+f]=new J(r);c["border-"+e+"-width"]=new J(t);c["border-"+f+"-width"]=new J(q);c[g]=new J(l);c["max-"+g]=new J(l);return{yd:E(d,h,D(d,k,m)),Fd:k,Ed:m}}Co.prototype.pb=function(a,b,c,d,e){Jl.prototype.pb.call(this,a,b,c,d,e);c.w=b.d};function Do(a,b){Jl.call(this,a,b);var c=b.k;this.j=vo[c];a.ma[c]=this;this.na=!0}u(Do,Jl);n=Do.prototype;
n.pb=function(a,b,c,d,e){var f=b.d;w(f,"display","flex");var g=Wl(this,a,"vertical-align"),h=null;g===H("middle")?h="center":g===H("top")?h="flex-start":g===H("bottom")&&(h="flex-end");h&&(w(f,"flex-flow",this.b?"row":"column"),w(f,"justify-content",h));Jl.prototype.pb.call(this,a,b,c,d,e)};
...
function Mo(a,b,c){function d(a){if(y)return y;y={ca:q?q.evaluate(a):null,Ka:l?l.evaluate(a):null,La:k?k.evaluate(a):null};var b=h.evaluate(a),c=0;[r,m,p,t].forEach(function(b){b&&(c+=b.evaluate(a))});(null===y.Ka||null===y.La)&&c+y.ca+y.Ka+y.La>b&&(null===y.Ka&&(y.Ka=0),null===y.La&&(y.se=0));null!==y.ca&&null!==y.Ka&&null!==y.La&&(y.La=null);null===y.ca&&null!==y.Ka&&null!==y.La?y.ca=b-c-y.Ka-y.La:null!==y.ca&&null===y.Ka&&null!==y.La?y.Ka=b-c-y.ca-y.La:null!==y.ca&&null!==y.Ka&&null===y.La?y.La=
...
f]=new J(new ic(a,function(){var a=d(this).Ka;return null===a?0:a},"margin-"+f));e["margin-"+g]=new J(new ic(a,function(){var a=d(this).La;return null===a?0:a},"margin-"+g));"left"===f?e.left=new J(D(a,c.marginLeft,c.Fb)):"top"===f&&(e.top=new J(D(a,c.marginTop,c.Eb)))}n.Rc=function(){var a=this.e.j;this.j.va?Mo(this,{Tc:"right",Xc:"left",ca:"width"},a):this.j.wa?Mo(this,{Tc:"left",Xc:"right",ca:"width"},a):this.ja({start:"left",end:"right",ca:"width"},a)};
n.Sc=function(){var a=this.e.j;this.j.xa?Mo(this,{Tc:"bottom",Xc:"top",ca:"height"},a):this.j.ua?Mo(this,{Tc:"top",Xc:"bottom",ca:"height"},a):this.ja({start:"top",end:"bottom",ca:"height"},a)};n.oc=function(a,b,c,d,e,f,g){Jl.prototype.oc.call(this,a,b,c,d,e,f,g);a=c.u;c=this.d.k;d=this.j;d.va||d.wa?d.xa||d.ua||(d.va?a.left[c]=b:d.wa&&(a.right[c]=b)):d.xa?a.top[c]=b:d.ua&&(a.bottom[c]=b)};
function No(a,b,c,d,e){this.b=a;this.h=b;this.f=c;this.d=d;this.e=e;this.g={};a=this.h;b=new Rc(a,"page-number");b=new Jc(a,new Pc(a,b,new gc(a,2)),a.b);c=new zc(a,b);a.values["recto-page"]=c;a.values["verso-page"]=b;"ltr"===fo(this.e)?(a.values["left-page"]=b,b=new zc(a,b),a.values["right-page"]=b):(c=new zc(a,b),a.values["left-page"]=c,a.values["right-page"]=b)}function Oo(a){var b={};vk(a.b,[],"",b);a.b.pop();return b}
function Po(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof U?e.value+"":Po(a,e);c.push(d+f+(e.Ha||""))}return c.sort().join("^")}function Qo(a){this.b=null;this.f=a}u(Qo,V);Qo.prototype.apply=function(a){a.N===this.f&&this.b.apply(a)};Qo.prototype.d=function(){return 3};Qo.prototype.e=function(a){this.b&&tj(a.Wb,this.f,this.b);return!0};function Ro(a){this.b=null;this.f=a}u(Ro,V);
Ro.prototype.apply=function(a){1===(new Rc(this.f,"page-number")).evaluate(a.g)&&this.b.apply(a)};Ro.prototype.d=function(){return 2};function So(a){this.b=null;this.f=a}u(So,V);So.prototype.apply=function(a){(new Rc(this.f,"left-page")).evaluate(a.g)&&this.b.apply(a)};So.prototype.d=function(){return 1};function To(a){this.b=null;this.f=a}u(To,V);To.prototype.apply=function(a){(new Rc(this.f,"right-page")).evaluate(a.g)&&this.b.apply(a)};To.prototype.d=function(){return 1};
function Uo(a){this.b=null;this.f=a}u(Uo,V);Uo.prototype.apply=function(a){(new Rc(this.f,"recto-page")).evaluate(a.g)&&this.b.apply(a)};Uo.prototype.d=function(){return 1};function Vo(a){this.b=null;this.f=a}u(Vo,V);Vo.prototype.apply=function(a){(new Rc(this.f,"verso-page")).evaluate(a.g)&&this.b.apply(a)};Vo.prototype.d=function(){return 1};function Wo(a,b){rj.call(this,a,b,null,null)}u(Wo,rj);
Wo.prototype.apply=function(a){var b=a.g,c=a.u,d=this.style;a=this.O;kj(b,c,d,a,null,null);if(d=d._marginBoxes){var c=ij(c,"_marginBoxes"),e;for(e in d)if(d.hasOwnProperty(e)){var f=c[e];f||(f={},c[e]=f);kj(b,f,d[e],a,null,null)}}};function Xo(a,b,c,d,e){Ek.call(this,a,b,null,c,null,d,!1);this.G=e;this.B=[];this.e="";this.u=[]}u(Xo,Ek);n=Xo.prototype;n.Kb=function(){this.eb()};n.hb=function(a,b){if(this.e=b)this.b.push(new Qo(b)),this.O+=65536};
n.Xb=function(a,b){b&&If(this,"E_INVALID_PAGE_SELECTOR :"+a+"("+b.join("")+")");this.u.push(":"+a);switch(a.toLowerCase()){case "first":this.b.push(new Ro(this.d));this.O+=256;break;case "left":this.b.push(new So(this.d));this.O+=1;break;case "right":this.b.push(new To(this.d));this.O+=1;break;case "recto":this.b.push(new Uo(this.d));this.O+=1;break;case "verso":this.b.push(new Vo(this.d));this.O+=1;break;default:If(this,"E_INVALID_PAGE_SELECTOR :"+a)}};
function Yo(a){var b;a.e||a.u.length?b=[a.e].concat(a.u.sort()):b=null;a.B.push({rd:b,O:a.O});a.e="";a.u=[]}n.Hb=function(){Yo(this);Ek.prototype.Hb.call(this)};n.pa=function(){Yo(this);Ek.prototype.pa.call(this)};
...
this)}}};n.Bd=function(a){tj(this.g.Wb,"*",a)};n.Dd=function(a){return new Wo(this.h,a)};n.bd=function(a){var b=ij(this.h,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);Ef(this.Z,new Zo(this.d,this.Z,this.k,c))};function Zo(a,b,c,d){Ff.call(this,a,b,!1);this.e=c;this.b=d}u(Zo,Gf);Zo.prototype.bb=function(a,b,c){fh(this.e,a,b,c,this)};Zo.prototype.Ub=function(a,b){Hf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Zo.prototype.Cc=function(a,b){Hf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};
Zo.prototype.cb=function(a,b,c){hj(this.b,a,new U(b,c?Bf(this):Cf(this)))};function $o(a){this.d=a;this.b={};this.b.page=[0]}function ap(a,b){Object.keys(b.b).forEach(function(a){this.b[a]=Array.b(b.b[a])},a)}function mk(a,b,c){return new ic(a.d,function(){var d=a.b[b];return c(d&&d.length?d[d.length-1]:null)},"page-counter-"+b)}function ok(a,b,c){return new ic(a.d,function(){return c(a.b[b]||[])},"page-counters-"+b)}
function bp(a,b,c){var d,e=b["counter-reset"];e&&(e=e.evaluate(c))&&(d=rg(e,!0));if(d)for(var f in d){var e=a,g=f,h=d[f];e.b[g]?e.b[g].push(h):e.b[g]=[h]}var l;(b=b["counter-increment"])&&(c=b.evaluate(c))&&(l=rg(c,!1));l?"page"in l||(l.page=1):l={page:1};for(var k in l)a.b[k]||(c=a,b=k,c.b[b]?c.b[b].push(0):c.b[b]=[0]),c=a.b[k],c[c.length-1]+=l[k]};var cp=new xf(function(){var a=K("uaStylesheetBase");vf(gh).then(function(b){var c=va("user-agent-base.css",ua);b=new Ek(null,null,null,null,null,b,!0);b.Lb("UA");Dk=b.g;gg(c,b,null,null).ta(a)});return N(a)},"uaStylesheetBaseFetcher");
function dp(a,b,c,d,e,f,g,h,l,k){this.h=a;this.g=b;this.b=c;this.d=d;this.B=e;this.f=f;this.l=a.F;this.u=g;this.e=h;this.k=l;this.w=k;this.j=a.f;kc(this.b,function(a){var b=this.b,c;c=(c=b.b[a])?(c=c.b[0])?c.b:null:null;var d;d=b.b[a];if(d=ep(this,d?d.d:"any"))d=(a=b.b[a])?0<a.b.length&&a.b[0].b.d<=this.k:!1;return d&&!!c&&!fp(this,c)});jc(this.b,new ic(this.b,function(){return this.na+this.b.d},"page-number"))}
...
function hp(a,b,c,d,e,f,g,h,l){nc.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.ba=b;this.lang=b.lang||c;this.viewport=d;this.f={body:!0};this.e=e;this.j=this.b=this.B=this.d=this.u=null;this.k=0;this.Oa=f;this.g=new nh(this.style.l);this.ma={};this.N=null;this.l=new $o(a.b);this.G={};this.la=null;this.Ma=g;this.Na=h;this.na=l;for(var k in a.e)(b=a.e[k]["flow-consume"])&&(b.evaluate(this,"flow-consume")==sd?this.f[k]=!0:delete this.f[k]);this.W={}}u(hp,nc);
function ip(a){var b=K("StyleInstance.init");a.d=new il(a.ba,a.style.d,a.style.g,a,a.f,a.style.j,a.l);ul(a.d,a);a.B={};a.B[a.ba.url]=a.d;var c=rl(a.d);a.la=fo(c);a.u=new lm(a.style.B);var d=new sk(a.style.d,a,a.l);a.u.h(d,c);km(a.u,a);a.N=new No(d,a.style.b,a.u,a,c);c=[];for(d=0;d<a.style.f.length;d++){var e=a.style.f[d];if(!e.L||e.L.evaluate(a))e=kh(e.Ab,a),e=new lh(e),c.push(e)}th(a.Oa,c,a.g).ta(b);var f=a.style.w;Object.keys(f).forEach(function(a){var b=mo(lo(f[a]),this);this.W[a]={width:b.ob+
2*b.Mc,height:b.nb+2*b.Mc}},a);return N(b)}function vl(a,b,c){if(a=a.b)a.e[b.b]||(a.e[b.b]=c),c=a.b[b.b],c||(c=new ti,a.b[b.b]=c),c.b.push(new si(new ri({ka:[{ha:b.h,Ra:0,ea:null,ya:null,sa:null}],da:0,M:!1}),b))}function jp(a,b){for(var c=Number.POSITIVE_INFINITY,d=0;d<b.b.length;d++){for(var e=b.b[d].d.Xa,f=e.ka[0].ha,g=e.da,h=e.M,l=0;f.ownerDocument!=a.ba.b;)l++,f=e.ka[l].ha,h=!1,g=0;e=yh(a.ba,f,g,h);e<c&&(c=e)}return c}
function kp(a,b){if(!b)return 0;var c=Number.POSITIVE_INFINITY,d;for(d in a.f){var e=b.b[d];if((!e||0==e.b.length)&&a.b){e=a.d;e.B=d;for(var f=0;null!=e.B&&(f+=5E3,sl(e,f,0)!=Number.POSITIVE_INFINITY););e=a.b.b[d];b!=a.b&&e&&(e=e.clone(),b.b[d]=e)}e&&(e=jp(a,e),e<c&&(c=e))}return c}function ep(a,b){switch(b){case "left":case "right":case "recto":case "verso":return(new Rc(a.style.b,b+"-page")).evaluate(a);default:return!0}}
function lp(a,b){var c=a.b,d=kp(a,c);if(d==Number.POSITIVE_INFINITY)return null;for(var e=a.u.children,f,g=0;g<e.length;g++)if(f=e[g],"vivliostyle-page-rule-master"!==f.d.qb){var h=1,l=Wl(f,a,"utilization");l&&l.od()&&(h=l.C);var l=pc(a,"em",!1),k=a.ob()*a.nb();a.k=sl(a.d,d,Math.ceil(h*k/(l*l)));h=a;l=c;k=void 0;for(k in l.b){var m=l.b[k];if(m&&0<m.b.length){var p=m.b[0].b;if(jp(h,m)===p.d){a:switch(p=m.d,p){case "left":case "right":case "recto":case "verso":break a;default:p=null}m.d=Zm(al(p,m.b[0].b.e))}}}a.j=
c.clone();h=a;l=h.b.d;k=void 0;for(k in h.b.b)for(m=h.b.b[k],p=m.b.length-1;0<=p;p--){var r=m.b[p];0>r.b.g&&r.b.d<h.k&&(r.b.g=l)}oc(a,a.style.b);h=Wl(f,a,"enabled");if(!h||h===ie){c=a;v.debug("Location - page",c.b.d);v.debug("  current:",d);v.debug("  lookup:",c.k);d=void 0;for(d in c.b.b)for(e=c.b.b[d],g=0;g<e.b.length;g++)v.debug("  Chunk",d+":",e.b[g].b.d);d=a.N;e=b;g=f.d;if(0===Object.keys(e).length)g.d.e=g;else{f=g;c=Po(d,e);f=f.g+"^"+c;c=d.g[f];if(!c){if("background-host"===g.qb)c=d,e=(new xo(c.h,
c.f.d,e)).f(c.f),e.h(c.b,c.e),km(e,c.d),c=e;else{c=d;h=e;e=g.clone({qb:"vivliostyle-page-rule-master"});if(g=h.size)h=lo(h),g=g.Ha,e.b.width=ej(c.d,e.b.width,new U(h.width,g)),e.b.height=ej(c.d,e.b.height,new U(h.height,g));e=e.f(c.f);e.h(c.b,c.e);km(e,c.d);c=e}d.g[f]=c}f=c.d;f.d.e=f;f=c}return f}}throw Error("No enabled page masters");}
function fp(a,b){var c=a.j.e,d=c[b.b].d;if(d){var e=b.d,f=c[d].b;if(!f.length||e<f[0])return!1;var c=Qa(f.length,function(a){return f[a]>e})-1,c=f[c],d=a.j.b[d],g=jp(a,d);return c<g?!1:g<c?!0:!ep(a,d.d)}return!1}
function mp(a,b,c){var d=a.b.b[c];if(!d||!ep(a,d.d))return M(!0);d.d="any";zn(b);a.f[c]&&0<b.ub.length&&(b.xd=!1);var e=K("layoutColumn"),f=[],g=[],h=!0;of(function(c){for(;0<d.b.length-g.length;){for(var e=0;0<=g.indexOf(e);)e++;var m=d.b[e];if(m.b.d>a.k||fp(a,m.b))break;for(var p=e+1;p<d.b.length;p++)if(!(0<=g.indexOf(p))){var r=d.b[p];if(r.b.d>a.k||fp(a,r.b))break;ei(r.b,m.b)&&(m=r,e=p)}var t=m.b,q=!0;Cn(b,m.d,h).then(function(a){h=!1;m.b.Wd&&(null===a||t.f)&&f.push(e);t.f?(g.push(e),P(c)):(a?
m.d=a:g.push(e),b.h&&(d.d=Zm(b.h)),a||b.h?P(c):q?q=!1:qf(c))});if(q){q=!1;return}}P(c)}).then(function(){d.b=d.b.filter(function(a,b){return 0<=f.indexOf(b)||0>g.indexOf(b)});O(e,!0)});return N(e)}
function np(a,b,c,d,e,f,g,h){Pl(c);var l=Wl(c,a,"enabled");if(l&&l!==ie)return M(!0);var k=K("layoutContainer"),m=Wl(c,a,"wrap-flow")===ud,p=c.b?c.g&&c.F:c.f&&c.G,l=Wl(c,a,"flow-from"),r=a.viewport.b.createElement("div"),t=Wl(c,a,"position");w(r,"position",t?t.name:"absolute");d.insertBefore(r,d.firstChild);var q=new vi(r);q.b=c.b;c.pb(a,q,b,a.g,a.e);q.D=e;q.F=f;e+=q.left+q.marginLeft+q.W;f+=q.top+q.marginTop+q.aa;if(l&&l.Cd())if(a.G[l.toString()])c.oc(a,q,b,null,1,a.e,a.g),l=M(!0);else{var y=K("layoutContainer.inner"),
L=l.toString(),Q=X(c,a,"column-count"),qa=X(c,a,"column-gap"),Y=1<Q?X(c,a,"column-width"):q.width,l=Vl(c,a),F=0,t=Wl(c,a,"shape-inside"),sa=pg(t,0,0,q.width,q.height,a),Fa=new Bm(L,a,a.viewport,a.d,l,a.ba,a.g,a.style.u,a,b,a.Ma,a.Na,h),Rh=0,ba=null;of(function(b){for(;Rh<Q;){var c=Rh++;if(1<Q){var d=a.viewport.b.createElement("div");w(d,"position","absolute");r.appendChild(d);ba=new gn(d,Fa,a.e);ba.b=q.b;ba.Oa=q.Oa;ba.hc=q.hc;q.b?(w(d,"margin-left",q.j+"px"),w(d,"margin-right",q.w+"px"),c=c*(Y+qa)+
q.k,Ci(ba,0,q.width),Bi(ba,c,Y)):(w(d,"margin-top",q.k+"px"),w(d,"margin-bottom",q.u+"px"),c=c*(Y+qa)+q.j,Bi(ba,0,q.height),Ci(ba,c,Y));ba.D=e+q.j;ba.F=f+q.k}else ba=new gn(r,Fa,a.e),Ai(ba,q),q=ba;ba.G=p?[]:g;ba.wb=sa;if(0<=ba.width){var k=K("inner");mp(a,ba,L).then(function(){ba.h&&"column"!=ba.h&&(Rh=Q,"region"!=ba.h&&(a.G[L]=!0));O(k,!0)});c=N(k)}else c=M(!0);if(c.Ca()){c.then(function(){0<h.b.length?P(b):(F=Math.max(F,ba.e),qf(b))});return}0<h.b.length||(F=Math.max(F,ba.e))}P(b)}).then(function(){q.e=
F;c.oc(a,q,b,ba,Q,a.e,a.g);O(y,!0)});l=N(y)}else{l=Wl(c,a,"content");t=!1;if(l&&Ei(l)){var ol=a.viewport.b.createElement("span");l.T(new Di(ol,a));r.appendChild(ol);jm(c,a,q,a.g)}else c.na&&(d.removeChild(r),t=!0);t||c.oc(a,q,b,null,1,a.e,a.g);l=M(!0)}l.then(function(){if(!c.f||0<Math.floor(q.e)){if(!m){var l=q.D+q.left,p=q.F+q.top,t=yi(q)+q.width+zi(q),y=wi(q)+q.height+xi(q),F=Wl(c,a,"shape-outside"),l=pg(F,l,p,t,y,a);$a(a.viewport.root)&&g.push(xe(l,0,-1.25*pc(a,"em",!1)));g.push(l)}}else if(0==
c.children.length){d.removeChild(r);O(k,!0);return}var Q=c.children.length-1;nf(function(){for(;0<=Q;){var d=c.children[Q--],d=np(a,b,d,r,e,f,g,h);if(d.Ca())return d}return M(!1)}).then(function(){O(k,!0)})});return N(k)}
function op(a,b,c){a.G={};c?(a.b=c.clone(),ll(a.d,c.f)):(a.b=new ui,ll(a.d,-1));a.lang&&b.b.setAttribute("lang",a.lang);c=a.b;c.d++;oc(a,a.style.b);a.j=c.clone();var d=Oo(a.N),e=lp(a,d);if(!e)return M(null);e.d.b.width.value===ke&&Yh(b);e.d.b.height.value===le&&Zh(b);bp(a.l,d,a);var f=mo(lo(d),a);pp(a,f,b);to(d,f,b,a);var d=Wl(e,a,"writing-mode")||Hd,f=Wl(e,a,"direction")||Qd,g=new Ki(b.B.bind(b),d,f),h=[],l=K("layoutNextPage");of(function(d){np(a,b,e,b.b,0,0,h.concat(),g).then(function(){if(0<g.b.length){h=
h.concat(Pi(g));g.b.splice(0,g.b.length);c=a.b=a.j.clone();for(var e;e=b.b.lastChild;)b.b.removeChild(e);qf(d)}else P(d)})}).then(function(){e.W(a,b,a.e);var d=new Rc(e.d.d,"left-page");b.g=d.evaluate(a)?"left":"right";var d=a.b.d,f;for(f in a.b.b)for(var g=a.b.b[f],h=g.b.length-1;0<=h;h--){var t=g.b[h];0<=t.b.g&&t.b.g+t.b.k-1<=d&&g.b.splice(h,1)}a.b=a.j=null;c.f=a.d.b;f=a.style.h.D[a.ba.url];d=b.I.getBoundingClientRect();b.d.width=d.width;b.d.height=d.height;g=b.h;for(d=0;d<g.length;d++)h=g[d],w(h.target,
h.name,h.value.toString());for(d=0;d<f.length;d++)if(g=f[d],t=b.j[g.Zb],h=b.j[g.Td],t&&h&&(t=Wh(t,g.action)))for(var q=0;q<h.length;q++)h[q].addEventListener(g.event,t,!1);var y;a:{for(y in a.f)if((f=c.b[y])&&0<f.b.length){y=!1;break a}y=!0}y&&(c=null);O(l,c)});return N(l)}
function pp(a,b,c){a.F=b.ob;a.D=b.nb;c.I.style.width=b.ob+2*b.Mc+"px";c.I.style.height=b.nb+2*b.Mc+"px";c.b.style.left=b.yb+"px";c.b.style.right=b.yb+"px";c.b.style.top=b.yb+"px";c.b.style.bottom=b.yb+"px";c.b.style.padding=b.Db+"px"}function qp(a,b,c,d){Ek.call(this,a.g,a,b,c,d,a.f,!c);this.e=a;this.u=!1}u(qp,Ek);n=qp.prototype;n.yc=function(){};n.xc=function(a,b,c){a=new El(this.e.j,a,b,c,this.e.w,this.L,Cf(this.Z));Ef(this.e,new qm(a.d,this.e,a,this.k))};
n.Bb=function(a){a=a.d;null!=this.L&&(a=Xc(this.d,this.L,a));Ef(this.e,new qp(this.e,a,this,this.w))};n.uc=function(){Ef(this.e,new Kk(this.d,this.Z))};n.wc=function(){var a={};this.e.k.push({Ab:a,L:this.L});Ef(this.e,new Lk(this.d,this.Z,null,a,this.e.f))};n.vc=function(a){var b=this.e.h[a];b||(b={},this.e.h[a]=b);Ef(this.e,new Lk(this.d,this.Z,null,b,this.e.f))};n.Ac=function(){var a={};this.e.B.push(a);Ef(this.e,new Lk(this.d,this.Z,this.L,a,this.e.f))};
n.$b=function(a){var b=this.e.l;if(a){var c=ij(b,"_pseudos"),b=c[a];b||(b={},c[a]=b)}Ef(this.e,new Lk(this.d,this.Z,null,b,this.e.f))};n.zc=function(){this.u=!0;this.eb()};n.Kb=function(){var a=new Xo(this.e.j,this.e,this,this.k,this.e.u);Ef(this.e,a);a.Kb()};n.pa=function(){Ek.prototype.pa.call(this);if(this.u){this.u=!1;var a="R"+this.e.F++,b=H(a),c;this.L?c=new dj(b,0,this.L):c=new U(b,0);jj(this.h,"region-id").push(c);this.lb();a=new qp(this.e,this.L,this,a);Ef(this.e,a);a.pa()}};
function rp(a){var b=a.getAttribute("content");if(!b)return"";a={};for(var c;null!=(c=b.match(/^,?\s*([-A-Za-z_.][-A-Za-z_0-9.]*)\s*=\s*([-+A-Za-z_0-9.]*)\s*/));)b=b.substr(c[0].length),a[c[1]]=c[2];b=a.width-0;a=a.height-0;return b&&a?"@-epubx-viewport{width:"+b+"px;height:"+a+"px;}":""}function sp(a){Df.call(this);this.f=a;this.g=new fc(null);this.j=new fc(this.g);this.w=new Bl(this.g);this.D=new qp(this,null,null,null);this.F=0;this.k=[];this.l={};this.h={};this.B=[];this.u={};this.b=this.D}
u(sp,Df);sp.prototype.error=function(a){v.b("CSS parser:",a)};function tp(a,b){return up(b,a)}function vp(a){uf.call(this,tp,"document");this.F=a;this.B={};this.h={};this.b={};this.D={};this.f=null;this.j=[]}u(vp,uf);function wp(a){var b=va("user-agent.xml",ua),c=K("OPSDocStore.init");vf(gh).then(function(d){a.f=d;vf(cp).then(function(){a.load(b).then(function(){O(c,!0)})})});return N(c)}function xp(a,b){a.j.push({url:b.url,text:b.text,ab:"User",Aa:null,media:null})}
function up(a,b){var c=K("OPSDocStore.load"),d=b.url;Gh(b,a).then(function(b){if(b){for(var f=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),h=0;h<g.length;h++){var l=g[h],k=l.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),m=l.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=l.getAttribute("action"),l=l.getAttribute("ref");k&&m&&p&&l&&f.push({Td:k,event:m,action:p,Zb:l})}a.D[d]=f;var r=[],f=va("user-agent-page.css",ua);r.push({url:f,text:null,
...
k&&"viewport"==g.getAttribute("name")&&r.push({url:d,text:rp(g),ab:"Author",L:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==h?"stylesheet"==k&&"text/css"==g.getAttribute("type")&&r.push({url:d,text:g.textContent,ab:"Author",Aa:null,media:null}):"http://example.com/sse"==h&&"property"===k&&(h=g.getElementsByTagName("name")[0])&&"stylesheet"===h.textContent&&(g=g.getElementsByTagName("value")[0])&&(g=va(g.textContent,d),r.push({url:g,text:null,Aa:null,media:null,ab:"Author"}));
for(var t="",h=0;h<r.length;h++)t+=r[h].url,t+="^",r[h].text&&(t+=r[h].text),t+="^";var q=a.B[t];q?(a.b[d]=q,O(c,b)):(f=a.h[t],f||(f=new xf(function(){var b=K("fetchStylesheet"),c=0,d=new sp(a.f);nf(function(){if(c<r.length){var a=r[c++];d.Lb(a.ab);return null!==a.text?hg(a.text,d,a.url,a.Aa,a.media).cd(!0):gg(a.url,d,a.Aa,a.media)}return M(!1)}).then(function(){q=new dp(a,d.g,d.j,d.D.g,d.w,d.k,d.l,d.h,d.B,d.u);a.B[t]=q;delete a.h[t];O(b,q)});return N(b)},"FetchStylesheet "+d),a.h[t]=f,f.start()),
vf(f).then(function(f){a.b[d]=f;O(c,b)}))}else O(c,null)});return N(c)};function yp(a,b,c,d,e,f,g,h){this.d=a;this.url=b;this.lang=c;this.e=d;this.g=e;this.S=Xb(f);this.h=g;this.f=h;this.Ba=this.b=null}function zp(a,b,c){if(0!=c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=Ha(d,"height","auto")&&(w(d,"height","auto"),zp(a,d,c));"absolute"==Ha(d,"position","static")&&(w(d,"position","relative"),zp(a,d,c))}}
...
yp.prototype.Vc=function(a){var b=this.h.Vc(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",w(e,"cursor","pointer"),e.addEventListener("click",Ap,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
yp.prototype.tc=function(a,b,c,d,e){if(this.b)return M(this.b);var f=this,g=K("showTOC"),h=new Xh(a,a);this.b=h;this.d.load(this.url).then(function(d){var k=f.d.b[d.url],m=gp(k,c,1E5,e);b=new Xm(b.f,m.fontSize,b.root,m.width,m.height);var p=new hp(k,d,f.lang,b,f.e,f.g,f.Vc(d),f.f,0);f.Ba=p;p.S=f.S;ip(p).then(function(){op(p,h,null).then(function(){zp(f,a,2);O(g,h)})})});return N(g)};
yp.prototype.qc=function(){if(this.b){var a=this.b;this.Ba=this.b=null;w(a.I,"visibility","none");var b=a.I.parentNode;b&&b.removeChild(a.I)}};yp.prototype.pd=function(){return!!this.b};function Bp(){vp.call(this,Cp(this));this.d=new uf(Gh,"document");this.u=new uf(yf,"text");this.w={};this.N={};this.k={};this.l={}}u(Bp,vp);function Cp(a){return function(b){return a.k[b]}}
function Dp(a,b,c){var d=K("loadEPUBDoc");"/"!==b.substring(b.length-1)&&(b+="/");c&&a.u.mc(b+"?r=list");a.d.mc(b+"META-INF/encryption.xml");var e=b+"META-INF/container.xml";a.d.load(e,!0,"Failed to fetch EPUB container.xml from "+e).then(function(f){if(f){f=Qh(vh(vh(vh(new wh([f.b]),"container"),"rootfiles"),"rootfile"),"full-path");for(var g=0;g<f.length;g++){var h=f[g];if(h){Ep(a,b,h,c).ta(d);return}}O(d,null)}else v.error("Received an empty response for EPUB container.xml "+e+". This may be caused by the server not allowing cross origin requests.")});
return N(d)}function Ep(a,b,c,d){var e=b+c,f=a.w[e];if(f)return M(f);var g=K("loadOPF");a.d.load(e,void 0,void 0).then(function(c){c?a.d.load(b+"META-INF/encryption.xml",void 0,void 0).then(function(l){(d?a.u.load(b+"?r=list"):M(null)).then(function(d){f=new Fp(a,b);Gp(f,c,l,d,b+"?r=manifest").then(function(){a.w[e]=f;a.N[b]=f;O(g,f)})})}):v.error("Received an empty response for EPUB OPF "+e+". This may be caused by the server not allowing cross origin requests.")});return N(g)}
function Hp(a,b,c){var d=K("EPUBDocStore.load");b=ta(b);(a.l[b]=up(a,{status:200,url:b,contentType:c.contentType,responseText:null,responseXML:c,sc:null})).ta(d);return N(d)}
Bp.prototype.load=function(a){var b=ta(a);if(a=this.l[b])return a.Ca()?a:M(a.jc());var c=K("EPUBDocStore.load");a=Bp.Hd.load.call(this,b,!0,"Failed to fetch a source document from "+b);a.then(function(a){a?O(c,a):v.error("Received an empty response for "+b+". This may be caused by the server not allowing cross origin requests.")});return N(c)};function Ip(){this.id=null;this.src="";this.f=this.d=null;this.H=-1;this.h=0;this.j=null;this.b=this.e=0;this.g=Ta}function Jp(a){return a.id}
function Kp(a){var b=Qe(a);return function(a){var d=K("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));tf(e).then(function(a){a=new DataView(a);for(var c=0;c<a.byteLength;c++){var e=a.getUint8(c),e=e^b[c%20];a.setUint8(c,e)}O(d,sf([a,f]))});return N(d)}}
...
function Op(a,b){var c={};return function(d,e){var f,g,h=d.r||c,l=e.r||c;if(a==Np&&(f="main"==h["http://idpf.org/epub/vocab/package/#title-type"],g="main"==l["http://idpf.org/epub/vocab/package/#title-type"],f!=g))return f?-1:1;f=parseInt(h["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(f)&&(f=Number.MAX_VALUE);g=parseInt(l["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(g)&&(g=Number.MAX_VALUE);return f!=g?f-g:a!=Mp&&b&&(f=(h[Mp]||h["http://idpf.org/epub/vocab/package/#alternate-script"])==
b,g=(l[Mp]||l["http://idpf.org/epub/vocab/package/#alternate-script"])==b,f!=g)?f?-1:1:d.o-e.o}}
function Pp(a,b){function c(a){for(var b in a){var d=a[b];d.sort(Op(b,k));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return Wa(a,function(a){return Va(a,function(a){var b={v:a.value,o:a.P};a.te&&(b.s=a.scheme);if(a.id||a.lang){var c=l[a.id];if(c||a.lang)a.lang&&(a={name:Mp,value:a.lang,lang:null,id:null,$c:a.id,scheme:null,P:a.P},c?c.push(a):c=[a]),c=Ua(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in Lp)f[g]=Lp[g];for(;null!=(g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/));)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=Lp;var h=1;g=Oh(Ph(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),P:h++,$c:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:Lp.dcterms+a.localName,P:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),$c:null,scheme:null};return null});var l=Ua(g,function(a){return a.$c});g=d(Ua(g,function(a){return a.$c?null:a.name}));var k=null;g[Mp]&&(k=g[Mp][0].v);c(g);return g}function Qp(){var a=window.MathJax;return a?a.Hub:null}var Rp={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function Fp(a,b){this.e=a;this.h=this.d=this.b=this.g=this.f=null;this.k=b;this.j=null;this.F={};this.lang=null;this.u=0;this.l={};this.G=this.D=this.N=null;this.w={};this.B=null;Qp()&&(Ui["http://www.w3.org/1998/Math/MathML"]=!0)}function Sp(a,b){return a.k?b.substr(0,a.k.length)==a.k?decodeURI(b.substr(a.k.length)):null:b}
function Gp(a,b,c,d,e){a.f=b;var f=vh(new wh([b.b]),"package"),g=Qh(f,"unique-identifier")[0];g&&(g=Ch(b,b.url+"#"+g))&&(a.j=g.textContent.replace(/[ \n\r\t]/g,""));var h={};a.g=Va(Mh(vh(vh(f,"manifest"),"item")),function(c){var d=new Ip,e=b.url;d.id=c.getAttribute("id");d.src=va(c.getAttribute("href"),e);d.d=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.g=f}(c=c.getAttribute("fallback"))&&!Rp[d.d]&&(h[d.src]=c);!a.D&&
d.g.nav&&(a.D=d);!a.G&&d.g["cover-image"]&&(a.G=d);return d});a.d=Sa(a.g,Jp);a.h=Sa(a.g,function(b){return Sp(a,b.src)});for(var l in h)for(g=l;;){g=a.d[h[g]];if(!g)break;if(Rp[g.d]){a.w[l]=g.src;break}g=g.src}a.b=Va(Mh(vh(vh(f,"spine"),"itemref")),function(b,c){var d=b.getAttribute("idref");if(d=a.d[d])d.f=b,d.H=c;return d});if(l=Qh(vh(f,"spine"),"toc")[0])a.N=a.d[l];if(l=Qh(vh(f,"spine"),"page-progression-direction")[0]){a:switch(l){case "ltr":l="ltr";break a;case "rtl":l="rtl";break a;default:throw Error("unknown PageProgression: "+
l);}a.B=l}var g=c?Qh(vh(vh(Lh(vh(vh(new wh([c.b]),"encryption"),"EncryptedData"),Kh()),"CipherData"),"CipherReference"),"URI"):[],k=Mh(vh(vh(f,"bindings"),"mediaType"));for(c=0;c<k.length;c++){var m=k[c].getAttribute("handler");(l=k[c].getAttribute("media-type"))&&m&&a.d[m]&&(a.F[l]=a.d[m].src)}a.l=Pp(vh(f,"metadata"),Qh(f,"prefix")[0]);a.l[Mp]&&(a.lang=a.l[Mp][0].v);if(!d){if(0<g.length&&a.j)for(d=Kp(a.j),c=0;c<g.length;c++)a.e.k[a.k+g[c]]=d;return M(!0)}f=new Ia;k={};if(0<g.length&&a.j)for(l="1040:"+
Re(a.j),c=0;c<g.length;c++)k[g[c]]=l;for(c=0;c<d.length;c++){var p=d[c];if(m=p.n){var r=decodeURI(m),g=a.h[r];l=null;g&&(g.j=0!=p.m,g.h=p.c,g.d&&(l=g.d.replace(/\s+/g,"")));g=k[r];if(l||g)f.append(m),f.append(" "),f.append(l||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}Tp(a);return rf(e,"","POST",f.toString(),"text/plain")}function Tp(a){for(var b=0,c=0;c<a.b.length;c++){var d=a.b[c],e=Math.ceil(d.h/1024);d.e=b;d.b=e;b+=e}a.u=b}
function Up(a,b,c){a.d={};a.h={};a.g=[];a.b=a.g;var d=a.f=new uh(null,"",(new DOMParser).parseFromString("<spine></spine>","text/xml"));b.forEach(function(a,b){var c=new Ip;c.H=b;c.id="item"+(b+1);c.src=a;var h=d.b.createElement("itemref");h.setAttribute("idref",c.id);d.root.appendChild(h);c.f=h;this.d[c.id]=c;this.h[a]=c;this.g.push(c)},a);return c?Hp(a.e,b[0],c):M(null)}
function Vp(a,b,c){var d=a.b[b],e=K("getCFI");a.e.load(d.src).then(function(a){var b=Ah(a,c),h=null;b&&(a=yh(a,b,0,!1),h=new jb,mb(h,b,c-a),d.f&&mb(h,d.f,0),h=h.toString());O(e,h)});return N(e)}
function Wp(a,b){return Xe("resolveFragment",function(c){if(b){var d=new jb;kb(d,b);var e;if(a.f){var f=lb(d,a.f.b);if(1!=f.ha.nodeType||f.M||!f.Zb){O(c,null);return}var g=f.ha,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.d[h]){O(c,null);return}e=a.d[h];d=f.Zb}else e=a.b[0];a.e.load(e.src).then(function(a){var b=lb(d,a.b);a=yh(a,b.ha,b.offset,b.M);O(c,{H:e.H,qa:a,R:-1})})}else O(c,null)},function(a,d){v.b(d,"Cannot resolve fragment:",b);O(a,null)})}
function Xp(a,b){return Xe("resolveEPage",function(c){if(0>=b)O(c,{H:0,qa:0,R:-1});else{var d=Qa(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.e.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=zh(a),g=Math.round(a*b/e.b),g==a&&g--);O(c,{H:d,qa:g,R:-1})})}},function(a,d){v.b(d,"Cannot resolve epage:",b);O(a,null)})}
function Yp(a,b){var c=a.b[b.H];if(0>=b.qa)return M(c.e);var d=K("getEPage");a.e.load(c.src).then(function(a){a=zh(a);var f=Math.min(a,b.qa);O(d,c.e+f*c.b/a)});return N(d)}function Zp(a,b,c,d,e){this.b=a;this.viewport=b;this.f=c;this.g=e;this.Jb=[];this.qa=this.R=this.H=0;this.S=Xb(d);this.e=new Vm(b.f)}function $p(a){var b=a.Jb[a.H];return b?b.gb[a.R]:null}n=Zp.prototype;n.mb=function(){if(this.b.B)return this.b.B;var a=this.Jb[this.H];return a?a.Ba.la:null};
function aq(a){var b=K("renderPage");bq(a).then(function(c){if(c){var d=-1;if(0>a.R){var d=a.qa,e=Qa(c.Ja.length,function(a){return kp(c.Ba,c.Ja[a])>d});a.R=e==c.Ja.length?Number.POSITIVE_INFINITY:e-1}var f=c.gb[a.R];f?(a.qa=f.offset,O(b,f)):of(function(b){if(a.R<c.Ja.length)P(b);else if(c.complete)a.R=c.Ja.length-1,P(b);else{var e=c.Ja[c.Ja.length-1],l=cq(a,c,e);op(c.Ba,l,e).then(function(k){l.I.style.display="none";l.I.style.visibility="visible";l.I.style.position="";l.I.style.top="";l.I.style.left=
"";l.I.setAttribute("data-vivliostyle-page-side",l.g);c.Ba.viewport.d.appendChild(l.I);k=(e=k)?e.d-1:c.Ja.length-1;a.g(c.Ba.W,c.item.H,k);e?(c.gb[k]=l,c.Ja.push(e),0<=d&&kp(c.Ba,e)>d?(f=l,a.R=c.Ja.length-2,P(b)):(l.k=0==c.item.H&&0==k,qf(b))):(c.gb.push(l),f=l,a.R=k,0>d&&(a.qa=l.offset),c.complete=!0,l.k=0==c.item.H&&0==k,l.l=c.item.H==a.b.b.length-1,P(b))})}}).then(function(){f=f||c.gb[a.R];var e=c.Ja[a.R];0>d&&(a.qa=kp(c.Ba,e));if(f)O(b,f);else{var h=cq(a,c,e);op(c.Ba,h,e).then(function(d){h.I.style.display=
"none";h.I.style.visibility="visible";h.I.style.position="";h.I.style.top="";h.I.style.left="";h.I.setAttribute("data-vivliostyle-page-side",h.g);c.Ba.viewport.d.appendChild(h.I);d=(e=d)?e.d-1:c.Ja.length-1;a.g(c.Ba.W,c.item.H,d);e?(c.gb[d]=h,c.Ja[a.R+1]=e):(c.gb.push(h),c.complete=!0,h.l=c.item.H==a.b.b.length-1);h.k=0==c.item.H&&0==d;O(b,h)})}})}else O(b,null)});return N(b)}n.ad=function(){return dq(this,this.b.b.length-1,Number.POSITIVE_INFINITY)};
function dq(a,b,c){var d=K("renderAllPages"),e=a.H,f=a.R;a.H=0;of(function(d){a.R=a.H==b?c:Number.POSITIVE_INFINITY;aq(a).then(function(){++a.H>b?P(d):qf(d)})}).then(function(){a.H=e;a.R=f;aq(a).ta(d)});return N(d)}n.Md=function(){this.R=this.H=0;return aq(this)};n.Nd=function(){this.H=this.b.b.length-1;this.R=Number.POSITIVE_INFINITY;return aq(this)};
n.nextPage=function(){var a=this,b=K("nextPage");bq(a).then(function(c){if(c){if(c.complete&&a.R==c.Ja.length-1){if(a.H>=a.b.b.length-1){O(b,null);return}a.H++;a.R=0}else a.R++;aq(a).ta(b)}else O(b,null)});return N(b)};n.Zc=function(){if(0==this.R){if(0==this.H)return M(null);this.H--;this.R=Number.POSITIVE_INFINITY}else this.R--;return aq(this)};function eq(a,b){var c="left"===b.g,d="ltr"===a.mb();return!c&&d||c&&!d}
function fq(a){var b=K("getCurrentSpread"),c=$p(a);if(!c)return M({left:null,right:null});var d=a.H,e=a.R,f="left"===c.g;(eq(a,c)?a.Zc():a.nextPage()).then(function(g){a.H=d;a.R=e;aq(a).then(function(){f?O(b,{left:c,right:g}):O(b,{left:g,right:c})})});return N(b)}n.Sd=function(){var a=$p(this);if(!a)return M(null);var a=eq(this,a),b=this.nextPage();if(a)return b;var c=this;return b.Bc(function(){return c.nextPage()})};
n.Vd=function(){var a=$p(this);if(!a)return M(null);var a=eq(this,a),b=this.Zc();if(a){var c=this;return b.Bc(function(){return c.Zc()})}return b};function gq(a,b){var c=K("navigateToEPage");Xp(a.b,b).then(function(b){b&&(a.H=b.H,a.R=b.R,a.qa=b.qa);aq(a).ta(c)});return N(c)}function hq(a,b){var c=K("navigateToCFI");Wp(a.b,b).then(function(b){b&&(a.H=b.H,a.R=b.R,a.qa=b.qa);aq(a).ta(c)});return N(c)}
function iq(a,b){v.debug("Navigate to",b);var c=Sp(a.b,ta(b));if(null==c&&(a.b.f&&b.match(/^#epubcfi\(/)&&(c=Sp(a.b,a.b.f.url)),null==c))return M(null);var d=a.b.h[c];if(!d)return a.b.f&&c==Sp(a.b,a.b.f.url)&&(c=b.indexOf("#"),0<=c)?hq(a,b.substr(c+1)):M(null);d.H!=a.H&&(a.H=d.H,a.R=0);var e=K("navigateTo");bq(a).then(function(c){var d=Ch(c.ba,b);d&&(a.qa=xh(c.ba,d),a.R=-1);aq(a).ta(e)});return N(e)}
function cq(a,b,c){var d=b.Ba.viewport,e=d.b.createElement("div");e.setAttribute("data-vivliostyle-page-container",!0);e.style.position="absolute";e.style.top="0";e.style.left="0";ja||(e.style.visibility="hidden");d.root.appendChild(e);var f=d.b.createElement("div");f.setAttribute("data-vivliostyle-bleed-box",!0);e.appendChild(f);f=new Xh(e,f);f.H=b.item.H;f.position=c;f.offset=kp(b.Ba,c);d!==a.viewport&&(a=$b(a.viewport.width,a.viewport.height,d.width,d.height),a=ig(null,new Tb(a,null)),f.h.push(new Uh(e,
"transform",a)));return f}function jq(a,b){var c=Qp();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=K("navigateToEPage"),f=gf(c);d.Push(function(){f.Ya(e)});return N(c)}return M(null)}
n.Vc=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=va(f,a.url),g=c.getAttribute("media-type");if(!g){var h=Sp(b.b,f);h&&(h=b.b.h[h])&&(g=h.d)}if(g&&(h=b.b.F[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Ma(f),l=Ma(g),g=new Ia;g.append(h);g.append("?src=");g.append(f);g.append("&type=");g.append(l);for(h=c.firstChild;h;h=h.nextSibling)1==h.nodeType&&
...
function bq(a){if(a.H>=a.b.b.length)return M(null);var b=a.Jb[a.H];if(b)return M(b);var c=a.b.b[a.H],d=a.b.e,e=K("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(zh(f)/2700),a.b.u=c.b);var g=d.b[f.url],h=a.Vc(f),l=a.viewport,k=gp(g,l.width,l.height,l.fontSize);if(k.width!=l.width||k.height!=l.height||k.fontSize!=l.fontSize)l=new Xm(l.f,k.fontSize,l.root,k.width,k.height);var k=a.Jb[a.H-1],m=new hp(g,f,a.b.lang,l,a.e,a.f,h,a.b.w,k?k.Ba.na+k.gb.length:0);k&&
ap(m.l,k.Ba.l);m.S=a.S;ip(m).then(function(){b={item:c,ba:f,Ba:m,Ja:[null],gb:[],complete:!1};a.Jb[a.H]=b;O(e,b)})});return N(e)}function kq(a){return{H:a.H,R:a.R,qa:a.qa}}function lq(a,b){b?(a.H=b.H,a.R=-1,a.qa=b.qa):(a.H=0,a.R=0,a.qa=0);return dq(a,a.H,a.R)}
n.tc=function(){var a=this.b,b=a.D||a.N;if(!b)return M(null);var c=K("showTOC");this.d||(this.d=new yp(a.e,b.src,a.lang,this.e,this.f,this.S,this,a.w));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";e.style.border=
"1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.d.tc(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";O(c,a)});return N(c)};n.qc=function(){this.d&&this.d.qc()};n.pd=function(){return this.d&&this.d.pd()};function mq(a,b,c,d){var e=this;this.h=a;this.ib=b;b.setAttribute("data-vivliostyle-viewer-viewport",!0);b.setAttribute("data-vivliostyle-viewer-status","loading");this.Oa=c;this.Na=d;a=a.document;this.ma=new ph(a.head,b);this.G=[];this.g=null;this.F=this.d=!1;this.f=this.j=this.e=this.l=null;this.fontSize=16;this.zoom=1;this.aa=!1;this.ad=!0;this.S=Wb();this.D=function(){};this.k=function(){};this.W=function(){e.d=!0;e.D()};this.u=function(){};this.w=a.getElementById("vivliostyle-page-rules");this.N=
...
mq.prototype.na=function(a){bo.b("loadEPUB");bo.b("loadFirstPage");this.ib.setAttribute("data-vivliostyle-viewer-status","loading");var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet;this.viewport=null;var f=K("loadEPUB"),g=this;g.B(a).then(function(){var a=new Bp;if(e)for(var l=0;l<e.length;l++)xp(a,e[l]);wp(a).then(function(){var e=va(b,g.h.location.href);g.G=[e];Dp(a,e,d).then(function(a){g.g=a;Wp(g.g,c).then(function(a){g.f=a;pq(g).then(function(){g.ib.setAttribute("data-vivliostyle-viewer-status",
"complete");bo.d("loadEPUB");oq(g,{t:"loaded",metadata:g.g.l});O(f,!0)})})})})});return N(f)};
mq.prototype.Fa=function(a){bo.b("loadXML");bo.b("loadFirstPage");this.ib.setAttribute("data-vivliostyle-viewer-status","loading");var b;"string"===typeof a.url?b=[a.url]:b=a.url;var c=a.document,d=a.fragment,e=a.userStyleSheet;this.viewport=null;var f=K("loadXML"),g=this;g.B(a).then(function(){var a=new Bp;if(e)for(var l=0;l<e.length;l++)xp(a,e[l]);wp(a).then(function(){var e=b.map(function(a){return va(a,g.h.location.href)});g.G=e;g.g=new Fp(a,"");Up(g.g,e,c).then(function(){Wp(g.g,d).then(function(a){g.f=
a;pq(g).then(function(){g.ib.setAttribute("data-vivliostyle-viewer-status","complete");bo.d("loadXML");oq(g,{t:"loaded"});O(f,!0)})})})})});return N(f)};function qq(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*lc.ex*a.fontSize/lc.em;if(d=lc[d])return c*d}return c}
mq.prototype.B=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.l=null,this.h.addEventListener("resize",this.W,!1),this.d=!0):this.h.removeEventListener("resize",this.W,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.d=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:qq(this,b["margin-left"])||0,marginRight:qq(this,b["margin-right"])||0,marginTop:qq(this,b["margin-top"])||0,marginBottom:qq(this,b["margin-bottom"])||
0,width:qq(this,b.width)||0,height:qq(this,b.height)||0},200<=b.width||200<=b.height)&&(this.h.removeEventListener("resize",this.W,!1),this.l=b,this.d=!0);"boolean"==typeof a.hyphenate&&(this.S.Pc=a.hyphenate,this.d=!0);"boolean"==typeof a.horizontal&&(this.S.Oc=a.horizontal,this.d=!0);"boolean"==typeof a.nightMode&&(this.S.Wc=a.nightMode,this.d=!0);"number"==typeof a.lineHeight&&(this.S.lineHeight=a.lineHeight,this.d=!0);"number"==typeof a.columnWidth&&(this.S.Lc=a.columnWidth,this.d=!0);"string"==
typeof a.fontFamily&&(this.S.fontFamily=a.fontFamily,this.d=!0);"boolean"==typeof a.load&&(this.aa=a.load);"boolean"==typeof a.renderAllPages&&(this.ad=a.renderAllPages);"string"==typeof a.userAgentRootURL&&(ua=a.userAgentRootURL);"boolean"==typeof a.spreadView&&a.spreadView!==this.S.$a&&(this.viewport=null,this.S.$a=a.spreadView,this.d=!0);"number"==typeof a.pageBorder&&a.pageBorder!==this.S.Ib&&(this.viewport=null,this.S.Ib=a.pageBorder,this.d=!0);"number"==typeof a.zoom&&a.zoom!==this.zoom&&(this.zoom=
...
function uq(a){var b=K("reportPosition");a.f||(a.f=kq(a.b));Vp(a.g,a.f.H,a.f.qa).then(function(c){var d=a.e;(a.aa&&0<d.f.length?tg(d.f):M(!0)).then(function(){vq(a,d,c).ta(b)})});return N(b)}function wq(a){var b=a.ib;if(a.l){var c=a.l;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new Xm(a.h,a.fontSize,b,c.width,c.height)}return new Xm(a.h,a.fontSize,b)}
function xq(a){if(a.l||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=wq(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.Jb;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.gb,d=0;d<c.length;d++){var e=c[d];if(e.G&&e.F){a=!0;break a}}}a=!1}b=!a}return b}
...
function yq(a){if(a.b){a.b.qc();for(var b=a.b.Jb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.gb,e;e=d.shift();)e=e.I,e.parentNode.removeChild(e)}}a.w&&(a.w.textContent="",a.N=!1);a.viewport=wq(a);b=a.viewport;w(b.e,"width","");w(b.e,"height","");w(b.d,"width","");w(b.d,"height","");w(b.d,"transform","");a.b=new Zp(a.g,a.viewport,a.ma,a.S,a.Ua.bind(a))}
function zq(a,b){a.F=!1;if(a.S.$a)return fq(a.b).Bc(function(c){rq(a);a.j=c;c.left&&(sq(a,c.left),c.right||c.left.I.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(sq(a,c.right),c.left||c.right.I.setAttribute("data-vivliostyle-unpaired-page",!0));c=Aq(a,c);a.viewport.zoom(c.width,c.height,a.zoom);a.e=b;return M(null)});tq(a,b);a.viewport.zoom(b.d.width,b.d.height,a.zoom);a.e=b;return M(null)}
function Aq(a,b){var c=0,d=0;b.left&&(c+=b.left.d.width,d=b.left.d.height);b.right&&(c+=b.right.d.width,d=Math.max(d,b.right.d.height));b.left&&b.right&&(c+=2*a.S.Ib);return{width:c,height:d}}var Bq={fe:"fit inside viewport"};
function pq(a){a.d=!1;if(xq(a))return M(!0);"complete"===a.ib.getAttribute("data-vivliostyle-viewer-status")&&a.ib.setAttribute("data-vivliostyle-viewer-status","resizing");oq(a,{t:"resizestart"});var b=K("resize");a.b&&!a.f&&(a.f=kq(a.b));yq(a);lq(a.b,a.f).then(function(c){zq(a,c).then(function(){uq(a).then(function(c){bo.d("loadFirstPage");(a.ad?a.b.ad():M(null)).then(function(){a.ib.setAttribute("data-vivliostyle-viewer-status","complete");oq(a,{t:"resizeend"});O(b,c)})})})});return N(b)}
function vq(a,b,c){var d=K("sendLocationNotification"),e={t:"nav",first:b.k,last:b.l};Yp(a.g,a.f).then(function(b){e.epage=b;e.epageCount=a.g.u;c&&(e.cfi=c);oq(a,e);O(d,!0)});return N(d)}mq.prototype.mb=function(){return this.b?this.b.mb():null};
mq.prototype.Ma=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.S.$a?this.b.Sd:this.b.nextPage;break;case "previous":a=this.S.$a?this.b.Vd:this.b.Zc;break;case "last":a=this.b.Nd;break;case "first":a=this.b.Md;break;default:return M(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return gq(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return iq(b.b,d)}}else return M(!0);var e=K("nextPage");a.call(b.b).then(function(a){a?(b.f=
...
function Eq(a,b){var c=Dq(b),d=null;Ze(function(){var b=K("commandLoop"),f=Se.d;a.u=function(b){var c=a.G.some(function(a){return b.href.substr(0,a.length)==a}),d={t:"hyperlink",href:b.href,internal:c};$e(f,function(){oq(a,d);return M(!0)})};of(function(b){if(a.d)pq(a).then(function(){qf(b)});else if(a.F)a.e&&zq(a,a.e).then(function(){qf(b)});else if(c){var e=c;c=null;Cq(a,e).then(function(){qf(b)})}else e=K("waitForCommand"),d=gf(e,self),N(e).then(function(){qf(b)})}).ta(b);return N(b)});a.D=function(){var a=
d;a&&(d=null,a.Ya())};a.k=function(b){if(c)return!1;c=Dq(b);a.D();return!0};a.h.adapt_command=a.k};Array.b||(Array.b=function(a,b,c){b&&c&&(b=b.bind(c));c=[];for(var d=a.length,e=0;e<d;e++)c[e]=b?b(a[e]):a[e];return c});Object.Sb||(Object.Sb=function(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]});return a});function Fq(a){var b={};Object.keys(a).forEach(function(c){var d=a[c];switch(c){case "autoResize":b.autoresize=d;break;case "pageBorderWidth":b.pageBorder=d;break;default:b[c]=d}});return b}function Gq(a,b){ja=a.debug;this.f=a;this.b=new mq(a.window||window,a.viewportElement,"main",this.Ld.bind(this));this.e={autoResize:!0,fontSize:16,pageBorderWidth:1,renderAllPages:!0,spreadView:!1,zoom:1};b&&this.Gd(b);this.d=new Xa}n=Gq.prototype;
n.Gd=function(a){var b=Object.Sb({a:"configure"},Fq(a));this.b.k(b);Object.Sb(this.e,a)};n.Ld=function(a){var b={type:a.t};Object.keys(a).forEach(function(c){"t"!==c&&(b[c]=a[c])});Ya(this.d,b)};n.Xd=function(a,b){this.d.addEventListener(a,b,!1)};n.$d=function(a,b){this.d.removeEventListener(a,b,!1)};n.Od=function(a,b,c){a||Ya(this.d,{type:"error",content:"No URL specified"});Hq(this,a,null,b,c)};n.Yd=function(a,b,c){a||Ya(this.d,{type:"error",content:"No URL specified"});Hq(this,null,a,b,c)};
function Hq(a,b,c,d,e){d=d||{};var f,g=d.userStyleSheet;g&&(f=g.map(function(a){return{url:a.url||null,text:a.text||null}}));e&&Object.Sb(a.e,e);b=Object.Sb({a:b?"loadXML":"loadEPUB",userAgentRootURL:a.f.userAgentRootURL,url:b||c,document:d.documentObject,fragment:d.fragment,userStyleSheet:f},Fq(a.e));Eq(a.b,b)}n.mb=function(){return this.b.mb()};
n.Qd=function(a){a:switch(a){case "left":a="ltr"===this.mb()?"previous":"next";break a;case "right":a="ltr"===this.mb()?"next":"previous";break a}this.b.k({a:"moveTo",where:a})};n.Pd=function(a){this.b.k({a:"moveTo",url:a})};n.Zd=function(a){var b;a:{b=this.b;if(!b.e)throw Error("no page exists.");switch(a){case "fit inside viewport":a=b.S.$a?Aq(b,b.j):b.e.d;b=Math.min(b.viewport.width/a.width,b.viewport.height/a.height);break a;default:throw Error("unknown zoom type: "+a);}}return b};
ca("vivliostyle.viewer.Viewer",Gq);Gq.prototype.setOptions=Gq.prototype.Gd;Gq.prototype.addListener=Gq.prototype.Xd;Gq.prototype.removeListener=Gq.prototype.$d;Gq.prototype.loadDocument=Gq.prototype.Od;Gq.prototype.loadEPUB=Gq.prototype.Yd;Gq.prototype.getCurrentPageProgression=Gq.prototype.mb;Gq.prototype.navigateToPage=Gq.prototype.Qd;Gq.prototype.navigateToInternalUrl=Gq.prototype.Pd;Gq.prototype.queryZoomFactor=Gq.prototype.Zd;ca("vivliostyle.viewer.ZoomType",Bq);Bq.FIT_INSIDE_VIEWPORT="fit inside viewport";
Yn.call(bo,"load_vivliostyle","end",void 0);var Iq=16,Jq="ltr";function Kq(a){window.adapt_command(a)}function Lq(){Kq({a:"moveTo",where:"ltr"===Jq?"previous":"next"})}function Mq(){Kq({a:"moveTo",where:"ltr"===Jq?"next":"previous"})}
...
function Oq(a){switch(a.t){case "loaded":a=a.viewer;var b=Jq=a.mb();a.ib.setAttribute("data-vivliostyle-page-progression",b);a.ib.setAttribute("data-vivliostyle-spread-view",a.S.$a);window.addEventListener("keydown",Nq,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",Lq,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",Mq,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
