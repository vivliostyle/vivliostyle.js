 ...
 *
 * Vivliostyle core 2019.1.100-pre.20190227010735
 */
(function(factory) {
...
function $t(a,b){this.h=a;this.C=this.g=this.b=this.u=this.j=null;this.G=b;this.N=null;this.Z={};this.lang=null;this.l=0;this.F=!1;this.S=!0;this.A=null;this.f={};this.ca=this.Yb=this.lf=null;this.Y={};this.J=null;this.H=pu(this);nu()&&(Jh["http://www.w3.org/1998/Math/MathML"]=!0)}
...
function au(a,b,c){b.readingProgression&&(a.J=b.readingProgression);void 0===a.f&&(a.f={});var d=c&&c.title||b.name||b.metadata&&b.metadata.title;d&&(a.f[ju]=[{v:d}]);var e=qu(a,a.G);!b.readingOrder&&c&&null!==e&&(b.readingOrder=[encodeURI(e)],Array.from(c.querySelectorAll("[role=doc-toc] a[href],[role=directory] a[href],nav li a[href],.toc a[href],#toc a[href]")).forEach(function(c){var d=qu(a,ya(c.href));c=d?encodeURI(d):c.href;-1==b.readingOrder.indexOf(c)&&b.readingOrder.push(c)}));var f=[],g=
0,h=-1;[b.readingOrder,b.resources].forEach(function(c){c instanceof Array&&c.forEach(function(c){var d=b.readingOrder.includes(c),e="string"===typeof c?c:c.url||c.href,k="string"===typeof c?"":c.oh||c.href&&c.type||"";if(d||"text/html"===k||"application/xhtml+xml"===k||/(^|\/)([^/]+\.(x?html|htm|xht)|[^/.]*)([#?]|$)/.test(e))d={url:Ba(Ea(e),a.G),index:g++,wb:null,nc:null},"contents"===c.rel&&-1===h&&(h=d.index),f.push(d)})});var l=L("initWithWebPubManifest");uu(a,f).then(function(){-1!==h&&(a.Yb=
a.u[h]);a.Yb||(a.Yb=a.C[e]);O(l,!0)});return l.result()}function vu(a,b,c){var d=a.b[b],e=L("getCFI");a.h.load(d.src).then(function(a){var b=kk(a,c),f=null;b&&(a=ik(a,b,0,!1),f=new ub,xb(f,b,c-a),d.j&&xb(f,d.j,0),f=f.toString());O(e,f)});return e.result()}
