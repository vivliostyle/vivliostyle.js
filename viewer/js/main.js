 ...
 *
 * Vivliostyle core 2016.10.1-pre.20170221070839
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
function un(a,b,c,d){if(a.g&&a.g[a.g.length-1].b)return tn(a,b,c),L(!0);var e=new Rf(a.V,a.ya,a.X,a.kb),f=ng(a.J,e);f&&(d=Math.max(d,f.R*Hk(a)));d+=40*Hk(a);var g=a.O,h=!g;if(h){f=a.element.ownerDocument.createElement("div");v(f,"position","absolute");var l=a.j.clone(),k=new Zl(a.f,"column",null,a.f.h,c.ma[0].node,null,null),g=new Xm(f,l,a.b,a.Va,k);g.ac=!1;cm(k,g);a.O=g;g.u=vn(a.j,a.u,f);g.ve=!0;a.u?(g.left=0,v(g.element,"width","2em")):(g.top=a.kb,v(g.element,"height","2em"))}a.element.appendChild(g.element);
...
function bo(a,b,c,d,e){var f;if(!(f=!b))a:{for(f=b.D;f;){if(f.parentNode===f.ownerDocument){f=!1;break a}f=f.parentNode}f=!0}if(f)return!1;f=Km(b,a.b,0,a.u);var g=b.M?b.parent&&b.parent.L:b.L;g&&(g=g.dc())&&(f+=(a.u?-1:1)*Sm(g));g=Tm(a,f);c&&(f+=Sn(a,c));En(a,f);if((d=a.h?d:!0)||!g)c=kk(b),b=Mm(b.L).g(c,e,g,a.ka),a.C.push(b);return g}
...
Fk(a),d=a.ab+a.top+Dk(a);e=new Rf(b,d,b+a.width,d+a.height);if(a.xa){b=a.xa;d=e.U;e=e.R;for(var f=[],g=0;g<b.b.length;g++){var h=b.b[g];f.push(new Sf(h.f+d,h.b+e))}b=new Xf(f)}else b=$f(e.U,e.R,e.T,e.N);a.J=kg(c,[b],Zm(a),a.pb,a.u);nn(a);a.g=null}function wn(a){a.Td=[];v(a.element,"width",a.width+"px");v(a.element,"height",a.height+"px");yn(a);a.ka=0;a.Yd=!1;a.l=null;a.La=null}function En(a,b){a.ka=Math.max(Hk(a)*(b-a.ya),a.ka)}
...
J||wm(G)||um(G),wm(G)?(yc=0,a.b=z.clone(),G.Bc=!1,P(b)):(zc=c,zc.l&&"column"!=zc.l&&(yc=J,"region"!=zc.l&&(a.V[H]=!0)),Ca=Math.max(Ca,zc.ka),yc<J?P(b):Q(b)))})}).then(function(){if(!wm(h)){zc.element===n&&(q=zc);q.ka=Ca;c.Wc(a,q,b,zc,J,a.g,a.h);var d=a.b.b[H];d&&"region"===d.f&&(d.f=null)}O(A,!0)});l=M(A)}else{if((l=ap(c,a,"content"))&&Pk(l)){r="span";l.url&&(r="img");var Kj=a.viewport.b.createElement(r);l.ba(new Ok(Kj,a,l));n.appendChild(Kj);"img"==r&&pp(c,a,Kj,a.h);op(c,a,q,a.h)}else c.xa&&(d.removeChild(n),
...
function hu(a,b){var c=a.L,d=gu(a),e=d.reduce(function(a){return a+1},0);if(0===e)return L(!0);var f=a.f.j,g=b.B;g.D.parentNode.removeChild(g.D);var h=I("layoutRowSpanningCellsFromPreviousFragment"),l=L(!0),k=0,m=[];d.forEach(function(a){l=l.oa(function(){var b=ik(a[0].Zd.ma[1],g.parent);return an(f,b,!1).oa(function(){function d(a){for(;h<a;){if(!(0<=m.indexOf(h))){var c=b.D.ownerDocument.createElement("td");v(c,"padding","0");b.D.appendChild(c)}h++}}var g=L(!0),h=0;a.forEach(function(a){g=g.oa(function(){var c=
