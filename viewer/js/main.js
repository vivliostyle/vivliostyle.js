 ...
 *
 * Vivliostyle core 2019.1.106-pre.20190610155329
 */
(function(factory) {
...
function Oa(a){var b=Ma[a];if(b||null===b)return b;switch(a){case "text-combine-upright":if(Na("-webkit-","text-combine")&&!Na("","text-combine-upright"))return Ma[a]=["-webkit-text-combine"],["-webkit-text-combine"];break;case "writing-mode":if(Na("-ms-","writing-mode"))return Ma[a]=["-ms-writing-mode"],["-ms-writing-mode"];break;case "filter":if(Na("-webkit-","filter"))return Ma[a]=["-webkit-filter"],["-webkit-filter"];break;case "clip-path":if(Na("-webkit-","clip-path"))return Ma[a]=["-webkit-clip-path",
"clip-path"];break;case "margin-inline-start":if(Na("-webkit-","margin-start"))return Ma[a]=["-webkit-margin-start"],["-webkit-margin-start"];break;case "margin-inline-end":if(Na("-webkit-","margin-end"))return Ma[a]=["-webkit-margin-end"],["-webkit-margin-end"];case "padding-inline-start":if(Na("-webkit-","padding-start"))return Ma[a]=["-webkit-padding-start"],["-webkit-padding-start"];break;case "padding-inline-end":if(Na("-webkit-","padding-end"))return Ma[a]=["-webkit-padding-end"],["-webkit-padding-end"]}for(var b=
t(La),c=b.next();!c.done;c=b.next())if(c=c.value,Na(c,a))return b=c+a,Ma[a]=[b],[b];w.b("Property not supported by the browser: ",a);return Ma[a]=null}function x(a,b,c){try{var d=Oa(b);d&&d.forEach(function(b){if("-ms-writing-mode"===b)switch(c){case "horizontal-tb":c="lr-tb";break;case "vertical-rl":c="tb-rl";break;case "vertical-lr":c="tb-lr"}else if("-webkit-text-combine"===b)switch(c){case "all":c="horizontal"}a&&a.style&&a.style.setProperty(b,c)})}catch(e){w.b(e)}}
function Pa(a,b,c){try{var d=Ma[b];return a.style.getPropertyValue(d?d[0]:b)}catch(e){}return c||""}function Qa(a){var b=a.getAttributeNS("http://www.w3.org/XML/1998/namespace","lang");b||"http://www.w3.org/1999/xhtml"!=a.namespaceURI||(b=a.getAttribute("lang"));return b}function Ra(){this.b=[]}Ra.prototype.append=function(a){this.b.push(a);return this};Ra.prototype.toString=function(){var a=this.b.join("");this.b=[a];return a};function Sa(a){return"\\"+a.charCodeAt(0).toString(16)+" "}
function Ta(a){return a.replace(/[^-_a-zA-Z0-9\u0080-\uFFFF]/g,Sa)}function Ua(a){return a.replace(/[\u0000-\u001F"\\]/g,Sa)}function Va(a){return a.replace(/[\s+&?=#\u007F-\uFFFF]+/g,encodeURIComponent)}function Wa(a){return!!a.match(/^[a-zA-Z\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u024F\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]$/)}function Ga(a,b){return a.replace(/[^-a-zA-Z0-9_]/g,function(a){return("string"===typeof b?b:"\\u")+(65536|a.charCodeAt(0)).toString(16).substr(1)})}
...
sb.prototype.g=function(a){a.append(":");a.append(this.offset.toString());if(this.f||this.b||this.Hb){a.append("[");if(this.f||this.b)this.f&&a.append(this.f.replace(/[\[\]\(\),=;^]/g,mb)),a.append(","),this.b&&a.append(this.b.replace(/[\[\]\(\),=;^]/g,mb));this.Hb&&(a.append(";s="),a.append(this.Hb));a.append("]")}};function ub(){this.pa=null}
...
if(!c)throw Error("E_CFI_NUMBER_EXPECTED");e+=c[0].length;g=parseInt(c[1],10);(h=c[4])&&(h=ob(h));var l=c[7];l&&(l=ob(l));c=pb(c[10]);f.push(new sb(g,h,l,Ia(c.s)));break;case "!":e++;f.push(new qb);break;case "~":case "@":case "":a.pa=f;return;default:throw Error("E_CFI_PARSE_ERROR");}}function wb(a,b){for(var c={node:b.documentElement,offset:0,K:!1,Hb:null,sd:null},d=0;d<a.pa.length;d++)if(!a.pa[d].h(c)){c.sd=new ub;c.sd.pa=a.pa.slice(d+1);break}return c}
...
S(h);a.b=Qf;l.splice(0,l.length);continue;case 29:a.b=Pf;g.Tb();continue;case 1:if(!k.b){a.b=Uf;g.error("E_CSS_SPACE_EXPECTED",k);continue}g.cc();case 2:if(34==tf(h,1).type)if(S(h),S(h),p=a.N[k.text],null!=p)switch(k=R(h),k.type){case 1:g.Wb(p,k.text);a.b=f?Nf:T;S(h);break;case 36:g.Wb(p,null);a.b=f?Nf:T;S(h);break;default:a.b=Sf,g.error("E_CSS_NAMESPACE",k)}else a.b=Sf,g.error("E_CSS_UNDECLARED_PREFIX",k);else g.Wb(a.I,k.text),a.b=f?Nf:T,S(h);continue;case 3:if(!k.b){a.b=Uf;g.error("E_CSS_SPACE_EXPECTED",
k);continue}g.cc();case 4:if(34==tf(h,1).type)switch(S(h),S(h),k=R(h),k.type){case 1:g.Wb(null,k.text);a.b=f?Nf:T;S(h);break;case 36:g.Wb(null,null);a.b=f?Nf:T;S(h);break;default:a.b=Sf,g.error("E_CSS_NAMESPACE",k)}else g.Wb(a.I,null),a.b=f?Nf:T,S(h);continue;case 5:k.b&&g.cc();case 6:g.ze(k.text);a.b=f?Nf:T;S(h);continue;case 7:k.b&&g.cc();case 8:g.oe(k.text);a.b=f?Nf:T;S(h);continue;case 55:k.b&&g.cc();case 14:S(h);k=R(h);b:switch(k.type){case 1:g.qd(k.text,null);S(h);a.b=f?Nf:T;continue;case 6:m=
...
null);a.b=f?Nf:T;S(h);continue;case 6:m=k.text;S(h);if("nth-fragment"==m){if(p=bg(a),!p)break}else p=ag(a);k=R(h);if(11==k.type){g.rd(m,p);a.b=f?Nf:T;S(h);continue}}g.error("E_CSS_PSEUDOELEM_SYNTAX",k);a.b=Sf;continue;case 9:k.b&&g.cc();case 10:S(h);k=R(h);if(1==k.type)m=k.text,S(h);else if(36==k.type)m=null,S(h);else if(34==k.type)m="";else{a.b=Uf;g.error("E_CSS_ATTR",k);S(h);continue}k=R(h);if(34==k.type){p=m?a.N[m]:m;if(null==p){a.b=Uf;g.error("E_CSS_UNDECLARED_PREFIX",k);S(h);continue}S(h);k=
...
3==a.j?Zf(a,"E_CSS_UNEXPECTED_BRC",k):(1==a.j?g.Fc(l.pop()):(k=l.pop(),g.Fc(k)),a.h.push("media"),g.La(),a.b=Lf));S(h);continue;case 49:if($f(a,11,k))if(a.g||3!=a.j)Zf(a,"E_CSS_UNEXPECTED_SEMICOL",k);else return a.B=l.pop(),a.G=!0,a.b=Lf,S(h),!1;S(h);continue;case 40:l.push(k.type);S(h);continue;case 27:a.b=Lf;S(h);g.dc();a.h.length&&a.h.pop();continue;case 30:m=k.text.toLowerCase();switch(m){case "import":S(h);k=R(h);if(2==k.type||8==k.type){a.J=k.text;S(h);k=R(h);if(17==k.type||0==k.type)return a.G=
...
function gg(a,b,c,d,e){var f=L("parseStylesheet"),g=new Wf(Lf,a,b,c),h=null;e&&(h=hg(new rf(e,b),b,c));if(h=cg(g,d,h&&h.Aa()))b.Fc(h),b.La();Ee(function(){for(var a={};!eg(g,100,!1,!1,!1,!1);){if(g.G){var d=Ba(g.J,c);g.B&&(b.Fc(g.B),b.La());a.Ce=L("parseStylesheet.import");ig(d,b,null,null).then(function(a){return function(){g.B&&b.dc();g.G=!1;g.J=null;g.B=null;O(a.Ce,!0)}}(a));return a.Ce.result()}d=Ce();if(d.Xa)return d;a={Ce:a.Ce}}return M(!1)}).then(function(){h&&b.dc();O(f,!0)});return f.result()}
...
n.he=function(a){return this.b&64?a:null};n.bd=function(a){return this.b&128?a:null};n.Ub=function(){return null};n.qc=function(){return null};n.Xb=function(){return null};n.Yc=function(a){return this.b&2046?a:null};var Yg=new $g(0,V,V);
...
n.Zc=function(a){return this.Db(a)};n.he=function(a){return this.Db(a)};n.bd=function(a){return this.Db(a)};n.Ub=function(){return null};n.qc=function(){return null};n.Xb=function(a){return this.Db(a)};n.Yc=function(){return null};function eh(a){ch.call(this,a)}v(eh,ch);eh.prototype.Ub=function(a){var b=dh(this,a.values,!1,0);return b===a.values?a:b?new Hc(b):null};
eh.prototype.qc=function(a){for(var b=this.f,c=!1;b;){if(b.eb instanceof fh){c=!0;break}b=b.f}return c?(b=dh(this,a.values,!1,0),b===a.values?a:b?new Ic(b):null):null};eh.prototype.h=function(a,b){return dh(this,a,!0,b)};function fh(a){ch.call(this,a)}v(fh,ch);fh.prototype.Ub=function(a){return this.Db(a)};fh.prototype.qc=function(a){var b=dh(this,a.values,!1,0);return b===a.values?a:b?new Ic(b):null};fh.prototype.h=function(a,b){for(var c=this.f,d;c!==this.g;){if(d=c.eb.h(a,b))return d;c=c.f}return null};
...
rh.prototype.qc=function(a){a.values[0].fa(this);if(this.error)return null;for(var b=[this.values["font-family"]],c=1;c<a.values.length;c++)b.push(a.values[c]);a=new Ic(b);a.fa(this.b.g["font-family"])?this.values["font-family"]=a:this.error=!0;return null};rh.prototype.rc=function(a){if(a=this.b.f[a.name])for(var b in a)this.values[b]=a[b];else this.error=!0;return null};var sh={SIMPLE:nh,INSETS:oh,INSETS_SLASH:ph,COMMA:qh,FONT:rh};
...
aj.prototype.rc=function(a){var b=this.f,c=b.J,d=Math.floor(c.length/2)-1;switch(a.name){case "open-quote":a=c[2*Math.min(d,b.D)];b.D++;break;case "close-quote":return 0<b.D&&b.D--,c[2*Math.min(d,b.D)+1];case "no-open-quote":return b.D++,new Oc("");case "no-close-quote":return 0<b.D&&b.D--,new Oc("")}return a};
...
n.La=function(){Nj(this);If.prototype.La.call(this);1==this.u&&(this.u=0)};n.dc=function(){If.prototype.dc.call(this)};function Nj(a){if(a.b){var b=a.ba+a.l.nf();Kj(a,a.Xf(b));a.b=null;a.h=null;a.j=null;a.D=!1;a.ba=0}}n.Xf=function(a){var b=this.G;this.D&&(b=b?"xxx-bogus-xxx":"footnote");return new ki(this.mb,a,this.h,b,this.j)};n.Qb=function(a,b,c){Dh(this.B,a,b,c,this)};n.kd=function(a,b){Jf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};
...
function Xk(a,b,c){this.M=a;this.parent=b;this.Ma=c;this.na=0;this.K=!1;this.kb=Vk;this.wa=b?b.wa:null;this.Fa=this.Ja=null;this.Ba=!1;this.ya=!0;this.xa=!1;this.j=b?b.j:0;this.display=null;this.W=al;this.ca=this.N=this.l=this.Ca=null;this.Z="baseline";this.la="top";this.ta=this.sa=0;this.I=!1;this.uc=b?b.uc:0;this.F=b?b.F:null;this.B=b?b.B:!1;this.S=this.hd=!1;this.D=this.A=this.G=this.g=null;this.h=b?b.h:{};this.b=b?b.b:!1;this.direction=b?b.direction:"ltr";this.f=b?b.f:null;this.Qa=this.lang=null;
this.C=b?b.C:null;this.u=null;this.ua={};this.Sa=1;this.Y=this.J=null}function bl(a){a.ya=!0;a.j=a.parent?a.parent.j:0;a.A=null;a.D=null;a.na=0;a.K=!1;a.display=null;a.W=al;a.Ca=null;a.l=null;a.N=null;a.ca=null;a.Z="baseline";a.I=!1;a.uc=a.parent?a.parent.uc:0;a.F=a.parent?a.parent.F:null;a.B=a.parent?a.parent.B:!1;a.g=null;a.G=null;a.Ja=null;a.hd=!1;a.S=!1;a.b=a.parent?a.parent.b:!1;a.Ja=null;a.Qa=null;a.C=a.parent?a.parent.C:null;a.u=null;a.ua={};a.Sa=1;a.J=null;a.Y=null}
...
function ur(a,b,c,d,e,f){var g=L("createRefShadow");a.da.u.load(b).then(function(h){if(h){var l=lk(h,b);if(l){var k=a.J,m=k.N[h.url];if(!m){var m=k.style.j.g[h.url],p=new Qb(0,k.jc(),k.ic(),k.u),m=new am(h,m.g,m.f,p,k.l,m.l,new Qp(k.h,h.url),new Rp(k.h,h.url,m.f,m.b));k.N[h.url]=m}f=new Zk(d,l,h,e,f,c,m)}}O(g,f)});return g.result()}
...
(H=!0);var tb;H?tb=a.g(f,a.w.parent?a.w.parent.A:null,k):tb=M(null);tb.then(function(g){g?H&&(d="true"==g.getAttribute("data-adapt-process-children")):g=Ir(a,Da,N);"a"==N&&g.addEventListener("click",a.page.J,!1);na&&($o(a,a.w,"inner",na),g.appendChild(na));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&mr(g);var h=a.w.h["image-resolution"],l=[],m=k.width,p=k.height,q=f.getAttribute("width"),r=f.getAttribute("height"),m=m===Zc||!m&&!q,p=p===Zc||!p&&!r;if("http://www.gribuser.ru/xml/fictionbook/2.0"!=
f.namespaceURI||"td"==N){for(var q=f.attributes,u=q.length,r=null,z=0;z<u;z++){var A=q[z],I=A.namespaceURI,E=A.localName,A=A.nodeValue;if(I)if("http://www.w3.org/2000/xmlns/"==I)continue;else"http://www.w3.org/1999/xlink"==I&&"href"==E&&(A=zr(a,A));else{if(E.match(/^on/))continue;if("style"==E)continue;if(("id"==E||"name"==E)&&b){A=a.h.Re(A,a.da.url);g.setAttribute(E,A);Hk(a.page,g,A);continue}"src"==E||"href"==E||"poster"==E?(A=zr(a,A),"href"===E&&(A=a.h.oc(A,a.da.url))):"srcset"==E&&(A=A.split(",").map(function(b){return zr(a,
b.trim())}).join(","));if("poster"===E&&"video"===N&&"http://www.w3.org/1999/xhtml"===Da&&m&&p){var tb=new Image,Kp=Ke(tb,A);Ca.push(Kp);l.push({Rf:tb,element:g,Of:Kp})}}"http://www.w3.org/2000/svg"==Da&&/^[A-Z\-]+$/.test(E)&&(E=E.toLowerCase());Jr.includes(E.toLowerCase())&&(A=gr(A,a.da.url,a.h));I&&(tb=lr[I])&&(E=tb+":"+E);"src"!=E||I||"img"!=N&&"input"!=N||"http://www.w3.org/1999/xhtml"!=Da?"href"==E&&"image"==N&&"http://www.w3.org/2000/svg"==Da&&"http://www.w3.org/1999/xlink"==I?a.page.j.push(Ke(g,
A)):I?g.setAttributeNS(I,E,A):g.setAttribute(E,A):r=A}r&&(tb="input"===N?new Image:g,q=Ke(tb,r),tb!==g&&(g.src=r),m||p?(m&&p&&h&&1!==h&&l.push({Rf:tb,element:g,Of:q}),Ca.push(q)):a.page.j.push(q))}delete k.content;(m=k["list-style-image"])&&m instanceof Tc&&(m=m.url,Ca.push(Ke(new Image,m)));Kr(a,k);Lr(a,g,k);if(!a.w.ya&&(m=null,b?c&&(m=a.w.b?kr:jr):m="clone"!==a.w.h["box-decoration-break"]?a.w.b?ir:hr:a.w.b?kr:jr,m))for(var Lp in m)x(g,Lp,m[Lp]);K&&g.setAttribute("value",k["ua-list-item-count"].stringValue());
...
function gs(a){var b={width:$d,height:ae,$b:be,ac:be},c=a.size;if(c&&c.value!==Zc){var d=c.value;d.Ud()?(c=d.values[0],d=d.values[1]):(c=d,d=null);if(c.Ac())b.width=c,b.height=d||c;else if(c=c.name&&bs[c.name.toLowerCase()])d&&d===yd?(b.width=c.height,b.height=c.width):(b.width=c.width,b.height=c.height)}(c=a.marks)&&c.value!==J&&(b.ac=fs);a=a.bleed;a&&a.value!==Zc?a.value&&a.value.Ac()&&(b.$b=a.value):c&&(a=!1,c.value.Ud()?a=c.value.values.some(function(a){return a===jd}):a=c.value===jd,a&&(b.$b=
new F(6,"pt")));return b}function hs(a,b){var c={},d=a.$b.L*Sb(b,a.$b.ka,!1),e=a.ac.L*Sb(b,a.ac.ka,!1),f=d+e,g=a.width;c.jc=g===$d?b.$.vc?b.$.vc.width*Sb(b,"px",!1):(b.$.ub?Math.floor(b.Cb/2)-b.$.Dc:b.Cb)-2*f:g.L*Sb(b,g.ka,!1);g=a.height;c.ic=g===ae?b.$.vc?b.$.vc.height*Sb(b,"px",!1):b.Lc-2*f:g.L*Sb(b,g.ka,!1);c.$b=d;c.ac=e;c.qe=f;return c}
function is(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("width",b);a.setAttribute("height",c);a.style.position="absolute";return a}function js(a,b,c){a=a.createElementNS("http://www.w3.org/2000/svg",c||"polyline");a.setAttribute("stroke","black");a.setAttribute("stroke-width",b);a.setAttribute("fill","none");return a}var ks={kh:"top left",lh:"top right",Xg:"bottom left",Yg:"bottom right"};
...
Object.keys(f).forEach(function(a){var b=hs(gs(f[a]),this);this.xb[a]={width:b.jc+2*b.qe,height:b.ic+2*b.qe}},a);return b.result()}function lm(a,b,c){if(a=a.b)a.f[b.b]||(a.f[b.b]=c),c=a.b[b.b],c||(c=new ml,a.b[b.b]=c),c.b.push(new ll(new jl({pa:[{node:b.element,kb:Vk,wa:null,Ja:null,Fa:null,Sa:0}],na:0,K:!1,Qa:null}),b))}
...
function Gt(a,b,c){a.Y=b.jc;a.S=b.ic;a.Ba=b.jc+2*b.qe;a.ua=b.ic+2*b.qe;c.H.style.width=a.Ba+"px";c.H.style.height=a.ua+"px";c.h.style.left=b.ac+"px";c.h.style.right=b.ac+"px";c.h.style.top=b.ac+"px";c.h.style.bottom=b.ac+"px";c.h.style.padding=b.$b+"px";c.h.style.paddingTop=b.$b+.01+"px"}function Ht(a,b,c,d){Jj.call(this,a.j,a,b,c,d,a.h,!c);this.g=a;this.F=!1}v(Ht,Jj);n=Ht.prototype;n.ce=function(){};
n.be=function(a,b,c){a=new oq(this.g.u,a,b,c,this.g.G,this.ia,Ef(this.oa));Gf(this.g,new cr(a.f,this.g,a,this.B))};n.Fc=function(a){a=a.Mc;this.ia&&(a=Bc(this.f,this.ia,a));Gf(this.g,new Ht(this.g,a,this,this.G))};n.Zd=function(){Gf(this.g,new Pj(this.f,this.oa))};n.ae=function(){var a={};this.g.B.push({Ec:a,ia:this.ia});Gf(this.g,new Qj(this.f,this.oa,null,a,this.g.h))};n.$d=function(a){var b=this.g.l[a];b||(b={},this.g.l[a]=b);Gf(this.g,new Qj(this.f,this.oa,null,b,this.g.h))};
...
n.La=function(){Jj.prototype.La.call(this);if(this.F){this.F=!1;var a="R"+this.g.N++,b=D(a),c;this.ia?c=new Vh(b,0,this.ia):c=new W(b,0);bi(this.mb,"region-id").push(c);this.dc();a=new Ht(this.g,this.ia,this,a);Gf(this.g,a);a.La()}};
...
jw.prototype.Cd=function(a){var b=this.C,c=a.w,d=b.b;if(c.parent&&b.j===c.parent.M){switch(c.u){case "header":if(d.zc)c.u="none";else return aw(d,c),M(!0);break;case "footer":if(d.yc)c.u="none";else return bw(d,c),M(!0)}d.g||(d.g=c.M)}return Gm.prototype.Cd.call(this,a)};jw.prototype.tc=function(a){var b=this.C,c=a.w;c.M===b.j&&(b.b.J=a.ld&&a.ld.M,a.Vb=!0);return"header"===c.u||"footer"===c.u?M(!0):Gm.prototype.tc.call(this,a)};function nw(){}v(nw,Ip);
...
for(var e=d+c.rowSpan,f=Sw(b,d),g=0;f[g];)g++;for(;d<e;d++)for(var f=Sw(b,d),h=g;h<g+c.f;h++){var l=f[h]=new Gw(d,h,c);c.b||(c.b=l)}this.Ra++}}return Gm.prototype.tc.call(this,a)};n.uf=function(a){cx(this,a)};n.Df=function(a){cx(this,a)};n.kg=function(a){cx(this,a)};n.Cf=function(a){cx(this,a)};function cx(a,b){var c=b.w;c&&c.A&&!Eo(c)&&a.f.push(c.clone())}function bx(a,b){0<a.f.length&&Jo(a.h,b.w,a.f);a.f=[]}
function dx(a,b){this.gc=!0;this.C=a;this.f=b;this.l=!1;this.b=-1;this.g=0;this.u=b.u;b.u=!1}v(dx,Gm);var ex={"table-caption":!0,"table-column-group":!0,"table-column":!0};
function fx(a,b,c,d){var e=b.rowIndex,f=b.Ra,g=c.A;if(1<b.f){x(g,"box-sizing","border-box");for(var h=a.C.J,l=0,k=0;k<b.f;k++)l+=h[b.b.Ra+k];l+=a.C.S*(b.f-1);x(g,a.C.u?"height":"width",l+"px")}b=g.ownerDocument.createElement("div");g.appendChild(b);c=new Hw(a.f,b,c);a=a.C;(g=a.f[e])||(g=a.f[e]=[]);g[f]=c;1===d.f.pa.length&&d.f.K&&(c.f=!0);return Km(c.lc,d).Hc(!0)}function gx(a,b){var c=a.C.h[0];return c?c.bc.b.Ra===b:!1}
...
dx.prototype.tc=function(a){var b=a.w,c=this.C.b,d=b.display;"table-header-group"===d?c&&!c.h&&c.B===b.M?(this.j=!1,b.A.parentNode.removeChild(b.A)):x(b.A,"display","table-row-group"):"table-footer-group"===d&&(c&&!c.h&&c.l===b.M?(this.h=!1,b.A.parentNode.removeChild(b.A)):x(b.A,"display","table-row-group"));if(d&&ex[d])b.A.parentNode.removeChild(b.A);else if(b.M===this.C.F)b.xa=sp(this.f,b,null),this.f.u=this.u,a.Vb=!0;else return Gm.prototype.tc.call(this,a);return M(!0)};var zw=[];
