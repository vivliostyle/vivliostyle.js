 ...
 *
 * Vivliostyle core 2019.1.100-pre.20190203044319
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
c[1]+"//gist.githubusercontent.com/"+c[2]+"/raw/"+c[6];else if(c=/^(https?:)\/\/((?:[^/.]+\.)?)jsbin\.com\/(\w+)((?:\/\d+)?).*$/.exec(a))a=c[1]+"//"+c[2]+"output.jsbin.com/"+c[3]+c[4]+"/";return a}b.match(/^\w{2,}:\/\/[^\/]+$/)&&(b+="/");if(a.match(/^\/\//))return(c=b.match(/^(\w{2,}:)\/\//))?c[1]+a:a;if(a.match(/^\//))return(c=b.match(/^(\w{2,}:\/\/[^\/]+)\//))?c[1]+a:a;a.match(/^\.(\/|$)/)&&(a=a.substr(1));c=b;var d=c.match(/^([^#?]*)/);b=d?d[1]:c;if(a.match(/^\#/))return b+a;c=b.lastIndexOf("/");
