 ...
 *
 * Vivliostyle core 2019.1.100-pre.20190130142719
 */
(function(factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
...
(I=!0);var qb;I?qb=a.g(f,a.w.parent?a.w.parent.B:null,k):qb=M(null);qb.then(function(g){g?I&&(d="true"==g.getAttribute("data-adapt-process-children")):g=Fr(a,Da,N);"a"==N&&g.addEventListener("click",a.page.H,!1);la&&(Yo(a,a.w,"inner",la),g.appendChild(la));"iframe"==g.localName&&"http://www.w3.org/1999/xhtml"==g.namespaceURI&&jr(g);var h=a.w.h["image-resolution"],l=[],m=k.width,p=k.height,q=f.getAttribute("width"),r=f.getAttribute("height"),m=m===Wc||!m&&!q,p=p===Wc||!p&&!r;if("http://www.gribuser.ru/xml/fictionbook/2.0"!=
...
Iv.prototype.l=function(){var a=this.h,b="";Object.keys(a).forEach(function(c){for(var d=a[c],e=d.length,f=0;f<e;f++){var g=d[f];b+=c;1<e&&(b+="("+f+")");b+=" => start: "+g.start+", end: "+g.end+", duration: "+(g.end-g.start)+"\n"}});w.f(b)};Iv.prototype.u=function(){this.registerEndTiming=this.b=this.registerStartTiming=this.f=this.g=Hv};Iv.prototype.A=function(){this.g=Gv;this.registerStartTiming=this.f=Fv;this.registerEndTiming=this.b=Ev};
