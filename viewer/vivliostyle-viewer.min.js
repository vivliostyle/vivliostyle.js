...
function Fm(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=Gm(d,new Dm([c,e]),b);g.Ha&&(f.center=g.Ha);d=g.Ha||d.d();d=(b-d)/2;c.b()&&(f.start=d);e.b()&&(f.end=d)}else c=Gm(c,e,b),c.Ha&&(f.start=c.Ha),c.Hb&&(f.end=c.Hb);return f}
...
function Jm(a,b,c,d,e){this.b=a;this.h=b;this.f=c;this.d=d;this.e=e;this.g={};a=this.h;b=new Hc(a,"page-number");b=new zc(a,new Fc(a,b,new Yb(a,2)),a.b);c=new pc(a,b);a.values["recto-page"]=c;a.values["verso-page"]=b;"ltr"===mm(this.e)?(a.values["left-page"]=b,b=new pc(a,b),a.values["right-page"]=b):(c=new pc(a,b),a.values["left-page"]=c,a.values["right-page"]=b)}function Km(a){var b={};Xh(a.b,[],"",b);a.b.pop();return b}function Lm(a){this.b=null;this.f=a}t(Lm,W);
Lm.prototype.apply=function(a){a.I===this.f&&this.b.apply(a)};Lm.prototype.d=function(){return 3};Lm.prototype.e=function(a){this.b&&hh(a.xb,this.f,this.b);return!0};function Mm(a){this.b=null;this.f=a}t(Mm,W);Mm.prototype.apply=function(a){1===(new Hc(this.f,"page-number")).evaluate(a.d)&&this.b.apply(a)};Mm.prototype.d=function(){return 2};function Nm(a){this.b=null;this.f=a}t(Nm,W);Nm.prototype.apply=function(a){(new Hc(this.f,"left-page")).evaluate(a.d)&&this.b.apply(a)};Nm.prototype.d=function(){return 1};
function Om(a){this.b=null;this.f=a}t(Om,W);Om.prototype.apply=function(a){(new Hc(this.f,"right-page")).evaluate(a.d)&&this.b.apply(a)};Om.prototype.d=function(){return 1};function Pm(a){this.b=null;this.f=a}t(Pm,W);Pm.prototype.apply=function(a){(new Hc(this.f,"recto-page")).evaluate(a.d)&&this.b.apply(a)};Pm.prototype.d=function(){return 1};function Qm(a){this.b=null;this.f=a}t(Qm,W);Qm.prototype.apply=function(a){(new Hc(this.f,"verso-page")).evaluate(a.d)&&this.b.apply(a)};Qm.prototype.d=function(){return 1};
function Rm(a,b){fh.call(this,a,b,null,null)}t(Rm,fh);Rm.prototype.apply=function(a){var b=a.d,c=a.w,d=this.style,e=this.b;$g(b,c,d,e,null,null);if(d=d._marginBoxes){var c=Yg(c,"_marginBoxes"),f;for(f in d)if(d.hasOwnProperty(f)){var g=c[f];g||(g={},c[f]=g);$g(b,g,d[f],e,null,null);g.content&&(g.content=g.content.qc(new Gh(a,null)))}}};function Sm(a,b,c,d){ei.call(this,a,b,null,c,null,d,!1);this.f=""}t(Sm,ei);m=Sm.prototype;m.mb=function(){this.f+="@page ";this.Za()};
m.Sa=function(a,b){this.f+=b;b&&(this.b.push(new Lm(b)),this.d+=65536)};
m.yb=function(a,b){b&&kf(this,"E_INVALID_PAGE_SELECTOR :"+a+"("+b.join("")+")");this.f+=":"+a;switch(a.toLowerCase()){case "first":this.b.push(new Mm(this.e));this.d+=256;break;case "left":this.b.push(new Nm(this.e));this.d+=1;break;case "right":this.b.push(new Om(this.e));this.d+=1;break;case "recto":this.b.push(new Pm(this.e));this.d+=1;break;case "verso":this.b.push(new Qm(this.e));this.d+=1;break;default:kf(this,"E_INVALID_PAGE_SELECTOR :"+a)}};m.ha=function(){this.f+="{";ei.prototype.ha.call(this)};
m.Oa=function(){this.f+="}";document.getElementById("vivliostyle-page-rules").textContent+=this.f;ei.prototype.Oa.call(this)};m.Ea=function(a,b,c){"size"===a&&(this.f+="size: "+b.toString()+(c?"!important":"")+";");ei.prototype.Ea.call(this,a,b,c)};m.jd=function(a){hh(this.h.xb,"*",a)};m.nd=function(a){return new Rm(this.k,a)};m.Jc=function(a){var b=Yg(this.k,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);ff(this.Y,new Tm(this.e,this.Y,this.u,c))};
function Tm(a,b,c,d){gf.call(this,a,b,!1);this.d=c;this.b=d}t(Tm,hf);Tm.prototype.Ea=function(a,b,c){Gg(this.d,a,b,c,this)};Tm.prototype.wb=function(a,b){jf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Tm.prototype.dc=function(a,b){jf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};Tm.prototype.Xa=function(a,b,c){Xg(this.b,a,new V(b,c?cf(this):df(this)))};function Um(a){this.d=a;this.b={};this.b.page=[0]}
...
function Vm(a,b,c){var d,e=b["counter-reset"];e&&(e=e.evaluate(c))&&(d=Qf(e,!0));if(d)for(var f in d){var e=a,g=f,h=d[f];e.b[g]?e.b[g].push(h):e.b[g]=[h]}var k;(b=b["counter-increment"])&&(c=b.evaluate(c))&&(k=Qf(c,!1));k?"page"in k||(k.page=1):k={page:1};for(var l in k)a.b[l]||(c=a,b=l,c.b[b]?c.b[b].push(0):c.b[b]=[0]),c=a.b[l],c[c.length-1]+=k[l]};function Wm(a,b,c,d,e,f,g,h,k){this.h=a;this.g=b;this.b=c;this.d=d;this.w=e;this.f=f;this.l=a.G;this.u=g;this.e=h;this.k=k;this.j=a.f;bc(this.b,function(a){return(a=this.b.b[a])?0<a.b.length&&a.b[0].b.b<=this.g:!1});ac(this.b,new $b(this.b,function(){return this.b.d},"page-number"))}
...
function $m(a,b){if(!b)return 0;var c=Number.POSITIVE_INFINITY,d;for(d in a.e){var e=b.b[d];if((!e||0==e.b.length)&&a.b){var f=a.d;f.l=d;for(e=0;null!=f.l&&(e+=5E3,Qj(f,e,0)!=Number.POSITIVE_INFINITY););e=a.b.b[d];b!=a.b&&e&&(e=e.clone(),b.b[d]=e)}if(e){for(var f=a,g=Number.POSITIVE_INFINITY,h=0;h<e.b.length;h++){for(var k=e.b[h].d.La,l=k.ja[0].va,n=k.aa,p=k.H,r=0;l.ownerDocument!=f.X.b;)r++,l=k.ja[r].va,p=!1,n=0;k=Ci(f.X,l,n,p);k<g&&(g=k)}f=g;f<c&&(c=f)}}return c}
function an(a,b){var c=$m(a,a.b);if(c==Number.POSITIVE_INFINITY)return null;for(var d=a.h.children,e,f=0;f<d.length;f++)if(e=d[f],"vivliostyle-page-rule-master"!==e.d.Wa){var g=1,h=vl(e,a,"utilization");h&&h.Vc()&&(g=h.B);h=fc(a,"em");a.g=Qj(a.d,c,Math.ceil(g*a.k()*a.j()/(h*h)));var g=a,h=g.b.d,k=void 0;for(k in g.b.b)for(var l=g.b.b[k],n=l.b.length-1;0<=n;n--){var p=l.b[n];0>p.b.e&&p.b.b<g.g&&(p.b.e=h)}ec(a,a.style.b);g=vl(e,a,"enabled");if(!g||g===Ld){d=a;v("Location - page "+d.b.d);v("  currnt: "+
c);v("  lookup: "+d.g);c=void 0;for(c in d.b.b)for(f=d.b.b[c],g=0;g<f.b.length;g++)v("  Chunk "+c+": "+f.b[g].b.b);c=a.I;d=b;f=e.d;if(0===Object.keys(d).length)f.d.e=f,c=e;else{e=d;g=f;h=[];k=void 0;for(k in e)Object.prototype.hasOwnProperty.call(e,k)&&(l=e[k],h.push(k+l.value+l.Ba));h.push(g.g);e=h.sort().join("^");g=c.g[e];if(!g){if("background-host"===f.Wa)f=c,d=(new tm(f.h,f.f.d,d)).f(f.f),d.h(f.b,f.e),Jl(d,f.d),g=d;else{g=c;h=d;d=f.clone({Wa:"vivliostyle-page-rule-master"});if(f=h.size)h=pm(h),
f=f.Ba,d.b.width=Ug(g.d,d.b.width,new V(h.width,f)),d.b.height=Ug(g.d,d.b.height,new V(h.height,f));d=d.f(g.f);d.h(g.b,g.e);Jl(d,g.d);g=d}c.g[e]=g}c=g.d;c.d.e=c;c=g}return c}}throw Error("No enabled page masters");}
function bn(a,b,c){var d=a.b.b[c];if(!d)return O(!0);a.e[c]&&0<b.A.length&&(b.dd=!1);yk(b);var e=M("layoutColumn"),f=[];Qe(function(c){for(;0<d.b.length;){var e=0,k=d.b[e];if(k.b.b>a.g)break;for(var l=1;l<d.b.length;l++){var n=d.b[l];if(n.b.b>a.g)break;cj(n.b,k.b)&&(k=n,e=l)}var p=k.b,r=!0;Dk(b,k.d).then(function(a){k.b.Dd&&(null==a||p.d)&&f.push(k);p.d?(d.b.splice(e,1),R(c)):a?(k.d=a,R(c)):(d.b.splice(e,1),r?r=!1:Se(c))});if(r){r=!1;return}}R(c)}).then(function(){0<f.length&&(d.b=f.concat(d.b));
Q(e,!0)});return P(e)}
...
function en(a,b){var c=pm(b),d=c.width;d===Nd?a.u=null:a.u=d.B*fc(a,d.b);c=c.height;c===Pd?a.l=null:a.l=c.B*fc(a,c.b)}function fn(a,b,c,d){ei.call(this,a.g,a,b,c,d,a.f,!c);this.f=a;this.A=!1}t(fn,ei);m=fn.prototype;m.$b=function(){};m.Zb=function(a,b,c){a=new el(this.f.j,a,b,c,this.f.u,this.F,df(this.Y));ff(this.f,new Pl(a.d,this.f,a,this.u))};m.fb=function(a){a=a.e;null!=this.F&&(a=Nc(this.e,this.F,a));ff(this.f,new fn(this.f,a,this,this.C))};m.Wb=function(){ff(this.f,new hi(this.e,this.Y))};
...
m.mb=function(){var a=new Sm(this.f.j,this.f,this,this.u);ff(this.f,a);a.mb()};m.ha=function(){ei.prototype.ha.call(this);if(this.A){this.A=!1;var a="R"+this.f.C++,b=H(a),c;this.F?c=new Tg(b,0,this.F):c=new V(b,0);Zg(this.k,"region-id").push(c);this.Oa();a=new fn(this.f,this.F,this,a);ff(this.f,a);a.ha()}};
function gn(a){var b=a.getAttribute("content");if(!b)return"";a={};for(var c;null!=(c=b.match(/^,?\s*([-A-Za-z_.][-A-Za-z_0-9.]*)\s*=\s*([-+A-Za-z_0-9.]*)\s*/));)b=b.substr(c[0].length),a[c[1]]=c[2];b=a.width-0;a=a.height-0;return b&&a?"@-epubx-viewport{width:"+b+"px;height:"+a+"px;}":""}function hn(a){ef.call(this);this.f=a;this.g=new Xb(null);this.j=new Xb(this.g);this.u=new bl(this.g);this.A=new fn(this,null,null,null);this.C=0;this.k=[];this.l={};this.h={};this.w=[];this.b=this.A}t(hn,ef);
hn.prototype.M=function(a){v("CSS parser: "+a)};function jn(a,b){return kn(b,a)}function ln(a){We.call(this,jn,!1);this.G=a;this.A={};this.h={};this.b={};this.C={};this.f=null;this.j=[]}t(ln,We);function mn(a){var b=ea("user-agent.xml",da),c=M("OPSDocStore.init");Xe(Hg).then(function(d){a.f=d;Xe(ki).then(function(){a.load(b).then(function(){Q(c,!0)})})});return P(c)}function nn(a,b){a.j.push({url:b.url,text:b.text,Pa:"User",ra:null,media:null})}
function kn(a,b){var c=M("OPSDocStore.load"),d=b.url;Hi(b,a).then(function(b){for(var f=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),h=0;h<g.length;h++){var k=g[h],l=k.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),n=k.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=k.getAttribute("action"),k=k.getAttribute("ref");l&&n&&p&&k&&f.push({Ad:l,event:n,action:p,Ab:k})}a.C[d]=f;var r=[],f=ea("user-agent-page.css",da);r.push({url:f,text:null,Pa:"UA",
...
l&&"viewport"==g.getAttribute("name")&&r.push({url:d,text:gn(g),Pa:"Author",F:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==h?"stylesheet"==l&&"text/css"==g.getAttribute("type")&&r.push({url:d,text:g.textContent,Pa:"Author",ra:null,media:null}):"http://example.com/sse"==h&&"property"===l&&(h=g.getElementsByTagName("name")[0])&&"stylesheet"===h.textContent&&(g=g.getElementsByTagName("value")[0])&&(g=ea(g.textContent,d),r.push({url:g,text:null,ra:null,media:null,Pa:"Author"}));
for(var q="",h=0;h<r.length;h++)q+=r[h].url,q+="^",r[h].text&&(q+=r[h].text),q+="^";var y=a.A[q];y?(a.b[d]=y,Q(c,b)):(f=a.h[q],f||(f=new Ze(function(){var b=M("fetchStylesheet"),c=0,d=new hn(a.f);Pe(function(){if(c<r.length){var a=r[c++];d.nb(a.Pa);var b;if(a.text){b=a.url;var e=a.ra,a=new Mb(a.text);b=Ff(a,d,b,e)}else b=Gf(a.url,d,a.ra);return b}return O(!1)}).then(function(){y=new Wm(a,d.g,d.j,d.A.h,d.u,d.k,d.l,d.h,d.w);a.A[q]=y;delete a.h[q];Q(b,y)});return P(b)},"FetchStylesheet "+d),a.h[q]=f,
f.start()),Xe(f).then(function(f){a.b[d]=f;Q(c,b)}))});return P(c)};function on(a,b,c,d,e,f,g,h){this.d=a;this.url=b;this.lang=c;this.e=d;this.g=e;this.U=Pb(f);this.h=g;this.f=h;this.Qa=this.b=null}function pn(a,b,c){if(0!=c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=za(d,"height")&&(u(d,"height","auto"),pn(a,d,c));"absolute"==za(d,"position")&&(u(d,"position","relative"),pn(a,d,c))}}
function qn(a){var b=a.target,c="\u25b8"==b.textContent;b.textContent=c?"\u25be":"\u25b8";for(b=b.parentNode.firstChild;b;)if(1!=b.nodeType)b=b.nextSibling;else{var d=b;"toc-container"==d.getAttribute("data-adapt-class")?b=d.firstChild:("toc-node"==d.getAttribute("data-adapt-class")&&(d.style.height=c?"auto":"0px"),b=b.nextSibling)}a.stopPropagation()}
on.prototype.Ac=function(a){var b=this.h.Ac(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",u(e,"cursor","pointer"),e.addEventListener("click",qn,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
on.prototype.Vb=function(a,b,c,d,e){if(this.b)return O(this.b);var f=this,g=M("showTOC"),h=new Xi(a);this.b=h;this.d.load(this.url).then(function(d){var l=f.d.b[d.url],n=Xm(l,c,1E5,e);b=new km(b.d,n.fontSize,b.root,n.width,n.height);var p=new Ym(l,d,f.lang,b,f.e,f.g,f.Ac(d),f.f);f.Qa=p;p.U=f.U;Zm(p).then(function(){dn(p,h,null).then(function(){pn(f,a,2);Q(g,h)})})});return P(g)};
on.prototype.Rb=function(){if(this.b){var a=this.b;this.Qa=this.b=null;u(a.J,"visibility","none");var b=a.J.parentNode;b&&b.removeChild(a.J)}};on.prototype.Xc=function(){return!!this.b};function rn(){ln.call(this,sn(this));this.d=new We(Hi,!1);this.u=new We($e,!1);this.w={};this.Z={};this.k={};this.l={}}t(rn,ln);function sn(a){return function(b){return a.k[b]}}
function tn(a,b,c){var d=M("loadEPUBDoc");c&&a.u.Pb(b+"?r=list");a.d.Pb(b+"META-INF/encryption.xml");a.d.load(b+"META-INF/container.xml").then(function(e){e=Si(zi(zi(zi(new Ai([e.b]),"container"),"rootfiles"),"rootfile"),"full-path");for(var f=0;f<e.length;f++){var g=e[f];if(g){un(a,b,g,c).ka(d);return}}Q(d,null)});return P(d)}
function un(a,b,c,d){var e=b+c,f=a.w[e];if(f)return O(f);var g=M("loadOPF");a.d.load(e).then(function(c){a.d.load(b+"META-INF/encryption.xml").then(function(k){(d?a.u.load(b+"?r=list"):O(null)).then(function(d){f=new vn(a,b);wn(f,c,k,d,b+"?r=manifest").then(function(){a.w[e]=f;a.Z[b]=f;Q(g,f)})})})});return P(g)}rn.prototype.load=function(a){a=ca(a);var b=this.l[a];return b?b.sa()?b:O(b.Nb()):rn.Ed.load.call(this,a)};
function xn(){this.id=null;this.src="";this.g=this.d=null;this.D=-1;this.h=0;this.j=null;this.b=this.e=0;this.f=La}function yn(a){return a.id}function zn(a){var b=re(a);return function(a){var d=M("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));Ve(e).then(function(a){a=new DataView(a);for(var c=0;c<a.byteLength;c++){var e=a.getUint8(c),e=e^b[c%20];a.setUint8(c,e)}Q(d,Ue([a,f]))});return P(d)}}
...
function En(a,b){function c(a){for(var b in a){var d=a[b];d.sort(Dn(b,l));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return Oa(a,function(a){return Na(a,function(a){var b={v:a.value,o:a.K};a.Jd&&(b.s=a.scheme);if(a.id||a.lang){var c=k[a.id];if(c||a.lang)a.lang&&(a={name:Bn,value:a.lang,lang:null,id:null,Hc:a.id,scheme:null,K:a.K},c?c.push(a):c=[a]),c=Ma(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in An)f[g]=An[g];for(;null!=(g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/));)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=An;var h=1;g=Qi(Ri(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),K:h++,Hc:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:An.dcterms+a.localName,K:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Hc:null,scheme:null};return null});var k=Ma(g,function(a){return a.Hc});g=d(Ma(g,function(a){return a.Hc?null:a.name}));var l=null;g[Bn]&&(l=g[Bn][0].v);c(g);return g}function Fn(){var a=window.MathJax;return a?a.Hub:null}var Gn={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function vn(a,b){this.e=a;this.g=this.d=this.b=this.h=this.f=null;this.k=b;this.j=null;this.C={};this.lang=null;this.u=0;this.l={};this.G=this.A=this.I=null;this.w={};Fn()&&(Jg["http://www.w3.org/1998/Math/MathML"]=!0)}function Hn(a,b){return a.k?b.substr(0,a.k.length)==a.k?decodeURI(b.substr(a.k.length)):null:b}
function wn(a,b,c,d,e){a.f=b;var f=zi(new Ai([b.b]),"package"),g=Si(f,"unique-identifier")[0];g&&(g=Gi(b,b.url+"#"+g))&&(a.j=g.textContent.replace(/[ \n\r\t]/g,""));var h={};a.h=Na(Ni(zi(zi(f,"manifest"),"item")),function(c){var d=new xn,e=b.url;d.id=c.getAttribute("id");d.src=ea(c.getAttribute("href"),e);d.d=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.f=f}(c=c.getAttribute("fallback"))&&!Gn[d.d]&&(h[d.src]=c);!a.A&&
d.f.nav&&(a.A=d);!a.G&&d.f["cover-image"]&&(a.G=d);return d});a.d=Ka(a.h,yn);a.g=Ka(a.h,function(b){return Hn(a,b.src)});for(var k in h)for(g=k;;){g=a.d[h[g]];if(!g)break;if(Gn[g.d]){a.w[k]=g.src;break}g=g.src}a.b=Na(Ni(zi(zi(f,"spine"),"itemref")),function(b,c){var d=b.getAttribute("idref");if(d=a.d[d])d.g=b,d.D=c;return d});if(k=Si(zi(f,"spine"),"toc")[0])a.I=a.d[k];var g=Si(zi(zi(Mi(zi(zi(new Ai([c.b]),"encryption"),"EncryptedData"),Li()),"CipherData"),"CipherReference"),"URI"),l=Ni(zi(zi(f,"bindings"),
"mediaType"));for(c=0;c<l.length;c++){var n=l[c].getAttribute("handler");(k=l[c].getAttribute("media-type"))&&n&&a.d[n]&&(a.C[k]=a.d[n].src)}a.l=En(zi(f,"metadata"),Si(f,"prefix")[0]);a.l[Bn]&&(a.lang=a.l[Bn][0].v);if(!d){if(0<g.length&&a.j)for(d=zn(a.j),c=0;c<g.length;c++)a.e.k[a.k+g[c]]=d;return O(!0)}f=new Aa;l={};if(0<g.length&&a.j)for(k="1040:"+se(a.j),c=0;c<g.length;c++)l[g[c]]=k;for(c=0;c<d.length;c++){var p=d[c];if(n=p.n){var r=decodeURI(n),g=a.g[r];k=null;g&&(g.j=0!=p.m,g.h=p.c,g.d&&(k=g.d.replace(/\s+/g,
"")));g=l[r];if(k||g)f.append(n),f.append(" "),f.append(k||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}In(a);return Te(e,!1,"POST",f.toString(),"text/plain")}function In(a){for(var b=0,c=0;c<a.b.length;c++){var d=a.b[c],e=Math.ceil(d.h/1024);d.e=b;d.b=e;b+=e}a.u=b}
function Jn(a,b,c){var d=new xn;d.D=0;d.id="item1";d.src=b;a.d={item1:d};a.g={};a.g[b]=d;a.h=[d];a.b=a.h;c?(a=a.e,d=M("EPUBDocStore.load"),b=ca(b),(a.l[b]=kn(a,{status:200,url:b,responseText:null,responseXML:c,Ub:null})).ka(d),c=P(d)):c=O(null);return c}function Kn(a,b,c){var d=a.b[b],e=M("getCFI");a.e.load(d.src).then(function(a){var b=Ei(a,c),h=null;b&&(a=Ci(a,b,0,!1),h=new bb,fb(h,b,c-a),d.g&&fb(h,d.g,0),h=h.toString());Q(e,h)});return P(e)}
function Ln(a,b){return ye("resolveFragment",function(c){if(b){var d=new bb;cb(d,b);var e;if(a.f){var f=db(d,a.f.b);if(1!=f.va.nodeType||f.H||!f.Ab){Q(c,null);return}var g=f.va,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.d[h]){Q(c,null);return}e=a.d[h];d=f.Ab}else e=a.b[0];a.e.load(e.src).then(function(a){var b=db(d,a.b);a=Ci(a,b.va,b.offset,b.H);Q(c,{D:e.D,ga:a,N:-1})})}else Q(c,null)},function(a){v("Error resolving fragment "+b);Q(a,null)})}
function Mn(a,b){return ye("resolveEPage",function(c){if(0>=b)Q(c,{D:0,ga:0,N:-1});else{var d=Ia(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.e.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=Di(a),g=Math.round(a*b/e.b),g==a&&g--);Q(c,{D:d,ga:g,N:-1})})}},function(a){v("Error resolving epage: "+b);Q(a,null)})}
function Nn(a,b){var c=a.b[b.D];if(0>=b.ga)return O(c.e);var d=M("getEPage");a.e.load(c.src).then(function(a){a=Di(a);var f=Math.min(a,b.ga);Q(d,c.e+f*c.b/a)});return P(d)}function On(a,b,c,d){this.b=a;this.viewport=b;this.f=c;this.Bb=[];this.ga=this.N=this.D=0;this.U=Pb(d);this.e=new jm(b.d)}function Pn(a){var b=a.Bb[a.D];return b?b.eb[a.N]:null}m=On.prototype;m.sc=function(){var a=this.Bb[this.D];return a?a.Qa.ea:null};
function Qn(a){var b=M("renderPage");Rn(a).then(function(c){if(c){var d=-1;if(0>a.N){var d=a.ga,e=Ia(c.Da.length,function(a){return $m(c.Qa,c.Da[a])>d});a.N=e==c.Da.length?Number.POSITIVE_INFINITY:e-1}var f=c.eb[a.N];f?(a.ga=f.offset,Q(b,f)):Qe(function(b){if(a.N<c.Da.length)R(b);else if(c.complete)a.N=c.Da.length-1,R(b);else{var e=c.Da[c.Da.length-1],k=Sn(a,c,e);dn(c.Qa,k,e).then(function(l){k.J.style.display="none";k.J.style.visibility="visible";k.J.setAttribute("data-vivliostyle-page-side",k.e);
(e=l)?(c.eb[e.d-1]=k,c.Da.push(e),0<=d&&$m(c.Qa,e)>d?(f=k,a.N=c.Da.length-2,R(b)):(k.h=0==c.item.D&&0==e.d-1,Se(b))):(c.eb.push(k),f=k,a.N=c.Da.length-1,0>d&&(a.ga=k.offset),c.complete=!0,k.h=0==c.item.D&&0==a.N,k.j=c.item.D==a.b.b.length-1,R(b))})}}).then(function(){if(f)Q(b,f);else{var e=c.Da[a.N];0>d&&(a.ga=$m(c.Qa,e));var h=Sn(a,c,e);dn(c.Qa,h,e).then(function(d){h.J.style.display="none";h.J.style.visibility="visible";h.J.setAttribute("data-vivliostyle-page-side",h.e);(e=d)?(c.eb[e.d-1]=h,c.Da[a.N+
1]=e):(c.eb.push(h),c.complete=!0,h.j=c.item.D==a.b.b.length-1);h.h=0==c.item.D&&0==a.N;Q(b,h)})}})}else Q(b,null)});return P(b)}m.Ic=function(){var a=this,b=M("renderAllPages"),c=a.D,d=a.N,e=a.b.b.length;a.D=0;Qe(function(b){a.N=Number.POSITIVE_INFINITY;Qn(a).then(function(){++a.D>=e?R(b):Se(b)})}).then(function(){a.D=c;a.N=d;Qn(a).ka(b)});return P(b)};m.vd=function(){this.N=this.D=0;return Qn(this)};m.wd=function(){this.D=this.b.b.length-1;this.N=Number.POSITIVE_INFINITY;return Qn(this)};
m.nextPage=function(){var a=this,b=M("nextPage");Rn(a).then(function(c){if(c){if(c.complete&&a.N==c.Da.length-1){if(a.D>=a.b.b.length-1){Q(b,null);return}a.D++;a.N=0}else a.N++;Qn(a).ka(b)}else Q(b,null)});return P(b)};m.Gc=function(){if(0==this.N){if(0==this.D)return O(null);this.D--;this.N=Number.POSITIVE_INFINITY}else this.N--;return Qn(this)};function Tn(a,b){var c="left"===b.e,d="ltr"===a.sc();return!c&&d||c&&!d}
function Un(a){var b=M("getCurrentSpread"),c=Pn(a);if(!c)return O({left:null,right:null});var d=a.D,e=a.N,f="left"===c.e;(Tn(a,c)?a.Gc():a.nextPage()).then(function(g){a.D=d;a.N=e;Qn(a).then(function(){f?Q(b,{left:c,right:g}):Q(b,{left:g,right:c})})});return P(b)}m.zd=function(){var a=Pn(this);if(!a)return O(null);var a=Tn(this,a),b=this.nextPage();if(a)return b;var c=this;return b.cc(function(){return c.nextPage()})};
m.Cd=function(){var a=Pn(this);if(!a)return O(null);var a=Tn(this,a),b=this.Gc();if(a){var c=this;return b.cc(function(){return c.Gc()})}return b};function Vn(a,b){var c=M("navigateToEPage");Mn(a.b,b).then(function(b){b&&(a.D=b.D,a.N=b.N,a.ga=b.ga);Qn(a).ka(c)});return P(c)}function Wn(a,b){var c=M("navigateToCFI");Ln(a.b,b).then(function(b){b&&(a.D=b.D,a.N=b.N,a.ga=b.ga);Qn(a).ka(c)});return P(c)}
function Xn(a,b){v("Navigate to "+b);var c=Hn(a.b,ca(b));if(null==c&&(a.b.f&&b.match(/^#epubcfi\(/)&&(c=Hn(a.b,a.b.f.url)),null==c))return O(null);var d=a.b.g[c];if(!d)return a.b.f&&c==Hn(a.b,a.b.f.url)&&(c=b.indexOf("#"),0<=c)?Wn(a,b.substr(c+1)):O(null);d.D!=a.D&&(a.D=d.D,a.N=0);var e=M("navigateTo");Rn(a).then(function(c){var d=Gi(c.X,b);d&&(a.ga=Bi(c.X,d),a.N=-1);Qn(a).ka(e)});return P(e)}
function Sn(a,b,c){var d=b.Qa.viewport,e=d.b.createElement("div");d.root.appendChild(e);e.style.position="relative";e.style.visibility="hidden";e.style.left="0px";e.style.top="0px";var f=new Xi(e);f.D=b.item.D;f.position=c;f.offset=$m(b.Qa,c);d!==a.viewport&&(a=Sb(a.viewport.width,a.viewport.height,d.width,d.height),a=Hf(null,new Mb(a)),f.f.push(new Ui(e,"transform",a)));return f}
function Yn(a,b){var c=Fn();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=M("navigateToEPage"),f=Je(c);d.Push(function(){f.Ra(e)});return P(c)}return O(null)}
m.Ac=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=ea(f,a.url),g=c.getAttribute("media-type");if(!g){var h=Hn(b.b,f);h&&(h=b.b.g[h])&&(g=h.d)}if(g&&(h=b.b.C[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Ea(f),k=Ea(g),g=new Aa;g.append(h);g.append("?src=");g.append(f);g.append("&type=");g.append(k);for(h=c.firstChild;h;h=h.nextSibling)1==h.nodeType&&
...
function Rn(a){if(a.D>=a.b.b.length)return O(null);var b=a.Bb[a.D];if(b)return O(b);var c=a.b.b[a.D],d=a.b.e,e=M("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(Di(f)/2700),a.b.u=c.b);var g=d.b[f.url],h=a.Ac(f),k=a.viewport,l=Xm(g,k.width,k.height,k.fontSize);if(l.width!=k.width||l.height!=k.height||l.fontSize!=k.fontSize)k=new km(k.d,l.fontSize,k.root,l.width,l.height);var n=new Ym(g,f,a.b.lang,k,a.e,a.f,h,a.b.w);n.U=a.U;Zm(n).then(function(){b={item:c,X:f,
Qa:n,Da:[null],eb:[],complete:!1};a.Bb[a.D]=b;Q(e,b)})});return P(e)}function Zn(a){return{D:a.D,N:a.N,ga:a.ga}}function $n(a,b){b?(a.D=b.D,a.N=-1,a.ga=b.ga):(a.D=0,a.N=0,a.ga=0);return Qn(a)}
m.Vb=function(){var a=this.b,b=a.A||a.I;if(!b)return O(null);var c=M("showTOC");this.d||(this.d=new on(a.e,b.src,a.lang,this.e,this.f,this.U,this,a.w));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";e.style.border=
"1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.d.Vb(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";Q(c,a)});return P(c)};m.Rb=function(){this.d&&this.d.Rb()};m.Xc=function(){return this.d&&this.d.Xc()};function ao(a,b,c,d){var e=this;this.g=a;this.cd=b;this.T=c;this.I=d;this.G=new ui(a.document.head,b);this.l="";this.f=null;this.d=!1;this.e=this.j=this.h=this.k=null;this.fontSize=16;this.A=!1;this.Ic=!0;this.U=Ob();this.u=function(){};this.w=function(){e.d=!0;e.u()};this.uc=function(){};this.C={loadEPUB:this.xd,loadXML:this.sd,configure:this.Rc,moveTo:this.ud,toc:this.Vb}}function bo(a,b){b.i=a.T;b.viewer=a;a.I(b)}m=ao.prototype;
m.xd=function(a){var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet,f=M("loadEPUB"),g=this;g.Rc(a).then(function(){var a=new rn;if(e)for(var k=0;k<e.length;k++)nn(a,e[k]);mn(a).then(function(){var e=ea(b,g.g.location.href);g.l=e;tn(a,e,d).then(function(a){g.f=a;Ln(g.f,c).then(function(a){g.e=a;co(g).then(function(){bo(g,{t:"loaded",metadata:g.f.l});Q(f,!0)})})})})});return P(f)};
m.sd=function(a){var b=a.url,c=a.document,d=a.fragment,e=a.userStyleSheet,f=M("loadXML"),g=this;g.Rc(a).then(function(){var a=new rn;if(e)for(var k=0;k<e.length;k++)nn(a,e[k]);mn(a).then(function(){var e=ea(b,g.g.location.href);g.l=e;g.f=new vn(a,"");Jn(g.f,e,c).then(function(){Ln(g.f,d).then(function(a){g.e=a;co(g).then(function(){bo(g,{t:"loaded"});Q(f,!0)})})})})});return P(f)};
function eo(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*cc.ex*a.fontSize/cc.em;if(d=cc[d])return c*d}return c}
m.Rc=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.k=null,this.g.addEventListener("resize",this.w,!1),this.d=!0):this.g.removeEventListener("resize",this.w,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.d=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:eo(this,b["margin-left"])||0,marginRight:eo(this,b["margin-right"])||0,marginTop:eo(this,b["margin-top"])||0,marginBottom:eo(this,b["margin-bottom"])||
0,width:eo(this,b.width)||0,height:eo(this,b.height)||0},200<=b.width||200<=b.height)&&(this.g.removeEventListener("resize",this.w,!1),this.k=b,this.d=!0);"boolean"==typeof a.hyphenate&&(this.U.vc=a.hyphenate,this.d=!0);"boolean"==typeof a.horizontal&&(this.U.tc=a.horizontal,this.d=!0);"boolean"==typeof a.nightMode&&(this.U.Cc=a.nightMode,this.d=!0);"number"==typeof a.lineHeight&&(this.U.lineHeight=a.lineHeight,this.d=!0);"number"==typeof a.columnWidth&&(this.U.oc=a.columnWidth,this.d=!0);"string"==
...
function fo(a){var b=[];a.h&&(b.push(a.h),a.h=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(u(a.J,"display","none"),a.removeEventListener("hyperlink",this.uc,!1))})}function go(a,b){b.addEventListener("hyperlink",a.uc,!1);u(b.J,"visibility","visible");u(b.J,"display","block")}function ho(a,b){fo(a);a.h=b;go(a,b)}
function io(a){var b=M("reportPosition");a.e||(a.e=Zn(a.b));Kn(a.f,a.e.D,a.e.ga).then(function(c){var d=a.h;(a.A&&0<d.d.length?Uf(d.d):O(!0)).then(function(){jo(a,d,c).ka(b)})});return P(b)}function ko(a){var b=a.cd;if(a.k){var c=a.k;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new km(a.g,a.fontSize,b,c.width,c.height)}return new km(a.g,a.fontSize,b)}
function lo(a){if(a.k||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=ko(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.Bb;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.eb,d=0;d<c.length;d++){var e=c[d];if(e.w&&e.u){a=!0;break a}}}a=!1}b=!a}return b}
function mo(a){if(a.b){a.b.Rb();for(var b=a.b.Bb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.eb,e;e=d.shift();)e=e.J,e.parentNode.removeChild(e)}}a.viewport=ko(a);a.b=new On(a.f,a.viewport,a.G,a.U)}
function no(a,b){if(a.U.Ya)return Un(a.b).cc(function(c){fo(a);a.j=c;c.left&&(go(a,c.left),c.right||c.left.J.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(go(a,c.right),c.left||c.right.J.setAttribute("data-vivliostyle-unpaired-page",!0));a.h=b;return O(null)});ho(a,b);a.h=b;return O(null)}
function co(a){a.d=!1;if(lo(a))return O(!0);var b=M("resize");a.b&&!a.e&&(a.e=Zn(a.b));mo(a);$n(a.b,a.e).then(function(c){no(a,c).then(function(){io(a).then(function(c){(a.Ic?a.b.Ic():O(null)).then(function(){Q(b,c)})})})});return P(b)}function jo(a,b,c){var d=M("sendLocationNotification"),e={t:"nav",first:b.h,last:b.j};Nn(a.f,a.e).then(function(b){e.epage=b;e.epageCount=a.f.u;c&&(e.cfi=c);bo(a,e);Q(d,!0)});return P(d)}m.sc=function(){return this.b?this.b.sc():null};
m.ud=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.U.Ya?this.b.zd:this.b.nextPage;break;case "previous":a=this.U.Ya?this.b.Cd:this.b.Gc;break;case "last":a=this.b.wd;break;case "first":a=this.b.vd;break;default:return O(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return Vn(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return Xn(b.b,d)}}else return O(!0);var e=M("nextPage");a.call(b.b).then(function(a){a?(b.e=null,no(b,
a).then(function(){io(b).ka(e)})):Q(e,!0)});return P(e)};m.Vb=function(a){var b=!!a.autohide;a=a.v;var c=this.b.Xc();if(c){if("show"==a)return O(!0)}else if("hide"==a)return O(!0);if(c)return this.b.Rb(),O(!0);var d=this,e=M("showTOC");this.b.Vb(b).then(function(a){if(a){if(b){var c=function(){d.b.Rb()};a.addEventListener("hyperlink",c,!1);a.J.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.uc,!1)}Q(e,!0)});return P(e)};
function oo(a,b){var c=b.a||"";return ye("runCommand",function(d){var e=a.C[c];e?e.call(a,b).then(function(){bo(a,{t:"done",a:c});Q(d,!0)}):(bo(a,{t:"error",content:"No such action",a:c}),Q(d,!0))},function(b,e){bo(a,{t:"error",content:e.toString(),a:c});Q(b,!0)})}function po(a){return"string"==typeof a?JSON.parse(a):a}
m.Tc=function(a){var b=po(a),c=null,d=this;Ae(function(){var a=M("commandLoop"),f=te.d;d.uc=function(a){var b={t:"hyperlink",href:a.href,internal:a.href.substr(0,d.l.length)==d.l};Be(f,function(){bo(d,b);return O(!0)})};Qe(function(a){if(d.d)co(d).then(function(){Se(a)});else if(b){var e=b;b=null;oo(d,e).then(function(){Se(a)})}else e=M("waitForCommand"),c=Je(e,self),P(e).then(function(){Se(a)})}).ka(a);return P(a)});d.u=function(){var a=c;a&&(c=null,a.Ra())};this.g.adapt_command=function(a){if(b)return!1;
b=po(a);d.u();return!0}};window.adapt_embedded&&(window.adapt_initEmbed=function(a,b,c){(new ao(window,document.body,b,function(b){var c=JSON.stringify(b);(new Ze(function(){return Te(a,!1,"POST",c)})).start()})).Tc(c);delete window.adapt_initEmbed});ba("adapt.viewer.Viewer",ao);ba("adapt.viewer.Viewer.prototype.initEmbed",ao.prototype.Tc);var qo=16,ro="ltr";function so(a){window.adapt_command(a)}function to(){so({a:"moveTo",where:"ltr"===ro?"previous":"next"})}function uo(){so({a:"moveTo",where:"ltr"===ro?"next":"previous"})}
function vo(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)so({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)so({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)so({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)so({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)uo(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)to(),a.preventDefault();else if("0"===b||"U+0030"===c)so({a:"configure",fontSize:Math.round(qo)}),a.preventDefault();else if("t"===b||"U+0054"===c)so({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)qo*=1.2,so({a:"configure",fontSize:Math.round(qo)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)qo/=1.2,so({a:"configure",
fontSize:Math.round(qo)}),a.preventDefault()}
function wo(a){switch(a.t){case "loaded":a=a.viewer;var b=ro=a.sc();a.cd.setAttribute("data-vivliostyle-page-progression",b);a.cd.setAttribute("data-vivliostyle-spread-view",a.U.Ya);window.addEventListener("keydown",vo,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",to,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",uo,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "error":v("Error: "+a.content);break;case "nav":(a=a.cfi)&&location.replace(ha(location.href,Ea(a||"")));break;case "hyperlink":a.internal&&so({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+n+"; margin: 0; }",document.head.appendChild(g));(new ao(window,l,"main",wo)).Tc(a)});
