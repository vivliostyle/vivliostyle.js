...
function Qf(a,b){var c=new Pf(b);try{a.L(c)}catch(d){v("toCounters: "+d)}return c.b}function Rf(){this.url=null;this.b=!1}t(Rf,Rc);Rf.prototype.sb=function(a){this.url||(this.url=a.url);return a};var Sf={opentype:!0,truetype:!0,woff:!0};Rf.prototype.ab=function(a){if("format"==a.name.toLowerCase())for(var b=0;b<a.values.length;b++)if(Sf[a.values[b].stringValue()]){this.b=!0;break}return a};
...
Jh={square:"\u25a0",disc:"\u2022",circle:"\u25e6",none:""},Kh={Gd:!1,ub:"\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",Sb:"\u5341\u767e\u5343",yd:"\u8ca0"};
function Lh(a){if(9999<a||-9999>a)return""+a;if(0==a)return Kh.ub.charAt(0);var b=new Aa;0>a&&(b.append(Kh.yd),a=-a);if(10>a)b.append(Kh.ub.charAt(a));else if(Kh.Hd&&19>=a)b.append(Kh.Sb.charAt(0)),0!=a&&b.append(Kh.Sb.charAt(a-10));else{var c=Math.floor(a/1E3);c&&(b.append(Kh.ub.charAt(c)),b.append(Kh.Sb.charAt(2)));if(c=Math.floor(a/100)%10)b.append(Kh.ub.charAt(c)),b.append(Kh.Sb.charAt(1));if(c=Math.floor(a/10)%10)b.append(Kh.ub.charAt(c)),b.append(Kh.Sb.charAt(0));(a%=10)&&b.append(Kh.ub.charAt(a))}return b.toString()}
...
function wi(a,b,c,d){var e=M("initFont"),f=b.src,g={},h;for(h in oi)g[h]=b.lb[h];d=vi(a,b,d);g["font-family"]=H(d);var k=new ri(g),l=a.b.ownerDocument.createElement("span");l.textContent="M";var n=(new Date).valueOf()+1E3;b=a.d.ownerDocument.createElement("style");h=pi+qi++;b.textContent=si(k,"",Ue([h]));a.d.appendChild(b);a.b.appendChild(l);l.style.visibility="hidden";l.style.fontFamily=d;for(var p in oi)u(l,p,g[p].toString());a=l.getBoundingClientRect();var r=a.right-a.left,q=a.bottom-a.top;b.textContent=
si(k,f,c);v("Starting to load font: "+f);var y=!1;Pe(function(){var a=l.getBoundingClientRect(),b=a.bottom-a.top;if(r!=a.right-a.left||q!=b)return y=!0,O(!1);(new Date).valueOf()>n?a=O(!1):(a=M("Frame.sleep"),Je(a).Ra(!0,10),a=P(a));return a}).then(function(){y?v("Loaded font: "+f):v("Failed to load font: "+f);Q(e,k)});return P(e)}
...
function Hi(a,b){var c=a.responseXML;if(!c){var d=new DOMParser,e=a.responseText||"<not-found/>",c=d.parseFromString(e,"text/html");c||(c=d.parseFromString(e,"text/xml"))||d.parseFromString("<error/>","text/xml")}c=new yi(b,a.url,c);return O(c)}function Ii(a){this.kb=a}function Ji(){var a=Ki;return new Ii(function(b){return a.kb(b)&&1==b.nodeType&&"http://www.idpf.org/2008/embedding"==b.getAttribute("Algorithm")})}
function Li(){var a=Ji(),b=Ki;return new Ii(function(c){if(!b.kb(c))return!1;c=new Ai([c]);c=zi(c,"EncryptionMethod");a&&(c=Mi(c,a));return 0<c.b.length})}var Ki=new Ii(function(){return!0});function Ai(a){this.b=a}function Ni(a){return a.b}function Mi(a,b){for(var c=[],d=0;d<a.b.length;d++){var e=a.b[d];b.kb(e)&&c.push(e)}return new Ai(c)}function Oi(a,b){function c(a){d.push(a)}for(var d=[],e=0;e<a.b.length;e++)b(a.b[e],c);return new Ai(d)}
function Pi(a,b){for(var c=[],d=0;d<a.b.length;d++)c.push(b(a.b[d]));return c}function Qi(a,b){for(var c=[],d=0;d<a.b.length;d++){var e=b(a.b[d]);null!=e&&c.push(e)}return c}function zi(a,b){return Oi(a,function(a,d){for(var e=a.firstChild;e;e=e.nextSibling)e.localName==b&&d(e)})}function Ri(a){return Oi(a,function(a,c){for(var d=a.firstChild;d;d=d.nextSibling)1==d.nodeType&&c(d)})}function Si(a,b){return Qi(a,function(a){return 1==a.nodeType?a.getAttribute(b):null})}
Ai.prototype.textContent=function(){return Pi(this,function(a){return a.textContent})};var Ti={transform:!0,"transform-origin":!0,position:!0};function Ui(a,b,c){this.target=a;this.name=b;this.value=c}var Vi={show:function(a){a.style.visibility="visible"},hide:function(a){a.style.visibility="hidden"},play:function(a){a.currentTime=0;a.play()},pause:function(a){a.pause()},resume:function(a){a.play()},mute:function(a){a.muted=!0},unmute:function(a){a.muted=!1}};function Wi(a,b){var c=Vi[b];return c?function(){for(var b=0;b<a.length;b++)try{c(a[b])}catch(e){}}:null}
function Xi(a){this.b={};this.J=a;this.f=[];var b=this;this.l=function(a){var d=a.currentTarget,e=d.getAttribute("href")||d.getAttributeNS("http://www.w3.org/1999/xlink","href");if(e&&(a.preventDefault(),a={type:"hyperlink",target:null,currentTarget:null,Fd:d,href:e},d=b.b[a.type]))for(a.target=b,a.currentTarget=b,e=0;e<d.length;e++)d[e](a)};this.g={};this.j=this.h=!1;this.D=0;this.position=null;this.offset=-1;this.e=null;this.d=[];this.k={top:{},bottom:{},left:{},right:{}}}t(Xi,Pa);
function Yi(a){a.w=!0;a.J.setAttribute("data-vivliostyle-auto-page-width",!0)}function Zi(a){a.u=!0;a.J.setAttribute("data-vivliostyle-auto-page-height",!0)}function $i(a,b,c){var d=a.g[c];d?d.push(b):a.g[c]=[b]}function aj(a,b){if(1==a.nodeType)return!1;var c=a.textContent;switch(b){case 0:return!!c.match(/^\s*$/);case 1:return!!c.match(/^[ \t\f]*$/);case 2:return 0==c.length}throw Error("Unexpected whitespace: "+b);}
function bj(a,b,c,d,e,f,g,h){this.f=a;this.g=b;this.b=c;this.Ba=d;this.j=e;this.d=f;this.Dd=g;this.h=h;this.e=-1}function cj(a,b){return a.d?!b.d||a.Ba>b.Ba?!0:a.h:!1}function dj(a,b){return a.top-b.top}function ej(a,b){return b.right-a.right}function fj(a,b,c,d,e,f,g){this.Y=a;this.Fc=d;this.$c=null;this.root=b;this.X=c;this.type=f;e&&(e.$c=this);this.b=g}function gj(a,b){this.Bd=a;this.count=b}
function hj(a,b,c){this.R=a;this.parent=b;this.$=c;this.aa=0;this.H=!1;this.Fa=0;this.da=b?b.da:null;this.ia=this.pa=null;this.C=!1;this.d=!0;this.overflow=!1;this.g=b?b.g:0;this.u=this.h=null;this.w=b?b.w:0;this.j=b?b.j:!1;this.b=this.A=this.l=null;this.k=b?b.k:{};this.f=b?b.f:!1;this.e=b?b.e:null}function ij(a){a.d=!0;a.g=a.parent?a.parent.g:0;a.b=null;a.aa=0;a.H=!1;a.h=null;a.u=null;a.l=null;a.A=null;a.pa=null;a.j=a.parent?a.parent.j:!1;a.f=a.parent?a.parent.f:!1;a.pa=null}
function jj(a){var b=new hj(a.R,a.parent,a.$);b.aa=a.aa;b.H=a.H;b.pa=a.pa;b.Fa=a.Fa;b.da=a.da;b.ia=a.ia;b.d=a.d;b.g=a.g;b.h=a.h;b.u=a.u;b.j=a.j;b.w=a.w;b.l=a.l;b.A=a.A;b.b=a.b;b.e=a.e;b.f=a.f;b.overflow=a.overflow;return b}hj.prototype.modify=function(){return this.C?jj(this):this};function kj(a){var b=a;do{if(b.C)break;b.C=!0;b=b.parent}while(b);return a}hj.prototype.clone=function(){for(var a=jj(this),b=a,c;null!=(c=b.parent);)c=jj(c),b=b.parent=c;return a};
function lj(a){return{va:a.R,Fa:a.Fa,da:a.da,pa:a.pa,ia:a.ia?lj(a.ia):null}}function mj(a){this.La=a;this.b=this.d=null}mj.prototype.clone=function(){var a=new mj(this.La);if(this.d){a.d=[];for(var b=0;b<this.d.length;++b)a.d[b]=this.d[b]}if(this.b)for(a.b=[],b=0;b<this.b.length;++b)a.b[b]=this.b[b];return a};function nj(a,b){this.d=a;this.b=b}nj.prototype.clone=function(){return new nj(this.d.clone(),this.b)};function oj(){this.b=[]}
oj.prototype.clone=function(){for(var a=new oj,b=this.b,c=a.b,d=0;d<b.length;d++)c[d]=b[d].clone();return a};function pj(){this.d=0;this.b={};this.e=0}pj.prototype.clone=function(){var a=new pj;a.d=this.d;a.f=this.f;a.e=this.e;a.g=this.g;for(var b in this.b)a.b[b]=this.b[b].clone();return a};
function qj(a){this.d=a;this.G=this.C=this.height=this.width=this.w=this.j=this.I=this.h=this.ya=this.ea=this.Ua=this.Z=this.marginBottom=this.marginTop=this.marginRight=this.marginLeft=this.top=this.left=0;this.Jb=this.A=null;this.wa=this.Kb=this.tb=this.Lb=this.e=0;this.b=!1}function rj(a){return a.marginTop+a.ea+a.j}function sj(a){return a.marginBottom+a.ya+a.w}function tj(a){return a.marginLeft+a.Z+a.h}function uj(a){return a.marginRight+a.Ua+a.I}
function vj(a,b){a.d=b.d;a.left=b.left;a.top=b.top;a.marginLeft=b.marginLeft;a.marginRight=b.marginRight;a.marginTop=b.marginTop;a.marginBottom=b.marginBottom;a.Z=b.Z;a.Ua=b.Ua;a.ea=b.ea;a.ya=b.ya;a.h=b.h;a.I=b.I;a.j=b.j;a.w=b.w;a.width=b.width;a.height=b.height;a.C=b.C;a.G=b.G;a.Jb=b.Jb;a.A=b.A;a.e=b.e;a.Lb=b.Lb;a.tb=b.tb;a.b=b.b}function wj(a,b,c){a.top=b;a.height=c;u(a.d,"top",b+"px");u(a.d,"height",c+"px")}function xj(a,b,c){a.left=b;a.width=c;u(a.d,"left",b+"px");u(a.d,"width",c+"px")}
function yj(a,b){this.b=a;this.d=b}t(yj,Rc);yj.prototype.Gb=function(a){this.b.appendChild(this.b.ownerDocument.createTextNode(a.d));return null};yj.prototype.sb=function(a){var b=this.b.ownerDocument.createElementNS("http://www.w3.org/1999/xhtml","img");b.setAttribute("src",a.url);this.b.appendChild(b);return null};yj.prototype.Na=function(a){this.Ta(a.values);return null};
yj.prototype.ob=function(a){a=a.ca().evaluate(this.d);"string"===typeof a&&this.b.appendChild(this.b.ownerDocument.createTextNode(a));return null};function zj(a){return null!=a&&a!==xd&&a!==wd&&a!==rd};function Aj(a,b,c){this.e=a;this.d=b;this.b=c}function Bj(){this.b=[]}function Cj(a){return 0==a.b.length?0:a.b[a.b.length-1].b}function Dj(a,b){if(0==a.b.length)a.b.push(new Aj(b,b,b));else{var c=a.b[a.b.length-1],d=c.b+b-c.d;c.d==c.e?(c.d=b,c.e=b,c.b=d):a.b.push(new Aj(b,b,d))}}function Ej(a,b){0==a.b.length?a.b.push(new Aj(b,0,0)):a.b[a.b.length-1].d=b}function Fj(a,b){var c=Ia(a.b.length,function(c){return b<=a.b[c].d}),c=a.b[c];return c.b-Math.max(0,c.e-b)}
function Gj(a,b){var c=Ia(a.b.length,function(c){return b<=a.b[c].b}),c=a.b[c];return c.e-(c.b-b)}
function Hj(a,b,c,d,e,f,g){this.X=a;this.root=a.root;this.ea=c;this.f=d;this.h=f;this.d=this.root;this.u={};this.w={};this.C=[];this.l=this.k=null;this.A=new Uh(b,d,g);this.e=new Bj;this.La=!0;this.G=[];this.Z=e;this.T=this.I=!1;this.b=a=Bi(a,this.root);Dj(this.e,a);b=Ij(this,this.root);ci(this.A,this.root,b);Jj(this,b,!1);this.j=!0;switch(this.root.namespaceURI){case "http://www.w3.org/1999/xhtml":case "http://www.gribuser.ru/xml/fictionbook/2.0":this.j=!1}this.G.push(!0);this.w={};this.w["e"+a]=
b;this.b++;Kj(this,-1)}function Lj(a,b,c,d){return(b=b[d])&&b.evaluate(a.f)!==c[d]}function Mj(a,b,c){for(var d in c){var e=b[d];e?(a.u[d]=e,delete b[d]):(e=c[d])&&(a.u[d]=new V(e,33554432))}}var Nj=["column-count","column-width"];
function Jj(a,b,c){c||["writing-mode","direction"].forEach(function(a){b[a]&&(this.u[a]=b[a])},a);if(!a.I){c=Lj(a,b,a.h.g,"background-color")?b["background-color"].evaluate(a.f):null;var d=Lj(a,b,a.h.g,"background-image")?b["background-image"].evaluate(a.f):null;if(c&&c!==rd||d&&d!==rd)Mj(a,b,a.h.g),a.I=!0}if(!a.T)for(c=0;c<Nj.length;c++)if(Lj(a,b,a.h.j,Nj[c])){Mj(a,b,a.h.j);a.T=!0;break}}
function Ij(a,b){if(b.style instanceof CSSStyleDeclaration){var c=b.getAttribute("style");if(c){var d=a.X.url,e=new ji(a.ea,a.h),c=new Mb(c);try{Df(new vf(mf,c,e,d),Number.POSITIVE_INFINITY,!1,!0)}catch(f){v("Style attribute parse error: "+f)}return e.b}}return{}}
function Kj(a,b){if(!(b>=a.b)){var c=a.f,d=Bi(a.X,a.root);if(b<d){var e=a.g(a.root,!1),f=e["flow-into"],f=f?f.evaluate(c,"flow-into").toString():"body";Oj(a,f,e,a.root,d)}d=Ei(a.X,b);e=Ci(a.X,d,0,!1);if(!(e>=a.b))for(;;){if(1!=d.nodeType)e+=d.textContent.length;else{var g=d;if(e!=Bi(a.X,g))throw Error("Inconsistent offset");var h=a.g(g,!1);if(f=h["flow-into"])f=f.evaluate(c,"flow-into").toString(),Oj(a,f,h,g,e);e++}if(e>=a.b)break;f=d.firstChild;if(null==f)for(;!(f=d.nextSibling);)if(d=d.parentNode,
d===a.root)return;d=f}}}function Oj(a,b,c,d,e){var f=0,g=Number.POSITIVE_INFINITY,h=!1,k=!1,l=!1,n=c["flow-options"];if(n){var p;a:{if(h=n.evaluate(a.f,"flow-options")){k=new Kf;try{h.L(k);p=k.b;break a}catch(r){v("toSet: "+r)}}p={}}h=!!p.exclusive;k=!!p["static"];l=!!p.last}(p=c["flow-linger"])&&(g=Mf(p.evaluate(a.f,"flow-linger"),Number.POSITIVE_INFINITY));(c=c["flow-priority"])&&(f=Mf(c.evaluate(a.f,"flow-priority"),0));d=new bj(b,d,e,f,g,h,k,l);a.C.push(d);a.l==b&&(a.l=null);a.k&&Pj(a.k,d)}
function Qj(a,b,c){var d=-1;if(b<=a.b&&(d=Fj(a.e,b),d+=c,d<Cj(a.e)))return Gj(a.e,d);if(null==a.d)return Number.POSITIVE_INFINITY;for(var e=a.f;;){var f=a.d.firstChild;if(null==f)for(;;){if(1==a.d.nodeType){var f=a.A,g=a.d;if(f.wa.pop()!==g)throw Error("Invalid call to popElement");f.pop();ai(f);a.La=a.G.pop()}if(f=a.d.nextSibling)break;a.d=a.d.parentNode;if(a.d===a.root)return a.d=null,b<a.b&&(0>d&&(d=Fj(a.e,b),d+=c),d<=Cj(a.e))?Gj(a.e,d):Number.POSITIVE_INFINITY}a.d=f;if(1!=a.d.nodeType)a.b+=a.d.textContent.length,
a.La?Dj(a.e,a.b):Ej(a.e,a.b);else{g=a.d;f=Ij(a,g);a.G.push(a.La);ci(a.A,g,f);a.j||"body"!=g.localName||g.parentNode!=a.root||(Jj(a,f,!0),a.j=!0);var h=f["flow-into"];h&&(h=h.evaluate(e,"flow-into").toString(),Oj(a,h,f,g,a.b),a.La=!!a.Z[h]);a.La&&(g=f.display)&&g.evaluate(e,"display")===wd&&(a.La=!1);if(Bi(a.X,a.d)!=a.b)throw Error("Inconsistent offset");a.w["e"+a.b]=f;a.b++;a.La?Dj(a.e,a.b):Ej(a.e,a.b);if(b<a.b&&(0>d&&(d=Fj(a.e,b),d+=c),d<=Cj(a.e)))return Gj(a.e,d)}}}
Hj.prototype.g=function(a,b){var c=Bi(this.X,a),d="e"+c;b&&(c=Ci(this.X,a,0,!0));this.b<=c&&Qj(this,c,0);return this.w[d]};function Rj(a,b){return a?b?"avoid"==a||"avoid"==b?"avoid":a:a:b}var Sj={img:!0,svg:!0,audio:!0,video:!0};
function Tj(a,b,c){var d=a.b;if(!d)return NaN;if(1==d.nodeType){if(a.H){var e=d.getBoundingClientRect();if(e.right>=e.left&&e.bottom>=e.top)return c?e.left:e.bottom}return NaN}var e=NaN,f=d.ownerDocument.createRange(),g=d.textContent.length;if(!g)return NaN;a.H&&(b+=g);b>=g&&(b=g-1);f.setStart(d,b);f.setEnd(d,b+1);a=Uj(f);if(b=c){b=document.body;if(null==Sa){var h=b.ownerDocument,f=h.createElement("div");f.style.position="absolute";f.style.top="0px";f.style.left="0px";f.style.width="100px";f.style.height=
"100px";f.style.overflow="hidden";f.style.lineHeight="16px";f.style.fontSize="16px";u(f,"writing-mode","vertical-rl");b.appendChild(f);g=h.createTextNode("a a a a a a a a a a a a a a a a");f.appendChild(g);h=h.createRange();h.setStart(g,0);h.setEnd(g,1);Sa=50>h.getBoundingClientRect().left;b.removeChild(f)}b=Sa}if(b){b=d.ownerDocument.createRange();b.setStart(d,0);b.setEnd(d,d.textContent.length);d=Uj(b);b=[];for(f=0;f<a.length;f++){g=a[f];for(h=0;h<d.length;h++){var k=d[h];if(g.top>=k.top&&g.bottom<=
k.bottom&&1>Math.abs(g.right-k.right)){b.push({top:g.top,left:k.left,bottom:k.bottom,right:k.right});break}}h==d.length&&(v("Could not fix character box"),b.push(g))}a=b}for(b=d=0;b<a.length;b++)f=a[b],g=c?f.bottom-f.top:f.right-f.left,f.right>f.left&&f.bottom>f.top&&(isNaN(e)||g>d)&&(e=c?f.left:f.bottom,d=g);return e}function Vj(a,b){this.e=a;this.f=b}Vj.prototype.d=function(a,b){return b<this.f?null:Wj(a,this,0<b)};Vj.prototype.b=function(){return this.f};
function Xj(a,b,c,d){this.position=a;this.f=b;this.g=c;this.e=d}Xj.prototype.d=function(a,b){var c;b<this.b()?c=null:(a.e=this.e,c=this.position);return c};Xj.prototype.b=function(){return("avoid"==this.f?1:0)+(this.g?3:0)+(this.position.parent?this.position.parent.g:0)};function Yj(a,b,c){this.$=a;this.d=b;this.b=c}
function Zj(a){for(var b=1;b<a.length;b++){var c=a[b-1],d=a[b];c===d?v("validateCheckPoints: duplicate entry"):c.$>=d.$?v("validateCheckPoints: incorrect boxOffset"):c.R==d.R&&(d.H?c.H&&v("validateCheckPoints: duplicate after points"):c.H?v("validateCheckPoints: inconsistent after point"):d.$-c.$!=d.aa-c.aa&&v("validateCheckPoints: boxOffset inconsistent with offsetInNode"))}}
function ak(a,b,c){qj.call(this,a);this.Mc=a.lastChild;this.k=b;this.fc=c;this.rd=a.ownerDocument;this.gc=!1;this.ta=this.cb=this.Ja=this.Oc=0;this.hc=this.Ib=this.l=this.f=null;this.Nc=!1;this.T=this.g=this.u=null;this.dd=!0;this.jc=this.ic=0}t(ak,qj);ak.prototype.clone=function(){var a=new ak(this.d,this.k,this.fc);vj(a,this);a.Mc=this.Mc;a.gc=this.gc;a.l=this.l?this.l.clone():null;a.Ib=this.Ib.concat();return a};
function bk(a,b){var c=b.getBoundingClientRect(),d=(a.b?a.cb:a.Oc)-a.f.V,e=(a.b?a.Oc:a.Ja)-a.f.P;return{left:c.left-d,top:c.top-e,right:c.right-d,bottom:c.bottom-e}}function ck(a,b){return a.b?b<a.ta:b>a.ta}function dk(a,b,c){var d=new hj(b.va,c,0);d.Fa=b.Fa;d.da=b.da;d.pa=b.pa;d.ia=b.ia?dk(a,b.ia,kj(c)):null;return d}
function ek(a,b){var c=M("openAllViews"),d=b.ja;fk(a.k,a.d,a.gc);var e=d.length-1,f=null;Pe(function(){for(;0<=e;){f=dk(a,d[e],f);if(0==e&&(f.aa=b.aa,f.H=b.H,f.H))break;var c=gk(a.k,f,0==e&&0==f.aa);e--;if(c.sa())return c}return O(!1)}).then(function(){Q(c,f)});return P(c)}var hk=/^[^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*([A-Za-z0-9_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527][^A-Za-z0-9_\u009E\u009F\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02AF\u037B-\u037D\u0386\u0388-\u0482\u048A-\u0527]*)?/;
function ik(a,b){if(b.e&&b.d&&!b.H&&0==b.e.count&&1!=b.b.nodeType){var c=b.b.textContent.match(hk);return jk(a.k,b,c[0].length)}return O(b)}function kk(a,b,c){var d=M("buildViewToNextBlockEdge");Qe(function(d){b.b&&c.push(kj(b));ik(a,b).then(function(f){f!==b&&(b=f,c.push(kj(b)));lk(a.k,b).then(function(c){(b=c)?b.h&&!a.b?mk(a,b).then(function(a){b=a;!b||b.overflow?R(d):Se(d)}):b.d?Se(d):R(d):R(d)})})}).then(function(){Q(d,b)});return P(d)}
function nk(a,b){if(!b.b)return O(b);var c=b.R,d=M("buildDeepElementView");Qe(function(d){ik(a,b).then(function(f){if(f!==b){for(var g=f;g&&g.R!=c;)g=g.parent;if(null==g){b=f;R(d);return}}lk(a.k,f).then(function(a){(b=a)&&b.R!=c?Se(d):R(d)})})}).then(function(){Q(d,b)});return P(d)}function ok(a,b,c,d,e){var f=a.rd.createElement("div");a.b?(u(f,"height",d+"px"),u(f,"width",e+"px")):(u(f,"width",d+"px"),u(f,"height",e+"px"));u(f,"float",c);u(f,"clear",c);a.d.insertBefore(f,b);return f}
function pk(a){for(var b=a.d.firstChild;b;){var c=b.nextSibling;if(1==b.nodeType){var d=b.style.cssFloat;if("left"==d||"right"==d)a.d.removeChild(b);else break}b=c}}function qk(a){for(var b=a.d.firstChild,c=a.hc,d=a.b?a.f.P:a.f.V,e=a.b?a.f.O:a.f.S,f=0;f<c.length;f++){var g=c[f],h=g.O-g.P;g.left=ok(a,b,"left",g.V-d,h);g.right=ok(a,b,"right",e-g.S,h)}}
function rk(a,b,c,d,e){var f;if(b&&b.H&&!b.d&&(f=Tj(b,0,a.b),!isNaN(f)))return f;b=c[d];for(e-=b.$;;){f=Tj(b,e,a.b);if(!isNaN(f))return f;if(0<e)e--;else{d--;if(0>d)return a.Ja;b=c[d];1!=b.b.nodeType&&(e=b.b.textContent.length)}}}function sk(a){return"number"==typeof a?a:(a=a.match(/^(-?[0-9]*(\.[0-9]*)?)px$/))?parseFloat(a[0]):0}
function tk(a,b){var c=a.fc.b.getComputedStyle(b,null),d=new Vd;c&&(d.left=sk(c.marginLeft),d.top=sk(c.marginTop),d.right=sk(c.marginRight),d.bottom=sk(c.marginBottom));return d}
function uk(a,b,c){if(a=a.fc.b.getComputedStyle(b,null))c.marginLeft=sk(a.marginLeft),c.Z=sk(a.borderLeftWidth),c.h=sk(a.paddingLeft),c.marginTop=sk(a.marginTop),c.ea=sk(a.borderTopWidth),c.j=sk(a.paddingTop),c.marginRight=sk(a.marginRight),c.Ua=sk(a.borderRightWidth),c.I=sk(a.paddingRight),c.marginBottom=sk(a.marginBottom),c.ya=sk(a.borderBottomWidth),c.w=sk(a.paddingBottom)}function vk(a,b,c){b=new Yj(b,c,c);a.g?a.g.push(b):a.g=[b]}
function wk(a,b,c,d){if(a.g&&a.g[a.g.length-1].b)return vk(a,b,c),O(!0);d+=40*(a.b?-1:1);var e=a.l,f=!e;if(f){var g=a.d.ownerDocument.createElement("div");u(g,"position","absolute");var h=a.k.clone(),e=new ak(g,h,a.fc);a.l=e;e.b=xk(a.k,a.b,g);e.gc=!0;a.b?(e.left=0,u(e.d,"width","2em")):(e.top=a.cb,u(e.d,"height","2em"))}a.d.appendChild(e.d);uk(a,e.d,e);g=(a.b?-1:1)*(d-a.Ja);a.b?e.height=a.f.O-a.f.P-rj(e)-sj(e):e.width=a.f.S-a.f.V-tj(e)-uj(e);d=(a.b?-1:1)*(a.cb-d)-(a.b?tj(e)-uj(e):rj(e)+sj(e));if(f&&
18>d)return a.d.removeChild(e.d),a.l=null,vk(a,b,c),O(!0);if(!a.b&&e.top<g)return a.d.removeChild(e.d),vk(a,b,c),O(!0);var k=M("layoutFootnoteInner");a.b?xj(e,0,d):wj(e,g,d);e.C=a.C+a.left+tj(a);e.G=a.G+a.top+rj(a);e.A=a.A;var l=new mj(c);f?(yk(e),f=O(!0)):0==e.A.length?(Bk(e),f=O(!0)):f=Ck(e);f.then(function(){Dk(e,l).then(function(d){a.b?(a.ta=a.cb+(e.e+tj(e)+uj(e)),xj(e,0,e.e)):(a.ta=a.cb-(e.e+rj(e)+sj(e)),wj(e,a.ta-a.Ja,e.e));var f;!a.b&&0<e.A.length?f=Ck(e):f=O(d);f.then(function(d){d=new Yj(b,
c,d?d.La:null);a.g?a.g.push(d):a.g=[d];Q(k,!0)})})});return P(k)}
function Ek(a,b){var c=M("layoutFootnote"),d=b.b;d.setAttribute("style","");u(d,"display","inline-block");d.textContent="M";var e=d.getBoundingClientRect(),f=a.b?e.left:e.bottom;d.textContent="";Fk(a.k,b,"footnote-call",d);d.textContent||d.parentNode.removeChild(d);d={ja:[{va:b.R,Fa:0,da:b.da,pa:null,ia:null}],aa:0,H:!1};e=b.$;b=b.modify();b.H=!0;wk(a,e,d,f).then(function(){a.l&&a.l.d.parentNode&&a.d.removeChild(a.l.d);ck(a,f)&&0!=a.u.length&&(b.overflow=!0);Q(c,b)});return P(c)}
function Gk(a,b){var c=M("layoutFloat"),d=b.b,e=b.h;u(d,"float","none");u(d,"position","absolute");u(d,"left","auto");u(d,"right","auto");u(d,"top","auto");nk(a,b).then(function(f){for(var g=bk(a,d),h=tk(a,d),g=new Td(g.left-h.left,g.top-h.top,g.right+h.right,g.bottom+h.bottom),h=a.b?a.f.P:a.f.V,k=a.b?a.f.O:a.f.S,l=b.parent;l&&l.d;)l=l.parent;if(l){var n=l.b.ownerDocument.createElement("div");n.style.left="0px";n.style.top="0px";a.b?(n.style.bottom="0px",n.style.width="1px"):(n.style.right="0px",
n.style.height="1px");l.b.appendChild(n);var p=bk(a,n),h=Math.max(a.b?p.top:p.left,h),k=Math.min(a.b?p.bottom:p.right,k);l.b.removeChild(n);l=a.b?g.O-g.P:g.S-g.V;"left"==e?k=Math.max(k,h+l):h=Math.min(h,k-l)}k=new Td(h,(a.b?-1:1)*a.f.P,k,(a.b?-1:1)*a.f.O);h=g;a.b&&(h=ke(g));a:for(var l=a.hc,n=h,p=n.P,r=n.S-n.V,q=n.O-n.P,y=oe(l,p);;){var x=p+q;if(x>k.O)break a;for(var I=k.V,J=k.S,C=y;C<l.length&&l[C].P<x;C++){var N=l[C];N.V>I&&(I=N.V);N.S<J&&(J=N.S)}if(I+r<=J||y>=l.length){"left"==e?(n.V=I,n.S=I+r):
(n.V=J-r,n.S=J);n.O+=p-n.P;n.P=p;break a}p=l[y].O;y++}a.b&&(g=new Td(-h.O,h.V,-h.P,h.S));u(d,"left",g.V-a.f.V+a.h+"px");u(d,"top",g.P-a.f.P+a.j+"px");g=a.b?g.V:g.O;if(ck(a,g)&&0!=a.u.length)b=b.modify(),b.overflow=!0,Q(c,b);else{pk(a);k=a.b?ke(a.f):a.f;l=a.hc;n=null;for(n=[new Xd(h.P,h.O,h.V,h.S)];0<n.length&&n[0].O<=k.P;)n.shift();if(0!=n.length){n[0].P<k.P&&(n[0].P=k.P);h=0==l.length?k.P:l[l.length-1].O;h<k.O&&l.push(new Xd(h,k.O,k.V,k.S));p=oe(l,n[0].P);for(r=0;r<n.length;r++){q=n[r];if(p==l.length)break;
l[p].P<q.P&&(h=l[p],p++,l.splice(p,0,new Xd(q.P,h.O,h.V,h.S)),h.O=q.P);for(;p<l.length&&(h=l[p++],h.O>q.O&&(l.splice(p,0,new Xd(q.O,h.O,h.V,h.S)),h.O=q.O),q.V!=q.S&&("left"==e?h.V=q.S:h.S=q.V),h.O!=q.O););}ne(k,l)}qk(a);"left"==e?a.ic=g:a.jc=g;Hk(a,g);Q(c,f)}});return P(c)}
function Ik(a,b){for(var c=a.b,d="";c&&b&&!d&&(1!=c.nodeType||(d=c.style.textAlign,b));c=c.parentNode);if(!b||"justify"==d){var c=a.b,e=c.ownerDocument,d=e.createElement("span");d.style.visibility="hidden";d.textContent=" ########################";d.setAttribute("data-adapt-spec","1");var f=b&&(a.H||1!=c.nodeType)?c.nextSibling:c;if(c=c.parentNode)c.insertBefore(d,f),b||(e=e.createElement("div"),c.insertBefore(e,f),d.style.lineHeight="80px",e.style.marginTop="-80px",e.style.height="0px",e.setAttribute("data-adapt-spec",
"1"))}}function Jk(a,b,c,d){var e=M("processLineStyling");Zj(d);var f=d.concat([]);d.splice(0,d.length);var g=0,h=b.e;0==h.count&&(h=h.Bd);Qe(function(d){if(h){var e=Kk(a,f),n=h.count-g;if(e.length<=n)R(d);else{var p=Lk(a,f,e[n-1]);Mk(a,p,!1,!1).then(function(){g+=n;jk(a.k,p,0).then(function(e){b=e;Ik(b,!1);h=b.e;f=[];kk(a,b,f).then(function(a){c=a;Se(d)})})})}}else R(d)}).then(function(){Array.prototype.push.apply(d,f);Zj(d);Q(e,c)});return P(e)}
function Nk(a,b){for(var c=0,d=0,e=b.length-1;0<=e;e--){var f=b[e];if(!f.H||!f.b||1!=f.b.nodeType)break;f=tk(a,f.b);f=a.b?-f.left:f.bottom;0<f?c=Math.max(c,f):d=Math.min(d,f)}return c-d}
function Ok(a,b){var c=M("layoutBreakableBlock"),d=[];kk(a,b,d).then(function(e){var f=d.length-1;if(0>f)Q(c,e);else{var f=rk(a,e,d,f,d[f].$),g=ck(a,f);null==e&&(f+=Nk(a,d));Hk(a,f);var h;b.e?h=Jk(a,b,e,d):h=O(e);h.then(function(b){0<d.length&&(a.u.push(new Vj(d,d[0].g)),g&&(2!=d.length&&0<a.u.length||d[0].R!=d[1].R||!Sj[d[0].R.localName])&&b&&(b=b.modify(),b.overflow=!0));Q(c,b)})}});return P(c)}
function Lk(a,b,c){Zj(b);for(var d=0,e=b[0].$,f=d,g=b.length-1,h=b[g].$,k;e<h;){k=e+Math.ceil((h-e)/2);for(var f=d,l=g;f<l;){var n=f+Math.ceil((l-f)/2);b[n].$>k?l=n-1:f=n}l=rk(a,null,b,f,k);if(a.b?l<c:l>c){for(h=k-1;b[f].$==k;)f--;g=f}else Hk(a,l),e=k,d=f}a=b[f];b=a.b;1!=b.nodeType&&(a.H?a.aa=b.length:(e-=a.$,c=b.data,173==c.charCodeAt(e)?(b.replaceData(e,c.length-e,"-"),e++):(d=c.charAt(e),e++,f=c.charAt(e),b.replaceData(e,c.length-e,Fa(d)&&Fa(f)?"-":"")),0<e&&(a=a.modify(),a.aa+=e,a.l=null)));return a}
function Kk(a,b){for(var c=[],d=b[0].b,e=b[b.length-1].b,f=[],g=d.ownerDocument.createRange(),h=!1,k=null,l=!1,n=!0;n;){var p=!0;do{var r=null;d==e&&(n=!1);1!=d.nodeType?(l||(g.setStartBefore(d),l=!0),k=d):h?h=!1:d.getAttribute("data-adapt-spec")?p=!l:r=d.firstChild;r||(r=d.nextSibling,r||(h=!0,r=d.parentNode));d=r}while(p&&n);if(l){g.setEndAfter(k);l=Uj(g);for(p=0;p<l.length;p++)f.push(l[p]);l=!1}}f.sort(a.b?ej:dj);k=d=h=g=e=0;for(n=a.b?-1:1;;){if(k<f.length&&(l=f[k],p=1,0<d&&(p=Math.max(a.b?l.right-
...
function Pk(a,b){if(!a.g)return O(!0);for(var c=!1,d=a.g.length-1;0<=d;--d){var e=a.g[d];if(e.$<=b)break;a.g.pop();e.b!==e.d&&(c=!0)}if(!c)return O(!0);var f=M("clearFootnotes"),g=a.e+a.Ja,h=a.g;a.l=null;a.g=null;var k=0;Pe(function(){for(;k<h.length;){var b=h[k++],b=wk(a,b.$,b.d,g);if(b.sa())return b}return O(!1)}).then(function(){Q(f,!0)});return P(f)}
function Wj(a,b,c){var d=b.e,e;if(c)e=c=1;else{for(e=d[0];e.parent&&e.d;)e=e.parent;c=Math.max((e.k.widows||1)-0,1);e=Math.max((e.k.orphans||1)-0,1)}var f=Kk(a,d),g=a.ta,d=Ia(f.length,function(b){return a.b?f[b]<g:f[b]>g}),d=Math.min(f.length-c,d);if(d<e)return null;g=f[d-1];if(b=Lk(a,b.e,g))a.e=(a.b?-1:1)*(g-a.Ja);return b}
function Mk(a,b,c,d){var e=b;c=c||null!=b.b&&1==b.b.nodeType&&!b.H;do{var f=e.b.parentNode;if(!f)break;var g=f,h=e.b;if(g)for(var k=void 0;(k=g.lastChild)!=h;)g.removeChild(k);c&&(f.removeChild(e.b),c=!1);e=e.parent}while(e);d&&Ik(b,!0);return Pk(a,b.$)}
function Qk(a,b,c){var d=M("findAcceptableBreak"),e=null,f=0,g=0;do for(var f=g,g=Number.MAX_VALUE,h=a.u.length-1;0<=h&&!e;--h){var e=a.u[h].d(a,f),k=a.u[h].b();k>f&&(g=Math.min(g,k))}while(g>f&&!e);var l=!1;if(!e){v("Could not find any page breaks?!!");if(a.dd)return Rk(a,b).then(function(b){b?(b=b.modify(),b.overflow=!1,Mk(a,b,l,!0).then(function(){Q(d,b)})):Q(d,b)}),P(d);e=c;l=!0}Mk(a,e,l,!0).then(function(){Q(d,e)});return P(d)}
function Sk(a){a=a.toString();return""==a||"auto"==a||!!a.match(/^0+(.0*)?[^0-9]/)}function Tk(a,b,c,d,e){if(!b)return!1;var f=Tj(b,0,a.b),g=ck(a,f);c&&(f+=Nk(a,c));Hk(a,f);if(d||!g)b=new Xj(kj(b),e,g,a.e),a.u.push(b);return g}
function Uk(a,b){if(b.b.parentNode){var c=tk(a,b.b),d=b.b.ownerDocument.createElement("div");a.b?(d.style.bottom="0px",d.style.width="1px",d.style.marginRight=c.right+"px"):(d.style.right="0px",d.style.height="1px",d.style.marginTop=c.top+"px");b.b.parentNode.insertBefore(d,b.b);var e=d.getBoundingClientRect(),e=a.b?e.right:e.top,f=a.b?-1:1,g;switch(b.u){case "left":g=a.ic;break;case "right":g=a.jc;break;default:g=f*Math.max(a.jc*f,a.ic*f)}e*f>=g*f?b.b.parentNode.removeChild(d):(e=Math.max(1,(g-e)*
...
function Vk(a,b,c){var d=M("skipEdges"),e=c?"avoid":null,f=null,g=[];Qe(function(c){for(;b;){do if(b.b){if(b.d&&1!=b.b.nodeType){if(aj(b.b,b.w))break;if(!b.H){Tk(a,f,null,!0,e)?(b=(f||b).modify(),b.overflow=!0):(b=b.modify(),b.l=e);R(c);return}}if(!b.H&&(b.u&&Uk(a,b),b.h)){Tk(a,f,null,!0,e)&&(b=(f||b).modify(),b.overflow=!0);R(c);return}if(1==b.b.nodeType){var d=b.b.style;if(b.H){if(f=kj(b),g.push(f),e=Rj(b.A,e),d&&(!Sk(d.paddingBottom)||!Sk(d.borderBottomWidth))){if(Tk(a,f,null,!0,e)){b=(f||b).modify();
b.overflow=!0;R(c);return}g=[f];f=e=null}}else{if((e=Rj(b.l,e))&&"avoid"!=e&&"auto"!=e){R(c);a.T=e;return}if(Sj[b.b.localName]){Tk(a,f,null,!0,e)&&(b=(f||b).modify(),b.overflow=!0);R(c);return}if(d&&(!Sk(d.paddingTop)||!Sk(d.borderTopWidth))){if(Tk(a,f,null,!0,e)){b=(f||b).modify();b.overflow=!0;R(c);return}f=e=null;g=[]}}}}while(0);d=lk(a.k,b);if(d.sa()){d.then(function(a){b=a;Se(c)});return}b=d.Nb()}0!=a.u.length&&Tk(a,f,g,!1,e)&&f&&(b=f.modify(),b.overflow=!0);R(c)}).then(function(){Q(d,b)});return P(d)}
function Rk(a,b){var c=b,d=M("skipEdges"),e=null;Qe(function(d){for(;b;){do if(b.b){if(b.d&&1!=b.b.nodeType){if(aj(b.b,b.w))break;if(!b.H){R(d);return}}if(!b.H&&b.h){R(d);return}if(1==b.b.nodeType){var g=b.b.style;if(b.H)e=Rj(b.A,e);else{if((e=Rj(b.l,e))&&"avoid"!=e&&"auto"!=e){R(d);a.T=e;return}if(Sj[b.b.localName]){R(d);return}if(g&&(!Sk(g.paddingTop)||!Sk(g.borderTopWidth))){R(d);return}}}}while(0);g=lk(a.k,b);if(g.sa()){g.then(function(a){b=a;Se(d)});return}b=g.Nb()}c=null;R(d)}).then(function(){Q(d,
c)});return P(d)}function mk(a,b){return"footnote"==b.h?Ek(a,b):Gk(a,b)}function Wk(a,b,c){var d=M("layoutNext");Vk(a,b,c).then(function(c){b=c;if(!b||a.T||b.overflow)Q(d,b);else if(b.h)mk(a,b).ka(d);else{a:{if(!b.H)switch(b.R.namespaceURI){case "http://www.w3.org/2000/svg":c=!1;break a}c=!0}c?Ok(a,b).ka(d):nk(a,b).ka(d)}});return P(d)}
function Bk(a){var b=a.d.ownerDocument.createElement("div");b.style.position="absolute";b.style.top=a.j+"px";b.style.right=a.I+"px";b.style.bottom=a.w+"px";b.style.left=a.h+"px";a.d.appendChild(b);var c=b.getBoundingClientRect();a.d.removeChild(b);var b=a.C+a.left+tj(a),d=a.G+a.top+rj(a);a.f=new Td(b,d,b+a.width,d+a.height);a.Oc=c?a.b?c.top:c.left:0;a.Ja=c?a.b?c.right:c.top:0;a.cb=c?a.b?c.left:c.bottom:0;a.ic=a.Ja;a.jc=a.Ja;a.ta=a.cb;c=a.f;b=a.C+a.left+tj(a);d=a.G+a.top+rj(a);b=a.Jb?ae(a.Jb,b,d):
ce(b,d,b+a.width,d+a.height);a.hc=me(c,[b],a.A,a.tb,a.b);qk(a);a.g=null}function yk(a){a.Ib=[];u(a.d,"width",a.width+"px");u(a.d,"height",a.height+"px");Bk(a);a.e=0;a.Nc=!1;a.T=null}function Hk(a,b){a.e=Math.max((a.b?-1:1)*(b-a.Ja),a.e)}function Xk(a,b){var c=b.b;if(!c)return O(!0);var d=M("layoutOverflownFootnotes"),e=0;Pe(function(){for(;e<c.length;){var b=c[e++],b=wk(a,0,b,a.Ja);if(b.sa())return b}return O(!1)}).then(function(){Q(d,!0)});return P(d)}
function Dk(a,b){a.Ib.push(b);if(a.Nc)return O(b);var c=M("layout");Xk(a,b).then(function(){ek(a,b.La).then(function(b){var e=b,f=!0;a.u=[];Qe(function(c){for(;b;){var h=!0;Wk(a,b,f).then(function(k){f=!1;b=k;a.T?R(c):b&&b.overflow?Qk(a,b,e).then(function(a){b=a;R(c)}):h?h=!1:Se(c)});if(h){h=!1;return}}R(c)}).then(function(){var e=a.l;e&&(a.d.appendChild(e.d),a.b?a.e=this.Ja-this.cb:a.e=e.top+rj(e)+e.e+sj(e));if(b){a.Nc=!0;var f=e=b,k=[];do f.e&&f.parent&&f.parent.e!==f.e||k.push(lj(f)),f=f.parent;
while(f);e=new mj({ja:k,aa:e.aa,H:e.H});if(a.g){f=[];for(k=0;k<a.g.length;k++){var l=a.g[k].b;l&&f.push(l)}e.b=f.length?f:null}Q(c,e)}else Q(c,null)})})});return P(c)}function Ck(a){for(var b=a.Ib;a.d.lastChild!=a.Mc;)a.d.removeChild(a.d.lastChild);pk(a);yk(a);var c=M("redoLayout"),d=0,e=null;Qe(function(c){if(d<b.length){var g=b[d++];Dk(a,g).then(function(a){a?(e=a,R(c)):Se(c)})}else R(c)}).then(function(){Q(c,e)});return P(c)};var Yk=1;function Zk(a,b,c,d,e){this.b={};this.children=[];this.e=null;this.h=0;this.d=a;this.name=b;this.Wa=c;this.ra=d;this.parent=e;this.g="p"+Yk++;e&&(this.h=e.children.length,e.children.push(this))}Zk.prototype.f=function(){throw Error("E_UNEXPECTED_CALL");};Zk.prototype.clone=function(){throw Error("E_UNEXPECTED_CALL");};function $k(a,b){var c=a.b,d=b.b,e;for(e in c)Object.prototype.hasOwnProperty.call(c,e)&&(d[e]=c[e])}
function al(a,b){for(var c=0;c<a.children.length;c++)a.children[c].clone({parent:b})}function bl(a){Zk.call(this,a,null,null,[],null);this.b.width=new V(Nd,0);this.b.height=new V(Pd,0)}t(bl,Zk);
function cl(a,b){this.e=b;var c=this;Xb.call(this,a,function(a,b){var f=a.match(/^([^.]+)\.([^.]+)$/);if(f){var g=c.e.k[f[1]];if(g&&(g=this.Z[g])){if(b){var f=f[2],h=g.ea[f];if(h)g=h;else{switch(f){case "columns":var h=g.d.d,k=new Mc(h,0),l=dl(g,"column-count"),n=dl(g,"column-width"),p=dl(g,"column-gap"),h=F(h,Oc(h,new Jc(h,"min",[k,l]),E(h,n,p)),p)}h&&(g.ea[f]=h);g=h}}else g=dl(g,f[2]);return g}}return null})}t(cl,Xb);
function el(a,b,c,d,e,f,g){a=a instanceof cl?a:new cl(a,this);Zk.call(this,a,b,c,d,e);this.e=this;this.F=f;this.j=g;this.b.width=new V(Nd,0);this.b.height=new V(Pd,0);this.b["wrap-flow"]=new V(jd,0);this.b.position=new V(Ad,0);this.b.overflow=new V(qd,0);this.k={}}t(el,Zk);el.prototype.f=function(a){return new fl(a,this)};el.prototype.clone=function(a){a=new el(this.d,this.name,a.Wa||this.Wa,this.ra,this.parent,this.F,this.j);$k(this,a);al(this,a);return a};
function gl(a,b,c,d,e){Zk.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.k[b]=this.g);this.b["wrap-flow"]=new V(jd,0)}t(gl,Zk);gl.prototype.f=function(a){return new hl(a,this)};gl.prototype.clone=function(a){a=new gl(a.parent.d,this.name,this.Wa,this.ra,a.parent);$k(this,a);al(this,a);return a};function il(a,b,c,d,e){Zk.call(this,a,b,c,d,e);this.e=e.e;b&&(this.e.k[b]=this.g)}t(il,Zk);il.prototype.f=function(a){return new jl(a,this)};
il.prototype.clone=function(a){a=new il(a.parent.d,this.name,this.Wa,this.ra,a.parent);$k(this,a);al(this,a);return a};function X(a,b,c){return b&&b!==jd?b.ca(a,c):null}function kl(a,b,c){return b&&b!==jd?b.ca(a,c):a.b}function ll(a,b,c){return b?b===jd?null:b.ca(a,c):a.b}function ml(a,b,c,d){return b&&c!==wd?b.ca(a,d):a.b}function nl(a,b,c){return b?b===Ld?a.g:b===od?a.f:b.ca(a,a.b):c}
function ol(a,b){this.e=a;this.d=b;this.C={};this.style={};this.k=this.l=null;this.children=[];this.G=this.I=this.f=this.g=!1;this.w=this.A=0;this.u=null;this.ta={};this.ea={};this.ya=this.b=!1;a&&a.children.push(this)}function pl(a,b,c){b=dl(a,b);c=dl(a,c);if(!b||!c)throw Error("E_INTERNAL");return E(a.d.d,b,c)}
function dl(a,b){var c=a.ta[b];if(c)return c;var d=a.style[b];d&&(c=d.ca(a.d.d,a.d.d.b));switch(b){case "margin-left-edge":c=dl(a,"left");break;case "margin-top-edge":c=dl(a,"top");break;case "margin-right-edge":c=pl(a,"border-right-edge","margin-right");break;case "margin-bottom-edge":c=pl(a,"border-bottom-edge","margin-bottom");break;case "border-left-edge":c=pl(a,"margin-left-edge","margin-left");break;case "border-top-edge":c=pl(a,"margin-top-edge","margin-top");break;case "border-right-edge":c=
...
pl(a,"padding-top-edge","padding-top");break;case "right-edge":c=pl(a,"left-edge","width");break;case "bottom-edge":c=pl(a,"top-edge","height")}if(!c){if("extent"==b)d=a.b?"width":"height";else if("measure"==b)d=a.b?"height":"width";else{var e=a.b?Rg:Sg,d=b,f;for(f in e)d=d.replace(f,e[f])}d!=b&&(c=dl(a,d))}c&&(a.ta[b]=c);return c}
function ql(a){var b=a.d.d,c=a.style,d=nl(b,c.enabled,b.g),e=X(b,c.page,b.b);if(e)var f=new Hc(b,"page-number"),d=Nc(b,d,new zc(b,e,f));(e=X(b,c["min-page-width"],b.b))&&(d=Nc(b,d,new yc(b,new Hc(b,"page-width"),e)));(e=X(b,c["min-page-height"],b.b))&&(d=Nc(b,d,new yc(b,new Hc(b,"page-height"),e)));d=a.T(d);c.enabled=new L(d)}ol.prototype.T=function(a){return a};
ol.prototype.xc=function(){var a=this.d.d,b=this.style,c=this.e?this.e.style.width.ca(a,null):null,d=X(a,b.left,c),e=X(a,b["margin-left"],c),f=ml(a,b["border-left-width"],b["border-left-style"],c),g=kl(a,b["padding-left"],c),h=X(a,b.width,c),k=X(a,b["max-width"],c),l=kl(a,b["padding-right"],c),n=ml(a,b["border-right-width"],b["border-right-style"],c),p=X(a,b["margin-right"],c),r=X(a,b.right,c),q=E(a,f,g),y=E(a,f,l);d&&r&&h?(q=F(a,c,E(a,h,E(a,E(a,d,q),y))),e?p?r=F(a,q,p):p=F(a,q,E(a,r,e)):(q=F(a,q,
r),p?e=F(a,q,p):p=e=Oc(a,q,new Yb(a,.5)))):(e||(e=a.b),p||(p=a.b),d||r||h||(d=a.b),d||h?d||r?h||r||(h=this.l,this.g=!0):d=a.b:(h=this.l,this.g=!0),q=F(a,c,E(a,E(a,e,q),E(a,p,y))),this.g&&(k||(k=F(a,q,d?d:r)),this.b||!X(a,b["column-width"],null)&&!X(a,b["column-count"],null)||(h=k,this.g=!1)),d?h?r||(r=F(a,q,E(a,d,h))):h=F(a,q,E(a,d,r)):d=F(a,q,E(a,r,h)));a=kl(a,b["snap-width"]||(this.e?this.e.style["snap-width"]:null),c);b.left=new L(d);b["margin-left"]=new L(e);b["border-left-width"]=new L(f);b["padding-left"]=
...
ol.prototype.yc=function(){var a=this.d.d,b=this.style,c=this.e?this.e.style.width.ca(a,null):null,d=this.e?this.e.style.height.ca(a,null):null,e=X(a,b.top,d),f=X(a,b["margin-top"],c),g=ml(a,b["border-top-width"],b["border-top-style"],c),h=kl(a,b["padding-top"],c),k=X(a,b.height,d),l=X(a,b["max-height"],d),n=kl(a,b["padding-bottom"],c),p=ml(a,b["border-bottom-width"],b["border-bottom-style"],c),r=X(a,b["margin-bottom"],c),q=X(a,b.bottom,d),y=E(a,g,h),x=E(a,p,n);e&&q&&k?(d=F(a,d,E(a,k,E(a,E(a,e,y),
x))),f?r?q=F(a,d,f):r=F(a,d,E(a,q,f)):(d=F(a,d,q),r?f=F(a,d,r):r=f=Oc(a,d,new Yb(a,.5)))):(f||(f=a.b),r||(r=a.b),e||q||k||(e=a.b),e||k?e||q?k||q||(k=this.k,this.f=!0):e=a.b:(k=this.k,this.f=!0),d=F(a,d,E(a,E(a,f,y),E(a,r,x))),this.f&&(l||(l=F(a,d,e?e:q)),this.b&&(X(a,b["column-width"],null)||X(a,b["column-count"],null))&&(k=l,this.f=!1)),e?k?q||(q=F(a,d,E(a,e,k))):k=F(a,d,E(a,q,e)):e=F(a,d,E(a,q,k)));a=kl(a,b["snap-height"]||(this.e?this.e.style["snap-height"]:null),c);b.top=new L(e);b["margin-top"]=
...
function rl(a){var b=a.d.d,c=a.style;a=X(b,c[a.b?"height":"width"],null);var d=X(b,c["column-width"],a),e=X(b,c["column-count"],null),f;(f=(f=c["column-gap"])&&f!==xd?f.ca(b,null):null)||(f=new Gc(b,1,"em"));d&&!e&&(e=new Jc(b,"floor",[Pc(b,E(b,a,f),E(b,d,f))]),e=new Jc(b,"max",[b.d,e]));e||(e=b.d);d=F(b,Pc(b,E(b,a,f),e),f);c["column-width"]=new L(d);c["column-count"]=new L(e);c["column-gap"]=new L(f)}function sl(a,b,c,d){a=a.style[b].ca(a.d.d,null);return jc(a,c,d,{})}
function tl(a,b){b.Z[a.d.g]=a;var c=a.d.d,d=a.style,e=a.e?ul(a.e,b):null,e=mi(a.C,b,e,!1);a.b=li(e,b,a.e?a.e.b:!1);ni(e,d,a.b,function(a,b){return b.value});a.l=new $b(c,function(){return a.A},"autoWidth");a.k=new $b(c,function(){return a.w},"autoHeight");a.xc();a.yc();rl(a);ql(a)}function vl(a,b,c){(a=a.style[c])&&(a=Jf(b,a,c));return a}function Y(a,b,c){(a=a.style[c])&&(a=Jf(b,a,c));return gd(a,b)}
function ul(a,b){var c;a:{if(c=a.C["region-id"]){for(var d=[],e=0;e<c.length;e++){var f=c[e].evaluate(b,"");f&&f!==G&&d.push(f)}if(d.length){c=d;break a}}c=null}if(c){d=[];for(e=0;e<c.length;e++)d[e]=c[e].toString();return d}return null}function wl(a,b,c,d){(a=vl(a,b,d))&&u(c.d,d,a.toString())}
function xl(a,b,c){var d=Y(a,b,"left"),e=Y(a,b,"margin-left"),f=Y(a,b,"padding-left"),g=Y(a,b,"border-left-width");a=Y(a,b,"width");xj(c,d,a);u(c.d,"margin-left",e+"px");u(c.d,"padding-left",f+"px");u(c.d,"border-left-width",g+"px");c.marginLeft=e;c.Z=g;c.h=f}
function yl(a,b,c){var d=Y(a,b,"right"),e=Y(a,b,"snap-height"),f=Y(a,b,"margin-right"),g=Y(a,b,"padding-right");b=Y(a,b,"border-right-width");u(c.d,"margin-right",f+"px");u(c.d,"padding-right",g+"px");u(c.d,"border-right-width",b+"px");c.marginRight=f;c.Ua=b;a.b&&0<e&&(a=d+uj(c),a=a-Math.floor(a/e)*e,0<a&&(c.Kb=e-a,g+=c.Kb));c.I=g;c.Lb=e}
function zl(a,b,c){var d=Y(a,b,"snap-height"),e=Y(a,b,"top"),f=Y(a,b,"margin-top"),g=Y(a,b,"padding-top");b=Y(a,b,"border-top-width");c.top=e;c.marginTop=f;c.ea=b;c.tb=d;!a.b&&0<d&&(a=e+rj(c),a=a-Math.floor(a/d)*d,0<a&&(c.wa=d-a,g+=c.wa));c.j=g;u(c.d,"top",e+"px");u(c.d,"margin-top",f+"px");u(c.d,"padding-top",g+"px");u(c.d,"border-top-width",b+"px")}
function Al(a,b,c){var d=Y(a,b,"margin-bottom"),e=Y(a,b,"padding-bottom"),f=Y(a,b,"border-bottom-width");a=Y(a,b,"height")-c.wa;u(c.d,"height",a+"px");u(c.d,"margin-bottom",d+"px");u(c.d,"padding-bottom",e+"px");u(c.d,"border-bottom-width",f+"px");c.height=a-c.wa;c.marginBottom=d;c.ya=f;c.w=e}function Bl(a,b,c){a.b?(zl(a,b,c),Al(a,b,c)):(yl(a,b,c),xl(a,b,c))}
function Cl(a,b,c){u(c.d,"border-top-width","0px");var d=Y(a,b,"max-height");a.I?wj(c,0,d):(zl(a,b,c),d-=c.wa,c.height=d,u(c.d,"height",d+"px"))}function Dl(a,b,c){u(c.d,"border-left-width","0px");var d=Y(a,b,"max-width");a.G?xj(c,0,d):(yl(a,b,c),d-=c.Kb,c.width=d,a=Y(a,b,"right"),u(c.d,"right",a+"px"),u(c.d,"width",d+"px"))}
...
ol.prototype.Tb=function(a,b){this.e&&this.b==this.e.b||u(b.d,"writing-mode",this.b?"vertical-rl":"horizontal-tb");(this.b?this.g:this.f)?this.b?Dl(this,a,b):Cl(this,a,b):(this.b?yl(this,a,b):zl(this,a,b),this.b?xl(this,a,b):Al(this,a,b));(this.b?this.f:this.g)?this.b?Cl(this,a,b):Dl(this,a,b):Bl(this,a,b);for(var c=0;c<El.length;c++)wl(this,a,b,El[c])};function Il(a,b,c){for(var d=0;d<Gl.length;d++)wl(a,b,c,Gl[d])}
ol.prototype.Qb=function(a,b,c,d,e){this.b?this.A=b.e+b.Kb:this.w=b.e+b.wa;var f=(this.b||!d)&&this.f,g=(!this.b||!d)&&this.g,h=null;if(g||f)g&&u(b.d,"width","auto"),f&&u(b.d,"height","auto"),h=(d?d.d:b.d).getBoundingClientRect(),g&&(this.A=Math.ceil(h.right-h.left-b.h-b.Z-b.I-b.Ua),this.b&&(this.A+=b.Kb)),f&&(this.w=h.bottom-h.top-b.j-b.ea-b.w-b.ya,this.b||(this.w+=b.wa));(this.b?this.f:this.g)&&Bl(this,a,b);if(this.b?this.g:this.f){if(this.b?this.G:this.I)this.b?yl(this,a,b):zl(this,a,b);this.b?
xl(this,a,b):Al(this,a,b)}if(1<e&&(f=Y(this,a,"column-rule-width"),g=vl(this,a,"column-rule-style"),h=vl(this,a,"column-rule-color"),0<f&&g&&g!=wd&&h!=Hd)){var k=Y(this,a,"column-gap"),l=this.b?b.height:b.width,n=this.b?"border-top":"border-left";for(d=1;d<e;d++){var p=(l+k)*d/e-k/2+b.h-f/2,r=b.height+b.j+b.w,q=b.d.ownerDocument.createElement("div");u(q,"position","absolute");u(q,this.b?"left":"top","0px");u(q,this.b?"top":"left",p+"px");u(q,this.b?"height":"width","0px");u(q,this.b?"width":"height",
r+"px");u(q,n,f+"px "+g.toString()+(h?" "+h.toString():""));b.d.insertBefore(q,b.d.firstChild)}}for(d=0;d<Fl.length;d++)wl(this,a,b,Fl[d]);for(d=0;d<Hl.length;d++)e=b,f=Hl[d],g=c.f,(h=vl(this,a,f))&&g.push(new Ui(e.d,f,h))};
ol.prototype.h=function(a,b){var c=this.C,d=this.d.b,e;for(e in d)Wg(e)&&Xg(c,e,d[e]);if("background-host"==this.d.Wa)for(e in b)if(e.match(/^background-/)||"writing-mode"==e)c[e]=b[e];if("layout-host"==this.d.Wa)for(e in b)e.match(/^background-/)||"writing-mode"==e||(c[e]=b[e]);Xh(a,this.d.ra,null,c);tl(this,a.d);for(c=0;c<this.d.children.length;c++)this.d.children[c].f(this).h(a,b);a.pop()};
function Jl(a,b){a.g&&(a.G=sl(a,"right",a.l,b)||sl(a,"margin-right",a.l,b)||sl(a,"border-right-width",a.l,b)||sl(a,"padding-right",a.l,b));a.f&&(a.I=sl(a,"top",a.k,b)||sl(a,"margin-top",a.k,b)||sl(a,"border-top-width",a.k,b)||sl(a,"padding-top",a.k,b));for(var c=0;c<a.children.length;c++)Jl(a.children[c],b)}function Kl(a){ol.call(this,null,a)}t(Kl,ol);Kl.prototype.h=function(a,b){ol.prototype.h.call(this,a,b);this.children.sort(function(a,b){return b.d.j-a.d.j||a.d.h-b.d.h})};
function fl(a,b){ol.call(this,a,b);this.u=this}t(fl,ol);fl.prototype.T=function(a){var b=this.d.e;b.F&&(a=Nc(b.d,a,b.F));return a};fl.prototype.Z=function(){};function hl(a,b){ol.call(this,a,b);this.u=a.u}t(hl,ol);function jl(a,b){ol.call(this,a,b);this.u=a.u}t(jl,ol);function Ll(a,b,c,d){var e=null;c instanceof ad&&(e=[c]);c instanceof Uc&&(e=c.values);if(e)for(a=a.d.d,c=0;c<e.length;c++)if(e[c]instanceof ad){var f=Vb(e[c].name,"enabled"),f=new Hc(a,f);d&&(f=new pc(a,f));b=Nc(a,b,f)}return b}
jl.prototype.T=function(a){var b=this.d.d,c=this.style,d=nl(b,c.required,b.f)!==b.f;if(d||this.f){var e;e=(e=c["flow-from"])?e.ca(b,b.b):new Yb(b,"body");e=new Jc(b,"has-content",[e]);a=Nc(b,a,e)}a=Ll(this,a,c["required-partitions"],!1);a=Ll(this,a,c["conflicting-partitions"],!0);d&&(c=(c=this.u.style.enabled)?c.ca(b,null):b.g,c=Nc(b,c,a),this.u.style.enabled=new L(c));return a};jl.prototype.Tb=function(a,b,c){u(b.d,"overflow","hidden");ol.prototype.Tb.call(this,a,b,c)};
function Ml(a,b,c,d){gf.call(this,a,b,!1);this.target=c;this.b=d}t(Ml,hf);Ml.prototype.Ea=function(a,b,c){Gg(this.b,a,b,c,this)};Ml.prototype.dc=function(a,b){jf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};Ml.prototype.wb=function(a,b){jf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Ml.prototype.Xa=function(a,b,c){this.target.b[a]=new V(b,c?50331648:67108864)};function Nl(a,b,c,d){Ml.call(this,a,b,c,d)}t(Nl,Ml);
function Ol(a,b,c,d){Ml.call(this,a,b,c,d);c.b.width=new V(Md,0);c.b.height=new V(Md,0)}t(Ol,Ml);Ol.prototype.Eb=function(a,b,c){a=new il(this.e,a,b,c,this.target);ff(this.Y,new Nl(this.e,this.Y,a,this.b))};Ol.prototype.Db=function(a,b,c){a=new gl(this.e,a,b,c,this.target);a=new Ol(this.e,this.Y,a,this.b);ff(this.Y,a)};function Pl(a,b,c,d){Ml.call(this,a,b,c,d)}t(Pl,Ml);Pl.prototype.Eb=function(a,b,c){a=new il(this.e,a,b,c,this.target);ff(this.Y,new Nl(this.e,this.Y,a,this.b))};
Pl.prototype.Db=function(a,b,c){a=new gl(this.e,a,b,c,this.target);a=new Ol(this.e,this.Y,a,this.b);ff(this.Y,a)};var Ql={"text-indent":"0px","margin-top":"0px","padding-top":"0px","border-top-width":"0px","border-top-style":"none","border-top-color":"transparent"},Rl={"text-indent":"0px","margin-right":"0px","padding-right":"0px","border-right-width":"0px","border-right-style":"none","border-right-color":"transparent"},Sl={};
function Tl(a){a.addEventListener("load",function(){a.contentWindow.navigator.epubReadingSystem={name:"adapt",version:"0.1",layoutStyle:"paginated",hasFeature:function(a){switch(a){case "mouse-events":return!0}return!1}}},!1)}var Ul=(new DOMParser).parseFromString('<root xmlns="http://www.pyroxy.com/ns/shadow"/>',"text/xml"),Vl="footnote-marker first-5-lines first-4-lines first-3-lines first-2-lines first-line first-letter before  after".split(" ");
function Wl(a,b,c,d){this.style=b;this.f=a;this.b=c;this.d=d;this.e={}}
Wl.prototype.g=function(a){var b=a.getAttribute("class")||"";this.b&&b&&b.match(/after$/)&&(this.style=this.b.g(this.f,!0),this.b=null);var c=this.style._pseudos[b]||{};if(!this.e[b]){this.e[b]=!0;var d=c.content;d&&(d=d.evaluate(this.d),zj(d)&&d.L(new yj(a,this.d)))}if(b.match(/^first-/)&&!c["x-first-pseudo"]){a=1;var e;"first-letter"==b?a=0:null!=(e=b.match(/^first-([0-9]+)-lines$/))&&(a=e[1]-0);c["x-first-pseudo"]=new V(new cd(a),0)}return c};
function Xl(a,b,c,d,e,f,g,h,k,l,n,p){this.w=a;this.f=b;this.viewport=c;this.l=c.b;this.j=d;this.C=e;this.X=f;this.A=g;this.k=h;this.G=k;this.d=l;this.g=n;this.u=p;this.I=this.b=null;this.h=!1;this.R=null;this.aa=0;this.e=null}Xl.prototype.clone=function(){return new Xl(this.w,this.f,this.viewport,this.j,this.C,this.X,this.A,this.k,this.G,this.d,this.g,this.u)};
function Yl(a,b,c,d,e,f){var g=M("createRefShadow");a.X.j.load(b).then(function(h){if(h){var k=Gi(h,b);if(k){var l=a.G,n=l.C[h.url];n||(n=l.style.h.b[h.url],n=new Hj(h,n.d,n.g,new dc(0,l.k(),l.j(),l.fontSize),l.e,n.j,l.w),l.C[h.url]=n);f=new fj(d,k,h,e,f,c,n)}}Q(g,f)});return P(g)}
function Zl(a,b,c,d,e,f,g,h){var k=M("createShadows"),l=e.template,n;l instanceof ed?n=Yl(a,l.url,2,b,h,null):n=O(null);n.then(function(l){var n=null;if("http://www.pyroxy.com/ns/shadow"==b.namespaceURI&&"include"==b.localName){var q=b.getAttribute("href"),y=null;q?y=h?h.X:a.X:h&&(q="http://www.w3.org/1999/xhtml"==h.Y.namespaceURI?h.Y.getAttribute("href"):h.Y.getAttributeNS("http://www.w3.org/1999/xlink","href"),y=h.Fc?h.Fc.X:a.X);q&&(q=ea(q,y.url),n=Yl(a,q,3,b,h,l))}null==n&&(n=O(l));n.then(function(l){var n;
if(n=d._pseudos){for(var p=Ul.createElementNS("http://www.pyroxy.com/ns/shadow","root"),q=p,r=0;r<Vl.length;r++){var y=Vl[r],Va;if(y){if(!n[y])continue;if(!("footnote-marker"!=y||c&&a.h))continue;if(y.match(/^first-/)&&(Va=e.display,!Va||Va===sd))continue;Va=Ul.createElementNS("http://www.w3.org/1999/xhtml","span");Va.setAttribute("class",y)}else Va=Ul.createElementNS("http://www.pyroxy.com/ns/shadow","content");q.appendChild(Va);y.match(/^first-/)&&(q=Va)}l=new fj(b,p,null,h,l,2,new Wl(b,d,f,g))}Q(k,
l)})});return P(k)}function fk(a,b,c){a.I=b;a.h=c}function $l(a,b,c,d){var e=a.f;c=mi(c,e,a.C,a.h);b=li(c,e,b);ni(c,d,b,function(b,c){var d=c.evaluate(e,b);if("font-family"==b){var k=a.A;if(d instanceof Uc){for(var d=d.values,l=[],n=0;n<d.length;n++){var p=d[n],r=k.b[p.stringValue()];r&&l.push(H(r));l.push(p)}d=new Uc(l)}else d=(k=k.b[d.stringValue()])?new Uc([H(k),d]):d}return d});return b}
function am(a,b){for(var c=a.b.R,d=[],e=a.b.da;c&&1==c.nodeType;){var f=e&&e.root==c;if(!f||2==e.type){var g=(e?e.b:a.j).g(c,!1);d.push(g)}f?(c=e.Y,e=e.Fc):c=c.parentNode}c={"font-size":new V(new K(fc(a.f,"em"),"px"),0)};e=new ah(c,a.f);for(f=d.length-1;0<=f;--f){var g=d[f],h=[],k;for(k in g)Ig[k]&&h.push(k);h.sort(Sd);for(var l=0;l<h.length;l++){var n=h[l];e.b=n;c[n]=g[n].qc(e)}}for(var p in b)Ig[p]||(c[p]=b[p]);return c}
var bm={a:"a",sub:"sub",sup:"sup",table:"table",tr:"tr",td:"td",th:"th",code:"code",body:"div",p:"p",v:"p",date:"p",emphasis:"em",strong:"strong",style:"span",strikethrough:"del"};function cm(a,b){b=ea(b,a.X.url);return a.u[b]||b}
function dm(a,b){var c=!0,d=M("createElementView"),e=a.R,f=a.b.da?a.b.da.b:a.j,g=f.g(e,!1),h={};a.b.parent||(g=am(a,g));a.b.f=$l(a,a.b.f,g,h);var k=h["flow-into"];if(k&&k.toString()!=a.w)return Q(d,!1),P(d);var l=h.display;if(l===wd)return Q(d,!1),P(d);Zl(a,e,null==a.b.parent,g,h,f,a.f,a.b.da).then(function(f){a.b.pa=f;var g=a.b.parent&&a.b.parent.j;f=h["float"];var k=h.clear;if(h.position===hd||h.position===Ad)a.b.j=!0,f=null;g&&(k=null,f!==pd&&(f=null));g=f===ud||f===Bd||f===pd;f&&(delete h["float"],
...
C||"li"==C?C="div":"q"==C?C="span":"a"==C&&(f=h["hyperlink-processing"])&&"normal"!=f.toString()&&(C="span");h.behavior&&"none"!=h.behavior.toString()&&a.g&&(y=!0);var N;y?N=a.g(e,a.b.parent?a.b.parent.b:null,h):N=O(null);N.then(function(f){f?y&&(c="true"==f.getAttribute("data-adapt-process-children")):f=a.createElement(J,C);"a"==C&&f.addEventListener("click",a.d.l,!1);x&&(Fk(a,a.b,"inner",x),f.appendChild(x));"iframe"==f.localName&&"http://www.w3.org/1999/xhtml"==f.namespaceURI&&Tl(f);if("http://www.gribuser.ru/xml/fictionbook/2.0"!=
e.namespaceURI||"td"==C){for(var g=e.attributes,k=g.length,l=null,n=0;n<k;n++){var p=g[n],r=p.namespaceURI,N=p.localName,p=p.nodeValue;if(r)if("http://www.w3.org/2000/xmlns/"==r)continue;else"http://www.w3.org/1999/xlink"==r&&"href"==N&&(p=cm(a,p));else{if(N.match(/^on/))continue;if("style"==N)continue;if("id"==N){$i(a.d,f,p);continue}if("src"==N||"href"==N||"poster"==N)p=cm(a,p)}if(r){var zk=Sl[r];zk&&(N=zk+":"+N)}"src"!=N||r||"img"!=C||"http://www.w3.org/1999/xhtml"!=J?"href"==N&&"image"==C&&"http://www.w3.org/2000/svg"==
J&&"http://www.w3.org/1999/xlink"==r?a.d.d.push(Vf(f,p)):r?f.setAttributeNS(r,N,p):f.setAttribute(N,p):l=p}l&&(g=Vf(f,l),h.width&&h.height?a.d.d.push(g):I.push(g))}delete h.content;(g=h["list-style-image"])&&g instanceof ed&&(g=g.url,I.push(Vf(new Image,g)));em(a,f,h);g=h.widows;k=h.orphans;if(g||k){if(a.b.parent){a.b.k={};for(var Od in a.b.parent.k)a.b.k[Od]=a.b.parent.k[Od]}g instanceof cd&&(a.b.k.widows=g.B);k instanceof cd&&(a.b.k.orphans=k.B)}if(!b&&!a.b.d){Od=a.b.f?Rl:Ql;for(var Ak in Od)u(f,
Ak,Od[Ak])}q&&f.setAttribute("value",h["ua-list-item-count"].stringValue());a.e=f;I.length?Uf(I).then(function(){Q(d,c)}):Oe().then(function(){Q(d,c)})})});return P(d)}function fm(a,b){var c=M("createNodeView"),d,e=!0;1==a.R.nodeType?d=dm(a,b):(8==a.R.nodeType?a.e=null:a.e=document.createTextNode(a.R.textContent.substr(a.aa||0)),d=O(!0));d.then(function(b){e=b;(a.b.b=a.e)&&(b=a.b.parent?a.b.parent.b:a.I)&&b.appendChild(a.e);Q(c,e)});return P(c)}
function gk(a,b,c){(a.b=b)?(a.R=b.R,a.aa=b.aa):(a.R=null,a.aa=-1);a.e=null;return a.b?fm(a,c):O(!0)}function gm(a){if(null==a.da||"content"!=a.R.localName||"http://www.pyroxy.com/ns/shadow"!=a.R.namespaceURI)return a;var b=a.$,c=a.da,d=a.parent,e,f;c.$c?(f=c.$c,e=c.root,c=c.type,2==c&&(e=e.firstChild)):(f=c.Fc,e=c.Y.firstChild,c=2);var g=a.R.nextSibling;g?(a.R=g,ij(a)):a.ia?a=a.ia:e?a=null:(a=a.parent.modify(),a.H=!0);if(e)return b=new hj(e,d,b),b.da=f,b.Fa=c,b.ia=a,b;a.$=b;return a}
function hm(a){var b=a.$+1;if(a.H){if(!a.parent)return null;if(3!=a.Fa){var c=a.R.nextSibling;if(c)return a=a.modify(),a.$=b,a.R=c,ij(a),gm(a)}if(a.ia)return a=a.ia.modify(),a.$=b,a;a=a.parent.modify()}else{if(a.pa&&(c=a.pa.root,2==a.pa.type&&(c=c.firstChild),c))return b=new hj(c,a,b),b.da=a.pa,b.Fa=a.pa.type,gm(b);if(c=a.R.firstChild)return gm(new hj(c,a,b));1!=a.R.nodeType&&(b+=a.R.textContent.length-1-a.aa);a=a.modify()}a.$=b;a.H=!0;return a}
function lk(a,b){b=hm(b);if(!b||b.H)return O(b);var c=M("nextInTree");gk(a,b,!0).then(function(a){b.b&&a||(b=b.modify(),b.H=!0,b.b||(b.d=!0));Q(c,b)});return P(c)}function im(a,b){if(b instanceof Uc)for(var c=b.values,d=0;d<c.length;d++)im(a,c[d]);else b instanceof ed&&(c=b.url,a.d.d.push(Vf(new Image,c)))}function em(a,b,c){var d=c["background-image"];d&&im(a,d);for(var e in c)d=c[e],!Ti[e]||"position"==e&&d!==Ad?u(b,e,d.toString()):a.d.f.push(new Ui(b,e,d))}
function Fk(a,b,c,d){if(!b.H){var e=(b.da?b.da.b:a.j).g(a.R,!1);if(e=e._pseudos)e=e[c],c={},b.f=$l(a,b.f,e,c),b=c.content,zj(b)&&(b.L(new yj(d,a.f)),delete c.content),em(a,d,c)}}
function jk(a,b,c){var d=M("peelOff"),e=b.e,f=b.aa,g=b.H;if(0<c)b.b.textContent=b.b.textContent.substr(0,c),f+=c;else if(!g&&b.b&&0==f){var h=b.b.parentNode;h&&h.removeChild(b.b)}for(var k=b.$+c,l=[];b.e===e;)l.push(b),b=b.parent;var n=l.pop(),p=n.ia;Pe(function(){for(;0<l.length;){n=l.pop();b=new hj(n.R,b,k);0==l.length&&(b.aa=f,b.H=g);b.Fa=n.Fa;b.da=n.da;b.pa=n.pa;b.ia=n.ia?n.ia:p;p=null;var c=gk(a,b,!1);if(c.sa())return c}return O(!1)}).then(function(){Q(d,b)});return P(d)}
Xl.prototype.createElement=function(a,b){return"http://www.w3.org/1999/xhtml"==a?this.l.createElement(b):this.l.createElementNS(a,b)};function xk(a,b,c){var d={},e=a.k._pseudos;b=$l(a,b,a.k,d);if(e&&e.before){var f={},g=a.createElement("http://www.w3.org/1999/xhtml","span");c.appendChild(g);$l(a,b,e.before,f);delete f.content;em(a,g,f)}delete d.content;em(a,c,d);return b}function jm(a){this.b=a}function Uj(a){return a.getClientRects()}
function km(a,b,c,d,e){this.d=a;this.fontSize=b;this.b=a.document;this.root=c||this.b.body;this.width=d||a.innerWidth;this.height=e||a.innerHeight;this.root.style["min-width"]=this.width+"px";this.root.style["min-height"]=this.height+"px"};function lm(a,b,c){function d(c){return a.b.getComputedStyle(b,null).getPropertyValue(c)}function e(){u(b,"display","block");u(b,"position","static");return d(J)}function f(){u(b,"display","inline-block");u(y,J,"99999999px");var a=d(J);u(y,J,"");return a}function g(){u(b,"display","inline-block");u(y,J,"0");var a=d(J);u(y,J,"");return a}function h(){u(b,"display","inline-block");return d(J)}function k(){throw Error("Getting fill-available block size is not implemented");}var l=b.style.display,n=b.style.position,
p=b.style.width,r=b.style.height,q=b.parentNode,y=b.ownerDocument.createElement("div");u(y,"position",n);q.insertBefore(y,b);y.appendChild(b);u(b,"width","auto");u(b,"height","auto");var x=d(ya["writing-mode"]||"writing-mode"),I="vertical-rl"===x||"vertical-lr"===x,J=I?"height":"width",C=I?"width":"height",N={};c.forEach(function(a){var c;switch(a){case "fill-available inline size":c=e();break;case "max-content inline size":c=f();break;case "min-content inline size":c=g();break;case "fit-content inline size":c=
h();break;case "fill-available block size":c=k();break;case "max-content block size":case "min-content block size":case "fit-content block size":c=d(C);break;case "fill-available width":c=I?k():e();break;case "fill-available height":c=I?e():k();break;case "max-content width":c=I?d(C):f();break;case "max-content height":c=I?f():d(C);break;case "min-content width":c=I?d(C):g();break;case "min-content height":c=I?g():d(C);break;case "fit-content width":c=I?d(C):h();break;case "fit-content height":c=
I?h():d(C)}N[a]=parseFloat(c);u(b,"position",n);u(b,"display",l)});u(b,"width",p);u(b,"height",r);q.insertBefore(b,y);q.removeChild(y);return N};function mm(a){var b=a["writing-mode"],b=b&&b.value;a=(a=a.direction)&&a.value;return b===Id||b!==Jd&&a!==Ed?"ltr":"rtl"}
var nm={a5:{width:new K(148,"mm"),height:new K(210,"mm")},a4:{width:new K(210,"mm"),height:new K(297,"mm")},a3:{width:new K(297,"mm"),height:new K(420,"mm")},b5:{width:new K(176,"mm"),height:new K(250,"mm")},b4:{width:new K(250,"mm"),height:new K(353,"mm")},letter:{width:new K(8.5,"in"),height:new K(11,"in")},legal:{width:new K(8.5,"in"),height:new K(14,"in")},ledger:{width:new K(11,"in"),height:new K(17,"in")}},om={width:Nd,height:Pd};
function pm(a){if((a=a.size)&&a.value!==jd){var b=a.value;b.md()?(a=b.values[0],b=b.values[1]):(a=b,b=null);return a.Wc()?{width:a,height:b||a}:(a=nm[a.name.toLowerCase()])?b&&b===td?{width:a.height,height:a.width}:{width:a.width,height:a.height}:om}return om}
var qm=function(){var a={width:!0,height:!0,"block-size":!0,"inline-size":!0,margin:!0,padding:!0,border:!0,outline:!0,"outline-width":!0,"outline-style":!0,"outline-color":!0};"left right top bottom before after start end block-start block-end inline-start inline-end".split(" ").forEach(function(b){a["margin-"+b]=!0;a["padding-"+b]=!0;a["border-"+b+"-width"]=!0;a["border-"+b+"-style"]=!0;a["border-"+b+"-color"]=!0});return a}(),rm={"top-left-corner":{K:1,oa:!0,la:!1,ma:!0,na:!0,ba:null},"top-left":{K:2,
...
la:!0,ma:!1,na:!1,ba:"center"},"bottom-left":{K:12,oa:!1,la:!0,ma:!1,na:!1,ba:"start"},"bottom-left-corner":{K:13,oa:!1,la:!0,ma:!0,na:!1,ba:null},"left-bottom":{K:14,oa:!1,la:!1,ma:!0,na:!1,ba:"end"},"left-middle":{K:15,oa:!1,la:!1,ma:!0,na:!1,ba:"center"},"left-top":{K:16,oa:!1,la:!1,ma:!0,na:!1,ba:"start"}},sm=Object.keys(rm).sort(function(a,b){return rm[a].K-rm[b].K});
function tm(a,b,c){el.call(this,a,null,"vivliostyle-page-rule-master",[],b,null,0);a=pm(c);new um(this.d,this,c,a);this.u={};vm(this,c);this.b.position=new V(Ad,0);this.b.width=new V(a.width,0);this.b.height=new V(a.height,0);for(var d in c)qm[d]||"background-clip"===d||(this.b[d]=c[d])}t(tm,el);function vm(a,b){var c=b._marginBoxes;c&&sm.forEach(function(d){c[d]&&(a.u[d]=new wm(a.d,a,d,b))})}tm.prototype.f=function(a){return new xm(a,this)};
function um(a,b,c,d){il.call(this,a,null,null,[],b);this.w=d;this.b["z-index"]=new V(new cd(0),0);this.b["flow-from"]=new V(H("body"),0);this.b.position=new V(hd,0);this.b.overflow=new V(Kd,0);for(var e in qm)qm.hasOwnProperty(e)&&(this.b[e]=c[e])}t(um,il);um.prototype.f=function(a){return new ym(a,this)};
function wm(a,b,c,d){il.call(this,a,null,null,[],b);this.l=c;a=d._marginBoxes[this.l];for(var e in d)if(b=d[e],c=a[e],Ig[e]||c&&c.value===rd)this.b[e]=b;for(e in a)Object.prototype.hasOwnProperty.call(a,e)&&(b=a[e])&&b.value!==rd&&(this.b[e]=b)}t(wm,il);wm.prototype.f=function(a){return new zm(a,this)};function xm(a,b){fl.call(this,a,b);this.j=null;this.wa={}}t(xm,fl);
xm.prototype.h=function(a,b){var c=this.C,d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d))switch(d){case "writing-mode":case "direction":c[d]=b[d]}fl.prototype.h.call(this,a,b)};xm.prototype.xc=function(){var a=this.style;a.left=Qd;a["margin-left"]=Qd;a["border-left-width"]=Qd;a["padding-left"]=Qd;a["padding-right"]=Qd;a["border-right-width"]=Qd;a["margin-right"]=Qd;a.right=Qd};
xm.prototype.yc=function(){var a=this.style;a.top=Qd;a["margin-top"]=Qd;a["border-top-width"]=Qd;a["padding-top"]=Qd;a["padding-bottom"]=Qd;a["border-bottom-width"]=Qd;a["margin-bottom"]=Qd;a.bottom=Qd};xm.prototype.Z=function(a,b,c){b=b.k;var d={start:this.j.marginLeft,end:this.j.marginRight,W:this.j.ib},e={start:this.j.marginTop,end:this.j.marginBottom,W:this.j.hb};Am(this,b.top,!0,d,a,c);Am(this,b.bottom,!0,d,a,c);Am(this,b.left,!1,e,a,c);Am(this,b.right,!1,e,a,c)};
function Bm(a,b,c,d,e){this.J=a;this.l=e;this.g=c;this.k=!X(d,b[c?"width":"height"],new Gc(d,0,"px"));this.h=null}Bm.prototype.b=function(){return this.k};function Cm(a){a.h||(a.h=lm(a.l,a.J.d,a.g?["max-content width","min-content width"]:["max-content height","min-content height"]));return a.h}Bm.prototype.e=function(){var a=Cm(this);return this.g?tj(this.J)+a["max-content width"]+uj(this.J):rj(this.J)+a["max-content height"]+sj(this.J)};
Bm.prototype.f=function(){var a=Cm(this);return this.g?tj(this.J)+a["min-content width"]+uj(this.J):rj(this.J)+a["min-content height"]+sj(this.J)};Bm.prototype.d=function(){return this.g?tj(this.J)+this.J.width+uj(this.J):rj(this.J)+this.J.height+sj(this.J)};function Dm(a){this.g=a}Dm.prototype.b=function(){return this.g.some(function(a){return a.b()})};Dm.prototype.e=function(){var a=this.g.map(function(a){return a.e()});return Math.max.apply(null,a)*a.length};
Dm.prototype.f=function(){var a=this.g.map(function(a){return a.f()});return Math.max.apply(null,a)*a.length};Dm.prototype.d=function(){var a=this.g.map(function(a){return a.d()});return Math.max.apply(null,a)*a.length};function Em(a,b,c,d,e,f){Bm.call(this,a,b,c,d,e);this.j=f}t(Em,Bm);Em.prototype.b=function(){return!1};Em.prototype.e=function(){return this.d()};Em.prototype.f=function(){return this.d()};Em.prototype.d=function(){return this.g?tj(this.J)+this.j+uj(this.J):rj(this.J)+this.j+sj(this.J)};
function Am(a,b,c,d,e,f){var g=a.d.d,h={},k={},l={},n;for(n in b){var p=rm[n];if(p){var r=b[n],q=a.wa[n],y=new Bm(r,q.style,c,g,f);h[p.ba]=r;k[p.ba]=q;l[p.ba]=y}}a=d.start.evaluate(e);d.end.evaluate(e);b=d.W.evaluate(e);var x=Fm(l,b),I=!1,J={};Object.keys(h).forEach(function(a){var b=X(g,k[a].style[c?"max-width":"max-height"],d.W);b&&(b=b.evaluate(e),x[a]>b&&(b=l[a]=new Em(h[a],k[a].style,c,g,f,b),J[a]=b.d(),I=!0))});I&&(x=Fm(l,b),I=!1,["start","center","end"].forEach(function(a){x[a]=J[a]||x[a]}));
var C={};Object.keys(h).forEach(function(a){var b=X(g,k[a].style[c?"min-width":"min-height"],d.W);b&&(b=b.evaluate(e),x[a]<b&&(b=l[a]=new Em(h[a],k[a].style,c,g,f,b),C[a]=b.d(),I=!0))});I&&(x=Fm(l,b),["start","center","end"].forEach(function(a){x[a]=C[a]||x[a]}));var N=a+b,lh=a+(a+b);["start","center","end"].forEach(function(a){var b=x[a];if(b){var d=h[a],e=0;switch(a){case "start":e=c?d.left:d.top;break;case "center":e=(lh-b)/2;break;case "end":e=N-b}c?xj(d,e,b-tj(d)-uj(d)):wj(d,e,b-rj(d)-sj(d))}})}
function Fm(a,b){var c=a.start,d=a.center,e=a.end,f={};if(d){var g=[c,e].filter(function(a){return a}),g=Gm(d,g.length?new Dm(g):null,b);g.Ha&&(f.center=g.Ha);d=g.Ha||d.d();d=(b-d)/2;c&&c.b()&&(f.start=d);e&&e.b()&&(f.end=d)}else c=Gm(c,e,b),c.Ha&&(f.start=c.Ha),c.Hb&&(f.end=c.Hb);return f}
function Gm(a,b,c){var d={Ha:null,Hb:null};if(a&&b)if(a.b()&&b.b()){var e=a.e(),f=b.e();0<e&&0<f?(f=e+f,f<c?d.Ha=c*e/f:(a=a.f(),b=b.f(),b=a+b,b<c?d.Ha=a+(c-b)*(e-a)/(f-b):0<b&&(d.Ha=c*a/b)),0<d.Ha&&(d.Hb=c-d.Ha)):0<e?d.Ha=c:0<f&&(d.Hb=c)}else a.b()?d.Ha=Math.max(c-b.d(),0):b.b()&&(d.Hb=Math.max(c-a.d(),0));else a?a.b()&&(d.Ha=c):b&&b.b()&&(d.Hb=c);return d}function ym(a,b){jl.call(this,a,b);this.marginLeft=this.marginBottom=this.marginRight=this.marginTop=this.hb=this.ib=null}t(ym,jl);
ym.prototype.h=function(a,b){var c=this.C,d;for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(d.match(/^column.*$/)||d.match(/^background-/))&&(c[d]=b[d]);jl.prototype.h.call(this,a,b);d=this.e;c={ib:this.ib,hb:this.hb,marginTop:this.marginTop,marginRight:this.marginRight,marginBottom:this.marginBottom,marginLeft:this.marginLeft};d.j=c;d=d.style;d.width=new L(c.ib);d.height=new L(c.hb);d["padding-left"]=new L(c.marginLeft);d["padding-right"]=new L(c.marginRight);d["padding-top"]=new L(c.marginTop);
d["padding-bottom"]=new L(c.marginBottom)};ym.prototype.xc=function(){var a=Hm(this,{start:"left",end:"right",W:"width"});this.ib=a.fd;this.marginLeft=a.pd;this.marginRight=a.od};ym.prototype.yc=function(){var a=Hm(this,{start:"top",end:"bottom",W:"height"});this.hb=a.fd;this.marginTop=a.pd;this.marginBottom=a.od};
function Hm(a,b){var c=a.style,d=a.d.d,e=b.start,f=b.end,g=b.W,h=a.d.w[g].ca(d,null),k=X(d,c[g],h),l=X(d,c["margin-"+e],h),n=X(d,c["margin-"+f],h),p=kl(d,c["padding-"+e],h),r=kl(d,c["padding-"+f],h),q=ml(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),y=ml(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),x=F(d,h,E(d,E(d,q,p),E(d,y,r)));k?(x=F(d,x,k),l||n?l?n=F(d,x,l):l=F(d,x,n):n=l=Oc(d,x,new Yb(d,.5))):(l||(l=d.b),n||(n=d.b),k=F(d,x,E(d,l,n)));c[e]=new L(l);c[f]=new L(n);c["margin-"+e]=
Qd;c["margin-"+f]=Qd;c["padding-"+e]=new L(p);c["padding-"+f]=new L(r);c["border-"+e+"-width"]=new L(q);c["border-"+f+"-width"]=new L(y);c[g]=new L(k);c["max-"+g]=new L(k);return{fd:F(d,h,E(d,l,n)),pd:l,od:n}}function zm(a,b){jl.call(this,a,b);var c=b.l;this.j=rm[c];a.wa[c]=this;this.ya=!0}t(zm,jl);m=zm.prototype;
m.Tb=function(a,b,c){var d=b.d;u(d,"display","flex");var e=vl(this,a,"vertical-align"),f=null;e===H("middle")?f="center":e===H("top")?f="flex-start":e===H("bottom")&&(f="flex-end");f&&(u(d,"flex-flow",this.b?"row":"column"),u(d,"justify-content",f));jl.prototype.Tb.call(this,a,b,c)};
m.ba=function(a,b){var c=this.style,d=this.d.d,e=a.start,f=a.end,g="left"===e,h=g?b.ib:b.hb,k=X(d,c[a.W],h),g=g?b.marginLeft:b.marginTop;if("start"===this.j.ba)c[e]=new L(g);else if(k){var l=kl(d,c["margin-"+e],h),n=kl(d,c["margin-"+f],h),p=kl(d,c["padding-"+e],h),r=kl(d,c["padding-"+f],h),q=ml(d,c["border-"+e+"-width"],c["border-"+e+"-style"],h),f=ml(d,c["border-"+f+"-width"],c["border-"+f+"-style"],h),k=E(d,k,E(d,E(d,p,r),E(d,E(d,q,f),E(d,l,n))));switch(this.j.ba){case "center":c[e]=new L(E(d,g,
Pc(d,F(d,h,k),new Yb(d,2))));break;case "end":c[e]=new L(F(d,E(d,g,h),k))}}};
function Im(a,b,c){function d(a){if(x)return x;x={W:y?y.evaluate(a):null,za:k?k.evaluate(a):null,Aa:l?l.evaluate(a):null};var b=h.evaluate(a),c=0;[r,n,p,q].forEach(function(b){b&&(c+=b.evaluate(a))});(null===x.za||null===x.Aa)&&c+x.W+x.za+x.Aa>b&&(null===x.za&&(x.za=0),null===x.Aa&&(x.Id=0));null!==x.W&&null!==x.za&&null!==x.Aa&&(x.Aa=null);null===x.W&&null!==x.za&&null!==x.Aa?x.W=b-c-x.za-x.Aa:null!==x.W&&null===x.za&&null!==x.Aa?x.za=b-c-x.W-x.Aa:null!==x.W&&null!==x.za&&null===x.Aa?x.Aa=b-c-x.W-
x.za:null===x.W?(x.za=x.Aa=0,x.W=b-c):x.za=x.Aa=(b-c-x.W)/2;return x}var e=a.style;a=a.d.d;var f=b.zc,g=b.Dc;b=b.W;var h=c["margin"+g.charAt(0).toUpperCase()+g.substring(1)],k=ll(a,e["margin-"+f],h),l=ll(a,e["margin-"+g],h),n=kl(a,e["padding-"+f],h),p=kl(a,e["padding-"+g],h),r=ml(a,e["border-"+f+"-width"],e["border-"+f+"-style"],h),q=ml(a,e["border-"+g+"-width"],e["border-"+g+"-style"],h),y=X(a,e[b],h),x=null;e[b]=new L(new $b(a,function(){var a=d(this).W;return null===a?0:a},b));e["margin-"+f]=new L(new $b(a,
function(){var a=d(this).za;return null===a?0:a},"margin-"+f));e["margin-"+g]=new L(new $b(a,function(){var a=d(this).Aa;return null===a?0:a},"margin-"+g));"left"===f?e.left=new L(E(a,c.marginLeft,c.ib)):"top"===f&&(e.top=new L(E(a,c.marginTop,c.hb)))}m.xc=function(){var a=this.e.j;this.j.ma?Im(this,{zc:"right",Dc:"left",W:"width"},a):this.j.na?Im(this,{zc:"left",Dc:"right",W:"width"},a):this.ba({start:"left",end:"right",W:"width"},a)};
m.yc=function(){var a=this.e.j;this.j.oa?Im(this,{zc:"bottom",Dc:"top",W:"height"},a):this.j.la?Im(this,{zc:"top",Dc:"bottom",W:"height"},a):this.ba({start:"top",end:"bottom",W:"height"},a)};m.Qb=function(a,b,c,d,e,f){jl.prototype.Qb.call(this,a,b,c,d,e,f);a=c.k;c=this.d.l;d=this.j;d.ma||d.na?d.oa||d.la||(d.ma?a.left[c]=b:d.na&&(a.right[c]=b)):d.oa?a.top[c]=b:d.la&&(a.bottom[c]=b)};
function Jm(a,b,c,d,e){this.b=a;this.h=b;this.f=c;this.d=d;this.e=e;this.g={};a=this.h;b=new Hc(a,"page-number");b=new zc(a,new Fc(a,b,new Yb(a,2)),a.b);c=new pc(a,b);a.values["recto-page"]=c;a.values["verso-page"]=b;"ltr"===mm(this.e)?(a.values["left-page"]=b,b=new pc(a,b),a.values["right-page"]=b):(c=new pc(a,b),a.values["left-page"]=c,a.values["right-page"]=b)}function Km(a){var b={};Xh(a.b,[],"",b);a.b.pop();return b}
function Lm(a,b){var c=[],d;for(d in b)if(Object.prototype.hasOwnProperty.call(b,d)){var e=b[d],f;f=e instanceof V?e.value+"":Lm(a,e);c.push(d+f+(e.Ba||""))}return c.sort().join("^")}function Mm(a){this.b=null;this.f=a}t(Mm,W);Mm.prototype.apply=function(a){a.I===this.f&&this.b.apply(a)};Mm.prototype.d=function(){return 3};Mm.prototype.e=function(a){this.b&&hh(a.xb,this.f,this.b);return!0};function Nm(a){this.b=null;this.f=a}t(Nm,W);
Nm.prototype.apply=function(a){1===(new Hc(this.f,"page-number")).evaluate(a.d)&&this.b.apply(a)};Nm.prototype.d=function(){return 2};function Om(a){this.b=null;this.f=a}t(Om,W);Om.prototype.apply=function(a){(new Hc(this.f,"left-page")).evaluate(a.d)&&this.b.apply(a)};Om.prototype.d=function(){return 1};function Pm(a){this.b=null;this.f=a}t(Pm,W);Pm.prototype.apply=function(a){(new Hc(this.f,"right-page")).evaluate(a.d)&&this.b.apply(a)};Pm.prototype.d=function(){return 1};
function Qm(a){this.b=null;this.f=a}t(Qm,W);Qm.prototype.apply=function(a){(new Hc(this.f,"recto-page")).evaluate(a.d)&&this.b.apply(a)};Qm.prototype.d=function(){return 1};function Rm(a){this.b=null;this.f=a}t(Rm,W);Rm.prototype.apply=function(a){(new Hc(this.f,"verso-page")).evaluate(a.d)&&this.b.apply(a)};Rm.prototype.d=function(){return 1};function Sm(a,b){fh.call(this,a,b,null,null)}t(Sm,fh);
Sm.prototype.apply=function(a){var b=a.d,c=a.w,d=this.style,e=this.b;$g(b,c,d,e,null,null);if(d=d._marginBoxes){var c=Yg(c,"_marginBoxes"),f;for(f in d)if(d.hasOwnProperty(f)){var g=c[f];g||(g={},c[f]=g);$g(b,g,d[f],e,null,null);g.content&&(g.content=g.content.qc(new Gh(a,null)))}}};function Tm(a,b,c,d){ei.call(this,a,b,null,c,null,d,!1);this.f=""}t(Tm,ei);m=Tm.prototype;m.mb=function(){this.f+="@page ";this.Za()};m.Sa=function(a,b){this.f+=b;b&&(this.b.push(new Mm(b)),this.d+=65536)};
m.yb=function(a,b){b&&kf(this,"E_INVALID_PAGE_SELECTOR :"+a+"("+b.join("")+")");this.f+=":"+a;switch(a.toLowerCase()){case "first":this.b.push(new Nm(this.e));this.d+=256;break;case "left":this.b.push(new Om(this.e));this.d+=1;break;case "right":this.b.push(new Pm(this.e));this.d+=1;break;case "recto":this.b.push(new Qm(this.e));this.d+=1;break;case "verso":this.b.push(new Rm(this.e));this.d+=1;break;default:kf(this,"E_INVALID_PAGE_SELECTOR :"+a)}};m.ha=function(){this.f+="{";ei.prototype.ha.call(this)};
m.Oa=function(){this.f+="}";document.getElementById("vivliostyle-page-rules").textContent+=this.f;ei.prototype.Oa.call(this)};m.Ea=function(a,b,c){"size"===a&&(this.f+="size: "+b.toString()+(c?"!important":"")+";");ei.prototype.Ea.call(this,a,b,c)};m.jd=function(a){hh(this.h.xb,"*",a)};m.nd=function(a){return new Sm(this.k,a)};m.Jc=function(a){var b=Yg(this.k,"_marginBoxes"),c=b[a];c||(c={},b[a]=c);ff(this.Y,new Um(this.e,this.Y,this.u,c))};
function Um(a,b,c,d){gf.call(this,a,b,!1);this.d=c;this.b=d}t(Um,hf);Um.prototype.Ea=function(a,b,c){Gg(this.d,a,b,c,this)};Um.prototype.wb=function(a,b){jf(this,"E_INVALID_PROPERTY_VALUE "+a+": "+b.toString())};Um.prototype.dc=function(a,b){jf(this,"E_INVALID_PROPERTY "+a+": "+b.toString())};Um.prototype.Xa=function(a,b,c){Xg(this.b,a,new V(b,c?cf(this):df(this)))};function Vm(a){this.d=a;this.b={};this.b.page=[0]}
...
function Wm(a,b,c){var d,e=b["counter-reset"];e&&(e=e.evaluate(c))&&(d=Qf(e,!0));if(d)for(var f in d){var e=a,g=f,h=d[f];e.b[g]?e.b[g].push(h):e.b[g]=[h]}var k;(b=b["counter-increment"])&&(c=b.evaluate(c))&&(k=Qf(c,!1));k?"page"in k||(k.page=1):k={page:1};for(var l in k)a.b[l]||(c=a,b=l,c.b[b]?c.b[b].push(0):c.b[b]=[0]),c=a.b[l],c[c.length-1]+=k[l]};function Xm(a,b,c,d,e,f,g,h,k){this.h=a;this.g=b;this.b=c;this.d=d;this.w=e;this.f=f;this.l=a.G;this.u=g;this.e=h;this.k=k;this.j=a.f;bc(this.b,function(a){return(a=this.b.b[a])?0<a.b.length&&a.b[0].b.b<=this.g:!1});ac(this.b,new $b(this.b,function(){return this.b.d},"page-number"))}
...
function Zm(a,b,c,d,e,f,g,h){dc.call(this,0,d.width,d.height,d.fontSize);this.style=a;this.X=b;this.lang=b.lang||c;this.viewport=d;this.e={body:!0};this.f=e;this.b=this.C=this.d=this.h=null;this.g=0;this.ya=f;this.T=new ti(this.style.l);this.Z={};this.I=null;this.w=new Vm(a.b);this.G={};this.ea=null;this.ta=g;this.wa=h;for(var k in a.e)(b=a.e[k]["flow-consume"])&&(b.evaluate(this,"flow-consume")==id?this.e[k]=!0:delete this.e[k])}t(Zm,dc);
function $m(a){var b=M("StyleInstance.init");a.d=new Hj(a.X,a.style.d,a.style.g,a,a.e,a.style.j,a.w);var c=a.d;c.k=a;for(var d=0;d<c.C.length;d++)Pj(c.k,c.C[d]);a.C={};c=a.C[a.X.url]=a.d;for(d=0;!c.j&&(d+=5E3,Qj(c,d,0)!=Number.POSITIVE_INFINITY););c=c.u;a.ea=mm(c);a.h=new Kl(a.style.w);d=new Uh(a.style.d,a,a.w);a.h.h(d,c);Jl(a.h,a);a.I=new Jm(d,a.style.b,a.h,a,c);c=[];for(d=0;d<a.style.f.length;d++){var e=a.style.f[d++];if(!e.F||e.F.evaluate(a)){var f=e.lb,g=a,e={},h=void 0;for(h in f)e[h]=f[h].evaluate(g,
h);f=e;g=void 0;for(g in oi)f[g]||(f[g]=oi[g]);e=new ri(e);c.push(e)}}d=a.ya;a=a.T;e=[];for(f=0;f<c.length;f++)g=c[f],g.src&&g.b?e.push(xi(d,g,a)):v("E_FONT_FACE_INVALID");Uf(e).ka(b);return P(b)}function Pj(a,b){var c=a.b;if(c){var d=c.b[b.f];d||(d=new oj,c.b[b.f]=d);d.b.push(new nj(new mj({ja:[{va:b.g,Fa:0,da:null,pa:null,ia:null}],aa:0,H:!1}),b))}}
function an(a,b){if(!b)return 0;var c=Number.POSITIVE_INFINITY,d;for(d in a.e){var e=b.b[d];if((!e||0==e.b.length)&&a.b){var f=a.d;f.l=d;for(e=0;null!=f.l&&(e+=5E3,Qj(f,e,0)!=Number.POSITIVE_INFINITY););e=a.b.b[d];b!=a.b&&e&&(e=e.clone(),b.b[d]=e)}if(e){for(var f=a,g=Number.POSITIVE_INFINITY,h=0;h<e.b.length;h++){for(var k=e.b[h].d.La,l=k.ja[0].va,n=k.aa,p=k.H,r=0;l.ownerDocument!=f.X.b;)r++,l=k.ja[r].va,p=!1,n=0;k=Ci(f.X,l,n,p);k<g&&(g=k)}f=g;f<c&&(c=f)}}return c}
function bn(a,b){var c=an(a,a.b);if(c==Number.POSITIVE_INFINITY)return null;for(var d=a.h.children,e,f=0;f<d.length;f++)if(e=d[f],"vivliostyle-page-rule-master"!==e.d.Wa){var g=1,h=vl(e,a,"utilization");h&&h.Vc()&&(g=h.B);h=fc(a,"em");a.g=Qj(a.d,c,Math.ceil(g*a.k()*a.j()/(h*h)));var g=a,h=g.b.d,k=void 0;for(k in g.b.b)for(var l=g.b.b[k],n=l.b.length-1;0<=n;n--){var p=l.b[n];0>p.b.e&&p.b.b<g.g&&(p.b.e=h)}ec(a,a.style.b);g=vl(e,a,"enabled");if(!g||g===Ld){d=a;v("Location - page "+d.b.d);v("  currnt: "+
c);v("  lookup: "+d.g);c=void 0;for(c in d.b.b)for(f=d.b.b[c],g=0;g<f.b.length;g++)v("  Chunk "+c+": "+f.b[g].b.b);c=a.I;f=b;g=e.d;if(0===Object.keys(f).length)g.d.e=g;else{e=g;d=Lm(c,f);e=e.g+"^"+d;d=c.g[e];if(!d){if("background-host"===g.Wa)d=c,f=(new tm(d.h,d.f.d,f)).f(d.f),f.h(d.b,d.e),Jl(f,d.d),d=f;else{d=c;h=f;f=g.clone({Wa:"vivliostyle-page-rule-master"});if(g=h.size)h=pm(h),g=g.Ba,f.b.width=Ug(d.d,f.b.width,new V(h.width,g)),f.b.height=Ug(d.d,f.b.height,new V(h.height,g));f=f.f(d.f);f.h(d.b,
d.e);Jl(f,d.d);d=f}c.g[e]=d}e=d.d;e.d.e=e;e=d}return e}}throw Error("No enabled page masters");}
function cn(a,b,c){var d=a.b.b[c];if(!d)return O(!0);a.e[c]&&0<b.A.length&&(b.dd=!1);yk(b);var e=M("layoutColumn"),f=[];Qe(function(c){for(;0<d.b.length;){var e=0,k=d.b[e];if(k.b.b>a.g)break;for(var l=1;l<d.b.length;l++){var n=d.b[l];if(n.b.b>a.g)break;cj(n.b,k.b)&&(k=n,e=l)}var p=k.b,r=!0;Dk(b,k.d).then(function(a){k.b.Dd&&(null==a||p.d)&&f.push(k);p.d?(d.b.splice(e,1),R(c)):a?(k.d=a,R(c)):(d.b.splice(e,1),r?r=!1:Se(c))});if(r){r=!1;return}}R(c)}).then(function(){0<f.length&&(d.b=f.concat(d.b));
Q(e,!0)});return P(e)}
function dn(a,b,c,d,e,f,g){var h=vl(c,a,"enabled");if(h&&h!==Ld)return O(!0);var k=M("layoutContainer"),l=vl(c,a,"wrap-flow")===jd,n=c.b?c.g&&c.G:c.f&&c.I,h=vl(c,a,"flow-from"),p=a.viewport.b.createElement("div"),r=vl(c,a,"position");u(p,"position",r?r.name:"absolute");d.insertBefore(p,d.firstChild);var q=new qj(p);q.b=c.b;c.Tb(a,q,b);q.C=e;q.G=f;e+=q.left+q.marginLeft+q.Z;f+=q.top+q.marginTop+q.ea;if(h&&h.kd())if(a.G[h.toString()])c.Qb(a,q,b,null,1,a.f),h=O(!0);else{var y=M("layoutContainer.inner"),x=
h.toString(),I=Y(c,a,"column-count"),J=Y(c,a,"column-gap"),C=1<I?Y(c,a,"column-width"):q.width,h=ul(c,a),N=0,r=vl(c,a,"shape-inside"),lh=Of(r,0,0,q.width,q.height,a),Va=new Xl(x,a,a.viewport,a.d,h,a.X,a.T,a.style.u,a,b,a.ta,a.wa),mh=0,Z=null;Qe(function(b){for(;mh<I;){var c=mh++;if(1<I){var d=a.viewport.b.createElement("div");u(d,"position","absolute");p.appendChild(d);Z=new ak(d,Va,a.f);Z.b=q.b;Z.tb=q.tb;Z.Lb=q.Lb;q.b?(u(d,"margin-left",q.h+"px"),u(d,"margin-right",q.I+"px"),c=c*(C+J)+q.j,xj(Z,0,
q.width),wj(Z,c,C)):(u(d,"margin-top",q.j+"px"),u(d,"margin-bottom",q.w+"px"),c=c*(C+J)+q.h,wj(Z,0,q.height),xj(Z,c,C));Z.C=e+q.h;Z.G=f+q.j}else Z=new ak(p,Va,a.f),vj(Z,q),q=Z;Z.A=n?[]:g;Z.Jb=lh;if(0<=Z.width){var h=M("inner");cn(a,Z,x).then(function(){Z.T&&"column"!=Z.T&&(mh=I,"region"!=Z.T&&(a.G[x]=!0));Q(h,!0)});c=P(h)}else c=O(!0);if(c.sa()){c.then(function(){N=Math.max(N,Z.e);Se(b)});return}N=Math.max(N,Z.e)}R(b)}).then(function(){q.e=N;c.Qb(a,q,b,Z,I,a.f);Q(y,!0)});h=P(y)}else h=vl(c,a,"content"),
r=!1,h&&zj(h)?(h.L(new yj(p,a)),Il(c,a,q)):c.ya&&(d.removeChild(p),r=!0),r||c.Qb(a,q,b,null,1,a.f),h=O(!0);h.then(function(){if(!c.f||0<Math.floor(q.e)){if(!l){var h=q.C+q.left,n=q.G+q.top,r=tj(q)+q.width+uj(q),x=rj(q)+q.height+sj(q),y=vl(c,a,"shape-outside"),h=Of(y,h,n,r,x,a);Ra(a.viewport.root)&&g.push(ae(h,0,-1.25*fc(a,"em")));g.push(h)}}else if(0==c.children.length){d.removeChild(p);Q(k,!0);return}var C=c.children.length-1;Pe(function(){for(;0<=C;){var d=c.children[C--],d=dn(a,b,d,p,e,f,g);if(d.sa())return d}return O(!1)}).then(function(){Q(k,
!0)})});return P(k)}
function en(a,b,c){a.G={};c?(a.b=c.clone(),Kj(a.d,c.e)):(a.b=new pj,Kj(a.d,-1));a.lang&&b.J.setAttribute("lang",a.lang);c=a.b;c.d++;ec(a,a.style.b);var d=Km(a.I);fn(a,d);var e=bn(a,d);if(!e)return O(null);e.d.b.width.value===Nd&&Yi(b);e.d.b.height.value===Pd&&Zi(b);Wm(a.w,d,a);var f=M("layoutNextPage");dn(a,b,e,b.J,0,0,[]).then(function(){e.Z(a,b,a.f);var d=new Hc(e.d.d,"left-page");b.e=d.evaluate(a)?"left":"right";var d=a.b.d,h;for(h in a.b.b)for(var k=a.b.b[h],l=k.b.length-1;0<=l;l--){var n=k.b[l];
0<=n.b.e&&n.b.e+n.b.j-1<=d&&k.b.splice(l,1)}a.b=null;c.e=a.d.b;h=a.style.h.C[a.X.url];k=b.f;for(d=0;d<k.length;d++)l=k[d],u(l.target,l.name,l.value.toString());for(d=0;d<h.length;d++)if(k=h[d],n=b.g[k.Ab],l=b.g[k.Ad],n&&l&&(n=Wi(n,k.action)))for(var p=0;p<l.length;p++)l[p].addEventListener(k.event,n,!1);var r;a:{for(r in a.e)if((h=c.b[r])&&0<h.b.length){r=!1;break a}r=!0}r&&(c=null);Q(f,c)});return P(f)}
function fn(a,b){var c=pm(b),d=c.width;d===Nd?a.u=null:a.u=d.B*fc(a,d.b);c=c.height;c===Pd?a.l=null:a.l=c.B*fc(a,c.b)}function gn(a,b,c,d){ei.call(this,a.g,a,b,c,d,a.f,!c);this.f=a;this.A=!1}t(gn,ei);m=gn.prototype;m.$b=function(){};m.Zb=function(a,b,c){a=new el(this.f.j,a,b,c,this.f.u,this.F,df(this.Y));ff(this.f,new Pl(a.d,this.f,a,this.u))};m.fb=function(a){a=a.e;null!=this.F&&(a=Nc(this.e,this.F,a));ff(this.f,new gn(this.f,a,this,this.C))};m.Wb=function(){ff(this.f,new hi(this.e,this.Y))};
...
m.mb=function(){var a=new Tm(this.f.j,this.f,this,this.u);ff(this.f,a);a.mb()};m.ha=function(){ei.prototype.ha.call(this);if(this.A){this.A=!1;var a="R"+this.f.C++,b=H(a),c;this.F?c=new Tg(b,0,this.F):c=new V(b,0);Zg(this.k,"region-id").push(c);this.Oa();a=new gn(this.f,this.F,this,a);ff(this.f,a);a.ha()}};
function hn(a){var b=a.getAttribute("content");if(!b)return"";a={};for(var c;null!=(c=b.match(/^,?\s*([-A-Za-z_.][-A-Za-z_0-9.]*)\s*=\s*([-+A-Za-z_0-9.]*)\s*/));)b=b.substr(c[0].length),a[c[1]]=c[2];b=a.width-0;a=a.height-0;return b&&a?"@-epubx-viewport{width:"+b+"px;height:"+a+"px;}":""}function jn(a){ef.call(this);this.f=a;this.g=new Xb(null);this.j=new Xb(this.g);this.u=new bl(this.g);this.A=new gn(this,null,null,null);this.C=0;this.k=[];this.l={};this.h={};this.w=[];this.b=this.A}t(jn,ef);
jn.prototype.M=function(a){v("CSS parser: "+a)};function kn(a,b){return ln(b,a)}function mn(a){We.call(this,kn,!1);this.G=a;this.A={};this.h={};this.b={};this.C={};this.f=null;this.j=[]}t(mn,We);function nn(a){var b=ea("user-agent.xml",da),c=M("OPSDocStore.init");Xe(Hg).then(function(d){a.f=d;Xe(ki).then(function(){a.load(b).then(function(){Q(c,!0)})})});return P(c)}function on(a,b){a.j.push({url:b.url,text:b.text,Pa:"User",ra:null,media:null})}
function ln(a,b){var c=M("OPSDocStore.load"),d=b.url;Hi(b,a).then(function(b){for(var f=[],g=b.b.getElementsByTagNameNS("http://www.idpf.org/2007/ops","trigger"),h=0;h<g.length;h++){var k=g[h],l=k.getAttributeNS("http://www.w3.org/2001/xml-events","observer"),n=k.getAttributeNS("http://www.w3.org/2001/xml-events","event"),p=k.getAttribute("action"),k=k.getAttribute("ref");l&&n&&p&&k&&f.push({Ad:l,event:n,action:p,Ab:k})}a.C[d]=f;var r=[],f=ea("user-agent-page.css",da);r.push({url:f,text:null,Pa:"UA",
...
l&&"viewport"==g.getAttribute("name")&&r.push({url:d,text:hn(g),Pa:"Author",F:null,media:null});else"http://www.gribuser.ru/xml/fictionbook/2.0"==h?"stylesheet"==l&&"text/css"==g.getAttribute("type")&&r.push({url:d,text:g.textContent,Pa:"Author",ra:null,media:null}):"http://example.com/sse"==h&&"property"===l&&(h=g.getElementsByTagName("name")[0])&&"stylesheet"===h.textContent&&(g=g.getElementsByTagName("value")[0])&&(g=ea(g.textContent,d),r.push({url:g,text:null,ra:null,media:null,Pa:"Author"}));
for(var q="",h=0;h<r.length;h++)q+=r[h].url,q+="^",r[h].text&&(q+=r[h].text),q+="^";var y=a.A[q];y?(a.b[d]=y,Q(c,b)):(f=a.h[q],f||(f=new Ze(function(){var b=M("fetchStylesheet"),c=0,d=new jn(a.f);Pe(function(){if(c<r.length){var a=r[c++];d.nb(a.Pa);var b;if(a.text){b=a.url;var e=a.ra,a=new Mb(a.text);b=Ff(a,d,b,e)}else b=Gf(a.url,d,a.ra);return b}return O(!1)}).then(function(){y=new Xm(a,d.g,d.j,d.A.h,d.u,d.k,d.l,d.h,d.w);a.A[q]=y;delete a.h[q];Q(b,y)});return P(b)},"FetchStylesheet "+d),a.h[q]=f,
f.start()),Xe(f).then(function(f){a.b[d]=f;Q(c,b)}))});return P(c)};function pn(a,b,c,d,e,f,g,h){this.d=a;this.url=b;this.lang=c;this.e=d;this.g=e;this.U=Pb(f);this.h=g;this.f=h;this.Qa=this.b=null}function qn(a,b,c){if(0!=c--)for(b=b.firstChild;b;b=b.nextSibling)if(1==b.nodeType){var d=b;"auto"!=za(d,"height")&&(u(d,"height","auto"),qn(a,d,c));"absolute"==za(d,"position")&&(u(d,"position","relative"),qn(a,d,c))}}
function rn(a){var b=a.target,c="\u25b8"==b.textContent;b.textContent=c?"\u25be":"\u25b8";for(b=b.parentNode.firstChild;b;)if(1!=b.nodeType)b=b.nextSibling;else{var d=b;"toc-container"==d.getAttribute("data-adapt-class")?b=d.firstChild:("toc-node"==d.getAttribute("data-adapt-class")&&(d.style.height=c?"auto":"0px"),b=b.nextSibling)}a.stopPropagation()}
pn.prototype.Ac=function(a){var b=this.h.Ac(a);return function(a,d,e){var f=e.behavior;if(!f||"toc-node"!=f.toString()&&"toc-container"!=f.toString())return b(a,d,e);a=d.getAttribute("data-adapt-class");"toc-node"==a&&(e=d.firstChild,"\u25b8"!=e.textContent&&(e.textContent="\u25b8",u(e,"cursor","pointer"),e.addEventListener("click",rn,!1)));var g=d.ownerDocument.createElement("div");g.setAttribute("data-adapt-process-children","true");"toc-node"==f.toString()?(e=d.ownerDocument.createElement("div"),
...
pn.prototype.Vb=function(a,b,c,d,e){if(this.b)return O(this.b);var f=this,g=M("showTOC"),h=new Xi(a);this.b=h;this.d.load(this.url).then(function(d){var l=f.d.b[d.url],n=Ym(l,c,1E5,e);b=new km(b.d,n.fontSize,b.root,n.width,n.height);var p=new Zm(l,d,f.lang,b,f.e,f.g,f.Ac(d),f.f);f.Qa=p;p.U=f.U;$m(p).then(function(){en(p,h,null).then(function(){qn(f,a,2);Q(g,h)})})});return P(g)};
pn.prototype.Rb=function(){if(this.b){var a=this.b;this.Qa=this.b=null;u(a.J,"visibility","none");var b=a.J.parentNode;b&&b.removeChild(a.J)}};pn.prototype.Xc=function(){return!!this.b};function sn(){mn.call(this,tn(this));this.d=new We(Hi,!1);this.u=new We($e,!1);this.w={};this.Z={};this.k={};this.l={}}t(sn,mn);function tn(a){return function(b){return a.k[b]}}
function un(a,b,c){var d=M("loadEPUBDoc");c&&a.u.Pb(b+"?r=list");a.d.Pb(b+"META-INF/encryption.xml");a.d.load(b+"META-INF/container.xml").then(function(e){e=Si(zi(zi(zi(new Ai([e.b]),"container"),"rootfiles"),"rootfile"),"full-path");for(var f=0;f<e.length;f++){var g=e[f];if(g){vn(a,b,g,c).ka(d);return}}Q(d,null)});return P(d)}
function vn(a,b,c,d){var e=b+c,f=a.w[e];if(f)return O(f);var g=M("loadOPF");a.d.load(e).then(function(c){a.d.load(b+"META-INF/encryption.xml").then(function(k){(d?a.u.load(b+"?r=list"):O(null)).then(function(d){f=new wn(a,b);xn(f,c,k,d,b+"?r=manifest").then(function(){a.w[e]=f;a.Z[b]=f;Q(g,f)})})})});return P(g)}sn.prototype.load=function(a){a=ca(a);var b=this.l[a];return b?b.sa()?b:O(b.Nb()):sn.Ed.load.call(this,a)};
function yn(){this.id=null;this.src="";this.g=this.d=null;this.D=-1;this.h=0;this.j=null;this.b=this.e=0;this.f=La}function zn(a){return a.id}function An(a){var b=re(a);return function(a){var d=M("deobfuscator"),e,f;a.slice?(e=a.slice(0,1040),f=a.slice(1040,a.size)):(e=a.webkitSlice(0,1040),f=a.webkitSlice(1040,a.size-1040));Ve(e).then(function(a){a=new DataView(a);for(var c=0;c<a.byteLength;c++){var e=a.getUint8(c),e=e^b[c%20];a.setUint8(c,e)}Q(d,Ue([a,f]))});return P(d)}}
var Bn={dcterms:"http://purl.org/dc/terms/",marc:"http://id.loc.gov/vocabulary/",media:"http://www.idpf.org/epub/vocab/overlays/#",onix:"http://www.editeur.org/ONIX/book/codelists/current.html#",xsd:"http://www.w3.org/2001/XMLSchema#"},Cn=Bn.dcterms+"language",Dn=Bn.dcterms+"title";
function En(a,b){var c={};return function(d,e){var f,g,h=d.r||c,k=e.r||c;if(a==Dn&&(f="main"==h["http://idpf.org/epub/vocab/package/#title-type"],g="main"==k["http://idpf.org/epub/vocab/package/#title-type"],f!=g))return f?-1:1;f=parseInt(h["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(f)&&(f=Number.MAX_VALUE);g=parseInt(k["http://idpf.org/epub/vocab/package/#display-seq"],10);isNaN(g)&&(g=Number.MAX_VALUE);return f!=g?f-g:a!=Cn&&b&&(f=(h[Cn]||h["http://idpf.org/epub/vocab/package/#alternate-script"])==
b,g=(k[Cn]||k["http://idpf.org/epub/vocab/package/#alternate-script"])==b,f!=g)?f?-1:1:d.o-e.o}}
function Fn(a,b){function c(a){for(var b in a){var d=a[b];d.sort(En(b,l));for(var e=0;e<d.length;e++){var f=d[e].r;f&&c(f)}}}function d(a){return Oa(a,function(a){return Na(a,function(a){var b={v:a.value,o:a.K};a.Jd&&(b.s=a.scheme);if(a.id||a.lang){var c=k[a.id];if(c||a.lang)a.lang&&(a={name:Cn,value:a.lang,lang:null,id:null,Hc:a.id,scheme:null,K:a.K},c?c.push(a):c=[a]),c=Ma(c,function(a){return a.name}),b.r=d(c)}return b})})}function e(a){if(a&&(a=a.match(/^\s*(([^:]*):)?(\S+)\s*$/))){var b=a[1]?
f[a[1]]:"http://idpf.org/epub/vocab/package/#";if(b)return b+a[3]}return null}var f;if(b){f={};for(var g in Bn)f[g]=Bn[g];for(;null!=(g=b.match(/(^\s*[A-Z_a-z\u007F-\uFFFF][-.A-Z_a-z0-9\u007F-\uFFFF]*):\s*(\S+)/));)b=b.substr(g[0].length),f[g[1]]=g[2]}else f=Bn;var h=1;g=Qi(Ri(a),function(a){if("meta"==a.localName){var b=e(a.getAttribute("property"));if(b)return{name:b,value:a.textContent,id:a.getAttribute("id"),K:h++,Hc:a.getAttribute("refines"),lang:null,scheme:e(a.getAttribute("scheme"))}}else if("http://purl.org/dc/elements/1.1/"==
a.namespaceURI)return{name:Bn.dcterms+a.localName,K:h++,lang:a.getAttribute("xml:lang"),value:a.textContent,id:a.getAttribute("id"),Hc:null,scheme:null};return null});var k=Ma(g,function(a){return a.Hc});g=d(Ma(g,function(a){return a.Hc?null:a.name}));var l=null;g[Cn]&&(l=g[Cn][0].v);c(g);return g}function Gn(){var a=window.MathJax;return a?a.Hub:null}var Hn={"appliaction/xhtml+xml":!0,"image/jpeg":!0,"image/png":!0,"image/svg+xml":!0,"image/gif":!0,"audio/mp3":!0};
function wn(a,b){this.e=a;this.g=this.d=this.b=this.h=this.f=null;this.k=b;this.j=null;this.C={};this.lang=null;this.u=0;this.l={};this.G=this.A=this.I=null;this.w={};Gn()&&(Jg["http://www.w3.org/1998/Math/MathML"]=!0)}function In(a,b){return a.k?b.substr(0,a.k.length)==a.k?decodeURI(b.substr(a.k.length)):null:b}
function xn(a,b,c,d,e){a.f=b;var f=zi(new Ai([b.b]),"package"),g=Si(f,"unique-identifier")[0];g&&(g=Gi(b,b.url+"#"+g))&&(a.j=g.textContent.replace(/[ \n\r\t]/g,""));var h={};a.h=Na(Ni(zi(zi(f,"manifest"),"item")),function(c){var d=new yn,e=b.url;d.id=c.getAttribute("id");d.src=ea(c.getAttribute("href"),e);d.d=c.getAttribute("media-type");if(e=c.getAttribute("properties")){for(var e=e.split(/\s+/),f={},g=0;g<e.length;g++)f[e[g]]=!0;d.f=f}(c=c.getAttribute("fallback"))&&!Hn[d.d]&&(h[d.src]=c);!a.A&&
d.f.nav&&(a.A=d);!a.G&&d.f["cover-image"]&&(a.G=d);return d});a.d=Ka(a.h,zn);a.g=Ka(a.h,function(b){return In(a,b.src)});for(var k in h)for(g=k;;){g=a.d[h[g]];if(!g)break;if(Hn[g.d]){a.w[k]=g.src;break}g=g.src}a.b=Na(Ni(zi(zi(f,"spine"),"itemref")),function(b,c){var d=b.getAttribute("idref");if(d=a.d[d])d.g=b,d.D=c;return d});if(k=Si(zi(f,"spine"),"toc")[0])a.I=a.d[k];var g=Si(zi(zi(Mi(zi(zi(new Ai([c.b]),"encryption"),"EncryptedData"),Li()),"CipherData"),"CipherReference"),"URI"),l=Ni(zi(zi(f,"bindings"),
"mediaType"));for(c=0;c<l.length;c++){var n=l[c].getAttribute("handler");(k=l[c].getAttribute("media-type"))&&n&&a.d[n]&&(a.C[k]=a.d[n].src)}a.l=Fn(zi(f,"metadata"),Si(f,"prefix")[0]);a.l[Cn]&&(a.lang=a.l[Cn][0].v);if(!d){if(0<g.length&&a.j)for(d=An(a.j),c=0;c<g.length;c++)a.e.k[a.k+g[c]]=d;return O(!0)}f=new Aa;l={};if(0<g.length&&a.j)for(k="1040:"+se(a.j),c=0;c<g.length;c++)l[g[c]]=k;for(c=0;c<d.length;c++){var p=d[c];if(n=p.n){var r=decodeURI(n),g=a.g[r];k=null;g&&(g.j=0!=p.m,g.h=p.c,g.d&&(k=g.d.replace(/\s+/g,
"")));g=l[r];if(k||g)f.append(n),f.append(" "),f.append(k||"application/octet-stream"),g&&(f.append(" "),f.append(g)),f.append("\n")}}Jn(a);return Te(e,!1,"POST",f.toString(),"text/plain")}function Jn(a){for(var b=0,c=0;c<a.b.length;c++){var d=a.b[c],e=Math.ceil(d.h/1024);d.e=b;d.b=e;b+=e}a.u=b}
function Kn(a,b,c){var d=new yn;d.D=0;d.id="item1";d.src=b;a.d={item1:d};a.g={};a.g[b]=d;a.h=[d];a.b=a.h;c?(a=a.e,d=M("EPUBDocStore.load"),b=ca(b),(a.l[b]=ln(a,{status:200,url:b,responseText:null,responseXML:c,Ub:null})).ka(d),c=P(d)):c=O(null);return c}function Ln(a,b,c){var d=a.b[b],e=M("getCFI");a.e.load(d.src).then(function(a){var b=Ei(a,c),h=null;b&&(a=Ci(a,b,0,!1),h=new bb,fb(h,b,c-a),d.g&&fb(h,d.g,0),h=h.toString());Q(e,h)});return P(e)}
function Mn(a,b){return ye("resolveFragment",function(c){if(b){var d=new bb;cb(d,b);var e;if(a.f){var f=db(d,a.f.b);if(1!=f.va.nodeType||f.H||!f.Ab){Q(c,null);return}var g=f.va,h=g.getAttribute("idref");if("itemref"!=g.localName||!h||!a.d[h]){Q(c,null);return}e=a.d[h];d=f.Ab}else e=a.b[0];a.e.load(e.src).then(function(a){var b=db(d,a.b);a=Ci(a,b.va,b.offset,b.H);Q(c,{D:e.D,ga:a,N:-1})})}else Q(c,null)},function(a){v("Error resolving fragment "+b);Q(a,null)})}
function Nn(a,b){return ye("resolveEPage",function(c){if(0>=b)Q(c,{D:0,ga:0,N:-1});else{var d=Ia(a.b.length,function(c){c=a.b[c];return c.e+c.b>b}),e=a.b[d];a.e.load(e.src).then(function(a){b-=e.e;b>e.b&&(b=e.b);var g=0;0<b&&(a=Di(a),g=Math.round(a*b/e.b),g==a&&g--);Q(c,{D:d,ga:g,N:-1})})}},function(a){v("Error resolving epage: "+b);Q(a,null)})}
function On(a,b){var c=a.b[b.D];if(0>=b.ga)return O(c.e);var d=M("getEPage");a.e.load(c.src).then(function(a){a=Di(a);var f=Math.min(a,b.ga);Q(d,c.e+f*c.b/a)});return P(d)}function Pn(a,b,c,d){this.b=a;this.viewport=b;this.f=c;this.Bb=[];this.ga=this.N=this.D=0;this.U=Pb(d);this.e=new jm(b.d)}function Qn(a){var b=a.Bb[a.D];return b?b.eb[a.N]:null}m=Pn.prototype;m.sc=function(){var a=this.Bb[this.D];return a?a.Qa.ea:null};
function Rn(a){var b=M("renderPage");Sn(a).then(function(c){if(c){var d=-1;if(0>a.N){var d=a.ga,e=Ia(c.Da.length,function(a){return an(c.Qa,c.Da[a])>d});a.N=e==c.Da.length?Number.POSITIVE_INFINITY:e-1}var f=c.eb[a.N];f?(a.ga=f.offset,Q(b,f)):Qe(function(b){if(a.N<c.Da.length)R(b);else if(c.complete)a.N=c.Da.length-1,R(b);else{var e=c.Da[c.Da.length-1],k=Tn(a,c,e);en(c.Qa,k,e).then(function(l){k.J.style.display="none";k.J.style.visibility="visible";k.J.setAttribute("data-vivliostyle-page-side",k.e);
(e=l)?(c.eb[e.d-1]=k,c.Da.push(e),0<=d&&an(c.Qa,e)>d?(f=k,a.N=c.Da.length-2,R(b)):(k.h=0==c.item.D&&0==e.d-1,Se(b))):(c.eb.push(k),f=k,a.N=c.Da.length-1,0>d&&(a.ga=k.offset),c.complete=!0,k.h=0==c.item.D&&0==a.N,k.j=c.item.D==a.b.b.length-1,R(b))})}}).then(function(){if(f)Q(b,f);else{var e=c.Da[a.N];0>d&&(a.ga=an(c.Qa,e));var h=Tn(a,c,e);en(c.Qa,h,e).then(function(d){h.J.style.display="none";h.J.style.visibility="visible";h.J.setAttribute("data-vivliostyle-page-side",h.e);(e=d)?(c.eb[e.d-1]=h,c.Da[a.N+
1]=e):(c.eb.push(h),c.complete=!0,h.j=c.item.D==a.b.b.length-1);h.h=0==c.item.D&&0==a.N;Q(b,h)})}})}else Q(b,null)});return P(b)}m.Ic=function(){var a=this,b=M("renderAllPages"),c=a.D,d=a.N,e=a.b.b.length;a.D=0;Qe(function(b){a.N=Number.POSITIVE_INFINITY;Rn(a).then(function(){++a.D>=e?R(b):Se(b)})}).then(function(){a.D=c;a.N=d;Rn(a).ka(b)});return P(b)};m.vd=function(){this.N=this.D=0;return Rn(this)};m.wd=function(){this.D=this.b.b.length-1;this.N=Number.POSITIVE_INFINITY;return Rn(this)};
m.nextPage=function(){var a=this,b=M("nextPage");Sn(a).then(function(c){if(c){if(c.complete&&a.N==c.Da.length-1){if(a.D>=a.b.b.length-1){Q(b,null);return}a.D++;a.N=0}else a.N++;Rn(a).ka(b)}else Q(b,null)});return P(b)};m.Gc=function(){if(0==this.N){if(0==this.D)return O(null);this.D--;this.N=Number.POSITIVE_INFINITY}else this.N--;return Rn(this)};function Un(a,b){var c="left"===b.e,d="ltr"===a.sc();return!c&&d||c&&!d}
function Vn(a){var b=M("getCurrentSpread"),c=Qn(a);if(!c)return O({left:null,right:null});var d=a.D,e=a.N,f="left"===c.e;(Un(a,c)?a.Gc():a.nextPage()).then(function(g){a.D=d;a.N=e;Rn(a).then(function(){f?Q(b,{left:c,right:g}):Q(b,{left:g,right:c})})});return P(b)}m.zd=function(){var a=Qn(this);if(!a)return O(null);var a=Un(this,a),b=this.nextPage();if(a)return b;var c=this;return b.cc(function(){return c.nextPage()})};
m.Cd=function(){var a=Qn(this);if(!a)return O(null);var a=Un(this,a),b=this.Gc();if(a){var c=this;return b.cc(function(){return c.Gc()})}return b};function Wn(a,b){var c=M("navigateToEPage");Nn(a.b,b).then(function(b){b&&(a.D=b.D,a.N=b.N,a.ga=b.ga);Rn(a).ka(c)});return P(c)}function Xn(a,b){var c=M("navigateToCFI");Mn(a.b,b).then(function(b){b&&(a.D=b.D,a.N=b.N,a.ga=b.ga);Rn(a).ka(c)});return P(c)}
function Yn(a,b){v("Navigate to "+b);var c=In(a.b,ca(b));if(null==c&&(a.b.f&&b.match(/^#epubcfi\(/)&&(c=In(a.b,a.b.f.url)),null==c))return O(null);var d=a.b.g[c];if(!d)return a.b.f&&c==In(a.b,a.b.f.url)&&(c=b.indexOf("#"),0<=c)?Xn(a,b.substr(c+1)):O(null);d.D!=a.D&&(a.D=d.D,a.N=0);var e=M("navigateTo");Sn(a).then(function(c){var d=Gi(c.X,b);d&&(a.ga=Bi(c.X,d),a.N=-1);Rn(a).ka(e)});return P(e)}
function Tn(a,b,c){var d=b.Qa.viewport,e=d.b.createElement("div");d.root.appendChild(e);e.style.position="relative";e.style.visibility="hidden";e.style.left="0px";e.style.top="0px";var f=new Xi(e);f.D=b.item.D;f.position=c;f.offset=an(b.Qa,c);d!==a.viewport&&(a=Sb(a.viewport.width,a.viewport.height,d.width,d.height),a=Hf(null,new Mb(a)),f.f.push(new Ui(e,"transform",a)));return f}
function Zn(a,b){var c=Gn();if(c){var d=b.ownerDocument,e=d.createElement("span");b.appendChild(e);d=d.importNode(a,!0);e.appendChild(d);d=c.queue;d.Push(["Typeset",c,e]);var c=M("navigateToEPage"),f=Je(c);d.Push(function(){f.Ra(e)});return P(c)}return O(null)}
m.Ac=function(a){var b=this;return function(c,d){var e;if("object"==c.localName&&"http://www.w3.org/1999/xhtml"==c.namespaceURI){var f=c.getAttribute("data");e=null;if(f){var f=ea(f,a.url),g=c.getAttribute("media-type");if(!g){var h=In(b.b,f);h&&(h=b.b.g[h])&&(g=h.d)}if(g&&(h=b.b.C[g])){e=b.viewport.b.createElement("iframe");e.style.border="none";var f=Ea(f),k=Ea(g),g=new Aa;g.append(h);g.append("?src=");g.append(f);g.append("&type=");g.append(k);for(h=c.firstChild;h;h=h.nextSibling)1==h.nodeType&&
...
c.namespaceURI)e=Zn(c,d);else if("http://example.com/sse"==c.namespaceURI){e=d?d.ownerDocument:b.viewport.b;g=c.localName;switch(g){case "t":case "tab":case "ec":case "nt":case "fraction":case "comment":case "mark":g="span";break;case "ruby":case "rp":case "rt":break;default:g="div"}e=e.createElement(g);e.setAttribute("data-adapt-process-children","true");e=O(e)}else e=O(null);return e}};
function Sn(a){if(a.D>=a.b.b.length)return O(null);var b=a.Bb[a.D];if(b)return O(b);var c=a.b.b[a.D],d=a.b.e,e=M("getPageViewItem");d.load(c.src).then(function(f){0==c.b&&1==a.b.b.length&&(c.b=Math.ceil(Di(f)/2700),a.b.u=c.b);var g=d.b[f.url],h=a.Ac(f),k=a.viewport,l=Ym(g,k.width,k.height,k.fontSize);if(l.width!=k.width||l.height!=k.height||l.fontSize!=k.fontSize)k=new km(k.d,l.fontSize,k.root,l.width,l.height);var n=new Zm(g,f,a.b.lang,k,a.e,a.f,h,a.b.w);n.U=a.U;$m(n).then(function(){b={item:c,X:f,
Qa:n,Da:[null],eb:[],complete:!1};a.Bb[a.D]=b;Q(e,b)})});return P(e)}function $n(a){return{D:a.D,N:a.N,ga:a.ga}}function ao(a,b){b?(a.D=b.D,a.N=-1,a.ga=b.ga):(a.D=0,a.N=0,a.ga=0);return Rn(a)}
m.Vb=function(){var a=this.b,b=a.A||a.I;if(!b)return O(null);var c=M("showTOC");this.d||(this.d=new pn(a.e,b.src,a.lang,this.e,this.f,this.U,this,a.w));var a=this.viewport,b=Math.min(350,Math.round(.67*a.width)-16),d=a.height-6,e=a.b.createElement("div");a.root.appendChild(e);e.style.position="absolute";e.style.visibility="hidden";e.style.left="3px";e.style.top="3px";e.style.width=b+10+"px";e.style.maxHeight=d+"px";e.style.overflow="scroll";e.style.overflowX="hidden";e.style.background="#EEE";e.style.border=
"1px outset #999";e.style.borderRadius="2px";e.style.boxShadow=" 5px 5px rgba(128,128,128,0.3)";this.d.Vb(e,a,b,d,this.viewport.fontSize).then(function(a){e.style.visibility="visible";Q(c,a)});return P(c)};m.Rb=function(){this.d&&this.d.Rb()};m.Xc=function(){return this.d&&this.d.Xc()};function bo(a,b,c,d){var e=this;this.g=a;this.cd=b;this.T=c;this.I=d;this.G=new ui(a.document.head,b);this.l="";this.f=null;this.d=!1;this.e=this.j=this.h=this.k=null;this.fontSize=16;this.A=!1;this.Ic=!0;this.U=Ob();this.u=function(){};this.w=function(){e.d=!0;e.u()};this.uc=function(){};this.C={loadEPUB:this.xd,loadXML:this.sd,configure:this.Rc,moveTo:this.ud,toc:this.Vb}}function co(a,b){b.i=a.T;b.viewer=a;a.I(b)}m=bo.prototype;
m.xd=function(a){var b=a.url,c=a.fragment,d=!!a.zipmeta,e=a.userStyleSheet,f=M("loadEPUB"),g=this;g.Rc(a).then(function(){var a=new sn;if(e)for(var k=0;k<e.length;k++)on(a,e[k]);nn(a).then(function(){var e=ea(b,g.g.location.href);g.l=e;un(a,e,d).then(function(a){g.f=a;Mn(g.f,c).then(function(a){g.e=a;eo(g).then(function(){co(g,{t:"loaded",metadata:g.f.l});Q(f,!0)})})})})});return P(f)};
m.sd=function(a){var b=a.url,c=a.document,d=a.fragment,e=a.userStyleSheet,f=M("loadXML"),g=this;g.Rc(a).then(function(){var a=new sn;if(e)for(var k=0;k<e.length;k++)on(a,e[k]);nn(a).then(function(){var e=ea(b,g.g.location.href);g.l=e;g.f=new wn(a,"");Kn(g.f,e,c).then(function(){Mn(g.f,d).then(function(a){g.e=a;eo(g).then(function(){co(g,{t:"loaded"});Q(f,!0)})})})})});return P(f)};
function fo(a,b){var c=parseFloat(b),d=/[a-z]+$/,e;if("string"===typeof b&&(e=b.match(d))){d=e[0];if("em"===d||"rem"===d)return c*a.fontSize;if("ex"===d||"rex"===d)return c*cc.ex*a.fontSize/cc.em;if(d=cc[d])return c*d}return c}
m.Rc=function(a){"boolean"==typeof a.autoresize&&(a.autoresize?(this.k=null,this.g.addEventListener("resize",this.w,!1),this.d=!0):this.g.removeEventListener("resize",this.w,!1));if("number"==typeof a.fontSize){var b=a.fontSize;5<=b&&72>=b&&this.fontSize!=b&&(this.fontSize=b,this.d=!0)}"object"==typeof a.viewport&&a.viewport&&(b=a.viewport,b={marginLeft:fo(this,b["margin-left"])||0,marginRight:fo(this,b["margin-right"])||0,marginTop:fo(this,b["margin-top"])||0,marginBottom:fo(this,b["margin-bottom"])||
0,width:fo(this,b.width)||0,height:fo(this,b.height)||0},200<=b.width||200<=b.height)&&(this.g.removeEventListener("resize",this.w,!1),this.k=b,this.d=!0);"boolean"==typeof a.hyphenate&&(this.U.vc=a.hyphenate,this.d=!0);"boolean"==typeof a.horizontal&&(this.U.tc=a.horizontal,this.d=!0);"boolean"==typeof a.nightMode&&(this.U.Cc=a.nightMode,this.d=!0);"number"==typeof a.lineHeight&&(this.U.lineHeight=a.lineHeight,this.d=!0);"number"==typeof a.columnWidth&&(this.U.oc=a.columnWidth,this.d=!0);"string"==
...
function go(a){var b=[];a.h&&(b.push(a.h),a.h=null);a.j&&(b.push(a.j.left),b.push(a.j.right),a.j=null);b.forEach(function(a){a&&(u(a.J,"display","none"),a.removeEventListener("hyperlink",this.uc,!1))})}function ho(a,b){b.addEventListener("hyperlink",a.uc,!1);u(b.J,"visibility","visible");u(b.J,"display","block")}function io(a,b){go(a);a.h=b;ho(a,b)}
function jo(a){var b=M("reportPosition");a.e||(a.e=$n(a.b));Ln(a.f,a.e.D,a.e.ga).then(function(c){var d=a.h;(a.A&&0<d.d.length?Uf(d.d):O(!0)).then(function(){ko(a,d,c).ka(b)})});return P(b)}function lo(a){var b=a.cd;if(a.k){var c=a.k;b.style.marginLeft=c.marginLeft+"px";b.style.marginRight=c.marginRight+"px";b.style.marginTop=c.marginTop+"px";b.style.marginBottom=c.marginBottom+"px";return new km(a.g,a.fontSize,b,c.width,c.height)}return new km(a.g,a.fontSize,b)}
function mo(a){if(a.k||!a.viewport||a.viewport.fontSize!=a.fontSize)return!1;var b=lo(a);if(!(b=b.width==a.viewport.width&&b.height==a.viewport.height)&&(b=a.b)){a:{a=a.b.Bb;for(b=0;b<a.length;b++){var c=a[b];if(c)for(var c=c.eb,d=0;d<c.length;d++){var e=c[d];if(e.w&&e.u){a=!0;break a}}}a=!1}b=!a}return b}
function no(a){if(a.b){a.b.Rb();for(var b=a.b.Bb,c=0;c<b.length;c++){var d=b[c];if(d)for(var d=d.eb,e;e=d.shift();)e=e.J,e.parentNode.removeChild(e)}}a.viewport=lo(a);a.b=new Pn(a.f,a.viewport,a.G,a.U)}
function oo(a,b){if(a.U.Ya)return Vn(a.b).cc(function(c){go(a);a.j=c;c.left&&(ho(a,c.left),c.right||c.left.J.setAttribute("data-vivliostyle-unpaired-page",!0));c.right&&(ho(a,c.right),c.left||c.right.J.setAttribute("data-vivliostyle-unpaired-page",!0));a.h=b;return O(null)});io(a,b);a.h=b;return O(null)}
function eo(a){a.d=!1;if(mo(a))return O(!0);var b=M("resize");a.b&&!a.e&&(a.e=$n(a.b));no(a);ao(a.b,a.e).then(function(c){oo(a,c).then(function(){jo(a).then(function(c){(a.Ic?a.b.Ic():O(null)).then(function(){Q(b,c)})})})});return P(b)}function ko(a,b,c){var d=M("sendLocationNotification"),e={t:"nav",first:b.h,last:b.j};On(a.f,a.e).then(function(b){e.epage=b;e.epageCount=a.f.u;c&&(e.cfi=c);co(a,e);Q(d,!0)});return P(d)}m.sc=function(){return this.b?this.b.sc():null};
m.ud=function(a){var b=this;if("string"==typeof a.where)switch(a.where){case "next":a=this.U.Ya?this.b.zd:this.b.nextPage;break;case "previous":a=this.U.Ya?this.b.Cd:this.b.Gc;break;case "last":a=this.b.wd;break;case "first":a=this.b.vd;break;default:return O(!0)}else if("number"==typeof a.epage){var c=a.epage;a=function(){return Wn(b.b,c)}}else if("string"==typeof a.url){var d=a.url;a=function(){return Yn(b.b,d)}}else return O(!0);var e=M("nextPage");a.call(b.b).then(function(a){a?(b.e=null,oo(b,
a).then(function(){jo(b).ka(e)})):Q(e,!0)});return P(e)};m.Vb=function(a){var b=!!a.autohide;a=a.v;var c=this.b.Xc();if(c){if("show"==a)return O(!0)}else if("hide"==a)return O(!0);if(c)return this.b.Rb(),O(!0);var d=this,e=M("showTOC");this.b.Vb(b).then(function(a){if(a){if(b){var c=function(){d.b.Rb()};a.addEventListener("hyperlink",c,!1);a.J.addEventListener("click",c,!1)}a.addEventListener("hyperlink",d.uc,!1)}Q(e,!0)});return P(e)};
function po(a,b){var c=b.a||"";return ye("runCommand",function(d){var e=a.C[c];e?e.call(a,b).then(function(){co(a,{t:"done",a:c});Q(d,!0)}):(co(a,{t:"error",content:"No such action",a:c}),Q(d,!0))},function(b,e){co(a,{t:"error",content:e.toString(),a:c});Q(b,!0)})}function qo(a){return"string"==typeof a?JSON.parse(a):a}
m.Tc=function(a){var b=qo(a),c=null,d=this;Ae(function(){var a=M("commandLoop"),f=te.d;d.uc=function(a){var b={t:"hyperlink",href:a.href,internal:a.href.substr(0,d.l.length)==d.l};Be(f,function(){co(d,b);return O(!0)})};Qe(function(a){if(d.d)eo(d).then(function(){Se(a)});else if(b){var e=b;b=null;po(d,e).then(function(){Se(a)})}else e=M("waitForCommand"),c=Je(e,self),P(e).then(function(){Se(a)})}).ka(a);return P(a)});d.u=function(){var a=c;a&&(c=null,a.Ra())};this.g.adapt_command=function(a){if(b)return!1;
b=qo(a);d.u();return!0}};window.adapt_embedded&&(window.adapt_initEmbed=function(a,b,c){(new bo(window,document.body,b,function(b){var c=JSON.stringify(b);(new Ze(function(){return Te(a,!1,"POST",c)})).start()})).Tc(c);delete window.adapt_initEmbed});ba("adapt.viewer.Viewer",bo);ba("adapt.viewer.Viewer.prototype.initEmbed",bo.prototype.Tc);var ro=16,so="ltr";function to(a){window.adapt_command(a)}function uo(){to({a:"moveTo",where:"ltr"===so?"previous":"next"})}function vo(){to({a:"moveTo",where:"ltr"===so?"next":"previous"})}
function wo(a){var b=a.key,c=a.keyIdentifier,d=a.location;if("End"===b||"End"===c)to({a:"moveTo",where:"last"}),a.preventDefault();else if("Home"===b||"Home"===c)to({a:"moveTo",where:"first"}),a.preventDefault();else if("ArrowUp"===b||"Up"===b||"Up"===c)to({a:"moveTo",where:"previous"}),a.preventDefault();else if("ArrowDown"===b||"Down"===b||"Down"===c)to({a:"moveTo",where:"next"}),a.preventDefault();else if("ArrowRight"===b||"Right"===b||"Right"===c)vo(),a.preventDefault();else if("ArrowLeft"===
b||"Left"===b||"Left"===c)uo(),a.preventDefault();else if("0"===b||"U+0030"===c)to({a:"configure",fontSize:Math.round(ro)}),a.preventDefault();else if("t"===b||"U+0054"===c)to({a:"toc",v:"toggle",autohide:!0}),a.preventDefault();else if("+"===b||"Add"===b||"U+002B"===c||"U+00BB"===c||"U+004B"===c&&d===KeyboardEvent.b)ro*=1.2,to({a:"configure",fontSize:Math.round(ro)}),a.preventDefault();else if("-"===b||"Subtract"===b||"U+002D"===c||"U+00BD"===c||"U+004D"===c&&d===KeyboardEvent.b)ro/=1.2,to({a:"configure",
fontSize:Math.round(ro)}),a.preventDefault()}
function xo(a){switch(a.t){case "loaded":a=a.viewer;var b=so=a.sc();a.cd.setAttribute("data-vivliostyle-page-progression",b);a.cd.setAttribute("data-vivliostyle-spread-view",a.U.Ya);window.addEventListener("keydown",wo,!1);document.body.setAttribute("data-vivliostyle-viewer-status","complete");a=document.getElementById("vivliostyle-page-navigation-left");a.addEventListener("click",uo,!1);b=document.getElementById("vivliostyle-page-navigation-right");b.addEventListener("click",vo,!1);[a,b].forEach(function(a){a.setAttribute("data-vivliostyle-ui-state",
"attention");window.setTimeout(function(){a.removeAttribute("data-vivliostyle-ui-state")},1E3)});break;case "error":v("Error: "+a.content);break;case "nav":(a=a.cfi)&&location.replace(ha(location.href,Ea(a||"")));break;case "hyperlink":a.internal&&to({a:"moveTo",url:a.href})}}
...
g.textContent="@page { size: "+n+"; margin: 0; }",document.head.appendChild(g));(new bo(window,l,"main",xo)).Tc(a)});
